...
//	var RDServer   = "/rsumunknownvar /rfn [http://rds.hanjin.com/RDServer/rdagent.jsp] /rsn [jdbc/HJSALPSA] /ruseurlmoniker [0]";  //RDServer RDAgnet url
//	var RDServerBAT = "/rsumunknownvar /rfn [http://rds.hanjin.com/RDServer/rdagent.jsp] /rsn [jdbc/HJSALPSB] /ruseurlmoniker [0]"; //Batch Connection Pool
	var RDServer   = "/rsumunknownvar /rfn [http://rdst.hanjin.com:19500/RDServer/rdagent.jsp] /rsn [jdbc/HJSALPSA] /ruseurlmoniker [0]";  //RDServer RDAgnet url
	var RDServerBAT = "/rsumunknownvar /rfn [http://rdst.hanjin.com:19500/RDServer/rdagent.jsp] /rsn [jdbc/HJSALPSB] /ruseurlmoniker [0]"; //Batch Connection Pool
	var RD_path = "http://alps.hanjin.com/hanjin/" ;            // Report file 위치
	
	var URL = "http://alps.hanjin.com/hanjin/rpt/cab" ;         // report 컴포넌트 다운로드 위치
	var RdReport = "/hanjin/rpt/jsp/rdReport.jsp" ;            // popup 으로 rd를 호출하는 공통 파일
	var RDServerIP = "http://localhost:7001/hanjin";		//File 이용시 Server IP 공통 사용.
...
document.write('  codebase="/hanjin/rpt/cab/rdviewer50u.cab#version=5,0,0,499"');
...
document.write('  codebase="/hanjin/rpt/cab/teechart7.cab#version=7,0,1,5">');
document.write('</object>');
}

function comRdpdfObject(){
document.write('<object');
//document.write('   id=rdpdf20');
document.write('   classid="clsid:0D0862D3-F678-48B5-876B-456457E668BC"');
document.write('   width=0%');
document.write('   height=0%');
document.write('   codebase="/hanjin/rpt/cab/rdpdf50.cab#version=2,1,0,83">');
document.write('</OBJECT>');
}

function comRdbarcodeObject(){
document.write('<object');
//document.write('   id=rdbarcode');
document.write('   classid="clsid:AA30E61C-DBC4-4DF6-B2CC-FAE39282CF56"');
document.write('   width=0%');
document.write('   height=0%');
document.write('   codebase="/hanjin/rpt/cab/rdbarcode5.cab#version=5,5,1,54">');
document.write(' </object>');
}
