...
<%@ page import="com.hanjin.bizcommon.eqorgchart.event.ComEns0O1Event"%>
<%
	ComEns0O1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	Exception serverException   = null;			//서버에서 발생한 에러
	String strErrMsg = "";								 //에러메세지
	int rowCount	 = 0;								  //DB ResultSet 리스트의 건수
	event = (ComEns0O1Event)request.getAttribute("Event");
...
<html>
<head>
<title>EQ Organization Chart</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;EQ Organization Chart</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
