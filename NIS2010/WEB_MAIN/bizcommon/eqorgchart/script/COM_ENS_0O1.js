        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtHidden,   0,    	daLeft,  	false,    	"loc_dpth_cd",  false,      "",       	dfNone,   	0,     		false,      false);
                    InitDataProperty(0, cnt++ , dtHidden,   0,    	daLeft,  	false,    	"loc_cd",       false,      "",       	dfNone,   	0,     		false,      false);
                    InitDataProperty(0, cnt++ , dtHidden,   0,    	daLeft,  	false,    	"prnt_loc_id",  false,      "",       	dfNone,   	0,     		false,      false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch4Post("COM_ENS_0O1GS.do", selectVal);               
    ...
    {   
       ...
       // chkDepth값이 존재한다면, 특정 Depth만 선택 가능하도록 해야 한다.
        if(chkDepth != "" && chkDepth != null) {
            ...
            {
                sheetObj.CellValue2(Row,"checkbox") = "N";
            }
        } else {
