...
<%@ page import="com.hanjin.bizcommon.calendar.event.ComEns0S1Event"%>
<%@ page import="com.hanjin.bizcommon.calendar.event.ComEns0S1EventResponse"%>
<%
...
<!-- link href="/hanjin/css/enis_contents.css" rel="stylesheet" type="text/css"-->
<script language="javascript" src="/hanjin/bizcommon/calendar/script/COM_ENS_0S1.js"></script>
...
<link href="/hanjin/css/enis_menu.css" rel="stylesheet" type="text/css"><!-- CSS for 'TOP'&'LEFT' frame -->
...
<tr>
	<td class="bodyright">
		...
		<!-- Put your 'STYLESHEET' into the <HEAD> tag on the corresponding page if you make 'FRAMESET's -->
		<!-- link href="/hanjin/css/enis_contents.css" rel="stylesheet" type="text/css"><!-- CSS for 'RIGHT' frame -->


		<!-- TABLE '#D' : ( Page Title, Historical Tail Navigation ) (S) -->
		<table width="100%" class="title">
		<tr>
			<td class="history"><img src="/hanjin/img/enis/ico_hystory.gif" width="8" height="9" align="absmiddle">Service Delivery &gt; Product Catalog &gt; Network Node </td>
		</tr>
		<tr>
			<td class="title"><img src="/hanjin/img/enis/ico_t1.gif" width="20" height="12"> Local Calendar Management</td>
		</tr>
		</table>
		...
		<tr><td class="align">
			...
			<table class="button">
			<tr><td><img class="cursor" src="/hanjin/img/enis/button/btn_retrieve.gif" width="66" height="20" border="0" name="btn_retrieve"></td>
				<td><img class="cursor" src="/hanjin/img/enis/button/btn_new.gif" width="66" height="20" border="0" name="btn_new"></td>
				<td><img class="cursor" src="/hanjin/img/enis/button/btn_save.gif" width="66" height="20" border="0" name="btn_save"></td>
			</tr>
			</table>
		...
		<table class="tab">
			<tr>
				...
				<!--img src="/hanjin/img/enis/sub_tab.gif" alt="" width="755" height="23" border="0"--></td>
			</tr>
		</table>
		<!-- TABLE '#D' : ( Tab ) (E) -->
...
<div id="tabLayer" style="display:inline">
				...
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							...
							<td width="15%">&nbsp;<input name="cnt_cd_cnt" type="text" style="width:35"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cnt_cd"></td>
							<td width="6%">Period</td>
							<td>&nbsp;<input name="frDate_cnt" type="text" style="width:75"> <img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_fr"> ~ <input name="toDate_cnt" type="text" style="width:75"> <img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_to"></td>
						</tr>
					</table>
		...
		<table width="100%" class="sbutton">
       	<tr><td class="align">
		    ...
		    <table class="sbutton">
		    <tr><td class="bt"><img class="cursor" src="/hanjin/img/enis/button/btng_rowadd.gif" width="65" height="19" border="0" name="btn_rowadd_cnt"></td>							
			</table>
...
<div id="tabLayer" style="display:none">
			...
			<tr>
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							<td width="8%"><img class="star">Country</td>
							<td width="12%">&nbsp;<input name="cnt_cd_ste" type="text" style="width:35"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cnt_cd"></td>
							...
							<td width="6%">Period</td>
							<td>&nbsp;<input name="frDate_ste" type="text" style="width:75"> <img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"> ~ 
									  <input name="toDate_ste" type="text" style="width:75"> <img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
						</tr>
					</table>
		...
		<table width="100%" class="sbutton">
       	<tr><td class="align">
		    ...
		    <table class="sbutton">
		    <tr><td class="bt"><img class="cursor" src="/hanjin/img/enis/button/btng_rowadd.gif" width="65" height="19" border="0" name="btn_rowadd_ste"></td>							
			</table>
			...
			<tr>
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							<td width="8%"><img class="star">Country</td>
							<td width="12%">&nbsp;<input name="text" type="text" style="width:35" value="US"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
							<td width="7%">Location</td>
							<td width="15%">&nbsp;<input name="text" type="text" style="width:50" value="USLGB"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
							<td width="6%">Period</td>
							<td>&nbsp;<input name="text2" type="text" style="width:75" value="2006-05-04"> <img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"> ~ <input name="text2" type="text" style="width:75" value="2006-05-04"> <img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
						</tr>
					</table>
