...
<%@ page import="com.hanjin.bizcommon.calendar.event.ComEns0S3Event"%>
<%@ page import="com.hanjin.bizcommon.calendar.event.ComEns0S3EventResponse"%>
<%@ page import="com.hanjin.framework.support.controller.html.FormCommand"%>
<%

	ComEns0S3Event event = null;
	ComEns0S3EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	...
	try {
		...
		if (serverException != null) {
			...
			event = (ComEns0S3Event)request.getAttribute("Event");
			eventResponse = (ComEns0S3EventResponse)request.getAttribute("EventResponse");
