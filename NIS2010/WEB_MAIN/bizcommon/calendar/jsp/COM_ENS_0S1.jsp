				...
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							...
							<td width="18%">&nbsp;<input class="input1" name="cnt_cd_cnt" maxlength="2" type="text" style="width:35" onKeyUp="javascript:upper(this);" onkeydown="cntPopup(0);"> <img class="cursor" src="img/alps/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cnt_cd"></td>
							<td width="6%">Period</td>
							<td>&nbsp;<input name="frDate_cnt" type="text" style="width:75"> <img class="cursor" src="img/alps/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_fr"> ~ 
									  <input name="toDate_cnt" type="text" style="width:75"> <img class="cursor" src="img/alps/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_to"></td>
						</tr>
					</table>
			...
			<tr>
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							<td width="6%">Country</td>
							<td width="12%">&nbsp;<input class="input1" name="cnt_cd_ste" maxlength="2" type="text" style="width:35" onChange="javascript:setSteList(this, document.form.ste_cd_ste);" onkeydown="cntPopup(1);"> <img class="cursor" src="img/alps/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cnt_cd"></td>
							<td width="15%">State / Province</td>
							<td width="25%"><select name="ste_cd_ste" style="width:50;">
											</select>
							</td>
							<td width="6%">Period</td>
							<td>&nbsp;<input name="frDate_ste" type="text" style="width:75"> <img class="cursor" src="img/alps/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_fr"> ~ 
									  <input name="toDate_ste" type="text" style="width:75"> <img class="cursor" src="img/alps/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_to"></td>
						</tr>
					</table>
				...
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							...
							<td width="12%">&nbsp;<input class="input1"name="cnt_cd_loc" maxlength="2" type="text" style="width:35" onKeyUp="javascript:upper(this);" onkeydown="cntPopup(2);"> <img class="cursor" src="img/alps/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cnt_cd"></td>
							<td width="7%">Location</td>
							<td width="15%">&nbsp;<input class="input1" name="loc_cd_loc" type="text" style="width:50" onKeyUp="javascript:upper(this);" onkeydown="locPopup();"> <img class="cursor" src="img/alps/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_loc_cd"></td>
							<td width="6%">Period</td>
							<td>&nbsp;<input name="frDate_loc" type="text" style="width:75"> <img class="cursor" src="img/alps/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_fr"> ~ 
									  <input name="toDate_loc" type="text" style="width:75"> <img class="cursor" src="img/alps/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar_to">
							</td>
						</tr>
					</table>
				...
				<td class="bg_b1">
					...
					<table class="search" border="0" style="width:733;">
						<tr class="h23">
							...
							<td width="15%">&nbsp;<%= com.hanjin.bizcommon.util.BizComUtil.getCodeCombo("conti_cd", "", "", "CONTI", 1, "0: :ALL") %></td>
							<td width="8%">Country</td>
							<td width="12%">&nbsp;<input class="input1" name="cnt_cd_month" maxlength="2" type="text" style="width:35" onChange="javascript:setFormConti(this, document.form.conti_cd);" onkeydown="cntPopup(3);"> <img class="cursor" src="img/alps/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cnt_cd"></td>
							<td width="4%">Year</td>
...
<tr><td class="bgdybottom_copy">
	...
	<table class="copy">
	<tr><td class="copy"><img src="/hanjin/img/enis/copy2.gif" width="460" height="16"></td></tr>
	</table>
