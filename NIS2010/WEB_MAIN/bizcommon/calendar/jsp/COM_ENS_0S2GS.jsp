...
<%@ page import="com.hanjin.bizcommon.calendar.event.ComEns0S2Event"%>
<%@ page import="com.hanjin.bizcommon.calendar.event.ComEns0S2EventResponse"%>
<%@ page import="com.hanjin.framework.support.controller.html.FormCommand"%>
<%

	ComEns0S2Event event = null;
	ComEns0S2EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	...
	try {
		...
		if (serverException != null) {
			...
			event = (ComEns0S2Event)request.getAttribute("Event");
			eventResponse = (ComEns0S2EventResponse)request.getAttribute("EventResponse");
