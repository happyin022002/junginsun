	        ...
	        switch(srcName) {
	    	    ...
	    	    case "btn_cnt_cd":        	        
	    	        ...
	    	        var param = "?conti_cd="+conti_cd+"&cnt_cd="+cnt_cd+"&classId=COM_ENS_0M1";		
	  				ComOpenPopupWithTarget('/hanjin/COM_ENS_0M1.do' + param, 560, 620, targetObjList, v_display, true);
	    	        break;
	    	    ...
	    	    case "btn_loc_cd":        	        
	    	        ...
	    	        var param = "?cnt_cd="+cnt_cd+"&loc_cd="+loc_cd+"&classId=COM_ENS_051";
	  				...
	  				ComOpenPopupWithTarget('/hanjin/COM_ENS_051.do' + param, 770, 480, targetObjList, v_display, true);
	    	        break;
    ...
    */
    ...
    {   
        if ( sheetObj.ColSaveName(col) == "cnt_cd" ) {
            ...
            var sheetIdx = 0; 
            comPopupInSheet('/hanjin/COM_ENS_0M1.do' + param, 565, 480, 'setCntInfoInSheet', display, row, col, true, false, sheetIdx);
    ...
    function sheet_cnt_OnChange(sheetObj, Row, Col, Value){
        ...
        if (sheetObj.ColSaveName(Col) == "cnt_cd") {            
            ...
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=CNT_VALID&cnt_cd="+Value+"&sheetIdx=0&row="+Row+"&col="+Col;
        } else if(sheetObj.ColSaveName(Col) == "frDate" || sheetObj.ColSaveName(Col) == "toDate") {
    ...
    {   
        ...
        } else if ( sheetObj.ColSaveName(col) == "ste_cd" )
        {
            ...
            var chkStr = display.substring(0,3);
            var sheetIdx = 1; 
            comPopupInSheet('/hanjin/COM_ENS_0X1.do' + param, 300, 380, 'setSteInfoInSheet', display, row, col, true, false, sheetIdx);
        }
    }
    ...
    function sheet_ste_OnChange(sheetObj, Row, Col, Value){
        ...
        if (sheetObj.ColSaveName(Col) == "cnt_cd") {            
            ...
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=CNT_VALID&cnt_cd="+Value+"&sheetIdx=1&row="+Row+"&col="+Col;
        } else if(sheetObj.ColSaveName(Col) == "frDate" || sheetObj.ColSaveName(Col) == "toDate") {
            setYoil(sheetObj, Row, Col, Value);
        } else if (sheetObj.ColSaveName(Col) == "ste_cd") {   
            if(Value.length != 2) {
            ...
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=STE_VALID&ste_cd="+Value+"&sheetIdx=1&row="+Row+"&col="+Col;
        }      
    }
    ...
    function sheet_ste_OnClick(sheetObj, Row, Col, Value){
        if (sheetObj.ColSaveName(Col) == "ste_cd") {
            ...
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=STE_EXIST&cnt_cd="+cnt_cd+"&sheetIdx=1&row="+Row+"&col="+Col;
    ...
    {   
        ...
        } else if ( sheetObj.ColSaveName(col) == "loc_cd" )
        {
            ...
            var chkStr = display.substring(0,3);
            var sheetIdx = 2; 
            comPopupInSheet('/hanjin/COM_ENS_051.do' + param, 770, 480, 'setLocInfoInSheet', display, row, col, true, false, sheetIdx);
        } else if ( sheetObj.ColSaveName(col) == "frDate" || sheetObj.ColSaveName(col) == "toDate" ) {
            var cal = new calendarPopupGrid();
    ...
    function sheet_loc_OnChange(sheetObj, Row, Col, Value){
        ...
        if (sheetObj.ColSaveName(Col) == "cnt_cd") {            
            ...
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=CNT_VALID&cnt_cd="+Value+"&sheetIdx=2&row="+Row+"&col="+Col;
        } else if(sheetObj.ColSaveName(Col) == "frDate" || sheetObj.ColSaveName(Col) == "toDate") {
            setYoil(sheetObj, Row, Col, Value);
        } else if (sheetObj.ColSaveName(Col) == "loc_cd") {   
            if(Value.length != 5) {
            ...
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=LOC_VALID&loc_cd="+Value+"&sheetIdx=2&row="+Row+"&col="+Col;
        }      
    }
    ...
    function sheet_loc_OnClick(sheetObj, Row, Col, Value){
        if (sheetObj.ColSaveName(Col) == "loc_cd") {
            ...
            var cnt_cd = sheetObj.CellValue(Row, "cnt_cd");            
            document.all.iframe_bizcom.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=LOC_EXIST&cnt_cd="+cnt_cd+"&sheetIdx=2&row="+Row+"&col="+Col;
        }
    }
   ...
   /**
    ...
    function setSteList(cntObj, targetObj){
        ...
        formObject.target="iframe_bizcom";
 		formObject.action="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=STE_COMBO&targetCombo="+targetObj.name+"&cnt_cd="+cntObj.value;
 		result = formObject.submit();
 		
 		//document.all.iframe_bizcom02.src="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=STE_IB&cnt_cd="+cntObj.value+"&sheetIdx=1&row=0";
    }
    ...
    function setFormConti(cntObj, targetObj) {
        ...
        var formObject = document.form;
        formObject.target="iframe_bizcom";
 		formObject.action="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?func=CONTI_CNT&targetObj="+targetObj.name+"&cnt_cd="+cntObj.value;
 		result = formObject.submit();
    }
