        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitColumnInfo(15, 5, 0, true);

                    // 해더에서 처리할 수 있는 각종 기능을 설정한다
                    InitHeadMode(true, true, true, true, false,false)
                    
                    
                    var HeadTitle = "||Seq.|Cust. Code|Customer Name|S.OFC|Address|ST|ZIP|Location|Type|Group Code|Vndr Code|Use|SREP Code" ;
                    ...
                    InitDataProperty(0, cnt++ , dtData,     400,    daLeft,  false,    	 	"bzet_addr",   			false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     0,    daLeft,  false,    	 	"ste_cd",   			false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     0,    daLeft,  false,    	 	"zip_cd",   			false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     0,    daLeft,  false,    	 	"loc_cd",   			false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     0,    daLeft,  false,    	 	"rvis_cntr_cust_tp_cd", false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     0,    daLeft,  false,    	 	"cust_grp_id",   		false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,       0,    daCenter,  false,   	"vndr_seq",     				false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,       0,    daCenter,  false,   	"use",     				false,          "",       dfNone,   	0,     false,       true);
...
//                     sheetObj.UseZipFile = true;
                     var sXml = sheetObj.GetSearchXml("COM_ENS_041GS.do", selectVal);
...
//                     sheetObj.DoSearch("COM_ENS_041GS.do?UseZipFile=true", selectVal);
           ...
           case IBSEARCHAPPEND:  // 페이징 조회
                ...
                formObj.f_cmd.value = SEARCH;         
                sheetObj.DoSearch4Post("COM_ENS_041GS.do", selectVal, "iPage=" + PageNo, true);  
           break;
...
//
//    function chkKorean(Object) {
//        
//        var keyValue = window.event.keyCode;      
//        
//        // 영문 및 숫자만 가능 처리        
//        if ( !(keyValue >= 65 && keyValue <= 90) && !(keyValue >= 48 && keyValue <= 57) ) {
//           return false;  
//        }
//    }