...
<%@ page import="com.hanjin.bizcommon.customer.event.ComEns043Event"%>
<%@ page import="com.hanjin.framework.core.layer.event.GeneralEventResponse"%>
<%
	ComEns043Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
       ...
       //userAuth=account.getAuth(); 
        ...
        event = (ComEns043Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">	S.Rep Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
<%} %>		
		...
		<table class="search">
			<tr>
				...
				<tr class="h23">
					<td width="60">Global ID</td>
					<td ><input type="text" name="glo_usr_id" maxlength="20" style="width:80;text-align: center;" style=""></td>
					<td width="80">S.rep Code</td>
					<td ><input type="text" name="srep_cd" maxlength="5" dataformat="engupnum" style="width:60;text-align: center;" style=""></td>
					<td width="80">Office Code</td>
					<td width=""><input type="text" name="ofc_cd" maxlength="6" dataformat="engupnum" style="width:70;text-align: center;" style=""></td>
					<td width="80">S.rep Name</td>
					<td ><input type="text" name="srep_nm" maxlength="30" onkeypress="" style="width:140;text-align: left;" style=""></td>
				</tr>
					</table>
				<!-- : ( Scenario ID ) (E) -->
