...
<script language="javascript" src="/hanjin/script/IBChart.js"></script>
<script language="javascript" src="/hanjin/script/IBSheetInfo.js"></script>
<script>
function setUpPage() {
	document.form.sheetId.value = "<%=request.getParameter("sheetId")%>";
	setColumnListBox();
}
</script>
</head>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/enis/ico_t1.gif" width="20" height="12">Multi Sort</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table width="100%" class="button"> 
		   ...
		   <table class="button"> 
			<tr><td><img class="cursor" src="/hanjin/img/enis/button/btn_add.gif" width="66" height="20" border="0" name="btn_add"></td>
