...
*@FileTitle : Location Code Inquiry(공통 Popup)
*Open Issues :
*Change history :
...
/* 업무별전역변수는 아래 부분에 추가 선언하여 사용한다. */
     ...
     */
     function loadPage(mainpage) {
        ...
        if(!(ComIsNull(formObject.loc_cd) && ComIsNull(formObject.rcc_cd) && ComIsNull(formObject.un_loc_ind_cd) && ComIsNull(formObject.loc_state))) {
            ...
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    if(mainPage == undefined){
                    	HeadTitle = "Sel|Sel|Seq|Location|Location Name|Region|State|Description|US Mode|SCC|ECC|LCC|RCC|S.OFC|EQ OFC|Country|UN|UNLoc|Hub Loc";
                    }else{
                    	HeadTitle = "Seq|Location|Location Name|Region|State|Description|US Mode|SCC|ECC|LCC|RCC|S.OFC|EQ OFC|Country|UN|UNLoc|Hub Loc";
                    }
                    ...
                    InitDataProperty(0, cnt++ , dtData,      	40,    	daCenter,  	false,    	"loc_state",    	false,          "",       dfNone, 		0,     		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	130,    	daLeft,  	false,    	"ste_nm",        	false,          "",       dfNone, 		0,     		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	60,    	daCenter,  	false,    	"",   	false,          "",       dfNone, 		0,    		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"scc_cd",       	false,          "",       dfNone, 		0,     		false,      true,		-1,		false,		true,	"Sub Local Control Center");
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"ecc_cd",       	false,          "",       dfNone, 		0,     		false,      true,		-1,		false,		true,	"Equipment Control Center");
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"lcc_cd",       	false,          "",       dfNone, 		0,     		false,      true,		-1,		false,		true,	"Local Control Center");
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"rcc_cd",       	false,          "",       dfNone, 		0,     		false,      true,		-1,		false,		true,	"Regional Control Center");
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"sls_ofc_cd",   	false,          "",       dfNone, 		0,    		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"eq_ctrl_ofc_cd",	false,          "",       dfNone, 		0,     		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	55,    	daCenter,  	false,    	"cnt_cd",			false,          "",       dfNone, 		0,     		false,      true);
                    InitDataProperty(0, cnt++ , dtData,     	40,    	daCenter,  	false,    	"un_loc_ind_cd",	false,          "",       dfNone, 		0,     		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"un_loc_cd",    	false,          "",       dfNone, 		0,     		false,      true);
                    InitDataProperty(0, cnt++ , dtData,      	50,    	daCenter,  	false,    	"hub_loc_cd",   	false,          "",       dfNone, 		0,    		false,      true);
            ...
            */
            switch(srcName) {
        	    ...
        	    case "Code_Detall":
        	    	...
        	    	ComOpenWindowCenter("/hanjin/locationCodeInquiry.do?f_cmd=101&loc_cd="+sheetObject.CellValue(row, "loc_cd") , "myWin", 605,560, true)
        	        break;
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch4Post("COM_ENS_051GS.do", selectVal);               
               
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value = SEARCHLIST;  
                sheetObj.DoSearch4Post("COM_ENS_051GS.do", selectVal, "iPage=" + PageNo, true);
           break;
