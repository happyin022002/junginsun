...
<%@ page import="com.hanjin.bizcommon.leasingcompanyyard.event.ComCom0004Event"%>
<%@ page import="com.hanjin.bizcommon.leasingcompanyyard.vo.SearchLeasingCompanyYardListVO"%>
<%
	ComCom0004Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComCom0004Event)request.getAttribute("Event");
		/* 
...
<html>
<head>
<title>Leasing Company Yard Code Inquiry</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">Leasing Company Yard Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
	<%} %>			
      ...
      <!--biz page (S)-->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="40">Code</td>	
						<td><input type="text" name="lse_co_yd_cd" style="width:70px;ime-mode:disabled;text-align:center" maxlength="7" dataformat="engup" id="lse_co_yd_cd" /> </td>
						<td width="75">Description</td>
						<td><input type="text" name="lse_co_yd_nm" style="width:380px;" maxlength="50" dataformat="excepthan" id="lse_co_yd_nm" /> </td>
						<%
							...
							<td>
								<select style="width:85px;" name="delt_flg">
										<option value="" <%if("".equals(delt_flg)){ %> selected="selected" <%} %>>ALL</option>
										<option value="A" <%if("N".equals(delt_flg)){ %> selected="selected" <%} %>>Active</option>
										<option value="D" <%if("Y".equals(delt_flg)){ %> selected="selected" <%} %>>Delete</option>
									</select>
							</td>
						<%
								}
