...
<%@ page import="com.hanjin.bizcommon.servicescope.event.ComEns0L1Event"%>
<%
	ComEns0L1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComEns0L1Event)request.getAttribute("Event");
		/* 
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Service Scope Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="17%">SVC SCP.</td>
					<td width="19%"><input type="text" name="svc_scp_cd" style="width:35" maxlength="3" dataformat="engup"></td>
					<td width="3%">Name</td>
					<td width=""><input type="text" name="svc_scp_nm" style="width:100%" ></td>
				</tr> 
