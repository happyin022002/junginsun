	...
	switch(sheetID) {
		case "sheet1" :
			with(sheetObj) {
				...
				var HeadTitle="Sel|Sel|Code|Name|Status||";
            	...
            	InitDataProperty(0, cnt++ , dtData,      	80,    	daCenter,  	false,    	"act_cd",     		false,          "",       dfNone,     	0,     		false,      true);
            	InitDataProperty(0, cnt++ , dtData,        330,    	  daLeft,  	false,    	"act_nm",      		false,          "",       dfNone,     	0,     		false,      true);
