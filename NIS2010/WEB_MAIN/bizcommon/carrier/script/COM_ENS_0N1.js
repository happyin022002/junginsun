        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtSeq,       	30,    daCenter,  false,    	"no",         	false,          "",       dfNone,   0,     		false,       true);
                    InitDataProperty(0, cnt++ , dtData,      	70,    daCenter,  false,    	"crr_cd",       false,          "",       dfNone,   0,     		false,       true);
                    InitDataProperty(0, cnt++ , dtData,      	70,    daLeft,    false,   		"crr_full_nm",  false,          "",       dfNone,   0,     		false,       true);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch4Post("COM_ENS_0N1GS.do", selectVal);               
               
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value = SEARCHLIST;  
                sheetObj.DoSearch4Post("COM_ENS_0N1GS.do", selectVal, "iPage=" + PageNo, true);
           break;
