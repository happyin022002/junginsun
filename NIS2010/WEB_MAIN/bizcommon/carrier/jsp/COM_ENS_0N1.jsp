...
<%@ page import="com.hanjin.bizcommon.carrier.event.ComEns0N1Event"%>
<%
	ComEns0N1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComEns0N1Event)request.getAttribute("Event");
		/* 
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Carrier Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="22%">Carrier Code</td>
					<td width="28%"><input type="text" name="crr_cd" style="width:70" maxlength="4" dataformat="engup"></td>
					<td width="12%">Name</td>
					<td width="38%"><input type="text" name="crr_nm" style="width:100%" dataformat="engup"></td></tr> 
				</table>
				<!-- : ( Scenario ID ) (E) -->
...
<!--
	  ...
	  */
	  ...
	  {
		<%
		if(event.getCarrierListVO() != null){ 
			   String crrCd   =	event.getCarrierListVO().getCrrCd();
			   String crrNm   =	event.getCarrierListVO().getCrrNm();			   
		%>
		eval("crr_cd" ).value = "<%= crrCd %>";
		eval("crr_nm" ).value = "<%= crrNm %>";
		<% } %>
	   }
-->
</SCRIPT>
