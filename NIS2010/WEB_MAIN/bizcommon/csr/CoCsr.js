...
function  getMsg(msgNo,msg1,msg2,msg3)
{
    ...
    msgs['CSR25035'] = 'The month of GL and ASA is different. First of all, please check whether ASA no. is accordingly generated.' ;
    msgs['CSR25036'] = 'CSR has been created.';
    msgs['CSR25037'] = 'Do you want to select Approval Step?';
    msgs['CSR25038'] = 'Please select Approval Type.';
    msgs['CSR25039'] = 'There is no CSR No.';
...
//csr_moveFocus의 Tab Key Event보완
function obj_moveFocus(fromFormElement, toFormElement, numleng) {
	var eleLeng = fromFormElement.value.length;
	if (eleLeng>=numleng){
		if(event.keyCode !=9){
			toFormElement.focus();
...
function csr_addComma2(src) {
  ...
  function tes_copy_rows_to(dest_obj, queryStr, appendMode){
  	...
  	dest_obj.DoSearch4Post("TES_SHEET.screen", queryStr, '', appendMode);
  }
...
function zu_openRunning(flag, bOpenLayer){
  ...
  if(document.getElementById('__FrameWaitIframe__')==null&&flag)
  {
    ...
    wait		+= " frameBorder='0' scrolling='no' src='"+waitImage +"'></iframe>";
	...
	var waitImage = "<IFRAME id='__WaitImgIframe__' marginwidth=0 marginheight=0 frameborder=0 width="+msgW+"px height="+msgH+"px style='visibility:visible;' src='"+waitImage +"'/>";
