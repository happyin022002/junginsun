...
/* 업무별전역변수는 아래 부분에 추가 선언하여 사용한다. */
     ...
     */
     function loadPage(mainpage) {
        ...
        if(!(ComIsNull(formObject.rep_cmdt_cd) && ComIsNull(formObject.rep_cmdt_nm))) {
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,      70,    daCenter,  false,    "rep_cmdt_cd",        false,          "",       dfNone,     0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,      200,    daLeft,  false,   "rep_cmdt_nm",    false,          "",       dfNone,     0,     false,       true);
                }
                break;
        }
    }
    ...
    function processButtonClick(){
        ...
        try {
            ...
            */
            if( e == "[object Error]") {
            	ComShowMessage("지금은 사용하실 수가 없습니다");
            } else {
            	ComShowMessage(e);
            }
        }
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch4Post("COM_ENS_0K1GS.do", selectVal);               
               
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value = SEARCHLIST;  
                sheetObj.DoSearch4Post("COM_ENS_0K1GS.do", selectVal, "iPage=" + PageNo, true);
           break;
