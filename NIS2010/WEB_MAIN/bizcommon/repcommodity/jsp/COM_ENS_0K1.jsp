...
<%@ page import="com.hanjin.bizcommon.repcommodity.event.ComEns0K1Event"%>
<%
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Rep Commodity Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
<%} %>		
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="25%">Commodity Code</td>
					<td width="15%">&nbsp;<input type="text" name="rep_cmdt_cd" style="width:45" maxlength="4" dataformat="number"></td>
					<td width="25%">Commodity Name</td>
					<td >&nbsp;<input type="text" name="rep_cmdt_nm" dataformat="engup" style="width:80%"></td></tr> 			
				</table>
				<!-- : ( Scenario ID ) (E) -->
