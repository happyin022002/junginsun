            ...
            switch(srcName) {
        	    ...
        	    case "btn_por_cd":
        	       ...
        	       var param = "?loc_cd="+loc_cd+"&classId=COM_ENS_051";
      			   ...
      			   comPopupWithTargetObj('/hanjin/COM_ENS_051.do' + param, 770, 485, targetObjList, v_display, true);
      			   break;
      		    case "btn_pol_cd":
...
//            }
   ...
   /**
    ...
    function setSvcScope() {        
        ...
        document.all.iframe_bizcom.src = "/hanjin/bizcommon/common/COM_ENS_COMMON.jsp?"
 		                + "func=SVC_SCOPE&"
