...
<%@ page import="com.hanjin.bizcommon.surcharge.event.ComEns0D1Event"%>
<%@ page import="com.hanjin.bizcommon.surcharge.event.ComEns0D1EventResponse"%>
<%
...
<script language="javascript" src="/hanjin/bizcommon/surcharge/script/COM_ENS_0D1.js"></script>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/enis/ico_t1.gif" width="20" height="12">Surcharge Inquiry By Rote</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					...
					<td width="15%">&nbsp;<input type="text" style="width:50" name="por" maxlength="5" onKeyUp="javascript:upper(this);" onChange="javascript:setSvcScope();"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_por_cd"></td>
					<td width="9%">POL</td>
					<td width="15%">&nbsp;<input type="text" style="width:50" name="pol" maxlength="5" onKeyUp="javascript:upper(this);" onChange="javascript:setSvcScope();"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_pol_cd"></td>
					<td width="6%">POD</td>
					<td width="14%">&nbsp;<input type="text" style="width:50" name="pod" maxlength="5" onKeyUp="javascript:upper(this);" onChange="javascript:setSvcScope();"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_pod_cd"></td>
					<td width="12%">&nbsp;&nbsp;Destin(Import)</td>
					<td width="18%"><input type="text" style="width:50" name="del" maxlength="5" onKeyUp="javascript:upper(this);" onChange="javascript:setSvcScope();"> <img class="cursor" src="/hanjin/img/enis/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_del_cd"></td></tr> 
				...
				<tr class="h23">
					...
					<td>&nbsp;&nbsp;Access Date</td>
					<td><input type="text" style="width:70" name="accessDate">&nbsp;<img class="cursor" src="/hanjin/img/enis/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td></tr> 
				</table>
...
<tr><td height="71" class="popup">
		...
		<table class="sbutton">
		<tr><td class="p_bt"><img class="cursor" src="/hanjin/img/enis/button/btn_ok.gif" width="66" height="20" border="0" name="btn_ok"></td>
			<td class="p_bt"><img class="cursor" src="/hanjin/img/enis/button/btn_close.gif" width="66" height="20" border="0" name="btn_close"></td></tr>
		</table>
