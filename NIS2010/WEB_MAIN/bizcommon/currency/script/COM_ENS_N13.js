	...
	try {
		...
		case "btn_downexcel":			
			if(mainPage == undefined){                    	
	    		sheetObject1.SpeedDown2Excel(false,false,true,"","",false,false,"",false,"0|1");
	    	} else {
	    		sheetObject1.SpeedDown2Excel(false,false,true,"","",false,false,"",false,"");
            }
		break;
 ...
 */
 function loadPage(mainpage) {
	...
	var formObject = document.form;
	if(!(ComIsNull(formObject.cnt_cd) && ComIsNull(formObject.curr_cd) && ComIsNull(formObject.curr_desc))) {
...
function initSheet(sheetObj, sheetNo) {
	...
	case "sheet1":
		with (sheetObj) {
			...
			var HeadTitle;
            if(mainPage == undefined){
				HeadTitle = "||Seq.|Currency|Country|Description";
            }else{
            	HeadTitle = "Seq.|Currency|Country|Description";
            }
			...
			InitDataProperty(0, cnt++, dtData, 60, daCenter, true, "cnt_cd",false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 200, daLeft, true, "curr_desc",false, "", dfNone, 0, true, true);
