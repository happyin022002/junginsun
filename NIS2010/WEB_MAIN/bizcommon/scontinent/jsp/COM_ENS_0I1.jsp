...
<%@ page import="com.hanjin.bizcommon.scontinent.event.ComEns0I1Event"%>
<%
	ComEns0I1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComEns0I1Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Sub Conti. Name</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
<%} %>	
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="40">Code</td>
					<td width="70"><input type="text" name="conti_cd" style="width:30;ime-mode:disabled" maxlength="2" dataformat="engup"></td>
	
					<td width="40">Name</td>
					<td><input type="text" name="conti_nm" dataformat="engup"></td></tr>
