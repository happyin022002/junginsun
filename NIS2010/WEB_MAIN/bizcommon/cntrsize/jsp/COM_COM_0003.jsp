...
<%@ page import="com.hanjin.bizcommon.cntrsize.event.ComCom0003Event"%>
<%@ page import="com.hanjin.bizcommon.cntrsize.event.ComCom0003EventResponse"%>
<%
	ComCom0003Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	ComCom0003EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	   ...
	   */ 
		...
		*/
		if (serverException != null) {
			...
			eventResponse = (ComCom0003EventResponse)request.getAttribute("EventResponse");
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/alps/ico_t1.gif" width="20" height="12">Container Size Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="12%">Code</td>
					<td width="15%"><input type="text" name="cntr_sz_cd" style="width:30;ime-mode:disabled" maxlength="2" dataformat="engup"></td>
					<!-- 
					...
					<td width="33%"><select style="width:60;">
							<option value="0" selected>40</option>
							 ...
							 -->
					<td>Description</td>
					<td width="15%" colspan="5"><input type="text" name="cntr_sz_desc" style="width:350"></td></tr>
...
<!--
	  ...
	  */
	  with(document.form)
	  {
		<%
		if(event != null){ 
			   String cntr_sz_cd   =event.getCntr_sz_cd();
			   String cntr_sz_desc   =event.getCntr_sz_desc();			   
		%>
		eval("cntr_sz_cd" ).value = "<%= cntr_sz_cd	 %>";
		eval("cntr_sz_desc" ).value = "<%= cntr_sz_desc	 %>";
		<% } %>
	   }
-->
</SCRIPT>
