...
<%@ page import="com.hanjin.bizcommon.daylightsavingtime.event.ComCom0005Event"%>
<%
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">Daylight Saving Time(DST) Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
	<%} %>	
      ...
      <!--biz page (S)-->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="90" >County Code</td>
						<td width="70"><input type="text" name="s_dst_cnt_cd" style="width:70px;text-align:center" maxlength="2" dataformat="engup" id="s_dst_cnt_cd" /> </td>
<%-- 					<%
						if(!"".equals(mdm_yn) && mdm_yn.length() > 0){
					%> --%>
					<td style="text-align: center">DST year</td>
		            <td><input type="text" style="width:100px;text-align:center" name="dst_yr" maxlength="4" id="dst_yr" dataformat="yy"/> </td>
					<td>Status</td>
						<td width="">
