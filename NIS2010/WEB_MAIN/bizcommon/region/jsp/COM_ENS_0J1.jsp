...
<%@ page import="com.hanjin.bizcommon.region.event.ComEns0J1Event"%>
<%
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Region Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
<%} %>		
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					...
					<td width="15%">&nbsp;<input type="text" name="cnt_cd" style="width:25" maxlength="2" dataformat="engup"></td>
					<td width="25%">Region Code</td>
					<td width="35%">&nbsp;<input type="text" name="rgn_cd" style="width:35" maxlength="3" dataformat="engup"></td></tr> 
