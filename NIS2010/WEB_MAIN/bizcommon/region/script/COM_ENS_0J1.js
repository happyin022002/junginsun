...
/* 업무별전역변수는 아래 부분에 추가 선언하여 사용한다. */
     ...
     */
     function loadPage(mainpage) {
        ...
        if(!(ComIsNull(formObject.cnt_cd) && ComIsNull(formObject.rgn_cd))) {
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,      100,    daCenter,  false,   "rgn_cd",        false,          "",       dfNone,     0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,      100,    daLeft,  false,   	 "rgn_nm",    false,          "",       dfNone,     0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,      100,    daCenter,  false,    "cnt_cd",        false,          "",       dfNone,     0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,      0,    daCenter,  false,    "sconti_cd",        false,          "",       dfNone,     0,     false,       true);
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
           ...
           case IBSEARCHAPPEND:  // 페이징 조회
                ...
                sheetObj.DoSearch4Post("COM_ENS_0J1GS.do", selectVal, "iPage=" + PageNo, true);
           break;
