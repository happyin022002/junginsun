...
<%@ page import="com.hanjin.bizcommon.vesselskd.event.ComEns0B1Event"%>
<%@ page import="com.hanjin.bizcommon.vesselskd.event.ComEns0B1EventResponse"%>
<%
ComEns0B1Event  event = null;                //PDTO(Data Transfer Object including Parameters)
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;VVD SKD Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="5%">VVD</td>
					<td><input type="text" name=vvd_cd style="width:100" onKeyUp="javascript:upper(this);"></td>
