...
<%@ page import="com.hanjin.bizcommon.cntrtpsz.event.ComEns0G1Event"%>
<%@ page import="com.hanjin.bizcommon.cntrtpsz.event.ComEns0G1EventResponse"%>
<%
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/alps/ico_t1.gif" width="20" height="12">Container Type Size Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="12%">Code</td>
					<td width="15%"><input type="text" name="cntr_tpsz_cd" style="width:30;ime-mode:disabled" maxlength="2" dataformat="engup"></td>
					<!-- 
					...
					<td width="33%"><select style="width:60;">
							<option value="0" selected>40</option>
							 ...
							 -->
					<td>Description</td>
					<td width="15%" colspan="5"><input type="text" name="cntr_tpsz_desc" style="width:350"></td></tr>
