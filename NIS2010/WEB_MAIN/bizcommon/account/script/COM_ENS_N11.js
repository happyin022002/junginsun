             ...
             case "sheet1" :
 				with (sheetObj) 
 				{
					...
					var headCount = ComCountHeadTitle(HeadTitle1);
                     ...
                     InitDataProperty(0, cnt++ , dtData,		150,	daCenter,	true,		"acct_cd",			false,		"",			dfNone,		0,			true,		true);
                     InitDataProperty(0, cnt++ , dtData,		280,	daLeft,		true,		"acct_eng_nm",		false,		"",			dfNone,		0,			true,		true);
