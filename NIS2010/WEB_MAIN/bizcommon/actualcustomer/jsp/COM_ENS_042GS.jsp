...
<%@ page import="com.hanjin.bizcommon.actualcustomer.event.ComEns042Event"%>
<%@ page import="com.hanjin.bizcommon.actualcustomer.event.ComEns042EventResponse"%>
<%@ page import="com.hanjin.framework.support.controller.html.FormCommand"%>
<%

	ComEns042Event event = null;
