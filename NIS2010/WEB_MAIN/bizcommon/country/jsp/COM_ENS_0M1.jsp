...
<%@ page import="com.hanjin.bizcommon.country.event.ComEns0M1Event"%>
<%
		...
		<table class="search" border="0"> 
			<tr>
				...
				<tr class="h23">
					...
					<td width="120"><%= com.hanjin.bizcommon.util.BizComUtil.getCodeCombo("conti_cd", "", " onchange='javascript:setSubConti();'", "CONTI", 1, "0: :ALL") %></td>
					<td width="100">Sub Continent</td>
					<td width=""><%= com.hanjin.bizcommon.util.BizComUtil.getCodeCombo("sconti_cd", "", "", "SCONTI", 1, "0: :ALL", "conti_cd=''") %></td></tr> 
				
				<tr class="h23">
					<td width="">Country Code</td>
					<td width=""><input type="text" name="cnt_cd" style="width:25" maxlength="2" dataformat="engup" value=''></td>
					<td width="">Name</td>
					<td width=""><input type="text" name="cnt_nm" style="width:115" dataformat="engup" value=''></td></tr> 
