...
document.onclick = processButtonClick;
	        ...
	        switch(srcName) {
	    	    ...
	    	    case "btn2_Down_Excel":	    	    	
	    	    	if(mainPage == undefined){                    	
	    	    		sheetObject.SpeedDown2Excel(false,false,true,"","",false,false,"",false,"0|1|5|7");
	    	    	} else {
	    	    		sheetObject.SpeedDown2Excel(false,false,true,"","",false,false,"",false,"3|5");
	                }
        	        break;
	        } // end switch
	    }catch(e) {            
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle;
                    if(mainPage == undefined){
                    	HeadTitle = "||Seq.|Code|Name|Continent Code|Continent|Sub Continent Code|Sub Continent|EU Country Flag" ;
                    }else{
                    	HeadTitle = "Seq.|Code|Name|Continent Code|Continent|Sub Continent Code|Sub Continent|EU Country Flag" ;
                    }
                    ...
                    if(mainPage == undefined){
                        ...
                        InitDataProperty(0, cnt++ , dtHidden,      	0,  	daCenter,  	false,     	"conti_cd",     false,      "",       		dfNone,     	0,     	false,      true);
                        InitDataProperty(0, cnt++ , dtData,      	90,    	daCenter,  	false,    	"conti_nm",     false,      "",       		dfNone,     	0,     	false,      true);
                        InitDataProperty(0, cnt++ , dtHidden,      	0,   	daCenter,  	false,    	"sconti_cd",    false,      "",       		dfNone,     	0,     	false,      true);
                        InitDataProperty(0, cnt++ , dtData,      	120,   	daCenter,  	false,    	"sconti_nm",    false,      "",       		dfNone,     	0,     	false,      true);
                        InitDataProperty(0, cnt++ , dtData,      	100,   	daCenter,  	false,    	"eu_cnt_flg",    false,      "",       		dfNone,     	0,     	false,      true);
                    } else {
	                    InitDataProperty(0, cnt++ , dtSeq,       	30,    	daCenter,  	false,    	"seq",          false,      "",       		dfNone,   		0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtData,      	100,    	daCenter,  	false,    	"cnt_cd",       false,      "",       		dfNone,     	0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtData,      	200,   	daLeft,  	false,      "cnt_nm",    	false,      "",       		dfNone,     	0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtHidden,      	0,  	daCenter,  	false,     	"conti_cd",     false,      "",       		dfNone,     	0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtData,      	250,    	daCenter,  	false,    	"conti_nm",     false,      "",       		dfNone,     	0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtHidden,      	0,   	daCenter,  	false,    	"sconti_cd",    false,      "",       		dfNone,     	0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtData,      	250,   	daCenter,  	false,    	"sconti_nm",    false,      "",       		dfNone,     	0,     	false,      true);
	                    InitDataProperty(0, cnt++ , dtData,      	100,   	daCenter,  	false,    	"eu_cnt_flg",    false,      "",       		dfNone,     	0,     	false,      true);
                    }
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch4Post("COM_ENS_0M1GS.do", selectVal);               
    ...
    */
    ...
    function setSubConti(){
        var formObject = document.form;
        formObject.conti_cd.value = formObject.conti_cd.value;
        formObject.target="iframe_bizcom";
 		formObject.action="/hanjin/bizcommon/common/COM_ENS_COMMON.jsp";
