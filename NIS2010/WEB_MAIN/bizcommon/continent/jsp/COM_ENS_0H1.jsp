...
<%@ page import="com.hanjin.bizcommon.continent.event.ComEns0H1Event"%>
<% 
	ComEns0H1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComEns0H1Event)request.getAttribute("Event");
		/* 
...
<html>
<head>
<title>Continent Code Inquiry</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Continent Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
	<%} %>	
