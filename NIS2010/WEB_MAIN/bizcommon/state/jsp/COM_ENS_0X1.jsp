...
<%@ page import="com.hanjin.bizcommon.state.event.ComEns0X1Event"%>
<%@ page import="com.hanjin.bizcommon.state.event.ComEns0X1EventResponse"%>
<% 
	ComEns0X1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	ComEns0X1EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	Exception serverException   = null;			//서버에서 발생한 에러
	DBRowSet rowSet	  = null;							   //DB ResultSet
	String strErrMsg = "";								 //에러메세지
	int rowCount	 = 0;	
	String cntCd ="";//DB ResultSet 리스트의 건수
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComEns0X1Event)request.getAttribute("Event");
		/* 
		...
		*/
		if (serverException != null) {
			...
			eventResponse = (ComEns0X1EventResponse)request.getAttribute("EventResponse");
