...
<%@ page import="com.hanjin.bizcommon.state.event.ComEns0V1Event"%>
<%@ page import="com.hanjin.bizcommon.state.event.ComEns0V1EventResponse"%>
<% 
	ComEns0V1Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	ComEns0V1EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	...
	try {
	   ...
	   */ 
		...
		*/
		event = (ComEns0V1Event)request.getAttribute("Event");
		/* 
		...
		*/
		if (serverException != null) {
			...
			eventResponse = (ComEns0V1EventResponse)request.getAttribute("EventResponse");
...
<script language="javascript" src="/hanjin/bizcommon/state/script/COM_ENS_0T1.js"></script>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/enis/ico_t1.gif" width="20" height="12">State Code Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
