...
<%@ page import="com.hanjin.bizcommon.state.event.ComEns0W1Event"%>
<%@ page import="com.hanjin.bizcommon.state.event.ComEns0W1EventResponse"%>
<% 
...
<script language="javascript" src="/hanjin/bizcommon/state/script/COM_ENS_0W1.js"></script>
