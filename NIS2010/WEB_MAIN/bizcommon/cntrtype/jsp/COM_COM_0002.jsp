...
<%@ page import="com.hanjin.bizcommon.cntrtype.event.ComCom0002Event"%>
<%@ page import="com.hanjin.bizcommon.cntrtype.event.ComCom0002EventResponse"%>
<%
	ComCom0002Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	ComCom0002EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	   ...
	   */ 
		...
		*/
		if (serverException != null) {
			...
			eventResponse = (ComCom0002EventResponse)request.getAttribute("EventResponse");
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/alps/ico_t1.gif" width="20" height="12">Container Type Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
			<tr>
				...
				<tr class="h23">
					<td width="12%">Code</td>
					<td width="15%"><input type="text" name="cntr_tp_cd" style="width:30;ime-mode:disabled" maxlength="2" dataformat="engup"></td>
					<!-- 
					<td width="12%">Character</td>
					<td width="18%"><select style="width:60;">
							<option value="0" selected>E</option>
							</select></td>
					<td width="10%">E/Q Size</td>
					<td width="33%"><select style="width:60;">
							<option value="0" selected>40</option>
							</select></td>
							 -->
					<td>Description</td>
					<td width="15%" colspan="5"><input type="text" name="cntr_tp_desc" style="width:350"></td></tr>
...
<!--
	  ...
	  */
	  with(document.form)
	  {
		<%
		if(event != null){ 
			   String cntr_tp_cd   =event.getCntr_tp_cd();
			   String cntr_tp_desc   =event.getCntr_tp_desc();			   
		%>
		eval("cntr_tp_cd" ).value = "<%= cntr_tp_cd	 %>";
		eval("cntr_tp_desc" ).value = "<%= cntr_tp_desc	 %>";
		<% } %>
	   }
-->
</SCRIPT>
