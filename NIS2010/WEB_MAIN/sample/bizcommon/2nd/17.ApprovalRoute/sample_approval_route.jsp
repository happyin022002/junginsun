...
<script language="JavaScript" src="/hanjin/js/CoPopup.js"></script>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          ...
          <tr>
            ...
            <td colspan=3 width="520" bgcolor="#EFEFEF">
			  <input name="apro_step" type="text" size="50" value="<%=com.hanjin.bizcommon.approval.util.ApprovalUtil.getApprovalRoute("SELHO", "AGT") %>">
          ...
          <tr>  
            ...
            <td>
              <%= com.hanjin.bizcommon.util.BizComUtil.getCodeCombo("sub_sys_cd", "", "", "SUBSYS", 1, "") %>
...
comOpenPopup('/hanjin/COM_ENS_0T1.do' + param, 620, 450, 'getCOM_ENS_0T1_1', '0,0', false, false, "", "", 0);
            	</pre>
            </td>
          </tr>
        </table>
