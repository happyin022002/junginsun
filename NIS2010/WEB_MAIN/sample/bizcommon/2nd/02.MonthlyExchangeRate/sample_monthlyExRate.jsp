...
<script language="javascript" src="sample_monthlyExRate.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>02. Monthly Exchange Rate (COM_ENS_0E1)</b> </th>
          </tr>
          <tr>
            ...
            <td width="550" bgcolor="#EFEFEF">
              <input name="frYearMon" type="text" size="10" maxlength="6" style="height:22">~<input name="toYearMon" type="text" size="10" maxlength="6" style="height:22"><br>
              <%= BizComUtil.getCodeCombo("curr_cd", "", "", "CURR", 2, "0: :ALL") %>
			  <br>
              ...
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1,1,1,1" style="height:22">
...
ComOpenPopup('/hanjin/COM_ENS_0E1.do' + param, 620, 450, 'getCOM_ENS_0E1_1', '0,0', false, false, "", "", 0);
            	</pre>
            </td>
          </tr>
        </table>
