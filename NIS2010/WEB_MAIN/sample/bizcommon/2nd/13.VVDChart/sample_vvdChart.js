            ...
            case "vvdchart_btn":         
            	...
            	{    	    
                    ...
                    // scnr_id : 시나리오 ID, depth : 3(Trade), 2(Lane), 3(VVD)
      				...
      				ComOpenPopupWithTarget('/hanjin/COM_ENS_0P1.do' + param, 400, 470, "trade:trade|lane:lane|vvd:vvd", v_display, true);
      				//ComOpenPopup('/hanjin/COM_ENS_0P1.do' + param, 400, 480, 'getCOM_ENS_0G1_2', v_display, true);
            	}
                break;
        }
    }
