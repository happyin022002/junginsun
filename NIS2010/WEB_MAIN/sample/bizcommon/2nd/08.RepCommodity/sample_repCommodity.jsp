...
<script language="javascript" src="sample_repCommodity.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>08. Rep Commodity (COM_ENS_0K1)</b> </th>
          </tr>
          <tr>
            <td width="100" class="cont">입력</td>
            <td width="180" class="title">
            	Rep Commodity Code:<br> 
            	Rep Commodity Name:<br>
            	Display Option:
            </td>
            <td width="520" bgcolor="#EFEFEF">
              <input name="rep_cmdt_cd" type="text" size="10" maxlength=6 style="height:22" readonly><br>
              <input name="rep_cmdt_nm" type="text" size="10" maxlength=6 style="height:22" readonly><br>
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1" style="height:22">
              <input name="rep_cmdt_btn" type="button" class="button" value="클릭">
...
ComOpenPopup('/hanjin/COM_ENS_0K1.do' + param, 620, 430, 'getCOM_ENS_0K1_1', '0,0', false, false, "", "", 0);

ComOpenPopupWithTarget('/hanjin/COM_ENS_0K1.do' + param, 505, 430, "3:rep_cmdt_cd|4:rep_cmdt_nm", v_display, true);
            	</pre>
            </td>
          </tr>
        </table>
