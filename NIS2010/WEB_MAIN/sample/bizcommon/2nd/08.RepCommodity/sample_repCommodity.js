            ...
            case "rep_cmdt_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	...
        		    	ComOpenPopup('/hanjin/COM_ENS_0K1.do' + param, 505, 430, 'getCOM_ENS_0K1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0K1.do' + param, 505, 430, 'getCOM_ENS_0K1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
...
function getCOM_ENS_0K1_1(rowArray) {
	...
	document.all.rep_cmdt_cd.value = colArray[3];
	document.all.rep_cmdt_nm.value = colArray[4];
}
...
function getCOM_ENS_0K1_2(rowArray) {
	...
	for(var i=0; i<rowArray.length; i++)
	{
		...
		colArray = rowArray[i];
		document.all.rep_cmdt_cd.value += colArray[3] + gubun;
	    document.all.rep_cmdt_nm.value += colArray[4] + gubun;
	}
}
