            ...
            case "cntr_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	...
        		    	ComOpenPopup('/hanjin/COM_ENS_0G1.do' + param, 620, 480, 'getCOM_ENS_0G1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0G1.do' + param, 620, 480, 'getCOM_ENS_0G1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
