...
<script language="javascript" src="sample_cntrTpSz.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>04. Container Type&Size (COM_ENS_0G1)</b> </th>
          </tr>
          <tr>
            ...
            <td width="550" bgcolor="#EFEFEF">
              <input name="cntr_tpsz_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="cntr_tpsz_desc" type="text" size="50" style="height:22"><br>
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1" style="height:22">
              <input name="cntr_btn" type="button" class="button" value="클릭">
...
ComOpenPopup('/hanjin/COM_ENS_0G1.do' + param, 620, 480, 'getCOM_ENS_0G1_1', v_display, true);

ComOpenPopupWithTarget('/hanjin/COM_ENS_0G1.do' + param, 620, 480, "3:cntr_tpsz_cd|4:cntr_tpsz_desc", v_display, true);
    ...
    <tr>
    	<td>
    		...
    		- Container Type/Size <%= com.hanjin.bizcommon.util.BizComUtil.getCodeCombo("cntr_tpsz_cd2", "", "", "CNTRTPSZ", 1, "0: :ALL") %>
    	</td>
    </tr>
  </table>
</form>
