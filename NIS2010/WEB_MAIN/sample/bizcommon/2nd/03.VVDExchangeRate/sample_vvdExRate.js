            ...
            case "exrate_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	...
        		    	ComOpenPopup('/hanjin/COM_ENS_0F1.do' + param, 775, 410, 'getCOM_ENS_0F1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0F1.do' + param, 775, 410, 'getCOM_ENS_0F1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
