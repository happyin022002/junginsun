        ...
        switch(srcName) {
            case "conti_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopupWithTarget('/hanjin/COM_ENS_0H1.do' + param, 305, 380, "3:conti_cd|4:conti_nm", v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0H1.do' + param, 305, 380, 'getCOM_ENS_0H1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0H1.do' + param, 305, 380, 'getCOM_ENS_0H1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
