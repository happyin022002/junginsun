...
<%@ page import="com.hanjin.framework.component.fax.FaxMetaInfo"%>
<%@ page import="com.hanjin.framework.component.fax.FaxUtility"%>
...
<script language="JavaScript" src="/hanjin/script/CoMessage_ko_KR.js"></script>
<script language="JavaScript" src="/hanjin/script/CoFormControl.js"></script>
<script language="JavaScript" src="/hanjin/script/CoPop.js"></script>
<script language="javascript" src="PopupSample.js"></script>
<SCRIPT LANGUAGE="javascript" SRC="/hanjin/script/CoCalendar.js" TYPE="text/javascript"></SCRIPT>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          ...
          <tr>
            ...
            <td width="550" bgcolor="#EFEFEF">
              <%= com.hanjin.bizcommon.util.BizComUtil.getCodeCombo("sub_sys_cd", "", "", "SUBSYS", 1, "") %><br>
