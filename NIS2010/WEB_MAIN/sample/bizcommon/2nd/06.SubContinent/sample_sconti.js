            ...
            case "sconti_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	...
        		    	ComOpenPopup('/hanjin/COM_ENS_0I1.do' + param, 405, 410, 'getCOM_ENS_0I1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
...
function getCOM_ENS_0I1_1(rowArray) {
	...
	document.all.sconti_cd.value = colArray[3];
	document.all.sconti_nm.value = colArray[4];
}
...
function getCOM_ENS_0I1_2(rowArray) {
	...
	for(var i=0; i<rowArray.length; i++)
	{
		...
		colArray = rowArray[i];
		document.all.sconti_cd.value += colArray[3] + gubun;
    	document.all.sconti_nm.value += colArray[4] + gubun;
	}
}
