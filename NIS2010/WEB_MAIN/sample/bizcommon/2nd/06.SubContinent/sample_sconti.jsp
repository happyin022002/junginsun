...
<script language="javascript" src="sample_sconti.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>06. Sub Continent (COM_ENS_0I1)</b> </th>
          </tr>
          <tr>
            <td width="100" class="cont">입력</td>
            <td width="150" class="title">
            	Sub Continent Code:<br> 
            	Sub Continent Name:<br>       	
            	Display Option:
            </td>
            <td width="550" bgcolor="#EFEFEF">
              <input name="sconti_cd" type="text" size="10" maxlength=6 style="height:22" readonly><br>
              <input name="sconti_nm" type="text" size="10" maxlength=6 style="height:22" readonly><br>
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1" style="height:22">
              <input name="sconti_btn" type="button" class="button" value="클릭">
...
ComOpenPopupWithTarget('/hanjin/COM_ENS_0I1.do' + param, 405, 410, "3:sconti_cd|4:sconti_nm", v_display, true);

ComOpenPopup('/hanjin/COM_ENS_0I1.do' + param, 405, 410, 'getCOM_ENS_0I1_2', v_display, true);
            	</pre>
            </td>
          </tr>
        </table>
