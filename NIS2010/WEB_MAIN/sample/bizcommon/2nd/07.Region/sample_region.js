            ...
            case "rgn_btn":         
            	...
            	{    	    
        		    ...
        		    if(chkStr == "1,0") {
        		    	...
        		    	ComOpenPopup('/hanjin/COM_ENS_0J1.do' + param, 525, 430, 'getCOM_ENS_0J1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0J1.do' + param, 525, 430, 'getCOM_ENS_0J1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
