...
<script language="javascript" src="sample_region.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>07. Region (COM_ENS_0J1)</b> </th>
          </tr>
          <tr>
            ...
            <td width="550" bgcolor="#EFEFEF">
              ...
              <input name="rgn_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="rgn_nm" type="text" size="10" maxlength=6 style="height:22" readonly><br>
...
ComOpenPopup('/hanjin/COM_ENS_0J1.do' + param, 525, 430, 'getCOM_ENS_0J1_1', '0,0', false, false, "", "", 0);

ComOpenPopupWithTarget('/hanjin/COM_ENS_0J1.do' + param, 525, 430, "5:cnt_cd|3:rgn_cd|4:rgn_nm", v_display, true);
            	</pre>
            </td>
          </tr>
        </table>
