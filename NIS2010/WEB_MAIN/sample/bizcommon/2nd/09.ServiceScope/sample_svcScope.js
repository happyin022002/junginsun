    ...
    try {
        switch(srcName) {
            case "svc_scp_btn":         
            	...
            	{    	    
            	    var v_svc_scp_cd = svc_scp_cd.value;
            	    var v_svc_scp_nm = svc_scp_nm.value;
        		    ...
        		    if(chkStr == "1,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0L1.do' + param, 420, 420, 'getCOM_ENS_0L1_1', v_display, true);
        		    } else if(chkStr == "0,1") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0L1.do' + param, 420, 420, 'getCOM_ENS_0L1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0L1.do' + param, 420, 420, 'getCOM_ENS_0L1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
...
function getCOM_ENS_0L1_2(rowArray) {
	...
	for(var i=0; i<rowArray.length; i++)
	{
		...
		colArray = rowArray[i];
		document.all.svc_scp_cd.value += colArray[3] + gubun;
	    document.all.svc_scp_nm.value += colArray[4] + gubun;
	}
}
