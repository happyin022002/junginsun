...
<script language="javascript" src="sample_svcScope.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>09. Service Scope (COM_ENS_0L1)</b> </th>
          </tr>
          <tr>
            <td width="100" class="cont">입력</td>
            <td width="180" class="title">
            	Service Scope Code:<br> 
            	Service Scope Name:<br>
            	Display Option:
            </td>
            <td width="520" bgcolor="#EFEFEF">
              <input name="svc_scp_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="svc_scp_nm" type="text" size="10" maxlength=6 style="height:22" readonly><br>
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1" style="height:22">
              <input name="svc_scp_btn" type="button" class="button" value="클릭">
...
ComOpenPopup('/hanjin/COM_ENS_0L1.do' + param, 620, 420, 'getCOM_ENS_0L1_1', '0,0', false, false, "", "", 0);
            	</pre>
            </td>
          </tr>
        </table>
