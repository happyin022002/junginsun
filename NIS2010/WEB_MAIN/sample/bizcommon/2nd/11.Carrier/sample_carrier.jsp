...
<script language="javascript" src="sample_carrier.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>11. Carrier (COM_ENS_0N1)</b> </th>
          </tr>
          <tr>
            ...
            <td width="520" bgcolor="#EFEFEF">
              <input name="crr_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="crr_nm" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1" style="height:22">
              <input name="carr_btn" type="button" class="button" value="클릭">
...
ComOpenPopup('/hanjin/COM_ENS_0N1.do' + param, 420, 430, 'getCOM_ENS_0N1_1', v_display, true);

ComOpenPopupWithTarget('/hanjin/COM_ENS_0N1.do' + param, 420, 430, "3:crr_cd|4:crr_nm", v_display, true);
            	</pre>
            </td>
          </tr>
        </table>
