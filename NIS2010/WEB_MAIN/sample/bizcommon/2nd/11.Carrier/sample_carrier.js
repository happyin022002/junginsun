    ...
    try {
        switch(srcName) {
            case "carr_btn":         
            	...
            	{    	    
            	    var v_crr_cd = crr_cd.value;
            	    var v_crr_nm = crr_nm.value;
            	    var classId = "COM_ENS_0N1";
        		    var param = '?crr_cd='+v_crr_cd+'&crr_nm='+v_crr_nm+'&classId='+classId;
        		    ...
        		    if(chkStr == "1,0") {
        		    	...
        		    	ComOpenPopup('/hanjin/COM_ENS_0N1.do' + param, 420, 430, 'getCOM_ENS_0N1_2', v_display, true);
        		    } else if(chkStr == "0,0") {
        		    	ComOpenPopup('/hanjin/COM_ENS_0N1.do' + param, 420, 430, 'getCOM_ENS_0N1_3', v_display, true);
        		    } else if(chkStr == "1,1"){
...
function getCOM_ENS_0N1_1(rowArray) {
	...
	document.all.crr_nm.value = colArray[4];
}
...
function getCOM_ENS_0N1_2(rowArray) {
	...
	for(var i=0; i<rowArray.length; i++)
	{
	    ...
	    document.all.crr_nm.value += colArray[4] + gubun;
	}
}
