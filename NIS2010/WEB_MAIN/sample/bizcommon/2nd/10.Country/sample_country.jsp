...
<script language="javascript" src="sample_country.js"></script>
    ...
    <tr>
      <td valign="top" height="475">       
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          <tr>
          <th colspan="4"><b>11. Country (COM_ENS_0M1)</b> </th>
          </tr>
          <tr>
            ...
            <td width="520" bgcolor="#EFEFEF">
              <input name="conti_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="sconti_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="cnt_cd" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="cnt_nm" type="text" size="10" maxlength=6 style="height:22"><br>
              <input name="dispaly" type="text" size="20" maxlength="13" value="1,0,1,1,1,1,1" style="height:22">
...
ComOpenPopup('/hanjin/COM_ENS_0M1.do' + param, 565, 450, 'getCOM_ENS_0M1_2', v_display, true);

ComOpenPopupWithTarget('/hanjin/COM_ENS_0M1.do' + param, 565, 450, "5:conti_cd|6:sconti_cd|3:cnt_cd|4:cnt_nm", v_display, true);
            	</pre>
            </td>
          </tr>
        </table>
