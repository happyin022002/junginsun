    ...
    switch(sheetNo) {
        case 1:      //IBSheet1 init
            with (sheetObj) {
                ...
                var HeadTitle = "Del.|STS|Seq.|Port|Hub Location|Location|Mode|Office|Creation DT|Update DT" ;
                ...
                InitDataProperty(0, cnt++ , dtPopupEdit,  60,    daCenter,  false,    "pop1",     true,       "",       dfNone,	0,     true,       true);
                InitDataProperty(0, cnt++ , dtPopupEdit,  90,    daCenter,  false,    "pop2",     true,       "",       dfNone,   	0,     true,       true);
                InitDataProperty(0, cnt++ , dtPopupEdit,  70,    daCenter,  false,    "pop3",     true,       "",       dfNone,   	0,     true,       true);
...
{   
    if ( sheetObj.ColSaveName(col) == "pop1" )
    {
        ...
        // Radio PopUp  
        if(chkStr == "1,0") {
           comPopupInSheet('/hanjin/COM_ENS_051.do' + param, 770, 470, 'getCOM_ENS_051_1', dispaly, row, col);
       
        // CheckBox PopUp (멀티 데이터 선택용) => Sheet를 대상으로 하는 경우는 의미가 없음
        //} else if(chkStr == "0,1") {
            //comPopupInSheet('/hanjin/COM_ENS_051.do' + param, 770, 470, 'getCOM_ENS_051_2', dispaly, sheetIdx, row, col);
           
        // Row 선택 PopUp
        } else if(chkStr == "0,0") {
           comPopupInSheet('/hanjin/COM_ENS_051.do' + param, 770, 470, 'getCOM_ENS_051_3', dispaly, row, col);
        } else if(chkStr == "1,1"){
