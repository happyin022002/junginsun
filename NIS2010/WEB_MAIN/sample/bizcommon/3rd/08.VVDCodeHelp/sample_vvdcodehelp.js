    ...
    try {
        switch(srcName) {
            case "cnt_btn":         
    		    ...
    		    if(chkStr == "1,0") {
    		    	ComOpenPopupWithTarget('/hanjin/VOP_VSK_0230.do?classId=VOP_VSK_0230', 305, 400, 'vsl_cd:vsl_cd|skd_voy_no:skd_voy_no|skd_dir_cd:skd_dir_cd|vps_eta_dt:vps_eta_dt', v_display + ',1', true);
    		    } else if(chkStr == "0,1") {
    		    	ComOpenPopup('/hanjin/VOP_VSK_0230.do?classId=VOP_VSK_0230', 305, 400, 'getVOP_VSK_0230', v_display + ',1', true);
    		    } else if(chkStr == "0,0") {
    		    	ComOpenPopupWithTarget('/hanjin/VOP_VSK_0230.do?classId=VOP_VSK_0230', 305, 400, 'vsl_cd:vsl_cd|skd_voy_no:skd_voy_no|skd_dir_cd:skd_dir_cd|vps_eta_dt:vps_eta_dt', v_display + ',1', true);
    		    } else if(chkStr == "1,1"){
