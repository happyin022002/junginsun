      ...
      <td valign="top" height="475">       
		...
		<tr>
            ...
            <td bgcolor="#FFFFFF" align="left" colspan="4">
            	<pre> 
ComOpenPopupWithTarget('/hanjin/VOP_VSK_0043.do?classId=VOP_VSK_0043', 430, 500, 'loc_cd:loc_cd|loc_nm:loc_nm', v_display + ',1', true);

ComOpenPopup('/hanjin/VOP_VSK_0043.do?classId=VOP_VSK_0043', 430, 500, 'getVOP_VSK_0043', v_display + ',1', true);
            	</pre>
            </td>
          </tr>
        </table>
