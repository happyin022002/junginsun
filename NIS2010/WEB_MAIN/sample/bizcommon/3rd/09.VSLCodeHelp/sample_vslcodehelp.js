    ...
    try {
        switch(srcName) {
            case "cnt_btn":         
    		    ...
    		    if(chkStr == "1,0") {
    		    	ComOpenPopupWithTarget('/hanjin/VOP_VSK_0219.do?classId=VOP_VSK_0219', 465, 480, 'vsl_cd:vsl_cd|vsl_eng_nm:vsl_eng_nm|crr_cd:crr_cd', v_display + ',1', true);
    		    } else if(chkStr == "0,1") {
    		    	ComOpenPopup('/hanjin/VOP_VSK_0219.do?classId=VOP_VSK_0219', 465, 480, 'getVOP_VSK_0219', v_display + ',1', true);
    		    } else if(chkStr == "0,0") {
    		    	ComOpenPopupWithTarget('/hanjin/VOP_VSK_0219.do?classId=VOP_VSK_0219', 465, 480, 'vsl_cd:vsl_cd|vsl_eng_nm:vsl_eng_nm|crr_cd:crr_cd', v_display + ',1', true);
    		    } else if(chkStr == "1,1"){
 ...
 */
function getVOP_VSK_0219(rowArray) {
