      ...
      <td valign="top" height="475">       
		...
		<tr>
            ...
            <td bgcolor="#FFFFFF" align="left" colspan="4">
            	<pre> 
ComOpenPopupWithTarget('/hanjin/UI_CTM_0435.do?classId=UI_CTM_0435&' + param, 630, 410, 'vndr_seq:vndr_seq|ofc_cd:ofc_cd|vndr_lgl_eng_nm:vndr_lgl_eng_nm|eng_addr:eng_addr', v_display + ',1', true);
            	</pre>
            </td>
          </tr>
        </table>
