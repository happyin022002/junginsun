    ...
    try {
        switch(srcName) {
            case "orgchart_btn":         
    		    ...
    		    if(chkStr == "1,0") {
    		    	ComOpenPopupWithTarget('/hanjin/COM_ENS_N13.do?classId=COM_ENS_N13&' + param, 500, 420, sTargetObjList, sDisplay, true);
    		    } else if(chkStr == "0,1") {
    		    	ComOpenPopupWithTarget('/hanjin/COM_ENS_N13.do?classId=COM_ENS_N13&' + param, 500, 420, sTargetObjList, sDisplay, true);
    		    } else if(chkStr == "0,0") {
    		    	ComOpenPopup('/hanjin/COM_ENS_N13.do?classId=COM_ENS_N13&' + param, 500, 420, 'getCOM_ENS_N13', sDisplay + ',1', true);
    		    } else if(chkStr == "1,1"){
