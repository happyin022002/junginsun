        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#D0B0AC">
          ...
          <tr>
            <td bgcolor="#FFFFFF" align="left" colspan="4">
            	<pre>
(사용예제)
ComOpenPopupWithTarget('/hanjin/COM_ENS_N13.do?classId=COM_ENS_N13&' + param, 500, 380, sTargetObjList, sDisplay, true);

ComOpenPopup('/hanjin/COM_ENS_N13.do?classId=COM_ENS_N13&' + param, 500, 380, 'getCOM_ENS_N13', sDisplay + ',1', true);
            	</pre>
            </td>
          </tr>
        </table>
