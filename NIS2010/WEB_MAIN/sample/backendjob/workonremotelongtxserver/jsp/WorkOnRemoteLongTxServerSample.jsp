...
<%@ page import="com.hanjin.sample.backendjob.workonremotelongtxserver.event.WorkOnRemoteLongTxServerSampleEvent"%>
...
MDM_VANDOR Table을 전체 조회 한 후 전체 로우 수를 가져오는 Remote on Long TX Server Job 수행
<p>
<!--Button (S) -->
