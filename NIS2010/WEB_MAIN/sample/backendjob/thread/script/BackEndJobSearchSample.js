...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBBATCH: //job
		if (sheetObj.id == "sheet1") {
			...
			var sXml = sheetObj.GetSearchXml("BackEndJobGS.do",
...
function getBackEndJobStatus() {
	...
	var sXml = sheetObject1.GetSearchXml("BackEndJobGS.do",
			FormQueryString(form));
...
function getBackEndJobLoadFile() {
	...
	ComOpenWait(false);
	var sXml = sheetObject1.GetSearchXml("BackEndJobGS.do", FormQueryString(form));
