...
<%@ page import="com.hanjin.sample.groupwarepopup.groupwarepopup.event.GroupwarePopupEvent"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.GroupwarePopup.GroupwarePopup");
