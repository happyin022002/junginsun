...
<%@ page import="com.hanjin.sample.file.exceldownloadusingrowset.event.ExceldownloadusingrowsetEvent"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.File.ExcelDownloadUsingRowset");
...
<body>
<form name="form" action="/hanjin/ExcelDownloadUsingRowsetGS.do">
