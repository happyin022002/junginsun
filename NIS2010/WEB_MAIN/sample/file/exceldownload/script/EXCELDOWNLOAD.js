 ...
 * @author 한진해운
 */
// sheet1ect에 대한 배열화를 한다.
/**
 * @extends
 * @class EXCELDOWNLOAD : EXCELDOWNLOAD 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function EXCELDOWNLOAD() {
	this.processButtonClick = tprocessButtonClick;
	this.setsheet1ect = setsheet1ect;
	...
	case "sheet1":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtHiddenStatus, 30, daCenter, false,
					"ibflag");
			InitDataProperty(0, cnt++, dtCheckBox, 50, daCenter, true,
					"thread_kill");
			InitDataProperty(0, cnt++, dtData, 200, daCenter, true, "jb_id",
					false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "thd_id",
					false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 250, daCenter, true, "jb_msg",
					false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 100, daCenter, true,
					"jb_sts_flg", false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 100, daCenter, true,
					"upd_usr_id", false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "upd_dt",
					false, "", dfNone, 0, true, true);
