...
<%@ page import="com.hanjin.sample.reportdesigner.withfiles.event.ComSampleRdWithFileEvent"%>
...
<%
	...
	String strUsr_id = "";
	String strUsr_nm = "";
	Logger log = Logger.getLogger("com.hanjin.apps.ReportDesigner.WithFiles");
