...
<%@ page import="com.hanjin.syscommon.common.menu.MenuBean" %>
<%@ page import="com.hanjin.syscommon.common.menu.MenuProcessor" %>
<%@ page import="com.hanjin.syscommon.common.menu.MenuEventResponse" %>
<%
	//String strErrMsg="";
	//Exception piEx=null;
	String userName = "";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:0;">
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="id">
			<tr>
				<td width="263" style="padding-left:5"><img src="img/new_sub/title.gif" width="263" height="25" alt="" border="0"></td>
