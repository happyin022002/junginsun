	...
	function func_test(sName, bHideLogic) {
	    ...
	    if (tab1.TabText(tab1.selectedIndex)=="String") {
	        helpurl.href = "http://nis2010.hanjin.com/jsdoc/" + tab1.TabText(tab1.selectedIndex) +".html#" + sName;
	        ...
	        if (!bHideLogic) {
	            if (tab1.TabText(tab1.selectedIndex)=="CoCommon2") {
	                helpurl.href = "http://nis2010.hanjin.com/jsdoc/" + tab1.TabText(tab1.selectedIndex-1) +".html#" + sName;
	            } else {
	                helpurl.href = "http://nis2010.hanjin.com/jsdoc/" + tab1.TabText(tab1.selectedIndex) +".html#" + sName;
	            }
	    ...
	    switch(sName) {
	        ...
	        case "ComOpenWindow":
	            MsgAdd("1.Modal로 열기");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", "myWin", "dialogWidth:383px; dialogHeight:161px", true) ==> ' + ComOpenWindow("/hanjin/img/waiting.gif", "myWin", "dialogWidth:383px; dialogHeight:161px",true));
	            MsgAdd("2.Modaless로 열기");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", "myWin", "toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable=no,alwaysRaised,dependent,titlebar=no,width=383,height=161") ==> '
	            + ComOpenWindow("/hanjin/img/waiting.gif", "myWin", "toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable=no,alwaysRaised,dependent,titlebar=no,width=383,height=161"));
	            break;
	        case "ComOpenWindowCenter":
	            MsgAdd("1.Modal로 열기");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", "myWin", 343,121, true) ==> ' + ComOpenWindowCenter("/hanjin/img/waiting.gif", "myWin", 383,161,true));
	            MsgAdd("2.Modaless로 열기");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", "myWin", 343,121) 		==> ' + ComOpenWindowCenter("/hanjin/img/waiting.gif", "myWin", 383,161));
	            break;
	        case "ComOpenPopup":
	            MsgAdd("1.에러만들기");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", 800, 400, "popupFinish", "1,1,1,1,1,1,1,1")       ==> ' + ComOpenPopup("/hanjin/img/waiting.gif", 800, 400, "popupFinish", "1,1,1,1,1,1,1,1"));
	            MsgAdd("2.Modal로 열기 - 팝업이 닫히면서 popupFinish 함수가 호출되어야 함");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", 800, 400, "popupFinish", "1,0,1,1,1,1,1,1", true) ==> ' + ComOpenPopup("/hanjin/img/waiting.gif", 800, 400, "popupFinish", "1,0,1,1,1,1,1,1", true));
	            MsgAdd("3.Modaless로 열기- 팝업이 닫히면서 popupFinish 함수가 호출되어야 함");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", 800, 400, "popupFinish", "1,0,1,1,1,1,1,1")       ==> ' + ComOpenPopup("/hanjin/img/waiting.gif", 800, 400, "popupFinish", "1,0,1,1,1,1,1,1"));
	            break;
	        case "ComOpenPopupWithTarget":
	            MsgAdd("1.에러만들기");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", 400, 200, "loc_dpth_cd:sltStatus|loc_cd:txtLocation", "1,1", false) ==> ' + ComOpenPopupWithTarget("/hanjin/img/waiting.gif", 400, 200, "loc_dpth_cd:sltStatus|loc_cd:txtLocation", "1,1", false));
	            MsgAdd("2.Modal로 열기 - 팝업이 닫히면서 opener.sltStatus=loc_dpth_cd, opener.txtLocation=loc_cd 설정해야 한다.");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", 400, 200, "loc_dpth_cd:sltStatus|loc_cd:txtLocation", "0,1", true)  ==> ' + ComOpenPopupWithTarget("/hanjin/img/waiting.gif", 400, 200, "loc_dpth_cd:sltStatus|loc_cd:txtLocation", "0,1", true));
	            MsgAdd("3.Modaless로 열기- 팝업이 닫히면서 opener.sltStatus=loc_dpth_cd, opener.txtLocation=loc_cd 설정해야 한다.");
	            MsgAdd(sName + '("/hanjin/img/waiting.gif", 400, 200, "loc_dpth_cd:sltStatus|loc_cd:txtLocation", "0,1", false) ==> ' + ComOpenPopupWithTarget("/hanjin/img/waiting.gif", 400, 200, "loc_dpth_cd:sltStatus|loc_cd:txtLocation", "0,1", false));
	            break;
	        case "ComChkValid":
