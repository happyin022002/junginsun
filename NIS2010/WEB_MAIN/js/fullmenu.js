...
var LowSubBgColor='#696969';	// Background color when mouse is not over on subs
var HighBgColor='#696969';	// Background color when mouse is over
var HighSubBgColor='#696969';	// Background color when mouse is over on subs
var FontLowColor='#FFFFFF';	// Font color when mouse is not over
var FontSubLowColor='#FFFFFF';	// Font color subs when mouse is not over
var FontHighColor='#FC5F00';	// Font color when mouse is over
var FontSubHighColor='#FC5F00';	// Font color subs when mouse is over
var BorderColor='#264541';	// Border color
var BorderSubColor='#264541';	// Border color for subs
...
var Arrws=['/hanjin/img/img_fullmenu_arrow_11.gif',7,5,'tridown.gif',10,5,'trileft.gif',5,10];	// Arrow source, width and height
...
function GoTo(){
	if(this.LinkTxt){
		...
		LowItem(HP);
		this.LinkTxt.indexOf('javascript:')!=-1?eval(this.LinkTxt):parent.document.getElementById("main").src=this.LinkTxt}}
