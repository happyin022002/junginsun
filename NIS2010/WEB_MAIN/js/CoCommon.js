...
'서브  시스템 : 공통자바스크립트
'프로그램 ID  : CoCommon.js
'프로그램 명  : 업무에서 공통으로 사용할 자바스크립트
'프로그램개요 : 업무에서 공통으로 사용할 자바스크립트
'작   성   자 : 공통팀
'작   성   일 : 2008-11
==================================================================================
'수정자/수정일/내역 :
==============================================================================--*/
    ...
    /**
     * @fileoverview 업무에서 공통으로 사용하는 자바스크립트파일로 문자열,유효성체크,날짜관련,숫자관련 각종 함수들을 정의한다.
     * @author 한진해운
     */

    /**
     * @class CoCommon : 문자열,유효성체크,날짜관련,숫자관련 각종 함수들을 정의한다.
     */
    function CoCommon() {
        this.ComChkLen             = ComChkLen;
        this.ComChkLenByByte       = ComChkLenByByte;
        this.ComGetLenByByte       = ComGetLenByByte;
        this.ComIsNull             = ComIsNull;
        this.ComIsEmpty            = ComIsEmpty;
        this.ComLtrim              = ComLtrim;
        this.ComRtrim              = ComRtrim;
        this.ComTrim               = ComTrim;
        this.ComTrimAll            = ComTrimAll;
        this.ComReplaceStr         = ComReplaceStr;
        this.ComIsContainsChars    = ComIsContainsChars;
        this.ComIsContainsCharsOnly= ComIsContainsCharsOnly;
        this.ComIsKorean           = ComIsKorean;
        this.ComIsAlphabet         = ComIsAlphabet;
        this.ComIsNumber           = ComIsNumber;
        this.ComIsMoneyNumber      = ComIsMoneyNumber;
        this.ComIsEmailAddr        = ComIsEmailAddr;
        this.ComAddComma           = ComAddComma;
        this.ComAddComma2          = ComAddComma2;
        this.ComParseInt           = ComParseInt;
        this.ComIsDate             = ComIsDate;
        this.ComIsTime             = ComIsTime;
        this.ComIsDateTime         = ComIsDateTime;
        this.ComIsDateTime2        = ComIsDateTime2;
        this.ComIsMonth            = ComIsMonth;
        this.ComIsDay              = ComIsDay;
        this.ComIsDay2             = ComIsDay2;
        this.ComIsWeek             = ComIsWeek;
        this.ComGetLastDay         = ComGetLastDay;
        this.ComGetDaysBetween     = ComGetDaysBetween;
        this.ComGetDaysToToday     = ComGetDaysToToday;
        this.ComGetDateAdd         = ComGetDateAdd;
        this.ComChkPeriod          = ComChkPeriod;
        this.ComIsJuminNo          = ComIsJuminNo;
        this.ComIsSaupjaNo         = ComIsSaupjaNo;
        this.ComLpad               = ComLpad;
        this.ComRpad               = ComRpad;
        this.ComGetNowInfo         = ComGetNowInfo;
        this.ComFullAges           = ComFullAges;
        this.ComGetAryJoin         = ComGetAryJoin;
        this.ComRound              = ComRound;
        this.ComTrunc              = ComTrunc;
        this.ComGetMaskedValue     = ComGetMaskedValue;
        this.ComGetUnMaskedValue   = ComGetUnMaskedValue;
        this.ComZeroToNull         = ComZeroToNull;
        this.ComNullToZero         = ComNullToZero;
        this.ComGetQuarterToMonth  = ComGetQuarterToMonth;
        this.ComToHtml             = ComToHtml;
        this.ComFuncCheck          = ComFuncCheck;
        this.ComNumberArray        = ComNumberArray;
        this.ComDownLoad		   = ComDownLoad;
    }
    ...
    function ComIsEmpty(obj) {
        try {
            ...
            return (ComTrimAll(sVal)=="" || sVal.replace(/\s|　/gi, '').length == 0)
        } catch(err) { ComFuncErrMsg(err.message); }
    }
