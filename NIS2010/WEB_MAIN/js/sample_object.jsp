  ...
  var bToggle = true;
    ...
    function func_test(sName) {
        ...
        if (ComFuncCheck(sName)) {
            ...
            helpurl.href = "http://nis2010.hanjin.com/jsdoc/CoObject.html#" + sName;
  ...
  <table bgcolor="#e0e0e0" width="980">
    <tr>
        <td>
          ...
          btnSave : <img style="border:0px; cursor:hand;" src="/hanjin/img/enis/button/btn_save.gif" width="66" height="20" border="0" name="btnSave"> /
