    ...
    function UpdateOrganTree()
    {
       ...
       //debugger;
    		...
    		if (sDomain == null)
    			...
    			//sDomain = "http://gw.hanjin.com";
    			sDomain = "http://gw.smlines.com";
    		...
    		// util.UpdateOrganTree("http://gw.hanjin.com",0);
    		var xmlDoc = util.LoadOrganTree();
    		if(xmlDoc == null)
    			xmlDoc = GetOrganXml();
   ...
   function findUserInfo(attr, val, val2)
    {
	   	var xpath = "";
    	var nodelist;
    	var returnvalue;
        ...
        if((val2=="MAIL")||(val2=="PHONE")||(val2=="SIP"))
        	returnvalue = trides.Decrypt("", getAttribute(node,val2));
        else
        	returnvalue = getAttribute(node,val2);
   ...
   function GetOrganXml() {

       var xmlDoc = new ActiveXObject("Msxml2.DOMDocument.6.0");
       var strQuery = "<DATA><AUTHENKEY>fEwt7+Ph6tNy8keVPjscxYRZlY1GAcodIqKb9/xVLtwh/lmFcd3+pRkTW5dn4asw</AUTHENKEY></DATA>"; //alpskey
       var xmlHTTP = new ActiveXObject("Microsoft.XMLHTTP");

       var url = "http://gw.smlines.com/GetOrganXml.aspx";
