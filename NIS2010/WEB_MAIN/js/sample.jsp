...
<input type="hidden" name="f_cmd">
  <table bgcolor="#e0e0e0" width="980">
    <tr>
        <td>
          ...
          btn_Retrieve : <img src="/hanjin/img/btns_search.gif" name="btn_Retrieve" onClick="alert(this.name)">
          ...
          <br>
            ...
            (1)년월일         	: <input type="text" name="txtDate1" dataformat="ymd"    caption="년월일"        maxlength="8" size="10"  value="2008-09-09"><img src="/hanjin/img/btns_calendar.gif" align="absmiddle" style="cursor:hand" onClick="func_test('calendarPopup1')">
            (2)년월           	: <input type="text" name="txtDate2" dataformat="ym"     caption="년월"          maxlength="6" size="8"   value="2008-09"><img src="/hanjin/img/btns_calendar.gif" align="absmiddle" style="cursor:hand" onClick="func_test('calendarPopup2')">
            (3)기간          	: <input type="text" name="txtsDate" dataformat="ymd"    caption="시작일"        maxlength="8"  size="10"  cofield="txteDate" value="2008-09-09">
                              	~ <input type="text" name="txteDate" dataformat="ymd"    caption="종료일"        maxlength="8"  size="10"  cofield="txtsDate"><img src="/hanjin/img/btns_calendar.gif" align="absmiddle" style="cursor:hand" onClick="func_test('calendarPopupFromTo1')">
            <br>
  ...
  <a target="nis2010help" href="http://nis2010.hanjin.com/jsdoc/index.html">도움말 전체</a>,
  <a target="nis2010helpsub" href="http://nis2010.hanjin.com/jsdoc/index.html" id="helpurl">함수도움말</a>
