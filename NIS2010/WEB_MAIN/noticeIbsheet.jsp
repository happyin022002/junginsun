...
<script language="JavaScript" type="text/javascript">
    ...
    function installTabTag(){
     ...
     function setupPage() {
		...
		if(obj.HeadBackColor != null) location.href = "/hanjin/SignOn.do";
     }	
</script>
</head>
			...
			<tr>
				...
				<table class="search" border="0" style="width: 100%;">
					...
					<tr class="">
						...
						<a href="http://alps.smlines.com/hanjin/sheet/IBSheetPro3.msi">http://alps.smlines.com/hanjin/sheet/IBSheetPro3.msi</a><br>
