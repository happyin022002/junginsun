...
%>
	<!--Logout (s)-->
			...
			<tr class="id">
				<td style="padding:0 0 0 13;"><img src="/hanjin/img/main_img/main_dot.gif" width="3" height="9" alt="" border="0" align="absmiddle">&nbsp;&nbsp;ID&nbsp;&nbsp;<font style="color:gray"><%=account.getUsr_id() %></font>&nbsp;&nbsp;&nbsp;&nbsp;
