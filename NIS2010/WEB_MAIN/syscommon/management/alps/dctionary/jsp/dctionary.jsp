...
<%@ page import="com.hanjin.syscommon.management.alps.dctionary.event.DctionaryEvent"%>
...
<%
	...
	Logger log = Logger.getLogger("com.hanjin.syscommon.management.alps.dctionary");
