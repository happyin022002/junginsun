            ...
            case "sheet1":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtData,		120,	daLeft,	true,		"usr_nm",	false,			"",      dfNone,				0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,		60,	daCenter,	true,		"use_flg",	false,			"",      dfNone,				0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,		80,	daLeft,	true,		"rhq",		false,			"",      dfNone,				0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,		80,	daLeft,	true,		"ofc_cd",	false,			"",      dfNone,				0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,		140,	daCenter,	true,		"acss_tms",	false,			"",      dfNone,				0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,		100,	daLeft,	true,		"pgm_no",	false,			"",      dfNone,				0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,		200,	daLeft,		true,		"pgm_nm",	false,			"",      dfNone,				0,		false,		false);
  ...
  // Sheet관련 프로세스 처리
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			...
			case IBSEARCH:      //조회
				ret = ComGetDaysBetween(form.dateFrom.value, form.dateTo.value) 
				if((ret > 31)||(ret<0)){
					alert('Maximum period is within 31 days.  Please set Last Login Period lest than 31 days.');
					break;
				}
				...
				if(validateForm(sheetObj,formObj,sAction)) {
					...
					var sXml = sheetObj.GetSearchXml("ADM_ACS_0002GS.do", FormQueryString(formObj));
					var key = "";
    ...
    function checkLoginData(key) {
		...
		var sXml = sheetObj.GetSearchXml("ADM_ACS_0002GS.do?key="+key, FormQueryString(formObj));
		if (sXml != "") {
