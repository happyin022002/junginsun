...
<%@ page import="com.hanjin.syscommon.management.alps.accesshistory.event.AccesshistoryEvent"%>
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="150"><select name="level" style="width:40;" class="input1">
					...
					<td width="140">Kind of Function</td>
					<td><select name="kind" style="width:80;" class="input1">
				...
				<tr class="h23">
					...
					<td><select name="rhq" style="width:80;" class="input1">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Office Code
						<input type="text" style="width:80;" dataformat="engup" class="input" name= "ofcCd" onKeyPress="javascript:ComKeyOnlyAlphabet('uppernum');">&nbsp;<img class="cursor" src="img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_ofc_cd">
					</td>
					<td>Menu No.</td>
					...
					<td>User ID</td>
					<td><input name="usrId" dataformat="engup" type="text" style="width:100;" class="input"></td>
				</tr>
				</table>
				<!--  biz_1   (E) -->
				...
				<table  width="100%">
					<tr><td colspan="2"><script language="javascript">ComSheetObject('sheet2');</script></td></tr>
				</table>
