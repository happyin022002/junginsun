...
<%@ page import="com.hanjin.syscommon.management.alps.officeprogram.event.OfficeProgramMappingEvent"%>
        ...
        <table class="search"> 
            <tr><td class="bg">
                ...
                <tr class="h23">
					           ...
					           <td width="150"><input type="text" style="width:70;" class="input" required fullfill name="ofc_cd" maxlength="4" style="ime-mode:disabled" readOnly></td>
					           <td width="75">Office Name</td>
					           <td width="">&nbsp;<input type="text" style="width:150;" class="input" value="" name="ofc_nm" maxlength="30"  readOnly></td> 
					       	 </tr>
	       					</table>
        <!-- : ( Scenario ID ) (E) -->
