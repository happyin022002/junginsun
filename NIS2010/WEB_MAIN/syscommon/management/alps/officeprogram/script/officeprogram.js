   ...
   function initSheet(sheetObj, sheetNo, colCnt) {
    ...
    function doActionIBSheet(sheetObj, formObj, sAction, a, PageNo) {
				...
				case IBSEARCH: // ??
					...
					var sXml = sheetObj.DoSearch("officeProgramGS.do", selectVal);
					
//					var sXml = sheetObj.GetSearchXml("officeProgramGS.do", selectVal);
...
//					if (arrXml.length>1) 
				...
				case IBSEARCHAPPEND: // ??? ??
					...
					sheetObj.DoSearch4Post("officeProgramGS.do", selectVal,
							"iPage=" + PageNo, true);
					break;
    ...
    function sheet1_OnScrollNext(sheet,CondParam, PageNo, OnePageRows) {
       doActionIBSheet(sheetObjects[0], document.form, IBSEARCHAPPEND, true, PageNo);
			...
			function sheet1_OnPopupClick(sheetObj, Row, Col) {
				...
				case "pgm_assign":
						ComOpenPopup('/hanjin/officeProgramMapping.do?ofc_cd='+ sheetObj.CellValue(Row, "ofc_cd") + "&ofc_nm="	+ escape(sheetObj.CellValue(Row, "ofc_eng_nm")), 700, 474,'setPrntUsrRoleCd', '1,0,1,1,1,1,1,1,1,0', true, false,Row, Col, 0);
