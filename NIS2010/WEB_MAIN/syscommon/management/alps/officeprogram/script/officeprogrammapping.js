	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				sheetObj.DoSearch4Post("officeProgramMappingGS.do", FormQueryString(formObj));
		...
		switch(sAction) {
		   case IBSEARCH:	  //조회
			...
			case IBSAVE:		//저장
				...
				sheetObj.DoSave("officeProgramMappingGS.do", FormQueryString(formObj),"ibflag",false);
				break;
			case IBCLEAR:	   //Clear
				sheetObj.RemoveAll();
				break;
