...
<%@ page import="com.hanjin.framework.support.view.signon.web.SignOnFilter" %>
<%@ page import="com.hanjin.framework.core.layer.event.GeneralEventResponse" %>
<%@ page import="java.util.List" %>
<%@ page import="com.hanjin.syscommon.management.alps.bookmark.vo.BookmarkListVO" %> 
...
<script>
	...
	function manageBookmark(){
		...
		document.form.action="/hanjin/CREATEBOOKMARK.do";
