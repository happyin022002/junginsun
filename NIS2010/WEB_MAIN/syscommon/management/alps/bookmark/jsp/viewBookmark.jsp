...
<script type="text/javascript" src='/hanjin/js/CoObject.js'></script>
...
<SCRIPT LANGUAGE="javascript" SRC="/hanjin/js/IBSheetInfo.js" TYPE="text/javascript"></SCRIPT>
  ...
  function loadPage() {
	...
	function sheet1_OnSearchEnd(sheetObj, ErrMsg) {
		with(sheetObj){
			...
			RowLevel(Row) = -1;
			CellValue(Row, "dp_nm") = " Manage Bookmark";
			CellImage(Row, "dp_nm") = "bookmark";
			CellFont("FontBold", Row, "dp_nm") = true;
		}
	...
	function createRemoveBookmark(cmd,pgmNo,prntPgmNo, dpNm ){
		...
		if(cmd==1){
			...
			document.form.action="/hanjin/CREATEREMOVEBOOKMARK.do?ibflag=I&pgm_no="+pgmNo+"&prnt_pgm_no=" + prntPgmNo + "&dp_nm="+dpNm;


		}else{
			document.form.f_cmd.value = REMOVE;
			document.form.action="/hanjin/CREATEREMOVEBOOKMARK.do?ibflag=D&pgm_no="+pgmNo;
		}//end if
	}
			...
			with (sheetObj) {
              ...
              //Host정보 설정[필수][HostIp, Port, PagePath]
				...
				var HeadTitle1 = "|||Bookmark Name|";
              	...
              	InitDataProperty(0, cnt++ , dtImageText,	140,	daLeft,			true,	"dp_nm",		false,		"",									dfNone,				0,		false,		false);
				...
				ImageList("bookmark") = "/hanjin/img/new_sub/btn_my_plus.gif";
				InitTreeInfo(0, "level",0,false);
				NodeClosePicture = "/hanjin/img/folder.gif";
                NodeOpenPicture = "/hanjin/img/folder_s.gif";
