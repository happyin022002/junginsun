			...
			case 2:	  //IBSheet2 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    //데이터속성    [ROW,  COL,    DATATYPE,    WIDTH,  DATAALIGN, COLMERGE,     SAVENAME,     KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                    InitDataProperty(0, cnt++ , dtCheckBox,     50,    daCenter,  false,   "checkbox");
                    ...
                    InitDataProperty(0, cnt++ , dtData,        150,    daLeft,    false,   "pgm_nm",           false,        "",     dfNone,           0,    false,       false);
                    InitDataProperty(0, cnt++ , dtHidden,        50,    daLeft,    false,   "add_flg");
                    InitDataProperty(0, cnt++ , dtHidden,     50,    daCenter,  false,   "user_flg");
                    InitDataProperty(0, cnt++ , dtHidden,     50,    daCenter,  false,   "role_flg");
                    InitDataProperty(0, cnt++ , dtHidden,     50,    daCenter,  false,   "super_flg");
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				sheetObj.DoSearch4Post("searchUserProgramMapping.do", FormQueryString(formObj));
    ...
    function sheet2_OnSearchEnd(sheetObj,errMsg){
      ...
      if(login_usr_auth_tp_cd == "S") {
		  ...
		  if(usr_auth_tp_cd == "A" || usr_auth_tp_cd == "E") {
		      	...
		      	for(var i=1; i<sheetObj.rowCount+1; i++) {   	      		
			   		if(sheetObj.CellValue(i, "super_flg") == "1") {
			   			sheetObj.CellEditable(i, "checkbox") = true;	  			
			  		} else {
			  			sheetObj.CellEditable(i, "checkbox") = false;
			  		}
			  	} 
