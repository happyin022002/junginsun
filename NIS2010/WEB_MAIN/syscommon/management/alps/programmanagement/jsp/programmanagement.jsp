...
*@FileName : programmanagement.jsp
...
<%@ page import="com.hanjin.syscommon.management.alps.program.event.ProgramManagementEvent"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.ProgramManagement.Program");
	...
	<tr><td valign="top">
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					<td>Program No.</td>
					<td><input type="text" style="width:100;" dataformat="engup" class="input" value="" name="s_pgm_no"></td>
					<td>Program Name</td>
					<td><input type="text" style="width:170;" class="input" value="" name="s_pgm_nm"></td>
					<td>Program Div.</td>
					...
					<td>Program Type</td>
					<td><select style="width:100;" class="input2" name ="s_pgm_tp_cd">
					...
					<td>Usage</td>
					<td><select style="width:100;" class="input3" name ="s_pgm_use_flg">
