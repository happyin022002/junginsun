...
<%@page import="com.hanjin.syscommon.management.alps.console.backendjob.event.ComBackendjobEvent"%><html>
...
<%
	...
	String strUsr_id = "";
	String strUsr_nm = "";
	Logger log = Logger.getLogger("com.hanjin.apps.Console.BackEndJob");
