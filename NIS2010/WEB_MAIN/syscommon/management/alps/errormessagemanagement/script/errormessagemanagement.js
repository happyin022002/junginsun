            ...
            case "sheet1":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++ , dtData,          				80,    	daCenter,  	false,   		"err_msg_cd",  	true,          		"",       dfEngUpKey,   			0,     false,      true, 8, true);
                    InitDataProperty(0, cnt++ , dtCombo,       			80,    	daCenter,  	false,   		"err_tp_cd",	 		true,          		"",       dfNone,   			0,     true,       true);
                    InitDataProperty(0, cnt++ , dtCombo,         			80,    	daCenter,  	false,   		"err_lvl_cd",	 		true,          		"",       dfNone,   			0,     true,       true);                    
                    InitDataProperty(0, cnt++ , dtData,         				250,    daLeft,    		false,   		"err_msg",     		true,          		"",       dfNone,	        0,     true,       true);
                    InitDataProperty(0, cnt++ , dtData,         				250,    daLeft,    		false,   		"err_desc",    		false,         	"",       dfNone,	        0,     true,       true);                  
                    
					InitDataCombo (0, "err_lvl_cd", "ERR|WARNING|INFO", "E|W|I","I");
					InitDataCombo (0, "err_tp_cd", "Server|UI|Both", "S|U|B","S");
                }
                break;
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			case IBSEARCH:      //조회
				...
				sheetObj.DoSearch("ErrorMessageManagementGS.do", FormQueryString(formObj));
				break;
			...
			case IBSAVE:        //저장
                ...
                sheetObj.DoSave("ErrorMessageManagementGS.do", FormQueryString(formObj));
				break;
...
//        }
    ...
    function sheet1_OnPopupClick(sheetObj,Row,Col){
     ...
     function sheet1_OnChange(sheetObj,Row,Col){
    	 if(Col == 2){
    		 var code = sheetObj.CellValue(Row, Col);
     ...
     function sheet1_OnBeforeEdit(sheetObj,Row,Col){
    	 sheetObj.InitDataValid(0, "err_msg_cd", vtEngUpOther, "0123456789");
     }
