...
<%@ page import="com.hanjin.syscommon.management.alps.jobcodemanagement.event.AdmSys0022Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	AdmSys0022Event event = null;
	...
	try {
		...
		event = (AdmSys0022Event)request.getAttribute("Event");
...
<html>
<head>
<title>Job Code Request Detail</title>
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Job Code Request Detail</td></tr>
			</table>
			<!-- Page Title (E) -->
				...
				<tr>
					<td class="bg" valign="top">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							...
							<tr class="h23" valign="top">
								<td>Approver&nbsp;</td>
								<td><input name="apro_usr_nm" type="text" class="input2" style="width:120;" readOnly></td>
								<td>Comment&nbsp;</td>
								<td><textarea name="apro_rmk" class="input2" style="width:350px;height:36px" maxlength="200" readOnly></textarea></td>
							</tr>
						</table>
						<!-- biz_3 (E) -->
					</td>
