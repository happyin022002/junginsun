...
<%@ page import="com.hanjin.syscommon.management.alps.jobcodemanagement.event.AdmSys0018Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	AdmSys0018Event event = null;
	...
	try {
		...
		event = (AdmSys0018Event)request.getAttribute("Event");
...
<html>
<head>
<title>Job Code Adjustment Approval</title>
