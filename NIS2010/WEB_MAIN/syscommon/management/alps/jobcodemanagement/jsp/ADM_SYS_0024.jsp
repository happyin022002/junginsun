...
<%@ page import="com.hanjin.syscommon.management.alps.jobcodemanagement.event.AdmSys0024Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
	AdmSys0024Event event = null;
	...
	try {
		...
		event = (AdmSys0024Event)request.getAttribute("Event");
				...
				<tr>
					<td class="bg" valign="top">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="h23">
								<td>Approver ID&nbsp;
									<input name="apro_usr_id" type="text" dataformat="engup" maxlength="10" class="input" style="ime-mode:disabled; width:120;"></td>
								<td>Approver Name&nbsp;
									<input name="apro_usr_nm" type="text" dataformat="eng" maxlength="200" class="input" style="ime-mode:disabled; width:200;"></td>
								<td>Office&nbsp;
									<input name="ofc_cd" type="text" dataformat="engup" maxlength="8" class="input" style="ime-mode:disabled; width:100;">
