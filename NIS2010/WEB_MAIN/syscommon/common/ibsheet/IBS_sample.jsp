...
<table width="750px" cellspacing="1" cellpadding="0" >
  ...
  <tr>
     ...
     <td width="500px" align="right">
        ...
        <a href="javascript:doAction('SaveGridSetting');"><img src="/hanjin/img/alps/button/btn_ib_save.gif" class="icon" border="0"></a>
  ...
  <tr>
    <td colspan="2">
      <OBJECT ID="mySheet" CLASSID="CLSID:341FBC5F-2AE4-41B8-BFE5-A03170569A27"
              CODEBASE="/hanjin/sheet/IBSheet3.CAB#version=3,4,0,12">
...
<table width="750px" cellspacing="1" cellpadding="0" >
  ...
  <tr>
     ...
     <td width="500px" align="right">
        ...
        <a href="javascript:doAction2('SaveGridSetting');"><img src="/hanjin/img/alps/button/btn_ib_save.gif" class="icon" border="0"></a>
