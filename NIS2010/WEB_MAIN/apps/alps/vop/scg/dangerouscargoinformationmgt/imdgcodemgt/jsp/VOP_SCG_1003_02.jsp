...
<%@ page import="com.hanjin.apps.alps.vop.scg.dangerouscargoinformationmgt.imdgcodemgt.event.VopScg100302Event"%>
...
<html>
<head>
<title>Permitted mixed stowage for goods of class 1</title>
	...
	<tr>
		<td valign="top">	
			...
			<table width="100%" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Permitted mixed stowage for goods of class 1 </td></tr>
			</table>
			<!-- : ( Title ) (E) -->
