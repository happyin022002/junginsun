...
<%@ page import="com.hanjin.apps.alps.vop.scg.dangerouscargoinformationmgt.imdgcodemgt.event.VopScg0003Event"%>
...
<html>
<head>
<title>Segregation Table (Creation)</title>
						...
						<table class="search" border="0" style="width:100%;"> 					
							<tr class="h23">
								...
								<td class="btn2_bg" align="right">
									<!-- 2009.07.08 인정환수석 요청으로 인한 버튼 주석처리 -->
