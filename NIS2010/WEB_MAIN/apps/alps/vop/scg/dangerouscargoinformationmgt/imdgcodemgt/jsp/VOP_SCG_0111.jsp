...
<%@ page import="com.hanjin.apps.alps.vop.scg.dangerouscargoinformationmgt.imdgcodemgt.event.VopScg0111Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0111Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0111Event)request.getAttribute("Event");
