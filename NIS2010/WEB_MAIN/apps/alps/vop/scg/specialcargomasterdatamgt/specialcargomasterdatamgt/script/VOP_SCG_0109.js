...
*@FileName : VOP_SCG_0109.js
*@FileTitle : HJS Chemical Inquiry(Answer)
*Open Issues :
*Change history :
* 1.0 Creation
=========================================================*/
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
	...
	/**
	 * @extends 
	 * @class VOP_SCG_0109 : VOP_SCG_0109 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function VOP_SCG_0109() {
    	 ...
    	 switch(sheetNo) {
    	 	case 1:      // sheet1 init
    	 		with (sheetObj) {
    	 			...
    	 			var HeadTitle = "|Opinion|Comment|Special Provision";
				    ...
				    InitDataProperty(0, cnt++ , dtCombo,          	100,    daCenter,   false,	"chem_opin_knd_cd",  	false, 	"",     dfNone,   	0,	true,      true);
                    InitDataProperty(0, cnt++ , dtData,       		300,   	daLeft,  	false,	"cmt_ctnt",			    false, 	"",     dfNone,   	0,  true,       true);
                    InitDataProperty(0, cnt++ , dtData,       		50,   	daCenter,  	false,	"imdg_spcl_provi_no",	false, 	"",     dfNullInteger,   	0,  true,      true,3);
  		...
  		switch(sAction) {
          	case IBSEARCH: //조회
          		if(validateForm(sheetObj,formObj,sAction)){
            	   	...
            	   	sheetObj.DoSearch("VOP_SCG_0109GS.do", FormQueryString(formObj));
  				}
          	break;
        	...
        	case IBSAVE:        //저장
     		   ...
     		   var sXml = sheetObjects[0].GetSaveXml("VOP_SCG_0109GS.do", sParam+"&" + ComGetPrefixParam( aryPrefix ) );
