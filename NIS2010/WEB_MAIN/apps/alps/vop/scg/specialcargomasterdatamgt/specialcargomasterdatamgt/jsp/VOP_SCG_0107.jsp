...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0107Event"%>
 <%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.List" %>

<%
	VopScg0107Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	    ...
	    log.debug("\n SignOnUserAccount getUsr_nm "+strUsr_nm );
	   
		event = (VopScg0107Event)request.getAttribute("Event");
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Packing Method Creation</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!-- : ( Search Options ) (S) -->
       				...
       				<td class="bg">
						...
						<table class="search" border="0" style="width:420;">
							<tr class="h23">
								...
								<td width="">
									<input type="text" style="width:50;text-align:center;ime-mode:disabled;" class="input" maxlength="7" name="imdg_pck_instr_cd" value="<%=pkCd%>" >
								</td>
								<td width="30">Seq.</td>
								<td width="120">
									<input type="text" style="width:40;text-align:center;ime-mode:disabled;" class="input" maxlength="2" name="imdg_pck_instr_seq" value="<%=pkCdSeq%>" >
								</td>
							</tr>
						</table>
						<!--  biz_1   (E) -->
