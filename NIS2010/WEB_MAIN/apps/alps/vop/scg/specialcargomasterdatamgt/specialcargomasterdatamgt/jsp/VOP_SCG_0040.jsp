...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0040Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0040Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0040Event)request.getAttribute("Event");
