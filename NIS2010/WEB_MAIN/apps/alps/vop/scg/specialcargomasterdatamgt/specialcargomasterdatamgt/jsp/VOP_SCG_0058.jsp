...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0058Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0058Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0058Event)request.getAttribute("Event");
...
<html>
<head>
<title>Packing Group (Inquiry)</title>
