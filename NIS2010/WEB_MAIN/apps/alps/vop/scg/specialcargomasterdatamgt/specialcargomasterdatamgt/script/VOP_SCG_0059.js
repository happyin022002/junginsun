...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0059 : vop_scg_0059 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    ...
    function processButtonClick(){
        ...
        try {
            ...
            switch(srcName) {
                ...
                case "btn1_Excel":
                    ...
                    sheetObj.SpeedDown2Excel(0, false, false, "", url, false, false, "", false, "ibflag|radio|delt_flg");
                    break;  
     ...
     function sheet1_OnLoadFinish(sheetObj) {         
         ...
         if(preConds.pop_yn == 'Y') {
        	 //체크박스 활성
        	 sheetObjects[0].ColHidden("radio") = false;
        	 //초기 조건 셋팅
   ...
   /**
         ...
         switch(sheetNo) {
            case 1:      //t1sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,         80,     daCenter,   true,   "imdg_spcl_provi_no",   false,   "",     dfNone,     0,  false,  true,   4);
                    InitDataProperty(0, cnt++ , dtHidden,       90,     daLeft,     false,  "imdg_spcl_provi_desc", false,   "",     dfNone,     0,  false,  false,  1000);
                    InitDataProperty(0, cnt++ , dtHidden,       30,     daLeft,     true,   "delt_flg",             false,  "",     dfNone,     0,  true,   true);

					ColHidden("radio") = true;
					EditableColorDiff = false;
                    InitDataValid(0, "imdg_spcl_provi_no", vtNumericOnly);
                }
                break;
     ...
     function validateForm(sheetObj,formObj,sAction){
      ...
      function sheet1_OnClick(sheetObj,Row, Col, Value) {
         ...
         if (sheetObj.ColSaveName(Col) == "imdg_spcl_provi_no") {
             formObj.imdg_spcl_provi_no2.value = sheetObj.CellValue(Row,"imdg_spcl_provi_no");
             formObj.imdg_spcl_provi_desc1.value = sheetObj.CellValue(Row,"imdg_spcl_provi_desc");
    ...
    function descCopy(sheetObject)  {           
        ...
        if (rowNo != "") {
            sheetObject.CellValue(rowNo,"imdg_spcl_provi_desc") = formObj.imdg_spcl_provi_desc1.value;
            descClear();
        }
     }
