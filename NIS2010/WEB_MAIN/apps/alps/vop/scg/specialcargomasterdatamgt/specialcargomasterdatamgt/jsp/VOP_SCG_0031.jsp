...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0031Event"%>
...
<html>
<head>
<title>Load Reject Reason (Creation)</title>
	     		...
	     		<tr>
	     			<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								<td width="130">Special Cargo Type</td>
								<td>
									<select name="spcl_cgo_cate_cd" style="width:100;" class="input1">
