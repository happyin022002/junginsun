...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0070Event"%>
...
<html>
<head>
<title>Segregation Group (Creation)</title>
	...
	<tr>
		<td valign="top">
			...
			<table class="search" id="mainTable"> 
       			<tr>
       				<td class="bg" style="height:514;" valign="top">	
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								<td width="500">
								<table><tr><td style="height:15"></td></tr></table>
									<!-- Grid - 1 (S) -->
								...
								<td width="459" valign="top">
									...
									<table class="search" border="0">
										<tr>
											<td class="title_h"></td>
											<td id="subTitle" class="title_s">Heavy metals and their salts (including their organometallic compounds)</td>
										</tr>
									</table>
									<!-- Grid - 1 (S) -->
									<table width="100%"  id="mainTable"> 
									...
									<!-- Grid - 1 (E) -->	
									<!--Sub Button (S) -->
									<table width="100%" class="button" cellpadding="0" cellspacing="0"> 
							       		<tr>
							       			<td class="btn2_bg">
											    <table border="0" cellpadding="0" cellspacing="0">
												    <tr>
														<td>
															<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
																<tr>
																	<td class="btn2_left"></td>
																	<td class="btn2" name="btn2_Row_Add2">Row Add</td>
																	<td class="btn2_right"></td>
																</tr>
															</table>
														</td>														
														<td>
															<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
																<tr>
																	<td class="btn2_left"></td>
																	<td class="btn2" name="btn2_Row_Insert2">Row Insert</td>
																	<td class="btn2_right"></td>
																</tr>
															</table>
														</td>
														...
														<td>
															<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
																<tr>
																	<td class="btn2_left"></td>
																	<td class="btn2" name="btn2_Row_Copy2">Row Copy</td>
																	<td class="btn2_right"></td>
																</tr>
															</table>
														</td>
														...
														<td>
															<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
																<tr>
																	<td class="btn2_left"></td>
																	<td class="btn2" name="btn2_Row_Delete2">Row Delete</td>
																	<td class="btn2_right"></td>
																</tr>
															</table>
														</td>
