...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0050 : vop_scg_0050 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
         ...
         switch(sheetNo) {
            case 1:      //t1sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,         150,    daCenter,   true,   "rgn_shp_opr_cd",       false,   "",     dfNone,     0,  false,  true, 3,    true);
                    InitDataProperty(0, cnt++ , dtData,         540,    daLeft,     true,   "rgn_shp_opr_desc",     false,  "",     dfNone,     0,  true,   true, 20);
