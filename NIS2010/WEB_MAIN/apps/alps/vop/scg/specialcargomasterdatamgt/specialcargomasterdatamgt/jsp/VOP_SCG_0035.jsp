...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0035Event"%>
...
<html>
<head>
<title>Target Lane for SPCL CGO APVL (Creation)</title>
