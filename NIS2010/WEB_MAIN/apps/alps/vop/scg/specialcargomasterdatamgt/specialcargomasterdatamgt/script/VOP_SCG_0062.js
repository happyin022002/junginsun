...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0062 : vop_scg_0062 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_scg_0062() {
         ...
         switch(sheetNo) {
            case 1:      //t1sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,         100,    daCenter,   true,   "imdg_tnk_tp_cd",       false,   "",      dfNone,      0,     false,   true, 1);
