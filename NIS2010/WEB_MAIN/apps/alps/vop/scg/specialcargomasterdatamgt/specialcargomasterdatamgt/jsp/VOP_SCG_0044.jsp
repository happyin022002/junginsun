...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0044Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0044Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0044Event)request.getAttribute("Event");
...
<html>
<head>
<title>IMO Type Portable Tanks (Creation)</title>
