...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0043 : vop_scg_0043 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_scg_0043() {
    ...
    // InitDataValid 의 Other Option 상에 추가되는 문자들 정의 - 2011.02.22
     		...
     		switch(srcName) {
				...
				case "btn_RowAdd":
					if (formObject.imdg_pck_tp_cd[1].checked) {
						sheetObject.InitDataCombo(0, "imdg_pck_tp_cd", "I|O|M", "I|O|M", "I", "I");
					}else if (formObject.imdg_pck_tp_cd[2].checked) {
						sheetObject.InitDataCombo(0, "imdg_pck_tp_cd", "I|O|M", "I|O|M", "O", "O");
					}else if (formObject.imdg_pck_tp_cd[3].checked) {
						sheetObject.InitDataCombo(0, "imdg_pck_tp_cd", "I|O|M", "I|O|M", "M", "M");
					}
         ...
         switch(sheetNo) {
         	case 1:      //t1sheet1 init
         		with (sheetObj) {
         			...
         			//var HeadTitle = "|Sel.|No.|Code|Description|Packaging \n Style|";
                    ...
                    InitDataProperty(0, cnt++ , dtDataSeq,      30,    daCenter);
         			InitDataProperty(0, cnt++ , dtData,   		60,    	daLeft,	   	true,   "imdg_pck_cd", 		true,   "",      dfNone,    0,     false,   true, 5);
         			InitDataProperty(0, cnt++ , dtData,			750,	daLeft,   	true,   "imdg_pck_desc",	false,  "",      dfEngKey,  0,     true,    true, 1000);
         			InitDataProperty(0, cnt++ , dtCombo,		80,    	daCenter,   true,   "imdg_pck_tp_cd",	false,  "",      dfNone,	0,     true,    true);
    	            ...
    	            InitDataValid(0, "imdg_pck_desc", vtEngOther, NUMBER_STRING + SPCHAR_STRING ); 
         			InitDataValid(0, "imdg_pck_cd", vtEngUpOther, NUMBER_STRING ); 
         			InitDataCombo(0, "imdg_pck_tp_cd", "I|O|M", "I|O|M");
                }
         		break;
         }
     }
