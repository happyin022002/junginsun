...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0055Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0055Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0055Event)request.getAttribute("Event");
...
<html>
<head>
<title>Definition of Class (Inquiry)</title>
