...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0049Event"%>
...
<html>
<head>
<title>Load Reject Reason (Inquiry)</title>
	...
	<tr>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="125">Special Cargo Type</td>
					<td width="">
									<select name="spcl_cgo_cate_cd" style="width:107;" class="">
