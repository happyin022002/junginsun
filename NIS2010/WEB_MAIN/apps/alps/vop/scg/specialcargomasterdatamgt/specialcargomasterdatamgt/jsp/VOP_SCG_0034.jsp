...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0034Event"%>
...
<html>
<head>
<title>Partner’s Contact Point for SPCL CGO (Creation)</title>
