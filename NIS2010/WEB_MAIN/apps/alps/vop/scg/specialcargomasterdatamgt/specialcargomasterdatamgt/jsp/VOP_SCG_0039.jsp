...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0039Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0039Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0039Event)request.getAttribute("Event");
...
<html>
<head>
<title>Marine Pollutant (Creation)</title>
