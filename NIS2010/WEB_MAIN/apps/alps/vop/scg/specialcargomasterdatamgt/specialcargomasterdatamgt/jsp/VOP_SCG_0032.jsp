...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0032Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0032Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0032Event)request.getAttribute("Event");
...
<html>
<head>
<title>SPCL CGO RSO (Creation)</title>
