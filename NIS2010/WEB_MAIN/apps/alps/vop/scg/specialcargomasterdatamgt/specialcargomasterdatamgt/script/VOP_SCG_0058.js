...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0058 : vop_scg_0058 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
         ...
         switch(sheetNo) {
            case 1:      //t1sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtCombo,        150,    daCenter,   true,   "imdg_pck_grp_cd",          false,   "",      dfNone,        0,     false,   true,   1);
