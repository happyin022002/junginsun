...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vms_scg_0046 : vms_scg_0046 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vms_scg_0046() {
     	...
     	try {
     		...
     		switch(srcName) {
				...
				case "btn_RowAdd":
					...
					sheetObject.CellValue(row,"imdg_segr_tp_cd") = ComGetObjValue(formObject.imdg_segr_tp_cd); 
         	...
         	case 1:      //t1sheet1 init
         		with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtDataSeq,      30,    daCenter);
         			InitDataProperty(0, cnt++ , dtData,			150,    daCenter,   true,   "imdg_segr_cd", 	true,   "",      dfNone,    0,     false,   true,	1);
         			InitDataProperty(0, cnt++ , dtData,			640,    daLeft,		true,	"imdg_segr_desc",	false,  "",      dfNone,    0,     true,    true,	350);
    	 			InitDataProperty(0, cnt++ , dtHidden,      	30,	    daLeft,	   	true,   "imdg_segr_tp_cd",  false,  "",      dfNone,	0,     true,	true);
