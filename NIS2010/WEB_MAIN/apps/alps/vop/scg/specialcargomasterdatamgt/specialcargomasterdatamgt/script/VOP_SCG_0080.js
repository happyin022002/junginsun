...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class vop_scg_0080 : vop_scg_0080 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_scg_0080() {
    ...
    function loadPage() {
        ...
        for(var i=0;i<uploadObjects.length;i++){
		    //1. 기본 환경 설정
		    ComConfigUpload(uploadObjects[i], "/hanjin/VOP_SCG_0080GS.do");
		}
        ...
        switch(sheetNo) {
            case 1:      //sheet0 init [Dg-제목]
                with (sheetObj) {
					...
					InitDataProperty(0, cnt++ , dtHidden,		    10,    daCenter,   true,    "cre_usr_id", 	 		 	false,    "",      dfNone,      0,     true,    true);
                    InitDataProperty(0, cnt++ , dtHidden,		    10,    daCenter,   true,    "cre_dt", 	  				false,    "",      dfDateYmd,   0,     true,    true);
                    InitDataProperty(0, cnt++ , dtHidden,		    10,    daCenter,   true,    "ftr_ctnt", 	  			false,    "",      dfNone,   0,     true,    true);
                    InitDataProperty(0, cnt++ , dtHidden,		    10,    daCenter,   true,    "spcl_cgo_guid_cd", 	  	false,    "",      dfDateYmd,   0,     true,    true);
                    InitDataProperty(0, cnt++ , dtHidden,		    10,    daCenter,   true,    "spcl_cgo_guid_seq", 	  	false,    "",      dfDateYmd,   0,     true,    true);
...
//				var user_role_cd = ComGetEtcData(xmlStr, "user_role_cd");   //role code 에 상관없이 creation 메뉴 권한으로 저장 권한 부여
					...
					ComBtnEnable("btn1_addrow");
					ComBtnEnable("btn2_addrow");
					ComBtnEnable("btn3_addrow");
					ComBtnEnable("btn1_addfile_row");
					ComBtnEnable("btn2_addfile_row");
					ComBtnEnable("btn3_addfile_row");
					ComBtnEnable("btn1_addfile_delete");
					ComBtnEnable("btn2_addfile_delete");
					ComBtnEnable("btn3_addfile_delete");
					ComBtnEnable("btn4_row_delete");
					ComBtnEnable("btn4_addrow");
					ComBtnEnable("btn4_addfile_row");
					ComBtnEnable("btn4_addfile_delete");					
