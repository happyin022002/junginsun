...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0067 : vop_scg_0067 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_scg_0067() {
   ...
   /**
             ...
             case "sheet1":      //t2sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtDataSeq,      30,    daCenter);
 					InitDataProperty(0, cnt++ , dtData,			60,		daCenter,	false,		"imdg_expt_qty_cd",	true,       "",		dfNone,		0,			false,		true,	2, true);
 					InitDataProperty(0, cnt++ , dtData,			450,	daCenter,	false,		"max_inr_pck_qty",	true,       "",		dfNone,		0,			true,		true,	9);
 					InitDataProperty(0, cnt++ , dtData,			0,		daCenter,	false,		"max_outr_pck_qty",	true,		"",		dfNone,		0,			true,		true,	9);
 	...
 	function sheet1_OnChange(sheetObj,Row, Col, Value){
 		...
 		if (sheetObj.ColSaveName(Col) == "imdg_expt_qty_cd") {
 			var bfCode = sheetObj.CellValue(Row,"imdg_expt_qty_cd");
