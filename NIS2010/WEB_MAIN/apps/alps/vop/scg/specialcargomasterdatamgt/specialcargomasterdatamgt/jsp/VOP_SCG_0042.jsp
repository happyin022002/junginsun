	       			...
	       			<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width=""><input type="text" name="imdg_pck_instr_cd" style="width:70;" class="input" maxlength="10" value="" dataformat="engup"  style="ime-mode:disabled"></td>
							</tr>
						</table>
					<!--  biz_1   (E) -->				
					</td>
