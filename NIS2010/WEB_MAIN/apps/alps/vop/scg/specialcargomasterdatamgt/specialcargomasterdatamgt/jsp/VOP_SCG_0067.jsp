...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0067Event"%>
...
<html>
<head>
<title>Excepted Quantities (Creation)</title>
