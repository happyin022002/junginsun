...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0047Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0047Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0047Event)request.getAttribute("Event");
...
<html>
<head>
<title>Compatibility Groups of Class 1 (Creation)</title>
