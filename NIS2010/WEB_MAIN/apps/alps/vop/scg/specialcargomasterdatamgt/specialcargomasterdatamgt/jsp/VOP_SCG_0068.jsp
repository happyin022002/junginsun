...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0068Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0068Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0068Event)request.getAttribute("Event");
...
<html>
<head>
<title>Excepted Quantities (Inquiry)</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<table width="100%" class="button"> 
     	<tr>
			<td width="300">* 0 - Not permitted as Excepted Quantity</td>
			<td width="">&nbsp;</td>
	    </tr>
	</table>				
			<!-- Grid - 1 (E) -->	
