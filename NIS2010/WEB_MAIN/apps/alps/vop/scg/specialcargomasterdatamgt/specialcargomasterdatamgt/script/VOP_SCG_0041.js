...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vms_scg_0041 : vms_scg_0041 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vms_scg_0041() {
   ...
   /**
         	...
         	case 1:      //t1sheet1 init
         		with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtDataSeq,      30,    daCenter);
         			InitDataProperty(0, cnt++ , dtData,   		100,    daCenter,   true,   "imdg_spcl_provi_no", 	true,   "",     dfNone,     0,  false,  true,	4);
         			InitDataProperty(0, cnt++ , dtHidden, 		90, 	daLeft, 	false, 	"imdg_spcl_provi_desc", true, 	"", 	dfNone, 	0, 	false, 	false,	1000);
 	...
 	function descCopy(sheetObject)  {   		
 		var formObj = document.form;
		var rowNo = sheetObject.SelectRow;
		sheetObject.CellValue(sheetObject.SelectRow,"imdg_spcl_provi_desc") = formObj.imdg_spcl_provi_desc1.value;
		descClear();
     }
