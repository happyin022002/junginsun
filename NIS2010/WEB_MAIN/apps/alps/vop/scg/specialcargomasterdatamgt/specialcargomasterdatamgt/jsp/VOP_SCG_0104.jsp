...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0104Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.List" %>

<%
	VopScg0104Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0104Event)request.getAttribute("Event");
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Max. Qty by Packaging Type</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!-- : ( Search Options ) (S) -->
       				...
       				<td class="bg">
						...
						<table class="search" border="0" style="width:420;">
							<tr class="h23">
								...
								<td width="">
									<input type="text" style="width:40;text-align:center;ime-mode:disabled;" class="input2" maxlength="4" name="f_pck_cd" value=<%=pkCd%> tabindex="1">
								</td>
								<td width="30">Seq.</td>
								<td width="120">
									<input type="text" style="width:40;text-align:center;ime-mode:disabled;" class="input2" maxlength="2" name="f_pck_cd_seq" value=<%=pkCdSeq%> tabindex="1">
								</td>
							</tr>
						</table>
						<!--  biz_1   (E) -->
