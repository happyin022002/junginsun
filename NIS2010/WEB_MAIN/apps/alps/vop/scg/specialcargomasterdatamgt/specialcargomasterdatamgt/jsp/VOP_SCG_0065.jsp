...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0065Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg0065Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg0065Event)request.getAttribute("Event");
...
<html>
<head>
<title>Compatibility Groups of Class 1 (Inquiry)</title>
