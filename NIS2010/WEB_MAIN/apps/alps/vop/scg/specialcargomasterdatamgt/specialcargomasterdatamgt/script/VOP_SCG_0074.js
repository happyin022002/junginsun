...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0074 : vop_scg_0074 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_scg_0074() {
            ...
            switch(sheetObj.id) {
                case "sheet1":      //sheet1 init
                   with (sheetObj) {
                        ...
                        InitDataProperty(0, cnt++ , dtData,         60,     daCenter,   false,      "imdg_un_no"    ,         false,      "",              dfNone,     0,          false,       true);
                        InitDataProperty(0, cnt++ , dtPopupEdit,    30,     daCenter,   false,      "imdg_un_no_seq",         false,      "",              dfNumber,     0,          false,       true);                     
                        ...
                        InitDataProperty(0, cnt++ , dtData,         30,     daCenter,   false,      "imdg_pck_grp_cd",        false,      "",             dfNone,     0,          false,       false);
