...
<%@ page import="com.hanjin.apps.alps.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0037Event"%>
...
<html>
<head>
<title>Definition of Class (Creation)</title>
