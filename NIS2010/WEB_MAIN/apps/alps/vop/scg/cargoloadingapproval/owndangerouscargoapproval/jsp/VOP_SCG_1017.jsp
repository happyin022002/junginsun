...
<%@ page import="com.hanjin.apps.alps.vop.scg.cargoloadingapproval.owndangerouscargoapproval.event.VopScg1017Event"%>
...
<html>
<head>
<title>Application Request & Approval Status – Break Bulk</title>
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  Application Request & Approval Status - Break Bulk </td></tr>
			</table>
			<!-- : ( Title ) (E) -->
