...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0006 : vop_scg_0006 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_scg_0006() {
 ...
 // 버튼 네임으로 구분하여 프로세스를 분기처리하는 이벤트핸들러 */
     ...
     function initControl() {
         ...
         // axon_event.addListenerForm('beforedeactivate','obj_beforedeactivate',  form);               
            ...
            case IBCLEAR:      //초기화 1. Class Combo 가져오기
                 ...
                 if( formObj.pPort_cd.value != ""){
                    ...
                    // formObj.optClass[1].fireEvent("onclick");
                     ...
                     formObj.imdg_clss_cd.Code2      = formObj.pImdg_clss_cd.value;
...
//	  	  		sheetObj.CellValue2( Row, sheetObjects[1].id+"_load_cmptn_auth_cd_p" ) = 0;  	
//	  	  	    sheetObj.CellValue2( Row, sheetObjects[1].id+"_load_cmptn_auth_cd_d" ) = 0;  
//	  	        sheetObj.CellValue2( Row, sheetObjects[1].id+"_load_cmptn_auth_cd_n" ) = 0;   	
//	  	        sheetObj.CellValue2( Row, sheetObjects[1].id+"_load_ton_ovr_vol_qty" ) = 0;    				    
//	  	        sheetObj.CellValue2( Row, sheetObjects[1].id+"_load_nd_tm_hrs" )       = "";  	             
     ...
     */
     ...
     function img_click(){
   	    ...
   	    if(obj.name == "srch_port_cd"){
            //if( document.form.port_cd.value != "" ){
