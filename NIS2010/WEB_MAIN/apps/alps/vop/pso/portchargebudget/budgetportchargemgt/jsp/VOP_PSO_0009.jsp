...
<%@ page import="com.hanjin.apps.alps.vop.pso.portchargebudget.budgetportchargemgt.event.VopPso0009Event"%>
...
<html>
<head>
<title>Estimate VVD Creation</title>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="35">Lane</td>
						<td width="100"><input type="text" name="vsl_slan_cd" dataformat="engup" maxlength="3" style="ime-mode:disabled; width:45; text-align:center;" class="input" value="">&nbsp;<img  name="btns_search" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
