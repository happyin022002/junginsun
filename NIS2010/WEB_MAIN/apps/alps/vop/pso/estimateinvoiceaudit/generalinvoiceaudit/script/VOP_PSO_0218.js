...
=========================================================*/
   ...
   /**
    ...
    /**
     * @extends 
     * @class vop_pso_0218 : vop_pso_0218 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_pso_0218() {
 ...
 function initSheet(sheetObj, sheetNo) {
 	...
 	with (sheetObj) {
 		...
 		case "sheet1": 
 			...
 			//if(chk=="IN")
 		//	var HeadTitle  = "|No. of TUG in Arrival|No. of TUG in Arrival|No. of TUG in Arrival|";
 			//else
 		   // var HeadTitle  = "|BAF|BAF|";
 			
 			var HeadTitle1 = "|Before|Current|";
            ...
            InitDataProperty(0, cnt++ , dtData,			200,		daCenter,	true,		prefix+"regno",		false,		"",			dfNullFloat,	2,			false,		false, 		10,			false,	false, 		"");
            InitDataProperty(0, cnt++ , dtData,			200,		daCenter,	true,		prefix+"objno",		false,		"",			dfNullFloat,	2,			true,		true, 		10,			false,	false, 		"");
 ...
 function doActionIBSheet(sheetObj, formObj, sAction) {
     ...
     case SEARCH01:		
		...
		var sXml = sheetObj.GetSearchXml("VOP_PSO_0218GS.do", param );
		setBasicData(sheetObj);
		var rtVal = ComGetEtcData(sXml, "BAF");

		sheetObj.CellValue2(1, "sheet1_regno") = rtVal;
