...
<%@ page import="com.hanjin.apps.alps.vop.pso.portsomasterdatamgt.porttariffmgt.event.VopPso0210Event"%>
...
<html>
<head>
<title>ID Link <%="F".equalsIgnoreCase(id_tp) ? "Formual" : "Condition"%></title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;ID Link <%="F".equalsIgnoreCase(id_tp) ? "Formual" : "Condition"%></td></tr>
		</table>
		<!-- : ( Title ) (E) -->
