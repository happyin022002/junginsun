...
<%@ page import="com.hanjin.apps.alps.vop.pso.portsomasterdatamgt.porttariffmgt.event.VopPso0002Event"%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<table class="search">
			<tr>
				...
				<table class="search" border="0" style="width:979;">
					<tr class="h23">
						<td width="30">Port</td>
						<td width="150"><input name="port_cd" value="" type="text" dataformat="uppernum" style="width: 50" class="input1" size="5" maxlength="5">&nbsp;<img class="cursor" name="btn_port_cd" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle">&nbsp; 
						<script language="javascript">ComComboObject('combo1',2, 50, 0, 1);</script>
						</td>
						<td width="105">Account CD</td>
						<td width="98" style="padding-left: 2"><script language="javascript">ComComboObject('combo2',2, 96, 0, 1,0);</script></td>
				...
				<table class="search" border="0" style="width:979;">
					<tr class="h23">
						...
						<td width=""><input type="text" name="org_vndr_nm" style="width:294; text-align:left" class="input" value=""></td>
					</tr>
				</table>
				<table class="search" border="0" style="width:979;">
					<tr class="h23">
				...
				<table class="search" border="0" style="width:979;">
					<tr class="h23">
						...
						<td width="316"><input name="contract" value="" type="text" style="width:270" class="input2" readonly>&nbsp;<img class="cursor" name="btn_cntr_cd" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
				...
				<div id="div_surcharge"><!-- Surcharge (S) -->
				<table class="line_bluedot">
					<tr>
						<td></td>
					</tr>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td class="btn2_left"></td>
										<td class="btn2" name="btn_RowAdd2" id="surRowAdd">Row&nbsp;Add</td>
										<td class="btn2_right"></td>
									</tr>
								</table>
								</td>
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td class="btn2_left"></td>
										<td class="btn2" name="btn_RowAdd3" id="disRowAdd">Row&nbsp;Add</td>
										<td class="btn2_right"></td>
									</tr>
								</table>
								</td>
		...
		<table width="100%" id="mainTable" style="display: none"><!-- MultiCombo의 OnChange() 기능用 Sheet, 초기화 안함 -->
			<!-- style="display:none" -->
			<tr>
