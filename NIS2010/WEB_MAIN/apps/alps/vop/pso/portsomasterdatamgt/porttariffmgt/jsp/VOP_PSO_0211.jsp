...
<form name="form" onKeyDown="ComKeyEnter()"><input type="hidden"
	...
	value=""> <input type="hidden" name="acct_cd"
	value="<%=strAcctCd%>"> <input type="hidden" name="acct_nm"
	value="<%=strAcctNm%>"> <input type="hidden" name="cost_cd"
	value="<%=strCostCd%>"> <input type="hidden" name="cost_nm"
	value="<%=strCostNm%>"> <input type="hidden" name="caller"
	value="<%=caller%>"> <!-- 개발자 작업	--> <!-- OUTER - POPUP (S)tart -->
<table width="100%" class="<%="IFRAME".equals(caller) ? "" : "popup"%>" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="100%" border="0" style="display:<%="IFRAME".equals(caller) ? "none" : "inline"%>">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Copy From</td>
			</tr>
		</table>
				...
				<table class="search" border="0" width="100%" style="display:<%="IFRAME".equals(caller) ? "none" : "inline"%>">
					<tr class="h23">
						...
						<td width="180"><input name="port_cd" type="text"
							...
							class="input2" value="<%=strPortCd%>" readonly>&nbsp;
					...
					<tr class="h23">
						<td width="60">Year</td>
						<td width="180"><input name="year" dataformat="y" type="text"
					...
					<tr class="h23">
						...
						<td width="180"><script language="javascript">ComComboObject('ver',3, 120, 1);</script></td>
