...
<%@ page import="com.hanjin.apps.alps.vop.fcm.vesselreport.vesselreport.event.VopFcm0004Event"%>
...
<html>
<head>
<title>Departure Report Item Error Cleansing</title>
		...
		<tr>
			<td valign="top">
				...
				<table width="100%" border="0">
					<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Departure Report Item Error Correction Pop-Up</td></tr>
				</table>
				<!-- : ( Title ) (E) -->
				<table class="search">
					<tr>
