...
/**
 * @extends
 * @class VOP_FCM_0005 : VOP_FCM_0005 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function VOP_FCM_0005() {
...
//	sheetObj.prefix = prefix;
	...
	case 1: // IBSheet1 init
		with (sheetObj) {
			// 높이 설정
			style.height = 220;
//			style.height = 250; // Hidden Haed 노출시 늘려주기 (개발시에만 사용)
			// 전체 너비 설정
...
//			MergeSheet = msNone;
	...
	case 2:
		with (sheetObj) {
			// 높이 설정
			style.height = 135;
//			style.height = 180; // Hidden Haed 노출시 늘려주기 (개발시에만 사용)
...
//			MergeSheet = msNone;
			...
			var HeadTitle1 = "Class|Vessel|Voy No.|Lane|Last Port|Dep Port|Miles Obs|Miles Eng|Miles In|Miles Out|SPD|RPM|AVG.\nPro.Pitch|Sailing\nTime";
				HeadTitle1 = HeadTitle1 + "|F.O|LS F.O|D.O|LS D.O|F.O|LS F.O|D.O|LS D.O|F.O|LS F.O|D.O|LS D.O|M/E| TTL |TTL|M/E|G/E|BLR|M/E|G/E|BLR|M/E|G/E|BLR|M/E|G/E|BLR";
				HeadTitle1 = HeadTitle1 + "|M/E|G/E|BLR|M/E|G/E|BLR|M/E|G/E|BLR|M/E|G/E|BLR|F.O BDR|F.O Actual|F.O Sulfur|LS F.O BDR|LS F.O Actual|LS F.O Sulfur|D.O BDR|D.O Actual";
				HeadTitle1 = HeadTitle1 + "|D.O Sulfur|LS D.O BDR|LS D.O Actual|LS D.O Sulfur|Next Port|ETA|Togo Mile|Togo Spd|S/B ENG ①\n(ETA-①)|P.O.B ②\n(②-①)|ANCHOR ③\n(③-①)|ANCHOR AWAY ④\n(④-③)";
				HeadTitle1 = HeadTitle1 + "|FIRST LINE ⑤\n(ETB-⑤)|COMM'CED WKG ⑥\n(⑥-⑤)|COMP'TED WKG ⑦\n(⑦-⑥)|LAST LINE ⑧\n(ETD-⑧)|DROP ANCHOR ⑨\n(⑨-⑧)|ANCHOR AWAY ⑩\n(⑩-⑨)|PILOT AWAY ⑪\n(⑪-⑧)";
				HeadTitle1 = HeadTitle1 + "|R/UP ENG ⑫\n(⑫-⑪)|R/UP ENG\n(Last Port)|FWD|MID|AFT|GM|FWD|MID|AFT|GM|Full|Em'ty|Total|Cargo Weight|Displacement|Disch.|Load|On Board|On Board(Last Port)|ERR_ITM_CTNT|RCV_DT|RCV_SEQ|DEP_RPT_ERR_TP_CD";
			...
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"cntr_dzn_capa",				false, "",	dfNone,			0,	false,	false);
			...
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"vsl_slan_cd",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_dep_port_cd",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_port_cd",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"nvgt_ml_dist_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"eng_ml_dist_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"mnvr_in_ml_dist_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"mnvr_out_ml_dist_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"avg_spd_ctnt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"avg_rpm_pwr_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"avg_prlr_pch_val",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sail_tm_hrs",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_foil_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_low_sulp_foil_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_doil_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_low_sulp_doil_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_foil_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_low_sulp_foil_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_doil_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_low_sulp_doil_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_dep_foil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_dep_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_dep_doil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_dep_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_stmng_mn_eng_ttl_qty",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"avg_port_ttl_qty",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"avg_port_ttl_hr_qty",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_mn_foil_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_gnr_foil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_blr_foil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_mn_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_gnr_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_blr_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_mn_doil_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_gnr_doil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_blr_doil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_mn_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_gnr_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sea_blr_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_mn_foil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_gnr_foil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_blr_foil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_mn_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_gnr_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_blr_low_sulp_foil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_mn_doil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_gnr_doil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_blr_doil_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_mn_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_gnr_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"port_blr_low_sulp_doil_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_foil_bdr_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_foil_act_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_foil_sulp_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_low_sulp_foil_bdr_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_low_sulp_foil_act_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_low_sulp_foil_sulp_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_doil_bdr_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_doil_act_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_doil_sulp_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_low_sulp_doil_bdr_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_low_sulp_doil_act_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"spl_low_sulp_doil_sulp_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"nxt_port_cd",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"nxt_port_eta_dt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"rmn_dist_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"rmn_avg_spd_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"sb_eng_dt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"plt_in_dt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"bfr_brth_ank_drp_dt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"bfr_brth_ank_off_dt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"vps_etb_dt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"cgo_wrk_st_dt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"cgo_wrk_end_dt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"vps_etd_dt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"aft_unbrth_ank_drp_dt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"aft_unbrth_ank_off_dt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"plt_out_dt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"rup_dt",						false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_port_rup_dt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_fwddr_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_mid_drft_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_aftdr_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"arr_gm_ctnt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_fwddr_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_mid_drft_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_aftdr_ctnt",				false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_gm_ctnt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"fcntr_obrd_teu_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"mcntr_obrd_teu_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"ttl_cntr_obrd_teu_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_cgo_ctnt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"dep_dpl_ctnt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"rf_cntr_dchg_knt_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"rf_cntr_lod_knt_ctnt",			false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"rf_cntr_obrd_knt_ctnt",		false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,	false,	"lst_rf_cntr_obrd_knt_ctnt",	false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50,		daCenter,   false,  "err_itm_ctnt",					false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50, 	daCenter,   false,  "rcv_dt",						false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50, 	daCenter,   false,  "rcv_seq",						false, "",	dfNone,			0,	false,	false);
			InitDataProperty(0, cnt++, dtHidden,	50, 	daCenter,   false,  "dep_rpt_err_tp_cd",			false, "",	dfNone,			0,	false,	false);
...
function sheet1_OnSearchEnd(sheetObj){
	...
	with(sheetObj){
		...
		sheetObj.CellValue(HeaderRows + 0,"left_head") = "NEW";
		sheetObj.CellValue(HeaderRows + 1,"left_head") = "EXISTING";
		sheetObj.CellValue(HeaderRows + 2,"left_head") = "Standard";
		sheetObj.CellValue(HeaderRows + 3,"left_head") = "DIFF.";
		sheetObj.CellValue(HeaderRows + 4,"left_head") = "Rate / Range";
		sheetObj.CellValue(HeaderRows + 5,"left_head") = "Error Setting";
		...
		for(var i=0;i < saveNamesArray.length; i++){
			sheetObj.CellValue(HeaderRows + 4, saveNamesArray[i]) = applyExpression("", "per", sheetObj.CellValue(HeaderRows + 4, saveNamesArray[i]));
		}
		
		// Rate / Range 각 항목 '-'값 가운데 정렬
		for(var i=0; i <= sheetObj.LastCol; i++){
			if(sheetObj.CellValue(HeaderRows + 4, i) == "-"){
				sheetObj.CellAlign(HeaderRows + 4, i) = daCenter;
			}
		}
		...
		for(var i=0; i < saveNamesArray.length; i++){
			sheetObj.CellValue(HeaderRows + 5, saveNamesArray[i]) = applyExpression("pm", "per", sheetObj.CellValue(HeaderRows + 5, saveNamesArray[i]));
		}
		...
		for(var i=0; i < saveNamesArray.length; i++){
			sheetObj.CellValue(HeaderRows + 5, saveNamesArray[i]) = applyExpression("pm", "", sheetObj.CellValue(HeaderRows + 5, saveNamesArray[i]));
		}
		
		// Overlap 항목 BG 적용 <---Error Setting 기준치 벗어난 항목 처리
		saveNames		= sheetObj.CellValue(HeaderRows + 0, "err_itm_ctnt");
		saveNamesArray	= saveNames.split("|");
		...
		// Overlap 항목 BG 적용 <---NEW 와 EXISTING 서로 다른 값은 아래에서 처리
		saveNames		= sheetObj.CellValue(HeaderRows + 1, "err_itm_ctnt");
		saveNamesArray	= saveNames.split("|");
		
		for(var i=0; i < saveNamesArray.length; i++){
			sheetObj.CellBackColor(HeaderRows + 1, saveNamesArray[i]) = sheetObj.RgbColor(255,051,255);
		}
...
function sheet1_OnDblClick(sheetObj, row, col) {
	...
	switch(row){
		case 5:
			// 수정 가능한 컬럼만 적용되게
			if(sheetObj.CellEditable(row - 1, col)){
				sheetObj.CellValue(row - 1, col) = sheetObj.CellValue(row, col);				
			}
			break;
	}
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case SEARCH: // 조회
		if (validateForm(sheetObj, formObj, sAction)) {
			...
			var rXml = sheetObj.GetSearchXml("VOP_FCM_0005GS.do", FormQueryString(formObj));
...
//			ComOpenWait(true);
			...
			var rXml = sheetObj.GetSearchXml("VOP_FCM_0005GS.do", saveStr + "&" +FormQueryString(formObj),"",true);
 			var arrXml = rXml.split("|$$|");
 			var arrCt = arrXml.length;
...
// 			ComOpenWait(false);
 			...
 			// simulation 시 Existing 데이터 제조회 하지 않고 hidden object 에 있는 값으로 넣어줌
 			for(var i=0; i < dataCols; i++){
 				sheetObj.CellValue(sheetObj.HeaderRows + 1, i + 1) = sheetObjects[3].CellValue(sheetObjects[3].HeaderRows, i);
 			}
 			
 			// date 형식 항목 변환
 			set_DateType(sheetObj);
 			
 			// Overlap 항목 BG 적용 <---HIDDEN SHEET의 EXISTING 값은 아래에서 처리
 			var saveNames		= sheetObjects[3].CellValue(sheetObjects[3].HeaderRows, "err_itm_ctnt");
 			var saveNamesArray	= saveNames.split("|");
 			
 			for(var i=0;i < saveNamesArray.length; i++){
 				sheetObj.CellBackColor(sheetObj.HeaderRows + 1, saveNamesArray[i]) = sheetObj.RgbColor(255,051,255);
 			}
...
//			dataFormatChk(sheetObj);
			...
			var rXml = sheetObj.GetSearchXml("VOP_FCM_0005GS.do", FormQueryString(formObj),"",true);
			var arrXml = rXml.split("|$$|");
			var arrCt = arrXml.length;
	...
	case REMOVE:
		if(confirm("Are you sure you want to Delete it?")){
			if (validateForm(sheetObj, formObj, sAction)) {
				...
				ComOpenWait(true);
				var sXml = sheetObj.GetSaveXml("VOP_FCM_0005GS.do", sParam);
				ComOpenWait(false);
...
function doSave(sheetObj, formObj){
	...
	if(simChk == 'Y'){
		...
		if(confirm("You have not yet simulation. Are you sure you want to Confirm it?")){
			doActionIBSheet(sheetObj, formObj, MULTI);
		}else{
			return;
		}
...
function set_DateType(sheetObj){
		...
		for(var i=0; i < saveNamesArray.length; i++){
			...
			sheetObj.CellValue(sheetObj.HeaderRows + 2, saveNamesArray[i]) = Usr_GetDateTimeSet(sheetObj.CellValue(sheetObj.HeaderRows + 2, saveNamesArray[i]));
		}
}
