...
<%@ page import="com.hanjin.apps.alps.vop.fcm.vesselreport.vesselreport.event.VopFcm0001Event"%>
...
<%
	...
	Logger log = Logger.getLogger("com.hanjin.apps.vop.fcm.vesselreport.vesselreport");
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="30">Port</td>
					<td width="100"><script language="javascript">ComComboObject('vps_port_cd',1,80,0,0);</script></td>
						...
						<tr>
							<td>
								<table border="0">
									<tr>
										<td>
										<table width="240"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">&nbsp;</td></tr><tr><td>
										<!--시트-->
										<script language="javascript">ComSheetObject('t1sheet1');</script></td></tr></table></td>
										<td><table style="width:3px; height:50;"><tr><td></td></tr></table></td>
										<td>
										<table width="310"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">&nbsp;&nbsp;Not Received</td></tr>
										<tr><td>																					
										<!--시트-->
										<script language="javascript">ComSheetObject('t1sheet2');</script></td></tr></table></td>
										<td><table style="width:3px;height:50;"><tr><td></td></tr></table></td>
										<td>
										<table width="245"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">&nbsp;&nbsp;Error</td></tr>
										<tr><td>									
										<!--시트-->
										<script language="javascript">ComSheetObject('t1sheet3');</script></td></tr></table></td>
										<td><table style="width:3px;height:50;"><tr><td></td></tr></table></td>
										<td>
										<table width="175"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">&nbsp;&nbsp;Overlap</td></tr>
										<tr><td>									
										<!--시트-->
										<script language="javascript">ComSheetObject('t1sheet4');</script></td></tr></table></td>
									</tr>
								</table>
								<table  class="button" border="0" cellpadding="0" cellspacing="0" > 
		       						<tr><td class="btn2_bg">
										<table width="485" border="0" cellpadding="" cellspacing="0"><tr>
										</tr>
										</table>
										</td>
										<td class="btn2_bg">
										<table width="245" border="0" cellpadding="" cellspacing="0"><tr>
										<td width="60"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
		       							...
		       							<td class="btn2_bg">
										<table width="175" border="0" cellpadding="0" cellspacing="0"><tr>
										<td width="70"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td>
										<td class="btn2" name="btn2_delete1">Delete</td>
										<td class="btn2_right"></td>
										</tr>
										</table></td>
										</tr>
		       							...
		       							<td class="btn2_bg">
										<table width="70" border="0" cellpadding="0" cellspacing="0"><tr>
										<td width="70"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td>
										<td class="btn2" name="btn2_delete2">Delete</td>
										<td class="btn2_right"></td>
										</tr>
										</table></td>
										</tr>
							...
							<td>
								<table>
									<tr>
										...
										<td>
										<table width="295"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">Not Received</td></tr>
										<tr><td>																					
										<!--시트-->
										<script language="javascript">ComSheetObject('t2sheet2');</script></td></tr></table></td>
										<td><table style="width:8px;"><tr><td></td></tr></table></td>
										<td>
										<table width="315"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">Mismatched</td></tr>
										<tr><td>									
										<!--시트-->
							...
							<td>
								<table>
									<tr>
										...
										<td><table style="width:8px;"><tr><td></td></tr></table></td>
										<td>
										<table width="285"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">Not Received</td></tr>
										<tr><td>																					
										<!--시트-->
										<script language="javascript">ComSheetObject('t3sheet2');</script></td></tr></table></td>
										<td><table style="width:8px;"><tr><td></td></tr></table></td>
										<td>
										<table width="335"><tr><td style="font-weight:bold;" style="font-size:10.5pt;">Mismatched</td></tr>
										<tr><td>									
										<!--시트-->
