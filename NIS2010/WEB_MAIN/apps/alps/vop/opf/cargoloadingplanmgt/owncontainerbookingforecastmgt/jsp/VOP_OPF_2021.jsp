...
<%@ page import="com.hanjin.apps.alps.vop.opf.cargoloadingplanmgt.owncontainerbookingforecastmgt.event.VopOpf2021Event"%>
...
<html>
<head>
<title>Weight Group (Inquiry)</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; Weight Group (Inquiry)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					<td width="33">Lane</td>
					<td width="320"><input type="text" tabIndex="1" style="width:50;" maxlength="3" fullfill caption="Lane" class="input1" name="slan_cd" value="<%=slan_cd%>" style="ime-mode:disabled" required>&nbsp;<img src="img/btns_search.gif" name="slan_cd_pop" width="19" height="20" border="0" align="absmiddle" class="cursor">
						&nbsp;<input type="text" style="width:200;" class="input2" name="slan_cd_desc" value="<%=slan_cd_desc%>" readonly></td>
