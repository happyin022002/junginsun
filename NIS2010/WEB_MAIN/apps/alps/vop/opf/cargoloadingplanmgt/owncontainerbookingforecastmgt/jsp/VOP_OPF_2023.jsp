 ...
 *@FileName : vop_opf_2023.jsp
 *@FileTitle : CBF Summary Preview
 *Open Issues :
 *Change history :
 *@LastModifyDate : 2016.01.10
 *@LastModifier : 우지석
 *@LastVersion : 1.0
 * 1.0 Creation
...
<%@ page import="com.hanjin.apps.alps.vop.opf.cargoloadingplanmgt.owncontainerbookingforecastmgt.event.VopOpf2023Event"%>
...
<%
	...
	VopOpf2023Event event = null; 		//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopOpf2023Event) request.getAttribute("Event");
...
<table width="100%" class="popup" cellpadding="10" border="0">
	<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; CLL & CBF Diff List</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!--biz page (S)-->
