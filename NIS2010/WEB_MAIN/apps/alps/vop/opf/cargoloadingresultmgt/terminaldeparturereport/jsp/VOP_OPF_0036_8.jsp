    ...
    <tr><td class="bg">
		<!-- biz_1  (S) -->
				...
				<td width="800" colspan="">
					...
					<tr class="h23">
					<td><input type="radio" value="" name="chk_Slot" class="trans" checked>&nbsp;BSA&nbsp;&nbsp;&nbsp;
					<input type="radio" value="" name="chk_Slot" class="trans" >&nbsp;HC/45'&nbsp;&nbsp;&nbsp;
					<input type="radio" value="" name="chk_Slot" class="trans" >&nbsp;Slot(Port)&nbsp;&nbsp;&nbsp;
					<input type="radio" value="" name="chk_Slot" class="trans" >&nbsp;Slot(DEP)</td> 
					</tr>
					</table>
				</td>
...
%>			<!-- Grid  (S) -->
				<SPAN id="t8sheetDiv" style="display:<%=(cnt == 1 ? "inline" : "none")%>">
...
%>
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg" style="text-align:left;">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn2" name="btn_t8BsaImport" id="btn_t8BsaImport">Import BSA & Slot Swap</td>
			...
			<td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_t8RowAdd">Row Add</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_t8RowInsert">Row Insert</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_t8RowCopy">Row Copy</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_t8Delete">Row Delete</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
					</tr></table>
