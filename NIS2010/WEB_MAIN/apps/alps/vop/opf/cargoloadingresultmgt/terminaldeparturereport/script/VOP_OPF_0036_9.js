...
var mBtnDis = "N";
    ...
    function processButtonClick(){
    	...
    	try {
			...
			switch(srcName) {
				case "btn_t9RowAdd":
						var sheetObj = document.t9sheet1;
	...
	function initSheet(sheetObj,sheetNo) {
		...
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++ , dtData,			170,	daCenter,	true,		prefix + "cntr_no",			mustInput,	"",					dfEngUpKey,	0,		true,		true,		13);
			InitDataProperty(0, cnt++ , dtPopupEdit,	100,	daCenter,	true,		prefix + "opr_cd",			false,		"",					dfNone,		0,		true,		true,		3);
			InitDataProperty(0, cnt++ , dtComboEdit,	100,	daCenter,	true,		prefix + "sztp",			false,		"",					dfNone,		0,		true,		true,		4);
			InitDataProperty(0, cnt++ , dtComboEdit,	100,	daCenter,	true,		prefix + "pol",				false,		"",					dfNone,		0,		true,		true,		5);
			InitDataProperty(0, cnt++ , dtComboEdit,	100,	daCenter,	true,		prefix + "pod",				false,		"",					dfNone,		0,		true,		true,		5);
			InitDataProperty(0, cnt++ , dtData,			100,	daCenter,	true,		prefix + "position",		false,		"",					dfNone,		0,		true,		true,		6);
			InitDataProperty(0, cnt++ , dtData,			100,	daRight,	true,		prefix + "weight",			false,		"",					dfNullFloat,1,		true,		true,		5);
			InitDataProperty(0, cnt++ , dtData,			100,	daLeft,		true,		prefix + "remark",			false,		"",					dfNone,		0,		true,		true,		15);
	...
	function podComboInit(){
		var prefix = "t9sheet1_";
		document.t9sheet1.InitDataCombo(0, prefix + "pod", parent.mPodName,  parent.mPodCode);
		document.t9sheet1.InitDataCombo(0, prefix + "pol", parent.mPodName,  parent.mPodCode);
	}
	...
	function t9sheet1_OnSelectCell(sheetObj,OldRow, OldCol, NewRow, NewCol) {
		...
		if(sheetObj.ColSaveName(OldCol) == "t9sheet1_opr_cd" && sheetObj.CellValue(OldRow, "t9sheet1_opr_cd") != "" && parent.mCheckValue){
