...
<%@ page import="com.hanjin.apps.alps.vop.opf.cargoloadingresultmgt.regiondeparturereport.event.VopOpf004601Event"%>
...
<html>
<head>
<title>RDR Creation – VSL Mvmt</title>
    ...
    <!-- Grid (S) -->
        <table width="100%"  id="mainTable">
            ...
            <tr><td class="btn2_bg">
                ...
                <tr>
                    ...
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn2_left"></td>
                    <td class="btn2_1" name="btn_ImportVesselMovement"   auth='c'  id="btn_ImportVesselMovement">Import Vessel Movement</td>
                    <td class="btn2_right"></td>
                    </tr>
                    </table></td>
                 </tr></table>
     ...
     <!-- Grid (E) -->
      ...
      <tr class="h23">
          ...
          <td width=""><input type="text" name="next_port" style="width:50;" class="input2" readonly  >&nbsp;<input type="text" name="eta" style="width:110;" class="input2" readonly></td>
      </tr>
      <tr class="h23">
