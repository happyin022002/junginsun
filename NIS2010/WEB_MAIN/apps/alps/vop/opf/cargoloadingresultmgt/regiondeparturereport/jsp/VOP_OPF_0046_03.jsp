...
<%@ page import="com.hanjin.apps.alps.vop.opf.cargoloadingresultmgt.regiondeparturereport.event.VopOpf004603Event"%>
...
<html>
<head>
<title>RDR Creation – HC/45</title>
    ...
    <!--  Button_Sub (S) -->
            ...
            <tr>
                <td width="180">
                    ...
                    <td class="btn2_1" name="btn_ImportSubAllocation"  auth='c' id="btn_ImportSubAllocation">Import Sub Allocation</td>
