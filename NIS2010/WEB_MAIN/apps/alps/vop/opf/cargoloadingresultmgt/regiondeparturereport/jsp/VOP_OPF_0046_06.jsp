...
<%@ page import="com.hanjin.apps.alps.vop.opf.cargoloadingresultmgt.regiondeparturereport.event.VopOpf004606Event"%>
...
<html>
<head>
<title>RDR Creation – Remark</title>
...
<td class="bg">
    ...
    <tr><td class="bg">
            ...
            <table class="height_2"><tr><td></td></tr></table>
                ...
                <table width="100%">
                    <tr><td><textarea style="width:99%;height:420" name="remark"  ></textarea></td>
                    </tr>
                </table>
