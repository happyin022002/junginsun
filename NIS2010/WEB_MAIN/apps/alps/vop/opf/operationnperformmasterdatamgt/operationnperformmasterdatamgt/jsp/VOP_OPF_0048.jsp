...
<%@ page import="com.hanjin.apps.alps.vop.opf.operationnperformmasterdatamgt.operationnperformmasterdatamgt.event.VopOpf0048Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopOpf0048Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopOpf0048Event)request.getAttribute("Event");
