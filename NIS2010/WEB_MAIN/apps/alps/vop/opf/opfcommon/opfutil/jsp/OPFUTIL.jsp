...
<%@ page import="com.hanjin.apps.alps.vop.opf.opfcommon.opfutil.event.OpfutilEvent"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.OpfCommon.OpfUtil");
...
/*=========================================================
	...
	* Mappign
	...
	<url-mapping url="VOP_OPF_0007.do" screen="VOP_OPF_0007.screen" >
        <web-action-class>com.hanjin.apps.alps.vop.opf.vesseloperationsupportmgt.terminalinformationmgt.event.VOP_OPF_0007HTMLAction</web-action-class>
    </url-mapping>

    <url-mapping url="VOP_OPF_0007GS.do" screen="com.hanjin.framework.core.controller.DefaultViewAdapter" >
        <web-action-class>com.hanjin.apps.alps.vop.opf.vesseloperationsupportmgt.terminalinformationmgt.event.VOP_OPF_0007HTMLAction</web-action-class>
    </url-mapping>

    <event-mapping>
        <event-class>com.hanjin.apps.alps.vop.opf.vesseloperationsupportmgt.terminalinformationmgt.event.VopOpf0007Event</event-class>
        <service-action-class>com.hanjin.apps.alps.vop.opf.vesseloperationsupportmgt.VesselOperationSupportMgtSC</service-action-class>
    </event-mapping>
	...
	* Screen
    ...
    <screen name="VOP_OPF_0007">
        ...
        <parameter key="body"     value="apps/alps/vop/opf/vesseloperationsupportmgt/terminalinformationmgt/jsp/vop_opf_0007.jsp"/>
    </screen>
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="130"><input type="text" style="width:150;" class="input1" name="gsys_nm" maxlength="100" caption="Port Code" value="com.hanjin.apps.alps">&nbsp;</td>
					<td width="10"></td>
					<td width="50">Sys</td>
