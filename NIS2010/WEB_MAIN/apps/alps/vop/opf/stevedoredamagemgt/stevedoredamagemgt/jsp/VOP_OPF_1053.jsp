...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Stevedore Damage Detail </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg" style="height:400" valign="top">
				...
				<tr class="h23">
					...
					<td width="150"><input type="text" name="clm_hndl_ofc_cd" caption="Claim Handling Office" style="width:70;ime-mode:disabled;text-align:center;" maxlength="6" class="input1" required>&nbsp;<img name="clm_hndl_ofc_cd_pop" class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
					<td width="30">PIC</td>
					<td width="210">
					<table width="100%" border="0">
					<tr>
				...
				<tr class="h23">
					...
					<td width="112"><input type="text" style="width:53;ime-mode:disabled;" maxlength="5" fullfill class="input" name="req_skd_voy_dir" caption="Voyage No">&nbsp;<img src="img/btns_search.gif" name="req_skd_voy_dir_pop" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"><input type="text" style="width:0;" name="noname"></td>
					<td width="35">Port</td>
					<td width="112">
					...
					<td width="30">ETA</td>
					<td align="right"><input type="text" style="width:75;" maxlength="8" class="input" dataformat="ymd" caption="ETA Date" name="req_eta_dt">&nbsp;<img src="img/btns_calendar.gif" name="btn_req_eta_dt" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
				</tr>
				<tr class="h23">
					<td colspan="2"></td>
					<td>Reason</td>
       		...
       		<tr><td class="bg" style="height:400" valign="top">
				...
				<tr class="h23">
					...
					<td><table width="90" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td>
							<td class="btn2" name="rpr_seq_delete">Seq.Delete</td>
							<td class="btn2_right"></td>
							</tr>
						</table></td>
				</tr> 
				...
				<tr class="h23">
					...
					<td width="" style="padding-left:2">
						<script language="javascript">ComComboObject('qttn_locl_curr_cd',1,70,0,1);</script>&nbsp;<input type="text" name="qttn_cost_locl_amt" dataformat="float" pointcount="2" caption="Local Amount" style="width:90; text-align:right;" maxlength="18" class="input1"></td>
					</tr> 
				</table>
				...
				<tr class="h23">
					...
					<td width="195"><input type="text" name="rpr_port_cd" caption="Port Code" style="width:98;" maxlength="5" class="input1">&nbsp;<img src="img/btns_search.gif" name="rpr_port_cd_pop" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					<td width="35">Date</td>
					<td width="265"><input type="text" name="rpr_dt" dataformat="ymd" caption="Repair Date" style="width:80;" maxlength="8" class="input1">&nbsp;<img src="img/btns_calendar.gif" name="btn_rpr_dt" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg" style="height:400" valign="top">
				...
				<tr class="h23">
					...
					<td width="243">
						<script language="javascript">ComComboObject('cmpn_curr_cd',1,74,0,1);</script>&nbsp;<input type="text" name="cmpn_cost_locl_amt" dataformat="float" pointcount="2" caption="Local Amount" style="width:94; text-align:right;" maxlength="18" class="input1"></td>
					<td width="30" class="stm">USD</td>
