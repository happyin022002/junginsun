...
//2011.01.04 권한부여 체크 삭제. 1053 화면 탭별로 권한 체크로 수정.
		//권한부여 체크 추가(2010.10.14)-- 로그인 User의 Role이 OPF04 일 경우만 팝업 오픈
//		if(arrUsrAuth == null){
//			popUpOpen = "N";
//		}else{
...
<html>
<head>
<title>Stevedore Damage Inquiry & Update</title>
