...
*@FileName : vop_opf_0055.js
*@FileTitle : Stevedore Damage Inquiry
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_opf_0055 : vop_opf_0055 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_opf_0055() {
...
//    	else if(!isNull(elementObj.value)){
    ...
    function sheet1_OnDblClick(sheetObj, row, col) {
    	var formObj = document.form;
	    	ComOpenPopup("VOP_OPF_1055.do?stv_dmg_no="+ sheetObj.CellValue(row,"sheet1_stv_dmg_no"), 1000, 650, "", "0,0", true);
    }
...
//    	 }
    ...
    //VOP_OPF_1055 에서 Close 시 이벤트 발생
    function call_1055(){
        var sheetObject1 = sheetObjects[0];
        var formObject = document.form;		
		doActionIBSheet(sheetObject1,formObject,IBSEARCH);
