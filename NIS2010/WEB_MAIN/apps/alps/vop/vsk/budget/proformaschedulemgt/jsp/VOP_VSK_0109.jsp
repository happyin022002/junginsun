...
*@FileName : VOP_VSK_0109.jsp
*@FileTitle : Budget Information Input for SKD Creation(PF SKD Use) (Pop-Up)
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.proformaschedulemgt.event.VopVsk0109Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0109Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0109Event)request.getAttribute("Event");
...
<html>
<head>
<title>Budget Information Input for SKD Creation(PF SKD Use) (Pop-Up)</title>
