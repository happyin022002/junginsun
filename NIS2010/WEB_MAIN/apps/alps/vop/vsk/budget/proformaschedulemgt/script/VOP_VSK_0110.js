...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
	...
	/**
	 * @extends 
	 * @class vop_vsk_0110 : vop_vsk_0110 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function vop_vsk_0110() {
...
//								sheetObj.DoSearch("VOP_VSK_0110GS.do");
//				                if(validateForm(sheetObj,formObj,sAction))
						var sParam = FormQueryString(formObj);
						var sXml = sheetObj.GetSearchXml("VOP_VSK_0110GS.do", sParam);
