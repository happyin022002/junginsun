...
*@FileName : vop_vsk_0108.jsp
*@FileTitle : Budget P/F SKD Type Inquiry (Pop-Up) 
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.proformaschedulemgt.event.VopVsk0108Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0108Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0108Event)request.getAttribute("Event");
...
<html>
<head>
<title>Budget P/F SKD Type Help (Pop-Up) </title>
