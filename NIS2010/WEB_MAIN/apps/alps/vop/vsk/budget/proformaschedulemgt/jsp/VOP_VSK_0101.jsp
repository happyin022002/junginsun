...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.proformaschedulemgt.event.VopVsk0101Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0101Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0101Event)request.getAttribute("Event");
...
<html>
<head>
<title>Budget P/F SKD Creation</title>
