...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.proformaschedulemgt.event.VopVsk0102Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0102Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0102Event)request.getAttribute("Event");
...
<html>
<head>
<title>Budget P/F SKD Inquiry</title>
