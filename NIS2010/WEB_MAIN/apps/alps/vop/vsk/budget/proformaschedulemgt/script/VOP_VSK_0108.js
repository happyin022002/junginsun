...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class VOP_VSK_0108 : VOP_VSK_0108 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function VOP_VSK_0108() {
 ...
 function doActionIBSheet(sheetObj,formObj,sAction) {
     ...
     switch(sAction) {
        ...
        case IBSEARCH:      //조회
        	...
        	sheetObj.DoSearch("VOP_VSK_0108GS.do", sParam + "&" + ComGetPrefixParam("sheet1_"));
        ...
        case SEARCH02:
        	sheetObj.WaitImageVisible = false;
			 ...
			 //var sXml = sheetObj.GetSearchXml("VOP_VSK_0108GS.do?op_=0108" , FormQueryString(formObj));
			 var sXml = sheetObj.GetSearchXml("VOP_VSK_0108GS.do" , FormQueryString(formObj));
