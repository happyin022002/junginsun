...
*@FileName : VOP_VSK_0113.jsp
*@FileTitle : VSL SKD Inquiry by Port - Budget
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.vesselschedulemgt.event.VopVsk0113Event"%>
<%@ page import="org.apache.log4j.Logger" %> 

<%
	VopVsk0113Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0113Event)request.getAttribute("Event");
...
<html>
<head>
<title>Port Code Inquiry - Budget</title>
...
<input type="hidden" name="use_pgm_nm" value="VOP_VSK_0113">
