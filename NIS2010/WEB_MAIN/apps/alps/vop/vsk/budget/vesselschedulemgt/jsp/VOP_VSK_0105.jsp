...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.vesselschedulemgt.event.VopVsk0105Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0105Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0105Event)request.getAttribute("Event");
...
<html>
<head>
<title>Budget VSL SKD Creation by VVD</title>
