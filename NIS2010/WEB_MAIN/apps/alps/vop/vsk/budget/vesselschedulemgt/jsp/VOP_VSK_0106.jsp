...
* 2014.03.06 Sang-Ki JEONG [CHM-201429238] Appending(All) or Removeing(Closed) Search Condition.
=========================================================*/%>
...
<%@ page import="com.hanjin.apps.alps.vop.vsk.budget.vesselschedulemgt.event.VopVsk0106Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0106Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0106Event)request.getAttribute("Event");
...
<html> 
<head>
<title>Budget VSL SKD Deletion</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="130" class="stm"><input type="text" style="width:37;text-align:center;ime-mode:disabled;" class="input" value="" name="vsl_slan_cd" maxlength="3" tabindex="1">&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_search1"></td>
					<td width="80">Vessel Code</td>
					<td width="150" class="stm"><input type="text" style="width:60;text-align:center;ime-mode:disabled;" name="vsl_cd" maxlength="4" tabindex="2">&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_search2"></td>
					<td width="50">Status</td>
					<td width="60" class="stm"><select name="skd_sts_cd" style="width:60" tabindex="3">
