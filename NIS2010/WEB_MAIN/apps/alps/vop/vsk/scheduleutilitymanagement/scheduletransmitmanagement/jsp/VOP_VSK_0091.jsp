...
<%@ page import="com.hanjin.apps.alps.vop.vsk.scheduleutilitymanagement.scheduletransmitmanagement.event.VopVsk0091Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopVsk0091Event event = null;					//PDTO(Data Transfer Object including Parameters)
...
//	String pageRows  = "100";
	...
	try {
		...
		event = (VopVsk0091Event)request.getAttribute("Event");
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="350">hours (Auto TLX/FAX notice - Actual Arrival) </td>
					<td width="490"></td>
				</tr>
				</table>
