...
/**
 * @extends
 * @class VOP_VSK_0091 : VOP_VSK_0091 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function VOP_VSK_0091() {
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: // sheet1 init
		with (sheetObj) {
			...
			var HeadTitle1 = "|CTRL HQ|CTRL Office|Port|TMNL|Lane|VVD|Vessel Name|OPR|Coastal SKD(At the time of TLX/FAX sending)|Coastal SKD(At the time of TLX/FAX sending)|POB|Drop Anchor|Actual Date|Actual Date|ETA notice via Auto TLX/FAX|ETA notice via Auto TLX/FAX|ETA notice via Auto TLX/FAX|ETA notice via Auto TLX/FAX|Diff.(Notice vs Actual)|Diff.(Notice vs Actual)|Diff.(C/S vs Actual)|Diff.(C/S vs Actual)|Diff.(C/S vs Notice)|Diff.(C/S vs Notice)|via cd|Send via|Result|Result|Result|esvc_vndr_seq|trsm_his_seq|trsm_ownr_cd";
			var HeadTitle2 = "|CTRL HQ|CTRL Office|Port|TMNL|Lane|VVD|Vessel Name|OPR|ETA|ETB|POB|Drop Anchor|ATA|ATB|ETA|ETB|Sending date|User ID|Arrival|Berthing|Arrival|Berthing|Arrival|Berthing|via cd|Send via|Time of adj. RPM|Old RPM|New RPM|esvc_vndr_seq|trsm_his_seq|trsm_ownr_cd";
			...
			InitDataProperty(0, cnt++ , dtData,			130,	daCenter,	true,	prefix+"vps_eta_dt",			false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			130,	daCenter,	true,	prefix+"vps_etb_dt",			false,	"",			dfNone,			0,			false,		false);
			
			//::Adding-2014-01-02:://
			InitDataProperty(0, cnt++ , dtData,			100,	daCenter,	true,	prefix+"pob_dt",				false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			100,	daCenter,	true,	prefix+"drp_ank_dt",			false,	"",			dfNone,			0,			false,		false);
			/////////////////////////
			...
			InitDataProperty(0, cnt++ , dtData,			95,		daCenter,	true,	prefix+"ntc_eta_dt",			false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			95,		daCenter,	true,	prefix+"ntc_etb_dt",			false,	"",			dfNone,			0,			false,		false);
			...
			InitDataProperty(0, cnt++ , dtData,			80,		daCenter,	true,	prefix+"dif_over_arr_dt",		false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			80,		daCenter,	true,	prefix+"dif_over_brth_dt",		false,	"",			dfNone,			0,			false,		false);
			
			//::Adding-2014-01-02:://			
			InitDataProperty(0, cnt++ , dtData,			60,		daCenter,	true,	prefix+"dif_cst_act_arr_dt",	false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			60,		daCenter,	true,	prefix+"dif_cst_act_brth_dt",	false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			60,		daCenter,	true,	prefix+"dif_cst_ntc_arr_dt",	false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			60,		daCenter,	true,	prefix+"dif_cst_ntc_brth_dt",	false,	"",			dfNone,			0,			false,		false);
			/////////////////////////
			...
			InitDataProperty(0, cnt++ , dtData,			100,	daCenter,	true,	prefix+"rpm_adj_dt",			false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			70,		daRight,	true,	prefix+"org_rpm_pwr",			false,	"",			dfNone,			0,			false,		false);
			InitDataProperty(0, cnt++ , dtData,			70,		daRight,	true,	prefix+"crnt_rpm_pwr",			false,	"",			dfNone,			0,			false,		false);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH: // 조회
		if(validateForm(sheetObj,formObj,sAction)){
			...
			var sXml = sheetObj.GetSearchXml("VOP_VSK_0091GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
