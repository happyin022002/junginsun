...
<%@ page import="com.hanjin.apps.alps.vop.vsk.scheduleutilitymanagement.scheduletransmitmanagement.event.VopVsk0292Event"%>
...
<%
    VopVsk0292Event  	event 			= null;		//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopVsk0292Event)request.getAttribute("Event");
...
<html>
<head>
<title>Pre Stowage Plan(Auto TLX)</title>
...
<input type="hidden" name="vps_etd_dt" 			value="<%=vps_etd_dt%>"			>
<input type="hidden" name="ntc_eta_dt" 			value="<%=ntc_eta_dt%>"			>
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Pre Stowage Plan(Auto TLX)</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
								...
								<td>
									<table width="160" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr>
											...
											<td class="btn1" name="btn_save">TLX send</td>
