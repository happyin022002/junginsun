...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
	...
	/**
	 * @extends 
	 * @class vop_vsk_0220 : vop_vsk_0220 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
    	...
    	try {
            ...
            switch(srcName) {
                ...
                case "btn_pf_lane_help":
					var sUrl = "/hanjin/VOP_VSK_0212.do?vsl_slan_cd="+formObject.vsl_slan_cd.value;
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
           	...
           	case SEARCH:      // 콤보 정보 조회
				...
				var sXml = sheetObj.GetSearchXml("VOP_VSK_0220GS.do", sParam);
