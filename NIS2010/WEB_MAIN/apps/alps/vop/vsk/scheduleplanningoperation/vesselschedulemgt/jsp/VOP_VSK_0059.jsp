...
<%@ page import="com.hanjin.apps.alps.vop.vsk.scheduleplanningoperation.vesselschedulemgt.event.VopVsk0059Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="130"><input type="text" style="width:37;text-align:center;ime-mode:disabled;" class="input" value="" name="vsl_slan_cd" maxlength="3" tabindex="1">&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_search1"></td>
					<td width="80">Vessel Code</td>   
					<td width="160"><input type="text" style="width:60;text-align:center;ime-mode:disabled;" name="vsl_cd" maxlength="4" tabindex="2">&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_search2"></td>
					<td width="">&nbsp;</td>
					</tr>
				</table>
				<!--  biz_1   (E) -->
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left">
					<td class="btn1" name="btn_SkdClosing">SKD&nbsp;Closing</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
