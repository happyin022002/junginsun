...
<%@ page import="com.hanjin.apps.alps.vop.vsk.scheduleplanningoperation.vesselschedulemgt.event.VopVsk0010Event"%>
				...
				<tr class="h23">
				 --> 
					...
					<td width=""><select style="width:140;" name="voy_no_type" class="input">
						...
						<option value="3">Direction(Add One) + Seq</option></select>
