...
<%@ page import="com.hanjin.apps.alps.vop.vsk.scheduleplanningoperation.vesselschedulemgt.event.VopVsk0058Event"%>
...
<input type="hidden" name="bound" value="1">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="480"><input type="text" name="vsl_slan_cd" style="width:45;text-align:center;ime-mode:disabled;" class="input2" value="" maxlength="3" readonly="readonly"></td>
					<td width="90">Created Date</td>
					<td width=""><input type="text" name="cre_dt" style="width:110;text-align:center;"  class="input2" value="" readonly="readonly"></td>
					</tr>
				<tr class="h23">
					<td width="" colspan="4"></td>   
					<td width="">Updated Date</td>
					<td width=""><input type="text" name="upd_dt" style="width:110;text-align:center;"  class="input2" value="" readonly="readonly"></td>
					</tr>
				</table>
				...
				<table class="grid2" border="0" style="width:979;"> 
						<tr class="h23">
							...
							<td width=""><textarea name="skd_rmk"  style="width:100%;height:50;"></textarea></td></tr>
				</table>
			</td>
		</tr>	
		</table>
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<td class="btn2" name="btn_POut">P/Out</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_POutCal">P/Out Cancel</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td> -->
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_add_call">Add Call</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_add_call_cancel">Add Call Cancel</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_skip_call">Skip Call</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_skip_call_cancel">Skip Call Cancel</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_reverse_call">Reverse Call</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
					</tr></table>
