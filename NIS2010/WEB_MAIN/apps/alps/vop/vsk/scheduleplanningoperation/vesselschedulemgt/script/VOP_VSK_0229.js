...
/**
 * @extends
 * @class VOP_VSK_0229 : VOP_VSK_0229 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: // sheet1 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 				175,	daCenter, false, "bkg_no", false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 				30,	daCenter, false, "bkg_sts", false, "", dfNone, 0, true, true);
		}
		break;
	...
	case IBSEARCH: // 조회
		...
		if (validateForm(sheetObj, formObj, sAction))
			if (sheetObj.id == "sheet1") {
				...
				var sXml = sheetObj.GetSearchXml("VOP_VSK_0229GS.do", sParam);
				if (sXml != ""){
