...
<%@ page import="com.hanjin.apps.alps.vop.vsk.vesseloperationsupportmgt.laneinformationmgt.event.VopVsk0510Event"%>
...
<input type="hidden" name="laneNm" value="<%=laneNm%>">
       	...
       	<tr><td class="bg" style="height:438" valign="top">	
			...
			<table width="100%" class="button"> 
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn2" name="btn_t1DLGroup">Lane Group</td>
		...
		<table class="search" id="mainTable"> 
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr>
					...
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2add1">Row Add</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2insert1">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2del1">Row Delete</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2add2">Row Add</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2insert2">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2del2">Row Delete</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
			...
			<!-- Grid - 4 (S) -->
				<table width="100%"  id="mainTable" style="display:none;"> 
					<tr>
						<td width="100%">
							<script language="javascript">ComSheetObject('t2sheet4');</script>
						</td>
					</tr>
				</table>			
			<!-- Grid - 4 (E) -->				
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2add3">Row Add</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2insert3">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2del3">Row Delete</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t3insert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
