	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="35">Port</td>					
					<td width="120"><input type="text" name="loc_cd" style="width:60;text-align:center;ime-mode:disabled;" class="input1" value="" dataformat="uppernum" maxlength="5" caption="Vessel Code">&nbsp;<img src="img/btns_search.gif" width="19" height="20" name="btn_loc_cd" border="0" align="absmiddle" class="cursor"></td>
					<td width="35">RHQ </td>
					<td width="110">
...
<div id="tabLayer" style="display:inline">
    ...
    <tr><td class="bg" style="height:400" valign="top">
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t1insert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t1del">Row Delete</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
			...
			<tr>
				...
				<td width="%" rowspan="2"> <textarea name="mnvr_rmk" style="width:100%;height:65"></textarea></td>
 				</tr>
			</table> 
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t4insert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t5insert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
    ...
    <tr><td class="bg" style="height:438" valign="top">
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6insert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
		...
		<table class="height_8"><tr><td></td></tr></table>
			...
			<tr class="tr_head2"></tr>
				<tr>
				<td width="15%" class="tr2_head" rowspan="2"> Remark(s)	</td>
				<td width="%" rowspan="2"> <textarea name="trsp_rmk_td" style="width:100%;height:60"></textarea></td>
 				</tr>
			</table> 			
...
<div id="tabLayer" style="display:none">
    ...
    <tr><td class="bg" style="height:438" valign="top">
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t7insert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
			...
			<tr class="tr_head2"></tr>
				<tr>
				<td width="15%" class="tr2_head" rowspan="2"> Remark(s)	</td>
				<td width="%" rowspan="2"> <textarea name="trsp_rmk_rd" style="width:100%;height:60"></textarea></td>
 				</tr>
			</table> 	
