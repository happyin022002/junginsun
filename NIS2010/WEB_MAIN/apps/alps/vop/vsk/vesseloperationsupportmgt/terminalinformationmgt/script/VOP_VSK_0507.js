...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_vsk_0507 : vop_vsk_0507 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_vsk_0507() {
...
//G/Crane Special Cargo Handling Information Remark 저장변수//
var gSpclCgoHndlRmk	= "";
...
/** tab [ G/Crane ] (S) **/
						...
						case "btn_t1RowAdd":
								...
								//yardCdCellComboInit(sheetObject1, row);
								sheetObject1.SelectCell(row, "t1sheet1_yd_cd", true);
								sheetObject1.CellValue2(row, "t1sheet1_spcl_cgo_hndl_rmk")	= gSpclCgoHndlRmk;
								break;
						...
						case "VskOpenPopupPortGantryCraneHandlingInfoAttachFile":
							...
							var sParam	= "port_cd="+tml_cd.substring(0,5);
							////alert('sParam === ['+sParam+']');
...
/** tab [ F/Crane ] (S) **/
						...
						case "btn_t2RowAdd":
								...
								//sheetObject2.CellValue(row, "t2sheet1_loc_cd") = document.form.loc_cd.value;
...
/** tab [ Berth Window ] (S) **/
						...
						case "btn_t4RowAdd":
								...
								sheetObject4.CellValue(row, "t4sheet1_loc_cd") = formObject.loc_cd.value;
								if(row > 1){
									sheetObject4.CellValue(row, "t4sheet1_yd_cd") = sheetObject4.CellValue(row - 1, "t4sheet1_yd_cd");
								}
...
/** tab [ Berth Window ] (E) **/
						...
						case "btn_New":
							...
							/*
							if(statsCnt > 0){
								if(ComShowCodeConfirm("VSK50009", changeSheet)){
    ...
    */
    function initControl() {
    	...
    	axon_event.addListener('change', 'spcl_cgo_hndl_rmk_onchange', 'spcl_cgo_hndl_rmk', '');		//Remark변경시에 처리되는 로직...
  ...
  /**
        ...
        switch(sheetID) {
            ...
            case "t1sheet1":
                with (sheetObj) {
					...
					var HeadTitle1 = "|Sel.|TMNL Code|TMNL Name|Max Weight with\nSpreader (Ton)|Max Weight without\nSpreader (Ton)|Clearance between\nLegs (M)|Reach\nRows|Tier|G/Crane Q’ty|G/Crane Q’ty|Remark|Special Remark|file-knt|upd_usr_id|upd_usr_id";
					var HeadTitle2 = "|Sel.|TMNL Code|TMNL Name|Max Weight with\nSpreader (Ton)|Max Weight without\nSpreader (Ton)|Clearance between\nLegs (M)|Reach\nRows|Tier|Total gang in TMNL|Max gang per Vessel|Remark|Special Remark|file-knt|upd_usr_id|upd_usr_id";
					...
					InitDataProperty(0, cnt++ , dtComboEdit,			100,	daCenter,	true,		prefix + "yd_cd",					true,		"",		dfNone,			0,		false,		true, 7);
					InitDataProperty(0, cnt++ , dtData,					100,	daLeft,		true,		prefix + "yd_nm",					false,		"",		dfNone,			0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,					120,	daRight,	true,		prefix + "grs_max_wgt",				false,		"",		dfFloat,		1,		true,		true, 7);
					InitDataProperty(0, cnt++ , dtData,					120,	daRight,	true,		prefix + "net_max_wgt",				false,		"",		dfFloat,		1,		true,		true, 7);
					InitDataProperty(0, cnt++ , dtData,					120,	daRight,	true,		prefix + "clr_btwn_leg_wdt",		false,		"",		dfFloat,		1,		true,		true, 8);
					...
					InitDataProperty(0, cnt++ , dtData,					150,	daRight,	true,		prefix + "ttl_gntr_crn_qty",		false,		"",		dfInteger,		0,		true,		true, 6);
					InitDataProperty(0, cnt++ , dtData,					100,	daRight,	true,		prefix + "vsl_gntr_crn_max_qty",	false,		"",		dfInteger,		0,		true,		true, 6);
					...
					InitDataProperty(0, cnt++ , dtHidden,				100,	daRight,	true,		prefix + "upd_usr_id",				false,		"",		dfNone,			0,		true,		true);
					InitDataProperty(0, cnt++ , dtHidden,				100,	daRight,	true,		prefix + "upd_dt",					false,		"",		dfNone,			0,		true,		true);
            ...
            case "t2sheet1":
                with (sheetObj) {                                                                                                                                                                                                                 
					...
					var HeadTitle1 = "|Sel.|Port|Seq.|Handling Cargo Weight (Ton)|Handling Cargo Height (M)|Crane Reach (M)|Handling Cost|Remark(s)|upd_usr_id|upd_usr_id";                                                                              
					var headCount = ComCountHeadTitle(HeadTitle1);                                                                                                                                                            
					...
					InitDataProperty(0, cnt++ , dtData,					200,	daRight,	false,		prefix + "max_hndl_cgo_wgt",	false,		"",	dfFloat,	1,	true,	true, 7);
					InitDataProperty(0, cnt++ , dtData,					200,	daRight,	false,		prefix + "max_hndl_cgo_hgt",	false,		"",	dfFloat,	1,	true,	true, 6);
					InitDataProperty(0, cnt++ , dtData,					180,	daRight,	false,		prefix + "max_rch_len",			false,		"",	dfFloat,	1,	true,	true, 8);        
            ...
            case "t3sheet1":
                with (sheetObj) {
					...
					InitDataProperty(0, cnt++ , dtHiddenStatus,			30,		daCenter,	false,		prefix + "ibflag");                                                                                                                                 
					InitDataProperty(0, cnt++ , dtCheckBox,				50,		daCenter,	false,		prefix + "del_chk");
					InitDataProperty(0, cnt++ , dtComboEdit,			80,		daCenter,	true,		prefix + "loc_cd",				true,		"",	dfNone,			0,		false,		true, 5);
					InitDataProperty(0, cnt++ , dtData,					30,		daCenter,	false,		prefix + "crn_seq",				false,		"",	dfInteger,		1,		false,		false);
            ...
            case "t4sheet1":
                with (sheetObj) {
					...
					*/
					...
					InitDataProperty(0, cnt++ , dtComboEdit,			85,		daCenter,	true,		prefix + "yd_cd",		true,	"",	dfNone,			0,	false,	true, 7);
					InitDataProperty(0, cnt++ , dtData,					90,		daLeft,		false,		prefix + "yd_nm",		false,	"",	dfNone,			0,	false,	true);
					...
					InitDataProperty(0, cnt++ , dtPopupEdit,			70,		daLeft,		false,		prefix + "crr_cd",		false,	"",	dfEngUpKey,		0,	true,	true, 3);
					InitDataProperty(0, cnt++ , dtHidden,				100,	daRight,	true,		prefix + "upd_usr_id",	false,	"",	dfNone,			0,	true,	true);
    ...
    function doActionIBSheet(sheetObj, formObj, sAction) {
			...
			switch(sAction) {
							...
							if(validateForm(sheetObj,formObj,sAction)){
								...
								if (sheetObj.id == "t1sheet1"){
									...
									if(arrCombo != null){
										...
										sheetObj.InitDataCombo(0, "t2sheet1_loc_cd", " |"+vInitDataComboName, " |"+arrCombo[0]);
									}										
									...
									if(arrCombo != null){
										...
										sheetObj.InitDataCombo(0, "t3sheet1_loc_cd", " |"+vInitDataComboName, " |"+arrCombo[0]);
									}									
					...
					case IBSAVE:			//저장
						/*
							duplCheck(sheetObjects[0], Row, Col, Value, "t1sheet1_yd_cd");	//imdg_segr_grp_no Value Duplication Check
							duplCheck(sheetObjects[3], Row, Col, Value, "t4sheet1_yd_cd|t4sheet1_slan_cd|t4sheet1_skd_dir_cd|t4sheet1_crr_cd");	//imdg_segr_grp_no Value Duplication Check
							
							if(sheetObjects[0].ColValueDup("t1sheet1_yd_cd") != ""){
						...
						*/
							...
							var sXml = sheetObjects[beforetab].GetSaveXml("VOP_VSK_0507GS.do", sParam);
	...
	function t1sheet1_OnSearchEnd(sheetObj, ErrMsg){
		if(sheetObj.RowCount > 0){
			...
			gSpclCgoHndlRmk							= document.form.spcl_cgo_hndl_rmk.value;	
    ...
    function t1sheet1_OnChange(sheetObj,Row, Col, Value) {
		if(sheetObj.ColSaveName(Col) == "t1sheet1_yd_cd"){
			...
			if(
			   sheetObj.CellValue(Row, "t1sheet1_grs_max_wgt") != "0" && 
				sheetObj.CellValue(Row, "t1sheet1_net_max_wgt") != "0" &&
				  ( parseInt(sheetObj.CellValue(Row, "t1sheet1_grs_max_wgt")) >
					parseInt(sheetObj.CellValue(Row, "t1sheet1_net_max_wgt")) )
			)
			{
				ComShowCodeMessage("VSK57015", "Max Weight without Spreader", "Max Weight with Spreader");
				sheetObj.CellValue(Row, "t1sheet1_grs_max_wgt") = "";
				sheetObj.CellValue(Row, "t1sheet1_net_max_wgt") = "";
			}
		}
   	}
    ...
    var checkyDcDFlg2 = false;  //Tmml Code 체크 플러그        
	...
	function t2sheet1_OnChange(sheetObj, Row, Col, Value){
		...
		if(sheetObj.ColSaveName(Col) == prefix + "loc_cd"){
			...
			/*
				조회조건의 Port코드가 다르게되면. Max + 1이 세팅이 되고. 
				만약 쉬트내에 있다면. 같은 Port가 됨...
			*/
			if(checkyDcDFlg2){
				var maxSeq = 0;
				var loc_cd = sheetObj.CellValue(Row,  prefix + "loc_cd");
				for(var cnt = 0; cnt <= sheetObj.RowCount; cnt++){
					if(cnt != Row && sheetObj.CellValue(cnt,  prefix + "loc_cd") == loc_cd && 
					   maxSeq < parseInt(sheetObj.CellValue(cnt,  prefix + "crn_seq"))){
						maxSeq = parseInt(sheetObj.CellValue(cnt,  prefix + "crn_seq"));
					}
				}
				...
				if(maxSeq == 0){
					...
					sheetObjects[4].DoSearch("VOP_VSK_0507GS.do", FormQueryString(document.form) + "&table_flag=1&tmp_loc_cd=" + sheetObj.CellValue(Row,  prefix + "loc_cd")  + "&" +  ComGetPrefixParam("sheet1_"));
				}else{
					sheetObj.CellValue(Row, prefix + "crn_seq") = maxSeq + 1;
					sheetObj.SelectCell(Row, "t2sheet1_max_hndl_cgo_wgt", true);
				}
			}
		}
	}
    ...
    var checkyDcDFlg3 = false;  //Tmml Code 체크 플러그        
	...
	function t3sheet1_OnChange(sheetObj, Row, Col, Value){
		...
		if(sheetObj.ColSaveName(Col) == prefix + "loc_cd"){
			...
			if(!checkyDcDFlg3){
				//7자리 체크 및 유효 TMNL Code 체크 
				if(sheetObj.CellValue(Row, "t3sheet1_loc_cd") != "" ){
					if(sheetObj.CellValue(Row, "t3sheet1_loc_cd").length < 5){
						ComShowCodeMessage("VSK50025");
						sheetObj.CellValue(Row, Col) = "";
						sheetObj.CellValue(Row, Col + 1) = "";
						sheetObj.SelectCell(Row, "t3sheet1_loc_cd", true);
			...
			*/
			if(checkyDcDFlg3){
				...
				if(maxSeq == 0){
					document.form.f_cmd.value = SEARCH05;
					sheetObjects[4].DoSearch("VOP_VSK_0507GS.do", FormQueryString(document.form) + "&table_flag=2&tmp_loc_cd=" + sheetObj.CellValue(Row,  prefix + "loc_cd") + "&" + ComGetPrefixParam("sheet1_"));
				}else{
					sheetObj.CellValue(Row, prefix + "crn_seq") = maxSeq + 1;
				}
			}
    ...
    var checkyDcDFlg4 = false;  //Tmml Code 체크 플러그        
    var checkLane = false;  //Tmml Code 체크 플러그        
    var checkCarrier = false;  //Tmml Code 체크 플러그        
    ...
    function t4sheet1_OnChange(sheetObj,Row, Col, Value) {
		if(sheetObj.ColSaveName(Col) == "t4sheet1_yd_cd" ||
		   sheetObj.ColSaveName(Col) == "t4sheet1_slan_cd" ||
		   sheetObj.ColSaveName(Col) == "t4sheet1_skd_dir_cd" ||
		   sheetObj.ColSaveName(Col) == "t4sheet1_crr_cd" 	){
    		//duplCheck(sheetObj, Row, Col, Value, "t4sheet1_yd_cd|t4sheet1_slan_cd|t4sheet1_skd_dir_cd|t4sheet1_crr_cd");	//imdg_segr_grp_no Value Duplication Check
		}
		...
		if(sheetObj.ColSaveName(Col) == "t4sheet1_yd_cd"){
			...
			if(!checkyDcDFlg4){
				//7자리 체크 및 유효 TMNL Code 체크 
				if(sheetObj.CellValue(Row, "t4sheet1_yd_cd") != "" ){
					if(sheetObj.CellValue(Row, "t4sheet1_yd_cd").length < 7){
						ComShowCodeMessage("VSK50018");
					}else{
						ComShowCodeMessage("VSK50020");
					}
				}
				sheetObj.CellValue(Row, "t4sheet1_yd_cd") = "";
				sheetObj.SelectCell(Row, "t4sheet1_yd_cd", true);
			}else{
				var sText = sheetObj.GetComboInfo(Row, Col, "Text");
				var arrText = sText.split("|");
				...
				sheetObj.CellValue(Row, "t4sheet1_yd_nm") = vText[1];
			}
		}
   	}
...
/*
		if(sheetObj.CellValue(OldRow, "t4sheet1_slan_cd") != "" && sheetObj.ColSaveName(OldCol) == "t4sheet1_slan_cd" && mCheckValue){
			if(sheetObj.CellValue(OldRow, "t4sheet1_slan_cd").length < 3){
				ComShowCodeMessage("VSK50027");
				sheetObj.SelectCell(OldRow, "t4sheet1_slan_cd", true);
			}else{
				document.form.f_cmd.value = SEARCH03;
				mEditRow = OldRow;
				sheetObjects[4].DoSearch("VOP_VSK_UTILGS.do", FormQueryString(document.form) + "&" + ComGetPrefixParam("sheet1_") + "&vsl_slan_cd=" + sheetObj.CellValue(OldRow, "t4sheet1_slan_cd"));
			}
		}
		
		if(sheetObj.CellValue(OldRow, "t4sheet1_crr_cd") != "" && sheetObj.ColSaveName(OldCol) == "t4sheet1_crr_cd" && mCheckValue){
			if(sheetObj.CellValue(OldRow, "t4sheet1_crr_cd").length < 3){
				ComShowCodeMessage("VSK50029");
				sheetObj.SelectCell(OldRow, "t4sheet1_crr_cd", true);
			}else{
				document.form.f_cmd.value = SEARCH04;
				mEditRow = OldRow;
				sheetObjects[4].DoSearch("VOP_VSK_UTILGS.do", FormQueryString(document.form) + "&" + ComGetPrefixParam("sheet1_") + "&crr_cd=" + sheetObj.CellValue(OldRow, "t4sheet1_crr_cd"));
			}
		}
*/
	}
	...
	function t4sheet1_OnDblClick(sheetObj, Row, Col){
		if(Col > sheetObj.SaveNameCol("t4sheet1_upd_dt"))
			ComOpenPopupWithTarget('/hanjin/VOP_VSK_0703.do?enableForm=Y', 500, 275, "loc_cd:loc_cd", "0,1,1,1,1,1,1", true);
	}

	function t4sheet1_OnPopupClick(sheetObj, Row, Col){
		if(sheetObj.ColSaveName(Col) == "t4sheet1_ref_slan_nm"){
			ComOpenPopup('/hanjin/COM_ENS_081.do', 830, 450, 'setLaneInfo', '0,0,1,1,1,1', false, false, Row, Col, 0);
		}else if(sheetObj.ColSaveName(Col) == "t4sheet1_crr_cd"){
			ComOpenPopup("COM_ENS_0N1.do", 500, 450, "setVslOprTpCd", "0,0,1,1,1,1", false, false, Row, Col, 0);
		}
	}
	...
	function sheet1_OnSearchEnd(sheetObj, ErrMsg){
		...
		if(sheetObj.RowCount > 0){
			if(document.form.f_cmd.value == SEARCH05){
				...
				var sXml = sheetObjects[1].GetSearchXml("VOP_VSK_0507GS.do", FormQueryString(document.form));
				...
				if(arrCombo != null){
					...
					sheetObjects[0].InitDataCombo(0, "t1sheet1_yd_cd", " |" + vInitDataComboName, " |" + arrCombo[0]);
					sheetObjects[3].InitDataCombo(0, "t4sheet1_yd_cd", " |" + vInitDataComboName, " |" + arrCombo[0]);
				}
			}
		}else{
	...
	function gntr_rmk_onchange(){
		if(sheetObjects[0].SelectRow > 0){
			sheetObjects[0].CellValue(sheetObjects[0].SelectRow , "t1sheet1_gntr_rmk") = document.form.gntr_rmk.value;
		}
	}
	
	//::jskjsk::2013-03-19:://
	function spcl_cgo_hndl_rmk_onchange(){
		
		//alert(sheetObjects[0].RowCount);
		
		if(sheetObjects[0].SelectRow > 0){
			for(var i=2; i<=sheetObjects[0].RowCount+1; i++){
				sheetObjects[0].CellValue(i , "t1sheet1_spcl_cgo_hndl_rmk") = document.form.spcl_cgo_hndl_rmk.value;	
				gSpclCgoHndlRmk												= document.form.spcl_cgo_hndl_rmk.value;	
			}
		}
	}	
	...
	function fltg_rmk_onchange(){
		if(sheetObjects[1].SelectRow > 0){
			sheetObjects[1].CellValue(sheetObjects[1].SelectRow , "t2sheet1_fltg_rmk") = document.form.fltg_rmk.value;
		}
	}
...
/*
		...
		var arr = new Array("", "", "");
		var sXml = sheetObjects[1].GetSearchXml("VOP_VSK_0507GS.do", FormQueryString(document.form) + "&" + ComGetPrefixParam(arr));
		var arrXml = sXml.split("|$$|");
*/
		/*
    ...
    /**
	 * 파일첨부팝업에서 첨부파일건수를 받아온다<br>
	 * @param {arry} aryPopupData
	 */
    function setAtchFileKnt(atchFileKnt){
		 //alert(atchFileKnt);
		 document.form.atch_file_knt.value = atchFileKnt;
    }	 
