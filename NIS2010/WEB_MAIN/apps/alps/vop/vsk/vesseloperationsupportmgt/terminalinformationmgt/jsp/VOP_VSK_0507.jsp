...
<%@ page import="com.hanjin.apps.alps.vop.vsk.vesseloperationsupportmgt.terminalinformationmgt.event.VopVsk0507Event"%>
	...
	<tr><td valign="top">
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
					<td width="35">Port</td>
					<td width="100"><input type="text" style="width:60;text-align:center;" class="input1" value="" name="loc_cd" maxlength="5" fullfill caption="Port Code" style="ime-mode:disabled">&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="ComOpenPopupWithTarget"></td>
					<td width="35">RHQ</td>
					<td width="100">
						<div id="enablePorRhq" style="display:none;"><script language="javascript">ComComboObject('por_rhq');</script></div>
						<div id="disablePorRhq" style="display:inline;"><input type="text" style="width:80;text-align:center;" class="input2" value="" name="por_rhq_diable" readonly></div>
					</td>
					<td width="450"></td>
...
<div id="tabLayer" style="display:inline">
		...
		<table class="search" id="mainTable">
			...
			<tr class="tr_head2"></tr>
				...
				<td width="%" rowspan="2"> <textarea style="width:100%;height:60" name="gntr_rmk" style="ime-mode:disabled"></textarea></td>
 				</tr>
			</table>
...
<div id="tabLayer" style="display:none">
		...
		<table class="search" id="mainTable"> 
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2RowInsert">Row Insert</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t2DownExcel1">Down Excel</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
			...
			<tr class="tr_head2"></tr>
				<td width="15%" class="tr2_head" rowspan="2"> Remark(s)	</td>
				<td width="%" rowspan="2"> <textarea style="width:100%;height:60" name="fltg_rmk" style="ime-mode:disabled"></textarea></td>
 				</tr>
			</table> 
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t3DownExcel1">Down Excel</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t4DownExcel1">Down Excel</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
