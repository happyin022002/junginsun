...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class vop_vsk_0514 : vop_vsk_0514 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function vop_vsk_0514() {
  ...
  // Sheet관련 프로세스 처리
	...
	function sheet1_OnSearchEnd(sheetObj, ErrMsg)
	{
		with(sheetObj)
		{
			var color1 = RgbColor(229, 234, 255);
			var color2 = RgbColor(230, 254, 197);
				
			ColBackColor("Date") = color1;
			ColBackColor("FirstTime1") = color2;
			ColBackColor("FirstTime2") = color2;
			ColBackColor("SecondTime1") = color2;
			ColBackColor("SecondTime2") = color2;
		}
	}
