...
<%@ page import="com.hanjin.apps.alps.vop.vsk.vesseloperationsupportmgt.shatideinformationmgt.event.VopVsk0514Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg" style="height:504" valign="top">	
				...
				<tr class="h23">
					...
					<td width=""><input type="text" name="upd_usr_id" style="width:80;" class="input2" readOnly></td>	
				</tr> 
				</table>				
				<!--  biz_1   (E) -->
