...
<%
	...
	try {
		...
		uiFlg = JSPUtil.replaceForHTML(request.getParameter("uiFlg"));
...
<html>
<head>
<title>Simulation No. Help</title>
...
<input type="hidden" name="uiflg"  value="<%=uiFlg%>">
<!-- 개발자 작업	-->
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Simulation No. Inquiry </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td ><input type="text" style="width:50;ime-mode:disabled;text-align:center" name="vsl_slan_cd" class="input" maxlength="3" dataformat="uppernum" value="<%=vsl_slan_cd%>" tabIndex="1" onKeyPress="if(event.keyCode==13) doSearch();">&nbsp;<img src="img/btns_search.gif" name="btns_search"  class="cursor" width="19" height="20" border="0" align="absmiddle"></td></tr>
				</table>
				<!--  biz_1   (E) -->
				<!-- : ( Grid ) (S) -->
