...
<%
	...
	try {
		...
		ctrlCd = JSPUtil.replaceForHTML(request.getParameter("ctrl_cd"));
...
<input type="hidden" name="ctrl_cd" value="<%=ctrlCd %>">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;VVD Code Inquiry </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
