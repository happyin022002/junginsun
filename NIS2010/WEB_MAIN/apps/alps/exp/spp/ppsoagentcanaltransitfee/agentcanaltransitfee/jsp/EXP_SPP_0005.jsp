...
<%@ page import="com.hanjin.apps.alps.exp.spp.ppsoagentcanaltransitfee.agentcanaltransitfee.event.ExpSpp0005Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="">
						  <input type="text" name="str_dt" 	 dataformat="ymd"    caption="시작일"    maxlength="8"  size="10"  cofield="end_dt" value="">   
                  		~ <input type="text" name="end_dt"   dataformat="ymd"    caption="종료일"    maxlength="8"  size="10"  cofield="str_dt">
