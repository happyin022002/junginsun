...
<%@ page import="com.hanjin.apps.alps.exp.spp.plseinvoiceinquiry.invoiceinquiry.event.ExpSpp0302Event"%>
...
<%
	...
	String strVndr_nm		= "";
	String strAdm_chk		= "0";
	Logger log = Logger.getLogger("com.hanjin.apps.alps.exp.spp.plseinvoiceinquiry.invoiceinquiry");
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="">	<input type="text" name="str_dt"   caption="From Date" style="width:62;text-align:center;" class="input1" value="" maxlength="8" dataformat="ymd" cofield="end_dt"   required>
									~
									<input type="text" name="end_dt"   caption="To Date"   style="width:62;text-align:center;" class="input1" value="" maxlength="8" dataformat="ymd" cofield="str_dt"   required>
