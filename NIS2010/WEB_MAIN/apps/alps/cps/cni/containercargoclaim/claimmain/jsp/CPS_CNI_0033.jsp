...
<input type="hidden" name="popupYn" value="<%=popupYn%>">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <% if ("Y".equals(popupYn)) { %>
        <tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">  Claim Main View</td></tr>
        <% } else { %>
			...
			<tr>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td width="120"><input type="text" name="cgo_clm_no" dataformat="engup"  fullfill maxlength="10" class="input1"
						...
						<td width="116"><input type="text" name="hdlr_usr_id" style="width: 75;text-align:center"
		...
		<table class="search">
			<tr>
					...
					<tr class="h23">
						...
						<table class="search" border="0" style="width: ;">
							<tr class="h23">
								...
								<td width="105"><input type="text" dataformat="engup" name="cgo_clm_ref_bl_no"  caption="B/L No."
								...
								<td width="85">
									<table width="80" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td>
											<td class="btn2_3" name="btns_BL_Preview" >B/L View</td>
											<td class="btn2_right"></td>
										</tr>
									</table>
								</td>
								<td width="30" title="Date of Loading">DOL</td>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						<td width="74" title="Notice Of Preliminary Claim">&nbsp;&nbsp;DON</td>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td width="124"><input type="text" name="cgo_clm_tp_cd" style="width: 60;text-align:center" dataformat="engup"
							value="" maxlength="3" class="input2" readonly="readonly" caption="TOC">&nbsp;</td>
						<td width="40" title="Cause of Damage / Loss">CODL</td>
						<td width="70"><input type="text" name="mjr_clm_dmg_lss_cd" style="width: 40;text-align:center" dataformat="engup"
							value="" maxlength="2" class="input2" readonly="readonly">&nbsp;</td>
						<td width="105" title="No 3rd Liable Party">3rd Liable Party</td>
						<td width="70"><input type="text" name="n3rd_labl_pty_cd" style="width: 50;text-align:center" dataformat="engup"
							value="" maxlength="3" class="input2" readonly="readonly">&nbsp;</td>
						<td width="25" title="Place of Incident">POI</td>
						<td width="57"><input type="text" name="inci_plc_tp_cd" style="width: 35;text-align:center" dataformat="engup"
							value="" maxlength="3" class="input2" readonly="readonly">&nbsp;</td>
						<td width="25" title="Date of Incident">DOI</td>
						<td width="98"><input type="text" name="inci_occr_dt"
