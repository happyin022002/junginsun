...
<%@page import="com.hanjin.apps.alps.cps.cni.containercargoclaim.incidentsurvey.event.CpsCni0013Event"%>
...
<table class="search" id="mainTable">
    <tr><td class="bg">
			...
			<tr class="h23">
				...
				<td width="100"><input type="text" style="width:76;text-align:center" name="upd_dt1" value="" class="input2"  readonly></td>
			...
			<tr class="h23">
				...
				<td width="35" title="Time Bar Date">DOTB</td>
			...
			<tr class="h23">
				...
				<td width="250"><input type="text" style="width:45;text-align:center" name="clm_cgo_tp_cd" value="" class="input2"  readonly>&nbsp;<input type="text" style="width:195;" name="cgo_qlty_desc" value="" class="input2"  readonly></td>
				<td width="95">Claim Amount</td>
				<td width="182" class="stm" align="right"><input type="text" style="width:165;text-align:right" name="clmt_usd_amt" value="" class="input2" readonly dataformat="float">&nbsp;&nbsp;USD</td>
				</tr>
			...
			<tr class="h23">
				<td width="57">Lane</td>
				<td width="93"><input type="text" style="width:50;text-align:center" name="slan_cd" value="" class="input2" readonly></td>
				...
				<td width="104">Insurer Ref No.</td>
			...
			<table class="search" border="0" style="width:979;">
			<tr class="h23">
				<td width="67">Salvager</td>
				<td width="333"><input type="hidden" style="width:80;" name="clm_pty_no" value="" class="input1" required caption="Salvager"><input type="text" style="width:80;" name="clm_pty_abbr_nm2" value="" class="input1" readonly required caption="Salvager">&nbsp;<img src="img/btns_search.gif" name="btns_salvager" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">&nbsp;<input type="text" style="width:220;" name="pty_nm" value="" class="input2" readonly ></td>
				...
				<td width="50"></td>
				<td width="144"></td>
				<td width="68">SL Ref No.</td>
				<td width=""><input type="text" style="width:100;text-align:center;ime-mode:disabled" name="ref_slv_no" value="" class="input" maxlength="20"></td>
			...
			<table class="search" border="0" style="width:979;">
			<tr class="h23">
				<td width="110">Salvaged Date</td>
				<td width="152"><input type="text" style="width:76;text-align:center" name="slv_dt" value="" class="input" dataformat="ymd" maxlength="8"  minlength="8">&nbsp;<img class="cursor" src="img/btns_calendar.gif" name="btns_date_cal1" width="19" height="20" border="0" align="absmiddle"></td>
				<td width="72">SL Updater</td>
				<td width="144"><input type="text" style="width:68;text-align:center" name="upd_usr_id" value="" readonly class="input2"></td>
				<td width="50">SL DOU</td>
				<td width=""><input type="text" style="width:80;text-align:center" name="upd_dt2" value="" readonly class="input2"></td>
				</tr>
			</table>
			<table class="search" border="0" style="width:100%;">
				<tr class="h23">
					<td width="110">Salvage Amount</td>
					<td width="230" class="stm"><input type="text" style="width:150;text-align:right;ime-mode:disabled" class="input" name="slv_locl_amt" value="" dataformat="float" maxlength="19" pointcount="2"  caption="Salvage Amount">&nbsp;<input type="text" style="width:38;" class="input" name="slv_locl_curr_cd" value="" maxlength="3" minlength="3" style="text-align:center;ime-mode:disabled" >&nbsp;<img src="img/btns_search.gif" name="btns_currency" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					<td width="40" title="Rate Of Exchange">R.O.E</td>
					<td width="" class="stm"><input type="text" style="width:80;text-align:right;ime-mode:disabled" class="input" name="slv_xch_rt" value="" dataformat="float" maxlength="12" pointcount="5" caption="R.O.E" >&nbsp;<img src="img/btns_search.gif" name="btns_roe" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">&nbsp;<input type="text" style="width:146;text-align:right;ime-mode:disabled" class="input2" name="slv_usd_amt" value="" dataformat="float" maxlength="19" pointcount="2" readonly>&nbsp;&nbsp;USD</td>
				   </tr>
				</table>
			...
			<table class="search" border="0">
				<tr><td class="title_h"></td>
					<td class="title_s">DV & Result</td></tr>
				</table>
			<table border="0" style="width:100%; background-color:white;" class="grid2">
				<tr>
					<td><textarea name="slv_desc" caption="DV & Result" style="width:100%;ime-mode:disabled" rows="20" class="textarea1" required></textarea></td>
				</tr>
			</table>
