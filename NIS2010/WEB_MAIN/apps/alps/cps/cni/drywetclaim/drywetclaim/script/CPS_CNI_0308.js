...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class Vessel Code & Name Inquiry : Vessel Code & Name Inquiry 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function CPS_CNI_0308() {
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtData,		40,		daCenter,	true,		"tov",				false,  "",	dfNone,		0,	false,		false);
					InitDataProperty(0, cnt++ , dtData,		40,		daCenter,	true,		"vsl_own_ind_cd",	false,  "",	dfNone,		0,	false,		false);
					InitDataProperty(0, cnt++ , dtData,		65,		daCenter,	true,		"lnch_dt",			false,  "",	dfDateYmd,	0,	false,		false);
					InitDataProperty(0, cnt++ , dtData,		110,	daLeft,		true,		"cnt_nm",			false,  "",	dfNone,		0,	false,		false);
					InitDataProperty(0, cnt++ , dtData,		70,		daRight,	true,		"grs_rgst_tong_wgt",false,  "",	dfFloat,	3,	false,		false);
					InitDataProperty(0, cnt++ , dtData,		183,	daLeft,		true,		"crr_nm",			false,  "",	dfNone,		0,	false,		false);
               }
               break;
        }
    }
	...
	*/
	function sheet1_OnDblClick(sheetObj, row, col) {	
		...
		var vslVo = {
			vsl_cd:sheetObj.CellValue(row , "vsl_cd"),
