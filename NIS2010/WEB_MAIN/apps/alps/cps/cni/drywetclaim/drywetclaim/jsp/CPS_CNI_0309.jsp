		    ...
		    <tr><td class="bg">	
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width=""><input type="text" name="dw_clm_no" style="width:90;" class="input1" maxlength="11" required dataformat="eng" fullfill caption="Case No." style="ime-mode:disabled" value="<%=dwClmNo%>"></td>
					</tr>
				</table> 
