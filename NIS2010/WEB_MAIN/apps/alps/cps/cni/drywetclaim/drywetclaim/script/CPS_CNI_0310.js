...
function obj_keypress() {
 ...
 function obj_keyup() {
     ...
     case "dw_clm_no":
     	ComKeyOnlyAlphabet('uppernum');
     	if (frm.dw_clm_no.value.length == 11) {
     		doActionIBSheet(SEARCHLIST01);
  		}
  		break;
  	}
...
function processButtonClick() {
	...
	try {
		...
		case "btn2_Manager":
			...
			var claim_no = frm.dw_clm_no.value
			var param = "dw_clm_no=" + claim_no ;
			var url = "CPS_CNI_0311.do?" + param;
