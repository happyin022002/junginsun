...
<!-- 개발자 작업 -->
<input type="hidden" name="mgr_hdlr_div_cd">
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; Handler History</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td><input type="text" style="width:100;text-align:center" class="input1" name="cgo_clm_no" maxlength="10" style="ime-mode:disabled" value="<%=cgoClmNo%>"></td>
				</tr>
				</table>
		 <!-- Grid  (S) -->
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<td class="btn2_3" name="btn2_Manager">Manager</td>
