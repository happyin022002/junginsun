...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class CPS_CNI_0096 : CPS_CNI_0096 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function CPS_CNI_0096() {
        ...
        switch(sheetID) {
            ...
            case "sheet1":
                with (sheetObj) {
                    ...
                    var HeadTitle1 = "||Seq.|User ID.|Role Code|User Role Desc|Creation User ID|Created Date|Updated User ID|Updated Date";
                    ...
                    InitDataProperty( 0 , cnt++ , dtData 			, 100  	, daLeft   	, true 	, "usr_id"    		, true 	, "" , dfNone,	0, false,	false	, 20	);
                    InitDataProperty( 0 , cnt++ , dtCombo	 		, 80  	, daCenter 	, true 	, "usr_role_cd"    	, true 	, "" , dfNone,	0, false,	false );
                    InitDataProperty( 0 , cnt++ , dtData 			, 350 	, daLeft   	, true 	, "user_role_desc" 	, false , "" , dfNone,	0, false,	false );
                    InitDataProperty( 0 , cnt++ , dtData 			, 100  	, daLeft   	, true 	, "cre_usr_id"     	, false , "" , dfNone,	0, false,	false );
                    InitDataProperty( 0 , cnt++ , dtData 			, 95  	, daCenter 	, true 	, "cre_dt"    		, false , "" , dfNone,	0, false,	false );
                    InitDataProperty( 0 , cnt++ , dtData 			, 100 	, daLeft   	, true 	, "upd_usr_id"  	, false , "" , dfNone,	0, false,	false );
...
//                if(!validateForm(sheetObj,formObj,sAction)) return;
                ...
                sheetObj.DoSearch("CPS_CNI_0096GS.do", FormQueryString(formObj));
                break;
            ...
            case SEARCH22:      //조회
			    ...
			    sheetObj.WaitImageVisible = false;
		 	    ...
		 	    var sXml = sheetObj.GetSearchXml("CPS_CNI_0096GS.do", FormQueryString(formObj));
				...
				if ( svcResult == "N" ){
					...
					ComShowCodeMessage("CNI00001", "User ID");
					return svcResult;
				}
				break;	
            ...
            case IBCLEAR:	// 화면 초기화 작업
            	...
            	break;
            case SEARCH02:
            	var sXml = sheetObj.GetSearchXml("CPS_CNI_0096GS.do?f_cmd=" + SEARCH02 + "&role_code=" + sheetObj.CellValue(Row, "usr_role_cd"));
            	
				//조회 후 결과처리
				var svcResult = ComGetEtcData(sXml, "EXIST");
				sheetObj.CellValue(Row, "user_role_desc") = svcResult;
				break;
            ...
            case IBINSERT:
            	...
            	sheetObj.CellValue(row, "usr_id") = formObj.usr_id.value;
//            	formObj.f_cmd.value = SEARCH02;
            ...
            case IBSAVE:
            	...
            	var sXml = sheetObj.GetSaveXml("CPS_CNI_0096GS.do", sParam);
