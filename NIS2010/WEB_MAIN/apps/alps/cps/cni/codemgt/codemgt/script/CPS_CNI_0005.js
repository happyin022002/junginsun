 ...
 *@FileName : cps_cni_0005.js
 *@FileTitle : [CPS_CNI_0005] Handler History
 *Open Issues :
 *Change history :
...
function initSheet(sheetObj, sheetNo) {
	...
	case "sheet2": //sheet2 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtHidden, 		0, 		daCenter, true, "cgo_clm_hdlr_his_seq");
			InitDataProperty(0, cnt++, dtHidden, 		0, 		daCenter, true, "cgo_clm_sts_cd");
...
function doActionIBSheet(sAction) {
	...
	case SEARCHLIST02: // Retrieve Manager History
		...
		var sXml = sheet2.GetSearchXml("CPS_CNI_0005GS.do",	FormQueryString(frm));
	...
	case IBINSERT: // Row Add
		...
		sheet2.CellValue2(row, "cgo_clm_no") = frm.cgo_clm_no.value; 
		...
		sheet2.CellValue2(row, "cgo_clm_sts_cd") = sheet1.CellValue(1, "cgo_clm_sts_cd"); //Handler 첫번째 Row의 상태값으로 셋팅 
		break;
	...
	case MULTI: //Save
		...
		var sXml = sheet2.GetSaveXml("CPS_CNI_0005GS.do", param);
