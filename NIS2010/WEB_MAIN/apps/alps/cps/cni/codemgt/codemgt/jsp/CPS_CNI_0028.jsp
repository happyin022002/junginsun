...
<%@page import="com.hanjin.apps.alps.cps.cni.codemgt.codemgt.event.CpsCni0028Event"%>
...
<table class="search" id="mainTable"> 
    <tr><td class="bg">	
			...
			<tr class="h23">
				...
				<td width="">
				<script language="javascript">ComComboObject("combo1", 1, 200, 1, 0, 0, false);</script>
				</td>
				</tr></table> 
