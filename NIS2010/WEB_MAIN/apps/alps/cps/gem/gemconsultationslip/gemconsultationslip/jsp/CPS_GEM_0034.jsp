...
<%@ page import="com.hanjin.apps.alps.cps.gem.gemconsultationslip.gemconsultationslip.event.CpsGem0034Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	CpsGem0034Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (CpsGem0034Event)request.getAttribute("Event");
