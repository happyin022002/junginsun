    			 ...
    			 case 1:      //sheet1 init
    				with (sheetObj) {
    				   ...
    				   //전체Edit 허용 여부 [선택, Default false]
    					...
    					var HeadTitle = "|Expense Type|Input Date|Invoice Date|CSR|INV Amount|USD Amount|Pay To|Status|Status Date";    					
    					...
    					InitDataProperty(0, cnt++, dtHiddenStatus,      80,     daCenter,  true,    "",        			false,          "",       dfNone,    0,     true,        true, 		    0,		false,		true);
    		...
    		case IBSEARCH_ASYNC01:      //Open
 			...
 			//	formObj.pln_yr.focus();
    		   ...
    		   case IBSEARCH:      //조회
    				...
    				var sXml = sheetObj.GetSearchXml("CPS_GEM_0034GS.do", FormQueryString(formObj));
