 				...
 				case "btn1_DownExcel":
 					if (sheet1.RowCount <= 0 ) {
 						...
 						for(var i = 6 ; i <= sheet1.LastRow; i+=6)
 							skiprow += i+"|";
 						sheet1.Down2Excel(1,false,false,true,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0014_02.xml",false,false,"Request Information",false,"",skiprow);
 					}
 					break;
 				case "btn1_Retrieve":
