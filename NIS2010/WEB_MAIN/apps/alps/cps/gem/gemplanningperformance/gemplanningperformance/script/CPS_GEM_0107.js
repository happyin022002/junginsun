...
//		Rdviewer.ViewShowMode(0);
 	...
 	*/
 	function rdOpen(rdObject, formObject, param){
 		...
 		var rdParam = "/rp " + param + " /riprnmargin /rwait";
 		// 열고자 하는 RD 파일을 지정한다.
 		var strPath = RD_path+"apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0029.mrd";
 		//var strPath = "http://localhost:7001/hanjin/"+"apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0029.mrd";
 		//alert(rdParam + "\n\n" + strPath);
