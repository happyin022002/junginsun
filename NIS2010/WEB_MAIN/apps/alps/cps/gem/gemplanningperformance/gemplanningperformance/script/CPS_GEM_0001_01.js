...
function processButtonClick() {
	...
	case "btn_Print":
		if (!ComIsNull(frm.gen_expn_rqst_no.value)) {
			...
			ComOpenWindow("about:blank","CPS_GEM_0103","width=900, height=610 ,scrollbars=no", false);
			...
			frm3.mrd.value = "apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0023.mrd";
