    			...
    			switch(srcName) {
    				...
    				case "btn1_DownExcel":
    					...
    					if(!frm.target_rpt[0].checked && !frm.target_rpt[1].checked && !frm.target_rpt[2].checked && !frm.target_rpt[3].checked){
    						...
    						sheet5.Down2Excel(1,false,false,true,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0018_05.xml",false,false,"Monthly Expense",false);
    			...
    			case SEARCHLIST: // Down Excel
     				...
     				var sXml = sheet1.GetSearchXml("CPS_GEM_0018GS.do", FormQueryString(frm));
		  			...
		  			if (arrXml.length > 0) {
		  				...
		  				//sheet1.Down2Excel(1,false,false,true,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0018_01.xml",false,false,"Summary_After Closing",false,maskfield);
		  				sheet1.SpeedDown2Excel(1,false,false,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0018_01.xml",false,false,"Summary_After Closing",false,maskfield);
    				...
    				frm.f_cmd.value = SEARCHLIST04;
     				...
     				var sXml = sheet2.GetSearchXml("CPS_GEM_0018GS.do", FormQueryString(frm));
		  			...
		  			if (arrXml.length > 0) {
		  				...
		  				sheet2.Down2Excel(1,false,false,true,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0018_02.xml",false,false,"Actual results by Expense",false,maskfield);
    			...
    			case SEARCHLIST05: // Actual results by Office
     				...
     				var sXml = sheet3.GetSearchXml("CPS_GEM_0018GS.do", FormQueryString(frm));
		  			...
		  			if (arrXml.length > 0) {
		  				...
		  				sheet3.Down2Excel(1,false,false,true,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0018_03.xml",false,false,"Actual results by Office",false,maskfield);
    			...
    			case SEARCHLIST06: // Actual results by Subsidiaries
     				...
     				var sXml = sheet4.GetSearchXml("CPS_GEM_0018GS.do", FormQueryString(frm));
		  			...
		  			if (arrXml.length > 0) {
		  				...
		  				sheet4.Down2Excel(1,false,false,true,"","apps/alps/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0018_04.xml",false,false,"Actual results by Subsidiaries",false,maskfield);
