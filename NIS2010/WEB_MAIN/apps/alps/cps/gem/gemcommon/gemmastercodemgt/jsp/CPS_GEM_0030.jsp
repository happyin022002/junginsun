...
<%@ page import="com.hanjin.apps.alps.cps.gem.gemcommon.gemmastercodemgt.event.CpsGem0030Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	CpsGem0030Event event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (CpsGem0030Event)request.getAttribute("Event");
	...
	<table class="search">
		<tr>
			...
			<table class="search" border="0" style="width: 100%">
				<tr class="h23">
					<td width="35%">
					<table class="search_sm2" border="0" style="width: 77%;">
						<tr class="h23">
							<td width="15%">
							...
							<td width="" align="left">
								<table border="0">
									<tr>
										<td><select style="width: 75;" class="input" name="sch_lvl1" onchange="selLevelChange('GEM_COMMONGS.do','SEARCHLIST03','sheet1','sch_hohq_gbn','1','document.form.sch_lvl');"></select></td>
										<td><select style="width: 75;" class="input" name="sch_lvl2" onchange="selLevelChange('GEM_COMMONGS.do','SEARCHLIST04','sheet1','sch_hohq_gbn','2','document.form.sch_lvl');" onmousedown="selLevelChange2('GEM_COMMONGS.do','SEARCHLIST04','sheet1','sch_hohq_gbn','2','document.form.sch_lvl');"></select></td>										                                                             
					...
					<td width="35%">
					<table class="search_sm2" border="0" style="width: 55%;">
						<tr class="h23">
							<td>
					...
					<td width="20%" align="right" colspan="2">Deleted Data<input type="checkbox" value="Y" class="trans" name="sch_delt_flg" onclick="isDeltFlg(this);"></td>
				</tr>
			</table>
