...
<%@ page import="com.hanjin.apps.alps.cps.gem.gemcommon.gemmastercodemgt.event.CpsGem0011Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	CpsGem0011Event event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (CpsGem0011Event)request.getAttribute("Event");
			...
			<tr>
				...
				<table class="search" border="0" style="width: 100%">
					...
					<tr class="h23">
						...
						<!--<td width="115" align="right">Deleted Data<input type="checkbox" value="Y" class="trans" name="sch_delt_flg" onclick="isDeltFlg(this);"></td>-->
