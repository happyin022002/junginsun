...
document.onclick = processButtonClick;
	...
	//			setYrMon();  // 월/주 입력 창에 금월 셋팅
            ...
            case IBSAVE:        //저장
                ...
                if(formObj.f_class_id.value == "ESM_MAS_0024") {
                	formObj.f_cmd.value = MULTI01;
			 	}
		 	                  
//             	sheetObj.DoAllSave("ESM_MAS_0173GS.do", masFormQueryString(formObj,'f_cmd',true), -1, false);
            	var sXml = sheetObj.GetSaveXml("ESM_MAS_9001GS.do", masFormQueryString(formObj));
