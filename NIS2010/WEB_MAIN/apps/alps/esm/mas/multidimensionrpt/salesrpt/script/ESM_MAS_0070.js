 ...
 * 2008.04.07 PEJ N200804020018 MAS Report 수정 요청  
 ...
 * 2008.06.10 PEJ N200805307020 Split 01-MAS_화면 개발 및 수정 
 ...
 * 2011.06.22 이행지 [CHM-201111643-01][MAS]달성율(%) 산출 로직 변경_Office Report vs QTA - OP 컬럼 소계식 수정
 ...
 * 2014.06.19 최덕우 [CHM-201430667] [MAS] Office Report vs QTA내 "Main / Sector" 컬럼 추가 요청
...
/**
 * @extends  
 * @class ESM_MAS_0070 : ESM_MAS_0070 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0070() {
...
//                        fixd_cnt = 21;
                    	...
                    	if (getComboObjValue(formObj.f_pro_lvl) == "O"){
                            HeadTitle  = HeadTitle + "|BKG OP|BKG OP|BKG OP|OP|OP|OP|BKG OPB|BKG OPB|BKG OPB|";
                            HeadTitle1 = HeadTitle1 + "|"+ header+"|Change(%)|"+header+"|Change(%)|"+header+"|Change(%)|";  
                            fixd_cnt = 30;                        
                    	}
...
//                        if(getComboObjValue(formObj.f_pro_lvl) == "O") fixd_cnt = fixd_cnt + 6;
                        ...
                        if(getComboObjValue(formObj.f_ofc_vw) == "C")  fixd_cnt = fixd_cnt + 14;
//                        else fixd_cnt = 41;
                    }
...
//                        }
            ...
            case 2:      //sheet2 init
                with (sheetObj) {
                    ...
                    Editable = false;                                                   //전체Edit 허용 여부 [선택, Default false]
                    InitRowInfo( 2, 1, 9, 100);                                         //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
                    if(getComboObjValue(formObj.f_pro_vw) == "P" && getComboObjValue(formObj.f_pro_lvl) == "O"){ //Office Profit
                        fixd_cnt = 15;
                    } else {
                        fixd_cnt = 12;
                    }
...
//                        else fixd_cnt = 30;
                    ...
                    InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_load",     false,      "",     dfFloatOrg,  2,      true,       true);
                    ...
                    InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_rev",      false,      "",     dfFloatOrg,  2,      true,       true);
                    ...
                    InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_cm",       false,      "",     dfFloatOrg,  2,      true,       true);
                    InitDataProperty(0, cnt++,  dtImageText,    120,     daRight,    false,      "cm_chng",      false,      "",     dfFloatOrg,  2,      true,       true);

                    if(getComboObjValue(formObj.f_pro_vw) == "R"){ //Office Profit
//                        InitDataProperty(0, cnt++,  dtData,      100,     daRight,    false,      "mas_stp",      false,      "",     dfNullInteger,       0,      true,       true);
//                        InitDataProperty(0, cnt++,  dtData,      100,     daRight,    false,      "mas_stp_net",  false,      "",     dfNullInteger,       0,      true,       true);
//                        InitDataProperty(0, cnt++,  dtData,      100,     daRight,    false,      "mas_branchCM", false,      "",     dfNullInteger,       0,      true,       true);
...
//                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_branchCM",       false,      "",     dfFloatOrg,       2,      true,       true);
//                        InitDataProperty(0, cnt++,  dtImageText,    135,     daRight,    false,      "mas_branch_chng",    false,      "",     dfFloatOrg,       2,      true,       true);
//                        }
...
//                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_bkg_op",   false,      "",     dfFloatOrg,  2,      true,       true);
...
//                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_op",            false,      "",         dfFloatOrg,  2,      true,       true);
//                        InitDataProperty(0, cnt++,  dtImageText,    120,     daRight,    false,      "mas_op_chng",       false,      "",         dfFloatOrg,  2,      true,       true);
//                        }
                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "qta_rpb",      false,      "",     dfFloatOrg,  2,      true,       true);
                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_rpb",      false,      "",     dfFloatOrg,  2,      true,       true);
                        ...
                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_cmb",      false,      "",     dfFloatOrg,  2,      true,       true);
...
//                        InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_opb",      false,      "",     dfFloatOrg,  2,      true,       true);
...
//                        }
                    ...
                    InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_bsa_capa",  false,      "",    dfFloatOrg, 2,      true,       true);
                    ...
                    InitDataProperty(0, cnt++,  dtAutoSum,      120,     daRight,    false,      "mas_lf",   false,      "",    dfFloatOrg, 2,      true,       true);
...
//                    }
                    ...
                    InitDataProperty(0, cnt++,      dtAutoSum,      90, daRight,    false,  "mas_load_share",false,      "",     dfFloatOrg,  2,      true,       true);
                    InitDataProperty(0, cnt++,      dtAutoSum,      90, daRight,    false,  "load_share",    false,      "|mas_load_share|-|qta_load_share|",dfFloatOrg,  2,      true,       true);
                    InitDataProperty(0, cnt++,      dtAutoSum,      90, daRight,    false,  "qta_cm_share",  false,      "",     dfFloatOrg,  2,      true,       true);
                    InitDataProperty(0, cnt++,      dtAutoSum,      90, daRight,    false,  "mas_cm_share",  false,      "",     dfFloatOrg,  2,      true,       true);
                    InitDataProperty(0, cnt++,      dtAutoSum,      90, daRight,    false,  "cm_share",      false,      "|mas_cm_share|-|qta_cm_share|",    dfFloatOrg,  2,      true,       true);
                    style.height = GetSheetHeight(baseHeight) ;
                }
                break;
...
//                        else fixd_cnt = 30;
            ...
            case 6:      //sheet6 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++,  dtAutoSum,      90, daRight,    false,      "mas_op_share",  false,      "",     dfFloatOrg,  2,  true,       true);
                    InitDataProperty(0, cnt++,  dtAutoSum,      90, daRight,    false,      "op_share",       false,      "|mas_op_share|-|qta_op_share|",    dfFloatOrg,  2,  true,       true);
                    }
                    style.height = GetSheetHeight(baseHeight) ;
                }
                break;    
    ...
    function sheet3_OnSearchEnd(sheetObj, errMsg){
        ...
        if(eval(sheetObj.SumValue(0, "qta_load")) > 0){
            sheetObj.SumValue(0, "load_chng") = eval("(" + sheetObj.SumValue(0,"mas_load")+ "/" + sheetObj.SumValue(0, "qta_load") + ")*100").toFixed(2);
        } else {
            sheetObj.SumValue(0, "load_chng") = "0";
        }
        if(eval(sheetObj.SumValue(0, "qta_rev")) > 0){
            sheetObj.SumValue(0, "rev_chng") = eval("(" + sheetObj.SumValue(0,"mas_rev")+ "/" + sheetObj.SumValue(0, "qta_rev") + ")*100").toFixed(2);
        } else {
            sheetObj.SumValue(0, "rev_chng") = "0";
        }
        
        if(eval(sheetObj.SumValue(0, "qta_cm")) > 0){
            sheetObj.SumValue(0, "cm_chng") = eval("(" + sheetObj.SumValue(0,"mas_cm")+ "/" + sheetObj.SumValue(0, "qta_cm") + ")*100").toFixed(2);
        } else {
            sheetObj.SumValue(0, "cm_chng") = "0";
        }
        ...
        if(parseInt(sheetObj.SumValue(0, "mas_load")) > 0){
            sheetObj.SumValue(0,"mas_cmb") = eval(sheetObj.SumValue(0,"mas_cm")+"/"+sheetObj.SumValue(0, "mas_load")).toFixed(2);
        } else {
            sheetObj.SumValue(0,"mas_cmb") = "0";
        }
        
        if(eval(sheetObj.SumValue(0, "qta_cmb")) > 0){
            sheetObj.SumValue(0, "cmb_chng") = eval("(" + sheetObj.SumValue(0,"mas_cmb")+ "-" + sheetObj.SumValue(0, "qta_cmb") + ")").toFixed(2);
        } else {
        ...
        if(eval(sheetObj.SumValue(0, "mas_load")) > 0){
            sheetObj.SumValue(0, "mas_rpb") = eval("(" + sheetObj.SumValue(0,"mas_rev")+ "/" + sheetObj.SumValue(0, "mas_load") + ")").toFixed(2);
        } else {
            sheetObj.SumValue(0, "mas_rpb") = "0";
        }         
        sheetObj.SumValue(0, "rpb_chng") = eval(sheetObj.SumValue(0,"mas_rpb")+ "-" + sheetObj.SumValue(0, "qta_rpb"));
        
        if(getComboObjValue(formObj.f_pro_vw) == "R" && getComboObjValue(formObj.f_ofc_vw) == "C"){ //Office Profit, Contract
            if(eval(sheetObj.SumValue(0, "qta_cm")) > 0){
//                sheetObj.SumValue(0, "mas_branch_chng") = eval("(" + sheetObj.SumValue(0,"mas_branchCM")+ "/" + sheetObj.SumValue(0, "qta_cm") + ")*100").toFixed(2); SAQ->SQM
            } else {
//                sheetObj.SumValue(0, "mas_branch_chng") = "0"; SAQ->SQM
            }
        }
...
//                sheetObj.SumValue(0, "op_chng") = eval("(" + sheetObj.SumValue(0,"mas_bkg_op")+ "/" + sheetObj.SumValue(0, "qta_bkg_op") + ")*100").toFixed(2);
//            } else {
//                sheetObj.SumValue(0, "op_chng") = "0";
//            }
...
//            }
//            if(parseInt(sheetObj.SumValue(0, "mas_load")) > 0){ SAQ->SQM
//                sheetObj.SumValue(0,"mas_opb") = eval(sheetObj.SumValue(0,"mas_bkg_op")+"/"+sheetObj.SumValue(0, "mas_load")).toFixed(2);
//            } else {
//                sheetObj.SumValue(0,"mas_opb") = "0";
//            }
//            if(eval(sheetObj.SumValue(0, "qta_opb")) > 0){ SAQ->SQM
//                sheetObj.SumValue(0, "opb_chng") = eval("(" + sheetObj.SumValue(0,"mas_opb")+ "-" + sheetObj.SumValue(0, "qta_opb") + ")").toFixed(2);
//            } else {
//                sheetObj.SumValue(0, "opb_chng") = "0";
//            }
//            if(parseInt(sheetObj.SumValue(0, "qta_bkg_op")) > 0){ SAQ->SQM
//                sheetObj.SumValue(0,"mas_op_chng") = eval("(" + sheetObj.SumValue(0,"mas_op")+"/"+sheetObj.SumValue(0, "qta_bkg_op")+ ")*100").toFixed(2);
//            } else {
//                sheetObj.SumValue(0,"mas_op_chng") = "0";
//            }
        }
        ...
        if(parseInt(sheetObj.SumValue(0, "mas_bsa_capa"))>0){
            sheetObj.SumValue(0, "mas_lf") = eval("("+sheetObj.SumValue(0, "mas_load")+"/"+sheetObj.SumValue(0, "mas_bsa_capa")+")*100").toFixed(2);
        }else{
            sheetObj.SumValue(0, "mas_lf") = "0";
        }       
        sheetObj.SumValue(0, "lf_chng") = eval(sheetObj.SumValue(0,"mas_lf")+"-"+ sheetObj.SumValue(0, "qta_lf"));
        ...
        if(getComboObjValue(formObj.f_ofc_lvl1) == "1" && getComboObjValue(formObj.f_ofc_cd) == "" && !formObj.f_ofc_sts.checked && !formObj.f_rf_sts.checked){
            ...
            sheetObj.ColHidden("mas_bsa_capa")  = false;
            sheetObj.ColHidden("bsa_capa_chng") = false;
            
            sheetObj.ColHidden("qta_lf")        = false;
            sheetObj.ColHidden("mas_lf")        = false;
            sheetObj.ColHidden("lf_chng")       = false;
        } else {
            sheetObj.ColHidden("qta_bsa_capa")  = true;
            sheetObj.ColHidden("mas_bsa_capa")  = true;
            sheetObj.ColHidden("bsa_capa_chng") = true;
            
            sheetObj.ColHidden("qta_lf")        = true;
            sheetObj.ColHidden("mas_lf")        = true;
            sheetObj.ColHidden("lf_chng")       = true;
        }
    ...
    function sheet4_OnSearchEnd(sheetObj, errMsg){
    	var formObj = document.form;
        sheetObj.SumValue(0, "load_share") = ComParseInt(sheetObj.SumValue(0, "mas_load_share")) - ComParseInt(sheetObj.SumValue(0, "qta_load_share"));
        sheetObj.SumValue(0, "cm_share")   = ComParseInt(sheetObj.SumValue(0, "mas_cm_share")) - ComParseInt(sheetObj.SumValue(0, "qta_cm_share"));
    }
...
//        document.getElementById("f_wk").className = "noact";
    ...
    function chgOffice(obj){
         ...
         if(obj.Text != ""){
 			...
 			var sXml = sheetObj.GetSearchXml("ESM_MAS_0070GS3.do", masFormQueryString(formObj));
...
//         }
    ...
    function f_pro_vw_OnChange(obj, code){
        ...
        ComMasOpCheckOfcCd(formObj.f_pro_lvl, ComGetObjValue(formObj.l_ofc_cd));
    }
    ...
    function setPeriod1(obj){
        ...
        ComMasSetPeriod5(obj,"div_period1");
    }
   ...
   /* 팝업 */
	function openSTPIncome(){
        ...
        if(flag){
    		...
    		ComOpenWindow('ESM_MAS_0135.do' + cond, 'STP_Income'
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                var sXml = sheetObj.GetSearchXml("ESM_MAS_0070GS.do", masFormQueryString(formObj));
        ...
        switch(sAction) {
            case IBSEARCH:      //조회
                ...
                if(formObj.f_ias_secter_sts.checked) {
                    ...
                    sXml = sheetObj.GetSearchXml("ESM_MAS_0070GSIASS.do", masFormQueryString(formObj));
                } else {
                    formObj.f_cmd.value = SEARCHLIST02;
                    sXml = sheetObj.GetSearchXml("ESM_MAS_0070GS2.do", masFormQueryString(formObj));                	
                }
            ...
            case SEARCH02:      //조회
                ...
                var sXml = sheetObj.GetSearchXml("ESM_MAS_0070GS4.do", masFormQueryString(formObj));
                formObj.f_pre_week.value = searchEtcData("f_pre_week", sXml, "1");
            ...
            if(tabObjects[0].SelectedIndex==0){
    			...
    			if(f_chkprd[1].checked && f_fm_mon.value != "" && f_fm_wk.value != ""){
        			if (ComParseInt(f_to_mon.value)-ComParseInt(f_fm_mon.value)!=0) {
        			    // [MAS10003] : Month 는(은) 1th 만 처리할수 있습니다.
        			    ComShowMessage(ComGetMsg("MAS10003", "Month", "1th"));
        			    f_to_mon.focus();
        				return false;
        			}
    			}
    			if(f_chkprd[0].checked && f_fm_wk.value != "" && f_to_wk.value != ""){
        			if (ComParseInt(f_to_wk.value)-ComParseInt(f_fm_wk.value)>14) {
        			    // [MAS10003] : Week 는(은) 15wk 만 처리할수 있습니다.
        			    ComShowMessage(ComGetMsg("MAS10003", "Week", "15wk"));
        			    f_to_wk.focus();
        				return false;
        			}
    			}
      ...
      */   
      function obj_OnClick() {
          ...
          case "f_rf_sts":
        	  if (formObj.f_sc_sts.checked){
        		  ...
        		  ComShowMessage(ComGetMsg("MAS10065"));
        	  }
        	  break;
          case "f_sc_sts":
      ...
      function viewCustomer() {
    	  ...
    	  if((    beforetab == 1
    		  ...
    		  if( formObj.l_ofc_cd.value == "SELCSG" || formObj.l_ofc_cd.value == "SELCMS" 
    			  || formObj.l_ofc_cd.value == "CLTCO" || formObj.l_ofc_cd.value == "SELAPM"){
    			  if(formObj.f_ias_secter_sts.checked) {
      ...
      function sheet5_OnSearchEnd(sheetObj, errMsg){
          ...
          if(getComboObjValue(formObj.f_pro_vw) == "R" && getComboObjValue(formObj.f_ofc_vw) == "C"){ //Office Profit, Contract
              if(eval(sheetObj.SumValue(0, "qta_cm")) > 0){
                  sheetObj.SumValue(0, "mas_branch_chng") = eval("(" + sheetObj.SumValue(0,"mas_branchCM")+ "/" + sheetObj.SumValue(0, "qta_cm") + ")*100").toFixed(2);
              } else {
                  sheetObj.SumValue(0, "mas_branch_chng") = "0";
              }
          }
          ...
          if(getComboObjValue(formObj.f_pro_vw) == "R" && getComboObjValue(formObj.f_ofc_vw) == "C" && formObj.f_rf_sts.checked){ //Office Profit, Contract, not Reefer
              sheetObj.ColHidden("mas_branchCM")     = true;
              sheetObj.ColHidden("mas_branch_chng")  = true;
              ...
              sheetObj.ColHidden("mas_branchCM")     = false;
              sheetObj.ColHidden("mas_branch_chng")  = false;
          ...
          if(getComboObjValue(formObj.f_pro_vw) == "R" && getComboObjValue(formObj.f_ofc_vw) == "C" && getComboObjValue(formObj.f_pro_lvl) == "O" && formObj.f_rf_sts.checked){
              sheetObj.ColHidden("mas_op")        = true;
              sheetObj.ColHidden("mas_op_chng")   = true;
          } else {
              sheetObj.ColHidden("mas_op")        = false;
              sheetObj.ColHidden("mas_op_chng")   = false;
          }
      ...
      function sheet6_OnSearchEnd(sheetObj, errMsg){
          ...
          sheetObj.SumValue(0, "cm_share")   = ComParseInt(sheetObj.SumValue(0, "mas_cm_share")) - ComParseInt(sheetObj.SumValue(0, "qta_cm_share"));
          if(getComboObjValue(formObj.f_pro_vw) == "R" && getComboObjValue(formObj.f_pro_lvl) == "O"){ //Office Profit
              sheetObj.SumValue(0, "op_share")   = ComParseInt(sheetObj.SumValue(0, "mas_op_share")) - ComParseInt(sheetObj.SumValue(0, "qta_op_share"));
          }
      }
