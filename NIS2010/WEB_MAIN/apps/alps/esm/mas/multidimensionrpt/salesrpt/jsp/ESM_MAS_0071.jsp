...
'서브  시스템 : Weekly Sales Report By Office 2
 2
'프로그램 ID  : apps/enis/esm/mas/multidimensionrpt/sales/jsp/ESM_MAS_0071.jsp
...
<%
	//ESM_MAS_071EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
							...
							<tr>
								<td class="bg">
									...
									<table class="search_in" border="0">
										<tr class="h23">
											<td colspan="3"><script language="javascript">masPeriod1_ofc();</script></td>
										</tr>
                                        <tr class="h23">
                                            <td width="5%"></td>
                                            <td width="9%"></td>
