...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0148 : ESM_MAS_0148 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0148() {
    		...
    		switch(sheetNo) {
    		    case 1:	//sheet1 init
    				with (sheetObj) {
    					...
    					var HeadTitle = "BKG NO|TP/SZ|Load|REV|CM COST|CM|CM2 COST|CM2" ;
    	...
    	function openCostDetail(){
    		...
    		if(sheetObjects[0].RowCount>0){//sheet1에 데이터가 있을때
    	      ...
    	      var row = obj1.SelectRow;
    			...
    			ComOpenWindow2('ESM_MAS_0149.do?'+ masFormQueryString(document.form)+cond, 
    	...
    	function doActionIBSheet(sheetObj,formObj,sAction) {
    		...
    		switch(sAction) {
    			case IBSEARCH:		//조회
        		    ...
        		    //20100414 이중환, FormQueryString -> masFormQueryString 변경
    				sheetObj.DoSearch4Post("ESM_MAS_0148GS.do", masFormQueryString(formObj));
    				ComOpenWait(false);
    				break;
