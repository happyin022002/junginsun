...
<%@ page import="com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0149Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
//	EsmMas0149Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//		event = (EsmMas0149Event)request.getAttribute(Event);
