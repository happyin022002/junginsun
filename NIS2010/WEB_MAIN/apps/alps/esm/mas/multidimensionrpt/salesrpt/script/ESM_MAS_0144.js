...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0144 : ESM_MAS_0144 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0144() {
...
//                        MultiSelection = true;
        ...
        function doActionIBSheet(sheetObj,formObj,sAction) {
            ...
            switch(sAction) {
                case IBSEARCH:      //조회
                    ...
                    sheetObj.DoSearch4Post("ESM_MAS_0144GS.do", masFormQueryString(formObj));
                    ComOpenWait(false);
                    break;
            }
        }
        ...
        function validateForm(sheetObj,formObj,sAction){
            with(formObj){
                ...
                //[CHM-201536832] 2015.07.13 - shipper code 자릿수 6자리 입력 후 조회하도록 변경
                if (f_cust_seq.value.length != 6) {
                	ComShowMessage(ComGetMsg('MAS10009', 'Shipper', '123456'));
