...
* 2014.07.18 PEJ [CHM-201431133] [MAS] HJL에서 ETS모듈 통해 발행한 W/O에 대한 Vendor 참조 로직 보완 및 S/P Code 추가 - Vendor 추가
=========================================================*/
		...
		switch(sheetNo) {
			case 1:	 //sheet1 init
				with (sheetObj) {
                    ...
                    var HeadTitle = "Node/Link|Activity Group|H|Cost Element|Source Code|Source Code Description|Amount|Ctrt/Avg|S/P|Remark|SEQ|avg_lvl_chk|" ;                   
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			case IBSEARCH:	 //조회
				...
				sheetObj.DoSearch4Post("ESM_MAS_0170GS.do", masFormQueryString(formObj));
				ComOpenWait(false);
