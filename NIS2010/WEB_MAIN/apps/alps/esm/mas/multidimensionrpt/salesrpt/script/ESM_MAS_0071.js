 ...
 * 2009.03.10 임옥영 R200903100006   MAS Office Report-Graph 오류 RD_path 주석처리 
...
/**
 * @extends 
 * @class ESM_MAS_0071 : ESM_MAS_0071 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0071() {
...
//        sheetObj.RowBackColor(5) = RgbColor(251, 230, 230);
    ...
    function chgOffice(obj){
         ...
         if(obj.Text != ""){
 			...
 			var sXml = sheetObj.GetSearchXml("ESM_MAS_0071GS2.do", masFormQueryString(formObj));
    ...
    */
    ...
    function rdOpen(rdObject,formObject, xml) {
        ...
        Rdviewer.FileOpen( RD_path + "apps/alps/esm/mas/multidimensionrpt/salesrpt/report/ESM_MAS_0071.mrd", "");
    }
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                var xml = sheetObj.GetSearchXml("ESM_MAS_0071GS.do", masFormQueryString(formObj));
            ...
            if (f_cmd.value == SEARCHLIST01){
                ...
                if(f_fm_mon.value != "" && f_to_mon.value != ""){
                    if((ComParseInt(f_to_mon.value) - ComParseInt(f_fm_mon.value))>= 3){
                        // [MAS10003] : Month 는(은) 3달만 처리할수 있습니다.
                         ComShowMessage(ComGetMsg("MAS10003", "Month", "3 Month"));
                         f_to_mon.focus();
                         return false;
                    }
                }
                if(f_fm_wk.value != "" && f_to_wk.value != ""){
                    if((ComParseInt(f_to_wk.value) - ComParseInt(f_fm_wk.value))>=10){
                        // [MAS10003] : Week 는(은) 10주 만 처리할수 있습니다.
                         ComShowMessage(ComGetMsg("MAS10003", "Week", "10 Week"));
                         f_to_wk.focus();
                         return false;
                    }
                }
