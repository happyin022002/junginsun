...
* History
* 1.0 최초 생성
* 2009-06-01 박상희  N200905110270 MAS_Pre CM/OP Simulation : Temp T/S Route 입력기능
...
<%@ page import="com.hanjin.apps.alps.esm.mas.multidimensionrpt.precmsimulation.event.EsmMas0171Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
//	EsmMas0171Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//		event = (EsmMas0171Event)request.getAttribute(Event);
