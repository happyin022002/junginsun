...
* 2011.12.21 최윤성 [CHM-201115260-01] [MAS] Pre CM/OP Simulation화면 U.I 변경요청 - Remark 문구추가
...
<input type="hidden" name="f_ofc_cd"  value="<%=strOfc_cd%>">
...
<input type="hidden" name="cntr_mt_dys">
<input type="hidden" name="ttl_dys">
		...
		<!-- TABLE '#D' : ( Search Options ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td >Revenue (USD)</td>
					<td><input name="f_g_rev" class="input1" type="text" style="width:50; ime-mode:disabled;" maxlength="25" onKeyUp="chkNumber(this); moveTab(this, f_spcl_dg);" onKeyPress="ComKeyOnlyNumber(this,'.'); setBfVal(this);">
					<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_RevDtl" onClick="openRevenueDetail('getF_g_rev');"></td>
					<td>Special Cargo</td>
				...
				<tr class="h23">
					...
					<td>MTY RTN<br>CY&nbsp;<input type="checkbox" class="trans" name="f_mty_rtn_yd_chk" value="Y" ></td>
					<td><input name="f_mty_rtn_yd_cd" readonly type="text" class="input2" required caption="RTN" maxlength="5" style="width:50;ime-mode:disabled;" onKeyUp="checkLoc_onKeyUp(this, this.value);moveTab(this, f_mty_rtn_yd_node);" onKeyPress="ComKeyOnlyAlphabet('uppernum');" >
						<input name="f_mty_rtn_yd_node" readonly type="text" class="input2" maxlength="2" style="width:20;ime-mode:disabled;" onKeyUp="moveTab(this, f_r_term);" onKeyPress="ComKeyOnlyAlphabet('uppernum');"  onChange="lstMtyRtnYd();">
					...
					<td colspan="2"><script language="javascript">ComComboObject('f_mty_rtn_lst_cd', 1, 80, false, 'Mty Rtn YD')</script></td>
					<td>Chassis<br>Term</td>											
					<td width="120" colspan="2">
						<script language="javascript">ComComboObject('f_chss_term', 1, 150, true)</script>
						<!-- <SELECT style='width:150' name="f_chss_term" >
							<OPTION value=""></OPTION>
							<OPTION value="C">Door/CY Exempted/RF</OPTION>
							<OPTION value="M">CY non exempted</OPTION>
						</SELECT> -->
					</td>
					<td></td>					                	
				</tr>
				<tr class="h23">
					...
					<td width="80">Quantity (BOX)</td>
					<td width="90"><input name="f_qty" class="input1" type="text" style="width:30;ime-mode:disabled;" onKeyUp="chkNumber(this); moveTab(this, f_agmt_sgn_ofc_cd);" onKeyPress="ComKeyOnlyNumber(this,'.'); setBfVal(this);"></td>
				</tr>
				<tr class="h23">
       	...
       	<tr><td class="bg">
				...
				<table width="100%" class="button">
					...
					<tr>
						...
						<!-- Repeat Pattern -->
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td><td class="btn2" id="btng_eqstatus" name="btng_eqstatus" onclick="javascript:callEQStatus();">EQ Status</td><td class="btn2_right"></td></tr></table></td>
						
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td><td class="btn2" id="btng_eqforecase" name="btng_eqforecase" onclick="javascript:callEQForecast();">EQ Forecast</td><td class="btn2_right"></td></tr></table></td>
								...
								<tr>
									...
									<td>
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
											<tr>
												<td class="btn2_left"></td><td class="btn2" id="btns_remarks" name="btns_remarks">Cost Detail</td><td class="btn2_right"></td>
