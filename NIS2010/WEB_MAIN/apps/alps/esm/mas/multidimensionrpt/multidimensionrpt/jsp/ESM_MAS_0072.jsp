 ...
 * 2014.07.14 최덕우 [CHM-201536859] P&L by Lane 밑에 Remark 수정 CSR
 * 2017.07.13 김동호 [CSR 1191] P/L by Agreement TAB 추가 및 미사용 기능 감춤(OP만 남겨놓고 없앰, IAS P&L invisible 처리)
=========================================================--%> 
...
<%
	...
	String strErrMsg = "";
	Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.ESM_MAS_0072");
	String userId = "";
	String ofc_cd = "";
	String ofc_lvl = "";
	String strOfc_cd = "";
	...
	try {
		...
		if (serverException != null) {
	        ...
	        if( eventResponse != null ) {
		        headCode1 = (eventResponse.getETCData("headCode1") == null) ? "" : eventResponse.getETCData("headCode1");
		        headName1 = (eventResponse.getETCData("headName1") == null) ? "" : eventResponse.getETCData("headName1");
		        headCode2 = (eventResponse.getETCData("headCode2") == null) ? "" : eventResponse.getETCData("headCode2");
		        headName2 = (eventResponse.getETCData("headName2") == null) ? "" : eventResponse.getETCData("headName2");
		        headCode3 = (eventResponse.getETCData("headCode3") == null) ? "" : eventResponse.getETCData("headCode3");
		        headName3 = (eventResponse.getETCData("headName3") == null) ? "" : eventResponse.getETCData("headName3");
	        }
		} //end of if
...
<tr>
	<td class="bg">
		...
		<tr class="h23">
			...
			<td colspan="2"><div style="display:none;"><input type="checkbox" class="trans" name="f_ias_flg" value="N" onClick="ias_change();">&nbsp;IAS P&L</div></td>
		</tr>
		</table>
...
<tr><td class="bg">
		...
		<tr class="h23">
			...
			<td width="180">
				...
				<SELECT name="f_chtbiz" onChange='changeChtBiz();' style='width:80'>
					...
					<OPTION value=" BIZ"> SML-sales</OPTION>
				</SELECT>
				</div>
			</td>
        ...
        <tr class="h23">
            <td width="80">TEU Based</td>
            <td width="330" class="sm">
                <input type="radio" name="f_rdotype_b" class="trans" value="9" checked>&nbsp;By Account &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="f_rdotype_b" class="trans" value="10" >&nbsp;By Lane / BND &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="f_rdotype_b" class="trans" value="11" >&nbsp;By VVD</td>
            <td width="160">
                <div id = "div_kor_b" style="display:inline">
                    <input type="radio" name= "f_iskorean_b" class="trans" value="1">&nbsp;KOR&nbsp;&nbsp;
                    <input type="radio" name= "f_iskorean_b" class="trans" value="2" checked>&nbsp;ENG
                </div>
            </td>
    
            <td width="180">
                <div id = "div_chtBiz_b" style="display:none">
                <b>By Division</b>&nbsp;&nbsp;&nbsp;
                <SELECT name="f_chtbiz" onChange='changeChtBiz();' style='width:80'>
                    <OPTION value=''>All</OPTION>
                    <OPTION value=" CHT"> Cht-out</OPTION>
            ...
            <td align="right" valign="bottom" style="padding-right:4;">
                <div id="div_zoom_in9"  style="position:relative; right:0px; top:0px; display:inline"> <!-- absolute / relative -->
                <img class="cursor" src="/hanjin/img/bu_prev01.gif" width="20" height="11" border="0" name="bu_zoom_in9" alt="Zoom in(+)">
                </div>
                <div id="div_zoom_out9" style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_next01.gif" width="20" height="11" border="0" name="bu_zoom_out9" alt="Zoom out(-)">
                </div>
                <div id="div_zoom_in10"  style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_prev01.gif" width="20" height="11" border="0" name="bu_zoom_in10" alt="Zoom in(+)">
                </div>
                <div id="div_zoom_out10" style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_next01.gif" width="20" height="11" border="0" name="bu_zoom_out10" alt="Zoom out(-)">
                </div>
                <div id="div_zoom_in11"  style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_prev01.gif" width="20" height="11" border="0" name="bu_zoom_in11" alt="Zoom in(+)">
                </div>
                <div id="div_zoom_out11" style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_next01.gif" width="20" height="11" border="0" name="bu_zoom_out11" alt="Zoom out(-)">
                </div>
                <div id="div_zoom_in12"  style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_prev01.gif" width="20" height="11" border="0" name="bu_zoom_in12" alt="Zoom in(+)">
                </div>
                <div id="div_zoom_out12" style="position:relative; right:0px; top:0px; display:none">
                <img class="cursor" src="/hanjin/img/bu_next01.gif" width="20" height="11" border="0" name="bu_zoom_out12" alt="Zoom out(-)">
                </div>
            </td>
        </tr>
        <tr><td class="height_5" colspan="3"></td></tr>
        ...
        <tr>
            <td width="100%">
                <div id="tabLayer9" style="display:inline">
                <table width="100%" id="mainTable9">
                <tr><td><script language="javascript">ComSheetObject('sheet9');</script></td></tr>
                </table>
                </div>
                <div id="tabLayer10" style="display:inline">
                <table width="100%" id="mainTable10">
                <tr><td><script language="javascript">ComSheetObject('sheet10');</script></td></tr>
                </table>
                </div>
                <div id="tabLayer11" style="display:inline">
                <table width="100%" id="mainTable11">
                <tr><td><script language="javascript">ComSheetObject('sheet11');</script></td></tr>
                </table>
                </div>
                <div id="tabLayer12" style="display:inline">
                <table width="100%" id="mainTable12">
                <tr><td><script language="javascript">ComSheetObject('sheet12');</script></td></tr>
                </table>
                </div>
		...
		<tr><td style="padding-left:11;" class="sm">
			...
			CM (PA) = Freight Revenue + Misc OP Revenue + DEM/DET + Domestic Saving Credit + One Way Saving – Full Cost – MT Cost – Agt Commission - CNTR EQ Cost – Chassis Cost
			<br>
			<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0" vspace="3">
			CM (RA) = CM (PA) – EMU Credit<br>
			<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0" vspace="3">
			OP (PA) = CM (PA) + Vessel Charter Revenue + Space Charter Revenue – OP Cost<br>
<!-- 	
			<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0" vspace="3">
