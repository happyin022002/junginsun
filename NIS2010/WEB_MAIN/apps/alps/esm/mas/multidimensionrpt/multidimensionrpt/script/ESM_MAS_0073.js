...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0073 : ESM_MAS_0073 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0073() {
		...
		try {
			...
			switch(srcName) {
				...
				case "btn_plan_exp":			//저장
					ComOpenPopup('/hanjin/ESM_MAS_0074.do',500, 300, 'getVVD', '1,0,1,1,1,1,1,1',true)
					break;
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			case IBSEARCH:      //조회
				...
				sheetObj.DoSearch4Post("ESM_MAS_0073GS.do", masFormQueryString(formObj));
				ComOpenWait(false);
				break;
