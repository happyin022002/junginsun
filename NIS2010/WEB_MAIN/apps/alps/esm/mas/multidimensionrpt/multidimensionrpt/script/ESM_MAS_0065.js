...
/**
 * @extends 
 * @class ESM_MAS_0065 : ESM_MAS_0065 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0065() {
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			case IBSEARCH:		//조회
				...
				sheetObj.DoSearch4Post("ESM_MAS_0065GS.do", masFormQueryString(formObj));
				ComOpenWait(false);
				break;
