...
<%@ page import="com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0130Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	
	EsmMas0130Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0130Event)request.getAttribute("Event");
