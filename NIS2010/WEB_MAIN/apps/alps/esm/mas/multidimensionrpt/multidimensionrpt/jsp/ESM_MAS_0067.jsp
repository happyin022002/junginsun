...
*@FileName : ESM_MAS_067.jsp
*@FileTitle : EQ 회송기여도 RPT 조회 2
*Open Issues :
                ...
                <tr>
                  <td class="bg">
                    ...
                    <table class="search_in" border="0">
                      <tr class="h23">
                        <td colspan="10"><script language="javascript">masPeriod1_ofc();</script></td>
                        <td width="33%">
                    ...
                    <table class="search_in" border="0">
                      ...
                      <tr class="h23">
                        ...
                        <td width="11%">POR</td>
                        <td width="17%"><input type="text" style="width:80" name="f_por_s" value="" maxlength="5" onKeyUp="upper(this);moveTab(this, f_pol_s)"></td>
                        <td width="11%">Revenue POL</td>
                        <td width="14%"><input type="text" style="width:80" name="f_pol_s" value="" maxlength="5" onKeyUp="upper(this);moveTab(this, f_pod_s)"></td>
                        <td width="9%">Revenue POD</td>
                        <td width="13%"><input type="text" style="width:80" name="f_pod_s" value="" maxlength="5" onKeyUp="upper(this);moveTab(this, f_del_s)"></td>
                        <td width="3%">DEL</td>
                        <td align="right"><input type="text" style="width:115" name="f_del_s" value="" maxlength="5" onKeyUp="upper(this);moveTab(this, txtShipper)"></td>
                      </tr>
                      ...
                      <tr class="h23">
                        ...
                        <td>Shipper</td>
                        <td><input type="text" name="txtShipper" value="" style="width:80;" maxlength="8" onKeyUp="upper(this);" onFocusOut="chkFormat(this);">
