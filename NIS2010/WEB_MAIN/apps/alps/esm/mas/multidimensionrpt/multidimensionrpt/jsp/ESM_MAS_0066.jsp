...
<%@ page import="com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.vo.MultiDimensionPfmcByOfficeListVO"%>
...
<%
	...
	StringBuffer sbCntr = new StringBuffer();
	StringBuffer sbCrd = new StringBuffer();
...
<form method="post" name="form" onKeyDown="ComKeyEnter();">
  ...
  <input type="hidden" name="f_crd_rto" value="<%=sbCrd.toString()%>">
