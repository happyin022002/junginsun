...
*Change history :
	...
	* 2014.03.25 박찬민 CHM-201429466 [MAS] Logistics vol. by office 화면
...
* @class ESM_MAS_0158 : ESM_MAS_0158 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
*/
function ESM_MAS_0158() {
	...
	*/
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		case IBCLEAR:          //조회
			...
			var sXml = sheetObj.GetSearchXml("ESM_MAS_0158GS.do", masFormQueryString(formObj));
			var arrXml = sXml.split("|$$|");
...
//						alert(formObj.f_chkprd[0].checked+ "" +formObj.f_split_mw.checked)
						...
						sheetObj.DoSearch4Post("ESM_MAS_0158GS.do", masFormQueryString(formObj));
						ComOpenWait(false);
					}
				}
