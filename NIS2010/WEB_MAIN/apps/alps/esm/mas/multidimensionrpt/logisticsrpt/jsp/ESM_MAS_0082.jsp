...
* 2012.02.28 이석준 [CHM-201216447-01] MAS화면 default값 변경 요청
...
<%@ page import="com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0082Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EsmMas0082Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		event = (EsmMas0082Event)request.getAttribute("Event");
