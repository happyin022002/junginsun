...
*@FileName : ESM_MAS_0080.jsp
*@FileTitle : Lane별 Activity
*Open Issues :
*Change history :
...
* 2009.10.07 최인경 New Framework 적용
...
<%@ page import="com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0080Event"%>

<%
	EsmMas0080Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		event = (EsmMas0080Event)request.getAttribute("Event");
...
<html>
<head>
<title>Logistics Expense by Lane</title>
       	...
       	<tr>
       		<td class="bg">
				...
				<table class="search_in" border="0">
					<tr class="h23">
						<td width="70" class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="7" height="9" border="0">Period</td>
						<td colspan="2"><script language="javascript">masPeriod3();</script></td>
						<td align="right" width="170">Split by Month / Week&nbsp;&nbsp;<input type="checkbox" name="f_split_mw" value="T" checked class="trans"></td>
					</tr>
                    <tr class="h23">
                    	<td></td>
                    	<td width="205"></td>
                     	<td width="444" class="gray_tit" style="color:#4361b6" style="font-size:8pt;">
				...
				<table class="search_in" border="0">
					<tr class="h23">
						<td width="90" class="gray_tit">
							<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="7" height="9" border="0">Trade / Lane</td>
						<td width="60">Report</td>
						<td width="110">
							<SELECT style='width:70' name="f_report" >
								<OPTION value="1">Trade</OPTION>
								<OPTION value="2">Lane</OPTION>
							</SELECT>
						</td>
						<td width="90">Trade</td>
						<td width="140">
							<script language="javascript">ComComboObject('f_trd_cd',1, 100 , 0 )</script>
						</td>
						<td width="50" style="padding-left:1">Lane</td>
						<td width="190">
							<script language="javascript">ComComboObject('f_rlane_cd',1, 80 , 0 )</script>
						</td>
						<td width="50" style="padding-left:1">Direction</td>
						<td>
					...
					<tr class="h23">
						<td class="gray_tit">
							<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="7" height="9" border="0">Activities
						</td>
						<td colspan="2">KPI1
							...
							KPI3<input type="radio" class="trans" name = "f_kpi_type" value="3" onClick="changeKpiType('3')" checked>
						</td>
						<td>Logistics KPI</td>
						<td id="div_mnKpi" style="display:none">
							<script language="javascript">ComComboObject('f_lgs_mn_kpi_cd',1, 100 , 1 )</script>
						</td>
						<td id = "div_lgsKpi" style="display:none">
							<script language="javascript">ComComboObject('f_lgs_kpi_cd',1, 100 , 1 )</script>
						</td>
						<td id = "div_lgsKpi3" style="display:inline">
							<script language="javascript">ComComboObject('f_lgs_kpi3_cd',1, 100 , 1 )</script>
						</td>
