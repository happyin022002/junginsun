...
<%@ page import="com.hanjin.apps.alps.esm.mas.eqbalance.eqbalance.event.EsmMas0018Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
	EsmMas0018Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0018Event)request.getAttribute("Event");
