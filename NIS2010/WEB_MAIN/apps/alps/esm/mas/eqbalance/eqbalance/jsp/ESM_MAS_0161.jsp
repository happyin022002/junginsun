...
<%@ page import="com.hanjin.apps.alps.esm.mas.eqbalance.eqbalance.event.EsmMas0161Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0161Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0161Event)request.getAttribute("Event");
