...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0136 : ESM_MAS_0136 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0136() {
            ...
            switch(sheetNo) {
                case 1:      //sheet2 init
                    with (sheetObj) {
                        ...
                        InitDataProperty(0, 	cnt++ , dtCheckBox,   	30,    daCenter,   true,    "por_repo_flg", false,          "",       	dfNone,       0,     		true,       	true);
        ...
        function sheet1_OnChange (sheetObj, row , col, value ){
            if(sheetObj.CellValue(row,"slevel")==0) {
                ...
                while(sheetObj.CellValue(row,"slevel")==1){
                    sheetObj.CellValue2(row,"por_repo_flg") = value;
                    row++;
                }
            }
        }
    	...
    	function doActionIBSheet(sheetObj,formObj,sAction) {
    		...
    		switch(sAction) {
    			case IBSEARCH:      //조회
    				...
    				sheetObj.DoSearch4Post("ESM_MAS_0136GS.do", masFormQueryString(formObj));
    				ComOpenWait(false);
    				break;
    			...
    			case IBSAVE:        //저장
    				...
    				sheetObj.DoAllSave("ESM_MAS_0136GS.do", masFormQueryString(formObj));
       ...
       /**
        ...
        function validateForm(sheetObj,formObj,sAction){
            with(formObj){
            	switch(sAction) {
            	case IBSAVE:
            		return ComShowConfirm(ComGetMsg('MAS10070'))
            		break;
            	}
            	return true;
            }
