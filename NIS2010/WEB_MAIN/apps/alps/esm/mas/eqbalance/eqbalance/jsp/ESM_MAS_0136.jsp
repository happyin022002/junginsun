...
*Change history :
  2008.02.13 전윤주 CSR NO. N200802010006 Rlane tree 구조 변경 후 UI 크기 변경
...
<%@ page import="com.hanjin.apps.alps.esm.mas.eqbalance.eqbalance.event.EsmMas0136Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0136Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0136Event)request.getAttribute("Event");
...
<html>
<head>
<title>From(POR) RCC For EQ Repo. Contribution</title>
...
<table width="400" class="popup" cellpadding="10" border="0">  <!-- CSR NO. N200802010006 -->
    ...
    <tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; From(POR) RCC For EQ Repo. Contribution</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
