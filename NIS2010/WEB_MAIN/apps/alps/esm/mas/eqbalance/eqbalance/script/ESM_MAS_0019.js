...
=========================================================
* History
* 2009.04.20 전윤주 N200904070092 MAS_CM 계산 수식 변경 (장비비 조회 메뉴에서 제외) 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0019 : ESM_MAS_0019 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0019() {
 	...
 	function doActionIBSheet(sheetObj,formObj,sAction) {
 		...
 		switch(sAction) {
			...
			case IBCLEAR:          //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_MAS_0019GS.do", masFormQueryString(formObj));
 			...
 			case IBSEARCH:	//조회
 				if(validateForm(sheetObj,formObj,sAction)) {
					...
					ComOpenWait(true);
 					...
 					sheetObj.DoSearch4Post("ESM_MAS_0019GS.do", masFormQueryString(formObj));
 					ComOpenWait(false);
 				}
 				break;
