...
* 2012.11.20 송호진 [CHM-201221090-01] [MAS] US DOMESTIC 반영 - CNTR_SZ_CD -> CNTR_TPSZ_CD 컬럼명 변경에 따른 조회조건 Text 변경 ( Size -> Type Size )
...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.usdomestic.event.EsmMas0014Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0014Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0014Event)request.getAttribute("Event");
...
<input type="hidden" name="mas_mty_ecc_ut_cost_cnt">
<input type="hidden" name="mas_ut_cost_cre_sts_cnt">
