...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_MAS_0139 : ESM_MAS_0139 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0139() {
 ...
 // 공통전역변수
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
    	...
    	switch(sAction) {
    		...
    		case IBSEARCH:		           //조회
    			...
    			sheetObj.DoSearch4Post("ESM_MAS_0139GS.do", masFormQueryString(formObj));
    			ComOpenWait(false);
    			break;
    		case IBSAVE:                  // 저장
    			// 업무처리중 버튼사용 금지 처리
    			...
    			sheetObj.DoSave("ESM_MAS_0139GS.do", masFormQueryString(formObj), -1, true);
    			ComOpenWait(false);
    			break;
    ...
    */
     ...
     */
    function Popup(str){
    	ComOpenWindow2("ESM_MAS_0140.do?" + str,'','width=900, height=500, menubar=no, scrollbars=no, resizable=yes');
