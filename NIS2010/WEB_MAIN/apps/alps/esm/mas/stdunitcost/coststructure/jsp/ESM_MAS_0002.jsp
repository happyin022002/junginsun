...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.coststructure.event.EsmMas0002Event"%>

<%
    EsmMas0002Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmMas0002Event)request.getAttribute("Event");
          ...
          <td class="bg">
            ...
            <table class="search" border="0">
              <tr>
                ...
                <img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5"><a href="javascript:ComOpenWindow2('ESM_MAS_0138.do?','','width=800, height=600, menubar=no, scrollbars=no, resizable=yes')"
                class="purple">Inquiry Office</a>
                <img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5"><a href="javascript:ComOpenWindow2('ESM_MAS_0130.do','','width=800,height=400, menubar=0, scrollbars=0, resizable=yes');" class="purple"> Report View Management</a>
                <img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5"><a href="javascript:ComOpenWindow2('ESM_MAS_0001.do','','width=400,height=400, menubar=0, scrollbars=0, resizable=yes')" class="purple">Set List-boxes</a></td>
              </tr>
              <tr>
