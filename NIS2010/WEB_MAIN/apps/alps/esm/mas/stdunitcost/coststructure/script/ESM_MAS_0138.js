...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0138 : ESM_MAS_0138 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0138() {
    ...
    function f_rhq_cd_OnChange(obj, code){
         ...
         if(obj.Text != ""){
 			...
 			var sXml = sheetObj.GetSearchXml("ESM_MAS_0138GS.do", masFormQueryString(formObj));
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			...
			case IBSEARCH:      //조회
				...
				sheetObj.DoSearch4Post("ESM_MAS_0138GS.do", masFormQueryString(formObj, 'param1|param2|param3|param4|param5|param6'));
				ComOpenWait(false);
	//			var xml = sheetObj.GetSearchXml("ESM_MAS_138GS.do", FormQueryString(formObj));
