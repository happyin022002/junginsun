...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.coststructure.event.EsmMas0139Event"%>
<%@ page import="com.hanjin.framework.support.view.signon.SignOnUserAccount"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0139Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0139Event)request.getAttribute("Event");
                  ...
                  <td class="bg">
                    ...
                    <table class="search_in" border="0">
                      <tr class="h23">
						...
						<td width="50%" align="right"><img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5"><a href="javascript:ComOpenWindow2('ESM_MAS_0140.do?f_calc_term_cd=&f_wtr_term_cd=&sysCommUiTitle=Feeder Term Ratio','', 'width=900,height=500,menubar=no,scrollbars=no, resizable=yes')" class="purple">Feeder Term Ratio Inquiry</a></td>
						<td width="1%"></td>
                      </tr>
                    </table>
                    <!-- : ( Year ) (E) -->
