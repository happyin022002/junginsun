...
*                  CSR NO. N200807170013 MAS_EQ Repo 단가 조회 화면 변경
...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.mtcost.event.EsmMas0009Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0009Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0009Event)request.getAttribute("Event");
