...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	switch(sAction) {
		case IBSEARCH:      //조회
			...
			sheetObj.DoSearch4Post("ESM_MAS_ASGNGS.do", masFormQueryString(formObj));
//			var xml = sheetObj.GetSearchXml("ESM_MAS_ASGNGS.do", FormQueryString(formObj));
