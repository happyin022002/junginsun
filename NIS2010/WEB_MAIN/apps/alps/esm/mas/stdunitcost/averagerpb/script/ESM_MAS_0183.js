...
function processButtonClick() {
	...
	try {
		...
		case "btn_Creation":  // Basic Info SAVE
			var strUrl = "ESM_MAS_0184.do" + "?f_rpb_yrmon="+formObject.f_rpb_yrmon.value;
...
//	sheetObj.ShowDebugMsg = true;
	...
	case SEARCH01: // Address Info Retrieve
		...
		var sXml = sheetObj.GetSearchXml("ESM_MAS_0183GS.do", masFormQueryString(formObj));
...
function validateForm(sheetObj, formObj, sAction) {
	if(formObj.f_rpb_yrmon.value==""){
		ComShowCodeMessage('MAS10009','Date','YYYY-MM');
		return false;
	}
	switch (sAction) {
		 ...
		 case SEARCH01: // Address Info Save
	         ...
	         if (formObj.f_rlane_cd.Text == "" || formObj.f_rlane_cd.Text == "All") {
	        	 ComShowCodeMessage('MAS10026','Lane');
	        	 return false;
	         }
			 break;
