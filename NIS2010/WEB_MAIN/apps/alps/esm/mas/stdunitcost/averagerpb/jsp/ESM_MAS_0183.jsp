...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.averagerpb.event.EsmMas0183Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0183Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0183Event)request.getAttribute("Event");
