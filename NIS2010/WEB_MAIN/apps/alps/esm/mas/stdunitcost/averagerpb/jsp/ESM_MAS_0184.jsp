...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.averagerpb.event.EsmMas0184Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0184Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	if(classId.equals("ESM_MAS_0174")) {
	...
	try {
		...
		event = (EsmMas0184Event)request.getAttribute("Event");
