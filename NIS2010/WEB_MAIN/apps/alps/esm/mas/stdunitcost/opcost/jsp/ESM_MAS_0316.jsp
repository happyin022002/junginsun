...
<%
	...
	String strUsr_id = "";
	String strUsr_nm = "";
    Logger log = Logger.getLogger("com.hanjin.alps.esm.mas.ESM_MAS_0316");
	try {
...
<html>
<head>
<title>Standard U/C(OP variable cost, etc)</title>
...
<input type="hidden" name="f_avg_grp_cd">
<!-- Outer Table (S)-->
...
<%
for (int sheetNo = 1; sheetNo <= 8; sheetNo++) {
	if(sheetNo == 1) {
%>
      ...
      <div id="tabLayer" style="display: none">
        ...
        <tr>
          <td class="bg">
            ...
            <table class="search" border="0">
              <tr>
                <td class="title_h" height="18"></td>
                <td class="title_s" style="padding-bottom:0;padding-top:0;">Sub Trade or Lane AVG</td>
              </tr>
            </table>
            <table width="100%" id="mainTable">
              <tr>
