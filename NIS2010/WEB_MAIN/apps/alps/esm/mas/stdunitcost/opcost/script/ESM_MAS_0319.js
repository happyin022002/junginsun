    ...
    switch(sheetNo) {
    	case 1:
	        with (sheetObj) {
	            ...
	            var HeadTitle   = "STS|YYYY-MM|YYYY-WK|Trade|Sub Trade|Lane|Bound|VVD|Target Load|Cost / TEU|stnd_cost_cd";
...
function doActionIBSheet(sheetObj,formObj,sAction) {
    ...
    switch(sAction) {    	
        case IBSEARCH:      //결과조회
            ...
            sheetObj.DoSearch("ESM_MAS_0319GS.do", masFormQueryString(formObj));
