...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.costsetup.event.EsmMas0023Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0023Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0023Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="80"><input type="text" class="input2" name="f_cost_yrmon" style="width:70;text-align:center"  value="<%=JSPUtil.getNull(request.getParameter("cost_yrmon"))%>"  maxlength="7" readonly >&nbsp;</td>
