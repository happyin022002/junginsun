...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.costsetup.event.EsmMas0022Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0022Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0022Event)request.getAttribute("Event");
