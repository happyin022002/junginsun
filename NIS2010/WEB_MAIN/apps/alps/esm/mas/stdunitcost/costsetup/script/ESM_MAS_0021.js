...
* 2013.02.19 서미진 [CHM-201323054] ESM_MAS_0022 팝업 사이즈 조절
* 2014.06.19 최성민 [CHM-201430638] [MAS] BU Other (계선/대선) 항목의 각 계정별 분리 반영 위한 CSR 
=========================================================
*/
    ...
    switch(srcName) {
      ...
      case "btn_Creation":
		...
		case "btn_Month_copy":		//팝업창(Month Copy)		
  	       var display = "0,1";
  	     if (tab_selno == 0) { //첫번째 탭이면
  	       ComOpenPopup("ESM_MAS_0173.do?classId=ESM_MAS_0021&prev_week="+prevWeek, 250, 200, "AverageUcCopy", display, true, false);
  	     }
  	    break;
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
        	case IBCLEAR:          //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_MAS_0021GS.do", masFormQueryString(formObj));
...
//				setYrMon();  // 월/주 입력 창에 금월 셋팅
            ...
            case IBSEARCH:      //결과조회
                ...
                sheetObj.DoSearch("ESM_MAS_0021GS.do", masFormQueryString(formObj));
            ...
            case IBSAVE:	//저장
  				if(validateForm(sheetObj,formObj,sAction)){
  					...
  					sheetObj.DoSave("ESM_MAS_0021GS.do", masFormQueryString(formObj));
  					ComOpenWait(false);
  				}
  				break;
    ...
    function doActionIBSheet2(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH:      //결과조회
                ...
                sheetObj.DoSearch4Post("ESM_MAS_0021GS.do",masFormQueryString(formObj)); 
    ...
    */
    function sheet1_OnPopupClick(sheetObj, Row, Col) {
       ...
       if (colName == "com_amt" && sheetObj.CellValue(Row,"itm_cd") == "CNTLY") {
           ...
           ComOpenWindowCenter('/hanjin/ESM_MAS_0024.do' + param, "ESM_MAS_0024_"+POPUP_OPEN_ID, 930, 570, false );    // radio PopUp
    ...
    */
    function sheet2_OnPopupClick(sheetObj, Row, Col) {
       ...
       if (colName == "pop_mty" && sheetObj.CellValue(Row,"itm_cd") == "MTYTT") {
           ...
           ComOpenWindowCenter('/hanjin/ESM_MAS_0022.do' + param, "ESM_MAS_0022_"+POPUP_OPEN_ID, 930, 590, false );    // radio PopUp

       } else if (colName == "pop_mty" && sheetObj.CellValue(Row,"itm_cd") == "GENTT") {
    	  
    	   if(sheetObj.CellValue(Row,"com_amt") < 1 ) {
    		   ComShowCodeMessage("MAS10015","General Expense");
    		   sheetObj.SelectCell(Row,"com_amt");
    		   return false;
    	   }
    	   
    	   var param = "?cost_yrmon="+ComGetMaskedValue(costYrmon,"ym");
           ComOpenWindowCenter('/hanjin/ESM_MAS_0023.do' + param, "ESM_MAS_0023_"+POPUP_OPEN_ID, 700, 345, false );    // radio PopUp
       }
   }
