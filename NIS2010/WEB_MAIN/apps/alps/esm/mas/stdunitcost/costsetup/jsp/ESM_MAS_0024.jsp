...
<%@ page import="com.hanjin.apps.alps.esm.mas.stdunitcost.costsetup.event.EsmMas0024Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0024Event event = null;
	...
	try {
		...
		event = (EsmMas0024Event)request.getAttribute("Event");
