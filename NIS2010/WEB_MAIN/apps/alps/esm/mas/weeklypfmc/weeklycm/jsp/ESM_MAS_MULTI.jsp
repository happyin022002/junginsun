...
*@FileName : esm_mas_multi.jsp
*@FileTitle : Multi data select common
*Open Issues : 이화면은 서버단을 타지 않는다 
*Change history :  
...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.weeklycm.event.EsmMas0279Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0279Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	if(!returnTitle.equals("")) {
 	...
 	try {
 		...
 		event = (EsmMas0279Event)request.getAttribute("Event");
