...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.alps.esm.mas.ESM_MAS_0006");
        ...
        <tr>
          <td class="bg">
            ...
            <table class="search_in" border="0">              
              <tr class="h23">
              	<td width="30px">&nbsp;&nbsp;Office</td>
				<td width="120px"><input type="text" style="width:80px" class="input" name="f_ofc_cd" value="" maxlength="8" onKeyUp="ComKeyEnter('LengthNextFocus');" style="ime-mode:disabled" onKeyPress="ComKeyOnlyAlphabet('upper')">
				<td width="60px"></td>
				<td width="60px"></td>
				<td width="60px"></td>
				<td width="60px"></td>
