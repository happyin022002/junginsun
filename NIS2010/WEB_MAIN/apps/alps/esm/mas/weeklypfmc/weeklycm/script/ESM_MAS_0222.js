...
//    			sheetObj.DoSearch4Post("ESM_MAS_0222GS.do", masFormQueryString(formObj));
                var sXml = sheetObj.GetSearchXml("ESM_MAS_0222GS.do" , FormQueryString(formObj));
