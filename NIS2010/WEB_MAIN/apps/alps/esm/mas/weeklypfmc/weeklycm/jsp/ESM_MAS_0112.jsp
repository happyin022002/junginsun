...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.weeklycm.event.EsmMas0112Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
	EsmMas0112Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0112Event)request.getAttribute("Event");
			...
			<table class="search">
				<tr>
					<td class="bg">
						...
						<tr><td class="sm" style="padding:1,10;">BOTH : both AR and MAS System.<br></td></tr>
						<tr><td class="sm" style="padding:1,10;">MAS Only : on the side of MAS System only.<br></td></tr>
						</table>
