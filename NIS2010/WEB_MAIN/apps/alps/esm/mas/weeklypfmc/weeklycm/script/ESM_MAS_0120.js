...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_MAS_0120 : ESM_MAS_0120 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0120() {
...
//						break;		
    			...
    			case "btn_popup":
		   	        ...
		   	        //spcPopup("POL", "loc_cd="+pol_cd+"&loc_port_ind=Y", 770, 470, "getPOL", "1,0,1,1,1,1,1,1" );
		   	     	...
		   	     	ComOpenWindow('ESM_MAS_0121.do?cost_use_tp_cd=A','Popup', 'width=530, height=350,menubar=0,status=0,scrollbars=0,resizable=1');
	   	        	break;  			
			} // end switch
		} catch(e) {
			if( e == "[object Error]") {
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {				
		...
		switch(sAction) {
			...
			case IBSEARCH:			//조회
				...
				sheetObj.DoSearch4Post("ESM_MAS_0120GS.do", masFormQueryString(formObj,'param1|param2|param3|param4'));
				ComOpenWait(false);
				break;
...
//					sheetObj.DoSave("ESM_MAS_0120GS.do", masFormQueryString(formObj,'f_cmd',true));
//					ComOpenWait(false);
//				}
//				break;
	...
	*/
	function f_trd_cd_OnChange(obj) {
		...
		if (obj.Text != "") {
			...
			var sXml = sheetObj.GetSearchXml("ESM_MAS_0120GS.do", masFormQueryString(formObj));
