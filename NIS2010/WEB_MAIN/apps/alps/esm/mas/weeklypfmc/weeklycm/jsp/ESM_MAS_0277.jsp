...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.alps.esm.mas.ESM_MAS_0277");
        ...
        <tr>
          <td class="bg">
            ...
            <table class="search_in" border="0">
				<tr class="h23">
					<td colspan="2"><script language="javascript">masPeriod1_ofc();</script></td>
					<td><input type="checkbox" class="trans" name="f_demdet" value="Y">&nbsp;Dem/Det</td>
					<td width="20"></td>
					<td width="60px">Status</td>
					<td width="170">			
						<script language="javascript">ComComboObject('f_status', 1, 90 , 0, 0 )</script>
					</td>
					<td width="40"></td>
				</tr>
			</table>
