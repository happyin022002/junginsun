...
<%
	...
	String f_exp_cust_cd = ((request.getParameter("f_exp_cust_cd")==null )?"":request.getParameter("f_exp_cust_cd"));
...
<input type="hidden" name ="f_exp_cust_cd" value="<%=f_exp_cust_cd%>">
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp;Multiple Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
