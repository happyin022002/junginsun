...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.weeklycm.event.EsmMas0121Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0121Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0121Event)request.getAttribute("Event");
