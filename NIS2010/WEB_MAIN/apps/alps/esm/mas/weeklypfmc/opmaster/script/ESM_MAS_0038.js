...
=========================================================
* History
* 2010.04.14 이행지 FormQueryString =>masFormQueryString 변경, Alps 전환후 Save가 없어져  스크립트에서 삭제
*/

/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
/**
 * @extends 
 * @class ESM_MAS_0038 : ESM_MAS_0038 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0038() {
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			...
			case IBSEARCH:      //조회
				...
				sheetObj.DoSearch4Post("ESM_MAS_0038GS.do", masFormQueryString(formObj));
				ComOpenWait(false);
				break;
		}
	}
