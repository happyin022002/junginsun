...
* 2011.05.26 최성민 [CHM-201006017-01] MAS 약정율 로직 추가 - Title Name 변경
...
<%
	...
	try {
		...
		check_cnt = request.getParameter("check_cnt")== null?"":request.getParameter("check_cnt");
...
<input type="hidden" name="check_cnt" value="<%=check_cnt%>">
