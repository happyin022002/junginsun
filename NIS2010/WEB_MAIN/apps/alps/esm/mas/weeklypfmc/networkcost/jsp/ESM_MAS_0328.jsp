...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.alps.esm.mas.ESM_MAS_0328");
    String f_yearweek = "";
    //String userId = "";    
    try {
        //추가----------------------------------------------------------------------------------------- START
        ...
        log.error("ESM_MAS_0328 Exception : "+e.toString());
    }
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; General Expense Cost Modification</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
          ...
          <td class="bg">
            <table class="search" border="0">
              <tr class="h23">
                ...
                <td width="15%">Additional cost TTL</td>
                ...
                <td width=""><input type="text" style="width:160;text-align:right;" name="f_add_ttl_expn" value="" maxlength="25" onkeyPress="ComKeyOnlyNumber(window);" onfocus="ComClearSeparator(this,'', ',');this.select();" onblur="javascript:fnAmountSet(this);"></td>                
              </tr>
            </table>
