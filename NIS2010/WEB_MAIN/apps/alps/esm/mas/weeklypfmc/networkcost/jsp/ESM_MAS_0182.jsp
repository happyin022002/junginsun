...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.networkcost.event.EsmMas0182Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0182Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0182Event)request.getAttribute("Event");
