...
<%
    ...
    String xml = "";
    Logger log = Logger.getLogger("com.hanjin.alps.esm.mas.ESM_MAS_0041");
    try {
        ...
        <tr>
          <td class="bg">
            <table class="search" border="0">
              <tr>
                <td class="gray"><img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5"><a href="#" class="purple"><span id="btn_setCostModi" name="btn_setCostModi">Cost Modification</span></a>
                </td>
              </tr>
