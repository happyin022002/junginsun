...
*@FileName : ESM_MAS_0044.js
*@FileTitle : Allocate Slot-cost By SML VS Slot-release
*Open Issues :
*Change history :
...
/**
 * @extends
 * @class ESM_MAS_0044 : ESM_MAS_0044 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
    function ESM_MAS_0044() {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++, dtData,    85,   daRight,  false, "amt_14",           false, "", dfFloat);
                    ...
                    CellBackColor(0,"amt_14") = RgbColor(184, 218, 231);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBCLEAR:          //조회
                ...
                var sXml = sheetObj.GetSearchXml("ESM_MAS_0044GS2.do", masFormQueryString(formObj));
            ...
            case IBSEARCH:      //조회
                ...
                sheetObj.DoSearch4Post("ESM_MAS_0044GS.do", masFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
                ComOpenWait(false);
                break;
