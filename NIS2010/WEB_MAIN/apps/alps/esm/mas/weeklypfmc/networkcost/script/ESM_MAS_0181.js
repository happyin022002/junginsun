...
/**
 * @extends 
 * @class ESM_MAS_0181 : ESM_MAS_0181 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0181() {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle   = "STS|||||Port|CY|Currency|Port Exp.|Port Exp.|Port Exp.|Canal Exp|Canal Exp|Canal Exp|";
                    var HeadTitle1  = "STS|||||Port|CY|Currency|MAS|PSO|Ratio|MAS|PSO|Ratio";
                  ...
                  //데이터속성                [ROW,   COL,    DATATYPE,           WIDTH,  DATAALIGN,  COLMERGE,   SAVENAME,           KEYFIELD,   CALCULOGIC,     DATAFORMAT,     POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN,    FULLINPUT,  SORTENABLE, TOOLTIP,    ALLCHECK,   SAVESTATUS, FORMATFIX]
                    ...
                    InitDataProperty(0,     cnt++,  dtData, 		    60,     daRight,     true,      "port_ratio",   false,      "",             dfNone,         0,          false,      false);
                    ...
                    InitDataProperty(0,     cnt++,  dtData, 		    60,     daRight,     true,      "cnl_ratio",    false,      "",             dfNone,         0,          false,      false);                    
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_MAS_0181GS.do", masFormQueryString(formObj));
				sheetObj.LoadSearchXml(sXml);
				var pso_cre_dt = ComGetEtcData(sXml, "pso_cre_dt");
				
				formObj.f_rqst_dt.value = ComGetMaskedValue(pso_cre_dt,"ymd");
//                sheetObj.DoSearch4Post("ESM_MAS_0181GS.do", masFormQueryString(formObj));
//                
...
//                if(!validateForm(sheetObj,formObj,sAction)) return false;
    				...
    				if (popup_save_flag){
	    				...
	    				*/
	                    ...
	                    sheetObj.DoSave("ESM_MAS_0181GS.do", masFormQueryString(formObj,'f_cmd',true), -1, true);     
    				} else {
