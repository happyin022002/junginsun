...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.networkcost.event.EsmMas0034Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.framework.component.util.io.HttpUtil"%> 

<%
	EsmMas0034Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0034Event)request.getAttribute("Event");
        ...
        <tr>
          <td class="bg">
            ...
            <table class="search_in" border="0">
              <tr class="h23">
                <td colspan="10"><script language="javascript">masPeriod1();</script></td>
              </tr>
