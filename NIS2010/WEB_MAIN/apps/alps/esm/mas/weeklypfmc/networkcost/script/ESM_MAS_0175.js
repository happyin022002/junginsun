...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends
     * @class ees_mas_0175 : ees_mas_0175 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_MAS_0175() {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++, dtAutoSum, 80,  daRight,  false, "amt_03",      false, "", dfFloat);
                    ...
                    InitDataProperty(0, cnt++, dtAutoSum, 95,  daRight,  false, "amt_08",      false, "", dfFloat);
                    InitDataProperty(0, cnt++, dtAutoSum, 95,  daRight,  false, "amt_15",      false, "", dfFloat);
    ...
    */
    ...
    /**
     ...
     function f_trd_cd_OnChange(obj,value,text) {
        ...
        var sXml = sheetObj.GetSearchXml("ESM_MAS_0175GS.do", masFormQueryString(formObj));
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                sheetObj.DoSearch4Post("ESM_MAS_0175GS.do", masFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
                ComOpenWait(false);
                break;
