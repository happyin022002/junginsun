...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.alps.esm.mas.ESM_MAS_0114");
    ...
    try {
        ...
        log.error("ESM_MAS_0114 Exception : "+e.toString());
    }
...
<!--
    with(document.form) {
        ...
        if (f_strtype.value == "3") { //SML SalesSlot Cht-out Missing 일때
            f_cobcost.disabled = true;
        }   }
-->
</script>
