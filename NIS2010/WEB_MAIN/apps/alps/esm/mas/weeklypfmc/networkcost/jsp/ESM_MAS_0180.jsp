...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.networkcost.event.EsmMas0180Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmMas0180Event  event = null;                    //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmMas0180Event)request.getAttribute("Event");
