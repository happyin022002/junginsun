...
/**
 * @extends 
 * @class ESM_MAS_0329 : ESM_MAS_0329 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0329() {
    ...
    switch(sheetNo) {
        case 1:      //sheet1 init
            ...
            //전체 너비 설정
                ...
                var HeadTitle0  = "STS|Lane/Bound(source)|General Exp.|Lane/Bound(Target Mon)|General Exp.|Diff";
                //해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
                InitHeadRow(0, HeadTitle0, true);
                
                //데이터속성    [ROW,    COL,    DATATYPE,       WIDTH,  DATAALIGN,  COLMERGE,   SAVENAME,   KEYFIELD,   CALCULOGIC, DATAFORMAT, POINTCOUNT,UPDATEEDIT,INSERTEDIT,EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                InitDataProperty(0,     cnt++,  dtHiddenStatus, 	30,      daCenter,   true,       "ibflag");
                InitDataProperty(0,     cnt++,  dtData,             180,     daCenter,   true,       "rlane_cd1",        false,     "",       dfNone,       0,  false,  false);
                InitDataProperty(0,     cnt++,  dtAutoSum,          110,     daRight,    true,       "org_gen_expn",	 false,     "",       dfInteger,    0,  false,  false);
                InitDataProperty(0,     cnt++,  dtData,             180,     daCenter,   true,       "rlane_cd2",        false,     "",       dfNone,   	0,  false,  false);
                InitDataProperty(0,     cnt++,  dtAutoSum,          110,     daRight,    true,       "tgt_gen_expn",     false,     "",       dfInteger,    0,  false,  false);
                InitDataProperty(0,     cnt++,  dtAutoSum,    	    180,     daRight,    true,       "diff_gen_expn",     false,    "",       dfInteger,    0,  false,  false);                
...
function doActionIBSheet(sheetObj,formObj,sAction) {
  ...
  switch(sAction) {
	case IBCLEAR:          //조회
		...
		var sXml = sheetObj.GetSearchXml("ESM_MAS_0329GS.do", masFormQueryString(formObj));
    ...
    case IBSEARCH:      //조회
		...
		sheetObj.DoSearch4Post("ESM_MAS_0329GS.do", masFormQueryString(formObj));
		ComOpenWait(false);
        break;
    ...
    case IBSAVE:                //저장
        ...
        sheetObj.DoSave("ESM_MAS_0329GS.do", masFormQueryString(formObj,'f_cmd',true), -1, false);
        ComOpenWait(false);
    ...
    case IBCREATE:
        ...
        sheetObj.DoSearch("ESM_MAS_0329GS.do", FormQueryString(formObj));          
...
function sheet1_OnSearchEnd(sheetObj, ErrMsg){
	var formObj = document.form;
	sheetObj.SumText(0,"rlane_cd1") = "TOTAL";
	sheetObj.SumText(0,"rlane_cd2") = "TOTAL";
	sheetObj.CellAlign(sheetObj.LastRow,"rlane_cd2") = daCenter;
