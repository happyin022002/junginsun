...
/**
 * @extends 
 * @class ESM_MAS_0154 : ESM_MAS_0154 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0154() {
  ...
  switch(sheetNo) {
    case 1:      //sheet1 init
        with (sheetObj) {
          ...
          var HeadTitle="Year|Week|Trade|R.Lane|Vessel|Voyage|Dir|SML \nBSA|Lease \nBSA|SML BSA \n(%)|Lease BSA\n(%)|Expense|Income";
...
function doActionIBSheet(sheetObj,formObj,sAction) {
  ...
  switch(sAction) {
    ...
    case SEARCHLIST:      //조회
        ...
        sheetObj.DoSearch4Post("ESM_MAS_0154GS.do", masFormQueryString(formObj));
        ComOpenWait(false);
        break;
