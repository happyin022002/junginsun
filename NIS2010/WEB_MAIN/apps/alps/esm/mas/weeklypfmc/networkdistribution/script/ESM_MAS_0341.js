...
/**
 * @extends 
 * @class ESM_MAS_0341 : ESM_MAS_0341 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0341() {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle0  = "STS|From VVD|From VVD|From VVD|From VVD|From VVD|From VVD|From VVD|From VVD|To VVD|To VVD|To VVD|To VVD|To VVD|To VVD|To VVD|To VVD|To VVD|Allocation result|Allocation result";
                    var HeadTitle1  = "STS|R.Month|Week|Trade|Lane|IOC|VVD|Unit Cost\nPer Slot|SML Sales\nAMT|R.Month|Week|Trade|Lane|IOC|VVD|Status|Vol(TEU)|Ratio(%)|T/S Expense";
                    ...
                    InitDataProperty(0,     cnt++,  dtData,        60,     daCenter,   true,       "fm_cost_yrmon"             ,         false,     "",    dfNone,       0,  false,  false);
...
//                    InitDataProperty(0,     cnt++,  dtData,        50,     daCenter,   true,       "fm_vsl_cd"                 ,         false,     "",    dfNone,       0,  false,  false);
//                    InitDataProperty(0,     cnt++,  dtData,        50,     daCenter,   true,       "fm_skd_voy_no"             ,         false,     "",    dfNone,       0,  false,  false);
//                    InitDataProperty(0,     cnt++,  dtData,        50,     daCenter,   true,       "fm_dir_cd"                 ,         false,     "",    dfNone,       0,  false,  false);
                    InitDataProperty(0,     cnt++,  dtData,        80,     daCenter,   true,       "fm_vvd"                    ,         false,     "",    dfNone,       0,  false,  false);
                    InitDataProperty(0,     cnt++,  dtData,        80,     daRight,    true,       "fm_ts_uc_amt"              ,         false,     "",    dfFloat,       2,  false,  false);
                    InitDataProperty(0,     cnt++,  dtData,        80,     daRight,    true,       "fm_sml_sls_amt"            ,         false,     "",    dfFloat,       2,  false,  false);
                    InitDataProperty(0,     cnt++,  dtData,        60,     daCenter,   true,       "to_cost_yrmon"             ,         false,     "",    dfNone,       0,  false,  false);
...
//                    InitDataProperty(0,     cnt++,  dtData,        50,     daCenter,   true,       "to_vsl_cd"                 ,         false,     "",    dfNone,       0,  false,  false);
//                    InitDataProperty(0,     cnt++,  dtData,        50,     daCenter,   true,       "to_skd_voy_no"             ,         false,     "",    dfNone,       0,  false,  false);
//                    InitDataProperty(0,     cnt++,  dtData,        50,     daCenter,   true,       "to_dir_cd"                 ,         false,     "",    dfNone,       0,  false,  false);
                    ...
                    InitDataProperty(0,     cnt++,  dtData,        70,     daRight,    true,       "ts_qty"                    ,         false,     "",    dfInteger,       2,  false,  false);
                    InitDataProperty(0,     cnt++,  dtData,        70,     daRight,    true,       "ts_qty_rto"                ,         false,     "",    dfFloat,       2,  false,  false);
                    InitDataProperty(0,     cnt++,  dtData,        90,     daRight,    true,       "ts_expn_amt"               ,         false,     "",    dfFloat,       2,  false,  false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {        
        ...
        switch(sAction) {
	        case IBCLEAR:          //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_MAS_0341GS.do", masFormQueryString(formObj));
            ...
            case IBSEARCH:      //조회
                ...
                if(validateForm(sheetObj,formObj,sAction)){
                    ...
                    sheetObj.DoSearch("ESM_MAS_0341GS.do", masFormQueryString(formObj));
           ...
           case IBCREATE:
                ...
                //sheetObj.DoSearch("ESM_MAS_0341GS.do", FormQueryString(formObj));        
                
                sXml = sheetObj.GetSaveXml("ESM_MAS_0341GS.do", FormQueryString(formObj));
                //alert(sXml)
