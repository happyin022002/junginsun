...
* 2014.03.11 최성민 [CHM-201429166]  [MAS] TS Allocation2 (OP5 및 OP6) 배부 로직 변경
=========================================================
*/
...
/**
 * @extends 
 * @class ESM_MAS_0050 : ESM_MAS_0050 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0050() {
...
function f_seltrade_OnChange(obj,value,text) {
 	...
 	if ("All"!=value) {
		...
		var sXml = sheetObj.GetSearchXml("ESM_MAS_0050GS.do", masFormQueryString(formObj));
...
//		  ComOpenWait(true);
		  ...
		  sheetObj.DoSearch4Post("ESM_MAS_0050GS.do", masFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
//		  ComOpenWait(false);
		  sheetObj.WaitImageVisible = false;
...
function monitoringBatchJob(){
	...
	var sXml = sheetObj.GetSearchXml("ESM_MAS_0050GS.do", FormQueryString(formObj));
