...
* 2013.08.12 최성민 [CHM-201326152] [MAS] SML Sales / Slot Cht out 화면 R.Month와 Week 정보 추가
*  
=========================================================*/
...
/**
 * @extends 
 * @class ESM_MAS_0045 : ESM_MAS_0045 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_MAS_0045() {
...
function initSheet(sheetObj,sheetNo) {
  switch(sheetNo) {
      case 1:      //sheet1, sheet2 init
      case 2:
        var head1 = "|All Network cost by VVD";
        var head2 = "|Network cost for SML Sales";
        ...
        with (sheetObj) {
          ...
          var HeadTitle0 = "STS|R.Month|Week|Trade|Lane|Vessel|Voy.|BD|Trade Dir.|OPR|OPR2|V.Capa.|BSA.Capa.|Type|Lane Type|Final\nSML BSA|CHT OUT|SML(%)|CHT(%)|Unit Cost\nPer Slot|Space Charter\nRevenue"
                         + headText1;
          var HeadTitle1 = "STS|R.Month|Week|Trade|Lane|Vessel|Voy.|BD|Trade Dir.|OPR|OPR2|V.Capa.|BSA.Capa.|Type|Lane Type|Final\nSML BSA|CHT OUT|SML(%)|CHT(%)|Unit Cost\nPer Slot|Space Charter\nRevenue"
                         + headText2;
          ...
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_01",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_02",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_03",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_04",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_05",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_06",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_07",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_08",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_09",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_10",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_11",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_12",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_13",         false, "", dfFloatOrg, 0, true, true);
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_1_14",         false, "", dfFloatOrg, 0, true, true);
          ...
          InitDataProperty(0, cnt++, dtAutoSum, 75, daRight,  true, "amt_3_14",         false, "", dfFloatOrg, 0, false, false);
          ...
          InitDataProperty(0, cnt++, dtHidden,	60, daCenter, true, "upd_usr_id",		false, "", dfNone,	   0, false, false);
...
function f_seltrade_OnChange(obj,value,text) {
	...
	if ("All"!=value) {
		...
		var sXml = sheetObj.GetSearchXml("ESM_MAS_0045GS2.do", masFormQueryString(formObj));
...
function doActionIBSheet(sheetObj,formObj,sAction) {
    ...
    switch(sAction) {
		...
		case IBSEARCH:      //조회
            ...
            sheetObj.DoSearch4Post("ESM_MAS_0045GS.do", masFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
            ComOpenWait(false);
            break;
		...
		case IBSAVE:      //저장
            if(validateForm(sheetObj,formObj,sAction)){
                ...
                sheetObj.DoSave("ESM_MAS_0045GS.do", masFormQueryString(formObj));
        ...
        case IBLOADEXCEL:   // 엑셀로드 (sheetObjects[1]  ---> sheetObjects[0] 으로)
            ...
            for(var sheet2_row = sheet2.HeaderRows; sheet2_row < sheet2_rowCount; sheet2_row++) {
            	var compare_key = "" 
			                    ...
			                    + sheet2.CellValue(sheet2_row, "vsl_cd")
			                    + sheet2.CellValue(sheet2_row, "skd_voy_no")
			                    + sheet2.CellValue(sheet2_row, "dir_cd");
                                 
            	var sheet1_row = sheet1.FindText("compare_key", compare_key);
                
                if(sheet1_row > -1) {
                	if (sheet1.CellValue(sheet1_row, "amt_1_01") != sheet2.CellValue(sheet2_row, "amt_1_01")) {
                		var sheet2_amount_1_01 = sheet2.CellValue(sheet2_row, "amt_1_01");
                        sheet1.CellValue(sheet1_row, "amt_1_01") = sheet2_amount_1_01;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_02") != sheet2.CellValue(sheet2_row, "amt_1_02")) {
                		var sheet2_amount_1_02 = sheet2.CellValue(sheet2_row, "amt_1_02");
                        sheet1.CellValue(sheet1_row, "amt_1_02") = sheet2_amount_1_02;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_03") != sheet2.CellValue(sheet2_row, "amt_1_03")) {
                		var sheet2_amount_1_03 = sheet2.CellValue(sheet2_row, "amt_1_03");
                        sheet1.CellValue(sheet1_row, "amt_1_03") = sheet2_amount_1_03;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_04") != sheet2.CellValue(sheet2_row, "amt_1_04")) {
                		var sheet2_amount_1_04 = sheet2.CellValue(sheet2_row, "amt_1_04");
                        sheet1.CellValue(sheet1_row, "amt_1_04") = sheet2_amount_1_04;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_05") != sheet2.CellValue(sheet2_row, "amt_1_05")) {
                		var sheet2_amount_1_05 = sheet2.CellValue(sheet2_row, "amt_1_05");
                        sheet1.CellValue(sheet1_row, "amt_1_05") = sheet2_amount_1_05;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_06") != sheet2.CellValue(sheet2_row, "amt_1_06")) {
                		var sheet2_amount_1_06 = sheet2.CellValue(sheet2_row, "amt_1_06");
                        sheet1.CellValue(sheet1_row, "amt_1_06") = sheet2_amount_1_06;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_07") != sheet2.CellValue(sheet2_row, "amt_1_07")) {
                		var sheet2_amount_1_07 = sheet2.CellValue(sheet2_row, "amt_1_07");
                        sheet1.CellValue(sheet1_row, "amt_1_07") = sheet2_amount_1_07;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_08") != sheet2.CellValue(sheet2_row, "amt_1_08")) {
                		var sheet2_amount_1_08 = sheet2.CellValue(sheet2_row, "amt_1_08");
                        sheet1.CellValue(sheet1_row, "amt_1_08") = sheet2_amount_1_08;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_09") != sheet2.CellValue(sheet2_row, "amt_1_09")) {
                		var sheet2_amount_1_09 = sheet2.CellValue(sheet2_row, "amt_1_09");
                        sheet1.CellValue(sheet1_row, "amt_1_09") = sheet2_amount_1_09;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_10") != sheet2.CellValue(sheet2_row, "amt_1_10")) {
                		var sheet2_amount_1_10 = sheet2.CellValue(sheet2_row, "amt_1_10");
                        sheet1.CellValue(sheet1_row, "amt_1_10") = sheet2_amount_1_10;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_11") != sheet2.CellValue(sheet2_row, "amt_1_11")) {
                		var sheet2_amount_1_11 = sheet2.CellValue(sheet2_row, "amt_1_11");
                        sheet1.CellValue(sheet1_row, "amt_1_11") = sheet2_amount_1_11;
                	}
                   
                	if (sheet1.CellValue(sheet1_row, "amt_1_12") != sheet2.CellValue(sheet2_row, "amt_1_12")) {
                		var sheet2_amount_1_12 = sheet2.CellValue(sheet2_row, "amt_1_12");
                        sheet1.CellValue(sheet1_row, "amt_1_12") = sheet2_amount_1_12;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_13") != sheet2.CellValue(sheet2_row, "amt_1_13")) {
                		var sheet2_amount_1_13 = sheet2.CellValue(sheet2_row, "amt_1_13");
                        sheet1.CellValue(sheet1_row, "amt_1_13") = sheet2_amount_1_13;
                	}
                    
                	if (sheet1.CellValue(sheet1_row, "amt_1_14") != sheet2.CellValue(sheet2_row, "amt_1_14")) {
                		var sheet2_amount_1_14 = sheet2.CellValue(sheet2_row, "amt_1_14");
                        sheet1.CellValue(sheet1_row, "amt_1_14") = sheet2_amount_1_14;
                	}
                }
            }
            ...
            if(sheet1.RowCount("U") == 0) {
                alert("No data changed.\n\n"
                        + "1. Excel file data does not match retrieved data. (TRD/RLANE/VVD)\n"
                        + "2. Wrong format file.\n"
                        + "3. Sales/Slot Cht-out column doesn't changed in excel file.");
                return false;
            }
        ...
        case IBCREATE:      //생성
            ...
            if (ComShowConfirm(ComGetMsg('MAS10020')) == true) {
                ...
                if (err_cd == "00000") {
                    ...
                    // SML Sales/Slot Cht-out 생성시 Missing 이 있을때 
