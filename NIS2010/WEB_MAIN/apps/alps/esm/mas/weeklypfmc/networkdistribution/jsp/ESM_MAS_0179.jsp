...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.networkdistribution.event.EsmMas0179Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0179Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0179Event)request.getAttribute("Event");
