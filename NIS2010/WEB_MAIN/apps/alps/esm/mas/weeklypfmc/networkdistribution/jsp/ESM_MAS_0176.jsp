...
<%@ page import="com.hanjin.apps.alps.esm.mas.weeklypfmc.networkdistribution.event.EsmMas0176Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmMas0176Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0176Event)request.getAttribute("Event");
