    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH:      //조회
                ...
                sheetObj.DoSearch4Post("ESM_MAS_0167GS.do", masFormQueryString(formObj));
                ComOpenWait(false);
                break;
            ...
            case IBSAVE:        //저장
                ...
                sheetObj.DoAllSave("ESM_MAS_0167GS.do", masFormQueryString(formObj));
                ComOpenWait(false);
                break;
