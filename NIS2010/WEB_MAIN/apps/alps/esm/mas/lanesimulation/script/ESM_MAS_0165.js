    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
        	case IBCLEAR:          //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_MAS_0165GS2.do", masFormQueryString(formObj));
        	...
        	case IBSEARCH:      //조회
                ...
                sheetObj.DoSearch("ESM_MAS_0165GS.do", masFormQueryString(formObj));
                ComOpenWait(false);
                break;
                ...
                formObj.f_cmd.value = MULTI01;
                    ...
                    if(saVar == "1" && vaVar == "0"){
                        if ( confirm("If 001 report is deleted, related simulations will be deleted. Will you proceed?") ) {
                        	...
                        	sheetObj.WaitImageVisible = false;
                        	ComOpenWait(true);
                            sheetObj.DoSave("ESM_MAS_0165GS.do", masFormQueryString(formObj));
                            formObj.f_cmd.value = SEARCH;
                            sheetObj.DoSearch4Post("ESM_MAS_0165GS.do", masFormQueryString(formObj));
                            ComOpenWait(false);
                        }
