    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
        	case IBCLEAR:          //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_MAS_0151GS.do", masFormQueryString(formObj));
            ...
            case IBSEARCH:      //조회
                ...
                if(comboObjects[0].Code == ""){
                	ComShowMessage(ComGetMsg("MAS10002","Vsl Class"));
    			        return false;
                }
                document.form.f_vsl_clss_capa.value = document.form.cobVslCls.text;
                sheetObj.DoSearch4Post("ESM_MAS_0151GS.do", masFormQueryString(formObj));
                ComOpenWait(false);
                break;
            ...
            case IBSAVE:        //저장
                ...
                sheetObj.DoSave("ESM_MAS_0151GS.do", masFormQueryString(formObj));
                ComOpenWait(false);
                break;
            ...
            case IBINSERT:      // 입력
                ...
                if(comboObjects[0].Code != "" && sheetObj.LastRow < 2){
                	...
                	ComShowMessage(ComGetMsg("MAS10058"));
                }
                break;
