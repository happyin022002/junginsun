	...
	switch(sAction) {
		...
		case IBSEARCH:		//조회
			if(validateForm(sheetObj,formObj,sAction)) {
    			...
    			sheetObj.DoSearch4Post("ESM_MAS_0168GS.do", masFormQueryString(formObj));
    			ComOpenWait(false);
			}
			break;
		...
		case IBSAVE://저장
			if(validateForm(sheetObj,formObj,sAction)){
			    ...
			    sheetObj.DoSave("ESM_MAS_0168GS.do", masFormQueryString(formObj));//
			    opener.setVal_f_sim();
			    ComOpenWait(false);
			}
			break;
