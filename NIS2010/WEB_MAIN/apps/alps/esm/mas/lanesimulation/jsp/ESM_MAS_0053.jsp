...
'프로그램 ID  : apps/enis/esm/mas/lanesimulation/jsp/ESM_MAS_0053.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0053Event"%>
<%@ page import="com.hanjin.framework.support.view.signon.SignOnUserAccount"%>
<%@ page import="com.hanjin.framework.component.util.io.HttpUtil"%>
<%
  	SignOnUserAccount account = (SignOnUserAccount) session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
    EsmMas0053Event  event = null;                				//PDTO(Data Transfer Object including Parameters)
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.mas.lanesimulation.EsmMas0053Event");
    try {
        event = (EsmMas0053Event)request.getAttribute("Event");
        ...
        log.error("ESM_MAS_0053 Exception : "+e.toString());
