...
<%@ page import="com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0168Event"%>
<%
	EsmMas0168Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmMas0168Event)request.getAttribute("Event");
