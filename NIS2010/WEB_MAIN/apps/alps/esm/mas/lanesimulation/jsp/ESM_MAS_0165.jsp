...
'프로그램 ID  : apps/enis/esm/mas/lanesimulation/jsp/ESM_MAS_165.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0165Event"%>
<%
    EsmMas0165Event  event = null;     //PDTO(Data Transfer Object including Parameters)
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.mas.lanesimulation.ESM_MAS_165");
    ...
    try {
        ...
        if (serverException != null) {
            ...
            event = (EsmMas0165Event)request.getAttribute("Event");
        } // end else

    }catch(Exception e) {
        log.error("EsmMas165Event Exception : "+e.toString());
