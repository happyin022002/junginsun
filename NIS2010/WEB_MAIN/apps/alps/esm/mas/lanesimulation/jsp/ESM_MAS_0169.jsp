...
'프로그램 ID  : apps/enis/esm/mas/lanesimulation/jsp/ESM_MAS_169.jsp
...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.mas.lanesimulation.ESM_MAS_0169");
    ...
    try {
        ...
        log.error("ESM_MAS_169 Exception : "+e.toString());
