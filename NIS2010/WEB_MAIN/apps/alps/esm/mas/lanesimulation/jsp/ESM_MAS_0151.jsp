...
'프로그램 ID  : apps/enis/esm/mas/lanesimulation/jsp/ESM_MAS_151.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0151Event"%>
<%
    EsmMas0151Event  event = null;     //PDTO(Data Transfer Object including Parameters)
    Exception serverException   = null; //서버에서 발생한 에러
    String strErrMsg    = "";           //에러메세지
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.mas.lanesimulation.ESM_MAS_0151");
    ...
    try {
        ...
        if (serverException != null) {
            ...
            event = (EsmMas0151Event)request.getAttribute("Event");
        } // end else
      
    }catch(Exception e) {
        log.error("ESM_MAS_151 Exception : "+e.toString());
