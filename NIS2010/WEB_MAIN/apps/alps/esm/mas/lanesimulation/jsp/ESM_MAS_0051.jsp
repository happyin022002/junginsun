...
'프로그램 ID  : apps/enis/esm/mas/lanesimulation/jsp/ESM_MAS_051.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0051Event"%>
<%@ page import="com.hanjin.framework.support.view.signon.SignOnUserAccount"%>
<%@ page import="com.hanjin.framework.component.util.io.HttpUtil"%>
<%
  	SignOnUserAccount account = (SignOnUserAccount) session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
    EsmMas0051Event event     = null;	//PDTO(Data Transfer Object including Parameters)
    Exception serverException = null; //서버에서 발생한 에러
    String strErrMsg 	 = "";          //에러메세지
    String xml = "";
	Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.mas.lanesimulation.EsmMas0051");
    ...
    try {
        ...
        if (serverException != null) {
	      ...
	      event = (EsmMas0051Event)request.getAttribute("Event");
	      xml = HttpUtil.makeXML(request,response); 
          xml = xml.replaceAll("\"", "'");
        } 
    }catch(Exception e) {
        log.error("ESM_MAS_0051.jsp Exception : " + e.toString());
