...
* 2009-03-10 Ari CSR No.N200903040140 COA COST SOURCE CODE 보이도록 처리
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0155 : ESM_COA_0155 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0155() {
    		...
    		switch(sheetNo) {
    			case 1:	 //sheet1 init
    				with (sheetObj) {
                        ...
                        var HeadTitle = "Node/Link|Activity Group|H|Cost Element|Source Code|Source Code Description/Activity|Amount|Ctrt/Avg|Vendor|Remark|avg_lvl_chk|SEQ" ;                   
    		...
    		switch(sAction) {
    			case IBSEARCH:	 //조회
    				if(validateForm(sheetObj,formObj,sAction)) {
    					...
    					sheetObj.DoSearch4Post("ESM_COA_0155GS.do", coaFormQueryString(formObj));
    					ComOpenWait(false);
    				}
    				break;
