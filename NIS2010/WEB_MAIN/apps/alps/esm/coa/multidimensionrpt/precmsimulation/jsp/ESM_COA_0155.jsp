...
<%@ page import="com.hanjin.apps.alps.esm.coa.multidimensionrpt.precmsimulation.event.EsmCoa0155Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
//	EsmCoa0155Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//		event = (EsmCoa0155Event)request.getAttribute(Event);
          ...
          <tr>
            <td class="bg">
              <table class="search" border="0">
                <tr>
                  <td class="title_h"></td>
                  <td class="title_s">Cost Remark Inquiry</td>
