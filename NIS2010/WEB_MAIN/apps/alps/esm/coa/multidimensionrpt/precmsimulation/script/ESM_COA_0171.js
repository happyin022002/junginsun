...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_COA_0171 : ESM_COA_0171 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0171() {
        ...
        */
                ...
                case IBSAVE:        /*저장*/
                    ...
                    for(i=2;i<l;i++){
                        if(n_ts_route == sheetobj2.CellValue(i, "ts_route")){
                            ComShowMessage(ComGetMsg('COA10042'));
                            exist_flg = "Y";
                        }
                    }
        ...
        function validateCond(){
            ...
            if(sheetObj.cellText(2,"n_pol")== ""){
                ComShowMessage(ComGetMsg('COA10002','POL'));
                return false;
            } else if(sheetObj.cellText(2,"lane1")== ""){
                ComShowMessage(ComGetMsg('COA10002','1st Lane'));
                return false;
            } else if(sheetObj.cellText(2,"n_pod")== ""){
                ComShowMessage(ComGetMsg('COA10002','POD'));
                return false;
            }
           ...
           if(!sheetObj.cellText(2,"port3") == "" ){
               for(i=2;i<8;i++){
                   if(sheetObj.cellText(2,i) == ""){
                     ComShowMessage(ComGetMsg('COA10041'));
                     return false;
                   }
               }
