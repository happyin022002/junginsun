...
* 2008.11.19 전윤주 CSR No. N200811060003 COA_Report 기능 개선(2) 선택된 option 상하로 이동
...
/**
 * @extends 
 * @class ESM_COA_0059 : ESM_COA_0059 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0059() {
...
document.onclick = processButtonClick;
        ...
        try {
            switch(srcName) {
                ...
                case "btn_Close":
                    ...
                    //opener.document.form.f_include_ts.checked = false;
                    opener.chgInitSheet();
     ...
     */
     function f_selgroup_OnChange(obj, code){
        ...
        sheetObject1.DoSearch4Post("ESM_COA_0059GS.do", coaFormQueryString(formObj)); 
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                //20100414 이중환, FormQueryString -> coaFormQueryString 변경
                sheetObj.DoSearch4Post("ESM_COA_0059GS.do", coaFormQueryString(formObj));
                break;
