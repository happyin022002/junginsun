...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.alps.esm.coa.ESM_COA_0059");
    try {
        ...
        pColDesc = request.getParameter("col_desc");
        reportFormPopupCallCnt = request.getParameter("call_cnt");
