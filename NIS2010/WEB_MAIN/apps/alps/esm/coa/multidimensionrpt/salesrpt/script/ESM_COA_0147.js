...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0147 : ESM_COA_0147 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0147() {
    		...
    		switch(sheetNo) {
    		    case 1:	//sheet1 init
    				with (sheetObj) {
    					...
    					var HeadTitle = "ORG|DEST|POR|REV POL|REV POD|DEL|TP/SZ|Load|REV|CM COST|CM|CM2 COST|CM2|OP COST|BKG OP" ;
...
//    					RangeBackColor(1, 13, 1, 20) = RgbColor(222, 251, 248);  // ENIS
  ...
  //  			 openWindow('ESM_COA_0148.do?'+ FormQueryString(document.form)+cond, 
  //  			    '_BKG', 'width=950,height=450,menubar=0,status=0,scrollbars=0,resizable=0')	
    		     //20100414 이중환, FormQueryString -> coaFormQueryString 변경    					
    			 ComOpenWindow2('ESM_COA_0148.do?'+ coaFormQueryString(document.form)+cond, 
    	...
    	function doActionIBSheet(sheetObj,formObj,sAction) {
    		...
    		switch(sAction) {
    			case IBSEARCH:		//조회
    				...
    				formObj.f_cmd.value = SEARCHLIST01;
    	            //20100414 이중환, FormQueryString -> coaFormQueryString 변경
    				sheetObj.DoSearch4Post("ESM_COA_0147GS.do", coaFormQueryString(formObj));
    				ComOpenWait(false);
    				break;
