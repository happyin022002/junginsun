...
* 2015.05.15 손진환[CHM-201535424] [COA] COA 상 Fixed Rate 반영
...
<%@ page import="com.hanjin.apps.alps.esm.coa.multidimensionrpt.salesrpt.event.EsmCoa0060Event"%>
        ...
        <tr>
          <td class="bg">
            ...
            <table class="search_in" border="0">
              <tr class="h23">
                <td colspan="3"><script language="javascript">coaPeriod3_ofc();</script><!-- FormControl.js --></td></tr>
              <tr class="h23">
                <td width="11%"></td>
                <td width="11%"></td>
            ...
            <table class="search_in" border="0"><tr class="h23">
              ...
              <tr class="h23">
                ...
                <td>Shipper</td>
                <td>
                  <input type="text" maxlength="8" name="txtShipper" style="width:80;ime-mode:disabled;" maxlegnth="8" onFocusOut="chkFormat(this);" onKeyPress="ComKeyOnlyAlphabet('uppernum');">
            ...
            <table class="search" border="0">
              <tr class="h23">
                ...
                <td width="300" class="gray">
                  ...
                  <a href="javascript:ComOpenWindowCenter('ESM_COA_0178.do', 'ESM_COA_0178', 500, 480, true, 'yes');" class="purple"> Set IAS Sub</a>
                  <img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5">
