...
* 2010.12.01 김기종 CSR No. CHM-201004982-01 COA Architecture 위배사항 수정 (CommonSC)
...
* 2013.11.18 박찬민 [CHM-201327153] [COA] Inquiry by Source Data 화면의 주차 연장 등 추가 사항 
...
<%
	...
	String strErrMsg = "";
	Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.coa.multidimensionrpt.sales.jsp.ESM_COA_035");
...
<tr>
	<td class="bg">
		...
		<tr class="h23">
			<td colspan="3"><script language="javascript">coaPeriod2_ofc();</script><!-- FormControl.js --></td>
		</tr>
        <tr class="h23">
            <td width="11%"></td>
            <td width="11%"></td>
    ...
    <tr>
      <td colspan="9" class="line_bluedot" style="height:11;"></td>
		...
		<tr class="h23">
			...
			<td colspan="2"><input type="checkbox" class="trans" name="f_bkg_sts" value="Y">Waiting Booking Include</td>
		</tr>
