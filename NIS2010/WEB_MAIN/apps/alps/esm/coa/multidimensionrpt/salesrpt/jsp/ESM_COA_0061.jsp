...
'프로그램 ID  : apps/enis/esm/coa/multidimensionrpt/sales/jsp/ESM_COA_061.jsp
...
' 2008.06.16 PEJ    N200805307021 Split 02-COA_화면 개발 및 수정
' 2008.08.29 박상희 N200807298360 Expense Detail로 테이블 변경하면서 화면단 모두 변경[061]
' 2008.09.22 김태윤 N200808278919 Spilt 01-COA_Report내 수정사항 (searchBKG061List, searchBkgAbcstp156List 쿼리수정)
...
' 2008.12.17 박상희 N200812100006 COA_Inquiry by BKG 화면 수정 : R.Mon/S.Mon 모두 보여줌
				    ...
				    <tr><td><img src="/hanjin/img/ico_star.gif" border=0> <strong>Remark</strong></td>
				        <td class="btn2_bg">
							...
							<tr>
								...
								<!-- Repeat Pattern -->
								<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
								<tr><td class="btn2_left"></td><td class="btn2" id="btns_remarks" name="btns_remarks">Remarks</td><td class="btn2_right"></td></tr></table></td>
