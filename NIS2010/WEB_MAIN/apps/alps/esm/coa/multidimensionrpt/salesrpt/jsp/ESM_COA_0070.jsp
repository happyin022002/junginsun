...
'프로그램 ID  : apps/enis/esm/coa/multidimensionrpt/sales/jsp/ESM_COA_070.jsp
...
' 2008.06.10 박은주 N200805307020 Split 01-COA_화면 개발 및 수정
...
* 2012.12.14 최윤성 [CHM-201222075-01] [COA] Account별 QTA 조회 기능 추가  - Customer 조건 추가
...
* 2014.04.25 최성민 [CHM-201429994] [COA] Office Report vs QTA 화면 항목 추가 (IAS Sector Sales)
...
<tr><td>
		...
		<tr><td class="bg" valign="top" width="100%">
					...
					<table class="search_in" border="0">
                         <tr class="h23" id="tr1" style="display:none;"><td colspan="5"><script language="javascript">coaPeriod3_ofc();</script></td></tr>
                         <tr class="h23">
							...
							<table border="0" style="height:15; width:590;">
		                		<tr class="h23">
		                  			<td style="padding-left:10;">
		    							...
		    							<input type="checkbox" class="trans" name="f_ofc_sts" value="Y" onClick="viewOffice();">&nbsp;Office Display&nbsp;&nbsp;&nbsp;
