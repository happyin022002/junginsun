...
===========================================================
	...
	' 2008.08.29 박상희 CSR No. N200807298360 Expense Detail로 테이블 변경하면서 화면단 모두 변경[148]
	' 2009.03.24 배진환 N200903130001 - Key Account 조회 조건 변경
	' 2009.04.03 김태윤 N200903170123 - COA_Multi-dimension report 조회권한 변경, 디자인 수정
	' 2009.05.14 박상희 N200904170011 - bound disp. & wk disp. 체크시 BKG Detail 팝업에도 반영
...
<%@ page import="com.hanjin.apps.alps.esm.coa.multidimensionrpt.salesrpt.event.EsmCoa0148Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
//	EsmCoa0148Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//		event = (EsmCoa0148Event)request.getAttribute("Event");
		serverException = (Exception)request.getAttribute(CommonWebKeys.EXCEPTION_OBJECT);

        f_ofc_cd = account.getOfc_cd();
        f_ofc_lvl =account.getUsr_auth_tp_cd();
...
//		GeneralEventResponse eventResponse = (GeneralEventResponse) request.getAttribute("EventResponse");
	...
	//N200903120100 처리를 위해 f_ofc_cd, ofc_lvl을 무조건 SELHO, 1로 바꾸어 준다.
	f_ofc_cd = !"SELHO".equals(f_ofc_cd)?"SELHO":f_ofc_cd;
	f_ofc_lvl = !"1".equals(f_ofc_cd)?"1":f_ofc_lvl;
%>
<html>
<head>
...
<form method="post" name="form" onSubmit="return false;" onKeyDown="ComKeyEnter();">
  ...
  <input type="hidden" name="f_chkprd" value="<%=JSPUtil.getNull(request.getParameter("f_chkprd"),"W")%>">
  <!-- -->
...
<!-- <input type="hidden" name="f_dir_cd" value="<%=JSPUtil.getNull(request.getParameter("f_dir_cd"))%>"> -->
  ...
  <table width="1000" class="popup" cellpadding="10" border="0">
    ...
    <tr><td valign="top">
			...
			<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; BKG Detail Inquiry</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
          ...
          <tr>
            <td class="bg">
              <table class="search" border="0">
                <tr>
                  <td class="title_h"></td>
                  <td class="title_s">BKG Detail Inquiry</td>
                </tr>
                <tr>
