...
/**
 * @extends 
 * @class ESM_COA_0135 : ESM_COA_0135 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0135() {
     ...
     function chgOffice(obj){
        ...
        if(obj.Text != ""){
        	formObj.f_cmd.value = SEARCHLIST13;
     		var sXml = sheetObj.GetSearchXml("ESM_COA_0135GS2.do", coaFormQueryString(formObj));
		...
		switch(sAction) {
			...
			case IBSEARCH:		//조회
				if(validateForm(sheetObj,formObj,sAction)){
					...
					sheetObj.DoSearch4Post("ESM_COA_0135GS.do", coaFormQueryString(formObj));
					ComOpenWait(false);
				}
				break;
