...
*@FileTitle : ROUTE CASE별 추정 비용 조회
*Open Issues :
...
* 2014.07.18 PEJ [CHM-201431133] [COA] HJL에서 ETS모듈 통해 발행한 W/O에 대한 Vendor 참조 로직 보완 및 S/P Code 추가 - Vendor 추가
=========================================================*/
		...
		switch(sheetNo) {
			case 1:	 //sheet1 init
				with (sheetObj) {
                    ...
                    var HeadTitle = "Node/Link|Activity Group|H|Cost Element|Source Code|Source Code Description/Activity|Amount|Ctrt/Avg|Vendor|Remark|SEQ|avg_lvl_chk|" ;                   
                    ...
                    InitDataProperty(0, cnt++, dtData,	    70,	daCenter,	true,   "coa_cost_src_cd", 	false,  "",	dfNone);
                    InitDataProperty(0, cnt++, dtData,		200,daLeft,		true,   "coa_cost_src_nm", 	false,  "",	dfNone);
                    ...
                    InitDataProperty(0, cnt++ ,dtData,	50,	daCenter,	true,	"vendor_seq",		false,  "",	dfNone);
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			case IBSEARCH:	 //조회
				...
				sheetObj.DoSearch4Post("ESM_COA_0170GS.do", coaFormQueryString(formObj));
				ComOpenWait(false);
