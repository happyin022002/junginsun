...
===========================================================
    ...
    * 2009.10.14송호진 initPeriod3_ofc -> coaPeriod3 수정 관련 getParameter Argument 수정
...
<%
//	EsmCoa0147Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//		event = (EsmCoa0147Event)request.getAttribute("Event");
