...
=========================================================*/
   ...
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0057 : ESM_COA_0057 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0057() {
    	...
    	function processButtonClick(){
    		...
    		try {
    			...
    			switch(srcName) {
    				...
    				case "btng_bkgdetail":
    					location.href="./UI_ESM_COA_032.html" ;
    					break;
		...
		function doActionIBSheet(sheetObj, formObj, sAction) {
			...
			switch (sAction) {
				case IBCLEAR: //조회
					...
					var sXml = sheetObj.GetSearchXml("ESM_COA_0057GS.do", coaFormQueryString(formObj));
				...
				case IBSEARCH: //조회
					if (validateForm(sheetObj, formObj, sAction)) {
						...
						sheetObj.DoSearch4Post("ESM_COA_0057GS.do", coaFormQueryString(formObj));
						ComOpenWait(false);
						break;
					}
					break;
    		...
    		switch(sAction) {
    			case IBSEARCH:		//조회
    				...
    				if(sheetObjects[0].RowCount>0){//sheet1에 데이터가 있을때
    					...
    					sheetObj.DoSearch4Post("ESM_COA_0057GS.do",coaFormQueryString(formObj)+ cond);
    				} else {
    					sheetObj.DoSearch4Post("ESM_COA_0057GS.do",coaFormQueryString(formObj));
    				}
    				ComOpenWait(false);
