...
* 2008.06.30 박상희 N200806127354 COA_조회권한 관련 요청
...
<%@ page import="com.hanjin.apps.alps.esm.coa.multidimensionrpt.salesrpt.event.EsmCoa0062Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.apps.alps.esm.coa.common.Utils"%>
<%@ page import="com.hanjin.framework.component.util.io.HttpUtil"%>

<%
//	EsmCoa0062Event  event = null;					//PDTO(Data Transfer Object including Parameters)
            ...
            <tr>
                <td class="bg">
                    ...
                    <table class="search_in" border="0">
                        <tr class="h23"><td colspan="10"><script language="javascript">coaPeriod3_ofc();</script></td></tr>
                        <tr class="h23">
