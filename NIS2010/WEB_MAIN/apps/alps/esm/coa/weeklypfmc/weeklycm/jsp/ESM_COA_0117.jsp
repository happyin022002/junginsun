...
<%@ page import="com.hanjin.apps.alps.esm.coa.weeklypfmc.weeklycm.event.EsmCoa0117Event"%>
<%@ page import="com.hanjin.framework.component.util.io.HttpUtil"%> 
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCoa0117Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCoa0117Event)request.getAttribute("Event");
