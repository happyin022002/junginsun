...
<tr><td class="bg">
		...
		<tr><td class="title_h"></td>
			...
			<td class="gray"><img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5"><a href="javascript:ComOpenWindow2('ESM_COA_0119.do', '', 'width=900,height=500,menubar=0,status=0,scrollbars=0,resizable=0')" class="purple">SRC Code Setting</a></td></tr>
		...
		<%
			//CDA, COL에만 권한, admin
			if("SELOP".equals(strTeam_cd)||"SELCSG".equals(strTeam_cd)||"system1".equals(strUsr_id)){
		%>
