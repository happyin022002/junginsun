...
<%@ page import="com.hanjin.apps.alps.esm.coa.weeklypfmc.networkcost.event.EsmCoa0177Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCoa0177Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCoa0177Event)request.getAttribute("Event");
...
<table>
<tr><td>
<table width="<%=costUseTpCdC.equals(costUseTpCd)?400:330%>" class="popup" cellpadding="10" border="0"> 
<tr><td class="top"></td></tr>
<tr>
    <td valign="top">
		<!-- : ( Title ) (S) -->
		<table width="100%" border="0">
		<tr><td class="title"><img src="/hanjin/img/alps/ico_t1.gif" width="20" height="12">Lane Detail</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
