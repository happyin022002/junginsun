  ...
  try {
    ...
    switch(srcName) {
      ...
      case "t2btng_missingstatus":
          ...
          ComOpenWindow2("ESM_COA_0114.do" + strUrl,'', "width=900,height=360,menubar=0,status=0,scrollbars=0,resizable=1");
          break;
  ...
  switch(sheetNo) {
      case 1:      //sheet1 init
        with (sheetObj) {
          ...
          initDataCombo(0, "vop_cd",      " |HJS|OTH",                                   " |HJS|OTH");
...
function f_cobtrade_OnChange(obj,value,text) {
	...
	if ("All"!=value) {
		...
		var sXml = sheetObj.GetSearchXml("ESM_COA_0110GS3.do", coaFormQueryString(formObj));
...
function sheet1_OnSearchEnd(sheetObj,ErrMsg) {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
    		...
    		case IBNEW:      //초기화
                ...
                sheetObj.DoSearch4Post("ESM_COA_0110GS.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8')); 
                break;
            ...
            case IBCREATE:      //생성
                ...
                if (sheetObj.RowCount > 0) {
                    ...
                    if (ComShowConfirm(ComGetMsg('COA10020')) == true) { 
                        ...
                        sheetObj.DoAllSave("ESM_COA_0110GS.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
                        
                        var saveStr = sheetObj.GetSaveString(true);
                        var sXml = sheetObj.GetSearchXml("ESM_COA_0110GS.do", coaFormQueryString(formObj, 'param1|param2|param3|param4|param5|param6|param7|param8|f_chkprevcre|fm_date|to_date')+"&"+saveStr);
    ...
    function doActionIBSheet2(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBNEW:      //초기화
                ...
                sheetObj.DoSearch4Post("ESM_COA_0110GS2.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8')); 
                ComOpenWait(false);
                break;
            ...
            case IBCREATE:      //생성
                ...
                if (sheetObj.RowCount > 0) {
                    ...
                    if (ComShowConfirm(ComGetMsg('COA10020')) == true) { 
                        ...
                        sheetObj.DoAllSave("ESM_COA_0110GS2.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
                        ComOpenWait(false);
    ...
    function getBackEndJobStatus() {
    	...
    	var sXml = sheetObj.GetSearchXml("ESM_COA_0110GS.do", coaFormQueryString(formObj));
