...
/**
 * @extends
 * @class ESM_COA_0039 : ESM_COA_0039 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0039() {
     ...
     */
      function f_seltrade_OnChange(obj,value,text) {
          ...
          if ("All"!=value) {
               ...
               var sXml = sheetObj.GetSearchXml("ESM_COA_0039GS2.do", coaFormQueryString(formObj));
    ...
    function doActionIBSheet(sheetObj, formObj, sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                sheetObj.DoSearch4Post("ESM_COA_0039GS.do", coaFormQueryString(formObj));
                ComOpenWait(false);
                break;
