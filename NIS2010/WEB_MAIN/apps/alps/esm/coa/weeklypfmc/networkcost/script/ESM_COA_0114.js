...
/**
 * @extends 
 * @class ESM_COA_0114 : ESM_COA_0114 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0114() {
...
function doActionIBSheet(sheetObj,formObj,sAction) {
  ...
  switch(sAction) {
	case IBCLEAR:          //조회
		...
		var sXml = sheetObj.GetSearchXml("ESM_COA_0114GS2.do", coaFormQueryString(formObj));
    ...
    case IBSEARCH:      //조회
		...
		sheetObj.DoSearch4Post("ESM_COA_0114GS.do", coaFormQueryString(formObj));
		ComOpenWait(false);
        break;
