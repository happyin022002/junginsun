...
/**
 * @extends 
 * @class ESM_COA_0108 : ESM_COA_0108 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0108() {
...
function f_seltrade_OnChange(obj,value,text) {
 	...
 	if ("All"!=value) {
		...
		var sXml = sheetObj.GetSearchXml("ESM_COA_0108GS.do", coaFormQueryString(formObj));
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	case IBCLEAR:          //조회
  	...
  	case IBSEARCH:      //조회
          ...
          sheetObj.DoSearch4Post("ESM_COA_0108GS.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
          ComOpenWait(false);
          break;
//
...
//          
      ...
      case IBCREATE:      //Apply to P/L
          ...
          ComOpenWait(true);
          formObj.f_cmd.value = MULTI01;
          var sXml = sheetObj.GetSearchXml("ESM_COA_0108GS.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
