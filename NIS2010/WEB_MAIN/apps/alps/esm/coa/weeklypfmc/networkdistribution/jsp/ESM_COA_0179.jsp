...
<%@ page import="com.hanjin.apps.alps.esm.coa.weeklypfmc.networkdistribution.event.EsmCoa0179Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCoa0179Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.WeeklyPFMC.NetworkDistribution");
	...
	try {
		...
		event = (EsmCoa0179Event)request.getAttribute("Event");
            ...
            <table class="search" border="0">
              <tr>
                ...
                <td width="30%" valign="middle" align="right">
                    ...
                    <a href="javascript:window.showModalDialog('ESM_COA_0159.do', 'win_commit', 'dialogWidth:800px;dialogHeight:560px;scroll:no');" class="purple">Commercial Based Unit Cost</a>
                </td>
                 -->
                <td width="20%" valign="middle" align="right">
                    <img class="cursor" src="/hanjin/img/alps/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5">
                    <a href="javascript:window.showModalDialog('ESM_COA_0125.do', 'win_commit', 'dialogWidth:700px;dialogHeight:660px;scroll:no');" class="purple">Commitment BSA/Ratio</a>
                </td>
              </tr>
