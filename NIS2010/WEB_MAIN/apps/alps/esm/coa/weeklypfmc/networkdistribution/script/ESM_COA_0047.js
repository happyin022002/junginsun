...
/**
 * @extends 
 * @class ESM_COA_0047 : ESM_COA_0047 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0047() {
...
//		  ComOpenWait(true);
		  ...
		  sheetObj.DoSearch4Post("ESM_COA_0047GS.do", coaFormQueryString(formObj,'param1|param2|param3|param4|param5|param6|param7|param8'));
//		  ComOpenWait(false);
		  sheetObj.WaitImageVisible = false;
...
function monitoringBatchJob(){
	...
	var sXml = sheetObj.GetSearchXml("ESM_COA_0047GS.do", FormQueryString(formObj));
