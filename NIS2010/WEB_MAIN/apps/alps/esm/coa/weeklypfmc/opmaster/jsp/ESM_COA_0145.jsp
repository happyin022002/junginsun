...
=========================================================
* History
* 2010.06.17 이행지 가로 사이즈 조정 (700->900)
...
<%@ page import="com.hanjin.apps.alps.esm.coa.weeklypfmc.opmaster.event.EsmCoa0145Event"%>
<%
    Exception serverException = null;	//서버에서 발생한 에러
    String strErrMsg = "";              //에러메세지
    Logger log = Logger.getLogger("com.hanjin.alps.esm.coa.ESM_COA_0145");
