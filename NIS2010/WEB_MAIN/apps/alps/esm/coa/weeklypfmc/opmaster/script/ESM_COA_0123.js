...
/**
 * @extends 
 * @class ESM_COA_0123 : ESM_COA_0123 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_COA_0123() {
...
function doActionIBSheet(sheetObj,formObj,sAction,PageNo) {
    ...
    switch(sAction) {
        ...
        case IBSEARCH:      //조회
            ...
            sheetObj.DoSearch4Post("ESM_COA_0123GS.do", coaFormQueryString(formObj));
            ComOpenWait(false);
            break;
