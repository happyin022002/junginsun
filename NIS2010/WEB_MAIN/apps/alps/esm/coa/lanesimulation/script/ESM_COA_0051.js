    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBROWSEARCH:   // sub trade에 대한 정보를 조회한다.
                ...
                sheetObj.DoRowSearch("ESM_COA_0051GS4.do", coaFormQueryString(formObj,'f_dept_cd_1|usr_id|f_ext_flg|f_slan_cd|f_dept_cd|f_usr_id|f_sim_dt|f_usr_id'));
                break;
...
//------------------------------------------------------
            ...
            case IBROWSEARCH:
                ...
                ComSetObjValue(formObj.f_skd_dir_cd,skd_dir_cd);
                sheetObj.DoRowSearch("ESM_COA_0051GS4.do", coaFormQueryString(formObj));
...
//  }
        ...
        /* BSA & Slot Swap Rev. & Cost 이 선택되었을때 */
            ...
            for(i=2; i<=rowNo; i++){
                 ...
                 */
                    ...
                    if(sheetObj.CellValue(i, "vop_cd") == "HJS")  sheetObj.CellValue2(i, "cal_hjs_bfr_bsa_capa")  =  "0";
    ...
    function s1sheet2_OnSearchEnd(sheetObj,ErrMsg){
        ...
        if(sheetObj.RowCount == 0){
            sheetObj.DoSearch("apps/alps/esm/coa/lanesimulation/jsp/ESM_COA_0051GS3.jsp");
            for( i = 0; i<no ; i++){
...
//        zu_openRunning(false);
    ...
    function callContiPair(){
        ...
        if(rtnValue){
          ...
          ComOpenWindowCenter("/hanjin/ESM_COA_0150.do" + param,"PopupEsmCoa0150",700,500,false);
        }
    }
    ...
    function callBSAbyVVD(){
        ...
        if (sheetObj2.LastRow >= 2){
            ComOpenWindowCenter("/hanjin/ESM_COA_0166.do?" + param,"vvd_Poupu",1000,580,false);
        }
    }

    /** Sheet2 Mendatory 항목
     vop_cd 가  HJS 일때 : Register, Vessel Class, Port Class, OPR, OPR2, BSA Capa
    ...
    function chkMendatory(){
        ...
        for(i=2; i<sheetObj2.LastRow; i++){
             ...
             if(sheetObj2.CellValue(i,"vop_cd")=="HJS"){//OPR2 가 HJS 일때 추가체크되는 Mendatory 항목
