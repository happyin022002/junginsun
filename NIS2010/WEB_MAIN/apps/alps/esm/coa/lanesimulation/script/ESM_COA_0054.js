...
document.onclick = processButtonClick;
		...
		switch(sAction) {
			...
			case IBSEARCH:      //조회
    			if(validateForm(sheetObj,formObj,sAction)) {
        			...
        			var rtn = sheetObj.GetSearchXml("ESM_COA_0054GS.do", coaFormQueryString(formObj));
	...
	function chgVessel(){
		...
		formObj.f_cmd.value = SEARCHLIST13;
 		var sXml = sheetObj.GetSearchXml("ESM_COA_0054GS2.do", coaFormQueryString(formObj));
 		var arrXml = sXml.split("|$$|");
