...
//				sheetObj.DoSearch4Post("ESM_COA_0053GS4.do", coaFormQueryString(formObj));
    ...
    function callVslConsum(){
        ...
        if(sheetObj.SelectRow <2){
            ...
            ComOpenWindowCenter("/hanjin/ESM_COA_0151.do"+param,"PopupEsmCoa0151",400,500,false);
        }
    }
...
// Step3 : Tab4 : Hire/TC Rev/Layup(Daily) --------------------------------------------
	...
	function callTCO() {
	    ...
	    ComOpenWindowCenter("/hanjin/ESM_COA_0167.do","PopupEsmCoa01671",400,350,false);
