...
'주  시 스 템 : ENIS
'서브  시스템 :
'프로그램 ID  : apps/enis/esm/coa/lanesimulation/jsp/ESM_COA_167.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0167Event"%>

<%
    EsmCoa0167Event  event = null;     //PDTO(Data Transfer Object including Parameters)
    Exception serverException   = null; //서버에서 발생한 에러
    String strErrMsg    = "";           //에러메세지
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.coa.lanesimulation.EsmCoa0167Event");
