...
'프로그램 ID  : apps/enis/esm/coa/lanesimulation/jsp/ESM_COA_052.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0052Event"%>
<%@ page import="com.hanjin.framework.support.view.signon.SignOnUserAccount"%>
...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.coa.lanesimulation.EsmCoa0052");
