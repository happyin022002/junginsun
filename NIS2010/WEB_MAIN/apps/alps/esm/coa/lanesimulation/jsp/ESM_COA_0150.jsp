...
'프로그램 ID  : apps/enis/esm/coa/lanesimulation/jsp/ESM_COA_150.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0150Event"%>
<%
    EsmCoa0150Event  event = null;     //PDTO(Data Transfer Object including Parameters)
    Exception serverException   = null; //서버에서 발생한 에러
    String strErrMsg    = "";           //에러메세지
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.coa.lanesimulation.EsmCoa0150Event");
		String ibDir = "";
		String ibIOC = "";
		String v_slan_cd = "";
