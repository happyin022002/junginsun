...
<%@ page import="com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0054Event"%>
...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.coa.lanesimulation.EsmCoa0054Event");
