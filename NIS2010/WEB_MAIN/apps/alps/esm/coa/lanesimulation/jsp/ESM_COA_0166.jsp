...
'프로그램 ID  : apps/enis/esm/coa/lanesimulation/jsp/ESM_COA_166.jsp
...
<%@ page import="com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0166Event"%>
...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esm.coa.lanesimulation.EsmCoa0166Event");
