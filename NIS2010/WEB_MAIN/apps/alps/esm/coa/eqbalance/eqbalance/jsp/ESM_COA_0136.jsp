...
<%@ page import="com.hanjin.apps.alps.esm.coa.eqbalance.eqbalance.event.EsmCoa0136Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCoa0136Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCoa0136Event)request.getAttribute("Event");
