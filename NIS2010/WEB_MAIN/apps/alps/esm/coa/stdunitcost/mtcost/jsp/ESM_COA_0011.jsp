...
<%@ page import="com.hanjin.apps.alps.esm.coa.stdunitcost.mtcost.event.EsmCoa0011Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCoa0011Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCoa0011Event)request.getAttribute("Event");
