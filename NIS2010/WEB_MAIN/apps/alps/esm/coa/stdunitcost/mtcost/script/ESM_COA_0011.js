...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0011 : ESM_COA_0011 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0011() {
  ...
  //var calPop = new calendarPopupGrid();
    ...
    function setComboObject(combo_obj){
  	...
  	function doActionIBSheet(sheetObj,formObj,sAction) {
  		...
  		switch(sAction) {
  			case IBCLEAR:          //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_COA_0011GS.do", FormQueryString(formObj));
  			...
  			case IBSEARCH:	//조회
				...
				sheetObj.DoSearch4Post("ESM_COA_0011GS.do", coaFormQueryString(formObj));
  				ComOpenWait(false);
 	...
 	function setPeriod(obj){
		...
		var sXml = sheetObj.GetSearchXml("ESM_COA_0011GS.do", coaFormQueryString(formObj));
		var arrXml = sXml.split("|$$|");
