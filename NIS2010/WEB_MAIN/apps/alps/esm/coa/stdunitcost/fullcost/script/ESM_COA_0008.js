...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0008 : ESM_COA_0008 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0008() {
    	...
    	function doActionIBSheet(sheetObj,formObj,sAction) {
    		...
    		switch(sAction) {
    			case IBCLEAR:          //조회
					...
					var sXml = sheetObj.GetSearchXml("ESM_COA_0008_1GS.do", FormQueryString(formObj));
    			...
    			case IBSEARCH:		//조회
    				if(validateForm(sheetObj,formObj,sAction)) {
    					...
    					sheetObj.DoSearch4Post("ESM_COA_0008GS.do",coaFormQueryString(formObj));
    					ComOpenWait(false);
    				}
    				break;
    	...
    	*/
    	function changeConditionType(v){
    		...
    		if(v == '1'){//Port To/FR Inland
    		    ...
    		    //var cond = '';
    		    //noRtnPopup('ESM_COA_141.do?f_pctl_no=T0706200000000370003' + cond, 'width=850,height=680,menubar=0,status=1,scrollbars=0,resizable=0')
    			div_coa.style.display = "none";
