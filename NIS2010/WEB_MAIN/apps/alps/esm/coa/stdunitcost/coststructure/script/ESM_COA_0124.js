...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0124 : ESM_COA_0124 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0124() {
	...
	function setDataFromParentHeader() {
		...
		currentRow = sheetObj.DataInsert(-1); sheetObj.CellValue2(currentRow, 0) = "Owner ship";sheetObj.CellValue2(currentRow, 1) = "coa_cost_src_prt_cd";
		...
		currentRow = sheetObj.DataInsert(-1); sheetObj.CellValue2(currentRow, 0) = "Source Code";sheetObj.CellValue2(currentRow, 1) = "coa_cost_src_cd";
		currentRow = sheetObj.DataInsert(-1); sheetObj.CellValue2(currentRow, 0) = "Source Code_Description";sheetObj.CellValue2(currentRow, 1) = "coa_cost_src_cd_nm";
