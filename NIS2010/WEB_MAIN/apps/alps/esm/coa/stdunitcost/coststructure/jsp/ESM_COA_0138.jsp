...
<%@ page import="com.hanjin.apps.alps.esm.coa.stdunitcost.coststructure.event.EsmCoa0138Event"%>
<%@ page import="com.hanjin.apps.alps.esm.coa.common.Utils"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
//	EsmCoa0138Event  event = null;					//PDTO(Data Transfer Object including Parameters)
