...
* 2014.11.03 박은주 [CHM-201432633] <Node/Link U/C Adjustment> 화면의 최대 조회 건수 변경
              ...
              <!-- TABLE '#D' : ( Button : Main ) (S) -->
				<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5;">
					...
					<%
						...
						if("SELOPA".equals(strOfc_cd)||"SELOPB".equals(strOfc_cd)||"SELCTY".equals(strOfc_cd)||"SELCSG".equals(strOfc_cd)) {
					%>
							<!--
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
              ...
              <tr class="h23">
                <td class="gray_tit" >
                  <img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">
                       Maximum to retrieve is 15,000 rows and Maximum to save is 200 rows.<br>
                  <img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">
                       In “Link Cost” screen, “VNDR_SEQ" (S/P No) and “COST_ACT_GRP_CD” (Act. Group) conditions are only applicable for TRS volume incentive, of which cost codes start with "TRFX".</br>
                       &nbsp;&nbsp;&nbsp;In addition, “COST_ACT_GRP_CD” (Act. Group) is valid only when “VNDR_SEQ" (S/P No) is input as a prerequisite other than the default “000000”.
