...
<%@ page import="com.hanjin.apps.alps.esm.coa.stdunitcost.coststructure.vo.CostStructureSoCodeRtnVO"%>
...
<!-- main 영역 시작 -->
		...
		<tr><td class="history"><img src="img/icon_history_dot.gif" align="absmiddle"> Sales Management > CNTR BIZ PFMC Analysis > Cost Table > Set-Up C/A Code > Register Cost Item</td></tr>
