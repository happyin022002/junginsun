...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0022 : ESM_COA_0022 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_COA_0022() {
  		...
  		switch(sheetNo) {
  			case 1:		//sheet1 init
  				with (sheetObj) {
					...
					var HeadTitle1 = "|Sel|Apply to\nAdjusted P&L|cost_yrmon|WK|sls_fm_dt|MT Invoicing AMT (COA)|MT Invoicing AMT (COA)|MT Invoicing AMT (COA)" +
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //결과조회
                ...
                sheetObj.DoSearch("ESM_COA_0022GS.do", coaFormQueryString(formObj));
            ...
            case IBCREATE:      //생성
				...
				ComOpenWait(true);
 				var sXml = sheetObj.GetSaveXml("ESM_COA_0022GS.do", sParam)
            ...
            case IBSAVE:	//저장
				...
				sheetObj.DoSave("ESM_COA_0022GS.do", coaFormQueryString(formObj),-1,false);
				ComOpenWait(false);
		...
		case IBSEARCH: // 조회
  		...
  		case IBCREATE:
   			...
   			if(sheetObj.CheckedRows("sel_flg") < 1) {
				ComShowCodeMessage("COA10015", "Sel");
   				return false;
   			}
			break; 	
  		...
  		case IBSAVE:
			...
			for (var i = sheetObj.HeaderRows; sheetObj.RowCount > 0 && i <= sheetObj.LastRow; i++) {				
				if(sheetObj.CellValue(i, "sel_flg") == "1" && sheetObj.CellValue(i, "mty_inv_amt") == 0) {
					ComShowCodeMessage("COA10015", "MT Invoicing AMT(TES/TRS)");
	   				return false;
				} 
			}
...
//	
    ...
    function doActionValidationResult(sheetObj, sKey) {
    	var sXml = sheetObj.GetSearchXml("ESM_COA_0022GS.do?f_cmd=" + COMMAND02 + "&key=" + sKey);
