...
<%@ page import="com.hanjin.apps.alps.esm.sam.custmanage.custmain.event.EsmSam0304Event"%>
<%@ page import="com.hanjin.framework.core.layer.event.GeneralEventResponse"%>
<%

    EsmSam0304Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmSam0304Event)request.getAttribute("Event");
