...
<%@ page import="com.hanjin.apps.alps.esm.sam.custmanage.custmain.event.EsmSam0305Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSam0305Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmSam0305Event)request.getAttribute("Event");
		...
		<table class="search">
			<tr>
				...
				<tr class="h23">
					...
					<td ><input type="text" name="zip_cd" maxlength="10" dataformat="uppernum" style="width:60" style=""></td>
					<td width="140">Group Customer Code</td>
					<td width="120"><input type="text" name="cust_grp_id" dataformat="uppernum" maxlength="10" style="width:100;ime-mode:disabled">&nbsp;</td>
					
					<td width="50">S.Rep</td>
					<td ><input type="text" name="srep_cd" maxlength="5" dataformat="uppernum" style="width:60" style=""></td>
				...
				<tr class="h23">
					...
					<td><input type="text" name="cust_nm" dataformat="uppernum" maxlength="60" size="60" style="width:200;ime-mode:disabled">
						&nbsp;Include  <input type="checkbox" name="include" checked="checked" Style="border-style:none"></td>
						<td width="100">     Location Code</td>
						    <td width="150"><input name="loc_cd" type="text" style="width:60;ime-mode:disabled" dataformat="engup" maxlength="5">
						...
						<td width="40">State</td>
							<td width="80"><input name="ste_cd" type="text" style="width:50;ime-mode:disabled" dataformat="uppernum" maxlength="3"></td>
