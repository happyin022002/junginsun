        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle = "Rqst No.|G/I|Name|Request DT|REP. Office|Sales Rep|Location code|Customer Code|Status|Date|Approval Date";
...
//                     sheetObj.UseZipFile = true;
                     var sXml = sheetObj.GetSearchXml("ESM_SAM_0310GS.do", selectVal);
...
//                     sheetObj.DoSearch("COM_ENS_041GS.do?UseZipFile=true", selectVal);
           ...
           case IBSEARCHAPPEND:  // 페이징 조회
                ...
                formObj.f_cmd.value = SEARCH;         
                sheetObj.DoSearch4Post("ESM_SAM_0310GS.do", selectVal, "iPage=" + PageNo, true);  
           break;
