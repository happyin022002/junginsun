...
<%@ page import="com.hanjin.apps.alps.esm.sam.custmanage.custrequest.event.EsmSam0310Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
    EsmSam0310Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
		...
		event = (EsmSam0310Event)request.getAttribute("Event");
				...
				<table class="search" border="0" style="width:800;">
					<tr class="h23">
					    <td width="120">Create Date</td>
									<td width="290" >
								    	<input type="text" style="width:80" value="" class="input"  name="cre_fm_dt"  maxlength='10' dataformat="ymd" >
												 &nbsp;~&nbsp;
												  <input type="text" style="width:80" value="" class="input"  name="cre_to_dt"  maxlength='10' dataformat="ymd" >
												  <img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="cre_date">
									</td>				
