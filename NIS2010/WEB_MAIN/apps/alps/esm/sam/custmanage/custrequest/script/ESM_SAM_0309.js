		...
		try {
			...
			case "btn_com_ens_0M1": // country pop-up
 			...
 			case "btn_esm_sam_0301": //group customer pop-up
	    		...
	    		if(!form.btn_esm_sam_0301.disabled)
		 ...
		 function doActionIBSheet(sheetObj, formObj, sAction) {
		     ...
		     switch(sAction) {
		 		...
		 		case SEARCH: //retrieve
	    		    ...
	    		    var sXml = sheetObj.GetSearchXml("ESM_SAM_0309GS.do", FormQueryString(formObj));				
					var arrXml = sXml.split("|$$|"); 
				...
				case MULTI:        //저장
					...
					if( formObj.creflag.value == "Y" && formObj.rqst_no.value == "" && formObj.grp_indiv_div.value == "I") {
						...
						ComOpenPopup('/hanjin/ESM_SAM_0304.do?' + param, 780, 470, "getESM_SAM_0309_saveflag", '0,0', true);
					} else {
				...
				case MULTI01:        //저장
					...
					var SaveXml = sheetObj.GetSaveXml("ESM_SAM_0309GS.do", sParam);
		    	...
		    	case SEARCH13:      //User MDM Auth check
					if(validateForm(sheetObj,formObj,sAction)){
				        ...
				        if(result=="N"){
				        	...
				        	ComSetDisplay("btn_Request1", false);
...
//	    			document.form.loc_cd.focus();
       ...
       */
	     ...
	     * Call Back Function  
	     */
	   function getESM_SAM_0309_saveflag(saveFlag) {
			var formObj   = document.form;
 		    var confMsg;
			var saveMsg;
...
//	            				document.form.mlt_trd_acct_flg.focus();
	    ...
	    function requestdisable(){
	    	...
	    	if (formObj.rqst_sts.value == "Requested" || formObj.rqst_sts.value == "Approved" || formObj.rqst_sts.value == "Rejected"){
	    		...
	    		formObj.btn_esm_sam_0301.disabled = true;  
	    		...
	    		formObj.btn_esm_sam_0301.disabled = false;  
