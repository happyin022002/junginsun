	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
				case SEARCH01: // 조회
					...
					var sXml = sheetObj.GetSearchXml("ESM_SAM_0307GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam("sheet2_"));
				...
				case IBSAVE:        //저장
					if(validateForm(sheetObj,formObj,sAction)) {
		 				...
		 				var SaveXml = sheetObj.GetSaveXml("ESM_SAM_0308GS.do", FormQueryString(formObj));
