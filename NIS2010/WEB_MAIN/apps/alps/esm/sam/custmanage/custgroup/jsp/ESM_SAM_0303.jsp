...
<%@ page import="com.hanjin.apps.alps.esm.sam.custmanage.custgroup.event.EsmSam0303Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
    EsmSam0303Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
		...
		event = (EsmSam0303Event)request.getAttribute("Event");
