		 ...
		 function doActionIBSheet(sheetObj, formObj, sAction) {
		     ...
		     switch(sAction) {
		 		...
		 		case SEARCH: //retrieve
	    		    ...
	    		    var sXml = sheetObj.GetSearchXml("ESM_SAM_0306GS.do", FormQueryString(formObj));				
					var arrXml = sXml.split("|$$|"); 
...
//	    			document.form.cust_cd.focus();
       ...
       */
	    function setSave(confMsg, saveMsg) {
			...
			var SaveXml = sheetObj.GetSaveXml("ESM_SAM_0306GS.do", sParam);
	     ...
	     * Call Back Function  
	     */
	   function getESM_SAM_0306_saveflag(saveFlag) {
			var formObj   = document.form;
 		    var confMsg;
			var saveMsg;
