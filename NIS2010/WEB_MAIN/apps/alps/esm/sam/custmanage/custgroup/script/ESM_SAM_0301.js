        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitColumnInfo(6, 5, 0, true);

                    // 해더에서 처리할 수 있는 각종 기능을 설정한다
                    InitHeadMode(true, true, true, true, false,false)
                    
                    
                    var HeadTitle = "||Code|Name|Control Office|Status";
...
//                     sheetObj.UseZipFile = true;
                     var sXml = sheetObj.GetSearchXml("ESM_SAM_0301GS.do", selectVal);
...
//                     sheetObj.DoSearch("COM_ENS_041GS.do?UseZipFile=true", selectVal);
           ...
           case IBSEARCHAPPEND:  // 페이징 조회
                ...
                formObj.f_cmd.value = SEARCH;         
                sheetObj.DoSearch4Post("ESM_SAM_0301GS.do", selectVal, "iPage=" + PageNo, true);  
           break;
