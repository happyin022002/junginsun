...
<%@ page import="com.hanjin.apps.alps.esm.sam.custmanage.custgroup.event.EsmSam0301Event"%>
<%@ page import="com.hanjin.framework.core.layer.event.GeneralEventResponse"%>
<%
    EsmSam0301Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
       ...
       //userAuth=account.getAuth(); 
        ...
        event = (EsmSam0301Event)request.getAttribute("Event");
