	...
	switch(sheetNo) {
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				var HeadTitle1 = "Include|CSR No.|Description|G/L date|Office|Slip Loc.";
				...
				InitDataProperty(0, cnt++ , dtCheckBox, 	60,		daCenter,   true,    	"check",  	false,		"",			dfNone,		0,			true,		false);
				InitDataProperty(0, cnt++ , dtData,			140,	daCenter,   true,    	"csr_no",   false,		"",			dfNone,		0,			false,		false);
				InitDataProperty(0, cnt++ , dtData,			340,	daLeft,    true,    	"des",      false,		"",			dfNone,		0,			false,		false);
				InitDataProperty(0, cnt++ , dtData,			80,	daCenter,   true,    	"gl_dt", 	false,		"",			dfDateYmd,		0,			false,		false);
				InitDataProperty(0, cnt++ , dtData,			60,	daCenter,   true,    	"off_cd",	false,		"",			dfNone,		0,			false,		false);
				InitDataProperty(0, cnt++ , dtData,			60,	daCenter,   true,    	"slip_loc",	false,		"",			dfNone,		0,			false,		false);
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	switch(sAction) {
	    case IBSEARCH:		//Retrieve
			...
			sheetObj.DoSearch4Post("ESM_AGT_0056GS.do", agtQryStr(formObj));
