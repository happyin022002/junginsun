...
*@FileName : ESM_AGT_0056.jsp
*@FileTitle : 02 CSR Selection
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtclosing.agtclosing.event.EsmAgt0056Event"%>
<%@ page import="com.hanjin.bizcommon.util.BizComUtil"%>
<%@ page import="org.apache.log4j.Logger"%>
<%
	EsmAgt0056Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmAgt0056Event) request.getAttribute("Event");
		...
		if (serverException != null) {
			...
			//ESM_AGT_0056 화면에서 넘어온 파라미터를 받는다.
	...
	<tr>
		<td><!-- : ( Title ) (S) -->
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; 02 CSR Selection</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
								...
								<td>
									<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr>
											...
											<td class="btn1" name="btn_ok" id="btn_ok">OK</td><td class="btn1_right"></td>
										</tr>
									</table>
								</td>
								<td>
