...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtclosing.agtclosing.event.EsmAgt0032Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmAgt0032Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmAgt0032Event)request.getAttribute("Event");
...
<html>
<head>
<title>Estimation Closing Report</title>
                        ...
                        <tr>
                                <td class="bg">
                                        <table class="search_in" border="0">
                                                <tr class="h23">
                                                        <td width="17%">Subject Closing Month</td>
                                                        <td width="10%" class="sm"><input type="hidden" name="exe_yrmon"><input type="text" class="input1" name="date1" style="width:60;" maxlength="7">&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar1"></td>
