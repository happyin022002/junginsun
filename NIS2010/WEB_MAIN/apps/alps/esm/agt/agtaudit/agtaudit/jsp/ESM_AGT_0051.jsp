...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtaudit.agtaudit.event.EsmAgt0051Event"%>
<%
		...
		<table class="search">
			<tr>
				...
				<table class="search" border="0" style="width: 737;">
					...
					<tr class="h23">
						<td colspan="1">B/L</td>
						<td colspan="7" >&nbsp;<input type="text" name="s_bl_no" class='input1' style="width: 100; ime-mode: disabled;" onKeyUp="ComKeyOnlyAlphabet('upper');" maxlength="12"> % <!-- setBlNo(this); --> <img src="/hanjin/img/button/btng_plus.gif" alt="Like and List Search" width="19" height="20" border="0" align="absmiddle"> &nbsp;<input type="text" name="bl_nos" style="width: 280; ime-mode: disabled;" onKeyUp="ComKeyOnlyAlphabet('upper');"></td>
					</tr>
				</table>
				</td>
			</tr>
		...
		<table class="search">
			<tr>
				...
				<table width="100%" class="search">
					<tr>
						<td class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">Booking</td>
					</tr>
				</table>
				...
				<table width="100%" class="search">
					<tr>
						<td class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">Agent Commission</td>
					</tr>
				</table>
