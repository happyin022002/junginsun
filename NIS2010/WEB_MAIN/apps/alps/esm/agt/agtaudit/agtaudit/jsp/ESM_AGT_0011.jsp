...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtaudit.agtaudit.event.EsmAgt0011Event"%>
...
//			} // end if
			...
			//ESM_AGT_0010 화면에서 넘어온 파라미터를 받는다.
...
<input type="hidden" name="bl_no"  			value="<%=blNo%>">	<!-- ESM_AGT_0010 화면에서 넘어온 파라미터 : B/L No -->
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; Detail &amp; History for B/L</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!-- Search BG (S) -->
						...
						<table class="search" border="0">
							<tr class="h23">
								<td width="363" valign="top">
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Calculation History</td>
										</tr>
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Commission Detail Amount</td>
										</tr>
										<tr><td height="5"></td></tr>
									</table>
									<table width="100%" id="mainTable">
								...
								<td valign="top">
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Basic Information</td>
										</tr>
										<tr><td height="5"></td></tr>
									</table>
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;TP/SZ QTY</td>
										</tr>
										<tr><td height="5"></td></tr>
									</table>
									<table width="100%" id="mainTable">
