...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtaudit.facaudit.event.EsmAgt0015Event"%>
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; FAC Details & History for B/L</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!--Button_L (S) -->
