...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtaudit.facaudit.event.EsmAgt0033Event"%>
...
//Combo Data : getCodeCombo('태그명','초기값', '추가요소', '업무명', '조건코드', '전체유무', '추가옵션')facArOfcCd
                                        ...
                                        <tr class="h23">
                                                ...
                                                <td width="45%">
                                                        ...
                                                        <tr><td class="stm" width="173" style="padding-left:10;">
                                                        	...
                                                        	<input type="text" name="search_dt_to" style="width:75"  dataformat="ymd" OnBeforeDeactivate="ComAddSeparator(this)" OnBeforeActivate="ComClearSeparator(this)" maxlength="10">&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar2"></td></tr>
                                                        </table>
                                                </td>
                                                <td align="right">Cur &nbsp;
