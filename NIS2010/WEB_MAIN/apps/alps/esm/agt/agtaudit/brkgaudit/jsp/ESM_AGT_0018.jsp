								...
								<td class="align">
									<table class="button">
										<tr>
											...
											<td><img class="cursor" src="/hanjin/img/button/btn_approvalrequest.gif" width="130" height="20" border="0" name="btn_request"></td>
											...
											<td><img class="cursor" src="/hanjin/img/button/btn_csrprint.gif" width="78" height="20" border="0" name="btn_csrprint"></td>
										</tr>
									</table>
								</td>
							</tr>
