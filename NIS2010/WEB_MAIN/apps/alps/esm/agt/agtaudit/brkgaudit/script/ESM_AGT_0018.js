	...
	switch(sheetNo) {
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				var HeadTitle = "CHK|STS|Freight Forwarder|Freight Forwarder|Freight Forwarder|CNT|AMT|vndrSeq|AP OFC|CSR NO|I/F Date|I/F Remark|RCV Remark|IF Flag|RCV Flag|Pay AMT|Pay Date|Check No|Method";
