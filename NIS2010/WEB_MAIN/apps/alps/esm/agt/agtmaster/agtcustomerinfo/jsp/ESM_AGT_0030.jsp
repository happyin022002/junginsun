...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtmaster.agtcustomerinfo.event.EsmAgt0030Event"%>
						...
						<table class="search_in" border="0">
							<tr class="h23">
								...
								<td>
									...
									<a href="javascript:openWindowOffice(document.form);" class="purple"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></a>
								</td>
							</tr>
						</table>
					</td>
