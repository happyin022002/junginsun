...
*@FileTitle : Customer Name 조회 (iFrame 및 IBSheet에서 사용)
*Open Issues : 
*Change history :
...
<%
	...
	if("".equals(sheetId)) { // IBSheet 에서 DoRowSearch로 조회한 경우
%>
		<?xml version="1.0"  ?>
		<SHEET>
		  <DATA>
...
<%
	} else {				// IBSheet 에서 iFrame을 이용해서 조회한 경우
%>
