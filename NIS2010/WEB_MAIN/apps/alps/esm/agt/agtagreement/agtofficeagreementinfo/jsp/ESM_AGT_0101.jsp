...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.event.EsmAgt0101Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmAgt0101Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//	ESM_AGT_0045 화면에서 넘어온 파라미터	
	...
	try {
		...
		event = (EsmAgt0101Event)request.getAttribute("Event");
...
<html>
<head>
<title>Rep.Container Type List</title>
...
<!-- OUTER - POPUP (S)tart -->
<table width="350" class="popup" cellpadding="10" border="0">
	<tr>
		<td class="top"></td>
	</tr>
	<tr>
		...
		<table width="300" border="0">
			<tr>
				<td class="title"><img src="/hanjin/img/ico_t1.gif" width="20" height="12">Rep.Container Type List</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!--Button_L (S) -->
		<% if(!pageType.equals("Inquiry")){%>
		<table width="300" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5;">
	       	<tr>
	       		<td class="btn1_bg">
