...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.event.ESM_AGT_037Event"%>
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.event.ESM_AGT_037EventResponse"%>
...
<%
	if (serverException == null) {
		...
		if( formcommand.isCommand(FormCommand.SEARCH08)){	//저장XML인 경우
%>
<RESULT>
  <TR-ALL>OK</TR-ALL>
</RESULT>
