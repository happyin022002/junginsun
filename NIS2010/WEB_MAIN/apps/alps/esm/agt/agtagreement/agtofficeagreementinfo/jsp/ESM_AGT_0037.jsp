...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.event.EsmAgt0037Event"%>
...
<%
	...
	int rowCount	 = 0;							//DB ResultSet 리스트의 건수0";
...
<input type="hidden" name="vndr_cnt_cd" value="<%= vndr_cnt_cd %>">			<!-- ESM_AGT_0003 화면에서 넘어온 파라미터 -->
	...
	<tr>
		<td valign="top">
			...
			<table width="280" border="0">
				<tr>
					<td class="title"><img src="/hanjin/img/ico_t1.gif" width="20" height="12">Other Information Info.</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
