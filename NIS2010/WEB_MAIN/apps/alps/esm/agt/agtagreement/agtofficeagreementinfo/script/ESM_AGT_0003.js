                ...
                case "cnt_btn":
                	...
                	{                	        
            		    ...
            		    if(chkStr == "1,0") {
            		        ...
            		        ComOpenPopup('/hanjin/ESM_AGT_0001.do' + param, 780, 560, 'getESM_AGT_001_1', v_display, true);
			...
			case 2:      //sheet1 init
				with (sheetObj) {
				   ...
				   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtCombo,     150,    daCenter,   true,    "ofc_chr_lvl",     true,          "",       dfNone,          0,     true,       true);
...
//	Definition & Compensation Sheet 저장  성공 유무
