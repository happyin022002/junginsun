...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.event.EsmAgt0004Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmAgt0004Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
//	ESM_AGT_0045 화면에서 넘어온 파라미터	
	...
	try {
		...
		event = (EsmAgt0004Event)request.getAttribute("Event");
...
<html>
<head>
<title>CNTR Type Size List</title>
...
<table width="600" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="580" border="0">
			<tr>
				<td class="title"><img src="/hanjin/img/ico_t1.gif" width="20" height="12">CNTR Type Size List</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!--Button_L (S) -->
