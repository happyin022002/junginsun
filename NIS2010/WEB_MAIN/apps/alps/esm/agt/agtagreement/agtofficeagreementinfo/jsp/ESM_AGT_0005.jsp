...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.event.EsmAgt0005Event"%>
...
<html>
<head>
<title>공제 대상 Charge 조회 및 다중 선택(Pop-up)</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="/hanjin/img/ico_t1.gif" width="20" height="12">Charge Deduction List</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!--Button_L (S) -->
