...
<%@ page import="com.hanjin.apps.alps.esm.agt.agtagreement.agtcustomeragreementinfo.event.EsmAgt0007Event"%>
                                ...
                                <table class="search_in" border="0">
                                        <tr class="h23">
                                                ...
                                                <td>&nbsp;<input type="text" name="search_brog_cnt_cust_seq" style="width:100;ime-mode:disabled;" onKeyPress="ComKeyOnlyAlphabet('uppernum')" maxlength="8"><input type="hidden" name="search_brog_cnt_cust_seqName">
                                                        <a href="javascript:openWindowCustomer(document.form);" class="purple"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></a></td></tr>
                                </table>
                        </td></tr>
                </table>
