...
/**
 * @extends 
 * @class ESM_SQM_0041 : ESM_SQM_0041 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_SQM_0041() {
	...
	switch(sheetNo) {
		case 1:		//sheet1 init
			with (sheetObj) {
				...
				var HeadTitle1 =  "SEQ|Year|Quarter|N.OB/\nOB|Office\nView|Trade|Sub\nTrade|R.Lane|Trade\nBound|Trade\nDirection|Week|VVD|Supply|RHQ|Office|Load QTA|G.REV QTA";
				...
				InitDataProperty(0,	cnt++,	dtData,		55,	daRight,	true,	"fnl_bsa_capa",	false,	"",	dfInteger,	0,	false,	false);
				...
				InitDataProperty(0,	cnt++,	dtAutoSum,	70, daRight,	true,	"ofc_qty",	    false,	"",	dfInteger,	0,	false,	false);
				InitDataProperty(0,	cnt++,	dtAutoSum,	70, daRight,	true,	"ofc_rev",	    false,	"",	dfInteger,	0,	false,	false);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		case IBSEARCH:          //조회
			...
			sheetObj.DoSearch("ESM_SQM_0020GS2.do",sParam);
