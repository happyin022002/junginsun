...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0040Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0040Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0040Event)request.getAttribute("Event");
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="90"><script language="javascript">ComComboObject('f_rgn_ofc_cd', 1, 75, 0 )</script></td>
											<td width="70">N.OB/OB</td>
							...
							<tr><td class="btn2_bg">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_Pop0041">Office Distribute Result</td><td class="btn2_right"></td></tr></table></td>
										
										<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_Pop0042">Office QTA Summary</td><td class="btn2_right"></td></tr></table></td>
										<!-- Repeat Pattern -->
									</tr>
								</table>
							</td></tr>
