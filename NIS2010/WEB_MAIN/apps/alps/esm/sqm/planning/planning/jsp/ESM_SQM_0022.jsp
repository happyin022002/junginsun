...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0022Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0022Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0022Event)request.getAttribute("Event");
...
<input type="hidden" name="f_qta_step_cd" value="04">
							...
							<tr><td class="btn2_bg">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_Pop0023">Office Distribute Result</td><td class="btn2_right"></td></tr></table></td>
										
										<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_Pop0024">Office QTA Summary</td><td class="btn2_right"></td></tr></table></td>
										<!-- Repeat Pattern -->
									</tr>
								</table>
							</td></tr>
