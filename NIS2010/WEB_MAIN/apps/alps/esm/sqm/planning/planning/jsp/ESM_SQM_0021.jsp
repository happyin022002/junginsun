...
<html>
<head>
<title>QTA Set-up by RHQ (O/B Loading)_Office QTA Summary</title>
	...
	<tr>
		<td>
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;QTA Set-up by RHQ (O/B Loading)_Office QTA Summary</td>
