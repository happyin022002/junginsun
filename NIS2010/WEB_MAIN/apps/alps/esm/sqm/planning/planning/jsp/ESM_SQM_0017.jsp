...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0017Event"%>
...
<%
	...
	EsmSqm0017Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0017Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Set up by Head Office_RHQ Distribute Result</title>
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="65"><input type="text" style="text-align:center;width:55;" class="input2" name="f_bse_qtr_cd" value="<%=p_bse_qtr_cd%>" readOnly></td>
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="65"><input type="text" style="text-align:center;width:55;" name="f_rlane_cd" class="input2" readOnly value="<%=p_rlane_cd%>"></td>
											<td width="90"><div id="div_dir">Trade Bound</div></td>
											<td width="70"><div id="dir_cd"><input type="text" style="text-align:center;width:55; ime-mode:disabled" name="f_dir_cd" class="input2" maxlength="20" readOnly value="<%=p_dir_cd%>"></div>
											<div id="trd_dir" style="display:none;"><input type="text" style="text-align:center;width:55; ime-mode:disabled" name="f_trd_dir" class="input2" maxlength="20" readOnly value="<%=p_trd_dir%>"></div></td>
											...
											<td width="75"><input type="text" style="text-align:center;width:65;" name="f_ob_div_cd" class="input2" readOnly value="<%=p_ob_div_cd%>"></td>
											<td width="40">RHQ</td>
