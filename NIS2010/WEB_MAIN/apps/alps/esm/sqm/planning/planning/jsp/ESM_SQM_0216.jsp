...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0216Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0216Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0216Event)request.getAttribute("Event");
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="80"><script language="javascript">ComComboObject('f_ofc_vw_cd', 1, 75, 1, 1)</script></td>
											<td width="40">RHQ</td>
										...
										<tr class="h23">
											...
											<td width="80">
												<div id="div_dir_cd"><script language="javascript">ComComboObject('f_dir_cd', 1, 75, 1)</script></div>
												<div id="div_trd_dir" style="display:none;"><script language="javascript">ComComboObject('f_hul_bnd_cd', 1, 75, 1)</script></div>
											</td>
											<td colspan="4"><input type="checkbox" name="f_trd_dir" class="trans">&nbsp;Trade Dir.</td>
										</tr>
									</table>
								</td>
							</tr>
