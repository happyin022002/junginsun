...
<html>
<head>
<title>QTA Set up by RHQ_Contract TTL_Office Distribute Result</title>
	...
	<tr>
		<td>
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;QTA Set-up by RHQ (Contract TTL)_Office Distribute Result</td>
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="70"><div id="dir_cd"><input type="text" style="width:55; ime-mode:disabled" name="f_dir_cd" class="input2" maxlength="20" readOnly value="<%=dirCd%>"></div>
											...
											<td width="75"><input type="text" style="width:65; ime-mode:disabled" name="f_rgn_ofc_cd" class="input2" maxlength="20" readOnly value="<%=ofcCd%>"></td>
