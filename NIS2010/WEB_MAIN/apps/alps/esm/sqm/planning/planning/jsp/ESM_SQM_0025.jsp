...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0025Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0025Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0025Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Set-up by RHQ (O/B Contract)</title>
...
<input type="hidden" name="f_qta_step_cd" value="05">
						...
						<table width="100%" class="button">
							<tr><td class="btn2_bg">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<!-- Repeat Pattern -->								
										<td id="td_LoadViewFigureCopy" ><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_LoadViewFigureCopy">Loading View Figure Copy</td><td class="btn2_right" ></td></tr></table></td>
																				
										<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_Pop0026">Office Distribute Result</td><td class="btn2_right"></td></tr></table></td>
										
										<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr><td class="btn2_left"></td><td class="btn2" name="btn_Pop0027">Office QTA Summary</td><td class="btn2_right"></td></tr></table></td>
										<!-- Repeat Pattern -->
									</tr>
								</table>
							</td></tr>
