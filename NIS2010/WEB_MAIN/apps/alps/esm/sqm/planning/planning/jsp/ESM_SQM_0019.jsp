...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0019Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0019Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0019Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Set-up by RHQ (O/B Loading)</title>
...
<input type="hidden" name="f_qta_step_cd" value="03">
									...
									<tr>
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
												<tr>
													...
													<td class="btn2" name="btn_Pop0020">Office Distribute Result</td>
										...
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
												<tr>
													<td class="btn2_left"></td>
													<td class="btn2" name="btn_Pop0021">Office QTA Summary</td>
													<td class="btn2_right"></td>
												</tr>
											</table>
										</td>
