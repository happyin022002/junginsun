...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0015Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0015Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0015Event)request.getAttribute("Event");
							...
							<tr>
								<td width="100" rowspan="2">
									<table class="search_sm2" width="90">
										<tr><td><input type="radio" class="trans" name="f_bse_tp_cd" value="Y"><label style="padding-left:2;">Yearly</label></td></tr>
										<tr><td><input type="radio" class="trans" name="f_bse_tp_cd" value="Q" checked><label style="padding-left:2;">Quarterly</label></td></tr>
									</table>
								</td>
								<td>
									<table class="search" border="0">
										<tr class="h23">
											<td width="50">Year</td>
											<td width="95"><script language="javascript">ComComboObject('f_bse_yr', 1, 70, 0, 1)</script></td>
							...
							<tr>
								<td>
									<table class="search" border="0">
										<tr class="h23">
											<td width="50">RHQ</td>
											<td width="95"><script language="javascript">ComComboObject('f_rhq_cd', 1, 70, 0 )</script></td>
