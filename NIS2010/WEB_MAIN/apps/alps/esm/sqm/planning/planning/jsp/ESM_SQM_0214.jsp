...
*@FileName       : ESM_SQM_0214.jsp
*@FileTitle      : QTA Set up by Head Office for IAS Sector_Add Creation
*Open Issues     :
*Change history  :
...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planning.event.EsmSqm0214Event"%>
...
<%
	...
	EsmSqm0214Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0214Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Set up by Head Office for IAS Sector_Add Creation</title>
...
<input type="hidden" name="f_fm_wk" value="<%= p_fm_wk%>">
<input type="hidden" name="f_to_wk" value="<%= p_to_wk%>">
	...
	<tr>
		<td valign="top">
			...
			<table width="850" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;&nbsp;QTA Set up by Head Office for IAS Sector_Add Creation</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
