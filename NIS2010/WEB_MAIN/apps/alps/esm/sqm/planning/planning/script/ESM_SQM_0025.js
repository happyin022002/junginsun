...
/**
 * @extends 
 * @class ESM_SQM_0025 : ESM_SQM_0025 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_SQM_0025() {
...
var buttonAction = ""; //Loading View Figure Copy 버튼 활성화 처리
...
function processButtonClick(){
	...
	try {
		...
		case "btn_Loadexcel":
			...
			break;
		case "btn_LoadViewFigureCopy":
			doActionIBSheet(sheetObject, formObj, "LoadViewFigureCopy");
			break;
		...
		case "btn_Pop0026":
        	...
        	ComOpenPopup("/hanjin/ESM_SQM_0026.do?"+searchParams+ "&div_period=" + document.getElementById("div_period").innerHTML, 910, 530, "", "0,0", true);
			break;
		case "btn_Pop0027":
			if (sheetObject.isDataModified == true) {
        	...
        	ComOpenPopup("/hanjin/ESM_SQM_0027.do?"+searchParams+ "&div_period=" + document.getElementById("div_period").innerHTML, 910, 530, "", "0,0", true);
			break;
		}
	} catch(e) {
		if( e == "[object Error]") {
...
var initSheetFn = function initSheet(sheetObj,sheetNo) {
	...
	case 1:		//sheet1 init
		with (sheetObj) {
			...
			var HeadTitle1 =  "STS|SEQ|Year|Quarter|N.OB\n/OB|Office\nView|Trade|Sub\nTrade|Lane|Lane\nBound|Trade\nBound|Trade\nDirection|RHQ|Office|Load (TEU) Portion Setting|Load (TEU) Portion Setting|G.REV Portion Setting|G.REV Portion Setting||Modi Flg";
			var HeadTitle2 =  "STS|SEQ|Year|Quarter|N.OB\n/OB|Office\nView|Trade|Sub\nTrade|Lane|Lane\nBound|Trade\nBound|Trade\nDirection|RHQ|Office|PFMC %|Target %|PFMC %|Target %||Modi Flg";
			...
			InitDataProperty(0,	cnt++,	dtData,		83,   daRight,	 true,	"",				    false,	"",	dfNone,		0,	false,	false);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH:          // 화면 조회 시
		...
		ComOpenWait(true);
		var rtnXml = sheetObj.GetSearchXml("ESM_SQM_0025GS.do",searchParams);	
		ComOpenWait(false);
	...
	case "LoadViewFigureCopy":          // 화면 조회 시
		if(ComGetObjValue(formObj.f_trd_cd) == ""){
			ComShowCodeMessage("SQM00013",'Trade');
	        return false;
		}
		...
		buttonAction = "LoadViewFigureCopy";
	...
	case IBSAVE:          // 화면 저장시
		...
		sheetObj.DoSave("ESM_SQM_0025GS.do", searchParams, -1, false);
	...
	case MULTI01:          // 화면 confirm시
		...
		sheetObj.DoSearch("ESM_SQM_0025GS.do", searchParams);
 ...
 function toggleButtons(step) {
 	switch (step) {
 		case "INIT":
 			...
 			ComBtnDisable("btn_Pop0026");
 			ComBtnDisable("btn_Pop0027");
			ComBtnDisable("btn_LoadViewFigureCopy");
 			break;
 		...
 		case "SEARCH":
 			...
 			ComBtnEnable("btn_Pop0026");
 			ComBtnEnable("btn_Pop0027");
 			ComBtnEnable("btn_LoadViewFigureCopy");
 			break;
   ...
   */
    ...
    */
    function sheet1_OnSearchEnd(sheetObj, ErrMsg){
   	 ...
   	 if(buttonAction == "LoadViewFigureCopy") {
