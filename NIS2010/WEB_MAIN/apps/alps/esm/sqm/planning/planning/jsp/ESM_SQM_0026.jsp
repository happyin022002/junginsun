...
*@FileName       : ESM_SQM_0026.jsp
*@FileTitle      : QTA Set-up by RHQ (O/B Contract)_Office Distribute Result
*Open Issues     :
*Change history  :
...
<html>
<head>
<title>QTA Set-up by RHQ (O/B Contract)_Office Distribute Result</title>
	...
	<tr>
		<td>
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;QTA Set-up by RHQ (O/B Contract)_Office Distribute Result</td>
