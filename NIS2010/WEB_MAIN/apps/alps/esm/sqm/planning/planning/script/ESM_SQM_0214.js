...
/**
 * @extends
 * @class ESM_SQM_0214 : ESM_SQM_0214 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_SQM_0214() {
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		case IBCLEAR:          // 화면 접속 시
			...
			var sXml   = sheetObj.GetSearchXml("ESM_SQM_0214GS.do", FormQueryString(formObj));
		...
		case IBSEARCH:          // 화면 조회 시
			...
			ComOpenWait(true);
			var rtnXml = sheetObj.GetSearchXml("ESM_SQM_0214GS.do",searchParams);
		...
		case MULTI01:		// Creation시에
			...
			sheetObj.DoSave("ESM_SQM_0214GS.do", searchParams, -1, false);
			ComOpenWait(false);
