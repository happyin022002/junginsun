...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planninginquiry.event.EsmSqm0029Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0029Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0029Event)request.getAttribute("Event");
								...
								<td width="190" rowspan="2" valign="top">
									<table class="search" border="0">
										...
										<tr class="h23">
											...
											<td width="170" colspan=3><input type="text" style="text-align:center;" class="input" size="3" maxlength="2" dataformat="int" name="f_fm_mon">
											&nbsp;&nbsp;~&nbsp;&nbsp;&nbsp;<input type="text" style="text-align:center;" class="input" dataformat="int" size="3" maxlength="2" name="f_to_mon"></td>
										</tr>
									</table>
								</td>
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="80"><script language="javascript">ComComboObject('f_rgn_ofc_cd', 1, 70, 0)</script></td>
											<td>&nbsp;</td>
										</tr>
										<tr class="h23">
											<td>Trade</td>
											<td><script language="javascript">ComComboObject('f_trd_cd', 1, 80, 0)</script></td>
											<td>R/Lane</td>
											<td><script language="javascript">ComComboObject('f_rlane_cd', 1, 90, 0)</script></td>
											<td><div id="div_dir">Lane Bound</div></td>
											<td><div id="dir_cd"><script language="javascript">ComComboObject('f_dir_cd', 1, 70, 0 )</script></div>
											    <div id="trd_dir" style="display:none;"><script language="javascript">ComComboObject('f_trd_dir', 1, 70, 0 )</script></div></td>
