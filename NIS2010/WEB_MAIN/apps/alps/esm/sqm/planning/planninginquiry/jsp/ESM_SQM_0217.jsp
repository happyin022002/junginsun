...
<%@ page import="com.hanjin.apps.alps.esm.sqm.planning.planninginquiry.event.EsmSqm0217Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0217Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0217Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Inquiry_Yearly Planning_IAS Sector</title>
							...
							<tr>
								<td>
									<table class="search" border="0">
										<tr class="h23">
											<td width="45">Year</td>
											<td width="100"><script language="javascript">ComComboObject('f_bse_yr', 1, 60, 0, 1 )</script></td>
											<td width="75">Office View</td>
											<td width="90"><script language="javascript">ComComboObject('f_ofc_vw_cd', 1, 75, 1, 1)</script></td>
									...
									<table class="search" border="0">	
										<tr class="h23">
											...
											<td width="90"><script language="javascript">ComComboObject('f_sub_trd_cd', 1, 75, 1)</script></td>
									...
									<table class="search" border="0">		
										<tr class="h23">
											...
											<td width="90"><script language="javascript">ComComboObject('f_rlane_cd', 1, 75, 1)</script></td>
											<td width="80">POL</td>
