...
<%@ page import="com.hanjin.apps.alps.esm.sqm.specialkpi.adjustment.event.EsmSqm0505Event"%>
...
<%
	...
	EsmSqm0505Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0505Event)request.getAttribute("Event");
...
<html>
<head>
<title>KPI Creation & Edit_New Lane Add </title>
	...
	<tr>
		<td valign="top">
			...
			<table width="500" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;&nbsp;KPI Creation & Edit_New Lane Add</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
