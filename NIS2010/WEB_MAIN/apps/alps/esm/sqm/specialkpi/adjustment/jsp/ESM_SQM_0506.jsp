...
<%@ page import="com.hanjin.apps.alps.esm.sqm.specialkpi.adjustment.event.EsmSqm0506Event"%>
...
<%
	...
	EsmSqm0506Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0506Event)request.getAttribute("Event");
...
<html>
<head>
<title>KPI Creation & Edit_New Office Add </title>
	...
	<tr>
		<td valign="top">
			...
			<table width="600" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;&nbsp;KPI Creation & Edit_New Office Add</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
			
			<!-- TABLE '#D' : ( Search Options ) (S) -->
			<table class="search" width="750" border="0">
				<tr>
					<td class="bg">
						<table >
							<tr>
			...
			<table class="line_bluedot" width="750" border="0"><tr><td colspan="8"></td></tr></table>	

			<!-- TABLE '#D' : ( Search Options ) (S) -->
			<table width="750" class="search" border="0">
				<tr>
					<td class="bg_b1">
						<table width="500" border="0" class="height_10"><tr><td></td></tr></table>
						<!-- : ( POR ) (S) -->
						<table width="750" border="0" id="mainTable">
							<tr>
...
<table width="750" class="height_5"><tr><td></td></tr></table>

<!-- : ( Button : pop ) (S) -->
<table width="800" class="sbutton">
	<tr>
