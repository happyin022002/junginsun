...
<%@ page import="com.hanjin.apps.alps.esm.sqm.adjustment.qtainquiry.event.EsmSqm0226Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0226Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0226Event)request.getAttribute("Event");
...
<html>
<head>
<title>Quarterly Current QTA Report for IAS Sector</title>
							...
							<tr>
								<td>
									<table class="search" border="0">
										<tr class="h23">
											<td width="43">Year</td>
											<td width="59"><script language="javascript">ComComboObject('f_bse_yr', 1, 55, 0, 1 )</script></td>
											<td width="51">Quarter</td>
											<td width="52"><script language="javascript">ComComboObject('f_bse_qtr_cd', 1, 50, 0, 1)</script></td>
											<td class="sm" width="160"><div id="div_period_based_on_rev_month"></div></td>
											<td width="71">Office View</td>
											<td width="76"><script language="javascript">ComComboObject('f_ofc_vw_cd', 1, 65, 1, 1)</script></td>
											<td width="81">Office Level</td>
											<td width="87"><script language="javascript">ComComboObject('f_ofc_lvl', 1, 75, 1, 1)</script></td>
											<td width="78"><div id="div_rhq">RHQ</div></td>
									...
									<table class="search" border="0">	
										<tr class="h23">
										<td width="42"><div id="div_monwk">Month</div></td>
											<td width="89">
												...
												<div id="div_wk" style="display:none">
													<input type="text" style="text-align:center;" class="input" size="2" maxlength="2" dataformat="int" name="f_fm_wk">
													~ <input type="text" style="text-align:center;" class="input" size="2" maxlength="2" dataformat="int" name="f_to_wk">
												</div>
											</td>
											<td width="234"><input type="checkbox" value="W" name="chk_week" class="trans">&nbsp;Week</td>
											<td width="71">Sub Trade</td>
											<td width="76"><script language="javascript">ComComboObject('f_sub_trd_cd', 1, 65, 1)</script></td>
											<td width="81">IAS Region</td>
											<td width="87"><script language="javascript">ComComboObject('f_ias_rgn_cd', 1, 75, 1)</script></td>
											<td width="78"><div id="div_dir">Lane Bound</div></td>
											<td width="75">
									...
									<table class="search" border="0">		
										<tr class="h23">
											<td width="365"></td>
											<td width="71">R/Lane</td>
											<td width="76"><script language="javascript">ComComboObject('f_rlane_cd', 1, 65, 1)</script></td>
											<td width="81">POL</td>
											<td width="87"><script language="javascript">ComComboObject('f_pol_cd', 1, 75, 1)</script></td>
											<td width="78">POD</td>
