...
<%@ page import="com.hanjin.apps.alps.esm.sqm.adjustment.qtainquiry.event.EsmSqm0037Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0037Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0037Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Inquiry_Quarterly Overall (Currently Updated)</title>
							...
							<tr>
								<td width="375">
									<table class="search" border="0">
										<tr class="h23">
											<td width="40">Year</td>
											<td width="65" style="padding-left:2;"><script language="javascript">ComComboObject('f_bse_yr', 1, 60, 0, 1 )</script></td>
											<td width="52"><div id="div_qtr">Quarter</div></td>
											<td width="52"><script language="javascript">ComComboObject('f_bse_qtr_cd', 1, 50, 0, 1)</script></td>
											<td class="sm"><div id="div_period_based_on_rev_month">&nbsp;</div></td>
										</tr>
									</table>
									<table class="search" border="0">
										<tr class="h23">
											<td width="40"><div id="div_monwk">Month</div></td>
											<td width="105">
