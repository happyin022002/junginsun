...
* 2015.01.22 변경된 Quarter 표시(week에서 rev month로)에 따라 미세조정
...
<%@ page import="com.hanjin.apps.alps.esm.sqm.adjustment.qtaadjustment.event.EsmSqm0033Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0033Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0033Event)request.getAttribute("Event");
...
<html>
<head>
<title>Portion Adjustment by RHQ</title>
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td><script language="javascript">ComComboObject('f_ob_div_cd', 1, 75, 0, 0)</script></td>
										</tr>
									</table>
								</td>
							</tr>
			...
			<table class="search" border="0">
				<tr>
					<td class="bg_b1">
									...
									<table border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
												<tr>
													<td class="btn2_left"></td>
													<td class="btn2" name="btn_RowAdd">Office Row&nbsp;Add</td>
													<td class="btn2_right"></td>
												</tr>
											</table>
										</td>
						...
						<table width="100%" class="search" >
							<tr><td height="5" id="sheet_unit">*When you use "Office Group Row Add" & "Creation" button, specific R/Lane information must be selected.</td></tr>
						</table>
				    	<!-- Button_Sub (E) -->	
					</td>
				</tr>
