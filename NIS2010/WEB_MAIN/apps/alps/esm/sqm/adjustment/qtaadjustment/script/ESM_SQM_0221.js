...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		case IBCLEAR:          // 화면 접속 시
			...
			var sXml   = sheetObj.GetSearchXml("ESM_SQM_0221GS.do", FormQueryString(formObj));
		...
		case IBSEARCH:          // 화면 조회 시
			...
			ComOpenWait(true);
			var rtnXml = sheetObj.GetSearchXml("ESM_SQM_0221GS.do",searchParams);	
		...
		case MULTI:		// Creation시에
			...
			sheetObj.DoSave("ESM_SQM_0221GS.do", searchParams, "sel_flg", false);
			ComOpenWait(false);
