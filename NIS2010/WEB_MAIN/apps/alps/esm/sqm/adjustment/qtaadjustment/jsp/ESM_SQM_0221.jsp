...
*@FileName       : ESM_SQM_0221.jsp
*@FileTitle      : QTA Edit for IAS Sector_POL-POD pair Add
*Open Issues     :
*Change history  :
...
<%@ page import="com.hanjin.apps.alps.esm.sqm.adjustment.qtaadjustment.event.EsmSqm0221Event"%>
...
<%
	...
	EsmSqm0221Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0221Event)request.getAttribute("Event");
...
<html>
<head>
<title>QTA Edit for IAS Sector_POL-POD pair Add</title>
	...
	<tr>
		<td valign="top">
			...
			<table width="850" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;&nbsp;QTA Edit for IAS Sector_POL-POD pair Add</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
						...
						<table >
							<tr>
								<td width="">
									<table class="search" border="0">
										<tr class="h23">
											<td width="70">Year</td>
											<td width="65"><input type="text" name="f_bse_yr" style="width:50;text-align:center;ime-mode:disabled;" readonly class="input2" value="<%= p_bse_yr%>"></td>
											...
											<td width="75"><input type="text" name="f_ofc_vw_cd" style="width:65;text-align:center;ime-mode:disabled;" readonly class="input2" value=""></td>
											<td width="80">Lane Bound</td>
											<td width=""><script language="javascript">ComComboObject('f_dir_cd', 1, 65, 1,1)</script></td>
											<td>&nbsp;</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td>
									<table class="search" border="0">
										<tr class="h23">
											<td width="72">Sub Trade</td>
											<td width="63"><script language="javascript">ComComboObject('f_sub_trd_cd', 1, 50, 1,1)</script></td>
											...
											<td width="82">POL</td>
											<td width="73"><script language="javascript">ComComboObject('f_pol_cd', 1, 65, 0)</script></td>
											<td width="80">POD</td>
											<td width=""><script language="javascript">ComComboObject('f_pod_cd', 1, 65, 0)</script></td>
										</tr>
									</table>
								</td>
							</tr>
