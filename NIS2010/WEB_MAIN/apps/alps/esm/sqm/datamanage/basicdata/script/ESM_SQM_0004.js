...
/**
 * @extends 
 * @class ESM_SQM_0004 : ESM_SQM_0004 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_SQM_0004() {
...
function doActionIBSheet(formObj, sAction) {
	...
	switch(sAction) {
		case IBCREATE:          // Data Create 시
			...
			var sXml = codeSheet.GetSearchXml("ESM_SQM_0004GS.do?", FormQueryString(formObj));
