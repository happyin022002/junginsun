...
<%@ page import="com.hanjin.apps.alps.esm.sqm.datamanage.basicdata.event.EsmSqm0005Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0005Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0005Event)request.getAttribute("Event");
...
<input type="hidden" name="cre_flg" value="<%=creFlg%>">
<!-- 개발자 작업	-->
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="85"><script language="javascript">ComComboObject('f_trd_cd', 1, 60, 0)</script></td>
											<td width="90">Lane Bound</td>
											<td width="100"><script language="javascript">ComComboObject('f_dir_cd', 1, 75, 0 )</script></td>
											<td width="80">Sub Trade</td>
											<td width="90"><script language="javascript">ComComboObject('f_sub_trd_cd', 1, 60, 0 )</script></td>
											<td width="65">R/Lane</td>
											<td width="95"><script language="javascript">ComComboObject('f_rlane_cd', 1, 70, 0 )</script></td>
											<td width="20"><input type="checkbox" name="vbp_if_flg" value="Y" class="trans"></td>
											<td><div id="div_vbp">VBP IF</div></td>
											<td width="20"><input type="checkbox" name="mas_flg" value="Y" class="trans"></td>
											<td><div id="div_mas">Compare with MAS</div></td>
											<td>&nbsp;</td>
										</tr>
									</table>
								</td>
									...
									<tr>
										...
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
												<tr>
													<td class="btn2_left"></td>
													<td class="btn2" name="btn_Retrieve1">SKD & BSA Inquiry</td>
													<td class="btn2_right"></td>
												</tr>
											</table>
										</td>
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
												<tr>
													<td class="btn2_left"></td>
													<td class="btn2" name="btn_0006Pop">Disable Lane Select</td>
													<td class="btn2_right"></td>
												</tr>
											</table>
										</td>
