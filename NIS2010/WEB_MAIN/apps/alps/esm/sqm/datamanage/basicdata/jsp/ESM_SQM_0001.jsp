							...
							<tr>
								...
								<td>
									<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
										<tr>
											<td class="btn1_left"></td>
											<td class="btn1" id="btn_PreQTACopy" name="btn_PreQTACopy">Previous QTA Copy</td>
											<td class="btn1_right"></td>
										</tr>
									</table>
								</td>
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="85"><div id="div_qtr">Quarter</div></td>
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="70"><script language="javascript">ComComboObject('f_trd_cd', 1, 60, 0)</script></td>
											<td width="85">Trade Bound</td>
											...
											<td><script language="javascript">ComComboObject('f_ob_div_cd', 1, 85, 0)</script></td>
										</tr>
									</table>
								</td>
							</tr>
