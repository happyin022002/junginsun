...
<%@ page import="com.hanjin.apps.alps.esm.sqm.datamanage.basicdata.event.EsmSqm0003Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0003Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0003Event)request.getAttribute("Event");
								...
								<td>
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="95"><script language="javascript">ComComboObject('f_ofc_lvl', 1, 80, 0, 1)</script></td>
											<td width="40">RHQ</td>
