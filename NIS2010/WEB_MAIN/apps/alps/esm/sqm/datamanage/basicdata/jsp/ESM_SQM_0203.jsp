...
<%@ page import="com.hanjin.apps.alps.esm.sqm.datamanage.basicdata.event.EsmSqm0203Event"%>
...
<%
	...
	EsmSqm0203Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0203Event)request.getAttribute("Event");
...
<html>
<head>
<title>POL-POD Management for IAS Sector_Add Creation </title>
	...
	<tr>
		<td valign="top">
			...
			<table width="850" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;&nbsp;POL-POD Management for IAS Sector_Add Creation</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
								...
								<td width="">
									<table class="search" border="0">
										<tr class="h23">
											...
											<td width="" class='sm'><div id="div_period"></div></td>
										</tr>
									</table>
								</td>
							</tr>
