...
/**
 * @extends 
 * @class ESM_SQM_0006 : ESM_SQM_0006 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_SQM_0006() {
	...
	switch(sheetNo) {
		case 1:		//sheet1 init
			with (sheetObj) {
				...
				var HeadTitle1 =  "SEQ|Trade|Lane Bound|Sub-Trade|Lane|Select";
				...
				InitDataProperty(0,	cnt++,	dtData,		90,	daCenter,	true,	"trd_cd",	  false,	"",	dfNone,	0,	false,	false);
				InitDataProperty(0,	cnt++,	dtData,		90,	daCenter,	true,	"dir_cd",	  false,	"",	dfNone,	0,	false,	false);
				InitDataProperty(0,	cnt++,	dtData,		90,	daCenter,	true,	"sub_trd_cd", false,	"",	dfNone,	0,	false,	false);
				InitDataProperty(0,	cnt++,	dtData,		90,	daCenter,	false,	"rlane_cd",	  false,	"",	dfNone,	0,	false,	false);				
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		case IBSEARCH:          //조회
			...
			var rtnXml = sheetObj.GetSearchXml("ESM_SQM_0006GS.do", FormQueryString(formObj));		
