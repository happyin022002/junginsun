...
<%@ page import="com.hanjin.apps.alps.esm.sqm.datamanage.officemapping.event.EsmSqm0205Event"%>
...
<%
	...
	EsmSqm0205Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0205Event)request.getAttribute("Event");
...
<html>
<head>
<title>Sector-Office Relation Setting for IAS Sector_Add Creation</title>
...
<input type="hidden" name="act_cnt">
	...
	<tr>
		<td valign="top">
			...
			<table width="850" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;&nbsp;Sector-Office Relation Setting for IAS Sector_Add Creation</td></tr>
			</table>
			<!-- : ( Title ) (E) -->
