...
<%@ page import="com.hanjin.apps.alps.esm.sqm.datamanage.costmanage.event.EsmSqm0012Event"%>
...
<%
	...
	EsmSqm0012Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0012Event)request.getAttribute("Event");
...
<html>
<head>
<title>Basic CMCB_New Lane Cost IF</title>
