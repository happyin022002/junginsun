...
<%@ page import="com.hanjin.apps.alps.esm.sqm.datamanage.costmanage.event.EsmSqm0209Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSqm0209Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSqm0209Event)request.getAttribute("Event");
...
<html>
<head>
<title>New Lane & Sector CMCB</title>
						...
						<table class="search_in">
							<tr>
								<td width="100" rowspan="2">
									<table class="search_sm2" width="100">
										<tr class="h23">
