...
<%@ page import="com.hanjin.apps.alps.esm.bis.blinformationmgt.blinformationmgt.event.EsmBis0743Event"%>	
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="java.util.StringTokenizer" %>

<%
	EsmBis0743Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBis0743Event) request.getAttribute("Event");
...
<!--table width="100%" class="popup" cellpadding="10" border="1"--> 
		...
		<table class="search" border='0'> 
       	<tr><td class="bg" valign='top'>
				...
				<tr><td class="tr2_head">Container Type</td>
					...
					--></td></tr>
				<tr><td class="tr2_head">Print Setup (Face)</td>
					<td class="input" width="250" style="padding-left:5px">
				...
				<tr><td class="tr2_head">Print Setup (Rider)</td>
					<td class="input" style="padding-left:5px">
				...
				<div style="display:none">
 				...
 				<td width="450" style='padding:4px' valign='top' bgcolor='#EFEFEF'> <!-- : ( Grid ) (S) -->
