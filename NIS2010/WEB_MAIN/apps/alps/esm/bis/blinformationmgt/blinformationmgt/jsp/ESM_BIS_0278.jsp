...
<%@ page import="com.hanjin.apps.alps.esm.bis.blinformationmgt.blinformationmgt.event.EsmBis0278Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EsmBis0278Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBis0278Event)request.getAttribute("Event");
...
<script language="javascript" type="text/javascript" src="apps/alps/esm/bis/CoBis.js"></script>
...
<input type="hidden" name="sheet_bkg_no_row_chk">
<input type="hidden" name="master_bl_no">
<input type="hidden" name="master_bkg_no">
...
<input type="hidden" name="bl_rect_top">
<input type="hidden" name="bl_rect_left">
<input type="hidden" name="bkg_rect_top">
<input type="hidden" name="bkg_rect_left">
...
<input type="hidden" name="com_isBatch" value="">
                        ...
                        <table class="search" border="0">
                          <tr class="h23">
                            ...
                            <td width="150" colspan="3" valign="top">
                              <table class="search" border="0">
                                <tr class="h23">
                                  <td valign="top" id="td_bl_no" width="125">
                                    <div id="bl_input" style="display:block;">
                                      <input type="text" name="input_bl_no" style="width:105;" class="input1" value="" maxlength="12" dataformat="engupnum">
                                    </div>
                                    <div id="bl_sheet" style="display:none;width:123px;height:150px;position:absolute;left:0px;top:0px;">
                                      <script language="javascript">ComSheetObject('t1sheet1');</script>
                                    </div>
                                  </td>
                                  <td valign="top" width="25">&nbsp;<img id="tb1_btn_input_bl_no" name="tb1_btn_input_bl_no" src="img/btns_multisearch.gif" width="19" height="20" border="0" style="cursor:hand" align="absmiddle"></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                          <tr class="h23">
                          <td width="98" valign="top">BKG No.</td>
                            <td width="150" colspan="3" valign="top">
                              <table class="search" border="0">
                                <tr class="h23">
                                  <td valign="top" id="td_bkg_no" width="125">
                                    <div id="bkg_input" style="display:block;">
                                      <input type="text" name="input_bkg_no" style="width:105;" class="input1" value="" maxlength="13" dataformat="engupnum">
                                    </div>
                                    <div id="bkg_sheet" style="display:none;width:123px;height:150px;position:absolute;left:0px;top:0px;">
                  						<script language="javascript">ComSheetObject('t1sheet2');</script>
               						</div>
                                  </td>
                                  <td valign="top" width="25">&nbsp;<img id="tb1_btn_input_bkg_no" name="tb1_btn_input_bkg_no" src="img/btns_multisearch.gif" width="19" height="20" border="0" style="cursor:hand" align="absmiddle"></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                          ...
                          <tr class="h23">
                            ...
                            <td width=""><input type="text" name="ob_srep_cd" style="width:50;" class="input" value="" maxlength="5" dataformat="engup"></td>
                          </tr>
                          <tr class="h23">
                      ...
                      <td>
                        ...
                        <table class="search_sm" border="0">
                          ...
                          <tr class="sm">
                            ...
                            <td width=""><input type="checkbox" name="hog_de_flg" value="Y"class="trans">&nbsp;Hot(Premier)</td>
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width=""><input type="text" name="Measure" style="width:88;text-align:right;" class="input" value="" readonly></td>
              	<td width="50">TOT TEU</td>
                <td width=""><input type="text" name="total_all_teu" style="width:88;text-align:right;" class="input" value="" readonly></td>
              </tr>
            </table>
            <!--  Button_Sub (S) -->
          ...
          <td class="btn1_bg">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn1_left"></td>
                    <td class="btn1" name="tb2_btn_DownExcel">Down Excel</td>
                    <td class="btn1_right"></td>
                    </tr></table></td>
