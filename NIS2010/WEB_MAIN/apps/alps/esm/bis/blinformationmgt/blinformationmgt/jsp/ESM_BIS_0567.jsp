...
<%@ page import="com.hanjin.apps.alps.esm.bis.blinformationmgt.blinformationmgt.event.EsmBis0567Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBis0567Event  event           = null;	//PDTO(Data Transfer Object including Parameters)
	...
	try {	
		event = (EsmBis0567Event)request.getAttribute("Event");		
...
<LINK href="/hanjin/css/alpl_contents.css" type="text/css" rel="stylesheet"/>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:100%;"> 
					...
					<tr class="h23">
						...
						<td width="160">
						    <input type="text" style="width:120;" class="input1" name="bkg_no" value="" caption="Booking No." maxlength="13" style="ime-mode:disabled" dataformat="uppernum"></td>
...
<!--
      ...
      with(document.form)
      {
        <%
        if(event != null){ 
            String bkgNo  = JSPUtil.getNullNoTrim(event.getBkgBlNoVO().getBkgNo());
            String popFlg = JSPUtil.getNullNoTrim(event.getPopFlg());
        %>
