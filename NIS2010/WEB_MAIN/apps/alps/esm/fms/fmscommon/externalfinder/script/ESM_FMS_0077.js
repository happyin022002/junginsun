...
*            - Carrier Name 입력시 대문자변환등 이벤트 제거 initControl()
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class Item Detail Management - Window : Item Detail Management - Window 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_fms_0077() {
    ...
    function initControl() {
        ...
        //2010.08.11 이준범 axon_event.addListener () 에서 "carr_nm" 제거
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtData,   		90,   	daCenter,  	false,   	"crr_cd",		false,        "",     dfNone,   	0,    false,      false);
					InitDataProperty(0, cnt++ , dtData,   		150,  	daLeft,  	false,   	"crr_full_nm",  false,        "",     dfNone,     	0,    false,      false, 50);
               }
                break;
        }
    }
