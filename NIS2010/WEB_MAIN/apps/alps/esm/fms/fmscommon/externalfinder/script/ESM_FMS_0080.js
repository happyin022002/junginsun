...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    function initControl() {
        ...
        axon_event.addListener ('keypress', 'num_keypress', 'acct_cd');
                ...
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitHeadMode(true, true, false, true, false,false)
                 	var HeadTitle = "||Seq|Account Code|Account Name";
					...
					InitDataProperty(0, cnt++ , dtData,   		300,  	daLeft,  	false,   	"acct_eng_nm",  false,        "",     dfNone,     	0,    false,      false, 50);
               }
                break;
        }
    }
...
//            }
    ...
    /**
     *  화면에서 Condition 조건에 따라 Search Keyword 입력 포맷을 변경한다 <br>
     * @param vel (0 : Account Code 1 : Account Name)
     * @return
     */    
    function sel_rdo_chk(vel) {
    	frm = document.form;
    	if(vel == 0) {
