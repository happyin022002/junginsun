...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutfleetmanagement.tchariodeliveryschedule.event.EsmFms0019Event"%>
...
<html>
<head>
<title>NB Delivery Schedule Creation</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
			...
			<tr><td class="title_h"></td>
				<td class="title_s">NB Delivery Schedule Creation / Master</td></tr>
			</table>
			...
			<tr class="h23">
				...
				<td width="101">Ship's Full Name</td>
