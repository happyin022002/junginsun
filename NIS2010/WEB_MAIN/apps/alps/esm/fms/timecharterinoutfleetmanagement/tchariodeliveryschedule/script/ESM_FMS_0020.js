        ...
        var formObject = document.form;
     	...
     	try {
     		...
     		switch(srcName) {
     			...
     			case "btn_yard":
     				ComOpenPopup("ESM_FMS_0082.do", 300, 320, "setFormYardName", "1,0,1,1,1", false, false, null, null, null, "esm_fms_0082");
     				break;
     			case "btn_owner":
     				ComOpenPopup("ESM_FMS_0083.do", 500, 355, "setFromOwnerName", "1,0,1,1,1", false, false, null, null, null, "esm_fms_0083");
     				break;
    	...
    	switch(sheetNo) {
    		case 1:      //sheet1 init
    			with (sheetObj) {
                     ...
                     InitDataProperty(0, cnt++ , dtData,   			150,   	daLeft,  	false,   "shp_nm",   			false,          "",      dfNone,   			0,	false,		false,		25);
                     InitDataProperty(0, cnt++ , dtData,   			250,   	daLeft,  	false,   "shp_bld_nm",   		false,         	"",      dfNone,      		0,	false,		false,		50);
                     InitDataProperty(0, cnt++ , dtData,   			100,   	daRight,   	false,   "vsl_dznd_capa",  		false,          "",      dfInteger,  		0,	false,		false,		5);
                     InitDataProperty(0, cnt++ , dtData,   			80,   	daRight,   	false,   "bse_14ton_vsl_capa",  false,          "",      dfInteger,  		0,	false,		false,		5);
                     InitDataProperty(0, cnt++ , dtData,   			60,   	daRight,  	false,   "rf_cntr_plg_qty",     false,          "",      dfInteger,  		0,	false,		false,		6);
                     InitDataProperty(0, cnt++ , dtData,   			60,   	daRight,   	false,   "shp_spd_qty",  		false,          "",      dfNullFloat,		2,	false,		false,		8);
                     InitDataProperty(0, cnt++ , dtData,   			100,   	daLeft,  	false,   "flet_ctrt_dur_ctnt",  false,          "",      dfNone,  			0,	false,		false,		30);
                     InitDataProperty(0, cnt++ , dtData,   			100,   	daLeft,  	false,   "trd_hus_nm",     		false,          "",      dfNone,     		0,	false,		false,		25);
                     InitDataProperty(0, cnt++ , dtData,   			140,   	daCenter,  	false,   "vsl_de_dt",  			false,          "",      dfDateYmd,			0,	false,		false);
                     InitDataProperty(0, cnt++ , dtData,   			150,   	daLeft,  	false,   "shp_yd_nm",     		false,          "",      dfNone,  			0,	false,		false);
                     InitDataProperty(0, cnt++ , dtData,   			150,    daLeft,  	false,   "ownr_nm",     	 	false,          "",      dfNone,     		0,	false,		false);
    ...
    function validateForm(sheetObj,formObj,sAction){
    	...
    	with(formObj){
    		...
    		if(parseInt(vslCdSize1.value.replace(",","")) > parseInt(vslCdSize2.value.replace(",",""))) { 
    			vslCdSize2.value = "";
    			// To Duration는 From Duration보다 커야 합니다
