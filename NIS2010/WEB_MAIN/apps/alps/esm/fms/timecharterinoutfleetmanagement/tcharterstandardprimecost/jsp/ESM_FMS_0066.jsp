...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutfleetmanagement.tcharterstandardprimecost.event.EsmFms0066Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmFms0066Event  event = null;				//PDTO(Data Transfer Object including Parameters)
...
//	Logger log = Logger.getLogger("com.hanjin.apps.TimeCharterInOutFleetManagement.TCharterStandardPrimeCost");
	...
	try {
		...
		event = (EsmFms0066Event)request.getAttribute("Event");
...
<tr><td valign="top">
	...
	<table class="search"> 
		...
		<tr><td class="title_h"></td>
			<td class="title_s">Standard Hire Inquiry - Master</td></tr>
		</table>
		...
		<table class="search" border="0">
		<tr><td class="title_h"></td>
			<td class="title_s">Standard Hire Inquiry - Grid</td></tr>
		</table>
		<!-- Grid  (S) -->
