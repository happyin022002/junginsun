...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutfleetmanagement.tcharterstandardprimecost.event.EsmFms0063Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmFms0063Event  event = null;				//PDTO(Data Transfer Object including Parameters)
...
//	Logger log = Logger.getLogger("com.hanjin.apps.TimeCharterInOutFleetManagement.TCharterStandardPrimeCost");
	...
	try {
		...
		event = (EsmFms0063Event)request.getAttribute("Event");
...
<tr><td valign="top">
	...
	<table class="search"> 
		...
		<tr><td class="title_h"></td>
			<td class="title_s">Standard Hire Creation - Master</td></tr>
		</table>
		...
		<table class="search" border="0">
		<tr><td class="title_h"></td>
			<td class="title_s">Standard Hire Creation - Grid</td></tr>
		</table>
		<!-- Grid  (S) -->
...
<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
      	<tr><td class="btn1_bg">
		    ...
		    <tr>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn1_left"></td>
						<td class="btn1" name="btn_hireCreation">Hire Creation</td>
						<td class="btn1_right"></td>
						</tr>
					</table></td>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
								<tr><td class="btn1_left"></td>
								<td class="btn1" name="btn_marketRateApply">Market Rate Apply</td>
								<td class="btn1_right"></td>
								</tr>
					</table></td>
					<!-- td class="btn1_line"></td>
