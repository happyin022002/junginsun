...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutfleetmanagement.tchariodockschedule.event.EsmFms0057Event"%>
...
<html>
<head>
<title>D/Dock Schedule Review - Chart</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">D/dock Schedule Review - Master</td></tr>
				</table>
				...
				<tr class="h23">
					...
					<td>Ship Yard</td>
					<td colspan="2"><input type="text" style="width:141;" class="input2" name="shpYdNm" caption="Owner" readonly>&nbsp;<img class="cursor" src="img/btns_search.gif" name="btn_yard" width="19" height="20" alt="" border="0" align="absmiddle"><input type="checkbox" name="btn_ydClr" class="trans">
					</td></tr>
				...
				<table class="search" border="0">
				<tr><td class="title_h"></td>
					<td class="title_s">D/dock Schedule Review</td></tr>
				</table>
					<!-- Grid  (S) -->
