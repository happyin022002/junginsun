...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutfleetmanagement.tchariodockschedule.event.EsmFms00541Event"%>
...
<input type="hidden" name="dck_sel_cd" value="E">
<!-- 개발자 작업	-->
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<table class="search" border="0">
				<tr><td class="title_h"></td>
					<td class="title_s">Estimated Schedule Data Input</td></tr>
				</table>
				<!-- Grid  (S) -->
