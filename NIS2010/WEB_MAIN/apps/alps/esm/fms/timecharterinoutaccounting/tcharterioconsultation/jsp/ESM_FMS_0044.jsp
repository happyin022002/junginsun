...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioconsultation.event.EsmFms0044Event"%>
...
<tr><td class="top"></td></tr>
	...
	<!--Page Title, Historical (S)-->
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Slip Correction Detail</td></tr>
		</table>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="280"><input type="text" style="width:56;text-align:center;" class="input2" value="<%=vsl_cd%>" readonly>&nbsp;<input type="text" style="width:200;" class="input2" value="&nbsp;<%=vsl_eng_nm%>" readonly></td>
				...
				<table class="search" border="0">
				<tr><td class="title_h"></td>
					<td class="title_s"> Slip Correction - Detail</td></tr>
				</table>
				<!-- Grid  (S) -->
