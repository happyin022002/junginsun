...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioconsultation.event.EsmFms00401Event"%>
...
<html>
<head>
<title>Manual Slip – Brokerage / Window</title>
...
<tr><td class="top"></td></tr>
	<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Manual Slip - Brokerage</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
