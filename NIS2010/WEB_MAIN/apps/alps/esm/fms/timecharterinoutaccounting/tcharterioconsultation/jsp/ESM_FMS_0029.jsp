...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioconsultation.event.EsmFms0029Event"%>
...
<%
	...
	String evidTpCd = JSPUtil.replaceForHTML(request.getParameter("evid_tp_cd"));
	String taxInvYrmon = request.getParameter("tax_inv_yrmon").substring(0,7);
	String ownGubun = request.getParameter("own_gubun");			// 추가.
...
<input type="hidden" name="evid_tp_cd" value="<%=evidTpCd%>">
<input type="hidden" name="own_gubun" value="<%=ownGubun%>">
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="530"><input type="text" style="width:60;text-align:center;" class="input1" name="tax_inv_yrmon" maxlength="6" value="<%=taxInvYrmon%>" dataformat="ym" required fullfill caption="Tax Inv Yrmon">&nbsp;<img class="cursor" src="img/btns_calendar.gif" name="tax_inv_yrmon_cal" width="19" height="20" alt="" border="0" align="absmiddle">&nbsp;
					...
					<td width="105">
						<table class="search_sm" border="0" style="width:250;"> 
							<tr class="h23">
								...
								<td width="" class="noinput1"><input type="radio" class="trans" name="tax_iss_cd" value="ELECTRONIC">전자 &nbsp;<input type="radio" class="trans" name="tax_iss_cd" value="PAPER">종이</td>
							</tr>
						</table>
						<table class="height_2"><tr><td></td></tr></table>
					</td>
					<!-- 
					<td width="105">발행구분</td>
					<td width="" class="noinput1"><input type="radio" class="trans" name="tax_tp_cd" value="1">종이 &nbsp;&nbsp;&nbsp;<input type="radio" class="trans" name="tax_tp_cd" value="2" checked>전자 </td>
					-->
				</tr>
				</table>
				<table class="search" border="0" style="width:880;"> 
					...
					<td width="640">
						<table class="search_sm" border="0" style="width:250;"> 
							<tr class="h23">
								...
								<td width="" class="noinput1"><input type="radio" class="trans" name="tax_vat_tp_cd" value="1">개인 &nbsp;&nbsp;&nbsp;<input type="radio" class="trans" name="tax_vat_tp_cd" value="2" checked>회사 </td>
							</tr>
						</table>
					</td>
					<td width="">
					...
					<td width="640">
						<table class="search_sm" border="0" style="width:250;"> 
							<tr class="h23">
								...
								<td width="" class="noinput1"><input type="radio" class="trans" name="tax_div_cd" value="1" checked onclick="gridReset();">흑자 &nbsp;&nbsp;&nbsp;<input type="radio" class="trans" name="tax_div_cd" value="2" onclick="gridReset();">적자 </td>
							</tr>
						</table>
					</td>
					<td width="">
					...
					<td width="640">
						<table class="search_sm" border="0" style="width:250;" id="l_evid_tp_cd" style="display:''"> 
							<tr class="h23">
								...
								<td width="" class="stm"><input type="radio" class="trans" name="tax_pl_cd" value="1" onclick="gridReset();">영세 &nbsp;&nbsp;&nbsp;<input type="radio" class="trans" name="tax_pl_cd" value="2" checked onclick="gridReset();">과세 </td>
							</tr>
						</table>
					</td>
					<td width="">
				...
				<tr class="h23">
					...
					<td width="530"><input type="text" style="width:138;text-align:center;" class="input1" name="spl_rgst_no" maxlength="13" dataformat="saupja" required caption="Spl Rgst No"></td>
				...
				<tr class="h23">
					<td width="50">&nbsp;&nbsp;발행일 </td>
					<td width="300"><input type="text" style="width:80;text-align:center;" class="input1" name="iss_dt" maxlength="8" dataformat="ymd" required fullfill caption="Iss Date">&nbsp;<img class="cursor" src="img/btns_calendar.gif" name="iss_dt_cal" width="19" height="20" border="0" align="absmiddle"></td>
					<td width="60">공급가액 </td>
