...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioinvoice.event.EsmFms0099Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmFms0099Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmFms0099Event)request.getAttribute("Event");
	...
	String slpTp = JSPUtil.replaceForHTML(request.getParameter("slp_tp"));	
%>
...
<input type="hidden" name="slp_tp" value="<%=slpTp%>">
