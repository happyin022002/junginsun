...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class Manhour Item Select Pop up : Manhour Item Select Pop up 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_fms_0081() {
                ...
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitHeadMode(true, true, false, true, false,false)
                 	var HeadTitle = "||Seq||Manhour Item Name";
	                ...
	                InitDataProperty(0, cnt++ , dtHidden,  		 0,    	daCenter,  	true,    "man_hr_list_seq");
					InitDataProperty(0, cnt++ , dtData,   		280,   	daLeft,  	false,   "man_hr_itm_nm",    		false,        "",     dfNone,     	0,    false,      false, 50);
...
//        sheetObj.ShowDebugMsg = true;
        switch(sAction) {
        	case IBSEARCH:      //조회
        		if(validateForm(sheetObj,formObj,sAction)){
        	   	...
        	   	sheetObj.DoSearch("ESM_FMS_0081GS.do", FormQueryString(formObj));
        		}
        		break;
    ...
    function sheet1_OnSearchEnd(sheetObj,ErrMsg){
   		sheetObj.ColumnSort("man_hr_itm_nm");
    }
