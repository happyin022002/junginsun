...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioinvoice.event.EsmFms0025Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmFms0025Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmFms0025Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Account Management Selection</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
