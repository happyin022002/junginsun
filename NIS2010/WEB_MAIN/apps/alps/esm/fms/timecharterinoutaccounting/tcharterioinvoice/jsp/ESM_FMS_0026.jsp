...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioinvoice.event.EsmFms0026Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmFms0026Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmFms0026Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Offhire Expenses Selection</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
