...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharterioinvoice.event.EsmFms0034Event"%>
...
//	Logger log = Logger.getLogger("com.hanjin.apps.TimeCharterInOutFleetManagement.TCharIODeliverySchedule");
	...
	String currCd		= JSPUtil.replaceForHTML(request.getParameter("csr_curr_cd"));
...
<html>
<head>
<title>Hire Revenue Retrieve</title>
...
<table width="900" class="popup" cellpadding="10" border="0"> 
	<tr><td class="top"></td></tr>
		...
		<table width="100%" border="0">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Hire Revenue Retrieve </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
