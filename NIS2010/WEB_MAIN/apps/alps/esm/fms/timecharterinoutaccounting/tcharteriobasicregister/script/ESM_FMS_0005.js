...
* 2009.04.16 윤세영
* 1.0 Creation
* * 2013.02.04 이영두 [CHM-201322553] 추가 칼럼 ChK 하고 저장하면 Custom Seq 와 관련된 계약 정보의 Vendor Data를 일괄 수정함 
=========================================================*/
/****************************************************************************************
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
					...
					var HeadTitle = "|Sel|Seq|Customer Code|Customer Code|Chartered Company Name|Head Ownership Name|Head Ownership Name|Owner Type|Korea Tax Required|Vendor Code|Vendor Name|Chk|";
					...
					InitDataProperty(0, cnt++ , dtData,   		 40,    daCenter,  	false,   "cust_cnt_cd",     		true,          "",      	dfEngUpKey,      	0,     false,       true, 2);
					InitDataProperty(0, cnt++ , dtPopupEdit,   	 80,    daCenter,  	false,   "cust_seq",   					true,          "",      dfUserFormat,   	0,     false,       true, 6);
					InitDataProperty(0, cnt++ , dtData,   		 290,   daLeft,  	false,   "cust_lgl_eng_nm",     		false,          "",     dfNone,      		0,     false,       false);

	                InitDataProperty(0, cnt++ , dtHidden,  		 0,    	daCenter,  	true,    "flet_mgmt_ownr_cust_seq");
					InitDataProperty(0, cnt++ , dtPopup,   		 260,   daLeft,  	false,   "ownr_nm",  					true,          "",      dfNone,  			0,     true,       	true);
					InitDataProperty(0, cnt++ , dtCombo,   		 85,   	daCenter,  	false,   "flet_ownr_tp_cd",     		false,          "",     dfNone,  			0,     false,       false);
					InitDataProperty(0, cnt++ , dtData,   		 130,   daCenter,  	false,   "tax_required",     	 		false,          "",     dfNone,     		0,     false,       false);
					InitDataProperty(0, cnt++ , dtPopupEdit,   	 105,   daCenter,  	false,   "vndr_seq",   					false,          "",      dfUserFormat,   	0,     true,        true, 6);
					InitDataProperty(0, cnt++ , dtData,   		 315,   daLeft,  	false,   "vndr_lgl_eng_nm",     		false,          "",     dfNone,      		0,     false,       false);
					InitDataProperty(0, cnt++ , dtCheckBox,  	 30,    daCenter,   false,   "SaveChk");
					InitDataProperty(0, cnt++ , dtHidden,   		 315,   daLeft,  	false,   "ownr_seq",     		false,          "",     dfNone,      		0,     false,       false);
...
//             }
 	...
 	function sheet1_OnSearchEnd(sheetObj, ErrMsg) {
 		ComColFontName(sheetObj, "cust_cnt_cd", "Courier New"); 	
	}	
	...
	function setOwnerName(aryPopupData, Row, Col, sheetIdx){
		...
		sheetObjects[0].CellValue2(Row,"flet_mgmt_ownr_cust_seq") = aryPopupData[0][3];
