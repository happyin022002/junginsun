...
<%@ page import="com.hanjin.apps.alps.esm.fms.timecharterinoutaccounting.tcharteriobasicregister.event.EsmFms0084Event"%>
...
<html>
<head>
<title>E-mail List Select</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;E-mail List Select </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		<table class="search"> 
       		<tr><td class="bg">
