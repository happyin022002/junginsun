...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class Item Name : Item Name 을 조회하기 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */	

	function ESM_FMS_0076() {
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++, 	dtCheckBox,  	0,    	daCenter,  	false,   	"checkbox",   	false,      "",     dfNone,   		0,     		true,       true);
					InitDataProperty(0, cnt++ , dtData,			390,	daLeft,     false,    	"acct_itm_nm",	false);
					InitDataProperty(0, cnt++ , dtData,   		70,		daCenter,   false,    	"acct_cd",		false);														 
					InitDataProperty(0, cnt++ , dtHidden,		00,		daCenter,   false,    	"acct_itm_seq");
               }
                break;
        }
    }
