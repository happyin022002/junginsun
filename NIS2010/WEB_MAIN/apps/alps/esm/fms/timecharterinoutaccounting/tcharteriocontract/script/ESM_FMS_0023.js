...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class Contract No : Contract No를 조회하기 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */	

	function ESM_FMS_0023() {
            ...
            case 1:      //t1sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    var HeadTitle = "||Vessel Code|Contract No.|Vessel Name|Ctrt Type";
                    ...
                    InitDataProperty(0, cnt++, 	dtDummyCheck,  	30,    	daCenter,  	false,    	"check_no",   		false,      "",     dfNone,   		0,     		true,       true);
                    //InitDataProperty(0, cnt++, 	dtCheckBox,  	30,    	daCenter,  	false,    	"check_no",   		false,      "",     dfNone,   		0,     		true,       true);
                    InitDataProperty(0, cnt++ , dtData,    		94,    	daCenter,  	true,    	"vsl_cd",     		false,      "",     dfNone,      	0,     		false,      false);
                    InitDataProperty(0, cnt++ , dtData,      	180,    daCenter,  	false,     	"flet_ctrt_no",     false,      "",     dfNone,      	0,     		false,      false);
                    InitDataProperty(0, cnt++ , dtData,      	180,    daLeft,  	false,     	"vsl_eng_nm",     	false,      "",     dfNone,      	0,     		false,      false);
                    InitDataProperty(0, cnt++ , dtHidden,      	180,    daCenter,  	false,     	"flet_ctrt_tp_cd",  false,      "",     dfNone,      	0,     		false,      false);
