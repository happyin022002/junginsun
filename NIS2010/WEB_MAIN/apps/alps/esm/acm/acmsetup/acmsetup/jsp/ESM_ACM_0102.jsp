...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmsetup.acmsetup.event.EsmAcm0002Event"%>
...
<input type="hidden" name="flag" value="<%=sflag%>">
<!-- 개발자 작업 --> 
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <td class="title"><img src="img/ico_t1.gif" width="20" height="12">Container TP/SZ Selection</td>
      </table>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table  border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td style="color:#532FC3; font-weight:bold;padding-left:0px;"><input type="radio" class="trans" name="grp_idv_div"<% if (request.getParameter("flag") != null) out.println("checked"); %>>By Container Group</td>
              </tr>
            </table>
            ...
            <!-- biz_2 (S) -->
            <table border="0" cellpadding="0" cellspacing="0" <% if (request.getParameter("flag") != null) out.println("style='display:none;'"); %>>
              <tr>
                <td style="color:#532FC3; font-weight:bold;padding-left:0px;"><input type="radio" class="trans" name="grp_idv_div">By Individual TP/SZ</td>
              </tr>
            </table>
...
<% if (request.getParameter("flag") == null) { %>
            <table class="search" border="0">
              <tr>
                <td class="gray_tit" style="font-weight:bold; padding:10px 0px 5px 3px;">Selected TP/SZ</td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="gray_tit" style="font-weight:bold; padding:10px 0px 5px 3px;">Container TP/SZ Code</td>
              </tr>
              <tr>
                <td style="padding-left:2px;">
                  <!-- Grid_2 (S) -->
