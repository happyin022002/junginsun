...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmsetup.acmsetup.event.EsmAcm0038Event"%>
<%@ page import="com.hanjin.bizcommon.util.BizComUtil"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
  EsmAcm0038Event event = null;        //PDTO(Data Transfer Object including Parameters)
  ...
  try {
    ...
    event = (EsmAcm0038Event)request.getAttribute("Event");
...
<html>
<head>
<title>Other Feederage Deduction Setting</title>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>POL&nbsp;
                  <select name="pol_cd1" style="width:100; display:none;"></select><input name="pol_cd" type="text"  dataformat="engup" maxlength="5" style="width:100; text-align:center;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                POD&nbsp;
                  <select name="pod_cd1" style="width:100; display:none;"></select><input name="pod_cd" type="text" dataformat="engup" maxlength="5" style="width:100; text-align:center;">
                </td>
              </tr>
