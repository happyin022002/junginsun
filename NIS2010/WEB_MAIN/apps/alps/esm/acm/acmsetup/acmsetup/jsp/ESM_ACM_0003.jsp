        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table class="search" border="0">
              <tr>
                <td class="title_h"></td>
                <td class="title_s">Charge Code Selection</td>
              </tr>
            </table>
            ...
            <table class="search" border="0">
              ...
              <tr>
                <td><textarea name="slct_rep_chg" style="width:459px; height:34" class="input2" readOnly></textarea></td>
                <td><textarea name="slct_charge" style="width:484px; height:34" class="input2" readOnly></textarea></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="3" class="accent1" style="font-weight:bold; padding:5px 0px 5px 0px;">※ Charge under the selected Rep. Charge will not be displayed on [User Set List].</td>
              </tr>
            </table>
            <!-- biz_2 (E) -->
