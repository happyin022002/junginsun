...
<html>
<head>
<title>Container TP/SZ Grouping</title>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table class="search" border="0">
              <tr>
                <td class="title_h"></td>
                <td class="title_s">User Set List</td>
              </tr>
            </table>
            <!-- Grid_1 (S) -->
            ...
            <table class="search" border="0">
              <tr>
                <td class="title_h"></td>
                <td class="title_s">Container TP/SZ Code Selection</td>
              </tr>
            </table>
            ...
            <table class="search" border="0">
              ...
              <tr>
                <td><textarea name="slct_tpsz" style="width:975px; height:34" class="input2" readOnly></textarea></td>
              </tr>
              <tr>
