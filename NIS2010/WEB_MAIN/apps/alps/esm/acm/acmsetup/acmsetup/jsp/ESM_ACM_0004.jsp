...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmsetup.acmsetup.event.EsmAcm0004Event"%>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>RHQ&nbsp;
                  <select name="rhq_cd_disp" style="width:100; display:none;"></select><input name="rhq_cd" type="text" class="input2" style="width:100; text-align:center;" readOnly>
                </td>
              </tr>
            </table>
            <!-- biz_1 (E) -->
