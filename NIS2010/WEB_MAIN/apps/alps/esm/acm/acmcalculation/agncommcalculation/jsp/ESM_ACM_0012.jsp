...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmcalculation.agncommcalculation.event.EsmAcm0012Event"%>
...
<html>
<head>
<title>Agent Commission Mass Calculation</title>
                      ...
                      <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                          <tr class="h23">
                            ...
                            <td style="padding-right:6px"><%=JSPUtil.getCodeCombo("vvd_div", "", "tabindex='7' style='width:125px;'", "CD03024", 0, "")%></td>
<!----------------------------------------------------------------->
                            <!-- Memo Sheet (S) -->
                ...
                <td width="50%" valign="top">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr class="h23">
                      ...
                      <td>Office&nbsp;
                        <%=JSPUtil.getCodeCombo("ofc_div", "", "tabindex='4' caption='Office' style='width:100px;'", "CD03036", 0, " ")%>
                        <%=JSPUtil.getCodeCombo("port_div", "", "tabindex='4'  caption='Route' style='width:70px;'", "CD01773", 0, " ")%></td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      <td class="btn1_left">
                      <td class="btn1" name="btn_search">Calculation Target Search</td>
                      <td class="btn1_right">
                    </tr>
                  </table>
                </td>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr class="h23">
                      <td>Total Target Bookings&nbsp;
                        <input name="ttl_bkg" type="text" tabindex="5" class="input2" style="width:120px; text-align:right;" readOnly>&nbsp;</td>
                      <td>
                        <table border="0" cellpadding="0" cellspacing="0" class="button">
                          <tr>
                            <td class="btn2_left"></td>
                ...
                <td>
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr class="h23">
                      ...
                      <td><input name="clc_rmk" type="text" maxlength="500" caption="Calculation Remark" class="input1" style="width:500px; ime-mode:disabled;" tabindex="5"></td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      <td class="btn1_left">
                      <td class="btn1" name="btn_start_clc">Start Mass Calculation</td>
                      <td class="btn1_right">
                    </tr>
                  </table>
                </td>
