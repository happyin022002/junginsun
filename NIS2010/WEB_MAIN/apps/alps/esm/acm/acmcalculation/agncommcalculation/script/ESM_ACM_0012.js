...
//                if (!ComChkValid(frmObj)) return;
                ...
                shtObj.DoSearch("ESM_ACM_0012GS.do", FormQueryString(frmObj));
            ...
            case IBSAVE:      //저장
                ...
                if (rArray != null) {
                    ...
                    shtObj.LoadSaveXml(shtObj.GetSaveXml("ESM_ACM_0012GS.do", FormQueryString(frmObj)));
                    ComOpenWait(false);
                }
             ...
             case MULTI01:  // Add Batch
                 ...
                 if(frmObj.agn_agmt_no.value == "" || frmObj.agn_agmt_no.value.length != 9) {
                  	ComShowCodeMessage("COM12114", " 'Agreement No'");
                  	return;
                  }
                 ComOpenWait(true);
