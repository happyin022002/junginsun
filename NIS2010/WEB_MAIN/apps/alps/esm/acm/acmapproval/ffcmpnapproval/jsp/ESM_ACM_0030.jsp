...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmapproval.ffcmpnapproval.event.EsmAcm0030Event"%>
              ...
              <tr>
                ...
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      <td class="btn1_left"></td>
                      <td class="btn1" name="btn_approval">Approval Request</td>
                      <td class="btn1_right"></td>
                    </tr>
                  </table>
                </td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>Interface Status&nbsp;
                  <%=JSPUtil.getCodeCombo("if_opt", "", "tabindex='1' style='width:90px;'", "CD03071", 0, "")%>&nbsp;
                </td>
              </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>Date&nbsp;&nbsp;&nbsp;
                  <%=JSPUtil.getCodeCombo("date_div", "", "tabindex='4' style='width:80px;'", "CD03094", 0, "")%>&nbsp;
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>Invoice Date&nbsp; <input type="text" class="input1" style="width: 85" maxlength="8" dataformat="ymd" OnBeforeDeactivate="ComAddSeparator(this)" OnBeforeActivate="ComClearSeparator(this)" name="inv_dt">
      ...
      <table class="search">
        <tr class="h23">
          <td class="bg" valign="top">
            ...
            <img src="img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">Detail
            <table width="100%" id="mainTable">
              <tr>
