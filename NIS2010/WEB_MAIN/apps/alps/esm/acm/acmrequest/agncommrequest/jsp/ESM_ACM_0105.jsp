...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmrequest.agncommrequest.event.EsmAcm0105Event"%>
...
<html>
<head>
<title>Calculation Detail</title>
...
<input type="hidden" name="brkg_flg" value="<%=JSPUtil.getParameter(request, "brkg_flg")%>">
<input type="hidden" name="crs_flg" value="<%=JSPUtil.getParameter(request, "crs_flg")%>">
<input type="hidden" name="brkg_ddct_chg_amt" value="<%=JSPUtil.getParameter(request, "brkg_ddct_chg_amt")%>">
<input type="hidden" name="crs_ddct_chg_amt" value="<%=JSPUtil.getParameter(request, "crs_ddct_chg_amt")%>">
<input type="hidden" name="ddct_chg_amt" value="<%=JSPUtil.getParameter(request, "ddct_chg_amt")%>">
<input type="hidden" name="brkg_ddct_trsp_amt" value="<%=JSPUtil.getParameter(request, "brkg_ddct_trsp_amt")%>">
<input type="hidden" name="crs_ddct_trsp_amt" value="<%=JSPUtil.getParameter(request, "crs_ddct_trsp_amt")%>">
<input type="hidden" name="ddct_trsp_amt" value="<%=JSPUtil.getParameter(request, "ddct_trsp_amt")%>">
<input type="hidden" name="brkg_post_rev_amt" value="<%=JSPUtil.getParameter(request, "brkg_post_rev_amt")%>">
<input type="hidden" name="crs_post_rev_amt" value="<%=JSPUtil.getParameter(request, "crs_post_rev_amt")%>">
<input type="hidden" name="post_rev_amt" value="<%=JSPUtil.getParameter(request, "post_rev_amt")%>">
<input type="hidden" name="brkg_crnt_rev_amt" value="<%=JSPUtil.getParameter(request, "brkg_crnt_rev_amt")%>">
<input type="hidden" name="crs_crnt_rev_amt" value="<%=JSPUtil.getParameter(request, "crs_crnt_rev_amt")%>">
<input type="hidden" name="crnt_rev_amt" value="<%=JSPUtil.getParameter(request, "crnt_rev_amt")%>">
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Calculation Detail</td></tr>
      </table>
      <!-- Page Title (E) -->
                ...
                <tr>
                  <td class="bg" valign="top">
                    ...
                    <table width="402" id="mainTableB2S1">
                      ...
                      <tr class="h23">
                        <td align="right" style="padding:5px 3px 10px 0px;">Total Charge Deduction&nbsp;<input name="ttl_chr_ddc" type="text" class="input2" style="width:100px; text-align:right;"  value="" readOnly>&nbsp;USD</td>
                      </tr>
                    </table>
                    <!-- Grid (E) -->
          ...
          <tr>
            <td height="425" colspan="3" valign="top">
              ...
              <table class="search" border="0">
                <tr>
                  <td class="title_h"></td>
                  <td class="title_s"><%=JSPUtil.getParameter(request, "generalBrkg")%></td>
                </tr>
              </table>
              ...
              <table class="search">
                <tr>
                  <td class="bg" valign="top">
                    ...
                    <!-- Grid (S) -->
                    <table width="100%" id="mainTableB3S4">
                      <tr>
                        <td width="100%"><script language="javascript">ComSheetObject("box3sheet4");</script></td>
                      </tr>
                    </table>
                    <!-- Grid (E) -->
