...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmsimulation.acmsimulation.event.EsmAcm0115Event"%>
...
<html>
<head>
<title>Simulation Agreement Copy From</title>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
          <td class="title"><img src="img/ico_t1.gif" width="20" height="12">Simulation Agreement Copy From</td>
        </tr>
      </table>
      <!-- Page Title, Historical (S) -->
