...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmmaster.acmchinaofficeinfo.event.EsmAcm0007Event"%>
...
<html>
<head>
<title>O/B Booking Office Info for China</title>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>A/R Office&nbsp;
                  <select name="finc_ofc_cd" style="width:100;"></select>
                </td>
              </tr>
            </table>
