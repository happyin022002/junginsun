...
* 2012.05.03 김상수
* 1.0 Creation
* 2013.06.04 박다은 [CHM-201324844] FF code 중복 체크 로직 변경 요청
* 2013.10.08 박다은 [선처리] FF Compensation Exclusion Setting 입력 로직 변경 요청
=========================================================*/
/****************************************************************************************
    ...
    function doActionIBSheet(shtObj, frmObj, sAction, CondParam, PageNo) {
        switch (sAction) {
            ...
            case IBSEARCH:       // 조회
                ...
                shtObj.DoSearch("ESM_ACM_0020GS.do", FormQueryString(frmObj));
                ComOpenWait(false);
                break;
        ...
        with (shtObj) {
            switch (ColSaveName(Col)) {
                ...
                case "ff_cnt_seq": 
                    ...
                    //[CHM-201324844] FF code중복 체크 로직 변경 요청
                    // Duplication check
//                    var xmlStr0 = shtObj.GetSearchXml("ESM_ACM_0020GS.do", "f_cmd=" + SEARCH01 + "&ff_cnt_seq=" + Value);
...
//                    }
                ...
                case "shpr_cnt_seq":
                    ...
                    if (ACMDecideErrXml(shtObj, xmlStr)) {
                        ...
                        var custCntCd = ComGetEtcData(xmlStr, "cust_cnt_cd");
                          //[선처리] FF Compensation Exclusion Setting 입력 로직 변경 요청
//                        // COSTOMER의 COUNTRY CODE가 form.ff_cnt_cd와 다를경우 Error
//                        if (custCntCd != undefined && custCntCd != document.form.ff_cnt_cd.value) {
//                            ComShowCodeMessage("ACM00003", "Country Code of Customer Code [" + Value + "]", "Customer Code");
//                            Cellvalue2(Row, "shpr_lgl_eng_nm") = "";
