...
/* 개발자 작업 */
        ...
        try {
            ...
            switch (srcName) {
                ...
                case "btn_cust_popup":
                    ...
                    ComOpenPopup("COM_ENS_041.do", 775, 445, "setPopupData_custCntSeq", "1,0,1,1,1,1,1", true);
                    break;
    ...
    function initSheet(shtObj, shtNo) {
        ...
        with (shtObj) {
            ...
            InitDataProperty(0, cnt++, dtPopupEdit,  120,    daCenter,    false,    "cust_cnt_seq",    true,     "",    dfNone,    0,    true,     true,    8,    true);
            ...
            InitDataProperty(0, cnt++, dtHidden,     80,     daCenter,    false,    "org_cust_seq");
            ...
            // 입력제한
            InitDataValid(0, "cust_cnt_seq", vtEngUpOther, "1234567890");    // 영대문자+숫자만
    ...
    function doActionIBSheet(shtObj, frmObj, sAction, CondParam, PageNo) {
        switch (sAction) {
            ...
            case IBSEARCH:       // 조회
                ...
                shtObj.DoSearch("ESM_ACM_0022GS.do", FormQueryString(frmObj));
                ComOpenWait(false);
                break;
