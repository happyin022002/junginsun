...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.event.EsmAcm0022Event"%>
...
<html>
<head>
<title>Customer-Vendor Match for Special Compensation</title>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table align="left" border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td>AGMT Customer&nbsp;
                  <input name="cust_cnt_seq" type="text" dataformat="engup" maxlength="8" style="width:100px;text-align:center;">
                  <img name="btn_cust_popup" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" style="cursor:hand;">
                </td>
              </tr>
            </table>
            <!-- biz_1 (E) -->
