    ...
    function doActionIBSheet(shtObj, frmObj, sAction, CondParam, PageNo) {
        switch (sAction) {
            ...
            case IBSEARCH:
                ...
                shtObj.DoSearch("ESM_ACM_0001GS.do", FormQueryString(frmObj));    // *** ESM_ACM_0001GS.do를 호출 **** //
                ComOpenWait(false);
                break;
            ...
            case MULTI:
                ...
                ComOpenWait(true);
                shtObj.LoadSaveXml(shtObj.GetSaveXml("ESM_ACM_0101GS.do", saveParam));
                ComOpenWait(false);
                break;
        }
    }
            ...
            switch (elementName) {
                ...
                case "dir_agmt_no":
                    if (dir_agmt_no.value.length > 8) {
                        // validation
                        var xmlStr = shtObj.GetSearchXml("ESM_ACM_0101GS.do", "f_cmd=" + SEARCH02 + "&agn_agmt_no=" + dir_agmt_no.value);
