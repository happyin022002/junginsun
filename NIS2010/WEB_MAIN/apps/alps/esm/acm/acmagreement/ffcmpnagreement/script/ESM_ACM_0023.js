...
//        try {
            ...
            switch (srcName) {
                ...
                case "btn_add":
                    ...
                    shtObj.CellValue(newRow, "por_rout_cd") = "*";
                    shtObj.CellValue(newRow, "pol_rout_cd") = "*";
                    shtObj.CellValue(newRow, "pod_rout_cd") = "*";
                    shtObj.CellValue(newRow, "fm_eff_dt") = "20000101";
                    shtObj.CellValue(newRow, "to_eff_dt") = "29991231";
                    shtObj.CellValue(newRow, "sc_no") = "*";
                    shtObj.CellValue(newRow, "rfa_no") = "*";
                    shtObj.CellValue(newRow, "cmdt_cd") = "*";
        ...
        with (shtObj) {
            switch (shtObj.id) {
                ...
                case "sheet1":
                    ...
                    InitDataProperty(0, cnt++ , dtPopupEdit,  90,    daCenter,   false,    "ff_cnt_seq",   	   	  true,     "",         dfNone,          0,     true,      true,       8);
                    InitDataProperty(0, cnt++ , dtData,       180,   daLeft,     false,    "ff_cnt_cust_nm",   	  false,    "",         dfNone,          0,     false,      false);
                    ...
                    InitDataProperty(0, cnt++ , dtPopupEdit,  90,    daCenter,   false,    "sc_no",               false,    "",         dfNone,          0,     true,       true,       9);
                    InitDataProperty(0, cnt++ , dtPopupEdit,  90,    daCenter,   false,    "rfa_no",              false,    "",         dfNone,          0,     true,       true,       11);
                    ...
                    InitDataProperty(0, cnt++ , dtCombo,      160,   daCenter,   false,    "ff_div_cd",           false,    "",         dfNone,          0,     true,       true);
                    InitDataProperty(0, cnt++ , dtHidden,     70,    daCenter,   false,    "ff_bkg_rt1",          false,    "",         dfNone,          0,     true,       true);
                    InitDataProperty(0, cnt++ , dtData,       70,    daRight,    false,    "ff_bkg_rt",           false,    "",         dfFloat,         3,     true,       true,       15);
                    InitDataProperty(0, cnt++ , dtData,       70,    daRight,    false,    "ff_bx_amt",           false,    "",         dfFloat,         3,     true,       true,       15);
                    InitDataProperty(0, cnt++ , dtData,       70,    daRight,    false,    "ff_teu_amt",          false,    "",         dfFloat,         3,     true,       true,       15);
                    InitDataProperty(0, cnt++ , dtData,       70,    daRight,    false,    "ff_feu_amt",          false,    "",         dfFloat,         3,     true,       true,       15);
                    InitDataProperty(0, cnt++ , dtData,       70,    daRight,    false,    "ff_rf_amt",           false,    "",         dfFloat,         3,     true,       true,       15);
                    InitDataProperty(0, cnt++ , dtData,       130,   daLeft,     false,    "ff_chg_ctnt",         false,    "",         dfNone,          0,     true,       true,       50);
                    InitDataProperty(0, cnt++ , dtHidden,      0,    daCenter,   false,    "ff_agmt_seq",         false,    "",         dfNone,          0,     false,      false);
                    InitDataProperty(0, cnt++ , dtHidden,      0,    daCenter,   false,    "ff_cnt_cd",           false,    "",         dfNone,          0,     false,      false);
                    InitDataProperty(0, cnt++ , dtHidden,      0,    daCenter,   false,    "ff_seq",              false,    "",         dfNone,          0,     false,      false);
                    ...
                    InitDataCombo(0, "ff_div_cd", "|" + ffDivCdText, "|" + ffDivCdCode, "");

                    //Validation 체크
                    InitDataValid(0, "ff_cnt_seq", vtEngUpOther, "0123456789");	// 영대문자, 숫자만 입력되도록 설정
                    ...
                    InitDataValid(0, "ff_chg_ctnt", vtEngUpOther, ","); // 영대문자, 콤마(,) 만 입력되도록 설정

                    ColIndent("ff_cnt_cust_nm") = 2;
                    ColIndent("shpr_cnt_nm") = 2;
    ...
    function doActionIBSheet(shtObj, frmObj, sAction, CondParam, PageNo) {
        switch (sAction) {
            ...
            case IBSEARCH:    // 조회(Master)
                ...
                shtObj.DoSearch("ESM_ACM_0023GS.do", FormQueryString(frmObj));
                ComOpenWait(false);
                break;
            ...
            switch (ColSaveName(Col)) {
                ...
                case "ff_cnt_seq":
                    ...
                    if (ACMDecideErrXml(shtObj, xmlStr)) {
                        ...
                        CellValue2(Row, "ff_cnt_cust_nm") = ComGetEtcData(xmlStr, "cust_lgl_eng_nm");
                    }
                    break;
                ...
                case "ff_div_cd":
                    if (Value == "BF" || Value == "BA") {
                        CellValue2(Row, "ff_bx_amt") = 0;
                        CellValue2(Row, "ff_teu_amt") = 0;
                        CellValue2(Row, "ff_feu_amt") = 0;
                        CellValue2(Row, "ff_rf_amt") = 0;
                        CellValue2(Row, "ff_chg_ctnt") = "";

                        CellEditable(Row, "ff_bkg_rt") = true;
                        CellEditable(Row, "ff_bx_amt") = false;
                        CellEditable(Row, "ff_teu_amt") = false;
                        CellEditable(Row, "ff_feu_amt") = false;
                        CellEditable(Row, "ff_rf_amt") = false;
                        CellEditable(Row, "ff_chg_ctnt") = false;
                    } else if (Value == "BS") {
                        CellValue2(Row, "ff_bx_amt") = 0;
                        CellValue2(Row, "ff_teu_amt") = 0;
                        CellValue2(Row, "ff_feu_amt") = 0;
                        ...
                        CellEditable(Row, "ff_feu_amt") = false;
                        CellEditable(Row, "ff_rf_amt") = false;
                        CellEditable(Row, "ff_chg_ctnt") = true;
                    } else if (Value == "CA") {
                        CellValue2(Row, "ff_bkg_rt") = 0;
                        CellValue2(Row, "ff_teu_amt") = 0;
                        CellValue2(Row, "ff_feu_amt") = 0;
                        CellValue2(Row, "ff_rf_amt") = 0;
                        CellValue2(Row, "ff_chg_ctnt") = "";

                        CellEditable(Row, "ff_bkg_rt") = false;
                        CellEditable(Row, "ff_bx_amt") = true;
                        CellEditable(Row, "ff_teu_amt") = false;
                        CellEditable(Row, "ff_feu_amt") = false;
                        CellEditable(Row, "ff_rf_amt") = false;
                        CellEditable(Row, "ff_chg_ctnt") = false;
                        ...
                        CellEditable(Row, "ff_bkg_rt") = false;
                        CellEditable(Row, "ff_bx_amt") = false;
                        CellEditable(Row, "ff_teu_amt") = true;
                        CellEditable(Row, "ff_feu_amt") = true;
                        CellEditable(Row, "ff_rf_amt") = true;
                        CellEditable(Row, "ff_chg_ctnt") = false;
                    }
                    break;
    ...
    function sheet1_OnSearchEnd(shtObj, ErrMsg) {
        ...
        with (shtObj) {
            for(var i=1; i<=shtObj.LastRow; i++) {
                if (shtObj.CellValue(i, "ff_div_cd") == "BA" || shtObj.CellValue(i, "ff_div_cd") == "BF") {
                    shtObj.CellValue2(i, "ff_bx_amt") = 0;
                    shtObj.CellValue2(i, "ff_teu_amt") = 0;
                    shtObj.CellValue2(i, "ff_feu_amt") = 0;
                    shtObj.CellValue2(i, "ff_rf_amt") = 0;
                    shtObj.CellValue2(i, "ff_chg_ctnt") = "";

                    shtObj.CellEditable(i, "ff_bkg_rt") = true;
                    shtObj.CellEditable(i, "ff_bx_amt") = false;
                    shtObj.CellEditable(i, "ff_teu_amt") = false;
                    shtObj.CellEditable(i, "ff_feu_amt") = false;
                    shtObj.CellEditable(i, "ff_rf_amt") = false;
                    shtObj.CellEditable(i, "ff_chg_ctnt") = false;
                } else if (shtObj.CellValue(i, "ff_div_cd") == "BS") {
                    shtObj.CellValue2(i, "ff_bx_amt") = 0;
                    shtObj.CellValue2(i, "ff_teu_amt") = 0;
                    shtObj.CellValue2(i, "ff_feu_amt") = 0;
                    shtObj.CellValue2(i, "ff_rf_amt") = 0;
                    ...
                    shtObj.CellEditable(i, "ff_feu_amt") = false;
                    shtObj.CellEditable(i, "ff_rf_amt") = false;
                    shtObj.CellEditable(i, "ff_chg_ctnt") = true;
                } else if (shtObj.CellValue(i, "ff_div_cd") == "CA") {
                    shtObj.CellValue2(i, "ff_bkg_rt") = 0;
                    CellValue2(i, "ff_teu_amt") = 0;
                    shtObj.CellValue2(i, "ff_feu_amt") = 0;
                    shtObj.CellValue2(i, "ff_rf_amt") = 0;
                    shtObj.CellValue2(i, "ff_chg_ctnt") = "";

                    shtObj.CellEditable(i, "ff_bkg_rt") = false;
                    shtObj.CellEditable(i, "ff_bx_amt") = true;
                    shtObj.CellEditable(i, "ff_teu_amt") = false;
                    shtObj.CellEditable(i, "ff_feu_amt") = false;
                    shtObj.CellEditable(i, "ff_rf_amt") = false;
                    shtObj.CellEditable(i, "ff_chg_ctnt") = false;
                } else if (shtObj.CellValue(i, "ff_div_cd") == "CS") {
                    shtObj.CellValue2(i, "ff_bkg_rt") = 0;
                    shtObj.CellValue2(i, "ff_bx_amt") = 0;
                    shtObj.CellValue2(i, "ff_chg_ctnt") = "";
                    ...
                    shtObj.CellEditable(i, "ff_bkg_rt") = false;
                    shtObj.CellEditable(i, "ff_bx_amt") = false;
                    shtObj.CellEditable(i, "ff_teu_amt") = true;
                    shtObj.CellEditable(i, "ff_feu_amt") = true;
                    shtObj.CellEditable(i, "ff_rf_amt") = true;
                    shtObj.CellEditable(i, "ff_chg_ctnt") = false;
                }
                shtObj.RowStatus(i) = "";
            }
