...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmagreement.spclcmpnagreement.event.EsmAcm0025Event"%>
        ...
        <tr>
          <td class="bg" valign="top">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr class="h23">
                <td width="40px">Office</td>
                <td>
                  <select name="spcl_ofc_cd" required caption="Office" class="input1" style="width:100px;" tabindex="1"></select>
                </td>
                <td align="right">Agreement Customer&nbsp;</td>
                <td><input type="text" name="cust_cnt_seq" style="width:100px;ime-mode:disabled;" onKeyPress="ComKeyOnlyAlphabet('uppernum')" maxlength="8">
                  <img class="cursor" name="btn_popup" src="img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle">
                </td>
                <td align="right">Show Deleted Customer&nbsp;</td>
                <td><input type="checkbox" value="Y" name="deleted_customer" class="trans"></td>
              </tr>
            </table>
            <!-- biz_1 (E) -->
