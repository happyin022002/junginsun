...
<%@ page import="com.hanjin.apps.alps.esm.acm.acmaudit.agncommaudit.event.EsmAcm0107Event"%>
...
<%
  ...
  String strUsr_id = "";
  String strUsr_nm = "";
  Logger log = Logger.getLogger("com.hanjin.apps.ACMMaster.AGNCommAgreement");
