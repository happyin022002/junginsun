...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="./img/icon_title_dot.gif" align="absmiddle">&nbsp;VIP Customer Report</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!-- ********************************************************************************************************************** -->
...
<input type="hidden" name="edit_yn" value="<%= edit_yn %>">
			<tr><td valign="top" style="padding-right:5;">	
										...
										<table class="search" border="0" style="width:950;">
											<tr class="h23">
												...
												&nbsp;<input type="text" style="width:25;" class="input1" name="cust_cnt_cd" value=""  maxlength='2'  dataformat='engup' style="ime-mode:disabled">&nbsp;<input type="text" style="width:50;" class="input1" maxlength='6' dataformat='num' name="cust_seq" style="ime-mode:disabled"  value="">&nbsp;<input type="text" style="width:118;" class="input" maxlength='50' dataformat='engup' name="cust_nm" value="" readonly>
												...
												<td width=""><input type="text" style="width:68;" class="input"  name="edi_id" value=""  maxlength='9' dataformat='engupnum' style="ime-mode:disabled">&nbsp;<input type="text" style="width:87;" class="input2" maxlength='50' dataformat='engup' name="edi_gr_cd" value="" readonly>&nbsp;<input type="text" style="width:96;" class="input2"  maxlength='50' dataformat='engup' name="edi_gr_nm" value="" readonly>&nbsp;<img class="cursor" src="./img/btns_search.gif" width="19" height="20" name="btn_Edi_Id" border="0" align="absmiddle"></td>
											</tr>
										</table>				
									</td>
								</tr>
									...
									<td style="padding-top:5px">											
										<table class="search" border="0" style="width:950;"> 
											<tr class="h23">
												...
												<td width=""><input type="text" style="width:20;" class="input"  name="credit" value=""  maxlength='2' dataformat='num' style="ime-mode:disabled"></td>
											</tr>
										</table>				
