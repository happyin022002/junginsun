...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.specialreport.event.EsmBkg0896Event"%>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;My Report Share</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
