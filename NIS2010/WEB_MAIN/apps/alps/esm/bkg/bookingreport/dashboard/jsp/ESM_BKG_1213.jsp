...
EsmBkg1212Event  event = null;					
	...
	try {
		...
		rptFomNo	= request.getParameter("rptFomNo");
		rptFomNm	= request.getParameter("rptFomNm");
		rptFomDesc	= request.getParameter("rptFomDesc");
		checkIbflag	= request.getParameter("checkIbflag");
		//editYn		= "N";
		if (rptId == null){
			rptId 		= "SELHO00011";
			bkgRptKndCd = "V";
...
<input type="hidden" name="f_rptFomNo" value="<%= rptFomNo %>">
<input type="hidden" name="f_rptFomNm" value="<%= rptFomNm %>">
<input type="hidden" name="f_rptFomDesc" value="<%= rptFomDesc %>">
<input type="hidden" name="checkIbflag" value="<%= checkIbflag %>">
<!-- 개발자 작업	-->
...
<tr><td valign="top">
        ...
        <table class="search"  style="width:746;">
            <tr>
                <td class="bg">
                    <table  border="0">
                        <tr>
                        <td width ="90"><b>Report Name </b></td><td><input type="text" name="rptFomNm"  class="input1" value="<%= rptFomNm %>" style ="text-align:center" disabled =true></td><td></td>
                        </tr>
                    </table>
                </td></tr>
        </table>
