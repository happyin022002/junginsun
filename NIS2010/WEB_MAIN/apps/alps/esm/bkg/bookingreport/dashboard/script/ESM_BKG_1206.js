    ...
    case 1: 
        with (sheetObj) {
            ...
            var HeadTitle = "ibflag|Seq|BKG No|Shipper|Consignee|Notify Party|POR|POL|POD|DEL|T.VVD|Current\nLocation|Contact No.|BKG\nStatus|POL ETD|VL Staying Days"
            	 +"|RDN No.|RDN Curr.|RDN Amount"
            	 +"|Customer Advisory\nSent Office|Customer Advisory\nSent ID|Customer Advisory\nSent Date|Customer Advisory\nSent Result"
                 +"|COD\nReason|COD\nRehandling Port|COD\nApproval Result"
            	 ;
            ...
            InitDataProperty(0, cnt++, dtData, 110, daCenter, false, "accr_dt",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 75, daCenter, false, "rdn_no",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 75, daCenter, false, "curr_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 75, daCenter, false, "dr_amt",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 130, daCenter, false, "ntc_snd_ofc_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 130, daCenter, false, "ntc_snd_usr_id",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 130, daCenter, false, "ntc_snd_rqst_dt",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 120, daCenter, false, "ntc_snd_rslt_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 130, daCenter, false, "cod_rqst_rsn_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 130, daCenter, false, "cod_sts_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtHidden, 120, daCenter, false, "cod_rhnd_port_yd_cd",      false,          "",       dfNone,          0,     false,       false);

            if(document.form.f_irr_tp_cd.value == 'rdn' ){
                ColHidden('rdn_no') = false;
                ColHidden('curr_cd') = false;
                ColHidden('dr_amt') = false;
            }else if(document.form.f_irr_tp_cd.value == 'cust_adv_fx_snd' ){
                ColHidden('ntc_snd_ofc_cd') = false;
                ColHidden('ntc_snd_usr_id') = false;
                ColHidden('ntc_snd_rqst_dt') = false;
                ColHidden('ntc_snd_rslt_cd') = false;
            }else if(document.form.f_irr_tp_cd.value == 'cod' ){
                ColHidden('cod_rqst_rsn_cd') = false;
                ColHidden('cod_sts_cd') = false;
                ColHidden('cod_rhnd_port_yd_cd') = false;
            }
