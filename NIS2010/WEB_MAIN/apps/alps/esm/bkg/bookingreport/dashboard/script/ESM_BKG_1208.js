...
function initSheet(sheetObj, sheetNo) {
    ...
    case 1: 
        with (sheetObj) {
            ...
            var HeadTitle = "BKG No|Shipper|Consignee|Notify Party|POR|POL|POD|DEL|T.VVD|Current\nLocation|Contact No.|BKG\nStatus|POL ETD|VL Staying Days"
            	 +"|Dem/Det\nTariff No.|Dem/Det\nCurr.|Dem/Det\nAmount"
                ;
           ...
           // InitDataProperty(0, cnt++, dtHidden, 75, daCenter, false, "s_seq",      false,          "",       dfNone,          0,     false,       false);
            ...
            InitDataProperty(0, cnt++, dtData, 75, daCenter, false, "dmdt_trf_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtData, 75, daCenter, false, "bzc_trf_curr_cd",      false,          "",       dfNone,          0,     false,       false);
            InitDataProperty(0, cnt++, dtData, 75, daCenter, false, "bil_amt",      false,          "",       dfNone,          0,     false,       false);
