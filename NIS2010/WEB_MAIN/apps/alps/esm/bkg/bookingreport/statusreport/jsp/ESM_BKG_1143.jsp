...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.statusreport.event.EsmBkg1143Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="30">VVD</td>
						<td width="110"><input type="text" name="vvd" style="width:80;" value="" dataformat="engupnum" maxlength="9" class="input1"></td>
						<td width="30">POL</td>
						<td width="90"><input type="text" name="pol_cd" style="width:50;" value="" dataformat="engupnum" maxlength="5">&nbsp;<input type="text" name="pol_nod_cd" style="width:20;" value="" dataformat="engupnum" maxlength="2" class="input"></td>
						<td width="30">POD</td>
						<td width="90"><input type="text" name="pod_cd" style="width:50;" value="" dataformat="engupnum" maxlength="5">&nbsp;<input type="text" name="pod_nod_cd" style="width:20;" value="" dataformat="engupnum" maxlength="2" class="input"></td>
