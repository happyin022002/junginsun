...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //t1sheet1 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 37, daCenter, true, "cust_st_nm_s", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 37, daCenter, true, "cust_eori_no_s", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 40, daCenter, true, "cust_tax_id_s", false, "", dfNone, 0, false, true);
			...
			InitDataProperty(0, cnt++, dtData, 37, daCenter, true, "cust_st_nm_c", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 37, daCenter, true, "cust_eori_no_c", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 40, daCenter, true, "cust_tax_id_c", false, "", dfNone, 0, false, true);
			...
			InitDataProperty(0, cnt++, dtData, 37, daCenter, true, "cust_st_nm_n", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 37, daCenter, true, "cust_eori_no_n", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 40, daCenter, true, "cust_tax_id_n", false, "", dfNone, 0, false, true);
	...
	case 2: //t2sheet1 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 110, daCenter, true, "b_usa_cstms_file_no", false, "", dfNone, 0, false, true);
			InitDataProperty(0, cnt++, dtData, 110, daCenter, true, "b_bl_no", false, "", dfNone, 0, false, true);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case COMMAND01: //CODE 조회						
		...
		var searchXml = sheetObj.GetSearchXml("ESM_BKG_1143GS.do", FormQueryString(formObj));
	...
	with (sheetObj) {
		...
		for ( var i = 2; i <= LastRow; i++) {
			...
			if (tabItem == 0) {
				...
				if ("E" == CellValue(i, "cust_st_nm_s")) {
					CellFontColor(i, "cust_st_nm_s") = redColor;
				}
				
				if ("E" == CellValue(i, "cust_eori_no_s")) {
					CellFontColor(i, "cust_eori_no_s") = redColor;
				}
				
				if ("E" == CellValue(i, "cust_tax_id_s")) {
					CellFontColor(i, "cust_tax_id_s") = redColor;
				}
				...
				if ("E" == CellValue(i, "cust_st_nm_c")) {
					CellFontColor(i, "cust_st_nm_c") = redColor;
				}
				
				if ("E" == CellValue(i, "cust_eori_no_c")) {
					CellFontColor(i, "cust_eori_no_c") = redColor;
				}
				
				if ("E" == CellValue(i, "cust_tax_id_c")) {
					CellFontColor(i, "cust_tax_id_c") = redColor;
				}
				...
				if ("E" == CellValue(i, "cust_st_nm_n")) {
					CellFontColor(i, "cust_st_nm_n") = redColor;
				}
				
				if ("E" == CellValue(i, "cust_eori_no_n")) {
					CellFontColor(i, "cust_eori_no_n") = redColor;
				}
				
				if ("E" == CellValue(i, "cust_tax_id_n")) {
					CellFontColor(i, "cust_tax_id_n") = redColor;
				}
				...
				if ("E" == CellValue(i, "cntr_mf_hts")) {
					CellFontColor(i, "cntr_mf_hts") = redColor;
				}
				
				if ("E" == CellValue(i, "cntr_mf_hs")) {
					CellFontColor(i, "cntr_mf_hs") = redColor;
				}
				
				if ("E" == CellValue(i, "cntr_mf_ncm")) {
					CellFontColor(i, "cntr_mf_ncm") = redColor;
				}
