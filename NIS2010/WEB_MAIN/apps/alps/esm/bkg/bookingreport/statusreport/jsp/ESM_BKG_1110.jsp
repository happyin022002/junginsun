...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.statusreport.event.EsmBkg1110Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="35">VVD</td>
					<td width="85">
						<input type="text" name="vvd_cd"  style="width:80;" class="input1" value="" style="ime-mode:disabled" dataformat="engupnum"  caption="VVD" maxlength="9" fullfill required></td> 
					<td width="150">
					...
					<td width="25">POL</td>
					<td width="55"><input type="text" name="pol_cd" style="width:45;" class="input1" value="" style="ime-mode:disabled" dataformat="engupnum"  caption="POL" maxlength="5"  ></td>
					<td width="25">POR</td>
					<td width="55"><input type="text" name="por_cd" style="width:45;" class="input" value="" style="ime-mode:disabled" dataformat="engupnum"  caption="POR" maxlength="5" ></td>  
					...
					<td width="90"><input type="text" name="pre_1_vvd" style="width:80;" class="input" value="" style="ime-mode:disabled" dataformat="engupnum"  caption="Pre VVD" maxlength="9" fullfill></td> 
					<td width="50">Pre POL</td>
					<td width="60"><input type="text" name="pre_1_pol_cd" style="width:50;" class="input" value="" style="ime-mode:disabled" dataformat="engupnum"  caption="Pre POL" maxlength="5" fullfill></td> 
					<td width="36">Yard</td>
