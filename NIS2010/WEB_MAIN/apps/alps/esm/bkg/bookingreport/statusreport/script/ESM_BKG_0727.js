...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_0727 : ESM_BKG_0727 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
         ...
         switch(sheetNo) {
             case 1:      //sheet1 init
                 with (sheetObj) {
					...
					InitDataProperty(0, cnt++ , dtData,  		 95,       	daCenter, 		 true,     "t_vvd",  		false,       "",      dfNone,   		0,     false,		false);
					InitDataProperty(0, cnt++ , dtData,    		 90,    	daCenter, 		 true,     "p_vvd",		false,       "",      dfNone,      	0,     false,		false);
			...
			case IBSEARCH:      //조회
				if(validateForm(sheetObj,formObj,sAction)){
					 formObj.f_cmd.value = SEARCH;
				  	  sheetObj.DoSearch("ESM_BKG_0727GS.do", FormQueryString(formObj)
						+ "&" + ComGetPrefixParam(""));
				}
...
//             }
    ...
    /*
     ...
     function goPrint(){		
   		...
   		var formObj = document.form;
   		var rdPath  = "apps/alps/esm/bkg/bookingreport/statusreport/report/ESM_BKG_5030.mrd";
   		var where   = "";
