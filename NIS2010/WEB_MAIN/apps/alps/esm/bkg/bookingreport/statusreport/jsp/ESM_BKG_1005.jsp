...
<%
	 ...
	 *@FileName : esm_bkg_1005.jsp
	 *@FileTitle : Queue List Message Pop Up
	 *Open Issues :
	 *Change history :
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="./img/icon_title_dot.gif"
					align="absmiddle">&nbsp;Queue List Message</td>
			</tr>
		</table>
		...
		<table class="search">
			<tr>
				...
				<table border="0" style="width: 100%; background-color: white;"
					...
					<tr>
						<td><textarea style="width: 100%" rows="4"><%=message%></textarea></td>
					</tr>
				</table>
