...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.event.EsmBkg0422Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	EsmBkg0422Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0422Event) request.getAttribute("Event");
						...
						<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td class="btn1" name="btn_bkg" id="btn_bkg_c">Go to BKG</td>
...
----------------------------------------------------------------------->
<!-- bkg_no로 바로 조회할 경우, Queue List 조회 용도 -->
