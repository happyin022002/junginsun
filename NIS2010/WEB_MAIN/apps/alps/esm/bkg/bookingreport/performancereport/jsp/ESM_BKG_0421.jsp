<%
	 ...
	 * 1.0 Creation
	 ...
	 2012.03.30 변종건 [CHM-201216845-01] Queue list search date 기능 보완
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.event.EsmBkg0421Event"%>	
<%@ page import="org.apache.log4j.Logger"%>

<%
	EsmBkg0421Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0421Event) request.getAttribute("Event");
...
<input type="hidden" name="com_zoomIn">
	...
	<input type="hidden" name="dpcs_ofc_cd" value="PKGSA">
       	...
       	<tr><td class="bg">
                ...
                <table class="search" border="0" style="width:979;"> 
                    <tr class="h23">
                        ...
                        <td style="padding-left:2px;">
	                        <table border="0">
		                		<tr class="h23">
		                  			...
		                  			<td style="background-color: #E9E9E9; border:1px solid #A3A4C7; padding:3px 10px 3px 3px;">
                        ...
                        <td width="25">SRC</td>
                        <td width=""><script language="javascript">ComComboObject("src_cd",2,80,1,0,1);</script></td>
                ...
                <table class="search" border="0" style="width:979;"> 
                    <tr class="h23">
                        ...
                        <td width="55">RTN OFC</td>
                        <td width=""><input type="text" style="width:60;ime-mode:disabled;margin-right:5px" value=""  name="return_to" maxlength="110" dataformat="engup" class="input"><img src="img/alps/button/btns_multisearch.gif" align="absmiddle"  style="cursor:hand" name="btn_multi_rtn_ofc" id="btn_multi_rtn_ofc"></td>
				...
				<tr class="h23">
					...
					<td width="230">
						...
						<input type="text" style="width: 80;" class="input" dataformat="etc" maxlength="500" name="cust_nm" value="" tabindex="43"></td>
					<td width="60">RTN TYPE</td>
					<td width="90"><select style="width:85;" class="input" name="return_tp_cd">
										<option value=""></option>
										<option value="S,R">FO &lt;&lt;-</option>
										<option value="S,T">FO -&gt;&gt;</option>
										<option value="I,R">Inputter &lt;&lt;-</option>
										<option value="I,T">Inputter -&gt;&gt;</option>
										<option value="R,R">Rater &lt;&lt;-</option>
										<option value="R,T">Rater -&gt;&gt;</option>
										<option value="C,R">Customer &lt;&lt;-</option>
										<option value="C,T">Customer -&gt;&gt;</option>
										<option value="P,R">S.REP &lt;&lt;-</option>
										<option value="P,T">S.REP -&gt&gt;</option>				
							  	   </select>
					</td>
					...
					<td width="120">Set Search&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" name="btn_SRCH_SET" align="absmiddle">&nbsp;<input type="checkbox" value="Y" name="set_slct_flg" class="trans" tabindex="6"></td>
					<td width="30">PIC</td>
					<td width="">
...
<table width="1024" class="button" border="0" cellpadding="0"
	...
	<tr>
		<td class="btn1_bg">
			<table id="div_Fpending" style="display:none" width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				<tr><td class="btn1_left"></td>
				<td class="btn1" name="btn_FPending" id="btn_FPending">F.Pending</td>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td id="div_pic"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn1_left"></td>
						<td class="btn1" name="btn_pic">PIC&nbsp;Change</td>
						<td class="btn1_right"></td>
						</tr>
					</table></td>
					<td id="div_pic"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
...
<div id="divRtnOfcList" style="z-index: 1;top:30px;margin-left:740px; position: absolute; display:none;" >
 	<table width="130" border="0"  cellpadding="0" cellspacing="0" >
		<tr>
			<td width = "100%"><script language="javascript">ComSheetObject('rtnOfcListSheet');</script></td>
		</tr>
	</table> 

	<table width="130" border="0" cellpadding="0" cellspacing="0" class="button">
		<tr><td class="btn2_left"></td>
			<td class="btn2" id="pRtnofc_list_add" name="pRtnofc_list_add">&nbsp;Add&nbsp;</td>
			<td class="btn2_right"></td>
			<td class="btn2_left"></td>
			<td class="btn2" id="pRtnofc_list_del" name="pRtnofc_list_del">Del</td>
			<td class="btn2_right"></td>
			<td class="btn2_left"></td>
			<td class="btn2" id="pRtnofc_list_ok" name="pRtnofc_list_ok">OK</td>
			<td class="btn2_right"></td>
		</tr>
	</table>
</div>		
