...
/**
 * @extends 
 * @class esm_bkg_0463 : esm_bkg_0463 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
	function esm_bkg_0463() {
		...
		switch (sheetNo) {
			case 1: //sheet1 init
				with (sheetObj) {
					...
					prefix = "sheet1_";
					var HeadTitle1 = "Region|Input|Input|Rate|Rate|QA|QA|Total|Total";
					var HeadTitle2 = "Region|Queue|Pending|Queue|Pending|Queue|Pending|Queue|Pending";
					...
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "inp_cnt", 	false, "", dfNone, 0, false, true);
					
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "inp_pnd_cnt",false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "rt_cnt" ,  	false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "rt_pnd_cnt", false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "aud_cnt", 	false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "aud_pnd_cnt",false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "ttl_cnt", 	false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 110, daCenter, false, prefix + "ttl_pnd_cnt",false, "", dfNone, 0, false, true);
			...
			case 2: //sheet2 init
				with (sheetObj) {
					...
					prefix = "sheet2_";
					var HeadTitle1 = "Region|Office|Input|Input|Rate|Rate|QA|QA|Total|Total";
					var HeadTitle2 = "Region|Office|Queue|Pending|Queue|Pending|Queue|Pending|Queue|Pending";
					...
					//데이터속성    [ROW, COL,  DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
					InitDataProperty(0, cnt++, dtData, 90,  daCenter, true,  prefix + "rgn_ofc_cd", false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 90,  daCenter, true,  prefix + "bkg_ofc_cd", false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "inp_cnt", 	false, "", dfNone, 0, false, true);
					
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "inp_pnd_cnt",false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "rt_cnt" ,  	false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "rt_pnd_cnt", false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "aud_cnt", 	false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "aud_pnd_cnt",false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "ttl_cnt", 	false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, prefix + "ttl_pnd_cnt",false, "", dfNone, 0, false, true);
			...
			case 3: //sheet3 init
				with (sheetObj) {
					...
					prefix = "sheet3_";
					var HeadTitle1 = "Seq|Region|Office|BKG No.|SI Transfer Date|Input|Rate|QA|Pending|Return to";
					var HeadTitle2 = "Seq|Region|Office|BKG No.|SI Transfer Date|Input|Rate|QA|Pending|Return to";
					...
					InitDataProperty(0, cnt++, dtData, 140, daCenter, true, prefix + "bkg_no", false, "", dfNone, 0, false, true);
					InitDataProperty(0, cnt++, dtData, 170, daCenter, true, prefix + "sr_wrk_sts_dt", false, "", dfNone, 0, false, true);
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		...
		switch (sAction) {
			case IBCLEAR:
				...
				var sXml = sheetObj.GetSearchXml("ESM_BKG_0463GS.do", FormQueryString(formObj));
			...
			case IBSEARCH: //조회
				...
				var searchXml = sheetObj.GetSaveXml("ESM_BKG_0463GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
