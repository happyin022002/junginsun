...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
     ...
     * @author 한진해운
     * @extends 
     * @class esm_bkg_1073  생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_1073() {
         ...
         switch(sheetObj.id) {
            ...
            case "sheet1":
              ...
              //InitDataProperty(0, cnt++ , dtSeq,					35,		daCenter,		false,		prefix + 	"Seq");
							...
							InitDataProperty(0, cnt++ , dtHidden,       0,	 daCenter,		false,		prefix + "dummy");//POP UP 시 display 값에 따라 히든처리 하나 에러가 있는듯 함                                                           
							InitDataProperty(0, cnt++ , dtRadioCheck,		30,	 daCenter,		false,		prefix + "radio"); 
							InitDataProperty(0, cnt++ , dtData,		     	100, daCenter,		false,		prefix + "grp_id",		false,			"",      dfNone,	0,		false, false); 
							InitDataProperty(0, cnt++ , dtData,		     	100, daLeft,		false,		prefix + "edi_id",		false,			"",      dfNone,	0,		false, false); 
							InitDataProperty(0, cnt++ , dtData,					200, daLeft,		false,		prefix + "grp_nm",		false,			"",      dfNone,	0,		false, false);
							 
							InitDataProperty(0, cnt++ , dtData,					120, daCenter,		false,		prefix + "cfm_flg",		false,			"",      dfNone,	0,		false, false); 
							InitDataProperty(0, cnt++ , dtData,					80,	 daCenter,		false,		prefix + "drf_flg",		false,			"",      dfNone,	0,		false, false); 
							InitDataProperty(0, cnt++ , dtData,					120, daCenter,		false,		prefix + "cgo_flg",		false,			"",      dfNone,	0,		false, false); 
