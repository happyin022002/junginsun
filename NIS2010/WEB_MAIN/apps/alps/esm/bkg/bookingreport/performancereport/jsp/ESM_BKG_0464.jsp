...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.event.EsmBkg0464Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg0464Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0464Event)request.getAttribute("Event");
