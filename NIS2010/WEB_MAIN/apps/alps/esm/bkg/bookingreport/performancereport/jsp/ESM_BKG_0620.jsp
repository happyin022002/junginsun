...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.event.EsmBkg0620Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg0620Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0620Event)request.getAttribute("Event");
	...
	<tr><td valign="top">
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="105">
							<input type="text" name="bkg_ofc_cd" style="width:80;" value="" style="ime-mode:disabled" dataformat="engup"  caption="BKG Office" maxlength="6" >
						</td>
						<td width="65">BKG Staff</td>
						<td width="" align="right">
							<script language="javascript">ComComboObject('bkg_staff',2, 80, 0,0,0,true);</script>
							<!--<input type="text" name="bkg_staff" style="width:80;" value="" style="ime-mode:disabled" dataformat="uppernum"  caption="Yard" maxlength="5" fullfill>
						--></td>
					</tr>
				</table>
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="36">Zone</td>
						<td width="100">
							<script language="javascript">ComComboObject('zone_code', 1, 77, 0,0,0);</script>
						...
						<td width="90">
							<table border="0" style="width:85;" class="search_sm2"> 
							<tr class="h23">
								<td>
						...
						<td width="" align="right" style="padding-left:;5">
							<table border="0" style="width:45;" class="search_sm2"> 
							<tr class="h23">
								<td class="sm">
									<input type="checkbox" name="so_flg" value="Y" class="trans">&nbsp;S/O</td></tr>
							</table>
						</td>
					</tr>
				</table>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="65">EQ OFFICE</td>
						<td width="">
							<input type="text" name="eq_ctrl_ofc_cd" style="width:60;" value="" style="ime-mode:disabled" dataformat="engup"  caption="BKG Office" maxlength="6" ></td>
		...
		<table class="search" id="mainTable"> 
			...
			<tr><td align="center" class="tr2_head">O2</td>
				...
				<td align="center"><input type="text" name="a5" style="width:100%;text-align:right" value="0" class="input2" readonly></td> 
