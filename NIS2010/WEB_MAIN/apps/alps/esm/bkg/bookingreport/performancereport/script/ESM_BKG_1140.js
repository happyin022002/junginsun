...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
     ...
     * @author 한진해운
     * @extends 
     * @class esm_bkg_1140  생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_1140() {
 ...
 /*********************** EDTITABLE MULIT COMBO END********************/ 
    ...
    * */
    ...
    function initControl() {
        ...
        axon_event.addListenerForm('change', 'objChange', formObject ); 
    }        
 ...
 // 버튼 네임으로 구분하여 프로세스를 분기처리하는 이벤트핸들러 */
	     		...
	     		var srcName = window.event.srcElement.getAttribute("name");
		 			...
		 			switch(srcName) {
		 				case "btn_select":
							...
							formObject.wrk_st_tm.value = sheetObject1.CellValue(selectRow, prefix+"wrk_st_tm");
		 				...
		 				case "ui_grp_cd":
		 					...
		 					break;
		 				//2011.11.30 doc. user search popup 추가 kbj
		 				case "btn_search":
		 					try{
		 					var sParam = '?ui_grp_cd='+ComGetObjValue(formObject.ui_grp_cd)+'&ui_rgn_ofc_cd='+ComGetObjValue(formObject.rgn_ofc_cd); 
		 					ComOpenWindowCenter("ESM_BKG_0436.do" + sParam, "ESM_BKG_0436", 600, 470,false);
		 					}catch(e){
   ...
   // Sheet관련 프로세스 처리
     function doActionIBSheet(sheetObj,formObj,sAction,Row,Col,PageNo) {
         ...
         switch(sAction) {
			 			...
			 			case IBSEARCH:      //조회
							...
							var sXml = sheetObj.GetSearchXml("ESM_BKG_1140GS.do", FormQueryString(formObj)+ "&" +  ComGetPrefixParam(prefix));
						...
						case MODIFY01:        //저장
								...
								var sXml = sheetObj.GetSaveXml("ESM_BKG_1140GS.do" , sParam);
     ...
     function sheet1_OnDblClick(sheetObj,rowIdx,colIdx) {
				...
				form.wrk_st_tm.value = sheetObj.CellValue(selectRow, prefix+"wrk_st_tm");
         ...
         switch(sheetObj.id) {
            ...
            case "sheet1":
              with (sheetObj) {
				...
				var HeadTitle1 = "Sel|Status|Work End Date|PIC|PIC ID|Group|";
				...
				InitDataProperty(0,		cnt++ , dtData,			  120,	daCenter,	false,	prefix + "dpcs_wrk_sts",	false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0,		cnt++ , dtData,				  110,	daCenter,	false,	prefix + "dpcs_wrk_dt",			      false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0,		cnt++ , dtData,				  120,	daCenter,	false,	prefix + "usr_nm",			      false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0,		cnt++ , dtData,				  80,	daCenter,	false,	prefix + "usr_id",			      false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0,		cnt++ , dtData,				  60,	daCenter,	false,	prefix + "dpcs_wrk_grp_nm",			      false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0,		cnt++ , dtData,				  60,	daCenter,	false,	prefix + "wrk_st_tm",			      false,		"",		dfNone,			0,		false,		false);
				CountPosition = 0;
