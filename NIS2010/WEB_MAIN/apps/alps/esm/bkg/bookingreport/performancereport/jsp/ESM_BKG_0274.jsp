...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.event.EsmBkg0274Event"%>	
    ...
    <tr><td class="bg">	
		...
		<table class="search" border="0" style="width:979;"> 
			...
			<td>
				...
				<tr class="h23">
					<td width="50">Feeder</td>
					<td class="stm" width="140"><span style="width:55px"><span id="div_pre_post">Pre</span> VVD</span>&nbsp;<input type="text" style="width:75;ime-mode:disabled" class="input" value="" name="fdr_vvd_cd" maxlength='9' dataformat='engupnum'></td>
					<td class="stm" width="140"><span style="width:50px"><span id="div_pre_post">Pre</span> POL</span>&nbsp;<input type="text" style="width:50;" value="" class="input" name="fdr_pol_cd" maxlength='5' dataformat='engup'> <input type="text" style="width:25;" value="" class="input" name="fdr_pol_yd_cd" maxlength='2' dataformat='engupnum'></td>
					<td class="stm" ><span style="width:55px"><span id="div_pre_post">Pre</span> POD</span>&nbsp;<input type="text" style="width:50;" value="" class="input" name="fdr_pod_cd" maxlength='5' dataformat='engup'> <input type="text" style="width:25;" value="" class="input" name="fdr_pod_yd_cd" maxlength='2' dataformat='engupnum'></td>
				</tr>
				</table> 
			</td>
			</tr>
						...
						<tr>
							...
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td class="btn1_left"></td>
										<td class="btn1" name="btn_DownCntr">Down Excel(CNTR)</td>
										<td class="btn1_right"></td>
									</tr>
								</table>
							</td>
