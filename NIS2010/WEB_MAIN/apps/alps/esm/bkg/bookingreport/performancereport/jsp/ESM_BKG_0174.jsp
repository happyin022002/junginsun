...
* 2011.04.08 변종건 [CHM-201109825-01] [BKG] C/A Summary 화면 메뉴 추가 요청
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.event.EsmBkg0174Event"%>
	...
	<!--Page Title, Historical (E)-->
		...
		<table class="search" id="mainTable"> 
			...
			<table class="grid2" border="0">
				<tr><td width="100" class="tr2_head">C/A Reason</td>
					<td width="480" class="stm">
						...
						<input type="checkbox" name="ca_reason_d" value="D" class="trans">D &nbsp;&nbsp;&nbsp;
			...
			<tr class="h23">
				...
				<td width="100">BKG Office</td>
				<td width="100"><input type="text" name="bkg_off" style="width:60" class="input" value="" dataformat="engup" fulfill maxlength="6"></td>
				<td width="70">RHQ</td>
				<td width="130"><script language="javascript">ComComboObject('rhq_cd', 1, 80, '');</script></td>
				<td width="90">DEL Office</td>
				<td width="90"><input type="text" name="del_off" style="width:60" class="input" value="" dataformat="engup" fulfill maxlength="6"></td>
				<td width="90">B.Office GSO</td>
				<td width=""><input type="text" name="gso_ofc_cd" style="width:60" class="input" value="" dataformat="engup" fulfill maxlength="6"></td>
			</tr>
			</table>
			<table class="search" border="0" style="width:100%;"> 
			<tr class="h23">
				...
				<td width="130"><script language="javascript">ComComboObject('dlv_ctnt_cd', 1, 80, '');</script></td>
				<td width="90">C.Office GSO</td>
				<td width="90"><input type="text" name="ctrt_ofc_cd" style="width:60" class="input" value="" dataformat="engup" fulfill maxlength="6"></td>
				<td width="90">C.Sales Rep.</td>
				<td width=""><input type="text" name="ctrt_srep_cd" style="width:60" class="input" value="" dataformat="engupnum" fulfill maxlength="6"></td>
			</tr>
			</table>
			<table class="search" border="0" style="width:100%;"> 
			<tr class="h23">
			...
			<tr class="h23">
				<td width="30">POR</td>
				<td width="80"><input type="text" name="por" style="width:55" class="input" value="" dataformat="engupnum" fulfill maxlength="5"></td>
				<td width="30">POL</td>
				<td width="80"><input type="text" name="pol" style="width:55" class="input" value="" dataformat="engupnum" fulfill maxlength="5"></td>
				<td width="30">POD</td>
				<td width="80"><input type="text" name="pod" style="width:55" class="input" value="" dataformat="engupnum" fulfill maxlength="5"></td>
				<td width="30">DEL</td>
				<td width=""><input type="text" name="del" style="width:55" class="input" value="" dataformat="engupnum" fulfill maxlength="5"></td>
			</tr>
			</table>
			<table class="height_8"><tr><td></td></tr></table>
			<table class="search" border="0">
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_rd">Cor/Inq List Print</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
