...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_0567 : esm_bkg_0567 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_0567() {
    	...
    	try {
			...
			switch(srcName) {
			    ...
			    case "btn_ca_kind_detail": 
			    	ComOpenPopup("ESM_BKG_0758.do?pgmNo=ESM_BKG_0758", 300, 430, "", '1,0,1,1,1', true);
			    	break;
			...
			case "sheet1":      //t4sheet1 init
		        with (sheetObj) {
		           ...
		           //전체Edit 허용 여부 [선택, Default false]
		            ...
		            InitDataProperty(0, cnt++ , dtData,   	    110,  daCenter,  	 false,   "corr_usr_id",           false,    "",      dfNone, 		  0,     false,      false);
        ...
        switch(sAction) {
      	    case IBSEARCH: 
      	    	...
      	    	if (sheetObj.id=="sheet1") {  
					...
					var sXml = sheetObj.GetSearchXml("ESM_BKG_0567GS.do", FormQueryString(formObj)); 
...
//		rdParam    = "/rp ['"+sheetObjects[0].CellValue(arrRow[0], "bkg_no")+"'] ['"+sheetObjects[0].CellValue(arrRow[0], "ca_no")+"']";
		rdParam    = "/rv bkg_no['"+sheetObjects[0].CellValue(arrRow[0], "bkg_no")+"'] ca_no['"+sheetObjects[0].CellValue(arrRow[0], "ca_no")+"']";
