...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingcorrection.codcorrection.event.EsmBkg0981Event"%>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;COD History  </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
