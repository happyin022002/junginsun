...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingcorrection.codcorrection.event.EsmBkg1009Event"%>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;<%if (strIsPop.equals("R")){%>Reject Reason Remarks<%}else{%>COD Remark<%}%></td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!-- : ( Search Options ) (S) -->
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					<td width="100%" align="center"><textarea style="width:100%" rows="5" name="diff_rmk" <%=(strIsPop.equals("R"))? "readOnly":""%>></textarea></td>
				</tr>
				</table>
			</td></tr>
		</table>
