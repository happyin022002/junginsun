...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg0040Event"%>
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="40">Name</td>
					<td width="120"><input type="text" name="scac_nm" style="width:80;" dataformat="engup" class="input" value="" maxlength="14"></td>
					<td width="40">SCAC</td>
					<td width="120"><input type="text" name="scac_cd" style="width:80;" dataformat="engup" class="input" value="" maxlength="4"></td>
					<td width="66">Auto Filer</td>
					<td width="120"><select name="usa_cstms_file_cd" style="width:67;">
					...
					<td width="">
						<input type="text" name="tot_count" style="width:60;" class="input2" value="">						
					</td>
				</tr>
				</table>
