...
* 2015.05.20 조창우
* 1.0 Creation
*참조 : ESM_BKG_1185 VGM CCT Creation
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg1185Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg1185Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1185Event)request.getAttribute("Event");
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="35">POL</td>
					<td width="150"><input type="text" name="loc_cd" dataformat="engup" maxlength="5"  style="width:80;" value="" class="input"></td>
					<td width="35">Lane</td>
