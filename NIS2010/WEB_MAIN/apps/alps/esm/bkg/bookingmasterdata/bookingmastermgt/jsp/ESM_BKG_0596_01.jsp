...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg059601Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg059601Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg059601Event)request.getAttribute("Event");
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="15" class="stm"> 	
					<td width="30" name ="rhq">RHQ</td>
					<td width=""><select name="rhq_ofc_cd" style="width:87;">
						<option value="">ALL</option>
						<option value="NYCRAS">NYCRAS</option>
						<option value="HAMRUS">HAMRUS</option>
						<option value="SINRSS">SINRSS</option>
						<option value="SHARCC">SHARCC</option>
						<option value="TYOSC">TYOSC</option>
						</select></td>
					<td width="15" class="stm"> 		
					<td width="25" name="period">Period</td>
					<td width="10" class="stm">
						<td width="" >
						  <input type="text" style="width:80" value="" class="input1"  name="from_dt"  maxlength='10' dataformat="ymd" >
						 &nbsp;~&nbsp;
		...
		<!--
				...
				<td width="70">VVD BDR</td>
					<td width="80"><input type="hidden" name="vvd_bdr" style="width:40;text-align:center" class="input2" value="" readonly></td>
					<td width="90">Total Booking</td>
					<td width="80"><input type="hidden" name="tot_booking_cnt" style="width:40;text-align:right" class="input2" value="" readonly></td>
					<td width="90">BDR Booking</td>
					<td width=""><input type="hidden" name="btr_booking_cnt" style="width:40;text-align:right" class="input2" value="" readonly></td>
					</tr>
				</table>
			<!-- Grid  (S) -->
