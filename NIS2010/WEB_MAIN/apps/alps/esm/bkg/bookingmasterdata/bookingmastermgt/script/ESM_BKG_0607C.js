	...
	function initSheet(sheetObj, sheetNo) {
		...
		case "sheet1":
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++, dtData, 30, daCenter, false,		prefix + "delt_flg");//2. 추가 - DEL
				...
				InitDataProperty(0, cnt++, dtData, 80, daCenter, false,		prefix + "upd_usr_id", false, "", dfNone, 0, false);   //3. 추가 - User id
				InitDataProperty(0, cnt++, dtData, 75, daCenter, false,		prefix + "ofc_cd", false, "", dfNone, 0, false); //4. 추가 - Office cd
				InitDataProperty(0, cnt++, dtData, 85, daCenter, false,		prefix + "upd_dt", false, "", dfNone, 0, false); //5. 추가 - Update date
