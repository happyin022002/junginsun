 ...
 */
	...
	/**
	 * @extends 
	 * @class esm_bkg_0653 : esm_bkg_0653 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function esm_bkg_0653() {
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case "sheet1": //sheet1 init
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++, dtData, 460, daLeft, false,
						"cmdt_nm", false, "", dfNone, 0, false, false, 80);
				InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "rep_cmdt_cd",
						false, "", dfNone, 0, false, false, 2);
	
				InitDataProperty(0, cnt++, dtData, 55, daLeft, false, "rep_cmdt_nm",
						false, "", dfNone, 0, false, false, 8);
				
				InitDataProperty(0, cnt++, dtHidden, 55, daLeft, false, "rep_imdg_lvl_cd",
						false, "", dfNone, 0, false, false, 8);
		...
		switch (sAction) {
			case IBSEARCH:
				if (validateForm(sheetObj, formObj, sAction)) {
					...
					sheetObj.DoSearch("ESM_BKG_0653GS.do", FormQueryString(formObj)
							+ "&" + ComGetPrefixParam(""));
				}
				break;
			case IBCLEAR:
