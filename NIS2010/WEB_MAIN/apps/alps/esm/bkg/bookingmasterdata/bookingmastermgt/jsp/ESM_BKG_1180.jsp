...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg1180Event"%>
...
<html>
<head>
<title>E-BKG Handling Office Setup</title>
	...
	<table class="search" id="mainTable"> 
      	<tr><td class="bg">
			...
			<tr class="h23">
				...
				<td width="100"><input type="text" name="hndl_ofc_cd" style="width:60;" value="" style="ime-mode:disabled" dataformat="engup" maxlength="6" ></td>
				<td width="40">POL</td>
				<td width="100"><input type="text" name="pol_cd" style="width:60;" value="" style="ime-mode:disabled" dataformat="engup" maxlength="5"  ></td>
				<td width="85">CMDT Desc.</td>
				<td width="290"><input type="text" name="cmdt_nm" style="width:250;" value="" style="ime-mode:disabled" dataformat="engnum" maxlength="100"  ></td>
			</tr> 
			</table> 
