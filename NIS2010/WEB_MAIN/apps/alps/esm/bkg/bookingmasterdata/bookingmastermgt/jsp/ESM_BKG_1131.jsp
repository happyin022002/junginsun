...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg1131Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg1131Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1131Event)request.getAttribute("Event");
...
<html>
<head>
<title>Import Restricted Commodities File Upload</title>
