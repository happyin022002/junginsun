...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg0253Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:959;"> 
					<tr class="h23">
						<td width="35">Port</td>
						<td width="100"><input type="text" name="loc_cd" style="width:60;" value="" style="ime-mode:disabled" dataformat="engup" caption="Port" maxlength="5" fullfill></td>
						<td width="110">Equalization Port</td>
