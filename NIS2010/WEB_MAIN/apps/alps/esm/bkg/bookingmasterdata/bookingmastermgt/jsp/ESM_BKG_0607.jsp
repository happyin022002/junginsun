...
<%
	...
	try {
		...
		hamo_tp_able = JSPUtil.getParameter(request, "hamo_tp_cd");
...
<style type="text/css">
div.mouseView { padding:10px; width:310px; position:absolute; border:2px solid #ccc; font-size:11px; background-color:#fafafa; font-family:Tahoma,verdana,arial,dotum,gulim;}
</style>
...
<input type="hidden" name="hamo_tp_able" value="<%=hamo_tp_able%>">
<!-- 개발자 작업	-->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="150">
						<script language="javascript">ComComboObject('hamo_tp_cd', 1, 60, 0,0,0);</script>
					</td>
					<td width="124"><span id="cd_title">HTS</span> Code</td>
					<td width=""><input type="text" name="hamo_trf_cd" style="width:96;" class="input" value="<%=hamo_trf_cd%>" style="ime-mode:disabled" dataformat="int" caption="Harmonized Tariff Code" maxlength="10"></td>
					<td width=""></td>
				</tr>
				<tr class="h23">
				...
				<tr class="h23">
					...
					<td width="" onmouseover="previewShow(event,this,'t_tip2');">FDA P/N</td>
					<td width="" onmouseover="previewShow(event,this,'t_tip2');">
...
<span style="display:none;"><div id="t_tip2" class="mouseView">FDA P/N : is to check whether importer U.S should declare</br>the commodity to U.S FDA (Food and Drug Administration).</div></span>
</body>
</html>
