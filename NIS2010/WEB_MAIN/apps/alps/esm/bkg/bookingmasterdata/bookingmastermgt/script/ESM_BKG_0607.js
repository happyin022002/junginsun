 ...
 */
	...
	function loadPage() {
		...
		if(document.form.hamo_tp_able.value!=""){
			document.form.hamo_tp_cd.Enable = false;
		}
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case "sheet1":
			with (sheetObj) {
				...
				var HeadTitle1 = "||Seq.|HTS Code|Description|Category|FDA P/N";
				...
				InitDataProperty(0, cnt++, dtData, 80, daCenter, false,
						"hamo_trf_cd", false, "", dfNone, 0, false);
				InitDataProperty(0, cnt++, dtData, 720, daLeft, false,
						"hamo_cd_desc", false, "", dfNone, 0, false);
				
				InitDataProperty(0, cnt++, dtData, 80, daLeft, false,
						"hamo_cate_ctnt", false, "", dfNone, 0, false);
				
				InitDataProperty(0, cnt++, dtData, 80, daCenter, false,
						"fda_decl_flg", false, "", dfNone, 0, false);
	...
	function doActionIBSheet(sheetObj, formObj, sAction, PageNo) {
		...
		case IBSEARCH: //조회
			if (validateForm(sheetObj, formObj, sAction)){
					...
					sheetObj.DoSearch4Post("ESM_BKG_0607GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(""));
			}		
			break;
        ...
        case IBSEARCHAPPEND:  // 페이징 조회
        		...
        		formObj.f_cmd.value = SEARCH;
        		sheetObj.DoSearch4Post("ESM_BKG_0607GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(""), "iPage=" + PageNo, true);
        	break; 
...
//			sheetObj.Down2Excel();
     ...
     */
	 function hamo_tp_cd_OnChange(comboObj,value,text){
		...
		if(hdrGubun == "HS"){
			HeadTitle1 = "||Seq.|HS Code|Description|Category|FDA P/N";
		}else{
			HeadTitle1 = "||Seq.|HTS Code|Description|Category|FDA P/N";
		}
