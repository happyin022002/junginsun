...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg1410Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.List" %>
<%@ page import="com.hanjin.apps.alps.esm.bkg.common.*" %>

<%
	EsmBkg1410Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1410Event)request.getAttribute("Event");
...
<input type="hidden" name="vvd_sig">
...
<table class="search" id="mainTable"> 
    <tr><td class="bg">	
			...
			<tr class="h23">
				<td width=120>BKG Office</td>
				<td width=""><input type="text" name="bkg_ofc_cd"  style="ime-mode:disabled;width:120px;" dataformat="engupnum" class="input"></td>
			</tr>
			</table>
