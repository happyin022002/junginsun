...
<html>
<head>
<title>Dangerous Cargo Filtering Set up</title>
...
<input type="hidden" name="sheet1_port_cd" value="<%= strPort_cd %>">
	...
	<!--Page Title, Historical (S)-->
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
			...
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">  Dangerous Cargo Filtering Set up</td></tr>
		</table>
       	...
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="1000"><select name="blck_kw_tp_cd" style="width:100;" class="input1" id= "blck_kw_tp_cd" onchange="javascript:searchByTpCd(this);">
						<option value="POT" >Prohibited</option>
						<option value="MIS">Mis-declared DG</option>
						</select></td>
				</tr>
				</table>
