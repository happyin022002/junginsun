...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg1215Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.List" %>
<%@ page import="com.hanjin.apps.alps.esm.bkg.common.*" %>

<%
	EsmBkg1215Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1215Event)request.getAttribute("Event");
...
<table class="search" id="mainTable"> 
    <tr><td class="bg">	
			...
			<tr class="h23">
				<td width="50">Type</td>
				<td width="" ><script language="javascript" >ComComboObject('bkg_aloc_tp_cd', 1, 100, 1, 0)</script></td>
