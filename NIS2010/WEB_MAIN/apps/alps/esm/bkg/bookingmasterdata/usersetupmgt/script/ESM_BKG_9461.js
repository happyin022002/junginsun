...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_9461 : esm_bkg_9461 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_9461() {
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
                 ...
                 //   InitColumnInfo(17, 0, 0, true);
                    ...
                    var HeadTitle1 = "|Del.|Sel.|||Customer Code|Customer Code";
					...
					InitDataProperty(0, cnt++ , dtHidden,  		  	35,     daCenter,  	true,   "usr_id"	,   	false,          "",      dfNone,      	0,     true,       true);
					InitDataProperty(0, cnt++ , dtHidden,  		  	35,     daCenter,  	true,   "set_sub_seq",   	false,          "",      dfNone,      	0,     true,       true);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
          case IBSEARCH:      //조회
				...
				sheetObj.DoSearch("ESM_BKG_9461GS.do",sParam);
		...
		case IBSAVE:        //저장
			if(validateForm(sheetObj,formObj,sAction)) {
            	...
            	var sXml = sheetObj.GetSaveXml("ESM_BKG_9461GS.do", sParam);
        ...
        case IBINSERT:      // 입력
        	...
        	sheetObj.CellValue2(Row, "usr_id") = formObj.strUsr_id.value;
 	 	...
 	 	case IBSAVE: // 조회
			...
			for(var i=1; i < sheetObj.RowCount+1; i++) {
				...
				if (sheetObj.CellValue(i,"cust_cnt_cd") == "" || sheetObj.CellValue(i,"cust_seq") == "") {
					ComShowMessage(ComGetMsg("BKG00445", "Customer code"));
				return false;
				}
