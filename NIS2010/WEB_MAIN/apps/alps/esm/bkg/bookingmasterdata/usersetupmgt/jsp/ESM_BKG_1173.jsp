...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg1173Event"%>
...
<%
	EsmBkg1173Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1173Event)request.getAttribute("Event");
...
<table class="search" id="mainTable"> 
    <tr><td class="bg">	
			...
			<tr class="h23">
				<td width="60">TRO OFC</td>
				<td width=""><input type="text" name="bkg_tro_ofc_cd"  style="ime-mode:disabled;width:120px;" dataformat="engupnum" class="input">
