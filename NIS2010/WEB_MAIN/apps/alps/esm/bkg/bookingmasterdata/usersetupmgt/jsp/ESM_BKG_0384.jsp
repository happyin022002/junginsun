...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg0384Event"%>
...
<html>
<head>
<title>Booking Notice Remark</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  Remark Template
</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width=""><input type="text" style="width:100;" class="input2" value="<%=strUsr_id%>" readonly></td>
				...
				<table width="100%" class="button"> 
		       	<tr><td class="btn2_bg">
					...
					<tr>
						...
						<td class="btn2" name="btn_AddRow">Add Row</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_DeleteRow">Row Delete</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>		
					</tr></table>
