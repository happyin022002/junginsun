...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg0232Event"%>
...
<html>
<head>
<title>e-Booking & SI Set Search</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;e-Booking & S/I Process Set Search</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
