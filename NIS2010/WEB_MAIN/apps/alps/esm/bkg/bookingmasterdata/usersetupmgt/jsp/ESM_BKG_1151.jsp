...
<table width="100%" class="popup" cellpadding="10" border="0"> 
	...
	<tr>
		...
		<tr><td class="title"><img src="./img/icon_title_dot.gif" align="absmiddle">&nbsp;B/L PDF Option</td></tr>
		</table>
				...
				<table class="search_sm2" border="0" width="260">
					<tr class="h23">
						...
						<td width="" class="stm">
							...
							<input type="radio" name="paper_type" value="4" class="trans" >&nbsp;Letter</td>
					</tr>
				</table>
				<table class="search" border="0" style="width:100%;"> 
					<tr><td width="90"><input type="checkbox" value="Y" name="preview_yn" class="trans" checked>&nbsp;Preview</td>
