 ...
 *@FileName : ESM_BKG_0573.js
 *@FileTitle : ESM_BKG_0573
 *Open Issues :
 *Change history :
...
function loadPage(dType, callGubun) {
	...
	function sheet1_OnLoadFinish(sheetObj) {
		...
		if(formObj.pgmNo.value != "ESM_BKG_0573") {
        ...
        case "sheet1":
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
				...
				var HeadTitle1 = "|Seq|MSG Send Num|Send Date|Send User|MSG Func ID|DECL Type|VVD|PORT|I/VVD|O/VVD|B/L No.|Declaration\nType|Status|ACK Date|Error MSG|Error Cntr No.|Total\nSubmitted Count|Total\nError|Total\nSucess|";
				...
				InitDataProperty(0, cnt++ , dtData,			200,	daCenterTop,	true,		"msg_snd_no",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,			120,		daCenterTop,	true,		"snd_dt",		false,		"",		dfDateYmd,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,			120,		daCenterTop,	true,		"snd_usr_id",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,			130,	daCenterTop,	true,		"msg_func_id",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,			120,		daCenterTop,	true,		"psa_dg_decl_tp_cd",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,			120,		daCenterTop,	true,		"vvd_cd",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,			110,		daCenterTop,	true,		"port_cd",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			80,		daCenterTop,	true,		"ib_vvd_cd",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			80,		daCenterTop,	true,		"ob_vvd_cd",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			90,		daCenterTop,	true,		"bl_no",			false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			80,		daCenterTop,	true,		"cntr_hndl_knd_cd", false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			50,		daCenterTop,	true,		"err_cntr_sts_cd",	false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			90,		daCenter,		true,		"upd_dt",			false,		"",		dfDateYmd,		0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			270,	daLeftTop,		true,		"cstms_err_msg",	false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			100,	daCenterTop,	true,		"cntr_no",			false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			130,	daCenterTop,	true,		"cntr_ttl_knt",		false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			50,		daCenterTop,	true,		"cntr_ttl_err_knt",	false,		"",		dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtHidden,			50,		daCenterTop,	true,		"cntr_ttl_scs_knt",	false,		"",		dfNone,			0,		false,		false);								
				InitDataProperty(0, cnt++ , dtHidden,		50,		daCenterTop,	true,		"rcv_log_err_seq",	false,		"",		dfNone,			0,		false,		false);
				
				InitViewFormat(0, "upd_dt", "yyyymmdd");
				CountPosition = 2;
...
function doActionIBSheet(sheetObj,formObj,sAction) {
    ...
    switch(sAction) {
		...
		case IBSEARCH:      //조회
			...
			var sXml = sheetObj.GetSearchXml("ESM_BKG_0573GS.do", FormQueryString(formObj));
...
//		    if(formObj.call_gubun.value == "ESM_BKG_0577") {
