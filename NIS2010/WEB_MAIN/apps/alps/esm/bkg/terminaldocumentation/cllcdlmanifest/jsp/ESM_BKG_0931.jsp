...
<%@ page import="com.hanjin.apps.alps.esm.bkg.terminaldocumentation.cllcdlmanifest.event.EsmBkg0931Event"%>
...
<table width="100%" class="popup" cellpadding="10" border="0"> 
	...
	<tr>
		<td valign="top">
			...
			<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Container Loading List(KOREA)_Print Preview</td></tr>
			</table>				
     	...
     	<table class="search" id="mainTable">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="140" align="left"><input type="text" style="width:200;" name="vvd_cd_nm" value="" class="input2" readonly></td>
					<td width="40" align="right">POL</td>
					<td width="140" align="left"><input type="text" style="width:45;" name="pol_cd_print" value="" class="input2" readonly></td>
					<td width="40" align="right">ETD</td>	
					<td width="" align="left"><input type="text" style="width:125;" name="vps_etd" value="" class="input2" readonly></td>
				</tr>			
				</table>				
