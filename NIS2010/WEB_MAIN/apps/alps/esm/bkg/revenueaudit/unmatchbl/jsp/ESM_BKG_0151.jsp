...
//		usaSvcModCds = RASUtil.getValueObject2StringArray((List<CodeInfo>)eventResponse.getCustomData("usaSvcModCd"), false , "|", "\t", "getCode", "getName");
        ...
        // Error BL Status 
        errBlCds = RASUtil.getValueObject2StringArray((List<CodeInfo>)eventResponse.getCustomData("errBlCd"), false , "|", "\t", "getCode", "getName");
    }catch(Exception e) {
...
<html>
<head>
<title>Charge and B/L Filtering</title>
...
//    var usaSvcModCdComboText = "|<//%=usaSvcModCds[1]%>";
    ...
    var errBlCdComboValue = "|<%=errBlCds[0]%>";
    var errBlCdComboText = "|<%=errBlCds[1]%>";
...
<script language="javascript" src="../script/UI_BKG_0151.js"></script>
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:0;,padding-bottom:2;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_downfile">Down&nbsp;File</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
			</tr>
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="35">RHQ</td>
					<td width="95"><script language="javascript">ComComboObject('bkg_rhq_cd', 1, 80, 0, 1, 0, false);</script></td>
					<td width="30">GSO</td>
					<td width="90"><script language="javascript">ComComboObject('bkg_gso_cd', 1, 80, 0, 0, 0, false);</script></td>
					<td width="40">Office</td>
					<td width="90"><script language="javascript">ComComboObject('bkg_ofc_cd', 1, 80, 0, 0, 0, false);</script></td>
					<td width="480">
						<table class="search_sm2" border="0" style="470"> 
							<tr class="h23">
								<td width="32">Date</td>
								<td width="210" class="stm">
									<input type="radio" value="BKG" class="trans" name="r_date">BKG&nbsp;
									<input type="radio" value="APPL" class="trans" name="r_date">Appl.&nbsp;
									<input type="radio" value="ETD" class="trans" name="r_date" checked>ETD&nbsp;
									<input type="radio" value="ETA" class="trans" name="r_date">ETA
								</td>
					...
					<td width=""><input type="text" style="width:80;text-align:center;ime-mode:disabled" class="input" name="bl_no" caption="B/L No" dataformat=uppernum maxlength="12"></td>
				</tr>	
				</table>
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="70">Contract</td>
					<td width="75"><script language="javascript">ComComboObject('bkg_ctrt_tp_cd', 1, 70, 0, 0, 0, false);</script></td>
					<td width="140"><input type="text" style="width:83;text-align:center;ime-mode:disabled" class="input" name="ctrt_no" caption="Contract No." dataformat="uppernum" maxLength="11">
					<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="ctrt_popup"></td>
					
					<td width="50">T/VVD</td>
					<td width="136"><input type="text" style="width:80;text-align:center;ime-mode:disabled" class="input" name="vvd" caption="T/VVD" dataformat=uppernum maxlength="9"> <img class="cursor"  src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="vvd_popup"></td>
				
					<td width="80">Commodity</td>
					<td width="120"><input type="text" style="width:60;text-align:center;ime-mode:disabled" class="input" name="cmdt_cd" dataformat="uppernum" maxLength="6">
					<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="cmdt_popup"></td>
					<td width="90">Cargo Type</td>
					<td width="105"><script language="javascript">ComComboObject('cargo_type', 2, 72, 0, 0, 0, false);</script></td>
					<td width="60">User ID</td>
					<td width="110"><input type="text" style="width:105;text-align:center;ime-mode:disabled" class="input" name="cre_usr_id" maxLength="20"></td>
				</tr>	
				</table>
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
				...
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="78">BDR Status</td>
					<td width="65"><script language="javascript">ComComboObject('bdr_flg', 1, 50, 0, 0, 0, false);</script></td>
					<td width="80">BKG Status</td>
					<td width="65"><script language="javascript">ComComboObject('bkg_sts_cd', 2, 50, 0, 0, 0, false);</script></td>
					<td width="80">Split Status</td>
					<td width="65"><script language="javascript">ComComboObject('split_flg', 2, 50, 0, 0, 0, false);</script></td>  
					<td width="100">Charge Status</td>
                    <td width="65"><script language="javascript">ComComboObject('charge_flg', 2, 50, 0, 0, 0, false);</script></td>
					<td width="88">Rating Type</td>
					<td width="120"><script language="javascript"> ComComboObject('auto_rat_flg', 1, 110, 0, 0, 0, false);</script></td>
					<td width="88">Audit Result</td>
					<td width="85"><script language="javascript"> ComComboObject('err_bl_cd', 1, 75, 0, 0, 0, false);</script></td>
				</tr>	
				</table>
				<table class="line_bluedot"><tr><td></td></tr></table>
...
<!--					<td width="131"><script language="javascript">ComComboObject('chg_cd', 2, 110, 0, 0, 0, false);</script></td>-->
                    ...
                    <table class="search_sm2" border="0" style="width:180;"> 
                        <tr class="h23">
					<td width="65"><script language="javascript">ComComboObject('chg_cd', 2, 60, 0, 1, 0, false);</script></td>
