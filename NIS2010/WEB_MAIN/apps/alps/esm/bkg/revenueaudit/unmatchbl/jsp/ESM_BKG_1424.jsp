...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1424Event"%>
...
<%
    EsmBkg1424Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg1424Event)request.getAttribute("Event");
...
<html>
<head>
<title>India THC BKG List for Audit</title>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="45"><nobr>POR</nobr></td>
						<td width="93"><input input type="text" class="input" value="" style="width:80;text-align:center;ime-mode:disabled" name="por_cd" dataformat=engup caption="POR" maxlength="5"></td>
						<td width="45" align="center"><nobr>POL</nobr></td>
						<td width="93"><input input type="text" class="input" value="" style="width:80;text-align:center;ime-mode:disabled" name="pol_cd" dataformat=engup caption="POL" maxlength="5"></td>
						<td width="45" align="center"><nobr>POD</nobr></td>
						<td width="93"><input input type="text" class="input" value="" style="width:80;text-align:center;ime-mode:disabled" name="pod_cd" dataformat=engup caption="POD" maxlength="5"></td>
						<td width="45"><nobr>DEL</nobr></td>
						<td width=""><input input type="text" class="input" value="" style="width:80;text-align:center;ime-mode:disabled" name="del_cd" dataformat=engup caption="DEL" maxlength="5"></td>
