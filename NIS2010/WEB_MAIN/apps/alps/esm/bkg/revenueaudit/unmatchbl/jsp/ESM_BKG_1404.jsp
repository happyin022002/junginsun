...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1404Event"%>
...
<%
    EsmBkg1404Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg1404Event)request.getAttribute("Event");
...
<html>
<head>
<title>TXS BKG List for Audit</title>
					...
					<tr class="h23">
						<td width="980">
							...
							<tr class="h23">
								...
								<td width="60"><script language="javascript">ComComboObject('svc_scp_cd', 2, 90, 0, 1, 0, false);</script></td>
								<td width="20" ></td>
								<td width="50">Tri-axel</td>
								<td width="">
									<select style="width:50;" class="input" name="tri_axel">
