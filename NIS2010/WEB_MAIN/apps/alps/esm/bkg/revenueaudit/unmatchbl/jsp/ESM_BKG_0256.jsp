...
*@FileTitle : Mismatch B/L Inquiry by Auditor
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg0256Event"%>
...
<html>
<head>
<title>Mismatch B/L Inquiry by Auditor</title>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="295"><input type="radio" name="dt_type" value="AUD" class="trans"> Audit Initial Date
						<input type="radio" name="dt_type" value="APL" class="trans" > Appl. Date
						<input type="radio" name="dt_type" value="PCT" class="trans" checked> PCT</td>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">	
						...
						<td width="125"><script language="javascript"> ComComboObject('umch_tp_cd', 1, 105, 0, 0, 0, false);</script></td>
						<td width="50">Charge</td>
                    	<td width="70"><script language="javascript">ComComboObject('chg_cd', 2, 55, 0, 0, 0, false);</script></td>
						<td width="100">Error Status </td>
						<td width="280">
						<script language="javascript"> ComComboObject('rev_aud_sts_cd', 1, 90, 0, 0, 0, false);</script>&nbsp;
						<script language="javascript"> ComComboObject('rev_aud_stl_knd_cd', 1, 150, 0, 0, 0, false);</script>
						</td>
						<td width="80">Rater ID</td>
						<td width=""><input type="text" name="rater_id" style="width:83;text-align:center;ime-mode:disabled;" value="" maxLength="20"></td>	
						<td width="83" style="text-align:center;">Settler ID</td>
						<td width="90"><input type="text" name="stl_usr_id" style="width:83;text-align:center;ime-mode:disabled;" value="" maxLength="20"></td>	
				
					</tr>
				</table>
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="70">Error Kind</td>
						<td width="75"><script language="javascript"> ComComboObject('err_umch_tp_cd', 3, 55, 0, 0, 0, false);</script></td>	
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_Settle">Manual Settle</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
					</tr></table>
