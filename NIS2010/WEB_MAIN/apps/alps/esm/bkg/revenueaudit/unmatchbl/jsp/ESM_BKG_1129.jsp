...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1129Event"%>
...
<%
    EsmBkg1129Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg1129Event)request.getAttribute("Event");
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="45"><nobr>Contract Type</nobr></td>
						...
						<td width="45"><nobr>BDR Status</nobr>
						<td width="65"><script language="javascript">ComComboObject('bdr_flg', 1, 62, 0, 0, 0, false);</script>
						</td>
						<td width="45"><nobr>Split Status</nobr>
						<td width="65"><script language="javascript">ComComboObject('split_flg', 2, 82, 0, 0, 0, false);</script></td>
					</tr>
				</table>
			...
			<table width="100%"> 
	       	<tr><td class="btn2_bg" align="right">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<tr class="h23"><td>CNTR Count&nbsp;&nbsp;</td></tr>
						</table></td>
						<td><input type="text" style="width:60;text-align:right" class="input" value="" name="cntr_cnt" readonly></td>
					</tr></table>
			</td></tr>
			</table>
	    	<!-- Button_Sub (E) -->
