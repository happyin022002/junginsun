...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg0705Event"%>
...
<%
    EsmBkg0705Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg0705Event)request.getAttribute("Event");
     ...
     // COD Reason Combo Data 생성
        codRqstRsnCds = RASUtil.getValueObject2StringArray((List<RsltCdListVO>)eventResponse.getCustomData("codRqstRsnCd"));
...
<script language="javascript">
    ...
    var codRqstRsnCdComboValue = "|<%=codRqstRsnCds[0]%>";
    var codRqstRsnCdComboText = "|<%=codRqstRsnCds[1]%>";
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="50">RHQ</td>
						<td width="120" align="left"><script language="javascript">ComComboObject('rhq_cd', 1, 90, 0, 1, 0, false);</script></td>
						...
						<td>
							...
							<tr class="h23">
								<td>Date</td>
								<td width="" class="stm"><input type="radio" class="trans" name="date_type" value="B" >BKG&nbsp;&nbsp;<input type="radio" class="trans" name="date_type" value="A">Appl.&nbsp;&nbsp;<input type="radio" name="date_type" value="E" class="trans" checked>ETD&nbsp;</td>
								<td width="">
								    <nobr>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="80"><nobr>COD Reason</nobr></td>
						<td width=""><script language="javascript"> ComComboObject('cod_rqst_rsn_cd', 2, 80, 0, 0, 0, false);</script></td>
						</tr>
				</table>
	</td></tr>
		</table>
