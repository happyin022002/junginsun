...
/**
 * @extends Bkg
 * @class ESM_BKG_1421:ESM_BKG_1421 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
...
function initIBComboItem() {
	...
	ComBkgTextCode2ComboItem(chgComboValue, chgComboText, getComboObject(comboObjects, 'chg_cd'), "|", "\t" );
	ComBkgTextCode2ComboItem(rtStsComboValue, rtStsComboValue, getComboObject(comboObjects, 'auto_rat_cd'), "|", "\t" ); 
		...
		case "sheet1":
	      	with (sheet1) {
	           ...
	           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	            ...
	            var HeadTitle1 = "|RHQ|BKG\nOffice|BKG No.|Appl. Date|BDR|Commodity|Commodity|Scope|Change History|POR|POL|POD|DEL|Contract\nType|Contract No.|" +
	            		"Booking|Booking|Booking|Booking|Booking|Booking|Booking|Contract|Contract|Contract|Contract|Contract|Contract|bl_cnt";
	            var HeadTitle2 = "|RHQ|BKG\nOffice|BKG No.|Appl. Date|BDR|Code|Name|Scope|Change History|POR|POL|POD|DEL|Contract\nType|Contract No.|" +
	            		"Charge|Curr|Rate|RatedAs|Per|Amount|M|Charge|Curr|Rate|RatedAs|Per|Amount|bl_cnt";
	            ...
	            InitDataProperty(0, cnt++, dtData,			60,    daCenter,    true,   "bkg_rhq_cd",        false,    "",      dfNone,      0,    true,     true);
	            InitDataProperty(0, cnt++, dtData,			60,    daCenter,    true,   "bkg_ofc_cd",        false,    "",      dfNone,      0,    true,     true);
				...
				InitDataProperty(0, cnt++, dtData,		   150,    daLeft,      true,   "rt_cng_his",        false,    "",      dfNone,      0,    true,     true);
				...
				InitDataProperty(0, cnt++, dtData,			50,    daCenter,    true,   "bkg_chg_cd",        false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			50,    daCenter,    true,   "bkg_curr_cd",       false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			70,    daRight,     true,   "bkg_chg_ut_amt",    false,    "",      dfNullFloat, 2,    false,    false);
				InitDataProperty(0, cnt++, dtData,			60,    daRight,     true,   "bkg_rat_as_qty",    false,    "",      dfNone,      0,    false,    false);
				
				InitDataProperty(0, cnt++, dtData,			35,    daCenter,    true,   "bkg_rat_ut_cd",     false,    "",      dfNone,      0,    false,    false);				
				InitDataProperty(0, cnt++, dtData,			80,    daRight,     true,   "bkg_chg_amt",       false,    "",      dfNullFloat, 2,    false,    false);
				InitDataProperty(0, cnt++, dtData,			35,    daCenter,    true,   "bkg_auto_rat_cd",   false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			50,    daCenter,    true,   "his_chg_cd",        false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			50,    daCenter,    true,   "his_curr_cd",       false,    "",      dfNone,      0,    false,    false);
				
				InitDataProperty(0, cnt++, dtData,			70,    daRight,     true,   "his_chg_ut_amt",    false,    "",      dfNullFloat, 2,    false,    false);
				InitDataProperty(0, cnt++, dtData,			60,    daRight,     true,   "his_rat_as_qty",    false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			35,    daCenter,    true,   "his_rat_ut_cd",     false,    "",      dfNone,      0,    false,    false);				
				InitDataProperty(0, cnt++, dtData,			80,    daRight,     true,   "his_chg_amt",       false,    "",      dfNullFloat, 2,    false,    false);
		...
		var rctOfcCd   = sheet1.CellValue(Row, "bkg_ofc_cd"); 	
	 	switch(colName){
	 		case "bkg_no":
		    	...
		    	comRASCallPop("ESM_BKG_0079", "ESM_BKG_1421", popParams, "");
				break;
			...
			case "ctrt_no":
	        	...
	        	comRASCallPop(pgmNo, "ESM_BKG_1421", popParams, "");
				break;
			...
			case "rdn_no":
	    		...
	    		comRASCallPop("ESM_BKG_0426", "ESM_BKG_1421", popParams, "");
				break;
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
        case IBSEARCH: //조회
        	...
        	sheetObj.DoSearch("ESM_BKG_1421GS.do", FormQueryString(formObj));
