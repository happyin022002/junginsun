...
*@FileName : ESM_BKG_1406.js
*@FileTitle : IHC BKG Inquiry for Audit
*Open Issues :
*Change history :
...
/**
 * @extends Bkg
 * @class ESM_BKG_1406:ESM_BKG_1406 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
		...
		case "sheet1":
	      	with (sheet1) {
	           ...
	           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	            ...
	            var HeadTitle1 = "|BKG|APPL DATE|bkg_ctrt_tp_cd|Contract|POR|POL|POD|DEL|R/D Term|R/D Term|CNTR|WGT|BKG Remark|BKG Remark|Carrier Haulage Check|Carrier Haulage Check|Carrier Haulage Check|Carrier Haulage Check|OIH:Cur/Rate/Rated As/Per/Amount|DIH:Cur/Rate/Rated As/Per/Amount|CYR:Cur/Rate/Rated As/Per/Amount|Audit\nResult|Audit\nDate|RDN No|bl_cnt";
	            var HeadTitle2 = "|BKG|APPL DATE|bkg_ctrt_tp_cd|Contract|POR|POL|POD|DEL|RCV|DEL|CNTR|WGT|External|Internal|Cost Code|SO No|SO From|SO To|OIH:Cur/Rate/Rated As/Per/Amount|DIH:Cur/Rate/Rated As/Per/Amount|CYR:Cur/Rate/Rated As/Per/Amount|Audit\nResult|Audit\nDate|RDN No|bl_cnt";
				...
				InitDataProperty(0, cnt++, dtData,			80,    daRight,     true,   "cntr_wgt",          false,    "",      dfNullFloat, 2,    false,    false);
				...
				InitDataProperty(0, cnt++, dtData,			65,    daCenter,    true,   "trsp_cost_dtl_mod", false,    "",      dfNone,      0,    true,     true);
				...
				InitDataProperty(0, cnt++, dtData,			210,   daLeft,      true,   "oih",               false,    "",      dfNone,      0,    true,     true);
				InitDataProperty(0, cnt++, dtData,			210,   daLeft,      true,   "dih",               false,    "",      dfNone,      0,    true,     true);
				InitDataProperty(0, cnt++, dtData,			210,   daLeft,      true,   "cyr",               false,    "",      dfNone,      0,    true,     true);
				InitDataProperty(0, cnt++, dtData,			75,    daCenter,    true,   "aud_sts_cd",        false,    "",      dfNone,      0,    true,     true);
				InitDataProperty(0, cnt++, dtData,			70,    daCenter,    true,   "rev_aud_dt",        false,    "",      dfDateYmd,   0,    true,    true);
		...
		var bkgNo 	   = sheet1.CellValue(Row, "bkg_no");    	
	 	switch(colName){
	 		case "bkg_no":
		    	...
		    	comRASCallPop("ESM_BKG_0079", "ESM_BKG_1406", popParams, "");
				break;
			...
			case "ctrt_no":
	        	...
	        	comRASCallPop(pgmNo, "ESM_BKG_1406", popParams, "");
				break;
	...
	switch(sAction) {
        case IBSEARCH: //조회
        	formObj.f_cmd.value = SEARCH;
 			sheet1.DoSearch("ESM_BKG_1406GS.do", FormQueryString(formObj));
