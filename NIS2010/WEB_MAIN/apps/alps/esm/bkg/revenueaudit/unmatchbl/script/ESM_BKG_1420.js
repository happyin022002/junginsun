...
/**
 * @extends Bkg
 * @class ESM_BKG_1420:ESM_BKG_1420 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
		...
		case "sheet1":
	      	with (sheet1) {
	           ...
	           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	            ...
	            var HeadTitle1 = "|Appl. Date|B/L No.|Scope|POR|POL|POD|DEL|Contract\nType|Contract No.|OB/L\nReceived|" +
	            		"Charge Info|Charge Info|Charge Info|Charge Info|Charge Info|AR MRI(OBS)|AR MRI(OBS)|" +
	            		"Doc Surcharge Exemption Approval|Doc Surcharge Exemption Approval|Doc Surcharge Exemption Approval|" +
	            		"Doc Surcharge Exemption Approval|Doc Surcharge Exemption Approval|Doc Surcharge Exemption Approval|bl_cnt";
	            var HeadTitle2 = "|Appl. Date|B/L No.|Scope|POR|POL|POD|DEL|Contract\nType|Contract No.|OB/L\nReceived|" +
	            		"Curr|Rate|RatedAs|Per|Amount|Curr|Amount|Approval|Date|Office|Name|Reason|Remark|bl_cnt";
				...
				InitDataProperty(0, cnt++, dtData,			75,    daCenter,    true,   "obl_rdem_ofc_cd",   false,    "",      dfNone,      0,    false,    false);
				...
				InitDataProperty(0, cnt++, dtData,			60,    daCenter,    true,   "inv_chg_amt",       false,    "",      dfNullFloat, 2,    false,    false);
				
				InitDataProperty(0, cnt++, dtData,			60,    daCenter,    true,   "apro_flg",   		 false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			70,    daCenter,    true,   "apro_dt",    		 false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			50,    daCenter,    true,   "apro_ofc_cd",       false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			90,    daCenter,    true,   "apro_usr_nm",    	 false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			150,   daLeft,  	true,   "chg_amd_rsn",    	 false,    "",      dfNone,      0,    false,    false);
		...
		var rctOfcCd   = sheet1.CellValue(Row, "bkg_ofc_cd"); 	
	 	switch(colName){
	 		case "bkg_no":
		    	...
		    	comRASCallPop("ESM_BKG_0079", "ESM_BKG_1420", popParams, "");
				break;
			...
			case "ctrt_no":
	        	...
	        	comRASCallPop(pgmNo, "ESM_BKG_1420", popParams, "");
				break;
			...
			case "rdn_no":
	    		...
	    		comRASCallPop("ESM_BKG_0426", "ESM_BKG_1420", popParams, "");
				break;
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
        case IBSEARCH: //조회
        	...
        	sheetObj.DoSearch("ESM_BKG_1420GS.do", FormQueryString(formObj));
