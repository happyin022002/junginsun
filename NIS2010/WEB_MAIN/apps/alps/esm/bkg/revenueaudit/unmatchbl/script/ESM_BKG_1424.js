...
*@FileName : ESM_BKG_1424.js
*@FileTitle : Iran DTH BKG List for Audit
*Open Issues :
*Change history :
...
/**
 * @extends Bkg
 * @class ESM_BKG_1424:ESM_BKG_1424 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
		...
		case "sheet1":
	      	with (sheet1) {
	           ...
	           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	            ...
	            var HeadTitle1 = "|BKG|APPL DATE|bkg_ctrt_tp_cd|Contract|POR|POL|POD|DEL|BKG Internal charge remark for Audit|OTH:Cur/Rate/Rated As/Per/Amount|DTH:Cur/Rate/Rated As/Per/Amount|Audit\nResult|Audit\nDate|RDN No|bl_cnt";
	            var HeadTitle2 = "|BKG|APPL DATE|bkg_ctrt_tp_cd|Contract|POR|POL|POD|DEL|BKG Internal charge remark for Audit|OTH:Cur/Rate/Rated As/Per/Amount|DTH:Cur/Rate/Rated As/Per/Amount|Audit\nResult|Audit\nDate|RDN No|bl_cnt";
				...
				InitDataProperty(0, cnt++, dtData,		    230,    daLeft,     true,   "inter_rmk",         false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			212,   daLeft,      true,   "oth",               false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			212,   daLeft,      true,   "dth",               false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			65,    daCenter,    true,   "aud_sts_cd",        false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			65,    daCenter,    true,   "rev_aud_dt",        false,    "",      dfDateYmd,   0,    false,    false);
				InitDataProperty(0, cnt++, dtData,			70,    daCenter,    true,   "rdn_no",            false,    "",      dfNone,      0,    false,    false);
				InitDataProperty(0, cnt++, dtHidden,		30,	   daCenter,    true,	"ttl_bkg_cnt",	     false,	   "",      dfNone,      0,	   false,	 false);
		...
		var bkgNo 	   = sheet1.CellValue(Row, "bkg_no");    	
	 	switch(colName){
	 		case "bkg_no":
		    	...
		    	comRASCallPop("ESM_BKG_0079", "ESM_BKG_1424", popParams, "");
				break;
			...
			case "ctrt_no":
	        	...
	        	comRASCallPop(pgmNo, "ESM_BKG_1424", popParams, "");
				break;
	...
	switch(sAction) {
        case IBSEARCH: //조회
        	formObj.f_cmd.value = SEARCH;
 			sheet1.DoSearch("ESM_BKG_1424GS.do", FormQueryString(formObj));
...
function validateForm(sheetObj, formObj, sAction){	
    ...
    switch (sAction) {
    	...
    	case IBSEARCH: //조회
    		...
    		if("" == toDtValue.value|| "" == fmDtObj.value){
				ComShowCodeMessage("BKG95031", "Application Date");
				return false;	
    		}
