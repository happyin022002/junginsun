...
/**
 * @extends Bkg
 * @class ESM_BKG_1080:ESM_BKG_1080 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
...
InitDataProperty(0, cnt++, dtPopup,     120,    daCenter,    true,   "rdn_no",            		false,    "",      dfNone,      0,    true,     false);
...
InitDataProperty(0, cnt++, dtData,      40,    daCenter,    true,   "ctrt_cntr_tpsz_cd2",      false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtData,      45,    daCenter,    true,   "crr_hngr_sgl_bar_qty",    false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtData,      45,    daCenter,    true,   "crr_hngr_dbl_bar_qty",    false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtData,      45,    daCenter,    true,   "crr_hngr_tpl_bar_qty",    false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtData,      45,    daCenter,    true,   "crr_hngr_qty",            false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtData,      45,    daCenter,    true,   "mer_hngr_qty",            false,    "",      dfNone,      0,    false,    false);
...
InitDataProperty(0, cnt++, dtData,      60,    daCenter,    true,   "rat_as_qty",              false,    "",      dfNullFloat, 3,    false,    false);
InitDataProperty(0, cnt++, dtData,      40,    daCenter,    true,   "rat_ut_cd",               false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtData,      70,    daCenter,    true,   "chg_amt",                 false,    "",      dfNullFloat, 2,    false,    false);
...
InitDataProperty(0, cnt++ ,dtHiddenStatus,	30,	daCenter, 	true,	"ibflag");
					...
					ColHidden("ctrt_cntr_tpsz_cd2") = true;
                    ShowButtonImage = 2;
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		...
		case IBSAVE:		//저장
	       ...
	       var sXml = sheet1.GetSaveXml("ESM_BKG_1080GS.do", sParam);
...
function sheet1_OnSearchEnd(sheetObj, errMsg) {
    ...
    if(sheetObj.RowCount > 0){
    	form.bl_cnt.value = sheetObj.CellValue(3,"bl_cnt");
    }else{
    	    	form.bl_cnt.value = "0";
    }
