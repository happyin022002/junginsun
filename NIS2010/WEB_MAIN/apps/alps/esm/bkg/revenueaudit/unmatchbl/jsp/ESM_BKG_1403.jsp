...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1403Event"%>
...
<%
	EsmBkg1403Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1403Event)request.getAttribute("Event");
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="260" >
							<input type="radio" class="trans" name="date_type" value="A" checked> Application Date &nbsp;&nbsp;&nbsp;
							<input type="radio" class="trans" name="date_type" value="L"> POL ETD
						</td>
						<td width="300" >
						<nobr>
						<input name="fm_dt" type="text" style="width:80;text-align:center;"  value="" class="input1" caption="From Date" maxlength="10" dataformat="ymd">
						<img class="cursor" src="img/btns_calendar.gif" name="btns_calendar1" width="19" height="20" border="0" align="absmiddle">
						~
						<input name="to_dt" type="text" style="width:80;text-align:center;"  value="" class="input1" caption="To Date" maxlength="10" dataformat="ymd">
						...
						<td width="150"><script language="javascript"> ComComboObject('bkg_ctrt_tp_cd', 1, 100, 0, 0, 0, false);</script></td>
						<td width="169"></td>
					</tr>
				</table>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">					
						...
						<td width="245"><script language="javascript"> ComComboObject('ofc_tp_cd', 1, 100, 0, 1, 0, false);</script></td>
						<td width="53">RHQ</td>
						<td width="225"><script language="javascript"> ComComboObject('bkg_rhq_cd', 1, 100, 0, 0, 0, false);</script></td>
						<td width="50">Office</td>
						<td width="150"><script language="javascript"> ComComboObject('bkg_ofc_cd', 1, 100, 0, 0, 0, false);</script></td>
						<td width="176"></td>					
					</tr>
				</table>
				<!--  biz_1   (E) -->		
