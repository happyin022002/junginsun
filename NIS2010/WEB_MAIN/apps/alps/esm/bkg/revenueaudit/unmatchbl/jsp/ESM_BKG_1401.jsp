...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1401Event"%>
...
<%
    EsmBkg1401Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg1401Event)request.getAttribute("Event");
     ...
     // Charge Status Combo Data 생성
        ...
        // Container Type Size
        cntrTpszs = RASUtil.getValueObject2StringArray((List<CodeInfo>)eventResponse.getCustomData("cntrTpsz"));
...
<script language="javascript">
    ...
    var cntrTpszComboValue = "<%=cntrTpszs[0]%>";
    var cntrTpszComboText = "<%=cntrTpszs[1]%>";
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="40" align="center"><nobr>B/L</nobr>
						<td width="126"><input input type="text" class="input" value="" style="width:100;text-align:center;ime-mode:disabled" name="bkg_no" dataformat=uppernum caption="B/L" maxlength="13"></td>
					</tr>
				</table>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
	                    ...
	                    <td width="80">CNTR TPSZ</td>
	                    <td width="65"><script language="javascript"> ComComboObject('cntr_tpsz_cd', 1, 60, 0, 0, 0, false);</script></td>
	                    <td width="459"></td>
					</tr>
				</table>
	</td>
