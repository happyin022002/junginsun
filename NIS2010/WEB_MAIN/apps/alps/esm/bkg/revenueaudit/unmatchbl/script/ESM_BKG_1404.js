...
/**
 * @extends  
 * @class ESM_BKG_1404 : ESM_BKG_1404 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_BKG_1404() {
		...
		case "sheet1":
	      	with (sheet1) {
		           ...
		           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	                ...
	                var HeadTitle1 = "BKG|BKG|BKG|BKG|BKG|BKG|BKG|BKG|BKG|BKG|BKG|BKG|W/O|W/O|W/O|W/O|W/O|W/O|W/O|TPB|TPB|TPB|TPB|TPB|TPB|BkgCnt";
	                var HeadTitle2 = "BKG|R/D Term|R/D Term|Scope|POR|POL|POD|DEL|Contract No|CNTR TPSZ|TXS Charge|TXS Charge|BKG|CNTR TPSZ|CNTR No|Tri-axel|Instruction|W/O No|W/O Issue Date|BKG|Exp Type|Exp Type|TPB No|Curr|Amount|BkgCnt";
	                var HeadTitle3 = "BKG|Rcv|De|Scope|POR|POL|POD|DEL|Contract No|CNTR TPSZ|Curr|Amount|BKG|CNTR TPSZ|CNTR No|Tri-axel|Instruction|W/O No|W/O Issue Date|BKG|Main|Sub|TPB No|Curr|Amount|BkgCnt";
...
//					InitDataProperty(0, cnt++, dtHiddenStatus,	30,	daCenter, 	true,	"ibflag");
					...
					InitDataProperty(0, cnt++, dtData,     60,	daCenter,		true,   "tri_axl_flg",				false,	"",      dfNone,      0,    false,    false);
					...
					InitDataProperty(0, cnt++, dtData,     35,	daCenter,		true,   "n3pty_expn_tp_cd",	false,	"",      dfNone,	    0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     50,	daCenter,		true,   "sub",						false,	"",      dfNone,      0,    false,    false);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
        case IBSEARCH: //조회
			...
			var sXml = sheet1.GetSearchXml("ESM_BKG_1404GS.do",FormQueryString(formObj));
