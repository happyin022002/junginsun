...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1079Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="40">RHQ</td>
						<td width="130"><script language="javascript">ComComboObject('bkg_rhq_cd', 1, 80, 0, 1, 0, false);</script></td>
						<td width="40">GSO</td>
						<td width="130"><script language="javascript">ComComboObject('bkg_gso_cd', 1, 80, 0, 0, 0, false);</script></td>
						<td width="45">Office</td>
						<td width="145"><script language="javascript">ComComboObject('bkg_ofc_cd', 1, 80, 0, 0, 0, false);</script></td>
						<td width="99"></td>
						<td>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="125"><nobr><input type="text" class="input" style="width:90;text-align:center;ime-mode:disabled" name="vvd" dataformat=uppernum caption="T/VVD" maxlength="9"> <img class="cursor"  src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btn_com_ens_ob2"></nobr></td>
						<td width="" align="right">
							<table class="search_sm2" border="0" style="width:300;"> 
								<tr class="h23">
									<td width="">Exclusion&nbsp;</td>
									<td class="stm"><input type="checkbox" class="trans" name="chk_exclusion">ALL&nbsp;&nbsp;&nbsp;<input type="checkbox" class="trans" id="chk_sub_exclusion" name="chk_eq_subst_flg">EQ Sub&nbsp;&nbsp;&nbsp;<input type="checkbox" class="trans" id="chkExclusion" name="chk_awk_cgo_flg">AK&nbsp;&nbsp;&nbsp;<input type="checkbox" class="trans" id="chkExclusion" name="chk_bb_cgo_flg">BB</td>
								</tr>
							</table>
						</td>
					</tr>
