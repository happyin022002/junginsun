...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1426Event"%>
...
<%
	EsmBkg1426Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1426Event)request.getAttribute("Event");
...
<html>
<head>
<title>Multi Rate BKG List for Audit</title>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="40">RHQ</td>
						<td width="110"><script language="javascript">ComComboObject('rct_rhq_cd', 1, 90, 0, 1, 0, false);</script></td>
						...
						<td width="130"><nobr><input type="text" class="input" style="width:90;text-align:center;ime-mode:disabled" name="t_vvd" dataformat=uppernum caption="T/VVD" maxlength="9" fullfill> <img class="cursor"  src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btn_com_ens_ob2"></nobr></td>
					</tr>
				</table>
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
				...
				<table class="search" border="0" style="width:979;"> 
                    <tr class="h23">
                        ...
                        <td width="65"><script language="javascript"> ComComboObject('por_pol_equals', 1, 50, 0, 0, 0, false);</script></td>
                        <td width="95"><nobr>POD = DEL</nobr></td>
                        <td width="65"><script language="javascript"> ComComboObject('pod_del_equals', 1, 50, 0, 0, 0, false);</script></td>
                        <td width="95"><nobr>Multi CNTR</nobr></td>
                        <td width="65"><script language="javascript"> ComComboObject('multi_cntr', 1, 50, 0, 0, 0, false);</script></td>
                        <td width="">&nbsp;</td>
                    </tr>
                </table>
	</td>
