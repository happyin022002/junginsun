...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_BKG_1409 : ESM_BKG_1409 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_1409() {
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    var HeadTitle1 = "VVD|POL|POD|Container No.|Position|Void(FEU)";
                    var HeadTitle2 = "VVD|POL|POD|Container No.|Position|Void(FEU)";
					...
					InitDataProperty(0, cnt++, dtData,         80,     daCenter,  true,    "pol_cd",     false,    "",         dfNone,     0,          true,       true);     
					InitDataProperty(0, cnt++, dtData,         80,     daCenter,  true,    "pod_cd",     false,    "",         dfNone,     0,          true,       true);      
					InitDataProperty(0, cnt++, dtData,         100,    daCenter,  true,    "cntr_no",    false,    "",         dfNone,     0,          true,       true);      
					InitDataProperty(0, cnt++, dtData,         100,    daCenter,  true,    "position",   false,    "",         dfNone,     0,          true,       true);      
					InitDataProperty(0, cnt++, dtData,         60,     daRight,   true,    "void_vol",   false,    "",         dfNone,     0,          true,       true);      
        ...
        switch(sAction) {
			...
			case IBSEARCH:      //조회
				if(validateForm(sheetObj,formObj,sAction)) {
                    ...
                    //sheetObj.DoSearch("ESM_BKG_1409GS.do", FormQueryString(formObj));
                    var rXml = sheetObj.GetSearchXml("ESM_BKG_1409GS.do", FormQueryString(formObj));
					//alert(rXml);
