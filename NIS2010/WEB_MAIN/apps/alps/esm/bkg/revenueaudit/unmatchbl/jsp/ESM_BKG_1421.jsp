...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg1421Event"%>
...
<%
    EsmBkg1421Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg1421Event)request.getAttribute("Event");
        ...
        // charge
        charges = RASUtil.getValueObject2StringArray((List<RsltCdListVO>)eventResponse.getCustomData("charge"));
        // autorating status
        autoRatCds = RASUtil.getValueObject2StringArray((List<CodeInfo>)eventResponse.getCustomData("autoRatCd"), false , "|", "\t", "getCode", "getName");
        log.debug("aaaaaaaaaaaaa" + autoRatCds[0]);
...
<script language="javascript">
    ...
    var chgComboValue = "|<%=charges[0]%>";
    var chgComboText = "|<%=charges[1]%>";

    var rtStsComboValue = "|<%=autoRatCds[0]%>";
    var rtStsComboText = "|<%=autoRatCds[1]%>"; 
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="85"><script language="javascript">ComComboObject('svc_scp_cd', 2, 60, 0, 0, 0, false);</script></td>
						<td width="85">Commodity</td>
						<td width="100"><nobr><input type="text" class="input" style="width:60;text-align:center;ime-mode:disabled" name="cmdt_cd" dataformat="int" caption="Commodity" maxlength="6"> <img class="cursor"  src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btns_cmdt"></nobr></td>
					</tr>
				</table>
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="95"><nobr>Charge Code</nobr></td>
						<td width="65"><script language="javascript">ComComboObject('chg_cd', 2, 50, 0, 0, 0, false);</script></td>
						<td width="95">Charge Status</td>
						<td width="60"><script language="javascript">ComComboObject('auto_rat_cd', 1, 45, 0, 0, 0, false);</script></td>
						<td width="">&nbsp;</td>
					</tr>
				</table>
	</td>
