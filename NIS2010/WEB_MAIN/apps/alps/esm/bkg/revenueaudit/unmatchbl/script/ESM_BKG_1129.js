...
/**
 * @extends Bkg
 * @class ESM_BKG_1129:ESM_BKG_1129 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
...
//		           MergeSheet = msAll;
		           ...
		           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
		            ...
		            var HeadTitle1 = "Seq.|RHQ|Office|B/L No.|BKG Date|Appl. Date|POL ETD|Scope|Contract No.|BDR\nStatus|Split\nStatus|Remarks\n(Office)|Remarks\n(Auditor)|RDN\nIssuance|RDN\nStatus|CNTR No.|TP/SZ|Vol.|WGT|Measure|bkg_no|bkg_ctrt_tp_cd|umch_bkg_seq|ctrt_cntr_tpsz_cd|bl_cnt|";
...
InitDataProperty(0, cnt++, dtData,      75,    daCenter,    true,   "rt_aply_dt",        false,    "",      dfNone,   0,    false,    false);
...
InitDataProperty(0, cnt++, dtData,      30,    daCenter,    true,   "pck_qty",		     false,    "",      dfFloat,	 2,    false,    false);
InitDataProperty(0, cnt++, dtData,      50,    daCenter,    true,   "cntr_wgt",          false,    "",      dfInteger,   0,    false,    false);
InitDataProperty(0, cnt++, dtData,      35,    daCenter,    true,   "meas_qty",          false,    "",      dfFloat,	 2,    false,    false);
InitDataProperty(0, cnt++, dtHidden,    50,    daCenter,    true,   "bkg_no",            false,    "",      dfNone,      0,    false,    false);
InitDataProperty(0, cnt++, dtHidden,    50,    daCenter,    true,   "bkg_ctrt_tp_cd",    false,    "",      dfNone,      0,    false,    false);
...
InitDataProperty(0, cnt++, dtHidden,    40,    daCenter,    true,   "ctrt_cntr_tpsz_cd", false,    "",      dfNone,      0,    false,    false);
		...
		var rctOfcCd   = sheet1.CellValue(Row, "bkg_ofc_cd"); 	
	 	switch(colName){
	 		case "bl_no":
		    	...
		    	comRASCallPop("ESM_BKG_0079", "ESM_BKG_1129", popParams, "");
				break;
			...
			case "ctrt_no":
	        	...
	        	comRASCallPop(pgmNo, "ESM_BKG_1129", popParams, "");
				break;
			...
			case "rdn_no":
	    		...
	    		comRASCallPop("ESM_BKG_0426", "ESM_BKG_1129", popParams, "");
				break;
		 	}
}
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
        case IBSEARCH: //조회
			...
			var sXml = sheet1.GetSearchXml("ESM_BKG_1129GS.do",FormQueryString(formObj));
			sheet1.LoadSearchXml(sXml);
			var cntrCnt = ComGetEtcData(sXml, "cntr_cnt");
			formObj.cntr_cnt.value = cntrCnt;
		...
		case IBSAVE:		//저장
			...
			var sXml = sheet1.GetSaveXml("ESM_BKG_1129GS.do", sParam);
