...
/**
 * @extends Bkg
 * @class ESM_BKG_1402:ESM_BKG_1402 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
...
//		           MergeSheet = msAll;
		           ...
		           //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
		            ...
		            var HeadTitle1 = "Booking\nRHQ|Booking\nOffice|BKG No.|Trunk VVD|POL ETD|Appl. Date|Acpt. Date\n(KR)|Acpt. Date\n(Local)|Day Diff|L Office|L Rep|Contract\nRHQ|Contract\nOffice|Contract Type|Contract No|Contract Holder|Amdt. Seq|Cre. Date|Req. Date|Eff. Date|Exp. Date|Apvl. date|Filed Date|Req. OFC|S.REP|Apvl. OFC|Appr. User|Scope|POR|POL|POD|DEL|SHPR|SHPR Name|CNEE|CNEE Name|NTFY|NTFY Name|BKG CNT|CTRT CNT|";
...
//					InitDataProperty(0 ,cnt++,	dtData,     40,     daCenter ,  true ,  "row_cnt",         false,    "",      dfNone,     0,    false,    false);
					...
					InitDataProperty(0, cnt++, dtData,     80,     daCenter,   true,   "rt_acpt_dt",       false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     80,     daCenter,   true,   "conv_acpt_dt",       false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     60,     daCenter,   true,   "day_diff",          false,   "",      dfNone,      0,    false,     false);
					InitDataProperty(0, cnt++, dtData,     90,     daCenter,   true,   "ob_sls_ofc_cd",     false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     90,     daCenter,   true,   "ob_srep_cd",     false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,   70,     daCenter,   true,   "ctrt_rhq_cd",     false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,   70,     daCenter,   true,   "ctrt_ofc_cd",     false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,	 90,	  daCenter,   true,	 "ctrt_tp",	          false,	"",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,	 90,	  daCenter,   true,	 "ctrt_no",	          false,	"",      dfNone,      0,	   false,	 false);
					InitDataProperty(0, cnt++, dtData,	 180,	  daLeft,   true,	 "ctrt_pty_nm",	          false,	"",      dfNone,      0,	   false,	 false);
					...
					InitDataProperty(0, cnt++, dtData,	 80,	  daCenter,   true,	 "req_dt",	          false,	"",      dfNone,      0,    false,    false);
					...
					InitDataProperty(0, cnt++, dtData,     80,    daCenter,   true,   "file_dt",		      false,    "",      dfNone,	     0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     70,    daCenter,   true,   "req_ofc",      false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     60,    daCenter,   true,   "req_srep",    false,    "",      dfNone,	     0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     70,    daCenter,   true,   "apro_ofc",    false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,     70,    daCenter,   true,   "apro_usr",      false,    "",      dfNone,       0,    false,    false);
					...
					InitDataProperty(0, cnt++, dtData,     65,    daLeft,    	true,   "shpr",       false,    "",      dfNone,      0,    false,    false);
					...
					InitDataProperty(0, cnt++, dtData,     65,    daLeft,    	true,   "ntfy", 		 false,    "",      dfNone,      0,    false,    false);
					InitDataProperty(0, cnt++, dtData,    180,    daLeft,    	true,   "ntfy_nm", 		 false,    "",      dfNone,      0,    false,    false);
		...
		var bkgNo 	   = sheet1.CellValue(Row, "bkg_no");    			
	 	...
	 	switch(colName){
	 		case "bkg_no":
		    	...
		    	comRASCallPop("ESM_BKG_0079", "ESM_BKG_1402", popParams, "");
				break;
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
        case IBSEARCH: //조회
			...
			var sXml = sheet1.GetSearchXml("ESM_BKG_1402GS.do",FormQueryString(formObj));
...
//        		if(null == ctrtTyObj.Code || "" == ctrtTyObj.Code){
...
function sheet1_OnSearchEnd(sheetObj, errMsg) {
    ...
    if(sheetObj.RowCount > 0){
    	form.bkg_cnt.value = sheetObj.CellValue(1,"bkg_cnt");
    	form.ctrt_cnt.value = sheetObj.CellValue(1,"ctrt_cnt");
    }else{
    	form.bkg_cnt.value = "0";
    	form.ctrt_cnt.value = "0";
    }
...
function changeOfcCdSubManual(obj) {
	...
	if (obj.checked) {
		formObj.bkg_ofc_cd_sub.value = "Y";
	} else {
		formObj.bkg_ofc_cd_sub.value = "N";
	}    			
}
