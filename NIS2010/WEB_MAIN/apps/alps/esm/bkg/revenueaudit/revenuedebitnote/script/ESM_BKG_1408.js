...
/**
 * @extends
 * @class esm_bkg_1408 : esm_bkg_1408 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function esm_bkg_1408() {
...
var uploadCnt = 0;
var URL_ESM_BKG = 'ESM_BKG_1408GS.do';
var prefix = "sheet1_";
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //sheet1 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, prefix + "rdn_no");
			InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, prefix + "rvis_seq");
...
function selectFile(sheetObj, Row, Col, _insert) {
	if (Col == '' || Col == '2') {
		...
		if (fileName.indexOf("\\") != -1) {
			...
			sheetObj.Cellvalue(Row, prefix + "rdn_no") = document.form.rdn_no.value;
			sheetObj.Cellvalue(Row, prefix + "rvis_seq") = document.form.rvis_seq.value;
		}
	}
}
///**
