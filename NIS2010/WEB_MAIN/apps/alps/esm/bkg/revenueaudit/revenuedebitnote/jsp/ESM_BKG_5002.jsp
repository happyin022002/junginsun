...
<%@ page import="com.hanjin.apps.alps.esm.bkg.revenueaudit.revenuedebitnote.event.EsmBkg5002Event"%>  
...
<%
	EsmBkg5002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg5002Event)request.getAttribute("Event");
...
<html>
<head>
<title>Unsettled RDN Aging Report</title>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="65">RDN Kind</td>
						<td width="105"><script language="javascript"> ComComboObject('rdn_knd_cd', 1, 90, 0, 0, 0, false);</script></td>
