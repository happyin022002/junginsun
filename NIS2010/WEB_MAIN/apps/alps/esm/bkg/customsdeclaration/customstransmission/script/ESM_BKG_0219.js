	...
	switch(sAction) {
		...
		case IBSEARCH:    // Retrieve
			...
			if (xmlArr[1] != null) {
				with (sheetObjects[1]) {
					...
					CellValue2(1, 1) = "SML INBOUND MANIFEST";
					CellValue2(1, 2) = "SML INBOUND MANIFEST";
					CellValue2(1, 3) = "SML INBOUND MANIFEST";
					RowMerge(1) =  true;
		...
		case IBDOWNEXCEL:    // Downexcel
			...
			with (sheetObj) {
				...
				"CNSHA") { var hjsYdcd = formObj.yd_cd.value.substr(5); switch
				(hjsYdcd) { case "W1": sipglYdcd = "WGQ1"; break; case "GQ":
