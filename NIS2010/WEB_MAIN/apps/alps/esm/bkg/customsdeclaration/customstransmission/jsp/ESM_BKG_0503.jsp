...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.korea.event.EsmBkg0503Event"%>
            ...
            <tr><td class="bg">
                ...
                <div style="display:none" id="col1">
					<table class="search" border="0" style="width:979;"> 
						...
						<tr><td class="stm" width="" style=" font-weight:bold;"> * TYPE_OTH (SML - NO BKG, CUST OPR BKG ONLY)</td></tr>
