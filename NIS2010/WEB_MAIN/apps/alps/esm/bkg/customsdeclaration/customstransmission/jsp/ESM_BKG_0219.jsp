...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.china.event.EsmBkg0219Event"%>
					...
					<td class="bg">
						...
						<table class="search" border="0" style="width:979px;">
							<tr class="h23">
								...
								<td>CNTR Owner&nbsp;
									<input type="text" name="cntr_owner" class="input2" style="width:60px; text-align:center;" readOnly value="SML"></td>
								<td>POR&nbsp;
