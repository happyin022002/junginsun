...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.canada.event.EsmBkgN003Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmBkgN003Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkgN003Event)request.getAttribute("Event");
	...
	<tr>
		<td class="bg">
			<table class="search" border="0" style="width:850">		
			 	<tr class="h23">
					<td width="20"><input type="radio" class="trans" name="ai_div" id="ai_div" value="GEN" checked></td>
					<td width="100">&nbsp;General AI</td>
					<td width="55">AI Type</td>
					<td width="130">
					...
					<td width="195"><input type="radio" class="trans" name="ai_div" id="ai_div" value="DEL" >&nbsp;Immediate Delete & AI</td>
					<td width="140">Status&nbsp;
						<select style="width:70;" name="sts_div">
				...
				<tr class="h23">
					...
					<td width="45">POL</td>
					<td width="80"><input type="text" style="width:60;ime-mode:disabled" class="input" name="pol_cd" dataformat="engup" maxlength="5" minlength="5" caption="POL"  value="<%=polCd%>"></td> 
					<td width="45">POD</td>
					<td width="100"><input type="text" style="width:60;ime-mode:disabled" class="input" 	name="pod_cd" dataformat="engup" maxlength="5" minlength="5" caption="POD"  value="<%=podCd%>"></td> 
