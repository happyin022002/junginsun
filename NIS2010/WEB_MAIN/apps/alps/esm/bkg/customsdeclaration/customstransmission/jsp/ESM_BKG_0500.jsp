...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.canada.event.EsmBkg0500Event"%>
					...
					<td width="140" rowspan="2">
						<table class="search_sm2" border="0" width="110">
							<tr class="h23">
								...
								<tr class="h23">
								<td  align="center">
									<select style="width:70;" name="trsm_msg_tp_id" onChange="trsm_msg_tp_id_onChange()">
