...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.canada.event.EsmBkg0431Event"%>
		...
		<table class="search" border="0" style="width:979;"> 
				...
				<tr class="h23">
					...
					<td><input type="text" style="width:120;ime-mode:disabled" class="input" 
						name="bl_no" dataformat="eng" maxlength="12" caption="B/L No" value="<%=strBlNo%>">
					</td> 
					<td colspan="4" id="td_a6_ata_only">
					 A6/ATA Only<INPUT class='trans' type='checkbox' value='Y' name="a6_ata_only">(B/L No. Is Not Checked)
					</td> 
				</tr>
			</table>
