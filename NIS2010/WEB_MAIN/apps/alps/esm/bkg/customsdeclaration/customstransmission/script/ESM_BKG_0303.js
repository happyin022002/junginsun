...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_0303 : ESM_BKG_0303 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_0303() {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			...
			case MULTI: 
				...
				ComOpenWait(true);
 				var sXml = sheetObj.GetSearchXml("ESM_BKG_0303GS.do", FormQueryString(formObj))
				var flatFile = ComGetEtcData(sXml, "flatFile");
 				
 				if(flatFile == "BKG43034") {
 					ComShowCodeMessage("BKG43034", "vvd & container"); // No downloaded {?msg1} data.
 					ComOpenWait(false);
 					return false;
 				}

 				var flatFiles = flatFile.split("||");
 				
 				var savedFileName = flatFiles[0];
 				flatFile = flatFiles[1];
