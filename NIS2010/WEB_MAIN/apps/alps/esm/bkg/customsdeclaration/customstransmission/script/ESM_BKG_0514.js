 ...
 *@FileTitle : Vessel Arrival Notice
 *Open Issues :
 *Change history :
...
/**
 * @extends
 * @class ESM_BKG-0514 : ESM_BKG-0514 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function esm_bkg_0514() {
...
case "sheet1": // sheet1 init
	with (sheetObj) {
		...
		var HeadTitle1 = "Flag|vvd|pod_cd|B/L count|Name|Eta";
		...
		case COMMAND01:
			...
			if (validateForm(sheetObj, formObj, sAction))
			{
				...
				if(confirm("Do you want to transmit HI to US Customs?")){
					...
					var sXml = sheetObj.GetSearchXml("ESM_BKG_0514GS.do", sParam);
					ComOpenWait(false);
