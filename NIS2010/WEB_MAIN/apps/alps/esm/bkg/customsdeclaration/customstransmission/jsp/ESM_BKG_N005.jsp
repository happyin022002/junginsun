...
*@FileName : ESM_BKG_N005.jsp
*@FileTitle : Canada Export: Transmission History
*Open Issues :
*Change history :
*@LastVersion : 1.0
* 
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.canada.event.EsmBkgN005Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkgN005Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkgN005Event)request.getAttribute("Event");
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="140" rowspan="2">
						<table class="search_sm2" border="0" width="110">
							<tr class="h23">
								...
								<tr class="h23">
								<td  align="center">
									<select style="width:70;" name="trsm_msg_tp_id">
					...
					<td width="130"><input type="text" style="width:90;ime-mode:disabled" class="input" 
						name="vvd_cd" dataformat="eng" maxlength="9" caption="VVD"></td> 
					<td width="45">POL</td>
					...
					<td rowspan="2" align="right">
						<table class="search_sm2" border="0" width="330">
							<tr class="h23">
								<td width="120"><input type="checkbox" class="trans" name="snd_dt_flg" value="true">&nbsp;Send Date</td></tr>
							<tr class="h23">
								<td class="stm">
				...
				<tr class="h23">
					...
					<td>OFFICE</td>
					<td><input type="text" style="width:90;" class="input" 
    		...
    		<table border="0" cellpadding="0" cellspacing="0">
    			<tr>
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn1_left"></td>
							<td class="btn1" name="btn_viewSendFile">View Sent File</td>
							<td class="btn1_right"></td>
							</tr>
						</table>
					</td>
