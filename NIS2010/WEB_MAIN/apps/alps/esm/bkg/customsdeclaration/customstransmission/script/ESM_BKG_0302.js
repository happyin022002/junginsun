...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_0302 : ESM_BKG_0302 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_0302() {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			...
			case MULTI: 
				...
				var savedFileName = formObj.vvd_cd.value;
				sheetObj.DataInsert(1);
				formObj.f_cmd.value = MULTI;
				
				ComOpenWait(true);
 				var sXml = sheetObj.GetSearchXml("ESM_BKG_0302GS.do", FormQueryString(formObj))
 				
 				var flatFile = ComGetEtcData(sXml, "flatFile");
 				
 				if(flatFile == "BKG43034") {
 					ComShowCodeMessage("BKG43034", "vvd & B/L & container"); // No downloaded {?msg1} data.
 					ComOpenWait(false);
 					return false;
 				}
