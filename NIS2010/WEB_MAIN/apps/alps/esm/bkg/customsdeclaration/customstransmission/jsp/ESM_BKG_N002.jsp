...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.canada.event.EsmBkgN002Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkgN002Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkgN002Event)request.getAttribute("Event");
	...
	<tr>
		<td class="bg">
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="30">VVD</td>
					<td width="120"><input type="text" style="width:90;ime-mode:disabled" class="input1" name="vvd_cd" maxlength="9" dataformat="eng" minlength="9" caption="VVD" value="<%=vvdCd%>" required></td> 
					<td width="30">POL</td>
					<td width="90"><input type="text" style="width:50;ime-mode:disabled" class="input1" required name="pol_cd" maxlength="5" dataformat="eng" minlength="5" value="<%=polCd%>" caption="POL"></td> 
					<td width="30">ETL</td>
					<td width="160"><input type="text" style="width:130;" class="input" name="etl_dt" readOnly></td>
					<td width="30">POD</td>
					<td width="90"><input type="text" style="width:50;ime-mode:disabled" class="input" name="pod_cd" maxlength="5" dataformat="eng" minlength="5" caption="POD" value="<%=podCd%>"></td>
					<td width="60">Customs</td>
					<td width="80"><input type="text" style="width:50;ime-mode:disabled" class="input" name="cstms_port_cd" maxlength="5" dataformat="eng" minlength="5" caption="Customs"></td>
					<td width="150">
...
<table class="search" id="mainTable"> 
	<tr>
		<td class="bg">
			...
			<table class="grid2" border="0" width="750" style="display:none;">
				<tr>
