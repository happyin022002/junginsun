...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.canada.event.EsmBkgN004Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EsmBkgN004Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkgN004Event)request.getAttribute("Event");
...
<html>
<head>
<title>Canada Export: B/L Inquiry</title>
