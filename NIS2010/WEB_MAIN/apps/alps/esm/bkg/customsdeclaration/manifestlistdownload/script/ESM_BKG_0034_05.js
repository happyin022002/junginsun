 ...
 ***************************************************************************************/
	...
	/**
	 * @extends
	 * @class ESM_BKG_0034_05 : ESM_BKG_0034_05 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1:
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++ , dtData,		45,		daCenter,		false,		"his_tp_id",		false,		"",	dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,		60,		daCenter,		false,		"his_itm_ctnt",		false,		"",	dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,		240,	daLeft,			false,		"pre_ctnt",			false,		"",	dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,		240,	daLeft,			false,		"crnt_ctnt",		false,		"",	dfNone,			0,		false,		false);
				...
				InitDataProperty(0, cnt++ , dtData,		120,	daCenter,		false,		"cre_dt",			false,		"",	dfUserFormat2,	0,		false,		false);
...
//				ComOpenWait(true);
				formObj.f_cmd.value = SEARCH01;
				if(PageNo >= 1){
					sheetObj.DoSearch("ESM_BKG_0034_05GS.do", CondParam, "page_no=" + PageNo, true);
				}else{
					sheetObj.DoSearch("ESM_BKG_0034_05GS.do", FormQueryString(formObj), "page_no=1", false);
				}
//				ComOpenWait(false);
				break;
		}
