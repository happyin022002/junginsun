...
* 1.0 Creation
*
* 1.1 2011.06.01 민정호 [CHM-201111028] AMS - Customs Data Download (D/L) 화면 validation추가
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.usa.event.EsmBkg0210Event"%>
...
<%
	...
	try {
		...
		if(strPgmNo.indexOf("0210") > 0){
			if(strPgmNo.endsWith("1")) strCustoms = "Origin US";
			if(strPgmNo.endsWith("2")) strCustoms = "US";
			if(strPgmNo.endsWith("3")) strCustoms = "Origin CA";
			if(strPgmNo.endsWith("4")) strCustoms = "CA";
		}
    ...
    <!--biz page (S)-->
        ...
        <tr><td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width="25">POL</td>
                    <td width="100"><input type="text" style="width:50; ime-mode: disabled;" value="<%=polCd%>" class=<%=strCustoms.startsWith("Origin") ? "input1" : "input" %>
                    dataformat="engupnum" name="pol_cd" maxlength="5" fullfill caption="POL" <%=strCustoms.startsWith("Origin") ? "required" : "" %>></td> 
                    <td width="20">POD</td>
                    <td width="100"><input type="text" style="width:50; ime-mode: disabled;" value="<%=podCd%>" class=<%=!strCustoms.startsWith("Origin") ? "input1" : "input" %>
                    dataformat="engupnum" name="pod_cd" maxlength="5" fullfill caption="POD" ></td> 
                    
                    <% if ( "ESM_BKG-0210_2".equals(request.getParameter("pgmNo")) ) { %>
						<td width="20">Customs</td>
	                    <td width=""><input type="text" style="width:50; ime-mode: disabled;" value="<%=customsCd %>" class=<%=!strCustoms.startsWith("Origin") ? "input1" : "input" %>
	                    dataformat="engupnum" name="customs_cd" maxlength="5" fullfill caption="Customs" ></td> 
					<% } else { %>
						<td width="20"></td>
	                    <td width="390"></td> 
					<% } %>
        ...
        <tr><td class="btn1_bg">
            ...
            <% if (strCustoms.indexOf("CA") < 0) { %>
                ...
                <td>
                	<table class="search" border="0" style="width:;"> 
                	<tr>
                    <td width="70">Actual Filing</td>
                    <td width="40">
                    	<select name="act_file_skd_dir_cd">
                    		<option value=""></option>
            ...
            <% } %>
                ...
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn1_left"></td>
                    <td class="btn1" name="btn_edi">Terminal EDI</td>
                    <td class="btn1_right"></td>
                    </tr>
                </table></td>
                <% } %>
                ...
                <td>
                    ...
                    <table class="search" border="0" style="width:;"> 
                    <tr>
                        <td><input type="checkbox" name="chkAllPol" class="trans"> All POL</td>
                        <td width=10></td>
                    </tr>
                    </table>
                    </div>
