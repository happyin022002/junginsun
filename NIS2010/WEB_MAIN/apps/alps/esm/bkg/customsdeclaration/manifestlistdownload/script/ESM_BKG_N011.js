...
//     
     function loadPage() {
         ...
         initControl();
     	if (formObject.cvy_ref_no.value != "") {
     ...
     function doActionIBSheet(sheetObj,formObj,sAction,row) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:       				
				...
				var sXml = sheetObj.DoSearch("ESM_BKG_N011GS.do", FormQueryString(formObj));
				...
				if(sheetObj.FindText("download_flag","Y") > 0) {
					ComBtnDisable("btn_Delete");
				}
 			...
 			case IBDELETE:        
				...
				var sXml = sheetObj.GetSaveXml("ESM_BKG_N011GS.do" , sParam);
