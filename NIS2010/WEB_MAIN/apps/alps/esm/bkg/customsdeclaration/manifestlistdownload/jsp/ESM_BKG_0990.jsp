...
<input type="hidden" name="form1_vvd_cd" value="<%=vvd_cd%>">
<input type="hidden" name="form1_pod_cd" value="<%=pod_cd%>">
<!-- 개발자 작업	-->
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"> Manifest Registration (MFS)_B/L ADD</span></td></tr>
		</table>	
		<!-- : ( Title ) (E) -->
			...
			<table class="search">  
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="220"><input type="text" style="width:110;" name="form1_dummy_bl_no" value="" class="input1" maxlength="12" readonly></td>
					<td width="50">Stage</td>
					<td width=""><select style="width:67;" name="form1_stage">
