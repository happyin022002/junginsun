    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			...
			case IBSEARCH : // 조회
				...
				var sXml =  sheetObj.GetSearchXml("ESM_BKG_1127GS.do", FormQueryString(formObj));
		...
		switch(sheetID) {
			...
			case "sheet1":
					with (sheetObj) {
						...
						InitDataProperty(0, cnt++ , dtData,  120, daCenter,  true,  "gmt_time",      false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  120, daCenter,  true,  "local_time",    false,  "",  dfNone,  0,  false,  false);
						...
						InitDataProperty(0, cnt++ , dtHidden,  120, daCenter,  true,  "mrn_no",        false,  "",  dfNone,  0,  false,  false);
