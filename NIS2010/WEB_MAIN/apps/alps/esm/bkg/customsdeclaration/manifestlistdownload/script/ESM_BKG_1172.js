...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_1172 : ESM_BKG_1172 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_1172() {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			...
			case IBSEARCH : // 조회
				...
				var sXml =  sheetObj.GetSearchXml("ESM_BKG_1172GS.do", FormQueryString(formObj));
		...
		switch(sheetID) {
			...
			case "sheet1":
					with (sheetObj) {
						...
						var HeadTitle1 = "|Seq.|Type|Message|VVD|POD|Time|Time|RCV_MSG|Result|Result|MSG Send No.|By|By|BY_NAME|edi_rcv_dt|edi_rcv_seq";
				        var HeadTitle2 = "|Seq.|Type|Message|VVD|POD|GMT|Local|RCV_MSG|Result|Result|MSG Send No.|By|By|BY_NAME|edi_rcv_dt|edi_rcv_seq";
						...
						InitDataProperty(0, cnt++ , dtData,  70,  daCenter,  true,  "type_cd",       false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  70,  daCenter,  true,  "msg_type",      false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  80,  daCenter,  true,  "vvd",           false,  "",  dfNone,  0,  false,  false);
						//InitDataProperty(0, cnt++ , dtData,  50,  daCenter,  true,  "cstms_port_cd", false,  "",  dfNone,  0,  false,  false);
						...
						InitDataProperty(0, cnt++ , dtData,  120, daCenter,  true,  "msg_snd_no",        false,  "",  dfNone,  0,  false,  false);
