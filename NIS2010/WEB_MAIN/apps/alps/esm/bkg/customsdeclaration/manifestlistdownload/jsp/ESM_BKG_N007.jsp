...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.canada.event.EsmBkgN007Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EsmBkgN007Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkgN007Event)request.getAttribute("Event");
