...
function processButtonClick() {
	...
	try {
		 ...
		 *********************************************/
		case "btn_1_1":
			sUrl = "ESM_BKG_0249.do&pgmNo=ESM_BKG_0249";
			sId = "ESM_BKG_0249"
			break;
		case "btn_1_2":
			sUrl = "ESM_BKG_0111.do&pgmNo=ESM_BKG_0111";
			sId = "ESM_BKG_0111"
			break;
		case "btn_1_3":
			sUrl = "ESM_BKG_0393.do&pgmNo=ESM_BKG_0393_3";
			sId = "ESM_BKG_0393"
			break;
		case "btn_1_4":
			sUrl = "ESM_BKG_0210.do&pgmNo=ESM_BKG-0210_3";
			sId = "ESM_BKG_0210"
			break;
		case "btn_1_5":
			sUrl = "ESM_BKG_0002.do&pgmNo=ESM_BKG_0002";
			sId = "ESM_BKG_0002"
			break;
		case "btn_1_6":
			sUrl = "ESM_BKG_0028.do&pgmNo=ESM_BKG_0028_3";
			sId = "ESM_BKG_0028"
			break;
		case "btn_1_7":
			sUrl = "ESM_BKG_0029.do&mainPage=true&pgmNo=ESM_BKG_0029";
			sId = "ESM_BKG_0029"
			break;
		case "btn_1_8":
			sUrl = "ESM_BKG_0500.do&pgmNo=ESM_BKG_0500";
			sId = "ESM_BKG_0500"
			break;
		case "btn_1_9":
			sUrl = "ESM_BKG_0431.do&mainPage=true&pgmNo=ESM_BKG_0431";
			sId = "ESM_BKG_0431"
			break;
		case "btn_1_10":
			sUrl = "ESM_BKG_0142.do&pgmNo=ESM_BKG_0142";
			sId = "ESM_BKG_0142"
			break;
		/***************************************************************************************************************
		 * Canada Menu
		...
		case "btn_2_1":
			...
			break;
		case "btn_2_2":
			sUrl = "ESM_BKG_0210.do&pgmNo=ESM_BKG-0210_4";
			sId = "ESM_BKG_0210"
			break;
		case "btn_2_3":
			sUrl = "ESM_BKG_0002.do&pgmNo=ESM_BKG_0002_2";
			sId = "ESM_BKG_0002"
			break;
		case "btn_2_4":
			sUrl = "ESM_BKG_0015.do&pgmNo=ESM_BKG_0015";
			sId = "ESM_BKG_0015"
			break;
		case "btn_2_5":
			sUrl = "ESM_BKG_0568.do&pgmNo=ESM_BKG_0568";
			sId = "ESM_BKG_0568"
			break;
		case "btn_2_6":
			sUrl = "ESM_BKG_0028.do&pgmNo=ESM_BKG_0028_4";
			sId = "ESM_BKG_0028"
			break;
		case "btn_2_7":
			sUrl = "ESM_BKG_0029.do&mainPage=true&pgmNo=ESM_BKG_0029_2";
			sId = "ESM_BKG_0029"
			break;
		case "btn_2_8":
			sUrl = "ESM_BKG_0025.do&pgmNo=ESM_BKG_0025";
			sId = "ESM_BKG_0025"
			break;
		case "btn_2_9":
			sUrl = "ESM_BKG_0013.do&pgmNo=ESM_BKG_0013";
			sId = "ESM_BKG_0013"
			break;
		case "btn_2_10":
			sUrl = "ESM_BKG_0016.do&pgmNo=ESM_BKG_0016";
			sId = "ESM_BKG_0016"
			break;
		case "btn_2_11":
			sUrl = "ESM_BKG_0354.do&pgmNo=ESM_BKG_0354";
			sId = "ESM_BKG_0354"
			break;
		} // end switch
		if (sId != "")
