...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_1112 : esm_bkg_1112 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_1112(){
...
function doActionIBSheet(sheetObj,formObj,sAction){
	...
	switch(sAction){
		case SEARCH :	//조회
			...
			var sXml = sheetObj.GetSearchXml("ESM_BKG_1112GS.do", FormQueryString(formObj));
