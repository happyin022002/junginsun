...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.russia.event.EsmBkg1165Event"%>
...
<LINK href="/hanjin/css/nis2010_contents.css" type="text/css" rel="stylesheet"/>
								...
								<td>		
								    ...
								    <!--<td><input type="text" name="sh_cust_cnt_cd" style="width:25;" class="input1" value="" maxlength=2 style="ime-mode:disabled"  dataformat="engup" tabindex=11>&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_t7Sh0192" id="btn_t7Sh0192">&nbsp;<input type="text" name="sh_cust_seq" style="width:58;" class="input1" value="" maxlength=6 style="ime-mode:disabled"  dataformat="int" tabindex=12>&nbsp;<img class="cursor" src="img/btns_inquiry.gif" width="19" height="20" border="0" align="absmiddle" name="btn_t7ShMdmCustNm" id="btn_t7ShMdmCustNm">&nbsp;<input type="text" name="sh_cust_lgl_eng_nm" style="width:120;" class="input2" value="" readonly>&nbsp;<input type="text" style="width:25;" class="input2" value="" readonly name="sh_cust_tp">&nbsp;<script language="javascript" >ComComboObject('kr_cstms_cust_tp_cd', 2, 90, 1, 0, 2)</script></td>-->
										...
										<tr class="h23">
											...
											<td><textarea  cols="35" rows="2" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img2" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('2','35',this, 'Shipper');" class="textarea1" name="sh_cust_nm" tabindex=13><%=sh_cust_nm%></textarea></td>
										</tr>
										<tr class="h23">
											<td width="" class="stm">Address</td>
											<td width=""colspan="6"><textarea cols="35" rows="3" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img3" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('3','35',this, 'Shipper');" wrap="hard"  class="textarea1" name="sh_cust_addr" tabindex=14><%=sh_cust_addr%></textarea></td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr class="h23">
								<td>								
									...
									<!--<td class="stm"><input type="text" name="cn_cust_cnt_cd" style="width:25;" class="input1" value="" maxlength=2 style="ime-mode:disabled"  dataformat="engup" tabindex=21>&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_t7Cn0192" id="btn_t7Cn0192">&nbsp;<input type="text"  name="cn_cust_seq" style="width:58;" class="input1" value="" maxlength=6 style="ime-mode:disabled"  dataformat="int" tabindex=22>&nbsp;<img class="cursor" src="img/btns_inquiry.gif" width="19" height="20" border="0" align="absmiddle" name="btn_t7CnMdmCustNm" id="btn_t7CnMdmCustNm">&nbsp;<input type="text" name="cn_cust_lgl_eng_nm" style="width:120;" class="input2" value="" readonly>&nbsp;<input type="text" style="width:25;" class="input2" value="" readonly name="cn_cust_tp">&nbsp;B/L Type&nbsp;<select style="width:60;" class="input" name="cust_to_ord_flg"><option value="Y">Order</option><option value="N">Straight</option></select></td>-->
										...
										<tr class="h23">
											<td width="68" class="stm">Name</td>
											<td ><textarea  cols="35" rows="2" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img2" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('2','35',this, 'Consignee');" wrap="hard"  name="cn_cust_nm" tabindex=23><%=cn_cust_nm%></textarea></td>
										</tr>
										<tr class="h23">
											<td width="" class="stm">Address</td>
											<td width=""><textarea cols="35" rows="3" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img3" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('3','35',this, 'Consignee');" wrap="hard"  name="cn_cust_addr" tabindex=24><%=cn_cust_addr%></textarea></td>
										</tr>
									</table>							
								</td>
							</tr>
							...
							<tr class="h23">
								<td>								
									...
									<tr class="h23"width="100%">
										...
										<tr class="h23">
											<td width="68" class="stm">Name</td>
											<td ><textarea  cols="35" rows="2" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img2" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('2','35',this, 'Notify');" wrap="hard"  name="nf_cust_nm" tabindex=43><%=nf_cust_nm%></textarea></td>
										</tr>
										<tr class="h23">
											<td width="" class="stm">Address</td>
											<td width=""><textarea cols="35" rows="3" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img3" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('3','35',this, 'Notify');" wrap="hard"  name="nf_cust_addr" tabindex=44><%=nf_cust_addr%></textarea></td>
										</tr>
									</table>
								...
								<td>								
									...
									<!--<td class="stm"><input type="text" name="cn_cust_cnt_cd" style="width:25;" class="input1" value="" maxlength=2 style="ime-mode:disabled"  dataformat="engup" tabindex=21>&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_t7Cn0192" id="btn_t7Cn0192">&nbsp;<input type="text"  name="cn_cust_seq" style="width:58;" class="input1" value="" maxlength=6 style="ime-mode:disabled"  dataformat="int" tabindex=22>&nbsp;<img class="cursor" src="img/btns_inquiry.gif" width="19" height="20" border="0" align="absmiddle" name="btn_t7CnMdmCustNm" id="btn_t7CnMdmCustNm">&nbsp;<input type="text" name="cn_cust_lgl_eng_nm" style="width:120;" class="input2" value="" readonly>&nbsp;<input type="text" style="width:25;" class="input2" value="" readonly name="cn_cust_tp">&nbsp;B/L Type&nbsp;<select style="width:60;" class="input" name="cust_to_ord_flg"><option value="Y">Order</option><option value="N">Straight</option></select></td>-->
										...
										<td width="68">Export Reference No.&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td><textarea  cols="35" rows="3" style="font-family:Courier New; font-size:15px; text-indent:0px;overflow-y:scroll;overflow-x:hidden" class="textarea_img3" wrap="physical" dataformat="etc" onBlur="javascript:validateCols('3','35',this, 'Export Ref.');" wrap="hard"  name="ex_cust_nm" tabindex=23><%=ex_cust_nm%></textarea></td>
										</tr>
									</table>							
								</td>
							</tr>
