   ...
   /**
			...
			switch(sheetID) {
				...
				case "sheet1":
						with (sheetObj) {
							...
							InitDataProperty(0,		cnt++ , dtData,					170,	daLeft,			true,		"brz_cmdt_cd",		false,		"",		dfNone,					0,		false,	true);
							InitDataProperty(0,		cnt++ , dtData,					500,	daLeft,			true,		"cmdt_desc",		false,		"",		dfNone,					0,		false,	true);
							InitDataProperty(0,		cnt++ , dtData,					220,	daLeft,			true,		"cmdt_cate_ctnt",	false,		"",		dfNone,					0,		false,	true);
    ...
    function sheet1_OnDblClick(sheetObj,Row,Col) {
        ...
        try{    	
			...
			obj.cd = sheetObj.CellValue(Row, "brz_cmdt_cd");
			obj.nm = sheetObj.CellValue(Row, "cmdt_desc");
