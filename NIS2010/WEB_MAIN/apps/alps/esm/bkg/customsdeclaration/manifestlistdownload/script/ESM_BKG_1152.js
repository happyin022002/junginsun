     ...
     function sheet1_OnSearchEnd(sheetObj, ErrMsg) {
         with (sheetObj) {
             ...
             for(var i= HeaderRows; i<= LastRow; i++) {
                if (CellValue(i,"exs_snt_rejt") != "0") {
                	CellFontColor(i,"exs_snt_rejt") = redColor;
                }
                if (CellValue(i,"exs_snt_donl") != "0") {
                	CellFontColor(i,"exs_snt_donl") = redColor;
                }
                if (CellValue(i,"exs_snt_nrcv") != "0") {
                	CellFontColor(i,"exs_snt_nrcv") = redColor;
                }
                if (CellValue(i,"exs_snt_hold") != "0") {
                	CellFontColor(i,"exs_snt_hold") = redColor;
                }
                if (CellValue(i,"exs_unsnt_cnt") != "0") {
                	CellFontColor(i,"exs_unsnt_cnt") = redColor;
                }
             }
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			...
			case IBSEARCH : // 조회
				...
				var sXml =  sheetObj.GetSearchXml("ESM_BKG_1152GS.do", FormQueryString(formObj));
		...
		switch(sheetID) {
			...
			case "sheet1":
					with (sheetObj) {
						...
						InitDataProperty(0, cnt++ , dtData,  80,  daCenter,  true,  "eu_pol",		false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  80,  daCenter,  true,  "bkg_pol",		false,  "",  dfNone,  0,  false,  false);
						...
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter, false,  "exs_snt_accp",	false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter, false,  "exs_snt_rejt",	false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter, false,  "exs_snt_donl",	false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter, false,  "exs_snt_nrcv",	false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter, false,  "exs_snt_hold",	false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter, false,  "exs_snt_rels",	false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter,  true,  "exs_unsnt_cnt",false,  "",  dfNone,  0,  false,  false);
						InitDataProperty(0, cnt++ , dtData,  60,  daCenter,  true,  "exs_amd_cnt",	false,  "",  dfNone,  0,  false,  false);
