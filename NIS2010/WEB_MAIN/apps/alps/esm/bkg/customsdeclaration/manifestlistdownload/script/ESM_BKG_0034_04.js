 ...
 ***************************************************************************************/
	...
	/**
	 * @extends
	 * @class ESM_BKG_0034_04 : ESM_BKG_0034_04 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	...
	function processButtonClick() {
		...
		try {
			...
			case "btn_railAMS":
				...
				var cntr_no = sheetObj.CellValue(selRow, "cntr_no");
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1:
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++ , dtHidden,	200,	daCenter,	false,		"diff_rmk",			false,		"",	dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,		120,	daCenter,	false,		"cntr_no",			false,		"",	dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,		120,	daCenter,	false,		"rail_crr_ref_no",	false,		"",	dfNone,			0,		false,		false);
				InitDataProperty(0, cnt++ , dtData,		120,	daCenter,	false,		"ibd_trsp_no",		false,		"",	dfNone,			0,		false,		false);
