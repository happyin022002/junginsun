...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.usa.event.EsmBkg0613Event"%><%@ page import="org.apache.log4j.Logger" %>
...
<html>
<head>
<title>US AMS: Manifest Transmit (MI)</title>
	...
	<tr><td valign="top">
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="30">POL</td>
						<td width="110">
							<input type="text" name="pol" style="width:50;ime-mode:disabled" maxlength="5" class="<%="ESM_BKG_0613".equals(pgmNo)?"input1":"input" %>" dataformat="engupnum" <%="ESM_BKG_0613".equals(pgmNo)?"required":"" %> fullfill caption="POL"  value="<%=polCd%>">
						</td>
						<td width="30">POD</td>
						<td width="80">
							<input type="text" name="pod" style="width:50;ime-mode:disabled" maxlength="5" class="<%="ESM_BKG_0613_2".equals(pgmNo)?"input1":"input" %>" dataformat="engupnum" fullfill caption="POD"  value="<%=podCd%>">
						</td>
						<td width="70">Customs</td>
						<td width="100">
							<input type="text" name="customs" style="width:50;ime-mode:disabled" maxlength="5" class="<%="ESM_BKG_0613_2".equals(pgmNo)?"input1":"input" %>" dataformat="engupnum" fullfill caption="Customs">
						</td>
						<td width="130">Actual Filing VVD</td>
						<td width="100"><input type="text" name="actualvvd" style="width:80;ime-mode:disabled" class="input2" readonly></td>
		...
		<table class="search" id="mainTable"> 
   		<tr><td class="bg">	
			...
			<tr><td width="18%" align="center">Total</td>
				<td class="sm">&nbsp;&nbsp;&nbsp;01 H/BL&nbsp;&nbsp;<input type="text" name="hbl01" style="width:40;text-align:center;" class="input" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				01 M/BL&nbsp;&nbsp;<input type="text" name="mbl01" style="width:40;text-align:center;" class="input" value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table class="search" border="0" style="width:135;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr><!-- 2009/06/16 request by Jung MinJung 
		    	<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_OFM_List_Retrieve">OFM List Retrieve</td>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_OfmGeneration">OFM Generation</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				</tr>
		...
		<table class="search" border="0" style="width:100%;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Add_BL">B/L Add</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Edit_BL">B/L Inquiry</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
