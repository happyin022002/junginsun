...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.eur24.event.EsmBkg1124Event"%>
...
<input type="hidden" name="search_prev_doc_no" value="">
<input type="hidden" name="ack_cd" value="">
<input type="hidden" name="his_ack_cd" value="">
<!-- 개발자 작업	-->
	...
	<tr><td valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
			<% if (!"".equals(strBlNo)) { %>
				...
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;EXS B/L Inquiry (EU Office)</td></tr>
			<% } else {%>
		...
		<td class="bg">
			...
			<table class="search" border="0" style="width:880;">
				<tr class="h23">
					...
					<td width="80">
						<select name="type_cd" style="width:80" class="input2" disabled=true>
			             <option value="O" selected>Export</option>
			             </select>					
					</td>
					<td width="70" align=right>Status&nbsp;</td>
					<td width="110" id='msg_func_id_field'>
				    ...
				    <td width="110" id='msg_func_hold_field'>
						<!-- <script language="javascript">ComComboObject('msg_func_hold', 1, 100, 1)</script>  -->
						<select name="msg_func_hold" style="width:100">
			            	<!-- <option value="D" selected>Hold (Doc.)</option>
			            	<option value="P">Hold (Phys.)</option>
			            	<option value="L">Hold Release</option> -->
						</select>
					</td>
					<td width="160">
						<input type="text" name="local_time" style="width:110;" class="input2" readonly>
					</td>
			...
			<table class="search" border="0" style="width:980;">
				<tr class="h23">
					...
					<td width="460"><input type="text" name="cstms_desc" style="width:380;" class="input"></td>	
					<td width="60">Prev. Doc</td>
					<td width="175">
						<input type="text" name="prev_doc_no" style="width:170;" class="input2" Readonly>
					</td>
					<td width="100">
						<input type="text" name="prev_doc_yd" style="width:90;" class="input2" Readonly>
					</td>
					...
					<td width="80">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr>
								<td><img src="./img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor" name="btn_prevDoc_pop" id="btn_prevDoc_pop"></td>
							</tr>
						</table>
					</td>
					<td width="*">&nbsp;</td>
