...
<input type="hidden" name="dspo_cd">
...
<table class="search">
	<tr>
		<td class="bg">
			...
			<!-- : ( Grid ) (S) -->
			<table width="100%" id="mainTable" style="width:979;height:285;">
				<tr>
					<td width="100%" valign="top"><script language="javascript">ComSheetObject('t3sheet1');</script>
					</td>
				</tr>
				<tr>
					<td width="100%" valign="top"><script language="javascript">ComSheetObject('t3sheet2');</script>
					</td>
				</tr>
			</table>
			<!-- : ( Grid ) (E) -->
