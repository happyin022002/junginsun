...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.canada.event.EsmBkg1178Event"%>
...
<html>
<head>
<title>Canada ACI: CRN( Conveyance Ref. No.) Delete</title>
	...
	<tr>
		<td valign="top">
			<table width="100%" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; CRN Delete</td></tr>
			</table>
			...
			<table class="search">
				<tr>
					...
					<td width="30">CRN</td>
								...
								<td width="150">
									<input type="text" style="width:90; ime-mode:disabled" name="cvy_ref_no" class="input1" maxlength="20"  required caption="CRN" >	
								</td>
							</tr>
						</table>
					</td>
