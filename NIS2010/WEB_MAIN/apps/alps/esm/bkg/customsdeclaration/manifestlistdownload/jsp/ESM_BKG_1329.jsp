...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.korea24.event.EsmBkg1329Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%
	EsmBkg1329Event event 		= null; //PDTO(Data Transfer Object including Parameters)
	...
	try
	{
		...
		event = (EsmBkg1329Event) request.getAttribute("Event");
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;">
					<tr class="h23">
						...
						<td width="30" style="display:none">POL</td>
						<td width="60"" style="display:none">
							<input type="text" name="in_pol" class="input" style="width:50; text-align:center;" dataformat="engupnum" maxlength="5"
								value="">
						</td>
						<td width="33">POD</td>
						<td width="87">
							<input type="text" name="in_pod" class="input1" style="width:47; text-align:center;" dataformat="engupnum" maxlength="5" onChange="funcOnFocus('pod')"
								 value="">&nbsp;<input type="text" name="in_hn" class="input" style="width:25; text-align:center;" value="" dataformat="eng" maxlength="2">
						</td>
						<td width="36">Type</td>
						<td width="110">
							<select style="width:105;" class="input" name="sel_type">
						...
						<td width="100">
							...
							<tr class="h23">
								...
								<td class="stm">
									...
									<input type="radio" class="trans" name="rad_ob" style="display:none">
<!--
									&nbsp;O/B
-->
								</td>
						...
						<td width="70" align="right" id="sc_td1" style="display:none; visibility:hidden;">&nbsp;C/S&nbsp;</td>
						<td width="120" align="right" id="sc_td2" style="display:none; visibility:hidden;"><script language="javascript">ComComboObject('sc', 2, 80, 1, 0)</script></td>
						<td width="40" style="visibility:hidden;"><input type="text" class="input" name="msn_start_num" style="width:34; text-align:center; display:none;" maxlength="4" dataformat="int"></td>
						<td width="170" align="right" style="visibility:hidden;"><table id="tb_msn_save" style="display:none;" width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td>
							<td class="btn2" name="btn_msn_save" id="btn_msn_save">MSN Save</td>
							<td class="btn2_right"></td>
							</tr>
							</table></td>
						<td width="40" align="right" id="etb_td1" style="display:none;">ETB</td>
						<td width="120" align="right" id="etb_td2" style="display:none;"><input type="text" name="etb_dt" class="input2" style="width:80; text-align:center;" ReadOnly></td>
					</tr>
				</table>
					...
					<tr class="h23">
						...
						<td width="227">
							...
							<tr class="h23">
								...
								<td class="stm" style="display:none;">
...
<Form name="transmitForm" id="transmitForm" method="POST" Action="/hanjin/ESM_BKG_1344.do?pgmNo=ESM_BKG_1344" target="transmitWindow">
