...
<html>
<head>
<title>ROCS:Receive History</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="600">
						<table class="search_sm" border="0" style="width:580;"> 
							<tr class="h23">
								...
								<td>								
								<input type="radio"  name="gubun" value="2" class="trans">Received Date&nbsp;
								
								<input type="text"
							style="width: 70; ime-mode: disabled" class="input1" maxlength="10" value="<%=JSPUtil.replace(DateTime.getDateString(),".","-")%>"
					...
					<td width="30">POL</td>
					<td width="80"><input type="text" name="pol_cd" style="width:60; ime-mode: disabled;" class="input"
                        dataformat="engupnum" maxlength="5" fullfill caption="POL"></td>
					<td width="30">POD</td>
					<td width="80"><input type="text" name="pod_cd" style="width:60; ime-mode: disabled;" class="input"
                        dataformat="engupnum" maxlength="5" fullfill caption="POD"></td> 
                    <td width="100">PODCalling Seq.</td>
