...
<%@ page import="com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.hongkong.event.EsmBkg0282Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
				<td width="40">&nbsp;&nbsp;VVD</td>
				<td width="150"><input name="vvd_number" type="text" style="text-align:center"  style="width:80" value="" class="input1" dataformat="uppernum" style="ime-mode: disabled" maxlength="9"></td>
					
				<td width="300">
				<table class="search_sm2" border="0" style="width:200;"> 
				<tr class="h23">
					<td width="70"><input name="pol_flg" type="radio"  class="trans" value="pol"   checked>POL</td>
					<td width="65"><input  name="pol_flg"  type="radio"  class="trans" value="pod" >&nbsp;&nbsp;POD</td>
					<td width=""><input    name="pol_code" type="text" style="width:50" value="CNHKG" class="input1" style="text-align:center" style="ime-mode: disabled" dataformat="engupnum" maxlength="5"></td>
					</tr>
				</table>
				</td>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="180"><input name="call_sign_no" type="text" style="width:70" value="" class="input2" readonly></td>
					<td width="30">ETD</td>
