     ...
     function processButtonClick(){
     	...
     	try {
             ...
             switch(srcName) {
 							...
 							case "btn_downexcel":
 								sheetObject1.SpeedDown2Excel(0,false,false,"","",false,false,"",false,"ibflag|Chk","",false,"");
 							break;
           ...
           case "sheet1":      //sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle = "|Sel.|Seq.|History|Received Result|B/L No.|Received Date|VVD|POL|POD|POD Calling\nSeq.|Received Seq|Error Code|Error Description|Error Ref";
                     ...
                     InitDataProperty(0, cnt++ , dtData,			50,     daCenter,    false,     "hist",      				false,    "",      dfNone, 			0,     false,		false);
 					 ...
 					 // Add. 2015.04.20
 					 InitDataProperty(0, cnt++ , dtData,      		70,     daCenter,    false,     "pod_clpt_ind_seq",			false,    "",      dfNone, 			0,     false,		false);
					 
 					 InitDataProperty(0, cnt++ , dtData,      		95,     daCenter,    false,     "rowcnt",     				false,    "",      dfNone, 			0,     false,		false);
 					 InitDataProperty(0, cnt++ , dtData,      		100,    daCenter,    false,     "rtm_edi_err_id",      	false,    "",      dfNone, 			0,     false,		false);

 					 InitDataProperty(0, cnt++ , dtData,      		220,    daLeft,    false,     "err_desc",					false,    "",      dfNone, 			0,     false,		false);
 					 InitDataProperty(0, cnt++ , dtData,      		110,    daLeft,    false,     "err_ctnt",      			false,    "",      dfNone, 			0,     false,		false);
                 ...
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     InitDataProperty(0, cnt++ , dtData,			50,     daCenter,    false,     "hist",      				false,    "",      dfNone, 			0,     false,		false);
 					 ...
 					 InitDataProperty(0, cnt++ , dtData,      		220,    daCenter,    false,     "err_desc",					false,    "",      dfNone, 			0,     false,		false);
 					 InitDataProperty(0, cnt++ , dtData,      		110,    daCenter,    false,     "err_ctnt",      			false,    "",      dfNone, 			0,     false,		false);
           ...
           case "sheet3":
               with (sheetObj) {
                  ...
                  //전체Edit 허용 여부 [선택, Default false]
                   ...
                   var HeadTitle = "Seq.|History|Received Result|B/L No.|Received Date|VVD|POL|POD|POD Calling\nSeq.|Received Seq.|Error Code|Error Description|Error Ref.";
   ...
   // Sheet관련 프로세스 처리
 					...
 					case COMMAND03:        //print 						
 						...
 						if(sheetObjects[0].RowCount >0)
 						{
 							...
 							for(var i=0; i<=sheetObjects[0].RowCount; i++){
 								...
 								sheetObjects[2].CellValue2(i,"pod_clpt_ind_seq") = sheetObjects[0].CellValue(i,"pod_clpt_ind_seq");  // Add. 2015.04.20
 								
 								sheetObjects[2].CellValue2(i,"rowcnt") = sheetObjects[0].CellValue(i,"rowcnt");
 								sheetObjects[2].CellValue2(i,"rtm_edi_err_id") = sheetObjects[0].CellValue(i,"rtm_edi_err_id");
 								sheetObjects[2].CellValue2(i,"err_desc") = sheetObjects[0].CellValue(i,"err_desc");
 								sheetObjects[2].CellValue2(i,"err_ctnt") = sheetObjects[0].CellValue(i,"err_ctnt");				    		 
 							}
 						}					 
						...
						ComOpenWindowCenter("/hanjin/ESM_BKG_0448_1.do?pgmNo=ESM_BKG_0448_1", "0448_1", 1024, 700, false);						 
					break;
 					case COMMAND02:        //LOG View
 						if(!validateForm(sheetObj,formObj,sAction)) {
							return false;
						} 
 						var sUrl = "/hanjin/ESM_BKG_1027.do?pgmNo=ESM_BKG_1027&rcv_snd_div_cd=R&sheet_msg_snd_dt="+formObj.sheet_msg_snd_dt.value+"&sheet_bl_no="+formObj.sheet_bl_no.value;
     ...
     function validateForm(sheetObj,formObj,sAction){
      ...
      function sheet1_OnClick(SheetObj, Row, Col){
    	  ...
    	  document.form.sheet_vvd_number.value = sheetObjects[0].CellValue( Row, "vvd_number" );
     	  document.form.sheet_pol_cd.value = sheetObjects[0].CellValue( Row, "pol_cd" );
     	  document.form.sheet_pod_cd.value = sheetObjects[0].CellValue( Row, "pod_cd" );
       ...
       {    	  
     	  ...
     	  var rownumber = 0;     	  
     	  sheetObjects[1].DoSearch("ESM_BKG_0448GS.do", FormQueryString(document.form));     	   
