 ...
 * 1.2 2011.08.05 민정호 [CHM-201111822] Split 05-R4J Rule Upgrade 관련 소스품질 향상을 위한 조치 건
=========================================================*/%>
        ...
        <table class="search" id="mainTable"> 
            <tr><td class="bg">
                ...
                <tr class="h23"> 
                    ...
                    <td width="140"><select style="width:71;" name="bkg_cgo_tp_cd" class="input1" <%="O".equals(strTransMode) ? "disabled" : "" %>>
                        <option value="">All</option>
                        <option value="F" selected>Full</option>
                        <option value="P">Empty</option>
                        </select></td>
                    <td><table class="search_sm2" border="0" style="width:250;"> 
                			<tr class="h23"> 
                    			...
                    			<td width="" class="stm">
                        			...
                        			<input type="radio" class="trans" name="trans_type" value="ts">T/S 
                        		</td>
             			   </tr>
                		</table>    
                    </td> 
<%if(strPgmNo.equals("ESM_BKG_0216-1")) {%>                    
                    <td><table class="search_sm2" border="0" style="width:100; margin-left:20px"> 
                			<tr class="h23"> 
                    			<td width="" class="stm">
                        			<input type="radio" class="trans" name="err_div" value="all" checked>All&nbsp;
                        			<input type="radio" class="trans" name="err_div" value="err">Error&nbsp;
                        		</td>
             			   </tr>
                		</table>    
                    </td> 
<%} else { %>
                    <td><table style="width:100; margin-left:20px"> 
                			<tr class="h23"> 
                    			<td></td>
             			   </tr>
                		</table>    
