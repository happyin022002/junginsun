...
<html>
<head>
<title>NIS vs Portnet Reconciliation Print</title>
	...
	<tr>
		<td valign="top">
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"><span id="notitle">&nbsp; NIS vs Portnet Reconciliation Print</span></td>
				</tr>
			</table>
			<table class="search">
				<tr>
