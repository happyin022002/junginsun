...
<html>
<head>
<title>SEA EXPORT CARGO MANIFEST Print</title>
	...
	<tr>
		<td valign="top">
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"><span id="notitle">&nbsp; SEA EXPORT CARGO MANIFEST Print</span></td>
				</tr>
			</table>
			<table class="search">
				<tr>
