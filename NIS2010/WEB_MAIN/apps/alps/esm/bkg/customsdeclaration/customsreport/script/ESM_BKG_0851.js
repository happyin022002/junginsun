...
function rdOpen(){
	...
	sXml +="<ETC>" ;
	sXml +="<MRN_NO>"+opener_sheet_obj1.EtcData("mrn_no")+"</MRN_NO>" ;
	sXml +="<BL_TP_CD>"+opener_sheet_obj1.EtcData("bl_tp_cd")+"</BL_TP_CD>" ;
	sXml +="<SHIP_NM>"+opener_sheet_obj1.EtcData("ship_nm")+"</SHIP_NM>" ;
	sXml +="<ETA_DT>"+opener_sheet_obj1.EtcData("eta_dt")+"</ETA_DT>" ;
	sXml +="<PORT_CD>"+opener_sheet_obj1.EtcData("port_cd")+"</PORT_CD>" ;
	sXml +="</ETC>";
	sXml +="</SHEET>";
...
//	RD_path = "http://localhost:7001/hanjin/"; // TEST 할때만..
	rdObjects[0].FileOpen(RD_path+'apps/alps/esm/bkg/customsdeclaration/customsreport/report/ESM_BKG_0851.mrd' ,RDServer);
}