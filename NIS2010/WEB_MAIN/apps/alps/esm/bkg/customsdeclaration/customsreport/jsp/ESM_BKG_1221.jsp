		...
		<table class="search"> 
			...
			<table class="search" border="0">
				...
				<tr class="h23">
					...
					<td width="110"><input type="text" name="export_vvd" style="width:90; ime-mode: disabled;" class="input1" dataformat="eng" minlength="9" maxlength="9" fullfill caption="Export VVD" required></td> 
					</tr>
