...
<input type="hidden" name="event_no" value="0340">
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
			...
			<td width="30">Mode</td>
			<td width=""><input type="text" style="width:70" value=" Inbound" class="input2" ReadOnly></td>
			</tr>
			</table>
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					...
					<td width="30">MSN</td>
					<td width="160"><input type="text" style="width:70" name="msn_no" class="input" style="ime-mode:disabled; text-align:center;" dataformat="num" maxlength="4"></td>
					<td width="37">Type</td>
					<td width=""><select name="mrn_bl_ts_cd" style="width:82;">
