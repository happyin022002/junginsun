...
*@FileName : ESM_BKG_0805.js
*@FileTitle : ESM_BKG_0805.js
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
	...
	*/
	function rdOpen(){
		...
		var opener_obj = opener;
		var opener_sheet_obj1 = window.dialogArguments.document.sheet2;
		...
		var urlPath = RD_path+'apps/alps/esm/bkg/customsdeclaration/customsreport/report/ESM_BKG_0805.mrd';
		
		//urlPath = "http://localhost:7001/hanjin/apps/alps/esm/bkg/customsdeclaration/customsreport/report/ESM_BKG_0805.mrd";
