...
<%@ page import="com.hanjin.apps.alps.esm.bkg.wharfagemgt.wharfagedecmgt.kr.event.EsmBkg0416Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:959;"> 
					<tr class="h23">
						<td width="35">Port</td>
						<td><input type="text" maxlength="5" style="width:60;ime-mode: disabled" class="input1" name="port_cd" dataformat="engupnum"></td>
					</tr> 
				</table>
				<!--  biz_1   (E) -->
