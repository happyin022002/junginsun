    	...
    	try {
            ...
            switch(srcName) {
            	...
            	case "btn_add":
					...
					sheetObject1.CellValue2(rowNum, "attr_ctnt1") = formObject.attr_ctnt1.value;
				break;
				...
				switch(sheetID) {
					...
					case "sheet1":
							with (sheetObj) {
								...
								InitDataProperty(0,		cnt++ , dtData,					200,	daCenter,		false,		"attr_ctnt2",						false,		"",		dfNone,					0,		true,		true);
								InitDataProperty(0,		cnt++ , dtData,					50,		daCenter,		false,		"attr_ctnt3",					false,		"",		dfSaupNo,				0,		true,		true);
								InitDataProperty(0,		cnt++ , dtHidden,					50,		daCenter,		false,		"hrd_cdg_id_seq",					false,		"",		dfNone,				0,		true,		true);
								
								InitDataProperty(0,		cnt++ , dtHidden,					200,	daCenter,		false,		"attr_ctnt1",						false,		"",		dfNone,					0,		true,		true);
        ...
        switch(sAction) {
			...
			case IBSAVE:        //저장
				...
				if( validateForm(sheetObj,formObj,sAction) ){
	    	        ...
	    	        var SaveXml = sheetObj.GetSaveXml("ESM_BKG_0738GS.do", sParam);
			...
			case IBDOWNEXCEL:
				if( sheetObj.RowCount > 0 )
					sheetObjects[0].Down2Excel(-1, false, false, true, "", "", false, false, "", true, "Chk");
				else
...
//			} else {
				try {
		    		var obj = new Object();
		    		obj.vRgstNo = sheetObj.Cellvalue(Row, 'attr_ctnt3');
		    		window.returnValue = obj;
		    		self.close();
				}catch(e) {}
//			}
