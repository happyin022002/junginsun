...
<%@ page import="com.hanjin.apps.alps.esm.bkg.wharfagemgt.wharfagedecmgt.kr.event.EsmBkg0560Event"%>
	...
	<tr><td valign="top">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="80">CNTR/BULK</td>
					<td width="120"><select style="width:67;" class="input1" name="cntr_blk_div_cd">
						<option value="A" selected="selected" >All</option>
						<option value="C">CNTR</option>
						<option value="B">BULK</option>
						</select></td>
					<td width="30">Port</td>
					<td width=""><input type="text"  maxlength="5" style="width:60;ime-mode: disabled" class="input1" dataformat="engupnum" name="port_cd"></td>
				</tr>
				</table>
