...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.blrating.blrating.event.EsmBkg0771Event"%>
...
<table width="100%" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Covered B/L</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) --> <!--biz page (S)-->
