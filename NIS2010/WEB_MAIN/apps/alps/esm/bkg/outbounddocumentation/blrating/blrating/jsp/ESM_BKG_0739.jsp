...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.blrating.blrating.event.EsmBkg0739Event"%>
...
<input type="hidden" name="rfa_no" value='<%=JSPUtil.getParameter(request, "rfa_no")%>'>
...
<input type="hidden" name="ctrt_tp_cd" value ="R">
...
<input type="hidden" name="frm_rtro_flg">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; RFA Information</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<table class="search" border="0" style="width:100%;">
				<tr class="h23">
					...
					<td width="110">Application Date</td>
					...
					<td width=""><input type="text" style="width:110" class="input" name="frm_frfa_no" value="<%=JSPUtil.getParameter(request, "rfa_no")%>" readonly></td>
					</tr>
			</table>
				...
				<tr class="h23">
					<td width="690" valign="top">
						<table width="100%" class="grid2">
							...
							<tr align="center">
								<td width="100" class="tr2_head"> RFA customer	</td>
			...
			<table class="search" border="0" style="width:880;">
				<tr class="h23">
					...
					<td width="177"><input type="text" style="width:110;text-align:right;" class="input2" name="frm_act_wgt" value="" readonly>&nbsp;<input type="text" style="width:30;text-align:right;" class="input2" name="frm_wgt_ut_cd" value="" readonly></td>
