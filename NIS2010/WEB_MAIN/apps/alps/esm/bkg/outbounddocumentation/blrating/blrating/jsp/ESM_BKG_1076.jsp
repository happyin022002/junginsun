...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.blrating.blrating.event.EsmBkg1076Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg1076Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1076Event)request.getAttribute("Event");
...
<input type="hidden" name="taa_no" value='<%=JSPUtil.getParameter(request, "taa_no")%>'>
...
<input type="hidden" name="ctrt_tp_cd" value ="T">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; TAA Information</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<table class="search" border="0" style="width:100%;">
				<tr class="h23">
					...
					<td width="35">CRD</td>
					<td width="150"><input type="text" style="width:80;text-align: center" class="input2" name="frm_cntr_cdr_dt" value="<%=JSPUtil.getParameter(request, "application_date")%>" readonly></td>
					<td width="60">&nbsp;TAA No.</td>
					<td width=""><input type="text" style="width:110" class="input" name="frm_ftaa_no" value="<%=JSPUtil.getParameter(request, "taa_no")%>" readonly></td>
						</tr>
			</table>
				...
				<tr class="h23">
					<td width="690" valign="top">
						<table width="100%" class="grid2">
							...
							<tr align="center">
								<td width="100" class="tr2_head">  TAA customer	</td>
							...
							<tr align="center">
								<td width="100" class="tr2_head"> Commodity	</td>
								<td colspan="2" class="input2"><input type="text" style="width: 100%; text-align: right" class="noinput2" name="frm_cmdt_cd" value='' readonly>	</td>
							...
							<tr align="center">
								...
								<td align="left" class="input2"><input type="text" style="width: 100%; text-align: left" class="noinput2" name="frm_rep_cmdt_nm" value='' readonly></td>
							</tr>
							<tr align="center">
			...
			<table class="search" border="0" style="width:880;">
				<tr class="h23">
					...
					<td width="177"><input type="text" style="width:110;text-align:right;" class="input2" name="frm_act_wgt" value="" readonly>&nbsp;<input type="text" style="width:30;text-align:right;" class="input2" name="" value="" readonly></td>
					...
					<td width=""><input type="text" style="width:110;text-align:right;" class="input2" name="frm_meas_qty" value="" readonly>&nbsp;<input type="text" style="width:40;text-align:center;" class="input2" name="frm_meas_ut_cd" value="" readonly></td>
						...
						<table class="search" border="0" style="width:100%;">
								<tr class="h23">
									...
									<input type="text" style="width:50;" class="input2" name="frm_del_cd" value="">
									</td>
									<td width="25">Pre</td>
									<td width="82"><input type="text" style="width:50;text-align:center;" class="input2"  name="frm_vv_pol_cd"  value="" readonly></td>
									<td width="32">Post</td>
									<td width="80"><input type="text" style="width:50;text-align:center;" class="input2"  name="frm_vv_pod_cd" value="" readonly></td>
									<td width="25">R/D</td>
									<td width="70"><input type="text" style="width:18;text-align:center;" class="input2"  name="frm_rcv_term_cd" value="" readonly>&nbsp;<input type="text" style="width:18;text-align:center;" class="input2"  name="frm_de_term_cd"  value="" readonly></td>
									<td width="50">Special</td>
									<td width="40"><input type="text" style="width:18;text-align:center;" class="input2"  name="frm_special" value="" readonly></td>
