...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.blrating.blrating.event.EsmBkg1604Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg1604Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1604Event)request.getAttribute("Event");
...
<html>
<head>
<title>Charge Amend Request</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Charge Amend Request</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
