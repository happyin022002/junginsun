...
<%
	 ...
	 *@FileName : esm_bkg_2006.jsp
	 *@FileTitle : INV IV Status Monitoring
	 *Open Issues :
	 *Change history :
...
<%
	EsmBkg2006Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg2006Event) request.getAttribute("Event");
	       	...
	       	<tr><td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width="400">
									<input type="text" style="width:80" value="" class="input1"  name="fm_dt"  maxlength='10' dataformat='ymd'>
								            ~
								...
								<td width="170"><input type="text" style="width:100" value="" class="input1" name="bkg_no" maxlength='13' style="ime-mode:disabled"></td>
								<td width="600"></td>
