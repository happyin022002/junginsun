    	...
    	try {
            ...
            switch(srcName) {
				...
				case "btn_exchange":
					...
					ComOpenWindowCenter(url, "ESM_BKG_0945", 435, 350, false);					
				break;
				...
				case "btn_downexcel":
					sheetObject2.SpeedDown2Excel(-1, true, true, '', '', false, false, '', false, "ibflag|seq|sel|SEALPop|PCKPop");
				break;												
				...
				case "btn_remark":
					...
					ComOpenWindowCenter(url, "ESM_BKG_0265", 450, 370, false);						
				break;																																				
            ...
            case "sheet1":      //sheet1 init
                ...
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++,  dtData,    100,    daRight,    false,    "op_cntr_qty",   false,    "",          dfFloat,     2,          false,     false);
            ...
            case "sheet2":      //sheet2 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  false,    "sel",                false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtHidden,       30,    daCenter,  false,    "bkg_no",             false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtHidden,       30,    daCenter,  false,    "cntr_rt_seq",        false,    "",         dfNone,     0,          false,        false);
                    ...
                    InitDataProperty(0, cnt++, dtData,         60,    daRight,   false,    "chg_ut_amt",         false,    "",         dfFloat,    2,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daRight,   false,    "rat_as_qty",         false,    "",         dfFloat,    3,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daRight,   false,    "bkg_qty",            false,    "",         dfFloat,    2,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "rat_ut_cd",          false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daRight,   false,    "chg_amt",            false,    "",         dfFloat,    2,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "frt_term_cd",        false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "frt_incl_xcld_div_cd", false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "n3pty_rcv_ofc_cd",   false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "n3pty_cust_cnt_cd",  false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "n3pty_cust_seq",     false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "cgo_cate_cd",        false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "rcv_term_cd",        false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "de_term_cd",         false,    "",         dfNone,     0,          false,        false);
                    InitDataProperty(0, cnt++, dtData,         60,    daCenter,  false,    "imdg_clss_cd",       false,    "",         dfNone,     0,          false,        false);
            ...
            case "sheet3":      //sheet3 init
                ...
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    //데이터속성    [ROW, COL,  DATATYPE,  WIDTH,  DATAALIGN,  COLMERGE,  SAVENAME,        KEYFIELD,  CALCULOGIC,  DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                    InitDataProperty(0, cnt++,  dtData,    100,    daCenter,   false,    "cust_tp",        false,    "",          dfNone,      0,          false,     false);
                    InitDataProperty(0, cnt++,  dtData,    100,    daCenter,   false,    "curr_cd",  false,    "",          dfNone,      0,          false,     false);
                    InitDataProperty(0, cnt++,  dtData,    100,    daRight,    false,    "chg_amt",   false,    "",          dfFloat,     2,          false,     false);
            ...
            case "sheet4":      //sheet4 init
                ...
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    //데이터속성    [ROW, COL,  DATATYPE,  WIDTH,  DATAALIGN,  COLMERGE,  SAVENAME,        KEYFIELD,  CALCULOGIC,  DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                    InitDataProperty(0, cnt++,  dtData,    100,    daCenter,   false,    "cust_tp",        false,    "",          dfNone,      0,          false,     false);
                    InitDataProperty(0, cnt++,  dtData,    100,    daCenter,   false,    "cust_key",  false,    "",          dfNone,      0,          false,     false);
                    InitDataProperty(0, cnt++,  dtData,    100,    daCenter,   false,    "ofc_cd",  false,    "",          dfNone,      0,          false,     false);
                    InitDataProperty(0, cnt++,  dtData,    100,    daCenter,   false,    "cnt_cd",  false,    "",          dfNone,      0,          false,     false);
  ...
  // Sheet관련 프로세스 처리
        ...
        switch(sAction) {
			...
			case IBSEARCH:      //조회
				if(validateForm(sheetObj,formObj,sAction)){
                    ...
                    var rXml = sheetObj.GetSearchXml("ESM_BKG_1043GS.do", FormQueryString(formObj));
			...
			case IBSAVE:        //저장
				if(validateForm(sheetObj,formObj,sAction)){
					...
					// return xML
					var rXml = sheetObj.GetSaveXml("ESM_BKG_1043GS.do", FormQueryString(formObj));
	...
	function getAmtTable(type){
		...
		if(idxArr.length == 0){
			...
			curr_cd = sheetObj.CellValue(idxArr[0], "curr_cd");
			chg_amt = sheetObj.CellValue(idxArr[0], "chg_amt");
			...
			for (ix = 0; ix < idxArr.length; ix++) {
				curr_cd = sheetObj.CellValue(idxArr[ix], "curr_cd");
				chg_amt = sheetObj.CellValue(idxArr[ix], "chg_amt");
				tableText += "\t<tr><td width=\"40\" class=\"tr2_head\">"+curr_cd+"</td><td align=\"right\">"+ComAddComma3(chg_amt, "#,###.00")+"</td></tr>"; 
			}			
		}
		tableText += "</table>"; 
	...
	function getOfficeTable(type){
		...
		if(idxArr.length == 0){
			...
			for (ix = 0; ix < idxArr.length; ix++) {
				cust_key = sheetObj.CellValue(idxArr[ix], "cust_key");
				ofc_cd = sheetObj.CellValue(idxArr[ix], "ofc_cd");
				cnt_cd = sheetObj.CellValue(idxArr[ix], "cnt_cd");
				cust_seq = sheetObj.CellValue(idxArr[ix], "cust_seq");
