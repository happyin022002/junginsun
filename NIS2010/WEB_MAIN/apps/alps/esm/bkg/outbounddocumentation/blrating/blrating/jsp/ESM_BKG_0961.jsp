...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.blrating.blrating.event.EsmBkg0961Event"%>
...
<html>
<head>
<title>freight & Charge_booking customer Inquiry</title>
...
<input type="hidden" name="call_type" value='<%=JSPUtil.getParameter(request, "call_type")%>'>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Booking Customer Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
