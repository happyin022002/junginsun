...
<html>
<head>
<title>Export / Import Information (LEBANON)</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for Lebanon Customs</td></tr>
				...
				<tr class="h23">
					...
					<td width=""><input type="text" style="width:200;" class="input" name="exp_lb_shpr_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Consignee VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_lb_cnee_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Notify VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_lb_ntfy_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
...
<input type="hidden" name="xter_rqst_seq" value="<%=xter_rqst_seq%>">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="120">Shipper VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_lb_shpr_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Consignee VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_lb_cnee_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Notify VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_lb_ntfy_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
