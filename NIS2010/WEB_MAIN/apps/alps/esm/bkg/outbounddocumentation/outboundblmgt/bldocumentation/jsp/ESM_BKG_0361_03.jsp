...
<html>
<head>
<title>Export / Import Information (Brazil)</title>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for BRAZIL Customs</td></tr>
				...
				<table class="search" border="0">
				<tr class="h23">
					<td width="130">Shipper CPF/CNPJ</td>
					<td width="172"><input type="text" style="width:170;" class="input" name="exp_shpr_tax_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="exp_shpr_tax_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
					<tr class="h23">
					<td width="">Consignee CPF/CNPJ</td>
					<td width=""><input type="text" style="width:170;" class="input" name="exp_cnee_tax_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="exp_cnee_tax_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
					<tr class="h23">
					<td width="">Notify CPF/CNPJ</td>
					<td width=""><input type="text" style="width:170;" class="input" name="exp_ntfy_tax_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="exp_ntfy_tax_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
					<tr class="h23">
					<td width="">DDE/SD</td>
					<td width=""><input type="text" style="width:170;" class="input" name="exp_brz_decl_no" maxlength="11" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="exp_brz_decl_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
...
<input type="hidden" name=bdrFlg>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="130">Shipper CPF/CNPJ</td>
					<td width="172"><input type="text" style="width:170;" class="input" name="imp_shpr_tax_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="imp_shpr_tax_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
					<tr class="h23">
					<td width="">Consignee CPF/CNPJ</td>
					<td width=""><input type="text" style="width:170;" class="input" name="imp_cnee_tax_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="imp_cnee_tax_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
					<tr class="h23">
					<td width="">Notify CPF/CNPJ</td>
					<td width=""><input type="text" style="width:170;" class="input" name="imp_ntfy_tax_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="imp_ntfy_tax_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
					<tr class="h23">
					<td width="">DDE/SD</td>
					<td width=""><input type="text" style="width:170;" class="input" name="imp_brz_decl_no" maxlength="11" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="imp_brz_decl_cpy_desc_flg" class="trans" value="Y" onClick="javascript:copyToDesc(this);">Copy to Description </td>
					</tr>
				</table>
