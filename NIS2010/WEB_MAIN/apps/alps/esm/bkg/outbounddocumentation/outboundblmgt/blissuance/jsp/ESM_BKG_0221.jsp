...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.outboundblmgt.blissuance.event.EsmBkg0221Event"%>
...
<%
	...
	try {
        ...
        form_cntcDtl   = JSPUtil.getParameter(request, "form_cntcDtl"		                );
...
<input type="hidden" name="form_cntcDtl"   value="<%=form_cntcDtl  %>">
...
<tr><td valign="top">
	...
	<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Edit Fax &amp; Email</td></tr>
	</table>
	<!-- : ( Title ) (E) -->
	...
	<table class="search"><tr><td class="bg">
		<table class="search" border="0" style="width:100%;"> 
			<tr class="h23">
				<td width="70">Fax&nbsp;&nbsp;</td>
				<td width="280"><input name="fax" type="text" style="width:270;" class="input" value="<%=fax_no%>" maxlength="50"></td>
			</tr>
			<tr></tr>
			<tr></tr>
			<tr></tr>
			...
			<tr class="h23">
				...
				<td width="280"><input name="email" type="text" style="width:270;" class="input" value="<%=email%>" maxlength="200"></td>
			</tr>
		</table>
	</td></tr></table>
	<!-- : ( Search Options ) (E) -->
...
<input type="hidden" name="send_hidden"    value="<%=send_hidden   %>">
