...
*@FileName : ESM_BKG_0361_10.jsp
*@FileTitle : Export / Import Information (PERU)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 김용진
...
<html>
<head>
<title>Export / Import Information (PERU)</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for PERU Customs</td></tr>
