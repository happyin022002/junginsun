...
*@FileName : ESM_BKG_0361_09.jsp
*@FileTitle : Export / Import Information (ECUADOR)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 김용진
...
<html>
<head>
<title>Export / Import Information (ECUADOR)</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for ECUADOR Customs</td></tr>
				...
				<tr class="h23">
					...
					<td width=""><input type="text" style="width:200;" class="input" name="exp_mx_shpr_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Consignee Tax ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_mx_cnee_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Notify Tax ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_mx_ntfy_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
...
<input type="hidden" name="xter_rqst_seq" value="<%=xter_rqst_seq%>">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="120">Shipper Tax ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_mx_shpr_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Consignee Tax ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_mx_cnee_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Notify Tax ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_mx_ntfy_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
