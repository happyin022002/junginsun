...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.outboundblmgt.blissuance.event.EsmBkg0927Event"%>
				...
				<tr class="h23">
					<td width="400">
						<table class="search_sm2" border="0" style="width:380;"> 
							...
							<tr class="h23">
								<td width="40">&nbsp;</td>
								<td  class="stm"><input type="checkbox" name="cntc_dtl_flg" value="Y" class="trans" checked>Contact detail (Draft B/L)</td>
							</tr> 
						</table>	
					</td>
					<td width="">
...
<form name="form3" method="post"><!-- 0221 팝업 -->
  ...
  <input type="hidden" name="form_cntcDtl">
