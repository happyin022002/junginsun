...
<html>
<head>
<title>Export / Import Information (Togo)</title>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for TOGO Customs</td></tr>
				...
				<table class="search" border="0">
				<tr class="h23">
					<td width="200">ECTN</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_tg_ectn_no"  dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="exp_tg_ectn_no_cpy_desc_flg" class="trans" value="Y"  checked="checked" disabled="disabled">Copy to Description </td>
					</tr>
...
<input type="hidden" name=issFlg>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="200">ECTN</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_tg_ectn_no" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="imp_tg_ectn_no_cpy_desc_flg" class="trans" value="Y"  checked="checked" disabled="disabled">Copy to Description </td>
					</tr>
				</table>
