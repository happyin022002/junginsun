...
<html>
<head>
<title>Export / Import Information (Korea)</title>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s"> Export License Number for Korea</td></tr>
				<tr><td class="height_5"></td></tr>
				</table>
				<table class="search" border="0">
				<tr class="h23">
					<td width="80">Booking No.</td>
					<td width=""><input type="text" name="bkg_no" style="width:110;" class="input2" value="<%=bkg_no%>" readonly></td>
					</tr>
				</table>
...
<input type="hidden" name="xter_rqst_seq" value="<%=xter_rqst_seq%>">
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<table class="search" border="0">
				<tr><td class="title_h"></td>
					<td class="title_s"> Import License Number for Korea</td></tr>
				<tr><td class="height_5"></td></tr>
				</table>
				<table class="search" border="0">
				<tr class="h23">
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;">
       	<tr><td class="btn3_bg">
		    ...
		    <tr>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_rowAdd2">Row Add</td>
					<td class="btn1_right"></td>
				</tr></table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
