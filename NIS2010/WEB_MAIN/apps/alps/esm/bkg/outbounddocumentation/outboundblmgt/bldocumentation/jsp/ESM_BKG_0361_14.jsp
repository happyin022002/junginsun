...
<html>
<head>
<title>Export / Import Information (Nigeria)</title>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for NIGERIA Customs</td></tr>
				<tr><td class="height_5"></td></tr>
				</table>
				<table class="search" border="0">
				<tr class="h23">
					<td width="200">Booking No.</td>
				...
				<table class="search" border="0">
				<tr class="h23">
					<td width="200">EXS(Exit Summary Number)</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_ng_exs_ens_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="exp_ng_exs_ens_no_cpy_desc_flg" class="trans" value="Y"checked="checked" disabled="disabled">Copy to Description </td>
					</tr>
				</table>
				<table class="search" border="0">	
				<tr>
					<td style="color: red;font-size: 13;">* EXS Validation : <a href = "https://acdnigeria.com/" target="_blank" style="color: red;font: bold;" >https://acdnigeria.com/</a></td>
				</tr>
				<tr>
					<td style="color: red;font-size: 13;">* You must check the EXS validity before insertion</td>
				</tr>
				</table>
...
<input type="hidden" name=issFlg>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<table class="search" border="0">
				<tr class="h23">
					<td width="200">ENS(Entry Summary Number)</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_ng_exs_ens_no" maxlength="14" dataformat="engup"></td>
					<td width="" class="stm"><input type="checkbox" name="imp_ng_exs_ens_no_cpy_desc_flg" class="trans" value="Y"  checked="checked" disabled="disabled">Copy to Description </td>
					</tr>
				</table>
				
				<table class="search" border="0">	
				<tr>
					<td style="color: red;font-size: 13;">* ENS Validation : <a href = "https://acdnigeria.com/" target="_blank" style="color: red;font: bold;" >https://acdnigeria.com/</a></td>
				</tr>
				<tr>
					<td style="color: red;font-size: 13;">* You must check the ENS validity before insertion</td>
				</tr>
				</table>
