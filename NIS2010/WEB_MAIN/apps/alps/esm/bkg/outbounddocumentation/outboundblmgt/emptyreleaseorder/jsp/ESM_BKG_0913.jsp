...
<%@ page import="com.hanjin.apps.alps.esm.bkg.outbounddocumentation.outboundblmgt.emptyreleaseorder.event.EsmBkg0913Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.OutboundBLMgtSC.EmptyReleaseOrderBC");
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; Edit Remark(s) </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<table class="search">
       		<tr><td class="bg">
				...
				<tr align="center">
					<td><textarea name='text_remark' style="width:100%;height:140"></textarea></td>
				</tr>
				</table>
		    <!-- : ( Button : Grid ) (E) -->
