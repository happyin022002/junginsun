...
<input type="hidden" id="blNoList" value="<%=StringUtil.xssFilter(request.getParameter("blNoList"))%>" />
<input type="hidden" id="seqList" value="<%=StringUtil.xssFilter(request.getParameter("seqList"))%>" />
<input type="hidden" name="strUsr_id" value="<%=strUsr_id%>">
<input type="hidden" name="rjct_rsn_rmk" value="">
<!-- OUTER - POPUP (S)tart -->
<table class="popup" cellpadding="10" width="100%" height="670"> 
<tr><td class="top"></td></tr>
<tr><td valign="top">
	
		<!-- : ( Title ) (S) -->
		<table width="100%" border="0">
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;<%=StringUtil.xssFilter(request.getParameter("com_mrdBodyTitle")) %></td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		<table id="rdTable" width="100%" height=98%">
			<tr>
...
<% if (StringUtil.xssFilter(request.getParameter("divFlg")).equals("Y")) { %>	
<!--Button (S) -->
       	...
       	<tr><td class="btn1_bg">
		    ...
		    <tr>	
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn1" name="btn_Previous" id="btn_Previous">Previous</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Next" id="btn_Next">Next</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
...
<tr><td height="69" class="popup">
<% }else if(StringUtil.xssFilter(request.getParameter("divFlg")).equals("B")) {%>
	<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top: 5; , padding-bottom: 5;"> 
       	<tr><td class="btn1_bg">
		    <table border="0" cellpadding="0" cellspacing="0">
		    <tr>	
