...
*@FileName : ESM_BKG_0361_12.jsp
*@FileTitle : Export / Import Information (ISRAEL)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 이재위
...
* -----------------------------------------------------------
* History
* 2012.08.03 이재위 [CHM-201219301] [M&D Export&Import Information] Israel VAT ID추가
...
<html>
<head>
<title>Export / Import Information (ISRAEL)</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Manifest Data for Israel Customs</td></tr>
				...
				<table class="search" border="0">
				<tr class="h23">
					<td width="120">Shipper VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_il_shpr_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Consignee VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_il_cnee_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Notify VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="exp_il_ntfy_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
...
<input type="hidden" name="xter_rqst_seq" value="<%=xter_rqst_seq%>">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="120">Shipper VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_il_shpr_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Consignee VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_il_cnee_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
				<tr class="h23">
					<td width="">Notify VAT ID</td>
					<td width=""><input type="text" style="width:200;" class="input" name="imp_il_ntfy_tax_id" dataformat="etc"  maxlength="20" value=""></td>
					</tr>
