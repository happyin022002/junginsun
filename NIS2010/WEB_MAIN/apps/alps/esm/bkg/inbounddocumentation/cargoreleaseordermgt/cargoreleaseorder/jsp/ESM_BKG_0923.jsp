...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg0923Event"%>
...
<html>
<head>
<title>Inbound Cargo Release for POD Office Popup History</title>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle" />&nbsp; Inbound Cargo Release Order for POD Office Pop-up History</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
