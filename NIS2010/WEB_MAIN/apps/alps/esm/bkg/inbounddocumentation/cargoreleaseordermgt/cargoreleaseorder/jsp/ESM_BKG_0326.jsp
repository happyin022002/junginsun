...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg0326Event"%>
...
<html>
<head>
<title>Japan Cargo Release Order (D/O)</title>
...
<script language="javascript">
    ...
    **************************************/
    ...
    var lginOfcCd = "<%=strOfc_cd%>"; //로그인 사용자 오피스 코드
    var lginCntCd = "<%=strCnt_cd%>"; //로그인 사용자 국가 코드
...
<input type='hidden' name ='jpDoSndStsCd'>
...
<!-- CCT, Third Office(CCT) 클릭 시 데이터 저장 변수(안진응) -->
    ...
    <td valign="top">
        ...
        <tr><td class="btn1_bg">
            ...
            <td>
                ...
                <tr>
                    <td class="btn1_left"></td>
                    <td class="btn1" name="btn_assign">Assign / Issue</td>
                    <td class="btn1_right"></td>
                </tr>
                </table>
            </td>
            ...
            <td>
                ...
                <tr>
                    <td class="btn1_left"></td>
                    <td class="btn1" name="btn_dorcancel">DOR Cancel</td>
                    <td class="btn1_right"></td>
                </tr>
                </table>
            </td>
        ...
        <tr>
            <td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width="160">
                        <input name="bl_no" caption="B/L No." type="text" style="width:125;" class="input" maxlength="13" style="ime-mode:disabled" style="background-image : url('img/btn_combo.gif'); background-position:top right; background-repeat:no-repeat;" value="<%=JSPUtil.getNull(request.getParameter("bl_no"))%>">
                    </td>
            ...
            <td class="bg">
                ...
                <tr class="h23">
                    <td>
                        ...
                        <tr class="h23">
                            ...
                            <td width="27">POD</td>
                            <td width="105"><input type="text" style="width: 50; text-align: center" class="input2" readOnly name="blInfo_pod_cd"></td>
                            <td width="27"> DEL</td>
                            ...
                            <td width="222"><input type="text" style="width: 100%; text-align: center" class="input2" readOnly name="blInfo_arrival_vessel"></td>
                        </tr>
                        <tr class="h23">
                            <td width="">&nbsp;ETA</td>
                            ...
                            <td width="">PKG</td>
                            <td width="">
                                <input type="text" style="width: 50; text-align: right" class="input2" readOnly name="blInfo_pck_qty">
                            ...
                            <td width=""><input type="text" style="width:100%;" class="input2" readOnly name="blInfo_dsch_loc"></td>
                        </tr>
                        </table>
                     </td>
                </tr>
                ...
                <tr class="h23">
                    <td width="340">
                        ...
                        <tr class="h23">
                            <td width="126">&nbsp;CY Operator Code</td>
                            <td width="110"><input name="cstmsInfo_cy_op_cd"  caption="CY Operator Code"  maxlength="5" type="text"style="width:87"  class="input1"  required="true" style="ime-mode:disabled" ></td>
                            <td width="40">Partial</td>
                            <td width=""><input type="text" style="width:30;text-align: center" class="input2" readOnly name="blInfo_cntr_prt_flg"></td>
                        </tr>
                        </table>
                        ...
                        <tr class="h23">
                            <td width="30">&nbsp;ICG</td>
                            <td width="58">
                                <select style="width=50px;text-align:center;" name='cstmsInfo_info_cgo_flg'>
                                    <option value="N">N</option>
                                    <option value="Y">Y</option>
                                </select>
                            </td>
                            <td width="30">CNTR</td>
                            <td width="108"><input type="text" style="width:87" name="cstmsInfo_full_mty_cd" class="input2" readOnly></td>
                            <td width="40" nowrap>SOC</td>
                    ...
                    <td width="639">
                        ...
                        <tr class="h23">
                            ...
                            <td width="152"><input type="text" name="blInfo_ccust_nm" style="width:150;text-align:left;" class="input2" readOnly></td>
                            <td width=""><input type="text" name="blInfo_ccust_addr"  style="width:420;text-align:left;" class="input2" readOnly></td>
                        </tr>
                        <tr class="h23">
                            <td>Notify</td>
                            <td><input type="text" name="blInfo_ncust_nm"   style="width:150;text-align:left;" class="input2" readOnly></td>
                            <td><input type="text" name="blInfo_ncust_addr" style="width:420;text-align:left;" class="input2" readOnly></td>
                        </tr>
                        </table>
                    </td>
                </tr>
                ...
                <table class="search" border="0" style="width:979;">
                <tr class="h23">
                    <td width="50">D/O ID</td>
                    <td width="110"><input type="text" style="width:100;" name='japDoInfo_jp_do_id' class="input" maxlength='10' dataformat="engupnum" style="ime-mode:disabled"></td>
                    <td width="120">
                        <table width="110" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr>
                            <td class="btn2_left"></td>
                            <td class="btn2" name="btn_do_id_save" id='doidSave'>D/O ID SAVE</td>
                            <td class="btn2_right"></td>
                        </tr>
                        </table>
                    </td>
                    <td width="" align="right">&nbsp;DOR Stowage
                        <input type="text" style="width:25; color:red; font-weight:bold;" name="dorStowage" class="input2" readonly></td>
                </tr>
                </table>
                ...
                <tr class="h23">
                    <td width="545">
                        ...
                        <tr class="h23">
                            <td>B/L Receive</td>
                            <td><input type="text" name="blIss_obl_rdem_knt" style="width:89%;text-align:center;" class="input" dataformat="int" style="ime-mode: disabled" maxlength='3'></td>
                            <td>OFC</td>
                            <td>
                            ...
                            <td>
                                ...
                                <input type="text" name="bl_surr_rmk_flg" style="width:50;text-align:center;" value="" class="noinput2" readOnly><img  id="div_btn_bl_surr_flg" name="btn_bl_surr_rmk" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
                        </tr>
                        <tr class="h23">
                            <td>Other DOC RCV</td>
                            <td>
                        ...
                        <tr class="h23">
                            ...
                            <td>OFC</td>
                            <td>
                                <input type="text" name="blIss_ibd_doc_rcv_ofc_cd" style="width:60;text-align:center;" value="" class="input2" readOnly>
                                <input type="text" name="bliss_ibd_doc_rcv_usr_id" style="width:70;text-align:center;" value="" class="input2" readOnly></td>
                            <td>DT</td>
                            <td>
                                <input type="text" name="bliss_ibd_doc_rcv_dt" style="width:110;text-align:center;" value="" class="input2" readOnly>
                                <input type="text" name="" style="width:10;text-align:center;" value="" class="noinput2" readOnly></td>
                        </tr>
                        <tr class="h23">
                        	<td>Charge Collection</td>
		                    <td>
								<select style="width:89%;text-align:center;" name="refinfo_attr_ctnt1" id ="refinfo_attr_ctnt1">
		                            <option value=""></option>
		                            <option value="Y">Y</option>
		                            <option value="N">N</option>
		                        </select>
                    ...
                    <td width="424">
                        ...
                        <tr class="h23">
                            <td>CCT1</td>
                            <td align="left"><input type="text" name="otsRcvInfo_cct_sts_cd" style="width:27;text-align:center;color:red;" class="input2" readOnly>&nbsp;<img id="div_btn_cct" name="btn_cct" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
                            <td>OFC</td>
                            <td>
                        ...
                        <tr class="h23">
                            <td>CCT2</td>
                            <td align="left"><input type="text" name="otsRcvInfo_n3pty_cct_sts_cd" style="width:27;text-align:center;color:red;" class="input2" readOnly>&nbsp;<img id="div_btn_third_cct" name="btn_third_cct" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
                            <td>OFC</td>
                            <td>
    ...
    <td class="btn1_bg">
        ...
        <tr>
            ...
            <td>
                ...
                <tr>
                    <td class="btn1_left"></td>
                    <td class="btn1" name="btn_doprint">D/O Preview</td>
                    <td class="btn1_right"></td>
                </tr>
                </table>
            </td>
            <td>
                ...
                <tr>
                    <td class="btn1_left"></td>
                    <td class="btn1" name="btn_doprint2">D/O Print</td>
                    <td class="btn1_right"></td>
                </tr>
                </table>
            </td>
            <td>
                ...
                <tr>
                    <td class="btn1_left"></td>
                    <td class="btn1" name="btn_recprint">Receipt Preview</td>
                    <td class="btn1_right"></td>
                </tr>
                </table>
            </td>
            <td>
                ...
                <tr>
                    <td class="btn1_left"></td>
                    <td class="btn1" name="btn_recprint2">Receipt Print</td>
                    <td class="btn1_right"></td>
                </tr>
                </table>
            </td>
...
<script language="javascript">ComSheetObject('japDoInfo');</script>
<!--Partial 컨테이너 정보 조회-->
