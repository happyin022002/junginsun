...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg0136Event"%>
...
<html>
<head>
<title>Merchant Haulage Application Inquiry</title>
...
<!-- : ( Title ) (S) -->
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
                <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Merchant Haulage Application Inquiry</span></td></tr>
            </table>
            <!-- : ( Title ) (E) -->	
		...
		<!-- Grid BG Box  (S) -->
			...
			<!--  biz_1  (S) -->
					...
					<td width="200"><input type="text" style="width:100" align="absmiddle" class="input2" value="<%=JSPUtil.getNull(request.getParameter("edo_rqst_no").substring(0, 11))%>" readonly></td>
					<td width="30">MSN</td>
					<td width="200"><input type="text" style="width:100" align="absmiddle" class="input2" value="<%=JSPUtil.getNull(request.getParameter("edo_rqst_no").substring(11))%>" readonly></td> 
					<td width="60">승인 선사</td>
					<td width=""><input type="text" style="width:100;" align="absmiddle" class="input2" value="SMLM" readonly></td>			
					</tr> 
				</table>				
       ...
       <tr><td class="bg">
				...
				<!--biz (s)-->
						<table border="0" style="width:900; background-color:white;" class="grid2"> 
							<tr>
								...
								<td class="input2"><input type="text" name = "edo_rct_dt" style="width:100%;" class="noinput2" value="" readonly></td> 
								</tr>
							...
							<tr>
								...
								<td class="input2"><input type="text" name = "edo_ack_dt_a" style="width:100%;" class="noinput2" value="" readonly></td> 
								</tr>
							...
							<tr>
								...
								<td class="input2" width=""><input type="text" name = "edo_ack_dt_r" style="width:100%;" class="noinput2" value="" readonly></td> 
							</tr>
							...
							<tr>
								...
								<td class="input2"><input type="text" name = "edo_ack_usr_id" style="width:100%;" class="noinput2" value="" readonly></td> 
							</tr>
							...
							<tr>
								...
								<td class="input2"><input type="text" name = "edo_vsl_nm" style="width:100%;" class="noinput2" value="" readonly></td> 
							</tr>
							<tr>
								<td width="" class="input2" colspan="3"><input type="text" style="width:100%;" class="noinput2" value=""></td> 
								<td class="tr2_head" width="">발급희망일 </td> 
								<td class="input2"><input type="text" name = "rqst_edo_iss_dt" style="width:100%;" class="noinput2" value="" readonly></td> 
								</tr>
			...
			<table class="line_bluedot"><tr><td colspan="6"></td></tr></table>
				...
				<!--biz (s)-->
						...
						<table border="0" style="width:900; background-color:white;" class="grid2"> 
							<tr>
								...
								<td width="305" class="input2"><input type="text" name = "ms_pty_nm" style="width:100%;" class="noinput2" value="" readonly></td> 
								<td class="tr2_head" width="150">담당자명</td> 
								<td width="" class="input2"><input type="text" name = "ms_pty_cntc_pson_nm" style="width:100%;" class="noinput2" value="" readonly></td> 
							</tr>
							<tr>
								<td class="tr2_head" width="">전화번호</td> 
								<td width="" class="input2"><input type="text" name = "ms_phn_no" style="width:100%;" class="noinput2" value="" readonly></td>
								<td class="tr2_head" width="">e-Mail</td>
								<td width="" class="input2"><input type="text" name = "ms_pty_eml" style="width:100%;" class="noinput2" value="" readonly></td>
								 
							</tr>
							<tr>
								<td class="tr2_head" width="">요청사항 </td> 
								<td width="" class="input2"><input type="text" name = "diff_rmk" style="width:100%;" class="noinput2" value="" readonly></td> 
				...
				<!--biz(E)-->
						...
						<table class="search" border="0">
							<tr><td class="title_h"></td>
								<td class="title_s">컨테이너별 운송업체</td></tr>
						</table>
						<!-- Grid (S) -->										
						<table width="100%"  id="mainTable" border="0" style="width:900;">
							<tr>
								<td width="100%">
