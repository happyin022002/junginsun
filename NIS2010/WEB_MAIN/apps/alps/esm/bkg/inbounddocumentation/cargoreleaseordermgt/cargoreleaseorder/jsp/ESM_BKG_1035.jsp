...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg1035Event"%>
...
<html>
<head>
<title>CY or Destuffing Setup (Vietnam)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;CY or Destuffing Setup (Vietnam)</span></td></tr>
        </table>
        <!-- : ( Title ) (E) -->
