...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg1167Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%
    EsmBkg1167Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg1167Event) request.getAttribute("Event");
...
<html>
<head>
<title>Canada Cargo Release</title>
                ...
                <td class="bg">
                    ...
                    <table class="search" border="0" style="width: 979;">
                        <tr class="h23">
                            ...
                            <td width="">
                                <input type="text" style="width: 95;" class="input1" value="" name="bl_no" caption="B/L No."                                    
                        ...
                        <tr>
                            ...
                            <td width="" valign="top">
                                ...
                                <table width="220" id="mainTable" style="display: none">
                                    <tr>
                                        <td width="100%">
                                            <script language="javascript">ComSheetObject('t6sheet6');</script>
                                        </td>
                                    </tr>
                                </table>                                
                                ...
                                <table width="500" id="mainTable_sheet_bl_status" style="display: none" bgcolor="blue">
                                    <tr>
                                        <td width="100%">
                                            <script language="javascript">ComSheetObject('t6sheet7');</script>
                                        </td>
                                    </tr>
                                </table>                        
                            ...
                            <td width="650" valign="top">
                                ...
                                <table class="search_sm" border="0" style="width:100%">
			                        ...
			                        <tr class="h23" id="web_print">
                                        ...
                                        <td width="" align="center" id="obl_inter_ser_no_chk_title" height="30"></td>
			                            <td width="">ID</td>
