...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg0684Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmBkg0684Event event     = null;         //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmBkg0684Event)request.getAttribute("Event");
...
<html>
<head>
<title>Bangladesh Cargo Release (D/O)</title>
...
<%@include file="../../../../bookingcommon/bookingutil/jsp/ESM_BKG_POPUP_TOP.jsp"%>
        ...
        <tr>
            <td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width="160">
                        <input name="bl_no" caption="B/L No." type="text" style="width:125;" class="input" maxlength="13"style="ime-mode:disabled" style="background-image : url('img/btn_combo.gif'); background-position:top right; background-repeat:no-repeat;" value="">
                    </td>
        ...
        <tr>
            <td class="bg">
                ...
                <table class="search_sm" border="0" style="width:979;">
                	<tr class="h23">
               			<td width="140" class="" nowrap="nowrap">Registration No</td>
						<td width="200" class=""><input type="text" name="refInfo_attr_ctnt1" style="width:90%;text-align:left;" class="input" maxlength="30"></td>
						<td width="160" class="" nowrap="nowrap">Bill of Entry Number</td>
						<td width="200" class=""><input type="text" name="refInfo_attr_ctnt2" style="width:90%;text-align:left;" class="input" maxlength="30"></td>
						<td width="120" class="" nowrap="nowrap">Bill of Entry Date</td>
						<td width="*" class="">
							<input type="text" name='refInfo_attr_ctnt3' style="width:75;ime-mode:disabled" class="input" dataformat="ymd" minlength="10" maxlength="10" >&nbsp;
							<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name='img_refInfo_attr_ctnt3'>&nbsp;
						</td>
                	</tr>
                	<tr class="h23">
               			<td width="140" class="" nowrap="nowrap">Delivery Validity up to</td>
						<td width="200" class=""><input type="text" name="refInfo_attr_ctnt4" style="width:90%;text-align:left;" class="input" maxlength="100"></td>
						<td width="160" class="" nowrap="nowrap">Delivery Extension up to</td>
						<td width="200" class=""><input type="text" name="refInfo_attr_ctnt6" style="width:90%;text-align:left;" class="input" maxlength="30"></td>
						<td width="170" class="" nowrap="nowrap">Warehouse/CY Designated</td>
						<td width="*" class="" ><input type="text" name="refInfo_attr_ctnt5" style="width:99.5%;text-align:left;" class="input" maxlength="100"></td>
                	</tr>
                </table>
                ...
                <tr class="h23">
                    ...
                    <!--  biz_4 _1 (S) -->
                        ...
                        <tr class="h23">
                            ...
                            <td class="">
                                <select name="blIss_ibd_doc_rcv_flg" style="width:89%;text-align:center;">
                            ...
                            <td class="">OFC</td>
                            <td class="">
                                <input type="text" name="blIss_ibd_doc_rcv_ofc_cd" style="width:60;" value="" class="input2" readonly="readonly">
                                <input type="text" name="blIss_ibd_doc_rcv_usr_id" style="width:70;" value="" class="input2" readonly="readonly"></td>
                            <td class="">DT</td>
                            <td class="">
                                <input type="text" name="blIss_ibd_doc_rcv_dt" style="width:110;text-align:center;" value="" class="input2" readonly="readonly">
