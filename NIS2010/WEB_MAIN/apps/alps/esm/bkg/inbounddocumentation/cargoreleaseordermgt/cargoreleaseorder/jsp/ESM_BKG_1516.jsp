...
<input name='yd_cd' type="hidden" value='<%=JSPUtil.getNull(request.getParameter("yd_cd"))%>'>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle" />&nbsp; EDI Setup History</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
