...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.event.EsmBkg066806Event"%>
       	...
       	<tr><td class="bg">
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
                    ...
                    <td width="130"><input type="text" style="width:90;" class="input2" value="" name = "frm_t6sheet1_cust_cd_c" readonly="true"></td>
                    <td width="45">Name</td>
                    <td width="225"><input type="text" style="width:180;" class="input2" value="" name = "frm_t6sheet1_cust_nm_c" readonly="true"></td>
                    <td width="60">Address</td>
                    <td><input type="text" style="width:350;" class="input2" value="" name = "frm_t6sheet1_cust_addr_c" readonly="true"></td>
                </tr>
                </table>
               ...
               <table width="100%" id="mainTable"> 
                ...
                <table class="height_6"><tr><td></td></tr></table>
                ...
                <tr class="h23">
                    ...
                    <td width="130"><input type="text" style="width:90;" class="input2" value="" name = "frm_t6sheet1_cust_cd_n" readonly="true"></td>
                    <td width="45">Name</td>
                    <td width="225"><input type="text" style="width:180;" class="input2" value="" name = "frm_t6sheet1_cust_nm_n" readonly="true"></td>
                    <td width="60">Address</td>
                    <td><input type="text" style="width:350;" class="input2" value="" name = "frm_t6sheet1_cust_addr_n" readonly="true"></td>
                 </tr>
                </table>
			...
			<tr class="h23">
				...
				<td width="130"><input type="text" style="width:70;" class="input2" value="" name = "frm_t6sheet1_cust_cd_a" readonly="true"></td>
				<td width="110">Name & Address</td>
				<td width=""><input type="text" style="width:576;" class="input2" value="" name = "frm_t6sheet1_cust_nm_a" readonly="true"></td> 
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr>
					...
					<td class="btn2" name="btn_t6Preview">Preview</td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6Master">Master Data</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6SendAn">Send A/N</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6AnTemplate">A/N Template</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6SendOBl">Send O.B/L</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
