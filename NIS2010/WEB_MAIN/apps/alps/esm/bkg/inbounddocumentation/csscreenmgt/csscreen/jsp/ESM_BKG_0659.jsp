...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.event.EsmBkg0659Event"%>
...
<html>
<head>
<title>DG Cargo Detail Pop-up</title>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="100%" border="0">
                <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle" />&nbsp;DG Cargo Detail(s)</td></tr>
            </table>
            <!-- : ( Title ) (E) -->            
