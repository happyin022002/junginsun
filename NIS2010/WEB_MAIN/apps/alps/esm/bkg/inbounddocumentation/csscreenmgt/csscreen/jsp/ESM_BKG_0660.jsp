...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.event.EsmBkg0660Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg0660Event  event = null;					//PDTO(Data Transfer Object including Parameters)
    ...
    // Param : blNo, blTpCd, bkgNo, bkgSplitNo
    String blNo        = "";
    String blTpCd      = "";
    String bkgNo       = "";
	...
	try {
		...
		event = (EsmBkg0660Event)request.getAttribute("Event");
...
<html>
<head>
<title>Break Bulk Detail(s) Pop-up</title>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="100%" border="0">
                <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle" />&nbsp;Break Bulk Detail(s)</td></tr>
            </table>
            <!-- : ( Title ) (E) -->
