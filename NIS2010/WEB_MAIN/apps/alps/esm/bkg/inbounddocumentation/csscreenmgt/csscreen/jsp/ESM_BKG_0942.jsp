...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.event.EsmBkg0942Event"%>
...
<%
    ...
    String strUsr_id    = "";
    String strUsr_nm    = "";
    Logger log = Logger.getLogger("com.hanjin.apps.csscreen.CsScreenBC");
...
<html>
<head>
<title>B/L Select Pop-up (Partial)</title>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle" />&nbsp;B/L Select Pop-up (Partial)</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
