            ...
            case "sheet1":      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++ , dtHidden,       30,   daCenter, false, "ntc_seq");
                    ...
                    InitDataProperty(0, cnt++ , dtData,         40,   daCenter, true,  "is_so",         false,    "",   dfNone,        0,    false,    true);
                    InitDataProperty(0, cnt++ , dtData,         60,   daCenter, true,  "cnmv_sts_cd",   false,    "",   dfNone,        0,    false,    true);
                    InitDataProperty(0, cnt++ , dtData,         150,  daCenter, true,  "incur_chg_amt", false,    "",   dfNullInteger, 0,    true,     true);
                    InitDataProperty(0, cnt++ , dtData,         60,   daCenter, true,  "n3pty_bil_yn",  false,    "",   dfNone,        0,    false,    true);
                    InitDataProperty(0, cnt++ , dtHidden,       120,  daCenter, true,  "n3pty_bil_no",  false,    "",   dfNone,        0,    false,    true);
        ...
        case IBSEARCH_ASYNC01:        
        	...
        	for(var i=0; i<sheetObj.RowCount; i++) {
            	if(sheetObj.CellValue(i+1, "chk") == "1") {
            		...
            		if (p_cnt > 1) p_if_amt += "|$|"; 
            		p_if_amt += sheetObj.CellValue(i+1, "incur_chg_amt");
            	}
        	}
        	...
        	var rtnValue = ComOpenPopupWithTarget('/hanjin/ESD_TPB_0103.do?pgmNo=ESD_TPB_0103&' + param, 1024, 600, "", "none", true);
        	if (rtnValue != null) {
            ...
            case IBSEARCH_ASYNC01:
            	...
            	for(var i=0; i<RowCount; i++) {
                	if(CellValue(i+1, "chk") == "1") {
                		if (CellValue(i+1, "incur_chg_amt") == "") {
