...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_1002 : ESM_BKG_1002 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_1002() {
    ...
    */
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        case IBSAVE:
	        ...
	        var sXml = sheetObj.GetSearchXml("ESM_BKG_1002GS.do", FormQueryString(formObj));  
            ...
            var sXml = sheetObj.GetSaveXml("ESM_BKG_1002GS.do", sParam);
