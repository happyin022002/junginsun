...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_0511 : ESM_BKG_0511 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_0511() {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        case IBSEARCH_ASYNC02:
        	...
        	var resultObj = ComOpenPopupWithTarget('/hanjin/ESM_BKG_1002.do?' + param, 306, 172, "", "none", true);
        	if (resultObj != null) {
        ...
        case IBSEARCH:
            ...
            sheetObjects[1].LoadSearchXml(arrXml[1]); // Detail
        ...
        case IBSAVE:
            ...
            var sXml = sheetObj.GetSaveXml("ESM_BKG_0511GS.do", sParam);
        ...
        case IBSEARCH_ASYNC03:
        	ComOpenPopupWithTarget('/hanjin/ESM_BKG_0510.do?pgmNo=ESM_BKG_0510', 1020, 700, "", "none", true);
        	break;
        }
    }
    ...
    function copyRowToForm() {
    	...
    	with (formObj) {
			...
			if (sheetObjects[0].RowCount == 0) {
    			...
    			sheetObj.CellValue(1,"pod_cd")            = pod_cd.value;
    			sheetObj.CellValue(1,"hld_ntc_tp_cd")     = hld_ntc_tp_cd.value;
    			sheetObj.CellValue(1,"auto_ntc_flg")      = "";
			...
			if (sheetObjects[1].RowCount == 0) {
    			...
    			sheetObj.CellValue(1,"pod_cd")         = pod_cd.value;
    			sheetObj.CellValue(1,"hld_ntc_tp_cd")  = hld_ntc_tp_cd.value;
    			sheetObj.CellValue(1,"hld_ntc_fom_cd") = hld_ntc_fom_cd.value;
    			sheetObj.CellValue(1,"hld_rmk")        = "";
    		}
    ...
    function setStatusFlag(sheets){
        for (var i=0;i<sheets.length;i++) {
        	for (var j=1;j<sheets[i].Rows;j++) {
        		if(sheets[i].RowStatus(j) == "R") {
        			sheets[i].RowStatus(j) = "U";
        		}
        	}
        }
    }      
    ...
    /**
    * Object(DEL) 값이 변경되면 콤보에 동일한 코드를 선택해준다.<br>
    * 
