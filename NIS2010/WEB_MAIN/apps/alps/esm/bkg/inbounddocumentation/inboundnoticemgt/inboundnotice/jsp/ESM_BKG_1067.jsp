...
<%@ page import="com.hanjin.apps.alps.esm.bkg.inbounddocumentation.inboundnoticemgt.inboundnotice.event.EsmBkg1067Event"%>
...
<%
    ...
    String parCntrNo        = "";
    String parOfcCd         = "";
	Logger log = Logger.getLogger("com.hanjin.apps.InboundBLMgtSC.PickUpNotice");
...
<html>
<head>
<title>Pick up upload history</title>
    ...
    <tr>
        <td valign="top">
            ...
            <table width="100%" border="0">
                <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle" />&nbsp;Pick up upload history </td></tr>
            </table>
            <!-- : ( Title ) (E) -->
