...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.ebookingconduct.ebookingreceipt.event.EsmBkg0225Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg0225Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0225Event)request.getAttribute("Event");
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_si_info_Save">Edit Tag</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
