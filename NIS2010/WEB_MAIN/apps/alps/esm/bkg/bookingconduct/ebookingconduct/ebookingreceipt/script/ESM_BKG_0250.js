...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_0250 : esm_bkg_0250 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_0250() {
...
//        axon_event.addListenerForm('beforedeactivate', 'bkg0250_deactivate',  formObject); //- 포커스 나갈때
//        axon_event.addListenerFormat('beforeactivate', 'bkg007901_activate',    formObject); //- 포커스 들어갈때
        axon_event.addListenerForm('click', 'bkg0250_click',    formObject); //- 클릭시
    }
    /**
     * 시트 초기설정값, 헤더 정의
        ...
        switch(sAction) {
      	    case IBSEARCH: 
      	    	if (sheetObj.id=="t1sheet1") {
					...
					var sXml = sheetObj.GetSearchXml("ESM_BKG_0250GS.do", FormQueryString(formObj));
		            ...
		            if (arrXml.length > 0) 
					{
      	    		...
      	    		formObj.f_cmd.value = SEARCH02;
 	          		sheetObj.DoSearch("ESM_BKG_0250GS.do", FormQueryString(formObj));
