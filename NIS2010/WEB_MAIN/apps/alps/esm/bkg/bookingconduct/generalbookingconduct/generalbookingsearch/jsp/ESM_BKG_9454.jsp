...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsearch.event.EsmBkg9454Event"%>
...
<html>
<head>
<title>Transhipment Route Update</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;T/S Route Update</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Pre VVD</td></tr>
				</table>
				...
				<tr><td class="title_h"></td>
					<td class="title_s">Trunk VVD</td></tr>
				</table>
				...
				<tr><td class="height_5"></td></tr>
				<tr><td class="title_h"></td>
					<td class="title_s">Post VVD</td></tr>
				</table>
