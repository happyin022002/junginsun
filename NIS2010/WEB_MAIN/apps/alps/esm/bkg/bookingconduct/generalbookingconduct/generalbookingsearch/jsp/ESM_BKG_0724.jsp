...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsearch.event.EsmBkg0724Event"%>
...
<html>
<head>
<title>Roll Over Information</title>
...
<input type="hidden" name="mrd" value="ESM_BKG_0816.mrd"> 
	...
	<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; Roll-over Information</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">	
				...
				<tr class="input2">
					<td><input type="text" style="width:100;" class="noinput2" name="bkg_no" value="<%=strBkgNo%>" readOnly></td>
					<td><input type="text" style="width:100;" class="noinput2" name="bl_no" readOnly></td>
				...
				<table class="height_5"><tr><td></td></tr></table>
				 ...
				 <tr><td align="right" class="stm">In case the reason of roll-over is "Carrier Schedule Change", Demurrage charge will be exempted.</td></tr>
				 </table>
