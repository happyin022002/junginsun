...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_0710 : esm_bkg_0710 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_0710() {
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtData,			20,		daCenter,		false,		prefix1+"rc_seq",			false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			100,	daCenter,		false,		prefix1+"cntr_no",			false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			60,		daRight,		false,		prefix1+"cdo_temp",			false,			"",      dfNullFloat,		2,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			90,		daLeft,			false,		prefix1+"cmdt_nm",			false,			"",      dfNone,			0,		false,	false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:      //조회
			...
			var sXml = sheetObj.GetSearchXml("ESM_BKG_0710GS.do", FormQueryString(formObj)+ "&" + ComGetPrefixParam(arrPreFix));
