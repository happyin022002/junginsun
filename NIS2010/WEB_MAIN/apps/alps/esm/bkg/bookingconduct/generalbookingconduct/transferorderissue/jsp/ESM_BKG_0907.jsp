...
*Open Issues : ESM_BKG_0079_02C 화면의, Container항목에서 팝업됨
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.transferorderissue.event.EsmBkg0907Event"%>
...
/*		
		...
		event = (EsmBkg0907Event)request.getAttribute("Event");
...
<html>
<head>
<title>TRO-Container Inquiry</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TRO - Container Inquiry
</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
