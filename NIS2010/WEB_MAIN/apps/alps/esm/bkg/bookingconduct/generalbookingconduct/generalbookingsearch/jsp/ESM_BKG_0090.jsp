...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsearch.event.EsmBkg0090Event"%>
...
<tr><td valign="top">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<table class="grid2" border="0" style="width:384;"> 
				<tr class="tr2_head">
					<td align="left">Remark(s)</td> 
				</tr>
				<tr>
					<td><textarea cols="71" rows="5" name="stwg_rmk" ></textarea></td> 
				</tr>
				</table>
