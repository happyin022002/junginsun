...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsearch.event.EsmBkg1062Event"%>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TAA No Search</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
				...
				<tr class="h23">
					<td style="width:530;">
						...
						<tr class="h23">
				            ...
				            Any match<input type="checkbox" name="include_flag" class="trans" value="Y"></td></tr>
						</table>
					</td>
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn3_bg">
		    ...
		    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Taa">TAA Inquiry</td>
					<td class="btn1_right"></td>
				</tr></table></td>
