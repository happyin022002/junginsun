...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsplitcombine.event.EsmBkg0974Event"%>
...
<html>
<head>
<title>Master Booking Selection</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Master Booking Selection</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<table class="search" border="0" style="width:590;"> 
				<tr class="h23">
				<td width="100">Group S/O No.</td>
				<td width=""><input type="text" name="grp_so_no" style="width:100;" class="input" dataformat="engup" maxlength="6" value=""></td>
		</tr>
		</table>
			<!-- : ( Grid )1 (S) -->
       	...
       	<tr><td class="btn3_bg">
		    ...
		    <tr>
				<td><table width="" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn1" name="btn_ConfirmCombine">Confirm Combine</td>
					<td class="btn1_right">
				</tr></table></td>
