...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_9455 : ESM_BKG_9455 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_9455() {
 ...
 // 공통전역변수
             ...
             case 1:      //t1sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     InitDataProperty(0, cnt++ , dtData,      			100,  	daCenter,  	false,     "full_cntr_no",   	false,          "",      dfNone,  			0,        false,    false);                     
                     ...
                     InitDataProperty(0, cnt++ , dtHidden,      		0,    daCenter,  	false,     "sts_cd");                     
   ...
   // Sheet관련 프로세스 처리
    ...
    function validateForm(sheetObj,formObj,sAction){
    	switch(sAction) {
	   	  	case IBSEARCH:         		
	   			if(ComGetObjValue(formObj.vvd) == ""){		// 조회없이 저장시
	  ...
	  var sRowStr = sheetObj.GetSelectionRows("/");
 	  ...
 	  if (Shift==1){
 	  	for (var i=0; i<arr.length; i++) {
 	  		if (sheetObj.ColSaveName(sheetObj.SelectCol) !="checkbox" && sheetObj.CellValue(arr[i],"checkbox")=="0"){
 	  			sheetObj.CellValue2(arr[i],"checkbox")="1";
 	  		}else if (sheetObj.ColSaveName(sheetObj.SelectCol) !="checkbox" && sheetObj.CellValue(arr[i],"checkbox")=="1"){
 	  			sheetObj.CellValue2(arr[i],"checkbox")="0";
 	  		}
 	  	}
 	  } 	  
  }           
