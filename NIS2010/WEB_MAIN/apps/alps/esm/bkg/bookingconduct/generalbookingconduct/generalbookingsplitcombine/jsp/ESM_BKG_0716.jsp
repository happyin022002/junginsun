...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsplitcombine.event.EsmBkg0716Event"%>
...
<script language="javascript">
	function setupPage(){
		...
		formObj.splitCntrSplitNo.value = opener.document.form.bbCntrSplitNo.value;
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;BB Application Split</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
