...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsearch.event.EsmBkg1078Event"%>
...
<html>
<head>
<title>TAA Commodity PopUp</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TAA Commodity Pop-Up</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<table class="search" border="0" style="width:560;"> 
				<tr class="h23">
					<td width="150">TAA No</td> 
					<td width=""><input type="text" name="taa_no" style="width:30%" class="input2" value="<%=taaNo %>" readonly></td>
				</tr>
				<tr class="h23">
					<td width="">Commodity Code</td> 
					<td width=""><input type="text" name="cmdt_cd" style="width:100%" class="input" value="" style="ime-mode:disabled"  maxlength=6 dataformat="int"></td>
				</tr>
				<tr class="h23">
					<td width="">Commodity Description</td> 
					<td width=""><input type="text" name="cmdt_nm" style="width:100%" class="input" value="" maxlength=30 dataformat="etc"></td>
				</tr></table>
				<!-- : ( Grid ) (S) -->
