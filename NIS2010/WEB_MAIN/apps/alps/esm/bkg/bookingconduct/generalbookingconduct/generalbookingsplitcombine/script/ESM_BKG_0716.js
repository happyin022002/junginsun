...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_0716 : esm_bkg_0716 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_0716() {
				...
				switch(sheetID) {
					...
					case "sheet1":
							with (sheetObj) {
								...
								InitDataProperty(0,		cnt++ , dtData,			70,		daCenter,		true,		prefix1+"bb_cgo_seq",       false,			"",      dfNone,			0,		false,	false);
								InitDataProperty(0,		cnt++ , dtData,			200,	daLeft,			true,		prefix1+"cmdt_nm",			false,		"",		dfNone,			0,		false,	false,		20);
								InitDataProperty(0,		cnt++ , dtData,			55,		daRight,		true,		prefix1+"dim_len",				false,		"",		dfNullInteger,	0,		false,	false,		4);
								InitDataProperty(0,		cnt++ , dtData,			55,		daRight,		true,		prefix1+"dim_wdt",				false,		"",		dfNullInteger,	0,		false,	false,		4);
								InitDataProperty(0,		cnt++ , dtData,			55,		daRight,		true,		prefix1+"dim_hgt",				false,		"",		dfNullInteger,	0,		false,	false,		4);
								InitDataProperty(0,		cnt++ , dtData,			90,		daRight,		true,		prefix1+"cgo_wgt",				false,		"",		dfNullFloat,	3,		false,	false);
								
								InitDataProperty(0,		cnt++ , dtCheckBox,		30,		daCenter,		true,		prefix1+ComGetObjValue(document.form.orgSplit),					false,		"",		dfNone,			0,		true,	true);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:      //조회
				...
				var sXml = sheetObj.GetSearchXml("ESM_BKG_0716GS.do", FormQueryString(formObj)+ "&" + ComGetPrefixParam(arrPreFix));
//				var sXml = sheetObj.GetSearchXml("ESM_BKG_0716GS.do", FormQueryString(formObj)+ "&" + ComGetPrefixParam(arrPreFix));
