...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_0654 : ESM_BKG_0654 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_0654() {
                ...
                case 1:      //sheet1 init
                    with (sheetObj) {
                       ...
                       //전체Edit 허용 여부 [선택, Default false]
                        ...
                        var HeadTitle = "|TP|Customer Code|Customer Code|Customer Name|RFA Number|Sales OFC|Sales Rep.|Service Scope|Service Scope";

                        //해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
                        InitHeadRow(0, HeadTitle, true);

                        //데이터속성    [ROW, COL,  DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                        InitDataProperty(0, cnt++ , dtRadioCheck, 	20,    daCenter,  		false,     	"chk");     
                        InitDataProperty(0, cnt++ , dtData,           	20,   	daCenter,    	false,     	"cust_tp_cd",   		false,    "",      dfNone, 		0,     false,    false);                        
                        ...
                        InitDataProperty(0, cnt++ , dtData, 	 		260,  	daLeft,	    	false,     	"cust_lgl_eng_nm", 	false,    "",      dfNone, 		0,     false,    false);
                        ...
                        InitDataProperty(0, cnt++ , dtData,          	70,   	daCenter,    	false,     	"sales_rep",      		false,    "",      dfNone, 		0,     false,    false);
                        InitDataProperty(0, cnt++ , dtData, 	 		35,   	daCenter,    	false,     	"svc_scp_cd",   		false,    "",      dfNone, 		0,     false,    false);
                        InitDataProperty(0, cnt++ , dtData, 	 		130,   	daLeft,    	false,     	"svc_scp_nm",   		false,    "",      dfNone, 		0,     false,    false);
        ...
        function doActionIBSheet(sheetObj,formObj,sAction) {
            ...
            switch(sAction) {
				case INIT:      // 최초로딩시
					...
					ComOpenWait(true);
					var sXml = sheetObj.GetSearchXml("ESM_BKG_0654GS.do" , FormQueryString(formObj));
					ComOpenWait(false); 
    	...
    	{		
    		if(ErrMsg == ""){
    			if(sheetObj.RowCount < 1){
    				...
    				sheetObj.CellValue(idx, "rfa_no") = "DUM0000001";
    			}
    		}
    	}      
    	//double click -> select
