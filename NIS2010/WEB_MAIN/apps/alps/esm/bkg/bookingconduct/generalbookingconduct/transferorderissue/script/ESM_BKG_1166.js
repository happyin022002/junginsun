            ...
            switch(srcName) {
	        	case "btn_ok":
	        		...
	        		if(sheetObject.SelectRow > 0) {
		        		parentObj.arb_curr_cd.value = sheetObject.CellValue(sheetObject.SelectRow, "gline_curr_cd");
		        		parentObj.arb_rev_amt.value = sheetObject.CellValue(sheetObject.SelectRow, "gline_rev_amt");
						self.close();
	        		} else {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
					...
					InitDataProperty(0,	cnt++,	dtData,			100 , 	daCenter,	false,	"gline_curr_cd",	false,	"", dfNone,	    0,      false, false);
					InitDataProperty(0,	cnt++,	dtData,			100 , 	daRight,    false,	"gline_rev_amt",	false,	"",	dfNone,		0,		false, false);
            	}
         		break;
        }
    }
