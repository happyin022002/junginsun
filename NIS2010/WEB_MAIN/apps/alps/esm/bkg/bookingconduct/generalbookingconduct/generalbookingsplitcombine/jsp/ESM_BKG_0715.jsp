...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsplitcombine.event.EsmBkg0715Event"%>
...
<%
	EsmBkg0715Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0715Event)request.getAttribute("Event");
...
<html>
<head>
<title>AK Application Split</title>
...
<script language="javascript">
	function setupPage(){
		...
		formObj.splitCntrSplitNo.value = opener.document.form.akCntrSplitNo.value;
...
<input type="hidden" name="cntrExists" value="<%=strcntrExists%>"> 
<input type="hidden" name="cntrPopExists" value="<%=strcntrPopExists%>"> 
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;AK Application Split</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width=""><input type="text" style="width:100;" class="input"  name="bkg_no" disabled>&nbsp;</td> 
				</tr>
				</table>
				<!-- : ( Grid ) (S) -->
