...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_0920 : esm_bkg_0920 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_0920() {
				...
				case "btn_Delete":
					for (var i=1; i<=sheetObject1.RowCount; i++) {
						if (sheetObject1.CellValue(i, "del_chk") == 1) {
							sheetObject1.CellValue2(i, "ibflag") = "D";
						}
					}
					break;
			...
			case "sheet1":      //hidden sheet1
	            with (sheetObj) {	
	               ...
	               //전체Edit 허용 여부 [선택, Default false]
	                ...
	                InitDataProperty(0,	cnt++,	dtData,			180, 	daCenter,	false,	"bkg_no",     true,	    "",			dfEngUpKey,	0,			true,		true,   13);
        ...
        switch(sAction) {
          	case IBSAVE: 
                ...
                var sParam = FormQueryString(formObj);
          		...
          		var sXml = sheetObj.GetSaveXml("ESM_BKG_0920GS.do", sParam); 
