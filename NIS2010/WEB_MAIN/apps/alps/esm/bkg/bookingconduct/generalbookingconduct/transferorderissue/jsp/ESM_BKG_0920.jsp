...
*@FileTitle : TRO-Copy
*Open Issues : ESM_BKG_0079_02C 화면의 TRO - Copy 팝업 
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.transferorderissue.event.EsmBkg0920Event"%>
...
<!-- 개발자 작업	-->
<input type="hidden" name="ui_id"     value=""><!-- historyLine구분용 -->
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TRO - Copy</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
