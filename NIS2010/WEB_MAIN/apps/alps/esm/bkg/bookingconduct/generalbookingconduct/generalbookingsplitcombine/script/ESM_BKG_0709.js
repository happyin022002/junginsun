...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esm_bkg_0709 : esm_bkg_0709 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esm_bkg_0709() {
    ...
    function loadPage() { 
		...
		/*if(ComParseInt(document.form.splitCnt)>0){
			if (ComGetObjValue(document.form.cntrExists)=="Y"){
				...
				setSplitNo(sheetObjects[0],document.form.splitCntrSplitNo.value,strSheetTitle,prefix1,prefix1+"dcgo_seq");
			}
            ...
            case 1:      //sheet1 init
                with (sheetObj) { 
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtHiddenStatus,	0,		daCenter,		false,		prefix1+"ibflag");
					InitDataProperty(0, cnt++ , dtHidden,		20,		daCenter,		false,		prefix1+"dcgo_seq",			false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			30,		daCenter,		false,		prefix1+"dg_cntr_seq",		false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			100,	daCenter,		false,		prefix1+"cntr_no",			false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			70,		daCenter,		false,		prefix1+"cntr_cgo_seq",		false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			70,		daCenter,		false,		prefix1+"imdg_un_no",		false,			"",      dfNone,			0,		false,	false);
					InitDataProperty(0, cnt++ , dtData,			90,		daCenter,		false,		prefix1+"imdg_clss_cd",		false,			"",      dfNone,			0,		false,	true);
...
//				var sXml = sheetObj.GetSearchXml("ESM_BKG_0709GS.do", FormQueryString(formObj)+ "&" + ComGetPrefixParam(arrPreFix));
				var sXml = sheetObj.GetSearchXml("ESM_BKG_0709GS.do", FormQueryString(formObj)+ "&" + ComGetPrefixParam(arrPreFix));
