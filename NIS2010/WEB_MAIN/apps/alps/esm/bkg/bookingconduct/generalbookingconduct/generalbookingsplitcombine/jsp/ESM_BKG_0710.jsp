...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.generalbookingconduct.generalbookingsplitcombine.event.EsmBkg0710Event"%>
...
<script language="javascript">
	function setupPage(){
		...
		formObj.splitCntrSplitNo.value = opener.document.form.rfCntrSplitNo.value;
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; RF Application Split
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td><input type="text" style="width:100;" class="input" name="bkg_no" disabled>&nbsp;</td> </tr>
				</table>
		<!-- : ( Search Options ) (S) -->
