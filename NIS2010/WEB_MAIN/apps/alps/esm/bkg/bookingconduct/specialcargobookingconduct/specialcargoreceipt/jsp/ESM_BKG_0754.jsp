...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.specialcargobookingconduct.specialcargoreceipt.event.EsmBkg0754Event"%>
...
<html>
<head>
<title>DG Sequence Selection</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;DG Sequence Selection</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
