...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.specialcargobookingconduct.specialcargoreceipt.event.EsmBkg0756Event"%>
...
<%
	...
	try {
		...
		sheetRow 	 = request.getParameter("sheetRow");
...
<html>
<head>
<title>Details per each package</title>
...
<input type="hidden" name="sheetRow" value="<%=sheetRow%>">
<input type="hidden" name="modalFlg" value="<%=modalFlg%>">
<input type="hidden" name="bkg_no" value="<%=bkgNo%>">
<input type="hidden" name="awk_cgo_seq" value="<%=awkCgoSeq%>">
<!-- 개발자 작업	-->
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Details per Each Package </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
