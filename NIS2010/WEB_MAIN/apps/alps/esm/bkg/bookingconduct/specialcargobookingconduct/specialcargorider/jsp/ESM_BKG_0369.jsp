...
<%@ page import="com.hanjin.apps.alps.esm.bkg.bookingconduct.specialcargobookingconduct.specialcargorider.event.EsmBkg0369Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg0369Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg0369Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  B/L Rider</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
       		...
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td class="stm">
						...
						<input type="radio" name='ridr_tp_cd' value="L" class="trans" onClick="fn_ridr_Tp_Change(this)" >LOI(Iran)
					</td>
					</tr>
				</table>
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn3_bg">
		    ...
		    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" id="loi_format_down" name="loi_format_down">LOI Format</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
