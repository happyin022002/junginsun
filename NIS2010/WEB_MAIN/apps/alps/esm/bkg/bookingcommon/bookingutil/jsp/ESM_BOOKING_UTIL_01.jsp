		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="./img/icon_title_dot.gif"
					align="absmiddle">&nbsp;Query Execution</td>
			</tr>
		</table>
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr>
					...
					<td align="left" >
					<div id='result' style="padding:5 10 5 10;width: 900px;height:250px;border-right:#000000 1px; border-top: #000000 1px;z-index:1;visibility: visible;overflow: auto;border-left: #000000 1px;border-bottom: #000000 1px;" >
					</div>
					</td>
					</tr>
				</table> 
