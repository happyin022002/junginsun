...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
     ...
     * @author 한진해운
     * @extends 
     * @class ESM_BOOKING_UTIL_01  생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
          ...
          var formObject = document.form;
	     	...
	     	try {
	     		...
	     		var srcName = window.event.srcElement.getAttribute("name");
		 			...
		 			switch(srcName) {
		 				case "btn_execute":
		 					doActionIBSheet(sheetObject1,formObject,COMMAND22);
		 					break;	
		 				case "btn_Close":
		 					self.close();
		 					break;	
   ...
   // Sheet관련 프로세스 처리
     ...
     function validateForm(sheetObj,formObj,sAction){
    	switch(sAction) {
    		...
    		case COMMAND22:
	    		if ( ComIsNull(formObj.flat_file)) {
	    			alert("Flat File is empty.");
	    			return false;
	    			break;
	    		}
