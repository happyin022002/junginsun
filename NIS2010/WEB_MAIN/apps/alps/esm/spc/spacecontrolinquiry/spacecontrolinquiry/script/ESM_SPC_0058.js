...
*                  - 해당화면 기존 Bottleneck search 의 컬럼 추가 형태로 ESM_SPC_0045 원본 copy 하여 사용
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_SPC_0058 : ESM_SPC_0058 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_SPC_0058() {
    	...
    	switch(sheetNo) {
    		case 1:      //sheet1 init
    			with (sheetObj) {
    				...
    				var HeadTitle1 = "Port|BSA|IOC|POD Port|Load|AVG CMPB|Discharge|Onboard|Loadable|Utilization ratio|seq|";
    				// 해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
    				InitHeadRow(0, HeadTitle1, true);
    				
    				// 데이터속성    [ROW, COL,  DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
    				
    				InitDataProperty(0, cnt++ , dtData  ,  60,   daCenter,  true ,     "port_cd"           ,     false,         "",   dfNone   ,      0,     true,       true,          30, 	false, 		false);
    				...
    				InitDataProperty(0, cnt++ , dtData  ,  60,   daCenter,  true ,     "pod_cd"            ,     false,         "",   dfNone   ,      0,     true,       true,          30, 	false, 		false);
    				InitDataProperty(0, cnt++ , dtData  ,  90,   daRight ,  false,     "lod_cur_teu_qty",     false,         "",   dfInteger,      0,     true,       true,          30, 	false, 		false);
    				InitDataProperty(0, cnt++ , dtData  ,  90,   daRight ,  false,     "avg_cmpb",     false,         "",   dfInteger,      0,     true,       true,          30, 	false, 		false);
    				...
    				InitDataProperty(0, cnt++ , dtData  ,  90,   daRight ,  false,     "load_capa"       ,     false,         "",   dfInteger,      0,     true,       true,          30, 	false, 		false);
    				InitDataProperty(0, cnt++ , dtData  ,  120,  daRight ,  false,     "util_ratio"		,     false,         "",   dfNone,      0,     true,       true,          30, 	false, 		false);
    		...
    		case 2:      //sheet1 init
				with (sheetObj) {
					...
					// 해더에서 처리할 수 있는 각종 기능을 설정한다
					InitHeadMode(true, true, false, true, false,false)
					var HeadTitle1 = "Port|BSA|IOC|POD Port|Load|AVG CMPB|Discharge|Onboard|Loadable|Utilization ratio";
					// 해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
					InitHeadRow(0, HeadTitle1, true);
					...
					InitDataProperty(0, cnt++ , dtData  ,  90,   daRight ,  false,     "load_capa"       ,     false,         "|bsa|-|teu_onboard|",   dfFloat,      1,     true,       true,          30, 	false, 		false);
					InitDataProperty(0, cnt++ , dtData  ,  120,  daRight ,  false,     "util_ratio",     false,         "",   dfNone,      0,     true,       true,          30, 	false, 		false);
					InitDataProperty(0, cnt++ , dtHidden,  90,   daRight ,  false,     "on_hc_ttl"       ,     false,         "",   dfFloat,      0,     true,       true,          30, 	false, 		false);
					InitDataProperty(0, cnt++ , dtHidden  ,  45,   daRight ,  true ,     "src_knd"        ,     false,         "",   dfNone   ,      0,     true,       true,        30);
					InitDataProperty(0, cnt++ , dtData,    1,    daLeft  ,  false,     ""               ,     false,         "",   dfNone   ,      0,     true,       true,        30, 	false, 		false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
    	...
    	switch(sAction) {
    		case IBSEARCH:      //조회
    			...
    			var datas = sheetObjects[beforetab].GetSearchXml("ESM_SPC_0058GS.do", param);
...
//    	if (in_vvd_chk !=true) in_vvd_chk = false; // in_vvd에서 넘어온 event에 대해서는 그대로 true로 check를 반환하기 위함.
    ...
    function getVVD(vvd){
    	...
    	if(year1 != "" && week1 != "" && lane != "" && bound != ""){
    		...
    		rtn = sheetObj.GetSearchXml("ESM_SPC_0058GS.do", param);
...
//    	formObj.in_vvd.value = "";
     ...
     */
    function setVVD(formObj, sheetObj, strVvd, strRelvvd, currVvd){
    	...
    	for(var j=0; j< vvdArr.length; j++){
    		...
    		// 2013.12.24 신자영 VVD상에 multi발생 시 ESM_SPC_0047에서 선택한 vvd로 강제 setting
    		if(vvdArr[j] == currVvd) {
    			formObj.re_vvd.value = relArr[j];
    			formObj.vvd.value = vvdArr[j]
    		}
    	}
    ...
    function sheet1_OnSearchEnd(sheetObj , ErrMsg){
    	...
    	//btn_save.parentNode.parentNode.parentNode.parentNode.style.display = "none";
