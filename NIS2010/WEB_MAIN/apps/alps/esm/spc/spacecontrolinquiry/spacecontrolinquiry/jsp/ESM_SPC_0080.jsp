...
<%@ page import="com.hanjin.apps.alps.esm.spc.spacecontrolinquiry.spacecontrolinquiry.event.EsmSpc0080Event"%>
					...
					<td class="bg">
						...
						<table class="search_in" border="0">
							<tr class="h23">
								...
								<td width="130"><img class="nostar">Sub Trade</td> <!-- 2010.09.16 이윤정  [CHM-201005916-01] Sub Trade 화면 조건 추가 -->
							...
							<tr class="h23">
								...
								<td colspan="1" style="padding-left:2"><script language="javascript">ComComboObject('operator',1,60,0);</script></td>
