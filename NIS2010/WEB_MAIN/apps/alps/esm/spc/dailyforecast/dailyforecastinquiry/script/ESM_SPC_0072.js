...
//        	    		var HeadTitle = "SEQ|BKG No.|SC No.|RFA No.|C.Customer Name|PORT|YARD|S.LANE|ETA DATE|ETD DATE|T.IND|C.IND" ;
        	    		var HeadTitle = "BKG No.|SC No.|RFA No.|C.Customer Name|TP/SZ";
        	    		//해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
        	    		InitHeadRow(0, HeadTitle, true);
        	    		
        	    		//데이터속성    [ROW, COL,  DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
//                        InitDataProperty(0, cnt++ , dtData,      27,    daCenter,  false,    "seq"        	   ,       	false,          "",       dfNone,   	0,     false,       true);
                        ...
                        InitDataProperty(0, cnt++ , dtData,      200,   daLeft,    false,    "ctrt_nm"    	   ,        false,          "",       dfNone,       0,     false,       true);
                        InitDataProperty(0, cnt++ , dtData,      100,   daLeft,    false,    "tpsz"    	   	   ,        false,          "",       dfNone,       0,     false,       true);
        	    	}
        	    	break;
        	}
        }
        ...
        function doActionIBSheet(sheetObj,formObj,sAction,a,PageNo) {
        	...
        	switch(sAction) {
        	    case IBSEARCH:      //조회
        	    	...
        	    	var rtnXml = sheetObj.GetSearchXml("ESM_SPC_0072GS.do", FormQueryString(formObj));
