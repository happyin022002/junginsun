...
<%@ page import="com.hanjin.apps.alps.esm.spc.dailyforecast.dailyforecastinquiry.event.EsmSpc0105Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSpc0105Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSpc0105Event)request.getAttribute("Event");
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="100"><select class="input" name="rhq_cd" onchange="rhq_cd_OnChange();"><option value="">ALL</option><option value="SHARC">SHARC</option><option value="SINRS">SINRS</option><option value="NYCRA">NYCRA</option><option value="HAMRU">HAMRU</option></select></td>
					<td width="100"><img class="nostar">RGN OFC</td>
					<td width="100"><script language="JavaScript">ComComboObject("ofc_cd", 2, 70, 0);</script></td>
				</tr>
				<tr class="h23">
					<td width="50" id="txtLane"><img class="nostar">Lane</td>
					<td width="150"><script language="JavaScript">ComComboObject("lane", 2, 80, 0);</script></td>
					...
					<td width="100"><input type="input" class="input1" name="pol1" size="6" maxlength="5" style="ime-mode:disabled;" onkeypress="eventKeyChangeChar(UPPER_CASE);"></td>
					
					<td width="70" id="txtDel"><img class="nostar">DEL</td>
					<td width="100"><input type="input" class="input1" name="del" size="9" maxlength="5" style="ime-mode:disabled;" onkeypress="eventKeyChangeChar(UPPER_CASE);"></td>
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td width="90">Data Sort : </td>
								<td width="5"></td>
								<td><input type="radio" class="trans" value="1" name="chkPreLane" id="dsPreLane" onclick="return changeSortSelection();"></td>
								<td><label for="dsPreLane" id="txtDsPreLane">By Pre Lane</label></td>
								<td width="5"></td>
								<td><input type="radio" class="trans" value="2" name="chkPostLane" id="dsPostLane" checked onclick="return changeSortSelection();"></td>
								<td><label for="dsPostLane">By Post Lane</label></td>
								<td width="5"></td>
							</tr>
						</table>
					</td>
				...
				<td>
					...
					<td width="5"></td>
					<td><input type="checkbox" class="trans" value="3" name="chkDsPort" id="dsPort" checked onclick="return changeDataSelection();"></td><td><label for="dsPort" id="txtDsPort">POL/POD</label></td>
					<td width="5"></td>
					<td><input type="checkbox" class="trans" value="4" name="chkDsDel" id="dsDel" checked onclick="return changeDataSelection();"></td><td><label for="dsDel" id="txtDsDel">DEL</label></td>
					<td width="5"></td>
					...
					<td width="5"></td>
					<td><input type="checkbox" class="trans" value="6" name="chkDsLane" id="dsLane" checked onclick="return changeDataSelection();"></td><td id="divDs2POD"><label for="dsLane">Lane/VVD</label></td>
					<td width="5"></td>
					...
					<td width="5"></td>
					<td><input type="checkbox" class="trans" value="7" name="chkDsPsVvd" id="dsPsVvd" onclick="return showPrePostDataCol();"></td><td id="divDsVvd"><label for="dsPsVvd">Post.VVD</label></td>
					<td width="5"></td>
					<td><input type="checkbox" class="trans" value="7" name="chkDsDPsVvd" id="dsDPsVvd" onclick="return showPrePostDataCol();"></td><td id="divDPsVvd"><label for="dsPsVvd">Post VVD info</label></td>
					<!--<td width="5"></td>
