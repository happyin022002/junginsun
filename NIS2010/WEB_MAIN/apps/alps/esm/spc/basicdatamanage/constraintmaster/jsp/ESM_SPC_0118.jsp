...
<%
    ...
    String pgm="";
    String rptFomNm="";
    Logger log = Logger.getLogger("com.hanjin.alps.esm.spc.ESM_SPC_0118");
    try {
        ...
        pColDesc =JSPUtil.getNull(request.getParameter("col_desc"));
        reportFormPopupCallCnt = JSPUtil.getNull(request.getParameter("call_cnt"));        
        pgm =JSPUtil.getNull(request.getParameter("pgm"));
        rptFomNm =JSPUtil.getNull(request.getParameter("rpt_fom_nm"));
        serverException = (Exception)request.getAttribute(CommonWebKeys.EXCEPTION_OBJECT);
...
<input type="hidden" name="rpt_fom_nm" id="rpt_fom_nm" value="">
<input type="hidden" name="sht_flag" id="sht_flag" value="">
<!-- OUTER - POPUP (S)tart -->
            ...
            <table class="search" border="0">
              ...
              <tr>
                <td colspan="4" class="sm">
                  ...
                  <input type="text" style="width:80;" name="f_savename" value="">(Name)
                  <input type="text" style="width:160;" name="f_rpt_fom_desc" value="">(Description)
                </td>
              </tr>
            </table>
            <!-- : ( Grid ) (E) -->
