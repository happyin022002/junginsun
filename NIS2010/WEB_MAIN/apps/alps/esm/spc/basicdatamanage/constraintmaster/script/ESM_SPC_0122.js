 ...
 * 2015.07.06 ESM_BKG_1183 COPY, [CHM-201536749]Mastertable Import기능 오류 수정 CR에 반영(Revenue Management System 추가 보완 개발 요청 선반영) 
...
/**
 * @extends
 * @class ESM_SPC_0122 : ESM_SPC_0122 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_SPC_0122() {
...
function loadPage() {
	try {
		if (document.form.bkg_no.value == '') {
			ComShowCodeMessage("SPC90307");// 조회를 위한 BKG no가 없습니다.
			self.close();
		}
...
//			SheetWidth = mainTable.clientWidth;
			...
			var HeadTitle = "|Seq|Type|Total Amount\n(USD)|Remark";
...
//			InitDataProperty(0, cnt++, dtCheckBox, 40, daCenter, true, "del_chk", false, "", dfNone, 0, true, true);
			...
			InitDataProperty(0, cnt++, dtData, 120, daLeft, false, "cost_nm", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, false, "amt", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 170, daLeft, false, "rmk", false, "", dfNone, 0, false, false);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	sheetObj.DoSearch("ESM_SPC_0122GS.do", sParam);
}
