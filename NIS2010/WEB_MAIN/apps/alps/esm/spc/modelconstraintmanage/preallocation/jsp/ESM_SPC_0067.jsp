...
<%@ page import="com.hanjin.apps.alps.esm.spc.modelconstraintmanage.preallocation.event.EsmSpc0067Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSpc0067Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.ModelConstraintManage.PreAllocation");
	...
	try {
		...
		event = (EsmSpc0067Event)request.getAttribute("Event");
...
<html>
<head>
<title>Pre-Allocation Creation</title>
		...
		<!-- TABLE '#D' : ( Search Options ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="3%">Year</td>
					<td width="13%" style="padding-left:3;">
						<select class="input1" name="year" style="width:70;"></select>
					</td>
					<td width="5%">Month</td>
					<td width="11%">
						<select class="input" name="month" style="width:50;"></select>
					</td>
					<td width="15%">Representative Trade</td>
					<td width="12%">
						<script language="JavaScript">ComComboObject("trade", 2, 60, 0, 0);</script>
					</td>
					<td width="7%">To Trade</td>
					<td width="12%">
						<script language="JavaScript">ComComboObject("toTrade", 2, 60, 0, 0);</script>
					</td>
					<td width="5%">Bound</td>
					<td>
