...
<%@ page import="com.hanjin.apps.alps.esm.spc.spaceallocationmanage.spaceallocationmanage.event.EsmSpc0031Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%

	EsmSpc0031Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSpc0031Event)request.getAttribute("Event");
...
<!-- 개발자 작업	-->
<!-- Outer Table (S)-->
<table width="900" border="0" cellpadding="0" cellspacing="0" class="bodypadding">
<tr><td>

		<!-- TABLE '#D' : ( Page Title, Historical Tail Navigation ) (S) -->
     	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Lane Status</td></tr>
		</table>
			...
			<tr><td class="bg">
				<table class="search" border="0">
					<tr class="h23">
						...
						<td width="55"><img class="nostar">VVD</td>
						<td width="100"><input type="text" name="vvd" class="input2" style="width:90;text-align:center" value="<%=vvd%>" readonly="readonly"></td>
						<td width="120">
							<input type="radio" value="Y" name="type" class="trans" checked>Yield Group
							<input type="radio"	value="D" name="type" class="trans">DEST
						</td>
					</tr>
				</table>
			</td></tr>
