...
//        			   if(!validateForm(sheetObjects[2],document.form,IBSAVE)){
//                           return false;
//                       }
        			   //Row Add 후 Ratio 값 검사. - 비어있으면 안됨.
        			   if( sheetObjects[2].CellValue(sheetObjects[2].SelectRow,"ibflag") != "D" && sheetObjects[2].CellValue(sheetObjects[2].SelectRow,"bkg_ctrl_rto") == "") { //ratio input check
//        				   ComShowMessage("ratio input check");//getMsg("SPC90147"));
        				   ComShowMessage(getMsg("SPC90147"));
        				   return false;
        			   }
        			   if( sheetObjects[2].CellValue(sheetObjects[2].SelectRow,"bkg_ctrl_dtl_cd") == "" ) { //office code select check
//        				   ComShowMessage("office code select check");//getMsg("SPC90148"));
        				   ComShowMessage(getMsg("SPC90148"));
        				   return false;
        			   }
        			   ...
        			   var param = "f_cmd=" + MULTI02;//SpcFormString(sheetObjects[2],"f_cmd");
        			   param += "&trd_cd=" + sheetObjects[0].CellValue(mainRow,"trd_cd") + 
        			   "&sub_trd_cd=" + sheetObjects[0].CellValue(mainRow,"sub_trd_cd") + 
//        			   "&rlane_cd=" + sheetObjects[0].CellValue(mainRow,"rlane_cd") + 
//        			   "&dir_cd=" + sheetObjects[0].CellValue(mainRow,"dir_cd") +
    		...
    		switch(sheetNo) {
    			 case 1:      //sheet1 init
    				with (sheetObj) {
    					...
    					var HeadTitle  = "Rep.\nTrade|Sub\nTrade|Lane|BD|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Control Option|Account Group|Account Group|Account Group|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|BKG Control|";
    					var HeadTitle1 = "Rep.\nTrade|Sub\nTrade|Lane|BD|D2|D4|HC|45'|53'|RF|RD|WGT|POL\n/POD|Dest|Dest|Dest|US\nMOD|Acct\n/CMDT|Fixed\nFlag|Yield\nGroup|From|To|By\nAlloc|By\nSMP|By\nMaster|BKG Apply|BKG Apply|BKG Apply|ALOC|ALOC|ALOC|SMP|SMP|SMP|MasterTable|MasterTable|MasterTable|";
    					// 2015.02.12 LOC->ECC Group 으로 변경
    					var HeadTitle2 = "Rep.\nTrade|Sub\nTrade|Lane|BD|D2|D4|HC|45'|53'|RF|RD|WGT|POL\n/POD|ECC|Loc Group|POD\n/DEL|US\nMOD|Acct\n/CMDT|Fixed\nFlag|Yield\nGroup|From|To|By\nAlloc|By\nSMP|By\nMaster|Must|F'CST|F'CST L/F|Must|F'CST|F.L/F|Must|F'CST|F.L/F|Must|F'CST|F.L/F|";
    					...
    					InitDataProperty(0, cnt++, dtData,         50,    daCenter,  true,	   "trd_cd",     	   				false,          "",       dfNone,    		0,     false,  true, 		0,		false,		false); //Rep. Trade
    					InitDataProperty(0, cnt++, dtData,         40,    daCenter,  true,     "sub_trd_cd", 	   				false,          "",       dfNone,    		0,     false,  true, 		0,		false,		false); //Sub Trade
    					InitDataProperty(0, cnt++, dtData,         50,    daCenter,  true,     "rlane_cd",         				false,          "",       dfNone,    		0,     false,  true, 		0,		false,		false); //Lane
    					InitDataProperty(0, cnt++, dtData,         30,    daCenter,  true,     "dir_cd",           				false,          "",       dfNone,    		0,     false,  true, 		0,		false,		false); //Bound

    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_d2_flg",     				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //D2
    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_d4_flg",     				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //D4
    				
    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_40ft_hc_flg", 				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //HC
    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_45ft_hc_flg", 				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //45
    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_53ft_flg",    				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //53
    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_rf_flg",      				false,          "",       dfNone,   		0,     true,   true, 		0,		false,		false, false, false, "", false); //Reefer
    					
    					InitDataProperty(0, cnt++, dtCheckBox,     30,    daCenter,  true,     "ctrl_rd_flg",     				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //RD
    					...
    					InitDataProperty(0, cnt++, dtCombo,        65,    daCenter,  true,     "ctrl_lvl_cd",      				false,          "",       dfNone,    		0,     true,   true); //POL/POD
    					
    					InitDataProperty(0, cnt++, dtCheckBox,     35,    daCenter,  false,    "ctrl_ecc_flg",     				false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //ECC    					    				
    					InitDataProperty(0, cnt++, dtCheckBox,     50,    daCenter,  false,    "ctrl_ecc_grp_flg",     			false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //LOC    					
    					InitDataProperty(0, cnt++, dtCombo,  	   50,    daCenter,  false,	   "ctrl_dest_lvl_cd",   			false,  		"",  	  dfNone,   		0, 	   true,   true);	//POD/DEL
    					...
    					InitDataProperty(0, cnt++, dtCheckBox,     45,    daCenter,  true,     "ctrl_acct_flg",     			false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //Account
    					InitDataProperty(0, cnt++, dtCheckBox,     50,    daCenter,  true,     "ctrl_fx_rt_flg",     			false,          "",       dfNone,    		0,     true,   true, 		0,		false,		false, false, false, "", false); //Fixed Rate Apply

    					
    					InitDataProperty(0, cnt++, dtCheckBox,     45,    daCenter,  true,     "acct_grp_ctrl_flg",				false,          "",       dfNone,    		0,     false,   true, 		0,		false,		false, false, false, "", false); //Yield Group
    					InitDataProperty(0, cnt++, dtData,         55,    daCenter,  true,     "aply_fm_yrwk",     				false,          "",       dfUserFormat,     0,     false,   false); 
    					InitDataProperty(0, cnt++, dtData,         55,    daCenter,  true,     "aply_to_yrwk",     				false,          "",       dfUserFormat,     0,     false,   false); 
    					
    					// 2015.01.12 booking control 추가
    					InitDataProperty(0, cnt++, dtHidden,       45,    daCenter,  true,	   "bkg_ctrl_aloc_flg",     		false,  		"",  	  dfNone,    		0, 		true,   true, 		0,		false,		false, false, true, "", false);
    					InitDataProperty(0, cnt++, dtHidden,       45,    daCenter,  true,     "bkg_ctrl_acct_grp_flg", 		false,          "",       dfNone,    		0,     	true,   true, 		0,		false,		false, false, true, "", false);
    					InitDataProperty(0, cnt++, dtHidden,       55,    daCenter,  true,     "bkg_ctrl_mst_flg",     			false,          "",       dfNone,    		0,     	true,   true, 		0,		false,		false, false, true, "", false);
    					
    					// 2015.01.13 3개 booking control의 적용 여부 or FCST기준 적용 여부
    					InitDataProperty(0, cnt++, dtHidden,       35,    daCenter,  true,		"bkg_ctrl_aply_flg",   			false,  		"",  	  dfNone,    		0, 		true,   true, 		0,		false,		false, false, false, "", false);
    					InitDataProperty(0, cnt++, dtHidden,       35,    daCenter,  true,		"bkg_ctrl_fcst_flg",    		false,          "",       dfNone,       	0,     	true,   true, 		0,		false,		false, false, false, "", false);
    					InitDataProperty(0, cnt++ ,dtHidden,  	   45,    daCenter,  false,		"bkg_ctrl_fcst_rto",  			false, 			"",       dfNumber,   		0, 		false,  true);	//	Control Office List
    					//2015.06.  요건 변경으로 추가됨
...
//    					HeadRowHeight = 21 ;
       			 ...
       			 case 2:      //sheet2 init
     				with (sheetObj) {
     					...
     					var HeadTitle  = "DEL.|Fixed\nFlag|STS|Rep. Trade|Sub Trade|Lane|Bound|Control|ECC/Loc Group\n/Contract|Office|ACCT,CMDT/\nLocation|Contractor Name|Account Name/\nCommodity Desc.";
     					
     					//해더행정보[필수][ROW,HEADTEXT,ROWMERGE=false, HIDDEN=false]
     					InitHeadRow(0, HeadTitle, true);
     					
     					//데이터속성    [ROW, COL,  DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
     					InitDataProperty(0, cnt++ , dtDelCheck,   			50,   daCenter,   	false,  "",     	 		false,	"",  dfNone,   		0, true,  true);
    					InitDataProperty(0, cnt++,  dtCheckBox,     		60,   daCenter,  	true,   "ctrl_fx_rt_flg",   false,  "",  dfNone,    	0, true,  false); 		//Fixed Rate Apply
     					...
     					InitDataProperty(0, cnt++ , dtCombo,  				120,  daCenter,  	false,	"aloc_ctrl_tp_cd",   false,  "",  dfNone,   	0, false, true);		//	Control   					
     					InitDataProperty(0, cnt++ , dtPopup,  				90,   daCenter,  	false,	"ctrl_loc_acct_cd",  false,  "",  dfNone,   	0, false, true, 10);	//	ctrl_loc_acct_cd Code
     					InitDataProperty(0, cnt++ , dtPopup,  				70,   daCenter,  	false,	"ofc_cd",  			 false,  "",  dfNone,   	0, true,  true);		//	Control Office List
     					InitDataProperty(0, cnt++ , dtData,  				110,  daCenter,  	false,	"aloc_ctrl_dtl_cd",  false,  "",  dfNone,   	0, false, true);		//	Code
     					InitDataProperty(0, cnt++ , dtData,  				130,  daLeft,  	    false,	"ctrt_nm",  		 false,  "",  dfNone,   	0, false, false);		//	Code
...
//     					InitDataCombo (0, "aloc_ctrl_tp_cd", "ECC|LOC Group|Contract(I/Acct)|Contract(A/Acct)|Contract(Commodity)", "E|G|A|B|C");
       			...
       			case 3:
     				with (sheetObj) {
     		            ...
     		            InitDataProperty(0, cnt++ , dtHiddenStatus,     	30,    daCenter,   false,    "ibflag",   	false,	"",       dfNone,   	0,     false,      true);
     					InitDataProperty(0, cnt++ , dtCombo,  		110,  daCenter,  	false,	"bkg_ctrl_tp_cd",  		false,  "",  dfNone,   		0, 		false, true);	//	Control Office List
     					InitDataProperty(0, cnt++ , dtPopup,  		70,   daCenter,  	false,	"bkg_ctrl_dtl_cd",  	false,  "",  dfNone,   		0, 		false, true);	//	Control Office List
     					InitDataProperty(0, cnt++ , dtData,  		70,   daCenter,  	false,	"bkg_ctrl_rto",  		false,  "",  dfNumber  ,   	0, 		false, true);	//	Control Office List
     					InitDataProperty(0, cnt++ , dtCheckBox,  	70,   daCenter,  	false,	"bkg_ctrl_acct_flg",  	false,  "",  dfNumber  ,   	0, 		false, true);	//	Control Office List
     					InitDataProperty(0, cnt++ , dtHidden,  	70,   daCenter,  	false,	"rd_flg",  	false,  "",  dfNumber  ,   	0, 		false, true);	//	조건 완화되면 spc_aloc_ctrl 테이블의 RAPLY_CFM_FLG를 setting
...
//	   				if(!checkDupRow(sheetObj)){		//동일한 값이 있는지 검사.
//						alert( "Row duplicated!" );
//		            	return false;
//		            }
    	...
    	function validateForm(sheetObj,formObj,sAction){
    		switch (sAction){
    				...
    				for ( var i = 0; i < sArr.length - 1; i++) {
    					...
    					if(sheetObj.CellValue(sArr[i], "ctrl_lvl_cd") == "T") {
    						if(sheetObj.CellValue(sArr[i], "ctrl_ecc_flg") == "0" && sheetObj.CellValue(sArr[i], "ctrl_ecc_grp_flg") == "0") { // ECC 또는 Loc 필수 체크
    							ComShowCodeMessage("COM12113", "ECC or ECC Group"); 
    			...
    			case COMMAND01: //sheet2 save
					...
					if( code.length < 5 ) {
//						alert("Please enter at least 5 characters at Ecc, Loc Group Code");
...
//        	    		Value = "Y";
        ...
        function sheet1_OnSearchEnd(sheetObj, ErrMsg){
        	...
        	for(var i=sheetObj.HeaderRows; i<sheetObj.HeaderRows+sheetObj.RowCount; i++){
        		...
        		if(sheetObj.CellValue(i, "bkg_ctrl_mst_tbl_fcast_flg") == "1") {
        			sheetObj.CellEditable(i, "bkg_ctrl_mst_tbl_fcast_rto") = true;
        		} else {
        			sheetObj.CellEditable(i, "bkg_ctrl_mst_tbl_fcast_rto") = false;
        			sheetObj.CellValue2(i, "bkg_ctrl_mst_tbl_fcast_rto")  = "";
        		}		
...
//        	    		sheetObj.CellEditable(Row, "bkg_ctrl_rto") = true;
        	    		...
        	    		//SMP인 경우 이전에 들어간 Rlane, dir 값이 있는 경우 해당 값을 사용하고 없는 경우 현재 선택된 rlane, dir 값을 사용
        	    		var flag = false;
        	    		for( var x=1 ; x<=sheetObjects[2].RowCount ; x++ ) {
	    	        		if( sheetObjects[2].CellValue( x , "bkg_ctrl_tp_cd" ) == "S" ){
	    	        			sheetObjects[2].CellValue2( Row , "rlane_cd") = sheetObjects[2].CellValue( x , "rlane_cd" );
	    	        			sheetObjects[2].CellValue2( Row , "dir_cd") = sheetObjects[2].CellValue( x , "dir_cd" );
	    	        			flag = true;
	    	        			break;
	    	        		}
	    	        	}
...
//        	    		sheetObj.CellValue2(Row, "bkg_ctrl_rto") = "";
		...
		function checkDupRow(sheetObj){
			...
			if( sheetObj == sheetObjects[2] )
				cmprCol = "2|3";		//Control, ECC, Account , Contractor Name, Account Name
			else
