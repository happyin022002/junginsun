...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_SPC_0031 : ESM_SPC_0031 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_SPC_0031() {
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
    				...
    				InitDataProperty(0, cnt++ , dtData,		40,		daRight,	true,		"bsa",			false,	"",			dfNone,			0,		true,  true);
    				InitDataProperty(0, cnt++ , dtData,		50,		daCenter,	true,		"cust_ctrl_cd",	false,	"",			dfNone,			0,		true,  true);
    				InitDataProperty(0, cnt++ , dtData,		50,		daCenter,	true,		"dest_loc_cd",	false,	"",			dfNone,			0,		true,  true);
    	...
    	switch(sAction) {
    		case IBSEARCH:      //조회
    			if (validateForm(sheetObj, formObj, sAction)) {
    				...
    				var rtnXml = sheetObj.GetSearchXml("ESM_SPC_0031GS.do", param);
    ...
    function sheet1_OnSearchEnd(sheetObj, ErrMsg){
    	...
    	if(formObj.type[0].checked){
    		sheetObj.ColHidden("cust_ctrl_cd") = false;
    		sheetObj.ColHidden("dest_loc_cd") = true;
    		
    		sheetObj.ColHidden("fcast_diff") = false;
    		sheetObj.ColHidden("fcast_rto_diff") = false;
    		sheetObj.ColHidden("aloc_diff") = false;
    		sheetObj.ColHidden("aloc_rto_diff") = false;
    		sheetObj.ColHidden("bkg_diff") = false;
    		sheetObj.ColHidden("bkg_rto_diff") = false;
    	}else{
    		sheetObj.ColHidden("cust_ctrl_cd") = true;
    		sheetObj.ColHidden("dest_loc_cd") = false;
    		
    		sheetObj.ColHidden("fcast_diff") = true;
    		sheetObj.ColHidden("fcast_rto_diff") = true;
    		sheetObj.ColHidden("aloc_diff") = true;
    		sheetObj.ColHidden("aloc_rto_diff") = true;
    		sheetObj.ColHidden("bkg_diff") = true;
    		sheetObj.ColHidden("bkg_rto_diff") = true;
    	}
    }
