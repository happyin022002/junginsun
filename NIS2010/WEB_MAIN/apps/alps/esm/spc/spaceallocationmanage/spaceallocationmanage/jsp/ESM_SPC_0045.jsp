...
* 2009.09.24 한상훈
* 1.0 Creation
* 2011.05.06 [CHM-201110568] 이석준 Bottleneck Check 화면 조건 보완
             VVD Input 조건 추가   
* 2015.02.09 박은주 [CHM-201534236] Bottleneck ratio button default 변경
*            F'cast+BKG -> Alloc+BKG를 default로 변경함
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esm.spc.spaceallocationmanage.spaceallocationmanage.event.EsmSpc0045Event"%>
...
<tr><td>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">	
			<tr><td class="history"><img src="img/icon_history_dot.gif"  align="absmiddle"> Sales Management > Space Control > Allocation Control > Bottleneck Check</td></tr>
			<tr><td class="title"><img src="img/icon_title_dot.gif" > Bottleneck Check </td></tr>
		</table>
		<% } else { %>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
				...
				<table class="search">
					<tr>
						...
						<table class="search" border="0">
							<tr class="h23">
								<td><input type="radio" value="F" name="dataSelect"	class="trans" onclick="changeTitle2();">F'cast + BKG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio" value="B" name="dataSelect" class="trans" onclick="changeTitle2();">BKG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio"	value="V" name="dataSelect" class="trans" onclick="changeTitle2();">VGM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio" value="A" name="dataSelect" class="trans" onclick="changeTitle2();" checked>Alloc. +BKG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio" value="W" name="dataSelect" class="trans" onclick="changeTitle2();" >Alloc. +VGM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="tabLayer" style="display:none"><!-- TABLE '#D' : ( Search Options ) (S) -->
				<table class="search">
					<tr><td class="bg">
						...
						<table class="search" border="0">
							<tr class="h23">
								<td><input type="radio" value="F" name="dataSelect1" class="trans" onclick="changeTitle1();">F'cast	+ BKG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio"	value="B" name="dataSelect1" class="trans" onclick="changeTitle1();">BKG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio"	value="V" name="dataSelect1" class="trans" onclick="changeTitle1();">VGM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio" value="A" name="dataSelect1" class="trans" onclick="changeTitle1();" checked>Alloc. +BKG&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								    <input type="radio" value="W" name="dataSelect1" class="trans" onclick="changeTitle1();" >Alloc. +VGM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
