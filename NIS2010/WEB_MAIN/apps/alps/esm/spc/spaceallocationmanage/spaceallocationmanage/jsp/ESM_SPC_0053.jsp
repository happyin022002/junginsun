...
<%@ page import="com.hanjin.apps.alps.esm.spc.spaceallocationmanage.spaceallocationmanage.event.EsmSpc0053Event"%>
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="30">VVD</td>
					<td width="">&nbsp;<input type="text" style="width:80;ime-mode:disabled;" name="vvd" value="" maxlength=9 onkeypress="eventKeyChangeChar(UPPER_CASE);"onchange="checkValue();">
						<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_popup_vvd"></td>
				</tr>
