...
<%@ page import="com.hanjin.apps.alps.esm.pri.profitabilitysimulation.cmsummary.event.EsmPri6052Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6052Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6052Event)request.getAttribute("Event");
    		...
    		<!-- : ( Search Options ) (S) -->
    			...
    			<table class="search"> 
           		<tr><td class="bg">
    				...
    				<tr><td class="title_h"></td>
    					<td class="title_s">Gross Revenue Detail (Contract Proposal)</td>
    			<td align="right" class="sm">[Unit: <%=frm_pfmc_unit %>/USD]</td>
    				...
    				<tr class="h23">
    					...
    					<td class="SM">&raquo; Previous:  Previous summary data for the same customer of the proposed contract<br>
    &raquo; New      : Estimated summary data based on the current contract<BR>
    &raquo; Gross Revenue(Previous) : The amount of Gross Revenue comes from containerized rating in BKG. So it can be different from the amount in main screen which is based on COA.
    </td>
    				</tr>	
    				</table>
