...
<%@ page import="com.hanjin.apps.alps.esm.pri.profitabilitysimulation.cmsummary.event.EsmPri6031Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.apps.alps.esm.pri.common.PRIUtil"%>
<%@ page import="com.hanjin.apps.alps.esm.pri.pricommon.pricommon.vo.RsltCdListVO"%>
<%@ page import="java.util.List"%>
<%
	EsmPri6031Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6031Event)request.getAttribute("Event");
		...
		// sub trade
		comboData = (List<RsltCdListVO>)eventResponse.getCustomData("SubTrdCdCombo");
		subTrdCdCombo = PRIUtil.getValueObject2StringArray(comboData,false);
...
<script language="javascript">
	...
	var subTrdCdValue = "<%=subTrdCdCombo[0]%>";		
	var subTrdCdText = "<%=subTrdCdCombo[1]%>";
...
<input type="hidden" name="min_smr_eff_yr"  >
<input type="hidden" name="min_smr_eff_wk"  >
<input type="hidden" name="max_smr_exp_yr"  >
<input type="hidden" name="max_smr_exp_wk"  >
...
<input type="hidden" name="min_yrwk">
<input type="hidden" name="max_yrwk">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  CM/OP Summary- Simulation(Contract Approval)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
