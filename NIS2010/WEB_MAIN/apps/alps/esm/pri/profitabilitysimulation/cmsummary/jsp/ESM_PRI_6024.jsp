...
<%@ page import="com.hanjin.apps.alps.esm.pri.profitabilitysimulation.cmsummary.event.EsmPri6024Event"%>
...
<%
	EsmPri6024Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6024Event)request.getAttribute("Event");
		...
		//Status
		comboData = (List<RsltCdListVO>)eventResponse.getCustomData("StatusCombo");
		statusCombo = PRIUtil.getValueObject2StringArray(comboData);
		// Profit View
...
<script language="javascript">
	...
	var statusComboValue = "<%=statusCombo[0]%>";
	var statusComboText = "<%=statusCombo[1]%>";
...
<input type="hidden" name="searched_status">
...
<input type="hidden" name="searched_slane_cd">
		...
		<table class="search"> 
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="330">
						<table class="search_sm2" border="0" style="width:200;"> 
							<tr>
								...
								<td class="noinput1"><input type="checkbox" value="S" class="trans" name="frm_contract_type_s" checked>S/C&nbsp;&nbsp;&nbsp;<input type="checkbox" name="frm_contract_type_r" value="R" class="trans" checked>RFA</td>
							</tr>
						</table>
					</td>
					<td width="300">
					...
					<td width=""><script language="javascript">ComComboObject('frm_status', 1, 85, 0, 1);</script></td>
				</tr>
				</table>
				...
				<tr class="h23"><td>
					...
					<tr>
						...
						<td width="120"><input type="text" style="width:68;" class="input" value="" name="frm_dest_rout_cd"  dataformat="engup" maxlength="3"><input type="hidden"  value="" name="frm_dest_loc_tp"   >
						<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor" name="btn_dest">&nbsp;</td>
						<td width="65">SVC Lane</td>
						<td width=""><input type="text" style="width:200;" class="input" value="" name="frm_slane_cd" readonly>
						<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor" name="btn_slane">&nbsp;</td>
