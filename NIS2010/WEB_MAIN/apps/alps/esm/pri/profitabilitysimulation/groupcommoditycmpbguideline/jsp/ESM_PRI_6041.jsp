...
<%@ page import="com.hanjin.apps.alps.esm.pri.profitabilitysimulation.groupcommoditycmpbguideline.event.EsmPri6041Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6041Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.ProfitabilitySimulation.GroupCommodityCMPBGuideline");
	...
	try {
		...
		event = (EsmPri6041Event)request.getAttribute("Event");
...
<html>
<head>
<title>CMPB Guideline Creation - Commodity Group</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;CMPB Guideline Creation - Commodity Group </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
