 ...
 *@FileTitle : CMPB Guideline Creation - Excel Import (Vertical)
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.profitabilitysimulation.cmpbguideline.event.EsmPri6002Event"%>
...
<html>
<head>
<title>CMPB Guideline Creation - Excel Import (Vertical)</title>
...
<!-- OUTER - POPUP (S)tart -->
<table width="960" class="popup" cellpadding="10" border="0"> 
<tr><td class="top"></td></tr>
<tr><td valign="top">
	
	<!-- : ( Title ) (S) -->
		<table width="100%" border="0">
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;CMPB Guideline Creation - Excel Import (Vertical)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
