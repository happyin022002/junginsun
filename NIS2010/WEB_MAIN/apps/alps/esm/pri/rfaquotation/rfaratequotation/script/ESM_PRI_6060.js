...
*@FileName : ESM_PRI_6060.js
*@FileTitle : RFA Rate Creation - Commodity 
*Open Issues :
*Change history :
              ...
              case "sheet1":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle = "|Sel.|Seq.|1|2|3|4|5|6|CMDT Type|CMDT Code|Commodity Description|Sort Order|fic_rt_tp_cd";
...
// 	  				  				  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX] 
                     ...
                     InitDataProperty(0, cnt++, dtHidden, 90, daLeft, false, "sort_order", false, "", dfNone, 0, true, true);
                     InitDataProperty(0, cnt++, dtHidden, 90, daLeft, false, "fic_rt_tp_cd", false, "", dfNone, 0, true, true);
          ...
          switch(sAction) {
			...
			case IBSAVE:        //저장	
				...
				for (var i = sheetObj.HeaderRows; sheetObj.RowCount > 0 && i <= sheetObj.LastRow; i++) {
					var prevRowStatus = sheetObj.RowStatus(i);
					var cmdtTpCd = sheetObj.CellValue(i, "prc_cmdt_tp_cd");
					
					if (cmdtTpCd == "G") {
						sheetObj.CellValue2(i, "sort_order") = 1;
					} else if (cmdtTpCd == "R") {
						sheetObj.CellValue2(i, "sort_order") = 2;
					} else if (cmdtTpCd == "C") {
						sheetObj.CellValue2(i, "sort_order") = 3;
					}
				}
   ...
   function sheet1_OnChange(sheetObj, Row, Col, Value)
   {
   	...
   	var formObj = document.form
	   	...
	   	case "prc_cmdt_def_cd":
			if (Value.length == 6){
				...
				formObj.cd.value = Value;
				var param = "&etc1=" + formObj.qttn_no.value + "&etc2=" + formObj.qttn_ver_no.value + "&etc5=RQ";	
	...
	function sheet1_OnPopupClick(sheetObj, Row, Col)
	{
		...
		if (colName == "prc_cmdt_def_cd"){
			var sUrl = "/hanjin/ESM_PRI_4027.do?commodity_cmd=CRG&grp_cd="+PRI_RQ+"&qttn_no="+formObj.qttn_no.value+"&qttn_ver_no="+formObj.qttn_ver_no.value;
