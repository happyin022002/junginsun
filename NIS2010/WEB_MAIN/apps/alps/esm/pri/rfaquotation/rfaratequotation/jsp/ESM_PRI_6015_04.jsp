...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri601504Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601504Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601504Event)request.getAttribute("Event");
