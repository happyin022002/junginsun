...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6069Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6069Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6069Event)request.getAttribute("Event");
	...
	String serviceCode = JSPUtil.getParameter(request, "service_code", "SP");
%>
<html>
<head>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:100%;"> 
    				<tr class="h23">
    					...
    					<td class="SM">
    					&raquo; [Schg Detail] is not related to Auto-rating. In case of any note clause existing on RFA, you have to input note conversion for Auto-rating.<br></td>   					
    				</tr>	
    				</table>
