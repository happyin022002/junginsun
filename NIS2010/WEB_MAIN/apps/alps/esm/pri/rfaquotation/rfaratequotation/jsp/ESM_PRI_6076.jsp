...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6076Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmPri6076Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
  ...
  //title
    ...
    if("CM".equals(request.getParameter("bkg_cm_op"))) 
    	title = "RFA Quotation CMPB View All";
    else
    	title = "RFA Quotation OPB View Al";
    ...
    try {
        ...
        event = (EsmPri6076Event)request.getAttribute("Event");
