 ...
 *@FileName : ESM_PRI_6045.js
 *@FileTitle : RFA Quotation Creation - Rate [Check Duplicate]
 *Open Issues :
 *Change history :
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: // sheet1 init
		with (sheetObj) {
			...
			var HeadTitle = "|Seq.|qttn_no|qttn_ver_no|cmdt_hdr_seq|rout_seq|rt_seq|Commodity Group|Origin|O.Via|D.Via|Destination|PER|CGO Type|CUR|Rate|View";
			...
			InitDataProperty(0, cnt++, dtHidden, 100, daCenter, false, "qttn_no", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtHidden, 100, daCenter, false, "qttn_ver_no", false, "", dfNone, 0, false, false);
			...
			InitDataProperty(0, cnt++, dtData, 280, daLeft, false, "prc_cmdt_def_nm", false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 165, daLeft, false, "org_rout_pnt_loc_def_nm", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "org_rout_via_port_def_nm", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "dest_rout_via_port_def_nm", false, "", dfNone, 0, true, true);
			InitDataProperty(0, cnt++, dtData, 165, daLeft, false, "dest_rout_pnt_loc_def_nm", false, "", dfNone, 0, true, true);
			...
			InitDataProperty(0, cnt++, dtData, 90, daRight, false, "qttn_rt_amt", false, "", dfNullFloat, 2, false, false);
...
/**
 * 링크한 컬럼에 마우스 오버시 호출된다. <br>
 * 커서 모양을 hand 또는 default로 조정한다.<br>
 * <br>
 * <b>Example :</b>
 * 
 * <pre>
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH: // 조회
		try {
			...
			sheetObj.DoSearch("ESM_PRI_6045GS.do", FormQueryString(formObj));
