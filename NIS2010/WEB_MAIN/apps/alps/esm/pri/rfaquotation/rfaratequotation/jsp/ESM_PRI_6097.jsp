...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6097Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	EsmPri6097Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6097Event) request.getAttribute("Event");
