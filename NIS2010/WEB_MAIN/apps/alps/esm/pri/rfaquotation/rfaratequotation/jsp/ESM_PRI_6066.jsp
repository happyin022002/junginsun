...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6066Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6066Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6066Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Quotation Cost Detail by Trans. Mode</title>
