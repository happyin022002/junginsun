...
/**
 * @extends
 * @class ESM_PRI_6082 : ESM_PRI_6082 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_PRI_6082() {
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH: //조회
		...
		case "sheet1":
			...
			sheetObj.DoSearch("ESM_PRI_6082GS.do", params);
			ComOpenWait(false);
			break;
		case "sheet2":
			ComOpenWait(true);
			...
			sheetObj.DoSearch("ESM_PRI_6082GS.do", param);
			ComOpenWait(false);
			break;
