...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri601505Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601505Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601505Event)request.getAttribute("Event");
