...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6015_03 : ESM_PRI_6015_03 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6015_03() {
...
//				WordWrap = true;
        ...
        case "sheet4":  // Grid 4 Rate
        	with (sheetObj) {
				...
				InitDataProperty(0, cnt++ , dtData,			110,daRight,	true,  "rate_adjust",  	false,	"",	dfFloat ,2,	false,	false);
        ...
        case IBSEARCH: // 조회
            ...
            try {
	            ...
	            if (sheetObj.id == "sheet1") {
	                ...
	                sheetObj.DoSearch("ESM_PRI_6015_03GS.do" , FormQueryString(formObj));
	                ...
	                formObj.f_cmd.value = SEARCH03;
	                var sXml = sheetObj.GetSearchXml("ESM_PRI_6015_03GS.do" , FormQueryString(formObj));
