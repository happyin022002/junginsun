...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6089Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6089Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6089Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Quotation Surcharge View All</title>
		...
		<!-- : ( Search Options ) (S) -->
	    	...
	    	<!-- Button_Sub (E) -->
				...
				<tr class="h23">
					...
					<td class="SM">
&raquo; Surcharge data comes from [Calculate] button click that is being used to check estimated profitability at the time of RFA Quotation.<BR>
    &nbsp;&nbsp;&nbsp;Due to this, estimated surcharge data can be different from auto-rating.<BR>
&raquo; Since this surcharge data has been generated at the time of RFA Quotation, non-revenue surcharge or undefined surcharge is excluded from the list.<BR>
