...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6079 : ESM_PRI_6079 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6079() {
 			...
 			case "sheet1":      // sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle1  = "|Sel.|Seq.|Code|Description|qttn_no|qttn_ver_no|grp_cmdt_seq|prc_cmdt_tp_cd";
            ...
            case IBSEARCH:      //조회
 				switch (sheetObj.id){
 					case "sheet1":
	 		            ...
	 		            sheetObj.DoSearch("ESM_PRI_6079GS.do", FormQueryString(formObj) + "&table_cd=SP");
	 		           ComOpenWait(false);
	 	                break;
 					case "sheet2":
 						ComOpenWait(true);
	 		            ...
	 		            sheetObj.DoSearch("ESM_PRI_6079GS.do", param);
	 		            ComOpenWait(false);
	 	                break;
 				}
 				break;
