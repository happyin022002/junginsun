...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6079Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6079Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6079Event)request.getAttribute("Event");
