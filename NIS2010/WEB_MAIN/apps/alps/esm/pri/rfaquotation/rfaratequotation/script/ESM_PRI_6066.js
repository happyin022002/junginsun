...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6066 : ESM_PRI_6066 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6066() {
             ...
             case 1:      // sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle1 = "Seq.|Route|Route|Route|Route|Per|CGO Type|Node Link|Trans.Mode|Cost Amount|GRP";
 					var HeadTitle2 = "Seq.|Origin|O. VIA|D. VIA|Dest.|Per|CGO Type|Node Link|Trans.Mode|Cost Amount|GRP";
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
	            ...
	            sheetObj.DoSearch("ESM_PRI_6066GS.do", FormQueryString(formObj) );
	            ComOpenWait(false);
                break;
 			break; 			
 			case IBINSERT:      // 입력
