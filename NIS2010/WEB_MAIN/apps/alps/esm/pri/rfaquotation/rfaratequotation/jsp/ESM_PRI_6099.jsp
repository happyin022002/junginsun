 ...
 *@FileName : ESM_PRI_6099.jsp
 *@FileTitle : Rate Creation - Excel Import For Add-On Tariff(Horizontal)
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6099Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="com.hanjin.framework.core.config.SiteConfigFactory"%>

<%
	EsmPri6099Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri6099Event) request.getAttribute("Event");
...
<html>
<head>
<title>RFA Rate Creation - Excel Import (Horizontal)</title>
...
<tr><td valign="top">
	...
	<!-- : ( Title ) (S) -->
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Quotion Creation - Excel Import  - Excel Import (Horizontal)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
