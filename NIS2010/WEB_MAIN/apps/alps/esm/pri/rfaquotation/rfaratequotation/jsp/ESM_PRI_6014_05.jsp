...
*@FileName : ESM_PRI_6014_05.jsp
*@FileTitle : RFA Quotation Rate Creation (For Add-On Tariff)
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri601405Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
	EsmPri601405Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601405Event)request.getAttribute("Event");
...
<input type="hidden" name="gen_spcl_rt_tp_cd" value="">
...
<input type="hidden" name="bak_fic_rt_tp_cd" value="">
<input type="hidden" name="fic_gline_rt_amt" value="">
		...
		<table width="100%" border="0" class="button" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
			...
			<table border="0" style="width:350;" class="search_sm2"> 
				...
				<!--grid (s)-->
				<table width="100%"  id="mainTable" name="mainTable" style="display:"> 
					<tr>
						<td width="100%">
...
<!-- Down Excel (Rate Of Include IHC)- Vertical -->
<script language="javascript">ComSheetObject('sheet13');</script>
<!-- Down Excel (Rate Of Include IHC)- Horizontal -->
