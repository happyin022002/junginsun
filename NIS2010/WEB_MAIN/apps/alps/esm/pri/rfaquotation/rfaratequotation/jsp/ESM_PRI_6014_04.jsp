...
*@FileName : ESM_PRI_6014_03.jsp
*@FileTitle : RFA Quotation Rate Creation (For AEW/AEE)
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri601404Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601404Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601404Event)request.getAttribute("Event");
