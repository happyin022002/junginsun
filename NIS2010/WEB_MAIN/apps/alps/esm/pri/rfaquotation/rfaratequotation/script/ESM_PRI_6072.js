...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6072 : ESM_PRI_6072 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6072() {
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			case IBSEARCH:      //조회
	            ...
	            sheetObj.DoSearch("ESM_PRI_6072GS.do", FormQueryString(formObj) + "&table_cd=SP");
                break;
 			case IBSAVE:        //저장
 				ComOpenWait(true);
				...
				var sXml = sheetObj.GetSaveXml("ESM_PRI_6072GS.do", sheetObj.GetSaveString() + "&" + FormQueryString(formObj)  );
 		...
 		var loc_type="";
       	...
       	switch(colName)
       	{
   	    	case "prc_cmdt_def_cd":		
 	  			...
 	  			var rtnVal = ComPriOpenWindowCenter(sUrl , "ESM_PRI_6079", 900, 334, true);
 	  			if (rtnVal != null){
   	    	...
   	    	case "dest_loc_def_cd":
			  	...
			  	params["dest_loc_tp_cd"] = sheetObj.CellValue(row,"dest_loc_tp_cd");
 	  	 		...
 	  	 		params["loc_type"] = loc_type;
 	  	  		window.Params = params; 	  	  		
 	  			var rtnVal = ComPriOpenWindowCenter(sUrl, "ESM_PRI_6082", 900, 374, true);
 	  			if (rtnVal != null){
