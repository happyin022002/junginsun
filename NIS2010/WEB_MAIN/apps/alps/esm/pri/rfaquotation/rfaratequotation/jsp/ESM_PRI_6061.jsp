...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6061Event"%>
...
<%
	EsmPri6061Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6061Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Quotation - Rate Adjust</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Quotation- Rate Adjust</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
