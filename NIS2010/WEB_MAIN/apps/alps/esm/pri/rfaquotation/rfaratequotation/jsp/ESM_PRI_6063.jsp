...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6063Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6063Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6063Event)request.getAttribute("Event");
