...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6072Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6072Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6072Event)request.getAttribute("Event");
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:100%;"> 
    				<tr class="h23">
    					...
    					<td class="SM">
    					&raquo; [Schg Adjust] is not related to Auto-rating. This can be only used to simulate pre-profitability by surcharge adjustment.<br></td>   					
    				</tr>	
    				</table>	
