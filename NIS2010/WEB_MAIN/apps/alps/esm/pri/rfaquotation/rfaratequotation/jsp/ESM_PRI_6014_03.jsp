...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri601403Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601403Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601403Event)request.getAttribute("Event");
