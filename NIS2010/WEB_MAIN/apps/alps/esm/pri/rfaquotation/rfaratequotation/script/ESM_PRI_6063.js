...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6063 : ESM_PRI_6063 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6063() {
              ...
              case "sheet1":      //sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"rout_cs_no",   			false,          "",      dfNone,      		0,			true,       true);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"rout_cs_src_dt",   			false,          "",      dfNone,      		0,			true,       true);
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
 				...
 				if ( sheetObj.id == "sheet1"){
 		            ...
 		            sheetObj.DoSearch("ESM_PRI_6063GS.do", FormQueryString(formObj)  );
 				...
 				if ( sheetObj.id == "sheet2"){
 		            ...
 		            sheetObj.DoSearch("ESM_PRI_6063GS.do", FormQueryString(formObj) +param  );
 				}
 				ComOpenWait(false);
                break;
 			case IBSAVE:        //저장
				...
				var r = sheetObj.DoSave("ESM_PRI_6063GS.do",  "f_cmd="+MULTI );
				if( r == true ){
			...
			case IBSEARCH_ASYNC01:
				...
				var param = FormQueryString(formObj) + "&popup_type=RQ";
