...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.event.EsmPri6077Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6077Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6077Event)request.getAttribute("Event");
