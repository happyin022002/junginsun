...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6069 : ESM_PRI_6069 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6069() {
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
	            ...
	            sXml = sheetObj.GetSearchXml("ESM_PRI_6069GS.do", FormQueryString(formObj) );
 			...
 			case IBSAVE:        //저장
				...
				var sXml = sheetObj.GetSaveXml("ESM_PRI_6069GS.do", sheetObj.GetSaveString() + "&" + FormQueryString(formObj)  );
    ...
    */         	
     ...
     */    
   	function getXChgRateFromYrMon(){
   		var tmpXchgYrMon = "";
      	var formObj = document.form
		var formParam = "f_cmd="+COMMAND34+"&etc1="+formObj.qttn_no.value;
         ...
         case IBSAVE: // 저장
		   ...
		   //필수 입력과 같은 확인이 이루어짐
		    if ( saveStr == ""){
         	 ...
         	 var colNames = "qttn_no|qttn_ver_no|svc_scp_cd|cmdt_hdr_seq|rout_seq|rt_seq|chg_cd";
         	 //중복체크
