...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaquotationmain.event.EsmPri6044Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmPri6044Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri6044Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Quotation Copy to Quotation</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  RFA Quotation Copy to Quotation</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
