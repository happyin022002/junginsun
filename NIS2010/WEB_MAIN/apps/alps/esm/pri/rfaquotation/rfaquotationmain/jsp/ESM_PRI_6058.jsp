...
*@FileName : ESM_PRI_6058.jsp
*@FileTitle : RFA Quotation - G/L Copy Option
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfaquotationmain.event.EsmPri6058Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmPri6058Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri6058Event)request.getAttribute("Event");
...
<input type="hidden" name="eff_dt" value="<%=request.getParameter("before_eff_dt")%>">
<input type="hidden" name="exp_dt" value="<%=request.getParameter("before_exp_dt")%>">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Quotation- Guideline Copy</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width=""><input type="text" name="svc_scp_cd" style="width:50;text-align:center;" class="input2" value="<%=request.getParameter("svc_scp_cd")%>" readonly>
					&nbsp;<input type="text" name="svc_scp_nm" style="width:312;" class="input2" value="<%=request.getParameter("svc_scp_nm")%>" readonly></td>
				</tr>
				</table>
				...
				<table border="0" style="width:100%;" class="search_sm2"> 
					...
					<tr class="h23">
						<td width="100%">
							<input type="checkbox" class="trans" name="frm_loc_chk" value="Y">&nbsp;Location Group&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class="trans" name="frm_cmdt_chk" value="Y">&nbsp;Commodity Group&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class="trans" name="frm_rate_chk" value="Y" >&nbsp;Rate
						</td>
					</tr>
