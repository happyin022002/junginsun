...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfagrouplocationquotation.event.EsmPri601501Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601501Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601501Event)request.getAttribute("Event");
