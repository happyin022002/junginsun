...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfagroupcommodityquotation.event.EsmPri601502Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601502Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601502Event)request.getAttribute("Event");
