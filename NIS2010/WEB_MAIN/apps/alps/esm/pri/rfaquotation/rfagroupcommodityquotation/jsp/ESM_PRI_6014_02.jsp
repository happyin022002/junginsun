...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaquotation.rfagroupcommodityquotation.event.EsmPri601402Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601402Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601402Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Quotation Commodity Group Creation</title>
