...
<%@ page import="com.hanjin.apps.alps.esm.pri.specialcargoquotation.scqawkward.event.EsmPri8003Event"%>
...
<%
	EsmPri8003Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri8003Event)request.getAttribute("Event");
...
<body class="popup_bg" onLoad="setupPage();"  onBeforeUnload="check_temporary_data_exists(2);" >
<form name="form">
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Awkward Cargo Rate Application</td></tr>
      </table>
      <!-- : ( Title ) (E) -->

<% } else { %>

<body onLoad="setupPage();" onBeforeUnload="check_temporary_data_exists(2);">
<form name="form">
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
				...
				<td width="66"><script language="javascript">ComComboObject('prop_srep_cd', 2, 61, 1, 0);</script></td>
      ...
      <table class="search">
        <tr>
          <td class="bg" valign="top">
              ...
              <tr class="h23">
                <td width="30">POR</td>
                <td width="80"><input type="text" style="width:50;" class="input" value="" maxlength="5" dataformat="uppernum" name="por_cd">
                ...
                <td width="30">DEL</td>
                <td width="80"><input type="text" style="width:50;" class="input" value="" maxlength="5" dataformat="uppernum" name="del_cd">
				...
				<td width="75"><script language="javascript">ComComboObject('svc_scp_cd_combo', 2, 70, 1, 1);</script></td>
              </tr>
            </table>

			<table class="search" border="0" style="width:979;">
              <tr class="h23">
                <td width="96">Customer</td>
                <td width="108"><input type="text" style="width:25;" class="input1" value="" maxlength="2" dataformat="engup" name="cust_cnt_cd" readonly>
                                <input type="text" style="width:51;" class="input1" value="" maxlength="6" dataformat="int" name="cust_seq" readonly>
                ...
                <td width="45"><script language="javascript">ComComboObject('rcv_term_cd', 2, 40, 1, 1, 0, false);</script></td>
                <td width="45"><script language="javascript">ComComboObject('de_term_cd', 2, 40, 1, 1, 0, false);</script></td>
                <td width="61"></td>
			...
			<table class="search" border="0" style="width:979;">
              <tr class="h23">
                <td width="96">Act. Customer</td>
                <td width="108"><input type="text" style="width:25;" class="input1" value="" maxlength="2" dataformat="engup" name="act_cust_cnt_cd" readonly>
                                <input type="text" style="width:51;" class="input1" value="" maxlength="6" dataformat="int" name="act_cust_seq" readonly>
                                <img class="cursor" src="img/btns_search.gif" name="btn_customer2" width="19" height="20" border="0" align="absmiddle"></td>
                <td width="325"><input type="text" style="width:230;" class="input1" value="" maxlength="200" name="act_cust_nm" ></td>
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                <td width="125">Proposal Duration</td>
                <td width="225"><input type="text" style="width:75;ime-mode:disabled;" class="input1" value="<%=pDate1%>" maxlength="10" dataformat="ymd" name="p_date1">&nbsp;~
                    <input type="text" style="width:75;ime-mode:disabled;" class="input1" value="<%=pDate2%>" maxlength="10" dataformat="ymd" name="p_date2">
                ...
                <td width="225"><input type="text" style="width:75;ime-mode:disabled;" class="input2" value="<%=aDate1%>" maxlength="10" dataformat="ymd" name="a_date1">&nbsp;~
                    <input type="text" style="width:75;ime-mode:disabled;" class="input2" value="<%=aDate2%>" maxlength="10" dataformat="ymd" name="a_date2">
                ...
                <td width="100"><input type="text" style="width:75;ime-mode:disabled;" class="input2" name="first_cre_usr_nm" readonly></td>
      ...
      <table class="height_8"><tr><td colspan="8"></td></tr></table>
        ...
        <table class="search" border="0">
          <tr>
            ...
            <td width="*"><script language="javascript">ComComboObject('meas_sys_cd', 1, 130, 1, 1, 0, false);</script></td>           
          </tr>
        </table>
        <!-- Grid (S) -->
            ...
            <td>
                  ...
                  <table border="0" style="width:100%; background-color:white;" class="grid2"> 
                    <tr>
                      ...
                      <td width="%"><textarea name="rmk_req" style="width:100%;height:57"></textarea></td>
                    </tr>
                    <tr>
                      <td width="15%" class="tr2_head"> Appr.</td>
                      <td width="%"><textarea name="rmk_appr" readonly class="textarea2" style="width:100%;height:57"></textarea></td>
                    </tr>
                  </table>
            </td>
          </tr>
