...
<%@ page import="com.hanjin.apps.alps.esm.pri.specialcargoquotation.scqlist.event.EsmPri8105Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	EsmPri8105Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri8105Event) request.getAttribute("Event");
			...
			<tr>
				...
				<table class="search" border="0" style="width: 600;">
					<tr class="h23">
						...
						<td width="">
							<input type="text" name="cust_cnt_cd" value="<%=custCntCd%>" dataformat="eng" maxlength="2" minlength="2" style="width: 30; ime-mode:disabled" class="input" required>&nbsp;<input type="text" name="cust_seq"  value="<%=custSeq%>" dataformat="int" maxlength="6" minlength="3" style="width: 50; ime-mode:disabled" class="input"></td>
					</tr>
					<tr class="h23">
