...
<%@ page import="com.hanjin.apps.alps.esm.pri.specialcargoquotation.scqlist.event.EsmPri8002Event"%>
...
<%
	EsmPri8002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri8002Event)request.getAttribute("Event");
...
<html>
<head>
<title>Awkward & Break Bulk Cargo Quotation List</title>
        ...
        <tr>
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                <td width="100" align="right">Approval Office&nbsp;</td>
                <td width="120"><script language="javascript">ComComboObject('apro_ofc_cd', 2, 100, 0, 0);</script>
                				<!-- input type="text" maxlength="6" onKeyPress="ComKeyOnlyAlphabet('upper')" name="apro_ofc_cd" style="width:90;text-align:center;" class="input" value="<%=strUsr_office_cd %>" required >    
                	            <img class="cursor" src="img/btns_search.gif" name="btn_ofc_hierarchy" width="19" height="20" border="0" align="absmiddle" -->
                	            </td>
                <td width="440"></td> 
      ...
      <table class="search">
        <tr>
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;">
            <!-- 
                <td width="90" align="left" colspan="2">Request No.</td>
                <td width="130" align="right" colspan="4"><input type="text" style="width:120;text-align:center;" class="input" value="" maxlength="15" onKeyPress="ComKeyOnlyAlphabet('uppernum')" name="scq_rqst_no">
                <td width="30" align="left" >&nbsp;</td>
                <td width="60" align="left" >Type&nbsp;</td>
                <td width="130" align="right" colspan="4"><select style="width:120;" class="input" name="tp_cd" tabindex="1">                
                                <option value=""></option>
                                <option value="" selected>ALL</option>
                                <option value="AK">Awkward</option>
                                <option value="BB">Break Bulk </option>
                                </select></td>    
                <td width="75" align="right">Customer&nbsp;</td>
                <td width="120"><input type="text" style="width:26;text-align:center;" class="input" value="" maxlength="2" onKeyPress="ComKeyOnlyAlphabet('upper')" name="cust_cnt_cd">
                                <input type="text" style="width:60;text-align:center;" class="input" value="" maxlength="6" onKeyPress="ComKeyOnlyNumber(this)" name="cust_seq">
                                <img class="cursor" src="img/btns_search.gif" name="btn_customer" width="19" height="20" border="0" align="absmiddle"></td>
                
                <td width="80" align="right">Commodity&nbsp;</td>
                <td width="120"><input type="text" style="width:90;text-align:center;" class="input" value="" maxlength="6" onKeyPress="ComKeyOnlyNumber(this)" name="cmdt_cd">
                				<img class="cursor" src="img/btns_search.gif" name="btn_cmdt_cd" width="19" height="20" border="0" align="absmiddle"></td>
                <td width="80" align="right">SVC Scope&nbsp;</td>
                <td width="70"><script language="javascript">ComComboObject('svc_scp_cd', 2, 68, 1, 0);</script></td>
              ...
              <tr class="h23">
                ...
                <td width="75" align="right">RQST OFC.&nbsp;</td>
                <td width="120"><input type="text" style="width:90;text-align:center;" class="input" value="" maxlength="6" onKeyPress="ComKeyOnlyAlphabet('upper')" name="rqst_ofc_cd">
                				<img class="cursor" src="img/btns_search.gif" name="btn_rqst_cd" width="19" height="20" border="0" align="absmiddle"></td> 				 
