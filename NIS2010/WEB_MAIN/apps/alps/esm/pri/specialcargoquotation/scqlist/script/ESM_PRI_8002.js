                ...
                case "btn_open":
					if (sheetObj.CellValue(sheetObj.SelectRow, 'tp_cd') == "AK") {
	                	if (validateForm(sheetObj, formObj)) {
	                    	var sUrl = "/hanjin/ESM_PRI_8004.do?";
			                    sUrl += "pop_mode=Y";
	                	...
	                	if (validateForm(sheetObj, formObj)) {
	                    	var sUrl = "/hanjin/ESM_PRI_8006.do?";
			                    sUrl += "pop_mode=Y";
		                        sUrl += "&p_rqstno="+sheetObj.CellValue(sheetObj.SelectRow, 'scq_rqst_no');
		                        sUrl += "&p_verno="+sheetObj.CellValue(sheetObj.SelectRow, 'scq_ver_no');
        ...
        switch(sheetNo) {
             ...
             case 2:      // awkward detail sheet
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++,    dtData,    140,    daCenter,    true,     "cmdt_nm",           false,    "",    dfNone,    0,    true,    true);
                    ...
                    InitDataProperty(0, cnt++,    dtData,    50,     daCenter,    false,    "apro_void_rt_amt",  false,    "",    dfNone,    0,    true,    true);
...
//    		formObj.rqst_srep_cd.InsertItem(0,'ALL','');
     	...
     	case SEARCH02:
			...
			sParam+="&" + FormQueryString(formObj);
     		...
     		var sXml = sheetObjects[1].GetSearchXml("ESM_PRI_8002GS.do", sParam);
...
//     		}
     	...
     	case IBSEARCH:      //조회
     		formObj.f_cmd.value = SEARCH01;
			var sXml = sheetObjects[0].GetSearchXml("ESM_PRI_8002GS.do", FormQueryString(formObj));
      ...
      * apro_ofc_cd 따른 apro_ofc_cd 콤보를 조회한다.<br>
      * <br><b>Example :</b>
      * <pre>
      *     searchSrepCd()
      * </pre>
     ...
     function searchSrepCd(type) {
     	...
     	if(ComIsEmpty(document.form.apro_ofc_cd)) {
     	...
     	if( type != "1"){
      		if(ComIsEmpty(document.form.apro_ofc_cd)) {
     			document.form.rqst_srep_cd.RemoveAll();
      			...
      			document.form.apro_ofc_cd.value =  document.form.apro_ofc_cd.value.toUpperCase();
