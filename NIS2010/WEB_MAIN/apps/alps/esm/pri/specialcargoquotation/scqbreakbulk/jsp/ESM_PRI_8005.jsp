...
<%@ page import="com.hanjin.apps.alps.esm.pri.specialcargoquotation.scqbreakbulk.event.EsmPri8005Event"%>
...
<%
  EsmPri8005Event  event = null;          //PDTO(Data Transfer Object including Parameters)
  ...
  try {
    ...
    event = (EsmPri8005Event)request.getAttribute("Event");
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Break Bulk Cargo Rate Application</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
...
<input type="hidden" name="curr_cd_pol_exrate">
<input type="hidden" name="curr_cd_pod_exrate">
<input type="hidden" name="curr_cd_ts_exrate">
              ...
              <% } %>
                ...
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      <td class="btn1_left"></td>
                      <td class="btn1" name="btn_countoffer">Count-Offer</td>
                      <td class="btn1_right"></td>
                    </tr>
                  </table>
                </td>
          ...
          <td class="bg">
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
				...
				<td width="66"><script language="javascript">ComComboObject('cmb_rqst_srep_cd', 3, 61, 1, 0);</script></td>
                <td width="100"><input type="text" style="width: 83;" name="rqst_srep_nm" readonly class="input2"></td>
				<td width="90">Approval OFC.</td>
                <td width="108"><script language="javascript">ComComboObject('apro_ofc_cd', 2, 100, 0, 1);</script>
                                <!--input type="text" style="width: 72;" name="apro_ofc_cd" dataformat="engup" class="input1" maxlength="6" required--> 
                                </td>
                <!--td width="30"><img class="cursor" src="img/btns_search.gif" name="btn_ofc_hierarchy" width="19" height="20" border="0" align="absmiddle"></td -->
                <td width="80" align="right">Request No.</td>
          ...
          <td class="bg" valign="top">
            <table class="search" border="0" style="width:979;" id="mainTable">
              <tr class="h23">
                ...
                <td width="70"><script language="javascript">ComComboObject('cmb_svc_scp_cd', 2, 70, 1, 1, 0, false);</script></td>
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width="29"></td>
                <td width="40">ETA 
                <td width="128"><input type="text" style="width:120;" class="input" value="" dataformat="int" maxlength="12" name="vps_eta_dt">
              </tr>
            </table>
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width="45"><script language="javascript">ComComboObject('cmb_rcv_term_cd', 2, 40, 1, 1, 0, false);</script></td>
                <td width="45"><script language="javascript">ComComboObject('cmb_de_term_cd', 2, 40, 1, 1, 0, false);</script></td>
                <td width="119"></td>
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width="108"><input type="text" style="width:25;" class="input1" value="" maxlength="2" dataformat="engup" name="act_cust_cnt_cd">
                                <input type="text" style="width:50;" class="input1" value="" maxlength="6" dataformat="int" name="act_cust_seq">
                                <img class="cursor" src="img/btns_search.gif" name="btn_customer2" width="19" height="20" border="0" align="absmiddle"></td>
                <td width="240"><input type="text" style="width:230;" class="input1" value="" maxlength="200" name="act_cust_nm" ></td>
                <td width="21"></td>
                <td width="132">Bidding Flag</td>
                <td width="90"><script language="javascript">ComComboObject('scq_bid_flg', 1, 80, 1, 0, 0, false);</script></td>
                <!--td width="119">Meas. Type</td>
                <td width="168"><script language="javascript">ComComboObject('meas_sys_cd', 1, 130, 1, 1, 0, false);</script></td-->           
                <td width="119">&nbsp;</td>
                <td width="168">&nbsp;</td>           
              </tr>
            </table>
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width="205"><input type="text" style="width:80;ime-mode:disabled;" class="input1" value="<%=pDate1%>" maxlength="10" dataformat="ymd" name="p_date1">&nbsp;~
                ...
                <td width="205"><input type="text" style="width:80;ime-mode:disabled;" class="input2" value="<%=aDate1%>" maxlength="10" dataformat="ymd" name="a_date1">&nbsp;~
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width="205"><input type="text" style="width:80;ime-mode:disabled;" class="input" name="prop_rt_amt" dataformat="int"></td>
                <td width="135"></td>
                <td width="130">Approval Rate (USD)</td>
                <td width="200"><input type="text" style="width:80;ime-mode:disabled;" class="input2" name="apro_rt_amt" dataformat="int" readonly></td>    
                <td width="24"></td>
            ...
            <table class="search" border="0" style="width:979;">
              <tr>
                <td width="490">
                  <table class="search" border="0">
                    ...
                    <td width="130"><script language="javascript">ComComboObject('meas_sys_cd', 1, 130, 1, 1, 0, false);</script></td>           
                  </table>
                </td>
                <td width="10"></td>
                <td width="199">
              ...
              <tr>
                <td width="490"><script language="javascript">ComSheetObject('sheet2');</script></td>
                <td width="10"></td>
                <td width="199"><script language="javascript">ComSheetObject('sheet3');</script></td>
                <td width="10"></td>
                <td width="260" rowspan="2">
                  <table border="0" style="width:100%; background-color:white;" class="grid2"> 
                    <tr>
                      <td width="15%" class="tr2_head"> Req.</td>
                      <td width="%"> <textarea name="prop_rmk" class="textarea" style="width:100%;height:69"></textarea></td>
                    </tr>
                    <tr>
                      <td width="15%" class="tr2_head"> Appr.</td>
                      <td width="%"> <textarea name="apro_rmk" class="textarea2" style="width:100%;height:69"></textarea></td>
                    </tr>
                  </table>
                </td>
              </tr>
                  ...
                  <table width="100%" class="button">
                    <tr><td class="btn2_bg">
                      <table border="0" cellpadding="0" cellspacing="0"><tr>
                        ...
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_rowadd_1">Row&nbsp;Add</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_rowdel_1">Row&nbsp;Del</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_copy_1">Copy</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td></tr>
                      </table>
                  ...
                  <table width="100%" class="button">
                    <tr><td class="btn2_bg">
                      <table border="0" cellpadding="0" cellspacing="0"><tr>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_rowadd_2">RowAdd</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_rowdel_2">RowDel</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_save_2">Save</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td></tr>
                      </table>
              ...
              <tr>
                <td width="485">
                  <table class="search" border="0">
				    ...
				    <td width="" style="padding-left:2;"><script language="javascript">ComComboObject('curr_cd_pol', 2, 50, 0, 1);</script></td>
                ...
                <td width="485">
                  <table class="search" border="0">
                    ...
                    <td class="title_s" width="80" > Local Curr.</td>
				    <td width="" style="padding-left:2;"><script language="javascript">ComComboObject('curr_cd_pod', 2, 50, 0, 1);</script></td>
                ...
                <td width="319" style="display:none">
                  <table class="search" border="0">
                    ...
                    <td class="title_s" width="30" > Curr.</td>
				    <td width="" style="padding-left:2;"><script language="javascript">ComComboObject('curr_cd_ts', 2, 50, 0, 1);</script></td>
                  ...
                  <table width="100%" class="button">
                    <tr><td class="btn2_bg">
                      <table border="0" cellpadding="0" cellspacing="0"><tr>
                        ...
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_save_pol">Save</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_confirm_pol">Confirm</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td></tr>
                      </table>
                  ...
                  <table width="100%" class="button">
                    <tr><td class="btn2_bg">
                      <table border="0" cellpadding="0" cellspacing="0"><tr>
                        <td style="display:none" ><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_save_pod">Save</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_confirm_pod">Confirm</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td></tr>
                      </table>
                  ...
                  <table width="100%" class="button">
                    <tr><td class="btn2_bg">
                      <table border="0" cellpadding="0" cellspacing="0"><tr>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_save_ts">Save</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2" name="btn_confirm_ts">Confirm</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td></tr>
                      </table>
...
<% if (popMode.equals("Y")) { %>
      ...
      <table width="100%" class="sbutton">
        <tr>
          <td height="71" class="popup"><table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:0;,padding-bottom:0;">
              <tr>
