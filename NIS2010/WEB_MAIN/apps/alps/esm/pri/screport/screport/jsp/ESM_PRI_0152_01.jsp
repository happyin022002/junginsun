...
<%@ page import="com.hanjin.apps.alps.esm.pri.screport.screport.event.EsmPri015201Event"%>
...
<%
	...
	try {
		...
		event = (EsmPri015201Event)request.getAttribute("Event");
		...
		mofFileLaneCdList = PRIUtil.getValueObject2StringArray((List<CodeInfo>)eventResponse.getCustomData("mofFileLaneCdList"), true ,"|","\t","getCode","getName");
...
<script language="javascript">
    ...
    var mofFileLaneCdValue = " |<%=mofFileLaneCdList[0]%>";
    var mofFileLaneCdText = " |<%=mofFileLaneCdList[1]%>";
