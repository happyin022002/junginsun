...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<!--Page Title, Historical (E)-->
			...
			<tr class="h23" style="height:20">
				<td width="40">Type</td>
				<td class="stm"><input type="radio" class="trans" name="rdoSummaryType" value="S" checked>Summary&nbsp;&nbsp;<input type="radio" class="trans" name="rdoSummaryType" value="D">Details by S/C</td>
				</tr>
