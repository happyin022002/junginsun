...
*@FileName : ESM_PRI_0152_04.js
*@FileTitle : Korea MOF Filing (Base Table) - Currency Type
*Open Issues :
*Change history :
...
//        axon_event.addListener ('keydown', 'ComKeyEnter', 'form');
    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        case "sheet1":      
			...
			InitDataProperty(0,		cnt++,	dtData,	80,		daCenter,		false,	"mof_id",		true,		"",			dfEngUpKey,			0,			true,		true, 	3 );
			InitDataProperty(0,		cnt++,	dtData,	80,		daCenter,		false,	"hjs_id",		true,		"",			dfEngUpKey,			0,			true,		true,	3 );
			InitDataProperty(0,		cnt++,	dtData,			100,		daCenter,		false,	"mapg_rmk",		false,		"",			dfNone,			0,			true,		true,   20 );
