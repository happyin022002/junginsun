...
<%@ page import="com.hanjin.apps.alps.esm.pri.screport.screport.event.EsmPri0150Event"%>
...
<%
	EsmPri0150Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0150Event)request.getAttribute("Event");
...
<html>
<head>
<title>Korea MOF Filing (by Upload)</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:0;,padding-bottom:2;"> 
	    ...
	    <tr>
			...
			<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				<tr><td class="btn1_left"></td>
				<td class="btn1" name="btn_multiDown">Multi-Download</td>
				<td class="btn1_right"></td>
				</tr>
			</table></td>
		</tr>
	...
	<table class="search" border="0"> 
		...
		<!--  biz_1  (S) -->
			...
			<table class="search_sm" border="0" > 
				...
				<td width="120"><script language="javascript">ComComboObject('f_ctrt_tp', 2, 111, 0, 1);</script></td>
				
				<td width="100">APVL OFC</td>
				<td width="100"><nobr>
