...
<%@ page import="com.hanjin.apps.alps.esm.pri.screport.screport.event.EsmPri0130Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri0130Event  event = null;					
	...
	try {
		...
		event = (EsmPri0130Event)request.getAttribute("Event");
...
<html>
<head>
<title>Charge Summary Report</title>
