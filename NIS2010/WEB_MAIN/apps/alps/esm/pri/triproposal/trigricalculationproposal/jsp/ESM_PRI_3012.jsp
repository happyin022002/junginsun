...
<%@ page import="com.hanjin.apps.alps.esm.pri.triproposal.trigricalculationproposal.event.EsmPri3012Event"%>
...
<%
    ...
    String strUsr_id = "";
    String strUsr_nm = "";
    Logger log = Logger.getLogger("com.hanjin.apps.TRIProposal.TRIGRICalculationProposal");
...
<html>
<head>
<title>TRI GRI Calculation - Route Point Select</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TRI GRI Calculation - Route Point Select</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
