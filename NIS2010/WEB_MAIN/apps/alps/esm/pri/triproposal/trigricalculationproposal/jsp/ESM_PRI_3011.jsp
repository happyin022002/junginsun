...
<%@ page import="com.hanjin.apps.alps.esm.pri.triproposal.trigricalculationproposal.event.EsmPri3011Event"%>
...
<html>
<head>
<title>TRI GRI Calculation - Commodity Select</title>
...
<table width="500" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="100%" border="0">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TRI GRI Calculation - Commodity Select</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
