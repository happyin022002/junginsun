...
<%@ page import="com.hanjin.apps.alps.esm.pri.triproposal.triproposal.event.EsmPri6085Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6085Event  event = null;					//PDTO(Data Transfer Object including Parameters)
...
<input type="hidden" name="trf_pfx_cd" value="<%=trf_pfx_cd%>">
