...
<%@ page import="com.hanjin.apps.alps.esm.pri.triproposal.triproposal.event.EsmPri3016Event"%>
...
<html>
<head>
<title>TRI Creation & Amendment - Route Point</title>
...
<!-- 개발자 작업 -->
<input type="hidden" name="tri_prop_no" value="<%=request.getParameter("tri_prop_no")%>">
...
<input type="hidden" name="tri_no" value="<%=request.getParameter("tri_no")%>">
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;TRI Creation & Amendment - Route Point </td></tr>
        </table>
        <!-- : ( Title ) (E) -->
       ...
       <tr><td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width="410" class="stm" style="font-size:12;">
