...
<%@ page import="com.hanjin.apps.alps.esm.pri.triproposal.triproposal.event.EsmPri3002Event"%>
...
<html>
<head>
<title>TRI Creation &amp; Amendment - Note Creation</title>
...
<input type="hidden" name="is_editable" value="<%=isEditable%>">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; TRI Creation & Amendment - Note Creation</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0">
					<tr class="h23">
						<td><textarea name="note_ctnt" style="width:100%; height:70;word-break:break-all;"><%=noteCtnt%></textarea></td>
					</tr>
				</table>
