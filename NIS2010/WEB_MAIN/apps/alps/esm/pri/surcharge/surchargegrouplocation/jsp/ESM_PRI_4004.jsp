...
<%@ page import="com.hanjin.apps.alps.esm.pri.surcharge.surchargegrouplocation.event.EsmPri4004Event"%>
<%@ page import="com.hanjin.syscommon.common.table.PriScgGrpLocVO"%>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Surcharge Location Group Creation</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
<%
    } else {
