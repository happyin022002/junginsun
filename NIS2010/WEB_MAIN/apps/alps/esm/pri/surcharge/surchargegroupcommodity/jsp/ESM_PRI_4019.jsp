...
<%@ page import="com.hanjin.apps.alps.esm.pri.surcharge.surchargegroupcommodity.event.EsmPri4019Event"%>
...
<html>
<head>
<title>Surcharge Commodity Group Inquiry</title>
    ...
    <!--biz page (S)-->
        ...
        <tr><td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width=""><script language="javascript">ComComboObject('svc_scp_cd', 2, 50, 0, 1, 0, false);</script>
