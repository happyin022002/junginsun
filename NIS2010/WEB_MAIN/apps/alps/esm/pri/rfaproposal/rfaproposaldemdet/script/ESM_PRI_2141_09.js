...
/**
 * @extends
 * @class ESM_PRI_2141_09 : ESM_PRI_2141_09 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_PRI_2141_09() {
    ...
    switch(sheetID) {
        case "sheet1":
            with (sheetObj) {
				...
				InitDataProperty(0, cnt++, dtHidden, 	   70,  daLeft,   true, "prop_no",			  true,  "", dfNone, 	0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 	   70,  daLeft,   true, "amdt_seq", 		  true,  "", dfNone, 	0, false, false);
				InitDataProperty(0, cnt++, dtHidden,	   150, daCenter, true, "n1st_cmnc_amdt_seq", true,  "", dfNone,	0, false, false);
				InitDataProperty(0, cnt++, dtData,		   200, daCenter, true, "dmdt_ft_tp_cd",	  false, "", dfNone,	0, false, false);
				InitDataProperty(0, cnt++, dtData,		   140, daCenter, true, "eff_dt",			  false, "", dfDateYmd,	0, false, false);
				InitDataProperty(0, cnt++, dtData,		   140, daCenter, true, "exp_dt",			  false, "", dfDateYmd,	0, false, false);
				InitDataProperty(0, cnt++, dtData,		   110, daCenter, true, "src_info_nm",		  false, "", dfNone,	0, false, false);
				InitDataProperty(0, cnt++, dtData,		   110, daCenter, true, "prc_prog_sts_nm",	  false, "", dfNone,	0, false, false);                
				InitDataProperty(0, cnt++, dtData,		   140, daLeft, true, "acpt_usr_nm",	      false, "", dfNone,	0, false, true);
                InitDataProperty(0, cnt++, dtData,		   90,  daCenter, true, "acpt_dt",		      false, "", dfDateYmd,	0, false, true);
