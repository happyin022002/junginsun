...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfatransportationadditionalchargeproposal.event.EsmPri2051Event"%>
...
<%
	EsmPri2051Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri2051Event)request.getAttribute("Event");
