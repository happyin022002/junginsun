<%@page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfatransportationadditionalchargeproposal.event.EsmPri200312Event"%>
<%  
/*=========================================================
 *Copyright(c) 2012 CyberLogitec
 *@FileName : ESM_PRI_2103_12.jsp
...
<%
	EsmPri200312Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri200312Event)request.getAttribute("Event");
...
<table class="search">
	...
	<!--  biz_2  (S) -->
	<table border="0" style="width:185;" class="search_sm2">
				<tr class="h23">
					<td width="50">Type</td>
