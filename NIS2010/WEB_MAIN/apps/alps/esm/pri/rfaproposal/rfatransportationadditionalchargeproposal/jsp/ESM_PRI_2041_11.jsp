...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfatransportationadditionalchargeproposal.event.EsmPri204111Event"%>
...
<%
	EsmPri204111Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri204111Event)request.getAttribute("Event");
