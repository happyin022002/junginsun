 ...
 *@FileName : ESM_PRI_2041_12.js
 *@FileTitle : Amendment History - Arbitrary (For Add On Tariff)
 *Open Issues :
 *Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2041_12 : ESM_PRI_2041_12 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2041_12() {
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
	     	case IBSEARCH:	//조회
	     		...
	     		var sXml = sheetObj.getSearchXml("ESM_PRI_2041_12GS.do", FormQueryString(formObj));
			...
			case IBSEARCH_ASYNC02: // font type 조회
				...
				var sXml = sheetObj.getSaveXml("ESM_PRI_2041_12GS.do", FormQueryString(formObj));
