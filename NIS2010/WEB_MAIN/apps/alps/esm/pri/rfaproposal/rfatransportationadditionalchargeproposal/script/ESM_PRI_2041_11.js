...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2041_11 : ESM_PRI_2041_11 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2041_11() {
    	...
    	switch (sheetID) {
    		...
    		case "sheet1":
    			...
    			with (sheetObj) {
    				...
    				InitDataProperty(0, cnt++, dtPopupEdit,  	57,  daCenter,  false,  "rout_pnt_loc_def_cd",  true,	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,    		130, daLeft,	false,  "rout_pnt_loc_def_nm",  false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,      	70,  daCenter,  false,  "prc_trsp_mod_cd",    	false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,      	55,  daCenter,  false,  "rcv_de_term_cd",       true,  	"", dfNone,			0);
    				InitDataProperty(0, cnt++, dtData, 			55, daRight,	true, 	"min_cgo_wgt", 			false, 	"", dfNullFloat,	2);
					InitDataProperty(0, cnt++, dtData, 			55, daRight, 	true, 	"max_cgo_wgt", 			false, 	"", dfNullFloat,	2);
    				InitDataProperty(0, cnt++, dtPopupEdit,   	57,  daCenter,  false,  "bse_port_def_cd",     	true,  	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo, 		70, daCenter, 	false, 	"cust_cnt_cd", 			false, 	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtHidden, 		0, 	daCenter,  	true,	"cust_nm");
    				InitDataProperty(0, cnt++, dtCombo,  		38,	 daCenter, 	false,  "rat_ut_cd",      		true,  	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,     	50,  daCenter, 	false,  "prc_cgo_tp_cd",     	true,  	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,      	43,  daCenter,  false,  "curr_cd",     			true,  	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,      	68,	 daRight,   false,  "prop_frt_rt_amt",     	true,  	"", dfNullFloat,	2);
    				InitDataProperty(0, cnt++, dtData,      	68,  daRight,   false,  "coffr_frt_rt_amt",    	false,  "", dfNullFloat, 	2);
    				InitDataProperty(0, cnt++, dtData,      	68,  daRight,   false,  "fnl_frt_rt_amt",     	false,  "", dfNullFloat, 	2);
    				...
    				InitDataProperty(0, cnt++, dtHidden, 		0,   daCenter,  false,	"org_dest_tp_cd");
    				...
    				InitDataProperty(0, cnt++, dtHidden, 		0,   daCenter,  false,	"acpt_usr_id");
...
//				sheetObj.DoSearch("ESM_PRI_2041_06GS.do", FormQueryString(formObj));
	     		var sXml = sheetObj.getSearchXml("ESM_PRI_2041_11GS.do", FormQueryString(formObj));
				showSheetObj(sXml);
				ComOpenWait(false);
	     		break;
			...
			case IBSEARCH_ASYNC02: // font type 조회
				...
				var sXml = sheetObj.getSaveXml("ESM_PRI_2041_11GS.do", FormQueryString(formObj));
