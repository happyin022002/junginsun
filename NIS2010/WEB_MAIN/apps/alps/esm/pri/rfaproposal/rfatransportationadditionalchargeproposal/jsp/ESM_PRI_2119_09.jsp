...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfatransportationadditionalchargeproposal.event.EsmPri201909Event"%>
...
<%
	EsmPri201909Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri201909Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Proposal & Amendment Inquiry - Arbitrary (For AEE/AEW)</title>
      	...
      	<tr><td class="btn1_bg">
		    ...
		    <tr>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn1" name="btn_retrieve">Retrieve[guideline]</td>
