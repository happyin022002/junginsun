...
*@FileName : ESM_PRI_2141_12.jsp
*@FileTitle : Spot Guide RFA Amendment History - Arbitrary
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfatransportationadditionalchargeproposal.event.EsmPri204112Event"%>
...
<%
	EsmPri204112Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri204112Event)request.getAttribute("Event");
