...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2119_01 : ESM_PRI_2119_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2119_01() {
         	...
         	case "sheet3":
         		with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     InitDataProperty(0, cnt++ , dtData,  	    	48,   daCenter,  true,	"curr_cd",      			false,	"",	dfNone, 			0,     false,       false);
                     ...
                     InitDataProperty(0, cnt++ , dtCombo,			150,  daCenter,  true,	"bkg_esvc_tp_cd",			false,	"",	dfNone, 			0,     false,       false);
