 ...
 *@FileName : ESM_PRI_2037.jsp
 *@FileTitle : RFA Proposal Creation - Rate For Add-On Tariff[GRI Calculation]
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfagricalculationproposal.event.EsmPri2037Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
    EsmPri2037Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri2037Event) request.getAttribute("Event");
...
<html>
<head>
<title>RFA Proposal Creation - Rate [GRI Calculation]</title>
...
<input type="hidden" name="gen_spcl_rt_tp_cd" value="<%=JSPUtil.getParameter(request, "fic_rt_tp_cd") %>">
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Creation - Rate [GRI Calculation]</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
