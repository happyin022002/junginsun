...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfagricalculationproposal.event.EsmPri2035Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
    EsmPri2035Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri2035Event) request.getAttribute("Event");
...
<div id="hiddenSheetLayer" style="display: inline">
