 ...
 *@FileName : ESM_PRI_2233.jsp
 *@FileTitle : General Update Creation
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfagricalculationproposal.event.EsmPri2233Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
    EsmPri2233Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri2233Event) request.getAttribute("Event");
...
<html>
<head>
<title>General Update Creation</title>
...
<input type="hidden" name="fic_rt_tp_cd" value="<%=JSPUtil.getParameter(request, "fic_rt_tp_cd", "G") %>">
<input type="hidden" name="gen_spcl_rt_tp_cd" value="<%=JSPUtil.getParameter(request, "fic_rt_tp_cd", "G") %>">

<input type="hidden" name="gri_data_save_flg"><!--변경후-->
<input type="hidden" name="actcust_desc"><!--변경후-->
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;General Update Creation</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
                ...
                <table width="100%" class="button"> 
                    <tr><td class="btn2_bg">
                        <table border="0" cellpadding="0" cellspacing="0"><tr>
                            ...
                            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                            <tr><td class="btn2_left"></td>
                            <td class="btn2" name="btn_delete1" suppressWait="Y">Delete</td>
                            <td class="btn2_right"></td>
                            </tr>
                            </table></td>
                        </tr></table>
                ...
                <table width="100%" class="button"> 
                    <tr><td class="btn2_bg">
                        <table border="0" cellpadding="0" cellspacing="0"><tr>
                            ...
                            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                            <tr><td class="btn2_left"></td>
                            <td class="btn2" name="btn_delete2" suppressWait="Y">Delete</td>
                            <td class="btn2_right"></td>
                            </tr>
                            </table></td>
                            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
...
<tr><td height="71" class="popup">
        ...
        <tr><td class="btn3_bg">
           ...
           <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn1_left"></td>
                    <td class="btn1" name="btn_apply_cancel">Apply Cancel</td>
                    <td class="btn1_right"></td></tr></table></td>                 
