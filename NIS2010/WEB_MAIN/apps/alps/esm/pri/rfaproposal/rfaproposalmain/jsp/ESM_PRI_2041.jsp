		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="174"><input type="text" style="width:110;text-align:center;" class="input1" name="rfa_no" dataformat="engup" maxlength="11" onKeyDown="ComKeyEnter('NextFocus')"></td>
			    ...
			    <tr class="h23">
					...
					<td width="385" style="padding-left:2px;"><script language="javascript">ComComboObject('svc_scp_cd', 2, 50, 0 , 0);</script>
						&nbsp;<input type="text" style="width:320;" class="input2" name="svc_scp_nm" readonly caption="Service Scope Name"></td>
