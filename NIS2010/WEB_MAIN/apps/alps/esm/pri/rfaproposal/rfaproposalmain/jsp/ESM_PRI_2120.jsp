...
<table width="95%" border="0" class="popup" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Spot Guide RFA View</td></tr>
	</table>
	...
	<!-- Hidden sheet for Transaction (E) -->	
				...
				<tr class="h23">
					...
					<!-- spot hidden -->
					<td width="65"></td>
					<td width=""><input type="hidden" style="width:115;text-align:center;" class="input2" name="rfa_ctrt_tp_cd"  dataformat="engup" readonly></td>			
					<!-- spot hidden -->	
					</tr>
				</table>
