...
*@FileName : ESM_PRI_6091.jsp
*@FileTitle : RFA Proposal MVC estimate
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfaproposalmain.event.EsmPri6091Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6091Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6091Event)request.getAttribute("Event");
		...
		frm_tgt_mvc_qty = JSPUtil.getParameter(request,"frm_tgt_mvc_qty");
...
<html>
<head>
<title>RFA Proposal Target MVC estimate</title>
...
<input type="hidden" name="frm_tgt_mvc_qty" value="<%=frm_tgt_mvc_qty %>">
...
<input type="hidden" name="prc_prop_sts_cd"  value = "<%=prc_prop_sts_cd%>">      
    ...
    <tr><td valign="top">
    		...
    		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Target MVC estimate(PRS purpose only)</td>
    		</tr>
    		</table>
    		<!-- : ( Title ) (E) -->
    		...
    		<!-- : ( Search Options ) (S) -->
				...
				<table class="search_sm2" border="0" style="width:460;"> 
							<tr class="h23">
								...
								<td width="90">&nbsp;Target MVC</td>
								<td class="stm"><input type="text" value="<%=frm_tgt_mvc_qty%>" style="width: 80; text-align: right" class="input2" readonly>
    				...
    				<tr class="h23">
    					...
    					<td class="SM">&raquo; Please input estimated target MVC data in order to have more accurate<BR> 
    					 &nbsp;&nbsp;&nbsp;CM/OP data through PRS calculation.<br>
    &raquo; Once you input estimated target MVC on the pop-up screen,<BR> 
    &nbsp;&nbsp;&nbsp;please click [OK] to proceed calculation .<BR>
    &raquo; Please keep in mind that inputted target MVC data is not reflected on RFA.
    </td>
    				</tr>	
    				</table>
