...
*@FileName : ESM_PRI_2141.js
*@FileTitle : Spot Guide RFA Amendment History 
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2141 : ESM_PRI_2141 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2141() {
...
var tabDivCount = 12;
  ...
  */
         ...
         try{
             switch(sAction) {
	  			case IBSEARCH_ASYNC01:      //조회
	  				...
	  				formObj.f_cmd.value = SEARCH11;  //변경 - SEARCH01; //이전
             ...
             case "sheet1":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					var HeadTitle1 = "|Seq.|AMD No.|SVC Scope|Effective Date|Expiry Date|Creation Date|Approve Date|prop_ofc_cd";
                     ...
                     InitDataProperty(0, cnt++, dtData,		    140, daCenter, false, "svc_scp_cd", false, "", dfDateYmd, 0, false, false,	3);
 					 ...
 					 InitDataProperty(0, cnt++, dtHidden,	    150, daCenter, false, "prop_ofc_cd",	false, "", dfNone, 0, false, false);
 	...
 	function initTab(tabObj, tabNo) {
		...
		case 1:
			with (tabObj) {
				var cnt = 0;
				/*
				InsertTab(-1, "Duration", cnt++);
				cnt++;
				//InsertTab(-1, "Affiliate", cnt++);
				cnt++;
				//InsertTab(-1, "Dem/Det", cnt++);
	...
	function getFrameTabId(tabIndex) {
		...
		//SPOT
		//Duration 0 , Rate 3, Location 4, Commodity 5, Special Note 7
		//alert("[tabIndex before]"+tabIndex);
		if(tabIndex == 0){
			tabIndex = 0;		//Duration 
		} else if(tabIndex == 1){
			tabIndex = 3;		//Rate
		} else if(tabIndex == 2){
			tabIndex = 4;		//Location Group
		} else if(tabIndex == 3){
			tabIndex = 5;		//Commodity Group
		} else if(tabIndex == 4){
			tabIndex = 6;		//Arbitrary
		} else if(tabIndex == 5){
			tabIndex = 7;		//Special Note
		} 
		//alert("[tabIndex after]"+tabIndex);
		
		switch (tabIndex) {
			case 0: {	//index:0
				frameId = "t1frame";
				sUrl = "ESM_PRI_2141_01.do";	//Duration 
				divIndex = "tabLayer1";
				break;
			}
			case 1: {
				frameId = "t2frame";
				sUrl = "ESM_PRI_2141_07.do";	//Affiliate Company 	X
				divIndex = "tabLayer2";
				break;
			}
			case 2: {
				frameId = "t3frame";
				sUrl = "ESM_PRI_2141_09.do";	//DEM/DET 	X
				divIndex = "tabLayer3";
				break;
			}
			case 3: {	//index:1 
/*				var index = checkArbiRate();
				if (index == 0) {
					frameId = "t4frame";
					sUrl = "ESM_PRI_2141_05.do";	//Rate
					divIndex = "tabLayer4";
				} else if (index == 1) {
					frameId = "t5frame";
					sUrl = "ESM_PRI_2141_10.do";	//Rate (For AEE/AEW)
					divIndex = "tabLayer5";
				} else if (index == 2) {
					frameId = "t11frame";
					sUrl = "ESM_PRI_2141_13.do";	//Rate (For Add On Tariff)
					divIndex = "tabLayer11";
				}*/
				//SPOT ONLY
				frameId = "t4frame";
			...
			case 4: {	//index:2
				frameId = "t6frame";
				sUrl = "ESM_PRI_2141_04.do";	//Location Group
				divIndex = "tabLayer6";
				break;
			}
			case 5: {	//index:3
				frameId = "t7frame";
				sUrl = "ESM_PRI_2141_03.do";	//Commodity Group
				divIndex = "tabLayer7";
				break;
			}
			case 6: {
...
//				if (index == 0) {
//					frameId = "t8frame";
//					sUrl = "ESM_PRI_2141_06.do";	//Arbitrary 	X
//					divIndex = "tabLayer8";
//				} else if (index == 1) {
//					frameId = "t9frame";
//					sUrl = "ESM_PRI_2141_11.do";	//Arbitrary (For AEE/AEW) 	X
//					divIndex = "tabLayer9";
//				} else if (index == 2) {
//					frameId = "t12frame";
//					sUrl = "ESM_PRI_2141_12.do";	//Arbitrary (For Add On Tariff) 	X
//					divIndex = "tabLayer12";
//				}
				//SPOT ONLY
				frameId = "t12frame";
				sUrl = "ESM_PRI_2141_12.do";	 // Arbitrary
				divIndex = "tabLayer12";
				break;
			}
			case 7: {	//index:4
    ...
    function sheet1_OnSelectCell(sheetObj, OldRow, OldCol, NewRow, NewCol)  {   
    	...
    	try{
    		...
    		if(OldRow != NewRow  ){
        		...
        		// Request Office가 BOMSC일 경우 Arbitrary Tab 추가
                setTabEnable(4, (sheetObj.CellValue(NewRow, "prop_ofc_cd") == 'BOMSC') ? true : false);
    ...
    */ 
	 ...
	 * @param {boolean} 필수  true : 활성  false : 비활성
