...
function processButtonClick() {
    ...
    try {
        ...
        case "btn_proposal":
			...
			var winObj = window.open("alpsMain.screen?parentPgmNo=" + parentPgmNo + src, "ESM_PRI_2003", sFeatures);  
        ...
        case "btn_history":
			...
			var parentPgmNo = pgmNo.substring(0, 8)+'M001';   
 			var src = "&pgmUrl="+ComReplaceStr(pgmUrl,"/","^") + "&pgmNo=" + pgmNo + params;
			var sFeatures = "status=no, width=1024, height=700, resizable=yes, scrollbars=yes";   
			var winObj = window.open("alpsMain.screen?parentPgmNo=" + parentPgmNo + src, "ESM_PRI_2041", sFeatures);  
...
function initSheet(sheetObj, sheetNo) {
    ...
    case "sheet0":
        with (sheetObj) {
           ...
           //전체Edit 허용 여부 [선택, Default false]
			...
			InitDataProperty(0, cnt++ , dtData,  	80,  	daCenter,  false, "prop_no",      		false, "", dfNone,    0, true, true);                
			InitDataProperty(0, cnt++ , dtData,  	240,	daLeft,		 false, "ctrt_pty_nm",  		false, "", dfNone,    0, true, true);
            InitDataProperty(0, cnt++ , dtData,   65,  	daCenter,  false, "cust_tp_nm",   		false, "", dfNone,    0, true, true);
            InitDataProperty(0, cnt++ , dtData,   60,  	daCenter,  false, "rfa_ctrt_tp_cd",   	false, "", dfNone,    0, true, true);
			InitDataProperty(0, cnt++ , dtData,  	55,  	daCenter,  false, "prop_ofc_cd",  	false, "", dfNone,    0, true, true);
			InitDataProperty(0, cnt++ , dtData,  	45,  	daCenter,  false, "prop_srep_cd", 	false, "", dfNone,    0, true, true);
			InitDataProperty(0, cnt++ , dtData,  	65,  	daCenter,  false, "cre_dt",       		false, "", dfDateYmd, 0, true, true);
			InitDataProperty(0, cnt++ , dtData,  	65,  	daCenter,  false, "eff_dt",       		false, "", dfDateYmd, 0, true, true);
			InitDataProperty(0, cnt++ , dtData,  	65,  	daCenter,  false, "exp_dt", 	   		false, "", dfDateYmd, 0, true, true);
    ...
    case "sheet2":
        with (sheetObj) {
            ...
            InitDataProperty(0, cnt++, dtData,   110, daRight,  false, "tgt_mvc_qty", 	   false, "", dfInteger, 0, false, false);
            InitDataProperty(0, cnt++, dtData,    60, daCenter, false, "cntr_lod_ut_cd",   false, "", dfNone,    0, false, false);
...
function getFrameTabId(tabIndex) {
	...
	switch (tabIndex) {
    	case 0: {
    		...
    		if (index == 0) {
    			frameId = "t1frame";
    			sUrl = "ESM_PRI_2019_07.do";
    			divIndex = "tabLayer1";
    		} else if (index == 1) {
    			frameId = "t2frame";
    			sUrl = "ESM_PRI_2019_08.do";
    			divIndex = "tabLayer2";
    		} else if (index == 2) {
    			frameId = "t3frame";
    			sUrl = "ESM_PRI_2019_13.do";
    			divIndex = "tabLayer3";
    		}
    		break;
    	}
    	case 1: {
    		frameId = "t4frame";
    		sUrl = "ESM_PRI_2019_02.do";
    		divIndex = "tabLayer4";
    		break;
    	}
    	case 2: {
    		frameId = "t5frame";
    		sUrl = "ESM_PRI_2019_03.do";
    		divIndex = "tabLayer5";
    		break;
    	}
    	case 3: {
    		...
    		if (index == 0) {
    			frameId = "t6frame";
    			sUrl = "ESM_PRI_2019_04.do";
    			divIndex = "tabLayer6";
    		} else if (index == 1) {
    			frameId = "t7frame";
    			sUrl = "ESM_PRI_2019_09.do";
    			divIndex = "tabLayer7";
    		} else if (index == 2) {
    			frameId = "t8frame";
    			sUrl = "ESM_PRI_2019_12.do";
    			divIndex = "tabLayer8";
    		}
    		break;
    	}
