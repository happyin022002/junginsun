...
<%
	...
	try {
		...
		prcCgoTpCdList = PRIUtil.getValueObject2StringArray((List<?>)eventResponse.getCustomData("prcCgoTpCdList"));	// Dry Only
...
<input type="hidden" name="bkg_rfa_no" value="<%=sRfaNo%>">
<input type="hidden" name="bkg_amdt_seq" value="<%=sAmdtSeq%>">
<input type="hidden" name="org_amdt_seq" value="<%=sAmdtSeq%>">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Master RFA View</td></tr>
	</table>
       	...
       	<tr><td class="bg">
			<!-- biz_1  (S) -->
				...
				<tr class="h23">
					...
					<td width="88"><input type="text" style="width:80;text-align:center;" class="input" name="rfa_no" maxlength="11" dataformat="engup" value="<%=sRfaNo%>" readonly> </td>
					<td width="60">AMD No.</td>
					<td width="48" style="padding-left:2"><input type="text" style="width:35;text-align:center;" class="input2" name="amdt_seq" value="<%=sAmdtSeq%>"  readonly></td>
					<td width="80" style="padding-left:2">Proposal No.</td>
					<td width="85"><input type="text" style="width:80;text-align:center;" class="input" name="prop_no" maxlength="11" dataformat="engup" value="<%=sPropNo%>" readonly></td>
				...
				<tr class="h23">
					...
					<td width="292"><script language="javascript">ComComboObject('req_usr_nm', 1, 215, 0, 1, 0);</script></td>
