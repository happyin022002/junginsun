 ...
 ***************************************************************************************/
    ...
    /**
     * @extends
     * @class ESM_PRI_2007 : ESM_PRI_2007 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2007 () {
        ...
        switch (sheetNo) {
            ...
            case 2: // sheet2 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++, dtHiddenStatus, 30, daCenter, false, "ibflag");
                    InitDataProperty(0, cnt++, dtHidden, 0, daLeft, false, "prop_no");
                    InitDataProperty(0, cnt++, dtHidden, 0, daLeft, false, "amdt_seq");
        ...
        switch (sAction) {
            ...
            case IBSAVE: //저장
                ...
                if (validateForm(sheetObj, formObj, sAction)) {
                    ...
                    var sXml = sheetObj.GetSaveXml("ESM_PRI_2007GS.do", sParam);
            ...
            case IBINSERT: // 입력
                ...
                sheetObj.CellValue(newRow, "prop_no") = formObj.prop_no.value;
                sheetObj.CellValue(newRow, "amdt_seq") = formObj.amdt_seq.value
    ...
    function sheet1_OnTreeChild (sheetObj, CondParam, Row) {
        try {
            ComOpenWait(true);
            sheetObj.DoSearch("ESM_PRI_2007GS.do", CondParam, "pnode_id=" + sheetObj.CellValue(Row, "node_id"), true, Row + 1);
            ComOpenWait(false);
        } catch(e) {
            if( e == "[object Error]") {
                ComShowMessage(OBJECT_ERROR);
