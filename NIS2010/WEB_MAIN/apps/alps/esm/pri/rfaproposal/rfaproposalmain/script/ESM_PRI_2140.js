...
//	 	            	}
					...
					if(ComIsDate(posEffDay) && posEffDay.length == 8){
					   var tmpEffYear = posEffDay.substring(0,4);
			        	var tmpExpYear = posExpDay.substring(0,4);
 ...
 */ 	        
   ...
   function spotDurationCheck(){
	   ...
	   var ctrtEffDt = ComGetUnMaskedValue(sheetObj.CellValue(1,"ctrt_eff_dt"),"ymd");
       var ctrtExpDt = ComGetUnMaskedValue(sheetObj.CellValue(1,"exp_dt"),"ymd");
 ...
 function checkNewDurValidation(){
     ...
     if (posEffDay > expDay && expDay !=""){
     	ComShowCodeMessage("PRI01089");	//msgs['PRI01089'] = 'New Duration Date can not earlier than Possible Effective Date.';
     	return false; 
     }
