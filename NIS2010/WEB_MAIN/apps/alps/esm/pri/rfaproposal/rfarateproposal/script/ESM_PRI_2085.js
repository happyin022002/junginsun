   ...
   /**
	...
	function sheet1_OnSelectCell(sheetObj, OldRow, OldCol, NewRow, NewCol)  {
		...
		if (OldRow != NewRow) {
			...
			ComPriSheetFilter(sheetObjects[1], "note_conv_mapg_id", sheetObjects[0].CellValue(NewRow, "note_conv_mapg_id"));
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        try {
			...
			case IBSEARCH: // parent sheet에서 조회
				...
				sheetObj.SelectRow = sheetObj.LastRow;
