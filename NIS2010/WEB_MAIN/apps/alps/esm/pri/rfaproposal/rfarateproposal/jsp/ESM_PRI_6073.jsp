...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri6073Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6073Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6073Event)request.getAttribute("Event");
