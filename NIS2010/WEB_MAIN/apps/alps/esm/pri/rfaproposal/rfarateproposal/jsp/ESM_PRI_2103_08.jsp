 ...
 *@FileName : ESM_PRI_2103_08.jsp
 *@FileTitle :Spot Guide RFA Creation - Rate(AEW/AEE)
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri200308Event"%>
...
<%
    EsmPri200308Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri200308Event) request.getAttribute("Event");
