 ...
 *@FileName : ESM_PRI_2070.js
 *@FileTitle : RFA Proposal & Amendment Creation - Rate Tab(Add-On Tariff Management) (H Type)
 *Open Issues :
 *Change history :
...
var org_ratCargoTpCd = new Array({
		...
		fic_prop_rt_amt : 'fic_org_rate_prop_dry20',
		...
		fic_prop_rt_amt : 'fic_org_rate_prop_dry40',
		...
		fic_prop_rt_amt : 'fic_org_rate_prop_dry40hc',
		...
		fic_prop_rt_amt : 'fic_org_rate_prop_dry45',
		...
		fic_prop_rt_amt : 'fic_org_rate_prop_rf40hc',
		...
		fic_prop_rt_amt : 'fic_org_rate_prop_rd40hc',
...
var dest_ratCargoTpCd = new Array({
			...
			prop_frt_rt_amt : 'rate_dry20',
			prop_bof_amt : 'rate_bof_dry20',
			fic_prop_rt_amt : 'fic_dest_rate_prop_dry20',
			...
			prop_frt_rt_amt : 'rate_dry40',
			prop_bof_amt : 'rate_bof_dry40',	
			fic_prop_rt_amt : 'fic_dest_rate_prop_dry40',
			...
			prop_frt_rt_amt : 'rate_dry40hc',
			prop_bof_amt : 'rate_bof_dry40hc',		
			fic_prop_rt_amt : 'fic_dest_rate_prop_dry40hc',
			...
			prop_frt_rt_amt : 'rate_dry45',
			prop_bof_amt : 'rate_bof_dry45',		
			fic_prop_rt_amt : 'fic_dest_rate_prop_dry45',
			...
			prop_frt_rt_amt : 'rate_rf40hc',
			prop_bof_amt : 'rate_bof_rf40hc',		
			fic_prop_rt_amt : 'fic_dest_rate_prop_rf40hc',
			...
			prop_frt_rt_amt : 'rate_rd40hc',
			prop_bof_amt : 'rate_bof_rd40hc',		
			fic_prop_rt_amt : 'fic_dest_rate_prop_rd40hc',
...
function initSheet(sheetObj, sheetNo) {
	...
	case "sheet1":  // sheet1 init
		with (sheetObj) {
			...
			var HeadTitle1 = "||cmdt_rout|CMDT\nSeq.|Commodity Group|Commodity Group|Actual Customer|Actual Customer|Route\nSeq.|Origin|Origin|Origin|Origin|Origin|O.Via|D.Via|Destination|Destination|Destination|Destination|Destination|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|Rate(USD)|||||||||||||||||||||||||||||||||||||||||||||||||org_rout_pnt_loc_tp_cd|dest_rout_pnt_loc_tp_cd|org_cy_dor_rt_tp_cd|dest_cy_dor_rt_tp_cd";
			var HeadTitle2 = "||cmdt_rout|CMDT\nSeq.|Code|Description|Code|Description|Route\nSeq.|Code|Description|Loc Group|Term|Transmode|Code|Code|Code|Description|Loc Group|Term|Transmode|Dry 20'|Dry 20'|Dry 20'|Dry 20'|Dry 40'|Dry 40'|Dry 40'|Dry 40'|Dry 40HC|Dry 40HC|Dry 40HC|Dry 40HC|Dry 45'|Dry 45'|Dry 45'|Dry 45'|RF 40HC|RF 40HC|RF 40HC|RF 40HC|RD 40HC|RD 40HC|RD 40HC|RD 40HC|||||||||||||||||||||||||||||||||||||||||||||||||org_rout_pnt_loc_tp_cd|dest_rout_pnt_loc_tp_cd|org_cy_dor_rt_tp_cd|dest_cy_dor_rt_tp_cd";
			var HeadTitle3 = "||cmdt_rout|CMDT\nSeq.|Code|Description|Code|Description|Route\nSeq.|Code|Description|Loc Group|Term|Transmode|Code|Code|Code|Description|Loc Group|Term|Transmode|Rate|BOF|OIH|DIH|Rate|BOF|OIH|DIH|Rate|BOF|OIH|DIH|Rate|BOF|OIH|DIH|Rate|BOF|OIH|DIH|Rate|BOF|OIH|DIH|||||||||||||||||||||||||||||||||||||||||||||||||org_rout_pnt_loc_tp_cd|dest_rout_pnt_loc_tp_cd|org_cy_dor_rt_tp_cd|dest_cy_dor_rt_tp_cd";
			...
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_org_rate_prop_dry20", false, "", dfNullFloat, 2, true, true, 9);
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_dest_rate_prop_dry20", false, "", dfNullFloat, 2, true, true, 9);
			...
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_org_rate_prop_dry40", false, "", dfNullFloat, 2, true, true, 9);
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_dest_rate_prop_dry40", false, "", dfNullFloat, 2, true, true, 9);
			...
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_org_rate_prop_dry40hc", false, "", dfNullFloat, 2, true, true, 9);
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_dest_rate_prop_dry40hc", false, "", dfNullFloat, 2, true, true, 9);
			...
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_org_rate_prop_dry45", false, "", dfNullFloat, 2, true, true, 9);
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_dest_rate_prop_dry45", false, "", dfNullFloat, 2, true, true, 9);
			...
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_org_rate_prop_rf40hc", false, "", dfNullFloat, 2, true, true, 9);
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_dest_rate_prop_rf40hc", false, "", dfNullFloat, 2, true, true, 9);
			...
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_org_rate_prop_rd40hc", false, "", dfNullFloat, 2, true, true, 9);
			InitDataProperty(0, cnt++, dtData, 100, daRight, false, "fic_dest_rate_prop_rd40hc", false, "", dfNullFloat, 2, true, true, 9);
			...
			sheetObj.SetMergeCell(1, 21, 1, 4);
			sheetObj.SetMergeCell(1, 25, 1, 4);
			sheetObj.SetMergeCell(1, 29, 1, 4);
			sheetObj.SetMergeCell(1, 33, 1, 4);
			sheetObj.SetMergeCell(1, 37, 1, 4);
			sheetObj.SetMergeCell(1, 41, 1, 4);
		}
		break;
	case "sheet2": // hidden
		with (sheetObj) {
...
function sheet1_OnChange(sheetObj, Row, Col, Value) {
	...
	} else if (colName == "rate_dry20" || colName == 'fic_org_prop_dry20' || colName == 'fic_dest_rate_prop_dry20' ) {
		setRate(sheetObj, Row, 'rate_dry20', 'rate_bof_dry20', 'fic_org_prop_dry20', 'fic_org_gline_rt_amt_dry20', 'fic_dest_rate_prop_dry20', 'fic_dest_gline_rt_amt_dry20');
		setBofCalculate(sheetObj, Row, 'rate_dry20', 'rate_bof_dry20', 'fic_org_rate_prop_dry20', 'fic_dest_rate_prop_dry20');
	} else if (colName == "rate_dry40" || colName == 'fic_org_rate_prop_dry40' || colName == 'fic_dest_rate_prop_dry40' ) {
		setRate(sheetObj, Row, 'rate_dry40', 'rate_bof_dry40', 'fic_org_rate_prop_dry40', 'fic_org_gline_rt_amt_dry40', 'fic_dest_rate_prop_dry40', 'fic_dest_gline_rt_amt_dry40');
		setBofCalculate(sheetObj, Row, 'rate_dry40', 'rate_bof_dry40', 'fic_org_rate_prop_dry40', 'fic_dest_rate_prop_dry40');
	} else if (colName == "rate_dry40hc" || colName == 'fic_org_rate_prop_dry40hc' || colName == 'fic_dest_rate_prop_dry40hc') {
		setRate(sheetObj, Row, 'rate_dry40hc', 'rate_bof_dry40hc', 'fic_org_rate_prop_dry40hc', 'fic_org_gline_rt_amt_dry40hc', 'fic_dest_rate_prop_dry40hc', 'fic_dest_gline_rt_amt_dry40hc');
		setBofCalculate(sheetObj, Row, 'rate_dry40hc', 'rate_bof_dry40hc', 'fic_org_rate_prop_dry40hc', 'fic_dest_rate_prop_dry40hc');
	} else if (colName == "rate_dry45" || colName == 'fic_org_rate_prop_dry45' || colName == 'fic_dest_rate_prop_dry45') {
		setRate(sheetObj, Row, 'rate_dry45', 'rate_bof_dry45', 'fic_org_rate_prop_dry45', 'fic_org_gline_rt_amt_dry45', 'fic_dest_rate_prop_dry45', 'fic_dest_gline_rt_amt_dry45');
		setBofCalculate(sheetObj, Row, 'rate_dry45', 'rate_bof_dry45', 'fic_org_rate_prop_dry45', 'fic_dest_rate_prop_dry45');
	} else if (colName == "rate_rf40hc" || colName == 'fic_org_rate_prop_rf40hc' || colName == 'fic_dest_rate_prop_rf40hc') {
		setRate(sheetObj, Row, 'rate_rf40hc', 'rate_bof_rf40hc', 'fic_org_rate_prop_rf40hc', 'fic_org_gline_rt_amt_rf40hc', 'fic_dest_rate_prop_rf40hc', 'fic_dest_gline_rt_amt_rf40hc');
		setBofCalculate(sheetObj, Row, 'rate_rf40hc', 'rate_bof_rf40hc', 'fic_org_rate_prop_rf40hc', 'fic_dest_rate_prop_rf40hc');
	} else if (colName == "rate_rd40hc" || colName == 'fic_org_rate_prop_rd40hc' || colName == 'fic_dest_rate_prop_rd40hc') {
		setRate(sheetObj, Row, 'rate_rd40hc', 'rate_bof_rd40hc', 'fic_org_rate_prop_rd40hc', 'fic_org_gline_rt_amt_rd40hc', 'fic_dest_rate_prop_rd40hc', 'fic_dest_gline_rt_amt_rd40hc');
		setBofCalculate(sheetObj, Row, 'rate_rd40hc', 'rate_bof_rd40hc', 'fic_org_rate_prop_rd40hc', 'fic_dest_rate_prop_rd40hc');
	...
	try {
		...
		case IBSAVE: // Save
			...
			if (bBackEndJob) {
				...
				var sXml = sheetObj.GetSaveXml("ESM_PRI_2070GS.do", sParam);
...
function validateForm(sheetObj, formObj, sAction) {
	...
	case IBSEARCH_ASYNC01: // Check
		...
		for ( var i = sheetObj.HeaderRows, n = sheetObj.HeaderRows + sheetObj.RowCount; i < n; i++) {
			...
			// Rate - OIH Check
			ficOrgPropDry20 = sheetObj.CellValue(i, "fic_org_rate_prop_dry20");
			ficOrgPropDry40 = sheetObj.CellValue(i, "fic_org_rate_prop_dry40");
			ficOrgPropDry40hc = sheetObj.CellValue(i, "fic_org_rate_prop_dry40hc");
			ficOrgPropDry45 = sheetObj.CellValue(i, "fic_org_rate_prop_dry45");
			ficOrgPropRf40hc = sheetObj.CellValue(i, "fic_org_rate_prop_rf40hc");
			ficOrgPropRd40hc = sheetObj.CellValue(i, "fic_org_rate_prop_rd40hc");
			
			// Rate - DIH Check
			ficDestPropDry20 = sheetObj.CellValue(i, "fic_dest_rate_prop_dry20");
			ficDestPropDry40 = sheetObj.CellValue(i, "fic_dest_rate_prop_dry40");
			ficDestPropDry40hc = sheetObj.CellValue(i, "fic_dest_rate_prop_dry40hc");
			ficDestPropDry45 = sheetObj.CellValue(i, "fic_dest_rate_prop_dry45");
			ficDestPropRf40hc = sheetObj.CellValue(i, "fic_dest_rate_prop_rf40hc");
			ficDestPropRd40hc = sheetObj.CellValue(i, "fic_dest_rate_prop_rd40hc");
			...
			if (rateDry20 != "") {
				...
				if (!ComIsNull(ficOrgPropDry20) && parseFloat(ficOrgPropDry20) <= 0.00 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry20", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficOrgPropDry20) && parseFloat(ficOrgPropDry20) >= 9999999.99 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry20", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
				
				if (!ComIsNull(ficDestPropDry20) && parseFloat(ficDestPropDry20) <= 0.00 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry20", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficDestPropDry20) && parseFloat(ficDestPropDry20) >= 9999999.99 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry20", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
			}
			...
			if (rateDry40 != "") {
				...
				if (!ComIsNull(ficOrgPropDry40) && parseFloat(ficOrgPropDry40) <= 0.00 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry40", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficOrgPropDry40) && parseFloat(ficOrgPropDry40) >= 9999999.99 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry40", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
				
				if (!ComIsNull(ficDestPropDry40) && parseFloat(ficDestPropDry40) <= 0.00 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry40", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficDestPropDry40) && parseFloat(ficDestPropDry40) >= 9999999.99 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry40", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}				
			}
			...
			if (rateDry40hc != "") {
				...
				if (!ComIsNull(ficOrgPropDry40hc) && parseFloat(ficOrgPropDry40hc) <= 0.00 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry40hc", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficOrgPropDry40hc) && parseFloat(ficOrgPropDry40hc) >= 9999999.99 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry40hc", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
				
				if (!ComIsNull(ficDestPropDry40hc) && parseFloat(ficDestPropDry40hc) <= 0.00 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry40hc", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficDestPropDry40hc) && parseFloat(ficDestPropDry40hc) >= 9999999.99 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry40hc", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}					
			}
			...
			if (rateDry45 != "") {
				...
				if (!ComIsNull(ficOrgPropDry45) && parseFloat(ficOrgPropDry45) <= 0.00 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry45", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficOrgPropDry45) && parseFloat(ficOrgPropDry45) >= 9999999.99 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_dry45", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
				
				if (!ComIsNull(ficDestPropDry45) && parseFloat(ficDestPropDry45) <= 0.00 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry45", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficDestPropDry45) && parseFloat(ficDestPropDry45) >= 9999999.99 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_dry45", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}					
			}
			...
			if (rateRf40hc != "") {
				...
				if (!ComIsNull(ficOrgPropRf40hc) && parseFloat(ficOrgPropRf40hc) <= 0.00 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_rf40hc", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficOrgPropRf40hc) && parseFloat(ficOrgPropRf40hc) >= 9999999.99 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_rf40hc", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
				
				if (!ComIsNull(ficDestPropRf40hc) && parseFloat(ficDestPropRf40hc) <= 0.00 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_rf40hc", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficDestPropRf40hc) && parseFloat(ficDestPropRf40hc) >= 9999999.99 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_rf40hc", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}					
			}
			...
			if (rateRd40hc != "") {
				...
				if (!ComIsNull(ficOrgPropRd40hc) && parseFloat(ficOrgPropRd40hc) <= 0.00 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_rd40hc", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficOrgPropRd40hc) && parseFloat(ficOrgPropRd40hc) >= 9999999.99 && OrgCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_org_rate_prop_rd40hc", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}
				
				if (!ComIsNull(ficDestPropRd40hc) && parseFloat(ficDestPropRd40hc) <= 0.00 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_rd40hc", ComGetMsg("PRI00321", "Rate", "0"));
					isClear = false;
				} else if (!ComIsNull(ficDestPropRd40hc) && parseFloat(ficDestPropRd40hc) >= 9999999.99 && DestCyDorRtTpCdVal =='D') {
					add2Tooltip(i, "fic_dest_rate_prop_rd40hc", ComGetMsg("PRI00336", "Rate", "9999999.99"));
					isClear = false;
				}					
			}
		...
		var sParam = FormQueryString(formObj) + "&" + sheetObj.GetSaveString();
		var sXml = sheetObject2.GetSearchXml("ESM_PRI_2070GS.do", sParam);
