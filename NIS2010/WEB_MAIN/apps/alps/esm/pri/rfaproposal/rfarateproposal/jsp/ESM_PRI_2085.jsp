...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2085Event"%>
...
<html>
<head>
<title>Amendment History - Rate (Route Note)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Amendment History - Rate (Route Note)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
