...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri204113Event"%>
...
<%
	EsmPri204113Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri204113Event) request.getAttribute("Event");
...
<html>
<head>
<title>Amendment History - Rate (For AEE/AEW)</title>
