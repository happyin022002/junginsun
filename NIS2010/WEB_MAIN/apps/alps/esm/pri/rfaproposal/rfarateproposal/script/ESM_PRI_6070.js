...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6070 : ESM_PRI_6070 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6070() {
 ...
 document.onclick = processButtonClick;
     ...
     */         
     function initCombo(formObj){  
		...
		var sXml = scgDtlSheetObj.GetSearchXml("PRICommonGS.do", FormQueryString(formObj)+"&etc1="+formObj.svc_scp_cd.value);
              ...
              case "sheet1":      //sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"prop_no",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"amdt_seq",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"svc_scp_cd",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"gen_spcl_rt_tp_cd",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"cmdt_hdr_seq",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"rout_seq",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"rt_seq",   			false,          "",      dfNone,      		0,			false,      true);
 			   ...
 			   case "sheet2":      //sheet2 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle1 = "|Sel.|Seq.|Surcharge\nCode|Per|Cur.|Amount|Amount|Amount|Remark(s)||||||||adj_flg|qttn_no|qttn_ver_no";
 					var HeadTitle2 = "|Sel.|Seq.|Surcharge\nCode|Per|Cur.|Local|USD|Tariff|Remark(s)||||||||adj_flg|qttn_no|qttn_ver_no";
 					var headCount = ComCountHeadTitle(HeadTitle1);
 					...
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"rt_seq",   			false,          "",      dfNone,      		0,			false,      false);
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
	            ...
	            sXml = sheetObj.GetSearchXml("ESM_PRI_6070GS.do", FormQueryString(formObj) );
 			...
 			case IBSAVE:        //저장
				...
				sheetObj.DoSave("ESM_PRI_6070GS.do", FormQueryString(formObj) );
				ComOpenWait(false);
				break;
 			case IBINSERT:      // 입력
     ...
     */     
     function setFormDataToSheet(idx, sheetObj, formObj){
    	 ...
    	 sheetObj.CellValue(idx, "rt_seq") = formObj.rt_seq.value;
    ...
    */       	
     ...
     */   
   	function getXChgRateFromYrMon(){
   		var tmpXchgYrMon = "";
      	var formObj = document.form
		var formParam = "f_cmd="+COMMAND35+"&etc1="+formObj.prop_no.value;
     ...
     function validateForm(sheetObj, formObj, sAction) {
         ...
         case IBSAVE: // 저장
	         if (sheetObj.IsDataModified == false) {
         	 ...
         	 var colNames = "prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|rt_seq|chg_cd";
         	 //중복체크
