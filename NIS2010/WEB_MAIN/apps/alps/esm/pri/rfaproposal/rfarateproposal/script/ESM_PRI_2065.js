...
//	                var HeadTitle2 = "|Seq.|Code|Description|Code|Description|Seq.|Code|Description|Term|Transmode|Code|Code|Code|Description|Term|Transmode|PER|Cargo Type|Rate|BUC|IFC|PSC";
	                ...
	                InitDataProperty(0, cnt++, dtCombo, 80, daCenter, false, "curr_cd", false, "", dfNone, 0, true, true, 2);
        ...
        try {
	        ...
	        case IBSAVE: // Save
	            ...
	            if (formObj.prop_no.value == "PDX090072M") {
		            ...
		            var sXml = sheetObj.GetSaveXml("ESM_PRI_2065GS.do", sParam);
...
//                            var validPerClass = "A,F,O,Q,S,P";
            ...
            var sParam = FormQueryString(formObj) + "&" + sheetObj.GetSaveString();
            var sXml = sheetObject2.GetSearchXml("ESM_PRI_2065GS.do", sParam);
...
function sheet1_OnLoadExcel(obj) {
	...
	for ( var i = obj.HeaderRows; i < obj.Rows; i++) {
		if(i == obj.HeaderRows) {
