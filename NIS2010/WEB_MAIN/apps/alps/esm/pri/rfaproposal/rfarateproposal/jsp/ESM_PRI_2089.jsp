...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2089Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
    EsmPri2089Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri2089Event) request.getAttribute("Event");
...
<html>
<head>
<title>Amendment History - Rate (Commodity)</title>
...
<table width="900" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="100%" border="0">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Amendment History - Rate (Commodity)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
