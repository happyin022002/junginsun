...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2024Event"%>
...
<html>
<head>
<title>RFA Proposal Creation - Rate (Route Note)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Creation - Rate (Route Note)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
