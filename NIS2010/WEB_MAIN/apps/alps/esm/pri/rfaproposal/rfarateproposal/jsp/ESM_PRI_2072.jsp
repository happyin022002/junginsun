...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2072Event"%>
...
<html>
<head>
<title>RFA Proposal Inquiry - Rate (Commodity Note)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Inquiry - Rate (Commodity Note)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
