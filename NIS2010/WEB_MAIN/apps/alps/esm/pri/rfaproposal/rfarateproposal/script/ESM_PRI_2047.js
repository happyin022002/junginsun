...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2047 : ESM_PRI_2047 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    	...
    	sheetObj.ShowDebugMsg = false;
     	...
     	switch(sAction) {
	     	...
	     	case IBSEARCH:
	    		...
	    		var sXml = sheetObj.GetSearchXml("ESM_PRI_2047GS.do" , FormQueryString(formObj));
