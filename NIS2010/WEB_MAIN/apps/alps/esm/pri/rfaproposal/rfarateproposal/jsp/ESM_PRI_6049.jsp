...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri6049Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6049Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6049Event)request.getAttribute("Event");
...
<html>
<head>
<title>PRS- S/C Amendment CM/OP View All</title>
				...
				<tr class="h23">
					<td width="450">
						<table class="search_sm2" border="0" style="width:350;"> 
							<tr class="h23">
								<td width="80">&nbsp;View</td>
								<td class="stm"><input type="radio" value="CMDT" name="by_view" class="trans" checked>By Commodity&nbsp;&nbsp;&nbsp;<input type="radio" value="CUST" name="by_view" class="trans" >By Actual Customer</td>
							</tr>	
						</table>
					</td>				
					<td width="230">
						<table class="search_sm2" border="0" style="width:200;"> 
							<tr class="h23">
								...
								<td class="stm"><input type="radio" value="FEU" name="pfmc_unit" class="trans" >FEU&nbsp;&nbsp;&nbsp;<input type="radio" value="TEU" name="pfmc_unit" class="trans" checked>TEU</td>
							</tr>	
						</table>
					</td>
