...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri201908Event"%>
...
<%
    EsmPri201908Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri201908Event) request.getAttribute("Event");
...
<html>
<head>
<title>RFA Proposal & Amendment Inquiry - Rate (For AEE/AEW)</title>
