...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri6070Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6070Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6070Event)request.getAttribute("Event");
