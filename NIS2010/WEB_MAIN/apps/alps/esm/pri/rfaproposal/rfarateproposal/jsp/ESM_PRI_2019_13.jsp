...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri201913Event"%>
...
<%
	EsmPri201913Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri201913Event) request.getAttribute("Event");
...
<html>
<head>
<title>RFA Proposal & Amendment Inquiry - Rate (For Add-On Tariff)</title>
...
<input type="hidden" name="s_svc_scp_cd_clr">
<input type="hidden" name="s_cmdt_hdr_seq_clr">
<input type="hidden" name="s_rout_seq_clr">
