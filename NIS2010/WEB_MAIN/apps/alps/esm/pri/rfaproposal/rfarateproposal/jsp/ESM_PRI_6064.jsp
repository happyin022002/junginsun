...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri6064Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6064Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6064Event)request.getAttribute("Event");
