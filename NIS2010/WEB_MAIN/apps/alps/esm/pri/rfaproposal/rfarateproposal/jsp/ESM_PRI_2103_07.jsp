 ...
 *@FileName : ESM_PRI_2103_07.jsp
 *@FileTitle : Spot Guide RFA Creation - Rate
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri200307Event"%>
