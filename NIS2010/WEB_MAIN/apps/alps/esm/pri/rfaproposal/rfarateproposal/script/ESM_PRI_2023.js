	...
	function sheet1_OnPopupClick(sheetObj, Row, Col) {
		...
		if (colName == "prc_cmdt_def_cd") {
			if (sheetObj.CellEditable(Row, "prc_cmdt_def_cd")) {
	            ...
	            sUrl += "&grp_cd=" + PRI_RP_SCP + "&commodity_cmd=CRG&prc_cmdt_tp_cd=" + sheetObj.CellValue(sheetObj.SelectRow, "prc_cmdt_tp_cd");
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        try {
	        ...
	        case IBSEARCH_ASYNC13: // Accept
	            ...
	            var sXml = sheetObj.GetSaveXml("ESM_PRI_2023GS.do", sParam);
