...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2073Event"%>
...
<html>
<head>
<title>RFA Proposal Inquiry - Rate (Route Note)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Inquiry - Rate (Route Note)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
		...
		<!--  biz_1   (E) -->
			...
			<table class="grid2" border="0" style="width:100%;"> 
				<tr class="tr2_head">
					<td width="100" class="input" align="center">Route Note</td>
