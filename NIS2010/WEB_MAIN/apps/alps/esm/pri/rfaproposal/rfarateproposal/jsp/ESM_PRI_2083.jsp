 ...
 *@FileName : ESM_PRI_2083.jsp
 *@FileTitle : RFA Proposal Inquiry - Rate (Actual Customer)
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2083Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
    EsmPri2083Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri2083Event) request.getAttribute("Event");
...
<html>
<head>
<title>RFA Proposal Inquiry - Rate (Actual Customer)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Inquiry - Rate (Actual Customer)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
