...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2023Event"%>
...
<html>
<head>
<title>RFA Proposal Creation - Rate (Commodity)</title>
...
<table width="800" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="100%" border="0">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Creation - Rate (Commodity)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
