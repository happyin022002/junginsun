...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2047Event"%>
       		...
       		<tr><td class="bg">
				...
				<table border="0" style="width:100%;" class="grid2"> 
					...
					<tr class="">
						...
						<td width="22%" align="center"><input type="text" name="act_cgo_len" dataformat="float" maxLength="10" pointcount="2" value=".00" style="width:100%;text-align:right;ime-mode:disabled" class="input">	</td>
						<td width="22%" align="center"><input type="text" name="act_cgo_wdt" dataformat="float" maxLength="10" pointcount="2" value=".00" style="width:100%;text-align:right;ime-mode:disabled" class="input">	</td>
						<td width="22%" align="center"><input type="text" name="act_cgo_hgt" dataformat="float" maxLength="10" pointcount="2" value=".00" style="width:100%;text-align:right;ime-mode:disabled" class="input">	</td>
						<td width="%" align="center"><input type="text" name="act_cgo_wgt" dataformat="float" maxLength="19" pointcount="2" value=".00" style="width:100%;text-align:right;ime-mode:disabled" class="input">	</td>
					</tr>
				</table>
				<table class="search" border="0">
				...
				<table border="0" style="width:100%;" class="search"> 
						...
						<td width="">
							...
							<input type="text" style="width:40;text-align:center;background-color:E8EFF9;" value="Q4" class="noinpu2" readonly>&nbsp;<input type="text" name="total_dead_slot2" value="0" style="width:40;text-align:center" class="noinput2" readonly></td>
						</tr>
				</table>
				<table border="0" style="width:100%;" class="search"> 
						<tr class="h23">
						<td width="40" valign="top">Note </td>
						<td width=""><textarea name="cgo_spec_rmk" cols="120" rows="4" style="ime-mode:disabled"></textarea></td>
						</tr>
				</table>
