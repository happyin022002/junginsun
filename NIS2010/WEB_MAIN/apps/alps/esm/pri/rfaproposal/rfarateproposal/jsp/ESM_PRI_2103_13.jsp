 ...
 *@FileName : ESM_PRI_2103_13.jsp
 *@FileTitle :Spot Guide RFA Creation - Rate(AddOn)
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri200313Event"%>
<%
    EsmPri200313Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri200313Event) request.getAttribute("Event");
...
<html>
<head>
<title>RFA Proposal Creation - Rate</title>
...
<input type="hidden" name="bak_fic_rt_tp_cd" value="G">
<input type="hidden" name="tgt_rate_sheet_id">
<input type="hidden" name="fic_gline_rt_amt">
<input type="hidden" name="curr_cd">
<input type="hidden" name="ctrt_eff_dt">
<input type="hidden" name="ctrt_exp_dt">
<input type="hidden" name="rfa_ctrt_tp_cd">
        <table class="search">
            <tr><td class="bg">
                ...
                <tr>
                    ...
                    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        ...
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                            <tr><td class="btn1_left"></td>
                            <td class="btn1" name="btn_cancel">Accept Cancel</td>
                            <td class="btn1_right"></td>
                            </tr>
                        </table></td>
                        <!-- 
                        ...
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                            <tr><td class="btn1_left"></td>
                            <td class="btn1" name="btn_gricalc">GRI Cal.</td>
                            <td class="btn1_right"></td>
                            </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                            <tr><td class="btn1_left"></td>
                            <td class="btn1" name="btn_checkduplicate">Check Duplicate</td>
                            <td class="btn1_right"></td>
                            </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                ...
                <table border="0" style="width:450;" class="search_sm2">
						<tr class="h23">
							<td width="50">Type</td>
							<td width="400" class="stm" style="font-size:12;" id="rdoTpCd">
								<input type="radio" name="fic_rt_tp_cd" value="G" class="trans">&nbsp;<span id="fic_rt_tp_cd1">Rate of Port (CY) only</span>&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="fic_rt_tp_cd" value="A" class="trans">&nbsp;<span id="fic_rt_tp_cd2">Rate of Including IHC</span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
				</table>
                ...
                <!-- Grid  (S) -->
                <table width="100%" id="mainTable" name="gen_table">
                    <tr>
                        <td width="100%">
	        ...
	        <div id="div_routDetail1" style="width:100%; display:none">
	        ...
	        <div id="div_routDetail2" style="width:100%; display:none">
            ...
            <tr class="h23"><td class="title_h"></td>
                <td class="title_s" width="100">Rate</td>
                <td>
                    <table class="search" border="0" style="width:320;" bgcolor="E9E9E9">
                        <tr class="h23">
                            <td width="110">&nbsp;&nbsp;PRS Cost Level</td>
                            <td width="" class="stm">
                            <input type="radio" name="rdoPRSCostLevel" value="CM" class="trans" checked>BKG CM(RA)&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="rdoPRSCostLevel" value="OP" class="trans">BKG OP(RA)
                            </td>
                        </tr>
                    </table>
            ...
            <!-- Grid  (S) -->
                ...
                <table width="100%" id="mainTable" name="arb_table" style="display:none">
                    <tr>
                        <td width="100%">
            ...
            <!-- Grid (E) -->
                ...
                <tr><td class="btn2_bg">
                    ...
                    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2_2" name="btn_calculate" id="btn_calculate">Calculate</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
                        ...
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn2_left"></td>
                        <td class="btn2_2" name="btn_cmviewall" id="btn_cmviewall">CM View All</td>
                        <td class="btn2_right"></td>
                        </tr>
                        </table></td>
...
<!--  // Excel Download용 Sheet(Horizontal) - Rate of Including IHC인경우 -->
<script language="javascript">ComSheetObject('sheet18');</script>
<!--  // Excel Download용 Sheet(Vertical) - Rate of Including IHC인경우 -->
