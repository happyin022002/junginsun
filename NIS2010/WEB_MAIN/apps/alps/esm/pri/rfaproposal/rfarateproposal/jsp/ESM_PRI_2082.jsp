...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2082Event"%>
...
<html>
<head>
<title>RFA Proposal Creation - Rate (Actual Customer)</title>
...
<input type="hidden" name="rfa_ctrt_tp_cd" value="<%=JSPUtil.getParameter(request, "rfa_ctrt_tp_cd") %>">
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Creation - Rate (Actual Customer)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
