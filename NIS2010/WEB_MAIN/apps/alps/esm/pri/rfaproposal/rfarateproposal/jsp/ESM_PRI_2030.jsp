...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2030Event"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
    EsmPri2030Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri2030Event) request.getAttribute("Event");
...
<input type="hidden" name="fic_rt_tp_cd" value="<%=StringUtil.xssFilter(request.getParameter("fic_rt_tp_cd"))%>">
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;RFA Proposal Creation - Rate (Route Point)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
       ...
       <tr><td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width="600" class="stm" style="font-size:12;">
                        ...
                        <input type="radio" id="pointType" name="rt_pnt" value="1" class="trans" <%= (ficRtTpCd.equals("A"))?"disabled":"" %>>&nbsp;Origin Via&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" id="pointType" name="rt_pnt" value="2" class="trans" <%= (ficRtTpCd.equals("A"))?"disabled":"" %>>&nbsp;Destination Via&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr><td class="btn2_bg">
                    ...
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn2_left"></td>
                    <td class="btn2" name="btn_copy" suppressWait="Y">Row Copy</td>
                    <td class="btn2_right"></td>
                    </tr>
                    </table></td>
