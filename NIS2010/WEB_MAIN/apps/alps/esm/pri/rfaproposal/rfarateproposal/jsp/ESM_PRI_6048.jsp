...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaproposal.rfarateproposal.event.EsmPri6048Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6048Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6048Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA CM/OP View All</title>
