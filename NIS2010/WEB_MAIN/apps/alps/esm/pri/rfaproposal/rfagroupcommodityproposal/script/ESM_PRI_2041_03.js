...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2041_03 : ESM_PRI_2041_03 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2041_03() {
			...
			case "sheet1":
				with (sheetObj) {
					...
					// SAVESTATUS, FORMATFIX]
                     ...
                     InitDataProperty(0, cnt++ , dtData,    		75,   	daCenter,  	true,	"prc_grp_cmdt_cd",			false,           "",      dfNone, 			0,     false,     false, 5);
 					 InitDataProperty(0, cnt++ , dtData,     		150,   	daLeft, 	true,	"prc_grp_cmdt_desc",		false,           "",      dfNone, 			0,     false,     false);
                     
	                 InitDataProperty(0, cnt++ , dtHidden,    	 	20, 	daCenter,  	true,  "src_info_cd");    
	                 InitDataProperty(0, cnt++ , dtHidden,    	 	20, 	daCenter,  	true,  "prc_prog_sts_cd");
				...
				with (sheetObj) {
					...
					// SAVESTATUS, FORMATFIX]
	                 InitDataProperty(0, cnt++ , dtHiddenStatus,	30,    	daCenter,	true,	"ibflag");
 	                 ...
 	                 InitDataProperty(0, cnt++ , dtDataSeq, 		30, 	daCenter, 	true,	"seq");
 					 InitDataProperty(0, cnt++ , dtHidden,    	 	40, 	daCenter,  	true,  "prop_no");
 	                 InitDataProperty(0, cnt++ , dtHidden,    	 	30, 	daCenter,  	true,  "amdt_seq");
 					 InitDataProperty(0, cnt++ , dtHidden,    	 	40, 	daCenter,  	true,  "svc_scp_cd");
 					 
 					 InitDataProperty(0, cnt++ , dtCombo,    	 	85, 	daCenter,  	true,  "prc_cmdt_tp_cd",	false,         	"",      dfNone, 			0,     false, 	false);
					 InitDataProperty(0, cnt++ , dtData, 			80,    	daCenter,  	true,	"prc_cmdt_def_cd",	false,         	"",      dfNone, 			0,     false,	false, 6);
                     ...
                     InitDataProperty(0, cnt++ , dtData,      		70,    	daCenter,  	true,	"exp_dt",      		false,          "",      dfDateYmd, 		0,     false, 	false);
 					 ...
 					 InitDataProperty(0, cnt++ , dtCombo,      		70,   	daCenter,  	true,	"prc_prog_sts_cd",	false,          "",      dfNone, 			0,     false, 	false);
	                 ...
	                 InitDataProperty(0, cnt++ , dtHidden,    	 	40, 	daCenter,  	true,  "grp_cmdt_seq");
	                 InitDataProperty(0, cnt++ , dtHidden, 			30, 	daCenter, 	true,	"grp_cmdt_dtl_seq");
		...
		try {
			...
			switch (sAction) {
				case IBSEARCH: // 조회
					...
					sheetObj.DoSearch("ESM_PRI_2041_03GS.do" , FormQueryString(formObj));
					break;
