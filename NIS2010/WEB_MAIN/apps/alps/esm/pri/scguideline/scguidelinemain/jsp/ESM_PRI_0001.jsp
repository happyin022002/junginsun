...
<%@ page import="com.hanjin.apps.alps.esm.pri.scguideline.scguidelinemain.event.EsmPri0001Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="390" style="padding-left:2px;"><script language="javascript">ComComboObject("svc_scp_cd", 2, 50, 0, 1, 0, false);</script>
					&nbsp;<input name="svc_scp_nm" type="text" style="width:290;"  value="" class="input2" readonly caption="Service Scope"></td>
					<td width="57">Duration</td>
					<td width="260" style="padding-left:2px;">
					<script language="javascript">ComComboObject("gline_seq", 3, 90, 0, 1, 2, true);</script>&nbsp;~&nbsp;<input name="eff_dt" type="hidden" value="" class="input1" caption="Effective Date" required><input name="eff_dt_hidden" type="hidden" value="" class="input1"><input name="exp_dt" type="text" style="width:75;"  value="" class="input1" caption="Expire Date" maxlength="10" dataformat="ymd" required>
				...
				<tr class="h23">
					...
					<td width="">Staff</td>
					<td width=""><input name="cre_usr_nm" type="text" style="width:108;"  value="" class="input2" readonly caption="Staff"></td>
					<td width="">Team</td>
            ...
            <div id="tabLayer" style="display:none">
            <iframe name="t4frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="405" src="about:blank"></iframe>
            </div>
            <div id="tabLayer" style="display:none">
            <iframe name="t5frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="728" src="about:blank"></iframe>
            </div>
            <div id="tabLayer" style="display:none">
            <iframe name="t6frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="405" src="about:blank"></iframe>
            </div>
            <div id="tabLayer" style="display:none">
            <iframe name="t7frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="405" src="about:blank"></iframe>
            </div>
