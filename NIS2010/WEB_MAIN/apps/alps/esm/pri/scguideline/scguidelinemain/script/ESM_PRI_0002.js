 ...
 ***************************************************************************************/
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        try {
			...
			case IBSEARCH_ASYNC20: // 화면 로딩시 Tab Count 조회
				...
				subDataCnt = 0;
				var sXml = sheetObj.GetSearchXml("ESM_PRI_0002GS.do", FormQueryString(formObj));
	...
	function loadTabPage(tabIndex) {
		...
		if (objTabWindow.location.href == "" || objTabWindow.location.href == "about:blank") {
			...
			switch (tabIndex) {
			case 0:
				sUrl = "ESM_PRI_0002_02.do"; 
				break;
			case 1:
				sUrl = "ESM_PRI_0002_01.do"; 
				break;
			case 2:
				sUrl = "ESM_PRI_0002_03.do"; 
				break;
			case 3:
				sUrl = "ESM_PRI_0002_04.do"; 
				break;
			case 4:
				sUrl = "ESM_PRI_0002_06.do"; 
				break;
			case 5:
				sUrl = "ESM_PRI_0002_05.do"; 
				break;
			case 6:
				sUrl = "ESM_PRI_0002_07.do"; 
				break;
			}
