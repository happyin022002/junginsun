...
<%@ page import="com.hanjin.apps.alps.esm.pri.scguideline.scboilerplateguideline.event.EsmPri0007Event"%>
...
<html>
<head>
<title>Boiler Plate Guideline</title>
...
<input type="hidden" name="blpl_hdr_seq_copy" value="">
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="30">Year</td>
					<td width="150" class="stm"><input name="blpl_ref_yr" maxlength="4" type="text" style="width:40;text-align:center;"  value="" class="input1"
					...
					<td width="60"><img src="img/btns_calendar.gif" class="cursor" name="btns_calendar" valign="bottom"></td>
					<td width="85">Confirmation</td>
					<td width=""><input name="cfm_flg" type="text" style="width:58;text-align:center;"  value="" class="input2" readonly caption="Confirmation"></td></tr>
