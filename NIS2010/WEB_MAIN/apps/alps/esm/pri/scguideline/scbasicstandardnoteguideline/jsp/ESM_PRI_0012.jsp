...
<%@ page import="com.hanjin.apps.alps.esm.pri.scguideline.scbasicstandardnoteguideline.event.EsmPri0012Event"%>
...
<html>
<head>
<title>Standard Note Conversion Inquiry</title>
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp;Standard Note Conversion Inquiry</td>
			</tr>
		</table>
