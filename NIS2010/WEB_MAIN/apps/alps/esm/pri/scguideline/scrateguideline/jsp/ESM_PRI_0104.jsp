...
<%@ page import="com.hanjin.apps.alps.esm.pri.scguideline.scrateguideline.event.EsmPri0104Event"%>
...
<html>
<head>
<title>Guideline Route Note Creation</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Guideline Route Note Creation</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
