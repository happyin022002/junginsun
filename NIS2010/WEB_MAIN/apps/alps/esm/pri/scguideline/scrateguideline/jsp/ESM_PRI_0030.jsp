...
<%@ page import="com.hanjin.apps.alps.esm.pri.scguideline.scrateguideline.event.EsmPri0030Event"%>
...
<input type="hidden" name="enable_flg" value="<%=enableFlg %>">
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Guideline MQC</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
        ...
        <table class="search" id="mainTable">
            <tr><td class="bg">
                ...
                <tr class="h23">
                    ...
                    <td width=""><input type="text" name="svc_scp_cd" style="width:35;text-align:center;" class="input2" value="<%=svcScpCd %>" readonly="readonly">&nbsp;<input type="text" name="svc_scp_nm" style="width:250;" class="input2" value="<%=svcScpNm %>" readonly="readonly"></td>
                </tr>
                <tr class="h23">
                    <td>Customer Type </td>
                    <td><input type="text" name="prc_cust_tp_nm" style="width:165;" class="input2" value="<%=prcCustTpNm %>" readonly="readonly"></td>
                </tr>
                </table>
                <!--  biz_1   (E) -->
