...
//		  				  			  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX] 
 					...
 					InitDataProperty(0, cnt++ , dtDataSeq,			40,  daCenter,	false, "seq", false, "", dfNone, 0,	true, true);
 					...
 					InitDataProperty(0, cnt++, dtHidden, 100, daCenter, false, "prc_cust_tp_cd", false, "", dfNone, 0, true, true);
...
//	                 var HeadTitle = "|1|2|3|4|5|6|7|Location Type|Location Code|Description|Term|Trans Mode";
	...
	//	  				  			  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX] 
						...
						InitDataProperty(0, cnt++, dtData, 50, daCenter, false, "prc_cust_tp_cd", true, "", dfNone, 0, false, false);
...
//				* opener화면으로 sheet data 내리는 방법
    ...
    */ 	
  	function radio_click()
  	{
  		var radioObj = document.form.rt_pnt;
  		var hiddenVal = false;
  		var idx = 1 ; //선택된 Route Point 의 index
    ...
    */  	      	 
	function sheet1_OnPopupClick(sheetObj, Row, Col)
	{
		...
		if (colName == "rout_pnt_loc_def_cd"){
			var sUrl = "/hanjin/ESM_PRI_4026.do?group_cmd=" + PRI_SG+ "&loc_tp_cd="+ locTpCd  + "&location_cmd=LG&svc_scp_cd=" + formObj.svc_scp_cd.value + "&gline_seq=" + formObj.gline_seq.value;
