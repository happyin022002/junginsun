...
*@FileTitle : Rate Guideline Creation - Commodity 
*Open Issues :
*Change history :
          ...
          switch(sAction) {
 			case IBCLEAR: // 화면 로딩시 			
				//공통 cmdt type
 				...
 				break;
			case IBSEARCH:      //조회 Rate 화면에서 데이터를 가져온다.				
    ...
    */  	      	 
	function sheet1_OnPopupClick(sheetObj, Row, Col)
	{
		...
		if (colName == "prc_cmdt_def_cd"){
			var sUrl = "/hanjin/ESM_PRI_4027.do?prc_cmdt_tp_cd="+ prcCmdtTpCd + "&commodity_cmd=CG&grp_cd="+PRI_SG+"&svc_scp_cd="+formObj.svc_scp_cd.value+"&gline_seq="+formObj.gline_seq.value+"&prc_cust_tp_cd="+formObj.prc_cust_tp_cd.value;
