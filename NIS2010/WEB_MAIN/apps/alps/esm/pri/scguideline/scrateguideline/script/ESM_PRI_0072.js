...
//		  				  			  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX] 
 					...
 					InitDataProperty(0, cnt++, dtHidden, 100, daCenter, false, "prc_cust_tp_cd", false, "", dfNone, 0, false, false);
...
// 					InitDataCombo(0,	"rout_pnt_loc_tp_cd",	"Location|GRP Location",	"L|G");
				
// 					ColHidden("svc_scp_cd") = true;
// 					ColHidden("gline_seq") = true;
// 					ColHidden("prc_cust_tp_cd") = true;
// 					ColHidden("cmdt_hdr_seq")  = true;
// 					ColHidden("rout_seq") = true;
// 					ColHidden("org_dest_tp_cd") = true;
// 					ColHidden("rout_pnt_seq") = true; 	
