...
<%@ page import="com.hanjin.apps.alps.esm.pri.scguideline.scrateguideline.event.EsmPri000106Event"%>
...
<%
	...
	String strUsr_nm = "";
	Logger log = Logger
			.getLogger("com.hanjin.apps.SCGuideline.SCGuidelineMain");
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								<td class="btn1_left"></td>
								<td class="btn1" name="btn_mqc">MQC</td>
								<td class="btn1_right"></td>
							</tr>
						</table>
						</td>
