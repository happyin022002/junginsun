 ...
 ***************************************************************************************/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_0030 : Guideline MQC 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0030 () {
    ...
    /**
     * Button Enable/Disable 처리 <br>
     * Guideline Rate 화면의 body 태그의 onLoad 이벤트핸들러 구현 <br>
     * 화면을 브라우저에서 로딩한 후에 선처리해야 하는 기능을 추가한다. <br>
     * <br><b>Example :</b>
     * <pre>
        ...
        switch (sheetNo) {
            case 1: // sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++, dtData,         150, daCenter, false, "mqc_rng_fm_qty",   true,   "",     dfNone,     0,  true,   true,   6);
                    InitDataProperty(0, cnt++, dtData,         150, daCenter, false, "mqc_rng_to_qty",   true,   "",     dfNone,     0,  true,   true,   6);
    ...
    function doActionIBSheet (sheetObj, formObj, sAction) {
        ...
        switch (sAction) {
            ...
            case IBSAVE: //저장
                ...
                if (validateForm(sheetObj, formObj, sAction)) {
                    if (sheetObj.id == "sheet1") {
                        ...
                        sheetObj.DoSave("ESM_PRI_0030GS.do", FormQueryString(formObj), -1, false);
                    }
                }
                ComOpenWait(false);
                break;
            ...
            case IBINSERT: // 입력
                ...
                if (Row == 1) {
                    sheetObj.CellValue2(Row, "mqc_rng_fm_qty") = 1;
                } else {
        ...
        with (sheetObj) {
            if (sAction == IBSAVE) {
                ...
                for ( var i = 1; i <= cnt; i++) {
                    ...
                    // MIN값은 0보다 커야함.
                    if (Number(sheetObj.CellValue(i, "mqc_rng_fm_qty")) == 0) {
