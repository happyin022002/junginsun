		...
		switch (sheetID) {
			case "sheet1":
				with (sheetObj) {
					...
					InitDataProperty(0, cnt++, dtData, 200, daLeft, false, "prc_grp_loc_desc", false, "", dfEngKey, 0, false, false, 100);
			...
			case "sheet2":
				with (sheetObj) {
					...
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, "loc_cd", false, "", dfEngUpKey, 0, false, false, 5, true);
			...
			case "sheet3":
				with (sheetObj) {
					...
					InitDataProperty(0, cnt++, dtData, 90, daLeft, false, "gline_seq", false, "", dfNone, 0, false, false);
					InitDataProperty(0, cnt++, dtData, 90, daLeft, false, "grp_loc_seq", false, "", dfNone, 0, false, false);
					InitDataProperty(0, cnt++, dtData, 90, daLeft, false, "grp_loc_dtl_seq", false, "", dfNone, 0, false, false);
