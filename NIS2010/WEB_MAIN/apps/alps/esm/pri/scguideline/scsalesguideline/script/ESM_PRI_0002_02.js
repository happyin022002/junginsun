		...
		switch (sheetID) {
			case "sheet1":
				with (sheetObj) {
					...
					InitDataProperty(0, cnt++, dtHidden, 90, daLeft, false, "ref_seq", false, "", dfNone, 0, false, false);
					InitDataProperty(0, cnt++, dtData, 90, daLeft, false, "ref_tit_nm", false, "", dfNone, 0, false, false, 100);
					InitDataProperty(0, cnt++, dtData, 90, daLeft, false, "ref_ctnt", false, "", dfNone, 0, false, false, 4000);
