...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_0085 : ESM_PRI_0085 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0085() {
        ...
        switch(sheetID) {
            ...
            case "sheet1":
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtDummyCheck,   50,   daCenter, false, "sel_chk", false, "", dfNone, 0, true, true);
                    InitDataProperty(0, cnt++ , dtDataSeq,      50,   daCenter, false, "seq");
                    InitDataProperty(0, cnt++ , dtHidden,       50,   daCenter, false, "stnd_wdg_seq");
                    InitDataProperty(0, cnt++ , dtData,         200,  daLeft,   false, "stnd_wdg_ctnt", true, "", dfNone, 0, false, false);
