...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.vessel.event.EsmPri4013Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.PRIMasterData.Vessel");
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Vessel Code Inquiry</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
        ...
        <!-- : ( Search Options ) (S) -->
            ...
            <tr><td class="bg">
                ...
                <tr class="h23">
                    <td width="85">Code</td>
                    <td><input type="text" name="vsl_cd" maxlength="4" style="width:60;ime-mode:disabled;" onKeyPress="ComKeyOnlyAlphabet('upper')"></td>
                </tr>
                <tr class="h23">
                    <td width="">Description</td>
                    <td><input type="text" name="vsl_eng_nm" style="width:200;"></td>
                </tr>
                </table>
