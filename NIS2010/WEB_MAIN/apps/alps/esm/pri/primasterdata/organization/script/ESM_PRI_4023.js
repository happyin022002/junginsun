...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class ESM_PRI_4023 : ESM_PRI_4023 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
            ...
            case "sheet1":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtSeq,	80,	 daCenter,	true,	"seq",			false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	100, daCenter,	true,	"ofc_cd",		false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	450, daLeft,	true,	"ofc_eng_nm",	false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	100, daCenter,	true,	"ofc_tp_cd",	false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	100, daCenter,	true,	"loc_cd",		false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	100, daCenter,	true,	"prnt_ofc_cd",	false,	"",	dfNone);
