...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_4021 : ESM_PRI_4021 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_4021() {
        	...
        	case "sheet1":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtData,	40,	 daCenter,	true,	"conti_cd",	false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	100, daCenter,	true,	"conti_nm",	false,	"",	dfNone);
            ...
            case "sheet2":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    //데이터속성    [ROW, COL,  DATATYPE,		WIDTH, DATAALIGN,	COLMERGE,	SAVENAME,			KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
					InitDataProperty(0, cnt++ , dtSeq,	40,	 daCenter,	true,	"seq",		 false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	40,	 daCenter,	true,	"sconti_cd", false,	"",	dfNone);
					InitDataProperty(0, cnt++ , dtData,	100, daCenter,	true,	"sconti_nm", false,	"",	dfNone);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
          	...
          	case IBSEARCH_ASYNC01:
				var contiCd = sheetObjects[0].CellValue(sheetObjects[0].SelectRow, "conti_cd");
