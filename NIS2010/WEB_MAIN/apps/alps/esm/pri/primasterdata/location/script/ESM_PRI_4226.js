 ...
 *****************************************************************************************
 ...
 var rtnVal = ComPriOpenWindowCenter(sUrl, "ESM_PRI_4226", 700, 280, true);
 if (rtnVal != null){
...
/**
 * @extends
 * @class ESM_PRI_4226 : ESM_PRI_4226 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_PRI_4226() {
