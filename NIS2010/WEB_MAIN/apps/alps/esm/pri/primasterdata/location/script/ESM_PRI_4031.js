...
function initSheet(sheetObj, sheetNo) {
	...
	case "sheet1":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 280, daLeft, false, "loc_nm", false, "", dfNone, 0, false, false, 20);
			InitDataProperty(0, cnt++, dtData, 70, daCenter, false, "sconti_cd", false, "", dfNone, 0, false, false);

			InitDataProperty(0, cnt++, dtData, 50, daCenter, false, "rgn_cd", false, "", dfNone, 0, false, false);
	...
	case "sheet2":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtSeq, 30, daCenter, false, "Seq");
			InitDataProperty(0, cnt++, dtData, 100, daCenter, false, "loc_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 380, daLeft, false, "loc_nm", false, "", dfNone, 0, false, false, 20);
			InitDataProperty(0, cnt++, dtData, 70, daCenter, false, "sconti_cd", false, "", dfNone, 0, false, false);
	...
	case "sheet3":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtHiddenStatus, 30, daCenter, false, "Status");
			InitDataProperty(0, cnt++, dtSeq, 30, daCenter, false, "Seq");
			InitDataProperty(0, cnt++, dtData, 100, daCenter, false, "combo_cnt_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 60, daCenter, false, "ste_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 300, daLeft, false, "ste_nm", false, "", dfNone, 0, false, false, 20);

			InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "conti_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 50, daCenter, false, "sconti_cd", false, "", dfNone, 0, false, false);
	...
	case "sheet4":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtHiddenStatus, 30, daCenter, false, "Status");
			InitDataProperty(0, cnt++, dtSeq, 30, daCenter, false, "Seq");
			InitDataProperty(0, cnt++, dtData, 60, daCenter, false, "rgn_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 320, daLeft, false, "rgn_nm", false, "", dfNone, 0, false, false, 20);
	...
	case "sheet5":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 400, daLeft, false, "cnt_nm", false, "", dfNone, 0, false, false, 20);
	...
	case "sheet6":
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 60, daCenter, false, "cnt_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 200, daLeft, false, "cnt_nm", false, "", dfNone, 0, false, false, 20);

			InitDataProperty(0, cnt++, dtData, 60, daCenter, false, "conti_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 200, daCenter, false, "sconti_cd", false, "", dfNone, 0, false, false);
