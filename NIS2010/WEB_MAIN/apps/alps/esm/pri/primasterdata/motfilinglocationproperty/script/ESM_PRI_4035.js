...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_4035 : ESM_PRI_4035 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_4035() {
   	         ...
   	         case "sheet1":      //hidden 
                    with (sheetObj) {
                       ...
                       //전체Edit 허용 여부 [선택, Default false]
                        ...
                        var HeadTitle = "|Sel.|Del Check|Seq.|Ori/Dest|Location|File Location|File Location Name|Lane Code|Svc Scope|File Flag|DEL Flag|Creation Date|Update Date ";
                        ...
                        InitDataProperty(0, cnt++ , dtSeq,    		 50,    daCenter,   false,  "Seq");
   					 	InitDataProperty(0, cnt++ , dtCombo,		 90,	daCenter,	false,  "org_dest_tp_cd",	true,    "",  dfNone,	 0,  false,  true  );
   					 	InitDataProperty(0, cnt++ , dtPopupEdit,	 100,	daCenter,  	false,  "loc_cd",	 		true,    "",  dfNone,	 0,  false,  true  );
   					 	InitDataProperty(0, cnt++ , dtData,		     100,	daCenter,   false,  "mot_file_loc_cd", 	false,   "",  dfNone,	 0,  true,   true  );
   					 	InitDataProperty(0, cnt++ , dtData,		     210,	daLeft,  	false,  "mot_file_loc_nm",	false,   "",  dfNone,    0,  true,   true  );
   					 	InitDataProperty(0, cnt++ , dtComboEdit,     90,	daCenter,   false,  "mot_file_lane_cd", true,    "",  dfNone, 	 0,  true,	 true  );
   					 	InitDataProperty(0, cnt++ , dtComboEdit,	 90,	daCenter,   false,  "svc_scp_cd", 		false,   "",  dfNone,	 0,  true,   true  );
   					 ...
   					 //	InitDataCombo(0,"org_dest_tp_cd", orgDestCdText, orgDestCdValue);
            ...
            switch(sAction) {
   	       ...
   	       case IBCLEAR:
      	        sheetObjects[1].InitDataCombo(0,"org_dest_tp_cd", orgDestCdText, orgDestCdValue);	        
       	        sheetObjects[1].InitDataCombo(0,"mot_file_lane_cd", motFileLaneCdText, motFileLaneCdValue);	        
       	        sheetObjects[1].InitDataCombo(0,"svc_scp_cd", svcScopeCdText, svcScopeCdValue);	        
              ...
              case IBSAVE:        //저장
           	   formObj.f_cmd.value = MULTI;
   				...
   				try {
   					...
   					var sXml = sheetObjects[1].GetSaveXml("ESM_PRI_4035GS.do", sParam);
            	...
            	switch(colName)
            	{
        	    	case "loc_cd":
		    			...
		    			if (rtnVal != null) {                                                                                                                                                                                                                                                                                                                                                                                                                           
		    				...
		    				sheetObj.CellValue2(Row, "mot_file_loc_cd") = rtnVal.cd;                                                                                                                                                                                                                                                                                                                                                                                              
		    				sheetObj.CellValue2(Row, "mot_file_loc_nm") = rtnVal.nm;                                                                                                                                                                                                                                                                                                                                                                                              
		    			}                                                                                                                                                                                                                                                                                                                                                                                                                                               
    		...
    		if (sName == "loc_cd") {
    			if (Value.length == 5) {
    				...
    				if (arrDesc != null && arrDesc.length > 0) {
    					sheetObjects[1].CellValue2(Row, "mot_file_loc_cd") = Value;
    					sheetObjects[1].CellValue2(Row, "mot_file_loc_nm") = arrDesc[0][1];
    					
    				} else {
    					sheetObj.CellValue2(Row, "loc_cd") = "";
    					sheetObj.CellValue2(Row, "mot_file_loc_cd") = "";
    					sheetObj.CellValue2(Row, "mot_file_loc_nm") = "";
