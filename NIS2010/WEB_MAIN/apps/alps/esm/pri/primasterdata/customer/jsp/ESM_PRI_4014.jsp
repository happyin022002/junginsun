...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.customer.event.EsmPri4014Event"%>
...
<%
	...
	ui_id = JSPUtil.getNull(request.getParameter("ui_id")); //ui_id 가 0131_01일 경우
	cust_tp = JSPUtil.getNull(request.getParameter("cust_tp")); //ui_id 가 0131_01일 경우 호출 팝업이 Group Customer인지 Customer인지 구분
%>
<html>
<head>
...
<input type="hidden" name="cust_tp" value="<%=cust_tp%>">
<%
