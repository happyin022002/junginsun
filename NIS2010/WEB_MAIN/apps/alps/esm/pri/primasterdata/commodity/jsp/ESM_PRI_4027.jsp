...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.commodity.event.EsmPri4027Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.PRIMasterData.Commodity");
