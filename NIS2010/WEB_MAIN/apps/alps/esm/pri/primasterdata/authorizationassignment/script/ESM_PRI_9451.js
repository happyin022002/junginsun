 ...
 */
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_9451 : ESM_PRI_9451 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_9451() {
        ...
        switch(sheetID) {
            case "sheet1":
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                var HeadTitle1  = "|Office|Name|Y/N|Update\nDate(KST)|Update Staff|Update Staff";
				...
				InitDataProperty(0, cnt++ , dtData,    	100,   	daCenter,  	false,		"auth_apro_ofc_cd", false,   "",      dfNone,     0,			false,       	false);
				InitDataProperty(0, cnt++ , dtData,    	350,   	daLeft,  	false,		"auth_apro_desc",   	false,  "",      dfNone,     0,			false,       	false);
    ...
    function doActionIBSheet(sheetObj, formObj, sAction) {
        ...
        switch(sAction) {
            case IBSEARCH: //조회
                ...
                sheet1.DoSearch("ESM_PRI_9451GS.do", FormQueryString(formObj));
