...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.event.EsmPri4110Event"%>
...
<%
    EsmPri4110Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri4110Event)request.getAttribute("Event");
        ...
        trdCds = PRIUtil.getValueObject2StringArray((List<RsltCdListVO>)eventResponse.getCustomData("trdList"));
...
<script language="javascript">
    var trdComboValue = "|<%=trdCds[0]%>";
    var trdComboText = "|<%=trdCds[1]%>";
    ...
    <table class="search">
        ...
        <table border="0" style="width:979;" class="search">
                <tr class="h23">
                    ...
                    <td width="57" style="padding-left:2"><script language="javascript">ComComboObject('trd_cd', 2, 55, 0, 0, 0, false);</script></td>
                    <td width="343"><input name="trd_nm" type="text" style="width:295;"  value="" class="input2" readonly="readonly" caption="Service Scope">
                    </td>
