...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.event.EsmPri2038Event"%>
...
<html>
<head>
<title>Authority Creation</title>
    ...
    <table class="search">
        ...
        <table border="0" style="width:979;" class="search">
                <tr class="h23">
                    ...
                    <td width="380"><script language="javascript">ComComboObject('svc_scp_cd', 2, 55, 0, 1, 0, false);</script>
