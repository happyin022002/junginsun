 ...
 *@FileName : ESM_PRI_9251.js
 *@FileTitle : RFA Auth Hardcoding Management (Retro)
 *Open Issues :
 *Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.event.EsmPri9251Event"%>
...
<%
	...
	try {
		...
		event = (EsmPri9251Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Auth Hardcoding Management (Retro)</title>
