 ...
 *@FileName : ESM_PRI_4110.js
 *@FileTitle : Surcharge Authority Inquiry
 *Open Issues :
 *Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_4110 : ESM_PRI_4110 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_4110 () {
    ...
    function initIBComboItem () {
        ComPriTextCode2ComboItem(trdComboValue, trdComboText, getComboObject(comboObjects, 'trd_cd'),"|","\t");
    }
            ...
            case 2:      // sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    var HeadTitle = "ID|Name|Title|Trade|Effective Date|Authorized By|Update Date||";
                    var headCount = ComCountHeadTitle(HeadTitle);
                    ...
                    //데이터속성    [ROW, COL,  DATATYPE,   WIDTH, DATAALIGN, COLMERGE, SAVENAME,  KEYFIELD, CALCULOGIC, DATAFORMAT, POINTCOUNT, UPDATEEDIT, INSERTEDIT, EDITLEN, FULLINPUT, SORTENABLE, TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
                    InitDataProperty(0, cnt++ , dtData,          90,   daLeft,      true,    "usr_id",      false,  "",  dfNone,     0, false,  false);
                    InitDataProperty(0, cnt++ , dtData,          110,  daLeft,      true,    "usr_nm",      false,  "",  dfNone,     0, false,  false);
                    InitDataProperty(0, cnt++ , dtData,          170,  daLeft,      true,    "grd_eng_nm",  false,  "",  dfNone,     0, false,  false);
                    InitDataProperty(0, cnt++ , dtData,          68,   daCenter,    false,   "trd_cd",  false,  "",  dfNone,     0, false,  false);
                    InitDataProperty(0, cnt++ , dtData,          83,   daCenter,    false,   "eff_dt",      false,  "",  dfDateYmd,  0, false,  false);
                    InitDataProperty(0, cnt++ , dtData,          97,   daLeft,      false,   "upd_usr_nm",  false,  "",  dfNone,     0, false,  false);
                    InitDataProperty(0, cnt++ , dtData,          70,   daCenter,    false,   "upd_dt",      false,  "",  dfDateYmd,  0, false,  false);
                    InitDataProperty(0, cnt++ , dtHidden,        0,    daLeft,      false,   "prc_ctrt_tp_cd", false,  "",  dfNone,  0, false,  false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH_ASYNC01: // office code 입력 시, 사원콤보리스트 조회
                ...
                var sXml = sheetObj.GetSearchXml("ESM_PRI_4110GS.do", FormQueryString(formObj));
            ...
            case IBSEARCH:      //조회
                ...
                if (validateForm(sheetObj,formObj,sAction)) {
                    if (sheetObj.id == "sheet1") {
                        ...
                        sheetObj.DoSearch("ESM_PRI_4110GS.do", FormQueryString(formObj));
     ...
     * trd_cd 콤보에서 값을 변경하면 선택한 값에 대한 description을 보여준다. <br>
     * <br><b>Example :</b>
     * <pre>
     *
     * </pre>
    ...
    function trd_cd_OnChange (comboObj, code, text) {
        ...
        if (arrText != null && arrText.length > 1) {
            formObj.trd_nm.value = arrText[1];
            var ofcCd = formObj.ofc_cd.value; 
            if(ofcCd != ''){            	
            doActionIBSheet(sheetObjects[1], formObj, IBSEARCH);
            }
        } else {
            formObj.trd_nm.value = "";
        }
    }

    /**
     * IBMultiCombo에서 OnClear 이벤트 발생시 호출되는 function <br>
     * trd_cd 콤보데이터가 모두 삭제되면 trd_nm 항목도 clear한다. <br>
     * <br><b>Example :</b>
     * <pre>
     *
     * </pre>
     ...
     * @version 2009.08.17
     */
    function trd_cd_OnClear (comboObj) {
        var formObj = document.form;
        formObj.trd_nm.value = "";
     ...
     * trd_cd 콤보에서 포커스가 나가면 선택한 값에 대한 description을 보여준다. <br>
     * <br><b>Example :</b>
     * <pre>
     *
     * </pre>
     ...
     * @version 2009.08.17
     */
    function trd_cd_OnBlur(comboObj) {
        var formObj = document.form;
        ...
        if (code != null && code != "") {
            ...
            if (text != null && text != "" && text != formObj.trd_nm.value) {
                formObj.trd_nm.value = comboObj.GetText(code, 1);
            }
        }
    }
