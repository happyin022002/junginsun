...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_2057 : ESM_PRI_2057 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2057 () {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH_ASYNC01: // office code 입력 시, 사원콤보리스트 조회
                ...
                var sXml = sheetObj.GetSearchXml("ESM_PRI_2057GS.do", FormQueryString(formObj));
