<%@page import="com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.event.EsmPri925101Event"%>
<%
/*=========================================================
...
<%
	...
	try {
		...
		event = (EsmPri925101Event)request.getAttribute("Event");
...
<html>
<head>
<title>RFA Auth Hardcoding Management (Retro) - Office Level</title>
...
<input  type="hidden" name="prc_ofc_auth_tp_cd" value = "R">
