...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.event.EsmPri2057Event"%>
...
<html>
<head>
<title>RFA Authority Inquiry</title>
    ...
    <table class="search">
        ...
        <table border="0" style="width:979;" class="search">
                <tr class="h23">
                    ...
                    <td width=""><input type="text" name="cntr_usr_id" style="width:150;"  value="<%=strUsr_nm %>" class="input2" readonly="readonly"></td>
                </tr>
        </table>
        <table border="0" style="width:979;" class="search">
                <tr class="h23">
                    <td width="95">Service Scope</td>
                    <td width="380"><script language="javascript">ComComboObject('svc_scp_cd', 2, 55, 0, 0, 0, false);</script>
                    &nbsp;<input name="svc_scp_nm" type="text" style="width:291;"  value="" class="input2" readonly="readonly" caption="Service Scope">
                    </td>
