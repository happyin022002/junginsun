...
function initTab(tabObj, tabNo) {
	...
	case 1:
		with (tabObj) {
			var cnt = 0;
			InsertTab(cnt++, "Retroactive RFA Approval Auth(Office Level)", 0);
			InsertTab(cnt++, "Retroactive RFA Approval Auth(User Level)", 1);
			ShowIcon = false;
		}
		break;
	}
...
function loadTabPage(tabIndex) {
	...
	if (objTabWindow.location.href == "" || objTabWindow.location.href == "about:blank") {
		...
		switch (tabIndex) {
		case 0:
			sUrl = "ESM_PRI_9251_01.do";
			break;
		case 1:
			sUrl = "ESM_PRI_9251_02.do";
			break;
		}
