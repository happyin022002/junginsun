...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_0013 : ESM_PRI_0013 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0013 () {
            ...
            case 2:      // sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++ , dtData,          68,   daCenter,    false,   "svc_scp_cd",  false,  "",  dfNone,     0, false,  false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH_ASYNC01: // office code 입력 시, 사원콤보리스트 조회
                ...
                var sXml = sheetObj.GetSearchXml("ESM_PRI_0013GS.do", FormQueryString(formObj));
