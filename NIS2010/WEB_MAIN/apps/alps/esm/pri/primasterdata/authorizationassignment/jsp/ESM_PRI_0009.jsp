...
<%@ page import="com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.event.EsmPri0009Event"%>
    ...
    <table class="search">
        ...
        <table border="0" style="width:979;" class="search">
                <tr class="h23">
                    ...
                    <td width="57" style="padding-left:2;"><script language="javascript">ComComboObject('svc_scp_cd', 2, 55, 0, 1, 0, false);</script></td>
