...
*@FileName : ESM_PRI_9051_01.js
*@FileTitle : S/C Auth Hardcoding Management - S/C APVL OFC List
*Open Issues :
*Change history :
   ...
   */ 
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        case IBSEARCH:      //조회
        	...
        	ComOpenWait(true);   
        	sheetObj.RemoveAll();
        	var sXml = sheetObj.GetSearchXml("ESM_PRI_9051_01GS.do", FormQueryString(formObj) );
		 ...
		 case IBSAVE:        //저장
			//저장시 Row Add 대상으로 기존 것과 중복이 있는지 확인.
		 	...
		 	if (sheetObj.IsDataModified) {
		 	   sheetObj.DoSave("ESM_PRI_9051_01GS.do",FormQueryString(formObj) );			 	   
		 	} else {
    ...
    */      
    ...
    function sheet1_OnDblClick(sheetObj, Row, Col) {
        ...
        var popParams = "title=S/C APVL OFC List (History)&prc_ctrt_tp_cd="+prc_ctrt_tp_cd+"&prc_ofc_auth_tp_cd="+prc_ofc_auth_tp_cd+"&auth_apro_ofc_cd="+auth_apro_ofc_cd;
