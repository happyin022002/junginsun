...
/**
 * @extends 
 * @class ESM_PRI_9251_02 : ESM_PRI_9251_02 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_PRI_9251_02() {
...
*/ 
 ...
 function doActionIBSheet(sheetObj,formObj,sAction) {
     ...
     case IBSEARCH:      //조회
     	...
     	ComOpenWait(true);   
     	sheetObj.RemoveAll();
     	var sXml = sheetObj.GetSearchXml("ESM_PRI_9251_02GS.do", FormQueryString(formObj) );
		 ...
		 case IBSAVE:        //저장
			//저장시 Row Add 대상으로 기존 것과 중복이 있는지 확인.
		 	...
		 	if (sheetObj.IsDataModified) {
		 	   sheetObj.DoSave("ESM_PRI_9251_02GS.do",FormQueryString(formObj) );			 	   
		 	} else {
 ...
 */      
 ...
 function sheet1_OnDblClick(sheetObj, Row, Col) {
     ...
     var popParams = "title=RFA Auth Hardcoding Management (Retro) - User Level (History)&prc_ctrt_tp_cd="+prc_ctrt_tp_cd+"&prc_usr_auth_tp_cd="+prc_usr_auth_tp_cd+"&auth_apro_usr_id="+auth_apro_usr_id;
