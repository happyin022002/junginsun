...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_4012 : ESM_PRI_4012 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_4012 () {
        ...
        switch (sheetObj.id) {
            case "sheet1": // sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++, dtData, 50, daCenter, true, "vsl_slan_cd", false, "", dfNone);
                    InitDataProperty(0, cnt++, dtData, 0, daLeft, true, "vsl_slan_nm", false, "", dfNone);
    ...
    function returnSelectCode (sheetObj) {
        window.returnValue = sheetObj.CellValue(sheetObj.SelectRow, "vsl_slan_cd");
        window.close();
    }
