...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ficcostinterface.event.EsmPri7007Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri7007Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri7007Event) request.getAttribute("Event");
...
<html>
<head>
<title>Add-on(Ocean Feeder) tariff copying to other trade</title>
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp;Add-on(Ocean Feeder) tariff copying to other trade</td>
			</tr>
		</table>
	<!-- : ( Title ) (E) -->
