...
* 2013.07.26 전윤주 [CHM-201326002] Over weight, DG service flag가 'Y' 인 경우 버튼 파란색으로 표시        
                                   Retrieve 버튼 hidden 처리
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri700402Event"%>
...
<%
	EsmPri700402Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri700402Event)request.getAttribute("Event");
...
<html>
<head>   
<title>IHC inquiry in local currency (TRO) - Reefer Tab </title>
...
<input type="hidden" name="ihc_cgo_tp_cd" value="RF">  
<input type="hidden" name="cnt_cd">
<input type="hidden" name="zip_cd">
