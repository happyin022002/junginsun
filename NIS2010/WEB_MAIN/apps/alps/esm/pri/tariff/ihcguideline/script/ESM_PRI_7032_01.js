...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_PRI_7032_01 : ESM_PRI_7032_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_7032_01() {
        ...
        try{
            ...
            case SEARCH01:   // retrieve sheet 
            	ComOpenWait(true); //->waiting->start
	 			...
	 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7032_01GS.do", FormQueryString(formObj));	 	 	 
        	 ...
        	 with (sheetObj) {
                ...
                //전체Edit 허용 여부 [선택, Default false]
 				...
 				var HeadTitle1 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|" +
 									 "Dry Tariff (USD)|Dry Tariff (USD)|Dry Tariff (USD)|Dry Tariff (USD)|Dry Tariff (USD)|Dry Tariff (USD)|Diff. (USD)|Diff. (USD)|Diff. (USD)|Diff. (USD)|Diff. (USD)|Diff. (USD)|Total Cost (USD)|Total Cost (USD)|Total Cost (USD)|Total Cost (USD)|Total Cost (USD)|Total Cost (USD)|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  
 				var HeadTitle2 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|" +
 									 "20'|20'|20'|40'|40'|40'|20'|20'|20'|40'|40'|40'|20'|20'|20'|40'|40'|40'|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  		
 				var HeadTitle3 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|" +
 									 "Rail|Truck|Total|Rail|Truck|Total|Rail|Truck|Total|Rail|Truck|Total|Rail|Truck|Total|Rail|Truck|Total|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";   
