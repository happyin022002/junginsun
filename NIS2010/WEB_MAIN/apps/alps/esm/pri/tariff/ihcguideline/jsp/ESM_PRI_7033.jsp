...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri7033Event"%>
...
<%
	EsmPri7033Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri7033Event)request.getAttribute("Event");
...
<html>
<head>   
<title>US Commercial Rail Add-on</title>
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp;US Commercial Rail Add-on</td>
			</tr>
		</table>
	<!-- : ( Title ) (E) -->
       	...
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn1" name="btn_retrieve">Route Retrieve</td>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				<tr><td class="btn1_left"></td>
				<td class="btn1" name="btn_apply_to_tariff">Apply to Tariff</td>
				<td class="btn1_right"></td>
				</tr></table></td>						
			</tr>
			</table>
