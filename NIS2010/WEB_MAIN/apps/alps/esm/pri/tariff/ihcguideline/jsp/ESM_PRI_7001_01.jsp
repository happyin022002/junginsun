...
*@FileName : ESM_PRI_7001_01.jsp
*@FileTitle : IHC Tariff Creation & Amendment - Dry Tab
*Open Issues :
*Change history :
*@LastModifyDate : 2012.10.07
...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri700101Event"%>
...
<%
	EsmPri700101Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri700101Event)request.getAttribute("Event");
...
<html>
<head>   
<title>IHC Tariff Creation & Amendment - Dry Tab</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<!--biz page (S)-->
			...
			<tr class="h23">                                                                                                                                                                                                              
				<td width="260"><input type="checkbox" name="node_code_flg" value="Y" class="trans">Node Code</td>  
				<td width="190">Tariff Rate Adjustment : 20'</td>
				...
				<td width="60"><input type="text" style="width:50;text-align:center;" class="input" name="flat_percent_45_app" maxlength="6" dataformat="apply"></td>
				<!-- 45' Cost 추가 end -->
