...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri703202Event"%>
...
<%
	EsmPri703202Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri703202Event)request.getAttribute("Event");
...
<html>
<head>   
<title>Inland add-on amendment history - Reefer Tab</title>
