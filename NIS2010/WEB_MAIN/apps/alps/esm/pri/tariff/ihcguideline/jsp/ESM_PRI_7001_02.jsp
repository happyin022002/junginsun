...
*@FileName : ESM_PRI_7001_02.jsp
*@FileTitle : IHC Tariff Creation & Amendment - Reefer Tab
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri700102Event"%>
...
<%
	EsmPri700102Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri700102Event)request.getAttribute("Event");
...
<html>
<head>   
<title>IHC Tariff Creation & Amendment - Reefer Tab</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<!--biz page (S)-->
			...
			<tr class="h23">                                                                                                                                                                                                              
				<td width="400"><input type="checkbox" name="node_code_flg" value="Y" class="trans">Node Code</td>  
