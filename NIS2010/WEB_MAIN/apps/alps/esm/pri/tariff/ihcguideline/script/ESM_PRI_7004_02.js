...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_PRI_7004_02 : ESM_PRI_7004_02 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_7004_02() {
    ...
    function doActionIBSheet(sheetObj, formObj, sAction) {
        ...
        try{
            ...
            case SEARCH01:   // retrieve sheet 
	 			...
	 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7004_02GS.do", FormQueryString(formObj));	 	 	 
        ...
        case "sheet1":
        	 with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                 ...
                 var HeadTitle1 = "|Seq.|Point|Postal\nCode|LOC\nGroup|Description|Hub|Base\nPort|Trans\nMode|Term|Tariff(Local Currency)|Tariff(Local Currency)|Tariff(Local Currency)|Tariff(USD)|Tariff(USD)|IHC_TRF_NO|ORG_DEST_TP_CD|SVC_SCP_CD|OVR_WGT_CGO_SVC_FLG";
     			 var HeadTitle2 = "|Seq.|Point|Postal\nCode|LOC\nGroup|Description|Hub|Base\nPort|Trans\nMode|Term|Curr.|RF|RF|RF|RF|IHC_TRF_NO|ORG_DEST_TP_CD|SVC_SCP_CD|OVR_WGT_CGO_SVC_FLG";
     			 var HeadTitle3 = "|Seq.|Point|Postal\nCode|LOC\nGroup|Description|Hub|Base\nPort|Trans\nMode|Term|Curr.|20'|40'|20'|40'|IHC_TRF_NO|ORG_DEST_TP_CD|SVC_SCP_CD|OVR_WGT_CGO_SVC_FLG";
                 ...
                 InitDataProperty(0, cnt++, dtHiddenStatus, 	30, 	daCenter,	true, "ibflag");
     			 ...
     			 InitDataProperty(0, cnt++, dtData, 			140, 	daLeft, 	true, "pnt_loc_cd_nm", 					false, "", dfNone, 0, false, false);
    			 ...
    			 InitDataProperty(0, cnt++, dtData, 			80, 	daRight, 	true, "gline_locl_curr_rf_20ft_amt", 	false, "", dfNullFloat, 2, false, false);
    			 InitDataProperty(0, cnt++, dtData, 			80, 	daRight, 	true, "gline_locl_curr_rf_40ft_amt", 	false, "", dfNullFloat, 2, false, false);
     			 InitDataProperty(0, cnt++, dtData, 			80, 	daRight, 	true, "gline_rf_20ft_frt_rt_amt", 		false, "", dfNullFloat, 2, false, false);
     			 InitDataProperty(0, cnt++, dtData, 			80, 	daRight, 	true, "gline_rf_40ft_frt_rt_amt", 		false, "", dfNullFloat, 2, false, false);
     			 ...
     			 InitDataProperty(0, cnt++, dtHidden,			100, 	daCenter, 	true, "org_dest_tp_cd",                 false, "", dfNone, 0, false, false); 
      			 ...
      			 sheetObj.SetMergeCell (1, 11, 1, 2); 
      			 sheetObj.SetMergeCell (1, 13, 1, 2); 
