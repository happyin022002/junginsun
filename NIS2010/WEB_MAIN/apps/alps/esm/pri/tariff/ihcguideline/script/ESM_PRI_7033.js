...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_PRI_7033 : ESM_PRI_7033 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_7033() {
    ...
    */
    function loadPage() {
        ...
        initControl();   
        if(formObj.fic_prop_sts_cd.value == 'I'){
        	buttonControl("LOAD");   
        }else{
        	buttonControl("READ");   
        }
        ...
        try{
            ...
            case SEARCH01:   // retrieve sheet 
            	ComOpenWait(true); //->waiting->start
	 			...
	 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7033GS.do", FormQueryString(formObj));	 	 	 
				...
				if (sheetObj.RowCount > 0) {
		            ...
		            for(var i = sheetObj.LastRow; i >= sheetObj.HeaderRows; i--){
						if(sheetObjects[0].CellValue(i, 'hub_loc_cd') == "" && sheetObjects[0].CellValue(i, 'bse_port_loc_cd') == "" && 
						   sheetObjects[0].CellValue(i, 'gline_20ft_rail_frt_rt_amt') == "0" && sheetObjects[0].CellValue(i, 'gline_40ft_rail_frt_rt_amt') == "0"){
			...
			case MULTI01: // Add
                ...
                sheetObjects[0].CellValue(iRow, 'rcv_de_term_cd') = formObj.rcv_de_term_cd.value;
                sheetObjects[0].SelectCell(iRow, "hub_loc_cd");
                buttonControl("ADD");   
				break;		
            ...
            case IBSAVE: // Save                  
                ...
                sParam = sParam + "&" + sParamSheet1;
	 			var sXml = sheetObj.GetSaveXml("ESM_PRI_7033GS.do", sParam);	
        ...
        case "sheet1":
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
				...
				var HeadTitle1 = "ibflag|Sel.|Seq|Point|Description|Term|Base\nPort|Rate (USD)|Rate (USD)|Cost (USD)|Cost (USD)|" +
								 "IHC_TRF_NO|AMDT_SEQ|SVC_SCP_CD|ORG_DEST_TP_CD|IHC_CGO_TP_CD";    
				var HeadTitle2 = "ibflag|Sel.|Seq|Point|Description|Term|Base\nPort|20'|40'|20'|40'|" +
								 "IHC_TRF_NO|AMDT_SEQ|SVC_SCP_CD|ORG_DEST_TP_CD|IHC_CGO_TP_CD";  	
                ...
                InitDataProperty(0, cnt++, 	dtData, 				50, 		daCenter, 	true, 	"hub_loc_cd", true, "", dfNone, 0, true, true);                                    
                ...
                InitDataProperty(0, cnt++, 	dtData,				50, 		daCenter, 	true, 	"bse_port_loc_cd", true, "", dfNone, 0, true, true);       
                InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_20ft_rail_frt_rt_amt", true, "", dfInteger, 0, true, true, 7);
                InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_40ft_rail_frt_rt_amt", true, "", dfInteger, 0, true, true, 7);
                InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"cost_20ft_rail_frt_rt_amt", false, "", dfInteger, 0, false, false, 7);
                InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"cost_40ft_rail_frt_rt_amt", false, "", dfInteger, 0, false, false, 7);
        ...
        case SEARCH03:   // check
            ...
            for(var i = sheetObj.HeaderRows; i <= sheetObj.LastRow; i++){
            	if(sheetObj.CellValue( i , "gline_20ft_rail_frt_rt_amt") == "0" ){
            		add2Tooltip(i, 'gline_20ft_rail_frt_rt_amt', msgs['PRI01125']);
            		isClear = false;
            	}
            	
            	if(sheetObj.CellValue( i , "gline_40ft_rail_frt_rt_amt") == "0" ){
            		add2Tooltip(i, 'gline_40ft_rail_frt_rt_amt', msgs['PRI01125']);
            		isClear = false;
            	}
            	
            	if(sheetObj.CellValue( i , "gline_20ft_rail_frt_rt_amt") != ""){
    		...
    		formObj.f_cmd.value = SEARCH03;
 			...
 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7033GS.do", sParam);	
 	       ...
 	       if (isClear) {
        	   ComBtnEnable("btn_apply_to_tariff"); 
        	   return false;
           }else{
 	    	   ComBtnDisable("btn_apply_to_tariff");               
               return true;
           }
            break;
        }
...
/**
    ...
    */ 
 	function buttonControl(mode) {			
 		...
 		case "READ":	// NOT Initial, read only			
