...
*@FileName : ESM_PRI_7025_01.js
*@FileTitle : IHC Tariff Amendment History - Dry Tab
*Open Issues :
*Change history :
...
=========================================================
* History              
* 2013.02.07 [CHM-201322859] 서미진 weight 컬럼 추가 - 현재 hidden 처리하여 반영       
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_PRI_7025_01 : ESM_PRI_7025_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_7025_01() {
        ...
        try{
            ...
            case SEARCH01:   // retrieve sheet 
            	ComOpenWait(true); //->waiting->start
	 			...
	 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7025_01GS.do", FormQueryString(formObj));	 	 	 
	 			...
	 			if(formObj.rhq_cd.value == "HAMRU"){
	 				...
	 				|| formObj.svc_scp_cd.value == "EAN" || formObj.svc_scp_cd.value == "EAS"){
	 	                ...
	 	                sheetObjects[0].CellValue2( 0 , 'gline_locl_curr_45ft_amt') = "Tariff ("+ formObj.locl_curr_cd.value+")";			//45'
	 	                sheetObjects[0].CellValue2( 0 , 'gline_locl_curr_dg_20ft_amt') = "Tariff ("+ formObj.locl_curr_cd.value+")";
	 	                sheetObjects[0].CellValue2( 0 , 'gline_locl_curr_dg_40ft_amt') = "Tariff ("+ formObj.locl_curr_cd.value+")";
	 	                sheetObjects[0].CellValue2( 0 , 'gline_locl_curr_dg_45ft_amt') = "Tariff ("+ formObj.locl_curr_cd.value+")";		//45'
	 	                sheetObjects[0].CellValue2( 1 , 'diff_locl_20ft') = formObj.locl_curr_cd.value;
	 	                sheetObjects[0].CellValue2( 1 , 'diff_locl_40ft') = formObj.locl_curr_cd.value;
	 	                sheetObjects[0].CellValue2( 1 , 'diff_locl_45ft') = formObj.locl_curr_cd.value;												//45'
	 	                sheetObjects[0].CellValue2( 1 , 'locl_curr_cost_20ft_frt_rt_amt') = formObj.locl_curr_cd.value;
	 	                sheetObjects[0].CellValue2( 1 , 'locl_curr_cost_40ft_frt_rt_amt') = formObj.locl_curr_cd.value;
	 	                sheetObjects[0].CellValue2( 1 , 'locl_curr_cost_45ft_frt_rt_amt') = formObj.locl_curr_cd.value;						//45'
	 					
	 					sheetObjects[0].ColHidden("gline_20ft_frt_rt_amt") = true;
	 					sheetObjects[0].ColHidden("gline_40ft_frt_rt_amt") = true;
	 					sheetObjects[0].ColHidden("gline_45ft_frt_rt_amt") = true;																		//45'
	 					sheetObjects[0].ColHidden("gline_locl_curr_20ft_amt") = false;
	 					sheetObjects[0].ColHidden("gline_locl_curr_40ft_amt") = false;
	 					sheetObjects[0].ColHidden("gline_locl_curr_45ft_amt") = false;																//45'
	 					sheetObjects[0].ColHidden("diff_20ft") = true;
	 					sheetObjects[0].ColHidden("diff_40ft") = true;
	 					sheetObjects[0].ColHidden("diff_45ft") = true;																						//45'
	 					sheetObjects[0].ColHidden("diff_locl_20ft") = false;
	 					sheetObjects[0].ColHidden("diff_locl_40ft") = false;
	 					sheetObjects[0].ColHidden("diff_locl_45ft") = false;																				//45'	
	 					sheetObjects[0].ColHidden("cost_20ft_frt_rt_amt") = true;
	 					sheetObjects[0].ColHidden("cost_40ft_frt_rt_amt") = true;
	 					sheetObjects[0].ColHidden("cost_45ft_frt_rt_amt") = true;																		//45'	
	 					sheetObjects[0].ColHidden("locl_curr_cost_20ft_frt_rt_amt") = false;
	 					sheetObjects[0].ColHidden("locl_curr_cost_40ft_frt_rt_amt") = false;
	 					sheetObjects[0].ColHidden("locl_curr_cost_45ft_frt_rt_amt") = false;														//45'	
	 				}
	 			}
...
//  				var HeadTitle1 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|" +
//								 "Diff.|Diff.|Diff.|Diff.|Total Cost|Total Cost|Total Cost|Total Cost|Max cargo weight\nw/o surcharge (Ton)|Max cargo weight\nw/o surcharge (Ton)|EFF Date|EXP Date|Source|" +
//								 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  
//				var HeadTitle2 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|Dry|Dry|DG|DG|Dry|Dry|DG|DG|" +
//								 "USD |USD |USD |USD |USD|USD|USD|USD|Max cargo weight\nw/o surcharge (Ton)|Max cargo weight\nw/o surcharge (Ton)|EFF Date|EXP Date|Source|" +
//								 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  		
//				var HeadTitle3 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|20'|40'|20'|40'|20'|40'|20'|40'|" +
//								 "20'|40'|20'|40'|20'|40'|20'|40'|20'|40'|EFF Date|EXP Date|Source|" +
//								 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";   
                 
                 
 				var HeadTitle1 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|" +
 									 "Diff.|Diff.|Diff.|Diff.|Diff.|Diff.|Total Cost|Total Cost|Total Cost|Total Cost|Total Cost|Total Cost|Max cargo weight\nw/o surcharge (Ton)|Max cargo weight\nw/o surcharge (Ton)|Max cargo weight\nw/o surcharge (Ton)|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  
 				var HeadTitle2 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|Dry|Dry|Dry|DG|DG|DG|Dry|Dry|Dry|DG|DG|DG|" +
 									 "USD |USD |USD |USD |USD|USD|USD|USD|USD|USD|USD|USD|Max cargo weight\nw/o surcharge (Ton)|Max cargo weight\nw/o surcharge (Ton)|Max cargo weight\nw/o surcharge (Ton)|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  		
 				var HeadTitle3 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|20'|40'|45'|20'|40'|45'|20'|40'|45'|20'|40'|45'|" +
 									 "20'|40'|45'|20'|40'|45'|20'|40'|45'|20'|40'|45'|20'|40'|45'|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";   
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				160, 		daLeft,	 	true, 	"pnt_loc_nm",                  				false, "", dfNone, 0, false, false);                                 
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_45ft_frt_rt_amt",       				false, "", dfFloat, 2, false, false, 9);  		//45'
     		 	 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight, 		true, 	"gline_dg_20ft_frt_rt_amt",    			false, "", dfNullFloat, 2, false, false);
     		     InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_dg_40ft_frt_rt_amt",    			false, "", dfNullFloat, 2, false, false);
     		     InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_dg_45ft_frt_rt_amt",    			false, "", dfNullFloat, 2, false, false);		//45'
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_locl_curr_45ft_amt",       			false, "", dfFloat, 2, false, false, 9);		//45'
     		 	 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight, 		true, 	"gline_locl_curr_dg_20ft_amt",   		 	false, "", dfNullFloat, 2, false, false);
     		     InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_locl_curr_dg_40ft_amt",    		false, "", dfNullFloat, 2, false, false);
     		     InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"gline_locl_curr_dg_45ft_amt",    		false, "", dfNullFloat, 2, false, false);		//45'
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight, 		true, 	"diff_45ft",	               						false, "", dfNone, 0, false, false);			//45'
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight, 		true, 	"diff_locl_45ft",	               				false, "", dfNone, 0, false, false);			//45'
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"cost_45ft_frt_rt_amt",        				false, "", dfNullFloat, 2, false, false, 9);	//45'
                 ...
                 InitDataProperty(0, cnt++, 	dtData, 				80, 		daRight,		true, 	"locl_curr_cost_45ft_frt_rt_amt",        false, "", dfNullFloat, 2, false, false, 9); 	//45'
     			 ...
     			 InitDataProperty(0, cnt++, 	dtData, 				80,		daRight, 		true, 	"trsp_45ft_agmt_wgt", 	       				false, "", dfNullFloat, 2, false, false, 9);	//45'
    ...
    */      
     ...
     * @version 2009.05.21
     */ 
	function tabLoadSheet(sIhcTrfNo, sAmdtSeq, sSvcScpCd, sOrgDestTpCd, sDetailTp, sRhqCd, sLoclCurrCd) {
		var formObject = document.form;
		if (formObject.ihc_trf_no.value != sIhcTrfNo || formObject.amdt_seq.value != sAmdtSeq || formObject.svc_scp_cd.value != sSvcScpCd 
		  || formObject.org_dest_tp_cd.value != sOrgDestTpCd || formObject.detail_tp.value != sDetailTp || formObject.rhq_cd.value != sRhqCd || formObject.locl_curr_cd.value != sLoclCurrCd) {
			...
			formObject.detail_tp.value = sDetailTp;
			formObject.rhq_cd.value = sRhqCd;
			formObject.locl_curr_cd.value = sLoclCurrCd;
			sheetObjects[0].RemoveAll();      
        	if(formObject.detail_tp.value == "1"){
        		sheetObjects[0].ColHidden('eff_dt') = true;
            	sheetObjects[0].ColHidden('exp_dt') = true;
        	}else{
        		sheetObjects[0].ColHidden('eff_dt') = false;
            	sheetObjects[0].ColHidden('exp_dt') = false;
        	} 
			if(formObject.detail_tp.value != "2" || formObject.amdt_seq.value != "0"){			
				doActionIBSheet(sheetObjects[0], document.form,SEARCH01);
			}
		}
	}
    ...
    function setLineStyle(sheetObj, idx) {
    	...
    	if (sheetObj.CellValue(idx, "amdt_seq") != document.form.amdt_seq.value) {
    		if(formObject.detail_tp.value == "2"){
    ...
    function sheet1Allclear() {
		...
		sheetObjects[0].ColHidden("cost_45ft_frt_rt_amt") = false;					//45'
    	sheetObjects[0].ColHidden("locl_curr_cost_20ft_frt_rt_amt") = true;
    	sheetObjects[0].ColHidden("locl_curr_cost_40ft_frt_rt_amt") = true;   	
    	sheetObjects[0].ColHidden("locl_curr_cost_45ft_frt_rt_amt") = true;		//45'
    }
			...
			case 'D' :		
	 			if(formObj.rhq_cd.value == "HAMRU"){
	 				...
	 				|| formObj.svc_scp_cd.value == "EAN" || formObj.svc_scp_cd.value == "EAS"){
	 					...
	 					sheetObj.ColHidden('gline_locl_curr_45ft_amt') = checked;			//45'
	 				}else{
	 					sheetObj.ColHidden('gline_20ft_frt_rt_amt') = checked;
	 					sheetObj.ColHidden('gline_40ft_frt_rt_amt') = checked;
	 					sheetObj.ColHidden('gline_45ft_frt_rt_amt') = checked;				//45'
	 				}
	 			}else{
					sheetObj.ColHidden('gline_20ft_frt_rt_amt') = checked;
					sheetObj.ColHidden('gline_40ft_frt_rt_amt') = checked;
			...
			case 'G' :
	 			if(formObj.rhq_cd.value == "HAMRU"){
	 				...
	 				|| formObj.svc_scp_cd.value == "EAN" || formObj.svc_scp_cd.value == "EAS"){
	 					...
	 					sheetObj.ColHidden('gline_locl_curr_dg_45ft_amt') = checked;						//45'
	 				}else{
	 					sheetObj.ColHidden('gline_dg_20ft_frt_rt_amt') = checked;
	 					sheetObj.ColHidden('gline_dg_40ft_frt_rt_amt') = checked;
	 					sheetObj.ColHidden('gline_dg_45ft_frt_rt_amt') = checked;							//45'
	 				}
	 			}else{
					sheetObj.ColHidden('gline_dg_20ft_frt_rt_amt') = checked;
					sheetObj.ColHidden('gline_dg_40ft_frt_rt_amt') = checked;
