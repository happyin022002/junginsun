...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri702501Event"%>
...
<%
	EsmPri702501Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri702501Event)request.getAttribute("Event");
...
<input type="hidden" name="detail_tp">
