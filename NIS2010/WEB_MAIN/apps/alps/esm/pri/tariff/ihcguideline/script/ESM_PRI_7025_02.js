        ...
        case "sheet1":
        	 with (sheetObj) {
                ...
                //전체Edit 허용 여부 [선택, Default false]
 				...
 				var HeadTitle1 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|Tariff (USD)|Tariff (USD)|Tariff (USD)|Tariff (USD)|" +
 									 "Diff.|Diff.|Diff.|Diff.|Total Cost|Total Cost|Total Cost|Total Cost|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  
 				var HeadTitle2 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|RF|RF|RF|RF|" +
 									 "USD |USD |USD |USD |USD|USD|USD|USD|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";  		
 				var HeadTitle3 = "ibflag|Seq|RTSeq|Point|Description|Hub|Base\nPort|Term|Trans\nMode|20'|40'|20'|40'|" +
 									 "20'|40'|20'|40'|20'|40'|20'|40'|EFF Date|EXP Date|Source|" +
 									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD";   
