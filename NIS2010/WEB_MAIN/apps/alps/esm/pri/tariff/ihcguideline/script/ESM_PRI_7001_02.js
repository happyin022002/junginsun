...
*@FileName : ESM_PRI_7001_02.js
*@FileTitle : IHC Tariff Creation & Amendment - Reefer
*Open Issues :
*Change history :
...
* 2014.09.01 최성환 [CHM-201431603] doActionIBSheet - MULTI07 Operation 계산상의 컬럼 선택 로직 수정
=========================================================*/ 
/**************************************************************************************** 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_PRI_7001_02 : ESM_PRI_7001_02 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_7001_02() {
        ...
        try{
            ...
            case SEARCH01:   // retrieve sheet 
            	...
            	clearAllgridForms();
	 			...
	 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7001_02GS.do", FormQueryString(formObj));	 	 	 
            ...
            case IBSAVE: // Save                  
                ...
                var sXml = sheetObjects[0].DoSave("ESM_PRI_7001_02GS.do", sParam, -1, false );  
        		ComOpenWait(false); //->waiting->End
            ...
            case MULTI07: // Apply          
            	...
            	for (var i = star_idex ; i < all_row ; i++ ){
            		if(sheetObjects[0].CellValue( i, "amdt_seq") != sheetObjects[0].CellValue( i, "n1st_cmnc_amdt_seq") ){
        		        ...
        		        //IHC tariff tariff adjustment 로직 변경 
        ...
        case "sheet1":
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
				...
				var HeadTitle1 = "ibflag|Sel.|Seq|RTSeq|Point|Node Point|Description|Hub|Node Hub|Base\nPort|Node Base\nPort|Contract\nTerm|Trans\nMode|Tariff (USD)|Tariff (USD)|Tariff (LOCAL)|Tariff (LOCAL)|" +
									 "Diff. (USD)|Diff. (USD)|Diff. (LOCAL)|Diff. (LOCAL)|Total Cost|Total Cost|Total Cost|Total Cost|Total Cost|EFF Date|EXP Date|Source|" +
				...
				var HeadTitle2 = "ibflag|Sel.|Seq|RTSeq|Point|Node Point|Description|Hub|Node Hub|Base\nPort|Node Base\nPort|Contract\nTerm|Trans\nMode|Tariff (USD)|Tariff (USD)|Tariff (LOCAL)|Tariff (LOCAL)|" +
									 "Diff. (USD)|Diff. (USD)|Diff. (LOCAL)|Diff. (LOCAL)|USD|USD|Local Currency|Local Currency|Local Currency|EFF Date|EXP Date|Source|" +
									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD|PRC_TRF_CRE_TP_CD|ORG_DEST_TP_CD|IHC_CGO_TP_CD";   		
				var HeadTitle3 = "ibflag|Sel.|Seq|RTSeq|Point|Node Point|Description|Hub|Node Hub|Base\nPort|Node Base\nPort|Contract\nTerm|Trans\nMode|20'|40'|20'|40'|" +
									 "20'|40'|20'|40'|20'|40'|Cur.|20'|40'|EFF Date|EXP Date|Source|" +
									 "IHC_TRF_NO|AMDT_SEQ|N1ST_CMNC_AMDT_SEQ|SVC_SCP_CD|PRC_TRF_CRE_TP_CD|ORG_DEST_TP_CD|IHC_CGO_TP_CD";     
                ...
                sheetObj.SetMergeCell (0, 17, 2, 2);  
                sheetObj.SetMergeCell (0, 19, 2, 2);  
    ...
    */
    function validateForm(sheetObj, formObj, sAction) {
        ...
        case IBSAVE: // Save        
            ...
            var sXml = sheetObj.GetSearchXml("ESM_PRI_7001_02GS.do", sParam);  
            var arrData  = ComPriXml2Array(sXml, "pnt_loc_cd|bse_port_loc_cd|rcv_de_term_cd");      
            if(arrData != undefined){
            	var chkArr = ComPriSheetFilterRows(sheetObjects[0], "pnt_loc_cd|bse_port_loc_cd|rcv_de_term_cd", arrData[0][0]+"|"+arrData[0][1]+"|"+arrData[0][2]);
            	sheetObjects[0].SelectCell( chkArr , "pnt_loc_cd" );
