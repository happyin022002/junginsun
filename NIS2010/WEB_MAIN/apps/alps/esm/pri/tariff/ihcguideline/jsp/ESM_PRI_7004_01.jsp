...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri700401Event"%>
...
<%
	EsmPri700401Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri700401Event)request.getAttribute("Event");
...
<html>
<head>   
<title>IHC inquiry in local currency (TRO) - Dry Tab </title>
...
<input type="hidden" name="ihc_cgo_tp_cd" value="DR"> 
