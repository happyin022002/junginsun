...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.ihcguideline.event.EsmPri703102Event"%>
...
<%
	EsmPri703102Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri703102Event)request.getAttribute("Event");
...
<html>
<head>   
<title>Inland Add-on Creation & Amendment - Reefer tab</title>
