...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.tariffcode.event.EsmPri3503Event"%>
...
<html>
<head>
<title>Tariff Code Inquiry</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
			...
			<tr class="h23">
				...
				<td width="160"><script language="javascript">ComComboObject("tariff_cd", 2, 100, 0, 0, 0, false);</script></td>
