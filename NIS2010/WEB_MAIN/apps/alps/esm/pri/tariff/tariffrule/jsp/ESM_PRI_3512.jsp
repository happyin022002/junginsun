...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.tariffrule.event.EsmPri3512Event"%>
...
<html>
<head>
<title>Tariff Rule Inquiry</title>
...
<script language="javascript">
	...
	var trfRuleStsCdComboValue = "|<%=trfRuleStsCd[0]%>".replace("|R", ""); //Returned 항목 제외
	var trfRuleStsCdComboText = "|<%=trfRuleStsCd[1]%>".replace("|Returned","");//Returned 항목 제외
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:0;,padding-bottom:2;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_openc">Open Creation</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td class="btn1_line"></td>
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
			...
			<table class="search" border="0" style="width:979;"> 
			<tr class="h23">
				<td width="190"><table border="0" cellpadding="0" cellspacing="0"><tr class="h23">						
					<td width="80">Tariff Code</td>
					<td width="110"><script language="javascript">ComComboObject("tariff_cd", 2, 100, 0, 1, 0, false);</script></td>
				</table></td>
				<td width="170"><table border="0" cellpadding="0" cellspacing="0"><tr class="h23">						
					<td width="50">Status</td>
					<td width="110"><script language="javascript">ComComboObject("trf_rule_sts_cd", 1, 100, 0, 0, 0, false);</script></td>
				</table></td>
				<td width="170"><table border="0" cellpadding="0" cellspacing="0"><tr class="h23">						
					<td width="55">Rule No.</td>
					<td width="100"><input type="text" name="trf_rule_no" maxlength="10" style="width:100%;text-align: center;ime-mode:disabled;" class="input" dataformat="engup" value=""></td>
				</table></td>
				<td><table border="0" cellpadding="0" cellspacing="0"><tr class="h23">						
					<td width="85">Search Word</td>
					<td width="250"><input type="text" name="trf_rule_ctnt" maxlength="50" style="width:100%;ime-mode:disabled;" class="input" dataformat=""  value=""></td>
				</table></td>				
			</tr>
			</table>	
			...
			<table class="search" border="0" style="width:979;"> 
				...
				<td width="100%">
					  ...
					  <table class="search" border="0">
				        ...
				        <tr><td><textarea name="rule_ctnt" id="rule_ctnt" class="" style="text-indent:0px; width:100%; height:190; font-family:Lucida Console; padding-right:500px; overflow-y:scroll;" readonly></textarea></td></tr>
					  
				   <!--     <tr><td><textarea name="rule_ctnt" id="rule_ctnt" class="" style="text-indent: 0px;width:480; height:190; font-family:Lucida Console; padding-right:12px;" readonly></textarea> </td></tr>
				      --> 
