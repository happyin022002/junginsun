...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_3505 : ESM_PRI_3505 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_3505() {
            ...
            case "sheet1":      //t1sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++, dtHidden,     	150,daCenter, 	false, 	"trf_bzc_sts_cd",		false, 	"", dfNone, 	0, 	false,  false);
                    InitDataProperty(0, cnt++, dtHidden,   		120,daCenter, 	false,  "pre_pub_dt", 			false, 	"", dfDateYmd, 	0, 	false, 	false);
            ...
            case IBSAVE:        //저장 			 	
 			 	...
 			 	var pubDt = sheetObj.CellValue(sRow, "pub_dt");
 	   			...
 	   			if(ret > 0) {
	 	   			...
	 	   			sheetObj.DoAllSave("ESM_PRI_3505GS.do", "f_cmd=" + MODIFY05);
 	   			} else {
     ...
     */
   	function validateForm(sheetObj, formObj, sAction) {
   		...
   		case IBSAVE: // 저장
		 	...
		 	var pubDt = sheetObj.CellValue(sRow, "pub_dt");
		 	var prePubDt = sheetObj.CellValue(sRow, "pre_pub_dt");
   			var ret = ComGetDaysBetween(effDt, pubDt);
 	...
 	function sheet1_OnSearchEnd(sheetObj, errMsg){
		...
		sheetObj.Cellvalue2(sheetObj.SelectRow, "trf_bzc_sts_cd") = "F"; //Publish
