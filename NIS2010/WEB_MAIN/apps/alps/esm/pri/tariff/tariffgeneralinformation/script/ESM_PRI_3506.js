...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_3506 : ESM_PRI_3506 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_3506() {
...
//		Rdviewer.DisableToolbar (1); 
	...
	*/	    
    function rdOpen(rdObject,formObj){
    	...
    	var path  = "apps/alps/esm/pri/tariff/tariffgeneralinformation/report/ESM_PRI_3506.mrd";
    	             
    	var param = "/rp ["+formObj.trf_pfx_cd.value+"] ["+formObj.trf_no.value+"] ["+formObj.amdt_seq.value +"] [Y] [Y] /rxlspagezoom [95]";
...
//    	RD_path = "http://localhost:7001/hanjin/";
	...
	*/		
	function controlTools(formObj){
        var Rdviewer = rdObjects[0];
		var file_nm = formObj.trf_pfx_cd.value + "-" + formObj.trf_no.value;
