...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_3518 : ESM_PRI_3518 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_3518() {
        ...
        case "sheet1":      //t1sheet1 init
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                var HeadTitle = "|Amend No.|Effective Date|1|2|3|4|5|6";
                ...
                InitDataProperty(0, cnt++, dtHidden,     	150,daCenter, 	true,  	"bef_eff_dt",	 		true,  	"", dfDateYmd, 	0, 	false,  false);
   ...
   */
	 		...
	 		switch (sAction) {																		
	 			...
	 			case IBSAVE: // Save
	 				...
	 				if (!ComPriConfirmSave()) {
	  				...
	  				ComOpenWait(true); 	
	  				sheetObj.DoAllSave("ESM_PRI_3518GS.do", "f_cmd=" + MODIFY01);	  				
	 				break;	 				
	 		}
 		}catch(e){
 			if (e == "[object Error]") {
 	...
 	function sheet1_OnSearchEnd(sheetObj, errMsg){
 		...
 		sheetObj.CellValue2(sheetObj.SelectRow, "amdt_seq") = parseInt(sheetObj.CellValue(sheetObj.SelectRow, "amdt_seq"));
 	...
 	function validateForm(sheetObj, formObj, sAction) {
 		...
 		case IBSEARCH: // 조회
   		...
   		case IBSAVE:
   			...
   			// 이전SEQ의 EFF_DT보다 현재SEQ의 EFF_DT가 커야 한다. 
   			if(bEffDt >= effDt) {
