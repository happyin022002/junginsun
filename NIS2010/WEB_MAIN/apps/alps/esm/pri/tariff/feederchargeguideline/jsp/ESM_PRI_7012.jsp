...
*@FileName : ESM_PRI_7012.jsp
*@FileTitle : Add-on Guideline Creation & Amendment - Amend
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.feederchargeguideline.event.EsmPri7012Event"%>
...
<%
	EsmPri7012Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri7012Event)request.getAttribute("Event");
		...
		tariffNo = request.getParameter("fdr_trf_no");	
		amendSeq = request.getParameter("amdt_seq");		
		creDt = request.getParameter("cre_dt");
		effDt = request.getParameter("eff_dt");
		expDt = request.getParameter("exp_dt");
		tariffNoView = request.getParameter("fdr_trf_no_view");	
...
<html>
<head>
<title>Add-on Tariff Creation & Amendment - Amend</title>
...
<input type="hidden" name="fdr_trf_no" value="<%=tariffNo%>">
...
<tr><td valign="top">	
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Add-on Tariff Creation & Amendment - Amend</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="150"><input type="text" name="fdr_trf_no_view" style="width:130;text-align:center;" readonly class="input2" value="<%=tariffNoView%>"></td>
				...
				<tr class="h23">
					...
					<td width="120"><input type="text" name="cre_dt" style="width:110;text-align:center;" readonly class="input2" value="<%=creDt%>" readonly></td>		
					<td width="100">Effective Date</td>
					<td width="150"><input type="text" name="eff_dt" style="width:130;text-align:center;" readonly class="input2" value="<%=effDt%>" readonly></td>
