...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class ESM_PRI_7003_01 : ESM_PRI_7003_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_7003_01() {
...
//            	ComOpenWait(true); //->waiting->start
	 			...
	 			var sXml = sheetObj.GetSearchXml("ESM_PRI_7003_01GS.do", FormQueryString(formObj));	 	 	 
...
*/     	    	
    ...
    */      
    function clearAllForms(){   
        ...
        sheet1Allclear();
        formObject.cgoTpcd[1].checked=false; 
     ...
     * Add-on DG버튼과 IHC Over weight 버튼의 상태와 색을 변경한다. <br>
     * <br><b>Example :</b>
     * <pre>
     * 
     * </pre>
