...
* 2013.07.30 [CHM-201326002] 전윤주 Over weight service flag가 'Y' 인 경우 버튼 파란색으로 표시  
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.feederchargeguideline.event.EsmPri700302Event"%>
...
<%
	EsmPri700302Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri700302Event)request.getAttribute("Event");
...
<html>
<head>   
<title>Feeder/IHC Tariff Inquiry - Reefer Tab</title>
