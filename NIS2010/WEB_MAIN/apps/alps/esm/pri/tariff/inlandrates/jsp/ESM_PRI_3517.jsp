...
<%@ page import="com.hanjin.apps.alps.esm.pri.tariff.inlandrates.event.EsmPri3517Event"%>
...
<html>
<head>
<title>Inland Rates Publish</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Inland Rates Publish
		</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
				    ...
				    <td width="330"><input type="text" style="width:200;" name="tariff_cd" readonly value="" class="input2"></td>
				</tr>
				<tr class="h23">
					<td width="">Inland Rates Name</td>
				    <td width=""><input type="text" style="width:200;" name="inland_nm" readonly value="" class="input2"></td>
				</tr>				
				</table>
