...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0117Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri0117Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri0117Event) request.getAttribute("Event");
...
<html>
<head>
<title>Amendment History - Rate (Direct Call)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Amendment History - Rate (Direct Call)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
