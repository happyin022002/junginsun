...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0097Event"%>
...
<html>
<head>
<title>Route Note Creation</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Route Note Creation</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
