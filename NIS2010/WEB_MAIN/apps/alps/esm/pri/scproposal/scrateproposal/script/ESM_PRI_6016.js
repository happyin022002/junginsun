...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6016 : ESM_PRI_6016 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6016() {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
 				...
 				if ( sheetObj.id == "sheet1"){
 		            ...
 		            sheetObj.DoSearch("ESM_PRI_6016GS.do", FormQueryString(formObj)  );
 				...
 				if ( sheetObj.id == "sheet2"){
 		            ...
 		            sheetObj.DoSearch("ESM_PRI_6016GS.do", FormQueryString(formObj) +param  );
 				}
 				ComOpenWait(false);
                break;
 			case IBSAVE:        //저장
				...
				var r = sheetObj.DoSave("ESM_PRI_6016GS.do",  "f_cmd="+MULTI );
				if( r == true ){
 			...
 			case IBSEARCH_ASYNC01:
				...
				var param = FormQueryString(formObj) + "&popup_type=SP";
