...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6021 : ESM_PRI_6021 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6021() {
 ...
 var TITLE_TEXT_CM = "S/C Proposal CM View All";
 var TITLE_TEXT_OP = "S/C Proposal OP View All";
              ...
              case 1:      //sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle1 = "|Seq.|Rate Type|Rate Type|CMDT|Route|Route|Route|Route|Previous|Previous|Previous|Previous|Previous|Previous|Estimate|Estimate|Estimate|Estimate|Estimate|Estimate|prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|prs_rat_ut_cd|ori_prs_estm_lod_qty";
 					 var HeadTitle2 = "|Seq.|G/Rate|S/Rate |CMDT|Origin|O.VIA|D.VIA|Dest.|PFMC|Share|CMPB|CM|OPB|OP|PFMC|Share|CMPB|CM|OPB|OP|prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|prs_rat_ut_cd|ori_prs_estm_lod_qty";
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
		        ...
		        sheetObj.DoSearch("ESM_PRI_6021GS.do", FormQueryString(formObj) + "&table_cd=SP");
		        ComOpenWait(false);
	            break;
 			...
 			case IBSAVE:        //저장
				...
				var sXml = sheetObj.GetSaveXml("ESM_PRI_6021GS.do", sheetObj.GetSaveString() + "&" + FormQueryString(formObj) + "&table_cd=SP");
