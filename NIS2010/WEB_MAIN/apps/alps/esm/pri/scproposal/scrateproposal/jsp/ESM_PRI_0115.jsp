...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0115Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri0115Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri0115Event) request.getAttribute("Event");
...
<html>
<head>
<title>Amendment History - Rate (Route)</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Amendment History - Rate (Route)</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
