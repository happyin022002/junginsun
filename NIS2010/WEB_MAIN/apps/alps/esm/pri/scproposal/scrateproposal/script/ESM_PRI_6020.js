...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6020 : ESM_PRI_6020 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6020() {
    ...
    var sheetCnt = 0;
    var isShowOp = true;
    var TITLE_TEXT_CM = "S/C CMPB View All";
    var TITLE_TEXT_OP = "S/C OPB View All";
                 ...
                 case 1:      //sheet1 init
                    with (sheetObj) {
                       ...
                       //전체Edit 허용 여부 [선택, Default false]
    					...
    					InitDataProperty(0, cnt++ , dtData,    			70,   	daLeft,  	true,		"ori_rout_pnt_loc_def_cd",   			false,          "",      dfNone,      		0,			false,       false);
    					...
    					InitDataProperty(0, cnt++ , dtData,    			70,   	daLeft,  	true,		"dst_rout_pnt_loc_def_cd",   			false,          "",      dfNone,      		0,			false,       false);
    					InitDataProperty(0, cnt++ , dtCombo,    		30,   	daCenter,  	true,		"rat_ut_cd",   	false,          "",      dfNone,      		0,			false,       false);
     					InitDataProperty(0, cnt++ , dtCombo,    		35,   	daCenter,  	true,		"prc_cgo_tp_cd",   	false,          "",      dfNone,      		0,			false,       false);
    					InitDataProperty(0, cnt++ , dtCombo,    		35,   	daCenter,  	true,		"curr_cd",   false,          "",      dfNone,      		0,			false,       false);
    					...
    					InitDataProperty(0, cnt++ , dtData,    		60,   	daRight,  	true,		"prs_gid_cmpb_amt",   			false,          "",      dfFloat,      	2,			false,       false);
        ...
        function doActionIBSheet(sheetObj,formObj,sAction) {
            ...
            switch(sAction) {
    			...
    			ComOpenWait(true);
   		        ...
   		        sheetObj.DoSearch("ESM_PRI_6020GS.do", FormQueryString(formObj) );
   		        ComOpenWait(false);
   	            break;
