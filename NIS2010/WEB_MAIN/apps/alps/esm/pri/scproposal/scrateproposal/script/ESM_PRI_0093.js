...
=========================================================
* History
* 2011.11.01 이관샨[CHM-201114234-01] BUC, PSC surcharge 내용을 추가로 보여준다.
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
			with (sheetObj) {
				...
				var HeadTitle = "|Seq.|prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|Commodity Group|Actual Customer|Commodity Note|route seq.|Origin|O.Via|D.Via|Destination|D.Call|Proposal|BUC|PSC|FRC|Total Rate|GRI|Route Note";
				...
				InitDataProperty(0, cnt++, dtData,    55, daCenterTop,false, "dir_call_flg",             false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData,   170, daLeftTop,  false, "rt_ctnt",                  false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData,    70, daRightTop, false, "buc_scg_amt",              false, "", dfNone, 2, false, false, 9);
        		InitDataProperty(0, cnt++, dtData,    70, daRightTop, false, "psc_scg_amt",              false, "", dfNone, 2, false, false, 9);
        		InitDataProperty(0, cnt++, dtData,    70, daRightTop, false, "frc_scg_amt",              false, "", dfNone, 2, false, false, 9);
        		InitDataProperty(0, cnt++, dtData,    80, daRightTop, false, "total_amt",                false, "", dfNone, 2, false, false, 9);
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        try {
	        ...
	        case IBSAVE: // Accept All
	            ...
	            var sXml = sheetObj.GetSaveXml("ESM_PRI_0093GS.do", sParam);
			...
			case IBSEARCH: // 조회
	            ...
	            sheetObj.DoSearch("ESM_PRI_0093GS.do", FormQueryString(formObj));
