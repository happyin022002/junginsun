	...
	function sheet1_OnPopupClick(sheetObj, Row, Col) {
		...
		if (colName == "rout_pnt_loc_def_cd") {
			if (sheetObj.CellEditable(Row, "rout_pnt_loc_def_cd")) {
	            ...
	            sUrl += "&group_cmd=" + PRI_SP_SCP + "&location_cmd=LG&loc_tp_cd=" + sheetObj.CellValue(sheetObj.SelectRow, "rout_pnt_loc_tp_cd");
	...
	function sheet2_OnPopupClick(sheetObj, Row, Col) {
		...
		if (colName == "rout_via_port_def_cd") {
			if (sheetObj.CellEditable(Row, "rout_via_port_def_cd")) {
	            var sUrl = "/hanjin/ESM_PRI_4026.do?" + FormQueryString(document.form);
	            sUrl += "&group_cmd=" + PRI_SP_SCP + "&location_cmd=LG&loc_tp_cd=" + sheetObj.CellValue(sheetObj.SelectRow, "rout_via_port_tp_cd");
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		try {
	        ...
	        case IBSEARCH_ASYNC13: // Accept
	            ...
	            var sXml = sheetObj.GetSaveXml("ESM_PRI_0027GS.do", sParam);
			...
			case IBINSERT: // 입력
	            ...
	            if (curPntViaType == "P") {
	            	...
	            	sheetObj.CellValue(idx, "rcv_de_term_cd") = "Y";
    ...
    function setLineEnable(sheetObj, idx) {
    	...
    	if (sheetObj.CellValue(idx, "n1st_cmnc_amdt_seq") == document.form.amdt_seq.value
        	...
        	if (sheetObj.id == "sheet1" || sheetObj.id == "sheet4") {
	        	...
	        	sheetObj.CellEditable(idx, "loc_grd_cnt_cd") = true;
	        	sheetObj.CellEditable(idx, "loc_grd_cd") = true;
        	...
        	if (sheetObj.id == "sheet1" || sheetObj.id == "sheet4") {
	        	...
	        	sheetObj.CellEditable(idx, "loc_grd_cnt_cd") = false;
	        	sheetObj.CellEditable(idx, "loc_grd_cd") = false;
