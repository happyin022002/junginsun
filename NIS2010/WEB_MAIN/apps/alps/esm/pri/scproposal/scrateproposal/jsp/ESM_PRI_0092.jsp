...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0092Event"%>
...
<html>
<head>
<title>S/C Proposal General/Special Rate - Commodity Note Inquiry</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;S/C Proposal General/Special Rate - Commodity Note Inquiry</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
