...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri6016Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6016Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6016Event)request.getAttribute("Event");
