...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0090Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri0090Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri0090Event) request.getAttribute("Event");
