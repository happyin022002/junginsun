...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0094Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri0094Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri0094Event) request.getAttribute("Event");
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Direct Call Amend Creation</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
