...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6018 : ESM_PRI_6018 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6018() {
 ...
 document.onclick = processButtonClick;
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
	            ...
	            sXml = sheetObj.GetSearchXml("ESM_PRI_6018GS.do", FormQueryString(formObj) );
 			...
 			case IBSAVE:        //저장
				...
				sheetObj.DoSave("ESM_PRI_6018GS.do", FormQueryString(formObj) );
				ComOpenWait(false);
				break;
 			case IBINSERT:      // 입력
	 ...
	 */  	 
   	function changeButtonStatus(sheetObj){
   		var formObj = document.form;
   		if(sheetObjects[1].RowCount > 0 && sheetObjects[1].IsDataModified == true ){
