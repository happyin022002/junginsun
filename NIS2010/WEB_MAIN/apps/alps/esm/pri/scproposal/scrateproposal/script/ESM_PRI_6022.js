...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6022 : ESM_PRI_6022 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6022() {
    ...
    var isReqUsr = false;
    var isAproUsr = false;
    var REMARK_TEXT_OP = "» CM= CMPB * PFMC , OP= OPB * PFMC\n» Actual: Actual Figures for current S/C\n» Estimate: Estimated Figures for current S/C based on actual figures\n» Sum= Actual + Estimate";
    var REMARK_TEXT_CM = "» CM= CMPB * PFMC\n» Actual: Actual Figures for current S/C\n» Estimate: Estimated Figures for current S/C based on actual figures\n» Sum= Actual + Estimate";
    var TITLE_TEXT_CM = "S/C Amendment CM View All";
    var TITLE_TEXT_OP = "S/C Amendment OP View All";
     ...
     */ 
                 ...
                 case 1:      //sheet1 init
                    with (sheetObj) {
                       ...
                       //전체Edit 허용 여부 [선택, Default false]
                        ...
                        var HeadTitle1 = "|Seq.|Rate Type|Rate Type|CMDT|Route|Route|Route|Route|Actual|Actual|Actual|Actual|Actual|Actual|Estimate|Estimate|Estimate|Estimate|Estimate|Estimate|Sum|Sum|Sum|Sum|Sum|Sum|prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|prs_rat_ut_cd|ori_prs_estm_lod_qty|flg_search_cmpb";
    					 var HeadTitle2 = "|Seq.|G/Rate|S/Rate |CMDT|Origin|O.VIA|D.VIA|Dest.|PFMC|Share|CMPB|CM|OPB|OP|PFMC|Share|CMPB|CM|OPB|OP|PFMC|Share|CMPB|CM|OPB|OP|prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|prs_rat_ut_cd|ori_prs_estm_lod_qty|flg_search_cmpb";
    					...
    					InitDataProperty(0, cnt++ , dtAutoSum,    		60,   	daRight,  	true,		"prs_crnt_lod_qty",   			false,          "",      dfNullFloat,      	1,			false,       true);
    					InitDataProperty(0, cnt++ , dtData,    		50,   	daRight,  	true,		"crnt_share",   			false,          "",      dfNone,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		55,   	daRight,  	true,		"prs_crnt_respb_cmpb_amt",   			false,          "",      dfNullFloat,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		85,   	daRight,  	true,		"crnt_cm",   			false,          "",      dfNullInteger,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		55,   	daRight,  	true,		"prs_crnt_respb_opb_amt",   			false,          "",      dfNullFloat,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		85,   	daRight,  	true,		"crnt_op",   			false,          "",      dfNullInteger,      	2,			false,       true);

    					InitDataProperty(0, cnt++ , dtAutoSum,    		60,   	daRight,  	true,		"prs_rmn_lod_qty",   			false,          "",      dfFloat,      	1,			true,       true);
    					InitDataProperty(0, cnt++ , dtData,    		50,   	daRight,  	true,		"rmn_share",   			false,          "",      dfNone,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		55,   	daRight,  	true,		"prs_rmn_respb_cmpb_amt",   			false,          "",      dfNullFloat,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		85,   	daRight,  	true,		"rmn_cm",   			false,          "|prs_rmn_respb_cmpb_amt| * |prs_rmn_lod_qty|",      dfNullInteger,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		55,   	daRight,  	true,		"prs_rmn_respb_opb_amt",   			false,          "",      dfNullFloat,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		85,   	daRight,  	true,		"rmn_op",   			false,          "|prs_rmn_respb_opb_amt| * |prs_rmn_lod_qty|",      dfNullInteger,      	2,			false,       true);
    		
    					
    					InitDataProperty(0, cnt++ , dtAutoSum,    		60,   	daRight,  	true,		"prs_sum_lod_qty",   			false,          "|prs_crnt_lod_qty|+|prs_rmn_lod_qty|",      dfFloat,      	1,			false,       false);
    					InitDataProperty(0, cnt++ , dtData,    		50,   	daRight,  	true,		"sum_share",   			false,          "",      dfNone,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		55,   	daRight,  	true,		"prs_sum_cmpb_amt",   			false,          "((|prs_crnt_respb_cmpb_amt|*|prs_crnt_lod_qty|)+(|prs_rmn_respb_cmpb_amt|*|prs_rmn_lod_qty|) ) / (|prs_crnt_lod_qty|+|prs_rmn_lod_qty|)",      dfNullFloat,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		85,   	daRight,  	true,		"sum_cm",   			false,          "(|prs_crnt_respb_cmpb_amt|*|prs_crnt_lod_qty|)+(|prs_rmn_respb_cmpb_amt|*|prs_rmn_lod_qty|)",      dfNullInteger,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		55,   	daRight,  	true,		"prs_sum_opb_amt",   			false,          "((|prs_crnt_respb_opb_amt|*|prs_crnt_lod_qty|)+(|prs_rmn_respb_opb_amt|*|prs_rmn_lod_qty|) ) / (|prs_crnt_lod_qty|+|prs_rmn_lod_qty|)",      dfNullFloat,      	2,			false,       true);
    					InitDataProperty(0, cnt++ , dtAutoSum,    		85,   	daRight,  	true,		"sum_op",   			false,          "(|prs_crnt_respb_opb_amt|*|prs_crnt_lod_qty|)+(|prs_rmn_respb_opb_amt|*|prs_rmn_lod_qty|)",      dfNullInteger,      	2,			false,       true);
    					...
    					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"ori_prs_rmn_lod_qty",   			false,          "",      dfFloat,      		1,			false,      false);
            ...
            switch(sAction) {
    			...
    			case IBSEARCH:      //조회
    				ComOpenWait(true);
	   		        ...
	   		        sheetObj.DoSearch("ESM_PRI_6022GS.do", FormQueryString(formObj) + "&table_cd=SP");
	   		        ComOpenWait(false);
	   	            break;
    			...
    			case IBSAVE:        //저장
					...
					var sXml = sheetObj.GetSaveXml("ESM_PRI_6022GS.do", sheetObj.GetSaveString() + "&" + FormQueryString(formObj) + "&table_cd=SP");
       ...
       function calcSheetFromChangingLod(sheetObj,row){
    	    ...
    	    //Estimate
	       	...
	       	var COL_RMN_CM = "rmn_cm";
	       	var COL_RMN_CMPB = "prs_rmn_respb_cmpb_amt";       	
	       	var COL_RMN_OP = "rmn_op";
	       	var COL_RMN_OPB = "prs_rmn_respb_opb_amt";
	       	//SUM
	       	var COL_SUM_LOD ="prs_sum_lod_qty";
	       	var COL_SUM_SHARE = "sum_share";       	
	       	var COL_SUM_CM = "sum_cm";
	       	var COL_SUM_CMPB = "prs_sum_cmpb_amt";       	
	       	var COL_SUM_OP = "sum_op";
	       	var COL_SUM_OPB = "prs_sum_opb_amt";
	       	
	       	var COL_CRNT_LOD = "prs_crnt_lod_qty";
	    	var COL_CRNT_SHARE = "crnt_share";      
	    	var COL_CRNT_CM = "crnt_cm";
	    	var COL_CRNT_OP = "crnt_op";
	    	var COL_CRNT_CMPB = "prs_crnt_respb_cmpb_amt";
	       	var COL_CRNT_OPB = "prs_crnt_respb_opb_amt";    	
	    	...
	    	//SUM의 share를 계산한다.
	       	...
	       	calcBottomCmpbOpb(sheetObj,COL_RMN_LOD,COL_RMN_CM,COL_RMN_CMPB);
	       	calcBottomCmpbOpb(sheetObj,COL_SUM_LOD,COL_SUM_CM,COL_SUM_CMPB);
	       	calcBottomCmpbOpb(sheetObj,COL_CRNT_LOD,COL_CRNT_CM,COL_CRNT_CMPB);

	       	calcBottomCmpbOpb(sheetObj,COL_RMN_LOD,COL_RMN_OP,COL_RMN_OPB);
	       	calcBottomCmpbOpb(sheetObj,COL_SUM_LOD,COL_SUM_OP,COL_SUM_OPB);	       	
	       	calcBottomCmpbOpb(sheetObj,COL_CRNT_LOD,COL_CRNT_OP,COL_CRNT_OPB);
	       	
	       	
	       	calcBottomShare(sheetObj,COL_RMN_SHARE,COL_RMN_LOD);
	       	calcBottomShare(sheetObj,COL_SUM_SHARE,COL_SUM_LOD);
	       	calcBottomShare(sheetObj,COL_CRNT_SHARE,COL_CRNT_LOD);
          ...
          */  
       	function searchCMPBAndOPBData(sheetObj,row ){
       		...
       		if( sheetObj.CellValue(row,"flg_search_cmpb") != "Y" && ( sheetObj.CellValue(row,"prs_rmn_respb_cmpb_amt") == "" || sheetObj.CellValue(row,"prs_rmn_respb_opb_amt") == "" ) ){
				...
				param += "&gen_spcl_rt_tp_cd=" +sheetObj.CellValue(row,"gen_spcl_rt_tp_cd");
				param += "&cmdt_hdr_seq=" +sheetObj.CellValue(row,"cmdt_hdr_seq");
				param += "&rout_seq=" +sheetObj.CellValue(row,"rout_seq");
				var sXml = sheetObj.GetSearchXml("ESM_PRI_6022GS.do", param );
