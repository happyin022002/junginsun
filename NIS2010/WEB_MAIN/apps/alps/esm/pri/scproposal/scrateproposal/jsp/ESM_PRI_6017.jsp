...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri6017Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6017Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6017Event)request.getAttribute("Event");
...
<html>
<head>
<title>S/C Proposal/Amendment Cost Detail by Trans. Mode</title>
