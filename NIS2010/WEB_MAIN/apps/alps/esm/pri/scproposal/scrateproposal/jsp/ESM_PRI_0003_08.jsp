...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri000308Event"%>
...
<html>
<head>
<title>S/C Proposal General/Special Rate - Creation</title>
...
<input type="hidden" name="gri_cal_readonly" value="N">
            ...
            <tr><td class="bg">
                ...
                <tr>
                    ...
                    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        ...
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                            <tr><td class="btn1_left"></td>
                            <td class="btn1" name="btn_viewall">View All</td>
                            <td class="btn1_right"></td>
                            </tr>
                        </table></td>
                        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                ...
                <!--  biz_1   (S) -->
                <table class="search_sm2" border="0" style="width:285;">
                <tr class="h23">
                    <td width="50">&nbsp;Type</td>
                    <td width="" class="stm" id="rdoRateTp">
	                <%
	                if (rateTypeList != null && rateTypeList.size() > 0) {
	                    for (int i = 0; i < rateTypeList.size(); i++) {
	                        com.hanjin.framework.component.util.code.CodeInfo row = rateTypeList.get(i);
