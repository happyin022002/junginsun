...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri6050Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6050Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6050Event)request.getAttribute("Event");
