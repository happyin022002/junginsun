...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0093Event"%>
...
<input type="hidden" name="not_acpt_cnt" value="<%=request.getParameter("n_acpt_cnt")%>">
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  Accept All</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
