...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0027Event"%>
...
<html>
<head>
<title>S/C Proposal Rate - Route Point</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;S/C Proposal Rate - Route Point </td></tr>
        </table>
        <!-- : ( Title ) (E) -->
