...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri6022Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6022Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6022Event)request.getAttribute("Event");
