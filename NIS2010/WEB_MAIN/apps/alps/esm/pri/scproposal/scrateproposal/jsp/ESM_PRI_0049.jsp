...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0049Event"%>
...
<html>
<head>
<title>S/C Proposal General/Special Rate - Commodity Inquiry</title>
...
<table width="900" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="100%" border="0">
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;S/C Proposal General/Special Rate - Commodity Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
