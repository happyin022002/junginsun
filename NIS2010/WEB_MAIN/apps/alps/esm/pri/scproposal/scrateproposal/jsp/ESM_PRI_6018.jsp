...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri6018Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6018Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6018Event)request.getAttribute("Event");
