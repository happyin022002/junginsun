...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0069Event"%>
...
<table width="1000" class="popup" cellpadding="10" border="0">
    ...
    <tr><td valign="top">
	        <table width="100%" border="0">
	            <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; View All Rates</td></tr>
	        </table>
	        <table class="search"> 
	            <tr>
	               <td class="bg">
