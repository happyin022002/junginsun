...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0098Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri0098Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri0098Event) request.getAttribute("Event");
...
<html>
<head>
<title>S/C Proposal General/Special Rate - Route Note Inquiry</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;S/C Proposal General/Special Rate - Route Note Inquiry</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
