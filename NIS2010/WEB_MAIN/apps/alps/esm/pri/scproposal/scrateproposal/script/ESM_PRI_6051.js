...
/**
 * @extends
 * @class ESM_PRI_6051 : ESM_PRI_6051 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_PRI_6051() {
...
function initParams(formObj) {
	...
	// formObj.loc_type[1].checked = true;
}
...
function initSheet(sheetObj, sheetNo) {
	...
	case "sheet1": // sheet1 init
		with (sheetObj) {
			...
			var HeadTitle1 = "|Sel.|Seq.|Location Code|Description|prop_no|amdt_seq|svc_scp_cd|grp_loc_seq|rout_loc_tp_cd|org_dest_tp_cd";
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH: //조회
		...
		case "sheet1":
			...
			sheetObj.DoSearch("ESM_PRI_6051GS.do", params);
			ComOpenWait(false);
			break;
		case "sheet2":
			ComOpenWait(true);
			...
			sheetObj.DoSearch("ESM_PRI_6051GS.do", param);
			ComOpenWait(false);
			break;
