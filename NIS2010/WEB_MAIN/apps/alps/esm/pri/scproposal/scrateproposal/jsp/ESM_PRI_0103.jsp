...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scrateproposal.event.EsmPri0103Event"%>
...
<html>
<head>
<title>S/C Proposal General/Special Rate - Actual Customer Inquiry</title>
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;S/C Proposal General/Special Rate - Actual Customer Inquiry</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
