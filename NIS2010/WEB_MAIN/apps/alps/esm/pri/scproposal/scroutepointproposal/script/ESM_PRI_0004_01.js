...
/**
 * @extends
 * @class ESM_PRI_0004_01 : ESM_PRI_0004_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESM_PRI_0004_01() {
        ...
        case "sheet1":
        	 ...
        	 with (sheetObj) {
                ...
                // 전체Edit 허용 여부 [선택, Default false]
                 ...
                 InitDataProperty(0, cnt++ , dtCombo,     		100,   	daCenter,  	false,	"rout_pnt_loc_tp_cd",	false,	"",      dfNone, 			0,     false,       false);
				 
                 InitDataProperty(0, cnt++ , dtData, 			100,   	daCenter,  	false,	"rout_pnt_loc_def_cd",	false,	"",      dfNone, 			0,     false,       false, 5);
	...
	try {
	    ...
	    switch(sAction) {
	     case IBSEARCH_ASYNC01: 
			...
			var sXml = sheetObj.GetSearchXml("ESM_PRI_0004_01GS.do" , FormQueryString(formObj));
