...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /** 
     * @extends 
     * @class ESM_PRI_0057_05 : ESM_PRI_0057_05 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0057_05() {
			...
			case "sheet1":
				with (sheetObj) {
					...
					// SAVESTATUS, FORMATFIX]
                     ...
                     InitDataProperty(0, cnt++ , dtData,    		100,   	daCenter,  	false,	"prc_grp_cmdt_cd",			false,           "",      dfNone, 			0,     false,     false, 5);
 					 InitDataProperty(0, cnt++ , dtData,     		120,   	daLeft, 	false,	"prc_grp_cmdt_desc",		false,           "",      dfNone, 			0,     false,     false);
				...
				with (sheetObj) {
					...
					// SAVESTATUS, FORMATFIX]
	                 ...
	                 InitDataProperty(0, cnt++ , dtHidden, 			90, 	daCenter, 	false,	"grp_cmdt_dtl_seq"); 					 
 	                 InitDataProperty(0, cnt++ , dtData, 			80,    daCenter,  	false,	"prc_cmdt_def_cd",   	false,          "",      dfNone, 			0,     false,       false, 6);
 					 InitDataProperty(0, cnt++ , dtData,     		200,   	daLeft,  	false,	"cmdt_def_nm",    	false,          "",      dfNone, 			0,     false,      false);
		...
		try {
			...
			switch (sAction) {
				case IBSEARCH: // 조회
					...
					sheetObj.DoSearch("ESM_PRI_0057_05GS.do" , FormQueryString(formObj));
					break;
    ...
    */
	function sheet2_OnSearchEnd(sheetObj, errMsg){
		...
		for(i=1 ; i < sheetObj.Rows; i++){
			...
			else if(sheetObj.CellValue(i,"n1st_cmnc_amdt_seq") == amdt_seq && sLgcyIfFlg != "Y"){
	...
	function sheet1_OnSearchEnd(sheetObj, errMsg){
		...
		for(i=1;i<=rCnt;i++){
			if(amdt_seq!=0){
				...
				if((sheetObj.CellValue(i,"src_info_cd")=="AM"||sheetObj.CellValue(i,"src_info_cd")=="AD"||sheetObj.CellValue(i,"src_info_cd")=="NW") && sLgcyIfFlg != "Y"){
					sheetObj.CellFont("FontColor", i, 1, i, sheetObj.LastCol)= sheetObj.RgbColor(255,0,0);				
				}	
			}
		}
