...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scgricalculationproposal.event.EsmPri0066Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	EsmPri0066Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id = "";
	String strUsr_nm = "";
	Logger log = Logger.getLogger("com.hanjin.apps.SCProposal.SCGRICalcualtionProposal");
	...
	try {
		...
		event = (EsmPri0066Event) request.getAttribute("Event");
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; GRI Calculation</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
