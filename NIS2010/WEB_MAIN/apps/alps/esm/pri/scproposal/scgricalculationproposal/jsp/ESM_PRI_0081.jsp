...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scgricalculationproposal.event.EsmPri0081Event"%>
...
<input type="hidden" name="cmdt_actcust_tp_cd" value="<%=request.getParameter("cmdt_actcust_tp_cd")%>">
