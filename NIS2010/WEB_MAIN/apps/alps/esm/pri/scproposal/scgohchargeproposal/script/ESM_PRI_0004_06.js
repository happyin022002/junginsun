...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0004_06 : ESM_PRI_0004_06 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0004_06() {
    		...
    		case "sheet1":
    			with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++, dtCombo,    	50,   daCenter, false,  "rout_pnt_loc_tp_cd",   false, 	"",	dfNone);
                    InitDataProperty(0, cnt++, dtData,    	55,   daCenter, false,  "rout_pnt_loc_def_cd",  false, 	"", dfNone);
                    InitDataProperty(0, cnt++, dtData,     	120,  daLeft,	false,  "rout_pnt_loc_def_nm",  false,  "", dfNone);
                    InitDataProperty(0, cnt++, dtCombo,    	60,   daCenter, false,  "prc_hngr_bar_tp_cd",   false, 	"", dfNone);
                    InitDataProperty(0, cnt++, dtCombo,    	40,   daCenter, false,  "rat_ut_cd",     		false, 	"", dfNone);
                    InitDataProperty(0, cnt++, dtCombo,    	60,   daCenter, false,  "curr_cd",    			false, 	"", dfNone);
                    ...
                    InitDataProperty(0, cnt++, dtCombo,    	70,   daCenter, false,  "src_info_cd",        	false,  "", dfNone);
                    InitDataProperty(0, cnt++, dtCombo,    	70,   daCenter, false,  "prc_prog_sts_cd",      false,	"", dfNone);
