...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.sctransportationadditionalchargeproposal.event.EsmPri0024Event"%>
...
<%
	EsmPri0024Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0024Event)request.getAttribute("Event");
...
<html>
<head>
<title>Proposal Origin/Destination Arbitrary - Excel Import</title>
...
<tr><td valign="top">
	<!-- : ( Title ) (S) -->
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Origin/Destination Arbitrary - Excel Import</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
