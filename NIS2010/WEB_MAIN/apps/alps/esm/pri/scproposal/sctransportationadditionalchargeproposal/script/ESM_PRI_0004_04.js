...
=========================================================
* History
* 2011.08.17 이관샨 [CHM-201112933-01] S/C Proposal & Amendment Inquiry 화면 스크립트 개선 - 조회 후 SCRIPT 오류 발생에 대해 불필요 SCRIPT 소스 삭제
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0004_04 : ESM_PRI_0004_04 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0004_04() {
    	...
    	switch (sheetID) {
    		...
    		case "sheet1":
    			with (sheetObj) {
    				...
    				var HeadTitle = "Seq.|Point|Description|Trans Mode|Term|Base Port|VIA|D/Call|Per|Cargo Type|Commodity|Currency|Proposal|C.Offer|Final|EFF Date|EXP Date|Source|Status|GRI|GRI|seq|Note|Accept Staff/Team|Accept Date||||||||||||";
    				...
    				InitDataProperty(0, cnt++, dtData,  	55,   daCenter,  false,	"rout_pnt_loc_def_cd",  false,	"",	dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,    	100,  daLeft,	 false,	"rout_pnt_loc_def_nm",  false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,     70,   daCenter,  false,	"prc_trsp_mod_cd",    	false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,     45,   daCenter,  false,	"rcv_de_term_cd",       false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,   	60,   daCenter,  false,	"bse_port_def_cd",     	false, 	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,   	60,   daCenter,  false,	"via_port_def_cd",    	false, 	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCheckBox,  40,   daCenter,  false,	"dir_call_flg",      	false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,  	40,   daCenter,  false,	"rat_ut_cd",      		false, 	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,     75,   daCenter,  false,	"prc_cgo_tp_cd",     	false, 	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,   	75,   daCenter,  false,	"prc_cmdt_def_cd", 		false, 	"", dfNone,			0);
    				InitDataProperty(0, cnt++, dtCombo,     60,   daCenter,  false,	"curr_cd",      		false, 	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,      70,   daRight,   false,	"prop_frt_rt_amt",     	false, 	"", dfNullFloat,	2);
    				InitDataProperty(0, cnt++, dtData,      70,   daRight,   false,	"coffr_frt_rt_amt",    	false,  "", dfNullFloat, 	2);
    				InitDataProperty(0, cnt++, dtData,      70,   daRight,   false,	"fnl_frt_rt_amt",     	false,  "", dfNullFloat, 	2);
    				InitDataProperty(0, cnt++, dtData,      70,   daCenter,  false,	"eff_dt", 				false,	"", dfDateYmd, 		0);
    				InitDataProperty(0, cnt++, dtData,      70,   daCenter,  false,	"exp_dt",      			false,  "", dfDateYmd, 		0);
    				InitDataProperty(0, cnt++, dtCombo,     70,   daCenter,  false,	"src_info_cd",     		false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtCombo,  	70,   daCenter,  false,	"prc_prog_sts_cd",      false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,      20,   daCenter,  false,	"gri_appl_tp_cd",      	false,  "", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,      70,   daRight,   false,	"gri_appl_amt",			false,	"", dfNullFloat,	2);
    				InitDataProperty(0, cnt++, dtData,      30,   daRight,   false,	"note_dp_seq", 			false,	"", dfNone, 		0);
    				InitDataProperty(0, cnt++, dtData,      90,   daLeft,    false,	"add_chg_note_ctnt", 	false,	"", dfNone, 		0);
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			...
			case IBSEARCH_ASYNC02: // font style 설정
				...
				var sXml = sheetObj.getSaveXml("ESM_PRI_0004_04GS.do", FormQueryString(formObj));
