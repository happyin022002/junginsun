...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0054Event"%>
...
<html>
<head>
<title>Commodity Note Conversion - Inquiry</title>
...
<input type="hidden" name="cmdt_note_seq" value="<%=request.getParameter("cmdt_note_seq")%>">
...
<input type="hidden" name="detail_seq" value="<%=request.getParameter("detail_seq")%>">
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp; Commodity Note Conversion - Inquiry</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) --> <!-- 1 (S) -->
		<table class="search" id="mainTable">
			<tr>
				...
				<table width="100%" class="grid2">
					<tr>
						<td class="noinput2"><textarea name="note_ctnt" style="height: 90; width: 100%; font-size: 9pt;" class="noinput2" readonly="true"></textarea></td>
					</tr>
				</table>
