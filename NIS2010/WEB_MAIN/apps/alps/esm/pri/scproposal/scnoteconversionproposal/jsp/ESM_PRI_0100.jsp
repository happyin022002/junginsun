...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0100Event"%>
...
<%
	EsmPri0100Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0100Event)request.getAttribute("Event");
...
<html>
<head>
<title>Note Conversion History - Commodity Note Conversion Creation</title>
...
<input type="hidden" name="cmdt_note_seq" value="<%=cmdtNoteSeq%>">
<input type="hidden" name="note_conv_mapg_id" value="<%=noteConvMapgId%>">
<input type="hidden" name="gen_spcl_rt_tp_cd" value="<%=genSpclRtTpCd%>">
...
<input type="hidden" name="note_conv_tp_cd" value="C">
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp; Commodity Note Conversion</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) --> <!-- 1 (S) -->
		<table class="search" id="mainTable">
			<tr>
				<td class="bg"><!-- Grid-1  (S) -->
				...
				<table width="100%" class="grid2">
					<tr>
						<td class="noinput2"><textarea name="note_ctnt" 
							style="height: 90; width: 100%; font-size: 9pt;" class="noinput2" readonly="true"></textarea></td>
					</tr>
				</table>
