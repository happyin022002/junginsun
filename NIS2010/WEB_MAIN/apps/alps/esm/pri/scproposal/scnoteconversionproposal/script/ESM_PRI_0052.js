...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0052 : ESM_PRI_0052 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0052() {
				...
				case IBSEARCH: // 조회
	 			...
	 			case IBSEARCHAPPEND: // 조회
		 			...
		 			formObj.f_cmd.value = SEARCH01;
	  				var sXml = sheetObj.GetSearchXml("ESM_PRI_0052GS.do", FormQueryString(formObj));
					sheetObj.LoadSearchXml(sXml);
	 				break;
	 		}
 		}catch(e){
