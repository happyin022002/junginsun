...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0055 : ESM_PRI_0055 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0055() {
         	...
         	case "sheet3":
         		with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     InitDataProperty(0, cnt++ , dtCombo,			80,   daCenter,  true,	"gen_spcl_rt_tp_cd",		false,	"",	dfNone, 			0,     false,       false);
	 			...
	 			case IBSEARCH_ASYNC01: // 조회
					ComOpenWait(true);
		 			formObj.f_cmd.value = SEARCH03;
	  				var sXml = sheetObj.GetSearchXml("ESM_PRI_0055GS.do", FormQueryString(formObj));
					sheetObj.LoadSearchXml(sXml);
	 				break;
	 		}
 		}catch(e){
