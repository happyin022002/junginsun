...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0033Event"%>
...
<html>
<head>
<title>Route Note Conversion</title>
...
<input type="hidden" name="rout_note_seq" value="<%=routNoteSeq%>">
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp;Route Note Conversion</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) --> <!-- 1 (S) -->
		<table class="search" id="mainTable">
			<tr>
				...
				<table class="search" border="0" style="width:100%;">
					<tr class="h23">
						<td><textarea name="note_ctnt" style="width:960; height:90" class="textarea2" readonly="true"></textarea></td>
					</tr>
				</table>
