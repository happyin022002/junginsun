...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0100 : ESM_PRI_0100 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0100() {
	 		...
	 		switch (sAction) {
				...
				case IBSEARCHAPPEND: // 조회
					...
					if(openSheet2YN) {
						...
						sheetObj.DoSearch("ESM_PRI_0100GS.do" , FormQueryString(formObj));
					} else {
						var sArr = dialogArguments.getSheetXml(0);
						var sXml = sArr[1];
						sheetObj.LoadSearchXml(sXml);
	 			...
	 			case IBSEARCH_ASYNC01: // 조회
					...
					var sXml = sheetObj.GetSearchXml("ESM_PRI_0100GS.do", FormQueryString(formObj));
		  			...
		  			if((ComShowCodeConfirm("PRI00001")) ) {
		  				...
		  				if(sheetObj.IsDataModified) {	
							...
							var sParam = FormQueryString(formObj);
			  				...
			  				var sXml = sheetObj.GetSaveXml("ESM_PRI_0100GS.do", sParam);
				  			...
				  			var sXml = sheetObj.GetSaveXml("ESM_PRI_0100GS.do", FormQueryString(formObj));
				  			sheetObj.LoadSaveXml(sXml);
		  				}
