...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0102 : ESM_PRI_0102 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0102() {
	 			...
	 			case IBSEARCH_ASYNC01: // 조회
					...
					var sNm = sheetObj.GetComboInfo(0,"chg_rule_def_cd","Text");
		 			...
		 			formObj.f_cmd.value = SEARCH03;
	  				var sXml = sheetObj.GetSearchXml("ESM_PRI_0102GS.do", FormQueryString(formObj));
		  			...
		  			if((ComShowCodeConfirm("PRI00001")) ) {
		  				...
		  				if(sheetObj.IsDataModified) {
							...
							var sParam = FormQueryString(formObj);
			  				...
			  				var sXml = sheetObj.GetSaveXml("ESM_PRI_0102GS.do", sParam); 
							...
							ComOpenWait(true);
				  			...
				  			var sXml = sheetObj.GetSaveXml("ESM_PRI_0102GS.do", FormQueryString(formObj));
				  			sheetObj.LoadSaveXml(sXml);
		  				}
