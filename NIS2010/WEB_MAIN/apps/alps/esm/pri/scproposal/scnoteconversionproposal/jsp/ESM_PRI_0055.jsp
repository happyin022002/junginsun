...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0055Event"%>
...
<html>
<head>
<title>Special Note Conversion - Inquiry</title>
...
<input type="hidden" name="note_seq" value="<%=request.getParameter("note_seq")%>">
<input type="hidden" name="note_ctnt_seq" value="<%=request.getParameter("note_ctnt_seq")%>">
	...
	<tr>
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp; Special Note Conversion - Inquiry</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) --> <!-- 1 (S) -->
		<table class="search" id="mainTable">
			<tr>
				...
				<table class="search">
					<tr>
						<td valign="top" width="40%"><!-- Grid-1  (S) -->
						...
						<td valign="top" width="67%"><!-- Grid-2  (S) -->
						<table width="100%" id="mainTable">
							<tr>
