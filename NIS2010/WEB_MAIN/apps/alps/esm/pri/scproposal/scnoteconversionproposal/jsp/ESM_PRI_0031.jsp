...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0031Event"%>
...
<html>
<head>
<title>Commodity Note Conversion</title>
				...
				<table width="100%" class="grid2">
					<tr>
						<td class="noinput2"><textarea name="note_ctnt" 
							style="height: 97; width: 100%; font-size: 9pt;" class="noinput2" readonly="true"></textarea></td>
					</tr>
				</table>
