 ...
 * 1.0 Creation 
 ===============================================================================================
 * History
 * 2018.01.10 최초생성 송민석 [CHM-201537788] SC 다운로드 보안 강화 _ 2차 개발
===============================================================================================*/

    /**
	 * @extends
	 * @class ESM_PRI_0034 : ESM_PRI_0034 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
    function ESM_PRI_0034() {
    ...
    function processButtonClick() {
        ...
        try {
            ...
            case "btn_amdhistory":
                ...
                comCallPop(pgmNo, "ESM_PRI_0034", popParams, "");
                break;
            }
        }catch(e){
			if( e == "[object Error]") {
...
//					SheetWidth = mainTable.clientWidth;
					...
					// TOOLTIP, ALLCHECK, SAVESTATUS, FORMATFIX]
		                ...
		                InitDataProperty(0, cnt++, dtData, 200, daLeft, false, "ui_name", false, "", dfNone, 0, false, false);
		                InitDataProperty(0, cnt++, dtData, 130, daCenter, false, "inquiry_time", false, "",  dfNone, 0, false, false);                
        ...
        try{
            ...
            case IBSEARCH: // 조회
            	if(validateForm(sheetObj,formObj,sAction)) {
					...
					var sXml = sheetObj.GetSearchXml("ESM_PRI_0034GS.do", sParam);
