...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6090 : ESM_PRI_6090 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6090() {
    ...
    document.onclick = processButtonClick;
        ...
        function changeHeaderName(){
    		...
    		sheetObjects[0].CellValue(0,"prs_prop_scp_mqc_qty") = "MQC("+formObj.frm_cntr_lod_ut_text.value+")";
        }
       ...
       */ 
        function initSheet(sheetObj,sheetNo) {
            ...
            var mqc = document.form.frm_prop_mqc_qty.value;
            if( mqc == ""){
            	mqc = "0";
            }
            switch(sheetObj.id) {
    			...
    			case "sheet1":      // sheet1 init
                    with (sheetObj) {
                       ...
                       //전체Edit 허용 여부 [선택, Default false]
                        ...
                        var HeadTitle1  = "|Seq.|SVC Scope|MQC(FEU)|Share(%)|calc_flg|prop_no|amdt_seq";
    					...
    					InitDataProperty(0, cnt++ , dtAutoSum,		80,		daRight,	false,		"prs_prop_scp_mqc_qty",	false,  "",			dfNullFloat,2,	true,		true);
            ...
            switch(sAction) {
               ...
               case IBSEARCH:      //조회
      		    ...
      		    formObj.f_cmd.value = SEARCH;
   				...
   				ComOpenWait(true);   
   				sheetObj.RemoveAll();
   				var sXml = sheetObj.GetSearchXml("ESM_PRI_6090GS.do", FormQueryString(formObj) );
			 ...
			 case IBSAVE:        //저장
			 	...
			 	sheetObj.DoSave("ESM_PRI_6090GS.do",FormQueryString(formObj) );
			 	ComOpenWait(false);   
                break;
            }
        }
