...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0036 : ESM_PRI_0036 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_0036() {
...
//					sheetObj.CellValue(1,"ibflag")="I";
					...
					var sXml = sheetObj.GetSaveXml("ESM_PRI_0036GS.do", sParam);
    ...
    function checkProposalStatus(){
        ...
        var sXml = sheetObj.GetSearchXml("ESM_PRI_0036GS.do" , sParam);
        var arrData = ComPriXml2Array(sXml, "etc1");         
        if (arrData !=null && arrData.length > 0){
       	 if (arrData[0][0] == "F"){//filed이면
           	 rValue ="Y";
            }
        }
        return rValue;       
