...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scproposalmain.event.EsmPri0028Event"%>
...
<%
	EsmPri0028Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0028Event) request.getAttribute("Event");
...
<%=JSPUtil.getIBCodeCombo("s_scrn_prog_cd", "", "CD03455", 0, "")%>   // sp screen program code
