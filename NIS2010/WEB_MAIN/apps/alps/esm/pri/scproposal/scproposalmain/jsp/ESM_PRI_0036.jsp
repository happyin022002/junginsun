...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scproposalmain.event.EsmPri0036Event"%>
...
<tr><td valign="top">
    ...
    <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; Amendment Request</td></tr>
    </table>
    <!-- : ( Title ) (E) -->		
	<!--biz page (S)-->
		<table class="search"> 
	...
	<table class="search" border="0" style="width:450;"> 
				<tr class="h23">
				    ...
				    <td width=""><input type="text" style="width:159;" name="sc_no" readonly value="<%=sc_no%>" class="input2"></td>
				</tr>
				<tr class="h23">
					<td width="">Duration</td>
				    <td width=""><input type="text" style="width:70;" name="ctrt_eff_dt" readonly  class="input2" maxlength="10" dataformat="ymd" caption="Effective date" cofield="ctrt_exp_dt">&nbsp;~&nbsp;<input type="text" style="width:70;" name="ctrt_exp_dt" readonly=true class="input2" maxlength="10" dataformat="ymd" caption="Expiration date" cofield="ctrt_eff_dt"></td>
				</tr>
				</table> 
