...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scgrouplocationproposal.event.EsmPri000402Event"%>
...
<%
	EsmPri000402Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri000402Event)request.getAttribute("Event");
