...
=========================================================
* History
* 2011.11.10 서미진 [CHM-201114405]  Location 정보 조회되도록 컬럼 추가
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0041 : ESM_PRI_0041 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
	   ...
	   try {
	 		...
	 		switch (sAction) {																		
	 			...
	 			case IBSEARCH: // 조회
		 			...
		 			var sXml = sheetObj.GetSearchXml("ESM_PRI_0041GS.do", FormQueryString(formObj));
