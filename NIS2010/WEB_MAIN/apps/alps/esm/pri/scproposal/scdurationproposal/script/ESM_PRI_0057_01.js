...
/**
 * @extends
 * @class ESM_PRI_0057_01 : ESM_PRI_0057_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
        ...
        case "sheet1":
            with (sheetObj) {
               ...
               //전체Edit 허용 여부 [선택, Default false]
                ...
                InitDataProperty(0, cnt++ , dtData,			100, daCenter, false, "ctrt_eff_dt",	  false, "", dfDateYmd, 0,	false,	true);
                InitDataProperty(0, cnt++ , dtData,			100, daCenter, false, "ctrt_exp_dt",	  false, "", dfDateYmd,	0,	false,	true);
...
//페이지가 LOAD완료 되었는지 확인하는 변수(메인에서확인한다.)
var loadSts = false;
/**
