...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scdurationproposal.event.EsmPri0019Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.SCProposal.SCDurationProposal");
...
<input type="hidden" name="save_all" >
<input type="hidden" name="amendcancel_gbn" >
<input type="hidden" name="mn_ctrt_eff_dur" >
<input type="hidden" name="mn_ctrt_exp_dur" >
<!-- OUTER - POPUP (S)tart -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="120">
						<input type="text" name="sc_no1" style="width:50;text-align:center;" class="input2" value="<%=scNo1%>">&nbsp;<input type="text" name="sc_no2" style="width:50;text-align:center;" class="input2" value="<%=scNo2%>"></td>
				...
				<tr class="h23">
					<td width="">SVC Scope</td>
					<td colspan="4" style="padding-left:2">
						<script language="javascript">ComComboObject('svc_scp_cd', 2, 50, 0, 1, 0, false);</script>&nbsp;<input name="svc_scp_nm" type="text" style="width:165;"  value="" class="input2" readonly caption="Service Scope">
						</td></tr>
				</table>
