...
<%@ page import="com.hanjin.apps.alps.esm.pri.scproposal.scnoteproposal.event.EsmPri000408Event"%>
...
<table class="search">
	<tr>
		...
		<table class="search">
			<tr>
				<td class=""><!--  biz_2  (S) -->
				<table border="0" style="width: 879;" class="search">
					<tr class="h23">
						<td width="30">Year</td>
