...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scgroupcommodityquotation.event.EsmPri600502Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri600502Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri600502Event)request.getAttribute("Event");
