...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6013_02 : ESM_PRI_6013_02 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6013_02() {
		...
		switch (sheetID) {
			...
			case "sheet2":
				with (sheetObj) {
					...
					var HeadTitle = "|Seq.|qttn_no|qttn_ver_no|Group Commodity Seq.|Group Commodity Detail Seq.|type code|CMDT Code|Description|src_info_cd|Source";
					...
					InitDataProperty(0, cnt++, dtHidden, 100, daCenter, false, "prc_cmdt_tp_cd", false, "", dfEngUpKey, 0, false, false);
					InitDataProperty(0, cnt++, dtData, 100, daCenter, false, "prc_cmdt_def_cd", false, "", dfEngKey, 0, true, true, 6, false);
					InitDataProperty(0, cnt++, dtData,		250,	daLeft,	  true,	  "prc_cmdt_def_nm",	false,	"",	dfNone,	0, true,  true);	
			...
			case IBSEARCH: // 조회
				if (validateForm(sheetObj,document.form,sAction)) {
					...
					try {
						...
						sheetObj.DoSearch("ESM_PRI_6013_02GS.do" , FormQueryString(formObj));
						ComOpenWait(false);
    ...
    */
     ...
     */
 	function sheetColResize() {
 		...
 		sheetObj2.FitColWidth("0|8|0|0|0|0|0|20|45|0|20");
