...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6078 : ESM_PRI_6078 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6078() {
            ...
            case IBSEARCH:      //조회
 				switch (sheetObj.id){
 					case "sheet1":
	 		            ...
	 		            sheetObj.DoSearch("ESM_PRI_6078GS.do", FormQueryString(formObj) + "&table_cd=SP");
	 		            ComOpenWait(false);
	 	                break;
 					case "sheet2":
 						ComOpenWait(true);
	 		            ...
	 		            sheetObj.DoSearch("ESM_PRI_6078GS.do", param);
	 		            ComOpenWait(false);
	 	                break;
 				}
 				break;
