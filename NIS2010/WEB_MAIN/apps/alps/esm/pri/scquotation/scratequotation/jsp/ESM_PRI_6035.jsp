...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scratequotation.event.EsmPri6035Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmPri6035Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri6035Event)request.getAttribute("Event");
...
<html>
<head>
<title>S/C Quotation-Rate View All</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;S/C Quotation Rate- View All</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
