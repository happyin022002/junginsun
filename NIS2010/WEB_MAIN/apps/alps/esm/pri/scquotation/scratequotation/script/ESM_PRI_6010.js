...
*@FileName : ESM_PRI_6010.js
*@FileTitle : S/C Quotation Rate - Origin & Destination
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class S/C Quotation Rate - Origin & Destination : S/C Quotation Rate - Origin & Destination 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6010() {
...
//		  				  			  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX] 
 					...
 					InitDataProperty(0, cnt++, dtHidden, 100, daCenter, false, "gen_spcl_rt_tp_cd", false, "", dfNone, 0, true, true);
...
//	 					alert(sheetObj.CellValue(Row,"display_seq"))
	 				}else{	
 	    			...
 	    			var param = "&etc1=" + formObj.qttn_no.value + "&etc2=" + formObj.qttn_ver_no.value	+ "&etc5=SQ";	
