...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scratequotation.event.EsmPri601303Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601303Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri601303Event)request.getAttribute("Event");
