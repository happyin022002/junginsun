...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6012 : ESM_PRI_6012 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6012() {
 ...
 document.onclick = processButtonClick;
 			...
 			case "sheet3":      //sheet3 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					InitDataProperty(0, cnt++ , dtCombo,    		35,   	daCenter,  	true,		"per",			false,          "",      dfNone,      		0,			true,       true);
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
 				...
 				if ( sheetObj.id == "sheet1"){
 					...
 					var params = FormQueryString(formObj) ;
  					sheetObj.DoSearch("ESM_PRI_6012GS.do", params);
 				}
 				ComOpenWait(false);
                break;
 			...
 			case IBSAVE:        //저장
                ...
                var sXml = sheetObjects[1].GetSaveXml("ESM_PRI_6012GS.do", sParam);
    ...
    function selectFirstRow(sheetObj,value,col){
		...
		if(row >= 0 ) sheetObj.SelectRow =row; 
    }
    ...
    function searchLocViaCd(sheetObj,row,col,changeColName){
		...
		case "dest_term_cd" :
  		...
  		var sXml = sheetObj.GetSearchXml("ESM_PRI_6012GS.do", params );
