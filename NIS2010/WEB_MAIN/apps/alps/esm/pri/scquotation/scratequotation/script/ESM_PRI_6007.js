...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        ...
        case IBSAVE: // Save
            ...
            try {
	            ...
	            var sXml = sheetObj.GetSaveXml("ESM_PRI_6007GS.do", sParam);
	...
	//                    }
	                ...
	                if (perTypeCode != "" || cargoTypeCode != "" || qttnRate != "") {
	        		    chkMdtryRate = true;
	        			if (perTypeCode == "") {
	            ...
	            var sParam = FormQueryString(formObj) + "&" + sheetObj.GetSaveString();
	            var sXml = sheetObjects[1].GetSearchXml("ESM_PRI_6007GS.do", sParam);
    ...
    /**
     * 텝키를 누르면 ckeck 후 check 된 다음 컬럼을 찾아 선택한다. <br>
     * <br><b>Example :</b>
     * <pre>
     *     clearTooltip()
     * </pre>
