...
*@FileName : ESM_PRI_6011.js
*@FileTitle : S/C Quotation Creation - Commodity 
*Open Issues :
*Change history :
              ...
              case "sheet1":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     var HeadTitle = "|Sel.|Seq.|1|2|3|4|5|6|CMDT Type|CMDT Code|Commodity Description|Sort Order";
...
//				alert(sheetObj.CellValue(idx, "gen_spcl_rt_tp_cd"))
...
//					sheetObj.RowStatus(i) = prevRowStatus;
				}
   ...
   function sheet1_OnChange(sheetObj, Row, Col, Value)
   {
	...
	function sheet1_OnPopupClick(sheetObj, Row, Col)
	{
		...
		if (colName == "prc_cmdt_def_cd"){
			var sUrl = "/hanjin/ESM_PRI_4027.do?commodity_cmd=CG&grp_cd="+PRI_SQ+"&qttn_no="+formObj.qttn_no.value+"&qttn_ver_no="+formObj.qttn_ver_no.value;
