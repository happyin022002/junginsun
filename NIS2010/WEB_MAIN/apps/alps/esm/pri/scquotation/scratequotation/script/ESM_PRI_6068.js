...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6068 : ESM_PRI_6068 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6068() {
 ...
 document.onclick = processButtonClick;
     ...
     */       
     ...
     /**  
     * Combo에서 필요한 코드를 조회해서 Combo에 Assign 한다.
     * 화면에 Setting 해 놓는다.
     *  
     * <br><b>Example :</b>
     * <pre>
              ...
              case "sheet1":      //sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"qttn_no",   			false,          "",      dfNone,      		0,			false,      true);
 					InitDataProperty(0, cnt++ , dtHidden,				120,   	daCenter,  	true,		"qttn_ver_no",   			false,          "",      dfNone,      		0,			false,      true);
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
	            ...
	            sXml = sheetObj.GetSearchXml("ESM_PRI_6068GS.do", FormQueryString(formObj) );
 			...
 			case IBSAVE:        //저장
				...
				var sXml = sheetObj.GetSaveXml("ESM_PRI_6068GS.do", sheetObj.GetSaveString() + "&" + FormQueryString(formObj)  );
         ...
         case IBSAVE: // 저장
		   ...
		   //필수 입력과 같은 확인이 이루어짐
		     if ( saveStr == ""){
         	 ...
         	 var colNames = "qttn_no|qttn_ver_no|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|rt_seq|chg_cd";
         	 //중복체크
