...
*@FileName : ESM_PRI_6010.jsp
*@FileTitle : : S/C Quotation Rate-Route Point
*Open Issues :
*Change history :
...
<html>
<head>
<title>S/C Quotation Rate - Route Point</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; S/C Quotation Rate - Route Point</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
