...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scratequotation.event.EsmPri6062Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6062Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6062Event)request.getAttribute("Event");
