...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scratequotation.event.EsmPri6078Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6078Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6078Event)request.getAttribute("Event");
