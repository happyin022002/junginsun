...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6062 : ESM_PRI_6062 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6062() {
 ...
 document.onclick = processButtonClick;
     ...
     function loadPage() {
		...
		//GEM일경우 btn2_Simulation버튼을 쓰지 못하도록 이름을 바꿔버린다.
		//GEM을 닫고 alps정식오픈 후  삭제해야함.
		ComPriMakeButtonUseless("btn2_Simulation");
		ComOpenWait(false);
              ...
              case "sheet1":      //sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					InitDataProperty(0, cnt++ , dtData,    			160,   	daCenter,  	true,		"ts_route",   			false,          "",      dfNone,      		0,			false,       false);
 					...
 					InitDataProperty(0, cnt++ , dtData,    			70,   	daCenter,  	true,		"rdterm",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtData,    			60,   	daCenter,  	true,		"svc_lane",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtData,    			70,   	daCenter,  	true,		"ttl_tztm_hrs",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtData,    			0,   	daCenter,  	true,		"respb_usd_ttl_amt",   			false,          "",      dfNullFloat,      		2,			false,       false);
 					
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"rout_cs_no",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"rout_cs_src_dt",   			false,          "",      dfNone,      		0,			false,       false);
 					
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"qttn_no",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"qttn_ver_no",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"gen_spcl_rt_tp_cd",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"cmdt_hdr_seq",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"rout_seq",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"rt_seq",   			false,          "",      dfNone,      		0,			false,       false);
 					InitDataProperty(0, cnt++ , dtHidden,    			100,   	daCenter,  	true,		"cost_tp",   			false,          "",      dfNone,      		0,			false,       false);
         ...
         switch(sAction) {
 			...
 			case IBSEARCH:      //조회
 				...
 				if ( sheetObj.id == "sheet1"){
 		            ...
 		            sheetObj.DoSearch("ESM_PRI_6062GS.do", FormQueryString(formObj)  );
 				...
 				if ( sheetObj.id == "sheet2"){
 		            ...
 		            sheetObj.DoSearch("ESM_PRI_6062GS.do", FormQueryString(formObj) +param  );
 				}
 				ComOpenWait(false);
                break;
 			case IBSAVE:        //저장
				...
				var r = sheetObj.DoSave("ESM_PRI_6062GS.do",  "f_cmd="+MULTI );
				if( r == true ){
 			...
 			case IBSEARCH_ASYNC01:
				...
				var param = FormQueryString(formObj) + "&popup_type=SQ";
