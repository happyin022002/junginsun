...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scgrouplocationquotation.event.EsmPri601301Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri601301Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.SCQuotation.SCGroupLocationQuotation");
	...
	try {
		...
		event = (EsmPri601301Event)request.getAttribute("Event");
