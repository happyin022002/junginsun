...
*@FileName : ESM_PRI_6013_01.js
*@FileTitle : S/C Quotation Location Group Inquiry
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_6013_01 : ESM_PRI_6013_01 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6013_01() {
		...
		switch (sheetID) {
			case "sheet1":
				with (sheetObj) {
					...
					var HeadTitle = "|Seq.|Service Scope|Gline Seq.|Group Location Seq.|Group Code|Description|src_info_cd";
			...
			case IBSEARCH: // 조회
				if (validateForm(sheetObj,document.form,sAction)) {
					...
					try {
						...
						sheetObj.DoSearch("ESM_PRI_6013_01GS.do" , FormQueryString(formObj));
						ComOpenWait(false);
    ...
    */
     ...
     */
 	function sheetColResize() {
 		...
 		sheetObj2.FitColWidth("0|8|0|0|0|0|20|45|0|20");
