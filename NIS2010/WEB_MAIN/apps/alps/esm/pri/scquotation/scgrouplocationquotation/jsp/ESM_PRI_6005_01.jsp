...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scgrouplocationquotation.event.EsmPri600501Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri600501Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri600501Event)request.getAttribute("Event");
