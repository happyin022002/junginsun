...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends Pri
     * @class ESM_PRI_6034 : ESM_PRI_6034 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_6034() {
            ...
            switch (sAction) {
                ...
                case IBSAVE: // 저장
                    ...
                    try {
	        			...
	        			var sXml = sheetObj.GetSaveXml("ESM_PRI_6034GS.do", FormQueryString(formObj));
