...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scquotationmain.event.EsmPri6005Event"%>
<%@ page import="com.hanjin.apps.alps.esm.pri.pricommon.pricommon.vo.RsltCdListVO"%>
<%@ page import="com.hanjin.apps.alps.esm.pri.common.PRIUtil"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6005Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6005Event)request.getAttribute("Event");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
		...
		<table class="search"> 
			...
			<!-- biz_1  (S) -->
				...
				<tr class="h23">
					...
					<td width="80"><input type="text" name="qttn_ofc_cd" style="width:53;text-align:center;" class="input2" value="<%=strUsr_office_cd %>" readonly></td>
					<td width="90">Sales Rep.</td>
					<td width="214"><script language="javascript">ComComboObject('qttn_srep_cd', 2, 68, 0, 1, 0, false);</script>
					&nbsp;<input type="text" name="qttn_srep_nm" style="width:73;" class="input2" value="" readonly></td>
				...
				<tr class="h23">
					...
					<td colspan='3' style="padding-left:2"><script language="javascript"> ComComboObject('svc_scp_cd', 2, 53, 0, 1, 0, false);</script>
					&nbsp;<input name="svc_scp_nm" type="text" style="width:223;"  value="" class="input2" readonly></td>
					<td>Creation Date</td>
				...
				<tr class="h23">
					...
					<td width="585">
					<input type="text" style="width:30;text-align:center;" dataformat="engup" maxlength="2" minlength="2" name="cust_cnt_cd" class="input1" caption="Customer Code" required>
					<input type="text" style="width:60;text-align:center;" dataformat="int" name="cust_seq" maxlength="6" class="input1" caption="Customer Code" required>
					<a href="javascript:popupCustomer();">
					<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btn_ctrt_cust_tp_pop" class="cursor"></a>
					<input type="text" name="cust_nm" style="width:403;" class="input2" value="" readonly>&nbsp;<script language="javascript">ComComboObject('prc_cust_tp_cd', 2, 52, 0, 1, 0, false);</script></td> 
					<td width="93" style="padding-left:10">Estimate MQC</td>
					<td width="" style="padding-left:3"><input type="text" name="estm_mqc_qty" dataformat="int" maxlength="6" style="width:114;text-align:right;" class="input" value="1">
					&nbsp;<script language="javascript">ComComboObject('cntr_lod_ut_cd', 1, 60, 0, 0, 0, false);</script></td>
				</tr>
				<tr class="h23">
					<td colspan="2"></td> 
					<td  style="padding-left:10">Estimate CM</td>
	...
	<table class="height_8"><tr><td></td></tr></table>
            ...
            <div id="tabLayer" style="display:none">
            <iframe name="t2frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="350" src="about:blank"></iframe>
            </div>
            <div id="tabLayer" style="display:none">
            <iframe name="t3frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="685" src="about:blank"></iframe>
            </div>
            <!-- 
            <div id="tabLayer" style="display:none">
            <iframe name="t4frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="685" src="about:blank"></iframe>
            </div>
             -->            
			<!-- iFrame (E) -->
