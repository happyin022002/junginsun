...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scquotationmain.event.EsmPri6013Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri6013Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri6013Event)request.getAttribute("Event");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
    ...
    <!--Button (E) -->
		...
		<table class="search"> 
			...
			<!-- biz_1  (S) -->
				...
				<tr class="h23">
					...
					<td width="65">Ver. No.</td>
					<td width="65"><script language="javascript">ComComboObject('qttn_ver_no', 1, 50, 0, 0, 0, false);</script></td> 
					<td width="110">Request Office</td>
					<td width="60"><input type="text" dataformat="engup" name="qttn_ofc_cd" style="width:50;text-align:center;" class="input" value="" required ></td>
					<td width="79">Sales Rep.</td>
					<td width="220"><script language="javascript">ComComboObject('qttn_srep_cd', 2, 70, 0, 0, 0, false);</script>
					...
					<td width="100">
					&nbsp;~&nbsp;<input name="cre_dt_to" type="text" style="width:78;text-align:center;"  value="" class="input" caption="Creation Date" maxlength="10" dataformat="ymd" required>
					</td>
					<td width="" align="left">
				...
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">	
					<td width="92">SVC Scope</td>
					<td width="200"><script language="javascript"> ComComboObject('svc_scp_cd', 2, 60, 0, 0, 0, false);</script>&nbsp;<input name="svc_scp_nm" type="text" style="width:125;" value="" class="input2" readonly></td>
					<td width="95">Customer Type</td>
					<td width="57"><script language="javascript">ComComboObject('prc_cust_tp_cd', 2, 50, 0, 0, 0, false);</script></td>
					<td width="62">Customer</td>
					<td width="350"><input type="text" style="width:30;text-align:center;" dataformat="engup" maxlength="2" minlength="2" name="cust_cnt_cd" class="input" caption="Customer Code" required>
					...
					<input type="text" name="cust_nm" style="width:216;" class="input2" value="" readonly>
					</td>
					<td>Status&nbsp;<script language="javascript">ComComboObject('qttn_status', 1, 79, 0, 0, 0, false);</script></td>
				</tr>
				</table>
				
				<table class="line_bluedot"><tr><td colspan="8"></td></tr></table>
				<table class="search" border="0" style="width:100%;"> 
					<tr class="h23"><td class="stm" align="right">[Unit:FEU/USD]</td></tr>
				</table>
				...
				<tr class="h23">
					...
					<td width="90"><input type="text" name="qttn_no_read" style="width:80;text-align:center;" class="input2" value="" maxlength="10" readonly></td>
					<td width="50">Ver. No.</td>
					<td width="50"><input type="text" name="qttn_ver_no_read" style="width:40;text-align:center;" class="input2" value="" readonly></td> 
					<td width="90">Request Office</td>
					<td width="60"><input type="text" name="qttn_ofc_cd_read" style="width:50;text-align:center;" class="input2" value="" readonly></td>
					<td width="65">Sales Rep.</td>
					<td width="200"><input type="text" name="qttn_srep_cd_read" style="width:55;text-align:center;" class="input2" value="" readonly>&nbsp;<input type="text" name="qttn_srep_nm_read" style="width:126;" class="input2" value="" readonly></td>
					<td width="93">Duration</td>   
					<td width="82">
					<input name="eff_dt_read" type="text" style="width:80;text-align:center;"  value="" class="input2" maxlength="10" readonly>
					</td>
					<td width="">&nbsp;&nbsp;~&nbsp;&nbsp;<input name="exp_dt_read" type="text" style="width:81;text-align:center;"  value="" class="input2" maxlength="10" readonly>
					</td>
				</tr>
				...
				<tr class="h23">
					...
					<td>Service Scope</td>
					<td colspan='3'><input type="text" name="svc_scp_cd_read" style="width:50;text-align:center;" class="input2" value="" readonly>&nbsp;<input name="svc_scp_nm_read" type="text" style="width:256;"  value="" class="input2" readonly></td>
					<td>Creation Date</td>
				...
				<tr class="h23">
					...
					<input type="text" style="width:60;text-align:center;" name="cust_seq_read" class="input2" readonly>&nbsp;<input type="text" name="cust_nm_read" style="width:456;" class="input2" value="" readonly>
					&nbsp;<input type="text" style="width:30;text-align:center;" name="prc_cust_tp_cd_read" class="input2" readonly>
					</td> 
					<td width="98">Estimate MQC</td>
					<td width="200"><input type="text" name="estm_mqc_qty_read" style="width:118;text-align:right;" class="input2" value="" readonly>
					&nbsp;<input type="text" name="cntr_lod_ut_cd_read" style="width:61;text-align:center;" class="input2" value="" readonly>
					</td>
				</tr>
				<tr class="h23">
					<td colspan="2"></td> 
					...
					&nbsp;<input type="text" style="width:61;text-align:center;" class="input2" value="USD" readonly></td>
				</tr>
				</table>
			<!-- biz_1  (E) -->
		...
		<table class="height_8"><tr><td></td></tr></table>
            ...
            <iframe name="t1frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="320" src="about:blank"></iframe>
            </div>
            <div id="tabLayer" style="display:none">
            <iframe name="t2frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="320" src="about:blank"></iframe>
            </div>
            <div id="tabLayer" style="display:none">
            <iframe name="t3frame" id="t1frame" frameborder="0" scrolling="no" width="100%" height="590" src="about:blank"></iframe>
            </div>
