...
*@FileName : ESM_PRI_6034.jsp
*@FileTitle : S/C Quotation Copy to Quotation
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esm.pri.scquotation.scquotationmain.event.EsmPri6034Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsmPri6034Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri6034Event)request.getAttribute("Event");
...
<html>
<head>
<title>S/C Quotation Copy to Quotation</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;  S/C Quotation Copy to Quotation</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
