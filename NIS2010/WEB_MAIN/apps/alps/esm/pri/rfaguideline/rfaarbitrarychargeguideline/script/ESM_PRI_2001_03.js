...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2001_03 : ESM_PRI_2001_03 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_PRI_2001_03() {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
        	...
        	case IBSEARCH_ASYNC01: // radio button select
				...
				var sXml = sheetObj.GetSearchXml("ESM_PRI_2001_03GS.do" , FormQueryString(formObj));
        	...
        	case IBSAVE:
				...
				var sParam = FormQueryString(formObj);
 				...
 				var sXml = sheetObj.GetSaveXml("ESM_PRI_2001_03GS.do", sParam+"&"+sParamSheet);
        	...
        	case MODIFY01:
				...
				var sXml = sheetObj.GetSaveXml("ESM_PRI_2001_03GS.do", sParamSheet);
				sheetObj.LoadSaveXml(sXml);
				ComOpenWait(false);
	            break;
