...
<%@ page import="com.hanjin.apps.alps.esm.pri.rfaguideline.rfaarbitrarychargeguideline.event.EsmPri200105Event"%>
...
<%
	EsmPri200105Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri200105Event)request.getAttribute("Event");
