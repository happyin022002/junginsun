   ...
   function sheet1_OnChange(sheetObj, Row, Col, Value)
   {
	...
	function sheet1_OnPopupClick(sheetObj, Row, Col)
	{
		...
		if (colName == "prc_cmdt_def_cd"){
			var sUrl = "/hanjin/ESM_PRI_4027.do?commodity_cmd=CRG&grp_cd="+PRI_RG+"&svc_scp_cd="+formObj.svc_scp_cd.value+"&gline_seq="+formObj.gline_seq.value + "&prc_cmdt_tp_cd=" + sheetObj.CellValue(sheetObj.SelectRow, "prc_cmdt_tp_cd");
