...
// 	  				  				  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX] 
    				 ...
    				 InitDataProperty(0, cnt++, dtHidden, 90, daLeft, false, "cmdt_seq", false, "", dfNone, 0, false, false);
    				
                     InitDataProperty(0, cnt++ , dtCombo,	  150,	daCenter,	false, "prc_cmdt_tp_cd",	false,	"",	dfNone,	0,	false,	false);
                     InitDataProperty(0, cnt++ , dtPopupEdit, 100,	daCenter,	false, "prc_cmdt_def_cd",	false,	"",	dfNone,	0,	false,	false, 6);
