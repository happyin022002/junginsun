     ...
     */
     ...
     //							  	  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX]
                     ...
                     InitDataProperty(0, cnt++ , dtData,     	 	100,    daCenter,  	false, 	"prc_grp_cmdt_cd",   	false, 	"", dfNone, 0, false, false,5,5);
 					 InitDataProperty(0, cnt++ , dtData,     	 	230,    daLeft,		false, 	"prc_grp_cmdt_desc", 	false, 	"", dfNone, 0, false, false, 30);
...
// 	                 InitDataProperty(0, cnt++ , dtDelCheck,     40,  daCenter,  false,	"del_chk");
                     InitDataProperty(0, cnt++ , dtDataSeq,  	 40,  daCenter,  true, 	"seq");
 	                 InitDataProperty(0, cnt++ , dtHidden,    	 40,  daCenter,  true,  "svc_scp_cd");
	                 InitDataProperty(0, cnt++ , dtHidden,    	 40,  daCenter,  true,  "gline_seq"); 
	                 InitDataProperty(0, cnt++ , dtCombo,      	 100,  daCenter,  true,	"prc_cmdt_tp_cd", 	false,	"",	dfNone,	0,	false,	false);
 ...
 //							  	  SORTENABLE, TOOLTIP, 	  ALLCHECK,   SAVESTATUS, FORMATFIX]
                     ...
                     InitDataProperty(0, cnt++ , dtData, 	 	 110, daCenter,  false, "prc_cmdt_def_cd");
	...
	function sheet1_OnSelectCell(sheetObj, OldRow, OldCol, NewRow, NewCol)  {
 	...
 	function doRowChange(sheetM, sheetD, OldRow, NewRow, OldCol, appendRow) {
 		...
 		if (OldRow != NewRow) {
			formObj.grp_cmdt_seq.value = sheetM.CellValue(NewRow,"grp_cmdt_seq")
