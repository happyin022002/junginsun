...
<%@ page import="com.hanjin.apps.alps.ees.ctm.emptyreleaseredeliveryordermgt.emptyreleaseredeliveryordermgt.event.EesCtm0428Event"%>
...
<html>
<head>
<title>Territories Management</title>
