...
<%@ page import="com.hanjin.apps.alps.ees.ctm.equipmentmovementmgt.containermovementfinder.event.EesCtm0408Event" %>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Each Container Inquiry</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;">
              <tr class="h23">
                ...
                <td width="220"><input type="text" style="width:85;ime-mode:disabled;" class="input1" maxlength="10" value="<%=pCntrno%>" tabindex="1" name="p_cntrno">
                                ...
                                <input type="text" style="width:0;ime-mode:disabled;" maxlength="1" tabindex="2" name="temp_0"></td>
                <td width="60">Duration</td>
                <td><input type="text" style="width:80;ime-mode:disabled; text-align:center;" class="input1" value="<%=pDate1%>" tabindex="3" name="p_date1">&nbsp;~
                    <input type="text" style="width:80;ime-mode:disabled; text-align:center;" class="input1" value="<%=pDate2%>" tabindex="4" name="p_date2">
                    <img src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" style="cursor:hand;" name="btn_Calendar"></td>
                <td width="80">At Risk(R/F)</td>
                <td><input type="text" style="width:30;ime-mode:disabled; text-align:center;" class="input" value="" tabindex="3" name="cntr_rsk_flg"></td>
              </tr>
            </table>
            <!-- biz_1 (E) -->
        ...
        <tr>
          <td class="bg"  style="height:467" valign="top">
            ...
            <table class="search" border="0">
              <tr>
                <td class="title_h"></td>
                <td class="title_s">EDI error message</td>
              </tr>
            </table>
            <!-- Grid  (S) -->
              ...
              <tr>
                ...
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      <td class="btn1_left"></td>
                      <td class="btn1" name="btn_bkg_inquiry">BKG&nbsp;Inquiry</td>
                      <td class="btn1_right"></td>
                    </tr>
                  </table>
                </td>
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      <td class="btn1_left"></td>
                      <td class="btn1" name="btn_delhist">DEL&nbsp;History</td>
                      <td class="btn1_right"></td>
                    </tr>
                  </table>
                </td>
