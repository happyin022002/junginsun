...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class ees_cgm_2028 : ees_cgm_2028 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_cgm_2028() {
        ...
        switch(sheetID) {
            ...
            case "sheet1":
                with (sheetObj) {
                    ...
                    HeadTitle2 = HeadTitle2 + "|Total|CLG|UMG";
                    ...
                    InitDataProperty(0, cnt++ , dtHiddenStatus,	30,	daCenter, true,	"ibflag");
 					InitDataProperty(0, cnt++ , dtData,		100,	daCenter, true,	"sts_evnt_ofc_cd",	false, "", dfNone,		0, false, true);
 					InitDataProperty(0, cnt++ , dtData,		100,	daCenter, true,	"old_vndr_seq",	  	false, "", dfNone,		0, false, true);
 					InitDataProperty(0, cnt++ , dtData,		110,	daCenter, true,	"old_agmt_no", 		false, "", dfNone,		0, false, true);
 					InitDataProperty(0, cnt++ , dtData,		80,		daCenter, true,	"old_agmt_lstm_cd",	false, "", dfNone,		0, false, true);
 					
 					InitDataProperty(0, cnt++ , dtData,		100,	daCenter, true,	"new_vndr_seq",	  	false, "", dfNone,		0, false, true);
 					InitDataProperty(0, cnt++ , dtData,		110,	daCenter, true,	"new_agmt_no", 		false, "", dfNone,		0, false, true);
 					InitDataProperty(0, cnt++ , dtData,		80,		daCenter, true,	"new_agmt_lstm_cd",	false, "", dfNone,		0, false, true);
 					InitDataProperty(0, cnt++ , dtAutoSum,	100,	daRight,  true,	"Total",	  		false, totalVal, dfNullInteger,	0, false, true);
 					InitDataProperty(0, cnt++ , dtAutoSum,	100,	daRight, true,	"eq_tpsz_cd_clg",	false, "", dfNullInteger,	0, false, true);
 					InitDataProperty(0, cnt++ , dtAutoSum,	100,	daRight, true,	"eq_tpsz_cd_umg",	false, "", dfNullInteger,	0, false, true);
        ...
        switch(sAction) {
        	...
        	case IBSEARCH:      //조회
        		...
        		sheetObj.WaitImageVisible=false;
		 	    ComOpenWait(true);
        		// 조회실행
	     		var sXml = sheetObj.GetSearchXml("EES_CGM_2028GS.do" , FormQueryString(formObj), '', true);
...
*/       
     ...
     */  
 	function sheet1_OnSearchEnd(sheetObj, ErrMsg)
 	{
 		with(sheetObj)
 		{
 			ShowSubSum("sts_evnt_ofc_cd", "8|9|10", -1, false, false, 0, "new_agmt_lstm_cd=Office Total");
 		}
 	}
     ...
     function sheet1_OnDblClick(sheetObj, Row, Col, CellX, CellY, CellW, CellH){
     	...
     	var sAgmtLstmCd  = document.form.old_agmt_lstm_cd.Text;
     	var s2AgmtLstmCd = document.form.new_agmt_lstm_cd.Text;
     	
     	if(colSaveName == 'eq_tpsz_cd_clg') 		eqTpszCd = "CLG";
     	else if(colSaveName == 'eq_tpsz_cd_umg')	eqTpszCd = "UMG";
     	
     	if( sheetObj.CellValue(Row, "new_agmt_lstm_cd")== "Office Total" ){
     		stsEvntOfcCd = sheetObj.cellValue(Row-1, "sts_evnt_ofc_cd");
  	   } else if( sheetObj.CellValue(Row, "sts_evnt_ofc_cd")== "TOTAL" ){
