...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ees_cgm_2023 : ees_cgm_2023 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_cgm_2023() {
    			...
    			case "btn_New":
   				...
   				case "btn_VersionDetails":	// Version Detail
   					if(formObject.agmt_no.value != ''){
						...
						ComOpenPopup('/hanjin/EES_CGM_2103.do' + param, 900, 500, "", "1,0", true, false);
					}
   					break;
   				...
   				case "btn_Print":			// Print (RD Open)
 					...
 					ComOpenPopupWithTarget('/hanjin/EES_CGM_2204.do', 775, 800, "", "0,1,1,1,1,1,1", true);
   					break;
         ...
         switch(sheetNo) {
         	case 1:      // sheet1 init
         		with (sheetObj) {
					...
					InitDataProperty(0, cnt++ ,    dtData, 80,  daCenter,	false,	"agmt_iss_ofc_cd",	false,	"",	dfNone,	0, false, true);
					InitDataProperty(0, cnt++ ,    dtData,	95,	 daCenter,	false,	"agmt_dt",			false,	"",	dfNone, 0, false, true);
					InitDataProperty(0, cnt++ ,    dtData,	65,	 daCenter,	false,	"agmt_lstm_cd",		false,	"",	dfNone,	0, false, true);
					InitDataProperty(0, cnt++ ,    dtData, 200,  daCenter,	false,	"effective_date",	false,	"",	dfNone,	0, false, true);
					InitDataProperty(0, cnt++ ,    dtData,	60,	 daCenter,	false,	"vndr_seq",			false,	"",	dfNone,	0, false, true);
					InitDataProperty(0, cnt++ ,    dtData, 330,  daLeft,	false,	"vndr_lgl_eng_nm",	false,	"",	dfNone,	0, false, true);
					...
					InitDataProperty(0, cnt++ ,    dtData,	90,	 daCenter,	false,	"upd_dt",			false,	"",	dfNone,	0, false, true);
