...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetagreement.event.EesCgm2028Event"%>
       		...
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td style="padding-left:2;">
						<script language="javascript">ComComboObject('old_agmt_lstm_cd', 1, 200, 0, 0, 0, false);</script>&nbsp;<!--input type="text" name="old_agmt_lstm_cd_text" style="width:145" class="input" value=""--></td>
					<td width="65">New Term</td>
					<td style="padding-left:2;">
						<script language="javascript">ComComboObject('new_agmt_lstm_cd', 1, 200, 0, 0, 0, false);</script>&nbsp;<!--input type="text" name="new_agmt_lstm_cd_text" style="width:145" class="input" value=""--></td>
				</tr> 
				</table>				
				<!--  biz_1   (E) -->
