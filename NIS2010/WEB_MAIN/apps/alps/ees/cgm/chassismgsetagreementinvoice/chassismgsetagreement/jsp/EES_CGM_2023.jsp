...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetagreement.event.EesCgm2023Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="160">&nbsp;<input type="text" name="agmt_iss_ofc_cd" dataformat="engup" maxlength="6" style="width:78;ime-mode:disabled" class="input" value="">&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle" id="btn_popup1" name="ComOpenPopupWithTarget1"></td>
					<td width="280">
					...
					<td width="399"><input name="agmt_dt_fr" type="text" dataformat="ymd" maxlength="8" style="width:78;ime-mode:disabled" class="input" value="">&nbsp;~&nbsp;<input type="text" name="agmt_dt_to" dataformat="ymd" maxlength="8" style="width:78;ime-mode:disabled" class="input" value="">&nbsp;<img name="btns_Calendar" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>  </tr>
				<tr class="h23">
					<td>Lease Term</td>
					<td>&nbsp;<script language="javascript">ComComboObject('agmt_lstm_cd', 1, 78, 0, 0, 0, false);</script></td>
					<td colspan="3">&nbsp;&nbsp;Lessor&nbsp;&nbsp;<input type="text" name="vndr_seq" dataformat="num" style="width:97;ime-mode:disabled" class="input" value="">&nbsp;<input type="text" name="vndr_lgl_eng_nm" style="width:403;ime-mode:disabled" class="input2" value="" readonly>&nbsp;<img class="cursor" src="img/btns_multisearch.gif" width="19" height="20" border="0" align="absmiddle" id="btn_popup2" name="ComOpenPopupWithTarget2"></td>  </tr>
				</table>
