...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetagreement.event.EesCgm1026Event"%>
		...
		<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="180">&nbsp;<input type="text" name="sts_evnt_dt" dataformat="ymd" maxlength="8" style="width:80;text-align:center;ime-mode:disabled" class="input1" value="">&nbsp;<img name="btns_Calendar_activityDt" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
					<td width="55">Office</td>
					<td><input type="text" style="width:80;" name="sts_evnt_ofc_cd" dataformat="engup" maxlength="6" style="ime-mode:disabled;text-align:center;" class="input1" value="">&nbsp;<img name="btns_office" class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
				</tr>
				</table>
				<!--  biz_1  (E) -->
				...
				<tr class="h23">
					...
					<td width="55">Ref. No.</td>
					<td><input type="text" name="old_agmt_ref_no" maxlength="15" readonly style="width:100;ime-mode:disabled" class="input2" value=""></td>
				</tr>
				<tr class="h23">
					<td width="100">Lease Term</td>
					<td width="180">&nbsp;<input type="text" name="old_agmt_lstm_cd" readonly style="width:35;text-align:center;ime-mode:disabled" class="input2" value=""></td>
					<td width="55">Lessor</td>
					<td><input type="text" name="old_vndr_seq" readonly style="width:100;text-align:left;" class="input2" value="">&nbsp;<input type="text" name="old_vndr_lgl_eng_nm" readonly style="width:380;" readonly class="input2" value=""></td>
				</tr>
				</table>
				...
				<table class="search" border="0">
				<tr><td class="title_h"></td>
					<td class="title_s">Current Status by Chassis</td></tr>
				</table>
			...
			<table class="line_bluedot"><tr><td colspan="6"></td></tr></table>
				...
				<tr class="h23">
					...
					<td width="55">Ref. No.</td>
					<td><input type="text" name="new_agmt_ref_no" maxlength="15" readonly style="width:100;ime-mode:disabled" class="input2" value=""></td>
				</tr>
				<tr class="h23">
					<td width="100">Lease Term</td>
					<td width="180"><input type="text" name="new_agmt_lstm_cd" readonly style="width:35;text-align:center;" class="input2" value=""></td>
					<td width="55">Lessor</td>
					<td><input type="text" name="new_vndr_seq" readonly style="width:100;text-align:left;" class="input2" value="">&nbsp;<input type="text" name="new_vndr_lgl_eng_nm" readonly style="width:380;" readonly class="input2" value=""></td>
				</tr>
				</table>
				<!--  biz_3  (E)  -->
			</td></tr>
