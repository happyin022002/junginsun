...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class ees_cgm_2026 : ees_cgm_2026 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_cgm_2026() {
	        	            ...
	        	            var checkDup = -1;
	        	     		...
	        	     		if(checkDup == -1){
	        					...
	        					formObj.eq_no.value = eqNo;
	        			 		var sXml = sheetObjects[1].GetSearchXml("EES_CGM_2026GS.do" , FormQueryString(formObj), '', true);
 				...
 				case "btns_agmtno":			// Agreement No 가져오기 팝업
 					if(!formObject.btns_agmtno.disabled){ 
						ComOpenPopupWithTarget(
							'/hanjin/EES_CGM_2022.do', 800, 435, 
            ...
            case 1:      // sheet1 init
            	with (sheetObj) {
					...
					InitDataProperty(0, cnt++ , dtHiddenStatus,30,	daCenter,	false,	"ibflag");
 					...
 					InitDataProperty(0, cnt++ , dtData,		125,	daCenter,	false,	"eq_no", 			false,	"",	dfNone,	0, false, true ,10);
 					InitDataProperty(0, cnt++ , dtData,		70,		daCenter,	false,	"eq_tpsz_cd",		false,	"",	dfNone,	0, false, false);
 					InitDataProperty(0, cnt++ , dtData,		70,		daCenter,	false,	"agmt_lstm_cd",		false,	"",	dfNone,	0, false, false);
 					InitDataProperty(0, cnt++ , dtData,		70,		daCenter,	false,	"sts_evnt_ofc_cd",	false,	"",	dfNone,	0, false, false);
 					InitDataProperty(0, cnt++ , dtData,		70,		daCenter,	false,	"sts_evnt_yd_cd",	false,	"",	dfNone,	0, false, false);
 					...
 					InitDataProperty(0, cnt++ , dtData,		80,		daCenter,	false,	"eq_aset_sts_cd",	false,	"",	dfNone,	0, false, false);
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
        	    ...
        	    sheetObj.WaitImageVisible=false;
		 	    ComOpenWait(true);
	     		// 조회실행
	     		var sXml = sheetObj.GetSearchXml("EES_CGM_2026GS.do" , FormQueryString(formObj), '', true);
 			...
 			case IBSAVE:        //저장
 				...
 				if(arrChkRows.length-1 > 0){
	        	    ...
	        	    sheetObj.WaitImageVisible=false;
			 	    ComOpenWait(true);
	 				var sXml = sheetObj.GetSaveXml("EES_CGM_2026GS.do", sParam);
