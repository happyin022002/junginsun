...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class EES_CGM_2206 : EES_CGM_2206 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_CGM_2206() {
     ...
     function sheet1_OnLoadFinish(sheetObj) {
        ...
        // Multi Combo 초기화
	 	//comboObjects[comboCnt++] = document.div;
	  	...
	  	arrGroup[2] = "CP|CP";
	  	arrGroup[3] = "NP|NP";
	  	makeComboObject(document.form.div, arrGroup, 1, 0, 1);
	  	*/
     	 initControl();
    ...
    */
    function initSheet(sheetObj,sheetNo) {
    	...
    	with (sheetObj) {
			...
			InitDataProperty(0, cnt++ , dtDataSeq,       50,  daCenter, false,    "seq",           false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,          90,  daCenter, false,    "exe_yrmon",     false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,          80,  daCenter, false,    "sys_src_id",    false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,          80,  daCenter, false,    "rev_yrmon",     false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,          80,  daCenter, false,    "acct_cd",       false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         100,  daCenter, false,    "agmt_no",       false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         100,  daCenter, false,    "agmt_lstm_cd",  false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         100,  daCenter, false,    "chss_pool_cd",  false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         120,  daCenter, false,    "invo_no",  	   false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         100,  daCenter, false,    "cost_vvd",      false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtHidden,          90,  daCenter, false,    "vsl_cd",        false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtHidden,          80,  daCenter, false,    "skd_voy_no",    false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtHidden,         120,  daCenter, false,    "skd_dir_cd",    false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtHidden,          60,  daCenter, false,    "rev_dir_cd",    false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         100,  daCenter, false,    "rev_vvd",       false,  "",   dfNone,   0,  true,   true);
			...
			InitDataProperty(0, cnt++ , dtData,         100,  daRight,  false,    "accl_amt",      false,  "",   dfFloat,   2,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         140,  daCenter, false,    "cre_usr_id",    false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         140,  daCenter, false,    "cre_dt",        false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         140,  daCenter, false,    "upd_usr_id",    false,  "",   dfNone,   0,  true,   true);
			InitDataProperty(0, cnt++ , dtData,         140,  daCenter, false,    "upd_dt",        false,  "",   dfNone,   0,  true,   true);
	      		...
	      		if(formObj.doc_type[0].checked==true) //DETAIL	  
	      		{
			    	if(validateForm(sheetObject2,formObj,sAction)){
		    			formObj.f_cmd.value = SEARCH;	
				 		sheetObj.WaitImageVisible=false;
				 		ComOpenWait(true);		
		    			sheetObject2.DoSearch("EES_CGM_2206GS.do",FormQueryString(formObj)); 
				 		ComOpenWait(false);
			    	}	      			
	      		}else{  //SUMMARY	
	      			if(validateForm(sheetObject1,formObj,sAction)){
		    			formObj.f_cmd.value = SEARCH02;	
				 		sheetObj.WaitImageVisible=false;
				 		ComOpenWait(true);		
		    			sheetObject1.DoSearch("EES_CGM_2206GS.do",FormQueryString(formObj)); 	      				
				 		ComOpenWait(false);
		    		}	
		    	}
		    	break;
	    	...
	    	case IBSAVE:        //저장
	      		if(formObj.doc_type[0].checked==true) //DETAIL
	      		{
			    	if(validateForm(sheetObject2,formObj,sAction)) {
		    			...
		    			var sXml   = sheetObject2.GetSaveXml("EES_CGM_2206GS.do", sParam);
