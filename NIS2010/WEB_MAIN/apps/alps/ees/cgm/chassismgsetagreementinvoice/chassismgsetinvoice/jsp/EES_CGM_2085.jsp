...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm2085Event"%>
...
<tr><td class="top"></td></tr>
	...
	<!--Page Title, Historical (S)-->
		<!--table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
			<tr><td class="history"><img src="img/icon_history_dot.gif" align="absmiddle">&nbsp;Equipment Management > M.G.Set > Lease > Invoice > Invoice Import & Audit</span></td></tr>
	...
	<!--biz page (S)-->
		<table class="search" id="mainTable"> 
			...
			<tr class="h23">
					...
					<td width="80"><input type="text" name="curr_cd" readonly style="width:40;ime-mode:disabled;text-align:center" class="input2" value="USD">&nbsp;<!--img class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle"--></td>
