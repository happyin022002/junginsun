...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm2032Event"%>
...
<html>
<head>
<title>Leased M.G.Set Charge Creation </title>
	...
	<!--biz page (S)-->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="88">Cost Month</td>
					<td width=""><input type="text" name="cost_yrmon" dataformat="ym" maxlength="6" style="width:60;ime-mode:disabled" class="input1" value="">&nbsp;<img name="btns_cost_yrmon" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
					</tr> 
