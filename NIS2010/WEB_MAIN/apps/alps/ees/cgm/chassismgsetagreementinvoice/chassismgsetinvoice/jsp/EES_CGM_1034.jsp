...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm1034Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="116"><input type="text" name="cost_ofc_cd" dataformat="engup" maxlength="6" style="width:60;ime-mode:disabled" class="input1" value="">&nbsp;<img name="btns_office" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					<td width="79">Cost Month</td>
					<td width="116"><input type="text" name="cost_yrmon" dataformat="ym" maxlength="6" style="width:60;ime-mode:disabled" class="input1" value="">&nbsp;<img name="btns_cost_yrmon" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
					<td width="72">S. Provider</td>
					<td width="260"><script language="javascript">ComComboObject('vndr_seq', 1, 240, 0, 0, 0, false);</script></td>
