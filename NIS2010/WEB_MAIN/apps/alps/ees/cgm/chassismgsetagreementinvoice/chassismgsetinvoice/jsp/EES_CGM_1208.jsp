 ...
 *--------------------------------------------------
 * History
 * 2015.03.05, [CHM-201534565], 이율규, 다운 엑셀 버튼 추가
...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm1208Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.framework.component.util.io.HttpUtil"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil"%>

<%
	EesCgm1208Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm1208Event)request.getAttribute("Event");
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="423">
					<script language="javascript">ComComboObject('cost_yrmon', 1, 110, 1, 1, 1, true);</script>&nbsp;<input type="text" name="inv_fm_date" dataformat="ymd" maxlength='8' style="width:80;text-align:center" class="input1" value="">&nbsp;<img class="cursor" name="btns_Calendar1" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle">
					...
					<td width="126"><input type="text" name="cost_ofc_cd" style="width:60;text-align:center;ime-mode:disabled" dataformat="engup" maxlength="6" value="">&nbsp;<img name="btns_office" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
				...
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="93">&nbsp;S. Provider</td>
					<td width="490"><input type="text" name="vndr_seq" dataformat="eng" style="width:70;text-align:center" class="input" value="">
					<img src="img/btns_search.gif" name="btns_vndr" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">
					<input type="text" name="vndr_nm" style="width:300" class="input2" value=""></td>
					<td width="80">Pool Code</td>
					<td width="410" style="padding-left:2"><script language="javascript">ComComboObject('chss_pool_cd', 1, 90, 0, 0, 0, false);</script>&nbsp;<input type="text" name="chss_pool_nm" readonly style="width:270;ime-mode:disabled" class="input2" value=""></td>
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				...
				<!-- 1. 2015.03.05, CHM-201534565, 이율규, 다운 엑셀 버튼 추가 start --> 
				<td class="btn1_line"></td>
				<td><table width="100" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Exceldown">Excel Down</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<!-- 1. 2015.03.05, CHM-201534565, 이율규, 다운 엑셀 버튼 추가 end --> 
			</tr>
			</table>
		</td></tr>
		</table>
