...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm1107Event"%>
...
<html>
<head>
<title>Chassis Estimate Expense</title>
       		...
       		<tr>
			    ...
			    <table class="search" border="0" bordercolor="red" style="width:979;"> 
				    <tr class="h23">					   			
						...
						<td width="30">DIV </td>
						<td width="100"><script language="javascript">ComComboObject('div', 1, 70, 0, 0, 0, false);</script></td>
						<td width="100">&nbsp;Cost Month</td>
						<td width="120">
						...
						<td width="">
						<div id="glMonthLayer">
							<table class="search" border="0" bordercolor="blue">
							<tr class="h23">
								<td width="90">&nbsp;GL Month </td>
								<td width="120">
									<input type="text" name="rev_yrmon" style="width:60" value="" class="input"  maxlength="6" dataformat="ym" >
									<img class="cursor" src="img/btns_calendar.gif" name="btn_calendarRevYrmon" width="19" height="20" border="0" align="absmiddle">
								</td>
							</tr>
							</table>
						</div>
