...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm1035Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="148">
					   <script language="javascript">ComComboObject('chss_mgst_inv_knd_cd', 2, 110, 0, 0, 0, false);</script>
				    </td>
					
					<td width="85" align="right">S. Provider&nbsp;</td>
					<td width=""><input type="text" name="vndr_seq" dataformat="eng" style="width:80;text-align:center" class="input" value="">
					<img src="img/btns_search.gif" name="btns_vndr" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">
					<input type="text" name="vndr_nm" style="width:481" class="input2" value=""></td>
				...
				<tr class="h23">
					<td width="663">			
						<table class="search_sm2" border="0" style="width:540;"> 
						<tr class="h23">
