...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm2035Event"%>
...
<input type="hidden" name="chss_mgst_inv_knd_cd" value="LS">
	...
	<tr><td valign="top">
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					<!--td width="30">DIV</td>
					<td width="80" style="padding-left:2;"><script language="javascript">ComComboObject('chss_mgst_inv_knd_cd', 1, 60, 0, 0, 0, false);</script></td-->
					<td width="72">Cost Office</td>
					<td width="116"><input type="text" name="cost_ofc_cd" dataformat="engup" maxlength="6" style="width:60;ime-mode:disabled;text-align:center" class="input1" value="">&nbsp;<img name="btns_office" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					<td width="80">Cost Month</td>
					<td width="116"><input type="text" name="cost_yrmon" dataformat="ym" maxlength="6" style="width:60;ime-mode:disabled;text-align:center" class="input1" value="">&nbsp;<img name="btns_cost_yrmon" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
					<td width="75">S. Provider</td>
					<td width="325"><script language="javascript">ComComboObject('vndr_seq', 1, 300, 0, 0, 0, false);</script></td>
					<td width="50">Option</td>
					<td><script language="javascript">ComComboObject('chss_mgst_inv_sts_cd', 1, 95, 0, 0, 0, false);</script></td>
				</tr> 
				</table>				
