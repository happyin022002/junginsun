...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm1031Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td><input name="inv_dt" type="text" maxlength="8" dataformat="ymd" style="width:75;ime-mode:disabled;text-align:center" class="input" value="">&nbsp;<img name="btns_inv_dt" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" id="btn_popup1"></td>
					 -->
				</tr>
				</table>
