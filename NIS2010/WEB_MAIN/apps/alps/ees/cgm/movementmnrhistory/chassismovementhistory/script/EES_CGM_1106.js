...
=========================================================*/
	...
	function rdOpen(){		
		...
		if ( rdObj[0].RowCount  == "0" && rdObj[1].RowCount == "0")                     // RD 로 보낼 sheet 에 데이타가 없으면 Error
		{
		...
		rdObjects[0].FileOpen(RD_path+'apps/alps/ees/cgm/movementmnrhistory/chassismovementhistory/report/EES_CGM_1106.mrd',RDServer);
		//rdObjects[0].FileOpen('http://localhost:7001/hanjin/apps/alps/ees/cgm/movementmnrhistory/chassismovementhistory/report/EES_CGM_1106.mrd',RDServer);
