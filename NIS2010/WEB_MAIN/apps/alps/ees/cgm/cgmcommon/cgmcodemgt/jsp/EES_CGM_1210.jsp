...
<%@ page import="com.hanjin.apps.alps.ees.cgm.cgmcommon.cgmcodemgt.event.EesCgm1210Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCgm1210Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event 				= (EesCgm1210Event)request.getAttribute("Event");
...
<html>
<head>
<title>Chassis S/C Exception History</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Chassis S/C Exception History</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
