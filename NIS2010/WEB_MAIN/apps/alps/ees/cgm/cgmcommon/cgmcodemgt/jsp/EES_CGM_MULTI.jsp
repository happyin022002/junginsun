...
<%@ page import="com.hanjin.apps.alps.ees.cgm.cgmcommon.cgmcodemgt.event.CgmComEvent"%>
<%@ page import="org.apache.log4j.Logger" %>
   
<%
	CgmComEvent  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	returntitle ="("+returntitle+")";
 	...
 	try {
 		...
 		event = (CgmComEvent)request.getAttribute("Event");
