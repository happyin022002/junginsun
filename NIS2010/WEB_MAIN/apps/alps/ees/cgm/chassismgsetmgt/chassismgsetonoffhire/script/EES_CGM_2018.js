...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ees_cgm_2018 : ees_cgm_2018 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_cgm_2018() {
...
//                        InitDataProperty(0, cnt++ , dtPopupEdit,  140,	daCenter,	false,		"sts_evnt_dt",		false,		"",      dfDateYmd,		0,     false,		true);
...
//    				     PopupButtonImage(0,"sts_evnt_dt") = 0;
    				     ShowButtonImage = 1;
                ...
                case "sheet2":
                    with (sheetObj) {
                     ...
                     // 해더에서 처리할 수 있는 각종 기능을 설정한다
                        ...
                        InitDataProperty(0, cnt++ , dtDataSeq,       40,    daCenter,  	 false,   "no",    		 false,          "",      dfNone,      	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtData,  	     50,	daCenter,  	 false,   "eq_aset_sts_cd",    		 false,          "",      dfNone,      	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtData,   	    100,    daCenter,  	 false,   "sts_evnt_dt",   	 false,          "",      dfNone, 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtData,  	    100,    daCenter,  	 false,   "cre_dt",    false,          "",      dfNone, 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtData,   	     70,    daCenter,  	 false,   "sts_evnt_ofc_cd",   		 false,          "",      dfNone,     	 0,     false,		true);
                                                                                                                                                                    		
                        InitDataProperty(0, cnt++ , dtData,  	     80,    daCenter,  	 false,   "sts_evnt_yd_cd",    			 false,          "",      dfNone,      	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtData,      	90,    daCenter,  	 false,   "agreeement",   false,          "",      dfNone,  			 0,     false,		true);
                        ...
                        InitDataProperty(0, cnt++ , dtData,  	    160,    daCenter,  	 false,   "vndr_lgl_eng_nm",    false,          "",      dfNone,      	 0,     false,		true);
                                                                                                                                                                    		
                        InitDataProperty(0, cnt++ , dtData,   	   80, 	  daCenter,  false,   "cre_usr_id",   		 false,          "",      dfNone,     	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "aciac_div_nm",   		 false,          "",      dfNone,     	 0,     false,		true);
                        
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "eq_tpsz_cd",   		 false,          "",      dfNone,     	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "agmt_lstm_cd",   		 false,          "",      dfNone,     	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "eq_sts_seq",   		 false,          "",      dfNone,     	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "eq_no",   		 false,          "",      dfNone,     	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "aciac_div_cd",   		 false,          "",      dfNone,     	 0,     false,		true);
                        
                        InitDataProperty(0, cnt++ , dtHidden,   	80, 	  daCenter,  false,   "term_cng_seq",   		 false,          "",      dfNone,     	 0,     false,		true);
                        InitDataProperty(0, cnt++ , dtHidden,       80,	  daCenter,	false,	  "chk_val",   		false,		"",      dfNone,     	 		0,     false,		true);
...
//    			 	 sheetObj.Redraw = false;
			 	     ...
			 	     ComOpenWait(true);
    			 	 sheetObject2.DoSearch("EES_CGM_2018GS.do",  queryString+"&"+params);
    			 	 ComOpenWait(false);
