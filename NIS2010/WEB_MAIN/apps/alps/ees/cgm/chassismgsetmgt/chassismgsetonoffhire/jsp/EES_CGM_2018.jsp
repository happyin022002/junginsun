...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2018Event"%>
...
<%
	EesCgm2018Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm2018Event)request.getAttribute("Event");
...
<html>
<head>
<title>M.G.Set Status Inquiry/Correction</title>
	...
	<!--biz page (S)-->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="80">M.G.Set No.</td>
					<td width="150"><input type="text" style="width:90;ime-mode:disabled;text-align:center" maxlength='10' dataformat="engup" class="input1" value="<%=eq_no %>" name="eq_no"></td>
					<td width="98">Active/Inactive</td>
					<td width="140"><input type="text" style="width:70;text-align:center" class="input2" value="" name="aciac_div_nm" readonly="readonly"></td>
					<td width="35">Type</td>
					<td width="140"><input type="text" style="width:50;text-align:center" class="input2" value="" name="eq_tpsz_cd" readonly="readonly"></td>
       	...
       	<tr><td class="btn1_bg">
		    ...
		    <tr>				
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn1"  name="btn_retrieve" id="btn_Retrieve">Retieve</td>
