...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1019Event"%>
...
<html>
<head>
<title>Lost Chassis Summary</title>
	...
	<!--biz page (S)-->
		<table class="search" id="mainTable"> 
			...
			<table class="search_sm2" border="0" style="width:553;"> 
				...
				<tr class="h23">
					<td width=""><input type="radio" name="eq_aset_sts_cd" onclick="javascript:Period_Chk()" value="FND" class="trans">  Found Total (Found Chassis Only)</td>
				</tr>
			</table>
       	...
       	<tr><td class="btn1_bg">
		    ...
		    <tr>				
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td class="btn1" name="btn_summary"  id="btn_Retrieve">Retrieve</td>
