...
=========================================================*/
	...
	function rdOpen(){		
		...
		sXmlEtc +="	<TOT_UMG>"+rdObj[0].SumText(0,"umg")+"</TOT_UMG>";
		sXmlEtc +="	<TOT_CLG>"+rdObj[0].SumText(0,"clg")+"</TOT_CLG>";
		sXmlEtc +="</ETC>"
		sXml +=sXmlEtc;
		sXml +="</SHEET>";
		...
		rdObjects[0].FileOpen(RD_path+'apps/alps/ees/cgm/chassismgsetmgt/chassismgsetonoffhire/report/EES_CGM_2202.mrd',RDServer);
		//rdObjects[0].FileOpen('http://localhost:7001/hanjin/apps/alps/ees/cgm/chassismgsetmgt/chassismgsetonoffhire/report/EES_CGM_2202.mrd',RDServer);
