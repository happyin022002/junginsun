...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2211Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCgm2211Event event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm2211Event)request.getAttribute("Event");
