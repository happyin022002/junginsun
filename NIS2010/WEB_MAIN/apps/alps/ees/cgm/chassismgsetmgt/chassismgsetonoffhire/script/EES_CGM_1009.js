...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ees_cgm_1009 : ees_cgm_1009 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
...
// 	                 InitDataProperty(0, cnt++ , dtStatus,	 30,    daCenter,  	 false,    "ibflag");
 	                 InitDataProperty(0, cnt++ , dtHidden,    		200,   daCenter,  	 false,    "vndr_seq",   	   false,  "",      dfNone,  	    0,     false, false);
                     ...
                     InitDataProperty(0, cnt++ , dtData,  		    85,   daCenter,  	 false,    "eq_no",    	       false,  "",      dfNone,      	0,     true,  true, 11);
                     ...
                     InitDataProperty(0, cnt++ , dtData,    		180,   daCenter,  	 false,    "vndr_nm",   	   false,  "",      dfNone,  	    0,     false, false);
...
//			alert(cellValue);
			if (cellValue != ''){
				formObj.f_cmd.value = SEARCH;
		 		...
		 		//alert(Row);
		         var sXml             = sheetObj.GetSearchXml("EES_CGM_1009GS.do", FormQueryString(formObj));
