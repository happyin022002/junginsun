...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1151Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCgm1151Event event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm1151Event)request.getAttribute("Event");
