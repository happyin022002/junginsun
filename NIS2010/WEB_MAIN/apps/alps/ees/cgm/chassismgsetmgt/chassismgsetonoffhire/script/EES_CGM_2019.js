...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ees_cgm_2019 : ees_cgm_2019 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_cgm_2019() {
    ...
    function loadPage() {
	  ...
	  axon_event.addListener('change', 'obj_change' ,'ofc_cd','eq_no' );
      ...
      function obj_keypress(){
	       	 ...
	       	 switch(obj.dataformat) {
	       	  ...
	       	  case "engup2":
	       	        ...
	       	        break;
	       	 case "engup3":
       	        if(obj.name=="ofc_cd") ComKeyOnlyAlphabet('uppernum')
       	        else ComKeyOnlyAlphabet('upper');
       	        break;
...
//                       InitDataProperty(0, cnt++ , dtHiddenStatus,	120,	daCenter,		false,		"agreement");
                     ...
                     InitDataProperty(0, cnt++, dtData,	    65,	 daRight, false, "eg5"              , false, "", dfNone, 0, false, false);
                     InitDataProperty(0, cnt++, dtData,	    65,	 daRight, false, "eg8"              , false, "", dfNone, 0, false, false);
     	...
     	try {
             ...
             switch(srcName) {
	 			...
	 			case "ComOpenPopupWithTarget2":
	 				ComOpenPopupWithTarget('/hanjin/COM_ENS_071.do?pgmNo=COM_ENS_071', 800, 480, "ofc_cd:ofc_cd", "1,0,1,1,1,1,1", true);
	 				break;
...
// 	 	        queryString = "f_cmd=" + SEARCHLIST ;
 	 	        var sXml = sheetObj.GetSearchXml("EES_CGM_2019GS.do",  FormQueryString(formObj));
 	 	 ...
 	 	 case IBSEARCH_ASYNC02:	// Office Code 에 대한 Validation 체크 
				...
				break;
     	   case IBSEARCH_ASYNC03:	// yd Code 에 대한 Validation 체크 
 			   	formObj.f_cmd.value = COMMAND01;
 			   	...
 			   	break;
     	  case IBSEARCH_ASYNC04:	//  yd Code  대한 Validation 체크 
     	  		formObj.f_cmd.value = COMMAND01;
