...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2212Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCgm2212Event event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm2212Event)request.getAttribute("Event");
