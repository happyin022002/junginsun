...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1153Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCgm1153Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm1153Event)request.getAttribute("Event");
