...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1102Event"%>
...
<html>
<head>
<title>Chassis Variation Status Inquiry</title>
...
<input type="hidden" name="include_en_param">
<input type="hidden" name="include_np_param">
<input type="hidden" name="location_param" value="<%=locationParam %>">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="230"><script language="javascript">ComComboObject('location', 1, 75, 0, 1, 1, true);</script>&nbsp;<input type="text" name="crnt_loc_cd" dataformat="engup" maxlength="5" style="width:89;ime-mode:disabled" class="input1" value="<%=crntLocCd %>">&nbsp;<img name="btns_crnt_loc_cd" class="cursor" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>					
					<td width="120">Include 'EN'<input type="checkbox" name="include_en" value="" class="trans" <%= includeEnParam  %>></td>
					<td width="350">Include 'NP'<input type="checkbox" name="include_np" value="" class="trans" <%= includeNpParam  %>></td>
					<td align="right">
						<table class="search_sm2" border="0"  style="width:180;">
							<tr class="h23">
								<td><input type="radio" name="doc_type" value="" class="trans" checked>Summary&nbsp;&nbsp;&nbsp;<input type="radio" name="doc_type" value="" class="trans">Detailed</td>
							</tr>
						</table>
					</td>
				</tr>
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="68">Period</td>
					<td width=""><input type="text" name="inq_fm_dys" style="width:75;ime-mode:disabled" dataformat="ymd"   dataformat="engup" class="input1"  maxlength='8' value = "<%=inqFmDys %>">&nbsp;~&nbsp;<input type="text" name="inq_to_dys" style="width:75;ime-mode:disabled" dataformat="ymd"  dataformat="engup"  class="input1"  maxlength='8' value = "<%=inqToDys %>" >&nbsp;<img name="btns_Calendar2" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
				</tr>
				</table>
				<!--  biz_1  (E) -->
		</td></tr>
