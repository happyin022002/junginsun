...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class EES_CGM_2078 : EES_CGM_2078 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_CGM_2078() {
 	...
 	try {
         ...
         switch(srcName) {
            ...
            case "btns_crnt_loc_cd":	// Location Popup
            	...
            	if( formObject.location.Text == "ALL")
            		return;
 ...
 */     
 function sheet1_OnLoadFinish(sheetObj) {
     ...
     doActionIBSheet(sheetObjects[0], document.form, IBSEARCH_ASYNC05);
  	 document.location.InsertItem(0, "ALL", "ALL");
	 */
 ...
 function initControl(){
	 ...
	 // 초기값 설정
     comboObjects[0].Index = 0;	// change event 를 발생시키기 위해 Index 를 사용
         ...
         case "sheet1":
             with (sheetObj) {
                ...
                //전체Edit 허용 여부 [선택, Default false]
                 ...
                 InitDataProperty(0, cnt++ , dtData,      240,    daCenter,  true,     "vndr_lgl_eng_nm",  false,    "",      dfNone, 0, false, false);
                 InitDataProperty(0, cnt++ , dtData,      140,    daCenter,  false,     "agmt_lstm_cd", 	false,    "",      dfNone, 0, false, false);
                 InitDataProperty(0, cnt++ , dtAutoSum,   200,    daRight,   false,     "eq_tpsz_cd_total", false,    "",      dfNone, 0, false, false);
                 InitDataProperty(0, cnt++ , dtAutoSum,   200,    daRight,   false,     "eq_tpsz_cd_umg",   false,    "",      dfNone, 0, false, false);
                 InitDataProperty(0, cnt++ , dtAutoSum,   200,    daRight,   false,     "eq_tpsz_cd_clg",   false,    "",      dfNone, 0, false, false);
        ...
        case IBSEARCH:      //조회
	    	...
	    	formObj.f_cmd.value = SEARCH;
	 		...
	 		if(validateForm(sheetObj,formObj,sAction))
	 		{
		 		sheetObj.WaitImageVisible=false;
		 		ComOpenWait(true);	 		 			
	 			var sXml = sheetObj.GetSearchXml("EES_CGM_2078GS.do" , FormQueryString(formObj));
...
function sheet1_OnSearchEnd(sheetObj, ErrMsg)
{
 	with(sheetObj)
 	{
         with(sheetObj)
         {
             ShowSubSum(0, "2|3|4", -1, false, false,	-1,"vndr_lgl_eng_nm=Sub Total");
         }
...
function sheet1_OnDblClick(sheetObj, Row, Col, CellX, CellY, CellW, CellH){
	...
	var groupValue1 = sheetObj.cellValue(Row, "vndr_lgl_eng_nm");
	if(groupValue1 != "Sub Total")
	{
		//기존 groupValue1 = groupValue1.substring(0,6); // Lessor
	...
	if(groupValue1 == "Sub Total")
	{
		...
		s2_agmtLstmCd	= sheetObj.cellValue(Row-1,"agmt_lstm_cd");
  	...
  	}else
	{
		s2_group1 = "";
		s2_groupValue1 = "";
		s2_agmtLstmCd	= sheetObj.cellValue(Row,"agmt_lstm_cd");
	}
