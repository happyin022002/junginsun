...
* 1.0 Creation
* History
* 2014.11.19 Chang Young Kim, CHM-201432569
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class EES_CGM_2084 : EES_CGM_2084 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_CGM_2084() {
            ...
            case 1:      //sheet1 init
                with (sheetObj) {
	               ...
	               //전체Edit 허용 여부 [선택, Default false]
					...
					var HeadTitle = "Seq.|M.G.Set No.|AGMT No.|Term|Type|Lessor|Manufactrue Date|On Hire Date|CHSS No.|CNTR No.|MVMT|LCC|SCC|Yard|MVMT Date|Days";
                    ...
                    InitDataProperty(0, cnt++ , dtData,  45, daCenter,  false, "agmt_lstm_cd",  false, "", dfNone, 0, false, false);
                    InitDataProperty(0, cnt++ , dtData,  45, daCenter,  false, "eq_tpsz_cd",    false, "", dfNone, 0, false, false);
                                                             
                    InitDataProperty(0, cnt++ , dtData, 180, daLeft,  	false, "vndr_abbr_nm",  false, "", dfNone, 0, false, false);
                    InitDataProperty(0, cnt++ , dtData, 110, daCenter,  false, "mft_dt",     false, "", dfUserFormat2, 0, false, false);
                    InitDataProperty(0, cnt++ , dtData, 110, daCenter,  false, "onh_dt",     false, "", dfUserFormat2, 0, false, false);
                    ...
                    InitDataProperty(0, cnt++ , dtData,  50, daCenter,  false, "mvmt",     		false, "", dfNone, 0, false, false);
                    ...
                    InitDataProperty(0, cnt++ , dtData,  80, daCenter,  false, "crnt_yd_cd",  	false, "", dfNone, 0, false, false);
                    InitDataProperty(0, cnt++ , dtData, 110, daCenter,  false, "mvmt_date",     false, "", dfUserFormat2, 0, false, false);
                    InitDataProperty(0, cnt++ , dtData,  60, daCenter,  false, "lsdays",     	false, "", dfNone, 0, false, false);

					InitUserFormat2(0, "mvmt_date", "####-##-## ##:##", "-|:" );
        ...
        switch(sAction) {
            case IBSEARCH:      //조회
                ...
                ComOpenWait(true,false);		 		
	     		// 조회실행
	     		var sXml = sheetObj.GetSearchXml("EES_CGM_2084GS.do" , FormQueryString(formObj));
