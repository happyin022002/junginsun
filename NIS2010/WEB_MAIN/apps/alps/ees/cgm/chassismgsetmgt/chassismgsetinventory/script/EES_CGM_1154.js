...
/**
 * @extends
 * @class EES_CGM_1154 : EES_CGM_1154 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function EES_CGM_1154() {
     ...
     switch(sAction) {
		case IBSEARCH:      //조회
			if(validateForm(sheetObj,formObj,sAction)){
				...
				sheetObj.DoSearch("EES_CGM_1154GS.do", FormQueryString(formObj));
				ComOpenWait(false);
			}
			break;				       
     }
