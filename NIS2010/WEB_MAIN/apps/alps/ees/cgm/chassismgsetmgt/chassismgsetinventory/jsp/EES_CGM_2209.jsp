...
<%@ page import="com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2209Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCgm2209Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm2209Event)request.getAttribute("Event");
		...
		<!-- Grid BG Box  (S) -->
     	<table class="search">
       	<tr><td class="bg" style="height:515;" valign="top">
			...
			<td width="250">
				<select style="width:62;" class="input" name="lstm_cd">
				<option value="ALL" selected>&nbsp&nbspALL</option>
				<option value="OW">&nbsp&nbspOW</option>
				<option value="LP">&nbsp&nbspLP</option>
				<option value="OL">&nbsp&nbspOL</option>
				</select>			
			</td>
