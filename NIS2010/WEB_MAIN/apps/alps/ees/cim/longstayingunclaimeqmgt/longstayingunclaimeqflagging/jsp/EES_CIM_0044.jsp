...
<%@ page import="com.hanjin.apps.alps.ees.cim.longstayingunclaimeqmgt.longstayingunclaimeqflagging.event.EesCim0044Event"%>
...
<html>
<head>
<title>Container Staying Days <%= titleFlag %>(Detail)</title>
...
<input type="hidden" name="ofc_cd" value="<%=event.getFlaggingSDaysOptionVO().getOfcCd() %>">
<input type="hidden" name="cntrprefix" value="<%=event.getFlaggingSDaysOptionVO().getCntrprefix() %>">
<input type="hidden" name="cntr_hngr_rck_cd" value="<%=event.getFlaggingSDaysOptionVO().getCntrHngrRckCd() %>">
<input type="hidden" name="disp_flg" value="<%=event.getFlaggingSDaysOptionVO().getDispFlg() %>">
<input type="hidden" name="d2_payld_flg" value="<%=event.getFlaggingSDaysOptionVO().getD2PayldFlg() %>">
<input type="hidden" name="cntr_yd_cd" value="<%=event.getFlaggingSDaysOptionVO().getCntrYdCd() %>">
<input type="hidden" name="code_flg" value="<%=event.getFlaggingSDaysOptionVO().getCodeFlg() %>">
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Container Staying Days <%= titleFlag %>(Detail)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
