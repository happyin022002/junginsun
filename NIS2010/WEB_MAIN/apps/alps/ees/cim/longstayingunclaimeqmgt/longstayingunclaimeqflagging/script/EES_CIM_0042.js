            ...
            case "sheet1":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    var HeadTitle1 = "Seq.|SCC|TP/SZ|CNTR No.|Term|F/M|Initial Status|Initial Status|Initial Status|Current Status|Current Status|Current Status|Current Status|Total\nS/Days|BKG No.|DMG|HRT|HBT|HBQ|DP|IM|UC|PF";
                    var HeadTitle2 = "Seq.|SCC|TP/SZ|CNTR No.|Term|F/M|Yard|MVMT|Event Date|Yard|MVMT|Event Date|S.Days|Total\nS/Days|BKG No.|DMG|HRT|HBT|HBQ|DP|IM|UC|PF";
                    ...
                    InitDataProperty(0, cnt++ , dtData,			65,		daCenter,	true,	"org_yd_cd",	            false,	"",	dfNone);
                    InitDataProperty(0, cnt++ , dtData,			50,   	daCenter, 	true,	"mvmt_sts_cd", 	            false,	"",	dfNone);
                    InitDataProperty(0, cnt++ , dtData,			70,   	daCenter,  	true,	"cnmv_evnt_dt",		         false,	"",	dfNone);
                                                                                                                        
                    InitDataProperty(0, cnt++ , dtData,			65,		daCenter,	true,	"crnt_yd_cd",	            false,	"",	dfNone);
                    ...
                    InitDataProperty(0, cnt++ , dtData,			60,   	daRight,   	true,	"tot_days", 	            false,	"",	dfNullInteger); 
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			case IBSEARCH:      //조회
		        ...
		        sheetObj.DoSearch("EES_CIM_0042GS.do",FormQueryString(formObj));
                ComOpenWait(false); 							
                break;
	   		case IBDOWNEXCEL:      // 입력
	   			sheetObj.SpeedDown2Excel(true,false,false,"","",false,false,"",false,"","",false,"",true);
	   			break;
        }
    }
