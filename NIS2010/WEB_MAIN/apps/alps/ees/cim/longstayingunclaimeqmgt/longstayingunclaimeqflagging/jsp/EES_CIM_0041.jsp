...
<%@ page import="com.hanjin.apps.alps.ees.cim.longstayingunclaimeqmgt.longstayingunclaimeqflagging.event.EesCim0041Event"%>
...
<html>
<head>
<title>Total S/Days (by MVMT Status)</title>
...
<input type="hidden" name="cntr_tpsz_cd" value="<%=event.getFlaggingSDaysOptionVO().getCntrTpszCd() %>">
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Total S/Days (by MVMT Status)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
