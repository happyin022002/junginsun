...
<%@ page import="com.hanjin.apps.alps.ees.cim.containersupplydemandforecast.cntrinventoryreport.event.EesCim0029Event"%>
...
<html>
<head>
<title>Stock Report (CNTR Data)</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Stock Report (CNTR Data)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<table class="search" id="mainTable"> 
			...
			<table class="search" border="0" style="width:650;"> 
				<tr class="h23">
					...
					<td><input type="text" name="total_cnt" style="width:60;text-align:right" readOnly class="tr_head3" value="">&nbsp;<input type="text" name="total" style="width:570;text-align:left" readOnly class="tr_head3" value=""></td>
				</tr>
				</table>
