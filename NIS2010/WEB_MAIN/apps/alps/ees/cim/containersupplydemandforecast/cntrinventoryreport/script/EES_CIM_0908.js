...
=========================================================*/
	...
	function rdOpen(){		
		...
		if ( opener_obj.beforetab =='1' ) {
			opener_sheet_obj1 =  opener_obj.document.t4sheet1;
		} else if  ( opener_obj.beforetab =='0' ) {
			opener_sheet_obj1 =  opener_obj.document.t1sheet1;
		} else if  ( opener_obj.beforetab =='2' ) {
			opener_sheet_obj1 =  opener_obj.document.t3sheet1;
		}
		...
		sXml +="<ETC>" ;  
		sXml +="	<LOC_TYPE_CODE>"+opener_obj.document.form.prt_loc_type_code.value+"  "+opener_obj.document.form.prt_loc_cd.value+"</LOC_TYPE_CODE>"
		...
		var ii = 0;
		if ( opener_obj.beforetab =='0' ) {
			sXml +="	<TITLE>Land Inventory(By MVMT)</TITLE>"
		} else if ( opener_obj.beforetab =='2' ) {
			sXml +="	<TITLE>Land Inventory(By Lease Term)</TITLE>"
		}
		sXml +="	<HEAD_CNTR_TPSZ_CD00>"+opener_obj.headTitle.split("|")[0]+"</HEAD_CNTR_TPSZ_CD00>"
		sXml +="	<HEAD_CNTR_TPSZ_CD01>"+opener_obj.headTitle.split("|")[1]+"</HEAD_CNTR_TPSZ_CD01>"
		sXml +="	<HEAD_CNTR_TPSZ_CD0>"+opener_obj.headTitle.split("|")[0]+"</HEAD_CNTR_TPSZ_CD0>"
		...
		if ( opener_obj.beforetab =='1' ) {
			rdObjects[0].FileOpen(RD_path+'apps/alps/ees/cim/containersupplydemandforecast/cntrinventoryreport/report/EES_CIM_0908_1.mrd',RDServer);
		} else {
			rdObjects[0].FileOpen(RD_path+'apps/alps/ees/cim/containersupplydemandforecast/cntrinventoryreport/report/EES_CIM_0908_2.mrd',RDServer);
		}
	}