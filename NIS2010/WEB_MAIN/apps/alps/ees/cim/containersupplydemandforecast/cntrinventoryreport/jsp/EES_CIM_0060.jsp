...
<%@ page import="com.hanjin.apps.alps.ees.cim.longstayingunclaimeqmgt.longstayingunclaimeqflagging.event.EesCim0060Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCim0060Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCim0060Event)request.getAttribute("Event");
...
<html>
<head>
<title>EQ Balance Report Input</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<table class="search" id="mainTable"> 
		...
		<tr class="h23">
			...
			<td width="156">Period Week(YYYY-WW)</td>
			<td width=84>
				<input type="text" class="input1" name="period_week" style="ime-mode:disabled;width:54;" dataformat="yw" maxlength="6">
			</td>
			<td width="76">Sub-Conti</td>
			<td width="190">
...
<div id="hiddenGridLayer" style="display:none">
	<!-- Grid (S) -->
	<table class="search"> 
		<tr><td class="bg">
		<table width="100%" class="search"  id="hiddenTable"> 
			<tr><td width="100%">
