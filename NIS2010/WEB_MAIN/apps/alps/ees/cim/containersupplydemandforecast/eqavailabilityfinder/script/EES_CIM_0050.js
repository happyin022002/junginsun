...
*@FileTitle : 금일 MTY Returned 컨테이너 수량을 확인하는 화면
*Open Issues :
*Change history :
...
=========================================================*/
    ...
    /**
    * @extends 
    * @class EES_CIM_0050 : EES_CIM_0050 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
    */
    function EES_CIM_0050() {
        ...
        switch(shtID) {
            case "sheet1":      //sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,         80,     daCenterTop,	true,  "fcast_dt",      false,  "", dfNone);
                    ...
                    InitDataProperty(0, cnt++ , dtData,         150,    daLeft,   		true,  "shpr",          false,  "", dfNone);
                    InitDataProperty(0, cnt++ , dtData,         150,    daLeft,    		true,  "cnee",   		false,  "", dfNone);
                    InitDataProperty(0, cnt++ , dtData,         150,    daLeft,    		true,  "ntfy",    		false,  "", dfNone);
               }
               break;
        }
    }
