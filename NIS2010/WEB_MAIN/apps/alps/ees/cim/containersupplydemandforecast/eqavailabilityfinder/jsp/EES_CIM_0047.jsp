...
<%@ page import="com.hanjin.apps.alps.ees.cim.containersupplydemandforecast.eqavailabilityfinder.event.EesCim0047Event"%>
...
<html>
<head>
<title>PUP(Picked Up) Information</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;PUP(Picked Up) Information</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
