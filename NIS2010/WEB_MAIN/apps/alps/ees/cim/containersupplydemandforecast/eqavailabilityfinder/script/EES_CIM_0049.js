...
*@FileName : EES_CIM_0049.js
*@FileTitle : IG(I/B MTY Generation) 예측수량을 Detail하게 조회
*Open Issues :
*Change history :
...
=========================================================*/
    ...
    /**
    * @extends 
    * @class EES_CIM_0049 : EES_CIM_0049 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
    */
    function EES_CIM_0049() {
        ...
        switch(shtID) {
            case "sheet1":      //sheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle1 = "IG\nEst. Date|Yard|BKG No.|TP/SZ|Vol|Del\nTerm|SHPR|CNEE|NTFY";
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH:      //조회
                ...
                sheetObj.DoSearch("EES_CIM_0049GS.do",FormQueryString(formObj));
            	ComOpenWait(false);             	
                break;
