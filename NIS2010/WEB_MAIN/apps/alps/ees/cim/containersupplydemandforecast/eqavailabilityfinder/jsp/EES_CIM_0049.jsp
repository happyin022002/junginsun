...
<%@ page import="com.hanjin.apps.alps.ees.cim.containersupplydemandforecast.eqavailabilityfinder.event.EesCim0049Event"%>
...
<html>
<head>
<title>IG(I/B MTY Generation) Information</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;IG(I/B MTY Generation) Information</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
