...
=========================================================*/
    ...
    /**
    * @extends 
    * @class EES_CIM_0051 : EES_CIM_0051 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
    */
    function EES_CIM_0051() {
        ...
        switch(shtID) {
            case "sheet1":      //sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,         80,    	daCenter,    	true,  "cntr_auth_no",  false,  "", dfNone);
               }
               break;
        }
    }
