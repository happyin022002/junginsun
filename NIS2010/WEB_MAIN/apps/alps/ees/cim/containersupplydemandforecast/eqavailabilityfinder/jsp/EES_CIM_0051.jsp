...
<%@ page import="com.hanjin.apps.alps.ees.cim.containersupplydemandforecast.eqavailabilityfinder.event.EesCim0051Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCim0051Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCim0051Event)request.getAttribute("Event");
...
<html>
<head>
<title>ON(OW&On-hire) Information</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;ON(OW&On-hire) Information</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
