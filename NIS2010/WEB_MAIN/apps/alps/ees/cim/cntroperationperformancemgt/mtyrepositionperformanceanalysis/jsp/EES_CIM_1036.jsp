...
<%@ page import="com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.mtyrepositionperformanceanalysis.event.EesCim1036Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesCim1036Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCim1036Event)request.getAttribute("Event");
...
<html>
<head>
<title>Repo Result for Domestic</title>
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
								...
								<td width="" colspan="2">
									<table class="search_sm2" border="0" style="width:95%;"> 
										<tr class="h23">
											...
											<select style="width:79;" class="input" name="rdtype" disabled>
				...
				<tr class="h23">
					<td width=""><table border="0" style="width:100%;" class="search_sm2"> 
						<tr class="h23">
							...
							<td width="100" class="stm"><input type="radio" value="R"  name="inquirywise" class="trans" checked>Within</td>
							<td width="30" class="stm">RCC</td>
							<td width="" colspan="2" style="padding-left:0">
								<input type="text" style="width:57;" class="input2" value="USNYC" name="rcc" dataformat="engup" style="ime-mode:disabled" maxLength ="5"  READONLY>
							</td>
							
						</tr> 
						<tr class="h23">
							<td width="100" class="stm"><input type="radio" value="L"  name="inquirywise"  class="trans" >Location</td>
							<td width="" class="stm"><span id="tt" >To</span></td>
							<td width="" class="stm"><input type="text" style="width:57;" class="input1" value="" name="loccode1" dataformat="engup" style="ime-mode:disabled" maxLength ="5">
							<img class="cursor" src="img/btns_search.gif" name="btn_location1" width="19" height="20" border="0" align="absmiddle"></td>
							<td width="" class="stm"><span id="ff" >From</span>&nbsp;<input type="text" style="width:57;" class="input" value="" name="loccode2" dataformat="engup" style="ime-mode:disabled" maxLength ="5">
