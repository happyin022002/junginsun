...
<%@ page import="com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EES_CIM_1027HTMLAction"%>
<%@ page import="com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EesCim1027Event"%>

<html>
<head>
<title>Location M/B by BKG-Wise</title>
...
<table width="100%" class="popup" cellpadding="10" border="0">
    ...
    <tr><td class="title"><img src="/hanjin/img/alps/ico_t1.gif" width="20" height="12">Location M/B by BKG-Wise</td></tr>
    </table>
    <!-- : ( Title ) (E) -->
