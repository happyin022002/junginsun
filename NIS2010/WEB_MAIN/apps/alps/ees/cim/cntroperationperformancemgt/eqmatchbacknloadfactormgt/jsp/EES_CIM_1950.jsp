...
<%@ page import="com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EES_CIM_1050HTMLAction"%>
<%@ page import="com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EesCim1050Event"%>

<html>
<head>
<title>Match-back by Vessel</title>
...
<table width="100%" class="popup" cellpadding="10" border="0">
    ...
    <tr><td class="title"><img src="/hanjin/img/alps/ico_t1.gif" width="20" height="12">Match-back by Vessel</td></tr>
    </table>
    <!-- : ( Title ) (E) -->
