...
/**
 * @extends 
 * @class EES_CIM_1030 : EES_CIM_1030 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function EES_CIM_1030() {
...
function loadPage() {	
	...
	doActionIBSheet(sheetObjects[0],objForm,IBSEARCH);	
}	
    ...
    switch(sheetNo) {
        case 1:      //sheet2 init
           ...
           //전체Edit 허용 여부 [선택, Default false]
            ...
            var HeadTitle = "Seq.|CNTR No.|TP/SZ|Term|MVMT|MVMT Date|Yard|BKG No.|POL|POR|POD|DEL|ETA DT|VVD";
            ...
            InitDataProperty(0, cnt++ , dtData,		65,     daCenter,    false,     "org_yd_cd",    	false,          "",      dfNone,      		0,     false,		false);
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	switch(sAction) {
		case IBSEARCH:      //조회
			...
			sheetObj.DoSearch4Post("EES_CIM_1030GS.do", FormQueryString(formObj));
			ComOpenWait(false);
			break;			
	}
}
