...
function rdOpen() {
	...
	//alert("sXml [" + sXml + "]");
	var sPeriod = opener_obj.document.form.rpt_fromdate.value + " ~ " + opener_obj.document.form.rpt_todate.value;

	var sTrade = "";
	if (opener_obj.document.form.rpt_trade.value == "") {
		sTrade = "ALL";
	} else {
		sTrade = opener_obj.document.form.rpt_trade.value;
	}
	...
	sXml += "    <LANE>" + opener_obj.document.form.rpt_lane.value + "</LANE>"
	sXml += "    <VVD>" + opener_obj.document.form.rpt_vvd.value + "</VVD>"
	...
	if (opener_obj.document.form.rpt_lfinfo.value == "E") {
		rdObjects[0].FileOpen(RD_path + 'apps/alps/ees/cim/cntroperationperformancemgt/eqmatchbacknloadfactormgt/report/EES_CIM_1950_2.mrd', RDServer);
	} else {
		rdObjects[0].FileOpen(RD_path + 'apps/alps/ees/cim/cntroperationperformancemgt/eqmatchbacknloadfactormgt/report/EES_CIM_1950_1.mrd', RDServer);
	}
}