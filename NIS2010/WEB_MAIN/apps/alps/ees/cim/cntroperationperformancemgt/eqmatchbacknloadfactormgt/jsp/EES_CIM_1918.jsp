...
<%@ page import="com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EES_CIM_1018HTMLAction"%>
...
<table width="100%" class="popup" cellpadding="10" border="0">
    ...
    <tr><td class="title"><img src="/hanjin/img/alps/ico_t1.gif" width="20" height="12">Location M/B by Logistics-Wise</td></tr>
    </table>
    <!-- : ( Title ) (E) -->
