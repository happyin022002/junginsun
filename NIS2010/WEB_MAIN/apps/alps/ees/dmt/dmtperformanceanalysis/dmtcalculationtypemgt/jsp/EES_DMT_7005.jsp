...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtperformanceanalysis.dmtcalculationtypemgt.event.EesDmt7005Event"%>
...
<html>
<head>
<title>Tariff Type Set-up</title>
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="135">User Office</td>
					<td width="150"><input type="text" name="ofc_cd" style="width:94;" class="input2" readOnly value="<%=strOfc_cd%>"></td>
					<td width="65">User Name</td>
					<td width=""><input type="text" name="usr_nm" style="width:300;" class="input2" readOnly value="<%=strUsr_nm%>"></td>
					</tr>
				<tr class="h23">
					<td width="">Tariff Type in Charge</td>
