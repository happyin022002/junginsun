...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtperformanceanalysis.chargecollectionreport.event.EesDmt6003Event"%>
...
<html>
<head>
<title>Monthly Invoiced &amp; Collection by Office</title>
	...
	<!--Page Title, Historical (E)-->
		...
		<table class="search" id="mainTable"> 
       		...
       		<div id="sch_cond_div" style=display:block;>
				...
				<tr class="h23">
					<td width="670" style="height:32;">
				
						<table border="0" style="width:650;" class="search_sm2"> 
						<tr class="h23">
							<td width="120">&nbsp;&nbsp;Date </td>
							<td class="stm">
								<input type="radio" name="dt_flg" value="M" class="trans" checked>&nbsp;Month&nbsp;&nbsp;<input type="text" name="to_mvmt_mon" maxlength="6" dataformat="ym"  style="width:65" class="input1">&nbsp;&nbsp;
								<input type="radio" name="dt_flg" value="P" class="trans">&nbsp;Period&nbsp;&nbsp;
								<input type="text" name="fm_dt" caption='From Date' maxlength="8" dataformat="ymd" style="width:80" class="input1">&nbsp;~
								<input type="text" name="to_dt" caption='To Date'   maxlength="8" dataformat="ymd" style="width:80" class="input1">
								<img class="cursor" src="img/btns_calendar.gif" name="btns_calendar" width="19" height="20" border="0" align="absmiddle"></td>
						</tr>
						</table>
					
					</td>
					<td width="60">Charge</td>
					<td width="120">
						<select name="chg_flg" style="width:80;" class="input1">
					...
					<td>
						<select name="io_bnd_flg" style="width:80;" class="input1">
						<option value="" selected>All</option>
				...
				<tr class="h23">
					...
					<td width="">Group by</td>
					<td>
						<select name="grp_flg" style="width:80;">
				...
				<tr class="h23">
					...
					<td width="" colspan="4"><input type="checkbox" name="incl_cntr" value="Y" class="trans" checked>&nbsp;&nbsp;&nbsp;Incl. CNTR Column</td>
				</tr> 
				</table>
				<!--  biz_1   (E) -->
		...
		<table class="search" id="mainTable"> 
			...
			<table border="0" style="width:650;" class="search"> 
				<tr class="h23">
					<td class="sm">* B/L: PPD regarded as O/B, CCT regarded as I/B</td></tr>
			</table>			
			</td></tr>
		</table>
		<!--biz page (E)-->
