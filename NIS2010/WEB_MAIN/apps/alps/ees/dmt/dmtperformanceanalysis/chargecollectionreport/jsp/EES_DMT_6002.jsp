...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtperformanceanalysis.chargecollectionreport.event.EesDmt6002Event"%>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Current Collection Status by Office – Detail(s)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
