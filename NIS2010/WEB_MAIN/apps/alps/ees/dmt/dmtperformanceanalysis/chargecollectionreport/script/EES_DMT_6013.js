...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class EES_DMT_6013 : EES_DMT_6013 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_DMT_6013() {
             ...
             case "sheet1":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     /* Remark 추가 */
                     var HeadTitle1 = "|Seq.|Office|Tariff|STS|A/R|CNTR No.|T/S|From YD|To YD|Fm|To|F/T|Over|From DT|To DT|F/Time CMNC|F/Time End|Cur.|Incurred AMT|CMDT EXPT AMT|Exception AMT|D/C AMT|Billable AMT|INV Cur.|Invoiced AMT|Collected Cur|Collected AMT|Uncollected Cur|Uncollected AMT|BKG No.|B/L No.|VVD|Lane|POR|POL|POD|DEL|R|D|S/C No.|RFA No.|INV No.|ISS DT|G/B|Remark";
                     ...
                     InitDataProperty(0, cnt++ , dtData,   		 35,	daCenter,	true,	"dmdt_ar_if_cd",    false,	"",		dfNone,			0,	false,	false);
                     ...
                     InitDataProperty(0, cnt++ , dtData, 		 70,	daCenter,	true,	"to_mvmt_yd_cd",   	false,	"",		dfNone,			0,	false,	false);

                     InitDataProperty(0, cnt++ , dtData,   		 35,	daCenter,	true,	"fm_mvmt_sts_cd",   false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 35,	daCenter,	true,	"to_mvmt_sts_cd",   false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 35,	daCenter,	true,	"ft_dys",       	false,	"",		dfInteger,		0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 40,	daCenter,	true,	"fx_ft_ovr_dys",   	false,	"",		dfInteger,		0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 75,	daCenter,	true,	"fm_mvmt_dt", 		false,	"",		dfDateYmd,		0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 75,	daCenter,	true,	"to_mvmt_dt",   	false,	"",		dfDateYmd,		0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 85,	daCenter,	true,	"ft_cmnc_dt",   	false,	"",		dfDateYmd,		0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 75,	daCenter,	true,	"ft_end_dt",    	false,	"",		dfDateYmd,		0,	false,	false);
                     ...
                     InitDataProperty(0, cnt++ , dtData,   		 100,	daRight,	true,	"cmdt_expt_amt", 	false,	"",		dfNullFloat,	2,	false,	false);
                     ...
                     InitDataProperty(0, cnt++ , dtData,   		 90,	daRight,	true,	"inv_chg_amt", 		false,	"",		dfNullFloat,	2,	false,	false);

                     InitDataProperty(0, cnt++ , dtData,   		 100,	daCenter,	true,	"coll_curr_cd", 	false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 100,	daRight,	true,	"coll_amt", 		false,	"",		dfNullFloat,	2,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 100,	daCenter,	true,	"uncoll_curr_cd", 	false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 100,	daRight,	true,	"uncoll_amt", 		false,	"",		dfNullFloat,	2,	false,	false);
                     ...
                     InitDataProperty(0, cnt++ , dtData,   		 50,	daCenter,	true,	"lane",     		false,	"",		dfNone,			0,	false,	false);
                     ...
                     InitDataProperty(0, cnt++ , dtData,   		 40,	daCenter,	true,	"bkg_rcv_term_cd",  false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 40,	daCenter,	true,	"bkg_de_term_cd",   false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 70,	daCenter,	true,	"sc_no",     		false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 95,	daCenter,	true,	"rfa_no",    		false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 90,	daCenter,	true,	"dmdt_inv_no",    	false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,   		 90,	daCenter,	true,	"iss_dt",    		false,	"",		dfDateYmd,		0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,		 50,	daCenter,	true,	"chg_type",       	false,	"",		dfNone,			0,	false,	false);
                     InitDataProperty(0, cnt++ , dtData,		 210,	daLeft,		true,	"corr_rmk",       	false,	"",		dfNone,			0,	false,	false);
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
			case IBSEARCH:      //조회
				...
				sheetObj.DoSearch("EES_DMT_6013GS.do", FormQueryString(formObj));
				ComOpenWait(false);
