...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtexceptionmgt.dualtypeexceptionmgt.event.EesDmt2014Event"%>
...
<html>
<head>
<title>Dual Type Exception Creation</title>
...
<!-- 입력한 Coverage 가 Dual 인지를 조회하기 위한 매개변수 -->
<input type="hidden"  name="cnt_cd">
<input type="hidden" name="rgn_cd">
<input type="hidden"  name="ste_cd">
<input type="hidden"  name="loc_cd">
<input type="hidden"  name="io_bnd">
<input type="hidden"  name="eff_dt">
<input type="hidden"  name="result">
<input type="hidden" name="result_sc_no">
<input type="hidden" name="result_dar_no">
<input type="hidden" name="result_dul_expt_eff_dt">
<input type="hidden" name="result_dul_expt_exp_dt">
...
<!-- 삭제가능한 Dual Type Customer 인지를 조회하기 위한 매개변수 -->
...
<!-- EXP DT 입력시 유효한지를 조회하기 위한 추가적인 매개변수 -->
<input type="hidden" name="exp_dt">
<!-- 중복여부를 체크를  위한 추가적인 매개변수 -->
		...
		<td class="bg">
			...
			<td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<td class="btn2" name="btn_AddDualType">Row Add</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_CopyDualType">Row Copy</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_DelDualType">Row Delete</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_ExpireDualType" id="btn_ExpireDualType">Expire</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
					</tr></table>
