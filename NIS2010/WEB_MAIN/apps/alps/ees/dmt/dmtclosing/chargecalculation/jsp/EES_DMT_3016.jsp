...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtclosing.chargecalculation.event.EesDmt3016Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesDmt3016Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesDmt3016Event)request.getAttribute("Event");
