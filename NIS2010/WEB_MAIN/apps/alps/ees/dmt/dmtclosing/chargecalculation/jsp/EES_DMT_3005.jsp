...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtclosing.chargecalculation.event.EesDmt3005Event"%>
...
<html>
<head>
<title>Charge Inquiry by Booking</title>
...
<table width="100%" border="0" <%=tableProp%> >
	...
	<table class="search"> 
       		<tr><td class="bg">
				...
				<!--  biz_1  (S) -->
				<table class="search" border="0" style="width:845"> 
					<tr class="h23">
						<td width="50">BKG No.</td>
						<td width="70"><input type="text" name="bkg_no" value="<%=JSPUtil.getParameter(request, "bkg_no", "")%>" dataformat="engup" maxlength="13" caption="BKG No."  style="width:110;" class="input1"></td>
						<td width="50" style="text-align:right;">B/L No. </td>
						<td width="120"><input type="text" name="bl_no" value="<%=JSPUtil.getParameter(request, "bl_no", "")%>" dataformat="engup" maxlength="12"   caption="B/L No."  style="width:110;" class="input1"></td>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="117"><input type="text" name="pre_rly_port_cd"  style="width:60;" class="input2" readonly></td>
						<td width="63">Post Port</td>
						<td width=""><input type="text" name="pst_rly_port_cd" style="width:70;" class="input2" readonly></td>
					</tr>
					...
					<tr class="h23">
						...
						<table class="grid2" border="0" style="width:480;" style="border-bottom:1px solid #E8EFF9;"> 
							...
							<tr class="h23">
								...
								<td width="90" class="noinput2"><input type="text" name="cmdt_cd" style="width:100%;" class="noinput2" readonly></td>
								<td width="" class="noinput2" colspan="5"><input type="text" name="cmdt_nm" style="width:300;" class="noinput2" readonly></td>
							</tr>
						</table>
						<table class="grid2" border="0" style="width:480;" style="border-bottom:1px solid #E8EFF9;">
							<tr class="h23">
						...
						<table class="grid2" border="0" style="width:480;">
							<tr class="h23">
								...
								<td width="90"  class="noinput2"><input type="text" name="sls_ofc_cd" style="width:100%;" class="noinput2" readonly></td>
				...
				<tr class="h23">
							<td width="102">CNTR Q'TY</td>
							<td width="54"><input type="text" name="cntr_qty" style="width:40;text-align:right;" class="input2" readonly ></td>
							<td width="145">Total Billable AMT </td>
							<td width="260"><input type="text" name="bzc_trf_curr_cd"   style="width:30;" 
								class="input2" readonly >&nbsp;<input type="text" name="tot_bil_amt"  style="width:170;text-align:right;" class="input2" readonly></td>
							<td>
					<!--  Button_Sub (S) -->
			...
			<tr class="h23">
				<td width="90">BKG CNTR Q’TY</td>
				<td width="50"><input type="text" name="tot_bkg_qty" style="width:40;text-align:right;" class="input2" readonly ></td>
				<td width="125">Exception CNTR QTY</td>
				<td width="50"><input type="text" name="tot_expt_qty" style="width:40;text-align:right;" class="input2" readonly ></td>
				<td width="120">Incurred CNTR QTY</td>
				<td width="50"><input type="text" name="tot_incur_qty" style="width:40;text-align:right;" class="input2" readonly ></td>
				<td width="130">Total Exception Cost</td>
				<td width="40"><input type="text" name="tot_expt_cur"  style="width:36;text-align:center;" class="input2" readonly></td>
				<td width="250"><input type="text" name="tot_expt_amt"  style="width:170;text-align:right;" class="input2" readonly></td>
			</tr>
			<tr class="h23">
				<td width="90">BKG CNTR TEU</td>
				<td width="50"><input type="text" name="bkg_cntr_teu" style="width:40;text-align:right;" class="input2" readonly ></td>
				<td width="125">Exception CNTR TEU</td>
				<td width="50"><input type="text" name="tot_expt_cntr_teu_knt" style="width:40;text-align:right;" class="input2" readonly ></td>
				<td width="120">Incurred CNTR TEU</td>
				<td width="50"><input type="text" name="tot_incur_cntr_teu_knt" style="width:40;text-align:right;" class="input2" readonly ></td>
				<td width="120">Total Incurred AMT</td>
				<td width="40"><input type="text" name="tot_incur_cur"  style="width:36;text-align:center;" class="input2" readonly></td>
				<td width="250"><input type="text" name="tot_incur_amt"  style="width:170;text-align:right;" class="input2" readonly></td>
