...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtclosing.chargecalculation.event.EesDmt3006Event"%>
...
<html>
<head>
<title>Charge Inquiry by CNTR</title>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="158"><input type="text" name="cntr_no" value="<%=JSPUtil.getParameter(request, "cntr_no", "")%>" dataformat="engup" maxlength="14"  caption="CNTR No." style="width:100;" class="input1">&nbsp;<input type="text" name="cntr_tpsz_cd" readonly style="width:30;" class="input2" value=""></td>
						<td width="70">Tariff Type</td>
						<td width="272" class="sm"><script language="javascript">ComComboObject('tariff_type',2,64,1,1);</script><input type="checkbox" name="dul_tp_expt_chk" value="" disabled class="trans">Dual Type Exception&nbsp;<input type="checkbox" name="uclm_chk" value="" disabled class="trans">UC</td>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width=""><input type="text" name="inact_sts_mn" readonly style="width:108;" class="input2" value=""></td>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<table class="grid2" border="0" style="width:480;" style="border-bottom:1px solid #E8EFF9;"> 
							<tr class="h23">
								<td class="tr2_head" width="58">S/C No.</td>
								<td width="83" class="noinput2"><input type="text" name="sc_no" readonly style="width:80;" class="noinput2" value=""></td>
								...
								<td width="95" class="noinput2"><input type="text" name="acust" readonly style="width:95;" class="noinput2" value=""></td>
							</tr>
							<tr class="h23">
								<td class="tr2_head" width="">CMDT</td>
								<td width="" class="noinput2"><input type="text" name="cmdt_cd" readonly style="width:60;" class="noinput2" value=""></td>
								<td width="" colspan="4" class="noinput2"><input type="text" name="cmdt_nm" readonly style="width:330;" class="noinput2" value=""></td>
							</tr>
						</table>
						<table class="grid2" border="0" style="width:480;" style="border-bottom:1px solid #E8EFF9;"> 
							<tr class="h23">
								<td class="tr2_head" width="80">Rep. CMDT</td>
								<td class="noinput2" width="52"><input type="text" name="rep_cmdt_cd" readonly style="width:50;" class="noinput2" value=""></td>
						...
						<table class="grid2" border="0" style="width:480;"> 
							<tr class="h23">
								...
								<td class="noinput2" width="110"><input type="text" name="rlse_dt" id="rlse_dt" readonly style="width:105;" class="noinput2" value=""></td>
					...
					<tr class="h23">
						<td width="310">
							...
							<tr class="h23">
								...
								<td width="110" class="noinput2"><input type="text" name="fm_mvmt_dt"    maxlength=8  style="width:80;"  readonly
									class="noinput2"></td>
								<td width="75" class="noinput2"><input type="text" name="fm_mvmt_yd_cd"   maxlength=7 style="width:70;" class="noinput2" value="" readonly></td>
								<td width="" class="noinput2"><input type="text" name="fm_mvmt_sts_cd" readonly style="width:60;" class="noinput2" value=""></td>
							</tr>
								<td class="tr2_head" width="58">To</td>
								<td width="110" class="noinput2"><input type="text" name="to_mvmt_dt"   maxlength=8 style="width:80;"  readonly
									class="noinput2"></td>
								<td width="75" class="noinput2"><input type="text" name="to_mvmt_yd_cd"   maxlength=7  style="width:70;" class="noinput2" value="" readonly></td>
								<td width="" class="noinput2"><input type="text" name="to_mvmt_sts_cd" readonly style="width:60;" class="noinput2" value=""></td>
							</tr>
							</table>
						...
						<td width="">
							...
							<tr class="">
								...
								<td width="45" class="noinput2"><input type="text" name="ft_dys" readonly style="width:99%;text-align:right;" class="noinput2" value=""></td>
							...
							<tr class="h23">
								...
								<td width="" class="noinput2"><input type="text" name="fx_ft_ovr_dys" readonly style="width:99%;text-align:right;" class="noinput2" value=""></td>
						...
						<td width="" valign="up">
							...
							<!-- 
							<tr class="h23">
								<td class="tr2_head" width="">Over Due</td>
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="360">
							<table class="grid2" border="0" style="width:197;"> 
							<tr class="h23">
								<td class="tr2_head" width="151">Charge Currency</td>
								<td width="43" class="noinput2"><input type="text" name="bzc_trf_curr_cd" readonly style="width:99%;" class="noinput2" value=""></td>
							</tr>
							</table>
						</td>
					</tr>
				...
				<table class="search" border="0" style="width:600;"> 
					<tr class="h23">
						...
						<td width="360" valign="top">
							...
							<tr class="h23">
								<td class="tr2_head" width="145">Total AMT</td>
								<td width="" class="noinput2" colspan="2"><input type="text" name="total_amt" readonly style="width:99%;text-align:right" class="noinput2" value=""></td>
							</tr>
							<tr class="h23">
								<td class="tr2_head" width="">D/C by AMT  or %</td>
								<td width="" class="noinput2" colspan="2"><input type="text" name="aft_expt_dc_amt" readonly style="width:99%;text-align:right" class="noinput2" value=""></td>
							</tr>
							<tr class="h23">
								<td class="tr2_head" width="">Billable AMT</td>
								<td width="42" class="noinput2"><input type="text" name="bil_cur" readonly style="width:40;text-align:left" class="noinput2" value=""></td>
								<td width="" class="noinput2"><input type="text" name="bil_amt" readonly style="width:94%;text-align:right" class="noinput2" value=""></td>
							</tr>
							<tr class="h23">
								<td class="tr2_head" width="">Exception Cost</td>
								<td width="42" class="noinput2"><input type="text" name="expt_cost_cur" readonly style="width:40;text-align:left" class="noinput2" value=""></td>
								<td width="" class="noinput2"><input type="text" name="expt_cost_amt" readonly style="width:94%;text-align:right" class="noinput2" value=""></td>
							</tr>
							</table>
						</td>
					</tr>
				...
				<td>
					...
					<tr class="h23">
						...
						<td width="879" class="noinput2"><textarea  name="corr_rmk"  style="width:100%;height:90" class="noinput2" readonly></textarea></td>
					</tr>
					</table>
				</td>
