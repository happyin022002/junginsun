...
*@FileName : EES_DMT_1201.jsp
*@FileTitle : Basic Tariff Monitor Inquiry
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtmasterdatamgt.demdettariffmgt.event.EesDmt1201Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesDmt1201Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesDmt1201Event)request.getAttribute("Event");
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						...
						<td width="310">&nbsp;<script language="javascript">ComComboObject('combo9', 2, 270 , 0, 1)</script>&nbsp;<img src="img/btns_multisearch.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
						<td width="130">&nbsp;Exist&nbsp;
						...
						<td width="200">&nbsp;Billable/Exempted&nbsp;
							<select name="bill_exem" style="width:70;" class="input" >
								<option value="A" selected>All</option>
				...
				<table class="search_sm2" border="0" style="width:520;">					
					<tr class="h23">
						...
						<td width="80" class="stm"><input type="checkbox" name="validity1" value="Y" class="trans" checked>&nbsp;Current </td>
						<td width="240" class="stm">(<input type="checkbox" name="validity3" class="trans">&nbsp;Current Y - To be Y</td>
						<td width="250" class="stm"> | <input type="checkbox" name="validity4" class="trans">&nbsp;Current Y - To be N )</td>
						<td width="80" class="stm"><input type="checkbox" name="validity2" class="trans" >&nbsp;To-be</td>
					</tr>
				</table>
				<!--  biz_1  (E) --></div>
				<table class="line_bluedot"><tr><td colspan="6"></td></tr></table>
