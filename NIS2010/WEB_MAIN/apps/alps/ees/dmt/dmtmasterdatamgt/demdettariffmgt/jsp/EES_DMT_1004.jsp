...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtmasterdatamgt.demdettariffmgt.event.EesDmt1004Event"%>
       		...
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<tr class="h23">
						...
						<td width="839" colspan="5">&nbsp;<script language="javascript">ComComboObject('combo9', 2, 264 , 0, 1)</script>&nbsp;<img src="img/btns_multisearch.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					</tr>
					</table> 
