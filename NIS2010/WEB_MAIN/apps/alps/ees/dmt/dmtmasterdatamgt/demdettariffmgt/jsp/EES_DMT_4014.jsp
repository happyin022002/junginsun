...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtmasterdatamgt.demdettariffmgt.event.EesDmt4014Event"%>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="510"><script language="javascript">ComComboObject('combo1', 2, 104 , 0, 1, 0, true)</script>
					&nbsp;<input type="text" name="dmdt_trf_nm" style="width:367;" class="input2" readonly value=""></td>
				...
				<tr class="h23">
					...
					<td width="58" class="stm">Continent</td>
					<td width="60" class="stm"><input type="text" id="cvrg_continent" name="cvrg_continent" caption="Continent" style="width:44;" class="input2" readonly value="A" ></td>
					<td width="110" class="stm">Country&nbsp;<input type="text" id="cvrg_country" name="cvrg_country" caption="country" style="width:50;" class="input2" readonly value="CN" ></td>
					<td width="42" class="stm">Region</td>
					<td width="80" >&nbsp;<input type="text" id="cvrg_region" name="cvrg_region" caption="region" style="width:60;" class="input2" readonly value="CNS" ></td>
					<td width="125" class="stm">Location&nbsp;<input type="text" id="cvrg_location" name="cvrg_location" caption="Location" maxlength="5" fullfill style="width:60;" class="input" value="" dataformat="engup" style="ime-mode:disabled" onKeyPress="ComKeyOnlyAlphabet('upper')" OnKeyUp="checkLocation1(this)"></td>
					<td width="160" class="stm">Yard&nbsp;<input type="text" id="yd_cd1" name="yd_cd1" style="width:60;" class="input" value="" dataformat="engup" maxlength="5" style="ime-mode:disabled" onKeyPress="ComKeyOnlyAlphabet('upper')" OnKeyUp="checkYard1(this)" >&nbsp;<script language="javascript">ComComboObject('combo2', 2, 50 , 0, 0, 0, true)</script></td>
					<td             class="stm">BKG Term&nbsp;<script language="javascript">ComComboObject('combo3', 2, 60, 1, 1, 0, true);</script></td></tr>
					
				<tr class="h23">
					<td><span id="OriginDest">Origin</span></td>
					<td class="stm">Continent</td>
					<td width="" class="stm" style="padding-left:2;"><script language="javascript">ComComboObject('combo4', 2, 44 , 0, 1, 0, true)</script></td>
				...
				<tr class="h23">
					...
					<table class="search" border="0"> 
						<tr class="h23">
							...
							<td class="stm"><input type="checkbox" name="xcld_sat_flg" value="Y" class="trans" disabled><span id="wknd1">SAT</span>&nbsp;&nbsp;<input type="checkbox" name="xcld_sun_flg" value="Y" disabled class="trans"><span id="wknd2">SUN</span>&nbsp;&nbsp;<input type="checkbox" name="xcld_hol_flg" value="Y" disabled class="trans">HOLIDAY</td>
						</tr>
					</table>
					<!-- Grid  (S) -->
						<table width="100%"  id="mainTable"> 
