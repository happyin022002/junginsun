...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtmasterdatamgt.demdettariffmgt.event.EesDmt4015Event"%>
	...
	<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="80">&nbsp;<input type="text" id="cvrg_continent" name="cvrg_continent" caption="Continent" style="width:60;" class="input2" readonly value="A" ></td>
					<td width="55" class="stm">Country</td>
					<td width="80">&nbsp;<input type="text" id="cvrg_country" name="cvrg_country" caption="country" style="width:60;" class="input2" readonly value="CN" ></td>
					<td width="45" class="stm">Region</td>
					...
					<td width="148">&nbsp;<input type="text" id="yd_cd1" name="yd_cd1" style="width:60;" class="input" value="" dataformat="engup" maxlength="5"  style="ime-mode:disabled" OnKeyUp="checkYard1(this)" onKeyPress="ComKeyOnlyAlphabet('upper')" >
					&nbsp;<script language="javascript">ComComboObject('combo1', 2, 60 , 0, 0, true)</script></td>	
					<td             class="stm">BKG Term&nbsp;<script language="javascript">ComComboObject('combo2', 2, 60, 1, 1, 0, true);</script></td></tr>
					...
					<td width="80">&nbsp;<script language="javascript">ComComboObject('combo5', 2, 60 , 0, 0, 0, true)</script></td>
					<td width="55" class="stm">Location</td>
					...
					<tr class="h23">
						...
						<td width="" colspan="5">&nbsp;<script language="javascript">ComComboObject('combo6', 2, 259 , 1, 1)</script>&nbsp;</td>
					</tr>
					</table> 
					...
					<table class="search" border="0" style="width:979;"> 
					<tr class="h23">
						<td width="140">&nbsp;&nbsp;CNTR & Cargo Type</td>
						<td width="" colspan="5">&nbsp;<script language="javascript">ComComboObject('combo7', 2, 370 , 0)</script>&nbsp;<img src="img/btns_multisearch.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					</tr>
					</table> 
					
					<table class="search_sm" border="0" style="width:537;">
					...
					<tr class="h23">
						...
						<td width="800" class="stm" colspan="2"><input type="checkbox" name="validity3" value="Y" class="trans">&nbsp;Expired</td>
					</tr>
				</table>
				<!--  biz_1  (E) --></div>
				<table class="line_bluedot"><tr><td colspan="6"></td></tr></table>
