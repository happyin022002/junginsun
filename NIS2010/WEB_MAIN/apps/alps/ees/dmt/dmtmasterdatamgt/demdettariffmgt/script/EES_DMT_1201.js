...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class EES_DMT_1201 : EES_DMT_1201 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_DMT_1201() {
        ...
        switch(sheetID) {
            ...
            case "sheet1":      // sheet4 init
                with (sheetObj) {
					...
					var HeadTitle1 = "|Coverage|Tariff\nType|Origin\nDest|BKG\nTerm|CNTR & Cargo Type|CNTR & Cargo Type|Tariff Exist|Billable/\nExempted|Effective Date|Expiration Date|To-be Y/N|PIC Team|Notification|Notification|Tariff Confirm";
					var HeadTitle2 = "|Coverage|Tariff\nType|Origin\nDest|BKG\nTerm|CNTR|Cargo|Tariff Exist|Billable/\nExempted|Effective Date|Expiration Date|To-be Y/N|PIC Team|ID|Name|Tariff Confirm";
                    ...
                    InitDataProperty(0,	cnt++ ,	dtData,			 80,	daCenterTop,	true,		"coverage",				false,		"",		dfNone,	0,	false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,			 80,	daCenterTop,	true,		"dmdt_trf_cd",			false,		"",		dfNone,	0,	false, false, -1, false, false);
                    InitDataProperty(0,	cnt++ ,	dtData,			 80,	daCenterTop,	true,		"org_dest",			    false,		"",		dfNone,	0,	false, false, -1, false, false);
                    InitDataProperty(0,	cnt++ ,	dtData,			 80,	daCenterTop,	true,		"dmdt_de_term_nm",		false,		"",		dfNone,	0,	false, false, -1, false, false);
                    
                    InitDataProperty(0, cnt++ , dtData,			100,	daCenterTop,	true,		"dmdt_cntr_tp_desc",	false,		"",		dfNone,	0,	false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,			120,	daCenterTop,	true,		"dmdt_cgo_tp_desc",		false,		"",		dfNone,	0,	false, false, -1, false, false);
                    
                    InitDataProperty(0, cnt++ , dtData,			100,	daCenterTop,	true,		"exist",				false,		"",		dfNone,	0,	false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,			100,	daCenterTop,	true,		"bill_exem",			false,		"",		dfNone,	0,	false, false, -1, false, false);
                    ...
                    InitDataProperty(0, cnt++ , dtData,         100,    daCenterTop,    true,       "to_be_yn",             false,      "",     dfNone, 0,  false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,         110,    daCenterTop,    true,       "pic_team",             false,      "",     dfNone, 0,  false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,         110,    daCenterTop,    true,       "trf_mng_usr_id",       false,      "",     dfNone, 0,  false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,         110,    daCenterTop,    true,       "trf_mng_usr_nm",       false,      "",     dfNone, 0,  false, false, -1, false, false);
                    InitDataProperty(0, cnt++ , dtData,         60,    daCenterTop,    true,       "trf_cfm_flg",          false,      "",     dfNone, 0,  false, false, -1, false, false);
        ...
        switch(sAction) {
        	...
        	case IBSEARCH:      //조회
				...
				//2.조회전 결과필드들을 Empty 시킨다.
					...
					//2.조회조건으로 조회실행
					sheetObj.DoSearch("EES_DMT_1201GS.do", FormQueryString(formObj));
				...
				if (sheetObj.id == "sheet1") {
					...
					switch(sComboAction) {
						case SEARCHLIST08:
							...
							addComboItem2(comboObjects[7],comboItems);
							
							for (var i = 0 ; i < comboItems.length ; i++) {
					    		var comboItem = comboItems[i].split(FIELDMARK);
					    		comboObjects[7].CheckIndex(i) = true; 
					    	}
...
//								ComSetObjValue(formObj.yd_cd1, "");
	...
	function setParameters(sAction) {
		...
		ComSetObjValue(formObj.dmdt_cntr_cgo_list, comboObjects[7].Code);
	...
	function initSearchControls() {
		...
		ComSetObjValue(formObj.validity1, "Y");		
		ComSetObjValue(formObj.validity2, "N");		
		ComSetObjValue(formObj.validity3, "N");		
		ComSetObjValue(formObj.validity4, "N");		
		
		ComSetObjValue(formObj.exist, "A");		
		ComSetObjValue(formObj.bill_exem, "A");
		ComSetObjValue(formObj.exp_ofc_cd, "A");		
	}		
	/*
	 * html컨트롤 이벤트 초기화 
	 */	
	...
	function currentCheckEvent(){
		document.form.validity3.checked = document.form.validity1.checked;
		document.form.validity4.checked = document.form.validity1.checked;
		document.form.validity3.disabled = !document.form.validity1.checked;
		document.form.validity4.disabled = !document.form.validity1.checked;
	}
	
	function currentCheckEvent2(){
		if(!document.form.validity3.checked && !document.form.validity4.checked) {
			document.form.validity1.checked = false;
			document.form.validity3.disabled = true;
			document.form.validity4.disabled = true;
		}
	}
