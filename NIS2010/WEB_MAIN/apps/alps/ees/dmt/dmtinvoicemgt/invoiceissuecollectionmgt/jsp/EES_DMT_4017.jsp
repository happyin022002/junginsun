...
*@FileName : EES_DMT_4017.jsp
*@FileTitle : Outstanding Inquiry by Customer & Issue
*Open Issues :
*Change history :
*@LastModifyDate : 20140728
*@LastModifier : KimYC
*@LastVersion : 1.0
* 2009.05.11 KimYC
* 1.0 Creation
...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtinvoicemgt.invoiceissuecollectionmgt.event.EesDmt4017Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EesDmt4017Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
       ...
       strUsr_em = account.getUsr_eml();
        ...
        event = (EesDmt4017Event)request.getAttribute("Event");
            ...
            <tr><td class="bg">
                ...
                <table class="search" border="0" style="width:979;"> 
                    <tr class="h23">
                        ...
                        <td width="310" class="stm" style="padding-left:2;">
                        ...
                        <td width="">
                            <script language="javascript">ComComboObject('combo1',2,240,1,1)</script>
                            &nbsp;<img src="img/btns_multisearch.gif"width="19"height="20"alt=""border="0"align="absmiddle"class="cursor">
                        </td>
                    ...
                    <tr class="h23">
                        ...
                        <td width="">
                            <script language="javascript">ComComboObject('combo3',2,240,1,1)</script>
                ...
                <table class="search" border="0" style="width:979;"> 
                    <tr class="h23">
                        ...
                        <td width="540">
	                        ...
	                        <tr><td>
							<input type="text" name="payc1" style="width:80;" dataformat="engup" class="input" caption="Payer" maxlength="8" minlength="8" style="ime-mode:disabled" onKeyPress="ComKeyOnlyAlphabet('uppernum')" >&nbsp;
							</td>
                        ...
                        <td width="10">
                        <input type="checkbox" name="chk_srep_flg1" value="N" class="trans" onClick="checkSrepFlag()">
                        </td>
                ...
                <table class="search" border="0" style="width:979;"> 
                    <tr class="h23">
                        <td width="82">Sales OFC </td>
                        <td width="310">
                            <script language="javascript">ComComboObject('sal_tm',1,240,1)</script>
                        </td>
                        <td width="70">Sales rep</td>
                        <td width="290"><input type="text" style="width:100;;" class="input" value="" name="sal_rep" dataformat="engup" maxlength="9"></td>
                    
				        <td width="60">Currency</td>
				        <td width="">
				            <select style="width:100;" class="input" name="curr_sel">
    ...
    <!--Button (S) -->
        ...
        <tr><td class="btn1_bg">
            ...
            <tr>
                ...
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn1_left"></td>
                    <td class="btn1" name="btn1_det_excel">Detailed down Excel</td>
                    <td class="btn1_right"></td>
                    </tr>
                </table></td>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
