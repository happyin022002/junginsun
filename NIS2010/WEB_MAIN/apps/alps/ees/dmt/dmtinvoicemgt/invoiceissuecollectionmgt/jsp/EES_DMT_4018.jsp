...
<%@ page import="com.hanjin.apps.alps.ees.dmt.dmtinvoicemgt.invoiceissuecollectionmgt.event.EesDmt4018Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EesDmt4018Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
		...
		************************************************/
        ...
        event = (EesDmt4018Event)request.getAttribute("Event");
        tIsof = (String)request.getParameter("isof");
        tTftp = (String)request.getParameter("tftp");
        tFrdt = (String)request.getParameter("frdt");
        tTodt = (String)request.getParameter("todt");
        tArif = (String)request.getParameter("arif");
        tPayc = (String)request.getParameter("payc");
        //tPayn = (String)request.getParameter("payn");
        tCutp = (String)request.getParameter("cutp");
        tCuno = (String)request.getParameter("cuno");
        tCude = (String)request.getParameter("cude");
        tScno = (String)request.getParameter("scno");
        tRfan = (String)request.getParameter("rfan");
        prg_ex_in_cd = (String)request.getParameter("prg_ex_in_cd");
        sal_tm = (String)request.getParameter("sal_tm");
        sal_rep = (String)request.getParameter("sal_rep");
        curr_sel = (String)request.getParameter("curr_sel");
...
<html>
<head>
<title>OTS Clean-up Campaign - Detail(s)</title>
...
<input type="hidden" name="sal_tm" value="<%=sal_tm%>">
<input type="hidden" name="sal_rep" value="<%=sal_rep%>">
<input type="hidden" name="curr_sel" value="<%=curr_sel%>">
...
<input type="hidden" name="sls_rmrk">
<input type="hidden" name="sls_ui" value="EES_DMT_4018">
...
<input type="hidden" name="cntrflg" >
...
<!-- Grid  (e) -->
        ...
        <td width="133">
            <input type="text" name="vinvqty" style="width:80;text-align:right" class="input2" value="">
        </td>
        ...
        <td width="178">
            <input type="text" name="vincamt" style="width:160;text-align:right" class="input2" value="">
        </td>
        <td width="71">
            CMDT AMT
        </td>
        <td width="179">
            <input type="text" name="vcmdtamt" style="width:140;text-align:right" class="input2" value="">
        </td>
        <td width="85">
            Expt AMT
        </td>
        <td width="">
        	<input type="text" name="vexcepamt" style="width:100%;text-align:right" class="input2" value="">
        </td>
        ...
        <td width="133">
            <input type="text" name="vdcamt" style="width:120;text-align:right" class="input2" value="">
        </td>
        ...
        <td width="178">
            <input type="text" name="vbilamt" style="width:160;text-align:right" class="input2" value="">
        </td>
        <td width="71">
            Tax AMT
        </td>
        <td width="179">
            <input type="text" name="vtaxamt" style="width:140;text-align:right" class="input2" value="">
        </td>
        ...
        <td width="">
            <input type="text" name="vpayamt" style="width:100%;text-align:right" class="input2" value="">
        </td>
        </tr>
        </table>

        <table class="search" border="0" style="width:979" style=display:none;> 
                    <tr class="h23">
                        <td width="72">Attention</td>
        ...
        <tr class="h23">
        <td>
            <table class="search" border="0" style="width:721;"> 
            <tr class="h23">
        ...
        <td>
            ...
            <td width="">
                ...
                <tr class="h23">
                <td>
                    <input type="text" style="width:100%;font-family: Courier New;" class="noinput" value="" name="sls_rmk01" maxlength="85">
                </td>
                </tr>
                <tr class="h23">
                <td>
                    <input type="text" style="width:100%;font-family: Courier New;" class="noinput" value="" name="sls_rmk02" maxlength="85">
                </td>
                </tr>
                </table>
            </td>
        ...
        <td class="stm" width="80">
            <input type="checkbox" value="Y" class="trans" name="attachYN1" title="Attach CNTR Rate Detail(s) to OTS Invoice Shee">
            &nbsp;Attach
        </td>
        <td width="80">
        ...
        <td width="100">
            ...
            <td class="btn2" name="btn1_down_excel1" title="CNTR Rate Detail(s) Down Excel">
                Down Excel
            </td>
            <td class="btn2_right">
            </td>
        ...
        <td width="">
            ...
            <td class="btn2" name="btn1_detail_print1" title="CNTR Rate Detail(s) Print">
                Detail Print
            </td>
            <td class="btn2_right">
            </td>
    ...
    <td class="btn1_bg">
        ...
        <td>
            ...
            <td class="btn1_right">
                ...
                <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr><td class="btn1_left"></td>
                    <td class="btn1" name="btn2_salse_save">Save</td>
                    <td class="btn1_right"></td>
                    </tr>
                </table></td>
