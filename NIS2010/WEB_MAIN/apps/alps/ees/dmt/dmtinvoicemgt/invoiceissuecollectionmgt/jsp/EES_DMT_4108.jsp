...
*@FileTitle : DEM/DET Email Send(Fax/Email 송부시 송부대상을 선택하는 기능(pop-up))
*Open Issues :
*Change history :
...
<input type="hidden" name="creof"><!-- ots parameter -->
...
<table width="100%" class="popup" cellpadding="10" border="0"> 
	...
	<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;E-mail Send
			</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		    				...
		    				<tr>
								<td width=""><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
									<tr><td class="btn1_left"></td>
										<td class="btn1" name="btn_email">E-mail Send</td>
