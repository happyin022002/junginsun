...
* 2015.09.14 이율규 [CHM-201537843] MNR Estimate 생성 시 조회 조건 변경 로직 수정(검색조건추가: Request DT)
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.repairmgt.event.EesMnr0019Event"%>
	...
	<tr><td valign="top">
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg"> 
				...
				<tr class="h23">	
					...
					<td width=""><script language="javascript">ComComboObject('sp_name', 8, 280, 1, 1,0,false,1);</script></td>
				</tr>   
				</table>  
				
				<table class="search" border="0" style="width:399;"> 
				<tr class="h23">
					<td width="75">Tariff No.</td>   
					<td width="150"><input type="text" name="trf_no" style="width:129" class="input2" value="" readOnly></td>
					<td width="70">Cost Office</td>	     
					<td width=""><input tabindex="0" type="text" name="cost_ofc_cd"  style="width:75;" class = "input2" value = "<%=strOfc_cd%>" readOnly></td>
				</tr>   
				<tr class="h23"> 
					<td width="75">EQ Type</td>  	    
					<td width="150" style="padding-left:2"><script language="javascript">ComComboObject('eq_knd_cd', 1, 130, 1, 3,0,false,0);</script></td>
				...
				<tr class="h23">  
					...
					<td width="200">	 	
						<input type="text" name="req_st_dt" dataformat="ymd"    caption="from date"   maxlength="8"  size="10"  cofield="req_end_dt" value="" class="input">      
      					~ <input type="text" name="req_end_dt" dataformat="ymd"    caption="to date"  maxlength="8"  size="10"  cofield="req_st_dt" class="input">
      				</td>
      				<td>
		...
		<table class="line_bluedot"><tr><td></td></tr></table>
			...
			<tr><td class="tr2_head">MANU.DT</td>
				...
				<td align="left" colspan="3" id="RfUnitMaker"> </td> 				   
			</tr>
...
<div id="tabLayer" style="display:none"> 
			...
			<tr>	  
			<td width="979" valign="top" style="padding-right:20;" rowspan="2">
			<!-- Grid 2 - Damage images (S) -->	
				...
				<td class="title_s">Photo (Maximum Capatity: 5MB) </td></tr>
				</table> 	
