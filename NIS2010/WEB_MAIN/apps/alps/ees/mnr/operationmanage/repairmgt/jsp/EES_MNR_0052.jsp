...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.repairmgt.event.EesMnr0052Event" %>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="760"><input type="text" style="width:90;" class="input1" value="" name="mnr_ord_seq"  required dataformat="engup">&nbsp;<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" style="cursor:hand;" align="absmiddle" name="btn_WONo"></td>
					<td width="40">Date</td>
				...
				<tr class="h23">
					...
					<td width="270" style="padding-left:2"><script language="javascript">ComComboObject('combo_vndr_seq',9, 250, 1, 1,2,false,1);</script>
					...
					<td><input type="text" style="width:50;" class="input2" value="" name="cost_ofc_cd" readonly></td></tr> 
				<tr class="h23">
					...
					<td>Currency</td>
					<td><input type="text" style="width:50;" class="input2" value="" name="curr_cd" readonly></td>
				</tr>
				</table>										
				<!--  biz   (E) -->
		...
		<table class="search" id="mainTable"> 
       	<tr><td class="bg">	
			...
			<tr><td colspan="2">	
				...
				<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="105">Cost Type </td>
					<td width="200" style="padding-left:2"><script language="javascript">ComComboObject('combo_cost_cd',2, 250 , 1, 1,2,false,1);</script>
					<input type="hidden" name="cost_cd"></td>
					<td width="" class="stm"><input type="checkbox" class="trans" name="rpr_offh_flg">&nbsp;Off-hire</td>
				...
				<tr><td width="10%" class="tr2_head">Remark(s)</td>
				    <td><textarea name="ord_hdr_rmk" style="ime-mode:disabled" style="width:100%;height:40" maxlength="4000"></textarea>
				    <textarea name="ord_hdr_rmk_org" style="display:none" style="width:0;height:0" maxlength="4000"></textarea></td>
				</tr>
				</table>					
