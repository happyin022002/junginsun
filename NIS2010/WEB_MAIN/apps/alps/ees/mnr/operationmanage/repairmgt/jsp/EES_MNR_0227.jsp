...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.repairmgt.event.EesMnr0227Event" %>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Extra W/O Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
		...
		<!-- : ( Search Options ) (S) -->
			...
			<!--  biz_1  (S) -->
				...
				<tr class="h23">
					...
					<td width=""><input type="text" name="cost_cd" style="width:140;" class="input2" value="" readonly></td>
				</tr> 
				</table>				
				<!--  biz_1   (E) -->
				<!-- Grid  (S) -->
			...
			<tr><td width="580" style="padding-right:20" valign="top">
			
					<table border="0" style="width:100%; background-color:white;" class="grid2"> 
					<tr class="tr2_head">
						<td>Expense For</td></tr>
					<tr><td><textarea name="ord_hdr_rmk"  style="ime-mode:disabled" style="width:100%; height:76;"  readonly></textarea></td></tr>
					</table>				
