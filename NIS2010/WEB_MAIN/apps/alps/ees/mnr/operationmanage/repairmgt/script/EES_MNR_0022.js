...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /** 
     * @extends   
     * @class EES_MNR_0022 : EES_MNR_0022 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_MNR_0022() {
		        ...
		        case "btn_Detail":	
					if(sheetObjects[1].RowCount == 0){ 
						...
						if(MnrNullToBlank(sheetObjects[1].CellValue(sheetObjects[1].SelectRow,"rqst_eq_no")) != ''){
							//2012.11.23 조경완 [CHM-201220893-01] Estimate Group Auditing 에서 Estimate Auditing 화면으로 연결	
							var rqstEqNo = sheetObjects[1].CellValue(sheetObjects[1].SelectRow,"rqst_eq_no");   
							var rqstRefNo = sheetObjects[1].CellValue(sheetObjects[1].SelectRow, "rqst_ref_no");
...
//							var eqKndCd = sheetObjects[1].CellValue(sheetObjects[1].SelectRow,"eq_knd_cd"); 
							...
							ComOpenPopup('/hanjin/EES_MNR_0023.do?rqst_eq_no='+rqstEqNo+"&rqst_ref_no="+rqstRefNo+"&pop_flag=Y", 1024, 950, '', '0,0', true, false);
							doActionIBSheet(sheetObjects[1],formObject,IBSEARCH);
						}	 
					}
                    break;	
          ...
          case IBSEARCH:      //목록조회   rqst_type  
                 if(validateForm(sheetObj,formObj,sAction)){    
						...
						var sParam = FormQueryString(formObj);
         				...
         				sheetObj.DoSearch4Post("EES_MNR_0022GS.do",sParam); 
				  } 	        
                break; 	
