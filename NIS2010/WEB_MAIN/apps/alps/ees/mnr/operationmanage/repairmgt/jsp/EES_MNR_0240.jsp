...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.repairmgt.event.EesMnr0240Event"%>
...
<input type="hidden" name="mnr_inp_tp_cd" value="E">
	...
	<tr><td valign="top">
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:0;,padding-bottom:2;">
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Upload">EDI Upload</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td class="btn1_line"></td>
		...
		<!-- 2 (S) -->
			...
			<tr class="h23">
				...
				<td width="138">
				<input style="width:80;" type="text" name="rpr_yd_cd" value='' dataformat="engup" maxlength="7" caption="yard cd" class="input1">&nbsp;<img src="img/btns_search.gif" name="btn_popup" width="19" height="20" alt="" border="0" align="absmiddle" style="cursor:pointer;cursor:hand">
				</td>
