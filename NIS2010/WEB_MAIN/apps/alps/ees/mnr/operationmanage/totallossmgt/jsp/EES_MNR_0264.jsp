...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.totallossmgt.event.EesMnr0264Event"%>
<%@ page import="org.apache.log4j.Logger" %> 
					   
<% 					
	EesMnr0264Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0264Event)request.getAttribute("Event");
					...
					<td width="30%" valign="top">
						<table class="search_" border="0" style="width:295;">
							...
							<tr class="h23"> 
								...
								<td width=""><input type="text" name="respb_ofc_cd" style="width:100" value="<%=currOfcCd%>" class="input" dataformat="engup" >&nbsp;<img name="respb_ofc_cd_popup" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
							</tr>		 
							<tr class="h23"> 
								<td width="90">Regional HQ</td>
								<td width="85"><script language="javascript">ComComboObject('ar_hd_qtr_ofc_cd', 2, 70, 0, 0);</script></td>
							</tr>		
						</table>	
					</td>
					<td width="70%">  
