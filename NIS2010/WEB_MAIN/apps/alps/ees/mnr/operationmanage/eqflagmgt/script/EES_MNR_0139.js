...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class EES_MNR_0139 : EES_MNR_0139 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_MNR_0139() {
...
//                  InitDataProperty(0, cnt++ , dtStatus,	 	50,    	daCenter,  	false,   	"ibflag"); 
  ...
  // Sheet관련 프로세스 처리
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
			 case IBSAVE:        //저장
				    ...
				    var sXml = sheetObj.GetSaveXml("EES_MNR_0139GS.do", sParam);
	...
	function comPopupOK_139(sheetObj,formObject) {
		...
		opener.getEES_MNR_139(rArray,ret_val);  //호출하는 부모js에 getMnr_Multi 붙여넣으면됩니다.
		window.close();                 
	}   
