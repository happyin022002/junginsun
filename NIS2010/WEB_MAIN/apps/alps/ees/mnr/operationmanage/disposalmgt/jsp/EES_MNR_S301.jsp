...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.disposalmgt.event.EesMnrS301Event"%>
...
<html>
<head>
<title>   Bidding Notice</span></title>	    
...
<input type="hidden" name="program_id" value="S301">  
...
<table width="755" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	<tr><td valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
		    ...
		    <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">   Bidding Notice</span></td></tr>
		</table>
       		...
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:100%;"> 
					<tr class="h23"> 
						...
						<td width="110"> 
						<script language="javascript">ComComboObject('eq_knd_cd', 1, 80, 1, 0);</script>
						</td> 
						<td width="65">Sale Type</td> 
						<td width="80"> 
						<script language="javascript">ComComboObject('disp_ut_tp_cd', 1, 50,0);</script>
						</td> 
						<td width="60">Location</td> 
						<td width=""> 
						<script language="javascript">ComComboObject('location_type', 1, 70,0);</script>&nbsp;<input type="text" name="location_country_cd" style="width:55" class="input" dataformat="engup" maxLength="5">&nbsp;<img name="location_country_cd_popup" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					</tr>   
				</table>				
				<!--  biz_1   (E) -->
