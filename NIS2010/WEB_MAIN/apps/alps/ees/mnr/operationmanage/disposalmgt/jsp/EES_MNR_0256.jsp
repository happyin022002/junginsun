...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.disposalmgt.event.EesMnr0256Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesMnr0256Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0256Event)request.getAttribute("Event");
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr><td class="title_h"></td>
					<td class="title_s"> Cancelled Invoice List</td></tr>
				</table>
			<!-- Grid  (S) -->
