...
<%@ page import="com.hanjin.apps.alps.ees.mnr.operationmanage.disposalmgt.event.EesMnr0157Event"%>
					...
					<td width="220" valign="top">
						<table class="search_" border="0" style="width:200;"> 
							<tr class="h23"> 
								...
								<script language="javascript">ComComboObject('in_disp_tp_cd', 1, 100, 1, 1,0,false,0);</script>
								</td>   
								</tr>     
							<tr class="h23">  
								<td width="85">App. Office</td>    
