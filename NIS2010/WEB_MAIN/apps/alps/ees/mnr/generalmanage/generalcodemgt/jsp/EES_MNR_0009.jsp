...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.generalcodemgt.event.EesMnr0009Event"%>
	...
	<tr><td valign="top">
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					<td width="80">Class Code</td>
					<td><script language="javascript">ComComboObject('combo1', 5, 190, 1, 1);</script></td></tr> 
				</table>				
       	...
       	<tr><td class="bg">	
			...
			<tr><td valign="top" width="33%">	
					...
					<tr><td class="title_h"></td>
						<td class="title_s">Class Code</td></tr>
					</table>
					<!-- Title -->
				...
				<td valign="top" width="33%" style="padding-left:10px;">	
					...
					<table class="search" border="0">
					<tr><td class="title_h"></td>
						<td class="title_s">Sub Class Code</td></tr>
					</table>
					<!-- Title -->
					...
					<table width="100%" class="button"> 
			       	<tr><td class="btn2_bg">
						...
						<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td>
							<td class="btn2" name="btn_Excel2">Down Excel</td>
							<td class="btn2_right"></td>
							</tr>
							</table></td>
				...
				<td valign="top" style="padding-left:10px;">	
					...
					<table class="search" border="0">
					<tr><td class="title_h"></td>
						<td class="title_s">MNR Code</td></tr>
					</table>
					<!-- Title -->
