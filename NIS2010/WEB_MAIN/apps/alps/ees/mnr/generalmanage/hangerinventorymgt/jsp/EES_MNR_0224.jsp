...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.hangerinventorymgt.event.EesMnr0224Event"%>
...
<html>
<head>
<title>Hanger Bar Inventory History</title>
...
<tr><td valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
		    <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">   Hanger Bar Inventory History</td></tr>
		</table> 
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="120"><input name="ofc_cd" value="<%=ofcCd%>" type="text" style="width:75" class="input2" readOnly></td>
