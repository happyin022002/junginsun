...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.officegeneralinfomgt.event.EesMnr0217Event"%>
...
<html>
<head>
<title>M&R Colleague Tree</title>
		...
		<table class="search" id="mainTable"> 
			...
			<!--  biz_1  (S) -->
				...
				<tr class="h23">
					...
					<td width="105">Operation Office</td>
					<td width="">
