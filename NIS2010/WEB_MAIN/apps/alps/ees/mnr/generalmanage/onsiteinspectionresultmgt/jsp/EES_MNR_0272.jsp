...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.onsiteinspectionresultmgt.event.EesMnr0272Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EesMnr0272Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String vndrNm = ((request.getParameter("vndr_nm")==null )?"":request.getParameter("vndr_nm"));
	String ydCd = ((request.getParameter("yd_cd")==null )?"":request.getParameter("yd_cd"));
	String fldAudDt = ((request.getParameter("fld_insp_dt")==null )?"":request.getParameter("fld_insp_dt"));
	String ofcCd = ((request.getParameter("insp_ofc_cd")==null )?"":request.getParameter("insp_ofc_cd"));	

	String inspYr = ((request.getParameter("insp_yr")==null )?"":request.getParameter("insp_yr"));
	String inspWk = ((request.getParameter("insp_wk")==null )?"":request.getParameter("insp_wk"));
	
	String t2Flg = ((request.getParameter("t2Flg")==null )?"":request.getParameter("t2Flg"));
	...
	try {
		...
		event = (EesMnr0272Event)request.getAttribute("Event");
...
<input type="hidden" name="insp_ofc_cd" value="<%=ofcCd %>">
<input type="hidden" name="insp_yr" value="<%=inspYr %>">
<input type="hidden" name="insp_wk" value="<%=inspWk %>">
<input type="hidden" name="t2Flg" value="<%=t2Flg %>">
<input type="hidden" name="usr_id" value="<%=strUsr_id %>">
<input type="hidden" name="vndrSeq1" value="<%=vndrSeq %>">
<input type="hidden" name="vndrNm1" value="<%=vndrNm %>">
<input type="hidden" name="fld_insp_dt1" value="<%=fldAudDt %>">
<input type="hidden" name="yd_cd1" value="<%=ydCd %>">
<!-- 개발자 작업	-->
<table width="100%" class="popup" cellpadding="10" border="0"> 
	...
	<tr><td valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
		    <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">On-site Inspection Result Detail Info</span></td></tr>
		</table> 
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="100"><script language="javascript">ComComboObject('combo1',2, 80 ,1,1,1)</script></td>
