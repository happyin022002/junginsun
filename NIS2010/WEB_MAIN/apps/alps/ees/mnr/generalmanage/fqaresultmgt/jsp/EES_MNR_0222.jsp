...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.fqaresultmgt.event.EesMnr0222Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="150"><script language="javascript">ComComboObject('combo1',2, 90 , 0);</script></td>
					<td width="110">Operation Office</td>
					<td width="150"><script language="javascript">ComComboObject('combo2',2, 80 , 0,'','',0,'');</script></td>
