...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.reefersparepartmgt.event.EesMnr0137Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="65">Unit Type</td>
					<td width="160"><script language="javascript">ComComboObject('combo_spr_ut_tp_nm',2, 100 , 1, 0,2,false,1);</script>
