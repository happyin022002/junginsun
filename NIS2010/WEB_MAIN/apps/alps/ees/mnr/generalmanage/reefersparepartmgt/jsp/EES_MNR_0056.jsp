...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.reefersparepartmgt.event.EesMnr0056Event"%>
	...
	<tr><td valign="top">
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					<td width="40">Date</td>
					<td width="105"><select style="width:113;" name="date_gubun" class="input1" >
						<option value="0" selected>Supply Date</option>
						<option value="1">Discharge Date</option>
						<option value="2">Check Date</option>
						</select></td>
					<td width="250"><input type="text" style="width:80;text-align:center" class="input1" name="fromcal" dataformat="ymd" required  fulfill  readonly>&nbsp~&nbsp<input type="text" style="width:80;text-align:center" class="input1" name="tocal" dataformat="ymd" required  fulfill  readonly>&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar"></td>
					<td width="40">Lane</td>
					<td width="184"><input type="text" style="width:120;text-align:left" class="input" name="vsl_slan_cd" dataformat="engup">&nbsp;<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btn_Lane"></td>
					<td width="75">Spare Type</td>
					<td><script language="javascript">ComComboObject('combo_spr_tp_cd',2, 100 , 1, 0,2,false,1);</script>
		...
		<table class="search" id="mainTable"> 
			...
			<tr><td class="title_h"></td>
			    <td class="title_s" width="600"> Reefer Spare Parts Inventory</td>
			    <td align="right">
				   <table>
				   	<tr> 
				   	<td><table width="130" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_spare_type_list">Spare Type List</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
			     <td><table width="110" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_workorder_history">W/O History</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
				   	</tr>
