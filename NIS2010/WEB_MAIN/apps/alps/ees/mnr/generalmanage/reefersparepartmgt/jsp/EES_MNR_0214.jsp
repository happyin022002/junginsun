...
<%@ page import="com.hanjin.apps.alps.ees.mnr.generalmanage.reefersparepartmgt.event.EesMnr0214Event"%>
...
<input type="hidden" name="spr_tp_cd" value="">
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">   Reefer Spare Part Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<table class="search" border="0" style="width:680;"> 
					<tr class="h23">
						<td width="60">Unit Type</td>
						<td width="110"><script language="javascript">ComComboObject('combo_spr_ut_tp_nm',2, 100 , 1, 0,2,false,1);</script>
					<input type="hidden" name="spr_ut_tp_nm"></td>
						<td width="70">Supply To</td>
						<td width=""><input type="text" name="spr_prt_spl_tp_nm" width="100" class="input2">
						<input type="hidden" name="spr_prt_spl_tp_cd"></td>
