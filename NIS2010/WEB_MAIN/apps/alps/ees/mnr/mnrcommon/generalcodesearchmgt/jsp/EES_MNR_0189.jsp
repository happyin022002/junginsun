...
<%@ page import="com.hanjin.apps.alps.ees.mnr.mnrcommon.generalcodesearchmgt.event.EesMnr0189Event"%>
...
<%
	...
	String currOfcCd           = "";
	String currOfcEngNm     = "";
	Logger log = Logger.getLogger("com.hanjin.apps.alps.ees.mnr.mnrcommon.generalcodesearchmgt");
