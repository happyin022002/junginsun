...
<%@ page import="com.hanjin.apps.alps.ees.mnr.reportmanage.performancereport.event.EesMnr0165Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesMnr0165Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0165Event)request.getAttribute("Event");
...
<html>
<head>
<title>Disposal Performance by Office</title>
...
<input type="hidden" name="h_rhq_cd">
<input type="hidden" name="h_ofc_cd">
