...
<%@ page import="com.hanjin.apps.alps.ees.mnr.reportmanage.performancereport.event.EesMnr0244Event"%>
...
<html>
<head>
<title>Disposal Performance by RCC</title>
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td style="text-align:right"><input type="checkbox" name="p_chk_expand" class="trans">All Expanded&nbsp;&nbsp;</td>
				</tr>
				<tr class="h23">
