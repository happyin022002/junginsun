...
<%@ page import="com.hanjin.apps.alps.ees.mnr.reportmanage.performancereport.event.EesMnr0120Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="350">&nbsp;<script language="javascript">ComComboObject('report_period_type',2, 110 , 1,1)</script> 
				...
				<tr class="h23">
					...
					<td width="130">&nbsp;<script language="javascript">ComComboObject('ofc_cd',2, 100 ,0, 0,'',0,'');</script></td>					
					<td width="50">Yard</td>
				    <td><input type="text" style="width:60;" class="input" name="yd_cd" value="" required fullfill type="text"  dataformat="engup" maxlength="7">&nbsp;<img src="img/btns_search.gif" width="19" height="20" class="cursor" alt="" border="0" align="absmiddle" id="btn_popup" name="btn_yd"></td>
				</tr> 
				</table>				
				<table class="search" border="0" style="width:979;">  				
				<tr class="h23">		
					<td width="130">FQA Creation Date</td>  
					<td width="">&nbsp;<input required type="text" name="fqa_fm_dt" dataformat="ymd"  maxlength="8"  size="10"  cofield="fqa_to_dt" value="" class="input">   
                              	~ <input required type="text" name="fqa_to_dt" dataformat="ymd"  maxlength="8"  size="10"  cofield="fqa_fm_dt" class="input">&nbsp;<img name="btn_calendar" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle">
					</td>		
				</tr> 								 				
				</table>								
				<!--  biz_1   (E) -->
