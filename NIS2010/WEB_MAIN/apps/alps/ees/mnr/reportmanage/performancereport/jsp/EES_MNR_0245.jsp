...
<%@ page import="com.hanjin.apps.alps.ees.mnr.reportmanage.performancereport.event.EesMnr0245Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesMnr0245Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0245Event)request.getAttribute("Event");
...
<html>
<head>
<title>Disposal Performance by Month</title>
