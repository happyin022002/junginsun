...
<%@ page import="com.hanjin.apps.alps.ees.mnr.reportmanage.performancereport.event.EesMnr0238Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="300">&nbsp;<script language="javascript">ComComboObject('report_period_type',2, 100 , 1,1)</script>
						
						&nbsp;<input type="text" name="fm_dt" dataformat="ymd"    caption="from date"        maxlength="8"  size="8"  cofield="to_dt" value="">   
                              	~ <input type="text" name="to_dt" dataformat="ymd"    caption="to date"        maxlength="8"  size="8"  cofield="fm_dt">&nbsp;<img name="btn_calendar" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle">
					</td>			
					<td width="90" align="right">EQ&nbsp;Type&nbsp; &nbsp;</td>
					<td width="100">&nbsp;<script language="javascript">ComComboObject('eq_type',2, 100, 1, 0, 2,false,1);</script></td>
					<td width="92" align="right">TP/SZ&nbsp; &nbsp;</td>
				...
				<table class="search" border="0" style="width:979;"> 				
				<tr class="h23">		
					<td width="90">W/O&nbsp;Type</td>	  	
					<td width="200">&nbsp;<script language="javascript">ComComboObject('mnr_wo_tp_cd',2, 140,0);</script></td>
