...
<%
	EesMnr0212Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0212Event) request.getAttribute("Event");
	...
	String ofc_cd = JSPUtil.getParameter(request, "po");
	if (ofc_cd == null)
		ofc_cd = "";
%>
<html>
...
<form name="form"><input type="hidden" name="f_cmd"> <input
	...
	name="retfld"> <!-- 개발자 작업	--> <!-- OUTER - POPUP (S)tart -->
