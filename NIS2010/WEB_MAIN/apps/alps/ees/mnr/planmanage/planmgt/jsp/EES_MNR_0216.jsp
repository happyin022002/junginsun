...
<%@ page import="com.hanjin.apps.alps.ees.mnr.planmanage.planmgt.event.EesMnr0216Event"%>
	...
	<!--biz page (S)-->
		...
		<table class="search" id="mainTable"> 
			...
			<!--  biz_1  (S) -->
				...
				<tr class="h23">
					<td width="90">Guidline Type</td>
					<td><script language="javascript">ComComboObject('mnr_grp_tp_cd',1, 100 , 0,1);</script></td> 
					</tr> 
				</table>				
				<!--  biz_1   (E) -->
