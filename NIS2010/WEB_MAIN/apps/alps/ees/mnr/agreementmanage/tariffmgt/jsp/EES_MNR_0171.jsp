...
<%@ page import="com.hanjin.apps.alps.ees.mnr.agreementmanage.tariffmgt.event.EesMnr0171Event"%>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="320" style="padding-left:2"><script language="javascript">ComComboObject('cbAgmtOffice', 2, 72, 0, 1);</script></td>
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<!-- td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_RDTest">RDTest</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td-->
