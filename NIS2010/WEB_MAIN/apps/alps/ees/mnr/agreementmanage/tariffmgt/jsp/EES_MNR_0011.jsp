...
*@FileName : ESS_MNR_0011.jsp
*@FileTitle : MNR Local Tariff Creation and Verify
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.ees.mnr.agreementmanage.tariffmgt.event.EesMnr0011Event"%>
...
<input type="hidden" name="mnr_inp_tp_cd">						<!-- 생성 시스템구분 (M:ALPS,W:SPP) -->
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="189"> <input type="text" name="search_trf_no" style="width:135;text-align:center" class="input1" required dataformat="engup" maxlength="20">&nbsp;<img name="trf_no_popup" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">
					<input type="hidden" name="trf_no" class="input2" readOnly="true">
					</td>
					<td width="75">Tariff Office</td>
					<td width="116"><input type="text" name="rqst_ofc_cd" style="width:50" class="input2" value="<%=strOfc_cd%>" readonly="readonly"></td>
					<td width="90">Creation User</td>
					<td width="95"><input type="text" name="cre_usr_id" style="width:80;text-align:center" class="input2" value="<%=strUsr_id%>" readonly="readonly"></td>
					<td width="90">Creation Date</td>
					<td width="90"><input type="text" name="cre_dt" style="width:80;text-align:center" class="input2" readonly="readonly"></td>
				...
				<tr class="h23">
					...
					<td width="110" style="padding-left:"><script language="javascript">ComComboObject('combo2', 1, 98, 1, 0);</script></td>
					<td width="60">S/P Code</td>
					<td width="230"><input type="text" name="vndr_seq" style="width:60;text-align:center" class="input1" dataformat="engup" maxlength="6">&nbsp;<img name="provider_popup" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">&nbsp;<input type="text" name="vndr_nm" style="width:130" class="input2" readonly="readonly"></td>
					<td width="58">Eff. from </td>
					<td width="155"><input type="text" name="eff_dt" style="width:80;text-align:center" class="input1" dataformat="ymd" maxlength="8">&nbsp;<img name="eff_dt_cal" src="img/btns_calendar.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					<td width="30">Cur.</td>
					<td width="86" style="padding-left:0"><script language="javascript">ComComboObject('combo4', 1, 80, 1, 0);</script></td>
					<td width="100">Unit Of Measure</td>
					<td width="" style="padding-left:2"><script language="javascript">ComComboObject('combo3', 1, 90, 1, 0);</script></td>
