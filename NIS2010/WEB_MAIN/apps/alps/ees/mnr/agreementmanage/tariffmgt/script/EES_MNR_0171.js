...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ees_mnr_0171 : ees_mnr_0171 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_mnr_0171() {
            ...
            case 1:      //t1sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitColumnInfo(headCount+ 1, 4, 0, true);
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      
				if(validateForm(sheetObj,formObj,sAction)) {
					...
					//조회
					var sXml = sheetObj.GetSearchXml("EES_MNR_0171GS.do", FormQueryString(formObj));
