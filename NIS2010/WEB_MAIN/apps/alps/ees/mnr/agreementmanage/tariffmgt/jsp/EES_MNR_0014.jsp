...
<%@ page import="com.hanjin.apps.alps.ees.mnr.agreementmanage.tariffmgt.event.EesMnr0014Event"%>
...
<input type="hidden" name="vndr_seq">							<!-- Vendor Sequence -->
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="170"><input type="text" name="search_trf_no" style="width:135;text-align:center" class="input1" required dataformat="engup" maxlength="20">&nbsp;<img name="trf_no_popup" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">
					<input type="hidden" name="trf_no" class="input2" readOnly="true">
					</td>
					<td width="75">Tariff Office</td>
					<td width="110"><input type="text" name="rqst_ofc_cd" style="width:75" class="input2" readonly="readonly"></td>
					<td width="90">Creation User</td>
					<td width="100"><input type="text" name="cre_usr_id" style="width:80;text-align:center" class="input2" readonly="readonly"></td>
					<td width="90">Creation  Date</td>
					<td width="110"><input type="text" name="cre_dt" style="width:80;text-align:center" class="input2" readonly="readonly"></td>
					<td width="43">Status</td>
					<td width="" style="padding-left:3"><script language="javascript">ComComboObject('combo1', 1, 145, 1, 0);</script></td>				
					</tr>
				<tr class="h23">
					<td width="">EQ Type </td>
					<td width="" style="padding-left:2"><script language="javascript">ComComboObject('combo2', 1, 135, 1, 0);</script></td>
					<td width="">Eff. from </td>
					<td width=""><input type="text" name="eff_dt" style="width:75;text-align:center" class="input1" dataformat="ymd" maxlength="8">&nbsp;<img name="eff_dt_cal" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle"></td>
					<td width="">Currency</td>
					<td width="" style="padding-left:2"><script language="javascript">ComComboObject('combo3', 1, 80, 1, 0);</script></td>
					<td width="" colspan="4">Unit Of Measure&nbsp;<script language="javascript">ComComboObject('combo4', 1, 68, 1, 0);</script></td>
					</tr> 
				</table>			
				<!--  biz_1   (E) -->
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t5LoadExcel">Load Excel</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
...
<div id="tabLayer" style="display:none">
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				...
				<tr><td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6RowAdd">Row Add</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6Delete">Row Delete</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
					...
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_t6RowCopy">Row Copy</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
	       ...
	       <table class="search" border="0" style="width:100%;"> 
			...
			<td width="" valign="top" style="padding: 20 0 0 0">
				...
				<tr><td class="tr2_head" width="100">Remark(s)</td>  
					<td>     
					<textarea name="mnr_trf_rmk" wrap="off" style="width:100%;height:60;"></textarea>
					</td>  
				</tr> 
				</table>
			</td>
