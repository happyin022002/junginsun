...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class EES_LSE_0097 : EES_LSE_0097 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
            ...
            case "sheet1":
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++ , dtData,			250,	daLeft,		false,	"rqst_file_sav_nm",		false,	"",	dfNone,		0,		false,		false);
					...
					InitDataProperty(0, cnt++ , dtData,			250,	daLeft,		false,	"apro_file_sav_nm",		false,	"",	dfNone,		0,		false,		false);
					InitDataProperty(0, cnt++ , dtHidden,		200,	daLeft,		false,	"apro_file_sav_id",		false,	"",	dfNone,		0,		false,		false);
					InitDataProperty(0, cnt++ , dtData,			300,	daLeft,		false,	"cxl_rsn_desc",			false,	"",	dfEngUpKey,	0,		false,		false,	100);
					...
					InitDataValid(0, "cxl_rsn_desc",	vtEngOther,   "0123456789 ");

				  	//전반적인 팝업 버튼 이미지를 설정한다.
  					//PopupImage = "/hanjin/img/btn_file.gif";
    ...
    function sheet1_OnSearchEnd(sheetObj, ErrMsg) {
    	with(sheetObj) {
    		...
    		for(var i = HeaderRows; i <= LastRow; i++) {
    			var vAproMode = CellValue(i, "mss_usd_apro_mod_cd");
    			CellEditable(i, "del_chk") = vAproMode == "APP";
    			if(vAproMode == "CNL") {
    				CellFontColor(i, "mss_usd_apro_mod_cd") = RgbColor(255, 0, 0);
    				CellEditable(i, "cxl_file_sav_nm") = true;
					CellEditable(i, "cxl_rsn_desc") = true;
    			}
    		}
	...
	function sheet1_OnChange(sheetObj, Row, Col, Value) {
		...
		with(sheetObj) {
			...
			switch(sName) {
				case "del_chk":
					if(Value == "1") {
						CellEditable(Row, "cxl_file_sav_nm") = true;
						CellEditable(Row, "cxl_rsn_desc") = true;
					} else {
						CellEditable(Row, "cxl_file_sav_nm") = false;
						CellEditable(Row, "cxl_rsn_desc")  = false;
						CellValue2(Row, "cxl_file_sav_nm") = "";
						CellValue2(Row, "cxl_file_sav_id") = "";
						CellValue2(Row, "cxl_rsn_desc")    = "";
					}
				break;
			}
		}
			...
			case "cxl_file_sav_nm":
				...
				if ( fileName.indexOf("\\") == -1 ) {
			 	...
			 	if ( !badFile ) {
			 		ComOpenWait(true);
			 		fileUploadFlag = true;
			 		sheetObj.CellValue2(Row, "cxl_file_sav_nm")   = relativePath;
					...
					sheetObj.CellValue2(Row, "cxl_file_sav_id") = uploadFileName;
