...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.onhireapproval.event.EesLse0030Event"%>
...
<input type="hidden" name="period_stdt">
<input type="hidden" name="period_eddt">
       	...
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
		       <td><table width="" border="0" cellpadding="0" cellspacing="0" class="button">
				...
				<td><table width="72" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="Cancel">Cancel</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
		</tr>
	...
	<table class="search" > 
       		<tr><td class="bg" style="height:516" valign="top">
				...
				<tr class="h23">
					...
					<td width="140">&nbsp;<script language="javascript" >ComComboObject('combo1', 1, 50, 1 ,1);</script></td>
					...
					<td width=""><script language="javascript">ComComboObject('cntr_onh_auth_no', 1, 150, 1 ,1);</script><input type="hidden" name="agmt_cty_cd" value="" ><input type="hidden" name="agmt_seq" value="" ></td>
				</tr> 
				</table>
				<!--  biz_1  (E) -->				
				...
				<tr class="h23">
					...
					<td width="108">&nbsp;<script language="javascript" >ComComboObject('combo2', 1, 106, 1 ,1);</script></td>
					<td width="265"><input type="text" name="tpsz_cd" style="width:220" value="" class="input" readonly></td>
				...
				<tr>
					...
					<td><textarea style="width:100%;height:80;" name="remarks" ></textarea></td>	
				</tr> 
				</table>
