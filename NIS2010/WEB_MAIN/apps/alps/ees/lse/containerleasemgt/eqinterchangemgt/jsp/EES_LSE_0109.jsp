...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.eqinterchangemgt.event.EesLse0109Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EesLse0109Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0109Event)request.getAttribute("Event");
...
<input type="hidden" name="current_auth">
<!-- 개발자 작업	-->
		...
		<table class="search" id="mainTable"> 
       		<tr>
				...
				<table class="line_bluedot"><tr><td></td></tr></table>	
				 ...
				 <table class="search" border="0" bordercolor="red" style="width:650;"> 
					...
					<tr class="h23">
						...
						<td width="30">To</td>
						<td width="180">
						  	<select name="loc_tp" style="width:63;">
