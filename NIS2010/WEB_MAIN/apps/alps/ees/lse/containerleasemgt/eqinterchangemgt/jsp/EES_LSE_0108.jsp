...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.eqinterchangemgt.event.EesLse0108Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
	EesLse0108Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0108Event)request.getAttribute("Event");
...
<html>
<head>
<title>EQ interchange Approval</title>
			...
			<table class="search" id="mainTable">
       		<tr><td class="bg">
       			<table class="search" border="0"><tr><td>
					...
					<tr class="h23">
						<td width="40">&nbsp;LCC </td>
						<td width="100"><input type="text" name="loc_cd" style="width:72;text-align:center;" class="input2" value="" readonly></td>

						<td width="55">Auth No.</td>
						<td width="643">
							<input type="text" name="auth_no" style="width:150;text-align:center;" class="input2" value="" readonly>
						</td>
					</tr>
					</table>
				</td></tr></table>
			...
			<table width="100%" class="button">
	       	<tr><td class="btn2_bg">
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn2_left"></td>
					<td class="btn2" name="btn_Creation">Auth Creation</td>
					<td class="btn2_right"></td>
					</tr>
					</table></td>
