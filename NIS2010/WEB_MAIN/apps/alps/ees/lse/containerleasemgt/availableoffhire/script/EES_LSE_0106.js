...
*@FileName : ees_lse_0106.js
*@FileTitle :LSE Component
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends LSE   
     * @class ees_lse_0106 : ees_lse_0106 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ees_lse_0106() {    
		...
		switch(sheetNo) {
			case 1:      //sheet1 init
				with (sheetObj) {
					...
					InitDataProperty(0, cnt++ , dtData,     100,   daCenter,  false,    "multiplekey",  false,			"",       dfNone,        0,       true,       true,	  11,	 true,	 true,	   "",	  false);
	...
	function comPopupOK(sheetObj,formObject) {
		...
		if(errcnt > 0){       
			ComShowCodeMessage("LSE01160", "Multiple Inquiry data!"); 
