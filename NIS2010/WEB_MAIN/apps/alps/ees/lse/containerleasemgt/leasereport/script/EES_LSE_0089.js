 ...
 *@FileName : EES_LSE_0089.js
 *@FileTitle : Off Hire Report Summary by RCC
 *Open Issues :
 *Change history :
 ...
 * 2014.02.26 길정권 CHM-201428950 ALPS-CNTR Lease-Report-Off hire Result-Off Hire result Summary By RCC
=========================================================*/
/****************************************************************************************
...
/**
 * @extends
 * @class EES_LSE_0089 : EES_LSE_0089 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function EES_LSE_0089() {
...
function initSheet(sheetObj,sheetNo) {
	...
	case "sheet1":
		with (sheetObj) {
			...
			var HeadTitle = "|RCC" + HeadTitleTemp + "|G.TTL|Ratio|";
			...
			for(var i = 0; i < 2; i++) {
				...
				InitDataProperty(i, cnt++ , dtHidden,		30,  	daCenter,	true,	"level_no",			false,	"",		dfNone);
				InitDataProperty(i, cnt++ , dtData,             90,    daCenter, true,  "rcc",         false,  "",     dfNone);
				for(var j=0; j<arrTpSz2.length; j++){
					InitDataProperty(i, cnt++ , dtData,             50,    daRight,  true,  arrTpSz2[j]+"",          false,  "",     dfNone,   0,  false,    true);
				}
				InitDataProperty(i, cnt++ , dtData,             50,    daRight,  true,  "div_total",       false,  "",     dfNone,   0,  false,    true);
				InitDataProperty(i, cnt++ , dtData,             50,    daRight,  true,  "ratio",       false,  "",     dfNone,   0,  false,    true);
			...
			InitTreeInfo("rcc", "", RgbColor(0,0,255), false);
		}
		break;
	}
}
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	if(validateForm(sheetObj,formObj,sAction))
		if (sheetObj.id == "sheet1"){
			...
			ComOpenWait(true);
			var sXml = sheetObj.GetSearchXml("EES_LSE_0089GS.do", FormQueryString(formObj));
