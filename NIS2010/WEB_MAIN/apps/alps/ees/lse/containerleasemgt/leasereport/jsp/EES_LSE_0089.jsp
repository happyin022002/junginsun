...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.leasereport.event.EesLse0089Event"%>
...
<html>
<head>
<title>Off Hire Report Summary by RCC</title>
 ...
 <table class="search"> 
			...
			<table class="search" border="0" style="width:979;"> 
				...
				<tr class="h23">
					...
					<td style="text-align:left"><input type="checkbox" name="chk_expand" class="trans"> All Expanded</td>
				</tr>
			</table>
