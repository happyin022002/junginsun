...
*@FileName : EES_LSE_0057.jsp
*@FileTitle : Total Container Inventory by Lease Term & TP/SZ
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.leasereport.event.EesLse0057Event"%>
...
<html>
<head>
<title>Total Container by Lease Term & TP/SZ</title>
...
<input type="hidden" name="hcond_agmt_cty_cd">
<input type="hidden" name="hcond_agmt_seq">
<input type="hidden" name="hcond_tpsz_cd">
<input type="hidden" name="hcond_mvsts_cd">
		...
		<table class="search" id="mainTable">
       		<tr><td class="bg">
				...
				<tr class="h23">
			        ...
			        <input type="text" name="loc_cd" caption="Location" style="width:95;ime-mode:disabled;" value="" class="input2"  dataformat="engup" maxlength="5" readonly fullfill>
					...
					<td width="550"><input type="text" name="vndr_seq" caption="Lessee" style="width:60;text-align:center;" class="input" value="" maxlength="6" dataformat="int">
						...
						<input type="text" name="vndr_nm" caption="Lessor." style="width:316" class="input2" value="" readonly>
					</td>
					<td style="text-align:right"><input type="checkbox" name="chk_expand" class="trans"> All Expanded</td>
				</tr>
				</table>
				<table class="search" border="0" style="width:979;">
				<tr class="h23">
					...
					<td width="68">AGMT No.</td>
					<td width="200"><input type="text" name="agmt_cty_cd" caption="AGMT No." style="width:40;text-align:center;" value="HHO" class="input2" readonly>
						<input type="text" caption="AGMT No." name="agmt_seq" style="width:100;text-align:center;" class="input" value="" maxlength="6" dataformat="int">
					...
					<td width="140">
						<script language="javascript" >ComComboObject('combo2', 1, 110, 1 );</script>
					</td>
					<td width="90">MVMT Status</td>
					<td width="">
						<script language="javascript" >ComComboObject('combo3', 1, 110, 1);</script>
					</td>
				</tr>
				</table>
			</td></tr>
