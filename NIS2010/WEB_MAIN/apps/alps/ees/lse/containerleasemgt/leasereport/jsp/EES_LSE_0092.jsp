...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.leasereport.event.EesLse0092Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesLse0092Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0092Event)request.getAttribute("Event");
...
<html>
<head>
<title>On-Hire Total Summary By Lease Term & Year</title>
					...
					<tr class="h23">
					    ...
					    <td width="460" colspan="2">
						   <select name="loc_tp" dataformat="engup">
					        ...
					        <input type="text" style="width:350" name="loc_cd"  value="" class="input2" readonly>
					...
					<tr class="h23">
					    <td width="80">
					      Supplier
						   	...
						   	<td width="404"><input type="text" style="width:401" name="supplier"  value="" class="input2" readonly>&nbsp;<input type="hidden" name="vndr_seq"  value="" >
						   	<td width="56"><img class="cursor" name="btns_search2" src="img/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
					    <td width="80">
					        TP/SZ
					     </td>
					    <td width="">
