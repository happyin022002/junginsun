...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.leasereport.event.EesLse0090Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesLse0090Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0090Event)request.getAttribute("Event");
...
<html>
<head>
<title>Off Hire Report Summary By Month</title>
 ...
 <table class="search"> 
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					...
					<td width="270">
					   <input type="text" name="period_stdt" style="width:80;ime-mode:disabled" value="" class="input1"  maxlength="8" dataformat="ymd" >&nbsp;~&nbsp;<input type="text" name="period_eddt" style="width:80;ime-mode:disabled" value="" class="input1" maxlength="8" dataformat="ymd" >&nbsp;<img class="cursor" src="img/btns_calendar.gif" name="btns_calendar2" width="19" height="20" border="0" align="absmiddle">
					</td>
