...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerleasemgt.leasereport.event.EesLse0036Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesLse0036Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0036Event)request.getAttribute("Event");
...
<html>
<head>
<title>On Hire Result by Location / AGMT No(Contract No.)-Option</title>
