...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class EES_LSE_0082 : EES_LSE_0082 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_LSE_0082() {
	...
	function rdOpen(){		
		...
		rdObjects[0].FileOpen(RD_path+'apps/alps/ees/lse/containerrentalcost/receivablerentalcost/report/EES_LSE_0082.mrd',RDServer);
		//rdObjects[0].FileOpen('http://localhost:7001/hanjin/apps/alps/ees/lse/containerrentalcost/receivablerentalcost/report/EES_LSE_0082.mrd',RDServer);
	}
