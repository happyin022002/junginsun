...
*@FileName : EES_LSE_0083.js
*@FileTitle : EQ Receivable Charge Summary by  Lease Term & Month
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class EES_LSE_0083 : EES_LSE_0083 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_LSE_0083() {
	...
	function rdOpen(){		
		...
		rdObjects[0].FileOpen(RD_path+'apps/alps/ees/lse/containerrentalcost/receivablerentalcost/report/EES_LSE_0083.mrd',RDServer);
		//rdObjects[0].FileOpen('http://localhost:7001/hanjin/apps/alps/ees/lse/containerrentalcost/receivablerentalcost/report/EES_LSE_0083.mrd',RDServer);
	}
