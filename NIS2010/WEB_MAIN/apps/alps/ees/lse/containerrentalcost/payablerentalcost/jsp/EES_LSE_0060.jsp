...
<%@ page import="com.hanjin.apps.alps.ees.lse.containerrentalcost.payablerentalcost.event.EesLse0060Event"%>
...
<html>
<head>
<title>EQ Payable Charge Summary</title>
       		...
       		<tr>
				...
				<tr class="h23">
					...
					<td width="" colspan="3">
					   <select style="width:178;" name="report_type" class="input1">
						<option value="rp_0060" selected>By Charge Type</option>
				...
				<tr class="h23">
					...
					<td width="435" valign='Top'>
                       ...
                       <table><tr><td>
					   <input type="text" name="period_stdt" style="width:60;ime-mode:disabled" value="" class="input1"  maxlength="6" dataformat="ym" >&nbsp;
					   &nbsp;~&nbsp;
					   <input type="text" name="period_eddt" style="width:60;ime-mode:disabled" value="" class="input1" maxlength="6" dataformat="ym" >&nbsp;
					...
					<td style="padding-left:2;">
					  <select style="width:110;" name="company" class="input">
				...
				<tr class="h23">
					...
					<td width="435">
					   <select style="width:60;" name="status" class="input">
						<option value="" selected>All</option>
						<option value="SBO">SBO</option>
						<option value="MUO">MUO</option>
					  </select>
					</td>
					<td width="120">Payable Amount</td>
					<td style="padding-left:2;">
					  <select style="width:110;" name="payable" class="input">
					    <option value="S" selected>S/O Amount</option>		
				...
				<tr class="h23">
					...
					<td width="485" >
					   <select style="width:178;" name="report_type" class="input1">
						...
						<option value="rp_0063" >By Lease Term & Month</option>
						<option value="rp_0064" >By Lessor & Month</option>
						<option value="rp_0065" >Summary Payable Charge</option>
					  </select>
					</td>	
					<td width="120">Period</td>					
					<td  width="" valign='Top'><input type="text" name="temp_text1" style="width:0;" value="" >
					   <div id="fixLayer1" style="position:absolute; visibility:hidden;">
                       <table><tr><td>
					   <input type="text" name="period_stdt" style="width:60;ime-mode:disabled" value="" class="input1"  maxlength="6" dataformat="ym" >&nbsp;<img class="cursor" src="img/btns_calendar.gif" name="btns_calendar2" width="19" height="20" border="0" align="absmiddle">&nbsp;~&nbsp;<input type="text" name="period_eddt" style="width:60;ime-mode:disabled" value="" class="input1" maxlength="6" dataformat="ym" >&nbsp;<img class="cursor" src="img/btns_calendar.gif" name="btns_calendar3" width="19" height="20" border="0" align="absmiddle">
					   </td></tr></table>
					   </div>
					   <div id="fixLayer2" style="position:absolute; visibility:hidden;">
                       <table><tr><td>
				...
				<tr class="h23">
					...
					<td style="padding-left:5">
					  <select style="width:120;" name="payable" class="input">
					    <option value="T" selected>SM Line Amount</option>	
				  ...
				  <table class="search" border="0" bordercolor="red" style="width:979;"> 
					<tr class="h23">
					    ...
					    <td style="padding-left:7;">
						    <script language="javascript" >ComComboObject('combo1', 1, 185, 1 );</script>&nbsp
					...
					<tr class="h23">
					    ...
					    <td style="padding-left:7;">
						    <script language="javascript" >ComComboObject('combo2', 1, 185, 1 );</script>&nbsp;
					...
					<tr class="h23">
					    ...
					    <td style="padding-left:7;">
						  <script language="javascript" >ComComboObject('combo3', 1, 185, 1 );</script>&nbsp;
