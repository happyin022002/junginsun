...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends
     * @class EES_LSE_0067 : EES_LSE_0067 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function EES_LSE_0067() {
	...
	function rdOpen(){
		...
		rdObjects[0].FileOpen(RD_path+'apps/alps/ees/lse/containerrentalcost/payablerentalcost/report/EES_LSE_0067.mrd',RDServer);
	}
 	/* 개발자 작업  끝 */