...
<%@ page import="com.hanjin.apps.alps.ees.lse.containercostanalysis.payableestimateaudit.event.EesLse0018Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.ContainerCostAnalysis.PayableEstimateAudit");
