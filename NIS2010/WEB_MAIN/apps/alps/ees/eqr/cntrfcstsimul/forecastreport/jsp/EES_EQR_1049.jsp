...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrfcstsimul.forecastreport.event.EesEqr1049Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EesEqr1049Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    String row    = ""; // 1003화면의 1049를 오픈한 row 구분
    String levelCd = "";
    ...
    try {
        ...
        event = (EesEqr1049Event)request.getAttribute("Event");
