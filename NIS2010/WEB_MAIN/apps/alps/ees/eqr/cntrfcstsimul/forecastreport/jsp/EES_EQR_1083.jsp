...
*@FileName : EES_EQR_1083.jsp 
*@FileTitle : MTY Repo Other 상세내역 조회 
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrfcstsimul.forecastreport.event.EesEqr1083Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EesEqr1083Event  event = null;              //PDTO(Data Transfer Object including Parameters)
...
//    String row    = ""; // 1003화면의 1083를 오픈한 row 구분
    try {
        SignOnUserAccount account=(SignOnUserAccount)session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
        strUsr_id = account.getUsr_id();
        strUsr_nm = account.getUsr_nm();

        event = (EesEqr1083Event)request.getAttribute("Event");
