...
*@FileName : EES_EQR_1082.js
*@FileTitle : MTY Repo In 과거실적 상세내역 조회
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    /**
    * @extends 
    * @class EES_EQR_1082 : EES_EQR_1082 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
    */
    function EES_EQR_1082() {
    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        switch(shtID) {
            ...
            with (sheetObj) {
                ...
                var HeadTitle = "Yard|Lane|VVD|ETB|DAY|D2|D4|D5|D7|R2|R5|R9|O2|S2|O4|S4|O5|F2|A2|F4|A4|F5|A5||||||";
                ...
                InitDataProperty(0, cnt++ , dtData,           80,     daCenter,   true,  "to_yd_cd",         false,  "",        dfNone, 		0,		false,		true,	5);
                InitDataProperty(0, cnt++ , dtData,           55,     daCenter,   true,  "vsl_lane_cd",  	 false,  "",        dfNone, 		0,		false,		false,	3);
                InitDataProperty(0, cnt++ , dtData,           85,     daCenter,   true,  "vvd",              false,  "",        dfNone, 		0,		false,		false,	9);
                InitDataProperty(0, cnt++ , dtData,           80,     daCenter,   true,  "to_etb_dt",        false,  "",        dfDateYmd, 	    0,		false,		false);
                InitDataProperty(0, cnt++ , dtData,           48,     daCenter,   true,  "to_etb_day",       false,  "",        dfDateYmd, 	    0,		false,		false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                var sXml = sheetObj.GetSearchXml("EES_EQR_1082GS.do",FormQueryString(formObj));
    		...
    		case IBSEARCH02:      //공통조회
    			...
    			var sXml = sheetObj.GetSearchXml("EES_EQR_1082GS.do" , FormQueryString(form));
