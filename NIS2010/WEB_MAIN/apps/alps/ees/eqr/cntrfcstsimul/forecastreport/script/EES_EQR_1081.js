...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    /**
    * @extends 
    * @class EES_EQR_1081 : EES_EQR_1081 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
    */
    function EES_EQR_1081() {
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
                ...
                var sXml = sheetObj.GetSearchXml("EES_EQR_1081GS.do",FormQueryString(formObj));
    		...
    		case IBSEARCH02:      //공통조회
    			...
    			var sXml = sheetObj.GetSearchXml("EES_EQR_1081GS.do" , FormQueryString(form));
