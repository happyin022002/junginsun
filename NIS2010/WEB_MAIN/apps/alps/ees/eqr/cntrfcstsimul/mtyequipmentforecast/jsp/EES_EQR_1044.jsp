...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrfcstsimul.mtyequipmentforecast.event.EesEqr1044Event"%>
...
<input type="hidden" name="curr_flag"  value="<%=event.getMtyBalanceRepoListVO().getCurrFlag() %>">
<!-- OUTER - POPUP (S)tart -->
...
<tr><td valign="top">
		...
		<table class="search" id="mainTable">
       		...
       		<table class="search" border="0" style="width:979;"> 
       			<tr class="h23">
       				<td colspan="4" align="center">Wk<%= week.substring(4) %> disc vol. (<%=event.getMtyBalanceRepoListVO().getWkStDt() %>~<%=event.getMtyBalanceRepoListVO().getWkEndDt() %>)</td>
				<tr class="h23">
