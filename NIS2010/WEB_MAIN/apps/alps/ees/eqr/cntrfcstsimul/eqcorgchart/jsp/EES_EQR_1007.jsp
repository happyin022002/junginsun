...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrfcstsimul.eqcorgchart.event.EesEqr1007Event"%>
<%
...
<html>
<head>
<title>EQR Organization Chart</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;EQR Organization Chart</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
