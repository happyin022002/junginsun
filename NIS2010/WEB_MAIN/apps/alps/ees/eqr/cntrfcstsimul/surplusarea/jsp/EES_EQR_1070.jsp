...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrfcstsimul.surplusarea.event.EesEqr1070Event"%>
...
<html>
<head>
<title>History Report - Surplus Area</title>
    ...
    <!--Button (S) -->
        ...
        <table class="search"> 
           <tr><td class="bg">
                ...
                <tr class="h23">
                    <td width="110">Period (YYYYWW)</td>
                    <td width="140">
                       <input name="fm_yrwk" value="" type="text" class="input1" style="width:60;ime-mode:disabled;" maxlength="6" onkeyup="onlyNumberInput(event);moveTabNormal(this,to_yrwk);">&nbsp;~
                       <input name="to_yrwk" value="" type="text" class="input1" style="width:60;ime-mode:disabled;" maxlength="6" onkeyup="onlyNumberInput(event);"> 
                    </td>
                    <td width="30"></td>
