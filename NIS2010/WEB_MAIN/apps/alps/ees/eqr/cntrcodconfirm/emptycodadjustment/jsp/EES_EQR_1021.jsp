       	...
       	<tr><td class="bg">
				...
				<tr class="h23" >
					...
					<td width="160" class="sm">
						<input type="text" style="width:55;" class="input1" value="" name="week"  required style="ime-mode:disabled"  dataformat="yw" maxlength="6"> (YYYY-WW)
					<td width="38">Trade </td>
					<td width="90"><select style="width:60;" class="input" name="trade">
					...
					<td width="160" style="padding-bottom:3"><!--  Button_Sub (S) -->
						<table width="120" class="button"> 
		       			<tr><td class="btn2_bg">
							<table border="0" cellpadding="0" cellspacing="0"><tr>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td>
							<td class="btn2" name="btn_remark">Remark by VVD</td>
				...
				<td width="30">VVD</td>
				<td width="82"><input type="text" style="width:80;" value=""  name="searchvvd"  style="ime-mode:disabled"   maxLength ="9" dataformat="engup" ></td>
				<td width="" style="padding-bottom:3"><!--  Button_Sub (S) -->
					<table width="80" class="button"> 
		       			<tr><td class="btn2_bg">
						<table border="0" cellpadding="0" cellspacing="0"><tr>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td>
							<td class="btn2" name="btn_mainretrieve" >Search</td>
							<td class="btn2_right"></td>
							</tr>
							</table></td>
						</tr></table>
