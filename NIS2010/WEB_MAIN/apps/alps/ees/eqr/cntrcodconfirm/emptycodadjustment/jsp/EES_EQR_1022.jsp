...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1022Event"%>
...
<%
    ...
    String strUsr_id        = "";
    String strUsr_nm        = "";
//    Logger log = Logger.getLogger("com.hanjin.apps.eqtransportplannperform.emptycodadjustment");
...
<html>
<head>
<title>MTY Repo Inquiry by VVD</title>
    ...
    <!--biz page (S)-->
        ...
        <tr><td style="padding:5px; background-color:#F3F2F8; border:1px solid #A3A4C7;">
                ...
                <tr class="h23">
                    ...
                    -->
                    <td width="260">&nbsp;</td>
                    <td width="74">Created by</td>
                    <td width="">
                        <input type="text" name="user" style="width:55;" class="input2" value="<%= strUsr_id %>" readonly>
                    </td>
                    </tr> 
        ...
        <tr><td class="bg">
            ...
            <tr class="tr2_head">
                ...
                <td width=""><textarea  name="remark" style="width:100%;height:50;">
</textarea></td></tr>
                </table> 
            <!--  Button_Sub (S) -->
