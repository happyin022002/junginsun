...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1055Event"%>
...
<html>
<head>
<title>MTY Discharge Plan by VVD</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; MTY Discharge Plan by VVD </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
