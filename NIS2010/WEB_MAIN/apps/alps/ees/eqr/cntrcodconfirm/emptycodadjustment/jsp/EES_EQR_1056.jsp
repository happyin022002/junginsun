...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1056Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesEqr1056Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
...
//    Logger log = Logger.getLogger("com.hanjin.apps.cntrcodconfirm.emptycodadjustment");
    ...
    try {
        ...
        event = (EesEqr1056Event)request.getAttribute("Event");
...
<tr><td valign="top">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Revenue MTY CNTR List</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
