...
<%
	...
	try { 
		...
		dest1			= JSPUtil.getParameter(request, "dest1");
		dest2			= JSPUtil.getParameter(request, "dest2");
		tpsz			= JSPUtil.getParameter(request, "tpsz");
		eta_dt			= JSPUtil.getParameter(request, "eta_dt");
		
		gubun			= request.getParameter("gubun");
		opn_scr			= request.getParameter("opn_scr");
...
<% if("A".equals(gubun)){ %>
								...
								<td width="100"><input name="dest1" type="text" class="input2" style="width:85;ime-mode:disabled;" value="<%= dest1 %>" readOnly></td>
								<td width="95">Dest.Yard</td>
								<td width="100"><input name="dest2" type="text" class="input2" style="width:85;ime-mode:disabled;" value="<%= dest2 %>" readOnly></td>
<% }else{ %>
								<td width="95">Dest. Yard</td> 
								<td width="100"><input name="dest1" type="text" class="input2" style="width:85;ime-mode:disabled;" value="<%= dest1 %>" readOnly></td>
