...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntrusarail.cntrforecastprecisionmanage.event.EesEqr1059Event"%>
						...
						<table class="search_in" border="0">
							<tr class="h23">
								...
								<td width="195"><input name="fm_dt" type="text" class="input1" style="width:72;" maxlength="10" dataformat="ymdhm">&nbsp;~&nbsp;
												<input name="to_dt" type="text" class="input1" style="width:72;" maxlength="10" dataformat="ymdhm"><img name="btns_calendar" class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" ></td>
								<td width="10"></td>
