...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntraccuracy.cntraccuracytrend.event.EesEqr1025Event"%>
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntraccuracy.cntraccuracytrend.vo.EesEqr1025ConditionVO"%>
		                ...
		                <td class="bg">
		                    <table class="search" border="0" style="width:1000;" >
								<tr class="h23" width="100%" >
									<td width="80"><input type="radio" name="dt_tp_cd" class="trans" value="W" OnClick="chg_dt_tp();" checked>Week</td>
									<td width="210">
										<input type="text" name="fm_wk" class="input" style="width:80" dataformat="yw" maxlength="6" onFocus="form_focus();"  onBlur="form_blur();" onKeyPress= "form_keypress();"> 
										~ 
										<input type="text" name="to_wk" class="input" style="width:80" dataformat="yw" maxlength="6" onFocus="form_focus();"  onBlur="form_blur();" onKeyPress= "form_keypress();">
									</td>
								...
								<tr class="h23">
									<td><input type="radio" name="dt_tp_cd" class="trans" value="D"  OnClick="chg_dt_tp();">ETA Date</td>
									<td>
										<input type="text" name="eta_fm_dt" class="input" style="width:80" dataformat="ymd" maxlength="8" onFocus="form_focus();"  onBlur="form_blur();" onKeyPress= "form_keypress();"> 
										~ 
										<input type="text" name="eta_to_dt" class="input" style="width:80" dataformat="ymd" maxlength="8" onFocus="form_focus();"  onBlur="form_blur();" onKeyPress= "form_keypress();">
									...
									<td>VVD</td>
									<td>
										<input type="text" name="vvd_cd" class="input" style="width:95"  maxlength="9" onFocus="form_focus();"  onChange="form_blur();" onKeyPress= "form_keypress();">
									</td>
									<td>TP/SZ</td>
									<td><%= tyszSelectBox %>&nbsp;
		                ...
		                <td class="bg">
		                    <table class="search_in" border="0">
								<tr>
									...
									<td> 
										<input type="checkbox" name="wgt" class="trans" onClick="form_data_selection();" checked>Weight&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="pln" class="trans" onClick="form_data_selection();" checked>MT Plan(A)&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="dif" class="trans" onClick="form_data_selection();" checked>Diff(A-B)&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="bkg" class="trans" onClick="form_data_selection();" checked>Full Booking&nbsp;&nbsp;&nbsp;
										<input type="checkbox" name="avg" class="trans" onClick="form_data_selection();" checked>Average Performance&nbsp;&nbsp;&nbsp;
									</td>
								</tr>
		                    </table>
		                </td>
