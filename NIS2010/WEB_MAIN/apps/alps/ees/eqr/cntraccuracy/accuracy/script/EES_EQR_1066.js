...
/**
 * @extends
 * @class EES_EQR_1066 : EES_EQR_1066 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function EES_EQR_1066() {
...
//				style.height = 450;
				...
				InitDataProperty(0, cnt++, dtData, 			43, daCenterTop ,	true,  "lcc_cd", 			false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			43, daCenterTop ,	true,  "ecc_cd", 			false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			55, daCenterTop, 	true,  "pol_yd_cd", 		false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData,			57, daCenterTop, 	true,  "wk",				false, 		"", 		dfNone,     	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			43, daCenterTop , 	true,  "vsl_lane_cd",		false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData,			70, daCenter, 		true,  "vvd_cd",			false,		"", 		dfNone,     	0,		false, 	false,	0	,0	,false);
				...
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false, "mty_pln_teu",  		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false, "mty_pln_box",  		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
			...
			for (var i = 0; i < consTpszArr.length; i++) { // MT PLAN
				...
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "mty_bkg_teu", 		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "mty_bkg_box", 		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
			...
			for (var i = 0; i < consTpszArr.length; i++) {//MT Booking
				...
				InitDataProperty(0, cnt++, dtData, 			30, daRight, 		false,  "diff_teu", 		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			30, daRight, 		false,  "diff_box", 		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
			...
			for (var i = 0; i < consTpszArr.length; i++) {//Diff(A-B)
				...
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "bkg_lodg_teu", 	false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "bkg_lodg_box", 	false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
			...
			for (var i = 0; i < consTpszArr.length; i++) {// Full BKG Lodg
				...
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "bkg_disch_teu", 	false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "bkg_disch_box", 	false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
			...
			for (var i = 0; i < consTpszArr.length; i++) {// Full BKG Disch
				...
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		true,   "void_teu", 		false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);

				InitDataProperty(0, cnt++, dtData, 			40, daRight, 		false,  "bsa_teu", 			false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			50, daRight, 		false,  "bsa_ton", 			false, 		"", 		dfNullInteger, 	0,		false, 	false,	0	,0	,false);
				
				InitDataProperty(0, cnt++, dtData, 			35, daRight, 		true,   "lf_fd", 			false, 		"", 		dfNone, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "lf_full_teu", 		false, 		"", 		dfNone, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			45, daRight, 		false,  "lf_full_ton", 		false, 		"", 		dfNone, 	0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtData, 			38, daRight, 		false,  "lf_ttl_teu", 		false, 		"", 		dfNone, 	0,		false, 	false,	0	,0	,false);
				...
				InitDataProperty(0, cnt++, dtHidden, 		40, daLeft ,		true,  "ibflag", 		false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtHidden, 		50, daLeft, 		true,   "", 			false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
				InitDataProperty(0, cnt++, dtHidden, 		50, daLeft, 		true,   "", 			false, 		"", 		dfNone, 		0,		false, 	false,	0	,0	,false);
