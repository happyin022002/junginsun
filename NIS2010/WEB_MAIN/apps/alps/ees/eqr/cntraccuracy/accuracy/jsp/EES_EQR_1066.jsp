...
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntraccuracy.cntraccuracytrend.event.EesEqr1066Event"%>
<%@ page import="com.hanjin.apps.alps.ees.eqr.cntraccuracy.cntraccuracytrend.vo.EesEqr1066ConditionVO"%>
		                ...
		                <td class="bg">
		                    <table class="search" border="0" style="width:1000;" >
								<tr class="h23" width="100%" >
									<td width="85"><input type="radio" name="dt_tp_cd" class="trans" value="W" OnClick="chg_dt_tp();" checked>Week</td>
									<td width="210">
		                    ...
		                    <table class="search_in" border="0">
								<tr>
									...
									<td> 
										...
										<input type="checkbox" name="avg" class="trans" onClick="form_data_selection();" checked>Average Performace&nbsp;&nbsp;&nbsp;
									</td>
								</tr>
		                    </table>
		                </td>
