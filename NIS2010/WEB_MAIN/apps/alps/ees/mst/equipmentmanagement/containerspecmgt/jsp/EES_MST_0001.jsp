...
<%@ page import="com.hanjin.apps.alps.ees.mst.equipmentmanagement.containerspecmgt.event.EesMst0001Event"%>
...
<%
	...
	try {
		...
		// save 버튼은 strOfc_cd 값이 SELCON 이어야 한다. 2009.05.06. 김석준
		...
		<!-- Grid BG Box  (S) -->
			...
			<td  valign="top">			
				...
				<tr class="h23">
					...
					<td align="right" width="85"><input type="text" name="cntr_sts_cd" style="width:78;" class="input" readonly style="text-align:center"></td>
					</tr>
