...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.generalarinvoicemasterdatamgt.event.FnsInv0117Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%
	FnsInv0117Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0117Event) request.getAttribute("Event");
...
<html>
<head>
<title>(Vietnam)Charge names in Vietnamese</title>
...
<input type="hidden" name="intg_cd_id" value = "CD00003">
