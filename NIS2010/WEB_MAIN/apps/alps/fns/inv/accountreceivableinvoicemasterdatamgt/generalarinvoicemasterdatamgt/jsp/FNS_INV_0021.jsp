...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.generalarinvoicemasterdatamgt.event.FnsInv0021Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0021Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0021Event)request.getAttribute("Event");
       	...
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td>
						...
						<option value="0" selected>SZPBB</option>
