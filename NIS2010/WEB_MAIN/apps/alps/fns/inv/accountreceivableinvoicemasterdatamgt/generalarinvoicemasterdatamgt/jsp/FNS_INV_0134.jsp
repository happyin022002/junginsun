...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.generalarinvoicemasterdatamgt.event.FnsInv0134Event"%>
<%@ page import="org.apache.log4j.Logger"%>
<%
	FnsInv0134Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0134Event) request.getAttribute("Event");
...
<html>
<head>
<title>Surcharge Description on Invoice</title>
...
<input type="hidden" name="ofc_cd" value="<%=loginOfcCd%>">
<input type="hidden" name="rhq" value="">
<input type="hidden" name="code"> 
<input type="hidden" name="gubun" value="MDMCHARGE">  
			...
			<tr>
				<td class="bg">
					...
					<tr class="h23">
						...
						<td width="200">
							<script language="javascript">ComComboObject('ar_ofc_cd', 1, 100, 1);</script>
						</td>
