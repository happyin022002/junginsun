...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.generalarinvoicemasterdatamgt.event.FnsInv0020Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0020Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0020Event)request.getAttribute("Event");
...
<html>
<head>
<title>(Spain)Local Charge Creation</title>
...
<input type="hidden" name="loc_cd2">
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td>
						<script language="javascript">ComComboObject('loc_cd', 1, 100, 0, 1, 0, true);</script>
						&nbsp;<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btns_port">
					</td>
				</table>				
				<!--  biz_1   (E) -->
