...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.arinvoiceexratemgt.event.FnsInv0089Event"%>
...
<table width="500" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="580" border="0">
			<tr>
				<td height="79" class="title"><img src="img/icon_title_dot.gif"	align="absmiddle"> Ex Rate Entry by Customer - Multi Cust</td>
			</tr>
		</table>
			...
			<tr>
				...
				<table class="search" border="0" style="width: 484;">
					<tr class="h23">
						...
						<td width=""><input type="text" style="width: 30" value="<%=cust_cnt_cd%>" class="input2" name="v_cust_cnt_cd" readonly>
						<input type="text" style="width: 55" value="<%=cust_seq%>" class="input2" name="v_cust_seq" readonly></td>
					</tr>
				</table>
