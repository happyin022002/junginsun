...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.arinvoicecustomermgt.event.FnsInv0142Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0142Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0142Event)request.getAttribute("Event");
...
<html>
<head>
<title>Actual Payer Inquiry</title>
		...
		<table class="search" id="mainTable">
			<tr>
				...
				<tr class="h23">
					...
					<td width="130" align="">Actual payer Code&nbsp;</td>
