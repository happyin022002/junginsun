...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemasterdatamgt.arinvoicecustomermgt.event.FnsInv0081Event"%>
...
<html>
<head>
<title>(N.China)I/B Agent Creation</title>
...
<input type="hidden" name="opt_type" value="V">
	...
	<tr><td valign="top">
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<table class="search_sm2" border="0" style="width:300;"> 
						<tr class="h23">
							...
							<td class="stm"><input type="radio" value="V" name="btn_opt" checked class="trans" caption="option">&nbsp;By Vessel&nbsp;&nbsp;&nbsp;<input type="radio" value="L" name="btn_opt" class="trans" caption="option">&nbsp;By POD/Lane</td></tr>
					</table>
					</td>
				...
				<div id="divPod" style="display:none">
				<table width="100%" class="search"  id="mainTable"> 
					<tr>
						<td width="100%">
