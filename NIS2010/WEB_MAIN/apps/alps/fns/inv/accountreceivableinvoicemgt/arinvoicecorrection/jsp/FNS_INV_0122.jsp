...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.arinvoicecorrection.event.FnsInv0122Event"%>
...
<html>
<head>
<title>Marking "Reverse Charge" by I/F No </title>
	...
	<td valign="top">
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
					<td width="110">B/L No.</td>
					<td width="100">
						<input name="bl_src_no" type="text" dataformat="engup" style="width:120" class="input1" value="" maxlength="12">&nbsp;</td>
