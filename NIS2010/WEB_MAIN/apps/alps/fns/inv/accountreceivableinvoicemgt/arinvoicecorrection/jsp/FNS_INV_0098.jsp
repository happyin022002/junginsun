...
<%
	...
	try {
		...
		arIfNo = request.getParameter("arIfNo") != null ? request
				.getParameter("arIfNo") : "";
...
<form name="form"><input type="hidden" name="f_cmd"> <input
	...
	type="hidden" name="cntr_no"> <input type="hidden"
	name="cntr_tpsz_cd"> <input type="hidden" name="ar_if_no"
	value="<%=arIfNo%>"> <!-- OUTER - POPUP (S)tart -->
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif"
					align="absmiddle">&nbsp;Container Info.</td>
			</tr>
		</table>
