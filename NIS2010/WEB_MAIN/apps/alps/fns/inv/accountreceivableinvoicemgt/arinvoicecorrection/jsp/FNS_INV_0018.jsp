...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.arinvoicecorrection.event.FnsInv0018Event"%>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td width="120"><input type="text" style="width: 100;"
							class="input1" name="if_no" dataformat="uppernum" maxlength="11"></td>
						<td width="55">B/L No.</td>
						<td width="120"><input type="text" style="width: 100;"
							class="input2" name="frm_bl_src_no" readOnly></td>
						<td width="60">BKG No.</td>
						<td width="140"><input type="text" style="width: 100;"
							class="input2" name="frm_bkg_no" readOnly></td>
						<td width="70">No. of Split</td>
						<td width="40"><input type="text" style="width: 25;"
				...
				<table class="search" border="0" style="width: 100%;">
					<tr class="h23">
						...
						<td width=""><input type="text" class="input2"
							style="width: 100;" name="frm_io_bnd_cd" readOnly></td>
					</tr>
				</table>
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td><input type="text" style="width: 43;" class="input2"
							name="frm_bkg_teu_qty" readonly>&nbsp;<input type="text"
							style="width: 50;" class="input2" name="frm_bkg_feu_qty" value=""
			...
			<tr>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<table class="search" border="0" style="width: 480;">
							<tr class="h23">
								<td width="80">TEU/FEU</td>
								<td width=""><input type="text" style="width: 48;"
									class="input2" name="bkg_teu_qty" readOnly>&nbsp;<input
									type="text" style="width: 47;" class="input2"
						...
						<table class="search" border="0" style="width: 480;">
							<tr class="h23">
								...
								<td width="200"><input type="text" style="width: 123;"
									class="input" name="inv_ref_no"></td>
								<td width="60">SML Ref.</td>
								<td width=""><input type="text" style="width: 130;"
						...
						<table class="search" border="0" style="width: 480;">
							<tr class="h23">
								...
								<td width=""><input type="text" style="width: 390;"
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td width="710"><input type="text" style="width: 30;"
							class="input2" name="frm_shpr_cust_cnt_cd" readOnly>&nbsp;<input
							type="text" style="width: 65;" class="input2"
							name="frm_shpr_cust_seq" readOnly>&nbsp;<input
							type="text" style="width: 400;" class="input2"
							name="frm_shpr_cust_nm" readOnly>&nbsp;<img
							src="img/btns_search.gif" width="19" height="20" alt=""
							border="0" align="absmiddle" class="cursor" name="btn_shprcust"></td>
