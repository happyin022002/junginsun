...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
	...
	/**
	 * @extends 
	 * @class FNS_INV_0018 : FNS_INV_0018 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function FNS_INV_0018() {
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		if(validateForm(sheetObj,formObj,sAction)){
			...
			var sXml = sheetObj.GetSearchXml("FNS_INV_0018GS.do" , FormQueryString(formObj));					
		...
		if(validateForm(sheetObj,formObj,sAction)){					
			...
			sheetObj.DoSave("FNS_INV_0018GS.do", FormQueryString(formObj)+ "&" + ComSetPrifix(sheetObjects[9].GetSaveString(true),"s0sheet1_")+ "&" + ComSetPrifix(sheetObjects[10].GetSaveString(true),"s0sheet2_")+ "&" + ComSetPrifix(sheetObjects[11].GetSaveString(true),"s0sheet3_")+ "&" + ComSetPrifix(sheetObjects[12].GetSaveString(true),"s0sheet4_") ,"");
