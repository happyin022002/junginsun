...
<%
	FnsInv0084Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0084Event) request.getAttribute("Event");
...
<html>
<head>
<title>(Thailand) Freight and Charge List</title>
		...
		<table class="search">
			<tr>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						<td width="30">VVD</td>
						<td><input type="text" style="width: 80;" class="input1"
							value="" dataformat="engup" name="vvd" maxlength="9"
							onfocusout="javascript:getVslNm();"> <input type="text"
							style="width: 240" value="" class="input2" name="vsl_eng_nm"
							readOnly></td>
					</tr>
				</table>
