...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.arinvoiceinquiry.event.FnsInv0069Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0069Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0069Event)request.getAttribute("Event");
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
					...
					<td width="300"><input type="text" name="from_date" required dataformat="ymd" maxlength="8" style="width:85" class="input1" cofield="to_date" caption="start date">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar1">&nbsp;&nbsp;~&nbsp;&nbsp;<input type="text" name="to_date" required dataformat="ymd" maxlength="8" style="width:85" class="input1" cofield="from_date" caption="end date">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar2"><input type="text" name="date_blank" maxlength="8" style="width:0" class="input" readOnly value="blank"></td>
					<!-- <td width="450">
						<table class="search_sm" border="0" style="width:400;"> 
						<tr class="h23">
							<td width="100"><input type="radio" name="date_option" value="I" class="trans" checked>IF Date</td>
							<td width="" rowspan="2"><input type="text" name="from_date" required dataformat="ymd" maxlength="8" style="width:85" class="input1" cofield="to_date" caption="start date">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar1">&nbsp;&nbsp;~&nbsp;&nbsp;<input type="text" name="to_date" required dataformat="ymd" maxlength="8" style="width:85" class="input1" cofield="from_date" caption="end date">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar2"></td>
						</tr>
						<tr class="h23">
							<td width="100"><input type="radio" name="date_option" value="S" class="trans" >S/A Date</td>
						</tr>
						</table>
					</td> -->  
					<td width="30" >RHQ</td>
				...
				<tr class="h23">
					...
					<td width="150" class="stm">USD&nbsp;<input name="usd_total" type="text" style="width:100;text-align:right" value="" class="input2" readOnly></td>
