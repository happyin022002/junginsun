...
*@FileName : FNS_INV_0141.js
*@FileTitle : (NYCNA)Invoice Inquiry by Issue Date/E-mail sent result
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class FNS_INV_0141 : FNS_INV_0141 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function FNS_INV_0141() {
		...
		switch(sheetNo) {
			case 1:      //t1sheet1 init
				with (sheetObj) {
					...
					var HeadTitle1 = "|Sent Result|Sent By|Issue Date|Office|Bound|Type|B/L No.|Send Seq.|Cust. Code|VVD|S/A Date|POL|POD|TTL USD|Receiver No.|User ID|Time Requested|Time Sent";
					...
					InitDataProperty(0, cnt++ , dtData,    		75,		daCenter, 	false,		"sent_result",		false,      "",      dfNone);
					InitDataProperty(0, cnt++ , dtData,    		55,		daCenter, 	false,		"sent_by",		false,      "",      dfNone);
					InitDataProperty(0, cnt++ , dtData,    		75,		daCenter, 	false,		"inv_snd_dt",		false,      "",      dfDateYmd);
					...
					InitDataProperty(0, cnt++ , dtData,    		60,		daCenter, 	false,		"snd_seq",    false,      "",      dfNone);
					InitDataProperty(0, cnt++ , dtData,    		75,		daCenter, 	false,    	"cust_code",     	false,      "",      dfNone);
                    ...
                    InitDataProperty(0, cnt++ , dtData,    	80,   	daRight,  	false,    	"ttl_amt", 		false,      "",      dfNullFloat, 	2);
                    InitDataProperty(0, cnt++ , dtData,    		160,     daCenter,  	false,    	"received_no",  		false,      "",      dfNone);
                    InitDataProperty(0, cnt++ , dtData,    		65,		daCenter, 	false,     	"cre_usr_id",	false,      "",      dfNone);
                    InitDataProperty(0, cnt++ , dtData,    		120,     daCenter,  	false,    	"time_requested",  		false,      "",      dfUserFormat2);
                    InitDataProperty(0, cnt++ , dtData,    		120,     daCenter,  	false,    	"time_sent",  		false,      "",      dfUserFormat2);
			...
			case IBSEARCH:      //조회
				if(validateForm(sheetObj,formObj,sAction)) {
					...
					var arrStr2 = formObj.ar_ofc_cd.Code.split("^");
	     			...
	     			var sXml = sheetObj.GetSearchXml("FNS_INV_0141GS.do", FormQueryString(formObj));		 			
