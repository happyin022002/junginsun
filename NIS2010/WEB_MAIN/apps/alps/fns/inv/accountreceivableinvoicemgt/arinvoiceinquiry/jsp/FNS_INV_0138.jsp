...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.arinvoiceinquiry.event.FnsInv0138Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0138Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0138Event)request.getAttribute("Event");
...
<html>
<head>
<title>Invoice Detail Inquiry for AKLBA</title>
			...
			<tr>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td><input name="ar_ofc_cd" type="text" style="width:60; text-align:center;" class="input1" value="AKLBA" readonly></td>
						<!--<td width="" style="padding-left: 2" readonly><script language="javascript">ComComboObject('ar_ofc_cd', 1, 96, 1, 1 );</script></td> -->
					</tr>
					<!-- 
					<tr class="h23">
						<td width="">ACT Cust</td>
						<td width=""><input type="text" style="width: 30;"	name="act_cust_cnt_cd" id="act_cust_cnt_cd"	onblur="fn_act_cust_chg();" style="ime-mode:disabled" onKeyPress="ComKeyOnlyAlphabet('upper')" maxlength="2" class="input" onKeyUp="javascript:checkCustLeng(this.value)">&nbsp;<input type="text" style="width: 60;" name="act_cust_seq" id="act_cust_seq" onblur="fn_act_cust_chg();" value="" maxlength="6" dataformat="num" class="input">&nbsp;<img class="cursor" src="img/btns_search.gif" name="btn_actcust" width="19" height="20" border="0" align="absmiddle">&nbsp;<input type="text" style="width: 300;" name="cust_lgl_eng_nm" value="" class="input2">&nbsp;<img class="cursor"	src="img/btns_search.gif" name="btn_custNm" width="19" height="20" border="0" align="absmiddle"></td>
					</tr>
					 -->
				</table>
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						<td width="82">I/F Date</td>
						<!-- 
						<td width="203"><select style="width: 96;" class="input" name="dt_type" onChange="javascript:chgDtType(this.value);">
						...
						-->
						<td width="" colspan="3" class="stm"><input type="text"	style="width: 82;" class="input1" name="fm_dt" class="input1" onBlur="fn_ComGetMaskedValue('fm_dt');" onKeyUp="javascript:checkFmDtLeng(this.value)" cofield="to_dt">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20"	border="0" align="absmiddle" name="btns_calendar1">&nbsp;&nbsp;~&nbsp;&nbsp;<input type="text" style="width: 82;" class="input1" name="to_dt" class="input1" onBlur="fn_ComGetMaskedValue('to_dt');" cofield="fm_dt">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20"	border="0" align="absmiddle" name="btns_calendar2"></td>
					</tr>
				</table>
				<!-- 
				<table class="search" border="0" style="width: 979;">
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						...
						<td width="" style="padding-left: 2"><select style="width: 100;" class="input" name="iss_opt" >
