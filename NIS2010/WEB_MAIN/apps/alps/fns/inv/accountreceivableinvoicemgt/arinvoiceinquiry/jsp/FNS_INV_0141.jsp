...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.arinvoiceinquiry.event.FnsInv0141Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0141Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0141Event)request.getAttribute("Event");
