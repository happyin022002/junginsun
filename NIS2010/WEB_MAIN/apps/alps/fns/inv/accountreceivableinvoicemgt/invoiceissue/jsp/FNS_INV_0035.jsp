...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.invoiceissue.event.FnsInv0035Event"%>
		...
		<table class="search" id="mainTable">
			<tr>
				...
				<table class="search" border="0" style="width: 979;">
					<tr class="h23">
						<td width="400">
						<table class="search_sm2" border="0" style="width: 375;">
							<tr class="h23">
								<td width="120">Select Option</td>
								<td width="305" rowspan="2">
								<table border="0" style="width: 230;" class="search">
									<tr class="h23">
										<%
										if(loginOfcCd.equals("BOMSC")||loginOfcCd.equals("DELSO")||loginOfcCd.equals("MAASO")||loginOfcCd.equals("CCUSO")||loginOfcCd.equals("TUTBS")||loginOfcCd.equals("AEVSO")||loginOfcCd.equals("LDHSO")){ 
										%>
										...
										<input type="radio" class="trans" value="M" name="sel_option"
											onclick="javascript:clickOption();">&nbsp;Multi&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio"
											class="trans" value="I" name="sel_option" 
											onclick="javascript:clickOption();">&nbsp;I/F No&nbsp;
 										<%
 										 } else {
										%>
										<td class="stm">&nbsp;&nbsp;&nbsp; <input type="radio"
										...
										<input type="hidden" 
											class="trans" value="I" name="sel_option"  
											onclick="javascript:clickOption();">									
										<%
 										 } 
										%>									
									  </td>
					...
					<td width="430" id="ind_opt" style="display:none">
						<table class="search_sm2" border="0" style="width:220;">
							<tr class="h23">
								<td width="90" align="">&nbsp;&nbsp;Invoice Type</td>
								<td width="50" class="stm"> <input type="radio" value="N" class="trans" checked name="ind_type" >New</td>
								<td width="50" class="stm"> <input type="radio" value="O" class="trans" name="ind_type" >Old</td>
							</tr>
						</table>
				...
				<table class="search" border="0" style="width: 120;" align="left">
					<tr class="h23" >
						<td id="sel_option_all"  width="120" >&nbsp;Single Invoice No.</td>
						<td id="sel_if_no"  width="120" >&nbsp;AR Interface No.</td>
					</tr>
				</table>
