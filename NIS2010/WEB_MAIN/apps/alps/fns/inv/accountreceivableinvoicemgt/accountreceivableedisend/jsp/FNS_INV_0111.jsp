...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.event.FnsInv0111Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsInv0111Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsInv0111Event)request.getAttribute("Event");
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
					...
					<td width="85" align=""  id="chg_type1">Change Type&nbsp;</td>
					<td width="" style="padding-left:2"  id="chg_type2"><script language="javascript">ComComboObject('change_type', 1, 150, 1, 1);</script></td>					
				</tr>
				<tr class="h23">
					<td width="110">Customer</td>
					<td width="" colspan = "6"><input type="text" style="ime-mode: disabled; width: 30" value="" class="input1" dataformat="engup" name="cust_cnt_cd" maxlength="2" onKeyUp="if(ComChkLen(this, 2)==2){ComSetNextFocus();}">
...
<tr>
	<td class="btn1_bg">
		...
		<tr>
			...
			<td id="partial_bl"><table width="115" border="0" cellpadding="0" cellspacing="0" class="button">
				<tr><td class="btn1_left"></td>
					<td class="btn1" id="btn_PartialBL" name="btn_PartialBL">Partial Billing</td>
					<td class="btn1_right"></td>
				</tr>
			</table></td>
