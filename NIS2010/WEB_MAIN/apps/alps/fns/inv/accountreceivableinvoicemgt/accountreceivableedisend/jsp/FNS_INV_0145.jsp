<%--
 ...
 - @LastModifier : 백승일
 - @LastVersion : 1.0
 - 1.0 Creation 2016.01.15 백승일
--%>
<%@ page contentType="text/html; charset=UTF-8" %>
<%@ page import="com.hanjin.apps.alps.vop.pso.portsomasterdatamgt.porttariffmgt.vo.AccountAndCostVO" %>
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.event.FnsInv0145Event" %>
...
<%
    Logger logger = Logger.getLogger("apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.FNS_INV_0145");
    FnsInv0145Event event = null;
    ...
    try {
        ...
        event = (FnsInv0145Event)request.getAttribute("Event");
