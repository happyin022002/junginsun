...
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.event.FnsInv0125Event" %>
...
<%
    Logger logger = Logger.getLogger("apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.FNS_INV_0125");
    ...
    try {
        ...
        event = (FnsInv0125Event)request.getAttribute("Event");
                        ...
                        <td class="bg">
                            ...
                            <table class="search" border="0" style="width:100%;">
                                ...
                                <tr class="h23">
                                    ...
                                    <!--  <td colspan = "6"> -->
                                    <td colspan = "6" style="padding: 2"><script language="javascript">ComComboObject('cust_cd', 1, 150, 1,1);</script>
                                        <!-- <input type="text" style="ime-mode: disabled; width: 30" class="input1" dataformat="engup" name="cust_cnt_cd" maxlength="2" onKeyUp="if(ComChkLen(this, 2)==2){ComSetNextFocus();}" onChange="fn_cust_nm();" value="US">
                                        <input type="text" style="width: 49" name="cust_seq" dataformat="num" class="input1" onChange="fn_cust_nm();" maxlength="6" value="029316"> 
