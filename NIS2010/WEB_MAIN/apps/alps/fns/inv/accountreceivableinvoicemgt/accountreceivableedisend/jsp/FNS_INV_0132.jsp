<%--
 ...
 - @LastModifier : 
 - @LastVersion : 1.0
 - 1.0 Creation 2012.11.27
--%>
<%@ page contentType="text/html; charset=UTF-8" %>
<%@ page import="com.hanjin.apps.alps.vop.pso.portsomasterdatamgt.porttariffmgt.vo.AccountAndCostVO" %>
<%@ page import="com.hanjin.apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.event.FnsInv0132Event" %>
...
<%
    Logger logger = Logger.getLogger("apps.alps.fns.inv.accountreceivableinvoicemgt.accountreceivableedisend.FNS_INV_0132");
    FnsInv0132Event event = null;
    ...
    try {
        ...
        event = (FnsInv0132Event)request.getAttribute("Event");
...
<head>
    <title>EDI Submission (Philips)</title>
                    ...
                    <tr>
                        <td class="bg">
                            ...
                            <table class="search" border="0" style="width:100%;">
                                <tr class="h23">
                                    <td width="120">Retrieve Option&nbsp;</td>
                                    <td width="128"><script language="javascript">ComComboObject('retr_opt', 1, 124, 1, 1);</script></td>
                                    <td width="170"><input name="retr_input" type="text" dataformat="engup" style="width:145" class="input1" value="" maxlength="13">&nbsp;</td>
                                    <td width="85">Sent Status&nbsp;</td>
                                    <td width="170" style="padding-left:2"><script language="javascript">ComComboObject('sent_stat', 1, 150, 1, 1);</script></td>
                                    <td width="45">Office</td>
                                    <td style="padding: 2"><script language="javascript">ComComboObject('ar_ofc_cd', 1, 80, 1,1);</script></td>
                                </tr>
                                <tr class="h23">
                                    <td width="110"></td>
                                ...
                                <tr class="h23">
                                    ...
                                    <td colspan = "6">
                                        <input type="text" style="ime-mode: disabled; width: 30" class="input1" dataformat="engup" name="cust_cnt_cd" maxlength="2" onKeyUp="if(ComChkLen(this, 2)==2){ComSetNextFocus();}" onChange="fn_cust_nm();" value="US" readonly>
                                        <input type="text" style="width: 49" name="cust_seq" dataformat="num" class="input1" onChange="fn_cust_nm();" maxlength="6"  value="062290" readonly>
