...
<%@ page import="com.hanjin.apps.alps.fns.tot.tonnagetaxoutput.tonnagetaxstandardprofitconclusion.event.FnsTot0022Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsTot0022Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsTot0022Event)request.getAttribute("Event");
