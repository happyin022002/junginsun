...
function processButtonClick() {
	...
	try {
		...
		case "btn1_New":
			...
			formObject.tong_flet_tp_cd.value = "A";
			break;
...
function openPopup() {
	...
	var trd_cd = sheetObjects[0].CellValue(sheetObjects[0].SelectRow,
			"sheet1_trd_cd");
	...
	ComOpenPopup('/hanjin/FNS_TOT_0031.do' + param, 1200, 450,
...
function setCfmCheck() {
	...
	var sXml = sheetObjects[1].GetSearchXml("FNS_TOT_0030GS.do",
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: // t1sheet1 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtHidden, 60, daCenter, true, prefix + "trd_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, prefix + "slan_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 60, daCenter, true, prefix + "stl_yrmon", false, "", dfDateYm, 0, false, false);
			...
			InitDataProperty(0, cnt++, dtData, 30, daCenter, true, prefix + "tong_flet_tp_cd", false, "", dfNone, 0, false, false);
			...
			InitDataProperty(0, cnt++, dtHidden, 70, daCenter, true, prefix + "ctrt_st_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtHidden, 70, daCenter, true, prefix + "ctrt_end_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtHidden, 50, daRight, true, prefix + "ctrt_year", false, "", dfFloat, 2, false, false);
			InitDataProperty(0, cnt++, dtData, 60, daRight, true, prefix + "ldb_capa_qty", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 60, daRight, true, prefix + "bsa_capa", false, "", dfInteger, 0, false, false);
	...
	case 2: // t1sheet2 init
		with (sheetObj) {
			...
			InitDataProperty(0, cnt++, dtData, 110, daLeft, true, prefix + "vsl_eng_nm", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 50, daCenter, true, prefix + "vsl_rgst_cnt_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 120, daCenter, true, prefix+ "tong_flet_tp_cd", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 70, daRight, true, prefix+ "grs_rgst_tong_wgt", false, "", dfInteger, 0, false,false);
			InitDataProperty(0, cnt++, dtData, 70, daRight, true, prefix+ "nrt_wgt", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daRight, true, prefix+ "per_ton_rev", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daCenter, true, prefix+ "vsl_de_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daCenter, true, prefix+ "ctrt_st_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daCenter, true, prefix+ "ctrt_end_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 80, daRight, true, prefix+ "ctrt_year", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "ldb_capa_qty", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "bsa_capa", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "act_bsa_capa", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "capa_diff", false, "", dfInteger, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "usg_rt", false, "", dfFloat, 2, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daCenter, true, prefix+ "fm_vvd_stl_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daCenter, true, prefix+ "to_vvd_stl_dt", false, "", dfDateYmd, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "voy_dys", false, "", dfNone, 0, false, false);
			InitDataProperty(0, cnt++, dtData, 90, daRight, true, prefix+ "tong_tax_amt", false, "", dfInteger, 0, false, false);
		}
		break;
	...
	case IBSEARCH: //조회
		if (validateForm(sheetObj, formObj, sAction)) {
			...
			if (sheetObj.id == "sheet1") {
				...
				var sXml = sheetObj.GetSearchXml("FNS_TOT_0030GS.do",
						FormQueryString(formObj) + "&"+ ComGetPrefixParam(prefix));

				sheetObjects[0].LoadSearchXml(sXml);
				formObj.total_txt_amt.value = ComRound(ComGetEtcData(sXml,"total_txAmt"), 0);
				ComChkObjValid(formObj.total_txt_amt);
				for ( var i = 2; i < sheetObjects[0].RowCount + 2; i++) {
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "voy_dys")) > 31) {
						sheetObjects[0].CellFontColor(i, prefix + "voy_dys") = sheetObjects[0].RgbColor(255, 0, 0);
					}
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "ldb_capa_qty")) <= 0) {
						sheetObjects[0].CellFontColor(i, prefix+ "ldb_capa_qty") = sheetObjects[0].RgbColor(255, 0, 0);
					}

					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "grs_rgst_tong_wgt")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix+ "grs_rgst_tong_wgt") = sheetObjects[0].RgbColor(255, 0, 0);
					}

					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "nrt_wgt")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix + "nrt_wgt") = sheetObjects[0].RgbColor(255, 0, 0);
					}
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "per_ton_rev")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix + "per_ton_rev") = sheetObjects[0].RgbColor(255, 0, 0);
					}
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "bsa_capa")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix + "bsa_capa") = sheetObjects[0].RgbColor(255, 0, 0);
					}
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "act_bsa_capa")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix+ "act_bsa_capa") = sheetObjects[0].RgbColor(255, 0, 0);
					}
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "usg_rt")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix + "usg_rt") = sheetObjects[0].RgbColor(255, 0, 0);
					}
					if (ComParseInt(sheetObjects[0].CellValue(i, prefix+ "tong_tax_amt")) < 0) {
						sheetObjects[0].CellFontColor(i, prefix+ "tong_tax_amt") = sheetObjects[0].RgbColor(255, 0, 0);
					}
				}
			}
		}
	...
	case IBSAVE: //저장
		if (closing_yn == "N") {
			if (validateForm(sheetObj, formObj, sAction)) {
				...
				sXml = sheetObj.GetSaveXml("FNS_TOT_0030GS.do", SaveStr + "&"
