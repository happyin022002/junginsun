...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
    ...
    /**
     * @extends 
     * @class fns_tot_023 : fns_tot_023 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function fns_tot_0023() {
            ...
            case 1:      // t1sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    var HeadTitle1 = "Seq.|LANE|TRADE|VVD|PORT|Turn|Act|Days||||";
		            ...
		            InitDataProperty(0, cnt++, dtData,	120,	daCenter,	true,		prefix+"slan_cd",	false,		"",       dfNone);
		            InitDataProperty(0, cnt++, dtData,	120,	daCenter,	false,	prefix+"trd_cd",	false,		"",       dfNone);
					InitDataProperty(0, cnt++, dtData,	150,	daCenter,	false,	prefix+"vvd",	false,		"",       dfNone,		2);
					InitDataProperty(0, cnt++, dtData,	130,	daCenter,	false,	prefix+"port_cd",	false,		"",       dfNone);
					InitDataProperty(0, cnt++, dtData,	100,	daCenter,	false,	prefix+"turn_port_ind_cd",	false,		"",       dfNone);
					InitDataProperty(0, cnt++, dtData,	150,	daCenter,	true,	prefix+"act_bsa_capa",	false,		"",       dfNone);
					InitDataProperty(0, cnt++, dtData,	150,	daCenter,	true,	prefix+"voy_dys",	false,		"",       dfNone,		1);
					...
					InitDataProperty(0, cnt++, dtHidden,	0,	daCenter,	false,	prefix+"skd_voy_no",	false,		"",       dfNone);
					InitDataProperty(0, cnt++, dtHidden,	0,	daCenter,	false,	prefix+"skd_dir_cd",	false,		"",       dfNone);
             ...
             case IBSEARCH:      //조회
	             if (validateForm(sheetObj, formObj, sAction)){
	                 ...
	                 if ( sheetObj.id == "sheet1"){
	     				 ...
	     				 if(formObj.exp_port[0].checked == true){
	     					formObj.s_exp_port.value = "A"; 
	     				 }else if(formObj.exp_port[1].checked == true){
	     					formObj.s_exp_port.value = "E"; 
	     				 }else if(formObj.exp_port[2].checked == true){
	     					formObj.s_exp_port.value = "P"; 
	     				 }

	     				 if(formObj.exp_turn[0].checked == true){
	     					formObj.s_exp_turn.value = "A"; 
	     				 }else if(formObj.exp_turn[1].checked == true){
	     					formObj.s_exp_turn.value = "D"; 
	     				 }else if(formObj.exp_turn[2].checked == true){
	     					formObj.s_exp_turn.value = "V"; 
	     				 }else if(formObj.exp_turn[2].checked == true){
	     					formObj.s_exp_turn.value = "F"; 
	     				 }
	     				 
	     				//alert("exp_port :: "+formObj.s_exp_port.value);
	     				//alert("exp_turn :: "+formObj.s_exp_turn.value); 
		    			
	     				var sXml = sheetObj.GetSearchXml("FNS_TOT_0023GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
