...
<%@ page import="com.hanjin.apps.alps.fns.tot.tonnagetaxoutput.tonnagetaxstandardprofitconclusion.event.FnsTot0011Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsTot0011Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsTot0011Event)request.getAttribute("Event");
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="200">
					<table border="0" style="width:280;" class="search_sm"> 
					<tr class="h23">
					<td width="" class="">
						<input type="checkbox" name = "c_nrt_yn" value="" class="trans" >&nbsp;&nbsp;NRT&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="checkbox" name = "c_use_yn" value="" class="trans">&nbsp;&nbsp;USE(%)&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="checkbox" name = "c_day_yn" value="" class="trans">&nbsp;&nbsp;DAYS&nbsp;&nbsp;&nbsp;&nbsp;
						</td></tr>
					</table>
					</td>
