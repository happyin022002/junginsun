...
<%@ page import="com.hanjin.framework.component.util.DateTime" %>
<%@ page import="com.hanjin.apps.alps.fns.tot.tonnagetaxoutput.tonnagetaxstandardprofitconclusion.event.FnsTot0012Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsTot0012Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	if(request.getParameter("modify_yn")!=null) {
		modify_yn 	= JSPUtil.replaceForHTML(request.getParameter("modify_yn"));
	}	
	...
	try {
		...
		event = (FnsTot0012Event)request.getAttribute("Event");
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Taxable Amount Confirmation (Monthly) by Detail </td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<table width="100%" class="button"> 
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0"><tr>
						...
						<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr><td class="btn2_left"></td>
						<td class="btn2" name="btn_Modify">Modify</td>
						<td class="btn2_right"></td>
						</tr>
						</table></td>
