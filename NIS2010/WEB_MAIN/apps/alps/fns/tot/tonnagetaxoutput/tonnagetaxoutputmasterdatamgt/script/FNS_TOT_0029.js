...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
	...
	/**
	 * @extends
	 * @class FNS_TOT_0029 : FNS_TOT_0029 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function FNS_TOT_0029() {
    ...
    function initSheet(sheetObj, sheetNo) {
        ...
        switch (sheetNo) {
            ...
            with (sheetObj) {
                ...
                var HeadTitle  = "|SEQ|Lane|Vessel|Name|Trade";
                ...
                InitDataProperty(0, cnt++, dtData,       135,      daLeft,      true,    "vsl_eng_nm",    false,    "",    dfNone,    0,    false,    false);
		...
		switch (sAction) {
			...
			case IBSEARCH:
                ...
                ComOpenWait(true);
		   		...
		   		var sXml = sheetObj.GetSearchXml("FNS_TOT_0029GS.do", FormQueryString(formObj));
			...
			case IBSAVE:        //저장
		    	...
		    	var sXml = sheetObj.GetSaveXml("FNS_TOT_0029GS.do", SaveStr + "&" + FormQueryString(formObj));
