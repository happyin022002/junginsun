...
<%@ page import="com.hanjin.apps.alps.fns.tot.tonnagetaxoutput.tonnagetaxfiling.event.FnsTot0025Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsTot0025Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsTot0025Event)request.getAttribute("Event");
