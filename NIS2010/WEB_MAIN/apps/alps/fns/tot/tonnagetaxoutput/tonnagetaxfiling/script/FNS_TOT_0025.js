...
*@FileName : FNS_TOT_0025.js
*@FileTitle : Actual BSA Summary
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class FNS_TOT_0025 : FNS_TOT_0025 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function FNS_TOT_0025() {
        ...
        switch(sheetNo) {
            case 1:      //t1sheet1 init
              with (sheetObj) {
                ...
                InitDataProperty(0, cnt++ , dtData,   60,  daCenter,  false,   "act_bsa_capa",   false,       "",       dfInteger,    0,     false,       false);
                InitDataProperty(0, cnt++ , dtData,   60,  daCenter,  false,   "usg_rt",   false,       "",       dfNone,    0,     false,       false);
                InitDataProperty(0, cnt++ , dtData,   60,  daCenter,  false,   "fm_port_cd",   false,       "",       dfNone,    0,     false,       false);
                InitDataProperty(0, cnt++ , dtData,   60,  daCenter,  false,   "to_port_cd",   false,       "",       dfNone,    0,     false,       false);
                ...
                InitDataProperty(0, cnt++ , dtData,   30,  daCenter,  false,   "voy_dys",   false,       "",       dfNone,    0,     false,       false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            ...
            case IBSEARCH:      //조회
            	...
            	sheetObj.DoSearch("FNS_TOT_0025GS.do", FormQueryString(formObj));
