...
<%@ page import="com.hanjin.apps.alps.fns.tot.tonnagetaxoutput.tonnagetaxfiling.event.FnsTot0024Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsTot0024Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsTot0024Event)request.getAttribute("Event");
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="300">
						<input type="text" style="width:40;" class="input1" name="year" value="<%=year%>" maxlength="4" onkeyup="onlyYearInput(event);" dataformat="yyyy" caption="Period">
