...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationsettlement.settlementprocess.event.FnsJoo0105Event"%>
...
<input type="hidden" name="rdr_flg" value="R">
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;">
                <tr class="h23">
					...
					<td><input type="checkbox" value="N" name="rmk_flg" id="rmk_flg" class="trans"></td>					                                        
					<td align="right" width="100">Search Option&nbsp;</td>
					<td><script language="javascript">ComComboObject('srch_opt', 1, 100, 0,0 );</script></td>										
					<td></td>					                                        
					<td align="right"></td>					                    
                    <td width="100"></td>                    
                </tr>
...
<!-- 				
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_rdr_save">RDR Save</td>
					<td class="btn1_right"></td>
				</tr></table></td>				
 -->				
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
