    ...
    function processButtonClick(){
        ...
        try {
            ...
            switch(srcName) {
        		...
        		case "btn_delete":
        			JooRowHideDelete(sheetObjects[0], prefix+"delt_flg");
        			break;		        			
        			
                case "btn_multi":
//  				    ComOpenPopup("/hanjin/FNS_JOO_0114.do", 600, 180,"getFNS_JOO_0114", "1,0,1,1,1,1,1,1");
				    ComOpenPopup("/hanjin/FNS_JOO_0114.do", 600, 500,"getFNS_JOO_0114", "1,0,1,1,1,1,1,1");                	
                    break;        			
     ...
     */
     function initCombo(comboObj, comboNo ) {
		...
		case "pic":
			...
			var comboItems = ("ALL,ALL|"+gPicCd).split("|");
			UF_addComboItem(comboObj, comboItems);
			comboObj.Text2 = "ALL";
			break;		
         }
...
//-----------------------
			...
			var HeadTitle1 = "STS|SEL|Seq.|Trade|Lane|Carrier|Rev/Exp|Settlement Item|Office|PIC";			
			...
			InitDataProperty(0, cnt++, dtCheckBox ,50, daCenter,   true, prefix+"delt_flg");			
			InitDataProperty(0, cnt++, dtHidden        , 60,   daCenter, true, prefix + "seq" 	    		, false, "", dfNone, 0, false, true);			
			InitDataProperty(0, cnt++, dtData        , 100, daCenter, true, prefix + "trd_cd" 			, true, "", dfNone, 0, false, true,3);
			InitDataProperty(0, cnt++, dtData        , 100, daCenter, true, prefix + "rlane_cd"     	, true, "", dfNone, 0, false, true,5);
			InitDataProperty(0, cnt++, dtData        , 100, daCenter, true, prefix + "crr_cd"    		, true, "", dfNone, 0, false, true,3);
			InitDataProperty(0, cnt++, dtCombo        , 100, daCenter, true, prefix + "re_divr_cd"  	, true, "", dfNone, 0, false, true);			
			...
			InitDataProperty(0, cnt++, dtData        , 200, daCenter, true, prefix + "pic" 				, false, "", dfNone, 0, true, true,20);			        		
//----------------------
			InitDataValid(0, "trd_cd", vtEngUpOnly); 
			InitDataValid(0, "rlane_cd", vtEngUpOther, "1234567890"); 
			InitDataValid(0, "crr_cd", vtEngUpOnly); 			
			InitDataCombo(0,  "re_divr_cd", "Rev|Exp", "R|E");			
...
*/										
            ...
            case    IBSAVE:        //저장
                ...
                try{                        	
                    var sXml =   sheetObj.GetSaveXml("FNS_JOO_0113GS.do", ComGetSaveString(sheetObj) + "&" + FormQueryString(formObj));
    ...
    /**
     * Multi Creation & Change 닫힌 후 실행
     */
	 function getFNS_JOO_0114() {
	 }    	
/* 개발자 작업  끝 */
