...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationmasterdatamgt.jointoperationmasterdatamgt.event.FnsJoo0079Event"%>
...
<html>
<head>
<title>Authority Office Creation</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
    ...
    <!--biz page (S)-->
        ...
        <table class="search" border="0" style="width:979;"> 
                ...
                <td width="100"><script language="javascript">ComComboObject('jo_crr_cd', 1, 60, 0, 0, 0 );</script></td>
                ...
                <td width="110">Authority Office</td>
                <td width="120"><script language="javascript">ComComboObject('auth_ofc_cd',1, 80,0,0);</script></td>
                <td width="">   
                <table class="search_sm2" border="0" style="width:100%;"> 
                    <tr class="h23">    
                    <td width="90">Delete Mark</td>
                    <td class="stm"><input type="radio" class="trans" name='delt_flg'  value='A' checked>&nbsp;All
