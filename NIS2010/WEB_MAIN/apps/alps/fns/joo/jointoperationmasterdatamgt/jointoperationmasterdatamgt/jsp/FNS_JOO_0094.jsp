 ...
 *@FileName : fns_joo_0094.jsp
 *@FileTitle : Add Copy POP UP화면
 *Open Issues :
 *Change history :
...
<%
	...
	String codeList = "";
	String pageRows = "100";
	String joBsaRefNo = StringUtil.xssFilter(request.getParameter("joBsaRefNo"));
	...
	String strUsr_nm = "";
	Logger log = Logger
			.getLogger("com.hanjin.apps.JointOperationMasterDataMgt.JointOperationMasterDataMgt");
	String crrCdList = "";
	String trdCdList = "";
	String ofcCdList = "";
	String joSrcList = "";
...
<form name="form">
<input type="hidden" name="f_cmd"> <input type="hidden" name="pagerows"> <input type="hidden" name="jo_bsa_ref_no" value="<%=joBsaRefNo%>"> 
<!-- 개발자 작업	-->
<table width="100%" class="popup" cellpadding="10" border="0">
	<tr>
		...
		<table width="100%" border="0">
			<tr>
				<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; BSA Information Entry Row Copy</td>
			</tr>
		</table>
			...
			<tr>
				<td class="bg">
					<table class="Grid" border="0"
						style="width: 100%; padding-top: 0px; padding-bottom: 0px; border-bottom: 0px;">
						<tr class="tr_head">
							<td width="40" style="padding-top: 0px; padding-bottom: 0px; border-bottom: 0px;">
								<input type="checkbox" name="all_div" class="trans" value="Y">&nbsp;All
							</td>
						</tr>
					</table>
					<!-- Grid  (S) -->
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top: 5; , padding-bottom: 10;">
			<tr>
				<td class="bg">Copy Row
					<input type="input" maxlength='3' value="1" dataformat="engup" name="copy_row_cnt" style="width: 50; text-align: center;">
				</td>
				<td class="btn1_bg">
