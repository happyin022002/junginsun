...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.jointoperationletter.event.FnsJoo0061Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0061Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0061Event)request.getAttribute("Event");
...
<html>
<head>
<title>Invoice Letter Information Text Creation</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td colspan="3"><textarea style="width:820;ime-mode:disabled" rows="2" name="ofc_addr" readonly class='textarea2' dataformat="etc"  disabled></textarea></td>
				</tr>
				<tr class="h23">
					<td width="90" valign="top">Text Detail - 1</td>
					<td width="" colspan="3"><textarea style="width:820;" name="n1st_stmt_ctnt" wrap=off style="heignt:30" dataformat="etc" style='IME-MODE: disabled'></textarea></td>
				</tr> 
				<tr class="h23">
					<td width="90" valign="top">Text Detail - 2</td>
					<td width="" colspan="3"><textarea style="width:820;" name="n2nd_stmt_ctnt" wrap=off style="heignt:30" dataformat="etc" style='IME-MODE: disabled'></textarea></td>
				</tr> 
				<tr class="h23">
					<td width="90" valign="top">Bank detail</td>
					<td width="" colspan="3"><textarea style="width:820;" name="bank_stmt_ctnt" readonly  class='textarea2' wrap=off rows="4" dataformat="etc" style='IME-MODE: disabled'></textarea></td>
				</tr> 
				<tr class="h23">
					<td width="90" valign="top">Attachment</td>
					<td width="420" valign="top"><textarea style="width:390;" name="n3rd_stmt_ctnt" wrap=off rows="8" dataformat="etc" style='IME-MODE: disabled'></textarea></td>
					<td width="90" valign="top">Signature</td>
					<td width=""><textarea style="width:310;" name="sig_stmt_ctnt" readonly  class='textarea2' rows="8" style='IME-MODE: disabled'></textarea></td>
				</tr> 
                <tr class="h23">
