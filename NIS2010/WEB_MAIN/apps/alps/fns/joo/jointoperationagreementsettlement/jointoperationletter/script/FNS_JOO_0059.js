...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class fns_joo_0059 : fns_joo_0059 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function fns_joo_0059() {
...
//    }
 ...
 function loadPage() {
  ...
  function fnEnterCheck(){
      ...
      var keyCheck = false;
      var elementName = "n1st_stmt_ctnt,n2nd_stmt_ctnt,n3rd_stmt_ctnt";
 ...
 function doActionIBSheet(sheetObj, formObj, sAction) {
    ...
    switch (sAction) {
        ...
        case IBSEARCH: // 조회
            ...
            var sXml = sheetObj.GetSearchXml("FNS_JOO_0059GS.do" , FormQueryString(form));
           ...
           // formObj.lbl_sig_stmt_ctnt   .value = sig_stmt_ctnt;
        ...
        case IBSAVE:  
            ...
            var sXml = sheetObj.GetSaveXml("FNS_JOO_0059GS.do",FormQueryString(formObj));
        ...
        case IBCLEAR:
            ...
            var sXml = sheetObjects[0].GetSearchXml("FNS_JOO_0059GS.do" , FormQueryString(form));
            var aXml = sXml.split("|$$|");
            ...
            formObj.lbl_sig_stmt_ctnt .value      = ComGetEtcData(aXml[0],"sig_stmt_ctnt");
        ...
        case IBSEARCH_ASYNC03:
            ...
            var sXml = sheetObj.GetSearchXml("FNS_JOO_0059GS.do", FormQueryString(formObj));
            ComXml2ComboItem( sXml, formObj.jo_tmplt_no, "code","code" );  
            break;
        case REMOVE:
            if(!validateForm(sheetObj,formObj,sAction))return;
 ...
 function validateForm(sheetObj, formObj, sAction) {
    ...
    switch (sAction) {
        ...
        case IBSAVE:   //저장
            ...
            if(formObj.lbl_sig_stmt_ctnt.value.length == 0){
                ComShowCodeMessage('JOO00116', 'Signature');
                formObj.lbl_sig_stmt_ctnt.focus();
                return false;
            }
            break;
 ...
 function len_chk(){
     ...
     if(formObj.n1st_stmt_ctnt.value.length > 4000){
         ...
         var n3rd_stmt_ctnt = formObj.n3rd_stmt_ctnt.value.substring(0, 4000);
         formObj.n3rd_stmt_ctnt.value = n3rd_stmt_ctnt;
         formObj.n3rd_stmt_ctnt.focus();
         return false;
     } 
