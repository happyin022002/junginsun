...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.jointoperationletter.event.FnsJoo0060Event"%>
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.jointoperationletter.vo.LetterVO"%>

<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0060Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0060Event)request.getAttribute("Event");
...
<input type="hidden"   name="jo_ltr_seq" value="<%=jo_ltr_seq %>"> <!-- key Check -->
<input type="hidden"   name="cre_usr_id" value="<%=strUsr_id %>"> 

<input type="hidden"   value="JOO" name="sub_sys_cd">

<input type="hidden"   value="FNS_JOO_0063.mrd" name="tmplmrd">                
...
<input type="hidden"   name="com_mrdSaveDialogFileName" value="McsInform">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<td width="91">&nbsp;Year/Month</td>
					<td width="138"><input type="text" style="width:60" class="input1"  dataformat='ym'  maxlength='6' value="<%=yyyyMM %>" caption='Period' required  fullfill name='acct_yrmon' >&nbsp;<img class="cursor" src="img/btns_back.gif" name='btn_acct_yrmon_back' width="19" height="20" border="0" align="absmiddle">&nbsp;<img class="cursor" src="img/btns_next.gif"  name='btn_acct_yrmon_next' width="19" height="20" border="0" align="absmiddle"></td>
					<td width="40">Carrier </td>
					<td width="127">&nbsp;<script language="javascript">ComComboObject('jo_crr_cd', 1, 60, 0, 1, 0 );</script>&nbsp;</td>
					<td width="40">Trade</td>
					<td width="110"><script language="javascript">ComComboObject('trd_cd'  ,1,60,0, 1);</script></td>
					<td width="35">Lane</td>
					<td width="100"><script language="javascript">ComComboObject('rlane_cd',1, 80,1, 1);</script></td>
					<td width="40">Office</td>
					<td width=""><input type="text" style="width:80;"   class="input2"  readonly  class="input" name='ofc_cd' value="<%=strOfc_cd %>"  /></td>
					</tr> 
				</table>			
<!--   1 Search E-->				
...
<!--   2 Search E-->						
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width=""><textarea style="width:979; height:50;"  wrap=off rows=3 name='n1st_stmt_ctnt'></textarea></td>
				</tr> 
			</table>
			...
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width=""><textarea style="width:979; height:40;"  rows=3 class="input2" readonly name='n2nd_stmt_ctnt'></textarea></td>
				</tr> 
			</table>
			<table class="height_8"><tr><td></td></tr></table>
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					<td width="400"><textarea style="width:400; height:90;"   rows=6 wrap=off name='n3rd_stmt_ctnt'></textarea></td>
					<td width="175"></td>
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="72" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Save"  id="btn_Save" auth='W'>Save</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_Attach"  id="btn_Attach" auth='W'>Attach</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td id='td_btn_File_View' style='display:none'  ><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_File_View" id="btn_File_View" auth='W'>FileView</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="72" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name=btn_Send id="btn_Send" auth='W'>Send</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td class="btn1_line"></td>
