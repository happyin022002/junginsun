...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.jointoperationconsultation.event.FnsJoo0027Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0027Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0027Event)request.getAttribute("Event");
...
<html>
<head>
<title>AP Data ERP Interface Inquiry</title>
       		...
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<table class="search_sm2" border="0" style="width:410;">
							<tr class="h23">
								<td width="">&nbsp;<input type="radio" value="0" class="trans" name="dt_flg" checked>&nbsp;&nbsp;Iss.DT&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="1" class="trans" name="dt_flg">&nbsp;&nbsp;Eff.DT&nbsp;&nbsp;&nbsp;<input type="text" style="width:80" value="<%=yyyyMMdd%>" dataformat="ymd" class="input1" name="iss_dt_fr">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar1">&nbsp;~&nbsp;<input type="text" style="width:80" value="<%=yyyyMMdd%>" class="input1" dataformat="ymd"  name="iss_dt_to">&nbsp;<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btn_calendar2"></td>
							</tr>
							</table></td>
