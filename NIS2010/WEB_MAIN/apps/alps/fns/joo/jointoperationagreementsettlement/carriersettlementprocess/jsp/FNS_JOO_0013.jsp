...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0013Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0013Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0013Event)request.getAttribute("Event");
...
<html>
<head>
<title>War Risk Surcharge Settlement</title>
...
<input type="hidden" name="jo_stl_itm_cd" value="W/R">
<input type="hidden" name="jo_mnu_nm" value="W/R">
<!-- 개발자 작업	-->
<html>
<body  onLoad="setupPage();"> 
<form name="form">
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="40">Lane</td>
					<td width=""><script language="javascript">ComComboObject('rlane_cd',3,80,0,1);</script></td></tr>
