...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0010Event"%>
...
<html>
<head>
<title>Over Used Slot Hire for TDR</title>
...
<input type="hidden" name="jo_mnu_nm" value="TDR">
<!-- 개발자 작업	-->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="90"><script language="javascript">ComComboObject('trd_cd',1,55,0,1);</script></td>
					<td width="35">Lane</td>
					<td width=""><script language="javascript">ComComboObject('rlane_cd',4,80,0,1);</script></td>
				</tr>
