...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0014Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0014Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0014Event)request.getAttribute("Event");
...
<html>
<head>
<title>Port Skip Settlement</title>
...
<input type="hidden" name="jo_stl_itm_cd" value="P/B">
<input type="hidden" name="jo_mnu_nm" value="P/B">
<!-- 개발자 작업	-->
