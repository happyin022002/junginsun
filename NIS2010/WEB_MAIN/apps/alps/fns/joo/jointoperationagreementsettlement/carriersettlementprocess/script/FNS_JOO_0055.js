...
/**
 * @extends 
 * @class fns_joo_0055 : fns_joo_0055 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function fns_joo_0055() {
...
// 버튼 네임으로 구분하여 프로세스를 분기처리하는 이벤트핸들러 */
     ...
     */
     ...
     function setSlanCdYn(){
    	 ...
    	 var sXml = sheetObjects[0].GetSearchXml("FNS_JOO_0055GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
            ...
            case 1:      // sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					var HeadTitle1 = "|Lane|V.V.D|V.V.D|V.V.D|Seq.|Port|ETD|Change Status|Update DT|Region|Upload\nStatus";
					...
					InitDataProperty(0, cnt++ , dtData,					65,		daCenter,		true,		prefix+"slan_cd",				false,		"",						dfNone,			0,			false,		false);
					InitDataProperty(0, cnt++ , dtData,					65,		daCenter,		true,		prefix+"vsl_cd",				false,		"",						dfNone,			0,			false,		false);
					InitDataProperty(0, cnt++ , dtData,					55,		daCenter,		true,		prefix+"voy_no",				false,		"",						dfNone,			0,			false,		false);
					InitDataProperty(0, cnt++ , dtData,					30,		daCenter,		true,		prefix+"dir_cd",				false,		"",						dfNone,			0,			false,		false);
					
					InitDataProperty(0, cnt++ , dtData,					50,		daCenter,		true,		prefix+"clpt_seq",				false,		"",						dfNone,			0,			false,		false);
					InitDataProperty(0, cnt++ , dtData,					80,		daCenter,		true,		prefix+"port_cd",				false,		"",						dfNone,			0,			false,		false);
					InitDataProperty(0, cnt++ , dtData,					160,	daCenter,		true,		prefix+"vps_etd_dt",		false,		"",						dfUserFormat2,			0,			false,		false);
					...
					InitDataProperty(0, cnt++ , dtData,				    60,	daCenter,		true,		prefix+"region",			false,		"",						dfNone,			0,			false,		false);
			...
			case IBSEARCH:      //조회
	             if (validateForm(sheetObj, formObj, sAction)){
	                 ...
	                 if ( sheetObj.id == "sheet1"){
		    			...
		    			var sXml = sheetObj.GetSearchXml("FNS_JOO_0055GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(prefix));
