...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0054Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    FnsJoo0054Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0054Event)request.getAttribute("Event");
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="35">Lane</td>
					<td width=""><input type="text" class="input1" name="slan_cd" style="width:60;" style="ime-mode:disabled" dataformat="uppernum" maxlength="3" >&nbsp;<img class="cursor" src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" name="btn1_pop_lane" ></td>
					</tr> 
				</table>
