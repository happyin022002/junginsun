...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0011Event"%>
...
<html>
<head>
<title>Reefer Surcharge Creation</title>
...
<input type="hidden" name="jo_stl_itm_cd" value="R/F">
<input type="hidden" name="jo_mnu_nm" value="R/F">
<input type="hidden" name="locl_curr_cd">
<input type="hidden" name="uc_bss_port_etd_dt">
<!-- 개발자 작업	-->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="65"><script language="javascript">ComComboObject('trd_cd',1,55,0,1);</script></td>
					<td width="35">Lane</td>
					<td width="90"><script language="javascript">ComComboObject('rlane_cd',5,80,0,1);</script></td>
					<td width="">
					 	<table border="0" style="width:100%;" class="search_sm">
					 	<tr  class="h23">
						 <td width="" class="noinput" style="font-size:12;"><input type="radio" name="rf_scg_stl_tp_cd" value="R" class="trans"> RDR <input type="radio" name="rf_scg_stl_tp_cd" value="T" class="trans"> TDR 
						 </td>
						 </tr>
						 </table>
					</td>
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-top:5;,padding-bottom:10;"> 
       	<tr><td class="btn1_bg">
		    ...
		    <tr>
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_delete_all" id="btn_delete_all" auth="C">Delete</td>
					<td class="btn1_right"></td>
					</tr>
				</table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
