...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0050Event"%>
...
<html>
<head>
<title>Target Voyage vs Unsettled Status</title>
	...
	<!--biz page (S)-->
		<table class="search"> 
       	<tr><td class="bg">
				...
				<td width="100"><script language="javascript">ComComboObject('trd_cd',1,80,0,0);</script></td>
				<td width="50">Lane</td>
				...
				<td width=""><input type="text" style="width:60" class="input1"  dataformat='ym'  maxlength='6' value="<%=yyyyMM %>" caption='Period From Month'   fullfill name='acct_yrmon_fr'  cofield="acct_yrmon_to">&nbsp;<img class="cursor" src="img/btns_back.gif" name='btn_acct_yrmon_fr_back' width="19" height="20" border="0" align="absmiddle">&nbsp;<img class="cursor" src="img/btns_next.gif"  name='btn_acct_yrmon_fr_next' width="19" height="20" border="0" align="absmiddle">&nbsp;~&nbsp;<input type="text" style="width:60" class="input1"     fullfill maxlength='6'  caption='Period To Month'  value="<%=yyyyMM %>" dataformat='ym' name='acct_yrmon_to'  cofield="acct_yrmon_fr">&nbsp;<img class="cursor" src="img/btns_back.gif"  name='btn_acct_yrmon_to_back'  width="19" height="20" border="0" align="absmiddle">&nbsp;<img class="cursor" src="img/btns_next.gif"  name='btn_acct_yrmon_to_next' width="19" height="20" border="0" align="absmiddle"></td>
				</tr> 
				<tr class="h23">
				<td width="50">Item</td>
				<td width="100"><script language="javascript">ComComboObject('jo_stl_itm_cd', 1, 80, 1, 0,0 );</script></td>
				<td width="50">Office</td>
				<td width="100"><script language="javascript">ComComboObject('ofc_cd', 1, 80, 1, 0,0 );</script></td>
				<td width="50">Diff.</td>
				<td width="100"><input type="checkbox" name="diff_only_yn" id="diff_only_yn" value="Y" class="trans" checked></td>
				<td width="50">Remark</td>
				<td width=""><input type="checkbox" name="rmk_yn" id="rmk_yn" value="N" class="trans" unchecked></td>
				</tr> 
				</table>
				<!--  biz_1   (E) -->
				</td>
