...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.event.FnsJoo0103Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
  FnsJoo0103Event  event = null;       //PDTO(Data Transfer Object including Parameters)
  ...
  try {
    ...
    event = (FnsJoo0103Event)request.getAttribute("Event");
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;">
                <tr class="h23">
                    ...
                    <td>&nbsp;&nbsp;</td>                    
					<td><input type="checkbox" value="R" name="rdr_flg" id="rdr_flg" class="trans"></td>                    
					<td align="right">RDR Port Only&nbsp;</td>
					<td><input type="checkbox" value="N" name="etd_flg" id="etd_flg" class="trans"></td>					                                        
					<td align="right">ETD Schedule&nbsp;</td>
					<td><input type="checkbox" value="N" name="alloc_flg" id="alloc_flg" class="trans"></td>					                                        
	       	...
	       	<tr><td class="btn2_bg">
				<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td class="btn2" id="btn_show" name="btn_show">Show</td>
							<td class="btn2_right"></td>
							<td class="btn2_left"></td>
							<td class="btn2" id="btn_hide" name="btn_hide">Hide</td>
							<td class="btn2_right"></td>
						</tr>
						</table></td>
				</table>
...
<!-- 				
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_retrieve2">Retrieve3</td>
					<td class="btn1_right"></td>
				</tr></table></td>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td>
					<td class="btn1" name="btn_retrieve4">Retrieve4</td>
					<td class="btn1_right"></td>
				</tr></table></td>
 -->				
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
