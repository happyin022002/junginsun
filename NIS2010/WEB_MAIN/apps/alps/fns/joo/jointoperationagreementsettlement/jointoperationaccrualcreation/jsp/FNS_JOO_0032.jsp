...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.jointoperationaccrualcreation.event.FnsJoo0032Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	FnsJoo0032Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0032Event)request.getAttribute("Event");
