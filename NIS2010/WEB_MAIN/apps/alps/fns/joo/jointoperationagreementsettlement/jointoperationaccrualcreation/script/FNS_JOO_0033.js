...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class fns_joo_0033 : fns_joo_0033 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function fns_joo_0033() {
             ...
             case 1:      //t1sheet1 init
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
                     ...
                     InitDataProperty(0, cnt++ , dtData,    100,    daCenter,    true,    prefix+"item",         false,          "",      dfNone ,    0,     false,          false, false     );
                     InitDataProperty(0, cnt++ , dtData,    100,    daCenter,    true,    prefix+"estm_vvd_tp_cd",     false,    "",      dfNone ,    0,     false,          false, false     );
                     InitDataProperty(0, cnt++ , dtAutoSum,    150,    daRight,  true,    prefix+"estm_vvd_tp_cd_cnt", false,    "",      dfInteger ,    0,  false,          false, false     );
                     InitDataProperty(0, cnt++ , dtAutoSum,    220,    daRight,  true,    prefix+"estm_amt",     false,          "",      dfFloat,   2 ,     false,          false, false     );

                     InitDataProperty(0, cnt++ , dtAutoSum,    220,    daRight,  true,    prefix+"act_amt",      false,          "",      dfFloat,   2  ,    false,          false, false     );
                     InitDataProperty(0, cnt++ , dtAutoSum,    220,    daRight,  true,    prefix+"accl_amt",     false,          "",      dfFloat,   2  ,    false,          false, false     );
    ...
    function doActionIBSheet(sheetObj, formObj, sAction) {
    	...
    	case IBSEARCH: //조회
    		if (validateForm(sheetObj, formObj, sAction)){
    			...
    			var sXml = sheetObj.GetSearchXml("FNS_JOO_0033GS.do", FormQueryString(formObj) + "&" + ComGetPrefixParam(aryPrefix));
