...
<%@ page import="com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.jointoperationaccrualcreation.event.FnsJoo0088Event"%>
<%@ page import="org.apache.log4j.Logger" %>
 
<%
	FnsJoo0088Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (FnsJoo0088Event)request.getAttribute("Event");
...
<html>
<head>
<title>Estimate Performance Change Status I</title>
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="120"><input type="text" style="width:60" class="input1" dataformat='ym' maxlength="6" name='rev_yrmon' value="<%=exeYrmon.substring(0,4)+"-"+exeYrmon.substring(4)%>">&nbsp;<img class="cursor" src="img/btns_back.gif" width="19" height="20" border="0" align="absmiddle" name="btn_estm_to_back">&nbsp;<img class="cursor" src="img/btns_next.gif" width="19" height="20" border="0" align="absmiddle" name="btn_estm_to_next"></td>
					<td width="20">&nbsp;</td>
					...
					<tr class="h23">
						...
						<td width="320">
								<table class="search_sm2" border="0" style="width:320;">
									<tr class="h23">
										<td width="320">&nbsp;<input type="radio" value="0" name="estm_option" class="trans" checked>Initial Estimate&nbsp;&nbsp;<input type="radio" name="estm_option" value="1" class="trans" >Actual+Adj. Accrual Cost&nbsp;</td>
									</tr>
								</table>
						</td>
						<td width="30">
