...
<%@ page import="com.hanjin.apps.alps.esd.eas.terminalmanage.event.EsdEas0912Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdEas0912Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0912Event)request.getAttribute("Event");
		...
		//editable      = JSPUtil.getParameter(request , "editable" , "");  0912는 조회 전용
		editable      = "N";
...
<input type="hidden" name="editable"         value="N">
