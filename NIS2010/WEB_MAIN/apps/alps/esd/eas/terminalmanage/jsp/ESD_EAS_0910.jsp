...
<%@ page import="com.hanjin.apps.alps.esd.eas.terminalmanage.event.EsdEas0910Event"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>
<%
	EsdEas0910Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0910Event)request.getAttribute("Event");
	...
	strErrMsg = new ErrorHandler(serverException).loadPopupMessage();
		...
		portCd = StringUtil.xssFilter(request.getParameter("port_cd"));
       	...
       	<tr><td class="btn3_bg">
		    ...
		    <tr>
				...
				<td><table width="72" border="0" cellpadding="0" cellspacing="0" class="button">
					<tr><td class="btn1_left"></td><td class="btn1" name="btn_ok">OK&nbsp;</td>
