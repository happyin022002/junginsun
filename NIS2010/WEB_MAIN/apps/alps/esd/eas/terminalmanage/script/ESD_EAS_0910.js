...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_EAS_0910 : ESD_EAS_0910 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_EAS_0910() {
         ...
         switch(sAction) {
            ...
            case IBSEARCH:      //조회
        		...
        		if ( sheetObj.id == "sheet1"){
        			...
        			var rXml = sheetObj.GetSearchXml("ESD_EAS_0910GS.do", sParam);
            ...
            case SEARCH01:	// Country Name 조회
				...
				var sParam = FormQueryString(formObj);
				var sXml = sheetObj.GetSearchXml("ESD_EAS_0910GS.do", sParam);
				ComOpenWait(false);
				...
				if(nm!=null){
					...
					ComShowMessage(formObj.cnt_cd.value +" doesn't exist.");
