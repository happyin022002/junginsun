    	 ...
    	 try {
            ...
            switch(srcName) {
         	    ...
         	    case "btn_apply":
         	        ...
         	        if(sRow == ""){
         	            ComShowMessage("Please input the 'Office'!!");
         	        }
         	        ...
         	        window.dialogArguments.document.form.office.value = doc_rtn;
         	        //formObj.ofc_cd.value = doc_rtn;
    	            window.close();
         	        break;
    		...
    		if( e == "[object Error]") {
    			ComShowMessage(ComGetMsg('TES21506')); //ComShowMessage("지금은 사용하실 수가 없습니다");
    		} else {
    			ComShowMessage(e);
    		}
    	}
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH:	  //조회
                ...
                var searchXml = sheetObj.GetSearchXml("ESD_EAS_0911GS.do",  EasFrmQryString(formObj));
                sheetObj.RemoveAll();
