...
<%
	...
	String s_vndr_seq = "";
	String s_inv_ofc_cd = "";
	String s_lgs_cost_cd = "";
	String s_lgs_cost_subj_cd = "";
	String s_loc_cd = "";
	...
	try {
		...
		s_lgs_cost_subj_cd = StringUtil.xssFilter(request.getParameter("s_lgs_cost_cd"))== null?"":StringUtil.xssFilter(request.getParameter("s_lgs_cost_cd").substring(0, 2) );
		s_lgs_cost_cd = StringUtil.xssFilter(request.getParameter("s_lgs_cost_cd"))== null?"":StringUtil.xssFilter(request.getParameter("s_lgs_cost_cd"));
...
<html>
<head>
<title>TES Auto Audit - MR Invoice History</title>
...
<input type="hidden" name="p_lgs_cost_subj_cd"   value="<%=s_lgs_cost_subj_cd%>">
<input type="hidden" name="p_lgs_cost_cd"   value="<%=s_lgs_cost_cd%>">
<!-- OUTER - POPUP (S)tart -->
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; TES Auto Audit - MR Invoice History</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
      <!--Button_L (S) -->
        ...
        <tr>
          <td class="bg">
            <table class="search_in" border="0" style="width:100%;">
              ...
              <tr class="h23">
				<td width="34">Lane</td>
				<td colspan="2" style="padding-left: 2;"><script language="javascript">ComComboObject('s_lane_cd', 1, 53, 0)</script></td>              
				<td width="75">Vessel Class</td>
				<td width="158" style="padding-left: 2;"><script language="javascript">ComComboObject('s_cntr_vsl_clss_capa', 1, 156, 0)</script></td>
				<td width="44">Vessel</td>
				<td width="76"><script language="javascript">ComComboObject('s_vsl_cd', 1, 60, 0)</script></td>              
				<td width="70">Cost Code</td>
				<td colspan="3" style="padding-left: 2;"><script language="javascript">ComComboObject('s_lgs_cost_subj_cd', 1, 60, 0)</script> <script language="javascript">ComComboObject('s_lgs_cost_dtl_cd', 1, 100, 0)</script>
				&nbsp;&nbsp;&nbsp;&nbsp;TP/SZ&nbsp;&nbsp;<script language="javascript">ComComboObject('s_cntr_tpsz_cd', 1, 80, 0)</script>
				</td>              
              </tr>
            </table>
          </td>
