...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esd.eas.ESD_EAS_0374");
	try {
...
<html>
<head>
<title>TES Auto Audit - Off-dock CY Invocie History</title>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; TES Auto Audit - Off-dock CY Invocie History</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
      <!--Button_L (S) -->
          ...
          <td class="bg">
            <table class="search_in" border="0" style="width:100%;">
              <tr class="h23">
				...
				<td width="50">S/P No.</td>
				<td width="298" colspan="3"><input type="text" name="s_vndr_seq" dataformat="int" style="width:60" value="<%=s_vndr_seq%>" maxlength="6" onBlur='vender_change();'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" name="btn_vndr" width="19" height="20" border="0" align="absmiddle">
				<input type="text" style="width:193" name="s_vndr_seq_name" class="input2" readOnly></td>
            ...
            <table class="search_in" border="0" style="width:100%;">
              <tr class="h23">
              <tr class="h23">
				<td width="100">TM Cal. Method</td>
				<td style="width:110; padding-left: 2;"><script language="javascript">ComComboObject('s_tml_calc_ind_cd', 1, 100, 0)</script></td>
				<td width="100">TM Cal. Method</td>
				<td style="width:95; padding-left: 2;"><script language="javascript">ComComboObject('s_sto_dys_ind_cd', 1, 85, 0)</script></td>
				<td width="70">Cal. Type</td>
				<td style="width:95; padding-left: 2;"><script language="javascript">ComComboObject('s_calc_tp_cd', 1, 85, 0)</script></td>
				<td width="70">Cost Code</td>
				<td style="padding-left: 2;"><script language="javascript">ComComboObject('s_lgs_cost_subj_cd', 1, 60, 0)</script> <script language="javascript">ComComboObject('s_lgs_cost_dtl_cd', 1, 100, 1)</script></td>              
              </tr>
            </table>
          </td>
        </tr>
...
<%
for (int sheetNo = 1; sheetNo <= 3; sheetNo++) {
	if(sheetNo == 1) {
%>
