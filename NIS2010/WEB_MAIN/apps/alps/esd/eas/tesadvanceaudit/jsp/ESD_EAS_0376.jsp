...
<%
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esd.eas.ESD_EAS_0376");
	try {
...
<html>
<head>
<title>TES Auto Audit - MR Storage Invocie History</title>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; TES Auto Audit - MR Storage Invocie History</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
      <!--Button_L (S) -->
