...
<%@ page import="com.hanjin.apps.alps.esd.eas.tesadvanceaudit.event.EsdEas0373Event"%>
...
<%
	...
	EsdEas0373Event  event = null;      //PDTO(Data Transfer Object including Parameters)
    ...
    Logger log = Logger.getLogger("com.hanjin.apps.alps.esd.eas.ESD_EAS_0373");
	try {
        event = (EsdEas0373Event)request.getAttribute("Event");
		...
		//Terminal 계산 방법
		if("TP".equals(s_tml_calc_ind_cd))
			s_tml_calc_ind_nm = "Through-put";
		else if("SP".equals(s_tml_calc_ind_cd))
			s_tml_calc_ind_nm = "Seperate";
...
<html>
<head>
<title>TES Auto Audit - Off-Dock CY Audit Detail</title>
  ...
  <tr>
    <td valign="top">
      ...
      <table width="100%" border="0">
        <tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; TES Auto Audit - Off-Dock CY Audit Detail</td></tr>
      </table>
      <!-- : ( Title ) (E) -->
      <!--Button_L (S) -->
...
%>
				...
				<td width="120"><input type="text" style="width:100" value="<%=s_tml_calc_ind_nm%>" value="Through-put" class="input2" readOnly></td>
<%
	}else if(sheetNo == 2){
%>              
              	<td width="76">Cal. Method</td>
