 ...
 ***************************************************************************************/
	/**
	 * @class ESD_EAS_0380 : 예)M&R Invoice Charge 조회 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function ESD_EAS_0380() {
			...
			case "sheet1":	  //IBSheet1 init
				with (sheetObj) {
				   ...
				   //전체Edit 허용 여부 [선택, Default false]
					...
					var HeadTitle  = "|Yard|S/P No|Inv No|Issued|Cal.\nType|Cost\nCode|Type/\nSize|DG|Applied\nDate|Cal.\nVol|Rev.\nVol|Uom|Rate|Curr|Ex\nRate|Inv Amt|Remark|3rd\nParty";
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:		//조회
				...
				sheetObj.DoSearch("ESD_EAS_0380GS.do", EasFrmQryString(formObj));
				break;
		}
	}
...
//				var sXml = sheetObj.GetSearchXml("EASCommonGS.do", FormQueryString(formObj));
