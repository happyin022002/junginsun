 ...
 ***************************************************************************************/
	/**
	 * @class ESD_EAS_0376 : 예)M&R Invoice Charge 조회 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function ESD_EAS_0376() {
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:		//조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_EAS_0376GS.do", FormQueryString(formObj));
...
//  		comboObjects[1].Code = document.form.lgs_cost_dtl_cd.value ;
	...
	*/
	...
	;	
		sUrl += sParam;
		ComOpenPopup(sUrl, 1020, 700, "", "0,0", true, false, "", "", "", "Detail");
	}
