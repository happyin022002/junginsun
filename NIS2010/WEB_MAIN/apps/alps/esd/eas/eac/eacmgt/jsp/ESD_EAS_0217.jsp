...
<%@ page import="com.hanjin.apps.alps.esd.eas.eac.eacmgt.event.EsdEas0217Event"%>

<%
	EsdEas0217Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0217Event)request.getAttribute("Event");
       	...
       	<tr><td class="bg">		
			...
			<table class="search" border="0" style="width: 979;">
				<tr class="h23">
					...
					<td width="210" style="padding-left:0;">
			...
			<tr class="h23">
				...
				<td width="72"></td>
				<td width="59">Keyword</td>
				<td width="103">
					<input name="s_keyword" type="text" style="width:103; text-align:left;" class="input">
				</td>				
				<td width="26"></td>
