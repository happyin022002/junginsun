...
/**
 * @extends 
 * @class ESD_EAS_0219 : ESD_EAS_0219 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_EAS_0219() {
...
//		alert(GetSheetHeight(20));
		...
		MergeSheet = msHeaderOnly; //해더만 머지
		...
		var HeadTitle1 = "|Ranking|Service Provider|Service Provider|EAC Cases|Amount(US$)|Amount(US$)|Processing|Processing|Pending|Pending|Completed|Completed";
		var HeadTitle2 = "|Ranking|Code|Name|EAC Cases|Audit|TPB|Case|Audit(US$)|Case|Audit(US$)|Case|Audit(US$)";
		...
		InitDataProperty(0, cnt++ , dtData,         100,  	daLeft,   true,   "vndr_nm",        	    false,    "",      dfNone,          0,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         70,  	daRight,   true,   "eac_cnt",       	        false,    "",      dfNullInteger,          0,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         100,  	daRight,   true,   "eac_amt",        	false,    "",      dfNullFloat,          2,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         100,  	daRight,   true,   "tpb_amt",       	false,    "",      dfNullFloat,          2,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         65,  	daRight,   true,   "proc_cnt",         	false,    "",      dfNullInteger,          0,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         100,  	daRight,   true,   "proc_amt",            false,    "",      dfNullFloat,          2,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         65,  	daRight,   true,   "pnd_cnt",            false,    "",      dfNullInteger,          0,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         100,  	daRight,   true,   "pnd_amt",            false,    "",      dfNullFloat,          2,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         65,  	daRight,   true,   "cmpl_cnt",            false,    "",      dfNullInteger,          0,          true,        true,   0,  false, true,  "", false);
		InitDataProperty(0, cnt++ , dtData,         100,  	daRight,   true,   "cmpl_amt",            false,    "",      dfNullFloat,          2,          true,        true,   0,  false, true,  "", false);		
	}
		break;
	}
}	
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH:
		if(validateForm(sheetObj,formObj,sAction)){
			...
			sheetObj.DoSearch4Post("ESD_EAS_0219GS.do", FormQueryString(formObj));
		}
		break;
