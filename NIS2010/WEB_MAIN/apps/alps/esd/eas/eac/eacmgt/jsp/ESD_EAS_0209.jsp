...
<%@ page import="com.hanjin.apps.alps.esd.eas.eac.eacmgt.event.EsdEas0209Event"%>

<%
	EsdEas0209Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0209Event)request.getAttribute("Event");
...
<script language="javascript">
	...
	<%= JSPUtil.getIBCodeCombo("s_eac_apro_tp_cd", "", "CD03341", 0, "")%>
</script>
</head>
       	...
       	<tr><td class="bg">		
			...
			<table class="search" border="0" style="width: 979;">
				<tr class="h23">
					...
					<td width="100" style="padding-left:1;">
						<script language="javascript">ComComboObject('s_rhq_ofc_cd',1,99,1,0,0);</script>
					</td>
					
	                <td width="30"></td>
					<td width="85">Office Type</td>
					<td width="100" style="padding-left:0;">
						<script language="javascript">ComComboObject('s_ofc_tp_cd',1,99,0,0,0);</script>
					</td>
					
	                <td width="30"></td>
					<td width="120">Audit Office</td>
					<td width="100" style="padding-left:0;">
						<script language="javascript">ComComboObject('s_ofc_cd',1,99,0,0,0);</script>
					</td>
			...
			<table class="search" border="0" style="width: 979;">
				<tr class="h23">
					...
					<td width="100" style="padding-left:1;">
						<script language="javascript">ComComboObject('s_eac_tp_cd',1,99,1,0,0);</script>
					</td>
					
	                <td width="30"></td>
					<td width="85">Audit Type</td>
					<td width="100" style="padding-left:0;">
						<script language="javascript">ComComboObject('s_eac_apro_tp_cd',1,99,1,0,0);</script>
					</td>
					
	                <td width="30"></td>
					<td width="120">Calculation Value</td>
					<td width="210">
						<script language="javascript">ComComboObject('s_cal_val',1,100,1,1,0);</script>
					</td>
