...
<%@ page import="com.hanjin.apps.alps.esd.eas.eac.eacmgt.event.EsdEas0210Event"%>

<%
	EsdEas0210Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0210Event)request.getAttribute("Event");
