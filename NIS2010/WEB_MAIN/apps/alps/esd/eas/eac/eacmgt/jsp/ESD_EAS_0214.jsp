...
<%@ page import="com.hanjin.apps.alps.esd.eas.eac.eacmgt.event.EsdEas0214Event"%>

<%
	EsdEas0214Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0214Event)request.getAttribute("Event");
		...
		<tr>
			<td class="btn1_bg">
				...
				<tr>
					...
					<td id="btn_save_auth" style="display:none">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
						<tr>
							<td class="btn1_left"></td>
