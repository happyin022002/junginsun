...
<%@ page import="com.hanjin.apps.alps.esd.eas.eac.eacmgt.event.EsdEas0218Event"%>

<%
	EsdEas0218Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0218Event)request.getAttribute("Event");
       	...
       	<tr><td class="bg">		
			...
			<table class="search" border="0" style="width: 979;">
				<tr class="h23">
	                ...
	                <td width="61"></td>
					<td width="86">Audit Type</td>
					<td width="100" style="padding-left:0;">
					    <script language="javascript">ComComboObject('s_eac_apro_tp_cd',1,100,1,0,0);</script>
					</td>
