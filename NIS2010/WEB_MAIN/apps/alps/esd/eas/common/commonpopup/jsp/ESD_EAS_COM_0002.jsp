...
<%
	...
	String ctrl_ofc_cd	 = request.getParameter("ctrl_ofc_cd"   )!=null&&!request.getParameter("ctrl_ofc_cd").equals("")?request.getParameter("ctrl_ofc_cd"	):"";
...
<input type="hidden" name="param_nm" value='ctrl_ofc_cd'>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/ico_t1.gif" width="20" height="12">TRO Office Select</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
