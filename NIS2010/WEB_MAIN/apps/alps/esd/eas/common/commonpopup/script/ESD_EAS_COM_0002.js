...
*@FileName : ESD_ESD_COM_0002.js
*@FileTitle :DOC Collection Inquiry Popup 화면
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : kim yong jin
*@LastVersion : 1.0
* 2011-09-23 kim yong jin
* 1.0 최초 생성
=========================================================*/
...
/* 버튼 네임으로 구분하여 프로세스를 분기처리하는 이벤트핸들러 */
    function processButtonClick(){
    	 ...
    	 try {
            ...
            switch(srcName) {
         	    ...
         	    case "btn_apply":
         	        ...
         	        if(formObj.incl_sub.checked == true){
         	            ...
         	            doc_rtn = sheetObj1.CellValue(1,'etc');
         	        }
         	        eval( "window.dialogArguments.document.form."+formObj.param_nm.value+".value = '"+doc_rtn+"';" );
    	            window.close();
         	        break;
    		...
    		if( e == "[object Error]") {
    			ComShowMessage(ComGetMsg('EAS90022')); //ComShowMessage("지금은 사용하실 수가 없습니다");
    		} else {
    			ComShowMessage(e);
    		}
    	}
   ...
   /**
    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        switch(sheetNo) {
            case 1:      //sheet init
				...
				InitDataProperty(0, cnt++, dtHidden, 100, daLeft, true, "ofc_cd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 100, daLeft, true, "ofc_cd_name", false, "", dfNone, 0, false, false);
			}
			break;


            case 2:      //ETC Data Search시 공통으로 사용하는 sheet
                with (sheetObj) {
                    //전체 너비 설정
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
              ...
              var xml = sheetObj.GetSearchXml("ESD_EAS_COM_0002GS.do", EasFrmQryString(formObj));
