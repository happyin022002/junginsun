...
*@FileName : ESD_EAS_0363.jsp
*@FileTitle : M&R Pre-Audit Criterion By Difference W/O & INV AMT
*Open Issues :
*Change history :
*@LastModifyDate : 2015-05-11
*@LastModifier : YulKyu Lee
*@LastVersion : 1.0
* 2015-05-11 YulKyu Lee
* 1.0 최초 생성
*  
=========================================================*/
/****************************************************************************************
 ...
 ***************************************************************************************/
	/**
	 * @class ESD_EAS_0363 : 예)M&R Invoice Charge 조회 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function ESD_EAS_0363() {
	...
	function processButtonClick(){
		...
		try {
			...
			case "btn_delete_office" :
				...
				break;
//			case "s_set_data_only" :	// 선택한 rows만 보이게 하는 함수
			...
			case "sheet1":	  //IBSheet1 init
				with (sheetObj) {
				   ...
				   //전체Edit 허용 여부 [선택, Default false]
					...
					var HeadTitle = "|Seq|Module|RHQ|Office|Objective of\nAuto-Audit|Permissible\nRatio(%)|Updated By|Update Date|Remarks|";
					...
					InitDataProperty(0, cnt++, dtData,		50,		daCenter,	false,	"module",			false,    		"",       dfNone,    0,     false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++, dtData,		70,		daCenter,	true,	"rhq_ofc_cd",		false,    		"",       dfNone,    0,     false,       false);
					...
					InitDataProperty(0, cnt++, dtData,		90,		daCenter,	false,	"ratio",			false,          "",       dfNullFloat,    0,     true,       true);
					...
					InitDataProperty(0, cnt++, dtData,		200,	daLeft,		false,	"aut_rmk",			false,          "",       dfNone,    0,     true,       true);
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:		//조회
				...
				sheetObj.DoSearch("ESD_EAS_0363GS.do", EasFrmQryString(formObj));
			...
			case MODIFY:	// MODIFY OFFICE AUDIT STATUS
				...
				sheetObj.DoSave("ESD_EAS_0363GS.do", EasFrmQryString(formObj));
...
//					MaxLength = 5;
	...
	function respb_ofc_cd_Check(checkOfficeCode){
		...
		var availability = ComGetEtcData(sXml, "EAS_0363_AVAILABILITY")
		var validation = ComGetEtcData(sXml, "EAS_0363_VALIDATION")
...
//		var formObj = document.form;
//		formObj.i_ofc_cd.value = value;
//		var colName = sheetObj.ColSaveName(col);
//	 	switch(colName) { //ofc_cd
//	 		case('rhq_ofc_cd'):
//	 			// Select 값을 변경시 confirm위해 자동으로 Select Check box 표시
//	 			if(!respb_ofc_cd_Check(3)){
//	 				sheetObj.CellValue(row,col) = "";
//	 			}
//	 		break;
//	 		case('ofc_cd'):
//	 			if(!respb_ofc_cd_Check(4)){
//	 				sheetObj.CellValue(row,col) = "";
//	 			}
//	 		break;
//	 	}
