...
<input type="hidden" name="office_code_in_sheet">
						...
						<!-- : ( Week ) (S) -->
							...
							<table class="search_in" border="0">
								<tr class="h23">
									...
									<td><input type="checkbox" name="s_set_data_only"  maxlength="6" style="width:20;text-align:center;ime-mode:disabled;border:0;" class="checkbox" value="1" >Set Data Only
									</td>
								</tr>								
							</table>
						<!-- : ( Week ) (E) -->
					...
					<table width="100%" class="button">
						<tr><td class="btn2_bg">
							<table border="0" cellpadding="0" cellspacing="0">
								...
								<!-- Repeat Pattern -->
								<td width="75">Office Code:</td><td width="100"><input type="text" name="i_ofc_cd" style="width:80;" class="input"  maxlength="6" dataformat="engup" onchange="javascript:setgetUpper(this)"></td>
								<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
