		       	...
		       	<tr>
		       		<td class="bg">
						...
						<table class="search_in" border="0">
							...
							<tr class="h23">
								<td>No of Repairs</td>
								<td style="padding-left:2" colspan="7"><input type="text" name="s_rpr_cnt" dataformat="int" maxlength="2" style="width:50px;text-align:center;ime-mode:disabled;" class="input" value="3"> Over 
								</td>
							</tr>								
						</table>
						<!-- : ( Week ) (E) -->
