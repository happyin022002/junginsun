...
<%@ page import="com.hanjin.apps.alps.esd.eas.expnaud.tesaud.event.EsdEas0312Event"%>
<%@ page import="org.apache.log4j.Logger" %>
 
<%
	EsdEas0312Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0312Event)request.getAttribute("Event");
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width=""  align="right"><input type="checkbox" name="manual_check" value="Y" class="trans">Discrepancy Only</td>
				</tr>
				</table> 
				<!-- : ( Week ) (E) -->
