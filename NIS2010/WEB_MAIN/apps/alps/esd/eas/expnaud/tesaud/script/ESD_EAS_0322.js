...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_EAS_0322 : ESD_EAS_0322 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
...
//  					InitRowInfo( 1, 1, 10);
  					...
  					sheetObj.InitColumnInfo(23, 0, 0, false);
  					...
  					sheetObj.InitHeadMode(true, true, false, true, false, false)
   					...
   					var HeadTitle1 = "|Seq|RHQ|Cost Office|INV Office|Yard|S/P Code|S/P Name|INV No|INV User|Calculated Type|Cost Code|Stacking Vol|Vol by Invoice|Differ|Free Pool|Over Vol|UOM|Rate|AGMT Curr|Exch Rate|Amount(USD)|Remark";
  					...
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 150, 	daLeft,	   	   false, 	 "vndr_lgl_eng_nm", false, 	"", 	dfNone, 		0, 		false, 		false );
  					...
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 130, 	daLeft,	   	   false, 	 "calc_tp_cd",   	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 75, 	daCenter,	   false, 	 "lgs_cost_cd",		false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 90, 	daRight,	   false, 	 "stk_vol_qty", 	false, 	"", 	dfFloat, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 90,    daRight,       false,    "inv_vol_qty",		false,  "",     dfFloat,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 70,    daRight,       false,    "diff_vol_qty",	false,  "",     dfFloat,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daCenter,      false,    "rev_yrmon",		false,  "",     dfDateYm,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 90,    daRight,       false,    "ovr_vol_qty",		false,  "",     dfFloat,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 90,    daCenter,      false,    "vol_tr_ut_cd",	false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 60,    daRight,       false,    "ctrt_rt",			false,  "",     dfFloat,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 75,    daCenter,      false,    "curr_cd",			false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 70,    daRight,       false,    "inv_xch_rt",		false,  "",     dfFloat,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 90,    daRight,       false,    "inv_amt",			false,  "",     dfFloat,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 140,   daCenter,      false,    "calc_rmk",		false,  "",     dfNone,    		0,    	false,    	false);
  	...
  	function doActionIBSheet(sheetObj, formObj, sAction, PageNo) {
  		...
  		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_EAS_0322GS.do", pageParam, true);
		   ...
		   case IBSEARCHAPPEND:
  			...
  			case IBSEARCH_ASYNC01: // 화면 로딩시 Cost CodeType 조회 tml_inv_tp_cd
				...
				var sXml = sheetObj.GetSearchXml("ESD_EAS_0322GS.do", FormQueryString(formObj));
