...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_EAS_0320 : ESD_EAS_0320 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
...
//  					InitRowInfo( 1, 1, 10);
  					...
  					sheetObj.InitColumnInfo(24, 0, 0, false);
...
//  					var HeadTitle1 = "|SEQ|CNTR No.|Type/Size|Origin Yard|Bound|MVMT Leg|From date|To date|Days|IN VVD|OUT VVD|BKG No.|B/L No.|Reefer Dry";
  					
  					var HeadTitle1 = "|Seq.|RHQ|Cost Office|INV Office|Yard|S/P|S/P Name|INV No.|INV User|Calculated Type|Cost Code|Type/Size|Applied \n Date|DG|Calculated Vol.|Revised Vol.|UOM|Rate|AGMT \n Curr.|Exch.\nRate|Amount\n(USD)|Remark|3rd Party";
  					...
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 70, 	daCenter,	   false, 	 "vndr_seq", 		false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtHiddenStatus, 		 130, 	daLeft,	       false, 	 "vndr_lgl_eng_nm", false, 	"", 	dfNone, 		0, 		false, 		false );
  					...
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 115, 	daCenter ,	   false, 	 "calc_tp_cd",		false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 80, 	daCenter,	   false, 	 "lgs_cost_cd", 	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 80, 	daCenter,	   false, 	 "cntr_tpsz_cd",	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 70, 	daCenter,	   false, 	 "tml_wrk_dy_cd",   false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 60, 	daCenter,	   false, 	 "dcgo_ind_cd",   	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 100, 	daRight,	   false, 	 "calc_vol_qty",	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 90, 	daRight,	   false, 	 "rvis_vol_qty", 	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 70,    daCenter,      false,    "vol_tr_ut_cd",	false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daRight,      false,     "ctrt_rt",			false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daCenter,      false,    "curr_cd",			false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daCenter,      false,    "inv_xch_rt",		false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daRight,       false,    "inv_amt",			false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 180,   daLeft,        false,    "calc_rmk",		false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daCenter,      false,    "n3pty_flg",		false,  "",     dfNone,    		0,    	false,    	false);
  	...
  	function doActionIBSheet(sheetObj, formObj, sAction, PageNo) {
  		...
  		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_EAS_0320GS.do", pageParam, true);
				sheetObj.LoadSearchXml(sXml, true);
				//prompt("AA",FormQueryString(formObj)); return;
//				sheetObj.DoSearch("ESD_EAS_0311GS.do", FormQueryString(formObj));
				break;
		   case IBSEARCHAPPEND:
			   formObj.f_cmd.value = SEARCHLIST01;
