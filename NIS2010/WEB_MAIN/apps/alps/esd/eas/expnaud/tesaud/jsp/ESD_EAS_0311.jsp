...
<%@ page import="com.hanjin.apps.alps.esd.eas.expnaud.tesaud.event.EsdEas0311Event"%>
<%@ page import="org.apache.log4j.Logger" %>
 
<%
	EsdEas0311Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0311Event)request.getAttribute("Event");
	...
	String actionInvStatusBox = JSPUtil.getCodeCombo("tml_inv_sts_cd", 		"01", "width='100'","CD00172", 0, addRowBound);
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="180"><%=actionInvDateBox%></td>
					<td width="220" colspan="2"><input type="text" name="fm_prd_dt" style="width:75" value="" maxlength=10 class="input1" onKeyUp='isNum1(this);' onKeyDown='chkInput(this);' OnBlur='obj_blur();' OnFocus='obj_focus();'>
					...
					<td width="110"><input type="text" style="width:76" name="yd_cd" maxlength=7 class="input1" onKeyUp='upper(this);' onBlur='yd_cd_change();' onKeyPress='enterCheck("retrieveEvent");'>
 				...
 				<tr class="h23">
					<td width="90">Cost Office</td>
					<td width="180"><input type="text" style="width:77" maxlength=6 onKeyUp='chkInput(this);upper(this);isAlpha(this);' onBlur='costOffice_change();' name="cost_ofc_cd" onKeyPress='enterCheck("retrieveEvent");'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cost_ofc_cd"></td>
					<td width="90">&nbsp;Invoice OFC</td>
					<td width="130" align="right">&nbsp;<input type="text" style="width:75" maxlength=6 onKeyUp='isAlpha(this);chkInput(this);upper(this);' onBlur='invoiceOffice_change();' name="inv_ofc_cd" onKeyPress='enterCheck("retrieveEvent");'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_inv_ofc_cd">&nbsp;</td>
					<td width="70">VVD</td> 
					<td !width="110"><input type="text" style="width:100" name="vvd" maxlength=20 onKeyPress='enterCheck("retrieveEvent");'></td>
 				...
 				<tr class="h23">
					...
					<td colspan="6"><script language="javascript">ComComboObject('lgs_cost_subj_cd',1, 120 , 0, 0)</script>&nbsp;&nbsp;<script language="javascript">ComComboObject('lgs_cost_dtl_cd',1, 140 , 1 )</script></td>
					<td width="" style="border-right:1pt solid white" !colspan="9" !align="right"><input type="checkbox" name="manual_check" value="Y" class="trans">Manual Input Only</td>
				</tr>
 				</table> 
				<!-- : ( Week ) (E) -->
