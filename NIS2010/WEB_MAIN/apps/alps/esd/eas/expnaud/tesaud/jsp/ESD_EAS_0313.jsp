...
<input type="hidden" name="calc_cost_grp_cd" value="SD">
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="" colspan="7"><%=actionInvDateBox%>&nbsp;<input type="text" name="fm_prd_dt" style="width:75" value="" maxlength=10 class="input1" onKeyUp='isNum1(this);' onKeyDown='chkInput(this);' OnBlur='obj_blur();' OnFocus='obj_focus();'>
				...
				<tr class="h23">	
					<td  !width="90">Yard Code</td>
					<td><input type="text" style="width:75" name="yd_cd" maxlength=7 class="input1" onKeyUp='upper(this);' onBlur='yd_cd_change();' onKeyPress='enterCheck("retrieveEvent");'>
					...
					<td width="140"><script language="javascript">ComComboObject('io_bnd_cd', 1, 70, 0, 0);</script></td>
					<td width="90">Cost Office</td>
					<td width="120">&nbsp;<input type="text" style="width:57" maxlength=6 onKeyUp='chkInput(this);upper(this);isAlpha(this);' onBlur='costOffice_change();' name="cost_ofc_cd" onKeyPress='enterCheck("retrieveEvent");'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cost_ofc_cd">
				</tr>
					
				<tr class="h23">
					<td !width="90">Invoice OFC</td>
					<td !width="125"><input type="text" style="width:75" maxlength=6 onKeyUp='isAlpha(this);chkInput(this);upper(this);' onBlur='invoiceOffice_change();' name="inv_ofc_cd" onKeyPress='enterCheck("retrieveEvent");'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_inv_ofc_cd"></td>
				
					<td  width="90">Invoice STS</td>
					<td colspan="4"><%=actionInvStatusBox%></td>
					<td width="" !colspan="9" !align="right"><input type="checkbox" name=vrfy_rslt_ind_cd value="Y" class="trans">Discrepancy Only</td>
				</tr>
				</table> 
				<!-- : ( Week ) (E) -->
