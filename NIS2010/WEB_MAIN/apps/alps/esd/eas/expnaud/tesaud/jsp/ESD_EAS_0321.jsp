     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">	
					...
					<td width="110"><script language="javascript">ComComboObject('io_bnd_cd', 1, 70, 0, 0);</script></td>
					<td !width="90"> S/P Code</td>
					<td width="180"><input type="text" style="width:50" value="" maxlength=6 name="vndr_seq" onKeyUp='chkInput(this);isNum(this);' onBlur='vender_change();'>
