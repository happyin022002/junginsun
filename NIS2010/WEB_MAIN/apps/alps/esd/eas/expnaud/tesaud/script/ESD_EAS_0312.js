...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_EAS_0312 : ESD_EAS_0312 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
...
//  					InitRowInfo( 1, 1, 10);
  					...
  					sheetObj.InitColumnInfo(20, 0, 0, false);
...
//  					var HeadTitle1 = "|SEQ|CNTR No.|Type/Size|Origin Yard|Bound|MVMT Leg|From date|To date|Days|IN VVD|OUT VVD|BKG No.|B/L No.|Reefer Dry";
  					...
  					var HeadTitle1 = "|Seq|RHQ|Cost Office|INV Office|Yard|S/P|S/P Name|INV No|INV User|CNTR No|CNTR \n DTC|Type/Size|F/M|DG|Working  \n Date|CLM Date|Rail Billing \n Date|Verify \n Result|Remark";
  					...
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 90, 	daCenter,	   false, 	 "yd_cd", 			false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 80, 	daCenter,	   false, 	 "vndr_seq", 		false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 120, 	daLeft,	       false, 	 "vndr_lgl_eng_nm", false, 	"", 	dfNone, 		0, 		false, 		false );
  					...
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 110, 	daCenter ,	   false, 	 "cntr_no",			false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 70, 	daCenter,	   false, 	 "cntr_dtc", 		false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 80, 	daCenter,	   false, 	 "cntr_tpsz_cd",	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 70, 	daCenter,	   false, 	 "cntr_sty_cd",   	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 70, 	daCenter,	   false, 	 "dcgo_clss_cd",   	false, 	"", 	dfNone, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 90, 	daCenter,	   false, 	 "wrk_dt",			false, 	"", 	dfDateYmd, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData, 		 90, 	daCenter,	   false, 	 "clm_dt", 			false, 	"", 	dfDateYmd, 		0, 		false, 		false );
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 90,    daCenter,      false,    "rail_bil_dt",		false,  "",     dfDateYmd,    	0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 80,    daCenter,      false,    "dscr_ind_cd",		false,  "",     dfNone,    		0,    	false,    	false);
  					sheetObj.InitDataProperty( 0, cnt++, dtData,      	 180,   daLeft,        false,    "cntr_rmk",		false,  "",     dfNone,    		0,    	false,    	false);
  	...
  	function doActionIBSheet(sheetObj, formObj, sAction, PageNo) {
  		...
  		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_EAS_0312GS.do", pageParam, true);
