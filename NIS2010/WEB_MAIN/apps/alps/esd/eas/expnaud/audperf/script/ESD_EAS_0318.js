...
*@FileName : ESD_EAS_0318.js
*@FileTitle : ESD_EAS_0318
*Open Issues :
*Change history :
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class esd_eas_0318 : esd_eas_0318 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_EAS_0318() {
			...
			switch(sheetID) {
				...
				case "sheet1":
						with (sheetObj) {
							...
							var HeadTitle1 = "|Seq|Office|Month|Module|S/P Code|S/P Name|Location|Invoice QTY|Local CUR|Amount|Amount(USD)||";
							...
							InitDataProperty(0,		cnt++ , dtData,					70,	daCenter,			false,		"mdl_cd",			false,		"",		dfNone,					0,		false,	true);
							InitDataProperty(0,		cnt++ , dtData,					70,	daCenter,			false,		"vndr_no",			false,		"",		dfNone,					0,		false,	true);
							InitDataProperty(0,		cnt++ , dtData,					200,	daLeft,			false,		"vndr_nm",			false,		"",		dfNone,					0,		false,	true);
							InitDataProperty(0,		cnt++ , dtData,					70,	daCenter,			false,		"loc_cd",			false,		"",		dfNone,					0,		false,	true);
							InitDataProperty(0,		cnt++ , dtData,					80,	daRight,			false,		"inv_qty",			false,		"",		dfNullInteger,			0,		false,	true);
							...
							InitDataProperty(0,		cnt++ , dtHidden,				100,	daLeft,			false,		"stnd_ym",			false,		"",		dfNone,					0,		false,	true);
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
			...
			case IBSEARCH:      //조회
				...
				sheetObj.DoSearch("ESD_EAS_0318GS.do",sParam);
				ComOpenWait(false);
				break;
    ...
    function sheet1_OnDblClick(sheetObj,Row,Col) {
    	...
    	if (ofcCd == "TOTAL") return;
    	
    	var sParam = Array();
    	var formObject = document.form;
		sParam[0] = "s_ym="+formObject.s_ym.value;
		sParam[1] = "s_ofc_cd="+formObject.s_ofc_cd.value;
		sParam[2] = "s_vndr_seq="+sheetObj.CellValue(Row, "vndr_no");
		sParam[3] = "s_rhq_yn="+formObject.s_rhq_yn.value;
		
        ComOpenWindowCenter("ESD_EAS_0319.do?"+sParam.join("&"), "winCostDtl", "1030", "560", true, "no");
    }
