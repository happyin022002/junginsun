...
*@FileName : ESD_EAS_0318.jsp
*@FileTitle : Logistics Expense Result - S/P Detail
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esd.eas.expnaud.audperf.event.EsdEas0318Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
	EsdEas0318Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdEas0318Event)request.getAttribute("Event");
...
<html>
<head>
<title>Logistics Expense Result - S/P Detail</title>
...
<tr><td valign="top">	
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle"> Logistics Expense Result - S/P Detail</td></tr>
		</table>
		<!-- : ( Title ) (E) -->			
