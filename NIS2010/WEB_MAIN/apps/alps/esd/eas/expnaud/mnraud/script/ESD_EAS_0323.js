...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_EAS_0323 : ESD_EAS_0323 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_EAS_0323() {
		...
		try {
			...
			switch(srcName) {
    			...
    			case "btn_vvd":	
	        	  	...
	        	  	break;	
    			case "btn_porl_cd":	
					var param="?loc_cd="+ComGetObjValue(frm.s_loc_cd); 
	 	...
	 	switch(sheetNo) {
	    	case 1:      //sheet1 init
		    	with (sheetObj) {
					...
					var HeadTitle1 = "|Seq.|RHQ|Register\nOffice|POR|POL|Install\nYard|CNTR No.|CNTR\nType|Install Bar\nQTY|W/O No.|WO Amount|WO Amount|S/P Code|S/P Name|BKG No.|Surcharge|Surcharge|OFT IN|Mixed";
...
//					HeadRowHeight = 12;
					...
					InitDataProperty(0, cnt++ , dtData,         60,  	daCenter,   true,   "rhq_cd",         			false,    "",      dfNone,        	0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         70,  	daCenter,   true,   "reg_ofc_cd", 		   		false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         60,  	daCenter,   true,   "por_nod_cd", 				false,    "",      dfNone,     		0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         60,  	daCenter,   true,   "pol_nod_cd", 				false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);					
					InitDataProperty(0, cnt++ , dtData,         70,  	daCenter,   true,   "mnr_flg_yd_cd",      	   	false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         95,  	daCenter,   true,   "eq_no",   	   	   			false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         60,  	daCenter,   true,   "eq_tpsz_cd",  		  		false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         70,  	daRight,   	true,   "hngr_bar_amd_qty",         false,    "",      dfNullInteger,   0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         80,  	daCenter,   true,   "wo_no",    				false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         40,  	daCenter,   true,   "wo_curr_cd",  	  			false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         80,  	daRight,   	true,   "wo_amt",         			false,    "",      dfNullFloat,     2,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         65,  	daCenter,   true,   "vndr_seq",        			false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					InitDataProperty(0, cnt++ , dtData,         150,  	daLeft,   	true,   "vndr_nm",         			false,    "",      dfNone,          0,          false,        false,   0,  false, true,  "", false);
					...
					InitDataProperty(0, cnt++ , dtData,         45,  	daCenter,   true,   "oft_in",     				false,    "",      dfNone,     		0,          false,        false,   0,  false, true,  "", false);
...
//						alert(sParam);
						var sXml = sheetObj.GetSearchXml("ESD_EAS_0323GS.do", sParam);
...
//			var pgmNo = 'ESD_EAS_0323';
//			var pgmUrl = 'ESD_EAS_0323.do?';
...
//				frm.s_eac_reg_usr_id.RemoveAll();
		...
		function validateForm(sheetObj,formObj,sAction){
			switch(sAction) {
			case IBSEARCH :
				// Mandatory Item Check - Flag Duration
				if(formObj.s_fm_dt.value == "" || formObj.s_to_dt.value == "" ) {
					ComShowCodeMessage("COM130403", "Flag Duration"); // S/O creation period;
					return false;
				}
				
				// Mandatory Item Check - Install Country Code
				if(formObj.s_cnt_cd.value == "" ){
					ComShowCodeMessage("COM130403", "Install Country Code"); 
					return false;
				}
		...
		function checkPeriodValidation(objFm,objTo){
			...
			if ( sTo > sMax){
				ComShowCodeMessage("COM132001", "Flag Duration","2 Month"); // msgs['COM132001'] = '{?msg1} exceeds maximum duration {?msg2}.';
				return false;
			}
		...
		function eac_transfer(sheetObj,Row,Col){
			...
			var eqNoList = "";
			var soNoList = "";
			var costCdList = "";	// Cost Code doesn't exist in 0323. this value need for eac i/f. ( default : XXXXXX )
			var temp = "";	
			var ofc_cd = "";
			var vndr_seq = "";
			var cur_cd = "";
