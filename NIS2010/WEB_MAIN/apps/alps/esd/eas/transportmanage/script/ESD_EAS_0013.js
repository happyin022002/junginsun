...
/**
 * @extends Bkg
 * @class ESD_EAS_0013 : 예)Drop Off Charge Collection Inqury 조회 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_EAS_0013() {
			...
			case 1:	  //IBSheet1 init
				with (sheetObj) {
				   ...
				   //전체Edit 허용 여부 [선택, Default false]
					...
					var HeadTitle = "SEQ|MT Return CY|Haulage|Container Q'ty|Container Q'ty|Container Q'ty|Container Q'ty|Container Q'ty|Container Q'ty|Container Q'ty|Tariff Amount(EUR)|Tariff Amount(EUR)|Tariff Amount(EUR)|Tariff Amount(EUR)|Tariff Amount(EUR)|Tariff Amount(EUR)|Tariff Amount(EUR)|TRO Amount\n(EUR)|DOD Amount\n(EUR)";
					var HeadTitle1 = "SEQ|MT Return CY|Haulage|D2|D4|D5|R2|R5|R9|Sum|D2|D4|D5|R2|R5|R9|Sum|TRO Amount\n(EUR)|DOD Amount\n(EUR)";
					...
					InitDataProperty(0, cnt++, dtData,      100,    daCenter, false,    "r2_qty",				false,          "",       dfNullInteger,    	0,     false,       true);
					InitDataProperty(0, cnt++, dtData,      100,    daCenter, false,    "r5_qty",               false,          "",       dfNullInteger,    	0,     false,       true);					
					InitDataProperty(0, cnt++, dtData,      100,    daCenter, false,    "r9_qty",     			false,          "",       dfNullInteger,    	0,     false,       true);					
					...
					InitDataProperty(0, cnt++, dtData,      100,    daCenter, false,    "trf_r2_qty",      		false,          "",       dfNullInteger,    	0,     false,       true); 
					InitDataProperty(0, cnt++, dtData,      100,    daCenter, false,    "trf_r5_qty",         	false,          "",       dfNullInteger,    	0,     false,       true);
					InitDataProperty(0, cnt++, dtData,      100,    daCenter, false,    "trf_r9_qty",         	false,          "",       dfNullInteger,    	0,     false,       true);
		...
		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				setFormValueBySelectType(selTpCd);
     			...
     			var sXml = sheetObj.GetSearchXml("ESD_EAS_0013GS.do", EasFrmQryString(formObj));
