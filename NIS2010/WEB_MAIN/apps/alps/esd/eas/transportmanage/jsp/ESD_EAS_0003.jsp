...
<%@ page import="com.hanjin.apps.alps.esd.eas.transportmanage.event.EsdEas0003Event"%>
<%
					...
					<td class="bg">
						...
						<table class="search_in" border="0">
							<tr class="h23">
								...
								<!-- <img class="cursor" img src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name='btns_office'> -->
								</td>
								...
								<input name="to_so_date" type="text" style="width:70" value="YYYYMMDD"> <img class="cursor" img src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" name='btns_calendar' align="absmiddle"></td>
							</tr>
						</table>
					</td>
				</tr>
