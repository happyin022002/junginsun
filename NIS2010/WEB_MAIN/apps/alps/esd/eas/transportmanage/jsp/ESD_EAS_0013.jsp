...
<%@ page import="com.hanjin.apps.alps.esd.eas.transportmanage.event.EsdEas0013Event"%>
	     	...
	     	<table class="search" border="0">
	              <tr><td class="bg">
		                  <table class="search_in" border="0">
		                    	<tr class="h23">
			                      <td width="10"><input type="radio" name="sel_tp_cd" value="1" class="trans" onClick="selectTpCd(this.value);" checked></td>
