...
<%@ page import="com.hanjin.apps.alps.esd.lea.logisticsexpenseaccrual.accrualbatchmanage.event.EsdLea0001Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.LogisticsExpenseAccrual.AccrualBatchManage");
...
<tr><td>
	...
	<tr><td class="bg">
		...
		<tr class="h23">
			...
			<td><input type="text" class="input1" style="width:60;" name="frm_exe_yrmon"  valid="1" desc= "Exe. Year-Month" value="<%=nowYYMM%>" onKeyUp="lea_comm_isNumberMessage(this,6);" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve')" onBlur="lea_com_convertYymm(this);" onClick="lea_com_select(this)"></td></tr>
		</table>
		<!-- : ( Year ) (E) -->
	...
	<table class="search">
	 	<tr><td class="bg">
			...
			<tr><td align="center">2</td>
				...
				<td style="padding-left:70;"><input type="text" class="input2"  name="frm_rev_vvd_if_flg_nm" style="width:140" readonly>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" name="btns_rev_vvd_search" width="19" height="20" border="0" align="absmiddle"></td>
			</tr>
