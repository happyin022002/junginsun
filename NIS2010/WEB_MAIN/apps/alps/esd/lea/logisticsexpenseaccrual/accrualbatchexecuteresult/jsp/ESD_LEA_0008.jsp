...
<%@ page import="com.hanjin.apps.alps.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0008Event"%>
    	...
    	<table class="search">
      	<tr><td class="bg">
			...
			<tr class="h23">
				...
				<td class="stm">
					<input type="text" class="input1" style="width:60;" maxlength="7" name="exe_yrmon_from"  valid="1" value="<%=fmExeYYMM %>" desc= "From Exe. Month"  onKeyUp="lea_comm_isNumberMessage(this,6);" onBlur="lea_com_convertYymm(this);" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve')" onClick="lea_com_select(this)"> ~
					<input type="text" class="input1" style="width:60;" maxlength="7" name="exe_yrmon_to"  valid="1" value="<%=nowExeYYMM %>" desc= "To Exe. Month"  onKeyUp="lea_comm_isNumberMessage(this,6);" onBlur="lea_com_convertYymm(this);"  onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve')" onClick="lea_com_select(this)"></td></tr>
			</table>
			<!-- : ( Year ) (E) -->
