...
<%@ page import="com.hanjin.apps.alps.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0006Event"%>
...
<%
	...
	open_div = StringUtil.xssFilter(request.getParameter("open_div")!=null&&!request.getParameter("open_div").equals("")?request.getParameter("open_div"):"");   
...
<tr><td>
		...
		<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"><span id="title"></td></tr>
		</table>
		...
		<!-- TABLE '#D' : ( Search Options ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
			...
			<table>
				<tr class="h23" width="600">
					<td width="35">RHQ</td>
					<td width="100">
					<SELECT style='width:80' name="f_rhq_cd" onChange="changeRHQCd1(this.value);" class="input1" >
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<!-- : ( Seq. ) (E) -->
					...
					<tr><td class="sm">
					<font size=2>
						<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0" vspace="4">This menu shows the <u>CONFIRMED(Actual+Accrual)</u> amount of monthly settlement of account by revenue month.<br>
						...
						<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0" vspace="4">Terminal expense paid for handling other carrier's (not HJS) volume is <u>EXCLUDED.</u> <br>
						<!--<img src="/hanjin/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0" vspace="4">Full volume incentive for Y2011 only shows <u>ACTUAL</u> amount, while for Y2012 shows <u>CONFIRMED</u> one. <br>  -->
						</font></td>
					</tr>
	    	<!-- Button_Sub (E) -->
			</td></tr>
