...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_LEA_0003 : ESD_LEA_0003 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_LEA_0003() {
                ...
                case 2:      //IBSheet2 init
                    with (sheetObj) {
    	            	...
    	            	var HeadTitle   = "STS|Rev.\nMonth|Full Volume Discount & Incentive-\nTerminal (512073)|Full Volume Discount & Incentive-\nTerminal (512073)|Full Volume Discount & Incentive-\nTerminal (512073)";
    	            		...
    	            		HeadTitle  += "|Empty Stevedorage\n(512061)|Empty Terminal Handling\n(512151)|Empty RePosition Storage\n(512221)";
    	            		HeadTitle  += "|Empty RePosition Transportation\n(512341)|Chassis Bundle Cost\n (512171)|Chassis Drayage \n (512331)";
    	            		HeadTitle  += "|US Domestic Rail Cost\n(512351)|Other Carrier's Terminal Cost\n(512019)|3rd Party Billing \nStevedorage (512181)";
                        ...
                        InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "estm_cost_amt_512073",		false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512073",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "adj_accl_cost_amt_512073",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "estm_cost_amt_512361",		false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512361",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "adj_accl_cost_amt_512361",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "estm_cost_amt_512074",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512074",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "adj_accl_cost_amt_512074",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					    					
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "estm_cost_amt_512362",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512362",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "adj_accl_cost_amt_512362",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512061",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512151",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512221",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512341",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512171",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512331",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512351",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512019",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512181",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
    					InitDataProperty(0, cnt++ , dtData  ,       95,    daRight ,  false,    "pst_act_cost_amt_512381",	false,          "",       dfNullFloat,   	2,     false ,        false  , 14);
            ...
            switch(sAction) {
            	...
            	case IBSEARCH:      //조회
                   //if(validateForm(sheetObj,formObj,sAction))
            		...
            		var searchXml 		= sheetObj.GetSearchXml("ESD_LEA_0003GS.do", leaFormQueryString(formObj));
      ...
      function doActionIBSheet2_etc(sheetObj,formObj,sAction) {
      	...
      	switch(sAction) {
      		case IBSEARCH_ASYNC01:      //조회
      		    ...
      		    var searchXml		= sheetObj.GetSearchXml("ESD_LEA_0003GS.do", leaFormQueryString(formObj));
      			formObj.max_exe_yrmon_month.value = ComGetEtcData(searchXml,"max_exe_yrmon_month");
    	...
    	*/
    	function lea_getFlagValues(sheetObj, formObj){
    		...
    		/* GL_ACCL_IF Confirm여부에 따른 UI에 Text 처리 */
    			...
    			formObj.gl_accl_if_confirm_text.value	= 'The result of settlement of accounts in ' + formObj.max_exe_yrmon_month.value + 'is updated.';
    			formObj.gl_accl_if_confirm_text2.value	= 'The result of settlement of accounts in ' + formObj.max_exe_yrmon_month.value + 'is updated.';
    	}
