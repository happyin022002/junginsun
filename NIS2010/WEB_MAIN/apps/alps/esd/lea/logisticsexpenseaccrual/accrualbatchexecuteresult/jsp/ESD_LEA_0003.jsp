...
<%@ page import="com.hanjin.apps.alps.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0003Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdLea0003Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdLea0003Event)request.getAttribute("Event");
...
<input type="hidden" name="max_exe_yrmon_month">
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="160"><input type="text" style="width:60;" class="input1" name="frm_exe_yrmon"  valid="1" desc= "Exe. Year-Month" value="<%=nowYYMM%>" onKeyUp="lea_comm_isNumberMessage(this,6);"  onBlur="lea_com_convertYymm(this);lea_com_setRevToYymm(this,document.form.frm_rev_yrmon_from, document.form.frm_rev_yrmon_to);" onKeyDown="lea_setRevToYymm(this,document.form.frm_rev_yrmon_to);lea_com_enterKeyEvent('lea_enterRetrieve')" onClick="lea_com_select(this)" disabled></td>
...
<div id="tabLayer" style="display:inline">
				...
				<table width="100%" class="button">
			       	<tr><td class="btn2_bg" width="400"><input type="text" class="transgray" name="gl_accl_if_confirm_text" value="" style="width:100%;" readonly>
			       		</td>
			       		<td class="btn2_bg">
						<table border="0" cellpadding="0" cellspacing="0">
						<tr>
...
<div id="tabLayer" style="display:none">
				...
				<!--  Button_Sub (S) -->
				<table width="100%" class="button">
			       	<tr><td class="btn2_bg"><td class="btn2_bg" width="400"><input type="text" class="transgray" name="gl_accl_if_confirm_text2" value="" style="width:100%;" readonly>
			       		</td>
			       		<td  class="btn2_bg">
						<table border="0" cellpadding="0" cellspacing="0">
						<tr>
