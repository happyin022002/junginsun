...
<%@ page import="com.hanjin.apps.alps.esd.lea.logisticsexpenseaccrual.actualcostcsrmanage.event.EsdLea0012Event"%>
       							...
       							<td class="bg">
									...
									<tr class="h23">
										...
										<td width="300" class="stm">
											...
											&nbsp;~&nbsp;
											<input type="text" name="frm_end_if_dt" desc="ERP I/F Date" class="input1" style="width:75;" value="<%=end_if_dt%>"  onBlur="lea_convertYymmdd(this);" onKeyUp="lea_comm_isNumberMessage(this,8);" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve');" onClick="lea_com_select(this)">&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar2"></td>
									...
									<tr class="h23">
										...
										<td><select name="frm_if_flg" desc="ERP I/F Status" style="width:75;" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve');">
											...
											<option value="E" <%=("N".equals(if_flg.trim())) ? "selected" : ""%>>E</option>
											</select></td>
										<td>LEA Interface</td>
