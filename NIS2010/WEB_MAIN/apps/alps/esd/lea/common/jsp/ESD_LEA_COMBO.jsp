...
* 1.0 최초 생성
* @History
* 2011-05-02 이정수 : Office COMBO가 정상적으로 생성되도록 수정하기 위해 만듬
=========================================================*/
--%>
...
<%@ page import="com.hanjin.apps.alps.esd.lea.common.codecomboutil.event.CommonEvent" %>
	...
	try{
		...
		if(serverException != null){
			...
			if(event != null){
				...
				cboData = CodeComboUtil.getCodeCombo(cboNm, defaultValue, addProperties, workName, param, allYN, addOption);
			}
		}
	}catch(Exception e){
