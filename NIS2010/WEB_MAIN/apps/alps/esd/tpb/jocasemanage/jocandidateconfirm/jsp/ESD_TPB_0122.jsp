...
* 2009-09-14 Jong-Geon Byeon	1.2 ALPS Migration
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esd.tpb.jocasemanage.jocandidateconfirm.event.EsdTpb0122Event"%>
...
<tr><td>
	...
	<!-- | -->			<td width="340">
							<% if ( ofc_lvl.equals("C") ) { %>
	<!-- | -->				<select class="input1" style="width:160;" name="s_if_ctrl_cd" caption="Control Office">
	<!-- | -->					<option value="<%=ofc_cd%>" selected><%=ofc_cd%></option>
	<!-- | -->				</select>
							<% } else { %>
	<!-- | -->				<select class="input1" style="width:160;" name="s_if_ctrl_cd" caption="Control Office" disabled>
	<!-- | -->					<option value="" selected>&lt;Select&gt;</option>
	<!-- | -->				</select>
							<% } %>
	<!-- | -->			</td>
	...
	<!-- | -->			<td>
	<!-- | -->				<select style="width:100;" name="s_if_ofc_cd" ><option value="" selected>ALL</option></select>
	<!-- | -->			</td>
	<!-- | -->		</tr>
	<!-- | -->	</table>
	<!-- | -->	<table class="search_in" border="0">
	<!-- | -->		<tr class="h23">
	<!-- | -->			<td width="80"><img class="nostar">Candidate</td>
	<!-- | -->			<!-- <td width="140"><%=TPBUtils.getCodeCombo("s_cfm_status", (ofc_lvl.equals("R")?"O":"W"), "style='width:150', class='input1'   caption='Confirm Status'", "CD00739", 0, "100000:W:New & Review|999999:ALL:ALL|","") %></td> -->
	<!-- | -->			<td width="250">
	<!-- | -->				<select name="s_nr" style="width:130;">
	...
	<!-- | -->				</select>
	<!-- | -->			</td>
	<!-- | -->			<td width="100"><img class="nostar">Exp. Type</td>
	<!-- | -->			<td>
	<!-- | -->				<%=JSPUtil.getCodeCombo("s_n3pty_src_sub_sys_cd", "", "style='width:160'", "CD00580", 0, "001: :ALL|")%>
	<!-- | -->				<select name="s_n3pty_bil_tp_cd" style="width:160;">
	...
	<!-- | -->			<td width="250"><input type="text" style="width:107" name="s_vvd" maxlength="9">&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_vvd"></td>
	<!-- | -->			<td width="100"><img class="nostar">Booking No.</td>
	<!-- | -->			<td width="340"><input type="text" style="width:160" name="s_bkg_no_all" maxlength="13" onblur="getBLNo(this.form,this,'s_')"></td>
	...
	<!-- | -->	<table class="search_in" border="0">
	<!-- | -->		<tr class="h23">
	<!-- | -->			<td width="80"><img class="nostar">CSR No.</td>
	<!-- | -->			<td width="250"><input type="text" style="width:160" name="s_csr_no" maxlength="20"></td>
	<!-- | -->			<td width="100"><img class="nostar">S/P Inv. No.</td>
	<!-- | -->			<td>
