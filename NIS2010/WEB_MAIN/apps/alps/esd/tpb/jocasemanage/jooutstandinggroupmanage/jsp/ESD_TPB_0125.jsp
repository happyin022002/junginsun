...
* 2010-04-30 Sun, CHOI 1.3 JO TPB Cancel 기능 추가
=========================================================*/
%>
...
<%@ page import="com.hanjin.apps.alps.esd.tpb.jocasemanage.jooutstandinggroupmanage.event.EsdTpb0125Event"%>
	...
	<!-- |______________________________________________ End Page Navigation & Title -->
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5;">
				<tr><td class="btn1_bg">
						...
						<tr>
							<!-- Repeat Pattern -->
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button" id="btn_jotpbcancel_t">
								<tr><td class="btn1_left"></td><td class="btn1" name="btn_jotpbcancel" id="btn_jotpbcancel">JO TPB Cancel</td><td class="btn1_right"></td></tr></table></td>
							<td width="30"></td>
