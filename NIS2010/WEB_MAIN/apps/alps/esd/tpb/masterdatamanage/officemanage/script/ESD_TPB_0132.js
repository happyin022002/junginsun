...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_TPB_0132 : ESD_TPB_0132 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_TPB_0132() {
		...
		switch(sheetNo) {
			case 1:	  //IBSheet1 init "H"
				with (sheetObj) {
					...
					InitDataProperty(0			,cnt++		,dtData			,100		,daCenter	,true		,"ofc_cd"				,true		,""			,dfNone		,0			,false		,false			);
					InitDataProperty(0			,cnt++		,dtData			,100		,daCenter	,true		,"n3pty_ofc_cd"			,false		,""			,dfNone		,0			,false		,false			);
					InitDataProperty(0			,cnt++		,dtData	   		,100		,daCenter	,true		,"rhq_cd"				,false		,""			,dfNone		,0			,false		,false			);
					InitDataProperty(0			,cnt++		,dtData	   		,100		,daCenter	,true		,"n3pty_ctrl_ofc_cd"	,false		,""			,dfNone		,0			,false		,false			);
					InitDataProperty(0			,cnt++		,dtData	   		,100		,daCenter	,true		,"n3pty_ar_ofc_cd"		,false		,""			,dfNone		,0			,false		,false			);
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				sheetObj.DoSearch4Post("ESD_TPB_0132GS.do", tpbFrmQryStr(formObj));
				break;
