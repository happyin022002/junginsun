...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_TPB_0121 : ESD_TPB_0121 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_TPB_0121() {
  		...
  		switch(sheetNo) {
  			...
  			case 1:	  //IBSheet1 init
  				with (sheetObj) {
  					...
  					InitDataProperty(0, cnt++, dtData,       60,    daCenter,  true,    "expn_tp_cd",       false,          "",       dfNone,    0,     false,       false);
  					...
  					InitDataProperty(0, cnt++, dtData,      115,    daRight ,  true,    "cnt_b",        false,          "",    dfFloat,    2,     false,       false);
  	...
  	function doActionIBSheet(sheetObj,formObj,sAction) {
  		...
  		switch(sAction) {
  		   case IBSEARCH:	  //조회
  				...
  				sheetObj.DoSearch4Post("ESD_TPB_0121GS.do", tpbFrmQryStr(formObj));
  				break;
  			case IBSAVE:		//저장
