...
* 2009.10.19 Park Sung-Jin 1.2 ALPS Migration 작업
...
<%@ page import="com.hanjin.apps.alps.esd.tpb.statusinquiry.performanceinquiry.event.EsdTpb0119Event"%>
...
<tr><td>
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="281"><!-- <input type="radio" name="s_date_type" value="L" class="trans" checked>Local&nbsp;
						<input type="radio" name="s_date_type" value="G" class="trans">GMT&nbsp; -->
						<input name="s_sdate" type="text" class="input1" style="width:70" value="<%=DateTime.addMonths(currentDay, -1, "yyyy-MM-dd")%>" data_format="ymd" required caption='Date' OnKeyDown="tpb_isNumD(this, 'Y');" onBlur="tpb_validateDateObj(this);">&nbsp;<!-- <img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar1"> -->&nbsp;~&nbsp;<input name="s_edate" type="text" class="input1" style="width:70" value="<%=currentDay%>" data_format="ymd" required caption='Date' OnKeyDown="tpb_isNumD(this, 'Y');" onBlur="tpb_validateDateObj(this);">&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar2"></td>
				...
				<table class="search_in" border="0">
					<tr class="h23">
						...
						<td width="100"><img class="nostar">Control Office</td>
						<td width="267">
	...
	<!-- | -->				</select>
				...
				<table class="search_in" border="0">
				<tr class="h23">
					<td width="25"><input type="radio" class="trans" name="s_exclude_jo" value="X"></td>
					<td width="90">Excluding JO</td>
					<td width="25"><input type="radio" class="trans" name="s_exclude_jo" value="O"></td>
					<td width="60">Only JO</td>
					<td width="25"><input type="radio" class="trans" name="s_exclude_jo" value="A" checked></td>
					<td width="116">All<%-- Added In 2008-05-19 --%></td>
					</td>
					<td width="25"><input type="checkbox" class="trans" name="s_exclude_roc" value="Y" checked></td>
					<td width="340">Excluding ROC</td>
					...
					<!--
					<td><img class="nostar">I/F Type</td>
					<td><%//=JSPUtil.getCodeCombo("s_n3pty_if_tp_cd", "", "style='width:140'", "CD00953", 0, "001: :&lt;&lt;Select&gt;&gt;|")%></td>
					<td><img class="nostar">Expense TP</td>
					<td><%//=JSPUtil.getCodeCombo("s_n3pty_expn_tp_cd", "", "style='width:140'", "CD00578", 0, "001: :&lt;&lt;Select&gt;&gt;|")%></td>
					-->
					</tr>
				</table>
				<!-- : ( Year ) (E) -->
