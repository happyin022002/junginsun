...
<%@ page import="com.hanjin.apps.alps.esd.tpb.statusinquiry.statusinquiry.event.EsdTpb0135Event"%>
		...
		<!-- TABLE '#D' : ( Search Options ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<!-- <td rowspan="3" width="150" valign="top">[Confirmation]</td>-->
					...
					<td width="120"><img class="nostar" id="period_class">Confirmed Month</td>
					<td width="*"><input type="text" name="s_sdate" maxlength="7" style="width:60" value="<%=p_sdate%>" caption="Date" data_format="ym" OnKeyDown="tpb_isNumD(this, 'Y');" onBlur="tpb_validateMonthObj(this);">&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar1">
					&nbsp;~&nbsp;
			...
			<!-- | -->				</select>
				...
				<tr class="h23">
					...
					<td width="60" ><input type="radio" name="s_if_type" value="S" class="trans" checked>TPB</td>
