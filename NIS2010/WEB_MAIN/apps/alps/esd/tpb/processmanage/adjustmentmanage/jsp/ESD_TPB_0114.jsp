...
<%@ page import="com.hanjin.apps.alps.esd.tpb.processmanage.adjustmentmanage.event.EsdTpb0114Event"%>
					...
					<tr class="h23">
						<td>
							...
							<table class="search" border="0" width="100%">
								<tr class="h23">
									<td width="25"><input type="radio" name="c_date_kind_flag" style="border:0" value="R" <%if(!ofc_lvl.equals("H")){%>checked<%}else{%>disabled=true<%} %>></td>
									<td width="120">W/O Request</td>
									<td width="200">
										<select name="s_date_flag_r" style="width:75;">
<!--										<%if(ofc_lvl.equals("R")){ %><option value="AL">W/O-All</option><%} %>-->
									...
									<td width="25"><input type="radio" name="c_date_kind_flag" style="border:0" value="I" <%if(ofc_lvl.equals("H")){%>checked<%} %>></td>
