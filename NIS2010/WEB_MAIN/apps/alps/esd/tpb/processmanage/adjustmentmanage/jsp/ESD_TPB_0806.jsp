...
<%@ page import="com.hanjin.apps.alps.esd.tpb.processmanage.adjustmentmanage.event.EsdTpb0806Event"%>
...
<html>
<head>
<title>Adjustment Approval Review Message</title>
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle"> Review Result</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
								...
								<td class="bg_b1">				
									...
									<table width="100%" id="mainTable">
										<tr>
											<td>
												* Review Result<br>
												<textarea type="text" style="width:98%" rows="5" name="s_ra_rmk" onblur="tpb_chkLenByByte(this,1000,'Reason')"></textarea>
											</td>
										</tr>
									</table>
									<!-- : ( POR ) (E) -->
