...
<%@ page import="com.hanjin.apps.alps.esd.trs.common.refercargodetailinquiry.event.EsdTrs0935Event"%>
...
<html>
<head>
<title>BKG CGO SPE Detail Popup - RF</title>
...
<input  type="hidden" name="tro_seq" value="<%=tro_seq%>">
<input  type="hidden" name="ui_conti_cd" value="<%=ui_conti_cd%>">
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; BKG CGO SPE Detail - RF</td></tr>
		</table>
		<!--향후 사용가능한 조건다는부분입니다.---->
		<!-- : ( Title ) (E) -->
