...
/**
 * @extends Bkg
 * @class ESD_TRS_0936 : 예)Booking 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TRS_0936() {
	...
	switch(sheetNo) {
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++ , dtData,       30,    daCenter,   true,    "grs_wgt_tp_cd",			false,          "",       dfNone,          0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       70,    daRight ,   true,    "net_wgt",		false,          "",       dfFloat,         3,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       30,    daCenter,   true,    "net_wgt_tp_cd",			false,          "",       dfNone,          0,     true,       true);				
				InitDataProperty(0, cnt++ , dtData,       50,    daCenter,   true,    "cmdt_cd",			false,          "",       dfNone,          0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,      100,    daCenter,   true,    "cmdt_nm",			false,          "",       dfNone,          0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ttl_dim_len",		false,          "",       dfInteger,       0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ttl_dim_wdt",		false,          "",       dfInteger,       0,     true,       true);                                                                                
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ttl_dim_hgt",		false,          "",       dfInteger,       0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ovr_fwrd_len",		false,          "",       dfInteger,       0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ovr_bkwd_len",		false,          "",       dfInteger,       0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ovr_hgt",			false,          "",       dfInteger,       0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ovr_lf_len",		false,          "",       dfInteger,       0,     true,       true);                                                                             
				InitDataProperty(0, cnt++ , dtData,       50,    daRight ,   true,    "ovr_rt_len",			false,          "",       dfInteger,       0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,      200,    daCenter,   true,    "stwg_rqst_desc",    false,          "",       dfNone,          0,     true,       true);
				InitDataProperty(0, cnt++ , dtData,       80,    daRight ,   true,    "ovr_void_slt_qty",    false,          "",       dfFloat,         1,     true,       true);
				InitDataProperty(0, cnt++ , dtData,      200,    daCenter,   true,    "diff_rmk",		false,          "",       dfNone,          0,     true,       true);

				RangeBackColor(1, 8, 1, 15) = RgbColor(222, 251, 248);   // ENIS   
				WordWrap = true;
			}
		break;
	}
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	switch(sAction) {
		case IBSEARCH:      //조회
			...
			sheetObj.DoSearch4Post("ESD_TRS_0936GS.do", TrsFrmQryString(formObj));
		break;
