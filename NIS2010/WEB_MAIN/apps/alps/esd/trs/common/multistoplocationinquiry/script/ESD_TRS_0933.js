...
/**
 * @extends Bkg
 * @class ESD_TRS_0933 : 예)Booking 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TRS_0933() {
           ...
           case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++ , dtData,       30,    daCenter,  true,    "trsp_rqst_ord_sub_seq",      false,          "",      dfNone,      0,     false,       false);
                    InitDataProperty(0, cnt++ , dtData,      120,    daCenter,  true,    "dor_arr_dt",      false,          "",      dfNone,      0,     false,       false);
                    InitDataProperty(0, cnt++ , dtData,      80,    daCenter,  true,    "dor_loc_cd",      false,          "",      dfNone,      0,     false,       false);
                    InitDataProperty(0, cnt++ , dtData,      80,    daCenter,  true,    "dor_pst_cd",      false,          "",      dfPostNo,      0,     false,       false);
                    InitDataProperty(0, cnt++ , dtData,     200,    daCenter,  true,    "dor_addr",      false,          "",      dfNone,      0,     false,       false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
           ...
           case IBSEARCH:      //조회
					...
					sheetObj.DoSearch4Post("ESD_TRS_0933GS.do", TrsFrmQryString(formObj));
					//sheet_OnSearchEnd();
                break;

            case IBSAVE:        //저장
              if(validateForm(sheetObj,formObj,sAction))
//                  ComShowMessage (" Apply .. ");
