...
<%@ page import="com.hanjin.apps.alps.esd.trs.workordermanage.predispatchsenthistory.event.EsdTrs0021Event"%>
<%
	SignOnUserAccount account = null; //Session 정보
	EsdTrs0021Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTrs0021Event)request.getAttribute("Event");
...
<html>
<head>
<title>Pre-Dispatch Sent History Inquiry</title>
							...
							<td width="578">
								<table border="0" style="height:25; width:507; background-color: #E9E9E9;">
									<tr><td class="sm" width="291" style="padding-left:15;">
										...
										<td><input name="frm_plandate" type="text" maxlength="8" style="width:75" onFocus="javascript:delHypen(this);" onBlur="javascript:getHypen(this);">&nbsp;~&nbsp;<input name="to_plandate" type="text" maxlength="8" style="width:75" onFocus="javascript:delHypen(this);" onBlur="javascript:getHypen(this);" onKeyup="javascript:doSearchEnter();"><img src="" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar">
										</td>
 ...
 -->							
					...
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td width="280"><input name="bkg_no" type="text" style="width:194;" value=""><img src="" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_multisearch.gif" width="19" height="20" border="0" align="absmiddle" name="btns_multibkg"></td>
				...
				<!-- : ( From Location ) (E) -->
					...
					<table width="100%" class="button">
						...
						<tr>
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" id="btng_senthistory" name="btng_senthistory">Status Inquiry</td><td class="btn2_right"></td></tr></table></td>
...
<form method="post" name="formRd">
	...
	<input type="hidden" name="sep_privew" value="">
</form>
</body>
</html>