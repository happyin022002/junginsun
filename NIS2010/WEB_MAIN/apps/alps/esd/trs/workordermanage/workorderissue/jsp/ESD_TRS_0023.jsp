...
* 2011.02.08   이재위 	1.4 [CHM-201108673-01] [TRS] Work Order Issue(ESD_TRS_0023) : W/O Preview per B/L 기능 개발
...
//    }
    ...
    mlt_mor_ony_flg			= trsCommonBC.searchMltMorOnyFlg(ofc_cd);
    //mlt_mor_ony_flg = "N";

    // S/O 번호로 넘어오는 경우 S/O No. Input 에 입력
    String so_no = "";
    StringBuffer sbSoNo = new StringBuffer();
    if(trsp_so_ofc_cty_cd != null && trsp_so_seq != null && trsp_so_ofc_cty_cd.size() > 0 && trsp_so_ofc_cty_cd.size() == trsp_so_seq.size()) {
    	for(int i=0; i<trsp_so_ofc_cty_cd.size(); i++){
    		if(!sbSoNo.toString().equals("")) sbSoNo.append(",");
    		sbSoNo.append(trsp_so_ofc_cty_cd.get(i));
    		sbSoNo.append(trsp_so_seq.get(i));
    	}
    	so_no = sbSoNo.toString();
    }
%>
<html>
<head>
...
<script language="javascript">
	...
	var cnt_cd = "<%=cnt_cd%>";
	var mlt_mor_ony_flg = "<%=mlt_mor_ony_flg%>";
        ...
        <table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5;">
            <tr><td class="btn1_bg">
                ...
                <tr>
                    ...
                    <td><div id="btnSave" style="display:none"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn1_left"></td><td class="btn1" id="btn_save" name="btn_save">Save</td><td class="btn1_right"></td></tr></table></div></td>
                    ...
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                        <tr><td class="btn1_left"></td><td class="btn1" id="btng_downexcel" name="btng_downexcel">Down Excel</td><td class="btn1_right"></td></tr></table></td>
                ...
                <table class="search_in" border="0">
                        <tr class="h23">
                            ...
                            <td><input type='text' name='combo_svc_provider'  style="width:100;" onChange='getTextVendorSeq(sheetObjects[0], document.form, this.value)' onKeyup='enterCheck(this)'>
                                <input type="text" name='svc_provider' readOnly style="width:382;" class="input2"><img src="/hanjin/img/blank.gif" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name='btng_provider'>
                            </td>
                            <td>VGM&nbsp;</td>
						    <td>
                            	<SELECT name="vgm_flg" style="width:40;" disabled="disbled">
	                            	<OPTION  value=""></OPTION>
                    ...
                    <table class="search_in" border="0">
                        <tr class="h23">
                            <td width="79">Date</td>
                            <td>
                                <table border="0" style="height:15; width:797; background-color: #E9E9E9;">
                                <tr><td class="sm" width="600" style="padding-left:10;">
                        ...
                        <tr class="h23">
                            ...
                            <td>
                                ...
                                <tr><td class="sm" width="170" style="padding-left:10;">
                                    ...
                                    <td width="200">
                                        <input name='fvvd_no' type="text" onBlur='javascript:this.value=this.value.toUpperCase();' onKeyup='enterCheck(this)' style="width:148;" ><img src="/hanjin/img/blank.gif" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_multisearch.gif" width="19" height="20" border="0" align="absmiddle" name='btns_fvvd_no'><img src="/hanjin/img/blank.gif" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name='btns_fvvd_s_no'>
                                    </td>   
                                 </tr>
                                </table>
                            </td>
                            
                            <td width="90">MTY Ref No.</td>
                            <td align="right"><input name='mty_rfrn_no' type="text" onBlur='javascript:this.value=this.value.toUpperCase();' onKeyup='enterCheck(this)'  onBlur='javascript:this.value=this.value.toUpperCase();' style="width:120;" ><img src="/hanjin/img/blank.gif" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_multisearch.gif" width="19" height="20" border="0" align="absmiddle" name='btns_mty_rfrn_no'></td>
                          </tr>
                    </table>
                    <table class="height_1"><tr><td></td></tr></table>
                    <table class="search_in" border="0">
                        <tr class="h23">
                            ...
                            <td align="right">
                                ...
                                <tr><td class="sm" width="205" style="padding-left:13;">
                                    ...
                                    <td align="right">
                                        <input name='eq_no' type="text" onBlur='javascript:this.value=this.value.toUpperCase();' onChange='checkDigit(this)' onKeyup='enterCheck(this)'  style="width:106;"><img src="/hanjin/img/blank.gif" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_multisearch.gif" width="19" height="20" border="0" align="absmiddle" name='btns_eq_no'>
                                    </td></tr>
                                </table>
                    ...
                    <table class="search_in" border="0">
                        <tr class="h23">
							...
							<td class="stm" border =0 style="width: 350px; ">
								<table border="0" style="height:15; width:350px;">
                                	<tr>
                                		<td class="sm" style="width: 350px; padding-left:13">
                                			<input name="radio_contract" type="radio" value="S" class="trans" checked>S/C&nbsp;&nbsp;
						    				<input name="radio_contract" type="radio" value="R" class="trans">RFA &nbsp;&nbsp;&nbsp;
						    				<input name="sc_rfa_cd" type="text" style="width:115;"  value="" maxlength="20" onBlur="setgetUpper(this);" >
						    				<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_contract";>
										</td>
                                	</tr>
                               	</table>
                            </td>                            
        ...
        <tr><td class="bg" height = 330>
                ...
                <table width="100%" class="button">
                    ...
                    <tr>
                        ...
                        <td>
                        <div id="MoreCandidate" style="display:">
                           <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                           <tr><td class="btn2_left"></td><td class="btn2" id="btng_morecandidate" name="btng_morecandidate">Multi More Candidate</td><td class="btn2_right"></td></tr>
                           </table>
                        </div>
                        </td>

                        <td>
                        <div id="MoreCntCandidate" style="display:">
                           <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                           <tr><td class="btn2_left"></td><td class="btn2" id="btng_morecntcandidate" name="btng_morecntcandidate">More CNT Candidate</td><td class="btn2_right"></td></tr>
                           </table>
                        </div>
                        </td>
...
<input type='hidden' name='cust_nomi_trkr_ind_cd'>
<input type='hidden' name='trsp_sp_cng_rsn_cd'>
<input type='hidden' name='trsp_sp_cng_rsn_rmk'>
<input type='hidden' name='vgm_wgt'>
<input type='hidden' name='agmt_mor_cnddt_aply_flg'>
...
<input type='hidden' name='nego_rmk'>
