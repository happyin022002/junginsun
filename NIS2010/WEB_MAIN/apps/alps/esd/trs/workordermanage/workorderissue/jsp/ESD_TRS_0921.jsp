...
<%
	...
	try {
	   ...
	   mlt_mor_ony_flg    = JSPUtil.getNull(StringUtil.xssFilter(request.getParameter("mlt_mor_ony_flg")  		));
...
<script language="javascript">
	...
	<%= JSPUtil.getIBCodeCombo("trsp_sp_cng_rsn_cd", "", "CD03520", 0, optionStr)%>
	
	var mlt_mor_ony_flg = "<%=mlt_mor_ony_flg%>";
	var eq_tp_sz_cd = "<%=eq_tp_sz_cd%>";
...
<body onLoad="setupPage();" onresize="changeSheetRows();">
<form name="form">
...
<input type="hidden" name="mlt_mor_ony_flg"    		value="<%=mlt_mor_ony_flg%>"   		>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; More Candidate</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
     	...
     	<table class="search">
       	<tr><td class="bg">
			...
			<table class="search" border="0">
				<tr class="h23">
					<td width="110">Container TP/SZ</td>
					<td width="72">
					<script language="javascript">ComComboObject('eq_tp_sz_cd', 1, 45, 1)</script>
					</td>
					<td width="80">From Node</td>
					<td width="110">
						<input type="text" style="width:50;" name="fm_loce" value="<%=from_loc%>" align="center">
						<input type="text" style="width:25;" name="fm_yard" value="<%=from_yard%>" align="center"></td>
					<td width="86">Via Node</td>
					<td width="110">
						<input type="text" style="width:50;" name="vai_loce" value="<%=via_loc%>" align="center">
						<input type="text" style="width:25;" name="vai_yard" value="<%=via_yard%>" align="center"></td>
					<td width="90">To Node</td>
					<td width="110">
						<input type="text" style="width:50;" name="to_loce" value="<%=to_loc%>" align="center">
						<input type="text" style="width:25;" name="to_yard" value="<%=to_yard%>" align="center"></td>
					<td width="95">Door Location</td>
					<td><input type="text" style="width:50;" name="dor_loce" value="<%=door_loc%>" align="center">
						<input type="text" style="width:25;" name="dor_yard" value="<%=door_zone%>" align="center"></td>
		    </table>
				<table class="search" border="0">
				<tr class="h23">
					<td width="55">Weight</td>
					<td width="125"><input type="text" style="width:98;" name="cntr_wgt" value="<%=wgt_qty%>" value="" align="right"></td>
					<td width="82">Weight UOM</td>
					<td width="110"><input type="text" style="width:50;" name="cntr_wgt_tp_cd" value="<%=wgt_uom%>" align="center"></td>
					<td width="86">Distance(Km)</td>
					<td width="110"><input type="text" style="width:79;" name="distance_km" value="<%=dist_km%>" align="right"></td>
					<td width="90">Distance(Mile)</td>
					<td width="110"><input type="text" style="width:50;align=right"  name="distance_mile" value="<%=dist_mile%>" align="right"></td>
					<td width="70">Way Type</td>
					<td><script language="javascript">ComComboObject('way_tp_cd', 1, 107, 1)</script></td>
				</tr>
				</table>
				...
				<tr class="h23">
					...
					<td width="90"><input type="text" style="width:63;" name=fm_cgo_tp_cd value="<%=cgo_tp_cd%>" value="" align="right"></td>
					<td width="82">Bound</td>
					<td width="110"><input type="text" style="width:50;" name="fm_bound_cd" value="<%=bound_cd%>" align="center"></td>
					<td width="86">Trans Mode</td>
					<td width="110"><input type="text" style="width:79;" name="fm_crr_mod_cd" value="<%=crr_mod_cd%>" align="right"></td>
					<td width="90">Cost Mode</td>
					<td><input type="text" style="width:50;align=right"  name="fm_cost_mod_cd" value="<%=cost_mod_cd%>" align="right"></td></tr>
				</table>
