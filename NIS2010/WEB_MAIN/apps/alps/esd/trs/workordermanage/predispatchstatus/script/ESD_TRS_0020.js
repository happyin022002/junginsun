...
/**
 * @extends Bkg
 * @class ESD_TRS_0020 : Booking ??? ?? ???? ???? ?? ????? ????.
 */
function ESD_TRS_0020() {
...
//				var HeadTitle = " |STS|Seq.|Reference No.|W/O No.|Vendor|Vendor|BKG No.|BKG No.|B/L No.|CNTR No.|TP/SZ|W/O ISS DT|DDL Sent Time|CAN Sent Time|F|FDate|O|O Date|C|C Date|Pickup NO|PU Yard|Available DT|Last Free DT|PU No CRE DT|" ;
				...
				InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "trsp_wo_no", false, "", dfNone,0, false, false);
				...
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "wo_iss_dt", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "dly_dis_snt_dt", false, "", dfNone, 0, false, false);

				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "trsp_cntr_aval_snt_dt", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "frt_flag", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "frt_date", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "org_flag", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "org_date", false, "", dfNone, 0, false, false);
				
				InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "bil_flag", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "bil_date", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 100,daCenter, false, "pickup_no", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 100,daCenter, false, "pu_yard", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "available_dt", false, "", dfNone, 0, false, false);
				
				InitDataProperty(0, cnt++, dtData, 120,daCenter, false, "last_free_dt", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, false, "pu_no_cre_dt", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 70, daCenter, false, "trsp_so_ofc_cty_cd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 70, daCenter, false, "trsp_so_seq", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 70, daCenter, false, "trsp_wo_ofc_cty_cd", false, "", dfNone, 0, false, false);
				
				InitDataProperty(0, cnt++, dtHidden, 70, daCenter, false, "trsp_wo_seq", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 70, daCenter, false, "sep_lopic", false, "", dfNone, 0, false, false);
...
//	document.formRd.ddl.value = sheetObj.CellValue(Row, "dly_dis_snt_dt");
//	document.formRd.can.value = sheetObj.CellValue(Row, "trsp_cntr_aval_snt_dt");
...
function validateFormSearch(formObj) {
	...
	if( lvToDate != "" ) { //날짜 체크하는 부분
		if( !ComIsDate(lvToDate) ) {
			ComShowCodeMessage("TRS90070");
	...
	switch(sAction) {
		case IBSEARCH:      //조회
			if( obj == "01" ) { // btn_retrieve
				...
				sheetObj.DoSearch4Post("ESD_TRS_0020GS.do", TrsFrmQryString(formObj));
...
//			} else if( obj == "03" && lvParam.length > 2 ) {
				...
				sheetObj.DoSearch4Post("ESD_TRS_0020GS.do", lvParam+"&"+TrsFrmQryString(formObj));
