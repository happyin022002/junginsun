 ...
 * 2011.03.02 민정호 1.2 [CHM-201109066] [TRS] AGMT verify rule 항목 추가요청 
 * 2011.06.24 황효근 1.3 [CHM-201111442] [TRS] R9 CNTR 추가관련 로직 변경요청
...
function initSheet(sheetObj, sheetNo) {
  ...
  with (sheetObj) {
	  ...
	  InitDataProperty(0, cnt++ , dtCombo,      50,  daCenter, true,"cust_nomi_trkr_ind_cd", false, "",  dfNone,       0,      true,   true,    2,   false,   false,     "",    false);
	  ...
	  InitDataProperty(0, cnt++ , dtCombo,      75,  daCenter, true,  "trsp_dist_tp_cd",  false,    "",  dfNone,       0,      true,   true,    2,   false,  false,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       60,  daRight,  true,   "trsp_agmt_dist",  false,    "",  dfNone,       0,      true,   true,    2,   false,  false,     "",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter, true,  "dist_meas_ut_cd",  false,    "",  dfNone,       0,      true,   true,    2,   false,  false,     "",    false);
	  ...
	  InitDataProperty(0, cnt++ , dtCheckBox,   25,  daCenter, true,            "eq_p2",  false,    "",  dfNone,       0,      true,   true,    2,   false,  false,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   25,  daCenter, true,            "eq_p4",  false,    "",  dfNone,       0,      true,   true,    2,   false,  false,     "",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      62,  daCenter, true,  "wtr_rcv_term_cd",  false,    "",  dfNone,       0,      true,   true,    1,   false,  false,     "Receving-I:FIO, T:Trackle Term, Y:CY Term, V:VD Term",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      60,  daCenter, true,   "wtr_de_term_cd",  false,    "",  dfNone,       0,      true,   true,    1,   false,  false,     "Delivery-O:FIO, T:Trackle Term, Y:CY Term, V:VD Term",    false);
	  InitDataProperty(0, cnt++ , dtData,       70,  daCenter, true,"trsp_agmt_bdl_qty",  false,    "",  dfNullInteger,0,      true,   true,    3,   false,  false,     "Input number of bundled Container (Cargo Type:Empty, Eq Type:F,A,P)",   false);
	  ...
	  InitDataProperty(0, cnt++ , dtCombo,      50,  daCenter, true,   "wgt_meas_ut_cd",  false,    "",  dfNone,       0,      true,   true,    3,   false,  false,     "Unit of measure for weight",    false);
	  ...
	  InitDataProperty(0, cnt++ , dtData,     	90,  daCenter, true,    "agmt_apro_dt",  false,    "",  dfDateYmd,    0,      true,   true,    8,   false,  false,     "",    false);
  ...
  with (sheetObj) {
	  ...
	  Editable = true; //전체Edit 허용 여부 [선택, Default false]
	  InitRowInfo( 2, 1, 9, 100); //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	  InitColumnInfo(54, 4, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
	  ...
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,              "chk",  false,    "", dfNone,       0,      true,   true );
	  InitDataProperty(0, cnt++ , dtStatus,     45,  daCenter,  true,           "ibflag",  false,    "", dfNone,       0,      true,   true,    0,   false,   false,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,      170,  daLeft,    true,              "rlt",  false,    "", dfNone,       0,      true,   true,  200,   false,   false,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       70,  daLeft,    true,             "rlt2",  false,    "", dfNone,       0,      true,   true,  200,   false,   false,     "",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter,  true, "trsp_cost_mod_cd",  false,    "", dfNone,       0,      true,   true,    2,   false,   false,     "Cost Mode-CY, Door, Bare CHZ(Stack), Bare CHZ(Flatbed), Empty Flatrack, Matchmaking(I)",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter,  true,  "agmt_trsp_tp_cd",  false,    "", dfNone,       0,      true,   true,    2,   false,   false,     "Transporation Mode-(Single Direct)TD,WD,RD  (Combine)RT,TR,WT,TW,RW,WR ",   false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter,  true,        "cgo_tp_cd",  false,    "", dfNone,       0,      true,   true,    2,   false,   false,     "Cargo Type-F:Full, E:Empty",    false);
	  InitDataProperty(0, cnt++ , dtData,       70,  daCenter,  true,          "cust_cd",  false,    "", dfEngUpKey,   0,      true,   true,    8,   false,   false,     "Customer Code for this agreement",    false);
	  ...
	  InitDataProperty(0, cnt++ , dtCombo,      62,  daCenter,  true,  "wtr_rcv_term_cd",  false,    "", dfNone,       0,      true,   true,    1,   false,   false,     "Receving-I:FIO, T:Trackle Term, Y:CY Term, V:VD Term",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      60,  daCenter,  true,   "wtr_de_term_cd",  false,    "", dfNone,       0,      true,   true,    1,   false,   false,     "Delivery-O:FIO, T:Trackle Term, Y:CY Term, V:VD Term",    false);
	  InitDataProperty(0, cnt++ , dtData,       60,  daCenter,  true,"trsp_agmt_bdl_qty",  false,    "", dfNullInteger,0,      true,   true,    3,   false,   false,     "Input number of bundled chassis",   false);
	  InitDataProperty(0, cnt++ , dtHidden,     60,  daRight,   true,           "to_wgt",  false,    "", dfNone,       0,      true,   true,    9,   false,   false,     "The final value of weight tier should be 'Max'",    false);
	  InitDataProperty(0, cnt++ , dtHidden,     50,  daCenter,  true,   "wgt_meas_ut_cd",  false,    "", dfNone,       0,      true,   true,    3,   false,   false,     "Unit of measure for weight",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      60,  daCenter,  true,"trsp_rvs_aply_flg",  false,    "", dfNone,       0,      true,   true,    8,   false,   false,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       75,  daCenter,  true,        "eff_fm_dt",  false,    "", dfDateYmd,    0,      true,   true,    8,   false,   false,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       75,  daCenter,  true,        "eff_to_dt",  false,    "", dfDateYmd,    0,      true,   true,    8,   false,   false,     "",    false);
      InitDataProperty(0, cnt++ , dtDataSeq,    50,  daCenter,  true,         "ui_seqno",  false,    "", dfNone,       0,      true,   true,    8,   false,   false,     "",    false);
...
//	  InitDataCombo(0, 'wgt_meas_ut_cd', " |KGS|LBS", " |KGS|LBS");
  ...
  with (sheetObj) {
	  ...
	  Editable = true; //전체Edit 허용 여부 [선택, Default false]
	  InitRowInfo( 2, 1, 9, 100); //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	  InitColumnInfo(37, 4, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
...
//    	    }
    		...
    		var eff_to_dt = doSepRemove(doSepRemove(formObj.fm_eff_to_dt.value, " "), "-");
   		    sheetObj.CellValue2(row,"eff_fm_dt") = eff_fm_dt;
	        sheetObj.CellValue2(row,"eff_to_dt") = eff_to_dt;
...
function Minimize(nItem) {
	...
	if( nItem == "1" ) {
		...
		sheetObjects[3].style.height = sheetObjects[3].GetSheetHeight(17);
	} else {
		objs.style.display = "inline";
		sheetObjects[2].style.height = sheetObjects[2].GetSheetHeight(11);
		sheetObjects[3].style.height = sheetObjects[3].GetSheetHeight(11);
	}
}
...
function openAgmtHdrPopup() {
	var formObject = document.form;
	var Option = "width=734,height=290,menubar=0,status=0,scrollbars=0,resizable=0";
	var agmt_no = formObject.fm_agmtno.value;  
	var param ="?agmt_no="+agmt_no;
	window.open('/hanjin/ESD_TRS_0220.do' + param, "popupAgmtHdr", Option);
}
...
function openAgmtScgPopup() {
	...
	var formObject = document.form;
	var Option = "width=1024,height=700,menubar=0,status=0,scrollbars=0,resizable=0";
	var agmt_no = formObject.fm_agmtno.value;  
	...
	window.open('/hanjin/ESD_TRS_0222.do' + param, "popupScg", Option);
}
