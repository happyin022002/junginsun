...
* 2011.06.29 민정호 [CHM-201111442] R9 CNTR 추가관련 로직 변경요청
* 2011.10.18 최종혁  [] [TRS] 조회조건 오타정정
...
<%
	...
	Exception         serverException   = null;     //서버에서 발생한 에러
  	...
  	String vndrNm 		= "";
  	String loclCreDt 	= "";
  	String effective_agmt	= "C";
  	
  	try {
  		fmLoc			= JSPUtil.getNull(request.getParameter("from"));
  		viaLoc			= JSPUtil.getNull(request.getParameter("via"));
  		doorLoc			= JSPUtil.getNull(request.getParameter("door"));
  		toLoc			= JSPUtil.getNull(request.getParameter("to"));
  		vndrSeq			= JSPUtil.getNull(request.getParameter("vndr_seq"));
  		vndrNm			= JSPUtil.getNull(request.getParameter("vndr_nm"));
  		/** Only EAS Start */
  		loclCreDt  	    = JSPUtil.getNull(request.getParameter("locl_cre_dt"));
  		effective_agmt  = JSPUtil.getNull(request.getParameter("effective_agmt"));
  		/** Only EAS End */	
...
<script language="javascript">
  function setupPage(){
    ...
    loadInitialCombo();
    /** Only EAS Start */
    var effective_agmt = "<%=effective_agmt%>";
    if(effective_agmt !=""){
	    document.form.fm_effective_agmt.value = "A";
    	effective_agmt_change();
    }
    /** Only EAS End */
  }
</script>
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:940px;"> 
              <tr class="h23">
                ...
                <td width="70">
                  <input type="text" name = "search_fm_loc" style="width:70;" class="input1" onFocus='fun_Focus(this)' onChange="getComboList(this, document.search_fm_yard, 'F');" onBlur="" maxlength="5" value="<%=fmLoc%>">
                </td>
                <td width="81">
                  <script language="javascript">ComComboObject('search_fm_yard', 1, 60, 0)</script><img src="/hanjin/img/blank.gif" width="2" height="2" border="0" align="absmiddle"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_frmnode">
                </td>
                <td width="92" align="right">Via</td>
                <td width="60">
                  <input type="text" name = "search_via_loc" style="width:60;" class="input1" onFocus='fun_Focus(this)' onChange="getComboList(this, document.form.search_via_yard, 'V');" onBlur="" maxlength="5" value="<%=viaLoc%>">
                </td>
                <td width="81">
                  <script language="javascript">ComComboObject('search_via_yard', 1, 60, 0)</script><img src="/hanjin/img/blank.gif" width="2" height="2" border="0" align="absmiddle"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"  name="btns_vianode">
                </td>
                <td width="100" align="right">Door</td>
                <td width="60">
                  <input type="text" name = "search_door_loc" style="width:60;" class="input1" onFocus='fun_Focus(this)' onChange="getComboList(this, document.form.search_door_yard, 'D');"  onBlur="" maxlength="5" value="<%=doorLoc%>">
                </td>
                <td width="81">
                  <script language="javascript">ComComboObject('search_door_yard', 1, 60, 0)</script><img src="/hanjin/img/blank.gif" width="2" height="2" border="0" align="absmiddle"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"  name="btns_dornode">
                </td>
                <td width="48" align="right">To</td>
                <td width="60">
                  <input type="text" name = "search_to_loc" style="width:60;" class="input1" onFocus='fun_Focus(this)' onChange="getComboList(this, document.form.search_to_yard, 'T');"  onBlur="" maxlength="5" value="<%=toLoc%>">
                </td>
                <td width="81"> 
                  <script language="javascript">ComComboObject('search_to_yard', 1, 60, 0)</script><img src="/hanjin/img/blank.gif" width="2" height="2" border="0" align="absmiddle"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"  name="btns_tonode">
                </td>
              </tr>             
              <tr class="h23">
                ...
                <td width="230" colspan="5">
                  <input name="fm_vndr_prmry_seq" type="text" style="width:80;" class="input" value="<%=vndrSeq%>" onBlur="vender_blur();">
                  <input name="fm_vndr_prmry_nm" type="text" style="width:117;" class="input" value="<%=vndrNm%>" readonly>
              ...
              <tr class="h23">
               ...
               <td width="92" align="right">Approval date</td>
                <td width="130" colspan="2">        	
              	<input type="text" name="approval_date" style="width:75">
