...
<%
	...
	selTrspScgCd	= JSPUtil.getCodeCombo("fm_trsp_scg_cd", "01"	,"style='width:98;'", "CD00917", 0, optionStr);
...
<html>
<head>
<title>Agreement Surcharge Rate History Inquiry</title>
  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"> Agreement Surcharge Rate History Inquiry</td></tr>
      </table>
      <!-- TABLE (E) -->
                ...
                <td width="" valign="top">
                  <table class="search" border="0" style="width:100%;">
                    ...
                    <tr class="h23">
                      ...
                      <td colspan="2">CMDT Group Code</td>
                    ...
                    <tr class="h23">
                      ...
                      <td>
                        ...
                        <script language="javascript">ComComboObject('fm_fm_nod_yd', 1, 44, 0)</script><img src="" width="4" height="1" border="0">
                      </td>
                      <td colspan="2">Via</td>
                      <td>
                        ...
                        <script language="javascript">ComComboObject('fm_via_nod_yd', 1, 44, 0);</script><img src="" width="4" height="1" border="0">
                      </td>
                      ...
                      <td>       
                        ...
                        <script language="javascript">ComComboObject('fm_dor_nod_yd', 1, 44, 0)</script><img src="" width="4" height="1" border="0">
                      </td>
                      <td colspan="2">To</td>
                      <td>
                        ...
                        <script language="javascript">ComComboObject('fm_to_nod_yd', 1, 44, 0);</script><img src="" width="4" height="1" border="0">
                      </td>
                    </tr>
                    <tr class="h23">
                      <td colspan="2">Route All</td>
                      <td>
                        <input name="fm_agmt_route_all_flg" class="trans" type="checkbox" >
                      </td>  
                      <td colspan="2">Surcharge</td>
                      <td>
<SELECT name = "fm_trsp_scg_cd" style='width:98;'>
<OPTION  value=""></OPTION>	
...
<OPTION  value="VAT"> VAT</OPTION>
                      ...
                      <td colspan="2">EQ</td>
                      <td colspan="3">
                        <select style="width:88;" class="input" name="fm_eq_knd_cd" >
                          <option value=""></option>
                          <option value="U">Container</option>
                          <option value="Z">Chassis</option>
                          <option value="G">Genset</option>
                        </select>
					    <script language="javascript">ComComboObject('combo1', 1, 140, 1)</script>
					    <input type="hidden" name="fm_eqtpsz" value="">    
                      </td>
                      <td>Delete&nbsp;<select name="delete_yn" style="width:52;">
