...
<%
	...
	trsp_agmt_rt_tp_cd = ((request.getParameter("trsp_agmt_rt_tp_cd")==null )?"":request.getParameter("trsp_agmt_rt_tp_cd"));
	try {
...
<html>
<head>
<title>Agreement Surcharge Rate Creation</title>
  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        ...
        <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"> Agreement Surcharge Rate Creation</td></tr>
      </table>
      <!-- TABLE (E) -->
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:510;"> 
              <tr class="h23">
                ...
                <td width="130"><input name="fm_agmtno" type="text" style="width:80;" class="input" value="<%=agmt_no%>" readonly></td>
                <td width="110">Agreement Type</td>
                <td width="130">
                  <select name="fm_trsp_agmt_rt_tp_cd" style="width:80;">
