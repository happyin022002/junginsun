...
* 2011.05.11 민정호   1.5 [CHM-201110223] USER 에 의한 AGMT HISTORY 관리를 위한 기능 추가요청
* 2011.06.24 황효근   1.6 [CHM-201111442] [TRS] R9 CNTR 추가관련 로직 변경요청
...
//	  InitDataCombo(0, 'trsp_scg_cd', trsp_scg_cdCode,	trsp_scg_cdCode);
  ...
  with (sheetObj) {
	  ...
	  Editable = true; //전체Edit 허용 여부 [선택, Default false]
	  InitRowInfo( 2, 1, 9, 100); //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	  InitColumnInfo(51, 4, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]

	  // 해더에서 처리할 수 있는 각종 기능을 설정한다
	  InitHeadMode(true, true, true, true, false,false)
	  var HeadTitle1 = "|Chassis Verification Result|Chassis Verification Result|Duplication|Surcharge|Rate Type|Rate Type|Rate Type|Rate Type|Rate Type|Rate Type|Effective Date|Effective Date|All Route|From|From|Via|Via|Door|Door|To|To|Fixed\nRatio Div|Currency|One Way|Round Trip|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|EQ Type/Size|Weight\nTier|UOM|SeqNo|CK|EQ" ;
	  ...
	  InitDataProperty(0, cnt++ , dtData,       70,   daRight,  true,      "trsp_rnd_rt",  false,    "",  dfNullFloat,     2,      true,    true,    15,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,          "eq_alal",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,          "eq_sfal",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,          "eq_slal",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,          "eq_taal",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,          "eq_gnal",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,          "eq_egal",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,           "eq_al2",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,           "eq_al4",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,           "eq_al5",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter,  true,           "eq_al8",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_sf2",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_sf4",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_sl2",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_ta2",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_gn4",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_gn5",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_eg5",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_eg8",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_zt4",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter,  true,           "eq_cb4",  false,    "",  dfNone,     0,      true,    true,     2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       60,   daRight,  true,           "to_wgt",  false,    "",  dfNone,     0,      false,   true,     9,   false,   true,     "The final value of weight tier should be 'Max'",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      80,  daCenter,  true,   "wgt_meas_ut_cd",  false,    "",  dfNone,     0,      false,   true,     3,   false,   true,     "Unit of measure for weight",    false);
	  InitDataProperty(0, cnt++ , dtDataSeq,        50,  daCenter,  true,         "ui_seqno",  false,    "",  dfNone,     0,      true,    true,     8,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   60,  daCenter,  true,            "ck_vf",  false,    "",  dfNone,     0,      true,    true,     8,   false,   true,     "",    false);
	  ...
	  InitDataCombo(0, 'agmt_rout_all_flg', " |Y|N", " |Y|N");
//	  InitDataCombo(0, 'trsp_scg_cd', trsp_scg_cdCode,	trsp_scg_cdCode);
	  InitDataCombo(0, 'trsp_scg_cd', "FUA|FUE|VAT", "FUA|FUE|VAT");
	  InitDataCombo(0, 'wgt_meas_ut_cd', " |KGS|LBS", " |KGS|LBS");
	  InitDataCombo(0, 'agmt_scg_rt_div_cd', " |Fixed|Ratio", " |F|R");
      document.form.header_row.value = HeaderRows-1;
	  sheetObj.ColHidden("ui_seqno") = true;
  ...
  with (sheetObj) {
	  ...
	  Editable = true; //전체Edit 허용 여부 [선택, Default false]
	  InitRowInfo( 2, 1, 9, 100); //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
	  InitColumnInfo(34, 4, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
	  ...
	  InitDataProperty(0, cnt++ , dtData,      170,  daLeft,   true,              "rlt",  false,    "",  dfNone,     0,      false,  false, 200,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       70,  daLeft,   true,             "rlt2",  false,    "",  dfNone,     0,      false,  false, 200,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      80,  daCenter, true,      "trsp_scg_cd",  false,    "",  dfNone,     0,      true,   true,    2,   false,   true,     "Cost Mode-CY, Door, Bare CHZ(Stack), Bare CHZ(Flatbed), Empty Flatrack, Matchmaking(I)",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter, true, "trsp_cost_mod_cd",  false,    "",  dfNone,     0,      false,  true,    2,   false,   true,     "Cost Mode-CY, Door, Bare CHZ(Stack), Bare CHZ(Flatbed), Empty Flatrack, Matchmaking(I)",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter, true,  "agmt_trsp_tp_cd",  false,    "",  dfNone,     0,      false,  true,    2,   false,   true,     "Transporation Mode-(Single Direct)TD,WD,RD  (Combine)RT,TR,WT,TW,RW,WR ",   false);
	  InitDataProperty(0, cnt++ , dtCombo,      40,  daCenter, true,        "cgo_tp_cd",  false,    "",  dfNone,     0,      false,  true,    2,   false,   true,     "Cargo Type-F:Full, E:Empty",    false);
	  InitDataProperty(0, cnt++ , dtData,       70,  daCenter, true,          "cust_cd",  false,    "",  dfEngUpKey, 0,      true,   true,    8,   false,   true,     "Customer Code for this agreement",    false);
	  InitDataProperty(0, cnt++ , dtData,       80,  daCenter, true,      "cmdt_grp_cd",  false,    "",  dfEngUpKey, 0,      false,  true,    6,   false,   true,     "Commodity Group that this rate is being applied",   false);
	  InitDataProperty(0, cnt++ , dtCombo,      90,  daCenter, true,   "rail_svc_tp_cd",  false,    "",  dfNone,     0,      false,  true,   50,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       75,  daCenter, true,        "eff_fm_dt",  false,    "",  dfDateYmd,  0,      true,   true,    8,   false,   true,     "Effective period of this rate",   false);
	  InitDataProperty(0, cnt++ , dtData,       75,  daCenter, true,        "eff_to_dt",  false,    "",  dfDateYmd,  0,      true,   true,    8,   false,   true,     "Effective period of this rate",   false);
	  ...
	  InitDataProperty(0, cnt++ , dtData,       70,   daRight, true,      "trsp_rnd_rt",  false,    "",  dfNullFloat,     2,      true,   true,   15,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   35,  daCenter, true,          "eq_alal",  false,    "",  dfNone,     0,      true,   true,    2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter, true,            "eq_cg",  false,    "",  dfNone,     0,      true,   true,    2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   30,  daCenter, true,            "eq_ug",  false,    "",  dfNone,     0,      true,   true,    2,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtData,       60,   daRight, true,           "to_wgt",  false,    "",  dfNone,     0,      false,  true,    9,   false,   true,     "The final value of weight tier should be 'Max'",    false);
	  InitDataProperty(0, cnt++ , dtCombo,      80,  daCenter, true,   "wgt_meas_ut_cd",  false,    "",  dfNone,     0,      false,  true,    3,   false,   true,     "Unit of measure for weight",    false);
	  InitDataProperty(0, cnt++ , dtDataSeq,        50,  daCenter, true,         "ui_seqno",  false,    "",  dfNone,     0,      true,   true,    8,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtCheckBox,   60,  daCenter, true,            "ck_vf",  false,    "",  dfNone,     0,      true,   true,    8,   false,   true,     "",    false);
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	case IBDELETE:
		if( sheetObj.CheckedRows("chk") < 1 ) {
			...
			sheetObj.DoSave("ESD_TRS_0221GS.do", TrsFrmQryString(formObj), "chk", false, true);
		}
	    break;
	case IBLOADEXCEL:
  ...
  function Minimize(nItem) {
	var objs = document.all.item("MiniLayer");
  	if( nItem == "1" ) {
  		...
  		sheetObjects[2].style.height = sheetObjects[2].GetSheetHeight(25);
  		sheetObjects[3].style.height = sheetObjects[3].GetSheetHeight(25);
  		sheetObjects[4].style.height = sheetObjects[4].GetSheetHeight(25);
  	} else {
