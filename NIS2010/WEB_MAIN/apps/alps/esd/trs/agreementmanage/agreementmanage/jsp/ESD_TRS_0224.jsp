                ...
                <td>
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                    <tr>
                      ...
                      <td class="btn1" id="btn_contract_link" name="btn_contract_link">Contract Link</td>
          ...
          <td class="bg">
            ...
            <table class="search" border="0" style="width:979;"> 
              ...
              <tr class="h23">
                ...
                <td width="60">
                  <select name="fm_cfm_flg" style="width:55;" class="input">
              ...
              <tr class="h23">
                ...
                <td width="60">
                  <select name="fm_link_flg" style="width:55;" class="input">
                    <option value="" selected>ALL</option>
                    <option value="Y">Y</option>
                    <option value="N">N</option>
                  </select>
                    ...
                    <tr>
                      ...
                      <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                          <tr>
                            ...
                            <td class="btn2" id="btng_ratecorrection" name="btng_ratecorrection">Rate Correction</td>
                      ...
                      <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                          <tr>
                            <td class="btn2_left"></td>
                            <td class="btn2" id="btng_surchargecorrection" name="btng_surchargecorrection">Surcharge Correction</td>
                            <td class="btn2_right"></td>
                          </tr>
                        </table>
                      </td>
                      <td id="btng_confirm_td">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                          <tr>
                            <td class="btn2_left"></td>
                            <td class="btn2" id="btng_confirm" name="btng_confirm">Confirm</td>
                            <td class="btn2_right"></td>
                          </tr>
                        </table>
                      </td>
