...
//	  style.height    = 325; // 높이 설정(버튼이 없을 경우)
	  ...
	  InitColumnInfo(34, 7, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]	  

	  // 해더에서 처리할 수 있는 각종 기능을 설정한다
	  InitHeadMode(true, true, true, true, false,false)
	  var HeadTitle1 = "Seq|Equipment|No of\nChassis|Weight\nTier|UOM|Delete\nY/N|Rank\n(ASC)|Effective Date|Effective Date|Currency|Rate|Rate|Feeder Term|Feeder Term|Reverse|Route|Route|Route|Route|Fixed or Per\nDistance|To Distance|To Distance|AGMT Approval\nDate|Update\nDate|Update\nUser|Confimr\n(Manager Level)|Confirm\nUser||" ;
	  var HeadTitle2 = "Seq|Equipment|No of\nChassis|Weight\nTier|UOM|Delete\nY/N|Rank\n(ASC)|From|To|Currency|One Way|Round Trip|Receiving|Delivery|Reverse|From|Via|Door|To|Fixed or Per\nDistance|Distance|Unit|AGMT Approval\nDate|Update\nDate|Update\nUser|Confimr\n(Manager Level)|Confirm\nUser||" ;
	  ...
	  InitDataProperty(0, cnt++ , dtData,       60,  daCenter,  true,"trsp_agmt_bdl_qty", false,    "",  dfNullInteger,0,    false,   false,    3,   false,   true,     "Input number of bundled chassis",   false);
	  ...
	  InitDataProperty(0, cnt++ , dtCombo,      50,  daCenter,  true,        "delt_flg",  false,	"",	 dfNone,	 0,		 true,	  true,	  3,   false, 	true);		// 추가-민정호	  
      ...
      InitDataProperty(0, cnt++ , dtCombo,      70,  daCenter,  true, "wtr_rcv_term_cd",  false,    "",  dfNone,     0,      false,   false,    1,   false,   true,     "Receving-I:FIO, T:Trackle Term, Y:CY Term, V:VD Term",    false);
      InitDataProperty(0, cnt++ , dtCombo,      70,  daCenter,  true,  "wtr_de_term_cd",  false,    "",  dfNone,     0,      false,   false,    1,   false,   true,     "Delivery-O:FIO, T:Trackle Term, Y:CY Term, V:VD Term",    false);
      InitDataProperty(0, cnt++ , dtData,       60,  daCenter,  true,"trsp_rnd_aply_flg", false,    "",  dfNone,     0,      false,   false,    8,   false,   true,     "",    false);
      ...
      InitDataProperty(0, cnt++ , dtData,      100,  daCenter,  true,    "agmt_apro_dt",  false,    "",  dfNone,  0,        false,  false,  10,   false,   true,  "", false);
	  ...
	  InitDataProperty(0, cnt++ , dtHidden,    100,  daCenter,  true,         "cfm_flg",  false,    "",  dfDateYmd,  0,      false,  false,    8,   false,   true,     "",    false);
	  InitDataProperty(0, cnt++ , dtHidden,     80,  daLeft,  true,        "cfm_usr_nm",  false,    "",  dfDateYmd,  0,      false,  false,    8,   false,   true,     "",    false);	  
	  ...
	  InitDataProperty(0, cnt++ , dtHidden,     80,  daCenter, true,   "trsp_agmt_nod_seq",  		false,    "",  dfNone,     0,     false,  false,  10,   false,   true,  "", false);
	  InitDataProperty(0, cnt++ , dtHidden,     80,  daCenter, true,   "trsp_agmt_rt_seq",  		false,    "",  dfNone,     0,     false,  false,  10,   false,   true,  "", false);
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	case IBSEARCH:
		...
		sheetObj.DoSearch4Post("ESD_TRS_0227GS.do", TrsFrmQryString(formObj));
		break;
	...
	case IBSAVE:        //저장
		...
		sheetObj.DoSave("ESD_TRS_0227GS.do", TrsFrmQryString(formObj), 'ibflag', false);
		break;	
	}
}
