...
<%@ page import="com.hanjin.apps.alps.esd.trs.invoicemanage.csrissuetranferslip.event.EsdTrs0036Event"%>
<%
...
<html>
<head>
<title>Transportation Invoice CSR Creation - Preview</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; Transportation Invoice CSR Preview</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
