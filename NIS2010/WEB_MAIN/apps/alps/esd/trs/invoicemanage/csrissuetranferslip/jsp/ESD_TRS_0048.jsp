...
<%@ page import="com.hanjin.apps.alps.esd.trs.invoicemanage.csrissuetranferslip.event.EsdTrs0048Event"%>
<%
	EsdTrs0048Event  event 		= null;			//PDTO(Data Transfer Object including Parameters)
...
<input type="hidden" name="selrow" value ="<%=selrow%>">
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; Rejected CSR Cancellation</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			...
			<tr><td class="bg">
					...
					<table class="search" border="0">
						<tr class="h23">
							...
							<td><input name="vndr_no" type="text" style="width:75;" value="">&nbsp;<input name="vndr_nm" type="text" style="width:222;" value=""></td>
						</tr>
					</table>
					<table class="search" border="0">
						<tr class="h23">
