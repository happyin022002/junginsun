...
* 1.0 최초 생성
* 1.9 2011.02.18 손은주 [CHM-201108834-01][TRS] Rail performance Report 부분의 주 단위 data 조회기능 추가 요청
* 1.11 2011.05.27 김종호 [CHM-201110817] [TRS] US Rail report 기능 보완 / 추가 요청
* 1.12 2011.06.10 김종호 [CHM-201110817] [TRS] US Rail report 기능 보완 / 추가 요청
...
<%@ page import="com.hanjin.apps.alps.esd.trs.report.usarailperformance.event.EsdTrs0102Event"%>

<%
	EsdTrs0102Event  event = null;				    //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTrs0102Event)request.getAttribute("Event");
					...
					<tr>
						<td class="bg">
							...
							<table class="search_in" border="0">
								<tr class="h23">
									<td width="80">Date</td>
									<td width="250"><select name="date_type" style="width:230;">
							...
							<table class="search_in" border="0" width="910">
								<tr class="h23">
									<td width="75">Lane / VVD </td>
									<td width="20" align="left"><input type="checkbox" name="vvd_dip" value="" class="trans" checked></td>
									<td width="10"></td>
									<td width="90">Rail Company</td>
									<td width="60"><script language="javascript">ComComboObject('rail_road_code',2, 70 , 1 )</script> </td>
									...
									<td width="130"><select name="status" style="width:120;" onchange="checkFullEmptyOption(this)";>
									...
									<td width="75"><select name="io_bound" style="width:55;" disabled>
										<option value="A" selected>ALL</option>
										<option value="I">IN</option>
										<option value="O">OUT</option>
										</select></td>
										<td width="20" align="left"><input type="checkbox" name="agmt_chk" value="" class="trans" onclick="checkAgmtRefNoOption();"></td>
										<td width="100">Agmt. Ref. No.</td>
									<td><input name="agmt_ref_no" type="text" style="width:87px;" disabled></td>
								</tr>
							</table>
							...
							<table class="search_in" border="0" width="910">
								<tr class="h23">
									...
									<td width="140">
										<select name="comp_cd" style="width:110;" >
											<option value="A" selected>ALL</option>
											<option value="H">SML</option>
											<option value="S">SEN</option>
											<option value="T">HJL(Domestic)</option>
											<option value="I">Invoice Only</option>
										</select>
									</td>
									<td width="62">Route</td>
									...
									<td width="93"><script language="javascript">ComComboObject('to_yard', 1, 47, 0);</script><img src="/hanjin/img/blank.gif" width="2" height="2"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="22" border="0" align="absmiddle" name="btns_tonode"></td>
									<td width="100">LOC On &nbsp;<input type="checkbox" name="loc_on" class="trans" value="L"></td>
									<td width="110" align="right">Equipment Office</td>
									<td width="120"><input name="ctrl_ofc" type="text" style="width:100%;" maxlength="6" onkeyup="upper(this)" ></td>
								</tr>
							</table>						
							<table class="search_in" border="0">
								<tr class="h23">
									<td width="80">CNTR TP/SZ</td>
									<td width="110"><script language="javascript">ComComboObject('cntr_tpsz', 1, 100, 1)</script></td>
									<td width="25" align="left"><input type="checkbox" name="size_chk" value="" class="trans"></td>
