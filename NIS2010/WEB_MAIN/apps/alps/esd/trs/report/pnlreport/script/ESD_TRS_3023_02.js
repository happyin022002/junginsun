...
/**
 * @extends 
 * @class ESD_TRS_3023_02 : ESD_TRS_3023_02 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TRS_3023_02() {
		...
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				var HeadTitle =             "Sts|SEQ|BKG No|W/O No|S/O No|COP No|CNTR No|Cntr\nTP/SZ";
				    HeadTitle = HeadTitle + "|W/O Office|BOUND|COST\nMODE|From|Via|To|Door|Trnas\nMode";
				...
				InitDataProperty(0, cnt++, 	dtData,   			90,	daRight, 	true,    	"wo_usd_amt",    				false, 		"", 		dfFloat, 	0, 			false, 		false, 			30, 	false,	 	true, 		"", 		false);
	...
	switch(sAction) {
		case IBSEARCH:		//Retrieve
			if(!validateForm(sheetObj,formObj,sAction)) return;
	   		...
	   		var sXml = sheetObj.GetSearchXml("ESD_TRS_3023_02GS.do", TrsFrmQryString(formObj) + "&s_bkg_arr=" + opener.form.s_bkg_arr.value );
