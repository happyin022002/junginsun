...
<html>
<head>
<title>Expense Summary by S/P (Detail Inquiry)</title>
...
<table width="800" class="popup" cellpadding="10" border="0">
  ...
  <tr>
  	<td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp; Expense Summary by S/P (Detail Inquiry)</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
