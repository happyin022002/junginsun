...
/**
 * @extends Bkg
 * @class ESD_TRS_0952 : 예)Booking 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TRS_0952() {
	...
	switch(sheetNo) {
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++, dtHidden, 90, daCenter, true, "trsp_so_ofc_seq", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 90, daCenter, true, "trsp_wo_ofc_seq", false, "", dfNone, 0, false, false);
				...
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "dor_pst_cd", false, "", dfNone, 1, true, true, 10);
				...
				//jsk-InitDataProperty(0, cnt++, dtHidden, 80, daCenter, true, "tro_cfm_curr_cd", false, "", dfNone, 0, false, false);
				//jsk-InitDataProperty(0, cnt++, dtHidden, 80, daRight, true, "tro_cfm_rev_amt", false, "", dfNone, 0, false, false);
				...
				InitDataProperty(0, cnt++, dtHidden, 100, daLeft, true, "bkg_qty", false, "", dfNone, 0, false, false); //20070625
				...
				InitDataProperty(0, cnt++, dtHidden, 50 , daCenter, true, "lstm_exp_flg", false, "", dfNone, 1, false, false);
				...
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "org_eq_tpsz_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "trsp_crr_mod_cd2", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "lse_cntr_flg", false, "", dfNone, 1, false, false);

				//UI에 나타나지 않는 값 끝

				RangeBackColor(1, 10, 1, 20) = RgbColor(222, 251, 248); // ENIS
		...
		case 2:      //sheet1 init
			with (sheetObj) {
				...
				var HeadTitle0 = "Sel.|STS|CB|SOURCE|S/O No|W/O No|CNTR No.|TP / SZ|Cost\nMode|CMC|Trans\nMode|From Node|From Node|Via Node|Via Node|To Node|To Node|Door Location|Door Location|Door Information|Door Information|Door Information|Door Information|Door Information|Door Information|Door Information|Multi\nStop|Planned Time|Planned Time|Planned Time|Planned Time|Planned Time|Planned Time|COP No|A/G SEQ|A/G Code|BKG No|BL No|BND|Term|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|BKG QTY|CGO\nTP|BKG\nSPE|Seal\nNo.1|Seal\nNo.2|Weight|Weight\n(KGS)|Weight\n(LBS)|Weight\nUOM|No of\nPKG|PKG\nCode|Commodity\nDescription|Trunk\nVVD|Lane|in VVD|out VVD|POR|POL|POD|DEL|Shipper|Consignee|Notify|Customs\nC.LOC|USA\nLast City|F|O|C|Pickup No.|Avaliable DT|Avaliable DT|Last Free DT|Last Free DT|S/C No|Customs\nClearance|Customs\nClearance No|RFA No|Used|Imm.\nExit|L/T|L/T\nEXP|Door\nSVC TP|Internal Remark|Remark\n(Special Instruction)|IRG|Transfer Requesting\nOffice Code|Transfer Requesting\nUser Name|Transfer Requesting\n Reason|78|79|80|81|82|83|84|85|86|87|88|89|90|91|92|93|94|95|96|97|98|99|100|Reference\nNumber";
				var HeadTitle1 = "Sel.|STS|CB|SOURCE|S/O No|W/O No|CNTR No.|TP / SZ|Cost\nMode|CMC|Trans\nMode|Loc|Node|Loc|Node|Loc|Node|Loc|Zone|Actual\nCustomer|Factory\nName|Zip\nCode|Address|TEL|FAX|PIC|Multi\nStop|From Departure|From Departure|To Arrival|To Arrival|Door Arrival|Door Arrival|COP No|A/G SEQ|A/G Code|No|BL No|BND|Term|SEQ|CNFM|Office|User ID|Time|Time|Revenue\nCurrency|Revenue\nAmount|Load\nReference No|BKG QTY|CGO\nTP|BKG\nSPE|Seal\nNo.1|Seal\nNo.2|Weight|Weight\n(KGS)|Weight\n(LBS)|Weight\nUOM|No of\nPKG|PKG\nCode|Commodity\nDescription|Trunk\nVVD|Lane|in VVD|out VVD|POR|POL|POD|DEL|Shipper|Consignee|Notify|Customs\nC.LOC|USA\nLast City|F|O|C|Pickup No.|||||S/C No|Customs\nClearance|Customs\nClearance No|RFA No|Used|Imm.\nExit|L/T|L/T\nEXP|Door\nSVC TP|Internal Remark|Remark\n(Special Instruction)|IRG|Transfer Requesting\nOffice Code|Transfer Requesting\nUser Name|Transfer Requesting\n Reason|78|79|80|81|82|83|84|85|86|87|88|89|90|91|92|93|94|95|96|97|98|99|100|Reference\nNumber";
				...
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "cre_ofc_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daCenter, true, "ref_id", false, "", dfEngUpKey, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 20, daLeft, true, "repo_pln_id", false, "", dfEngUpKey, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 20, daLeft, true, "pln_yrwk", false, "", dfEngUpKey, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 20, daLeft, true, "ref_seq", false, "", dfEngUpKey, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 20, daLeft, true, "trsp_so_cmb_tp_cd", false, "", dfEngUpKey, 0, false, false);
...
//			sheetObj.ShowDebugMsg = true;
			sheetObjects[1].DoSearch4Post("ESD_TRS_0952GS.do", sheetObj.GetSaveString(false, true, "chk1")+"&"+TrsFrmQryString(formObj));
//			sheetObj.ShowDebugMsg = false;
		break;
	}
}
...
function IBS_Sheet2SheetStatus6(topSheet, downSheet, toSheet) {
	...
	for (ic = 0; ic<=topSheet.LastCol; ic++) {
		if( topSheet.ColSaveName(ic) == "chk1" ) {
			...
			rowXml += "<TD>"+iz+"-1</TD>";
		} else if( topSheet.ColSaveName(ic) == "shpr_cust_nm" || topSheet.ColSaveName(ic) == "cnee_cust_nm" || topSheet.ColSaveName(ic) == "ntfy_cust_nm" || topSheet.ColSaveName(ic) == "cmdt_name"  || topSheet.ColSaveName(ic) == "dor_de_addr" ) {
			rowXml += "<TD><![CDATA[" + topSheet.CellValue(arrTRow[0], ic) + "]]></TD>";
		} else if( topSheet.ColSaveName(ic) == "inter_rmk" || topSheet.ColSaveName(ic) == "spcl_instr_rmk" ) {
			...
			rowXml += "<TD>" + topSheet.CellValue(arrTRow[0],ic) + "</TD>";
		}
	}
	...
	for (ic = 0; ic<=downSheet.LastCol; ic++) {
		...
		if( downSheet.ColSaveName(ic) == "chk1" ) {
		...
		} else if( downSheet.ColSaveName(ic) == "lst_loc_cd"  ) { //추가
			...
			rowXml += "<TD BGCOLOR='222,251,248' EDIT='TRUE'>" + downSheet.CellValue(arrDRow[0],ic) + "</TD>";
		} else if( downSheet.ColSaveName(ic) == "shpr_cust_nm" || downSheet.ColSaveName(ic) == "cnee_cust_nm" || downSheet.ColSaveName(ic) == "ntfy_cust_nm" || downSheet.ColSaveName(ic) == "cmdt_name" ) {
			rowXml += "<TD><![CDATA[" + downSheet.CellValue(arrDRow[0], ic) + "]]></TD>";
		} else if( downSheet.ColSaveName(ic) == "inter_rmk" || downSheet.ColSaveName(ic) == "spcl_instr_rmk" ) {
...
function IBS_Sheet2SheetStatus5(fromSheet, toSheet, sStatus)  {
	...
	for (ir = 0; ir < arrRow.length-1; ir++) {
		...
		for (ic = 0; ic<=fromSheet.LastCol; ic++) {
			...
			} else if( fromSheet.ColSaveName(ic) == "lst_loc_cd"  ) { //추가
			...
			} else if( fromSheet.ColSaveName(ic) == "shpr_cust_nm" || fromSheet.ColSaveName(ic) == "cnee_cust_nm" || fromSheet.ColSaveName(ic) == "ntfy_cust_nm" || fromSheet.ColSaveName(ic) == "cmdt_name" || fromSheet.ColSaveName(ic) == "inter_rmk" || fromSheet.ColSaveName(ic) == "spcl_instr_rmk" || fromSheet.ColSaveName(ic) == "dor_de_addr" ) {
	...
	for (ir = 0; ir < sRow; ir++) {
		...
		for (ic = 0; ic<=fromSheet.LastCol; ic++) {
			...
			if( fromSheet.ColSaveName(ic) == "chk1" ) {
				...
				rowXml += "<TD COMBO-TEXT='"+sText+"' COMBO-CODE='"+sCode+"'>" + fromSheet.CellValue(ir+2, ic) + "</TD>";
			} else if( fromSheet.ColSaveName(ic) == "shpr_cust_nm" || fromSheet.ColSaveName(ic) == "cnee_cust_nm" || fromSheet.ColSaveName(ic) == "ntfy_cust_nm" || fromSheet.ColSaveName(ic) == "cmdt_name" ||  fromSheet.ColSaveName(ic) == "inter_rmk" || fromSheet.ColSaveName(ic) == "spcl_instr_rmk" ) {
				rowXml += "<TD><![CDATA[" + fromSheet.CellValue(ir+2,ic) + "]]></TD>";
			} else {
				rowXml += "<TD>" + fromSheet.CellValue(ir+2,ic) + "</TD>";
			}
