...
*@FileTitle : Europe CY & DOOR S/O Creation
*Open Issues :
*Change history :
...
* 2012.06.05 신동일 [CHM-201217633] [TRS] Distance 추가(구주 Hinterland T/F 및 시스템 개발 Project)
...
function initSheet(sheetObj, sheetNo) {
	...
	var sheetObject2 = sheetObjects[2];   //t3sheet1
	var sheetObject3 = sheetObjects[3];   //sheet2
	var sheetObject4 = sheetObjects[4];   //t4sheet1 -- Actual Customer Info Set GRID  
	var sheetObject5 = sheetObjects[5];   //rtnsheet
	var cnt = 0;
	...
	switch(sheetNo) {
		case 1:      //t1sheet1 init
			with (sheetObj) {
				...
				+"Distance|Distance|Door Information|Door Information|Door Information|Door Information|"
				...
				+"Confirm Time|Confirm Time|Revenue\nCurrency|Revenue\nAmount|Load\nReference No|"
				+"TRO REP CMDT|BKG QTY|CGO\nTP|CNTR\nSPE|Seal\nNo.1|Seal\nNo.2|Weight|Weight\n(KGS)|Weight\n(LBS)|"
				+"Weight\nUOM|No of\nPKG|PKG\nCode|Commodity\nDescription|Trunk\nVVD|Lane|"
				...
				InitDataProperty(0, cnt++, dtData,  80, daCenter, true, "fm_nod_cd", false, "", dfEngUpKey, 1, true, true, 5);
				InitDataProperty(0, cnt++, dtCombo, 50, daCenter, true, "fm_nod_yard", false, "", dfNone, 1, true, true);
				InitDataProperty(0, cnt++, dtData,  80, daCenter, true, "via_nod_cd", false, "", dfEngUpKey, 1, true, true, 5);
				InitDataProperty(0, cnt++, dtCombo, 50, daCenter, true, "via_nod_yard",false, "", dfNone, 1, true, true);
				InitDataProperty(0, cnt++, dtData,  80, daCenter, true, "to_nod_cd", false, "", dfEngUpKey, 1, true, true, 5);
				InitDataProperty(0, cnt++, dtCombo, 50, daCenter, true, "to_nod_yard", false, "", dfNone, 1, true, true);
				InitDataProperty(0, cnt++, dtData,  80, daCenter, true, "dor_nod_cd", false, "", dfNone, 1, true, true, 5);
				...
				InitDataProperty(0, cnt++, dtData, 75, 		daCenter, true, "spot_bid_due_dt", 		false, "",    	dfDateYmd, 1, false, false);
				InitDataProperty(0, cnt++, dtData, 60, 		daCenter, true, "spot_bid_due_dt_hms", 	false, "",   	dfTimeHms, 1, false, false);
				
				InitDataProperty(0, cnt++, dtData, 70, daCenter, true, "n1st_nod_pln_dt", false, "",    dfDateYmd, 1, true, true);
				InitDataProperty(0, cnt++, dtData, 50, daCenter, true, "n1st_nod_pln_dt_hms", false, "",   dfTimeHms, 1, true, true);
				InitDataProperty(0, cnt++, dtData, 70, daCenter, true, "lst_nod_pln_dt", false, "", dfDateYmd, 1, true, true);
				InitDataProperty(0, cnt++, dtData, 50, daCenter, true, "lst_nod_pln_dt_hms", false, "",     dfTimeHms, 1, true, true);
				InitDataProperty(0, cnt++, dtData, 70, daCenter, true, "dor_nod_pln_dt", false, "", dfDateYmd, 1, true, true);
				InitDataProperty(0, cnt++, dtData, 50, daCenter, true, "dor_nod_pln_dt_hms", false, "",     dfTimeHms, 1, true, true);
				
				InitDataProperty(0, cnt++, dtData, 70, daCenter, true, "dor_arr_dt_dd", false, "", dfDateYmd, 1, false, false); //20070726
				InitDataProperty(0, cnt++, dtData, 50, daCenter, true, "dor_arr_dt_hms", false, "", dfTimeHms, 1, false, false); //20070726
				...
				InitDataProperty(0, cnt++, dtData, 80, daCenter, true, "tro_cfm_curr_cd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 80, daRight, true, "tro_cfm_rev_amt", false, "", dfNone, 0, false, false);
				...
				InitDataProperty(0, cnt++, dtHidden, 60, daCenter, true, "rail_to_nod_cd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 100, daCenter, true, "rail_cre_dt_dd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "rail_cre_dt_hms", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 100, daCenter, true, "ibd_cstms_clr_loc_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 100, daCenter, true, "lst_loc_cd", false, "", dfNone, 0, true, true);
				...
				InitDataProperty(0, cnt++, dtData, 100, daLeft, true, "cng_rsn_desc", false, "", dfEngUpKey, 0, true, true,255); //2014.03.27 hidden // 2014.04.28 다시 원복 //
...
//				EditableColorDiff = false; //배경 색을 유지한다. false일 경우만.
		...
		case 2:      //t2sheet1
			with (sheetObj) {
				...
				Editable = true; //전체Edit 허용 여부 [선택, Default false]
				InitRowInfo( 2, 1, 9, 100); //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
				InitColumnInfo(157, 5, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
				...
				InitDataProperty(0, cnt++, dtHidden, 70, daCenter, true, "prt_bkg_no", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "bl_no", false, "", dfNone, 0, false, false); //bl_no = BL_NO + BL_NO_TP + BL_NO_CHK
				InitDataProperty(0, cnt++, dtData,  50, daCenter, true, "trsp_bnd_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "bkg_rcvde_term_cd", false, "", dfNone, 0, false, false);
				...
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "rail_cre_dt_hms", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 100, daCenter, true, "ibd_cstms_clr_loc_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 100, daCenter, true, "lst_loc_cd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "cgor_frt_pay_ind_flg", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtHidden, 50, daCenter, true, "cgor_org_bl_rcvr_ind_flg", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 50 , daCenter, true, "cgor_cstms_acpt_re_ind_flg", false, "", dfNone, 0, false, false);
		...
		case 3: //t3sheet1
			with (sheetObj) {
				...
				Editable = true; //전체Edit 허용 여부 [선택, Default false]
				InitRowInfo( 2, 1, 9, 100); //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
				InitColumnInfo(164, 5, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
				...
				InitDataProperty(0, cnt++, dtData, 80, daCenter, true, "trsp_so_sts_nm", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "bkg_no", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 100, daCenter, true, "prt_bkg_no", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "bl_no", false, "", dfNone, 0, false, false); //bl_no = BL_NO + BL_NO_TP + BL_NO_CHK
				InitDataProperty(0, cnt++, dtData,  50, daCenter, true, "trsp_bnd_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "bkg_rcvde_term_cd", false, "", dfNone, 0, false, false);
			...
			case "btng_multipleapply": //Multiple Apply 동시적용
				...
				if( doMultipleApply(sheetObject) ) {
              	...
              	for( var i=0; i<sheetObject.RowCount; i++ ) {
					...
					ComOpenWindow('ESD_TRS_0003.do?scrn_id=0002&cost_mode_cd='+lv_cost_mode_cd, 'ESD_TRS_0003', 'top=200, left=200, width=785, height=395, toolbar=0, directories=0, status=0, menubar=0, scrollbars=0, resizable=0');
				}
			break;
...
function t1sheet1_OnChange(sheetObj, row , col , value) {
	...
	if( sheetObj.ColSaveName(col) == "chk1" ) {
		...
		document.form.TRSP_SO_EQ_KIND.value = "";
		if( doengnumcheck(lvfm) ) {   //doengnumcheck:영문과 숫자에 대한 유효성을 체크. 
			if( lvfm.length == 5 ) {
...
//				getYardSheetCombo1(sheetObj, document.form, row, col, "to_nod_yard", lvto); //Varidation check
		...
		if(form.dist_div_cd.value=="G"){ //Grid OnChange Event일때만 Distance를 조회한다.
			distance_cal(sheetObj, row);
		}
...
//2014.03.27  CHECK 제외	 //2014.04.28 다시  check 하도록 수정함.	
...
function doMultipleApply(sheetObj) {	
	...
	for( var i=0; i<objArray.length; i++ ) {
		...
		lvTransMode = objTrans[i]; //TransMode
...
// 	sheetObj.DoRowSearch("ESD_TRS_0002GS.do", queryString);
 ...
 function changeLocCheck(sheetObj,row){
	...
	if(cng_rsn_desc == ""){
//2014.04.28 Trans Mode check 만 제외	   
