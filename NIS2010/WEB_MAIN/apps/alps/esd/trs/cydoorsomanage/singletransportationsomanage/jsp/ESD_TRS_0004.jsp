...
<input type="hidden" name="pgmId" value="ESD_TRS_0004">
<!-- Outer Table (S)-->
				...
				<td class="bg">
					<table class="search_in" border="0">
						<tr class="h23">
						    ...
						    <td width="163">
                            <SELECT name = "cydoor_div" style='width:60' onChange="getCostModeCombo(document.sel_costmode);" ><OPTION  value="DR">DOOR</OPTION><OPTION  value="CY">CY</OPTION></SELECT>
                            </td>
							<td>
				    ...
				    <tr class="h23">
				    <td width="45"></td>
				    <td class="sm"  style= "color:#CC3D3D">For export door, please use Door Arrival Date inquiry option.</td>
                    </tr>
					</table>
					<table class="search_in" border="0">
				    <tr class="h23">
...
<form name='soForm' method='POST'>
    ...
    <input type="hidden" name="pgmId" value="ESD_TRS_0004">	
    <input type="hidden" name="ui_conti_cd" value="M">
