...
* 2014.04.22 김현화 [CHM-201429951]Asia 지역 Door Location 변경 허용 로직. 
	...
	switch(sheetNo) {
		case 1:      //t1sheet1 init
			with (sheetObj) {
				...
				InitColumnInfo   (159, 5, 0, true); //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
				...
				+"COP No|A/G SEQ|A/G Code|S/O Status|Block Stowage|BKG No|Master BKG No|BL No|BND|Term|"
				...
				InitDataProperty(0, cnt++, dtData, 100, daCenter, true, "blck_stwg", false, "", dfNone, 1, false, false);
				...
				InitDataProperty(0, cnt++, dtHidden, 80 , daCenter, true, "dor_svc_tp_cd", false, "", dfNone, 0, true, true);
...
//				EditableColorDiff = false; //배경 색을 유지한다. false일 경우만.
		...
		case 2:      //sheet 2 init
			with (sheetObj) {
				...
				InitDataProperty(0, cnt++, dtHidden, 50 , daCenter, true, "imdt_ext_flg", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 60 , daCenter, true, "lstm_cd", false, "", dfNone, 1, false, false);
				InitDataProperty(0, cnt++, dtHidden, 80 , daCenter, true, "dor_svc_tp_cd", false, "", dfNone, 0, false, false);
				InitDataProperty(0, cnt++, dtData, 120, daLeft, true, "inter_rmk", false, "", dfEngUpKey, 1, true, true, 255);
			...
			case "btng_multipleapply": //Multiple Apply 동시적용
				...
				if( doMultipleApply(sheetObject) ) {
              	...
              	for( var i=0; i<sheetObject.RowCount; i++ ) {
					...
					ComOpenWindow('ESD_TRS_0003.do?scrn_id=0005&cost_mode_cd='+lv_cost_mode_cd, 'ESD_TRS_0003', 'top=200, left=200, width=785, height=395, toolbar=0, directories=0, status=0, menubar=0, scrollbars=0, resizable=0');
				}
			break;
...
//2014.03.27 CHECK 제외	//2014.04.22 다시  check 하도록 수정함.
 ...
 */
 ...
 function changeLocCheck(sheetObj,row){
	...
	if(cng_rsn_desc == ""){
//2014.04.22 Trans Mode check 만 제외	   
