	...
	switch(sheetNo) {
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				//InitColumnInfo(150, 7 , 0, true);
				//추가YJ
				InitColumnInfo(180+8+4+4+15+1+1+1+1, 8 , 0, true);
				...
				for(var i=1; i<=spot_bid_vndr_cnt;i++){
					HeadTitle1_dynamic += "|Bid "+i+"|Bid "+i+"|Bid "+i+"|Bid "+i+"|Bid "+i+"";
					HeadTitle2_dynamic += "|S/P Code|S/P Name|Currency|Rate|Rate(USD)";
				}

				var HeadTitle = "Status||Seq.|S/O Office|Bid|Bid No|Bid Due Date|Bid Due Date|EQ No.|TP/SZ|Org TP/SZ|Cost\nMode|Trans\nMode|S/O TP|Unplanned|Pre-Pull|CB|Frustrated|S/O No.|S/O CRE DT|S/O DEL|" +
				"S/O DEL DT|S/O UPD Name|Bid Status|W/O Office|W/O No.|W/O Iss STS|W/O Iss WK|W/O Iss DT|W/O ISS TP|W/O ISS Name|BND|Route|Route|Route|" +
				"Route"+HeadTitle1_dynamic+"|More Bidder|Distance|Distance|Door Information|Door Information|Door Information|Door Information|Door Information|Door Information|Door Information|Web D/O|Web D/O|Web D/O|Winner S/P|Winner S/P|Winner S/P|Parent S/P|Parent S/P|W/O RCV DT|Appt. Time|Deliv. Time|Feeder Term|Feeder Term|" +
				"3rd Party|Cost OFC|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Work Order Amount|Exchange\nRate|Calculation\nLogic|" +
				"INV Status|Invoice Amount|Invoice Amount|Invoice Amount|Invoice Amount|Invoice Amount|Invoice S/P|Invoice S/P|Invoice No.|INV CNFM\nDT|CSR No.|INV I/F DT|" +
				"INV OFC|INV User|Invoice Remark|Estimated Time|Estimated Time|Estimated Time|Estimated Time|COP No.|A/G SEQ|A/G Code|BKG No.|BL No.|Term|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|TRO Information|BKG QTY|POR|POL|POD|DEL|" +
				...
				"|Guideline Rate|Guideline Rate|Guideline Rate|Guideline Rate|Guideline Rate|Guideline Rate|Guideline Rate|Guideline Rate" +
				"|vs W/O Amount|vs W/O Amount|vs W/O Amount|vs W/O Amount" +
				"|vs Invoice Amount|vs Invoice Amount|vs Invoice Amount|vs Invoice Amount" ; 

				var HeadTitle1 = "Status||Seq.|S/O Office|Bid|Bid No|Date|Time|EQ No.|TP/SZ|Org TP/SZ|Cost\nMode|Trans\nMode|S/O TP|Unplanned|Pre-Pull|CB|Frustrated|S/O No.|S/O CRE DT|S/O DEL|" +
				"S/O DEL DT|S/O UPD Name|Bid Status|W/O Office|W/O No.|W/O Iss STS|W/O Iss WK|W/O Iss DT|W/O ISS TP|W/O ISS Name|BND|From|Via|To|" +
				"Door"+HeadTitle2_dynamic+"|More Bidder|Km|R.Link|Actual Customer|Factory Name|Zip Code|Address|TEL|FAX|PIC|User Info|Time|Time|Type|Code|Name|Code|Name|W/O RCV DT|Appt. Time|Deliv. Time|Receiving|Delivery|" +
				"3rd Party|Cost OFC|Currency|Basic|Negotiated|Fuel|VAT|Toll Fee|Additional|HZD|OVR|Usa Rail Surcharge|Total|Total(USD)|Exchange\nRate|Calculation\nLogic|" +
				"INV Status|Currency|Basic|Surcharge|Total|Total(USD)|Code|Name|Invoice No.|INV CNFM\nDT|CSR No.|INV I/F DT|" +
				"INV OFC|INV User|Invoice Remark|From Departure|To Arrival|Door Arrival|TRO Door Date|COP No.|A/G SEQ|A/G Code|BKG No.|BL No.|Term|SEQ|CNFM|Office|User ID|Confirm Time|Rev Curr|Rev Amt|Manifested|Load Ref No|BKG QTY|POR|POL|POD|DEL|" +
				"T.VVD|Lane|In VVD|In VVD Lane|Out VVD|Out VVD Lane|CGO TP|CNTR SPE|Used|L/T|I.Exit|L/T EXP|Seal No.1|Seal No.2|" +
				"Weight(KGS)|Weight(LBS)|No of PKG|PKG CD|Commodity DESC|C.LOC|USA Last City|F|O|C|IT No|" +
				"Pickup No.|PU Yard|Available DT|Last Free DT|S/C No.|RFA No.|Contract Customer Name|Door SVC TP|Pickup CNTR|Shipper|Consignee|Notify|Ref.BKG No|" +
				"Ref.BL No|Outgate Date|Ingate Date|MTY Reference No|Reason|Internal\nRemark|Nego. Remark|Reason of\nNode Change|Special Instruction|W/O Instruction|CHZ Bundle|Supplement Kind|" +
				"Date|Yard|Date|Yard|Status|Date|Yard|WEB M'ty|Grace End|GP ID|GP Seq.|ETS|HJL Handling Fee||||||" +
				"|S/P Code|Currency|Basic|Fuel|VAT|Toll Fee|Total Rate|Total Rate(USD)" +
				"|Currency|Amount|USD|Result" +
				"|Currency|Amount|USD|Result" ; 
				...
				InitDataProperty(0, cnt++ , dtData,  		80,    daCenter,   	true,    "so_cre_ofc_cd",     	false,          "",       dfNone,          0,     false,       false);
				
				//2015.08.20 Add Spot Bidding column by SHIN DONG IL
				InitDataProperty(0, cnt++, dtHidden, 			30,    daCenter, 	true, 	 "spot_bid_flg", 		false, 			"", 	  dfNone,    		1, 	  false,  	   false);
				...
				InitDataProperty(0, cnt++ , dtHidden,			70,    daCenter,   	true,    "org_eq_tpsz",			false,      	"",		  dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden,			65,    daCenter,   	true,    "upln_so_flg",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,			60,    daCenter,   	true,    "pre_pull_flg",     	false,          "",       dfNone,          0,     false,       false); //20121031
				InitDataProperty(0, cnt++ , dtHidden,			30,    daCenter,   	true,    "bkg_cntr_cmb_seq",    false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,			65,    daCenter,   	true,    "trsp_frst_flg",     	false,          "",       dfNone,          0,     false,       false);
		 	...
		 	//  InitDataProperty(0, cnt++ , dtData,  		80,    daCenter,   true,     "upd_usr_id",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		90,    daCenter,   	true,    "upd_usr_nm",     		false,          "",       dfNone,          0,     false,       false);
				
				InitDataProperty(0, cnt++ , dtData,  		100,    daCenter,   	true,    "spot_bid_sts_cd",     false,          "",       dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtData, 		120,   daCenter,   	true,    "wo_iss_sts_cd",     	false,          "",       dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daCenter,   	true,    "wo_iss_tp",     		false,          "",       dfNone,          0,     false,       false);
				
			//	InitDataProperty(0, cnt++ , dtData,  		80,    daCenter,   true,     "wo_iss_id",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		90,    daCenter,   	true,    "wo_iss_nm",     		false,          "",       dfNone,          0,     false,       false);
				...
				for(var i=1; i<=spot_bid_vndr_cnt;i++){
					InitDataProperty(0, cnt++ , dtData,      60,    daCenter,  	true,   "spot_bid_vndr_seq_"+i,	false,		"",		dfNone,	0,	false,		false,		14,false, true);
					InitDataProperty(0, cnt++ , dtData,      100,    daLeft,  	true,   "spot_bid_vndr_nm_"+i,	false,		"",		dfNone,	0,	false,		false,		14,false, true);
					InitDataProperty(0, cnt++ , dtData,      60,    daCenter,  	true,   "spot_bid_curr_cd_"+i,	false,		"",		dfNone,	0,	false,		false,		14,false, true);
					InitDataProperty(0, cnt++ , dtData,      80,    daRight,  	true,   "spot_bid_amt_"+i,	    false,		"",		dfNullFloat,2,	false,		false,		14,false, true);
					InitDataProperty(0, cnt++ , dtHidden,    80,    daRight,  	true,   "spot_bid_usd_amt_"+i,	false,		"",		dfNullFloat,2,	false,		false,		14,false, true);
				}
				InitDataProperty(0, cnt++ , dtPopup,     80,    daCenter,  	true,   "spot_bid_more_bid",		false,		"",		dfNone,		0,	true,		false,		5, false, true);
				
				//2012.06.01 Add Distance column by SHIN DONG IL
				InitDataProperty(0, cnt++, dtHidden,  		60,    daRight,    	true, 	 "ttl_dist", 			false, 			"", 	  dfInteger, 	   1, 	  false, 	   false);
				InitDataProperty(0, cnt++, dtHidden,  		50,    daCenter,   	true, 	 "lnk_dist_div_cd", 	false, 			"", 	  dfNone, 		   1, 	  false, 	   false);

				InitDataProperty(0, cnt++ , dtHidden,  		100,   daLeft,     	true,    "door_act_cust",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daLeft,     	true,    "door_fctry_nm",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daLeft,     	true,    "door_zip",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		140,   daLeft,     	true,    "dor_de_addr",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daLeft,     	true,    "door_tel",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daLeft,     	true,    "door_fax",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daLeft,     	true,    "door_pic",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daLeft,     	true,    "usa_do_usr_info", 	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daCenter,   	true,    "do_cre_date",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daCenter,   	true,    "do_cre_time",     	false,          "",       dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden, 		70,    daCenter,   	true,    "pvndr_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		120,   daLeft,     	true,    "pvndr_nm",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "wo_rcv_dt",     		false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "appt_time",     		false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "deliv_time",     		false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		80,    daCenter,   	true,    "wtr_rcv_term_cd",     false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		80,    daCenter,   	true,    "wtr_de_term_cd",     	false,          "",       dfNone,          0,     false,       false);
				
				InitDataProperty(0, cnt++ , dtHidden, 		70,    daCenter,   	true,    "n3pty_bil_flg",     	false,          "",       dfNone,          0,     true,        false);
				InitDataProperty(0, cnt++ , dtHidden,  		90,    daCenter,   	true,    "cost_ofc_cd",     	false,          "",       dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daRight,    	true,    "inv_xch_rt",     		false,          "",       dfNone,          2,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daLeft,     	true,    "inv_calc_lgc_tp_cd",  false,          "",       dfNone,          2,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden,  		70,    daCenter,   	true,    "inv_vndr_cd",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		130,   daLeft,     	true,    "inv_vndr_nm",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		80,    daCenter,   	true,    "inv_no",     			false,          "",       dfNone,          0,     false,       false);
				
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "inv_cfm_dt",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		130,   daCenter,   	true,    "car_no",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		110,   daCenter,   	true,    "inv_if_dt",     		false,          "",       dfUserFormat2,   0,     false,       false);

				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "inv_cfm_ofc_cd",     	false,          "",       dfNone,          0,     false,       false);
			//  InitDataProperty(0, cnt++ , dtData,   		70,    daCenter,   true,     "inv_cre_usr_id",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "inv_cre_usr_nm",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		150,   daLeft,     	true,    "inv_rmk",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "n1st_nod_pln_dt",     false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "lst_nod_pln_dt",     	false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "dor_nod_pln_dt",     	false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		110,   daCenter,   	true,    "dor_arr_dt",     		false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daCenter,   	true,    "cop_no",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "ag_seq",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "ag_code",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daCenter,   	true,    "bkg_no",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daCenter,   	true,    "bl_no",     			false,          "",       dfNone,          0,     false,       false);
				
				InitDataProperty(0, cnt++ , dtHidden,   		50,    daCenter,   	true,    "term",     			false,          "",       dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden,   		50,    daCenter,   	true,    "tro_cfm_ofc",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "tro_cfm_usr",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daCenter,   	true,    "tro_cfm_upd",     	false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		65,    daCenter,   	true,    "tro_rev_cur",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "eur_tro_rev",     	false,          "",       dfNullFloat,     0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "manifested",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daCenter,   	true,    "tro_lod_ref",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "bkg_qty",     		false,          "",       dfNone,          0,     false,       false);
				...
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "t_vvd",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "slan_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "ib_vvd_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daCenter,   	true,    "ib_slan_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "ob_vvd_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		85,    daCenter,   	true,    "ob_slan_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "cgo_tp_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "bkg_spe",     		false,          "",       dfNone,          0,     true,        false);
				InitDataProperty(0, cnt++ , dtHidden,   		50,    daCenter,   	true,    "used",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		40,    daCenter,   	true,    "lt",     				false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		50,    daCenter,   	true,    "i_exit",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "lt_exp",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "seal_no",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,   	true,    "seal_no2",     		false,          "",       dfNone,          0,     false,       false);

				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "weight_kgs",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "weight_lbs",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "no_pkg",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "pkg_cd",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		120,    daLeft,    	true,    "cmdt_nm",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "c_loc",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "usa_last_city",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		30,    daCenter,   	true,    "f",     				false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		30,    daCenter,   	true,    "o",     				false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		30,    daCenter,   	true,    "c",     				false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "it_no",     			false,          "",       dfNone,          0,     false,       false);
				
				InitDataProperty(0, cnt++ , dtHidden,   		70,    daCenter,  	true,    "pickup_no",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		60,    daCenter,   	true,    "pu_yard_cd",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		110,    daCenter,   true,    "available_dt",     	false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		110,    daCenter,   true,    "last_free_dt",     	false,          "",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "sc_no",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daCenter,   	true,    "rfa_no",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden, 		170,   daLeft,      true,    "ctrc_cust_nm",     	false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daLeft,   	true,    "door_svc_tp",     	false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daCenter,   	true,    "pkup_cntr",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daLeft,   	true,    "shipper",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daLeft,   	true,    "consignee",     		false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		90,    daLeft,   	true,    "notify",     			false,          "",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daCenter,   	true,    "ref_bkg_no",     		false,      	"",       dfNone,          0,     false,       false);

				InitDataProperty(0, cnt++ , dtHidden,   		80,    daCenter,   	true,    "ref_bl_no",     		false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daCenter,   	true,    "org_gate_out_dt",     false,      	"",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		100,   daCenter,  	true,    "dest_gate_in_dt",     false,      	"",       dfUserFormat2,   0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,  		110,   daCenter,   	true,    "mty_ref_id",     		false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daCenter,   	true,    "trsp_purp_rsn",     	false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		80,    daLeft,   	true,    "inter_rmk",     		false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,    daLeft,   	true,    "nego_rmk",     		false,      	"",       dfNone,          0,     false,       false);
				//2012.10.30 [CHM-201220924 ] Reason of Node Change(CNG_RSN_DESC) 컬럼추가
				InitDataProperty(0, cnt++ , dtHidden,   		110,   daLeft,   	true,    "cng_rsn_desc",      	false,      	"",       dfNone,          0,     false,       false); //2014.03.27
				InitDataProperty(0, cnt++ , dtHidden,   		110,   daLeft,   	true,    "spcl_instr_rmk",    	false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		110,   daLeft,     	true,    "wo_instr_rmk",      	false,      	"",       dfNone,          0,     false,       false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daLeft,     	true,    "chz_bundle_seq",	  	false,			"",		  dfNone,		   0,     false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daLeft,     	true,    "trsp_spl_so_tp_cd", 	false,			"",		  dfNone,		   0,     false,	   false,		100,		false,		false,	   "",	  false);

				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "fm_dt",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "fm_yd",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "to_dt",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "to_yd",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "to_sts",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "mt_dt",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "mt_yd",				false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "web_mt_dt",			false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,   daCenter,    true,    "grace_end",			false,			"",		  dfNone,		   0,      false,	   false,		100,		false,		false,	   "",	  false);
				InitDataProperty(0, cnt++ , dtHidden,    		120,   daCenter,  	true,    "mcntr_bdl_grp_seq",	false,			"",		  dfNone,		   0,	   false,	   false,		  5, 		false, 		true);	
				InitDataProperty(0, cnt++ , dtHidden,     	80,    daCenter,  	true,    "mcntr_bdl_seq",		false,			"",		  dfNone,		   0,	   false,	   false,		  5, 		false, 		true);
				InitDataProperty(0, cnt++ , dtHidden, 		40,    daCenter,    true,    "hjl_no",     			false,      	"",       dfNone,          0,      false,      false);
				InitDataProperty(0, cnt++ , dtHidden,   		100,    daRight,    true,    "wo_hjl_hndl_amt",     false,      	"",       dfNullFloat,     2,      false,      false);
				...
				InitDataProperty(0, cnt++ , dtData, 		80,    daCenter,    true,    "gline_vndr_seq",     	false,      	"",       dfNone,          0,      false,      false);
				InitDataProperty(0, cnt++ , dtData, 		80,    daCenter,    true,    "gline_curr_cd",     	false,      	"",       dfNone,          0,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "gline_bzc_amt",     	false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "gline_fuel_scg_amt",  false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "gline_scg_vat_amt",   false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "gline_toll_fee_amt",  false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "gline_ttl_amt",     	false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "gline_ttl_amt_usd",   false,      	"",       dfNullFloat,     2,      false,      false);
				
				InitDataProperty(0, cnt++ , dtData, 		80,    daCenter,    true,    "vs_wo_curr_cd",     	false,      	"",       dfNone,          0,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "vs_wo_amt",     		false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "vs_wo_amt_usd",     	false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData, 		80,    daCenter,    true,    "vs_wo_rslt",     		false,      	"",       dfNone,          0,      false,      false);
				
				InitDataProperty(0, cnt++ , dtData, 		80,    daCenter,    true,    "vs_inv_curr_cd",     	false,      	"",       dfNone,          0,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "vs_inv_amt",     		false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData,   		100,    daRight,    true,    "vs_inv_amt_usd",     	false,      	"",       dfNullFloat,     2,      false,      false);
				InitDataProperty(0, cnt++ , dtData, 		80,    daCenter,    true,    "vs_inv_rslt",     	false,      	"",       dfNone,          0,      false,      false);
	...
	switch(sAction) {
		case IBSEARCH:      //조회
			...
			if(obj == "RTV" ) {    //  Retrieve 시
				//sheetObj.DoSearch4Post("ESD_TRS_0092GS.do", TrsFrmQryString(formObj));
			    formObj.hid_grid_flg.value = 'Y';

				IBS_DoSearchSax(sheetObj, "ESD_TRS_0092GS.do", TrsFrmQryString(formObj));
...
function sheet1_OnPopupClick (sheetObj , row , col )
{
	...
	switch(colName)
	{
		...
		case('spot_bid_more_bid'):

			if(sheetObj.CellValue(row, 'spot_bid_more_bid') == "Y"){

				var url = '?targetRow='+row;
				url += '&spot_bid_no='+sheetObj.CellValue(row, 'spot_bid_no');
				url += '&spot_bid_win_vndr_seq='+sheetObj.CellValue(row, 'vndr_cd');
				url += '&spot_bid_sel_row='+row;
				url += '&more_bid_read_only=Y';
...
/*function office_check(obj){ 
	...
	if(charval=="Y"){
		if(value !=""){
			...
			formObject.sheet1.DoRowSearch("ESD_TRS_0092GS.do", queryString);
