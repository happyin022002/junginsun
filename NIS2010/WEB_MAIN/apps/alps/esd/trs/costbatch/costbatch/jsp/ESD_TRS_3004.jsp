...
<%@ page import="com.hanjin.apps.alps.esd.trs.costbatch.costbatch.event.EsdTrs3004Event"%>
<%
	EsdTrs3004Event  event = null;							//PDTO(Data Transfer Object including Parameters)
	...
	try {
	   ...
	   //userAuth=account.getAuth();
		...
		event = (EsdTrs3004Event)request.getAttribute("Event");
				...
				<tr>
					<td class="bg">
						<table class="search_in" border="0">
							<tr class="h23">
								<td width="40">RHQ</td>
								<td width="100"><input name="rhq_cd" type="text" style="width:50;" class="input2" readOnly></td>
