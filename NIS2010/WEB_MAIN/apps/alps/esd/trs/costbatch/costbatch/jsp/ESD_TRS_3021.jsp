...
<%@ page import="com.hanjin.apps.alps.esd.trs.costbatch.costbatch.event.EsdTrs3021Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdTrs3021Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTrs3021Event)request.getAttribute("Event");
