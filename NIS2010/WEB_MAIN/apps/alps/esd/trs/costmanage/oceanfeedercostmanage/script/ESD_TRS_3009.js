...
* 2012.08.21 변종건 [CHM-201219483-01] 구주 Hinterland T/F -  TRS (Transportation) - Ocean Feeder Cost Inquiry 추가 요건 반영
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_TRS_3009 : esd_trs_3009 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_trs_3009() {
...
//						ComOpenWait(true, true);
					...
					case "btn_cost_detail":
						if( objs[0].style.display == "inline" ){
							...
							var acct_tbl_div = "TRS_FDR_COST_ACCT";
						} else if( objs[2].style.display == "inline" ){
							var sheetObj = sheetObjects[2];
							var acct_tbl_div = "TRS_FDR_RF_COST_ACCT";
						}
						...
						if( sheetObj.RowCount > 0 ){
							...
							ComOpenPopup('/hanjin/ESD_TRS_3019.do' + param, 1024,620,'', '1,0,1,1,1,1,1,1');
						}
						break;
    ...
    function loadPage() {
		...
		var sParam = TrsFrmQryString(formObj);
		var sXml = sheetObjects[3].GetSearchXml("ESD_TRS_3009GS.do", sParam);
        ...
        switch(sheetID) {
            ...
            case "sheet2":
                with (sheetObj) {
					...
					HeadTitle1 += "|IMDG Class 1|IMDG Class 1|IMDG Class 1|IMDG Class 1";
					HeadTitle1 += "|IMDG Class 2|IMDG Class 2|IMDG Class 2|IMDG Class 2";
					HeadTitle1 += "|IMDG Class 3|IMDG Class 3|IMDG Class 3|IMDG Class 3";
					HeadTitle1 += "|IMDG Class 4|IMDG Class 4|IMDG Class 4|IMDG Class 4";
					HeadTitle1 += "|IMDG Class 5|IMDG Class 5|IMDG Class 5|IMDG Class 5";
					HeadTitle1 += "|IMDG Class 6|IMDG Class 6|IMDG Class 6|IMDG Class 6";
					HeadTitle1 += "|IMDG Class 7|IMDG Class 7|IMDG Class 7|IMDG Class 7";
					HeadTitle1 += "|IMDG Class 8|IMDG Class 8|IMDG Class 8|IMDG Class 8";
					HeadTitle1 += "|IMDG Class 9|IMDG Class 9|IMDG Class 9|IMDG Class 9";
					...
					HeadTitle2 += "|SVC_1|SCHG_1|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_2|SCHG_2|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_3|SCHG_3|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_4|SCHG_4|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_5|SCHG_5|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_6|SCHG_6|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_7|SCHG_7|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_8|SCHG_8|20' TTL|40' TTL";
					HeadTitle2 += "|SVC_9|SCHG_9|20' TTL|40' TTL";
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n1st_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n2nd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n3rd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n4th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n5th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n6th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n7th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n8th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n9th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
    ...
    function initForm(param){
    	if( param == "btn_reset1" ){
			...
			ComSetObjValue(formObject.in_trans20, "");
			ComSetObjValue(formObject.in_trans40, "");
			ComSetObjValue(formObject.in_mty20, "");
			ComSetObjValue(formObject.in_mty40, "");
			ComSetObjValue(formObject.in_tmnl20, "");
			ComSetObjValue(formObject.in_tmnl40, "");
    	} else if( param == "btn_reset2" ){
    		comboObjects[13].Text = "";
			comboObjects[14].Code = "Y";
			comboObjects[15].Code = "F";
			comboObjects[16].Text = "";
			comboObjects[17].Code = "Y";
			comboObjects[18].Code = "F";
			comboObjects[19].Text = "";
			comboObjects[20].Code = "Y";
			comboObjects[21].Code = "F";
						
			ComSetObjValue(formObject.in_class1, "");
			ComSetObjValue(formObject.in_class2, "");
			ComSetObjValue(formObject.in_class3, "");
    	}
    }
	...
	function sheet2_OnChange(sheetObj, Row, Col, Value){
		...
		if ( sName == "imdg_n1st_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n1st_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n1st_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n1st_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n1st_clss_scg_amt"));
		} else if( sName == "imdg_n2nd_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n2nd_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n2nd_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n2nd_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n2nd_clss_scg_amt"));
		} else if( sName == "imdg_n3rd_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n3rd_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n3rd_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n3rd_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n3rd_clss_scg_amt"));
		} else if( sName == "imdg_n4th_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n4th_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n4th_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n4th_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n4th_clss_scg_amt"));
		} else if( sName == "imdg_n5th_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n5th_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n5th_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n5th_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n5th_clss_scg_amt"));
		} else if( sName == "imdg_n6th_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n6th_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n6th_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n6th_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n6th_clss_scg_amt"));
		} else if( sName == "imdg_n7th_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n7th_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n7th_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n7th_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n7th_clss_scg_amt"));
		} else if( sName == "imdg_n8th_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n8th_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n8th_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n8th_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n8th_clss_scg_amt"));
		} else if( sName == "imdg_n9th_clss_scg_amt" ) {
			sheetObj.CellValue2(Row, "imdg_n9th_clss_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_20ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n9th_clss_scg_amt"));
			sheetObj.CellValue2(Row, "imdg_n9th_clss_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "fdr_40ft_ttl_amt")) + parseFloat(sheetObj.CellValue(Row, "imdg_n9th_clss_scg_amt"));
		}
	}
    ...
    function doActionIBSheet(sheetObj,formObj,sAction,msgFlg) {
        ...
        switch(sAction) {
			case IBSEARCH: //Retrieve
	        	...
	        	var sParam = TrsFrmQryString(formObj);
				var sXml = sheetObj.GetSearchXml("ESD_TRS_3009GS.do", sParam);
			...
			case MULTI01: //Dry Save
				...
				var sXml = sheetObj.GetSaveXml("ESD_TRS_3009GS.do", TrsFrmQryString(formObj) + "&" + sParam, true);
			...
			case MULTI03:
				...
				var sParam = ComGetSaveString(sheetObjects[0], true, false) + ComGetSaveString(sheetObjects[1], true, false) + ComGetSaveString(sheetObjects[2], true, false);
			...
			case MULTI04:
				...
				var sXml = sheetObj.GetSaveXml("ESD_TRS_3009GS.do", TrsFrmQryString(formObj), true);
				sheetObj.LoadSaveXml(sXml);
       	...
       	for( var idx = 0 + parseInt(sheetObjOrg.HeaderRows); idx <= sheetObjOrg.LastRow; idx++ ){
			...
			if( findRow > -1 )
			{
				if( document.all.item("tabLayer")[0].style.display == "inline" || document.all.item("tabLayer")[2].style.display == "inline" ){
					...
					sheetObjOrg.CellValue(idx, "imdg_n1st_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n1st_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n2nd_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n2nd_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n2nd_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n2nd_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n3rd_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n3rd_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n3rd_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n3rd_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n4th_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n4th_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n4th_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n4th_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n5th_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n5th_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n5th_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n5th_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n6th_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n6th_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n6th_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n6th_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n7th_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n7th_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n7th_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n7th_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n8th_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n8th_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n8th_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n8th_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "imdg_n9th_clss_svc_flg")		= sheetObjExl.CellValue(findRow, "imdg_n9th_clss_svc_flg");
					sheetObjOrg.CellValue(idx, "imdg_n9th_clss_scg_amt") 		= sheetObjExl.CellValue(findRow, "imdg_n9th_clss_scg_amt");
					sheetObjOrg.CellValue(idx, "load_excel") 					= "OK";
				}
    		}
		}
     ...
     */
 	function getDgCostAdjustmentCal(){
		...
		if( comboObjects[13].Text == "" && comboObjects[16].Text == "" && comboObjects[19].Text == "" ){
			ComShowCodeMessage("COM130201", "Cost Adjustment");
			return false;
		}
		...
		var arrClss2 = comboObjects[16].Code.split(",")
		var arrClss3 = comboObjects[19].Code.split(",")
		...
		//가져온 행을 배열로 반든다.
		var arrRow = iCheckRows.split("|");
		var clssStr = comboObjects[13].Code + "," + comboObjects[16].Code + "," + comboObjects[19].Code;
		var svc_flg = "N";
		var schg_amt = 0;
		for( idx = 0; idx < arrRow.length - 1; idx++ ){
			//Class1
			if( clssStr.indexOf("Class1") > -1 ){
				if( clssStr.substr(clssStr.indexOf("Class1")+7,1) == "1" ){
					...
					schg_amt 	= formObj.in_class1.value;
				} else if( clssStr.substr(clssStr.indexOf("Class1")+7,1) == "2" ){
					svc_flg		= comboObjects[17].Code;
					schg_amt 	= formObj.in_class2.value;
				} else if( clssStr.substr(clssStr.indexOf("Class1")+7,1) == "3" ){
					svc_flg		= comboObjects[20].Code;
					schg_amt 	= formObj.in_class3.value;
				}
				
				sheetObj.CellValue(arrRow[idx], "imdg_n1st_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n1st_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class2") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n2nd_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n2nd_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class3") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n3rd_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n3rd_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class4") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n4th_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n4th_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class5") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n5th_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n5th_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class6") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n6th_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n6th_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class7") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n7th_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n7th_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class8") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n8th_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n8th_clss_scg_amt") = schg_amt;
			}
			...
			if( clssStr.indexOf("Class9") > -1 ){
				...
				sheetObj.CellValue(arrRow[idx], "imdg_n9th_clss_svc_flg") = svc_flg;
				sheetObj.CellValue(arrRow[idx], "imdg_n9th_clss_scg_amt") = schg_amt;
			}
    ...
    function formDeact(){
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n1st_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n1st_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n2nd_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n2nd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n3rd_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n3rd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n4th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n4th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n5th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n5th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n6th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n6th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n7th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n7th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n8th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n8th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n9th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n9th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
    ...
    function formAct(){
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n1st_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n1st_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n2nd_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n2nd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n3rd_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n3rd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n4th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n4th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n5th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n5th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n6th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n6th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n7th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n7th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n8th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n8th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
		...
		sheetObjects[1].InitDataProperty(0, sheetObjects[1].SaveNameCol("imdg_n9th_clss_scg_amt"), 		dtData,				60, daRight, 	true,		"imdg_n9th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			true, 		true);
