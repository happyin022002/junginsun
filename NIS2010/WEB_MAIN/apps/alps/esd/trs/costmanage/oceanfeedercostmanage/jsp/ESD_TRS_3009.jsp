...
<%@ page import="com.hanjin.apps.alps.esd.trs.costmanage.oceanfeedercostmanage.event.EsdTrs3009Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdTrs3009Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		trf_no = ((request.getParameter("trf_no")==null)?"":request.getParameter("trf_no"));
		...
		event = (EsdTrs3009Event)request.getAttribute("Event");
...
<input type="hidden" name="in_ofc_cd" value="<%=strOfc_cd%>">
		       		...
		       		<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width="170"><script language="javascript">ComComboObject('in_cost_trf_no', 1, 120, 1, 1);</script></td>
								<td width="100">Status</td>
								<td width="170"><input type="text" name="cost_trf_sts_nm" style="width:120;text-align:left;" class="input2" readonly></td>
								<td width="90">Update Date</td>
								<td width=""><input type="text" name="upd_dt" style="width:140;text-align:left;" class="input2" readonly></td>
							</tr>
							<tr class="h23">
								<td>Currency</td>
								<td><input type="text" name="curr_cd" style="width:116;text-align:left;" class="input2" readonly></td>
								<td>Effective From</td>
								<td><input type="text" name="eff_fm_dt" style="width:120;text-align:left;" class="input2" readonly></td>
								<td>User</td>
								<td><input type="text" name="upd_usr_id" style="width:140;text-align:left;" class="input2" readonly></td>
							</tr>
						</table>
						<!-- biz_1  (E) -->		
					</td>
						...
						<div id="dgLayer" style="display:none">
							...
							<table class="search" border="0" style="width:979;"> 
								<tr class="h23">
									...
									<td width="110"><script language="javascript">ComComboObject('class1_combo', 1, 110, 1, 0);</script></td>
									...
									<td width="15">||</td>
									<td width="110"><script language="javascript">ComComboObject('class2_combo', 1, 110, 1, 0);</script></td>
									...
									<td width="15">||</td>
									<td width="110"><script language="javascript">ComComboObject('class3_combo', 1, 110, 1, 0);</script></td>
