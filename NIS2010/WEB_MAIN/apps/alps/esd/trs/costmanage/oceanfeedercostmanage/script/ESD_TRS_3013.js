...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_TRS_3013 : esd_trs_3013 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_trs_3013() {
        ...
        switch(sheetID) {
        	case "sheet1":
        		with (sheetObj) {
					...
					var HeadTitle1 = "Flag|Tariff No|Status|Effective\nFrom|From|To|Pre/Post|DIR|Feeder Term|Feeder Term";
					...
					HeadTitle1 += "|Service Provider|Service Provider|OLD\nAGMT|Creation|Creation|Creation|Update|Update|Update|cost_trf_rout_seq|curr_cd";

					var HeadTitle2 = "Flag|Tariff No|Status|Effective\nFrom|From|To|Pre/Post|DIR|RCV|DEL";
					...
					HeadTitle2 += "|Code|Name|OLD\nAGMT|Time|User|Office|Time|User|Office|cost_trf_rout_seq|curr_cd";
					...
					InitDataProperty(0, cnt++, 	dtHidden,			75, daCenter, 	true,		"curr_cd",						false, 		"", 		dfNone, 	0, 			false, 		false);
				}
				break;
            ...
            case "sheet2":
                with (sheetObj) {
                    ...
                    var HeadTitle1 = "Flag|Tariff No|Status|Effective\nFrom|From|To|BND|DIR|Feeder Term|Feeder Term";
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n1st_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n2nd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n3rd_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n4th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n5th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n6th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n7th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n8th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"imdg_n9th_clss_scg_amt",       false, 		"", 		dfFloat, 	2, 			false, 		false);
        ...
        switch(sAction) {
			case IBSEARCH: //Retrieve
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSearchXml("ESD_TRS_3013GS.do", sParam);
			...
			case IBDOWNEXCEL:
				...
				formObj.action = "ESD_TRS_3013EXCEL.do?"+ TrsFrmQryString(formObj);
			    formObj.submit();
			    ComOpenWait(false);
		        break;
    ...
    function validateForm(sheetObj,formObj,sAction){
		switch (sAction) {
			case IBSEARCH:
/*			
				if(comboObjects[0].Code == "" && ComIsEmpty(formObj.eff_to_dt.value) && ComIsEmpty(formObj.from_nod_cd.value) && ComIsEmpty(formObj.hub_nod_cd.value) && ComIsEmpty(formObj.port_nod_cd.value) && ComIsEmpty(formObj.cost_trf_no.value)){
