...
<%@ page import="com.hanjin.apps.alps.esd.trs.costmanage.oceanfeedercostmanage.event.EsdTrs3013Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.Date"%>
<%
	EsdTrs3013Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTrs3013Event)request.getAttribute("Event");
	       			...
	       			<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							...
							<tr class="h23">
								...
								<td width="170">
									<input name="from_nod_cd" type="text" dataformat="engupcomma" style="width:100;">
								...
								<td width="90">To</td>
								<td colspan="3">
									<input name="to_nod_cd" type="text" dataformat="engupcomma" style="width:100;">
