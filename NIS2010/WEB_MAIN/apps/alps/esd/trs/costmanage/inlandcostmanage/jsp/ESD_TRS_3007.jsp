...
<%@ page import="com.hanjin.apps.alps.esd.trs.costmanage.inlandcostmanage.event.EsdTrs3007Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.Date"%>
<%
	EsdTrs3007Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTrs3007Event)request.getAttribute("Event");
...
<input type="hidden" name="excel_chk_incl">
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td>Effective as of</td>
					<td><input type="text" name="eff_to_dt" style="width:80;" class="input" dataformat="ymd" maxlength="8">&nbsp;<img src="img/btns_calendar.gif" name="bnt_eff_to_dt" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
					<td colspan="2"><input type="checkbox" name="chk_incl" value="Y" class="trans" onclick="javascript:fun_incl();">Incl. Unconfirmed Cost</td>
				</tr>
				<tr class="h23">
					...
					<td width="78">Trans Mode</td>
					<td width="100"><script language="javascript">ComComboObject('trsp_crr_mod_cd', 1, 80, 1, 0);</script></td>
				</tr>
				<tr class="h23">
					<td width="78">Bound</td>
					<td><script language="javascript">ComComboObject('io_bnd_cd', 1, 104, 1, 0);</script></td>
					<td>R/D Term</td>
					<td><script language="javascript">ComComboObject('rcv_de_term_cd', 1, 104, 1, 0);</script></td>
					<td>Cost Tariff No</td>
					<td colspan="3">
