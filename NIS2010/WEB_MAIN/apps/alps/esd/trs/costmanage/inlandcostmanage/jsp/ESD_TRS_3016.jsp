...
<%@ page import="com.hanjin.apps.alps.esd.trs.costmanage.inlandcostmanage.event.EsdTrs3016Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdTrs3016Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTrs3016Event)request.getAttribute("Event");
