...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_TRS_3005 : esd_trs_3005 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_trs_3005() {
	...
	switch(sheetNo) {
		case 1:      //sheet1 init
			with (sheetObj) {
				...
				var HeadTitle1 =  "Node/Link|Activity\nGroup|Cost\nElement|Cost\nElement|Cost\nCode|Cost Code Description|20'|20'|20'|40'|40'|40'";
	...
	switch(sAction) {
		case IBSEARCH:		//Retrieve
			if(!validateForm(sheetObj,formObj,sAction)) return;
	   		...
	   		sheetObj.DoSearch4Post("ESD_TRS_3005GS.do", TrsFrmQryString(formObj));
	   		break;
