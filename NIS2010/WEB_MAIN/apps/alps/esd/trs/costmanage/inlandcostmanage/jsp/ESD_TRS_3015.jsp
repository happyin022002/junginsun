...
<%@ page import="com.hanjin.apps.alps.esd.trs.costmanage.inlandcostmanage.event.EsdTrs3015Event"%>
<%
	EsdTrs3015Event  event = null;							//PDTO(Data Transfer Object including Parameters)
	...
	*/
	...
	try {
	   ...
	   //userAuth=account.getAuth();
		...
		event = (EsdTrs3015Event)request.getAttribute("Event");
						...
						<table class="search_in" border="0">
							...
							<tr class="h23">
								...
								<td width="280" class="sm" colspan="2">
									<input name="fm_dt" type="text" style="width:90;text-align:center;" value="" onFocus='removeBarDate(this);' onBlur='trsBlurDate(this);'>&nbsp;&nbsp;~&nbsp;
									<input name="to_dt" type="text" style="width:90;text-align:center;" value="" onFocus='removeBarDate(this);' onBlur='trsBlurDate(this);'>
