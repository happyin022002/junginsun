...
*@FileName : ESD_TES_9034.jsp
*@FileTitle :Volume Adjustment PopUp 화면(TMRFMO)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
<input type="hidden" name="coin_cntr_flg">

<!-- OUTER - POPUP (S)tart -->
<table width="440" class="popup" cellpadding="10">
...
<tr><td valign="top">
		...
		// 수동인 경우 활성화
		if ( "M".equals(calc_tp_cd ) || "S".equals(calc_tp_cd ) ) { 
		%>
		<table width="400" class="search">
				...
				<table width="100%" !class="search_in" border="0">
					...
					<tr class="h23">
						...
						<td><img class="nostar">Gate In/Out</td>
						<td>&nbsp;
								<select style="width:80;"  value="0" name="param_rvis_gate_in_out_cd">
									<option value="" selected>All</option>
									<option value="GI">Gate In</option>
									<option value="GO">Gate Out</option>
								</select>			
						</td>
					</table>
				<!-- : ( Week ) (E) -->
			...
			<table width="100%" class="sbutton">
					...
					<table class="sbutton">
		    			<tr>
	    					...
	    					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
	    					<tr><td><img class="cursor" src="/hanjin/img/button/btng_rowadd.gif" width="65" height="19" border="0" name="btng_rowadd"></td></tr></table></td>
	    					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
	    					<tr><td><img class="cursor" src="/hanjin/img/button/btng_rowdel.gif" width="65" height="19" border="0" name="btn_rowdel"></td></tr></table></td>
						</tr>
					</table>
					</div>
				</td></tr>
