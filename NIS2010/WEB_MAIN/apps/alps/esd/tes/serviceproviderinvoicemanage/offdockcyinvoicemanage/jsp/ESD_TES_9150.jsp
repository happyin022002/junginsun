...
<html>
<head>
<title>Off Dock CY File Import Pop Up</title>
		...
		<!-- TABLE '#D' : ( Search Options : Speed ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="15%"><input type="radio" name="mode" value="D" class="trans" onClick="setColDataFormat(sheet,'wrk_dt','D');" checked>&nbsp;Day</td>
					<td width="85%"><input type="radio" name="mode" value="M" class="trans" onClick="setColDataFormat(sheet,'wrk_dt','M');">&nbsp;Month</td></tr>
				</table>
				<!-- : ( Speed ) (S) -->
