...
* 2015-09-09 김영신 [CHM-201537696] "File Import" 버튼을 "Get CNTR List"로 변경
=========================================================*/
--%>
...
<html>
<head>
<title>Off-dock CY Invoice 관리</title>
...
<!--//
tabindex 속성은 A, AREA, BUTTON, INPUT, OBJECT, SELECT, TEXTAREA 등에 적용가능합니다.
//-->
...
<input type="hidden" name="tml_inv_tp_cd" value="OF"><!--// OFF-DOCK invoice type //-->
...
<input type="hidden"	name="t5sht_tot_cgst_amt" value="">
<input type="hidden"	name="t5sht_tot_sgst_amt" value="">
<input type="hidden"	name="t5sht_tot_igst_amt" value="">
<input type="hidden"	name="t5sht_tot_ugst_amt" value="">
        ...
        <table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td><input class="input" type="text" name="err_inv_no" maxlength="30" style="width:93" onKeyDown='tes_chkInput(this);' onBlur='validateErrInvNo();'></td>
					<%if(conti_cd.trim().equals("E") || ida_ofc_cd.equals("Y")){ %>
					<td !width="">Reverse CHG&nbsp;<input type="checkbox" name="ap_rvs_cng_flg" value="Y" class="trans"></td>
					<%} else{ %>
     	...
     	<table class="search" style="width:997;">
       	<tr><td class="bg" valign="top">
				...
				<tr class="h23">
					...
					<td width="120">&nbsp;<input class="input" type="text" name="yd_cd" value='' maxlength=7 style="width:67" onKeyUp='tes_isApNum(this); this.value=this.value.toUpperCase();' onKeyDown='tes_chkInput(this);' onBlur='validateYardCode(); this.value=this.value.toUpperCase();'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_yard">
				...
				<tr>
					<td colspan="4">
						<table>
							<tr class="h23">
								<td width="45%"><img class="nostar">Target Period</td>
								<td width="55%">&nbsp;&nbsp;<input class="input" type="text" name="fm_prd_dt" style="width:69" value="" maxlength=10 onKeyUp='tes_isNumD(this,"Y"); tes_moveFocus(this,this.form.to_prd_dt,10);' onKeyDown='tes_chkInput(this); tes_isNumD(this,"Y");' onBlur='if(validateDateObj(this)){period_ChkMod();}'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar1">&nbsp;&nbsp;~&nbsp;&nbsp;<input class="input" type="text" name="to_prd_dt" style="width:69" value="" maxlength=10 onKeyUp='tes_isNumD(this,"Y");' onKeyDown='tes_chkInput(this); tes_isNumD(this,"Y");' onBlur='if(validateDateObj(this)){period_ChkMod();}'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar2" ></td>
							</tr>
							<tr class="h23">
			...
			<td class="bg">
				...
				<tr class="h23">
					<td width="100"><img class="nostar">INV AMT</td>
					<td width="120">&nbsp;<input class="input" type="text" name="ttl_inv_amt" maxlength=14 style="width:92;text-align:right;" onKeyUp='tes_isMon(this,"Y",this.form.curr_cd.Code);' onKeyDown='tes_chkInput(this); tes_isMon(this,"Y",this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this,this.form.curr_cd.Code); set_total_amount();"></td>					
					<td width="100"><img class="nostar">TAX</td>
					<td width="120">&nbsp;<input class="input" type="text" name="vat_amt" maxlength=14 style="width:92;text-align:right;" onKeyUp='tes_isMon(this,"Y",this.form.curr_cd.Code);' onKeyDown='tes_chkInput(this); tes_isMon(this,"Y",this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this,this.form.curr_cd.Code); set_total_amount();"></td></tr>
				<tr class="h23">
					<td><img class="nostar">W.H.T</td>
					<td>&nbsp;<input class="input" type="text" name="whld_tax_amt" maxlength=20 style="width:92;text-align:right;" onKeyUp='tes_isMon(this,"Y",this.form.curr_cd.Code);' onKeyDown='tes_chkInput(this); tes_isMon(this,"Y",this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this,this.form.curr_cd.Code); set_total_amount();" readonly></td>
					<td><img class="nostar">Total AMT</td>
					<td>&nbsp;<input class="input" type="text" name="total_amt" maxlength=22 style="width:92;text-align:right;" readonly></td></tr>
				<tr class="h23">
					<td><img class="nostar">Issued DT</td>
					<td>&nbsp;<input class="input" type="text" style="width:69" maxlength=10 name="iss_dt" onKeyUp='tes_isNumD(this,"Y");' onKeyDown='tes_chkInput(this); tes_isNumD(this,"Y");' onBlur='validateDateObj2(this); isValIssSys(this);'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="btns_calendar3"></td>
				...
				<tr class="h23">
					...
					<td>&nbsp;<input class="input" type="text" name="tml_inv_sts_cd2" maxlength=2 value="" style="width:92" class="input" readonly><input type="hidden" name="tml_inv_sts_cd" maxlength=2 value=""></td>
					<td><img class="nostar">Reject STS</td>
					<td>&nbsp;<input class="input" type="text" name="tml_inv_rjct_sts_cd" maxlength=2 value="NL" style="width:92" class="input" readonly><input type="hidden" name="inv_rjct_rmk" value=""></td></tr>
				<tr class="h23">
					<td></td>
					<td colspan="3">&nbsp;</td>
				</tr>
					...
					<tr>
						<td>
							...
							<tr class="h23">
								...
								<td width="90">&nbsp;<input class="input" type="text" style="width:82;text-align:right;" name="ida_cgst_amt" desc= "CGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td width="40"><img class="nostar">SGST</td>
								<td width="90">&nbsp;<input class="input" type="text" style="width:82;text-align:right;" name="ida_sgst_amt" desc= "SGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td width="40"><img class="nostar">IGST</td>
								<td width="90">&nbsp;<input class="input" type="text" style="width:82;text-align:right;" name="ida_igst_amt" desc= "IGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td width="40"><img class="nostar">UGST</td>
								<td width="90">&nbsp;<input class="input" type="text" style="width:82;text-align:right;" name="ida_ugst_amt" desc= "UGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td></td>
								<td>&nbsp;</td>
		...
		<table class="search">
        		<tr><td class="bg">
        			...
        			<table border="0" class="grid2" background-color:white;>
        				<tr>
        					<td width="170" class="tr2_head">Cost Group</td>
        					<td width="250">&nbsp;&nbsp;<b>TMNL</b><input type="checkbox" name="TMNL" value="" class="trans" onClick="setRadioOptionEnable(); setCalcCostCond();" checked>&nbsp;&nbsp;&nbsp;<b>Storage Day</b><input type="checkbox" name="StorageDay" value="" class="trans" onClick="setRadioOptionEnable(); setCalcCostCond();" checked></td>
        					<td width="180" class="tr2_head">Cost Calc. Method</td>
        					<td width="360">&nbsp;&nbsp;<b>Gate In & Out</b><input type="radio" name="CostCalcMethod" value="TP" class="trans" onClick="setCalcCostCond();">&nbsp;&nbsp;&nbsp;<b>Period</b><input type="radio" name="CostCalcMethod" value="SP" class="trans" onClick="setCalcCostCond();"></td>
        				</tr>
        			</table>
...
<div id="tabLayer" style="display:inline">
     	...
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table width="100%" class="sbutton">
	       	<tr><td class="align">
			    <table class="sbutton">
			    <tr><td class="bt"><img class="cursor" src="/hanjin/img/bu_next01.gif" width="20" height="11" border="0" onClick="showSummary();"></td></tr>
				</table>
		...
		<div id="SearchLayer02" style="display:inline">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td width="4%">Total</td>
					<td width="15%"><input type="text" name='sht_01_ttl_box' value='' style="width:80" class="input" readonly></td>
					<td width="3%">Full</td>
					<td width="14%"><input type="text" name='sht_01_full' value='' style="width:80" class="input" readonly></td>
					<td width="3%">Empty</td>
					<td width="15%"><input type="text" name='sht_01_mt' style="width:80" class="input" readonly></td>
					<!--td width="7%">TS(BKG)</td>
					<td width="14%"><input type="text" name='sht_01_ts_bkg' style="width:80" class="input" readonly></td-->
					<td width="13%">TS(Same Yard)</td>
					<td><input type="text" name='sht_01_ts_same_yard' style="width:80" class="input" readonly></td></tr>
			</table>
			<table class="search_in" border="0">
				<tr class="h23">
					<td width="18">D2 </td><td width="40"><input type="text" name="sht_01_D2" style="width:32" class="input" readonly></td>
					<td width="18">D4 </td><td width="40"><input type="text" name="sht_01_D4" style="width:32" class="input" readonly></td>
					<td width="18">D5 </td><td width="40"><input type="text" name="sht_01_D5" style="width:32" class="input" readonly></td>
					<td width="18">D7 </td><td width="40"><input type="text" name="sht_01_D7" style="width:32" class="input" readonly></td>
					<td width="18">D8 </td><td width="40"><input type="text" name="sht_01_D8" style="width:32" class="input" readonly></td>
					<td width="18">D9 </td><td width="40"><input type="text" name="sht_01_D9" style="width:32" class="input" readonly></td>
					<td width="18">DW </td><td width="40"><input type="text" name="sht_01_DW" style="width:32" class="input" readonly></td>
					<td width="18">DX </td><td width="40"><input type="text" name="sht_01_DX" style="width:32" class="input" readonly></td>
					<td width="18">R2 </td><td width="40"><input type="text" name="sht_01_R2" style="width:32" class="input" readonly></td>
					<td width="18">R4 </td><td width="40"><input type="text" name="sht_01_R4" style="width:32" class="input" readonly></td>
					<td width="18">R5 </td><td width="40"><input type="text" name="sht_01_R5" style="width:32" class="input" readonly></td>
					<td width="18">R7 </td><td width="40"><input type="text" name="sht_01_R7" style="width:32" class="input" readonly></td>
					<td width="18">R8 </td><td width="40"><input type="text" name="sht_01_R8" style="width:32" class="input" readonly></td>
					<td width="18">R9 </td><td width="40"><input type="text" name="sht_01_R9" style="width:32" class="input" readonly></td>
					<td width="18">F2 </td><td width="40"><input type="text" name="sht_01_F2" style="width:32" class="input" readonly></td>
					<td width="18">F4 </td><td width="40"><input type="text" name="sht_01_F4" style="width:32" class="input" readonly></td></tr>
				<tr class="h23">				    
					<td>F5</td><td><input type="text" name="sht_01_F5" style="width:32" class="input" readonly></td>
					<td>O2</td><td><input type="text" name="sht_01_O2" style="width:32" class="input" readonly></td>
					<td>O4</td><td><input type="text" name="sht_01_O4" style="width:32" class="input" readonly></td>
					<td>O5</td><td><input type="text" name="sht_01_O5" style="width:32" class="input" readonly></td>
					<td>O7</td><td><input type="text" name="sht_01_O7" style="width:32" class="input" readonly></td>
					<td>S2</td><td><input type="text" name="sht_01_S2" style="width:32" class="input" readonly></td>
					<td>S4</td><td><input type="text" name="sht_01_S4" style="width:32" class="input" readonly></td>
					<td>T2</td><td><input type="text" name="sht_01_T2" style="width:32" class="input" readonly></td>
					<td>T4</td><td><input type="text" name="sht_01_T4" style="width:32" class="input" readonly></td>
					<td>A2</td><td><input type="text" name="sht_01_A2" style="width:32" class="input" readonly></td>
					<td>A4</td><td><input type="text" name="sht_01_A4" style="width:32" class="input" readonly></td>
					<td>A5</td><td><input type="text" name="sht_01_A5" style="width:32" class="input" readonly></td>
					<td>P2</td><td><input type="text" name="sht_01_P2" style="width:32" class="input" readonly></td>
					<td>P4</td><td><input type="text" name="sht_01_P4" style="width:32" class="input" readonly></td>
					<!-- 
					<td>Z2</td><td><input type="text" name="sht_01_Z2" style="width:32" class="input" readonly></td>
					<td>Z4</td><td><input type="text" name="sht_01_Z4" style="width:32" class="input" readonly></td>
					-->
					<td>C2</td><td><input type="text" name="sht_01_C2" style="width:32" class="input" readonly></td>
					<td>C4</td><td><input type="text" name="sht_01_C4" style="width:32" class="input" readonly></td>
					</tr>
			</table>
				<!-- : ( Week ) (E) -->
		</div>
				...
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t1btng_fileimport" id="t1btng_fileimport">Get CNTR List</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" name='t3sht_tot_inv_amt' class="input" style="width:150;text-align:right;" readonly></td></tr>
			</table>
			...
			<table width="100%" class="button">
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t3btng_costCal" id="t3btng_costCal">Cost Calculation (AGMT)</td>						
							<td class="btn2_right"></td></tr></table></td>							
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t3btng_listclear" id="t3btng_clear">List Clear</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table border="0" cellpadding="0" cellspacing="0"><tr>
							<td><input type="text" name="t3rowsadd" size="2" value="1" maxlength="4"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" name='t4sht_tot_inv_amt' class="input" style="width:150;text-align:right;" readonly></td></tr>
			</table>
			...
			<table width="100%" class="button">
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t4btng_costCal" id="t4btng_costCal">Cost Calculation (AGMT)</td>						
							<td class="btn2_right"></td></tr></table></td>							
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t4btng_listclear" id="t4btng_listclear">List Clear</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table border="0" cellpadding="0" cellspacing="0"><tr>
							<td><input type="text" name="t4rowsadd" size="2" value="1" maxlength="4"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" name='t5sht_tot_inv_amt' class="input" style="width:150;text-align:right;" readonly></td></tr>
			</table>
			...
			<table width="100%" class="button">
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_listclear" id="t5btng_listclear">List Clear</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_fileimport" id="t5btng_fileimport">File Import</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_rowdel" id="t5btng_rowdel">Delete</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table border="0" cellpadding="0" cellspacing="0"><tr>
							<td><input type="text" name="t5rowsadd" size="2" value="1" maxlength="4"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_rowadd" id="t5btng_rowadd">Row Add</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_save" id="t5btng_save">Save</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_totalamount" id="t5btng_totalamount">Total Amount</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="t5btng_confirm" id="t5btng_confirm">Confirm</td>
							<td class="btn2_right"></td></tr></table></td>
						<!-- Repeat Pattern -->
...
<input type="text" class="input2" name="txt3" value="txt3">
<input type="text" class="input2_2" name="txt4" value="txt4">
-->
