/**
 * @fileoverview Off-Dock CY Container List - Tab Cost Calc.(TMNL) - Revised Volume TO Input 에서 사용하는 업무 스크립트를 정의한다.
 * @author SM LINE
 */

/**
 * @extends Tes
 * @class ESD_TES_9074 : Off-Dock CY Container List - Tab Cost Calc.(TMNL) - Revised Volume TO Input 에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TES_9074() {
    ...
    function processButtonClick(){
    	 ...
    	 try {
    		...
    		if( e == "[object Error]") {
    			ComShowMessage(getMsg('TES23028')); //showErrMessage("지금은 사용하실 수가 없습니다");
    		} else {
    			ComShowMessage(e);
    		}
    	}
        ...
        switch(sheetNo) {
             case 1:      //sheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++, dtCheckBox,   30,    daCenter,  false,    "tml_rvis_ind_flg",        false,          "",       dfNone,    0,     false,       false);
					//InitDataProperty(0, cnt++, dtStatus,     30,    daCenter,  false,    "ibflag");
                    InitDataProperty(0, cnt++, dtSeq,        50,    daCenter,  false,    "",        false,          "",       dfNone,    0,     false,       false);
                    InitDataProperty(0, cnt++, dtData,      90,    daCenter,  false,    "lgs_cost_cd",        false,          "",       dfNone,    0,     false,       false);
                    ...
                    InitDataProperty(0, cnt++, dtData,       90,    daLeft,	   false,   "cntr_rmk",       false,          "",       dfNone,    0,     false,       false);
					...
					InitDataProperty(0, cnt++, dtHidden,     30,    daCenter,  false,    "cntr_tpsz_cd",        false,          "",       dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,     30,    daCenter,  false,    "cntr_sty_cd",        false,          "",       dfNone,    0,     false,       false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
		   case IBSEARCH:      //조회
			    ...
			    sheetObj.DoSearch4Post("ESD_TES_9074Popup.do", tesFrmQryStr(formObj));
			    break;
