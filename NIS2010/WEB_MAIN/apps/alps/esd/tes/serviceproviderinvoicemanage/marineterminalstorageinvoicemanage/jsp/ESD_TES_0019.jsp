...
<%@ page import="com.hanjin.apps.alps.esd.tes.serviceproviderinvoicemanage.marineterminalstorageinvoicemanage.event.EsdTes0019Event"%>
<%
...
<html>
<head>
<title>Marine Terminal Storage Container List 조회 - Coincidence</title>
...
<input type="hidden" name="hld_rmk" value="">
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="135"><input class="input2" type="text" style="width:115" value=""  name ="vndr_seq_name" valid="1" class="input2" readOnly ></td>
					<td width="81"><img class="nostar">INV No</td>
					<td width="135"><input class="input1" type="text" name="inv_no" value="" tabindex='2' maxlength="30" style="width:129" onKeyPress='tes_enterCheck("retrieve");' onKeyDown='tes_chkInput(this);' onBlur='validateInvDupChk();'></td>
					...
					<td width="150"><input type="text" name="err_inv_no" maxlength="30" style="width:93" onKeyDown='tes_chkInput(this);' onBlur='validateErrInvNo();' readonly></td>
				...
				<tr class="h23">
					...
					<td colspan="2"><input class="input" type="text" style="width:93;" name="dbt_note_no" maxlength="30" onKeyDown='tes_chkInput(this);' readonly></td>
				</tr>
				</table>
				</div>
				<!-- : ( Week ) (E) -->
        	...
        	<tr><td class="bg">
        		...
        		<table border="0" class="grid2" background-color:white;>
						...
						<td width="147" class="tr2_head">Yard Name</td>
        					<td width="113"><input name="yd_nm" type="text" class="noinput" style="width:120" value="" readonly></td>
        				</tr>
						<tr>
							...
							<td class="tr2_head">Effective Date</td>
        					<td><input name="eff_dt" type="text" class="noinput" style="width:80" value="" readonly></td>
        				</tr>
						<tr>
						...
						<tr>
        					...
        					<td><input name="tml_inv_rjct_sts_cd" type="text" class="noinput" style="width:80" value=""></td>
							<td class="tr2_head">Period</td>
        					<td colspan="5"><input name="fm_prd_dt" type="text" class="noinput" style="width:200" value="" readonly></td>
        				</tr>
        		</table>
...
<!-- UI_ESD_TES_019 : THIS IS 1st TAB -->
       	...
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					...
					<td width="3%">Empty</td>
					<td width="15%"><input type="text" style="width:80" name='sht_01_mt' readonly></td>
					<td width="13%">TS(Same Yard)</td>
					<td><input type="text" style="width:80" name='sht_01_ts_same_yard' readonly></td></tr>
			</table>
			<table class="search_in" border="0">
				<tr class="h23">
...
<!-- UI_ESD_TES_052 : THIS IS 2st TAB -->
...
<!-- UI_ESD_TES_053 : THIS IS 3st TAB -->
<div id="tabLayer" style="display:none">
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" style="width:100;text-align:right;" name="ttl_calc_amt1" value="" readonly></td></tr>
			</table>
...
<!-- UI_ESD_TES_054 : THIS IS 4st TAB -->
<div id="tabLayer" style="display:none">
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" style="width:100;text-align:right;" name="ttl_calc_amt2" readonly></td></tr>
			</table>
