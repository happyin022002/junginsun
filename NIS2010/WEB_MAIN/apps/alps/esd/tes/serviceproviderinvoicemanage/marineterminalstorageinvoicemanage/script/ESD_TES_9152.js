/**
 * @fileoverview Marine Terminal Storage Invoice Creation & Correction -- FileUpload Freepool 화면에서 사용하는 업무 스크립트를 정의한다.
 * @author SM LINE
 */

/**
 * @extends Tes
 * @class ESD_TES_9152 : Marine Terminal Storage Invoice Creation & Correction -- FileUpload Freepool 화면에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TES_9152() {
    ...
    function loadPage() {
		...
		// eBilling - B
		if (window.dialogArguments.document.form.edi_flg.value == 'Y'){
			document.form.mode[0].disabled = true;
			document.form.mode[1].disabled = true;
	 ...
	 /**
	  * Cost Calc.(SR by FP) sheet의 data 삭제
	  * @return
	  */
	function chkOprShtData(){
		...
		if (hasOprShtData()){
			...
			if (!confirm(ComGetMsg('TES40012'))){
				...
				window.dialogArguments.removeStorageInvoice02();
				window.focus();
			}
			return false;
		}
	...
	/**
	 * CALC.ByPool sheet의 data가 존재하는지 확인 
	 * @return
	 */		
	function hasOprShtData(){
		var opener_sheet_obj;
		/* CALC.ByPool sheet의 data를 존재여부 확인... */
		opener_sheet_obj = opener_obj.document.t4sheet1;
             ...
             case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
					...
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "tml_agmt_ofc_cty_cd",        false,          "",    dfNone,    0,     false,       false);

					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "tml_agmt_seq",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "tml_agmt_ver_no",        false,          "",    dfNone,    0,     false,       false);
					...
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "lgs_cost_cd",        false,          "",    dfNone,    0,     false,       false);

					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "lgs_cost_cd2",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       80,    daCenter,  true,    "stk_vol_qty",        false,          "",    dfInteger,    0,     false,       false);
                    InitDataProperty(0, cnt++, dtHidden,       80,    daCenter,  true,    "fp_teu_qty",        false,          "",    dfInteger,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "diff_vol_qty",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "ovr_vol_qty",        false,          "",    dfNone,    0,     false,       false);

					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "vol_tr_ut_cd",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "ctrt_rt",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "calc_amt",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,       50,    daCenter,  true,    "fp_calc_prd_cd",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,	   50,    daCenter,  true,    "acct_cd",        false,          "",    dfNone,    0,     false,       false);

					InitDataProperty(0, cnt++, dtHidden,	   50,    daCenter,  true,    "calc_cost_grp_cd",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,	   50,    daCenter,  true,    "calc_tp_cd",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,	   80,    daCenter,  true,    "dup_chk_idx",        false,          "",    dfNone,    0,     false,       false);
					InitDataProperty(0, cnt++, dtHidden,	   80,    daCenter,  true,    "curr_chk",        false,          "",    dfNone,    0,     false,       false);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
           ...
           case IBSEARCH:      //조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_TES_9152Popup.do", param+'&'+tesFrmQryStr(formObj),"",true);
           ...
           case IBSEARCH_ASYNC01:
                ...
                var searchXml = sheetObj.GetSearchXml("ESD_TES_9152Popup.do", tesFrmQryStr(formObj),"",true);
                sheetObj.RemoveAll();
