...
/**
 * @extends Tes
 * @class ESD_TES_0012 : GST Invoice Summary (India) 화면에서 사용하는 업무 스크립트를 정의한다.
 */
...
/*               var HeadTitle0 = " |SO OFC|SO SEQ|CSR\nNo.|CSR\nST|INV\nType|Tml INV TP Cd|Inv. No.|VVD|Inv\nST|REJ.|CRED\nDT|CRED\nUser ID|Inv. OFC||Cost OFC||Yard CD||CURR|INV RCV DT|INV ISS DT|INV UPDT DT|INV CNFM DT|CSR RQST DT|CSR I/F DT|P.\nD/Date|P.ST|Hold|Vendor||VAT AMT|WHT AMT|INV. AMT|Calculation Method (AMT)|Calculation Method (AMT)|Calculation Method (AMT)|RJCT RMK|EDI|Retroactive";
               ...
               */
               var HeadTitle0 ="|Seq.|SO OFC|SO SEQ|Invoice\nOffice|Cost\nOffice|SM Line|SM Line|Service Provider|Service Provider|S/P Code|S/P Name|Invoice No.|VVD|Invoice\nIssue Date|Invoice\nReceived Date|Invoice\nCreation Date|Invoice\nConfirm Date|Invoice\nCreator ID|Yard\nCode|Invoice\nType|Invoice\nStatus|Reject\nStatus|CSR No.|CSR\nStatus|HSN/SAC|HSN/SAC Description|Goods/\nServices|Reverse\nCharge|Hold|Cur.|Invoice\nAmount|CGST|CGST|SGST|SGST|IGST|IGST|UGST|UGST|GST Sum|GST Sum|Total Amount\n(Invoice+GST)";
               var HeadTitle1 ="|Seq.|SO OFC|SO SEQ|Invoice\nOffice|Cost\nOffice|GSTIN/UIN|State\nCode|GSTIN/UIN|State\nCode|S/P Code|S/P Name|Invoice No.|VVD|Invoice\nIssue Date|Invoice\nReceived Date|Invoice\nCreation Date|Invoice\nConfirm Date|Invoice\nCreator ID|Yard\nCode|Invoice\nType|Invoice\nStatus|Reject\nStatus|CSR No.|CSR\nStatus|HSN/SAC|HSN/SAC Description|Goods/\nServices|Reverse\nCharge|Hold|Cur.|Invoice\nAmount|Rate|AMT|Rate|AMT|Rate|AMT|Rate|AMT|Rate|AMT|Total Amount\n(Invoice+GST)";
               //행정보설정[필수][HEADROWS,DATAROWS,VIEWROWS,ONEPAGEROWS=100]
               InitRowInfo( 2, 1, 9, 100);

               //컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
               InitColumnInfo(49, 2, 0, true);
//               InitColumnInfo(ComCountHeadTitle(HeadTitle0), 8, 0, true);
               ...
               //|State\nCode|GSTIN/UIN|State\nCode
               InitDataProperty(0, cnt++, dtData,        120,    daCenter,  true,   "cst_ofc_gst_no",               false,          "",       dfNone,    0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        50,    daCenter,  true,    "cst_ofc_ste_cd",               false,          "",       dfNone, 0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        120,    daCenter,  true,    "vndr_gst_no",               false ,          "",       dfNone, 0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        50,    daCenter,  true,    "vndr_ste_cd",               false,          "",       dfNone, 0,     false,       false);
               ...
               InitDataProperty(0, cnt++, dtData,        150,    daLeft,  true,   "inv_no",               false,          "",       dfNone,    0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        130,    daLeft,  true,     "vvd",               false,          "",       dfNone,    0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        95,    daCenter,  true,    "iss_dt",               false,          "",       dfDateYmd, 0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        95,    daCenter,  true,    "rcv_dt",               false,          "",       dfDateYmd, 0,     false,       false);
               
               InitDataProperty(0, cnt++, dtData,        95,    daCenter,  true,    "cre_dt",               false,          "",       dfDateYmd, 0,     false,       false);
               InitDataProperty(0, cnt++, dtData,        95,    daCenter,  true,    "inv_cfm_dt",               false,          "",       dfDateYmd, 0,     false,       false);
               ...
               InitDataProperty(0, cnt++, dtData,        50,    daCenter,  true,    "tml_inv_sts_cd",       false,          "",       dfNone,    0,     false,       false);            
               InitDataProperty(0, cnt++, dtData,        50,    daCenter,  true,    "tml_inv_rjct_sts_cd",  false,          "",       dfNone,    0,     false,       false);
               ...
               InitDataProperty(0, cnt++ , dtData,    200,    daLeft,  true,     "ida_sac_nm"           ,       false,          "",       dfNone,    0,     true,       true);
               //HSN/SAC Description 
               InitDataProperty(0, cnt++ , dtCombo,    75,    daCenter,  true,    "ida_pay_tp_cd"        ,       false,          "",       dfNone,    0,     true,       true);
               InitDataProperty(0, cnt++ , dtData,       60  ,    daCenter,  true,    "ap_rvs_cng_flg"     ,     false,          "",       dfNone,         0,     true,      true);
               ...
               InitDataProperty(0, cnt++, dtAutoSum,     140,    daRight ,  true,    "inv_amt",          false,          "",       dfFloat,   2,     false,       false);
               InitDataProperty(0, cnt++ , dtAutoAvg,    50,    daRight ,  false,    "ida_cgst_rto"         ,       false,          "",       dfFloat,   2,     true,       true);
               InitDataProperty(0, cnt++ , dtAutoSum,    70,    daRight ,  false,    "ida_cgst_amt"         ,       false,          "",       dfFloat,   2,     true,       true);
               
               InitDataProperty(0, cnt++ , dtAutoAvg,    50,    daRight ,  false,    "ida_sgst_rto"         ,       false,          "",       dfFloat,   2,     true,       true);
               InitDataProperty(0, cnt++ , dtAutoSum,    70,    daRight ,  false,    "ida_sgst_amt"         ,       false,          "",       dfFloat,   2,     true,       true);
               InitDataProperty(0, cnt++ , dtAutoAvg,    50,    daRight ,  false,    "ida_igst_rto"         ,       false,          "",       dfFloat,   2,     true,       true);
               InitDataProperty(0, cnt++ , dtAutoSum,    70,    daRight ,  false,    "ida_igst_amt"         ,       false,          "",       dfFloat,   2,     true,       true);
               InitDataProperty(0, cnt++ , dtAutoAvg,    50,    daRight ,  false,    "ida_ugst_rto"         ,       false,          "",       dfFloat,   2,     true,       true);
               
               InitDataProperty(0, cnt++ , dtAutoSum,    70,    daRight ,  false,    "ida_ugst_amt"         ,       false,          "",       dfFloat,   2,     true,       true);
               InitDataProperty(0, cnt++ , dtAutoAvg,    50,    daRight ,  false,    "ida_gst_rto"          ,       false,          "",       dfFloat,   2,     false,      false);
               InitDataProperty(0, cnt++ , dtAutoSum,    90,    daRight ,  false,    "ida_gst_amt"          ,       false,          "",       dfFloat,   2,     false,      false);
               //Total Amount\n(Invoice+GST)
               InitDataProperty(0, cnt++, dtAutoSum,      120,    daRight,  true,    "total_amt",        false,          "",       dfFloat,    2,     false,       false);
        ...
        switch(sAction) {
           ...
           case IBSEARCH:      //조회
                 if(validateForm(sheetObj,formObj,sAction)){
                     ...
                     sheetObj.DoSearch4Post("ESD_TES_0012GS.do", tesFrmQryStr(formObj));
                 }
            ...
            case IBSAVE:        //저장
		        ...
		        var savexml = sheetObj.GetSaveXml("ESD_TES_0012GS.do", param+'&'+tesFrmQryStr(formObj));
    ...
    */  
    ...
    function sheet1_OnSearchEnd(sheetObj){
        ...
        for(var i=sheetObj.HeaderRows; i<sheetObj.HeaderRows+sheetObj.RowCount; i++){
            ...
            sheetObj.CellFont("FontBold", i,'inv_amt') = true;
            sheetObj.CellFont("FontBold", i,'ida_gst_amt') = true;
