...
<%@ page import="com.hanjin.apps.alps.esd.tes.serviceproviderinvoicemanage.marineterminalinvoicemanage.event.EsdTes0013Event"%>
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="100"><img class="nostar">Invoice OFC</td>
					...
					<td width="92"><img class="nostar">Invoice STS</td>
				...
				<tr class="h23">
					...
					<td><img class="nostar">CSR STS</td>
					<td>
					...
					<td width="92" style="padding-left:0"><img class="nostar">Reject &nbsp;STS</td>
			...
			<table width="100%" class="button">
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_toinvcorrection" id="btng_toinvcorrection">Modify Invoice</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_cntrlist" id="btng_cntrlist">View Invoice</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							...
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_rejectlift" id="btng_rejectlift">Reject Lift</td>
							<td class="btn2_right"></td></tr></table></td>
						<!-- Repeat Pattern -->
