			    			...
			    			<tr>
			    				...
			    				<%if(rvis_div!=null && !rvis_div.trim().equals("")){ %>
			    					<%if(edi_flg.equalsIgnoreCase("Y")){ %>
				    					...
				    					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				    					<tr><td><img src="/hanjin/img/button/btng_rowadd.gif" width="65" height="19" border="0"></td></tr></table></td>
				    					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
				    					<tr><td><img src="/hanjin/img/button/btng_rowdel.gif" width="65" height="19" border="0"></td></tr></table></td>
			    					<%} else {%>
			    					    <td class="sm"><b>Row Count</b><input name="row_count" type="text" style="width:30; height:19; text-align:right" value="1" maxlength="3" onFocus="javascript:select()"></td>
				    					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
