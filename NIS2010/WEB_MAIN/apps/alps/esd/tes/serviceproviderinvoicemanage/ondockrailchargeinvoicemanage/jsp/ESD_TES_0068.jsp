...
<%@ page import="com.hanjin.apps.alps.esd.tes.serviceproviderinvoicemanage.ondockrailchargeinvoicemanage.event.EsdTes0068Event"%>
<%
...
<html>
<head>
<title>On-dock Rail Charge Container List 조회</title>
       	...
       	<tr><td class="bg">
     		...
     		<table class="search_in" border="0">
				...
				<tr class="h23">
					...
					<td width="90"><input type="text" style="width:115" value=""  name ="vndr_seq_name" class="input2" readOnly ></td>
					...
					<td width="110"><input type="text" name="err_inv_no" style="width:93;" maxLength="30" onBlur='validateErrInvNo();'readonly></td>
		...
		<table class="search">
        	<tr><td class="bg">
        			...
        			<table border="0" class="grid2" background-color:white;>
						...
						<td width="122"><input name="inv_ofc_cd" type="text" class="noinput" style="width:80" value="" readonly></td>
        					<td width="122" class="tr2_head">Yard Code</td>
        					<td width="110"><input name="yd_cd" type="text" class="noinput" style="width:80" value="" readonly></td>
						...
						<tr>
        					...
        					<td align="center">
        					<table border="0" cellpadding="0" cellspacing="0">
        					<input type="hidden" name="hld_rmk" maxlength=500 value="">
        					<tr>
        						<td style="border-width:0;"><input name="hld_flg" type="text" class="noinput" style="width:18" value="" readonly>&nbsp;</td>
        						<td style="border-width:0;">
		        					<table width="80" border="0" cellpadding="0" cellspacing="0" class="button">
								     <tr>
								     	<td class="btn2_left" style="padding:0; border:0;"></td>
								     	<td class="btn2" name="btns_remarks" style="padding:0; border:0;"  id="btns_remarks">Remarks</td>
			...
			<td <%if(ida_ofc_cd.equals("Y")){ %>class="bg"<%} %>> 
				...
				<table border="0" class="grid2" background-color:white;>
							<tr>
								...
								<td><input class="noinput" type="text" style="text-align:right;width:60"  name="ida_cgst_amt"  valid="1" desc= "CGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();" readonly></td>
							</tr>
							<tr>
								<td class="tr2_head" style="width:55">SGST</td>
								<td><input class="noinput" type="text" style="text-align:right; width:60" name="ida_sgst_amt"  valid="1" desc= "SGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"readonly></td>
							</tr>
							<tr>
								<td class="tr2_head" style="width:55">IGST</td>
								<td><input class="noinput" type="text" style="text-align:right; width:60" name="ida_igst_amt"  valid="1" desc= "IGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"readonly></td>
							</tr>
							<tr>
								<td class="tr2_head" style="width:55">UGST</td>
								<td><input class=noinput type="text" style="text-align:right; width:60" name="ida_ugst_amt"  valid="1" desc= "UGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"readonly></td>
							</tr>
					</table>
					</div>
				</td>
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" style="width:100" name = "ttl_calc_amt1" readonly></td></tr>
			</table>
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td width="4%">Total</td>
					<td width="15%"><input type="text" style="width:80" name='sht_01_ttl_box' readonly></td>
					<td width="3%">Full</td>
					<td width="14%"><input type="text" style="width:80" name='sht_01_full' readonly></td>
					<td width="3%">Empty</td>
					<td><input type="text" style="width:80" name='sht_01_mt' readonly></td></tr>
			</table>
			<table class="search_in" border="0">
				<tr class="h23">
					<td width="18">D2 </td><td width="40"><input type="text" style="width:32" name="sht_01_D2" readonly></td>
					<td width="18">D4 </td><td width="40"><input type="text" style="width:32" name="sht_01_D4" readonly></td>
					<td width="18">D5 </td><td width="40"><input type="text" style="width:32" name="sht_01_D5" readonly></td>
					<td width="18">D7 </td><td width="40"><input type="text" style="width:32" name="sht_01_D7" readonly></td>
					<td width="18">D8 </td><td width="40"><input type="text" style="width:32" name="sht_01_D8" readonly></td>
					<td width="18">D9 </td><td width="40"><input type="text" style="width:32" name="sht_01_D9" readonly></td>
					<td width="18">DW </td><td width="40"><input type="text" style="width:32" name="sht_01_DW" readonly></td>
					<td width="18">DX </td><td width="40"><input type="text" style="width:32" name="sht_01_DX" readonly></td>
					<td width="18">R2 </td><td width="40"><input type="text" style="width:32" name="sht_01_R2" readonly></td>
					<td width="18">R4 </td><td width="40"><input type="text" style="width:32" name="sht_01_R4" readonly></td>
					<td width="18">R5 </td><td width="40"><input type="text" style="width:32" name="sht_01_R5" readonly></td>
					<td width="18">R7 </td><td width="40"><input type="text" style="width:32" name="sht_01_R7" readonly></td>
					<td width="18">R8 </td><td width="40"><input type="text" style="width:32" name="sht_01_R8" readonly></td>
					<td width="18">R9 </td><td width="40"><input type="text" style="width:32" name="sht_01_R9" readonly></td>
					<td width="18">F2 </td><td width="40"><input type="text" style="width:32" name="sht_01_F2" readonly></td>
					<td width="18">F4 </td><td width="40"><input type="text" style="width:32" name="sht_01_F4" readonly></td></tr>
				<tr class="h23">					
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" style="width:100" name = "ttl_calc_amt2" readonly></td></tr>
			</table>
		...
		<!-- TABLE '#D' : ( Tab BG Box ) (S) -->
     	<table class="search" border="0">
       	<tr><td class="bg">
			...
			<table class="search_in" border="0">
				<tr class="h23">
					<td align="right">Calculated AMT&nbsp;&nbsp;<input type="text" style="width:100" name = "ttl_calc_amt3" readonly></td></tr>
			</table>
