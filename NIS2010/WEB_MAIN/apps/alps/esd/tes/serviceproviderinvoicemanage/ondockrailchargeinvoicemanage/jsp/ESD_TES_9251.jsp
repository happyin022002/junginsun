...
*@FileTitle : TES 3rd Party Billing Inquiry Popup화면-Marine Terminal Invoice
*Open Issues :
*Change history :
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<table width="100%" class="sbutton">
				    ...
				    <table class="sbutton">
				    <tr><!--td class="bt"><img class="cursor" src="/hanjin/img/button/btng_rowadd.gif" width="65" height="19" border="0" name="btng_rowadd"></td>
						<td class="bt"><img class="cursor" src="/hanjin/img/button/btng_delete.gif" width="65" height="19" border="0" name="btng_rowdel"></td-->
						<td class="bt"><!--<img class="cursor" src="/hanjin/img/button/btng_interfaceto3rd.gif" width="185" height="19" border="0" name="btng_interfaceto3rd"></td>--></tr>
				    </table>
