...
<%@ page import="com.hanjin.apps.alps.esd.tes.serviceproviderinvoicemanage.ondockrailchargeinvoicemanage.event.EsdTes0064Event"%>
...
<input type="hidden"	name="tml_inv_tp_cd"		value="ON">
<input type="hidden"	name="max_wrk_dt"			value="">
<input type="hidden"	name="min_wrk_dt"			value="">
...
------------------------------------------------------------------------>
<input type="hidden" name="yd_chr_inv_tp_cd" value="">
<input type="hidden" name="calcOnDockComboItems" value="">
<input type="hidden" name="cntrTpszComboItems" value="">

<input type="hidden" name="calcOnDockComboItemsDesc" value="">
...
<!--	Retroactive Invoice 처리를 위한 추가 - 변경시 비교를 위해 조회시 값. ( 2010-10-15 )	-->
...
<tr><td>
     	...
     	<table class="search" width=100%>
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="100" class="stm"><input class="input1" type="text" style="width:68" name="vndr_seq" desc= "VNDR Code" value='' tabindex='1' maxlength=6 onKeyUp='tes_isNum(this);' onBlur='validateVndrSeq();'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_vndr">
					</td>
					...
					<td width="90"><input type="text" style="width:115" value=""  name ="vndr_seq_nm" class="input2" readOnly ></td>

					<td width="62"><img class="nostar">INV No</td>
					<td width="100"><input class="input1" type="text" style="width:128" name="inv_no"  desc= "Inv. No." tabindex='2' onKeyPress='enterCheck("retrieveEvent");' onBlur='validateInvDupChk();'></td>
					...
					<td width="110"><input type="text" name="err_inv_no" style="width:93;" maxLength="30" onBlur='validateErrInvNo();'></td>
				...
				<tr class="h23">
					...
					<td width="75" class="stm"><input type="text" style="width:90" value=""  name ="ida_gst_rgst_ste" class="input2" readOnly ></td>
					<td width="35"><img class="nostar">GSTIN/UIN</td>
					<td width="90"><input type="text" style="width:115" value=""  name ="ida_gst_rgst_no" class="input2" readOnly ></td>
					<td width="60"><img class="nostar">State</td>
					<td width="132"><input class="input2" type="text" style="width:20" name="ida_ste_cd" readOnly >&nbsp;<input class="input2" type="text" style="width:105" name="ida_ste_nm" valid="1" readOnly ></td>
     	...
     	<table class="search_in" width="100%">
       	<tr><td class="bg" valign="top">
				...
				<tr class="h23">
					...
					<td width="120">&nbsp;<input class="input1" type="text" style="width:68"  name="yd_cd" valid="1" desc= "Yard Code"  maxlength=7 style="width:71" onKeyUp='tes_isApNum(this);upper(this);' onBlur='validateYardCode();'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_yard"></td>
					...
					<td width="120">&nbsp;<input class="input2" type="text" style="width:100" name="yd_nm" readOnly></td>
				</tr>
				<tr class="h23">
					<td><img class="nostar">Cost OFC</td>
					<td>&nbsp;<input class="input1" type="text" style="width:68" name="cost_ofc_cd" value='' maxlength=6 onKeyUp='tes_isAlphabet(this);upper(this);' onBlur='validateCostOFC();'>&nbsp;<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_cost_ofc"></td>
										<input type="hidden" name="cost_ofc_hidden" value=''>
										<input type="hidden" name="is_valid_cost_ofc" value=''>
					<td><img class="nostar">INV OFC</td>
					<td>&nbsp;<input class="input1" type="text" style="width:100" name ="inv_ofc_cd" valid="1" desc= "Inv. OFC" class="noinput1" value="<%=ofcCd%>" readOnly></td>
				</tr>
				...
				<tr class="h23">
					...
					<table class="button">
									...
									<tr>
										...
										<!-- Repeat Pattern -->
										<td><input type="checkbox" value="" class="trans" name="hld_flg" ></td>
										<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
			...
			<td class="bg">
				...
				<tr class="h23">
					...
					<td width="120">&nbsp;<input type="text" style="width:100;text-align:right;"  name="vat_amt"    desc= "V.A.T"  onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_total_amount();"></td></tr>
				<tr class="h23">
					<td><img class="nostar">W.H.T</td>
					<td>&nbsp;<input type="text" name="whld_tax_amt" style="width:92;text-align:right;" onKeyUp='tes_isMon(this,"Y",this.form.curr_cd.Code);' onKeyDown='tes_chkInput(this); tes_isMon(this,"Y",this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this,this.form.curr_cd.Code);set_total_amount();"></td>
					<td><img class="nostar">Total AMT</td>
					<td>&nbsp;<input type="text" name="total_amt" style="width:100;" onKeyUp='tes_isMon(this,"Y",this.form.curr_cd.Code);' onKeyDown='tes_chkInput(this); tes_isMon(this,"Y",this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this,this.form.curr_cd.Code);"></td></tr>
				<tr class="h23">
				...
				<tr class="h23">
					...
					<td>&nbsp;<input class="input2" type="text" style="width:92" name="tml_inv_sts_nm"  value="" class="noinput1" readonly></td>
										<input type="hidden"   name="tml_inv_sts_cd" value="R">
					<td><img class="nostar">Reject STS</td>
					<td>&nbsp;<input class="input2" type="text" style="width:100" name="tml_inv_rjct_sts_nm"   desc= "Reject STS" maxlength=2 value=""  class="noinput1" readonly></td></tr>
										<input type="hidden" name="tml_inv_rjct_sts_cd"  value="NL" ><input type="hidden" name="inv_rjct_rmk" maxlength=500 value="">
				</table>
				<!-- : ( Week ) (E) -->
					...
					<tr>
						...
						<td class="bg">
							...
							<tr class="h23">
								...
								<td width="100">&nbsp;<input class="input1" type="text" style="width:92;text-align:right;" name="ida_cgst_amt" desc= "CGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td width="40"><img class="nostar">SGST</td>
								<td width="100">&nbsp;<input class="input1" type="text" style="width:92;text-align:right;" name="ida_sgst_amt" desc= "SGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td width="40"><img class="nostar">IGST</td>
								<td width="100">&nbsp;<input class="input1" type="text" style="width:92;text-align:right;" name="ida_igst_amt" desc= "IGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							<tr class="h23">
								<td width="40"><img class="nostar">UGST</td>
								<td width="100">&nbsp;<input class="input1" type="text" style="width:92;text-align:right;" name="ida_ugst_amt" desc= "UGST AMT" onKeyUp='tes_isMon(this,"Y", this.form.curr_cd.Code);' onBlur="tes_chkAmtFmtObj(this, this.form.curr_cd.Code);set_vat_amount();"></td>
							</tr>
							</table>
						</td>
					</tr>
		...
		<!-- TABLE '#D' : ( Search Options :  ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td width="74%" class="stm"></td>
					<td width="11%">Calculated AMT</td>
					<td width="15%" align="right">&nbsp;<input type="text" style="width:150;text-align:right;" value="" name="tot_inv_amt"  readOnly></td></tr>
		...
		<div id="SearchLayer02" style="display:inline">
			<table class="search_in" border="0">
				<tr class="h23">
					<td width="4%">Total</td>
					<td width="15%"><input class="input2" type="text"  name="container_tot" style="width:80;text-align:right;" readOnly disabled></td>
					<td width="3%">Full</td>
					<td width="14%"><input class="input2" type="text" name="full" style="width:80;text-align:right;" readOnly disabled></td>
					<td width="3%">Empty</td>
					<td><input class="input2" type="text" name="empty" style="width:80;text-align:right;" readOnly disabled></td></tr>
			</table>
			<table class="search_in" border="0">
				<tr class="h23">
					<td width="18">D2 </td><td width="40"><input class="input2" type="text" name="size_d2" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">D4 </td><td width="40"><input class="input2" type="text" name="size_d4" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">D5 </td><td width="40"><input class="input2" type="text" name="size_d5" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">D7 </td><td width="40"><input class="input2" type="text" name="size_d7" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">D8 </td><td width="40"><input class="input2" type="text" name="size_d8" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">D9 </td><td width="40"><input class="input2" type="text" name="size_d9" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">DW </td><td width="40"><input class="input2" type="text" name="size_dw" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">DX </td><td width="40"><input class="input2" type="text" name="size_dx" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">R2 </td><td width="40"><input class="input2" type="text" name="size_r2" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">R4 </td><td width="40"><input class="input2" type="text" name="size_r4" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">R5 </td><td width="40"><input class="input2" type="text" name="size_r5" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">R7 </td><td width="40"><input class="input2" type="text" name="size_r7" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">R8 </td><td width="40"><input class="input2" type="text" name="size_r8" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">R9 </td><td width="40"><input class="input2" type="text" name="size_r9" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">F2 </td><td width="40"><input class="input2" type="text" name="size_f2" style="width:32;text-align:right;" readOnly disabled ></td>
					<td width="18">F4 </td><td width="40"><input class="input2" type="text" name="size_f4" style="width:32;text-align:right;" readonly disabled ></td></tr>
				<tr class="h23">					
					<td>F5</td><td><input class="input2" type="text" name="size_f5" style="width:32;text-align:right;" readOnly disabled></td>
					<td>O2</td><td><input class="input2" type="text" name="size_o2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>O4</td><td><input class="input2" type="text" name="size_o4" style="width:32;text-align:right;" readOnly disabled></td>
					<td>O5</td><td><input class="input2" type="text" name="size_o5" style="width:32;text-align:right;" readOnly disabled></td>
					<td>O7</td><td><input class="input2" type="text" name="size_o7" style="width:32;text-align:right;" readOnly disabled></td>
					<td>S2</td><td><input class="input2" type="text" name="size_s2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>S4</td><td><input class="input2" type="text" name="size_s4" style="width:32;text-align:right;" readOnly disabled></td>
					<td>T2</td><td><input class="input2" type="text" name="size_t2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>T4</td><td><input class="input2" type="text" name="size_t4" style="width:32;text-align:right;" readOnly disabled></td>
					<td>A2</td><td><input class="input2" type="text" name="size_a2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>A4</td><td><input class="input2" type="text" name="size_a4" style="width:32;text-align:right;" readOnly disabled></td>
					<td>A5</td><td><input class="input2" type="text" name="size_a5" style="width:32;text-align:right;" readOnly disabled></td>
					<td>P2</td><td><input class="input2" type="text" name="size_p2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>P4</td><td><input class="input2" type="text" name="size_p4" style="width:32;text-align:right;" readOnly disabled></td>
					<!-- 
					<td>Z2</td><td><input class="input2" type="text" name="size_z2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>Z4</td><td><input class="input2" type="text" name="size_z4" style="width:32;text-align:right;" readOnly disabled></td>
					-->
					<td>C2</td><td><input class="input2" type="text" name="size_c2" style="width:32;text-align:right;" readOnly disabled></td>
					<td>C4</td><td><input class="input2" type="text" name="size_c4" style="width:32;text-align:right;" readOnly disabled></td>
					></tr>
			</table>
		</div>
				<!-- : ( Week ) (E) -->
				...
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_todiscrepancy1" id="btng_todiscrepancy1">To Discrepancy</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_fileimport1" id="btng_fileimport1">File Import</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_costcalc1" id="btng_costcalc1">Cost Calc.</td>
							<td class="btn2_right"></td></tr></table></td>
						<!-- Repeat Pattern -->
				...
				<tr><td class="btn2_bg">
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<!-- Repeat Pattern -->
							...
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_save3" id="btng_save3">Save</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_totalamount3" id="btng_totalamount3">Total Amount</td>
							<td class="btn2_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
							<tr><td class="btn2_left"></td><td class="btn2" name="btng_confirm3" id="btng_confirm3">Confirm</td>
							<td class="btn2_right"></td></tr></table></td>
						<!-- Repeat Pattern -->
...
<script language="javascript">ComSheetObject('hidden_sheets4_etc');</script>
</div>
</body>
</html>
