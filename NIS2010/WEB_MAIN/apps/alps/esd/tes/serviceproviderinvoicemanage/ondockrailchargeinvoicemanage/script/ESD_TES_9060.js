             ...
             case 1:      //sheet1 init
                with (sheetObj) {
                   ...
                   //전체Edit 허용 여부 [선택, Default false]
                    ...
                    InitDataProperty(0, cnt++, dtHidden,    150,    daCenter,  true,    "calc_cost_grp_cd",        false,          "",       dfNone,    0,     false,       false);
...
//                    DoSearch("UI_ESD_TES_906_DATA.html");
                    ShowSubSum(0, "1");
               }
                break;
        }
...
//				ComShowMessage('일단 대기');
			    sheetObj.DoSearch4Post("ESD_TES_9060Popup.do", tesFrmQryStr(formObj));
			    break;
	...
	function sheet_OnSearchEnd(sheetObj,errMsg){
		...
		sheetObj.ShowSubSum("calc_cost_grp_cd", "2", -1, false, false, -1, "lgs_cost_cd=Storage Sub Total");
