	...
	***************************************************************************************/
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
           ...
           case IBSEARCH:      //조회
				var sXml = sheetObj.GetSearchXml("TESInvoiceCommonGS.do", tesFrmQryStr(formObj));
	...
	function sheet_OnSearchEnd(sheet, ErrMsg){
		var formObj = document.form;
		var ret_val = sheet.EtcData(formObj.coid.value);
		
//		2009-12-08 이정혜
//		data가 undefined 일 경우 아래 조건에 걸리는 부분이 없어서 이상한 데이터("undifined")를 뿌리게 된다
//		그래서 undefined 일 경우 빈값을 넣어준다.
