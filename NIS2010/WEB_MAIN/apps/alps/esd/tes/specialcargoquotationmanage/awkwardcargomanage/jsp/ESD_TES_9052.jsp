...
<%@ page import="com.hanjin.apps.alps.esd.tes.specialcargoquotationmanage.awkwardcargomanage.event.EsdTes9052Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdTes9052Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTes9052Event)request.getAttribute("Event");
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;AWK Cargo Tariff Excel Upload-Basic</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
