 ...
 ***************************************************************************************/
	...
	/**
	 * @extends
	 * @class ESD_TES_9053 : ESD_TES_9053 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function ESD_TES_9053() {
...
//	            var HeadTitle2 = "|Port|Tmnl CD|TO Port|TML|Curr|20'|40'|Service Provider|ID|Condition Desc|Remark|Verify Result";
	            var HeadTitle1 = "||Port|Tmnl\nCD||T/S\nType|I/O|IN/OOG|Unit Cost Manual (Local Curr.)|Unit Cost Manual (Local Curr.)|Unit Cost Manual (Local Curr.)|||||Tariff Condition|Tariff Condition|Remark|Verify Result"; 
                var HeadTitle2 = "||Port|Tmnl\nCD||T/S\nType|I/O|IN/OOG|Curr|20'|40'|||||ID|Condition Desc|Remark|Verify Result"; 
...
//	            var prefix="sheet1_";
                ...
                InitDataProperty(0, cnt++ , dtData,			65,		daCenter,	true,	"tml_awk_ts_cd",	true,		"",	dfNone,			0,		true,		true);
                InitDataProperty(0, cnt++ , dtData,			45,		daCenter,	true,	"io_bnd_cd",		true,		"",	dfNone,			0,		true,		true);
                InitDataProperty(0, cnt++ , dtData,			65,		daCenter,	true,	"io_ga_cd",			true,		"",	dfNone,			0,		true,		true);
			...
			case IBSEARCH: //조회
				...
				for(var i = 0; i < sheetObj.RowCount; i++) {
					condStr = "port_cd="    + sheetObj.CellValue(i+2, "port_cd")
							...
							+ "&Row="       + (i+2)
							+ "&f_cmd="     + formObj.f_cmd.value ;
					var sXml = sheetObj.GetSearchXml("ESD_TES_9053GS.do", condStr);
...
//				sheetObj.LoadSearchXml(sXml);
			...
			case IBSAVE:
				...
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSaveXml("ESD_TES_9053GS.do", sParam);
					ComOpenWait(false);		
	...
	function sheet1_OnClick(sheetObj, row, col, value) {
  	...
  	function chkDupRow(sheetObject){
		var idx = 0;
		var Rows = "";
		Rows = sheetObject.ColValueDupRows("port_cd|tml_cd|tml_awk_ts_cd|io_bnd_cd|io_ga_cd|cond_no", false);
		var arr_rows = null;
