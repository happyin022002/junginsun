...
*@FileName : ESD_TES_0052.jsp
*@FileTitle :AWK Cargo Tariff History-Basic
*Open Issues :
*Change history :
...
<%@ page import="com.hanjin.apps.alps.esd.tes.specialcargoquotationmanage.awkwardcargomanage.event.EsdTes0052Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdTes0052Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdTes0052Event)request.getAttribute("Event");
...
<html>
<head>
<title>AWK Cargo Tariff History-Basic</title>
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;AWK Cargo Tariff History - Basic</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
