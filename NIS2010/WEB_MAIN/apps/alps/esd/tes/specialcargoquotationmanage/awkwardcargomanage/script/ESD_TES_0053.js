...
*@FileName : ESD_TES_0053.js
*@FileTitle : Tariff History-T/S
*Open Issues :
*Change history :
 ...
 ***************************************************************************************/
	...
	/**
	 * @extends
	 * @class ESD_TES_0053 : ESD_TES_0053 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function ESD_TES_0053() {
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
			with (sheetObj) {
				...
				var HeadTitle1 = "Ver.||Port|Tmnl\nCD|T/S\nType|I/O|IN/OOG|Unit Cost Manual (Local Curr.)|Unit Cost Manual (Local Curr.)|Unit Cost Manual (Local Curr.)|Unit Cost Manual (USD)|Unit Cost Manual (USD)|Unit Cost Auto (USD)|Unit Cost Auto (USD)|Total Handling Cost (USD)|Total Handling Cost (USD)|Tariff Condition||Remark|Upd\nUser|Upd\nDate";
	            var HeadTitle2 = "Ver.||Port|Tmnl\nCD|T/S\nType|I/O|IN/OOG|Curr|20'|40'|20'|40'|20'|40'|20'|40'|Tariff Condition||Remark|Upd\nUser|Upd\nDate";
				...
				InitDataProperty(0, cnt++ , dtData,		45,		daCenter,	true,		"tml_cd",				false,		"",		dfNone,			0,		false,		false);
	            InitDataProperty(0, cnt++ , dtCombo,	40,		daCenter,	true,		"tml_awk_ts_cd",		false,		"",		dfNone,			0,		false,		false);
	            ...
	            InitDataProperty(0, cnt++ , dtData,		95,		daLeft,		true,		"calc_rmk",				false,		"",		dfNone,			0,		false,		false);
	            ...
	            InitDataCombo(0, "tml_awk_ts_cd", "SAME|DIFF", "S|D");
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
	    ...
	    switch(sAction) {
			case IBSEARCH: //조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_TES_0053GS.do", FormQueryString(formObj));
