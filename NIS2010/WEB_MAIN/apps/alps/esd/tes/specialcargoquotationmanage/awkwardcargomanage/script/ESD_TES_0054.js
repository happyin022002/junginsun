...
*@FileName : ESD_TES_0054.js
*@FileTitle : Tariff History-addon
*Open Issues :
*Change history :
 ...
 ***************************************************************************************/
	...
	/**
	 * @extends
	 * @class ESD_TES_0054 : ESD_TES_0054 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
	 */
	function ESD_TES_0054() {
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
			with (sheetObj) {
				...
				var HeadTitle1 = "Ver.|FROM|FROM|TO|TO|Unit Cost Manual (Local Curr.)|Unit Cost Manual (Local Curr.)|Unit Cost Manual (Local Curr.)|Unit Cost Auto (USD)|Unit Cost Auto (USD)|Service Provider|Tariff Condition||Remark|Upd User|Upd Date";
	            var HeadTitle2 = "Ver.|Port|Tmnl|Port|Tmnl|Curr|20'|40'|20'|40'|Service Provider|Tariff Condition||Remark|Upd User|Upd Date"; 
	            ...
	            InitDataProperty(0, cnt++, dtData, 		30, 		daCenter, 	true, 		"tml_awk_trf_ver_no", 	false, 		"", 	dfNone, 		0, 		false, false);
	            InitDataProperty(0, cnt++ , dtData,		85,			daCenter,	true,		"fm_loc_cd",			false,		"",		dfEngUpKey,		0,		false,	false);
	            InitDataProperty(0, cnt++ , dtData,		55,			daCenter,	true,		"fm_nod_yd_no",			false,		"",		dfNone,			0,		false,	false);
	            InitDataProperty(0, cnt++ , dtData,		85,			daCenter,	true,		"to_loc_cd",			false,		"",		dfEngUpKey,		0,		false,	false);
	            InitDataProperty(0, cnt++ , dtData,		55,			daCenter,	true,		"to_nod_yd_no",			false,		"",		dfNone,			0,		false,	false);
	            ...
	            InitDataProperty(0, cnt++ , dtData,		130,		daRight,	true,		"vndr_nm",				false,		"",		dfNone,			0,		false,	false);
		...
		sheetObj.ShowDebugMsg = false;
	     switch(sAction) {
			case IBSEARCH: //조회
				...
				var sXml = sheetObj.GetSearchXml("ESD_TES_0054GS.do", FormQueryString(formObj));
