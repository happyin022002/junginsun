...
<%@ page import="com.hanjin.apps.alps.esd.tes.serviceprovideragreementmanage.terminalagreementmanage.event.EsdTes9170Event"%>
<html>
<head>
...
<input type="hidden" name="lgsCostCDSheet">
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp;Storage Rate Excel Upload</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
