...
/**
 * @extends Tes
 * @class ESD_TES_0031 : 에서 사용하는 업무 스크립트를 정의한다.
 */
function ESD_TES_0031() {
			...
			switch(srcName) {
				...
				case "btn_save":					
					for(var i=1;i<=sheetObjects[0].RowCount;i++){
							if(sheetObjects[0].RowStatus(i)=="I" && sheetObjects[0].CellValue(i,"tml_crr_cd")==""){
									ComShowMessage(getMsg('TES15010'));
									return false;								
							}else if(sheetObjects[0].RowStatus(i)=="I" && sheetObjects[0].CellValue(i,"crr_desc")==""){
...
//					var HeadTitle = "Del.|STS|Carrier Code|Carrier Full Name" ;
					...
					//InitDataProperty(0, cnt++ , dtStatus,	 	30,		daCenter,			false,	"ibflag",		false,			""	);
					InitDataProperty(0, cnt++ , dtData,	 		250,	daCenter,			false,	"crr_cd",		false,			"",			dfNone,			0,			false,			true,   3);
					InitDataProperty(0, cnt++ , dtData,	 		250,	daLeft,			false,	"crr_nm",		false,			"",			dfNone,			0,			false,			true	);
			   }
				break;
		}
	}
		...
		switch(sAction) {
            ...
            case IBSEARCH:	  //조회
				...
				if(validateForm(sheetObj,formObj,sAction)) {
					...
					//sheetObj.DoSearch4Post("com.hanjin.apps.bms.bms.pfm.managemarketstatus.UIBMSPFM001Action.do", tesFrmQryStr(formObj));
				}
				break;
			case IBSAVE:		//저장
				if(validateForm(sheetObj,formObj,sAction)) { 
