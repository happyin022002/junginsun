...
<%@ page import="com.hanjin.apps.alps.esd.prd.networklinkmanage.oceanrouteconditionmanage.event.EsdPrd0041Event"%>

<%
	EsdPrd0041Event  event = null;				//PDTO(Data Transfer Object including Parameters)
				...
				<td class="bg">
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td width="200"><input class="input1" name="i_port_cd" maxlength="5" type="text" style="width:70" value="" tabIndex="1"  dataformat="engup">
								<img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_port"></td>
							<!-- td width="" align="right"><img class="nostar">Del&nbsp;<input type="checkbox" name="del_flag" value="Y" class="trans" unchecked></td-->
							<td width="35">Lane</td>
							<td width=""><input name="i_vsl_slan_cd" maxlength="3" type="text" style="width:70" value="" tabIndex="3"  dataformat="engup">
