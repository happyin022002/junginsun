...
* 1.0 Creation
* history
* 2010.11.17 채창호 CHM-201007210 : IRG Inquiry 오류 수정
...
//    			inputChkUpper(thisObj,keyObj , 'SEARCH02');
         		if(eval('document.form.'+srcName+'.value').length ==5 ){
         			...
         			inputChkUpper(thisObj,keyObj , 'SEARCH04');
         	    }    			
    		}
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtCheckBox,     60,    daCenter,  false,   prefix + "inlnd_rout_optm_flg",       false,  "",       dfNone,      0,     false,       true);
                    InitDataProperty(0, cnt++ , dtCheckBox,     60,    daCenter,  false,    prefix + "altn_optm_flg",            false,          "",       dfNone,         0,     false,       true, -1, false, true, "", false);
                    ...
                    InitDataProperty(0, cnt++ , dtData,         400,   daLeft,    false,   prefix + "route",                    false,  "",       dfNone,      0,     false,       true);
            ...
            case 2:      //IBSheet2 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtData,       90,    daCenter,  false,   prefix +  "agmt_ref_no",       false,  "",       dfNone,       0,     false,       false);
                    //----Add column[20061202] : CombinedMode 
                    InitDataProperty(0, cnt++ , dtCheckBox,   100,   daCenter,  false,   prefix +  "inlnd_rout_cmb_flg",       false,  "",       dfNone,       0,     false,        true);
     ...
     */
     function checkInput() {
         ...
         if(i_org_cd.length == 0 ){
        	...
        	//2자리 이상입력으로 제한변경. 2012.01.10 Kim Hyun Hwa 
         ...
         if (!i_org_chk && !i_dest_chk) {
        	 // ComShowMessage(ComGetMsg('PRD90120',"From', 'To",'5 or 7')); 
