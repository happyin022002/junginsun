			...
			<tr>
				<td width="30%">
			       <table border="0" style="height:20; width:90%;background-color: #E9E9E9;">
			            <tr><input type="hidden" name="rBtnIrgCd" value="I"></input>
				...
				<td class="bg">
					...
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td width="159"><input name="i_bkg_flg" type="checkbox" class="trans" disabled value="Y" unchecked></td>
					...
					<table class="search_in" border="0">
						...
						<td width="105"><img class="nostar">Optimum Flag</td>
							<td width="75"><input name="i_optm_flg" type="checkbox" class="trans" disabled value="Y" unchecked></td>
							<td width="30"></td>
