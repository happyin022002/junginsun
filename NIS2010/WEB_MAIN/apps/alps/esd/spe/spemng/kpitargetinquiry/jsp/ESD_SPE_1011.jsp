...
<%@ page import="com.hanjin.apps.alps.esd.spe.spemng.kpitargetinquiry.event.EsdSpe1011Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.SpeMng.KpiTargetInquiry");
