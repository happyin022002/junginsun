...
<%@ page import="com.hanjin.apps.alps.esd.spe.egmapping.evaluationgroupmapping.event.EsdSpe1009Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSpe1009Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1009Event)request.getAttribute("Event");
