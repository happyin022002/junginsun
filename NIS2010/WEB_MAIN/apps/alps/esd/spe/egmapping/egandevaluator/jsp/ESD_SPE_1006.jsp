...
<%@ page import="com.hanjin.apps.alps.esd.spe.egmapping.egandevaluator.event.EsdSpe1006Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSpe1006Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1006Event)request.getAttribute("Event");
