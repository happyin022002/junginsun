...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_SPE_1006 : ESD_SPE_1006 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_SPE_1006() {
	 	...
	 	switch(sheetNo) {
	    	case 1:      //sheet1 init
		    	with (sheetObj) {
					...
					InitDataProperty(0,	cnt++,	dtHidden,       30,		daCenter,	false,	"chk");
					...
					InitDataProperty(0, cnt++ , dtPopupEdit,    170,  	daCenter,   true,   "bzc_evr_usr_id",      	true,    "",      dfNone,          0,          true,         true,   10);
					InitDataProperty(0, cnt++ , dtData,         170,  	daLeft,     true,   "bzc_evr_usr_nm",       true,    "",      dfNone,          0,          false,        false,  10);
					InitDataProperty(0, cnt++ , dtHidden,       170,  	daCenter,   true,   "per_evr_usr_id",       true,    "",      dfNone,          0,          true,         true,   10);
					InitDataProperty(0, cnt++ , dtHidden,       170,  	daLeft,     true,   "per_evr_usr_nm",       true,    "",      dfNone,          0,          false,        false,  10);					
					...
					InitDataProperty(0, cnt++ , dtHidden,       100,  	daLeft,     true,   "eg_rhq_cd",            false,   "",      dfNone,          0,          false,        false,  10);
					InitDataProperty(0, cnt++ , dtHidden,       100,  	daLeft,     true,   "eg_ofc_cd",            false,   "",      dfNone,          0,          false,        false,  10);					
//					InitDataValid(0, "bzc_evr_usr_id"  , vtNumericOnly);
	    	...
	    	case 2:      //sheet2 init
				...
				var HeadTitle1 = "ibflag|Chk|EG ID|EG Name|Performance Evaluator ID|Performance Evaluator|Performance Evaluator ID|Performance Evaluator|ISINPUT";
				...
				InitDataProperty(0, cnt++ , dtData,         80,  	daCenter,   true,   "eg_id",         	    false,   "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtData,         120,  	daCenter,   true,   "eg_nm",                false,   "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtHidden,       170,  	daCenter,   true,   "bzc_evr_usr_id",      	true,    "",      dfNone,          0,          true,         true,   10);
				InitDataProperty(0, cnt++ , dtHidden,       170,  	daLeft,     true,   "bzc_evr_usr_nm",       true,    "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtPopupEdit,    170,  	daCenter,   true,   "per_evr_usr_id",       true,    "",      dfNone,          0,          true,         true,   10);
				InitDataProperty(0, cnt++ , dtData,         170,  	daLeft,     true,   "per_evr_usr_nm",       true,    "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtHidden,       100,  	daLeft,     true,   "ev_knd_seq",           false,   "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtHidden,       100,  	daLeft,     true,   "ev_knd_cd",            false,   "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtHidden,       100,  	daLeft,     true,   "isinput",              false,   "",      dfNone,          0,          false,        false,  10);
				InitDataProperty(0, cnt++ , dtHidden,       100,  	daLeft,     true,   "eg_rhq_cd",            false,   "",      dfNone,          0,          false,        false,  10);
	 		...
	 		with(sheetObj) {
				...
				switch(sName) {
					case "bzc_evr_usr_id":		//Basic Evaluator ID Pop-up
						  ...
						  var v_eg_ofc_cd = sheetObj.CellValue(Row,"eg_ofc_cd")
						  ComOpenPopup("/hanjin/ESD_SPE_1023.do?RHQ_CD="+ v_ofc_cd+"&EG_OFC_CD="+ v_eg_ofc_cd, 770, 580, 'setPopupParam', '1,0,1,1,1', true, false, Row, Col, 0);
						break;
				}
	 		}
	    }	  
...
//	    			 ComOpenPopup("/hanjin/COM_ENS_091.do?ofc_cd="+ v_ofc_cd, 770, 580, 'setPopupParam', '1,0,1,1,1', true, false, Row, Col, 1);
					  var v_ofc_cd = "A"
					  var v_eg_ofc_cd = sheetObj.CellValue(Row,"eg_ofc_cd")
					  ComOpenPopup("/hanjin/ESD_SPE_1023.do?RHQ_CD="+ v_ofc_cd+"&EG_OFC_CD="+ v_eg_ofc_cd, 770, 580, 'setPopupParam', '1,0,1,1,1', true, false, Row, Col, 1);	    			
	    			break;
	    		}
	    	}
	    }	  
