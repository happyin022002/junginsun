...
/* 업무별전역변수는 아래 부분에 추가 선언하여 사용한다. */
     ...
     */
     function loadPage() {
        ...
        formObject.ofc_cd.value = formObject.eg_ofc_cd.value
        doActionIBSheetDept(sheetObjectDept, formObject, IBSEARCH);
        sheetObjectDept.ShowTreeLevel(1);
    ...
    /* 조직도 세팅 */
    function doActionIBSheetDept(sheetObj, formObj, sAction) {
        sheetObj.ShowDebugMsg = false;
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                selectVal = FormQueryString(formObj)
                sheetObj.DoSearch4Post("ESD_SPE_1023GS.do", selectVal);               
