...
<%@ page import="com.hanjin.apps.alps.esd.spe.performancereport.kpidetailreportbykpi.event.EsdSpe1021Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsdSpe1021Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1021Event)request.getAttribute("Event");
			...
			<table class="search" border="0"  style="width: 979;" >
				<tr class="h23">
					...
					<td width="120" style="padding-left:1;">
						<script language="javascript">ComComboObject('s_sp_kpi_id',1,120,0,0,0);</script>
					</td>
					<td width="18"></td>
