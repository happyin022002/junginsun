...
<%@ page import="com.hanjin.apps.alps.esd.spe.performancemanagement.kpiperformance.event.EsdSpe1012Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
	EsdSpe1012Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String ofc_cd					= "";
	String rhq_ofc_cd				= "";
	Logger log = Logger.getLogger("com.hanjin.apps.alps.esd.spe.performancemanagement.KpiPerformanceConfirm");
	...
	try {
		...
		event = (EsdSpe1012Event)request.getAttribute("Event");
...
<html>
<head>
<title>KPI Performance Confirm</title>
