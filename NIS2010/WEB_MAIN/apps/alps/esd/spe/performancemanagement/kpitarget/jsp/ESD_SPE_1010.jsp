...
<%@ page import="com.hanjin.apps.alps.esd.spe.performancemanagement.kpitarget.event.EsdSpe1010Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSpe1010Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1010Event)request.getAttribute("Event");
