...
<%@ page import="com.hanjin.apps.alps.esd.spe.performancemanagement.terminalproductivity.event.EsdSpe1013Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSpe1013Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1013Event)request.getAttribute("Event");
