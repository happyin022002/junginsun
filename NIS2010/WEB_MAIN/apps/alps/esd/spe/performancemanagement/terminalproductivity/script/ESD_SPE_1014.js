...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_SPE_1014 : ESD_SPE_1014 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_SPE_1014() {
	 	...
	 	switch(sheetNo) {
	    	case 1:      //sheet1 init
		    	with (sheetObj) {
					...
					var HeadTitle1 = "ibflag|Seq.|EG ID|EG Name|S/P Code|S/P Name|Year|Terminal|Prior Year|Prior Year|Target|Remark|EV_TML_PROD_TGT_SEQ";
					var HeadTitle2 = "ibflag|Seq.|EG ID|EG Name|S/P Code|S/P Name|Year|Terminal|Performance|Target|Target|Remark|EV_TML_PROD_TGT_SEQ";
					...
					InitDataProperty(0, cnt++ , dtPopupEdit,    75,  	daCenter,   true,   "sp_seq",                    false,    "",     dfNone,          0,          true,         true,   10);
					InitDataProperty(0, cnt++ , dtData,         170,  	daLeft,     true,   "sp_name",                   false,    "",     dfNone,          0,          false,        false,  10);
					InitDataProperty(0, cnt++ , dtData,         70,  	daCenter,   true,   "ev_yr",                     false,    "",     dfNone,          0,          false,        false,   4);
					InitDataProperty(0, cnt++ , dtPopupEdit,    80,  	daCenter,   true,   "tml_cd",                    false,    "",     dfNone,          0,          true,         true,   10);
					...
					InitDataProperty(0, cnt++ , dtData,         60,  	daCenter,   true,   "kpi_tgt_rto",               false,    "",     dfNullFloat,     2,          true,         true,   5);
					InitDataProperty(0, cnt++ , dtData,         110,  	daLeft,     true,   "kpi_rmk",                   false,    "",     dfNone,          0,          true,         true,   2000);
					InitDataProperty(0, cnt++ , dtHidden,       110,  	daLeft,     true,   "ev_tml_prod_tgt_seq",   false,    "",     dfNone,          0,          true,         true,   10);
	 		...
	 		with(sheetObj) {
				...
				switch(sName) {
					...
					case "tml_cd":		//Yard Code No Pop-up
						ComOpenPopup('/hanjin/COM_ENS_061.do', 800, 475, "callBackYardGrid", "0,1,1,1,1,1,1", true, false, row, col, 0); 
						break;
				}
	 		}
	    }	  
