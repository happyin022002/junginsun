...
<%@ page import="com.hanjin.apps.alps.esd.spe.egmaster.spservicecategory.event.EsdSpe1004Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSpe1004Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1004Event)request.getAttribute("Event");
