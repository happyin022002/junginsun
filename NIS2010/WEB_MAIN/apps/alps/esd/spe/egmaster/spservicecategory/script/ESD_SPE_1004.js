...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_SPE_1004 : ESD_SPE_1004 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_SPE_1004() {
...
//	    	ComXml2ComboItem(rhqXml, frm.s_eg_rhq_cd, "eg_ofc_cd", "eg_ofc_cd");
	...
	function ComXmlGridMake(xmlStr,  codeCol, textCol) {
		...
		try {
			...
			var headItem1 = "ibflag|save_sc_val|S/P Code|S/P Nmae|Regional Group|Control Office|Contract Office";
			var headItem2 = "ibflag|save_sc_val|S/P Code|S/P Nmae|Regional Group|Control Office|Contract Office";	
			    itemCnt =0;
...
//				headItem2 = headItem2+"|"+item;
	    	...
	    	with (sheetObjects[0]) {
				...
				//컬럼정보설정[필수][COLS,FROZENCOL,LEFTHEADCOLS=0,FROZENMOVE=false]
				InitColumnInfo(itemCnt+8, 8, 0, false);
				...
				InitDataProperty(0, cnt++ , dtPopupEdit,    70,  	daCenter,   true,   "sp_seq",         	   false,     "",      dfNone,          0,          true,         true,   10);
				InitDataProperty(0, cnt++ , dtData,         130,  	daLeft,     true,   "sp_name",             false,    "",      dfNone,          0,          true,         true,  10);
				InitDataProperty(0, cnt++ , dtCombo,        110,  	daCenter,   true,   "sp_grp_ofc_cd",       false,     "",      dfNone,          0,          true,         true,  10);
				InitDataProperty(0, cnt++ , dtData,         100,  	daCenter,   true,   "sp_ctrl_ofc_cd",      false,    "",      dfNone,          0,          true,         true,   5);
