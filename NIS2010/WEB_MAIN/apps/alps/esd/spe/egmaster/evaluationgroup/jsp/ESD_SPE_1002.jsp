...
<%@ page import="com.hanjin.apps.alps.esd.spe.egmaster.evaluationgroup.event.EsdSpe1002Event"%>
...
<%
	...
	EsdSpe1002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1002Event)request.getAttribute("Event");
