...
<%@ page import="com.hanjin.apps.alps.esd.spe.egmaster.evaluationgroup.event.EsdSpe1001Event"%>
...
<%
	...
	EsdSpe1001Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSpe1001Event)request.getAttribute("Event");
			...
			<table class="search" border="0"  style="width: 979;" >
				<tr class="h23">
					...
					<td width="100" style="padding-left:1;">
						<script language="javascript">ComComboObject('s_eg_rhq_cd',1,100,0,0,0);</script>
					</td>
