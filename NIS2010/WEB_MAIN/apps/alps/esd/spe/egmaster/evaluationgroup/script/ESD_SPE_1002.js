...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_SPE_1002 : ESD_SPE_1002 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_SPE_1002() {
	 	...
	 	switch(sheetNo) {
	    	case 1:      //sheet1 init
		    	with (sheetObj) {
					...
					var HeadTitle1 = "ibflag|Seq.|EG ID|EG Name|Level1(RHQ)|Level2(Office)|CODE|Level3(Service Category)|Contract Office";
					...
					InitDataProperty(0, cnt++ , dtCombo,        100,  	daCenter,   true,   "eg_rhq_cd",        false,     "",     dfNone,          0,          false,        true,   10);
					InitDataProperty(0, cnt++ , dtData,         100,  	daCenter,   true,   "eg_ofc_cd",        false,     "",     dfNone,          0,          false,        true,   10);
					InitDataProperty(0, cnt++ , dtData,         50,  	daCenter,   true,   "ev_svc_cate_code", false,    "",     dfNone,          0,          false,        false,  10);
					InitDataProperty(0, cnt++ , dtCombo,        170,  	daLeft,     true,   "ev_svc_cate_cd",   false,     "",     dfNone,          0,          false,        true,   10);
					InitDataProperty(0, cnt++ , dtHidden,       100,  	daCenter,   true,   "ctrt_ofc_cd",      false,     "",     dfNone,          0,          false,        true,   10);
