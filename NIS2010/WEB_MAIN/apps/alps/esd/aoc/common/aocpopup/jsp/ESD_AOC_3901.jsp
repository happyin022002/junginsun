...
<%@ page import="com.hanjin.apps.alps.esd.aoc.common.aocpopup.event.EsdAoc3901Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdAoc3901Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3901Event)request.getAttribute("Event");
