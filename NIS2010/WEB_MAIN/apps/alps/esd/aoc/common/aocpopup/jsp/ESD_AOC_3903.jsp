...
<%@ page import="com.hanjin.apps.alps.esd.aoc.common.aocpopup.event.EsdAoc3903Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdAoc3903Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3903Event)request.getAttribute("Event");
...
<input type="hidden" name="curr_cd" value="<%=currCd%>">
					...
					<td width="100%" class="bg">
						<table width="100%" border="0">
							...
							<tr class="h23">
								...
								<td width="190">
									<script language="javascript">ComComboObject('co_curr_cd', 1, 100, 1);</script>
								</td>
					...
					<td width="100%" class="bg">
						<table width="100%" border="0">
							<tr class="h23">
								...
								<td width="30">From</td>
								<td width="50"><input name="from_amt" type="text" dataformat="num" style="width:50;text-align:right;" class="input" value="0" maxlength="6"></td>
								<td width="50">Amount</td>
								<td width="50"><input name="itval_amt" type="text" dataformat="num" style="width:50;text-align:right;" class="input" value="" maxlength="6"></td>
								<td width="100">
