...
*@FileName : ESD_AOC_3303.js
*@FileTitle : Inland Cost Management Route Detail
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3303 : esd_aoc_3303 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3303() {
	...
	function loadPage() {
		...
		var sXml = sheetObjects[1].GetSearchXml("ESD_AOC_3302GS.do", sParam);
...
// 					InsertItem(i++, "Full Trans 20'", "FT2");
					...
					InsertItem(i++, "Domestic 40'", "DT4");
					InsertItem(i++, "Domestic 20'", "DT2"); 
         ...
         switch(sheetID) {
        	case "sheet1":
        		with (sheetObj) {
					...
					var HeadTitle1 = "Port-LOC|R/D\nTerm||Sel.|Del.|Port|Hub|LOC|Trans\nMode|Empty\nPU/RTN|CURR|Total Cost|Total Cost|M/B Ratio|M/B Ratio|M/B Ratio";
					...
					HeadTitle1 += "|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’|Full Truck Basic Cost 20’";
					...
					HeadTitle1 += "|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’|Full Truck Basic Cost 40’";
					...
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"rail_20ft_bzc_cost_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"rail_20ft_bzc_cost_amt", 		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_20ft_bzc_cost_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_20ft_bzc_cost_ttl_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"rail_20ft_bzc_agmt_wgt",       false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_20ft_bzc_agmt_wy_tp_cd", 	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"rail_20ft_fuel_scg_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"rail_20ft_fuel_scg_amt",		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_20ft_fuel_scg_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"rail_20ft_fuel_agmt_wy_tp_cd",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"rail_40ft_bzc_cost_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"rail_40ft_bzc_cost_amt", 		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_40ft_bzc_cost_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_40ft_bzc_cost_ttl_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"rail_40ft_bzc_agmt_wgt",  		false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_40ft_bzc_agmt_wy_tp_cd",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"rail_40ft_fuel_scg_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"rail_40ft_fuel_scg_amt",		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"rail_40ft_fuel_scg_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"rail_40ft_fuel_agmt_wy_tp_cd", false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"trk_20ft_bzc_cost_src_nm",		false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"trk_20ft_bzc_cost_amt", 		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_20ft_bzc_cost_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_20ft_bzc_cost_ttl_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"trsp_agmt_20ft_mty_yd_cd", 	false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"trk_20ft_bzc_agmt_wy_tp_cd",   false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"trk_20ft_fuel_scg_src_nm",		false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"trk_20ft_fuel_scg_amt",		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_20ft_fuel_scg_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"trk_20ft_fuel_agmt_wy_tp_cd", 	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"toll_fee_amt_20", 				false, 		"", 		dfFloat, 	2, 			false, 		false);
			
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"trk_40ft_bzc_cost_sys_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"trk_40ft_bzc_cost_amt", 		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_40ft_bzc_cost_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_40ft_bzc_scg_ttl_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"trsp_agmt_40ft_mty_yd_cd", 	false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"trk_40ft_bzc_agmt_wy_tp_cd",   false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"trk_40ft_fuel_scg_src_nm",		false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"trk_40ft_fuel_scg_amt",		false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_40ft_fuel_scg_adj_amt", 	false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trk_40ft_fuel_agmt_wy_tp_cd",  false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"tml_20ft_cost_src_nm", 		false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"tml_20ft_cost_amt", 			false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			60, daCenter, 	true,		"tml_40ft_cost_src_nm", 		false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData, 			50, daCenter, 	true,		"n1st_inlnd_rout_cmb_flg", 		false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData, 			50, daCenter, 	true,		"n2nd_inlnd_rout_cmb_flg", 		false, 		"", 		dfNone, 	0, 			false, 		false);
         ...
         switch(sAction) {
			case IBSEARCH:      //Sort
				if (sheetObj.id == "sheet1"){
		        	...
		        	var sParam = FormQueryString(formObj);
					var sXml = sheetObj.GetSearchXml("ESD_AOC_3303GS.do", sParam);
					if(sXml.length>0){
			...
			case MULTI01: //Apply
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSaveXml("ESD_AOC_3303GS.do", FormQueryString(formObj) + "&" + sParam, true);	        			
			...
			case MULTI02: //Delete
				if(validateForm(sheetObj,formObj,sAction)){
		        	...
		        	opener.form.reset_flg.value = "Y";
		        	var sXml = sheetObj.GetSaveXml("ESD_AOC_3303GS.do", sParam);
					sheetObj.LoadSaveXml(sXml);
				}
				break;
         }
		...
		switch (sAction) {
			case MULTI01:
				...
				for( var idx = sheetObj.HeaderRows; idx <= sheetObj.LastRow; idx++ ){
					if( sheetObj.RowStatus(idx) == "U" && sheetObj.CellValue(idx, "cost_sel_rout_flg") != "Y" ){
						if( sheetObj.CellValue(idx, "rf_cnt") > 0 ){
							if( ComShowCodeConfirm("AOC90035") ){
								break;
							} else{
								sheetObj.SelectCell(idx, "cost_sel_rout_flg");
								return false;
							}
						}
					}
