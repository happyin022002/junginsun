...
* --------------------------------------------------------
* History
* 2015.03.12 최성환 [CHM-201534710] AOC 2차 소스 보안 품질 진행 요청  
=========================================================*/
--%>
...
<%@ page import="com.hanjin.apps.alps.esd.aoc.usacostmgt.usainlandcostmanage.event.EsdAoc3311Event"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
	EsdAoc3311Event  event = null;							//PDTO(Data Transfer Object including Parameters)
	...
	*/
	...
	try {
		...
		event = (EsdAoc3311Event)request.getAttribute("Event");
