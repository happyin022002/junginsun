...
<%@ page import="com.hanjin.apps.alps.esd.aoc.usacostmgt.usainlandcostmanage.event.EsdAoc3310Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.Date"%>
<%
	EsdAoc3310Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3310Event)request.getAttribute("Event");
	...
	String svcCd  = JSPUtil.getCodeCombo("f_svc_mod_cd" , "01", "style='width:120'", "CD03118", 0, "000010:ALL:ALL");
%>
<html>
<head>
...
<script language="javascript">
	...
	<%= JSPUtil.getIBCodeCombo("f_svc_mod_cd" , "", "CD03118", 0, "")%>
...
<input type="hidden" name="excel_svc_mod_cd">
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="163"><script language="javascript">ComComboObject('io_bnd_cd', 1, 122, 1, 0);</script></td>
					<td width="89">SVC Mode</td>
					<td><script language="javascript">ComComboObject('svc_mod_cd', 1, 104, 1, 0);</script></td>
				</tr>
				</table>
