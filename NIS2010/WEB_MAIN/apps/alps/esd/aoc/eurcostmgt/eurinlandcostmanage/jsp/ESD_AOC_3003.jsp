...
<%@ page import="com.hanjin.apps.alps.esd.aoc.eurcostmgt.eurinlandcostmanage.event.EsdAoc3003Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdAoc3003Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3003Event)request.getAttribute("Event");
...
<input type="hidden" name="s_cost_rout_grp_no">
