...
*@FileName : ESD_AOC_3003.js
*@FileTitle : Inland Cost Management Route Detail(EUR)
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier : 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3003 : esd_aoc_3003 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3003() {
	...
	function processButtonClick(){
		...
		try {
			...
			switch(srcName) {
				...
				case "btn_close":
					window.close();
					//window.dialogArguments.call_esd_aoc_3002();
					break;
	...
	function loadPage() {
		...
		var sXml = sheetObjects[1].GetSearchXml("ESD_AOC_3002GS.do", sParam);
         ...
         switch(sheetID) {
        	case "sheet1":
        		with (sheetObj) {
					...
					var HeadTitle1 = "Port-LOC|R/D\nTerm||Sel.|Del.|Port|Hub|LOC|Empty\nPU/RTN|Trans\nMode|CURR|Total Cost|Total Cost|Total Cost|M/B Ratio|M/B Ratio|M/B Ratio|M/B Ratio";
					...
					HeadTitle1 += "|Full Trans Cost 45’|Full Trans Cost 45’|Full Trans Cost 45’|Full Trans Cost 45’|Full Trans Cost 45’|Full Trans Cost 45’";
					HeadTitle1 += "|Empty\nCost 20’|Empty\nCost 40’|Empty\nCost 45’|Terminal Cost 20’|Terminal Cost 20’|Terminal Cost 40’|Terminal Cost 40’|Terminal Cost 45’|Terminal Cost 45’|1st Link|1st Link|Com-\nbined|2nd Link|2nd Link|OLD\nAGMT";
					HeadTitle1 += "|cost_trf_no|cost_trf_rout_seq|cost_rout_grp_no|cost_rout_grp_no_rnk|rcv_de_term_cd|rf_cnt|Flag";

					var HeadTitle2 = "Port-LOC|R/D\nTerm||Sel.|Del.|Port|Hub|LOC|Empty\nPU/RTN|Trans\nMode|CURR|20’|40’|45’|SCC|20’|40’|45’";
					HeadTitle2    += "|System\nSource|System\nAmount|MTY YD\n(AGMT)|MTY\nDiff|Weight\n(AGMT)|Rate\nType";
					HeadTitle2    += "|System\nSource|System\nAmount|MTY YD\n(AGMT)|MTY\nDiff|Weight\n(AGMT)|Rate\nType";
					HeadTitle2    += "|System\nSource|System\nAmount|MTY YD\n(AGMT)|MTY\nDiff|Weight\n(AGMT)|Rate\nType";	// 45' Cost 추가
					HeadTitle2    += "|System\nAmount|System\nAmount|System\nAmount|System\nSource|System\nAmount|System\nSource|System\nAmount|System\nSource|System\nAmount|S/P\nCode|S/P\nName|Com-\nbined|S/P\nCode|S/P\nName|OLD\nAGMT";
					...
					InitDataProperty(0, cnt++, 	dtData, 			60, daRight, 	true,		"mty_trsp_45ft_cost_amt", 		false, 		"", 		dfFloat, 	2, 			false, 		false);	// 45' Cost 추가
         ...
         switch(sAction) {
			case IBSEARCH:      //Sort
				if (sheetObj.id == "sheet1"){
		        	...
		        	var sParam = FormQueryString(formObj);
					var sXml = sheetObj.GetSearchXml("ESD_AOC_3003GS.do", sParam);
					if(sXml.length>0){
			...
			case MULTI01: //Apply
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSaveXml("ESD_AOC_3003GS.do", FormQueryString(formObj) + "&" + sParam, true);	        			
			...
			case MULTI02: //Delete
				if(validateForm(sheetObj,formObj,sAction)){
		        	...
		        	opener.form.reset_flg.value = "Y";
		        	var sXml = sheetObj.GetSaveXml("ESD_AOC_3003GS.do", sParam);
					sheetObj.LoadSaveXml(sXml);
				}
				break;
         }
