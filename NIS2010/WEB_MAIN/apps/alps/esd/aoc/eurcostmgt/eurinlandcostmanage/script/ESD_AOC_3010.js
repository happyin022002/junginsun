...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3010 : esd_aoc_3010 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3010() {
   	    ...
   	    switch(comboObj.id) {				
			...
			case "cost_factor_cd":
				with(comboObj) {
					...
					InsertItem(i++,  "Full Trans 45'",  "F45");	// 45' Cost 추가
					InsertItem(i++,  "Empty 20'",  "E2");
					InsertItem(i++,  "Empty 40'",  "E4");
					InsertItem(i++,  "Empty 45'",  "E45");	// 45' Cost 추가
					InsertItem(i++,  "TMNL 20'",  "T2");
					InsertItem(i++,  "TMNL 40'",  "T4");
					InsertItem(i++,  "TMNL 45'",  "T45");	// 45' Cost 추가
					comboObj.Code = "ALL";
	        	}
				break;
        ...
        switch(sheetID) {
        	case "sheet1":
        		with (sheetObj) {
					...
					HeadTitle1 += "|Creation|Creation|Creation|Update|Update|Update|curr_cd|cost_trf_rout_seq";

					var HeadTitle2 = "Flag|Country|BND|Tariff No|Status|Effective\nFrom|Port-LOC|R/D\nTerm|C|Port|Hub|LOC|Trans\nMode|CURR|20'|40'|45'|LOC\nGroup|SCC|20'|40'|45'";
					...
					HeadTitle2 += "|System\nAmount|S/P\nCode|S/P\nName|Com-\nbined|S/P\nCode|S/P\nName|OLD\nAGMT";
					HeadTitle2 += "|Time|User|Office|Time|User|Office|curr_cd|cost_trf_rout_seq";
					...
					InitDataProperty(0, cnt++, 	dtData,				30, daCenter, 	true,		"cost_sel_rout_flg",          	false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"loc_grp_no",                	false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					// 45' Cost 추가 end
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"mty_trsp_20ft_cost_sys_src_nm",false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"mty_trsp_40ft_cost_sys_src_nm",false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"mty_trsp_45ft_cost_sys_src_nm",false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					InitDataProperty(0, cnt++, 	dtHidden,			70, daCenter, 	true,		"curr_cd", 						false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtHidden,			70, daCenter, 	true,		"cost_trf_rout_seq", 			false, 		"", 		dfNone, 	0, 			false, 		false);
				}
				break;
            ...
            case "sheet2":
                with (sheetObj) {
					...
					var HeadTitle1 = "Flag|Country|BND|Tariff No|Status|Effective\nFrom|Trans\nMode|CURR|EQ\nSize|DG|DG|DG|Overweight (Ton)|Overweight (Ton)|Overweight (Ton)|Overweight (Ton)|Overweight (Ton)|Creation|Creation|Creation|Update|Update|Update";
					var HeadTitle2 = "Flag|Country|BND|Tariff No|Status|Effective\nFrom|Trans\nMode|CURR|EQ\nSize|SVC|Fixed|%|SVC|From|To|Fixed|%|Time|User|Office|Time|User|Office";
					...
					InitDataProperty(0, cnt++, 	dtData,				65, daCenter, 	true,		"cost_trf_sts_nm",  			false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				65, daCenter, 	true,		"eff_fm_dt",        			false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo, 			60, daCenter, 	true,		"trsp_crr_mod_cd", 				false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				50, daCenter, 	true,		"curr_cd",			           	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo, 			50, daCenter, 	true,		"cntr_sz_cd", 					false, 		"", 		dfNone, 	0, 			false, 		false);
//					InitDataProperty(0, cnt++, 	dtCombo, 			60, daCenter, 	true,		"rc_svc_flg", 					false, 		"", 		dfNone, 	0, 			false, 		false);
//					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"rf_fx_rt", 					false, 		"", 		dfFloat, 	2, 			false, 		false);
//					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"rf_fx_rto", 					false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo, 			60, daCenter, 	true,		"dcgo_svc_flg", 				false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"dg_fx_rt",						false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"dg_fx_rto", 					false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo, 			60, daCenter, 	true,		"ovwt_cgo_svc_flg", 			false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"min_cgo_wgt", 					false, 		"", 		dfFloat, 	2, 			false, 		false, 		7);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"max_cgo_wgt", 					false, 		"", 		dfFloat, 	2, 			false, 		false, 		7);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"ovr_wgt_fx_rt", 				false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 			70, daRight, 	true,		"ovr_wgt_fx_rto", 				false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData, 		   120,	daCenter, 	true,		"locl_cre_dt", 					false, 		"", 		dfNone, 	0, 			false, 		false);
...
//					InitDataCombo(0, "rc_svc_flg", 		"Y|N", "Y|N");
            ...
            case "sheet3":
                with (sheetObj) {
					...
					var HeadTitle1 = "Flag|Country|BND|Tariff No|Status|Effective\nFrom|Port-LOC|R/D\nTerm|C|Port|Hub|LOC|Trans\nMode|CURR|RF total cost|RF total cost";
					var HeadTitle2 = "Flag|Country|BND|Tariff No|Status|Effective\nFrom|Port-LOC|R/D\nTerm|C|Port|Hub|LOC|Trans\nMode|CURR|20'|40'";
					...
					InitDataProperty(0, cnt++, 	dtData,				50, daCenter, 	true,		"trsp_crr_mod_cd",           	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				50, daCenter, 	true,		"curr_cd",			           	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				90,	daRight, 	true,		"rf_20ft_ttl_cost_amt",        	false, 		"", 		dfFloat, 	2, 			true, 		true);
					InitDataProperty(0, cnt++, 	dtData,				90,	daRight, 	true,		"rf_40ft_ttl_cost_amt",        	false, 		"", 		dfFloat, 	2, 			true, 		true);
        ...
        switch(sAction) {
			case IBSEARCH: //Retrieve
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSearchXml("ESD_AOC_3010GS.do", sParam);
			...
			case IBDOWNEXCEL:
				...
				ComOpenWait(true);
					...
					formObj.excel_trsp_crr_mod_cd.value = comboObjects[1].Code;
					formObj.excel_rcv_de_term_cd.value 	= comboObjects[2].Code;
					formObj.excel_cost_factor_cd.value 	= comboObjects[3].Code;
					formObj.excel_sys_src_cd.value 		= comboObjects[4].Code;
					formObj.excel_adjustment_cd.value 	= comboObjects[5].Code;
					...
					formObj.action = "ESD_AOC_3010EXCEL.do?"+ AocFrmQryString(formObj);
				    formObj.submit();
				    ComOpenWait(false);
				}
		        break;
