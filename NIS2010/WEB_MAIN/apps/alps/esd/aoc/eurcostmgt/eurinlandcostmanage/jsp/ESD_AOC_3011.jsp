...
<%@ page import="com.hanjin.apps.alps.esd.aoc.eurcostmgt.eurinlandcostmanage.event.EsdAoc3011Event"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
	EsdAoc3011Event  event = null;							//PDTO(Data Transfer Object including Parameters)
	...
	*/
	...
	try {
		...
		event = (EsdAoc3011Event)request.getAttribute("Event");
