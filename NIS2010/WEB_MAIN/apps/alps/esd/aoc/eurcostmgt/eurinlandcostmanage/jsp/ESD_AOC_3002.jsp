...
<%@ page import="com.hanjin.apps.alps.esd.aoc.eurcostmgt.eurinlandcostmanage.event.EsdAoc3002Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>


<%
	EsdAoc3002Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3002Event)request.getAttribute("Event");
	       			...
	       			<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 	
							<tr class="h23">
								...
								<td>20' </td><td><input type="text" name="cntr_20ft_crte_wgt" style="width:40;text-align:right;" class="input2" readonly></td>
								<td>40' </td><td><input type="text" name="cntr_40ft_crte_wgt" style="width:40;text-align:right;" class="input2" readonly></td>
								<td>45' </td><td><input type="text" name="cntr_45ft_crte_wgt" style="width:40;text-align:right;" class="input2" readonly></td><!-- 45' Cost 추가 -->
							</tr>
						</table>	
						<!-- biz_1  (E) -->		
					</td>
		       		...
		       		<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							...
							<tr class="h23">
								...
								<td></td>
								<td>Trans 45’</td>
								<td><script language="javascript">ComComboObject('co_trans45_src', 1, 80, 1, 0);</script></td>
								<td><script language="javascript">ComComboObject('co_trans45', 1, 50, 1, 0);</script></td>
								<td><input type="text" name="in_trans45" style="width:45;text-align:right;" dataformat="float" maxlength="6" class="input"></td>
								<td>MTY 45’</td>
								<td><script language="javascript">ComComboObject('co_mty45_src', 1, 80, 1, 0);</script></td>
								<td><script language="javascript">ComComboObject('co_mty45', 1, 82, 1, 0);</script></td>
								<td><input type="text" name="in_mty45" style="width:45;text-align:right;" dataformat="float" maxlength="6" class="input2" readonly></td>
								<td>TMNL 45’</td>
								<td><script language="javascript">ComComboObject('co_tmnl45_src', 1, 80, 1, 0);</script></td>
								<td><script language="javascript">ComComboObject('co_tmnl45', 1, 50, 1, 0);</script></td>
								<td><input type="text" name="in_tmnl45" style="width:45;text-align:right;" dataformat="float" maxlength="6" class="input"></td>
				                <td width="70"></td>
							</tr>
							<!-- 45' Cost 추가 end  -->
		 				</table>
