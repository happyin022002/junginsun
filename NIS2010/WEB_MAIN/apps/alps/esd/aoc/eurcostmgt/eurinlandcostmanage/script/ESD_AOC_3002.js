...
*@FileName : ESD_AOC_3002.js
*@FileTitle : EUR Inland Cost Management
*Open Issues :
*Change history :
...
* 2013.04.02 이재위 [CHM-201323627] [AOC] HJL Commission Fee 관련 보완
* 2013.06.25 서미진 [CHM-201325458] 화면에서 조정 후 HJL Fee 도 Total cost 합산되도록 수정
...
* 2015.02.03 전지예 [CHM-201533794] 45' Column 추가
* 2015.04.17 최성환 [CHM-201534870] DG, Overweight 정보 미입력 시 Confirm 차단 기능 생성
* 2015.09.21 현성길 [CHM-201537842] Total Cost 45" Column 값이 "0"인 구간이 있는 경우에도 해당 Tariff Confirm 가능하도록 Logic 변경
=========================================================*/
/****************************************************************************************
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3002 : esd_aoc_3002 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3002() {
				...
				switch(srcName) {
					...
					case "btn_cost_detail":
						if( sheetObject1.RowCount > 0 ){
							...
							param = param + '&ttlAmt45='+sheetObject1.CellValue(sheetObject1.SelectRow,"inlnd_45ft_ttl_amt");	// 45' Cost 추가
							...
							ComOpenPopup('/hanjin/ESD_AOC_3004.do' + param, 1024,620,'', '1,0,1,1,1,1,1,1');
						}
						break;
					...
					case "btn_load_excel":
						...
						var vLoadFlg = sheetObject4.LoadExcel(-2, 1, "", 1, -1, "", true, false);
						if( vLoadFlg ){
					...
					case"btn_load_excel3":
						...
						var vLoadFlg = sheetObject5.LoadExcel(-2, 1, "", 1, -1, "", true, false);
						if( vLoadFlg ){
	...
	function initCombo(comboObj, comboNo) {
		...
		var arrRow2Text = f_sys_src_cdText.split("|");
   	    ...
   	    switch(comboObj.id) {
			case "co_trans20":
			case "co_trans40":
			case "co_trans45":	// 45' Cost 추가
			case "co_tmnl20":
			case "co_tmnl40":  
			case "co_tmnl45":	// 45' Cost 추가
				with(comboObj) {
					InsertItem(i++, "%", "R");
					InsertItem(i++, "Flat", "F");
					Code = "R";
        ...
        switch(sheetID) {
        	case "sheet1":		// (Dry Tab)
        		with (sheetObj) {
                    ...
                    HeadTitle1 		+= "|Total Cost|Total Cost|Total Cost|LOC\nGroup|M/B Ratio|M/B Ratio|M/B Ratio|M/B Ratio";	// 45' Cost 추가
					...
					HeadTitle1 		+= "|Full Trans Cost 45'|Full Trans Cost 45'|Full Trans Cost 45'|Full Trans Cost 45'|Full Trans Cost 45'|Full Trans Cost 45'|Full Trans Cost 45'|Full Trans Cost 45'";		// 45' Cost 추가
					...
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"inlnd_45ft_ttl_amt",        	false, 		"", 		dfFloat, 	2, 			false, 		false);	// 45' Cost 추가
					...
					InitDataProperty(0, cnt++, 	dtData,				50, daRight, 	true,		"mb_45ft_rto",               	false, 		"", 		dfNone, 	0, 			false, 		false);	// 45' Cost 추가
					...
					// 45' Cost 추가
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"trsp_45ft_cost_sys_src_cd", 	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"trsp_45ft_cost_amt",        	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight, 		true,		"trsp_45ft_adj_cost_amt",    	false, 		"", 		dfFloat, 	2, 			true, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"trsp_45ft_ttl_cost_amt",    	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"trsp_agmt_45ft_mty_yd_cd", 	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo,			50, daCenter, 	true,		"trsp_diff_45ft", 				false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"agmt_wgt_45ft",                false, 		"", 		dfNone, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"trsp_rate_type_45ft", 			false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					// 45' Cost 추가
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"mty_trsp_45ft_cost_sys_src_cd",false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"mty_trsp_45ft_cost_amt",    	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight, 		true,		"mty_trsp_45ft_adj_cost_amt",	false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					// 45' Cost 추가
					InitDataProperty(0, cnt++, 	dtCombo,			60, daCenter, 	true,		"tml_45ft_cost_sys_src_cd",  	false, 		"", 		dfNone, 	0, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight,	 	true,		"tml_45ft_cost_amt",         	false, 		"", 		dfFloat, 	2, 			false, 		false);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight, 		true,		"tml_45ft_adj_cost_amt",     	false, 		"", 		dfFloat, 	2, 			true, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"tml_45ft_ttl_cost_amt",     	false, 		"", 		dfFloat, 	2, 			false, 		false);
					
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"hjl_fee_amt",     				false, 		"", 		dfFloat, 	2, 			false, 		false);
					...
					InitDataCombo(0, "trsp_45ft_cost_sys_src_cd", f_sys_src_cdText, f_sys_src_cdCode);	// 45' Cost 추가
					...
					InitDataCombo(0, "mty_trsp_45ft_cost_sys_src_cd", f_sys_src_cdText, f_sys_src_cdCode);	// 45' Cost 추가
					...
					InitDataCombo(0, "tml_45ft_cost_sys_src_cd", f_sys_src_cdText, f_sys_src_cdCode);	// 45' Cost 추가
	...
	function sheet1_OnChange(sheetObj, Row, Col, Value){
		...
		if (sName == "trsp_20ft_adj_cost_amt") {
			...
			sheetObj.CellValue(Row, "inlnd_20ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_20ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_20ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_20ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
			...
			sheetObj.CellValue(Row, "inlnd_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_40ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_40ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
		// 45' Cost 추가
		}else if (sName == "trsp_45ft_adj_cost_amt") {
			sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_45ft_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "trsp_45ft_adj_cost_amt"));
			sheetObj.CellValue(Row, "inlnd_45ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
			...
			sheetObj.CellValue(Row, "inlnd_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_40ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_40ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
		// 45' Cost 추가
		}else if (sName == "mty_trsp_45ft_adj_cost_amt") {
			sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt") = parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_adj_cost_amt"));
			sheetObj.CellValue(Row, "inlnd_45ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
			...
			sheetObj.CellValue(Row, "inlnd_40ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_40ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_40ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
		// 45' Cost 추가
		}else if (sName == "tml_45ft_adj_cost_amt") {
			sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt") = parseFloat(sheetObj.CellValue(Row, "tml_45ft_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_45ft_adj_cost_amt"));
			sheetObj.CellValue(Row, "inlnd_45ft_ttl_amt") = parseFloat(sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt"))+ parseFloat(sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "hjl_fee_amt"));
        ...
        switch(sAction) {
			case IBSEARCH: 	//Retrieve
				if(validateForm(sheetObj,formObj,sAction, msgFlg)){
					...
					var sXml = sheetObj.GetSearchXml("ESD_AOC_3002GS.do", sParam);
			...
			case MULTI01: 	//Dry Save
				if(validateForm(sheetObj,formObj,sAction, msgFlg)){
					...
					if( sParam == ""){ return;}
					var sXml = sheetObj.GetSaveXml("ESD_AOC_3002GS.do", FormQueryString(formObj) + "&" + sParam, true);	        			
			...
			case MULTI03:	//Confirm
				...
				var sXml = sheetObj.GetSaveXml("ESD_AOC_3002GS.do", FormQueryString(formObj), true);
	...
	function getInCntCd(rowArray) {
		...
		var sParam = FormQueryString(formObj);
		var sXml = sheetObjects[2].GetSearchXml("ESD_AOC_3002GS.do", sParam);
    ...
    // 45' Cost 추가
    function co_mty45_OnChange(comObj, index, text)
    {
		var formObj = document.form;
		if(text == "-SYS AMT"){
			formObj.in_mty45.value = "";
			formObj.in_mty45.className = "input2";
			formObj.in_mty45.readOnly = true;
		}else{
			formObj.in_mty45.value = "";
			formObj.in_mty45.className = "input";
			formObj.in_mty45.readOnly = false;
		}
    }
    		...
    		case "in_cnt_cd":
    			if(!isNull(elementObj.value)){
    				if(elementObj.maxLength != elementObj.value.length){
						...
						var sXml = sheetObjects[2].GetSaveXml("ESD_AOC_3002GS.do", FormQueryString(formObj), true);
	    				var vCnt = ComGetEtcData(sXml, "cnt");
						if(vCnt == 0){
...
//							ComSetObjValue(formObj.curr_cd, "");
    		...
    		case "in_trans45":
    			if(!isNull(elementObj.value)){
					if(elementObj.value.substring(elementObj.value.length-1, elementObj.value.length) == "-"){
						ComSetObjValue(formObj.in_trans45, "");
					}
    			}
    			break;
    		...
    		case "in_mty45":
    			if(!isNull(elementObj.value)){
					if(elementObj.value.substring(elementObj.value.length-1, elementObj.value.length) == "-"){
						ComSetObjValue(formObj.in_mty45, "");
					}
    			}
    			break;
    		...
    		case "in_tmnl45":
    			if(!isNull(elementObj.value)){
					if(elementObj.value.substring(elementObj.value.length-1, elementObj.value.length) == "-"){
						ComSetObjValue(formObj.in_tmnl45, "");
					}
    			}
    			break;
    ...
    function initForm(){
		...
		comboObjects[16].Code = "R";
		comboObjects[17].Code = "^";
		comboObjects[18].Code = "R";
		comboObjects[19].Code = "^";
		comboObjects[20].Code = "R";
		
		ComSetObjValue(document.form.in_trans20, "");
		ComSetObjValue(document.form.in_trans40, "");
		ComSetObjValue(document.form.in_trans45, ""); // 45' Cost 추가
		ComSetObjValue(document.form.in_mty20, "");
		ComSetObjValue(document.form.in_mty40, "");
		ComSetObjValue(document.form.in_mty45, "");	// 45' Cost 추가
		ComSetObjValue(document.form.in_tmnl20, "");
		ComSetObjValue(document.form.in_tmnl40, "");
		ComSetObjValue(document.form.in_tmnl45, "");	// 45' Cost 추가
    }
    ...
    function popUpCall(url, btnFlg){
    	if( url == "ESD_AOC_3003" ){
    		if( sheetObjects[0].RowCount < 1 ){
				...
				var sUrl = "/hanjin/ESD_AOC_3003.do";
				var myOption = "width=1024,height=640,menubar=0,status=0,scrollbars=0,resizable=1";
				window.open(sUrl + param, "ESD_AOC_3003", myOption);
			}
    	}
    }
...
//		sheetObjects[0].Copy2SheetCol(sheetObjects[2], "", "", -1, -1, 2, 2, true, false, "chk");
    	...
    	for( var idx = tmpSheetObj.HeaderRows; idx <= tmpSheetObj.LastRow; idx++ ){
 			if( tmpSheetObj.CellValue(idx, "cost_trf_rout_seq") != "" ){
	 			...
	 			if( orgFindRow > -1 ){
	 				...
	 				&&  orgSheetObj.CellValue(orgFindRow, "trsp_45ft_adj_cost_amt") 	== tmpSheetObj.CellValue(idx, "trsp_45ft_adj_cost_amt")	// 45' Cost 추가
	 				...
	 				&&  orgSheetObj.CellValue(orgFindRow, "mty_trsp_45ft_adj_cost_amt") == tmpSheetObj.CellValue(idx, "mty_trsp_45ft_adj_cost_amt")	// 45' Cost 추가
	 				...
	 				&&  orgSheetObj.CellValue(orgFindRow, "tml_45ft_adj_cost_amt") 		== tmpSheetObj.CellValue(idx, "tml_45ft_adj_cost_amt") ){	// 45' Cost 추가
	 					normalityErrFlg = "Y";
	 				} else{
...
//	  				incompatibleErrCnt++;
	  				...
	  				tmpSheetObj.Copy2SheetCol(orgSheetObj, "", "", idx, idx, 2, 2, true, false, "");
	  				orgSheetObj.CellValue(orgSheetObj.LastRow, "chk") = "0";
//	  				orgSheetObj.CellValue(orgSheetObj.LastRow, "rf_20ft_ttl_cost_amt") = 0;
//	  				orgSheetObj.CellValue(orgSheetObj.LastRow, "rf_40ft_ttl_cost_amt") = 0;
	  				orgSheetObj.CellValue(orgSheetObj.LastRow, "load_excel") = "Add";
	  				orgSheetObj.RowStatus(orgSheetObj.LastRow) = "I";
	  			}
...
//  		}
	...
	function getCostAdjustmentTransCal(sheetObj, formObj){
		...
		// 45' Cost 추가
		var in_mty45_check ;
		if( comboObjects[18].Code == "S"){
			in_mty45_check = false;
		}else{
			if(ComIsEmpty(formObj.in_mty45.value)){
				in_mty45_check = true;
			}else{
				in_mty45_check = false;
			}
		...
		// 45' Cost 추가
		if(ComIsEmpty(formObj.in_trans20.value) && ComIsEmpty(formObj.in_trans40.value) && ComIsEmpty(formObj.in_trans45.value)
		   && in_mty20_check && in_mty40_check && in_mty45_check
		   && ComIsEmpty(formObj.in_tmnl20.value) && ComIsEmpty(formObj.in_tmnl40.value) && ComIsEmpty(formObj.in_tmnl45.value)
		)
		{
		...
		&& comboObjects[15].Text == "" && comboObjects[17].Text == "" && comboObjects[19].Text == "" ){
		...
		for (i=0; i<arrRow.length-1; i++){
			...
			if(comboObjects[1].Code.indexOf("^") > -1  || comboObjects[1].Code.indexOf(sheetObj.CellValue(arrRow[i], "trsp_crr_mod_cd")) > -1){
				...
				if(comboObjects[8].Code.indexOf("^") > -1  || comboObjects[8].Code.indexOf(sheetObj.CellValue(arrRow[i], "rcv_de_term_cd")) > -1){
					...
					// 45' Cost 추가
					if(!ComIsEmpty(formObj.in_trans45.value)){
						if(comboObjects[15].Code.indexOf("^") > -1  || comboObjects[15].Code.indexOf(sheetObj.CellValue(arrRow[i], "trsp_45ft_cost_sys_src_cd")) > -1){
							var in_trans45 = formObj.in_trans45.value;
							if(comboObjects[16].Code == "R"){
								sheetObj.CellValue(arrRow[i], "trsp_45ft_adj_cost_amt") = ComTrunc(parseFloat(sheetObj.CellValue(arrRow[i], "trsp_45ft_cost_amt"))*(in_trans45/100), 2);
							}else{
								sheetObj.CellValue(arrRow[i], "trsp_45ft_adj_cost_amt") = in_trans45;
							}
						}
					}
					
					if(!ComIsEmpty(formObj.in_mty45.value) || comboObjects[18].Code == "S"){
						if(comboObjects[17].Code.indexOf("^") > -1  || comboObjects[17].Code.indexOf(sheetObj.CellValue(arrRow[i], "mty_trsp_45ft_cost_sys_src_cd")) > -1){
							var in_mty45 = formObj.in_mty45.value;
							if(comboObjects[18].Code == "S"){
								sheetObj.CellValue(arrRow[i], "mty_trsp_45ft_adj_cost_amt") =  "-"+sheetObj.CellValue(arrRow[i], "mty_trsp_45ft_cost_amt");
							}else if(comboObjects[18].Code == "R"){
								sheetObj.CellValue(arrRow[i], "mty_trsp_45ft_adj_cost_amt") = ComTrunc(parseFloat(sheetObj.CellValue(arrRow[i], "mty_trsp_45ft_cost_amt"))*(in_mty45/100), 2);
							}else{
								sheetObj.CellValue(arrRow[i], "mty_trsp_45ft_adj_cost_amt") = in_mty45;
							}
						}
					}
					
					if(!ComIsEmpty(formObj.in_tmnl45.value)){
						if(comboObjects[19].Code.indexOf("^") > -1  || comboObjects[19].Code.indexOf(sheetObj.CellValue(arrRow[i], "tml_45ft_cost_sys_src_cd")) > -1){
							var in_tmnl45 = formObj.in_tmnl45.value;
							if(comboObjects[20].Code == "R"){
								sheetObj.CellValue(arrRow[i], "tml_45ft_adj_cost_amt") = ComTrunc(parseFloat(sheetObj.CellValue(arrRow[i], "tml_45ft_cost_amt"))*(in_tmnl45/100), 2);
							}else{
								sheetObj.CellValue(arrRow[i], "tml_45ft_adj_cost_amt") = in_tmnl45;
							}
						}
					}
				}
    ...
    function setCostTariffNoInfo(){
		...
		formObj.cntr_45ft_crte_wgt.value = ComGetEtcData(sXml, "cntr_45ft_crte_wgt");	// 45' Cost 추가
	...
	function formDeact(){
		...
		sheetObjects[0].InitDataProperty(0, sheetObjects[0].SaveNameCol("trsp_45ft_adj_cost_amt"), 		dtData,				70, daRight, 	true,		"trsp_45ft_adj_cost_amt", 		false, 		"", 		dfFloat, 	2, 			false, 		false);	// 45' Cost 추가
		...
		sheetObjects[0].InitDataProperty(0, sheetObjects[0].SaveNameCol("mty_trsp_45ft_adj_cost_amt"), 	dtData,				70, daRight, 	true,		"mty_trsp_45ft_adj_cost_amt",	false, 		"",			dfFloat, 	2, 			false, 		false);	// 45' Cost 추가
		...
		sheetObjects[0].InitDataProperty(0, sheetObjects[0].SaveNameCol("tml_45ft_adj_cost_amt"), 		dtData,				70, daRight, 	true,		"tml_45ft_adj_cost_amt",  		false, 		"", 		dfFloat, 	2, 			false, 		false);	// 45' Cost 추가
    ...
    function formAct(){
		...
		sheetObjects[0].InitDataProperty(0, sheetObjects[0].SaveNameCol("trsp_45ft_adj_cost_amt"), 		dtData,				70, daRight, 	true,		"trsp_45ft_adj_cost_amt", 		false, 		"", 		dfFloat, 	2, 			true, 		true);	// 45' Cost 추가
		...
		sheetObjects[0].InitDataProperty(0, sheetObjects[0].SaveNameCol("mty_trsp_45ft_adj_cost_amt"), 	dtData,				70, daRight, 	true,		"mty_trsp_45ft_adj_cost_amt",	false, 		"",			dfFloat, 	2, 			true, 		true);	// 45' Cost 추가
		...
		sheetObjects[0].InitDataProperty(0, sheetObjects[0].SaveNameCol("tml_45ft_adj_cost_amt"), 		dtData,				70, daRight, 	true,		"tml_45ft_adj_cost_amt",  		false, 		"", 		dfFloat, 	2, 			true, 		true);	// 45' Cost 추가
    ...
    function formAdjDisable(){
		...
		// 45' Cost 추가
		document.form.co_trans45_src.enable = false;
		document.form.co_trans45.enable = false;
		document.form.co_mty45_src.enable = false;
		document.form.co_mty45.enable = false;
		document.form.co_tmnl45_src.enable = false;
		document.form.co_tmnl45.enable = false;
		...
		// 45' Cost 추가
		document.form.in_trans45.className = "input2";
		document.form.in_trans45.readOnly = true;
		document.form.in_trans45.value = "";
		
		document.form.in_mty45.className = "input2";
		document.form.in_mty45.readOnly = true;
		document.form.in_mty45.value = "";
		
		document.form.in_tmnl45.className = "input2";
		document.form.in_tmnl45.readOnly = true;
		document.form.in_tmnl45.value = "";
    }
    ...
    function formAdjEnable(){
		...
		// 45' Cost 추가
		document.form.co_trans45_src.enable = true;
		document.form.co_trans45.enable = true;
		document.form.co_mty45_src.enable = true;
		document.form.co_mty45.enable = true;
		document.form.co_tmnl45_src.enable = true;
		document.form.co_tmnl45.enable = true;
		...
		// 45' Cost 추가
		document.form.in_trans45.className = "input";
		document.form.in_trans45.readOnly = false;
		document.form.in_trans45.value = "";
		
		document.form.in_mty45.className = "input";
		document.form.in_mty45.readOnly = false;
		document.form.in_mty45.value = "";
		
		document.form.in_tmnl45.className = "input";
		document.form.in_tmnl45.readOnly = false;
		document.form.in_tmnl45.value = "";
    }
	...
	// 45' Cost 추가 start
	function co_trans45_src_OnCheckClick(comboObj, index, code) {
		if( code == "^" ){
			if( comboObj.CheckIndex(0) == false ){
				comboObj.Code = "^";
				comboObj.CheckIndex(0) = false;
	...
	function co_mty45_src_OnCheckClick(comboObj, index, code) {
		if( code == "^" ){
			if( comboObj.CheckIndex(0) == false ){
				comboObj.Code = "^";
				comboObj.CheckIndex(0) = false;
	...
	function co_tmnl45_src_OnCheckClick(comboObj, index, code) {
		if( code == "^" ){
			if( comboObj.CheckIndex(0) == false ){
				comboObj.Code = "^";
				comboObj.CheckIndex(0) = false;
	...
	function validateDry(sheetObj){
		...
		if( sheetObj.RowCount > 0 ){
			...
			//[CHM-201537842]EUR Inland Cost Management 45" rate 관련 Logic 변경
			// 45 cost 가 0 이어도 confirm이 가능하도록 요청
				
				// 45' Cost 추가
//				if(sheetObj.CellValue(i,"inlnd_45ft_ttl_amt") <= 0){
//					sheetObj.CellBackColor(i,"inlnd_45ft_ttl_amt")  = sheetObj.RgbColor(255,54,54);
//					checkRed45 ++;
//				}else{
//					sheetObj.CellBackColor(i,"inlnd_45ft_ttl_amt")  = sheetObj.UnEditableColor;
//				}
...
//			if(checkRed20 != 0 || checkRed40 != 0 || checkRed45 != 0){
//				return false;
//			}
