...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3022 : esd_aoc_3022 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3022() {
...
//							param = param + '&curr_cd='				+ formObject.curr_cd.value;
							...
							param = param + '&ttlAmt45='			+ sheetObj.CellValue(sheetObj.SelectRow,"fdr_45ft_ttl_amt");  // 45' Cost 추가
    ...
    function loadPage() {
		...
		var sXml = sheetObjects[3].GetSearchXml("ESD_AOC_3022GS.do", sParam);
        ...
        switch(sheetID) {
        	case "sheet1":
        		with (sheetObj) {
					...
					var HeadTitle1 = "Flag||cost_trf_no|cost_trf_rout_seq|From|To|BND|DIR|Feeder Term|Feeder Term|Total Cost|Total Cost|Total Cost|M/B Ratio|M/B Ratio|M/B Ratio|M/B Ratio";
					...
					HeadTitle1 += "|Trans Cost 45'|Trans Cost 45'|Trans Cost 45'|Trans Cost 45'|Trans Cost 45'|Trans Cost 45'";	// 45' Cost 추가
					...
					HeadTitle1 += "|Empty Cost 45'|Empty Cost 45'|Empty Cost 45'|Empty Cost 45'|Empty Cost 45'";		// 45' Cost 추가
					...
					HeadTitle1 += "|Terminal Cost 45'|Terminal Cost 45'|Terminal Cost 45'|Terminal Cost 45'|Terminal Cost 45'";	// 45' Cost 추가
					HeadTitle1 += "|Service Provider|Service Provider|OLD\nAGMT|Load Excel\nValidation";

					var HeadTitle2 = "Flag||cost_trf_no|cost_trf_rout_seq|From|To|BND|DIR|RCV|DEL|20'|40'|45'|SCC|20'|40'|45'";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TRS2|Weight\n(AGMT)|Total";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TRS4|Weight\n(AGMT)|Total";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TRS4|Weight\n(AGMT)|Total";	// 45' Cost 추가
					...
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"trsp_45ft_cost_sys_src_cd",		false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"mty_trsp_45ft_cost_sys_src_cd",		false, 		"", 		dfNone, 	0, 			false, 		false);
					...
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"tml_45ft_cost_sys_src_cd",		false, 		"", 		dfNone, 	0, 			false, 		false);
            ...
            case "sheet4":
        		with (sheetObj) {
					...
					var HeadTitle1 = "Flag||cost_trf_no|cost_trf_rout_seq|From|To|BND|DIR|Feeder Term|Feeder Term|Total Cost|Total Cost|Total Cost|M/B Ratio|M/B Ratio|M/B Ratio|M/B Ratio";	// 45'
					HeadTitle1 += "|Trans Cost 20'|Trans Cost 20'|Trans Cost 20'|Trans Cost 20'|Trans Cost 20'";
					HeadTitle1 += "|Trans Cost 40'|Trans Cost 40'|Trans Cost 40'|Trans Cost 40'|Trans Cost 40'";
					...
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TRS2|Total";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TRS4|Total";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TRS4|Total";	// 45' Cost 추가
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_MTY2|Total";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_MTY4|Total";
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_MTY4|Total";	// 45' Cost 추가
					HeadTitle2 += "|System\nSource|System\nSource|System\nAmount|ADJ_TMNL2|Total";
					...
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"fdr_20ft_ttl_amt",        		false, 		"", 		dfFloat, 	2, 			false,		true);
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"fdr_40ft_ttl_amt",        		false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"fdr_45ft_ttl_amt",        		false, 		"", 		dfFloat, 	2, 			false, 		true);	// 45' Cost 추가
					InitDataProperty(0, cnt++, 	dtData,				50, daCenter, 	true,		"scc_cd",           			false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"mb_20ft_rto",        			false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"mb_40ft_rto",        			false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				65, daRight, 	true,		"mb_45ft_rto",        			false, 		"", 		dfFloat, 	2, 			false, 		true);	// 45' Cost 추가
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"trsp_20ft_cost_sys_src_cd", 	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"trsp_20ft_cost_sys_src_nm", 	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trsp_20ft_cost_amt",        	false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight, 	true,		"trsp_20ft_adj_cost_amt",    	false, 		"", 		dfFloat, 	2, 			true, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"trsp_40ft_ttl_cost_amt",    	false, 		"", 		dfFloat, 	2, 			false, 		true);
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"trsp_45ft_cost_sys_src_cd",		false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"trsp_45ft_cost_sys_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"trsp_45ft_cost_amt",				false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight,	 	true,		"trsp_45ft_adj_cost_amt",		false, 		"", 		dfFloat, 	2, 			true, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight,	 	true,		"trsp_45ft_ttl_cost_amt",			false, 		"", 		dfFloat, 	2, 			false, 		true);
					// 45' Cost 추가 end
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"mty_trsp_20ft_cost_sys_src_cd",false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"mty_trsp_20ft_cost_sys_src_nm",false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"mty_trsp_20ft_cost_amt",       false, 		"", 		dfFloat, 	2, 			false, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"mty_trsp_40ft_ttl_cost_amt",   false, 		"", 		dfFloat, 	2, 			false, 		true);
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"mty_trsp_45ft_cost_sys_src_cd",		false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"mty_trsp_45ft_cost_sys_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight,	 	true,		"mty_trsp_45ft_cost_amt",				false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight,	 	true,		"mty_trsp_45ft_adj_cost_amt",		false, 		"", 		dfFloat, 	2, 			true, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight,		true,		"mty_trsp_45ft_ttl_cost_amt",			false, 		"", 		dfFloat, 	2, 			false, 		true);
					// 45' Cost 추가 end
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"tml_20ft_cost_sys_src_cd",  	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"tml_20ft_cost_sys_src_nm",  	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"tml_20ft_cost_amt",         	false, 		"", 		dfFloat, 	2, 			false, 		true);
					...
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 	true,		"tml_40ft_ttl_cost_amt",     	false, 		"", 		dfFloat, 	2, 			false, 		true);
					// 45' Cost 추가 start
					InitDataProperty(0, cnt++, 	dtHidden,			60, daCenter, 	true,		"tml_45ft_cost_sys_src_cd",		false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"tml_45ft_cost_sys_src_nm",	false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight,		true,		"tml_45ft_cost_amt",				false, 		"", 		dfFloat, 	2, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,				70, daRight,		true,		"tml_45ft_adj_cost_amt",			false, 		"", 		dfFloat, 	2, 			true, 		true);
					InitDataProperty(0, cnt++, 	dtData,				60, daRight, 		true,		"tml_45ft_ttl_cost_amt",			false, 		"", 		dfFloat, 	2, 			false, 		true);
					// 45' Cost 추가 end
					InitDataProperty(0, cnt++, 	dtData,				60, daCenter, 	true,		"vndr_seq",             		false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData,			   120,	daLeft, 	true,		"vndr_nm",              		false, 		"", 		dfNone, 	0, 			false, 		true);
					InitDataProperty(0, cnt++, 	dtData, 			70, daCenter, 	true,		"agmt_old_flg", 				false, 		"", 		dfNone, 	0, 			false, 		true);
    ...
    function initForm(param){
    	if( param == "btn_reset1" ){
			...
			ComSetObjValue(document.form.in_trans45, "");
			ComSetObjValue(document.form.in_mty20, "");
			ComSetObjValue(document.form.in_mty40, "");
			ComSetObjValue(document.form.in_mty45, "");
			ComSetObjValue(document.form.in_tmnl20, "");
			ComSetObjValue(document.form.in_tmnl40, "");
			ComSetObjValue(document.form.in_tmnl45, "");
    	} else if( param == "btn_reset2" ){
    		comboObjects[19].Text = "";
			comboObjects[20].Code = "Y";
			comboObjects[21].Code = "R";
			comboObjects[22].Code = "^";
			comboObjects[23].Text = "";
			comboObjects[24].Code = "Y";
			comboObjects[25].Code = "R";
			comboObjects[26].Code = "^";
			comboObjects[27].Text = "";
			comboObjects[28].Code = "Y";
			comboObjects[29].Code = "R";
			comboObjects[30].Code = "^";
	...
	function sheet1_OnChange(sheetObj, Row, Col, Value){
		...
		if ( sName == "trsp_20ft_adj_cost_amt" ) {
		...
		} else if( sName == "trsp_45ft_adj_cost_amt" ) {	// 45' Cost 추가
			sheetObj.CellValue2(Row, "trsp_45ft_ttl_cost_amt") 		= parseFloat(sheetObj.CellValue(Row, "trsp_45ft_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "trsp_45ft_adj_cost_amt"));
			sheetObj.CellValue2(Row, "fdr_45ft_ttl_amt") 			= parseFloat(sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt"));
			...
			sheetObj.CellValue2(Row, "fdr_40ft_ttl_amt") 			= parseFloat(sheetObj.CellValue(Row, "trsp_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_40ft_ttl_cost_amt"));
		} else if( sName == "mty_trsp_45ft_adj_cost_amt" ) {	// 45' Cost 추가
			sheetObj.CellValue2(Row, "mty_trsp_45ft_ttl_cost_amt") 	= parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_adj_cost_amt"));
			sheetObj.CellValue2(Row, "fdr_45ft_ttl_amt") 			= parseFloat(sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt"));
			...
			sheetObj.CellValue2(Row, "fdr_40ft_ttl_amt") 			= parseFloat(sheetObj.CellValue(Row, "trsp_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_40ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_40ft_ttl_cost_amt"));
		} else if( sName == "tml_45ft_adj_cost_amt" ) {	// 45' Cost 추가
			sheetObj.CellValue2(Row, "tml_45ft_ttl_cost_amt") 		= parseFloat(sheetObj.CellValue(Row, "tml_45ft_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_45ft_adj_cost_amt"));
			sheetObj.CellValue2(Row, "fdr_45ft_ttl_amt") 			= parseFloat(sheetObj.CellValue(Row, "trsp_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "mty_trsp_45ft_ttl_cost_amt")) + parseFloat(sheetObj.CellValue(Row, "tml_45ft_ttl_cost_amt"));
		}
	}
    ...
    function doActionIBSheet(sheetObj,formObj,sAction,msgFlg) {
        ...
        switch(sAction) {
			case IBSEARCH: //Retrieve
	        	...
	        	var sParam = AocFrmQryString(formObj);
				var sXml = sheetObj.GetSearchXml("ESD_AOC_3022GS.do", sParam);
			...
			case MULTI01: //Dry Save
				...
				var sXml = sheetObj.GetSaveXml("ESD_AOC_3022GS.do", AocFrmQryString(formObj) + "&" + sParam, true);
			...
			case MULTI04:
				...
				var sXml = sheetObj.GetSaveXml("ESD_AOC_3022GS.do", AocFrmQryString(formObj), true);
				sheetObj.LoadSaveXml(sXml);
    ...
    function setCostTariffNoInfo(){
		...
		ComSetObjValue(formObj.cntr_45ft_crte_wgt, ComGetEtcData(sXml, "cntr_45ft_crte_wgt"));	// 45' Cost 추가
    ...
    function tab1_OnChange(tabObj , nItem)
    {
        ...
        switch(nItem) {
    		case 0:
				...
				document.all.item("45dryLayer").style.display = "inline";	// 45' Cost 추가
    		...
    		case 1:
				...
				document.all.item("45dryLayer").style.display = "none";	// 45' Cost 추가
			...
			if( findRow > -1 )
			{
				if( document.all.item("tabLayer")[0].style.display == "inline" || document.all.item("tabLayer")[2].style.display == "inline" ){
					...
					if( document.all.item("tabLayer")[0].style.display == "inline" ) {
						sheetObjOrg.CellValue(idx, "trsp_45ft_adj_cost_amt") 		= sheetObjExl.CellValue(findRow, "trsp_45ft_adj_cost_amt");
						sheetObjOrg.CellValue(idx, "mty_trsp_45ft_adj_cost_amt") 	= sheetObjExl.CellValue(findRow, "mty_trsp_45ft_adj_cost_amt");
						sheetObjOrg.CellValue(idx, "tml_45ft_adj_cost_amt") 		= sheetObjExl.CellValue(findRow, "tml_45ft_adj_cost_amt");
					}
	...
	function getDryRfCostAdjustmentCal(){
		...
		var tmnl40_err_flg = false;
		// 45' Cost 추가
		var tran45_err_flg = false;
		var mty45_err_flg = false;
		var tmnl45_err_flg = false;
    	...
    	// // 45' Cost 추가
    	if(isDry) {
    		if( formObj.in_trans45.value == "" )								tran45_err_flg = true;
    		if( comboObjects[16].Code != "S" && formObj.in_mty45.value == "" ) 	mty45_err_flg = true;
    		if( formObj.in_tmnl45.value == "" ) 								tmnl45_err_flg = true;
    	}
		...
		if( tran20_err_flg && tran40_err_flg && mty20_err_flg && mty40_err_flg && tmnl20_err_flg && tmnl40_err_flg ){
			if( !isDry ){
				...
				return false;
			// 45' Cost 추가
			} else if( isDry && tran45_err_flg && mty45_err_flg && tmnl45_err_flg ) {
				ComShowCodeMessage("COM130201", "Cost Adjustment");
				return false;
			}
		}
		...
		for( idx = 0; idx < arrRow.length - 1; idx++ ){
			...
			//Trans45' Adjustment Amount 추가
			if( isDry && formObj.in_trans45.value != "" ){
				if( comboObjects[13].Code.indexOf("^") > -1 || comboObjects[13].Code.indexOf(sheetObj.CellValue(arrRow[idx], "trsp_45ft_cost_sys_src_cd")) > -1 ){
					var trans45_val = formObj.in_trans45.value;
					if( comboObjects[14].Code == "R" ){
						sheetObj.CellValue(arrRow[idx], "trsp_45ft_adj_cost_amt") = ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "trsp_45ft_cost_amt")) * (trans45_val/100), 2);
					} else{
						sheetObj.CellValue(arrRow[idx], "trsp_45ft_adj_cost_amt") = trans45_val;
					}
				}
			}
			...
			//Mty45' Adjustment Amount 추가
			if( isDry && (formObj.in_mty45.value != "" || comboObjects[16].Code == "S") ){
				if( comboObjects[15].Code.indexOf("^") > -1 || comboObjects[15].Code.indexOf(sheetObj.CellValue(arrRow[idx], "mty_trsp_45ft_cost_sys_src_cd")) > -1 ){
					var mty45_val = formObj.in_mty45.value;
					if( comboObjects[16].Code == "S" ){
						sheetObj.CellValue(arrRow[idx], "mty_trsp_45ft_adj_cost_amt") = parseFloat(sheetObj.CellValue(arrRow[idx], "mty_trsp_45ft_cost_amt")) * -1;
					} else if( comboObjects[10].Code == "R" ){
						sheetObj.CellValue(arrRow[idx], "mty_trsp_45ft_adj_cost_amt") = ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "mty_trsp_45ft_cost_amt")) * (mty45_val/100), 2);
					} else{
						sheetObj.CellValue(arrRow[idx], "mty_trsp_45ft_adj_cost_amt") = mty45_val;
					}
				}
			}
			...
			//Tmnl45' Adjustment Amount 추가
			if( isDry && formObj.in_tmnl45.value != "" ){
				if( comboObjects[17].Code.indexOf("^") > -1 || comboObjects[17].Code.indexOf(sheetObj.CellValue(arrRow[idx], "tml_45ft_cost_sys_src_cd")) > -1 ){
					var tmnl45_val = formObj.in_tmnl45.value;
					if( comboObjects[18].Code == "R" ){
						sheetObj.CellValue(arrRow[idx], "tml_45ft_adj_cost_amt") = ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "tml_45ft_cost_amt")) * (tmnl45_val/100), 2);
					} else{
						sheetObj.CellValue(arrRow[idx], "tml_45ft_adj_cost_amt") = tmnl45_val;
					}
				}
			}
		}
     ...
     */
 	function getDgCostAdjustmentCal(){
		...
		if( comboObjects[19].Text == "" && comboObjects[23].Text == "" && comboObjects[27].Text == "" ){
			ComShowCodeMessage("COM130201", "Cost Adjustment");
			return false;
		}
		...
		//Class 중복 체크
		var arrClss1 = comboObjects[19].Code.split(",")
		var arrClss2 = comboObjects[23].Code.split(",")
		var arrClss3 = comboObjects[27].Code.split(",")
		var clss_err_flg = false;
		
		if( comboObjects[19].Text != "" ){
		...
		//가져온 행을 배열로 만든다.
		var arrRow = iCheckRows.split("|");
		var clssStr = comboObjects[19].Code + "," + comboObjects[23].Code + "," + comboObjects[27].Code;
		var svc_flg = "N";
		var schg_amt_20ft = 0;
		var schg_amt_40ft = 0;
		for( idx = 0; idx < arrRow.length - 1; idx++ ){
			...
			if( clssStr.indexOf("Class1") > -1 ){
				if( clssStr.substr(clssStr.indexOf("Class1")+7,1) == "1" ){
					...
					if( comboObjects[21].Code == "R" ){
						if( comboObjects[22].Code == "^" || comboObjects[22].Code == "D2,D4" ){
						...
						} else if(comboObjects[22].Code == "D2"){
							schg_amt_20ft 	= ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "fdr_20ft_ttl_amt")) * (formObj.in_class1.value/100), 2);
						} else if(comboObjects[22].Code == "D4"){
							schg_amt_40ft 	= ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "fdr_40ft_ttl_amt")) * (formObj.in_class1.value/100), 2);
						}	
					} else {
						if( comboObjects[22].Code == "^" || comboObjects[22].Code == "D2,D4" ){
					...
					svc_flg		= comboObjects[24].Code;
					if( comboObjects[25].Code == "R" ){
						if( comboObjects[26].Code == "^" || comboObjects[26].Code == "D2,D4" ){
						...
						} else if(comboObjects[26].Code == "D2"){
							schg_amt_20ft 	= ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "fdr_20ft_ttl_amt")) * (formObj.in_class2.value/100), 2);
						} else if(comboObjects[26].Code == "D4"){
							schg_amt_40ft 	= ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "fdr_40ft_ttl_amt")) * (formObj.in_class2.value/100), 2);
						}
					} else {
						if( comboObjects[26].Code == "^" || comboObjects[26].Code == "D2,D4" ){
					...
					svc_flg		= comboObjects[28].Code;
					if( comboObjects[29].Code == "R" ){
						if( comboObjects[30].Code == "^" || comboObjects[30].Code == "D2,D4" ){
						...
						} else if(comboObjects[30].Code == "D2"){
							schg_amt_20ft 	= ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "fdr_20ft_ttl_amt")) * (formObj.in_class3.value/100), 2);
						} else if(comboObjects[30].Code == "D4"){
							schg_amt_40ft 	= ComTrunc(parseFloat(sheetObj.CellValue(arrRow[idx], "fdr_40ft_ttl_amt")) * (formObj.in_class3.value/100), 2);
						}
					} else {
						if( comboObjects[30].Code == "^" || comboObjects[30].Code == "D2,D4" ){
