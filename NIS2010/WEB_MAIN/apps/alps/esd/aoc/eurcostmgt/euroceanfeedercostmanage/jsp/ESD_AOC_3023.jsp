...
<%@ page import="com.hanjin.apps.alps.esd.aoc.eurcostmgt.euroceanfeedercostmanage.event.EsdAoc3023Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
	EsdAoc3023Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		ttl_amt45			= JSPUtil.getNull(request.getParameter("ttlAmt45"));		// 45' Cost 추가
		...
		event = (EsdAoc3023Event)request.getAttribute("Event");
