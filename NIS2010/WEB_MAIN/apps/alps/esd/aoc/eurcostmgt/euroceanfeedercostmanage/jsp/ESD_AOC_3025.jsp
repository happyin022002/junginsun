...
<%@ page import="com.hanjin.apps.alps.esd.aoc.eurcostmgt.euroceanfeedercostmanage.event.EsdAoc3025Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.Date"%>
<%
	EsdAoc3025Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3025Event)request.getAttribute("Event");
