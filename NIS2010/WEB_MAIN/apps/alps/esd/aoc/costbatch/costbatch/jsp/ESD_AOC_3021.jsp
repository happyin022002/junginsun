...
<%@ page import="com.hanjin.apps.alps.esd.aoc.costbatch.costbatch.event.EsdAoc3021Event"%>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
	EsdAoc3021Event  event = null;							//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3021Event)request.getAttribute("Event");
