...
<%@ page import="com.hanjin.apps.alps.esd.aoc.aocreport.pnlreport.event.EsdAoc3033Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdAoc3033Event  event 	= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3033Event)request.getAttribute("Event");
