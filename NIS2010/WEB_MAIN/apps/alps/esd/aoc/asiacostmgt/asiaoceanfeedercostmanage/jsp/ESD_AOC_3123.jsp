...
*@FileName : ESD_AOC_3123.jsp
*@FileTitle : Ocean Feeder Cost Management Cost Detail (SHA/SIN)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
<%@ page import="com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiaoceanfeedercostmanage.event.EsdAoc3123Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdAoc3123Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3123Event)request.getAttribute("Event");
