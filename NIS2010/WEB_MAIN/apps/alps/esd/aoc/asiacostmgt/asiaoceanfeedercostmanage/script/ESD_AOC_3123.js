...
*@FileName : ESD_AOC_3123.js
*@FileTitle : Ocean Feeder Cost Management Cost Detail (SHA)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3123 : esd_aoc_3123 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3123() {
	...
	switch(sAction) {
		case IBSEARCH:		//Retrieve
			if(!validateForm(sheetObj,formObj,sAction)) return;
	   		...
	   		sheetObj.DoSearch4Post("ESD_AOC_3123GS.do", AocFrmQryString(formObj));
	   		break;
