...
*@FileName : ESD_AOC_3122.jsp
*@FileTitle : Ocean Feeder Cost Management(SHA/SIN)
*Open Issues :
*Change history :
...
* 2013.08.16 서미진 [선처리 CSR] DG tab의 apply/reset 버튼 조정
...
<%@ page import="com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiaoceanfeedercostmanage.event.EsdAoc3122Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.hanjin.framework.component.util.StringUtil" %>

<%
	EsdAoc3122Event  event 		= null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3122Event)request.getAttribute("Event");
			...
			<table class="search"> 
	       		<tr>
		       		<td class="bg">
						...
						<%if(rhqCd.equals("SHARC")){ %>
							<tr class="h23">
							<td width="90">RHQ</td>
				<td class="stm" colspan="3"><input type="radio" class="trans" name="rdoRhqCd" value="SHARC" checked>SHARC&nbsp;&nbsp;<input type="radio" class="trans" name="rdoRhqCd" value="SELIB">SELIB&nbsp;&nbsp;<input type="radio" class="trans" name="rdoRhqCd" value="TYOIB">TYOIB</td>
							</tr>
					  	<%}%>
							<tr class="h23">
