...
*@FileName : ESD_AOC_3125.js
*@FileTitle : Ocean Feeder Cost Inquiry(SHA)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3125 : esd_aoc_3125 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3125() {
        ...
        switch(sAction) {
			case IBSEARCH: //Retrieve
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSearchXml("ESD_AOC_3125GS.do", sParam);
			...
			case IBDOWNEXCEL:
				...
				formObj.action = "ESD_AOC_3125EXCEL.do?"+ AocFrmQryString(formObj);
			    formObj.submit();
			    ComOpenWait(false);
		        break;
