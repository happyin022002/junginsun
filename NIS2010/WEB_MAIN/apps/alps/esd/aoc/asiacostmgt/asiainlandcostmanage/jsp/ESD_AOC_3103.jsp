...
*@FileName : ESD_AOC_3103.jsp
*@FileTitle : Inland Cost Management Route Detail(SHA/SIN)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
<%@ page import="com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiainlandcostmanage.event.EsdAoc3103Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdAoc3103Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3103Event)request.getAttribute("Event");
