...
*@FileName : ESD_AOC_3110.jsp
*@FileTitle : Inland Cost Inquiry(SHA/SIN)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
<%@ page import="com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiainlandcostmanage.event.EsdAoc3110Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.Date"%>
<%
	EsdAoc3110Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdAoc3110Event)request.getAttribute("Event");
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td><script language="javascript">ComComboObject('trsp_crr_mod_cd', 1, 104, 1, 0);</script></td>
				</tr>
				</table>
