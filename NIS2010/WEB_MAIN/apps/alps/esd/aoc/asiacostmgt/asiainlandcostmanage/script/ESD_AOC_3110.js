...
*@FileName : ESD_AOC_3110.js
*@FileTitle : Inland Cost Inquiry(SHA)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_AOC_3110 : esd_aoc_3110 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function esd_aoc_3110() {
        ...
        switch(sAction) {
			case IBSEARCH: //Retrieve
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml = sheetObj.GetSearchXml("ESD_AOC_3110GS.do", sParam);
			...
			case IBDOWNEXCEL:
				if(validateForm(sheetObj,formObj,sAction)){
					...
					formObj.action = "ESD_AOC_3110EXCEL.do?"+ AocFrmQryString(formObj);
				    formObj.submit();
				    ComOpenWait(false);
				}
		        break;
