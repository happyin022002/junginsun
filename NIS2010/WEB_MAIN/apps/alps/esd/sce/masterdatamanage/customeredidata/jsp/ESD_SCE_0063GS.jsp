...
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.event.ESD_SCE_0063Event"%>
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.event.ESD_SCE_0063EventResponse"%>
<%@ page import="com.hanjin.framework.support.controller.html.FormCommand"%>
<%

    ESD_SCE_0063Event event = null;
    ESD_SCE_0063EventResponse eventResponse = null;    //RDTO(Data Transfer Object including DB ResultSet)
    ...
    try {
        ...
        if (serverException != null) {
            ...
            event = (ESD_SCE_0063Event)request.getAttribute("Event");
            eventResponse = (ESD_SCE_0063EventResponse)request.getAttribute("EventResponse");
...
<%
           } else {    //System.out.println("cnt : " + cnt);//조회XML인 경우%>
