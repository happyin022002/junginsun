...
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.event.ESD_SCE_0067Event"%>
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.event.ESD_SCE_0067EventResponse"%>
<%@ page import="com.hanjin.framework.support.controller.html.FormCommand"%>
<%

	Logger log = Logger.getLogger("com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.jsp.ESD_SCE_0067GS");
