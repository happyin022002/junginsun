...
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.event.ESD_SCE_0073Event"%>
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.customeredidata.event.ESD_SCE_0073EventResponse"%>
<%@ page import="com.hanjin.framework.support.controller.html.FormCommand"%>
<%

    ESD_SCE_0073Event event = null;
    ESD_SCE_0073EventResponse eventResponse = null;    	  //RDTO(Data Transfer Object including DB ResultSet)
...
//    System.out.println("GS 073");
    ...
    try {
        ...
        if (serverException != null) {
            ...
            event = (ESD_SCE_0073Event)request.getAttribute("Event");

            if(event.getFormCommand().isCommand(FormCommand.SEARCH02)){
            	eventResponse = (ESD_SCE_0073EventResponse)request.getAttribute("EventResponse");
...
<%
    } else if(event.getFormCommand().isCommand(FormCommand.COMMAND03) || event.getFormCommand().isCommand(FormCommand.COMMAND02)) {
%>	
	<ETC-DATA>
