...
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.exceptiondata.event.EsdSce0028Event"%>
<%@ page import="com.hanjin.apps.alps.esd.sce.common.util.basic.CodeUtilBC" %>
<%@ page import="com.hanjin.apps.alps.esd.sce.common.util.basic.CodeUtilBCImpl" %>
				...
				<td class="bg">
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td><input name="ofc_cd" type="text" style="width:90; text-transform:uppercase;" maxlength="6" onKeyUp="this.value=this.value.toUpperCase()">&nbsp;<img onClick="openOfcPop(false,'ofc_cd')" class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
						</tr>
					</table>
