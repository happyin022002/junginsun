...
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.exceptiondata.event.EsdSce0112Event"%>
...
<tr>
	<td class="bodyright" width="100%">
				...
				<td class="bg">
					<table class="search" border="0" style="width:200;">
						<tr class="h23">
							...
							<img onClick="openOfcPopUp(true,'mstofccd')" class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
		...
		<tr><td class="align">
			...
			<table class="button">
				<tr>
				    <!--<td><img class="cursor" src="/hanjin/img/enis/button/btn_retrieve.gif" width="66" height="20" border="0" name="btn_retrieve"></td>
					...
					<td><img class="cursor" src="/hanjin/img/enis/button/btn_downexcel.gif" width="84" height="20" border="0" name="btn_downexcel"></td> -->
					</tr>
				</table></td></tr>
		</table>
...
<td class="bodyright" width="100%">
	...
	<table width="100%" class="title">
  	<tr>
  	  <td class="title">
        <!--<img src="/hanjin/img/enis/ico_t1.gif" width="20" height="12">Mapping Office  -->
        Mapping Office
      </td>
    </tr>
	</table>
	<table class="height_5"><tr><td></td></tr></table>
				...
				<td class="bg">
					<table class="search" border="0" style="width:600;">
						<tr class="h23">
							...
							<img onClick="openOfcPopUp(true,'mapgofccd')" class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
		...
		<tr><td class="align">
			...
			<table class="button">
				<tr>
				    <!-- <td><img class="cursor" src="/hanjin/img/enis/button/btn_retrieve.gif" width="66" height="20" border="0" name="dbtn_retrieve"></td>
					<td><img class="cursor" src="/hanjin/img/enis/button/btn_new.gif" width="66" height="20" border="0" name="dbtn_new"></td>
					<td><img class="cursor" src="/hanjin/img/enis/button/btn_save.gif" width="66" height="20" border="0" name="dbtn_save"></td>
					<td><img class="cursor" src="/hanjin/img/enis/button/btn_downexcel.gif" width="84" height="20" border="0" name="dbtn_downexcel"></td> -->
					</tr>
				</table></td></tr>
		</table>
		<!-- TABLE '#D' : ( Button : Main ) (E) -->
	...
	<!--
	<tr><td colspan=2 align="center" class="bg_a">
  		<table class="sbutton">
  			<tr><td><img class="cursor" src="/hanjin/img/enis/button/btn_save.gif" width="66" height="20" border="0" name="dbtn_save"></td>
			</tr>
		</table>
	</td></tr>
	 -->
