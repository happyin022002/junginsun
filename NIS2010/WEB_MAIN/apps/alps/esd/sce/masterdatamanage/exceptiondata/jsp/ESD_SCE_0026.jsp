...
<%@ page import="com.hanjin.apps.alps.esd.sce.masterdatamanage.exceptiondata.event.EsdSce0026Event"%>
...
<tr><td>
	...
	<table width="100%" class="title">
  	<tr>
  	  <td class="title">
        <img src="/hanjin/img/icon_title_dot.gif" width="9" height="9">&nbsp;Exception Type Detail
      </td>
    </tr>
	</table>
