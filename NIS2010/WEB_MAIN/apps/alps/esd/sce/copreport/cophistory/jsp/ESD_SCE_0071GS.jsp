...
<%@page import="com.hanjin.apps.alps.esd.sce.copreport.cophsitory.event.ESD_SCE_0071EventResponse"%>
...
%>
		<TR>
			...
			<TD><![CDATA[ <%=( "SMCU0000000".equals( JSPUtil.getNull(rowSet.getString("CNTR_NO")))?"":JSPUtil.getNull(rowSet.getString("CNTR_NO")))%>]]></TD>
