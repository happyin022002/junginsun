...
<%@ page import="com.hanjin.apps.alps.esd.sce.copreport.optimumroutepass.event.EsdSce0170Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="java.util.Date"%>
<%
	EsdSce0170Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSce0170Event)request.getAttribute("Event");
...
<input type="hidden" name="from_node">
<input type="hidden" name="door_node">
		...
		<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="">
						<script language="javascript">ComComboObject('trsp_mod_cd', 1, 120, 1);</script>
					</td>	
				</tr>
				</table>
				...
				<tr class="h23">
					<td width="165">W/O Issue Office Code</td>
					<td width="240">
						<table border="0" style="height:25; width:100%; background-color: #E9E9E9;">
						<tr>
							<td><input name="input_office" type="text" class="input1" style="width:70" onkeyup="upper(this)" value="<%=strOfc_cd%>" ><img src="" width="2" height="1" border="0"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_office">&nbsp;&nbsp;<input type="checkbox" name="chk_office" value="Y" class="trans" onClick="javascript:fun_chkOffice();">Incl. Sub OFC</td>
						</tr>
						</table>
					</td>
					<td width="10"></td>
					<td width="100">Inland Route</td>
					<td width="422">
						<table border="0" style="height:25; width:90%; background-color: #E9E9E9;">
                        <tr>
                        	<td width="50">From/To</td>
							<td width="66"><input name="search_fm_loc" type="text" style="width:56;" maxlength="5" onChange="getComboList(this, document.form.search_fm_yard, 'F');" onBlur=""  ></td>
							<td width="80"><script language="javascript">ComComboObject('search_fm_yard', 1, 48, 0)</script><img src="" width="2" hight="1"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btns_frmnode"></td>
							<td width="50">Door</td>
							...
							<td width="80"><script language="javascript">ComComboObject('search_door_yard', 1, 45, 0)</script><img src="" width="2" hight="1"><img class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"  name="btns_dorloc"></td>
						</tr>
                        </table>
                        </td>
				</tr>
