...
*@FileName : ESD_SCE_0160.jsp
*@FileTitle : SCEM - Candidate Inquiry by Dwell Type
*Open Issues :
*Change history :
...
<input type="hidden" name="cntr_no_list" value=''>
...
<tr><td>
	...
	<!-- TABLE '#D' : ( Button : Main ) (S) -->
				...
				<tr><td class="btn1_bg">
						...
						<tr>
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
								<tr><td class="btn1_left"></td><td class="btn1" name="btn_copyemail" id="btn_copyemail">Copy E-mail sending option</td><td class="btn1_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
      ...
      <table class="search">
        <tr>
          <td class="bg"><!-- biz_1  (S) -->
            <table class="search_in" border="0" style="width:1050;">
              <tr class="h23">
                <td width="100">Date (LMT)</td>
		        ...
		        <td width="50">POD</td>
				<!--  POD 멀티체크박스&&& -->
				<td width="80"><input name="pod_cd" caption="POD" type="text" class="input" style="width:60 ;ime-mode:disabled;" minlength="2" maxlength="5">&nbsp;<!-- img onClick="openLocPopUp(true,'pod_cd')" class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"--></td>
                ...
                <td width="50">VVD</td>
				<td width="80"><input name="vvd" caption="VVD" type="text" style="width:70; text-align:left;ime-mode:disabled; " maxlength="9">&nbsp;<!-- img onClick="openVVDPopUp(true)" class="cursor" src="/hanjin/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"--></td>
						
              </tr>
               <tr class="h23">
                <td width="100">Rail Dest</td>
                ...
                <td width="140"><input name="bl_no" caption="BL NO" type="text" style="width:100;ime-mode:disabled; " class="input" value="" maxlength="12"></td>
