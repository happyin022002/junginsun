...
<%@ page import="com.hanjin.apps.alps.esd.sce.dwellnotification.event.EsdSce0155Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSce0155Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSce0155Event)request.getAttribute("Event");
          ...
          <table><tr><td width=25% align=left>
            <table class="search" border="0" style="width:480;" >
              ...
              <td width="65">S/C NO :</td>
                <td width="*"><input type="text" style="width:80;" class="input2" value="<%=sc_no %>" Readonly></td>
                <td width="110">Customer Code :</td>
                <td width="*"><input type="text" style="width:70;" class="input2" name="cust_cd" value="<%=cust_cd%>" Readonly></td>
                <td width="55">Type :</td>
