 ...
 *@FileName : ESD_SCE_0141.js
 *@FileTitle : 96hrs Terminal Dwell
 *Open Issues :
 *Change history :
...
/**
 * @extends
 * @class ESD_SCE_0141 : ESD_SCE_0141 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */

function ESD_SCE_0141() {
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: 
		with (sheetObj) {
			...
			InitColumnInfo(39, 2, 0, true); //24

			// 해더에서 처리할 수 있는 각종 기능을 설정한다
			InitHeadMode(true, true, false, true, false, false)

			var HeadTitle = "CNTR NO|Type & Size|Mode|BKG No|BL No|Lane|VVD|POD|"
							+"DEL|Delivery Term|Rail Origin Yard|Rail Dest Yard|Movement/Yard|Movement date|Dwell Hours|Dwell Reasons|Fixed POD LFD|F|O|C|Customs Date|Customs location|Contract\nSub-Office|Contract\nOffice|S/C No(BKG Main)(1)|S/C Customer(1)|Sent status(1)|E-mailing list(1)|Exception Status(1)|"
						//	+"Shipper|E-mailing list|Sent status|Exception Status|Consignee|E-mailing list|Sent status|Exception Status|Notify|E-mailing list|Sent status|Exception Status|Batch Date|Dwell Type";
							+"Consignee(2)|E-mailing list(2)|Sent status(2)|Exception Status(2)|Notify(3)|E-mailing list(3)|Sent status(3)|Exception Status(3)|Batch Date|Dwell Type";
			...
			InitDataProperty(0, cnt++, dtData, 75, daCenter, false, "cntr_tpsz_cd");
			InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "so_mode");
			//InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "sc_no");
			//InitDataProperty(0, cnt++, dtData, 150, daLeft, false, "cust_cd_nm");
			InitDataProperty(0, cnt++, dtData, 85, daCenter, false, "bkg_no");
			InitDataProperty(0, cnt++, dtData, 85, daCenter, false, "bl_no");
			InitDataProperty(0, cnt++, dtData, 70, daCenter, false, "vsl_slan_cd");
			...
			InitDataProperty(0, cnt++, dtData, 85, daCenter, false, "de_term_cd");
            InitDataProperty(0, cnt++, dtData, 85, daCenter, false, "rail_org_yd_cd");
            InitDataProperty(0, cnt++, dtData, 85, daCenter, false, "rail_dest_yd_cd");
			...
			InitDataProperty(0, cnt++, dtData, 80, daCenter, false, "dwll_hrs");
			InitDataProperty(0, cnt++, dtData, 150, daLeft, false, "dwll_rsn");
			InitDataProperty(0, cnt++, dtData, 90, daCenter, false, "ft_end_dt");
			InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "frt_clt_flg");
			InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "obl_rdem_flg");
			InitDataProperty(0, cnt++, dtData, 30, daCenter, false, "cstms_clr_cd");
			InitDataProperty(0, cnt++, dtData, 150, daCenter, false, "cstms_clr_lst_dt");
			InitDataProperty(0, cnt++, dtData, 100, daCenter, false, "cstms_loc_cd");
...
//		ComOpenWait(true);
		...
		sheetObj.DoSearch("ESD_SCE_0141GS.do", SceFrmQryString(formObj));
...
function tabClearSheet() {
	...
	formObject.cntr_no.value = "";
	formObject.sent.value = "";
	formObject.cust_value1.value = "";
	formObject.cust_value2.value = "";
