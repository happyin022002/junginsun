...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESD_SCE_0155 : ESD_SCE_0155 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESD_SCE_0155() {
             ...
             case 1:      //IBSheet1 init
                	 with (sheetObj) {
     	               ...
     	               //전체Edit 허용 여부 [선택, Default false]
     	                ...
     	                var HeadTitle = "|CHK|Office|E - mail Address|CRM|Origin|Destination|Other Parties|Remark|C.Date|C.User|C.Name|D.Date|D.User|D.Name|sc_no|ntfc_seq|i_del_flg|";
     	              ...
     	              // InitDataProperty(0, cnt++ , dtStatus,	30,   daCenter, false, "ibflag");
     	                InitDataProperty(0, cnt++ , dtCheckBox,	    60,   daCenter, false, "chk"      ,   false, "", dfNone, 	  0, true, true , -1,false,true,"",true);
     	                InitDataProperty(0, cnt++ , dtData,     	60,  daCenter, false, "cre_ofc_cd",   false , "", dfNone, 	  0, false, false);
     	                InitDataProperty(0, cnt++ , dtData,     	170,  daLeft, false, "subsc_eml",   true , "", dfNone, 	  0, false, false);
     	                InitDataProperty(0, cnt++ , dtCheckBox,	    60,   daCenter, false, "eml_fm_crm_flg"      ,   false, "", dfNone, 	  0, true, true , -1,false,true,"",true);
     	                InitDataProperty(0, cnt++ , dtCheckBox,	    60,   daCenter, false, "eml_bkg_org_flg"      ,   false, "", dfNone, 	  0, true, true , -1,false,true,"",true);
     	                InitDataProperty(0, cnt++ , dtCheckBox,	    100,   daCenter, false, "eml_bkg_dest_flg"      ,   false, "", dfNone, 	  0, true, true , -1,false,true,"",true);
     	                InitDataProperty(0, cnt++ , dtCheckBox,	    100,   daCenter, false, "eml_bkg_otr_flg"      ,   false, "", dfNone, 	  0, true, true , -1,false,true,"",true);
     	                InitDataProperty(0, cnt++ , dtData,     	250,  daLeft  , false, "subsc_rmk",   false, "", dfNone, 	  0, true, true);
     					...
     					InitDataProperty(0, cnt++ , dtData,      	100,  daCenter, false, "cre_usr_nm",  false, "", dfNone, 	  0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,     	72,   daCenter, false, "delt_dt",     false, "", dfDateYmd,    0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,      	72,   daCenter, false, "delt_usr_id", false, "", dfNone,       0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,      	100,  daCenter, false, "delt_usr_nm", false, "", dfNone,       0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,      	100,  daCenter, false, "sc_no",       false, "", dfNone,       0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,      	100,  daCenter, false, "ntfc_seq",    false, "", dfNone,       0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,      	100,  daCenter, false, "i_del_flg",       false, "", dfNone,       0, false, false);
     	                InitDataProperty(0, cnt++ , dtHidden,      	100,  daCenter, false, "cust_cd",       false, "", dfNone,       0, false, false);
            ...
            switch(sAction) {
            	case IBSEARCH_ASYNC01:      //조회
            		//if(validateForm(sheetObj,formObj,sAction)){
            			formObj.f_cmd.value = SEARCH;
            	      	sheetObj.DoSearch4Post("ESD_SCE_0155GS.do", SceFrmQryString(formObj));
            		// }
            	break;
            	...
            	case IBSAVE:
            		if(validateForm(sheetObj,formObj,sAction)){
            			...
            			sheetObj.DoSave("ESD_SCE_0155GS.do", SceFrmQryString(formObj));
            		}
        	  	break;
...
//           */  
       	function sheet1_OnChange(sheetObj,Row, Col, Value) {
       	    var formObject = document.form;
      		 if(sheetObj.ColSaveName(Col) == "eml_bkg_org_flg"){
         ...
         */  
         ...
         function  closeWindow(){
        	 ...
        	 var opnSheetObj = opener.sheetObjects[0];
           	 var formObject = document.form;
        	 opnSheetObj.CellValue2(opnSheetObj.SelectRow, "email_list_cnt") = "Edit (Registered : "+ formObject.totalCount.value +" )";
        	 self.close();
         }
	/* 개발자 작업  끝 */