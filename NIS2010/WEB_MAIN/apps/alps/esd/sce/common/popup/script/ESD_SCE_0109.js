        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    InitDataProperty(0, cnt++ , dtCheckBox,20,    daCenter,  false,    "check2",           false,          "",       dfNone,	    0,     true,       true);
                    ...
                    InitDataProperty(0, cnt++ , dtData,      85,    daCenter,  false,    "eq_ctrl_ofc_cd",       false,          "",       dfNone, 	0,     false,       true);
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          ...
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch4Post("ESD_SCE_0109GS.do", selectVal);               
               
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value = SEARCHLIST;  
                sheetObj.DoSearch4Post("ESD_SCE_0109GS.do", selectVal, "iPage=" + PageNo, true);
           break;
