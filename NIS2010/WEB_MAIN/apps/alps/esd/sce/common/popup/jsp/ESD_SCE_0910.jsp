...
<%
	...
	try {
		...
		selfccd = request.getParameter("sel_ofc_cd") == null ? "" : request.getParameter("sel_ofc_cd");
...
<html>
<head>
<title>Office Search Popup</title>
...
<tr><td valign="top">
		...
		<table width="100%" border="0">
			<tr><td height="79" class="title"><img src="/hanjin/img/icon_title_dot.gif" align="absmiddle">&nbsp;Office Select</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
