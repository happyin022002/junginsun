	...
	try {
        ...
        switch(srcName) {
			...
			case "btn_ok":
				...
				opener.getSCNO( sheetObj.CellValue(arrChkRows[0], "scno"));
    ...
    switch(sheetNo) {
        case 1:      //IBSheet1 init
            with (sheetObj) {
                ...
                InitDataProperty(0, cnt++ , dtData,      116,    daCenter,  false,    "customercode",        false,          "",       dfNone,       0,     false,       true);
                InitDataProperty(0, cnt++ , dtData,      116,    daCenter  ,  false,    "customername",        false,          "",       dfNone,       0,     false,       true);
                InitDataProperty(0, cnt++ , dtData,      116,    daCenter  ,  false,    "scno",        false,          "",       dfDateYmd,       0,     false,       true);
                InitDataProperty(0, cnt++ , dtData,      116,    daCenter  ,  false,    "soffice",        false,          "",       dfDateYmd,       0,     false,       true);
...
//                }
                ...
                sheetObj.DoSearch4Post("ESD_SCE_0105GS.do", selectVal);
...
function sheet1_OnScrollNext(sheetObj,CondParam, PageNo, OnePageRow){
    ...
    if (sheetObj.TotalRows > sheetObj.RowCount){    
		...
		//alert("pageNo:"+PageNo);
    	selectVal = SceFrmQryString(formObj);
	    sheetObj.DoSearch4Post("ESD_SCE_0105GS.do", selectVal, "cur_page=" + PageNo, true);
    }	    
}
