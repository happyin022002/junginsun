...
<%@ page import="com.hanjin.apps.alps.esd.sce.customerscheduleedi.portpairexception.event.EsdSce0127Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSce0127Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSce0127Event)request.getAttribute("Event");
		...
		adj_rgst_dt = eventResponse.getETCData("adj_rgst_dt");
		adj_seq = eventResponse.getETCData("adj_seq");
		...
		slan_cd = eventResponse.getETCData("slan_cd");
...
<input type="hidden" name="adj_rgst_dt" value="<%=adj_rgst_dt%>">
<input type="hidden" name="adj_seq" value="<%=adj_seq%>">
	...
	<tr>
		<td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
				...
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp;Adjustment lane</td></tr>
			</table>
