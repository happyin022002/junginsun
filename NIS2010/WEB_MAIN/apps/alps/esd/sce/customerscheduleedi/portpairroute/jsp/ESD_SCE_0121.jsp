...
<%@ page import="com.hanjin.apps.alps.esd.sce.customerscheduleedi.portpairroute.event.EsdSce0121Event"%>
<%
	EsdSce0121Event  event = null;					//PDTO(Data Transfer Object including Parameters)
		...
		<table width="100%" class="button" border="0" cellpadding="0" cellspacing="0" style="padding-bottom:5;">
				<tr><td class="btn1_bg">
						...
						<tr>
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
								<tr><td class="btn1_left"></td><td class="btn1" name="btn_ocn" id="btn_ocn">Ocn Route</td><td class="btn1_right"></td></tr></table></td>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
			...
			<tr>
				<td class="bg">
					...
					<tr class="h23">
						...
						<td width="">
							<script language="javascript">ComComboObject('partner_id_cd', 2, 150, 1, 1);</script>
							<!-- input class="input1" type="text" name="partner_id" value="6135830007" style="width:120; text-transform:uppercase;" onfocusout="javascript:getPartnerName()" --> <input class="input2" type="text" name="partner_name" readonly value="" style="width:416">
						</td>
					</tr>
					</table>
					...
					<tr class="h23">
						...
						<td width="40">Type</td>
						<td width="80"><input type="hidden" name="ts_type" value="A">
							<select name="select1" style="width:70;" onChange="changeSelect('T')"   tabIndex="6">
								<option value="A" >All</option>
								<option value="D" >Direct</option>
								<option value="T" >T/S</option>
							</select></td>

						<td><table border="0" bordercolor="#A3A4C7" class="search" style="height:21; width:100; background color: #F3F2F8;"><td align="center">No Use Flag&nbsp;<input name="no_use_flag" type="checkbox" class="trans"  value="N" unchecked></td></table></td>
					</tr>
					</table>
				</td>
			</tr>
