...
<%@ page import="com.hanjin.apps.alps.esd.sce.bkgcopmanage.event.EsdSce9998Event"%>
...
<%
	...
	EsdSce9998Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
			...
			event = (EsdSce9998Event)request.getAttribute("Event");
...
<!--  											<td class="btn1_line"></td>-->
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_create" id="btn_create">Booking Create</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											...
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_split" id="btn_split">Booking Split</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_combine" id="btn_combine">Booking Combine</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_cntrAttach" id="btn_cntrAttach">Container attach</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_cntrDetach" id="btn_cntrDetach">Container Detach</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											...
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_moveCntr" id="btn_moveCntr">Move Container</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											...
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_replan" id="btn_replan">Replan</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
										...
										<tr>
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_cntrCnfm" id="btn_cntrCnfm">Container Confirm</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_confirmTro" id="btn_confirmTro">Confirm Tro</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
											<td>
												<table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
													<tr>
														<td class="btn1_left"></td>
														<td class="btn1" name="btn_genPc" id="btn_genPc">Welcome To the Hell</td>
														<td class="btn1_right"></td>
													</tr>
												</table>
											</td>
			...
			<td class="bg">
				...
				<tr class="h23">
					...
					<td width="" >
						...
						<img onClick="openAddPaste('tgt_bkg_nos')" class="cursor" src="/hanjin/img/button/btng_plus.gif" width="19" height="20" border="0" align="absmiddle">
					</td>
