...
<%@ page import="com.hanjin.apps.alps.esd.sce.batch.copmanage.event.COPManageEvent" %>
<%@ page import="com.hanjin.apps.alps.esd.sce.batch.copmanage.COPManageBSC" %>
...
<%
	...
	try {
		...
		//str_bkg_no 			= "CMB73150031";
		//str_bkg_no_split 	= "  ";
		//str_in_cntr_no 		= "ARAU4003760-ARAU4003776-ARAU4004812";
		//str_in_cntr_tp 		= "D5-D3-D4";
		//str_in_chg_cntr_no 	= "YJIU4006879@*ARAU4002996-SHJU4000067@*SMPU2011095";
		//str_in_chg_cntr_tp 	= "D4@*D4-D3@*D4-D5@*D4";
