...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.location.event.BcmCcd0015Event"%>
...
<!-- page_title_area(E) -->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="120" style="text-align: right">Sub Continent Code</td>
                    <td width="90"><input type="text" style="width:50px;ime-mode:disabled;text-align:center" name="sconti_cd" id="sconti_cd" class="input1" dataformat="engup" maxlength="2">
                    ...
                    <td colspan="3"><input type="text" style="width:60%;" dataformat="engupspace" otherchar="()_\-,. " name="sconti_nm" id="sconti_nm" class="input1"  maxlength="50"></td>
                </tr>   
        </table>
    <table class="line_bluedot"><tr><td></td></tr></table>
    <table class="search" border="0" style="width:979;">
				<tr class="h23">
                    <td width="120" style="text-align: right">Continent</td>
                    <td><script type="text/javascript">ComComboObject('conti_cd', 2, 78, 1, 1, 1);</script></td>
                </tr>
                </table>
     <table class="search" border="0" style="width:979;">
                <tr class="h23">
