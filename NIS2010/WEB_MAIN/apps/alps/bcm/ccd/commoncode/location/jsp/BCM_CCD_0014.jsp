...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.location.event.BcmCcd0014Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    BcmCcd0014Event  event = null;              //PDTO(Data Transfer Object including Parameters)
    Exception serverException   = null;         //Error from server
    String strErrMsg = "";                      //Error from server
    ...
    try {
        ...
        event = (BcmCcd0014Event)request.getAttribute("Event");
...
<!-- page_title_area(E) -->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="95" style="text-align: right">Continent Code</td>
                    <td width="90"><input type="text" style="width:50px;ime-mode:disabled;text-align:center" name="conti_cd" id="conti_cd" class="input1" dataformat="engup" maxlength="1">
                    ...
                    <td width="80" style="text-align: right">Name</td>
                    <td><input type="text" style="width:60%;" dataformat="engupspace" otherchar="()_\-,. " name="conti_nm" id="conti_nm" class="input1"  maxlength="50"></td>
                </tr>
        </table>
