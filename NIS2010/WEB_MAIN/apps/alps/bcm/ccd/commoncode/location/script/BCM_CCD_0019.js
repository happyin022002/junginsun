...
function processButtonClick(){
   ...
   /*******************************************************/
    ...
    try {
        switch(srcName) {
	        case "btn_History":
	        	var tblNo = 'MDM_LOCATION';
	        	var locCd = formObject.loc_cd.value;
	        	var mstKey = nullToBlank(locCd);
				if (mstKey == "") {
					ComShowCodeMessage("CCD00038", "Location Code");
					return false;
				}
            ...
            case "btns_search1":
                ...
                var sUrl="/hanjin/COM_ENS_051.do?loc_cd=" + formObj.loc_cd.value +"&main_page=false&mdm_yn="+formObj.mdm_yn.value;
                var rVal=ComOpenPopup(sUrl, 870, 400, "locCodeHelp", "0,0", true);
                break;
            case "btns_search2":
                var formObj=document.form;
            ...
            case "btns_search3":
                ...
                var rVal=ComOpenPopup(sUrl, 770, 420, "cntCodeHelp", "0,0", true);
                break;
            case "btns_search4":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_0J1.do?rgn_cd=" + formObj.rgn_cd.value +"&main_page=false";
                var rVal=ComOpenPopup(sUrl, 650, 400, "rgnCodeHelp", "0,0", true);
                break;
            case "btns_search5"://approval route management
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_0X1.do?ste_cd=" + formObj.ste_cd.value +"&main_page=false";
                var rVal=ComOpenPopup(sUrl, 300, 350, "steCodeHelp", "0,0,1,1,1", true);
                break;
            case "btns_search6":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_051.do?scc_cd=" + formObj.scc_cd.value +"&main_page=false&scc_flg=Y";
                var rVal=ComOpenPopup(sUrl, 750, 410, "sccCodeHelp", "0,0", true);
                break;
            case "btns_search7":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_061.do?node_cd=" + formObj.rep_zn_cd.value +"&main_page=&mode=zone&mode_only=Y";
                var rVal=ComOpenPopup(sUrl, 780, 420, "zoneCodeHelp", "0,0", true);                
                break;
            case "btns_search8":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_071.do?ofc_cd=" + formObj.sls_ofc_cd.value +"&main_page=false";
                var rVal=ComOpenPopup(sUrl, 650, 430, "slsOfcCodeHelp", "0,0", true);
                break;
            case "btns_search9":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_071.do?ofc_cd=" + formObj.eq_ctrl_ofc_cd.value +"&main_page=false";
                var rVal=ComOpenPopup(sUrl, 650, 430, "eqCtrlOfcCodeHelp", "0,0", true);
                break;
            case "btns_search10":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_071.do?ofc_cd=" + formObj.finc_ctrl_ofc_cd.value +"&main_page=false";
                var rVal=ComOpenPopup(sUrl, 650, 430, "fincCtrlOfcCodeHelp", "0,0", true);
                break;
            case "btns_search11":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_061.do?node_cd=" + formObj.mty_pkup_yd_cd.value +"&main_page=&mode=yard&mode_only=Y";
                var rVal=ComOpenPopup(sUrl, 800, 420, "mtyPkupYdCodeHelp", "0,0", true);
                break;
            case "btns_search12":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_061.do?node_cd=" + formObj.eq_rtn_yd_cd.value +"&main_page=&mode=yard&mode_only=Y";
                var rVal=ComOpenPopup(sUrl, 800, 420, "eqRtnYdCodeHelp", "0,0", true);
                break;
            case "btns_search13":
                var formObj=document.form;
                var sUrl="/hanjin/COM_ENS_051.do?loc_cd=" + formObj.hub_loc_cd.value +"&main_page=false";
                var rVal=ComOpenPopup(sUrl, 800, 410, "hubLocCodeHelp", "0,0", true);
                break;
...
function loadPage() {
    ...
    document.form.ecc_cd.style.backgroundColor="#E8E7EC";
    document.form.rcc_cd.style.backgroundColor="#E8E7EC";
    document.form.lcc_cd.style.backgroundColor="#E8E7EC";
}
...
function doActionIBCombo(sheetObj,formObj,sAction,sComboObj,sComboAction,sComboKey){
    switch (sAction) {
        case SEARCH01: // load page
            var sXml=sheetObj.GetSearchXml("BCM_CCD_0019GS.do", "f_cmd=" + SEARCH01);
...
//                    ComBtnDisable("btn_Save");  
                ...
                var sXml=sheetObj.GetSearchXml("BCM_CCD_0019GS.do", sParam);
                ...
                if(loc_nm == ""){
                	...
                	if(ComIsBtnEnable("btn_Create")) {
                        if(ComShowConfirm(ComGetMsg("CCD00034", "Location Code"))){
                			...
                			ComEnableObject(formObj.btns_search1, false);                        } else {
                        }
                	}
                } else {
                	if (ComIsBtnEnable("btn_Create")) {
	                    ...
	                    formObj.ecc_cd.value=ComXmlString(sXml, "ecc_cd");
	                    formObj.lcc_cd.value=ComXmlString(sXml, "lcc_cd");
	                    formObj.rcc_cd.value=ComXmlString(sXml, "rcc_cd");
	...
	//                    formObj.loc_grd_no.value=ComXmlString(sXml, "loc_grd_no");
	                    ...
	                    formObj.loc_chr_cd.Code = ComXmlString(sXml, "loc_chr_cd");
	                    formObj.loc_tp_cd.Code = ComXmlString(sXml, "loc_tp_cd");
	                    formObj.conti_cd.Code = ComXmlString(sXml, "conti_cd");
	                    ...
	                    formObj.bkg_bl_pfx_cd.value=ComXmlString(sXml, "bkg_bl_pfx_cd");
	                    formObj.blk_port_flg.value=ComXmlString(sXml, "blk_port_flg");
	...
	//					formObj.modi_loc_cd2.value = ComXmlString(sXml, "modi_loc_cd2");
	                    ...
	                    formObj.loc_cd.style.backgroundColor="#E8E7EC";
        ...
        case IBSAVE:
            if(validateForm(sheetObj,formObj,sAction)){
                ...
                if(ComShowCodeConfirm(tmpMsg, "Data")){
                    ComOpenWait(true);
                    var sXml=sheetObj.GetSaveXml("BCM_CCD_0019GS.do", sParam + "&" + ComGetPrefixParam("sheet1_"));
        ...
        case SEARCH14:      //Set Country Click
            if(validateForm(sheetObj,formObj,sAction)){
                ...
                if(contiCd!="") comboObjects[2].Code = contiCd;
                ComOpenWait(false);
            }
        break;
        ...
        case IBCLEAR:
            clearAllData(sheetObj, formObj);
 			...
 			formObj.loc_cd.style.backgroundColor="#CCFFFD";
            ComEnableObject(formObj.btns_search1, true);
            formObj.call_port_flg.checked=false;
            formObj.loc_chr_cd.Code("");
            formObj.loc_tp_cd.Code("");
    ...
    switch(sAction) {
        ...
        case IBSAVE:        //save
            if(formObj.loc_cd.value == ""){
                ...
                return false;
            }else if(formObj.loc_cd.value.length != 5) {
            	ComShowCodeMessage("CCD00057", "Location Code", "5");
            	ComSetFocus(formObj.loc_cd);
                return false;
            }else if(formObj.loc_nm.value == ""){
                ComShowCodeMessage("CCD00001", "English Name");
                ComSetFocus(formObj.loc_nm);
                return false;
            }else if(formObj.loc_chr_cd.Text()== ""){
                ComShowCodeMessage("CCD00001", "Character");
                ComSetFocus(formObj.loc_chr_cd);
                return false;
            }else if(formObj.port_inlnd_flg.value == ""){
                ComShowCodeMessage("CCD00001", "Port");
                ComSetFocus(formObj.port_inlnd_flg);
                return false;
            }else if(formObj.loc_tp_cd.Text() == ""){
                ComShowCodeMessage("CCD00001", "Type");
                ComSetFocus(formObj.loc_tp_cd);
                return false;
            }else if(formObj.conti_cd.Text() == ""){
                ComShowCodeMessage("CCD00001", "Continent");
                ComSetFocus(formObj.conti_cd);
                return false;
            }else if(formObj.sconti_cd.value == ""){
                ComShowCodeMessage("CCD00001", "Sub Continent");
                ComSetFocus(formObj.sconti_cd);
                return false;
                ...
                ComSetFocus(formObj.loc_locl_lang_nm);
                return false;
            } else if(formObj.gmt_hrs.value == ""){
                ComShowCodeMessage("CCD00001", "UTC Gap");
                ComSetFocus(formObj.gmt_hrs);
                return false;
            } 
            
            if(formObj.loc_lat.value.length > 0) {
            	if(formObj.loc_lat.value.match(/\./g) != null) {
            		if(formObj.loc_lat.value.match(/\./g).length != 1) {
            			ComShowCodeMessage("COM132201", "Latitude");
            			ComSetFocus(formObj.loc_lat);
            			return false;
            		} 
            	}
            	if(formObj.loc_lat.value.indexOf('.') == -1) {
            		if(formObj.loc_lat.value.length > 3) {
            			ComShowCodeMessage("CCD00067", "Latitude", "3");
            			ComSetFocus(formObj.loc_lat);
                		return false;
            		}
            	} else {
            		if(formObj.loc_lat.value.indexOf('.') > 3) {
            			ComShowCodeMessage("CCD00067", "Latitude", "3");
            			ComSetFocus(formObj.loc_lat);
            			return false;
            		} else if (formObj.loc_lat.value.length - formObj.loc_lat.value.indexOf('.') > 3) {
            			ComShowCodeMessage("CCD00066", "Latitude", "2");
            			ComSetFocus(formObj.loc_lat);
            			return false;
            		}
            	} 
            ...
            if(formObj.loc_lon.value.length > 0) {
            	if(formObj.loc_lon.value.match(/\./g) != null) {
            		if(formObj.loc_lon.value.match(/\./g).length != 1) {
            			ComShowCodeMessage("COM132201", "Longitude");
            			ComSetFocus(formObj.loc_lon);
            			return false;
            		} 
            	}
            	if(formObj.loc_lon.value.indexOf('.') == -1) {
            		if(formObj.loc_lon.value.length > 3) {
            			ComShowCodeMessage("CCD00067", "Longitude", "3");
            			ComSetFocus(formObj.loc_lon);
                		return false;
            		}
            	} else {
            		if(formObj.loc_lon.value.indexOf('.') > 3) {
            			ComShowCodeMessage("CCD00067", "Longitude", "3");
            			ComSetFocus(formObj.loc_lon);
            			return false;
            		} else if (formObj.loc_lon.value.length - formObj.loc_lon.value.indexOf('.') > 3) {
            			ComShowCodeMessage("CCD00066", "Longitude", "2");
            			ComSetFocus(formObj.loc_lon);
            			return false;
            		}
            	}
            ...
            if(locCd.substring(0,2) != formObj.cnt_cd.value){
            	ComShowCodeMessage("CCD00051");
            	ComSetFocus(formObj.cnt_cd);
                return false;
            }
            ...
            if(formObj.scc_cd.value.length > 0) {
...
function clearAllData(sheetObj, formObj){
    ...
    formObj.call_port_flg.checked=false;
    formObj.loc_chr_cd.Text = "";
    formObj.loc_tp_cd.Text = "";
...
function sccCodeHelp(rowArray) {
    ...
    doActionIBSheet(sheetObject1, formObj, SEARCH06);
    formObj_OnChange();
}
