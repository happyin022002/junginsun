...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.location.event.BcmCcd0017Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
        BcmCcd0017Event  event = null;              //PDTO(Data Transfer Object including Parameters)
        ...
        try {
            SignOnUserAccount account=(SignOnUserAccount)session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
                ...
                event = (BcmCcd0017Event)request.getAttribute("Event");
...
<!--biz page (S)-->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="95" style="text-align: right">Region Code</td>
                    <td width="80">
                        <input type="text" style="width:50px;ime-mode:disabled;text-align:center" name="rgn_cd" class="input1" dataformat="engup" maxlength="3" id="rgn_cd"/>
                    ...
                    <td width="95" style="text-align: right">Name</td>
                    <td><input type="text" style="width:60%;" class="input1" dataformat="engupspace" otherchar="()_\-,. " name="rgn_nm"  maxlength="50" id="rgn_nm" /></td>
                </tr>   
        </table>
	<table class="line_bluedot"><tr><td></td></tr></table>
          <table class="search" border="0" style="width:979;">
			<tr class="h23">
                    <td width="95" style="text-align: right">Country</td>
                    <td width="80">
                        <input type="text" style="width:50px;ime-mode:disabled;text-align:center" class="input1" name="cnt_cd" dataformat="engup" maxlength="2" id="cnt_cd" onBlur="obj_change();"/>
