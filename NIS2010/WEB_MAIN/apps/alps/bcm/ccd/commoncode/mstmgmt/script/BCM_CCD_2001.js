		...
		try {
			...
			switch (srcName) {
				...
				case "btn_com_ens_091":
		    		...
		    		ComOpenPopup('/hanjin/COM_ENS_091.do?' + param, 780, 550, 'setCallBack0B2', '1,0,1,1,1,1,1,1', true);
					break;
		...
		case "sheet1":
		    with(sheetObj){			       
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:0,   SaveName:prefix+"ibflag" },
			             ...
			             {Type:"Popup",     Hidden:0, Width:120,  Align:"Center",  ColMerge:0,   SaveName:prefix+"usr_id",          KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
    ...
    function sheet1_OnSearchEnd(sheetObj, ErrMsg){
 	...
 	function sheet1_OnPopupClick(sheetObj,Row,Col) {
 		...
 		if (sheetObj.ColSaveName(Col) == prefix+"usr_id") {
			...
			ComOpenPopup('/hanjin/COM_ENS_091.do?' + param, 780, 550, 'getCOM_ENS_091', '1,0,1,1,1,1,1,1', true, Col, Row);
 		}
 	}
