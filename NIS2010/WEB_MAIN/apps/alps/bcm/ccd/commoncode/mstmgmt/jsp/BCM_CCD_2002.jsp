...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.mstmgmt.event.BcmCcd2002Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	BcmCcd2002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.hanjin.apps.CommonCode.MstMgmt");
	...
	try {
		...
		event = (BcmCcd2002Event)request.getAttribute("Event");
...
<input type="hidden" name="proc_tp_cd" id="proc_tp_cd" />
...
<div class="opus_design_inquiry wFit">
	...
	<table> 
		...
		<tr class="h23">
			<th>Request Date</th>
			<td><input type="text" style="width:80px;" class="input" name="fm_rqst_dt" dataformat="ymd"  caption="Request From Date"><!-- 
			 -->~ <!-- 
...
<div class="wrap_result">
	...
	<div class="opus_design_grid">
		<h3 class="title_design">Request List</h3>
	...
	<!-- opus_design_grid(S) -->
	<div class="opus_design_grid">
		<h3 class="title_design">Completion</h3>
		<!-- opus_design_btn(S) -->
		<div class="opus_design_btn"><!--
