...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.mstmgmt.event.BcmCcd2001Event"%>
...
<div class="opus_design_inquiry wFit">
	<table>
		...
		<tr class="h23">
			...
			<th>Authority ID</th>
			<td><input type="text" style="width:120px; ime-mode:disabled; text-align:center;" class="input" name="usr_id" value="" maxlength="20" dataformat="excepthan"  id="usr_id" /><!-- 
