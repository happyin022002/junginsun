 ...
 ***************************************************************************************/
    ...
    function processButtonClick(){
        ...
        try {
            ...
            case "btn_History":
            	var tblNo = 'MDM_TRADE';
	        	var vslslanCd = formObj.trd_cd.value;
	        	var mstKey = nullToBlank(vslslanCd);
	        	
				if (mstKey == "") {
					ComShowCodeMessage("CCD00038", "Trade Code");
					return false;
				}
			...
			case "btns_trade":
				...
				//var sUrl="/hanjin/COM_COM_0012.do?code=" + formObj.trd_cd.value + "&main_page=" + "false"+ "&mdm_yn=" + "Y";
				var sUrl="/hanjin/COM_ENS_081.do?trade_cd=" + formObj.trd_cd.value +"&main_page=false&mode=rev";
...
// 		        doActionIBSheet(sheetObjects[0],formObj,SEARCH02);
 				break;
            case "btn_ofc_cd":
            	var sUrl="/hanjin/COM_ENS_071.do?ofc_cd=" + formObj.ofc_cd.value;
    ...
    */
	...
	function doActionIBCombo(sheetObj,formObj,sAction,sComboObj,sComboAction,sComboKey){
		switch (sAction) {
			...
			var sXml=sheetObj.GetSearchXml("BCM_CCD_0030GS.do", "f_cmd=" + SEARCH01);
			...
			for(var i=0; i<rtnValue.length; i++){
				...
				if(i == 2){
					comboXml[0] = "|" + comboXml[0];
					comboXml[1] = "|" + comboXml[1];
				}
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
    	...
    	case SEARCH02:				//query
    		if (validateForm(sheetObj, formObj, sAction)) {
	    		...
	    		var sXml=sheetObj.GetSearchXml("BCM_CCD_0030GS.do", sParam);
...
//	    			formObj.trd_nm.focus();
	    		...
	    		formObj.fm_conti_cd.Code = getValueForCombo(ComXmlString(sXml, "fm_conti_cd"));
	    		
	    		//to_conti_cd.SetSelectCode(getValueForCombo(ComXmlString(sXml, "to_conti_cd")));
	    		formObj.to_conti_cd.Code = getValueForCombo(ComXmlString(sXml, "to_conti_cd"));
	    		
	    		//vsl_tp_cd.SetSelectCode(getValueForCombo(ComXmlString(sXml, "vsl_tp_cd")));
	    		formObj.vsl_tp_cd.Code = getValueForCombo(ComXmlString(sXml, "vsl_tp_cd"));
    	...
    	case MULTI01:				//save
    		if (validateForm(sheetObj, formObj, sAction)) {
	    		...
	    		if(ComShowConfirm(ComGetMsg(tmpMsg, "Data"))){
 	        	...
 	        	ComOpenWait(true);
 	    		var sParam=FormQueryString(formObj);
 	    		var sXml=sheetObj.GetSaveXml("BCM_CCD_0030GS.do", sParam);
 	    		var sav=ComGetEtcData(sXml, "TRANS_RESULT_KEY");
    	...
    	case IBCLEAR:
    		...
    		formObj.fm_conti_cd.Code = "";
    		
    		//to_conti_cd.SetSelectCode("");
    		formObj.to_conti_cd.Code = "";
