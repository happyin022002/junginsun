...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.commodity.event.BcmCcd0010Event"%>
...
<!-- page_title_area(E) -->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="140" style="text-align: right">Rep. Commodity Code</td>
                    <td width="130">
                        <input type="text" style="width:80px;text-align:center;ime-mode:disabled;" class="input1" dataformat="int" name="rep_cmdt_cd" id="rep_cmdt_cd" maxlength="4">
                    	<img src="img/btns_search.gif" name="btns_search" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor" id="btns_search">
                    </td>
                    <td width="160" style="text-align: right">Group Commodity Code</td>
                    <td>
                        <input type="text" style="width:80px;text-align:center;ime-mode:disabled;" class="input1" dataformat="int" name="grp_cmdt_cd" id="grp_cmdt_cd" maxlength="2">
                    </td>
                </tr>
        </table>
    ...
    <div class= "opus_design_inquiry">
        <table class="search" border="0" style="width:979;">
			<tr class="h23">
                    ...
                    <td width=""><input type="text" style="width:440px;text-align:left;" class="input1" dataformat="engupspecial" otherchar="()_\-,. " name="rep_cmdt_nm" id="rep_cmdt_nm" maxlength="200"></td>
