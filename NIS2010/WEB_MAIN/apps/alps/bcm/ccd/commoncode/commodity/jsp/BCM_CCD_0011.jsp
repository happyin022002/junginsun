...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.commodity.event.BcmCcd0011Event"%>
...
<!-- opus_design_inquiry(S) -->
		...
		<tr>
			<td class="bg">
				...
				<tr class="h23">
                    <td width="145" style="text-align: right">Commodity Code</td>
                    <td colspan="3">
                        <input type="text" style="width:80px;text-align:center;ime-mode:disabled;" class="input1" dataformat="int" name="cmdt_cd" maxlength="6" >
		...
		<table class="line_bluedot"><tr><td></td></tr></table>
          <table class="search" border="0" style="width:979;">
			<tr class="h23">
                    <td width="145" style="text-align: right">Name</td>
                    <td><input type="text" style="width:60%;text-align:left;" class="input1" name="cmdt_nm" dataformat="engupspecial" maxlength="200"></td>
                </tr>   
                </table>
                <table class="search" border="0" style="width:979;">
                <tr class="h23">
                    <td width="145" style="text-align: right">Rep. Commodity Code</td>
                    <td width="200"><script type="text/javascript">ComComboObject('rep_cmdt_cd', 2, 100, 1, 1, 0, false)</script></td>
                    <td width="120" style="text-align: right">Rep. IMDG Level</td>
                    <td width="70"><script type="text/javascript">ComComboObject('rep_imdg_lvl_cd', 2, 60, 1, 0, 0, false)</script></td>
                    <td width="120" style="text-align: right">FMC Exempt Flag</td>
                    <td>
                        <select style="width:60px;" class="input" name="fmc_exp_flg">
                            <option value=""></option>
                            <option value="Y">Y</option>
                            <option value="N">N</option>
                        </select>
                    </td>
<!--                     <td style="text-align: right">EU Export Flag</td>
                    <td>
        		...
        		<table class="search" border="0" style="width:979;">
                <tr class="h23">
                	<td width="145" style="text-align: right">Group Commodity Code</td>
                    <td width="200"><script type="text/javascript">ComComboObject('grp_cmdt_cd', 2, 100, 1, 1, 0, false)</script></td>
                    <td width="120" style="text-align: right">Chemical Flag</td>
                    <td>
                        <select style="width:50px;" class="input" name="chem_flg" id="chem_flg" >
                ...
                <tr class="h23">
                    <td>Delete Flag</td>
                    <td>
                        <select style="width:50px;" class="input" name="delt_flg" id="delt_flg" >
                            <option value="N">N</option>
                            <option value="Y">Y</option>
                        </select>
                    </td>
