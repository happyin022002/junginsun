...
document.onclick=processButtonClick;
    ...
    function initSheet(sheetObj,sheetNo) {
    	var cnt=0;
        with(sheetObj){
	          var HeadTitle="|Charge Code|Charge Name|Charge Type|Charge Rev Type|Charge Applying Type|Payment Term|Applying Service Mode Flag|Account (G/L)|Rep.Charge|Auto Rating Flag|Display Seq. on B/L|CY|CFS|Door|Tackle|Not Applicable|Delete Flag|Create User|Create Date/Time|Last Update User|Last Update Date/Time";
