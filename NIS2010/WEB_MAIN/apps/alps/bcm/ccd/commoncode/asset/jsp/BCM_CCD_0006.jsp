...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.asset.event.BcmCcd0006Event"%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:5;">
	...
	<tr><td valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
			...
			<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"><span id="title">&nbsp; Container Size</span></td></tr>
		</table>
       		...
       		<tr>
				...
				<!--  biz_1  (S) -->
					<table class="search" border="0" style="width:979;"> 
						<tr class="h23">
							<td width="200">Container Size Code</td>
							<td width="500" >
								<input id="cntr_tp_cd" style="width: 50px; text-align:center;" class="input1" value="" name="cntr_sz_cd" maxlength="2" dataformat="uppernum" type="text" >
       			...
       			<td class="bg">	
       				<table class="search" border="0" style="width:979;"> 
       					<tr class="h23">
							<td width="200">TEU</td>
							<td width="500" >
								<input id="cntr_sz_teu_capa" style="width: 50px; text-align:right;" class="input1" value="" name="cntr_sz_teu_capa" maxlength="18" dataformat="float" type="text" >
							</td>
							<td width="300" ></td>
						</tr>
						<tr class="h23">
							<td width="200">Container Size Name</td>
							<td width="500">
								<input id="cntr_tp_desc" style="width: 500px; text-align:left;" class="input1" value="" name="cntr_sz_desc" maxlength="100" dataformat="uppernum" otherchar="!@&()_/\- " type="text" >
							</td>
