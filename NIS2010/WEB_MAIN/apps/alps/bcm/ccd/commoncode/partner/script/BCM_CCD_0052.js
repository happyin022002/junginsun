...
function processButtonClick() {
    ...
    try {
        ...
        case "btn_CheckDup":
            ...
            var rtn=ComOpenPopup('/hanjin/BCM_CCD_1035.do?' + param, 780, 470, '', '0,0', true); 
            break;
        case "btn_com_ens_041":
            if(formObj.creflag.value != "Y"){
               var param="";
               param=param + "&" + "cust_seq=" + form.cust_seq.value+"&mdm_yn="+ formObj.mdm_yn.value;
               ComOpenPopup('/hanjin/COM_ENS_041.do?' + param, 768, 450, 'setCallBack0B2', '1,0,1,1,1,1,1,1', true);
            }
            break;
        case "btn_com_ens1_041":
           var param="";
           param=param + "&" + "cust_seq=" + form.cnsd_cust_seq.value+"&mdm_yn="+ formObj.mdm_yn.value;
           ComOpenPopup('/hanjin/COM_ENS_041.do?' + param, 768, 450, 'setCallBack0B2Cnsd', '1,0,1,1,1,1,1,1', true);
            break;
        case "btn_com_ens_0M1":
         ...
         case "btn_com_ens_071":
            ...
            ComOpenPopup('/hanjin/COM_ENS_071.do?' + param, 780, 470, 'setCallBack0B3', '1,0,1,1,1,1,1,1', true);
            break;
         case "btn_com_ens_0C1":
            var param="";
            param=param + "&" + "vndr_seq=" + form.vndr_seq.value;
            ComOpenPopup('/hanjin/COM_ENS_0C1.do?' + param, 780, 470, 'setCallBack0B4', '1,0,1,1,1,1,1,1', true);
            break;
         case "btn_com_ens_n13":
            var param="";
            param=param + "&" + "curr_cd=" + form.capi_curr_cd.value;
            ComOpenPopup('/hanjin/COM_ENS_N13.do?' + param, 780, 470, 'setCallBack0B6', '1,0,1,1,1,1,1,1', true);
            break;
        case "btn_com_com_0006":
            var param="";                     
            param=param + "cust_grp_id=" + form.cust_grp_id.value+"&mdm_yn="+ form.mdm_yn.value;              
            ComOpenPopup('/hanjin/COM_COM_0006.do?' + param, 780, 420, 'setCustGrpId', '1,0,1,1,1,1,1,1', true);              
            break;
...
//             }
         ...
         case "btn_srep_search":
         	...
         	var sUrl="/hanjin/COM_COM_0008.do?srep_cd=" + formObj.srep_cd.value + "&mdm_yn="+v1 + "&delt_flg=N";
        ...
        case MULTI:        //저장
            ...
            if( formObj.creflag.value == "Y" && formObj.cust_cd.value == "" && formObj.rqst_no.value == "") { // CREATE
                ...
                if(sav == "F") { // Legacy Code(SAP ID) is not unique
    				...
    				ComOpenPopup('/hanjin/BCM_CCD_1035.do?' + param, 780, 470, "getBCM_CCD_1035_saveflag", '0,0', true);
                }
...
function sheet2_OnPopupClick(sheetObj,Row,Col)
{
    ...
    if (sheetObj.ColSaveName(Col) == prefix+"cnt_cd") {
        ...
        ComOpenPopup('/hanjin/COM_ENS_0M1.do?' + param, 780, 470, 'getCOM_ENS_0M1', '1,0,1,1,1,1,1,1', true, Col, Row);
