	...
	function initSheet(sheetObj, sheetNo) {
		...
		case "sheet1":
	 	...
	 	function sheet1_OnPopupClick(sheetObj,Row,Col)
    		...
    		ComOpenPopup('/hanjin/COM_ENS_0M1.do?' + param, 780, 510, 'getCOM_ENS_0M1', '1,0,1,1,1,1,1,1', true, Col, Row);
	 		}else if (sheetObj.ColSaveName(Col) == prefix+"ste_cd") {
 				param=param + "&" + "ste_cd=" 
 				//+sheetObj.CellValue(Row,Col);
 				ComOpenPopup('/hanjin/COM_ENS_0X1.do?' + param, 650, 460, 'getCOM_ENS_0X1', '1,0,1,1,1,1,1,1', true, Col,Row);
 			}
	 		}
