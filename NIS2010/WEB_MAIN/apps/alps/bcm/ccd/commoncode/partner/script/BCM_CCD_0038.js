    ...
    function processButtonClick(){
        ...
        try {
            ...
            case "btn_CheckDup":
				...
				ComOpenPopup('/hanjin/BCM_CCD_1038.do?' + param, 880, 450, 'saveCustGrp', '1,0,1,1,1,1,1,1', true); 
				break;
            case "btn_Save":
            ...
            case "btn_com_ens_071":
				var param="";
	    		param=param + "&" + "ofc_cd=" + form.ofc_cd.value;
	    		ComOpenPopup('/hanjin/COM_ENS_071.do?' + param, 780, 510, 'setCallBack0B1', '1,0,1,1,1,1,1,1', true);
				break;
			case "btn_com_ens_091":
				var param="";
	    		param=param + "&" + "srep_cd=" + form.srep_cd.value;
	    		ComOpenPopup('/hanjin/COM_ENS_091.do?' + param, 780, 600, 'setCallBack0B2', '1,0,1,1,1,1,1,1', true);
				break;
			case "btn_com_com_0006":
				if(formObj.rqst_no.value == ""){
					if(formObj.create_yn.value != "Y"){
		    		    ...
		    		    ComOpenPopup('/hanjin/COM_COM_0006.do?' + param, 780, 430, 'setCustGrpId', '1,0,1,1,1,1,1,1', true);
					}
				}
				break;
			case "btn_com_com_0008":
				var param="";		    	
	    		param=param + "srep_cd=" + form.srep_cd.value;				
	    		ComOpenPopup('/hanjin/COM_COM_0008.do?' + param, 770, 410, 'setSalesRep', '1,0,1,1,1,1', true);				
				break;
            }
        }catch(e) {
            if( e == "[object Error]") {
...
//	      }
	    ...
	    function obj_change(){
	    	...
	    	try {
	            ...
	            switch(srcName) {
	            	case "cust_grp_id":
	            		if(formObject.creflag.value == "N" && formObject.cust_grp_id.value.length>0){
	            			doActionIBSheet(sheetObject1, formObject, SEARCH);
	            		} else if(formObject.creflag.value == "Y" && formObject.cust_grp_id.value.length>0){
