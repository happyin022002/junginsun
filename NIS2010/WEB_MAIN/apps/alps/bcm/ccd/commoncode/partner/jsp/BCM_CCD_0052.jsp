...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.partner.event.BcmCcd0052Event"%>
		...
		<table>
			...
			<tbody>
				<tr>
                    ...
                    <th>Legacy Code(SAP ID)</th>
                    <td><input type="text" style="width:150px; text-align:center; ime-mode:disabled;" class="input" dataformat="engup" name="modi_cust_cd" maxlength="30"></td>
                    <th>Legacy Code(GCC)</th>
                    <td><input type="text" style="width:150px; text-align:center; ime-mode:disabled;" class="input" dataformat="engup" name="modi_cust_cd2" maxlength="30"></td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			...
			<tbody>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" style="width:100px;ime-mode:disabled;text-align:center;" maxlength="10" name="cust_grp_id" class="input" value="" dataformat="engup" otherchar=" &,.-" disabled><!--
                       --><button type="button" class="input_seach_btn" name="btn_com_com_0006" id="btn_com_com_0006" disabled></button>
                    </td>
                    <th><input id="rail_road_prio_flg" value="Y" class="trans" name="rail_road_prio_flg" type="checkbox" /><label for="rail_road_prio_flg"><strong>Priority for Rail Road</strong></label></th>
                </tr> 
                <tr>
		...
		<table>
			...
			<tbody>
                <tr>
                    ...
                    <td>
                    	<select style="width:80px;" class="input" name="nmd_cust_flg" id="nmd_cust_flg">
                            <option value="N">N</option>
                            <option value="Y">Y</option>
                        </select>
                    </td>
		...
		<table>
			...
			<tbody>
                <tr>
                    ...
                    <td colspan="3"><input type="text" style="width:124px;" class="input" value="" name="nvocc_lic_no" maxlength="20" dataformat="eng" otherchar=" &-,."></td>
                </tr>
                <tr>
                    ...
                    <td colspan="3"><input type="text" style="width:102px;" class="input" value="" name="nvocc_bd_end_eff_dt" dataformat="ymd" maxlength="10"><!-- 
                ...
                <tr>
                    ...
                    <td><script language="javascript">ComComboObject('inv_edi_lvl_cd', 2, 102, 1, 0 ,1 ,false)</script></td>
