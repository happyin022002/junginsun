	...
	function processButtonClick() {
		...
		try {
			...
			case "btn_com_ens_041":
	    		...
	    		ComOpenPopup('/hanjin/COM_ENS_041.do?' + param, 780, 480, 'setCallBack0B2', '1,0,1,1,1,1,1,1', true);
				break;
             ...
             case "btn_com_ens_n13":
 	    		...
 	    		ComOpenPopup('/hanjin/COM_ENS_N13.do?' + param, 700, 490, 'setCallBack0B3', '1,0,1,1,1,1,1,1', true);
 				break;
             case "btn_com_ens_042":
  				var param="";
  	    		param=param + "&" + "act_cust_cd=" + form.act_cust_cd.value;
  	    		ComOpenPopup('/hanjin/COM_ENS_041.do?' + param, 780, 480, 'setCallBack0B4', '1,0,1,1,1,1,1,1', true);
  				break;
