...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.partner.event.BcmCcd0039Event"%>
...
<!-- opus_design_inquiry(S) -->
	<div class="opus_design_inquiry wFit">
		<table>
			<tbody>
				...
				<tr>
					<th>Customer Code</th>
					<td><input id="cust_cd" style="width: 80px; text-align:center;" class="input1" name="cust_cd" value="" maxlength="8" dataformat="engup" type="text" /><button class="input_seach_btn" name="btn_com_ens_041" id="btn_com_ens_041" type="button"></button></td>
					<td></td>
				</tr>
			</tbody>
		</table>
	...
	<div class="opus_design_inquiry wFit">	
		<table>
			...
			<tbody>
				<tr class="h23">
					<th>Credit Control Office</th>
					<td><input id="cr_clt_ofc_cd" style="width: 80px; ime-mode:disabled; text-align:center;" class="input" value="" name="cr_clt_ofc_cd" maxlength="6" dataformat="engup" type="text" /><button class="input_seach_btn" name="btn_com_ens_071" id="btn_com_ens_071" type="button"></button></td>
					<th>Credit Currency</th>
					<td><input id="cr_curr_cd" style="width: 100px; ime-mode:disabled; text-align:center;" class="input" value="" name="cr_curr_cd" maxlength="5" dataformat="engup" type="text" /><button class="input_seach_btn" name="btn_com_ens_n13" id="btn_com_ens_n13" type="button"></button></td>
					<th>O/B Credit Term/Day</th>
					<td><input id="ob_cr_term_dys" style="width: 104px; ime-mode:disabled; text-align:right;" class="input" value="" name="ob_cr_term_dys" maxlength="3" dataformat="num" type="text" /></td>
					<th>I/B Credit Term/Day</th>
					<td><input id="ib_cr_term_dys" style="width: 114px; ime-mode:disabled; text-align:right;" class="input" value="" name="ib_cr_term_dys" maxlength="3" dataformat="num" type="text" /></td>
					<td></td>
			    </tr>
			    <tr class="h23">
					...
					<th>Revised Amount Re-Invoicing</th>
					<td><select style="width: 50px;" dataformat="engup" class="input" name="riss_inv_flg" id="riss_inv_flg"><option value="N" >N</option><option value="Y" >Y</option></select></td>
					<th>Credit Start Date</th>
					<td><input id="cr_st_dt" style="width: 75px; ime-mode:disabled" class="input" value="" name="cr_st_dt" dataformat="ymd" maxlength="10" type="text" /><button class="calendar ir" name="btn_opn_dt_cal" id="btn_opn_dt_cal" type="button"></button></td>
					<th>Credit End Date</th>
					<td><input id="cr_end_dt" style="width: 85px; ime-mode:disabled" class="input" value="" name="cr_end_dt" dataformat="ymd" maxlength="10" type="text" /><button class="calendar ir" name="btn_clz_dt_cal" id="btn_clz_dt_cal" type="button"></button></td>
					<td></td>
			    </tr>	
			</tbody>
		</table>
		...
		<table>
			...
			<colgroup>
				...
				<tr class="h23">
					...
					<td><select style="width: 50px; ime-mode:disabled" dataformat="engup" class="input" name="cust_rlse_ctrl_flg" id="cust_rlse_ctrl_flg"><option value="N">N</option><option value="Y" >Y</option></select></td>
					<td></td>
					<th>Credit Flag</th>
					<td><select style="width: 50px;" dataformat="engup" class="input" name="cr_flg" id="cr_flg"><option value="N">N</option><option value="Y" >Y</option></select></td>
					<td></td>
				</tr>	
			</tbody>
		</table>
		...
		<table>
			...
			<tbody>
				<tr class="h23">
					<th>O/B E-mail</th>
					<td><input id="ob_eml" style="width: 240px; ime-mode:disabled; text-align:left;" class="input" value="" name="ob_eml" maxlength="200" type="text" /></td>
					<th>I/B E-mail</th>
					<td><input id="ib_eml" style="width: 240px; ime-mode:disabled; text-align:left;" class="input" value="" name="ib_eml" maxlength="200" type="text" /></td>
					<td></td>
				</tr>	
				<tr class="h23">
					<th>O/B Fax No</th>
					<td><input id="ob_fax_no" style="width: 150px; ime-mode:disabled; text-align:left;" class="input" value="" name="ob_fax_no" maxlength="20" otherchar="-" dataformat="num" type="text" /></td>
					<th>I/B Fax No</th>
					<td><input id="ib_fax_no" style="width: 150px; ime-mode:disabled; text-align:left;" class="input" value="" name="ib_fax_no" maxlength="20" otherchar="-" dataformat="num" type="text" /></td>
                    <th>Credit DIV</th>
                    <td>
