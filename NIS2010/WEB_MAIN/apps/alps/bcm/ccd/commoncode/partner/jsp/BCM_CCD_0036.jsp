...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.partner.event.BcmCcd0036Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    BcmCcd0036Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (BcmCcd0036Event)request.getAttribute("Event");
...
<div class="opus_design_inquiry wFit">
	<table> 
		...
		<tr class="h23">
			<th>Customer  Code</th>
			<td><input type="text" style="width:80px;ime-mode:disabled;text-align:center;" class="input1" name="cust_cd" value="" maxlength="8" dataformat="engup"><!-- 
			 --><button type="button" name="btn_com_ens_041" id="btn_com_ens_041"  class="input_seach_btn"></button></td>
			
			<th>Address Type</th>
			<td><script type="text/javascript">ComComboObject('addr_tp_cd', 2, 100, 1, 1 ,0 ,false)</script></td>
...
<div class="opus_design_grid">
	...
	<!-- Content -->
		<button type="button" class="btn_normal" name="btn_add" id="btn_add" style="display: none">Row Add</button><!-- 
		 --><button type="button" class="btn_normal" name="btn_del" id="btn_del" style="display: none">Row Delete</button>
	</div>
	<!-- opus_design_btn(e) -->
