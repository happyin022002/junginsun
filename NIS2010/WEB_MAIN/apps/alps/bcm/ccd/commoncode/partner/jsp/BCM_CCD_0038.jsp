...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.partner.event.BcmCcd0038Event"%>
...
<div class="opus_design_inquiry wFit">
	...
	<table> 
		...
		<tr>
			<th>Abbreviation</th>
			<td><nobr><input type="text" class="input" style="width:100px;ime-mode:disabled;text-align:center;" name="cust_grp_abbr_nm" maxlength="6" dataformat="engup"></nobr></td>				
