...
<%@ page import="com.hanjin.apps.alps.bcm.ccd.commoncode.partner.event.BcmCcd1035Event"%>
		...
		<div class="opus_design_inquiry wFit">
			...
			<table> 
	            ...
	            <tbody>
		             <tr>
						<th>&nbsp Country</th>
						<td><input type="text" name="cust_cnt_cd" dataformat="enguponly" maxlength="2" size="60" style="width:70px;ime-mode:disabled" readOnly></td>
						<th>Location</th>
