...
<%@ page import="com.hanjin.apps.alps.bcm.cms.custmanage.custmain.event.BcmCms0302Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	BcmCms0302Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (BcmCms0302Event)request.getAttribute("Event");
       			...
       			<td class="bg">	
					...
					<table class="search" border="0" style="width:979;"> 
						...
						<tr class="h23">
							...
							<td width="140">Named BIZ Customer</td>
							    <td><input type="checkbox" name="nmd_cust_flg" value="" class="trans"></td> 
							<td width="20"></td>
							<td width="144">No Use in Sales Date</td>
							<td width="" >
								<input id="sls_delt_eff_dt" style="width: 80px;" class="input" value="" name="sls_delt_eff_dt" maxlength="8"  type="text" dataformat="ymd" >
								<img class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle" name="sls_delt_eff_date">
							</td>
						</tr>
					</table>	
					...
					<table class="search" border="0" style="width:979;"> 
						<tr class="h23">
							...
							<td width="150" >
								<input id="srep_cd" style="width: 100px; text-align:center;" class="input" value="" name="srep_cd" maxlength="5" dataformat="uppernum" type="text" >
						...
						<tr class="h23">
							...
							<td width="" >
								...
								<img src="img/btns_search.gif" name="btn_BCM_CMS_0301" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
							<td width="150">Vendor Code</td>
							<td width="150" >
								<input id="vndr_seq" style="width: 70px; text-align:center;" class="input" value="" name="vndr_seq" maxlength="6" dataformat="int" type="text" >
								<img src="img/btns_search.gif" name="btn_com_ens_0C1" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor">
							</td>
						</tr>
						<tr class="h23">
			...
			<table class="search" border="0" height=220 style="width:100%;" > 
		        <tr class="h23">
	    	    	<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								<td width="140">BKG Alert Period</td>
								<td width="250" >
							    ...
							    <td><textarea input id="bkg_alt_msg" style="width: 340px; height:40px;" class="input" value="" name="bkg_alt_msg" maxlength="4000" type="text" /></textarea></td>
							</tr>
							<tr class="h23">
								<td width="140">Subsidiary Company</td>
								<td width="250" >
									<script type="text/javascript">ComComboObject('subs_co_cd', 2, 250, 1, 0 ,0 ,false)</script>
								</td>
								<td></td>
								<td></td>
								<td></td>
