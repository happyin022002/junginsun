        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle = "|Seq.|Cust. Code|Customer Name|Sales OFC|Address|ST|ZIP|Location|Type|Group Code|GST NO.|Vndr Code|Status" ;
...
//                     sheetObj.UseZipFile = true;
                     var sXml = sheetObj.GetSearchXml("BCM_CMS_0305GS.do", selectVal);
...
//                     sheetObj.DoSearch("COM_ENS_041GS.do?UseZipFile=true", selectVal);
           ...
           case IBSEARCHAPPEND:  // 페이징 조회
                ...
                formObj.f_cmd.value = SEARCH;         
                sheetObj.DoSearch4Post("BCM_CMS_0305GS.do", selectVal, "iPage=" + PageNo, true);  
           break;
