...
<%@ page import="com.hanjin.apps.alps.bcm.cms.custmanage.custmain.event.BcmCms0305Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	BcmCms0305Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (BcmCms0305Event)request.getAttribute("Event");
		...
		<table class="search">
			<tr>
				...
				<tr class="h23">
					...
					<td width="120"><input type="text" name="cust_cd" dataformat="engup" maxlength="2" style="width:25;ime-mode:disabled">&nbsp;
					...
					<td width="90">     Location Code</td>
						    <td width="90"><input name="loc_cd" type="text" style="width:50;ime-mode:disabled" dataformat="engup" maxlength="5">
					...
					<td width="100"><input type="text" name="cust_grp_id" dataformat="uppernum" maxlength="10" style="width:80;ime-mode:disabled">&nbsp;</td>
					<td width="50">S.Rep</td>
					<td width="60"><input type="text" name="srep_cd" maxlength="5" dataformat="uppernum" style="width:50" style=""></td>
				...
				<tr class="h23">
					...
					<td><input type="text" name="cust_nm" dataformat="uppernum" maxlength="60" size="60" style="width:160;ime-mode:disabled">
						&nbsp;Include  <input type="checkbox" name="include" checked="checked" Style="border-style:none"></td>
					<td width="80">Local Name</td>
						<td width="130"><input name="cust_locl_lang_nm" type="text" style="width:120;ime-mode:disabled" maxlength="100"></td>
					<td width="80">Tax Payer ID</td>
						<td width="110"><input name="cust_rgst_no" type="text" style="width:100;ime-mode:disabled" dataformat="uppernum" maxlength="20"></td>
