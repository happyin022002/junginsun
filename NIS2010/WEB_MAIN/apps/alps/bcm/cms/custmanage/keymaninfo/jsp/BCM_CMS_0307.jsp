...
<%@ page import="com.hanjin.apps.alps.bcm.cms.custmanage.keymaninfo.event.BcmCms0307Event"%>	
<%@ page import="org.apache.log4j.Logger"%>

<%
	BcmCms0307Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (BcmCms0307Event) request.getAttribute("Event");
