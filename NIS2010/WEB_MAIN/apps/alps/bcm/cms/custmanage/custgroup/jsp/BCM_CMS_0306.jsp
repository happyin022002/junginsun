...
<%@ page import="com.hanjin.apps.alps.bcm.cms.custmanage.custgroup.event.BcmCms0306Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	BcmCms0306Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (BcmCms0306Event)request.getAttribute("Event");
