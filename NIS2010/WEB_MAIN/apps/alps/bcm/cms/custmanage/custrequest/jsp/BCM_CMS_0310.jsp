...
<%@ page import="com.hanjin.apps.alps.bcm.cms.custmanage.custrequest.event.BcmCms0310Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%
    BcmCms0310Event  event = null;                //PDTO(Data Transfer Object including Parameters)
    ...
    try {
		...
		event = (BcmCms0310Event)request.getAttribute("Event");
