    	...
    	try {
            ...
            switch(srcName) {
        	    ...
        	    case "btn_com_ens_071": // office pop-up
         		...
         		case "cre_date":
        			var cal = new ComCalendarFromTo();
        			cal.select(document.form.cre_fm_dt, document.form.cre_to_dt,'yyyy-MM-dd');
        			break;
...
//  	        	ComKeyOnlyAlphabet('upper','32');
    ...
    function loadPage() {
        ...
        document.form.cre_fm_dt.value = ComGetDateAdd(null, "d", -30, "-");
        document.form.cre_to_dt.value = ComGetNowInfo();
    }
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
                    ...
                    var HeadTitle = "Rqst No.|G/I|Name|Request DT|Sales Office|Sales Rep|Location code|Customer Code|Status|Date|Approval Date|Reject Reason|Reject Reason Comment";
                    ...
                    InitDataProperty(0, cnt++ , dtHidden,   100,    daCenter  ,  false,    	"rqst_dt", 				false,          "",       dfNone,       0,     false,       true);
                    ...
                    InitDataProperty(0, cnt++ , dtData,     100,    daCenter,  false,    	"upd_dt",   			false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     100,    daCenter,  false,    	"app_dt",   			false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     100,    daCenter,  false,    	"rjct_rsn_cd",   		false,          "",       dfNone,   	0,     false,       true);
                    InitDataProperty(0, cnt++ , dtData,     100,    daCenter,  false,    	"rjct_rsn_rmk",   			false,          "",       dfNone,   	0,     false,       true);
