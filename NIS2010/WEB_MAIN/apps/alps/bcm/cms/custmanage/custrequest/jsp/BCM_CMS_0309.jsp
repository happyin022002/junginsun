...
<%@ page import="com.hanjin.apps.alps.bcm.cms.custmanage.custrequest.event.BcmCms0309Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	BcmCms0309Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (BcmCms0309Event)request.getAttribute("Event");
