	...
	var RDServerBAT = "/rsumunknownvar /rfn [http://rdst.hanjin.com:19500/RDServer/rdagent.jsp] /rsn [jdbc/HJSALPSA] /ruseurlmoniker [0]"; //Batch Connection Pool
	var RD_path = "http://alpsdev.hanjin.com:9400/hanjin/" ;            // Report file 위치
	var URL = "http://alpsdev.hanjin.com:9400/hanjin/rpt/cab" ;         // report 컴포넌트 다운로드 위치
	var RdReport = "/hanjin/rpt/jsp/rdReport.jsp" ;            // popup 으로 rd를 호출하는 공통 파일
	var RDServerIP = "http://alpsdev.hanjin.com:9400/hanjin";		//File 이용시 Server IP 공통 사용.
...
document.write('  codebase="/hanjin/rpt/cab/rdviewer50u.cab#version=5,0,0,273"');
...
document.write('  codebase="/hanjin/rpt/cab/teechart7.cab#version=7,0,1,4">');
document.write('</object>');
}
...
document.write('   width=0%');
document.write('   height=0%');
document.write('   codebase="/hanjin/rpt/cab/rdpdf50.cab#version=2,1,0,38">');
document.write('</OBJECT>');
}
