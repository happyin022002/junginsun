...
<%@ page import="com.hanjin.framework.support.view.menu.MenuBean" %>
<%@ page import="com.hanjin.framework.support.view.menu.MenuProcessor" %>
<%@ page import="com.hanjin.framework.support.view.menu.MenuEventResponse" %>
<%
	//String strErrMsg="";
	//Exception piEx=null;
	String userName = "";
...
<script language="javascript" type="text/javascript" src="/hanjin/js/jquery-1.6.1.min.js"></script>
<script language="javascript" type="text/javascript" src="js/CoObject.js?version=U15"></script>
<SCRIPT LANGUAGE="javascript" SRC="/hanjin/js/CoCommon.js" TYPE="text/javascript"></SCRIPT>
<SCRIPT LANGUAGE="javascript" SRC="/hanjin/js/CoFormControl.js" TYPE="text/javascript"></SCRIPT>
<SCRIPT LANGUAGE="javascript" SRC="/hanjin/js/CoMessage.js" TYPE="text/javascript"></SCRIPT>
<script language="javascript" type="text/javascript" src="js/IBSheetInfo.js?version=multi"></script>
<SCRIPT LANGUAGE="javascript" SRC="/hanjin/js/CoCalendar.js" TYPE="text/javascript"></SCRIPT>
<script language="javascript" src="/hanjin/js/swfobject.js" type="text/javascript"></script>
<script language="javascript" type="text/javascript" src="/hanjin/js/CoPopup.js?version=U1"></script>
...
//마우스 버튼 click 시 Bookmark div가 사라지게 한다.
 ...
 function changeBookmark(){
		...
		if(document.getElementById("imgBookmark").src.indexOf('img/new_sub/btn_plus.gif') >= 0){
			cmd = 1; // ADD
			var tmp =window.showModalDialog("/hanjin/CREATEBOOKMARK.do?f_cmd=" + SEARCH01 + "&title=" + title, window, "scroll:no;status:no;help:no;dialogWidth:500px;dialogHeight:255px");
//			if ( tmp = '' ) return;
			...
			document.getElementById("bookMark").src = "/hanjin/CREATEREMOVEBOOKMARK.do?ibflag=I&f_cmd="+cmd+"&pgm_no="+pgmNo+"&prnt_pgm_no=" + tmpArr[0] + "&dp_nm="+encodeURI(tmpArr[1]);
		}else{
			cmd = 5; // REMOVE
			document.getElementById("bookMark").src = "/hanjin/CREATEREMOVEBOOKMARK.do?ibflag=D&f_cmd="+cmd+"&pgm_no="+pgmNo;
		}
...
//		alert('selLen='+selLen);
		...
		if(isAdded==true){
			img.src="/hanjin/img/new_sub/btn_minus.gif";
			img.alt="Delete";
		}else{ 
			img.src="/hanjin/img/new_sub/btn_plus.gif";
			img.alt="Add";
		}			
...
function menu_reolad(pgmNo, flag) {
    ...
    try {
        ...
        var winObj = window.open("alpsMain.screen?parentPgmNo="+pgmNo,"",sFeatures);
        winObj.focus();
        //return winObj;
	...
	try {
		...
		if ( window.opener && !window.opener.closed ) {
			if ( window.opener.parent ) {
				window.opener.top.signature2(on_off);
			} else {
				window.opener.signature2(on_off);
			}
			self.close();
		} else {
...
function makeCover(state, level, x, y, x2, y2, w, h) {
	...
	var menu = document.getElementById('alpsMenuDiv');
...
function showFlashMenu(flag) {
	...
	document.getElementById("alpsMenu").style.height = iframeHeight+"px";
	isShowMenu = flag;
...
function callDisappearMenu2Flash(){
	document.getElementById("alpsMenu").disappearMenu();
	showFlashMenu(false);
}
	...
	/**
  	...
  	*/
 	function dctionary(){
		ComOpenPopup('/hanjin/Dctionary.do', 405, 230, 'Dctionary', "0,0", true);
	}
  	
	function unEntity(str){ 
  		return String(str)
			/*
			일부 [[ ]] 로 이름이 둘러 쌓인 메뉴들이 navigation 상에는 << >> 로 변경되는데 다시 [[ ]] 로 변경해주기 위함.
			ex) Service Management > Booking/Documentation > Advance Manifest > US AMS (Origin Office) > << US AMS Main Menu >>
			*/
  			.replace(/</g,'%5B')
			.replace(/>/g,'%5D')
			/*
			navigation depth 를 의마하는 > 문자를 @ 로, 몇몇 메뉴들에 포함 된 & 문자를 $ 으로 변경함. 
			변경 후 파라미터로 넘겨 ITSM S/R Reqeust 창에서 각각 > 과 & 으로 재변환해줌.
			ITSM 서버 상에서 >, < 등은 XSS 정책으로 파라미터에 쓸 수 없고 & 문자는 다른 문자들에 영향을 주기 때문.
			*/
			.replace(/&gt;/g, "@")
			.replace(/&/g, "$")
	...
	function goItsm() {
		if(document.main.curNavigation == undefined){
			var menuPath="";
		}else{
			menuPath = document.main.curNavigation;	
		}
		ComOpenWindowCenter('http://itsm.hanjin.com/ITSM_WEB/jsp/main/login_sso.jsp?req_app=external&ext_page=WD/SR/sro_req_alps_input.jsp&ext_pgm_cd=' + unEntity(menuPath), 'popITSM', 860, 500, false, 1);
	}
</script>
</head>
<body onload="refreshBookmark();startCheck();" onresize="checkIframeWidth();return true;">
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="padding-top:2;padding-left:0;">
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="id">
			<tr>
				<td width="125" style="padding-left:5"><img src="img/new_sub/logo_test.gif" width="125" height="25" alt="" border="0"></td>
				<td width="125" style="padding-left:5"><img src="img/new_sub/logo_test.gif" width="125" height="25" alt="" border="0"></td>
				<td width="125" style="padding-left:5"><img src="img/new_sub/logo_test.gif" width="125" height="25" alt="" border="0"></td>
				<td width="" valign="bottom" style="padding-bottom:1;" align="right">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td class="id" style="padding-right:3;" align="right"><a href="javascript:goItsm();"><img src="img/button/btn_itsupport.gif" alt="" border="0"></a>&nbsp;&nbsp;<img id="messageBox" src="img/new_sub/img_topmenu_message_01.gif" width="24" height="13" alt="" border="0" class="cursor" onclick="message('null','null','null');"><strong id="newCnt">0</strong>&nbsp;&nbsp;<img src="img/new_sub/vline_dot.gif" width="1" height="13" alt="" border="0">&nbsp;&nbsp;<font color="#696B6C">ID</font>&nbsp;<%=userId%>&nbsp;&nbsp;&nbsp;<font color="#696B6C">Name&nbsp;</font><%=userName%>&nbsp;&nbsp;&nbsp;<font color="#696B6C">Office</font>&nbsp;<%=ofc_cd%>&nbsp;<a href="javascript:signature('Off')"><img src="img/new_sub/btn_logout.gif" width="40" height="13" alt="" border="0"></a></td>
					...
					<table width="100%"  height="36" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td valign="middle" style="padding-left:10">
								<!-- 메뉴 생성 스크립트 (S) -->
							<div id="alpsMenuDiv" style="position:absolute; height:100%; top:27px; left:12px; z-index:1;" onmouseover="showFlashMenu(true)" onclick="callDisappearMenu2Flash()">
                         ...
                         <script type="text/javascript">
	                         //window["alpsMenu"] = new Object();
								var so = new SWFObject("/hanjin/img/new_sub/AlpsMenu.swf", "alpsMenu", "990", "34", "8", "#ffffff");
...
<iframe id="ifmenu01" style="position: absolute; width: 780px; height: 330px; left: 215px; top: 26px; z-index: 3; visibility: hidden;" frameBorder="0" scrolling="no"></iframe>
<div id="menu01" style="position: absolute; Z-INDEX: 4; top: 26px; left: 215px; width: 780px; visibility: hidden;">
<!--Full Menu(S)--> <!-- Frame Table (S) -->
<table width="780" style="border: #525267 1px solid;background-color: F4F4F4;border-top:1px solid #FFFFFF;" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="1" background="img/new_sub/ffull_top_bg.gif" ></td>
		<td width="100" background="img/new_sub/ffull_top_bg.gif" style="font-family: Tahoma,verdana,arial; font-size: 11px; font-weight:bold;color: #595959;padding:10 5 10 7;">Common</td>
	</tr>
	<tr>
		<td valign="top" style="padding:3 0 3 0;">
			...
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESM_RAS_M001')">Revenue Audit</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
			...
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESD_TOR_M001')">Terminal Operation</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
			...
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESD_EAS_M001')">Expense Audit</a></td>
			</tr>
			...
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESD_AOC_M001')">Add-on Cost</a></td>
			</tr>
			</table>
		</td>
		...
		<td valign="top" style="padding:3 0 3 0;">
			<table  border="0" cellpadding="0" cellspacing="0">
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESM_SQM_M001')">Sales Quota Management</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
			...
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESM_MAS_M001')">Managerial<br>Accounting System</a></td>
			</tr>			
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
		...
		<td valign="top" style="padding:3 0 3 0;">
			...
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('EES_DOD_M001')">Drop Off Management</a></td>
			</tr>
			</table>
		</td>
		<td bgcolor="D2D2D2"></td>
		<td valign="top" style="padding:3 0 3 0;">
			...
			<tr><td valign="top" style="padding:2 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('VOP_FCM_M001')">Fuel Consumption Management</a></td>
			</tr>
			</table>
		</td>
		<td bgcolor="D2D2D2"></td>
		<td valign="top" style="padding:3 0 3 0;">
			<table  border="0" cellpadding="0" cellspacing="0">
			<tr><td valign="top" style="padding:2 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('FNS_TOT_M001')">Tonnage Tax</a></td>
			</tr>
			<tr><td valign="top" style="padding:2 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
			...
			<tr><td valign="top" style="padding:2 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESM_ACM_M001')">Agent Commission Management</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('CPS_GEM_M001')">General Expense Management</a></td>
			</tr>
			<tr><td style="padding:0 0 11 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESM_BIS_M001')">Bill of Lading Information (Archives)</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESD_LEA_M001')">Logistics Expense Accrual</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('ESD_SPE_M001')">S/P Evaluation & Differentiation</a></td>
			</tr>
			</table>
		</td>
		<td bgcolor="D2D2D2"></td>
		<td valign="top" style="padding:3 0 3 0;">
			<table  border="0" cellpadding="0" cellspacing="0">
			<!-- <tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('COM_AMP_M001')">Approval by Management(PDT)</a></td>
			</tr> -->
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('COM_CAP_M001')">Approval</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('COM_SEC_M001')">Security</a></td>
			</tr>
			<tr><td style="padding:0 0 0 0"><img src="img/new_sub/sub_menu_dot.gif" width="8" height="20" alt="" border="0"></td>
				<td class="full"><a href="javascript:menu_reolad('COM_ARC_M001')">Archive</a></td>
			</tr>
			</table>
		</td>
	</tr>
...
<iframe id="_modulepopup_" src="/hanjin/COM_NTC_0003.do?f_pgm_no=<%=parentPgmNo%>" frameborder="0" marginHeight="0" marginWidth="0" width="0" height="0" style="position:absolute;visibility:hidden;z-index:1;display:none;" ></iframe>
</body>
</html>
