	...
	var RDServerBAT = "/rsumunknownvar /rfn [http://rds.hanjin.com/RDServer/rdagent.jsp] /rsn [jdbc/HJSALPSA] /ruseurlmoniker [0]"; //Batch Connection Pool
	var RD_path = "http://alps.smlines.com/hanjin/" ;            // Report file 위치
	var URL = "http://alps.smlines.com/hanjin/rpt/cab" ;         // report 컴포넌트 다운로드 위치
	var RdReport = "/hanjin/rpt/jsp/rdReport.jsp" ;            // popup 으로 rd를 호출하는 공통 파일
	var RDServerIP = "http://alps.smlines.com/hanjin";		//File 이용시 Server IP 공통 사용.
