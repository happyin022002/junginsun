 ...
 *
 * @author Ari
 * @see ESM_MAS_135Event , ESM_MAS_135EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_MAS_0135HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_MAS_135HTMLAction 객체를 생성
	 */
	public ESM_MAS_0135HTMLAction() {
		//
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_MAS_135Event로 파싱하여 request에 셋팅<br>
	 *
	...
	public Event perform(HttpServletRequest request) {
		...
		EsmMas0135Event event = new EsmMas0135Event();
