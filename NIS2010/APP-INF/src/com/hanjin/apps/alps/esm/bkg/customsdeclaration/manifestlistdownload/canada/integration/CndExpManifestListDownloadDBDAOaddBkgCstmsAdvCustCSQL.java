...
*@FileName : CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCustCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCustCSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   INTO  BKG_CSTMS_AMER_CUST" ).append("\n"); 
		query.append("         (" ).append("\n"); 
