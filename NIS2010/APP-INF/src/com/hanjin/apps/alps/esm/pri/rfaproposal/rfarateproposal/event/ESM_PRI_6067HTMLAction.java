...
*@FileName : ESM_PRI_6067HTMLAction.java
...
public class ESM_PRI_6067HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6067HTMLAction 객체를 생성
	 */
	public ESM_PRI_6067HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6067Event event = new EsmPri6067Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltPriCostDetailByTransModeListVO((RsltPriCostDetailByTransModeListVO)getVO(request, RsltPriCostDetailByTransModeListVO .class));
		}
