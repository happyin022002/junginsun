...
*@FileName : SpecialManifestDBDAOsearchMainPartiesRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchMainPartiesRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchMainPartiesRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchMainPartiesRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,DECODE(SUBSTR(@[ofc_cd], 1, 3), 'ANR','HANSHI', 'SML' ) PARTY_ID" ).append("\n"); 
		query.append("	,'' AUTHORIZED" ).append("\n"); 
		query.append("	,'' ADDRESS1" ).append("\n"); 
