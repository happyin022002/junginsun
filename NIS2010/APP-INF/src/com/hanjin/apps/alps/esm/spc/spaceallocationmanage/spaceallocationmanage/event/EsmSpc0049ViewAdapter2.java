...
*@FileName : EsmSpc0049ViewAdapter2.java
*@FileTitle : EsmSpc0049ViewAdapter2
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmSpc0049ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmSpc0049ViewAdapter2(){
    	super();
    }
