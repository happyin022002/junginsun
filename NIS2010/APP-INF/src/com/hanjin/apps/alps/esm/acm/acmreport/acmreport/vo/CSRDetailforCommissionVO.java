...
*@FileName : CSRDetailforCommissionVO.java
*@FileTitle : CSRDetailforCommissionVO
*Open Issues :
*Change history :
...
public class CSRDetailforCommissionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CSRDetailforCommissionVO> models = new ArrayList<CSRDetailforCommissionVO>();
	...
	public CSRDetailforCommissionVO() {}

	public CSRDetailforCommissionVO(String ibflag, String pagerows, String seq, String invNo, String netAmt, String taxAmt, String totAmt, String csrNo) {
		this.invNo = invNo;
		this.csrNo = csrNo;
		this.totAmt = totAmt;
		this.netAmt = netAmt;
	 ...
	 */
	public CSRDetailforCommissionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CSRDetailforCommissionDtrbVO[]
	 */
	public CSRDetailforCommissionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CSRDetailforCommissionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CSRDetailforCommissionVO();
				if (invNo[i] != null)
		...
		return getCSRDetailforCommissionVOs();
	}
	...
	public CSRDetailforCommissionVO[] getCSRDetailforCommissionVOs(){
		CSRDetailforCommissionVO[] vos = (CSRDetailforCommissionVO[])models.toArray(new CSRDetailforCommissionVO[models.size()]);
		return vos;
	}
