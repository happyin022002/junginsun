...
*@FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAddGlineCopyCSQL.java
...
public class SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAddGlineCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAddGlineCopyCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAddGlineCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",       @[upd_usr_id]" ).append("\n"); 
		query.append(",       SYSDATE" ).append("\n"); 
		query.append("FROM    PRI_SG_GRP_LOC_DTL" ).append("\n"); 
