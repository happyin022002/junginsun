...
import com.hanjin.apps.alps.esm.acm.acmagreement.facommagreement.integration.FACommAgreementDBDAO;
import com.hanjin.apps.alps.esm.acm.acmagreement.facommagreement.integration.FACommAgreementEAIDAO;
...
//		List<FACAgreementVO> insertVoList = new ArrayList<FACAgreementVO>();
		...
		try{
			...
			for(int i=0; i<facAgreementVOs.length; i++) {
				...
				if(fac_div_cd.equals("BL")){
					facAgreementVOs[i].setBkgFacRt(facAgreementVOs[i].getBkgFacBlAmt());
				}
