...
*@FileName : ESM_FMS_0028HTMLAction.java
...
public class ESM_FMS_0028HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0028HTMLAction 객체를 생성
	 */
	public ESM_FMS_0028HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0028Event event = new EsmFms0028Event();
