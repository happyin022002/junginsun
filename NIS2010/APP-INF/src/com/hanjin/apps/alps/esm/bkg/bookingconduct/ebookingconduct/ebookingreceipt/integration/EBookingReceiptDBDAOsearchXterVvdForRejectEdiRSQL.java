...
public class EBookingReceiptDBDAOsearchXterVvdForRejectEdiRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", NULL						vvdloyd" ).append("\n"); 
		...
		query.append(", mst.POD_NM				vdpodname" ).append("\n"); 
		query.append(", NULL						ref1vvdvoy" ).append("\n"); 
		query.append(", NULL						VVDPODNAME" ).append("\n"); 
		...
		query.append("FROM bkg_xter_rqst_mst mst, vsk_VSL_PORT_SKD VVD1, vsk_VSL_PORT_SKD VVD2" ).append("\n"); 
