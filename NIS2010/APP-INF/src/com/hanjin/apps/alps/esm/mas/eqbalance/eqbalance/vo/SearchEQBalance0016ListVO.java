...
*@FileName : SearchEQBalance0016ListVO.java
*@FileTitle : SearchEQBalance0016ListVO
*Open Issues :
*Change history :
...
public class SearchEQBalance0016ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEQBalance0016ListVO> models = new ArrayList<SearchEQBalance0016ListVO>();
	...
	public SearchEQBalance0016ListVO() {}

	public SearchEQBalance0016ListVO(String ibflag, String pagerows, String costYrmon, String cntrTpszCd, String eqRepoCrLvl, String imbalAllAplyFlg, String imbalFmRto, String imbalToRto, String opbAllAplyFlg, String opbFmAmt, String opbToAmt, String mbAllAplyFlg, String mbFmRto, String mbToRto, String num) {
	 ...
	 * @param request
	 * @return SearchEQBalance0016ListVO[]
	 */
	public SearchEQBalance0016ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEQBalance0016ListVO[]
	 */
	public SearchEQBalance0016ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEQBalance0016ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchEQBalance0016ListVO();
		...
		return getSearchEQBalance0016ListVOs();
	}
	 ...
	 * @return SearchEQBalance0016ListVO[]
	 */
	public SearchEQBalance0016ListVO[] getSearchEQBalance0016ListVOs(){
		SearchEQBalance0016ListVO[] vos = (SearchEQBalance0016ListVO[])models.toArray(new SearchEQBalance0016ListVO[models.size()]);
		return vos;
	}
