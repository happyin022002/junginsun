...
*@FileName : ChinaManifestListDownloadDBDAOsearchChinaVslRgstRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOsearchChinaVslRgstRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOsearchChinaVslRgstRSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOsearchChinaVslRgstRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${search_div} == 'PUBLIC')" ).append("\n"); 
		...
		query.append("#if (${search_div} == 'PORT')" ).append("\n"); 
		...
		query.append("#elseif (${search_div} == 'PUBLIC')" ).append("\n"); 
		query.append("               VVD.CRR_CD," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("               CNTR.VSL_ENG_NM," ).append("\n"); 
		query.append("               CNTR.LLOYD_NO," ).append("\n"); 
		query.append("               SKD.VSL_CD," ).append("\n"); 
		query.append("#if (${search_div} == 'PUBLIC')" ).append("\n"); 
		query.append("               VVD.IB_SKD_VOY_NO," ).append("\n"); 
		query.append("               VVD.IB_SKD_DIR_NM," ).append("\n"); 
		query.append("               VVD.OB_SKD_VOY_NO," ).append("\n"); 
		query.append("               VVD.OB_SKD_DIR_NM," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("#if (${search_div} == 'PUBLIC')" ).append("\n"); 
		query.append("               BKG_CSTMS_CHN_CORR_VVD VVD," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("           AND SKD.VPS_PORT_CD = VVD.PORT_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
