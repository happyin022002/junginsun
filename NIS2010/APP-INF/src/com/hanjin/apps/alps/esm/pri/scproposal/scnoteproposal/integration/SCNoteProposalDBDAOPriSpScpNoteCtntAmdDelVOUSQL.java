...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntAmdDelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntAmdDelVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Standard Note - Amend 시 Delete 버튼
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntAmdDelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntAmdDelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_NOTE_CTNT" ).append("\n"); 
		query.append("   SET SRC_INFO_CD 			= @[src_info_cd]" ).append("\n"); 
