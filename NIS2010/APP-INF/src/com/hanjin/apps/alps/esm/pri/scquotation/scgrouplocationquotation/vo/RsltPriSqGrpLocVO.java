...
*@FileName : RsltPriSqGrpLocVO.java
*@FileTitle : RsltPriSqGrpLocVO
*Open Issues :
*Change history :
...
public class RsltPriSqGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqGrpLocVO> models = new ArrayList<RsltPriSqGrpLocVO>();
	...
	public RsltPriSqGrpLocVO() {}

	public RsltPriSqGrpLocVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpLocSeq, String prcGrpLocCd, String prcGrpLocDesc, String srcInfoCd, String srcInfoNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public RsltPriSqGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqGrpLocVO[]
	 */
	public RsltPriSqGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqGrpLocVO model = null;
	 ...
	 * @return RsltPriSqGrpLocVO[]
	 */
	public RsltPriSqGrpLocVO[] getRsltPriSqGrpLocVOs(){
		RsltPriSqGrpLocVO[] vos = (RsltPriSqGrpLocVO[])models.toArray(new RsltPriSqGrpLocVO[models.size()]);
		return vos;
	}
