...
*@FileName : ESM_COA_0081HTMLAction.java
...
public class ESM_COA_0081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0081HTMLAction 객체를 생성
	 */
	public ESM_COA_0081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0081Event event = new EsmCoa0081Event();
