...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtHdrVODSQL.java
...
public class SCRateQuotationDBDAOPriSqRtCmdtHdrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtHdrVODSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtHdrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
