...
*@FileName : ESM_PRI_7025HTMLAction.java
...
public class ESM_PRI_7025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_7025HTMLAction 객체를 생성
	 */
	public ESM_PRI_7025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7025Event event = new EsmPri7025Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) { 
			event.setSearchIHCAmendmentHistoryMainVO((SearchIHCAmendmentHistoryMainVO)getVO(request, SearchIHCAmendmentHistoryMainVO .class));
		} else if (command.isCommand(FormCommand.SEARCH02)) {
			event.setIHCTariffInquiryListVO((IHCTariffInquiryListVO) getVO(request, IHCTariffInquiryListVO.class));	
		}
		return  event;
	}
