...
*@FileName : Kor24ManifestListDBDAOsearchKcdTpCustRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchKcdTpCustRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Customer테이블에 BL테이블의 CSTMS_DEL_TP_CD와 같은 코드를 넣기위해 재 조회한다.
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchKcdTpCustRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchKcdTpCustRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT CSTMS_DECL_TP_CD" ).append("\n");
