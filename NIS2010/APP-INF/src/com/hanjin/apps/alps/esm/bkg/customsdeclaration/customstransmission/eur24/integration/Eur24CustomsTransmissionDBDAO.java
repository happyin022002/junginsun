...
public class Eur24CustomsTransmissionDBDAO extends DBDAOSupport {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Eur24BlinfoVO>  searchBlGeneral ( String blNo , String vslCd , String skdVoyNo , String skdDirCd , String cstmsPortCd , String pType, String eu1stPortClptSeq)throws DAOException {
		DBRowSet dbRowset = null;
		...
		try
		{
			...
			param.put("eu_1st_port_clpt_seq", eu1stPortClptSeq);
			...
			velParam.put("eu_1st_port_clpt_seq", eu1stPortClptSeq);
	...
	/**
	 * MVMT_REF_NO는 존재하지만, Send되지 않은 BL조회<br>
	 * 2015.06.13
	 * @param String blNo 
	 * @param String vslCd 
	 * @param String skdVoyNo
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Eur24BlinfoVO>  searchUnsndBL ( String blNo , String vslCd , String skdVoyNo , String skdDirCd , String cstmsPortCd)throws DAOException {
		DBRowSet dbRowset = null;
		List<Eur24BlinfoVO> list = null;
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try
		{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new Eur24CustomsTransmissionDBDAOSearchUnsendBlRSQL(), param,velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, Eur24BlinfoVO.class);
		}
		catch (SQLException se)
		{
