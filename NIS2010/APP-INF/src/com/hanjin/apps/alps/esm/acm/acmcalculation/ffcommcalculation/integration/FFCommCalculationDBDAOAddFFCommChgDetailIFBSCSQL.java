...
*@FileName : FFCommCalculationDBDAOAddFFCommChgDetailIFBSCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOAddFFCommChgDetailIFBSCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOAddFFCommChgDetailIFBSCSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAOAddFFCommChgDetailIFBSCSQL(){
		setQuery();
		...
		params.put("ff_chg_ctnt_div",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : FFCommCalculationDBDAOAddFFCommChgDetailIFBSCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT   @[bkg_no], @[bkg_ff_cnt_cd], @[bkg_ff_seq], @[new_ff_cmpn_seq], CHG_CD, SUM(CHG_AMT)," ).append("\n"); 
		...
		query.append("    AND CHG_CD IN ( @[ff_chg_ctnt_div] )" ).append("\n"); 
