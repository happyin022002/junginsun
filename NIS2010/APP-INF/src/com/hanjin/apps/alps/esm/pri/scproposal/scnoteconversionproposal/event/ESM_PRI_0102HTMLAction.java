...
*@FileName : ESM_PRI_0102HTMLAction.java
...
public class ESM_PRI_0102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0102HTMLAction 객체를 생성
	 */
	public ESM_PRI_0102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0102Event event = new EsmPri0102Event();
				
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriSpScpNoteCtntListVO((PriSpScpNoteCtntListVO)getVO(request, PriSpScpNoteCtntListVO .class));
		...
		/*
			...
			event.setPriSpScpNoteVO((PriSpScpNoteVO)getVO(request, PriSpScpNoteVO .class));
		}
		*/
