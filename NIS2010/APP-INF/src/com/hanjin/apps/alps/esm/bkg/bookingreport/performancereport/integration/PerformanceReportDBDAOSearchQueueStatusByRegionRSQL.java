...
*@FileName : PerformanceReportDBDAOSearchQueueStatusByRegionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchQueueStatusByRegionRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Queue Status Report - Region별 결과를 조회한다.
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchQueueStatusByRegionRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchQueueStatusByRegionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
