...
*@FileName : BKGDetail0148VO.java
*@FileTitle : BKGDetail0148VO
*Open Issues :
*Change history :
...
public class BKGDetail0148VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BKGDetail0148VO> models = new ArrayList<BKGDetail0148VO>();
	...
	public BKGDetail0148VO() {}

	public BKGDetail0148VO(String ibflag, String pagerows, String bkgNo, String spclCntrTpszCd, String load, String rev, String cmc, String cm, String opc, String op, String gRpb, String cmCost, String cmcost, String cmb, String opCost, String opcost, String opb,String cm2,String cm2Cost) {
		this.rev = rev;
		this.op = op;
		this.opcost = opcost;
		this.opb = opb;
	 ...
	 */
	public BKGDetail0148VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BKGDetail0148VO[]
	 */
	public BKGDetail0148VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BKGDetail0148VO model = null;
	...
	public BKGDetail0148VO[] getBKGDetail0148VOs(){
		BKGDetail0148VO[] vos = (BKGDetail0148VO[])models.toArray(new BKGDetail0148VO[models.size()]);
		return vos;
	}
