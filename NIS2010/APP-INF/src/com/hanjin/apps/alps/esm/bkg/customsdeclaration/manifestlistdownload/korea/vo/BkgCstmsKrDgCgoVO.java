...
*@FileName : BkgCstmsKrDgCgoVO.java
*@FileTitle : BkgCstmsKrDgCgoVO
*Open Issues :
*Change history :
...
public class BkgCstmsKrDgCgoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsKrDgCgoVO> models = new ArrayList<BkgCstmsKrDgCgoVO>();
...
/**
	 ...
	 */
	public BkgCstmsKrDgCgoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrDgCgoVO[]
	 */
	public BkgCstmsKrDgCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsKrDgCgoVO model = null;
	...
	public BkgCstmsKrDgCgoVO[] getBkgCstmsKrDgCgoVOs(){
		BkgCstmsKrDgCgoVO[] vos = (BkgCstmsKrDgCgoVO[])models.toArray(new BkgCstmsKrDgCgoVO[models.size()]);
		return vos;
	}
