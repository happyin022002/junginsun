...
public class TsBkgListForBayPlanInputVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<TsBkgListForBayPlanInputVO> models = new ArrayList<TsBkgListForBayPlanInputVO>();
	...
	public TsBkgListForBayPlanInputVO() {}

	public TsBkgListForBayPlanInputVO(String ibflag, String pagerows, String vslCd, String polCd, String ydCd, String ofcCd, String bkgClzStsCd) {
		this.ofcCd = ofcCd;
		this.vslCd = vslCd;
		this.polCd = polCd;
		this.ibflag = ibflag;
	 ...
	 */
	public TsBkgListForBayPlanInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgListForBayPlanInputVO[]
	 */
	public TsBkgListForBayPlanInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TsBkgListForBayPlanInputVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TsBkgListForBayPlanInputVO();
				if (ofcCd[i] != null)
	 ...
	 * @return BkgListForBayPlanInputVO[]
	 */
	public TsBkgListForBayPlanInputVO[] getBkgListForBayPlanInputVOs(){
		TsBkgListForBayPlanInputVO[] vos = (TsBkgListForBayPlanInputVO[])models.toArray(new TsBkgListForBayPlanInputVO[models.size()]);
		return vos;
	}
