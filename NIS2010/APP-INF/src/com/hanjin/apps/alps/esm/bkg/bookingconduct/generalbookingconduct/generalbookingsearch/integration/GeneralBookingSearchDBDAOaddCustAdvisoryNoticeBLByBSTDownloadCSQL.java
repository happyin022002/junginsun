...
*@FileName : GeneralBookingSearchDBDAOaddCustAdvisoryNoticeBLByBSTDownloadCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingSearchDBDAOaddCustAdvisoryNoticeBLByBSTDownloadCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addCustAdvisoryNoticeBLByBSTDownload
	  * </pre>
	  */
	public GeneralBookingSearchDBDAOaddCustAdvisoryNoticeBLByBSTDownloadCSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingSearchDBDAOaddCustAdvisoryNoticeBLByBSTDownloadCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
