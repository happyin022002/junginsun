...
public class CLLCDLManifestDBDAOsearchCllBlRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	'BLNBR:'||NVL(M.BL_NO,' ')||NVL(M.BL_TP_CD,' ')||CHR(10)||" ).append("\n"); 
		...
		query.append("	'BLREPCMD:'||NVL(M.REP_CMDT_DESC,' ')||CHR(10)||" ).append("\n"); 
		query.append("	'REMARK:'||REPLACE(REPLACE(Translate(NVL(BK.XTER_RMK,' '), chr(13)||chr(10),' ')," ).append("\n"); 
		...
		query.append("	'INV_NO:'||CHR(10)||" ).append("\n"); 
		...
		query.append("	'UD_CD:'||NVL(BK.STWG_CD,' ')||CHR(10) BL_INFO," ).append("\n"); 
		...
		query.append("	Translate(NVL(M.CMDT_DESC,' '),CHR(13)||CHR(10),' ') CMDT_DESC" ).append("\n"); 
		...
		query.append("AND M.CLPT_IND_SEQ	= @[in_pol_split_no]" ).append("\n"); 
