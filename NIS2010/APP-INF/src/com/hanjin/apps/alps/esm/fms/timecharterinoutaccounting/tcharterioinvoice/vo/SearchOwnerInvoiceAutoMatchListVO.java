...
*@FileName : SearchOwnerInvoiceAutoMatchListVO.java
*@FileTitle : SearchOwnerInvoiceAutoMatchListVO
*Open Issues :
*Change history :
...
public class SearchOwnerInvoiceAutoMatchListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOwnerInvoiceAutoMatchListVO> models = new ArrayList<SearchOwnerInvoiceAutoMatchListVO>();
	...
	public SearchOwnerInvoiceAutoMatchListVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public SearchOwnerInvoiceAutoMatchListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOwnerInvoiceAutoMatchListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOwnerInvoiceAutoMatchListVO();
	...
	public SearchOwnerInvoiceAutoMatchListVO[] getSearchOwnerInvoiceListVOs(){
		SearchOwnerInvoiceAutoMatchListVO[] vos = (SearchOwnerInvoiceAutoMatchListVO[])models.toArray(new SearchOwnerInvoiceAutoMatchListVO[models.size()]);
		return vos;
	}
