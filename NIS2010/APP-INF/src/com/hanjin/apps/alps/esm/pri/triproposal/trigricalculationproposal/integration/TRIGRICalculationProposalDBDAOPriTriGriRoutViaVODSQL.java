...
*@FileName : TRIGRICalculationProposalDBDAOPriTriGriRoutViaVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAOPriTriGriRoutViaVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriTriGriRoutViaVO Delete
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAOPriTriGriRoutViaVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAOPriTriGriRoutViaVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_GRI_ROUT_VIA" ).append("\n"); 
