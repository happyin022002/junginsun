...
*@FileName : EsmFms0039ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EsmFms0039ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"~~", "~~", "~~", "flet_ppay_rlt_cd", "acct_itm_nm", "acct_cd", "n1st_curr_cd", "n1st_amt", "org_slip_no", "vvd_cd",
							   "org_slp_tp_cd","org_slp_func_cd","org_slp_ofc_cd","org_slp_iss_dt","org_slp_ser_no","org_slp_seq_no",
							   "~~", "~~", "~~", "ap_desc1", "ap_desc2", "ap_desc3", "ap_desc4", "ap_desc5", "vvd_cd1", "dummy1",
							   "","","","","",""};
