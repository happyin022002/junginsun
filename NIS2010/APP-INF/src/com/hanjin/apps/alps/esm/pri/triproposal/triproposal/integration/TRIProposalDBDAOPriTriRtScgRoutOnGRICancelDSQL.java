...
*@FileName : TRIProposalDBDAOPriTriRtScgRoutOnGRICancelDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgRoutOnGRICancelDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgRoutOnGRICancelDSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgRoutOnGRICancelDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_SCG_ROUT T" ).append("\n"); 
