...
*@FileName : ModelManageDBDAODeleteModelshipAcctListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAODeleteModelshipAcctListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Season/Version의 Account 정보를 삭제합니다.
	  * [CHM-201322502-01] SPC 프로젝트 - 성수기 선복운영 개선을 위한 T/F추진
	  * </pre>
	  */
	public ModelManageDBDAODeleteModelshipAcctListDSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAODeleteModelshipAcctListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SPC_MDL_CUST_CTRL" ).append("\n"); 
