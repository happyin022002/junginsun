...
*@FileName : ScqAwkwardDBDAOsearchAwkCostByCgoRoutTmpRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOsearchAwkCostByCgoRoutTmpRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Cargo - Route 별 비용 리스트 TMP
	  * </pre>
	  */
	public ScqAwkwardDBDAOsearchAwkCostByCgoRoutTmpRSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOsearchAwkCostByCgoRoutTmpRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    PRI_SCQ_AWK_CGO_TMP A" ).append("\n"); 
		query.append("    ,   PRI_SCQ_AWK_ROUT_TMP B" ).append("\n"); 
		query.append("    ," ).append("\n"); 
		query.append("    (" ).append("\n"); 
		query.append("        SELECT  CGO_SEQ, ROUT_SEQ, COST_TP_CD, SUM ( USD_AMT ) AS SUM_AMT" ).append("\n"); 
		query.append("        FROM    PRI_SCQ_AWK_YD_DTL_TMP" ).append("\n"); 
		...
		query.append("        FROM    PRI_SCQ_AWK_ROUT_DTL_TMP" ).append("\n"); 
		query.append("        WHERE   SCQ_RQST_NO = @[scq_rqst_no]" ).append("\n"); 
		query.append("        AND     SCQ_VER_NO  = @[scq_ver_no_tmp]" ).append("\n"); 
