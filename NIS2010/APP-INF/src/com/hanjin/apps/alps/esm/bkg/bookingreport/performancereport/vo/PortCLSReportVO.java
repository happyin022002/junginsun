...
public class PortCLSReportVO extends AbstractValueObject {
	...
	private String noRtTotCnt   = null;
	private String noRtFrmCnt   = null;
	private String noRtCnt   = null;
	private String noRtPercent   = null;
	private String noRtSts   = null;
	private String etb   = null;
	private String spotGidRfaCd   = null;
	private String rtroKndCd   = null;
	private String rtById   = null;
	private String cntrCfmById   = null;
	...
	public PortCLSReportVO(String ibflag, String pagerows, String obSlsOfcCd, String obSrepCd, String ctrtOfcCd, String ctrtSrepCd, String rnum, String bkgNo, String blNo, String shprCd, String shprNm, String polCd, String brhCfmInd, String brhCfmIndNm, String pct, String atd, String etd, String bkgDate, String vvdCd, String bkgLane, String laneInd, String bkgStsCd, String siFlg, String cneeCd, String cneeNm, String bkgOfcCd, String bkgStf, String ctrtNo, String dummyFlag, String cntrCfmFlg, String scNo, String rfaNo, String taaNo, String rhqCd, String rowsPerPage, String currPage, String totalCnt, String totCnt, String bkTotCnt, String rtTotCnt, String cntrTotCnt, String cnTotCnt, String contTotCnt, String bkChargeCnt, String rtFirmCnt, String cntrFirmCnt, String cnCodeCnt, String contActCnt, String contDummyCnt, String cntrBalanceCnt, String cnBalanceCnt, String contBalanceCnt, String bkNonChargeCnt, String rtNonChargeCnt, String bkPercent, String rtPercent, String cntrPercent, String cnPercent, String contPercent, String reportType, String dtType, String delConti, String slanCd, String gso, String rateCheck, String porCd, String podCd, String delCd, String cmdtCd, String cmdtNm,String noRtTotCnt,String noRtFrmCnt,String noRtCnt,String noRtPercent,String noRtSts,String etb,String spotGidRfaCd,String rtroKndCd,String rtById,String cntrCfmById,String ofcTpCd,String cOfcCdSub,String lOfcCdSub, String ctrtCustCd, String ctrtCustNm, String alocStsCd) {
		this.cneeCd = cneeCd;
		...
		this.cmdtCd = cmdtCd; 
		this.cmdtNm = cmdtNm; 
		this.noRtTotCnt = noRtTotCnt; 
		this.noRtFrmCnt = noRtFrmCnt; 
		this.noRtCnt = noRtCnt; 
		this.noRtPercent = noRtPercent; 
		this.noRtSts = noRtSts; 
		this.etb = etb; 
		this.spotGidRfaCd = spotGidRfaCd;
		this.rtroKndCd = rtroKndCd;
		this.rtById = rtById;
		this.cntrCfmById = cntrCfmById;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("del_conti", getDelConti());
		...
		this.hashColumns.put("no_rt_tot_cnt", getNoRtTotCnt());
		this.hashColumns.put("no_rt_frm_cnt", getNoRtFrmCnt());
		this.hashColumns.put("no_rt_cnt", getNoRtCnt());
		this.hashColumns.put("no_rt_percent", getNoRtPercent());
		this.hashColumns.put("no_rt_sts", getNoRtSts());
		this.hashColumns.put("etb", getEtb());
		this.hashColumns.put("spot_gid_rfa_cd", getSpotGidRfaCd());
		this.hashColumns.put("rtro_knd_cd", getRtroKndCd());
		this.hashColumns.put("rt_by_id", getRtById());
		this.hashColumns.put("cntr_cfm_by_id", getCntrCfmById());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("del_conti", "delConti");
		...
		this.hashFields.put("no_rt_tot_cnt", "noRtTotCnt");
		this.hashFields.put("no_rt_frm_cnt", "noRtFrmCnt");
		this.hashFields.put("no_rt_cnt", "noRtCnt");
		this.hashFields.put("no_rt_percent", "noRtPercent");
		this.hashFields.put("no_rt_sts", "noRtSts");
		this.hashFields.put("etb", "etb");
		this.hashFields.put("spot_gid_rfa_cd", "spotGidRfaCd");
		this.hashFields.put("rtro_knd_cd", "rtroKndCd");
		this.hashFields.put("rt_by_id", "rtById");
		this.hashFields.put("cntr_cfm_by_id", "cntrCfmById");
	 ...
	 * @return delConti
	 */
	public void setDelConti(String delConti) {
		this.delConti = delConti;
	}
	...
	/**
	 * @param rateCheck the rateCheck to set
	 */
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDelConti(JSPUtil.getParameter(request, prefix + "del_conti", ""));
		...
		setNoRtTotCnt(JSPUtil.getParameter(request, prefix + "no_rt_tot_cnt", ""));
		setNoRtFrmCnt(JSPUtil.getParameter(request, prefix + "no_rt_frm_cnt", ""));
		setNoRtCnt(JSPUtil.getParameter(request, prefix + "no_rt_cnt", ""));
		setNoRtPercent(JSPUtil.getParameter(request, prefix + "no_rt_percent", ""));
		setNoRtSts(JSPUtil.getParameter(request, prefix + "no_rt_sts", ""));
		setEtb(JSPUtil.getParameter(request, prefix + "etb", ""));
		setSpotGidRfaCd(JSPUtil.getParameter(request, prefix + "spot_gid_rfa_cd", ""));
		setRtroKndCd(JSPUtil.getParameter(request, prefix + "rtro_knd_cd", ""));
		setRtById(JSPUtil.getParameter(request, prefix + "rt_by_id", ""));
		setCntrCfmById(JSPUtil.getParameter(request, prefix + "cntr_cfm_by_id", ""));
	...
	public PortCLSReportVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] delConti = (JSPUtil.getParameter(request, prefix	+ "del_contit", length));
			...
			String[] noRtTotCnt = (JSPUtil.getParameter(request, prefix	+ "no_rt_tot_cnt", length));
			String[] noRtFrmCnt = (JSPUtil.getParameter(request, prefix	+ "no_rt_frm_cnt", length));
			String[] noRtCnt = (JSPUtil.getParameter(request, prefix	+ "no_rt_cnt", length));
			String[] noRtPercent = (JSPUtil.getParameter(request, prefix	+ "no_rt_percent", length));
			String[] noRtSts = (JSPUtil.getParameter(request, prefix	+ "no_rt_sts", length));
			String[] etb = (JSPUtil.getParameter(request, prefix	+ "etb", length));
			String[] spotGidRfaCd = (JSPUtil.getParameter(request, prefix	+ "spot_gid_rfa_cd", length));
			String[] rtroKndCd = (JSPUtil.getParameter(request, prefix	+ "rtro_knd_cd", length));
			String[] rtById = (JSPUtil.getParameter(request, prefix	+ "rt_by_id", length));
			String[] cntrCfmById = (JSPUtil.getParameter(request, prefix	+ "cntr_cfm_by_id", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (noRtTotCnt[i] != null)
					model.setNoRtTotCnt(noRtTotCnt[i]);
				if (noRtFrmCnt[i] != null)
					model.setNoRtFrmCnt(noRtFrmCnt[i]);
				if (noRtCnt[i] != null)
					model.setNoRtCnt(noRtCnt[i]);
				if (noRtPercent[i] != null)
					model.setNoRtPercent(noRtPercent[i]);
				if (noRtSts[i] != null)
					model.setNoRtSts(noRtSts[i]);
				if (etb[i] != null)
					model.setEtb(etb[i]);
				if (spotGidRfaCd[i] != null)
					model.setSpotGidRfaCd(spotGidRfaCd[i]);
				if (rtroKndCd[i] != null)
					model.setRtroKndCd(rtroKndCd[i]);
				if (rtById[i] != null)
					model.setRtById(rtById[i]);
				if (cntrCfmById[i] != null)
					model.setCntrCfmById(cntrCfmById[i]);
				if (ofcTpCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.delConti = this.delConti .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.noRtTotCnt = this.noRtTotCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.noRtFrmCnt = this.noRtFrmCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.noRtCnt = this.noRtCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.noRtPercent = this.noRtPercent .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.noRtSts = this.noRtSts .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.etb = this.etb .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.spotGidRfaCd = this.spotGidRfaCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rtroKndCd = this.rtroKndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rtById = this.rtById .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cntrCfmById = this.cntrCfmById .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	...
	public String getNoRtTotCnt() {
		return noRtTotCnt;
	}

	public void setNoRtTotCnt(String noRtTotCnt) {
		this.noRtTotCnt = noRtTotCnt;
	}

	public String getNoRtFrmCnt() {
		return noRtFrmCnt;
	}

	public void setNoRtFrmCnt(String noRtFrmCnt) {
		this.noRtFrmCnt = noRtFrmCnt;
	}

	public String getNoRtCnt() {
		return noRtCnt;
	}

	public void setNoRtCnt(String noRtCnt) {
		this.noRtCnt = noRtCnt;
	}

	public String getNoRtPercent() {
		return noRtPercent;
	}

	public void setNoRtPercent(String noRtPercent) {
		this.noRtPercent = noRtPercent;
	}

	public String getNoRtSts() {
		return noRtSts;
	}

	public void setNoRtSts(String noRtSts) {
		this.noRtSts = noRtSts;
	}
	...
	public String getSpotGidRfaCd() {
		return spotGidRfaCd;
	}

	public void setSpotGidRfaCd(String spotGidRfaCd) {
		this.spotGidRfaCd = spotGidRfaCd;
	}
	...
	public void setRtById(String rtById) {
		this.rtById = rtById;
	}

	public String getCntrCfmById() {
		return cntrCfmById;
	}

	public void setCntrCfmById(String cntrCfmById) {
		this.cntrCfmById = cntrCfmById;
	}
