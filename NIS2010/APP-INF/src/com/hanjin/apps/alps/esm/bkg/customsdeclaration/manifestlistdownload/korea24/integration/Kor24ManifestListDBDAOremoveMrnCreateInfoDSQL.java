...
*@FileName : Kor24ManifestListDBDAOremoveMrnCreateInfoDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOremoveMrnCreateInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOremoveMrnCreateInfoDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOremoveMrnCreateInfoDSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_KR_MF_REF_NO" ).append("\n");
