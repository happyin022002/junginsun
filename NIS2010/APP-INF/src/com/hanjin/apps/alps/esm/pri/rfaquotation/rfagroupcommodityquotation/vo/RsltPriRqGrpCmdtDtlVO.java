...
*@FileName : RsltPriRqGrpCmdtDtlVO.java
*@FileTitle : RsltPriRqGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class RsltPriRqGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRqGrpCmdtDtlVO> models = new ArrayList<RsltPriRqGrpCmdtDtlVO>();
	...
	public RsltPriRqGrpCmdtDtlVO() {}

	public RsltPriRqGrpCmdtDtlVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String grpCmdtDtlSeq, String prcCmdtTpCd, String prcCmdtDefCd, String prcCmdtDefNm, String srcInfoCd, String srcInfoNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public RsltPriRqGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqGrpCmdtDtlVO[]
	 */
	public RsltPriRqGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqGrpCmdtDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriRqGrpCmdtDtlVO();
				if (updDt[i] != null)
		...
		return getRsltPriRqGrpCmdtDtlVOs();
	}
	 ...
	 * @return RsltPriRqGrpCmdtDtlVO[]
	 */
	public RsltPriRqGrpCmdtDtlVO[] getRsltPriRqGrpCmdtDtlVOs(){
		RsltPriRqGrpCmdtDtlVO[] vos = (RsltPriRqGrpCmdtDtlVO[])models.toArray(new RsltPriRqGrpCmdtDtlVO[models.size()]);
		return vos;
	}
