...
*@FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtDtlVOAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtDtlVOAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtDtlVOAllDSQL(){
		setQuery();
		...
		query.append("FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtDtlVOAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
