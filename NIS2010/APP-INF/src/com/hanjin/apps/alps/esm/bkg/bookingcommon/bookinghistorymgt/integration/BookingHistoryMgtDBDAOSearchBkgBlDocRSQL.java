...
*@FileName : BookingHistoryMgtDBDAOSearchBkgBlDocRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingHistoryMgtDBDAOSearchBkgBlDocRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingHistoryMgtDBDAOSearchBkgBlDocRSQL
	  * </pre>
	  */
	public BookingHistoryMgtDBDAOSearchBkgBlDocRSQL(){
		setQuery();
		...
		query.append("FileName : BookingHistoryMgtDBDAOSearchBkgBlDocRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", TO_CHAR(BL_OBRD_DT, 'YYYY-MM-DD HH24:MI:SS') BL_OBRD_DT" ).append("\n"); 
		...
		query.append(", TO_CHAR(BDR_DT, 'YYYY-MM-DD HH24:MI:SS') BDR_DT" ).append("\n"); 
		query.append(", BDR_CNG_FLG" ).append("\n"); 
		query.append(", CORR_NO" ).append("\n"); 
		query.append(", CORR_USR_ID" ).append("\n"); 
		query.append(", CORR_OFC_CD" ).append("\n"); 
		query.append(", TO_CHAR(CORR_N1ST_DT, 'YYYY-MM-DD HH24:MI:SS') CORR_N1ST_DT" ).append("\n"); 
		...
		query.append(", TO_CHAR(BDR_GDT, 'YYYY-MM-DD HH24:MI:SS') BDR_GDT " ).append("\n"); 
		query.append(", TO_CHAR(CORR_GDT, 'YYYY-MM-DD HH24:MI:SS') CORR_GDT " ).append("\n"); 
		query.append(", COBIZ_AUTH_NO " ).append("\n"); 
		query.append(", BDR_RSN_CD" ).append("\n"); 
		query.append(", BDR_RSN_RMK" ).append("\n"); 
		query.append(", BDR_CXL_USR_ID" ).append("\n"); 
		query.append(", TO_CHAR(BDR_CXL_DT, 'YYYY-MM-DD HH24:MI:SS') BDR_CXL_DT" ).append("\n"); 
