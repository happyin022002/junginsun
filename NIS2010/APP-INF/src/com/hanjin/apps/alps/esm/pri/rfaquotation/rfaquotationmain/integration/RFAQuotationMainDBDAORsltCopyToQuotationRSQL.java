...
*@FileName : RFAQuotationMainDBDAORsltCopyToQuotationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAQuotationMainDBDAORsltCopyToQuotationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAORsltCopyToQuotationRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.rfaquotation.rfaquotationmain.integration").append("\n"); 
		query.append("FileName : RFAQuotationMainDBDAORsltCopyToQuotationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
