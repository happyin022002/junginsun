...
*@FileName : ESM_BKG_0618HTMLAction.java
...
public class ESM_BKG_0618HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0618HTMLAction 객체를 생성
	 */
	public ESM_BKG_0618HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0618Event event = new EsmBkg0618Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setLoadingConfirmationinVO((LoadingConfirmationinVO)getVO(request, LoadingConfirmationinVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setLoadingConfirmationinVO((LoadingConfirmationinVO)getVO(request, LoadingConfirmationinVO .class));
			event.setLoadingConfirmationinVOS((LoadingConfirmationinVO[])getVOs(request, LoadingConfirmationinVO .class,""));
