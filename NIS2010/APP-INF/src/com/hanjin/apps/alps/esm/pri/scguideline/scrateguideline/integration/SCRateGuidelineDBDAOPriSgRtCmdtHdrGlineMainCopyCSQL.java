...
*@FileName : SCRateGuidelineDBDAOPriSgRtCmdtHdrGlineMainCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtCmdtHdrGlineMainCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtCmdtHdrGlineMainCopyCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append(", TO_DATE(@[trgt_eff_dt], 'YYYY-MM-DD')" ).append("\n"); 
		query.append(", TO_DATE(@[trgt_exp_dt], 'YYYY-MM-DD')" ).append("\n"); 
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtCmdtHdrGlineMainCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}