...
*@FileName : KorObTransWhfVO.java
*@FileTitle : KorObTransWhfVO
*Open Issues :
*Change history :
...
public class KorObTransWhfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorObTransWhfVO> models = new ArrayList<KorObTransWhfVO>();
	...
	public KorObTransWhfVO() {}

	public KorObTransWhfVO(String ibflag, String pagerows, String transType, String transTypeChg, String bkgNo, String ktPort, String ktSeq, String exptKcdTp, String kcdTp) {
		this.ktSeq = ktSeq;
		this.bkgNo = bkgNo;
	 ...
	 */
	public KorObTransWhfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorObTransWhfVO[]
	 */
	public KorObTransWhfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorObTransWhfVO model = null;
	 ...
	 * @return KorObTransWhfVO[]
	 */
	public KorObTransWhfVO[] getKorObTransWhfVOs(){
		KorObTransWhfVO[] vos = (KorObTransWhfVO[])models.toArray(new KorObTransWhfVO[models.size()]);
		return vos;
	}
