...
* 2013.08.08 최성민 [CHM-201325911] [MAS] P&L 화면 일부 로직 수정 -  By Account로 조회 시, E/B W/B가 아닌 H/H, B/H로 grouping 하여 표기
=========================================================*/
 ...
 * @since J2EE 1.6
 */
public class EsmMas0072ViewAdapter4 extends DefaultViewAdapter {
	
    public EsmMas0072ViewAdapter4(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0072ViewAdapter ########### [START]");
...
//						format_flg = "";
				    ...
				    for(int idx=1; idx<=headCnt; idx++) {
				    	...
				    	strBuilder.append("\n<TD ").append(bold).append(format_flg).append(">").append(JSPUtil.getNull(rowSet[1].getString("dir_m_amt" + idx))).append("</TD>");
				    	strBuilder.append("\n<TD ").append(bold).append(format_flg).append(">").append(JSPUtil.getNull(rowSet[1].getString("trd_amt" + idx))).append("</TD>");
				    }
				    
				    strBuilder.append("\n<TD ").append(bold).append(format_flg).append(">").append(JSPUtil.getNull(rowSet[1].getString("com_amt"))).append("</TD>");			    	
		...
		log.debug("########### EsmMas0072ViewAdapter ########### [END]");        
