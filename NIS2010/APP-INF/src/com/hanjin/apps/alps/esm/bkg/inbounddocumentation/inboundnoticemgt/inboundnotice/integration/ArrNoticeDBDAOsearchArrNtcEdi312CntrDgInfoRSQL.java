...
*@FileName : ArrNoticeDBDAOsearchArrNtcEdi312CntrDgInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ArrNoticeDBDAOsearchArrNtcEdi312CntrDgInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchArrNtcEdi312CntrDgInfo
	  * </pre>
	  */
	public ArrNoticeDBDAOsearchArrNtcEdi312CntrDgInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ArrNoticeDBDAOsearchArrNtcEdi312CntrDgInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       || 'MAR_POLL:' 	|| ''				|| CHR(10)  " ).append("\n"); 
