...
*@FileName : Kor24CustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchMaxMacSndLogSeqRSQL").append("\n");
		query.append("*/").append("\n");
	}
