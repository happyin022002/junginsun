...
*@FileName       : ESM_SQM_0014HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmSqm0014Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0014HTMLAction 객체를 생성
	 */
	public ESM_SQM_0014HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0014Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSqm0014Event event = new EsmSqm0014Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
			event.setSqmQtaLodRevVOS((SqmQtaLodRevVO[])getVOs(request, SqmQtaLodRevVO .class,""));
