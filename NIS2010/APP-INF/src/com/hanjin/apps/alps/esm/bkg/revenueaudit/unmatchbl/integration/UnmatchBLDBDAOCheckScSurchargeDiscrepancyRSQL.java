...
public class UnmatchBLDBDAOCheckScSurchargeDiscrepancyRSQL implements ISQLTemplate{
	...
	public UnmatchBLDBDAOCheckScSurchargeDiscrepancyRSQL(){
		...
		params.put("mod",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("                			                WHERE B.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("                			                AND H.HRD_CDG_ID = 'SUR_AUDIT_EXPT'" ).append("\n"); 
		query.append("                			                AND SUBSTR(B.POL_CD,1,2) = H.ATTR_CTNT7" ).append("\n"); 
		query.append("                			                AND @[ca_flg] = 'N'" ).append("\n"); 
		query.append("                                            AND @[mod] = 'C'" ).append("\n"); 
		query.append("                			                UNION ALL" ).append("\n"); 
		query.append("                			                SELECT H.ATTR_CTNT1" ).append("\n"); 
		...
		query.append("                AND    (" ).append("\n"); 
		query.append("								R2.CHG_CD IN (SELECT ATTR_CTNT1 FROM BKG_HRD_CDG_CTNT, BK WHERE HRD_CDG_ID = 'SUR_AUDIT_EXPT' AND ATTR_CTNT5 = BK.SC_NO)" ).append("\n"); 
