...
*@FileName : Kor24ManifestListDBDAORemoveCustMaxInfoKorDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAORemoveCustMaxInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchMaxTransSeqKor에서 구한 seq보다 큰 Customer 데이터를 삭제한다.
	  * </pre>
	  */
	public Kor24ManifestListDBDAORemoveCustMaxInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAORemoveCustMaxInfoKorDSQL").append("\n");
		query.append("*/").append("\n");
	}
