...
*@FileName : RFAProposalMainDBDAORsltPropScpAmdtSmryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORsltPropScpAmdtSmryVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAProposalMainDBDAORsltPropScpAmdtSmryVORSQL
	  * </pre>
	  */
	public RFAProposalMainDBDAORsltPropScpAmdtSmryVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORsltPropScpAmdtSmryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                             AND    AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("                             AND    SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("                             AND    NVL(FIC_RT_TP_CD, 'G') = 'G'" ).append("\n"); 
		query.append("                             UNION ALL" ).append("\n"); 
		query.append("                             SELECT '73' PROP_SCP_TERM_TP_CD" ).append("\n"); 
		query.append("                                   ,DECODE (COUNT (1), 0, 'N', 'Y') DAT_CNT" ).append("\n"); 
		query.append("                             FROM   PRI_RP_SCP_RT_CMDT_HDR" ).append("\n"); 
		query.append("                             WHERE  PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("                             AND    AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("                             AND    SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("                             AND    FIC_RT_TP_CD = 'A') B" ).append("\n"); 
		query.append("                    WHERE  PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("                    AND    AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("                    AND    SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
