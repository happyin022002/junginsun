...
*@FileName : OfficeMappingDBDAOCreateNewLaneOfficeCmcbCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OfficeMappingDBDAOCreateNewLaneOfficeCmcbCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OfficeMappingDBDAOCreateNewLaneOfficeCmcbCSQL(){
		setQuery();
		...
		query.append("FileName : OfficeMappingDBDAOCreateNewLaneOfficeCmcbCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SQM_QTA_NEW_LANE_OFC_COST (" ).append("\n"); 
