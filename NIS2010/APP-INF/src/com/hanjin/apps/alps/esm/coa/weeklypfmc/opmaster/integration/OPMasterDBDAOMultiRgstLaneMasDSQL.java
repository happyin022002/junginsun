...
*@FileName : OPMasterDBDAOMultiRgstLaneMasDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiRgstLaneMasDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiRgstLaneMasDSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiRgstLaneMasDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_LANE_RGST SET" ).append("\n"); 
