...
*@FileName : StatusReportDBDAOSearchBLStatusListSpecialCargo1RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOSearchBLStatusListSpecialCargo1RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * StatusReportDBDAOSearchBLStatusListSpecialCargo1RSQL
	  * </pre>
	  */
	public StatusReportDBDAOSearchBLStatusListSpecialCargo1RSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOSearchBLStatusListSpecialCargo1RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                , DECODE(CNTR_TPSZ_CD,'O7',CNTR_VOL_QTY,0) AS O7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                                , AK.CNTR_NO AS CNTR_NO" ).append("\n"); 
		query.append("                                 /* T/S */" ).append("\n"); 
		query.append("                                , AK.CNTR_TPSZ_CD AS CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                 /* CMDT */" ).append("\n"); 
		query.append("                                  ,(SELECT CMDT_NM FROM MDM_COMMODITY A" ).append("\n"); 
		query.append("                                   WHERE A.CMDT_CD = VB.CMDT_CD) AKREP_CMDT" ).append("\n"); 
		query.append("                                    /*  FWD */" ).append("\n"); 
		query.append("                                , AK.OVR_FWRD_LEN AS OVR_FWRD_LEN" ).append("\n"); 
		query.append("                                  /* AFT */" ).append("\n"); 
		query.append("                                , AK.OVR_BKWD_LEN AS OVR_BKWD_LEN" ).append("\n"); 
		query.append("                                  /* HGT */" ).append("\n"); 
		query.append("                                , AK.OVR_HGT AS OVR_HGT" ).append("\n"); 
		query.append("                                  /* PORT */" ).append("\n"); 
		query.append("                                , AK.OVR_LF_LEN AS OVR_LF_LEN" ).append("\n"); 
		query.append("                                  /* STAR */" ).append("\n"); 
		query.append("                                , AK.OVR_RT_LEN AS OVR_RT_LEN" ).append("\n"); 
		query.append("                                  /*  VOID (FEU)*/" ).append("\n"); 
		query.append("                                , TRIM(TO_CHAR(AK.OVR_VOID_SLT_QTY,'999990.9')) OVR_VOID_SLT_QTY" ).append("\n"); 
		query.append("                                  /* Net */" ).append("\n"); 
		query.append("                                , AK.NET_WGT AS NET_WGT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                  /* PKG */" ).append("\n"); 
		query.append("                                , AK.PCK_QTY||AK.PCK_TP_CD AS PKG" ).append("\n"); 
		query.append("                                  /* AT */" ).append("\n"); 
		query.append("                                , AK.SPCL_CGO_APRO_CD AS SPCL_CGO_APRO_CD" ).append("\n"); 
		query.append("                                  /* WGT  */" ).append("\n"); 
		query.append("                                , TRIM(TO_CHAR(NVL(GRS_WGT,0) ,'999,999,990.999')) GRS_WGT" ).append("\n"); 
		query.append("								 , AK.AWK_CGO_SEQ  AS CGO_SEQ " ).append("\n"); 
		query.append("                                 , AK.STWG_RQST_DESC AS STOWAGE" ).append("\n"); 
		...
		query.append("                                AND VB.BKG_NO = AK.BKG_NO(+)" ).append("\n"); 
		query.append("                                AND VB.AWK_CGO_FLG ='Y'" ).append("\n"); 
