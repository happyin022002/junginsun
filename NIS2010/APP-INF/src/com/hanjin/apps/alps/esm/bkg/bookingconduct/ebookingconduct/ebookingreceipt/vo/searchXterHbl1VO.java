...
*@FileName : searchXterHbl1VO.java
*@FileTitle : searchXterHbl1VO
*Open Issues :
*Change history :
...
public class searchXterHbl1VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchXterHbl1VO> models = new ArrayList<searchXterHbl1VO>();
	...
	public searchXterHbl1VO() {}

	public searchXterHbl1VO(String ibflag, String pagerows, String hblSeq, String xterSiNo, String xterSiSeq, String hblNo, String shprNm, String shprAddr, String cneeNm, String cneeAddr, String notiNm, String notiAddr, String hblWgt, String wgtUtCd, String pckQty, String pckTpCd, String cmdtMeasQty, String cmdtMeasUtCd, String blMkDesc, String blGdsDesc, String bkgNo) {
...
/**
	 ...
	 * @param request
	 * @return searchXterHbl1VO[]
	 */
	public searchXterHbl1VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchXterHbl1VO[]
	 */
	public searchXterHbl1VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchXterHbl1VO model = null;
	 ...
	 * @return searchXterHbl1VO[]
	 */
	public searchXterHbl1VO[] getsearchXterHbl1VOs(){
		searchXterHbl1VO[] vos = (searchXterHbl1VO[])models.toArray(new searchXterHbl1VO[models.size()]);
		return vos;
	}
