...
*@FileName : RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtDtlVOUSQL.java
...
public class RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_GRP_CMDT_DTL SET" ).append("\n"); 
