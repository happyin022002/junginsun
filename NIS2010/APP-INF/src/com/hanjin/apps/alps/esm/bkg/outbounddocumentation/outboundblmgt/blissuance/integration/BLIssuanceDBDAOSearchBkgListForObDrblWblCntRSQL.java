...
*@FileName : BLIssuanceDBDAOSearchBkgListForObDrblWblCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOSearchBkgListForObDrblWblCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchBkgListForObDrblWblCnt
	  * </pre>
	  */
	public BLIssuanceDBDAOSearchBkgListForObDrblWblCntRSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOSearchBkgListForObDrblWblCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SUM  (CASE WHEN 3 = FAX_STS_CD AND FAX_RNUM = 1  THEN 1 ELSE 0 END) AS FAX_SUCCESS,  --SUCCESS(COMPLETED)" ).append("\n"); 
		query.append("       SUM  (CASE WHEN 2 = FAX_STS_CD AND FAX_RNUM = 1  THEN 1 ELSE 0 END) AS FAX_SENDING,  --SENDING(SENDING)" ).append("\n"); 
		query.append("       SUM  (CASE WHEN 1 = FAX_STS_CD AND FAX_RNUM = 1 THEN 1 ELSE 0 END) AS FAX_NO_SEND,  --NOSEND" ).append("\n"); 
		query.append("       SUM  (CASE WHEN 4 = FAX_STS_CD AND FAX_RNUM = 1 THEN 1 ELSE 0 END) AS FAX_FAILED,   --FAILED(FAILED)" ).append("\n"); 
		...
		query.append("       SUM  (CASE WHEN 3 = EML_STS_CD AND EML_RNUM = 1 THEN 1 ELSE 0 END) AS EML_SUCCESS,  --SUCCESS(COMPLETED)" ).append("\n"); 
		query.append("       SUM  (CASE WHEN 2 = EML_STS_CD AND EML_RNUM = 1 THEN 1 ELSE 0 END) AS EML_SENDING,  --SENDING(SENDING)" ).append("\n"); 
		query.append("       SUM  (CASE WHEN 1 = EML_STS_CD AND EML_RNUM = 1 THEN 1 ELSE 0 END) AS EML_NO_SEND,  --NOSEND" ).append("\n"); 
		query.append("       SUM  (CASE WHEN 4 = EML_STS_CD AND EML_RNUM = 1 THEN 1 ELSE 0 END) AS EML_FAILED    --FAILED(FAILED)" ).append("\n"); 
		...
		query.append("               ROW_NUMBER() OVER (PARTITION BY BKG.BKG_NO,FAX.HIS_SEQ ORDER BY BKG.BKG_NO,FAX.HIS_SEQ) FAX_RNUM," ).append("\n"); 
		query.append("               ROW_NUMBER() OVER (PARTITION BY BKG.BKG_NO,EML.HIS_SEQ ORDER BY BKG.BKG_NO,EML.HIS_SEQ) EML_RNUM" ).append("\n"); 
