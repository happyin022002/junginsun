...
*@FileName : Kor24CustomsTransmissionDBDAOsearchTransmitChkRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchTransmitChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchTransmitChkRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchTransmitChkRSQL").append("\n");
		query.append("*/").append("\n");
	}
