...
*@FileName : Jp24ManifestListDownloadDBDAOaddAdvJpReceiveLogInsCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24ManifestListDownloadDBDAOaddAdvJpReceiveLogInsCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SASXXX인경우만 사용 하는 INSERT
	  * </pre>
	  */
	public Jp24ManifestListDownloadDBDAOaddAdvJpReceiveLogInsCSQL(){
		setQuery();
		...
		query.append("FileName : Jp24ManifestListDownloadDBDAOaddAdvJpReceiveLogInsCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
