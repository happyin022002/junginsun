...
*@FileName : ESM_PRI_6091HTMLAction.java
...
public class ESM_PRI_6091HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6091HTMLAction 객체를 생성
	 */
	public ESM_PRI_6091HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6091Event event = new EsmPri6091Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriRpScpMnVOS((PriRpScpMnVO[])getVOs(request, PriRpScpMnVO .class,""));
		}
