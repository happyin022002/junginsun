...
public class SqScpGlineCopyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqScpGlineCopyVO> models = new ArrayList<SqScpGlineCopyVO>();
	 ...
	 */
	public SqScpGlineCopyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpScpGlineCopyVO[]
	 */
	public SqScpGlineCopyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqScpGlineCopyVO model = null;
	 ...
	 * @return SpScpGlineCopyVO[]
	 */
	public SqScpGlineCopyVO[] getSpScpGlineCopyVOs(){
		SqScpGlineCopyVO[] vos = (SqScpGlineCopyVO[])models.toArray(new SqScpGlineCopyVO[models.size()]);
		return vos;
	}
