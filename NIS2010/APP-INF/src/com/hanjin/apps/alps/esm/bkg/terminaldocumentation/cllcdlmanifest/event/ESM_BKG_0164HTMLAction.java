...
*@FileName : ESM_BKG_0164HTMLAction.java
...
public class ESM_BKG_0164HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0164HTMLAction 객체를 생성
	 */
	public ESM_BKG_0164HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0164Event event = new EsmBkg0164Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCllCdlCheckUsaCondVO((CllCdlCheckUsaCondVO)getVO(request, CllCdlCheckUsaCondVO.class));
		}
		return  event;
	}
