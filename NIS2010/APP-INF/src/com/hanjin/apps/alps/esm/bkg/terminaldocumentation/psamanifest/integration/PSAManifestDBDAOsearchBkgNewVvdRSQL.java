...
*@FileName : PSAManifestDBDAOsearchBkgNewVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOsearchBkgNewVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG VVD에서 POL=SGSIN인 Vessel정보를 조회한다.
	  * </pre>
	  */
	public PSAManifestDBDAOsearchBkgNewVvdRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOsearchBkgNewVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
