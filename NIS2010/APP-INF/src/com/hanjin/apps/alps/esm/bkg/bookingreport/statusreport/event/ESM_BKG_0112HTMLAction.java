...
*@FileName : ESM_BKG_0112HTMLAction.java
...
public class ESM_BKG_0112HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0112HTMLAction 객체를 생성
	 */
	public ESM_BKG_0112HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0112Event event = new EsmBkg0112Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgCMCroChkListinVO((BkgCMCroChkListByExportBLVO)getVO(request, BkgCMCroChkListByExportBLVO .class));
		}
