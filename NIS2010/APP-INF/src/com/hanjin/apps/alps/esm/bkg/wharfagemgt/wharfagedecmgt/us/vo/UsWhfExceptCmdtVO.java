...
*@FileName : UsWhfExceptCmdtVO.java
*@FileTitle : UsWhfExceptCmdtVO
*Open Issues :
*Change history :
...
public class UsWhfExceptCmdtVO extends WhfExceptCmdtVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsWhfExceptCmdtVO> models = new ArrayList<UsWhfExceptCmdtVO>();
	...
	public UsWhfExceptCmdtVO() {}

	public UsWhfExceptCmdtVO(String ibflag, String pagerows, String portCd, String cmdtSeq, String kwNm1, String kwNm2, String cmdtDesc, String ioBndCd, String creUsrId, String creDt, String updUsrId, String cmdtRmk) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCmdtRmk(JSPUtil.getParameter(request, prefix + "cmdt_rmk", ""));
	 ...
	 * @param request
	 * @return UsWhfExceptCmdtVO[]
	 */
	public UsWhfExceptCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsWhfExceptCmdtVO[]
	 */
	public UsWhfExceptCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsWhfExceptCmdtVO model = null;
	...
	public UsWhfExceptCmdtVO[] getUsWhfExceptCmdtVOs(){
		UsWhfExceptCmdtVO[] vos = (UsWhfExceptCmdtVO[])models.toArray(new UsWhfExceptCmdtVO[models.size()]);
		return vos;
	}
