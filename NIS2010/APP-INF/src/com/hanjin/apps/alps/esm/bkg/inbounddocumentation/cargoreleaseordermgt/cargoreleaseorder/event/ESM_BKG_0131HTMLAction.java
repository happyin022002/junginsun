...
*@FileName : esm_bkg_0131HTMLAction.java
...
public class ESM_BKG_0131HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * esm_bkg_0131HTMLAction 객체를 생성
	 */
	public ESM_BKG_0131HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0131Event event = new EsmBkg0131Event();
    	
		if(command.isCommand(FormCommand.SEARCH)) {
			
			//event.setBkgJapDoIssueListVO((BkgJapDoIssueListVO)getVO(request, BkgJapDoIssueListVO .class));
			DoCheckListSearchVO searchVo = (DoCheckListSearchVO)getVO(request, DoCheckListSearchVO .class);
			...
			event.setDoCheckListSearchVO(searchVo);
		}
