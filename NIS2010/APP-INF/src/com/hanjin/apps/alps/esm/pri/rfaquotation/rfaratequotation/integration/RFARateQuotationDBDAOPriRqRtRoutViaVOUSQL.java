...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutViaVOUSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutViaVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutViaVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutViaVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_RT_ROUT_VIA SET" ).append("\n"); 
