...
*@FileName : SearchDailyForcastManageByVvdListDAOSqlNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SearchDailyForcastManageByVvdListDAOSqlNameRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchDailyForcastManageByVvdList
	  * </pre>
	  */
	public SearchDailyForcastManageByVvdListDAOSqlNameRSQL(){
		setQuery();
		...
		query.append("FileName : SearchDailyForcastManageByVvdListDAOSqlNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
