...
/**
 * NIS2010 SCGOHChargeProposalDBDAO <br>
...
public class SCGOHChargeProposalDBDAO extends DBDAOSupport {
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<RsltGohChgListVO> searchGOHChargeHistoryList(PriSpScpGohChgVO priSpScpGohChgVO,PriSpHistoryInquiryParamVO priSpHistoryInquiryParamVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<RsltGohChgListVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	...
	/**
	 * S/C Proposal Creation - GOH 정보를 QUICK ACCEPT ALL을 위해 조회 합니다. <br>
	 * 
	 * @param PriSpScpGohChgVO priSpScpGohChgVO
	 * @return List<RsltGohChgListVO>
	 * @exception DAOException
	 */
	 @SuppressWarnings("unchecked")
	public List<PriSpScpGohChgVO> searchGOHChargeQuickList(PriSpScpGohChgVO priSpScpGohChgVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<PriSpScpGohChgVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new SCGOHChargeProposalDBDAOPriSpScpGohChgVORSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, PriSpScpGohChgVO .class);
		}catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage(), se);
		}catch(Exception ex){
