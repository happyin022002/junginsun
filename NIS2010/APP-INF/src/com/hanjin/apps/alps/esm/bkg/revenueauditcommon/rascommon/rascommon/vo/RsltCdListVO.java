...
public class RsltCdListVO extends AbstractValueObject {
	...
	public RsltCdListVO(String ibflag, String pagerows, String amdtSeq, String svcScpCd, String glineSeq, String etc1, String etc3, String etc2, String etc4, String etc5, String propNo, String cd, String nm, String creOfcCd, String qttnNo, String qttnVerNo, String rhqSet, String rdnKndCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rhqSet", getRhqSet());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rhq_set", "rhqSet");
	 ...
	 * @param rhqSet
	 */
	public void setRhqSet(String rhqSet) {
		this.rhqSet = rhqSet;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRhqSet(JSPUtil.getParameter(request, "rhq_set",""));
	...
	public RsltCdListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] rhqSet = (JSPUtil.getParameter(request, prefix	+ "rhq_set", length));
	...
	*/
	public void unDataFormat(){
		...
		this.rhqSet = this.rhqSet .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
