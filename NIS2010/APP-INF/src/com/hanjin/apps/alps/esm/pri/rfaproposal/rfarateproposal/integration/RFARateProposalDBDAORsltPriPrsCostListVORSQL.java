...
*@FileName : RFARateProposalDBDAORsltPriPrsCostListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPriPrsCostListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPriPrsCostListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPriPrsCostListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   prop_no, amdt_seq, svc_scp_cd, gen_spcl_rt_tp_cd, cmdt_hdr_seq, rout_seq,rt_seq, cost_tp 변수를 추가해줘야한다." ).append("\n"); 
		query.append("*/" ).append("\n"); 
