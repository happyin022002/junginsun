...
*@FileName : TransferOrderIssueDBDAORemoveBkgTroSpclCgoSeqDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAORemoveBkgTroSpclCgoSeqDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDBDAORemoveBkgTroSpclCgoSeqDSQL
	  * </pre>
	  */
	public TransferOrderIssueDBDAORemoveBkgTroSpclCgoSeqDSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAORemoveBkgTroSpclCgoSeqDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
