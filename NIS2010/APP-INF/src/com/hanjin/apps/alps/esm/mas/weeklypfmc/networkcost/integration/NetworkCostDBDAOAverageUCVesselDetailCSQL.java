...
*@FileName : NetworkCostDBDAOAverageUCVesselDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOAverageUCVesselDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOAverageUCVesselDetailCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOAverageUCVesselDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL MAS_POOL_VSL_DLY_HIR_PRC" ).append("\n"); 
		query.append("(" ).append("\n"); 
