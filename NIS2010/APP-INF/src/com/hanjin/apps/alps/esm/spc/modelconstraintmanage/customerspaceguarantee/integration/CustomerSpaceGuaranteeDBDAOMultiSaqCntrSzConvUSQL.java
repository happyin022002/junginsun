...
*@FileName : CustomerSpaceGuaranteeDBDAOMultiSaqCntrSzConvUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerSpaceGuaranteeDBDAOMultiSaqCntrSzConvUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Type Size 별 Teu Conversion UPDATE
	  * </pre>
	  */
	public CustomerSpaceGuaranteeDBDAOMultiSaqCntrSzConvUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerSpaceGuaranteeDBDAOMultiSaqCntrSzConvUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SAQ_CNTR_SZ_CONV" ).append("\n"); 
		query.append("   SET VSL_OWN_IND_CD           = @[vsl_own_ind_cd]          ," ).append("\n"); 
