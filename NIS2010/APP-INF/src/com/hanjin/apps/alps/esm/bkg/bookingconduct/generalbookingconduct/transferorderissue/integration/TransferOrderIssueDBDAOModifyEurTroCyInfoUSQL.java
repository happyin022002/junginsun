...
*@FileName : TransferOrderIssueDBDAOModifyEurTroCyInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOModifyEurTroCyInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * return cy정보를 업데이트 한다.
	  * </pre>
	  */
	public TransferOrderIssueDBDAOModifyEurTroCyInfoUSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOModifyEurTroCyInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET CNTR_RTN_YD_CD = @[cntr_rtn_yd_cd]" ).append("\n"); 
