...
*@FileName 		: COACommonHTMLAction.java
*@FileTitle 	:  
*Open Issues 	:
*Change history :
...
public class CommonHTMLAction extends HTMLActionSupport {
    ...
    /**
     * ESM_COA_CommonHTMLAction 객체를 생성
     */
     ...
     * HttpRequst의 정보를 ESM_COA_053Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        event.setCommandClassName("COACommonSC");
