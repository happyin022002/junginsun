...
public class BkgXterCustVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setExCustCntCd(JSPUtil.getParameter(request, "ex_cust_cnt_cd", ""));
        setExCustSeq(JSPUtil.getParameter(request, "ex_cust_seq", ""));
        setExCustLglEngNm(JSPUtil.getParameter(request, "ex_cust_lgl_eng_nm", ""));
