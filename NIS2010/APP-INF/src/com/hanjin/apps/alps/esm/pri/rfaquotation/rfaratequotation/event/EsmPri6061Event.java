...
import com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.vo.RsltPriCommodityRouteAreaVO;
import com.hanjin.apps.alps.esm.pri.rfaquotation.rfaratequotation.vo.RsltPriCommodityRouteVO;
import com.hanjin.framework.support.layer.event.EventSupport;

/**
 * ESM_PRI_6061 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_PRI_6061HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * 
 * @author SONG MIN SEOK
 * @see ESM_PRI_6061HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmPri6061Event extends EventSupport {
