...
*@FileName : ArrivalNoticeDBDAOaddArrNtcDtlsCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ArrivalNoticeDBDAOaddArrNtcDtlsCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ArrivalNoticeDBDAOaddArrNtcDtlsCSQL(){
		setQuery();
		...
		query.append("FileName : ArrivalNoticeDBDAOaddArrNtcDtlsCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
