...
*@FileName : RFARateProposalDBDAOFicRouteGroupVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOFicRouteGroupVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FIC Route Group을 조회한다.
	  * </pre>
	  */
	public RFARateProposalDBDAOFicRouteGroupVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOFicRouteGroupVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , @[prc_io_bnd_cd] PRC_IO_BND_CD" ).append("\n"); 
