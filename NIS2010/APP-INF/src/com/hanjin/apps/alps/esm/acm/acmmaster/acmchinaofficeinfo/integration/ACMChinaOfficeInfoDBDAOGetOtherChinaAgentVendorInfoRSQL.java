...
*@FileName : ACMChinaOfficeInfoDBDAOGetOtherChinaAgentVendorInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMChinaOfficeInfoDBDAOGetOtherChinaAgentVendorInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMChinaOfficeInfoDBDAOGetOtherChinaAgentVendorInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ACMChinaOfficeInfoDBDAOGetOtherChinaAgentVendorInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
