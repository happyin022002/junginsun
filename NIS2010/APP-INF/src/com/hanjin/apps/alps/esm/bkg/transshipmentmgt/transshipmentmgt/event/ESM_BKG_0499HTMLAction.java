...
*@FileName : ESM_BKG_0499HTMLAction.java
 ...
 * @see ESM_BKG_0499Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_0499HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_ESM_BKG_0499HTMLAction 객체를 생성
	 */
	public ESM_BKG_0499HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0499Event event = new EsmBkg0499Event();
		

		if(    command.isCommand(FormCommand.SEARCH) 
			|| command.isCommand(FormCommand.SEARCH01)
			|| command.isCommand(FormCommand.SEARCH03)) {
			event.setTSTimeRptVO((TSTimeRptVO)getVO(request, TSTimeRptVO .class));
		}
