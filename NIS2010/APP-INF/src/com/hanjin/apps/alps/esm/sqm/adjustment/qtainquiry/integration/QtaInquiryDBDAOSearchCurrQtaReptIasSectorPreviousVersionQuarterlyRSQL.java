...
*@FileName : QtaInquiryDBDAOSearchCurrQtaReptIasSectorPreviousVersionQuarterlyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaInquiryDBDAOSearchCurrQtaReptIasSectorPreviousVersionQuarterlyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * QtaInquiryDBDAOSearchCurrQtaReptIasSectorPreviousVersionQuarterly
	  * </pre>
	  */
	public QtaInquiryDBDAOSearchCurrQtaReptIasSectorPreviousVersionQuarterlyRSQL(){
		setQuery();
		...
		query.append("FileName : QtaInquiryDBDAOSearchCurrQtaReptIasSectorPreviousVersionQuarterlyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        (" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("        SELECT '20'||SUBSTR(BSE_YR,-2) AS BSE_YR" ).append("\n"); 
		...
		query.append("        ,RLANE_CD" ).append("\n"); 
		query.append("        ,DIR_CD" ).append("\n"); 
		query.append("        ,DECODE(HUL_BND_CD, 'HH', 'H/H', 'BH', 'B/H') AS HUL_BND_CD" ).append("\n"); 
		query.append("        ,BSE_MON                 " ).append("\n"); 
		query.append("        ,BSE_WK" ).append("\n"); 
		query.append("        ,SLS_YRMON " ).append("\n"); 
		...
		query.append("        AND BSE_YR = 'SQ'||SUBSTR(@[f_bse_yr],-2)" ).append("\n"); 
		query.append("        AND BSE_QTR_CD = DECODE(@[f_bse_tp_cd], 'Y', '00', SUBSTR(@[f_bse_qtr_cd],1,1)||@[f_ofc_vw_cd])" ).append("\n"); 
