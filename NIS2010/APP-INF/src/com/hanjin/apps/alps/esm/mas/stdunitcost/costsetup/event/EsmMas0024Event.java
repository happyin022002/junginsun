...
/**
 *  ESM_MAS_0024에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0024HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Choi, DukWoo
 * @see ESM_MAS_0024HTMLAction 참조
 * @since J2EE 1.6 VesselLayupVO
 */
public class EsmMas0024Event extends EventSupport {
