...
public class CLLCDLManifestDBDAOsearchSpclStowRqstByMlbRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      DECODE(CLL.STWG_CD, 'OLBS', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) OLBS_20," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBS', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) OLBS_40," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBS', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0,  1), 0) OLBS_40H," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBS', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 0) OLBS_45," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBL', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) OLBL_20," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBL', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) OLBL_40," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBL', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0,  1), 0) OLBL_40H," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBL', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 0) OLBL_45," ).append("\n"); 
