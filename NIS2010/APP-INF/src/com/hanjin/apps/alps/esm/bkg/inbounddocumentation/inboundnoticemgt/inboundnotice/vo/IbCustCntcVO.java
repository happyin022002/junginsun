...
public class IbCustCntcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<IbCustCntcVO> models = new ArrayList<IbCustCntcVO>();
	...
	private List<IbCustCntcVO> detailBkgIbCustCntcVO = null;
	...
	public List<IbCustCntcVO> getDetailBkgIbCustCntcVO() {
		return detailBkgIbCustCntcVO;
	}

	public void setDetailBkgIbCustCntcVO(List<IbCustCntcVO> detailBkgIbCustCntcVO) {
	 ...
	 * @return IbCustCntcVO[]
	 */
	public IbCustCntcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return IbCustCntcVO[]
	 */
	public IbCustCntcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		IbCustCntcVO model = null;
	 ...
	 * @return IbCustCntcVO[]
	 */
	public IbCustCntcVO[] getIbCustCntcVOs(){
		IbCustCntcVO[] vos = (IbCustCntcVO[])models.toArray(new IbCustCntcVO[models.size()]);
		return vos;
	}
