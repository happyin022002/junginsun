...
*@FileName : CargoReleaseOrderDBDAOaddBkbcOblUsCgoRlseHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOaddBkbcOblUsCgoRlseHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOaddBkbcOblUsCgoRlseHisCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOaddBkbcOblUsCgoRlseHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            DECODE(@[cgor_team_cd],'S',@[obl_rdem_flg],NVL(MAX(OBL_RDEM_FLG),'N'))," ).append("\n"); 
		...
		query.append("            @[evnt_usr_id]," ).append("\n"); 
		query.append("            NVL(MAX((SELECT OBL_RDEM_LST_DT FROM BKG_CGO_RLSE WHERE BL_NO = @[bl_no]))," ).append("\n"); 
		...
		query.append("                  MAX((SELECT OBL_RDEM_LST_DT FROM BKG_CGO_RLSE WHERE BL_NO = @[bl_no])),'GMT')," ).append("\n"); 
		...
		query.append("		   		SELECT A.DO_HLD_FLG DO_HLD_FLG" ).append("\n"); 
