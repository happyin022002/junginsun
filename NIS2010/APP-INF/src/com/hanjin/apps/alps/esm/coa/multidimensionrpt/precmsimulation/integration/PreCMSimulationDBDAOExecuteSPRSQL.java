...
public class PreCMSimulationDBDAOExecuteSPRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	CALL TRS_AGMT_APLY_TO_COA_PRC('',@[f_pctl_no],@[f_pctl_no],null,'N',@[f_out_param_number])" ).append("\n"); 
		...
		query.append("	CALL COA_COST_PARA_ASSIGN_PKG.MAIN_PRECM_AVG(@[f_pctl_no],@[f_cost_yrmon],@[f_void_qty])" ).append("\n"); 
		query.append("#elseif (${f_call_id} == 'ABC' )" ).append("\n"); 
		query.append("	CALL COA_COST_PARA_ASSIGN_PKG.MAIN_PRECM_ABC_STP(@[f_pctl_no],@[f_pctl_no],@[f_cost_yrmon])" ).append("\n"); 
