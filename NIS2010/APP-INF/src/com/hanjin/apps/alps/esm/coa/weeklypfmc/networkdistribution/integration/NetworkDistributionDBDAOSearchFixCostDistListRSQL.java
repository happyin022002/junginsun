...
public class NetworkDistributionDBDAOSearchFixCostDistListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	#if (${f_inout} == 'ESM_COA_0179')" ).append("\n"); 
		...
		query.append("		  #if (${f_inout} == 'ESM_COA_0047')" ).append("\n"); 
		query.append("		    #if (${f_op_view} == 'OP4')" ).append("\n"); 
		...
		query.append("		   #elseif (${f_inout} == 'ESM_COA_0050')	" ).append("\n"); 
		query.append("			  AND  NVL(DTRB_STEP_CD,'BZC') = 'CMT' 	 " ).append("\n"); 
		query.append("		   #elseif (${f_inout} == 'ESM_COA_0179')" ).append("\n"); 
