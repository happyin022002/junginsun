...
*@FileName : ACMSimulationDBDAOManageAGNCommAddBatchListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOManageAGNCommAddBatchListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 대상 Actual Agreement 를 Batch 에 입력한다.
	  * 
	  * * 2014.06.03 박다은 [CHM-201430120] Agent Comm. Mass simulation 에 기능 추가
	  * </pre>
	  */
	public ACMSimulationDBDAOManageAGNCommAddBatchListCSQL(){
		setQuery();
		...
		params.put("act_agmt_sml_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("sa_arr_dt_to",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("sa_arr_dt_fm",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ACMSimulationDBDAOManageAGNCommAddBatchListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,@[act_agmt_sml_no]" ).append("\n"); 
		query.append("              ,'MassSim(A)_'||@[agn_agmt_no]||'_'||to_char(sysdate,'yymmddhh24miss')" ).append("\n"); 
		query.append("              ,REPLACE(@[sa_arr_dt_fm],'-','')" ).append("\n"); 
		query.append("              ,REPLACE(@[sa_arr_dt_to],'-','')" ).append("\n"); 
		query.append("              ,@[agn_agmt_no]" ).append("\n"); 
