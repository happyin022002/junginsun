...
*@FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewCtrtRefCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewCtrtRefCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewCtrtRefCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewCtrtRefCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AGT_AGN_CTRT_REF" ).append("\n"); 
