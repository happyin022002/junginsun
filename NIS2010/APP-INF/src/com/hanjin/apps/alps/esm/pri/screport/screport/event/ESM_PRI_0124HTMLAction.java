...
*@FileName : ESM_PRI_0124HTMLAction.java
...
public class ESM_PRI_0124HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0124HTMLAction 객체를 생성
	 */
	public ESM_PRI_0124HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0124Event event = new EsmPri0124Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchSCTimelyRateListVO((RsltSearchSCTimelyRateListVO)getVO(request, RsltSearchSCTimelyRateListVO.class));
		}
