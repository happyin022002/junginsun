...
*@FileName : EsmCoa0145ViewAdapter.java
*@FileTitle : EsmCoa0145ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_COA_0145 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0145ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0145ViewAdapter(){
    	super();
    }
