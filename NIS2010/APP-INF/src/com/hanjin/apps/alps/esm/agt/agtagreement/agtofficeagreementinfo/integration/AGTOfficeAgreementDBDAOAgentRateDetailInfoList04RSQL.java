...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList04RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList04RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * sc_inp_term_cd 결과에 agt_agn_otr_ref 조회하여 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList04RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList04RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    OTR_REF_DIV_CD = 'SCNO'" ).append("\n"); 
		query.append("AND    OTR_LVL_CD = '3' )) T START WITH NO = 1 CONNECT BY NOCYCLE PRIOR NO = NO - 1" ).append("\n"); 
