...
public class APActualInterfaceDetailForBRKGVO extends AbstractValueObject {
	...
	public APActualInterfaceDetailForBRKGVO(String ibflag, String pagerows, String commProcRsltRsn, String csrNo, String apOfcCd, String brogSeq, String bkgStsCd, String stsOption, String searchDtTo, String fwdr, String blNo, String vndr, String bkgNo, String actIfCommAmt, String ifOption, String vndrSeq, String brogBkgRt, String searchDtFr, String brogRefNo, String brogType, String cmpnSeq, String cmpnType, String cmpnRefNo, String cmpnBkgRt, String cmpnRfTeuRt, String cmpnRfFeuRt) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cmpn_ref_no", getCmpnRefNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cmpn_ref_no", "cmpnRefNo");
	 ...
	 * @return cmpnRefNo
	 */
	public String getCmpnRefNo() {
		return this.cmpnRefNo;
	}
	 ...
	 * @param cmpnRefNo
	 */
	public void setCmpnRefNo(String cmpnRefNo) {
		this.cmpnRefNo = cmpnRefNo;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCmpnRefNo(JSPUtil.getParameter(request, prefix + "cmpn_ref_no", ""));
	...
	public APActualInterfaceDetailForBRKGVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cmpnRefNo = (JSPUtil.getParameter(request, prefix	+ "cmpn_ref_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (cmpnRefNo[i] != null)
					model.setCmpnRefNo(cmpnRefNo[i]);
				if (brogBkgRt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.cmpnRefNo = this.cmpnRefNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
