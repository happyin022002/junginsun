...
*@FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCntrMfDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCntrMfDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeBkgCstmsDuCntrMf
	  * </pre>
	  */
	public DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCntrMfDSQL(){
		setQuery();
		...
		query.append("FileName : DubaiManifestListDownloadDBDAOremoveBkgCstmsDuCntrMfDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM BKG_CSTMS_DU_CNTR_MF" ).append("\n"); 
