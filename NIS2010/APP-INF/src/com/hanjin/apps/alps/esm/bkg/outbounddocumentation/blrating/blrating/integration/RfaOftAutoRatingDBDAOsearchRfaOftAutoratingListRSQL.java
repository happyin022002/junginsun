...
*@FileName : RfaOftAutoRatingDBDAOsearchRfaOftAutoratingListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RfaOftAutoRatingDBDAOsearchRfaOftAutoratingListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RfaOftAutoRatingDBDAOsearchRfaOftAutoratingList - RFA AutoRaiting
	  * </pre>
	  */
	public RfaOftAutoRatingDBDAOsearchRfaOftAutoratingListRSQL(){
		setQuery();
		...
		query.append("FileName : RfaOftAutoRatingDBDAOsearchRfaOftAutoratingListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("RFA 정보도 같이 SELECT 되며, 유효한 S/C 와 연결되지 않으면 SELECT 되는 ROW 가 없다." ).append("\n"); 
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("AND			NVL(TO_DATE(@[rt_aply_dt], 'YYYYMMDD'), ( SELECT TO_DATE(RT_APLY_DT) FROM BKG_RATE A WHERE A.BKG_NO = BK.BKG_NO ))	BETWEEN RS.EFF_DT AND RS.EXP_DT" ).append("\n"); 
		...
		query.append("AND			RS.AMDT_SEQ			= RM.AMDT_SEQ" ).append("\n"); 
		query.append("AND			RS.SVC_SCP_CD		= BK.SVC_SCP_CD" ).append("\n"); 
		query.append("AND			NVL(TO_DATE(@[rt_aply_dt], 'YYYYMMDD'), ( SELECT TO_DATE(RT_APLY_DT) FROM BKG_RT_HIS A WHERE A.BKG_NO = BK.BKG_NO AND A.CORR_NO = BK.CORR_NO ))	BETWEEN RS.EFF_DT AND RS.EXP_DT" ).append("\n"); 
		query.append("AND			BK.BKG_NO				= @[bkg_no]	-- BKG No" ).append("\n"); 
		...
		query.append("NC.NOTE_CONV_MAPG_ID				," ).append("\n"); 
		query.append("NC.NOTE_CONV_SEQ						," ).append("\n"); 
		query.append("ROW_NUMBER() OVER ( PARTITION BY NC.BQ_SEQ ORDER BY NC.NOTE_CONV_RULE_CD, NC.CONV_TP_PRIO DESC, NVL(NC.CMDT_HDR_SEQ, 0), NVL(NC.ROUT_SEQ, 0) )	NC_SEQ	," ).append("\n"); 
		...
		query.append("FROM		DUAL" ).append("\n"); 
		query.append("WHERE		( ( BQ.POR_CONTI_CD = 'E' OR BQ.POR_CNT_CD = 'US' ) AND BQ.DEL_CONTI_CD <> 'A' )" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT  'G', GL.PRC_GRP_LOC_CD" ).append("\n"); 
		query.append("FROM		GL" ).append("\n"); 
		query.append("WHERE		( ( BQ.POR_CONTI_CD = 'E' OR BQ.POR_CNT_CD = 'US' ) AND BQ.DEL_CONTI_CD <> 'A' )" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     NVL(OA.PRC_CGO_TP_CD, '*')  IN ( '*', BQ.DR_TP, BQ.DG_TP, BQ.RF_TP, BQ.AK_TP, BQ.BB_TP )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(") ," ).append("\n"); 
		...
		query.append("SELECT  'L', BQ.POD_CD" ).append("\n"); 
		query.append("FROM		DUAL" ).append("\n"); 
		query.append("WHERE		( ( BQ.DEL_CONTI_CD = 'E' OR BQ.DEL_CNT_CD = 'US' ) AND BQ.POR_CONTI_CD <> 'A' )" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT  'G', GL.PRC_GRP_LOC_CD" ).append("\n"); 
		query.append("FROM		GL" ).append("\n"); 
		query.append("WHERE		( ( BQ.DEL_CONTI_CD = 'E' OR BQ.DEL_CNT_CD = 'US' ) AND BQ.POR_CONTI_CD <> 'A' )" ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND     NVL(DA.PRC_CGO_TP_CD, '*')  IN ( '*', BQ.DR_TP, BQ.DG_TP, BQ.RF_TP, BQ.AK_TP, BQ.BB_TP )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")	," ).append("\n"); 
		...
		query.append("CM.CMDT_SEQ, OP.ROUT_PNT_SEQ, DP.ROUT_PNT_SEQ, OV.ROUT_VIA_SEQ, OV.ROUT_VIA_SEQ" ).append("\n"); 
		query.append("ORDER BY	DECODE(RT.RAT_UT_CD," ).append("\n"); 
		query.append("BQ.CTRT_CNTR_TPSZ_CD, 100," ).append("\n"); 
		query.append("( SELECT MIN(A.RAT_UT_CD) FROM PRI_RAT_UT A WHERE A.RAT_UT_CD IN ( '20', '40', 'HC', '45', '53' ) AND A.CNTR_SZ_CD = BQ.CTRT_CNTR_SZ_CD ), 100," ).append("\n"); 
		query.append("'BL', 80," ).append("\n"); 
		...
		query.append("AND			CM.PROP_NO		= CH.PROP_NO AND CM.AMDT_SEQ		= CH.AMDT_SEQ AND	CM.SVC_SCP_CD			= CH.SVC_SCP_CD AND	CM.CMDT_HDR_SEQ			= CH.CMDT_HDR_SEQ AND CM.SRC_INFO_CD		<> 'AD'" ).append("\n"); 
		query.append("AND			AC.PROP_NO(+)	= CH.PROP_NO AND AC.AMDT_SEQ(+)	= CH.AMDT_SEQ AND	AC.SVC_SCP_CD(+)	= CH.SVC_SCP_CD AND	AC.CMDT_HDR_SEQ(+)	= CH.CMDT_HDR_SEQ AND AC.SRC_INFO_CD(+)	<> 'AD'" ).append("\n"); 
		...
		query.append("AND     OP.PROP_NO		= CR.PROP_NO AND OP.AMDT_SEQ		= CR.AMDT_SEQ AND OP.SVC_SCP_CD			= CR.SVC_SCP_CD AND OP.CMDT_HDR_SEQ			= CR.CMDT_HDR_SEQ AND OP.ROUT_SEQ			= CR.ROUT_SEQ AND OP.ORG_DEST_TP_CD			= 'O' AND OP.SRC_INFO_CD		<> 'AD'" ).append("\n"); 
		query.append("AND     DP.PROP_NO		= CR.PROP_NO AND DP.AMDT_SEQ		= CR.AMDT_SEQ AND DP.SVC_SCP_CD			= CR.SVC_SCP_CD AND DP.CMDT_HDR_SEQ			= CR.CMDT_HDR_SEQ AND DP.ROUT_SEQ			= CR.ROUT_SEQ AND DP.ORG_DEST_TP_CD			= 'D' AND DP.SRC_INFO_CD		<> 'AD'" ).append("\n"); 
		query.append("AND     OV.PROP_NO(+)	= CR.PROP_NO AND OV.AMDT_SEQ(+)	= CR.AMDT_SEQ AND OV.SVC_SCP_CD(+)	= CR.SVC_SCP_CD AND OV.CMDT_HDR_SEQ(+)	= CR.CMDT_HDR_SEQ AND OV.ROUT_SEQ(+)	= CR.ROUT_SEQ AND OV.ORG_DEST_TP_CD(+)	= 'O' AND OV.SRC_INFO_CD(+)	<> 'AD'" ).append("\n"); 
		query.append("AND     DV.PROP_NO(+)	= CR.PROP_NO AND DV.AMDT_SEQ(+)	= CR.AMDT_SEQ AND DV.SVC_SCP_CD(+)	= CR.SVC_SCP_CD AND DV.CMDT_HDR_SEQ(+)	= CR.CMDT_HDR_SEQ AND DV.ROUT_SEQ(+)	= CR.ROUT_SEQ AND DV.ORG_DEST_TP_CD(+)	= 'D' AND DV.SRC_INFO_CD(+)	<> 'AD'" ).append("\n"); 
		query.append("AND     RT.PROP_NO		= CR.PROP_NO AND RT.AMDT_SEQ		= CR.AMDT_SEQ AND RT.SVC_SCP_CD			= CR.SVC_SCP_CD AND RT.CMDT_HDR_SEQ			= CR.CMDT_HDR_SEQ AND RT.ROUT_SEQ			= CR.ROUT_SEQ AND RT.SRC_INFO_CD				<> 'AD'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("BQ.RFA_NO											CTRT_NO										," ).append("\n"); 
		...
		query.append("NULL													OA_MIN_CGO_WGT						," ).append("\n"); 
		query.append("NULL													OA_MAX_CGO_WGT						," ).append("\n"); 
		...
		query.append("NULL													DA_MIN_CGO_WGT						," ).append("\n"); 
		query.append("NULL													DA_MAX_CGO_WGT						," ).append("\n"); 
		...
		query.append("OA.MIN_CGO_WGT								OA_MIN_CGO_WGT						," ).append("\n"); 
		query.append("OA.MAX_CGO_WGT								OA_MAX_CGO_WGT						," ).append("\n"); 
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND			RT.RAT_UT_CD	<> 'BL'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("DA.MIN_CGO_WGT								DA_MIN_CGO_WGT						," ).append("\n"); 
		query.append("DA.MAX_CGO_WGT								DA_MAX_CGO_WGT						," ).append("\n"); 
		...
		query.append("R.OA_MIN_CGO_WGT						OA_MIN_CGO_WGT						," ).append("\n"); 
		query.append("R.OA_MAX_CGO_WGT						OA_MAX_CGO_WGT						," ).append("\n"); 
		...
		query.append("R.DA_MIN_CGO_WGT						DA_MIN_CGO_WGT						," ).append("\n"); 
		query.append("R.DA_MAX_CGO_WGT						DA_MAX_CGO_WGT						," ).append("\n"); 
