...
*@FileName : EsmMas0042ViewAdapter.java
*@FileTitle : EsmMas0042ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0042 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmMas0042ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0042ViewAdapter(){
    	super();
    }
