...
*@FileName : MRIInquiryDBDAOCoaMonMiscRevPreTeuVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MRIInquiryDBDAOCoaMonMiscRevPreTeuVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MRIInquiryDBDAOCoaMonMiscRevPreTeuVOUSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.coa.stdunitcost.mriinquiry.integration").append("\n"); 
		query.append("FileName : MRIInquiryDBDAOCoaMonMiscRevPreTeuVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_MON_MISC_REV_PRE_TEU" ).append("\n"); 
