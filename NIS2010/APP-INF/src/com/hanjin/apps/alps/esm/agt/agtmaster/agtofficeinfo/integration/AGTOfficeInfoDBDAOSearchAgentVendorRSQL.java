...
*@FileName : AGTOfficeInfoDBDAOSearchAgentVendorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeInfoDBDAOSearchAgentVendorRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AGTOfficeInfoDBDAOSearchAgentVendorRSQL
	  * </pre>
	  */
	public AGTOfficeInfoDBDAOSearchAgentVendorRSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeInfoDBDAOSearchAgentVendorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT count(1) VNDERCOUNT" ).append("\n"); 
