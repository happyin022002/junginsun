...
*@FileName : PerformanceReportDBDAOSearchSREmlReceivingListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchSREmlReceivingListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchSREmlReceivingListVORSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchSREmlReceivingListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   EML.BKG_NO IN (" ).append("\n"); 
		...
		query.append("AND nvl(EML.BKG_NO_MTCH_STS_CD,'F') = nvl(@[sr_bkg_sts_cd], nvl(EML.BKG_NO_MTCH_STS_CD,'F')) -- add 2011.08.11" ).append("\n"); 
