...
*@FileName       : ESM_COA_167HTMLActon.java
*@FileTitle      : 
*Open Issues     :
*Change history  :
 ...
 *
 * @author eunju park
 * @see EsmCoa0167Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_0167HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_COA_0167HTMLAction 객체를 생성
     */
    public ESM_COA_0167HTMLAction() {
    	//
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_COA_167Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0167Event event = new EsmCoa0167Event();
  	
    	HashMap hash = new HashMap();
    	hash = Utils.requestToHashMap(request);
    	
        if(command.isCommand(FormCommand.MULTI01)){
  	    	event.setTmChtrOutHirVos((CoaTmChtrOutHirVO[])getVOs(request, CoaTmChtrOutHirVO .class));
