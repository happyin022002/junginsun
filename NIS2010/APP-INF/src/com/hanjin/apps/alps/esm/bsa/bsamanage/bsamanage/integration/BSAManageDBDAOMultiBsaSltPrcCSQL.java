...
*@FileName : BSAManageDBDAOMultiBsaSltPrcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiBsaSltPrcCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * History-------------------------------
	  * 2010.07.19 이행지 [CHM-201112101-01] BSA_SLT_PRC.curr_cd 컬럼 추가로 인한 쿼리 수정
	  * </pre>
	  */
	public BSAManageDBDAOMultiBsaSltPrcCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiBsaSltPrcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_SLT_PRC A" ).append("\n"); 
