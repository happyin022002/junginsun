...
*@FileName : ACMSimulationDBDAORemoveSimAgnRateDetailCntrListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAORemoveSimAgnRateDetailCntrListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DeleteSimAgnRateDetail
	  * </pre>
	  */
	public ACMSimulationDBDAORemoveSimAgnRateDetailCntrListDSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAORemoveSimAgnRateDetailCntrListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_SIM_AGMT_DTL_CNTR" ).append("\n"); 
