...
*@FileName : JapanCmfModificationVO.java
*@FileTitle : JapanCmfModificationVO
*Open Issues :
*Change history :
...
public class JapanCmfModificationVO extends ManifestModificationVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<JapanCmfModificationVO> models = new ArrayList<JapanCmfModificationVO>();
	 ...
	 */
	public JapanCmfModificationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanCmfModificationVO[]
	 */
	public JapanCmfModificationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JapanCmfModificationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new JapanCmfModificationVO();
				if (custSeq2[i] != null)
		...
		return getJapanCmfModificationVOs();
	}
	 ...
	 * @return JapanCmfModificationVO[]
	 */
	public JapanCmfModificationVO[] getJapanCmfModificationVOs(){
		JapanCmfModificationVO[] vos = (JapanCmfModificationVO[])models.toArray(new JapanCmfModificationVO[models.size()]);
		return vos;
	}
