...
*@FileName : KorDownCheckVO.java
*@FileTitle : KorDownCheckVO
*Open Issues :
*Change history :
...
public class KorDownCheckVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDownCheckVO> models = new ArrayList<KorDownCheckVO>();
	...
	public KorDownCheckVO() {}

	public KorDownCheckVO(String ibflag, String pagerows, String blNo, String vvd, String bkgNo, String cstmsDeclTpCd, String ioBndCd, String podCd, String polCd) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.polCd = polCd;
		this.bkgNo = bkgNo;
	 ...
	 */
	public KorDownCheckVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDownCheckVO[]
	 */
	public KorDownCheckVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDownCheckVO model = null;
	 ...
	 * @return KorDownCheckVO[]
	 */
	public KorDownCheckVO[] getKorDownCheckVOs(){
		KorDownCheckVO[] vos = (KorDownCheckVO[])models.toArray(new KorDownCheckVO[models.size()]);
		return vos;
	}
