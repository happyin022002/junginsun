...
*@FileName : ESM_MAS_0140HTMLAction.java
...
public class ESM_MAS_0140HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0140HTMLAction 객체를 생성
	 */
	public ESM_MAS_0140HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0140Event event = new EsmMas0140Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMasTrnsTermCalcVOS((MasTrnsTermCalcVO[])getVOs(request, MasTrnsTermCalcVO .class,""));
		}
