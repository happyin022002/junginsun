...
*@FileName : SCGOHChargeProposalDBDAOPriSpScpGohChgRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGOHChargeProposalDBDAOPriSpScpGohChgRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGOHChargeProposalDBDAOPriSpScpGohChgRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCGOHChargeProposalDBDAOPriSpScpGohChgRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_GOH_CHG SET" ).append("\n"); 
