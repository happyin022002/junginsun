...
*@FileName : Kor24BondCdVO.java
*@FileTitle : Kor24BondCdVO
*Open Issues :
*Change history :
...
public class Kor24BondCdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24BondCdVO> models = new ArrayList<Kor24BondCdVO>();
	...
	public Kor24BondCdVO() {}

	public Kor24BondCdVO(String ibflag, String pagerows, String vvd, String bdAreaCd, String userId, String portCd, String inType, String ioBndCd, String podCd, String polCd, String podTml, String trnsSeq, String cstmsDeclTpCd, String bkgNo, String mfSndRcvrId) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMfSndRcvrId(JSPUtil.getParameter(request, "mf_snd_rcvr_id", ""));
	 ...
	 * @param request
	 * @return Kor24BondCdVO[]
	 */
	public Kor24BondCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24BondCdVO[]
	 */
	public Kor24BondCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BondCdVO model = null;
	 ...
	 * @return Kor24BondCdVO[]
	 */
	public Kor24BondCdVO[] getKor24BondCdVOs(){
		Kor24BondCdVO[] vos = (Kor24BondCdVO[])models.toArray(new Kor24BondCdVO[models.size()]);
		return vos;
	}
