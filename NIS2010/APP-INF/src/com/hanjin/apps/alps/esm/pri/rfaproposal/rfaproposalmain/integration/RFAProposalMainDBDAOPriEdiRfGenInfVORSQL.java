...
*@FileName : RFAProposalMainDBDAOPriEdiRfGenInfVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriEdiRfGenInfVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI > EDI 로 전송하는 RF_GENINF Interface 정보
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriEdiRfGenInfVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriEdiRfGenInfVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", PRI_RP_HDR HD" ).append("\n"); 
		query.append(", PRI_RP_DUR DR" ).append("\n"); 
