...
*@FileName : StatusManageDBDAORemoveQtaStepVerDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAORemoveQtaStepVerDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * QTA Establishing Status Management 관련 Creation류 버튼 Data 생성 전 Setp Ver별 삭제처리
	  * </pre>
	  */
	public StatusManageDBDAORemoveQtaStepVerDSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAORemoveQtaStepVerDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SQM_QTA_STEP_VER" ).append("\n"); 
