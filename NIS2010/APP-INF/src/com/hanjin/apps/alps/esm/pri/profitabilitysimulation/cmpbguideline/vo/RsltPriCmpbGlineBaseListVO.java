...
*@FileName : RsltPriCmpbGlineBaseListVO.java
*@FileTitle : RsltPriCmpbGlineBaseListVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGlineBaseListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGlineBaseListVO> models = new ArrayList<RsltPriCmpbGlineBaseListVO>();
	...
	public RsltPriCmpbGlineBaseListVO() {}

	public RsltPriCmpbGlineBaseListVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq, String vslSlanCd, String prcCmdtDefCd, String orgRoutPntLocDefCd, String orgRoutViaPortDefCd, String destRoutViaPortDefCd, String destRoutPntLocDefCd) {
		this.bseSeq = bseSeq;
	 ...
	 * @param request
	 * @return RsltPriCmpbGlineBaseListVO[]
	 */
	public RsltPriCmpbGlineBaseListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGlineBaseListVO[]
	 */
	public RsltPriCmpbGlineBaseListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGlineBaseListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGlineBaseListVO();
				if (bseSeq[i] != null)
		...
		return getRsltPriCmpbGlineBaseListVOs();
	}
	 ...
	 * @return RsltPriCmpbGlineBaseListVO[]
	 */
	public RsltPriCmpbGlineBaseListVO[] getRsltPriCmpbGlineBaseListVOs(){
		RsltPriCmpbGlineBaseListVO[] vos = (RsltPriCmpbGlineBaseListVO[])models.toArray(new RsltPriCmpbGlineBaseListVO[models.size()]);
		return vos;
	}
