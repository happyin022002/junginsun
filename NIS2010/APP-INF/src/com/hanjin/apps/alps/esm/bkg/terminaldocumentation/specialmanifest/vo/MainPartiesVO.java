...
*@FileName : MainPartiesVO.java
*@FileTitle : MainPartiesVO
*Open Issues :
*Change history :
...
public class MainPartiesVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MainPartiesVO> models = new ArrayList<MainPartiesVO>();
	...
	public MainPartiesVO() {}

	public MainPartiesVO(String ibflag, String pagerows, String partyType, String partyId, String authorized, String address1, String address2, String address3, String address4, String address5, String contact, String phone, String fax, String ref1) {
	 ...
	 * @param request
	 * @return MainPartiesVO[]
	 */
	public MainPartiesVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MainPartiesVO[]
	 */
	public MainPartiesVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MainPartiesVO model = null;
	 ...
	 * @return MainPartiesVO[]
	 */
	public MainPartiesVO[] getMainPartiesVOs(){
		MainPartiesVO[] vos = (MainPartiesVO[])models.toArray(new MainPartiesVO[models.size()]);
		return vos;
	}
