...
*@FileName : EsmCoa0181Event.java
*@FileTitle : EsmCoa0181Event
*Open Issues :
*Change history :
...
/**
 * ESM_COA_0181 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_COA_0181HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author LEE SUK JOON
 * @see ESM_COA_0181HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmCoa0181Event extends EventSupport {
	...
	/** Constructor */
	public EsmCoa0181Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmCoa0181Event";
	}
