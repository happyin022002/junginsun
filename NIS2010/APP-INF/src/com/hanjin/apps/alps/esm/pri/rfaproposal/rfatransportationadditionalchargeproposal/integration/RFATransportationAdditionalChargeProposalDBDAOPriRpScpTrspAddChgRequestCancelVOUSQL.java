...
*@FileName : RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFATransportationAdditionalChargeProposalDBDAOPriRpScpTrspAddChgRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , COFFR_FRT_RT_AMT = NULL" ).append("\n"); 
