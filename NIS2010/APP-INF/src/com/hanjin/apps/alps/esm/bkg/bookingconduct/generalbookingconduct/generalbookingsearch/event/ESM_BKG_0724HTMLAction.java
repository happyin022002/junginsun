...
*@FileName : ESM_BKG_0724HTMLAction.java
...
public class ESM_BKG_0724HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0724HTMLAction 객체를 생성
	 */
	public ESM_BKG_0724HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0724Event event = new EsmBkg0724Event();
		...
		if(command.isCommand(FormCommand.DEFAULT)||command.isCommand(FormCommand.SEARCH)) {
			...
			event.setBkgBlNoVO((BkgBlNoVO)getVO(request,  BkgBlNoVO.class));
			event.setRollOvrVOs((RollOvrVO[])getVOs(request,RollOvrVO.class,"sheet1_"));
		}
