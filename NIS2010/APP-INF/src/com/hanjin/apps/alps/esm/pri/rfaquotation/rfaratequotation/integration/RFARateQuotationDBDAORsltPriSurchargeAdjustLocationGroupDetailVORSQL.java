...
*@FileName : RFARateQuotationDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_rq_grp_loc_dtl loc_dtl" ).append("\n"); 
		...
		query.append("SELECT loc_mdm.loc_cd , loc_mdm.loc_nm" ).append("\n"); 
		query.append(",'' AS qttn_no,'' qttn_ver_no,0 AS grp_loc_seq" ).append("\n"); 
