...
*@FileName : BSAManageDBDAORemoveSpcScPortDownDetailDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveSpcScPortDownDetailDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveSpcScPortDownDetail DELETE
	  * </pre>
	  */
	public BSAManageDBDAORemoveSpcScPortDownDetailDSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveSpcScPortDownDetailDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
