...
*@FileName : ESM_FMS_0034HTMLAction.java
...
public class ESM_FMS_0034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0034HTMLAction 객체를 생성
	 */
	public ESM_FMS_0034HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0034Event event = new EsmFms0034Event();
