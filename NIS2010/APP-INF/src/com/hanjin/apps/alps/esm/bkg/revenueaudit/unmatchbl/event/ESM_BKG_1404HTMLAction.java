...
*@FileName : ESM_BKG_1404HTMLAction.java
...
public class ESM_BKG_1404HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1404HTMLAction 객체를 생성
	 */
	public ESM_BKG_1404HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("\n\n\n\n\n   ESM_BKG_1404HTMLAction aaaaaaaaaaaaaaaa  Start \n\n\n\n");

		
    	FormCommand command = FormCommand.fromRequest(request);
		EsmBkg1404Event event = new EsmBkg1404Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTxsBkgListForAuditSchVO((TxsBkgListForAuditSchVO)getVO(request, TxsBkgListForAuditSchVO .class));
		}
