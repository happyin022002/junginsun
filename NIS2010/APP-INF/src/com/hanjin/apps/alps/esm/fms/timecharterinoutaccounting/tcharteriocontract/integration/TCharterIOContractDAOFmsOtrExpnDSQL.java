...
public class TCharterIOContractDAOFmsOtrExpnDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOFmsOtrExpnDSQL
	  * </pre>
	  */
	public TCharterIOContractDAOFmsOtrExpnDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("delete from fms_otr_expn" ).append("\n"); 
		...
		query.append("and eff_dt = TO_DATE(@[ori_eff_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("and exp_dt = TO_DATE(@[ori_exp_dt],'YYYYMMDD')" ).append("\n"); 

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.nis2010.esm.fms.timecharterinoutaccounting.tcharteriocontract.integration").append("\n"); 
		query.append("FileName : TCharterIOContractDAOFmsOtrExpnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}