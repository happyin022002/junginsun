...
public class SalesRPTDBDAOsearchInqByLane0062ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		,DECODE(@[f_pro_lvl],'M', (BKG_REV+MISC_REV-CM_COST-NVL(OWN_FDR_AMT,0)), 0) AS CM2         " ).append("\n"); 
		...
		query.append("				,'' TRD_DIR_CD" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("				,COA_GET_CD_NM_FNC('CD03217', R.HUL_BND_CD) AS TRD_DIR_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if ( ${f_bkg_disp} != '' )" ).append("\n"); 
		...
		query.append("				,SUM(DECODE(@[f_pro_vw], 'P', 0 , 'R', NVL(D.RA_OP_COST_TTL_AMT, 0))) OP_COST" ).append("\n"); 
