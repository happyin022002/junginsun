...
*@FileName : RFAGroupCommodityQuotationDBDAORsltPriRqGrpCmdtVORSQL.java
...
public class RFAGroupCommodityQuotationDBDAORsltPriRqGrpCmdtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityQuotationDBDAORsltPriRqGrpCmdtVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityQuotationDBDAORsltPriRqGrpCmdtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
