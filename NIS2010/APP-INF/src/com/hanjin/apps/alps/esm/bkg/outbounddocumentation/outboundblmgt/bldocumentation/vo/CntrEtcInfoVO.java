...
public class CntrEtcInfoVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("cn_dir_flg", getCnDirFlg());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("cn_dir_flg", "cnDirFlg");
    ...
    public String getCnDirFlg() {
        return cnDirFlg;
    }

    public void setCnDirFlg(String cnDirFlg) {
        this.cnDirFlg = cnDirFlg;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setCnDirFlg(JSPUtil.getParameter(request, "cn_dir_flg", ""));
    }
    ...
    public CntrEtcInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] cnDirFlg = (JSPUtil.getParameter(request, prefix + "cn_dir_flg", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.cnDirFlg = this.cnDirFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
