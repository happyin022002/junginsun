...
*@FileName : KrWharfageDecMgtDBDAOModifyBkgKrWhfRtIfCsrNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOModifyBkgKrWhfRtIfCsrNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOModifyBkgKrWhfRtIfCsrNoUSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOModifyBkgKrWhfRtIfCsrNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET D.CSR_NO = @[csr_no]," ).append("\n"); 
