...
*@FileName : searchDiversionRequestVO.java
*@FileTitle : searchDiversionRequestVO
*Open Issues :
*Change history :
...
public class searchDiversionRequestVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchDiversionRequestVO> models = new ArrayList<searchDiversionRequestVO>();
...
/**
	 ...
	 * @param request
	 * @return searchDiversionRequestVO[]
	 */
	public searchDiversionRequestVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchDiversionRequestVO[]
	 */
	public searchDiversionRequestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchDiversionRequestVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new searchDiversionRequestVO();
				if (ptName[i] != null)
		...
		return getsearchDiversionRequestVOs();
	}
	 ...
	 * @return searchDiversionRequestVO[]
	 */
	public searchDiversionRequestVO[] getsearchDiversionRequestVOs(){
		searchDiversionRequestVO[] vos = (searchDiversionRequestVO[])models.toArray(new searchDiversionRequestVO[models.size()]);
		return vos;
	}
