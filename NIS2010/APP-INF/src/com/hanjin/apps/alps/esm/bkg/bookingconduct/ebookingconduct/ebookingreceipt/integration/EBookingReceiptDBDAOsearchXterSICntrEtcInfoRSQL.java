...
*@FileName : EBookingReceiptDBDAOsearchXterSICntrEtcInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOsearchXterSICntrEtcInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOsearchXterSICntrEtcInfoRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOsearchXterSICntrEtcInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",      (SELECT 'Y' FROM BKG_BOOKING BK, BKG_VVD VVD  WHERE BK.BKG_NO =  A.BKG_NO" ).append("\n"); 
		query.append("                                                AND BK.BKG_NO = VVD.BKG_NO" ).append("\n"); 
		query.append("                                                AND (BK.DEL_CD LIKE 'CN%' OR BK.POD_CD LIKE 'CN%' OR VVD.POD_CD LIKE 'CN%')" ).append("\n"); 
		query.append("                                                                                AND BK.POD_CD != 'CNHKG' " ).append("\n"); 
		query.append("                                                                             AND BK.DEL_CD != 'CNHKG' " ).append("\n"); 
		query.append("                                                AND NOT EXISTS ( SELECT 'X' FROM BKG_VVD V, BKG_BOOKING BKG " ).append("\n"); 
		query.append("                                                                  WHERE V.BKG_NO = BK.BKG_NO  " ).append("\n"); 
		query.append("                                                                                                  AND BKG.BKG_NO = BK.BKG_NO" ).append("\n"); 
		query.append("                                                                  AND ((V.POL_CD LIKE 'CN%' AND V.POD_CD LIKE 'CN%') OR V.POD_CD = 'CNHKG')" ).append("\n"); 
		query.append("                                                                 )" ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		query.append("                                                AND ROWNUM = 1) CN_DIR_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
