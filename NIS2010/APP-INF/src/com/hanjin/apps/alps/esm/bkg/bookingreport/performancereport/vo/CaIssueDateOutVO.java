...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setKindJ(JSPUtil.getParameter(request, prefix + "kind_j", ""));
		setKindK(JSPUtil.getParameter(request, prefix + "kind_k", ""));
		setKindH(JSPUtil.getParameter(request, prefix + "kind_h", ""));
		setKindI(JSPUtil.getParameter(request, prefix + "kind_i", ""));
		setKindF(JSPUtil.getParameter(request, prefix + "kind_f", ""));
		setVpsEtaDt(JSPUtil.getParameter(request, prefix + "vps_eta_dt", ""));
		setBlNo(JSPUtil.getParameter(request, prefix + "bl_no", ""));
		setKindG(JSPUtil.getParameter(request, prefix + "kind_g", ""));
		setKindD(JSPUtil.getParameter(request, prefix + "kind_d", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setKindE(JSPUtil.getParameter(request, prefix + "kind_e", ""));
		setKindC(JSPUtil.getParameter(request, prefix + "kind_c", ""));
		setKindB(JSPUtil.getParameter(request, prefix + "kind_b", ""));
		setPolCd(JSPUtil.getParameter(request, prefix + "pol_cd", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setKindA(JSPUtil.getParameter(request, prefix + "kind_a", ""));
		...
		setCaRsnNm(JSPUtil.getParameter(request, prefix + "ca_rsn_nm", ""));
	}
