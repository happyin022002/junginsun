...
*@FileName : SearchMTCost10ListVO.java
*@FileTitle : SearchMTCost10ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost10ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost10ListVO> models = new ArrayList<SearchMTCost10ListVO>();
	...
	public SearchMTCost10ListVO() {}

	public SearchMTCost10ListVO(String ibflag, String pagerows, String costYrmon, String fromEcc, String toEcc, String cntrTpszCd, String vol, String contiSteve, String contiTrans, String contiDays, String mvmtSteve, String mvmtTrans, String mvmtDays, String contiSteveUc, String contiTransUc, String contiTtlUc) {
		this.toEcc = toEcc;
...
/**
	 ...
	 */
	public SearchMTCost10ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost10ListVO[]
	 */
	public SearchMTCost10ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost10ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCost10ListVO();
				if (toEcc[i] != null)
		...
		return getSearchMTCost10ListVOs();
	}
	 ...
	 * @return SearchMTCost10ListVO[]
	 */
	public SearchMTCost10ListVO[] getSearchMTCost10ListVOs(){
		SearchMTCost10ListVO[] vos = (SearchMTCost10ListVO[])models.toArray(new SearchMTCost10ListVO[models.size()]);
		return vos;
	}
