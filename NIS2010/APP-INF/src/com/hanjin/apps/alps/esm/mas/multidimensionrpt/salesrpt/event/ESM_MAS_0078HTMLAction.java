...
*@FileName       : ESM_MAS_078HTMLAction.java
*@FileTitle      : 
*Open Issues     :
*Change history  :
*@LastModifyDate : 2007-05-09
*@LastModifier   : Park Eun Ju
*@LastVersion    : 1.0
* 2007-05-09 Park Eun Ju
* 1.0 최초 생성
===========================================================
' History :
 ...
 *
 * @author Park Eun Ju
 * @see ESM_MAS_078Event , ESM_MAS_078EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_MAS_0078HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_MAS_078HTMLAction 객체를 생성
	 */
	public ESM_MAS_0078HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_MAS_078Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0078Event event = new EsmMas0078Event();
