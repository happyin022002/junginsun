...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSMODBlFlatFileOldRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSMODBlFlatFileOldRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSMODBlFlatFileOldRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSMODBlFlatFileOldRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
