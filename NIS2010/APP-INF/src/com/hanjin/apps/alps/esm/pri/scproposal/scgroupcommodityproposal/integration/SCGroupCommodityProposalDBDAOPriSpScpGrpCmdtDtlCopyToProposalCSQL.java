...
*@FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGrpCmdtDtlCopyToProposal
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	PRI_SQ_GRP_CMDT B" ).append("\n"); 
		query.append(",	PRI_SQ_GRP_CMDT_DTL C" ).append("\n"); 
