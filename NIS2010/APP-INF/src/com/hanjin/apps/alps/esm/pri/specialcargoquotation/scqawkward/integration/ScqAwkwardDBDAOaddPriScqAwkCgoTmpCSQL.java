...
*@FileName : ScqAwkwardDBDAOaddPriScqAwkCgoTmpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOaddPriScqAwkCgoTmpCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_CGO_TMP 테이블 생성
	  * </pre>
	  */
	public ScqAwkwardDBDAOaddPriScqAwkCgoTmpCSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOaddPriScqAwkCgoTmpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SCQ_AWK_CGO_TMP" ).append("\n"); 
