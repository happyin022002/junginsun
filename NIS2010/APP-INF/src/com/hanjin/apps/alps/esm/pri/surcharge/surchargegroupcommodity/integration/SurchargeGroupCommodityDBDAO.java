...
/**
 * NIS2010 CommonGroupCommodityDBDAO <br>
...
public class SurchargeGroupCommodityDBDAO extends DBDAOSupport {
	...
	public List<RsltPriScgGrpCmdtDtlVO> searchSurchargeGroupCommodityDetailList(PriScgGrpCmdtVO priComGrpCmdtVO, SignOnUserAccount account) throws DAOException {
		DBRowSet dbRowset = null;
