...
*@FileName : CLLCDLManifestCdlCntrDescInfoVO.java
*@FileTitle : CLLCDLManifestCdlCntrDescInfoVO
*Open Issues :
*Change history :
...
public class CLLCDLManifestCdlCntrDescInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CLLCDLManifestCdlCntrDescInfoVO> models = new ArrayList<CLLCDLManifestCdlCntrDescInfoVO>();
	...
	public CLLCDLManifestCdlCntrDescInfoVO() {}

	public CLLCDLManifestCdlCntrDescInfoVO(String ibflag, String pagerows, String cntrDesc, String cusMark, String cntrDescEnd) {
	 ...
	 * @param request
	 * @return CLLCDLManifestCdlCntrDescInfoVO[]
	 */
	public CLLCDLManifestCdlCntrDescInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CLLCDLManifestCdlCntrDescInfoVO[]
	 */
	public CLLCDLManifestCdlCntrDescInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CLLCDLManifestCdlCntrDescInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CLLCDLManifestCdlCntrDescInfoVO();
		...
		return getCLLCDLManifestCdlCntrDescInfoVOs();
	}
	 ...
	 * @return CLLCDLManifestCdlCntrDescInfoVO[]
	 */
	public CLLCDLManifestCdlCntrDescInfoVO[] getCLLCDLManifestCdlCntrDescInfoVOs(){
		CLLCDLManifestCdlCntrDescInfoVO[] vos = (CLLCDLManifestCdlCntrDescInfoVO[])models.toArray(new CLLCDLManifestCdlCntrDescInfoVO[models.size()]);
		return vos;
	}
