 ...
 * 2015.06.10 이한나[CHM-201535768] ENS OLD MRN 자동 삭제 관련
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.integration.Eur24CustomsTransmissionDBDAO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eu24RcvMsgVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCMinfoListOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCMinfoListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCntrListOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCntrListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCntrMfListOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCntrMfListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCntrSealListOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCntrSealListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCustListOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlCustListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlDgCgoListOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlDgCgoListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlRouteCntListVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlinfoOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24BlinfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24DiversionRequestVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24SendHistoryOBVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24SendHistoryVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24VesselArrivalTransmitVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.eur24.vo.Eur24VesselArrivalVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.integration.IsraelCustomsTransmissionDBDAO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.vo.ManifestTransmitVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.vo.VesselArrivalTransmitVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.eur24.integration.Eur24ManifestDownloadDBDAO;
 ...
 * @since J2EE 1.6
 */
public class Eur24CustomsTransmissionBCImpl extends CustomsTransmissionBCImpl{
    ...
    private Eur24ManifestDownloadDBDAO ManiDbDao = null; // Add. [CHM-201535768]
	...
	public Eur24CustomsTransmissionBCImpl(){
		...
		ManiDbDao = new Eur24ManifestDownloadDBDAO(); // Add. [CHM-201535768]
	}
...
//					}
			...
			sendFlatFileVO.setQueueNm(SubSystemConfigFactory.get("BKG.ALPSBKG_UBIZHJS_EUR24.IBMMQ.QUEUE"));
	 ...
	 * @throws EventException
	 */
	private String makeFlatFileForArrivalNotice(BookingUtil util, Eur24VesselArrivalVO eurVo) throws EventException{
		String header;
		StringBuilder flatFile = new StringBuilder();
		// FlatFile Header를 생성한다.
		header = util.searchCstmsEdiHeader("SMLM", "EUR24" + eurVo.getTransNation(), "ARNENT");
		...
		flatFile.append("PT_EORI:DE5647002").append("\n");
		flatFile.append("PT_NAME:SM Line Corporation, Seoul").append("\n");
		flatFile.append("PT_ADDRESS:SM LINE CORPORATION, 25 GUKJEGEUMYUNG-RO 2-GIL, YEONGDEUNGPO-GU, SEOUL, KOREA").append("\n");
	 ...
	 * @throws EventException
	 */
	private String makeFlatFileForDiversionRequest(BookingUtil util, Eur24DiversionRequestVO eurVo) throws EventException{
		String header;
		StringBuilder flatFile = new StringBuilder();
		// FlatFile Header를 생성한다.
		header = util.searchCstmsEdiHeader("SMLM", "EUR24" + eurVo.getCntCd(), "DIVREQ");
		flatFile.append(header).append("\n");
		flatFile.append("DOC_NO:").append(eurVo.getDocNo().replace("\r", "").replace("\n", "")).append("\n");
		flatFile.append("CALL_REF_NO:").append(eurVo.getCallRefNo()).append("\n");
	...
	public String transmitManifest(ManifestTransmitVO[] manifestTransmitVOs, SignOnUserAccount account) throws EventException {
		...
		Eur24BlInfoCondVO eur24BlInfoCondVO = new Eur24BlInfoCondVO();
		...
		String uploadEtaHis = "";
		String pType = "";
		String eu1stPortClptSeq ="";
		
		String[] tempStr = null;
		int tempCount = 0;
		
		//add. 2014.12.10 Update History
		BkgDocProcSkdVO bkgDocProcSkdVO = null;
		String usrId    = "";
		
		// Add. 2015.05.
		List<Eur24BlinfoVO> unsndBlinfoVOs = null;
		Eur24BlinfoVO unsndBlinfoVO = null;
		String vvd = "";
		...
		try {
			if (manifestTransmitVOs.length > 0) {
				...
				for (int q = 0; q < manifestTransmitVOs.length; q++) {
					...
					eu1stPortClptSeq = eu24ManifestTransmitVO.getEu1stPortClptSeq();  // add. 2015.11.20
					...
					log.debug("eu1stPort:"+eu1stPort + ", eu1stPortClptSeq:"+eu1stPortClptSeq);
					...
					//////////////////////////////////////////////////////
					// Add. 2015.05. [CHM-201535768]
					// ENS일 경우, VVD변경 후 처음 전송하는 BL에 대해서 Original로 보내기 위한 로직
					if("ENS".equals(pType)){
							
						unsndBlinfoVOs = dbDao.searchUnsndBL(blNo, vslCd, skdVoyNo, skdDirCd, eu1stPort);
						
						if(unsndBlinfoVOs.size() > 0 ){
							//System.out.println("++++::::: " + unsndBlinfoVOs.size());
							
							unsndBlinfoVO = unsndBlinfoVOs.get(0);
						 	
							vvd = eu24ManifestTransmitVO.getVslCd()+eu24ManifestTransmitVO.getSkdVoyNo()+eu24ManifestTransmitVO.getSkdDirCd();
							
							eur24BlInfoCondVO.setBlNo(eu24ManifestTransmitVO.getBlNo());
							eur24BlInfoCondVO.setVvd(vvd);
							eur24BlInfoCondVO.setCstmsYdCd(eu24ManifestTransmitVO.getEu1stPort());
							
							eur24BlInfoCondVO.setMrnFlg("D");
							eur24BlInfoCondVO.setMvmtRefNo(unsndBlinfoVO.getMvmtRefNo());

							eur24BlInfoCondVO.setCreUsrId(account.getUpd_usr_id());
							eur24BlInfoCondVO.setUpdUsrId(account.getUpd_usr_id());
														
							log.error("Transmit - Amend : Before MRN Delete / blNo + MRN No. : " + unsndBlinfoVO.getBlNo() + "^" + unsndBlinfoVO.getMrn());
							
							ManiDbDao.modifyMrnNo(eur24BlInfoCondVO);
							ManiDbDao.addMrnNoHis(eur24BlInfoCondVO);
					...
					//************************* Bl info 조회 ****************************
					eur24BlinfoVOs = dbDao.searchBlGeneral(blNo, vslCd, skdVoyNo, skdDirCd, eu1stPort, pType, eu1stPortClptSeq);
...
//					}
					...
					bfTemp.append("PT_EORI:").append("DE5647002").append("\n");
					bfTemp.append("PT_NAME:SM Line Corporation, Seoul").append("\n");
					bfTemp.append("PT_ADDRESS:SM LINE CORPORATION, 25 GUKJEGEUMYUNG-RO 2-GIL, YEONGDEUNGPO-GU, SEOUL, KOREA").append("\n");
					bfTemp.append("PT_STREET:").append("").append("\n");
					bfTemp.append("PT_CITY:").append("SEOUL").append("\n");
					bfTemp.append("PT_POSTAL_CD:").append("").append("\n");
					bfTemp.append("PT_CNT_CD:").append("KR").append("\n");
...
//							uploadEtaHis = "";
						...
						//Add. 2014.12.10 HISTORY BCImpl - mbl, hbl  flag update
						usrId = eur24SendHistoryVO.getCreUsrId();
						...
						bkgHisBC.manageDocProcAIFlag("X", bkgDocProcSkdVO);
						//End. 2014.12.10
...
//			}
	 ...
	 * @throws EventException
	 */
	private String makeFlatFileForFiArrivalNotice(BookingUtil util, Eur24VesselArrivalVO eurVo) throws EventException{
		String header;
		StringBuilder flatFile = new StringBuilder();
	 ...
	 * @throws EventException
	 */
	private String makeFlatFileArrivalNoticeFi(BookingUtil util, Eur24VesselArrivalVO eurVo, Eur24VesselFIArrivalNoticeDetailVO anFITransmitVO) throws EventException{
