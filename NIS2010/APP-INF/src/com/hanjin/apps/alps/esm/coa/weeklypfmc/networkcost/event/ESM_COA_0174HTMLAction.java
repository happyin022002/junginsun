...
*@FileName : ESM_COA_0174HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_COA_0174HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_COA_0174HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0174Event event = new EsmCoa0174Event();  
