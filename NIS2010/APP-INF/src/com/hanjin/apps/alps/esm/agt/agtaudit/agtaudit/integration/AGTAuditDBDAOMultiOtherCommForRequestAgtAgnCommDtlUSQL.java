...
*@FileName : AGTAuditDBDAOMultiOtherCommForRequestAgtAgnCommDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOMultiOtherCommForRequestAgtAgnCommDtlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTAuditDBDAOMultiOtherCommForRequestAgtAgnCommDtlUSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOMultiOtherCommForRequestAgtAgnCommDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET ACT_USD_COMM_AMT  = ROUND (@[act_usd_comm_amt], 2)," ).append("\n"); 
		...
		query.append("AND CNTR_TPSZ_CD      = 'BX'" ).append("\n"); 
