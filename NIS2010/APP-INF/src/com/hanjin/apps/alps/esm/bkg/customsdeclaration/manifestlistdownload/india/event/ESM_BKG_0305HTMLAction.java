...
*@FileName : ESM_BKG_0305HTMLAction.java
...
public class ESM_BKG_0305HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0745HTMLAction 객체를 생성
	 */
	public ESM_BKG_0305HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0305Event event = new EsmBkg0305Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setIndiaBondListCondVO((IndiaBondListCondVO)getVO(request, IndiaBondListCondVO.class));
		}
