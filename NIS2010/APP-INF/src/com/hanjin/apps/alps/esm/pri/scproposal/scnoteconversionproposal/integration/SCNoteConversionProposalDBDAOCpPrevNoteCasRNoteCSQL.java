...
*@FileName : SCNoteConversionProposalDBDAOCpPrevNoteCasRNoteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOCpPrevNoteCasRNoteCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOCpPrevNoteCasRNoteCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAOCpPrevNoteCasRNoteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            FROM PRI_SP_SCP_RT_CMDT_RNOTE S" ).append("\n"); 
		...
		query.append("             AND S.ROUT_NOTE_SEQ = B.ROUT_NOTE_SEQ)" ).append("\n"); 
		...
		query.append("    FROM PRI_SC_NOTE_CONV A, PRI_SP_SCP_RT_CMDT_RNOTE B, PRI_SP_SCP_MN C" ).append("\n"); 
		...
		query.append("     AND B.CMDT_HDR_SEQ = @[cmdt_hdr_seq]" ).append("\n"); 
		query.append("     AND B.ROUT_SEQ = @[rout_seq]" ).append("\n"); 
		query.append("     AND B.ROUT_NOTE_SEQ = @[rout_note_seq]" ).append("\n"); 
