...
*@FileName : ESM_PRI_0062HTMLAction.java
...
public class ESM_PRI_0062HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0062HTMLAction 객체를 생성
	 */
	public ESM_PRI_0062HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0062Event event = new EsmPri0062Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchSCListVO((RsltSearchSCListVO)getVO(request, RsltSearchSCListVO.class));
