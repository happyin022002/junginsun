...
*@FileName : SpecialCargoReceiptDBDAODcgo2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAODcgo2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAODcgo2USQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAODcgo2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND DCGO_SEQ = @[awk_dcgo_seq]" ).append("\n"); 
