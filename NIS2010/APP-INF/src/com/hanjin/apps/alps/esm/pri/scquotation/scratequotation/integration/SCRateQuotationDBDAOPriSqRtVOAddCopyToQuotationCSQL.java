...
*@FileName : SCRateQuotationDBDAOPriSqRtVOAddCopyToQuotationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtVOAddCopyToQuotationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtVOAddCopyToQuotationCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtVOAddCopyToQuotationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
