...
*@FileName : RFARateProposalDBDAORsltRtListHorizontalExcelForAddOnTariffVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtListHorizontalExcelForAddOnTariffVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtListHorizontalExcelForAddOnTariffVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtListHorizontalExcelForAddOnTariffVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       B.ORG_RATE_PROP_DRY20 AS FIC_ORG_RATE_PROP_DRY20," ).append("\n"); 
		query.append("       B.ORG_RATE_PROP_DRY40 AS FIC_ORG_RATE_PROP_DRY40," ).append("\n"); 
		query.append("       B.ORG_RATE_PROP_DRY40HC AS FIC_ORG_RATE_PROP_DRY40HC," ).append("\n"); 
		query.append("       B.ORG_RATE_PROP_DRY45 AS FIC_ORG_RATE_PROP_DRY45," ).append("\n"); 
		query.append("       B.ORG_RATE_PROP_RF40HC AS FIC_ORG_RATE_PROP_RF40HC," ).append("\n"); 
		query.append("       B.ORG_RATE_PROP_RD40HC AS FIC_ORG_RATE_PROP_RD40HC," ).append("\n"); 
		query.append("       B.DEST_RATE_PROP_DRY20 AS FIC_DEST_RATE_PROP_DRY20," ).append("\n"); 
		query.append("       B.DEST_RATE_PROP_DRY40 AS FIC_DEST_RATE_PROP_DRY40," ).append("\n"); 
		query.append("       B.DEST_RATE_PROP_DRY40HC AS FIC_DEST_RATE_PROP_DRY40HC," ).append("\n"); 
		query.append("       B.DEST_RATE_PROP_DRY45 AS FIC_DEST_RATE_PROP_DRY45," ).append("\n"); 
		query.append("       B.DEST_RATE_PROP_RF40HC AS FIC_DEST_RATE_PROP_RF40HC," ).append("\n"); 
		query.append("       B.DEST_RATE_PROP_RD40HC AS FIC_DEST_RATE_PROP_RD40HC,        " ).append("\n"); 
		...
		query.append("                          F.ORG_RATE_PROP_DRY20," ).append("\n"); 
		query.append("                          F.ORG_RATE_PROP_DRY40," ).append("\n"); 
		query.append("                          F.ORG_RATE_PROP_DRY40HC," ).append("\n"); 
		query.append("                          F.ORG_RATE_PROP_DRY45," ).append("\n"); 
		query.append("                          F.ORG_RATE_PROP_RF40HC," ).append("\n"); 
		query.append("                          F.ORG_RATE_PROP_RD40HC," ).append("\n"); 
		query.append("                          F.DEST_RATE_PROP_DRY20," ).append("\n"); 
		query.append("                          F.DEST_RATE_PROP_DRY40," ).append("\n"); 
		query.append("                          F.DEST_RATE_PROP_DRY40HC," ).append("\n"); 
		query.append("                          F.DEST_RATE_PROP_DRY45," ).append("\n"); 
		query.append("                          F.DEST_RATE_PROP_RF40HC," ).append("\n"); 
		query.append("                          F.DEST_RATE_PROP_RD40HC," ).append("\n"); 
		query.append("                          F.RATE_DRY20 - (F.ORG_RATE_PROP_DRY20 + F.DEST_RATE_PROP_DRY20) AS RATE_BOF_DRY20," ).append("\n"); 
		query.append("                          F.RATE_DRY40 - (F.ORG_RATE_PROP_DRY40 + F.DEST_RATE_PROP_DRY40) AS RATE_BOF_DRY40," ).append("\n"); 
		query.append("                          F.RATE_DRY40HC - (F.ORG_RATE_PROP_DRY40HC + F.DEST_RATE_PROP_DRY40HC) AS RATE_BOF_DRY40HC," ).append("\n"); 
		query.append("                          F.RATE_DRY45 - (F.ORG_RATE_PROP_DRY45 + F.DEST_RATE_PROP_DRY45) AS RATE_BOF_DRY45," ).append("\n"); 
		query.append("                          F.RATE_RF40HC - (F.ORG_RATE_PROP_RF40HC + F.DEST_RATE_PROP_RF40HC) AS RATE_BOF_RF40HC," ).append("\n"); 
		query.append("                          F.RATE_RD40HC - (F.ORG_RATE_PROP_RD40HC + F.DEST_RATE_PROP_RD40HC) AS RATE_BOF_RD40HC," ).append("\n"); 
		...
		query.append("                                        WHEN (T.RAT_UT_CD = 'D2' OR T.RAT_UT_CD = '20') AND T.PRC_CGO_TP_CD = 'DR' THEN T.PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS RATE_DRY20," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D4' OR T.RAT_UT_CD = '40') AND T.PRC_CGO_TP_CD = 'DR' THEN T.PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS RATE_DRY40," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN T.RAT_UT_CD = 'D5' AND T.PRC_CGO_TP_CD = 'DR' THEN T.PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS RATE_DRY40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D7' OR T.RAT_UT_CD = '45') AND T.PRC_CGO_TP_CD = 'DR' THEN T.PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS RATE_DRY45," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'R5' OR T.RAT_UT_CD = '40') AND T.PRC_CGO_TP_CD = 'RF' THEN T.PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS RATE_RF40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN T.RAT_UT_CD = 'R5' AND T.PRC_CGO_TP_CD = 'DR' THEN T.PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS RATE_RD40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D2' OR T.RAT_UT_CD = '20') AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_ORG_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS ORG_RATE_PROP_DRY20," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D4' OR T.RAT_UT_CD = '40') AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_ORG_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS ORG_RATE_PROP_DRY40," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN T.RAT_UT_CD = 'D5' AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_ORG_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS ORG_RATE_PROP_DRY40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D7' OR T.RAT_UT_CD = '45') AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_ORG_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS ORG_RATE_PROP_DRY45," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'R5' OR T.RAT_UT_CD = '40') AND T.PRC_CGO_TP_CD = 'RF' THEN T.FIC_ORG_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS ORG_RATE_PROP_RF40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN T.RAT_UT_CD = 'R5' AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_ORG_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS ORG_RATE_PROP_RD40HC,                                      " ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D2' OR T.RAT_UT_CD = '20') AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_DEST_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS DEST_RATE_PROP_DRY20," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D4' OR T.RAT_UT_CD = '40') AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_DEST_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS DEST_RATE_PROP_DRY40," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN T.RAT_UT_CD = 'D5' AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_DEST_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS DEST_RATE_PROP_DRY40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'D7' OR T.RAT_UT_CD = '45') AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_DEST_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS DEST_RATE_PROP_DRY45," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN (T.RAT_UT_CD = 'R5' OR T.RAT_UT_CD = '40') AND T.PRC_CGO_TP_CD = 'RF' THEN T.FIC_DEST_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS DEST_RATE_PROP_RF40HC," ).append("\n"); 
		query.append("                                  SUM(CASE" ).append("\n"); 
		query.append("                                        WHEN T.RAT_UT_CD = 'R5' AND T.PRC_CGO_TP_CD = 'DR' THEN T.FIC_DEST_PROP_RT_AMT" ).append("\n"); 
		query.append("                                      END) AS DEST_RATE_PROP_RD40HC,                                      " ).append("\n"); 
		query.append("                                  LPAD(T.CMDT_HDR_SEQ, 5, '0') || '|' || LPAD(T.ROUT_SEQ, 5, '0') || '|' || '00001' AS ROUT_ROWKEY" ).append("\n"); 
