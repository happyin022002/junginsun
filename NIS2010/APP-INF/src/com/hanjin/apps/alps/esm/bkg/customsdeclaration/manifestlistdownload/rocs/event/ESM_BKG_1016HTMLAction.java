...
*@FileName : ESM_BKG_1016HTMLAction.java
...
public class ESM_BKG_1016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1016HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1016Event event = new EsmBkg1016Event();
		if(command.isCommand(FormCommand.SEARCH)) { 
			event.setRocsManifestListCondVO((RocsManifestListCondVO)getVO(request, RocsBlVO.class));			 
		} 
