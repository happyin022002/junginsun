...
/**
 * ESM_COA_0066 에 대한 ViewAdapter<br>
 * - ESM_COA_0066HTMLAction에서 작성<br>
 *
 * @author 김기식
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmCoa0069ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0069ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmCoa0069ViewAdapter ########### [START]");
    	...
    	try{			    
			...
			strBuilder.append("<TR>");
			strBuilder.append("<TD></TD>");
			strBuilder.append("<TD>Minimum G.RPB for Cost Saving</TD>");
			strBuilder.append("<TD></TD>");
			strBuilder.append("<TD></TD>");				
			if(hArr != null) {
				for(int k=0; k<hArr.length; k++){
		...
		log.debug("########### EsmCoa0069ViewAdapter ########### [END]");        
