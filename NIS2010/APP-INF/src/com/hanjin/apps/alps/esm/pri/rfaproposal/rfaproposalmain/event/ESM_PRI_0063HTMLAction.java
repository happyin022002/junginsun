...
import com.hanjin.apps.alps.esm.pri.rfaproposal.rfaproposalmain.vo.RsltPriSgGrpCmdtVO;
...
public class ESM_PRI_0063HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0063HTMLAction 객체를 생성
	 */
	public ESM_PRI_0063HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0063Event event = new EsmPri0063Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltPriSgGrpCmdtVO((RsltPriSgGrpCmdtVO)getVO(request, RsltPriSgGrpCmdtVO.class));
//			event.setAttribute("prc_cust_tp_cd", request.getParameter("prc_cust_tp_cd"));
		}
