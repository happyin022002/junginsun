...
* 2010.09.01 김기종 Ticket ID:CHM-201004982-01 MAS Architecture 위배사항 수정 searchComBoCdList0059 메소드 추가
...
* 2011.08.18 연상원 [CHM-201112940-01] [MAS] Pre-CM / OP simulation 오류 수정요청
* 2011.10.13 최성민 [CHM-201113894-01] [MAS, PRD] FMX AUBNE 요율 조회문제
* 2012.01.02 최성민 [CHM-201114896-01] [MAS] CM2 추가 개발 요청
...
* 2013.07.10 박찬민 [CHM-201325474] [MAS] Customer Segmentation 관련 변경사항 MDM DB 변경 
* 2013.11.15 박찬민 [CHM-201327153] [MAS] Inquiry by Source Data 화면의 주차 연장 등 추가 사항 
...
* 2014.01.23 김수정 [CHM-201428608] [MAS] PreCM RD 추정 로직 변경
...
*=========================================================*/
package com.hanjin.apps.alps.esm.mas.multidimensionrpt;
...
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.basic.LogisticsRPTBC;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.basic.LogisticsRPTBCImpl;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0080Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0081Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0082Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0158Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.logisticsrpt.event.EsmMas0163Event;
...
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.basic.MultiDimensionRPTBC;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.basic.MultiDimensionRPTBCImpl;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0063Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0066Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0068Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0069Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0072Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0073Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0074Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0130Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0178Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.multidimensionrpt.event.EsmMas0192Event;
...
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.precmsimulation.event.EsmMas0153Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.precmsimulation.event.EsmMas0155Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.precmsimulation.event.EsmMas0162Event;
...
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.basic.SalesRPTBC;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.basic.SalesRPTBCImpl;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0035Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0057Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0059Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0060Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0061Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0062Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0070Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0071Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0078Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0135Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0144Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0147Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0148Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0149Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0156Event;
import com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.event.EsmMas0170Event;
...
public class MultiDimensionRPTSC extends ServiceCommandSupport {
	...
	public EventResponse perform(Event e) throws EventException {
		...
		if (e.getEventName().equalsIgnoreCase("EsmMas0057Event")) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0035Event")) {
			...
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCH01)) {    // sheet1 조회 결과 엑셀 파일 이메일 전송
                eventResponse = sendMailInqSrcDtAcct0035List(e);
            } else if (e.getFormCommand().isCommand(FormCommand.SEARCH11)) {    // sheet2 조회 결과 엑셀 파일 이메일 전송
                eventResponse = sendMailInqSrcDtTpSz0035List(e);
            } else { // 초기Load시
				eventResponse = searchComBoCdList0035(e);
				//eventResponse = searchTypeSizeList(e);
			}
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0130Event")) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0170Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchBkgRmkList(e);
			}
			
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0059Event")) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0060Event")) {
			log.debug("####################### 멀티.EsmMas0060Event() ############# ");
			...
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST03)) { // excel down - 화면출력없이 바로 파일 저장됨.
				eventResponse = searchInqByCondition060ExcelList(e);
			} else{
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0061Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0062Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0063Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0066Event")) {
			//if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchMultiDimension0066List(e);
			//}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0068Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0069Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0070Event")){
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0071Event")){
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0072Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
                ...
                eventResponse = searchWeeklySalesByOffice3TEUBased9List(e);
            } else if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST10)) {
                eventResponse = searchWeeklySalesByOffice3TEUBased10List(e);
            } else if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST11)) {
                eventResponse = searchWeeklySalesByOffice3TEUBased11List(e);
		...
		}  else if (e.getEventName().equalsIgnoreCase("EsmMas0073Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchAdjCostDetail(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0074Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchPlannedExpDetail(e);
			}

		}else if (e.getEventName().equalsIgnoreCase("EsmMas0135Event")) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0078Event")) {			
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0144Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchShipperList(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0147Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchRouteDetail0147List(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0148Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchBKGDetail0148List(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0149Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchCostDetail0149List(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0153Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
			...
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCH01)) {    // RHQ, ECC 조회
    			eventResponse = searchYdToRhq(e);
			} else{
				eventResponse = searchComBoCdList0153(e); 
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0155Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchPreCMRemarkList(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0156Event")) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0163Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
				eventResponse = searchUSInlandCost0163List(e);
			}

		} else if (e.getEventName().equalsIgnoreCase("EsmMas0080Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0081Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0082Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0158Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0178Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
		...
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0192Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)) {
				eventResponse = searchPlAdjustmentTotalList(e);
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST02)) {
				eventResponse = searchPlAdjustmentTradeList(e);
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST03)) {
				eventResponse = searchPlAdjustmentVVDList(e);
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
				eventResponse = searchProfitLossCreationStatus(e);
			} else if (e.getFormCommand().isCommand(FormCommand.SEARCH01)) { //monitoring
				eventResponse = monitorPNLCreation(e);
			} else if (e.getFormCommand().isCommand(FormCommand.MULTI)) {
				eventResponse = createProfitLossAdjustment(e);
			} else { // 초기Load시
				eventResponse = searchComBoCdList0192(e);
			}
		} else if (e.getEventName().equalsIgnoreCase("EsmMas0162Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
				eventResponse = searchRevenueDetailList(e);
			}
			else if (e.getFormCommand().isCommand(FormCommand.INIT)) {
				eventResponse = searchComBoCdList0162(e);
 			}
		}
		return eventResponse;
	...
	private EventResponse searchComBoCdList0035(Event e) throws EventException {
	   	...
	   	EsmMas0035Event event = (EsmMas0035Event)e;
       ...
       try {    
    	   ...
    	   String lgn_ofc_lvl = commonBC.searchOFCLevel(account.getOfc_cd());
    	   List<GetCodeSelectVO> listOfcTpCd = commonBC.getCodeSelectList("ofcTpCd", account.getOfc_cd());
    	   String ofc_tp_cd = "XX";
    	   if(listOfcTpCd.size() > 0) {
    	       ofc_tp_cd = listOfcTpCd.get(0).getOfcTpCd();
    	   }
    	   ...
    	   if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST11)){
    		   ...
    		   /*-------------------------------------------------------*/
		    	...
		    	/*------------------------------------------------*/
		       	...
		       	eventResponse.setETCData("lgn_ofc_lvl", lgn_ofc_lvl);
	...
	/**
	 * ESM_MAS_035: BackEndJob 결과 - Account별 엑셀다운 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	...
	private EventResponse excelDownInqSrcDtAcct0035List(Event e) throws EventException {
		...
		try{
			...
			eventResponse.setCustomData("fileName", "ESM_MAS_0035DL.xls");
	...
	/**
	 * ESM_MAS_035: Type size 별 엑셀다운 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	...
	/**
     * ESM_MAS_0035: Account 엑셀파일 메일 전송 이벤트 처리<br>
     * 
     * @param e Event
     * @return response EventResponse
     * @exception EventException
     */
	private EventResponse sendMailInqSrcDtAcct0035List(Event e) throws EventException {
        GeneralEventResponse eventResponse = new GeneralEventResponse();
        EsmMas0035Event event = (EsmMas0035Event)e;
        SalesRPTBC command = new SalesRPTBCImpl();

        try{
            command.sendMailInqSrcDtListUsingBatch(account, event.getSalesOffiRepoConditionVO(), "1");
            
            eventResponse.setETCData("result", "1");
        }catch(EventException ex){
            log.error("err " + ex.toString(), ex);
            throw new EventException(new ErrorHandler(ex).getMessage());
        }catch(Exception ex){
	...
	/**
     * ESM_MAS_0035: TpSz 엑셀파일 메일 전송 이벤트 처리<br>
     * 
     * @param e Event
     * @return response EventResponse
     * @exception EventException
     */
    private EventResponse sendMailInqSrcDtTpSz0035List(Event e) throws EventException {
        GeneralEventResponse eventResponse = new GeneralEventResponse();
        EsmMas0035Event event = (EsmMas0035Event)e;
        SalesRPTBC command = new SalesRPTBCImpl();

        try{
            command.sendMailInqSrcDtListUsingBatch(account, event.getSalesOffiRepoConditionVO(), "2");
        }catch(EventException ex){
            log.error("err " + ex.toString(), ex);
            throw new EventException(new ErrorHandler(ex).getMessage());
        }catch(Exception ex){
	...
	private EventResponse searchUSInlandCost0163List(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0163Event event = (EsmMas0163Event)e;
	...
	private EventResponse searchBkgRmkList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0170Event event = (EsmMas0170Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
   ...
   private EventResponse searchComBoCdList0057(Event e) throws EventException {
	...
	private EventResponse searchMonthlyAvgUC0057List(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0057Event event = (EsmMas0057Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
   ...
   private EventResponse searchComBoCdList0130(Event e) throws EventException {
	...
	private EventResponse searchReportViewList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0130Event event = (EsmMas0130Event)e;
    ...
    private EventResponse searchInqByCondition060List(Event e) throws EventException {
    	log.debug("11111111111111111111111111 멀티.searchInqByCondition060List() #############  [START]");
        EsmMas0060Event event = (EsmMas0060Event)e;
        GeneralEventResponse eventResponse = new GeneralEventResponse();
        String userId = event.getSignOnUserAccount().getUsr_id();
        try{
        	SalesRPTBC command = new SalesRPTBCImpl();
            event.getSalesRPTCommonVO().setEventName("EsmMas0060Event");
	 ...
	 * @exception EventException
	 */
    private EventResponse searchInqByCondition060ExcelList(Event e) throws EventException {
	   log.debug("############# 멀티.searchInqByCondition060ExcelList() #############  [START]");
       EsmMas0060Event event = (EsmMas0060Event)e;
       GeneralEventResponse eventResponse = new GeneralEventResponse();
       String userId = event.getSignOnUserAccount().getUsr_id();
       try{
    	   SalesRPTBC command = new SalesRPTBCImpl();
           event.getSalesRPTCommonVO().setEventName("EsmMas0060Event");
           DBRowSet rowSet = command.searchInqByCondition060ExcelList(event.getSearchConditionVO(), event.getSalesRPTCommonVO(), userId);
           
           log.debug("===>"+event.getSearchConditionVO().getFHeadernm());
           
           eventResponse.setCustomData("rowset", rowSet);
           eventResponse.setCustomData("columns", event.getSearchConditionVO().getFHeadernm());
           eventResponse.setCustomData("isZip", true);
			
           log.debug("####################### 멀티.searchInqByCondition060ExcelList() #############  [END]");
           return eventResponse;
	...
	private EventResponse excelDownInqByCondition060List(Event e) throws EventException {
		...
		try{
			...
			eventResponse.setCustomData("fileName", "ESM_MAS_0060DL.csv");
			eventResponse.setCustomData("isZip", false);
		} catch(EventException ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler(ex).getMessage());
	    		   ...
	    		   /*-------------------------------------------------------*/
			        ...
			        /*-------------------------------------------------------*/
			       	String array[][] = { 
							 ...
							 {"rptAuth","CD00940|"+ofc_lvl,""},
							 /*3. Profit Level*/
							 {"CD00941","",""},//-- 2012.01.02 SHKIM CODE ADD (CM2) //{"rptAuth","CD00941|"+ofc_lvl,""}, 
							 /*4. Office Level*/
							 {"allOFCLevel",ofc_lvl,""},
							 /*5. Office*/
							 {"office3",ofc_cd+"|"+ofc_lvl+"|"+ofc_lvl+"|" + com.hanjin.framework.component.util.DateTime.getYear() +"|" + Utils.getCurrentMon(),"All"},
...
//							 {"mdmReeferCoreAcct","","All"},
   ...
   private EventResponse searchSetForm059List(Event e) throws EventException {
       EsmMas0059Event event = (EsmMas0059Event)e;
       GeneralEventResponse eventResponse = new GeneralEventResponse();
       try{
    	   SalesRPTBC command = new SalesRPTBCImpl();
   ...
   /**
    ...
    private EventResponse multiSetForm059(Event e) throws EventException {
        ...
        try {
            begin();
            SalesRPTBC command = new SalesRPTBCImpl();
            event.getSalesRPTCommonVO().setEventName("EsmMas0059Event");
            eventResponse = (GeneralEventResponse) command.multiSetForm059(event.getSearchConditionVO(), event.getSalesRPTCommonVO(), event.getSalesRPTCommonVOs(), event.getMasRptItmInfoMstVOs(), event.getMasRptItmInfoDtlVOs(), account);
            commit();
            return eventResponse;
   ...
   private EventResponse searchComBoCdList0061(Event e) throws EventException {
	...
	private EventResponse searchBKG0061List(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0061Event event = (EsmMas0061Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
	...
	private EventResponse searchBKG0061List2(Event e) throws EventException {
		...
		try{
			CommonMasRsVO commonMasRsVO = command.searchBKG0061List2(searchConditionVO);
			commonMasRsVO.setConditionVO(searchConditionVO);
			returnVOList.add(commonMasRsVO);
			eventResponse.setRsVoList(returnVOList);
			eventResponse.setETCData("header", commonMasRsVO.getHeader());
		}catch(EventException ex){
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler(ex).getMessage());
		}catch(Exception ex){
	...
	private EventResponse searchBKG0061List3(Event e) throws EventException {
		...
		try{
			CommonMasRsVO commonMasRsVO = command.searchBKG0061List3(event.getSearchConditionVO());
			returnVOList.add(commonMasRsVO);
			eventResponse.setRsVoList(returnVOList);
		}catch(EventException ex){
			log.error("err " + ex.toString(), ex);
   ...
   private EventResponse searchComBoCdList0062(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0062Event event = (EsmMas0062Event)e;
	   	CommonBC commonBC = new CommonBCImpl();
       try {    
    	   if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST10)){
   ...
   private EventResponse searchComBoCdList0063(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0063Event event = (EsmMas0063Event)e;
	   	CommonBC commonBC = new CommonBCImpl();
       try {    
    	   if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST11)){
	...
	private EventResponse searchMultiDimension0066List(Event e) throws EventException {
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0066Event event = (EsmMas0066Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
   ...
   private EventResponse searchComBoCdList0068(Event e) throws EventException {
	...
	private EventResponse searchMultiDimension0068List(Event e) throws EventException {
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0068Event event = (EsmMas0068Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
   ...
   private EventResponse searchComBoCdList0069(Event e) throws EventException {
	...
	private EventResponse searchMultiDimension0069List(Event e) throws EventException {
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0069Event event = (EsmMas0069Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
   ...
   private EventResponse searchComBoCdList0070(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0070Event event = (EsmMas0070Event)e;
	   	CommonBC commonBC = new CommonBCImpl();
        try {    
   ...
   private EventResponse searchComBoCdList0071(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0071Event event = (EsmMas0071Event)e;
	   	CommonBC commonBC = new CommonBCImpl();
       try {    
    	   SalesOffiRepoConditionVO conVo = event.getSalesOffiRepoConditionVO();
   ...
   private EventResponse searchComBoCdList0072(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0072Event event = (EsmMas0072Event)e;
	   	MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
	   	CommonBC commonBC = new CommonBCImpl();
     ...
     * @exception EventException
     */
    private EventResponse searchWeeklySalesByOffice3TEUBased9List(Event e) throws EventException {
        GeneralEventResponse eventResponse = new GeneralEventResponse();
        EsmMas0072Event event = (EsmMas0072Event)e;
        MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
        RepoPfmcConditionVO conVo = event.getRepoPfmcConditionVO();
        ...
        try {
            list =  command.searchWeeklySalesByOffice3TEUBased9List(conVo);         
            eventResponse.setRsVoList(list);
     ...
     * @exception EventException
     */
    private EventResponse searchWeeklySalesByOffice3TEUBased10List(Event e) throws EventException {
        GeneralEventResponse eventResponse = new GeneralEventResponse();
        EsmMas0072Event event = (EsmMas0072Event)e;
        MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
        RepoPfmcConditionVO conVo = event.getRepoPfmcConditionVO();
        ...
        try {
            list =  command.searchWeeklySalesByOffice3TEUBased10List(conVo);         
            eventResponse.setRsVoList(list);
     ...
     * @exception EventException
     */
    private EventResponse searchWeeklySalesByOffice3TEUBased11List(Event e) throws EventException {
        GeneralEventResponse eventResponse = new GeneralEventResponse();
        EsmMas0072Event event = (EsmMas0072Event)e;
        MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
        RepoPfmcConditionVO conVo = event.getRepoPfmcConditionVO();
        ...
        try {
            list =  command.searchWeeklySalesByOffice3TEUBased11List(conVo);         
            eventResponse.setRsVoList(list);
   ...
   private EventResponse searchComBoCdList0135(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0135Event event = (EsmMas0135Event)e;
	   	CommonBC codeUtil = new CommonBCImpl();
       try {    
	...
	private EventResponse searchDailyBKGView0078List(Event e) throws EventException {
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0078Event event = (EsmMas0078Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
   ...
   private EventResponse searchComBoCdList0078(Event e) throws EventException {
	...
	private EventResponse searchShipperList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0144Event event = (EsmMas0144Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
	...
	private EventResponse searchRouteDetail0147List(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0147Event event = (EsmMas0147Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
	...
	private EventResponse searchBKGDetail0148List(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0148Event event = (EsmMas0148Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
	...
	private EventResponse searchCostDetail0149List(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0149Event event = (EsmMas0149Event)e;
		SalesRPTBC command = new SalesRPTBCImpl();
		List<AbstractValueObject> returnVOList = new ArrayList<AbstractValueObject>();

		try{
			CommonMasRsVO commonMasRsVO = command.searchCostDetail0149List(event.getSearchConditionVO());
			returnVOList.add(commonMasRsVO);
			eventResponse.setRsVoList(returnVOList);
		}catch(EventException ex){
			log.error("err " + ex.toString(), ex);
   ...
   private EventResponse searchComBoCdList0153(Event e) throws EventException {
	...
	/**
	 * 조회 이벤트 처리<br>
	 * ESM_MAS_0153 sheet1 ROUTE 조회 이벤트 처리<br>
	 * 
	 * @param Event e
	 * @return EventResponse
	 * @exception EventException
	...
	private EventResponse searchPreCMSimulationRoutList(Event e) throws EventException {
		...
		try {
			EsmMas0153Event masEvent = (EsmMas0153Event) e;
			SearchCondition0153VO searchCondition0153VO = masEvent.getSearchCondition0153VO();
...
/*			if ( por.equals("CNFOC")) {
			...
			////////////////////////////////////////////////////
			//SpclRevmt는 MAS_COST_ASSIGN_PRECM_PRC에서 CgoTp로 세팅되고 있음.
			...
			// [CHM-201428608] [MAS] PreCM RD 추정 로직 변경
...
//			commonMasRsVO.setDbRowset(command.createPrdCtlgFullRoutForMAS(event0080));
			//prd backend job 
			eventResponse.setETCData("BackEndJobKey", command.startPrdBackEndJob(account, event0080));

//			commonMasRsVO.setEventName("GS");
//			returnVOList.add(commonMasRsVO);
//			eventResponse.setRsVoList(returnVOList);
	...
	private EventResponse createPreCMSimulationCostList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0153Event event = (EsmMas0153Event)e;
		PreCMSimulationBC command = new PreCMSimulationBCImpl();
	...
	/**
	 * 조회 이벤트 처리<br>
	 * ESM_MAS_0153 sheet2 COST 조회 이벤트 처리<br>
	 * 
	 * @param Event e
	 * @return EventResponse
	 * @exception EventException
	...
	private EventResponse searchPreCMSimulationCostList(Event e) throws EventException {
		...
		List<AbstractValueObject> returnVOList = new ArrayList<AbstractValueObject>();
		try{
			CommonMasRsVO commonMasRsVO = command.searchPreCMSimulationCostList(event.getSearchCondition0153VO());
			commonMasRsVO.setConditionVO((Object)(event.getSearchCondition0153VO()));
			commonMasRsVO.setEventName("GS2");
			returnVOList.add(commonMasRsVO);
			eventResponse.setRsVoList(returnVOList);
		}catch(EventException ex){
			log.error("err " + ex.toString(), ex);
    ...
    private EventResponse  searchPrdBackEndJobResult(Event e) throws EventException {
        ...
        try {            
        	...
        	commonMasRsVO.setDbRowset((DBRowSet) backEndJobResult.loadFromFile(key));
	...
	/**
	 * 조회 이벤트 처리<br>
	 * ESM_MAS_0155 비용 RMK 상세 리스트 조회<br>
	 * 
	 * @param Event e
	 * @return EventResponse
	 * @exception EventException
	...
	private EventResponse searchPreCMRemarkList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0155Event event = (EsmMas0155Event)e;
		PreCMSimulationBC command = new PreCMSimulationBCImpl();
   ...
   private EventResponse searchComBoCdList0156(Event e) throws EventException {
	...
	/**
	 * 조회 이벤트 처리<br>
	 * ESM_MAS_156  BKG에 대한 상세정보 리스트 조회<br>
	 * 
	 * @param e
	 * 
	 * @return response EventResponse
	...
	private EventResponse searchListBkgAbcstp0156List(Event e) throws EventException {
		...
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0156Event event = (EsmMas0156Event)e;
   ...
   private EventResponse searchComBoCdList0080(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0080Event event = (EsmMas0080Event)e;
	   	CommonBC codeUtil = new CommonBCImpl();
   ...
   private EventResponse searchComBoCdList0081(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0081Event event = (EsmMas0081Event)e;
	   	CommonBC codeUtil = new CommonBCImpl();
	   	SearchLgstConditionVO conVo = event.getSearchLgstConditionVO();
       try {    
    	   if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST13)){
   ...
   private EventResponse searchComBoCdList0082(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0082Event event = (EsmMas0082Event)e;
	   	CommonBC codeUtil = new CommonBCImpl();
	   	SearchLgstConditionVO conVo = event.getSearchLgstConditionVO();
       try {    
    	   if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST11)){
   ...
   private EventResponse searchComBoCdList0158(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0158Event event = (EsmMas0158Event)e;
	   	CommonBC codeUtil = new CommonBCImpl();
	   	SearchLgstConditionVO conVo = event.getSearchLgstConditionVO();
       try {    
    	   if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST13)){
	...
	private EventResponse searchIasSubCdList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0178Event event = (EsmMas0178Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
	...
	private EventResponse searchProfitLossCreationStatus(Event e) throws EventException {
		...
		try{
			...
			if (e.getEventName().equalsIgnoreCase("EsmMas0192Event")) {
				EsmMas0192Event event = (EsmMas0192Event)e;
				event.getRepoPfmcConditionVO().setFUcCd("PLAD");
				list = command.searchProfitLossCreationStatus(event.getRepoPfmcConditionVO());
			} else {
				EsmMas0072Event event = (EsmMas0072Event)e;
				event.getRepoPfmcConditionVO().setFUcCd("PLRP");
				list = command.searchProfitLossCreationStatus(event.getRepoPfmcConditionVO());
			}
	...
	private EventResponse searchAdjCostDetail(Event e) throws EventException {
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0073Event event = (EsmMas0073Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
	...
	private EventResponse searchPlannedExpDetail(Event e) throws EventException {
		// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0074Event event = (EsmMas0074Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
	...
	private EventResponse monitorPNLCreation(Event e) throws EventException {
		...
		try{
			String strStatus = "";
			if (e.getEventName().equalsIgnoreCase("EsmMas0072Event")) {
				strStatus = command.checkProfitLossCreateBatchStatus("PLRP");
			} else if (e.getEventName().equalsIgnoreCase("EsmMas0192Event")) {
				strStatus = command.checkProfitLossCreateBatchStatus("PLAD");
			}
			//1. 배치가 돌고 있는지 Check 한다
			eventResponse.setETCData("BatchStatus", strStatus);
		} catch (EventException ex){
	 ...
	 * @exception EventException
	 */
   private EventResponse searchComBoCdList0192(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	EsmMas0192Event event = (EsmMas0192Event)e;
	   	MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
	   	CommonBC commonBC = new CommonBCImpl();
       ...
       try {    
    	   if (e.getFormCommand().isCommand(FormCommand.SEARCHLIST11)){
				...
				eventResponse = commonBC.getMakeCodeSelectList(eventResponse,array);
		       	...
		       	StringBuffer headCode1 = new StringBuffer(); //sheet2 가변
		    	StringBuffer headName1 = new StringBuffer();
		    	StringBuffer headCode2 = new StringBuffer(); //sheet3 가변
		    	StringBuffer headName2 = new StringBuffer();
   ...
   /**
	 ...
	 * @exception EventException
	 */
	private EventResponse searchPlAdjustmentTotalList(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0192Event event = (EsmMas0192Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
		RepoPfmcConditionVO conVo = event.getRepoPfmcConditionVO();
		...
		try {
			list =  command.searchPlAdjustmentTotalList(conVo);			
			eventResponse.setRsVoList(list);
	 ...
	 * @exception EventException
	 */
	private EventResponse searchPlAdjustmentTradeList(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0192Event event = (EsmMas0192Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
		RepoPfmcConditionVO conVo = event.getRepoPfmcConditionVO();
		...
		try {
			list =  command.searchPlAdjustmentTradeList(conVo);			
			eventResponse.setRsVoList(list);
	 ...
	 * @exception EventException
	 */
	private EventResponse searchPlAdjustmentVVDList(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0192Event event = (EsmMas0192Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
		RepoPfmcConditionVO conVo = event.getRepoPfmcConditionVO();
		...
		try {
			list =  command.searchPlAdjustmentVVDList(conVo);			
			eventResponse.setRsVoList(list);
	 ...
	 * @exception EventException
	 */
	private EventResponse createProfitLossAdjustment(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0192Event event = (EsmMas0192Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
		try{
			...
			commit();
			// 4. batch를 실행한다.
			strStatus = command.createProfitLossAdjustment(event.getRepoPfmcConditionVO(),account);						
			eventResponse.setETCData("BatchStatus", strStatus);
		} catch(EventException ex) {
			rollback();
			log.error("err " + ex.toString(), ex);
	 ...
	 * @exception EventException
	 */
	private EventResponse searchYdToRhq(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0153Event event = (EsmMas0153Event)e;
		MultiDimensionRPTBC command = new MultiDimensionRPTBCImpl();
		SearchCondition0153VO searchCondition0153VO = event.getSearchCondition0153VO();
		List<SearchCondition0153VO> list = null;
		
		try{
//		    String rtn_yd = event.getSearchCondition0153VO().getFMtyRtnLstCd();
//			String list = command.searchYdToRhq(rtn_yd);
						
			list = command.searchYdToRhq(searchCondition0153VO);
			
			if(list.size() > 0){
				eventResponse.setETCData("mas_rhq", list.get(0).getMasRhq());
				eventResponse.setETCData("mas_ecc", list.get(0).getMasEcc());
				eventResponse.setETCData("mas_rcc", list.get(0).getMasRcc());
			} 
		} catch(EventException ex) {
			rollback();
			log.error("err " + ex.toString(), ex);
	...
	/**
	 * ESM_MAS_0162 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	 */
   private EventResponse searchComBoCdList0162(Event e) throws EventException {
	   	GeneralEventResponse eventResponse = new GeneralEventResponse();
	   	CommonBC codeUtil = new CommonBCImpl();
       try {    
	       	String array[][] = {
   ...
   /**
	 ...
	 * @exception EventException
	 */
	private EventResponse searchRevenueDetailList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0162Event event = (EsmMas0162Event)e;
		PreCMSimulationBC command = new PreCMSimulationBCImpl();
		try{
			List<RevenueDetailVO> list = command.searchRevenueDetailList(event.getRevenueDetailCondVO());
			eventResponse.setRsVoList(list);
		}catch(EventException ex){
           throw ex;
       }catch(Exception ex){
