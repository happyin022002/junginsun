...
*@FileName : RsltGriCalcDestViaListVO.java
*@FileTitle : RsltGriCalcDestViaListVO
*Open Issues :
*Change history :
...
public class RsltGriCalcDestViaListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltGriCalcDestViaListVO> models = new ArrayList<RsltGriCalcDestViaListVO>();
	...
	public RsltGriCalcDestViaListVO() {}

	public RsltGriCalcDestViaListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String orgDestTpCd, String griRoutViaSeq, String routViaPortTpCd, String routViaPortDefCd, String routViaPortDefNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRoutViaPortDefNm(JSPUtil.getParameter(request, prefix + "rout_via_port_def_nm", ""));
	 ...
	 * @param request
	 * @return RsltGriCalcDestViaListVO[]
	 */
	public RsltGriCalcDestViaListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltGriCalcDestViaListVO[]
	 */
	public RsltGriCalcDestViaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltGriCalcDestViaListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltGriCalcDestViaListVO();
				if (updDt[i] != null)
		...
		return getRsltGriCalcDestViaListVOs();
	}
	 ...
	 * @return RsltGriCalcDestViaListVO[]
	 */
	public RsltGriCalcDestViaListVO[] getRsltGriCalcDestViaListVOs(){
		RsltGriCalcDestViaListVO[] vos = (RsltGriCalcDestViaListVO[])models.toArray(new RsltGriCalcDestViaListVO[models.size()]);
		return vos;
	}
