...
*@FileName : SCRateProposalDBDAORsltPriSurchargeAdjustLocationGroupVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriSurchargeAdjustLocationGroupVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriSurchargeAdjustLocationGroupVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriSurchargeAdjustLocationGroupVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_sp_scp_rt_rout_pnt rout_pnt" ).append("\n"); 
		...
		query.append("FROM pri_sp_scp_rt_rout_via rout_via" ).append("\n"); 
		...
		query.append(", pri_sp_scp_grp_loc grp_loc" ).append("\n"); 
