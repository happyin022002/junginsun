...
*@FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtVOUSQL.java
...
public class SCGroupCommodityQuotationDBDAOPriSqGrpCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupCommodityQuotationDBDAOPriSqGrpCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_GRP_CMDT SET" ).append("\n"); 
