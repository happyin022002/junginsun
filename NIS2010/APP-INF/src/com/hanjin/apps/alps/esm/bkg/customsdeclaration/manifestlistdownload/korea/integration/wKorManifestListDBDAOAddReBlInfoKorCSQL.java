...
*@FileName : wKorManifestListDBDAOAddReBlInfoKorCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class wKorManifestListDBDAOAddReBlInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public wKorManifestListDBDAOAddReBlInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : wKorManifestListDBDAOAddReBlInfoKorCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("IB_VSL_CD,IB_SKD_VOY_NO,IB_SKD_DIR_CD, IB_ETA_DT)" ).append("\n"); 
		...
		query.append(", DECODE(@[bkg_cgo_tp], 'P', 'EMPTY', NVL(@[desc1], ' '))" ).append("\n"); 
		query.append(", @[desc2]" ).append("\n"); 
