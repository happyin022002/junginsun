...
*@FileName : PerformanceReportDBDAOSearchProductionRatioDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchProductionRatioDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Production Ratio Report - 상세 목록을 조회한다.
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchProductionRatioDetailRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchProductionRatioDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
