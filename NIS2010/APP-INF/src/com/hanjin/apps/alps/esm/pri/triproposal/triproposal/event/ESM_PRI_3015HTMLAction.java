 ...
 *@FileName : ESM_PRI_3015HTMLAction.java
 *@FileTitle : ESM_PRI_3015HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_3015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_3015HTMLAction 객체를 생성
	 */
	public ESM_PRI_3015HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3015Event event = new EsmPri3015Event();
