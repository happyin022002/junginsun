 ...
 *@FileName : ESM_BKG_0699HTMLAction.java
 *@FileTitle : ESM_BKG_0699HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0699HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0122HTMLAction 객체를 생성
	 */
	public ESM_BKG_0699HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0699Event event = new EsmBkg0699Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setKrWhfExemptInfoCondVO((KrWhfExemptInfoCondVO)getVO( request, KrWhfExemptInfoCondVO.class ));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setBlKrWhfExptVOs( (BlKrWhfExptVO[])getVOs(request, BlKrWhfExptVO.class, "sheet1_") );
			event.setCntrKrWhfExptVOs( (CntrKrWhfExptVO[])getVOs(request, CntrKrWhfExptVO.class, "sheet2_") );
		} 
