...
*@FileName : ACMReportDBDAOAddReportItemListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMReportDBDAOAddReportItemListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMReportDBDAOAddReportItemListCSQL(){
		setQuery();
		...
		params.put("ac_rpt_itm_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ACMReportDBDAOAddReportItemListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
