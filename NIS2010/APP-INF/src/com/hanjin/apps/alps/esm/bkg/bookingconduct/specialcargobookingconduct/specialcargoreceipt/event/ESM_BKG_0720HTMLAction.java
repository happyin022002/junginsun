...
*@FileName : ESM_BKG_0720HTMLAction.java
*@FileTitle : Copy To
*Open Issues :
*Change history :
...
public class ESM_BKG_0720HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0720HTMLAction 객체를 생성
	 */
	public ESM_BKG_0720HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0720Event event = new EsmBkg0720Event();
