...
*@FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddCopyToQuotationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddCopyToQuotationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddCopyToQuotationCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddCopyToQuotationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SQ_GRP_CMDT_DTL (" ).append("\n"); 
