...
public class AGNCommApprovalDBDAOGetAcmCsrCondInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           @[whld_tax_rt]                    AS WHLD_TAX_RT," ).append("\n"); 
		...
		query.append("                             THEN ROUND (SUM (A.PAY_IF_AMT+(A.PAY_IF_AMT*NVL (@[inv_tax_rt],0)/100)+(A.PAY_IF_AMT*NVL (@[whld_tax_rt],0)/100)),0)" ).append("\n"); 
		query.append("                             WHEN A.CURR_CD = 'TWD'" ).append("\n"); 
		query.append("                             THEN ROUND (SUM (A.PAY_IF_AMT+(A.PAY_IF_AMT*NVL (@[inv_tax_rt],0)/100)+(A.PAY_IF_AMT*NVL (@[whld_tax_rt],0)/100)),0)" ).append("\n"); 
		query.append("                             ELSE ROUND (SUM (A.PAY_IF_AMT+(A.PAY_IF_AMT*NVL (@[inv_tax_rt],0)/100)+(A.PAY_IF_AMT*NVL (@[whld_tax_rt],0)/100)),2)" ).append("\n"); 
		query.append("                             END " ).append("\n"); 
		query.append("                            ) AS CSR_AMT_2013" ).append("\n"); 
		query.append("," ).append("\n"); 
		query.append("MAX (" ).append("\n"); 
		query.append("     CASE" ).append("\n"); 
		query.append("     WHEN B.OFF_SET_FLG = 'Y'" ).append("\n"); 
		query.append("     THEN 0" ).append("\n"); 
		query.append("     WHEN A.CURR_CD = 'JPY'" ).append("\n"); 
		query.append("     THEN ROUND (SUM (A.PAY_IF_AMT),0)" ).append("\n"); 
		query.append("     WHEN A.CURR_CD = 'TWD'" ).append("\n"); 
		query.append("     THEN ROUND (SUM (A.PAY_IF_AMT),0)" ).append("\n"); 
		query.append("     ELSE ROUND (SUM (A.PAY_IF_AMT),2)" ).append("\n"); 
		query.append("     END " ).append("\n"); 
		query.append("    ) " ).append("\n"); 
		query.append("+" ).append("\n"); 
		query.append("MAX (" ).append("\n"); 
		...
		query.append("     THEN 0" ).append("\n"); 
		query.append("     WHEN A.CURR_CD = 'JPY'" ).append("\n"); 
		query.append("     THEN ROUND (SUM (A.PAY_IF_AMT*NVL (@[inv_tax_rt],0)/100),0)" ).append("\n"); 
		query.append("     WHEN A.CURR_CD = 'TWD'" ).append("\n"); 
		query.append("     THEN ROUND (SUM (A.PAY_IF_AMT*NVL (@[inv_tax_rt],0)/100),0)" ).append("\n"); 
		query.append("     ELSE ROUND (SUM (A.PAY_IF_AMT*NVL (@[inv_tax_rt],0)/100),2)" ).append("\n"); 
		query.append("     END " ).append("\n"); 
		query.append("    ) " ).append("\n"); 
		query.append("+" ).append("\n"); 
		query.append("MAX (" ).append("\n"); 
		...
		query.append("     THEN 0" ).append("\n"); 
		query.append("     WHEN A.CURR_CD = 'JPY'" ).append("\n"); 
		query.append("     THEN ROUND (SUM (A.PAY_IF_AMT*NVL (@[whld_tax_rt],0)/100),0)" ).append("\n"); 
		query.append("     WHEN A.CURR_CD = 'TWD'" ).append("\n"); 
		query.append("     THEN ROUND (SUM (A.PAY_IF_AMT*NVL (@[whld_tax_rt],0)/100),0)" ).append("\n"); 
		query.append("     ELSE ROUND (SUM (A.PAY_IF_AMT*NVL (@[whld_tax_rt],0)/100),2)" ).append("\n"); 
		query.append("     END " ).append("\n"); 
		...
		query.append("                      -- [CHM-201433385] ACM -> GW 넘길때(CSR) Local문자로 나오는 부분 영문으로 전환요청" ).append("\n"); 
		query.append("                      -- NVL(LTRIM(B.VNDR_LOCL_LANG_NM),B.VNDR_LGL_ENG_NM) AS INV_DESC," ).append("\n"); 
		query.append("                      LTRIM(B.VNDR_LGL_ENG_NM) AS INV_DESC," ).append("\n"); 
