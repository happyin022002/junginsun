...
*@FileName : esm_bkg_0954HTMLAction.java
...
public class ESM_BKG_0954HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * esm_bkg_0954HTMLAction 객체를 생성
	 */
	public ESM_BKG_0954HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0954Event event = new EsmBkg0954Event();
		if(command.isCommand(FormCommand.MODIFY)) {

			String bkgNo     = request.getParameter("bkg_no");
			String rmk       = request.getParameter("h_rmk");

			BkgDoHisVO bkgDoHis = new BkgDoHisVO();

			bkgDoHis.setBkgNo(bkgNo);
			bkgDoHis.setDoCngEvntCd("RR");
			bkgDoHis.setPreCtnt("NO");
			bkgDoHis.setCrntCtnt(rmk);

			event.setBkgDoHis(bkgDoHis);
