...
*@FileName : FeederChargeGuideLineDBDAOAddFDRTariffDurationAmendCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOAddFDRTariffDurationAmendCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add FDR Tariff Duration Amend
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOAddFDRTariffDurationAmendCSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOAddFDRTariffDurationAmendCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRF_FDR_DUR (" ).append("\n"); 
		...
		query.append("         , @[upd_usr_id]" ).append("\n"); 
		query.append("         , SYSDATE" ).append("\n"); 
		query.append("      FROM PRI_TRF_FDR_DUR  " ).append("\n"); 
