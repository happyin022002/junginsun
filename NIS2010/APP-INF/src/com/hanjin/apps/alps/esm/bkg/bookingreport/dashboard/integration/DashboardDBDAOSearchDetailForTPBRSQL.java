...
*@FileName : DashboardDBDAOSearchDetailForTPBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DashboardDBDAOSearchDetailForTPBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * General + TPB Detail 항목을 조회한다.
	  * </pre>
	  */
	public DashboardDBDAOSearchDetailForTPBRSQL(){
		setQuery();
		...
		query.append("FileName : DashboardDBDAOSearchDetailForTPBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  DB.BKG_NO" ).append("\n"); 
		query.append(", SHRP" ).append("\n"); 
		...
		query.append(", ACCR_DT" ).append("\n"); 
		query.append(", G.N3PTY_NO" ).append("\n"); 
		query.append(", CASE WHEN G.OTS_STS_CD IN ('R','T','J') THEN COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD02799', G.OTS_STS_DTL_CD)" ).append("\n"); 
		query.append("       ELSE COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD00588', G.OTS_STS_CD)" ).append("\n"); 
		query.append("   END AS TPB_STS_NM" ).append("\n"); 
		query.append(", G.CURR_CD TPB_CURR_CD" ).append("\n"); 
		query.append(", SUM(DECODE(G.INV_AMT, 0, G.OTS_AMT, G.INV_AMT)) TPB_AMT" ).append("\n"); 
		...
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("  AND DB.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("  AND D.N3PTY_DELT_TP_CD = 'N'" ).append("\n"); 
		query.append("  AND D.N3PTY_NO IS NOT NULL" ).append("\n"); 
		...
		query.append(", ACCR_DT" ).append("\n"); 
		query.append(", G.N3PTY_NO" ).append("\n"); 
		query.append(", OTS_STS_DTL_CD" ).append("\n"); 
		query.append(", OTS_STS_CD" ).append("\n"); 
