...
*@FileName : RFAProposalMainDBDAORsltCreMstRFANoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORsltCreMstRFANoVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Master RFA NO 생성
	  * Office Prefix 3자리 + 연도 2자리 + M (Master) + Sequence 4자리
	  * </pre>
	  */
	public RFAProposalMainDBDAORsltCreMstRFANoVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORsltCreMstRFANoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT SUBSTR(@[ofc_cd],0,3)||SUBSTR(TO_CHAR(SYSDATE,'YYYY'),-2)||'M'" ).append("\n"); 
