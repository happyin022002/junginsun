 ...
 * @since J2EE 1.6
 */
public class SearchAmendmentRevenueDetailListBackEndJob extends BackEndCommandSupport{
	...
	public DBRowSet doStart() throws Exception {
		...
		try {
			...
			rowSet = dbDao.searchAmendmentRevenueDetailList(inPrsAmendmentCmSummaryVO,dateParam.get(0));
