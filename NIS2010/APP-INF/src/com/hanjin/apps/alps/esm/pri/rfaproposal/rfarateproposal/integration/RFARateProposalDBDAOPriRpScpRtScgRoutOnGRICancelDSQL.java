...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgRoutOnGRICancelDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgRoutOnGRICancelDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgRoutOnGRICancelDSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgRoutOnGRICancelDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RP_SCP_RT_SCG_ROUT T" ).append("\n"); 
