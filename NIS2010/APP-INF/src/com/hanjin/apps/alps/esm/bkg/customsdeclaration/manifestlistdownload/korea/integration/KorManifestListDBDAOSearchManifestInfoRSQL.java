...
*@FileName : KorManifestListDBDAOSearchManifestInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchManifestInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchManifestInfoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchManifestInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, TO_CHAR(NVL(D.ACT_WGT,0),'FM00000000.000') ACT_WGT " ).append("\n"); 
		...
		query.append("	  AND DECODE(@[in_bound],'O',DECODE(LENGTH(@[in_pod_tmnl]),7,A.POL_YD_CD,' '),' ') " ).append("\n"); 
		query.append("	  	= DECODE(@[in_bound],'O',DECODE(LENGTH(@[in_pod_tmnl]),7,@[in_pod_tmnl],' '),' ')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if( ${sel_type} == 'T')" ).append("\n"); 
		query.append("	   AND B.BKG_CGO_TP_CD ='P'    " ).append("\n"); 
		query.append("	   AND A.POD_CD <> B.POD_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if( ${sel_type} == 'R')" ).append("\n"); 
		query.append("	   AND B.BKG_CGO_TP_CD <>'P'    " ).append("\n"); 
		query.append("	   AND A.POD_CD <> B.POD_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
