...
public class SCProposalMainDBDAOPriSpScpAmdtSmryVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("${prop_scp_term_tp_cd} == \"61\" || ${prop_scp_term_tp_cd} == \"62\")" ).append("\n"); 
		...
		query.append("AND SRC.ADD_CHG_TP_CD 	= 'A'" ).append("\n"); 
		query.append("AND SRC.ORG_DEST_TP_CD 	= 'D'" ).append("\n"); 
		query.append("#elseif(${prop_scp_term_tp_cd} == \"61\")" ).append("\n"); 
		query.append("AND SRC.ADD_CHG_TP_CD 	= 'I'" ).append("\n"); 
		query.append("AND SRC.ORG_DEST_TP_CD 	= 'O'" ).append("\n"); 
		query.append("#elseif(${prop_scp_term_tp_cd} == \"62\")" ).append("\n"); 
		query.append("AND SRC.ADD_CHG_TP_CD 	= 'I'" ).append("\n"); 
		query.append("AND SRC.ORG_DEST_TP_CD 	= 'D'" ).append("\n"); 
