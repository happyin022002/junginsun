...
public class USDomesticDBDAO extends DBDAOSupport {
	 ...
	 * @throws DAOException
	 */
	public String searchMasMtyEccUtCostCnt(String fCostYrmon) throws DAOException {
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new USDomesticDBDAOSearchMasMtyEccUtCostCntRSQL(), param, velParam);
	...
	/**
	 * ESM_MAS_0014 : CREATE 를 하기 위한 기간 히스토리 생성
	 *
	 * @param SearchUSDomesticVO searchUSDomesticVO
