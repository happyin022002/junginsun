...
*@FileName : SpclSeqForSplitVO.java
*@FileTitle : SpclSeqForSplitVO
*Open Issues :
*Change history :
...
public class SpclSeqForSplitVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpclSeqForSplitVO> models = new ArrayList<SpclSeqForSplitVO>();
	...
	public SpclSeqForSplitVO() {}

	public SpclSeqForSplitVO(String ibflag, String pagerows, String code, String cntrNo, String dcgoSeq) {
		this.ibflag = ibflag;
		this.cntrNo = cntrNo;
	 ...
	 */
	public SpclSeqForSplitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpclSeqForSplitVO[]
	 */
	public SpclSeqForSplitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpclSeqForSplitVO model = null;
	 ...
	 * @return SpclSeqForSplitVO[]
	 */
	public SpclSeqForSplitVO[] getSpclSeqForSplitVOs(){
		SpclSeqForSplitVO[] vos = (SpclSeqForSplitVO[])models.toArray(new SpclSeqForSplitVO[models.size()]);
		return vos;
	}
