...
public class DgSendHistoryVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAutoSndTpCd(JSPUtil.getParameter(request, "auto_snd_tp_cd", ""));
