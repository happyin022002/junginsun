...
*@FileName : BookingMasterMgtDBDAOBkgVgmClzSetVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOBkgVgmClzSetVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VGM CCT Delete 를 위한 Query
	  * </pre>
	  */
	public BookingMasterMgtDBDAOBkgVgmClzSetVODSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOBkgVgmClzSetVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
