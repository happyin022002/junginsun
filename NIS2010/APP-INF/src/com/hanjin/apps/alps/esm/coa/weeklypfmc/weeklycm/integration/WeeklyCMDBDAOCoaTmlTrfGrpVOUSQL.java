...
*@FileName : WeeklyCMDBDAOCoaTmlTrfGrpVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOCoaTmlTrfGrpVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOCoaTmlTrfGrpVOUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOCoaTmlTrfGrpVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_TML_TRF_GRP" ).append("\n"); 
		query.append("SET COA_COST_SRC_CD = @[coa_cost_src_cd]" ).append("\n"); 
		query.append(",TML_TRF_ITM_DESC = @[tml_trf_itm_desc]" ).append("\n"); 
		query.append(",TML_TRF_DTL_DESC = @[tml_trf_dtl_desc]" ).append("\n"); 
		query.append(",TML_UT_CD = @[tml_ut_cd]" ).append("\n"); 
		query.append(",CRE_USR_ID = @[cre_usr_id]" ).append("\n"); 
		query.append(",CRE_DT = SYSDATE" ).append("\n"); 
		query.append(",UPD_USR_ID = @[upd_usr_id]" ).append("\n"); 
		query.append(",UPD_DT = SYSDATE" ).append("\n"); 
		query.append("WHERE TML_CD = @[tml_cd]" ).append("\n"); 
