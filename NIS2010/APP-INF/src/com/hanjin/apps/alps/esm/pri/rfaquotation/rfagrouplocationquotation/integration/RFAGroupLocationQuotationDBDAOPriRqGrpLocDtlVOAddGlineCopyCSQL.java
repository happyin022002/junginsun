...
*@FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOAddGlineCopyCSQL.java
...
public class RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOAddGlineCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOAddGlineCopyCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOAddGlineCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",       @[upd_usr_id]" ).append("\n"); 
		query.append(",       SYSDATE" ).append("\n"); 
		query.append("FROM    PRI_RG_GRP_LOC_DTL" ).append("\n"); 
