...
public class MtyQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyQtyVO> models = new ArrayList<MtyQtyVO>();
	...
	public MtyQtyVO(String ibflag, String pagerows, String cntrTpszCd, String opCntrQty) {
		this.ibflag = ibflag;
	 ...
	 * @return MtyQtyVO[]
	 */
	public MtyQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyQtyVO[]
	 */
	public MtyQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyQtyVO model = null;
	...
	public MtyQtyVO[] getMtyQtyVOs(){
		MtyQtyVO[] vos = (MtyQtyVO[])models.toArray(new MtyQtyVO[models.size()]);
		return vos;
	}
