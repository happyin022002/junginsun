...
*@FileName : ESM_BKG_1181HTMLAction.java
...
public class ESM_BKG_1181HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1181HTMLAction 객체를 생성
	 */
	public ESM_BKG_1181HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1181Event event = new EsmBkg1181Event();

//		if(command.isCommand(FormCommand.SEARCH)) {
//			event.setFumgLocCd(request.getParameter("fumg_loc_cd"));
//		}
