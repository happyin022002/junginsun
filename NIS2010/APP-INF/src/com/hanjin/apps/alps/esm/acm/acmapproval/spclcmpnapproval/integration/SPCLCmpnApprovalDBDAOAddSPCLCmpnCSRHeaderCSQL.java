...
*@FileName : SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRHeaderCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRHeaderCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddSPCLCmpnCSRHeader
	  * </pre>
	  */
	public SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRHeaderCSQL(){
		setQuery();
		...
		query.append("FileName : SPCLCmpnApprovalDBDAOAddSPCLCmpnCSRHeaderCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* AP_INV_HDR INSERT */" ).append("\n"); 
		query.append("INSERT INTO AP_INV_HDR " ).append("\n"); 
		query.append("     (CSR_NO, CSR_TP_CD, INV_DT, INV_TERM_DT, GL_DT, VNDR_NO, CSR_AMT," ).append("\n"); 
		query.append("      PAY_AMT, PAY_DT, CSR_CURR_CD, VNDR_TERM_NM, INV_DESC, ATTR_CATE_NM," ).append("\n"); 
		...
		query.append("      ATTR_CTNT11, ATTR_CTNT12, ATTR_CTNT13, ATTR_CTNT14, ATTR_CTNT15," ).append("\n"); 
		query.append("      GLO_ATTR_CTNT1, GLO_ATTR_CTNT2, GLO_ATTR_CTNT3, GLO_ATTR_CTNT4, GLO_ATTR_CTNT5," ).append("\n"); 
		query.append("      GLO_ATTR_CTNT6, GLO_ATTR_CTNT7, GLO_ATTR_CTNT8, GLO_ATTR_CTNT9, GLO_ATTR_CTNT10," ).append("\n"); 
		query.append("      GLO_ATTR_CTNT11, GLO_ATTR_CTNT12, GLO_ATTR_CTNT13, GLO_ATTR_CTNT14, GLO_ATTR_CTNT15," ).append("\n"); 
		query.append("      GLO_ATTR_CTNT16, GLO_ATTR_CTNT17, GLO_ATTR_CTNT18," ).append("\n"); 
		query.append("      SRC_CTNT, PAY_MZD_LU_CD, PAY_GRP_LU_CD, COA_CO_CD, COA_RGN_CD, COA_CTR_CD," ).append("\n"); 
		query.append("      COA_ACCT_CD, COA_VVD_CD, COA_INTER_CO_CD, COA_FTU_N1ST_CD, COA_FTU_N2ND_CD," ).append("\n"); 
		query.append("      PPD_NO, PPD_DTRB_NO, PPD_APLY_AMT, PPD_GL_DT, APRO_FLG, TAX_DECL_FLG, ERR_CSR_NO," ).append("\n"); 
		query.append("      IF_FLG, IF_DT, IF_ERR_RSN, PPAY_APLY_FLG, TJ_OFC_CD, ACT_XCH_RT, IMP_ERR_FLG," ).append("\n"); 
		query.append("      RCV_ERR_FLG, TAX_CURR_XCH_FLG, USR_EML, IMP_ERR_RSN, RCV_ERR_RSN," ).append("\n"); 
		query.append("      FTU_USE_CTNT1, FTU_USE_CTNT2, FTU_USE_CTNT3, FTU_USE_CTNT4, FTU_USE_CTNT5," ).append("\n"); 
		query.append("      CRE_DT, CRE_USR_ID, EAI_EVNT_DT, AGMT_DOC_CFM_CD, GW_AGMT_DOC_CFM_CD)" ).append("\n"); 
		query.append("VALUES(@[csr_no], @[csr_tp_cd], @[inv_dt], @[inv_term_dt], @[gl_dt], @[vndr_no], @[csr_amt]," ).append("\n"); 
		query.append("    @[pay_amt], @[pay_dt], @[csr_curr_cd], @[vndr_term_nm], @[inv_desc], @[attr_cate_nm]," ).append("\n"); 
		query.append("    @[attr_ctnt1], @[attr_ctnt2], @[attr_ctnt3], @[attr_ctnt4], @[attr_ctnt5]," ).append("\n"); 
		query.append("    @[attr_ctnt6], @[attr_ctnt7], @[attr_ctnt8], @[attr_ctnt9], @[attr_ctnt10]," ).append("\n"); 
		query.append("    @[attr_ctnt11], @[attr_ctnt12], @[attr_ctnt13], @[attr_ctnt14], @[attr_ctnt15]," ).append("\n"); 
		...
		query.append("    @[rcv_err_flg], @[tax_curr_xch_flg], @[usr_eml], @[imp_err_rsn], @[rcv_err_rsn]," ).append("\n"); 
		query.append("    @[ftu_use_ctnt1], @[ftu_use_ctnt2], @[ftu_use_ctnt3], @[ftu_use_ctnt4], @[ftu_use_ctnt5]," ).append("\n"); 
		query.append("    SYSDATE, @[cre_usr_id], SYSDATE, 'Y', '')" ).append("\n"); 
