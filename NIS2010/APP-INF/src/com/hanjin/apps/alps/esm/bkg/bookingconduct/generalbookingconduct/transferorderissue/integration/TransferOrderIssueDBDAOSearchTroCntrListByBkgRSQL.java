...
*@FileName : TransferOrderIssueDBDAOSearchTroCntrListByBkgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOSearchTroCntrListByBkgRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG no 로 Cntr List 를 조회한다.
	  * </pre>
	  */
	public TransferOrderIssueDBDAOSearchTroCntrListByBkgRSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOSearchTroCntrListByBkgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
