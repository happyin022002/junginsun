...
public class SearchSpaceControlLFSummaryListVO extends AbstractValueObject {
	...
	/* Column Info t_ttl_wgt_lf */
	private String tTtlWgtLf = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("t_ttl_wgt_lf", gettTtlWgtLf());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("t_ttl_wgt_lf", "tTtlWgtLf");
...
/**
	 ...
	 * @param tTtlWgtLf
	 */
	public void settTtlWgtLf(String tTtlWgtLf) {
		this.tTtlWgtLf = tTtlWgtLf;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		settTtlWgtLf(JSPUtil.getParameter(request, prefix + "t_ttl_wgt_lf", ""));
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tTtlWgtLf = this.tTtlWgtLf .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
	}
}
