...
*@FileName : ACMSimulationDBDAORemoveAcmSimCommChgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAORemoveAcmSimCommChgDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAORemoveAcmSimCommChgDSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAORemoveAcmSimCommChgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_SIM_COMM_CHG" ).append("\n"); 
