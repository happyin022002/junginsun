...
*@FileName : ESM_PRI_6055HTMLAction.java
...
public class ESM_PRI_6055HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6055HTMLAction 객체를 생성
	 */
	public ESM_PRI_6055HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6055Event event = new EsmPri6055Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInRevenueLaneVO((InRevenueLaneVO)getVO(request, InRevenueLaneVO .class));
		}
