...
*@FileName : QtaAdjustmentDBDAORemoveCfmTgtVvdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAORemoveCfmTgtVvdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [QTA Adjustment by VVD]에서 확정데이터를 [삭제] 합니다
	  * </pre>
	  */
	public QtaAdjustmentDBDAORemoveCfmTgtVvdDSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAORemoveCfmTgtVvdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE SQM_CFM_TGT_VVD" ).append("\n"); 
