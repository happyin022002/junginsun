...
*@FileName : CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestDtlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestDtlRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,BKG_CSTMS_AMER_CNTR    CT" ).append("\n"); 
		query.append("              ,BKG_CSTMS_AMER_CNTR_MF MF" ).append("\n"); 
