...
*@FileName       : ESM_SQM_0030HTMLAction.java
 ...
 * @author SQM USER
 * @see EsmSqm0030Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0030HTMLAction 객체를 생성
	 */
	public ESM_SQM_0030HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0030Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSqm0030Event event = new EsmSqm0030Event();
