...
*@FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOUSQL.java
...
public class GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GRP_CMDT SET" ).append("\n"); 
