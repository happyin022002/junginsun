...
*@FileTitle : <Kor24AutoImfSndDtlVO.java
*@FileTitle : Kor24AutoImfSndDtlVO
*Open Issues :
*Change history :
...
public class Kor24AutoImfSndDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24AutoImfSndDtlVO> models = new ArrayList<Kor24AutoImfSndDtlVO>();
	...
	public Kor24AutoImfSndDtlVO() {}

	public Kor24AutoImfSndDtlVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq, String ediSndMsg) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return Kor24AutoImfSndDtlVO[]
	 */
	public Kor24AutoImfSndDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24AutoImfSndDtlVO[]
	 */
	public Kor24AutoImfSndDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24AutoImfSndDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24AutoImfSndDtlVO();
				if (ofcCd[i] != null)
		...
		return getKor24AutoImfSndDtlVOs();
	}
	 ...
	 * @return Kor24AutoImfSndDtlVO[]
	 */
	public Kor24AutoImfSndDtlVO[] getKor24AutoImfSndDtlVOs(){
		Kor24AutoImfSndDtlVO[] vos = (Kor24AutoImfSndDtlVO[])models.toArray(new Kor24AutoImfSndDtlVO[models.size()]);
		return vos;
	}
