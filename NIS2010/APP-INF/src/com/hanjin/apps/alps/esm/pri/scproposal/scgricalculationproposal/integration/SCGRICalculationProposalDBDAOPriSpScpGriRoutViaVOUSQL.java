...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutViaVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriRoutViaVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriRoutViaVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_GRI_ROUT_VIA SET" ).append("\n"); 
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutViaVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}