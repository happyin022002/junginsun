...
*@FileName : ESM_COA_0178HTMLAction.java
...
public class ESM_COA_0178HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0178HTMLAction 객체를 생성
	 */
	public ESM_COA_0178HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0178Event event = new EsmCoa0178Event();
