...
*@FileName : SearchTariffScopeDupVO.java
*@FileTitle : SearchTariffScopeDupVO
*Open Issues :
*Change history :
...
public class SearchTariffScopeDupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchTariffScopeDupVO> models = new ArrayList<SearchTariffScopeDupVO>();
	...
	public SearchTariffScopeDupVO() {}

	public SearchTariffScopeDupVO(String ibflag, String pagerows, String trfNo, String svcScpCd, String trfPfxCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return SearchTariffScopeDupVO[]
	 */
	public SearchTariffScopeDupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTariffScopeDupVO[]
	 */
	public SearchTariffScopeDupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchTariffScopeDupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchTariffScopeDupVO();
				if (ibflag[i] != null)
		...
		return getSearchTariffScopeDupVOs();
	}
	 ...
	 * @return SearchTariffScopeDupVO[]
	 */
	public SearchTariffScopeDupVO[] getSearchTariffScopeDupVOs(){
		SearchTariffScopeDupVO[] vos = (SearchTariffScopeDupVO[])models.toArray(new SearchTariffScopeDupVO[models.size()]);
		return vos;
	}
