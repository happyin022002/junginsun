...
*@FileName : ESM_BKG_0915HTMLAction.java
...
public class ESM_BKG_0915HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0915HTMLAction 객체를 생성
	 */
	public ESM_BKG_0915HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0915Event event = new EsmBkg0915Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgCstmsTmlCllDgCgoVOS((BkgCstmsTmlCllDgCgoVO[])getVOs(request, BkgCstmsTmlCllDgCgoVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)||command.isCommand(FormCommand.MULTI01)) {
			event.setCllSpclCondVO((CllSpclCondVO)getVO(request, CllSpclCondVO .class));
		}	
