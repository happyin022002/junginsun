...
*@FileName : UserSetupMgtDBDAOTroRmkStupCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAOTroRmkStupCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAOTroRmkStupCSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAOTroRmkStupCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_TRO_STUP (" ).append("\n"); 
