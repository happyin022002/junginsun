...
*@FileName : Kor24ManifestListDBDAOsearchBreakBulkCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchBreakBulkCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchBreakBulkCheckRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchBreakBulkCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
