...
*@FileName : ESM_BSA_0123HTMLAction.java
 ...
 * @see EsmBsa0123Event 참조
 * @since J2EE 1.6
 */
public class ESM_BSA_0123HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_BSA_0123HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBsa0123Event event = new EsmBsa0123Event();
