...
public class NetworkCostDBDAOCreateAverageUCCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                                -- Create Lane Table에서 지정한 OP4 단가 생성 대상 노선들 (Lane Avg U/C) 의 / Create시 지정한 WK 에 해당하는 SML Sales Cht/Out의 모든 Data를 긁어온다." ).append("\n"); 
		query.append("                                                -- 단, Final SML BSA가 0인 VVD는 대상에서 제외한다. 비용이 들어있어도 제외한다. 그랬을 시 아래와 같은 모양새의  Data 확보 완료." ).append("\n"); 
		...
		query.append("                              , MAS_LANE_VSL_TP_FREQ B" ).append("\n"); 
