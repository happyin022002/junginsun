...
*@FileName : TRIProposalDBDAOPriTriRtScgCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_TRI_RT_SCG A" ).append("\n"); 
