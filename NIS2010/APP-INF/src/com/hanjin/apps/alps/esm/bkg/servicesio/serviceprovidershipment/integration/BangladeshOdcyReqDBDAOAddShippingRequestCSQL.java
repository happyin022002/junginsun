...
*@FileName : BangladeshOdcyReqDBDAOAddShippingRequestCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BangladeshOdcyReqDBDAOAddShippingRequestCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BangladeshOdcyReqDBDAOAddShippingRequestCSQL(){
		setQuery();
		...
		query.append("FileName : BangladeshOdcyReqDBDAOAddShippingRequestCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  @[bkg_no]" ).append("\n"); 
		query.append(" ,@[cntr_no]" ).append("\n"); 
		query.append(" ,(SELECT NVL(MAX(CNTR_SEQ) +1, 1) FROM BKG_CUST_SHP_RQST WHERE BKG_NO = @[bkg_no] AND CNTR_NO = @[cntr_no])" ).append("\n"); 
		query.append(" ,@[cntr_tpsz_cd]" ).append("\n"); 
		query.append(" ,@[cntr_seal_no]" ).append("\n"); 
		query.append(" ,@[pck_qty]" ).append("\n"); 
		query.append(" ,@[pck_tp_cd]" ).append("\n"); 
