...
*@FileName : USDomesticDBDAOAddEQOffhireCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USDomesticDBDAOAddEQOffhireCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public USDomesticDBDAOAddEQOffhireCSQL(){
		setQuery();
		...
		query.append("FileName : USDomesticDBDAOAddEQOffhireCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- EQ OFF HIRE" ).append("\n"); 
		...
		query.append("                      , COUNT(A.CNTR_NO) AS EQ_OFFH_QTY" ).append("\n"); 
		...
		query.append("                    AND C.CNTR_LSTM_CNG_FLG                     = 'N' -- TERM_CHANGE" ).append("\n"); 
		...
		query.append("                    AND C.CNTR_STS_EVNT_DT BETWEEN TO_DATE (REPLACE(@[f_cre_start_dt], '-', '' )||'01', 'rrrrmmdd')" ).append("\n"); 
		...
		query.append("         SET A1.EQ_OFFH_QTY     = B1.EQ_OFFH_QTY" ).append("\n"); 
		...
		query.append("        , A1.EQ_OFFH_QTY" ).append("\n"); 
		...
		query.append("        , B1.EQ_OFFH_QTY" ).append("\n"); 
