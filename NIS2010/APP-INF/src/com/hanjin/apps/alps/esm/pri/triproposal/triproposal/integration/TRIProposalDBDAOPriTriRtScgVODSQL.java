...
*@FileName : TRIProposalDBDAOPriTriRtScgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_SCG Delete
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_SCG" ).append("\n"); 
