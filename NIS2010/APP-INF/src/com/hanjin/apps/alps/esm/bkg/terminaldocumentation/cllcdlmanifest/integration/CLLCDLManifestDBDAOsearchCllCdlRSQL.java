...
public class CLLCDLManifestDBDAOsearchCllCdlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2017.08.09 이인영 O.BL Serial Number 추가
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("	(SELECT WM_CONCAT(TO_CLOB(P.OBL_INTER_SER_NO)) FROM BKG_INET_BL_PRN_AUTH P, BKG_BOOKING B WHERE P.BKG_NO = TB1.BKG_NO AND P.BKG_NO = B.BKG_NO AND (B.Bl_TP_CD IS NULL OR B.Bl_TP_CD <> 'W') AND P.DELT_FLG = 'N') OBL_SER_NO," ).append("\n"); 
		...
		query.append("	TO_CHAR(VGM_WGT,'9,999,999.000') VGM_WGT," ).append("\n"); 
		...
		query.append("		MAX(ROUND(CNTR.CNTR_WGT/1000,0))  CNTR_WGT," ).append("\n"); 
		query.append("		MAX(DOC.ACT_WGT) ACT_WGT," ).append("\n"); 
		query.append("		MAX(CNTR.PCK_QTY) PCK_QTY," ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	#if (${in_list_type} == 'L' ) " ).append("\n"); 
		query.append("		MAX(REPLACE(TRANSLATE(NVL(BCS.CUST_NM,' '),CHR(13)||CHR(10),' '),'''',' '))  CUST_NM," ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		query.append("		MAX(DECODE(BKG.CUST_TO_ORD_FLG,'Y',REPLACE(TRANSLATE(NVL(BCN.CUST_NM,' '),CHR(13)||CHR(10),' '),'''',' ')," ).append("\n"); 
		query.append("				  REPLACE(TRANSLATE(NVL(BCC.CUST_NM,' '),CHR(13)||CHR(10),' '),'''',' '))) CUST_NM," ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		...
		query.append("	MAX(CNTR.CNTR_VOL_QTY) CNTR_VOL_QTY," ).append("\n"); 
		...
		query.append("	MAX(CNTR.MEAS_QTY*1000)  MEAS_QTY," ).append("\n"); 
		query.append("	MAX(BKG.PRCT_FLG) PRCT_FLG," ).append("\n"); 
		query.append("	MAX(CNTR.DCGO_FLG) DCGO_FLG," ).append("\n"); 
		query.append("    MAX(CNTR.BB_CGO_FLG) BB_CGO_FLG," ).append("\n"); 
		...
		query.append("	MAX(DECODE(NVL(CNTR.VGM_WGT_UT_CD, 0), 'LBS', NVL(CNTR.VGM_WGT, 0)*0.4536, NVL(CNTR.VGM_WGT, 0))) VGM_WGT," ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	#if (${in_list_type} == 'L' ) " ).append("\n"); 
		query.append("		REPLACE(TRANSLATE(NVL(BCS.CUST_NM,' '),CHR(13)||CHR(10),' '),'''',' ') CUST_NM," ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		query.append("		DECODE(BKG.CUST_TO_ORD_FLG,'Y',REPLACE(TRANSLATE(NVL(BCN.CUST_NM,' '),CHR(13)||CHR(10),' '),'''',' ')," ).append("\n"); 
		query.append("				  REPLACE(TRANSLATE(NVL(MAX(BCC.CUST_NM),' '),CHR(13)||CHR(10),' '),'''',' ')) CUST_NM," ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		...
		query.append("	MAX(CNTR.CNTR_WGT)  A_CNTR_WGT," ).append("\n"); 
		query.append("	MAX(DECODE(NVL(CNTR.VGM_WGT_UT_CD, 0), 'LBS', ROUND (NVL(CNTR.VGM_WGT, 0)*0.4536, 3), NVL(CNTR.VGM_WGT, 0))) VGM_WGT," ).append("\n"); 
		query.append("	'KGS' VGM_WGT_UT_CD," ).append("\n"); 
		query.append("	#if (${in_list_type} == 'L' ) " ).append("\n"); 
		...
		query.append("	, MAX(RF.CBM_PER_HR_QTY||DECODE(RF.CNTR_VENT_TP_CD, 'C', ' CMH', 'P', ' % Open', '')) AS VENT" ).append("\n"); 
		query.append("	, MAX(CNTR.VGM_VRFY_SIG_CTNT ) AS VGM_VRFY_SIG_CTNT" ).append("\n"); 
		query.append("	, MAX(CNTR.VGM_MZD_TP_CD) AS VGM_MZD_TP_CD" ).append("\n"); 
		query.append("	FROM	" ).append("\n"); 
		...
		query.append("			AND NVL(VVD.POL_CLPT_IND_SEQ,'1') = @[pol_split_no]" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		...
		query.append("		#end" ).append("\n"); 
		query.append("		#if (${pod_split_no} != '')" ).append("\n"); 
		query.append("			AND NVL(VVD.POD_CLPT_IND_SEQ,'1') = @[pod_split_no]" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		...
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	#if (${in_bkg_aloc_sts_cd} == 'S' )" ).append("\n"); 
		query.append("			AND BKG.ALOC_STS_CD = 'S'" ).append("\n"); 
		query.append("	#elseif	" ).append("\n"); 
		query.append("		(${in_bkg_aloc_sts_cd} == 'F' )" ).append("\n"); 
		query.append("			AND BKG.ALOC_STS_CD = 'F'" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		...
		query.append("		AND BKG.POR_CD = @[in_por_cd]" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	#if (${in_del_cd} != '' ) " ).append("\n"); 
		query.append("		AND BKG.DEL_CD = @[in_del_cd]" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		...
		query.append("	#else" ).append("\n"); 
		query.append("		GROUP BY TEMP.VVD_CD, CNTR.CNTR_NO, CNTR.CNTR_TPSZ_CD, CNTR.CNTR_WGT, DOC.ACT_WGT, CNTR.PCK_QTY, BKG.BKG_NO, BKG.BL_NO||BKG.BL_TP_CD, " ).append("\n"); 
		...
		query.append("		#end" ).append("\n"); 
		query.append("			CNTR.SOC_FLG, BKG.STWG_CD, CM.HAMO_TRF_CD, CM.CMDT_HS_CD, CNTR.CNTR_VOL_QTY, CNTR.CNTR_TPSZ_CD, " ).append("\n"); 
		...
		query.append("			VVD.POL_YD_CD, VVD.POD_CD, VVD.POD_YD_CD, CNTR.MEAS_QTY, BKG.PRCT_FLG, CNTR.DCGO_FLG,CNTR.BB_CGO_FLG, CNTR.RC_FLG, CNTR.AWK_CGO_FLG, CNTR.HNGR_FLG," ).append("\n"); 
		query.append("		#if (${in_list_type} == 'L' ) " ).append("\n"); 
		query.append("			ORG_YD_CD, CNMV_EVNT_DT" ).append("\n"); 
		query.append("		#else" ).append("\n"); 
		query.append("			DEST_YD_CD, ORG_YD_CD, CNMV_EVNT_DT" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
