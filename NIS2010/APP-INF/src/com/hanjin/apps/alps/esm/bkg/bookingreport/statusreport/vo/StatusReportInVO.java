...
public class StatusReportInVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String alocStsCdS = null;

    /* Column Info */
    private String rateCheck = null;

    /* Column Info */
    private String zoneCd = null;

    /* Column Info */
    private String nonRdStsF = null;
    ...
    /* Column Info */
    private String alocStsCdF = null;

    /* Column Info */
    private String spCargoGe = null;

    /* Column Info */
    private String masterRfaNo = null;
    ...
    /* Column Info */
    private String ctrtCngTpCd = null;

    /* Column Info */
    private String spVehicle = null;
    ...
    /* Column Info */
    private String spotGuideRfaNo = null;
    ...
    /* Column Info */
    private String mtyRtnEcc = null;

    /* Column Info */
    private String rTerm = null;

    /* Column Info */
    private String basicRfaNo = null;
    ...
    public StatusReportInVO(String ibflag, String pagerows, String agentCdAll, String nonRev, String lTeamCd, String holding, String spCargoHd, String spCargoHg, String spCargoPc, String rowsPerPage, String vvdCd, String fvVvdCd, String fvPolCd, String fvPodYardCd, String bOfcCdSub, String custCntCd, String spCargoPm, String bOfcCd, String bkgKind, String nonRdStsR, String orderbyTitleSql, String boardFromDt, String alocStsCdS, String rateCheck, String nonRdStsF, String zoneCd, String alocStsCdF, String boardToDt, String pGridType, String masterRfaNo, String spCargoGe, String sModeOri, String rtroKndCd, String podCd, String spCargoFg, String podTs, String bStaffId, String stopCargo, String caedY, String caedN, String spCargoFu, String laneCd, String rev, String roN, String custNm, String crnNoFlag, String sRouteDest, String spCargoRb, String wgtFrom, String roY, String spCargoRf, String cmdtCd, String spCargoRd, String polLocal, String bkgToDt, String cRepId, String ctrRfaNo, String dirCd, String cOfcCdSub, String deliMode, String lOfcCdSub, String certiChecks, String rdYn, String ctrtCngTpCd, String spVehicle, String orderbySelect, String spCargoSoc, String pBkgRptKndCd, String spotGuideRfaNo, String etaToDt, String fvPolLocal, String fvPodCd, String podLocal, String lRepId, String lastOrderby, String mtyRtnEcc, String rTerm, String basicRfaNo, String certiG, String sModeDest, String certiN, String fvPolYardCd, String certiY, String polCd, String currPage, String polYardCd, String spCargoLi, String bkgStsCdW, String dTerm, String bkgStsCdX, String webStsCdM, String soNo, String spCargoBb, String podYardCd, String delCd, String ctrRfaCd, String lOfcCd, String bkgStsCdI, String cargoTpF, String bkgStsCdF, String webStsCdA, String fvPrePstCd, String bkgStsCdA, String trunkFlag, String sRouteOri, String spCargoAk, String certiC, String cOfcCd, String certiD, String agentCd, String cargoTpR, String orderby, String certiA, String cargoTpP, String etaFromDt, String certiB, String nonSpCargo, String fvPodLocal, String porCd, String wgtTo, String blTypeS, String pReportType, String aesY, String blCerti, String spCargoEq, String custTpCd, String rctRhqCd, String orderbyTitle, String custTpCdS, String polTs, String caFlag, String custTpCdN, String webUpdSts, String custTpCdF, String custTpCdG, String custSeq, String custTpCdC, String eqType, String cmdtNm, String custTpCdA, String blTypeA, String bkgFromDt, String aesN, String spCargoDg, String nonDgChemFlg, String blckStwgCd, String usrOfcCd, String canOfcCd) {
        this.agentCdAll = agentCdAll;
        this.nonRev = nonRev;
        this.holding = holding;
        this.lTeamCd = lTeamCd;
        ...
        this.nonRdStsR = nonRdStsR;
        this.orderbyTitleSql = orderbyTitleSql;
        this.boardFromDt = boardFromDt;
        this.alocStsCdS = alocStsCdS;
        this.rateCheck = rateCheck;
        this.zoneCd = zoneCd;
        this.nonRdStsF = nonRdStsF;
        this.pGridType = pGridType;
        this.boardToDt = boardToDt;
        this.alocStsCdF = alocStsCdF;
        this.spCargoGe = spCargoGe;
        this.masterRfaNo = masterRfaNo;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("l_team_cd", getLTeamCd());
        ...
        this.hashColumns.put("non_rd_sts_r", getNonRdStsR());
        this.hashColumns.put("orderby_title_sql", getOrderbyTitleSql());
        this.hashColumns.put("board_from_dt", getBoardFromDt());
        this.hashColumns.put("aloc_sts_cd_s", getAlocStsCdS());
        this.hashColumns.put("rate_check", getRateCheck());
        this.hashColumns.put("zone_cd", getZoneCd());
        this.hashColumns.put("non_rd_sts_f", getNonRdStsF());
        this.hashColumns.put("p_grid_type", getPGridType());
        this.hashColumns.put("board_to_dt", getBoardToDt());
        this.hashColumns.put("aloc_sts_cd_f", getAlocStsCdF());
        this.hashColumns.put("sp_cargo_ge", getSpCargoGe());
        this.hashColumns.put("master_rfa_no", getMasterRfaNo());
        ...
        this.hashColumns.put("sp_cargo_fu", getSpCargoFu());
        ...
        this.hashColumns.put("ctrt_cng_tp_cd", getCtrtCngTpCd());
        this.hashColumns.put("sp_vehicle", getSpVehicle());
        ...
        this.hashColumns.put("spot_guide_rfa_no", getSpotGuideRfaNo());
        ...
        this.hashColumns.put("mty_rtn_ecc", getMtyRtnEcc());
        this.hashColumns.put("r_term", getRTerm());
        this.hashColumns.put("basic_rfa_no", getBasicRfaNo());
        ...
        this.hashColumns.put("sp_cargo_li", getSpCargoLi());
        ...
        this.hashColumns.put("web_sts_cd_m", getWebStsCdM());
        ...
        this.hashColumns.put("bkg_sts_cd_i", getBkgStsCdI());
        ...
        this.hashColumns.put("web_sts_cd_a", getWebStsCdA());
        ...
        this.hashColumns.put("bl_certi", getBlCerti());
        ...
        this.hashColumns.put("web_upd_sts", getWebUpdSts());
        ...
        this.hashColumns.put("can_ofc_cd", getCanOfcCd());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("l_team_cd", "lTeamCd");
        ...
        this.hashFields.put("non_rd_sts_r", "nonRdStsR");
        this.hashFields.put("orderby_title_sql", "orderbyTitleSql");
        this.hashFields.put("board_from_dt", "boardFromDt");
        this.hashFields.put("aloc_sts_cd_s", "alocStsCdS");
        this.hashFields.put("rate_check", "rateCheck");
        this.hashFields.put("zone_cd", "zoneCd");
        this.hashFields.put("non_rd_sts_f", "nonRdStsF");
        this.hashFields.put("p_grid_type", "pGridType");
        this.hashFields.put("board_to_dt", "boardToDt");
        this.hashFields.put("aloc_sts_cd_f", "alocStsCdF");
        this.hashFields.put("sp_cargo_ge", "spCargoGe");
        this.hashFields.put("master_rfa_no", "masterRfaNo");
        ...
        this.hashFields.put("sp_cargo_fu", "spCargoFu");
        ...
        this.hashFields.put("ctrt_cng_tp_cd", "ctrtCngTpCd");
        this.hashFields.put("sp_vehicle", "spVehicle");
        ...
        this.hashFields.put("spot_guide_rfa_no", "spotGuideRfaNo");
        ...
        this.hashFields.put("mty_rtn_ecc", "mtyRtnEcc");
        this.hashFields.put("r_term", "rTerm");
        this.hashFields.put("basic_rfa_no", "basicRfaNo");
        ...
        this.hashFields.put("sp_cargo_li", "spCargoLi");
        ...
        this.hashFields.put("web_sts_cd_m", "webStsCdM");
        ...
        this.hashFields.put("bkg_sts_cd_i", "bkgStsCdI");
        ...
        this.hashFields.put("web_sts_cd_a", "webStsCdA");
        ...
        this.hashFields.put("bl_certi", "blCerti");
        ...
        this.hashFields.put("web_upd_sts", "webUpdSts");
        ...
        this.hashFields.put("can_ofc_cd", "canOfcCd");
	 ...
	 * @return nonRdStsR
	 */
    public String getNonRdStsR() {
        return this.nonRdStsR;
    }
	 ...
	 * @return alocStsCdS
	 */
    public String getAlocStsCdS() {
        return this.alocStsCdS;
    }
	 ...
	 * @return nonRdStsF
	 */
    public String getNonRdStsF() {
        return this.nonRdStsF;
    }
	 ...
	 * @return alocStsCdF
	 */
    public String getAlocStsCdF() {
        return this.alocStsCdF;
    }
	 ...
	 * @return spCargoGe
	 */
    public String getSpCargoGe() {
        return this.spCargoGe;
    }
	 ...
	 * @return masterRfaNo
	 */
    public String getMasterRfaNo() {
        return this.masterRfaNo;
    }
	 ...
	 * @return spCargoFu
	 */
    public String getSpCargoFu() {
        return this.spCargoFu;
    }
	 ...
	 * @return ctrtCngTpCd
	 */
    public String getCtrtCngTpCd() {
        return this.ctrtCngTpCd;
    }
	 ...
	 * @return spVehicle
	 */
    public String getSpVehicle() {
        return this.spVehicle;
    }
    ...
    /**
	 * Column Info
	 * @return spotGuideRfaNo
	 */
    public String getSpotGuideRfaNo() {
        return this.spotGuideRfaNo;
    }
	 ...
	 * @return basicRfaNo
	 */
    public String getBasicRfaNo() {
        return this.basicRfaNo;
    }
	 ...
	 * @return spCargoLi
	 */
    public String getSpCargoLi() {
        return this.spCargoLi;
    }
	 ...
	 * @return webStsCdM
	 */
    public String getWebStsCdM() {
        return this.webStsCdM;
    }
	 ...
	 * @return bkgStsCdI
	 */
    public String getBkgStsCdI() {
        return this.bkgStsCdI;
    }
	 ...
	 * @return webStsCdA
	 */
    public String getWebStsCdA() {
        return this.webStsCdA;
    }
	 ...
	 * @return webUpdSts
	 */
    public String getWebUpdSts() {
        return this.webUpdSts;
    }
	 ...
	 * @param lTeamCd
	 */
    public void setLTeamCd(String lTeamCd) {
        this.lTeamCd = lTeamCd;
    }
	 ...
	 * @param nonRdStsR
	 */
    public void setNonRdStsR(String nonRdStsR) {
        this.nonRdStsR = nonRdStsR;
    }
	 ...
	 * @param alocStsCdS
	 */
    public void setAlocStsCdS(String alocStsCdS) {
        this.alocStsCdS = alocStsCdS;
    }
	 ...
	 * @param nonRdStsF
	 */
    public void setNonRdStsF(String nonRdStsF) {
        this.nonRdStsF = nonRdStsF;
    }
	 ...
	 * @param alocStsCdF
	 */
    public void setAlocStsCdF(String alocStsCdF) {
        this.alocStsCdF = alocStsCdF;
    }
	 ...
	 * @param spCargoGe
	 */
    public void setSpCargoGe(String spCargoGe) {
        this.spCargoGe = spCargoGe;
    }
	 ...
	 * @param masterRfaNo
	 */
    public void setMasterRfaNo(String masterRfaNo) {
        this.masterRfaNo = masterRfaNo;
    }
	 ...
	 * @param spCargoFu
	 */
    public void setSpCargoFu(String spCargoFu) {
        this.spCargoFu = spCargoFu;
    }
	 ...
	 * @param ctrtCngTpCd
	 */
    public void setCtrtCngTpCd(String ctrtCngTpCd) {
        this.ctrtCngTpCd = ctrtCngTpCd;
    }
	 ...
	 * @param spVehicle
	 */
    public void setSpVehicle(String spVehicle) {
        this.spVehicle = spVehicle;
    }
    ...
    /**
	 * Column Info
	 * @param spotGuideRfaNo
	 */
    public void setSpotGuideRfaNo(String spotGuideRfaNo) {
        this.spotGuideRfaNo = spotGuideRfaNo;
    }
	 ...
	 * @param basicRfaNo
	 */
    public void setBasicRfaNo(String basicRfaNo) {
        this.basicRfaNo = basicRfaNo;
    }
	 ...
	 * @param spCargoLi
	 */
    public void setSpCargoLi(String spCargoLi) {
        this.spCargoLi = spCargoLi;
    }
	 ...
	 * @param webStsCdM
	 */
    public void setWebStsCdM(String webStsCdM) {
        this.webStsCdM = webStsCdM;
    }
	 ...
	 * @param bkgStsCdI
	 */
    public void setBkgStsCdI(String bkgStsCdI) {
        this.bkgStsCdI = bkgStsCdI;
    }
	 ...
	 * @param webStsCdA
	 */
    public void setWebStsCdA(String webStsCdA) {
        this.webStsCdA = webStsCdA;
    }
	 ...
	 * @param blCerti
	 */
    public void setBlCerti(String blCerti) {
        this.blCerti = blCerti;
    }
	 ...
	 * @param webUpdSts
	 */
    public void setWebUpdSts(String webUpdSts) {
        this.webUpdSts = webUpdSts;
    }
    ...
    public void setCanOfcCd(String canOfcCd) {
        this.canOfcCd = canOfcCd;
    }

    public String getCanOfcCd() {
        return this.canOfcCd;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        setAgentCdAll(JSPUtil.getParameter(request, prefix + "agent_cd_all", ""));
        setNonRev(JSPUtil.getParameter(request, prefix + "non_rev", ""));
        setHolding(JSPUtil.getParameter(request, prefix + "holding", ""));
        setLTeamCd(JSPUtil.getParameter(request, prefix + "l_team_cd", ""));
        setSpCargoHd(JSPUtil.getParameter(request, prefix + "sp_cargo_hd", ""));
        setSpCargoHg(JSPUtil.getParameter(request, prefix + "sp_cargo_hg", ""));
        setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
        setSpCargoPc(JSPUtil.getParameter(request, prefix + "sp_cargo_pc", ""));
        setRowsPerPage(JSPUtil.getParameter(request, prefix + "rows_per_page", ""));
        setVvdCd(JSPUtil.getParameter(request, prefix + "vvd_cd", ""));
        setFvVvdCd(JSPUtil.getParameter(request, prefix + "fv_vvd_cd", ""));
        setFvPolCd(JSPUtil.getParameter(request, prefix + "fv_pol_cd", ""));
        setFvPodYardCd(JSPUtil.getParameter(request, prefix + "fv_pod_yard_cd", ""));
        setBOfcCdSub(JSPUtil.getParameter(request, prefix + "b_ofc_cd_sub", ""));
        setCustCntCd(JSPUtil.getParameter(request, prefix + "cust_cnt_cd", ""));
        setSpCargoPm(JSPUtil.getParameter(request, prefix + "sp_cargo_pm", ""));
        setBOfcCd(JSPUtil.getParameter(request, prefix + "b_ofc_cd", ""));
        setBkgKind(JSPUtil.getParameter(request, prefix + "bkg_kind", ""));
        setNonRdStsR(JSPUtil.getParameter(request, prefix + "non_rd_sts_r", ""));
        ...
        setAlocStsCdS(JSPUtil.getParameter(request, prefix + "aloc_sts_cd_s", ""));
        setRateCheck(JSPUtil.getParameter(request, prefix + "rate_check", ""));
        setZoneCd(JSPUtil.getParameter(request, prefix + "zone_cd", ""));
        setNonRdStsF(JSPUtil.getParameter(request, prefix + "non_rd_sts_f", ""));
        setPGridType(JSPUtil.getParameter(request, prefix + "p_grid_type", ""));
        setBoardToDt(JSPUtil.getParameter(request, prefix + "board_to_dt", ""));
        setAlocStsCdF(JSPUtil.getParameter(request, prefix + "aloc_sts_cd_f", ""));
        setSpCargoGe(JSPUtil.getParameter(request, prefix + "sp_cargo_ge", ""));
        setMasterRfaNo(JSPUtil.getParameter(request, prefix + "master_rfa_no", ""));
        setSModeOri(JSPUtil.getParameter(request, prefix + "s_mode_ori", ""));
        setPodCd(JSPUtil.getParameter(request, prefix + "pod_cd", ""));
        setRtroKndCd(JSPUtil.getParameter(request, prefix + "rtro_knd_cd", ""));
        setSpCargoFg(JSPUtil.getParameter(request, prefix + "sp_cargo_fg", ""));
        ...
        setSpCargoFu(JSPUtil.getParameter(request, prefix + "sp_cargo_fu", ""));
        setLaneCd(JSPUtil.getParameter(request, prefix + "lane_cd", ""));
        setRev(JSPUtil.getParameter(request, prefix + "rev", ""));
        setRoN(JSPUtil.getParameter(request, prefix + "ro_n", ""));
        setCustNm(JSPUtil.getParameter(request, prefix + "cust_nm", ""));
        setCrnNoFlag(JSPUtil.getParameter(request, prefix + "crn_no_flag", ""));
        setSRouteDest(JSPUtil.getParameter(request, prefix + "s_route_dest", ""));
        setSpCargoRb(JSPUtil.getParameter(request, prefix + "sp_cargo_rb", ""));
        setWgtFrom(JSPUtil.getParameter(request, prefix + "wgt_from", ""));
        setRoY(JSPUtil.getParameter(request, prefix + "ro_y", ""));
        ...
        setCRepId(JSPUtil.getParameter(request, prefix + "c_rep_id", ""));
        ...
        setDeliMode(JSPUtil.getParameter(request, prefix + "deli_mode", ""));
        setLOfcCdSub(JSPUtil.getParameter(request, prefix + "l_ofc_cd_sub", ""));
        setCertiChecks(JSPUtil.getParameter(request, prefix + "certi_checks", ""));
        setRdYn(JSPUtil.getParameter(request, prefix + "rd_yn", ""));
        setCtrtCngTpCd(JSPUtil.getParameter(request, prefix + "ctrt_cng_tp_cd", ""));
        setSpVehicle(JSPUtil.getParameter(request, prefix + "sp_vehicle", ""));
        setOrderbySelect(JSPUtil.getParameter(request, prefix + "orderby_select", ""));
        setSpCargoSoc(JSPUtil.getParameter(request, prefix + "sp_cargo_soc", ""));
        setPBkgRptKndCd(JSPUtil.getParameter(request, prefix + "p_bkg_rpt_knd_cd", ""));
        setSpotGuideRfaNo(JSPUtil.getParameter(request, prefix + "spot_guide_rfa_no", ""));
        setEtaToDt(JSPUtil.getParameter(request, prefix + "eta_to_dt", ""));
        setFvPolLocal(JSPUtil.getParameter(request, prefix + "fv_pol_local", ""));
        setFvPodCd(JSPUtil.getParameter(request, prefix + "fv_pod_cd", ""));
        setPodLocal(JSPUtil.getParameter(request, prefix + "pod_local", ""));
        setLRepId(JSPUtil.getParameter(request, prefix + "l_rep_id", ""));
        setLastOrderby(JSPUtil.getParameter(request, prefix + "last_orderby", ""));
        setMtyRtnEcc(JSPUtil.getParameter(request, prefix + "mty_rtn_ecc", ""));
        setRTerm(JSPUtil.getParameter(request, prefix + "r_term", ""));
        setBasicRfaNo(JSPUtil.getParameter(request, prefix + "basic_rfa_no", ""));
        setCertiG(JSPUtil.getParameter(request, prefix + "certi_g", ""));
        setSModeDest(JSPUtil.getParameter(request, prefix + "s_mode_dest", ""));
        setCertiN(JSPUtil.getParameter(request, prefix + "certi_n", ""));
        setFvPolYardCd(JSPUtil.getParameter(request, prefix + "fv_pol_yard_cd", ""));
        setCertiY(JSPUtil.getParameter(request, prefix + "certi_y", ""));
        ...
        setSpCargoLi(JSPUtil.getParameter(request, prefix + "sp_cargo_li", ""));
        ...
        setWebStsCdM(JSPUtil.getParameter(request, prefix + "web_sts_cd_m", ""));
        ...
        setBkgStsCdI(JSPUtil.getParameter(request, prefix + "bkg_sts_cd_i", ""));
        setLOfcCd(JSPUtil.getParameter(request, prefix + "l_ofc_cd", ""));
        setCargoTpF(JSPUtil.getParameter(request, prefix + "cargo_tp_f", ""));
        setBkgStsCdF(JSPUtil.getParameter(request, prefix + "bkg_sts_cd_f", ""));
        setFvPrePstCd(JSPUtil.getParameter(request, prefix + "fv_pre_pst_cd", ""));
        setWebStsCdA(JSPUtil.getParameter(request, prefix + "web_sts_cd_a", ""));
        setSRouteOri(JSPUtil.getParameter(request, prefix + "s_route_ori", ""));
        ...
        setCertiC(JSPUtil.getParameter(request, prefix + "certi_c", ""));
        setCargoTpR(JSPUtil.getParameter(request, prefix + "cargo_tp_r", ""));
        setAgentCd(JSPUtil.getParameter(request, prefix + "agent_cd", ""));
        setCertiD(JSPUtil.getParameter(request, prefix + "certi_d", ""));
        setCertiA(JSPUtil.getParameter(request, prefix + "certi_a", ""));
        setOrderby(JSPUtil.getParameter(request, prefix + "orderby", ""));
        setCertiB(JSPUtil.getParameter(request, prefix + "certi_b", ""));
        setEtaFromDt(JSPUtil.getParameter(request, prefix + "eta_from_dt", ""));
        setCargoTpP(JSPUtil.getParameter(request, prefix + "cargo_tp_p", ""));
        setNonSpCargo(JSPUtil.getParameter(request, prefix + "non_sp_cargo", ""));
        setPorCd(JSPUtil.getParameter(request, prefix + "por_cd", ""));
        setFvPodLocal(JSPUtil.getParameter(request, prefix + "fv_pod_local", ""));
        setBlTypeS(JSPUtil.getParameter(request, prefix + "bl_type_s", ""));
        setWgtTo(JSPUtil.getParameter(request, prefix + "wgt_to", ""));
        setPReportType(JSPUtil.getParameter(request, prefix + "p_report_type", ""));
        setAesY(JSPUtil.getParameter(request, prefix + "aes_y", ""));
        setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
        setBlCerti(JSPUtil.getParameter(request, prefix + "bl_certi", ""));
        setSpCargoEq(JSPUtil.getParameter(request, prefix + "sp_cargo_eq", ""));
        ...
        setWebUpdSts(JSPUtil.getParameter(request, prefix + "web_upd_sts", ""));
        ...
        setBlTypeA(JSPUtil.getParameter(request, prefix + "bl_type_a", ""));
        setAesN(JSPUtil.getParameter(request, prefix + "aes_n", ""));
        ...
        setCanOfcCd(JSPUtil.getParameter(request, prefix + "can_ofc_cd", ""));
    }
    ...
    public StatusReportInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] lTeamCd = (JSPUtil.getParameter(request, prefix + "l_team_cd", length));
            ...
            String[] nonRdStsR = (JSPUtil.getParameter(request, prefix + "non_rd_sts_r", length));
            ...
            String[] alocStsCdS = (JSPUtil.getParameter(request, prefix + "aloc_sts_cd_s", length));
            String[] rateCheck = (JSPUtil.getParameter(request, prefix + "rate_check", length));
            String[] zoneCd = (JSPUtil.getParameter(request, prefix + "zone_cd", length));
            String[] nonRdStsF = (JSPUtil.getParameter(request, prefix + "non_rd_sts_f", length));
            ...
            String[] alocStsCdF = (JSPUtil.getParameter(request, prefix + "aloc_sts_cd_f", length));
            String[] spCargoGe = (JSPUtil.getParameter(request, prefix + "sp_cargo_ge", length));
            String[] masterRfaNo = (JSPUtil.getParameter(request, prefix + "master_rfa_no", length));
            ...
            String[] spCargoFu = (JSPUtil.getParameter(request, prefix + "sp_cargo_fu", length));
            ...
            String[] ctrtCngTpCd = (JSPUtil.getParameter(request, prefix + "ctrt_cng_tp_cd", length));
            String[] spVehicle = (JSPUtil.getParameter(request, prefix + "sp_vehicle", length));
            ...
            String[] spotGuideRfaNo = (JSPUtil.getParameter(request, prefix + "spot_guide_rfa_no", length));
            ...
            String[] mtyRtnEcc = (JSPUtil.getParameter(request, prefix + "mty_rtn_ecc", length));
            String[] rTerm = (JSPUtil.getParameter(request, prefix + "r_term", length));
            String[] basicRfaNo = (JSPUtil.getParameter(request, prefix + "basic_rfa_no", length));
            ...
            String[] spCargoLi = (JSPUtil.getParameter(request, prefix + "sp_cargo_li", length));
            ...
            String[] webStsCdM = (JSPUtil.getParameter(request, prefix + "web_sts_cd_m", length));
            ...
            String[] bkgStsCdI = (JSPUtil.getParameter(request, prefix + "bkg_sts_cd_i", length));
            ...
            String[] webStsCdA = (JSPUtil.getParameter(request, prefix + "web_sts_cd_a", length));
            ...
            String[] blCerti = (JSPUtil.getParameter(request, prefix + "bl_certi", length));
            ...
            String[] webUpdSts = (JSPUtil.getParameter(request, prefix + "web_upd_sts", length));
            ...
            String[] canOfcCd = (JSPUtil.getParameter(request, prefix + "can_ofc_cd", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (nonRdStsR[i] != null)
                    model.setNonRdStsR(nonRdStsR[i]);
                ...
                if (alocStsCdS[i] != null)
                    model.setAlocStsCdS(alocStsCdS[i]);
                if (rateCheck[i] != null)
                    model.setRateCheck(rateCheck[i]);
                if (zoneCd[i] != null)
                    model.setZoneCd(zoneCd[i]);
                if (nonRdStsF[i] != null)
                    model.setNonRdStsF(nonRdStsF[i]);
                if (pGridType[i] != null)
                    model.setPGridType(pGridType[i]);
                if (boardToDt[i] != null)
                    model.setBoardToDt(boardToDt[i]);
                if (alocStsCdF[i] != null)
                    model.setAlocStsCdF(alocStsCdF[i]);
                if (spCargoGe[i] != null)
                    model.setSpCargoGe(spCargoGe[i]);
                if (masterRfaNo[i] != null)
                    model.setMasterRfaNo(masterRfaNo[i]);
                if (sModeOri[i] != null)
                ...
                if (spCargoFu[i] != null)
                    model.setSpCargoFu(spCargoFu[i]);
                if (laneCd[i] != null)
                ...
                if (ctrtCngTpCd[i] != null)
                    model.setCtrtCngTpCd(ctrtCngTpCd[i]);
                if (spVehicle[i] != null)
                    model.setSpVehicle(spVehicle[i]);
                ...
                if (spotGuideRfaNo[i] != null)
                    model.setSpotGuideRfaNo(spotGuideRfaNo[i]);
                if (etaToDt[i] != null)
                ...
                if (mtyRtnEcc[i] != null)
                    model.setMtyRtnEcc(mtyRtnEcc[i]);
                if (rTerm[i] != null)
                    model.setRTerm(rTerm[i]);
                if (basicRfaNo[i] != null)
                    model.setBasicRfaNo(basicRfaNo[i]);
                if (certiG[i] != null)
                ...
                if (spCargoLi[i] != null)
                    model.setSpCargoLi(spCargoLi[i]);
                ...
                if (webStsCdM[i] != null)
                    model.setWebStsCdM(webStsCdM[i]);
                if (soNo[i] != null)
                ...
                if (bkgStsCdI[i] != null)
                    model.setBkgStsCdI(bkgStsCdI[i]);
                if (lOfcCd[i] != null)
                ...
                if (webStsCdA[i] != null)
                    model.setWebStsCdA(webStsCdA[i]);
                if (sRouteOri[i] != null)
                ...
                if (webUpdSts[i] != null)
                    model.setWebUpdSts(webUpdSts[i]);
                if (custTpCdF[i] != null)
	...
	*/
    public void unDataFormat() {
        ...
        this.lTeamCd = this.lTeamCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.nonRdStsR = this.nonRdStsR.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.alocStsCdS = this.alocStsCdS.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.rateCheck = this.rateCheck.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.zoneCd = this.zoneCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.nonRdStsF = this.nonRdStsF.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.alocStsCdF = this.alocStsCdF.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.spCargoGe = this.spCargoGe.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.masterRfaNo = this.masterRfaNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.spCargoFu = this.spCargoFu.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.ctrtCngTpCd = this.ctrtCngTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.spVehicle = this.spVehicle.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.spotGuideRfaNo = this.spotGuideRfaNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.mtyRtnEcc = this.mtyRtnEcc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.rTerm = this.rTerm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.basicRfaNo = this.basicRfaNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.spCargoLi = this.spCargoLi.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.webStsCdM = this.webStsCdM.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.bkgStsCdI = this.bkgStsCdI.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.webStsCdA = this.webStsCdA.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.blCerti = this.blCerti.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.webUpdSts = this.webUpdSts.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.canOfcCd = this.canOfcCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
