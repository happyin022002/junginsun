...
*@FileName : SCRealCustomerProposalDBDAOAddcopyRealCustomerCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRealCustomerProposalDBDAOAddcopyRealCustomerCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Real Customer 데이터를 Copy 합니다.
	  * </pre>
	  */
	public SCRealCustomerProposalDBDAOAddcopyRealCustomerCSQL(){
		setQuery();
		...
		query.append("FileName : SCRealCustomerProposalDBDAOAddcopyRealCustomerCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
