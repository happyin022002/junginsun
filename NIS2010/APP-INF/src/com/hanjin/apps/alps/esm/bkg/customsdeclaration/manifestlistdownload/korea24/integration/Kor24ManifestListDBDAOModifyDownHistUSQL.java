...
*@FileName : Kor24ManifestListDBDAOModifyDownHistUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOModifyDownHistUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOModifyDownHistUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_ADV_KR_DL_HIS" ).append("\n");
		query.append("SET    BL_KNT = BL_KNT + @[delete_bl_cnt]" ).append("\n");
		...
		query.append("FileName : Kor24ManifestListDBDAOModifyDownHistUSQL").append("\n");
		query.append("*/").append("\n");
	}
}