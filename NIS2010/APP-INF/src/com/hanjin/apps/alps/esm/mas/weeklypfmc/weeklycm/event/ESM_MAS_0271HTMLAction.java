...
**@FileName : ESM_MAS_0271HTMLAction.java
 ...
 * @author Je Ryang Yoo
 * @see EsmMas0271Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0271HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0271HTMLAction 객체를 생성
	 */
	public ESM_MAS_0271HTMLAction() {} 

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0271Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0271Event event = new EsmMas0271Event();  	
    	
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDemDetCostDayBatRstVO((DemDetCostDayBatRstVO)getVO(request, DemDetCostDayBatRstVO.class));
		} else {
