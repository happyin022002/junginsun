...
public class CargoReleaseOrderDBDAOsearchDoCheckReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,RST.POR_CD    " ).append("\n"); 
		query.append("      ,RST.POL_CD" ).append("\n"); 
		query.append("      ,RST.SLAN_CD    " ).append("\n"); 
		...
		query.append("          , SUB_RSLT.POR_CD       AS POR_CD " ).append("\n"); 
		query.append("	      , SUB_RSLT.POL_CD       AS POL_CD " ).append("\n"); 
		query.append("	      , SUB_RSLT.SLAN_CD      AS SLAN_CD             " ).append("\n"); 
		...
		query.append("	         , BKGM.SLAN_CD" ).append("\n"); 
