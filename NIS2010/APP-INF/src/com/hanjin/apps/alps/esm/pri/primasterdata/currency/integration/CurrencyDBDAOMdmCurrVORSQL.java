...
*@FileName : CurrencyDBDAOMdmCurrVORSQL.java
...
public class CurrencyDBDAOMdmCurrVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CurrencyDBDAOMdmCurrVORSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.primasterdata.currency.integration").append("\n"); 
		query.append("FileName : CurrencyDBDAOMdmCurrVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
