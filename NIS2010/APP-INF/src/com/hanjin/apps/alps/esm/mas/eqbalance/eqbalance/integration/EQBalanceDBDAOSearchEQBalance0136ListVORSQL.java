...
*@FileName : EQBalanceDBDAOSearchEQBalance0136ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOSearchEQBalance0136ListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQBalanceDBDAOSearchEQBalance0136ListVORSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOSearchEQBalance0136ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,DECODE(A2.POR_REPO_FLG,'',MIN(NVL(A2.POR_REPO_FLG,'N')),A2.POR_REPO_FLG) POR_REPO_FLG" ).append("\n"); 
		...
		query.append("               ,POR_REPO_FLG" ).append("\n"); 
		query.append("          FROM MAS_CNTR_REPO_ROUT_ECC" ).append("\n"); 
		...
		query.append("         (A2.COST_YRMON,A1.RCC_CD,A1.ECC_CD,A2.POR_REPO_FLG)" ).append("\n"); 
		query.append("         ,(A1.RCC_CD))" ).append("\n"); 
