...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtHdrVOUSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtHdrVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtHdrVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtHdrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_RT_CMDT_HDR SET" ).append("\n"); 
