...
public class BkgChgRateVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFxRtFlg(JSPUtil.getParameter(request, "fx_rt_flg", ""));
