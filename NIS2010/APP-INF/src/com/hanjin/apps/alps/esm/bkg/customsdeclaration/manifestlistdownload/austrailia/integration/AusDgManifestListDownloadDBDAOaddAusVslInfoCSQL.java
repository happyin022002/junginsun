...
*@FileName : AusDgManifestListDownloadDBDAOaddAusVslInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusDgManifestListDownloadDBDAOaddAusVslInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusDgManifestListDownloadDBDAOaddAusVslInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AusDgManifestListDownloadDBDAOaddAusVslInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_DG_VSL_SKD " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("(" ).append("\n"); 
