...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased8ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased8ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased8ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased8ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                  FROM COA_LANE_TS_QTY A," ).append("\n"); 
		query.append("                                       COA_MON_VVD B,   " ).append("\n"); 
		query.append("                                       COA_LANE_RGST L1" ).append("\n"); 
		...
		query.append("                                      FROM COA_MON_VVD B" ).append("\n"); 
		...
		query.append("                   ,39, '52101011'" ).append("\n"); 
		query.append("                   ,40, '52201011'" ).append("\n"); 
		query.append("                   ,41, '52301011'" ).append("\n"); 
		query.append("                   ,42, '52401011'" ).append("\n"); 
		query.append("                   ,43, '52601011'" ).append("\n"); 
		query.append("                   ,44, '52101021'" ).append("\n"); 
		query.append("                   ,45, '52201021'" ).append("\n"); 
		query.append("                   ,46, '52301021'" ).append("\n"); 
		query.append("                   ,47, '52402011'" ).append("\n"); 
		query.append("                   ,48, '52501011'" ).append("\n"); 
		query.append("                   ,49, '52601021'" ).append("\n"); 
		query.append("                   ,50, '65000000'" ).append("\n"); 
		query.append("                   ,51, '65010001'" ).append("\n"); 
		query.append("                   ,52, '54600000'" ).append("\n"); 
		query.append("                   ,53, 'OPCOST00'" ).append("\n"); 
		query.append("                   ,54, 'OPCB0000'" ).append("\n"); 
		query.append("                   ,55, 'BOPTOTAL'" ).append("\n"); 
		query.append("                   ,56, 'BOPB0000'" ).append("\n"); 
		...
		query.append("                   ,39, CNTR_SHORT_TERM_EQ_RENTAL" ).append("\n"); 
		query.append("                   ,40, CNTR_LONG_TERM_EQ_RENTAL" ).append("\n"); 
		query.append("                   ,41, CNTR_MR_CHARGE" ).append("\n"); 
		query.append("                   ,42, CNTR_DEPRECIATION" ).append("\n"); 
		query.append("                   ,43, CNTR_INSURANCE" ).append("\n"); 
		query.append("                   ,44, CHASSIS_SHORT_TERM_EG_RENTAL" ).append("\n"); 
		query.append("                   ,45, CHASSIS_LONG_TERM_EQ_RENTAL" ).append("\n"); 
		query.append("                   ,46, SHASSIS_MR_CHARGE" ).append("\n"); 
		query.append("                   ,47, CHASSIS_DEPRECIATION" ).append("\n"); 
		query.append("                   ,48, CHASSIS_DRAYAGE" ).append("\n"); 
		query.append("                   ,49, CHASSIS_INSURANCE" ).append("\n"); 
		query.append("                   ,50, BUSINESS_ACTIVITY_COST" ).append("\n"); 
		query.append("                   ,51, GEN_EXPN" ).append("\n"); 
		query.append("                   ,52, INTERNAL_EXPN" ).append("\n"); 
		query.append("                   ,53, OP_COST" ).append("\n"); 
		query.append("                   ,54, DECODE(TOT_QTY, 0, 0, OP_COST / TOT_QTY)" ).append("\n"); 
		query.append("                   ,55, ((FREIGTH_REV + MISC_REV + SUPPLY + SPC_CHTR) - CM_COST_TOTAL - OP_COST)" ).append("\n"); 
		query.append("                   ,56, DECODE(TOT_QTY, 0, 0, ((FREIGTH_REV + MISC_REV + SUPPLY + SPC_CHTR) - CM_COST_TOTAL - OP_COST) / TOT_QTY) ) AS AMT" ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("      FROM (" ).append("\n"); 
		query.append("            SELECT COST_YRMON" ).append("\n"); 
		query.append("                  ,SLS_YRMON" ).append("\n"); 
		...
		query.append("                   " ).append("\n"); 
		query.append("                  ,SUM(CM_COST_TOTAL) + SUM(EMPTY_TERMINAL_EXPENSE) + SUM(EMPTY_TRANSPORT_EXPENSE) AS CM_COST_TOTAL " ).append("\n"); 
		query.append("                  ,(SUM(CM)+SUM(SPC_CHTR)) - (SUM(EMPTY_TERMINAL_EXPENSE) + SUM(EMPTY_TRANSPORT_EXPENSE)) AS CM" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("              	    " ).append("\n"); 
		query.append("                  ,SUM(US_DOMESTIC_SAV_CREDIT      ) AS US_DOMESTIC_SAV_CREDIT" ).append("\n"); 
		query.append("                  ,SUM(CNTR_LONG_TERM_EQ_RENTAL    ) AS CNTR_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                  ,SUM(CNTR_SHORT_TERM_EQ_RENTAL   ) AS CNTR_SHORT_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                  ,SUM(CNTR_MR_CHARGE              ) AS CNTR_MR_CHARGE " ).append("\n"); 
		query.append("                  ,SUM(CNTR_DEPRECIATION           ) AS CNTR_DEPRECIATION " ).append("\n"); 
		query.append("                  ,SUM(CNTR_INSURANCE              ) AS CNTR_INSURANCE " ).append("\n"); 
		query.append("                  ,SUM(CHASSIS_SHORT_TERM_EG_RENTAL) AS CHASSIS_SHORT_TERM_EG_RENTAL " ).append("\n"); 
		query.append("                  ,SUM(CHASSIS_LONG_TERM_EQ_RENTAL ) AS CHASSIS_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                  ,SUM(SHASSIS_MR_CHARGE           ) AS SHASSIS_MR_CHARGE " ).append("\n"); 
		query.append("                  ,SUM(CHASSIS_DEPRECIATION        ) AS CHASSIS_DEPRECIATION " ).append("\n"); 
		query.append("                  ,SUM(CHASSIS_DRAYAGE             ) AS CHASSIS_DRAYAGE " ).append("\n"); 
		query.append("                  ,SUM(CHASSIS_INSURANCE           ) AS CHASSIS_INSURANCE " ).append("\n"); 
		...
		query.append("                  ,SUM(OP_COST) + SUM(US_DOMESTIC_SAV_CREDIT) + SUM(CNTR_LONG_TERM_EQ_RENTAL) + SUM(CNTR_SHORT_TERM_EQ_RENTAL) + " ).append("\n"); 
		query.append("                   SUM(CNTR_MR_CHARGE) + SUM(CNTR_DEPRECIATION) + SUM(CNTR_INSURANCE) + SUM(CHASSIS_SHORT_TERM_EG_RENTAL) + " ).append("\n"); 
		query.append("                   SUM(CHASSIS_LONG_TERM_EQ_RENTAL) + SUM(SHASSIS_MR_CHARGE) + SUM(CHASSIS_DEPRECIATION) + " ).append("\n"); 
		query.append("                   SUM(CHASSIS_DRAYAGE) + SUM(CHASSIS_INSURANCE) + SUM(BUSINESS_ACTIVITY_COST) + SUM(GEN_EXPN) + SUM(INTERNAL_EXPN)  AS OP_COST" ).append("\n"); 
		query.append("              FROM (" ).append("\n"); 
		query.append("              " ).append("\n"); 
		...
		query.append("                          " ).append("\n"); 
		query.append("                          ,SUM(DECODE('P','P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT))" ).append("\n"); 
		query.append("                                  -(SUM(A2.MTY_STVG_PA_AMT)+SUM(A2.MTY_TRSP_PA_AMT))   AS CM_COST_TOTAL " ).append("\n"); 
		query.append("                          ,SUM(A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV) " ).append("\n"); 
		query.append("                           - (SUM(DECODE('P','P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT))-(SUM(A2.MTY_STVG_PA_AMT)+SUM(A2.MTY_TRSP_PA_AMT)))         AS CM" ).append("\n"); 
		query.append("                          " ).append("\n"); 
		query.append("                          " ).append("\n"); 
		query.append("                          ,SUM(A2.USA_DMST_SAV_CR_AMT)       				   AS US_DOMESTIC_SAV_CREDIT" ).append("\n"); 
		query.append("                          ,SUM(A2.CNTR_LTERM_PA_AMT)                                        AS CNTR_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                          ,SUM(A2.CNTR_STERM_PA_AMT)                                        AS CNTR_SHORT_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                          ,SUM(A2.CNTR_MNR_CHG_PA_AMT)                                      AS CNTR_MR_CHARGE " ).append("\n"); 
		query.append("                          ,SUM(A2.CNTR_DPC_PA_AMT)                                          AS CNTR_DEPRECIATION " ).append("\n"); 
		query.append("                          ,SUM(A2.CNTR_INSUR_PA_AMT)                                        AS CNTR_INSURANCE " ).append("\n"); 
		query.append("                          ,SUM(A2.CHSS_STERM_PA_AMT)                                        AS CHASSIS_SHORT_TERM_EG_RENTAL " ).append("\n"); 
		query.append("                          ,SUM(A2.CHSS_LTERM_PA_AMT)                                        AS CHASSIS_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                          ,SUM(A2.CHSS_MNR_CHG_PA_AMT)                                      AS SHASSIS_MR_CHARGE " ).append("\n"); 
		query.append("                          ,SUM(A2.CHSS_DPC_PA_AMT)                                          AS CHASSIS_DEPRECIATION " ).append("\n"); 
		query.append("                          ,SUM(A2.CHSS_DRYG_PA_AMT)                                         AS CHASSIS_DRAYAGE " ).append("\n"); 
		query.append("                          ,SUM(A2.CHSS_INSUR_PA_AMT)                                        AS CHASSIS_INSURANCE " ).append("\n"); 
		...
		query.append("                      FROM  COA_BKG_EXPN_DTL_WK A2 " ).append("\n"); 
		...
		query.append("                  " ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, DECODE('P','P',PA_CM_COST_TTL_AMT,'R',RA_CM_COST_TTL_AMT),0))" ).append("\n"); 
		query.append("                  - SUM(DECODE(STATUS, STATUS2, MTY_STVG_PA_AMT,0))" ).append("\n"); 
		query.append("                  + SUM(DECODE(STATUS, STATUS2, MTY_TRSP_PA_AMT,0)) AS CM_COST_TOTAL " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, BKG_REV+BKG_OFT_REV+BKG_MISC_REV,0)) " ).append("\n"); 
		query.append("                  - SUM(DECODE(STATUS, STATUS2, DECODE('P','P',PA_CM_COST_TTL_AMT,'R',RA_CM_COST_TTL_AMT),0))" ).append("\n"); 
		query.append("                  - SUM(DECODE(STATUS, STATUS2, MTY_STVG_PA_AMT,0))" ).append("\n"); 
		query.append("                  + SUM(DECODE(STATUS, STATUS2, MTY_TRSP_PA_AMT,0)) AS CM" ).append("\n"); 
		query.append("                  " ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, US_DOMESTIC_SAV_CREDIT          ,0)) AS US_DOMESTIC_SAV_CREDIT" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CNTR_LONG_TERM_EQ_RENTAL        ,0)) AS CNTR_LONG_TERM_EQ_RENTAL" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CNTR_SHORT_TERM_EQ_RENTAL       ,0)) AS CNTR_SHORT_TERM_EQ_RENTAL" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CNTR_MR_CHARGE                  ,0)) AS CNTR_MR_CHARGE" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CNTR_DEPRECIATION               ,0)) AS CNTR_DEPRECIATION" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CNTR_INSURANCE                  ,0)) AS CNTR_INSURANCE" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CHASSIS_SHORT_TERM_EG_RENTAL    ,0)) AS CHASSIS_SHORT_TERM_EG_RENTAL" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CHASSIS_LONG_TERM_EQ_RENTAL     ,0)) AS CHASSIS_LONG_TERM_EQ_RENTAL" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, SHASSIS_MR_CHARGE               ,0)) AS SHASSIS_MR_CHARGE" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CHASSIS_DEPRECIATION            ,0)) AS CHASSIS_DEPRECIATION" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CHASSIS_DRAYAGE                 ,0)) AS CHASSIS_DRAYAGE" ).append("\n"); 
		query.append("                  , SUM(DECODE(STATUS, STATUS2, CHASSIS_INSURANCE               ,0)) AS CHASSIS_INSURANCE" ).append("\n"); 
		...
		query.append("                                  ,A2.CNTR_LTERM_PA_AMT        AS CNTR_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                                  ,A2.CNTR_STERM_PA_AMT        AS CNTR_SHORT_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                                  ,A2.CNTR_MNR_CHG_PA_AMT      AS CNTR_MR_CHARGE " ).append("\n"); 
		query.append("                                  ,A2.CNTR_DPC_PA_AMT          AS CNTR_DEPRECIATION " ).append("\n"); 
		query.append("                                  ,A2.CNTR_INSUR_PA_AMT        AS CNTR_INSURANCE " ).append("\n"); 
		query.append("                                  ,A2.CHSS_STERM_PA_AMT        AS CHASSIS_SHORT_TERM_EG_RENTAL " ).append("\n"); 
		query.append("                                  ,A2.CHSS_LTERM_PA_AMT        AS CHASSIS_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                                  ,A2.CHSS_MNR_CHG_PA_AMT      AS SHASSIS_MR_CHARGE " ).append("\n"); 
		query.append("                                  ,A2.CHSS_DPC_PA_AMT          AS CHASSIS_DEPRECIATION " ).append("\n"); 
		query.append("                                  ,A2.CHSS_DRYG_PA_AMT         AS CHASSIS_DRAYAGE " ).append("\n"); 
		query.append("                                  ,A2.CHSS_INSUR_PA_AMT        AS CHASSIS_INSURANCE " ).append("\n"); 
		query.append("                                  ,0 AS BUSINESS_ACTIVITY_COST " ).append("\n"); 
		query.append("                                  ,0 AS OP_COST" ).append("\n"); 
		query.append("                                  ,0 AS GEN_EXPN" ).append("\n"); 
		query.append("                                  ,0 AS INTERNAL_EXPN" ).append("\n"); 
		...
		query.append("                                  , COA_PSG_TS_ARRAY_FNC(" ).append("\n"); 
		query.append("                                        a2.n1st_trd_cd, DECODE (COA_SLAN_CONTI_CONV_FNC(A2.n1st_finc_vvd_cd, SUBSTR(A2.N1ST_RLANE_CD, 1, 3), SUBSTR (A2.n1st_ioc_conti_cd, 1, 1)), COA_SLAN_CONTI_CONV_FNC(A2.n1st_finc_vvd_cd, SUBSTR(A2.N1ST_RLANE_CD, 1, 3), SUBSTR (A2.n1st_ioc_conti_cd, 2, 1)), 'I', 'O'), A2.n1st_rlane_cd, SUBSTR (A2.n1st_finc_vvd_cd, 1, 9), A2.n1st_pol_cd, A2.n1st_pod_cd, --1" ).append("\n"); 
		query.append("                                        a2.n2nd_trd_cd, DECODE (COA_SLAN_CONTI_CONV_FNC(A2.n2nd_finc_vvd_cd, SUBSTR(A2.N2nd_RLANE_CD, 1, 3), SUBSTR (A2.n2nd_ioc_conti_cd, 1, 1)), COA_SLAN_CONTI_CONV_FNC(A2.n2nd_finc_vvd_cd, SUBSTR(A2.n2nd_RLANE_CD, 1, 3), SUBSTR (A2.n2nd_ioc_conti_cd, 2, 1)), 'I', 'O'), A2.n2nd_rlane_cd, SUBSTR (A2.n2nd_finc_vvd_cd, 1, 9), A2.n2nd_pol_cd, A2.n2nd_pod_cd, --2" ).append("\n"); 
		query.append("                                        a2.n3rd_trd_cd, DECODE (COA_SLAN_CONTI_CONV_FNC(A2.n3rd_finc_vvd_cd, SUBSTR(A2.n3rd_RLANE_CD, 1, 3), SUBSTR (A2.n3rd_ioc_conti_cd, 1, 1)), COA_SLAN_CONTI_CONV_FNC(A2.n3rd_finc_vvd_cd, SUBSTR(A2.n3rd_RLANE_CD, 1, 3), SUBSTR (A2.n3rd_ioc_conti_cd, 2, 1)), 'I', 'O'), A2.n3rd_rlane_cd, SUBSTR (A2.n3rd_finc_vvd_cd, 1, 9), A2.n3rd_pol_cd, A2.n3rd_pod_cd, --3" ).append("\n"); 
		query.append("                                        a2.n4th_trd_cd, DECODE (COA_SLAN_CONTI_CONV_FNC(A2.n4th_finc_vvd_cd, SUBSTR(A2.n4th_RLANE_CD, 1, 3), SUBSTR (A2.n4th_ioc_conti_cd, 1, 1)), COA_SLAN_CONTI_CONV_FNC(A2.n4th_finc_vvd_cd, SUBSTR(A2.n4th_RLANE_CD, 1, 3), SUBSTR (A2.n4th_ioc_conti_cd, 2, 1)), 'I', 'O'), A2.n4th_rlane_cd, SUBSTR (A2.n4th_finc_vvd_cd, 1, 9), A2.n4th_pol_cd, A2.n4th_pod_cd  --4" ).append("\n"); 
		...
		query.append("                          ,0 AS EMPTH_TERMINAL_EXPENSE " ).append("\n"); 
		query.append("                          ,0 AS EMPTY_TRANSPORT_EXPENSE " ).append("\n"); 
		...
		query.append("                          ,0 AS CNTR_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                          ,0 AS CNTR_SHORT_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                          ,0 AS CNTR_MR_CHARGE " ).append("\n"); 
		query.append("                          ,0 AS CNTR_DEPRECIATION " ).append("\n"); 
		query.append("                          ,0 AS CNTR_INSURANCE " ).append("\n"); 
		query.append("                          ,0 AS CHASSIS_SHORT_TERM_EG_RENTAL " ).append("\n"); 
		query.append("                          ,0 AS CHASSIS_LONG_TERM_EQ_RENTAL " ).append("\n"); 
		query.append("                          ,0 AS SHASSIS_MR_CHARGE " ).append("\n"); 
		query.append("                          ,0 AS CHASSIS_DEPRECIATION " ).append("\n"); 
		query.append("                          ,0 AS CHASSIS_DRAYAGE " ).append("\n"); 
		query.append("                          ,0 AS CHASSIS_INSURANCE " ).append("\n"); 
		query.append("                          ,0 AS BUSINESS_ACTIVITY_COST" ).append("\n"); 
		query.append("                          ,0 AS OP_COST" ).append("\n"); 
		query.append("                          ,0 AS GEN_EXPN" ).append("\n"); 
		query.append("                          ,0 AS INTERNAL_EXPN" ).append("\n"); 
		...
		query.append("                            ,0 AS INTERNAL_EXPN" ).append("\n"); 
		query.append("                       FROM COA_MON_VVD A1 " ).append("\n"); 
		query.append("                           ,COA_PFIT_LSS_GEN_EXPN A2 " ).append("\n"); 
		...
		query.append("				" ).append("\n"); 
		query.append("                      UNION ALL" ).append("\n"); 
		query.append("                      /* Trans Volume Incentive, Internal Expense, Business Activity Cost, MT Cost */" ).append("\n"); 
		query.append("                     SELECT COST_YRMON  " ).append("\n"); 
		query.append("                           ,SLS_YRMON  " ).append("\n"); 
		query.append("                           ,COST_WK" ).append("\n"); 
		query.append("                           ,TRD_CD " ).append("\n"); 
		...
		query.append("                           ,0 AS OTHER_TRANSPORT_EXPENSE " ).append("\n"); 
		query.append("                           ,0 AS CARRIERS_HAULAGE_SVG_CHG" ).append("\n"); 
		query.append("                           ,SUM(DECODE(STND_COST_CD, '51102000', AMT, 0)) * MAX(RTO) AS EMPTY_TERMINAL_EXPENSE" ).append("\n"); 
		query.append("                           ,SUM(DECODE(STND_COST_CD, '51302000', AMT, 0)) * MAX(RTO) AS EMPTY_TRANSPORT_EXPENSE" ).append("\n"); 
		query.append("                           ,0 AS AGENT_COMMISSION                             " ).append("\n"); 
		query.append("                           ,0 AS CM_COST_TOTAL " ).append("\n"); 
		query.append("                           ,0 AS CM  " ).append("\n"); 
		query.append("                           ,0 AS US_DOMESTIC_SAV_CREDIT" ).append("\n"); 
		...
		query.append("                           ,0 AS CHASSIS_DRAYAGE " ).append("\n"); 
		query.append("                           ,0 AS CHASSIS_INSURANCE " ).append("\n"); 
		query.append("                           ,SUM(DECODE(STND_COST_CD, '65000000', AMT, 0)) * MAX(RTO) AS BUSINESS_ACTIVITY_COST                           " ).append("\n"); 
		query.append("                           ,0 AS OP_COST" ).append("\n"); 
		query.append("                           ,0 AS GEN_EXPN" ).append("\n"); 
		query.append("                           ,SUM(DECODE(STND_COST_CD, '54600000', AMT, 0)) * MAX(RTO) AS INTERNAL_EXPN" ).append("\n"); 
		query.append("                       FROM ( " ).append("\n"); 
		...
		query.append("                                    ,MAX(NVL(R.RTO, 0)) RTO" ).append("\n"); 
		...
		query.append("                                                                       , 'O|BIZ', DECODE(A2.STND_COST_CD, '51102000', A2.ADJ_N5TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                                                        , '51302000', A2.ADJ_N5TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                                                        , '65000000', A2.ADJ_N5TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                                                        , A2.N5TH_HJS_SLS_AMT)" ).append("\n"); 
		query.append("                                                                       , DECODE(A2.STND_COST_CD, '51102000', A2.ADJ_N5TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                                                               , '51302000', A2.ADJ_N5TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                                                               , '65000000', A2.ADJ_N5TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                                                               , A2.N5TH_ESTM_PL_AMT))" ).append("\n"); 
		query.append("                                    	                 ,'R', A2.RA_PL_AMT)) AS AMT" ).append("\n"); 
		query.append("                                FROM COA_MON_VVD A1 " ).append("\n"); 
		...
		query.append("#end /*ofc_월별 관리*/" ).append("\n"); 
		query.append("    		" ).append("\n"); 
		query.append("                                 AND A2.STND_COST_CD  IN ('54600000', '51102000', '51302000', '65000000')" ).append("\n"); 
		query.append("                                 AND A2.STND_COST_CD  = A3.STND_COST_CD " ).append("\n"); 
		query.append("                                 AND A1.DELT_FLG      <> 'Y' " ).append("\n"); 
		query.append("    				" ).append("\n"); 
		query.append("#if(${f_chkprd} =='M')" ).append("\n"); 
		...
		query.append("                     WHERE CPY_NO BETWEEN 1 AND 56" ).append("\n"); 
