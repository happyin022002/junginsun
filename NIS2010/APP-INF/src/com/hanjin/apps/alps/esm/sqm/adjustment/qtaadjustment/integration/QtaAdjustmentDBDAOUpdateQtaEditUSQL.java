...
*@FileName : QtaAdjustmentDBDAOUpdateQtaEditUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAOUpdateQtaEditUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public QtaAdjustmentDBDAOUpdateQtaEditUSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAOUpdateQtaEditUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,SQM_CNG_TP_CD = CASE @[sqm_cng_tp_cd] WHEN 'M' THEN 'M'" ).append("\n"); 
