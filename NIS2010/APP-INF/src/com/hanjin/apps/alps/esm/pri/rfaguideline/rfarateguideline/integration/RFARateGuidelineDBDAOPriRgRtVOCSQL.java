...
*@FileName : RFARateGuidelineDBDAOPriRgRtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOPriRgRtVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOPriRgRtVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOPriRgRtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
