...
*@FileName : BlRatingDBDAORemoveRateCADSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAORemoveRateCADSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BlRatingDBDAORemoveRateCADSQL
	  * </pre>
	  */
	public BlRatingDBDAORemoveRateCADSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAORemoveRateCADSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
