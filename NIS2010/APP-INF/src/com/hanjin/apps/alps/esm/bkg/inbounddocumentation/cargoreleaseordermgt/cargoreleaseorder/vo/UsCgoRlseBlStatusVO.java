...
*@FileName : UsCgoRlseBlStatusVO.java
*@FileTitle : UsCgoRlseBlStatusVO
*Open Issues :
*Change history :
...
public class UsCgoRlseBlStatusVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsCgoRlseBlStatusVO> models = new ArrayList<UsCgoRlseBlStatusVO>();
	 ...
	 */
	public UsCgoRlseBlStatusVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsCgoRlseBlStatusVO[]
	 */
	public UsCgoRlseBlStatusVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsCgoRlseBlStatusVO model = null;
		...
		return getUsCgoRlseBlStatusVOs();
	}
	 ...
	 * @return UsCgoRlseBlStatusVO[]
	 */
	public UsCgoRlseBlStatusVO[] getUsCgoRlseBlStatusVOs(){
		UsCgoRlseBlStatusVO[] vos = (UsCgoRlseBlStatusVO[])models.toArray(new UsCgoRlseBlStatusVO[models.size()]);
		return vos;
	}
