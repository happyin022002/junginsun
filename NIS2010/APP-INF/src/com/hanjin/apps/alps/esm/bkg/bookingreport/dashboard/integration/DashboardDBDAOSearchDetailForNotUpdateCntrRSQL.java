...
*@FileName : DashboardDBDAOSearchDetailForNotUpdateCntrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DashboardDBDAOSearchDetailForNotUpdateCntrRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * General + Not updated Container Detail 항목을 조회한다.
	  * </pre>
	  */
	public DashboardDBDAOSearchDetailForNotUpdateCntrRSQL(){
		setQuery();
		...
		query.append("FileName : DashboardDBDAOSearchDetailForNotUpdateCntrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", WM_CONCAT(D.CNTR_NO) NOT_UPD_CNTR_LIST" ).append("\n"); 
		...
		query.append(", CTM_MVMT_IRR D" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("  AND DB.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("  AND D.CNMV_IRR_STL_FLG = 'N'" ).append("\n"); 
