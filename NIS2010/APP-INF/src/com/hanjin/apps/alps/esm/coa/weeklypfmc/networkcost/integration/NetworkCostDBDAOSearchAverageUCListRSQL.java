...
public class NetworkCostDBDAOSearchAverageUCListRSQL implements ISQLTemplate{
	...
	public NetworkCostDBDAOSearchAverageUCListRSQL(){
		...
		params.put("f_coa_cd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("  FROM COA_OP_AVG_UT_COST B , COA_STND_ACCT A  " ).append("\n"); 
		...
		query.append(" #end " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(" /*COA CODE*/" ).append("\n"); 
		query.append(" #if (${f_coa_cd} != '') " ).append("\n"); 
		query.append("   AND A.STND_COST_CD = @[f_coa_cd]" ).append("\n"); 
		query.append(" #end" ).append("\n"); 
