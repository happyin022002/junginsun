...
public class TaiwanCustomsTransmissionDBDAOsearchBlGeneralRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("TRANSLATE(NVL(BKG.XTER_RMK,' '),CHR(13)||CHR(10),' ') remark," ).append("\n"); 
		...
		query.append("TRANSLATE(NVL(COM.CMDT_NM,' '),CHR(13)||CHR(10),' ') cmdtDesc" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("FROM MDM_ORGANIZATION OFC, MDM_COMMODITY COM, BKG_BOOKING BKG, BKG_BL_DOC DOC, BKG_BL_ISS BL, BKG_VVD VVD, BKG_CUSTOMER BCC, BKG_CUSTOMER BCS, BKG_CUSTOMER BCN, BKG_CUSTOMER BCA, BKG_CUSTOMER BCF, BKG_CUSTOMER BCE" ).append("\n"); 
