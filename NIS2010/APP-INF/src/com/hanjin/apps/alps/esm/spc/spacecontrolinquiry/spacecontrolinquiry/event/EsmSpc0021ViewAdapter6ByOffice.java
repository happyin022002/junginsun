...
*@FileName       : EsmSpc0021ViewAdapter6ByOffice.java
 ...
 * @since J2EE 1.5
 */
public class EsmSpc0021ViewAdapter6ByOffice extends ViewAdapter{
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) 
	{
		...
		int rowCountview = viewList.size(); // 51
		...
		if (rowCountview > 0 && viewList != null) {//3.1
			...
			for(int i =0 ; i < rowCountview ; i++){
				...
				// Tree의 Level
				level = aq_cd.equals("-")?0:(ofc_cd.equals("+")?1:(port1.equals("+")?2:3));
				...
				sbufXML.append("<TD>").append(aq_cd.equals("-")?"":(ofc_cd.equals("+")?"":port1)).append("</TD>\n");	// port
