 ...
 * @since J2EE 1.6
 */
public class EsmCoa0070ViewAdapter3 extends DefaultViewAdapter {
	
    public EsmCoa0070ViewAdapter3(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmCoa0070ViewAdapter3 ########### [START]");
		...
		log.debug("########### EsmCoa0070ViewAdapter3 ########### [END]");        
