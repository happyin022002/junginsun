...
*@FileName : SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033VVDLaneRgstListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033VVDLaneRgstListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMultiSpaceAllocation0033VVDLaneRgstList
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033VVDLaneRgstListCSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033VVDLaneRgstListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPC_IRR_LANE_RGST" ).append("\n"); 
