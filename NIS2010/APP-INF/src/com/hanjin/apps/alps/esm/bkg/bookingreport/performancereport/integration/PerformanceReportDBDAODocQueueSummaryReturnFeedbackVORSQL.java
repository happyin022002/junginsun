...
*@FileName : PerformanceReportDBDAODocQueueSummaryReturnFeedbackVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAODocQueueSummaryReturnFeedbackVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PerformanceReportDBDAODocQueueSummaryReturnFeedbackVORSQL
	  * </pre>
	  */
	public PerformanceReportDBDAODocQueueSummaryReturnFeedbackVORSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAODocQueueSummaryReturnFeedbackVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       TOTAL_RQST," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND((TOTAL_RQST / TOTAL) * 100, 2), '990.99')) AS TOTAL_PER," ).append("\n"); 
		query.append("       INPUT_RQST," ).append("\n"); 
		query.append("       INPUT_D1," ).append("\n"); 
		query.append("       INPUT_D3," ).append("\n"); 
		query.append("       INPUT_D5," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND((INPUT_RQST / TOTAL) * 100, 2), '990.99')) AS INPUT_PER," ).append("\n"); 
		query.append("       RATE_RQST," ).append("\n"); 
		query.append("       RATE_D1," ).append("\n"); 
		query.append("       RATE_D3," ).append("\n"); 
		query.append("       RATE_D5," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND((RATE_RQST / TOTAL) * 100, 2), '990.99')) AS RATE_PER," ).append("\n"); 
		query.append("       FO_RQST," ).append("\n"); 
		query.append("       FO_D1," ).append("\n"); 
		query.append("       FO_D3," ).append("\n"); 
		query.append("       FO_D5," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND((FO_RQST / TOTAL) * 100, 2), '990.99')) AS FO_PER," ).append("\n"); 
		query.append("       CUSTOMER_RQST," ).append("\n"); 
		query.append("       CUSTOMER_D1," ).append("\n"); 
		query.append("       CUSTOMER_D3," ).append("\n"); 
		query.append("       CUSTOMER_D5," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND((CUSTOMER_RQST / TOTAL) * 100, 2), '990.99')) AS CUSTOMER_PER" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                        WHEN RTN_TOT > 0 OR INPUT_TOT > 0 OR RATE_TOT > 0 OR CUSTOMER_TOT > 0 THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS TOTAL_RQST," ).append("\n"); 
		query.append("               -----------------" ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN INPUT_TOT > 0 THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS INPUT_RQST," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN INPUT_DD >= '00' AND INPUT_DD <= '01' AND 0 < INPUT_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS INPUT_D1," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN INPUT_DD >= '02' AND INPUT_DD <= '03' AND 0 < INPUT_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS INPUT_D3," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN INPUT_DD >= '04' AND 0 < INPUT_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS INPUT_D5," ).append("\n"); 
		query.append("               -----------------" ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN RATE_TOT > 0 THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS RATE_RQST," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN RATE_DD >= '00' AND RATE_DD <= '01' AND 0 < RATE_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS RATE_D1," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN RATE_DD >= '02' AND RATE_DD <= '03' AND 0 < RATE_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS RATE_D3," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN RATE_DD >= '04' AND 0 < RATE_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS RATE_D5," ).append("\n"); 
		query.append("               -----------------" ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN FO_TOT > 0 THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS FO_RQST," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN FO_DD >= '00' AND FO_DD <= '01' AND 0 < FO_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS FO_D1," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN FO_DD >= '02' AND FO_DD <= '03' AND 0 < FO_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS FO_D3," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN FO_DD >= '04' AND 0 < RTN_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS FO_D5," ).append("\n"); 
		query.append("               -----------------" ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN CUSTOMER_TOT > 0 THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS CUSTOMER_RQST," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN CUSTOMER_DD >= '00' AND CUSTOMER_DD <= '01' AND 0 < CUSTOMER_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS CUSTOMER_D1," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN CUSTOMER_DD >= '02' AND CUSTOMER_DD <= '03' AND 0 < CUSTOMER_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS CUSTOMER_D3," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN CUSTOMER_DD >= '04' AND 0 < CUSTOMER_TOT THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS CUSTOMER_D5" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("          FROM" ).append("\n"); 
		...
		query.append("                           AND SR_STS_CD = 'RR') AS RTN_TOT," ).append("\n"); 
		query.append("                       -----------------" ).append("\n"); 
		query.append("                       (SELECT COUNT(*)" ).append("\n"); 
		query.append("                          FROM BKG_SR_HIS" ).append("\n"); 
		query.append("                         WHERE BKG_NO = A.BKG_NO" ).append("\n"); 
		...
		query.append("                           AND FNT_OFC_RTN_CD = 'I') AS INPUT_TOT," ).append("\n"); 
		query.append("                       BKG_GET_CONV_INTVAL_TIME_FNC(BKG_DPCS_COMMON_PKG.BKG_DPCS_SR_HIS_ACT_SUM_FNC(A.SR_KND_CD, A.SR_NO, A.BKG_NO, 'RR', 'I'), 'DD') AS INPUT_DD," ).append("\n"); 
		query.append("                       -----------------" ).append("\n"); 
		query.append("                       (SELECT COUNT(*)" ).append("\n"); 
		query.append("                          FROM BKG_SR_HIS" ).append("\n"); 
		query.append("                         WHERE BKG_NO = A.BKG_NO" ).append("\n"); 
		...
		query.append("                           AND SR_KND_CD = A.SR_KND_CD" ).append("\n"); 
		query.append("                           AND SR_STS_CD = 'RR'" ).append("\n"); 
		query.append("                           AND FNT_OFC_RTN_CD = 'R') AS RATE_TOT," ).append("\n"); 
		query.append("                       BKG_GET_CONV_INTVAL_TIME_FNC(BKG_DPCS_COMMON_PKG.BKG_DPCS_SR_HIS_ACT_SUM_FNC(A.SR_KND_CD, A.SR_NO, A.BKG_NO, 'RR', 'R'), 'DD') AS RATE_DD," ).append("\n"); 
		query.append("                       -----------------" ).append("\n"); 
		query.append("                       (SELECT COUNT(*)" ).append("\n"); 
		query.append("                          FROM BKG_SR_HIS" ).append("\n"); 
		query.append("                         WHERE BKG_NO = A.BKG_NO" ).append("\n"); 
		...
		query.append("                           AND SR_KND_CD = A.SR_KND_CD" ).append("\n"); 
		query.append("                           AND SR_STS_CD = 'RR'" ).append("\n"); 
		query.append("                           AND FNT_OFC_RTN_CD = 'S') AS FO_TOT," ).append("\n"); 
		query.append("                       BKG_GET_CONV_INTVAL_TIME_FNC(BKG_DPCS_COMMON_PKG.BKG_DPCS_SR_HIS_ACT_SUM_FNC(A.SR_KND_CD, A.SR_NO, A.BKG_NO, 'RR', 'S'), 'DD') AS FO_DD," ).append("\n"); 
		query.append("                       -----------------" ).append("\n"); 
		query.append("                       (SELECT COUNT(*)" ).append("\n"); 
		query.append("                          FROM BKG_SR_HIS" ).append("\n"); 
		query.append("                         WHERE BKG_NO = A.BKG_NO" ).append("\n"); 
		...
		query.append("                           AND SR_KND_CD = A.SR_KND_CD" ).append("\n"); 
		query.append("                           AND SR_STS_CD = 'RR'" ).append("\n"); 
		query.append("                           AND FNT_OFC_RTN_CD = 'C') AS CUSTOMER_TOT," ).append("\n"); 
		query.append("                       BKG_GET_CONV_INTVAL_TIME_FNC(BKG_DPCS_COMMON_PKG.BKG_DPCS_SR_HIS_ACT_SUM_FNC(A.SR_KND_CD, A.SR_NO, A.BKG_NO, 'RR', 'C'), 'DD') AS CUSTOMER_DD" ).append("\n"); 
		query.append("" ).append("\n"); 
