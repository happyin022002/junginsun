...
*@FileName : AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRequestUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRequestUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRequestUSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRequestUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET    COMM_PROC_STS_CD = 'RR'," ).append("\n"); 
