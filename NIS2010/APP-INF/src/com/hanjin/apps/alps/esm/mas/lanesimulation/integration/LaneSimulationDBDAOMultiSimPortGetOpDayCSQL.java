...
*@FileName : LaneSimulationDBDAOMultiSimPortGetOpDayCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimPortGetOpDayCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimPortGetOpDayCSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimPortGetOpDayCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_SIM_TML_INFO( SIM_DT, SIM_NO, SKD_DIR_CD, TML_CD,                                      						                          " ).append("\n"); 
		query.append("                                  VSL_DBL_CALL_SEQ, PORT_SEQ, PORT_DYS, SEA_DYS, TURN_PORT_IND_CD,                                  " ).append("\n"); 
		...
		query.append("           ,B1.PORT_CD||NVL(SUBSTR(B2.TML_CD,6,2),'XX') TML_CD                                                                      " ).append("\n"); 
		...
		query.append("           ,B1.TURN_PORT_FLG AS TURN_PORT_IND_CD                                                                                    " ).append("\n"); 
		...
		query.append("            ,MAS_SIM_TML_INFO B3                                                                                                    " ).append("\n"); 
		...
		query.append("       AND B2.CRR_CD(+)      = 'SML'                                                                                                " ).append("\n"); 
