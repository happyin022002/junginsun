...
*@FileName : RsltPriRgGrpLocVO.java
*@FileTitle : RsltPriRgGrpLocVO
*Open Issues :
*Change history :
...
public class RsltPriRgGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRgGrpLocVO> models = new ArrayList<RsltPriRgGrpLocVO>();
	...
	public RsltPriRgGrpLocVO() {}

	public RsltPriRgGrpLocVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String grpLocSeq, String orgDestTpCd, String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriRgGrpLocVO[]
	 */
	public RsltPriRgGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRgGrpLocVO[]
	 */
	public RsltPriRgGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRgGrpLocVO model = null;
	 ...
	 * @return RsltPriRgGrpLocVO[]
	 */
	public RsltPriRgGrpLocVO[] getRsltPriRgGrpLocVOs(){
		RsltPriRgGrpLocVO[] vos = (RsltPriRgGrpLocVO[])models.toArray(new RsltPriRgGrpLocVO[models.size()]);
		return vos;
	}
