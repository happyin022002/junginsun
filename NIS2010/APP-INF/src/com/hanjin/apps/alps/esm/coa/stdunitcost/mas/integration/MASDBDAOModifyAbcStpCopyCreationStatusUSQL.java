...
*@FileName : MASDBDAOModifyAbcStpCopyCreationStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MASDBDAOModifyAbcStpCopyCreationStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MASDBDAOModifyAbcStpCopyCreationStatusUSQL(){
		setQuery();
		...
		query.append("FileName : MASDBDAOModifyAbcStpCopyCreationStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'BUAC' CM_UC_CD" ).append("\n"); 
