...
*@FileName : Kor24CustomsTransmissionDBDAOaddAutoMACAMDSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddAutoMACAMDSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddAutoMACAMDSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddAutoMACAMDSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n");
		query.append("SELECT '6SK'" ).append("\n");
		...
		query.append("WHERE MSG_LOG_TP_ID	= '6SK'" ).append("\n");
