...
=========================================================*/
package com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.basic;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.integration.UsaCustomsReportDBDAO;
 ...
 * @since J2EE 1.6
 */
public class UsaCustomsReportBCImpl extends CustomsReportBCImpl {
		...
		try{
			...
			if(pgmNo.equals("ESM_BKG_0041") || pgmNo.equals("ESM_BKG_0041_2")) {
				...
				if ("ISF5".equals(vo.getGeneralOrRail())){
					 ...
					 ***********************************************************/
					vo.setTmp1("C");
					if(!"".equals(vo.getExclRls()) || !"".equals(vo.getCustomsResultCode()) || 
	...
	private String generateCsv(List vos) throws EventException {
