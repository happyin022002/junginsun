...
*@FileName : RFARateProposalDBDAORsltFicGuidelineRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltFicGuidelineRateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltFicGuidelineRateRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltFicGuidelineRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
