...
*@FileName : StatusReportDBDAOSearchBLStatusListSpecialCargo3RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOSearchBLStatusListSpecialCargo3RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * StatusReportDBDAOSearchBLStatusListSpecialCargo3RSQL
	  * </pre>
	  */
	public StatusReportDBDAOSearchBLStatusListSpecialCargo3RSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOSearchBLStatusListSpecialCargo3RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, TRIM(TO_CHAR(SUM(TO_NUMBER(MEAS_QTY,'999,999,990.999')) OVER() ,'999,999,990.999')) TOTAL_MEA" ).append("\n"); 
		...
		query.append("                                , DG.CNTR_NO AS CNTR_NO" ).append("\n"); 
		query.append("                                 /* T/S */" ).append("\n"); 
		query.append("                                , DG.CNTR_TPSZ_CD AS CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                 /* Substance */" ).append("\n"); 
		query.append("                                , DG.PRP_SHP_NM AS PRP_SHP_NM" ).append("\n"); 
		query.append("                                 /* Contact Point */" ).append("\n"); 
		query.append("                                , DG.EMER_CNTC_PHN_NO_CTNT AS EMER_CNTC_PHN_NO_CTNT" ).append("\n"); 
		query.append("                                , DG.IMDG_UN_NO AS IMDG_UN_NO" ).append("\n"); 
		query.append("                                , DG.DG_CNTR_SEQ AS DG_CNTR_SEQ" ).append("\n"); 
		query.append("                                , DG.IMDG_CLSS_CD AS IMDG_CLSS_CD" ).append("\n"); 
		query.append("                                , DG.IMDG_COMP_GRP_CD AS IMDG_COMP_GRP_CD" ).append("\n"); 
		query.append("                                 /* Pack Grp */" ).append("\n"); 
		query.append("                                , DG.IMDG_PCK_GRP_CD AS IMDG_PCK_GRP_CD" ).append("\n"); 
		query.append("                                 /* F/Point */" ).append("\n"); 
		query.append("                                , DG.FLSH_PNT_CDO_TEMP AS FLSH_PNT_CDO_TEMP" ).append("\n"); 
		query.append("                                  /* Net */" ).append("\n"); 
		query.append("                                , TRIM(TO_CHAR(DG.NET_WGT ,'999,999,990.999')) NET_WGT" ).append("\n"); 
		query.append("                                  /* Gross */" ).append("\n"); 
		query.append("                                , TRIM(TO_CHAR(NVL(GRS_WGT,0) ,'999,999,990.999')) GRS_WGT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                  /* Mea*/" ).append("\n"); 
		query.append("								, TRIM(TO_CHAR(NVL(DG.MEAS_QTY,0) ,'999,999,990.999')) MEAS_QTY" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                  /* PKG */" ).append("\n"); 
		query.append("                                , DG.OUT_IMDG_PCK_QTY1||DG.OUT_IMDG_PCK_CD1 AS PKG" ).append("\n"); 
		query.append("                                  /* AT */" ).append("\n"); 
		query.append("                                , DG.SPCL_CGO_APRO_CD AS SPCL_CGO_APRO_CD" ).append("\n"); 
		query.append("                                , DG.DCGO_SEQ AS CGO_SEQ " ).append("\n"); 
		query.append("                                , DG.SPCL_STWG_RQST_DESC  AS STOWAGE" ).append("\n"); 
		...
		query.append("                                AND VB.BKG_NO = DG.BKG_NO(+)" ).append("\n"); 
		query.append("                                AND VB.DCGO_FLG ='Y'" ).append("\n"); 
