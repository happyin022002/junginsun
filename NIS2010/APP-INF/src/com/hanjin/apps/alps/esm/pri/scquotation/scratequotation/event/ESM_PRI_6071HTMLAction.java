...
public class ESM_PRI_6071HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6019HTMLAction 객체를 생성
	 */
	public ESM_PRI_6071HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6071Event event = new EsmPri6071Event();
	
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSqScgAdjVOS((PriSqScgAdjVO[])getVOs(request, PriSqScgAdjVO .class,""));
