...
*@FileName : ESM_BKG_0727HTMLAction.java
...
public class ESM_BKG_0727HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0727HTMLAction 객체를 생성
	 */
	public ESM_BKG_0727HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0727Event event = new EsmBkg0727Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBdrBookingNoListVO((BdrBookingNoListVO)getVO(request, BdrBookingNoListVO .class));
		}
