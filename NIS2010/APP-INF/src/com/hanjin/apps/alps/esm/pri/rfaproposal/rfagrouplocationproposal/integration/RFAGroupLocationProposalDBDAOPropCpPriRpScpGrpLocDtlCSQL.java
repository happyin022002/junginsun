...
*@FileName : RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_GRP_LOC_DTL Insert
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocDtlCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY A.PROP_NO,A.AMDT_SEQ,A.SVC_SCP_CD,A.GRP_LOC_SEQ) AS GRP_LOC_SEQ" ).append("\n"); 
		query.append(", DENSE_RANK() OVER (PARTITION BY A.PROP_NO,A.AMDT_SEQ,A.SVC_SCP_CD,A.GRP_LOC_SEQ" ).append("\n"); 
		query.append("ORDER BY A.PROP_NO,A.AMDT_SEQ,A.SVC_SCP_CD,A.GRP_LOC_SEQ,B.GRP_LOC_DTL_SEQ) AS GRP_LOC_DTL_SEQ" ).append("\n"); 
		...
		query.append(",PRI_RP_SCP_GRP_LOC_DTL B" ).append("\n"); 
