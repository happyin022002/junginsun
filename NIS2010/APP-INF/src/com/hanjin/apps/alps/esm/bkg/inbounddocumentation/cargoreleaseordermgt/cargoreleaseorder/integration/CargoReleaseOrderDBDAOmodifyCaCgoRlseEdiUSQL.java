...
public class CargoReleaseOrderDBDAOmodifyCaCgoRlseEdiUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       FRT_CLT_LST_DT	= DECODE(@[frt_clt_flg],FRT_CLT_FLG,FRT_CLT_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('TORSC') ))," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${obl_rdem_flg} != '' )" ).append("\n"); 
		query.append("       OBL_RDEM_FLG	    = @[obl_rdem_flg]," ).append("\n"); 
		query.append("       OBL_RDEM_LST_DT	= DECODE(@[obl_rdem_flg],OBL_RDEM_FLG,OBL_RDEM_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('TORSC') ))," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                                     TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('TORSC')),'YYYYMMDDHH24MISS')))," ).append("\n"); 
		...
		query.append("        GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',SYSDATE,GLOBALDATE_PKG.GET_LOCCD_FNC('TORSC') )," ).append("\n"); 
