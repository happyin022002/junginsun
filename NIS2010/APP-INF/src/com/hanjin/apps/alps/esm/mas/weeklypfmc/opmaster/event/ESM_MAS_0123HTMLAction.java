...
*@FileName : ESM_MAS_0123HTMLAction.java
...
public class ESM_MAS_0123HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0123HTMLAction 객체를 생성
	 */
	public ESM_MAS_0123HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0123Event event = new EsmMas0123Event();
