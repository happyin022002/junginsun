...
*@FileName : EQBalanceDBDAOMasCntrRepoShtgInfoVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOMasCntrRepoShtgInfoVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * * 2012.03.22 김종준 [CHM-201217091-01] EMU 관련 로직 보완/변경 검토 요청의 건 -MAS_CNTR_REPO_SHTG_INFO 테이블의 삭제
	  * </pre>
	  */
	public EQBalanceDBDAOMasCntrRepoShtgInfoVODSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOMasCntrRepoShtgInfoVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
