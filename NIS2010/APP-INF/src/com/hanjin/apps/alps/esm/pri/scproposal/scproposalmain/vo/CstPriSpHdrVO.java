...
*@FileName : CstPriSpHdrVO.java
*@FileTitle : CstPriSpHdrVO
*Open Issues :
*Change history :
...
public class CstPriSpHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpHdrVO> models = new ArrayList<CstPriSpHdrVO>();
	...
	public CstPriSpHdrVO() {}

	public CstPriSpHdrVO(String ibflag, String pagerows, String ofcCd, String svcScpCd, String exFlg, String scNo, String preFix) {
		this.preFix = preFix;
		this.exFlg = exFlg;
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
	 ...
	 */
	public CstPriSpHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpHdrVO[]
	 */
	public CstPriSpHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpHdrVO model = null;
	 ...
	 * @return CstPriSpHdrVO[]
	 */
	public CstPriSpHdrVO[] getCstPriSpHdrVOs(){
		CstPriSpHdrVO[] vos = (CstPriSpHdrVO[])models.toArray(new CstPriSpHdrVO[models.size()]);
		return vos;
	}
