...
public class MTCostDBDAOCreateCopyEqRepoCostCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("#if(${table_name} =='MAS_MTCH_BAK_INFO')" ).append("\n"); 
		query.append("INSERT INTO MAS_MTCH_BAK_INFO" ).append("\n"); 
		...
		query.append("    @[user_id]," ).append("\n"); 
		query.append("    SYSDATE" ).append("\n"); 
		query.append("FROM MAS_MTCH_BAK_INFO" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]" ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_FULL_ECC_IMBAL')" ).append("\n"); 
		query.append("INSERT INTO MAS_FULL_ECC_IMBAL" ).append("\n"); 
		...
		query.append("    @[user_id]," ).append("\n"); 
		query.append("    SYSDATE" ).append("\n"); 
		query.append("FROM MAS_FULL_ECC_IMBAL" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]" ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_CNTR_MTY_MVMT')" ).append("\n"); 
		query.append("INSERT INTO MAS_CNTR_MTY_MVMT" ).append("\n"); 
		...
		query.append("    @[user_id]," ).append("\n"); 
		query.append("    SYSDATE" ).append("\n"); 
		query.append("FROM MAS_CNTR_MTY_MVMT" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]       " ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_MTY_CNTR_ROUT_PERF')" ).append("\n"); 
		query.append("INSERT INTO MAS_MTY_CNTR_ROUT_PERF" ).append("\n"); 
		...
		query.append("WHERE COST_YRMON = @[f_src_mon]  " ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_MTY_ECC_CNTR_SMRY')" ).append("\n"); 
		query.append("INSERT INTO MAS_MTY_ECC_CNTR_SMRY" ).append("\n"); 
		...
		query.append("FROM MAS_MTY_ECC_CNTR_SMRY" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]        " ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_MTY_ECC_UT_COST')" ).append("\n"); 
		query.append("INSERT INTO MAS_MTY_ECC_UT_COST" ).append("\n"); 
		...
		query.append("WHERE COST_YRMON = @[f_src_mon]     " ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_MTY_DEST_COST')" ).append("\n"); 
		query.append("INSERT INTO MAS_MTY_DEST_COST" ).append("\n"); 
		query.append("(COST_YRMON," ).append("\n"); 
		...
		query.append("WHERE COST_YRMON = @[f_src_mon]       " ).append("\n"); 
		query.append("#elseif (${table_name} =='MAS_MTY_CNTR_ROUT_DTL')" ).append("\n"); 
		query.append("INSERT INTO MAS_MTY_CNTR_ROUT_DTL" ).append("\n"); 
		...
		query.append("       MTY_STVG_TTL_AMT, MTY_TRSP_TTL_AMT, TTL_TZ_DYS, TTL_TZTM_HRS, TTL_CNTR_QTY, " ).append("\n"); 
		query.append("       @[user_id],SYSDATE,@[user_id],SYSDATE" ).append("\n"); 
		query.append("FROM MAS_MTY_CNTR_ROUT_DTL" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]   " ).append("\n"); 
