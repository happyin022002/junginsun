...
*@FileName : CommonDBDAOCheckOfcRhqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonDBDAOCheckOfcRhqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonDBDAOCheckOfcRhqRSQL(){
		setQuery();
		...
		query.append("FileName : CommonDBDAOCheckOfcRhqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND OFC_TP_CD IN ('BA','BB','BS')" ).append("\n"); 
