...
*@FileName : RfaOftAutoRatingDBDAOcheckOftRateMatchRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RfaOftAutoRatingDBDAOcheckOftRateMatchRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RfaOftAutoRatingDBDAOcheckOftRateMatchRSQL(){
		setQuery();
		...
		query.append("FileName : RfaOftAutoRatingDBDAOcheckOftRateMatchRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
