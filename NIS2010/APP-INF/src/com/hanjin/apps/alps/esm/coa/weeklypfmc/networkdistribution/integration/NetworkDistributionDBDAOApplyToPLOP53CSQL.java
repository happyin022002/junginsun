...
*@FileName : NetworkDistributionDBDAOApplyToPLOP53CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOApplyToPLOP53CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkDistributionDBDAOApplyToPLOP53CSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOApplyToPLOP53CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,SUM(DECODE(SUBSTR(B.CNTR_TPSZ_CD, -1), '2', B.N5TH_ESTM_PL_AMT, '3', B.N5TH_ESTM_PL_AMT, B.N5TH_ESTM_PL_AMT*2)) AS ESTM_PL_AMT /*TEU Base*/" ).append("\n"); 
		...
		query.append("                 ,COA_PFIT_LSS_SMRY  B" ).append("\n"); 
		...
		query.append("            A.N5TH_ESTM_PL_AMT = B.ESTM_PL_AMT" ).append("\n"); 
