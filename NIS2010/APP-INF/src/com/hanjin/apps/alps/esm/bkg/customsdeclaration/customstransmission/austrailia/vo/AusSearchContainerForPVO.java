...
*@FileName : AusSearchContainerForPVO.java
*@FileTitle : AusSearchContainerForPVO
*Open Issues :
*Change history :
...
public class AusSearchContainerForPVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AusSearchContainerForPVO> models = new ArrayList<AusSearchContainerForPVO>();
	...
	public AusSearchContainerForPVO() {}

	public AusSearchContainerForPVO(String ibflag, String pagerows, String cntrnbr, String punit, String pkg, String cntrwgt, String cntrtype, String sealnbr, String fmInd, String rfInd, String dgInd, String akInd, String bkInd, String temp, String tunit, String vent, String measure, String rdtype, String cmdtDesc, String cmdtcd, String rfRemark, String rfdryInd, String ovf, String ovr, String ovh, String ovlw, String ovrw, String ovwgt, String voidSlot, String stwgReq, String cntrNo) {
		this.ovrw = ovrw;
	 ...
	 * @param request
	 * @return AusSearchContainerForPVO[]
	 */
	public AusSearchContainerForPVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusSearchContainerForPVO[]
	 */
	public AusSearchContainerForPVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusSearchContainerForPVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AusSearchContainerForPVO();
				if (ovrw[i] != null)
		...
		return getAusSearchContainerForPVOs();
	}
	 ...
	 * @return AusSearchContainerForPVO[]
	 */
	public AusSearchContainerForPVO[] getAusSearchContainerForPVOs(){
		AusSearchContainerForPVO[] vos = (AusSearchContainerForPVO[])models.toArray(new AusSearchContainerForPVO[models.size()]);
		return vos;
	}
