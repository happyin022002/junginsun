...
*@FileName : Kor24IbTransWhfVO.java
*@FileTitle : Kor24IbTransWhfVO
*Open Issues :
*Change history :
...
public class Kor24IbTransWhfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24IbTransWhfVO> models = new ArrayList<Kor24IbTransWhfVO>();
	...
	public Kor24IbTransWhfVO() {}

	public Kor24IbTransWhfVO(String ibflag, String pagerows, String transType, String transTypeChg, String bkgNo, String ktPort, String ktSeq, String inBound, String podTml, String kcdTp, String exptKcdTp) {
		this.ktSeq = ktSeq;
		this.bkgNo = bkgNo;
	 ...
	 */
	public Kor24IbTransWhfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24IbTransWhfVO[]
	 */
	public Kor24IbTransWhfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24IbTransWhfVO model = null;
	 ...
	 * @return Kor24IbTransWhfVO[]
	 */
	public Kor24IbTransWhfVO[] getKor24IbTransWhfVOs(){
		Kor24IbTransWhfVO[] vos = (Kor24IbTransWhfVO[])models.toArray(new Kor24IbTransWhfVO[models.size()]);
		return vos;
	}
