...
*@FileName : RFAGroupLocationProposalDBDAORsltGrpLocInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAORsltGrpLocInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAORsltGrpLocInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAORsltGrpLocInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND EXISTS ( SELECT 'X' FROM PRI_RP_SCP_GRP_LOC_DTL" ).append("\n"); 
