...
public class EurManifestListVO extends ManifestListDetailVO {
	...
	public EurManifestListVO(String ibflag, String pagerows, String blNo,
			String dtSeq, String cntrNos, String polCd, String podCd,
			String bPolCd, String bPodCd, String delCd, String custToOrdFlg,
			String ensInfo, String shNm, String shAd, String shCt, String shCn,
			String shZip, String shStr, String shEori, String cneeNm1,
			String cneeAd1, String cneeCt1, String cneeCn1, String cneeZip1,
			String cneeStr1, String cneeEori1, String ntfyNm1, String ntfyAd1,
			String ntfyCt1, String ntfyCn1, String ntfyZip1, String ntfyStr1,
			String ntfyEori1, String bkgNo, String vslCallsign,
			String vslLloydcode, String vslFullname, String eta, String etd,
			String pofe, String mrn, String exsMrn, String exportMrn, String pofeEta, String cneeNm,
			String cneeAd, String cneeCt, String cneeCn, String cneeZip,
			String cneeStr, String cneeEori, String ntfyNm, String ntfyAd,
			String ntfyCt, String ntfyCn, String ntfyZip, String ntfyStr,
			String ntfyEori, String errYn, String polYdCd, String podYdCd, String slanCd, String cntrPrtFlg,
			String hsCd, String cgoDesc, String bkgCgoTpCd) {
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCustToOrdFlg(JSPUtil.getParameter(request, prefix
				+ "cust_to_ord_flg", ""));
		...
		setHsCd(JSPUtil.getParameter(request, prefix + "hs_cd", ""));
	...
	public EurManifestListVO[] fromRequestGrid(HttpServletRequest request,
		...
		try {
			String[] ntfyZip = (JSPUtil.getParameter(request, prefix
					+ "ntfy_zip", length));
			String[] eta = (JSPUtil.getParameter(request, prefix + "eta",
					length));
			String[] cneeStr1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_str1", length));
			String[] dtSeq = (JSPUtil.getParameter(request, prefix + "dt_seq",
					length));
			String[] cntrNos = (JSPUtil.getParameter(request, prefix
					+ "cntr_nos", length));
			String[] etd = (JSPUtil.getParameter(request, prefix + "etd",
					length));
			String[] blNo = (JSPUtil.getParameter(request, prefix + "bl_no",
					length));
			String[] ntfyNm1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_nm1", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix
					+ "pagerows", length));
			String[] cneeCt = (JSPUtil.getParameter(request,
					prefix + "cnee_ct", length));
			String[] polCd = (JSPUtil.getParameter(request, prefix + "pol_cd",
					length));
			String[] cneeZip1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_zip1", length));
			String[] custToOrdFlg = (JSPUtil.getParameter(request, prefix
					+ "cust_to_ord_flg", length));
			String[] cneeCn = (JSPUtil.getParameter(request,
					prefix + "cnee_cn", length));
			String[] cneeStr = (JSPUtil.getParameter(request, prefix
					+ "cnee_str", length));
			String[] vslFullname = (JSPUtil.getParameter(request, prefix
					+ "vsl_fullname", length));
			String[] cneeCt1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_ct1", length));
			String[] vslCallsign = (JSPUtil.getParameter(request, prefix
					+ "vsl_callsign", length));
			String[] ntfyCt1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_ct1", length));
			String[] delCd = (JSPUtil.getParameter(request, prefix + "del_cd",
					length));
			String[] ntfyAd = (JSPUtil.getParameter(request,
					prefix + "ntfy_ad", length));
			String[] cneeZip = (JSPUtil.getParameter(request, prefix
					+ "cnee_zip", length));
			String[] podCd = (JSPUtil.getParameter(request, prefix + "pod_cd",
					length));
			String[] cneeAd = (JSPUtil.getParameter(request,
					prefix + "cnee_ad", length));
			String[] bPolCd = (JSPUtil.getParameter(request, prefix
					+ "b_pol_cd", length));
			String[] bkgNo = (JSPUtil.getParameter(request, prefix + "bkg_no",
					length));
			String[] ntfyStr = (JSPUtil.getParameter(request, prefix
					+ "ntfy_str", length));
			String[] shCt = (JSPUtil.getParameter(request, prefix + "sh_ct",
					length));
			String[] cneeAd1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_ad1", length));
			String[] shCn = (JSPUtil.getParameter(request, prefix + "sh_cn",
					length));
			String[] ntfyStr1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_str1", length));
			String[] pofe = (JSPUtil.getParameter(request, prefix + "pofe",
					length));
			String[] shZip = (JSPUtil.getParameter(request, prefix + "sh_zip",
					length));
			String[] pofeEta = (JSPUtil.getParameter(request, prefix
					+ "pofe_eta", length));
			String[] shAd = (JSPUtil.getParameter(request, prefix + "sh_ad",
					length));
			String[] mrn = (JSPUtil.getParameter(request, prefix + "mrn",
					length));
			String[] exsMrn = (JSPUtil.getParameter(request, prefix + "exs_mrn",
					length));
			String[] exportMrn = (JSPUtil.getParameter(request, prefix + "export_mrn",
					length));
			String[] cneeEori1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_eori1", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix + "ibflag",
					length));
			String[] ntfyCn = (JSPUtil.getParameter(request,
					prefix + "ntfy_cn", length));
			String[] ensInfo = (JSPUtil.getParameter(request, prefix
					+ "ens_info", length));
			String[] errYn = (JSPUtil.getParameter(request, prefix + "err_yn",
					length));
			String[] bPodCd = (JSPUtil.getParameter(request, prefix
					+ "b_pod_cd", length));
			String[] ntfyEori = (JSPUtil.getParameter(request, prefix
					+ "ntfy_eori", length));
			String[] shEori = (JSPUtil.getParameter(request,
					prefix + "sh_eori", length));
			String[] shNm = (JSPUtil.getParameter(request, prefix + "sh_nm",
					length));
			String[] ntfyCt = (JSPUtil.getParameter(request,
					prefix + "ntfy_ct", length));
			String[] ntfyCn1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_cn1", length));
			String[] cneeEori = (JSPUtil.getParameter(request, prefix
					+ "cnee_eori", length));
			String[] cneeNm1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_nm1", length));
			String[] ntfyNm = (JSPUtil.getParameter(request,
					prefix + "ntfy_nm", length));
			String[] cneeNm = (JSPUtil.getParameter(request,
					prefix + "cnee_nm", length));
			String[] ntfyAd1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_ad1", length));
			String[] vslLloydcode = (JSPUtil.getParameter(request, prefix
					+ "vsl_lloydcode", length));
			String[] shStr = (JSPUtil.getParameter(request, prefix + "sh_str",
					length));
			String[] cneeCn1 = (JSPUtil.getParameter(request, prefix
					+ "cnee_cn1", length));
			String[] ntfyZip1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_zip1", length));
			String[] ntfyEori1 = (JSPUtil.getParameter(request, prefix
					+ "ntfy_eori1", length));
			String[] polYdCd = (JSPUtil.getParameter(request, prefix
					+ "pol_yd_cd", length));
			String[] podYdCd = (JSPUtil.getParameter(request, prefix
					+ "pod_yd_cd", length));
			String[] slanCd = (JSPUtil.getParameter(request, prefix
					+ "slan_cd", length));
			String[] cntrPrtFlg = (JSPUtil.getParameter(request, prefix
					+ "cntr_prt_flg", length));
			String[] hsCd = (JSPUtil.getParameter(request, prefix
					+ "hs_cd", length));
			String[] cgoDesc = (JSPUtil.getParameter(request, prefix
					+ "cgo_desc", length));
			String[] bkgCgoTpCd = (JSPUtil.getParameter(request, prefix
					+ "bkg_cgo_tp_cd", length));
	...
	public EurManifestListVO[] getEurManifestListVOs() {
		EurManifestListVO[] vos = (EurManifestListVO[]) models
				.toArray(new EurManifestListVO[models.size()]);
		return vos;
	}
	...
	public void unDataFormat() {
		this.ntfyZip = this.ntfyZip.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.eta = this.eta.replaceAll(",", "").replaceAll("-", "").replaceAll(
				"/", "").replaceAll(":", "");
		this.cneeStr1 = this.cneeStr1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.dtSeq = this.dtSeq.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cntrNos = this.cntrNos.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.etd = this.etd.replaceAll(",", "").replaceAll("-", "").replaceAll(
				"/", "").replaceAll(":", "");
		this.blNo = this.blNo.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyNm1 = this.ntfyNm1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.pagerows = this.pagerows.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeCt = this.cneeCt.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.polCd = this.polCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeZip1 = this.cneeZip1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.custToOrdFlg = this.custToOrdFlg.replaceAll(",", "").replaceAll(
				"-", "").replaceAll("/", "").replaceAll(":", "");
		this.cneeCn = this.cneeCn.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeStr = this.cneeStr.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.vslFullname = this.vslFullname.replaceAll(",", "").replaceAll("-",
				"").replaceAll("/", "").replaceAll(":", "");
		this.cneeCt1 = this.cneeCt1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.vslCallsign = this.vslCallsign.replaceAll(",", "").replaceAll("-",
				"").replaceAll("/", "").replaceAll(":", "");
		this.ntfyCt1 = this.ntfyCt1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.delCd = this.delCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyAd = this.ntfyAd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeZip = this.cneeZip.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.podCd = this.podCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeAd = this.cneeAd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.bPolCd = this.bPolCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.bkgNo = this.bkgNo.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyStr = this.ntfyStr.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.shCt = this.shCt.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeAd1 = this.cneeAd1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.shCn = this.shCn.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyStr1 = this.ntfyStr1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.pofe = this.pofe.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.shZip = this.shZip.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.pofeEta = this.pofeEta.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.shAd = this.shAd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.mrn = this.mrn.replaceAll(",", "").replaceAll("-", "").replaceAll(
				"/", "").replaceAll(":", "");
		this.exsMrn = this.exsMrn.replaceAll(",", "").replaceAll("-", "").replaceAll(
				"/", "").replaceAll(":", "");
		this.exportMrn = this.exportMrn.replaceAll(",", "").replaceAll("-", "").replaceAll(
				"/", "").replaceAll(":", "");
		this.cneeEori1 = this.cneeEori1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyCn = this.ntfyCn.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ensInfo = this.ensInfo.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.errYn = this.errYn.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.bPodCd = this.bPodCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyEori = this.ntfyEori.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.shEori = this.shEori.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.shNm = this.shNm.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyCt = this.ntfyCt.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyCn1 = this.ntfyCn1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeEori = this.cneeEori.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeNm1 = this.cneeNm1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyNm = this.ntfyNm.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeNm = this.cneeNm.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyAd1 = this.ntfyAd1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.vslLloydcode = this.vslLloydcode.replaceAll(",", "").replaceAll(
				"-", "").replaceAll("/", "").replaceAll(":", "");
		this.shStr = this.shStr.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cneeCn1 = this.cneeCn1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyZip1 = this.ntfyZip1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ntfyEori1 = this.ntfyEori1.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.polYdCd = this.polYdCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.podYdCd = this.podYdCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.slanCd = this.slanCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cntrPrtFlg = this.cntrPrtFlg.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.hsCd = this.hsCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.cgoDesc = this.cgoDesc.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.bkgCgoTpCd = this.bkgCgoTpCd.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
	}
}
