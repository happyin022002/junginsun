...
*@FileName : KorCustomsTransmissionDBDAOaddDGMNFTSndDtlLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOaddDGMNFTSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DGMNFT Send Log Detail
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOaddDGMNFTSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOaddDGMNFTSndDtlLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n"); 
		query.append("SELECT '6TC'" ).append("\n"); 
		...
		query.append("WHERE MSG_LOG_TP_ID =	'6TC'" ).append("\n"); 
