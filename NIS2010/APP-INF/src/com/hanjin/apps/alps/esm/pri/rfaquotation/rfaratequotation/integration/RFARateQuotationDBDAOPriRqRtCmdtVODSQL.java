...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtVODSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
