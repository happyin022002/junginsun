...
*@FileName       : ESM_SQM_0004HTMLAction.java
 ...
 * @author SQM USER
 * @see EsmSqm0004Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0004HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_SQM_0004HTMLAction 객체를 생성
	 */
	public ESM_SQM_0004HTMLAction() {}
	
	/**
	 * HTML DOM 객체의 Value 를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0004Event로 파싱하여 request 에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSqm0004Event event = new EsmSqm0004Event();
