...
*@FileName : RocsmanifestListDownloadDBDAOsearchRocsSendListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsmanifestListDownloadDBDAOsearchRocsSendListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsmanifestListDownloadDBDAOsearchRocsSendListRSQL(){
		setQuery();
		...
		query.append("FileName : RocsmanifestListDownloadDBDAOsearchRocsSendListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	DECODE(A.RTM_EDI_MSG_TP_CD,'1','CANCEL','5','REPLACE','9','ORIGINAL') RTM_EDI_MSG_TP_CD," ).append("\n"); 
		...
		query.append(" WHERE	A.RCV_SND_DIV_CD = 'S' " ).append("\n"); 
		query.append("#if (${msg_type}!= '')" ).append("\n"); 
		query.append("   AND  A.RTM_EDI_MSG_TP_CD	=	@[msg_type]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
