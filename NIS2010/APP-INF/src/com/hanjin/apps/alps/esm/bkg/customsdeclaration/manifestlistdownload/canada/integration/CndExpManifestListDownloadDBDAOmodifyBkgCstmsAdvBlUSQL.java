...
*@FileName : CndExpManifestListDownloadDBDAOmodifyBkgCstmsAdvBlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOmodifyBkgCstmsAdvBlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOmodifyBkgCstmsAdvBlUSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOmodifyBkgCstmsAdvBlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BKG_CSTMS_AMER_BL" ).append("\n"); 
