...
*@FileName : SCRateProposalDBDAOPriSpScpScgAdjVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpScgAdjVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpScgAdjVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpScgAdjVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE pri_sp_scp_scg_adj" ).append("\n"); 
