...
*@FileName : esm_bkg_0414HTMLAction.java
 ...
 * @author Park Mangeon
 * @see EsmBkg0414Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_0414HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0414HTMLAction 객체를 생성
	 */
	public ESM_BKG_0414HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0414Event event = new EsmBkg0414Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			PkupNtcSentHisSchVO pkupNtcSentHisSch =(PkupNtcSentHisSchVO)getVO(request, PkupNtcSentHisSchVO .class);
			event.setPkupNtcSentHisSchVO(pkupNtcSentHisSch);
		}
