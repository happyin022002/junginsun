...
public class PerformanceReportDBDAOSaelsPerformanceReportGeneralRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  TRIM(TO_CHAR(SUM(TEU) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(FEU) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_FEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(TTL) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_TTL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(VOID_TEU) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_VOID_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(VOID_FEU) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_VOID_FEU" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(GROSS) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_GROSS" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(NET) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(NON_NET) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_NON_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(MISC) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_MISC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(NON_REV) OVER( PARTITION BY VVD) ,'999,999,999,990.99')) AS SUB_TOT_NON_REV" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* TOTAL */" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(TEU) OVER() ,'999,999,999,990.99')) AS TOT_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(FEU) OVER() ,'999,999,999,990.99')) AS TOT_FEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(TTL) OVER() ,'999,999,999,990.99')) AS TOT_TTL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(VOID_TEU) OVER() ,'999,999,999,990.99')) AS TOT_VOID_TEU" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(VOID_FEU) OVER() ,'999,999,999,990.99')) AS TOT_VOID_FEU" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(GROSS) OVER() ,'999,999,999,990.99')) AS TOT_GROSS" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(NET) OVER() ,'999,999,999,990.99')) AS TOT_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(NON_NET) OVER() ,'999,999,999,990.99')) AS TOT_NON_NET" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(MISC) OVER() ,'999,999,999,990.99')) AS TOT_MISC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUM(NON_REV) OVER() ,'999,999,999,990.99')) AS TOT_NON_REV" ).append("\n"); 
		query.append("" ).append("\n"); 
