...
/**
 * ESM_MAS_0329 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0329HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Je Ryang Yoo
 * @see ESM_MAS_0329HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0329Event extends EventSupport {
	...
	/** Constructor */
	public EsmMas0329Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmMas0329Event";
	}
