...
public class BookingMasterMgtDBDAOSearchVvdBDRTimeVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append(", 	DECODE(TRNK_AUTO_BDR_FLG,'Y','A',Decode(TRNK_MNL_BDR_FLG,'Y','M', DECODE(TRNK_BDR_CRE_USR_ID, NULL, '', 'M'))) TRNK_AUTO_BDR_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(", 	DECODE(FDR_AUTO_BDR_FLG,'Y','A',Decode(FDR_MNL_BDR_FLG,'Y','M', DECODE(FDR_BDR_CRE_USR_ID, NULL, '', 'M'))) FDR_AUTO_BDR_FLG" ).append("\n"); 
