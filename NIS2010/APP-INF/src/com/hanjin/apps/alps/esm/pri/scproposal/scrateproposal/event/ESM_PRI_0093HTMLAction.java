 ...
 *@FileName : UI_PRI_0093HTMLAction.java
 *@FileTitle : ESM_PRI_0093HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_0093HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0093Event event = new EsmPri0093Event();
