...
public class ESM_BKG_0620HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0620HTMLAction 객체를 생성
	 */
	public ESM_BKG_0620HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0620Event event = new EsmBkg0620Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTroStatusListInVO((TroStatusListInVO)getVO(request, TroStatusListInVO .class));
