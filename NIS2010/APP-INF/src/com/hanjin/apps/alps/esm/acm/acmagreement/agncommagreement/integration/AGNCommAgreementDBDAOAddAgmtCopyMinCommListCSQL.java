...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyMinCommListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyMinCommListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add Agmt Copy Minimum Comm List
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyMinCommListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyMinCommListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
