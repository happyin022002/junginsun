...
public class EsmSpc0080ViewAdapter extends ViewAdapter{
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) 
	{
		...
		if (rowCountview > 0 && viewList != null) {//3.1
			...
			String[] typ = {"BSA", "FULL", "EMPTY", "TTL LOAD", "TTL WGT", "FULL LF", "TTL LF", "WGT LF"};
			String rlane_cd   = "";
			String dir_cd     = "";
			String sub_trd_cd = "";
			String opr_cd     = "";
					...
					for(int w = 1 ; w <= duration ; w++) {
						...
						switch (w) {
							case 1: // BSA, FULL, EMPTY, TTL_LOAD, TTL WT, FULL_LF, TTL_LF
								...
								temp8 = viewList.get(i).getTtlWgtLf1();
								break;
							...
							case 2:
								...
								temp8 = viewList.get(i).getTtlWgtLf2();
								break;
							...
							case 3:
								...
								temp8 = viewList.get(i).getTtlWgtLf3();
								break;
							...
							case 4:
								...
								temp8 = viewList.get(i).getTtlWgtLf4();
								break;
							...
							case 5:
								...
								temp8 = viewList.get(i).getTtlWgtLf5();
								break;
							...
							case 6:
								...
								temp8 = viewList.get(i).getTtlWgtLf6();
								break;
							...
							case 7:
								...
								temp8 = viewList.get(i).getTtlWgtLf7();
								break;
							...
							case 8:
								...
								temp8 = viewList.get(i).getTtlWgtLf8();
								break;
							...
							case 9:
								...
								temp8 = viewList.get(i).getTtlWgtLf9();
								break;
							...
							case 10:
								...
								temp8 = viewList.get(i).getTtlWgtLf10();
								break;
							...
							case 11:
								...
								temp8 = viewList.get(i).getTtlWgtLf11();
								break;
							...
							case 12:
								...
								temp8 = viewList.get(i).getTtlWgtLf12();
								break;
							...
							case 13:
								...
								temp8 = viewList.get(i).getTtlWgtLf13();
								break;
							...
							case 14:
								...
								temp8 = viewList.get(i).getTtlWgtLf14();
								break;
							...
							case 15:
								...
								temp8 = viewList.get(i).getTtlWgtLf15();
								break;
						}
