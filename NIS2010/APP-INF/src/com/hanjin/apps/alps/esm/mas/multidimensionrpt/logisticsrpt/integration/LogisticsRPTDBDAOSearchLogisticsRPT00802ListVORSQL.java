...
public class LogisticsRPTDBDAOSearchLogisticsRPT00802ListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_MAS_0080화면에서  DETAIL에 대한 쿼리입니다. - 품질향상
	  * 
	  * 
	...
	public void setQuery(){
		...
		query.append("      ,MAS_GET_CD_NM_FNC('CD01065', DECODE(D1.COST_ACT_GRP_TP_CD, 'N', 'TM', 'TR')) LGS_KPI_COST_GRP_NM" ).append("\n"); 
		...
		query.append("           MAS_GET_CD_NM_FNC(DECODE( D1.P_KPITYPE, '1','CD01064', '2', 'CD00950'), D1.KPI_CD)" ).append("\n"); 
		...
		query.append("                      ,MAS_BKG_LGS_SMRY A3" ).append("\n"); 
		...
		query.append("         ,D1.COST_ACT_GRP_TP_CD" ).append("\n"); 
		query.append("         ,MAS_GET_CD_NM_FNC('CD01065', DECODE(D1.COST_ACT_GRP_TP_CD, 'N', 'TM', 'TR')) " ).append("\n"); 
