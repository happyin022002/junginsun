 ...
 *@FileName : ESM_PRI_6014_05HTMLAction.java
 *@FileTitle : S/C Quotation Rate Creation (For AEW/AEE)
 *Open Issues :
 *Change history :
...
public class ESM_PRI_6014_05HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6014_05HTMLAction 객체를 생성
	 */
	public ESM_PRI_6014_05HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri601405Event event = new EsmPri601405Event();
		...
		if (command.isCommand(FormCommand.MULTI01)) {
			...
			// excel down ver
			event.getRateQuotationVO().setSvcScpCd(JSPUtil.getParameter(request, "svc_scp_cd"));
			event.getRateQuotationVO().setPriRqRtCmdtHdrVO((PriRqRtCmdtHdrVO) getVO(request, PriRqRtCmdtHdrVO.class));
