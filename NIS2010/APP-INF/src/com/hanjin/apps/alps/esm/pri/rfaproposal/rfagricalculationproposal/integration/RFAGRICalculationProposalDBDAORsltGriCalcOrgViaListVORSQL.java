...
*@FileName : RFAGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
