...
*@FileName : MTCostDBDAOSearchMTCost12ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCost12ListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCost12ListVORSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCost12ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
