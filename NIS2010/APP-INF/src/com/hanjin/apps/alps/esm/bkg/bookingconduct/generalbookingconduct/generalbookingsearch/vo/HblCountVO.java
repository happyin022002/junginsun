...
*@FileName : HblCountVO.java
*@FileTitle : HblCountVO
*Open Issues :
*Change history :
...
public class HblCountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<HblCountVO> models = new ArrayList<HblCountVO>();
	...
	public HblCountVO(String ibflag, String pagerows, String hblTtlKnt) {
		this.ibflag = ibflag;
	 ...
	 * @return HblCountVO[]
	 */
	public HblCountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return HblCountVO[]
	 */
	public HblCountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HblCountVO model = null;
	...
	public HblCountVO[] getHblCountVOs(){
		HblCountVO[] vos = (HblCountVO[])models.toArray(new HblCountVO[models.size()]);
		return vos;
	}
