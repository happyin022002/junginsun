...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutDirCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutDirCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpRtRoutDirCopyToProposal
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutDirCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutDirCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , L.DIR_CALL_FLG" ).append("\n"); 
		query.append("     , 'I'" ).append("\n"); 
		query.append("     , L.SRC_INFO_CD" ).append("\n"); 
