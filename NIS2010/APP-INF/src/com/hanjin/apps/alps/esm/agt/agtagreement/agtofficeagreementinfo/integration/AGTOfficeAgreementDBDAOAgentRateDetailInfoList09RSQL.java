...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList09RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList09RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_rout_ref 조회 하여 sls_ofc_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList09RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList09RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM   (SELECT DISTINCT ROUT_INFO_CD AS CD" ).append("\n"); 
		...
		query.append("AND    ROUT_REF_DIV_CD = 'SAOF'" ).append("\n"); 
