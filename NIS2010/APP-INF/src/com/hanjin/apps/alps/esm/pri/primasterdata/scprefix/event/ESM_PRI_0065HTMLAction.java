...
*@FileName : UI_PRI_0065HTMLAction.java
...
public class ESM_PRI_0065HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0065HTMLAction 객체를 생성
	 */
	public ESM_PRI_0065HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0065Event event = new EsmPri0065Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriScPfxMapgVOS((PriScPfxMapgVO[])getVOs(request, PriScPfxMapgVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setPriScPfxMapgVO((PriScPfxMapgVO)getVO(request, PriScPfxMapgVO .class));
		}
