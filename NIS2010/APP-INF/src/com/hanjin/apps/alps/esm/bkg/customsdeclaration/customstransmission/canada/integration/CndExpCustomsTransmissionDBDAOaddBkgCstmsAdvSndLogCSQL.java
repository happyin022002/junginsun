...
*@FileName : CndExpCustomsTransmissionDBDAOaddBkgCstmsAdvSndLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOaddBkgCstmsAdvSndLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addBkgCstmsAdvSndLog
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOaddBkgCstmsAdvSndLogCSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOaddBkgCstmsAdvSndLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
