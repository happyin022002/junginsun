...
import com.hanjin.apps.alps.esm.agt.agtaudit.facaudit.event.EsmAgt0034Event;
...
public class FACAuditDBDAO extends DBDAOSupport {
    ...
    */
     ...
     * @throws DAOException
     */
    public void createFACAPTempTable(Event et, HashMap paramHash) throws DAOException {
    	EsmAgt0034Event event = (EsmAgt0034Event)et;
...
//        return dRs;
     ...
     * @throws DAOException
     */
    public void createFACAcutalINFFromAPbyMSG(HashMap paramHash, HashMap eaiHash) throws DAOException {
    	Connection con = null;				// Connection Interface  
        PreparedStatement updatePs1 = null; // UPDATE를 수행하기 위한 SQL Statement
