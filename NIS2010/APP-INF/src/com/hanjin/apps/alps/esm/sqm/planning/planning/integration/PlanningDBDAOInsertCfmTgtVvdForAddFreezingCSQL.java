...
public class PlanningDBDAOInsertCfmTgtVvdForAddFreezingCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Freezing, Add Freezing 시 SQM_CFM_TGT_VVD에 insert
	  * 
	...
	public void setQuery(){
		query.append("INSERT INTO SQM_CFM_TGT_VVD(QTA_RLSE_VER_NO, BSE_TP_CD, BSE_YR, BSE_QTR_CD, QTA_TGT_CD, TRD_CD, RLANE_CD, DIR_CD, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, BSE_MON, BSE_WK, SLS_YRMON, CONV_DIR_CD, SUB_TRD_CD, IOC_CD, FNL_BSA_CAPA, LOD_QTY, GRS_REV, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
