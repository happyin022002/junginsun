...
public class AGNCommCalculationDBDAOSearchAGNCommMassCalExcelListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   WHERE R.BKG_NO = A.BKG_NO" ).append("\n"); 
		...
		query.append("  ) AS REV_MON, -- R.Mon" ).append("\n"); 
		...
		query.append("   WHERE AGN_CD = A.AGN_CD AND ROWNUM = 1" ).append("\n"); 
		query.append("  ) AS HQ_OFC_CD," ).append("\n"); 
