...
public class KrWharfageDecMgtDBDAOmergeSearchBkgKrWhfBlCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("CASE WHEN @[cstms_decl_tp_cd] = 'I' AND A.KR_CSTMS_BND_CD = 'M' THEN 'IM'" ).append("\n"); 
		query.append("WHEN @[cstms_decl_tp_cd] = 'I' THEN 'II'" ).append("\n"); 
		query.append("WHEN @[cstms_decl_tp_cd] = 'T' THEN 'IT'" ).append("\n"); 
		query.append("WHEN @[cstms_decl_tp_cd] = 'E' AND A.KR_CSTMS_BND_CD = 'M' THEN 'OM'" ).append("\n"); 
		...
		query.append("@[whf_pol_cd] IN ('KRPUS', 'KRKAN', 'KRINC', 'KRPTK','KRGIN') AND" ).append("\n"); 
		query.append("A.POD_CD IN ('KRPUS', 'KRKAN', 'KRINC', 'KRPTK','KRGIN') AND" ).append("\n"); 
		...
		query.append("@[whf_pol_cd] IN ('KRPUS', 'KRKAN', 'KRINC', 'KRPTK','KRGIN') AND" ).append("\n"); 
		query.append("A.POL_CD IN ('KRPUS', 'KRKAN', 'KRINC', 'KRPTK','KRGIN') AND" ).append("\n"); 
		...
		query.append("FROM BKG_CSTMS_KR_BL A, NISADM.BKG_BOOKING B, NISADM.BKG_RATE C," ).append("\n"); 
