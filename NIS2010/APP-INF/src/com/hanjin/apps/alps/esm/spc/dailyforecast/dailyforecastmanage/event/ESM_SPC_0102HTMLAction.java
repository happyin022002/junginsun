...
*@FileName : ESM_SPC_0107HTMLAction.java
...
public class ESM_SPC_0102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0102HTMLAction 객체를 생성
	 */
	public ESM_SPC_0102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setSpcDlyFcastCustVOS(spcDlyFcastCustVO.fromRequestGrid(request, ""));
		}		
