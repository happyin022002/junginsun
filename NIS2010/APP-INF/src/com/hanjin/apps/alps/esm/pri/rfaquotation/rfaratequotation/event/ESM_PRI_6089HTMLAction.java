...
*@FileName : ESM_PRI_6089HTMLAction.java
...
public class ESM_PRI_6089HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6089HTMLAction 객체를 생성
	 */
	public ESM_PRI_6089HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6089Event event = new EsmPri6089Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPriRqRtCmdtHdrVO((PriRqRtCmdtHdrVO)getVO(request, PriRqRtCmdtHdrVO .class));
		}
