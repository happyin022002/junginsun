...
*@FileName : KorCustomsTransmissionDBDAOaddCUSREPSndLogOldCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOaddCUSREPSndLogOldCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOaddCUSREPSndLogOldCSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOaddCUSREPSndLogOldCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , NULL" ).append("\n"); 
		query.append("     , DECODE(@[resnd_chk],'P',DECODE(@[kt_pa],20,'KMPAE010',30,'KMPAE030',622,'KMPAE050',31,'KMPAE030'),RPAD('KTNETULHS4G',20))" ).append("\n"); 
		query.append("     , @[user_id]" ).append("\n"); 
		query.append("     , @[user_id]" ).append("\n"); 
