...
*@FileTitle      : AES No. Input 화면(UI_HOM_3058)에서 정보 생성시 ALPS 로 I/F
*@Author         : Jong-ho Kim
*Open Issues     :
*Change history  :
...
---------------------------------------------------------------------------
 History
* 2012.06.12 김종호 [CHM-201218129] Split 03-[2차] Homepage 수정 요청 : CAED 관련 19 항목 추가
=========================================================*/
...
import com.hanjin.irep.alpsws.WEB0060001Document;
import com.hanjin.irep.alpsws.WEB0060001Document.WEB0060001;
import com.hanjin.irep.alpsws.WEB0060001Document.WEB0060001.DataArea;
import com.hanjin.irep.alpsws.WEB0060001Document.WEB0060001.DataArea.AesInfoCollection;
import com.hanjin.irep.alpsws.WEB0060001Document.WEB0060001.DataArea.AesInfoCollection.AesInfoRequest;
import com.hanjin.irep.alpsws.WEB0060001Document.WEB0060001.DataArea.AesInfoCollection.AesInfoResponse;
...
@WLHttpTransport(contextPath="/hanjin/webservices", serviceUri="/BKGWeb0060001WSProxy",
...
public class BKGWeb0060001WSProxy {
	...
	/**
	 * AES No. Input 화면(UI_HOM_3058)에서 정보 생성시 ALPS 로 I/F <br>
	 * 
	 * @author Jong-ho Kim
