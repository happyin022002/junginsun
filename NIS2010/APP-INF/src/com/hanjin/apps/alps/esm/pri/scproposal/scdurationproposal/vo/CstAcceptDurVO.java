...
*@FileName : CstAcceptDurVO.java
*@FileTitle : CstAcceptDurVO
*Open Issues :
*Change history :
...
public class CstAcceptDurVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstAcceptDurVO> models = new ArrayList<CstAcceptDurVO>();
	...
	public CstAcceptDurVO() {}

	public CstAcceptDurVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String prcProgStsCd, String n1stCmncAmdtSeq, String acptUsrId, String acptOfcCd, String acptDt, String updUsrId, String updDt, String stsCd) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CstAcceptDurVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstAcceptDurVO[]
	 */
	public CstAcceptDurVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstAcceptDurVO model = null;
	 ...
	 * @return CstAcceptDurVO[]
	 */
	public CstAcceptDurVO[] getCstAcceptDurVOs(){
		CstAcceptDurVO[] vos = (CstAcceptDurVO[])models.toArray(new CstAcceptDurVO[models.size()]);
		return vos;
	}
