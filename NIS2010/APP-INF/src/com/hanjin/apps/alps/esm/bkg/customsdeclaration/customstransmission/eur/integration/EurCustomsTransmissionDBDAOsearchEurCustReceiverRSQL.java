...
*@FileName : EurCustomsTransmissionDBDAOsearchEurCustReceiverRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurCustomsTransmissionDBDAOsearchEurCustReceiverRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EurCustomsTransmissionDBDAOsearchEurCustReceiverRSQL
	  * </pre>
	  */
	public EurCustomsTransmissionDBDAOsearchEurCustReceiverRSQL(){
		setQuery();
		...
		query.append("FileName : EurCustomsTransmissionDBDAOsearchEurCustReceiverRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND 	INTG_CD_VAL_DESC = @[cnt_cd]" ).append("\n"); 
