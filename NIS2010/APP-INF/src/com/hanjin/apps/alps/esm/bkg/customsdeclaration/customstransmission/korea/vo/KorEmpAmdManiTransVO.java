...
*@FileName : KorEmpAmdManiTransVO.java
*@FileTitle : KorEmpAmdManiTransVO
*Open Issues :
*Change history :
...
public class KorEmpAmdManiTransVO extends EmpAmdManiTransVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorEmpAmdManiTransVO> models = new ArrayList<KorEmpAmdManiTransVO>();
	...
	public KorEmpAmdManiTransVO() {}

	public KorEmpAmdManiTransVO(String ibflag, String pagerows, String ibTsSeq, String ibTsCblno, String ibTsPort, String ibTsBkgno, String ibTsType, String ibTsVvd, String corrCd, String corrReason, String usrId, String subNo, String blNo, String receiver, String ofcCd) {
...
/**
	 ...
	 * @param request
	 * @return KorEmpAmdManiTransVO[]
	 */
	public KorEmpAmdManiTransVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorEmpAmdManiTransVO[]
	 */
	public KorEmpAmdManiTransVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEmpAmdManiTransVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new KorEmpAmdManiTransVO();
				if (ibTsBkgno[i] != null)
		...
		return getKorEmpAmdManiTransVOs();
	}
	 ...
	 * @return KorEmpAmdManiTransVO[]
	 */
	public KorEmpAmdManiTransVO[] getKorEmpAmdManiTransVOs(){
		KorEmpAmdManiTransVO[] vos = (KorEmpAmdManiTransVO[])models.toArray(new KorEmpAmdManiTransVO[models.size()]);
		return vos;
	}
