...
*@FileName : SCRateQuotationDBDAOPriSqRtScgRoutCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtScgRoutCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtScgRoutCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtScgRoutCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
