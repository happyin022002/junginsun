...
*@FileName : KorWareHouseCondVO.java
*@FileTitle : KorWareHouseCondVO
*Open Issues :
*Change history :
...
public class KorWareHouseCondVO extends WareHouseCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorWareHouseCondVO> models = new ArrayList<KorWareHouseCondVO>();
	...
	public KorWareHouseCondVO() {}

	public KorWareHouseCondVO(String ibflag, String pagerows, String cntCd, String whCd, String locCd, String whNm, String cstmsCd) {
		this.locCd = locCd;
		this.ibflag = ibflag;
		this.whCd = whCd;
		this.cntCd = cntCd;
	 ...
	 */
	public KorWareHouseCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorWareHouseCondVO[]
	 */
	public KorWareHouseCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorWareHouseCondVO model = null;
	 ...
	 * @return KorWareHouseCondVO[]
	 */
	public KorWareHouseCondVO[] getKorWareHouseCondVOs(){
		KorWareHouseCondVO[] vos = (KorWareHouseCondVO[])models.toArray(new KorWareHouseCondVO[models.size()]);
		return vos;
	}
