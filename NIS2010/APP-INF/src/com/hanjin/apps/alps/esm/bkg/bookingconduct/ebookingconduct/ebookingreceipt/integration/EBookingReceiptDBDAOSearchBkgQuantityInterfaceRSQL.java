...
*@FileName : EBookingReceiptDBDAOSearchBkgQuantityInterfaceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchBkgQuantityInterfaceRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchBkgQuantityInterfaceRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOSearchBkgQuantityInterfaceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       CNTR_QTY OP_CNTR_QTY," ).append("\n"); 
