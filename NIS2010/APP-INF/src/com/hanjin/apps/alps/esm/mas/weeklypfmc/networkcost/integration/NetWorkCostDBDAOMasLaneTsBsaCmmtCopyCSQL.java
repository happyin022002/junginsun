...
*@FileName : NetWorkCostDBDAOMasLaneTsBsaCmmtCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetWorkCostDBDAOMasLaneTsBsaCmmtCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetWorkCostDBDAOMasLaneTsBsaCmmtCopyCSQL(){
		setQuery();
		...
		query.append("FileName : NetWorkCostDBDAOMasLaneTsBsaCmmtCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   INTO MAS_LANE_TS_BSA_CMMT" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		...
		query.append("   FROM MAS_LANE_TS_BSA_CMMT" ).append("\n"); 
