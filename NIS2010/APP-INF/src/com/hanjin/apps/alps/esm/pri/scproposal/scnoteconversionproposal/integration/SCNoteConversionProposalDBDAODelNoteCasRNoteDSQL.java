...
*@FileName : SCNoteConversionProposalDBDAODelNoteCasRNoteDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAODelNoteCasRNoteDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Route Note Amend Cancel시 해당 Note Conv 삭제
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAODelNoteCasRNoteDSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAODelNoteCasRNoteDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
