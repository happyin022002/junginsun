...
*@FileName : TRIGRICalculationProposalDBDAOPriTriGriRoutPntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAOPriTriGriRoutPntVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriTriGriRoutPntVO Delete
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAOPriTriGriRoutPntVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAOPriTriGriRoutPntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_GRI_ROUT_PNT" ).append("\n"); 
