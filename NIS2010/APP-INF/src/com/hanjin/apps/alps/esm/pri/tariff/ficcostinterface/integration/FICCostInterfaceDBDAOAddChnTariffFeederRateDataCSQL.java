...
*@FileName : FICCostInterfaceDBDAOAddChnTariffFeederRateDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOAddChnTariffFeederRateDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Feeder Asia(SIN,SHA) Cost Interface
	  * </pre>
	  */
	public FICCostInterfaceDBDAOAddChnTariffFeederRateDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOAddChnTariffFeederRateDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                    FROM #if(${rhq_cd} == 'SINRS')" ).append("\n"); 
		query.append("                             AOC_CHN_FDR_TRF_DTL  A," ).append("\n"); 
		query.append("                             AOC_CHN_FDR_TRF_HDR  B," ).append("\n"); 
		query.append("                             AOC_CHN_FDR_RF_TRF_DTL G," ).append("\n"); 
