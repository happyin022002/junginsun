...
*@FileName : RFAProposalDEMDETDBDAORqCpPriRpDmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalDEMDETDBDAORqCpPriRpDmdtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Copy to proposal (RFA Quotation)
	  * </pre>
	  */
	public RFAProposalDEMDETDBDAORqCpPriRpDmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalDEMDETDBDAORqCpPriRpDmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
