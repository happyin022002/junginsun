...
*@FileName : Kor24ManifestListDBDAOsearchWhfNoticeRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchWhfNoticeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchWhfNoticeRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchWhfNoticeRSQL").append("\n");
		query.append("*/").append("\n");
	}
