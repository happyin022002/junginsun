...
*@FileName : PriSpScpTrspAddChgGriArbOKCLSubListVO.java
*@FileTitle : PriSpScpTrspAddChgGriArbOKCLSubListVO
*Open Issues :
*Change history :
...
public class PriSpScpTrspAddChgGriArbOKCLSubListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpTrspAddChgGriArbOKCLSubListVO> models = new ArrayList<PriSpScpTrspAddChgGriArbOKCLSubListVO>();
	...
	public PriSpScpTrspAddChgGriArbOKCLSubListVO() {}

	public PriSpScpTrspAddChgGriArbOKCLSubListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String orgDestTpCd, String griGrpSeq, String griAdjSeq, String ratUtCd, String prcCgoTpCd, String currCd, String griRtAmt, String griRtRto, String fltPctTpCd, String updUsrId, String creUsrId) {
	 ...
	 */
	public PriSpScpTrspAddChgGriArbOKCLSubListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpTrspAddChgGriArbOKCLSubListVO[]
	 */
	public PriSpScpTrspAddChgGriArbOKCLSubListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpTrspAddChgGriArbOKCLSubListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpTrspAddChgGriArbOKCLSubListVO();
				if (griRtAmt[i] != null)
		...
		return getPriSpScpTrspAddChgGriArbOKCLSubListVOs();
	}
	...
	public PriSpScpTrspAddChgGriArbOKCLSubListVO[] getPriSpScpTrspAddChgGriArbOKCLSubListVOs(){
		PriSpScpTrspAddChgGriArbOKCLSubListVO[] vos = (PriSpScpTrspAddChgGriArbOKCLSubListVO[])models.toArray(new PriSpScpTrspAddChgGriArbOKCLSubListVO[models.size()]);
		return vos;
	}
