...
*@FileName : KorManifestListDBDAOmodifyTransmitDateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOmodifyTransmitDateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOmodifyTransmitDateUSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOmodifyTransmitDateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
