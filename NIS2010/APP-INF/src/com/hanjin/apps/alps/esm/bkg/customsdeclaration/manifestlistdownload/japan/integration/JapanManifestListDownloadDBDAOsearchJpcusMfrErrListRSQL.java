...
*@FileName : JapanManifestListDownloadDBDAOsearchJpcusMfrErrListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOsearchJpcusMfrErrListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOsearchJpcusMfrErrListRSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOsearchJpcusMfrErrListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND ( SUBSTR(RCV_KEY_DAT_CTNT,1,3) != '000'" ).append("\n"); 
		query.append("OR SUBSTR(RCV_KEY_DAT_CTNT,5,3) != '000'" ).append("\n"); 
		query.append("OR SUBSTR(RCV_KEY_DAT_CTNT,9,3) != '000'" ).append("\n"); 
		query.append("OR SUBSTR(RCV_KEY_DAT_CTNT,13,3) != '000')" ).append("\n"); 
