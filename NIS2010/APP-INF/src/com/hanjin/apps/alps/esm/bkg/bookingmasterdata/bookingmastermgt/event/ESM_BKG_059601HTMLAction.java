...
*@FileName : ESM_BKG_0596HTMLAction.java
...
public class ESM_BKG_059601HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0596HTMLAction 객체를 생성
	 */
	public ESM_BKG_059601HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg059601Event event = new EsmBkg059601Event();
		
		log.debug(request.getParameter("bdr_flag"));
		if(command.isCommand(FormCommand.MULTI01) || command.isCommand(FormCommand.MULTI02) || command.isCommand(FormCommand.MULTI03) || command.isCommand(FormCommand.MULTI04)) {
			event.setSearchBDRTimeVOS((SearchBDRTimeVO[])getVOs(request, SearchBDRTimeVO .class,""));
			event.setSearchBDRTimeVO((SearchBDRTimeVO)getVO(request, SearchBDRTimeVO .class));
		}
