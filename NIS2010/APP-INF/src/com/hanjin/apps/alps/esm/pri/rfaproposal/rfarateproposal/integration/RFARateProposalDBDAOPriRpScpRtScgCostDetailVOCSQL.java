...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgCostDetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgCostDetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgCostDetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgCostDetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ( SELECT PRC_CTRT_CUST_TP_CD FROM PRI_RP_MN WHERE PROP_NO = @[prop_no] AND AMDT_SEQ = @[amdt_seq]  ) AS CUST_TP_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    FROM  PRI_RP_SCP_RT               RT  ," ).append("\n"); 
		query.append("            PRI_RP_SCP_RT_USD_ROUT_CS   RR  ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("    WHERE  RR.PROP_NO             = RT.PROP_NO" ).append("\n"); 
		...
		query.append("AND   G.PRC_CTRT_TP_CD    = 'R'/* 현재 R 은 없음 */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(") ," ).append("\n"); 
		...
		query.append("    FROM  PRI_RFA_NOTE_CONV NC" ).append("\n"); 
		...
		query.append("/* START ############################### 2010.04.05 ADD */" ).append("\n"); 
		query.append("--SELECT BQ_SEQ       ," ).append("\n"); 
		query.append("--    SEL_TP_CD      ," ).append("\n"); 
		query.append("--    SEL_TP_PRIO     ," ).append("\n"); 
		query.append("--    CHG_CD       ," ).append("\n"); 
		...
		query.append("--" ).append("\n"); 
		query.append("--UNION ALL" ).append("\n"); 
		query.append("/* END   ############################### 2010.04.05 ADD */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT BQ_SEQ       ," ).append("\n"); 
		query.append("    SEL_TP_CD      ," ).append("\n"); 
		query.append("    SEL_TP_PRIO     ," ).append("\n"); 
		...
		query.append("    GS.SUR_RT_AMT   ," ).append("\n"); 
		...
		query.append("    ELSE FN.SUR_RT_AMT END, 0)             AS TRF_SCG_AMT  ," ).append("\n"); 
		query.append("    NVL(CASE" ).append("\n"); 
		...
		query.append("    NVL(CASE" ).append("\n"); 
		query.append("    WHEN FN.RT_INCL_FLG = 'N' AND FN.RAT_UT_CD = 'PC' THEN NVL(F1.CHG_AMT, 0) * FN.RAT_AS_QTY / 100" ).append("\n"); 
		query.append("    ELSE FN.CHG_AMT END, 0) / DECODE(NVL(USD_LOCL_XCH_RT,0), 0, 1, USD_LOCL_XCH_RT) AS ADJ_SCG_USD_AMT " ).append("\n"); 
		...
		query.append("    (A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ, A.RT_SEQ," ).append("\n"); 
		...
		query.append("    (B.PROP_NO, B.AMDT_SEQ, B.SVC_SCP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.RT_SEQ," ).append("\n"); 
