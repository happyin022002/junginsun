...
public class CaSummaryReportOutVO extends AbstractValueObject {
	...
	/* Column Info */
	private String totCntBlTtl = null;
	/* Column Info */
	...
	public CaSummaryReportOutVO(String ibflag, String pagerows, String corrDt, String cntHlgC, String blNo, String cxlModiFlg, String polCd, String cntHlgM, String ctrtOfcCd, String updUsrId, String bkgOfcCd, String delCd, String corrUsrId, String slsRhqCd, String vvd, String podCd, String cntCaTtl, String bkgNo, String blObrdDt, String porCd, String custNm, String creDt, String cntClassN, String cntRsnA, String cntRsnC, String cntExempt, String cntClassE, String corrOfcCd, String updDt, String caRsnCd, String cntRsnM, String bkgSplitModiFlg, String cntBlTtl, String cntRsnR, String corrNo, String cntRsnG, String cntClassR, String cntKindA, String cntKindB, String cntKindC, String diffRmk, String cntKindD, String cntKindI, String cntKindJ, String cntKindK, String cntKindE, String cntKindF, String cntKindG, String cntKindH, String rev, String nonrev, String exp, String exemption, String gsoOfcCd, String ctrtSrepCd, String totCntBlTtl, String cntRsnD) {
		this.corrDt = corrDt;
		...
		this.totCntBlTtl = totCntBlTtl;
		this.cntRsnR = cntRsnR;
		this.corrNo = corrNo;
		this.cntRsnG = cntRsnG;
		this.cntRsnD = cntRsnD;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("exp", getExp());
		...
		this.hashColumns.put("nonrev", getNonrev());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("nonrev", "nonrev");
	 ...
	 * @return totCntBlTtl
	 */
	public String getTotCntBlTtl() {
		return this.totCntBlTtl;
	}
	 ...
	 * @param totCntBlTtl
	 */
	public void setTotCntBlTtl(String totCntBlTtl) {
		this.totCntBlTtl = totCntBlTtl;
	}
	 ...
	 * @param cntRsnD
	 */
	public void setCntRsnD(String cntRsnD) {
		this.cntRsnD = cntRsnD;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setExp(JSPUtil.getParameter(request, prefix + "exp", ""));
		...
		setNonrev(JSPUtil.getParameter(request, prefix + "nonrev", ""));
		...
		setTotCntBlTtl(JSPUtil.getParameter(request, prefix + "tot_cnt_bl_ttl", ""));
		...
		setCntRsnD(JSPUtil.getParameter(request, prefix + "cnt_rsn_d", ""));
	...
	public CaSummaryReportOutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] exp = (JSPUtil.getParameter(request, prefix	+ "exp", length));
			...
			String[] nonrev = (JSPUtil.getParameter(request, prefix	+ "nonrev", length));
			...
			String[] totCntBlTtl = (JSPUtil.getParameter(request, prefix	+ "tot_cnt_bl_ttl", length));
			...
			String[] cntRsnD = (JSPUtil.getParameter(request, prefix	+ "cnt_rsn_d", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (totCntBlTtl[i] != null)
					model.setTotCntBlTtl(totCntBlTtl[i]);
				if (cntRsnR[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.exp = this.exp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.totCntBlTtl = this.totCntBlTtl .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.cntRsnD = this.cntRsnD .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
