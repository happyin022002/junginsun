...
*@FileName : Kor24CustomsTransmissionDBDAOaddCUSREPSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddCUSREPSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LOG 관리를 위한 작업(DETAIL)
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddCUSREPSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddCUSREPSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
