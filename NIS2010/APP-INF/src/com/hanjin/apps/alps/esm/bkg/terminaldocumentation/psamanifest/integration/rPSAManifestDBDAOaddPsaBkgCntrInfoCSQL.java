...
*@FileName : rPSAManifestDBDAOaddPsaBkgCntrInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class rPSAManifestDBDAOaddPsaBkgCntrInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public rPSAManifestDBDAOaddPsaBkgCntrInfoCSQL(){
		setQuery();
		...
		query.append("FileName : rPSAManifestDBDAOaddPsaBkgCntrInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
