...
*@FileName : RFARateQuotationDBDAOPriRqRtUsdRoutCsFlagVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtUsdRoutCsFlagVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtUsdRoutCsFlagVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtUsdRoutCsFlagVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_RT_USD_ROUT_CS" ).append("\n"); 
