...
*@FileName : ESM_PRI_8102HTMLAction.java
...
public class ESM_PRI_8102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_8102HTMLAction 객체를 생성
	 */
	public ESM_PRI_8102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri8102Event event = new EsmPri8102Event();
		
		event.setSearchConditionVO((SearchConditionVO) getVO(request, SearchConditionVO.class));
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriAuthorizationVOS((PriAuthorizationVO[])getVOs(request, PriAuthorizationVO .class,""));
		}
