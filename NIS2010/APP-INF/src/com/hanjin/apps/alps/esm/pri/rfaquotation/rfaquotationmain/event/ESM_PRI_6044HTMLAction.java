...
public class ESM_PRI_6044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6044HTMLAction 객체를 생성
	 */
	public ESM_PRI_6044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6044Event event = new EsmPri6044Event();
		
		//copy
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setRsltCopyToQuotationVO((RsltCopyToQuotationVO)getVO(request, RsltCopyToQuotationVO .class));
		}
