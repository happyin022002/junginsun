...
*@FileName : Kor24SumVO.java
*@FileTitle : Kor24SumVO
*Open Issues :
*Change history :
...
public class Kor24SumVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24SumVO> models = new ArrayList<Kor24SumVO>();
...
/**
	 ...
	 * @return Kor24SumVO[]
	 */
	public Kor24SumVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24SumVO[]
	 */
	public Kor24SumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24SumVO model = null;
	 ...
	 * @return Kor24SumVO[]
	 */
	public Kor24SumVO[] getKor24SumVOs(){
		Kor24SumVO[] vos = (Kor24SumVO[])models.toArray(new Kor24SumVO[models.size()]);
		return vos;
	}
