...
*@FileName : EsmMas0154Event.java
*@FileTitle : EsmMas0154Event
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0154 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0154HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Ki Dae
 * @see ESM_MAS_0154HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0154Event extends EventSupport {
	...
	/** Constructor */
	public EsmMas0154Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmMas0154Event";
	}
