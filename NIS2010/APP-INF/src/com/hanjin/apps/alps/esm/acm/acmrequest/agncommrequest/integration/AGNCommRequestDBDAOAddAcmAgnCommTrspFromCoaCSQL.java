...
*@FileName : AGNCommRequestDBDAOAddAcmAgnCommTrspFromCoaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOAddAcmAgnCommTrspFromCoaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAcmAgnCommTrspFromCoa
	  * </pre>
	  */
	public AGNCommRequestDBDAOAddAcmAgnCommTrspFromCoaCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOAddAcmAgnCommTrspFromCoaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
