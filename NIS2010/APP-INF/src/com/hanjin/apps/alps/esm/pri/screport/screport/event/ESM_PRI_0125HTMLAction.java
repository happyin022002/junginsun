...
*@FileName : ESM_PRI_0125HTMLAction.java
...
public class ESM_PRI_0125HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0125HTMLAction 객체를 생성
	 */
	public ESM_PRI_0125HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0125Event event = new EsmPri0125Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchSCOutOfDateBkgListVO((RsltSearchSCOutOfDateBkgListVO)getVO(request, RsltSearchSCOutOfDateBkgListVO.class));
		}
