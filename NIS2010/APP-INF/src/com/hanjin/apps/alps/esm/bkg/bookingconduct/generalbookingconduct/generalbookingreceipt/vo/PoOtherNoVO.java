...
public class PoOtherNoVO {
	...
	private List<PoOtherLoadingCntrVO>	 o_poOtherLoadingCntrVOs	= null;//sheet4 = 결과값 List로 리턴받기
	...
	private BkgReferenceVO[]	 i_poOtherLoadingCntrVOs	= null;//sheet4 = 처리대상값 배열로 받기
	...
	/**
	 * @return the o_poOtherLoadingCntrVOs
	 */
	public List<PoOtherLoadingCntrVO> getO_poOtherLoadingCntrVOs() {
		return o_poOtherLoadingCntrVOs;
	}
	/**
	 * @param otherLoadingCntrVOs the o_poOtherLoadingCntrVOs to set
	 */
	public void setO_poOtherLoadingCntrVOs(List<PoOtherLoadingCntrVO> otherLoadingCntrVOs) {
		o_poOtherLoadingCntrVOs = otherLoadingCntrVOs;
	}
	...
	/**
	 * @return the i_poOtherLoadingCntrVOs
	 */
	public BkgReferenceVO[] getI_poOtherLoadingCntrVOs() {
		return i_poOtherLoadingCntrVOs;
	}
	/**
	 * @param otherLoadingCntrVOs the i_poOtherLoadingCntrVOs to set
	 */
	public void setI_poOtherLoadingCntrVOs(BkgReferenceVO[] otherLoadingCntrVOs) {
		i_poOtherLoadingCntrVOs = otherLoadingCntrVOs;
	}
