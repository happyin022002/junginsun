...
*@FileName 		: AGTCommonHTMLAction.java
*@FileTitle 	:  
*Open Issues 	:
*Change history :
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.enis.esm.agt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 * - Parsing 한 정보를 Event로 변환, request에 담아 AGTCommonSC로 실행요청<br>
 * - AGTCommonSC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 *
...
public class CommonHTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        event.setCommandClassName("AGTCommonSC");
