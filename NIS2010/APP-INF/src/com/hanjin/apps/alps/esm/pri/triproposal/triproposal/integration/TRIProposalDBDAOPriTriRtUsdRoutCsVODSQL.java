...
*@FileName : TRIProposalDBDAOPriTriRtUsdRoutCsVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtUsdRoutCsVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_USD_ROUT_CS Delete
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtUsdRoutCsVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtUsdRoutCsVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_USD_ROUT_CS" ).append("\n"); 
