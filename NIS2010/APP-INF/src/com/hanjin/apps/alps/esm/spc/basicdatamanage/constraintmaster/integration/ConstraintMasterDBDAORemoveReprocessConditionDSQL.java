...
*@FileName : ConstraintMasterDBDAORemoveReprocessConditionDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintMasterDBDAORemoveReprocessConditionDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Reprocess 종료 시 해당조건을 SPC_SB_BKG_PROC_STS 테이블에서 삭제합니다.
	  * </pre>
	  */
	public ConstraintMasterDBDAORemoveReprocessConditionDSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintMasterDBDAORemoveReprocessConditionDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
