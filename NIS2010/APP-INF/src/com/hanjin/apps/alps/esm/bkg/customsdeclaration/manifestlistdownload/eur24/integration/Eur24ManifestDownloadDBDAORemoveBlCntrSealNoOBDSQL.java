...
*@FileName : Eur24ManifestDownloadDBDAORemoveBlCntrSealNoOBDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBlCntrSealNoOBDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_CSTMS_EUR_SEAL_NO table 데이터 삭제
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBlCntrSealNoOBDSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBlCntrSealNoOBDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_EUR_IO_SEAL_NO" ).append("\n"); 
