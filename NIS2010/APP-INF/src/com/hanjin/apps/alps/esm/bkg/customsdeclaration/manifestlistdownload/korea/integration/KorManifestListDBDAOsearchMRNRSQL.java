...
*@FileName : KorManifestListDBDAOsearchMRNRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchMRNRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchMRNRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : KorManifestListDBDAOsearchMRNRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}