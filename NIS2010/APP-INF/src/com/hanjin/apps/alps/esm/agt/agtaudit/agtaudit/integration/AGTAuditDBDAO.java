...
import com.hanjin.apps.alps.esm.agt.agtaudit.agtaudit.vo.AGTCommTobeApproved1VO;
...
/**
 * ALPS AGTAuditDBDAO <br>
 * - ALPS-AGTAudit system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author Lee Ho Jin
...
public class AGTAuditDBDAO extends DBDAOSupport {
	...
	public DBRowSet searchModifyAGTCommForRequestEdi(String sEdiRequestBkg) throws DAOException {
		...
		try{
//2011.07.07 이정수 R4J			if(sEdiRequestBkg != null && sEdiRequestBkg != ""){
			if(sEdiRequestBkg != null && !"".equals(sEdiRequestBkg)){
	 ...
	 */ 
	public boolean selectBKGStatusXCd(APActualInterfaceMasterVO apActualInterfaceMasterVO) throws DAOException, EventException{
		DBRowSet dbRowset = null;
		List<AgtCommListVO> list = null;
		boolean bkgSts = true;
		//query parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new AGTAuditDBDAOSearchBKGStatusXCdRSQL(), param, velParam);
			if ( 0 < dbRowset.getRowCount()){
				list = (List)RowSetUtil.rowSetToVOs(dbRowset, AgtCommListVO .class);
				for(int i=0 ; i < list.size() ; i++){
					if(list.get(i).getBkgStsCd().equals("X"))bkgSts=false;
				}
			}
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
...
//				 }
		...
		/**
		 * (ESM_AGT_040) Agent Commission 정보를 조회한다.<br>
		 * 
		 ...
		 */
		 @SuppressWarnings("unchecked")
		public List<AgtCommBkgInfoVO> searchAGTCommforReportbyCustomizedOption(AgtCommBkgInfoVO agtCommBkgInfoVO) throws DAOException {
			DBRowSet dbRowset = null;
			List<AgtCommBkgInfoVO> list = null;
			//query parameter
			Map<String, Object> param = new HashMap<String, Object>();
			//velocity parameter
			Map<String, Object> velParam = new HashMap<String, Object>();
			...
			try{
				if(agtCommBkgInfoVO != null){
					Map<String, String> mapVO = agtCommBkgInfoVO .getColumnValues();
				
					param.putAll(mapVO);
					velParam.putAll(mapVO);
				}
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new AGTAuditDBDAOAgtCommBkgInfoVORSQL(), param, velParam);
				list = (List)RowSetUtil.rowSetToVOs(dbRowset, AgtCommBkgInfoVO .class);
			} catch(SQLException se) {
				log.error(se.getMessage(),se);
				throw new DAOException(new ErrorHandler(se).getMessage());
			} catch(Exception ex) {
			 ...
			 */
			 @SuppressWarnings("unchecked")
			public List<AgtRptItmInfoDtlVO> searchRptItem(AgtRptItmInfoDtlVO agtRptItmInfoDtlVO) throws DAOException {
				DBRowSet dbRowset = null;
				List<AgtRptItmInfoDtlVO> list = null;
				//query parameter
				Map<String, Object> param = new HashMap<String, Object>();
				//velocity parameter
				Map<String, Object> velParam = new HashMap<String, Object>();
				...
				try{
					if(agtRptItmInfoDtlVO != null){
						Map<String, String> mapVO = agtRptItmInfoDtlVO.getColumnValues();
					
						param.putAll(mapVO);
						velParam.putAll(mapVO);
					}
					dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new AGTAuditDBDAOAgtRptItmInfoDtlVORSQL(), param, velParam);
					list = (List)RowSetUtil.rowSetToVOs(dbRowset, AgtRptItmInfoDtlVO .class);
				} catch(SQLException se) {
					log.error(se.getMessage(),se);
					throw new DAOException(new ErrorHandler(se).getMessage());
				} catch(Exception ex) {
	 ...
	 * @throws Exception
	 */
	public List<AgtRptItmInfoMstDtlVO> searchAGTDimensionReportbyMultiOption(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
		DBRowSet dbRowSet = null;
		List<AgtRptItmInfoMstDtlVO> list = null;
		...
		Map<String, Object> velParam = new HashMap<String, Object>();
		try{
			if(agtRptItmInfoMstDtlVO != null){
				Map<String, String> mapVO = agtRptItmInfoMstDtlVO.getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				log.info("\n   >>> param="+param);
			}
			dbRowSet = new SQLExecuter("").executeQuery((ISQLTemplate)new AGTAuditDBDAODimensionReportbyMultiOptionRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowSet, AgtRptItmInfoMstDtlVO.class);
		}catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch(Exception ex) {
	 ...
	 * @throws Exception
	 */
	public List<AgtRptItmInfoMstDtlVO> searchAGTDimensionReportbyMultiOption1(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
		DBRowSet dbRowSet = null;
		List<AgtRptItmInfoMstDtlVO> list = null;
		...
		try{
			...
			dbRowSet = new SQLExecuter("").executeQuery((ISQLTemplate)new AGTAuditDBDAODimensionReportbyMultiOption1RSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowSet, AgtRptItmInfoMstDtlVO.class);
		}catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	...
	/**
	 * ESM_AGT_0041 화면에서 MaxSeq 조회
	 * @param AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO
	 * @return List<AgtRptItmInfoMstDtlVO>
	 * @throws DAOException
	 * @throws Exception
	 */
	public List<AgtRptItmInfoMstDtlVO> searchAGTDimensionReportbyMultiOptionMaxSeq(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
		DBRowSet dbRowSet = null;
		List<AgtRptItmInfoMstDtlVO> list = null;
		...
		try{
			...
			dbRowSet = new SQLExecuter("").executeQuery((ISQLTemplate)new AGTAuditDBDAODimensionReportbyMultiOptionMaxSeqRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowSet, AgtRptItmInfoMstDtlVO.class);
		}catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	...
	/**
	 * ESM_AGT_0041 화면에서 Master Delete
	 * @param AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO
	 * @return int
	 * @throws DAOException
	 * @throws Exception
	 */
	public int deleteAGTAuditDBDAODimensionReportbyMultiOptionMst(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try{
			...
			SQLExecuter sqlExe = new SQLExecuter("DEFAULT");
			result = sqlExe.executeUpdate((ISQLTemplate) new AGTAuditDBDAODimensionReportbyMultiOptionMstDSQL(), param, velParam);
			if(result == Statement.EXECUTE_FAILED){
	...
	/**
	 * ESM_AGT_0041 화면에서 Detail Delete
	 * @param AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO
	 * @return int
	 * @throws DAOException
	 * @throws Exception
	 */
	public int deleteAGTAuditDBDAODimensionReportbyMultiOptionDtl(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
	    //query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try{
			...
			SQLExecuter sqlExe = new SQLExecuter("DEFAULT");
			result = sqlExe.executeUpdate((ISQLTemplate) new AGTAuditDBDAODimensionReportbyMultiOptionDtlDSQL(), param, velParam);
			if(result == Statement.EXECUTE_FAILED){
				throw new DAOException("Fail to delete SQL");
			}
		}catch (SQLException se) {
	...
	/**
	 * ESM_AGT_0041 화면에서 Master 저장
	 * @param AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO
	 * @return int
	 * @throws DAOException
	 * @throws Exception
	 */
	public int createAGTAuditDBDAODimensionReportbyMultiOptionMst(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
		int insCnt = 0;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			SQLExecuter sqlExe = new SQLExecuter("DEFAULT");
			insCnt = sqlExe.executeUpdate((ISQLTemplate) new AGTAuditDBDAODimensionReportbyMultiOptionMstCSQL(), param, velParam);
	 ...
	 * @throws Exception
	 */
	public int createAGTAuditDBDAODimensionReportbyMultiOptionDtl(AgtRptItmInfoMstDtlVO agtRptItmInfoMstDtlVO) throws DAOException, Exception{
	    int insCnt = 0;
	    //query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			SQLExecuter sqlExe = new SQLExecuter("DEFAULT");
			insCnt = sqlExe.executeUpdate((ISQLTemplate) new AGTAuditDBDAODimensionReportbyMultiOptionDtlCSQL(), param, velParam);
			if(insCnt == Statement.EXECUTE_FAILED){
				throw new DAOException("Fail to Insert SQL");
			}
		}catch (SQLException se) {
