...
=========================================================*/
package com.hanjin.apps.alps.esm.coa.common;
...
import com.hanjin.apps.alps.esm.coa.common.event.CommonEvent;
import com.hanjin.apps.alps.esm.coa.common.event.EsmCoa9000Event;
import com.hanjin.apps.alps.esm.coa.common.event.EsmCoa9001Event;
...
/**
 * 1. 기능 : ENIS-COA Business Logic ServiceCommand<br> 
 * 2. 처리 개요 :<p>
 *  - ENIS-COA에 대한 비지니스 트랜잭션을 처리한다.<br>
 * 3. 주의사항 :<p>
 * ===================================<br>
...
//     Login User Information
    ...
    public EventResponse perform(Event e) throws EventException {
        ...
        if (e.getEventName().equalsIgnoreCase("EsmCoa9000Event")) {//COAEvent
        ...
        } else if (e.getEventName().equalsIgnoreCase("EsmCoa9001Event")) {	//Average U/C 화면popup
...
//        }
   ...
   /**
	...
	private EventResponse createVslLayupWeekCopy(Event e) throws EventException {
		EsmCoa9001Event event = (EsmCoa9001Event)e; // 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try {
			begin();
			CommonBC command = new CommonBCImpl();
