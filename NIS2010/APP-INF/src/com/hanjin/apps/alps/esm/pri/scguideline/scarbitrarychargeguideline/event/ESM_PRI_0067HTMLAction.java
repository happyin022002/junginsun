...
*@FileName : ESM_PRI_0067HTMLAction.java
...
import com.hanjin.apps.alps.esm.pri.scguideline.scarbitrarychargeguideline.vo.RsltPriSgArbKeyVO;
...
public class ESM_PRI_0067HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0067HTMLAction 객체를 생성
	 */
	public ESM_PRI_0067HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0067Event event = new EsmPri0067Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setRsltPriSgArbKeyVO((RsltPriSgArbKeyVO)getVO(request, RsltPriSgArbKeyVO .class));
		}
