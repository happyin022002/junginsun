...
*@FileName : PerformanceReportDBDAODpcsAmendReasonBkgListVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAODpcsAmendReasonBkgListVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAODpcsAmendReasonBkgListVODSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAODpcsAmendReasonBkgListVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_SR_CRNT_RQST" ).append("\n"); 
