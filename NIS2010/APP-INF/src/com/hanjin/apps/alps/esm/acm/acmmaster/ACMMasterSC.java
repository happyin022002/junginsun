...
=========================================================*/
package com.hanjin.apps.alps.esm.acm.acmmaster;

import java.util.List;

import com.hanjin.apps.alps.esm.acm.acmmaster.acmchinaofficeinfo.basic.ACMChinaOfficeInfoBC;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmchinaofficeinfo.basic.ACMChinaOfficeInfoBCImpl;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmchinaofficeinfo.event.EsmAcm0005Event;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmchinaofficeinfo.event.EsmAcm0007Event;
...
import com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.basic.ACMCustomerInfoBC;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.basic.ACMCustomerInfoBCImpl;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.event.EsmAcm0019Event;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.event.EsmAcm0020Event;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.event.EsmAcm0021Event;
import com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.event.EsmAcm0022Event;
...
/**
 * ALPS-ACMMaster Business Logic ServiceCommand - ALPS-ACMMaster 대한 비지니스 트랜잭션을 처리한다.
 *
 * @author KIM, Sang-Soo
...
public class ACMMasterSC extends ServiceCommandSupport {
	 ...
	 * ALPS-ACMMaster system 업무에서 발생하는 모든 이벤트의 분기처리<br>
	 *
	 * @param e Event
	...
	private EventResponse manageOBChinaOfficeInfo(Event e) throws EventException {
		...
		try{
			begin();
			BkgChinaAgentVO[] bkgChinaAgentVOs = command.manageOBChinaOfficeInfo(event.getChinaOfficeInfoVOs());
			// BKG모듈 호출
	...
	private EventResponse manageFFCmpnExSetting(Event e) throws EventException {
		...
		try{
			...
			rollback();
			throw new EventException(new ErrorHandler(ex).getMessage()); // [CHM-201324844] FF code중복 체크 로직 변경 요청
		} catch(Exception ex) {
			rollback();
			throw new EventException(new ErrorHandler(ex).getMessage(), ex);
		}
