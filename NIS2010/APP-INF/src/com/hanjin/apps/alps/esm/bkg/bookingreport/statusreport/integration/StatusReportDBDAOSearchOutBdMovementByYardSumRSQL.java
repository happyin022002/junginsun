...
public class StatusReportDBDAOSearchOutBdMovementByYardSumRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      , VVD_CD||TRD_CD||SUB_TRD_CD||RLANE_CD SUB_STR" ).append("\n"); 
		query.append("      , ORG_YD_CD" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OP' AND CNTR_TPSZ_CD_MV = 'D2' THEN CNTR_VOL_QTY ELSE 0 END) OP_DR2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OP' AND CNTR_TPSZ_CD_MV != 'D2' AND CNTR_TPSZ_CD_MV LIKE 'D%' THEN CNTR_VOL_QTY ELSE 0 END) OP_DR4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OP' AND CNTR_TPSZ_CD_MV = 'R2' THEN CNTR_VOL_QTY ELSE 0 END) OP_RF2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OP' AND CNTR_TPSZ_CD_MV != 'R2' AND CNTR_TPSZ_CD_MV LIKE 'R%' THEN CNTR_VOL_QTY ELSE 0 END) OP_RF4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OC' AND CNTR_TPSZ_CD_MV = 'D2' THEN CNTR_VOL_QTY ELSE 0 END) OC_DR2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OC' AND CNTR_TPSZ_CD_MV != 'D2' AND CNTR_TPSZ_CD_MV LIKE 'D%' THEN CNTR_VOL_QTY ELSE 0 END) OC_DR4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OC' AND CNTR_TPSZ_CD_MV = 'R2' THEN CNTR_VOL_QTY ELSE 0 END) OC_RF2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OC' AND CNTR_TPSZ_CD_MV != 'R2' AND CNTR_TPSZ_CD_MV LIKE 'R%' THEN CNTR_VOL_QTY ELSE 0 END) OC_RF4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN (CNMV_STS_CD = 'EN' OR CNMV_STS_CD = 'TN') AND CNTR_TPSZ_CD_MV = 'D2' THEN CNTR_VOL_QTY ELSE 0 END) ETN_DR2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN (CNMV_STS_CD = 'EN' OR CNMV_STS_CD = 'TN') AND CNTR_TPSZ_CD_MV != 'D2'  AND CNTR_TPSZ_CD_MV LIKE 'D%' THEN CNTR_VOL_QTY ELSE 0 END) ETN_DR4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN (CNMV_STS_CD = 'EN' OR CNMV_STS_CD = 'TN') AND CNTR_TPSZ_CD_MV = 'R2' THEN CNTR_VOL_QTY ELSE 0 END) ETN_RF2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN (CNMV_STS_CD = 'EN' OR CNMV_STS_CD = 'TN') AND CNTR_TPSZ_CD_MV != 'R2'  AND CNTR_TPSZ_CD_MV LIKE 'R%' THEN CNTR_VOL_QTY ELSE 0 END) ETN_RF4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'MT' AND CNTR_TPSZ_CD_MV = 'D2' THEN CNTR_VOL_QTY ELSE 0 END) MT_DR2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'MT' AND CNTR_TPSZ_CD_MV != 'D2'  AND CNTR_TPSZ_CD_MV LIKE 'D%' THEN CNTR_VOL_QTY ELSE 0 END) MT_DR4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'MT' AND CNTR_TPSZ_CD_MV = 'R2' THEN CNTR_VOL_QTY ELSE 0 END) MT_RF2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'MT' AND CNTR_TPSZ_CD_MV != 'R2'  AND CNTR_TPSZ_CD_MV LIKE 'R%' THEN CNTR_VOL_QTY ELSE 0 END) MT_RF4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OT' AND CNTR_TPSZ_CD_MV = 'D2' THEN CNTR_VOL_QTY ELSE 0 END) OT_DR2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OT' AND CNTR_TPSZ_CD_MV != 'D2' AND CNTR_TPSZ_CD_MV LIKE 'D%'  THEN CNTR_VOL_QTY ELSE 0 END) OT_DR4" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OT' AND CNTR_TPSZ_CD_MV = 'R2' THEN CNTR_VOL_QTY ELSE 0 END) OT_RF2" ).append("\n"); 
		query.append("      , SUM(CASE WHEN CNMV_STS_CD = 'OT' AND CNTR_TPSZ_CD_MV != 'R2' AND CNTR_TPSZ_CD_MV LIKE 'R%'  THEN CNTR_VOL_QTY ELSE 0 END) OT_RF4" ).append("\n"); 
		...
		query.append("                , CASE WHEN B.CNMV_STS_CD IN ('OP', 'OC', 'EN', 'TN', 'MT') THEN B.CNMV_STS_CD ELSE 'OT' END CNMV_STS_CD" ).append("\n"); 
		...
		query.append("                    AND    ROWNUM = 1  ) PRE_VVD_CNT" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY VVD_CD, TRD_CD, SUB_TRD_CD, RLANE_CD, ORG_YD_CD" ).append("\n"); 
