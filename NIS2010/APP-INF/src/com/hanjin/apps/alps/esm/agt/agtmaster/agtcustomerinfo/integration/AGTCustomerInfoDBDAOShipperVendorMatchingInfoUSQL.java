...
*@FileName : AGTCustomerInfoDBDAOShipperVendorMatchingInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerInfoDBDAOShipperVendorMatchingInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCustomerInfoDBDAOShipperVendorMatchingInfoUSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerInfoDBDAOShipperVendorMatchingInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AGT_CMPN_CUST_MTCH" ).append("\n"); 
