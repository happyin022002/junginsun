...
*@FileName : ESM_PRI_0152HTMLAction.java
...
public class ESM_PRI_0152HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0152HTMLAction 객체를 생성
	 */
	public ESM_PRI_0152HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0152Event event = new EsmPri0152Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPriMofMapgVO((PriMofMapgVO)getVO(request, PriMofMapgVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setPriMofMapgVOs((PriMofMapgVO[])getVOs(request, PriMofMapgVO.class, ""));
			event.setPriMofMapgHisVOs((PriMofMapgHisVO[])getVOs(request, PriMofMapgHisVO.class, ""));
		}
