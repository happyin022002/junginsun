...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutPntAllDSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutPntAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutPntAllDSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutPntAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
