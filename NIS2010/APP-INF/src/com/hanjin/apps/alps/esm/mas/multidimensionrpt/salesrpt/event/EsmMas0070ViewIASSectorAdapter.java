...
*@FileName : EsmMas0070ViewIASSectorAdapter.java
*@FileTitle : EsmMas0070ViewIASSectorAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0070ViewIASSectorAdapter extends DefaultViewAdapter {
	
    public EsmMas0070ViewIASSectorAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0070ViewIASSectorAdapter ########### [START]");
