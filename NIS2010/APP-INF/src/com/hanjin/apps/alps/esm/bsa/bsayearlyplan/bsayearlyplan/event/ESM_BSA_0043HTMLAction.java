...
*@FileName : ESM_BSA_0043HTMLAction.java
...
public class ESM_BSA_0043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BSA_0043HTMLAction 객체를 생성
	 */
	public ESM_BSA_0043HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBsa0043Event event = new EsmBsa0043Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setParamCoaMonVvdYryPlnVO((ParamCoaMonVvdYryPlnVO)getVO(request, ParamCoaMonVvdYryPlnVO .class));
		}
