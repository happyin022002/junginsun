...
public class ObDblWblInVO extends AbstractValueObject {
	...
	private String noSrFlg = null;
	private String scNo = null;
	private String polYdCd = null;
	private String rfaNo = null;
	private String unPickupFlg = null;
	...
	public ObDblWblInVO(String unPickupFlg, String blTpCd, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String podCd, String bkgOfcCd, String docUsrId, String bkgStsCd, String bkgCustTpCd, String custCntCd, String custSeq, String custNm, String oblIssOfcCd, String oblIssUsrId, String obSlsOfcCd, String obSrepCd, String bkgNo, String blNo, String blObrdDtFrom, String blObrdDtTo, String oblIssDtFrom, String oblIssDtTo, String faxProcStsCd, String emlProcStsCd, String noSrFlg, String scNo, String polYdCd, String rfaNo) {
		this.unPickupFlg = unPickupFlg;
		this.blTpCd = blTpCd;
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("un_pickup_flg", getUnPickupFlg());
		...
		this.hashColumns.put("no_sr_flg", getNoSrFlg());
	...
	public HashMap<String, String> getFieldNames() {
		this.hashFields.put("un_pickup_flg", "unPickupFlg");
		...
		this.hashFields.put("no_sr_flg", "noSrFlg");	
	 ...
	 * @return unPickupFlg
	 */
	public String getUnPickupFlg() {
		return this.unPickupFlg;
	}
	 ...
	 * @param unPickupFlg
	 */
	public void setUnPickupFlg(String unPickupFlg) {
		this.unPickupFlg = unPickupFlg;
	}
	 ...
	 * @param noSrFlg
	 */
	public void setNoSrFlg(String noSrFlg) {
		this.noSrFlg = noSrFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		setUnPickupFlg(JSPUtil.getParameter(request, "un_pickup_flg", ""));
		...
		setNoSrFlg(JSPUtil.getParameter(request, "no_sr_flg", ""));
	...
	public ObDblWblInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] noSrFlg = (JSPUtil.getParameter(request, prefix + "no_sr_flg", length));
			String[] scNo = (JSPUtil.getParameter(request, prefix + "sc_no", length));
			String[] polYdCd = (JSPUtil.getParameter(request, prefix + "pol_yd_cd", length));
			String[] rfaNo = (JSPUtil.getParameter(request, prefix + "rfa_no", length));
			String[] unPickupFlg = (JSPUtil.getParameter(request, prefix + "un_pickup_flg", length));
			for (int i = 0; i < length; i++) {
				...
				if (unPickupFlg[i] != null)
					model.setUnPickupFlg(unPickupFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		this.unPickupFlg = this.unPickupFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.noSrFlg = this.noSrFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
