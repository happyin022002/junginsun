...
*@FileName : KorMrnCondVO.java
*@FileTitle : KorMrnCondVO
*Open Issues :
*Change history :
...
public class KorMrnCondVO extends MrnCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorMrnCondVO> models = new ArrayList<KorMrnCondVO>();
	...
	public KorMrnCondVO(String ibflag, String pagerows, String vvd, String ioBndCd, String mrnNo, String portCd, String fromDt, String toDt, String vslCd, String skdVoyNo, String skdDirCd) {
		this.toDt = toDt;
		this.vvd = vvd;
		this.vslCd = vslCd;
		this.fromDt = fromDt;
	 ...
	 * @return KorMrnCondVO[]
	 */
	public KorMrnCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMrnCondVO[]
	 */
	public KorMrnCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMrnCondVO model = null;
	 ...
	 * @return KorMrnCondVO[]
	 */
	public KorMrnCondVO[] getKorMrnCondVOs(){
		KorMrnCondVO[] vos = (KorMrnCondVO[])models.toArray(new KorMrnCondVO[models.size()]);
		return vos;
	}
