...
*@FileName : TCharterIOInvoiceDAORemovePreInvDtlsDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAORemovePreInvDtlsDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOInvoiceDAORemovePreInvDtlsDSQL
	  * </pre>
	  */
	public TCharterIOInvoiceDAORemovePreInvDtlsDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : TCharterIOInvoiceDAORemovePreInvDtlsDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}