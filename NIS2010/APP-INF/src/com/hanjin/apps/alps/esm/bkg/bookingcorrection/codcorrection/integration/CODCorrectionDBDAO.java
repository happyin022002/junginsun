...
import com.hanjin.apps.alps.esm.bkg.bookingcorrection.codcorrection.vo.BkgCodCostSumVO;
...
import com.hanjin.apps.alps.esm.bkg.bookingcorrection.codcorrection.vo.CodLastHistoryVO;
...
/**
 * ALPS CODCorrectionDBDAO <br>
 * - ALPS-BookingCorrection system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
...
public class CODCorrectionDBDAO extends DBDAOSupport {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public CodRsoVO searchCodRsoRoute(BkgBlNoVO bkgBlNoVO, String codRqstSeq, String rehandlingPort, String robFlag) throws DAOException{
		DBRowSet dbRowset = null;
		...
		try{
			if(bkgBlNoVO != null){
				...
				param.put("rob_flag", robFlag);
				velParam.putAll(mapVO);
			}
			dbRowset = new SQLExecuter("DEFAULT").executeQuery((ISQLTemplate)new CODCorrectionDBDAOSearchCodRsoRouteRSQL(), param, velParam);
	 ...
	 * @exception DAOException
	 */
	public String searchCodRso(BkgBlNoVO bkgBlNoVO, String codRqstSeq, String rehandlingPort) throws DAOException{
		DBRowSet dbRowset = null;
		String rso = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	...
	/**
	 * cod 대상 cntr의 awk 정보를 조회한다.<br>
     * 
	 * @param  BkgBlNoVO bkgBlNoVO
	 * @param  String codRqstSeq
	 * @return List<CodCntrAkInfoVO>
	 * @exception DAOException
	 */
	@SuppressWarnings("unchecked")
	public List<CodCntrAkInfoVO> searchCodCntrAkInfo(BkgBlNoVO bkgBlNoVO, String codRqstSeq) throws DAOException{
		DBRowSet dbRowset = null;
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CODCorrectionDBDAOSearchCodCntrAkInfoRSQL(), param, velParam);
			akInfoVOs = (List)RowSetUtil.rowSetToVOs(dbRowset, CodCntrAkInfoVO.class);
		}catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage(),se);
		}catch(Exception ex){
