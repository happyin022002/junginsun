...
*@FileName : EBookingReceiptDBDAOaddBkgXterTroDtlCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterTroDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterTroDtlCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_TRO_DTL" ).append("\n");
		query.append("(" ).append("\n");
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterTroDtlCSQL").append("\n");
		query.append("*/").append("\n");
	}
}