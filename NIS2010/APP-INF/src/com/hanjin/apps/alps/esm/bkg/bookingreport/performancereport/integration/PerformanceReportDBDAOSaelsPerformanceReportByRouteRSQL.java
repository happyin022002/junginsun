...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportByRouteRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportByRouteRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportByRouteRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportByRouteRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,SUM(VOID_SLOT)           VOID_SLOT" ).append("\n"); 
		...
		query.append("              ,SUM(DECODE(SUBSTR(QUA.CNTR_TPSZ_CD,1,1),'Q',(DECODE(SUBSTR(QUA.CNTR_TPSZ_CD,-1),'2',NVL(QUA.OP_CNTR_QTY,0),0)),0)) VOID_SLOT" ).append("\n"); 
