...
*@FileName : BkgCstmsKrDgCgoVvdVO.java
*@FileTitle : BkgCstmsKrDgCgoVvdVO
*Open Issues :
*Change history :
...
public class BkgCstmsKrDgCgoVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsKrDgCgoVvdVO> models = new ArrayList<BkgCstmsKrDgCgoVvdVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("arv_tm", getArvTm());
		...
		this.hashColumns.put("io_tm", getIoTm());
		...
		this.hashColumns.put("from_tm", getFromTm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("arv_tm", "arvTm");
		...
		this.hashFields.put("io_tm", "ioTm");
		...
		this.hashFields.put("from_tm", "fromTm");
	 ...
	 * @param ioTm
	 */
	public void setIoTm(String ioTm) {
		this.ioTm = ioTm;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setArvTm(JSPUtil.getParameter(request, "arv_tm", ""));
		...
		setToTm(JSPUtil.getParameter(request, "to_tm", ""));
		...
		setIoTm(JSPUtil.getParameter(request, "io_tm", ""));
		...
		setFromTm(JSPUtil.getParameter(request, "from_tm", ""));
	 ...
	 */
	public BkgCstmsKrDgCgoVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrDgCgoVvdVO[]
	 */
	public BkgCstmsKrDgCgoVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsKrDgCgoVvdVO model = null;
		...
		try {
			...
			String[] arvTm = (JSPUtil.getParameter(request, prefix	+ "arv_tm", length));
			...
			String[] ioTm = (JSPUtil.getParameter(request, prefix	+ "io_tm", length));
			...
			String[] fromTm = (JSPUtil.getParameter(request, prefix	+ "from_tm", length));
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCstmsKrDgCgoVvdVO();
				if (fromDt[i] != null)
		...
		return getBkgCstmsKrDgCgoVvdVOs();
	}
	 ...
	 * @return BkgCstmsKrDgCgoVvdVO[]
	 */
	public BkgCstmsKrDgCgoVvdVO[] getBkgCstmsKrDgCgoVvdVOs(){
		BkgCstmsKrDgCgoVvdVO[] vos = (BkgCstmsKrDgCgoVvdVO[])models.toArray(new BkgCstmsKrDgCgoVvdVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.arvTm = this.arvTm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ioTm = this.ioTm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.fromTm = this.fromTm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
