...
*@FileName : Kor24ManifestListDBDAOSearchMaxSeqDownHistKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchMaxSeqDownHistKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchMaxSeqDownHistKorRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FROM BKG_CSTMS_ADV_KR_DL_HIS" ).append("\n");
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchMaxSeqDownHistKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
}