...
public class JapanManifestListDownloadDBDAOsearchCntrDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	AA.CNTR_SEAL_NO2," ).append("\n"); 
		query.append("    AA.CNTR_SEAL_NO3," ).append("\n"); 
		query.append("    AA.CNTR_SEAL_NO4," ).append("\n"); 
		query.append("    AA.CNTR_SEAL_NO5," ).append("\n"); 
		query.append("    AA.CNTR_SEAL_NO6," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("		(  SELECT NVL(MAX(DECODE(ROWNUM, 1, CNTR_SEAL_NO, '')),' ') " ).append("\n"); 
		query.append("		   FROM (" ).append("\n"); 
		query.append("            SELECT *" ).append("\n"); 
		query.append("            FROM BKG_CNTR_SEAL_NO" ).append("\n"); 
		query.append("            ORDER BY CNTR_SEAL_SEQ ASC" ).append("\n"); 
		query.append("           ) X" ).append("\n"); 
		query.append("		   WHERE X.BKG_NO = C.BKG_NO" ).append("\n"); 
