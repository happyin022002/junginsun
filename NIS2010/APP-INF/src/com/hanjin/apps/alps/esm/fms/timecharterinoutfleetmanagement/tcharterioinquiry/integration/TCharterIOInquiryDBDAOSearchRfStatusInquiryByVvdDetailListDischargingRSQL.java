...
*@FileName : TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdDetailListDischargingRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdDetailListDischargingRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdDetailListDischargingRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdDetailListDischargingRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         ,C.POL		AS loadingport" ).append("\n"); 
		query.append("		 ,C.POD		AS dischargingport" ).append("\n"); 
		query.append("		 ,C.OPR_CD	AS operator" ).append("\n"); 
		query.append("		 ,C.ID 		AS cntrno" ).append("\n"); 
		query.append("		 ,'Discharging'	AS kind" ).append("\n"); 
		...
		query.append("      AND C.POD = (" ).append("\n"); 
		query.append("        SELECT NVL(REP_PORT_CD, VPS_PORT_CD)" ).append("\n"); 
		query.append("        FROM STO_PLN_VSL_PORT_SKD" ).append("\n"); 
