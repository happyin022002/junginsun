...
*@FileName : EsmMas0156ViewAdapter.java
*@FileTitle : EsmMas0156ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0156 에 대한 ViewAdapter<br>
 * - ESM_MAS_0156HTMLAction에서 작성<br>
 *
 * @author 김기식
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0156ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0156ViewAdapter(){
    	super(); 
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0156ViewAdapter ########### [START]");
        ...
        log.debug("########### EsmMas0156ViewAdapter ########### [END]");
