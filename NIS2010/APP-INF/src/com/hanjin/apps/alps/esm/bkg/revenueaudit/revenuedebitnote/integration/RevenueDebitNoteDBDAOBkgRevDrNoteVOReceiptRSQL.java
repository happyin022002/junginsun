...
public class RevenueDebitNoteDBDAOBkgRevDrNoteVOReceiptRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", A1.UMCH_SUB_TP_CD AS UMCH_SUB_TP_CD" ).append("\n"); 
		...
		query.append("    from COM_INTG_CD_DTL" ).append("\n"); 
		query.append("    WHERE INTG_CD_ID = 'CD03402'" ).append("\n"); 
		query.append("    AND   INTG_CD_VAL_CTNT = A1.RDN_KND_CD) AS RDN_KND_CD" ).append("\n"); 
