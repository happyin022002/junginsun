...
*@FileName : RFAProposalMainDBDAORsltPropMnSpotVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORsltPropMnSpotVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2016.09.02 [CHM-201642759] PRI 하드코딩 권한부여 기능 개발 Request By SELXWP / Hye-In Ahn
	  * </pre>
	  */
	public RFAProposalMainDBDAORsltPropMnSpotVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORsltPropMnSpotVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
