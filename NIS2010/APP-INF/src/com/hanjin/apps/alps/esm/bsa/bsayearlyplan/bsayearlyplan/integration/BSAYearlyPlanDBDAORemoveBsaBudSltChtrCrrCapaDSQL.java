...
*@FileName : BSAYearlyPlanDBDAORemoveBsaBudSltChtrCrrCapaDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAORemoveBsaBudSltChtrCrrCapaDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAORemoveBsaBudSltChtrCrrCapaDSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAORemoveBsaBudSltChtrCrrCapaDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_BUD_SLT_CHTR_CRR_CAPA" ).append("\n"); 
