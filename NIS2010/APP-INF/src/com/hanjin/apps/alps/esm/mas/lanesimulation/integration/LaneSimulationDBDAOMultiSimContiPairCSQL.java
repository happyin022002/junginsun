...
*@FileName : LaneSimulationDBDAOMultiSimContiPairCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimContiPairCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimContiPairCSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimContiPairCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO  MAS_SIM_DTL_REV_LANE(" ).append("\n"); 
