...
*@FileName : Kor24ManifestListDBDAOSearchDownHistCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchDownHistCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchDownHistCheckRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchDownHistCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
