...
*@FileName : ESM_MAS_0221HTMLAction.java
...
public class ESM_MAS_0221HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0221HTMLAction 객체를 생성
	 */
	public ESM_MAS_0221HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0221Event event = new EsmMas0221Event();
