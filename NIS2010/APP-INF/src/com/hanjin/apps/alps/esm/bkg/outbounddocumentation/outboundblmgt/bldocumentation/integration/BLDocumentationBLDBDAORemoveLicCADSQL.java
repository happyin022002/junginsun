...
*@FileName : BLDocumentationBLDBDAORemoveLicCADSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAORemoveLicCADSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLDocumentationBLDBDAORemoveLicCADSQL
	  * </pre>
	  */
	public BLDocumentationBLDBDAORemoveLicCADSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationBLDBDAORemoveLicCADSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
