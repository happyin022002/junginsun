...
*@FileName : SCRateGuidelineDBDAODestPriSgRtRoutPntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAODestPriSgRtRoutPntVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAODestPriSgRtRoutPntVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCRateGuidelineDBDAODestPriSgRtRoutPntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}