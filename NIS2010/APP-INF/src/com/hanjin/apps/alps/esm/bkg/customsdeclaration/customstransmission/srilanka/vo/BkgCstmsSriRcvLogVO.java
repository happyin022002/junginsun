...
*@FileName : BkgCstmsSriRcvLogVO.java
*@FileTitle : BkgCstmsSriRcvLogVO
*Open Issues :
*Change history :
...
public class BkgCstmsSriRcvLogVO extends CstmsRcvLogVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsSriRcvLogVO> models = new ArrayList<BkgCstmsSriRcvLogVO>();
	...
	public BkgCstmsSriRcvLogVO() {}

	public BkgCstmsSriRcvLogVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String srStsCd, String vslNm, String vslAuthNo, String vslRgstNo, String depDt, String rgstDt, String rjctDt, String srStsDesc, String userId, String rspnDivCd, String rdate, String rtime) {
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return BkgCstmsSriRcvLogVO[]
	 */
	public BkgCstmsSriRcvLogVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsSriRcvLogVO[]
	 */
	public BkgCstmsSriRcvLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsSriRcvLogVO model = null;
		...
		return getBkgCstmsSriRcvLogVOs();
	}
	 ...
	 * @return BkgCstmsSriRcvLogVO[]
	 */
	public BkgCstmsSriRcvLogVO[] getBkgCstmsSriRcvLogVOs(){
		BkgCstmsSriRcvLogVO[] vos = (BkgCstmsSriRcvLogVO[])models.toArray(new BkgCstmsSriRcvLogVO[models.size()]);
		return vos;
	}
