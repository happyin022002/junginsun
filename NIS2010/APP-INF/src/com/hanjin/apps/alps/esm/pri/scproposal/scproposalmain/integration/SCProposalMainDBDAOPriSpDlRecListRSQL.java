...
*@FileName : SCProposalMainDBDAOPriSpDlRecListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAOPriSpDlRecListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpDownloadRecord 정보를 조회한다
	  * </pre>
	  */
	public SCProposalMainDBDAOPriSpDlRecListRSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAOPriSpDlRecListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,N.DL_SCRN 		AS DL_SCRN" ).append("\n"); 
		query.append("        ,N.OPEN_TIME    AS OPEN_TIME" ).append("\n"); 
		query.append("        ,N.SAVE_TIME    AS SAVE_TIME" ).append("\n"); 
		query.append("        ,N.CLOSE_TIME   AS CLOSE_TIME" ).append("\n"); 
		...
		query.append("		,(SELECT INTG_CD_VAL_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD03455' AND INTG_CD_VAL_CTNT = SR.SP_SCRN_EVNT_PGM_CD) AS DL_SCRN" ).append("\n"); 
		...
		query.append("		,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('GMT',SS.SCRN_OPN_GDT,GLOBALDATE_PKG.GET_LOCCD_FNC('SELSC')),'YYYY/MM/DD HH24:MI:SS')  AS SAVE_TIME" ).append("\n"); 
		query.append("        ,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('GMT',(SELECT SCRN_OPN_GDT FROM PRI_SP_DL_REC A WHERE A.PRNT_SCRN_EVNT_SEQ = SR.SCRN_EVNT_SEQ AND SP_PRN_EVNT_TP_CD = 'C' AND ROWNUM = 1 ),GLOBALDATE_PKG.GET_LOCCD_FNC('SELSC')),'YYYY/MM/DD HH24:MI:SS')  AS CLOSE_TIME" ).append("\n"); 
		...
		query.append("		,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('GMT',SS.SCRN_OPN_GDT,GLOBALDATE_PKG.GET_LOCCD_FNC('NYCRA')),'YYYY/MM/DD HH24:MI:SS')  AS SAVE_TIME" ).append("\n"); 
		query.append("        ,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('GMT',(SELECT SCRN_OPN_GDT FROM PRI_SP_DL_REC A WHERE A.PRNT_SCRN_EVNT_SEQ = SR.SCRN_EVNT_SEQ AND SP_PRN_EVNT_TP_CD = 'C' AND ROWNUM = 1 ),GLOBALDATE_PKG.GET_LOCCD_FNC('NYCRA')),'YYYY/MM/DD HH24:MI:SS')  AS CLOSE_TIME" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		...
		query.append("		,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('GMT',SS.SCRN_OPN_GDT,GLOBALDATE_PKG.GET_LOCCD_FNC('HAMRU')),'YYYY/MM/DD HH24:MI:SS')  AS SAVE_TIME" ).append("\n"); 
		query.append("        ,TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('GMT',(SELECT SCRN_OPN_GDT FROM PRI_SP_DL_REC A WHERE A.PRNT_SCRN_EVNT_SEQ = SR.SCRN_EVNT_SEQ AND SP_PRN_EVNT_TP_CD = 'C' AND ROWNUM = 1 ),GLOBALDATE_PKG.GET_LOCCD_FNC('HAMRU')),'YYYY/MM/DD HH24:MI:SS')  AS CLOSE_TIME" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		...
		query.append("        PRI_SP_DL_REC       SR  ," ).append("\n"); 
		query.append("		PRI_SP_DL_REC		SS	," ).append("\n"); 
		...
		query.append("AND		SR.PRNT_SCRN_EVNT_SEQ = SS.PRNT_SCRN_EVNT_SEQ(+)" ).append("\n"); 
		query.append("AND     SR.SP_PRN_EVNT_TP_CD = 'O'" ).append("\n"); 
		query.append("AND     SS.SP_PRN_EVNT_TP_CD(+) = 'S'" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("ORDER BY OPEN_TIME DESC, SAVE_TIME" ).append("\n"); 
