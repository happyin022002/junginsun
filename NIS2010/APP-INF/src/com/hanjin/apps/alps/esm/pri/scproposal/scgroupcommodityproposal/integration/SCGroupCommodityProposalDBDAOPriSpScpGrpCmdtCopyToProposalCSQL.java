...
*@FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGrpCmdtCopyToProposal
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
