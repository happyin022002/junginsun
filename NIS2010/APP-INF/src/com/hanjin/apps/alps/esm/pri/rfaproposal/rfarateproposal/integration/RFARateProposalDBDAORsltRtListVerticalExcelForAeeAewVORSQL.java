...
*@FileName : RFARateProposalDBDAORsltRtListVerticalExcelForAeeAewVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtListVerticalExcelForAeeAewVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtListVerticalExcelForAeeAewVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtListVerticalExcelForAeeAewVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       B.FIC_PROP_RT_AMT," ).append("\n"); 
		query.append("       B.FIC_GLINE_RT_AMT," ).append("\n"); 
		query.append("       B.FIC_GLINE_UPD_DT," ).append("\n"); 
		query.append("       B.OPTM_TRSP_MOD_FLG," ).append("\n"); 
		...
		query.append("                          F.FIC_PROP_RT_AMT," ).append("\n"); 
		...
		query.append("                                     T.ROUT_SEQ," ).append("\n"); 
		query.append("                                     T.ROUT_VIA_PORT_DEF_CD," ).append("\n"); 
		query.append("                                     T.ROUT_VIA_PORT_TP_CD" ).append("\n"); 
		...
		query.append("                                  T.PROP_FRT_RT_AMT - T.FIC_PROP_RT_AMT AS PROP_BOF_AMT," ).append("\n"); 
