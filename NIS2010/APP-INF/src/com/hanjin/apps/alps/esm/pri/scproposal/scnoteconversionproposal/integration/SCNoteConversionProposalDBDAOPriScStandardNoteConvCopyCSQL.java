...
*@FileName : SCNoteConversionProposalDBDAOPriScStandardNoteConvCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOPriScStandardNoteConvCopyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriScStandardNoteConvCopy
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOPriScStandardNoteConvCopyCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteConversionProposalDBDAOPriScStandardNoteConvCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         , @[note_hdr_seq] AS NOTE_HDR_SEQ" ).append("\n"); 
		...
		query.append("         , C.NOTE_HDR_SEQ" ).append("\n"); 
		...
		query.append("       , PRI_SG_STND_NOTE_CTNT D" ).append("\n"); 
		query.append("    WHERE D.SVC_SCP_CD = C.SVC_SCP_CD" ).append("\n"); 
		query.append("    AND   D.NOTE_HDR_SEQ = C.NOTE_HDR_SEQ" ).append("\n"); 
		...
		query.append("     , F.NOTE_HDR_SEQ" ).append("\n"); 
		query.append("     , E.PROP_NO" ).append("\n"); 
		query.append("     , E.AMDT_SEQ" ).append("\n"); 
		query.append("     , E.CHG_RULE_TP_CD" ).append("\n"); 
		query.append("     , E.NOTE_CONV_CHG_CD" ).append("\n"); 
		query.append("     , E.NOTE_CONV_RULE_CD" ).append("\n"); 
		query.append("     , (CASE WHEN ((TO_CHAR(E.EFF_DT,'YYYY-MM-DD') >= @[eff_dt] AND TO_CHAR(EFF_DT,'YYYY-MM-DD') <= @[exp_dt]) OR TO_CHAR(E.EFF_DT,'YYYY-MM-DD') = '9999-12-31' )" ).append("\n"); 
		query.append("        	 THEN E.EFF_DT" ).append("\n"); 
		query.append("			 ELSE TO_DATE(@[eff_dt],'YYYY-MM-DD') END) AS EFF_DT" ).append("\n"); 
		query.append("	 , (CASE WHEN ((TO_CHAR(E.EXP_DT,'YYYY-MM-DD') <= @[exp_dt] AND TO_CHAR(EXP_DT,'YYYY-MM-DD') >= @[eff_dt]) OR TO_CHAR(E.EXP_DT,'YYYY-MM-DD') = '9999-12-31' )	 " ).append("\n"); 
		query.append("        	 THEN E.EXP_DT" ).append("\n"); 
		query.append("        	 ELSE TO_DATE(@[exp_dt],'YYYY-MM-DD') END) AS EXP_DT" ).append("\n"); 
