...
public class EsmPri0063Event extends EventSupport {
	...
	public PriSgGrpCmdtVO[] getPriSgGrpCmdtVOS(){
		PriSgGrpCmdtVO[] rtnVOs = null;
		if (this.priSgGrpCmdtVOs != null) {
			rtnVOs = new PriSgGrpCmdtVO[priSgGrpCmdtVOs.length];
	...
	public PriSpScpGrpCmdtDtlVO[] getPriSpScpGrpCmdtDtlVOS(){
		PriSpScpGrpCmdtDtlVO[] rtnVOs = null;
		if (this.priSpScpGrpCmdtDtlVOs != null) {
			rtnVOs = new PriSpScpGrpCmdtDtlVO[priSpScpGrpCmdtDtlVOs.length];
			System.arraycopy(priSpScpGrpCmdtDtlVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public PriSgGrpCmdtDtlVO[] getPriSgGrpCmdtDtlVOS(){
		PriSgGrpCmdtDtlVO[] rtnVOs = null;
		if (this.priSgGrpCmdtDtlVOs != null) {
			rtnVOs = new PriSgGrpCmdtDtlVO[priSgGrpCmdtDtlVOs.length];
