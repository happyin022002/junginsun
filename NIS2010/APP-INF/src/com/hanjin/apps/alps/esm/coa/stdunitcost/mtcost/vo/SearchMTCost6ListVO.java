...
*@FileName : SearchMTCost6ListVO.java
*@FileTitle : SearchMTCost6ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost6ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost6ListVO> models = new ArrayList<SearchMTCost6ListVO>();
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMnlRqstFlg(JSPUtil.getParameter(request, "mnl_rgst_flg", ""));
	}
	 ...
	 */
	public SearchMTCost6ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost6ListVO[]
	 */
	public SearchMTCost6ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost6ListVO model = null;
		...
		try {
			...
			String[] mnlRqstFlg = (JSPUtil.getParameter(request, prefix	+ "mnl_rgst_flg", length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchMTCost6ListVO();
				if (eqStatus[i] != null)
		...
		return getSearchMTCost6ListVOs();
	}
	 ...
	 * @return SearchMTCost6ListVO[]
	 */
	public SearchMTCost6ListVO[] getSearchMTCost6ListVOs(){
		SearchMTCost6ListVO[] vos = (SearchMTCost6ListVO[])models.toArray(new SearchMTCost6ListVO[models.size()]);
		return vos;
	}
