...
* 1.0 Creation
* 
* 2014.01.17 박다은 [CHM-201428434] [ACM] Other Commission 의 office character code 생성 로직 변경
=========================================================*/
...
public class OTRCommRequestDBDAOAddOTRCommRequestAcmAgnOtrCommCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("		-- [CHM-201428434] [ACM] Other Commission 의 office character code 생성 로직 변경" ).append("\n"); 
