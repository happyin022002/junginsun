...
public class GeneralBookingReceiptDBDAOModifyBkgCustCodeUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",   CUST_ADDR =( SELECT REPLACE(bzet_addr, '@*', CHR(13))" ).append("\n"); 
		...
		query.append(",   CUST_CD_UPD_DT = GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,(SELECT POL_CD FROM BKG_BOOKING WHERE BKG_NO = @[bkg_no]))" ).append("\n"); 
