...
*@FileName : ExcelDownSpaceUtilizationLaneListVO.java
*@FileTitle : ExcelDownSpaceUtilizationLaneListVO
*Open Issues :
*Change history :
...
public class ExcelDownSpaceUtilizationLaneListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ExcelDownSpaceUtilizationLaneListVO> models = new ArrayList<ExcelDownSpaceUtilizationLaneListVO>();
	 ...
	 * @param request
	 * @return SearchSpaceAllocationManage058QtyListVO[]
	 */
	public ExcelDownSpaceUtilizationLaneListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @param request
	 * @param prefix
	 * @return ExcelDownSpaceUtilizationLaneListVO[]
	 */
	public ExcelDownSpaceUtilizationLaneListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ExcelDownSpaceUtilizationLaneListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ExcelDownSpaceUtilizationLaneListVO();
				if (iocCd[i] != null)
		...
		return getExcelDownSpaceUtilizationLaneListVOs();
	}
	 ...
	 * @return ExcelDownSpaceUtilizationLaneListVO[]
	 */
	public ExcelDownSpaceUtilizationLaneListVO[] getExcelDownSpaceUtilizationLaneListVOs(){
		ExcelDownSpaceUtilizationLaneListVO[] vos = (ExcelDownSpaceUtilizationLaneListVO[])models.toArray(new ExcelDownSpaceUtilizationLaneListVO[models.size()]);
		return vos;
	}
