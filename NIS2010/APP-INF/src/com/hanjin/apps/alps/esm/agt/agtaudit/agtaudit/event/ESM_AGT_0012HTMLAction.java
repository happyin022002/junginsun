...
*@FileName : ESM_AGT_012HTMLAction.java
 ...
 * @see EsmAgt0012Event , ESM_AGT_012EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_AGT_0012HTMLAction extends HTMLActionSupport {

	/**
	 * ESM_AGT_012HTMLAction 객체를 생성
	 */
	public ESM_AGT_0012HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_AGT_012Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0012Event event = new EsmAgt0012Event();
