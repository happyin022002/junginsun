...
*@FileName : Kor24ManifestListDBDAOremoveBlInfoDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOremoveBlInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOremoveBlInfoDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOremoveBlInfoDSQL").append("\n");
		query.append("*/").append("\n");
	}
