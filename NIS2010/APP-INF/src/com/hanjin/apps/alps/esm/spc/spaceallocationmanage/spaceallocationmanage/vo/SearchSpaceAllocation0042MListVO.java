...
public class SearchSpaceAllocation0042MListVO extends AbstractValueObject {
	...
	public SearchSpaceAllocation0042MListVO(String ibflag, String pagerows, String trdCd, String subTrdCd, String rlaneCd, String dirCd, 
			String costYr, String costMon, String costWk, String vslCd, String skdVoyNo, String skdDirCd, String vvd, String bsaVol, String bsaWgt, 
			String lodVol, String lodWgt, String lodHc, String lod45, String lodRf, String qtaOcn, String qtaIpc, String fcOcnVol, String fcOcnWgt, 
			String fcIpcVol, String fcIpcWgt, String alOcnVol, String alOcnWgt, String alIpcVol, String alIpcWgt, String bkgOcnVol, String bkgOcnWgt, 
			...
			String fcTsWgt,String alTsVol,String alTsWgt,String bkgTsVol,String bkgTsWgt,String bkgBsVol,String bkgBsWgt, String cmOp, String cmOc, String cmVl, String acct, 
			String season, String usable, String ctrlD2Flg, String ctrlD4Flg, String ctrlRdFlg, String ctrlEccFlg, String ctrlLocFlg, String ctrlUsaSvcModFlg,
			String ctrlAcctFlg, String ctrlDestLvlCd, String sbFlg, String ctrlFxRtFlg,String bkgWgtVgm,String bkgVolVgm,String bkgIpcVolVgm,String bkgOcnVolVgm,String bkgTsVolVgm) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("usable", getUsable());
		...
		this.hashColumns.put("sb_flg", getSbFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("usable", "usable");
		...
		this.hashFields.put("sb_flg", "sbFlg");
	...
	public void setSbFlg(String sbFlg) {
		this.sbFlg = sbFlg;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setUsable(JSPUtil.getParameter(request, prefix + "usable", ""));
		...
		setSbFlg(JSPUtil.getParameter(request, prefix + "sb_flg", ""));
	...
	public SearchSpaceAllocation0042MListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] usable = (JSPUtil.getParameter(request, prefix	+ "usable", length));
			...
			String[] sbFlg = (JSPUtil.getParameter(request, prefix	+ "sb_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (sbFlg[i] != null)
					model.setSbFlg(sbFlg[i]);	
				if (ctrlFxRtFlg[i] != null) model.setCtrlFxRtFlg(ctrlFxRtFlg[i]);	
				if (bkgWgtVgm[i] != null) model.setBkgWgtVgm(bkgWgtVgm[i]);
				if (bkgIpcWgtVgm[i] != null) model.setBkgIpcWgtVgm(bkgIpcWgtVgm[i]);
				if (bkgOcnWgtVgm[i] != null) model.setBkgOcnWgtVgm(bkgOcnWgtVgm[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.usable = this.usable .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.sbFlg = this.sbFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
