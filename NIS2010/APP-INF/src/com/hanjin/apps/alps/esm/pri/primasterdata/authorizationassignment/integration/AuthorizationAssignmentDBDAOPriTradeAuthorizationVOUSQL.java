...
*@FileName : AuthorizationAssignmentDBDAOPriTradeAuthorizationVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AuthorizationAssignmentDBDAOPriTradeAuthorizationVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Trade Authorization 생성
	  * </pre>
	  */
	public AuthorizationAssignmentDBDAOPriTradeAuthorizationVOUSQL(){
		setQuery();
		...
		query.append("FileName : AuthorizationAssignmentDBDAOPriTradeAuthorizationVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
