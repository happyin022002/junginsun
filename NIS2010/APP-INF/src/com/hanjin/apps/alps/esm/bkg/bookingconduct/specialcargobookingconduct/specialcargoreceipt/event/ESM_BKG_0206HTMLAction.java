...
*@FileName : ESM_BKG_0206HTMLAction.java
...
public class ESM_BKG_0206HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0206HTMLAction 객체를 생성
	 */
	public ESM_BKG_0206HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0206Event event = new EsmBkg0206Event();
        log.debug("::CALL::> ESM_BKG_0206_HTMLAction - " + command.getCommand());
