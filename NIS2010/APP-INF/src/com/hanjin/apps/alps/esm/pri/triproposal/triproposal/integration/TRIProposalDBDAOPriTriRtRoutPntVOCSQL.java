...
*@FileName : TRIProposalDBDAOPriTriRtRoutPntVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtRoutPntVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtRoutPntVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtRoutPntVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRI_RT_ROUT_PNT (" ).append("\n"); 
