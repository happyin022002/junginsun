...
*@FileName : SCTransportationAdditionalChargeProposalDBDAOArbitraryAcceptAllVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCTransportationAdditionalChargeProposalDBDAOArbitraryAcceptAllVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCTransportationAdditionalChargeProposalDBDAOArbitraryAcceptAllVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCTransportationAdditionalChargeProposalDBDAOArbitraryAcceptAllVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${prop_sts_cd} == 'Q')" ).append("\n"); 
		query.append(", FNL_FRT_RT_AMT = PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(", FNL_FRT_RT_AMT = DECODE(COFFR_FRT_RT_AMT,NULL,PROP_FRT_RT_AMT,COFFR_FRT_RT_AMT)" ).append("\n"); 
