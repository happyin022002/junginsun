...
*@FileName : SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCContractClauseGuidelineDBDAOPriSgCtrtCluzVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE pri_sg_ctrt_cluz SET" ).append("\n"); 
