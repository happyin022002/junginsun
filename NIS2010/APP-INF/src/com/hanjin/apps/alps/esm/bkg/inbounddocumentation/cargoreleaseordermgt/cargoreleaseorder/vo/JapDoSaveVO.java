...
*@FileName : JapDoSaveVO.java
*@FileTitle : JapDoSaveVO
*Open Issues :
*Change history :
...
public class JapDoSaveVO extends AbstractValueObject {

	/**
	 *
	 */
	private static final long serialVersionUID = 8628492345270835768L;

	private Collection<JapDoSaveVO> models = new ArrayList<JapDoSaveVO>();
	...
	/* Column Info */
	private String blissIbdDocRcvFlg = null;
	/* Column Info */
	private String blissOldIbdDocRcvFlg = null;
	...
	public JapDoSaveVO(String ibflag, String pagerows, String bkgNo, String cstmsRefNm, String cstmsRefCtnt, String cstmsAsgnNm, String cstmsAsgnCtnt, String interRmk, String doHldFlg, String creUsrId, String creDt, String updUsrId, String updDt, String cyOpCd, String infoCgoFlg, String idaImpGenMfNo, String idaCgorOrdYr, String idaCstmsAsgnLineNo, String doSplitFlg, String oblCngFlg, String doCngEvntCd, String oldOblRdemKnt, String newOblRdemKnt, String blissIbdDocRcvFlg, String blissOldIbdDocRcvFlg, String attrCtnt1, String attrCtnt2, String attrCtnt3, String attrCtnt4, String attrCtnt5) {
		this.updDt = updDt;
		...
		this.blissIbdDocRcvFlg = blissIbdDocRcvFlg;
		this.blissOldIbdDocRcvFlg = blissOldIbdDocRcvFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bliss_ibd_doc_rcv_flg", getBlissIbdDocRcvFlg());
		this.hashColumns.put("bliss_old_ibd_doc_rcv_flg", getBlissOldIbdDocRcvFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("bliss_ibd_doc_rcv_flg", "blissIbdDocRcvFlg");
		this.hashFields.put("bliss_old_ibd_doc_rcv_flg", "blissOldIbdDocRcvFlg");
	...
	/**
	 * Column Info
	 * @return blissIbdDocRcvFlg
	 */
	public String getBlissIbdDocRcvFlg() {
		return this.blissIbdDocRcvFlg;
	}

	/**
	 * Column Info
	 * @return blissOldIbdDocRcvFlg
	 */
	public String getBlissOldIbdDocRcvFlg() {
		return this.blissOldIbdDocRcvFlg;
	}
	...
	/**
	 * Column Info
	 * @param blissIbdDocRcvFlg
	 */
	public void setBlissIbdDocRcvFlg(String blissIbdDocRcvFlg) {
		this.blissIbdDocRcvFlg = blissIbdDocRcvFlg;
	}

	/**
	 * Column Info
	 * @param blissOldIbdDocRcvFlg
	 */
	public void setBlissOldIbdDocRcvFlg(String blissOldIbdDocRcvFlg) {
		this.blissOldIbdDocRcvFlg = blissOldIbdDocRcvFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBlissIbdDocRcvFlg(JSPUtil.getParameter(request, "bliss_ibd_doc_rcv_flg", ""));
		setBlissOldIbdDocRcvFlg(JSPUtil.getParameter(request, "bliss_old_ibd_doc_rcv_flg", ""));
	 ...
	 * @return JapDoSaveVO[]
	 */
	public JapDoSaveVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapDoSaveVO[]
	 */
	public JapDoSaveVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JapDoSaveVO model = null;
		...
		try {
			...
			String[] blissIbdDocRcvFlg = (JSPUtil.getParameter(request, prefix	+ "bliss_ibd_doc_rcv_flg", length));
			String[] blissOldIbdDocRcvFlg = (JSPUtil.getParameter(request, prefix	+ "bliss_old_ibd_doc_rcv_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (blissIbdDocRcvFlg[i] != null)
					model.setBlissIbdDocRcvFlg(blissIbdDocRcvFlg[i]);
				if (blissOldIbdDocRcvFlg[i] != null)
					model.setBlissOldIbdDocRcvFlg(blissOldIbdDocRcvFlg[i]);
				if (attrCtnt1[i] != null)
	 ...
	 * @return JapDoSaveVO[]
	 */
	public JapDoSaveVO[] getJapDoSaveVOs(){
		JapDoSaveVO[] vos = (JapDoSaveVO[])models.toArray(new JapDoSaveVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.blissIbdDocRcvFlg = this.blissIbdDocRcvFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.blissOldIbdDocRcvFlg = this.blissOldIbdDocRcvFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
