...
*@FileName : NetworkCostDBDAOMultiAverageUCCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOMultiAverageUCCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Average U/C(OP fixed/variable cost, SPC CHT Rev/Charterage)
	  * </pre>
	  */
	public NetworkCostDBDAOMultiAverageUCCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOMultiAverageUCCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_OP_AVG_UT_COST A " ).append("\n"); 
