...
public class Jp24ManifestListDownloadDBDAOSearchCargoInfoHeaderRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("WHERE SKD.CLPT_IND_SEQ = '1'" ).append("\n"); 
		...
		query.append("AND SKD.VPS_PORT_CD LIKE @[pod_prefix]||@[pod_postfix]||'%'" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		...
		query.append("AND BKG.BKG_NO = @[bl_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
