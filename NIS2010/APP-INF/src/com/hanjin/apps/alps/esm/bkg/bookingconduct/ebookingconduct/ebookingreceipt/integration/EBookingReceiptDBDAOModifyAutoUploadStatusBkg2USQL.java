...
*@FileName : EBookingReceiptDBDAOModifyAutoUploadStatusBkg2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOModifyAutoUploadStatusBkg2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOModifyAutoUploadStatusBkg2USQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOModifyAutoUploadStatusBkg2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET SYS_UPLD_FLG = @[sys_upld_flg]" ).append("\n"); 
