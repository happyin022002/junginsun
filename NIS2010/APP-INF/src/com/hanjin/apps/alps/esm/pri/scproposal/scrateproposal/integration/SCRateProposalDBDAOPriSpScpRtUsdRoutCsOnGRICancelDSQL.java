...
*@FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsOnGRICancelDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtUsdRoutCsOnGRICancelDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtUsdRoutCsOnGRICancelDSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsOnGRICancelDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_SP_SCP_RT_USD_ROUT_CS T" ).append("\n"); 
