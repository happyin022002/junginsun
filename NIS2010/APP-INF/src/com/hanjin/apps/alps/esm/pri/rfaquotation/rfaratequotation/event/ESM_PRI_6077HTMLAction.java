...
*@FileName : ESM_PRI_6077HTMLAction.java
...
public class ESM_PRI_6077HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6077HTMLAction 객체를 생성
	 */
	public ESM_PRI_6077HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6077Event event = new EsmPri6077Event();
		 
		if(command.isCommand(FormCommand.MULTI)) {
			PriRqRtCmdtRoutSetVO vo = (PriRqRtCmdtRoutSetVO)getVO(request, PriRqRtCmdtRoutSetVO.class);
			PriRqRtCmdtRoutVO[] routVOs = (PriRqRtCmdtRoutVO[])getVOs(request, PriRqRtCmdtRoutVO .class,"");
			vo.setPriRqRtCmdtRoutVOS(routVOs);
			event.setPriRqRtCmdtRoutSetVO(vo);
		}
