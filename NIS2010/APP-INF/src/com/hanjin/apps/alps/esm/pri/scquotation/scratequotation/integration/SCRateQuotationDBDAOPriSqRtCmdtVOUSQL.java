...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtVOUSQL.java
...
public class SCRateQuotationDBDAOPriSqRtCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_RT_CMDT SET" ).append("\n"); 
