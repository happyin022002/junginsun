...
*@FileName : HongKongCustomsTransmissionDBDAOsearchMarksDescRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HongKongCustomsTransmissionDBDAOsearchMarksDescRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public HongKongCustomsTransmissionDBDAOsearchMarksDescRSQL(){
		setQuery();
		...
		query.append("FileName : HongKongCustomsTransmissionDBDAOsearchMarksDescRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("BMD.CMDT_DESC CMDT_DESC," ).append("\n"); 
		query.append("BMD.MK_DESC MK_DESC" ).append("\n"); 
