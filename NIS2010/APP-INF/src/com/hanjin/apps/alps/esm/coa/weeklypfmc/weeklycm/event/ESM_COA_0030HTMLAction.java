...
*@FileName : ESM_COA_0030HTMLAction.java
...
public class ESM_COA_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0030HTMLAction 객체를 생성
	 */
	public ESM_COA_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0030Event event = new EsmCoa0030Event();
