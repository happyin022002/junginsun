...
*@FileName : CndExpManifestListDownloadDBDAOaddBkgCstmsAdvMkDescCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOaddBkgCstmsAdvMkDescCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOaddBkgCstmsAdvMkDescCSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOaddBkgCstmsAdvMkDescCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO  BKG_CSTMS_AMER_MK_DESC" ).append("\n"); 
		query.append("(" ).append("\n"); 
