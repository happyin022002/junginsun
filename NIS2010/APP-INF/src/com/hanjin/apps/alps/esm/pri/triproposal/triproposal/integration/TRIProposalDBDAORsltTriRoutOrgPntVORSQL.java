...
*@FileName : TRIProposalDBDAORsltTriRoutOrgPntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAORsltTriRoutOrgPntVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAORsltTriRoutOrgPntVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAORsltTriRoutOrgPntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
