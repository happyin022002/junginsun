...
*@FileName : ESM_PRI_0022HTMLAction.java
...
public class ESM_PRI_0022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0022HTMLAction 객체를 생성
	 */
	public ESM_PRI_0022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0022Event event = new EsmPri0022Event();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriSpCtrtCustTpVOS((PriSpCtrtCustTpVO[])getVOs(request, PriSpCtrtCustTpVO .class,""));
		}
		else if(command.isCommand(FormCommand.MULTI02)) {
			event.setPriSpCtrtPtyVOS((PriSpCtrtPtyVO[])getVOs(request, PriSpCtrtPtyVO .class,""));
		}
			...
			//2011.03.30 이행지 [CHM-201109659-01] File Upload Key를 담기 위한 로직 추가
