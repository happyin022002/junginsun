...
*@FileName : SpecialCargoReceiptDBDAObkgRfCgoVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAObkgRfCgoVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAObkgRfCgoVODSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAObkgRfCgoVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("DELETE FROM BKG_RF_CGO_HIS" ).append("\n"); 
