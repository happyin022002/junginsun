...
*@FileName : NetworkDistributionDBDAOSearchAgrdNtwkAllocByAgmtInterCreDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOSearchAgrdNtwkAllocByAgmtInterCreDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkDistributionDBDAOSearchAgrdNtwkAllocByAgmtInterCreDSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOSearchAgrdNtwkAllocByAgmtInterCreDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MAS_ALOC_INTER_TS_EXPN" ).append("\n"); 
