...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.basic;

import java.util.List;

import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.basic.CustomsTransmissionBCImpl;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.integration.IndiaCustomsTransmissionDBDAO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaBlListDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaCntrListDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaCntrMtDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaIgmVslResultVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaIgmVslVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaMaxSeqModiVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaTransmitCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.india.vo.IndiaTransmitDetailVO;
 ...
 * @since J2EE 1.6
 */
public class IndiaCustomsTransmissionBCImpl extends CustomsTransmissionBCImpl {
		...
		if(manifestTransmitVO != null) {
			...
			switch(Integer.parseInt(processType)) {
				case 1 : { // Contaniner List(EDI)
					retFlatFile = transmitContainerListManifest(manifestTransmitVO);
					break;
				}
				case 2 : { // India IGM Generation (EDI) 
					retFlatFile = transmitIGMGenerationManifest(manifestTransmitVO);
					break;
				}
				case 3 : { // TP Request (EDI)
					retFlatFile = transmitTPRequestManifest(manifestTransmitVO);
					break;
				}
				default : {}
			} // end switch()
	...
	private String transmitIGMGenerationManifest(ManifestTransmitVO manifestTransmitVO) throws EventException {
		...
		try {
			...
			podCd = indiaTransmitCondVO.getPodCd();
...
//								if("1".equals(msgType) && "INNAH".equals(podCd)){
//									flatFile.append(indiaCntrMtDetailVO.getIdaMrnLineOprId()).append((char)29);
//								}else {
