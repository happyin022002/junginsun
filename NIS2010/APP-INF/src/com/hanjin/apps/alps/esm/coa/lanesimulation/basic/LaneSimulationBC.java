...
/**
 * ALPS-COA Business Logic Command Interface<br>
 * - ALPS-COA에 대한 비지니스 로직에 대한 인터페이스<br>
 *
 * @author eunju park
 * @see ESM_COA_0051EventResponse 참조
 * @since J2EE 1.4
 */
public interface LaneSimulationBC  {
	/* ====================================================================================
	  ...
	  ==================================================================================== */
	/**
	 * ESM_COA_0051 화면의 Lane Simulation 조회 이벤트를 처리한다.
	 * 
	...
	/**
	* ESM_COA_0051 화면의 Lane Simulation 저장 이벤트를 처리한다.
	...
	*/
	...
	/**
	* ESM_COA_0051 화면의 Vessel Info 조회 이벤트를 처리한다.
	* 
	...
	*/
	...
	/**
	* ESM_COA_0051 화면의 Simulation Vessel 조회 이벤트를 처리한다.
	* 
	...
	*/
	...
	/**
	* ESM_COA_0051 화면의 Simulation Vessel 저장 이벤트를 처리한다.
	* 
	...
	*/
	...
	/**
	* ESM_COA_0165 화면의 Lane Simulation 조회 이벤트를 처리한다.
	* 
	...
	*/
	...
	/**
	* ESM_COA_0165 화면의 Lane Simulation 삭제 이벤트를 처리한다.
	* 
	...
	*/
	...
	/**
	* ESM_COA_0166 화면의 Lane Simulation 조회 이벤트를 처리한다.
	* 
...
//    public SearchSimCalcVO multiSimPortCalc(SearchSimCalcVO vos) throws EventException;    
     ...
     * 
     * @param CoaBnkCsmVO[] coaBnkCsmVOS
     * @param SignOnUserAccount account
     * @throws EventException
     */
    public void multiSimConsum(CoaBnkCsmVO[] coaBnkCsmVOS,SignOnUserAccount account) throws EventException;
    /*================================================================================================================*/   
    /**
	 ...
	 * @throws EventException
	 */
    public List<CoaSimInfoVO> createCoaSimRqst(PfSkdGRPVO vo, String ind, SignOnUserAccount account) throws EventException;
