...
*@FileName : EurCustomsTransmissionDBDAOsearchUviRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurCustomsTransmissionDBDAOsearchUviRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurCustomsTransmissionDBDAOsearchUviRSQL(){
		setQuery();
		...
		query.append("FileName : EurCustomsTransmissionDBDAOsearchUviRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   PORT_CD             =  DECODE(NVL(@[pod_cd], ''), '', @[pol_cd], @[pod_cd])" ).append("\n"); 
