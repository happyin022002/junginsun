...
*@FileName : ScqAwkwardDBDAOremovePriScqProgAwkDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqProgAwkDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *   PRI_SCQ_PROG 의 삭제 구문이 필요
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqProgAwkDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqProgAwkDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
