...
public class ESM_PRI_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0009HTMLAction 객체를 생성
	 */
	public ESM_PRI_0009HTMLAction() {}
	...
	public Event perform (HttpServletRequest request) throws HTMLActionException {
        ...
        EsmPri0009Event event = new EsmPri0009Event();
        ...
        if (command.isCommand(FormCommand.MULTI)) {
            ...
            if (vos != null) {
                for (int i = 0, n = vos.length; i < n; i++) {
                    vos[i].setSvcScpCd(request.getParameter("svc_scp_cd"));
                }
            }
