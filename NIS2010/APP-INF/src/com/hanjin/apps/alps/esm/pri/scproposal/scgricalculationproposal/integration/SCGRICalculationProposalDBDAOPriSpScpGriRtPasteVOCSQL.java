...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriRtPasteVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriRtPasteVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriRtPasteVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriRtPasteVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_GRI_RT (" ).append("\n"); 
		...
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_GRI_RT_CPY" ).append("\n"); 
