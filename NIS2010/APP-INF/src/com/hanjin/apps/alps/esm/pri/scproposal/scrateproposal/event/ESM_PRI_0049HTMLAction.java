 ...
 *@FileName : ESM_PRI_0049HTMLAction.java
...
public class ESM_PRI_0049HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0049Event event = new EsmPri0049Event();
