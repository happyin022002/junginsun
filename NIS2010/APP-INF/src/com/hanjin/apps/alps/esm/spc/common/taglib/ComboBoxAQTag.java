 ...
 * @since J2EE 1.4
 */
public class ComboBoxAQTag extends ComboBoxTag {
	private static transient org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ComboBoxAQTag.class);
	String rhq = "";
	...
	protected String[][] getOptionList() throws EventException {
		...
		String[][] datas = null;
		try {
			response = (ComboxEventResponse) sc.searchAQComboList(getModule(), rhq, getDel());
