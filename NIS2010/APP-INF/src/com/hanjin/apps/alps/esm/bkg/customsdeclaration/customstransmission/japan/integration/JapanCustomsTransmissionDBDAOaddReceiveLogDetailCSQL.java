...
*@FileName : JapanCustomsTransmissionDBDAOaddReceiveLogDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanCustomsTransmissionDBDAOaddReceiveLogDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanCustomsTransmissionDBDAOaddReceiveLogDetailCSQL(){
		setQuery();
		...
		query.append("FileName : JapanCustomsTransmissionDBDAOaddReceiveLogDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
