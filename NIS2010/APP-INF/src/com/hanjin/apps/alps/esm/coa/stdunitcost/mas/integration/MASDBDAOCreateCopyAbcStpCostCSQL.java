...
public class MASDBDAOCreateCopyAbcStpCostCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("#if(${table_name} =='COA_SVC_TRNS_PRC')" ).append("\n"); 
		query.append("INSERT INTO COA_SVC_TRNS_PRC" ).append("\n"); 
		...
		query.append("#elseif (${table_name} =='COA_SVC_TRNS_OFC_MAPG')" ).append("\n"); 
		query.append("INSERT INTO COA_SVC_TRNS_OFC_MAPG" ).append("\n"); 
		...
		query.append("    @[user_id]," ).append("\n"); 
		query.append("    SYSDATE" ).append("\n"); 
		query.append("FROM  COA_SVC_TRNS_OFC_MAPG" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]" ).append("\n"); 
		query.append("#elseif (${table_name} =='COA_OFC_ROUT_MAPG')" ).append("\n"); 
		query.append("INSERT INTO COA_OFC_ROUT_MAPG" ).append("\n"); 
		...
		query.append("    @[user_id]," ).append("\n"); 
		query.append("    SYSDATE" ).append("\n"); 
		query.append("FROM  COA_OFC_ROUT_MAPG" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif (${table_name} =='COA_SVC_TRNS_PRC_MGN')" ).append("\n"); 
		query.append("INSERT INTO COA_SVC_TRNS_PRC_MGN" ).append("\n"); 
		...
		query.append("    @[user_id]," ).append("\n"); 
		query.append("    SYSDATE" ).append("\n"); 
		query.append("FROM  COA_SVC_TRNS_PRC_MGN" ).append("\n"); 
		query.append("WHERE COST_YRMON = @[f_src_mon]" ).append("\n"); 
