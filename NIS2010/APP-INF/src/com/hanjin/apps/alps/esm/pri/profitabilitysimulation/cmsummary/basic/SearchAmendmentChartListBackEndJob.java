 ...
 * @since J2EE 1.6
 */
public class SearchAmendmentChartListBackEndJob extends BackEndCommandSupport{
	...
	public DBRowSet doStart() throws Exception {
		...
		try {
			List<RsltPrsAmendmentSummaryChartTargetListVO>  vo = dbDao.searchAmendmentChartTargetList(inPrsAmendmentCmSummaryVO);

			rowSet = dbDao.searchAmendmentChartList(inPrsAmendmentCmSummaryVO,vo);
