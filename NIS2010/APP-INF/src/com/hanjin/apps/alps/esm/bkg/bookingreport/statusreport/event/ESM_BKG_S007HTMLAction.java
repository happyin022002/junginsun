...
public class ESM_BKG_S007HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0071HTMLAction 객체를 생성
     */
    public ESM_BKG_S007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkgS007Event event = new EsmBkgS007Event();
		
		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((SearchRollOverInformationVO) getVO(request, SearchRollOverInformationVO.class));
		}
