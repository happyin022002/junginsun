...
*@FileName : ESM_BKG_1057HTMLAction.java
...
public class ESM_BKG_1057HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1057HTMLAction 객체를 생성
	 */
	public ESM_BKG_1057HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1057Event event = new EsmBkg1057Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			//event.setInfoVO((SearchFCLListVO) getVO(request, SearchFCLListVO .class));
			event.setsearchFCLListVO((SearchFCLListVO)getVO(request, SearchFCLListVO .class));
