...
*@FileName : WeeklyCMDBDAOMasMonVvdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOMasMonVvdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *   A: AR Only 일때 MAS_MON_VVD Insert
	  * </pre>
	  */
	public WeeklyCMDBDAOMasMonVvdVOCSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOMasMonVvdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_MON_VVD												" ).append("\n"); 
		...
		query.append("       ,HJS_BSA_RTO      ,CHTR_BSA_RTO         ,VVD_BSA_CAPA			 " ).append("\n"); 
		...
		query.append("       ,SKD.VPS_PORT_CD  ,0                    ,'AR Only'				 " ).append("\n"); 
		...
		query.append("       ,MAS_LANE_RGST    LANE											 " ).append("\n"); 
