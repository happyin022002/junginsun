...
public class EsmPri200301Event extends EventSupport {
	...
	public RsltNoteCtntListVO[] getRsltNoteCtntListVOS(){
		RsltNoteCtntListVO[] rtnVOs = null;
		if (this.rsltNoteCtntListVOs != null) {
			rtnVOs = new RsltNoteCtntListVO[rsltNoteCtntListVOs.length];
			System.arraycopy(rsltNoteCtntListVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public PriRpScpNoteCtntVO[] getPriRpScpNoteCtntVOS(){
		PriRpScpNoteCtntVO[] rtnVOs = null;
		if (this.priRpScpNoteCtntVOs != null) {
			rtnVOs = new PriRpScpNoteCtntVO[priRpScpNoteCtntVOs.length];
			System.arraycopy(priRpScpNoteCtntVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public RsltNoteListVO[] getRsltNoteListVOS(){
		RsltNoteListVO[] rtnVOs = null;
		if (this.rsltNoteListVOs != null) {
			rtnVOs = new RsltNoteListVO[rsltNoteListVOs.length];
			System.arraycopy(rsltNoteListVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
