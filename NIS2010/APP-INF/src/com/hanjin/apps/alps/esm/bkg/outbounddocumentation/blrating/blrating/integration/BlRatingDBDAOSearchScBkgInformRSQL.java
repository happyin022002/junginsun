...
*@FileName : BlRatingDBDAOSearchScBkgInformRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOSearchScBkgInformRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOSearchScBkgInformRSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOSearchScBkgInformRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,(SELECT REP_CMDT_NM FROM MDM_REP_CMDT K WHERE K.REP_CMDT_CD = MAI.REP_CMDT_CD) AS REP_CMDT_NM" ).append("\n"); 
		...
		query.append("	,SC_NO AS FSC_NO" ).append("\n"); 
		query.append("	,TVVD AS BKG_VVD" ).append("\n"); 
		...
		query.append("      FROM PRI_SP_PROG P, COM_USER U" ).append("\n"); 
		...
		query.append("		,NVL(BKG.PORT_SKP_FLG,'N') PORT_SKP_FLG" ).append("\n"); 
		...
		query.append("		AND BL.CORR_NO ='TMP0000001'  ) MAI" ).append("\n"); 
		query.append(",(SELECT S.SREP_EML" ).append("\n"); 
		query.append("        ,S.SREP_CD" ).append("\n"); 
		query.append("    FROM PRI_SP_MN P, MDM_SLS_REP S" ).append("\n"); 
		query.append("   WHERE (P.PROP_NO, P.AMDT_SEQ) IN (SELECT MN.PROP_NO" ).append("\n"); 
		query.append("                                          , MAX(MN.AMDT_SEQ) AMDT_SEQ" ).append("\n"); 
		query.append("                                       FROM PRI_SP_MN MN, PRI_SP_HDR HDR" ).append("\n"); 
		query.append("                                      WHERE HDR.SC_NO = @[sc_no]" ).append("\n"); 
		...
		query.append("										AND   MN.PROP_STS_CD = 'F'" ).append("\n"); 
		query.append("                                      GROUP BY MN.PROP_NO)" ).append("\n"); 
		query.append("     AND S.SREP_CD = P.PROP_SREP_CD ) SREP" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
		query.append("	BKG_NO" ).append("\n"); 
		...
		query.append("	WHERE " ).append("\n"); 
		query.append("		BKG.BKG_NO = BL.BKG_NO " ).append("\n"); 
		query.append("		AND BKG.BKG_NO= @[bkg_no]  ) MAI" ).append("\n"); 
		query.append(",(SELECT S.SREP_EML" ).append("\n"); 
		query.append("        ,S.SREP_CD" ).append("\n"); 
		query.append("    FROM PRI_SP_MN P, MDM_SLS_REP S" ).append("\n"); 
		query.append("   WHERE (P.PROP_NO, P.AMDT_SEQ) IN (SELECT MN.PROP_NO" ).append("\n"); 
