...
*@FileName : ESM_PRI_0057_09HTMLAction.java
...
public class ESM_PRI_0057_09HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0057_09HTMLAction 객체를 생성
	 */
	public ESM_PRI_0057_09HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri005709Event event = new EsmPri005709Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltAfilListVO((RsltAfilListVO)getVO(request, RsltAfilListVO.class));
