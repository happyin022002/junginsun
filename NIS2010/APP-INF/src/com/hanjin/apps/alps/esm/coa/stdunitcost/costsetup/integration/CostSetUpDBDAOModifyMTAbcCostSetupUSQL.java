...
*@FileName : CostSetUpDBDAOModifyMTAbcCostSetupUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostSetUpDBDAOModifyMTAbcCostSetupUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostSetUpDBDAOModifyMTAbcCostSetupUSQL(){
		setQuery();
		...
		query.append("FileName : CostSetUpDBDAOModifyMTAbcCostSetupUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
