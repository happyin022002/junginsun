...
*@FileName : AGTAuditDBDAOCreateAGTCSRHeaderApInvIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOCreateAGTCSRHeaderApInvIfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateAGTCSRHeaderApInvIf
	  * </pre>
	  */
	public AGTAuditDBDAOCreateAGTCSRHeaderApInvIfCSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOCreateAGTCSRHeaderApInvIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AP_INV_IF" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("'ESMAGTAGN'||C.LOCAL_DT," ).append("\n"); 
		query.append("ROWNUM" ).append("\n"); 
		query.append("+" ).append("\n"); 
		query.append("(     SELECT" ).append("\n"); 
		query.append("NVL(MAX(INV_SEQ)+1, 0)" ).append("\n"); 
		query.append("FROM AP_INV_IF" ).append("\n"); 
		query.append("WHERE AP_PGM_NO = 'ESMAGTAGN'||C.LOCAL_DT" ).append("\n"); 
		query.append(") ," ).append("\n"); 
		query.append("(     SELECT" ).append("\n"); 
		...
		query.append("ROUND(A.INV_DT, 2)," ).append("\n"); 
		...
		query.append("ROUND(B.INV_AMT, 2)," ).append("\n"); 
