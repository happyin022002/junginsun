...
*@FileName : RFAProposalMainDBDAORqCpPriRpAmdtSmryVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORqCpPriRpAmdtSmryVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAProposalMainDBDAORqCpPriRpAmdtSmryVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORqCpPriRpAmdtSmryVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RP_AMDT_SMRY(" ).append("\n"); 
		...
		query.append("WHEN INTG_CD_VAL_CTNT = '08' THEN 'Y'" ).append("\n"); 
		...
		query.append("INTG_CD_ID = 'CD01739'" ).append("\n"); 
