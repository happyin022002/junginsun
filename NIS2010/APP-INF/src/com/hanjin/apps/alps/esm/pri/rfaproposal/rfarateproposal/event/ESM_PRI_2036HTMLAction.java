 ...
 *@FileName : ESM_PRI_2036HTMLAction.java
...
public class ESM_PRI_2036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_0093HTMLAction 객체를 생성
	 */
	public ESM_PRI_2036HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2036Event event = new EsmPri2036Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			vo.setPriRpScpTrspAddChgVOS((PriRpScpTrspAddChgVO[])getVOs(request, PriRpScpTrspAddChgVO .class, "sheet2_"));	// Arbitrary
			vo.setPriRpScpNoteCtntVOS((PriRpScpNoteCtntVO[])getVOs(request, PriRpScpNoteCtntVO .class, "sheet3_"));	// Special Notes
			vo.setPriRpScpGrpLocDtlVOS((PriRpScpGrpLocDtlVO[])getVOs(request, PriRpScpGrpLocDtlVO .class, "sheet4_"));	// Location Group
			vo.setPriRpScpGrpCmdtDtlVOS((PriRpScpGrpCmdtDtlVO[])getVOs(request, PriRpScpGrpCmdtDtlVO .class, "sheet5_"));	// Commodity Group
