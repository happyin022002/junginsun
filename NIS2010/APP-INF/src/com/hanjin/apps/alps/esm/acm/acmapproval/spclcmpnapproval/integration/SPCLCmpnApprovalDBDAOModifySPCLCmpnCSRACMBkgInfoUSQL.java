...
*@FileName : SPCLCmpnApprovalDBDAOModifySPCLCmpnCSRACMBkgInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPCLCmpnApprovalDBDAOModifySPCLCmpnCSRACMBkgInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySPCLCmpnCSRACMBkgInfo
	  * </pre>
	  */
	public SPCLCmpnApprovalDBDAOModifySPCLCmpnCSRACMBkgInfoUSQL(){
		setQuery();
		...
		query.append("FileName : SPCLCmpnApprovalDBDAOModifySPCLCmpnCSRACMBkgInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
