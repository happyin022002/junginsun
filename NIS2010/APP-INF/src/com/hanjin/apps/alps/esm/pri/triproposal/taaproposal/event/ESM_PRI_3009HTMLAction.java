...
*@FileName : ESM_PRI_3009HTMLAction.java
...
public class ESM_PRI_3009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3009HTMLAction 객체를 생성
	 */
	public ESM_PRI_3009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3009Event event = new EsmPri3009Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltTaaTriListVO((RsltTaaTriListVO)getVO(request, RsltTaaTriListVO.class));
