...
*@FileName : ESM_FMS_00331HTMLAction.java
...
public class ESM_FMS_00331HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0032HTMLAction 객체를 생성
	 */
	public ESM_FMS_00331HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms00331Event event = new EsmFms00331Event();

 		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondSearchInvoiceNoVO((CondSearchInvoiceNoVO)getVO(request, CondSearchInvoiceNoVO .class));
		}
