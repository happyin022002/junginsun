...
*@FileName : RsltPriScgAplyDtRuleVO.java
*@FileTitle : RsltPriScgAplyDtRuleVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.pri.surcharge.applicationdaterule.vo;
...
public class RsltPriScgAplyDtRuleVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriScgAplyDtRuleVO> models = new ArrayList<RsltPriScgAplyDtRuleVO>();
	...
	public RsltPriScgAplyDtRuleVO() {}

	public RsltPriScgAplyDtRuleVO(String ibflag, String pagerows, String scgAplyDtRuleSeq, String svcScpCd, String porDefCd, String porTpCd, String polDefCd, String polTpCd, String podDefCd, String podTpCd, String delDefCd, String delTpCd, String aplyDtRuleTpCd, String effDt, String expDt, String updUsrId, String updDt, String aplyDtRmk) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return RsltPriScgAplyDtRuleVO[]
	 */
	public RsltPriScgAplyDtRuleVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriScgAplyDtRuleVO[]
	 */
	public RsltPriScgAplyDtRuleVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriScgAplyDtRuleVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriScgAplyDtRuleVO();
				if (updDt[i] != null)
		...
		return getRsltPriScgAplyDtRuleVOs();
	}
	 ...
	 * @return RsltPriScgAplyDtRuleVO[]
	 */
	public RsltPriScgAplyDtRuleVO[] getRsltPriScgAplyDtRuleVOs(){
		RsltPriScgAplyDtRuleVO[] vos = (RsltPriScgAplyDtRuleVO[])models.toArray(new RsltPriScgAplyDtRuleVO[models.size()]);
		return vos;
	}
