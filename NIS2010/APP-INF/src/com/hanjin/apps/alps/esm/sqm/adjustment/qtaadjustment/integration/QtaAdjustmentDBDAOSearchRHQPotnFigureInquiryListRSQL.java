...
public class QtaAdjustmentDBDAOSearchRHQPotnFigureInquiryListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Portion Adjustment by RHQ 내 Figure Inquiry팝업을 조회한다.
	  * 
	  ...
	  * 20160615 김용습 SELCMI 예외처리 로직 추가
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("      ,SUBSTR(Q.HUL_BND_CD,0,1) || '/' || SUBSTR(Q.HUL_BND_CD, -1) AS HUL_BND_CD" ).append("\n"); 
		...
		query.append("                                  ,ROUND(RHQ_QTY - RHQ_LOD_SUM) AS DIFF" ).append("\n"); 
		...
		query.append("                      AND C.SQM_CNG_TP_CD   <> 'I')" ).append("\n"); 
