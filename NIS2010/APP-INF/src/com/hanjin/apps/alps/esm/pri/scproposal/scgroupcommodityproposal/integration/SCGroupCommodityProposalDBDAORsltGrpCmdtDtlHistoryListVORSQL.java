...
*@FileName : SCGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Commodity Group Detail History 정보 조회
	  * 2012.02.23 이석준[CHM-201216153-01] S/C Amendment History 화면 기능 개선 요청
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
