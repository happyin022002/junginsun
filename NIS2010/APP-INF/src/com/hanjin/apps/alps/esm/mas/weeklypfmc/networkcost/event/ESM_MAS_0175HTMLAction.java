...
*@FileName : ESM_MAS_0175HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_MAS_0175HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_MAS_0175HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0175Event event = new EsmMas0175Event();  
