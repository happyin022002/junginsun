...
*@FileName : RsltIhcChgListVO.java
*@FileTitle : RsltIhcChgListVO
*Open Issues :
*Change history :
...
public class RsltIhcChgListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltIhcChgListVO> models = new ArrayList<RsltIhcChgListVO>();
	 ...
	 * @param request
	 * @return RsltIhcChgListVO[]
	 */
	public RsltIhcChgListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltIhcChgListVO[]
	 */
	public RsltIhcChgListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltIhcChgListVO model = null;
	...
	public RsltIhcChgListVO[] getRsltIhcChgListVOs(){
		RsltIhcChgListVO[] vos = (RsltIhcChgListVO[])models.toArray(new RsltIhcChgListVO[models.size()]);
		return vos;
	}
