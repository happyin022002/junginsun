 ...
 *@FileName : ESM_PRI_7034HTMLAction.java
 ...
 * @see EsmPri7034Event 참조
 * @since J2EE 1.6
 */
public class ESM_PRI_7034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_7034HTMLAction 객체를 생성
	 */
	public ESM_PRI_7034HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7034Event event = new EsmPri7034Event();
		
		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchUsTariffInquiryListVO((SearchUsTariffInquiryListVO) getVO(request, SearchUsTariffInquiryListVO.class));
		}
		return event;
	}
