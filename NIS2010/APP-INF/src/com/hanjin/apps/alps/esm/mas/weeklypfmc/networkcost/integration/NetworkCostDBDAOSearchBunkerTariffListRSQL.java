...
public class NetworkCostDBDAOSearchBunkerTariffListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,D1.FOIL_AVG_CSM" ).append("\n"); 
		query.append("      ,D2.VSL_INFO" ).append("\n"); 
		query.append("  FROM MAS_BNK_TRF D1 " ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		...
		query.append("								,SUBSTR(A3.HUL_BND_CD,1,1)||'/'||SUBSTR(A3.HUL_BND_CD,-1) AS HUL_BND_CD" ).append("\n"); 
