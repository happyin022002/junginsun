...
public class BangladeshManifestListDownloadDBDAOsearchManifestObBlListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       REPLACE(SUBSTR(REPLACE(REPLACE(TRANSLATE(NVL(S.CUST_NM, ' '), CHR(13)||CHR(10), ' '), '', ' '), CHR(9), ' '), 1, 150)||SUBSTR(REPLACE(REPLACE(TRANSLATE(NVL(S.CUST_ADDR, ' '), CHR(13)||CHR(10), ' '), '', ' '), CHR(9), ''), 1, 100),' ',' ') SHIPPER_NM," ).append("\n"); 
		query.append("       REPLACE(SUBSTR(REPLACE(REPLACE(TRANSLATE(NVL(C.CUST_NM, ' '), CHR(13)||CHR(10), ' '), '', ' '), CHR(9), ' '), 1, 150)||SUBSTR(REPLACE(REPLACE(TRANSLATE(NVL(C.CUST_ADDR, ' '), CHR(13)||CHR(10), ' '), '', ' '), CHR(9), ''), 1, 100),' ',' ') CNEE_NM,       " ).append("\n"); 
