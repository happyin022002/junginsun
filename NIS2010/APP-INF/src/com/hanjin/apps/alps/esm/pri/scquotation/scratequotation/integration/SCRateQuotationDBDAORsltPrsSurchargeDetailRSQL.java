...
*@FileName : SCRateQuotationDBDAORsltPrsSurchargeDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPrsSurchargeDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPrsSurchargeDetailRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPrsSurchargeDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 	PRI_SCG.QTTN_NO, PRI_SCG.QTTN_VER_NO, PRI_SCG.GEN_SPCL_RT_TP_CD," ).append("\n"); 
		...
		query.append("FROM PRI_SQ_RT_SCG PRI_SCG" ).append("\n"); 
