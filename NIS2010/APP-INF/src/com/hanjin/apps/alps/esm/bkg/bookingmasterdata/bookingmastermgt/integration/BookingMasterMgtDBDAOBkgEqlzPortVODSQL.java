...
*@FileName : BookingMasterMgtDBDAOBkgEqlzPortVODSQL.java
...
public class BookingMasterMgtDBDAOBkgEqlzPortVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingMasterMgtDBDAOBkgEqlzPortVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_EQLZ_PORT" ).append("\n"); 
		...
		query.append("FileName : BookingMasterMgtDBDAOBkgEqlzPortVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}