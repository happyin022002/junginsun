...
*@FileName : SCGOHChargeProposalDBDAOPriSpScpGohChgAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGOHChargeProposalDBDAOPriSpScpGohChgAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCGOHChargeProposalDBDAOPriSpScpGohChgAmdVO
	  * </pre>
	  */
	public SCGOHChargeProposalDBDAOPriSpScpGohChgAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGOHChargeProposalDBDAOPriSpScpGohChgAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_SP_SCP_GOH_CHG" ).append("\n"); 
