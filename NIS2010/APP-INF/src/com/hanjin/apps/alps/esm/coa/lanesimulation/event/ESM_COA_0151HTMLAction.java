...
*@FileName       : ESM_COA_151HTMLAction.java
 ...
 *
 * @author eunju park
 * @see EsmCoa0151Event  참조
 * @since J2EE 1.6
 */
public class ESM_COA_0151HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_COA_0151HTMLAction 객체를 생성
     */
    public ESM_COA_0151HTMLAction() {
    	//
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_COA_151Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0151Event event = new EsmCoa0151Event();
 	    if(command.isCommand(FormCommand.SEARCHLIST01)) {
 	    	event.setCoaBnkCsmVO((CoaBnkCsmVO)getVO(request, CoaBnkCsmVO .class));
  	    } else if(command.isCommand(FormCommand.MULTI01)) {
  	    	event.setCoaBnkCsmVOS((CoaBnkCsmVO[])getVOs(request, CoaBnkCsmVO .class));
  	    }else{
