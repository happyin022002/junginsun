...
*@FileName : ESM_MAS_0118HTMLAction.java
...
public class ESM_MAS_0118HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0118HTMLAction 객체를 생성
	 */
	public ESM_MAS_0118HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0118Event event = new EsmMas0118Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMasInterOwnTmlCostVOS((MasInterOwnTmlCostVO[])getVOs(request, MasInterOwnTmlCostVO .class,""));
