...
*@FileName : RFARateQuotationDBDAOPriRqRtGlineMappingCostDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtGlineMappingCostDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtGlineMappingCostDetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtGlineMappingCostDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                       ,PRI_RQ_RT        RATE" ).append("\n"); 
		query.append("                       ,PRI_RQ_RT_USD_ROUT_CS  ROUT" ).append("\n"); 
		query.append("                       ,PRI_PRS_USD_ROUT_CS_INFO   ROUT_INFO " ).append("\n"); 
		query.append("                       ,PRI_CMPB_GLINE_MAPG  MAPG" ).append("\n"); 
		query.append("                       ,(SELECT DISTINCT A.QTTN_NO, A.QTTN_VER_NO, A.CMDT_HDR_SEQ, A.CMDT_SEQ, " ).append("\n"); 
		...
		query.append("                		        LEFT OUTER JOIN  PRI_RQ_GRP_CMDT B" ).append("\n"); 
		...
		query.append("                        		       )" ).append("\n"); 
		query.append("                		        LEFT OUTER JOIN PRI_RQ_GRP_CMDT_DTL C" ).append("\n"); 
		...
		query.append("                   " ).append("\n"); 
		query.append("                   AND  MN.PRC_CUST_TP_CD = DECODE(MAPG.PRS_CUST_TP_CD, 'M', MN.PRC_CUST_TP_CD, MAPG.PRS_CUST_TP_CD)" ).append("\n"); 
		...
		query.append("                   AND  MAPG.MQC_RNG_FM_QTY <= NVL(MN.ESTM_MQC_QTY, 0)" ).append("\n"); 
		query.append("                   AND  MAPG.MQC_RNG_TO_QTY >= NVL(MN.ESTM_MQC_QTY, 0)" ).append("\n"); 
