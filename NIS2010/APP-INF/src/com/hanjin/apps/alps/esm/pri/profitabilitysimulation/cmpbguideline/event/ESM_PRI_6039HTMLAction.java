...
public class ESM_PRI_6039HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6039HTMLAction 객체를 생성
	 */
	public ESM_PRI_6039HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6039Event event = new EsmPri6039Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPriCmpbGlineBseVO((PriCmpbGlineBseVO)getVO(request, PriCmpbGlineBseVO .class));
		}
