...
*@FileName : SearchSpaceAllocationManage045VVDListVO.java
*@FileTitle : SearchSpaceAllocationManage045VVDListVO
*Open Issues :
*Change history :
...
public class SearchSpaceAllocationManage045VVDListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSpaceAllocationManage045VVDListVO> models = new ArrayList<SearchSpaceAllocationManage045VVDListVO>();
	...
	public SearchSpaceAllocationManage045VVDListVO() {}

	public SearchSpaceAllocationManage045VVDListVO(String ibflag, String pagerows, String costYrwk, String vvd, String relVvd, String t) {
		this.vvd = vvd;
		this.ibflag = ibflag;
		this.t = t;
		this.relVvd = relVvd;
	 ...
	 */
	public SearchSpaceAllocationManage045VVDListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSpaceAllocationManage045VVDListVO[]
	 */
	public SearchSpaceAllocationManage045VVDListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSpaceAllocationManage045VVDListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSpaceAllocationManage045VVDListVO();
				if (vvd[i] != null)
					model.setVvd(vvd[i]);
				if (ibflag[i] != null)
		...
		return getSearchSpaceAllocationManage045VVDListVOs();
	}
	...
	public SearchSpaceAllocationManage045VVDListVO[] getSearchSpaceAllocationManage045VVDListVOs(){
		SearchSpaceAllocationManage045VVDListVO[] vos = (SearchSpaceAllocationManage045VVDListVO[])models.toArray(new SearchSpaceAllocationManage045VVDListVO[models.size()]);
		return vos;
	}
