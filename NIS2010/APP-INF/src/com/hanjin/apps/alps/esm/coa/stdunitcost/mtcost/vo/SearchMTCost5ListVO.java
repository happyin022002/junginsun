...
*@FileName : SearchMTCost5ListVO.java
*@FileTitle : SearchMTCost5ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost5ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost5ListVO> models = new ArrayList<SearchMTCost5ListVO>();
	...
	public SearchMTCost5ListVO() {}

	public SearchMTCost5ListVO(String ibflag, String pagerows, String costYrmon, String fcntrEccCd, String cntrTpszCd, String eqStatus, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty) {
...
/**
	 ...
	 */
	public SearchMTCost5ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost5ListVO[]
	 */
	public SearchMTCost5ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost5ListVO model = null;
		...
		return getSearchMTCost5ListVOs();
	}
	 ...
	 * @return SearchMTCost5ListVO[]
	 */
	public SearchMTCost5ListVO[] getSearchMTCost5ListVOs(){
		SearchMTCost5ListVO[] vos = (SearchMTCost5ListVO[])models.toArray(new SearchMTCost5ListVO[models.size()]);
		return vos;
	}
