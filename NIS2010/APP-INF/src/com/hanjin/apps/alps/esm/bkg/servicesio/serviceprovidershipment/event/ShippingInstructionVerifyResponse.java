...
*@FileName : ShippingInstructionVerifyReponse.java
...
/**
 * ShippingInstructionVerifyResponse에 대한 PDTO(Data Transfer Object including Parameters)<br>
 *
 * @author SEO MI JIN
 * @see SppBkg0001Event 참조
 * @since J2EE 1.4
 */
public class ShippingInstructionVerifyResponse {
	
	private String id			= "ShippingInstructionVerifyReponse";
