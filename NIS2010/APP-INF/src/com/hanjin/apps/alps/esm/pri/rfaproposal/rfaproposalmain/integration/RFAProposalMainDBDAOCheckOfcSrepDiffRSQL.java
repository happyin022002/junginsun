...
*@FileName : RFAProposalMainDBDAOCheckOfcSrepDiffRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOCheckOfcSrepDiffRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * * 2011.04.08 김민아 [CHM-201110030-01] Request Office 또는 Sales Rep 정보의 변경 유무를 체크한다.
	  * </pre>
	  */
	public RFAProposalMainDBDAOCheckOfcSrepDiffRSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOCheckOfcSrepDiffRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND (PROP_OFC_CD <> @[prop_ofc_cd]" ).append("\n"); 
		query.append("    OR  PROP_SREP_CD <> @[prop_srep_cd])" ).append("\n"); 
