...
* 2009.06.10 이병규
* 1.0 Creation
* 1.1 2011.05.03 이재위 [CHM-201108912] [Booking] AWK 화물의 weight Check 로직 생성 요청
=========================================================*/
...
public class ESM_BKG_0055HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        if(command.isCommand(FormCommand.DEFAULT)) {
			...
			BkgAwkCgoVO vo = (BkgAwkCgoVO)getVO(request, BkgAwkCgoVO.class );
			
			event.setBkgAwkCgoVO(vo);
