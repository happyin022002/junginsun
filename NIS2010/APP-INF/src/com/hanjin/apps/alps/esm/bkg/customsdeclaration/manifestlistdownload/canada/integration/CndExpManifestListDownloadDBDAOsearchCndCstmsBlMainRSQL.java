...
*@FileName : CndExpManifestListDownloadDBDAOsearchCndCstmsBlMainRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchCndCstmsBlMainRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchCndCstmsBlMainRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchCndCstmsBlMainRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,'918P'||A.BL_NO AS CCN_NO" ).append("\n"); 
		...
		query.append("       ,BKG_CSTMS_AMER_BL HBL" ).append("\n"); 
