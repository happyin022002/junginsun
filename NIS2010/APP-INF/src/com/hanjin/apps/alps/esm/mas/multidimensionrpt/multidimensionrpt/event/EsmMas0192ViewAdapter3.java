 ...
 * @since J2EE 1.6
 */
public class EsmMas0192ViewAdapter3 extends DefaultViewAdapter {
	
    public EsmMas0192ViewAdapter3(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0192ViewAdapter3 ########### [START]");
    	...
    	try{	
			...
			if (rowSet != null) {
				...
				while (rowSet[1].next()) {
					...
					strBuilder.append("\n<TD>").append(JSPUtil.getNull(rowSet[1].getString("skd_dir_cd"))).append("</TD>");
		...
		log.debug("########### EsmMas0192ViewAdapter3 ########### [END]");        
