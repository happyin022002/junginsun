...
*@FileName : Kor24ManifestListDBDAOremoveVvdInfoKorDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOremoveVvdInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Manifest Main VVD 삭제
	  * </pre>
	  */
	public Kor24ManifestListDBDAOremoveVvdInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOremoveVvdInfoKorDSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("AND OB_DECL_TP_CD = @[in_type]" ).append("\n");
