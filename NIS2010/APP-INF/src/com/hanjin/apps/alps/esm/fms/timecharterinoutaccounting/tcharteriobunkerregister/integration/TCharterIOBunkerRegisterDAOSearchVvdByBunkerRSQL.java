...
public class TCharterIOBunkerRegisterDAOSearchVvdByBunkerRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT VSL_CD || SKD_VOY_NO || SKD_DIR_CD || REV_DIR_CD VVD" ).append("\n"); 
		query.append("FROM FMS_VVD" ).append("\n"); 
		query.append("WHERE VSL_CD = @[vsl_cd]" ).append("\n"); 
		query.append("AND @[bunker_dt] BETWEEN VST_DT AND VED_DT" ).append("\n"); 

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.nis2010.esm.fms.timecharterinoutaccounting.tcharteriobunkerregister.integration").append("\n"); 
