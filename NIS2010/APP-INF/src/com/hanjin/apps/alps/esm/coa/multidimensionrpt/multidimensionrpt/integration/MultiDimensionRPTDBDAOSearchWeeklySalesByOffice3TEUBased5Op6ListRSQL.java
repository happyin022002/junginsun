...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op6ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op6ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op6ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op6ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		 || $key == '54400000' || $key == '54600000' || $key == 'OPCOST00' || $key == 'BOPTOTAL' || $key == 'OPUTOTAL' || $key == 'NTCOALOC') " ).append("\n"); 
		query.append("		,DECODE(B.NO,1,SUM(DECODE(A.STND_COST_CD, '$key', NVL(A.AMT, 0), 0)), " ).append("\n"); 
		query.append("					   SUM(DECODE(A.STND_COST_CD, '$key', DECODE('$key','BOPTOTAL',NVL(A.OTR_AMT, 0) * -1 ,'OPUTOTAL',NVL(A.OTR_AMT, 0) * -1 ,NVL(A.OTR_AMT, 0)), 0))) AS COST_AMT$velocityCount" ).append("\n"); 
		...
		query.append("		, SUM (B2.N6TH_ADJ_OTR_FNL_AMT) AS OTR_AMT" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("         SELECT A1.COST_YRMON SLS_YRMON " ).append("\n"); 
		...
		query.append("		   ,16, ((INCOME_TOTAL - CM_COST) - N6TH_HJS_SLS_AMT - N6TH_CO_AMT - CMMT_COST - INTER_TS)   /* CMMT0001 */" ).append("\n"); 
		...
		query.append("			,SUM (N6TH_HJS_SLS_AMT) N6TH_HJS_SLS_AMT " ).append("\n"); 
		...
		query.append("				         ) " ).append("\n"); 
		query.append("				    ,0 " ).append("\n"); 
		query.append("				    ) AS N6TH_HJS_SLS_AMT " ).append("\n"); 
		query.append("				,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("                 -- Initial Network Cost(HJS Sales/Slot Cht-out->All Network Cost by VVD->Total)" ).append("\n"); 
		...
		query.append("                 , NVL(SUM(A2.N6TH_ADJ_OTR_FNL_AMT),0) AS OTR_AMT" ).append("\n"); 
		...
		query.append("			   SELECT A1.SLS_YRMON " ).append("\n"); 
		query.append("					, A1.TRD_CD" ).append("\n"); 
		query.append("					, A1.SUB_TRD_CD" ).append("\n"); 
		query.append("					, A1.RLANE_CD " ).append("\n"); 
		query.append("					, A1.IOC_CD" ).append("\n"); 
		...
		query.append("				#end	                " ).append("\n"); 
		query.append("						       " ).append("\n"); 
		query.append("				GROUP BY A1.SLS_YRMON, A1.TRD_CD, A1.SUB_TRD_CD, A1.RLANE_CD, A1.IOC_CD, A1.DIR_CD, L1.HUL_BND_CD " ).append("\n"); 
		query.append("		    " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("          UNION ALL" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				,0 N6TH_HJS_SLS_AMT " ).append("\n"); 
		...
		query.append("          WHERE 1 = 1 " ).append("\n"); 
		query.append("        #if(${f_chkprd} =='M')" ).append("\n"); 
		query.append("            AND A1.COST_YRMON BETWEEN @[f_year]||@[f_fm_mon]" ).append("\n"); 
		query.append("            AND @[f_year]||@[f_to_mon] " ).append("\n"); 
		query.append("        #elseif (${f_chkprd} =='W')" ).append("\n"); 
		query.append("            AND A1.COST_YRMON LIKE @[f_year]||@[f_sls_mon]||'%'" ).append("\n"); 
		query.append("            AND A1.COST_WK BETWEEN @[f_fm_wk] AND @[f_to_wk] " ).append("\n"); 
		query.append("        #end " ).append("\n"); 
		...
		query.append("WHERE (A.RLANE_CD, B.NO) NOT IN (" ).append("\n"); 
		query.append("                SELECT 'CNTMR',2 FROM DUAL UNION ALL" ).append("\n"); 
		query.append("                SELECT 'CDMCO',2 FROM DUAL UNION ALL" ).append("\n"); 
		query.append("                SELECT 'CNTTS',2 FROM DUAL UNION ALL" ).append("\n"); 
		query.append("                SELECT 'CNTLY',2 FROM DUAL UNION ALL" ).append("\n"); 
		query.append("                SELECT 'CNTMR',2 FROM DUAL )  " ).append("\n"); 
