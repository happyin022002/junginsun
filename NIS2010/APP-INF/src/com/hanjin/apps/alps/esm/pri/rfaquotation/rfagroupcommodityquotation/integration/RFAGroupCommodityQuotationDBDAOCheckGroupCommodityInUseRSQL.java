...
*@FileName : RFAGroupCommodityQuotationDBDAOCheckGroupCommodityInUseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityQuotationDBDAOCheckGroupCommodityInUseRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityQuotationDBDAOCheckGroupCommodityInUseRSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityQuotationDBDAOCheckGroupCommodityInUseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
