...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtRoutEstmCostDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtCmdtRoutEstmCostDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtRoutEstmCostDetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtRoutEstmCostDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("" ).append("\n"); 
		query.append("MERGE INTO PRI_SQ_RT_CMDT_ROUT A " ).append("\n"); 
		query.append("USING (" ).append("\n"); 
		query.append("        SELECT QTTN_NO, QTTN_VER_NO, GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("        SELECT  A.QTTN_NO, A.QTTN_VER_NO, A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("		      ,ROW_NUMBER() OVER(PARTITION BY A.QTTN_NO,A.QTTN_VER_NO,A.GEN_SPCL_RT_TP_CD,A.CMDT_HDR_SEQ,A.ROUT_SEQ " ).append("\n"); 
		...
		query.append("              ,PRI_SQ_RT B" ).append("\n"); 
