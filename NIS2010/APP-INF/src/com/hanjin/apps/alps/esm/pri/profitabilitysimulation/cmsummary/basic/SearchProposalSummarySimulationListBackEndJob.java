 ...
 * @since J2EE 1.6
 */
public class SearchProposalSummarySimulationListBackEndJob extends BackEndCommandSupport{
	...
	private InPrsProposalSummarySimulationSetVO inPrsProposalSummarySimulationSetVO; 
	 ...
	 * @exception
	 */
	public void setSearchParameterVOs(InPrsProposalCmSummaryVO inPrsProposalCmSummaryVO , InPrsProposalSummarySimulationSetVO inPrsProposalSummarySimulationSetVO,SignOnUserAccount account) {
	...
	public DBRowSet doStart() throws Exception {
		...
		try {
			...
			rowSet  = dbDao.searchProposalSummarySimulationList(inPrsProposalCmSummaryVO,inPrsProposalSummarySimulationSetVO );
