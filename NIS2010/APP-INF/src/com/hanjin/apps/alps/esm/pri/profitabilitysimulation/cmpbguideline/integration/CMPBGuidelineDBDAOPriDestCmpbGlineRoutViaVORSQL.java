...
*@FileName : CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVORSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE	A.GLINE_SEQ = @[gline_seq]" ).append("\n"); 
