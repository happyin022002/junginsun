...
*@FileName : SCRateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/** qttn_no,qttn_ver_no,rate_type,cost_tp,rout_pnt,trans_mode */" ).append("\n"); 
		query.append("" ).append("\n"); 
