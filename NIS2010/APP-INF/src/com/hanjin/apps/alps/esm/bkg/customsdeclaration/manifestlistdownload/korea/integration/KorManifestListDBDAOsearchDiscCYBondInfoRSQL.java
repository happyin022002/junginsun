...
public class KorManifestListDBDAOsearchDiscCYBondInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           SEQ.CSTMS_CRR_IN_LOC_WH_CD," ).append("\n"); 
		query.append("           (SELECT NVL(LOC_NM,' ') LOC_NM" ).append("\n"); 
		query.append("            FROM BKG_DCHG_LOC" ).append("\n"); 
		query.append("            WHERE OTR_DCHG_CD = SEQ.CSTMS_CRR_IN_LOC_WH_CD" ).append("\n"); 
		query.append("            AND SKD_DIR_CD = SEQ.SKD_DIR_CD " ).append("\n"); 
		query.append("            AND ROWNUM = 1) CSTMS_CRR_IN_LOC_WH_NM," ).append("\n"); 
