...
*@FileName : TAAProposalDBDAOPriTaaHdrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TAAProposalDBDAOPriTaaHdrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TAAProposalDBDAOPriTaaHdrCSQL(){
		setQuery();
		...
		query.append("FileName : TAAProposalDBDAOPriTaaHdrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TAA_HDR (" ).append("\n"); 
