...
*@FileName : RFARateQuotationDBDAOPriRqRtScgCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtScgCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtScgCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtScgCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM  PRI_RQ_RT_SCG" ).append("\n"); 
		...
		query.append("AND  ADJ_FLG = 'N'" ).append("\n"); 
