...
*@FileName : CargoReleaseOrderDBDAOAddKorDoAttorneyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOAddKorDoAttorneyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOAddKorDoAttorneyCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOAddKorDoAttorneyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_DO_ATTY_DTL (" ).append("\n"); 
		query.append("FM_ATTY_BIZ_NO" ).append("\n"); 
		query.append(",	TO_ATTY_BIZ_NO" ).append("\n"); 
