...
*@FileTitle : <Kor24CusrepVO.java
*@FileTitle : Kor24CusrepVO
*Open Issues :
*Change history :
...
public class Kor24CusrepVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CusrepVO> models = new ArrayList<Kor24CusrepVO>();
	 ...
	 * @param request
	 * @return Kor24CusrepVO[]
	 */
	public Kor24CusrepVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24CusrepVO[]
	 */
	public Kor24CusrepVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CusrepVO model = null;
	 ...
	 * @return Kor24CusrepVO[]
	 */
	public Kor24CusrepVO[] getKor24CusrepVOs(){
		Kor24CusrepVO[] vos = (Kor24CusrepVO[])models.toArray(new Kor24CusrepVO[models.size()]);
		return vos;
	}
