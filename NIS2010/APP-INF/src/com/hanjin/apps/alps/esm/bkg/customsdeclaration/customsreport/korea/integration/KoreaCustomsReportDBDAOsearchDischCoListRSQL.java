...
*@FileName : KoreaCustomsReportDBDAOsearchDischCoListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchDischCoListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 한국 세관에 적하 목록 전송시 Discharging Company 조회
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchDischCoListRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchDischCoListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
