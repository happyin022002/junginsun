...
*@FileName : ConstraintMasterDBDAOCustomerControlGroupRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintMasterDBDAOCustomerControlGroupRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VO용
	  * ConstraintMasterDBDAOCustomerControlGroupRSQL - 패키지 이동으로 신규 생성
	  * </pre>
	  */
	public ConstraintMasterDBDAOCustomerControlGroupRSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintMasterDBDAOCustomerControlGroupRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
