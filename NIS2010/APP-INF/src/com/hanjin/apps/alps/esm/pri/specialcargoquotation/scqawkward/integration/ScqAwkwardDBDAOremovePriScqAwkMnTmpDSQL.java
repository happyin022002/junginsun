...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkMnTmpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkMnTmpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_MN_TMP 테이블 삭제
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkMnTmpDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkMnTmpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  PRI_SCQ_AWK_MN_TMP" ).append("\n"); 
