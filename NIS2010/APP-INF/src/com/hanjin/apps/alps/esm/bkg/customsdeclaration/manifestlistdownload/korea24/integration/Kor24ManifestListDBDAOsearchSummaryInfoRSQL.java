...
*@FileName : Kor24ManifestListDBDAOsearchSummaryInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchSummaryInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchSummaryInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchSummaryInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
