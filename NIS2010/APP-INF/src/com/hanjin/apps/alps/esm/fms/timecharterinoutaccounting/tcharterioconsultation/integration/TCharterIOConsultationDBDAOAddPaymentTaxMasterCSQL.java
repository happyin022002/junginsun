...
*@FileName : TCharterIOConsultationDBDAOAddPaymentTaxMasterCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOAddPaymentTaxMasterCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOConsultationDBDAOAddPaymentTaxMasterCSQL
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOAddPaymentTaxMasterCSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOAddPaymentTaxMasterCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO FMS_TAX(" ).append("\n"); 
		...
		query.append("	@[tax_inv_yrmon]," ).append("\n"); 
		query.append("	@[ofc_cd]," ).append("\n"); 
		query.append("    (SELECT LPAD(TO_NUMBER(NVL(MAX(TAX_SER_NO),0)) + 1,5,'0')" ).append("\n"); 
