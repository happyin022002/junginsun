...
public class CLLCDLManifestDBDAOsearchVslSkdRSQL implements ISQLTemplate{
	...
	public CLLCDLManifestDBDAOsearchVslSkdRSQL(){
		...
		params.put("in_split_no",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("#if (${in_split_no} != '')" ).append("\n"); 
		query.append("AND VPS.CLPT_IND_SEQ = @[in_split_no]  -- Add. 2015.02.09.  CHM-201533845" ).append("\n"); 
