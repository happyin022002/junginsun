...
*@FileName : RsltPriPrsUsdRoutCsInfoSimulationVO.java
*@FileTitle : RsltPriPrsUsdRoutCsInfoSimulationVO
*Open Issues :
*Change history :
...
public class RsltPriPrsUsdRoutCsInfoSimulationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriPrsUsdRoutCsInfoSimulationVO> models = new ArrayList<RsltPriPrsUsdRoutCsInfoSimulationVO>();
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setProdRev(JSPUtil.getParameter(request, prefix + "prod_rev", ""));
		...
		setParaRoutNo(JSPUtil.getParameter(request, prefix + "para_rout_no", ""));
		...
		setSlsHoCd(JSPUtil.getParameter(request, prefix + "sls_ho_cd", ""));
		...
		setCopCreFlg(JSPUtil.getParameter(request, prefix + "cop_cre_flg", ""));
		...
		setBkgSelFlg(JSPUtil.getParameter(request, prefix + "bkg_sel_flg", ""));
	 ...
	 * @param request
	 * @return RsltPriPrsUsdRoutCsInfoSimulationVO[]
	 */
	public RsltPriPrsUsdRoutCsInfoSimulationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriPrsUsdRoutCsInfoSimulationVO[]
	 */
	public RsltPriPrsUsdRoutCsInfoSimulationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriPrsUsdRoutCsInfoSimulationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriPrsUsdRoutCsInfoSimulationVO();
		...
		return getRsltPriPrsUsdRoutCsInfoSimulationVOs();
	}
	 ...
	 * @return RsltPriPrsUsdRoutCsInfoSimulationVO[]
	 */
	public RsltPriPrsUsdRoutCsInfoSimulationVO[] getRsltPriPrsUsdRoutCsInfoSimulationVOs(){
		RsltPriPrsUsdRoutCsInfoSimulationVO[] vos = (RsltPriPrsUsdRoutCsInfoSimulationVO[])models.toArray(new RsltPriPrsUsdRoutCsInfoSimulationVO[models.size()]);
		return vos;
	}
