...
*@FileName : ESM_MAS_0185HTMLAction.java
*@FileTitle : Port Tariff Detail Inquiry
*Open Issues :
*Change history :
...
public class ESM_MAS_0185HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0185HTMLAction 객체를 생성
	 */
	public ESM_MAS_0185HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0185Event event = new EsmMas0185Event();  
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			...
			event.setSearchPortTariffWeekListVO((SearchPortTariffWeekListVO)getVO(request, SearchPortTariffWeekListVO.class));	
		}	
		else if(command.isCommand(FormCommand.MULTI01)) {			
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO.class));
			event.setSearchPortTariffWeekListVOs((SearchPortTariffWeekListVO[])getVOs(request, SearchPortTariffWeekListVO.class));
		}	
