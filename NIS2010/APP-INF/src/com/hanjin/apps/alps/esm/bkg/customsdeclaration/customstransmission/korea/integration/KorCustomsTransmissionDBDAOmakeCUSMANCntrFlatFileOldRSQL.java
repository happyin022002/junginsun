...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSMANCntrFlatFileOldRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSMANCntrFlatFileOldRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSMANCntrFlatFileOldRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSMANCntrFlatFileOldRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
