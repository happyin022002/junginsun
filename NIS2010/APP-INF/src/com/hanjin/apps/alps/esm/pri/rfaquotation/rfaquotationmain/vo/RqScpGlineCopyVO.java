...
public class RqScpGlineCopyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RqScpGlineCopyVO> models = new ArrayList<RqScpGlineCopyVO>();
	 ...
	 */
	public RqScpGlineCopyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpScpGlineCopyVO[]
	 */
	public RqScpGlineCopyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RqScpGlineCopyVO model = null;
	 ...
	 * @return SpScpGlineCopyVO[]
	 */
	public RqScpGlineCopyVO[] getSpScpGlineCopyVOs(){
		RqScpGlineCopyVO[] vos = (RqScpGlineCopyVO[])models.toArray(new RqScpGlineCopyVO[models.size()]);
		return vos;
	}
