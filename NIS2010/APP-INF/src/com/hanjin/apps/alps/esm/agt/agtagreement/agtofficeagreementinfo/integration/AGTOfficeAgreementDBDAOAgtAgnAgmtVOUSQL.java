...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Table agt_agn_agmt update
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtVOUSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AGT_AGN_AGMT" ).append("\n"); 
		query.append("SET	FM_EFF_DT = @[fm_eff_dt]," ).append("\n"); 
		query.append("TO_EFF_DT = @[to_eff_dt]," ).append("\n"); 
		query.append("XCH_RT_DIV_LVL = @[xch_rt_div_lvl]," ).append("\n"); 
		query.append("OFC_CHR_LVL = @[ofc_chr_lvl]," ).append("\n"); 
