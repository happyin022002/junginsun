...
*@FileName : CostAssignDBDAOMultiMasBkgComIfHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostAssignDBDAOMultiMasBkgComIfHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostAssignDBDAOMultiMasBkgComIfHisCSQL(){
		setQuery();
		...
		query.append("FileName : CostAssignDBDAOMultiMasBkgComIfHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_BKG_COM_IF_HIS C1" ).append("\n"); 
