...
public class UsaInbondTransmissionDBDAOsearchH01ForCntrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT	RPAD('H01'||@[flag2]||RPAD(@[cntr_no],14,' ')||RPAD(to_char(to_date(replace(replace(@[arr_dt],'-',''),'/',''),'yyyymmdd'),'rrmmdd'),6,' ')||RPAD(LOC_AMS_PORT_CD,4,' ')||'SMLM',80,' ')||CHR(10)||" ).append("\n"); 
		query.append("	RPAD('H02'||'BM'||'SMLM'||NVL(@[bl_no],' '),80,' ')||CHR(10)" ).append("\n"); 
