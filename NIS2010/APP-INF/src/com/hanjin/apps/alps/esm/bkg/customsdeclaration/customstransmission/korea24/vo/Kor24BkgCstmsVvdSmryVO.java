...
public class Kor24BkgCstmsVvdSmryVO extends TransmitCondVO {

private static final long serialVersionUID = 1L;

	private Collection<Kor24BkgCstmsVvdSmryVO> models = new ArrayList<Kor24BkgCstmsVvdSmryVO>();
	 ...
	 */
	public Kor24BkgCstmsVvdSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrVvdSmryVO[]
	 */
	public Kor24BkgCstmsVvdSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BkgCstmsVvdSmryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24BkgCstmsVvdSmryVO();
				if (inVvd[i] != null)
	 ...
	 * @return BkgCstmsKrVvdSmryVO[]
	 */
	public Kor24BkgCstmsVvdSmryVO[] getBkgCstmsKrVvdSmryVOs(){
		Kor24BkgCstmsVvdSmryVO[] vos = (Kor24BkgCstmsVvdSmryVO[])models.toArray(new Kor24BkgCstmsVvdSmryVO[models.size()]);
		return vos;
	}
