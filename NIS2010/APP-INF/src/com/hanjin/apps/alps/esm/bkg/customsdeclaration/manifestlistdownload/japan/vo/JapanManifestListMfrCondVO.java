...
*@FileName : JapanManifestListMfrCustInfoVO.java
*@FileTitle : JapanManifestListMfrCustInfoVO
*Open Issues :
*Change history :
*	2017.09.07 from Request 수정
 ...
 */
public class JapanManifestListMfrCondVO extends ManifestListCondVO {

    private static final long serialVersionUID = 1L;

    private Collection<JapanManifestListMfrCondVO> models = new ArrayList<JapanManifestListMfrCondVO>();
    ...
    public JapanManifestListMfrCondVO() {
    }

    public JapanManifestListMfrCondVO(String ibflag, String pagerows, String blNumber, String vvdCd, String clptIndSeq, String custCntCd, String custSeq, String custNm, String custAddr, String phnNo, String faxNo, String custCntCd2, String custSeq2, String custNm2, String custAddr2, String phnNo2, String faxNo2, String custCntCd3, String custSeq3, String custNm3, String custAddr3, String phnNo3, String faxNo3, String podCd) {
	 ...
	 */
    public JapanManifestListMfrCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanManifestListMfrCustInfoVO[]
	 */
    public JapanManifestListMfrCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        JapanManifestListMfrCondVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new JapanManifestListMfrCondVO();
                if (custSeq2[i] != null)
	 ...
	 * @return JapanManifestListMfrCustInfoVO[]
	 */
    public JapanManifestListMfrCondVO[] getJapanManifestListMfrCustInfoVOs() {
        JapanManifestListMfrCondVO[] vos = (JapanManifestListMfrCondVO[]) models.toArray(new JapanManifestListMfrCondVO[models.size()]);
        return vos;
    }
