...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailHisListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyDetailHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgmtCopyDetailHisList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyDetailHisListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailHisListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_DTL_HIS" ).append("\n"); 
		...
		query.append("       '' AS CRE_GDT," ).append("\n"); 
