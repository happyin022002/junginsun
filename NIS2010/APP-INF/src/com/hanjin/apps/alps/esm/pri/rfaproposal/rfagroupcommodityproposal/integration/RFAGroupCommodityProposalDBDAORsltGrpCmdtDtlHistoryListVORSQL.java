...
*@FileName : RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * commodity code history 조회
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAORsltGrpCmdtDtlHistoryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
