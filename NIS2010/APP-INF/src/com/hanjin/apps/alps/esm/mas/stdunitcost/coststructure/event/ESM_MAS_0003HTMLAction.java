...
*@FileName : ESM_MAS_0003HTMLAction.java
...
public class ESM_MAS_0003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0003HTMLAction 객체를 생성
	 */
	public ESM_MAS_0003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0003Event event = new EsmMas0003Event();
