...
public class FACCommCalculationDBDAOSearchFACAGMTRateInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                        CASE CHG_CD" ).append("\n"); 
		query.append("                        WHEN 'SMC' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'TSC' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'DTS' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'TXS' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'WHC' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'CPU' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'MSC' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'OCR' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'LWS' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'HWS' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'CFC' THEN 'OFT'" ).append("\n"); 
		query.append("                        WHEN 'EMC' THEN 'OFT'" ).append("\n"); 
		query.append("                        ELSE CHG_CD" ).append("\n"); 
		query.append("                         END" ).append("\n"); 
		...
		query.append("                         AND CHG_CD" ).append("\n"); 
		query.append("                          IN" ).append("\n"); 
		query.append("                           (" ).append("\n"); 
		query.append("                             'OFT','SMC','TSC','DTS','TXS','WHC'," ).append("\n"); 
		query.append("                             'CPU','MSC','OCR','LWS','HWS','CFC','EMC'" ).append("\n"); 
		query.append("                           )" ).append("\n"); 
		query.append("                )" ).append("\n"); 
