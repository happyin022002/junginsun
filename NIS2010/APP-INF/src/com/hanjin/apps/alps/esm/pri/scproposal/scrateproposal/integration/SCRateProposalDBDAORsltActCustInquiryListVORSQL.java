...
*@FileName : SCRateProposalDBDAORsltActCustInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltActCustInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltActCustInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltActCustInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
