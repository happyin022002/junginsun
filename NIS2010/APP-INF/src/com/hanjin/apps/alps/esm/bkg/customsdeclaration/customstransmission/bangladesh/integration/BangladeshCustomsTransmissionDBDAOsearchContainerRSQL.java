...
public class BangladeshCustomsTransmissionDBDAOsearchContainerRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		'DG_IMCO:'||DECODE(BKG.DCGO_FLG, 'Y',  (SELECT BDCI.IMDG_CLSS_CD FROM BKG_DG_CGO BDCI" ).append("\n"); 
		...
		query.append("		'DG_UN_CD:'||DECODE(BKG.DCGO_FLG, 'Y', (SELECT BDCU.IMDG_UN_NO FROM BKG_DG_CGO BDCU" ).append("\n"); 
		...
		query.append("												AND    ROWNUM = 1), ' ')||CHR(10)||" ).append("\n"); 
		query.append("		'CNTR_LOC_CD:'||NVL(DECODE(BKG.DEL_CD, 'BDCGP', ' ', 'BDDAC', '102DICD', BKG.DEL_CD), ' ')||CHR(10)||" ).append("\n"); 
		query.append("		'COMMODITY_CD:'||NVL(SUBSTR(BKG.CMDT_CD, 1, 2), '')||CHR(10)||" ).append("\n"); 
		query.append("        '}CNTR_INFO'||CHR(10) cntr_desc" ).append("\n"); 
		query.append("FROM   BKG_CONTAINER CNTR, BKG_BOOKING BKG" ).append("\n"); 
