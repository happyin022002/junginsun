...
*@FileName : CargoReleaseOrderDBDAOaddCaCgoRlseHisEdiCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOaddCaCgoRlseHisEdiCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CargoReleaseOrderDBDAOaddCaCgoRlseHisEdi
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOaddCaCgoRlseHisEdiCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOaddCaCgoRlseHisEdiCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',SYSDATE,'CATOR')," ).append("\n"); 
