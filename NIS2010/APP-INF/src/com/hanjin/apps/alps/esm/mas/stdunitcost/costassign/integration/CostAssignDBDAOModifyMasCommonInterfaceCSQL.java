...
*@FileName : CostAssignDBDAOModifyMasCommonInterfaceCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostAssignDBDAOModifyMasCommonInterfaceCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *    MAS_BKG_COM_IF테이블에 데이터를 INSERT/UPDATE
	  * </pre>
	  */
	public CostAssignDBDAOModifyMasCommonInterfaceCSQL(){
		setQuery();
		...
		query.append("FileName : CostAssignDBDAOModifyMasCommonInterfaceCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_BKG_COM_IF A1" ).append("\n"); 
