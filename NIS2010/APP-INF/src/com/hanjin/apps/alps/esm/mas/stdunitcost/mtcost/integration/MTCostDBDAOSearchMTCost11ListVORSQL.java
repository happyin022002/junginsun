...
*@FileName : MTCostDBDAOSearchMTCost11ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCost11ListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCost11ListVORSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCost11ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
