...
*@FileName : CargoReleaseOrderDBDAOaddEdiSndLogByJapDorEvntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOaddEdiSndLogByJapDorEvntCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Japan Cargo Release 화면 DOR I/F시에 로그인(Event)User& Office로 저장
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOaddEdiSndLogByJapDorEvntCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOaddEdiSndLogByJapDorEvntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[msg_tp_nm]" ).append("\n"); 
		query.append(",@[msg_tp_id]" ).append("\n"); 
		query.append(",BDTL.EVNT_USR_ID         --edi_evnt_usr_id]" ).append("\n"); 
		query.append(",BDTL.EVNT_OFC_CD         --edi_evnt_ofc_cd]" ).append("\n"); 
		query.append(",GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(BDTL.EVNT_OFC_CD)      --edi_evnt_ofc_cd])" ).append("\n"); 
		...
		query.append(", BKG_DO_DTL BDTL" ).append("\n"); 
		...
		query.append("AND   BDTL.BKG_NO          = DOR.BKG_NO" ).append("\n"); 
		query.append("AND   BDTL.RLSE_SEQ        = DOR.RLSE_SEQ" ).append("\n"); 
		query.append("AND   BDTL.RLSE_STS_CD     = 'D'" ).append("\n"); 
