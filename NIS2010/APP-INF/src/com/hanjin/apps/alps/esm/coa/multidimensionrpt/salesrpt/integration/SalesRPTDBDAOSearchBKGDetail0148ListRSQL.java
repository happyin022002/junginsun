...
public class SalesRPTDBDAOSearchBKGDetail0148ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,(BKG_REV+MISC_REV-CM_COST)         AS CM       -- REV(BKG_REV+BKG_OFT_REV+BKG_MISC_REV+SCR_CHG_REV)-CM_COST" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST-CM2_COST) AS CM2" ).append("\n"); 
		query.append("      , OP_COST + DEM_DET                  AS OPC      -- OP_COST" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST-OP_COST) AS OP       -- CM-OP_COST" ).append("\n"); 
		...
		query.append("      ,(BKG_REV+MISC_REV-CM_COST)/LOAD    AS CMB      -- CM/LOAD" ).append("\n"); 
		query.append("      , OP_COST+ DEM_DET                   AS OP_COST " ).append("\n"); 
		query.append("      ,(OP_COST+ DEM_DET)/LOAD            AS OPCOST   -- OP_COST/LOAD" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST-OP_COST)/LOAD AS OPB -- OP/LOAD" ).append("\n"); 
