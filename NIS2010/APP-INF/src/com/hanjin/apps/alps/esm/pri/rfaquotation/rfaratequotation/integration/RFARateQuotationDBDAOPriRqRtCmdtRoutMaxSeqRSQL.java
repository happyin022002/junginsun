...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtRoutMaxSeqRSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtRoutMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtRoutMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtRoutMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
