...
*@FileName : ESM_BIS_0927HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.bis.blinformationmgt.blinformationmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_BIS_0927HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BIS_0927HTMLAction 객체를 생성
	 */
	public ESM_BIS_0927HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBis0927Event event = new EsmBis0927Event();
