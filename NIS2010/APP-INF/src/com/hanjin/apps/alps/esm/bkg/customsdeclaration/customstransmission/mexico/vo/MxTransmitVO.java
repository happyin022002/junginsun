...
*@FileName : MxTransmitVO.java
*@FileTitle : MxTransmitVO
*Open Issues :
*Change history :
...
public class MxTransmitVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxTransmitVO> models = new ArrayList<MxTransmitVO>();
	...
	public MxTransmitVO(String ibflag, String pagerows, String bkgNo, String polCd, String podCd, String vvd, String cntrNo, String blNo, String hisSeq, String ntcKndCd, String ediId, String bkgNtcSndRsltCd, String sndUsrId, String creUsrId, String updUsrId, String tmp1, String tmp2, String tmp3) {
	 ...
	 * @return MxTransmitVO[]
	 */
	public MxTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxTransmitVO[]
	 */
	public MxTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxTransmitVO model = null;
	 ...
	 * @return MxTransmitVO[]
	 */
	public MxTransmitVO[] getMxTransmitVOs(){
		MxTransmitVO[] vos = (MxTransmitVO[])models.toArray(new MxTransmitVO[models.size()]);
		return vos;
	}
