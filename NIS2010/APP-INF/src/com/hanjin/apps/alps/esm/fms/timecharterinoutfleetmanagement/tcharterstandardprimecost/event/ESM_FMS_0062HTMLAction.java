...
public class ESM_FMS_0062HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0062HTMLAction 객체를 생성
	 */
	public ESM_FMS_0062HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0062Event event = new EsmFms0062Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomTeuRngVOS((CustomTeuRngVO[])getVOs(request, CustomTeuRngVO .class,""));
			event.setRngYr(request.getParameter("rngYr"));
		}
