...
*@FileName : PkupCntrRtnYdVO.java
*@FileTitle : PkupCntrRtnYdVO
*Open Issues :
*Change history :
...
public class PkupCntrRtnYdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PkupCntrRtnYdVO> models = new ArrayList<PkupCntrRtnYdVO>();
	...
	/* Column Info */
	private String rtnYdSavDtS = null;
	/* Column Info */
	...
	/* Column Info */
	private String rtnYdSavDtE = null;
	/* Column Info */
	...
	public PkupCntrRtnYdVO() {}

	public PkupCntrRtnYdVO(String ibflag, String pagerows, String rtnYdSeq, String podCd, String pkupYdId, String fnlDestCd, String mcntrRtnYdCd, String rtnYdSavOfcCd, String rtnYdSavUsrId, String rtnYdSavDt, String deltFlg, String deltUsrId, String deltDt, String creUsrId, String creDt, String updUsrId, String updDt, String rtnYdSavDtS, String rtnYdSavDtE) {
		this.updDt = updDt;
		this.rtnYdSeq = rtnYdSeq;
		this.mcntrRtnYdCd = mcntrRtnYdCd;
		this.rtnYdSavDtS = rtnYdSavDtS;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rtn_yd_sav_dt_s", getRtnYdSavDtS());
		...
		this.hashColumns.put("rtn_yd_sav_dt_e", getRtnYdSavDtE());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rtn_yd_sav_dt_s", "rtnYdSavDtS");
		...
		this.hashFields.put("rtn_yd_sav_dt_e", "rtnYdSavDtE");
	 ...
	 * @return rtnYdSavDtS
	 */
	public String getRtnYdSavDtS() {
		return this.rtnYdSavDtS;
	}
	 ...
	 * @return rtnYdSavDtE
	 */
	public String getRtnYdSavDtE() {
		return this.rtnYdSavDtE;
	}
	 ...
	 * @param rtnYdSavDtS
	 */
	public void setRtnYdSavDtS(String rtnYdSavDtS) {
		this.rtnYdSavDtS = rtnYdSavDtS;
	}
	 ...
	 * @param rtnYdSavDtE
	 */
	public void setRtnYdSavDtE(String rtnYdSavDtE) {
		this.rtnYdSavDtE = rtnYdSavDtE;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRtnYdSavDtS(JSPUtil.getParameter(request, prefix + "rtn_yd_sav_dt_s", ""));
		...
		setRtnYdSavDtE(JSPUtil.getParameter(request, prefix + "rtn_yd_sav_dt_e", ""));
	 ...
	 */
	public PkupCntrRtnYdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PkupCntrRtnYdVO[]
	 */
	public PkupCntrRtnYdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PkupCntrRtnYdVO model = null;
		...
		try {
			...
			String[] rtnYdSavDtS = (JSPUtil.getParameter(request, prefix	+ "rtn_yd_sav_dt_s", length));
			...
			String[] rtnYdSavDtE = (JSPUtil.getParameter(request, prefix	+ "rtn_yd_sav_dt_e", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (rtnYdSavDtS[i] != null)
					model.setRtnYdSavDtS(rtnYdSavDtS[i]);
				if (deltFlg[i] != null)
				...
				if (rtnYdSavDtE[i] != null)
					model.setRtnYdSavDtE(rtnYdSavDtE[i]);
				if (creUsrId[i] != null)
	 ...
	 * @return PkupCntrRtnYdVO[]
	 */
	public PkupCntrRtnYdVO[] getPkupCntrRtnYdVOs(){
		PkupCntrRtnYdVO[] vos = (PkupCntrRtnYdVO[])models.toArray(new PkupCntrRtnYdVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.rtnYdSavDtS = this.rtnYdSavDtS .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.rtnYdSavDtE = this.rtnYdSavDtE .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
