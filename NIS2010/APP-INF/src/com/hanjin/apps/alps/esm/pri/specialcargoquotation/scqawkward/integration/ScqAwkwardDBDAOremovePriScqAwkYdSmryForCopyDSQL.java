...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkYdSmryForCopyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkYdSmryForCopyDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkYdSmryForCopyDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkYdSmryForCopyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PRI_SCQ_AWK_YD_SMRY      " ).append("\n"); 
