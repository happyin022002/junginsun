...
*@FileName : ESM_MAS_0080HTMLAction.java
*@FileTitle : Logistics Exp. by Lane 
*Open Issues :
*Change history :
* 2009.10.08 최인경 1.0 Creation
...
public class ESM_MAS_0080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0080HTMLAction 객체를 생성
	 */
	public ESM_MAS_0080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0080Event event = new EsmMas0080Event();
