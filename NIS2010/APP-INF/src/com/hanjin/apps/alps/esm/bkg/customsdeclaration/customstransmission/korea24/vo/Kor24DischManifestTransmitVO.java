...
*@FileTitle : <Kor24DischManifestTransmitVO.java
*@FileTitle : Kor24DischManifestTransmitVO
*Open Issues :
*Change history :
...
public class Kor24DischManifestTransmitVO extends DischManifestTransmitVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24DischManifestTransmitVO> models = new ArrayList<Kor24DischManifestTransmitVO>();
	...
	public Kor24DischManifestTransmitVO() {}
	 ...
	 */
	public Kor24DischManifestTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24DischManifestTransmitVO[]
	 */
	public Kor24DischManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24DischManifestTransmitVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24DischManifestTransmitVO();
				if (etaDt[i] != null)
		...
		return getKor24DischManifestTransmitVOs();
	}
	 ...
	 * @return Kor24DischManifestTransmitVO[]
	 */
	public Kor24DischManifestTransmitVO[] getKor24DischManifestTransmitVOs(){
		Kor24DischManifestTransmitVO[] vos = (Kor24DischManifestTransmitVO[])models.toArray(new Kor24DischManifestTransmitVO[models.size()]);
		return vos;
	}
