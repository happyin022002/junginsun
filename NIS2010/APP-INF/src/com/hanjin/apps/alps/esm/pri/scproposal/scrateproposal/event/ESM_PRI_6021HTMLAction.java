...
*@FileName : ESM_PRI_6021HTMLAction.java
...
public class ESM_PRI_6021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6021HTMLAction 객체를 생성
	 */
	public ESM_PRI_6021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6021Event event = new EsmPri6021Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			PriSpScpRtCmdtRoutSetVO vo = (PriSpScpRtCmdtRoutSetVO)getVO(request, PriSpScpRtCmdtRoutSetVO.class);
			PriSpScpRtCmdtRoutVO[] routVOs = (PriSpScpRtCmdtRoutVO[])getVOs(request, PriSpScpRtCmdtRoutVO .class,"");
			vo.setPriSpScpRtCmdtRoutVOS(routVOs);
			event.setPriSpScpRtCmdtRoutSetVO(vo);
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltPriRateCmViewAllVO((RsltPriRateCmViewAllVO)getVO(request, RsltPriRateCmViewAllVO .class));
		}
