			...
			try{
				while(rowSets.next()){
					...
					if(office.equals("")) {
						...
						week = "+";
					} else if(sub_trd_cd.equals("")) {
						sub_trd_cd = "-";
					}
					
//					System.out.println("Office/vvd/lane:["+searchOffice+"]["+searchVVD+"]["+searchLane+"]["+lvl+"]");
					...
					if((!searchOffice || lvl >= 2) && (!searchVVD || (lvl != 2 && lvl != 3)) && (!searchWeek || lvl != 3) && (!searchLane || lvl != 2)){
						...
						sbufXML.append("<td BGCOLOR=\"").append(lvl>2?color[3]:color[lvl-1]).append("\">" + sub_trd_cd + "</td>\n");
