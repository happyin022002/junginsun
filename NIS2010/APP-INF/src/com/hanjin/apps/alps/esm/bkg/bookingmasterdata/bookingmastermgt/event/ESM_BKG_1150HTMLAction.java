...
*@FileName : ESM_BKG_1150HTMLAction.java
*@FileTitle : Edit VVD
*Open Issues :
*Change history :
...
public class ESM_BKG_1150HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1150HTMLAction 객체를 생성
	 */
	public ESM_BKG_1150HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1150Event event = new EsmBkg1150Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgMapgVvdVO((BkgMapgVvdVO)getVO(request, BkgMapgVvdVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgMapgVvdVOs((BkgMapgVvdVO[])getVOs(request, BkgMapgVvdVO .class,""));
		}
