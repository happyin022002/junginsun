...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVOAddCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriCmpbGlineCustVOAddCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineCustVOAddCopyCSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVOAddCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_CMPB_GLINE_CUST (" ).append("\n"); 
