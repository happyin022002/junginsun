...
*@FileName : ESM_MAS_0149HTMLAction.java
...
public class ESM_MAS_0149HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0149HTMLAction 객체를 생성
	 */
	public ESM_MAS_0149HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0149Event event = new EsmMas0149Event();
		

		event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setRouteDetail0147VO((RouteDetail0147VO)getVO(request, RouteDetail0147VO .class));
		}
