...
import com.hanjin.apps.alps.esm.agt.agtagreement.agtofficeagreementinfo.integration.AGTOfficeAgreementInfoDBDAO;
 ...
 * 
 * @author Lee Ho Jin
 * @see EsmAgt0003EventResponse,AGTOfficeAgreementInfoBC 각 DAO 클래스 참조
 * @since J2EE 1.6
 */
public class AGTOfficeAgreementInfoBCImpl extends BasicCommandSupport implements
	...
	/**
	 * AGTOfficeAgreementInfoBCImpl 객체 생성<br>
	 * AGTOfficeAgreementInfoDBDAO를 생성한다.<br>
	 */
	...
	/**
	 * (EsmAgt0001 화면에 대한 생성 이벤트 처리<br>
	 * 
	...
	/**
	 * (EsmAgt0001 화면에 대한 삭제 이벤트 처리<br>
	 * 
	 * @param AgtAgnAgmtVO[] agtAgnAgmtVOS
	 * @param SignOnUserAccount account
	 * @exception EventException
	...
	/**
	 * (EsmAgt0001 화면에 대한 복제 이벤트 처리<br>
	 * 
	 * @param AgtAgnAgmtVO[] agtAgnAgmtVOS
	 * @param AgtAgnAgmtVO agtAgnAgmtVO
	 * @param SignOnUserAccount account
	...
	/**
	 * (ESM_AGT_0003) AgentRateInfo 의 정보를 가져온다.<br>
	 * 
	...
	/**
	 * (ESM_AGT_003) AgentRateDetailInfo 의 정보를 가져온다.<br>
	 * 
	...
	/**
	 * (ESM_AGT_003) AgentRateInfo 의 CUD 수행한다.<br>
	 * @param AgtAgnAgmtVO[] agtAgnAgmtVO
	 * @param SignOnUserAccount account
	 * @exception EventException
	 */
	...
	/**
	 * (ESM_AGT_003) Agreement 의 정보를 Copy한다.<br>
	 * @param AgtAgnAgmtVO[] agtAgnAgmtVOs
	 * @param AgtAgnAgmtVO agtAgnAgmtVO
	 * @param SignOnUserAccount account
	 * @exception EventException
...
//			List<AgtAgnAgmtVO> insertVoList = new ArrayList<AgtAgnAgmtVO>();
	...
	/**
	 * (ESM_AGT_0003) Agent Agreement Rate Creation 의 정보를 SAVE(C, U, D)한다.<br>
	...
	//					Charge 값을 agt_agn_chg_ref 테이블에 INSERT - 2
...
//						Customer 값을 agt_agn_otr_ref 테이블에 INSERT - 3
...
//						S/C NO 값을 agt_agn_otr_ref 테이블에 INSERT(sc_inp_term_cd) - 4
...
//						RFA NO 값을 agt_agn_otr_ref 테이블에 INSERT(rfa_inp_term_cd) - 5
...
//						S/C OFC 값을 agt_agn_ctrt_ref 테이블에 INSERT(sc_ofc_inp_cd) - 6
...
//						RFA OFC 값을 agt_agn_ctrt_ref 테이블에 INSERT(rfa_ofc_inp_cd) - 7
...
//						BKG OFC 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_ofc_inp_term_cd) - 8
...
//						Sales OFC 값을 agt_agn_rout_ref 테이블에 INSERT(sls_ofc_inp_term_cd) - 9
...
//						POR 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_por_inp_term_cd) - 10
...
//					 	POL 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_pol_inp_term_cd) - 11
...
//						POD 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_pod_inp_term_cd) - 12
						...
						log.info("\n 20");
						log.info("\n PODL2");
//						DEL 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_del_inp_term_cd) - 13
...
//						PPD 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_ppd_inp_term_cd) - 14
...
//						CCT 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_clt_inp_term_cd) - 15
...
//						3rd Party 값을 agt_agn_rout_ref 테이블에 INSERT(bkg_n3rd_inp_term_cd) - 16
...
//						Lane 값을 agt_agn_otr_ref 테이블에 INSERT(lane_inp_term_cd) - 17
...
//						Vessel 값을 agt_agn_otr_ref 테이블에 INSERT(vsl_inp_term_cd) - 18
...
//					agt_agn_agmt_rt 테이블에 UPDATE
					dbDao.modifymultiRowCopySaveAgtAgnAgmtRt(agtAgnAgmtRtVOS[i]);	
//					TP/SZ 값을 agt_agn_otr_ref 테이블에 INSERT - 1
					if(!agtAgnAgmtRtVOS[i].getCntrInpTermCd().equals("") || !agtAgnAgmtRtVOS[i].getCntrInpTermCd().equals("*")){
						StringTokenizer cntrInpTermCdStoken01 = new StringTokenizer(agtAgnAgmtRtVOS[i].getCntrInpTermCd(), ",");
						String hasToString = null;
						while(cntrInpTermCdStoken01.hasMoreTokens()){
...
//					agt_agn_agmt_rt 테이블의 데이터 삭제
	...
	/**
	 * ESM_AGT_0005 화면에 대한 조회 이벤트 처리<br>
	 * 
	...
	/**
	 * ESM_AGT_0006 화면에 대한 조회 이벤트 처리<br>
	 * 
	...
	/**
	 * ESM_AGT_0037 화면에 대한 agt_agn_otr_ref 조회 이벤트 처리<br>
	...
	/**
	 * ESM_AGT_0037 화면에 대한 agt_agn_cntr_ref 조회 이벤트 처리<br>
