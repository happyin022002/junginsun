...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased1ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("											,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.CO_AMT,'O|BIZ', B2.HJS_SLS_AMT,B2.ESTM_PL_AMT) " ).append("\n"); 
		query.append("										) " ).append("\n"); 
		...
		query.append("			#end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		 GROUP BY B1.TRD_CD, L1.HUL_BND_CD" ).append("\n"); 
		query.append("                , (CASE WHEN B2.STND_COST_CD IN ('52101013', '52201013', '52101012', '52201012')" ).append("\n"); 
		query.append("                       THEN '52101014'" ).append("\n"); 
		query.append("                    WHEN B2.STND_COST_CD IN ('52301013', '52301012')" ).append("\n"); 
		query.append("                       THEN '52301014'" ).append("\n"); 
		...
		query.append("											,'LOAD0000', DECODE(SUBSTR (B2.CNTR_TPSZ_CD, -1),'2', B2.ESTM_PL_AMT, '3', B2.ESTM_PL_AMT, B2.ESTM_PL_AMT * 2) " ).append("\n"); 
		query.append("											,'BSA00000', B2.ESTM_PL_AMT " ).append("\n"); 
		query.append("											,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.CO_AMT,'O|BIZ', B2.HJS_SLS_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("										) " ).append("\n"); 
		query.append("							,'R', DECODE (B2.STND_COST_CD " ).append("\n"); 
		query.append("										,'LOAD0000', DECODE(SUBSTR(B2.CNTR_TPSZ_CD, -1),'2', B2.RA_PL_AMT, '3', B2.RA_PL_AMT, B2.RA_PL_AMT * 2) " ).append("\n"); 
		query.append("										,'92404011', DECODE(@[f_ofc_vw],'L', 0, 'C', DECODE(@[f_ofc_lvl],'1',0, B2.RA_PL_AMT)) " ).append("\n"); 
		...
		query.append("			   	   ,29, 'NTCOALOC'	" ).append("\n"); 
		...
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_TP_CD " ).append("\n"); 
		query.append("					                 ,'O', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("					                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.CO_AMT,'O|BIZ', A2.HJS_SLS_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("					                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ,0 " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	AND STND_COST_CD NOT IN ('OPCOST01', 'OPCOST02')  -- OP Cost Total(Pooling), OPCOST02(Pooling) 숨김 처리 (P&L Report)" ).append("\n"); 
