...
*@FileName : KrWharfageDecMgtDBDAOmodifyBkgKrWhfVolWhfDecSaveUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOmodifyBkgKrWhfVolWhfDecSaveUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOmodifyBkgKrWhfVolWhfDecSaveUSQL(){
		setQuery();
		...
		params.put("rduc_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ntc_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("whf_usr_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : KrWharfageDecMgtDBDAOmodifyBkgKrWhfVolWhfDecSaveUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHF_RT_AMT     =  REPLACE(@[whf_rt_amt],',','')" ).append("\n"); 
		...
		query.append(",WHF_USR_NM     =  @[whf_usr_nm]" ).append("\n"); 
		query.append(",WHF_CUST_KND_CD=  @[whf_cust_knd_cd]" ).append("\n"); 
		query.append(",NTC_AMT        =  REPLACE(@[ntc_amt],',','')" ).append("\n"); 
		query.append(",RDUC_AMT       =  REPLACE(@[rduc_amt],',','')" ).append("\n"); 
		query.append(",COMM_AMT       =  REPLACE(@[comm_amt],',','') " ).append("\n"); 
