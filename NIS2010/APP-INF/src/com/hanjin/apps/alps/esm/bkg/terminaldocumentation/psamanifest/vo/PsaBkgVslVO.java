...
public class PsaBkgVslVO extends AbstractValueObject {
	...
	/* Column Info */
	private String podYdcdLoc2 = null;
	/* Column Info */
	private String ucrNo = null;
	/* Column Info */
	private String podYdcdLoc1 = null;
	/* Column Info */
	...
	/* Column Info */
	private String podYdcdLoc3 = null;
	/* Column Info */
	private String podLoc3 = null;
	/* Column Info */
	private String opCd = null;
	/* Column Info */
	private String bkgYdcdPod = null;
	/* Column Info */
	...
	public PsaBkgVslVO(String ibflag, String pagerows, String shprNm1, String shprNm2, String bkgSeq, String pvVoyDir, String ucrNo, String soCd, String bkgNo, String podLoc3, String opCd, String podLoc2, String pvVslNm, String podLoc1, String bkgPod, String bkgFi, String bkgYdcdPod, String podYdcdLoc1, String podYdcdLoc2, String podYdcdLoc3) {
		this.shprNm1 = shprNm1;
		this.shprNm2 = shprNm2;
		this.pagerows = pagerows;
		this.bkgSeq = bkgSeq;
		this.pvVoyDir = pvVoyDir;
		this.podYdcdLoc2 = podYdcdLoc2;
		this.ucrNo = ucrNo;
		this.podYdcdLoc1 = podYdcdLoc1;
		this.soCd = soCd;
		this.ibflag = ibflag;
		this.bkgNo = bkgNo;
		this.podYdcdLoc3 = podYdcdLoc3;
		this.podLoc3 = podLoc3;
		this.opCd = opCd;
		this.bkgYdcdPod = bkgYdcdPod;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pod_ydcd_loc2", getPodYdcdLoc2());
		this.hashColumns.put("ucr_no", getUcrNo());
		this.hashColumns.put("pod_ydcd_loc1", getPodYdcdLoc1());
		this.hashColumns.put("so_cd", getSoCd());
		this.hashColumns.put("ibflag", getIbflag());
		this.hashColumns.put("bkg_no", getBkgNo());
		this.hashColumns.put("pod_ydcd_loc3", getPodYdcdLoc3());
		this.hashColumns.put("pod_loc3", getPodLoc3());
		this.hashColumns.put("op_cd", getOpCd());
		this.hashColumns.put("bkg_ydcd_pod", getBkgYdcdPod());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pod_ydcd_loc2", "podYdcdLoc2");
		this.hashFields.put("ucr_no", "ucrNo");
		this.hashFields.put("pod_ydcd_loc1", "podYdcdLoc1");
		this.hashFields.put("so_cd", "soCd");
		this.hashFields.put("ibflag", "ibflag");
		this.hashFields.put("bkg_no", "bkgNo");
		this.hashFields.put("pod_ydcd_loc3", "podYdcdLoc3");
		this.hashFields.put("pod_loc3", "podLoc3");
		this.hashFields.put("op_cd", "opCd");
		this.hashFields.put("bkg_ydcd_pod", "bkgYdcdPod");
	 ...
	 * @return podYdcdLoc2
	 */
	public String getPodYdcdLoc2() {
		return this.podYdcdLoc2;
	}
	 ...
	 * @return podYdcdLoc1
	 */
	public String getPodYdcdLoc1() {
		return this.podYdcdLoc1;
	}
	 ...
	 * @return podYdcdLoc3
	 */
	public String getPodYdcdLoc3() {
		return this.podYdcdLoc3;
	}
	 ...
	 * @return bkgYdcdPod
	 */
	public String getBkgYdcdPod() {
		return this.bkgYdcdPod;
	}
	 ...
	 * @param podYdcdLoc2
	 */
	public void setPodYdcdLoc2(String podYdcdLoc2) {
		this.podYdcdLoc2 = podYdcdLoc2;
	}
	 ...
	 * @param podYdcdLoc1
	 */
	public void setPodYdcdLoc1(String podYdcdLoc1) {
		this.podYdcdLoc1 = podYdcdLoc1;
	}
	 ...
	 * @param podYdcdLoc3
	 */
	public void setPodYdcdLoc3(String podYdcdLoc3) {
		this.podYdcdLoc3 = podYdcdLoc3;
	}
	 ...
	 * @param bkgYdcdPod
	 */
	public void setBkgYdcdPod(String bkgYdcdPod) {
		this.bkgYdcdPod = bkgYdcdPod;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPodYdcdLoc2(JSPUtil.getParameter(request, prefix + "pod_ydcd_loc2", ""));
		setUcrNo(JSPUtil.getParameter(request, prefix + "ucr_no", ""));
		setPodYdcdLoc1(JSPUtil.getParameter(request, prefix + "pod_ydcd_loc1", ""));
		setSoCd(JSPUtil.getParameter(request, prefix + "so_cd", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setBkgNo(JSPUtil.getParameter(request, prefix + "bkg_no", ""));
		setPodYdcdLoc3(JSPUtil.getParameter(request, prefix + "pod_ydcd_loc3", ""));
		setPodLoc3(JSPUtil.getParameter(request, prefix + "pod_loc3", ""));
		setOpCd(JSPUtil.getParameter(request, prefix + "op_cd", ""));
		setBkgYdcdPod(JSPUtil.getParameter(request, prefix + "bkg_ydcd_pod", ""));
	...
	public PsaBkgVslVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] podYdcdLoc2 = (JSPUtil.getParameter(request, prefix	+ "pod_ydcd_loc2", length));
			String[] ucrNo = (JSPUtil.getParameter(request, prefix	+ "ucr_no", length));
			String[] podYdcdLoc1 = (JSPUtil.getParameter(request, prefix	+ "pod_ydcd_loc1", length));
			String[] soCd = (JSPUtil.getParameter(request, prefix	+ "so_cd", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] bkgNo = (JSPUtil.getParameter(request, prefix	+ "bkg_no", length));
			String[] podYdcdLoc3 = (JSPUtil.getParameter(request, prefix	+ "pod_ydcd_loc3", length));
			...
			String[] bkgYdcdPod = (JSPUtil.getParameter(request, prefix	+ "bkg_ydcd_pod", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (podYdcdLoc2[i] != null)
					model.setPodYdcdLoc2(podYdcdLoc2[i]);
				if (ucrNo[i] != null)
					model.setUcrNo(ucrNo[i]);
				if (podYdcdLoc1[i] != null)
					model.setPodYdcdLoc1(podYdcdLoc1[i]);
				if (soCd[i] != null)
				...
				if (podYdcdLoc3[i] != null)
					model.setPodYdcdLoc3(podYdcdLoc3[i]);
				if (podLoc3[i] != null)
					model.setPodLoc3(podLoc3[i]);
				if (opCd[i] != null)
					model.setOpCd(opCd[i]);
				if (bkgYdcdPod[i] != null)
					model.setBkgYdcdPod(bkgYdcdPod[i]);
				if (podLoc2[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.podYdcdLoc2 = this.podYdcdLoc2 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ucrNo = this.ucrNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podYdcdLoc1 = this.podYdcdLoc1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.soCd = this.soCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.bkgNo = this.bkgNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podYdcdLoc3 = this.podYdcdLoc3 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.bkgYdcdPod = this.bkgYdcdPod .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
