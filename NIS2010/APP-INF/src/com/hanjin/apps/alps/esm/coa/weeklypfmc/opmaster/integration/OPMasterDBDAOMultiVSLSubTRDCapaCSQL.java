...
*@FileName : OPMasterDBDAOMultiVSLSubTRDCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiVSLSubTRDCapaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiVSLSubTRDCapa INSERT
	  * </pre>
	  */
	public OPMasterDBDAOMultiVSLSubTRDCapaCSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiVSLSubTRDCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[vsl_cd]" ).append("\n"); 
		query.append(", (SELECT MAX(VSL_SEQ) FROM COA_VSL_RGST WHERE VSL_CD = @[vsl_cd])" ).append("\n"); 
		query.append(", @[sub_trd_cd]" ).append("\n"); 
		query.append(", @[sub_trd_capa]" ).append("\n"); 
		query.append(", @[cre_usr_id]" ).append("\n"); 
