...
*@FileName : RFARateProposalDBDAOPropCpPriRpScpRtRoutPntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropCpPriRpScpRtRoutPntCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPropCpPriRpScpRtRoutPntCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropCpPriRpScpRtRoutPntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY S.PROP_NO, S.AMDT_SEQ, S.SVC_SCP_CD" ).append("\n"); 
		query.append("                                     , S.CMDT_HDR_SEQ, S.ROUT_SEQ, S.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("                          ORDER BY S.PROP_NO, S.AMDT_SEQ, S.SVC_SCP_CD" ).append("\n"); 
