...
*@FileName : PSASpecialManifestDBDAOPSADgEdiVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOPSADgEdiVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSADgEdiVO 생성을 위해 사용
	  * </pre>
	  */
	public PSASpecialManifestDBDAOPSADgEdiVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.terminaldocumentation.psaspecialmanifest.integration").append("\n"); 
		query.append("FileName : PSASpecialManifestDBDAOPSADgEdiVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,'' frm_vsl_eng_nm" ).append("\n"); 
		query.append("	,'' frm_lloyd_no" ).append("\n"); 
		query.append("	,'' frm_call_sgn_no" ).append("\n"); 
		query.append("	,'' frm_vsl_cnt_cd" ).append("\n"); 
