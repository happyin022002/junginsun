...
*@FileName : RsltAuthorityVO.java
*@FileTitle : RsltAuthorityVO
*Open Issues :
*Change history :
...
public class RsltMqcAuthorityVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltMqcAuthorityVO> models = new ArrayList<RsltMqcAuthorityVO>();
	...
	public RsltMqcAuthorityVO() {}

	public RsltMqcAuthorityVO(String ibflag, String pagerows, String reqUsrFlg, String aproUsrFlg) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return RsltAuthorityVO[]
	 */
	public RsltMqcAuthorityVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltAuthorityVO[]
	 */
	public RsltMqcAuthorityVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltMqcAuthorityVO model = null;
	 ...
	 * @return RsltAuthorityVO[]
	 */
	public RsltMqcAuthorityVO[] getRsltAuthorityVOs(){
		RsltMqcAuthorityVO[] vos = (RsltMqcAuthorityVO[])models.toArray(new RsltMqcAuthorityVO[models.size()]);
		return vos;
	}
