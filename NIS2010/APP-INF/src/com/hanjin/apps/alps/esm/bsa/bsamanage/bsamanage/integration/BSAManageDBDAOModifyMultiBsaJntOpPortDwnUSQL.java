...
*@FileName : BSAManageDBDAOModifyMultiBsaJntOpPortDwnUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifyMultiBsaJntOpPortDwnUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BSA_0026 화면의 BsaJntOpPortDwn UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOModifyMultiBsaJntOpPortDwnUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifyMultiBsaJntOpPortDwnUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BSA_JNT_OP_PORT_DWN" ).append("\n"); 
