...
*@FileName : SCGroupLocationProposalDBDAORsltGrpLocDtlStsListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAORsltGrpLocDtlStsListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCGroupLocationProposalDBDAORsltGrpLocDtlStsListVORSQL
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAORsltGrpLocDtlStsListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAORsltGrpLocDtlStsListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("pri_sp_scp_grp_loc_dtl dtl," ).append("\n"); 
