...
*@FileName : TCharterIOInvoiceDAOSearchVnorSeq2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAOSearchVnorSeq2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInvoiceDAOSearchVnorSeq2RSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDAOSearchVnorSeq2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                     SELECT COUNT(VNOR_SEQ) " ).append("\n"); 
		query.append("                     FROM  FMS_VNOR" ).append("\n"); 
		query.append("                  ) > 0 THEN ( " ).append("\n"); 
		query.append("                               SELECT MAX(VNOR_SEQ) + 1 AS VNOR_SEQ " ).append("\n"); 
		query.append("                               FROM FMS_VNOR " ).append("\n"); 
		query.append("                             ) " ).append("\n"); 
