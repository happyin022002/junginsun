...
*@FileName : ESM_BKG_066808HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_066808HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_066808HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg066808Event event = new EsmBkg066808Event();
        ...
        log.debug("===================================");
        log.debug("    ESM_BKG_066808HTMLAction Start   ");
        log.debug("===================================");
