...
*@FileName : KorManifestListDBDAOModifyDownHistUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOModifyDownHistUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOModifyDownHistUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : KorManifestListDBDAOModifyDownHistUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}