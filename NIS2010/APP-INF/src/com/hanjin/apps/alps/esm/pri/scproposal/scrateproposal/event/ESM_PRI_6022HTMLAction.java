...
*@FileName : ESM_PRI_6022HTMLAction.java
...
public class ESM_PRI_6022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6022HTMLAction 객체를 생성
	 */
	public ESM_PRI_6022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6022Event event = new EsmPri6022Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setRsltPriAmdCmViewAllVO((RsltPriAmdCmViewAllVO)getVO(request, RsltPriAmdCmViewAllVO .class));
