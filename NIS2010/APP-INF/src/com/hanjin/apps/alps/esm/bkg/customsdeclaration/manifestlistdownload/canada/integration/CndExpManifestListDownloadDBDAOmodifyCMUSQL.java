...
*@FileName : CndExpManifestListDownloadDBDAOmodifyCMUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOmodifyCMUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOmodifyCMUSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOmodifyCMUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BKG_CSTMS_AMER_CNTR_MF MF" ).append("\n"); 
		...
		query.append("                ,@[bl_no]" ).append("\n"); 
		query.append("                ,NVL((SELECT /*+ index_desc(A XPKBKG_CSTMS_AMER_CNTR_MF MF) */" ).append("\n"); 
		query.append("                             CMDT_GDS_SEQ" ).append("\n"); 
		query.append("                      FROM   BKG_CSTMS_AMER_CNTR_MF A" ).append("\n"); 
