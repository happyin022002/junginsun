...
*@FileName : KorMakeFlatFileBLBodyVO.java
*@FileTitle : KorMakeFlatFileBLBodyVO
*Open Issues :
*Change history :
...
public class KorMakeFlatFileBLBodyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorMakeFlatFileBLBodyVO> models = new ArrayList<KorMakeFlatFileBLBodyVO>();
	...
	public KorMakeFlatFileBLBodyVO() {}

	public KorMakeFlatFileBLBodyVO(String ibflag, String pagerows, String bkgNo, String kcdTp, String blData, String vslCd, String ktPort, String obType, String mrnType, String podLoc, String polLoc) {
	 ...
	 * @param request
	 * @return KorMakeFlatFileBLBodyVO[]
	 */
	public KorMakeFlatFileBLBodyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMakeFlatFileBLBodyVO[]
	 */
	public KorMakeFlatFileBLBodyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMakeFlatFileBLBodyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new KorMakeFlatFileBLBodyVO();
				if (mrnType[i] != null)
		...
		return getKorMakeFlatFileBLBodyVOs();
	}
	 ...
	 * @return KorMakeFlatFileBLBodyVO[]
	 */
	public KorMakeFlatFileBLBodyVO[] getKorMakeFlatFileBLBodyVOs(){
		KorMakeFlatFileBLBodyVO[] vos = (KorMakeFlatFileBLBodyVO[])models.toArray(new KorMakeFlatFileBLBodyVO[models.size()]);
		return vos;
	}
