...
*@FileName : RFARateProposalDBDAOPriRpScpRtCmdtRoutVOMSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCmdtRoutVOMSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCmdtRoutVOMSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCmdtRoutVOMSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_RP_SCP_RT_CMDT_ROUT" ).append("\n"); 
