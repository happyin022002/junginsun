...
*@FileName : ScqAwkwardDBDAOcopyPriScqAwkRqstNoYdSmryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOcopyPriScqAwkRqstNoYdSmryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_YD_SMRY Temp Table Copy 해오기
	  * </pre>
	  */
	public ScqAwkwardDBDAOcopyPriScqAwkRqstNoYdSmryCSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOcopyPriScqAwkRqstNoYdSmryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SCQ_AWK_YD_SMRY" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("    ,   @[cre_usr_id]" ).append("\n"); 
		query.append("    ,   SYSDATE" ).append("\n"); 
		query.append("FROM    PRI_SCQ_AWK_YD_SMRY" ).append("\n"); 
