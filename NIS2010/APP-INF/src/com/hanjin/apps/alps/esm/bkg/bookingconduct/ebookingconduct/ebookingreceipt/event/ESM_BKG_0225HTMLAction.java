...
*@FileName : ESM_BKG_0225HTMLAction.java
...
public class ESM_BKG_0225HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0225HTMLAction 객체를 생성
	 */
	public ESM_BKG_0225HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0225Event event = new EsmBkg0225Event();
...
//			event.setBkgSrFaxVOS((BkgSrFaxVO[])getVOs(request, BkgSrFaxVO .class,"sheet1_"));
			...
			event.setBkgSrFaxVOS((BkgSrFaxVO[])getVOs(request, BkgSrFaxVO .class));
		}
//		}else if(command.isCommand(FormCommand.MULTI03)) {
