...
*@FileName : ESM_COA_0062HTMLAction.java
...
public class ESM_COA_0062HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0062HTMLAction 객체를 생성
	 */
	public ESM_COA_0062HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0062Event event = new EsmCoa0062Event();
		

		event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInqByLane0062VO((InqByLane0062VO)getVO(request, InqByLane0062VO .class));
		}
