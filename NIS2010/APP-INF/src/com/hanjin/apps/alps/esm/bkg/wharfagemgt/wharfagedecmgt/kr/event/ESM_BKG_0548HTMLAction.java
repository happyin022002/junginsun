 ...
 *@FileName : ESM_BKG_0548HTMLAction.java
 *@FileTitle : ESM_BKG_0548HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0548HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0548HTMLAction 객체를 생성
	 */
	public ESM_BKG_0548HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0548Event event = new EsmBkg0548Event();
		...
		if (command.isCommand(FormCommand.SEARCH)) {
			...
			event.setWhfBerthCdCondVO( (KrWhfBerthCdCondVO)getVO(request, KrWhfBerthCdCondVO.class) ); 
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setKrWhfVslInfoVO( (KrWhfVslInfoVO)getVO( request, KrWhfVslInfoVO.class ) );
		} 
