...
public class JapanManifestListCntrDetailVO extends AbstractValueObject {
	...
	public JapanManifestListCntrDetailVO(String ibflag, String pagerows, String cntrPrtFlg, String vpsEtdDt, String blNo, String podCd, String deTermCd, String polCd, String bkgNo, String cntrNo, String seq, String cntrSealNo, String cntrSealNo2, String cntrSealNo3, String cntrSealNo4, String cntrSealNo5, String cntrSealNo6, String rcvTermCd, String cntrKnt) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCntrSealNo4(JSPUtil.getParameter(request, prefix + "cntr_seal_no4", ""));
		setCntrSealNo5(JSPUtil.getParameter(request, prefix + "cntr_seal_no5", ""));
		setCntrSealNo6(JSPUtil.getParameter(request, prefix + "cntr_seal_no6", ""));
