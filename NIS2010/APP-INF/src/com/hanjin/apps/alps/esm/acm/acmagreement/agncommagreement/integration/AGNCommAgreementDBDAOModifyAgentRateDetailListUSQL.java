...
*@FileName : AGNCommAgreementDBDAOModifyAgentRateDetailListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOModifyAgentRateDetailListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyAgentRateDetail
	  * </pre>
	  */
	public AGNCommAgreementDBDAOModifyAgentRateDetailListUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOModifyAgentRateDetailListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE ACM_AGN_AGMT_DTL" ).append("\n"); 
		query.append("   SET OFC_SET_TP_CD = @[ofc_set_tp_cd]," ).append("\n"); 
		query.append("       OFC_CVRG_CD = @[ofc_cvrg_cd]," ).append("\n"); 
		query.append("       OFC_CD = @[ofc_cd]," ).append("\n"); 
		query.append("       OFT_PAY_TERM_CD = @[oft_pay_term_cd]," ).append("\n"); 
		query.append("       FULL_MTY_CD = @[full_mty_cd]," ).append("\n"); 
		query.append("       CURR_CD = @[curr_cd]," ).append("\n"); 
		query.append("       COMM_FX_AMT = @[comm_fx_amt]," ).append("\n"); 
		query.append("       COMM_PAY_TERM_CD = @[comm_pay_term_cd]," ).append("\n"); 
		query.append("       REV_DIV_CD = @[rev_div_cd]," ).append("\n"); 
		query.append("       COMM_RT = @[comm_rt]," ).append("\n"); 
		query.append("       HLG_DDCT_ORG_FLG = @[hlg_ddct_org_flg]," ).append("\n"); 
		query.append("       HLG_DDCT_DEST_FLG = @[hlg_ddct_dest_flg]," ).append("\n"); 
		query.append("       FDRG_DDCT_ORG_FLG = @[fdrg_ddct_org_flg]," ).append("\n"); 
		query.append("       FDRG_DDCT_DEST_FLG = @[fdrg_ddct_dest_flg]," ).append("\n"); 
		query.append("	   -- 2017.08.18 Charge Commission 추가 -- start" ).append("\n"); 
		query.append("	   CHG_COMM_DIV_CD = @[chg_comm_div_cd]," ).append("\n"); 
		query.append("	   CHG_COMM_RT = @[chg_comm_rt]," ).append("\n"); 
		query.append("	   CHG_COMM_OTR_AMT = @[chg_comm_otr_amt], " ).append("\n"); 
		query.append("	   CHG_COMM_CURR_CD = @[chg_comm_curr_cd]," ).append("\n"); 
		query.append("	   CHG_COMM_PAY_TERM_CD = @[chg_comm_pay_term_cd], " ).append("\n"); 
