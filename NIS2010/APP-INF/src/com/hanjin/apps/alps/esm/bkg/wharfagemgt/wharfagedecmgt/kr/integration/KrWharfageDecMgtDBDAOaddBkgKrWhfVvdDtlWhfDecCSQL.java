...
*@FileName : KrWharfageDecMgtDBDAOaddBkgKrWhfVvdDtlWhfDecCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOaddBkgKrWhfVvdDtlWhfDecCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOaddBkgKrWhfVvdDtlWhfDecCSQL(){
		setQuery();
		...
		params.put("kr_whf_dc_rsn_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("kr_whf_dc_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ttl_ton_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : KrWharfageDecMgtDBDAOaddBkgKrWhfVvdDtlWhfDecCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_KR_WHF_VVD_DTL" ).append("\n"); 
		query.append("(" ).append("\n"); 
