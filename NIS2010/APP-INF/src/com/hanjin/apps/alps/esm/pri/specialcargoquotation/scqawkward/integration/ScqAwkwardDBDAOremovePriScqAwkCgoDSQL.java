...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkCgoDSQL.java
...
public class ScqAwkwardDBDAOremovePriScqAwkCgoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkCgoDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkCgoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
