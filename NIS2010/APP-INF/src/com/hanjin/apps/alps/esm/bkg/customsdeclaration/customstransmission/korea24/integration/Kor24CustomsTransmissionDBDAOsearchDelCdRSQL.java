...
*@FileName : Kor24CustomsTransmissionDBDAOsearchDelCdRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchDelCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchDelCdRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchDelCdRSQL").append("\n");
		query.append("*/").append("\n");
	}
