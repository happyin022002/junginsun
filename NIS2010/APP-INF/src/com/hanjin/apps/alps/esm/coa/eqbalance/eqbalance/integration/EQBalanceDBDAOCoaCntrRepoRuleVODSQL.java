...
*@FileName : EQBalanceDBDAOCoaCntrRepoRuleVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOCoaCntrRepoRuleVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQBalanceDBDAOCoaCntrRepoRuleVODSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOCoaCntrRepoRuleVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE COA_CNTR_REPO_RULE" ).append("\n"); 
