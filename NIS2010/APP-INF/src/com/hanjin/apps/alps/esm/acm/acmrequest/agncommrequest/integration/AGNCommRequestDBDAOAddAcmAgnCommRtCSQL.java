...
public class AGNCommRequestDBDAOAddAcmAgnCommRtCSQL implements ISQLTemplate{
	...
	public AGNCommRequestDBDAOAddAcmAgnCommRtCSQL(){
		...
		params.put("ddct_vip_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("org_comm_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("min_comm_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("min_comm_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(", ROUND( @[ddct_vip_amt], 2)                 AS DDCT_VIP_AMT" ).append("\n"); 
		...
		query.append(", CASE WHEN @[max_ac_seq] > 1  AND ROUND( @[comm_amt],2) < 0 THEN 0" ).append("\n"); 
		query.append("       ELSE ROUND( @[org_comm_amt],2) " ).append("\n"); 
		query.append("  END                                        AS ORG_COMM_AMT" ).append("\n"); 
		query.append(", CASE WHEN @[max_ac_seq] > 1  AND ROUND( @[comm_amt],2) < 0 THEN 0" ).append("\n"); 
		query.append("       ELSE ROUND( @[min_comm_amt],2) " ).append("\n"); 
		query.append("  END                                        AS MIN_COMM_AMT" ).append("\n"); 
		query.append(", @[min_comm_flg] AS MIN_COMM_FLG" ).append("\n"); 
