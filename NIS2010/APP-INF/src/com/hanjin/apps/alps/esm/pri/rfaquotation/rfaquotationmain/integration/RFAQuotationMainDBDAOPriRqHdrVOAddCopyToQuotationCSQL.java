...
*@FileName : RFAQuotationMainDBDAOPriRqHdrVOAddCopyToQuotationCSQL.java
...
public class RFAQuotationMainDBDAOPriRqHdrVOAddCopyToQuotationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAOPriRqHdrVOAddCopyToQuotationCSQL(){
		setQuery();
		...
		query.append("FileName : RFAQuotationMainDBDAOPriRqHdrVOAddCopyToQuotationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RQ_HDR (" ).append("\n"); 
