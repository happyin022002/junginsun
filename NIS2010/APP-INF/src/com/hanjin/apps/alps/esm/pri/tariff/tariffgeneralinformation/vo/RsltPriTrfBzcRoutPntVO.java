...
public class RsltPriTrfBzcRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriTrfBzcRoutPntVO> models = new ArrayList<RsltPriTrfBzcRoutPntVO>();
	...
	public RsltPriTrfBzcRoutPntVO() {}

	public RsltPriTrfBzcRoutPntVO(String ibflag, String pagerows, String trfPfxCd, String trfNo, String amdtSeq, String orgDestTpCd, String trfBzcRoutPntSeq, String trfBzcRoutPntTpCd, String trfBzcRoutPntDefCd, String cntNm, String n1stCmncAmdtSeq, String srcInfoCd, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return RsltPriTrfBzcRoutPntVO[]
	 */
	public RsltPriTrfBzcRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriTrfBzcRoutPntVO[]
	 */
	public RsltPriTrfBzcRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriTrfBzcRoutPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriTrfBzcRoutPntVO();
				if (updDt[i] != null)
		...
		return getRsltPriTrfBzcRoutPntVOs();
	}
	 ...
	 * @return RsltPriTrfBzcRoutPntVO[]
	 */
	public RsltPriTrfBzcRoutPntVO[] getRsltPriTrfBzcRoutPntVOs(){
		RsltPriTrfBzcRoutPntVO[] vos = (RsltPriTrfBzcRoutPntVO[])models.toArray(new RsltPriTrfBzcRoutPntVO[models.size()]);
		return vos;
	}
