...
public class KoreaCustomsReportDBDAOsearchOFMListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  FROM BKG_VVD VVD,BKG_BOOKING BKG, BKG_BL_DOC DOC, BKG_CSTMS_KR_MF_SEQ_NO MSN" ).append("\n"); 
		...
		query.append(" ORDER BY MSN.MRN_BL_TS_CD, VVD.POD_CD" ).append("\n"); 
