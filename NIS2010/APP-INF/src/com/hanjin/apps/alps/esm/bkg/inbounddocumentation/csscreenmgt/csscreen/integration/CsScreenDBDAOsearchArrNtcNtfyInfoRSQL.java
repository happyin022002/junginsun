...
*@FileName : CsScreenDBDAOsearchArrNtcNtfyInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CsScreenDBDAOsearchArrNtcNtfyInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CsScreenDBDAOsearchArrNtcNtfyInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CsScreenDBDAOsearchArrNtcNtfyInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , SUBQ.SND_NO6                                            AS SND_NO6" ).append("\n"); 
		query.append("     , SUBQ.SND_NO7                                            AS SND_NO7" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD1,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD1,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD1 -- Arrival Notice Sent History와 같은 코드 사용할 시에 전송결과 코드 변환" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD2,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD2,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD2" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD3,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD3,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD3" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD4,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD4,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD4" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD5,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD5,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD5" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD6,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD6,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD6" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD7,'9'), '5', 'B', '6', 'R','9','X','P'), " ).append("\n"); 
		query.append("                                     DECODE(NVL(SUBQ.SND_RSLT_CD7,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("     , NVL2(SUBQ.SND_FLG6,SUBQ.SND_FLG6,NVL2(SUBQ.SND_NO6,'Y','N')) AS SND_FLG6    -- Do Not Send Flag" ).append("\n"); 
		query.append("     , NVL2(SUBQ.SND_FLG7,SUBQ.SND_FLG7,NVL2(SUBQ.SND_NO7,'Y','N')) AS SND_FLG7    -- Do Not Send Flag" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD1 )   AS SND_RSLT_NM1  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD2 )   AS SND_RSLT_NM2  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD3 )   AS SND_RSLT_NM3  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD4 )   AS SND_RSLT_NM4  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD5 )   AS SND_RSLT_NM5  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD6 )   AS SND_RSLT_NM6  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC( DECODE(SUBQ.KIND_DESC, 'Fax','CD00959','CD00960'), SUBQ.SND_RSLT_CD7 )   AS SND_RSLT_NM7  -- Fax & E-MAIL 전송 상태" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A1', ADTL.FAX_NO      , NULL)) AS SND_NO6" ).append("\n"); 
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A2', ADTL.FAX_NO      , NULL)) AS SND_NO7" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A1', ADTL.FAX_SND_FLG , NULL)) AS SND_FLG6" ).append("\n"); 
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A2', ADTL.FAX_SND_FLG , NULL)) AS SND_FLG7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A1', NVL(ADTL.FAX_NTC_SND_RSLT_CD, FXSD.FAX_PROC_STS_CD) , NULL)) AS SND_RSLT_CD6" ).append("\n"); 
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A2', NVL(ADTL.FAX_NTC_SND_RSLT_CD, FXSD.FAX_PROC_STS_CD) , NULL)) AS SND_RSLT_CD7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                  AND BKGM.BKG_STS_CD <> 'S'  -- add by Park Mangeon (AS IS에 의거) " ).append("\n"); 
		query.append("                  AND BKGM.BL_NO IS NOT NULL  -- add by Park Mangeon (AS IS에 의거)" ).append("\n"); 
		...
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A1', ADTL.NTC_EML     , NULL)) AS SND_NO6" ).append("\n"); 
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A2', ADTL.NTC_EML     , NULL)) AS SND_NO7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A1', ADTL.EML_SND_FLG , NULL)) AS SND_FLG6" ).append("\n"); 
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A2', ADTL.EML_SND_FLG , NULL)) AS SND_FLG7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A1', NVL(ADTL.EML_NTC_SND_RSLT_CD, EMSD.EML_PROC_STS_CD) , NULL)) AS SND_RSLT_CD6" ).append("\n"); 
		query.append("             , MAX(DECODE(ADTL.CUST_CNTC_TP_CD, 'A2', NVL(ADTL.EML_NTC_SND_RSLT_CD, EMSD.EML_PROC_STS_CD) , NULL)) AS SND_RSLT_CD7" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("             , MAX(NVL(ADTL.EML_SND_DT, GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',EMSD.EML_DT,GLOBALDATE_PKG.GET_LOCCD_FNC( ( SELECT COM.OFC_CD " ).append("\n"); 
		query.append("                                                                                                                         FROM COM_USER COM " ).append("\n"); 
		query.append("                                                                                                                         WHERE COM.USR_ID=ADTL.EML_SND_USR_ID) )) )) AS SND_DT" ).append("\n"); 
		query.append("             , MAX(NVL(ADTL.EML_SND_GDT, GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',EMSD.EML_DT,'GMT' ))) AS SND_GDT      " ).append("\n"); 
		query.append("             , @[usr_id] AS LOGIN_USR_ID" ).append("\n"); 
		query.append("             , MAX(BKGM.IS_EVAL) AS IS_EVAL" ).append("\n"); 
		query.append("         FROM (SELECT /*+ ALL_ROWS */" ).append("\n"); 
		query.append("                       BKGM.BKG_NO" ).append("\n"); 
