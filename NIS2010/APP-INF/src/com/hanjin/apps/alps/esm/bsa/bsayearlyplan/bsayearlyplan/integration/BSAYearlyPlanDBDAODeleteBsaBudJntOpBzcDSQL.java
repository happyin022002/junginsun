...
*@FileName : BSAYearlyPlanDBDAODeleteBsaBudJntOpBzcDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAODeleteBsaBudJntOpBzcDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSA_BUD_JNT_OP_BZC 테이블의 데이터를 삭제한다.
	  * </pre>
	  */
	public BSAYearlyPlanDBDAODeleteBsaBudJntOpBzcDSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAODeleteBsaBudJntOpBzcDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
