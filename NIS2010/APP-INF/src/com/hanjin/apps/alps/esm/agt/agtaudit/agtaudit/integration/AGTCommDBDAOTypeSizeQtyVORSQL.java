...
*@FileName : AGTCommDBDAOTypeSizeQtyVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCommDBDAOTypeSizeQtyVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_AGT_0011 화면 TP/SZ QTY 조회
	  * </pre>
	  */
	public AGTCommDBDAOTypeSizeQtyVORSQL(){
		setQuery();
		...
		query.append("FileName : AGTCommDBDAOTypeSizeQtyVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
