...
*@FileName : DgPackageVO.java
*@FileTitle : DgPackageVO
*Open Issues :
*Change history :
...
public class DgPackageVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DgPackageVO> models = new ArrayList<DgPackageVO>();
	...
	public DgPackageVO(String ibflag, String pagerows, String imdgPckCd, String imdgPckDesc, String imdgPckTpCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return DgPackageVO[]
	 */
	public DgPackageVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DgPackageVO[]
	 */
	public DgPackageVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DgPackageVO model = null;
	...
	public DgPackageVO[] getDgPackageVOs(){
		DgPackageVO[] vos = (DgPackageVO[])models.toArray(new DgPackageVO[models.size()]);
		return vos;
	}
