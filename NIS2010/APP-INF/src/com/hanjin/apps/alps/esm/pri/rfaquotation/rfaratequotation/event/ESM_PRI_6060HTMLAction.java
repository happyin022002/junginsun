...
*@FileName : ESM_PRI_6060HTMLAction
...
public class ESM_PRI_6060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6060HTMLAction 객체를 생성
	 */
	public ESM_PRI_6060HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri6060Event event = new EsmPri6060Event();
