...
*@FileName : AGTAuditDBDAOBeforeCanceledAcSeqDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOBeforeCanceledAcSeqDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BeforeCanceledAcSeqDtl
	  * </pre>
	  */
	public AGTAuditDBDAOBeforeCanceledAcSeqDtlDSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOBeforeCanceledAcSeqDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
