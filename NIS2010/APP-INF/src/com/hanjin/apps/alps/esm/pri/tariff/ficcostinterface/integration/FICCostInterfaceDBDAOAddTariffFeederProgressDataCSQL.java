...
*@FileName : FICCostInterfaceDBDAOAddTariffFeederProgressDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOAddTariffFeederProgressDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT - PRI_TRF_FDR_PROG
	  * </pre>
	  */
	public FICCostInterfaceDBDAOAddTariffFeederProgressDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOAddTariffFeederProgressDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
