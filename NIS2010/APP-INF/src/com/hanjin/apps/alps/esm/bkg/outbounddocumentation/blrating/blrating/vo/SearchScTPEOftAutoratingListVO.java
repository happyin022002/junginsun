...
*@FileName : SearchScTPEOftAutoratingListVO.java
*@FileTitle : SearchScTPEOftAutoratingListVO
*Open Issues :
*Change history :
...
public class SearchScTPEOftAutoratingListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchScTPEOftAutoratingListVO> models = new ArrayList<SearchScTPEOftAutoratingListVO>();
	 ...
	 * @param request
	 * @return SearchScTPEOftAutoratingListVO[]
	 */
	public SearchScTPEOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchScTPEOftAutoratingListVO[]
	 */
	public SearchScTPEOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchScTPEOftAutoratingListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchScTPEOftAutoratingListVO();
		...
		return getSearchScTPEOftAutoratingListVOs();
	}
	 ...
	 * @return SearchScTPEOftAutoratingListVO[]
	 */
	public SearchScTPEOftAutoratingListVO[] getSearchScTPEOftAutoratingListVOs(){
		SearchScTPEOftAutoratingListVO[] vos = (SearchScTPEOftAutoratingListVO[])models.toArray(new SearchScTPEOftAutoratingListVO[models.size()]);
		return vos;
	}
