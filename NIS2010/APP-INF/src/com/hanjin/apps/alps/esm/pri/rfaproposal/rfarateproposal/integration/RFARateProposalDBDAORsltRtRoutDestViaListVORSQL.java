...
*@FileName : RFARateProposalDBDAORsltRtRoutDestViaListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtRoutDestViaListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtRoutDestViaListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtRoutDestViaListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
