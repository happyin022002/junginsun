...
*@FileName : ESM_FMS_0063HTMLAction.java
...
public class ESM_FMS_0063HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0063HTMLAction 객체를 생성
	 */
	public ESM_FMS_0063HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0063Event event = new EsmFms0063Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomStndHirVOS((CustomStndHirVO[])getVOs(request, CustomStndHirVO .class,""));
			event.setRngYr(request.getParameter("rngYr").replace("-", ""));
