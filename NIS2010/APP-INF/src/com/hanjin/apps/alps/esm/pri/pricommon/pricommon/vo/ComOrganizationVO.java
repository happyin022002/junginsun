...
*@FileName : ComOrganizationVO.java
*@FileTitle : ComOrganizationVO
*Open Issues :
*Change history :
...
public class ComOrganizationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComOrganizationVO> models = new ArrayList<ComOrganizationVO>();
	...
	public ComOrganizationVO() {}

	public ComOrganizationVO(String ibflag, String pagerows, String level, String pnodeId, String nodeId, String nodeNm, String ofcCd, String usrId, String typeFlg, String authFlg, String haveChild, String propNo, String amdtSeq, String usrNm) {
...
/**
	 ...
	 */
	public ComOrganizationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComOrganizationVO[]
	 */
	public ComOrganizationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComOrganizationVO model = null;
	...
	public ComOrganizationVO[] getComOrganizationVOs(){
		ComOrganizationVO[] vos = (ComOrganizationVO[])models.toArray(new ComOrganizationVO[models.size()]);
		return vos;
	}
