...
*@FileName : GeneralBookingReceiptDBDAOModifyKrPkupRtnCyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingReceiptDBDAOModifyKrPkupRtnCyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralBookingReceiptDBDAOModifyKrPkupRtnCyUSQL
	  * </pre>
	  */
	public GeneralBookingReceiptDBDAOModifyKrPkupRtnCyUSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingReceiptDBDAOModifyKrPkupRtnCyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("             , BKG_TRO_DTL DTL" ).append("\n"); 
		...
		query.append("   SET BK.MTY_PKUP_YD_CD = NVL(TRO.PKUP_YD_CD,BK.MTY_PKUP_YD_CD)" ).append("\n"); 
		query.append("     , BK.FULL_RTN_YD_CD = NVL(TRO.RTN_YD_CD,BK.FULL_RTN_YD_CD)" ).append("\n"); 
