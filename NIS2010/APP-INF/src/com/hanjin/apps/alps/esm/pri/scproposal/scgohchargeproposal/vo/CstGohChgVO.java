...
*@FileName : CstGohChgVO.java
*@FileTitle : CstGohChgVO
*Open Issues :
*Change history :
...
public class CstGohChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstGohChgVO> models = new ArrayList<CstGohChgVO>();
	 ...
	 * @return CstGohChgVO[]
	 */
	public CstGohChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstGohChgVO[]
	 */
	public CstGohChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstGohChgVO model = null;
	 ...
	 * @return CstGohChgVO[]
	 */
	public CstGohChgVO[] getCstGohChgVOs(){
		CstGohChgVO[] vos = (CstGohChgVO[])models.toArray(new CstGohChgVO[models.size()]);
		return vos;
	}
