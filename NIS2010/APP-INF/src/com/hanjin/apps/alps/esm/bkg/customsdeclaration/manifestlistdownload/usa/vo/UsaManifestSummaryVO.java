...
public class UsaManifestSummaryVO extends ManifestListDetailVO {
	...
	public UsaManifestSummaryVO(String ibflag, String pagerows, String vvd, String pol, String pod, String eta, String frob, String customs, String sentTime, String mi, String cntrCount, String blCount, String mblCount01, String mblCount02, String mblCount03, String hblCount, String etd, String bdrCount, String xi) {
		this.eta = eta;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setXi(JSPUtil.getParameter(request, "xi", ""));		
	...
	public UsaManifestSummaryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] xi = (JSPUtil.getParameter(request, prefix	+ "xi", length));			
	...
	*/
	public void unDataFormat(){
		...
		this.xi = this.xi .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
