...
*@FileName : ScqAwkwardDBDAOcopyPriScqAwkRoutDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOcopyPriScqAwkRoutDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_ROUT_DTL Temp Table Copy 해오기
	  * </pre>
	  */
	public ScqAwkwardDBDAOcopyPriScqAwkRoutDtlCSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOcopyPriScqAwkRoutDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SCQ_AWK_ROUT_DTL " ).append("\n"); 
		query.append("(" ).append("\n"); 
