...
public class CustEtcVO extends AbstractValueObject {
	...
	/* Column Info */
	private String krCstmsCustTpCdUseFlg = null;
	/* Column Info */
	...
	/* Column Info */
	private String jp24AlertFlg = null;
	/* Column Info */
	...
	public CustEtcVO(String ibflag, String pagerows, String bkgNo, String blNo, String blTpCd, String blNoTp, String bkgVvd, String porCd, String polCd, String podCd, String delCd, String scNo, String rfaNo, String svcScpCd, String samCneeNtfyFlg, String agmtActCntCd, String agmtActCustSeq, String krCstmsCustTpCd, String custToOrdFlg, String orgCntNm, String ffRefNo, String fmcCd, String frobFlag, String nlFlag, String bkgStsCd, String caFlg, String indivPsonFlg, String obSlsOfcCd, String obSrepCd, String deTermCd, String jp24AlertFlg, String applDt, String eu24Flg, String docTpCd, String krCstmsCustTpCdUseFlg, String emlInfo) {
		this.applDt = applDt;
		this.porCd = porCd;
		this.krCstmsCustTpCdUseFlg = krCstmsCustTpCdUseFlg;
		...
		this.jp24AlertFlg = jp24AlertFlg;
		this.rfaNo = rfaNo;
		this.polCd = polCd;
		this.ibflag = ibflag;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("kr_cstms_cust_tp_cd_use_flg", getKrCstmsCustTpCdUseFlg());
		...
		this.hashColumns.put("jp24_alert_flg", getJp24AlertFlg());
		...
		this.hashColumns.put("eu24_flg", getEu24Flg());
		...
		this.hashColumns.put("eml_info", getEmlInfo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("kr_cstms_cust_tp_cd_use_flg", "krCstmsCustTpCdUseFlg");
		...
		this.hashFields.put("jp24_alert_flg", "jp24AlertFlg");
		...
		this.hashFields.put("eu24_flg", "eu24Flg");
		...
		this.hashFields.put("eml_info", "emlInfo");
	...
	/**
	 * Column Info
	 * @return krCstmsCustTpCdUseFlg
	 */
	public String getKrCstmsCustTpCdUseFlg() {
		return this.krCstmsCustTpCdUseFlg;
	}
	 ...
	 * @return jp24AlertFlg
	 */
	public String getJp24AlertFlg() {
		return this.jp24AlertFlg;
	}
	...
	/**
	 * Column Info
	 * @param krCstmsCustTpCdUseFlg
	 */
	public void setKrCstmsCustTpCdUseFlg(String krCstmsCustTpCdUseFlg) {
		this.krCstmsCustTpCdUseFlg = krCstmsCustTpCdUseFlg;
	}
	 ...
	 * @param jp24AlertFlg
	 */
	public void setJp24AlertFlg(String jp24AlertFlg) {
		this.jp24AlertFlg = jp24AlertFlg;
	}
	 ...
	 * @param emlInfo
	 */
	public void setEmlInfo(String emlInfo) {
		this.scNo = emlInfo;
	}
	 ...
	 * @param eu24Flg
	 */
	public void setEu24Flg(String eu24Flg) {
		this.eu24Flg = eu24Flg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setKrCstmsCustTpCdUseFlg(JSPUtil.getParameter(request, prefix + "kr_cstms_cust_tp_cd_use_flg", ""));
		...
		setJp24AlertFlg(JSPUtil.getParameter(request, prefix + "jp24_alert_flg", ""));
		...
		setEu24Flg(JSPUtil.getParameter(request, prefix + "eu24_flg", ""));
		...
		setEmlInfo(JSPUtil.getParameter(request, prefix + "eml_info", ""));
	}
	...
	public CustEtcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] krCstmsCustTpCdUseFlg = (JSPUtil.getParameter(request, prefix	+ "kr_cstms_cust_tp_cd_use_flg", length));
			...
			String[] jp24AlertFlg = (JSPUtil.getParameter(request, prefix	+ "jp24_alert_flg", length));
			...
			String[] eu24Flg = (JSPUtil.getParameter(request, prefix	+ "eu24_flg", length));
			...
			String[] emlInfo = (JSPUtil.getParameter(request, prefix	+ "eml_info", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (krCstmsCustTpCdUseFlg[i] != null)
					model.setKrCstmsCustTpCdUseFlg(krCstmsCustTpCdUseFlg[i]);
				if (bkgStsCd[i] != null)
				...
				if (jp24AlertFlg[i] != null)
					model.setJp24AlertFlg(jp24AlertFlg[i]);
				if (rfaNo[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.krCstmsCustTpCdUseFlg = this.krCstmsCustTpCdUseFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.jp24AlertFlg = this.jp24AlertFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.eu24Flg = this.eu24Flg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.emlInfo = this.emlInfo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
