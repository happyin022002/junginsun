...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList18RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList18RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_otr_ref 조회 하여 vsl_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList18RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList18RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    OTR_REF_DIV_CD = 'VSSL'" ).append("\n"); 
		query.append("AND    OTR_LVL_CD = '6' )) T START WITH NO = 1 CONNECT BY NOCYCLE PRIOR NO = NO - 1" ).append("\n"); 
