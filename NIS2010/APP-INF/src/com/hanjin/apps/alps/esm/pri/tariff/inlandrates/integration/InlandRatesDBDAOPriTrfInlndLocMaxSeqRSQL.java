...
*@FileName : InlandRatesDBDAOPriTrfInlndLocMaxSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRatesDBDAOPriTrfInlndLocMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Location Information  max seq를 조회한다.
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndLocMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndLocMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MAX(TRF_INLND_RT_SEQ), 0) TRF_INLND_RT_SEQ" ).append("\n"); 
