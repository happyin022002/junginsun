...
*@FileName : PSADeclBaseInfoVO.java
*@FileTitle : PSADeclBaseInfoVO
*Open Issues :
*Change history :
...
public class PSADeclBaseInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSADeclBaseInfoVO> models = new ArrayList<PSADeclBaseInfoVO>();
	...
	public PSADeclBaseInfoVO() {}

	public PSADeclBaseInfoVO(String ibflag, String pagerows, String docName, String declType, String handling, String status, String reason, String userRef, String oldUserRef, String firstUserRef, String secFileNbr, String ffRef) {
	 ...
	 */
	public PSADeclBaseInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSADeclBaseInfoVO[]
	 */
	public PSADeclBaseInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSADeclBaseInfoVO model = null;
	 ...
	 * @return PSADeclBaseInfoVO[]
	 */
	public PSADeclBaseInfoVO[] getPSADeclBaseInfoVOs(){
		PSADeclBaseInfoVO[] vos = (PSADeclBaseInfoVO[])models.toArray(new PSADeclBaseInfoVO[models.size()]);
		return vos;
	}
