...
*@FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtUsdRoutCsVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtUsdRoutCsVODSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from pri_sp_scp_rt_usd_rout_cs" ).append("\n"); 
