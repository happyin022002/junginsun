...
*@FileName : CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOUSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.profitabilitysimulation.cmsummary.integration").append("\n"); 
		query.append("FileName : CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_PRS_CTRT_SMRY_COST_TMP TBL" ).append("\n"); 
		...
		query.append("		" ).append("\n"); 
		query.append("#if (${virtual_query_tp_cd}== 'LOAD') " ).append("\n"); 
		query.append("		, ( PRS_CRNT_LOD_QTY +  DECODE(DT_CALC_TP_CD,'+', DT_AMOUNT , (PRS_CRNT_LOD_QTY  * DT_AMOUNT /100 ) ) ) AS SIMUL_DT" ).append("\n"); 
		query.append("#elseif (${virtual_query_tp_cd} == 'REV') " ).append("\n"); 
		query.append("		, ( TEU_FRT_REV +  DECODE(DT_CALC_TP_CD,'+', DT_AMOUNT , (TEU_FRT_REV  * DT_AMOUNT /100 ) ) ) AS SIMUL_DT" ).append("\n"); 
		query.append("#elseif (${virtual_query_tp_cd} == 'COST') " ).append("\n"); 
		query.append("			, ( PRS_RESPB_CM_UC_AMT +  DECODE(DT_CALC_TP_CD,'+', DT_AMOUNT , (PRS_RESPB_CM_UC_AMT  * DT_AMOUNT /100 ) ) ) AS SIMUL1_DT" ).append("\n"); 
		query.append("			, ( PRS_PFIT_CM_UC_AMT  +  DECODE(DT_CALC_TP_CD,'+', DT_AMOUNT , (PRS_PFIT_CM_UC_AMT   * DT_AMOUNT /100 ) ) ) AS SIMUL2_DT" ).append("\n"); 
		query.append("			, ( PRS_RESPB_OPFIT_UC_AMT  +  DECODE(DT_CALC_TP_CD,'+', DT_AMOUNT , (PRS_RESPB_OPFIT_UC_AMT   * DT_AMOUNT /100 ) ) ) AS SIMUL3_DT" ).append("\n"); 
		...
		query.append("			, SR_CST_DTL.PRS_CRNT_LOD_QTY  " ).append("\n"); 
		query.append("			, SR_CST_DTL.PRS_RESPB_CM_UC_AMT  " ).append("\n"); 
		query.append("			, SR_CST_DTL.PRS_PFIT_CM_UC_AMT " ).append("\n"); 
		query.append("			, SR_CST_DTL.PRS_RESPB_OPFIT_UC_AMT " ).append("\n"); 
		query.append("			, SR_CST_DTL.TEU_FRT_REV  " ).append("\n"); 
		query.append("			, SR_CST_DTL.PRS_RESPB_CMPB_AMT   " ).append("\n"); 
		query.append("			, SR_CST_DTL.PRS_PFIT_CMPB_AMT    " ).append("\n"); 
		...
		query.append("			AND DECODE(DT.RLANE_CD,'NULL',1, INSTR(DT.RLANE_CD,  SR_CST_DTL.RLANE_CD  )) > 0" ).append("\n"); 
		...
		query.append("#if (${virtual_query_tp_cd}== 'LOAD') " ).append("\n"); 
		query.append("		TBL.PRS_CRNT_LOD_QTY = RSLT.SIMUL_DT" ).append("\n"); 
		query.append("#elseif (${virtual_query_tp_cd} == 'REV') " ).append("\n"); 
		query.append("		TBL.TEU_FRT_REV = RSLT.SIMUL_DT" ).append("\n"); 
		query.append("#elseif (${virtual_query_tp_cd} == 'COST') " ).append("\n"); 
		query.append("		TBL.PRS_RESPB_CM_UC_AMT = RSLT.SIMUL1_DT" ).append("\n"); 
		query.append("		,TBL.PRS_PFIT_CM_UC_AMT = RSLT.SIMUL2_DT" ).append("\n"); 
		query.append("		,TBL.PRS_RESPB_OPFIT_UC_AMT = RSLT.SIMUL3_DT" ).append("\n"); 
		query.append("#end" ).append("\n"); 
