...
public class KrWharfageDecMgtDBDAOsearchKrWhfChgListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  FROM ( SELECT B.BKG_NO, B.BL_NO, B.BL_TP_CD, NVL(E.CUST_NM, 'SM Line Corporation CO., LTD') AS CUST_NM, F.CUST_NM AS XPT_REF_NO, D.BKG_RT_WHF_EXPT_CD, D.WHF_SHPR_RGST_NO, C.BL_CVRD_TP_CD" ).append("\n"); 
