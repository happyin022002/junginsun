...
*@FileName : BLDocumentationBLDBDAOCreateMkDescCACSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAOCreateMkDescCACSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLDocumentationBLDBDAOCreateMkDescCACSQL
	  * </pre>
	  */
	public BLDocumentationBLDBDAOCreateMkDescCACSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationBLDBDAOCreateMkDescCACSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
