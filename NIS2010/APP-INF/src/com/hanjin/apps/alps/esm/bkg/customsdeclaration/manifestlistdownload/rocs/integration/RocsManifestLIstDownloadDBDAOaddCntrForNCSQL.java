...
*@FileName : RocsManifestLIstDownloadDBDAOaddCntrForNCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestLIstDownloadDBDAOaddCntrForNCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestLIstDownloadDBDAOaddCntrForNCSQL(){
		setQuery();
		...
		query.append("FileName : RocsManifestLIstDownloadDBDAOaddCntrForNCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			 CNTR_NO, 	CNTR_TPSZ_CD, 	ISO_CNTR_TPSZ_CD, 	CNTR_TPSZ_DESC, CNTR_SEAL_NO," ).append("\n"); 
		...
		query.append("			 CRE_USR_ID, CRE_OFC_CD, UPD_DT, UPD_USR_ID,	CRE_DT,		T1_DOC_FLG)" ).append("\n"); 
		query.append("			 SELECT @[crn_number], 		CNTR.BKG_NO," ).append("\n"); 
		...
		query.append("			 		  CNTR.PCK_TP_CD,	NVL(PCK_QTY,0), 		PKG.PCK_NM," ).append("\n"); 
		query.append("			 		  WGT_UT_CD, NVL(CNTR_WGT,0), 		MEAS_UT_CD,	NVL(MEAS_QTY,0)," ).append("\n"); 
		query.append("					  @[user_id],@[ofc_cd],		sysdate,	@[user_id],	sysdate,	DOC_CMPL_FLG" ).append("\n"); 
		...
		query.append("			 WHERE (CNTR.BKG_NO) in (" ).append("\n"); 
		...
		query.append("             AND TPSZ.CNTR_TPSZ_ISO_CD = ISO.ISO_CNTR_TPSZ_CD(+)" ).append("\n"); 
