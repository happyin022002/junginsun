 ...
 *@FileName : ESM_BKG_1032HTMLAction.java
 ...
 * 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.eur.event;
 ...
 * @since J2EE 1.6
 */
public class ESM_BKG_1032HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1032HTMLAction 객체를 생성
	 */
	public ESM_BKG_1032HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1032Event event = new EsmBkg1032Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			
			event.setSendLogCondVO((SendLogCondVO) getVO(request, EurSearchSendLogCondVO.class));
		}
