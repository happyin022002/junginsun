...
*@FileName : SCRateProposalDBDAORsltRtListVerticalExcelVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtListVerticalExcelVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtListVerticalExcelVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtListVerticalExcelVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,B.FRC_USD_AMT" ).append("\n"); 
		...
		query.append("                         ,F.FRC_USD_AMT" ).append("\n"); 
		query.append("                     FROM (SELECT PROP_NO" ).append("\n"); 
		query.append("                                 ,AMDT_SEQ" ).append("\n"); 
		query.append("                                 ,SVC_SCP_CD" ).append("\n"); 
		query.append("                                 ,GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                                 ,G.FRC_USD_AMT" ).append("\n"); 
		query.append("                                 ,LPAD(T.CMDT_HDR_SEQ, 5, '0') || '|' || LPAD(T.ROUT_SEQ, 5, '0') || '|' ||" ).append("\n"); 
		...
		query.append("                                         ,G.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                                         ,MAX(DECODE(G.CHG_CD, 'FRC', G.ADJ_SCG_USD_AMT)) AS FRC_USD_AMT" ).append("\n"); 
		query.append("                                     FROM PRI_SP_SCP_RT_SCG G" ).append("\n"); 
		...
		query.append("                                      AND G.GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd]" ).append("\n"); 
