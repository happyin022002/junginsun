...
*@FileName : SendMessageListVO.java
*@FileTitle : SendMessageListVO
*Open Issues :
*Change history :
...
public class SendMailListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SendMailListVO> models = new ArrayList<SendMailListVO>();
	...
	public SendMailListVO() {}

	public SendMailListVO(String ibflag, String pagerows, String errorCode, String errMsg, String slsOfcCd, String trdCd, String subTrdCd, String rlaneCd, String vslCd, String skdVoyNo, String dirCd, String slsYrmon, String costWk, String contents, String usrId, String usrNm, String usrEml, String ofcCd, String fileKey) {
		this.vslCd = vslCd;
...
/**
	 ...
	 */
	public SendMailListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SendMailListVO[]
	 */
	public SendMailListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SendMailListVO model = null;
	 ...
	 * @return SendMailListVO[]
	 */
	public SendMailListVO[] getSendMailListVOs(){
		SendMailListVO[] vos = (SendMailListVO[])models.toArray(new SendMailListVO[models.size()]);
		return vos;
	}
