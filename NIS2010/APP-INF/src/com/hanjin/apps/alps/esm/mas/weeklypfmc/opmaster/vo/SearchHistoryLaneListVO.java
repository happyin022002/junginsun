...
public class SearchHistoryLaneListVO extends AbstractValueObject {
	...
	public SearchHistoryLaneListVO(String ibflag, String pagerows, String flag, String laneSeq, String trdCd, String subTrdCd, String slanCd, String rlaneCd, String dirCd, String iocCd, String vslLaneTpCd, String stupFlg, String vvdCd, String laneAplyFomDt, String laneAplyToDt, String updUsrId, String updDt, String opLaneTpCd) {
		this.iocCd = iocCd;
	...
	*/
	public void unDataFormat(){
		...
		this.opLaneTpCd = this.updDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
