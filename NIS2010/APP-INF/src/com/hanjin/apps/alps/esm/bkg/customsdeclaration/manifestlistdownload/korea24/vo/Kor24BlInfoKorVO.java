...
public class Kor24BlInfoKorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24BlInfoKorVO> models = new ArrayList<Kor24BlInfoKorVO>();
	...
	public Kor24BlInfoKorVO() {}

	public Kor24BlInfoKorVO(String ibflag, String pagerows, String cTrnsSeq,String dmstPortCd,String vvd, String bdAreaCd, String userId, String portCd, String inType, String ioBndCd, String podCd, String polCd, String podTml, String trnsSeq, String cstmsDeclTpCd, String bkgNo, String smtAmdNo, String cstmsBlNo) {
	...
	/**
	 * @param cstmsBlNo the cstmsBlNo to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCstmsBlNo(JSPUtil.getParameter(request, "cstms_bl_no", ""));
		setDmstPortCd(JSPUtil.getParameter(request, "dmst_port_cd", ""));
		setCTrnsSeq(JSPUtil.getParameter(request, "c_trns_seq", ""));
	}
	 ...
	 */
	public Kor24BlInfoKorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrBlVO[]
	 */
	public Kor24BlInfoKorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BlInfoKorVO model = null;
	 ...
	 * @return BkgCstmsKrBlVO[]
	 */
	public Kor24BlInfoKorVO[] getBkgCstmsKrBlVOs(){
		Kor24BlInfoKorVO[] vos = (Kor24BlInfoKorVO[])models.toArray(new Kor24BlInfoKorVO[models.size()]);
		return vos;
	}
