...
*@FileName : TCharterIOConsultationDBDAOCustomCsulSlpInterface2CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOCustomCsulSlpInterface2CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOCustomCsulSlpInterface2CSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOCustomCsulSlpInterface2CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	FLET_SRC_TP_CD " ).append("\n"); 
		query.append(",	VSL_CD         " ).append("\n"); 
		query.append(",  (SELECT SUBSTR(C.EFF_DT, 3, 4)" ).append("\n"); 
		query.append("    FROM FMS_CONSULTATION C" ).append("\n"); 
		query.append("    WHERE C.SLP_TP_CD||C.SLP_FUNC_CD||C.SLP_OFC_CD||C.SLP_ISS_DT||C.SLP_SER_NO = " ).append("\n"); 
		...
		query.append(",	LSG_GR_NO      " ).append("\n"); 
		query.append(",   SUBSTR(TO_INV_NO, 1, 4) || (SELECT SUBSTR(C.EFF_DT, 3, 4)" ).append("\n"); 
		query.append("                             FROM FMS_CONSULTATION C" ).append("\n"); 
		query.append("                             WHERE C.SLP_TP_CD||C.SLP_FUNC_CD||C.SLP_OFC_CD||C.SLP_ISS_DT||C.SLP_SER_NO = " ).append("\n"); 
		query.append("                                   S.SLP_TP_CD||S.SLP_FUNC_CD||S.SLP_OFC_CD||S.SLP_ISS_DT||S.SLP_SER_NO)" ).append("\n"); 
		query.append(",	AP_SLP_TP_CD   " ).append("\n"); 
