...
*@FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOCSQL.java
...
public class MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOCSQL(){
		setQuery();
		...
		query.append("FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
