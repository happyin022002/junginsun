...
*@FileName : Eur24ManifestDownloadDBDAOSearchBlCntrSealNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOSearchBlCntrSealNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BKG_1107에서 CNTR하위 SEAL정보를 가져오는 SQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOSearchBlCntrSealNoRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOSearchBlCntrSealNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
