...
*@FileName : SCQuotationMainDBDAOCheckExistRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCQuotationMainDBDAOCheckExistRateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * cmdt seq 별 rate 존재하는 지 체크(cmdt_rout 까지만 체크)
	  * </pre>
	  */
	public SCQuotationMainDBDAOCheckExistRateRSQL(){
		setQuery();
		...
		query.append("FileName : SCQuotationMainDBDAOCheckExistRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                FROM PRI_SQ_RT_CMDT_ROUT B" ).append("\n"); 
