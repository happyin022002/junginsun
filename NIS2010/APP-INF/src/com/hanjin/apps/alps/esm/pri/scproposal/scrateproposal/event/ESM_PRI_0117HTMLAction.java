 ...
 *@FileName : ESM_PRI_0117HTMLAction.java
...
public class ESM_PRI_0117HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0117Event event = new EsmPri0117Event();
