...
*@FileName : Kor24ManifestListDBDAOSearchMrnNoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchMrnNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchMrnNoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchMrnNoRSQL").append("\n");
		query.append("*/").append("\n");
	}
