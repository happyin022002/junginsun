...
*@FileName : Eur24ManifestDownloadDBDAOModifyBlCntrSealNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOModifyBlCntrSealNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOModifyBlCntrSealNoUSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOModifyBlCntrSealNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_EUR_SEAL_NO" ).append("\n"); 
