...
*@FileName : ESM_SAM_0303HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_SAM_0303HTMLAction extends HTMLActionSupport {

    /**
     * ESM_SAM_0301HTMLAction 객체를 생성
     */
    public ESM_SAM_0303HTMLAction() {
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_SAM_0303Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSam0303Event event = new EsmSam0303Event(cust_grp_id, cust_grp_nm, ofc_cd, iPage, mdm_yn, delt_flg,cust_grp_abbr_nm);            	
