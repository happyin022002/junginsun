...
*@FileName : WeeklyCMDBDAOCoaInterOwnTmlCostVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOCoaInterOwnTmlCostVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CoaInterOwnTmlCostVO delete
	  * </pre>
	  */
	public WeeklyCMDBDAOCoaInterOwnTmlCostVODSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOCoaInterOwnTmlCostVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM COA_INTER_OWN_TML_COST" ).append("\n"); 
