...
public class ESM_PRI_6046HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6046HTMLAction 객체를 생성
	 */
	public ESM_PRI_6046HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6046Event event = new EsmPri6046Event();
		
		//copy
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setRsltCopyToProposalVO((RsltCopyToProposalVO)getVO(request, RsltCopyToProposalVO .class));
		}
