...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyMinCommHisListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyMinCommHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add Agmt Copy Minimum Comm His List
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyMinCommHisListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyMinCommHisListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
