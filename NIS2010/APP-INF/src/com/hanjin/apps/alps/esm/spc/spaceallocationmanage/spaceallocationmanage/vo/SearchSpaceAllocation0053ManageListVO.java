...
public class SearchSpaceAllocation0053ManageListVO extends AbstractValueObject {
	...
	public SearchSpaceAllocation0053ManageListVO(String ibflag, String pagerows, String repTrdCd, String repSubTrdCd, String rlaneCd, String dirCd, String week, String vvd, String ctrlSpcFlg, String ctrl40ftHcFlg, String ctrl45ftHcFlg, String ctrl53ftFlg, String ctrlRfFlg, String ctrlPortFlg, String ctrlWgtFlg, String forVolum, String forHc, String forHc45, String for53ft, String forReefer, String forWeight, String acctGrpCtrlFlg, String ctrlD2flg, String ctrlD4flg, String ctrlRdFlg, String ctrlEccFlg, String ctrlLocFlg, String ctrlDestLvlCd, String ctrlUsaSvcModFlg, String ctrlAcctFlg) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAcctGrpCtrlFlg(JSPUtil.getParameter(request, "acct_grp_ctrl_flg", ""));
		setCtrlD2flg(JSPUtil.getParameter(request, "ctrl_d2_flg", ""));
		setCtrlD4flg(JSPUtil.getParameter(request, "ctrl_d4_flg", ""));
		setCtrlRdFlg(JSPUtil.getParameter(request, "ctrl_rd_flg", ""));
		setCtrlEccFlg(JSPUtil.getParameter(request, "ctrl_ecc_flg", ""));
		setCtrlLocFlg(JSPUtil.getParameter(request, "ctrl_loc_flg", ""));
		setCtrlDestLvlCd(JSPUtil.getParameter(request, "ctrl_dest_lvl_cd", ""));
		setCtrlUsaSvcModFlg(JSPUtil.getParameter(request, "ctrl_usa_svc_mod_flg", ""));
		setCtrlAcctFlg(JSPUtil.getParameter(request, "ctrl_acct_flg", ""));
	}
