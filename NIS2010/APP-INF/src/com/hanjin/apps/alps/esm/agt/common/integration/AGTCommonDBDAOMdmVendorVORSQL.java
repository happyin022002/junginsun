...
*@FileName : AGTCommonDBDAOMdmVendorVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCommonDBDAOMdmVendorVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCommonDBDAOMdmVendorVORSQL(){
		setQuery();
		...
		query.append("FileName : AGTCommonDBDAOMdmVendorVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
