...
*@FileName : ESM_BKG_1002HTMLAction.java
...
public class ESM_BKG_1002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1002HTMLAction 객체를 생성
	 */
	public ESM_BKG_1002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1002Event event = new EsmBkg1002Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setFmOfcCd(JSPUtil.getParameter(request, "fm_ofc_cd"));
			event.setFmPodCd(JSPUtil.getParameter(request, "fm_pod_cd"));
