...
*@FileName : ESM_BKG_1000HTMLAction.java
...
public class ESM_BKG_1000HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1000HTMLAction 객체를 생성
     */
    public ESM_BKG_1000HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg1000Event event = new EsmBkg1000Event();
        if(command.isCommand(FormCommand.MULTI)) {
            event.setBkgKorDoAttorneyVOs((KorDoAttorneyVO[])getVOs(request, KorDoAttorneyVO.class, "sheet1_"));
        }else if(command.isCommand(FormCommand.SEARCH)) {
            event.setBkgKorDoAttorneyVO((KorDoAttorneyVO)getVO(request, KorDoAttorneyVO.class));
        }
