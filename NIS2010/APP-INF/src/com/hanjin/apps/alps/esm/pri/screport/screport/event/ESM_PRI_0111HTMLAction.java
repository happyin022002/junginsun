...
*@FileName : ESM_PRI_0111HTMLAction.java
...
public class ESM_PRI_0111HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0111HTMLAction 객체를 생성
	 */
	public ESM_PRI_0111HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0111Event event = new EsmPri0111Event();
		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRsltSearchSCBlListVO((RsltSearchSCBlListVO)getVO(request, RsltSearchSCBlListVO.class));
		}
