...
public class TransshipmentMgtDBDAOsearchNextVvdForAssignRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        , to_char(next_skd_from.vps_etd_dt, 'yyyy-mm-dd hh') etd " ).append("\n"); 
		query.append("        , to_char(next_skd_to.vps_eta_dt,   'yyyy-mm-dd hh') eta " ).append("\n"); 
		query.append("        , rly_skd.vps_port_cd    ||substr(next_skd_from.yd_cd, 6, 2) relay_tmnl " ).append("\n"); 
		query.append("        , next_skd_from.clpt_ind_seq relay_seq" ).append("\n"); 
