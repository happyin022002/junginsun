...
public class ESM_BKG_0564HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0564HTMLAction 객체를 생성
	 */
	public ESM_BKG_0564HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0564Event event = new EsmBkg0564Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltUnmatchStatusReportVO((RsltUnmatchStatusReportVO)getVO(request, RsltUnmatchStatusReportVO .class));
		}
