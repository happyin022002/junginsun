...
*@FileName : SCReportDBDAOPriMotTrfMnDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAOPriMotTrfMnDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_MOT_TRF_MN Table Delete
	  * </pre>
	  */
	public SCReportDBDAOPriMotTrfMnDSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAOPriMotTrfMnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  PRI_MOT_TRF_MN" ).append("\n"); 
