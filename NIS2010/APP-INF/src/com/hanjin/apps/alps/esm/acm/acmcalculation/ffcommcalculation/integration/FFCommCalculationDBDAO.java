...
/**
 * ALPS FFCommCalculationDBDAO <br>
 * - ALPS-FFCalculation system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 *
...
public class FFCommCalculationDBDAO extends DBDAOSupport {
	...
	/**
	 * [ESM_ACM_0027]
	 * Canada FF Compensation 지급 대상인지를 확인 한다. <br>
	 *
	 * @param String bkg_no
	 * @return String
	 * @exception DAOException
	 */
	public String searchCanadaFFCmpn(String bkg_no) throws DAOException {
		DBRowSet dbRowset = null;
		String canadaFFCmpnChk = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new FFCommCalculationDBDAOSearchCanadaFFCmpnRSQL(), param, velParam);
			if (dbRowset.next()) {
				canadaFFCmpnChk = dbRowset.getString("CANADA_CHECK");
			}
...
//            }
	 ...
	 * @param String bkg_no
	 * @param String ff_bkg_rt
	 * @param String ff_chg_ctnt_div
	 * @return SearchFFBookingInfoVO
	 * @exception DAOException
	 */
	@SuppressWarnings("unchecked")
	public SearchFFBookingInfoVO searchCalcFFCommBSInfo(String bkg_no, String ff_bkg_rt, String ff_chg_ctnt_div) throws DAOException {
		DBRowSet dbRowset = null;
		SearchFFBookingInfoVO BkgInfo = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
	 ...
	 * @exception DAOException
	 */
	public void addFFCommChgDetailIFBS(SearchFFBookingInfoVO searchFFBookingInfoVO, String ff_chg_ctnt_div) throws DAOException {
		SQLExecuter sqlExe = new SQLExecuter("");
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
	 ...
	 * @exception DAOException
	 */
	public void addFFCommChgDetailBS(SearchFFBookingInfoVO searchFFBookingInfoVO, String ff_chg_ctnt_div) throws DAOException {
		SQLExecuter sqlExe = new SQLExecuter("");
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
	 ...
	 * [ESM_ACM_0027]
	 * FF Audit Re-Calculate <br>
	 * [CHM-201325292] 잘못나간 Compensation 회수로직 추가 요청(zero sum)
	 * @param String bkg_no
	 * @param String ff_cmpn_seq
	 * @return String
	 * @exception DAOException
	 ...
	 * @exception DAOException
	 */
	public String searchOldIfCnt(String bkg_no) throws DAOException {
		DBRowSet dbRowset = null;
		String oldIfCnt = ""; 
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new FFCommCalculationDBDAOSearchOldIfCntRSQL(), param, null);
			if (dbRowset.next()) {
				oldIfCnt = dbRowset.getString("OLD_IF_CNT");
			}
		} catch(SQLException se) {
			log.error(se.getMessage(), se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 * [ESM_ACM_0027]
	 * FF Audit Re-Calculate <br>
	 * FF Compensation 이 ERP 로 I/F 이후에 ACM_FAC_EXCLU_SET 을 등록 하여 지급하지 말아야 하는 Fowarder 로 등록 된 경우 - 커미션 생성 하여 ZeroSum 처리
	 * @param SearchFFBookingInfoVO searchFFBookingInfoVO
	 * @exception DAOException
	 */
	public void addFFCommZeroSumExclu(SearchFFBookingInfoVO searchFFBookingInfoVO) throws DAOException {
		SQLExecuter sqlExe = new SQLExecuter("");
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try {
			...
			int insCnt = sqlExe.executeUpdate((ISQLTemplate) new FFCommCalculationDBDAOAddFFCommZeroSumExcluCSQL(), param, null);
			if (insCnt == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to insert No" + " SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(), se);
