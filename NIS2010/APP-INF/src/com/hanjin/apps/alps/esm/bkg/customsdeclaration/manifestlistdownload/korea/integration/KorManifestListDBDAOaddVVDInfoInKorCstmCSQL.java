...
public class KorManifestListDBDAOaddVVDInfoInKorCstmCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		--DECODE(PORT_CD,'KRPUS','030197004','KRKAN','062112001','KRINC','020116001','KRPTK','016105001','KRUSN','110109004','KRGIN','020112001','030197004'), NULL, NULL," ).append("\n"); 
		query.append("        DECODE(KV.CSTMS_DCHG_CD, NULL, DECODE(KV.PORT_CD,'KRPUS','030197004','KRKAN','062112001','KRINC','020116001','KRPTK','016105001','KRUSN','110109004','KRGIN','020112001','030197004'), KV.CSTMS_DCHG_CD) CSTMS_DCHG_CD,      " ).append("\n"); 
		...
		query.append("AND		KV.IO_BND_CD	 = @[io_bnd_cd]" ).append("\n"); 
		query.append("AND     KV.VVD_SEQ       = (	SELECT 	MAX(VVD_SEQ) " ).append("\n"); 
