...
*@FileName : UsaHblCheckDetailVO.java
*@FileTitle : UsaHblCheckDetailVO
*Open Issues :
*Change history :
...
public class UsaHblCheckDetailVO extends HouseBlDetailVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaHblCheckDetailVO> models = new ArrayList<UsaHblCheckDetailVO>();
...
/**
	 ...
	 * @param request
	 * @return UsaHblCheckDetailVO[]
	 */
	public UsaHblCheckDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaHblCheckDetailVO[]
	 */
	public UsaHblCheckDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaHblCheckDetailVO model = null;
		...
		return getUsaHblCheckDetailVOs();
	}
	 ...
	 * @return UsaHblCheckDetailVO[]
	 */
	public UsaHblCheckDetailVO[] getUsaHblCheckDetailVOs(){
		UsaHblCheckDetailVO[] vos = (UsaHblCheckDetailVO[])models.toArray(new UsaHblCheckDetailVO[models.size()]);
		return vos;
	}
