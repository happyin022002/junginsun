...
public class OfficeMappingDBDAOSearchSectorOfcRelationSetListT2RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY A1.TRD_CD, A1.SUB_TRD_CD, IAS_RGN_CD, A1.RLANE_CD, A1.DIR_CD, A1.PF_GRP_CD, A1.RHQ_CD, A1.RGN_OFC_CD, A1.POL_CALL_SEQ ,A1.POD_CALL_SEQ" ).append("\n"); 
