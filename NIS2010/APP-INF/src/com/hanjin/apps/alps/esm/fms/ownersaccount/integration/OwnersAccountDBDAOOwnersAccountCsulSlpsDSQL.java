...
*@FileName : OwnersAccountDBDAOOwnersAccountCsulSlpsDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnersAccountDBDAOOwnersAccountCsulSlpsDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Owner's Account 상세 전표 삭제   
	  * </pre>
	  */
	public OwnersAccountDBDAOOwnersAccountCsulSlpsDSQL(){
		setQuery();
		...
		query.append("FileName : OwnersAccountDBDAOOwnersAccountCsulSlpsDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
