...
*@FileName : AncsManifestListDownloadDBDAOremoveBkgCstmsAnrBlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsManifestListDownloadDBDAOremoveBkgCstmsAnrBlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsManifestListDownloadDBDAOremoveBkgCstmsAnrBlDSQL(){
		setQuery();
		...
		query.append("FileName : AncsManifestListDownloadDBDAOremoveBkgCstmsAnrBlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
