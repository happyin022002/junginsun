...
*@FileName : SCNoteConversionProposalDBDAOPriScNoteConvListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteConversionProposalDBDAOPriScNoteConvListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriScNoteConvListVO 생성 쿼리
	  * </pre>
	  */
	public SCNoteConversionProposalDBDAOPriScNoteConvListVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.scproposal.scnoteconversionproposal.integration").append("\n"); 
		query.append("FileName : SCNoteConversionProposalDBDAOPriScNoteConvListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", '' CONV_DEST_LOC_CNT_CD" ).append("\n"); 
		...
		query.append(", '' CONV_DEST_VIA_LOC_CNT_CD" ).append("\n"); 
		...
		query.append(", '' CONV_ORG_VIA_LOC_CNT_CD" ).append("\n"); 
		...
		query.append(", '' CONV_ORG_LOC_CNT_CD" ).append("\n"); 
