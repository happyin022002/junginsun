...
*@FileName : UsaCntrSealNoListRsltVO.java
*@FileTitle : UsaCntrSealNoListRsltVO
*Open Issues :
*Change history :
...
public class UsaCntrSealNoListRsltVO extends ContainerListRsltVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaCntrSealNoListRsltVO> models = new ArrayList<UsaCntrSealNoListRsltVO>();
	...
	public UsaCntrSealNoListRsltVO() {}

	public UsaCntrSealNoListRsltVO(String ibflag, String pagerows, String blNo, String cntrNo, String sealNoSeq, String sealNo) {
		this.sealNo = sealNo;
		this.ibflag = ibflag;
		this.cntrNo = cntrNo;
	 ...
	 * @param request
	 * @return UsaCntrSealNoListRsltVO[]
	 */
	public UsaCntrSealNoListRsltVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaCntrSealNoListRsltVO[]
	 */
	public UsaCntrSealNoListRsltVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaCntrSealNoListRsltVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaCntrSealNoListRsltVO();
				if (sealNo[i] != null)
		...
		return getUsaCntrSealNoListRsltVOs();
	}
	 ...
	 * @return UsaCntrSealNoListRsltVO[]
	 */
	public UsaCntrSealNoListRsltVO[] getUsaCntrSealNoListRsltVOs(){
		UsaCntrSealNoListRsltVO[] vos = (UsaCntrSealNoListRsltVO[])models.toArray(new UsaCntrSealNoListRsltVO[models.size()]);
		return vos;
	}
