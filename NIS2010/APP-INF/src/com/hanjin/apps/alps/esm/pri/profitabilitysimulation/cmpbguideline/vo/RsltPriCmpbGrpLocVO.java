...
*@FileName : RsltPriCmpbGrpLocVO.java
*@FileTitle : RsltPriCmpbGrpLocVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGrpLocVO> models = new ArrayList<RsltPriCmpbGrpLocVO>();
	...
	public RsltPriCmpbGrpLocVO() {}

	public RsltPriCmpbGrpLocVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String grpLocSeq, String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriCmpbGrpLocVO[]
	 */
	public RsltPriCmpbGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGrpLocVO[]
	 */
	public RsltPriCmpbGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGrpLocVO model = null;
		...
		return getRsltPriCmpbGrpLocVOs();
	}
	 ...
	 * @return RsltPriCmpbGrpLocVO[]
	 */
	public RsltPriCmpbGrpLocVO[] getRsltPriCmpbGrpLocVOs(){
		RsltPriCmpbGrpLocVO[] vos = (RsltPriCmpbGrpLocVO[])models.toArray(new RsltPriCmpbGrpLocVO[models.size()]);
		return vos;
	}
