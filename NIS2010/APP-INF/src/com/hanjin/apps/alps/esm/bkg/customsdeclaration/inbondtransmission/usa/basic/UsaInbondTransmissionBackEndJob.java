...
public class UsaInbondTransmissionBackEndJob extends BackEndCommandSupport {
	...
	public void setMibTransmitVO(MibTransmitVO[] mibTransmitVO){
		if(mibTransmitVO != null){
			MibTransmitVO[] tmpVOs = Arrays.copyOf(mibTransmitVO, mibTransmitVO.length);
			this.mibTransmitVO = tmpVOs;
		}
	}
	...
	public Object doStart() throws Exception {
		...
		{
			InbondTransmissionBC command = new UsaInbondTransmissionBCImpl();
