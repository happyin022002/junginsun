...
*@FileName : ESM_BKG_1409HTMLAction.java
...
public class ESM_BKG_1409HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1409HTMLAction 객체를 생성
	 */
	public ESM_BKG_1409HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1409Event event = new EsmBkg1409Event();
		log.debug("***** ESM_BKG_1409HTMLAction : " + command.getCommand());
