...
*@FileName : TariffRuleDBDAOPriTrfRulePublishCancleUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffRuleDBDAOPriTrfRulePublishCancleUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *                                                         - Publish Cacel할 데이터의 수정내역 반영
	  * </pre>
	  */
	public TariffRuleDBDAOPriTrfRulePublishCancleUSQL(){
		setQuery();
		...
		query.append("FileName : TariffRuleDBDAOPriTrfRulePublishCancleUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , PUB_DT				= TO_DATE(@[pub_dt], 'YYYYMMDD')" ).append("\n"); 
