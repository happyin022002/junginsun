...
*@FileName : CndExpManifestListDownloadDBDAOsearchContainerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchContainerListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchContainerListRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchContainerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    BKG_CSTMS_AMER_CNTR C" ).append("\n"); 
		query.append("       ,BKG_CSTMS_AMER_CNTR_MF M" ).append("\n"); 
