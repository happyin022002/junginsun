...
*@FileName : ESM_BKG_0654HTMLAction.java
...
public class ESM_BKG_0654HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0654HTMLAction 객체를 생성
	 */
	public ESM_BKG_0654HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0654Event event = new EsmBkg0654Event();
