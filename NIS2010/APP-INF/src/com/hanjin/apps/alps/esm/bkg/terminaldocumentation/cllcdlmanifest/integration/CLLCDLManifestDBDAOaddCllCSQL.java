...
public class CLLCDLManifestDBDAOaddCllCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	NVL(DECODE(@[rc_flg],'1','Y','0','N',@[rc_flg]),'N')" ).append("\n"); 
		query.append(",	NVL(DECODE(@[dcgo_flg],'1','Y','0','N',@[dcgo_flg]),'N')" ).append("\n"); 
		query.append(",	NVL(DECODE(@[awk_cgo_flg],'1','Y','0','N',@[awk_cgo_flg]),'N')" ).append("\n"); 
		query.append(",	NVL(DECODE(@[bb_cgo_flg],'1','Y','0','N',@[bb_cgo_flg]),'N')" ).append("\n"); 
		query.append(",	NVL(DECODE(@[rd_cgo_flg],'1','Y','0','N',@[rd_cgo_flg]),'N')" ).append("\n"); 
		query.append(",	@[list_rmk]" ).append("\n"); 
		query.append(",	@[edi_rcv_sts_cd]" ).append("\n"); 
		query.append(",	@[bl_rmk]" ).append("\n"); 
		query.append(",	@[flt_file_ref_no]" ).append("\n"); 
