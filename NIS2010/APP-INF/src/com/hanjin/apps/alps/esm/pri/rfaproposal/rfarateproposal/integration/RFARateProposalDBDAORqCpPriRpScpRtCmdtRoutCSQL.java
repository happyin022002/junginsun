...
*@FileName : RFARateProposalDBDAORqCpPriRpScpRtCmdtRoutCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORqCpPriRpScpRtCmdtRoutCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RqCpPriRpScpRtCmdtRout
	  * </pre>
	  */
	public RFARateProposalDBDAORqCpPriRpScpRtCmdtRoutCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORqCpPriRpScpRtCmdtRoutCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    EXISTS (" ).append("\n"); 
		query.append("        SELECT 'X'" ).append("\n"); 
		query.append("        FROM PRI_RQ_RT_ROUT_PNT M" ).append("\n"); 
