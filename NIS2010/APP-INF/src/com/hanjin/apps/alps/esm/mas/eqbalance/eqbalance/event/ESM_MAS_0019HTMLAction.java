...
*@FileName : ESM_MAS_0019HTMLAction.java
*@FileTitle : Repo U/C 
*Open Issues :
*Change history :
...
public class ESM_MAS_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0019HTMLAction 객체를 생성
	 */
	public ESM_MAS_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0019Event event = new EsmMas0019Event();
