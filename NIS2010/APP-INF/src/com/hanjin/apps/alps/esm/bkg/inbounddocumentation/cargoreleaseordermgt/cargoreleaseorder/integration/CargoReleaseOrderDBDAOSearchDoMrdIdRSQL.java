...
public class CargoReleaseOrderDBDAOSearchDoMrdIdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          , CASE WHEN USR.CONTI_CD IN ('AF','EN','EC','AW','AE') THEN USR.CONTI_CD" ).append("\n"); 
		query.append("                 ELSE '*' END                                             AS CONTI_CD" ).append("\n"); 
		query.append("          " ).append("\n"); 
		query.append("          , CASE WHEN USR.CNT_CD IN ('KR','JP','IN','VN','BD')   THEN USR.CNT_CD" ).append("\n"); 
