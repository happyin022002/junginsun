...
*@FileName : ESM_BKG_066805HTMLAction.java
...
public class ESM_BKG_066805HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_066805HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg066805Event event = new EsmBkg066805Event();
        ...
        log.debug("===================================");
        log.debug("    ESM_BKG_066805HTMLAction Start ");
        log.debug("===================================");
        ...
        if(command.isCommand(FormCommand.SEARCH)) {
        	//***********************************************************
        	//2009-08-12 Son Yun Seuk 추가(Customs Result Tab = SEARCH)
        	//***********************************************************
            if (blNo.isEmpty() == false) {						//안진응 수정(공통 적용하는 부분임)
