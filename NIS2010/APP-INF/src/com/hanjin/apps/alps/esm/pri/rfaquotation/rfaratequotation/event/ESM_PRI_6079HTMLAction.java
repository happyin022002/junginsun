...
*@FileName : ESM_PRI_6050HTMLAction.java
...
public class ESM_PRI_6079HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6079HTMLAction 객체를 생성
	 */
	public ESM_PRI_6079HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6079Event event = new EsmPri6079Event();
 	
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltPriSurchargeAdjustCommodityVO((RsltPriSurchargeAdjustCommodityVO)getVO(request, RsltPriSurchargeAdjustCommodityVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH02)) {
				event.setRsltPriSurchargeAdjustCommodityDetailVO((RsltPriSurchargeAdjustCommodityDetailVO)getVO(request, RsltPriSurchargeAdjustCommodityDetailVO .class));
		}		
