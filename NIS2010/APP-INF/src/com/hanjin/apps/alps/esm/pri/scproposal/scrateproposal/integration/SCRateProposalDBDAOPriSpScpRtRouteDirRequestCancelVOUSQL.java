...
*@FileName : SCRateProposalDBDAOPriSpScpRtRouteDirRequestCancelVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRouteDirRequestCancelVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRouteDirRequestCancelVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRouteDirRequestCancelVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
