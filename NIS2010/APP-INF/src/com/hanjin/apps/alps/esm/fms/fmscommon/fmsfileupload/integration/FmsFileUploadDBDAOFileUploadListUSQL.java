...
*@FileName : FmsFileUploadDBDAOFileUploadListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FmsFileUploadDBDAOFileUploadListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FmsFileUploadDBDAOFileUploadListUSQL
	  * </pre>
	  */
	public FmsFileUploadDBDAOFileUploadListUSQL(){
		setQuery();
		...
		query.append("FileName : FmsFileUploadDBDAOFileUploadListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE FMS_ATCH_FILE" ).append("\n"); 
