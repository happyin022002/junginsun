...
public class SearchBookingTrendReportVO extends AbstractValueObject {
	...
	/* Column Info */
	private String podCdTrunk = null;	
	/* Column Info */
	...
	/* Column Info */
	private String d15 = null;
	/* Column Info */
	private String d16 = null;
	/* Column Info */
	private String d17 = null;
	/* Column Info */
	private String d18 = null;
	/* Column Info */
	private String d19 = null;
	/* Column Info */
	private String d20 = null;
	/* Column Info */
	private String d21 = null;
	/* Column Info */
	private String d22 = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pod_cd_trunk", getPodCdTrunk());
		...
		this.hashColumns.put("d_15", getD15());
		this.hashColumns.put("d_16", getD16());
		this.hashColumns.put("d_17", getD17());
		this.hashColumns.put("d_18", getD18());
		this.hashColumns.put("d_19", getD19());
		this.hashColumns.put("d_20", getD20());
		this.hashColumns.put("d_21", getD21());
		this.hashColumns.put("d_22", getD22());
		this.hashColumns.put("d_23", getD23());
		this.hashColumns.put("d_24", getD24());
		this.hashColumns.put("d_25", getD25());
		this.hashColumns.put("d_26", getD26());
		this.hashColumns.put("d_27", getD27());
		this.hashColumns.put("d_28", getD28());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pod_cd_trunk", "podCdTrunk");
		...
		this.hashFields.put("d_15", "d15");
		this.hashFields.put("d_16", "d16");
		this.hashFields.put("d_17", "d17");
		this.hashFields.put("d_18", "d18");
		this.hashFields.put("d_19", "d19");
		this.hashFields.put("d_20", "d20");
		this.hashFields.put("d_21", "d21");
		this.hashFields.put("d_22", "d22");
		this.hashFields.put("d_23", "d23");
		this.hashFields.put("d_24", "d24");
		this.hashFields.put("d_25", "d25");
		this.hashFields.put("d_26", "d26");
		this.hashFields.put("d_27", "d27");
		this.hashFields.put("d_28", "d28");		
	 ...
	 * @return podCdTrunk
	 */
	public String getPodCdTrunk() {
		return this.podCdTrunk;
	}	
	 ...
	 * @param podCdTrunk
	 */
	public void setPodCdTrunk(String podCdTrunk) {
		this.podCdTrunk = podCdTrunk;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPodCdTrunk(JSPUtil.getParameter(request, prefix + "pod_cd_trunk", ""));
		...
		setD15(JSPUtil.getParameter(request, "d_15", ""));
		setD16(JSPUtil.getParameter(request, "d_16", ""));
		setD17(JSPUtil.getParameter(request, "d_17", ""));
		setD18(JSPUtil.getParameter(request, "d_18", ""));
		setD19(JSPUtil.getParameter(request, "d_19", ""));
		setD20(JSPUtil.getParameter(request, "d_20", ""));
		setD21(JSPUtil.getParameter(request, "d_21", ""));
		setD22(JSPUtil.getParameter(request, "d_22", ""));
		setD23(JSPUtil.getParameter(request, "d_23", ""));
		setD24(JSPUtil.getParameter(request, "d_24", ""));
		setD25(JSPUtil.getParameter(request, "d_25", ""));
		setD26(JSPUtil.getParameter(request, "d_26", ""));
		setD27(JSPUtil.getParameter(request, "d_27", ""));
		setD28(JSPUtil.getParameter(request, "d_28", ""));		
	...
	public SearchBookingTrendReportVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] podCdTrunk = (JSPUtil.getParameter(request, prefix	+ "pod_cd_trunk", length));
			...
			String[] d15 = (JSPUtil.getParameter(request, prefix	+ "d_15", length));
			String[] d16 = (JSPUtil.getParameter(request, prefix	+ "d_16", length));
			String[] d17 = (JSPUtil.getParameter(request, prefix	+ "d_17", length));
			String[] d18 = (JSPUtil.getParameter(request, prefix	+ "d_18", length));
			String[] d19 = (JSPUtil.getParameter(request, prefix	+ "d_19", length));
			String[] d20 = (JSPUtil.getParameter(request, prefix	+ "d_20", length));
			String[] d21 = (JSPUtil.getParameter(request, prefix	+ "d_21", length));
			String[] d22 = (JSPUtil.getParameter(request, prefix	+ "d_22", length));
			String[] d23 = (JSPUtil.getParameter(request, prefix	+ "d_23", length));
			String[] d24 = (JSPUtil.getParameter(request, prefix	+ "d_24", length));
			String[] d25 = (JSPUtil.getParameter(request, prefix	+ "d_25", length));
			String[] d26 = (JSPUtil.getParameter(request, prefix	+ "d_26", length));
			String[] d27 = (JSPUtil.getParameter(request, prefix	+ "d_27", length));
			String[] d28 = (JSPUtil.getParameter(request, prefix	+ "d_28", length));	
			...
			for (int i = 0; i < length; i++) {
				...
				if (podCdTrunk[i] != null)
					model.setPodCdTrunk(podCdTrunk[i]);				
				if (d12[i] != null)
					model.setD12(d12[i]);
				if (d11[i] != null)
					model.setD11(d11[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.podCdTrunk = this.podCdTrunk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.d15  = this.d15 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d16  = this.d16 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d17  = this.d17 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d18  = this.d18 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d19  = this.d19 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d20  = this.d20 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d21  = this.d21 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d22  = this.d22 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d23  = this.d23 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d24  = this.d24 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d25  = this.d25 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d26  = this.d26 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d27  = this.d27 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.d28  = this.d28 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
