...
*@FileName : CalculateDBDAOPriPrsUsdRoutActCostSimulationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CalculateDBDAOPriPrsUsdRoutActCostSimulationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CalculateDBDAOPriPrsUsdRoutActCostSimulationCSQL(){
		setQuery();
		...
		query.append("FileName : CalculateDBDAOPriPrsUsdRoutActCostSimulationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		AND ( ESTM_USD_UC_AMT <> 0 OR RESPB_USD_UC_AMT <> 0 OR ESTM_USD_TTL_AMT <> 0  OR RESPB_USD_TTL_AMT <> 0 ) -- 전부0인것은 제외" ).append("\n"); 
