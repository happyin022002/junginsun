...
*@FileName : UsaContainerListVO.java
*@FileTitle : UsaContainerListVO
*Open Issues :
*Change history :
...
public class UsaContainerListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaContainerListVO> models = new ArrayList<UsaContainerListVO>();
	...
	public UsaContainerListVO() {}

	public UsaContainerListVO(String ibflag, String pagerows, String blNo, String cntrNo, String cntrTpszCd, String ibdCntrStsCd, String sealNo, String cntrMfFlag) {
		this.sealNo = sealNo;
		this.ibflag = ibflag;
		this.cntrNo = cntrNo;
	 ...
	 * @param request
	 * @return UsaContainerListVO[]
	 */
	public UsaContainerListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaContainerListVO[]
	 */
	public UsaContainerListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaContainerListVO model = null;
	 ...
	 * @return UsaContainerListVO[]
	 */
	public UsaContainerListVO[] getUsaContainerListVOs(){
		UsaContainerListVO[] vos = (UsaContainerListVO[])models.toArray(new UsaContainerListVO[models.size()]);
		return vos;
	}
