...
*@FileName : Kor24MsnNoCondVO.java
*@FileTitle : Kor24MsnNoCondVO
*Open Issues :
*Change history :
...
public class Kor24MsnNoCondVO extends MsnNoCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24MsnNoCondVO> models = new ArrayList<Kor24MsnNoCondVO>();
	...
	public Kor24MsnNoCondVO() {}

	public Kor24MsnNoCondVO(String ibflag, String pagerows, String msnStartNum, String inVvd, String inPod, String tp, String fe, String blNo, String bkgNo, String hidden3, String pod, String msn) {
		this.inVvd = inVvd;
		this.inPod = inPod;
		this.bkgNo = bkgNo;
...
/**
	 ...
	 * @param request
	 * @return Kor24MsnNoCondVO[]
	 */
	public Kor24MsnNoCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24MsnNoCondVO[]
	 */
	public Kor24MsnNoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24MsnNoCondVO model = null;
	...
	public Kor24MsnNoCondVO[] getKor24MsnNoCondVOs(){
		Kor24MsnNoCondVO[] vos = (Kor24MsnNoCondVO[])models.toArray(new Kor24MsnNoCondVO[models.size()]);
		return vos;
	}
