...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op5ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op5ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op5ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op5ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		   ,16, ((INCOME_TOTAL - CM_COST) - N5TH_HJS_SLS_AMT - N5TH_CO_AMT - CMMT_COST - INTER_TS)   /* CMMT0001 */" ).append("\n"); 
		...
		query.append("			,SUM (N5TH_HJS_SLS_AMT) N5TH_HJS_SLS_AMT " ).append("\n"); 
		...
		query.append("				         ) " ).append("\n"); 
		query.append("				    ,0 " ).append("\n"); 
		query.append("				    ) AS N5TH_HJS_SLS_AMT " ).append("\n"); 
		query.append("				,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("				,0 N5TH_HJS_SLS_AMT " ).append("\n"); 
