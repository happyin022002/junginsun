...
*@FileName : RFAQuotationMainDBDAORsltPriRqMnVOReportRSQLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAQuotationMainDBDAORsltPriRqMnVOReportRSQLRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAORsltPriRqMnVOReportRSQLRSQL(){
		setQuery();
		...
		query.append("FileName : RFAQuotationMainDBDAORsltPriRqMnVOReportRSQLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	TO_CHAR(DECODE(B.CNTR_LOD_UT_CD, 'F', NVL(B.ESTM_MQC_QTY,0)*0.5, B.ESTM_MQC_QTY),'999,999,999') AS ESTM_MQC_QTY" ).append("\n"); 
		...
		query.append("	 AND    INTG_CD_VAL_CTNT = B.PRC_CUST_TP_CD) AS PRC_CUST_TP_CD          --PRC_CUST_TP_CD 명" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${prc_cust_tp_cd} != '' && ${prc_cust_tp_cd} != 'M')" ).append("\n"); 
