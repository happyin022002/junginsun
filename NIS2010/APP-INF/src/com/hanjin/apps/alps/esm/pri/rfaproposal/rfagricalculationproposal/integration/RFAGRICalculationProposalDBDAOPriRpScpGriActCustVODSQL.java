...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriActCustVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriActCustVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriActCustVO Delete
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriActCustVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriActCustVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RP_SCP_GRI_ACT_CUST" ).append("\n"); 
