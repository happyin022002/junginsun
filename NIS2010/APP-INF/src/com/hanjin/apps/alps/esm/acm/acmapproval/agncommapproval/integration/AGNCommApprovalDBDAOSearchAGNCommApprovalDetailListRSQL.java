...
public class AGNCommApprovalDBDAOSearchAGNCommApprovalDetailListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       DECODE(A.AC_TP_CD, 'G', 1, 'K', 2, 'H', 3, 'S', 4, 'C',  6, 7) AS AC_TP_CD_SEQ," ).append("\n"); 
		query.append("       DECODE(A.AC_TP_CD, 'G', 'General', 'K', 'Brokerage', 'H', 'CHF', 'S', 'T/S', 'C', 'Cross', 'Others') AS AC_TP_CD," ).append("\n"); 
