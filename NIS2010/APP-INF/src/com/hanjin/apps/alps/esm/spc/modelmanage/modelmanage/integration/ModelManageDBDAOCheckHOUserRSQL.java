...
*@FileName : ModelManageDBDAOCheckHOUserRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAOCheckHOUserRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 입력하는 사람이 본사 소속인지 확인합니다.
	  * </pre>
	  */
	public ModelManageDBDAOCheckHOUserRSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAOCheckHOUserRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND U.OFC_CD <> 'SELCTY' --TEMP 지역본부로 인지" ).append("\n"); 
