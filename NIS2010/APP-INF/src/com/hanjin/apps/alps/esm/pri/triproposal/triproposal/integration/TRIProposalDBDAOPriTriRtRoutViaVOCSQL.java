...
*@FileName : TRIProposalDBDAOPriTriRtRoutViaVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtRoutViaVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_ROUT_VIA INSERT
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtRoutViaVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtRoutViaVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRI_RT_ROUT_VIA (" ).append("\n"); 
