...
public class LogisticsRPTDBDAOSearchLogisticsRPT0158ListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("CONV_COA_OFC_LVL AS " ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	    FROM  COA_OFC_LVL LVL_CURR" ).append("\n"); 
		query.append("	    " ).append("\n"); 
		query.append("	) CURR , COA_OFC_LVL LVL" ).append("\n"); 
		...
		query.append("          ,COA_BKG_EXPN_DTL_WK A" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("          ,MDM_LOCATION E" ).append("\n"); 
		query.append("          ,CONV_COA_OFC_LVL F" ).append("\n"); 
		query.append("          ,MDM_LOCATION G" ).append("\n"); 
		query.append("          ,CONV_COA_OFC_LVL H" ).append("\n"); 
