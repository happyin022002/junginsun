...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutViaAllDSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutViaAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutViaAllDSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutViaAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
