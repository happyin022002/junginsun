...
*@FileName : ESM_PRI_6023HTMLAction.java
...
public class ESM_PRI_6023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6023HTMLAction 객체를 생성
	 */
	public ESM_PRI_6023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri6023Event event = new EsmPri6023Event();
		return  event;
	}
