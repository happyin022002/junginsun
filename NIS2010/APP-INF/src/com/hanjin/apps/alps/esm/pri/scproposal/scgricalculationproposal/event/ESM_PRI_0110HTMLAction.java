 ...
 *@FileName : ESM_PRI_0110HTMLAction.java
...
public class ESM_PRI_0110HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0110Event event = new EsmPri0110Event();
