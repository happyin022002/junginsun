...
*@FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtRoutDirCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOGlineCopyPriSpScpRtRoutDirCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_SP_SCP_RT_ROUT_DIR Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOGlineCopyPriSpScpRtRoutDirCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtRoutDirCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
