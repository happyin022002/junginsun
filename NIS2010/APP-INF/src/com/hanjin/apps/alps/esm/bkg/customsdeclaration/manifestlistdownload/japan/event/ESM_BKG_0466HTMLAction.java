...
*@FileName : ESM_BKG_0466HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0466HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0466HTMLAction 객체를 생성 
	 */
	public ESM_BKG_0466HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0466Event event = new EsmBkg0466Event();
