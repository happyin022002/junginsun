...
public class EsmPri200302Event extends EventSupport {
	...
	public PriRpScpGrpLocDtlVO[] getPriRpScpGrpLocDtlVOS(){
		PriRpScpGrpLocDtlVO[] rtnVOs = null;
		if (this.priRpScpGrpLocDtlVOs != null) {
			rtnVOs = new PriRpScpGrpLocDtlVO[priRpScpGrpLocDtlVOs.length];
			System.arraycopy(priRpScpGrpLocDtlVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public PriRpScpGrpLocVO[] getPriRpScpGrpLocVOS(){
		PriRpScpGrpLocVO[] rtnVOs = null;
		if (this.priRpScpGrpLocVOs != null) {
			rtnVOs = new PriRpScpGrpLocVO[priRpScpGrpLocVOs.length];
			System.arraycopy(priRpScpGrpLocVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
