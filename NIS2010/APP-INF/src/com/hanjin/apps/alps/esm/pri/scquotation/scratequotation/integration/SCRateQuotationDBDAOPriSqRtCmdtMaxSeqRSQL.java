...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtMaxSeqRSQL.java
...
public class SCRateQuotationDBDAOPriSqRtCmdtMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
