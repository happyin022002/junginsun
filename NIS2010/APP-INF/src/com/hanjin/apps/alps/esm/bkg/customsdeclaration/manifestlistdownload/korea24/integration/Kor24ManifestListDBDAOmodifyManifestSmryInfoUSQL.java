...
*@FileName : Kor24ManifestListDBDAOmodifyManifestSmryInfoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyManifestSmryInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyManifestSmryInfoUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyManifestSmryInfoUSQL").append("\n");
		query.append("*/").append("\n");
	}
