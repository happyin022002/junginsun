 ...
 * @since J2EE 1.4
 */
public class ESM_AGT_0058HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0058Event event = new EsmAgt0058Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setAgtCmpnCustMtchVO((AgtCmpnCustMtchVO)getVO(request, AgtCmpnCustMtchVO.class));
		}
		if(command.isCommand(FormCommand.MULTI)){
			event.setAgtCmpnCustMtchVOs((AgtCmpnCustMtchVO[])getVOs(request, AgtCmpnCustMtchVO .class,""));
		}
