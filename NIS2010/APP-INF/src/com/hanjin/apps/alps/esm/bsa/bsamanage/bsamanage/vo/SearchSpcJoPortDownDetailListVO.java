...
*@FileName : SearchSpcJoPortDownDetailListVO.java
*@FileTitle : SearchSpcJoPortDownDetailListVO
*Open Issues :
*Change history :
...
public class SearchSpcJoPortDownDetailListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSpcJoPortDownDetailListVO> models = new ArrayList<SearchSpcJoPortDownDetailListVO>();
	...
	public SearchSpcJoPortDownDetailListVO() {}

	public SearchSpcJoPortDownDetailListVO(String ibflag, String pagerows, String bsaSeq, String trdCd, String rlaneCd, String dirCd, String vopCd, String vslCapa, String bsaOpCd, String bsaOpJbCd, String crrCd, String portSeq, String portCd, String portBsaCapa) {
		this.vopCd = vopCd;
		this.trdCd = trdCd;
	 ...
	 * @param request
	 * @return SearchSpcJoPortDownDetailListVO[]
	 */
	public SearchSpcJoPortDownDetailListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSpcJoPortDownDetailListVO[]
	 */
	public SearchSpcJoPortDownDetailListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSpcJoPortDownDetailListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSpcJoPortDownDetailListVO();
				if (vopCd[i] != null)
		...
		return getSearchSpcJoPortDownDetailListVOs();
	}
	 ...
	 * @return SearchSpcJoPortDownDetailListVO[]
	 */
	public SearchSpcJoPortDownDetailListVO[] getSearchSpcJoPortDownDetailListVOs(){
		SearchSpcJoPortDownDetailListVO[] vos = (SearchSpcJoPortDownDetailListVO[])models.toArray(new SearchSpcJoPortDownDetailListVO[models.size()]);
		return vos;
	}
