...
*@FileName : ESM_MAS_0115HTMLAction.java
...
public class ESM_MAS_0115HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0115HTMLAction 객체를 생성
	 */
	public ESM_MAS_0115HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0115Event event = new EsmMas0115Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchEMUPfmcListVO((SearchEMUPfmcListVO)getVO(request, SearchEMUPfmcListVO .class));
