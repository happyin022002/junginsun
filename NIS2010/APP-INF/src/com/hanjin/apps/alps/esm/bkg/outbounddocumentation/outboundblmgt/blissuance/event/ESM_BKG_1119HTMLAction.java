...
*@FileName : ESM_BKG_1119HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_1119HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1119HTMLAction 객체를 생성
	 */
	public ESM_BKG_1119HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBlIssRqstVO((BlIssRqstVO)getVO(request, BlIssRqstVO.class));
		}
		else if(command.isCommand(FormCommand.MODIFY01)) {
			event.setBlIssRqstVOs((BlIssRqstVO[])getVOs(request, BlIssRqstVO.class, ""));
		}
