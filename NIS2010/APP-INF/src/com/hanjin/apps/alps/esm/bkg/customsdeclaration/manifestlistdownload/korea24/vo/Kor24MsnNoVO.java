...
*@FileName : Kor24MsnNoVO.java
*@FileTitle : Kor24MsnNoVO
*Open Issues :
*Change history :
...
public class Kor24MsnNoVO extends MsnNoVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24MsnNoVO> models = new ArrayList<Kor24MsnNoVO>();
	...
	public Kor24MsnNoVO(String ibflag, String pagerows, String msnStartNum, String inVvd, String inPod, String tp, String fe, String blNo, String bkgNo, String hidden3, String pod, String msn) {
		this.inVvd = inVvd;
		this.inPod = inPod;
		this.bkgNo = bkgNo;
...
/**
	 ...
	 * @return Kor24MsnNoVO[]
	 */
	public Kor24MsnNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24MsnNoVO[]
	 */
	public Kor24MsnNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24MsnNoVO model = null;
	 ...
	 * @return Kor24MsnNoVO[]
	 */
	public Kor24MsnNoVO[] getKor24MsnNoVOs(){
		Kor24MsnNoVO[] vos = (Kor24MsnNoVO[])models.toArray(new Kor24MsnNoVO[models.size()]);
		return vos;
	}
