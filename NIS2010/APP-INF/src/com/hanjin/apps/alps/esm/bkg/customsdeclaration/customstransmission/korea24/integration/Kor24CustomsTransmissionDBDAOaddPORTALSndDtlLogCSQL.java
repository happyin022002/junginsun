...
*@FileName : Kor24CustomsTransmissionDBDAOaddPORTALSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddPORTALSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PORTAL Send Detail Log를 add한다.
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddPORTALSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddPORTALSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE MSG_LOG_TP_ID  = DECODE(@[io_bnd_cd],'O','5VD','5VJ')" ).append("\n");
