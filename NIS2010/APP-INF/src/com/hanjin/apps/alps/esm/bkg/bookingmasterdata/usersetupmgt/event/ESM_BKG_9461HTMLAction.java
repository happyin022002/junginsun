...
*@FileName : ESM_BKG_9461HTMLAction.java
...
public class ESM_BKG_9461HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9461HTMLAction 객체를 생성
	 */
	public ESM_BKG_9461HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9461Event event = new EsmBkg9461Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgSrchSetVOS((BkgSrchSetVO[])getVOs(request, BkgSrchSetVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgSrchSetVO((BkgSrchSetVO)getVO(request, BkgSrchSetVO .class));
		}
