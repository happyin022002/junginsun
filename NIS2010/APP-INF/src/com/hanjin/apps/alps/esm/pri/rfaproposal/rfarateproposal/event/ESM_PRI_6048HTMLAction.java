...
*@FileName : ESM_PRI_6048HTMLAction.java
...
public class ESM_PRI_6048HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6048HTMLAction 객체를 생성
	 */
	public ESM_PRI_6048HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6048Event event = new EsmPri6048Event();
		 
		if(command.isCommand(FormCommand.MULTI)) {
			PriRpScpRtCmdtRoutSetVO vo = (PriRpScpRtCmdtRoutSetVO)getVO(request, PriRpScpRtCmdtRoutSetVO.class);
			PriRpScpRtCmdtRoutVO[] routVOs = (PriRpScpRtCmdtRoutVO[])getVOs(request, PriRpScpRtCmdtRoutVO .class,"");
			vo.setPriRpScpRtCmdtRoutVOS(routVOs);
			event.setPriRpScpRtCmdtRoutSetVO(vo);
		}
