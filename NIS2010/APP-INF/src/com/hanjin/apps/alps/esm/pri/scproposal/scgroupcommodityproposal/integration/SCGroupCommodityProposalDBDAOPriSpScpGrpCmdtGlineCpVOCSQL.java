...
*@FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtGlineCpVOCSQL
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("pri_sg_grp_cmdt cmdt" ).append("\n"); 
		query.append("" ).append("\n"); 
