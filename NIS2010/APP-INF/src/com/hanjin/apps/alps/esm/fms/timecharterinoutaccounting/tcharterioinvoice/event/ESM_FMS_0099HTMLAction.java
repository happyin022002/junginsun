...
*@FileName : ESM_FMS_0099HTMLAction.java
...
public class ESM_FMS_0099HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0099HTMLAction 객체를 생성
	 */
	public ESM_FMS_0099HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0099Event event = new EsmFms0099Event();
 		...
 		if(command.isCommand(FormCommand.SEARCH)) {
 			...
 			event.setSlpTp(request.getParameter("slp_tp")); 			
