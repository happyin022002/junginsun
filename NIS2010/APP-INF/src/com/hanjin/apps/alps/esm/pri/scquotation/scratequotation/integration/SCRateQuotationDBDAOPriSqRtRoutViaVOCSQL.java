...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutViaVOCSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutViaVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutViaVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutViaVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
