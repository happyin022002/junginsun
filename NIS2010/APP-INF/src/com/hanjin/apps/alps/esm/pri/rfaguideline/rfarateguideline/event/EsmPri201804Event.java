 ...
 *@FileName : EsmPri201804Event.java
...
import com.hanjin.apps.alps.esm.pri.scguideline.scrateguideline.event.ESM_PRI_0030HTMLAction;
...
public class EsmPri201804Event extends EventSupport {
	...
	public PriRgRtCmdtHdrVO[] getPriRgRtCmdtHdrVOS() {
		PriRgRtCmdtHdrVO[] rtnVOs = null;
		if (this.priRgRtCmdtHdrVOS != null) {
			rtnVOs = new PriRgRtCmdtHdrVO[priRgRtCmdtHdrVOS.length];
			System.arraycopy(priRgRtCmdtHdrVOS, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public PriRgRtCmdtRoutVO[] getPriRgRtCmdtRoutVOS() {
		PriRgRtCmdtRoutVO[] rtnVOs = null;
		if (this.priRgRtCmdtRoutVOS != null) {
			rtnVOs = new PriRgRtCmdtRoutVO[priRgRtCmdtRoutVOS.length];
			System.arraycopy(priRgRtCmdtRoutVOS, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public PriRgRtVO[] getPriRgRtVOS() {
		PriRgRtVO[] rtnVOs = null;
		if (this.priRgRtVOS != null) {
			rtnVOs = new PriRgRtVO[priRgRtVOS.length];
			System.arraycopy(priRgRtVOS, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public RsltRtCmdtListVO[] getRsltRtCmdtListVOS() {
		RsltRtCmdtListVO[] rtnVOs = null;
		if (this.rsltRtCmdtListVOS != null) {
			rtnVOs = new RsltRtCmdtListVO[rsltRtCmdtListVOS.length];
			System.arraycopy(rsltRtCmdtListVOS, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public RsltRtRoutListVO[] getRsltRtRoutListVOS() {
		RsltRtRoutListVO[] rtnVOs = null;
		if (this.rsltRtRoutListVOS != null) {
			rtnVOs = new RsltRtRoutListVO[rsltRtRoutListVOS.length];
			System.arraycopy(rsltRtRoutListVOS, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public RsltRtListVO[] getRsltRtListVOS() {
		RsltRtListVO[] rtnVOs = null;
		if (this.rsltRtListVOS != null) {
			rtnVOs = new RsltRtListVO[rsltRtListVOS.length];
			System.arraycopy(rsltRtListVOS, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
