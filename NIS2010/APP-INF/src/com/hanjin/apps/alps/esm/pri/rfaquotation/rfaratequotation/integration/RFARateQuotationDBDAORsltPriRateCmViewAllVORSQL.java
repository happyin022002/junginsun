...
*@FileName : RFARateQuotationDBDAORsltPriRateCmViewAllVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriRateCmViewAllVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriRateCmViewAllVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriRateCmViewAllVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WITH VW_PRI_RQ_RT_CMDT  AS (" ).append("\n"); 
		...
		query.append("		FROM PRI_RQ_RT_CMDT " ).append("\n"); 
		...
		query.append("		,CMDT.CMDT_HDR_SEQ" ).append("\n"); 
		query.append(")," ).append("\n"); 
		query.append("VW_PRI_RQ_RT_ROUT_PNT_ORI AS (" ).append("\n"); 
		...
		query.append("		,ROUT_PNT.ORG_DEST_TP_CD" ).append("\n"); 
		query.append(" )," ).append("\n"); 
		query.append(" VW_PRI_RQ_RT_ROUT_PNT_DEST AS (" ).append("\n"); 
		query.append(" 	SELECT  ROUT_PNT.QTTN_NO,ROUT_PNT.QTTN_VER_NO" ).append("\n"); 
		query.append("		,ROUT_PNT.CMDT_HDR_SEQ, ROUT_PNT.ROUT_SEQ" ).append("\n"); 
		query.append("		,ROUT_PNT.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("		, SUBSTR(MAX(SYS_CONNECT_BY_PATH(ROUT_PNT_LOC_DEF_CD || DECODE(TERM_NM,'','','(' || TERM_NM || ')') , '; ')),3) AS ROUT_PNT_LOC_DEF_CD " ).append("\n"); 
		...
		query.append("		,ROUT_PNT.ORG_DEST_TP_CD" ).append("\n"); 
		query.append(")," ).append("\n"); 
		query.append("VW_PRI_RQ_RT_ROUT_VIA_ORI AS (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append(")," ).append("\n"); 
		query.append("VW_PRI_RQ_RT_ROUT_VIA_DEST AS (" ).append("\n"); 
		query.append("	SELECT 	 ROUT_VIA.QTTN_NO,ROUT_VIA.QTTN_VER_NO" ).append("\n"); 
		query.append("		,ROUT_VIA.CMDT_HDR_SEQ, ROUT_VIA.ROUT_SEQ" ).append("\n"); 
		query.append("		,ROUT_VIA.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("		,SUBSTR(MAX(SYS_CONNECT_BY_PATH(ROUT_VIA_PORT_DEF_CD , '; ')),3) AS ROUT_VIA_PORT_DEF_CD " ).append("\n"); 
		...
		query.append("	SELECT 	QTTN_NO	,QTTN_VER_NO ,CMDT_HDR_SEQ ,ROUT_SEQ" ).append("\n"); 
		...
		query.append("		FROM 	VW_PRI_RQ_RT_ROUT_PNT_ORI" ).append("\n"); 
		...
		query.append("		FROM 	VW_PRI_RQ_RT_ROUT_PNT_DEST" ).append("\n"); 
		query.append("		UNION ALL" ).append("\n"); 
		query.append("		SELECT " ).append("\n"); 
		query.append("			QTTN_NO" ).append("\n"); 
		query.append("			,QTTN_VER_NO" ).append("\n"); 
		...
		query.append("		FROM 	VW_PRI_RQ_RT_ROUT_VIA_ORI" ).append("\n"); 
		query.append("		UNION ALL" ).append("\n"); 
		query.append("		SELECT " ).append("\n"); 
		query.append("			QTTN_NO" ).append("\n"); 
		query.append("			,QTTN_VER_NO" ).append("\n"); 
		...
		query.append("		FROM 	VW_PRI_RQ_RT_ROUT_VIA_DEST" ).append("\n"); 
		query.append("	)" ).append("\n"); 
		query.append("	GROUP BY QTTN_NO ,QTTN_VER_NO ,CMDT_HDR_SEQ ,ROUT_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT QTTN_NO,QTTN_VER_NO,CMDT_HDR_SEQ,ROUT_SEQ" ).append("\n"); 
		...
		query.append("	,DECODE(TOT_PRE_TOT_QTY,0,0,TO_CHAR(ROUND(PRS_PRE_LOD_QTY / TOT_PRE_TOT_QTY * 100,2),'990.99')) || '%'  AS PRE_SHARE  --Previous - Share(%) - 해당 Route Performance의 전체 Performance대비 Share" ).append("\n"); 
		...
		query.append("	,DECODE(TOT_ESTM_TOT_QTY,0,0, TO_CHAR(ROUND(PRS_ESTM_LOD_QTY / TOT_ESTM_TOT_QTY * 100 ,2),'990.99')) || '%' AS ESTM_SHARE -- Estimate - Share(%)  -- 해당 Route Performance의 전체 Performance대비 Share" ).append("\n"); 
		...
		query.append("FROM (" ).append("\n"); 
		query.append("	SELECT CR.QTTN_NO,CR.QTTN_VER_NO,CR.CMDT_HDR_SEQ,CR.ROUT_SEQ" ).append("\n"); 
		...
		query.append("		,SUM(CR.PRS_PRE_LOD_QTY/DECODE(@[pfmc_unit],'FEU',2,'TEU',1))  OVER( PARTITION BY CR.QTTN_NO,CR.QTTN_VER_NO) AS TOT_PRE_TOT_QTY" ).append("\n"); 
		query.append("		,SUM(CR.PRS_ESTM_LOD_QTY/DECODE(@[pfmc_unit],'FEU',2,'TEU',1)) OVER( PARTITION BY CR.QTTN_NO,CR.QTTN_VER_NO) AS TOT_ESTM_TOT_QTY" ).append("\n"); 
		query.append("		,CR.PRS_RAT_UT_CD" ).append("\n"); 
		query.append("		,U.CNTR_SZ_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	FROM PRI_RQ_RT_CMDT_HDR H" ).append("\n"); 
		query.append("		, VW_PRI_RQ_RT_CMDT C" ).append("\n"); 
		query.append("		, VW_PRI_ROUT ROUT" ).append("\n"); 
		query.append("		, PRI_RQ_RT_CMDT_ROUT CR" ).append("\n"); 
		query.append("		, PRI_RAT_UT U" ).append("\n"); 
		query.append("	WHERE H.QTTN_NO = C.QTTN_NO" ).append("\n"); 
		query.append("		AND H.QTTN_VER_NO = C.QTTN_VER_NO" ).append("\n"); 
		query.append("		AND H.CMDT_HDR_SEQ = C.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("		AND H.QTTN_NO = ROUT.QTTN_NO" ).append("\n"); 
		query.append("		AND H.QTTN_VER_NO = ROUT.QTTN_VER_NO" ).append("\n"); 
		query.append("		AND H.CMDT_HDR_SEQ = ROUT.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		AND ROUT.QTTN_NO = CR.QTTN_NO(+)" ).append("\n"); 
		query.append("		AND ROUT.QTTN_VER_NO = CR.QTTN_VER_NO(+)" ).append("\n"); 
		...
		query.append("		AND H.QTTN_NO = @[qttn_no]" ).append("\n"); 
		query.append("		AND H.QTTN_VER_NO = @[qttn_ver_no]" ).append("\n"); 
		query.append(")" ).append("\n"); 
