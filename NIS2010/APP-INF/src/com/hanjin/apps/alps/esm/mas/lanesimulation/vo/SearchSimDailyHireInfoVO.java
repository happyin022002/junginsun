...
*@FileName : SearchSimDailyHireInfoVO.java
*@FileTitle : SearchSimDailyHireInfoVO
*Open Issues :
*Change history :
...
public class SearchSimDailyHireInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSimDailyHireInfoVO> models = new ArrayList<SearchSimDailyHireInfoVO>();
	...
	public SearchSimDailyHireInfoVO() {}

	public SearchSimDailyHireInfoVO(String ibflag, String pagerows, String stndCostNm, String stndCostCd, String sgrpCostCd) {
		this.ibflag = ibflag;
	 ...
	 */
	public SearchSimDailyHireInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSimDailyHireInfoVO[]
	 */
	public SearchSimDailyHireInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSimDailyHireInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSimDailyHireInfoVO();
				if (ibflag[i] != null)
		...
		return getSearchSimDailyHireInfoVOs();
	}
	 ...
	 * @return SearchSimDailyHireInfoVO[]
	 */
	public SearchSimDailyHireInfoVO[] getSearchSimDailyHireInfoVOs(){
		SearchSimDailyHireInfoVO[] vos = (SearchSimDailyHireInfoVO[])models.toArray(new SearchSimDailyHireInfoVO[models.size()]);
		return vos;
	}
