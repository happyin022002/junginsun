...
*@FileName : TariffRuleDBDAOPriTrfRuleProgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffRuleDBDAOPriTrfRuleProgVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff Rule Progress Insert
	  * </pre>
	  */
	public TariffRuleDBDAOPriTrfRuleProgVOCSQL(){
		setQuery();
		...
		query.append("FileName : TariffRuleDBDAOPriTrfRuleProgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , @[trf_rule_no]" ).append("\n"); 
		query.append("     , @[amdt_seq]" ).append("\n"); 
		query.append("     , NVL(MAX(TRF_RULE_PROG_SEQ)+1, 1)" ).append("\n"); 
		query.append("     , @[trf_rule_sts_cd]" ).append("\n"); 
		query.append("     , @[prog_usr_id]" ).append("\n"); 
		query.append("     , @[prog_ofc_cd]" ).append("\n"); 
		...
		query.append("     , @[cre_usr_id]" ).append("\n"); 
		query.append("     , SYSDATE" ).append("\n"); 
		query.append("  FROM PRI_TRF_RULE_PROG " ).append("\n"); 
