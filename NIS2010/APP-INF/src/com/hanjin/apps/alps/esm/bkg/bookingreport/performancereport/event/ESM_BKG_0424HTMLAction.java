...
*@FileName : ESM_BKG_0424HTMLAction.java
 ...
 * @see EsmBkg0424Event 참조
 * @since J2EE 1.5
 */

public class ESM_BKG_0424HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0424HTMLAction 객체를 생성
     */
    public ESM_BKG_0424HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0424Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0424Event event = new EsmBkg0424Event();
		
		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO2((DocQueueReportByPolListInVO) getVO(request, DocQueueReportByPolListInVO.class));
		}else if (command.isCommand(FormCommand.SEARCH01)){
			event.setInfoVO((DocQueueVvdListVO) getVO(request, DocQueueVvdListVO.class));
