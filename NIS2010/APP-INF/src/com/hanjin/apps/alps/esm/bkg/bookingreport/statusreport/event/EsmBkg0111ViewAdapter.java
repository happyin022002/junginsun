 ...
 * @since J2EE 1.6
 */
public class EsmBkg0111ViewAdapter extends ViewAdapter{
...
//						    //Float.parseFloat(nowColValues.get("pck_qty_da")) != subConrPkg){
					...
					sbufXML.append("  <TD><![CDATA["); sbufXML.append(JSPUtil.getNull(nowColValues.get("ctrt_cust_nm"))); sbufXML.append("]]></TD>\n");					
