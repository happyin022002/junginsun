...
*@FileName : CstPriSpScpCpVO.java
*@FileTitle : CstPriSpScpCpVO
*Open Issues :
*Change history :
...
public class CstPriSpScpCpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpScpCpVO> models = new ArrayList<CstPriSpScpCpVO>();
	 ...
	 * @param request
	 * @return CstPriSpScpCpVO[]
	 */
	public CstPriSpScpCpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpScpCpVO[]
	 */
	public CstPriSpScpCpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpScpCpVO model = null;
	...
	public CstPriSpScpCpVO[] getCstPriSpScpCpVOs(){
		CstPriSpScpCpVO[] vos = (CstPriSpScpCpVO[])models.toArray(new CstPriSpScpCpVO[models.size()]);
		return vos;
	}
