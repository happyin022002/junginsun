...
*@FileName : AGNCommAgreementDBDAOAddAgentRateCommChgListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateCommChgListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateCommChgListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateCommChgListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
