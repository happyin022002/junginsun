...
public class VskVslPortSkdConditionVO extends AbstractValueObject {
	...
	public VskVslPortSkdConditionVO(String ibflag, String pagerows, String vvd, String lane, String pol, String clptIndSeq, String clptSeq, String terminal, String cct, String cctDt, String cctTm, String etb, String etbDt, String etbTm, String etd, String etdDt, String etdTm, String tTime, String pod, String podClptIndSeq, String podClptSeq, String terminal2, String etb2, String etb2Dt, String etb2Tm, String vpsRmk, String updDt, String updTm, String slanCd, String vslCd, String skdVoyNo, String skdDirCd, String vpsPortPol, String pfEtdFromDt, String pfEtdToDt, String pfEtbFromDt, String pfEtbToDt, String vpsPortPod, String oldTick,String vslEngNm,String crrCd) {
		this.etb = etb;
		this.vslCd = vslCd;
		this.vpsRmk = vpsRmk;
		this.etb2Dt = etb2Dt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("old_tick", getOldTick());
		...
		this.hashColumns.put("t_time", getTTime());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("old_tick", "oldTick");
		...
		this.hashFields.put("t_time", "tTime");
	 ...
	 * @param oldTick
	 */
	public void setOldTick(String oldTick) {
		this.oldTick = oldTick;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOldTick(JSPUtil.getParameter(request, prefix + "old_tick", ""));
		...
		setTTime(JSPUtil.getParameter(request, prefix + "t_time", ""));
	...
	public VskVslPortSkdConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] oldTick = (JSPUtil.getParameter(request, prefix	+ "old_tick", length));
			...
			String[] tTime = (JSPUtil.getParameter(request, prefix	+ "t_time", length));
	...
	*/
	public void unDataFormat(){
		...
		this.oldTick = this.oldTick .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.tTime = this.tTime .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
