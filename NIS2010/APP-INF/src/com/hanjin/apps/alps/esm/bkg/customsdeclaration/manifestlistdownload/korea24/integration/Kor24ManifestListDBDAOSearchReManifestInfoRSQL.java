...
*@FileName : Kor24ManifestListDBDAOSearchReManifestInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchReManifestInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchReManifestInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchReManifestInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
