...
*@FileName : Kor24ManifestListDBDAOsearchOldExportChkRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchOldExportChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchOldExportChkRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchOldExportChkRSQL").append("\n");
		query.append("*/").append("\n");
	}
