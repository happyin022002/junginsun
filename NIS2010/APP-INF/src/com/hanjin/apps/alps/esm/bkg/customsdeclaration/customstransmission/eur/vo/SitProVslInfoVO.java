...
*@FileName : SitProVslInfoVO.java
*@FileTitle : SitProVslInfoVO
*Open Issues :
*Change history :
...
public class SitProVslInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SitProVslInfoVO> models = new ArrayList<SitProVslInfoVO>();
	...
	public SitProVslInfoVO() {}

	public SitProVslInfoVO(String ibflag, String pagerows, String vvd, String vslCallsign, String vslLloydcode, String vslFullname, String vslRgstCntCd, String port, String portname, String eta, String etd, String nextport, String nextportEta, String prevport, String prevportEtd, String ioInd, String compId) {
		this.port = port;
		this.compId = compId;
...
/**
	 ...
	 */
	public SitProVslInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SitProVslInfoVO[]
	 */
	public SitProVslInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SitProVslInfoVO model = null;
	 ...
	 * @return SitProVslInfoVO[]
	 */
	public SitProVslInfoVO[] getSitProVslInfoVOs(){
		SitProVslInfoVO[] vos = (SitProVslInfoVO[])models.toArray(new SitProVslInfoVO[models.size()]);
		return vos;
	}
