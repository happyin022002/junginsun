...
*@FileName : ESM_BKG_1164HTMLAction.java
*@FileTitle : ESM_BKG-1164
*Open Issues :
*Change history :
...
public class ESM_BKG_1164HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1164HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1164HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1164Event event = new EsmBkg1164Event();

    	if(command.isCommand(FormCommand.SEARCH)) {
    		event.setFdrBlInVO((FdrBlInVO)getVO(request, FdrBlInVO .class));
    	}else if(command.isCommand(FormCommand.MULTI)) { 			 		
			event.setFdrBlVOS((FdrBlVO[])getVOs(request, FdrBlVO.class,"t1sheet1"));
