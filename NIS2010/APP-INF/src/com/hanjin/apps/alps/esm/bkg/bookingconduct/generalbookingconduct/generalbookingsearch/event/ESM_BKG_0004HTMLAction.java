...
*@FileName : ESM_BKG_0004HTMLAction.java
...
public class ESM_BKG_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0004HTMLAction 객체를 생성
	 */
	public ESM_BKG_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0004Event event = new EsmBkg0004Event();

		if(command.isCommand(FormCommand.SEARCH)){
			event.setVvd(request.getParameter("vvd"));
			event.setDirCd(request.getParameter("dir_cd"));
			event.setBkgCustAvcNtcRmkVO((BkgCustAvcNtcRmkVO)getVO(request, BkgCustAvcNtcRmkVO.class, ""));
