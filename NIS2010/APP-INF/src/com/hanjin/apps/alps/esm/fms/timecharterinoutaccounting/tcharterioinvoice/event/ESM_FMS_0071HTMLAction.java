...
*@FileName : ESM_FMS_0071HTMLAction.java
 ...
 * @author JUNGYOONTAE
 * @see EsmFms0071Event 참조
 * @since J2EE 1.6
 */

public class ESM_FMS_0071HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0071HTMLAction 객체를 생성
	 */
	public ESM_FMS_0071HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0071Event event = new EsmFms0071Event();
