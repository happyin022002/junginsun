...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgOnGRICancelDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgOnGRICancelDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GRI Cancel시 Scg테이블 삭제
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgOnGRICancelDSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgOnGRICancelDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RP_SCP_RT_SCG T" ).append("\n"); 
