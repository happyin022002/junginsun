...
*@FileName : ESM_MAS_0023HTMLAction.java
...
public class ESM_MAS_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0023HTMLAction 객체를 생성
	 */
	public ESM_MAS_0023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0023Event event = new EsmMas0023Event();
