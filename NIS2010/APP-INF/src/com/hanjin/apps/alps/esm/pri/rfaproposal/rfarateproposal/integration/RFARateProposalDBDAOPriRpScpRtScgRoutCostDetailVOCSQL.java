...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    (PROP_NO, AMDT_SEQ, SVC_SCP_CD, CMDT_HDR_SEQ, ROUT_SEQ, RT_SEQ," ).append("\n"); 
		query.append("    POR_CD, POL_CD, POD_CD, DEL_CD, RCV_TERM_CD, DE_TERM_CD, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
		query.append("SELECT A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ, A.RT_SEQ," ).append("\n"); 
		...
		query.append("       PRI_RP_SCP_RT_USD_ROUT_CS B," ).append("\n"); 
		...
		query.append("   AND A.PRC_PROG_STS_CD IN ( 'I', 'R' )" ).append("\n"); 
