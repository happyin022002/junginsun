...
*@FileName : BSAYearlyPlanDBDAORemoveBsaBudJntOpCrrCapaDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAORemoveBsaBudJntOpCrrCapaDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAORemoveBsaBudJntOpCrrCapaDSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAORemoveBsaBudJntOpCrrCapaDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_BUD_JNT_OP_CRR_CAPA" ).append("\n"); 
