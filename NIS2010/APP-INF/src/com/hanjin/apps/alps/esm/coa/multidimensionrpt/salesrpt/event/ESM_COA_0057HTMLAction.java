...
*@FileName : ESM_COA_0057HTMLAction.java
...
public class ESM_COA_0057HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0057HTMLAction 객체를 생성
	 */
	public ESM_COA_0057HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0057Event event = new EsmCoa0057Event();
