...
*@FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpGRICancelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpGRICancelCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpGRICancelCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpGRICancelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[cre_usr_id]" ).append("\n"); 
		query.append(",SYSDATE" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_RT_USD_ROUT_CS T" ).append("\n"); 
