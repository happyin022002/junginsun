...
*@FileName : ESM_FMS_0057HTMLAction.java
...
public class ESM_FMS_0057HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0057HTMLAction 객체를 생성
	 */
	public ESM_FMS_0057HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0057Event event = new EsmFms0057Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondDryDockScheduleVO((CondDryDockScheduleVO)getVO(request, CondDryDockScheduleVO .class));
		}
