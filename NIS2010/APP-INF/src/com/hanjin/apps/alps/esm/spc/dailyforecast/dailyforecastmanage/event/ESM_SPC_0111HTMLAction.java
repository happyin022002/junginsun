...
*@FileName : ESM_SPC_0111HTMLAction.java
...
public class ESM_SPC_0111HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0102HTMLAction 객체를 생성
	 */
	public ESM_SPC_0111HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSpc0111Event event = new EsmSpc0111Event();
    	SpcCtrtFcastOfcMapgVO spcCtrtFcastOfcMapgVO = new SpcCtrtFcastOfcMapgVO();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setSpcCtrtFcastOfcMapgVOS(spcCtrtFcastOfcMapgVO.fromRequestGrid(request, ""));
