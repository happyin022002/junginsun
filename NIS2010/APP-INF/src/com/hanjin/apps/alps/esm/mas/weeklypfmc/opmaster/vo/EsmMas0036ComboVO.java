...
public class EsmMas0036ComboVO extends AbstractValueObject {
	...
	/* DB List 객체  */
	List<EsmMas0036ComboVO> list = null;	
	
	/*	테이블 컬럼의 값을 저장하는 Hashtable */
	private HashMap<String, String> hashColumns = new HashMap<String, String>();	

	public EsmMas0036ComboVO() {}
	...
	/** DB List Getter */
	public List<EsmMas0036ComboVO> getListSet() {
		return list;
	}

	/** DB List Setter */
	public void setListSet(List<EsmMas0036ComboVO> list) {
		this.list = list;
	}		
