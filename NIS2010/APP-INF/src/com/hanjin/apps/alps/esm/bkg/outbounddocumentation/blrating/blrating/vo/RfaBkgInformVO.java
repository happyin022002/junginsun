...
*@FileName : RfaBkgInformVO.java
*@FileTitle : RfaBkgInformVO
*Open Issues :
*Change history :
...
public class RfaBkgInformVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RfaBkgInformVO> models = new ArrayList<RfaBkgInformVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("frfa_no", getFRfaNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("frfa_no", "fRfaNo");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFRfaNo(JSPUtil.getParameter(request, "frfa_no", ""));
	 ...
	 */
	public RfaBkgInformVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RfaBkgInformVO[]
	 */
	public RfaBkgInformVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RfaBkgInformVO model = null;
		...
		try {
			...
			String[] fRfaNo = (JSPUtil.getParameter(request, prefix	+ "frfa_no", length));
	 ...
	 * @return RfaBkgInformVO[]
	 */
	public RfaBkgInformVO[] getRfaBkgInformVOs(){
		RfaBkgInformVO[] vos = (RfaBkgInformVO[])models.toArray(new RfaBkgInformVO[models.size()]);
		return vos;
	}
