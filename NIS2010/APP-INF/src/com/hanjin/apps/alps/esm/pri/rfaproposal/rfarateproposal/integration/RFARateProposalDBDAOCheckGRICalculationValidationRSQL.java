...
*@FileName : RFARateProposalDBDAOCheckGRICalculationValidationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOCheckGRICalculationValidationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOCheckGRICalculationValidationRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOCheckGRICalculationValidationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE X.FIC_ORG_RT_USE_STS_CD IN ('1', '2', '3') OR X.FIC_DEST_RT_USE_STS_CD IN ('1', '2', '3')" ).append("\n"); 
