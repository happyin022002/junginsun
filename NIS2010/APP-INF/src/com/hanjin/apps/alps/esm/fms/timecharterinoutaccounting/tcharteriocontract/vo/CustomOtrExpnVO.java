...
*@FileName : CustomOtrExpnVO.java
*@FileTitle : CustomOtrExpnVO
*Open Issues :
*Change history :
...
public class CustomOtrExpnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomOtrExpnVO> models = new ArrayList<CustomOtrExpnVO>();
	 ...
	 * @return 
	 */
	public CustomOtrExpnVO() {}
	
	/**
	 * 생성자
	 * @param String ibflag, String pagerows, String fletCtrtNo, String acctCd, String acctItmSeq, String effDt, String expDt, String currCd, String otrExpnAmt, String creUsrId, String creDt, String updUsrId, String updDt, String oriEffDt, String oriExpDt, String oriAcctCd, String oriAcctItmSeq
	 * @return 
	 */
	public CustomOtrExpnVO(String ibflag, String pagerows, String fletCtrtNo, String acctCd, String acctItmSeq, String effDt, String expDt, String currCd, String otrExpnAmt, String creUsrId, String creDt, String updUsrId, String updDt, String oriEffDt, String oriExpDt, String oriAcctCd, String oriAcctItmSeq) {
		this.updDt = updDt;
		this.currCd = currCd;
		this.creDt = creDt;
	...
	public CustomOtrExpnVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CustomOtrExpnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomOtrExpnVO model = null;
		...
		return getCustomOtrExpnVOs();
	}

	public CustomOtrExpnVO[] getCustomOtrExpnVOs(){
		CustomOtrExpnVO[] vos = (CustomOtrExpnVO[])models.toArray(new CustomOtrExpnVO[models.size()]);
		return vos;
	}
