...
*@FileName : DgAproInfoVO.java
*@FileTitle : DgAproInfoVO
*Open Issues :
*Change history :
...
public class DgAproInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DgAproInfoVO> models = new ArrayList<DgAproInfoVO>();
	...
	public DgAproInfoVO(String ibflag, String pagerows, String rqstUsrId, String rqstDt, String rqstGdt, String imdgUnNo) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setRqstDt(JSPUtil.getParameter(request, prefix + "imdg_un_no", ""));
	 ...
	 * @return DgAproInfoVO[]
	 */
	public DgAproInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DgAproInfoVO[]
	 */
	public DgAproInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DgAproInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new DgAproInfoVO();
				if (imdgUnNo[i] != null)
					model.setImdgUnNo(rqstDt[i]);
				if (rqstDt[i] != null)
	...
	public DgAproInfoVO[] getDgAproInfoVOs(){
		DgAproInfoVO[] vos = (DgAproInfoVO[])models.toArray(new DgAproInfoVO[models.size()]);
		return vos;
	}
