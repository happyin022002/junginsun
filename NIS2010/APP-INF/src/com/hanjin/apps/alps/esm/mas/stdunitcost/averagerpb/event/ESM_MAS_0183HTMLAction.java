...
*@FileName : ESM_MAS_0014HTMLAction.java
...
public class ESM_MAS_0183HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0009HTMLAction 객체를 생성
	 */
	public ESM_MAS_0183HTMLAction() {}
...
//		FormCommand command = FormCommand.fromRequest(request);
		EsmMas0183Event event = new EsmMas0183Event();
