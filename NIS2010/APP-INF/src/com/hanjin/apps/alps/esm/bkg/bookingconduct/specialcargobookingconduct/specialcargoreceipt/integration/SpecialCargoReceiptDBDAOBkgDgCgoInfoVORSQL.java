...
*@FileName : SpecialCargoReceiptDBDAOBkgDgCgoInfoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOBkgDgCgoInfoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOBkgDgCgoInfoVORSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOBkgDgCgoInfoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM (SELECT A.IMDG_COMP_GRP_CD" ).append("\n"); 
		...
		query.append("              ,TO_CHAR(A.RQST_DT, 'YYYY-MM-DD HH24:MI:SS') RQST_DT " ).append("\n"); 
		query.append("              ,TO_CHAR(A.RQST_GDT, 'YYYY-MM-DD HH24:MI:SS') RQST_GDT" ).append("\n"); 
		...
		query.append("			  ,'' MERGE_DG_CNTR_SEQ" ).append("\n"); 
		...
		query.append("                   AND (   ((    L1.conti_cd = 'E' OR L2.conti_cd = 'E')" ).append("\n"); 
		...
		query.append("                        OR ((    L3.conti_cd = 'E' OR L4.conti_cd = 'E')" ).append("\n"); 
		query.append("                             AND (   B.de_term_cd IN ('D','H')" ).append("\n"); 
		query.append("                                  OR (    B.pod_cd <> B.del_cd" ).append("\n"); 
		query.append("                                      AND NVL(L4.call_port_flg, 'N') <> 'Y'))))) HCDG_QTY" ).append("\n"); 
		...
		query.append("      )" ).append("\n"); 
		query.append(" WHERE CNTR_CGO_SEQ = '1'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT *" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		query.append("        SELECT A.IMDG_COMP_GRP_CD" ).append("\n"); 
		query.append("              ,A.CNTR_VOL_QTY" ).append("\n"); 
		query.append("              ,A.IMDG_SUBS_RSK_LBL_CD4" ).append("\n"); 
		query.append("              ,A.BKG_NO" ).append("\n"); 
		query.append("              ,A.DCGO_SEQ" ).append("\n"); 
