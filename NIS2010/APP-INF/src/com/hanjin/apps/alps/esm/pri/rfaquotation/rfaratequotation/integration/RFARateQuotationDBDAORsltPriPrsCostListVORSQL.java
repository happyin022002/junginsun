...
*@FileName : RFARateQuotationDBDAORsltPriPrsCostListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriPrsCostListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriPrsCostListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriPrsCostListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   QTTN_NO, QTTN_VER_NO, cmdt_hdr_seq, rout_seq,rt_seq, cost_tp 변수를 추가해줘야한다." ).append("\n"); 
		query.append("*/" ).append("\n"); 
