...
public class EurManifestListCondVO extends ManifestListCondVO {
	...
	public EurManifestListCondVO(String ibflag, String pagerows, String vvdCd, String podCd, String polCd, String blNo, String receiverId, String checkFrobSearch, String podYdCd, String polYdCd, String modeType, String tsTpCd) {
		this.podCd = podCd;
		this.polCd = polCd;
		this.ibflag = ibflag;
		this.vvdCd = vvdCd;
