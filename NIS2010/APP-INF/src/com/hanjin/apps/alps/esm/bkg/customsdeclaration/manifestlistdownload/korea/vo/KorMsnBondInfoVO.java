...
*@FileName : KorMsnBondInfoVO.java
*@FileTitle : KorMsnBondInfoVO
*Open Issues :
*Change history :
...
public class KorMsnBondInfoVO extends MsnBondInfoVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorMsnBondInfoVO> models = new ArrayList<KorMsnBondInfoVO>();
	...
	private KorBondLocalInfoVO[] bondLocalInfoVOs = null;
	
	private KorBondTsInfoVO[] bondTsInfoVOs = null;
	
	/**
	 * @return the bondTsInfoVOs
	 */
	public KorBondTsInfoVO[] getBondTsInfoVOs() {
		return bondTsInfoVOs;
	}

	/**
	 * @param bondTsInfoVOs the bondTsInfoVOs to set
	 */
	public void setBondTsInfoVOs(KorBondTsInfoVO[] bondTsInfoVOs) {
		this.bondTsInfoVOs = bondTsInfoVOs;
	}

	/**
	 * @return the bondLocalInfoVOs
	 */
	public KorBondLocalInfoVO[] getBondLocalInfoVOs() {
		return bondLocalInfoVOs;
	}

	/**
	 * @param bondLocalInfoVOs the bondLocalInfoVOs to set
	 */
	public void setBondLocalInfoVOs(KorBondLocalInfoVO[] bondLocalInfoVOs) {
		this.bondLocalInfoVOs = bondLocalInfoVOs;
	}
	...
	public KorMsnBondInfoVO() {}

	public KorMsnBondInfoVO(String ibflag, String pagerows, String type, String mrnNo, String mrnChkNo, String vvd, String pol, String pod, String mrnMode, String yard, String msnNo, String bkgNo) {
		this.vvd = vvd;
	 ...
	 */
	public KorMsnBondInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMsnBondInfoVO[]
	 */
	public KorMsnBondInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMsnBondInfoVO model = null;
	 ...
	 * @return KorMsnBondInfoVO[]
	 */
	public KorMsnBondInfoVO[] getKorMsnBondInfoVOs(){
		KorMsnBondInfoVO[] vos = (KorMsnBondInfoVO[])models.toArray(new KorMsnBondInfoVO[models.size()]);
		return vos;
	}
