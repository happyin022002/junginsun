...
*@FileName : ESM_PRI_9123HTMLAction.java
...
public class ESM_PRI_9123HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_9123HTMLAction 객체를 생성
	 */
	public ESM_PRI_9123HTMLAction() {}
	...
	public Event perform (HttpServletRequest request) throws HTMLActionException {
        ...
        EsmPri9123Event event = new EsmPri9123Event();

        if (command.isCommand(FormCommand.SEARCH01)) {
            event.setChangeUserVO((ChangeUserVO) getVO(request, ChangeUserVO.class));
