...
*@FileName : InlandRatesDBDAOPriTrfInlndRtExcelVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRatesDBDAOPriTrfInlndRtExcelVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndRtExcelVOCSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndRtExcelVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , @[trf_inlnd_seq]" ).append("\n"); 
		query.append("     , @[amdt_seq] " ).append("\n"); 
		query.append("	 , NVL(MAX(TRF_INLND_RT_SEQ) +1, 1)" ).append("\n"); 
		query.append("     , @[inlnd_rt_bse_loc_cd]" ).append("\n"); 
		query.append("     , @[inlnd_rt_bse_loc_zip_cd]" ).append("\n"); 
		query.append("     , @[inlnd_rt_term_cd]" ).append("\n"); 
		query.append("     , @[inlnd_rt_via_loc_cd]" ).append("\n"); 
