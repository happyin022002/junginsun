...
*@FileName : ESM_MAS_0030HTMLAction.java
...
public class ESM_MAS_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0030HTMLAction 객체를 생성
	 */
	public ESM_MAS_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0030Event event = new EsmMas0030Event();
		
		if (command.isCommand(FormCommand.SEARCH)) {
			event.setSearchWeeklyTargetVVD0030ListVO((SearchWeeklyTargetVVD0030ListVO)getVO(request, SearchWeeklyTargetVVD0030ListVO .class));
