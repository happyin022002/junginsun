...
*@FileName : SpacecontrolinquiryDBDAOSearchSpaceUtilizationLaneListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAOSearchSpaceUtilizationLaneListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAOSearchSpaceUtilizationLaneListRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAOSearchSpaceUtilizationLaneListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                 AND T1.VSL_SLAN_CD = SUBSTR(@[lane], 1, 3)" ).append("\n"); 
		...
		query.append("                                AND VSL_SLAN_CD = SUBSTR(@[lane], 1, 3)" ).append("\n"); 
		...
		query.append("  ORDER BY VP.VSL_CD" ).append("\n"); 
		query.append("          ,VP.SKD_VOY_NO" ).append("\n"); 
		query.append("          ,VP.SKD_DIR_CD" ).append("\n"); 
		query.append("          ,MV.RLANE_CD" ).append("\n"); 
		query.append("          ,VP.CLPT_SEQ" ).append("\n"); 
		...
		query.append("          ,Z.LOAD_TEU_TTL" ).append("\n"); 
		query.append("          ,Z.LOD_WGT_TTL" ).append("\n"); 
		query.append("          ,Z.DIS_WGT_TTL" ).append("\n"); 
		query.append("          ,Z.ON_WGT_TTL" ).append("\n"); 
		query.append("          ,Z.LOAD_WGT_TTL" ).append("\n"); 
		query.append("          ,Z.PAST" ).append("\n"); 
		query.append("          ,Z.BSA" ).append("\n"); 
		query.append("          ,Z.WGT_BSA " ).append("\n"); 
		query.append("      FROM (" ).append("\n"); 
		query.append("              SELECT Z.BASE_VVD" ).append("\n"); 
		query.append("                    ,Z.RLANE_CD" ).append("\n"); 
		query.append("                    ,Z.SRC" ).append("\n"); 
		...
		query.append("                                                  ,DECODE(Q.SEQ, 1, A.QTY_TTL, 0)                             AS LOD_TTL -- OCEN 이면 QTY 아니면 0" ).append("\n"); 
		...
		query.append("                                                  ,COPY     Q  -- IOC 오 묶기 위한것(1 ~ 5)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(" SELECT VP.VVD" ).append("\n"); 
		...
		query.append("       ,VP.CARRIER_CD" ).append("\n"); 
		query.append("       ,VP.LOAD_TEU_TTL" ).append("\n"); 
		query.append("       ,VP.LOAD_WGT_TTL" ).append("\n"); 
		query.append("       ,VP.AVG_CMPB" ).append("\n"); 
		query.append("       ,VP.VIEW_TYPE" ).append("\n"); 
		query.append("       ,R.IS_R01" ).append("\n"); 
		query.append("	   ,R1.IS_R02" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		query.append(" SELECT  VP.VVD" ).append("\n"); 
		query.append("        ,VP.RLANE_CD" ).append("\n"); 
		query.append("        ,VP.CLPT_SEQ" ).append("\n"); 
		query.append("        ,VP.POL_PORT" ).append("\n"); 
		query.append("        ,NVL(VP.POL_YD_CD,'TTL') AS POL_YD_CD" ).append("\n"); 
		query.append("        ,VP.POL_TML_CD" ).append("\n"); 
		query.append("        ,VP.POL_ETA" ).append("\n"); 
		query.append("        ,VP.POL_ETD" ).append("\n"); 
		query.append("        ,VP.POD_PORT" ).append("\n"); 
		...
		query.append("        ,VP.POD_ETD" ).append("\n"); 
		query.append("        ,VP.CARRIER_CD" ).append("\n"); 
		query.append("        ,ROUND(LC.LOAD_TEU_TTL) AS LOAD_TEU_TTL" ).append("\n"); 
		query.append("        ,ROUND(LC.LOAD_WGT_TTL) AS LOAD_WGT_TTL" ).append("\n"); 
		query.append("        ,NVL(ROUND(AVG(VP.AVG_CMPB)),0) AS AVG_CMPB" ).append("\n"); 
		...
		query.append("                 ) Z" ).append("\n"); 
		query.append("           WHERE 1 = 1" ).append("\n"); 
		query.append("             AND VP.RLANE_CD   = Z.RLANE_CD   (+)" ).append("\n"); 
		...
		query.append("   WHERE VP.VVD        = LC.BASE_VVD(+)" ).append("\n"); 
		query.append("     AND VP.POL_YD_CD  = LC.PORT_CD(+)" ).append("\n"); 
		query.append("     AND VP.RLANE_CD   = LC.RLANE_CD(+)" ).append("\n"); 
		query.append("   GROUP BY GROUPING SETS (" ).append("\n"); 
		query.append("                             (VP.VVD,VP.RLANE_CD,VP.CLPT_SEQ,VP.POL_PORT,VP.POL_YD_CD,VP.POL_TML_CD,VP.POL_ETA,VP.POL_ETD,VP.POD_PORT,VP.POD_YD_CD,VP.POD_TML_CD,VP.POD_ETA,VP.POD_ETD,VP.CARRIER_CD,ROUND(LC.LOAD_TEU_TTL),ROUND(LC.LOAD_WGT_TTL))," ).append("\n"); 
		query.append("                             (VP.VVD)" ).append("\n"); 
		query.append("                          )" ).append("\n"); 
		query.append("         ) VP" ).append("\n"); 
		...
		query.append("         NVL((SELECT 1  -- 20131211 ???" ).append("\n"); 
		query.append("                        FROM SPC_HD_HUL_MST HD" ).append("\n"); 
		query.append("                       WHERE HD.RLANE_CD = @[lane]" ).append("\n"); 
		query.append("                         AND HD.DIR_CD   = SUBSTR(VP.VVD,9,1)" ).append("\n"); 
		query.append("                         AND ROWNUM      = 1" ).append("\n"); 
		query.append("                    ),2)," ).append("\n"); 
		query.append("         MIN(VP.POL_ETA) OVER(PARTITION BY VP.VVD)," ).append("\n"); 
		query.append("         VP.VVD," ).append("\n"); 
		query.append("         NVL(VP.CLPT_SEQ,30)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("--   ORDER BY VP.VVD" ).append("\n"); 
		query.append("--        ,VP.RLANE_CD" ).append("\n"); 
		query.append("--        ,VP.CLPT_SEQ" ).append("\n"); 
