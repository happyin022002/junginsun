...
*@FileName : OTRCommRequestDBDAOSearchOTRCommRequestListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OTRCommRequestDBDAOSearchOTRCommRequestListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOTRCommRequestList
	  * </pre>
	  */
	public OTRCommRequestDBDAOSearchOTRCommRequestListRSQL(){
		setQuery();
		...
		query.append("FileName : OTRCommRequestDBDAOSearchOTRCommRequestListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       NVL(A.PAY_XCH_RT, C.USD_LOCL_XCH_RT) AS PAY_XCH_RT, -- CHM-201323475 : Other Comm. 환율 적용 로직 변경 요청 " ).append("\n"); 
