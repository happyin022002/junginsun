...
*@FileName : ESM_MAS_9999HTMLAction.java
...
public class ESM_MAS_AssignHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_AssignHTMLAction 객체를 생성
	 */
	public ESM_MAS_AssignHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMasAssignEvent event = new EsmMasAssignEvent();
log.debug("\nooooooooooooooESM_MAS_AssignHTMLAction perform");	
    	if(command.isCommand(FormCommand.SEARCHLIST)) {
log.debug("\nooooooooooooooESM_MAS_AssignHTMLAction SEARCHLIST = " + FormCommand.SEARCHLIST);			
			event.setFMasBatCd(JSPUtil.getNull(request.getParameter("f_mas_bat_cd")));
