...
public class TCharterIOContractDAOSelectFmsPayTermRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOSelectFmsPayTermRSQL
	  * </pre>
	  */
	public TCharterIOContractDAOSelectFmsPayTermRSQL(){
		setQuery();
