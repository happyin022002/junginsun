...
*@FileName : SCQuotationMainDBDAOsearchGlineExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCQuotationMainDBDAOsearchGlineExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCQuotationMainDBDAOsearchGlineExistRSQL(){
		setQuery();
		...
		query.append("FileName : SCQuotationMainDBDAOsearchGlineExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM  PRI_SG_MN B" ).append("\n"); 
		...
		query.append(",       PRI_SG_GRP_LOC_DTL B" ).append("\n"); 
		...
		query.append("ORDER BY EFF_DT DESC) AS SEQ" ).append("\n"); 
		...
		query.append(") A, PRI_SG_RT B" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND A.SVC_SCP_CD = B.SVC_SCP_CD" ).append("\n"); 
		query.append("AND A.GLINE_SEQ = B.GLINE_SEQ" ).append("\n"); 
		...
		query.append("AND   C.PRC_CUST_TP_CD = A.PRC_CUST_TP_CD" ).append("\n"); 
		...
		query.append("AND   D.PRC_CUST_TP_CD = A.PRC_CUST_TP_CD" ).append("\n"); 
