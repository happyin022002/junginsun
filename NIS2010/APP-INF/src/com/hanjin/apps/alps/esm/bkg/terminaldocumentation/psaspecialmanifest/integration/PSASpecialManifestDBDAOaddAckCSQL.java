...
*@FileName : PSASpecialManifestDBDAOaddAckCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOaddAckCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSASpecialManifestDBDAOaddAckCSQL(){
		setQuery();
		...
		query.append("FileName : PSASpecialManifestDBDAOaddAckCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_PSA_DG_RCV_ERR (" ).append("\n"); 
