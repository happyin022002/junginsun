...
*@FileName : Kor24ManifestListDBDAOaddBlInfoKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOaddBlInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOaddBlInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOaddBlInfoKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("  INTO BKG_CSTMS_ADV_KR_BL " ).append("\n");
