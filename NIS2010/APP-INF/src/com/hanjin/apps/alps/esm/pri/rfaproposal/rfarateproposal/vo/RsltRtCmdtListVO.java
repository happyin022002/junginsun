...
public class RsltRtCmdtListVO implements Serializable {
	...
	private List<RsltCnoteNoteConvListVO> rsltCnoteNoteConvListVOS = null;
	...
	/**
	 * @return the rsltCnoteNoteConvListVOS
	 */
	public List<RsltCnoteNoteConvListVO> getRsltCnoteNoteConvListVOS() {
		return rsltCnoteNoteConvListVOS;
	}

	/**
	 * @param rsltCnoteNoteConvListVOS the rsltCnoteNoteConvListVOS to set
	 */
	public void setRsltCnoteNoteConvListVOS(List<RsltCnoteNoteConvListVO> rsltCnoteNoteConvListVOS) {
		this.rsltCnoteNoteConvListVOS = rsltCnoteNoteConvListVOS;
	}
