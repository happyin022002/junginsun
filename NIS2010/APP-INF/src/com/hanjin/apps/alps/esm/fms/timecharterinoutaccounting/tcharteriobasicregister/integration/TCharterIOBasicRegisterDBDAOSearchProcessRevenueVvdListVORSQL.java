...
*@FileName : TCharterIOBasicRegisterDBDAOSearchProcessRevenueVvdListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOBasicRegisterDBDAOSearchProcessRevenueVvdListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Processl Revenue Vvd List
	  * </pre>
	  */
	public TCharterIOBasicRegisterDBDAOSearchProcessRevenueVvdListVORSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOBasicRegisterDBDAOSearchProcessRevenueVvdListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM MDM_REV_LANE M, FMS_ESTM_REV_VVD A" ).append("\n"); 
