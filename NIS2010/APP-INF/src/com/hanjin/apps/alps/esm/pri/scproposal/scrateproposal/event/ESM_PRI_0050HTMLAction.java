 ...
 *@FileName : ESM_PRI_0050HTMLAction.java
...
public class ESM_PRI_0050HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0050Event event = new EsmPri0050Event();
