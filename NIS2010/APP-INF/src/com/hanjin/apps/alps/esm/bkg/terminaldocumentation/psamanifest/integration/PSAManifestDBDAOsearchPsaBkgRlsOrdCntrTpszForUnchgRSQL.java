...
*@FileName : PSAManifestDBDAOsearchPsaBkgRlsOrdCntrTpszForUnchgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOsearchPsaBkgRlsOrdCntrTpszForUnchgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSAManifestDBDAOsearchPsaBkgRlsOrdCntrTpszForUnchgRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOsearchPsaBkgRlsOrdCntrTpszForUnchgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", PSA_IF_CD RO_FI" ).append("\n"); 
