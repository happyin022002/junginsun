...
*@FileName : UsWharfageDecMgtDBDAOaddBkgUsaWhfSndQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOaddBkgUsaWhfSndQtyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOaddBkgUsaWhfSndQtyCSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOaddBkgUsaWhfSndQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_USA_WHF_SND_QTY (" ).append("\n"); 
