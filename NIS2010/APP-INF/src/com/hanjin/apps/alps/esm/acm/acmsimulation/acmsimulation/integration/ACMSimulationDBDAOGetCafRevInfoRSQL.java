...
*@FileName : ACMSimulationDBDAOGetCafRevInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOGetCafRevInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOGetCafRevInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOGetCafRevInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
