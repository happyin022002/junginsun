...
*@FileName : ESM_BKG_0904HTMLAction.java
...
public class ESM_BKG_0904HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0904HTMLAction 객체를 생성
	 */
	public ESM_BKG_0904HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0904Event event = new EsmBkg0904Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setRcvId(request.getParameter("rcv_id"));
			event.setExCntrTransmitCondVO((ExCntrTransmitCondVO)getVO(request, ExCntrTransmitCondVO.class));
		}
