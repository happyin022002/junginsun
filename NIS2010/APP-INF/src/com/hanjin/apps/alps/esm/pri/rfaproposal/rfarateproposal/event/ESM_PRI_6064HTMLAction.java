...
public class ESM_PRI_6064HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6016HTMLAction 객체를 생성
	 */
	public ESM_PRI_6064HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6064Event event = new EsmPri6064Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			RsltPriPrsCostListVO[] vos = (RsltPriPrsCostListVO[])getVOs(request, RsltPriPrsCostListVO .class);
			event.setRsltPriPrsCostListVOS(vos);	
			PriRpScpRtUsdRoutCsVO routCsVO = (PriRpScpRtUsdRoutCsVO)getVO(request, PriRpScpRtUsdRoutCsVO .class);
			event.setPriRpScpRtUsdRoutCsVO(routCsVO); 
