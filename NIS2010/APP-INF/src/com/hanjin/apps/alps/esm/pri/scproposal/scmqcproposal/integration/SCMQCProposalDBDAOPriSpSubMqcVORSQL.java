...
*@FileName : SCMQCProposalDBDAOPriSpSubMqcVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAOPriSpSubMqcVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_sub_mqc select
	  * </pre>
	  */
	public SCMQCProposalDBDAOPriSpSubMqcVORSQL(){
		setQuery();
		...
		query.append("FileName : SCMQCProposalDBDAOPriSpSubMqcVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
