...
public class NetworkDistributionDBDAOApplyToPL1CSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               ,SUM(DECODE(NO,1,N1ST_ASGN_AMT,0))                                                                       AS N1ST_ASGN_AMT" ).append("\n"); 
		...
		query.append("                        ,SUM(N1ST_ASGN_AMT)            N1ST_ASGN_AMT" ).append("\n"); 
		...
		query.append("                                ,NVL(B.HJS_SLS_AMT, 0) + NVL(B.N1ST_ASGN_AMT, 0) + NVL(B.IPT_ASGN_AMT, 0)+NVL(B.CO_AMT,0)  AS ESTM_PL_AMT" ).append("\n"); 
		...
		query.append("                                ,NVL(B.HJS_SLS_AMT, 0) + NVL(B.N1ST_ASGN_AMT, 0) + NVL(B.IPT_ASGN_AMT, 0)                  AS HJS_SLS_AMT2     /*HJS비율 금액*/" ).append("\n"); 
		...
		query.append("                                ,NVL(B.N1ST_ASGN_AMT, 0)                                                                   AS N1ST_ASGN_AMT " ).append("\n"); 
		...
		query.append("              ,A.HJS_SLS_AMT  = B.HJS_SLS_AMT2" ).append("\n"); 
		query.append("              ,A.CO_AMT       = B.CO_AMT" ).append("\n"); 
		query.append("              ,A.N1ST_ASGN_AMT = B.N1ST_ASGN_AMT" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("           , A.N1ST_ASGN_AMT" ).append("\n"); 
		...
		query.append("           , B.N1ST_ASGN_AMT" ).append("\n"); 
