...
/**
 * ESM_MAS_0120 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0120HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author SHKIM
 * @see ESM_MAS_0120HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmMas0120Event extends EventSupport {
	...
	/** Table Value Object 조회 조건 및 단건 처리  */
	private MasSsnlSltMgmtUtVO masSsnlSltMgmtUtVO = null;
	
	/** Table Value Object Multi Data 처리 */
	private MasSsnlSltMgmtUtVO[] masSsnlSltMgmtUtVOs = null;
	
	/** 입력 Data 처리 */
	private SearchConditionVO searchConditionVO = null;

	public EsmMas0120Event(){}
	...
	public void setMasSsnlSltMgmtUtVO(MasSsnlSltMgmtUtVO masSsnlSltMgmtUtVO){
		this. masSsnlSltMgmtUtVO = masSsnlSltMgmtUtVO;
	}

	public void setMasSsnlSltMgmtUtVOS(MasSsnlSltMgmtUtVO[] masSsnlSltMgmtUtVOs){
		this. masSsnlSltMgmtUtVOs = masSsnlSltMgmtUtVOs;
	}
