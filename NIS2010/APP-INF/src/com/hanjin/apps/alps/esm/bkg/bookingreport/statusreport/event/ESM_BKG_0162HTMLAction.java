...
*@FileName : ESM_BKG_0162HTMLAction.java
...
public class ESM_BKG_0162HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0162HTMLAction 객체를 생성
	 */
	public ESM_BKG_0162HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0162Event event = new EsmBkg0162Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCntrStowageintVO((CntrStowageintVO)getVO(request, CntrStowageintVO .class));
		}
