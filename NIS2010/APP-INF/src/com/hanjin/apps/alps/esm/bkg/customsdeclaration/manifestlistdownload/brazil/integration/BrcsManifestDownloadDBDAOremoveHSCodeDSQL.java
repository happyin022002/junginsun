...
*@FileName : BrcsManifestDownloadDBDAOremoveHSCodeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BrcsManifestDownloadDBDAOremoveHSCodeDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BrcsManifestDownloadDBDAOremoveHSCodeDSQL(){
		setQuery();
		...
		query.append("FileName : BrcsManifestDownloadDBDAOremoveHSCodeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
