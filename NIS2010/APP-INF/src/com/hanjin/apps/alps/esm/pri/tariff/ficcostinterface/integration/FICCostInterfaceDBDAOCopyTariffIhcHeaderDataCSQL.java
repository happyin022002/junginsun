...
*@FileName : FICCostInterfaceDBDAOCopyTariffIhcHeaderDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCopyTariffIhcHeaderDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CopyTariffIhcHeaderData
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCopyTariffIhcHeaderDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCopyTariffIhcHeaderDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , @[org_dest_tp_cd]" ).append("\n"); 
		query.append("     , @[ihc_trf_no] " ).append("\n"); 
		query.append("     , HDR.COST_TRF_NO" ).append("\n"); 
		query.append("     , @[cost_cnt_cd]" ).append("\n"); 
		query.append("     , @[rhq_cd]" ).append("\n"); 
		query.append("     , @[cre_usr_id]" ).append("\n"); 
		...
		query.append("   AND HDR.IHC_TRF_NO     = @[ori_ihc_trf_no]" ).append("\n"); 
