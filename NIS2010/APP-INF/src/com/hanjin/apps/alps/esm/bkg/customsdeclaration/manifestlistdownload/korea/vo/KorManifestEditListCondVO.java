...
*@FileName : KorManifestEditListCondVO.java
*@FileTitle : KorManifestEditListCondVO
*Open Issues :
*Change history :
 ...
 * @author 박상훈
 * @since J2EE 1.6
 * @see ManifestEditListCondVO
 */

public class KorManifestEditListCondVO extends ManifestEditListCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorManifestEditListCondVO> models = new ArrayList<KorManifestEditListCondVO>();
	...
	public KorManifestEditListCondVO() {}

	public KorManifestEditListCondVO(String ibflag, String pagerows, String transTp, String blNo, String cstmsDeclTpCd, String portCd, String userId) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return KorManifestEditListCondVO[]
	 */
	public KorManifestEditListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorManifestEditListCondVO[]
	 */
	public KorManifestEditListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorManifestEditListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new KorManifestEditListCondVO();
				if (ibflag[i] != null)
		...
		return getKorManifestEditListCondVOs();
	}
	 ...
	 * @return KorManifestEditListCondVO[]
	 */
	public KorManifestEditListCondVO[] getKorManifestEditListCondVOs(){
		KorManifestEditListCondVO[] vos = (KorManifestEditListCondVO[])models.toArray(new KorManifestEditListCondVO[models.size()]);
		return vos;
	}
