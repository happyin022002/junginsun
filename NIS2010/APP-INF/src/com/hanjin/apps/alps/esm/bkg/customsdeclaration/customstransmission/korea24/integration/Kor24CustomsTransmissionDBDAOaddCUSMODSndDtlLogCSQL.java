...
*@FileName : Kor24CustomsTransmissionDBDAOaddCUSMODSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddCUSMODSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CUSMOD 전송 Detail 내역(Flat File)을 add한다.
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddCUSMODSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddCUSMODSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_KR_SND_LOG_DTL (" ).append("\n");
		...
		query.append("SELECT	'SCA'," ).append("\n");
		...
		query.append("WHERE	MSG_LOG_TP_ID	= 'SCA'" ).append("\n");
