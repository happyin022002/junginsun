...
*@FileName : SCRateQuotationDBDAOPriSqRtScgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtScgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtScgVODSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtScgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
