...
*@FileName : RfaOftAutoRatingDBDAOSearchRfaAmericaOftAutoratingListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RfaOftAutoRatingDBDAOSearchRfaAmericaOftAutoratingListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchRfaAmericaOftAutoratingList
	  * </pre>
	  */
	public RfaOftAutoRatingDBDAOSearchRfaAmericaOftAutoratingListRSQL(){
		setQuery();
		...
		query.append("FileName : RfaOftAutoRatingDBDAOSearchRfaAmericaOftAutoratingListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
