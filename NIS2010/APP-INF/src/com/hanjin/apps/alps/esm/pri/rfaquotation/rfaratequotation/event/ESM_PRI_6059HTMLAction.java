 ...
 *@FileName : ESM_PRI_6059HTMLAction.java
...
public class ESM_PRI_6059HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6059HTMLAction 객체를 생성
	 */
	public ESM_PRI_6059HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri6059Event event = new EsmPri6059Event();
