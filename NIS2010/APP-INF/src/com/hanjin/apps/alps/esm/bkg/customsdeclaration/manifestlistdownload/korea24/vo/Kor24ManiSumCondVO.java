...
*@FileName : Kor24ManifestSmryVO.java
*@FileTitle : Kor24ManifestSmryVO
*Open Issues :
*Change history :
...
public class Kor24ManiSumCondVO extends ManiSumCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ManiSumCondVO> models = new ArrayList<Kor24ManiSumCondVO>();
	...
	public Kor24ManiSumCondVO() {}

	public Kor24ManiSumCondVO(String ibflag, String pagerows, String mrnNo, String vvd, String vvdSeq, String inType, String portCd, String podTml, String userId, String ofcCd, String podCd, String polCd, String ioBndCd, String tmlCd) {
	 ...
	 * @param request
	 * @return Kor24ManifestSmryVO[]
	 */
	public Kor24ManiSumCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24ManifestSmryVO[]
	 */
	public Kor24ManiSumCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ManiSumCondVO model = null;
		...
		return getKor24ManifestSmryVOs();
	}
	 ...
	 * @return Kor24ManifestSmryVO[]
	 */
	public Kor24ManiSumCondVO[] getKor24ManifestSmryVOs(){
		Kor24ManiSumCondVO[] vos = (Kor24ManiSumCondVO[])models.toArray(new Kor24ManiSumCondVO[models.size()]);
		return vos;
	}
