...
*@FileName : ACMCustomerInfoDBDAORemoveFFVendorMatchListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMCustomerInfoDBDAORemoveFFVendorMatchListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCustomerInfoDBDAORemoveFFVendorMatchListDSQL(){
		setQuery();
		...
		query.append("FileName : ACMCustomerInfoDBDAORemoveFFVendorMatchListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_FF_VNDR_MTCH" ).append("\n"); 
