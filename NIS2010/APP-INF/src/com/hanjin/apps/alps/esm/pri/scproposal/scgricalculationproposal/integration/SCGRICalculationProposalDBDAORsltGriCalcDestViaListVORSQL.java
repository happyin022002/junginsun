...
*@FileName : SCGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAORsltGriCalcDestViaListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_SP_SCP_GRI_ROUT_VIA A" ).append("\n"); 
