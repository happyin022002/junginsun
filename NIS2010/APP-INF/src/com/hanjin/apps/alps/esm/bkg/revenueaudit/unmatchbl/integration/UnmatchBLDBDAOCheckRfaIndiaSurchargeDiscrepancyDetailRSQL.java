...
*@FileName : UnmatchBLDBDAOCheckRfaIndiaSurchargeDiscrepancyDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckRfaIndiaSurchargeDiscrepancyDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * India에 대하여 RFA SurchargeDiscrepancy Detail 를 조회한다.
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckRfaIndiaSurchargeDiscrepancyDetailRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckRfaIndiaSurchargeDiscrepancyDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
