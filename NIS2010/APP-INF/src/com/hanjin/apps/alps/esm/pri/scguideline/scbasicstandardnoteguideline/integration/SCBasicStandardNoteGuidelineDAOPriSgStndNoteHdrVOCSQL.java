...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrVOCSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[note_ref_yr]," ).append("\n"); 
		query.append("@[note_nm]," ).append("\n"); 
		query.append("decode(NVL(@[cfm_flg],''),'','N','No','N','Yes','Y',@[cfm_flg])," ).append("\n"); 
		query.append("@[cfm_usr_id]," ).append("\n"); 
		query.append("@[cre_usr_id]," ).append("\n"); 
