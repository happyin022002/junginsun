...
*@FileName : ArrivalNoticeDBDAOsearchArrNtcMatchCustListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ArrivalNoticeDBDAOsearchArrNtcMatchCustListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Inquery Arrival Notice Customer Validation Match Customer List
	  * </pre>
	  */
	public ArrivalNoticeDBDAOsearchArrNtcMatchCustListRSQL(){
		setQuery();
		...
		query.append("FileName : ArrivalNoticeDBDAOsearchArrNtcMatchCustListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      /* CHM-201432769 Validate Date 항목  추가 요청 및 - 홍우리 대리 */" ).append("\n"); 
		query.append("      , TO_CHAR(RSLT.VAL_DT,'YYYY-MM-DD HH24:MI:SS') AS VAL_DT" ).append("\n"); 
		query.append("" ).append("\n"); 
