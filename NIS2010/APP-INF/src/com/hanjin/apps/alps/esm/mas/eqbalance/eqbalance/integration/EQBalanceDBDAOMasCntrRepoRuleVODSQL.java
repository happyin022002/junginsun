...
*@FileName : EQBalanceDBDAOMasCntrRepoRuleVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOMasCntrRepoRuleVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQBalanceDBDAOMasCntrRepoRuleVODSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOMasCntrRepoRuleVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE MAS_CNTR_REPO_RULE" ).append("\n"); 
