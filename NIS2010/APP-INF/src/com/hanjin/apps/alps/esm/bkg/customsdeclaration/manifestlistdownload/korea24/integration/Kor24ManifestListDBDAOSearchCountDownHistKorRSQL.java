...
*@FileName : Kor24ManifestListDBDAOSearchCountDownHistKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchCountDownHistKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchCountDownHistKorRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchCountDownHistKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
}