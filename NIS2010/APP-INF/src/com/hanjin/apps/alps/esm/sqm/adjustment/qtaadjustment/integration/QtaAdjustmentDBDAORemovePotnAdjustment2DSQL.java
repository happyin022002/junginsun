...
*@FileName : QtaAdjustmentDBDAORemovePotnAdjustment2DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAORemovePotnAdjustment2DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public QtaAdjustmentDBDAORemovePotnAdjustment2DSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAORemovePotnAdjustment2DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND (@[f_bse_yr]||@[f_bse_qtr_cd] IN ('20161Q', '20162Q') OR @[f_bse_yr] < '2016') --2016 2Q까지만 작동하게 함. 2016 3Q부터 IAS는 OVERALL, SECTOR 이원화하여 관리" ).append("\n"); 
