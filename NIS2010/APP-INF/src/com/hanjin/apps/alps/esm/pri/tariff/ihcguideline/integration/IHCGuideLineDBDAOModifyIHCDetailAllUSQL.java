...
*@FileName : IHCGuideLineDBDAOModifyIHCDetailAllUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOModifyIHCDetailAllUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 엑셀 업로드 전 IHC_RT_RMK 를 null로 초기화 한다.
	  * </pre>
	  */
	public IHCGuideLineDBDAOModifyIHCDetailAllUSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOModifyIHCDetailAllUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET IHC_RT_RMK = ''" ).append("\n"); 
