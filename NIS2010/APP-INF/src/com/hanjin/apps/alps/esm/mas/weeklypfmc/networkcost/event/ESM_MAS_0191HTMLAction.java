...
**@FileName : ESM_MAS_0191HTMLAction.java
 ...
 * @author Je Ryang Yoo
 * @see EsmMas0191Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0191HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0191HTMLAction 객체를 생성
	 */
	public ESM_MAS_0191HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0191Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0191Event event = new EsmMas0191Event();  	
    			
		// 조회
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMASCreateMonitorVO((MASCreateMonitorVO)getVO(request, MASCreateMonitorVO.class));			
		}
		// 저장
		/*else if(command.isCommand(FormCommand.MULTI)) {			
			event.setMASCreateMonitorVOs((MASCreateMonitorVO[])getVOs(request, MASCreateMonitorVO.class, ""));			
		}*/
		else {
			event.setMASCreateMonitorVO((MASCreateMonitorVO)getVO(request, MASCreateMonitorVO.class));
