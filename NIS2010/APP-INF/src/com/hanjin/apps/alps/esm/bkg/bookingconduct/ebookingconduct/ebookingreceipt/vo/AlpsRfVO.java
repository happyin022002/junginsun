...
public class AlpsRfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AlpsRfVO> models = new ArrayList<AlpsRfVO>();
	...
	public AlpsRfVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String rcSeq, String cntrTpszCd, String status, String cmdtCd, String cmdtDesc, String fdoTemp, String cdoTemp, String pwrSplCblFlg, String ventRto, String clngTpCd, String humidNo, String maxRcSeq, String cntrVentTpCd, String diffRmk) {
		this.rcSeq = rcSeq;
	 ...
	 * @return NisRfVO[]
	 */
	public AlpsRfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NisRfVO[]
	 */
	public AlpsRfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AlpsRfVO model = null;
	 ...
	 * @return NisRfVO[]
	 */
	public AlpsRfVO[] getNisRfVOs(){
		AlpsRfVO[] vos = (AlpsRfVO[])models.toArray(new AlpsRfVO[models.size()]);
		return vos;
	}
