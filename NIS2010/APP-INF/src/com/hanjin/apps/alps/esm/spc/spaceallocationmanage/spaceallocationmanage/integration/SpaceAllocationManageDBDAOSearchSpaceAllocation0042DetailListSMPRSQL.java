...
*@FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailListSMPRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailListSMPRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [ESM_SPC_0042] 성수기 항차의 detail 정보를 조회합니다.
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailListSMPRSQL(){
		setQuery();
		setQuery2();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0042DetailListSMPRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n"); 
		query.append("--2014.08.13 all_pol관련 option" ).append("\n"); 
		...
		query.append("           -- 2015.01.08 SPC_ALOC_LANE_CTRL_OPT_DTL의 Key추가 " ).append("\n"); 
		query.append("           -- DECODE(NVL(REPLACE(D.SC_NO||D.RFA_NO, '*', ''), '*'), '*', D.CTRL_LOC_ACCT_CD, REPLACE(D.SC_NO||D.RFA_NO, '*', '')) AS CTRL_LOC_ACCT_CD," ).append("\n"); 
		...
		query.append("           -- 2015.02.16 LOC제거/ECC GROUP 추가" ).append("\n"); 
		query.append("           --NVL(DECODE(A.CTRL_ECC_FLG, 'Y', 'E', DECODE(A.CTRL_ECC_GRP_FLG, 'Y', 'G', 'N')), 'N') AS CTRL_DEST, -- E:ECC, G:ECC GROUP" ).append("\n"); 
		...
		query.append("                     DECODE(V.HH_FLG, 'Y', COST_YRWK||'-'||VER_SEQ, '200001-1')" ).append("\n"); 
		...
		query.append("                               PL.HH_FLG        ," ).append("\n"); 
		query.append("                               PL.VSL_CD        ," ).append("\n"); 
		query.append("                               PL.SKD_VOY_NO    ," ).append("\n"); 
		query.append("                               PL.SKD_DIR_CD    ," ).append("\n"); 
		query.append("                               SUBSTR(PL.SEASON, 1, 6) AS SEASON    ," ).append("\n"); 
		query.append("                               SUBSTR(PL.SEASON, 8)    AS VER_SEQ   ," ).append("\n"); 
		...
		query.append("                               PL.SKD_VOY_NO    ," ).append("\n"); 
		query.append("                               PL.SKD_DIR_CD    ," ).append("\n"); 
		query.append("                               SUBSTR(PL.SEASON, 1, 6)," ).append("\n"); 
		query.append("                               SUBSTR(PL.SEASON, 8)   ," ).append("\n"); 
		...
		query.append("     GROUP BY REP_TRD_CD       , --20140821" ).append("\n"); 
		query.append("           REP_SUB_TRD_CD      ," ).append("\n"); 
		query.append("           RLANE_CD            ," ).append("\n"); 
		query.append("           DIR_CD              ," ).append("\n"); 
		query.append("           TRD_CD              ," ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",RFA_BKG_DATA AS ( --20140821" ).append("\n"); 
		query.append("SELECT DISTINCT CUST_CNT_CD||LPAD(CUST_SEQ,6,'0') AS SHP_CUST_CD," ).append("\n"); 
		query.append("       POL_CD AS RFA_POL_CD," ).append("\n"); 
		query.append("       POD_CD AS RFA_POD_CD," ).append("\n"); 
		...
		query.append("           -- conversion된 Office들이 BKG에 있는경우처리(ex:JKTBB)" ).append("\n"); 
		query.append("           SPC_SCR_OFC_CONV_FNC(SLS_OFC_CD) AS SLS_OFC_CD," ).append("\n"); 
		query.append("           COST_YR             ," ).append("\n"); 
		query.append("           COST_WK             ," ).append("\n"); 
		query.append("           IOC_CD              ," ).append("\n"); 
		query.append("           --SPC_MDL_CUST_CTRL에 CUST_CTRL_CD가 존재하면 먼저 적용. 존재하지 않으면서 AES_FLG = 'Y'일때 SPC_MDL_CUST_RFA 테이블에 있는  CUST_CTRL_CD적용." ).append("\n"); 
		query.append("           CASE WHEN A.SMP_CUST_CTRL_CD IS NOT NULL          " ).append("\n"); 
		query.append("                THEN A.CUST_CTRL_CD" ).append("\n"); 
		query.append("                ELSE (CASE WHEN A.AES_FLG = 'Y' " ).append("\n"); 
		query.append("                           THEN NVL(RD.CUST_CTRL_CD,'C')                         " ).append("\n"); 
		query.append("                           ELSE A.CUST_CTRL_CD" ).append("\n"); 
		query.append("                      END)" ).append("\n"); 
		...
		query.append("                     --CASE WHEN A.TRD_CD = 'AES' AND A.RFA_NO IS NULL AND A.SHP_CUST_CNT_CD = 'CN' AND A.IOC_CD != 'T' AND A.SC_NO IS NULL THEN" ).append("\n"); 
		query.append("                     --       'Y'" ).append("\n"); 
		query.append("                     --ELSE   " ).append("\n"); 
		query.append("                     --       'N'" ).append("\n"); 
		query.append("                     --END  AS AES_FLG,  " ).append("\n"); 
		query.append("                     CASE WHEN (A.TRD_CD = 'AES' OR A.TRD_CD = 'IAS')   " ).append("\n"); 
		query.append("                               AND A.SHP_CUST_CNT_CD = 'CN' " ).append("\n"); 
		query.append("                               AND A.IOC_CD != 'T' " ).append("\n"); 
		query.append("                          THEN 'Y'" ).append("\n"); 
		query.append("                          ELSE 'N'" ).append("\n"); 
		query.append("                     END AS AES_FLG,   " ).append("\n"); 
		query.append("                     M.CUST_CTRL_CD AS SMP_CUST_CTRL_CD," ).append("\n"); 
		query.append("                     DECODE(A.IOC_CD, 'T', 'C', NVL(M.CUST_CTRL_CD, 'C')) AS CUST_CTRL_CD," ).append("\n"); 
		...
		query.append("                     A.POL_CONTI           ," ).append("\n"); 
		query.append("                     A.OFC_CONTI           ," ).append("\n"); 
		query.append("                     A.POL_SKIP            ," ).append("\n"); 
		query.append("                     A.POD_SKIP            ," ).append("\n"); 
		...
		query.append("                     A.ALOC_STS_CD         , --2015.03.12" ).append("\n"); 
		...
		query.append("                     TO_NUMBER(NVL(SUBSTR(A.CM_VAL,  1, 10), 0)) AS CM_OP          ," ).append("\n"); 
		query.append("                     TO_NUMBER(NVL(SUBSTR(A.CM_VAL, 11, 10), 0)) AS CM_OC          ," ).append("\n"); 
		query.append("                     TO_NUMBER(NVL(SUBSTR(A.CM_VAL, 21, 10), 0)) AS CM_VL          ," ).append("\n"); 
		query.append("                     A.SHP_CUST_CNT_CD||LPAD(A.SHP_CUST_SEQ,6,'0')  AS SHP_CUST_CD, " ).append("\n"); 
		...
		query.append("                               VPP.VER_SEQ       ," ).append("\n"); 
		...
		query.append("                               SPC_GET_SMP_AMEND_FNC(VPP.TRD_CD, VPP.SEASON, VPP.VER_SEQ, B.SC_NO) AS SC_NO," ).append("\n"); 
		query.append("                               " ).append("\n"); 
		...
		query.append("                               SPC_GET_SMP_AMEND_FNC(VPP.TRD_CD, VPP.SEASON, VPP.VER_SEQ, DECODE(SUBSTR(B.RFA_NO, 1, 3), 'DUM', '', B.RFA_NO)) AS RFA_NO," ).append("\n"); 
		...
		query.append("                               NVL((" ).append("\n"); 
		query.append("                                    SELECT DISTINCT(D.CTRL_LOC_ACCT_CD)  --20140821" ).append("\n"); 
		...
		query.append("                               B.ALOC_STS_CD         , --2015.03.12 / ALOC_STS_CD = S 인 경우에 대한 SUM 을 위해 필요" ).append("\n"); 
		query.append("                               (" ).append("\n"); 
		query.append("                                  SELECT" ).append("\n"); 
		...
		query.append("                           -- 2015.02.16 BOOKING 확인 결과 cargo type 수정" ).append("\n"); 
		...
		query.append("             ) A, RFA_BKG_DATA RD" ).append("\n"); 
		query.append("       WHERE A.SHP_CUST_CD = RD.SHP_CUST_CD(+) " ).append("\n"); 
		query.append("         AND A.BKG_POL_CD  = RD.RFA_POL_CD(+)" ).append("\n"); 
		query.append("         AND A.BKG_POD_CD  = RD.RFA_POD_CD(+)" ).append("\n"); 
		query.append("         AND A.CMDT_CD     = RD.CMDT_CD(+)" ).append("\n"); 
		query.append("           " ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(", SPC_DLY_FCAST_CUST_TEMP AS (" ).append("\n"); 
		query.append("    SELECT VPP.SEASON, VPP.VER_SEQ," ).append("\n"); 
		query.append("           F.IOC_TS_CD, F.SLS_RHQ_CD, F.SLS_AQ_CD, F.SLS_RGN_OFC_CD, F.CFM_TTL_QTY, F.CFM_40FT_HC_QTY, F.CFM_45FT_HC_QTY, F.CFM_53FT_QTY, F.CFM_RF_QTY, F.CFM_TTL_WGT, " ).append("\n"); 
		query.append("           F.RLANE_CD , F.DIR_CD    , F.VSL_CD   , F.SKD_VOY_NO    , F.SKD_DIR_CD , F.POL_YD_CD      , F.POD_YD_CD      , F.CUST_CNT_CD , F.CUST_SEQ  , F.TRD_CD     ," ).append("\n"); 
		query.append("           F.SC_NO    , F.RFA_NO," ).append("\n"); 
		query.append("           -- 2014.07.28 컬럼 추가" ).append("\n"); 
		query.append("           F.USA_BKG_MOD_CD, F.DEST_LOC_CD," ).append("\n"); 
		query.append("           F.FCAST_20FT_DRY_QTY, F.FCAST_40FT_DRY_QTY, F.FCAST_RD_QTY, " ).append("\n"); 
		query.append("           F.CFM_20FT_DRY_QTY, F.CFM_40FT_DRY_QTY, F.CFM_RD_QTY, " ).append("\n"); 
		query.append("           F.USD_BKG_20FT_DRY_QTY, F.USD_BKG_40FT_DRY_QTY, F.USD_BKG_RD_QTY," ).append("\n"); 
		query.append("           F.POL_IND_SEQ, F.POD_IND_SEQ,           " ).append("\n"); 
		query.append("           VPP.POL_YD_SEQ," ).append("\n"); 
		query.append("           VPP.POD_YD_SEQ," ).append("\n"); 
		query.append("           VPP.POL_CD," ).append("\n"); 
		query.append("           VPP.POD_CD" ).append("\n"); 
		...
		query.append("--           2014.08.21" ).append("\n"); 
		query.append("--           SUM(GUIDE)          AS GUIDE         , " ).append("\n"); 
		query.append("           MAX(GUIDE)          AS GUIDE         , " ).append("\n"); 
		query.append("           MAX(OFC_TTL_GUIDE)  AS OFC_TTL_GUIDE, " ).append("\n"); 
		query.append("           MAX(CTRL_TTL_GUIDE) AS CTRL_TTL_GUIDE, " ).append("\n"); 
		query.append("           MAX(GUIDE_TTL)      AS GUIDE_TTL, --CHM-201431038 SPC기능보완요청" ).append("\n"); 
		...
		query.append("           DECODE(POD_CD, '0000000', MAX(CFM_FLG)) AS CFM_FLG," ).append("\n"); 
		query.append("           -- 2014.07.28" ).append("\n"); 
		...
		query.append("           SUM(DECODE(FLG, 'L', 0, 1))                  AS NMDL_MD              ," ).append("\n"); 
		...
		query.append("                     0 OFC_TTL_GUIDE,  " ).append("\n"); 
		query.append("                     0 AS CTRL_TTL_GUIDE, " ).append("\n"); 
		query.append("                     0 AS GUIDE_TTL, --CHM-201431038 SPC기능보완요청" ).append("\n"); 
		...
		query.append("                     0 AS BS_TEU," ).append("\n"); 
		query.append("                     0 AS BS_WGT," ).append("\n"); 
		...
		query.append("                )" ).append("\n"); 
		query.append("--                 AND (VPP.COST_YR || VPP.COST_WK < '201427' OR (VPP.COST_YR || VPP.COST_WK >= '201427' AND VPP.IOC_CD <>'I'))" ).append("\n"); 
		...
		query.append("                     MQ.LOD_QTY * (MQ.GRS_RPB_REV - MQ.PA_CM_UC_AMT) AS BKG_QTA_CMB," ).append("\n"); 
		query.append("                     0 AS GUIDE  ," ).append("\n"); 
		query.append("                     0 OFC_TTL_GUIDE,  0 AS CTRL_TTL_GUIDE, 0 AS GUIDE_TTL, --CHM-201431038 SPC기능보완요청" ).append("\n"); 
		query.append("                     0 AS FC_TEU ," ).append("\n"); 
		query.append("                     0 AS FC_HC  ," ).append("\n"); 
		query.append("                     0 AS FC_45  ," ).append("\n"); 
		query.append("                     0 AS FC_53  ," ).append("\n"); 
		...
		query.append("                 AND VPP.COST_YR || VPP.COST_WK BETWEEN O.OFC_APLY_FM_YRWK AND O.OFC_APLY_TO_YRWK" ).append("\n"); 
		query.append("                 -- IPC SQM 추가 2014.06.26" ).append("\n"); 
		query.append("                 AND VPP.COST_YR || VPP.COST_WK >= '201427' " ).append("\n"); 
		...
		query.append("                                -- 2015.04.06 office가 입력되지 않은 case는 전체 office에 걸리도록 함." ).append("\n"); 
		query.append("								AND (( DECODE(IOC_TS_CD, 'T', F.SLS_RGN_OFC_CD, F.SLS_RGN_OFC_CD) IN " ).append("\n"); 
		query.append("                                              (SELECT OFC.OFC_CD" ).append("\n"); 
		query.append("                                                 FROM SPC_ALOC_LANE_CTRL_OFC OFC" ).append("\n"); 
		query.append("                                                WHERE D.RLANE_CD           = OFC.RLANE_CD" ).append("\n"); 
		query.append("								                  AND D.TRD_CD             = OFC.TRD_CD" ).append("\n"); 
		...
		query.append("                                                                                                              WHERE B.LOC_CD = DECODE(M.CTRL_DEST_LVL,'T', F.DEST_LOC_CD, SUBSTR(F.POD_YD_CD, 1, 5))" ).append("\n"); 
		...
		query.append("--                                                                                                                      FROM MDM_EQ_ORZ_CHT A,  " ).append("\n"); 
		query.append("--                                                                                                                           MDM_LOCATION C " ).append("\n"); 
		query.append("--                                                                                                                     WHERE C.LOC_CD = DECODE(M.CTRL_DEST_LVL,'T',F.DEST_LOC_CD,SUBSTR(F.POD_YD_CD, 1, 5))" ).append("\n"); 
		query.append("--                                                                                                                       AND A.SCC_CD = C.SCC_CD)" ).append("\n"); 
		query.append("                        ),'OTHERS')" ).append("\n"); 
		query.append("                     ELSE" ).append("\n"); 
		query.append("                        'OTHERS'" ).append("\n"); 
		...
		query.append("                     NULL AS SPC_CTRL_ALOC_POL_RMK," ).append("\n"); 
		query.append("                     NULL AS SPC_CTRL_ALOC_POD_RMK" ).append("\n"); 
		query.append("                FROM SPC_DLY_FCAST_CUST_TEMP F  ," ).append("\n"); 
		query.append("                     VVD_POL_POD        VPP," ).append("\n"); 
		...
		query.append("                 AND F.SKD_DIR_CD = VPP.SKD_DIR_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                 AND F.POL_CD      = VPP.POL_CD" ).append("\n"); 
		query.append("                 AND F.POD_CD      = VPP.POD_CD" ).append("\n"); 
		query.append("                 AND F.POL_YD_SEQ  = VPP.POL_YD_SEQ" ).append("\n"); 
		query.append("                 AND F.POD_YD_SEQ  = VPP.POD_YD_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                 AND F.SEASON      = C.COST_YRWK(+)" ).append("\n"); 
		query.append("                 AND F.VER_SEQ     = C.VER_SEQ(+)" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("                     US_MOD          ," ).append("\n"); 
		query.append("                     -- 2014.08.02 [CHM-201431081] SPC Allocation Control Option 추가 보완 요청" ).append("\n"); 
		query.append("                     -- booking table의 contract office 기준" ).append("\n"); 
		query.append("                     ACCOUNT_CD      ," ).append("\n"); 
		...
		query.append("                     0 AS FC_D4  ," ).append("\n"); 
		query.append("                     0 AS FC_RD  ," ).append("\n"); 
		query.append("                     (B.BKG_D2FT_QTY)    AS BT_D2 ," ).append("\n"); 
		query.append("                     (B.BKG_D4FT_QTY)    AS BT_D4 ," ).append("\n"); 
		query.append("                     (B.BKG_RD_QTY)    AS BT_RD ," ).append("\n"); 
		query.append("                     0 AS AP_D2  ," ).append("\n"); 
		query.append("                     0 AS AP_D4  ," ).append("\n"); 
		query.append("                     0 AS AP_RD  ," ).append("\n"); 
		...
		query.append("                                           	'OTHERS'" ).append("\n"); 
		query.append("                                          END AS US_MOD," ).append("\n"); 
		query.append("                                          -- 2015.02.16 Empty Repo는 Account 없음 따라서 control option 로직 적용 제외" ).append("\n"); 
		query.append("                                          'OTHERS' AS ACCOUNT_CD ," ).append("\n"); 
		query.append("                                          VPP.OFC_CD AS BASE_RHQ_CD ," ).append("\n"); 
		query.append("                                          VPP.POL_CD                ," ).append("\n"); 
		query.append("                                          VPP.POD_CD                ," ).append("\n"); 
		...
		query.append("--                SELECT 7   AS DIV," ).append("\n"); 
		query.append("--                      'L' AS FLG," ).append("\n"); 
		query.append("--                      V.REP_TRD_CD    ," ).append("\n"); 
		query.append("--                      V.REP_SUB_TRD_CD," ).append("\n"); 
		query.append("--                      V.TRD_CD        ," ).append("\n"); 
		query.append("--                      V.SUB_TRD_CD    ," ).append("\n"); 
		query.append("--                      V.IOC_CD        ," ).append("\n"); 
		query.append("--                      L.CUST_CTRL_CD  ," ).append("\n"); 
		query.append("--                      V.OFC_CD         AS BASE_RHQ_CD," ).append("\n"); 
		query.append("--                      O.N2ND_PRNT_OFC_CD AS RHQ_CD," ).append("\n"); 
		query.append("--                      L.SLS_AQ_CD      AS AREA_CD    ," ).append("\n"); 
		query.append("--                      L.SLS_RGN_OFC_CD AS OFC_CD     ," ).append("\n"); 
		query.append("--                      'OTHERS' AS US_MOD," ).append("\n"); 
		query.append("--                      -- 2014.08.19 Account는 나누지 않도록 변경" ).append("\n"); 
		query.append("----                      CASE WHEN P.CTRL_ACCOUNT = 'Y' THEN" ).append("\n"); 
		query.append("----                                       NVL((SELECT D.CTRL_LOC_ACCT_CD" ).append("\n"); 
		query.append("----                                              FROM SPC_ALOC_LANE_CTRL_OPT_DTL D" ).append("\n"); 
		query.append("----                                             WHERE P.RLANE_CD                           = D.RLANE_CD" ).append("\n"); 
		...
		query.append("----                                               AND P.SKD_DIR_CD                         = D.DIR_CD " ).append("\n"); 
		query.append("----                                               AND D.ALOC_CTRL_TP_CD                    = 'A'  " ).append("\n"); 
		query.append("----                                               AND D.CTRL_LOC_ACCT_CD                   = L.CUST_CNT_CD ||LPAD(L.CUST_SEQ,6,'0')                                        " ).append("\n"); 
		query.append("----                                       ),'OTHERS')" ).append("\n"); 
		query.append("----                      ELSE" ).append("\n"); 
		query.append("----                        'OTHERS'" ).append("\n"); 
		query.append("----                      END AS ACCOUNT_CD," ).append("\n"); 
		...
		query.append("--                      0                AS BKG_QUOTA  ," ).append("\n"); 
		query.append("--                      0                AS BKG_QTA_CMB," ).append("\n"); 
		query.append("--                      RLANE_ADJ_QTY    AS GUIDE      ," ).append("\n"); 
		query.append("----                       OFC_TTL_GUIDE, CTRL_TTL_GUIDE, GUIDE_TTL," ).append("\n"); 
		query.append("--                      0 AS FC_TEU," ).append("\n"); 
		query.append("--                      0 AS FC_HC ," ).append("\n"); 
		query.append("--                      0 AS FC_45 ," ).append("\n"); 
		query.append("--                      0 AS FC_53 ," ).append("\n"); 
		...
		query.append("--                      NULL AS SPC_CTRL_ALOC_POL_RMK," ).append("\n"); 
		query.append("--                      NULL AS SPC_CTRL_ALOC_POD_RMK" ).append("\n"); 
		query.append("--                 FROM SPC_MDL_CUST_REV_LANE L," ).append("\n"); 
		query.append("--                      VVDS                  V," ).append("\n"); 
		query.append("--                      SPC_OFC_LVL           O," ).append("\n"); 
		query.append("--                      PARAMS                P" ).append("\n"); 
		query.append("--                WHERE L.COST_YRWK  = V.SEASON" ).append("\n"); 
		query.append("--                  AND L.VER_SEQ    = V.VER_SEQ" ).append("\n"); 
		query.append("--                  AND L.TRD_CD     = V.TRD_CD" ).append("\n"); 
		query.append("--                  AND L.SUB_TRD_CD = V.SUB_TRD_CD" ).append("\n"); 
		query.append("--                  AND L.RLANE_CD   = V.RLANE_CD" ).append("\n"); 
		query.append("--                  AND V.HH_FLG     = 'Y'" ).append("\n"); 
		query.append("--                  AND (    L.SLS_RHQ_CD = V.OFC_CD" ).append("\n"); 
		query.append("--                        OR L.SLS_RHQ_CD = 'SINRS')" ).append("\n"); 
		query.append("--                  AND NVL(L.RLANE_ADJ_QTY,0)>0" ).append("\n"); 
		query.append("--                  AND O.OFC_CD     = L.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("--                  AND V.COST_YR || V.COST_WK BETWEEN O.OFC_APLY_FM_YRWK AND O.OFC_APLY_TO_YRWK" ).append("\n"); 
		query.append("		-- 2014.07.09 CHM-201431038 SPC기능보완요청 위의 쿼리 대신 아래 사용" ).append("\n"); 
		query.append("              SELECT 7 AS DIV" ).append("\n"); 
		query.append("                   , 'L' AS FLG" ).append("\n"); 
		...
		query.append("                   , A1.CUST_CTRL_CD" ).append("\n"); 
		query.append("                   , A1.BASE_RHQ_CD" ).append("\n"); 
		query.append("                   , A1.RHQ_CD" ).append("\n"); 
		query.append("                   , A1.AREA_CD" ).append("\n"); 
		query.append("                   , A1.OFC_CD" ).append("\n"); 
		query.append("                   ,'OTHERS' AS US_MOD" ).append("\n"); 
		query.append("                   ,'OTHERS' AS ACCOUNT_CD" ).append("\n"); 
		query.append("--                   ,'0000000'        AS POL_CD    " ).append("\n"); 
		query.append("--                   ,'0000000'        AS POD_CD" ).append("\n"); 
		query.append("                   , A2.POL_CD        AS POL_CD    " ).append("\n"); 
		query.append("                   , A2.POD_CD        AS POD_CD" ).append("\n"); 
		query.append("                   ,'OTHERS' AS DEL_CD" ).append("\n"); 
		query.append("--                   ,   0                AS POL_SEQ    " ).append("\n"); 
		query.append("--                   ,   0                AS POD_SEQ    " ).append("\n"); 
		query.append("--                   ,   NULL             AS POL_SKIP  " ).append("\n"); 
		query.append("--                    ,  NULL             AS POD_SKIP   " ).append("\n"); 
		query.append("                   , A2.POL_SEQ              AS POL_SEQ    " ).append("\n"); 
		query.append("                   , A2.POD_SEQ              AS POD_SEQ    " ).append("\n"); 
		query.append("                   , A2.POL_SKIP             AS POL_SKIP  " ).append("\n"); 
		query.append("                   , A2.POD_SKIP             AS POD_SKIP   " ).append("\n"); 
		query.append("                   , 0 AS BKG_QUOTA" ).append("\n"); 
		query.append("                   , 0 AS BKG_QTA_CMB" ).append("\n"); 
		query.append("                   , A1.GUIDE" ).append("\n"); 
		query.append("                   , OFC_TTL_GUIDE" ).append("\n"); 
		query.append("                   , CTRL_TTL_GUIDE" ).append("\n"); 
		query.append("                   , GUIDE_TTL" ).append("\n"); 
		query.append("                   , 0 AS FC_TEU" ).append("\n"); 
		query.append("                   , 0 AS FC_HC" ).append("\n"); 
		query.append("                   , 0 AS FC_45" ).append("\n"); 
		query.append("                   , 0 AS FC_53" ).append("\n"); 
		...
		query.append("                   , 0 AS AP_RD  " ).append("\n"); 
		query.append("                   , 'N' AS PAST" ).append("\n"); 
		query.append("                   , A1.LST_LODG_PORT_ETD_DT" ).append("\n"); 
		query.append("                   , A1.LST_LODG_PORT_CD" ).append("\n"); 
		query.append("                   , NULL AS CFM_FLG" ).append("\n"); 
		query.append("                   , NULL AS SPC_CTRL_ALOC_RMK" ).append("\n"); 
		query.append("                   , NULL AS SPC_CTRL_ALOC_POL_RMK" ).append("\n"); 
		query.append("                   , NULL AS SPC_CTRL_ALOC_POD_RMK" ).append("\n"); 
		query.append("                FROM (SELECT V.REP_TRD_CD" ).append("\n"); 
		query.append("                           , V.REP_SUB_TRD_CD" ).append("\n"); 
		query.append("                           , V.TRD_CD" ).append("\n"); 
		query.append("                           , V.SUB_TRD_CD" ).append("\n"); 
		query.append("                           , V.IOC_CD" ).append("\n"); 
		query.append("                           , L.CUST_CTRL_CD" ).append("\n"); 
		query.append("                           , V.OFC_CD AS BASE_RHQ_CD" ).append("\n"); 
		query.append("                           , L.SLS_RHQ_CD AS RHQ_CD" ).append("\n"); 
		query.append("                           , L.SLS_AQ_CD AS AREA_CD" ).append("\n"); 
		query.append("                           , L.SLS_RGN_OFC_CD AS OFC_CD" ).append("\n"); 
		query.append("                           --, RLANE_ADJ_QTY AS GUIDE" ).append("\n"); 
		query.append("                           , V.LST_LODG_PORT_ETD_DT" ).append("\n"); 
		query.append("                             , V.LST_LODG_PORT_CD" ).append("\n"); 
		query.append("                             , SUM(RLANE_ADJ_QTY) OVER (PARTITION BY L.TRD_CD, L.SUB_TRD_CD, L.RLANE_CD, L.SLS_RGN_OFC_CD, L.CUST_CTRL_CD) AS GUIDE" ).append("\n"); 
		query.append("							 , SUM(RLANE_ADJ_QTY) OVER (PARTITION BY L.TRD_CD, L.SUB_TRD_CD, L.RLANE_CD, L.SLS_RGN_OFC_CD) OFC_TTL_GUIDE" ).append("\n"); 
		query.append("                             , SUM(RLANE_ADJ_QTY) OVER (PARTITION BY L.TRD_CD, L.SUB_TRD_CD, L.RLANE_CD, L.CUST_CTRL_CD) CTRL_TTL_GUIDE " ).append("\n"); 
		query.append("                             , SUM(RLANE_ADJ_QTY) OVER (PARTITION BY L.TRD_CD, L.SUB_TRD_CD, L.RLANE_CD) AS GUIDE_TTL" ).append("\n"); 
		query.append("                          FROM SPC_MDL_CUST_REV_LANE L" ).append("\n"); 
		query.append("                             , VVDS V" ).append("\n"); 
		query.append("							 , SPC_OFC_LVL           O" ).append("\n"); 
		query.append("                         WHERE L.COST_YRWK = V.SEASON" ).append("\n"); 
		...
		query.append("                           AND NVL(L.RLANE_ADJ_QTY,0)>0" ).append("\n"); 
		query.append("						   AND O.OFC_CD     = L.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("						  AND V.COST_YR || V.COST_WK BETWEEN O.OFC_APLY_FM_YRWK AND O.OFC_APLY_TO_YRWK) A1" ).append("\n"); 
		...
		query.append("                             ,VPP.TRD_CD" ).append("\n"); 
		query.append("                             ,VPP.SUB_TRD_CD" ).append("\n"); 
		query.append("                             ,MAP.IOC_TS_CD" ).append("\n"); 
		query.append("                             ,MAP.SLS_RHQ_CD" ).append("\n"); 
		query.append("                             ,MAP.SLS_OFC_CD" ).append("\n"); 
		query.append("                             ,MAP.SLS_AQ_CD" ).append("\n"); 
		query.append("                             ,MAP.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("                             ,VPP.POL_CD" ).append("\n"); 
		query.append("                             ,VPP.POD_CD" ).append("\n"); 
		query.append("                             ,VPP.POL_SEQ" ).append("\n"); 
		query.append("                             ,VPP.POD_SEQ" ).append("\n"); 
		...
		query.append("                             ,VPP.POD_SKIP" ).append("\n"); 
		query.append("                          FROM VVD_POL_POD VPP" ).append("\n"); 
		query.append("                             , SPC_FCAST_OFC_POL_MAPG MAP" ).append("\n"); 
		query.append("                         WHERE VPP.REP_TRD_CD = MAP.REP_TRD_CD" ).append("\n"); 
		query.append("                           AND VPP.REP_SUB_TRD_CD = MAP.REP_SUB_TRD_CD" ).append("\n"); 
		query.append("                           AND VPP.RLANE_CD = MAP.RLANE_CD" ).append("\n"); 
		query.append("                           AND VPP.DIR_CD = MAP.DIR_CD" ).append("\n"); 
		query.append("                           AND VPP.TRD_CD = MAP.TRD_CD" ).append("\n"); 
		query.append("                           AND VPP.SUB_TRD_CD = MAP.SUB_TRD_CD" ).append("\n"); 
		query.append("                           AND VPP.COST_YR || VPP.COST_WK >= MAP.BSE_YRWK" ).append("\n"); 
		query.append("                           AND VPP.HH_FLG = 'Y'" ).append("\n"); 
		query.append("                           AND VPP.POL_CD LIKE MAP.POL_CD||'%' ) A2" ).append("\n"); 
		query.append("                 WHERE A1.REP_TRD_CD = A2.REP_TRD_CD" ).append("\n"); 
		query.append("                   AND A1.REP_SUB_TRD_CD = A2.REP_SUB_TRD_CD" ).append("\n"); 
		query.append("                   AND A1.TRD_CD = A2.TRD_CD" ).append("\n"); 
		query.append("                   AND A1.SUB_TRD_CD = A2.SUB_TRD_CD" ).append("\n"); 
		query.append("                   AND A1.IOC_CD = A2.IOC_TS_CD" ).append("\n"); 
		query.append("                   AND A1.OFC_CD = A2.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("           )" ).append("\n"); 
		...
		query.append("    SELECT T.RGN_OFC_CD AS OFC_CD, " ).append("\n"); 
		...
		query.append("              FROM SPC_ALOC_CUST_POL_POD K" ).append("\n"); 
		...
		query.append("               AND K.CUST_CTRL_CD = T.CUST_CTRL_CD" ).append("\n"); 
		...
		query.append("           1 AS NMDL_MD" ).append("\n"); 
		query.append("           -- 2014.08.13" ).append("\n"); 
		query.append("           --V.US_MOD," ).append("\n"); 
		query.append("           --V.ACCOUNT_CD," ).append("\n"); 
		query.append("           --V.DEL_CD" ).append("\n"); 
		query.append("    FROM (" ).append("\n"); 
		...
		query.append("                 AND M.IOC_TS_CD      = P.IOC_CD" ).append("\n"); 
		query.append("                 AND M.SLS_OFC_CD     = P.OFC_CD" ).append("\n"); 
		...
		query.append("    SELECT IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, " ).append("\n"); 
		query.append("           CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POD_CD, DEL_CD," ).append("\n"); 
		query.append("           POL_SEQ, POD_SEQ, POL_SKIP, POD_SKIP, REP_TRD_CD, REP_SUB_TRD_CD, TRD_CD, SUB_TRD_CD," ).append("\n"); 
		...
		query.append("		   MAX(BS_TEU) AS BS_TEU," ).append("\n"); 
		query.append("		   MAX(BS_WGT) AS BS_WGT," ).append("\n"); 
		...
		query.append("           MAX(NMDL_MD) AS NMDL_MD," ).append("\n"); 
		...
		query.append("--               0 AS BKG_QTA_CMB," ).append("\n"); 
		query.append("--               0 AS GUIDE, " ).append("\n"); 
		query.append("----               0 AS OFC_TTL_GUIDE," ).append("\n"); 
		query.append("----               0 AS CTRL_TTL_GUIDE," ).append("\n"); 
		query.append("----               0 AS GUIDE_TTL,--CHM-201431038 SPC기능보완요청" ).append("\n"); 
		query.append("--               0 AS FC_TEU," ).append("\n"); 
		query.append("--               0 AS FC_HC," ).append("\n"); 
		...
		query.append("               BS_TEU," ).append("\n"); 
		query.append("               BS_WGT," ).append("\n"); 
		query.append("               CM_OP," ).append("\n"); 
		query.append("               CM_OC," ).append("\n"); 
		query.append("               CM_VL," ).append("\n"); 
		...
		query.append("               0 AS OFC_TTL_GUIDE, " ).append("\n"); 
		query.append("               0 AS CTRL_TTL_GUIDE," ).append("\n"); 
		query.append("               0 AS GUIDE_TTL," ).append("\n"); 
		query.append("               0 AS FC_TEU," ).append("\n"); 
		query.append("               0 AS FC_HC," ).append("\n"); 
		query.append("               0 AS FC_45," ).append("\n"); 
		query.append("               0 AS FC_53," ).append("\n"); 
		...
		query.append("          )" ).append("\n"); 
		query.append("     GROUP BY IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POD_CD, DEL_CD, POL_SEQ, POD_SEQ, POL_SKIP, POD_SKIP, REP_TRD_CD, REP_SUB_TRD_CD, TRD_CD, SUB_TRD_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("           COUNT(DISTINCT DECODE(POD_CD, '0000000', NULL, DECODE(NQTA_MD * NCFM_MD*NMDL_MD, 0, NULL, POL_CD||POD_CD))) + DECODE(NVL(POL_CD, '+'), '+', COUNT(DISTINCT DECODE(POL_CD, '0000000', NULL, DECODE(NQTA_MD * NCFM_MD*NMDL_MD, 0, NULL, POL_CD))), 0) AS CHILD_CNT," ).append("\n"); 
		query.append("           COUNT(DISTINCT DECODE(POD_CD, '0000000', NULL, DECODE(NQTA_MD * NCFM_MD*NMDL_MD, 0, NULL, POL_CD||POD_CD))) AS LEAF_CNT," ).append("\n"); 
		query.append("           DECODE(NVL(POL_CD, '+'), '+', COUNT(DISTINCT DECODE(POL_CD, '0000000', NULL, DECODE(NQTA_MD * NCFM_MD*NMDL_MD, 0, NULL, POL_CD))), 0) AS POD_CNT," ).append("\n"); 
		query.append("           --2014." ).append("\n"); 
		query.append("           DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(US_MOD, NULL, 0, 1) + DECODE(ACCOUNT_CD, NULL, 0, 1) + DECODE(POL_CD, NULL, 0, 1) + DECODE(POD_CD, NULL, 0, 1) + DECODE(DEL_CD, NULL, 0, 1) AS LVL," ).append("\n"); 
		...
		query.append("           SUM(NMDL_MD) AS NMDL_MD," ).append("\n"); 
		query.append("           (" ).append("\n"); 
		...
		query.append("      FROM ALL_DATA" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("-- OFC_CD가 SHAAS,SINWA,SHADSC 인경우  2009/01월부터 적용" ).append("\n"); 
		query.append("#if (${office} != '')" ).append("\n"); 
		...
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POL_SEQ, POD_CD, POD_SEQ, LST_LODG_PORT_ETD_DT, LST_LODG_PORT_CD, DEL_CD)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POL_SEQ, POD_CD, POD_SEQ, LST_LODG_PORT_ETD_DT, LST_LODG_PORT_CD)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POL_SEQ)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD, US_MOD)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD, CUST_CTRL_CD)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD)," ).append("\n"); 
		query.append("                           (IOC_CD, BASE_RHQ_CD, RHQ_CD)," ).append("\n"); 
		query.append("                           --(IOC_CD, BASE_RHQ_CD, CUST_CTRL_CD)," ).append("\n"); 
		...
		query.append("           DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(DEL_CD, NULL, 0, 1) AS LVL," ).append("\n"); 
		query.append("           MIN(PAST)    AS PAST," ).append("\n"); 
		...
		query.append("		      		AND C.COST_YRWK   = P.SEASON " ).append("\n"); 
		query.append("				AND C.VER_SEQ     = P.VER_SEQ          " ).append("\n"); 
		...
		query.append("--				AND D.DIR_CD			= OFC.DIR_CD " ).append("\n"); 
		query.append("--				AND D.ALOC_CTRL_TP_CD	= OFC.ALOC_CTRL_TP_CD " ).append("\n"); 
		query.append("--				AND OFC.OFC_CD			= BAR.SLS_OFC_CD" ).append("\n"); 
		query.append("                -- ECC GROUP 관련하여 비교 컬럼 변경" ).append("\n"); 
		query.append("                AND DECODE(M.CTRL_DEST, 'E', D.CTRL_LOC_ACCT_CD, 'G', D.ALOC_CTRL_DTL_CD) = (SELECT A.ECC_CD" ).append("\n"); 
		query.append("                                                                                               FROM MDM_EQ_ORZ_CHT A,  " ).append("\n"); 
		query.append("                                                                                                    MDM_LOCATION C " ).append("\n"); 
		...
		query.append("                          FROM REP_VVDS ) M" ).append("\n"); 
		...
		query.append(") " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT DECODE(CHILD_CNT, 0, 0, EDIT) AS EDIT," ).append("\n"); 
		query.append("         REP_TRD_CD    ," ).append("\n"); 
		query.append("         REP_SUB_TRD_CD," ).append("\n"); 
		query.append("         TRD_CD        ," ).append("\n"); 
		query.append("         SUB_TRD_CD    ," ).append("\n"); 
		...
		query.append("              NVL((SELECT (SELECT CUST_LGL_ENG_NM " ).append("\n"); 
		...
		query.append("         POL_SKIP    ," ).append("\n"); 
		query.append("         POD_SKIP    ," ).append("\n"); 
		query.append("         DECODE(CUST_CTRL_CD, 'C', DECODE(SUB_TRD_CD,'IP',BKG_QUOTA,0), BKG_QUOTA)   AS BKG_QUOTA  ," ).append("\n"); 
		query.append("         DECODE(CUST_CTRL_CD, 'C', DECODE(SUB_TRD_CD,'IP',BKG_QTA_CMB,0), BKG_QTA_CMB) AS BKG_QTA_CMB,          " ).append("\n"); 
		...
		query.append("         -- Guide 중요 - 데이타 확인 시 필요. 주석 지우지 말 것." ).append("\n"); 
		query.append("--         GUIDE ORG_GUIDE, " ).append("\n"); 
		query.append("--         CTRL_TTL_GUIDE, " ).append("\n"); 
		query.append("--         OFC_TTL_GUIDE," ).append("\n"); 
		query.append("--         GUIDE_TTL, -- 전체 total" ).append("\n"); 
		query.append("--         GUIDE_TTL2, -- office별 total" ).append("\n"); 
		query.append("--         MAX(GUIDE_TTL) OVER() MAX_GUIDE_TTL," ).append("\n"); 
		query.append("	     CASE " ).append("\n"); 
		query.append("			 WHEN CUST_CTRL_CD = '+' THEN BKG_QUOTA" ).append("\n"); 
		query.append("             WHEN RHQ_CD IS NULL AND CUST_CTRL_CD = 'C' THEN BKG_QUOTA - MAX(GUIDE_TTL) OVER() " ).append("\n"); 
		query.append("             WHEN RHQ_CD IS NULL AND CUST_CTRL_CD <> 'C' THEN CTRL_TTL_GUIDE" ).append("\n"); 
		query.append("             WHEN RHQ_CD IS NOT NULL AND CUST_CTRL_CD <> 'C' AND US_MOD = '+' THEN GUIDE" ).append("\n"); 
		query.append("--            WHEN RHQ_CD IS NOT NULL AND CUST_CTRL_CD = 'C' AND US_MOD = '+' THEN BKG_QUOTA - GUIDE_TTL2" ).append("\n"); 
		query.append("             WHEN RHQ_CD IS NOT NULL AND CUST_CTRL_CD = 'C' AND US_MOD = '+' THEN BKG_QUOTA - OFC_TTL_GUIDE" ).append("\n"); 
		query.append("			 ELSE 0" ).append("\n"); 
		query.append("         END AS GUIDE," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("                         AND BAR.CUST_CTRL_CD  = NVL(Z.CUST_CTRL_CD, '0')" ).append("\n"); 
		...
		query.append("                         AND BAR.POL_YD_CD     = NVL(SUBSTR(Z.POL_CD, 1, 5), '00000')" ).append("\n"); 
		query.append("                         AND BAR.POD_YD_CD     = NVL(SUBSTR(Z.POD_CD, 1, 5), '00000')" ).append("\n"); 
		query.append("                         --AND BAR.CUST_CTRL_CD  = NVL(Z.CUST_CTRL_CD, BAR.CUST_CTRL_CD)    -- 20140814 수정" ).append("\n"); 
		...
		query.append("                   GUIDE, MAX(OFC_TTL_GUIDE) OVER (PARTITION BY REP_TRD_CD, REP_SUB_TRD_CD, TRD_CD, SUB_TRD_CD, IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD) AS OFC_TTL_GUIDE, CTRL_TTL_GUIDE, GUIDE_TTL,--CHM-201431038 SPC기능보완요청" ).append("\n"); 
		query.append("                   MAX(GUIDE) OVER (PARTITION BY REP_TRD_CD, REP_SUB_TRD_CD, TRD_CD, SUB_TRD_CD, IOC_CD, BASE_RHQ_CD, RHQ_CD, AREA_CD, OFC_CD) AS GUIDE_TTL2, " ).append("\n"); 
		...
		query.append("-- all pol인 경우 Guide가 0보다 크면 모두 열도록 " ).append("\n"); 
		query.append("#if (${all_pol} == 'Y')" ).append("\n"); 
		query.append("             WHERE ( LVL < 2 OR (NQTA_MD > 0 AND NCFM_MD > 0 AND NMDL_MD > 0) OR BKG_QUOTA > 0 OR GUIDE > 0)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("             WHERE ( LVL < 2 OR (NQTA_MD > 0 AND NCFM_MD > 0 AND NMDL_MD > 0) OR BKG_QUOTA > 0 )" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("--             OR GUIDE > 0 --CHM-201431038 SPC기능보완요청" ).append("\n"); 
		query.append("--                        OR US_MOD = 'OTHERS'  OR DEL_CD = 'OTHERS' OR ACCOUNT_CD = 'OTHERS') -- 'OTHERS'는 기본값이므로 항상 나오게 함" ).append("\n"); 
		query.append("               -- 2014.10.10 T/S인 경우 DEST TOTAL 제외" ).append("\n"); 
		query.append("               AND NOT ((SUB_TRD_CD = 'IP' OR IOC_CD = 'E' OR IOC_CD = 'T') AND RHQ_CD IS NULL AND (CUST_CTRL_CD IS NOT NULL OR DEL_CD IS NOT NULL))" ).append("\n"); 
		...
		query.append("                   0            AS POL_SKIP    ," ).append("\n"); 
		query.append("                   0            AS POD_SKIP    ," ).append("\n"); 
		query.append("                   0            AS BKG_QUOTA   ," ).append("\n"); 
		query.append("                   0            AS BKG_QTA_CMB ," ).append("\n"); 
		query.append("                   0            AS CMB_AVG     ," ).append("\n"); 
		...
		query.append("                   0            AS GUIDE_TTL   ," ).append("\n"); 
		query.append("                   0 		AS OFC_TTL_GUIDE, " ).append("\n"); 
		query.append("                   0 		AS CTRL_TTL_GUIDE, --CHM-201431038 SPC기능보완요청" ).append("\n"); 
		query.append("                   0            AS GUIDE_TTL2," ).append("\n"); 
		query.append("                   --fc_ttl_teu값 추가(TEU + HC*2 + 45FT*2), fcast = 1(Fcast+BKG), 2(Fcast Only), 3(BKG only)" ).append("\n"); 
	...
	public void setQuery2(){
		...
		query.append("                   0   AS LEAF_CNT ," ).append("\n"); 
		query.append("                   0   AS POD_CNT  ," ).append("\n"); 
		query.append("                   1   AS LVL      ," ).append("\n"); 
		query.append("                   'N' AS PAST     ," ).append("\n"); 
		query.append("                   1  AS AP_MD     ," ).append("\n"); 
		query.append("                   A.SPC_CTRL_ALOC_RMK     AS SPC_CTRL_ALOC_RMK    ," ).append("\n"); 
		query.append("                   A.SPC_CTRL_ALOC_POL_RMK AS SPC_CTRL_ALOC_POL_RMK," ).append("\n"); 
		query.append("                   A.SPC_CTRL_ALOC_POD_RMK AS SPC_CTRL_ALOC_POD_RMK," ).append("\n"); 
		query.append("                   -- 2014.07.28 컬럼추가" ).append("\n"); 
		...
		query.append("         AND POD_CD <> '0000000'" ).append("\n"); 
		...
		query.append("         MAX(CMB_AVG) OVER (PARTITION BY " ).append("\n"); 
		...
		query.append("[CHM-201324211-01] SLS_OFC_CD 관련 로직 수정" ).append("\n"); 
		query.append("[선처리] Allocation 추가요건 - guide 0이면서 fcast, aloc, bkg도 없는 경우 조회되지 않도록 수정" ).append("\n"); 
		query.append("[Trouble shooting] 이전 ver과 비교해 SC만 변경된 경우, outer 가 제대로 되지 않아 fcast 누락" ).append("\n"); 
		...
		query.append("2014.05.30 김시몬-튜닝" ).append("\n"); 
		query.append("2014.07.03 김시몬-IAS Sector 반영관련 수정" ).append("\n"); 
		query.append("2014.07.11 Arie IM CHM-201431038 SPC기능보완요청" ).append("\n"); 
		query.append("*/" ).append("\n"); 
