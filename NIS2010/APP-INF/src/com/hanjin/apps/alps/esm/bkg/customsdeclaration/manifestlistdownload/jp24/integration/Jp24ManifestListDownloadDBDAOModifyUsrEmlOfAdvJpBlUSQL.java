...
*@FileName : Jp24ManifestListDownloadDBDAOModifyUsrEmlOfAdvJpBlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24ManifestListDownloadDBDAOModifyUsrEmlOfAdvJpBlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24ManifestListDownloadDBDAOModifyUsrEmlOfAdvJpBlUSQL(){
		setQuery();
		...
		query.append("FileName : Jp24ManifestListDownloadDBDAOModifyUsrEmlOfAdvJpBlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("   SET USR_EML = @[usr_eml]," ).append("\n"); 
