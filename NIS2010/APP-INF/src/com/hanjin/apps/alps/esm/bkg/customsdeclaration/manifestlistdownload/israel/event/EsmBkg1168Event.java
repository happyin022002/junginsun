...
=========================================================*/
package com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.israel.event;
...
public class EsmBkg1168Event extends EventSupport {
	...
	public void setIsraelManifestTransmitVO(
			IsraelManifestTransmitVO israelManifestTransmitVO) {
	...
	public IsraelManifestTransmitVO[] getIsraelManifestTransmitVOs() {
		...
		if (this.israelManifestTransmitVOs != null) {
	...
	public void setIsraelManifestTransmitVOs(IsraelManifestTransmitVO[] israelManifestTransmitVOs){
		if(israelManifestTransmitVOs != null){
			IsraelManifestTransmitVO[] tmpVOs = Arrays.copyOf(israelManifestTransmitVOs, israelManifestTransmitVOs.length);
			this.israelManifestTransmitVOs = tmpVOs;
		}
	}
