...
*@FileName : CargoReleaseOrderDBDAOaddBkbcFrtUsCgoRlseCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOaddBkbcFrtUsCgoRlseCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOaddBkbcFrtUsCgoRlseCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOaddBkbcFrtUsCgoRlseCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			WHERE NOT EXISTS (SELECT 'Y' FROM BKG_CGO_RLSE WHERE BL_NO = @[bl_no])" ).append("\n"); 
