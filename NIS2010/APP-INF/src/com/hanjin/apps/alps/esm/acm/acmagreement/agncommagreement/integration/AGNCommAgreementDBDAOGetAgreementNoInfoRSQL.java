...
*@FileName : AGNCommAgreementDBDAOGetAgreementNoInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOGetAgreementNoInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAOGetAgreementNoInfoRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOGetAgreementNoInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
