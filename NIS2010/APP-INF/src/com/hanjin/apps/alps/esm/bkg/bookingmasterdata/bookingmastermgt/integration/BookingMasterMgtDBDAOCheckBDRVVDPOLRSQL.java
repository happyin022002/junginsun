...
*@FileName : BookingMasterMgtDBDAOCheckBDRVVDPOLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOCheckBDRVVDPOLRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingMasterMgtDBDAOCheckBDRVVDPOLRSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOCheckBDRVVDPOLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--AND VPS_ETD_DT > SYSDATE" ).append("\n"); 
