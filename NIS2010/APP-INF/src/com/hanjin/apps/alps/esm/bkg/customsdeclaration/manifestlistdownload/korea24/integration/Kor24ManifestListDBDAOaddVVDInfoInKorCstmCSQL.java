...
*@FileName : Kor24ManifestListDBDAOaddVVDInfoInKorCstmCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOaddVVDInfoInKorCstmCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOaddVVDInfoInKorCstmCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOaddVVDInfoInKorCstmCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_ADV_KR_VVD_SMRY" ).append("\n");
		...
		query.append("AND     ((@[in_type] IN ('A','B','C','M') AND KV.OB_DECL_TP_CD IN ('A','B','C','M')) OR" ).append("\n");
