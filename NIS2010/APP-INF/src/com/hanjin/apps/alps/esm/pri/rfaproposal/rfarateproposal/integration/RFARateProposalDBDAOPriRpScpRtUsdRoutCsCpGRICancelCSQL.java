...
*@FileName : RFARateProposalDBDAOPriRpScpRtUsdRoutCsCpGRICancelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtUsdRoutCsCpGRICancelCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GRI Cancel시 PriSpScpRtUsdRoutCs 테이블 복구
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtUsdRoutCsCpGRICancelCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtUsdRoutCsCpGRICancelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,@[cre_usr_id]" ).append("\n"); 
		query.append("        ,SYSDATE" ).append("\n"); 
		query.append("    FROM PRI_RP_SCP_RT_USD_ROUT_CS T" ).append("\n"); 
