...
*@FileName : Kor24ManifestListDBDAOmodifyCrossInfoKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyCrossInfoKorUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyCrossInfoKor 수정 쿼리
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyCrossInfoKorUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyCrossInfoKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_KR_RMK" ).append("\n");
		query.append("" ).append("\n");
