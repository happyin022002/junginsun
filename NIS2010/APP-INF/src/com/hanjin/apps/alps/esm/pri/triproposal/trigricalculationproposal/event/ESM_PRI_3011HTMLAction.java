 ...
 *@FileName : ESM_PRI_3011HTMLAction.java
...
public class ESM_PRI_3011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_3011HTMLAction 객체를 생성
	 */
	public ESM_PRI_3011HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3011Event event = new EsmPri3011Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setPriTriGriCmdtVO((PriTriGriCmdtVO) getVO(request, PriTriGriCmdtVO.class));
