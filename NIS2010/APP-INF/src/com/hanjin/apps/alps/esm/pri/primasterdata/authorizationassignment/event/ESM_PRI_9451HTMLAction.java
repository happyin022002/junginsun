...
*@FileName : ESM_PRI_9451HTMLAction.java
...
public class ESM_PRI_9451HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 6292978124068251371L;

	/**
     * ESM_PRI_9451HTMLAction 객체를 생성
     */
    public ESM_PRI_9451HTMLAction() {
    }

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmPri9451Event로 파싱하여 request에 셋팅<br>
	 *
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri9451Event event = new EsmPri9451Event();

		if(command.isCommand(FormCommand.SEARCHLIST01)){ 
			event.setRsltAuthHisVO((RsltAuthHisVO)getVO(request, RsltAuthHisVO.class));
 		}
