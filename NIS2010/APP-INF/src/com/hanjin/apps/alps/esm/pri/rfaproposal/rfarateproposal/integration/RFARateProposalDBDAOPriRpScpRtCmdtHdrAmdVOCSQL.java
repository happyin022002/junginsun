...
*@FileName : RFARateProposalDBDAOPriRpScpRtCmdtHdrAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCmdtHdrAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFARateProposalDBDAOPriRpScpRtCmdtHdrAmdVOCSQL
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCmdtHdrAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCmdtHdrAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    @[upd_usr_id]       ," ).append("\n"); 
		query.append("    SYSDATE             ," ).append("\n"); 
		query.append("    HDR.FIC_RT_TP_CD" ).append("\n"); 
		query.append("FROM " ).append("\n"); 
		query.append("    PRI_RP_SCP_RT_CMDT_HDR HDR" ).append("\n"); 
