...
*@FileName : PSAManifestDBDAOsearchPsaBkgCntrCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOsearchPsaBkgCntrCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSA BKG CNTR의 CNTR Count를 조회한다.
	  * </pre>
	  */
	public PSAManifestDBDAOsearchPsaBkgCntrCntRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOsearchPsaBkgCntrCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  CNTR_KNT" ).append("\n"); 
