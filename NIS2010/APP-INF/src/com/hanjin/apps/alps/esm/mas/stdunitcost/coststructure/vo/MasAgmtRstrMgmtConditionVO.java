...
public class MasAgmtRstrMgmtConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasAgmtRstrMgmtConditionVO> models = new ArrayList<MasAgmtRstrMgmtConditionVO>();
	...
	public MasAgmtRstrMgmtConditionVO() {}

	public MasAgmtRstrMgmtConditionVO(String code, String ibflag, String pagerows, String locGrpTpCd, String masCostSrcCd, String n1stNodCd, String n2ndNodCd, String n3rdNodCd, String n4thNodCd, String costSrcUseFlg, String locDeltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.code = code;
		this.updDt = updDt;
	 ...
	 */
	public MasAgmtRstrMgmtConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasAgmtRstrMgmtVO[]
	 */
	public MasAgmtRstrMgmtConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasAgmtRstrMgmtConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasAgmtRstrMgmtConditionVO();
				if (code[i] != null)
				...
				if (i==0) {
					...
					try {						
						...
						String[] mas_cost_src_cd = code[0].split("[|]");
						if(mas_cost_src_cd.length > 0){
							HashMap<String, Object> hMap = null;
				            for(int j=0; j<mas_cost_src_cd.length; j++){
				            	hMap = new HashMap<String, Object>();
				            	String[] cost_src_use_cd = (JSPUtil.getParameter(request, mas_cost_src_cd[j], length));
				            	hMap.put(mas_cost_src_cd[j], cost_src_use_cd);
		...
		return getMasAgmtRstrMgmtConditionVOs();
	}
	...
	public MasAgmtRstrMgmtConditionVO[] getMasAgmtRstrMgmtConditionVOs(){
		MasAgmtRstrMgmtConditionVO[] vos = (MasAgmtRstrMgmtConditionVO[])models.toArray(new MasAgmtRstrMgmtConditionVO[models.size()]);
		return vos;
	}
...
//	 * @return MasAgmtRstrMgmtVO
//	 */
//	public MasAgmtRstrMgmtConditionVO getMasAgmtRstrMgmtConditionVO(){
//		MasAgmtRstrMgmtConditionVO vo = (MasAgmtRstrMgmtConditionVO)models.toArray(new MasAgmtRstrMgmtConditionVO);
//		return vo;
//	}
