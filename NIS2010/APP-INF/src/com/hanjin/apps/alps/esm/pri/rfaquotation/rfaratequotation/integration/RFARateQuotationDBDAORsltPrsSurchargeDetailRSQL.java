...
*@FileName : RFARateQuotationDBDAORsltPrsSurchargeDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPrsSurchargeDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPrsSurchargeDetailRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPrsSurchargeDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 	PRI_SCG.QTTN_NO, PRI_SCG.QTTN_VER_NO," ).append("\n"); 
		...
		query.append("FROM PRI_RQ_RT_SCG PRI_SCG" ).append("\n"); 
