...
public class ESM_BKG_1131HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_BKG_1131HTMLAction 객체를 생성
	 */
	public ESM_BKG_1131HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1131Event event = new EsmBkg1131Event();
		String[] keys =null;
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			RestrictCmdtFileVO restrictCmdtFileVO 	= (RestrictCmdtFileVO)getVO(request, RestrictCmdtFileVO .class);
			event.setRestrictCmdtFileVO(restrictCmdtFileVO);

		}
		else if(command.isCommand(FormCommand.MULTI)) {

			RestrictCmdtFileVO restrictCmdtFileVO 	= (RestrictCmdtFileVO)getVO(request, RestrictCmdtFileVO.class);
			BkgImpImgStoVO[] bkgImpImgStoVOs 	= (BkgImpImgStoVO[])getVOs(request, BkgImpImgStoVO .class,"sheet1_");
			restrictCmdtFileVO.setKeys(keys);
			restrictCmdtFileVO.setBkgImpImgStoVOs(bkgImpImgStoVOs);
			event.setRestrictCmdtFileVO(restrictCmdtFileVO);
