...
*@FileName : CndCustomsTransmissionDBDAOsearchCndCstmsRcvHisListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsTransmissionDBDAOsearchCndCstmsRcvHisListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndCustomsTransmissionDBDAOsearchCndCstmsRcvHisListRSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsTransmissionDBDAOsearchCndCstmsRcvHisListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       " ).append("\n"); 
		query.append("       /* 2017.11.01 유효한 값으로수정 */" ).append("\n"); 
		...
		query.append("       ,BKG_CSTMS_CD_CONV_CTNT D /* 2017.11.01 유효한 값으로수정 */" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("   AND  A.CSTMS_RJCT_MSG     = D.ATTR_CTNT1(+)" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${a6_ata_only} != '')" ).append("\n"); 
		query.append("   AND  A.BL_NO IS NULL" ).append("\n"); 
		query.append("   AND  A.RCV_MSG_TP_ID IN ('824','997','350')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
