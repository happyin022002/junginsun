...
*@FileName : Kor24ManifestListDBDAOSearchMaxTransSeqKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchMaxTransSeqKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchMaxTransSeqKorRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchMaxTransSeqKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
