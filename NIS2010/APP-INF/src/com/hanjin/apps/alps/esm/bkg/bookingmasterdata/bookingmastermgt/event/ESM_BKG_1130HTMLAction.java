...
*@FileName : ESM_BKG_1130HTMLAction.java
...
public class ESM_BKG_1130HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1130HTMLAction 객체를 생성
	 */
	public ESM_BKG_1130HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1130Event event = new EsmBkg1130Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setRestrictCmdtListVOs((RestrictCmdtListVO[])getVOs(request, RestrictCmdtListVO .class,""));
			
		} else if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01) || command.isCommand(FormCommand.SEARCH02)) {
			event.setRestrictCmdtListVO((RestrictCmdtListVO)getVO(request, RestrictCmdtListVO .class));
