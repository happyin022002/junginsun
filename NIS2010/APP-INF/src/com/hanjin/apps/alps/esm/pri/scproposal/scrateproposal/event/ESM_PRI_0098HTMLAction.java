 ...
 *@FileName : ESM_PRI_0098HTMLAction.java
...
public class ESM_PRI_0098HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0098Event event = new EsmPri0098Event();
