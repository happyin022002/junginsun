...
*@FileName : BSAManageDBDAORemoveBSATableSC2DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveBSATableSC2DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveBSATableSC2DSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveBSATableSC2DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_SLT_CHTR_CRR_CAPA" ).append("\n"); 
