...
*@FileName : Kor24ManifestListDBDAOSearchCNTRInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchCNTRInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchCNTRInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchCNTRInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append(", MAX(CNTR_SEAL_NO1) CNTR_SEAL_NO1" ).append("\n");
		query.append(", MAX(CNTR_SEAL_NO2) CNTR_SEAL_NO2" ).append("\n");
		...
		query.append("FROM (SELECT NVL(CNTR.CNTR_NO,' ') CNTR_NO" ).append("\n");
		query.append(", NVL(CNTR.CNTR_TPSZ_CD,' ')  CNTR_TPSZ_CD" ).append("\n");
		query.append(", NVL(DECODE(SEAL.CNTR_SEAL_SEQ,1,SEAL.CNTR_SEAL_NO),' ') CNTR_SEAL_NO1" ).append("\n");
		query.append(", NVL(DECODE(SEAL.CNTR_SEAL_SEQ,2,SEAL.CNTR_SEAL_NO),' ') CNTR_SEAL_NO2" ).append("\n");
		...
		query.append(")" ).append("\n");
		query.append("GROUP BY CNTR_NO,CNTR_TPSZ_CD,PCK_QTY,PCK_TP_CD,CNTR_WGT,WGT_UT_CD,MEAS_QTY,MEAS_UT_CD,OP_CNTR_QTY,CNTR_VOL_QTY,BKG_NO" ).append("\n");
