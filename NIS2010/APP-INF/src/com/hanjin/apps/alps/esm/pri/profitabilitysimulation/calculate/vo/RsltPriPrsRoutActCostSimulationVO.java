...
*@FileName : RsltPriPrsRoutActCostSimulationVO.java
*@FileTitle : RsltPriPrsRoutActCostSimulationVO
*Open Issues :
*Change history :
...
public class RsltPriPrsRoutActCostSimulationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriPrsRoutActCostSimulationVO> models = new ArrayList<RsltPriPrsRoutActCostSimulationVO>();
	...
	public RsltPriPrsRoutActCostSimulationVO() {}

	public RsltPriPrsRoutActCostSimulationVO(String ibflag, String pagerows, String routCsNo, String routCsClssNo, String costActGrpSeq, String cntrTpszCd, String coaCostSrcCd, String stndCostCd, String raAcctCd, String costUtAmtCd, String costSrcSysCd, String costAssBseCd, String railSvcTpCd, String actGrpCd, String costActGrpTpCd, String vslSlanCd, String ctrlOfcCd, String costOfcCd, String costIoBndCd, String n1stNodCd, String n1stNodTpCd, String n1stEstmDt, String n2ndNodCd, String n3rdNodCd, String n4thNodCd, String routTzModCd, String n1stPolPodDist, String n1stDistUtCd, String n2ndPolPodDist, String n2ndDistUtCd, String n3rdPolPodDist, String n3rdDistUtCd, String n1stVndrSeq, String n2ndVndrSeq, String n3rdVndrSeq, String n4thVndrSeq, String custNomiTrkrFlg, String preNodCd, String pstNodCd, String preLnkVndrSeq, String pstLnkVndrSeq, String fcgoTzDys, String fcgoTzHrs, String mcgoTzDys, String mcgoTzHrs, String cntrQty, String costCateCd, String estmUcAmt, String respbUcAmt, String loclCurrCd, String trspSvcOfcCd, String costAsgnCalcFlg, String lgsCostCdChkFlg, String thrpRtFlg, String actGrpTmlFlg, String lgsCostAutoCdFlg, String iocCd, String bfrTrspModCd, String aftTrspModCd, String ctrtRtnFlg, String aplyVndrSeq, String sccCd, String eccCd, String paraFmSccCd, String paraToSccCd, String paraFmEccCd, String paraToEccCd, String n1stRailCrrTpCd, String n2ndRailCrrTpCd, String n3rdRailCrrTpCd, String estmUsdUcAmt, String respbUsdUcAmt, String estmUsdTtlAmt, String respbUsdTtlAmt, String wtrDeTermCd, String wtrRcvTermCd, String inlndRoutInclSttlFlg, String n1stTrspAgmtSeq, String n2ndTrspAgmtSeq, String n3rdTrspAgmtSeq, String n1stTrspAgmtOfcCtyCd, String n1stAgmtRefNo, String n2ndTrspAgmtOfcCtyCd, String n2ndAgmtRefNo, String n3rdTrspAgmtOfcCtyCd, String n3rdAgmtRefNo, String costCalcRmk) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setLgsCostAutoCdFlg(JSPUtil.getParameter(request, prefix + "lgs_cost_auto_cd_flg", ""));
		setN4thVndrSeq(JSPUtil.getParameter(request, prefix + "n4th_vndr_seq", ""));
		setEstmUsdUcAmt(JSPUtil.getParameter(request, prefix + "estm_usd_uc_amt", ""));
		setRaAcctCd(JSPUtil.getParameter(request, prefix + "ra_acct_cd", ""));
		setRespbUsdUcAmt(JSPUtil.getParameter(request, prefix + "respb_usd_uc_amt", ""));
		...
		setActGrpTmlFlg(JSPUtil.getParameter(request, prefix + "act_grp_tml_flg", ""));
		setN3rdRailCrrTpCd(JSPUtil.getParameter(request, prefix + "n3rd_rail_crr_tp_cd", ""));
		setBfrTrspModCd(JSPUtil.getParameter(request, prefix + "bfr_trsp_mod_cd", ""));
		setN1stRailCrrTpCd(JSPUtil.getParameter(request, prefix + "n1st_rail_crr_tp_cd", ""));
		setCntrTpszCd(JSPUtil.getParameter(request, prefix + "cntr_tpsz_cd", ""));
		setN1stEstmDt(JSPUtil.getParameter(request, prefix + "n1st_estm_dt", ""));
		setN3rdTrspAgmtOfcCtyCd(JSPUtil.getParameter(request, prefix + "n3rd_trsp_agmt_ofc_cty_cd", ""));
		setAplyVndrSeq(JSPUtil.getParameter(request, prefix + "aply_vndr_seq", ""));
		setParaFmSccCd(JSPUtil.getParameter(request, prefix + "para_fm_scc_cd", ""));
		...
		setN3rdDistUtCd(JSPUtil.getParameter(request, prefix + "n3rd_dist_ut_cd", ""));
		setTrspSvcOfcCd(JSPUtil.getParameter(request, prefix + "trsp_svc_ofc_cd", ""));
		setPstNodCd(JSPUtil.getParameter(request, prefix + "pst_nod_cd", ""));
		...
		setRoutTzModCd(JSPUtil.getParameter(request, prefix + "rout_tz_mod_cd", ""));
		...
		setParaToEccCd(JSPUtil.getParameter(request, prefix + "para_to_ecc_cd", ""));
		setParaFmEccCd(JSPUtil.getParameter(request, prefix + "para_fm_ecc_cd", ""));
		setRailSvcTpCd(JSPUtil.getParameter(request, prefix + "rail_svc_tp_cd", ""));
		setEstmUsdTtlAmt(JSPUtil.getParameter(request, prefix + "estm_usd_ttl_amt", ""));
		setFcgoTzHrs(JSPUtil.getParameter(request, prefix + "fcgo_tz_hrs", ""));
		setPstLnkVndrSeq(JSPUtil.getParameter(request, prefix + "pst_lnk_vndr_seq", ""));
		setCoaCostSrcCd(JSPUtil.getParameter(request, prefix + "coa_cost_src_cd", ""));
		setMcgoTzDys(JSPUtil.getParameter(request, prefix + "mcgo_tz_dys", ""));
		setPreNodCd(JSPUtil.getParameter(request, prefix + "pre_nod_cd", ""));
		setPreLnkVndrSeq(JSPUtil.getParameter(request, prefix + "pre_lnk_vndr_seq", ""));
		setRespbUsdTtlAmt(JSPUtil.getParameter(request, prefix + "respb_usd_ttl_amt", ""));
		setCostIoBndCd(JSPUtil.getParameter(request, prefix + "cost_io_bnd_cd", ""));
		setLgsCostCdChkFlg(JSPUtil.getParameter(request, prefix + "lgs_cost_cd_chk_flg", ""));
		setN1stNodTpCd(JSPUtil.getParameter(request, prefix + "n1st_nod_tp_cd", ""));
		...
		setN3rdPolPodDist(JSPUtil.getParameter(request, prefix + "n3rd_pol_pod_dist", ""));
		setMcgoTzHrs(JSPUtil.getParameter(request, prefix + "mcgo_tz_hrs", ""));
		...
		setThrpRtFlg(JSPUtil.getParameter(request, prefix + "thrp_rt_flg", ""));
		setRoutCsNo(JSPUtil.getParameter(request, prefix + "rout_cs_no", ""));
		setN2ndPolPodDist(JSPUtil.getParameter(request, prefix + "n2nd_pol_pod_dist", ""));
		...
		setN1stDistUtCd(JSPUtil.getParameter(request, prefix + "n1st_dist_ut_cd", ""));
		...
		setCostCateCd(JSPUtil.getParameter(request, prefix + "cost_cate_cd", ""));
		...
		setN2ndRailCrrTpCd(JSPUtil.getParameter(request, prefix + "n2nd_rail_crr_tp_cd", ""));
		setCostAsgnCalcFlg(JSPUtil.getParameter(request, prefix + "cost_asgn_calc_flg", ""));
		setAftTrspModCd(JSPUtil.getParameter(request, prefix + "aft_trsp_mod_cd", ""));
		setCostUtAmtCd(JSPUtil.getParameter(request, prefix + "cost_ut_amt_cd", ""));
		setRespbUcAmt(JSPUtil.getParameter(request, prefix + "respb_uc_amt", ""));
		setFcgoTzDys(JSPUtil.getParameter(request, prefix + "fcgo_tz_dys", ""));
		...
		setN1stPolPodDist(JSPUtil.getParameter(request, prefix + "n1st_pol_pod_dist", ""));
		setParaToSccCd(JSPUtil.getParameter(request, prefix + "para_to_scc_cd", ""));
		...
		setN2ndDistUtCd(JSPUtil.getParameter(request, prefix + "n2nd_dist_ut_cd", ""));
	 ...
	 * @param request
	 * @return RsltPriPrsRoutActCostSimulationVO[]
	 */
	public RsltPriPrsRoutActCostSimulationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriPrsRoutActCostSimulationVO[]
	 */
	public RsltPriPrsRoutActCostSimulationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriPrsRoutActCostSimulationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriPrsRoutActCostSimulationVO();
		...
		return getRsltPriPrsRoutActCostSimulationVOs();
	}
	 ...
	 * @return RsltPriPrsRoutActCostSimulationVO[]
	 */
	public RsltPriPrsRoutActCostSimulationVO[] getRsltPriPrsRoutActCostSimulationVOs(){
		RsltPriPrsRoutActCostSimulationVO[] vos = (RsltPriPrsRoutActCostSimulationVO[])models.toArray(new RsltPriPrsRoutActCostSimulationVO[models.size()]);
		return vos;
	}
