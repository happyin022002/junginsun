...
public class SalesRPTDBDAOSearchDailyBranchView0078ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			       ,coa_rgst_bkg b2 -- b " ).append("\n"); 
		query.append("			       ,coa_bkg_svc_trns_smry b3 -- c " ).append("\n"); 
		query.append("			       ,coa_ofc_lvl b4 -- d " ).append("\n"); 
		query.append("			#if(${f_isshpr}=='Y')       " ).append("\n"); 
		...
		query.append("				   ,coa_bkg_expn_dtl b7 --h" ).append("\n"); 
		query.append("            #end" ).append("\n"); 
		query.append("			   WHERE 1=1 " ).append("\n"); 
