...
*@FileName : AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoOfcListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoOfcListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchGeogOfcInfoOfcList
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoOfcListRSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoOfcListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND SUBSTR(LOC_CD,1,2)" ).append("\n"); 
		...
		query.append("#else" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("CASE B.OFC_CD" ).append("\n"); 
		...
		query.append("AND ROUT_LVL_CD      = '7'" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append("WHERE B.OFC_CD                      = A.ROUT_INFO_CD" ).append("\n"); 
