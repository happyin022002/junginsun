...
*@FileName : ESM_BKG_0071HTMLAction.java
...
public class ESM_BKG_0071HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0071HTMLAction 객체를 생성
     */
    public ESM_BKG_0071HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0071Event event = new EsmBkg0071Event();

		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((SearchBDRBookingStatusListVO) getVO(request, SearchBDRBookingStatusListVO.class));
		}
