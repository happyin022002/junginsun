...
*@FileName : AlpsTroMstVO.java
*@FileTitle : AlpsTroMstVO
*Open Issues :
*Change history :
...
public class AlpsTroMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AlpsTroMstVO> models = new ArrayList<AlpsTroMstVO>();
	...
	public AlpsTroMstVO(String ibflag, String pagerows, String troSeq, String ownrTrkFlg, String requestResult, String rqstDt, String actShprNm, String cntcPsonNm, String cntcPhnNo, String cntcMphnNo, String dorPstNo, String actShprAddr, String diffRmk, String cxlFlg, String cfmFlg, String isEur, String ioBndCd) {
		this.rqstDt = rqstDt;
...
/**
	 ...
	 * @return AlpsTroMstVO[]
	 */
	public AlpsTroMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AlpsTroMstVO[]
	 */
	public AlpsTroMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AlpsTroMstVO model = null;
	 ...
	 * @return AlpsTroMstVO[]
	 */
	public AlpsTroMstVO[] getAlpsTroMstVOs(){
		AlpsTroMstVO[] vos = (AlpsTroMstVO[])models.toArray(new AlpsTroMstVO[models.size()]);
		return vos;
	}
