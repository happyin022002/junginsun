...
*@FileTitle : <Kor24ImfmodVO.java
*@FileTitle : Kor24ImfmodVO
*Open Issues :
*Change history :
...
public class Kor24ImfmodVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ImfmodVO> models = new ArrayList<Kor24ImfmodVO>();
...
/**
	 ...
	 * @param request
	 * @return Kor24ImfmodVO[]
	 */
	public Kor24ImfmodVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24ImfmodVO[]
	 */
	public Kor24ImfmodVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ImfmodVO model = null;
	 ...
	 * @return Kor24ImfmodVO[]
	 */
	public Kor24ImfmodVO[] getKor24ImfmodVOs(){
		Kor24ImfmodVO[] vos = (Kor24ImfmodVO[])models.toArray(new Kor24ImfmodVO[models.size()]);
		return vos;
	}
