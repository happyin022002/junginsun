...
*@FileName : ChinaEdiSendVO.java
*@FileTitle : ChinaEdiSendVO
*Open Issues :
*Change history :
...
public class ChinaEdiSendVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ChinaEdiSendVO> models = new ArrayList<ChinaEdiSendVO>();
	...
	public ChinaEdiSendVO() {}

	public ChinaEdiSendVO(String ibflag, String pagerows, String bkgNo, String hisSeq, String ntcKndCd, String ediId, String bkgNtcSndRsltCd, String sndUsrId, String sndDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return BrEdiSendVO[]
	 */
	public ChinaEdiSendVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BrEdiSendVO[]
	 */
	public ChinaEdiSendVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ChinaEdiSendVO model = null;
	 ...
	 * @return BrEdiSendVO[]
	 */
	public ChinaEdiSendVO[] getBrEdiSendVOs(){
		ChinaEdiSendVO[] vos = (ChinaEdiSendVO[])models.toArray(new ChinaEdiSendVO[models.size()]);
		return vos;
	}
