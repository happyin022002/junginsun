 ...
 * @since J2EE 1.6
 */
public class EsmMas0135ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0135ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0135ViewAdapter ########### [START]");
		...
		log.debug("########### EsmMas0135ViewAdapter ########### [END]");        
