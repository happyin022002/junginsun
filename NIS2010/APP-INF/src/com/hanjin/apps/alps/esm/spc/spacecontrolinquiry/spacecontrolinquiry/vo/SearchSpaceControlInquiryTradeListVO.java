...
public class SearchSpaceControlInquiryTradeListVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("wgt_lf", getWgtLf());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("wgt_lf", "wgtLf");
	 ...
	 * @param fctWgt
	 */
	public void setWgtLf(String wgtLf) {
		this.wgtLf = wgtLf;
	}
	/**
	 * Column Info
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLoadable(JSPUtil.getParameter(request, "loadable", ""));
	...
	*/
	public void unDataFormat(){
		...
		this.wgtLf = this.wgtLf .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
