...
*@FileName : TCharterIOBasicRegisterDBDAOFmsEmailAddresssUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOBasicRegisterDBDAOFmsEmailAddresssUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * E-mail List Registration Update
	  * </pre>
	  */
	public TCharterIOBasicRegisterDBDAOFmsEmailAddresssUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOBasicRegisterDBDAOFmsEmailAddresssUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE FMS_SCR_EML_ADDR SET" ).append("\n"); 
