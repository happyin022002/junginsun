...
*@FileName : ESM_BKG_0595HTMLAction.java
...
public class ESM_BKG_0595HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0595HTMLAction 객체를 생성
	 */
	public ESM_BKG_0595HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0595Event event = new EsmBkg0595Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFreightChargeSummaryReportInVO((FreightChargeSummaryReportInVO)getVO(request, FreightChargeSummaryReportInVO .class));
		}
