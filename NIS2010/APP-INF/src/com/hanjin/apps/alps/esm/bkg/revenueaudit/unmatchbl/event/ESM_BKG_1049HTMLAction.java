...
*@FileName : ESM_BKG_1049HTMLAction.java
...
public class ESM_BKG_1049HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1049HTMLAction 객체를 생성
	 */
	public ESM_BKG_1049HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1049Event event = new EsmBkg1049Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchUnmatchItemListVO((RsltSearchUnmatchItemListVO)getVO(request, RsltSearchUnmatchItemListVO.class));
		}
