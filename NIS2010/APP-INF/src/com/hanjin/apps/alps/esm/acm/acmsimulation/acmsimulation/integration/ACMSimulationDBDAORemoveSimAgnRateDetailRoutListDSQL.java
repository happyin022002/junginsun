...
*@FileName : ACMSimulationDBDAORemoveSimAgnRateDetailRoutListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAORemoveSimAgnRateDetailRoutListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAORemoveSimAgnRateDetailRoutListDSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAORemoveSimAgnRateDetailRoutListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_SIM_AGMT_DTL_ROUT" ).append("\n"); 
