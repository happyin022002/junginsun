...
*@FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPriRpScpGrpLocVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPriRpScpGrpLocVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RP_SCP_GRP_LOC LOC" ).append("\n"); 
