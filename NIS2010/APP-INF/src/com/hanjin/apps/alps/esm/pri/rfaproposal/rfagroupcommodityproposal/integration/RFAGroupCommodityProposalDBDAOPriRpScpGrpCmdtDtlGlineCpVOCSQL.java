...
*@FileName : RFAGroupCommodityProposalDBDAOPriRpScpGrpCmdtDtlGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAOPriRpScpGrpCmdtDtlGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAGroupCommodityProposalDBDAOPriRpScpGrpCmdtDtlGlineCpVOCSQL
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAOPriRpScpGrpCmdtDtlGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAOPriRpScpGrpCmdtDtlGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CMDT.GRP_CMDT_DTL_SEQ," ).append("\n"); 
		...
		query.append("PRI_RG_GRP_CMDT_DTL CMDT" ).append("\n"); 
		query.append("" ).append("\n"); 
