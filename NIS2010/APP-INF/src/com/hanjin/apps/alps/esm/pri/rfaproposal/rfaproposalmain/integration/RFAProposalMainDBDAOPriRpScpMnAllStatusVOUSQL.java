...
*@FileName : RFAProposalMainDBDAOPriRpScpMnAllStatusVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpScpMnAllStatusVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Cancel 시 Status 변경
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpScpMnAllStatusVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpScpMnAllStatusVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET PROP_SCP_STS_CD = @[prop_scp_sts_cd]" ).append("\n"); 
		query.append(",UPD_USR_ID          = @[upd_usr_id]" ).append("\n"); 
		query.append(",UPD_DT              = SYSDATE" ).append("\n"); 
		query.append("WHERE PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("AND    AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("AND EXISTS ( SELECT 1 FROM PRI_RP_SCP_AMDT_SMRY" ).append("\n"); 
