 ...
 * @since J2EE 1.6
 */
public class EsmCoa0066ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0066ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmCoa0066ViewAdapter ########### [START]");
		...
		log.debug("########### EsmCoa0066ViewAdapter ########### [END]");        
