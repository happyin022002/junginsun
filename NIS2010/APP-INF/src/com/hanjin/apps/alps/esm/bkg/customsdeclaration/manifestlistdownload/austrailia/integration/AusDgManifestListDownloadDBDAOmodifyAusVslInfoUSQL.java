...
*@FileName : AusDgManifestListDownloadDBDAOmodifyAusVslInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusDgManifestListDownloadDBDAOmodifyAusVslInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Australia Vessel 정보를 업데이트한다.
	  * </pre>
	  */
	public AusDgManifestListDownloadDBDAOmodifyAusVslInfoUSQL(){
		setQuery();
		...
		query.append("FileName : AusDgManifestListDownloadDBDAOmodifyAusVslInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_DG_VSL_SKD SET " ).append("\n"); 
		query.append("	BRTH_YD_CD = @[brth_yd_cd]" ).append("\n"); 
		query.append(",	BRTH_YD_NM = @[yd_nm]" ).append("\n"); 
		query.append(",	SVC_RQST_NO = @[svc_rqst_no]" ).append("\n"); 
		query.append(",	ETA_DT = TO_DATE(@[eta_d] || ' ' ||@[eta_t],'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		query.append(",	ETD_DT = TO_DATE(@[etd_d] || ' ' ||@[etd_t],'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		query.append(",	LLOYD_NO   = @[lloyd_no]" ).append("\n"); 
		query.append(",   VSL_ID = @[vsl_cd]" ).append("\n"); 
