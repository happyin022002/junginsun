...
*@FileName : RevenueDebitNoteDBDAOBkgRevDrNoteProgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOBkgRevDrNoteProgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrNoteProgVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_REV_DR_NOTE_PROG" ).append("\n"); 
		...
		query.append("FileName : RevenueDebitNoteDBDAOBkgRevDrNoteProgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}