...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineRoutViaVOUSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineRoutViaVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineRoutViaVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_ROUT_VIA SET" ).append("\n"); 
		...
		query.append(",	ROUT_VIA_SEQ = @[rout_via_seq]" ).append("\n"); 
		...
		query.append("WHERE	GLINE_SEQ = @[gline_seq]" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineRoutViaVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}