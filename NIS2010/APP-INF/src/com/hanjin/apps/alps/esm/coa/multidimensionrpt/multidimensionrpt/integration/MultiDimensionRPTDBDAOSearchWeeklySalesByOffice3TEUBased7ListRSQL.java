...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased7ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                   ,31, EMPTH_TERMINAL_EXPENSE" ).append("\n"); 
		...
		query.append("                  ,SUM(EMPTH_TERMINAL_EXPENSE        ) AS EMPTH_TERMINAL_EXPENSE " ).append("\n"); 
		...
		query.append("                          		" ).append("\n"); 
		query.append("                          ,SUM(A2.MTY_STVG_PA_AMT)          AS EMPTH_TERMINAL_EXPENSE " ).append("\n"); 
		...
		query.append("                          ,SUM(A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV) " ).append("\n"); 
		query.append("                           - SUM(DECODE('P','P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT))         AS CM" ).append("\n"); 
		query.append("                          " ).append("\n"); 
		query.append("                          " ).append("\n"); 
		...
		query.append("                  , SUM(DECODE(STATUS, STATUS2, BKG_REV+BKG_OFT_REV+BKG_MISC_REV+SCR_CHG_REV, 0)) " ).append("\n"); 
