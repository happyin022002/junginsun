...
*@FileName : MTCostDBDAOSearchMTCost5ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCost5ListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCost5ListVORSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCost5ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
