...
*@FileName : BDRCorrectionDBDAOSearchAddChargeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BDRCorrectionDBDAOSearchAddChargeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BDRCorrectionDBDAOSearchAddChargeRSQL
	  * </pre>
	  */
	public BDRCorrectionDBDAOSearchAddChargeRSQL(){
		setQuery();
		...
		query.append("FileName : BDRCorrectionDBDAOSearchAddChargeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CHG_CD_HIS" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("WHERE BKG_NO IS NULL" ).append("\n"); 
