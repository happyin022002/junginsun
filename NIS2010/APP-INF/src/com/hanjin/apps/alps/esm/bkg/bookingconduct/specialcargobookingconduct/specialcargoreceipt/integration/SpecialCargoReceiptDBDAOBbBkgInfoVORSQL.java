...
*@FileName : SpecialCargoReceiptDBDAOBbBkgInfoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOBbBkgInfoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOBbBkgInfoVORSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOBbBkgInfoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		       AND K.RIDR_TP_CD ='B'" ).append("\n"); 
		...
		query.append("           and a.CMDT_CD = b.CMDT_CD) a" ).append("\n"); 
		...
		query.append("            and CORR_NO = 'TMP0000001') b" ).append("\n"); 
		query.append("      , (select BKG_NO" ).append("\n"); 
		...
		query.append("            AND BV.VSL_PRE_PST_CD = 'U') d" ).append("\n"); 
		query.append(" where a.BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("   and a.CORR_NO = 'TMP0000001'" ).append("\n"); 
		...
		query.append("             , CONCAT(CONCAT(VSL_CD, SKD_VOY_NO),SKD_DIR_CD) VSL_CD" ).append("\n"); 
		query.append("             , RCV_TERM_CD" ).append("\n"); 
		query.append("             , DE_TERM_CD" ).append("\n"); 
		query.append("             , POL_CD" ).append("\n"); 
		query.append("             , SUBSTR(POL_NOD_CD, 6,2) POL_NOD_CD" ).append("\n"); 
		query.append("             , POD_CD" ).append("\n"); 
		query.append("             , SUBSTR(POD_NOD_CD, 6,2) POD_NOD_CD" ).append("\n"); 
		query.append("             , a.POR_CD" ).append("\n"); 
		query.append("             , a.DEL_CD" ).append("\n"); 
		query.append("             , a.OVR_VOID_SLT_QTY" ).append("\n"); 
		query.append("             , a.CMDT_CD" ).append("\n"); 
		...
		query.append("          where bkg_no = @[bkg_no]) b" ).append("\n"); 
		query.append("      , (select BKG_NO" ).append("\n"); 
		query.append("              , sum(PCK_QTY) PCK_QTY" ).append("\n"); 
		query.append("              , sum(GRS_WGT) GRS_WGT" ).append("\n"); 
		query.append("              , WGT_UT_CD" ).append("\n"); 
		...
		query.append("          where bkg_no = @[bkg_no]" ).append("\n"); 
		query.append("       group by BKG_NO, WGT_UT_CD) c" ).append("\n"); 
