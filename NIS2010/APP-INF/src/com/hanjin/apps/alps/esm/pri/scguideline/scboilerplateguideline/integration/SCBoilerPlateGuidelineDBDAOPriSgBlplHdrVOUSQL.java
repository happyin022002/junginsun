...
*@FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("blpl_ref_yr = @[blpl_ref_yr]," ).append("\n"); 
		query.append("blpl_nm = @[blpl_ref_yr] || ' Boiler Plate'," ).append("\n"); 
