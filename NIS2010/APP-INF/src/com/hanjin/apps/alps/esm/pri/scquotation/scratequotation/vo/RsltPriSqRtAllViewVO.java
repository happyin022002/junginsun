...
public class RsltPriSqRtAllViewVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqRtAllViewVO> models = new ArrayList<RsltPriSqRtAllViewVO>();
	 ...
	 */
	public RsltPriSqRtAllViewVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqRtAllViewVO[]
	 */
	public RsltPriSqRtAllViewVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqRtAllViewVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSqRtAllViewVO();
	 ...
	 * @return RsltPriSqRtAllViewVO[]
	 */
	public RsltPriSqRtAllViewVO[] getRsltPriSqRtAllViewVOs(){
		RsltPriSqRtAllViewVO[] vos = (RsltPriSqRtAllViewVO[])models.toArray(new RsltPriSqRtAllViewVO[models.size()]);
		return vos;
	}
