 ...
 *@FileName : ESM_BKG_0560HTMLAction.java
 *@FileTitle : ESM_BKG_0560HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0560HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0560HTMLAction 객체를 생성
	 */
	public ESM_BKG_0560HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0560Event event = new EsmBkg0560Event();

		if (command.isCommand(FormCommand.SEARCH)) {

			event.setKrWhfPortRtListCondVO( (KrWhfPortRtListCondVO)getVO(request, KrWhfPortRtListCondVO.class) );  
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setKrWhfPortRtVOs2((KrWhfPortRtVO[])getVOs(request, KrWhfPortRtVO.class, "sheet1_") );  
		}
