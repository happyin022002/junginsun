	...
	protected String makeDataTag(List<AbstractValueObject> voList, String prefix) {
		...
		try{
			...
			for (int k=0; k<voList.size(); k++) {
				...
				// 직후 bl_no와 다르면 카운팅
				Map<String, String> tempMapColumnValues = null;
				...
				for (String colNm : colNmArray) {
					...
					if (("mst_bl".equals(colNm) && "E".equals(colValue)) ||
						("shpr_nm".equals(colNm) || "shpr_addr".equals(colNm) || "shpr_cnt_cd".equals(colNm) || "shpr_phn_no".equals(colNm) || "shpr_via".equals(colNm) ||
						 "cnee_nm".equals(colNm) || "cnee_addr".equals(colNm) || "cnee_cnt_cd".equals(colNm) || "cnee_phn_no".equals(colNm) || "cnee_via".equals(colNm) ||
						 "ntfy_nm".equals(colNm) || "ntfy_addr".equals(colNm) || "ntfy_cnt_cd".equals(colNm) || "ntfy_phn_no".equals(colNm) || "ntfy_via".equals(colNm) ||
						 "cmdt_cd".equals(colNm) || "cmdt_hs_cd".equals(colNm) || "mk_desc".equals(colNm) ||
						 "pck_qty".equals(colNm) || "pck_tp_cd".equals(colNm) || "act_wgt".equals(colNm) ||
						 "wgt_ut_cd".equals(colNm) || "meas_qty".equals(colNm) || "meas_ut_cd".equals(colNm) ||
						 "imdg_cls".equals(colNm) || "un_no".equals(colNm)) && "N".equals(colValue)) {
			...
			searchXml.append("   <ETC KEY='disp_hjs_err_bl'>" + errSeq + "</ETC>\n");
