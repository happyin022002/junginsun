...
*@FileName : Kor24CustomsTransmissionDBDAOaddIMFMODSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddIMFMODSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * IMFMOD 전송 Detail 내역(Flat File)을 add한다.
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddIMFMODSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddIMFMODSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
