...
*@FileName : CndExpManifestListDownloadDBDAOsearchContainerManifestListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchContainerManifestListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchContainerManifestListRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchContainerManifestListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
