...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineCmdtVOUSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineCmdtVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_CMDT SET" ).append("\n"); 
		...
		query.append(",	CMDT_SEQ = @[cmdt_seq]" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}