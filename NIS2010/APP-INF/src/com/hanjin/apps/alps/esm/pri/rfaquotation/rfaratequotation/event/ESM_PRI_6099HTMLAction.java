 ...
 *@FileName : ESM_PRI_6099HTMLAction.java
...
public class ESM_PRI_6099HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6099HTMLAction 객체를 생성
	 */
	public ESM_PRI_6099HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6099Event event = new EsmPri6099Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			event.getRateQuotationVO().setPriRqRtCmdtHdrVO((PriRqRtCmdtHdrVO) getVO(request, PriRqRtCmdtHdrVO.class));
			event.getRateQuotationVO().setRsltPriRqRtListHorizontalExcelForAddOnTariffVOs((RsltPriRqRtListHorizontalExcelForAddOnTariffVO[]) getVOs(request, RsltPriRqRtListHorizontalExcelForAddOnTariffVO.class, ""));
		}
