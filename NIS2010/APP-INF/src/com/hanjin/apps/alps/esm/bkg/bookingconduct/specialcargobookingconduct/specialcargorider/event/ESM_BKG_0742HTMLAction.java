...
*@FileName : UI_BKG_0742HTMLAction.java
...
public class ESM_BKG_0742HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_BKG_0742HTMLAction 객체를 생성
	 */
	public ESM_BKG_0742HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("[START:: perform ESM_BKG_0742HTMLAction  ]==========");

		EsmBkg0742Event event = new EsmBkg0742Event();

		FormCommand command = FormCommand.fromRequest(request);
		if(command.isCommand(FormCommand.SEARCH)) {
			log.debug("[START:: ESM_BKG_0742HTMLAction SEARCH ]==========");
			AttachFileInVO attachFileInVO = (AttachFileInVO)getVO(request, AttachFileInVO.class);
			event.setAttachFileInVO(attachFileInVO);
			log.debug("[END:: ESM_BKG_0742HTMLAction SEARCH ]==========");
		}

		request.setAttribute("Event", event);
		log.debug("[END:: perform ESM_BKG_0742HTMLAction  ]==========");
		return  event;
	}
