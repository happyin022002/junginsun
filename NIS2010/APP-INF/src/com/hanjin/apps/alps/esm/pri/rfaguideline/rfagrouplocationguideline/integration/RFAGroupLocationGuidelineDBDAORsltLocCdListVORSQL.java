...
*@FileName : RFAGroupLocationGuidelineDBDAORsltLocCdListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationGuidelineDBDAORsltLocCdListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * location code check
	  * 2013.01.23 전윤주 [CHM-201322530] mdm_location 체크 시 delt_flg check 추가
	  * </pre>
	  */
	public RFAGroupLocationGuidelineDBDAORsltLocCdListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationGuidelineDBDAORsltLocCdListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
