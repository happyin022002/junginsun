...
*@FileName : ESM_BKG_0214HTMLAction.java
...
public class ESM_BKG_0214HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0214HTMLAction 객체를 생성
	 */
	public ESM_BKG_0214HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0214Event event = new EsmBkg0214Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDocPFMCOfcListVO((DocPFMCOfcListVO)getVO(request, DocPFMCOfcListVO .class));
			event.setDocPFMCBLListVO((DocPFMCBLListVO)getVO(request, DocPFMCBLListVO .class));
