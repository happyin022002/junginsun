...
*@FileName : ESM_BKG_1176HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_1176HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1176HTMLAction 객체를 생성
     */
    public ESM_BKG_1176HTMLAction() {
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_BKG_1176Event로 파싱하여 request에 셋팅<br>
     * 
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EsmBkg1176Event event = new EsmBkg1176Event();
