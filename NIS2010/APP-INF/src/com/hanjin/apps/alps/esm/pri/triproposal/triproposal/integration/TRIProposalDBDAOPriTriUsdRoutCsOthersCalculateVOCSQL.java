...
*@FileName : TRIProposalDBDAOPriTriUsdRoutCsOthersCalculateVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriUsdRoutCsOthersCalculateVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriUsdRoutCsOthersCalculateVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriUsdRoutCsOthersCalculateVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND ORG.TRI_PROP_NO  = OVIA.TRI_PROP_NO(+)    " ).append("\n"); 
		query.append("   AND ORG.TRI_PROP_NO  = DVIA.TRI_PROP_NO(+)   " ).append("\n"); 
		...
		query.append("   AND NVL(ROUT.POL_CD, 'Z') = NVL(OVIA.LOC_CD, 'Z')" ).append("\n"); 
		query.append("   AND NVL(ROUT.POD_CD, 'Z') = NVL(DVIA.LOC_CD, 'Z')" ).append("\n"); 
		...
		query.append("   AND ROUT.PRS_ROUT_CS_BAT_RSLT_CD = 'S'" ).append("\n"); 
