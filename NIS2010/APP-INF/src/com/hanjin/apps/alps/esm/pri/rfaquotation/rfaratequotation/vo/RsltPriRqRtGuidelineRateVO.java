 ...
 *@FileName : RsltPriRqRtGuidelineRateVO.java
 *@FileTitle : RsltPriRqRtGuidelineRateVO
 *Open Issues :
 *Change history :
...
public class RsltPriRqRtGuidelineRateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<RsltPriRqRtGuidelineRateVO> models = new ArrayList<RsltPriRqRtGuidelineRateVO>();
	...
	public RsltPriRqRtGuidelineRateVO() {
	}

	public RsltPriRqRtGuidelineRateVO(String ibflag, String pagerows, String hSeq, String routDpSeq, String cmdtDpSeq, String ficRtUseStsCd, String ficRoutCmbTpCd,
			String optmTrspModFlg, String groupNo, String dr20ftAmt, String rf20ftAmt, String dg20ftAmt, String dr40ftAmt, String rf40ftAmt, String dg40ftAmt,
			String basePortList, String cmdtRout) {
	 ...
	 * 
	 * @param request
	 * @return RsltPriRqRtGuidelineRateVO[]
	 */
	public RsltPriRqRtGuidelineRateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqRtGuidelineRateVO[]
	 */
	public RsltPriRqRtGuidelineRateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqRtGuidelineRateVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriRqRtGuidelineRateVO();
				if (rf40ftAmt[i] != null)
		...
		return getRsltPriRqRtGuidelineRateVOs();
	}
	 ...
	 * @return RsltPriRqRtGuidelineRateVO[]
	 */
	public RsltPriRqRtGuidelineRateVO[] getRsltPriRqRtGuidelineRateVOs() {
		RsltPriRqRtGuidelineRateVO[] vos = (RsltPriRqRtGuidelineRateVO[]) models.toArray(new RsltPriRqRtGuidelineRateVO[models.size()]);
		return vos;
	}
