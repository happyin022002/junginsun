...
public class KorCustomsTransmissionDBDAOmakeDGMNFTCNTRInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			MF_CERTI_NO||DECODE(@[io_bnd_cd], 'I','SMLM','')			||'~'||	    /*	MANIFEST REFERENCE NO + INBOUND SMLM	*/" ).append("\n"); 
		query.append("			DECODE(@[io_bnd_cd],'O',SUBSTR(@[certi_seq_no],2),CGO_SEQ_NO)||'~'||	/*	MANIFEST REFERENCE SEQ NO	*//* OUTBOUD SEQ 만 INBOUND SEQ로 전송*/" ).append("\n"); 
		query.append("			''		||'~'||	" ).append("\n"); 
