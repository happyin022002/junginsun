...
public class CLLCDLManifestDBDAOsearchCllBkgRfCgoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  AND NVL(CLL.CLPT_IND_SEQ,'1') = @[clpt_ind_seq]   -- Add. 2015.02.09. CHM-201533845" ).append("\n"); 
		...
		query.append("													#if (${clpt_ind_seq} != '')        " ).append("\n"); 
		query.append("													  AND NVL(CLPT_IND_SEQ,'1') = @[clpt_ind_seq]   -- Add. 2015.02.09. CHM-201533845" ).append("\n"); 
		query.append("													#end" ).append("\n"); 
