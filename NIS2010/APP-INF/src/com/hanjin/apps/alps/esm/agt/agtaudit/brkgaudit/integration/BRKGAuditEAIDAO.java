 ...
 * @since J2EE 1.4
 */
public class BRKGAuditEAIDAO extends EAIDAOSupport {
	 ...
	 * @throws DAOException
	 */	
	public FNS0080003Document[] transferAtOnceAGT018ToEAIByWS(String csrNo, DBRowSet rowSet, ComAproRqstRoutVO rout) throws DAOException {

		FNS0080003Document[] docReq		= null;        
        int cnt = 1;
		
		try {
			log.debug("\n\n WebService 연동 시작 : AGT018 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ \n\n");
			...
			log.error("\n AGT(BROKERAGE) START CSRNO : "+csrNo+", FNS0080003Document[] - arr_leng:"+docReq.length+" <<<<\n");
