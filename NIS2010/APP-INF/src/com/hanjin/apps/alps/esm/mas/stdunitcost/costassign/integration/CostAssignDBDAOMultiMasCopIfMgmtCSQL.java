...
*@FileName : CostAssignDBDAOMultiMasCopIfMgmtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostAssignDBDAOMultiMasCopIfMgmtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostAssignDBDAOMultiMasCopIfMgmtCSQL(){
		setQuery();
		...
		query.append("FileName : CostAssignDBDAOMultiMasCopIfMgmtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_COP_IF_MGMT A1" ).append("\n"); 
		query.append("USING (" ).append("\n"); 
		query.append("       SELECT @[bkg_no]         AS BKG_NO" ).append("\n"); 
		query.append("             ,'n'               AS MAS_DY_BAT_CD" ).append("\n"); 
		query.append("             ,0                 AS MAS_DY_BAT_SEQ" ).append("\n"); 
		query.append("             ,SYSDATE           AS MAS_DY_BAT_DT" ).append("\n"); 
		query.append("             ,@[if_rmk] AS COST_IF_DY_RMK" ).append("\n"); 
		...
		query.append("       SET A1.MAS_DY_BAT_CD  = A2.MAS_DY_BAT_CD" ).append("\n"); 
		query.append("          ,A1.COST_IF_DY_RMK = A2.COST_IF_DY_RMK" ).append("\n"); 
		query.append("          ,A1.MAS_DY_BAT_DT  = A2.MAS_DY_BAT_DT" ).append("\n"); 
		...
		query.append("          ,A1.MAS_DY_BAT_CD" ).append("\n"); 
		query.append("          ,A1.MAS_DY_BAT_SEQ" ).append("\n"); 
		query.append("          ,A1.MAS_DY_BAT_DT" ).append("\n"); 
		...
		query.append("          ,A2.MAS_DY_BAT_CD" ).append("\n"); 
		query.append("          ,A2.MAS_DY_BAT_SEQ" ).append("\n"); 
		query.append("          ,A2.MAS_DY_BAT_DT" ).append("\n"); 
