...
public class CsScreenDBDAOsearchArrNtcCneeInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD6,'9'), '5', 'B', '6', 'R','9','X','P'), DECODE(NVL(SUBQ.SND_RSLT_CD6,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD6" ).append("\n"); 
		query.append("     , DECODE(SUBQ.KIND_DESC, 'Fax', DECODE(NVL(SUBQ.SND_RSLT_CD7,'9'), '5', 'B', '6', 'R','9','X','P'), DECODE(NVL(SUBQ.SND_RSLT_CD7,'9'), '3', 'B', '2', 'R', '9','X','P'))   AS SND_RSLT_CD7" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("     , BKG_COM_INTG_CD_NM_FNC('CD00960', SUBQ.SND_RSLT_CD6 )   AS SND_RSLT_NM6  -- RD E-MAIL전송 상태" ).append("\n"); 
		query.append("     , BKG_COM_INTG_CD_NM_FNC('CD00960', SUBQ.SND_RSLT_CD7 )   AS SND_RSLT_NM7  -- RD E-MAIL전송 상태" ).append("\n"); 
