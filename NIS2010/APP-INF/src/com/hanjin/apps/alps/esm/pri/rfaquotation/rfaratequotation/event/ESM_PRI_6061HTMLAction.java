 ...
 *@FileName : ESM_PRI_6061HTMLAction.java
...
public class ESM_PRI_6061HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6061HTMLAction 객체를 생성
	 */
	public ESM_PRI_6061HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6061Event event = new EsmPri6061Event();
