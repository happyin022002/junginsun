...
*@FileName : RsltPriCommodityRouteVO.java
*@FileTitle : RsltPriCommodityRouteVO
*Open Issues :
*Change history :
...
public class RsltPriCommodityRouteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCommodityRouteVO> models = new ArrayList<RsltPriCommodityRouteVO>();
	...
	public RsltPriCommodityRouteVO() {}

	public RsltPriCommodityRouteVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String genSpclRtTpCd, String cmdtHdrSeq, String cmdtNm) {
		this.ibflag = ibflag;
	 ...
	 */
	public RsltPriCommodityRouteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCommodityRouteVO[]
	 */
	public RsltPriCommodityRouteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCommodityRouteVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCommodityRouteVO();
				if (ibflag[i] != null)
		...
		return getRsltPriCommodityRouteVOs();
	}
	...
	public RsltPriCommodityRouteVO[] getRsltPriCommodityRouteVOs(){
		RsltPriCommodityRouteVO[] vos = (RsltPriCommodityRouteVO[])models.toArray(new RsltPriCommodityRouteVO[models.size()]);
		return vos;
	}
