...
public class SCCopyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SCCopyVO> models = new ArrayList<SCCopyVO>();
	...
	public SCCopyVO(String ibflag, String pagerows, String propNo, String amdtSeq, String effDt, String n1stCmncDt, String blplHdrSeq, String creUsrId, String updUsrId) {
	 ...
	 * @return SCCopyVO[]
	 */
	public SCCopyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SCCopyVO[]
	 */
	public SCCopyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SCCopyVO model = null;
		...
		try {
			...
			String[] n1stCmncDt = (JSPUtil.getParameter(request, prefix	+ "n1st_cmnc_dt".trim(), length));
	 ...
	 * @return SCCopyVO[]
	 */
	public SCCopyVO[] getSCCopyVOs(){
		SCCopyVO[] vos = (SCCopyVO[])models.toArray(new SCCopyVO[models.size()]);
		return vos;
	}
