...
*@FileName : IHCDetailVO.java
*@FileTitle : IHCDetailVO
*Open Issues :
*Change history :
...
public class IHCDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<IHCDetailVO> models = new ArrayList<IHCDetailVO>();
	...
	public IHCDetailVO(String ibflag, String pagerows, String svcScpCd, String orgDestTpCd, String ihcTrfNo, String amdtSeq, String ihcCgoTpCd, String creUsrId, String updUsrId) {
...
/**
	 ...
	 * @return IHCDetailVO[]
	 */
	public IHCDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return IHCDetailVO[]
	 */
	public IHCDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		IHCDetailVO model = null;
	 ...
	 * @return IHCDetailVO[]
	 */
	public IHCDetailVO[] getIHCDetailVOs(){
		IHCDetailVO[] vos = (IHCDetailVO[])models.toArray(new IHCDetailVO[models.size()]);
		return vos;
	}
