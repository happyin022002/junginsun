...
*@FileName : SearchMTCost8ListVO.java
*@FileTitle : SearchMTCost8ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost8ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost8ListVO> models = new ArrayList<SearchMTCost8ListVO>();
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPOriDest(JSPUtil.getParameter(request, prefix + "p_ori_dest", ""));
	 ...
	 */
	public SearchMTCost8ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost8ListVO[]
	 */
	public SearchMTCost8ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost8ListVO model = null;
		...
		return getSearchMTCost8ListVOs();
	}
	 ...
	 * @return SearchMTCost8ListVO[]
	 */
	public SearchMTCost8ListVO[] getSearchMTCost8ListVOs(){
		SearchMTCost8ListVO[] vos = (SearchMTCost8ListVO[])models.toArray(new SearchMTCost8ListVO[models.size()]);
		return vos;
	}
