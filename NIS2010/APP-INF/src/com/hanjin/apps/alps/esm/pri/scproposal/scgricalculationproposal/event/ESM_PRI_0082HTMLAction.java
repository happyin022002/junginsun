 ...
 *@FileName : UI_PRI_0082HTMLAction.java
...
public class ESM_PRI_0082HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0082Event event = new EsmPri0082Event();

 
	        if (command.isCommand(FormCommand.SEARCH01)) {
	            event.setPriSpScpRtActCustVO((PriSpScpRtActCustVO) getVO(request, PriSpScpRtActCustVO.class));
	        }
