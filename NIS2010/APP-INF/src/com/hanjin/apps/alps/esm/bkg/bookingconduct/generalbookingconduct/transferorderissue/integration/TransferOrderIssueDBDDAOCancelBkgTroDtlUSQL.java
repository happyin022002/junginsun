...
*@FileName : TransferOrderIssueDBDDAOCancelBkgTroDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDDAOCancelBkgTroDtlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDBDAOCancelBkgTroDtlUSQL
	  * </pre>
	  */
	public TransferOrderIssueDBDDAOCancelBkgTroDtlUSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDDAOCancelBkgTroDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_TRO_DTL" ).append("\n"); 
