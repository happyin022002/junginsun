...
*@FileName : BLInformationMgtDBDAOSearchHouseBlYnRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLInformationMgtDBDAOSearchHouseBlYnRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLInformationMgtDBDAOSearchHouseBlYnRSQL(){
		setQuery();
		...
		query.append("FileName : BLInformationMgtDBDAOSearchHouseBlYnRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM BIS_HBL HBL" ).append("\n"); 
