...
*@FileName : UsaCustomsTransmissionDBDAOmodifyCustomsResultForRemarkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaCustomsTransmissionDBDAOmodifyCustomsResultForRemarkUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaCustomsTransmissionDBDAOmodifyCustomsResultForRemarkUSQL(){
		setQuery();
		...
		query.append("FileName : UsaCustomsTransmissionDBDAOmodifyCustomsResultForRemarkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("BL_NVOCC_TP_CD = 'M'," ).append("\n"); 
