...
*@FileName : PRICommonDBDAOPrsRqExchangeRateYrMonRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAOPrsRqExchangeRateYrMonRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_rq_mn prs_xch_rt_yrmon 을 조회한다. 조회조건 (prop_no , amdt_seq , svc_scp_cd )
	  * </pre>
	  */
	public PRICommonDBDAOPrsRqExchangeRateYrMonRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAOPrsRqExchangeRateYrMonRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
