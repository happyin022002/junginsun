...
public class BrManifestListDetailVO extends ManifestListDetailVO {
	...
	/* Column Info */
	private String ibTsYn = null;
	/* Column Info */
	private String obTsYn = null;
	/* Column Info */	
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ib_ts_yn", getIbTsYn());
		this.hashColumns.put("ob_ts_yn", getObTsYn());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ib_ts_yn", "ibTsYn");
		this.hashFields.put("ob_ts_yn", "obTsYn");
	 ...
	 * @param ibTsYn
	 */
	public void setIbTsYn(String ibTsYn) {
		this.ibTsYn = ibTsYn;
	}
	 ...
	 * @param obTsYn
	 */
	public void setObTsYn(String obTsYn) {
		this.obTsYn = obTsYn;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setIbTsYn(JSPUtil.getParameter(request, prefix + "ib_ts_yn", ""));
		setObTsYn(JSPUtil.getParameter(request, prefix + "ob_ts_yn", ""));
		setTrd(JSPUtil.getParameter(request, prefix + "trd", ""));
		setWpm(JSPUtil.getParameter(request, prefix + "wpm", ""));		
	}
	...
	public BrManifestListDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ibTsYn = (JSPUtil.getParameter(request, prefix	+ "ib_ts_yn", length));
			String[] obTsYn = (JSPUtil.getParameter(request, prefix	+ "ob_ts_yn", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ibTsYn[i] != null)
					model.setIbTsYn(ibTsYn[i]);
				if (obTsYn[i] != null)
					model.setObTsYn(obTsYn[i]);
				if (trd[i] != null)
					model.setTrd(trd[i]);
				if (wpm[i] != null)
					model.setWpm(wpm[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.ibTsYn = this.ibTsYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.obTsYn = this.obTsYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
