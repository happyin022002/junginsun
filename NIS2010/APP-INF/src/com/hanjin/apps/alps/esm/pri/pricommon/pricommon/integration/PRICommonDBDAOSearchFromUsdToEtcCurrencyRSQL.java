...
*@FileName : PRICommonDBDAOSearchFromUsdToEtcCurrencyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAOSearchFromUsdToEtcCurrencyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * USD 금액을 다른 환율 금액으로 변경
	  * </pre>
	  */
	public PRICommonDBDAOSearchFromUsdToEtcCurrencyRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAOSearchFromUsdToEtcCurrencyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT USD_LOCL_XCH_RT * NVL(@[rate], 0) RATE" ).append("\n"); 
