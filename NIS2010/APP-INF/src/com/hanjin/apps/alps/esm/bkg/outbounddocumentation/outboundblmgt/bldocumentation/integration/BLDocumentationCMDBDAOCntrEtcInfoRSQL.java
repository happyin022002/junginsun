...
public class BLDocumentationCMDBDAOCntrEtcInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append(",      (SELECT 'Y' FROM BKG_BKG_HIS BK, BKG_VVD_HIS VVD  WHERE BK.BKG_NO =  A.BKG_NO" ).append("\n"); 
		...
		query.append("                                                AND  NOT EXISTS ( SELECT 'X' FROM BKG_VVD_HIS V , BKG_BKG_HIS BKG" ).append("\n"); 
		...
		query.append("                                                                                                            AND V.CORR_NO = 'TMP0000001')" ).append("\n"); 
		query.append("" ).append("\n"); 
