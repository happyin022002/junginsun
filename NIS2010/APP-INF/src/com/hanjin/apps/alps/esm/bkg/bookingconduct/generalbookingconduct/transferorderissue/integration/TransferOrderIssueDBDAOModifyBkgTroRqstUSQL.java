...
*@FileName : TransferOrderIssueDBDAOModifyBkgTroRqstUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOModifyBkgTroRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDBDAOModifyBkgTroRqst
	  * </pre>
	  */
	public TransferOrderIssueDBDAOModifyBkgTroRqstUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("SET RQST_DT = SYSDATE," ).append("\n");
		...
		query.append("FileName : TransferOrderIssueDBDAOModifyBkgTroRqstUSQL").append("\n");
		query.append("*/").append("\n");
	}
}