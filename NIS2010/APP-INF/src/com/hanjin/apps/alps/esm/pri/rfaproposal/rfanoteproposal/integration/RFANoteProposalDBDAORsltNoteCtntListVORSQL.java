...
*@FileName : RFANoteProposalDBDAORsltNoteCtntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteProposalDBDAORsltNoteCtntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFANoteProposalDBDAORsltNoteCtntListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFANoteProposalDBDAORsltNoteCtntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
