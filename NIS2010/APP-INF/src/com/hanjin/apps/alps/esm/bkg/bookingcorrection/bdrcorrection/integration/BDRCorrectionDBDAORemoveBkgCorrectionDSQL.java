...
*@FileName : BDRCorrectionDBDAORemoveBkgCorrectionDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BDRCorrectionDBDAORemoveBkgCorrectionDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BDRCorrectionDBDAORemoveBkgCorrectionDSQL
	  * </pre>
	  */
	public BDRCorrectionDBDAORemoveBkgCorrectionDSQL(){
		setQuery();
		...
		query.append("FileName : BDRCorrectionDBDAORemoveBkgCorrectionDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
