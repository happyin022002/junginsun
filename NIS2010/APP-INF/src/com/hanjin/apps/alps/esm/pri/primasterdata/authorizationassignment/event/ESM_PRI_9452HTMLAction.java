...
*@FileName : ESM_PRI_9452HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_PRI_9452HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 6292978124068251371L;

	/**
     * ESM_PRI_9452HTMLAction 객체를 생성
     */
    public ESM_PRI_9452HTMLAction() {
    }

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmPri9452Event로 파싱하여 request에 셋팅<br>
	 *
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri9452Event event = new EsmPri9452Event();
