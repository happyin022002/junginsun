...
*@FileName : ESM_BKG_0746HTMLAction.java
...
public class ESM_BKG_0746HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0746HTMLAction 객체를 생성
	 */
	public ESM_BKG_0746HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0746Event event = new EsmBkg0746Event();
		

		if(command.isCommand(FormCommand.INIT)) {
			event.setVesselUtilizationStatusReportInVO((VesselUtilizationStatusReportInVO)getVO(request, VesselUtilizationStatusReportInVO .class));
