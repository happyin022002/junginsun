...
*@FileName : AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRejectUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRejectUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FAC Agreement Management Reject
	  * </pre>
	  */
	public AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRejectUSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerAgreementInfoDBDAOAgtFacAgmtRtRejectUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET COMM_PROC_STS_CD   = 'RE'," ).append("\n"); 
