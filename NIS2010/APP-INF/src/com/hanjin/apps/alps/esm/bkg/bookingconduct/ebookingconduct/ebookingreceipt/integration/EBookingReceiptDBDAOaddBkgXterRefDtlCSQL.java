...
*@FileName : EBookingReceiptDBDAOaddBkgXterRefDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterRefDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterRefDtlCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterRefDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_REF_DTL" ).append("\n"); 
		query.append("(" ).append("\n"); 
