...
*@FileName : RfaInformListVO.java
*@FileTitle : RfaInformListVO
*Open Issues :
*Change history :
...
public class RfaInformListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<RfaInformListVO> models = new ArrayList<RfaInformListVO>();
	...
	public RfaInformListVO() {}

	public RfaInformListVO(String ibflag, String pagerows, String pt, String commodityDescription, String por, String pol, String pod, String del, String dCall, String rd, String per, String cgoTp, String cur, String amount, String transMode, String qTy, String dtl, String ntV, String nt) {
		this.nt = nt;
	 ...
	 * @param request
	 * @return RfaInformListVO[]
	 */
	public RfaInformListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RfaInformListVO[]
	 */
	public RfaInformListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RfaInformListVO model = null;
	 ...
	 * @return RfaInformListVO[]
	 */
	public RfaInformListVO[] getRfaInformListVOs(){
		RfaInformListVO[] vos = (RfaInformListVO[])models.toArray(new RfaInformListVO[models.size()]);
		return vos;
	}
