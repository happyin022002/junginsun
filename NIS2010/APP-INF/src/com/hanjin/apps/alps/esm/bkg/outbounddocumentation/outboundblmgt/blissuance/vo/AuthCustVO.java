...
*@FileName : AuthCustVO.java
*@FileTitle : AuthCustVO
*Open Issues :
*Change history :
...
public class AuthCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AuthCustVO> models = new ArrayList<AuthCustVO>();
	...
	public AuthCustVO(String ibflag, String pagerows, String bkgNo, String custTp, String custCd, String custNm,String wblEml) {
		this.custTp = custTp;
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
		this.custNm = custNm;
	 ...
	 * @return AuthCustVO[]
	 */
	public AuthCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AuthCustVO[]
	 */
	public AuthCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AuthCustVO model = null;
	 ...
	 * @return AuthCustVO[]
	 */
	public AuthCustVO[] getAuthCustVOs(){
		AuthCustVO[] vos = (AuthCustVO[])models.toArray(new AuthCustVO[models.size()]);
		return vos;
	}
