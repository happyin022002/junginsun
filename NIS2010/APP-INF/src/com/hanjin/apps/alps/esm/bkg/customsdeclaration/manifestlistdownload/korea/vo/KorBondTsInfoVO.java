...
*@FileName : KorBondTsInfoVO.java
*@FileTitle : KorBondTsInfoVO
*Open Issues :
*Change history :
...
public class KorBondTsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorBondTsInfoVO> models = new ArrayList<KorBondTsInfoVO>();
	...
	/* Column Info */
	private String relayPodCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String relayPolCd = null;
	/* Column Info */
	...
	public KorBondTsInfoVO() {}

	public KorBondTsInfoVO(String ibflag, String pagerows, String mfCfmFlg, String mfSeqNo, String blNo, String krCstmsBlTpCd, String cstmsClrTpCd, String cstmsDchgLocWhCd, String cstmsCrrInLocWhCd, String cstmsClrWhCd, String bdTpCd, String nextVvd, String relayPolCd, String relayPodCd, String custNm, String pckQty, String pckTpCd, String actWgt, String polCd, String podCd, String delCd, String dcgoFlg, String rcFlg, String awkCgoFlg, String bbCgoFlg, String bdrFlg, String bdrCngFlg, String bkgStsCd, String bkgNo, String wgtUtCd, String porCd, String measQty, String measUtCd, String blTpCd, String obSlsOfcCd, String rcvTermCd, String mfRefNo) {
		this.porCd = porCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("relay_pod_cd", getRelayPodCd());
		...
		this.hashColumns.put("relay_pol_cd", getRelayPolCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("relay_pod_cd", "relayPodCd");
		...
		this.hashFields.put("relay_pol_cd", "relayPolCd");
	 ...
	 * @return relayPodCd
	 */
	public String getRelayPodCd() {
		return this.relayPodCd;
	}
	 ...
	 * @return relayPolCd
	 */
	public String getRelayPolCd() {
		return this.relayPolCd;
	}
	 ...
	 * @param relayPodCd
	 */
	public void setRelayPodCd(String relayPodCd) {
		this.relayPodCd = relayPodCd;
	}
	 ...
	 * @param relayPolCd
	 */
	public void setRelayPolCd(String relayPolCd) {
		this.relayPolCd = relayPolCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRelayPodCd(JSPUtil.getParameter(request, "relay_pod_cd", ""));
		...
		setRelayPolCd(JSPUtil.getParameter(request, "relay_pol_cd", ""));
	 ...
	 */
	public KorBondTsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorBondTsInfoVO[]
	 */
	public KorBondTsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorBondTsInfoVO model = null;
		...
		try {
			...
			String[] relayPodCd = (JSPUtil.getParameter(request, prefix	+ "relay_pod_cd", length));
			...
			String[] relayPolCd = (JSPUtil.getParameter(request, prefix	+ "relay_pol_cd", length));
			String[] mfSeqNo = (JSPUtil.getParameter(request, prefix	+ "mf_seq_no", length));
			String[] rcFlg = (JSPUtil.getParameter(request, prefix	+ "rc_flg", length));
			
			for (int i = 0; i < length; i++) {
				model = new KorBondTsInfoVO();
				if (porCd[i] != null)
				...
				if (relayPodCd[i] != null)
					model.setRelayPodCd(relayPodCd[i]);
				if (mfCfmFlg[i] != null)
				...
				if (relayPolCd[i] != null)
					model.setRelayPolCd(relayPolCd[i]);
				if (mfSeqNo[i] != null)
	 ...
	 * @return KorBondTsInfoVO[]
	 */
	public KorBondTsInfoVO[] getKorBondTsInfoVOs(){
		KorBondTsInfoVO[] vos = (KorBondTsInfoVO[])models.toArray(new KorBondTsInfoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.relayPodCd = this.relayPodCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.relayPolCd = this.relayPolCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
