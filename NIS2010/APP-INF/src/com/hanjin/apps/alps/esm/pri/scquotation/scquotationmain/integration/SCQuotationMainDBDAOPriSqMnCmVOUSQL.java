...
*@FileName : SCQuotationMainDBDAOPriSqMnCmVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCQuotationMainDBDAOPriSqMnCmVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCQuotationMainDBDAOPriSqMnCmVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCQuotationMainDBDAOPriSqMnCmVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_MN" ).append("\n"); 
		...
		query.append("FROM PRI_SQ_RT_CMDT_ROUT CR" ).append("\n"); 
