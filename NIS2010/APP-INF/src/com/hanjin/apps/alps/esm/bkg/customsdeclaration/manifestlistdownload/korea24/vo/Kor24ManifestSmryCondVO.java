...
*@FileName : Kor24ManifestSmryCondVO.java
*@FileTitle : Kor24ManifestSmryCondVO
*Open Issues :
*Change history :
 ...
 * @author 박상훈
 * @since J2EE 1.6
 * @see ManifestSmryCondVO
 */

public class Kor24ManifestSmryCondVO extends ManifestSmryCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ManifestSmryCondVO> models = new ArrayList<Kor24ManifestSmryCondVO>();
	...
	public Kor24ManifestSmryCondVO() {}

	public Kor24ManifestSmryCondVO(String ibflag, String pagerows, String userId, String vvd, String portCd, String polCd, String podCd, String tmlCd, String podTml, String bdAreaCd, String ioBndCd, String inType, String callKnt, String vslNm, String vslCallSgnCd, String etaDt, String etdDt, String cstmsDchgCd, String dchgMzdCd, String ioTmlLocCd, String loclCstmsCd, String loclCstmsPrtCd, String vslCntCd, String mrnNo, String vvdSeq) {
		this.etaDt = etaDt;
	 ...
	 */
	public Kor24ManifestSmryCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24ManifestSmryCondVO[]
	 */
	public Kor24ManifestSmryCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ManifestSmryCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24ManifestSmryCondVO();
				if (etaDt[i] != null)
		...
		return getKor24ManifestSmryCondVOs();
	}
	 ...
	 * @return Kor24ManifestSmryCondVO[]
	 */
	public Kor24ManifestSmryCondVO[] getKor24ManifestSmryCondVOs(){
		Kor24ManifestSmryCondVO[] vos = (Kor24ManifestSmryCondVO[])models.toArray(new Kor24ManifestSmryCondVO[models.size()]);
		return vos;
	}
