...
*@FileName : EsmMas0146ViewAdapter.java
*@FileTitle : EsmMas0146ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0146 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmMas0146ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0146ViewAdapter(){
    	super();
    }
