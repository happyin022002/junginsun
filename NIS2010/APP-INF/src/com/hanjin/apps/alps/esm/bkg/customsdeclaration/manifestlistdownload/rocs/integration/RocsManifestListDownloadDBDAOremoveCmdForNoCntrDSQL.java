...
*@FileName : RocsManifestListDownloadDBDAOremoveCmdForNoCntrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestListDownloadDBDAOremoveCmdForNoCntrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestListDownloadDBDAOremoveCmdForNoCntrDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("AND CNTR_NO not in (" ).append("\n"); 
		...
		query.append("FileName : RocsManifestListDownloadDBDAOremoveCmdForNoCntrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}