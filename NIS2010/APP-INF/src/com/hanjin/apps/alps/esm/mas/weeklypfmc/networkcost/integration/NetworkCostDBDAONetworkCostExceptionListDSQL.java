...
*@FileName : NetworkCostDBDAONetworkCostExceptionListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAONetworkCostExceptionListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Network Cost Exception List 를 저장한다.(Delete)
	  * </pre>
	  */
	public NetworkCostDBDAONetworkCostExceptionListDSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAONetworkCostExceptionListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
