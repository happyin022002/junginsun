...
=========================================================
* History
* 2011.06.27 이행지 [CHM-201111837] Split 20-R4J Rule Upgrade 관련 소스품질 향상을 위한 조치 건 : catch절에 throw가 없을 경우 log.error 사용권고
=========================================================*/
package com.hanjin.apps.alps.esm.pri.common;
...
/**
 * NIS2010-PRIUtil Common Utility - 공통 로직을 처리한다.
 *
 * @author Minseok Song
 * @see 
 * @since J2EE 1.6
...
public class PRIUtil {
    ...
    private static transient org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(PRIUtil.class);
