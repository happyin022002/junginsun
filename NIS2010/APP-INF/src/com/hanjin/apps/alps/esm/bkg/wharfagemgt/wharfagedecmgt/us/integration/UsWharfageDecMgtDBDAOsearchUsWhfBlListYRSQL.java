...
*@FileName : UsWharfageDecMgtDBDAOsearchUsWhfBlListYRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOsearchUsWhfBlListYRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOsearchUsWhfBlListYRSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOsearchUsWhfBlListYRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",DECODE(DECODE(@[bound], 'I', A.DE_TERM_CD, A.RCV_TERM_CD), 'D', 'Door', 'Y', 'CY', '') AS TERM" ).append("\n"); 
		query.append(",B.USA_WHF_TP_CD" ).append("\n"); 
		...
		query.append(",BKG_USA_WHF_BL B" ).append("\n"); 
		...
		query.append("AND  B.BKG_IO_BND_CD = C.BKG_IO_BND_CD" ).append("\n"); 
		...
		query.append("AND  B.BKG_IO_BND_CD = 'I'" ).append("\n"); 
		query.append("AND  A.POD_CD = @[port]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("AND  B.BKG_IO_BND_CD = 'O'" ).append("\n"); 
		query.append("AND  A.POL_CD = @[port]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY C.BL_NO, C.CNTR_NO" ).append("\n"); 
