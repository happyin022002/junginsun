...
*@FileName : SCGroupLocationQuotationDBDAORsltPriSqGrpLocVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationQuotationDBDAORsltPriSqGrpLocVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAORsltPriSqGrpLocVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAORsltPriSqGrpLocVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
