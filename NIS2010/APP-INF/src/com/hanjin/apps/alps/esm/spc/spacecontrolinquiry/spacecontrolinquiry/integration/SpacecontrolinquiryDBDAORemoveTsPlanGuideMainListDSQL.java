...
*@FileName : SpacecontrolinquiryDBDAORemoveTsPlanGuideMainListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAORemoveTsPlanGuideMainListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [T/S Plan & guide Main]을 [삭제]합니다
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAORemoveTsPlanGuideMainListDSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAORemoveTsPlanGuideMainListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SPC_TS_PLN_GID_MN" ).append("\n"); 
