...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.coa.weeklypfmc.weeklycm 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_COA_0029HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {// Retrieve
			...
			event.setMultiCoaMonVvdVOs((MultiCoaMonVvdVO[])getVOs(request, MultiCoaMonVvdVO.class));
		}				
