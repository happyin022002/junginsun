...
*@FileName : SCRateProposalDBDAORsltPriCostDetailByTransModeListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriCostDetailByTransModeListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriCostDetailByTransModeListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriCostDetailByTransModeListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/** prop_no,amdt_seq,svc_scp_cd,rate_type,cost_tp,rout_pnt,trans_mode */" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("          ,G_RATE_TYPE,S_RATE_TYPE" ).append("\n"); 
		...
		query.append("	      ,DECODE(MIN(A.GEN_SPCL_RT_TP_CD),'G',1,0) G_RATE_TYPE" ).append("\n"); 
		query.append("	      ,DECODE(MAX(A.GEN_SPCL_RT_TP_CD),'S',1,0) S_RATE_TYPE" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	  FROM PRI_SP_SCP_RT_USD_ROUT_CS A" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	#if (${rate_type} != 'B')   -- B:BOTH, G, S" ).append("\n"); 
		query.append("		AND A.GEN_SPCL_RT_TP_CD = @[rate_type]" ).append("\n"); 
