...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtVOUSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_RT_CMDT SET" ).append("\n"); 
