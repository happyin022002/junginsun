...
*@FileName : KorManifestListDBDAOsearchCustTypeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchCustTypeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchCustTypeRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchCustTypeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
