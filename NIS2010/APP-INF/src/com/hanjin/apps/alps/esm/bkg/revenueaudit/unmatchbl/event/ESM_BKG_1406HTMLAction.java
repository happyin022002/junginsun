...
*@FileName : ESM_BKG_1406HTMLAction.java
...
public class ESM_BKG_1406HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1406HTMLAction 객체를 생성
	 */
	public ESM_BKG_1406HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1406Event event = new EsmBkg1406Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setIhcBKGListForAuditVO((IhcBKGListForAuditVO)getVO(request, IhcBKGListForAuditVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI01)) {
			event.setIhcBKGListForAuditVOS((IhcBKGListForAuditVO[])getVOs(request, IhcBKGListForAuditVO.class, ""));
		}
