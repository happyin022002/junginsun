...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplTitleVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplTitleVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Boiler Plate Header Title Select
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplTitleVORSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplTitleVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT BLPL_NM" ).append("\n"); 
