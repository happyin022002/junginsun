...
*@FileName : ScqBreakbulkDBDAOsearchEmailTargetUserListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqBreakbulkDBDAOsearchEmailTargetUserListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqBreakbulkDBDAOsearchEmailTargetUserListRSQL(){
		setQuery();
		...
		query.append("FileName : ScqBreakbulkDBDAOsearchEmailTargetUserListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT USR_EML AS TO_USER FROM COM_USER" ).append("\n"); 
		...
		query.append("WHERE SREP_CD = (SELECT RQST_SREP_CD FROM PRI_SCQ_BB_MN" ).append("\n"); 
		query.append("                 WHERE 1=1" ).append("\n"); 
		query.append("                 AND SCQ_RQST_NO = @[scq_rqst_no] " ).append("\n"); 
