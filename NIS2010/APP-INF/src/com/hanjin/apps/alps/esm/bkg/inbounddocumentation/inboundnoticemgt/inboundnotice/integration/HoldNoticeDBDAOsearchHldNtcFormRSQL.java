...
*@FileName : HoldNoticeDBDAOsearchHldNtcFormRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HoldNoticeDBDAOsearchHldNtcFormRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public HoldNoticeDBDAOsearchHldNtcFormRSQL(){
		setQuery();
		...
		query.append("FileName : HoldNoticeDBDAOsearchHldNtcFormRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
