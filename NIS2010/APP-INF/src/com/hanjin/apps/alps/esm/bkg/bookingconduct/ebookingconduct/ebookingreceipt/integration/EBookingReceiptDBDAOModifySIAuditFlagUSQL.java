...
*@FileName : EBookingReceiptDBDAOModifySIAuditFlagUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOModifySIAuditFlagUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOModifySIAuditFlagUSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOModifySIAuditFlagUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET    SI_AUD_FLG = @[si_aud_flg]" ).append("\n"); 
