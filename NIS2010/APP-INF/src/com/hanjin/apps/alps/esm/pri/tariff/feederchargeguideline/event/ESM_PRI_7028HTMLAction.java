 ...
 *@FileName : ESM_PRI_7028HTMLAction.java
 ...
 * @see EsmPri7028Event 참조
 * @since J2EE 1.6
 */
public class ESM_PRI_7028HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_7028HTMLAction 객체를 생성
	 */
	public ESM_PRI_7028HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7028Event event = new EsmPri7028Event();
		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setfDRDGSurchargeVO((FDRDGSurchargeVO)getVO(request, FDRDGSurchargeVO .class));
		}
		return event;
	}
