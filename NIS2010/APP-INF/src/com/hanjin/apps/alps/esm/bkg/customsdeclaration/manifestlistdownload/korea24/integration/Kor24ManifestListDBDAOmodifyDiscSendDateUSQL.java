...
*@FileName : Kor24ManifestListDBDAOmodifyDiscSendDateUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyDiscSendDateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyDiscSendDateUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyDiscSendDateUSQL").append("\n");
		query.append("*/").append("\n");
	}
