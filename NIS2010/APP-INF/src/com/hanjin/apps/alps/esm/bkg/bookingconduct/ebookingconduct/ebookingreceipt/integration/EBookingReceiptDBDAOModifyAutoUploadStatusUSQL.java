...
*@FileName : EBookingReceiptDBDAOModifyAutoUploadStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOModifyAutoUploadStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOModifyAutoUploadStatusUSQL(){
		setQuery();
		...
		params.put("pctl_expt_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : EBookingReceiptDBDAOModifyAutoUploadStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        , PCTL_EXPT_FLG = @[pctl_expt_flg]" ).append("\n"); 
