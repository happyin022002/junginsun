...
*@FileName : BRKGAuditDBDAOSearchBRKGInfoListForPrintRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BRKGAuditDBDAOSearchBRKGInfoListForPrintRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BRKGAuditDBDAOSearchBRKGInfoListForPrintRSQL(){
		setQuery();
		...
		query.append("FileName : BRKGAuditDBDAOSearchBRKGInfoListForPrintRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SUM(A.ACT_IF_COMM_AMT) AMOUNT," ).append("\n"); 
