...
import com.hanjin.syscommon.common.table.MasMnlCostStupVO;
...
public class CostSetUpDBDAO extends DBDAOSupport {
	 ...
	 * [처리대상] 정보를 [행위] 합니다.<br>
	 * 
	 * @param List<MasMnlCostStupVO> masMnlCostStupVOs
	 ...
	 * @throws Exception
	 */
	public int[] multiOtherCostSetup(List<MasMnlCostStupVO> masMnlCostStupVOs,SignOnUserAccount account,String cost_yrwk) throws DAOException,Exception {
		int updCnt[] = null;
		Map<String, Object> velParam = new HashMap<String, Object>();
		try {
			...
			if(masMnlCostStupVOs .size() > 0){
				updCnt = sqlExe.executeBatch((ISQLTemplate)new CostSetUpDBDAOModifyOtherCostSetupUSQL(), masMnlCostStupVOs,velParam);
	 ...
	 * @throws Exception
	 */
	public int[] multiMTAbcCostSetup(List<MasMnlCostStupVO> masMnlCostStupVOs,SignOnUserAccount account,String cost_yrmon) throws DAOException,Exception {
		int updCnt[] = null;
		Map<String, Object> velParam = new HashMap<String, Object>();
		try {
			SQLExecuter sqlExe = new SQLExecuter("");
			...
			if(masMnlCostStupVOs .size() > 0){
				updCnt = sqlExe.executeBatch((ISQLTemplate)new CostSetUpDBDAOModifyMTAbcCostSetupUSQL(), masMnlCostStupVOs,velParam);
				for(int i = 0; i < updCnt.length; i++){
					if(updCnt[i]== Statement.EXECUTE_FAILED)
						throw new DAOException("Fail to insert No"+ i + " SQL");
				}
	...
	public List<MtyRepoTESTRSCostVO> searchMtyRepoCostDtl(SearchConditionVO searchConditionVO) throws DAOException {
	 ...
	 /**
		 ...
		 */
		 @SuppressWarnings("unchecked")
		public List<MtyRepoTESTRSCostVO> searchInterfaceData(SearchConditionVO searchConditionVO) throws DAOException {
			DBRowSet dbRowset = null;
			List<MtyRepoTESTRSCostVO> list = null;
			//query parameter
			Map<String, Object> param = new HashMap<String, Object>();
			...
			try{
				...
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CostSetUpDBDAOSearchInterfaceDataRSQL(), param, velParam);
				list = (List)RowSetUtil.rowSetToVOs(dbRowset, MtyRepoTESTRSCostVO .class);
			} catch(SQLException se) {
				log.error(se.getMessage(),se);
				throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 */
	 @SuppressWarnings({ "unchecked", "rawtypes" })
	public List<GeneralExpenseVO> searchGeneralExpenseAsList(GeneralExpenseVO generalExpenseVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<GeneralExpenseVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CostSetUpDBDAOGeneralExpenseAsRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, GeneralExpenseVO .class);
	 	} catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage(), se);
	 ...
	 * [일반관리비] 를 [일괄수정] 합니다.<br>
	 * 
	 * @param MasMnlCostStupVO masMnlCostStupVO
	 * @exception DAOException
	 */
	public void modifyGeneralExpenseAll(MasMnlCostStupVO masMnlCostStupVO) throws DAOException {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		int result = 0;
		try{
			if(masMnlCostStupVO != null){
				Map<String, String> mapVO = masMnlCostStupVO .getColumnValues();
