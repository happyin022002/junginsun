...
*@FileName : BSAYearlyPlanDBDAOMultiBsaBudSltChtrCrrCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOMultiBsaBudSltChtrCrrCapaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOMultiBsaBudSltChtrCrrCapaCSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOMultiBsaBudSltChtrCrrCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_BUD_SLT_CHTR_CRR_CAPA A" ).append("\n"); 
