...
*@FileName : ESM_PRI_6047HTMLAction.java
...
public class ESM_PRI_6047HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6047HTMLAction 객체를 생성
	 */
	public ESM_PRI_6047HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6047Event event = new EsmPri6047Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltPriRateCmpbViewAllListVO((RsltPriRateCmpbViewAllListVO)getVO(request, RsltPriRateCmpbViewAllListVO .class));
		}
