...
public class BLDocumentationCMDBDAOSearchConfirmOthBkgRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       CASE WHEN PRE_CNMV_STS_CD IN ('MT','XX') THEN 'Y'" ).append("\n"); 
		query.append("            WHEN PRE_CNMV_STS_CD ='ID' AND NOW_CNMV_STS_CD ='OC' THEN 'Y'   " ).append("\n"); 
		...
		query.append("              ,CNTR.NOW_CNMV_STS_CD AS NOW_CNMV_STS_CD             " ).append("\n"); 
		...
		query.append("                      ,BCNTR.CNMV_STS_CD AS NOW_CNMV_STS_CD" ).append("\n"); 
