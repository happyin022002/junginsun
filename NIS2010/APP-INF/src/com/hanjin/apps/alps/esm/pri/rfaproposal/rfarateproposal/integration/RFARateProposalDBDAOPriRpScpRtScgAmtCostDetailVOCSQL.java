...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgAmtCostDetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgAmtCostDetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgAmtCostDetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgAmtCostDetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("" ).append("\n"); 
		query.append("MERGE INTO PRI_RP_SCP_RT_SCG A" ).append("\n"); 
		...
		query.append("          FROM (SELECT MN.PROP_NO, MN.AMDT_SEQ, MN.SVC_SCP_CD, MN.CMDT_HDR_SEQ, MN.ROUT_SEQ, RT.RT_SEQ, " ).append("\n"); 
		query.append("                       NVL(SCG_ADJ.BKG_RAT_UT_CD, RT.RAT_UT_CD) AS BKG_RAT_UT_CD, NVL(SCG_ADJ.PRC_CGO_TP_CD, RT.PRC_CGO_TP_CD) PRC_CGO_TP_CD, SCG_ADJ.CHG_CD, SCG_ADJ.CURR_CD,  " ).append("\n"); 
		...
		query.append("                  FROM PRI_RP_SCP_RT_CMDT_ROUT MN," ).append("\n"); 
		query.append("                       PRI_RP_SCP_RT_ROUT_PNT ORG," ).append("\n"); 
		query.append("                       PRI_RP_SCP_RT_ROUT_PNT DST," ).append("\n"); 
		query.append("                       (SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ROUT_VIA_PORT_DEF_CD " ).append("\n"); 
		query.append("                          FROM PRI_RP_SCP_RT_ROUT_VIA " ).append("\n"); 
		query.append("                         WHERE PROP_NO = @[prop_no] AND AMDT_SEQ = @[amdt_seq] AND SVC_SCP_CD = @[svc_scp_cd] AND ORG_DEST_TP_CD = 'O') OVIA," ).append("\n"); 
		query.append("                       (SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ROUT_VIA_PORT_DEF_CD " ).append("\n"); 
		query.append("                          FROM PRI_RP_SCP_RT_ROUT_VIA " ).append("\n"); 
		query.append("                         WHERE PROP_NO = @[prop_no] AND AMDT_SEQ = @[amdt_seq] AND SVC_SCP_CD = @[svc_scp_cd] AND ORG_DEST_TP_CD = 'D' ) DVIA," ).append("\n"); 
		query.append("                       PRI_RP_SCP_RT_CMDT CMDT," ).append("\n"); 
		query.append("                       PRI_RP_SCP_RT RT," ).append("\n"); 
		query.append("                       PRI_RP_SCP_SCG_ADJ SCG_ADJ," ).append("\n"); 
		...
		query.append("		   AND EXISTS ( SELECT 'O' FROM PRI_RP_SCP_RT_SCG SCG" ).append("\n"); 
		...
		query.append("INSERT ( A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ, A.RT_SEQ, " ).append("\n"); 
		...
		query.append("VALUES ( B.PROP_NO, B.AMDT_SEQ, B.SVC_SCP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.RT_SEQ,     	" ).append("\n"); 
