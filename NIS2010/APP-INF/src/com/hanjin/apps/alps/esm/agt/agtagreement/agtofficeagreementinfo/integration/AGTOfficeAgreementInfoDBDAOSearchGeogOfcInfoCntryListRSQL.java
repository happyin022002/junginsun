...
*@FileName : AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoCntryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoCntryListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchGeogOfcInfoCntryList
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoCntryListRSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOSearchGeogOfcInfoCntryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#else" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("CASE B.CNT_CD" ).append("\n"); 
		query.append("WHEN A.ROUT_INFO_CD" ).append("\n"); 
		query.append("THEN '1'" ).append("\n"); 
		query.append("ELSE '0'" ).append("\n"); 
		query.append("END                               AS CHECKBOX," ).append("\n"); 
		query.append("B.CNT_CD                      AS CNT_CD," ).append("\n"); 
		query.append("B.CNT_NM                      AS CNT_NM" ).append("\n"); 
		...
		query.append("WHERE B.CNT_CD                      = A.ROUT_INFO_CD" ).append("\n"); 
