...
*@FileName : OPMasterDBDAOMultiHistoryLaneSeeIfUpdateOrInsertRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistoryLaneSeeIfUpdateOrInsertRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistoryLaneSeeIfUpdateOrInsertRSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistoryLaneSeeIfUpdateOrInsertRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM MAS_LANE_TP_HIS B" ).append("\n"); 
		query.append(", ( SELECT TRD_CD, RLANE_CD, DIR_CD, LANE_APLY_FM_DT" ).append("\n"); 
