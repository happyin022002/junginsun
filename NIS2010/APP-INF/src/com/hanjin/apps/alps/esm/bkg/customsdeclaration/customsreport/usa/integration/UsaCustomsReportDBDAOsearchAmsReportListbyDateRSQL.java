...
public class UsaCustomsReportDBDAOsearchAmsReportListbyDateRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SELECT TB.*   , '' AS SEQ, REPLACE(REPLACE(REPLACE(CUST.CUST_NM, CHR(13)||CHR(10),' '), CHR(13), ' '), CHR(10), ' ') AS CUST_NM" ).append("\n"); 
		query.append("       ,CASE CSTMS_CLR_TP_CD WHEN 'L' THEN 'Local' WHEN 'I' THEN 'P/MIB' END CSTMS_CLR_TP_NM" ).append("\n"); 
		query.append("       ,CASE WHEN (DEL_SCC = POD_SCC OR CHECKFLAG ='EQUALS') THEN 'Local cargo' WHEN DEL_SCC != POD_SCC THEN 'IPI' ELSE '' END CGO_DEST_TYPE_NM" ).append("\n"); 
		query.append("  FROM ( " ).append("\n"); 
		query.append("        SELECT PBL.CNT_CD" ).append("\n"); 
		...
		query.append("              ,BR.RFA_NO" ).append("\n"); 
		query.append("              ,BR.TAA_NO" ).append("\n"); 
		query.append("              ,NVL(NVL(NVL(BR.RFA_NO,BR.SC_NO),BR.TAA_NO),' ') CONTRAT_NO" ).append("\n"); 
		...
		query.append("              ,CASE WHEN DECODE(PBL.MF_NO, NULL, PBL.CSTMS_FILE_TP_CD, '0') = 2  AND" ).append("\n"); 
		query.append("                ( (PBL.POD_CD LIKE 'US%' AND A.DEL_CD NOT LIKE 'US%') OR IBD.CSTMS_CLR_TP_CD IN ('V','F')) THEN 'X' ELSE 'Y' END Non3ZSearchYn" ).append("\n"); 
		query.append("              ,IBD.CSTMS_CLR_TP_CD " ).append("\n"); 
		query.append("              ,LO.SCC_CD DEL_SCC" ).append("\n"); 
		query.append("              ,LO2.SCC_CD POD_SCC" ).append("\n"); 
		query.append("              ,CASE WHEN (LO.SCC_CD = 'USLAX' AND LO2.SCC_CD = 'USLGB') OR (LO.SCC_CD = 'USLGB' AND LO2.SCC_CD = 'USLAX') THEN 'EQUALS' ELSE 'N' END CHECKFLAG" ).append("\n"); 
		query.append("              ,( " ).append("\n"); 
		query.append("                SELECT TO_CHAR(VPS_ETD_DT, 'yyyy-mm-dd hh24:mi') AS VPS_ETD_DT " ).append("\n"); 
		query.append("                FROM VSK_VSL_PORT_SKD SKD1" ).append("\n"); 
		query.append("                WHERE A.VSL_CD         = SKD1.VSL_CD" ).append("\n"); 
		query.append("                  AND A.SKD_VOY_NO     = SKD1.SKD_VOY_NO" ).append("\n"); 
		query.append("                  AND A.SKD_DIR_CD     = SKD1.SKD_DIR_CD" ).append("\n"); 
		query.append("                  AND A.CSTMS_POL_CD   = SKD1.VPS_PORT_CD" ).append("\n"); 
		query.append("                  AND SKD1.CLPT_IND_SEQ = 1" ).append("\n"); 
		query.append("                ) T_POL_ETD" ).append("\n"); 
		query.append("              ,( " ).append("\n"); 
		query.append("                SELECT TO_CHAR(VPS_ETA_DT, 'yyyy-mm-dd hh24:mi') AS VPS_ETA_DT " ).append("\n"); 
		query.append("                FROM VSK_VSL_PORT_SKD SKD2" ).append("\n"); 
		query.append("                WHERE A.VSL_CD         = SKD2.VSL_CD" ).append("\n"); 
		query.append("                  AND A.SKD_VOY_NO     = SKD2.SKD_VOY_NO" ).append("\n"); 
		query.append("                  AND A.SKD_DIR_CD     = SKD2.SKD_DIR_CD" ).append("\n"); 
		query.append("                  AND A.CSTMS_POD_CD   = SKD2.VPS_PORT_CD" ).append("\n"); 
		query.append("                  AND SKD2.CLPT_IND_SEQ = 1" ).append("\n"); 
		query.append("                ) T_POD_ETA" ).append("\n"); 
		...
		query.append("		  AND CR.ENTR_NO LIKE 'V5N%'" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("           AND A.DEL_CD  = LO.LOC_CD" ).append("\n"); 
		query.append("           AND A.POD_CD  = LO2.LOC_CD           " ).append("\n"); 
		...
		query.append("                                   )" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		query.append("                AND ( CASE WHEN A.CSTMS_FILE_TP_CD = 2  AND ( (A.CSTMS_POD_CD LIKE 'US%' AND A.DEL_CD NOT LIKE 'US%') OR IBD.CSTMS_CLR_TP_CD IN ('V','F')) THEN 'X' ELSE 'Y' END) = 'Y'" ).append("\n"); 
		...
		query.append("                                   )" ).append("\n"); 
		query.append("                     )" ).append("\n"); 
		query.append("            #elseif (${tmp3} == '2O4O')" ).append("\n"); 
		query.append("                AND (" ).append("\n"); 
		query.append("                     CR.CSTMS_SEQ IN (SELECT MAX( CSTMS_SEQ )" ).append("\n"); 
		query.append("                                      FROM BKG_CSTMS_ADV_RSLT" ).append("\n"); 
		query.append("                                     WHERE BL_NO = PBL.BL_NO" ).append("\n"); 
		query.append("                                       AND CNT_CD = PBL.CNT_CD" ).append("\n"); 
		query.append("                                       AND DSPO_CD IN ('2O','4O')" ).append("\n"); 
		query.append("                                  GROUP BY DSPO_CD" ).append("\n"); 
		query.append("                                   )" ).append("\n"); 
		query.append("                     )" ).append("\n"); 
		...
		query.append("                  )" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("        #if (${excl_rls} != '')" ).append("\n"); 
		...
		query.append("                #elseif (${pmib_tp} == 'I')" ).append("\n"); 
		query.append("                    AND IBD.CSTMS_CLR_TP_CD = 'I'" ).append("\n"); 
		query.append("                #elseif (${pmib_tp} == 'L')" ).append("\n"); 
		query.append("                    AND IBD.CSTMS_CLR_TP_CD = 'L'" ).append("\n"); 
		query.append("                #elseif (${pmib_tp} == 'LC')" ).append("\n"); 
		query.append("                    AND (LO.SCC_CD = LO2.SCC_CD OR (LO.SCC_CD = 'USLAX' AND LO2.SCC_CD = 'USLGB') OR (LO.SCC_CD = 'USLGB' AND LO2.SCC_CD = 'USLAX'))" ).append("\n"); 
		query.append("                #elseif (${pmib_tp} == 'IP')" ).append("\n"); 
		query.append("                    AND (LO.SCC_CD != LO2.SCC_CD AND (LO.SCC_CD != 'USLAX' OR LO2.SCC_CD != 'USLGB') AND (LO.SCC_CD != 'USLGB' OR LO2.SCC_CD != 'USLAX'))" ).append("\n"); 
		query.append("                #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("    #if (${tmp3} == '3Z')" ).append("\n"); 
		query.append("      AND TB.Non3ZSearchYn = 'Y'" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("WITH T_VIEW AS(" ).append("\n"); 
		query.append("SELECT    TB.*, '' AS SEQ, REPLACE(REPLACE(REPLACE(CUST.CUST_NM, CHR(13)||CHR(10),' '), CHR(13), ' '), CHR(10), ' ') AS CUST_NM" ).append("\n"); 
		query.append("          ,CASE CSTMS_CLR_TP_CD WHEN 'L' THEN 'Local' WHEN 'I' THEN 'P/MIB' END CSTMS_CLR_TP_NM" ).append("\n"); 
		query.append("          ,CASE WHEN (DEL_SCC = POD_SCC OR CHECKFLAG ='EQUALS') THEN 'Local cargo' WHEN DEL_SCC != POD_SCC THEN 'IPI' ELSE '' END CGO_DEST_TYPE_NM" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		...
		query.append("		#if (${customs_result_code_grp} == 'WP')" ).append("\n"); 
		query.append("		   AND C.ENTR_NO LIKE 'V5N%'" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("           AND A.DEL_CD  = LO.LOC_CD" ).append("\n"); 
		...
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        #if (${contract_type} != '')" ).append("\n"); 
		query.append("		  #if (${contract_type} == 'SC')" ).append("\n"); 
		query.append("	  		AND BR.SC_NO IS NOT NULL" ).append("\n"); 
		query.append("          #elseif (${contract_type} == 'RFA')" ).append("\n"); 
		query.append("	  		AND BR.RFA_NO IS NOT NULL" ).append("\n"); 
		query.append("          #elseif (${contract_type} == 'TAA')" ).append("\n"); 
		query.append("	  		AND BR.TAA_NO IS NOT NULL" ).append("\n"); 
		query.append("          #end" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("  	    #if (${err_type} != '')" ).append("\n"); 
		query.append("  	      #if (${err_type} == 'U') /*Un-Sent*/" ).append("\n"); 
		query.append("           AND (CASE WHEN A.MF_SND_DT IS NULL THEN 1 ELSE 0 END) = 1" ).append("\n"); 
		query.append("  	      #end" ).append("\n"); 
		query.append("	    #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("       ) TB" ).append("\n"); 
		query.append("      ,BKG_CSTMS_ADV_CUST CUST" ).append("\n"); 
		query.append("  	  #if (${err_type} != '')" ).append("\n"); 
		query.append("  	     #if (${err_type} == 'N') /*Not-Received*/" ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		query.append("            SELECT *" ).append("\n"); 
		query.append("            FROM (" ).append("\n"); 
		query.append("                SELECT C.BL_NO" ).append("\n"); 
		query.append("                        ,MAX(CASE WHEN  A.TRSM_MSG_TP_ID IN ('MI','AI') THEN A.CRR_BAT_NO ELSE ' ' END ) S_CRR_BAT_NO" ).append("\n"); 
		query.append("                        ,MAX(CASE WHEN  B.RCV_MSG_TP_ID IN ('MR','AR') THEN B.CRR_BAT_NO ELSE ' ' END ) R_CRR_BAT_NO " ).append("\n"); 
		query.append("                FROM BKG_CSTMS_ADV_SND_LOG A, BKG_CSTMS_ADV_RCV_LOG B,BKG_CSTMS_ADV_EDI_BL_RSPN C" ).append("\n"); 
		query.append("                WHERE 1=1" ).append("\n"); 
		query.append("                #if (${mbl_no} != '' )" ).append("\n"); 
		query.append("                        AND C.BL_NO = @[mbl_no]" ).append("\n"); 
		query.append("                #else" ).append("\n"); 
		query.append("                    #if (${ams_file_no} != '')" ).append("\n"); 
		query.append("                        AND C.BL_NO = @[ams_file_no]" ).append("\n"); 
		query.append("                    #else" ).append("\n"); 
		query.append("                        #if (${vvd} != '')" ).append("\n"); 
		query.append("                            AND A.VSL_CD = SUBSTR(@[vvd],1,4)" ).append("\n"); 
		query.append("                            AND A.SKD_VOY_NO = SUBSTR(@[vvd], 5, 4)" ).append("\n"); 
		...
		query.append("                AND C.CRR_BAT_NO = A.CRR_BAT_NO" ).append("\n"); 
		...
		query.append("            WHERE (CASE WHEN S_CRR_BAT_NO != R_CRR_BAT_NO THEN 1 ELSE 0 END) = 1" ).append("\n"); 
		...
		query.append("  	#if (${err_type} != '')" ).append("\n"); 
		query.append("  	   #if (${err_type} == 'N') /*Not-Received*/" ).append("\n"); 
		query.append("          AND TB.AMS_FILE_NO = X.BL_NO" ).append("\n"); 
		query.append("  	   #end" ).append("\n"); 
		query.append("	 #end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("  	#if (${search_discrepancy} == 'Y')" ).append("\n"); 
		query.append("        , NVL((" ).append("\n"); 
		query.append("            SELECT SUM(RS.CNTR_QTY) CNTR_QTY" ).append("\n"); 
		query.append("            FROM BKG_CSTMS_ADV_RSLT  RS" ).append("\n"); 
		query.append("                ,BKG_CSTMS_ADV_RCV_LOG RM" ).append("\n"); 
		query.append("            WHERE RS.CNT_CD = RM.CNT_CD" ).append("\n"); 
		...
		query.append("            AND RS.DSPO_CD = '69'" ).append("\n"); 
		query.append("            AND BL.POD_CD LIKE 'US%'" ).append("\n"); 
		query.append("            AND BL.FILER = 1" ).append("\n"); 
		query.append("            AND RS.BL_NO = BL.MBL_NO" ).append("\n"); 
		query.append("            AND RS.CNT_CD = BL.CNT_CD" ).append("\n"); 
		query.append("            AND RM.SCAC_CD = 'SMLM'" ).append("\n"); 
		query.append("            GROUP BY RS.BL_NO" ).append("\n"); 
		query.append("        ),0) HJSC_QTY," ).append("\n"); 
		query.append("        NVL((" ).append("\n"); 
		query.append("            SELECT SUM(RS.CNTR_QTY) CNTR_QTY" ).append("\n"); 
		query.append("            FROM BKG_CSTMS_ADV_RSLT  RS" ).append("\n"); 
		query.append("                ,BKG_CSTMS_ADV_RCV_LOG RM" ).append("\n"); 
		...
		query.append("            AND RM.SCAC_CD != 'SMLM'" ).append("\n"); 
		query.append("            GROUP BY RS.BL_NO" ).append("\n"); 
		query.append("        ),0) NON_HJSC_QTY" ).append("\n"); 
		query.append("  	#else" ).append("\n"); 
		query.append("      , 0 HJSC_QTY , 0 NON_HJSC_QTY" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("    FROM T_VIEW BL" ).append("\n"); 
		query.append(") X  " ).append("\n"); 
		query.append("#if (${search_discrepancy} == 'Y')" ).append("\n"); 
		query.append("WHERE HJSC_QTY != NON_HJSC_QTY AND NON_HJSC_QTY > 0 AND HJSC_QTY > 0 --불일치" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#end" ).append("\n"); 
