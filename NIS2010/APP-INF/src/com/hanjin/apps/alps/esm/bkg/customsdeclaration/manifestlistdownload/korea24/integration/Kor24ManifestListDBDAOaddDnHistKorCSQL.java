...
*@FileName : Kor24ManifestListDBDAOaddDnHistKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOaddDnHistKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOaddDnHistKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOaddDnHistKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
