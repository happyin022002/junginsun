/*=========================================================
 *Copyright(c) SMLines
 *@FileName : ESM_BKG_N007HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_N007HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_N007HTMLAction 객체를 생성
	 */
	public ESM_BKG_N007HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkgN007Event event = new EsmBkgN007Event();
