...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCBoilerPlateProposalDB PriSpBlplAmdVO
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_SP_BLPL BLPL" ).append("\n"); 
		...
		query.append("WHERE" ).append("\n"); 
		query.append("PROP_NO 	= BLPL.PROP_NO" ).append("\n"); 
		query.append("AND AMDT_SEQ     = BLPL.AMDT_SEQ" ).append("\n"); 
		query.append("AND BLPL_SEQ    = BLPL.BLPL_SEQ" ).append("\n"); 
		query.append("AND SRC_INFO_CD <> 'AD'" ).append("\n"); 
		query.append(")" ).append("\n"); 
