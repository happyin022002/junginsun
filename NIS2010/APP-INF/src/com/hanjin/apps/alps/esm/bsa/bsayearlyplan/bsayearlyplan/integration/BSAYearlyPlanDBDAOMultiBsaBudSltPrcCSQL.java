...
*@FileName : BSAYearlyPlanDBDAOMultiBsaBudSltPrcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOMultiBsaBudSltPrcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Hsitory--------------------------------------------------
	  * 2011.07.20 이행지 [CHM-201112101-01] curr_cd 컬럼 추가에 따른 쿼리수정
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOMultiBsaBudSltPrcCSQL(){
		setQuery();
		...
		params.put("hjs_bfr_sub_capa",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : BSAYearlyPlanDBDAOMultiBsaBudSltPrcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_BUD_SLT_PRC A" ).append("\n"); 
		...
		query.append("               @[hjs_bfr_sub_capa]  AS HJS_BFR_SUB_CAPA," ).append("\n"); 
		...
		query.append("             HJS_BFR_SUB_CAPA  = B.HJS_BFR_SUB_CAPA," ).append("\n"); 
		...
		query.append("             CURR_CD           = B.CURR_CD" ).append("\n"); 
		...
		query.append("              B.BSA_SLT_COST_TP_CD, " ).append("\n"); 
		...
		query.append("              B.HJS_BFR_SUB_CAPA, " ).append("\n"); 
