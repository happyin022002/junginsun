...
public class XptImpLicVO extends AbstractValueObject {
	...
	/* Column Info */
	private String vinCtnt = null;
	/* Column Info */
	private String vehCmdtFlg = null;
	/* Column Info */
	private String idaShpBilNo = null;
	/* Column Info */
	private String idaShpBilIssDt = null;
	/* Column Info */
	private String ngExsEnsNo = null;
	/* Column Info */
	private String tgEctnNo = null;
	...
	public XptImpLicVO(String ibflag, String pagerows, String bkgNo, String ioBndCd, String xptImpSeq, String cntCd, String xptLicNo, String tsRefNo, String pckQty, String pckTpCd, String mfWgt, String wgtUtCd, String divdFlg, String divdSeq, String divdPckQty, String divdPckTpCd, String divdWgt, String divdWgtUtCd, String samPckId, String samPckQty, String samPckTpCd, String ucrNo, String ausMfRefNo, String aesTpCd, String aesInlndTrnsPfxCtnt, String aesInlndTrnsNo, String aesPtaPfxCtnt, String aesPtaNo1, String aesPtaNo2, String aesPtaDt, String aesPtuPfxCtnt, String aesPtuNo, String aesPtuDt, String aesDwnPfxCtnt, String aesDwnNo, String aesDwnDt, String aesExptId, String aesExptCtnt, String shprTaxNo, String shprTaxCpyDescFlg, String cneeTaxNo, String cneeTaxCpyDescFlg, String ntfyTaxNo, String ntfyTaxCpyDescFlg, String brzDeclNo, String brzDeclCpyDescFlg, String brzCmdtCd, String idDeclCd, String idXptNo, String idXptNoIssDt, String idOfcCd, String idaIecNo, String idaIecCpyDescFlg, String caedTpCd, String caedPfxCtnt, String caedNo1, String caedNo2, String caedNo3, String g7EdiPfxCtnt, String g7EdiNo1, String g7EdiNo2, String b13aXptPfxCtnt, String b13aXptDt, String b13aXptNo1, String b13aXptNo2, String mfSmryRptPfxCtnt, String mfSmryRptNo, String cgoCtrlPfxCtnt, String cgoCtrlNo, String ndrRefPfxCtnt, String ndrRefId, String ndrRefCtnt, String creUsrId, String creDt, String updUsrId, String updDt,String seq, String mxShprTaxId, String mxCneeTaxId, String mxNtfyTaxId, String trShprTaxId, String trCneeTaxId, String trNtfyTaxId, String ilShprTaxId, String ilCneeTaxId, String ilNtfyTaxId, String lbShprTaxId, String lbCneeTaxId, String lbNtfyTaxId, String entrClssTpCd, String entrClssRmk, String porCd, String aesTpPrnFlg, String vehCmdtFlg, String vinCtnt, String idaShpBilNo, String idaShpBilIssDt, String ngExsEnsNo, String tgEctnNo, String cntrNo  ) {
		...
		this.vinCtnt = vinCtnt;
		this.vehCmdtFlg = vehCmdtFlg;
		this.idaShpBilNo = idaShpBilNo;
		this.idaShpBilIssDt = idaShpBilIssDt;
		this.ngExsEnsNo = ngExsEnsNo;
		this.tgEctnNo = tgEctnNo;
		this.cntrNo = cntrNo;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vin_ctnt", getVinCtnt());
		this.hashColumns.put("veh_cmdt_flg", getVehCmdtFlg());
		this.hashColumns.put("ida_shp_bil_no", getIdaShpBilNo());
		this.hashColumns.put("ida_shp_bil_iss_dt", getIdaShpBilIssDt());
		this.hashColumns.put("ng_exs_ens_no", getNgExsEnsNo());
		this.hashColumns.put("tg_ectn_no", getTgEctnNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("vin_ctnt", "vinCtnt");
		this.hashFields.put("veh_cmdt_flg", "vehCmdtFlg");
		this.hashFields.put("ida_shp_bil_no", "idaShpBilNo");
		this.hashFields.put("ida_shp_bil_iss_dt", "idaShpBilIssDt");
		this.hashFields.put("ng_exs_ens_no", "ngExsEnsNo");
		this.hashFields.put("tg_ectn_no", "tgEctnNo");
	 ...
	 * @return idaShpBilNo
	 */
	public String getIdaShpBilNo() {
		return this.idaShpBilNo;
	}
	
	/**
	 * Column Info
	 * @return idaShpBilIssDt
	 */
	public String getIdaShpBilIssDt() {
		return this.idaShpBilIssDt;
	}
	 ...
	 * @return lbNtfyTaxId
	 */
	public String getNgExsEnsNo() {
		return this.ngExsEnsNo;
	}
	 ...
	 * @param tgEctnNo
	 */
	public void setTgEctnNo(String tgEctnNo) {
		this.tgEctnNo = tgEctnNo;
	}
	 ...
	 * @param idaShpBilNo
	 */
	public void setIdaShpBilNo(String idaShpBilNo) {
		this.idaShpBilNo = idaShpBilNo;
	}
	/**
	 * Column Info
	 * @param idaShpBilIssDt
	 */
	public void setIdaShpBilIssDt(String idaShpBilIssDt) {
		this.idaShpBilIssDt = idaShpBilIssDt;
	}
	 ...
	 * @param ngExsEnsNo
	 */
	public void setNgExsEnsNo(String ngExsEnsNo) {
		this.ngExsEnsNo = ngExsEnsNo;
	}
	...
	/**
	 * @param vinCtnt the vinCtnt to set
	 */
	public void setVinCtnt(String vinCtnt) {
		this.vinCtnt = vinCtnt;
	}
	
	/**
	 * @param vehCmdtFlg the vehCmdtFlg to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setVinCtnt(JSPUtil.getParameter(request, "vin_ctnt", ""));
		setVehCmdtFlg(JSPUtil.getParameter(request, "veh_cmdt_flg", ""));
		setIdaShpBilNo(JSPUtil.getParameter(request, "ida_shp_bil_no", ""));
		setIdaShpBilIssDt(JSPUtil.getParameter(request, "ida_shp_bil_iss_dt", ""));
		setNgExsEnsNo(JSPUtil.getParameter(request, "ng_exs_ens_no", ""));
		setTgEctnNo(JSPUtil.getParameter(request, "tg_ectn_no", ""));
	...
	public XptImpLicVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] vinCtnt = (JSPUtil.getParameter(request, prefix	+ "vin_ctnt", length));
			String[] vehCmdtFlg = (JSPUtil.getParameter(request, prefix	+ "veh_cmdt_flg", length));
			String[] idaShpBilNo = (JSPUtil.getParameter(request, prefix	+ "ida_shp_bil_no", length));
			String[] idaShpBilIssDt = (JSPUtil.getParameter(request, prefix	+ "ida_shp_bil_iss_dt", length));
			String[] ngExsEnsNo = (JSPUtil.getParameter(request, prefix	+ "ng_exs_ens_no", length));
			String[] tgEctnNo = (JSPUtil.getParameter(request, prefix	+ "tg_ectn_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (vinCtnt[i] != null)
					model.setVinCtnt(vinCtnt[i]);
				if (vehCmdtFlg[i] != null)
					model.setVehCmdtFlg(vehCmdtFlg[i]);
				if (idaShpBilNo[i] != null)
					model.setIdaShpBilNo(idaShpBilNo[i]);
				if (idaShpBilIssDt[i] != null)
					model.setIdaShpBilIssDt(idaShpBilIssDt[i]);
				if (ngExsEnsNo[i] != null)
					model.setNgExsEnsNo(ngExsEnsNo[i]);
				if (tgEctnNo[i] != null)
					model.setTgEctnNo(tgEctnNo[i]);
				if (cntrNo[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.vinCtnt = this.vinCtnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.vehCmdtFlg = this.vehCmdtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.idaShpBilNo = this.idaShpBilNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.idaShpBilIssDt = this.idaShpBilIssDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ngExsEnsNo = this.ngExsEnsNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.tgEctnNo = this.tgEctnNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
