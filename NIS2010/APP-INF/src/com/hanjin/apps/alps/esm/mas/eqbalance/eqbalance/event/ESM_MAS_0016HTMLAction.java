...
*@FileName : ESM_MAS_0016HTMLAction.java
...
public class ESM_MAS_0016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0016HTMLAction 객체를 생성
	 */
	public ESM_MAS_0016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0016Event event = new EsmMas0016Event();
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setMasCntrRepoRuleVOS((MasCntrRepoRuleVO[])getVOs(request, MasCntrRepoRuleVO .class,""));
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
		}		
		else if(command.isCommand(FormCommand.MULTI03)) {
			event.setMasCntrRepoShtgInfoVOS((MasCntrRepoShtgInfoVO[])getVOs(request, MasCntrRepoShtgInfoVO .class,""));
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
