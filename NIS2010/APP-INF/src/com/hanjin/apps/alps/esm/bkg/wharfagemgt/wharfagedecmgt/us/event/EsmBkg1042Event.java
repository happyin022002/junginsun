...
/**
 * ESM_BKG_1042 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_BKG_1042HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * 
 * @author Kim Min Jeong
 * @see ESM_BKG_1042HTMLAction 참조
 * @since J2EE 1.4
 */
public class EsmBkg1042Event extends EventSupport {
