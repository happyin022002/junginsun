...
*@FileName : ESM_MAS_0330HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Jong-Ock KIM
 * @see EsmMas0330Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0330HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0330HTMLAction 객체를 생성
	 */
	public ESM_MAS_0330HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0330Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0330Event event = new EsmMas0330Event();  		
    	...
    	if(command.isCommand(FormCommand.INIT)) {
			...
			event.setAverageUCVesselVOs((AverageUCVesselVO[])getVOs(request, AverageUCVesselVO.class));
		} else if(command.isCommand(FormCommand.SEARCH10)) {
			event.setAverageUCVesselVO((AverageUCVesselVO)getVO(request, AverageUCVesselVO.class));
    	}
