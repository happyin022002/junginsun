...
*@FileName : CODCorrectionDBDAOmodifyCodRsoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CODCorrectionDBDAOmodifyCodRsoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * bkg_no, cod_rqst_seq에 맞는 bkg_cod에 rgn_code를 update한다.
	  * </pre>
	  */
	public CODCorrectionDBDAOmodifyCodRsoUSQL(){
		setQuery();
		...
		query.append("FileName : CODCorrectionDBDAOmodifyCodRsoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
