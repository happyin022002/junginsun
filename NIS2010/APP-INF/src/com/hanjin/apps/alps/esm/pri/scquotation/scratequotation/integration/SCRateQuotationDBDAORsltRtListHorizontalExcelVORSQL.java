...
*@FileName : SCRateQuotationDBDAORsltRtListHorizontalExcelVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltRtListHorizontalExcelVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltRtListHorizontalExcelVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltRtListHorizontalExcelVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND T.QTTN_VER_NO = @[qttn_ver_no]" ).append("\n"); 
		query.append("AND T.GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd]" ).append("\n"); 
		query.append("GROUP BY T.QTTN_NO, T.QTTN_VER_NO, T.GEN_SPCL_RT_TP_CD, T.CMDT_HDR_SEQ, T.ROUT_SEQ) F" ).append("\n"); 
		...
		query.append("AND (NVL(A.ROUT_DP_SEQ,'') = '' OR" ).append("\n"); 
		query.append("COALESCE(F.RATE_DRY20, F.RATE_DRY40, F.RATE_DRY40HC, F.RATE_DRY45, F.RATE_RD40HC, F.RATE_RF40HC) IS NOT NULL)" ).append("\n"); 
