...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtRoutPntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtRoutPntCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_RT_ROUT_PNT Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtRoutPntCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtRoutPntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , S.LOC_GRD_CNT_CD" ).append("\n"); 
		query.append("     , S.LOC_GRD_CD" ).append("\n"); 
		...
		query.append("    ,PRI_SP_SCP_RT_ROUT_PNT S" ).append("\n"); 
