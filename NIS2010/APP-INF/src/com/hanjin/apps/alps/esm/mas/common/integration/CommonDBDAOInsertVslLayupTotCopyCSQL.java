...
public class CommonDBDAOInsertVslLayupTotCopyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MAS_MNL_COST_STUP 테이블에 total값 입력
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("    (SELECT COST_YR||EQ_WK FROM MAS_WK_PRD WHERE COST_YR = SUBSTR(REPLACE(@[f_tar_week],'-',''),1,4) AND COST_WK = SUBSTR(REPLACE(@[f_tar_week],'-',''),5,2))" ).append("\n"); 
