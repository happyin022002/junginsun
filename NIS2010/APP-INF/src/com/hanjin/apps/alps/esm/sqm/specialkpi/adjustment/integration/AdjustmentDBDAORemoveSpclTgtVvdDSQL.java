...
*@FileName : AdjustmentDBDAORemoveSpclTgtVvdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AdjustmentDBDAORemoveSpclTgtVvdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [SKD Adjustment by VVD]에서 확정데이터를 [삭제] 합니다
	  * </pre>
	  */
	public AdjustmentDBDAORemoveSpclTgtVvdDSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentDBDAORemoveSpclTgtVvdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE SQM_SPCL_TGT_VVD" ).append("\n"); 
