 ...
 *@FileName : ESM_PRI_2068HTMLAction.java
...
public class ESM_PRI_2068HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2068HTMLAction 객체를 생성
	 */
	public ESM_PRI_2068HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2068Event event = new EsmPri2068Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setRsltRtListHorizontalLoadExcelForAeeAewVOs((RsltRtListHorizontalLoadExcelForAeeAewVO[]) getVOs(request, RsltRtListHorizontalLoadExcelForAeeAewVO.class, ""));
