...
*@FileName : ESM_SPC_0109HTMLAction.java
...
public class ESM_SPC_0109HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0102HTMLAction 객체를 생성
	 */
	public ESM_SPC_0109HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0109Event event = new EsmSpc0109Event();
		SpcCtrtFcastCustVO spcCtrtFcastCustVO = new SpcCtrtFcastCustVO();
		

		if(command.isCommand(FormCommand.MULTI01)) {
			event.setSpcCtrtFcastCustVOS(spcCtrtFcastCustVO.fromRequestGrid(request, ""));
