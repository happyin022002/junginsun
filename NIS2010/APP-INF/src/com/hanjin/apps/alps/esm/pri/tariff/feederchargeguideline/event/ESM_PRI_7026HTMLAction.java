...
*@FileName : ESM_PRI_7026HTMLAction.java
...
public class ESM_PRI_7026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_7026HTMLAction 객체를 생성
	 */
	public ESM_PRI_7026HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7026Event event = new EsmPri7026Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) { 
			event.setSearchFDRAmendmentHistoryMainVO((SearchFDRAmendmentHistoryMainVO)getVO(request, SearchFDRAmendmentHistoryMainVO .class));
		} else 	if(command.isCommand(FormCommand.SEARCH02)) { 
			event.setSearchFDRAmendmentHistoryDetailVO((SearchFDRAmendmentHistoryDetailVO)getVO(request, SearchFDRAmendmentHistoryDetailVO .class));
		} 
		return  event;
	}
