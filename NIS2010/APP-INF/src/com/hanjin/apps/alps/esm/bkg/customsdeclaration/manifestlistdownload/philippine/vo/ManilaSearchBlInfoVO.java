...
public class ManilaSearchBlInfoVO extends AbstractValueObject {
	...
	public ManilaSearchBlInfoVO(String ibflag, String pagerows, String regNumber2, String pod, String year, String blNo, String cargoType, String etlCargoType, String shipperName, String shipperAddress1, String shipperAddress2, String shipperAddress3, String shipperAddress4, String consigneeName, String consigneeAddress1, String consigneeAddress2, String consigneeAddress3, String consigneeAddress4, String notifyName, String notifyAddress1, String notifyAddress2, String notifyAddress3, String notifyAddress4, String weight, String volume, String countryOrigin, String totalCntr, String seq) {
		this.weight = weight;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setShipperAddress3(JSPUtil.getParameter(request, "shipper_address3", ""));
		setShipperAddress4(JSPUtil.getParameter(request, "shipper_address4", ""));
		setBlNo(JSPUtil.getParameter(request, "bl_no", ""));
		setEtlCargoType(JSPUtil.getParameter(request, "etl_cargo_type", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setNotifyName(JSPUtil.getParameter(request, "notify_name", ""));
		setShipperName(JSPUtil.getParameter(request, "shipper_name", ""));
		setNotifyAddress1(JSPUtil.getParameter(request, "notify_address1", ""));
		setCargoType(JSPUtil.getParameter(request, "cargo_type", ""));
		setNotifyAddress2(JSPUtil.getParameter(request, "notify_address2", ""));
		setNotifyAddress3(JSPUtil.getParameter(request, "notify_address3", ""));
		setNotifyAddress4(JSPUtil.getParameter(request, "notify_address4", ""));
		setYear(JSPUtil.getParameter(request, "year", ""));
		setCountryOrigin(JSPUtil.getParameter(request, "country_origin", ""));
		setPod(JSPUtil.getParameter(request, "pod", ""));
		setConsigneeName(JSPUtil.getParameter(request, "consignee_name", ""));
		setShipperAddress2(JSPUtil.getParameter(request, "shipper_address2", ""));
		setShipperAddress1(JSPUtil.getParameter(request, "shipper_address1", ""));
		setRegNumber2(JSPUtil.getParameter(request, "reg_number2", ""));
		setSeq(JSPUtil.getParameter(request, "seq", ""));
		setConsigneeAddress4(JSPUtil.getParameter(request, "consignee_address4", ""));
		setVolume(JSPUtil.getParameter(request, "volume", ""));
		setConsigneeAddress3(JSPUtil.getParameter(request, "consignee_address3", ""));
		setConsigneeAddress2(JSPUtil.getParameter(request, "consignee_address2", ""));
		setConsigneeAddress1(JSPUtil.getParameter(request, "consignee_address1", ""));
