...
*@FileName : CargoReleaseOrderDBDAOsearchEdiFullCntrRlseOrderHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchEdiFullCntrRlseOrderHeaderRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 구주 Full Container Release Order EDI 전송 Header 정보 조회
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchEdiFullCntrRlseOrderHeaderRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchEdiFullCntrRlseOrderHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("RPAD(NVL(TRIM('EUR'),' '),3)||" ).append("\n"); 
