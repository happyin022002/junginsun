...
*@FileName : RFARateProposalDBDAOPropCpPriRpScpRtCmdtRoutCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropCpPriRpScpRtCmdtRoutCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPropCpPriRpScpRtCmdtRoutCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropCpPriRpScpRtCmdtRoutCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         , DENSE_RANK() OVER (PARTITION BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD ORDER BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.BLET_DP_SEQ, A.CMDT_HDR_SEQ) AS CMDT_HDR_SEQ" ).append("\n"); 
		...
		query.append("	 , DECODE(@[rfa_ctrt_tp_cd], 'M', ROWNUM, 'B', L.MST_ROUT_ID, '') MST_ROUT_ID" ).append("\n"); 
		...
		query.append("#if (${IS_MASTER_COPY} == 'Y') " ).append("\n"); 
		query.append("-- Master RFA에서 Route 선택하고 Copy 했을 경우" ).append("\n"); 
