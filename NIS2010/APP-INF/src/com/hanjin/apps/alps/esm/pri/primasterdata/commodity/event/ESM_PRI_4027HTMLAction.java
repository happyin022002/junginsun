...
*@FileName : ESM_PRI_4027HTMLAction.java
...
public class ESM_PRI_4027HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_4027HTMLAction 객체를 생성
	 */
	public ESM_PRI_4027HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri4027Event event = new EsmPri4027Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) { //Commodity
			event.setCmdtParaVO((CmdtParaVO)getVO(request, CmdtParaVO .class));
		} else if(command.isCommand(FormCommand.SEARCH02)) { //Group Commodity
			event.setCmdtParaVO((CmdtParaVO)getVO(request, CmdtParaVO .class));
