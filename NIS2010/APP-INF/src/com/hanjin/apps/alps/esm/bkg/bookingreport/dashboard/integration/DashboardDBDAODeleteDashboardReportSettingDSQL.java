...
*@FileName : DashboardDBDAODeleteDashboardReportSettingDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DashboardDBDAODeleteDashboardReportSettingDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Log in user id  +  bkg ofc 의 DBD_IRR_TP_CD 데이터를 삭제한다.
	  * </pre>
	  */
	public DashboardDBDAODeleteDashboardReportSettingDSQL(){
		setQuery();
		...
		query.append("FileName : DashboardDBDAODeleteDashboardReportSettingDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND DBD_IRR_TP_CD=@[dbd_irr_tp_cd]" ).append("\n"); 
