...
*@FileName : ESM_BKG_1425HTMLAction.java
...
public class ESM_BKG_1425HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1425HTMLAction 객체를 생성
	 */
	public ESM_BKG_1425HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1425Event event = new EsmBkg1425Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setUmchErrBlReportVO((UmchErrBlReportVO)getVO(request, UmchErrBlReportVO .class));
		}
