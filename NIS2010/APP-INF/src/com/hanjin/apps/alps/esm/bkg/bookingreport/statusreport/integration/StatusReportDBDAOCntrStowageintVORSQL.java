...
public class StatusReportDBDAOCntrStowageintVORSQL implements ISQLTemplate{
	...
	public StatusReportDBDAOCntrStowageintVORSQL(){
		...
		params.put("lodg_dchg_ind_cd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("              NVL(BAY.CNTR_REF_NO,'') CNTR_NO				--Container No                                                 " ).append("\n"); 
		...
		query.append("		  		AND (VSL_CD, SKD_VOY_NO, SKD_DIR_CD,LODG_VSL_CD,LODG_VOY_NO,LODG_DIR_CD) IN (                          " ).append("\n"); 
		query.append("          		                                                                                                               " ).append("\n"); 
		query.append("                         SELECT SKD.VSL_CD,SKD.SKD_VOY_NO,SKD.SKD_DIR_CD,SKD.VSL_CD,SKD.SKD_VOY_NO,SKD.SKD_DIR_CD                      " ).append("\n"); 
		...
		query.append("                ,     B.BKG_CGO_TP_CD  CGO_TP                                                                                          " ).append("\n"); 
		...
		query.append("-------------------------------------------------------------------------------------                                                  " ).append("\n"); 
		query.append("	SELECT /*+ use_hash(bay st) INDEX(bay)*/ /* @@ 힌트적용  2014.11.24 튜닝 */" ).append("\n"); 
		query.append("#if (${bound_type} == 'I')   " ).append("\n"); 
		query.append("						/*+ INDEX(bay XAK5OPF_BAY_PLN_LDIS) */  /* 2014.11.24 튜닝 힌트 추가*/                                                                              " ).append("\n"); 
		query.append("#end	" ).append("\n"); 
		...
		query.append("#end                                                                                                                                   " ).append("\n"); 
		query.append("#if (${stwg_status} != 'C')                                                                                                            " ).append("\n"); 
		query.append("				AND LODG_DCHG_IND_CD  IN ('L','D')                                                                     " ).append("\n"); 
		query.append("#else                                                                                                                                  " ).append("\n"); 
		query.append("				AND LODG_DCHG_IND_CD = 'C'                                                                             " ).append("\n"); 
		query.append("#end                                                                                                                                   " ).append("\n"); 
		query.append("				AND CRR_CD ='SML'                                                                                      " ).append("\n"); 
		...
		query.append("		 AND   DECODE(NVL(CGO_TP,'M'),'M',NVL(LODG_DCHG_IND_CD,''),NVL(CGO_TP,'')) = @[cgo_tp]                                 " ).append("\n"); 
		query.append("#end                                                                                                                                   " ).append("\n"); 
		query.append("                                                                                                                                       " ).append("\n"); 
		query.append("                                                                                                                                       " ).append("\n"); 
		query.append("#end                                                                                                                                   " ).append("\n"); 
		...
		query.append(",   Y.COD_RQST_RSN_CD" ).append("\n"); 
		query.append(",  (SELECT INTG_CD_VAL_DESC" ).append("\n"); 
		query.append("      FROM COM_INTG_CD_DTL" ).append("\n"); 
		query.append("     WHERE INTG_CD_ID = 'CD02153'" ).append("\n"); 
		query.append("       AND INTG_CD_VAL_CTNT = Y.COD_RQST_RSN_CD" ).append("\n"); 
		query.append("    ) AS COD_RQST_RSN_NM" ).append("\n"); 
		query.append(",	X.BK_POL" ).append("\n"); 
		query.append(",	X.BK_POD" ).append("\n"); 
		...
		query.append("FROM   TEMP_T X , BKG_COD Y" ).append("\n"); 
