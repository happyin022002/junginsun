...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtHdrCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtHdrCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpRtCmdtHdrCopyToProposal
	  * * 2015.04.06 송호진 [CHM-201534007] Fixed index 개발
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtHdrCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtHdrCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY A.QTTN_NO, A.QTTN_VER_NO, A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("                          ORDER BY A.QTTN_NO, A.QTTN_VER_NO, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ) AS BLET_DP_SEQ" ).append("\n"); 
