...
*@FileName : ESM_BKG_1426HTMLAction.java
...
public class ESM_BKG_1426HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1426HTMLAction 객체를 생성
	 */
	public ESM_BKG_1426HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1426Event event = new EsmBkg1426Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMultiRateBkgListVO((MultiRateBkgListVO)getVO(request, MultiRateBkgListVO .class));
		}
