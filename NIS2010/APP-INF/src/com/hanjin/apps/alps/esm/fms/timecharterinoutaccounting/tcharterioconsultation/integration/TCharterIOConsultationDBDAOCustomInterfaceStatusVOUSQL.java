...
*@FileName : TCharterIOConsultationDBDAOCustomInterfaceStatusVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOCustomInterfaceStatusVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 자발적, 비자발적 오류 처리할 전표에 대한 취소 작업을 진행한다
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOCustomInterfaceStatusVOUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOCustomInterfaceStatusVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
