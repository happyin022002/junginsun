...
public class AlpsQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AlpsQtyVO> models = new ArrayList<AlpsQtyVO>();
	 ...
	 * @return AlpsQtyVO[]
	 */
	public AlpsQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AlpsQtyVO[]
	 */
	public AlpsQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AlpsQtyVO model = null;
	 ...
	 * @return AlpsQtyVO[]
	 */
	public AlpsQtyVO[] getAlpsQtyVOs(){
		AlpsQtyVO[] vos = (AlpsQtyVO[])models.toArray(new AlpsQtyVO[models.size()]);
		return vos;
	}
