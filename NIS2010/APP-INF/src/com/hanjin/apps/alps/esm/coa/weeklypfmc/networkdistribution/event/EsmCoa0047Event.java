...
*@FileName : EsmCoa0047Event.java
*@FileTitle : EsmCoa0047Event
*Open Issues :
*Change history :
...
/**
 * ESM_COA_0047 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_COA_0047HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Ki Dae
 * @see ESM_COA_0047HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmCoa0047Event extends EventSupport {
	...
	/** Constructor */
	public EsmCoa0047Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmCoa0047Event";
	}
