...
*@FileName : BkgChkPntItemTpVO.java
*@FileTitle : BkgChkPntItemTpVO
*Open Issues :
*Change history :
...
public class BkgChkPntItemTpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgChkPntItemTpVO> models = new ArrayList<BkgChkPntItemTpVO>();
	...
	public BkgChkPntItemTpVO() {}

	public BkgChkPntItemTpVO(String ibflag, String pagerows, String chkPntTpCd, String chkPntItmSeq, String chkPntItmTpSeq, String chkPntItmTpNm, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public BkgChkPntItemTpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgChkPntItemTpVO[]
	 */
	public BkgChkPntItemTpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgChkPntItemTpVO model = null;
	...
	public BkgChkPntItemTpVO[] getBkgChkPntItemTpVOs(){
		BkgChkPntItemTpVO[] vos = (BkgChkPntItemTpVO[])models.toArray(new BkgChkPntItemTpVO[models.size()]);
		return vos;
	}
