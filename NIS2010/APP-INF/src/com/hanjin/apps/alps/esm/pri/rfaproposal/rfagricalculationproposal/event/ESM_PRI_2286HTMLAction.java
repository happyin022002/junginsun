 ...
 *@FileName : ESM_PRI_2286HTMLAction.java
...
public class ESM_PRI_2286HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2286HTMLAction 객체를 생성
	 */
	public ESM_PRI_2286HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2286Event event = new EsmPri2286Event();
