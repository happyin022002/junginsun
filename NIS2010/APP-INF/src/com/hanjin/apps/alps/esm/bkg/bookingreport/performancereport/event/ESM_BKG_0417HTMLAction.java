...
*@FileName : ESM_BKG_0417HTMLAction.java
...
public class ESM_BKG_0417HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0417HTMLAction 객체를 생성
	 */
	public ESM_BKG_0417HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0417Event event = new EsmBkg0417Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01) 
					|| command.isCommand(FormCommand.SEARCH02) || command.isCommand(FormCommand.SEARCHLIST)) {
			event.setPortCLSReportVO((PortCLSReportVO)getVO(request, PortCLSReportVO .class));
		}
