...
public class EsmFms0085Event extends EventSupport {
	...
	public CustomEmailAddressVO[] getCustomEmailAddressVOS(){
		CustomEmailAddressVO[] rtnVOs = null;
		if (this.customEmailAddressVOs != null) {
			rtnVOs = new CustomEmailAddressVO[customEmailAddressVOs.length];
			System.arraycopy(customEmailAddressVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
}