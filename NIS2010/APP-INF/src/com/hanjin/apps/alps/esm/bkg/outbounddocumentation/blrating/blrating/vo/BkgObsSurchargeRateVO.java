...
*@FileName : BkgObsSurchargeRateVO.java
*@FileTitle : BkgObsSurchargeRateVO
*Open Issues :
*Change history :
...
public class BkgObsSurchargeRateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgObsSurchargeRateVO> models = new ArrayList<BkgObsSurchargeRateVO>();
	...
	public BkgObsSurchargeRateVO() {}

	public BkgObsSurchargeRateVO(String ibflag, String pagerows, String bkgNo, String ratUtCd, String cltOfcCd, String chgCd, String currCd, String scgAmt, String cgoCateCd, String creUsrId, String loginOfc, String ppdOfc, String payTermCd, String updUsrId, String frtInclXcldDivCd) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
		this.chgCd = chgCd;
...
/**
	 ...
	 */
	public BkgObsSurchargeRateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgObsSurchargeRateVO[]
	 */
	public BkgObsSurchargeRateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgObsSurchargeRateVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgObsSurchargeRateVO();
				if (bkgNo[i] != null)
		...
		return getBkgObsSurchargeRateVOs();
	}
	 ...
	 * @return BkgObsSurchargeRateVO[]
	 */
	public BkgObsSurchargeRateVO[] getBkgObsSurchargeRateVOs(){
		BkgObsSurchargeRateVO[] vos = (BkgObsSurchargeRateVO[])models.toArray(new BkgObsSurchargeRateVO[models.size()]);
		return vos;
	}
