...
*@FileName : SCRateQuotationDBDAORsltPriSurchargeAdjustCommodityVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriSurchargeAdjustCommodityVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriSurchargeAdjustCommodityVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriSurchargeAdjustCommodityVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_sq_rt_cmdt rt_cmdt" ).append("\n"); 
		...
		query.append(", pri_sq_grp_cmdt grp_cmdt" ).append("\n"); 
