...
*@FileName : RsltPriPrsBatCalculateVO.java
*@FileTitle : RsltPriPrsBatCalculateVO
*Open Issues :
*Change history :
...
public class RsltPriPrsBatCalculateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriPrsBatCalculateVO> models = new ArrayList<RsltPriPrsBatCalculateVO>();
	...
	public RsltPriPrsBatCalculateVO() {}

	public RsltPriPrsBatCalculateVO(String ibflag, String pagerows, String paraInfoCtnt, String prsBatId) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return RsltPriPrsBatCalculateVO[]
	 */
	public RsltPriPrsBatCalculateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriPrsBatCalculateVO[]
	 */
	public RsltPriPrsBatCalculateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriPrsBatCalculateVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriPrsBatCalculateVO();
				if (ibflag[i] != null)
		...
		return getRsltPriPrsBatCalculateVOs();
	}
	 ...
	 * @return RsltPriPrsBatCalculateVO[]
	 */
	public RsltPriPrsBatCalculateVO[] getRsltPriPrsBatCalculateVOs(){
		RsltPriPrsBatCalculateVO[] vos = (RsltPriPrsBatCalculateVO[])models.toArray(new RsltPriPrsBatCalculateVO[models.size()]);
		return vos;
	}
