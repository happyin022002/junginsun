...
*@FileName : SCRateProposalDBDAORsltPrsSurchargeDetailApplicableRouteRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPrsSurchargeDetailApplicableRouteRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPrsSurchargeDetailApplicableRouteRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPrsSurchargeDetailApplicableRouteRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select 	pri_rout.prop_no, pri_rout.amdt_seq, pri_rout.svc_scp_cd, pri_rout.gen_spcl_rt_tp_cd," ).append("\n"); 
		...
		query.append("from pri_sp_scp_rt_scg_rout pri_rout" ).append("\n"); 
