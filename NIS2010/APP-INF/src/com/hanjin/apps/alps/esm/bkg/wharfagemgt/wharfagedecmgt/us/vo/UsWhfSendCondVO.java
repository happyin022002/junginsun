...
*@FileName : UsWhfSendCondVO.java
*@FileTitle : UsWhfSendCondVO
*Open Issues :
*Change history :
...
public class UsWhfSendCondVO extends WhfSendCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsWhfSendCondVO> models = new ArrayList<UsWhfSendCondVO>();
	...
	public UsWhfSendCondVO() {}

	public UsWhfSendCondVO(String ibflag, String pagerows, String blNo, String bkgNo, String cntrNo, String fm, String cstmsDesc, String usaWhfExptFlg, String delCd, String term, String usaWhfTpCd, String ft20, String ft40, String ft45, String whfFlg, String port, String vvd, String bound, String typeRail, String creUsrId) {
		this.port = port;
	 ...
	 */
	public UsWhfSendCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsWhfSendCondVO[]
	 */
	public UsWhfSendCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsWhfSendCondVO model = null;
	 ...
	 * @return UsWhfSendCondVO[]
	 */
	public UsWhfSendCondVO[] getUsWhfSendCondVOs(){
		UsWhfSendCondVO[] vos = (UsWhfSendCondVO[])models.toArray(new UsWhfSendCondVO[models.size()]);
		return vos;
	}
