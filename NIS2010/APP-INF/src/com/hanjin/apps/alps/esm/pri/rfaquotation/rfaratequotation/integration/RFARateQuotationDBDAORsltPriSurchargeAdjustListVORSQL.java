...
*@FileName : RFARateQuotationDBDAORsltPriSurchargeAdjustListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriSurchargeAdjustListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriSurchargeAdjustListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriSurchargeAdjustListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_rq_scg_adj" ).append("\n"); 
