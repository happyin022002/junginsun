...
*@FileName : IHCGuideLineDBDAOCheckUsIHCTariffTotalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOCheckUsIHCTariffTotalRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Check US IHC Tariff Total value is 0
	  * </pre>
	  */
	public IHCGuideLineDBDAOCheckUsIHCTariffTotalRSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOCheckUsIHCTariffTotalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND (RT.GLINE_20FT_FRT_RT_AMT = 0 OR RT.GLINE_40FT_FRT_RT_AMT = 0)" ).append("\n"); 
