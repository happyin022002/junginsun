...
*                  - Including non-validated code 조건 추가 ( nonValFlg )
...
public class ArrNtcCustCodeErrSearchVO extends AbstractValueObject {
	...
	/* Column Info */
	private String etaDtS = null;
	/* Column Info */
	private String etaDtE = null;
	/* Column Info */
	private String custTpCd = null;
	/* Column Info */
	private String valCd = null;
	/* Column Info */
	private String nonValFlg = null;
	...
	public ArrNtcCustCodeErrSearchVO(String ibflag, String pagerows, String bkgCreDtS, String bkgCreDtE, String ofcCd, String valCd, String docUsrId, String custTpCd, String valDtS, String valDtE, String etaDtS, String etaDtE, String custCd, String valUsrId, String blNo, String mtchFlg, String errFlg, String obEvCd, String ibEvCd, String hqEvCd, String excelFlg, String pageNo, String nonValFlg, String gsoCd, String rhqCd, String ofcTpCd) {
		this.ofcCd = ofcCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("eta_dt_s", getEtaDtS());
		this.hashColumns.put("eta_dt_e", getEtaDtE());
		this.hashColumns.put("cust_tp_cd", getCustTpCd());
		this.hashColumns.put("val_cd", getValCd());
		this.hashColumns.put("non_val_flg", getNonValFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("eta_dt_s", "etaDtS");
		this.hashFields.put("eta_dt_e", "etaDtE");
		this.hashFields.put("cust_tp_cd", "custTpCd");
		this.hashFields.put("val_cd", "valCd");
		this.hashFields.put("non_val_flg", "nonValFlg");
	 ...
	 * @return nonValFlg
	 */
	public String getNonValFlg() {
		return this.nonValFlg;
	}
	 ...
	 * @param etaDtS
	 */
	public void setEtaDtS(String etaDtS) {
		this.etaDtS = etaDtS;
	}
	 ...
	 * @param etaDtE
	 */
	public void setEtaDtE(String etaDtE) {
		this.etaDtE = etaDtE;
	}
	 ...
	 * @param nonValFlg
	 */
	public void setNonValFlg(String nonValFlg) {
		this.nonValFlg = nonValFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setEtaDtS(JSPUtil.getParameter(request, prefix + "eta_dt_s", ""));
		setEtaDtE(JSPUtil.getParameter(request, prefix + "eta_dt_e", ""));
		setCustTpCd(JSPUtil.getParameter(request, prefix + "cust_tp_cd", ""));
		setValCd(JSPUtil.getParameter(request, prefix + "val_cd", ""));
		setNonValFlg(JSPUtil.getParameter(request, prefix + "non_val_flg", ""));
	...
	public ArrNtcCustCodeErrSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] etaDtS = (JSPUtil.getParameter(request, prefix	+ "eta_dt_s", length));
			String[] etaDtE = (JSPUtil.getParameter(request, prefix	+ "eta_dt_e", length));
			...
			String[] nonValFlg = (JSPUtil.getParameter(request, prefix	+ "non_val_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (etaDtS[i] != null)
					model.setEtaDtS(etaDtS[i]);
				if (etaDtE[i] != null)
					model.setEtaDtE(etaDtE[i]);
				if (custTpCd[i] != null)
					model.setCustTpCd(custTpCd[i]);
				if (valCd[i] != null)
					model.setValCd(valCd[i]);
				if (nonValFlg[i] != null)
					model.setNonValFlg(nonValFlg[i]);
				if (gsoCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.etaDtS = this.etaDtS .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.etaDtE = this.etaDtE .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.nonValFlg = this.nonValFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
