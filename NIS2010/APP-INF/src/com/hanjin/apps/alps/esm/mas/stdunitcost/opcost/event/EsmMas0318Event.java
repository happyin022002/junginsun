...
/**
 * ESM_MAS_0318 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0318HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Jong-Ock KIM
 * @see ESM_MAS_0318HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmMas0318Event extends EventSupport {
	...
	private StndUseQtyVO[] stndUseQtyVOs = null;
	
	public EsmMas0318Event(){}
	...
	public StndUseQtyVO[] getStndUseQtyVOs() {
		return stndUseQtyVOs;
	}

	public void setStndUseQtyVOs(
			StndUseQtyVO[] stndUseQtyVOs) {
		this.stndUseQtyVOs = stndUseQtyVOs;
	}
}