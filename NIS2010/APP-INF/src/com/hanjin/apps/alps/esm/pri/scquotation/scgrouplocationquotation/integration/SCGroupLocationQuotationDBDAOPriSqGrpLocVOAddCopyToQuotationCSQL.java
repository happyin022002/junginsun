...
*@FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddCopyToQuotationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddCopyToQuotationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddCopyToQuotationCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddCopyToQuotationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SQ_GRP_LOC (" ).append("\n"); 
