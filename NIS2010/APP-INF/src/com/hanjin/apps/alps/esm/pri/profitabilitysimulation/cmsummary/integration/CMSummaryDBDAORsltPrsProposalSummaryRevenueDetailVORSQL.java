...
*@FileName : CMSummaryDBDAORsltPrsProposalSummaryRevenueDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMSummaryDBDAORsltPrsProposalSummaryRevenueDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMSummaryDBDAORsltPrsProposalSummaryRevenueDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : CMSummaryDBDAORsltPrsProposalSummaryRevenueDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	SELECT	  /*+ MATERIALIZE LEADING(DUR)  */ " ).append("\n"); 
		...
		query.append("		AND SCP_MN.AMDT_SEQ = 0" ).append("\n"); 
		...
		query.append("		, IFC_SCG_AMT" ).append("\n"); 
		query.append("		, PSC_SCG_AMT" ).append("\n"); 
		query.append("		, OTHERS_SCG_AMT" ).append("\n"); 
		...
		query.append("			, SUM(BUC_SCG_AMT * PRS_ESTM_LOD_QTY_FOR_RATE) AS BUC_SCG_AMT" ).append("\n"); 
		query.append("			, SUM(IFC_SCG_AMT * PRS_ESTM_LOD_QTY_FOR_RATE) AS IFC_SCG_AMT" ).append("\n"); 
		query.append("			, SUM(PSC_SCG_AMT * PRS_ESTM_LOD_QTY_FOR_RATE) AS PSC_SCG_AMT" ).append("\n"); 
		query.append("			, SUM(OTHERS_SCG_AMT *PRS_ESTM_LOD_QTY_FOR_RATE) AS OTHERS_SCG_AMT" ).append("\n"); 
		query.append("			, SUM(PROP_FRT_RT_AMT * PRS_ESTM_LOD_QTY_FOR_RATE) AS OFT_AMT" ).append("\n"); 
		query.append("		FROM (" ).append("\n"); 
		query.append("			SELECT	" ).append("\n"); 
		query.append("				MAX(MN.PROP_OFC_CD ) AS PROP_OFC_CD" ).append("\n"); 
		query.append("				, MAX(MN.PROP_OFC_NM) AS PROP_OFC_NM --  AS PROP_OFC_NM -- REQUEST OFFICE" ).append("\n"); 
		query.append("				, MAX(MN.CUST_CNT_CD) AS CUST_CNT_CD" ).append("\n"); 
		query.append("				, MAX(MN.CUST_SEQ) AS CUST_SEQ" ).append("\n"); 
		query.append("				, MAX(MN.PROP_NO) AS PROP_NO" ).append("\n"); 
		query.append("				, MAX(MN.AMDT_SEQ) AS AMDT_SEQ" ).append("\n"); 
		query.append("				, MAX(MN.CTRT_EFF_DT) AS CTRT_EFF_DT, MAX(MN.CTRT_EXP_DT) AS CTRT_EXP_DT" ).append("\n"); 
		query.append("				, MAX(MN.CTRT_PTY_NM) AS  CTRT_PTY_NM-- CTRT_PTY_NM								-- CUSTOMER NAME" ).append("\n"); 
		query.append("				, MAX(RT.PROP_FRT_RT_AMT) AS PROP_FRT_RT_AMT" ).append("\n"); 
		query.append("				, MAX(RT.PRS_SCG_AMT) AS PRS_SCG_AMT" ).append("\n"); 
		query.append("				, MAX(CMDT_ROUT.PRS_ESTM_LOD_QTY )  AS PRS_ESTM_LOD_QTY -- LOAD(NEW)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				, SUM( " ).append("\n"); 
		query.append("						CASE WHEN SCG.CHG_CD= 'BUC' OR SCG.CHG_CD = 'BAF' OR SCG.CHG_CD = 'FRC' THEN" ).append("\n"); 
		query.append("							SCG.ADJ_SCG_USD_AMT " ).append("\n"); 
		query.append("						ELSE " ).append("\n"); 
		query.append("							0" ).append("\n"); 
		query.append("						END" ).append("\n"); 
		query.append("					) AS BUC_SCG_AMT" ).append("\n"); 
		query.append("				, SUM( " ).append("\n"); 
		query.append("						CASE WHEN SCG.CHG_CD= 'IFC' OR SCG.CHG_CD = 'IRF' OR SCG.CHG_CD = 'IFM' THEN" ).append("\n"); 
		query.append("							SCG.ADJ_SCG_USD_AMT " ).append("\n"); 
		query.append("						ELSE " ).append("\n"); 
		query.append("							0" ).append("\n"); 
		query.append("						END" ).append("\n"); 
		query.append("					) AS IFC_SCG_AMT" ).append("\n"); 
		query.append("				, SUM( " ).append("\n"); 
		query.append("						CASE WHEN SCG.CHG_CD= 'PSC' OR SCG.CHG_CD = 'PSS' THEN" ).append("\n"); 
		query.append("							SCG.ADJ_SCG_USD_AMT " ).append("\n"); 
		query.append("						ELSE " ).append("\n"); 
		query.append("							0" ).append("\n"); 
		query.append("						END" ).append("\n"); 
		query.append("					) AS PSC_SCG_AMT" ).append("\n"); 
		query.append("				, SUM(CASE WHEN SCG.CHG_CD <> 'BUC' AND SCG.CHG_CD <> 'BAF' AND SCG.CHG_CD <> 'FRC' " ).append("\n"); 
		query.append("								AND SCG.CHG_CD <> 'IFC' AND SCG.CHG_CD <> 'IRF' AND SCG.CHG_CD <> 'IFM'" ).append("\n"); 
		query.append("								AND SCG.CHG_CD <> 'PSC' AND SCG.CHG_CD <> 'PSS'" ).append("\n"); 
		query.append("					THEN SCG.ADJ_SCG_USD_AMT" ).append("\n"); 
		query.append("					ELSE" ).append("\n"); 
		query.append("						0" ).append("\n"); 
		query.append("					END)  AS OTHERS_SCG_AMT    --  CM_NEW_OP_TRADE" ).append("\n"); 
		query.append("				, MAX(CASE WHEN SUBSTR(CMDT_ROUT.PRS_RAT_UT_CD,2,1) = '2' OR SUBSTR(CMDT_ROUT.PRS_RAT_UT_CD,1,1) = '2' " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			GROUP BY CMDT_ROUT.PROP_NO " ).append("\n"); 
		...
		query.append("	SELECT  /*+ MATERIALIZE */  'S' AS CTRT_TP_CD, OLD_PROP_NO, OLD_AMDT_SEQ, SVC_SCP_CD, SUBSTR(SC_NO, 17, 37) AS SC_NO ,SUBSTR(SC_NO, 1, 8) AS CTRT_EXP_DT,SUBSTR(SC_NO, 9, 8)" ).append("\n"); 
		query.append("	FROM (" ).append("\n"); 
		...
		query.append("		FROM (SELECT  /*+ ORDERED USE_HASH(NW C M) INDEX_FFS(C XZK99PRI_SP_CTRT_PTY) */      " ).append("\n"); 
		query.append("				M.PROP_NO, MAX(M.AMDT_SEQ) AS AMDT_SEQ" ).append("\n"); 
		...
		query.append("			AND H.SC_NO is not null" ).append("\n"); 
		...
		query.append("		, SUM((SELECT NVL(SCG.SCG_AMT,0 )" ).append("\n"); 
		query.append("		  		FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("		  		WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON              " ).append("\n"); 
		...
		query.append("					AND SCG.CHG_CD = 'OFT' ) * SR_CST_DTL.PRS_CRNT_LOD_QTY) AS OFT_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT NVL(SUM(SCG.SCG_AMT),0)" ).append("\n"); 
		query.append("		  		FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("		  		WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON              " ).append("\n"); 
		query.append("					AND SR_CST_DTL.PRS_WK		  = SCG.PRS_WK            " ).append("\n"); 
		query.append("					AND SR_CST_DTL.PRC_CTRT_TP_CD	  = SCG.PRC_CTRT_TP_CD    " ).append("\n"); 
		...
		query.append("					AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD    " ).append("\n"); 
		query.append("					AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD   " ).append("\n"); 
		query.append("					AND (SCG.CHG_CD = 'BUC' OR SCG.CHG_CD = 'BAF' OR SCG.CHG_CD = 'FRC') ) * SR_CST_DTL.PRS_CRNT_LOD_QTY) AS BUC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT NVL(SUM( SCG.SCG_AMT),0)" ).append("\n"); 
		query.append("		  		FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("		  		WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON              " ).append("\n"); 
		query.append("					AND SR_CST_DTL.PRS_WK		  = SCG.PRS_WK            " ).append("\n"); 
		...
		query.append("					AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD    " ).append("\n"); 
		query.append("					AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD   " ).append("\n"); 
		query.append("					AND (SCG.CHG_CD = 'IFC' OR SCG.CHG_CD = 'IFR' OR SCG.CHG_CD = 'IFM') ) * SR_CST_DTL.PRS_CRNT_LOD_QTY) AS IFC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT NVL(SUM(SCG.SCG_AMT),0)" ).append("\n"); 
		query.append("		  		FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("		  		WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON              " ).append("\n"); 
		query.append("					AND SR_CST_DTL.PRS_WK		  = SCG.PRS_WK            " ).append("\n"); 
		...
		query.append("					AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD    " ).append("\n"); 
		query.append("					AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD   " ).append("\n"); 
		query.append("					AND (SCG.CHG_CD = 'PSC' OR SCG.CHG_CD = 'PSS') ) * SR_CST_DTL.PRS_CRNT_LOD_QTY) AS PSC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT SUM(" ).append("\n"); 
		query.append("							CASE WHEN SCG.CHG_CD <> 'BUC' AND SCG.CHG_CD <> 'BAF' AND SCG.CHG_CD <> 'FRC' " ).append("\n"); 
		query.append("								AND SCG.CHG_CD <> 'IFC' AND SCG.CHG_CD <> 'IRF' AND SCG.CHG_CD <> 'IFM'" ).append("\n"); 
		query.append("								AND SCG.CHG_CD <> 'PSC' AND SCG.CHG_CD <> 'PSS' AND SCG.CHG_CD <> 'OFT'" ).append("\n"); 
		query.append("							THEN SCG.SCG_AMT" ).append("\n"); 
		query.append("							ELSE" ).append("\n"); 
		query.append("								0" ).append("\n"); 
		query.append("							END)" ).append("\n"); 
		query.append("		  FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		...
		query.append("			AND SR_CST_DTL.ORG_LOC_DEF_CD	  = SCG.ORG_LOC_DEF_CD    " ).append("\n"); 
		query.append("			AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD    " ).append("\n"); 
		query.append("			AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD   ) * SR_CST_DTL.PRS_CRNT_LOD_QTY) AS OTHERS_SCG_AMT_PREVIOUS" ).append("\n"); 
		...
		query.append("			, SUM(PROP_FRT_RT_AMT * PRS_ESTM_LOD_QTY_FOR_RATE) AS OFT_AMT" ).append("\n"); 
		query.append("		FROM (" ).append("\n"); 
		query.append("			SELECT	MAX(MN.PROP_OFC_CD ) AS PROP_OFC_CD" ).append("\n"); 
		query.append("				, MAX(MN.PROP_OFC_NM) AS PROP_OFC_NM --  AS PROP_OFC_NM -- REQUEST OFFICE" ).append("\n"); 
		query.append("				, MAX(MN.CUST_CNT_CD) AS CUST_CNT_CD" ).append("\n"); 
		query.append("				, MAX(MN.CUST_SEQ) AS CUST_SEQ" ).append("\n"); 
		query.append("				, MAX(MN.PROP_NO) AS PROP_NO" ).append("\n"); 
		...
		query.append("					0" ).append("\n"); 
		query.append("					END" ).append("\n"); 
		query.append("				)  AS OTHERS_SCG_AMT    --  CM_NEW_OP_TRADE" ).append("\n"); 
		query.append("				, MAX(CASE WHEN SUBSTR(CMDT_ROUT.PRS_RAT_UT_CD,2,1) = '2' OR SUBSTR(CMDT_ROUT.PRS_RAT_UT_CD,1,1) = '2' " ).append("\n"); 
		query.append("						THEN CMDT_ROUT.PRS_ESTM_LOD_QTY  " ).append("\n"); 
		query.append("	       				ELSE	" ).append("\n"); 
		query.append("							 CMDT_ROUT.PRS_ESTM_LOD_QTY    / 2" ).append("\n"); 
		...
		query.append("				AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD" ).append("\n"); 
		query.append("				AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD" ).append("\n"); 
		query.append("				AND SCG.CHG_CD = 'OFT' )  * SR_CST_DTL.PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("		) AS OFT_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT NVL(SUM(SCG.SCG_AMT),0)" ).append("\n"); 
		query.append("			FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("			WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON" ).append("\n"); 
		query.append("				AND SR_CST_DTL.PRS_WK		  = SCG.PRS_WK" ).append("\n"); 
		...
		query.append("				AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD" ).append("\n"); 
		query.append("				AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD" ).append("\n"); 
		query.append("				AND (SCG.CHG_CD = 'BUC' OR SCG.CHG_CD = 'BAF' OR SCG.CHG_CD = 'FRC') )  * SR_CST_DTL.PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("		) AS BUC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT NVL(SUM( SCG.SCG_AMT),0)" ).append("\n"); 
		query.append("			FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("			WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON" ).append("\n"); 
		query.append("				AND SR_CST_DTL.PRS_WK		  = SCG.PRS_WK" ).append("\n"); 
		...
		query.append("				AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD" ).append("\n"); 
		query.append("				AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD" ).append("\n"); 
		query.append("				AND (SCG.CHG_CD = 'IFC' OR SCG.CHG_CD = 'IFR' OR SCG.CHG_CD = 'IFM') )  * SR_CST_DTL.PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("		) AS IFC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT NVL(SUM(SCG.SCG_AMT),0)" ).append("\n"); 
		query.append("			FROM  PRI_PRS_CTRT_SMRY_SCG_DTL SCG" ).append("\n"); 
		query.append("			WHERE  SR_CST_DTL.PRS_YRMON          = SCG.PRS_YRMON" ).append("\n"); 
		query.append("				AND SR_CST_DTL.PRS_WK		  = SCG.PRS_WK" ).append("\n"); 
		...
		query.append("				AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD" ).append("\n"); 
		query.append("				AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD" ).append("\n"); 
		query.append("				AND (SCG.CHG_CD = 'PSC' OR SCG.CHG_CD = 'PSS') )  * SR_CST_DTL.PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("		) AS PSC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("		, SUM((SELECT SUM(" ).append("\n"); 
		query.append("				CASE WHEN SCG.CHG_CD <> 'BUC' AND SCG.CHG_CD <> 'BAF' AND SCG.CHG_CD <> 'FRC'" ).append("\n"); 
		query.append("				AND SCG.CHG_CD <> 'IFC' AND SCG.CHG_CD <> 'IRF' AND SCG.CHG_CD <> 'IFM'" ).append("\n"); 
		query.append("				AND SCG.CHG_CD <> 'PSC' AND SCG.CHG_CD <> 'PSS' AND SCG.CHG_CD <> 'OFT'" ).append("\n"); 
		...
		query.append("				AND SR_CST_DTL.ORG_LOC_DEF_CD	  = SCG.ORG_LOC_DEF_CD" ).append("\n"); 
		query.append("				AND SR_CST_DTL.DEST_LOC_TP_CD	  = SCG.DEST_LOC_TP_CD" ).append("\n"); 
		query.append("				AND SR_CST_DTL.DEST_LOC_DEF_CD	  = SCG.DEST_LOC_DEF_CD   )  * SR_CST_DTL.PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("		) AS OTHERS_SCG_AMT_PREVIOUS" ).append("\n"); 
		...
		query.append("#if (${frm_contract_type} != 'R') " ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("	  N.BUC_SCG_AMT" ).append("\n"); 
		query.append("	, N.IFC_SCG_AMT" ).append("\n"); 
		query.append("	, N.PSC_SCG_AMT" ).append("\n"); 
		query.append("	, N.OTHERS_SCG_AMT" ).append("\n"); 
		query.append("	, N.OFT_AMT" ).append("\n"); 
		query.append("	, P.BUC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("	, P.IFC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("	, P.PSC_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("	, P.OTHERS_SCG_AMT_PREVIOUS" ).append("\n"); 
		query.append("	, P.OFT_AMT_PREVIOUS" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,MN.PROP_OFC_CD" ).append("\n"); 
		...
		query.append("	, P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS  AS G_REV_PREVIOUS					-- Gross Revenue(Previous)" ).append("\n"); 
		query.append("	, DECODE(P.LOAD_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.LOAD_NEW,0,TO_NUMBER(NULL), (N.LOAD_NEW - P.LOAD_PREVIOUS	) /  ABS(P.LOAD_PREVIOUS)  )) * 100  AS LOAD_DIFF -- NEW/PREIOUS * 100 (%)" ).append("\n"); 
		query.append("	, DECODE(P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.G_REV,0,TO_NUMBER(NULL), (N.G_REV - (P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS)	) /  ABS(P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS)  )) * 100  AS G_REV_DIFF -- GROSS REVENUE -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.OFT_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.OFT_AMT,0,TO_NUMBER(NULL), (N.OFT_AMT - P.LOAD_PREVIOUS	) /  ABS(P.OFT_AMT_PREVIOUS)  )) * 100 AS OFT_AMT_DIFF -- OFT -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.BUC_SCG_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.BUC_SCG_AMT,0,TO_NUMBER(NULL), (N.BUC_SCG_AMT - P.BUC_SCG_AMT_PREVIOUS	) /  ABS(P.BUC_SCG_AMT_PREVIOUS)  )) * 100   AS BUC_SCG_AMT_DIFF -- BUF -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.IFC_SCG_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.IFC_SCG_AMT,0,TO_NUMBER(NULL), (N.IFC_SCG_AMT - P.IFC_SCG_AMT_PREVIOUS	) /  ABS(P.IFC_SCG_AMT_PREVIOUS)  )) * 100  AS IFC_SCG_AMT_DIFF -- IFC -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.PSC_SCG_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.PSC_SCG_AMT,0,TO_NUMBER(NULL), (N.PSC_SCG_AMT - P.PSC_SCG_AMT_PREVIOUS	) /  ABS(P.PSC_SCG_AMT_PREVIOUS)  )) * 100  AS PSC_SCG_AMT_DIFF -- PSC -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.OTHERS_SCG_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.OTHERS_SCG_AMT,0,TO_NUMBER(NULL), (N.OTHERS_SCG_AMT - P.OTHERS_SCG_AMT_PREVIOUS	) /  ABS(P.OTHERS_SCG_AMT_PREVIOUS)  )) * 100   AS OTHERS_SCG_AMT_DIFF -- OTHERS -DIFF(%)" ).append("\n"); 
		...
		query.append("	, N.LOAD_NEW						-- LOAD(NEW)" ).append("\n"); 
		query.append("	, P.LOAD_PREVIOUS					-- Load(Previous)" ).append("\n"); 
		query.append("	, P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS  AS G_REV_PREVIOUS		" ).append("\n"); 
		query.append("	, DECODE(P.LOAD_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.LOAD_NEW,0,TO_NUMBER(NULL), (N.LOAD_NEW - P.LOAD_PREVIOUS	) /  ABS(P.LOAD_PREVIOUS)  )) * 100  AS LOAD_DIFF -- NEW/PREIOUS * 100 (%)" ).append("\n"); 
		query.append("	, DECODE(P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.G_REV,0,TO_NUMBER(NULL), (N.G_REV - (P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS)	) /  ABS(P.BUC_SCG_AMT_PREVIOUS+P.IFC_SCG_AMT_PREVIOUS+P.PSC_SCG_AMT_PREVIOUS+P.OTHERS_SCG_AMT_PREVIOUS+P.OFT_AMT_PREVIOUS)  )) * 100  AS G_REV_DIFF -- GROSS REVENUE -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.OFT_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.OFT_AMT,0,TO_NUMBER(NULL), (N.OFT_AMT - P.LOAD_PREVIOUS	) /  ABS(P.OFT_AMT_PREVIOUS)  )) * 100 AS OFT_AMT_DIFF -- OFT -DIFF(%)" ).append("\n"); 
		query.append("	, DECODE(P.BUC_SCG_AMT_PREVIOUS, 0, TO_NUMBER(NULL), DECODE(N.BUC_SCG_AMT,0,TO_NUMBER(NULL), (N.BUC_SCG_AMT - P.BUC_SCG_AMT_PREVIOUS	) /  ABS(P.BUC_SCG_AMT_PREVIOUS)  )) * 100   AS BUC_SCG_AMT_DIFF -- BUF -DIFF(%)" ).append("\n"); 
