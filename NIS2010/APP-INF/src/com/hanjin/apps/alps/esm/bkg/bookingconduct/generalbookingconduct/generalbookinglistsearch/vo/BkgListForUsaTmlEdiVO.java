...
public class BkgListForUsaTmlEdiVO extends AbstractValueObject {
	...
	public BkgListForUsaTmlEdiVO(String ibflag, String pagerows, String bkgNo, String bkgStsCd, String fM, String fH, String sp, String tVvd, String vvdHistory, String etb, String lane, String polCd, String ydCd, String bkgDate, String ack, String sendDate, String ackDate, String sendUsrId, String sendUsrNm, String tmlErrMsg, String bpXmrn) {
		this.etb = etb;
		this.bpXmrn = bpXmrn;
		this.sp = sp;
		this.ack = ack;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSp(JSPUtil.getParameter(request, prefix + "sp", ""));
		setAck(JSPUtil.getParameter(request, prefix + "ack", ""));
		setBkgStsCd(JSPUtil.getParameter(request, prefix + "bkg_sts_cd", ""));
		setBkgDate(JSPUtil.getParameter(request, prefix + "bkg_date", ""));
		setTmlErrMsg(JSPUtil.getParameter(request, prefix + "tml_err_msg", ""));
		setAckDate(JSPUtil.getParameter(request, prefix + "ack_date", ""));
		setVvdHistory(JSPUtil.getParameter(request, prefix + "vvd_history", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setLane(JSPUtil.getParameter(request, prefix + "lane", ""));
		setSendDate(JSPUtil.getParameter(request, prefix + "send_date", ""));
		setFH(JSPUtil.getParameter(request, prefix + "f_h", ""));
