...
*@FileName : RsltPriRqGrpLocVO.java
*@FileTitle : RsltPriRqGrpLocVO
*Open Issues :
*Change history :
...
public class RsltPriRqGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRqGrpLocVO> models = new ArrayList<RsltPriRqGrpLocVO>();
	...
	public RsltPriRqGrpLocVO() {}

	public RsltPriRqGrpLocVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpLocSeq, String prcGrpLocCd, String prcGrpLocDesc, String srcInfoCd, String srcInfoNm, String creUsrId, String creDt, String updUsrId, String updDt, String orgDestTpCd) {
		this.updDt = updDt;
	 ...
	 */
	public RsltPriRqGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqGrpLocVO[]
	 */
	public RsltPriRqGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqGrpLocVO model = null;
	 ...
	 * @return RsltPriRqGrpLocVO[]
	 */
	public RsltPriRqGrpLocVO[] getRsltPriRqGrpLocVOs(){
		RsltPriRqGrpLocVO[] vos = (RsltPriRqGrpLocVO[])models.toArray(new RsltPriRqGrpLocVO[models.size()]);
		return vos;
	}
