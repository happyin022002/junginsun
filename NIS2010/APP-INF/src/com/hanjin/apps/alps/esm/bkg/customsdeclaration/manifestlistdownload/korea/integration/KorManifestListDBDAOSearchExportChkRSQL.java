...
*@FileName : KorManifestListDBDAOSearchExportChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchExportChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchExportChkRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchExportChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    XPT_LIC_NO   = @[bme_elno]" ).append("\n"); 
		query.append("AND    PCK_QTY = @[bme_pkg_qty]" ).append("\n"); 
		query.append("AND    PCK_TP_CD  = @[bme_pkg_cd]" ).append("\n"); 
		query.append("AND    CNTR_WGT = @[bme_wgt_qty]" ).append("\n"); 
		query.append("AND    WGT_UT_CD  = @[bme_wgt_tp]" ).append("\n"); 
