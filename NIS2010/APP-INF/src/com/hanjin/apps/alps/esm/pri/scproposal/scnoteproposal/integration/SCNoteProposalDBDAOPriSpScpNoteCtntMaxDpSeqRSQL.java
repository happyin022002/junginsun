...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntMaxDpSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntMaxDpSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * seq-1 에 해당하는 max dp_seq를 조회한다.
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntMaxDpSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntMaxDpSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
