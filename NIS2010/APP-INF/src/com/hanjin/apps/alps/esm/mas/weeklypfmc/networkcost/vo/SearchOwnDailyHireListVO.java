...
*@FileName : SearchOwnDailyHireListVO.java
*@FileTitle : SearchOwnDailyHireListVO
*Open Issues :
*Change history :
...
public class SearchOwnDailyHireListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOwnDailyHireListVO> models = new ArrayList<SearchOwnDailyHireListVO>();
	...
	public SearchOwnDailyHireListVO() {}

	public SearchOwnDailyHireListVO(String ibflag, String pagerows, String costYrmon, String costWk, String vslCd, String vslClssCapa, String ownVslRmk) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return SearchOwnDailyHireListVO[]
	 */
	public SearchOwnDailyHireListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOwnDailyHireListVO[]
	 */
	public SearchOwnDailyHireListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOwnDailyHireListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOwnDailyHireListVO();
				if (vslCd[i] != null)
		...
		return getSearchOwnDailyHireListVOs();
	}
	 ...
	 * @return SearchOwnDailyHireListVO[]
	 */
	public SearchOwnDailyHireListVO[] getSearchOwnDailyHireListVOs(){
		SearchOwnDailyHireListVO[] vos = (SearchOwnDailyHireListVO[])models.toArray(new SearchOwnDailyHireListVO[models.size()]);
		return vos;
	}
