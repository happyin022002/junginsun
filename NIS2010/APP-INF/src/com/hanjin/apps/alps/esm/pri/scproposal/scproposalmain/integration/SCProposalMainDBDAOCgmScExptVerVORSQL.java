...
*@FileName : SCProposalMainDBDAOCgmScExptVerVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAOCgmScExptVerVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * - 미승인 CHSS Exception 존재할 경우 해당하는 General Rate, Special Rate, Special Note의  Scope 별 bullet 정보를 조회한다.
	  * </pre>
	  */
	public SCProposalMainDBDAOCgmScExptVerVORSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAOCgmScExptVerVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   AND  A.NOTE_CLSS_CD = 'C'-- Class가 CHSS 인 경우" ).append("\n"); 
		...
		query.append("                   AND  NOTE_TP_CD = 'P' -- Special Rate 이면 " ).append("\n"); 
		query.append("                   AND  NOTE_CLSS_CD = 'C' -- Class가 CHSS 인 경우" ).append("\n"); 
