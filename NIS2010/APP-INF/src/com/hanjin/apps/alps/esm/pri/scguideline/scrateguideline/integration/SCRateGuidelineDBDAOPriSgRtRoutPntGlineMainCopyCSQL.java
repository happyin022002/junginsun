...
*@FileName : SCRateGuidelineDBDAOPriSgRtRoutPntGlineMainCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtRoutPntGlineMainCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtRoutPntGlineMainCopyCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SG_RT_ROUT_PNT" ).append("\n"); 
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtRoutPntGlineMainCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}