...
*@FileName : SCRateQuotationDBDAORsltPriCostSimulationCheckRouteVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriCostSimulationCheckRouteVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriCostSimulationCheckRouteVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriCostSimulationCheckRouteVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, PNT.QTTN_NO, PNT.QTTN_VER_NO, PNT.GEN_SPCL_RT_TP_CD,PNT.CMDT_HDR_SEQ, PNT.ORG_DEST_TP_CD,PNT.ROUT_SEQ " ).append("\n"); 
		query.append("	FROM PRI_SQ_RT_ROUT_PNT PNT" ).append("\n"); 
		query.append("	    , PRI_SQ_GRP_LOC GRP" ).append("\n"); 
		query.append("	    , PRI_SQ_GRP_LOC_DTL GRP_DTL" ).append("\n"); 
		...
		query.append("		, QTTN_NO, QTTN_VER_NO, GEN_SPCL_RT_TP_CD,CMDT_HDR_SEQ, ORG_DEST_TP_CD,ROUT_SEQ " ).append("\n"); 
