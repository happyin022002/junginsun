...
public class CostStructureDBDAOMultiCostStructure0137CSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("WHEN NOT MATCHED THEN" ).append("\n"); 
		query.append("    INSERT" ).append("\n"); 
		query.append("    (B1.COST_YRMON       , B1.FULL_MTY_CD, B1.CNTR_TPSZ_CD, B1.COST_LOC_GRP_CD, B1.SLAN_CD, B1.NOD_CD    , B1.COA_COST_SRC_CD, B1.LOCL_CURR_CD," ).append("\n"); 
		...
		query.append("    VALUES" ).append("\n"); 
		query.append("    (B2.COST_YRMON       , B2.FULL_MTY_CD, B2.CNTR_TPSZ_CD, B2.COST_LOC_GRP_CD, NVL(B2.SLAN_CD,'NNN'), B2.NOD_CD    , B2.COA_COST_SRC_CD, B2.LOCL_CURR_CD," ).append("\n"); 
