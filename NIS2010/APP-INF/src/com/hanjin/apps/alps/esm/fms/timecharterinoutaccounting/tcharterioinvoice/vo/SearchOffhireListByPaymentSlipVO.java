...
*@FileName : SearchOffhireListByPaymentSlipVO.java
*@FileTitle : SearchOffhireListByPaymentSlipVO
*Open Issues :
*Change history :
...
public class SearchOffhireListByPaymentSlipVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOffhireListByPaymentSlipVO> models = new ArrayList<SearchOffhireListByPaymentSlipVO>();
	...
	public SearchOffhireListByPaymentSlipVO() {}

	public SearchOffhireListByPaymentSlipVO(String ibflag, String pagerows, String duration, String acctNm, String acctCd, String vvdBunker, String currCd, String invAmt, String invDesc, String ctrCd, String slpLocCd, String fletIssTpCd, String invSeq, String invDtlSeq, String fletSrcTpCd, String effDt, String expDt, String vvdYn, String fletCtrtNo) {
		this.vvdYn = vvdYn;
...
/**
	 ...
	 */
	public SearchOffhireListByPaymentSlipVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOffhireListByPaymentSlipVO[]
	 */
	public SearchOffhireListByPaymentSlipVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOffhireListByPaymentSlipVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOffhireListByPaymentSlipVO();
				if (vvdYn[i] != null)
		...
		return getSearchOffhireListByPaymentSlipVOs();
	}
	 ...
	 * @return SearchOffhireListByPaymentSlipVO[]
	 */
	public SearchOffhireListByPaymentSlipVO[] getSearchOffhireListByPaymentSlipVOs(){
		SearchOffhireListByPaymentSlipVO[] vos = (SearchOffhireListByPaymentSlipVO[])models.toArray(new SearchOffhireListByPaymentSlipVO[models.size()]);
		return vos;
	}
