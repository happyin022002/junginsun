...
*@FileName : Kor24CustomsTransmissionDBDAOmakeDiscBodyFlatFileRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOmakeDiscBodyFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOmakeDiscBodyFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOmakeDiscBodyFlatFileRSQL").append("\n");
		query.append("*/").append("\n");
	}
