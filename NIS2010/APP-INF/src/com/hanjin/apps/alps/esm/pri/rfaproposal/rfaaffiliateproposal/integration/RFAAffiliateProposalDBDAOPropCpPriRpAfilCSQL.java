...
*@FileName : RFAAffiliateProposalDBDAOPropCpPriRpAfilCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAAffiliateProposalDBDAOPropCpPriRpAfilCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Copy PRI_RP_AFIL Insert
	  * </pre>
	  */
	public RFAAffiliateProposalDBDAOPropCpPriRpAfilCSQL(){
		setQuery();
		...
		query.append("FileName : RFAAffiliateProposalDBDAOPropCpPriRpAfilCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
