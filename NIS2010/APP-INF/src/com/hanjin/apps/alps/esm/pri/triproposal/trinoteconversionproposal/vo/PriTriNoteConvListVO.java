...
*@FileName : PriTriNoteConvListVO.java
*@FileTitle : PriTriNoteConvListVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.pri.triproposal.trinoteconversionproposal.vo;
...
public class PriTriNoteConvListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriTriNoteConvListVO> models = new ArrayList<PriTriNoteConvListVO>();
	...
	public PriTriNoteConvListVO() {}

	public PriTriNoteConvListVO(String ibflag, String pagerows, String amdtSeq, String bkgCmdtDefCd, String bkgCmdtTpCd, String bkgDelDefCd, String bkgDelTpCd, String bkgDeTermCd, String bkgDirCallFlg, String bkgHngrBarTpCd, String bkgImdgClssCd, String bkgMaxCgoWgt, String bkgMinCgoWgt, String bkgPodDefCd, String bkgPodTpCd, String bkgPolDefCd, String bkgPolTpCd, String bkgPorDefCd, String bkgPorTpCd, String bkgPrcCgoTpCd, String bkgRatUtCd, String bkgRcvTermCd, String bkgSocFlg, String bkgTsPortDefCd, String bkgTsPortTpCd, String bkgUsaSvcModCd, String chgRuleTpCd, String convPrcCgoTpCd, String convRatUtCd, String creDt, String creUsrId, String currCd, String effDt, String expDt, String frtRtAmt, String noteConvChgCd, String noteConvMapgId, String noteConvRuleCd, String noteConvSeq, String noteConvTpCd, String payTermCd, String rtApplTpCd, String rtOpCd, String ruleApplChgTpCd, String trfNo, String trfPfxCd, String triPropNo, String updDt, String updUsrId, String usrId, String bkgPorCntCd, String bkgPolCntCd, String bkgPodCntCd, String bkgDelCntCd) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setConvRatUtCd(JSPUtil.getParameter(request, "conv_rat_ut_cd", ""));
		setRtApplTpCd(JSPUtil.getParameter(request, "rt_appl_tp_cd", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setBkgDelTpCd(JSPUtil.getParameter(request, "bkg_del_tp_cd", ""));
		setBkgSocFlg(JSPUtil.getParameter(request, "bkg_soc_flg", ""));
		setBkgHngrBarTpCd(JSPUtil.getParameter(request, "bkg_hngr_bar_tp_cd", ""));
		setEffDt(JSPUtil.getParameter(request, "eff_dt", ""));
		setBkgTsPortTpCd(JSPUtil.getParameter(request, "bkg_ts_port_tp_cd", ""));
		setBkgMaxCgoWgt(JSPUtil.getParameter(request, "bkg_max_cgo_wgt", ""));
		setBkgTsPortDefCd(JSPUtil.getParameter(request, "bkg_ts_port_def_cd", ""));
		setBkgCmdtDefCd(JSPUtil.getParameter(request, "bkg_cmdt_def_cd", ""));
		setBkgPodTpCd(JSPUtil.getParameter(request, "bkg_pod_tp_cd", ""));
		setTrfPfxCd(JSPUtil.getParameter(request, "trf_pfx_cd", ""));
		setBkgCmdtTpCd(JSPUtil.getParameter(request, "bkg_cmdt_tp_cd", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setRtOpCd(JSPUtil.getParameter(request, "rt_op_cd", ""));
		setBkgMinCgoWgt(JSPUtil.getParameter(request, "bkg_min_cgo_wgt", ""));
		setBkgPolDefCd(JSPUtil.getParameter(request, "bkg_pol_def_cd", ""));
		...
		setConvPrcCgoTpCd(JSPUtil.getParameter(request, "conv_prc_cgo_tp_cd", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setTrfNo(JSPUtil.getParameter(request, "trf_no", ""));
		setBkgRatUtCd(JSPUtil.getParameter(request, "bkg_rat_ut_cd", ""));
		setBkgDelDefCd(JSPUtil.getParameter(request, "bkg_del_def_cd", ""));
		setBkgUsaSvcModCd(JSPUtil.getParameter(request, "bkg_usa_svc_mod_cd", ""));
		setBkgImdgClssCd(JSPUtil.getParameter(request, "bkg_imdg_clss_cd", ""));
		setCurrCd(JSPUtil.getParameter(request, "curr_cd", ""));
		setBkgPrcCgoTpCd(JSPUtil.getParameter(request, "bkg_prc_cgo_tp_cd", ""));
		...
		setBkgDirCallFlg(JSPUtil.getParameter(request, "bkg_dir_call_flg", ""));
		setBkgDelCntCd(JSPUtil.getParameter(request, "bkg_del_cnt_cd", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setUsrId(JSPUtil.getParameter(request, "usr_id", ""));
		setBkgPolCntCd(JSPUtil.getParameter(request, "bkg_pol_cnt_cd", ""));
		setExpDt(JSPUtil.getParameter(request, "exp_dt", ""));
		setBkgPolTpCd(JSPUtil.getParameter(request, "bkg_pol_tp_cd", ""));
		setNoteConvTpCd(JSPUtil.getParameter(request, "note_conv_tp_cd", ""));
		setRuleApplChgTpCd(JSPUtil.getParameter(request, "rule_appl_chg_tp_cd", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setNoteConvRuleCd(JSPUtil.getParameter(request, "note_conv_rule_cd", ""));
		setBkgPorTpCd(JSPUtil.getParameter(request, "bkg_por_tp_cd", ""));
		setBkgPodDefCd(JSPUtil.getParameter(request, "bkg_pod_def_cd", ""));
		setNoteConvChgCd(JSPUtil.getParameter(request, "note_conv_chg_cd", ""));
		setBkgPorDefCd(JSPUtil.getParameter(request, "bkg_por_def_cd", ""));
		setFrtRtAmt(JSPUtil.getParameter(request, "frt_rt_amt", ""));
		setBkgPorCntCd(JSPUtil.getParameter(request, "bkg_por_cnt_cd", ""));
		setBkgPodCntCd(JSPUtil.getParameter(request, "bkg_pod_cnt_cd", ""));
	 ...
	 */
	public PriTriNoteConvListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriTriNoteConvListVO[]
	 */
	public PriTriNoteConvListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriTriNoteConvListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriTriNoteConvListVO();
				if (amdtSeq[i] != null)
		...
		return getPriTriNoteConvListVOs();
	}
	...
	public PriTriNoteConvListVO[] getPriTriNoteConvListVOs(){
		PriTriNoteConvListVO[] vos = (PriTriNoteConvListVO[])models.toArray(new PriTriNoteConvListVO[models.size()]);
		return vos;
	}
