...
*@FileName : SearchLinkCostListVO.java
*@FileTitle : SearchLinkCostListVO
*Open Issues :
*Change history :
...
public class SearchLinkCostListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchLinkCostListVO> models = new ArrayList<SearchLinkCostListVO>();
	...
	public SearchLinkCostListVO() {}

	public SearchLinkCostListVO(String ibflag, String pagerows, String lnkFmNodCd, String lnkToNodCd, String costActGrpCd, String grp, String cost, String stndCostCd, String stndCostNm, String coaCostSrcCd, String coaCostSrcCdNm, String lvl, String costAssBseCd, String loclCurrCd, String locType, String costNm) {
	 ...
	 */
	public SearchLinkCostListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchLinkCostListVO[]
	 */
	public SearchLinkCostListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchLinkCostListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchLinkCostListVO();
		...
		return getSearchLinkCostListVOs();
	}
	...
	public SearchLinkCostListVO[] getSearchLinkCostListVOs(){
		SearchLinkCostListVO[] vos = (SearchLinkCostListVO[])models.toArray(new SearchLinkCostListVO[models.size()]);
		return vos;
	}
