...
*@FileName : KorEdiMrnVO.java
*@FileTitle : KorEdiMrnVO
*Open Issues :
*Change history :
...
public class KorEdiMrnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorEdiMrnVO> models = new ArrayList<KorEdiMrnVO>();
	...
	public KorEdiMrnVO(String ibflag, String pagerows, String mrnNo, String mrnChkNo, String vvdSeq) {
		this.ibflag = ibflag;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mrn_nbr", getMrnNo());
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMrnNo(JSPUtil.getParameter(request, "mrn_nbr", ""));
	 ...
	 * @param request
	 * @return SearchMrnNoKorVO[]
	 */
	public KorEdiMrnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMrnNoKorVO[]
	 */
	public KorEdiMrnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEdiMrnVO model = null;
		...
		try {
			...
			String[] mrnChkNo = (JSPUtil.getParameter(request, prefix	+ "mrn_chk_no".trim(), length));
			String[] mrnNo = (JSPUtil.getParameter(request, prefix	+ "mrn_nbr".trim(), length));
			String[] vvdSeq = (JSPUtil.getParameter(request, prefix	+ "vvd_seq".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new KorEdiMrnVO();
				if (ibflag[i] != null)
	 ...
	 * @return SearchMrnNoKorVO[]
	 */
	public KorEdiMrnVO[] getSearchMrnNoKorVOs(){
		KorEdiMrnVO[] vos = (KorEdiMrnVO[])models.toArray(new KorEdiMrnVO[models.size()]);
		return vos;
	}
