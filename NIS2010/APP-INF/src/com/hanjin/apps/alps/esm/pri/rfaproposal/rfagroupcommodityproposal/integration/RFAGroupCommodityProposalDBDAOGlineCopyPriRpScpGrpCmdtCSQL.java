...
*@FileName : RFAGroupCommodityProposalDBDAOGlineCopyPriRpScpGrpCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupCommodityProposalDBDAOGlineCopyPriRpScpGrpCmdtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_RP_SCP_GRP_CMDT Insert
	  * </pre>
	  */
	public RFAGroupCommodityProposalDBDAOGlineCopyPriRpScpGrpCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityProposalDBDAOGlineCopyPriRpScpGrpCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY A.SVC_SCP_CD, A.GLINE_SEQ, A.GRP_CMDT_SEQ) AS GRP_CMDT_SEQ" ).append("\n"); 
		query.append(",DENSE_RANK() OVER(PARTITION BY A.SVC_SCP_CD, A.GLINE_SEQ, A.GRP_CMDT_SEQ" ).append("\n"); 
		query.append("ORDER BY A.SVC_SCP_CD, A.GLINE_SEQ, A.GRP_CMDT_SEQ, B.GRP_CMDT_DTL_SEQ) AS SEQ" ).append("\n"); 
