...
*@FileName : UnmatchBLDBDAOCheckScIndiaSurchargeDiscrepancyDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckScIndiaSurchargeDiscrepancyDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckScIndiaSurchargeDiscrepancyDetailRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckScIndiaSurchargeDiscrepancyDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            OVER (PARTITION BY CHG_CD, CHG_AMT) AS CHK_CHG_AMT" ).append("\n"); 
		...
		query.append("                        AND     (    (" ).append("\n"); 
		query.append("                                        RA.chg_cd in ('DIH','OIH')" ).append("\n"); 
		query.append("                                    AND RA.CHG_UT_AMT = 0" ).append("\n"); 
		query.append("                                    AND BR.CHG_USD_AMT > RA.CHG_USD_AMT" ).append("\n"); 
		query.append("                                    )" ).append("\n"); 
		query.append("                               OR   (  " ).append("\n"); 
		query.append("                                        BR.CURR_CD      = RA.CURR_CD" ).append("\n"); 
		query.append("                                    AND BR.CHG_UT_AMT   = RA.CHG_UT_AMT" ).append("\n"); 
		query.append("                                    )" ).append("\n"); 
		query.append("                               OR   (  " ).append("\n"); 
		query.append("                                     ABS(BR.CHG_USD_AMT - RA.CHG_USD_AMT) <= 5" ).append("\n"); 
		query.append("                                    )" ).append("\n"); 
		query.append("                               )" ).append("\n"); 
		...
		query.append("                      )" ).append("\n"); 
		query.append("     AND	CHG_CD	in (   SELECT H.ATTR_CTNT1" ).append("\n"); 
		query.append("                            FROM BKG_BOOKING B, BKG_HRD_CDG_CTNT H" ).append("\n"); 
		query.append("                            WHERE BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("                            AND H.HRD_CDG_ID = 'SUR_AUDIT_EXPT'" ).append("\n"); 
		query.append("                            AND ((" ).append("\n"); 
		query.append("                                 SUBSTR(B.POD_CD,1,2) = H.ATTR_CTNT4" ).append("\n"); 
		query.append("                                 AND H.ATTR_CTNT4 = @[cnt_cd]" ).append("\n"); 
		query.append("                                 )" ).append("\n"); 
		query.append("                             OR (" ).append("\n"); 
		query.append("                                 SUBSTR(B.POL_CD,1,2) = H.ATTR_CTNT7" ).append("\n"); 
		query.append("                                 AND H.ATTR_CTNT7 = @[cnt_cd]" ).append("\n"); 
		query.append("                                 ))" ).append("\n"); 
		query.append("                            AND H.ATTR_CTNT9 = 'Y'" ).append("\n"); 
		query.append("                            AND @[ca_flg] = 'N'" ).append("\n"); 
		query.append("                            UNION ALL" ).append("\n"); 
		...
		query.append("                            AND H.ATTR_CTNT9 = 'Y'" ).append("\n"); 
		query.append("                            AND ((" ).append("\n"); 
		query.append("                                 SUBSTR(POD_CD,1,2) = H.ATTR_CTNT4" ).append("\n"); 
		query.append("                                 AND H.ATTR_CTNT4 = @[cnt_cd]" ).append("\n"); 
		query.append("                                 )" ).append("\n"); 
		query.append("                             OR (" ).append("\n"); 
		query.append("                                 SUBSTR(POL_CD,1,2) = H.ATTR_CTNT7" ).append("\n"); 
		query.append("                                 AND H.ATTR_CTNT7 = @[cnt_cd]" ).append("\n"); 
		query.append("                                 ))" ).append("\n"); 
		query.append("                            AND @[ca_flg] = 'Y'" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		...
		query.append("                        --" ).append("\n"); 
		query.append("                        AND     BS.CHG_CD       = BR.CHG_CD" ).append("\n"); 
		query.append("                        AND     BS.CHG_USD_AMT  = BR.CHG_USD_AMT" ).append("\n"); 
		query.append("                        AND     BS.CHK_CHG_AMT  = BR.CHK_CHG_AMT" ).append("\n"); 
		query.append("                            OR  BS.CHG_CD       = BR.CHG_CD" ).append("\n"); 
		query.append("                        AND     BS.CHG_USD_AMT  = BR.CHG_USD_AMT" ).append("\n"); 
		query.append("                        AND     BS.CHK_CHG_AMT <> BR.CHK_CHG_AMT" ).append("\n"); 
		query.append("                        AND     BS.RAT_UT_CD    = BR.RAT_UT_CD" ).append("\n"); 
		query.append("                        AND     BS.CGO_CATE_CD  = BR.CGO_CATE_CD" ).append("\n"); 
		query.append("                        AND     BS.RCV_TERM_CD  = BR.RCV_TERM_CD" ).append("\n"); 
		query.append("                        AND     BS.DE_TERM_CD   = BR.DE_TERM_CD" ).append("\n"); 
		query.append("                      )" ).append("\n"); 
		query.append("     AND	CHG_CD	in (   SELECT H.ATTR_CTNT1" ).append("\n"); 
		query.append("                            FROM BKG_BOOKING B, BKG_HRD_CDG_CTNT H" ).append("\n"); 
		query.append("                            WHERE BKG_NO = @[bkg_no]" ).append("\n"); 
		...
		query.append("                        )" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT DECODE(NVL(SUM(DECODE(CHG_CD,'OIH',1,'DIH',1,0)),0),0,'Y','E') IHC_FLG" ).append("\n"); 
		query.append("      ,DECODE(NVL(SUM(DECODE(CHG_CD,'OTH',1,'DTH',1,'NST',1,0)),0),0,'Y','E') THC_FLG" ).append("\n"); 
		query.append("  FROM E1" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
