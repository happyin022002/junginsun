...
*@FileName : CaCgoRlseBkbcFocVO.java
*@FileTitle : CaCgoRlseBkbcFocVO
*Open Issues :
*Change history :
...
public class CaCgoRlseBkbcFocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CaCgoRlseBkbcFocVO> models = new ArrayList<CaCgoRlseBkbcFocVO>();
	 ...
	 */
	public CaCgoRlseBkbcFocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CaCgoRlseBkbcFocVO[]
	 */
	public CaCgoRlseBkbcFocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CaCgoRlseBkbcFocVO model = null;
	 ...
	 * @return CaCgoRlseBkbcFocVO[]
	 */
	public CaCgoRlseBkbcFocVO[] getCaCgoRlseBkbcFocVOs(){
		CaCgoRlseBkbcFocVO[] vos = (CaCgoRlseBkbcFocVO[])models.toArray(new CaCgoRlseBkbcFocVO[models.size()]);
		return vos;
	}
