 ...
 * @see SCQUOTATION Event 참조
 * @since J2EE 1.6
 */

public class ESM_PRI_6074HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6074HTMLAction 객체를 생성
	 */
	public ESM_PRI_6074HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6074Event event = new EsmPri6074Event();
 	
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriSqRtCmdtHdrVO((PriSqRtCmdtHdrVO)getVO(request, PriSqRtCmdtHdrVO .class));
		}
