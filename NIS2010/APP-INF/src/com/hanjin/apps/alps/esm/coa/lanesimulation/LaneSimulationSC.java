...
=========================================================*/
package com.hanjin.apps.alps.esm.coa.lanesimulation;
...
import com.hanjin.apps.alps.esm.coa.lanesimulation.basic.LaneSimulationBC;
import com.hanjin.apps.alps.esm.coa.lanesimulation.basic.LaneSimulationBCImpl;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0051Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0052Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0053Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0054Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0150Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0151Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0164Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0165Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0166Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0167Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0168Event;
import com.hanjin.apps.alps.esm.coa.lanesimulation.event.EsmCoa0169Event;
			...
			if   (e.getFormCommand().isCommand(FormCommand.SEARCHLIST10)){
				...
				if(rtnVo.getDbRowSet() != null){
					 while(rtnVo.getDbRowSet().next()){
						 headerCD = headerCD + JSPUtil.getNull(rtnVo.getDbRowSet().getString("code")) + "|";
						 headerNM = headerNM + JSPUtil.getNull(rtnVo.getDbRowSet().getString("name")) + "|";
					 }
				} // end if
