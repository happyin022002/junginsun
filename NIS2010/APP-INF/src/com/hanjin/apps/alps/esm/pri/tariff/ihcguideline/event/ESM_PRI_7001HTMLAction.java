 ...
 *@FileName : ESM_PRI_7001HTMLAction.java
...
public class ESM_PRI_7001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_7001HTMLAction 객체를 생성
	 */
	public ESM_PRI_7001HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7001Event event = new EsmPri7001Event();
