...
*@FileName : ESM_BKG_1054_99HTMLAction.java
 ...
 * @author Park Mangeon
 * @see EsmBkg1054Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_1054_99HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1054_99HTMLAction 객체를 생성
	 */
	public ESM_BKG_1054_99HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg105499Event event = new EsmBkg105499Event();
		int iSize = 0;
...
//			// Customer Code Validation 결과를 요청한다.Match
//			ArrNtcSearchVO arrNtcSearchVO = (ArrNtcSearchVO)getVO(request,ArrNtcSearchVO.class);
//			arrNtcSearchVO.setVpsEtaDtStart(arrNtcSearchVO.getVpsEtaDtStart().replaceAll("-", ""));
//			arrNtcSearchVO.setVpsEtaDtEnd(arrNtcSearchVO.getVpsEtaDtEnd().replaceAll("-", ""));
//
...
//			// Un-Match에 대한 Validation 결과를 저장한다.
