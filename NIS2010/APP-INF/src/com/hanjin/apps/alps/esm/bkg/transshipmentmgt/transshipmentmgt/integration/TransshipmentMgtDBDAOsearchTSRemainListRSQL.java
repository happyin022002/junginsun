...
public class TransshipmentMgtDBDAOsearchTSRemainListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				,(SELECT POD_CD FROM BKG_VVD M" ).append("\n"); 
		query.append("				 WHERE M.BKG_NO = BK.BKG_NO" ).append("\n"); 
		query.append("				   AND M.POL_CD =  @[loc_cd]" ).append("\n"); 
		...
		query.append("                , replace(sh.cust_nm,chr(13)||chr(10),'') sh_nm" ).append("\n"); 
		query.append("                , replace(cn.cust_nm,chr(13)||chr(10),'') cn_nm" ).append("\n"); 
		...
		query.append("           and frmr_vvd.poD_cd = @[loc_cd]" ).append("\n"); 
		...
		query.append("    and (next_vsl is not null or next_vsl not in ('SMXX', 'SMYY', 'SMZZ'))" ).append("\n"); 
		query.append("#elseif(${next_vvd} == 'N')" ).append("\n"); 
		query.append("    and (next_vsl is null or next_vsl in ('SMXX', 'SMYY', 'SMZZ'))" ).append("\n"); 
		query.append("#end" ).append("\n"); 
