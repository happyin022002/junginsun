...
*@FileName : ESM_COA_0023HTMLAction.java
...
public class ESM_COA_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0023HTMLAction 객체를 생성
	 */
	public ESM_COA_0023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0023Event event = new EsmCoa0023Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGeneralExpenseVO((GeneralExpenseVO)getVO(request, GeneralExpenseVO .class));
		} else if(command.isCommand(FormCommand.MULTI01)) { 
			event.setGeneralExpenseVOS((GeneralExpenseVO[])getVOs(request, GeneralExpenseVO .class,""));
		}
