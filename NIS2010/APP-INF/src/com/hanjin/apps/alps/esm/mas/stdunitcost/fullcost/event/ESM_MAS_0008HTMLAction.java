...
*@FileName : ESM_MAS_0008HTMLAction.java
...
public class ESM_MAS_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0008HTMLAction 객체를 생성
	 */
	public ESM_MAS_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0008Event event = new EsmMas0008Event();
