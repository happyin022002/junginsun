 ...
 *@FileName : SearchDetailCntVO.java
 *@FileTitle : SearchDetailCntVO
 *Open Issues :
 *Change history :
...
public class RsltSearchDetailCntVO extends AbstractValueObject {
	...
	/* Column Info */
	private String rateIhcCnt = null;
	/* Column Info */
	...
	public RsltSearchDetailCntVO(String ibflag, String pagerows, String grpLocCnt, String grpCmdtCnt, String rateCnt, String rateIhcCnt, String rateGCnt, String rateSCnt) {
		this.grpLocCnt = grpLocCnt;
		this.ibflag = ibflag;
		this.rateSCnt = rateSCnt;
		this.rateCnt = rateCnt;
		this.rateGCnt = rateGCnt;
		this.rateIhcCnt = rateIhcCnt;
	...
	public HashMap<String, String> getColumnValues() {
		...
		this.hashColumns.put("rate_ihc_cnt", getRateIhcCnt());
	...
	public HashMap<String, String> getFieldNames() {
		...
		this.hashFields.put("rate_ihc_cnt", "rateIhcCnt");
	 ...
	 * @return rateIhcCnt
	 */
	public String getRateIhcCnt() {
		return this.rateIhcCnt;
	}
	 ...
	 * @param rateIhcCnt
	 */
	public void setRateIhcCnt(String rateIhcCnt) {
		this.rateIhcCnt = rateIhcCnt;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setGrpLocCnt(JSPUtil.getParameter(request, prefix + "grp_loc_cnt", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setRateSCnt(JSPUtil.getParameter(request, prefix + "rate_s_cnt", ""));
		setRateCnt(JSPUtil.getParameter(request, prefix + "rate_cnt", ""));
		setRateGCnt(JSPUtil.getParameter(request, prefix + "rate_g_cnt", ""));
		setRateIhcCnt(JSPUtil.getParameter(request, prefix + "rate_ihc_cnt", ""));
		setGrpCmdtCnt(JSPUtil.getParameter(request, prefix + "grp_cmdt_cnt", ""));
	...
	public RsltSearchDetailCntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] rateIhcCnt = (JSPUtil.getParameter(request, prefix + "rate_ihc_cnt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (rateIhcCnt[i] != null)
					model.setRateIhcCnt(rateIhcCnt[i]);
	 ...
	 * @return SearchDetailCntVO[]
	 */
	public RsltSearchDetailCntVO[] getSearchDetailCntVOs() {
	...
	public void unDataFormat() {
		...
		this.rateIhcCnt = this.rateIhcCnt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
