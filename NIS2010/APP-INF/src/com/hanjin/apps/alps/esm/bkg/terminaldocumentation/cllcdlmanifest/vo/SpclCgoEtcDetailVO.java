...
*@FileName : SpclCgoEtcDetailVO.java
*@FileTitle : SpclCgoEtcDetailVO
*Open Issues :
*Change history :
...
public class SpclCgoEtcDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpclCgoEtcDetailVO> models = new ArrayList<SpclCgoEtcDetailVO>();
	...
	public SpclCgoEtcDetailVO() {}

	public SpclCgoEtcDetailVO(String ibflag, String pagerows, String eCgoType, String ePod, String eCntrNo, String eTp, String eDetail, String eMlb, String eBkgBs) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("e_bkg_bs", getEBkgBs());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("e_bkg_bs", "eBkgBs");
	 ...
	 * @param eBkgBs
	 */
	public void setEBkgBs(String eBkgBs) {
		this.eBkgBs = eBkgBs;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setEBkgBs(JSPUtil.getParameter(request, prefix + "e_bkg_bs", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return SpclCgoEtcDetailVO[]
	 */
	public SpclCgoEtcDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpclCgoEtcDetailVO[]
	 */
	public SpclCgoEtcDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpclCgoEtcDetailVO model = null;
		...
		try {
			...
			String[] eBkgBs = (JSPUtil.getParameter(request, prefix	+ "e_bkg_bs", length));
			
			for (int i = 0; i < length; i++) {
				model = new SpclCgoEtcDetailVO();
				if (eDetail[i] != null)
	 ...
	 * @return SpclCgoEtcDetailVO[]
	 */
	public SpclCgoEtcDetailVO[] getSpclCgoEtcDetailVOs(){
		SpclCgoEtcDetailVO[] vos = (SpclCgoEtcDetailVO[])models.toArray(new SpclCgoEtcDetailVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.eBkgBs = this.eBkgBs .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
