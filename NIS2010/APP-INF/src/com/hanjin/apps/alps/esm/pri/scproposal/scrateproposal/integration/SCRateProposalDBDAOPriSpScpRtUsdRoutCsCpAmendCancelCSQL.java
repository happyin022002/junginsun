...
*@FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpAmendCancelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpAmendCancelCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Amend Cancel시 PriSpScpRtUsdRoutCs 테이블 복구
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpAmendCancelCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtUsdRoutCsCpAmendCancelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[cre_usr_id]" ).append("\n"); 
		query.append(",SYSDATE" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_RT_USD_ROUT_CS" ).append("\n"); 
