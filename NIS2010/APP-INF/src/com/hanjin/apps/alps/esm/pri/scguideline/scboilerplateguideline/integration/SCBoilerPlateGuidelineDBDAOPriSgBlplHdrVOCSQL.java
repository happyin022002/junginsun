...
*@FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOCSQL.java
...
public class SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into pri_sg_blpl_hdr (" ).append("\n"); 
		...
		query.append("@[blpl_ref_yr]," ).append("\n"); 
		query.append("@[blpl_ref_yr] || ' Boiler Plate'," ).append("\n"); 
		query.append("DECODE(NVL(@[cfm_flg],''),'','N',@[cfm_flg])," ).append("\n"); 
		query.append("@[cfm_usr_id]," ).append("\n"); 
		query.append("@[cre_usr_id]," ).append("\n"); 
