...
*@FileName : RFAGRICalculationProposalDBDAORsltGriCalcActCustListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAORsltGriCalcActCustListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAORsltGriCalcActCustListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAORsltGriCalcActCustListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
