...
*@FileName : ESM_SPC_0085HTMLAction.java
...
public class ESM_SPC_0085HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0085HTMLAction 객체를 생성
	 */
	public ESM_SPC_0085HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0085Event event = new EsmSpc0085Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSpcTeamQtaRtoVOs((SpcTeamQtaRtoVO[])getVOs(request, SpcTeamQtaRtoVO .class,""));
