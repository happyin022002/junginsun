...
*@FileName       : EsmSqm0043ViewAdapter.java
 ...
 * @since SQM USER
 */
public class EsmSqm0043ViewAdapter extends DefaultViewAdapter {
    /**
     *  EsmSqm0043ViewAdapter.<br>
     */
    public EsmSqm0043ViewAdapter(){
        super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
        ...
        for(int i=0;i<realCnt;i++){
            ...
            cng_tp        = getNull(colValues.get("sqm_cng_tp_cd"));
            ...
            sbufXML.append("<TD>" + getNull(colValues.get("sqm_cng_tp_cd"))+ "</TD>");
            sbufXML.append("</TR>\n");
        }
        sbufXML.append("</DATA>\n");
