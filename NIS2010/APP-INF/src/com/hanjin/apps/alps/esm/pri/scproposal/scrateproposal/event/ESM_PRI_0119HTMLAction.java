 ...
 *@FileName : ESM_PRI_0119HTMLAction.java
...
public class ESM_PRI_0119HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0119Event event = new EsmPri0119Event();
