 ...
 *@FileName : RsltPriRqRtRoutPntVO.java
 *@FileTitle : RsltPriRqRtRoutPntVO
 *Open Issues :
 *Change history :
...
public class RsltPriRqRtRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<RsltPriRqRtRoutPntVO> models = new ArrayList<RsltPriRqRtRoutPntVO>();
	...
	public RsltPriRqRtRoutPntVO() {
	}

	public RsltPriRqRtRoutPntVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String routSeq, String orgDestTpCd,
			String routPntSeq, String routPntLocTpCd, String routPntLocDefCd, String rcvDeTermCd, String prcTrspModCd, String srcInfoCd, String creUsrId, String creDt,
			String updUsrId, String updDt, String routPntLocDefNm, String rcvDeTermNm, String bsePortLocCd, String ficRoutCmbTpCd) {
		this.updDt = updDt;
	 ...
	 */
	public RsltPriRqRtRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqRtRoutDestPntVO[]
	 */
	public RsltPriRqRtRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqRtRoutPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriRqRtRoutPntVO();
				if (updDt[i] != null)
		...
		return getRsltPriRqRtRoutPntVOs();
	}
	 ...
	 * @return RsltPriRqRtRoutDestPntVO[]
	 */
	public RsltPriRqRtRoutPntVO[] getRsltPriRqRtRoutPntVOs() {
		RsltPriRqRtRoutPntVO[] vos = (RsltPriRqRtRoutPntVO[]) models.toArray(new RsltPriRqRtRoutPntVO[models.size()]);
		return vos;
	}
