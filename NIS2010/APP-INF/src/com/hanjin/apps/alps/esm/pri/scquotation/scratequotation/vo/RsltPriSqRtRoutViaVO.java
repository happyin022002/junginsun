...
*@FileName : RsltPriSqRtRoutViaVO.java
*@FileTitle : RsltPriSqRtRoutViaVO
*Open Issues :
*Change history :
...
public class RsltPriSqRtRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqRtRoutViaVO> models = new ArrayList<RsltPriSqRtRoutViaVO>();
	 ...
	 * @param request
	 * @return RsltPriSqRtRoutViaVO[]
	 */
	public RsltPriSqRtRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqRtRoutViaVO[]
	 */
	public RsltPriSqRtRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqRtRoutViaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSqRtRoutViaVO();
				if (updDt[i] != null)
		...
		return getRsltPriSqRtRoutViaVOs();
	}
	 ...
	 * @return RsltPriSqRtRoutViaVO[]
	 */
	public RsltPriSqRtRoutViaVO[] getRsltPriSqRtRoutViaVOs(){
		RsltPriSqRtRoutViaVO[] vos = (RsltPriSqRtRoutViaVO[])models.toArray(new RsltPriSqRtRoutViaVO[models.size()]);
		return vos;
	}
