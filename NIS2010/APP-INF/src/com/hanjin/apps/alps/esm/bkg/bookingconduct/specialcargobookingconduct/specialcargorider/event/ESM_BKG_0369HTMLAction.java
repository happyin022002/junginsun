...
*@FileName : ESM_BKG_0369HTMLAction.java
*@FileTitle : B/L Rider
*Open Issues :
*Change history :
...
public class ESM_BKG_0369HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0369HTMLAction 객체를 생성
	 */
	public ESM_BKG_0369HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("[START::  ESM_BKG_0369HTMLAction  ]==========");

		EsmBkg0369Event event = new EsmBkg0369Event();
		String[] keys =null;
		...
		log.debug("[END:: perform ESM_BKG_0369HTMLAction  ]==========");
		return  event;
	}
