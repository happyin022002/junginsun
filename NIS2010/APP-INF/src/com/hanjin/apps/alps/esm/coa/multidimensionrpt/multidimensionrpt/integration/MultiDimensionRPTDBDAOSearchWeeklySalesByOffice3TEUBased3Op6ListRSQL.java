...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3Op6ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3Op6ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3Op6ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased3Op6ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		                       ,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.N6TH_CO_AMT,'O|BIZ', B2.N6TH_HJS_SLS_AMT,B2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("		                       ) " ).append("\n"); 
		...
		query.append("		                       ,'LOAD0000', DECODE(SUBSTR (B2.CNTR_TPSZ_CD, -1),'2', B2.N6TH_ESTM_PL_AMT, '3', B2.N6TH_ESTM_PL_AMT, B2.N6TH_ESTM_PL_AMT * 2) " ).append("\n"); 
		query.append("		                       ,'BSA00000', B2.N6TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("		                       ,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.N6TH_CO_AMT,'O|BIZ', B2.N6TH_HJS_SLS_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("		                       ) " ).append("\n"); 
		query.append("		          ,'R', DECODE (B2.STND_COST_CD " ).append("\n"); 
		query.append("		                       ,'LOAD0000', DECODE(SUBSTR(B2.CNTR_TPSZ_CD, -1),'2', B2.RA_PL_AMT, '3', B2.RA_PL_AMT, B2.RA_PL_AMT * 2) " ).append("\n"); 
		query.append("		                       ,'92404011', DECODE(@[f_ofc_vw],'L', 0, 'C', DECODE(@[f_ofc_lvl],'1',0, B2.RA_PL_AMT))  " ).append("\n"); 
		...
		query.append("				,NVL (SUM (DECODE (A3.STND_COST_TP_CD " ).append("\n"); 
		query.append("				                 ,'O', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("				                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("				                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("				                              ) " ).append("\n"); 
		query.append("				                 ,0 " ).append("\n"); 
		query.append("				                 ) " ).append("\n"); 
