...
*@FileName : RFARateProposalDBDAORqCpPriRpScpRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORqCpPriRpScpRtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORqCpPriRpScpRtCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORqCpPriRpScpRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY S.QTTN_NO, S.QTTN_VER_NO, R.CMDT_HDR_SEQ, R.ROUT_SEQ" ).append("\n"); 
		query.append("                          ORDER BY S.QTTN_NO, S.QTTN_VER_NO, R.CMDT_HDR_SEQ, R.ROUT_SEQ, S.RT_SEQ) AS RT_SEQ" ).append("\n"); 
		...
		query.append("	 , S.FIC_QTTN_RT_AMT" ).append("\n"); 
		...
		query.append("	 , S.FIC_ORG_QTTN_RT_AMT" ).append("\n"); 
		...
		query.append("	 , S.FIC_DEST_QTTN_RT_AMT" ).append("\n"); 
		...
		query.append("    ,PRI_RQ_RT S" ).append("\n"); 
