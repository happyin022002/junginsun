...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtRouteCmpbVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtRouteCmpbVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtRouteCmpbVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtRouteCmpbVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_SP_SCP_RT_CMDT_ROUT ROUT" ).append("\n"); 
		query.append("USING (" ).append("\n"); 
		query.append("        SELECT PROP_NO ,AMDT_SEQ ,SVC_SCP_CD ,GEN_SPCL_RT_TP_CD ,CMDT_HDR_SEQ ,ROUT_SEQ , RAT_UT_CD, PRC_CGO_TP_CD" ).append("\n"); 
