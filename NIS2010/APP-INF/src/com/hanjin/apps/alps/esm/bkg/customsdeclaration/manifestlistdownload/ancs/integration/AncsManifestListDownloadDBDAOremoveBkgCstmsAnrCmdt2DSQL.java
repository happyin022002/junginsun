...
*@FileName : AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCmdt2DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCmdt2DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCmdt2DSQL(){
		setQuery();
		...
		query.append("FileName : AncsManifestListDownloadDBDAOremoveBkgCstmsAnrCmdt2DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM BKG_CSTMS_ANR_CMDT A" ).append("\n"); 
