...
*@FileName : AGTAuditDBDAOModifyAGTCommBkgInfoRevVVDUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOModifyAGTCommBkgInfoRevVVDUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyAGTCommInfo of Rev VVD
	  * </pre>
	  */
	public AGTAuditDBDAOModifyAGTCommBkgInfoRevVVDUSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.agt.agtaudit.agtaudit.integration").append("\n"); 
		query.append("FileName : AGTAuditDBDAOModifyAGTCommBkgInfoRevVVDUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INF.RLANE_CD        AS INF_RLANE_CD," ).append("\n"); 
		query.append("INF.REV_VVD_CD      AS INF_REV_VVD_CD," ).append("\n"); 
		query.append("INF.ESTM_IOC_DIV_CD AS INF_ESTM_IOC_DIV_CD," ).append("\n"); 
		query.append("REV.RLANE_CD        AS REV_RLANE_CD," ).append("\n"); 
		query.append("REV.REV_VVD_CD      AS REV_REV_VVD_CD," ).append("\n"); 
		query.append("REV.ESTM_IOC_DIV_CD AS REV_ESTM_IOC_DIV_CD" ).append("\n"); 
		query.append("FROM AGT_COMM_BKG_INFO INF," ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("BKG_NO," ).append("\n"); 
		query.append("CASE RNK" ).append("\n"); 
		query.append("WHEN 1" ).append("\n"); 
		query.append("THEN N1ST_CONTI" ).append("\n"); 
		query.append("WHEN 2" ).append("\n"); 
		query.append("THEN N2ND_CONTI" ).append("\n"); 
		query.append("WHEN 3" ).append("\n"); 
		query.append("THEN N3RD_CONTI" ).append("\n"); 
		query.append("WHEN 4" ).append("\n"); 
		query.append("THEN N4TH_CONTI" ).append("\n"); 
		query.append("ELSE ''" ).append("\n"); 
		query.append("END                 AS ESTM_IOC_DIV_CD," ).append("\n"); 
		query.append("CASE RNK" ).append("\n"); 
		query.append("WHEN 1" ).append("\n"); 
		query.append("THEN N1ST_RLANE_CD" ).append("\n"); 
		query.append("WHEN 2" ).append("\n"); 
		query.append("THEN N2ND_RLANE_CD" ).append("\n"); 
		query.append("WHEN 3" ).append("\n"); 
		query.append("THEN N3RD_RLANE_CD" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("NVL (SAQ_GET_RLANE_FNC (C.SLAN_CD,C.POL_CD,C.POD_CD), 'RBCCO'), --N1ST_RLANE_CD" ).append("\n"); 
		query.append("CASE WHEN D.SLAN_CD IS NULL THEN '' ELSE SAQ_GET_RLANE_FNC (D.SLAN_CD,D.POL_CD,D.POD_CD) END, --N2ND_RLANE_CD" ).append("\n"); 
		query.append("CASE WHEN E.SLAN_CD IS NULL THEN '' ELSE SAQ_GET_RLANE_FNC (E.SLAN_CD,E.POL_CD,E.POD_CD) END, -- N3RD_RLANE_CD" ).append("\n"); 
		query.append("CASE WHEN F.SLAN_CD IS NULL THEN '' ELSE SAQ_GET_RLANE_FNC (F.SLAN_CD,F.POL_CD,F.POD_CD) END, -- N4TH_RLANE_CD" ).append("\n"); 
		...
		query.append("NVL (SAQ_GET_RLANE_FNC (C.SLAN_CD,C.POL_CD,C.POD_CD), 'RBCCO') AS N1ST_RLANE_CD," ).append("\n"); 
		query.append("CASE WHEN D.SLAN_CD IS NULL THEN '' ELSE SAQ_GET_RLANE_FNC (D.SLAN_CD,D.POL_CD,D.POD_CD) END AS N2ND_RLANE_CD," ).append("\n"); 
		query.append("CASE WHEN E.SLAN_CD IS NULL THEN '' ELSE SAQ_GET_RLANE_FNC (E.SLAN_CD,E.POL_CD,E.POD_CD) END AS N3RD_RLANE_CD," ).append("\n"); 
		query.append("CASE WHEN F.SLAN_CD IS NULL THEN '' ELSE SAQ_GET_RLANE_FNC (F.SLAN_CD,F.POL_CD,F.POD_CD) END AS N4TH_RLANE_CD," ).append("\n"); 
		...
		query.append("WHERE COMM_PROC_STS_CD = 'AS'" ).append("\n"); 
		...
		query.append("WHERE INF.BKG_NO            = REV.BKG_NO" ).append("\n"); 
		query.append("AND INF.REV_VVD_CD      <>  REV.REV_VVD_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SET INF_RLANE_CD        = REV_RLANE_CD," ).append("\n"); 
		query.append("INF_REV_VVD_CD      = REV_REV_VVD_CD," ).append("\n"); 
		query.append("INF_ESTM_IOC_DIV_CD = REV_ESTM_IOC_DIV_CD" ).append("\n"); 
