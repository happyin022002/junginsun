...
*@FileName : ESM_AGT_0056HTMLAction.java
...
public class ESM_AGT_0056HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0056HTMLAction 객체를 생성
	 */
	public ESM_AGT_0056HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0056Event event = new EsmAgt0056Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchCSRSelectionVO((SearchCSRSelectionVO)getVO(request, SearchCSRSelectionVO .class));
		}
