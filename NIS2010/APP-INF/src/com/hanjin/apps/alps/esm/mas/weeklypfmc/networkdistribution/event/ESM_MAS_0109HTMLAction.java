...
*@FileName : ESM_MAS_0109HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Jong-Ock KIM
 * @see EsmMas0109Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0109HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0109HTMLAction 객체를 생성
	 */
	public ESM_MAS_0109HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0109Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0109Event event = new EsmMas0109Event();  		
