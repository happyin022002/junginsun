...
*@FileName : RFARateQuotationDBDAOSearchFicGuidelineRateForLoadExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOSearchFicGuidelineRateForLoadExcelRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Quotation Load Excel의 Guide 정보를 조회하기 위한 파일
	  * </pre>
	  */
	public RFARateQuotationDBDAOSearchFicGuidelineRateForLoadExcelRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOSearchFicGuidelineRateForLoadExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("				,'$route.getDestPrcTrspModNm()' AS prc_trsp_mod_cd" ).append("\n"); 
		query.append("				,'$route.getDestRcvDeTermNm()' AS rcv_de_term_cd" ).append("\n"); 
		query.append("				, PRI_FIC_RATE_CALCULATE_PKG.PRI_getFICRouteGroup_FNC(@[eff_dt], @[svc_scp_cd], '$route.getDestRoutPntLocDefCd()', '$route.getDestRoutViaPortDefCd()','$route.getDestRcvDeTermNm()', '$route.getDestPrcTrspModNm()') AS FIC_RT_RSLT" ).append("\n"); 
		query.append("			FROM DUAL" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		query.append("		#foreach( ${route} in ${route_list}) " ).append("\n"); 
		...
		query.append("				,'$route.getOrgPrcTrspModNm()' AS prc_trsp_mod_cd" ).append("\n"); 
		query.append("				,'$route.getOrgRcvDeTermNm()' AS rcv_de_term_cd" ).append("\n"); 
		query.append("				, PRI_FIC_RATE_CALCULATE_PKG.PRI_getFICRouteGroup_FNC(@[eff_dt], @[svc_scp_cd], '$route.getOrgRoutPntLocDefCd()', '$route.getOrgRoutViaPortDefCd()','$route.getOrgRcvDeTermNm()', '$route.getOrgPrcTrspModNm()') AS FIC_RT_RSLT" ).append("\n"); 
		query.append("			FROM DUAL" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("#end	" ).append("\n"); 
