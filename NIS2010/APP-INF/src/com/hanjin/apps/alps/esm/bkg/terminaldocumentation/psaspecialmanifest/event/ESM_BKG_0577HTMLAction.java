...
*@FileName : ESM_BKG_0577HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
import com.hanjin.apps.alps.esm.bkg.terminaldocumentation.psaspecialmanifest.vo.PSASpecialContainerSaveVO;
 ...
 * @see EsmBkg0577Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0577HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_FMS_0577HTMLAction 객체를 생성
	 */
	public ESM_BKG_0577HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0577Event event = new EsmBkg0577Event();
		
		if(	 command.isCommand(FormCommand.SEARCH02) ) {
			
			event.setPsaDgListCondVO((PSADgListCondVO) getVO(request, PSADgListCondVO.class));
			...
			event.setPsaDgEdiVOs((PSADgEdiVO[]) getVOs(request, PSADgEdiVO.class)); 
