...
*@FileName : UnmatchBLDBDAOIranDthBKGListForAuditRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOIranDthBKGListForAuditRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * IranDthBKGListForAuditVO
	  * </pre>
	  */
	public UnmatchBLDBDAOIranDthBKGListForAuditRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOIranDthBKGListForAuditRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND B.POD_CD LIKE 'IR%')" ).append("\n"); 
