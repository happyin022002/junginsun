...
*@FileName : RFARateProposalDBDAORsltPriSurchargeAdjustListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPriSurchargeAdjustListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPriSurchargeAdjustListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPriSurchargeAdjustListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_rp_scp_scg_adj" ).append("\n"); 
