...
*@FileName : SCRateQuotationDBDAOPriSqRtAdjustUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtAdjustUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtAdjustUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtAdjustUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("	) ," ).append("\n"); 
		query.append("	VW_ORI_SQ_RT_ROUT_PNT AS (" ).append("\n"); 
		...
		query.append("	)," ).append("\n"); 
		query.append("	VW_DEST_SQ_RT_ROUT_PNT AS (" ).append("\n"); 
		query.append("		SELECT" ).append("\n"); 
		query.append("			QTTN_NO" ).append("\n"); 
		query.append("			, QTTN_VER_NO" ).append("\n"); 
		query.append("			, GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("	)," ).append("\n"); 
		query.append("	VW_ORI_SQ_RT_ROUT_VIA AS (" ).append("\n"); 
		query.append("		SELECT" ).append("\n"); 
		query.append("			QTTN_NO" ).append("\n"); 
		query.append("			, QTTN_VER_NO" ).append("\n"); 
		query.append("			, GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("		AND ORG_DEST_TP_CD = 'O'" ).append("\n"); 
		query.append("	)," ).append("\n"); 
		query.append("	VW_DEST_SQ_RT_ROUT_VIA AS (" ).append("\n"); 
		query.append("		SELECT" ).append("\n"); 
		query.append("			QTTN_NO" ).append("\n"); 
		query.append("			, QTTN_VER_NO" ).append("\n"); 
		query.append("			, GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("			, PRI_SQ_RT_CMDT_ROUT MN" ).append("\n"); 
		query.append("			, VW_ORI_SQ_RT_ROUT_PNT VM_ORI_PNT" ).append("\n"); 
		query.append("			, VW_DEST_SQ_RT_ROUT_PNT VM_DEST_PNT" ).append("\n"); 
		query.append("			, VW_ORI_SQ_RT_ROUT_VIA VM_ORI_VIA" ).append("\n"); 
		query.append("			, VW_DEST_SQ_RT_ROUT_VIA VM_DEST_VIA" ).append("\n"); 
		...
		query.append("			AND MN.GEN_SPCL_RT_TP_CD = VW_RATE.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("			AND MN.GEN_SPCL_RT_TP_CD = VM_ORI_PNT.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("			AND MN.GEN_SPCL_RT_TP_CD = VM_DEST_PNT.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("			AND MN.GEN_SPCL_RT_TP_CD = VM_ORI_VIA.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("			AND MN.GEN_SPCL_RT_TP_CD = VM_DEST_VIA.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("							AND EX.GEN_SPCL_RT_TP_CD = RT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
