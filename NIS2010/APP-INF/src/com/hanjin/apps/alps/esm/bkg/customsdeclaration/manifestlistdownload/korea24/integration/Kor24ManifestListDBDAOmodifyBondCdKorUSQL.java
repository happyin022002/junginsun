...
*@FileName : Kor24ManifestListDBDAOmodifyBondCdKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyBondCdKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyBondCdKorUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyBondCdKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
