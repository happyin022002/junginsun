...
*@FileName : RFARateProposalDBDAOModifyProposalScopeRateGRICancelForAddOnTariffUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOModifyProposalScopeRateGRICancelForAddOnTariffUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rate Calcurate Cancel처리
	  * </pre>
	  */
	public RFARateProposalDBDAOModifyProposalScopeRateGRICancelForAddOnTariffUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOModifyProposalScopeRateGRICancelForAddOnTariffUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
