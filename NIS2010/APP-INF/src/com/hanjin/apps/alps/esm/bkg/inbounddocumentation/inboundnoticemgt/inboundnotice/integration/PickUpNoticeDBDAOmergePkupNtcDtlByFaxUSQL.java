...
*@FileName : PickUpNoticeDBDAOmergePkupNtcDtlByFaxUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PickUpNoticeDBDAOmergePkupNtcDtlByFaxUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PickUpNoticeDBDAOmergePkupNtcDtlByFaxUSQL(){
		setQuery();
		...
		query.append("FileName : PickUpNoticeDBDAOmergePkupNtcDtlByFaxUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[fax_snd_usr_id] AS FAX_SND_USR_ID" ).append("\n"); 
		...
		query.append(",	FAX_TP_CD      = 'M'" ).append("\n"); 
		query.append(",	FAX_SND_DT     = NULL" ).append("\n"); 
		query.append(",	FAX_SND_GDT    = NULL" ).append("\n"); 
		query.append(",	FAX_SND_USR_ID = B.FAX_SND_USR_ID" ).append("\n"); 
		query.append(",	UPD_USR_ID     = B.UPD_USR_ID" ).append("\n"); 
		query.append(",	UPD_DT         = SYSDATE" ).append("\n"); 
		query.append("WHERE B.FAX_NO IS NOT NULL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(",NULL" ).append("\n"); 
		query.append(",B.FAX_SND_USR_ID" ).append("\n"); 
		query.append(",NULL" ).append("\n"); 
		query.append(",NULL" ).append("\n"); 
		query.append(",NULL" ).append("\n"); 
		query.append(",NULL" ).append("\n"); 
