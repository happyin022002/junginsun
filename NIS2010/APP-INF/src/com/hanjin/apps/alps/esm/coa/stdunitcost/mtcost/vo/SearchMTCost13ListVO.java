...
*@FileName : SearchMTCost13ListVO.java
*@FileTitle : SearchMTCost13ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost13ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost13ListVO> models = new ArrayList<SearchMTCost13ListVO>();
...
/**
	 ...
	 */
	public SearchMTCost13ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost13ListVO[]
	 */
	public SearchMTCost13ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost13ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCost13ListVO();
				if (eqStatus[i] != null)
		...
		return getSearchMTCost13ListVOs();
	}
	 ...
	 * @return SearchMTCost13ListVO[]
	 */
	public SearchMTCost13ListVO[] getSearchMTCost13ListVOs(){
		SearchMTCost13ListVO[] vos = (SearchMTCost13ListVO[])models.toArray(new SearchMTCost13ListVO[models.size()]);
		return vos;
	}
