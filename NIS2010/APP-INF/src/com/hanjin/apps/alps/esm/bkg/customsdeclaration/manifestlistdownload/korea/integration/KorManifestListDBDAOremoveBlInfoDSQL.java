...
*@FileName : KorManifestListDBDAOremoveBlInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOremoveBlInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOremoveBlInfoDSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOremoveBlInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_KR_BL" ).append("\n"); 
		...
		query.append("AND ((@[in_type] = 'D' AND KT.KR_CSTMS_BND_CD IN ('A','B','C','M')) OR (@[in_type] <> 'D' AND KT.KR_CSTMS_BND_CD = @[in_type]))" ).append("\n"); 
		...
		query.append("GROUP   BY  KT.BKG_NO, KT.CSTMS_DECL_TP_CD, DMST_PORT_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
