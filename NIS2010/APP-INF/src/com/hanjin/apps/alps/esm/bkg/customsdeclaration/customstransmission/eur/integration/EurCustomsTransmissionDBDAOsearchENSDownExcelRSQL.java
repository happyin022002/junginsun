...
public class EurCustomsTransmissionDBDAOsearchENSDownExcelRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            WHERE BL_NO = T.BKG_NO" ).append("\n"); 
		...
		query.append("             AND EUR.VSL_CD(+) = VVD.VSL_CD" ).append("\n"); 
		query.append("             AND EUR.SKD_VOY_NO(+) = VVD.SKD_VOY_NO" ).append("\n"); 
		query.append("             AND EUR.SKD_DIR_CD(+) = VVD.SKD_DIR_CD" ).append("\n"); 
		query.append("             AND EUR.BL_NO(+) = VVD.BKG_NO" ).append("\n"); 
		query.append("             AND EUR.CSTMS_PORT_CD(+) = VVD.POL_CD" ).append("\n"); 
