...
*@FileName : ESM_BKG_0425HTMLAction.java
...
public class ESM_BKG_0425HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0425HTMLAction 객체를 생성
	 */
	public ESM_BKG_0425HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0425Event event = new EsmBkg0425Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgEmlAcctStupVOS((BkgEmlAcctStupVO[])getVOs(request, BkgEmlAcctStupVO .class,""));
		}
		event.setBkgEmlAcctStupVO((BkgEmlAcctStupVO)getVO(request, BkgEmlAcctStupVO .class));
