...
public class JapanCustomsTransmissionDBDAOsearchJapanPODInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DECODE(L1.ATTR_CTNT2, NULL, DECODE(SUBSTR(L2.LOC_CD,1,2),'AW','AN','CS','CB','EU','ZY','KZ','KA','LI','ZY','RU','RS','TJ','TA','UA','UK','UZ','UB','YU','YE', SUBSTR(L2.LOC_CD,1,2))||'ZZZ',L1.ATTR_CTNT2) POD" ).append("\n"); 
		query.append("FROM BKG_CSTMS_CD_CONV_CTNT L1, MDM_LOCATION L2" ).append("\n"); 
