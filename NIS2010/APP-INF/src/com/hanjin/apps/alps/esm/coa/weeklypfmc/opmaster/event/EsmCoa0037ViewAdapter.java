...
*@FileName : EsmCoa0037ViewAdapter.java
*@FileTitle : EsmCoa0037ViewAdapter
*Open Issues :
*Change history :
...
* 2009.07.14 김기대 
* 1.0 Creation
* 2011.01.26 최윤성 [CHM-201108537-01] Create VSL Table 수정
*  - OPR, OPR2 동적 메소드 적용
=========================================================*/
...
/**
 * ESM_COA_0037 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0037ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0037ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(DBRowSet rs, String prefix){
    	...
    	try{
    		opr  = commonBc.getCodeCombo("vsl_oshp_cd", "VslOwner", "HJS", "code"); 
    	...
    	try{
		    ...
		    if(totCnt > 0){
		    		while(rs.next()){
		    			int i=6;	// 5개 항목은 직접 append 했으므로 6 부터.
...
//    					strBuilder.append("	<TD>R</TD>");
    					...
    					strBuilder.append("	<TD><![CDATA["+JSPUtil.getNull(rs.getString("STATUS"))+"]]></TD>");
		    			...
		    			for (int j = 5 ; j < rs.getMetaData().getColumnCount() ; j++) {
