...
*@FileName : CstPriSpAfilVO.java
*@FileTitle : CstPriSpAfilVO
*Open Issues :
*Change history :
...
public class CstPriSpAfilVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpAfilVO> models = new ArrayList<CstPriSpAfilVO>();
	...
	public CstPriSpAfilVO() {}

	public CstPriSpAfilVO(String ibflag, String pagerows, String prcProgStsCd, String acptUsrId, String acptOfcCd, String acptDt, String updUsrId, String updDt, String propNo, String amdtSeq, String stsCd, String effDt) {
		this.stsCd = stsCd;
		this.updDt = updDt;
	 ...
	 */
	public CstPriSpAfilVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpAfilVO[]
	 */
	public CstPriSpAfilVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpAfilVO model = null;
	 ...
	 * @return CstPriSpAfilVO[]
	 */
	public CstPriSpAfilVO[] getCstPriSpAfilVOs(){
		CstPriSpAfilVO[] vos = (CstPriSpAfilVO[])models.toArray(new CstPriSpAfilVO[models.size()]);
		return vos;
	}
