...
*@FileName : Kor24ManifestListDBDAOsearchCustTypeRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchCustTypeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchCustTypeRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchCustTypeRSQL").append("\n");
		query.append("*/").append("\n");
	}
