...
*@FileName : ArrNoticeDBDAOsearchPodListByVVDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ArrNoticeDBDAOsearchPodListByVVDRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ArrNoticeDBDAOsearchPodListByVVDRSQL(){
		setQuery();
		...
		query.append("FileName : ArrNoticeDBDAOsearchPodListByVVDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
