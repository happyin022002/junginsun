...
*@FileName : TRIProposalDBDAOPriTriRtScgCostDetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgCostDetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgCostDetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgCostDetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        MN.TRF_PFX_CD, " ).append("\n"); 
		query.append("        MN.TRF_NO, " ).append("\n"); 
		query.append("        RT.TRI_PROP_NO  AS PROP_NO    ," ).append("\n"); 
		query.append("        RT.AMDT_SEQ      ," ).append("\n"); 
		query.append("        RT.CURR_CD		," ).append("\n"); 
		query.append("        RT.PROP_FRT_RT_AMT  ," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        ( SELECT SVC_SCP_CD " ).append("\n"); 
		query.append("            FROM PRI_TARIFF A, PRI_SVC_SCP_TRF B " ).append("\n"); 
		query.append("           WHERE A.TRF_PFX_CD = MN.TRF_PFX_CD " ).append("\n"); 
		query.append("             AND A.TRF_NO = MN.TRF_NO " ).append("\n"); 
		query.append("             AND A.TRF_PFX_CD = B.TRF_PFX_CD " ).append("\n"); 
		query.append("             AND A.TRF_NO = B.TRF_NO " ).append("\n"); 
		query.append("             AND B.SVC_SCP_CD IN ( SELECT O.SVC_SCP_CD" ).append("\n"); 
		query.append("                                      FROM MDM_SVC_SCP_LMT O,  MDM_SVC_SCP_LMT D" ).append("\n"); 
		query.append("                                     WHERE O.RGN_CD = ( SELECT RGN_CD FROM MDM_LOCATION WHERE LOC_CD = RC.POR_CD )" ).append("\n"); 
		query.append("                                       AND O.ORG_DEST_CD = 'O'" ).append("\n"); 
		query.append("                                       AND O.SVC_SCP_IND_FLG = 'Y'" ).append("\n"); 
		query.append("                                       AND D.RGN_CD = ( SELECT RGN_CD FROM MDM_LOCATION WHERE LOC_CD = RC.DEL_CD )" ).append("\n"); 
		query.append("                                       AND D.ORG_DEST_CD = 'D'" ).append("\n"); 
		query.append("                                       AND D.SVC_SCP_IND_FLG = 'Y'   " ).append("\n"); 
		query.append("                                       AND O.SVC_SCP_CD = D.SVC_SCP_CD" ).append("\n"); 
		query.append("                                  )  " ).append("\n"); 
		query.append("             AND ROWNUM = 1  ) AS SVC_SCP_CD ," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("            PRI_TRI_RT_USD_ROUT_CS   RR  ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("    WHERE MN.TRI_PROP_NO        = RT.TRI_PROP_NO " ).append("\n"); 
		query.append("    AND   RR.TRI_PROP_NO         = RT.TRI_PROP_NO" ).append("\n"); 
		...
		query.append("    AND   RT.TRI_PROP_NO   = @[tri_prop_no]" ).append("\n"); 
		...
		query.append("	WHERE	RT.TRI_PROP_NO	= @[tri_prop_no]" ).append("\n"); 
		query.append("	AND     RT.AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("	AND		RT.PROP_STS_CD	IN ( 'I', 'R' )" ).append("\n"); 
		query.append("	AND		NC.TRI_PROP_NO	= RT.TRI_PROP_NO" ).append("\n"); 
		query.append("	AND		NC.AMDT_SEQ		= RT.AMDT_SEQ " ).append("\n"); 
		query.append("	AND     NC.NOTE_CONV_MAPG_ID = RT.NOTE_CONV_MAPG_ID" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("--	SELECT	NC.*" ).append("\n"); 
		query.append("--	FROM	PRI_TAA_TRI_LIST	TL	," ).append("\n"); 
		query.append("--			PRI_TRI_RT			RT	," ).append("\n"); 
		query.append("--			PRI_TRI_NOTE_CONV	NC" ).append("\n"); 
		query.append("--	WHERE	RT.TRI_PROP_NO	= TL.TRI_PROP_NO" ).append("\n"); 
		query.append("---- 2010.02.24 NOTE 는 날짜 의미 없음. ( 김진철 과장 )" ).append("\n"); 
		query.append("----	AND		TO_DATE(SYSDATE)BETWEEN RT.EFF_DT AND RT.EXP_DT + 0.99999		/* 0.99999 는 23시 59분 59초를 의미 */" ).append("\n"); 
		query.append("--	AND		RT.PROP_STS_CD	IN ( 'I', 'R' )" ).append("\n"); 
		query.append("--	AND		NC.TRI_PROP_NO	= RT.TRI_PROP_NO" ).append("\n"); 
		query.append("--	AND		NC.AMDT_SEQ		= RT.AMDT_SEQ    " ).append("\n"); 
		query.append("---- 2010.02.24 NOTE 는 날짜 의미 없음. ( 김진철 과장 )" ).append("\n"); 
		...
		query.append("	SELECT	NC.*" ).append("\n"); 
		query.append("	FROM	PRI_SVC_SCP_TRF		ST	," ).append("\n"); 
		query.append("			PRI_TRI_NOTE		TN	," ).append("\n"); 
		query.append("			PRI_TRI_NOTE_CONV	NC" ).append("\n"); 
		query.append("	WHERE	TN.TRF_PFX_CD	= ST.TRF_PFX_CD" ).append("\n"); 
		query.append("	AND		TN.TRF_NO		= ST.TRF_NO" ).append("\n"); 
		query.append("	AND     ST.SVC_SCP_CD   = ( SELECT SVC_SCP_CD FROM BQ WHERE ROWNUM = 1 ) " ).append("\n"); 
		query.append("-- 2010.02.24 NOTE 는 날짜 의미 없음. ( 김진철 과장 )" ).append("\n"); 
		query.append("--	AND		TO_DATE(SYSDATE)BETWEEN TN.EFF_DT AND TN.EXP_DT + 0.99999		/* 0.99999 는 23시 59분 59초를 의미 */" ).append("\n"); 
		...
		query.append("	OR	NC.TRI_PROP_NO	= BQ.PROP_NO" ).append("\n"); 
		query.append("		)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("        DECODE(C_NOT.RT_APPL_TP_CD, 'I', 'Y', DECODE(C.RT_APPL_TP_CD, 'I', 'Y', 'N'))	RT_INCL_FLG		," ).append("\n"); 
		...
		query.append("		AND	C1.CHG_CD			NOT IN ( 'WHF', 'AST', 'GST', 'VDT', 'VTT', 'GRI' )" ).append("\n"); 
		query.append("		)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(") ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("        DECODE(C_NOT.RT_APPL_TP_CD, 'I', 'I', 'N' ) RT_INCL_FLG  ," ).append("\n"); 
		query.append("        DECODE(C_NOT.BKG_CONV_TP_CD, 'C', 'Y', 'N') NOT_RULE_FLG" ).append("\n"); 
		query.append("    FROM  BQ         ," ).append("\n"); 
		query.append("        PRI_SCG_PRF  SP  ," ).append("\n"); 
		query.append("        MDM_CHARGE  MC  ," ).append("\n"); 
		...
		query.append("                              WHERE TRI_PROP_NO = BQ.PROP_NO" ).append("\n"); 
		...
		query.append("    RT_INCL_FLG" ).append("\n"); 
		query.append("FROM  C1" ).append("\n"); 
		query.append("WHERE  RT_APPL_TP_CD  = 'F' /* Fixed Amount */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*******************************************************************************************" ).append("\n"); 
		...
		query.append("      AND SG.CHG_CD NOT IN ( 'WHF', 'AST', 'GST', 'VDT', 'VTT', 'GRI' )" ).append("\n"); 
		query.append("      )" ).append("\n"); 
		query.append(") ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT FN.PROP_NO   AS PROP_NO," ).append("\n"); 
		...
		query.append("            OR F2.CHG_CD  IN ( DECODE(F1.POR_CNT_CD, 'VN', 'OTH'), DECODE(F1.POR_CNT_CD, 'VN', 'ORC'), DECODE(F1.DEL_CNT_CD, 'VN', 'DTH'), DECODE(F1.DEL_CNT_CD, 'VN', 'DDC') )" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		...
		query.append("AND   FN.CHG_CD NOT IN ( 'GRI', 'GOH', 'WHF', 'GST', 'AST', 'VDT', 'VTT')" ).append("\n"); 
		...
		query.append("ON (    A.TRI_PROP_NO = B.PROP_NO" ).append("\n"); 
		...
		query.append("    (A.TRI_PROP_NO, A.AMDT_SEQ, " ).append("\n"); 
		...
		query.append("    (B.PROP_NO, B.AMDT_SEQ, " ).append("\n"); 
