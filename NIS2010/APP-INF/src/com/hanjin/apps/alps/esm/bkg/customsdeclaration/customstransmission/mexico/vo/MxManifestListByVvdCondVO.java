...
public class MxManifestListByVvdCondVO extends AbstractValueObject {
	...
	public MxManifestListByVvdCondVO(String ibflag, String pagerows, String vvd, String podCd, String polCd, String searchFlg, String tmp1, String tmp2, String tmp3, String searchCargo) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.tmp2 = tmp2;
		this.polCd = polCd;
