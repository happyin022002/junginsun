...
*@FileName : FICCostInterfaceDBDAOCheckCopyServiceScopeEffdtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCheckCopyServiceScopeEffdtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * check exist IHC tariff's effective date
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCheckCopyServiceScopeEffdtRSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCheckCopyServiceScopeEffdtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
