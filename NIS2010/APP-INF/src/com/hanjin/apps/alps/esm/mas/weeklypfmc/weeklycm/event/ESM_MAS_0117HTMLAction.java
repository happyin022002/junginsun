...
public class ESM_MAS_0117HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0117HTMLAction 객체를 생성
	 */
	public ESM_MAS_0117HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0117Event event = new EsmMas0117Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMasSltMgmtUtVOS((MasSltMgmtUtVO[])getVOs(request, MasSltMgmtUtVO .class,""));
		}
