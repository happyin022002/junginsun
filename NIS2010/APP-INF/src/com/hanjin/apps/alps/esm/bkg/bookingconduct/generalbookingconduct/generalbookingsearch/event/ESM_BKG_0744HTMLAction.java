...
*@FileName : ESM_BKG_0744HTMLAction.java
...
public class ESM_BKG_0744HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0744HTMLAction 객체를 생성
	 */
	public ESM_BKG_0744HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0744Event event = new EsmBkg0744Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setBkgBlNoVO((BkgBlNoVO)getVO(request, BkgBlNoVO .class));
			event.setHblCountVO((HblCountVO)getVO(request, HblCountVO .class));
			event.setBkgUsaCstmsFileNoVOs((BkgUsaCstmsFileNoVO[])getVOs(request, BkgUsaCstmsFileNoVO.class, ""));
		}
