...
*@FileTitle : <Kor24CntrCntVO.java
*@FileTitle : Kor24CntrCntVO
*Open Issues :
*Change history :
...
public class Kor24CntrCntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CntrCntVO> models = new ArrayList<Kor24CntrCntVO>();
	...
	public Kor24CntrCntVO() {}

	public Kor24CntrCntVO(String ibflag, String pagerows, String teuCnt, String feuCnt, String bkgNo, String cstmsDeclTpCd, String portCd) {
		this.teuCnt = teuCnt;
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 */
	public Kor24CntrCntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24CntrCntVO[]
	 */
	public Kor24CntrCntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CntrCntVO model = null;
	 ...
	 * @return Kor24CntrCntVO[]
	 */
	public Kor24CntrCntVO[] getKor24CntrCntVOs(){
		Kor24CntrCntVO[] vos = (Kor24CntrCntVO[])models.toArray(new Kor24CntrCntVO[models.size()]);
		return vos;
	}
