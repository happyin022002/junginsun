...
*@FileName : OPCostDBDAOStndUtCostDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPCostDBDAOStndUtCostDtlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPCostDBDAOStndUtCostDtlUSQL(){
		setQuery();
		...
		params.put("fnl_ttl_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : OPCostDBDAOStndUtCostDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_STND_UT_COST_DTL" ).append("\n"); 
		query.append("   SET FNL_TTL_AMT = @[fnl_ttl_amt]" ).append("\n"); 
		query.append("     , TGT_LOD_QTY = @[tgt_lod_qty]" ).append("\n"); 
