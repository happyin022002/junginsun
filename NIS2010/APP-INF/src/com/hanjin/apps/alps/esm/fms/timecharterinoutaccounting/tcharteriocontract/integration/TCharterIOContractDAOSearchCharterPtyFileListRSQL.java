...
*@FileName : TCharterIOContractDAOSearchCharterPtyFileListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOContractDAOSearchCharterPtyFileListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOSearchCharterPtyFileListRSQL
	  * </pre>
	  */
	public TCharterIOContractDAOSearchCharterPtyFileListRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOContractDAOSearchCharterPtyFileListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
