...
public class TCharterIOInquiryDBDAOFmsContractRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("CASE WHEN AA.OWNR_SEQ IS NULL THEN" ).append("\n"); 
		query.append("DECODE(BB.OWNR_NM,NULL,CC.OWNR_NM,BB.OWNR_NM)" ).append("\n"); 
		query.append("ELSE" ).append("\n"); 
		query.append("(SELECT FO.OWNR_NM" ).append("\n"); 
		query.append("FROM FMS_OWNER FO" ).append("\n"); 
		query.append("WHERE AA.OWNR_SEQ = FO.OWNR_SEQ" ).append("\n"); 
		query.append("AND ROWNUM =1)" ).append("\n"); 
		query.append("END OWNR_NM," ).append("\n"); 
		query.append("CASE WHEN AA.OWNR_SEQ IS NULL THEN" ).append("\n"); 
		query.append("DECODE(BB.OWNR_SEQ,NULL,CC.OWNR_SEQ,BB.OWNR_SEQ)" ).append("\n"); 
		query.append("ELSE" ).append("\n"); 
		query.append("AA.OWNR_SEQ" ).append("\n"); 
		query.append("END OWNR_SEQ," ).append("\n"); 
