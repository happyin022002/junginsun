...
public class ESM_BKG_1143HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1143HTMLAction 객체를 생성
	 */
	public ESM_BKG_1143HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1143Event event = new EsmBkg1143Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgCroChkListinVO((BkgCroChkListinVO)getVO(request, BkgCroChkListinVO .class));
		}
