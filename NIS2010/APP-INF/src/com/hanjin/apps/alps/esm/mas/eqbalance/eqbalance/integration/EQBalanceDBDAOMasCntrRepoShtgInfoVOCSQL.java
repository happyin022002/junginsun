...
*@FileName : EQBalanceDBDAOMasCntrRepoShtgInfoVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOMasCntrRepoShtgInfoVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * * 2012.03.22 김종준 [CHM-201217091-01] EMU 관련 로직 보완/변경 검토 요청의 건 - MAS_CNTR_REPO_SHTG_INFO 테이블의 인서트
	  * </pre>
	  */
	public EQBalanceDBDAOMasCntrRepoShtgInfoVOCSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOMasCntrRepoShtgInfoVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_CNTR_REPO_SHTG_INFO" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("	   ,@[ecc_cd]" ).append("\n"); 
		query.append("	   ,(SELECT DISTINCT LCC_CD FROM MAS_LOCATION_V WHERE ECC_CD =@[ecc_cd] )" ).append("\n"); 
		query.append("	   ,(SELECT DISTINCT RCC_CD FROM MAS_LOCATION_V WHERE ECC_CD =@[ecc_cd] )" ).append("\n"); 
