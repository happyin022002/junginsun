...
*@FileName : SCReportDBDAOPriMofMapgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAOPriMofMapgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCReportDBDAOPriMofMapgVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAOPriMofMapgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_MOF_MAPG " ).append("\n"); 
		query.append("    SET MOF_ID = @[mof_id]" ).append("\n"); 
		query.append("      , HJS_ID = @[hjs_id]" ).append("\n"); 
		query.append("      , MAPG_RMK = @[mapg_rmk]" ).append("\n"); 
