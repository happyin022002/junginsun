...
*@FileName : ESM_MAS_0073HTMLAction.java
 ...
 *
 * @author KimJongBeom
 * @see EsmMas0073Event , ESM_MAS_0073EventResponse 참조
 * @since J2EE 1.4
 */ 

public class ESM_MAS_0073HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_MAS_072Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0073Event event = new EsmMas0073Event();
