...
*@FileName : ESM_BKG_9462HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_9462HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9462HTMLAction 객체를 생성
	 */
	public ESM_BKG_9462HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9462Event event = new EsmBkg9462Event();
