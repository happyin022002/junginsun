...
*@FileName : RevenueDebitNoteDBDAOBkgRevDrNoteProgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOBkgRevDrNoteProgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrNoteProgVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE BKG_REV_DR_NOTE_PROG SET" ).append("\n"); 
		query.append("RDN_RMK = @[rdn_rmk]" ).append("\n"); 
		...
		query.append("WHERE  RDN_NO = @[rdn_no]" ).append("\n"); 
		query.append("AND	   RVIS_SEQ = @[rvis_seq]" ).append("\n"); 
		query.append("AND    RDN_STS_CD = @[rdn_sts_cd])" ).append("\n"); 

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.nis2010.esm.bkg.revenueaudit.revenuedebitnote.integration").append("\n"); 
		query.append("FileName : RevenueDebitNoteDBDAOBkgRevDrNoteProgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}