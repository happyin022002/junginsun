...
*@FileName : ESM_COA_054HTMLAction.java
 ...
 *
 * @author Park Eun Ju
 * @see EsmCoa0054Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_0054HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0054HTMLAction 객체를 생성
	 */
	public ESM_COA_0054HTMLAction() {
		//
	}
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_COA_056Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0054Event event = new EsmCoa0054Event();
