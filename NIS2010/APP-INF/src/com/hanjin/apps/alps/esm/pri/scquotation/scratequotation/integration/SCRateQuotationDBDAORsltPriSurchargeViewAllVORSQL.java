...
*@FileName : SCRateQuotationDBDAORsltPriSurchargeViewAllVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriSurchargeViewAllVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriSurchargeViewAllVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriSurchargeViewAllVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,DECODE(A.GEN_SPCL_RT_TP_CD,'G','Y','N') AS G_GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("	,DECODE(A.GEN_SPCL_RT_TP_CD,'S','Y','N') AS S_GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("	" ).append("\n"); 
		query.append("	, DECODE(A.DIR_CALL_FLG,'Y','YES','NO') AS DIR_CALL_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	, DENSE_RANK() OVER (PARTITION BY A.QTTN_NO, A.QTTN_VER_NO ORDER BY A.QTTN_NO, A.QTTN_VER_NO,A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ ) AS SEQ" ).append("\n"); 
		query.append("  FROM PRI_SQ_RT_CMDT_ROUT A" ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		...
		query.append("			      ,ROW_NUMBER() OVER(PARTITION BY QTTN_NO, QTTN_VER_NO,GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD ORDER BY QTTN_NO, QTTN_VER_NO,GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD, DECODE(ROUT_PNT_LOC_TP_CD, 'G', '1', 'L', '2'), ROUT_PNT_LOC_DEF_CD) AS RN" ).append("\n"); 
		...
		query.append("			      ,SRC_INFO_CD" ).append("\n"); 
		query.append("			      ,ROW_NUMBER() OVER(PARTITION BY QTTN_NO, QTTN_VER_NO,GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD ORDER BY QTTN_NO, QTTN_VER_NO,GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, ORG_DEST_TP_CD, DECODE(ROUT_VIA_PORT_TP_CD, 'G', '1', 'L', '2'), ROUT_VIA_PORT_DEF_CD) AS RN" ).append("\n"); 
		...
		query.append("			      ,SRC_INFO_CD" ).append("\n"); 
		query.append("			      ,ROW_NUMBER() OVER(PARTITION BY QTTN_NO, QTTN_VER_NO,GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ ORDER BY QTTN_NO, QTTN_VER_NO, GEN_SPCL_RT_TP_CD,CMDT_HDR_SEQ, DECODE(PRC_CMDT_TP_CD, 'G', '1', 'C', '2'), PRC_CMDT_DEF_CD) AS RN" ).append("\n"); 
		...
		query.append("      , (" ).append("\n"); 
		query.append("		SELECT 	PRI_ROUT.QTTN_NO, PRI_ROUT.QTTN_VER_NO,PRI_ROUT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("			, SUM( PRI_SCG.ADJ_SCG_USD_AMT ) OVER( PARTITION BY PRI_ROUT.QTTN_NO, PRI_ROUT.QTTN_VER_NO,PRI_ROUT.GEN_SPCL_RT_TP_CD, PRI_ROUT.CMDT_HDR_SEQ, PRI_ROUT.ROUT_SEQ, PRI_ROUT.RT_SEQ ) AS TOT_SURCHARGE" ).append("\n"); 
		query.append("		FROM PRI_SQ_RT_SCG_ROUT PRI_ROUT" ).append("\n"); 
		query.append("			, PRI_SQ_RT_SCG PRI_SCG" ).append("\n"); 
		...
		query.append("			AND PRI_ROUT.GEN_SPCL_RT_TP_CD = PRI_SCG.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("#if( ${gen_spcl_rt_tp_cd} != 'B'   )" ).append("\n"); 
		query.append("		    AND PRI_ROUT.GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd]" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("      ) SCG" ).append("\n"); 
		query.append("      , PRI_SQ_RT RT" ).append("\n"); 
		query.append(" WHERE  I.QTTN_NO = A.QTTN_NO" ).append("\n"); 
		query.append("	AND I.QTTN_VER_NO = A.QTTN_VER_NO" ).append("\n"); 
		query.append("	AND I.GEN_SPCL_RT_TP_CD = A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("	AND A.GEN_SPCL_RT_TP_CD = RT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("#end " ).append("\n"); 
		query.append(" ORDER BY  A.QTTN_NO, A.QTTN_VER_NO,A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ" ).append("\n"); 
