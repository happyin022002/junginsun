...
*@FileName : ESM_BKG_0913HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.bkg.outbounddocumentation.outboundblmgtsc 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_BKG_0913HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0913HTMLAction 객체를 생성
	 */
	public ESM_BKG_0913HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EsmBkg0913Event event = new EsmBkg0913Event();
