...
public class BookingMasterMgtDBDAOBkgEdiGrpCustUSQL implements ISQLTemplate{
	...
	public BookingMasterMgtDBDAOBkgEdiGrpCustUSQL(){
		...
		params.put("bkg_cust_tp_desc",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bl_drft_auto_once_snd_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ulti_trns_cust_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bl_drft_auto_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ulti_new_asia_cust_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("			   NVL(@[bkg_cust_tp_desc],'ALL') AS BKG_CUST_TP_DESC," ).append("\n"); 
		query.append("			   NVL(@[bl_drft_auto_dys],'0') AS BL_DRFT_AUTO_DYS," ).append("\n"); 
		query.append("               @[bl_drft_auto_once_snd_flg] AS BL_DRFT_AUTO_ONCE_SND_FLG," ).append("\n"); 
		query.append("			   nvl(@[ulti_new_asia_cust_flg], '0') as ulti_new_asia_cust_flg," ).append("\n"); 
		query.append("			   nvl(@[ulti_trns_cust_flg], '0') as ulti_trns_cust_flg" ).append("\n"); 
		...
		query.append("             BL_DRFT_AUTO_DYS          = TB.BL_DRFT_AUTO_DYS," ).append("\n"); 
		query.append("             BL_DRFT_AUTO_ONCE_SND_FLG = DECODE(TB.BL_DRFT_AUTO_ONCE_SND_FLG,'1','Y','Y','Y','N')," ).append("\n"); 
		...
		query.append("			 BKG_CUST_TP_DESC          = TB.BKG_CUST_TP_DESC," ).append("\n"); 
		query.append("		     ulti_new_asia_cust_flg    = decode(TB.ulti_new_asia_cust_flg, 1, 'Y', 0, 'N', 'N')," ).append("\n"); 
		query.append("             ulti_trns_cust_flg    	   = decode(TB.ulti_trns_cust_flg, 1, 'Y', 0, 'N', 'N')" ).append("\n"); 
		...
		query.append("			   BL_DRFT_AUTO_DYS," ).append("\n"); 
		query.append("               BL_DRFT_AUTO_ONCE_SND_FLG," ).append("\n"); 
		...
		query.append("				ulti_new_asia_cust_flg," ).append("\n"); 
		query.append("				ulti_trns_cust_flg)" ).append("\n"); 
		...
		query.append("               TB.BL_DRFT_AUTO_DYS," ).append("\n"); 
		query.append("               DECODE(TB.BL_DRFT_AUTO_ONCE_SND_FLG,'1','Y','Y','Y','N')," ).append("\n"); 
		...
		query.append("               TB.BKG_CUST_TP_DESC," ).append("\n"); 
		query.append("				TB.ulti_new_asia_cust_flg," ).append("\n"); 
		query.append("				TB.ulti_trns_cust_flg )" ).append("\n"); 
