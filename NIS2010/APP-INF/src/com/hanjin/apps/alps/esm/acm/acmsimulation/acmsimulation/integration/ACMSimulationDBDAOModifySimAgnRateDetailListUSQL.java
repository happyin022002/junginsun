...
*@FileName : ACMSimulationDBDAOModifySimAgnRateDetailListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOModifySimAgnRateDetailListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySimAgnRateDetail
	  * </pre>
	  */
	public ACMSimulationDBDAOModifySimAgnRateDetailListUSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOModifySimAgnRateDetailListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE ACM_SIM_AGMT_DTL" ).append("\n"); 
