 ...
 *@FileName : ESM_PRI_7014HTMLAction.java
...
public class ESM_PRI_7014HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7014Event event = new EsmPri7014Event();

		if (command.isCommand(FormCommand.MULTI)) {
			event.setIHCDetailVO((IHCDetailVO) getVO(request, IHCDetailVO.class));
			event.setPriTrfIHCRtVOs((PriTrfIHCRtVO[])getVOs(request, PriTrfIHCRtVO.class,""));
