...
*@FileName : SurchargeDBDAOPriScgRqstRtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeDBDAOPriScgRqstRtVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * (ESM_PRI_4003)PRI_SCG_RQST_RT 테이블 조회. (PRI_SCG_RT과 비교하기 위함)
	  * </pre>
	  */
	public SurchargeDBDAOPriScgRqstRtVORSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeDBDAOPriScgRqstRtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , A.SCG_RQST_SEQ" ).append("\n"); 
		query.append("	 , A.SCG_RQST_STS_CD" ).append("\n"); 
		query.append("	 , A.SCG_RQST_PROC_CD" ).append("\n"); 
		...
		query.append("             , A.SCG_SEQ" ).append("\n"); 
		query.append("      ) B" ).append("\n"); 
		query.append("     , PRI_SCG_RT DD" ).append("\n"); 
		query.append(" WHERE 1=1" ).append("\n"); 
		query.append("   AND A.SVC_SCP_CD  = B.SVC_SCP_CD " ).append("\n"); 
		query.append("   AND A.CHG_CD = B.CHG_CD" ).append("\n"); 
		query.append("   AND A.SCG_SEQ = B.SCG_SEQ" ).append("\n"); 
		query.append("   AND A.SCG_RQST_SEQ = B.SCG_RQST_SEQ" ).append("\n"); 
		query.append("   AND DD.SVC_SCP_CD  = B.SVC_SCP_CD " ).append("\n"); 
		query.append("   AND DD.CHG_CD = B.CHG_CD" ).append("\n"); 
		query.append("   AND DD.SCG_SEQ = B.SCG_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("   AND DD.SVC_SCP_CD IN (SELECT SVC_SCP_CD FROM PRI_SCG_TRD_SVC_SCP_MAPG WHERE TRD_CD = @[trd_cd])" ).append("\n"); 
		query.append("   AND DD.CHG_CD = @[chg_cd]" ).append("\n"); 
		query.append("   AND DD.CHG_CD = F.CHG_CD" ).append("\n"); 
		query.append("#if (${svc_scp_cd} != '') " ).append("\n"); 
		query.append("   AND DD.SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${scg_seq} != '') " ).append("\n"); 
		query.append("   AND DD.SCG_SEQ = @[scg_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${por_def_cd} != '') " ).append("\n"); 
		query.append("   AND NVL(DD.POR_DEF_CD, 'NULL') = B.POR_DEF_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${pol_def_cd} != '') " ).append("\n"); 
		query.append("   AND NVL(DD.POL_DEF_CD, 'NULL') = C.POL_DEF_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${pod_def_cd} != '') " ).append("\n"); 
		query.append("   AND NVL(DD.POD_DEF_CD, 'NULL') = D.POD_DEF_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${del_def_cd} != '')" ).append("\n"); 
		query.append("   AND NVL(DD.DEL_DEF_CD, 'NULL') = E.DEL_DEF_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${scg_imdg_clss_cd} != '')" ).append("\n"); 
		query.append("   AND NVL(DD.SCG_IMDG_CLSS_CD, 'NULL') IN (@[scg_imdg_clss_cd], 'NULL')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${prc_cgo_tp_cd} != '')" ).append("\n"); 
		query.append("   AND	NVL(DD.PRC_CGO_TP_CD, 'NULL') IN (" ).append("\n"); 
		...
		query.append("   AND DD.SCG_RQST_PROC_CD = @[scg_rqst_proc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("   AND DD.DELT_FLG = 'N'" ).append("\n"); 
		query.append("" ).append("\n"); 
