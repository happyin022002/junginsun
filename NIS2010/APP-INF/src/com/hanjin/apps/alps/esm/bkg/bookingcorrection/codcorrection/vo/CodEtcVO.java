...
public class CodEtcVO extends AbstractValueObject {
	...
	/* Column Info */
	private String autoCodFlg = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("auto_cod_flg", getAutoCodFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("auto_cod_flg", "autoCodFlg");
	...
	public void setAutoCodFlg(String autoCodFlg) {
		this.autoCodFlg = autoCodFlg;
	}
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAutoCodFlg(JSPUtil.getParameter(request, prefix + "auto_cod_flg", ""));
	}
	...
	public CodEtcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] autoCodFlg = (JSPUtil.getParameter(request, prefix	+ "aut_cod_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (autoCodFlg[i] != null)
					model.setAutoCodFlg(autoCodFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.autoCodFlg = this.autoCodFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
