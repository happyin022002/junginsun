...
*@FileName : MTCostDBDAOSearchMTCost14ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCost14ListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCost14ListVORSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCost14ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
