...
*@FileName : ESM_SPC_0012HTMLAction.java
...
public class ESM_SPC_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0012HTMLAction 객체를 생성
	 */
	public ESM_SPC_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0012Event event = new EsmSpc0012Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSaqMdlCnstVOS((SaqMdlCnstVO[])getVOs(request, SaqMdlCnstVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchConstraintItemListVO((SearchConstraintItemListVO)getVO(request, SearchConstraintItemListVO .class));
		}
