...
public class CostStructureDBDAOMultiSoCodeSrcAcctCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MAS_COST_SRC_ACCT 테이블등록 (Register Cost Items)
	...
	public CostStructureDBDAOMultiSoCodeSrcAcctCSQL(){
		...
		params.put("mas_cost_src_prt_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("mas_cost_src_cd_nm",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_COST_SRC_ACCT A " ).append("\n"); 
		query.append("  USING (SELECT @[mas_cost_src_cd] AS MAS_COST_SRC_CD " ).append("\n"); 
		...
		query.append("            ,@[mas_cost_src_prt_cd] AS MAS_COST_SRC_PRT_CD " ).append("\n"); 
		...
		query.append("            ,@[mas_cost_src_cd_nm] AS MAS_COST_SRC_CD_NM " ).append("\n"); 
		...
		query.append("  ON (A.MAS_COST_SRC_CD = B.MAS_COST_SRC_CD) " ).append("\n"); 
		query.append("  WHEN NOT MATCHED THEN " ).append("\n"); 
		query.append("    INSERT (A.MAS_COST_SRC_CD" ).append("\n"); 
		query.append("          ,A.COST_ASS_BSE_CD" ).append("\n"); 
		query.append("          ,A.STND_COST_CD" ).append("\n"); 
		query.append("          ,A.SGRP_COST_CD" ).append("\n"); 
		query.append("          ,A.MAS_COST_SRC_PRT_CD " ).append("\n"); 
		...
		query.append("          ,A.MAS_COST_SRC_CD_NM " ).append("\n"); 
		...
		query.append("          ,A.MAS_COST_SRC_PRT_CD     = B.MAS_COST_SRC_PRT_CD " ).append("\n"); 
		...
		query.append("          ,A.MAS_COST_SRC_CD_NM      = B.MAS_COST_SRC_CD_NM " ).append("\n"); 
