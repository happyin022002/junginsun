...
*@FileName : DubaiCstmsVO.java
*@FileTitle : DubaiCstmsVO
*Open Issues :
*Change history :
...
public class DubaiCstmsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DubaiCstmsVO> models = new ArrayList<DubaiCstmsVO>();
	...
	public DubaiCstmsVO(String ibflag, String pagerows, String blNo, String usrId, String cstmsRefCtnt) {
		this.blNo = blNo;
		this.ibflag = ibflag;
		this.usrId = usrId;
...
/**
	 ...
	 * @return DubaiCstmsVO[]
	 */
	public DubaiCstmsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DubaiCstmsVO[]
	 */
	public DubaiCstmsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DubaiCstmsVO model = null;
	 ...
	 * @return DubaiCstmsVO[]
	 */
	public DubaiCstmsVO[] getDubaiCstmsVOs(){
		DubaiCstmsVO[] vos = (DubaiCstmsVO[])models.toArray(new DubaiCstmsVO[models.size()]);
		return vos;
	}
