...
*@FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod047DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2014.08.03
*@LastModifier : 신자영
*@LastVersion : 1.0
* 2014.08.03 신자영
* 1.0 Creation
...
public class SpaceAllocationManageDBDAOMultiSpcAlocPolPod047DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOMultiSpcAlocPolPod047DSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod047DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   -- 2014.08.01 del 추가" ).append("\n"); 
		query.append("   AND DEST_LOC_CD  = DECODE(@[del_cd], '1', '00000', @[del_cd])" ).append("\n"); 
