...
/**
 * ESM_COA_0050 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_COA_0050HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Ki Jong
 * @see ESM_COA_0050HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmCoa0050Event extends EventSupport {
	...
	/** Constructor */
	public EsmCoa0050Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmCoa0050Event";
	}
