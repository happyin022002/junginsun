...
*@FileName : NetworkCostDBDAOAverageUCCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOAverageUCCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Average U/C(OP fixed/variable cost, SPC CHT Rev/Charterage) Insert
	  * </pre>
	  */
	public NetworkCostDBDAOAverageUCCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOAverageUCCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
