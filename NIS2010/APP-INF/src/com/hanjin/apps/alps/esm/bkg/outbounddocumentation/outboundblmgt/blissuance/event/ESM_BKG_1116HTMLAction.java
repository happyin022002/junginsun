...
*@FileName : ESM_BKG_1116HTMLAction.java
...
public class ESM_BKG_1116HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1116HTMLAction 객체를 생성
	 */
	public ESM_BKG_1116HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1116Event event = new EsmBkg1116Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEBLIssueInputVO((EBLIssueInputVO)getVO(request, EBLIssueInputVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			// 저장 변수 
			event.setEBLIssueVOs((EBLIssueVO[])getVOs(request, EBLIssueVO.class,"sheet1_"));
