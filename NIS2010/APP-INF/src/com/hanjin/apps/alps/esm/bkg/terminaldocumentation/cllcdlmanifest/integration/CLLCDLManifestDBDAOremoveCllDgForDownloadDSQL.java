...
*@FileName : CLLCDLManifestDBDAOremoveCllDgForDownloadDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CLLCDLManifestDBDAOremoveCllDgForDownloadDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeCllDgForDownload
	  * </pre>
	  */
	public CLLCDLManifestDBDAOremoveCllDgForDownloadDSQL(){
		setQuery();
		...
		query.append("FileName : CLLCDLManifestDBDAOremoveCllDgForDownloadDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
