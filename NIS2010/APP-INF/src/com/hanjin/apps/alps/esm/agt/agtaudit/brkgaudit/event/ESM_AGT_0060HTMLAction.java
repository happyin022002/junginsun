...
*@FileName : ESM_AGT_060HTMLAction.java
*@FileTitle : Brokerage AP Interface for S.America
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class ESM_AGT_0060HTMLAction extends HTMLActionSupport {


	private static final long serialVersionUID = 1L;
	/**
	 * ESMAGT0060HTMLAction 객체를 생성
	 */
	public ESM_AGT_0060HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0060Event event = new EsmAgt0060Event();
