...
*@FileName : PerformanceReportDBDAOBkgSrFaxVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOBkgSrFaxVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOBkgSrFaxVOUSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOBkgSrFaxVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${sr_knd_cd} == 'M') " ).append("\n"); 
