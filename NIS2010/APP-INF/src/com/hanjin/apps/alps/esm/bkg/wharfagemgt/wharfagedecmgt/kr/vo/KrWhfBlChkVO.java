...
*@FileName : KrWhfBlChkVO.java
*@FileTitle : KrWhfBlChkVO
*Open Issues :
*Change history :
...
public class KrWhfBlChkVO extends WhfBlChkVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfBlChkVO> models = new ArrayList<KrWhfBlChkVO>();
	...
	public KrWhfBlChkVO(String ibflag, String pagerows, String cstmsDeclTpCd, String blNo) {
		this.ibflag = ibflag;
	 ...
	 * @return KrWhfBlChkVO[]
	 */
	public KrWhfBlChkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfBlChkVO[]
	 */
	public KrWhfBlChkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfBlChkVO model = null;
	 ...
	 * @return KrWhfBlChkVO[]
	 */
	public KrWhfBlChkVO[] getKrWhfBlChkVOs(){
		KrWhfBlChkVO[] vos = (KrWhfBlChkVO[])models.toArray(new KrWhfBlChkVO[models.size()]);
		return vos;
	}
