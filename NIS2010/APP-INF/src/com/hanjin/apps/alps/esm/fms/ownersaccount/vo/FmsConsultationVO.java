...
public class FmsConsultationVO extends AbstractValueObject {
	...
	public FmsConsultationVO(String ibflag, String pagerows, String slpTpCd, String slpFuncCd, String slpOfcCd, String slpIssDt
			, String slpSerNo, String fletCtrtNo, String csrCurrCd, String csrAmt, String csrUsrId, String csrDesc, String diffAmt
			, String diffDesc, String rqstAmt, String rqstDt, String effDt, String evidTpCd, String aproFlg, String aproDt
			, String cxlFlg, String cxlDesc, String mnlTpFlg, String vatSlpTpCd, String vatSlpFuncCd, String vatSlpOfcCd, String vatSlpIssDt
			, String vatSlpSerNo, String ppayHirNo, String creUsrId, String creDt, String updUsrId, String updDt, String docEvidTpCd
			, String apCxlFlg, String oaInterMmDesc, String oaInvDt, String sCsrNo, String sFlg
			, String orgSlpTpCd, String orgSlpFuncCd, String orgSlpOfcCd, String orgSlpIssDt, String orgSlpSerNo, String asaNo, String vatCsrNo, String aproRqstNo) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("s_flg", getsFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("s_flg", "sFlg");
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setsFlg(JSPUtil.getParameter(request, prefix + "s_flg", ""));
	...
	public FmsConsultationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sFlg = (JSPUtil.getParameter(request, prefix	+ "s_flg", length));
			...
			String[] vatCsrNo = (JSPUtil.getParameter(request, prefix + "vat_csr_no", length));	
	...
	*/
	public void unDataFormat(){
		...
		this.sFlg = this.sFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
