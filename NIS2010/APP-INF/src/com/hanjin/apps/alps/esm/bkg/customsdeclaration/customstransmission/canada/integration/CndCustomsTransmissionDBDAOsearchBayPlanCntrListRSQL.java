...
public class CndCustomsTransmissionDBDAOsearchBayPlanCntrListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  /* Equipment Status 3:Import 4:Remain on board */" ).append("\n"); 
		query.append("  DECODE(SUBSTR(NVL(DECODE( VL2.UN_LOC_IND_CD, 'Y', VL2.LOC_CD, VL2.UN_LOC_CD) , BPC.POD_ISO ),1,2),'CA','3','4') CNTR_STATUS," ).append("\n"); 
