...
*@FileName : Kor24CorrInfoVO.java
*@FileTitle : Kor24CorrInfoVO
*Open Issues :
*Change history :
...
public class Kor24CorrInfoVO extends SndCorrVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CorrInfoVO> models = new ArrayList<Kor24CorrInfoVO>();
	 ...
	 * @param request
	 * @return Kor24CorrInfoVO[]
	 */
	public Kor24CorrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24CorrInfoVO[]
	 */
	public Kor24CorrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CorrInfoVO model = null;
	 ...
	 * @return Kor24CorrInfoVO[]
	 */
	public Kor24CorrInfoVO[] getKor24CorrInfoVOs(){
		Kor24CorrInfoVO[] vos = (Kor24CorrInfoVO[])models.toArray(new Kor24CorrInfoVO[models.size()]);
		return vos;
	}
