...
public class SCReportDBDAORsltSearchSCRateSearchListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            RT.BZC_OFRT_RT_AMT   , " ).append("\n"); 
		query.append("            RT.DEST_ARB_AMT      ," ).append("\n"); 
		query.append("            RT.DOR_TRKA_AMT      ," ).append("\n"); 
		query.append("            CR.PRS_CRNT_LOD_QTY / 2 PRS_CRNT_LOD_QTY" ).append("\n"); 
		...
		query.append("                     #if(${rout_pnt_loc_def_cd_ori} == 'USLGB' || ${rout_pnt_loc_def_cd_ori} == 'USLAX')" ).append("\n"); 
		query.append("                     AND      OP.ROUT_PNT_LOC_DEF_CD IN ('USLGB','USLAX')" ).append("\n"); 
		query.append("                     #elseif(${rout_pnt_loc_def_cd_ori} == 'USOAK' || ${rout_pnt_loc_def_cd_ori} == 'USSFO')" ).append("\n"); 
		query.append("                     AND      OP.ROUT_PNT_LOC_DEF_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                     #else" ).append("\n"); 
		query.append("                     AND      OP.ROUT_PNT_LOC_DEF_CD  LIKE @[rout_pnt_loc_def_cd_ori] || '%'  -- Origin" ).append("\n"); 
		query.append("                     #end" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		...
		query.append("                     AND      OP.ORG_DEST_TP_CD       = 'O'" ).append("\n"); 
		query.append("                     AND      OP.SRC_INFO_CD          <> 'AD'" ).append("\n"); 
		query.append("                     AND      OP.ROUT_PNT_LOC_TP_CD = 'L'" ).append("\n"); 
		query.append("                     AND      EXISTS (" ).append("\n"); 
		query.append("                                       SELECT 'X'" ).append("\n"); 
		query.append("                                         FROM PRI_SP_SCP_GRP_LOC GL, PRI_SP_SCP_GRP_LOC_DTL GLD" ).append("\n"); 
		query.append("                                        WHERE OP.PROP_NO              = GL.PROP_NO" ).append("\n"); 
		query.append("                                          AND OP.AMDT_SEQ             = GL.AMDT_SEQ" ).append("\n"); 
		query.append("                                          AND OP.SVC_SCP_CD           = GL.SVC_SCP_CD" ).append("\n"); 
		query.append("                                          AND OP.ROUT_PNT_LOC_DEF_CD  = GLD.LOC_CD   -- Origin" ).append("\n"); 
		query.append("                                          AND GL.PROP_NO              = GLD.PROP_NO" ).append("\n"); 
		query.append("                                          AND GL.AMDT_SEQ             = GLD.AMDT_SEQ" ).append("\n"); 
		query.append("                                          AND GL.SVC_SCP_CD           = GLD.SVC_SCP_CD" ).append("\n"); 
		query.append("                                          AND GL.GRP_LOC_SEQ           = GLD.GRP_LOC_SEQ" ).append("\n"); 
		query.append("                                          AND GL.PRC_GRP_LOC_CD        LIKE @[rout_pnt_loc_def_cd_ori] || '%'" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("                OR" ).append("\n"); 
		...
		query.append("                                          AND OP.AMDT_SEQ             = GL.AMDT_SEQ" ).append("\n"); 
		query.append("                                          AND OP.SVC_SCP_CD           = GL.SVC_SCP_CD" ).append("\n"); 
		query.append("                                          AND OP.ROUT_PNT_LOC_DEF_CD  =   GL.PRC_GRP_LOC_CD   " ).append("\n"); 
		query.append("                                          AND GL.PROP_NO              = GLD.PROP_NO" ).append("\n"); 
		query.append("                                          AND GL.AMDT_SEQ             = GLD.AMDT_SEQ" ).append("\n"); 
		query.append("                                          AND GL.SVC_SCP_CD           = GLD.SVC_SCP_CD" ).append("\n"); 
		query.append("                                          AND GL.GRP_LOC_SEQ          = GLD.GRP_LOC_SEQ" ).append("\n"); 
		query.append("                                          #if (${rout_pnt_loc_def_cd_ori} == 'USLGB' || ${rout_pnt_loc_def_cd_ori} == 'USLAX')" ).append("\n"); 
		query.append("                                          AND GLD.LOC_CD IN ('USLGB','USLAX')" ).append("\n"); 
		query.append("                                          #elseif (${rout_pnt_loc_def_cd_ori} == 'USOAK' || ${rout_pnt_loc_def_cd_ori} == 'USSFO')" ).append("\n"); 
		query.append("                                          AND GLD.LOC_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                                          #else" ).append("\n"); 
		query.append("                                          AND GLD.LOC_CD LIKE @[rout_pnt_loc_def_cd_ori] || '%'" ).append("\n"); 
		query.append("                                          #end" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		...
		query.append("                     #if (${rout_pnt_loc_def_cd_dest} == 'USLGB' || ${rout_pnt_loc_def_cd_dest} == 'USLAX')" ).append("\n"); 
		query.append("                     AND     DP.ROUT_PNT_LOC_DEF_CD IN ('USLGB','USLAX')" ).append("\n"); 
		query.append("                     #elseif (${rout_pnt_loc_def_cd_dest} == 'USOAK' || ${rout_pnt_loc_def_cd_dest} == 'USSFO')" ).append("\n"); 
		query.append("                     AND     DP.ROUT_PNT_LOC_DEF_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                     #else" ).append("\n"); 
		query.append("                     AND     DP.ROUT_PNT_LOC_DEF_CD  LIKE @[rout_pnt_loc_def_cd_dest] || '%'   -- Destination" ).append("\n"); 
		query.append("                     #end" ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		query.append("             OR" ).append("\n"); 
		query.append("            EXISTS (" ).append("\n"); 
		...
		query.append("                     AND      DP.ORG_DEST_TP_CD       = 'D'" ).append("\n"); 
		query.append("                     AND      DP.SRC_INFO_CD          <> 'AD'" ).append("\n"); 
		query.append("                     AND      DP.ROUT_PNT_LOC_TP_CD = 'L'" ).append("\n"); 
		query.append("                     AND      EXISTS (" ).append("\n"); 
		query.append("                                        SELECT 'X'" ).append("\n"); 
		query.append("                                          FROM PRI_SP_SCP_GRP_LOC GL, PRI_SP_SCP_GRP_LOC_DTL GLD" ).append("\n"); 
		query.append("                                         WHERE DP.PROP_NO              = GL.PROP_NO" ).append("\n"); 
		query.append("                                           AND DP.AMDT_SEQ             = GL.AMDT_SEQ" ).append("\n"); 
		query.append("                                           AND DP.SVC_SCP_CD           = GL.SVC_SCP_CD" ).append("\n"); 
		query.append("                                           AND DP.ROUT_PNT_LOC_DEF_CD  =   GLD.LOC_CD   -- Origin" ).append("\n"); 
		query.append("                                           AND GL.PROP_NO              = GLD.PROP_NO" ).append("\n"); 
		query.append("                                           AND GL.AMDT_SEQ             = GLD.AMDT_SEQ" ).append("\n"); 
		query.append("                                           AND GL.SVC_SCP_CD           = GLD.SVC_SCP_CD" ).append("\n"); 
		query.append("                                           AND GL.GRP_LOC_SEQ          = GLD.GRP_LOC_SEQ" ).append("\n"); 
		query.append("                                           AND GL.PRC_GRP_LOC_CD       LIKE @[rout_pnt_loc_def_cd_dest] || '%'   -- Destination" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		query.append("                OR" ).append("\n"); 
		...
		query.append("                                           AND DP.AMDT_SEQ             = GL.AMDT_SEQ" ).append("\n"); 
		query.append("                                           AND DP.SVC_SCP_CD           = GL.SVC_SCP_CD" ).append("\n"); 
		query.append("                                           AND DP.ROUT_PNT_LOC_DEF_CD  = GL.PRC_GRP_LOC_CD   " ).append("\n"); 
		query.append("                                           AND GL.PROP_NO              = GLD.PROP_NO" ).append("\n"); 
		query.append("                                           AND GL.AMDT_SEQ             = GLD.AMDT_SEQ" ).append("\n"); 
		query.append("                                           AND GL.SVC_SCP_CD           = GLD.SVC_SCP_CD" ).append("\n"); 
		query.append("                                           AND GL.GRP_LOC_SEQ          = GLD.GRP_LOC_SEQ" ).append("\n"); 
		...
		query.append("                                           AND GLD.LOC_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                                          #else" ).append("\n"); 
		query.append("                                           AND GLD.LOC_CD LIKE @[rout_pnt_loc_def_cd_dest] || '%'-- Destination" ).append("\n"); 
		query.append("                                          #end" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		...
		query.append("                    #if (${rout_via_port_def_cd_ori} == 'USLGB' || ${rout_via_port_def_cd_ori} == 'USLAX')" ).append("\n"); 
		query.append("                    AND      OV.ROUT_VIA_PORT_DEF_CD IN ('USLGB','USLAX')" ).append("\n"); 
		query.append("                    #elseif (${rout_via_port_def_cd_ori} == 'USOAK' || ${rout_via_port_def_cd_ori} == 'USSFO')" ).append("\n"); 
		query.append("                    AND      OV.ROUT_VIA_PORT_DEF_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                    #else" ).append("\n"); 
		query.append("                    AND      OV.ROUT_VIA_PORT_DEF_CD LIKE NVL(@[rout_via_port_def_cd_ori], OV.ROUT_VIA_PORT_DEF_CD) || '%' -- Origin Via" ).append("\n"); 
		query.append("                    #end" ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		query.append("              OR" ).append("\n"); 
		query.append("              EXISTS (" ).append("\n"); 
		...
		query.append("                     AND      OV.ORG_DEST_TP_CD       = 'O'" ).append("\n"); 
		query.append("                     AND      OV.SRC_INFO_CD          <> 'AD'" ).append("\n"); 
		query.append("                     AND      OV.ROUT_VIA_PORT_TP_CD = 'L'" ).append("\n"); 
		query.append("                     AND      EXISTS (" ).append("\n"); 
		query.append("                                       SELECT 'X'" ).append("\n"); 
		query.append("                                         FROM PRI_SP_SCP_GRP_LOC GL, PRI_SP_SCP_GRP_LOC_DTL GLD" ).append("\n"); 
		query.append("                                        WHERE OV.PROP_NO              = GL.PROP_NO" ).append("\n"); 
		query.append("                                          AND OV.AMDT_SEQ             = GL.AMDT_SEQ" ).append("\n"); 
		query.append("                                          AND OV.SVC_SCP_CD           = GL.SVC_SCP_CD" ).append("\n"); 
		query.append("                                          AND OV.ROUT_VIA_PORT_DEF_CD  = GLD.LOC_CD   -- Origin Via" ).append("\n"); 
		query.append("                                          AND GL.PROP_NO              = GLD.PROP_NO" ).append("\n"); 
		query.append("                                          AND GL.AMDT_SEQ             = GLD.AMDT_SEQ" ).append("\n"); 
		query.append("                                          AND GL.SVC_SCP_CD           = GLD.SVC_SCP_CD" ).append("\n"); 
		query.append("                                          AND GL.GRP_LOC_SEQ           = GLD.GRP_LOC_SEQ" ).append("\n"); 
		query.append("                                          AND GL.PRC_GRP_LOC_CD        LIKE @[rout_via_port_def_cd_ori] || '%' -- Origin Via" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("                OR" ).append("\n"); 
		...
		query.append("                                           AND GLD.LOC_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                                          #else" ).append("\n"); 
		query.append("                                           AND GLD.LOC_CD LIKE @[rout_via_port_def_cd_ori] || '%'-- Origin Via" ).append("\n"); 
		query.append("                                          #end" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		...
		query.append("                    #if (${rout_via_port_def_cd_dest} == 'USLGB' || ${rout_via_port_def_cd_dest} == 'USLAX')" ).append("\n"); 
		query.append("                    AND      DV.ROUT_VIA_PORT_DEF_CD  IN ('USLGB','USLAX')" ).append("\n"); 
		query.append("                    #elseif (${rout_via_port_def_cd_dest} == 'USOAK' || ${rout_via_port_def_cd_dest} == 'USSFO')" ).append("\n"); 
		query.append("                    AND      DV.ROUT_VIA_PORT_DEF_CD  IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                    #else" ).append("\n"); 
		query.append("                     AND     DV.ROUT_VIA_PORT_DEF_CD LIKE NVL(@[rout_via_port_def_cd_dest], DV.ROUT_VIA_PORT_DEF_CD) || '%'  -- Dest Via" ).append("\n"); 
		query.append("                    #end                    " ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		query.append("            OR" ).append("\n"); 
		query.append("            EXISTS (" ).append("\n"); 
		...
		query.append("                     AND      DV.ORG_DEST_TP_CD       = 'D'" ).append("\n"); 
		query.append("                     AND      DV.SRC_INFO_CD          <> 'AD'" ).append("\n"); 
		query.append("                     AND      DV.ROUT_VIA_PORT_TP_CD = 'L'" ).append("\n"); 
		query.append("                     AND      EXISTS (" ).append("\n"); 
		query.append("                                        SELECT 'X'" ).append("\n"); 
		query.append("                                          FROM PRI_SP_SCP_GRP_LOC GL, PRI_SP_SCP_GRP_LOC_DTL GLD" ).append("\n"); 
		query.append("                                         WHERE DV.PROP_NO              = GL.PROP_NO" ).append("\n"); 
		query.append("                                           AND DV.AMDT_SEQ             = GL.AMDT_SEQ" ).append("\n"); 
		query.append("                                           AND DV.SVC_SCP_CD           = GL.SVC_SCP_CD" ).append("\n"); 
		query.append("                                           AND DV.ROUT_VIA_PORT_DEF_CD  =   GLD.LOC_CD   -- Origin" ).append("\n"); 
		query.append("                                           AND GL.PROP_NO              = GLD.PROP_NO" ).append("\n"); 
		query.append("                                           AND GL.AMDT_SEQ             = GLD.AMDT_SEQ" ).append("\n"); 
		query.append("                                           AND GL.SVC_SCP_CD           = GLD.SVC_SCP_CD" ).append("\n"); 
		query.append("                                           AND GL.GRP_LOC_SEQ          = GLD.GRP_LOC_SEQ" ).append("\n"); 
		query.append("                                           AND GL.PRC_GRP_LOC_CD       LIKE @[rout_via_port_def_cd_dest] || '%'   -- Dest Via" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		query.append("                OR" ).append("\n"); 
		...
		query.append("                                           AND GLD.LOC_CD IN ('USOAK','USSFO')" ).append("\n"); 
		query.append("                                          #else" ).append("\n"); 
		query.append("                                           AND GLD.LOC_CD LIKE @[rout_via_port_def_cd_dest] || '%'   -- Dest Via" ).append("\n"); 
		query.append("                                          #end" ).append("\n"); 
		query.append("                                       )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("    #if (${chg_cd} == 'BUC' || ${chg_cd} == 'PSC' || ${chg_cd} == 'FRC')" ).append("\n"); 
		query.append("    " ).append("\n"); 
		...
		query.append("		    0 FNL_OFT_RT_AMT ," ).append("\n"); 
		query.append("		    NVL(decode(@[chg_cd],'BUC',RS.TRF_SCG_AMT),0) FNL_BUC_RT_AMT," ).append("\n"); 
		query.append("            NVL(decode(@[chg_cd],'FRC',RS.TRF_SCG_AMT),0) FNL_FRC_RT_AMT," ).append("\n"); 
		query.append("		    NVL(decode(@[chg_cd],'PSC',RS.TRF_SCG_AMT),0) FNL_PSC_RT_AMT," ).append("\n"); 
		query.append("            RT.BZC_OFRT_RT_AMT  ," ).append("\n"); 
		query.append("            RT.DEST_ARB_AMT     ," ).append("\n"); 
		query.append("            RT.DOR_TRKA_AMT     ," ).append("\n"); 
		query.append("            RT.PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("    FROM    RT  ," ).append("\n"); 
		query.append("            PRI_SP_SCP_RT_SCG   RS" ).append("\n"); 
		...
		query.append("    AND     RS.GEN_SPCL_RT_TP_CD = RT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("    AND     RS.CHG_CD            = @[chg_cd]         -- Charge ( BUC, PSC, FRC )       " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    #if (${fnl_frt_rt} != '')" ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("    #if (${fnl_frt_rt} == '<' && ${fnl_frt_rt_amt} != '')" ).append("\n"); 
		query.append("    AND    RS.TRF_SCG_AMT < TO_NUMBER(REPLACE(@[fnl_frt_rt_amt],',','')) -- RATE" ).append("\n"); 
		query.append("    #elseif (${fnl_frt_rt} == '>' && ${fnl_frt_rt_amt} != '')" ).append("\n"); 
		query.append("    AND    RS.TRF_SCG_AMT > TO_NUMBER(REPLACE(@[fnl_frt_rt_amt],',','')) -- RATE" ).append("\n"); 
		query.append("    #elseif (${fnl_frt_rt} == '<=' && ${fnl_frt_rt_amt} != '')" ).append("\n"); 
		query.append("    AND    RS.TRF_SCG_AMT <= TO_NUMBER(REPLACE(@[fnl_frt_rt_amt],',','')) -- RATE" ).append("\n"); 
		...
		query.append("            RT.PRC_CGO_TP_CD     ," ).append("\n"); 
		query.append("            RT.CURR_CD           ," ).append("\n"); 
		query.append("            RT.FNL_FRT_RT_AMT FNL_FRT_RT_AMT," ).append("\n"); 
		query.append("            RT.FNL_FRT_RT_AMT FNL_OFT_RT_AMT," ).append("\n"); 
		query.append("            NVL((SELECT SUM(RS.TRF_SCG_AMT )" ).append("\n"); 
		query.append("                      FROM PRI_SP_SCP_RT_SCG RS" ).append("\n"); 
		query.append("                     WHERE RS.PROP_NO           = RT.PROP_NO" ).append("\n"); 
		query.append("                       AND RS.AMDT_SEQ          = RT.AMDT_SEQ" ).append("\n"); 
		query.append("                       AND RS.SVC_SCP_CD        = RT.SVC_SCP_CD" ).append("\n"); 
		query.append("                       AND RS.GEN_SPCL_RT_TP_CD= RT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                       AND RS.ROUT_SEQ          = RT.ROUT_SEQ" ).append("\n"); 
		query.append("                       AND RS.RT_SEQ            = RT.RT_SEQ " ).append("\n"); 
		query.append("                       AND RS.CHG_CD                     = 'BUC')" ).append("\n"); 
		query.append("                ,0) FNL_BUC_RT_AMT," ).append("\n"); 
		query.append("            NVL((SELECT SUM(RS.TRF_SCG_AMT )" ).append("\n"); 
		query.append("                      FROM PRI_SP_SCP_RT_SCG RS" ).append("\n"); 
		query.append("                     WHERE RS.PROP_NO           = RT.PROP_NO" ).append("\n"); 
		query.append("                       AND RS.AMDT_SEQ          = RT.AMDT_SEQ" ).append("\n"); 
		...
		query.append("                       AND RS.ROUT_SEQ          = RT.ROUT_SEQ" ).append("\n"); 
		query.append("                       AND RS.RT_SEQ            = RT.RT_SEQ " ).append("\n"); 
		query.append("                       AND RS.CHG_CD                     = 'FRC')" ).append("\n"); 
		query.append("                ,0) FNL_FRC_RT_AMT,                " ).append("\n"); 
		query.append("            NVL((SELECT SUM(RS.TRF_SCG_AMT)" ).append("\n"); 
		query.append("                      FROM PRI_SP_SCP_RT_SCG RS" ).append("\n"); 
		query.append("                     WHERE RS.PROP_NO           = RT.PROP_NO" ).append("\n"); 
		query.append("                       AND RS.AMDT_SEQ          = RT.AMDT_SEQ" ).append("\n"); 
		...
		query.append("                       AND RS.ROUT_SEQ          = RT.ROUT_SEQ" ).append("\n"); 
		query.append("                       AND RS.RT_SEQ            = RT.RT_SEQ " ).append("\n"); 
		query.append("                       AND RS.CHG_CD                     = 'PSC')" ).append("\n"); 
		query.append("                ,0) FNL_PSC_RT_AMT,                " ).append("\n"); 
		query.append("            RT.BZC_OFRT_RT_AMT   BZC_OFRT_RT_AMT,              " ).append("\n"); 
		query.append("            RT.DEST_ARB_AMT      DEST_ARB_AMT," ).append("\n"); 
		query.append("            RT.DOR_TRKA_AMT      DOR_TRKA_AMT," ).append("\n"); 
		query.append("            RT.PRS_CRNT_LOD_QTY  PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("    FROM    RT" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")   ," ).append("\n"); 
		...
		query.append("            DECODE(@[chg_cd],'OBP',CG.FNL_OFT_RT_AMT + CG.FNL_BUC_RT_AMT +CG.FNL_PSC_RT_AMT,'OFB',CG.FNL_OFT_RT_AMT + CG.FNL_BUC_RT_AMT" ).append("\n"); 
		query.append("                            ,'OFP',CG.FNL_OFT_RT_AMT + CG.FNL_FRC_RT_AMT +CG.FNL_PSC_RT_AMT,'OFF',CG.FNL_OFT_RT_AMT + CG.FNL_FRC_RT_AMT" ).append("\n"); 
		query.append("                            , CG.FNL_FRT_RT_AMT)  FNL_FRT_RT_AMT," ).append("\n"); 
		query.append("		    CG.FNL_OFT_RT_AMT ," ).append("\n"); 
		query.append("		    CG.FNL_BUC_RT_AMT," ).append("\n"); 
		query.append("            CG.FNL_FRC_RT_AMT," ).append("\n"); 
		query.append("		    CG.FNL_PSC_RT_AMT," ).append("\n"); 
		query.append("            CG.BZC_OFRT_RT_AMT          ," ).append("\n"); 
		query.append("            CG.DEST_ARB_AMT             ," ).append("\n"); 
		query.append("            CG.DOR_TRKA_AMT             ," ).append("\n"); 
		...
		query.append("        PROP_SCP_OFC_CD     , -- 추가" ).append("\n"); 
		query.append("        PROP_SCP_SREP_CD    , -- 추가" ).append("\n"); 
		query.append("        AMDT_SEQ            ," ).append("\n"); 
		query.append("        SVC_SCP_CD          ," ).append("\n"); 
		query.append("        GEN_SPCL_RT_TP_CD   ," ).append("\n"); 
		query.append("        CMDT_HDR_SEQ        , -- 추가" ).append("\n"); 
		query.append("        ROUT_SEQ            , -- 추가" ).append("\n"); 
		query.append("        RT_SEQ              , -- 추가" ).append("\n"); 
		query.append("        CMDT_NM             ," ).append("\n"); 
		query.append("        ACT_CUST_NM         ," ).append("\n"); 
		query.append("        --REPLACE(ORG_NM     , '^|^', ';') AS ORG_NM      ," ).append("\n"); 
		query.append("        REPLACE(ORG_CD     , '^|^', ';') AS ORG_CD      ," ).append("\n"); 
		query.append("        --REPLACE(ORG_VIA_NM , '^|^', ';') AS ORG_VIA_NM  ," ).append("\n"); 
		query.append("		REPLACE(ORG_VIA_CD , '^|^', ';') AS ORG_VIA_CD  ," ).append("\n"); 
		query.append("        --REPLACE(DEST_VIA_NM, '^|^', ';') AS DEST_VIA_NM ," ).append("\n"); 
		query.append("		REPLACE(DEST_VIA_CD, '^|^', ';') AS DEST_VIA_CD ," ).append("\n"); 
		query.append("        --REPLACE(DEST_NM    , '^|^', ';') AS DEST_NM     ," ).append("\n"); 
		query.append("		REPLACE(DEST_CD    , '^|^', ';') AS DEST_CD     ," ).append("\n"); 
		query.append("        CHG_CD              ," ).append("\n"); 
		query.append("        INTG_CD_VAL_DP_DESC CHG_CD_TXT," ).append("\n"); 
		query.append("        RAT_UT_CD           ," ).append("\n"); 
		query.append("        PRC_CGO_TP_CD       ," ).append("\n"); 
		query.append("        CURR_CD             ," ).append("\n"); 
		query.append("        FNL_FRT_RT_AMT      ," ).append("\n"); 
		query.append("		FNL_OFT_RT_AMT ," ).append("\n"); 
		query.append("		FNL_BUC_RT_AMT," ).append("\n"); 
		query.append("        FNL_FRC_RT_AMT," ).append("\n"); 
		query.append("		FNL_PSC_RT_AMT," ).append("\n"); 
		...
		query.append("FROM    SC,(SELECT INTG_CD_VAL_CTNT,INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("              FROM COM_INTG_CD_dtl" ).append("\n"); 
		query.append("             WHERE INTG_CD_ID = 'CD02293'" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		query.append("WHERE   1 = 1" ).append("\n"); 
		query.append("  AND   CHG_CD = INTG_CD_VAL_CTNT" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${chg_cd} == 'OBP' || ${chg_cd} == 'OFB' || ${chg_cd} == 'OFP' || ${chg_cd} == 'OFF')" ).append("\n"); 
		query.append("    #if (${fnl_frt_rt} != '')    " ).append("\n"); 
		query.append("        #if (${fnl_frt_rt} == '<' && ${fnl_frt_rt_amt} != '')" ).append("\n"); 
		query.append("        AND    FNL_FRT_RT_AMT < TO_NUMBER(REPLACE(@[fnl_frt_rt_amt],',','')) -- RATE" ).append("\n"); 
		query.append("        #elseif (${fnl_frt_rt} == '>' && ${fnl_frt_rt_amt} != '')" ).append("\n"); 
		query.append("        AND    FNL_FRT_RT_AMT > TO_NUMBER(REPLACE(@[fnl_frt_rt_amt],',','')) -- RATE" ).append("\n"); 
		query.append("        #elseif (${fnl_frt_rt} == '<=' && ${fnl_frt_rt_amt} != '')" ).append("\n"); 
		query.append("        AND    FNL_FRT_RT_AMT <= TO_NUMBER(REPLACE(@[fnl_frt_rt_amt],',','')) -- RATE" ).append("\n"); 
