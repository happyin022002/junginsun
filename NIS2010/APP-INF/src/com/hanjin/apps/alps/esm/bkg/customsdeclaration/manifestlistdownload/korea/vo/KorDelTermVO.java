...
*@FileName : KorDelTermVO.java
*@FileTitle : KorDelTermVO
*Open Issues :
*Change history :
...
public class KorDelTermVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDelTermVO> models = new ArrayList<KorDelTermVO>();
	...
	public KorDelTermVO(String ibflag, String pagerows, String bkgDelCd, String mdmLocNm, String delTermCd) {
		this.ibflag = ibflag;
	 ...
	 * @return KorDelTermVO[]
	 */
	public KorDelTermVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDelTermVO[]
	 */
	public KorDelTermVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDelTermVO model = null;
	 ...
	 * @return KorDelTermVO[]
	 */
	public KorDelTermVO[] getKorDelTermVOs(){
		KorDelTermVO[] vos = (KorDelTermVO[])models.toArray(new KorDelTermVO[models.size()]);
		return vos;
	}
