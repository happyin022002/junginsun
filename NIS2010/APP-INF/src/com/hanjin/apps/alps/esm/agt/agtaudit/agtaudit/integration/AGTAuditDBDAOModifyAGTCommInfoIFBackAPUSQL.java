...
*@FileName : AGTAuditDBDAOModifyAGTCommInfoIFBackAPUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOModifyAGTCommInfoIFBackAPUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyAGTCommInfoIFBackAPU
	  * </pre>
	  */
	public AGTAuditDBDAOModifyAGTCommInfoIFBackAPUSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOModifyAGTCommInfoIFBackAPUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET ATTR_CTNT1  = NULL," ).append("\n"); 
		...
		query.append("IF_DT       = CRE_DT," ).append("\n"); 
