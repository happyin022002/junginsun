...
*@FileName : RFARateProposalDBDAORsltPrsSurchargeDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPrsSurchargeDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPrsSurchargeDetailRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPrsSurchargeDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select 	pri_scg.prop_no, pri_scg.amdt_seq, pri_scg.svc_scp_cd," ).append("\n"); 
		...
		query.append("from pri_rp_scp_rt_scg pri_scg" ).append("\n"); 
