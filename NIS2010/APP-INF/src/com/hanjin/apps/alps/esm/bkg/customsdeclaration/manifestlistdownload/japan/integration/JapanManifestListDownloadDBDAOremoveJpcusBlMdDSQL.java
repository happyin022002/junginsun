...
*@FileName : JapanManifestListDownloadDBDAOremoveJpcusBlMdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOremoveJpcusBlMdDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOremoveJpcusBlMdDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_JP_BL_MK" ).append("\n"); 
		...
		query.append("FileName : JapanManifestListDownloadDBDAOremoveJpcusBlMdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}