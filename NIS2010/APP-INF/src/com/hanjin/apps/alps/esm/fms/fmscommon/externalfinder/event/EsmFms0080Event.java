...
public class EsmFms0080Event extends EventSupport {
	...
	public SearchMdmAccountCodeListVO[] getSearchMdmAccountCodeListVOS(){
		SearchMdmAccountCodeListVO[] rtnVOs = null;
		if (this.searchmdmaccountcodelistvos != null) {
			rtnVOs = new SearchMdmAccountCodeListVO[searchmdmaccountcodelistvos.length];
			System.arraycopy(searchmdmaccountcodelistvos, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
