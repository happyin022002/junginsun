...
*@FileName : ESM_BKG_1110HTMLAction.java
...
public class ESM_BKG_1110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1110HTMLAction 객체를 생성
	 */
	public ESM_BKG_1110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1110Event event = new EsmBkg1110Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setOutBdEirMovementStatusListVO((OutBdEirMovementStatusListVO)getVO(request, OutBdEirMovementStatusListVO .class));
		}
