...
*@FileName : RFARateProposalDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPriSurchargeAdjustLocationGroupDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_rp_scp_grp_loc_dtl loc_dtl" ).append("\n"); 
