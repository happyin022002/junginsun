...
*@FileName : SCGroupLocationQuotationDBDAORsltPriSqGrpLocDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationQuotationDBDAORsltPriSqGrpLocDtlVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAORsltPriSqGrpLocDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAORsltPriSqGrpLocDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
