...
*@FileName : Kor24ManifestListDBDAOmodifyVVDSendKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyVVDSendKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyVVDSendKorUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyVVDSendKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
