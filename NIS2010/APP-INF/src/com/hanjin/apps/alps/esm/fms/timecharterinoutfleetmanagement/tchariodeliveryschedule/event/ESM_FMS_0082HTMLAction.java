...
*@FileName : ESM_FMS_0082HTMLAction.java
...
public class ESM_FMS_0082HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0082HTMLAction 객체를 생성
	 */
	public ESM_FMS_0082HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EsmFms0082Event event = new EsmFms0082Event();
