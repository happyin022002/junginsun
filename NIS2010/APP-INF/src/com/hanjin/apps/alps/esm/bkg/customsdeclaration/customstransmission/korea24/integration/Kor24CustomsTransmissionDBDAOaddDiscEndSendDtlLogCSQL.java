...
*@FileName : Kor24CustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
