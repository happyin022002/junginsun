...
*@FileName : Kor24CustomsTransmissionDBDAOsearchTeuFeuCntRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchTeuFeuCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchTeuFeuCntRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchTeuFeuCntRSQL").append("\n");
		query.append("*/").append("\n");
	}
