...
public class StatusReportDBDAOSearchBkgCroChkListByBLVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             " ).append("\n"); 
		query.append("#if (${pol_cd} != '') " ).append("\n"); 
		query.append("       SUBSTR(BV.POL_CD,1,2) CNT_CD" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("	 SUBSTR(BV.POD_CD,1,2) CNT_CD" ).append("\n"); 
		...
		query.append("		WHEN NVL(C_S.CUST_NM,'N') = 'N' AND (POD_V.SHPR_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_NM_FLG,'N') END  AS CUST_NM_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CUST_ADDR,'N') = 'N' AND (POD_V.SHPR_ADDR_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_ADDR_FLG, 'N') END  AS CUST_ADDR_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CUST_CTY_NM,'N') = 'N' AND (POD_V.SHPR_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_CTY_FLG, 'N') END  AS CUST_CTY_NM_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CSTMS_DECL_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CSTMS_DECL_CNT_CD,'N') = 'N' AND (POD_V.SHPR_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_CNT_FLG,'N') END  AS CSTMS_DECL_CNT_CD_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_ZIP_ID,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("			  WHEN NVL(C_S.CUST_ZIP_ID,'N') = 'N' AND (POD_V.SHPR_ZIP_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_ZIP_FLG,'N') END  AS CUST_ZIP_ID_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.EUR_CSTMS_ST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("			  WHEN NVL(C_S.EUR_CSTMS_ST_NM,'N') = 'N' AND (POD_V.SHPR_ST_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_ST_NM_FLG, 'N') END  AS CUST_ST_NM_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("        ,CASE WHEN NVL(C_S.EORI_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("	 		  WHEN NVL(C_S.EORI_NO,'N') = 'N' AND (POD_V.SHPR_EORI_NO_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.SHPR_EORI_NO_FLG, 'N') END  AS CUST_EORI_NO_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN CASE WHEN LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL) THEN 'N'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (POD_V.XPT_IMP_REF_FLG6 = 'E' ) THEN 'E'" ).append("\n"); 
		query.append("		 ELSE NVL(POD_V.XPT_IMP_REF_FLG6, 'N') END AS CUST_TAX_ID_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN CASE WHEN LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL) THEN 'N'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (POD_V.XPT_IMP_REF_FLG6 = 'E' ) THEN 'E'" ).append("\n"); 
		query.append("		 ELSE NVL(POD_V.XPT_IMP_REF_FLG6, 'N') END AS CUST_TAX_ID_C" ).append("\n"); 
		query.append("		 " ).append("\n"); 
		query.append("		,CASE WHEN CASE WHEN LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL) THEN 'N'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.TR_NTFY_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (POD_V.XPT_IMP_REF_FLG6 = 'E' ) THEN 'E'" ).append("\n"); 
		query.append("		 ELSE NVL(POD_V.XPT_IMP_REF_FLG6, 'N') END AS CUST_TAX_ID_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_NM,'N') = 'N' AND (POD_V.CNEE_NM_FLG = 'E' ) THEN DECODE(BKG.CUST_TO_ORD_FLG,'Y','Y','E')" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_NM_FLG,'N') END  AS CUST_NM_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_ADDR,'N') = 'N' AND (POD_V.CNEE_ADDR_FLG = 'E') THEN DECODE(BKG.CUST_TO_ORD_FLG,'Y','Y','E')" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_ADDR_FLG, 'N') END  AS CUST_ADDR_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_CTY_NM,'N') = 'N' AND (POD_V.CNEE_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_CTY_FLG, 'N') END  AS CUST_CTY_NM_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CSTMS_DECL_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CSTMS_DECL_CNT_CD,'N') = 'N' AND (POD_V.CNEE_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_CNT_FLG, 'N') END  AS CSTMS_DECL_CNT_CD_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_STE_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_STE_CD,'N') = 'N' AND (POD_V.CNEE_STE_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_STE_FLG, 'N') END  AS CUST_STE_CD_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_ZIP_ID,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_ZIP_ID,'N') = 'N' AND (POD_V.CNEE_ZIP_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_ZIP_FLG, 'N') END  AS CUST_ZIP_ID_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.EUR_CSTMS_ST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.EUR_CSTMS_ST_NM,'N') = 'N' AND (POD_V.CNEE_ST_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_ST_NM_FLG, 'N') END  AS CUST_ST_NM_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("        ,CASE WHEN NVL(C_C.EORI_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.EORI_NO,'N') = 'N' AND (POD_V.CNEE_EORI_NO_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.CNEE_EORI_NO_FLG,'N') END  AS CUST_EORI_NO_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_NM,'N') = 'N' AND (POD_V.NTFY_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_NM_FLG, 'N') END  AS CUST_NM_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_ADDR,'N') = 'N' AND (POD_V.NTFY_ADDR_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_ADDR_FLG,'N') END  AS CUST_ADDR_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_CTY_NM,'N') = 'N' AND (POD_V.NTFY_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_CTY_FLG, 'N') END  AS CUST_CTY_NM_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CSTMS_DECL_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CSTMS_DECL_CNT_CD,'N') = 'N' AND (POD_V.NTFY_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_CNT_FLG,'N') END  AS CSTMS_DECL_CNT_CD_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_STE_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_STE_CD,'N') = 'N' AND (POD_V.NTFY_STE_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_STE_FLG,'N') END  AS CUST_STE_CD_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_ZIP_ID,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_ZIP_ID,'N') = 'N' AND (POD_V.NTFY_ZIP_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_ZIP_FLG, 'N') END  AS CUST_ZIP_ID_N" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	    ,CASE WHEN NVL(C_N.EUR_CSTMS_ST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.EUR_CSTMS_ST_NM,'N') = 'N' AND (POD_V.NTFY_ST_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_ST_NM_FLG,'N') END  AS CUST_ST_NM_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("        ,CASE WHEN NVL(C_N.EORI_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.EORI_NO,'N') = 'N' AND (POD_V.NTFY_EORI_NO_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POD_V.NTFY_EORI_NO_FLG,'N') END  AS CUST_EORI_NO_N" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                      WHEN (POD_V.CNTR_PCK_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POD_V.CNTR_PCK_FLG,'N') END  AS PCK_QTY_CHK" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("                ,CASE WHEN DOC.ACT_WGT = CM_CNT.CM_WGT_CHK  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN (POD_V.CNTR_WGT_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POD_V.CNTR_WGT_FLG,'N') END  AS ACT_WET_CHK" ).append("\n"); 
		query.append("                            " ).append("\n"); 
		query.append("                ,CASE WHEN DOC.MEAS_QTY = CM_CNT.CM_MEAS_CHK  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN (POD_V.CNTR_MEAS_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POD_V.CNTR_MEAS_FLG, 'N') END  AS MEAS_QTY_CHK" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                	WHEN NVL(CM_CNT.CM_MK,'N') = 'N' AND (POD_V.CNTR_MF_MK_FLG= 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POD_V.CNTR_MF_MK_FLG, 'N') END  AS CNTR_MF_MK_DESC" ).append("\n"); 
		query.append("          " ).append("\n"); 
		query.append("          	  ,CASE WHEN NVL(CM_CNT.CM_DS,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.CM_DS,'N') = 'N' AND (POD_V.CNTR_MF_DESC_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POD_V.CNTR_MF_DESC_FLG,'N') END  AS CNTR_MF_GDS_DESC" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("      				WHEN  POD_V.SEAL_NO_FLG = 'E' OR  POD_V.SEAL_NO_FLG = 'E' THEN 'E'" ).append("\n"); 
		...
		query.append("                	WHEN NVL(CM_CNT.HAMO_TRF_CD,'N') = 'N' AND (POD_V.CNTR_MF_CMDT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POD_V.CNTR_MF_CMDT_FLG,'N') END  AS CNTR_MF_HTS" ).append("\n"); 
		query.append("           " ).append("\n"); 
		query.append("           	  ,CASE WHEN NVL(CM_CNT.CMDT_HS_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.CMDT_HS_CD,'N') = 'N' AND (POD_V.CMDT_HS_CD_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POD_V.CMDT_HS_CD_FLG,'N') END  AS CNTR_MF_HS" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("           	  ,CASE WHEN NVL(CM_CNT.NCM_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.NCM_NO,'N') = 'N' AND (POD_V.CNTR_MF_NCM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POD_V.CNTR_MF_NCM_FLG,'N') END  AS CNTR_MF_NCM" ).append("\n"); 
		query.append("            " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${tab_item} != '') " ).append("\n"); 
		query.append("	          ,@[tab_item] TAB_ITEM" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("			  ,ROW_NUMBER() OVER ( PARTITION BY BKG.BKG_NO, CNT.CNTR_NO ORDER BY BKG.BKG_NO, CNT.CNTR_NO, POD_V.LOC_CD ASC ) ROW_NUMBER" ).append("\n"); 
		...
		query.append("		#if (${pol_cd} != '') " ).append("\n"); 
		query.append("			--AND NVL(VVD.POL_CD,'X') = POD_V.LOC_CD(+)" ).append("\n"); 
		query.append("			AND NVL(VVD.POL_CD,'X') = NVL(POD_V.LOC_CD(+), NVL(VVD.POL_CD,'X'))" ).append("\n"); 
		query.append("			--AND NVL(VVD.POD_CD,'X') = POD_V.LOC_CD(+)" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		...
		query.append("              ,ISS.OBL_ISS_USR_ID" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CUST_NM,'N') = 'N' AND (POL_V.SHPR_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_NM_FLG,'N') END  AS CUST_NM_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CUST_ADDR,'N') = 'N' AND (POL_V.SHPR_ADDR_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_ADDR_FLG, 'N') END  AS CUST_ADDR_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CUST_CTY_NM,'N') = 'N' AND (POL_V.SHPR_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_CTY_FLG, 'N') END  AS CUST_CTY_NM_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CSTMS_DECL_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_S.CSTMS_DECL_CNT_CD,'N') = 'N' AND (POL_V.SHPR_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_CNT_FLG,'N') END  AS CSTMS_DECL_CNT_CD_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.CUST_ZIP_ID,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("			  WHEN NVL(C_S.CUST_ZIP_ID,'N') = 'N' AND (POL_V.SHPR_ZIP_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_ZIP_FLG,'N') END  AS CUST_ZIP_ID_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_S.EUR_CSTMS_ST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("			  WHEN NVL(C_S.EUR_CSTMS_ST_NM,'N') = 'N' AND (POL_V.SHPR_ST_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_ST_NM_FLG, 'N') END  AS CUST_ST_NM_S" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("        ,CASE WHEN NVL(C_S.EORI_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("	 		  WHEN NVL(C_S.EORI_NO,'N') = 'N' AND (POL_V.SHPR_EORI_NO_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.SHPR_EORI_NO_FLG, 'N') END  AS CUST_EORI_NO_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN CASE WHEN LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL) THEN 'N'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (POL_V.XPT_IMP_REF_FLG6 = 'E' ) THEN 'E'" ).append("\n"); 
		query.append("		 ELSE NVL(POL_V.XPT_IMP_REF_FLG6, 'N') END AS CUST_TAX_ID_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN CASE WHEN LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL) THEN 'N'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (POL_V.XPT_IMP_REF_FLG6 = 'E' ) THEN 'E'" ).append("\n"); 
		query.append("		 ELSE NVL(POL_V.XPT_IMP_REF_FLG6, 'N') END AS CUST_TAX_ID_C" ).append("\n"); 
		query.append("		 " ).append("\n"); 
		query.append("		,CASE WHEN CASE WHEN LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.MX_NTFY_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (LIC.TR_CNEE_TAX_ID IS NOT NULL OR LIC.TR_SHPR_TAX_ID IS NOT NULL OR LIC.MX_CNEE_TAX_ID IS NOT NULL OR LIC.MX_SHPR_TAX_ID IS NOT NULL) THEN 'N'" ).append("\n"); 
		query.append("		      WHEN CASE WHEN LIC.TR_NTFY_TAX_ID IS NOT NULL OR LIC.TR_NTFY_TAX_ID IS NOT NULL THEN 'Y' ELSE 'N' END = 'N' " ).append("\n"); 
		query.append("		      AND (POL_V.XPT_IMP_REF_FLG6 = 'E' ) THEN 'E'" ).append("\n"); 
		query.append("		 ELSE NVL(POL_V.XPT_IMP_REF_FLG6, 'N') END AS CUST_TAX_ID_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_NM,'N') = 'N' AND (POL_V.CNEE_NM_FLG = 'E' ) THEN DECODE(BKG.CUST_TO_ORD_FLG,'Y','Y','E')" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_NM_FLG,'N') END  AS CUST_NM_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_ADDR,'N') = 'N' AND (POL_V.CNEE_ADDR_FLG = 'E') THEN DECODE(BKG.CUST_TO_ORD_FLG,'Y','Y','E')" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_ADDR_FLG, 'N') END  AS CUST_ADDR_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_CTY_NM,'N') = 'N' AND (POL_V.CNEE_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_CTY_FLG, 'N') END  AS CUST_CTY_NM_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CSTMS_DECL_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CSTMS_DECL_CNT_CD,'N') = 'N' AND (POL_V.CNEE_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_CNT_FLG, 'N') END  AS CSTMS_DECL_CNT_CD_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_STE_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_STE_CD,'N') = 'N' AND (POL_V.CNEE_STE_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_STE_FLG, 'N') END  AS CUST_STE_CD_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.CUST_ZIP_ID,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.CUST_ZIP_ID,'N') = 'N' AND (POL_V.CNEE_ZIP_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_ZIP_FLG, 'N') END  AS CUST_ZIP_ID_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_C.EUR_CSTMS_ST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.EUR_CSTMS_ST_NM,'N') = 'N' AND (POL_V.CNEE_ST_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_ST_NM_FLG, 'N') END  AS CUST_ST_NM_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("        ,CASE WHEN NVL(C_C.EORI_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_C.EORI_NO,'N') = 'N' AND (POL_V.CNEE_EORI_NO_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.CNEE_EORI_NO_FLG,'N') END  AS CUST_EORI_NO_C" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_NM,'N') = 'N' AND (POL_V.NTFY_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_NM_FLG, 'N') END  AS CUST_NM_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_ADDR,'N') = 'N' AND (POL_V.NTFY_ADDR_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_ADDR_FLG,'N') END  AS CUST_ADDR_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_CTY_NM,'N') = 'N' AND (POL_V.NTFY_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_CTY_FLG, 'N') END  AS CUST_CTY_NM_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CSTMS_DECL_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CSTMS_DECL_CNT_CD,'N') = 'N' AND (POL_V.NTFY_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_CNT_FLG,'N') END  AS CSTMS_DECL_CNT_CD_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_STE_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_STE_CD,'N') = 'N' AND (POL_V.NTFY_STE_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_STE_FLG,'N') END  AS CUST_STE_CD_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,CASE WHEN NVL(C_N.CUST_ZIP_ID,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.CUST_ZIP_ID,'N') = 'N' AND (POL_V.NTFY_ZIP_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_ZIP_FLG, 'N') END  AS CUST_ZIP_ID_N" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	    ,CASE WHEN NVL(C_N.EUR_CSTMS_ST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.EUR_CSTMS_ST_NM,'N') = 'N' AND (POL_V.NTFY_ST_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_ST_NM_FLG,'N') END  AS CUST_ST_NM_N" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("        ,CASE WHEN NVL(C_N.EORI_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("		WHEN NVL(C_N.EORI_NO,'N') = 'N' AND (POL_V.NTFY_EORI_NO_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("		ELSE NVL(POL_V.NTFY_EORI_NO_FLG,'N') END  AS CUST_EORI_NO_N" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("              ,REPLACE(C_C.CUST_NM,CHR(13) || CHR(10),' ')         AS CUST_NM" ).append("\n"); 
		query.append("              ,REPLACE(C_S.CUST_NM,CHR(13) || CHR(10),' ')         AS S_CUST_NM" ).append("\n"); 
		query.append("              ,REPLACE(C_N.CUST_NM,CHR(13) || CHR(10),' ')         AS N_CUST_NM" ).append("\n"); 
		...
		query.append("              ,NVL(DOC.MEAS_QTY,0)                                 AS MEAS_QTY_DA" ).append("\n"); 
		query.append("              ,CASE WHEN DOC.PCK_QTY = CM_CNT.CM_PCK_CHK  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN (POL_V.CNTR_PCK_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.CNTR_PCK_FLG,'N') END  AS PCK_QTY_CHK" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("                ,CASE WHEN DOC.ACT_WGT = CM_CNT.CM_WGT_CHK  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN (POL_V.CNTR_WGT_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.CNTR_WGT_FLG,'N') END  AS ACT_WET_CHK" ).append("\n"); 
		query.append("                            " ).append("\n"); 
		query.append("                ,CASE WHEN DOC.MEAS_QTY = CM_CNT.CM_MEAS_CHK  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN (POL_V.CNTR_MEAS_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.CNTR_MEAS_FLG, 'N') END  AS MEAS_QTY_CHK" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("              ,NVL(CM_CNT.CM_PCK, 0)                                  AS PCK_QTY_CM" ).append("\n"); 
		query.append("              ,NVL(CM_CNT.CM_WGT, 0)                                  AS CNTR_MF_WGT" ).append("\n"); 
		query.append("              ,NVL(CM_CNT.CM_MEAS, 0)                                 AS MEAS_QTY_CM" ).append("\n"); 
		query.append("              ,CASE WHEN NVL(CM_CNT.CM_MK,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.CM_MK,'N') = 'N' AND (POL_V.CNTR_MF_MK_FLG= 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_MK_FLG, 'N') END  AS CNTR_MF_MK_DESC" ).append("\n"); 
		query.append("          " ).append("\n"); 
		query.append("          	  ,CASE WHEN NVL(CM_CNT.CM_DS,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.CM_DS,'N') = 'N' AND (POL_V.CNTR_MF_DESC_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_DESC_FLG,'N') END  AS CNTR_MF_GDS_DESC" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("              ,CNT.CNTR_NO" ).append("\n"); 
		query.append("              ,NVL(CNT.PCK_QTY,0)                                  AS PCK_QTY_CO" ).append("\n"); 
		query.append("              ,NVL(CNT.CNTR_WGT,0)                                 AS CNTR_WGT" ).append("\n"); 
		...
		query.append("                                FROM   BKG_CNTR_SEAL_NO" ).append("\n"); 
		query.append("                                WHERE  BKG_NO = CNT.BKG_NO AND CNTR_NO = CNT.CNTR_NO)),'N') <> 'N' THEN 'Y'" ).append("\n"); 
		query.append("      				WHEN  POL_V.SEAL_NO_FLG = 'E' OR  POL_V.SEAL_NO_FLG = 'E' THEN 'E'" ).append("\n"); 
		query.append("      				ELSE  'N' END  AS CNTR_SEAL_SEQ    " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("              ,'0' Seq" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(CM_CNT.HAMO_TRF_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.HAMO_TRF_CD,'N') = 'N' AND (POL_V.CNTR_MF_CMDT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_CMDT_FLG,'N') END  AS CNTR_MF_HTS" ).append("\n"); 
		query.append("           " ).append("\n"); 
		query.append("           	  ,CASE WHEN NVL(CM_CNT.CMDT_HS_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.CMDT_HS_CD,'N') = 'N' AND (POL_V.CMDT_HS_CD_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CMDT_HS_CD_FLG,'N') END  AS CNTR_MF_HS" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("           	  ,CASE WHEN NVL(CM_CNT.NCM_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(CM_CNT.NCM_NO,'N') = 'N' AND (POL_V.CNTR_MF_NCM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_NCM_FLG,'N') END  AS CNTR_MF_NCM" ).append("\n"); 
		query.append("            " ).append("\n"); 
		query.append("#if (${tab_item} != '') " ).append("\n"); 
		query.append("	          ,@[tab_item] TAB_ITEM" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("			  ,ROW_NUMBER() OVER ( PARTITION BY BKG.BKG_NO, CNT.CNTR_NO ORDER BY BKG.BKG_NO, CNT.CNTR_NO, POL_V.LOC_CD ASC ) ROW_NUMBER" ).append("\n"); 
		query.append("        FROM   BKG_VVD_TMP      VVD" ).append("\n"); 
		query.append("              ,BKG_BOOKING      BKG" ).append("\n"); 
		query.append("              ,BKG_CUSTOMER     C_S" ).append("\n"); 
		query.append("              ,BKG_CUSTOMER     C_C" ).append("\n"); 
		...
		query.append("		#if (${pol_cd} =='' && ${pod_cd} != '') " ).append("\n"); 
		query.append("			--AND NVL(VVD.POD_CD,'X') = POL_V.LOC_CD(+)" ).append("\n"); 
		query.append("			AND NVL(VVD.POD_CD,'X') = NVL(POL_V.LOC_CD(+), NVL(VVD.POD_CD,'X'))" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
