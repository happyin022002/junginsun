...
*@FileName : ESM_BKG_0621HTMLAction.java
...
public class ESM_BKG_0621HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0621HTMLAction 객체를 생성
	 */
	public ESM_BKG_0621HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0621Event event = new EsmBkg0621Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTroUsaStatusListInVO((TroUsaStatusListInVO)getVO(request, TroUsaStatusListInVO .class));
