...
*@FileName : CalculateDBDAOCoaComParaDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CalculateDBDAOCoaComParaDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete MAS_COM_PARA with PCTL_NO
	  * 
	  * * History
	  * 2015.06.26 CHM-201536492 Split05-주간 MAS Open에 따른 타모듈 프로그램 적용 요청
	  * </pre>
	  */
	public CalculateDBDAOCoaComParaDSQL(){
		setQuery();
		...
		query.append("FileName : CalculateDBDAOCoaComParaDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE MAS_COM_PARA" ).append("\n"); 
