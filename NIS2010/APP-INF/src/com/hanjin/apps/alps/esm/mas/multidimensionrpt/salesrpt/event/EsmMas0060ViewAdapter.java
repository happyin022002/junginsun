...
*@FileName : EsmMas0060ViewAdapter.java
*@FileTitle : EsmMas0060ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0060ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0060ViewAdapter(){
    	super();
    }
