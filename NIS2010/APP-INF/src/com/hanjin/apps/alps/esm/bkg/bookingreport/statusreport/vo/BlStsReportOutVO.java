...
public class BlStsReportOutVO extends AbstractValueObject {
	...
	/* Column Info */
	private String cntrConfirm = null;
	/* Column Info */
	...
	/* Column Info */
	private String bdiConfirm = null;
	...
	public BlStsReportOutVO(String ibflag, String pagerows, String bkgNo, String blNo, String porCd, String polCd, String podCd, String delCd, String bkgOfc, String delOfc, String obType, String obDate, String irBlType, String irOffice, String irDate, String irBy, String orsOffice, String orsDate, String orsNo, String orsSurrender, String orsDo, String bdiSr, String bdiComplete, String bdiOffice, String bdiBy, String vvdCd, String shipper, String consignee, String salesOffice, String salesRep, String ppd, String cct, String blIssued, String blReleased, String ppdOrg, String ppd3rd, String cctDest, String cct3rd, String oblIssRmk, String ppdOrg2, String ppd3rd2, String cctDest2, String cct3rd2, String fowarder, String blPrint, String scRfaNo, String payTermCd, String totalCnt, String rowsPerPage, String currPage, String rnum, String bdiType, String bdiConfirm, String vvdEtd, String cntrConfirm, String podEta) {
		...
		this.bdiConfirm = bdiConfirm;
		this.vvdEtd = vvdEtd;
		this.cntrConfirm = cntrConfirm;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bdi_confirm", getBdiConfirm());
		this.hashColumns.put("vvd_etd", getVvdEtd());
		this.hashColumns.put("cntr_confirm", getCntrConfirm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("bdi_confirm", "bdiConfirm");
		this.hashFields.put("vvd_etd", "vvdEtd");
		this.hashFields.put("cntr_confirm", "cntrConfirm");
	 ...
	 * @return cntrCfm
	 */
	public String getCntrConfirm() {
		return this.cntrConfirm;
	}
	 ...
	 * @return bdiConfirm
	 */
	public String getBdiConfirm() {
		return this.bdiConfirm;
	}
	 ...
	 * @param cntrCfm
	 */
	public void setCntrConfirm(String cntrConfirm) {
		this.cntrConfirm = cntrConfirm;
	}
	 ...
	 * @param bdiConfirm
	 */
	public void setBdiConfirm(String bdiConfirm) {
		this.bdiConfirm = bdiConfirm;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBdiConfirm(JSPUtil.getParameter(request, "bdi_confirm", ""));
		setVvdEtd(JSPUtil.getParameter(request, "vvd_etd", ""));
		setCntrConfirm(JSPUtil.getParameter(request, "cntr_confirm", ""));
	...
	public BlStsReportOutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] bdiConfirm = (JSPUtil.getParameter(request, prefix	+ "bdi_confirm", length));
			String[] vvdEtd = (JSPUtil.getParameter(request, prefix	+ "vvd_etd", length));
			String[] cntrConfirm = (JSPUtil.getParameter(request, prefix	+ "cntr_confirm", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (bdiConfirm[i] != null)
					model.setBdiConfirm(bdiConfirm[i]);
				if (vvdEtd[i] != null)
					model.setVvdEtd(vvdEtd[i]);
				if (cntrConfirm[i] != null)
					model.setCntrConfirm(cntrConfirm[i]);
				if (podEta[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.bdiConfirm = this.bdiConfirm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.vvdEtd = this.vvdEtd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cntrConfirm = this.cntrConfirm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
