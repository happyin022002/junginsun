...
*@FileName : PercentBaseChargeDBDAOModifyPercentBaseChargeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PercentBaseChargeDBDAOModifyPercentBaseChargeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PercentBaseChargeDBDAOModifyPercentBaseChargeUSQL(){
		setQuery();
		...
		query.append("FileName : PercentBaseChargeDBDAOModifyPercentBaseChargeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SCG_PCT_BSE" ).append("\n"); 
		query.append("   SET PATT_DESC = @[patt_desc]" ).append("\n"); 
