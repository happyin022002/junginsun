...
public class KorCllCondVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("in_split_no", getInSplitNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("in_split_no", "inSplitNo");
	 ...
	 * @return inSplitNo
	 */
	public String getInSplitNo() {
		return this.inSplitNo;
	}
	 ...
	 * @param inSplitNo
	 */
	public void setInSplitNo(String inSplitNo) {
		this.inSplitNo = inSplitNo;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setInSplitNo(JSPUtil.getParameter(request, prefix + "in_split_no", ""));
	}
	...
	public KorCllCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] inSplitNo = (JSPUtil.getParameter(request, prefix	+ "in_split_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (inSplitNo[i] != null)
					model.setInSplitNo(inSplitNo[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.inSplitNo = this.inSplitNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
