...
*@FileName : SCRateProposalDBDAOGetMaxBletDpSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOGetMaxBletDpSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOGetMaxBletDpSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOGetMaxBletDpSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
