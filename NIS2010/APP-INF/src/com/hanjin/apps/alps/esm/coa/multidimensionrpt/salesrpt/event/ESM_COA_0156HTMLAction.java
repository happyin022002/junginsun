 ...
 *@FileName       : ESM_COA_156HTMLAction.java
 ...
 *
 * @author Park Eun Ju 
 * @see ESM_COA_0156Event , ESM_COA_0156EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_COA_0156HTMLAction extends HTMLActionSupport {
	 ...
	 */
	public ESM_COA_0156HTMLAction() {
		//
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_COA_0156Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0156Event event = new EsmCoa0156Event();
