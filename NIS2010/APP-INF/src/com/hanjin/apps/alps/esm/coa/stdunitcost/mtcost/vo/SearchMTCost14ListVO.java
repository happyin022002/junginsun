...
*@FileName : SearchMTCost14ListVO.java
*@FileTitle : SearchMTCost14ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost14ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost14ListVO> models = new ArrayList<SearchMTCost14ListVO>();
	...
	public SearchMTCost14ListVO() {}

	public SearchMTCost14ListVO(String ibflag, String pagerows, String costYrmon, String fcntrEccCd, String cntrTpszCd, String eqStatus, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty) {
...
/**
	 ...
	 */
	public SearchMTCost14ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost14ListVO[]
	 */
	public SearchMTCost14ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost14ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCost14ListVO();
		...
		return getSearchMTCost14ListVOs();
	}
	 ...
	 * @return SearchMTCost14ListVO[]
	 */
	public SearchMTCost14ListVO[] getSearchMTCost14ListVOs(){
		SearchMTCost14ListVO[] vos = (SearchMTCost14ListVO[])models.toArray(new SearchMTCost14ListVO[models.size()]);
		return vos;
	}
