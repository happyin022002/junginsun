...
public class TCharterIOContractDAOSearchAgreementPayTermListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOSearchAgreementPayTermListRSQL
	  * </pre>
	  */
	public TCharterIOContractDAOSearchAgreementPayTermListRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("DECODE(ctrt_pay_term_cd,'A','Semi Month','B','15 Days','Month') ctrt_pay_term_cd" ).append("\n"); 
		...
		query.append("FileName : TCharterIOContractDAOSearchAgreementPayTermListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}