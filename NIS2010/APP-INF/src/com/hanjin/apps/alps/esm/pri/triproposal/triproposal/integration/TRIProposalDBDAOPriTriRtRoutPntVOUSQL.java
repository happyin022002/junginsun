...
*@FileName : TRIProposalDBDAOPriTriRtRoutPntVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtRoutPntVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_ROUT_PNT Update
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtRoutPntVOUSQL(){
		setQuery();
		...
		params.put("rout_pnt_loc_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtRoutPntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_TRI_RT_ROUT_PNT SET" ).append("\n"); 
		query.append("ROUT_PNT_LOC_CD = @[rout_pnt_loc_cd]" ).append("\n"); 
