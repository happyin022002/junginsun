...
*@FileName : RsltPriSpDurVO.java
*@FileTitle : RsltPriSpDurVO
*Open Issues :
*Change history :
...
public class RsltPriSpDurVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpDurVO> models = new ArrayList<RsltPriSpDurVO>();
	 ...
	 * @param request
	 * @return RsltPriSpDurVO[]
	 */
	public RsltPriSpDurVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpDurVO[]
	 */
	public RsltPriSpDurVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpDurVO model = null;
	 ...
	 * @return RsltPriSpDurVO[]
	 */
	public RsltPriSpDurVO[] getRsltPriSpDurVOs(){
		RsltPriSpDurVO[] vos = (RsltPriSpDurVO[])models.toArray(new RsltPriSpDurVO[models.size()]);
		return vos;
	}
