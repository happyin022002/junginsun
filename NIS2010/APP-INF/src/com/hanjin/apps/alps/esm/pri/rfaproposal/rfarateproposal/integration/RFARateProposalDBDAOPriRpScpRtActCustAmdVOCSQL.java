...
*@FileName : RFARateProposalDBDAOPriRpScpRtActCustAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtActCustAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFARateProposalDBDAOPriRpScpRtActCustAmdVOCSQL
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtActCustAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtActCustAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    PRI_RP_SCP_RT_ACT_CUST CUST" ).append("\n"); 
