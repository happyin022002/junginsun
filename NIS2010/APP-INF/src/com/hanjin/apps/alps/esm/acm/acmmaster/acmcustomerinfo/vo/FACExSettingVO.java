...
*@FileName : FACExSettingVO.java
*@FileTitle : FACExSettingVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.acm.acmmaster.acmcustomerinfo.vo;
...
public class FACExSettingVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FACExSettingVO> models = new ArrayList<FACExSettingVO>();
	...
	public FACExSettingVO() {}

	public FACExSettingVO(String ibflag, String pagerows, String ffCntSeq, String custLglEngNm, String shprCntSeq, String shprLglEngNm, String facOfcCd, String ffCntCd, String orgFfSeq, String orgShprCntCd, String orgShprSeq, String usrId) {
		this.ibflag = ibflag;
		this.usrId = usrId;
...
/**
	 ...
	 */
	public FACExSettingVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FACExSettingVO[]
	 */
	public FACExSettingVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FACExSettingVO model = null;
	...
	public FACExSettingVO[] getFACExSettingVOs(){
		FACExSettingVO[] vos = (FACExSettingVO[])models.toArray(new FACExSettingVO[models.size()]);
		return vos;
	}
