...
*@FileName : ESM_SPC_0097HTMLAction.java
...
public class ESM_SPC_0097HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0030HTMLAction 객체를 생성
	 */
	public ESM_SPC_0097HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0097Event event = new EsmSpc0097Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSpcBkgCmpbVO((SpcBkgCmpbVO)getVO(request, SpcBkgCmpbVO .class));
		}
