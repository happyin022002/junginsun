...
*@FileName : EBookingReceiptDBDAOSearchXterSIPoOtherNoBkgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchXterSIPoOtherNoBkgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchXterSIPoOtherNoBkgRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOSearchXterSIPoOtherNoBkgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,'BKPO' BKG_REF_TP_CD" ).append("\n"); 
		query.append("      ,NVL(MST.PO_NO,CUST_REF_NO_CTNT) CUST_REF_NO_CTNT" ).append("\n"); 
		...
		query.append("  AND MST.BKG_NO = A.BKG_NO(+)" ).append("\n"); 
		query.append("  AND MST.BKG_NO = B.BKG_NO(+)" ).append("\n"); 
		query.append("  AND B.BKG_REF_TP_CD(+) ='BKPO'" ).append("\n"); 
