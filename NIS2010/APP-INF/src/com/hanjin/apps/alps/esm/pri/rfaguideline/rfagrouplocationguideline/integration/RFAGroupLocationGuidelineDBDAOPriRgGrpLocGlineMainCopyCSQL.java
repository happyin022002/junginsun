...
*@FileName : RFAGroupLocationGuidelineDBDAOPriRgGrpLocGlineMainCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationGuidelineDBDAOPriRgGrpLocGlineMainCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationGuidelineDBDAOPriRgGrpLocGlineMainCopyCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationGuidelineDBDAOPriRgGrpLocGlineMainCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
