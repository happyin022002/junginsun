...
*@FileName : ESM_COA_0154HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Kim Ki Dae
 * @see EsmCoa0154Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_0154HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0154HTMLAction 객체를 생성
	 */
	public ESM_COA_0154HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCoa0154Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0154Event event = new EsmCoa0154Event();  		
