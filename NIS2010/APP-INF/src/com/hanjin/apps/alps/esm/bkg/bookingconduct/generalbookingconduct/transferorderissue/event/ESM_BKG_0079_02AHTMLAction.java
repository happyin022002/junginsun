...
public class ESM_BKG_0079_02AHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0079_02CHTMLAction 객체를 생성
	 */
	public ESM_BKG_0079_02AHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg007902aEvent event = new EsmBkg007902aEvent();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setRtnTroFlg(request.getParameter("rtn_tro_flg"));  //'N'
			...
			//event.getTroVO().setArrBkgTroVO          ((BkgTroVO[])          getVOs(request, BkgTroVO.class,           "t2asheet2_"));
			event.getTroVO().setArrTroMstVO          ((TroMstVO[])          getVOs(request, TroMstVO.class,           "t2asheet2_"));
			event.getTroVO().setArrTroDtlVO          ((TroDtlVO[])          getVOs(request, TroDtlVO.class,           "t2asheet3_"));
			event.getTroVO().setArrBkgTroSpclCgoSeqVO((BkgTroSpclCgoSeqVO[])getVOs(request, BkgTroSpclCgoSeqVO.class, "t2asheet4_"));
			//<--------------------------------------------------
			...
			event.setTroDtlVO((TroDtlVO)getVO(request, TroDtlVO.class));	
		}
