...
public class CLLCDLManifestDBDAOsearchCllSpclCgoSumByPodRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		SELECT DG.POD_CD2 GUBUN_CD2," ).append("\n"); 
		query.append("			BQ.BLCK_STWG_CD AS GUBUN_CD," ).append("\n"); 
		...
		query.append("			DECODE(SUM(LOCAL_RF_40H_R5 + LOCAL_RF_40H_R8 + LOCAL_RF_40H_R9), 0, '', SUM(LOCAL_RF_40H_R5 + LOCAL_RF_40H_R8 + LOCAL_RF_40H_R9)) LOCAL_RF_40H," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			DECODE(SUM(LOCAL_OT_40 + LOCAL_OT_45), 0, '', SUM(LOCAL_OT_40 + LOCAL_OT_45)) LOCAL_OT_40," ).append("\n"); 
		...
		query.append("			DECODE(SUM(TS_RF_40H_R5 + TS_RF_40H_R8 + TS_RF_40H_R9), 0, '', SUM(TS_RF_40H_R5 + TS_RF_40H_R8 + TS_RF_40H_R9)) TS_RF_40H," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			DECODE(SUM(TS_OT_40 + TS_OT_45), 0, '', SUM(TS_OT_40 + TS_OT_45)) TS_OT_40," ).append("\n"); 
		...
		query.append("			DECODE(SUM(LOCAL_RF_40H_R5 + LOCAL_RF_40H_R8 + LOCAL_RF_40H_R9 + TS_RF_40H_R5 + TS_RF_40H_R8 + TS_RF_40H_R9), 0, '', SUM(LOCAL_RF_40H_R5 + LOCAL_RF_40H_R8 + LOCAL_RF_40H_R9 + TS_RF_40H_R5 + TS_RF_40H_R8 + TS_RF_40H_R9)) SUM_RF_40H," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			DECODE(SUM(LOCAL_OT_40 + LOCAL_OT_45 + TS_OT_40 + TS_OT_45), 0, '', SUM(LOCAL_OT_40 + LOCAL_OT_45 + TS_OT_40 + TS_OT_45)) SUM_OT_40," ).append("\n"); 
		...
		query.append("			DG.CLPT_SEQ CLPT_SEQ" ).append("\n"); 
		query.append("		FROM " ).append("\n"); 
		...
		query.append("					GROUP BY NVL(LO.UN_LOC_CD,BV.POD_CD), BK.BLCK_STWG_CD, BK.BKG_NO) DG, " ).append("\n"); 
		query.append("				" ).append("\n"); 
		query.append("					(SELECT NVL(LO.UN_LOC_CD,BV.POD_CD) POD_CD2" ).append("\n"); 
		query.append("						, BK.BLCK_STWG_CD AS BLCK_STWG_CD" ).append("\n"); 
		query.append("						, BK.BKG_NO BKG_NO" ).append("\n"); 
		...
		query.append("								, MAX(DECODE(BV.POL_CD,BK.POL_CD, DECODE(BQ.CNTR_TPSZ_CD,'R5',DECODE(BQ.RC_FLG,'Y',BQ.OP_CNTR_QTY,0),0),0))        LOCAL_RF_40H_R5" ).append("\n"); 
		query.append("								, MAX(DECODE(BV.POL_CD,BK.POL_CD, DECODE(BQ.CNTR_TPSZ_CD,'R8',DECODE(BQ.RC_FLG,'Y',BQ.OP_CNTR_QTY,0),0),0))        LOCAL_RF_40H_R8" ).append("\n"); 
		query.append("								, MAX(DECODE(BV.POL_CD,BK.POL_CD, DECODE(BQ.CNTR_TPSZ_CD,'R9',DECODE(BQ.RC_FLG,'Y',BQ.OP_CNTR_QTY,0),0),0))        LOCAL_RF_40H_R9" ).append("\n"); 
		...
		query.append("								, MAX(DECODE(BV.POL_CD,BK.POL_CD, 0,DECODE(BQ.CNTR_TPSZ_CD,'R5',DECODE(BQ.RC_FLG,'Y',BQ.OP_CNTR_QTY,0),0)))        TS_RF_40H_R5" ).append("\n"); 
		query.append("								, MAX(DECODE(BV.POL_CD,BK.POL_CD, 0,DECODE(BQ.CNTR_TPSZ_CD,'R8',DECODE(BQ.RC_FLG,'Y',BQ.OP_CNTR_QTY,0),0)))        TS_RF_40H_R8" ).append("\n"); 
		query.append("								, MAX(DECODE(BV.POL_CD,BK.POL_CD, 0,DECODE(BQ.CNTR_TPSZ_CD,'R9',DECODE(BQ.RC_FLG,'Y',BQ.OP_CNTR_QTY,0),0)))        TS_RF_40H_R9" ).append("\n"); 
		...
		query.append("						AND NVL(BK.SPLIT_RSN_CD,' ') <> 'M'" ).append("\n"); 
		query.append("						AND BK.BKG_NO = BQ.BKG_NO" ).append("\n"); 
		query.append("					GROUP BY NVL(LO.UN_LOC_CD,BV.POD_CD),BK.BLCK_STWG_CD, BK.BKG_NO " ).append("\n"); 
		...
		query.append("						, SUM(DECODE(BV.POL_CD,BK.POL_CD, DECODE(BQ.CNTR_TPSZ_CD,'O5',BQ.OP_CNTR_QTY,0),0)) LOCAL_OT_40H" ).append("\n"); 
		query.append("						, SUM(DECODE(BV.POL_CD,BK.POL_CD, DECODE(BQ.CNTR_TPSZ_CD,'O7',BQ.OP_CNTR_QTY,0),0)) LOCAL_OT_45" ).append("\n"); 
		query.append("						" ).append("\n"); 
		...
		query.append("						, SUM(DECODE(BV.POL_CD,BK.POL_CD, 0, DECODE(BQ.CNTR_TPSZ_CD,'O5',BQ.OP_CNTR_QTY,0))) TS_OT_40H" ).append("\n"); 
		query.append("						, SUM(DECODE(BV.POL_CD,BK.POL_CD, 0, DECODE(BQ.CNTR_TPSZ_CD,'O7',BQ.OP_CNTR_QTY,0))) TS_OT_45" ).append("\n"); 
		query.append("						" ).append("\n"); 
		...
		query.append("					GROUP BY NVL(LO.UN_LOC_CD,BV.POD_CD), BK.BLCK_STWG_CD , BK.BKG_NO) BQ" ).append("\n"); 
		query.append("				WHERE DG. BKG_NO = RF.BKG_NO" ).append("\n"); 
		query.append("				AND DG. BKG_NO = BQ.BKG_NO" ).append("\n"); 
		query.append("		 " ).append("\n"); 
		query.append("		GROUP BY DG.POD_CD2, DG.CLPT_SEQ, BQ.BLCK_STWG_CD" ).append("\n"); 
		query.append("		ORDER BY DG.CLPT_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("			BLCK_STWG_CD AS GUBUN_CD," ).append("\n"); 
		query.append("			'' GUBUN_CD3," ).append("\n"); 
		query.append("			1 ORDER_GUBUN," ).append("\n"); 
		query.append("			DECODE(SUM(LOCAL_DG_40 + LOCAL_DG_45), 0, '', SUM(LOCAL_DG_40 + LOCAL_DG_45)) LOCAL_DG_40," ).append("\n"); 
		query.append("			DECODE(SUM(LOCAL_DG_20), 0, '', SUM(LOCAL_DG_20)) LOCAL_DG_20," ).append("\n"); 
		...
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_RF_40H_R5," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '8', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_RF_40H_R8,					" ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '9', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_RF_40H_R9," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0), 0), 0), 0) LOCAL_FR_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_FR_20," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_FR_40H," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_FR_45," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0), 0), 0), 0) LOCAL_OT_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_OT_20," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_OT_40H," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, NULL, DECODE(CLL.MTY_BKG_CD, 'F', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 0), 0) LOCAL_OT_45," ).append("\n"); 
		...
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'TS', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0) TS_DG_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'TS', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0) TS_DG_40H," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'TS', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0) TS_DG_45," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'TS', DECODE(DG.IMDG_UN_NO, NULL, 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0) TS_DG_20," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, '8',0,'9', 0, COUNT(CLL.BKG_NO))), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, '8',0,'9', 0, COUNT(CLL.BKG_NO))), 0), 0), 0) TS_RF_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO),  0) ), 0), 0), 0) TS_RF_40H_R5," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '8', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '8', COUNT(CLL.BKG_NO),  0) ), 0), 0), 0) TS_RF_40H_R8," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '9', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '9', COUNT(CLL.BKG_NO),  0) ), 0), 0), 0) TS_RF_40H_R9," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_RF_45," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'R', DECODE(SUBSTR(CLL.CLL_RMK1, 1, 2), NULL, 0, 'RD', 0, 'UD', 0, 'OD', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_RF_20," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '4', COUNT(CLL.BKG_NO), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0), 0), 0) TS_FR_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_FR_20," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_FR_40H," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'F', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'A', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_FR_45," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, COUNT(CLL.BKG_NO))), 0), 0), 0) TS_OT_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_OT_20," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_OT_40H," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 'TS', DECODE(DG.IMDG_UN_NO, NULL, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 1, 1), 'O', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 'S', DECODE(CLL.CLL_RMK1, NULL, 0, 'IN/GU', 0, DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', COUNT(CLL.BKG_NO), 0)), 0), 0), 0) TS_OT_45," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0)), 'TS', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '5', 0, '7', 0, DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0)), 0) TS_PCOD_40," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0), 0), 'TS', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '5', DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0), 0), 0) TS_PCOD_40H," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0), 0), 'TS', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0), 0), 0) TS_PCOD_45," ).append("\n"); 
		query.append("					DECODE(CLL.KR_CLL_TS_CD, 'TT', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0), 0), 'TS', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', DECODE(KR_TML_PRCT_ID, 'P', COUNT(CLL.BKG_NO), 0), 0), 0) TS_PCOD_20," ).append("\n"); 
		query.append("					VPS.CLPT_SEQ CLPT_SEQ" ).append("\n"); 
		query.append("				FROM BKG_CSTMS_TML_KR_CLL CLL, BKG_BOOKING BKG, VSK_VSL_PORT_SKD VPS, (SELECT DISTINCT IMDG_UN_NO FROM BKG_DG_CGO ) DG, MDM_LOCATION LO" ).append("\n"); 
		...
		query.append("					AND LO.LOC_CD = VPS.VPS_PORT_CD" ).append("\n"); 
		...
		query.append("				GROUP BY NVL(LO.UN_LOC_CD, CLL.POD_CD), BKG.BLCK_STWG_CD , KR_CLL_TS_CD, MTY_BKG_CD, CNTR_TPSZ_CD, DG.IMDG_UN_NO, CLL_RMK1, KR_TML_PRCT_ID, VPS.CLPT_SEQ )" ).append("\n"); 
