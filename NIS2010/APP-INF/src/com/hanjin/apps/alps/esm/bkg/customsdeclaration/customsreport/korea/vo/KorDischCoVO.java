...
public class KorDischCoVO extends DischCoVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDischCoVO> models = new ArrayList<KorDischCoVO>();
	...
	public KorDischCoVO(String ibflag, String pagerows, String portCd, String cstmsDchgCoId, String cstmsDchgCoNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public KorDischCoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfBerthCdVO[]
	 */
	public KorDischCoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDischCoVO model = null;
	 ...
	 * @return KrWhfBerthCdVO[]
	 */
	public KorDischCoVO[] getKorDischCoVOs(){
		KorDischCoVO[] vos = (KorDischCoVO[])models.toArray(new KorDischCoVO[models.size()]);
		return vos;
	}
