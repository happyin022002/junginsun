...
----------------------------------------------------------
 History
* 2010.12.09 최도순 [CHM-201007310] BKG C/M 화면에 DG SEQ 선택 필드 (구주 24 HR)
...
public class CmBkgInfoVO extends AbstractValueObject {
	...
	/* Column Info */
	private String trFlg = null;
	/* Column Info */
	private String usFrobFlg = null;
	/* Column Info */
	private String ruFlg = null;
	/* Column Info */
	private String hsEuFlg = null;
	...
	public CmBkgInfoVO(String ibflag, String pagerows, String bkgNo, String blNo, String blTpCd, String tVvd, String vslCd, String skdVoyNo, String skdDirCd, String bkgCgoTpCd, String porCd, String polCd, String podCd, String delCd, String preRlyPortCd, String pstRlyPortCd, String bkgRcvTermCd, String bkgDeTermCd, String cmdtCd, String repCmdtCd, String bkgStsCd, String cmdtNm, String bdrFlg, String corrFlg, String htsFlg, String bkgPckQty, String bkgPckUnit, String bkgWgtQty, String bkgWgtUnit, String bkgMeasQty, String bkgMeasUnit, String shprCntCd, String shprSeq, String shprNm, String cneeCntCd, String cneeSeq, String cneeNm, String bkgMkDesc, String bkgCstmsDesc, String mypkgFlg, String creUsrId, String updUsrId, String eurFlg, String deFlg, String stwgCd, String trFlg, String usFrobFlg, String ruFlg, String hsEuFlg) {
		...
		this.stwgCd = stwgCd;
		this.trFlg = trFlg;
		this.usFrobFlg = usFrobFlg;
		this.ruFlg = ruFlg;
		this.hsEuFlg = hsEuFlg;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("de_flg", getDeFlg());
		this.hashColumns.put("stwg_cd", getStwgCd());
		this.hashColumns.put("tr_flg", getTrFlg());
		this.hashColumns.put("us_frob_flg", getUsFrobFlg());
		this.hashColumns.put("ru_flg", getRuFlg());
		this.hashColumns.put("hs_eu_flg", getHsEuFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("de_flg", "deFlg");
		this.hashFields.put("stwg_cd", "stwgCd");
		this.hashFields.put("tr_flg", "trFlg");
		this.hashFields.put("ru_flg", "ruFlg");
		this.hashFields.put("hs_eu_flg", "hsEuFlg");
	 ...
	 * @return usFrobFlg
	 */
	public String getUsFrobFlg() {
		return this.usFrobFlg;
	}
	 ...
	 * @param ruFlg
	 */
	public void setRuFlg(String ruFlg) {
		this.ruFlg = ruFlg;
	}
	 ...
	 * @param trFlg
	 */
	public void setTrFlg(String trFlg) {
		this.trFlg = trFlg;
	}
	 ...
	 * @param hsEuFlg
	 */
	public void setHsEuFlg(String hsEuFlg) {
		this.hsEuFlg = hsEuFlg;
	}
	 ...
	 * @param usFrobFlg
	 */
	public void setUsFrobFlg(String usFrobFlg) {
		this.usFrobFlg = usFrobFlg;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTrFlg(JSPUtil.getParameter(request, prefix + "tr_flg", ""));
		...
		setDeFlg(JSPUtil.getParameter(request, prefix + "de_flg", ""));
		setStwgCd(JSPUtil.getParameter(request, prefix + "stwg_cd", ""));
		setUsFrobFlg(JSPUtil.getParameter(request, prefix + "us_frob_flg", ""));
		setRuFlg(JSPUtil.getParameter(request, prefix + "ru_flg", ""));
		setHsEuFlg(JSPUtil.getParameter(request, prefix + "hs_eu_flg", ""));
	}
	...
	public CmBkgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] deFlg = (JSPUtil.getParameter(request, prefix	+ "de_flg", length));
			String[] stwgCd = (JSPUtil.getParameter(request, prefix	+ "stwg_cd", length));
			String[] trFlg = (JSPUtil.getParameter(request, prefix	+ "tr_flg", length));
			String[] usFrobFlg = (JSPUtil.getParameter(request, prefix	+ "us_frob_flg", length));
			String[] ruFlg = (JSPUtil.getParameter(request, prefix	+ "ru_flg", length));
			String[] hsEuFlg = (JSPUtil.getParameter(request, prefix	+ "hs_eu_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (trFlg[i] != null)
					model.setTrFlg(trFlg[i]);
				if (usFrobFlg[i] != null)
					model.setUsFrobFlg(usFrobFlg[i]);
				if (ruFlg[i] != null)
					model.setRuFlg(ruFlg[i]);
				if (hsEuFlg[i] != null)
					model.setHsEuFlg(hsEuFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.trFlg = this.trFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ruFlg = this.ruFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.usFrobFlg = this.usFrobFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.hsEuFlg = this.hsEuFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
