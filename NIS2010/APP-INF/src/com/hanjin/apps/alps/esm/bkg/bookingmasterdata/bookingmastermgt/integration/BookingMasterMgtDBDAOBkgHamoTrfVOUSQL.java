...
*@FileName : BookingMasterMgtDBDAOBkgHamoTrfVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOBkgHamoTrfVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * HamoTrf code update 쿼리
	  * </pre>
	  */
	public BookingMasterMgtDBDAOBkgHamoTrfVOUSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOBkgHamoTrfVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",   hamo_tp_cd = @[hamo_tp_cd]" ).append("\n"); 
		query.append(",	hamo_trf_cd = @[hamo_trf_cd]" ).append("\n"); 
		query.append(",	hamo_cd_desc = @[hamo_cd_desc]" ).append("\n"); 
		query.append(",	fda_decl_flg = @[fda_decl_flg]" ).append("\n"); 
