...
*@FileName : RFARateQuotationDBDAORsltPriPrsCostDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriPrsCostDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriPrsCostDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriPrsCostDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* qttn_no,qttn_ver_no,cmdt_hdr_seq,rout_seq,rt_seq, rout_cs_no,rout_cs_src_dt,cost_tp  파라메터 추가*/" ).append("\n"); 
