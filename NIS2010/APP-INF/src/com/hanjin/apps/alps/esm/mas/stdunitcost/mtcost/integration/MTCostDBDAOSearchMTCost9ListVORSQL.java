...
*@FileName : MTCostDBDAOSearchMTCost9ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCost9ListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MAS_FULL_ECC_IMBAL 테이블의 데이터 조회    - 품질향상
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCost9ListVORSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCost9ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,@[p_ori_dest] ORI_DEST" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	,'' AS F_CNTR_TPSZ_CD3" ).append("\n"); 
		query.append("	,'' AS F_COST_YRMON" ).append("\n"); 
		query.append("	,'' AS F_ECC_CD3" ).append("\n"); 
		query.append("	,'' AS F_ORI_DEST2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("  FROM (SELECT COST_YRMON " ).append("\n"); 
		query.append("              ,FCNTR_ECC_CD " ).append("\n"); 
		query.append("              ,CNTR_TPSZ_CD " ).append("\n"); 
		query.append("              ,CNTR_IO_VOL_STS_CD " ).append("\n"); 
		query.append("              ,MAS_GET_CD_NM_FNC('CD00849', NVL(CNTR_IO_VOL_STS_CD, 'X')) EQ_STATUS " ).append("\n"); 
