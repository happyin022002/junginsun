...
*@FileName : ESM_BKG_0927HTMLAction.java
...
public class ESM_BKG_0927HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0927HTMLAction 객체를 생성
	 */
	public ESM_BKG_0927HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0927Event event = new EsmBkg0927Event();
...
//			String form_Rate = JSPUtil.getParameter(request, "form_Rate");
