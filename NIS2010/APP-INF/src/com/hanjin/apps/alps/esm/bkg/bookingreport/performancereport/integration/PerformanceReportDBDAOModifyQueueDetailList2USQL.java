...
*@FileName : PerformanceReportDBDAOModifyQueueDetailList2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOModifyQueueDetailList2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOModifyQueueDetailList2USQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOModifyQueueDetailList2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET	PND_FLG = 'Y' /* 상수 */" ).append("\n"); 
		query.append("   ,PND_USR_ID = @[usr_id]" ).append("\n"); 
		query.append("   ,PND_DT = DPCS_DOC_FM_DT" ).append("\n"); 
		...
		query.append("AND SR_KND_CD =DECODE(@[src_cd],'FAX','F','EDI','E','DeskTop','D','SEA-NACCS','S','E-MAIL','M',@[src_cd]) /* 0421의 SRC_CD*/" ).append("\n"); 
