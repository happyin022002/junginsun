...
*@FileName : PSASpecialManifestDBDAOPsaDGRcvMsgDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOPsaDGRcvMsgDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PsaDGRcvMsgDtlVO 생성을 위해 사용
	  * </pre>
	  */
	public PSASpecialManifestDBDAOPsaDGRcvMsgDtlVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.terminaldocumentation.psaspecialmanifest.integration").append("\n"); 
		query.append("FileName : PSASpecialManifestDBDAOPsaDGRcvMsgDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
