...
*@FileName : RFAProposalMainDBDAOPriRpProgAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpProgAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAProposalMainDBDAOPriRpProgAmdVO
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpProgAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpProgAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_RP_PROG" ).append("\n"); 
