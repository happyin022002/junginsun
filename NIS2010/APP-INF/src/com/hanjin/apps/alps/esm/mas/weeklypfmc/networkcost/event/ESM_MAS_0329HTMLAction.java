...
**@FileName : ESM_MAS_0329HTMLAction.java
 ...
 * @author Je Ryang Yoo
 * @see EsmMas0329Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0329HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0329HTMLAction 객체를 생성
	 */
	public ESM_MAS_0329HTMLAction() {}//
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0329Event event = new EsmMas0329Event();  		
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setSearchAvgHireOwnVslDtrbListVOs((SearchAvgHireOwnVslDtrbListVO[])getVOs(request, SearchAvgHireOwnVslDtrbListVO.class));
