...
*@FileName : QtaAdjustmentDBDAOCompareWithHORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAOCompareWithHORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public QtaAdjustmentDBDAOCompareWithHORSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAOCompareWithHORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'COMPARISON_WITH_HO_LOADING_'||COMPARISON_WITH_HO_LOADING AS HOL_RESULT" ).append("\n"); 
		query.append("	,'COMPARISON_WITH_HO_CONTRACT_'||COMPARISON_WITH_HO_CONTRACT AS HOC_RESULT" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("    SELECT COMPARISON_WITH_HO_LOADING, COMPARISON_WITH_HO_CONTRACT" ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("    (" ).append("\n"); 
		query.append("        WITH PORTION_ADJUST_HO_LOADING AS" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("            (" ).append("\n"); 
		query.append("                SELECT TRD_CD, SUB_TRD_CD, RLANE_CD, DIR_CD, MIN(HO_APLY_FM_YRWK_LOADING) AS HO_APLY_FM_YRWK_LOADING, MAX(HO_APLY_TO_YRWK_LOADING) AS HO_APLY_TO_YRWK_LOADING " ).append("\n"); 
		query.append("                FROM" ).append("\n"); 
		query.append("                (" ).append("\n"); 
		query.append("                    SELECT A2.TRD_CD, A2.SUB_TRD_CD, A2.RLANE_CD, A2.DIR_CD, A2.APLY_FM_YRWK AS HO_APLY_FM_YRWK_LOADING, A2.APLY_TO_YRWK AS HO_APLY_TO_YRWK_LOADING" ).append("\n"); 
		...
		query.append("            (" ).append("\n"); 
		query.append("                SELECT TRD_CD, SUB_TRD_CD, RLANE_CD, DIR_CD, '999999' AS HO_APLY_FM_YRWK_LOADING, '999999' AS HO_APLY_TO_YRWK_LOADING" ).append("\n"); 
		query.append("                FROM" ).append("\n"); 
		query.append("                (" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("        )" ).append("\n"); 
		query.append("        ,PORTION_ADJUST_HO_CONTRACT AS" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("            (" ).append("\n"); 
		query.append("                SELECT TRD_CD, SUB_TRD_CD, RLANE_CD, DIR_CD, MIN(HO_APLY_FM_YRWK_CONTRACT) AS HO_APLY_FM_YRWK_CONTRACT, MAX(HO_APLY_TO_YRWK_CONTRACT) AS HO_APLY_TO_YRWK_CONTRACT " ).append("\n"); 
		query.append("                FROM" ).append("\n"); 
		query.append("                (" ).append("\n"); 
		query.append("                    SELECT A2.TRD_CD, A2.SUB_TRD_CD, A2.RLANE_CD, A2.DIR_CD, A2.APLY_FM_YRWK AS HO_APLY_FM_YRWK_CONTRACT, A2.APLY_TO_YRWK AS HO_APLY_TO_YRWK_CONTRACT" ).append("\n"); 
		query.append("                      FROM SQM_QTA_LANE_OFC A1" ).append("\n"); 
		query.append("                          ,SQM_CFM_QTA_POTN_MGMT A2" ).append("\n"); 
		query.append("                          ,SQM_DAT_RLT A3" ).append("\n"); 
		query.append("                          ,MAS_LANE_RGST A4" ).append("\n"); 
		...
		query.append("            UNION ALL" ).append("\n"); 
		query.append("            (" ).append("\n"); 
		query.append("                SELECT TRD_CD, SUB_TRD_CD, RLANE_CD, DIR_CD, '999999' AS HO_APLY_FM_YRWK_CONTRACT, '999999' AS HO_APLY_TO_YRWK_CONTRACT" ).append("\n"); 
		query.append("                FROM" ).append("\n"); 
		query.append("                (" ).append("\n"); 
		query.append("                    SELECT DISTINCT A2.TRD_CD, A2.SUB_TRD_CD, A2.RLANE_CD, A2.DIR_CD, A2.TRD_CD||A2.SUB_TRD_CD||A2.RLANE_CD||A2.DIR_CD AS TSRD" ).append("\n"); 
		query.append("                        FROM MAS_LANE_RGST A1, " ).append("\n"); 
		...
		query.append("                            WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) = SUBSTR(HO_APLY_FM_YRWK_LOADING,1,4)  -- HO FROM YEAR 비교" ).append("\n"); 
		query.append("                            THEN " ).append("\n"); 
		query.append("                                (" ).append("\n"); 
		query.append("                                    CASE " ).append("\n"); 
		query.append("                                        WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) = SUBSTR(HO_APLY_TO_YRWK_LOADING,1,4) -- HO TO YEAR 비교" ).append("\n"); 
		query.append("                                        THEN " ).append("\n"); 
		query.append("                                            (" ).append("\n"); 
		query.append("                                                CASE " ).append("\n"); 
		query.append("                                                  WHEN BSE_WK >= SUBSTR(HO_APLY_FM_YRWK_LOADING,5) -- HO FROM WEEK 비교" ).append("\n"); 
		query.append("                                                  THEN " ).append("\n"); 
		query.append("                                                    (" ).append("\n"); 
		query.append("                                                        CASE" ).append("\n"); 
		query.append("                                                            WHEN BSE_WK <= SUBSTR(HO_APLY_TO_YRWK_LOADING,5) -- HO TO WEEK 비교" ).append("\n"); 
		query.append("                                                            THEN 'SAME'" ).append("\n"); 
		query.append("                                                            ELSE 'DIFFERENT!'||HL.TRD_CD||'!'||HL.SUB_TRD_CD||'!'||HL.RLANE_CD||'!'||HL.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                                                        END" ).append("\n"); 
		query.append("                                                    )" ).append("\n"); 
		query.append("                                                  ELSE 'DIFFERENT!'||HL.TRD_CD||'!'||HL.SUB_TRD_CD||'!'||HL.RLANE_CD||'!'||HL.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                                                END" ).append("\n"); 
		...
		query.append("                                    END" ).append("\n"); 
		query.append("                                )" ).append("\n"); 
		query.append("                            WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) > SUBSTR(HO_APLY_FM_YRWK_LOADING,1,4)  " ).append("\n"); 
		query.append("                            THEN 'SAME'" ).append("\n"); 
		query.append("                            WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) < SUBSTR(HO_APLY_FM_YRWK_LOADING,1,4)" ).append("\n"); 
		query.append("                            THEN 'DIFFERENT!'||HL.TRD_CD||'!'||HL.SUB_TRD_CD||'!'||HL.RLANE_CD||'!'||HL.DIR_CD||'!'||BSE_WK  " ).append("\n"); 
		query.append("                        END" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("                    WHEN SLS_YR = SUBSTR(HO_APLY_FM_YRWK_LOADING,1,4)  -- HO FROM YEAR 비교" ).append("\n"); 
		query.append("                    THEN " ).append("\n"); 
		query.append("                        (" ).append("\n"); 
		query.append("                            CASE " ).append("\n"); 
		query.append("                                WHEN SLS_YR = SUBSTR(HO_APLY_TO_YRWK_LOADING,1,4) -- HO TO YEAR 비교" ).append("\n"); 
		query.append("                                THEN " ).append("\n"); 
		query.append("                                    (" ).append("\n"); 
		query.append("                                        CASE " ).append("\n"); 
		query.append("                                          WHEN BSE_WK >= SUBSTR(HO_APLY_FM_YRWK_LOADING,5) -- HO FROM WEEK 비교" ).append("\n"); 
		...
		query.append("                            END" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("                    WHEN SLS_YR > SUBSTR(HO_APLY_FM_YRWK_LOADING,1,4)  " ).append("\n"); 
		query.append("                    THEN 'SAME'" ).append("\n"); 
		query.append("                    WHEN SLS_YR < SUBSTR(HO_APLY_FM_YRWK_LOADING,1,4)" ).append("\n"); 
		query.append("                    THEN 'DIFFERENT!'||HL.TRD_CD||'!'||HL.SUB_TRD_CD||'!'||HL.RLANE_CD||'!'||HL.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                    END AS COMPARISON_WITH_HO_LOADING    " ).append("\n"); 
		query.append("               ,CASE" ).append("\n"); 
		query.append("                    WHEN BSE_WK IN ('00', '53')" ).append("\n"); 
		query.append("                    THEN" ).append("\n"); 
		query.append("                        (" ).append("\n"); 
		query.append("                        CASE" ).append("\n"); 
		query.append("                            WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) = SUBSTR(HO_APLY_FM_YRWK_CONTRACT,1,4)  -- HO FROM YEAR 비교" ).append("\n"); 
		query.append("                            THEN " ).append("\n"); 
		query.append("                                (" ).append("\n"); 
		query.append("                                    CASE " ).append("\n"); 
		query.append("                                        WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) = SUBSTR(HO_APLY_TO_YRWK_CONTRACT,1,4) -- HO TO YEAR 비교" ).append("\n"); 
		query.append("                                        THEN " ).append("\n"); 
		query.append("                                            (" ).append("\n"); 
		query.append("                                                CASE " ).append("\n"); 
		query.append("                                                  WHEN BSE_WK >= SUBSTR(HO_APLY_FM_YRWK_CONTRACT,5) -- HO FROM WEEK 비교" ).append("\n"); 
		query.append("                                                  THEN " ).append("\n"); 
		query.append("                                                    (" ).append("\n"); 
		query.append("                                                        CASE" ).append("\n"); 
		query.append("                                                            WHEN BSE_WK <= SUBSTR(HO_APLY_TO_YRWK_CONTRACT,5) -- HO TO WEEK 비교" ).append("\n"); 
		query.append("                                                            THEN 'SAME'" ).append("\n"); 
		query.append("                                                            ELSE 'DIFFERENT!'||HC.TRD_CD||'!'||HC.SUB_TRD_CD||'!'||HC.RLANE_CD||'!'||HC.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                                                        END" ).append("\n"); 
		query.append("                                                    )" ).append("\n"); 
		query.append("                                                  ELSE 'DIFFERENT!'||HC.TRD_CD||'!'||HC.SUB_TRD_CD||'!'||HC.RLANE_CD||'!'||HC.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                                                END" ).append("\n"); 
		...
		query.append("                                    END" ).append("\n"); 
		query.append("                                )" ).append("\n"); 
		query.append("                            WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) > SUBSTR(HO_APLY_FM_YRWK_CONTRACT,1,4)  " ).append("\n"); 
		query.append("                            THEN 'SAME'" ).append("\n"); 
		query.append("                            WHEN NVL((SELECT SUBSTR(MMV.COST_YRMON, 1, 4) FROM MAS_MON_VVD MMV WHERE MMV.TRD_CD = A2.TRD_CD AND MMV.RLANE_CD = A2.RLANE_CD AND MMV.VSL_CD = SUBSTR(A2.VVD,1,4) AND MMV.SKD_VOY_NO = SUBSTR(A2.VVD,5,8) AND MMV.DIR_CD = SUBSTR(A2.VVD,9,9)),SLS_YR) < SUBSTR(HO_APLY_FM_YRWK_CONTRACT,1,4)  " ).append("\n"); 
		query.append("                            THEN 'DIFFERENT!'||HC.TRD_CD||'!'||HC.SUB_TRD_CD||'!'||HC.RLANE_CD||'!'||HC.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                        END" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("                    WHEN SLS_YR = SUBSTR(HO_APLY_FM_YRWK_CONTRACT,1,4)  -- HO FROM YEAR 비교" ).append("\n"); 
		query.append("                    THEN " ).append("\n"); 
		query.append("                        (" ).append("\n"); 
		query.append("                            CASE " ).append("\n"); 
		query.append("                                WHEN SLS_YR = SUBSTR(HO_APLY_TO_YRWK_CONTRACT,1,4) -- HO TO YEAR 비교" ).append("\n"); 
		query.append("                                THEN " ).append("\n"); 
		query.append("                                    (" ).append("\n"); 
		query.append("                                        CASE " ).append("\n"); 
		query.append("                                          WHEN BSE_WK >= SUBSTR(HO_APLY_FM_YRWK_CONTRACT,5) -- HO FROM WEEK 비교" ).append("\n"); 
		...
		query.append("                            END" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("                    WHEN SLS_YR > SUBSTR(HO_APLY_FM_YRWK_CONTRACT,1,4)  " ).append("\n"); 
		query.append("                    THEN 'SAME'" ).append("\n"); 
		query.append("                    WHEN SLS_YR < SUBSTR(HO_APLY_FM_YRWK_CONTRACT,1,4)  " ).append("\n"); 
		query.append("                    THEN 'DIFFERENT!'||HC.TRD_CD||'!'||HC.SUB_TRD_CD||'!'||HC.RLANE_CD||'!'||HC.DIR_CD||'!'||BSE_WK" ).append("\n"); 
		query.append("                    END AS COMPARISON_WITH_HO_CONTRACT" ).append("\n"); 
		query.append("            " ).append("\n"); 
		query.append("            FROM MAS_LANE_RGST A1, " ).append("\n"); 
		query.append("                 (" ).append("\n"); 
		query.append("                   SELECT O_QTA_RLSE_VER_NO  AS QTA_RLSE_VER_NO" ).append("\n"); 
		...
		query.append("                         ,O_VVD" ).append("\n"); 
		query.append("                 )A2" ).append("\n"); 
		query.append("                 ,PORTION_ADJUST_HO_LOADING HL" ).append("\n"); 
		query.append("                 ,PORTION_ADJUST_HO_CONTRACT HC" ).append("\n"); 
		query.append("        WHERE A1.TRD_CD         = A2.TRD_CD" ).append("\n"); 
		query.append("        AND A1.SUB_TRD_CD       = A2.SUB_TRD_CD" ).append("\n"); 
		query.append("        AND A1.RLANE_CD         = A2.RLANE_CD" ).append("\n"); 
		query.append("        AND A1.DIR_CD           = A2.DIR_CD" ).append("\n"); 
		query.append("        AND A1.IOC_CD           = A2.IOC_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        AND A1.TRD_CD           = HL.TRD_CD" ).append("\n"); 
		query.append("        AND A1.SUB_TRD_CD       = HL.SUB_TRD_CD" ).append("\n"); 
		query.append("        AND A1.RLANE_CD         = HL.RLANE_CD" ).append("\n"); 
		query.append("        AND A1.DIR_CD           = HL.DIR_CD" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("        AND A1.TRD_CD           = HC.TRD_CD" ).append("\n"); 
		query.append("        AND A1.SUB_TRD_CD       = HC.SUB_TRD_CD" ).append("\n"); 
		query.append("        AND A1.RLANE_CD         = HC.RLANE_CD" ).append("\n"); 
		query.append("        AND A1.DIR_CD           = HC.DIR_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        #if (${f_portion_link} != '' && ${f_portion_link} != 'All')" ).append("\n"); 
		query.append("        AND DECODE(SQM_CNG_TP_CD, 'I', 'Y', 'N') = @[f_portion_link]" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		...
		query.append("    )" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("WHERE COMPARISON_WITH_HO_LOADING LIKE 'DIFFERENT%'" ).append("\n"); 
		query.append(" OR COMPARISON_WITH_HO_CONTRACT LIKE 'DIFFERENT%'" ).append("\n"); 
