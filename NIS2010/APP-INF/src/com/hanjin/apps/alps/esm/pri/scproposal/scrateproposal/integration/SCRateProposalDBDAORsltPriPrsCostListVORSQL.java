...
*@FileName : SCRateProposalDBDAORsltPriPrsCostListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriPrsCostListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriPrsCostListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriPrsCostListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   , '' AS IS_ONLINE_CALL" ).append("\n"); 
