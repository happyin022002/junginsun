...
*@FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocMaxGrpLocDtlSeqRSQL.java
...
public class SCGroupLocationQuotationDBDAOPriSqGrpLocMaxGrpLocDtlSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAOPriSqGrpLocMaxGrpLocDtlSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocMaxGrpLocDtlSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(MAX(GRP_LOC_DTL_SEQ)+1,1) AS MAX_GRP_LOC_DTL_SEQ" ).append("\n"); 
