...
*@FileName : AGTAuditDBDAODimensionReportbyMultiOptionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAODimensionReportbyMultiOptionRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTAuditDBDAODimensionReportbyMultiOptionRSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAODimensionReportbyMultiOptionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
