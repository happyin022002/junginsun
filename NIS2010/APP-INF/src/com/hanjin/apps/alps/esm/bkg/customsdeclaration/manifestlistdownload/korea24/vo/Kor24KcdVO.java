...
*@FileName : Kor24KcdVO.java
*@FileTitle : Kor24KcdVO
*Open Issues :
*Change history :
...
public class Kor24KcdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24KcdVO> models = new ArrayList<Kor24KcdVO>();
	...
	public Kor24KcdVO(String ibflag, String pagerows, String cstmsDeclTpCd, String bkgNo, String trnsSeq, String dmstPortCd, String vvd) {
		this.vvd = vvd;
...
/**
	 ...
	 * @return Kor24KcdVO[]
	 */
	public Kor24KcdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24KcdVO[]
	 */
	public Kor24KcdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24KcdVO model = null;
	 ...
	 * @return Kor24KcdVO[]
	 */
	public Kor24KcdVO[] getKor24KcdVOs(){
		Kor24KcdVO[] vos = (Kor24KcdVO[])models.toArray(new Kor24KcdVO[models.size()]);
		return vos;
	}
