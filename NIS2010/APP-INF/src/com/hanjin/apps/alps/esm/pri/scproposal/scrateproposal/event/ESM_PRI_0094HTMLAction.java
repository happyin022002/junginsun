 ...
 *@FileName : UI_PRI_0094HTMLAction.java
 *@FileTitle : ESM_PRI_0094HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_0094HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0094Event event = new EsmPri0094Event();

		if (command.isCommand(FormCommand.MODIFY01)) {
			event.setPriSpScpRtRoutDirVOS((PriSpScpRtRoutDirVO[]) getVOs(request, PriSpScpRtRoutDirVO.class, ""));
