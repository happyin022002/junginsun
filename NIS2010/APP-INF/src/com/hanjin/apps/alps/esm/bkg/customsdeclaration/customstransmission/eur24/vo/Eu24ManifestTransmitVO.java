...
*@FileName : Eu24ManifestTransmitVO.java
*@FileTitle : Eu24ManifestTransmitVO
*Open Issues :
*Change history :
...
public class Eu24ManifestTransmitVO extends ManifestTransmitVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eu24ManifestTransmitVO> models = new ArrayList<Eu24ManifestTransmitVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("prtPgmNo", getPrtPgmNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("prtPgmNo", "prtPgmNo");
	 ...
	 * @return prtPgmNo
	 */
	public String getPrtPgmNo() {
		return this.prtPgmNo;
	}
	 ...
	 * @param prtPgmNo
	 */
	public void setPrtPgmNo(String prtPgmNo) {
		this.prtPgmNo = prtPgmNo;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPrtPgmNo(JSPUtil.getParameter(request, prefix + "prtPgmNo", ""));
	 ...
	 * @param request
	 * @return Eu24ManifestTransmitVO[]
	 */
	public Eu24ManifestTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eu24ManifestTransmitVO[]
	 */
	public Eu24ManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eu24ManifestTransmitVO model = null;
		...
		try {
			...
			String[] prtPgmNo = (JSPUtil.getParameter(request, prefix	+ "prtPgmNo", length));
			...
			for (int i = 0; i < length; i++) {
				model = new Eu24ManifestTransmitVO();
				if (vslCd[i] != null)
		...
		return getEu24ManifestTransmitVOs();
	}
	...
	public Eu24ManifestTransmitVO[] getEu24ManifestTransmitVOs(){
		Eu24ManifestTransmitVO[] vos = (Eu24ManifestTransmitVO[])models.toArray(new Eu24ManifestTransmitVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.prtPgmNo = this.prtPgmNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
