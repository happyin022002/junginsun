...
*@FileName : ESM_MAS_054HTMLAction.java
 ...
 *
 * @author Park Eun Ju
 * @see EsmMas0054Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0054HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0054HTMLAction 객체를 생성
	 */
	public ESM_MAS_0054HTMLAction() {
		//
	}
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_MAS_056Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0054Event event = new EsmMas0054Event();
    	HashMap hash = new HashMap();
    	hash = Utils.requestToHashMap(request);
  	    if(command.isCommand(FormCommand.SEARCHLIST)){	
  	    	event.setSearchReportConditionVO((SearchReportConditionVO)getVO(request, SearchReportConditionVO .class));
