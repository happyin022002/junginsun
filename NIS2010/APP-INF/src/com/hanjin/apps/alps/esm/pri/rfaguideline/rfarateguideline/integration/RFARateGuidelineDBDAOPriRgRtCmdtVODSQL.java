...
*@FileName : RFARateGuidelineDBDAOPriRgRtCmdtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOPriRgRtCmdtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOPriRgRtCmdtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOPriRgRtCmdtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RG_RT_CMDT" ).append("\n"); 
