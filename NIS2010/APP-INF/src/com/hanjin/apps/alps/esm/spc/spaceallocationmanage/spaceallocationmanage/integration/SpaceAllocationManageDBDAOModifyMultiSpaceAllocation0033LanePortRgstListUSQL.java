...
*@FileName : SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LanePortRgstListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LanePortRgstListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyMultiSpaceAllocation0033LanePortRgstList
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LanePortRgstListUSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LanePortRgstListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SPC_LANE_PORT_RGST" ).append("\n"); 
