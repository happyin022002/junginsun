...
*@FileName : StatusManageDBDAORemoveQtaPotnMgmtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAORemoveQtaPotnMgmtDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * HO Creation, RHQ Creation 전 데이터 삭제 처리
	  * </pre>
	  */
	public StatusManageDBDAORemoveQtaPotnMgmtDSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAORemoveQtaPotnMgmtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SQM_QTA_POTN_MGMT" ).append("\n"); 
