...
*@FileName : KorDiscHeadInfoVO.java
*@FileTitle : KorDiscHeadInfoVO
*Open Issues :
*Change history :
...
public class KorDiscHeadInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDiscHeadInfoVO> models = new ArrayList<KorDiscHeadInfoVO>();
	...
	public KorDiscHeadInfoVO() {}

	public KorDiscHeadInfoVO(String ibflag, String pagerows, String mrnNo, String mrnChkNo, String vslCd, String skdVoyNo, String skdDirCd, String portCd, String ioBndCd, String coNm) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 */
	public KorDiscHeadInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDiscHeadInfoVO[]
	 */
	public KorDiscHeadInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDiscHeadInfoVO model = null;
	 ...
	 * @return KorDiscHeadInfoVO[]
	 */
	public KorDiscHeadInfoVO[] getKorDiscHeadInfoVOs(){
		KorDiscHeadInfoVO[] vos = (KorDiscHeadInfoVO[])models.toArray(new KorDiscHeadInfoVO[models.size()]);
		return vos;
	}
