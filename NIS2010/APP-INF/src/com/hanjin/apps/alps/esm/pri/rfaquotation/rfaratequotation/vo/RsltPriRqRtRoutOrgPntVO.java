...
*@FileName : RsltPriRqRtRoutOrgPntVO.java
*@FileTitle : RsltPriRqRtRoutOrgPntVO
*Open Issues :
*Change history :
...
public class RsltPriRqRtRoutOrgPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRqRtRoutOrgPntVO> models = new ArrayList<RsltPriRqRtRoutOrgPntVO>();
...
/**
	 ...
	 * @param request
	 * @return RsltPriRqRtRoutOrgPntVO[]
	 */
	public RsltPriRqRtRoutOrgPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqRtRoutOrgPntVO[]
	 */
	public RsltPriRqRtRoutOrgPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqRtRoutOrgPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriRqRtRoutOrgPntVO();
				if (updDt[i] != null)
		...
		return getRsltPriRqRtRoutOrgPntVOs();
	}
	 ...
	 * @return RsltPriRqRtRoutOrgPntVO[]
	 */
	public RsltPriRqRtRoutOrgPntVO[] getRsltPriRqRtRoutOrgPntVOs(){
		RsltPriRqRtRoutOrgPntVO[] vos = (RsltPriRqRtRoutOrgPntVO[])models.toArray(new RsltPriRqRtRoutOrgPntVO[models.size()]);
		return vos;
	}
