 ...
 *@FileName : ESM_BKG_959HTMLAction.java
...
public class ESM_BKG_0959HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;

    /**
     * ESM_BKG_959HTMLAction 객체를 생성
     */
    public ESM_BKG_0959HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0959Event event = new EsmBkg0959Event();
        log.debug("***** ESM_BKG_959HTMLAction : " + command.getCommand());

        String orgCntrMfNo = JSPUtil.getParameter(request, "org_cntr_mf_no", "");
        
        event.setOrgCntrMfNo(orgCntrMfNo);
