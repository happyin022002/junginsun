...
*@FileName : UsaACECustomsTransmissionDBDAOsearchMiHiHeaderFooterOBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaACECustomsTransmissionDBDAOsearchMiHiHeaderFooterOBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UsaACECustomsTransmissionDBDAOsearchMiHiHeaderFooterOBRSQL
	  * </pre>
	  */
	public UsaACECustomsTransmissionDBDAOsearchMiHiHeaderFooterOBRSQL(){
		setQuery();
		...
		query.append("FileName : UsaACECustomsTransmissionDBDAOsearchMiHiHeaderFooterOBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 RPAD(substr(@[vsl_eng_nm],1,23), 23, ' ')||substr(@[vvd],5,5)||" ).append("\n"); 
		query.append("     LPAD(TO_CHAR('     '),5,'0')||'      '||' '||@[vsl_lloyd]||'Y',80,' ')||CHR(10)||		  " ).append("\n"); 
