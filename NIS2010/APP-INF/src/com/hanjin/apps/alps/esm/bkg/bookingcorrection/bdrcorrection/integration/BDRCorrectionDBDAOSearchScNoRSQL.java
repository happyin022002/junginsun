...
*@FileName : BDRCorrectionDBDAOSearchScNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BDRCorrectionDBDAOSearchScNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Booking 의 SC No. 를 조회 한다.
	  * </pre>
	  */
	public BDRCorrectionDBDAOSearchScNoRSQL(){
		setQuery();
		...
		query.append("FileName : BDRCorrectionDBDAOSearchScNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
