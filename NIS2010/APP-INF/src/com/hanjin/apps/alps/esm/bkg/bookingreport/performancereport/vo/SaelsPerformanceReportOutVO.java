...
public class SaelsPerformanceReportOutVO extends AbstractValueObject {
	...
	/* Column Info */
	private String forwarderCd = null;
	/* Column Info */
	private String forwarderNm = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cntr_ttl", getCntrTtl());
		...
		this.hashColumns.put("forwarder_cd", getForwarderCd());
		this.hashColumns.put("forwarder_nm", getForwarderNm());		
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cntr_ttl", "cntrTtl");
		...
		this.hashFields.put("forwarder_cd", "forwarderCd");
		this.hashFields.put("forwarder_nm", "forwarderNm");
	 ...
	 * @param teuTtl
	 */
	public void setCntrTtl(String cntrTtl) {
		this.cntrTtl = cntrTtl;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCntrTtl(JSPUtil.getParameter(request, prefix + "cntr_ttl", ""));
		...
		setForwarderCd(JSPUtil.getParameter(request, prefix + "forwarder_cd", ""));
		setForwarderNm(JSPUtil.getParameter(request, prefix + "forwarder_nm", ""));		
	...
	public SaelsPerformanceReportOutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cntrTtl = (JSPUtil.getParameter(request, prefix	+ "cntr_ttl", length));
			...
			String[] forwarderCd = (JSPUtil.getParameter(request, prefix	+ "forwarder_cd", length));
			String[] forwarderNm = (JSPUtil.getParameter(request, prefix	+ "forwarder_nm", length));			
			...
			for (int i = 0; i < length; i++) {
				...
				if (forwarderCd[i] != null)
					model.setForwarderCd(forwarderCd[i]);
				if (forwarderNm[i] != null)
					model.setForwarderNm(forwarderNm[i]);				
	...
	*/
	public void unDataFormat(){
		...
		this.cntrTtl = this.cntrTtl .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.forwarderCd = this.forwarderCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.forwarderNm = this.forwarderNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
