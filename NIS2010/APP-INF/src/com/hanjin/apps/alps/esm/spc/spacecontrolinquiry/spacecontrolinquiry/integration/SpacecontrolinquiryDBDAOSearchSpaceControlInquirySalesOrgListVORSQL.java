...
public class SpacecontrolinquiryDBDAOSearchSpaceControlInquirySalesOrgListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       --20140801 추가(S)" ).append("\n"); 
		...
		query.append("       --20140801 추가(E)" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(", QTA_DATA AS (" ).append("\n"); 
		query.append("    SELECT DECODE(SUBSTR(D.TRD_CD, 1, 1), 'I', 'I', 'O') AS IOC_TS_CD," ).append("\n"); 
		query.append("           DECODE(M.DIV, 'RHQ', NVL(D.AQ_CD,  O.N2ND_PRNT_OFC_CD), ( SELECT O.SAQ_RGN_OFC_CD" ).append("\n"); 
		...
		query.append("       --AND B.BSE_QTR_CD       = CEIL(TO_NUMBER(DECODE(M.COST_WK,'00','01','53','52',M.COST_WK))/13)||'Q' --CEIL(TO_NUMBER(M.COST_MON) / 3)||'Q'" ).append("\n"); 
		...
		query.append("                            NVL((SELECT B.CTRL_LOC_ACCT_CD" ).append("\n"); 
		query.append("                                   FROM SPC_ALOC_LANE_CTRL_OPT_DTL B" ).append("\n"); 
		query.append("                                  WHERE M.RLANE_CD                           = B.RLANE_CD" ).append("\n"); 
		query.append("                                    AND SPC_GET_REP_TRD_FNC(M.RLANE_CD)      = B.TRD_CD" ).append("\n"); 
		query.append("                                    AND SPC_GET_REP_SUB_TRD_FNC(M.RLANE_CD)  = B.SUB_TRD_CD" ).append("\n"); 
		query.append("                                    AND M.SKD_DIR_CD                         = B.DIR_CD " ).append("\n"); 
		query.append("                                    AND B.ALOC_CTRL_TP_CD                    = 'A'  " ).append("\n"); 
		query.append("                                    AND B.CTRL_LOC_ACCT_CD  = D.CUST_CNT_CD ||LPAD(D.CUST_SEQ,6,'0')                                        " ).append("\n"); 
		query.append("                                ),'XX999999')   -- 20140801 수정" ).append("\n"); 
		...
		query.append("                     ,D.CFM_20FT_DRY_QTY" ).append("\n"); 
		query.append("                     ,D.CFM_40FT_DRY_QTY" ).append("\n"); 
		query.append("                     ,D.CFM_RD_QTY" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                FROM PARAMS             M," ).append("\n"); 
		...
		query.append("                     ,D.ASGN_20FT_DRY_QTY" ).append("\n"); 
		query.append("                     ,D.ASGN_40FT_DRY_QTY" ).append("\n"); 
		query.append("                     ,D.ASGN_RD_QTY" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                FROM  PARAMS           M" ).append("\n"); 
		...
		query.append("              							OR M.OFC_CD = (" ).append("\n"); 
		...
		query.append("                          NVL(DECODE(BAR.USA_BKG_MOD_CD,'OTH','OTHERS',BAR.USA_BKG_MOD_CD),'OTHERS') -- SPC_BKG_AVG_REV.LOCAL/IPI" ).append("\n"); 
		query.append("                     ELSE" ).append("\n"); 
		query.append("                          'OTHERS'" ).append("\n"); 
		query.append("                     END AS USA_BKG_MOD_CD" ).append("\n"); 
		query.append("                     " ).append("\n"); 
		...
		query.append("         --ELSE" ).append("\n"); 
		query.append("         --        (" ).append("\n"); 
		query.append("         --         SELECT MAX(CUST_LGL_ENG_NM)" ).append("\n"); 
		...
		query.append("               -- 20140728 추가(S)" ).append("\n"); 
		query.append("               AND BAR.USA_BKG_MOD_CD = Z.USA_BKG_MOD_CD1" ).append("\n"); 
		query.append("               --AND BAR.CUST_ACCT      = Z.CUST_ACCT1" ).append("\n"); 
		query.append("			   -- 20140728 추가(E)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("                   -- 20140728 추가(S)" ).append("\n"); 
		query.append("                   'OTHERS'   AS USA_BKG_MOD_CD1," ).append("\n"); 
		query.append("                   --'XX999999' AS CUST_ACCT1," ).append("\n"); 
		query.append("				   -- 20140728 추가(E)" ).append("\n"); 
		query.append("" ).append("\n"); 
