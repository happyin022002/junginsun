...
*@FileName : EsmMas0036ViewAdapter.java
*@FileTitle : EsmMas0036ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6 
 */
public class EsmMas0036ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0036ViewAdapter(){
    	super();
    }
