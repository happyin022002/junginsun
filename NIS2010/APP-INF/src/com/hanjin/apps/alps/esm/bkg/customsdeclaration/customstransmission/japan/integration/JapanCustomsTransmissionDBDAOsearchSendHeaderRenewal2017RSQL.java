...
*@FileName : JapanCustomsTransmissionDBDAOsearchSendHeaderRenewal2017RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanCustomsTransmissionDBDAOsearchSendHeaderRenewal2017RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanCustomsTransmissionDBDAOsearchSendHeaderRenewal2017RSQL(){
		setQuery();
		...
		query.append("FileName : JapanCustomsTransmissionDBDAOsearchSendHeaderRenewal2017RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
