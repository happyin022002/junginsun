...
*@FileName : SCRateQuotationDBDAOPriSqRtCMPBCostDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtCMPBCostDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCMPBCostDetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCMPBCostDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
