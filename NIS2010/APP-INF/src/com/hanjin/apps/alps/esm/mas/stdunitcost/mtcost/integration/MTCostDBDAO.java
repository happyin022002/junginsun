...
//	        	System.out.println("\n\n=======>"+map.toString());
	        	...
	        	velParam.put("table_name", "MAS_MTCH_BAK_INFO");
	        	...
	        	velParam.put("table_name", "MAS_FULL_ECC_IMBAL");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL");  
	            
	        	velParam.put("table_name", "MAS_CNTR_MTY_MVMT");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL");  
	            
	        	velParam.put("table_name", "MAS_MTY_CNTR_ROUT_PERF");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL");  
	            
	        	velParam.put("table_name", "MAS_MTY_ECC_CNTR_SMRY");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL");   
	            
	        	velParam.put("table_name", "MAS_MTY_CNTR_ROUT_DTL");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL");  
	            
	        	velParam.put("table_name", "MAS_MTY_ECC_UT_COST");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL");  
	            
	        	velParam.put("table_name", "MAS_MTY_DEST_COST");
	        	saveCnt = new SQLExecuter("").executeUpdate((ISQLTemplate)new MTCostDBDAORemoveEqRepoCostDSQL(), map, velParam);
	            if(saveCnt== Statement.EXECUTE_FAILED)
	                throw new DAOException("Fail to modify SQL"); 
