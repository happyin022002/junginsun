...
*@FileName : UsWharfageDecMgtDBDAOmodifyBkgUsaWhfSndQtyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOmodifyBkgUsaWhfSndQtyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyBkgUsaWhfSndQty
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOmodifyBkgUsaWhfSndQtyUSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOmodifyBkgUsaWhfSndQtyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_USA_WHF_SND_QTY SET" ).append("\n"); 
