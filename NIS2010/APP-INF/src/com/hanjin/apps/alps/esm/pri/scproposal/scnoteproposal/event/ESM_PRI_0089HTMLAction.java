...
*@FileName : ESM_PRI_0089HTMLAction.java
...
public class ESM_PRI_0089HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0089HTMLAction 객체를 생성
	 */
	public ESM_PRI_0089HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0089Event event = new EsmPri0089Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltCtrtCluzListVO((RsltCtrtCluzListVO)getVO(request, RsltCtrtCluzListVO.class));
		}else{
			event.setRsltCtrtCluzListVO((RsltCtrtCluzListVO)getVO(request, RsltCtrtCluzListVO.class));
		}
