...
public class Kor24BizNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24BizNoVO> models = new ArrayList<Kor24BizNoVO>();
	...
	public Kor24BizNoVO(String ibflag, String pagerows, String bizCntCd, String bizCustCd, String bizNo) {
		this.ibflag = ibflag;
	 ...
	 * @return CreatorVO[]
	 */
	public Kor24BizNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreatorVO[]
	 */
	public Kor24BizNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BizNoVO model = null;
	 ...
	 * @return CreatorVO[]
	 */
	public Kor24BizNoVO[] getCreatorVOs(){
		Kor24BizNoVO[] vos = (Kor24BizNoVO[])models.toArray(new Kor24BizNoVO[models.size()]);
		return vos;
	}
