...
*@FileName : EsmMas0045ViewAdapter.java
*@FileTitle : EsmMas0045ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0045 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmMas0045ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0045ViewAdapter(){
    	super();
    }
	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_1_14"))+"</TD>");
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_2_14"))+"</TD>");
                    ...
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("amt_3_14"))+"</TD>");
                    
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("compare_key"))+"</TD>");
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("ioc_cd"))+"</TD>");
                    
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("cre_usr_id"))+"</TD>");
                    strBuilder.append("  <TD>"+JSPUtil.getNull((String)colValues.get("upd_usr_id"))+"</TD>");
                    strBuilder.append("</TR>");  
	            }
	            //-------------------------------------------------------------------------------------------------
            } catch(Exception e){
