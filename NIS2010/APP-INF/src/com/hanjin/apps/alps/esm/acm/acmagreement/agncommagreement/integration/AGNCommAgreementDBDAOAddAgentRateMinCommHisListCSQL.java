...
*@FileName : AGNCommAgreementDBDAOAddAgentRateMinCommHisListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgentRateMinCommHisListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgentRateMinCommHisListCSQL(){
		setQuery();
		...
		params.put("agmt_dtl_his_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgentRateMinCommHisListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_MIN_COMM_HIS" ).append("\n"); 
