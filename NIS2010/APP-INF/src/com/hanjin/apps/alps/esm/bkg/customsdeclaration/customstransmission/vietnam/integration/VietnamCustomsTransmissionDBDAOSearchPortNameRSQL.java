...
*@FileName : VietnamCustomsTransmissionDBDAOSearchPortNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VietnamCustomsTransmissionDBDAOSearchPortNameRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VietnamCustomsTransmissionDBDAOSearchPortNameRSQL(){
		setQuery();
		...
		query.append("FileName : VietnamCustomsTransmissionDBDAOSearchPortNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
