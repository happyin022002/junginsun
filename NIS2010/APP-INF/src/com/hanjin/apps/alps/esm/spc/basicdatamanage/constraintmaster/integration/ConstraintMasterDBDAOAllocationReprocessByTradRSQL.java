...
*@FileName : ConstraintMasterDBDAOAllocationReprocessByTradRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintMasterDBDAOAllocationReprocessByTradRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Compulsory Firm 에서 Reprocess 버튼 클릭시 동작, Trad로 SPC_SB_BKG_APLY_PROC 호출함.
	  * </pre>
	  */
	public ConstraintMasterDBDAOAllocationReprocessByTradRSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintMasterDBDAOAllocationReprocessByTradRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL SPC_SB_BKG_APLY_PRC('W', null, null, @[rlane_cd], @[dir_cd], @[week], @[duration], @[cfm_usr_id])" ).append("\n"); 
		query.append("/*" ).append("\n"); 
