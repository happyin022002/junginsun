 ...
 * @since J2EE 1.6
 */
public class EsmMas0078ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0078ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0078ViewAdapter ########### [START]");
		...
		log.debug("########### EsmMas0078ViewAdapter ########### [END]");        
