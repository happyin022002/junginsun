...
*@FileName : UsWharfageDecMgtDBDAOsearchUsWhfBlListForRemoveRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOsearchUsWhfBlListForRemoveRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchUsWhfBlListForRemove
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOsearchUsWhfBlListForRemoveRSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOsearchUsWhfBlListForRemoveRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
