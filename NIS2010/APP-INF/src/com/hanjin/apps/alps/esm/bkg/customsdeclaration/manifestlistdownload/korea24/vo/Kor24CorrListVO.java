...
*@FileName : Kor24CorrListVO.java
*@FileTitle : Kor24CorrListVO
*Open Issues :
*Change history :
...
public class Kor24CorrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CorrListVO> models = new ArrayList<Kor24CorrListVO>();
	...
	public Kor24CorrListVO() {}

	public Kor24CorrListVO(String ibflag, String pagerows, String smtAmdNo, String trnsSeq, String krCstmsCorrId, String corrRsn, String preCtnt1, String crntCtnt1, String preCtnt2, String crntCtnt2, String preCtnt3, String crntCtnt3, String preCtnt4, String crntCtnt4) {
	 ...
	 * @param request
	 * @return Kor24CorrListVO[]
	 */
	public Kor24CorrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24CorrListVO[]
	 */
	public Kor24CorrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CorrListVO model = null;
	...
	public Kor24CorrListVO[] getKor24CorrListVOs(){
		Kor24CorrListVO[] vos = (Kor24CorrListVO[])models.toArray(new Kor24CorrListVO[models.size()]);
		return vos;
	}
