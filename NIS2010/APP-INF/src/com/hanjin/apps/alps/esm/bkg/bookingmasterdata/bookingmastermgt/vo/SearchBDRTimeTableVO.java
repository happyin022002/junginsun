...
*@FileName : SearchBDRTimeTableVO.java
*@FileTitle : SearchBDRTimeTableVO
*Open Issues :
*Change history :
...
public class SearchBDRTimeTableVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBDRTimeTableVO> models = new ArrayList<SearchBDRTimeTableVO>();
	 ...
	 */
	public SearchBDRTimeTableVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBDRTimeTableVO[]
	 */
	public SearchBDRTimeTableVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBDRTimeTableVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBDRTimeTableVO();
				if (cbSlanCd[i] != null)
		...
		return getSearchBDRTimeTableVOs();
	}
	...
	public SearchBDRTimeTableVO[] getSearchBDRTimeTableVOs(){
		SearchBDRTimeTableVO[] vos = (SearchBDRTimeTableVO[])models.toArray(new SearchBDRTimeTableVO[models.size()]);
		return vos;
	}
