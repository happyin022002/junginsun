...
=========================================================*/
package com.hanjin.apps.alps.esm.coa.multidimensionrpt.multidimensionrpt.basic;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import com.hanjin.apps.alps.esm.coa.common.vo.SearchConditionVO;
import com.hanjin.apps.alps.esm.coa.multidimensionrpt.multidimensionrpt.integration.MultiDimensionRPTDBDAO;
...
//	 * @param e 
//	 * 
//	 * @return response ESM_COA_062EventResponse
//	 * @exception EventException
//	 */
//    public EventResponse searchMultiDimensionRPT062List(Event e) throws EventException {
//        
//        ESM_COA_062Event event=(ESM_COA_062Event)e;		// PDTO(Data Transfer Object including Parameters)
...
//			return new ESM_COA_062EventResponse(rowSet,"SUCCESS");
...
//	 */
//    public EventResponse searchMultiDimensionRPT062List2(Event e) throws EventException {
//        ESM_COA_062Event event = (ESM_COA_062Event)e;		// PDTO(Data Transfer Object including Parameters)
////        DBRowSet rowSet = null;							// 데이터 전송을 위해 DB ResultSet을 구현한 객체
...
//			return new ESM_COA_062EventResponse(strItem[0], strItem[1], "SUCCESS");
////		} catch (DAOException de) {
////			log.error("err "+de.toString(),de);
////			throw new EventException(de.getMessage());
//		} catch (Exception et){ 
...
//    }
	 ...
	 * @param e 
	 * 
	 * @return response ESM_COA_063EventResponse
	 * @exception EventException
	 */
//	public EventResponse searchMultiDimension065List(Event e) throws EventException {
//		DBRowSet rowSet=null; // 데이터 전송을 위해 DB ResultSet을 구현한 객체
//		ESM_COA_065Event event=(ESM_COA_065Event)e;
//
//		try {
//			rowSet=dbDao.searchMultiDimension065List(event);
//			return new ESM_COA_065EventResponse(rowSet,"SUCCESS");
//		} catch (DAOException de) {
//			log.error("err "+de.toString(),de);
//			throw new EventException(de.getMessage());
//		}
//	}
	...
	public MultiDimensionPfmcByOfficeListVO searchMultiDimension0066List(RepoPfmcConditionVO repoPfmcConditionVO) throws EventException {
		...
		try {
			...
			if(cArr != null) {
				rowSet=dbDao.searchMultiDimension0066List(repoPfmcConditionVO, cols);
			}	
			rtnVo.setCArr(cArr);
	 ...
	 * @param e 
	 * 
	 * @return response ESM_COA_067EventResponse
	 * @exception EventException
	 */
//	public EventResponse searchMultiDimension067List(Event e) throws EventException {
//		DBRowSet rowSet=null; // 데이터 전송을 위해 DB ResultSet을 구현한 객체
//		ESM_COA_067Event event=(ESM_COA_067Event)e;
//	
//		try {
//			rowSet=dbDao.searchMultiDimension067List(event);
//			return new ESM_COA_067EventResponse(rowSet,"SUCCESS");
//		} catch (DAOException de) {
//			log.error("err "+de.toString(),de);
//			throw new EventException(de.getMessage());
//		}
//	}
	 ...
	 * @param e 
	 * 
	 * @return response ESM_COA_068EventResponse
	 * @exception EventException
	 */
	/*public EventResponse searchMultiDimension0682List(Event e) throws EventException {
		DBRowSet rowSet=null; // 데이터 전송을 위해 DB ResultSet을 구현한 객체
		DBRowSet hRs = null;
		ESM_COA_068Event event=(ESM_COA_068Event)e;
		ESM_COA_068EventResponse res= new ESM_COA_068EventResponse();
	
		try {
			
			hRs = dbDao.searchMultiDimension0682VarHeader(event);
			String[] cArr = null;
			String[] rtoArr = null;
			...
			if(cArr != null) {
				rowSet=dbDao.searchMultiDimension0682List(event, cArr);
				res = new ESM_COA_068EventResponse(rowSet,"SUCCESS", cArr, rtoArr);
			}
...
*/
	...
	public MultiDimensionPfmcByOfficeListVO searchMultiDimension00692List(RepoPfmcConditionVO repoPfmcConditionVO) throws EventException {
		...
		try {
			...
			if(cArr != null) {
				rowSet=dbDao.searchMultiDimension00692List(repoPfmcConditionVO, cols);
			}	
			rtnVo.setCArr(cArr);
			rtnVo.setRtoArr(rtoArr);
			rtnVo.setRowSet(rowSet);
...
//		DBRowSet rowSet=null; // 데이터 전송을 위해 DB ResultSet을 구현한 객체
//		ESM_COA_063Event event=(ESM_COA_063Event)e;
//	
//		try {
//			rowSet=dbDao.searchMultiDimension0632List(event);
//			return new ESM_COA_063EventResponse(rowSet,"SUCCESS");
//		} catch (DAOException de) {
//			log.error("err "+de.toString(),de);
//			throw new EventException(de.getMessage());
//		}
//	}
	...
	/**
	 * [비즈니스대상]을 [행위] 합니다.<br>
	 * * ESM_COA_0130화면에 대한 저장 이벤트 처리<br>
	 * 
	 * @param SearchReportViewListVO[] searchReportViewListVO
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3HeaderList(RepoPfmcConditionVO vo) throws EventException {
		DBRowSet[] rowSetArr = new DBRowSet[2]; // 데이터 전송을 위해 DB ResultSet을 구현한 객체
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased1List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			if("OP6".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased1Op6List(vo, cols);	
			}else if("OP5".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased1Op5List(vo, cols);	
			}else if("OP4".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased1Op4List(vo, cols);		
			}else{
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased2List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			if("OP6".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased2Op6List(vo, cols);
			}else if("OP5".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased2Op5List(vo, cols);
			}else if("OP4".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased2Op4List(vo, cols);		
			}else{
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased3List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			if("OP6".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased3Op6List(vo, cols);
			}else if("OP5".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased3Op5List(vo, cols);
			}else if("OP4".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased3Op4List(vo, cols);		
			}else{
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased4List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			if("OP6".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased4Op6List(vo, cols);	
			}else if("OP5".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased4Op5List(vo, cols);	
			}else if("OP4".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased4Op4List(vo, cols);		
			}else{
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased4List(vo, cols);	
			}
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased5List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			if("OP6".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased5Op6List(vo, cols);
			}else if("OP5".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased5Op5List(vo, cols);
			}else if("OP4".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased5Op4List(vo, cols);		
			}else{
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased5List(vo, cols);
			}
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased6List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			if("OP6".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased6Op6List(vo, cols);
			}else if("OP5".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased6Op5List(vo, cols);
			}else if("OP4".equals(vo.getFOpView())){
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased6Op4List(vo, cols);		
			}else{
				rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased6List(vo, cols);
			}
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased7List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased7List(vo, cols);
	...
	public List<MultiDimensionRptRtnVO> searchWeeklySalesByOffice3TEUBased8List(RepoPfmcConditionVO vo) throws EventException {
		...
		try {
			...
			// Data
			rowSetArr[1] = dbDao.searchWeeklySalesByOffice3TEUBased8List(vo, cols);
	...
	/**
	 * 조회 이벤트 처리<br>
	 * IAS 협의체별 Scop 조회 (ESM_COA_0178)<br>
	 * 
	...
	/**
	 * IAS 협의체별 Scop 관리화면 Save 이벤트 처리(ESM_COA_0178)<br>
	 * 
	 ...
	 */
	public String checkProfitLossCreateBatchStatus() throws EventException {
		...
		try {
			...
			List<CoaUtCostCreStsVO> list = dbDao.searchProfitLossCreationStatus(repoPfmcConditionVO);
	...
	public String createProfitLossSummary(RepoPfmcConditionVO repoPfmcConditionVO,SignOnUserAccount account) throws EventException {
        ...
        String params = "";
			try {
				...
				su.directExecuteJob("ESM_COA_B003",params);
	 ...
	 * @exception EventException
	 */
	public List<CoaUtCostCreStsVO> searchProfitLossCreationStatus(RepoPfmcConditionVO repoPfmcConditionVO) throws EventException{
		try {
