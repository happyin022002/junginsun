...
*@FileName : CntrDetailVO.java
*@FileTitle : CntrDetailVO
*Open Issues :
*Change history :
...
public class CntrDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrDetailVO> models = new ArrayList<CntrDetailVO>();
	
	/* Column Info */
	private String seal2No = null;
	/* Column Info */
	private String rdCgoFlg = null;
	/* Column Info */
	private String seal2KndCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String seal1KndCd = null;
	/* Column Info */
	private String seal1No = null;
	/* Column Info */
	...
	/* Column Info */
	private String seal1PtyTpCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String seal2PtyTpCd = null;
	...
	public CntrDetailVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String cntrTpszCd, String cnmvStsCd, String seal1No, String seal1KndCd, String seal1PtyTpCd, String seal2No, String seal2KndCd, String seal2PtyTpCd, String cntrCfmFlg, String cntrPrtFlg, String cntrVolQty, String orgYdCd, String cnmvEvntDt, String cgoRcvDt, String hngrFlg, String dcgoFlg, String bbCgoFlg, String awkCgoFlg, String rcFlg, String rdCgoFlg, String socFlg, String poNo, String diffRmk, String creUsrId, String updUsrId) {
		this.seal2No = seal2No;
		this.rdCgoFlg = rdCgoFlg;
		this.seal2KndCd = seal2KndCd;
		this.cgoRcvDt = cgoRcvDt;
		this.pagerows = pagerows;
		this.cnmvStsCd = cnmvStsCd;
		this.ibflag = ibflag;
		this.seal1KndCd = seal1KndCd;
		this.seal1No = seal1No;
		this.bbCgoFlg = bbCgoFlg;
		this.cntrTpszCd = cntrTpszCd;
		this.dcgoFlg = dcgoFlg;
		this.seal1PtyTpCd = seal1PtyTpCd;
		...
		this.seal2PtyTpCd = seal2PtyTpCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("seal2_no", getSeal2No());
		this.hashColumns.put("rd_cgo_flg", getRdCgoFlg());
		this.hashColumns.put("seal2_knd_cd", getSeal2KndCd());
		this.hashColumns.put("cgo_rcv_dt", getCgoRcvDt());
		this.hashColumns.put("pagerows", getPagerows());
		this.hashColumns.put("cnmv_sts_cd", getCnmvStsCd());
		this.hashColumns.put("ibflag", getIbflag());
		this.hashColumns.put("seal1_knd_cd", getSeal1KndCd());
		this.hashColumns.put("seal1_no", getSeal1No());
		this.hashColumns.put("bb_cgo_flg", getBbCgoFlg());
		this.hashColumns.put("cntr_tpsz_cd", getCntrTpszCd());
		this.hashColumns.put("dcgo_flg", getDcgoFlg());
		this.hashColumns.put("seal1_pty_tp_cd", getSeal1PtyTpCd());
		...
		this.hashColumns.put("seal2_pty_tp_cd", getSeal2PtyTpCd());
	...
	public HashMap<String, String> getFieldNames(){
		this.hashFields.put("seal2_no", "seal2No");
		this.hashFields.put("rd_cgo_flg", "rdCgoFlg");
		this.hashFields.put("seal2_knd_cd", "seal2KndCd");
		this.hashFields.put("cgo_rcv_dt", "cgoRcvDt");
		this.hashFields.put("pagerows", "pagerows");
		this.hashFields.put("cnmv_sts_cd", "cnmvStsCd");
		this.hashFields.put("ibflag", "ibflag");
		this.hashFields.put("seal1_knd_cd", "seal1KndCd");
		this.hashFields.put("seal1_no", "seal1No");
		this.hashFields.put("bb_cgo_flg", "bbCgoFlg");
		this.hashFields.put("cntr_tpsz_cd", "cntrTpszCd");
		this.hashFields.put("dcgo_flg", "dcgoFlg");
		this.hashFields.put("seal1_pty_tp_cd", "seal1PtyTpCd");
		...
		this.hashFields.put("seal2_pty_tp_cd", "seal2PtyTpCd");
	 ...
	 * @return seal2KndCd
	 */
	public String getSeal2KndCd() {
		return this.seal2KndCd;
	}
	 ...
	 * @return seal1KndCd
	 */
	public String getSeal1KndCd() {
		return this.seal1KndCd;
	}
	 ...
	 * @return seal1PtyTpCd
	 */
	public String getSeal1PtyTpCd() {
		return this.seal1PtyTpCd;
	}
	 ...
	 * @return seal2PtyTpCd
	 */
	public String getSeal2PtyTpCd() {
		return this.seal2PtyTpCd;
	}
	 ...
	 * @param seal2No
	 */
	public void setSeal2No(String seal2No) {
		this.seal2No = seal2No;
	}
	 ...
	 * @param seal2KndCd
	 */
	public void setSeal2KndCd(String seal2KndCd) {
		this.seal2KndCd = seal2KndCd;
	}
	 ...
	 * @param seal1KndCd
	 */
	public void setSeal1KndCd(String seal1KndCd) {
		this.seal1KndCd = seal1KndCd;
	}
	 ...
	 * @param seal1No
	 */
	public void setSeal1No(String seal1No) {
		this.seal1No = seal1No;
	}
	 ...
	 * @param seal1PtyTpCd
	 */
	public void setSeal1PtyTpCd(String seal1PtyTpCd) {
		this.seal1PtyTpCd = seal1PtyTpCd;
	}
	 ...
	 * @param seal2PtyTpCd
	 */
	public void setSeal2PtyTpCd(String seal2PtyTpCd) {
		this.seal2PtyTpCd = seal2PtyTpCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		setSeal2No(JSPUtil.getParameter(request, "seal2_no", ""));
		setRdCgoFlg(JSPUtil.getParameter(request, "rd_cgo_flg", ""));
		setSeal2KndCd(JSPUtil.getParameter(request, "seal2_knd_cd", ""));
		...
		setSeal1KndCd(JSPUtil.getParameter(request, "seal1_knd_cd", ""));
		setSeal1No(JSPUtil.getParameter(request, "seal1_no", ""));
		setBbCgoFlg(JSPUtil.getParameter(request, "bb_cgo_flg", ""));
		setCntrTpszCd(JSPUtil.getParameter(request, "cntr_tpsz_cd", ""));
		setDcgoFlg(JSPUtil.getParameter(request, "dcgo_flg", ""));
		setSeal1PtyTpCd(JSPUtil.getParameter(request, "seal1_pty_tp_cd", ""));
		...
		setSeal2PtyTpCd(JSPUtil.getParameter(request, "seal2_pty_tp_cd", ""));
	}
	 ...
	 * @return CntrDetailVO[]
	 */
	public CntrDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrDetailVO[]
	 */
	public CntrDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrDetailVO model = null;
		...
		try {
			String[] seal2No = (JSPUtil.getParameter(request, prefix	+ "seal2_no", length));
			String[] rdCgoFlg = (JSPUtil.getParameter(request, prefix	+ "rd_cgo_flg", length));
			String[] seal2KndCd = (JSPUtil.getParameter(request, prefix	+ "seal2_knd_cd", length));
			String[] cgoRcvDt = (JSPUtil.getParameter(request, prefix	+ "cgo_rcv_dt", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			String[] cnmvStsCd = (JSPUtil.getParameter(request, prefix	+ "cnmv_sts_cd", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] seal1KndCd = (JSPUtil.getParameter(request, prefix	+ "seal1_knd_cd", length));
			String[] seal1No = (JSPUtil.getParameter(request, prefix	+ "seal1_no", length));
			String[] bbCgoFlg = (JSPUtil.getParameter(request, prefix	+ "bb_cgo_flg", length));
			String[] cntrTpszCd = (JSPUtil.getParameter(request, prefix	+ "cntr_tpsz_cd", length));
			String[] dcgoFlg = (JSPUtil.getParameter(request, prefix	+ "dcgo_flg", length));
			String[] seal1PtyTpCd = (JSPUtil.getParameter(request, prefix	+ "seal1_pty_tp_cd", length));
			...
			String[] seal2PtyTpCd = (JSPUtil.getParameter(request, prefix	+ "seal2_pty_tp_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new CntrDetailVO();
				if (seal2No[i] != null)
					model.setSeal2No(seal2No[i]);
				if (rdCgoFlg[i] != null)
					model.setRdCgoFlg(rdCgoFlg[i]);
				if (seal2KndCd[i] != null)
					model.setSeal2KndCd(seal2KndCd[i]);
				if (cgoRcvDt[i] != null)
				...
				if (seal1KndCd[i] != null)
					model.setSeal1KndCd(seal1KndCd[i]);
				if (seal1No[i] != null)
					model.setSeal1No(seal1No[i]);
				if (bbCgoFlg[i] != null)
				...
				if (seal1PtyTpCd[i] != null)
					model.setSeal1PtyTpCd(seal1PtyTpCd[i]);
				if (updUsrId[i] != null)
				...
				if (seal2PtyTpCd[i] != null)
					model.setSeal2PtyTpCd(seal2PtyTpCd[i]);
				models.add(model);
			}
	 ...
	 * @return CntrDetailVO[]
	 */
	public CntrDetailVO[] getCntrDetailVOs(){
		CntrDetailVO[] vos = (CntrDetailVO[])models.toArray(new CntrDetailVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		this.seal2No = this.seal2No .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rdCgoFlg = this.rdCgoFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.seal2KndCd = this.seal2KndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cgoRcvDt = this.cgoRcvDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.pagerows = this.pagerows .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cnmvStsCd = this.cnmvStsCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.seal1KndCd = this.seal1KndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.seal1No = this.seal1No .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.bbCgoFlg = this.bbCgoFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cntrTpszCd = this.cntrTpszCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.dcgoFlg = this.dcgoFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.seal1PtyTpCd = this.seal1PtyTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.seal2PtyTpCd = this.seal2PtyTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
