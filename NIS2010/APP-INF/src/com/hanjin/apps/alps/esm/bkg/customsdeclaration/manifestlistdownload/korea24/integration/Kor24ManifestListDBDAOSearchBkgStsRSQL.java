...
*@FileName : Kor24ManifestListDBDAOSearchBkgStsRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchBkgStsRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchBkgStsRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchBkgStsRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(KR_BL_AMDT_STS_CD,' ') BKG_STS_CD" ).append("\n");
