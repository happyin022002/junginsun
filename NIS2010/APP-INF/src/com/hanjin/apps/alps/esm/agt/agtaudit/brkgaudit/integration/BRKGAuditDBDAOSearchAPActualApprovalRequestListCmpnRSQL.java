...
*@FileName : BRKGAuditDBDAOSearchAPActualApprovalRequestListCmpnRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BRKGAuditDBDAOSearchAPActualApprovalRequestListCmpnRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BRKGAuditDBDAOSearchAPActualApprovalRequestListCmpnRSQL(){
		setQuery();
		...
		query.append("FileName : BRKGAuditDBDAOSearchAPActualApprovalRequestListCmpnRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    AND A.CMPN_IF_DT IS NULL" ).append("\n"); 
		...
		query.append("    AND A.CMPN_SEQ = (" ).append("\n"); 
		query.append("		SELECT " ).append("\n"); 
		query.append("			MAX(D.CMPN_SEQ)" ).append("\n"); 
		query.append("        FROM AGT_CMPN_COMM D" ).append("\n"); 
		query.append("        WHERE D.BKG_NO = A.BKG_NO--//:stsOpt,:frDate,:toDate" ).append("\n"); 
		query.append("        AND CMPN_IF_DT IS NULL" ).append("\n"); 
