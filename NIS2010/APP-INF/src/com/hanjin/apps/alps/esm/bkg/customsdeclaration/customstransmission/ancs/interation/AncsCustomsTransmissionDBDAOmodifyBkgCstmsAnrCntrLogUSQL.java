...
*@FileName : AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrCntrLogUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrCntrLogUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrCntrLogUSQL(){
		setQuery();
		...
		query.append("FileName : AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrCntrLogUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_ANR_CNTR_LOG" ).append("\n"); 
		query.append("SET" ).append("\n"); 
		query.append("EDI_RCV_STS_CD  = @[edi_rcv_sts_cd]" ).append("\n"); 
