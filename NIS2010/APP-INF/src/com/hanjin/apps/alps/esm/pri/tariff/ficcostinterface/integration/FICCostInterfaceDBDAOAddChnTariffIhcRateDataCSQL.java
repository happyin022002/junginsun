...
*@FileName : FICCostInterfaceDBDAOAddChnTariffIhcRateDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOAddChnTariffIhcRateDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SIN/SHA Cost Interface
	  * </pre>
	  */
	public FICCostInterfaceDBDAOAddChnTariffIhcRateDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOAddChnTariffIhcRateDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  FROM   " ).append("\n"); 
		query.append("                        AOC_CHN_INLND_TRF_DTL A," ).append("\n"); 
