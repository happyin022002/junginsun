 ...
 * @see EsmBkg1177Event 참조
 * @since J2EE 1.4
 */
  
public class ESM_BKG_1177HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1177HTMLAction 객체를 생성
	 */
	public ESM_BKG_1177HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException 
	{
		...
		EsmBkg1177Event event = new EsmBkg1177Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDoVtyDtUpdHisVO((DoVtyDtUpdHisVO) getVO(request, DoVtyDtUpdHisVO.class));
		}
