...
*@FileName : Eur24CustomsTransmissionDBDAOAddRcvLogErrOBCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOAddRcvLogErrOBCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOAddRcvLogErrOBCSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOAddRcvLogErrOBCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOAddRcvLogErrOBCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_IO_RCV_ERR" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("    @[edi_rcv_dt],      @[edi_rcv_seq],    NVL((SELECT MAX(RCV_LOG_ERR_SEQ) FROM BKG_CSTMS_EUR_IO_RCV_ERR WHERE BND_TP_CD = 'O' AND EDI_RCV_DT = @[edi_rcv_dt] AND EDI_RCV_SEQ = @[edi_rcv_seq]),0)+1," ).append("\n"); 
