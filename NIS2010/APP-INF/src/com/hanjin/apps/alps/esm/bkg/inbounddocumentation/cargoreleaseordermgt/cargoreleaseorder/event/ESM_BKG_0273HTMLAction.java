...
*@FileName : ESM_BKG_0273HTMLAction.java
 ...
 * @see EsmBkg0273Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_0273HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0272HTMLAction 객체를 생성
	 */
	public ESM_BKG_0273HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException 
	{
		...
		EsmBkg0273Event event = new EsmBkg0273Event();
		
		if(command.isCommand(FormCommand.SEARCH)) 
		{
			event.setFullCntrRlseOrderHisSearchVO((FullCntrRlseOrderHisSearchVO) getVO(request, FullCntrRlseOrderHisSearchVO.class));
		}
