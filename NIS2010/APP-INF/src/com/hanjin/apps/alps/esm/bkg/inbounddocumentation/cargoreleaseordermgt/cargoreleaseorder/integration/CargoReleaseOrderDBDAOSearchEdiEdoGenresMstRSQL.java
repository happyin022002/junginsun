...
*@FileName : CargoReleaseOrderDBDAOSearchEdiEdoGenresMstRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOSearchEdiEdoGenresMstRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOSearchEdiEdoGenresMstRSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOSearchEdiEdoGenresMstRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ||'MSG_ACK_TP:'  || @[edo_ack_cd]                            || CHR(10)    -- 'A' or 'R'	" ).append("\n"); 
		query.append("      ||'MSG_ACK_DT:'  || TO_CHAR(sysdate, 'YYYYMMDDHH24MISS')     || CHR(10)	" ).append("\n"); 
		query.append("      ||'MSG_R_REASON:'|| decode(@[edo_ack_cd],'R',@[edo_rjct_rsn],'') || CHR(10)" ).append("\n"); 
