...
*@FileName : EsmBsa0026ViewAdapter.java
*@FileTitle : EsmBsa0026ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmBsa0026ViewAdapter extends DefaultViewAdapter {
	
    public EsmBsa0026ViewAdapter(){
    	super();
    }
