...
*@FileName : CommodityDBDAOPriRqGrpCmdtDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOPriRqGrpCmdtDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_RQ_GRP_CMDT_DTL 테이블 조회
	  * </pre>
	  */
	public CommodityDBDAOPriRqGrpCmdtDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOPriRqGrpCmdtDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
