...
*@FileName : ESM_PRI_0130_02HTMLAction.java
...
public class ESM_PRI_0130_02HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0130_02HTMLAction 객체를 생성
	 */
	public ESM_PRI_0130_02HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri013002Event event = new EsmPri013002Event();
    	FormCommand command = FormCommand.fromRequest(request);

		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRptSearchChargeSummaryReportSummaryViewVO ((RptSearchChargeSummaryReportSummaryViewVO) getVO(request, RptSearchChargeSummaryReportSummaryViewVO .class));
