...
*@FileName : CostManageDBDAOSearchBasicCmcbForIasSecNewLaneIfRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostManageDBDAOSearchBasicCmcbForIasSecNewLaneIfRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Basic CMCB for IAS Sector _ New Lane Cost IF List를 조회한다.
	  * </pre>
	  */
	public CostManageDBDAOSearchBasicCmcbForIasSecNewLaneIfRSQL(){
		setQuery();
		...
		query.append("FileName : CostManageDBDAOSearchBasicCmcbForIasSecNewLaneIfRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM SQM_SCTR_NEW_LANE A1, SQM_SCTR_PAIR_COST A2" ).append("\n"); 
		...
		query.append("ORDER BY A1.SUB_TRD_CD, A1.RLANE_CD" ).append("\n"); 
