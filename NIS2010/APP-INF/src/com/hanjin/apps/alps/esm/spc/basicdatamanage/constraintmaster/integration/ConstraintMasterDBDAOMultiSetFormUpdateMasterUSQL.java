...
*@FileName : ConstraintMasterDBDAOMultiSetFormUpdateMasterUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintMasterDBDAOMultiSetFormUpdateMasterUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPC_RPT_FOM 컬럼 rpt_fom_desc 수정
	  * </pre>
	  */
	public ConstraintMasterDBDAOMultiSetFormUpdateMasterUSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintMasterDBDAOMultiSetFormUpdateMasterUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,rpt_fom_nm =@[rpt_fom_nm]" ).append("\n"); 
		query.append("	,rpt_fom_desc =@[rpt_fom_desc]" ).append("\n"); 
