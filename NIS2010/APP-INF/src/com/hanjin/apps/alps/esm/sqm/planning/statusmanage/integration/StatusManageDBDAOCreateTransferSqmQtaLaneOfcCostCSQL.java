...
*@FileName : StatusManageDBDAOCreateTransferSqmQtaLaneOfcCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateTransferSqmQtaLaneOfcCostCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Transfer 시 연간 정보로 1Q SQM_QTA_LANE_OFC_COST 생성
	  * </pre>
	  */
	public StatusManageDBDAOCreateTransferSqmQtaLaneOfcCostCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateTransferSqmQtaLaneOfcCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
