...
*@FileName : CondSearchFleetStatusSumVO.java
*@FileTitle : CondSearchFleetStatusSumVO
*Open Issues :
*Change history :
...
public class CondSearchFleetStatusSumVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CondSearchFleetStatusSumVO> models = new ArrayList<CondSearchFleetStatusSumVO>();
	...
	public CondSearchFleetStatusSumVO() {}

	public CondSearchFleetStatusSumVO(String ibflag, String pagerows, String laneCd, String schDt, String gearWith, String ownrSeq, String periodFlag, String contractType, String vslSize1, String vslSizeFlag, String vslSize2, String schDtTo) {
		this.laneCd = laneCd;
		this.ibflag = ibflag;
	 ...
	 */
	public CondSearchFleetStatusSumVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CondSearchFleetStatusVO[]
	 */
	public CondSearchFleetStatusSumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CondSearchFleetStatusSumVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CondSearchFleetStatusSumVO();
				if (laneCd[i] != null)
	 ...
	 * @return CondSearchFleetStatusVO[]
	 */
	public CondSearchFleetStatusSumVO[] getCondSearchFleetStatusVOs(){
		CondSearchFleetStatusSumVO[] vos = (CondSearchFleetStatusSumVO[])models.toArray(new CondSearchFleetStatusSumVO[models.size()]);
		return vos;
	}
