...
*@FileName : RFARateQuotationDBDAORsltPriRqRtRoutOrgPntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriRqRtRoutOrgPntVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriRqRtRoutOrgPntVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriRqRtRoutOrgPntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	(SELECT ORG_CY_DOR_RT_TP_CD" ).append("\n"); 
		query.append("          FROM PRI_RQ_RT_CMDT_ROUT" ).append("\n"); 
		query.append("         WHERE QTTN_NO = A.QTTN_NO" ).append("\n"); 
		query.append("               AND QTTN_VER_NO = A.QTTN_VER_NO" ).append("\n"); 
		query.append("               AND CMDT_HDR_SEQ = A.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("               AND ROUT_SEQ = A.ROUT_SEQ) ORG_CY_DOR_RT_TP_CD" ).append("\n"); 
