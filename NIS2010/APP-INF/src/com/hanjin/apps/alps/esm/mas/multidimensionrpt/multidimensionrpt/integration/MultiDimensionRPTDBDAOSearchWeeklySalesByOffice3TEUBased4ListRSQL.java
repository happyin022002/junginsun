...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, CASE  WHEN @[f_op_view] ='OP1' AND C2.RPT_ITM_DESC = 'OPCOST01' THEN 'OP Cost Total(Pooling)'" ).append("\n"); 
		...
		query.append("		          AND A2.STND_COST_CD NOT IN ( '52101013', '52201013', '52101012', '52201012'" ).append("\n"); 
		...
		query.append("			AND STND_COST_CD != 'OPCOST02'" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	AND STND_COST_CD NOT IN ('OPCOST01', 'OPCOST02')  -- OP Cost Total(Pooling), OPCOST02(Pooling) 숨김 처리  (Adjusted P&L)" ).append("\n"); 
