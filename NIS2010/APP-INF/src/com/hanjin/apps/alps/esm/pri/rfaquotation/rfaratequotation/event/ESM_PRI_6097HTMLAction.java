 ...
 *@FileName : ESM_PRI_6097HTMLAction.java
...
public class ESM_PRI_6097HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6097HTMLAction 객체를 생성
	 */
	public ESM_PRI_6097HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6097Event event = new EsmPri6097Event();
