...
*@FileName : MRIInquiryDBDAOMasMonMiscRevPreTeuVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MRIInquiryDBDAOMasMonMiscRevPreTeuVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MRIInquiryDBDAOMasMonMiscRevPreTeuVOCSQL(){
		setQuery();
		...
		query.append("FileName : MRIInquiryDBDAOMasMonMiscRevPreTeuVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
