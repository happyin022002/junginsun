...
*@FileName : EsmCoa0060ViewAdapter2.java
*@FileTitle : EsmCoa0060ViewAdapter2
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0060ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmCoa0060ViewAdapter2(){
    	super();
    }
