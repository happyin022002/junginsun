...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList13RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList13RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_rout_ref 조회 하여 bkg_del_inp_term_cd 에 setting
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList13RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList13RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    ROUT_REF_DIV_CD = 'DELL'" ).append("\n"); 
