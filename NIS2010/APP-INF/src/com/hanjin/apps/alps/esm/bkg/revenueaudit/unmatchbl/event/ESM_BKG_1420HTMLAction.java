...
*@FileName : ESM_BKG_1420HTMLAction.java
...
public class ESM_BKG_1420HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1420HTMLAction 객체를 생성
	 */
	public ESM_BKG_1420HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1420Event event = new EsmBkg1420Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setOblSurrenderForAuditVO((OblSurrenderForAuditVO)getVO(request, OblSurrenderForAuditVO.class));
		}
