...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtRouteCmpbVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtCmdtRouteCmpbVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtRouteCmpbVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtRouteCmpbVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_SQ_RT_CMDT_ROUT ROUT" ).append("\n"); 
		query.append("USING (" ).append("\n"); 
		query.append("        SELECT QTTN_NO ,QTTN_VER_NO ,GEN_SPCL_RT_TP_CD ,CMDT_HDR_SEQ ,ROUT_SEQ , RAT_UT_CD, PRC_CGO_TP_CD" ).append("\n"); 
		...
		query.append("        AND ROUT.GEN_SPCL_RT_TP_CD = RT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
