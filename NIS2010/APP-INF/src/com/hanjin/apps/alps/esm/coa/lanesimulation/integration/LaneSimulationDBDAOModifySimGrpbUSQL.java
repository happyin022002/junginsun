...
*@FileName : LaneSimulationDBDAOModifySimGrpbUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOModifySimGrpbUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOModifySimGrpbUSQL(){
		setQuery();
		...
		params.put("lod_ttl_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("grs_ttl_rev",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.coa.lanesimulation.integration").append("\n"); 
		query.append("FileName : LaneSimulationDBDAOModifySimGrpbUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_SIM_SVC_LANE" ).append("\n"); 
		query.append("SET BSA_CAPA    = @[bsa_capa]," ).append("\n"); 
		query.append("LDF_RTO     = @[ldf_rto]," ).append("\n"); 
		query.append("LOD_TTL_QTY = @[lod_ttl_qty]," ).append("\n"); 
		query.append("GRS_RPB_REV = @[grs_rpb_rev]," ).append("\n"); 
		query.append("GRS_TTL_REV = @[grs_ttl_rev]," ).append("\n"); 
