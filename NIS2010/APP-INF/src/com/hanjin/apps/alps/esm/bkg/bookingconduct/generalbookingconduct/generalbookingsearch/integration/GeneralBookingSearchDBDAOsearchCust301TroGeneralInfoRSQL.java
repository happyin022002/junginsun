...
public class GeneralBookingSearchDBDAOsearchCust301TroGeneralInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	|| 'TRM_INSTRUCTION:'	||replace(replace(replace(nvl(tro.diff_rmk, ' '), chr(13)||chr(10), ' '), chr(13), ' '), chr(10), ' ')|| CHR(10)" ).append("\n"); 
		...
		query.append("	|| 'TRD_ADDR:'			||replace(replace(replace(nvl(tro.ACT_SHPR_ADDR,' '),chr(13)||chr(10),' '), chr(13),' '), chr(10),' ')|| CHR(10)" ).append("\n"); 
