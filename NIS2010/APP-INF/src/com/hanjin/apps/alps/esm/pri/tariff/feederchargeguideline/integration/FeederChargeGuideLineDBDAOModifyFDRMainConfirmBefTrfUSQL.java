...
*@FileName : FeederChargeGuideLineDBDAOModifyFDRMainConfirmBefTrfUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOModifyFDRMainConfirmBefTrfUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify FDR Main Confirm BefTrf
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOModifyFDRMainConfirmBefTrfUSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOModifyFDRMainConfirmBefTrfUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
