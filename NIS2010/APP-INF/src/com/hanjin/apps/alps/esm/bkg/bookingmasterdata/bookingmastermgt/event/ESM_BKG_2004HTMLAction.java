...
*@FileName : ESM_BKG_2004HTMLAction.java
...
public class ESM_BKG_2004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_2004HTMLAction 객체를 생성
	 */
	public ESM_BKG_2004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg2004Event event = new EsmBkg2004Event();

		BkgHrdCdgDescVO bkgHrdCdgDescVO = new BkgHrdCdgDescVO();
		bkgHrdCdgDescVO.fromRequest(request);
		if(command.isCommand(FormCommand.MULTI)) {
			
			event.setBkgHrdCdgDescVO(bkgHrdCdgDescVO);
			event.setBkgHrdCdgDescVOs((BkgHrdCdgDescVO[])getVOs(request, BkgHrdCdgDescVO.class,""));
		}
