...
*@FileName : ESM_BKG_0573HTMLAction.java
*@FileTitle : Transit (Sending Results) by Container No
*Open Issues :
*Change history :
 ...
 * @see EsmBkg0573Event 참조
 * @since J2EE 1.6
 */
public class ESM_BKG_0573HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0573Event event = new EsmBkg0573Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			
			event.setPsaSendHistoryCondVO((PSASendHistoryCondVO)getVO(request, PSASendHistoryCondVO.class));
