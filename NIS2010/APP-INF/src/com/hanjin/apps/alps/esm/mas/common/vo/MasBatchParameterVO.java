...
*@FileName : MASBatchParameterVO.java
*@FileTitle : MASBatchParameterVO, MAS배치 수행에 필요한 Parameter 모음
*Open Issues :
*Change history :
 ...
 */
public class MasBatchParameterVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBatchParameterVO> models = new ArrayList<MasBatchParameterVO>();
	...
	*/	
	 ...
	 * @param outParaNumber
	 */
	public MasBatchParameterVO(String bkgNo, String startPctlNo,
			String endPctlNo, String costYrmon, String usrId, String delPara,
			String outParaVarchar, String outParaNumber, String cntrMtDys) {
		this.bkgNo = bkgNo;
	...
	/**
	 * @param cntrMtDys the cntrMtDys to set
	 */
	 ...
	 * @param request
	 * @return MasBatchParameterVO[]
	 */
	public MasBatchParameterVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBatchParameterVO[]
	 */
	public MasBatchParameterVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBatchParameterVO model = null;
		...
		return getMasBatchParameterVOs();
	}
	 ...
	 * @return MasBatchParameterVO[]
	 */
	public MasBatchParameterVO[] getMasBatchParameterVOs(){
		MasBatchParameterVO[] vos = (MasBatchParameterVO[])models.toArray(new MasBatchParameterVO[models.size()]);
		return vos;
	}
