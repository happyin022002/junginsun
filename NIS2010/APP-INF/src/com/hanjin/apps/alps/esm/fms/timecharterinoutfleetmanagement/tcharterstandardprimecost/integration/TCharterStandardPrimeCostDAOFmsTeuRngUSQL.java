...
public class TCharterStandardPrimeCostDAOFmsTeuRngUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TEU Range Target Update
	  * </pre>
	  */
	public TCharterStandardPrimeCostDAOFmsTeuRngUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("hir_aply_flg = @[hir_aply_flg]," ).append("\n"); 
