...
*@FileName : RFARateGuidelineDBDAOPriRgRtCmdtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOPriRgRtCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOPriRgRtCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOPriRgRtCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RG_RT_CMDT" ).append("\n"); 
		query.append("SET PRC_CMDT_TP_CD = @[prc_cmdt_tp_cd]" ).append("\n"); 
