...
*@FileName : SpclRiderInVO.java
*@FileTitle : SpclRiderInVO
*Open Issues :
*Change history :
...
public class SpclRiderInVO extends AbstractValueObject {
	...
	private Collection<SpclRiderInVO> models = new ArrayList<SpclRiderInVO>();
	...
	/**
	 * @param bkgImgStoVOs the bkgImgStoVOs to set
	 */
	public void setBkgImgStoVOs(BkgImgStoVO[] bkgImgStoVOs) {
		this.bkgImgStoVOs = bkgImgStoVOs;
	}
	...
	public SpclRiderInVO() {}

	public SpclRiderInVO(String ibflag, String pagerows, String bkgNo, String bkgNoSplit, String ridrTpCd) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 */
	public SpclRiderInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpclRiderInVO[]
	 */
	public SpclRiderInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpclRiderInVO model = null;
	 ...
	 * @return SpclRiderInVO[]
	 */
	public SpclRiderInVO[] getSpclRiderInVOs(){
		SpclRiderInVO[] vos = (SpclRiderInVO[])models.toArray(new SpclRiderInVO[models.size()]);
		return vos;
	}
