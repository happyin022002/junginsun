...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op6ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           FROM MAS_MNL_COST_STUP A1" ).append("\n"); 
		...
		query.append("			              ,'P', (INCOME_TOTAL) - (CM_COST + SPC_CHTR) - VSL_CHTR_REV " ).append("\n"); 
		query.append("			              ,'R', DECODE (@[f_ofc_lvl] " ).append("\n"); 
		query.append("			                           ,'1', (INCOME_TOTAL) - (CM_COST + SPC_CHTR) - VSL_CHTR_REV /* DEM/DET 비용삭제 */ " ).append("\n"); 
		query.append("			                           , (INCOME_TOTAL) - (CM_COST + SPC_CHTR) - VSL_CHTR_REV " ).append("\n"); 
		query.append("			                           ) " ).append("\n"); 
