...
*@FileName : ESM_MAS_0012HTMLAction.java
...
public class ESM_MAS_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0012HTMLAction 객체를 생성
	 */
	public ESM_MAS_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0012Event event = new EsmMas0012Event();
	
		if(command.isCommand(FormCommand.MULTI)) {			
			event.setMasSvcTrnsPrcVOS((MasSvcTrnsPrcVO[])getVOs(request, MasSvcTrnsPrcVO.class,""));		
		}
