...
*@FileName : SCRateProposalDBDAORsltRtRoutOrgPntInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtRoutOrgPntInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtRoutOrgPntInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtRoutOrgPntInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
