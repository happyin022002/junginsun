...
*@FileName : UnmatchBLDBDAOSelectCompareBkgRevUmchItmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOSelectCompareBkgRevUmchItmRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * selectCompareBkgRevUmchItm
	  * </pre>
	  */
	public UnmatchBLDBDAOSelectCompareBkgRevUmchItmRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOSelectCompareBkgRevUmchItmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM   (" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT UMCH_TP_CD, BKG_ITM_LOG, CTRT_ITM_LOG" ).append("\n"); 
