...
public class JapanManifestListDownloadDBDAOsearchBkgCustRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             SAM_CNEE_NTFY_FLG  -- NOTIFY가 CONSIGNEE와 같다는 FLAG" ).append("\n"); 
		query.append(" " ).append("\n"); 
		...
		query.append("         AND (B.BKG_CUST_TP_CD = 'S' OR B.BKG_CUST_TP_CD = 'C' OR B.BKG_CUST_TP_CD = 'N')" ).append("\n"); 
		query.append("  " ).append("\n"); 
		query.append(" )" ).append("\n"); 
