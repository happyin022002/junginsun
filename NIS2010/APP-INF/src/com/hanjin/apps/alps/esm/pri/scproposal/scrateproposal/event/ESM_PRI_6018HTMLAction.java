...
public class ESM_PRI_6018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6018HTMLAction 객체를 생성
	 */
	public ESM_PRI_6018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6018Event event = new EsmPri6018Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSpScpRtScgVOS((PriSpScpRtScgVO[])getVOs(request, PriSpScpRtScgVO .class,""));
		}
