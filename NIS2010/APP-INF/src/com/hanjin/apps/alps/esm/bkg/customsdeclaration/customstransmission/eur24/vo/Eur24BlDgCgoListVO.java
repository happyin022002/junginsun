...
*@FileName : Eur24BlDgCgoListVO.java
*@FileTitle : Eur24BlDgCgoListVO
*Open Issues :
*Change history :
...
public class Eur24BlDgCgoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eur24BlDgCgoListVO> models = new ArrayList<Eur24BlDgCgoListVO>();
...
/**
	 ...
	 * @param request
	 * @return Eur24BlDgCgoListVO[]
	 */
	public Eur24BlDgCgoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eur24BlDgCgoListVO[]
	 */
	public Eur24BlDgCgoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eur24BlDgCgoListVO model = null;
	 ...
	 * @return Eur24BlDgCgoListVO[]
	 */
	public Eur24BlDgCgoListVO[] getEur24BlDgCgoListVOs(){
		Eur24BlDgCgoListVO[] vos = (Eur24BlDgCgoListVO[])models.toArray(new Eur24BlDgCgoListVO[models.size()]);
		return vos;
	}
