...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtVOCSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
