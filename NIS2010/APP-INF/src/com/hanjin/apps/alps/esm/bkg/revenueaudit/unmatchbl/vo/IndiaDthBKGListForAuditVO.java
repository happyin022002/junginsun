...
*@FileName : IndiaDthBKGListForAuditVO.java
*@FileTitle : IndiaDthBKGListForAuditVO
*Open Issues :
*Change history :
...
public class IndiaDthBKGListForAuditVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<IndiaDthBKGListForAuditVO> models = new ArrayList<IndiaDthBKGListForAuditVO>();
	...
	public IndiaDthBKGListForAuditVO() {}

	public IndiaDthBKGListForAuditVO(String ibflag, String pagerows, String bkgNo, String rtAplyDt, String bkgCtrtTpCd, String ctrtNo, String porCd, String polCd, String podCd, String delCd, String rcvTermCd, String deTermCd, String cntrNo, String cntrTpszCd, String cntrWgt, String oth, String dth, String cyr, String bkgRhqCd, String svcScpCd, String fmDt, String toDt, String bkgCnt, String soNo, String soBnd, String fmNodCd, String toNodCd, String audStsCd, String revAudDt, String interRmk, String xterRmk, String trspCostDtlMod, String rdnNo, String ttlBkgCnt, String nst) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("nst", getNst());
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setNst(JSPUtil.getParameter(request, prefix + "nst", ""));
	}
	 ...
	 */
	public IndiaDthBKGListForAuditVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return IndiaDthBKGListForAuditVO[]
	 */
	public IndiaDthBKGListForAuditVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		IndiaDthBKGListForAuditVO model = null;
		...
		try {
			...
			String[] nst = (JSPUtil.getParameter(request, prefix	+ "nst", length));
			
			for (int i = 0; i < length; i++) {
				model = new IndiaDthBKGListForAuditVO();
				if (toNodCd[i] != null)
		...
		return getIndiaDthBKGListForAuditVOs();
	}
	...
	public IndiaDthBKGListForAuditVO[] getIndiaDthBKGListForAuditVOs(){
		IndiaDthBKGListForAuditVO[] vos = (IndiaDthBKGListForAuditVO[])models.toArray(new IndiaDthBKGListForAuditVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.nst = this.nst .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
