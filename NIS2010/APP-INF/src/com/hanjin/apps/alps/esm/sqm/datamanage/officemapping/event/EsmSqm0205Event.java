...
/**
 * ESM_SQM_0205 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_SQM_0205HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author SQM USER
 * @see ESM_SQM_0205HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmSqm0205Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	public EsmSqm0205Event(){}
