...
*Open Issues :
*Change history :
*	2017.09.07 하대성 shprPhnNo, cneePhnNo, ntfyPhnNo, delCd, delReason, shprVia, cneeVia, ntfyVia Column Add
...
public class CargoInfoDetailVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String shprVia = null;

    /* Column Info */
    private String cneeVia = null;

    /* Column Info */
    private String ntfyVia = null;
    ...
    public CargoInfoDetailVO(String ibflag, String pagerows, String seq, String blNo, String mstBl, String bkgPolCd, String polCd, String podCd, String bkgDelCd, String aSType, String aCmrKind, String tSType, String tCmrKind, String sDt, String samrRst, String samrDt, String sa111Rst, String sa111Dt, String scmrRst, String scmrDt, String sc108Rst, String sc108RstDtl, String sc108Dt, String shprNm, String shprAddr, String shprCntCd, String cneeNm, String cneeAddr, String cneeCntCd, String ntfyNm, String ntfyAddr, String ntfyCntCd, String usrEml, String oldUsrEml, String cmdtCd, String cmdtHsCd, String mkDesc, String pckQty, String pckTpCd, String actWgt, String wgtUtCd, String measQty, String measUtCd, String imdgCls, String unNo, String cntrNo, String podDiv, String rvisCntrCustTpCd, String errInfo, String sInfo, String usrId, String bkgPodCd, String bbCgoFlg, String shprPhnNo, String cneePhnNo, String ntfyPhnNo, String delCd, String delReason, String shprVia, String cneeVia, String ntfyVia) {
        ...
        this.shprVia = shprVia;
        this.cneeVia = cneeVia;
        this.ntfyVia = ntfyVia;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("old_usr_eml", getOldUsrEml());
        ...
        this.hashColumns.put("shpr_via", getShprVia());
        this.hashColumns.put("cnee_via", getCneeVia());
        this.hashColumns.put("ntfy_via", getNtfyVia());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("old_usr_eml", "oldUsrEml");
        ...
        this.hashFields.put("shpr_via", "shprVia");
        this.hashFields.put("cnee_via", "cneeVia");
        this.hashFields.put("ntfy_via", "ntfyVia");
	 ...
	 * @return oldUsrEml
	 */
    public String getOldUsrEml() {
        return this.oldUsrEml;
    }
	 ...
	 * @param oldUsrEml
	 */
    public void setOldUsrEml(String oldUsrEml) {
        this.oldUsrEml = oldUsrEml;
    }
    ...
    public void setShprVia(String shprVia) {
        this.shprVia = shprVia;
    }

    public String getShprVia() {
        return this.shprVia;
    }

    public void setCneeVia(String cneeVia) {
        this.cneeVia = cneeVia;
    }

    public String getCneeVia() {
        return this.cneeVia;
    }

    public void setNtfyVia(String ntfyVia) {
        this.ntfyVia = ntfyVia;
    }

    public String getNtfyVia() {
        return this.ntfyVia;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setOldUsrEml(JSPUtil.getParameter(request, prefix + "old_usr_eml", ""));
        ...
        setShprVia(JSPUtil.getParameter(request, prefix + "shpr_via", ""));
        setCneeVia(JSPUtil.getParameter(request, prefix + "cnee_via", ""));
        setNtfyVia(JSPUtil.getParameter(request, prefix + "ntfy_via", ""));
    }
    ...
    public CargoInfoDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] oldUsrEml = (JSPUtil.getParameter(request, prefix + "old_usr_eml", length));
            ...
            String[] shprVia = (JSPUtil.getParameter(request, prefix + "shpr_via", length));
	    	String[] cneeVia = (JSPUtil.getParameter(request, prefix + "cnee_via", length));
	    	String[] ntfyVia = (JSPUtil.getParameter(request, prefix + "ntfy_via", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (oldUsrEml[i] != null)
                    model.setOldUsrEml(oldUsrEml[i]);
                if (sc108Dt[i] != null)
                ...
                if (shprVia[i] != null) 
		    		model.setShprVia(shprVia[i]);
				if (cneeVia[i] != null) 
		    		model.setCneeVia(cneeVia[i]);
				if (ntfyVia[i] != null) 
		    		model.setNtfyVia(ntfyVia[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.oldUsrEml = this.oldUsrEml.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.shprVia = this.shprVia.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cneeVia = this.cneeVia.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.ntfyVia = this.ntfyVia.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
