...
*@FileName : PsaBkgRlsOrdVO.java
*@FileTitle : PsaBkgRlsOrdVO
*Open Issues :
*Change history :
...
public class PsaBkgRlsOrdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsaBkgRlsOrdVO> models = new ArrayList<PsaBkgRlsOrdVO>();
	...
	public PsaBkgRlsOrdVO() {}

	public PsaBkgRlsOrdVO(String ibflag, String pagerows, String bkgNo, String bkgSeq, String psaSerNo, String subPsaSerNo, String psaIfCd, String ydCd, String cntrTpszCd, String cntrQty, String usrId) {
...
/**
	 ...
	 * @param request
	 * @return PsaBkgRlsOrdVO[]
	 */
	public PsaBkgRlsOrdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaBkgRlsOrdVO[]
	 */
	public PsaBkgRlsOrdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaBkgRlsOrdVO model = null;
	 ...
	 * @return PsaBkgRlsOrdVO[]
	 */
	public PsaBkgRlsOrdVO[] getPsaBkgRlsOrdVOs(){
		PsaBkgRlsOrdVO[] vos = (PsaBkgRlsOrdVO[])models.toArray(new PsaBkgRlsOrdVO[models.size()]);
		return vos;
	}
