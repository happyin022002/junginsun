...
*@FileName : ESM_BKG_0151HTMLAction.java
...
public class ESM_BKG_1092HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0151HTMLAction 객체를 생성
	 */
	public ESM_BKG_1092HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1092Event event = new EsmBkg1092Event();
		
		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRsltSearchAuditByCommodityAndRouteListVO((RsltSearchAuditByCommodityAndRouteListVO)getVO(request, RsltSearchAuditByCommodityAndRouteListVO.class));
		}
