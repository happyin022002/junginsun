...
**@FileName : ESM_MAS_0043HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_MAS_0043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0043HTMLAction 객체를 생성
	 */
	public ESM_MAS_0043HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0043Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0043Event event = new EsmMas0043Event();  	
    	
		if(command.isCommand(FormCommand.SEARCHLIST01)) {			
			event.setAvgHireOwnVslVO((AvgHireOwnVslVO)getVO(request, AvgHireOwnVslVO.class));						
		} else if(command.isCommand(FormCommand.MULTI01)) {			
			event.setAvgHireOwnVslVOs((AvgHireOwnVslVO[])getVOs(request, AvgHireOwnVslVO.class));			
