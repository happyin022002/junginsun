...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.russia.vo.VvdKeyVO;
...
public class ESM_BKG_1163HTMLAction extends HTMLActionSupport 
{
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException 
	{
		...
		else if (command.isCommand(FormCommand.MULTI03))
		{
			...
			// Delete
            event.setBlInfoVOs((BlInfoVO[])getVOs(request, RussiaBlInfoListVO.class));
		}
