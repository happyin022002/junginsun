...
/**
 * ESM_MAS_0315 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0315HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Jong-Ock KIM
 * @see ESM_MAS_0315HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmMas0315Event extends EventSupport {
	...
	private StndUtCostVO[] stndUtCostVOs = null;
	
	public EsmMas0315Event(){}
	...
	public StndUtCostVO[] getStndUtCostVOs() {
		return stndUtCostVOs;
	}

	public void setStndUtCostVOs(
			StndUtCostVO[] stndUtCostVOs) {
		this.stndUtCostVOs = stndUtCostVOs;
	}
}