...
public class USDomesticDBDAOSearchUSDomesticCostRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                FROM MAS_USA_DMST_UT_COST B1" ).append("\n"); 
		...
		query.append("                                 AND B2.ORG_RAIL_LOC_CD = MAS_LOC_FNC ( B1.ORG_RAIL_LOC_CD, 'ECC' ) " ).append("\n"); 
		...
		query.append("FROM MAS_USA_DMST_UT_COST B2" ).append("\n"); 
