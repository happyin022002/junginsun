...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_blpl_ctnt update
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
