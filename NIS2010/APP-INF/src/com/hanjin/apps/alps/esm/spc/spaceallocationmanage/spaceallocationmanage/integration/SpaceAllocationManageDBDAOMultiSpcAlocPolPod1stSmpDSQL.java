...
*@FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod1stSmpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOMultiSpcAlocPolPod1stSmpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 성수기 Alloc Copy 시 ALOC_CUST_POL_POD 데이터 삭제
	  * 
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOMultiSpcAlocPolPod1stSmpDSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod1stSmpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
