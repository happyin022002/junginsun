...
*@FileName : PriTrfFdrHdrVO.java
*@FileTitle : PriTrfFdrHdrVO
*Open Issues :
*Change history :
...
public class PriTrfFdrHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriTrfFdrHdrVO> models = new ArrayList<PriTrfFdrHdrVO>();
	...
	public PriTrfFdrHdrVO() {}

	public PriTrfFdrHdrVO(String ibflag, String pagerows, String updDt, String ofcCd, String creUsrId, String rhqCd, String costTrfNo, String svcScpCd, String creDt, String fdrTrfNo, String updUsrId, String verMapgSeq, String orgDestTpCd) {
		this.updDt = updDt;
		this.rhqCd = rhqCd;
...
/**
	 ...
	 * @param request
	 * @return PriTrfFdrHdrVO[]
	 */
	public PriTrfFdrHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriTrfFdrHdrVO[]
	 */
	public PriTrfFdrHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriTrfFdrHdrVO model = null;
	 ...
	 * @return PriTrfFdrHdrVO[]
	 */
	public PriTrfFdrHdrVO[] getPriTrfFdrHdrVOs(){
		PriTrfFdrHdrVO[] vos = (PriTrfFdrHdrVO[])models.toArray(new PriTrfFdrHdrVO[models.size()]);
		return vos;
	}
