...
*@FileName : ESM_COA_0061HTMLAction.java
...
public class ESM_COA_0061HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0061HTMLAction 객체를 생성
	 */
	public ESM_COA_0061HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0061Event event = new EsmCoa0061Event();
