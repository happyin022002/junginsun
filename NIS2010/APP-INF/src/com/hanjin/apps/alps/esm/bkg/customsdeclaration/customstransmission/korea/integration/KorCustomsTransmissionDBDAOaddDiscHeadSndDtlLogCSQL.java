...
*@FileName : KorCustomsTransmissionDBDAOaddDiscHeadSndDtlLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOaddDiscHeadSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOaddDiscHeadSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOaddDiscHeadSndDtlLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
