...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteVOCSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
