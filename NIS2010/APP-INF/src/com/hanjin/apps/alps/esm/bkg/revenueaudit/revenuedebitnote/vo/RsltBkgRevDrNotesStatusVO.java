...
public class RsltBkgRevDrNotesStatusVO extends AbstractValueObject {
	...
	public RsltBkgRevDrNotesStatusVO(String erUmchTpCd, String bkgCtrtTpCd, String ibflag, String pagerows, String issOfcCd, String rctRhqCd, String rctOfcCd, String respbRhqCd, String respbOfcCd, String bkgNo, String blNo, String scRfaNo, String cOfcRep, String ctrtTpCd, String rdnNo, String rvisSeq, String rdnStsCd, String rdnStsNm, String umchTpCd, String umchSubTpCd, String rdnIssRsnCd, String usdAmt, String umchRmk, String bkgCorrNo, String officeRdnRmk, String receiverRdnRmk, String revAudToolCd, String revAudToolNm, String rdnIssDt, String updDt, String issUsrId, String stlUsrId, String receiverUsrId, String rdnIssDtFrom, String rdnIssDtTo, String rgnOfcCd, String gso, String svcScpcd, String stlPrdDys, String rdnKndCd, String invNo, String vvdCd, String n3ptyNo, String atchExist, String ctrtPtyNm, String ctrtNo) {
		...
		this.stlPrdDys = stlPrdDys;
		this.rdnKndCd = rdnKndCd;
		this.invNo = invNo;
		this.vvdCd = vvdCd;
		this.n3ptyNo = n3ptyNo;
		this.atchExist = atchExist;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("c_ofc_rep", getcOfcRep());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("c_ofc_rep", "cOfcRep");
	 ...
	 * @return stlPrdDys
	 */
	public String getStlPrdDys() {
		return this.stlPrdDys;
	}
	 ...
	 * @return atchExist
	 */
	public String getAtchExist() {
		return this.atchExist;
	}
	 ...
	 * @param cOfcRep
	 */
	public void setcOfcRep(String cOfcRep) {
		this.cOfcRep = cOfcRep;
	}
	 ...
	 * @param stlPrdDys
	 */
	public void setStlPrdDys(String stlPrdDys) {
		this.stlPrdDys = stlPrdDys;
	}
	 ...
	 * @param atchExist
	 */
	public void setAtchExist(String atchExist) {
		this.atchExist = atchExist;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setcOfcRep(JSPUtil.getParameter(request, prefix + "c_ofc_rep", ""));
	...
	public RsltBkgRevDrNotesStatusVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cOfcRep = (JSPUtil.getParameter(request, prefix	+ "c_ofc_rep", length));
			...
			String[] stlPrdDys = (JSPUtil.getParameter(request, prefix	+ "stl_prd_dys", length));
			...
			String[] atchExist = (JSPUtil.getParameter(request, prefix	+ "atch_exist", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (stlPrdDys[i] != null)
					model.setStlPrdDys(stlPrdDys[i]);
				if (rdnKndCd[i] != null)
				...
				if (atchExist[i] != null)
					model.setAtchExist(atchExist[i]);
				if (ctrtPtyNm[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.cOfcRep = this.cOfcRep .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.stlPrdDys = this.stlPrdDys .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.atchExist = this.atchExist .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
