...
*@FileName       : ESM_MAS_165HTMLAction.java
*@FileTitle      : 
*Open Issues     :
*Change history  :
 ...
 *
 * @author eunju park
 * @see EsmMas0165Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0165HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_MAS_0165HTMLAction 객체를 생성
     */
    public ESM_MAS_0165HTMLAction() {
    	//
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_MAS_165Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0165Event event = new EsmMas0165Event();
