...
*@FileName : NetworkCostDBDAOOtherVesselDailyHireCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOOtherVesselDailyHireCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOOtherVesselDailyHireCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOOtherVesselDailyHireCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL MAS_OTR_VSL_DLY_HIR_PRC" ).append("\n"); 
		query.append("(" ).append("\n"); 
