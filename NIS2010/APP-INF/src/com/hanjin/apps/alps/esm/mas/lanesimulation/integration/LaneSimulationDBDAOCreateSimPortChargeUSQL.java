...
public class LaneSimulationDBDAOCreateSimPortChargeUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_SIM_PORT_CHG INTO_INFO" ).append("\n"); 
		...
		query.append("FROM MAS_SIM_PORT_CHG A1" ).append("\n"); 
		query.append(",MAS_PORT_TRF     A2" ).append("\n"); 
		...
		query.append("AND A2.COST_YRMON IN (SELECT MAX(COST_YRMON) FROM MAS_PORT_TRF)" ).append("\n"); 
