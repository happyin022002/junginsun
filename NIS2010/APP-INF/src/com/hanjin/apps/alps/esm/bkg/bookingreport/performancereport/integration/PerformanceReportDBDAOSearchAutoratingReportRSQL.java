...
public class PerformanceReportDBDAOSearchAutoratingReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	FROM   (SELECT BK.SVC_SCP_CD" ).append("\n"); 
		query.append("					, BK.BKG_OFC_CD" ).append("\n"); 
		query.append("					, (SELECT REGION FROM BKG_OFC_LVL_V OL WHERE OL.OFC_CD = BK.BKG_OFC_CD) REGION" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			#if (${region} != '' && ${bkg_ofc_cd} == '') " ).append("\n"); 
		query.append("				AND    BK.BKG_OFC_CD IN (SELECT OFC_CD " ).append("\n"); 
		query.append("										FROM BKG_OFC_LVL_V OL " ).append("\n"); 
		query.append("										WHERE OL.REGION   = @[region]) " ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("			AND    OL.REGION   = @[region] " ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY BK.SVC_SCP_CD" ).append("\n"); 
		query.append("      ,BK.BKG_OFC_CD" ).append("\n"); 
