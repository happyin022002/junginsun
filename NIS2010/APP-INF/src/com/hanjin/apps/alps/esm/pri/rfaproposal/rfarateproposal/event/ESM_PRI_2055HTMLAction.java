 ...
 *@FileName : ESM_PRI_2055HTMLAction.java
...
public class ESM_PRI_2055HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2055HTMLAction 객체를 생성
	 */
	public ESM_PRI_2055HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2055Event event = new EsmPri2055Event();
		
		event.setCntrTpszCd(JSPUtil.getParameter(request, "cntr_tpsz_cd", ""));
		event.setOrgDestTpCd(JSPUtil.getParameter(request, "org_dest_tp_cd", ""));
		event.setFcntrEccCd(JSPUtil.getParameter(request, "fcntr_ecc_cd", ""));
