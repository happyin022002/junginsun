...
*@FileName : RFARateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriCostDetailByTransModeListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/** qttn_no,qttn_ver_no,cost_tp,rout_pnt,trans_mode */" ).append("\n"); 
		query.append("" ).append("\n"); 
