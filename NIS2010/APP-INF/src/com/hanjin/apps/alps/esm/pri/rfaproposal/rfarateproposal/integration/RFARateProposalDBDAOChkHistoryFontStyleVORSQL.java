...
*@FileName : RFARateProposalDBDAOChkHistoryFontStyleVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOChkHistoryFontStyleVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rate의 General(CY)와 IHC의 FONT STYLE를 조회합니다. (History)
	  * </pre>
	  */
	public RFARateProposalDBDAOChkHistoryFontStyleVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOChkHistoryFontStyleVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
