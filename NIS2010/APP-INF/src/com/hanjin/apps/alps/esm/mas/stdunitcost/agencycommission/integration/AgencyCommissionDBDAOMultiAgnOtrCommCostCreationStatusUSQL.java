...
*@FileName : AgencyCommissionDBDAOMultiAgnOtrCommCostCreationStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgencyCommissionDBDAOMultiAgnOtrCommCostCreationStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgencyCommissionDBDAOMultiAgnOtrCommCostCreationStatusUSQL(){
		setQuery();
		...
		query.append("FileName : AgencyCommissionDBDAOMultiAgnOtrCommCostCreationStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   ,'AGNT' CM_UC_CD" ).append("\n"); 
