...
*@FileName : KrWhfBkgChkVO.java
*@FileTitle : KrWhfBkgChkVO
*Open Issues :
*Change history :
...
public class KrWhfBkgChkVO extends WhfBkgChkVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfBkgChkVO> models = new ArrayList<KrWhfBkgChkVO>();
	...
	public KrWhfBkgChkVO() {}

	public KrWhfBkgChkVO(String ibflag, String pagerows, String cstmsDeclTpCd, String blNo, String diff) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return KrWhfBkgChkVO[]
	 */
	public KrWhfBkgChkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfBkgChkVO[]
	 */
	public KrWhfBkgChkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfBkgChkVO model = null;
	 ...
	 * @return KrWhfBkgChkVO[]
	 */
	public KrWhfBkgChkVO[] getKrWhfBkgChkVOs(){
		KrWhfBkgChkVO[] vos = (KrWhfBkgChkVO[])models.toArray(new KrWhfBkgChkVO[models.size()]);
		return vos;
	}
