...
*@FileName : ESM_MAS_0340HTMLAction.java
...
public class ESM_MAS_0340HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0340HTMLAction 객체를 생성
	 */
	public ESM_MAS_0340HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0340Event event = new EsmMas0340Event();
