...
*@FileName : Kor24ManifestListDBDAOremoveCorrInfoDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOremoveCorrInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOremoveCorrInfoDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOremoveCorrInfoDSQL").append("\n");
		query.append("*/").append("\n");
	}
