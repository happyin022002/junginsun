...
*@FileName : EdiAdvJpCommonVO.java
*@FileTitle : EdiAdvJpCommonVO
*Open Issues :
*Change history :
*	2017.09.07 하대성 data41, data42 Column Add
 ...
 */
public class EdiAdvJpCommonVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<EdiAdvJpCommonVO> models = new ArrayList<EdiAdvJpCommonVO>();
	 ...
	 * @param request
	 * @return EdiAdvJpCommonVO[]
	 */
    public EdiAdvJpCommonVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EdiAdvJpCommonVO[]
	 */
    public EdiAdvJpCommonVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        EdiAdvJpCommonVO model = null;
	 ...
	 * @return EdiAdvJpCommonVO[]
	 */
    public EdiAdvJpCommonVO[] getEdiAdvJpCommonVOs() {
        EdiAdvJpCommonVO[] vos = (EdiAdvJpCommonVO[]) models.toArray(new EdiAdvJpCommonVO[models.size()]);
        return vos;
    }
