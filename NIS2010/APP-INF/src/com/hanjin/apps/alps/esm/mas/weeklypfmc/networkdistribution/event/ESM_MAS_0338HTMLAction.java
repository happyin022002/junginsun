...
*@FileName : ESM_MAS_0338HTMLAction.java
...
public class ESM_MAS_0338HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0338HTMLAction 객체를 생성
	 */
	public ESM_MAS_0338HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0338Event event = new EsmMas0338Event();
		...
		if(command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO.class));
	        event.setMasAgrdNtwkCostRtoVOs((MasAgrdNtwkCostRtoVO[])getVOs(request, MasAgrdNtwkCostRtoVO.class));         
