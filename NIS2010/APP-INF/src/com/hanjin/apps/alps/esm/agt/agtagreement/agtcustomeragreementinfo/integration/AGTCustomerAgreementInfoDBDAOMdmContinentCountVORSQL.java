...
*@FileName : AGTCustomerAgreementInfoDBDAOMdmContinentCountVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerAgreementInfoDBDAOMdmContinentCountVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCustomerAgreementInfoDBDAOMdmContinentCountVORSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerAgreementInfoDBDAOMdmContinentCountVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
