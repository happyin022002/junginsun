...
*@FileName : RFARateProposalDBDAOPriRpScpRtRoutViaStatusVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtRoutViaStatusVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtRoutViaStatusVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtRoutViaStatusVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_RT_ROUT_VIA  SET " ).append("\n"); 
		...
		query.append("#if (${prc_prog_sts_cd} == 'I') " ).append("\n"); 
