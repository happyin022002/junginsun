...
*@FileName : SearchLogisticsRPT0158ListVO.java
*@FileTitle : SearchLogisticsRPT0158ListVO
*Open Issues :
*Change history :
...
*  2011.06.21 이석준 [CHM-201111642-01] cost_rmon 추가
=========================================================*/
...
public class SearchLogisticsRPT0158ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchLogisticsRPT0158ListVO> models = new ArrayList<SearchLogisticsRPT0158ListVO>();
	...
	/**
	  * ESM_COA_0158 화면용 VO 생성자
	  */
	public SearchLogisticsRPT0158ListVO() {}
	
	/**
	  * ESM_COA_0158 화면용 VO 생성자
	  */
	public SearchLogisticsRPT0158ListVO(String ibflag, String pagerows, String pReport, String costYrmonwk, String costYrmon, String costWk, String rhqCd, String ctrlOfcCd, String costActGrpTpCd, String lgsKpiCostGrpNm, String kpiCd, String kpiNm, String vol, String totalCost, String unitCost, String kpiOrder,String costRmon) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cost_rmon", getCostRmon());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cost_rmon", "costRmon");
	 ...
	 * @return costRmon
	 */
	public String getCostRmon() {
		return this.costRmon;
	}
	 ...
	 * @param costRmon
	 */
	public void setCostRmon(String costRmon) {
		this.costRmon = costRmon;
	}	
	/**
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCostRmon(JSPUtil.getParameter(request, "costRmon", ""));
	}
	 ...
	 */
	public SearchLogisticsRPT0158ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchLogisticsRPT0158ListVO[]
	 */
	public SearchLogisticsRPT0158ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchLogisticsRPT0158ListVO model = null;
		...
		try {
			...
			String[] costRmon = (JSPUtil.getParameter(request, prefix	+ "cost_rmon", length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchLogisticsRPT0158ListVO();
				if (totalCost[i] != null)
		...
		return getSearchLogisticsRPT0158ListVOs();
	}
	...
	public SearchLogisticsRPT0158ListVO[] getSearchLogisticsRPT0158ListVOs(){
		SearchLogisticsRPT0158ListVO[] vos = (SearchLogisticsRPT0158ListVO[])models.toArray(new SearchLogisticsRPT0158ListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.costRmon = this.costRmon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
