...
*@FileName : BSAYearlyPlanDBDAOSearchCreateBSAInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOSearchCreateBSAInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOSearchCreateBSAInfoRSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOSearchCreateBSAInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM MAS_MON_VVD_YRY_PLN" ).append("\n"); 
