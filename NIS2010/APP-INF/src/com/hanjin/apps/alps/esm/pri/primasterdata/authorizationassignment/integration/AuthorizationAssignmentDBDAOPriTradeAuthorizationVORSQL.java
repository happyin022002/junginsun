...
*@FileName : AuthorizationAssignmentDBDAOPriTradeAuthorizationVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AuthorizationAssignmentDBDAOPriTradeAuthorizationVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Trade Authorization 조회
	  * </pre>
	  */
	public AuthorizationAssignmentDBDAOPriTradeAuthorizationVORSQL(){
		setQuery();
		...
		query.append("FileName : AuthorizationAssignmentDBDAOPriTradeAuthorizationVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , AU.CRE_DT AS CRE_DT" ).append("\n"); 
		...
		query.append("    #if (${trd_cd} != '') " ).append("\n"); 
		query.append("AND   AU.TRD_CD = @[trd_cd]" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		...
		query.append("AND   AU.TRD_CD(+) = @[trd_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY UR.USR_ID, AU.TRD_CD" ).append("\n"); 
