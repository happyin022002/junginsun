...
*@FileName : ESM_SPC_0048HTMLAction.java
 ...
 * @author Haeng-ji,Lee
 * @see EsmSpc0048Event 참조
 * @since J2EE 1.6
 */

public class ESM_SPC_0048HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0048HTMLAction 객체를 생성
	 */
	public ESM_SPC_0048HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSpc0048Event event = new EsmSpc0048Event();
