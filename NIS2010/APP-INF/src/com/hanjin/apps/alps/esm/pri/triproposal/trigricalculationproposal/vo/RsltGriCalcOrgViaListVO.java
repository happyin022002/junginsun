...
*@FileName : RsltGriCalcOrgViaListVO.java
*@FileTitle : RsltGriCalcOrgViaListVO
*Open Issues :
*Change history :
...
public class RsltGriCalcOrgViaListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltGriCalcOrgViaListVO> models = new ArrayList<RsltGriCalcOrgViaListVO>();
	...
	public RsltGriCalcOrgViaListVO() {}

	public RsltGriCalcOrgViaListVO(String ibflag, String pagerows, String trfPfxCd, String trfNo, String griGrpSeq, String orgDestTpCd, String griRoutViaSeq, String routViaPortTpCd, String routViaPortDefCd, String routViaPortDefNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltGriCalcOrgViaListVO[]
	 */
	public RsltGriCalcOrgViaListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltGriCalcOrgViaListVO[]
	 */
	public RsltGriCalcOrgViaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltGriCalcOrgViaListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltGriCalcOrgViaListVO();
				if (updDt[i] != null)
		...
		return getRsltGriCalcOrgViaListVOs();
	}
	 ...
	 * @return RsltGriCalcOrgViaListVO[]
	 */
	public RsltGriCalcOrgViaListVO[] getRsltGriCalcOrgViaListVOs(){
		RsltGriCalcOrgViaListVO[] vos = (RsltGriCalcOrgViaListVO[])models.toArray(new RsltGriCalcOrgViaListVO[models.size()]);
		return vos;
	}
