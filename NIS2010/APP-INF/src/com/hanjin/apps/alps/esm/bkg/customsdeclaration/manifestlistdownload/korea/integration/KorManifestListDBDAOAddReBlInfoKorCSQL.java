...
public class KorManifestListDBDAOAddReBlInfoKorCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		BD_AREA_CD, CSTMS_CRR_IN_LOC_WH_CD, IMDG_CLSS_CD, KR_CSTMS_WH_TP_CD, KR_WH_CD, CGO_DESC1, CGO_DESC2, " ).append("\n"); 
		...
		query.append("		IB_VSL_CD,IB_SKD_VOY_NO,IB_SKD_DIR_CD, IB_ETA_DT , CRS_CHK_RSLT_FLG, MF_SND_FLG, MF_DL_DIFF_FLG, BB_CGO_WGT, BB_CGO_MEAS_QTY, SI_FLG) " ).append("\n"); 
		...
		query.append("		, CASE WHEN (@[kcd_tp] = 'I' OR @[kcd_tp] = 'T') AND @[bkg_cgo_tp] = 'P' AND @[kt_port] = 'KRPUS' THEN 'ST' ELSE @[bond_area_code] END" ).append("\n"); 
