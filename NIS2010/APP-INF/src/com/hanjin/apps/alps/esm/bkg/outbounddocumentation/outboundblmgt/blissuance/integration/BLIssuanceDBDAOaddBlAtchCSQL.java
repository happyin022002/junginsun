...
*@FileName : BLIssuanceDBDAOaddBlAtchCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLIssuanceDBDAOaddBlAtchCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BLIssuanceDBDAOaddBlAtchCSQL
	  * </pre>
	  */
	public BLIssuanceDBDAOaddBlAtchCSQL(){
		setQuery();
		...
		query.append("FileName : BLIssuanceDBDAOaddBlAtchCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_N3RD_PTY_BL_FILE_STO " ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(" ,@[frt_term_cd]" ).append("\n"); 
		query.append(" ,(" ).append("\n"); 
		query.append("	SELECT NVL(MAX(FILE_SEQ),0)+1" ).append("\n"); 
		query.append("	FROM BKG_N3RD_PTY_BL_FILE_STO" ).append("\n"); 
		query.append("	WHERE BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("      AND POL_CD = @[pol_cd]" ).append("\n"); 
		query.append("      AND N3PTY_OFC_CD = @[n3pty_ofc_cd]" ).append("\n"); 
		query.append("      AND PAYR_CUST_CNT_CD = @[payr_cust_cnt_cd]" ).append("\n"); 
		query.append("      AND PAYR_CUST_SEQ = @[payr_cust_seq]" ).append("\n"); 
		query.append("      AND OBL_ISS_OFC_CD = @[obl_iss_ofc_cd]" ).append("\n"); 
