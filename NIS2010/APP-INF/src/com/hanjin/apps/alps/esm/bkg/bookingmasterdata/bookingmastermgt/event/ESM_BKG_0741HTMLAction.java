...
*@FileName : ESM_BKG_0741HTMLAction.java
...
public class ESM_BKG_0741HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0741HTMLAction 객체를 생성
	 */
	public ESM_BKG_0741HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0741Event event = new EsmBkg0741Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgEsvcHndlOfcVOS((BkgEsvcHndlOfcVO[])getVOs(request, BkgEsvcHndlOfcVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgDocPerfOfcVO((BkgDocPerfOfcVO)getVO(request, BkgDocPerfOfcVO .class));
		}
