...
public class ESM_SPC_0046HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0047HTMLAction 객체를 생성
	 */
	public ESM_SPC_0046HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0046Event event = new EsmSpc0046Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			...
			event.setGrpAcct(request.getParameter("grp_acct"));
