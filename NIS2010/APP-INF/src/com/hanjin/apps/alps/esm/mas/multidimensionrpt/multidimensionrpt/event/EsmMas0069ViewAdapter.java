 ...
 * @since J2EE 1.6
 */
public class EsmMas0069ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0069ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0069ViewAdapter ########### [START]");
		...
		log.debug("########### EsmMas0069ViewAdapter ########### [END]");        
