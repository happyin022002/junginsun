...
*@FileName       : ESM_SQM_0006HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmSqm0006Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0006HTMLAction 객체를 생성
	 */
	public ESM_SQM_0006HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0006Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSqm0006Event event = new EsmSqm0006Event();
