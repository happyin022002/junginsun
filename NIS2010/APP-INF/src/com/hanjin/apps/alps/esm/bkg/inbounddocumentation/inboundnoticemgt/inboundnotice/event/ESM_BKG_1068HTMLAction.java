...
public class ESM_BKG_1068HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1068HTMLAction 객체를 생성
	 */
	public ESM_BKG_1068HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1068Event event = new EsmBkg1068Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setTpbInfoVOs((TpbInfoVO[])getVOs(request,  TpbInfoVO.class, "sheet1_"));
		}
