...
*@FileName : ESM_PRI_0063HTMLAction.java
...
public class ESM_PRI_0096HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0096HTMLAction 객체를 생성
	 */
	public ESM_PRI_0096HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0096Event event = new EsmPri0096Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltPropCopyVO((RsltPropCopyVO)getVO(request, RsltPropCopyVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {
            event.setRsltPropCpBlplAfilListVOs((RsltPropCopyVO[])getVOs(request, RsltPropCopyVO.class, "sheet1_"));
            event.setRsltPropCopyVOs((RsltPropCopyVO[])getVOs(request, RsltPropCopyVO.class, "sheet2_"));
            event.setRsltPropCopyVO((RsltPropCopyVO)getVO(request, RsltPropCopyVO.class));
		}
		else {
		    event.setRsltPropCopyVO((RsltPropCopyVO)getVO(request, RsltPropCopyVO.class));
