...
*@FileName : TRIGRICalculationProposalDBDAOPriTriGriGrpVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAOPriTriGriGrpVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriTriGriGrpVO Delete
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAOPriTriGriGrpVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAOPriTriGriGrpVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_GRI_GRP" ).append("\n"); 
