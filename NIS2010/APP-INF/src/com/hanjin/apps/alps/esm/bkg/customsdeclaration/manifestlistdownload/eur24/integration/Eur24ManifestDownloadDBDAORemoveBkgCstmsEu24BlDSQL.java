...
*@FileName : Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24BlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24BlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24BlDSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24BlDSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.eur24.integration").append("\n"); 
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBkgCstmsEu24BlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_EUR_BL" ).append("\n"); 
