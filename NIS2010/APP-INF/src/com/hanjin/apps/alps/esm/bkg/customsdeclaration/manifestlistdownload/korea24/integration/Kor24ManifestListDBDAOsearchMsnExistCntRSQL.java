...
*@FileName : Kor24ManifestListDBDAOsearchMsnExistCntRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchMsnExistCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchMsnExistCntRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchMsnExistCntRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("FROM    BKG_CSTMS_ADV_KR_BL TRANS" ).append("\n");
