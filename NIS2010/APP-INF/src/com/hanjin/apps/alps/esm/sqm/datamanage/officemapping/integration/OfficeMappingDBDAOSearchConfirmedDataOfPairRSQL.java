...
*@FileName : OfficeMappingDBDAOSearchConfirmedDataOfPairRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OfficeMappingDBDAOSearchConfirmedDataOfPairRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OfficeMappingDBDAOSearchConfirmedDataOfPairRSQL(){
		setQuery();
		...
		query.append("FileName : OfficeMappingDBDAOSearchConfirmedDataOfPairRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select * from sqm_sctr_cfm_qta" ).append("\n"); 
