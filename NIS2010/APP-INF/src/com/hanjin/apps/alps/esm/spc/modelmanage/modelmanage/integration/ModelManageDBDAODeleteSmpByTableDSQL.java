...
*@FileName : ModelManageDBDAODeleteSmpByTableDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAODeleteSmpByTableDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SMP Season Creation시, 해당 season의 데이터가 기존재할 경우 삭제합니다.
	  * 2013.05.06 [CHM-201324211-01] 프로젝트 안정화 및 HELP DESK - SMP Season Creation 배치->backend로 변경
	  * </pre>
	  */
	public ModelManageDBDAODeleteSmpByTableDSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAODeleteSmpByTableDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
