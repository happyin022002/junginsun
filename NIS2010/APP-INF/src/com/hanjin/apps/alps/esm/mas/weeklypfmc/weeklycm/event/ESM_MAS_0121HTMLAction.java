...
*@FileName : ESM_MAS_0121HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.esm.mas.weeklypfmc 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_MAS_0121HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0121HTMLAction 객체를 생성
	 */
	public ESM_MAS_0121HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0121Event event = new EsmMas0121Event();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO.class));
			event.setMasLaneDirConvVOS((MasLaneDirConvVO[])getVOs(request, MasLaneDirConvVO .class,""));
			...
			event.setMasLaneDirConvVO((MasLaneDirConvVO)getVO(request, MasLaneDirConvVO.class));
		}
