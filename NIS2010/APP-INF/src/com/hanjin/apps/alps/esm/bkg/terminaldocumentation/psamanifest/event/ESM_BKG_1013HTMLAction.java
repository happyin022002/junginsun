...
*@FileName : ESM_BKG_1013HTMLAction.java
*@FileTitle : ESM_BKG_1013HTMLAction
*Open Issues :
*Change history :
...
/**
 * ESM_BKG_1013 의 HTML Action Class
 * 
 * @author 박상훈
 * @see HTMLActionSupport
 * @since J2EE 1.6
 */
public class ESM_BKG_1013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	public ESM_BKG_1013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1013Event event = new EsmBkg1013Event();
