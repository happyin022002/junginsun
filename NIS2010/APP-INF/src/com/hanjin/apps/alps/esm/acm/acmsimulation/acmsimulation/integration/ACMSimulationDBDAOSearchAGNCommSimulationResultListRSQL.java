...
*@FileName : ACMSimulationDBDAOSearchAGNCommSimulationResultListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOSearchAGNCommSimulationResultListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Simulation한 결과를 조회한다.
	  * </pre>
	  */
	public ACMSimulationDBDAOSearchAGNCommSimulationResultListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOSearchAGNCommSimulationResultListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
