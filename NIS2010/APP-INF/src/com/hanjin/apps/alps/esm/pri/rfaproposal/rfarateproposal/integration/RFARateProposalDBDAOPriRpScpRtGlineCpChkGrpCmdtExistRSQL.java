...
*@FileName : RFARateProposalDBDAOPriRpScpRtGlineCpChkGrpCmdtExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtGlineCpChkGrpCmdtExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtGlineCpChkGrpCmdtExistRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtGlineCpChkGrpCmdtExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_RG_MN A, PRI_RG_RT_CMDT_HDR B, PRI_RG_RT_CMDT C" ).append("\n"); 
		...
		query.append("FROM PRI_RP_SCP_MN SA, PRI_RP_SCP_GRP_CMDT SB" ).append("\n"); 
