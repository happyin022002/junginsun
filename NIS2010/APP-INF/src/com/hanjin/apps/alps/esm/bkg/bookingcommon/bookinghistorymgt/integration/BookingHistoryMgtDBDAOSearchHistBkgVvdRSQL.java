...
public class BookingHistoryMgtDBDAOSearchHistBkgVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                  '/'||OLD.POL_YD_CD||'('||OLD.POL_CLPT_IND_SEQ||')'||" ).append("\n"); 
		query.append("                  '/'||OLD.POD_YD_CD||'('||OLD.POD_CLPT_IND_SEQ||')' PRE_CTNT" ).append("\n"); 
		...
		query.append("                  '/'||NOW.POL_YD_CD||'('||NOW.POL_CLPT_IND_SEQ||')'||" ).append("\n"); 
		query.append("                  '/'||NOW.POD_YD_CD||'('||NOW.POD_CLPT_IND_SEQ||')' CRNT_CTNT" ).append("\n"); 
