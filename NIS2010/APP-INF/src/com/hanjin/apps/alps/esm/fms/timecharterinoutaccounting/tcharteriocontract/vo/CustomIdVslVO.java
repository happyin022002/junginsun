...
*@FileName : CustomIdVslVO.java
*@FileTitle : CustomIdVslVO
*Open Issues :
*Change history :
...
public class CustomIdVslVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomIdVslVO> models = new ArrayList<CustomIdVslVO>();
	 ...
	 * @return 
	 */
	public CustomIdVslVO() {}
	
	/**
	 * 생성자
	 * @param String ibflag, String pagerows, String fletCtrtNo, String vslCd, String useFlg, String creUsrId, String creDt, String updUsrId, String updDt, String oriVslCd
	 * @return 
	 */
	public CustomIdVslVO(String ibflag, String pagerows, String fletCtrtNo, String vslCd, String useFlg, String fletRptFlg, String creUsrId, String creDt, String updUsrId, String updDt, String oriVslCd) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	...
	public CustomIdVslVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CustomIdVslVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomIdVslVO model = null;
		...
		try {
			...
			String[] fletRptFlg = (JSPUtil.getParameter(request, prefix	+ "flet_rpt_flg".trim(), length));
		...
		return getCustomIdVslVOs();
	}

	public CustomIdVslVO[] getCustomIdVslVOs(){
		CustomIdVslVO[] vos = (CustomIdVslVO[])models.toArray(new CustomIdVslVO[models.size()]);
		return vos;
	}
