...
* --------------------------------------------------------
* History
* 2011.02.08 김영철 [] R4J 메소드 주석 기술 ( searchHldBkgVVD - 1219 )
=========================================================*/
...
public class HoldNoticeDBDAO extends DBDAOSupport {
	 ...
	 */
	public void addEnisLog(String modName, String applInfo, String logDesc) throws DAOException {
		Map<String, Object> param = new HashMap<String, Object>();
		Map<String, Object> velParam = new HashMap<String, Object>();

		try {

log.info("HoldNoticeDBDAO.addEnisLog()==>ENIS_LOG_PRC(SYSDATE, " + modName + ", " + logDesc + ", " + applInfo + ")");
