...
*@FileName : FeederChargeGuideLineDBDAOModifyFDRMainCancelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOModifyFDRMainCancelUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify FDR Main Cancel
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOModifyFDRMainCancelUSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOModifyFDRMainCancelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
