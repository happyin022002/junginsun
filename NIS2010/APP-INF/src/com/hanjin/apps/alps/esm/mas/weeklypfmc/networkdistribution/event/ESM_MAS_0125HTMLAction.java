...
*@FileName : ESM_MAS_0125HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Kim Ki Dae
 * @see EsmMas0125Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0125HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0125HTMLAction 객체를 생성
	 */
	public ESM_MAS_0125HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0125Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0125Event event = new EsmMas0125Event();  		
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			...
			event.setMasLaneTsBsaCmmtVOs((MasLaneTsBsaCmmtVO[])getVOs(request, MasLaneTsBsaCmmtVO.class));	
