...
public class CargoReleaseOrderDBDAOAddEdoDoCSQL implements ISQLTemplate{
	...
	public CargoReleaseOrderDBDAOAddEdoDoCSQL(){
		...
		params.put("payr_remit_dt1",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("payr_remit_dt2",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(",	PAYR_REMIT_DT1" ).append("\n"); 
		query.append(",	PAYR_REMIT_DT2" ).append("\n"); 
		...
		query.append(",	@[payr_bank_nm]" ).append("\n"); 
		query.append(",	@[payr_bank_acct_no]" ).append("\n"); 
		query.append(",	TO_DATE(@[payr_remit_dt1],'YYYYMMDD')" ).append("\n"); 
		query.append(",	TO_DATE(@[payr_remit_dt2],'YYYYMMDD')" ).append("\n"); 
		query.append(",	@[hndl_ofc_cd]" ).append("\n"); 
