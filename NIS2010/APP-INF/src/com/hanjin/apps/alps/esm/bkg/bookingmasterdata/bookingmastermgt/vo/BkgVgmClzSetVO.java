...
*@FileName : BkgVgmClzSetVO.java
*@FileTitle : BkgVgmClzSetVO
*Open Issues :
*Change history :
...
public class BkgVgmClzSetVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	 
	private Collection<BkgVgmClzSetVO> models = new ArrayList<BkgVgmClzSetVO>();
	 ...
	 */
	public BkgVgmClzSetVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgvgmClzSetVO[]
	 */
	public BkgVgmClzSetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgVgmClzSetVO model = null;
	...
	public BkgVgmClzSetVO[] getBkgvgmClzSetVOs(){
		BkgVgmClzSetVO[] vos = (BkgVgmClzSetVO[])models.toArray(new BkgVgmClzSetVO[models.size()]);
		return vos;
	}
