...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteCtntVOAllDSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteCtntVOAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteCtntVOAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteCtntVOAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM pri_sg_stnd_note_ctnt" ).append("\n"); 
