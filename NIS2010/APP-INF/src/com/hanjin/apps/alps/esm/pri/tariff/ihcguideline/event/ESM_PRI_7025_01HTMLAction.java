 ...
 *@FileName : ESM_PRI_7025_01HTMLAction.java
...
public class ESM_PRI_7025_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_7025_01HTMLAction 객체를 생성
	 */
	public ESM_PRI_7025_01HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri702501Event event = new EsmPri702501Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchIHCAmendmentHistoryDetailVO((SearchIHCAmendmentHistoryDetailVO)getVO(request, SearchIHCAmendmentHistoryDetailVO .class));
		}
		return event;
	}
