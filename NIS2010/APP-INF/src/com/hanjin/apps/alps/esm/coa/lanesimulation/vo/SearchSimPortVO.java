...
*@FileName : SearchSimPortVO.java
*@FileTitle : SearchSimPortVO
*Open Issues :
*Change history :
...
public class SearchSimPortVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSimPortVO> models = new ArrayList<SearchSimPortVO>();
	...
	public SearchSimPortVO() {}

	public SearchSimPortVO(String ibflag, String pagerows, String slanCd, String sectNo, String trdCd, String rlaneCd, String skdDirCd, String tmlCd, String seq, String turnPortIndCd, String fmCnt, String toCnt, String num) {
		this.toCnt = toCnt;
		this.fmCnt = fmCnt;
		this.trdCd = trdCd;
		this.sectNo = sectNo;
	 ...
	 * @param request
	 * @return SearchSimPortVO[]
	 */
	public SearchSimPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSimPortVO[]
	 */
	public SearchSimPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSimPortVO model = null;
	 ...
	 * @return SearchSimPortVO[]
	 */
	public SearchSimPortVO[] getSearchSimPortVOs(){
		SearchSimPortVO[] vos = (SearchSimPortVO[])models.toArray(new SearchSimPortVO[models.size()]);
		return vos;
	}
