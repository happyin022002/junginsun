...
*@FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewAgmtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewAgmtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewAgmtCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewAgmtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AGT_AGN_AGMT" ).append("\n"); 
		...
		query.append("FM_EFF_DT, TO_EFF_DT," ).append("\n"); 
		...
		query.append("@[vndr_cnt_cd]," ).append("\n"); 
		query.append("@[vndr_seq]," ).append("\n"); 
		query.append("1 AS AGN_AGMT_VER_SEQ," ).append("\n"); 
		...
		query.append("AND AGMT_OFC_CD      = @[agmt_ofc_cd_value]" ).append("\n"); 
