...
*@FileName : PSASpecialManifestDBDAOaddPsaVslInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOaddPsaVslInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSASpecialManifestDBDAOaddPsaVslInfoCSQL(){
		setQuery();
		...
		query.append("FileName : PSASpecialManifestDBDAOaddPsaVslInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_DG_VSL_SKD (" ).append("\n"); 
