...
*@FileName : GroupCommodityCMPBGuidelineDBDAOCheckGroupCommodityInUseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GroupCommodityCMPBGuidelineDBDAOCheckGroupCommodityInUseRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupCommodityCMPBGuidelineDBDAOCheckGroupCommodityInUseRSQL(){
		setQuery();
		...
		query.append("FileName : GroupCommodityCMPBGuidelineDBDAOCheckGroupCommodityInUseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
