...
*@FileName : FeederChargeGuideLineDBDAOUploadAddonCreationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOUploadAddonCreationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 엑셀 업로드를 통한 Feeder 추가
	  * 
	  * * History
	  * 2013.03.16 [CHM-201534279] 전지예 Pricing Feeder/IHC tariff 45" 칼럼 추가 안
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOUploadAddonCreationUSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOUploadAddonCreationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
