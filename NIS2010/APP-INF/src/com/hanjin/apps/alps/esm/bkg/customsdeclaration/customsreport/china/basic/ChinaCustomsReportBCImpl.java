...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.china.basic;

import java.util.ArrayList;
import java.util.List;

import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.basic.CustomsReportBCImpl;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.china.integration.ChinaCustomsReportDBDAO;
 ...
 * @since J2EE 1.6
 */
public class ChinaCustomsReportBCImpl extends CustomsReportBCImpl {
	...
	public List<ManifestListDetailVO> searchTransmitHist(
			TransmitHistCondVO  transmitHistCondVO ) throws EventException {
	...
	public List<BkgCstmsCCAMListVO> searchBkgCCAMList(BkgCstmsCCAMCondVO bkgCstmsCCAMCondVO) throws EventException {
		List<BkgCstmsCCAMListVO> bkgCstmsCCAMListVOs = null;
		List<ManifestListDetailVO> manifestListDetailVOs = null;
		
		try {
			bkgCstmsCCAMListVOs = dbDao.searchBkgCCAMList(bkgCstmsCCAMCondVO);

			//bkgCstmsCCAMListVOs = (List<BkgCstmsCCAMListVO>)(Object)bkgCstmsCCAMListVOs;
