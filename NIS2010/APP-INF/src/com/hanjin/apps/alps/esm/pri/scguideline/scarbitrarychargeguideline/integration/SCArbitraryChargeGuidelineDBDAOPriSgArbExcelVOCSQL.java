...
*@FileName : SCArbitraryChargeGuidelineDBDAOPriSgArbExcelVOCSQL.java
...
public class SCArbitraryChargeGuidelineDBDAOPriSgArbExcelVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCArbitraryChargeGuidelineDBDAOPriSgArbExcelVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCArbitraryChargeGuidelineDBDAOPriSgArbExcelVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", @[gline_seq]" ).append("\n"); 
		query.append(", @[org_dest_tp_cd]" ).append("\n"); 
		query.append(", NVL((SELECT /*+ INDEX_DESC(A XPKPRI_SG_ARB) */  ARB_SEQ" ).append("\n"); 
