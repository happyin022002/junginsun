...
public class UsaCustomsTransmissionDBDAOsearchMiHiHeaderFooterRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	RPAD('ACRSMLM      '||@[trsp_msg_tp_cd],80,' ')||CHR(10)||" ).append("\n"); 
		...
		query.append("	RPAD('P01'||substr(@[loc_amsport],1,4)||substr(@[vps_eta_dt],1,6)||LPAD(TO_CHAR(@[bl_cnt]),5,'0'),80,' ')||CHR(10)||" ).append("\n"); 
