...
*@FileName : ESM_BKG_0914HTMLAction.java
...
public class ESM_BKG_0914HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0914HTMLAction 객체를 생성
	 */
	public ESM_BKG_0914HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0914Event event = new EsmBkg0914Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPctlOfficeListVO((PortCloseOfficeListVO)getVO(request, PortCloseOfficeListVO .class));
			event.setPortCloseBLlistVO((PortCloseBLlistVO)getVO(request, PortCloseBLlistVO .class));
