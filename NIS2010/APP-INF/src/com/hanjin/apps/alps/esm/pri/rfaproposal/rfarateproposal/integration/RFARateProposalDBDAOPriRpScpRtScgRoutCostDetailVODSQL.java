...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgRoutCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("" ).append("\n"); 
		query.append("MERGE INTO PRI_RP_SCP_RT_SCG_ROUT A" ).append("\n"); 
