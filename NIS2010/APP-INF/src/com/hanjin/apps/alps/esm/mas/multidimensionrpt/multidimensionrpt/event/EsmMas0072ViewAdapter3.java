 ...
 * @since J2EE 1.6
 */
public class EsmMas0072ViewAdapter3 extends DefaultViewAdapter {
	
    public EsmMas0072ViewAdapter3(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0072ViewAdapter3 ########### [START]");
		...
		log.debug("########### EsmMas0072ViewAdapter3 ########### [END]");        
