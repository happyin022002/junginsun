...
public class JapDoHisSearchVO extends AbstractValueObject {
	...
	public JapDoHisSearchVO(String ibflag, String pagerows, String evntDtStart, String evntDtEnd, String evntOfcCd, String issueDt, String issueOfcCd, String podCd, String rdFlag, String rlseStsCd, String skdDirCd, String skdVoyNo, String vslCd, String pageNo, String excelFlg,String dorIf) {
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dor_if", getDorIf());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dor_if", "dorIf");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDorIf(JSPUtil.getParameter(request, "dor_if", ""));
	}
	...
	public JapDoHisSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dorIf = (JSPUtil.getParameter(request, prefix	+ "dor_if", length));
	...
	*/
	public void unDataFormat(){
		...
		this.dorIf = this.dorIf .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}

	public String getDorIf() {
		return dorIf;
	}

	public void setDorIf(String dorIf) {
		this.dorIf = dorIf;
	}
}
