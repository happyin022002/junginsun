...
*@FileName : ESM_BKG_1604HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_1604HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2007HTMLAction 객체를 생성
	 */
	public ESM_BKG_1604HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1604Event event = new EsmBkg1604Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriRpAproRqstRefUsrVOs((PriRpAproRqstRefUsrVO[])getVOs(request, PriRpAproRqstRefUsrVO.class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setOrganizationChartVO((OrganizationChartVO) getVO(request, OrganizationChartVO.class));
		}
