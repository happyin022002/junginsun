...
*@FileName : ZDAOFrtCltLstVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ZDAOFrtCltLstVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ZDAOFrtCltLstVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.integration").append("\n"); 
		query.append("FileName : ZDAOFrtCltLstVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'' as frt_chk" ).append("\n"); 
		query.append(",'' as frt_chk_cnt" ).append("\n"); 
