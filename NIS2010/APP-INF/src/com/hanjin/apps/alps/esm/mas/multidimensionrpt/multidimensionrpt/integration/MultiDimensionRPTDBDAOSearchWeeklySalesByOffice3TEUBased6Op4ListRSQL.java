...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op4ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op4ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op4ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op4ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
