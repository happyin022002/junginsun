...
*@FileName : SearchBunkerFeeVO.java
*@FileTitle : SearchBunkerFeeVO
*Open Issues :
*Change history :
...
* =========================================================
* History
* 2012.01.31 김종준 [CHM-201215754-01] [MAS] Bunker Fee 화면 개발 건.
=========================================================*/
...
public class SearchBunkerFeeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBunkerFeeVO> models = new ArrayList<SearchBunkerFeeVO>();
...
/**
	 ...
	 * @param request
	 * @return SearchBunkerFeeVO[]
	 */
	public SearchBunkerFeeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBunkerFeeVO[]
	 */
	public SearchBunkerFeeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBunkerFeeVO model = null;
	 ...
	 * @return SearchBunkerFeeVO[]
	 */
	public SearchBunkerFeeVO[] getSearchBunkerFeeVOs(){
		SearchBunkerFeeVO[] vos = (SearchBunkerFeeVO[])models.toArray(new SearchBunkerFeeVO[models.size()]);
		return vos;
	}
