...
public class LaneSimulationDBDAOCreateSimVolProj1CSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("INSERT INTO COA_SIM_VOL_PRJ(SIM_DT, SIM_NO, SECT_NO, POL_CD, POD_CD, PORT_PAIR_QTY, PORT_PAIR_LOD_QTY, PORT_PAIR_RTO, GRS_RPB_REV, TRD_CD, SUB_TRD_CD, RLANE_CD, SKD_DIR_CD, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT) " ).append("\n"); 
		...
		query.append("	                    FROM COA_SIM_SMRY B1 " ).append("\n"); 
		query.append("	                        ,( " ).append("\n"); 
