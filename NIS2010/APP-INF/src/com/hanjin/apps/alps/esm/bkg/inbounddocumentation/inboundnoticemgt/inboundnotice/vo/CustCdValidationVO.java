...
public class CustCdValidationVO extends AbstractValueObject {
	...
	private String valAvalFlg = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("val_aval_flg", getValAvalFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("val_aval_flg", "valAvalFlg");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMdmCustCd(JSPUtil.getParameter(request, prefix + "val_ofc_cd", ""));
	...
	public CustCdValidationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] valAvalFlg = (JSPUtil.getParameter(request, prefix	+ "val_aval_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (valAvalFlg[i] != null)
					model.setValAvalFlg(valAvalFlg[i]);
				if (valDt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.valAvalFlg = this.valAvalFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	...
	public String getValAvalFlg() {
		return valAvalFlg;
	}

	public void setValAvalFlg(String valAvalFlg) {
		this.valAvalFlg = valAvalFlg;
	}
