...
*@FileName : DpcsSiSplitBkgCntrHisVO.java
*@FileTitle : DpcsSiSplitBkgCntrHisVO
*Open Issues :
*Change history :
...
public class DpcsSiSplitBkgCntrHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DpcsSiSplitBkgCntrHisVO> models = new ArrayList<DpcsSiSplitBkgCntrHisVO>();
	...
	/* Column Info */
	private String originBkgQty = null;
	/* Column Info */
	...
	/* Column Info */
	private String originCntrCnt = null;
	/* Column Info */
	...
	public DpcsSiSplitBkgCntrHisVO() {}

	public DpcsSiSplitBkgCntrHisVO(String ibflag, String pagerows, String bkgNo, String docTpCd, String xterRqstNo, String splitStsCd, String xterBkgRqstStsCd, String bkgUpldStsCd, String xterRqstSeq, String rqstDt, String polCd, String rqstDepDt, String vvdCd, String ediHldFlg, String originBkgQty, String bkgQty, String originCntrCnt, String cntrCnt, String cntrDesc, String xterRmk, String xterRmkAll, String pckQty, String pckTpCd, String netWgt, String netWgtUtCd, String measQty, String measUtCd, String xterSndrId, String vpsEtdDt, String searchType, String creDt, String noRank) {
		this.creDt = creDt;
		...
		this.polCd = polCd;
		this.ibflag = ibflag;
		this.originBkgQty = originBkgQty;
		this.vvdCd = vvdCd;
		this.bkgQty = bkgQty;
		...
		this.netWgt = netWgt;
		this.originCntrCnt = originCntrCnt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("origin_bkg_qty", getOriginBkgQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("origin_bkg_qty", "originBkgQty");
	 ...
	 * @return originBkgQty
	 */
	public String getOriginBkgQty() {
		return this.originBkgQty;
	}
	...
	/**
	 * Column Info
	 * @return originCntrCnt
	 */
	public String getOriginCntrCnt() {
		return this.originCntrCnt;
	}
	 ...
	 * @param originBkgQty
	 */
	public void setOriginBkgQty(String originBkgQty) {
		this.originBkgQty = originBkgQty;
	}
	 ...
	 * @param noRank
	 */
	public void setNoRank(String noRank) {
		this.noRank = noRank;
	}
	 ...
	 * @param originCntrCnt
	 */
	public void setOriginCntrCnt(String originCntrCnt) {
		this.originCntrCnt = originCntrCnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOriginBkgQty(JSPUtil.getParameter(request, prefix + "origin_bkg_qty", ""));
		...
		setNoRank(JSPUtil.getParameter(request, prefix + "no_rank", ""));
		...
		setOriginCntrCnt(JSPUtil.getParameter(request, prefix + "origin_cntr_cnt", ""));
	 ...
	 */
	public DpcsSiSplitBkgCntrHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DpcsSiSplitBkgCntrHisVO[]
	 */
	public DpcsSiSplitBkgCntrHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DpcsSiSplitBkgCntrHisVO model = null;
		...
		try {
			...
			String[] originBkgQty = (JSPUtil.getParameter(request, prefix	+ "origin_bkg_qty", length));
			...
			String[] noRank = (JSPUtil.getParameter(request, prefix	+ "no_rank", length));
			...
			String[] originCntrCnt = (JSPUtil.getParameter(request, prefix	+ "origin_cntr_cnt", length));
			...
			for (int i = 0; i < length; i++) {
				model = new DpcsSiSplitBkgCntrHisVO();
				if (creDt[i] != null)
				...
				if (originBkgQty[i] != null)
					model.setOriginBkgQty(originBkgQty[i]);
				if (vvdCd[i] != null)
				...
				if (originCntrCnt[i] != null)
					model.setOriginCntrCnt(originCntrCnt[i]);
				if (cntrCnt[i] != null)
		...
		return getDpcsSiSplitBkgCntrHisVOs();
	}
	...
	public DpcsSiSplitBkgCntrHisVO[] getDpcsSiSplitBkgCntrHisVOs(){
		DpcsSiSplitBkgCntrHisVO[] vos = (DpcsSiSplitBkgCntrHisVO[])models.toArray(new DpcsSiSplitBkgCntrHisVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.originBkgQty = this.originBkgQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.noRank = this.noRank .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.originCntrCnt = this.originCntrCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
