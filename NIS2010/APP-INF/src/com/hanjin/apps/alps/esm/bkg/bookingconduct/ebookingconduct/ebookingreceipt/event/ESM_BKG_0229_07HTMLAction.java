...
*@FileName : ESM_BKG_0229_07HTMLAction.java
...
public class ESM_BKG_0229_07HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0229_07HTMLAction 객체를 생성
	 */
	public ESM_BKG_0229_07HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg022907Event event = new EsmBkg022907Event();
		...
		{
			event.setCntrTpSz(request.getParameter("cntrtpsz"));
		}		
		else if (command.isCommand(FormCommand.MULTI03))
		{
			// Reefer
			AlpsRfVO[] nisRfVOs = (AlpsRfVO[]) getVOs(request, AlpsRfVO .class,"t7sheet1_");
			int iMaxRcSeq = 0;
			int iDataCnt = 0;
			...
			event.setBkgRfCgoVOs(bkgRfCgoVO);
		}		
