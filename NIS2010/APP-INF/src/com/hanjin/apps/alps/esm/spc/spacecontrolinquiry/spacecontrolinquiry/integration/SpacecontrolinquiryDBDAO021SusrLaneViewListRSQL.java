...
*@FileName : SpacecontrolinquiryDBDAO021SusrLaneViewListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAO021SusrLaneViewListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Kim Sung Hun : Ticket ID : CHM-201215649
	  * 2012.02.16 김성훈 [CHM-201216142-01] 사용자별 Lane 정보 관리/조회시 Lane 항목 추가
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAO021SusrLaneViewListRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAO021SusrLaneViewListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM SPC_USR_LANE_INFO" ).append("\n"); 
