...
*@FileName : PsaJurongIfVO.java
*@FileTitle : PsaJurongIfVO
*Open Issues :
*Change history :
...
public class PsaJurongIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsaJurongIfVO> models = new ArrayList<PsaJurongIfVO>();
	...
	public PsaJurongIfVO() {}

	public PsaJurongIfVO(String ibflag, String pagerows, String vslName, String vvdNm, String cntrNo, String portCd, String cntrTpCd, String cntrSzCd, String undDeckTpId, String special) {
		this.ibflag = ibflag;
	 ...
	 */
	public PsaJurongIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaJurongIfVO[]
	 */
	public PsaJurongIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaJurongIfVO model = null;
	...
	public PsaJurongIfVO[] getPsaJurongIfVOs(){
		PsaJurongIfVO[] vos = (PsaJurongIfVO[])models.toArray(new PsaJurongIfVO[models.size()]);
		return vos;
	}
