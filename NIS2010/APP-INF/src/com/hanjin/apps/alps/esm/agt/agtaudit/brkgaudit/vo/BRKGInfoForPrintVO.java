...
*@FileName : BRKGInfoForPrint1VO.java
*@FileTitle : BRKGInfoForPrint1VO
*Open Issues :
*Change history :
...
public class BRKGInfoForPrintVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BRKGInfoForPrintVO> models = new ArrayList<BRKGInfoForPrintVO>();
	 ...
	 * @param hdrAmt
	 */
	public void setHdrAmt(String hdrAmount) {
		this.hdrAmount = hdrAmt;
	}
	 ...
	 * @param request
	 * @return BRKGInfoForPrint1VO[]
	 */
	public BRKGInfoForPrintVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BRKGInfoForPrint1VO[]
	 */
	public BRKGInfoForPrintVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BRKGInfoForPrintVO model = null;
		...
		return getBRKGInfoForPrint1VOs();
	}
	 ...
	 * @return BRKGInfoForPrint1VO[]
	 */
	public BRKGInfoForPrintVO[] getBRKGInfoForPrint1VOs(){
		BRKGInfoForPrintVO[] vos = (BRKGInfoForPrintVO[])models.toArray(new BRKGInfoForPrintVO[models.size()]);
		return vos;
	}
