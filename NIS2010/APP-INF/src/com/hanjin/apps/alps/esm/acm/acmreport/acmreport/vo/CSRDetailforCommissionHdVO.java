...
*@FileName : CSRDetailforCommissionHdVO.java
*@FileTitle : CSRDetailforCommissionHdVO
*Open Issues :
*Change history :
...
public class CSRDetailforCommissionHdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CSRDetailforCommissionHdVO> models = new ArrayList<CSRDetailforCommissionHdVO>();
	...
	public CSRDetailforCommissionHdVO() {}

	public CSRDetailforCommissionHdVO(String ibflag, String pagerows, String tjOfcCd, String invDt, String vndrSeq, String vndrLoclLangNm, String attrCtnt1, String csrCurrCd, String csrAmt, String invTermDt, String attrCtnt2, String csrNo) {
		this.csrNo = csrNo;
	 ...
	 */
	public CSRDetailforCommissionHdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CSRDetailforCommissionHdrVO[]
	 */
	public CSRDetailforCommissionHdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CSRDetailforCommissionHdVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CSRDetailforCommissionHdVO();
				if (csrNo[i] != null)
		...
		return getCSRDetailforCommissionHdVOs();
	}
	...
	public CSRDetailforCommissionHdVO[] getCSRDetailforCommissionHdVOs(){
		CSRDetailforCommissionHdVO[] vos = (CSRDetailforCommissionHdVO[])models.toArray(new CSRDetailforCommissionHdVO[models.size()]);
		return vos;
	}
