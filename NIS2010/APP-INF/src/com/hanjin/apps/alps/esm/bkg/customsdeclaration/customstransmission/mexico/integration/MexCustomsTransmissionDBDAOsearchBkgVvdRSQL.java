...
*@FileName : MexCustomsTransmissionDBDAOsearchBkgVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MexCustomsTransmissionDBDAOsearchBkgVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * dwkim, 0370, MxBkgVvdVO
	  * </pre>
	  */
	public MexCustomsTransmissionDBDAOsearchBkgVvdRSQL(){
		setQuery();
		...
		query.append("FileName : MexCustomsTransmissionDBDAOsearchBkgVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",NVL(decode(B.SHP_CALL_NO, NULL, C.SHP_CALL_NO, B.SHP_CALL_NO),' ') VVD_REF_NO1" ).append("\n"); 
		query.append(",A.POL_CD BLPOL1" ).append("\n"); 
		query.append(",E.LOC_NM POL_FULLNAME1" ).append("\n"); 
		query.append(",A.POD_CD BLPOD1" ).append("\n"); 
