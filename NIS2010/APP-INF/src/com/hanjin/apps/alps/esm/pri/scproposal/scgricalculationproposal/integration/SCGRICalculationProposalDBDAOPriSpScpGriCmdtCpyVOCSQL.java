...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriCmdtCpyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriCmdtCpyVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriCmdtCpyVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriCmdtCpyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_GRI_CMDT_CPY (" ).append("\n"); 
		...
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_GRI_CMDT" ).append("\n"); 
