...
*@FileName : HoldNoticeDBDAOmodifyHldNtcSendIdByEmailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HoldNoticeDBDAOmodifyHldNtcSendIdByEmailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public HoldNoticeDBDAOmodifyHldNtcSendIdByEmailUSQL(){
		setQuery();
		...
		query.append("FileName : HoldNoticeDBDAOmodifyHldNtcSendIdByEmailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("HLD_EML_SND_ID = @[hld_eml_snd_id]" ).append("\n"); 
