...
*@FileName : RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOUSQL.java
...
public class RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_GRP_CMDT SET" ).append("\n"); 
