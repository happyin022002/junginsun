...
*@FileName : PlanningDBDAOCreateTransferSqmSctrPfGrpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOCreateTransferSqmSctrPfGrpCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [SQM_SCTR_PF_GRP] 데이터를 1Q로 복사한다.
	  * </pre>
	  */
	public PlanningDBDAOCreateTransferSqmSctrPfGrpCSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOCreateTransferSqmSctrPfGrpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SQM_SCTR_PF_GRP (BSE_TP_CD, BSE_YR, BSE_QTR_CD, RLANE_CD, PF_GRP_CD, PF_SVC_TP_CD, TRD_CD, SUB_TRD_CD, PF_ROUT_DESC, SQM_ACT_FLG, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT )" ).append("\n"); 
