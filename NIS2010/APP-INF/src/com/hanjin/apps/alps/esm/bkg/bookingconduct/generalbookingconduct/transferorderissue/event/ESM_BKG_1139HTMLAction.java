...
*@FileName : ESM_BKG_1139HTMLAction.java
...
public class ESM_BKG_1139HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1139HTMLAction 객체를 생성
	 */
	public ESM_BKG_1139HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1139Event event = new EsmBkg1139Event();
        log.debug("::CALL::> ESM_BKG_1139_HTMLAction - " + command.getCommand());
