...
*@FileName : SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowOfficeLaneListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowOfficeLaneListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchSpaceControlInquiryNoShowOfficeLaneList
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowOfficeLaneListRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowOfficeLaneListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n"); 
		query.append("  SELECT N.AQ_CD   ," ).append("\n"); 
		...
		query.append("         DECODE(N.AQ_CD, NULL, 0, 1) + DECODE(N.OFC_CD, NULL, 0, 1) + DECODE(N.RLANE_CD, NULL, 0, 1) + DECODE(N.VVD, NULL, 0, 1) AS LVL" ).append("\n"); 
		query.append("    FROM NSHW_DATA N" ).append("\n"); 
		query.append("GROUP BY GROUPING SETS (" ).append("\n"); 
		query.append("                         (N.AQ_CD, N.OFC_CD, N.TRD_CD, N.SUB_TRD_CD, N.RLANE_CD, N.VVD, N.DIR_CD, N.COST_YR, N.COST_WK)," ).append("\n"); 
		query.append("                         (N.AQ_CD, N.OFC_CD, N.TRD_CD, N.SUB_TRD_CD, N.RLANE_CD)," ).append("\n"); 
		query.append("                         (N.AQ_CD, N.OFC_CD)," ).append("\n"); 
		query.append("                         (N.AQ_CD)" ).append("\n"); 
		query.append("                       )" ).append("\n"); 
		query.append("ORDER BY DECODE(N.AQ_CD, 'DNC', '1', 'DSC', '2', 'DKJ', '3', 'DSA', '4', 'DPI', '5', NVL(N.AQ_CD, '0'))," ).append("\n"); 
		query.append("         NVL(N.OFC_CD  , ' ')," ).append("\n"); 
		query.append("         NVL(N.TRD_CD  , ' ')," ).append("\n"); 
