...
*@FileName : TRIProposalDBDAOPriTriRtUsdRoutCsFlagVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtUsdRoutCsFlagVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_USD_ROUT_CS의 USD_ROUT_CS_SEL_FLG값을 갱신
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtUsdRoutCsFlagVOUSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtUsdRoutCsFlagVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_TRI_RT_USD_ROUT_CS" ).append("\n"); 
