...
*@FileName : ESM_COA_0221HTMLAction.java
...
public class ESM_COA_0221HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0221HTMLAction 객체를 생성
	 */
	public ESM_COA_0221HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0221Event event = new EsmCoa0221Event();
