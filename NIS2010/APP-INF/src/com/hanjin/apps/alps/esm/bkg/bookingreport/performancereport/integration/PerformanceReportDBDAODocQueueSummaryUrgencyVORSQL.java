...
*@FileName : PerformanceReportDBDAODocQueueSummaryUrgencyVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAODocQueueSummaryUrgencyVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PerformanceReportDBDAODocQueueSummaryUrgencyVORSQL
	  * </pre>
	  */
	public PerformanceReportDBDAODocQueueSummaryUrgencyVORSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAODocQueueSummaryUrgencyVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(NORMAL, 0, 0, (NORMAL / TOTAL) * 100), 2), '990.99')) AS NORMAL_PER," ).append("\n"); 
		query.append("       VIP," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(VIP, 0, 0, (VIP / TOTAL) * 100), 2), '990.99')) AS VIP_PER," ).append("\n"); 
		query.append("       URGENT," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(URGENT, 0, 0, (URGENT / TOTAL) * 100), 2), '990.99')) AS URGENT_PER," ).append("\n"); 
		query.append("       EDI," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(EDI, 0, 0, (EDI / TOTAL) * 100), 2), '990.99')) AS EDI_PER" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("               SUM(DECODE(URGENCY, 'FN', 1, 'MN', 1, 0)) AS NORMAL," ).append("\n"); 
		query.append("               SUM(DECODE(URGENCY, 'FV', 1, 'MV', 1, 0)) AS VIP," ).append("\n"); 
		query.append("               SUM(DECODE(URGENCY, 'FU', 1, 'MU', 1, 0)) AS URGENT," ).append("\n"); 
		query.append("               SUM(DECODE(SR_KND_CD, 'E', 1, 0)) AS EDI" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                       A.SR_KND_CD||A.SR_URG_CD AS URGENCY" ).append("\n"); 
		query.append("" ).append("\n"); 
