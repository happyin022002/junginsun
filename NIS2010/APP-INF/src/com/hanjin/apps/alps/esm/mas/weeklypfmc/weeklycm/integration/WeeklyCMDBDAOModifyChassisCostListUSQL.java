...
*@FileName : WeeklyCMDBDAOModifyChassisCostListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOModifyChassisCostListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOModifyChassisCostListUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOModifyChassisCostListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_CHSS_COST_UPLD" ).append("\n"); 
		query.append("SET EFF_FM_YRMON = @[eff_fm_yrmon]," ).append("\n"); 
		query.append("	EFF_TO_YRMON = @[eff_to_yrmon]," ).append("\n"); 
		query.append("	ON_ST_AMT = @[on_st_amt]," ).append("\n"); 
		query.append("	ON_TML_AMT = @[on_tml_amt]," ).append("\n"); 
		query.append("	MIG_AMT = @[mig_amt]," ).append("\n"); 
		query.append("	REV_SHR_AMT = @[rev_shr_amt]," ).append("\n"); 
		query.append("	CR_MM_AMT = @[cr_mm_amt]," ).append("\n"); 
		query.append("	MISC_RBIL_AMT = @[misc_re_bil_amt]," ).append("\n"); 
		query.append("	ON_CHSS_AMT = @[on_chss_amt]," ).append("\n"); 
		query.append("	CHSS_DRYG_AMT = @[chss_dryg_amt]," ).append("\n"); 
		query.append("	COM_SUB_TTL_AMT = @[com_sub_ttl_amt]," ).append("\n"); 
		query.append("	CHSS_RMK = @[chss_rmk]," ).append("\n"); 
		query.append("	UPD_USR_ID = @[upd_usr_id]," ).append("\n"); 
		query.append("	UPD_DT = SYSDATE" ).append("\n"); 
		query.append("WHERE COST_YR     = @[cost_yr]" ).append("\n"); 
		query.append("  AND BSE_QTR_CD = @[cost_qtr_cd]" ).append("\n"); 
