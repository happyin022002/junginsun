...
*@FileName : RFARateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtCmdtDtlInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY CMDT_HDR_SEQ, DECODE(PRC_CMDT_TP_CD, 'G', 1, 'R', 2, 'C', 3, 99), PRC_CMDT_DEF_CD ,CMDT_SEQ" ).append("\n"); 
