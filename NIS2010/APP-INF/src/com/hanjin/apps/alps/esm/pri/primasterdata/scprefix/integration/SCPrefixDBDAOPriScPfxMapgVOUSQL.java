...
*@FileName : SCPrefixDBDAOPriScPfxMapgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCPrefixDBDAOPriScPfxMapgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCPrefixDBDAOPriScPfxMapgVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_SC_PFX_MAPG SET" ).append("\n"); 
		query.append("SC_PFX_CD = @[sc_pfx_cd]," ).append("\n"); 
		...
		query.append("FileName : SCPrefixDBDAOPriScPfxMapgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}