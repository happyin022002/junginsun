...
*@FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVODSQL.java
...
public class RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Commodity Guideline Detail Delete
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtDtlVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RG_GRP_CMDT_DTL" ).append("\n"); 
