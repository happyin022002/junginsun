...
*@FileName : ScqBreakbulkDBDAOmodifyPriScqBbRoutCostUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqBreakbulkDBDAOmodifyPriScqBbRoutCostUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyPriScqBbRoutCost
	  * </pre>
	  */
	public ScqBreakbulkDBDAOmodifyPriScqBbRoutCostUSQL(){
		setQuery();
		...
		query.append("FileName : ScqBreakbulkDBDAOmodifyPriScqBbRoutCostUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SCQ_BB_ROUT_COST" ).append("\n"); 
		...
		query.append("   AND ROUT_COST_SEQ   = @[rout_cost_seq]" ).append("\n"); 
