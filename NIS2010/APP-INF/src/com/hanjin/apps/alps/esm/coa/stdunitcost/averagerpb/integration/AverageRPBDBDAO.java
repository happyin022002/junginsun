...
import com.hanjin.apps.alps.esm.coa.stdunitcost.usdomestic.integration.USDomesticDBDAOSearchUSDomCreationStatusRSQL;
import com.hanjin.apps.alps.esm.coa.weeklypfmc.networkdistribution.integration.NetworkDistributionDBDAOAddTSAllocationBatchStatusCSQL;
import com.hanjin.apps.alps.esm.coa.weeklypfmc.networkdistribution.integration.NetworkDistributionDBDAOCheckTsAllocationCreateBatchStatusRSQL;
...
public class AverageRPBDBDAO extends DBDAOSupport {
	 ...
	 * @throws DAOException
	 */
	public List<CoaUtCostCreStsVO> searchRPBStatus(String fTargetYrMon) throws DAOException {
        DBRowSet dbRowset = null;
	 ...
	 * @throws DAOException
	 */
	public List<CoaUtCostCreStsVO> checkAverageRPBCreateBatchStatus() throws DAOException {
        DBRowSet dbRowset = null;
        List<CoaUtCostCreStsVO> list = null;
      //query parameter
		Map<String, Object> param = new HashMap<String, Object>();
