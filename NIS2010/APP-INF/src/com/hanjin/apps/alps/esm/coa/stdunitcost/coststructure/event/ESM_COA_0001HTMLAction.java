...
*@FileName : ESM_COA_001HTMLAction.java
...
public class ESM_COA_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_001HTMLAction 객체를 생성
	 */
	public ESM_COA_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0001Event event = new EsmCoa0001Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCoaSpclRepoCntrRgstVOS((CoaSpclRepoCntrRgstVO[])getVOs(request, CoaSpclRepoCntrRgstVO.class,""));
