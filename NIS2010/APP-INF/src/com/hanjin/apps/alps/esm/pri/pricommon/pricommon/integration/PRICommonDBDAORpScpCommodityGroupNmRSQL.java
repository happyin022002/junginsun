...
*@FileName : PRICommonDBDAORpScpCommodityGroupNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAORpScpCommodityGroupNmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PRICommonDBDAORpScpCommodityGroupNmRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAORpScpCommodityGroupNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
