...
*@FileName : BookingHistoryMgtDBDAOsearchCntrMfDescChgHisRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingHistoryMgtDBDAOsearchCntrMfDescChgHisRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingHistoryMgtDBDAOsearchCntrMfDescChgHisRSQL
	  * </pre>
	  */
	public BookingHistoryMgtDBDAOsearchCntrMfDescChgHisRSQL(){
		setQuery();
		...
		query.append("FileName : BookingHistoryMgtDBDAOsearchCntrMfDescChgHisRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            , @[cntr_mf_gds_desc] PRE_CTNT" ).append("\n"); 
		...
		query.append("           AND NOW.CNTR_MF_SEQ (+) = @[cntr_mf_seq]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    )    " ).append("\n"); 
