...
public class ESM_BKG_0154HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI)) {
	        ...
	        event.getBkgUsrDfltSetVO().setVskdDlayFlg(JSPUtil.getParameter(request,"vskd_dlay_flg","N"));
	        ...
	        event.getBkgUsrDfltSetVO().setSmplSiFlg(JSPUtil.getParameter(request,"smpl_si_flg","N"));
