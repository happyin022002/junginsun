...
*@FileName : ESM_BKG_0592HTMLAction.java
...
public class ESM_BKG_0592HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0592HTMLAction 객체를 생성
	 */
	public ESM_BKG_0592HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0592Event event = new EsmBkg0592Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			log.debug(request.getParameter("ibflag"));
			event.setBkgDpcsUsrGrpVOS((BkgDpcsUsrGrpVO[])getVOs(request, BkgDpcsUsrGrpVO .class,""));
