...
*@FileName : ChinaManifestListDownloadDBDAOaddBlCntrRfListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOaddBlCntrRfListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOaddBlCntrRfListCSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOaddBlCntrRfListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_CHN_RF (" ).append("\n"); 
