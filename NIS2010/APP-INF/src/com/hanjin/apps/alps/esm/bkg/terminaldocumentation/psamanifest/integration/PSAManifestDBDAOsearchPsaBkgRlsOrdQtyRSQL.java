...
*@FileName : PSAManifestDBDAOsearchPsaBkgRlsOrdQtyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOsearchPsaBkgRlsOrdQtyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSA BKG Release Order에서 CNTR Qty값을 구한다.
	  * </pre>
	  */
	public PSAManifestDBDAOsearchPsaBkgRlsOrdQtyRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOsearchPsaBkgRlsOrdQtyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
