...
*@FileName : IHCGuideLineDBDAORemoveIHCGuidelineDetailAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAORemoveIHCGuidelineDetailAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Remove IHC Guideline Detail All
	  * </pre>
	  */
	public IHCGuideLineDBDAORemoveIHCGuidelineDetailAllDSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAORemoveIHCGuidelineDetailAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
