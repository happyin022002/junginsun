...
public class OfficeMappingDBDAOUpdateAddSectorOfcRelSetPolPodFlgUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Sector Office Relation Setting POL POD Pair Add for IAS Sector 추가 생성시 SQM_SCTR_PAIR_MGMT/SQM_ACT_FLG를 Y로 업데이트 한다.
	  * </pre>
	  */
	...
	public void setQuery(){
		query.append("UPDATE SQM_SCTR_PAIR_MGMT" ).append("\n"); 
		query.append("SET SQM_ACT_FLG  = 'Y'" ).append("\n"); 
