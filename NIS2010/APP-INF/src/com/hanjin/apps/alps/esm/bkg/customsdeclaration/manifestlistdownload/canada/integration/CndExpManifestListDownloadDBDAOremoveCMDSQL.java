...
*@FileName : CndExpManifestListDownloadDBDAOremoveCMDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOremoveCMDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOremoveCMDSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOremoveCMDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_AMER_CNTR_MF" ).append("\n"); 
