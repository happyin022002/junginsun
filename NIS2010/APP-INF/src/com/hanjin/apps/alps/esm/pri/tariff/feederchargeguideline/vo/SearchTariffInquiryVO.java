...
*@FileName : SearchTariffInquiryVO.java
*@FileTitle : SearchTariffInquiryVO
*Open Issues :
*Change history :
...
public class SearchTariffInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchTariffInquiryVO> models = new ArrayList<SearchTariffInquiryVO>();
	...
	public SearchTariffInquiryVO() {}

	public SearchTariffInquiryVO(String ibflag, String pagerows, String svcTpCd, String rhqCd, String svcScpCd, String pntLocCd, String cntCd, String orgDestTpCd, String accDt, String bsePortLocCd, String ihcCgoTpCd) {
...
/**
	 ...
	 */
	public SearchTariffInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTariffInquiryVO[]
	 */
	public SearchTariffInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchTariffInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchTariffInquiryVO();
				if (svcTpCd[i] != null)
		...
		return getSearchTariffInquiryVOs();
	}
	 ...
	 * @return SearchTariffInquiryVO[]
	 */
	public SearchTariffInquiryVO[] getSearchTariffInquiryVOs(){
		SearchTariffInquiryVO[] vos = (SearchTariffInquiryVO[])models.toArray(new SearchTariffInquiryVO[models.size()]);
		return vos;
	}
