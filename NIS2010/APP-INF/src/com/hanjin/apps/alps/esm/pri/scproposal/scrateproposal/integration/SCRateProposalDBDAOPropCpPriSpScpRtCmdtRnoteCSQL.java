...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtCmdtRnoteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtCmdtRnoteCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_RT_CMDT_RNOTE Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtCmdtRnoteCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtCmdtRnoteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , S.NOTE_CHG_TP_CD" ).append("\n"); 
