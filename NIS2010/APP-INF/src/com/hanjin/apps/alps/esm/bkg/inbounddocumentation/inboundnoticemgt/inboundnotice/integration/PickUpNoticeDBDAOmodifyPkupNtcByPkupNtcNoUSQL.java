...
*@FileName : PickUpNoticeDBDAOmodifyPkupNtcByPkupNtcNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PickUpNoticeDBDAOmodifyPkupNtcByPkupNtcNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PickUpNoticeDBDAOmodifyPkupNtcByPkupNtcNoUSQL(){
		setQuery();
		...
		query.append("FileName : PickUpNoticeDBDAOmodifyPkupNtcByPkupNtcNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_PKUP_NTC X" ).append("\n"); 
		...
		query.append("WHERE  PKUP_NTC_SND_STS_CD = 'N'" ).append("\n"); 
