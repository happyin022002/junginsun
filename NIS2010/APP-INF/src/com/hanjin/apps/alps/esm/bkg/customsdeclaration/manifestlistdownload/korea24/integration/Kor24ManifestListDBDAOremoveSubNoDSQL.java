...
*@FileName : Kor24ManifestListDBDAOremoveSubNoDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOremoveSubNoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOremoveSubNoDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOremoveSubNoDSQL").append("\n");
		query.append("*/").append("\n");
	}
