...
*@FileName : RsltPriSqRtCmdtVO.java
*@FileTitle : RsltPriSqRtCmdtVO
*Open Issues :
*Change history :
...
public class RsltPriSqRtCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqRtCmdtVO> models = new ArrayList<RsltPriSqRtCmdtVO>();
	...
	public RsltPriSqRtCmdtVO() {}

	public RsltPriSqRtCmdtVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String genSpclRtTpCd, String cmdtHdrSeq, String cmdtSeq, String prcCmdtTpCd, String prcCmdtDefCd, String prcCmdtDefNm, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriSqRtCmdtVO[]
	 */
	public RsltPriSqRtCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqRtCmdtVO[]
	 */
	public RsltPriSqRtCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqRtCmdtVO model = null;
	...
	public RsltPriSqRtCmdtVO[] getRsltPriSqRtCmdtVOs(){
		RsltPriSqRtCmdtVO[] vos = (RsltPriSqRtCmdtVO[])models.toArray(new RsltPriSqRtCmdtVO[models.size()]);
		return vos;
	}
