...
*@FileName : RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_GRP_LOC Insert
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPropCpPriRpScpGrpLocCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY A.PROP_NO,A.AMDT_SEQ,A.SVC_SCP_CD,A.GRP_LOC_SEQ," ).append("\n"); 
		query.append("B.GRP_LOC_DTL_SEQ) AS SEQ" ).append("\n"); 
