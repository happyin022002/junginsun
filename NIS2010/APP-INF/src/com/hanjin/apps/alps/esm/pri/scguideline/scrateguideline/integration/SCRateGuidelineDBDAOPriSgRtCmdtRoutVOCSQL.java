...
*@FileName : SCRateGuidelineDBDAOPriSgRtCmdtRoutVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtCmdtRoutVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtCmdtRoutVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtCmdtRoutVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	@[cmdt_hdr_seq]," ).append("\n"); 
		query.append("	@[rout_seq]," ).append("\n"); 
		query.append("	decode(@[dir_call_flg], '0', 'N', '1', 'Y', @[dir_call_flg])," ).append("\n"); 
		query.append("	@[cre_usr_id]," ).append("\n"); 
