...
*@FileName : SCRateProposalDBDAOPropCpPriSpScpRtActCustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPropCpPriSpScpRtActCustCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPropCpPriSpScpRtActCustCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPropCpPriSpScpRtActCustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    AND   A.GEN_SPCL_RT_TP_CD = DECODE ( @[srate_chk], '1', 'S', '' )" ).append("\n"); 
		...
		query.append("                          ORDER BY B.PROP_NO, B.AMDT_SEQ, B.SVC_SCP_CD, B.GEN_SPCL_RT_TP_CD, B.CMDT_HDR_SEQ, B.ACT_CUST_SEQ) AS ACT_CUST_SEQ" ).append("\n"); 
		...
		query.append("    ,PRI_SP_SCP_RT_ACT_CUST B" ).append("\n"); 
		query.append("WHERE B.PROP_NO = A.PROP_NO" ).append("\n"); 
		query.append("AND   B.AMDT_SEQ = A.AMDT_SEQ" ).append("\n"); 
		query.append("AND   B.SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   B.GEN_SPCL_RT_TP_CD = A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
