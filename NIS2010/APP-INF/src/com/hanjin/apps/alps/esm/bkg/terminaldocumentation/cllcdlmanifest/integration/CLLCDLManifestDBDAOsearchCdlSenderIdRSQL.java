...
*@FileName : CLLCDLManifestDBDAOsearchCdlSenderIdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CLLCDLManifestDBDAOsearchCdlSenderIdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLLCDLManifestDBDAOsearchCdlSenderIdRSQL(){
		setQuery();
		...
		query.append("FileName : CLLCDLManifestDBDAOsearchCdlSenderIdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     AND EDI_MSG_IND_CD = '8'" ).append("\n"); 
