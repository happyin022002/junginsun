...
*@FileName : SearchMissingStatusListVO.java
*@FileTitle : SearchMissingStatusListVO
*Open Issues :
*Change history :
...
public class SearchMissingStatusListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMissingStatusListVO> models = new ArrayList<SearchMissingStatusListVO>();
	...
	public SearchMissingStatusListVO() {}

	public SearchMissingStatusListVO(String ibflag, String pagerows, String costYrwk, String stndCostCd, String stndCostNm, String trdCd, String rlaneCd, String iocCd, String vvdCd, String creDt, String costCalcRmk) {
		this.iocCd = iocCd;
		this.ibflag = ibflag;
		this.vvdCd = vvdCd;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return SearchMissingStatusListVO[]
	 */
	public SearchMissingStatusListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMissingStatusListVO[]
	 */
	public SearchMissingStatusListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMissingStatusListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMissingStatusListVO();
				if (iocCd[i] != null)
		...
		return getSearchMissingStatusListVOs();
	}
	 ...
	 * @return SearchMissingStatusListVO[]
	 */
	public SearchMissingStatusListVO[] getSearchMissingStatusListVOs(){
		SearchMissingStatusListVO[] vos = (SearchMissingStatusListVO[])models.toArray(new SearchMissingStatusListVO[models.size()]);
		return vos;
	}
