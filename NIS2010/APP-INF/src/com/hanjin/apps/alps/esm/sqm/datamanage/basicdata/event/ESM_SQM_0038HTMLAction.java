...
*@FileName       : ESM_SQM_0038HTMLAction.java
 ...
 * @author SQM USER
 * @see EsmSqm0038Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0038HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0038HTMLAction 객체를 생성
	 */
	public ESM_SQM_0038HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0038Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSqm0038Event event = new EsmSqm0038Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setSqmQtaLaneMgmtVOS((SqmQtaLaneMgmtVO[])getVOs(request, SqmQtaLaneMgmtVO .class,""));
		}
