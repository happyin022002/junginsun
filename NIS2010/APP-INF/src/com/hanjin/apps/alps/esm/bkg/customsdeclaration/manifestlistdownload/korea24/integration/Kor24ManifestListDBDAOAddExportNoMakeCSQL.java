...
*@FileName : Kor24ManifestListDBDAOAddExportNoMakeCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOAddExportNoMakeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOAddExportNoMakeCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOAddExportNoMakeCSQL").append("\n");
		query.append("*/").append("\n");
	}
