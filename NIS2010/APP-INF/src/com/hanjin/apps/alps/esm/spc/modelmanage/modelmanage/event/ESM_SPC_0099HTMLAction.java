...
*@FileName : ESM_SPC_0099HTMLAction.java
...
public class ESM_SPC_0099HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0030HTMLAction 객체를 생성
	 */
	public ESM_SPC_0099HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EsmSpc0099Event event = new EsmSpc0099Event();
