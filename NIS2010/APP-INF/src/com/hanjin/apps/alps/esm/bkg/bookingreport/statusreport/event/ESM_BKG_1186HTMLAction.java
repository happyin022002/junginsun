...
public class ESM_BKG_1186HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_1186HTMLAction 객체를 생성
     */
    public ESM_BKG_1186HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmBkg1186Event 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1186Event event = new EsmBkg1186Event(); 

		if ( command.isCommand(FormCommand.SEARCH) ){
			event.setInfoVO((VgmStatusReportVO) getVO(request, VgmStatusReportVO.class));
		}
