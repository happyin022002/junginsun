...
public class KorVslInfoNManifestCondVO extends VslInfoNManifestCondVO {
	...
	public KorVslInfoNManifestCondVO(String ibflag, String pagerows, String vvd, String polCd, String podCd, String tmlCd, String inType, String blNo, String ioBndCd, String receiver, String userId) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.inType = inType;
		this.polCd = polCd;
