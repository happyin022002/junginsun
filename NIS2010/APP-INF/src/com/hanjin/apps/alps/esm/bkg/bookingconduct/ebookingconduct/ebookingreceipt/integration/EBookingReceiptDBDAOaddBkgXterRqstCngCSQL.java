...
*@FileName : EBookingReceiptDBDAOaddBkgXterRqstCngCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterRqstCngCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterRqstCngCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_RQST_CNG" ).append("\n");
		query.append("(" ).append("\n");
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterRqstCngCSQL").append("\n");
		query.append("*/").append("\n");
	}
}