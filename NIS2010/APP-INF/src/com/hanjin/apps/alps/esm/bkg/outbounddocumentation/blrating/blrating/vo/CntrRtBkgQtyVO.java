...
*@FileName : CntrRtBkgQtyVO.java
*@FileTitle : CntrRtBkgQtyVO
*Open Issues :
*Change history :
...
public class CntrRtBkgQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrRtBkgQtyVO> models = new ArrayList<CntrRtBkgQtyVO>();
	...
	public CntrRtBkgQtyVO() {}

	public CntrRtBkgQtyVO(String ibflag, String pagerows, String bkgNo, String cntrTpszCd, String opCntrQty, String eqSubstCntrTpszCd, String eqSubstCgoQty) {
	 ...
	 * @param request
	 * @return CntrRtBkgQtyVO[]
	 */
	public CntrRtBkgQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrRtBkgQtyVO[]
	 */
	public CntrRtBkgQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrRtBkgQtyVO model = null;
	 ...
	 * @return CntrRtBkgQtyVO[]
	 */
	public CntrRtBkgQtyVO[] getCntrRtBkgQtyVOs(){
		CntrRtBkgQtyVO[] vos = (CntrRtBkgQtyVO[])models.toArray(new CntrRtBkgQtyVO[models.size()]);
		return vos;
	}
