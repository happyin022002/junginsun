...
*@FileName : ESM_PRI_4017HTMLAction.java
...
public class ESM_PRI_4017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_4017HTMLAction 객체를 생성
	 */
	public ESM_PRI_4017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri4017Event event = new EsmPri4017Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setCstSvcScpVO((CstSvcScpVO)getVO(request, CstSvcScpVO .class));
