...
public class KorCustomsTransmissionDBDAOmakeCUSDMRFlatFileRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        DECODE(@[old_disc],null,'02','01')  ||'~'|| /* 전송모드 1:정정, 2:추가 */" ).append("\n"); 
		...
		query.append("        SUBSTR(@[usr_name],36,35)         ||'~'|| /*  정정 신청자 성명    */" ).append("\n"); 
		query.append("        SUBSTR(@[usr_name],71,35)                 /*  정정 신청자 성명    */" ).append("\n"); 
