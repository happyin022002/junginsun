 ...
 * @since J2EE 1.4
 */
public class ComboBoxRgnOfcTag extends ComboBoxTag {
	private static transient org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ComboBoxRgnOfcTag.class);
	String rhq = "";
	...
	protected String[][] getOptionList() throws EventException {
		...
		String[][] datas = null;
		try {
			response = (ComboxEventResponse) sc.searchRgnOfcComboList(getModule(), rhq, getDel());
