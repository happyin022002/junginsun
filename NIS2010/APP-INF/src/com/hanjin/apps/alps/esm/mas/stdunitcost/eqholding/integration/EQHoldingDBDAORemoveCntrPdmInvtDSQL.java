...
*@FileName : EQHoldingDBDAORemoveCntrPdmInvtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQHoldingDBDAORemoveCntrPdmInvtDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Container PDM by Inventory Delete 로직
	  * </pre>
	  */
	public EQHoldingDBDAORemoveCntrPdmInvtDSQL(){
		setQuery();
		...
		query.append("FileName : EQHoldingDBDAORemoveCntrPdmInvtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MAS_CNTR_EQ_COST" ).append("\n"); 
