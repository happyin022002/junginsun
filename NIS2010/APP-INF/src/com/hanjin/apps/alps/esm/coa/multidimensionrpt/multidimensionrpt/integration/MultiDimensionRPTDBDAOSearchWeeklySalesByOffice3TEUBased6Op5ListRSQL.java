...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op5ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op5ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op5ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased6Op5ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		#if(${f_ofc_cd} !='')" ).append("\n"); 
		query.append("			#if(${f_excl_sts} =='')" ).append("\n"); 
		query.append("				/*N200902110080   COA_SINWA 실적 조회 권한 관련 DECODE(SUBSTR(?, 1, 4), 'SHAR', 'SINWA', '')*/" ).append("\n"); 
		query.append("				AND DECODE (@[f_ofc_lvl] ,'1', B4.OFC_N1ST_LVL_CD,'2', B4.OFC_N2ND_LVL_CD,'3', B4.OFC_N3RD_LVL_CD,'4', B4.OFC_N4TH_LVL_CD,'5', B4.OFC_N5TH_LVL_CD,'6', B4.OFC_N6TH_LVL_CD,'7', B4.OFC_N7TH_LVL_CD) = @[f_ofc_cd] " ).append("\n"); 
		query.append("			#else" ).append("\n"); 
		query.append("				AND B4.OFC_CD  = @[f_ofc_cd]  " ).append("\n"); 
		query.append("			#end" ).append("\n"); 
