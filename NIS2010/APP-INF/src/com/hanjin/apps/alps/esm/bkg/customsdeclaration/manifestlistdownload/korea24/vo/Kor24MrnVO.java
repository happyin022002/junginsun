...
*@FileName : Kor24MrnVO.java
*@FileTitle : Kor24MrnVO
*Open Issues :
*Change history :
...
public class Kor24MrnVO extends ManifestListCondVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24MrnVO> models = new ArrayList<Kor24MrnVO>();
	...
	public Kor24MrnVO(String ibflag, String pagerows, String mrnNo, String mrnChkNo, String vvdSeq, String etaEtd, String etdDt) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return Kor24MrnVO[]
	 */
	public Kor24MrnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24MrnVO[]
	 */
	public Kor24MrnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24MrnVO model = null;
	 ...
	 * @return Kor24MrnVO[]
	 */
	public Kor24MrnVO[] getKor24MrnVOs(){
		Kor24MrnVO[] vos = (Kor24MrnVO[])models.toArray(new Kor24MrnVO[models.size()]);
		return vos;
	}
