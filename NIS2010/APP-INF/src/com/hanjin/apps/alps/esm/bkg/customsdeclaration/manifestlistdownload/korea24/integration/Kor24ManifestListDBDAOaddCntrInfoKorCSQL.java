...
*@FileName : Kor24ManifestListDBDAOaddCntrInfoKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOaddCntrInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOaddCntrInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOaddCntrInfoKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_ADV_KR_CNTR " ).append("\n");
