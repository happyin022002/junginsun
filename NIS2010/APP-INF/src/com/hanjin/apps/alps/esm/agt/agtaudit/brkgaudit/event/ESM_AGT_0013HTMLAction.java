...
*@FileName : ESM_AGT_013HTMLAction.java
 ...
 * @see EsmAgt0013Event , ESM_AGT_013EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_AGT_0013HTMLAction extends HTMLActionSupport {


	private static final long serialVersionUID = 1L;
	/**
	 * ESMAGT0013HTMLAction 객체를 생성
	 */
	public ESM_AGT_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0013Event event = new EsmAgt0013Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBrkgCommVO((BrkgCommVO)getVO(request, BrkgCommVO .class));
		}
		
		if(command.isCommand(FormCommand.MULTI)){
			event.setBrkgCommVOS((BrkgCommVO[])getVOs(request, BrkgCommVO .class, ""));
			event.setBrkgCommVO((BrkgCommVO)getVO(request, BrkgCommVO .class));
		}
