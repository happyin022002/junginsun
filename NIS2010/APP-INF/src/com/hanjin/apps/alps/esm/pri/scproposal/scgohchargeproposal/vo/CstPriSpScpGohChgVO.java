...
*@FileName : CstPriSpScpGohChgVO.java
*@FileTitle : CstPriSpScpGohChgVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.pri.scproposal.scgohchargeproposal.vo;
...
public class CstPriSpScpGohChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriSpScpGohChgVO> models = new ArrayList<CstPriSpScpGohChgVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPrcHngrBarTpSeq(JSPUtil.getParameter(request, "prc_hngr_bar_tp_seq", ""));
	 ...
	 */
	public CstPriSpScpGohChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriSpScpGohChgVO[]
	 */
	public CstPriSpScpGohChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriSpScpGohChgVO model = null;
		...
		return getCstPriSpScpGohChgVOs();
	}
	 ...
	 * @return CstPriSpScpGohChgVO[]
	 */
	public CstPriSpScpGohChgVO[] getCstPriSpScpGohChgVOs(){
		CstPriSpScpGohChgVO[] vos = (CstPriSpScpGohChgVO[])models.toArray(new CstPriSpScpGohChgVO[models.size()]);
		return vos;
	}
