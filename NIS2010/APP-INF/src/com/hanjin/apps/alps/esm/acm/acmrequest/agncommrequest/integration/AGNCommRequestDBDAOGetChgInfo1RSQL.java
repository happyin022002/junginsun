...
*@FileName : AGNCommRequestDBDAOGetChgInfo1RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOGetChgInfo1RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommRequestDBDAOGetChgInfo1RSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOGetChgInfo1RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       AND B.CHG_CD IN ('INF', 'DRF', 'ATS', 'DHS', 'BLS', 'TDS', 'DCA', 'BCU', 'AHC', 'MSS', 'CPS', 'ACP', 'CIS', 'WHS', 'SIS', 'FMS', 'IVA', 'TRC', 'DIH', 'DAR', 'WJC', 'RTS', 'OAR', 'OIH', 'PSU', 'ATC', 'FFT', 'REF', 'CTS', 'VMI', 'TMS', 'RFC', 'CDP', 'PPE', 'CER', 'PSM', 'WWT', 'MDA') " ).append("\n"); 
		query.append("     --AND B.REP_CHG_CD = 'TAC' -- [CHM-201325569] REP_CHG_CD 변경에 따라서 하드코딩 계산 로직 변경 (TMO)" ).append("\n"); 
		query.append("        )" ).append("\n"); 
