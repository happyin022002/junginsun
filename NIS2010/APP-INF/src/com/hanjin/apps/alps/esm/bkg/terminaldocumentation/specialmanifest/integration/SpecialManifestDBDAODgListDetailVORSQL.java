...
*@FileName : SpecialManifestDBDAODgListDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAODgListDetailVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DgListDetailVO 생성을 위해 사용
	  * </pre>
	  */
	public SpecialManifestDBDAODgListDetailVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.terminaldocumentation.specialmanifest.integration").append("\n"); 
		query.append("FileName : SpecialManifestDBDAODgListDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     ''CRNT_CELL_PSN_NO_CNT -- Bay Plan 사용 여부" ).append("\n"); 
		query.append("     " ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append("    ,''ACK_RCV_STS_CD   -- edi 전송 결과" ).append("\n"); 
		query.append("     " ).append("\n"); 
		query.append("    ,''LOCAL_DB_YN      -- local db data인지 booking data인지" ).append("\n"); 
		query.append("    " ).append("\n"); 
		...
		query.append("    ,''IN_IMDG_PCK_QTY1                   -- Inner Qty" ).append("\n"); 
		query.append("    ,''IN_IMDG_PCK_CD1                    -- Inner Code" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	,''IMDG_COMP_GRP_CD					-- Compati-bility" ).append("\n"); 
		query.append("" ).append("\n"); 
