...
public class SearchSpaceAllocationManage045QtyListVO extends AbstractValueObject {
	...
	public SearchSpaceAllocationManage045QtyListVO(String ibflag, String pagerows, String iocCd, String onTtl, String lodTtl, String portSeq, String flg, String bsa, String disTtl, String portCd, String src, String past, String onHcTtl) {
		this.iocCd = iocCd;
		this.lodTtl = lodTtl;
		this.flg = flg;
		this.past = past;
