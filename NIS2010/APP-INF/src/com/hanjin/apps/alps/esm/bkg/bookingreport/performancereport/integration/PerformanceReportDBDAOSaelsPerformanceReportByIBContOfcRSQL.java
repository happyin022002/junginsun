...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportByIBContOfcRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportByIBContOfcRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportByIBContOfcRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportByIBContOfcRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(SALE.TTL,0,0,ROUND(SALE.GROSS / SALE.TTL,2)) AS EQ_RPB" ).append("\n"); 
		query.append("      ,(SELECT SUBSTR(LOC_CD,0,2) FROM MDM_ORGANIZATION WHERE OFC_CD = SALE.SLS_RGN_OFC_CD) RGN_CNT            " ).append("\n"); 
		query.append("      ,(SELECT SUBSTR(LOC_CD,0,2) FROM MDM_ORGANIZATION WHERE OFC_CD = SALE.EQ_CTRL_OFC_CD) OFC_CNT" ).append("\n"); 
		...
		query.append("      ,BKG.SLS_RHQ_CD" ).append("\n"); 
		query.append("      ,BKG.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("      ,BKG.EQ_CTRL_OFC_CD" ).append("\n"); 
		...
		query.append("      ,SUM(D2)                  D2" ).append("\n"); 
		query.append("      ,SUM(D4)                  D4" ).append("\n"); 
		query.append("      ,SUM(D5)                  D5" ).append("\n"); 
		query.append("      ,SUM(R2)                  R2" ).append("\n"); 
		query.append("      ,SUM(R4)                  R4" ).append("\n"); 
		query.append("      ,SUM(S2)                  S2" ).append("\n"); 
		query.append("      ,SUM(S4)                  S4" ).append("\n"); 
		query.append("      ,SUM(RD2)                 RD2" ).append("\n"); 
		query.append("      ,SUM(RD4)                 RD4" ).append("\n"); 
		...
		query.append("              ,BKG.SLS_RHQ_CD" ).append("\n"); 
		query.append("              ,BKG.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("              ,(SELECT EQ_CTRL_OFC_CD FROM MDM_LOCATION WHERE LOC_CD = BKG.POD_CD) EQ_CTRL_OFC_CD" ).append("\n"); 
		...
		query.append("         WHERE BKG.BKG_STS_CD  NOT IN ('S','X')" ).append("\n"); 
		...
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD IN ('D2','C2') THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IN ('D2','C2') THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) D2" ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD IN ('D4','C4') THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD  IN ('D4','C4')  THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) D4" ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'D5' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'D5' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) D5           " ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'R2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'R2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) R2          " ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'R4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'R4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) R4" ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'S2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'S2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) S2" ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD IS NULL THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.CNTR_TPSZ_CD = 'S4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'S4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          END),2) S4                                            " ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.CNTR_TPSZ_CD = 'D2' THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'R2' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END" ).append("\n"); 
		query.append("                          ELSE 0 " ).append("\n"); 
		query.append("                          END),2) RD2" ).append("\n"); 
		query.append("               ,ROUND(SUM(CASE WHEN QUA.CNTR_TPSZ_CD = 'D4' THEN" ).append("\n"); 
		query.append("                               CASE WHEN QUA.EQ_SUBST_CNTR_TPSZ_CD = 'R4' THEN NVL(CHG.CHG_AMT,0) / NVL(XCH.USD_LOCL_XCH_RT,1)" ).append("\n"); 
		query.append("                                    ELSE 0" ).append("\n"); 
		query.append("                               END " ).append("\n"); 
		query.append("                          ELSE 0" ).append("\n"); 
		query.append("                          END),2) RD4" ).append("\n"); 
		query.append("           FROM BKG_BOOKING     BKG " ).append("\n"); 
		query.append("               ,BKG_QUANTITY    QUA" ).append("\n"); 
