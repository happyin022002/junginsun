...
*@FileName : QtaInquiryDBDAOSearchQuarterlyCurrnetQtaListPreviousVersionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaInquiryDBDAOSearchQuarterlyCurrnetQtaListPreviousVersionRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * QtaInquiryDBDAOSearchQuarterlyCurrnetQtaListPreviousVersion
	  * </pre>
	  */
	public QtaInquiryDBDAOSearchQuarterlyCurrnetQtaListPreviousVersionRSQL(){
		setQuery();
		...
		query.append("FileName : QtaInquiryDBDAOSearchQuarterlyCurrnetQtaListPreviousVersionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                ,SUBSTR(BSE_QTR_CD,1,1)||'Q' BSE_QTR_CD" ).append("\n"); 
		...
		query.append("                ,NVL(SLS_YRMON, '20'||SUBSTR(BSE_YR,-2)||BSE_MON) AS SLS_YRMON" ).append("\n"); 
		query.append("				,BSE_MON" ).append("\n"); 
		query.append("                ,BSE_WK" ).append("\n"); 
		...
		query.append("              AND BSE_YR          = 'OQ'||SUBSTR(@[f_bse_yr],-2)" ).append("\n"); 
