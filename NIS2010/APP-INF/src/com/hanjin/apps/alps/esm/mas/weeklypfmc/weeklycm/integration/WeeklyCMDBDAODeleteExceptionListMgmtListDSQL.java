...
*@FileName : WeeklyCMDBDAODeleteExceptionListMgmtListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAODeleteExceptionListMgmtListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Exception List Unit 삭제
	  * </pre>
	  */
	public WeeklyCMDBDAODeleteExceptionListMgmtListDSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAODeleteExceptionListMgmtListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MAS_CHSS_EXPT_LIST" ).append("\n"); 
