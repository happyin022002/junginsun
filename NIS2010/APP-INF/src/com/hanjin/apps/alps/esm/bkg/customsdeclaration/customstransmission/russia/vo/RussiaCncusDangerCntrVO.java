...
*@FileName : RussiaCncusDangerCntrVO.java
*@FileTitle : RussiaCncusDangerCntrVO
*Open Issues :
*Change history :
...
public class RussiaCncusDangerCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RussiaCncusDangerCntrVO> models = new ArrayList<RussiaCncusDangerCntrVO>();
	...
	public RussiaCncusDangerCntrVO() {}

	public RussiaCncusDangerCntrVO(String ibflag, String pagerows, String flashPoint, String page, String contactName, String undgno, String label, String contactTel, String clss, String emsNo) {
...
/**
	 ...
	 * @param request
	 * @return RussiaCncusDangerCntrVO[]
	 */
	public RussiaCncusDangerCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RussiaCncusDangerCntrVO[]
	 */
	public RussiaCncusDangerCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RussiaCncusDangerCntrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RussiaCncusDangerCntrVO();
		...
		return getRussiaCncusDangerCntrVOs();
	}
	 ...
	 * @return RussiaCncusDangerCntrVO[]
	 */
	public RussiaCncusDangerCntrVO[] getRussiaCncusDangerCntrVOs(){
		RussiaCncusDangerCntrVO[] vos = (RussiaCncusDangerCntrVO[])models.toArray(new RussiaCncusDangerCntrVO[models.size()]);
		return vos;
	}
