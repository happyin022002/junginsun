...
*@FileName : Kor24ManifestListDBDAOSearchMaxSeqDownHistRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchMaxSeqDownHistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchMaxSeqDownHistRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchMaxSeqDownHistRSQL").append("\n");
		query.append("*/").append("\n");
	}
}