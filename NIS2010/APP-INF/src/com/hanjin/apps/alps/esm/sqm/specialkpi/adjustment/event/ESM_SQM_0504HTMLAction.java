...
*@FileName       : ESM_SQM_0504HTMLAction.java
 ...
 * @author 이혜민
 * @see EsmSqm0504Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0504HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0504HTMLAction 객체를 생성
	 */
	public ESM_SQM_0504HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0504Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSqm0504Event event = new EsmSqm0504Event();
    	if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
			event.setSqmSpclCfmQtaVOS((SqmSpclCfmQtaVO[])getVOs(request, SqmSpclCfmQtaVO .class,""));
