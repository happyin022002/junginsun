...
*@FileName : RsltPriCmpbGlineServiceLaneVO.java
*@FileTitle : RsltPriCmpbGlineServiceLaneVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGlineServiceLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGlineServiceLaneVO> models = new ArrayList<RsltPriCmpbGlineServiceLaneVO>();
	...
	public RsltPriCmpbGlineServiceLaneVO() {}

	public RsltPriCmpbGlineServiceLaneVO(String ibflag, String pagerows, String vslSlanCd, String vslSlanNm, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq) {
		this.bseSeq = bseSeq;
	 ...
	 * @param request
	 * @return RsltPriCmpbGlineServiceLaneVO[]
	 */
	public RsltPriCmpbGlineServiceLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGlineServiceLaneVO[]
	 */
	public RsltPriCmpbGlineServiceLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGlineServiceLaneVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGlineServiceLaneVO();
				if (bseSeq[i] != null)
		...
		return getRsltPriCmpbGlineServiceLaneVOs();
	}
	 ...
	 * @return RsltPriCmpbGlineServiceLaneVO[]
	 */
	public RsltPriCmpbGlineServiceLaneVO[] getRsltPriCmpbGlineServiceLaneVOs(){
		RsltPriCmpbGlineServiceLaneVO[] vos = (RsltPriCmpbGlineServiceLaneVO[])models.toArray(new RsltPriCmpbGlineServiceLaneVO[models.size()]);
		return vos;
	}
