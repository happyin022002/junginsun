...
*@FileName : BLDocumentationBLDBDAOmodifyManifestUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationBLDBDAOmodifyManifestUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLDocumentationBLDBDAOmodifyManifestUSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationBLDBDAOmodifyManifestUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET	ID_DECL_CD = @[id_decl_cd]," ).append("\n"); 
