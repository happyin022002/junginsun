...
*@FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVODSQL.java
...
public class MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVODSQL(){
		setQuery();
		...
		query.append("FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
