...
*@FileName : Kor24ManifestListDBDAOModifyBizNoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOModifyBizNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOModifyBizNoUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOModifyBizNoUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("   SET BIZ_RGST_NO = @[biz_no]" ).append("\n");
		query.append(" WHERE BKG_NO = @[bkg_no]" ).append("\n");
		query.append("   AND CSTMS_DECL_TP_CD = DECODE(@[expt_kcd_tp],'R','R','T','T',@[kcd_tp])" ).append("\n");
