...
*@FileName : IHCGuideLineDBDAOmodifyIHCGuidelineConfirmBefTrfUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOmodifyIHCGuidelineConfirmBefTrfUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * update pre version IHC_TRF_NO's exp_dt
	  * </pre>
	  */
	public IHCGuideLineDBDAOmodifyIHCGuidelineConfirmBefTrfUSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOmodifyIHCGuidelineConfirmBefTrfUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
