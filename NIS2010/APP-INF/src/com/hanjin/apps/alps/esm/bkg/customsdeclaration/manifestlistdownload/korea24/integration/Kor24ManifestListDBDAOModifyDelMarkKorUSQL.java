...
*@FileName : Kor24ManifestListDBDAOModifyDelMarkKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOModifyDelMarkKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOModifyDelMarkKorUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOModifyDelMarkKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
