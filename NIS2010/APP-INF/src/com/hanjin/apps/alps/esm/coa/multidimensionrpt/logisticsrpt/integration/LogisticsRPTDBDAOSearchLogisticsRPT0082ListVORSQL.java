...
public class LogisticsRPTDBDAOSearchLogisticsRPT0082ListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2014.07.09 PEJ [CHM-201431087] [COA] Multi-Dimension Report > Logistics PFMC > Expense 화면 조회로직 변경요청
	...
	public void setQuery(){
		...
		query.append("      ,CASE WHEN KPI_CD = 'RAIL' AND RHQ_CD IN ('SELSC','TYOSC') THEN 'Trxoouck'" ).append("\n"); 
