...
public class WeeklyCMDBDAOSearchOPCreditRtPortPairRSQL2 implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOSearchOPCreditRtPortPairRSQL2(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("   FROM MAS_CNTR_REPO_SPLS_DEL_RTO A" ).append("\n"); 
