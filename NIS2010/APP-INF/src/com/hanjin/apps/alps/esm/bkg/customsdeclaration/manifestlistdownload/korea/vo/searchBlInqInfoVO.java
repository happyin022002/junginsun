...
*@FileName : searchBlInqInfoVO.java
*@FileTitle : searchBlInqInfoVO
*Open Issues :
*Change history :
...
public class searchBlInqInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchBlInqInfoVO> models = new ArrayList<searchBlInqInfoVO>();
	 ...
	 * @param request
	 * @return searchBlInqInfoVO[]
	 */
	public searchBlInqInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchBlInqInfoVO[]
	 */
	public searchBlInqInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchBlInqInfoVO model = null;
	 ...
	 * @return searchBlInqInfoVO[]
	 */
	public searchBlInqInfoVO[] getsearchBlInqInfoVOs(){
		searchBlInqInfoVO[] vos = (searchBlInqInfoVO[])models.toArray(new searchBlInqInfoVO[models.size()]);
		return vos;
	}
