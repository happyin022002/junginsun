...
*@FileName : ESM_MAS_0311HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Kim Ki Dae
 * @see EsmMas0311Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0311HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0311HTMLAction 객체를 생성
	 */
	public ESM_MAS_0311HTMLAction() {}//
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0311Event event = new EsmMas0311Event();  		
