...
*@FileName : PlanningDBDAOCreateQtaLoadRevForSectorFreezingCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOCreateQtaLoadRevForSectorFreezingCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [QTA Set up for IAS Sector by Head Office] 의 [확정데이터]를 생성한다.
	  * </pre>
	  */
	public PlanningDBDAOCreateQtaLoadRevForSectorFreezingCSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOCreateQtaLoadRevForSectorFreezingCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SUBSTR(@[f_bse_yr], 3, 2) || C1.BSE_QTR_CD || LPAD(C5.CPY_NO,2,'0') AS QTA_RLSE_VER_NO" ).append("\n"); 
		...
		query.append("      ,NVL((SELECT N3RD_PRNT_OFC_CD FROM SQM_ORGANIZATION_V WHERE OFC_CD = C1.RGN_OFC_CD),'') AS AQ_CD" ).append("\n"); 
		...
		query.append("      ,(SELECT CPY_NO FROM COM_CPY_NO WHERE CPY_NO BETWEEN 1 AND 2)  C5" ).append("\n"); 
		query.append(" WHERE 1=1" ).append("\n"); 
