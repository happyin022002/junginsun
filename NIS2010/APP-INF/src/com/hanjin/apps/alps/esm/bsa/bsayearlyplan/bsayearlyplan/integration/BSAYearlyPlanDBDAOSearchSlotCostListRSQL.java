...
*@FileName : BSAYearlyPlanDBDAOSearchSlotCostListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOSearchSlotCostListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOSearchSlotCostListRSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOSearchSlotCostListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    BSA_BUD_SLT_PRC     A " ).append("\n"); 
		query.append("   ,BSA_BUD_SLT_PRC_CRR B " ).append("\n"); 
		query.append("   ,(SELECT  " ).append("\n"); 
		...
		query.append("                FROM    BSA_BUD_JNT_OP_BZC      X " ).append("\n"); 
		query.append("                       ,BSA_BUD_JNT_OP_CRR_CAPA Y " ).append("\n"); 
		...
		query.append("                       ,X.HJS_BSA_BFR_SUB_CAPA " ).append("\n"); 
		query.append("                       ,Y.CRR_BSA_CAPA " ).append("\n"); 
		query.append("                FROM    BSA_BUD_SLT_CHTR_BZC      X " ).append("\n"); 
		query.append("                       ,BSA_BUD_SLT_CHTR_CRR_CAPA Y " ).append("\n"); 
		query.append("                WHERE   X.BSA_SEQ   = Y.BSA_SEQ " ).append("\n"); 
		query.append("                AND     X.RLANE_CD  = Y.RLANE_CD " ).append("\n"); 
		query.append("                AND     X.DIR_CD    = Y.DIR_CD " ).append("\n"); 
		query.append("                AND     X.TRD_CD    = Y.TRD_CD " ).append("\n"); 
