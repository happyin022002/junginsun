...
*@FileName : SCBoilerPlateGuidelineDBDAOSearchPriSgBlplMaxSeqRSQL.java
...
public class SCBoilerPlateGuidelineDBDAOSearchPriSgBlplMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOSearchPriSgBlplMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOSearchPriSgBlplMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("nvl(max(blpl_seq)+1),1) as blpl_seq" ).append("\n"); 
