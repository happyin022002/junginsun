...
public class ChinaManifestListDownloadDBDAOsearchVslInfoListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("VPS.SLAN_CD			SLAN_CD," ).append("\n"); 
		query.append("VPS.VPS_ETB_DT		ETB," ).append("\n"); 
		query.append("ROW_NUMBER() OVER(PARTITION BY VPS.VSL_CD,VPS.SKD_VOY_NO,VPS.SKD_DIR_CD,VPS.VPS_PORT_CD ORDER BY VPS.CLPT_SEQ DESC) RNUM" ).append("\n"); 
