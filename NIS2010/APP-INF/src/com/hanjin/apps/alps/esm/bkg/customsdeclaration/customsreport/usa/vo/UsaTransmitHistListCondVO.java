...
public class UsaTransmitHistListCondVO extends TransmitHistListCondVO {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("auto_gubun", getAutoGubun());		
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("auto_gubun", "autoGubun");		
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAutoGubun(JSPUtil.getParameter(request, "auto_gubun", ""));		
	...
	public UsaTransmitHistListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] autoGubun = (JSPUtil.getParameter(request, prefix	+ "auto_gubun", length));			
			...
			for (int i = 0; i < length; i++) {
				...
				if (autoGubun[i] != null)
					model.setAutoGubun(autoGubun[i]);				
				if (sndOfcCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.autoGubun = this.autoGubun .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
