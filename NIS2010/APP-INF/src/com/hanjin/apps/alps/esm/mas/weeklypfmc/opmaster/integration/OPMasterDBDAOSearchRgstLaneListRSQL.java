...
public class OPMasterDBDAOSearchRgstLaneListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	, (SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD03217' AND INTG_CD_VAL_CTNT = MAS_LANE_RGST.HUL_BND_CD) HUL_BND_CD" ).append("\n"); 
		query.append("    , (SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD03218' AND INTG_CD_VAL_CTNT = MAS_LANE_RGST.IAS_RGN_CD) IAS_RGN_CD" ).append("\n"); 
