...
*@FileName : ESM_BKG_0232HTMLAction.java
...
public class ESM_BKG_0232HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0232HTMLAction 객체를 생성
	 */
	public ESM_BKG_0232HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0232Event event = new EsmBkg0232Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgXterSrchSetVOS((BkgXterSrchSetVO[])getVOs(request, BkgXterSrchSetVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgXterSrchSetVO((BkgXterSrchSetVO)getVO(request, BkgXterSrchSetVO .class));
		}
