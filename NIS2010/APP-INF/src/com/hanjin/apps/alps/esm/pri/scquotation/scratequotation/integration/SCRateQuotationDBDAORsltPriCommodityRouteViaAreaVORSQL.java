...
*@FileName : SCRateQuotationDBDAORsltPriCommodityRouteViaAreaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriCommodityRouteViaAreaVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriCommodityRouteViaAreaVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriCommodityRouteViaAreaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_SQ_RT_ROUT_VIA MN" ).append("\n"); 
