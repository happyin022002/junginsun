...
*@FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOUSQL.java
...
public class MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOUSQL(){
		setQuery();
		...
		query.append("FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_MQC_RNG SET" ).append("\n"); 
