...
*@FileName : AGNCommAgreementDBDAORemoveAgentRateDetailRoutListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAORemoveAgentRateDetailRoutListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DeleteAgentRateDetail
	  * </pre>
	  */
	public AGNCommAgreementDBDAORemoveAgentRateDetailRoutListDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAORemoveAgentRateDetailRoutListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
