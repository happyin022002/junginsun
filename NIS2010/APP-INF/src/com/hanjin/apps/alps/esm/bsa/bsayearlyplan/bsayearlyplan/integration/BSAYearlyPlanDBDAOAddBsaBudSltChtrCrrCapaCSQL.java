...
*@FileName : BSAYearlyPlanDBDAOAddBsaBudSltChtrCrrCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOAddBsaBudSltChtrCrrCapaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOAddBsaBudSltChtrCrrCapaCSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOAddBsaBudSltChtrCrrCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BSA_BUD_SLT_CHTR_CRR_CAPA (" ).append("\n"); 
		...
		query.append("        @[upd_usr_id], " ).append("\n"); 
		query.append("        SYSDATE" ).append("\n"); 
		query.append(" FROM   BSA_BUD_SLT_CHTR_BZC  A," ).append("\n"); 
		query.append("       (" ).append("\n"); 
		query.append("        SELECT DISTINCT " ).append("\n"); 
		query.append("              BSA_OP_CD, " ).append("\n"); 
		query.append("              CRR_CD" ).append("\n"); 
		query.append("         FROM BSA_CRR_RGST" ).append("\n"); 
		query.append("         WHERE BSA_OP_CD         = @[bsa_op_cd]   /* SPACE CHARTERING */" ).append("\n"); 
