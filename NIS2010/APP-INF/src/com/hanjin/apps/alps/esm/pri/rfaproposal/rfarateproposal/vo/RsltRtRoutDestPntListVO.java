...
*@FileName : RsltRtRoutDestPntListVO.java
*@FileTitle : RsltRtRoutDestPntListVO
*Open Issues :
*Change history :
...
public class RsltRtRoutDestPntListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltRtRoutDestPntListVO> models = new ArrayList<RsltRtRoutDestPntListVO>();
...
/**
	 ...
	 * @param request
	 * @return RsltRtRoutDestPntListVO[]
	 */
	public RsltRtRoutDestPntListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltRtRoutDestPntListVO[]
	 */
	public RsltRtRoutDestPntListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRtRoutDestPntListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltRtRoutDestPntListVO();
				if (amdtSeq[i] != null)
		...
		return getRsltRtRoutDestPntListVOs();
	}
	 ...
	 * @return RsltRtRoutDestPntListVO[]
	 */
	public RsltRtRoutDestPntListVO[] getRsltRtRoutDestPntListVOs(){
		RsltRtRoutDestPntListVO[] vos = (RsltRtRoutDestPntListVO[])models.toArray(new RsltRtRoutDestPntListVO[models.size()]);
		return vos;
	}
