...
*@FileName : RsltPriCmpbGlineSvcLaneVO.java
*@FileTitle : RsltPriCmpbGlineSvcLaneVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGlineSvcLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGlineSvcLaneVO> models = new ArrayList<RsltPriCmpbGlineSvcLaneVO>();
	...
	public RsltPriCmpbGlineSvcLaneVO() {}

	public RsltPriCmpbGlineSvcLaneVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq, String vslSlanCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.bseSeq = bseSeq;
	 ...
	 * @param request
	 * @return RsltPriCmpbGlineSvcLaneVO[]
	 */
	public RsltPriCmpbGlineSvcLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGlineSvcLaneVO[]
	 */
	public RsltPriCmpbGlineSvcLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGlineSvcLaneVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGlineSvcLaneVO();
				if (updDt[i] != null)
		...
		return getRsltPriCmpbGlineSvcLaneVOs();
	}
	 ...
	 * @return RsltPriCmpbGlineSvcLaneVO[]
	 */
	public RsltPriCmpbGlineSvcLaneVO[] getRsltPriCmpbGlineSvcLaneVOs(){
		RsltPriCmpbGlineSvcLaneVO[] vos = (RsltPriCmpbGlineSvcLaneVO[])models.toArray(new RsltPriCmpbGlineSvcLaneVO[models.size()]);
		return vos;
	}
