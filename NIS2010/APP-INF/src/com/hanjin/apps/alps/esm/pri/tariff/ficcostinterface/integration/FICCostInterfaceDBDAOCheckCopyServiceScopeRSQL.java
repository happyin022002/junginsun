...
*@FileName : FICCostInterfaceDBDAOCheckCopyServiceScopeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCheckCopyServiceScopeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * validation for copying service scope
	  * 2014.12.09 [CHM-201433135] [Add-on/IHC Tariff > SIN] 국가코드 ZA 추가
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCheckCopyServiceScopeRSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCheckCopyServiceScopeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , TRS_JOIN_FNC (CURSOR(" ).append("\n"); 
		query.append("SELECT DISTINCT RHQ.CNT_CD AS COST_CNT_CD  " ).append("\n"); 
		...
		query.append("    AND    RHQ.CNT_CD IN ( #foreach(${key} in ${cost_cnt_cd})" ).append("\n"); 
		...
		query.append("                                #end " ).append("\n"); 
		query.append("                         #end )" ).append("\n"); 
		query.append(")) AS COST_CNT_CD FROM DUAL" ).append("\n"); 
