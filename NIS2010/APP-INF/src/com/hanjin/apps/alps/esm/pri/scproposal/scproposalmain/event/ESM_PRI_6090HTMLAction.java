...
*@FileName : ESM_PRI_6090HTMLAction.java
...
public class ESM_PRI_6090HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6090HTMLAction 객체를 생성
	 */
	public ESM_PRI_6090HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6090Event event = new EsmPri6090Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSpScpMnVOS((PriSpScpMnVO[])getVOs(request, PriSpScpMnVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setInPrsMQCEstimateVO((InPrsMQCEstimateVO)getVO(request, InPrsMQCEstimateVO .class));
		}
