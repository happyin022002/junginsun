...
*@FileName : SearchQtaInquiryListVO.java
*@FileTitle : SearchQtaInquiryListVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.sqm.planning.planninginquiry.vo;
...
public class SearchQtaInquiryListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchQtaInquiryListVO> models = new ArrayList<SearchQtaInquiryListVO>();
	...
	public SearchQtaInquiryListVO() {}

	public SearchQtaInquiryListVO(String ibflag, String pagerows, String bseYr, String ofcVwCd, String rhqCd, String rgnOfcCd, String trdCd, String subTrdCd, String rlaneCd, String bseMon, String dirCd, String hulBndCd, String fnlBsaCapa, String lodQty, String gRev, String grpb, String paCmC, String raCmC, String paCm, String raCm, String raCmcb, String paCmcb, String raCmpb, String paCmpb) {
		this.lodQty = lodQty;
		this.raCmpb = raCmpb;
...
/**
	 ...
	 * @param request
	 * @return SearchQtaInquiryListVO[]
	 */
	public SearchQtaInquiryListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchQtaInquiryListVO[]
	 */
	public SearchQtaInquiryListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchQtaInquiryListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchQtaInquiryListVO();
				if (lodQty[i] != null)
		...
		return getSearchQtaInquiryListVOs();
	}
	 ...
	 * @return SearchQtaInquiryListVO[]
	 */
	public SearchQtaInquiryListVO[] getSearchQtaInquiryListVOs(){
		SearchQtaInquiryListVO[] vos = (SearchQtaInquiryListVO[])models.toArray(new SearchQtaInquiryListVO[models.size()]);
		return vos;
	}
