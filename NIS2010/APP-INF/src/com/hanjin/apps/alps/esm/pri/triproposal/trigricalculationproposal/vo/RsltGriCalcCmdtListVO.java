...
*@FileName : RsltGriCalcCmdtListVO.java
*@FileTitle : RsltGriCalcCmdtListVO
*Open Issues :
*Change history :
...
public class RsltGriCalcCmdtListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltGriCalcCmdtListVO> models = new ArrayList<RsltGriCalcCmdtListVO>();
	...
	public RsltGriCalcCmdtListVO() {}

	public RsltGriCalcCmdtListVO(String ibflag, String pagerows, String trfPfxCd, String trfNo, String griGrpSeq, String cmdtSeq, String cmdtCd, String cmdtNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltGriCalcCmdtListVO[]
	 */
	public RsltGriCalcCmdtListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltGriCalcCmdtListVO[]
	 */
	public RsltGriCalcCmdtListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltGriCalcCmdtListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltGriCalcCmdtListVO();
				if (updDt[i] != null)
		...
		return getRsltGriCalcCmdtListVOs();
	}
	 ...
	 * @return RsltGriCalcCmdtListVO[]
	 */
	public RsltGriCalcCmdtListVO[] getRsltGriCalcCmdtListVOs(){
		RsltGriCalcCmdtListVO[] vos = (RsltGriCalcCmdtListVO[])models.toArray(new RsltGriCalcCmdtListVO[models.size()]);
		return vos;
	}
