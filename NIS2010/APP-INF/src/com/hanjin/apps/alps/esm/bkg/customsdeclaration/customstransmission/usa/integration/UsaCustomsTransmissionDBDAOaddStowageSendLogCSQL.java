...
*@FileName : UsaCustomsTransmissionDBDAOaddStowageSendLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaCustomsTransmissionDBDAOaddStowageSendLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * dwkim, addStowageSendLog
	  * </pre>
	  */
	public UsaCustomsTransmissionDBDAOaddStowageSendLogCSQL(){
		setQuery();
		...
		query.append("FileName : UsaCustomsTransmissionDBDAOaddStowageSendLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
