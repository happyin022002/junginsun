...
*@FileName : UsaInbondTransmissionDBDAOsearchArrHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInbondTransmissionDBDAOsearchArrHeaderRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * dwkim Arr Header Query
	  * </pre>
	  */
	public UsaInbondTransmissionDBDAOsearchArrHeaderRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInbondTransmissionDBDAOsearchArrHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	RPAD('J01SMLM',80,' ')||CHR(10)" ).append("\n"); 
