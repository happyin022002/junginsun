...
*@FileName : ESM_BKG_0362HTMLAction.java
...
public class ESM_BKG_0362HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0362HTMLAction 객체를 생성
	 */
	public ESM_BKG_0362HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0362Event event = new EsmBkg0362Event();
        log.debug("##### CALL:ESM_BKG_0362HTMLAction - " + command.getCommand());

        String bkgNo      = JSPUtil.getParameter(request, "bkg_no");
        String vinNoList       = JSPUtil.getParameter(request, "vin_no_list");

        event.setBkgNo(bkgNo);
        event.setVinNoList(vinNoList);
