 ...
 *@FileName : ESM_PRI_2076HTMLAction.java
...
public class ESM_PRI_2076HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri2076Event event = new EsmPri2076Event();
