...
*@FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtListCSQL.java
...
public class RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtListCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
