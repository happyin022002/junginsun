...
*@FileName : ESM_BKG_1215HTMLAction.java
...
public class ESM_BKG_1215HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1215HTMLAction 객체를 생성
	 */
	public ESM_BKG_1215HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1215Event event = new EsmBkg1215Event();
		log.debug("***** ESM_BKG_1215HTMLAction : " + command.getCommand());
		...
		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH02) 
            ...
            event.setBkgAlocMgmtVO((BkgAlocMgmtVO)getVO(request, BkgAlocMgmtVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
            event.setBkgAlocMgmtVOs((BkgAlocMgmtVO[])getVOs(request, BkgAlocMgmtVO.class));
		}
