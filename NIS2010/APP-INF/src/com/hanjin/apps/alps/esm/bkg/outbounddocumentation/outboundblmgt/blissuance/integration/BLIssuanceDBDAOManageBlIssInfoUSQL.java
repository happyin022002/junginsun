...
public class BLIssuanceDBDAOManageBlIssInfoUSQL implements ISQLTemplate{
	...
	public BLIssuanceDBDAOManageBlIssInfoUSQL(){
		...
		params.put("bl_hld_usr_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bl_hld_rsn_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bl_hld_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bl_hld_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("    , @[bl_hld_flg]" ).append("\n"); 
		query.append("    , @[bl_hld_rsn_cd]" ).append("\n"); 
		query.append("#if ('000000'!=${bl_hld_dt})" ).append("\n"); 
		query.append("	,TO_DATE(replace(substr(@[bl_hld_dt],1,10),'-',''),'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(" 	,NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("    , @[bl_hld_usr_id]" ).append("\n"); 
		...
		query.append("    ,BL_HLD_FLG         = @[bl_hld_flg]" ).append("\n"); 
		query.append("    ,BL_HLD_RSN_CD      = @[bl_hld_rsn_cd]" ).append("\n"); 
		query.append("#if ('000000'!=${bl_hld_dt})" ).append("\n"); 
		query.append("    ,BL_HLD_DT          = TO_DATE(@[bl_hld_dt], 'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(" 	,BL_HLD_DT			= NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("    ,BL_HLD_USR_ID      = @[bl_hld_usr_id]" ).append("\n"); 
