...
/**
 * ALPS-CustomsTransmission Business Logic Basic Command implementation<br>
 * - ALPS-CustomsTransmission에 대한 비지니스 로직을 처리한다.<br>
 * 
 * @author KIM SEUNG MIN
 * @see ESM_BKG-0017EventResponse,PanamaCustomsTransmissionBC 각 DAO 클래스 참조
 * @since J2EE 1.4
 */
public abstract class CustomsReportBCImpl extends BasicCommandSupport implements CustomsReportBC {
	...
	/**
	 * Discharging Company 처리 (추가/수정/삭제)
	 * 
	...
	/**
	 * 세관에 EDI를 통해 적하목록 신고 후 신고 내역 조회한다.
	 * @param TransmitHistListCondVO transmitHistListCondVO
	 * @return List<TransmitHistListDetailVO>
	 * @exception EventException
	 */
	public List<TransmitHistListDetailVO> searchTransmitHistList(TransmitHistListCondVO transmitHistListCondVO)
			throws EventException {
		return null;
	}

	/**
	 * 세관에 EDI를 통해 적하목록 신고 후 전송한 메세지 내역 조회한다.
	 * @param TransmitHistFileCondVO transmitHistFileCondVO
	 * @return List<TransmitHistFileDetailVO>
	 * @exception EventException
	 */
	public List<TransmitHistFileDetailVO> searchTransmitHistFile(TransmitHistFileCondVO transmitHistFileCondVO)
			throws EventException {
		return null;
	}
	 ...
	 * @exception EventException
	 */
	public List<SendLogDetailVO> searchSendLog(
			SendLogCondVO sendLogCondVO)
			throws EventException {
		return null;
	}
	 ...
	 * @exception EventException
	 */
	public List<CheckListDetailListVO> searchTransmissionCheckList(TransmissionChkListCondVO transmissionChkListCondVO)
			throws EventException {
		return null;
	}
	 ...
	 * @exception EventException
	 */
	public List<UsaVesselArrivalDetailVO> searchVesselArrival(UsaVesselArrivalCondVO usaVesselArrivalCondVO)
			throws EventException {
		return null;
	}
