...
public class EQBalanceDBDAOSearchEQBalance00163ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	   ,(SELECT DISTINCT LCC_CD FROM COA_LOCATION_V WHERE ECC_CD =A.ECC_CD ) LCC_CD                                                     " ).append("\n"); 
		query.append("	   ,(SELECT DISTINCT RCC_CD FROM COA_LOCATION_V WHERE ECC_CD =A.ECC_CD ) RCC_CD" ).append("\n"); 
