...
*@FileName : ESM_PRI_0003_09HTMLAction.java
...
public class ESM_PRI_0003_09HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0003_09HTMLAction 객체를 생성
	 */
	public ESM_PRI_0003_09HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri000309Event event = new EsmPri000309Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSpScpNoteListVO((PriSpScpNoteListVO)getVO(request, PriSpScpNoteListVO .class));
		}
		else if(command.isCommand(FormCommand.REMOVELIST)) {
			event.setPriSpScpNoteListVO((PriSpScpNoteListVO)getVO(request, PriSpScpNoteListVO .class));
		}
