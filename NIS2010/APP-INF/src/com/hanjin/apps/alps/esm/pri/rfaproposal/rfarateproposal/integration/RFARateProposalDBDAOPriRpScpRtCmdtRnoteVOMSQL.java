...
*@FileName : RFARateProposalDBDAOPriRpScpRtCmdtRnoteVOMSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCmdtRnoteVOMSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCmdtRnoteVOMSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCmdtRnoteVOMSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[rout_seq]" ).append("\n"); 
		query.append(",	@[rout_note_seq]" ).append("\n"); 
		query.append(",	NVL(@[note_ctnt],'.')" ).append("\n"); 
		query.append(",	@[note_conv_mapg_id]" ).append("\n"); 
