...
*@FileName : BSAYearlyPlanDBDAOMultiBsaBudSltPrcCrrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOMultiBsaBudSltPrcCrrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOMultiBsaBudSltPrcCrrCSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOMultiBsaBudSltPrcCrrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_BUD_SLT_PRC_CRR A " ).append("\n"); 
