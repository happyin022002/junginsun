...
public class AGNCommCalculationDBDAOSearchBkgCalculationDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT B.BKG_NO,IO_BND_CD,GENERAL_AMT,BROG_AMT,CHF_AMT,TS_AMT,CROSS_AMT,CHG_COMM_AMT," ).append("\n"); 
		query.append("    ( " ).append("\n"); 
		...
		query.append("		NVL(SUM(DECODE(A.AC_TP_CD, 'P', A.IF_AMT, 0)),0) AS CHG_COMM_AMT" ).append("\n"); 
