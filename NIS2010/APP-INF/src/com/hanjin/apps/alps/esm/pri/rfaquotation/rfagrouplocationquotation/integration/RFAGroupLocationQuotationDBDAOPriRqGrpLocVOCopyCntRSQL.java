...
*@FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocVOCopyCntRSQL.java
...
public class RFAGroupLocationQuotationDBDAOPriRqGrpLocVOCopyCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * gline 카피 전에 저장할 데이터가 있는 지 조회
	  * </pre>
	  */
	public RFAGroupLocationQuotationDBDAOPriRqGrpLocVOCopyCntRSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocVOCopyCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
