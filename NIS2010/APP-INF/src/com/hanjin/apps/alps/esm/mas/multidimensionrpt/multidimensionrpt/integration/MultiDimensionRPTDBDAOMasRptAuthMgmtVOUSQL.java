...
*@FileName : MultiDimensionRPTDBDAOMasRptAuthMgmtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOMasRptAuthMgmtVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MAS_RPT_AUTH_MGMT 테이블의 레포트 별 권한 수정
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOMasRptAuthMgmtVOUSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOMasRptAuthMgmtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_RPT_AUTH_MGMT" ).append("\n"); 
