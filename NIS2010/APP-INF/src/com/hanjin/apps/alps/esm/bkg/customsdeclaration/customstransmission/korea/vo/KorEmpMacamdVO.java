...
*@FileName : KorEmpMacamdVO.java
*@FileTitle : KorEmpMacamdVO
*Open Issues :
*Change history :
...
public class KorEmpMacamdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorEmpMacamdVO> models = new ArrayList<KorEmpMacamdVO>();
	...
	public KorEmpMacamdVO() {}

	public KorEmpMacamdVO(String ibflag, String pagerows, String ediSndData, String polCd, String cstmsBlNo, String trnsSeq, String dmstPortCd, String bkgNo, String cstmsDeclTpCd) {
		this.bkgNo = bkgNo;
...
/**
	 ...
	 */
	public KorEmpMacamdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorEmpMacamdVO[]
	 */
	public KorEmpMacamdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEmpMacamdVO model = null;
	 ...
	 * @return KorEmpMacamdVO[]
	 */
	public KorEmpMacamdVO[] getKorEmpMacamdVOs(){
		KorEmpMacamdVO[] vos = (KorEmpMacamdVO[])models.toArray(new KorEmpMacamdVO[models.size()]);
		return vos;
	}
