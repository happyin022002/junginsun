...
*@FileName : ESM_BKG_1083HTMLAction.java
...
public class ESM_BKG_1083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1083HTMLAction 객체를 생성
	 */
	public ESM_BKG_1083HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1083Event event = new EsmBkg1083Event();
		

		if(command.isCommand(FormCommand.INIT)) {
			event.setSearchBookingTrendReportVO((SearchBookingTrendReportVO)getVO(request, SearchBookingTrendReportVO .class));
