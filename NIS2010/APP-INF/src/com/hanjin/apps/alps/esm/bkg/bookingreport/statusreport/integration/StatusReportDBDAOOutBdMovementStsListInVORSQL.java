...
public class StatusReportDBDAOOutBdMovementStsListInVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      , (SELECT BVVD.POD_CD" ).append("\n"); 
		query.append("         FROM BKG_VVD BVVD" ).append("\n"); 
		query.append("         WHERE BVVD.BKG_NO = TOT.BKG_NO" ).append("\n"); 
		query.append("         AND   BVVD.VSL_PRE_PST_CD = 'T') AS TRUNK_POD_CD" ).append("\n"); 
		query.append("      , POL_CD" ).append("\n"); 
		query.append("      , DEL_CD" ).append("\n"); 
		query.append("      , CNTR_TPSZ_CD" ).append("\n"); 
		query.append("      , OP_CNTR_QTY" ).append("\n"); 
		query.append("      , RD_CNTR_QTY" ).append("\n"); 
		...
		query.append("                          , SUBSTR(TRANSLATE(NVL(VB.SHPR_NAME,' '),CHR(13)||CHR(10),' '),1,20) CUST_NM" ).append("\n"); 
		...
		query.append("						  , CASE WHEN SUBSTR(A.CNTR_TPSZ_CD,1,1) = 'R'AND  SUBSTR(A.EQ_SUBST_CNTR_TPSZ_CD,1,1) = 'D' THEN A.EQ_SUBST_CGO_QTY ELSE 0 END AS RD_CNTR_QTY" ).append("\n"); 
		...
		query.append("                          , (  SELECT  NVL(CLM.CLM_SGHT_CD,' ')||','||NVL(CLM.ARR_LOC_NM,' ')||','||NVL(CLM.ARR_STE_CD,' ')||','||NVL(TO_CHAR(CLM.ARR_DT,'YYYY-MM-DD'),' ')||','||NVL(TO_CHAR(CLM.DEP_DT,'YYYY-MM-DD'),' ')" ).append("\n"); 
		query.append("                               FROM    SCE_CLM CLM, SCE_CLM_SGHT SGHT" ).append("\n"); 
		...
		query.append("                                                                                                                FROM    SCE_CLM Z" ).append("\n"); 
		...
		query.append("                          , (  SELECT  J.PWR_SPL_CBL_FLG" ).append("\n"); 
		...
		query.append("                            )   AK" ).append("\n"); 
		query.append("                          , 'VVD : ' || VB.TRUNK_VVD || '   POL : ' || VB.KEY_POL_CD || '    CCT : ' || TO_CHAR((PRD_GET_CCT_FNC(V.Yd_Cd,V.Slan_Cd,V.SKD_DIR_CD, VB.BKG_CGO_TP_CD, V.VPS_ETB_DT, V.VPS_ETD_DT, V.VSL_CD||V.SKD_VOY_NO||V.SKD_DIR_CD )),  'YYYY-MM-DD HH24:MI') || '   ETD : ' || TO_CHAR(V.VPS_ETD_DT,  'YYYY-MM-DD HH24:MI')  SUBGROUP_TITLE" ).append("\n"); 
		query.append("                          , '' VVD_CD" ).append("\n"); 
		query.append("                          , '' OFC_INC_SUB" ).append("\n"); 
		query.append("                          , '' CUST_TP_CD" ).append("\n"); 
		query.append("                          , '' CUST_CNT_CD" ).append("\n"); 
		...
		query.append("                                                  WHERE BKG_NO = BK.BKG_NO AND BL_NO_TP <> '0')" ).append("\n"); 
		query.append("                                AND  NOT EXISTS ( SELECT   'Y' FROM BKG_CONTAINER " ).append("\n"); 
		query.append("                                                 WHERE BKG_NO  = BK.BKG_NO" ).append("\n"); 
		query.append("                                                 AND   CNTR_NO = B.CNTR_NO" ).append("\n"); 
		query.append("                                                 AND   CNTR_PRT_FLG ='Y')                       " ).append("\n"); 
