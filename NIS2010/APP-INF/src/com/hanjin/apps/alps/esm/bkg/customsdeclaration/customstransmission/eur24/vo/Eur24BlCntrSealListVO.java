...
*@FileName : Eur24BlCntrSealListVO.java
*@FileTitle : Eur24BlCntrSealListVO
*Open Issues :
*Change history :
...
public class Eur24BlCntrSealListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eur24BlCntrSealListVO> models = new ArrayList<Eur24BlCntrSealListVO>();
...
/**
	 ...
	 * @param request
	 * @return Eur24BlCntrSealListVO[]
	 */
	public Eur24BlCntrSealListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eur24BlCntrSealListVO[]
	 */
	public Eur24BlCntrSealListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eur24BlCntrSealListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Eur24BlCntrSealListVO();
				if (updDt[i] != null)
		...
		return getEur24BlCntrSealListVOs();
	}
	 ...
	 * @return Eur24BlCntrSealListVO[]
	 */
	public Eur24BlCntrSealListVO[] getEur24BlCntrSealListVOs(){
		Eur24BlCntrSealListVO[] vos = (Eur24BlCntrSealListVO[])models.toArray(new Eur24BlCntrSealListVO[models.size()]);
		return vos;
	}
