...
*@FileName : ESM_BKG_1018HTMLAction.java
...
public class ESM_BKG_1018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0052HTMLAction 객체를 생성
	 */
	public ESM_BKG_1018HTMLAction() {}
	...
	{
		EsmBkg1018Event event = new EsmBkg1018Event();
		
		event.setDoPrnRmkVO((DoPrnRmkVO) getVO(request, DoPrnRmkVO.class));
