...
public class CargoReleaseOrderDBDAOSearchKorEdiHistoryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , TO_CHAR( GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',TO_DATE(sysdate, 'YYYY/MM/DD HH24MISS'), 'GMT' ),'YYYYMMDD HH24MISS')    AS SND_RQST_GDT" ).append("\n"); 
		...
		query.append("     , TO_CHAR( GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',TO_DATE(sysdate, 'YYYY/MM/DD HH24MISS'), 'GMT' ),'YYYYMMDD HH24MISS')    AS SND_GDT " ).append("\n"); 
