...
*@FileName : UsWharfageDecMgtDBDAOaddBkgUsaWhfSndHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOaddBkgUsaWhfSndHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOaddBkgUsaWhfSndHisCSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOaddBkgUsaWhfSndHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_USA_WHF_SND_HIS (" ).append("\n"); 
