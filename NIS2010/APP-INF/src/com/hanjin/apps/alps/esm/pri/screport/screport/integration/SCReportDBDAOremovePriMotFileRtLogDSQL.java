...
*@FileName : SCReportDBDAOremovePriMotFileRtLogDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAOremovePriMotFileRtLogDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCReportDBDAOremovePriMotFileRtLogDSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAOremovePriMotFileRtLogDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM	PRI_MOT_FILE_RT_LOG" ).append("\n"); 
