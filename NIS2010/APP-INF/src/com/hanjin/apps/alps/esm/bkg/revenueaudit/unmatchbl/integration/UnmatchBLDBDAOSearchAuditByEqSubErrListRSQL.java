...
*@FileName : UnmatchBLDBDAOSearchAuditByEqSubErrListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOSearchAuditByEqSubErrListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Audit by CNTR Qty Discrepancy 리스트 정보를 Container 별로 조회한다
	  * </pre>
	  */
	public UnmatchBLDBDAOSearchAuditByEqSubErrListRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOSearchAuditByEqSubErrListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          AND UB.BKG_REV_AUD_TP_CD='E' " ).append("\n"); 
		...
		query.append("        BK.BKG_NO            ," ).append("\n"); 
		query.append("        BK.BL_NO             ," ).append("\n"); 
		query.append("        NVL(TO_CHAR(BK.BKG_CRE_DT, 'YYYY-MM-DD'),' ') AS BKG_CRE_DT ," ).append("\n"); 
		query.append("        NVL(TO_CHAR(BK.RT_APLY_DT, 'YYYY-MM-DD'),' ') AS RT_APLY_DT ," ).append("\n"); 
		query.append("        NVL(TO_CHAR(BK.POL_ETD,'YYYY-MM-DD'),' ')     AS POL_ETD ," ).append("\n"); 
		query.append("        BK.SVC_SCP_CD        , -- param" ).append("\n"); 
		query.append("        BK.BKG_CTRT_TP_CD    , -- param" ).append("\n"); 
		...
		query.append("		NVL(RDN_STS_NM,' ') 			   AS RDN_STS_NM," ).append("\n"); 
		query.append("        SPLIT_FLG   ," ).append("\n"); 
		query.append("        SPLIT_NM ," ).append("\n"); 
		query.append("         " ).append("\n"); 
		query.append("        BCNT.CNTR_NO             AS CNTR_NO, " ).append("\n"); 
		query.append("        BCNT.CNTR_TPSZ_CD        AS CNTR_TPSZ_CD,          " ).append("\n"); 
		query.append("        BCNT.CNTR_VOL_QTY        AS PCK_QTY, " ).append("\n"); 
		query.append("        BCNT.CNTR_WGT            AS CNTR_WGT,      " ).append("\n"); 
		query.append("        BCNT.MEAS_QTY           AS MEAS_QTY     " ).append("\n"); 
		query.append("FROM    (" ).append("\n"); 
		...
		query.append("        )" ).append("\n"); 
		query.append("AND	(  BQ.EQ_SUBST_FLG	= 'Y' )" ).append("\n"); 
		query.append("AND	( 'N'	= 'N' OR BQ.AWK_CGO_FLG		= 'N' OR BQ.AWK_CGO_FLG	IS NULL )" ).append("\n"); 
		query.append("AND ( 'N'		= 'N' OR BQ.BB_CGO_FLG		= 'N' OR BQ.BB_CGO_FLG IS NULL)" ).append("\n"); 
		query.append("AND    BCNT.BKG_NO =  BK.BKG_NO" ).append("\n"); 
		query.append("ORDER BY" ).append("\n"); 
