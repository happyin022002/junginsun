...
*@FileName : SCReportDBDAOPriMotTrfRtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAOPriMotTrfRtDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_MOT_TRF_RT Table Delete
	  * </pre>
	  */
	public SCReportDBDAOPriMotTrfRtDSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAOPriMotTrfRtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
