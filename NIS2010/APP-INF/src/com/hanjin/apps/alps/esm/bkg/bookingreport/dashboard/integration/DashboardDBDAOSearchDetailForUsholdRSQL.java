...
*@FileName : DashboardDBDAOSearchDetailForUsholdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DashboardDBDAOSearchDetailForUsholdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * General + US Hold Detail 항목을 조회한다.
	  * </pre>
	  */
	public DashboardDBDAOSearchDetailForUsholdRSQL(){
		setQuery();
		...
		query.append("FileName : DashboardDBDAOSearchDetailForUsholdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", (SELECT COUNT(NTC.BKG_NO)" ).append("\n"); 
		query.append("     FROM BKG_HLD_NTC NTC" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		query.append("      AND A.BKG_NO = NTC.BKG_NO" ).append("\n"); 
		query.append("      AND NTC.HLD_NTC_TP_CD ='PH'" ).append("\n"); 
		query.append("      AND NOT EXISTS (SELECT 'Y' FROM BKG_HLD_NTC NTC1" ).append("\n"); 
		query.append("                       WHERE 1=1" ).append("\n"); 
		query.append("                         AND NTC.BKG_NO = NTC1.BKG_NO" ).append("\n"); 
		query.append("                         AND NTC1.HLD_NTC_TP_CD ='CF'" ).append("\n"); 
		query.append("                         AND ROWNUM =1)) AS HOLD_CNT" ).append("\n"); 
		query.append(", (SELECT COUNT(NTC.BKG_NO)" ).append("\n"); 
		query.append("     FROM BKG_HLD_NTC NTC" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		query.append("      AND A.BKG_NO = NTC.BKG_NO" ).append("\n"); 
		query.append("      AND NTC.HLD_NTC_TP_CD ='CF') AS REMOVAL_CNT" ).append("\n"); 
		query.append(", (SELECT COUNT(NTC.BKG_NO)" ).append("\n"); 
		query.append("     FROM BKG_HLD_NTC NTC" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		query.append("      AND A.BKG_NO = NTC.BKG_NO" ).append("\n"); 
		query.append("      AND NTC.HLD_NTC_TP_CD ='PH') AS HOLD_TTL" ).append("\n"); 
		query.append(", ( SELECT /*+ INDEX_DESC(H XPKBKG_HLD_NTC) */ CSTMS_PRE_HLD_CD" ).append("\n"); 
		query.append("      FROM BKG_HLD_NTC H" ).append("\n"); 
		query.append("     WHERE 1=1" ).append("\n"); 
		query.append("       AND A.BKG_NO = H.BKG_NO" ).append("\n"); 
		query.append("       AND ROWNUM=1 ) AS CSTMS_PRE_HLD_CD" ).append("\n"); 
		query.append(", ( SELECT " ).append("\n"); 
