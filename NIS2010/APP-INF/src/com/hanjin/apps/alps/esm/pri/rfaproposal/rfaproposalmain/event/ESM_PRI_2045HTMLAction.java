...
*@FileName : ESM_PRI_2045HTMLAction.java
...
public class ESM_PRI_2045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2046HTMLAction 객체를 생성
	 */
	public ESM_PRI_2045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2045Event event = new EsmPri2045Event();

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriRpRetroVO((PriRpRetroVO)getVO(request, PriRpRetroVO.class));
