...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutPntMaxSeqRSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutPntMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutPntMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutPntMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
