...
*@FileName : CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVODSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriDestCmpbGlineRoutViaVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_CMPB_GLINE_ROUT_VIA" ).append("\n"); 
