...
public class FDRProgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FDRProgVO> models = new ArrayList<FDRProgVO>();
	...
	public FDRProgVO(String ibflag, String pagerows, String updDt, String progUsrId, String amdtSeq, String svcScpCd, String progSeq, String orgDestTpCd, String creDt, String creUsrId, String progDt, String progOfcCd, String fdrTrfNo, String updUsrId, String ficPropStsCd) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return FDRProgVO[]
	 */
	public FDRProgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FDRProgVO[]
	 */
	public FDRProgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FDRProgVO model = null;
	 ...
	 * @return FDRProgVO[]
	 */
	public FDRProgVO[] getFDRProgVOs(){
		FDRProgVO[] vos = (FDRProgVO[])models.toArray(new FDRProgVO[models.size()]);
		return vos;
	}
