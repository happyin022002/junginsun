...
*@FileName : BookingMasterMgtDBDAOremoveBkgEdiSubLnkMsgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOremoveBkgEdiSubLnkMsgDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_EDI_SUB_LNK_MSG를 삭제한다.
	  * </pre>
	  */
	public BookingMasterMgtDBDAOremoveBkgEdiSubLnkMsgDSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOremoveBkgEdiSubLnkMsgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
