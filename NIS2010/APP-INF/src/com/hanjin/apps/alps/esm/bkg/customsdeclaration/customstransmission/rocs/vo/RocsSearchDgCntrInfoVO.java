...
public class RocsSearchDgCntrInfoVO extends AbstractValueObject {
	...
	public RocsSearchDgCntrInfoVO(String ibflag, String pagerows, String cntrNo, String dgImoClass, String dgUnno, String dgFlashPnt, String dgPkgDesc) {
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDgFlashPnt(JSPUtil.getParameter(request, "dg_flash_pnt", ""));
		setDgImoClass(JSPUtil.getParameter(request, "dg_imo_class", ""));
		setCntrNo(JSPUtil.getParameter(request, "cntr_no", ""));
		setDgPkgDesc(JSPUtil.getParameter(request, "dg_pkg_desc", ""));
		setDgUnno(JSPUtil.getParameter(request, "dg_unno", ""));
	...
	public RocsSearchDgCntrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dgFlashPnt = (JSPUtil.getParameter(request, prefix	+ "dg_flash_pnt".trim(), length));
			String[] dgImoClass = (JSPUtil.getParameter(request, prefix	+ "dg_imo_class".trim(), length));
			String[] cntrNo = (JSPUtil.getParameter(request, prefix	+ "cntr_no".trim(), length));
			String[] dgPkgDesc = (JSPUtil.getParameter(request, prefix	+ "dg_pkg_desc".trim(), length));
			String[] dgUnno = (JSPUtil.getParameter(request, prefix	+ "dg_unno".trim(), length));
