...
*@FileName : ESM_AGT_0009HTMLAction.java
...
public class ESM_AGT_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0009HTMLAction 객체를 생성
	 */
	public ESM_AGT_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0009Event event = new EsmAgt0009Event();
		

		if(command.isCommand(FormCommand.SEARCH))
		{
			event.setAgtOtrUtCostVO((AgtOtrUtCostVO)getVO(request, AgtOtrUtCostVO .class));
		}
