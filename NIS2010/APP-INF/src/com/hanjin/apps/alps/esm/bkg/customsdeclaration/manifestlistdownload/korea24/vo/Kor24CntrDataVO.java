...
*@FileName : Kor24CntrDataVO.java
*@FileTitle : Kor24CntrDataVO
*Open Issues :
*Change history :
...
public class Kor24CntrDataVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CntrDataVO> models = new ArrayList<Kor24CntrDataVO>();
	...
	public Kor24CntrDataVO() {}

	public Kor24CntrDataVO(String ibflag, String pagerows, String vvd, String portCd, String inType, String ioBndCd, String podCd, String polCd, String podTml) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.polCd = polCd;
		this.inType = inType;
	 ...
	 */
	public Kor24CntrDataVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrCntrVO[]
	 */
	public Kor24CntrDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CntrDataVO model = null;
	 ...
	 * @return BkgCstmsKrCntrVO[]
	 */
	public Kor24CntrDataVO[] getBkgCstmsKrCntrVOs(){
		Kor24CntrDataVO[] vos = (Kor24CntrDataVO[])models.toArray(new Kor24CntrDataVO[models.size()]);
		return vos;
	}
