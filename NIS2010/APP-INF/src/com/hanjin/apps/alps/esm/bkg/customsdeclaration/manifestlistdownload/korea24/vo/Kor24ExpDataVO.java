...
*@FileName : BkgCstmsKrXptLicVO.java
*@FileTitle : BkgCstmsKrXptLicVO
*Open Issues :
*Change history :
...
public class Kor24ExpDataVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ExpDataVO> models = new ArrayList<Kor24ExpDataVO>();
	...
	public Kor24ExpDataVO() {}

	public Kor24ExpDataVO(String ibflag, String pagerows, String vvd, String portCd, String inType, String ioBndCd, String podCd, String polCd, String podTml) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.polCd = polCd;
		this.inType = inType;
	 ...
	 */
	public Kor24ExpDataVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrXptLicVO[]
	 */
	public Kor24ExpDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ExpDataVO model = null;
	 ...
	 * @return BkgCstmsKrXptLicVO[]
	 */
	public Kor24ExpDataVO[] getBkgCstmsKrXptLicVOs(){
		Kor24ExpDataVO[] vos = (Kor24ExpDataVO[])models.toArray(new Kor24ExpDataVO[models.size()]);
		return vos;
	}
