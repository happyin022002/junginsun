...
*@FileName : EsmMas0110ViewAdapter2.java
*@FileTitle : EsmMas0110ViewAdapter2
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0110ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmMas0110ViewAdapter2(){
    	super();
    }
