...
public class Jp24ManifestListDownloadDBDAOSearchBkgBookingRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          WHEN ACT_WGT > 999999.999" ).append("\n"); 
		query.append("             THEN ROUND(ACT_WGT * 0.001, 3)" ).append("\n"); 
		query.append("          ELSE ACT_WGT" ).append("\n"); 
		query.append("       END AS ACT_WGT," ).append("\n"); 
		query.append("       CASE" ).append("\n"); 
		query.append("          WHEN ACT_WGT > 999999.999" ).append("\n"); 
		query.append("             THEN 'TNE'" ).append("\n"); 
		...
		query.append("       (" ).append("\n"); 
		query.append("        select /*+ INDEX_DESC(DG XPKBKG_DG_CGO) */" ).append("\n"); 
