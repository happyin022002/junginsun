...
*@FileName : EBookingReceiptDBDAOsearchNisDgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOsearchNisDgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOsearchNisDgRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOsearchNisDgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DG.EMER_CNTC_PSON_NM" ).append("\n"); 
