...
*@FileName : TCharterIOContractDAOSearchHireSysDate2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOContractDAOSearchHireSysDate2RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOSearchHireSysDate2RSQL
	  * </pre>
	  */
	public TCharterIOContractDAOSearchHireSysDate2RSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOContractDAOSearchHireSysDate2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
