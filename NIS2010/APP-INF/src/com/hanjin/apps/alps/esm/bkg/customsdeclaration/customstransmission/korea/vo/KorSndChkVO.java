...
*@FileName : KorSndChkVO.java
*@FileTitle : KorSndChkVO
*Open Issues :
*Change history :
...
public class KorSndChkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorSndChkVO> models = new ArrayList<KorSndChkVO>();
	...
	public KorSndChkVO(String ibflag, String pagerows, String sndChk, String bkgNo, String cstmsDeclTpCd, String dmstPortCd, String cstmsBlNo, String trnsSeq) {
...
/**
	 ...
	 * @return KorSndChkVO[]
	 */
	public KorSndChkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorSndChkVO[]
	 */
	public KorSndChkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorSndChkVO model = null;
	 ...
	 * @return KorSndChkVO[]
	 */
	public KorSndChkVO[] getKorSndChkVOs(){
		KorSndChkVO[] vos = (KorSndChkVO[])models.toArray(new KorSndChkVO[models.size()]);
		return vos;
	}
