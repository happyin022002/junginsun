...
*@FileName : ESM_BKG_1080HTMLAction.java
...
public class ESM_BKG_1080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1080HTMLAction 객체를 생성
	 */
	public ESM_BKG_1080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1080Event event = new EsmBkg1080Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltSearchAuditByHangerInstallationListVO((RsltSearchAuditByHangerInstallationListVO)getVO(request, RsltSearchAuditByHangerInstallationListVO.class));
		}
        else if(command.isCommand(FormCommand.MULTI01)) {
			
			
			event.setRsltSearchAuditByHangerInstallationListVOS((RsltSearchAuditByHangerInstallationListVO[])getVOs(request, RsltSearchAuditByHangerInstallationListVO.class, ""));
