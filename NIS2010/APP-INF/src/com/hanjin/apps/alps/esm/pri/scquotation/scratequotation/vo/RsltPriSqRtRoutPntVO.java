...
*@FileName : RsltPriSqRtRoutPntVO.java
*@FileTitle : RsltPriSqRtRoutPntVO
*Open Issues :
*Change history :
...
public class RsltPriSqRtRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqRtRoutPntVO> models = new ArrayList<RsltPriSqRtRoutPntVO>();
	 ...
	 * @param request
	 * @return RsltPriSqRtRoutPntVO[]
	 */
	public RsltPriSqRtRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqRtRoutPntVO[]
	 */
	public RsltPriSqRtRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqRtRoutPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSqRtRoutPntVO();
				if (updDt[i] != null)
		...
		return getRsltPriSqRtRoutPntVOs();
	}
	 ...
	 * @return RsltPriSqRtRoutPntVO[]
	 */
	public RsltPriSqRtRoutPntVO[] getRsltPriSqRtRoutPntVOs(){
		RsltPriSqRtRoutPntVO[] vos = (RsltPriSqRtRoutPntVO[])models.toArray(new RsltPriSqRtRoutPntVO[models.size()]);
		return vos;
	}
