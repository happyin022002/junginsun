...
*@FileName : NoteConversionDBDAOPriNoteConvGrpLocDtlVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NoteConversionDBDAOPriNoteConvGrpLocDtlVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NoteConversionDBDAOPriNoteConvGrpLocDtlVODSQL(){
		setQuery();
		...
		query.append("FileName : NoteConversionDBDAOPriNoteConvGrpLocDtlVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
