...
*@FileName : ESM_BKG_0961HTMLAction.java
...
public class ESM_BKG_0961HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0961HTMLAction 객체를 생성
	 */
	public ESM_BKG_0961HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0961Event event = new EsmBkg0961Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPpdCctCustInVO((PpdCctCustInVO)getVO(request, PpdCctCustInVO .class));
		}
