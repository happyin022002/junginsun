...
*@FileName : ESM_MAS_0130HTMLAction.java
...
public class ESM_MAS_0130HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0130HTMLAction 객체를 생성
	 */
	public ESM_MAS_0130HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0130Event event = new EsmMas0130Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			
			event.setSearchReportViewListVOS((SearchReportViewListVO[])getVOs(request, SearchReportViewListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchReportViewListVO((SearchReportViewListVO)getVO(request, SearchReportViewListVO .class));
		}
