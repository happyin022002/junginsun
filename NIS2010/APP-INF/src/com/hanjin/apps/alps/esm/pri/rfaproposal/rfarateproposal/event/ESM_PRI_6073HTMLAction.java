...
public class ESM_PRI_6073HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6019HTMLAction 객체를 생성
	 */
	public ESM_PRI_6073HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6073Event event = new EsmPri6073Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriRpScpScgAdjVOS((PriRpScpScgAdjVO[])getVOs(request, PriRpScpScgAdjVO .class,""));
