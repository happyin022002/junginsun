...
*@FileName : EsmMas0072ViewAdapter5.java
*@FileTitle : EsmMas0072ViewAdapter5
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0072ViewAdapter5 extends DefaultViewAdapter {
	
    public EsmMas0072ViewAdapter5(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0072ViewAdapter5 ########### [START]");
		...
		log.debug("########### EsmMas0072ViewAdapter5 ########### [END]");        
