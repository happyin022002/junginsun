...
*@FileName : SearchScTPSOftAutoratingListVO.java
*@FileTitle : SearchScTPSOftAutoratingListVO
*Open Issues :
*Change history :
...
public class SearchScTPSOftAutoratingListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchScTPSOftAutoratingListVO> models = new ArrayList<SearchScTPSOftAutoratingListVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRtCalcFrtRtAmt(JSPUtil.getParameter(request, "rt_calc_frt_rt_amt", ""));
		...
		setOaCalcFrtRtAmt(JSPUtil.getParameter(request, "oa_calc_frt_rt_amt", ""));
		...
		setBkgBqOccrSeq(JSPUtil.getParameter(request, "bkg_bq_occr_seq", ""));
		...
		setOiCalcFrtRtAmt(JSPUtil.getParameter(request, "oi_calc_frt_rt_amt", ""));
		...
		setDaCalcFrtRtAmt(JSPUtil.getParameter(request, "da_calc_frt_rt_amt", ""));
		...
		setDiCalcFrtRtAmt(JSPUtil.getParameter(request, "di_calc_frt_rt_amt", ""));
	 ...
	 * @param request
	 * @return SearchScTPSOftAutoratingListVO[]
	 */
	public SearchScTPSOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchScTPSOftAutoratingListVO[]
	 */
	public SearchScTPSOftAutoratingListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchScTPSOftAutoratingListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchScTPSOftAutoratingListVO();
		...
		return getSearchScTPSOftAutoratingListVOs();
	}
	 ...
	 * @return SearchScTPSOftAutoratingListVO[]
	 */
	public SearchScTPSOftAutoratingListVO[] getSearchScTPSOftAutoratingListVOs(){
		SearchScTPSOftAutoratingListVO[] vos = (SearchScTPSOftAutoratingListVO[])models.toArray(new SearchScTPSOftAutoratingListVO[models.size()]);
		return vos;
	}
