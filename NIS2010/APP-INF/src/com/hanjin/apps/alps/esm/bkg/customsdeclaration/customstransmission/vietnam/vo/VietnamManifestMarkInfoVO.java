...
public class VietnamManifestMarkInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VietnamManifestMarkInfoVO> models = new ArrayList<VietnamManifestMarkInfoVO>();
	...
	public VietnamManifestMarkInfoVO() {}

	public VietnamManifestMarkInfoVO(String ibflag, String pagerows, String mark1, String mark2, String mark3, String mark4, String mark5, String mark6, String mark7, String mark8, String mark9, String mark10) {
		this.mark10 = mark10;
		this.mark9 = mark9;
		this.mark8 = mark8;
		this.mark7 = mark7;
...
/**
	 ...
	 * @param request
	 * @return VietnamManifestMarkInfoVO[]
	 */
	public VietnamManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VietnamManifestMarkInfoVO[]
	 */
	public VietnamManifestMarkInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VietnamManifestMarkInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new VietnamManifestMarkInfoVO();
				if (mark10[i] != null)
		...
		return getVietnamManifestMarkInfoVOs();
	}
	 ...
	 * @return VietnamManifestMarkInfoVO[]
	 */
	public VietnamManifestMarkInfoVO[] getVietnamManifestMarkInfoVOs(){
		VietnamManifestMarkInfoVO[] vos = (VietnamManifestMarkInfoVO[])models.toArray(new VietnamManifestMarkInfoVO[models.size()]);
		return vos;
	}
