...
*@FileName : NoShowReflectionDBDAOMultiSpcNshwRfltCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NoShowReflectionDBDAOMultiSpcNshwRfltCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * No-Show 반영기준 데이터  INSERT
	  * </pre>
	  */
	public NoShowReflectionDBDAOMultiSpcNshwRfltCSQL(){
		setQuery();
		...
		query.append("FileName : NoShowReflectionDBDAOMultiSpcNshwRfltCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPC_NSHW_RFLT (" ).append("\n"); 
		query.append("    TRD_CD           ," ).append("\n"); 
		query.append("    SUB_TRD_CD       ," ).append("\n"); 
		query.append("    RLANE_CD         ," ).append("\n"); 
		query.append("    DIR_CD           ," ).append("\n"); 
		query.append("    ALOC_DDCT_BSE_CD ," ).append("\n"); 
		query.append("    ALOC_DDCT_CS_CD  ," ).append("\n"); 
		query.append("    ALOC_DDCT_TGT_CD ," ).append("\n"); 
		query.append("    ALOC_DDCT_MOD_CD ," ).append("\n"); 
		query.append("    ALOC_DDCT_MOD_VAL," ).append("\n"); 
