...
*@FileName : Kor24CustomsTransmissionDBDAOsearchCstmMaxAckSeqRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchCstmMaxAckSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchCstmMaxAckSeqRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchCstmMaxAckSeqRSQL").append("\n");
		query.append("*/").append("\n");
	}
