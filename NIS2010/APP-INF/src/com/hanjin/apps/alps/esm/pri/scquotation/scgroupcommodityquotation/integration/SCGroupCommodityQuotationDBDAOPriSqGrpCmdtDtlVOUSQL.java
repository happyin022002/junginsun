...
*@FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOUSQL.java
...
public class SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_GRP_CMDT_DTL SET" ).append("\n"); 
