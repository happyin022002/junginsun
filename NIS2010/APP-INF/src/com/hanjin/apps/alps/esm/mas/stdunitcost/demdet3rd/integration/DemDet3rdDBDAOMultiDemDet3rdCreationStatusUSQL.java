...
*@FileName : DemDet3rdDBDAOMultiDemDet3rdCreationStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDet3rdDBDAOMultiDemDet3rdCreationStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDet3rdDBDAOMultiDemDet3rdCreationStatusUSQL(){
		setQuery();
		...
		query.append("FileName : DemDet3rdDBDAOMultiDemDet3rdCreationStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   ,'DMDT' CM_UC_CD" ).append("\n"); 
