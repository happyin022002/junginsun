...
*@FileName : FICCostInterfaceDBDAOCopyTariffIhcMainDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCopyTariffIhcMainDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CopyTariffIhcMainData
	  * 2013.02.27 [CHM-201323352] 전윤주 copy 시 confirm date를 copy한 날짜로, confrim user는 copy한 user 로 변경
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCopyTariffIhcMainDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCopyTariffIhcMainDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND MN.IHC_TRF_NO     = @[ori_ihc_trf_no] " ).append("\n"); 
