...
*@FileName : EsmCoa0059ViewAdapter.java
*@FileTitle : EsmCoa0059ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0059ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0059ViewAdapter(){
    	super();
    }
	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
                    ...
                    strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)colValues.get("slct_itm_fom_desc"))+"]]></TD>");
