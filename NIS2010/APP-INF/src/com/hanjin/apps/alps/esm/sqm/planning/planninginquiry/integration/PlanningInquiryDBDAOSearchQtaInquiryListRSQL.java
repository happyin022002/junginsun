...
public class PlanningInquiryDBDAOSearchQtaInquiryListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * * 2016.03.08 최성민 [CHM-201640194] QTA Set up by Head Office for IAS Sector_Summary VVD 중복 계산 관련 로직 수정
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(HUL_BND_CD,'BH','B/H','H/H') HUL_BND_CD" ).append("\n"); 
		...
		query.append("      ,MAS.HUL_BND_CD" ).append("\n"); 
		...
		query.append("   AND VVD.FNL_BSA_CAPA   <> 0" ).append("\n"); 
		query.append("      )" ).append("\n"); 
