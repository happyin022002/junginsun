...
*@FileName : UsCgoRlseListVO.java
*@FileTitle : UsCgoRlseListVO
*Open Issues :
*Change history :
...
public class UsCgoRlseListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsCgoRlseListVO> models = new ArrayList<UsCgoRlseListVO>();
	...
	public UsCgoRlseListVO() {}

	public UsCgoRlseListVO(String ibflag, String pagerows, String blNo, String bkgNo, String pcsQty, String vvdCd, String podCd, String delCd, String hubCd, String lastUpDt, String frtCltFlg, String fLastDt, String oblRdemFlg, String oLastDt, String cstmsClrCd, String cLastDt, String tmlSnd, String tmlLastDt, String prtInd, String custNm, String interRmk, String doHldFlg, String oblTtlKnt, String bkgPodCd, String oblInterSerNo, String oblInterSerNoChkUsrId, String oblInterSerNoChkDt, String bkgPodYdCd , String actPodCd, String porCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("act_pod_cd", getActPodCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("act_pod_cd", "actPodCd");		
	 ...
	 * @return actPodCd
	 */
	public String getActPodCd() {
		return this.actPodCd;
	}
	 ...
	 * @param actPodCd
	 */
	public void setActPodCd(String actPodCd) {
		this.actPodCd = actPodCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setActPodCd(JSPUtil.getParameter(request, "act_pod_cd", ""));	
		setOblInterSerNoChkUsrId(JSPUtil.getParameter(request, "obl_inter_ser_no_chk_usr_id", ""));		
		setOblInterSerNoChkDt(JSPUtil.getParameter(request, "obl_inter_ser_no_chk_dt", ""));		
		setOblInterSerNo(JSPUtil.getParameter(request, "obl_inter_ser_no", ""));
		setBkgPodYdCd(JSPUtil.getParameter(request, "bkg_pod_yd_cd", ""));
		setBkgPodYdCd(JSPUtil.getParameter(request, "por_cd", ""));
	 ...
	 */
	public UsCgoRlseListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsCgoRlseListVO[]
	 */
	public UsCgoRlseListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsCgoRlseListVO model = null;
		...
		try {
			...
			String[] actPodCd = (JSPUtil.getParameter(request, prefix	+ "act_pod_cd", length));
	 ...
	 * @return UsCgoRlseListVO[]
	 */
	public UsCgoRlseListVO[] getUsCgoRlseListVOs(){
		UsCgoRlseListVO[] vos = (UsCgoRlseListVO[])models.toArray(new UsCgoRlseListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.actPodCd = this.actPodCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
