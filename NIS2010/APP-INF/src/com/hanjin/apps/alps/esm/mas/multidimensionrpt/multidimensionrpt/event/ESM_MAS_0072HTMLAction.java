...
*@FileName : ESM_MAS_0072HTMLAction.java
 ...
 *
 * @author KimJongBeom
 * @see EsmMas0072Event , ESM_MAS_0072EventResponse 참조
 * @since J2EE 1.4
 */ 

public class ESM_MAS_0072HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0072Event event = new EsmMas0072Event();
