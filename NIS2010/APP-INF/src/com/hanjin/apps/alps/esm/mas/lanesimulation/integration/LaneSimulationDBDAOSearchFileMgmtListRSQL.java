...
public class LaneSimulationDBDAOSearchFileMgmtListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",'' USER_ID" ).append("\n"); 
		query.append("FROM MAS_SIM_INFO A" ).append("\n"); 
		query.append(",(" ).append("\n"); 
		...
		query.append("(SELECT SIM_RMK FROM MAS_SIM_RPT_MST A1 WHERE A1.SIM_DT = B1.SIM_DT AND A1.SIM_NO = B1.SIM_NO AND A1.SIM_RPT_NO = B1.SIM_RPT_NO AND A1.SECT_NO = '001') || ' ' ||" ).append("\n"); 
		query.append("(SELECT SIM_RMK FROM MAS_SIM_RPT_MST A1 WHERE A1.SIM_DT = B1.SIM_DT AND A1.SIM_NO = B1.SIM_NO AND A1.SIM_RPT_NO = B1.SIM_RPT_NO AND A1.SECT_NO = '002') || ' ' ||" ).append("\n"); 
		query.append("(SELECT SIM_RMK FROM MAS_SIM_RPT_MST A1 WHERE A1.SIM_DT = B1.SIM_DT AND A1.SIM_NO = B1.SIM_NO AND A1.SIM_RPT_NO = B1.SIM_RPT_NO AND A1.SECT_NO = '003') || ' ' ||" ).append("\n"); 
		query.append("(SELECT SIM_RMK FROM MAS_SIM_RPT_MST A1 WHERE A1.SIM_DT = B1.SIM_DT AND A1.SIM_NO = B1.SIM_NO AND A1.SIM_RPT_NO = B1.SIM_RPT_NO AND A1.SECT_NO = '004') || ' ' ||" ).append("\n"); 
		query.append("(SELECT SIM_RMK FROM MAS_SIM_RPT_MST A1 WHERE A1.SIM_DT = B1.SIM_DT AND A1.SIM_NO = B1.SIM_NO AND A1.SIM_RPT_NO = B1.SIM_RPT_NO AND A1.SECT_NO = '005') || ' ' ||" ).append("\n"); 
		query.append("(SELECT SIM_RMK FROM MAS_SIM_RPT_MST A1 WHERE A1.SIM_DT = B1.SIM_DT AND A1.SIM_NO = B1.SIM_NO AND A1.SIM_RPT_NO = B1.SIM_RPT_NO AND A1.SECT_NO = '006')" ).append("\n"); 
		query.append(") SIM_RMK" ).append("\n"); 
		query.append("FROM MAS_SIM_RPT_MST B1" ).append("\n"); 
