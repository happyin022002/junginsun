 ...
 *@FileName : ESM_PRI_0002HTMLAction.java
...
public class ESM_PRI_0002HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0002Event event = new EsmPri0002Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setPriSgMnVO((PriSgMnVO) getVO(request, PriSgMnVO.class));
