...
*@FileName : Kor24ManifestListDBDAOmodifyCorrInfoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyCorrInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyCorrInfoUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyCorrInfoUSQL").append("\n");
		query.append("*/").append("\n");
	}
