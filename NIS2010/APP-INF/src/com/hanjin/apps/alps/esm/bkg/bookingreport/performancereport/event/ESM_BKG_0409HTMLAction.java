...
*@FileName : ESM_BKG_0409HTMLAction.java
...
public class ESM_BKG_0409HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0409HTMLAction 객체를 생성
	 */
	public ESM_BKG_0409HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0409Event event = new EsmBkg0409Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchDPCSPfmcErrorListVO((SearchDPCSPfmcErrorListVO)getVO(request, SearchDPCSPfmcErrorListVO .class));
