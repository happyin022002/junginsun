...
*@FileName : ModelManageDBDAOUpdateSmpCtrtFcastOfcMapgAmendUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAOUpdateSmpCtrtFcastOfcMapgAmendUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ModelManageDBDAOUpdateSmpCtrtFcastOfcMapgAmendUSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAOUpdateSmpCtrtFcastOfcMapgAmendUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SPC_CTRT_FCAST_OFC_MAPG" ).append("\n"); 
