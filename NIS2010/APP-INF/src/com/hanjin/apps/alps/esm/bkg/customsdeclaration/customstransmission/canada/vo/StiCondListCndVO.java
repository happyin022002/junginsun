...
*@FileName : StiCondListCnd.java
*@FileTitle : StiCondListCndVO
*Open Issues :
*Change history :
 ...
 */
public class StiCondListCndVO extends StowageManifestCondVO {

    private static final long serialVersionUID = 1L;

    private Collection<StiCondListCndVO> models = new ArrayList<StiCondListCndVO>();
    ...
    public StiCondListCndVO() {
    }

    public StiCondListCndVO(String ibflag, String pagerows, String vvd, String allerror, String lastpol, String pol, String pod, String cntropr, String excludeca, String pageno, String tmp1, String tmp2, String tmp3, String tmp4, String tmp5, String vpsPortCd, String clptIndSeq) {
	 ...
	 * @param request
	 * @return StiCondListCndVO[]
	 */
    public StiCondListCndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StiCondListCndVO[]
	 */
    public StiCondListCndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        StiCondListCndVO model = null;
	 ...
	 * @return StiCondListCndVO[]
	 */
    public StiCondListCndVO[] getStiCondListCndVOs() {
        StiCondListCndVO[] vos = (StiCondListCndVO[]) models.toArray(new StiCondListCndVO[models.size()]);
        return vos;
    }
