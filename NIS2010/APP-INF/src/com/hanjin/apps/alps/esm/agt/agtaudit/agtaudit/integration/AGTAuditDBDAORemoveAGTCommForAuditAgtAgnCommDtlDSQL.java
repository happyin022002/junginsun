...
*@FileName : AGTAuditDBDAORemoveAGTCommForAuditAgtAgnCommDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAORemoveAGTCommForAuditAgtAgnCommDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveAGTCommForAuditAgtAgnCommDtl
	  * </pre>
	  */
	public AGTAuditDBDAORemoveAGTCommForAuditAgtAgnCommDtlDSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAORemoveAGTCommForAuditAgtAgnCommDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
