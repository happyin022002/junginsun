...
*@FileName : OPMasterDBDAOMultiHistLstFlgMasUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistLstFlgMasUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistLstFlgMasUSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistLstFlgMasUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
