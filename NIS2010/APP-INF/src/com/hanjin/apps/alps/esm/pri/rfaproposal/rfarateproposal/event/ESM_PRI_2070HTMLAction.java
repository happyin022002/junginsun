 ...
 *@FileName : ESM_PRI_2070HTMLAction.java
...
public class ESM_PRI_2070HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2070HTMLAction 객체를 생성
	 */
	public ESM_PRI_2070HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2070Event event = new EsmPri2070Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setRsltRtListHorizontalExcelForAddOnTariffVOs((RsltRtListHorizontalExcelForAddOnTariffVO[]) getVOs(request,
					RsltRtListHorizontalExcelForAddOnTariffVO.class, ""));
