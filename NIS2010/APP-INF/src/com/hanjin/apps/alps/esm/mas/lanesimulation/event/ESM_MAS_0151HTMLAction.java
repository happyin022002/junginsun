...
*@FileName       : ESM_MAS_151HTMLAction.java
 ...
 *
 * @author eunju park
 * @see EsmMas0151Event  참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0151HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_MAS_0151HTMLAction 객체를 생성
     */
    public ESM_MAS_0151HTMLAction() {
    	//
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_MAS_151Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0151Event event = new EsmMas0151Event();
 	    if(command.isCommand(FormCommand.SEARCHLIST01)) {
 	    	event.setMasBnkCsmVO((MasBnkCsmVO)getVO(request, MasBnkCsmVO .class));
  	    } else if(command.isCommand(FormCommand.MULTI01)) {
  	    	event.setMasBnkCsmVOS((MasBnkCsmVO[])getVOs(request, MasBnkCsmVO .class));
  	    }else{
