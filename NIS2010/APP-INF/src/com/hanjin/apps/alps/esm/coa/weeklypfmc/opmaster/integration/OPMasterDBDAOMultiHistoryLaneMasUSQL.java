...
*@FileName : OPMasterDBDAOMultiHistoryLaneMasUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistoryLaneMasUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistoryLaneMasUSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistoryLaneMasUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_LANE_TP_HIS SET " ).append("\n"); 
