...
*@FileName : NetworkDistributionDBDAOCreateAllocationResultInterCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOCreateAllocationResultInterCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *                                                        - TS Allocation(Internal Pricing) 화면 Create, Apply To PL 버튼적용 쿼리
	  * </pre>
	  */
	public NetworkDistributionDBDAOCreateAllocationResultInterCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOCreateAllocationResultInterCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL MAS_CREATE_NTCOST_INTERPRC_PRC" ).append("\n"); 
		query.append("(" ).append("\n"); 
