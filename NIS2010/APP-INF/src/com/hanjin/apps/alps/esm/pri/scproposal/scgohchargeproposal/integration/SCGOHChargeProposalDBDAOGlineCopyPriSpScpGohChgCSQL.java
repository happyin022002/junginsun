...
*@FileName : SCGOHChargeProposalDBDAOGlineCopyPriSpScpGohChgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGOHChargeProposalDBDAOGlineCopyPriSpScpGohChgCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_SP_SCP_GOH_CHG Insert
	  * </pre>
	  */
	public SCGOHChargeProposalDBDAOGlineCopyPriSpScpGohChgCSQL(){
		setQuery();
		...
		query.append("FileName : SCGOHChargeProposalDBDAOGlineCopyPriSpScpGohChgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
