...
*@FileName : EBookingReceiptDBDAOSearchBkgBlNoInterfaceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchBkgBlNoInterfaceRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchBkgBlNoInterfaceRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOSearchBkgBlNoInterfaceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
