 ...
 * 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.panama.basic;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.panama.integration.PanamaManifestListDownloadDBDAO;
...
public class PanamaManifestListDownloadBCImpl extends ManifestListDownloadBCImpl {
	...
	public void modifySendHist(ManifestTransmitVO manifestTransmitVO, SignOnUserAccount account) throws EventException {
		try {
			...
			if ( account != null )
				panamaManifestTransmitVO.setEdiSndDt(util.searchLocalTime(account.getCnt_cd()+account.getOfc_cd().substring(0,3)));
			else
				panamaManifestTransmitVO.setEdiSndDt(util.searchLocalTime("USSAV"));
