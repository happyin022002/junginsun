...
*@FileName : NetworkCostDBDAOMultiLaneDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOMultiLaneDetailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOMultiLaneDetailUSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOMultiLaneDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_LANE_VSL_FREQ SET " ).append("\n"); 
