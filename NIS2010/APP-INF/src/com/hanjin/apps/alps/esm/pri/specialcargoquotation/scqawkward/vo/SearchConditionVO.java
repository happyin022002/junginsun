...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setPodContCd(JSPUtil.getParameter(request, prefix + "pod_cont_cd", ""));
		setTsLaneCd(JSPUtil.getParameter(request, prefix + "ts_lane_cd", ""));
		setPolContCd(JSPUtil.getParameter(request, prefix + "pol_cont_cd", ""));
		setTnkLaneCd(JSPUtil.getParameter(request, prefix + "tnk_lane_cd", ""));
		setTsPortCd(JSPUtil.getParameter(request, prefix + "ts_port_cd", ""));
		setPolPortCd(JSPUtil.getParameter(request, prefix + "pol_port_cd", ""));
		setPolCntyCd(JSPUtil.getParameter(request, prefix + "pol_cnty_cd", ""));
		setPodCntyCd(JSPUtil.getParameter(request, prefix + "pod_cnty_cd", ""));
		...
		setStayTime(JSPUtil.getParameter(request, prefix + "stay_time", ""));
