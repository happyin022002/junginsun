...
*@FileName : WeeklyCMDBDAOMasMonVvdVOChkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOMasMonVvdVOChkUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *  MAS_MON_VVD Check List 수정   
	  * </pre>
	  */
	public WeeklyCMDBDAOMasMonVvdVOChkUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOMasMonVvdVOChkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_MON_VVD" ).append("\n"); 
