 ...
 *@FileName : ESM_PRI_0112HTMLAction.java
...
public class ESM_PRI_0112HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0112Event event = new EsmPri0112Event();
