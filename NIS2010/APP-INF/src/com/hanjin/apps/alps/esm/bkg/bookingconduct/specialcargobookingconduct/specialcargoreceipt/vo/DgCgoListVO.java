...
*@FileName : DgCgoListVO.java
*@FileTitle : DgCgoListVO
*Open Issues :
*Change history :
...
public class DgCgoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L; 
	
	private Collection<DgCgoListVO> models = new ArrayList<DgCgoListVO>();
	...
	/* Column Info */
	private String dfltSegrGrpNm = null;
	/* Column Info */
	...
	/* Column Info */
	private String spclProviNo = null;
	/* Column Info */
	...
	public DgCgoListVO(String ibflag, String pagerows, String imdgCompGrpCd, String cntrVolQty, String imdgSubsRskLblCd4, String bkgNo, String dcgoSeq, String dgCntrSeq, String cntrCgoSeq, String cntrNo, String cntrTpszCd, String imdgUnNo, String imdgUnNoSeq, String spclProviNo, String imdgClssCd, String imdgSubsRskLblCd1, String imdgSubsRskLblCd2, String imdgSubsRskLblCd3, String imdgLmtQtyFlg, String imdgExptQtyFlg, String netWgt, String grsWgt, String wgtUtCd, String flshPntCdoTemp, String prpShpNm, String hzdDesc, String hzdCtnt, String dfltSegrGrpNm, String stwgTempCtnt, String measQty, String measUtCd, String clodFlg, String spclStwgRqstDesc, String dcgoStsCd, String cgoLclFlg, String emerCntcPhnNoCtnt, String emerCntcPsonNm, String emerTempCtnt, String ctrlTempCtnt, String emsNo, String emerRspnGidNo, String emerRspnGidChrNo, String imdgPckGrpCd, String mrnPolutFlg, String psaNo, String certiNo, String inImdgPckQty1, String inImdgPckCd1, String inImdgPckQty2, String inImdgPckCd2, String intmdImdgPckQty1, String intmdImdgPckCd1, String intmdImdgPckQty2, String intmdImdgPckCd2, String outImdgPckQty1, String outImdgPckCd1, String outImdgPckQty2, String outImdgPckCd2, String maxInPckQty, String maxInPckTpCd, String cneeDtlDesc, String netExploWgt, String radaSkdNo, String radaAmt, String radaUtCd, String radaTrspNo, String rcFlg, String awkCgoFlg, String bbCgoFlg, String rcSeq, String awkCgoSeq, String bbCgoSeq, String hcdgFlg, String hcdgDpndQtyFlg, String rqstDt, String rqstUsrId, String aplyNo, String spclCgoAproCd, String diffRmk, String creUsrId, String creDt, String updUsrId, String updDt, String spclRqstFlg, String spclRqstDesc, String porCd, String delCd, String rcvTermCd, String deTermCd, String eqTpsz, String inImdgPckDesc1, String inImdgPckDesc2, String intmdImdgPckDesc1, String intmdImdgPckDesc2, String outImdgPckDesc1, String outImdgPckDesc2, String imdgSpclProviNo, String crrCd, String hcdgPckRstrDesc, String hcdgIntmdBcRstrDesc, String hcdgTnkRstrDesc, String imdgMrnPolutCd, String imdgExptQtyCd, String grsCapaQty, String ltdQty, String hcdgQty, String dcgoRqstGrpEml1, String dcgoRqstGrpEml2) {
		...
		this.ltdQty = ltdQty;
		this.dfltSegrGrpNm = dfltSegrGrpNm;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dflt_segr_grp_nm", getDfltSegrGrpNm());
		...
		this.hashColumns.put("spcl_provi_no", getSpclProviNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dflt_segr_grp_nm", "dfltSegrGrpNm");
		...
		this.hashFields.put("spcl_provi_no", "spclProviNo");
	...
	/**
	 * Column Info
	 * @return dfltSegrGrpNm
	 */
	public String getDfltSegrGrpNm() {
		return this.dfltSegrGrpNm;
	}
	 ...
	 * @return spclProviNo
	 */
	public String getSpclProviNo() {
		return this.spclProviNo;
	}
	 ...
	 * @param dfltSegrGrpNm
	 */
	public void setDfltSegrGrpNm(String dfltSegrGrpNm) {
		this.dfltSegrGrpNm = dfltSegrGrpNm;
	}
	 ...
	 * @param spclProviNo
	 */
	public void setSpclProviNo(String spclProviNo) {
		this.spclProviNo = spclProviNo;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDfltSegrGrpNm(JSPUtil.getParameter(request, prefix + "dflt_segr_grp_nm", ""));
		...
		setSpclProviNo(JSPUtil.getParameter(request, prefix + "spcl_provi_no", ""));
	 ...
	 * @return DgCgoListVO[]
	 */
	public DgCgoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DgCgoListVO[]
	 */
	public DgCgoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DgCgoListVO model = null;
		...
		try {
			...
			String[] dfltSegrGrpNm = (JSPUtil.getParameter(request, prefix	+ "dflt_segr_grp_nm", length));
			...
			String[] spclProviNo = (JSPUtil.getParameter(request, prefix	+ "spcl_provi_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (dfltSegrGrpNm[i] != null)
					model.setDfltSegrGrpNm(dfltSegrGrpNm[i]);
				...
				if (spclProviNo[i] != null)
					model.setSpclProviNo(spclProviNo[i]);
				if (rqstDt[i] != null)
	...
	public DgCgoListVO[] getDgCgoListVOs(){
		DgCgoListVO[] vos = (DgCgoListVO[])models.toArray(new DgCgoListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.dfltSegrGrpNm = this.dfltSegrGrpNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.spclProviNo = this.spclProviNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
