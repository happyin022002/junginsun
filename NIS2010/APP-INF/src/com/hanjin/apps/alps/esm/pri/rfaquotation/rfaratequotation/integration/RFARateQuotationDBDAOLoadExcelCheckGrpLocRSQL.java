...
*@FileName : RFARateQuotationDBDAOLoadExcelCheckGrpLocRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOLoadExcelCheckGrpLocRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LoadExcelCheckGrpLoc
	  * </pre>
	  */
	public RFARateQuotationDBDAOLoadExcelCheckGrpLocRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOLoadExcelCheckGrpLocRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
