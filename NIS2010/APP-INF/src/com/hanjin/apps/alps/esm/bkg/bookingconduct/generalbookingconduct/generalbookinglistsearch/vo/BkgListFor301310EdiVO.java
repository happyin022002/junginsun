...
*@FileName : BkgListFor301310EdiVO.java
*@FileTitle : BkgListFor301310EdiVO
*Open Issues :
*Change history :
...
public class BkgListFor301310EdiVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgListFor301310EdiVO> models = new ArrayList<BkgListFor301310EdiVO>();
	...
	/* Column Info */
	private String isaNo = null;
	/* Column Info */
	private String xterRqstViaCd = null;
	/* Column Info */
	private String tp301 = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("isa_no", getIsaNo());
		this.hashColumns.put("tp_301", getTp301());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("isa_no", "isaNo");
		this.hashFields.put("tp_301", "tp301");
	 ...
	 * @param tp301
	 */
	public void setTp301(String tp301) {
		this.tp301 = tp301;
	}
	 ...
	 * @param isaNo
	 */
	public void setIsaNo(String isaNo) {
		this.isaNo = isaNo;
	}
	/**
	 * Column Info
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIsaNo(JSPUtil.getParameter(request, "isa_no", ""));
		setTp301(JSPUtil.getParameter(request, "tp_301", ""));
	 ...
	 * @param request
	 * @return BkgListFor301310EdiVO[]
	 */
	public BkgListFor301310EdiVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgListFor301310EdiVO[]
	 */
	public BkgListFor301310EdiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgListFor301310EdiVO model = null;
		...
		try {
			...
			String[] isaNo = (JSPUtil.getParameter(request, prefix	+ "isa_no", length));
			String[] tp301 = (JSPUtil.getParameter(request, prefix	+ "tp_301", length));
			String[] xterRqstViaCd = (JSPUtil.getParameter(request, prefix	+ "xter_rqst_via_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new BkgListFor301310EdiVO();
				if (porCd[i] != null)
		...
		return getBkgListFor301310EdiVOs();
	}
	 ...
	 * @return BkgListFor301310EdiVO[]
	 */
	public BkgListFor301310EdiVO[] getBkgListFor301310EdiVOs(){
		BkgListFor301310EdiVO[] vos = (BkgListFor301310EdiVO[])models.toArray(new BkgListFor301310EdiVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.isaNo = this.isaNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.tp301 = this.tp301 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
