...
*@FileName : RFARateQuotationDBDAOPriRqRtAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtAllDSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
