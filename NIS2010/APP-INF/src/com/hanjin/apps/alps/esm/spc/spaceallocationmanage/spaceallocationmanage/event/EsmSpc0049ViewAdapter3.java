...
*@FileName : EsmSpc0049ViewAdapter3.java
*@FileTitle : EsmSpc0049ViewAdapter3
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmSpc0049ViewAdapter3 extends DefaultViewAdapter {
	
    public EsmSpc0049ViewAdapter3(){
    	super();
    }
