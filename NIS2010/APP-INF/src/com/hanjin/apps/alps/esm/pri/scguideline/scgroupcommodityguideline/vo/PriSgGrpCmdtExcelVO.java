...
*@FileName : PriSgGrpCmdtExcelVO.java
*@FileTitle : PriSgGrpCmdtExcelVO
*Open Issues :
*Change history :
...
public class PriSgGrpCmdtExcelVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSgGrpCmdtExcelVO> models = new ArrayList<PriSgGrpCmdtExcelVO>();
	...
	public PriSgGrpCmdtExcelVO() {}

	public PriSgGrpCmdtExcelVO(String ibflag, String pagerows, String prcGrpCmdtCd, String prcGrpCmdtDesc, String prcCmdtDefCd, String cmdtNm) {
		this.ibflag = ibflag;
		this.cmdtNm = cmdtNm;
	...
	public PriSgGrpCmdtExcelVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public PriSgGrpCmdtExcelVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSgGrpCmdtExcelVO model = null;
		...
		return getPriSgGrpCmdtExcelVOs();
	}

	public PriSgGrpCmdtExcelVO[] getPriSgGrpCmdtExcelVOs(){
		PriSgGrpCmdtExcelVO[] vos = (PriSgGrpCmdtExcelVO[])models.toArray(new PriSgGrpCmdtExcelVO[models.size()]);
		return vos;
	}
