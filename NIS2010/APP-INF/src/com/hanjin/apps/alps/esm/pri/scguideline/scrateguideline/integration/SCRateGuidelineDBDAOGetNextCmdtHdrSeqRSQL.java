...
*@FileName : SCRateGuidelineDBDAOGetNextCmdtHdrSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOGetNextCmdtHdrSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOGetNextCmdtHdrSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateGuidelineDBDAOGetNextCmdtHdrSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL((SELECT /*+ INDEX_DESC(A XPKPRI_SG_RT_CMDT_HDR) */" ).append("\n"); 
