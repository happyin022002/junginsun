...
public class BookingHistoryMgtDBDAOSearchBkgContainerRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", TO_CHAR(CGO_RCV_DT, 'YYYY-MM-DD HH24:MI') CGO_RCV_DT" ).append("\n"); 
		...
		query.append(", TO_CHAR(VGM_VRFY_DT, 'YYYY-MM-DD') VGM_VRFY_DT" ).append("\n"); 
		query.append(", TO_CHAR(VGM_DTMN_DT, 'YYYY-MM-DD') VGM_DTMN_DT" ).append("\n"); 
