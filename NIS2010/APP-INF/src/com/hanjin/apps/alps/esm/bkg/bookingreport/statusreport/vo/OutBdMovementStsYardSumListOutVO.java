...
public class OutBdMovementStsYardSumListOutVO extends AbstractValueObject {
	...
	public OutBdMovementStsYardSumListOutVO(String ibflag, String pagerows, String orgYdCd, String opDr2, String opDr4, String opRf2, String opRf4, String ocDr2, String ocDr4, String ocRf2, String ocRf4, String etnDr2, String etnDr4, String etnRf2, String etnRf4, String mtDr2, String mtDr4, String mtRf2, String mtRf4, String otDr2, String otDr4, String otRf2, String otRf4, String trdCd, String subTrdCd, String rlaneCd, String subStr, String vvdCd) {
		this.otDr4 = otDr4;
		this.mtDr2 = mtDr2;
		this.ocDr2 = ocDr2;
		this.mtDr4 = mtDr4;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sub_str", getSubStr());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sub_str", "subStr");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSubStr(JSPUtil.getParameter(request, "sub_str", ""));
		setSubStr(JSPUtil.getParameter(request, "vvd_cd", ""));
	}
	...
	public OutBdMovementStsYardSumListOutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] subStr = (JSPUtil.getParameter(request, prefix	+ "sub_str", length));
	...
	*/
	public void unDataFormat(){
		...
		this.subStr = this.subStr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
