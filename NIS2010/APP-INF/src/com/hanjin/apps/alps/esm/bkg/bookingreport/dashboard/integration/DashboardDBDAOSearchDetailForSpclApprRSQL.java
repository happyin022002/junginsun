...
*@FileName : DashboardDBDAOSearchDetailForSpclApprRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2014.01.04
*@LastModifier : 
*@LastVersion : 1.0
* 2014.01.04 
* 1.0 Creation
...
public class DashboardDBDAOSearchDetailForSpclApprRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * General + Special Cargo Approval Detail 항목을 조회한다.
	  * </pre>
	  */
	public DashboardDBDAOSearchDetailForSpclApprRSQL(){
		setQuery();
		...
		query.append("FileName : DashboardDBDAOSearchDetailForSpclApprRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", ( SELECT COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01955', SPCL_CGO_APRO_CD) AWK_CGO_CD" ).append("\n"); 
		query.append("      FROM BKG_AWK_CGO D" ).append("\n"); 
		query.append("     WHERE 1=1" ).append("\n"); 
		query.append("       AND A.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("       AND SPCL_CGO_APRO_CD IN ('N','P')" ).append("\n"); 
		query.append("       AND ROWNUM=1) AS AWK_CGO_CD" ).append("\n"); 
		query.append(", ( SELECT COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01955', SPCL_CGO_APRO_CD) AWK_CGO_CD" ).append("\n"); 
		query.append("      FROM BKG_BB_CGO D" ).append("\n"); 
		query.append("     WHERE 1=1" ).append("\n"); 
		query.append("       AND A.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("       AND SPCL_CGO_APRO_CD IN ('N','P')" ).append("\n"); 
		query.append("       AND ROWNUM=1) AS BB_CGO_CD" ).append("\n"); 
		query.append(", ( SELECT COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01955', SPCL_CGO_APRO_CD) AWK_CGO_CD" ).append("\n"); 
		query.append("      FROM BKG_RF_CGO D" ).append("\n"); 
		query.append("     WHERE 1=1" ).append("\n"); 
		query.append("       AND A.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("       AND SPCL_CGO_APRO_CD IN ('N','P')" ).append("\n"); 
		query.append("       AND ROWNUM=1) AS RF_CGO_CD" ).append("\n"); 
		query.append(", ( SELECT COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01955', SPCL_CGO_APRO_CD) DG_CGO_CD" ).append("\n"); 
		query.append("      FROM BKG_DG_CGO D" ).append("\n"); 
		query.append("     WHERE 1=1" ).append("\n"); 
		query.append("       AND A.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("       AND SPCL_CGO_APRO_CD IN ('N','P')" ).append("\n"); 
		query.append("       AND ROWNUM=1) AS DG_CGO_CD" ).append("\n"); 
		query.append(", ( SELECT " ).append("\n"); 
