...
*@FileName : PerformanceReportDBDAOSearchProductionRatioByOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchProductionRatioByOfficeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Production Ratio Report - Office별 결과를 조회한다.
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchProductionRatioByOfficeRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchProductionRatioByOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
