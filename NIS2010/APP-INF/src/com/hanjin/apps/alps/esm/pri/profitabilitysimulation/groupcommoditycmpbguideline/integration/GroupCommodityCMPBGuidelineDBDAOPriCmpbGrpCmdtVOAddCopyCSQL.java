...
*@FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOAddCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOAddCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOAddCopyCSQL(){
		setQuery();
		...
		query.append("FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVOAddCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_CMPB_GRP_CMDT (" ).append("\n"); 
