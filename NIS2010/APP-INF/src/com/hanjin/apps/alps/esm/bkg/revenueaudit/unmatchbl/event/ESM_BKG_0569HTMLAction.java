...
public class ESM_BKG_0569HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0569HTMLAction 객체를 생성
	 */
	public ESM_BKG_0569HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0569Event event = new EsmBkg0569Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setUnmatchSettlementListVO((UnmatchSettlementListVO)getVO(request, UnmatchSettlementListVO .class));
		}
