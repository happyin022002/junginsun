...
*@FileName : CustomEmailAddressVO.java
*@FileTitle : CustomEmailAddressVO
*Open Issues :
*Change history :
...
public class CustomEmailAddressVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomEmailAddressVO> models = new ArrayList<CustomEmailAddressVO>();
	...
	public CustomEmailAddressVO() {}

	public CustomEmailAddressVO(String ibflag, String pagerows, String emlSeq, String cntcPsonNm, String cntcPsonEml, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public CustomEmailAddressVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomEmailAddressVO[]
	 */
	public CustomEmailAddressVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomEmailAddressVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CustomEmailAddressVO();
				if (updDt[i] != null)
		...
		return getCustomEmailAddressVOs();
	}
	...
	public CustomEmailAddressVO[] getCustomEmailAddressVOs(){
		CustomEmailAddressVO[] vos = (CustomEmailAddressVO[])models.toArray(new CustomEmailAddressVO[models.size()]);
		return vos;
	}
