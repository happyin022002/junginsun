...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_TP_CD " ).append("\n"); 
		query.append("				                 ,'O', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("				                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N5TH_CO_AMT,'O|BIZ',                   " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N5TH_HJS_SLS_AMT, A2.N5TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N5TH_ESTM_PL_AMT, A2.N5TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("				                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("				                              ) " ).append("\n"); 
		query.append("				                 ,0 " ).append("\n"); 
		query.append("				                 ) " ).append("\n"); 
		...
		query.append("	" ).append("\n"); 
		query.append("                 SELECT A1.TRD_CD" ).append("\n"); 
		query.append("                      , A1.DIR_CD HUL_BND_CD" ).append("\n"); 
		query.append("                      , 0 AS VOYAGE" ).append("\n"); 
		query.append("                      , 0 AS SUPPLY" ).append("\n"); 
		query.append("                      , 0 AS LOAD_TEU" ).append("\n"); 
		query.append("                      , 0 AS REVENUE" ).append("\n"); 
