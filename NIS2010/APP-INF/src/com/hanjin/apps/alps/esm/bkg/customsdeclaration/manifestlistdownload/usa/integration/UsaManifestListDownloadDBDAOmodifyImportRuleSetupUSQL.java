...
*@FileName : UsaManifestListDownloadDBDAOmodifyImportRuleSetupUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOmodifyImportRuleSetupUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOmodifyImportRuleSetupUSQL(){
		setQuery();
		...
		params.put("xpt_imp_ref_flg7",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : UsaManifestListDownloadDBDAOmodifyImportRuleSetupUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	xpt_imp_ref_flg6 = DECODE(NVL(@[xpt_imp_ref_flg6],'N'), 1, 'Y', 'N'), --Tax ID" ).append("\n"); 
		query.append("	xpt_imp_ref_flg7 = DECODE(NVL(@[xpt_imp_ref_flg7],'N'), 1, 'Y', 'N'), --IEC  " ).append("\n"); 
