...
*@FileName : TransferOrderIssueDBDAOcopyTroSpclCgoSeqBySplitCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOcopyTroSpclCgoSeqBySplitCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * copyTroSpclCgoSeqBySplit
	  * </pre>
	  */
	public TransferOrderIssueDBDAOcopyTroSpclCgoSeqBySplitCSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOcopyTroSpclCgoSeqBySplitCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO BKG_TRO_SPCL_CGO_SEQ" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(",A.TRO_SPCL_CGO_SEQ" ).append("\n"); 
		query.append(",A.SPCL_CGO_CD" ).append("\n"); 
		query.append(",A.SPCL_CGO_SEQ" ).append("\n"); 
		query.append(",@[usr_id]" ).append("\n"); 
		query.append(",SYSDATE" ).append("\n"); 
		query.append(",@[usr_id]" ).append("\n"); 
		query.append(",SYSDATE" ).append("\n"); 
		query.append("FROM BKG_TRO_SPCL_CGO_SEQ A" ).append("\n"); 
