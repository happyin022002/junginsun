...
*@FileName : SearchSpaceControlInquiryCustomerListVO.java
*@FileTitle : SearchSpaceControlInquiryCustomerListVO
*Open Issues :
*Change history :
...
public class SearchSpaceControlInquiryCustomerListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSpaceControlInquiryCustomerListVO> models = new ArrayList<SearchSpaceControlInquiryCustomerListVO>();
...
/**
	 ...
	 */
	public SearchSpaceControlInquiryCustomerListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSpaceControlInquiryCustomerListVO[]
	 */
	public SearchSpaceControlInquiryCustomerListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSpaceControlInquiryCustomerListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSpaceControlInquiryCustomerListVO();
				if (fctWgt[i] != null)
		...
		return getSearchSpaceControlInquiryCustomerListVOs();
	}
	...
	public SearchSpaceControlInquiryCustomerListVO[] getSearchSpaceControlInquiryCustomerListVOs(){
		SearchSpaceControlInquiryCustomerListVO[] vos = (SearchSpaceControlInquiryCustomerListVO[])models.toArray(new SearchSpaceControlInquiryCustomerListVO[models.size()]);
		return vos;
	}
