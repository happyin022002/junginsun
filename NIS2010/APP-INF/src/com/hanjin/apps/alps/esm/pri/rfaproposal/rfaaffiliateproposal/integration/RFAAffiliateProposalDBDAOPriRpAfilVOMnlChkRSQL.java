...
*@FileName : RFAAffiliateProposalDBDAOPriRpAfilVOMnlChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAAffiliateProposalDBDAOPriRpAfilVOMnlChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAAffiliateProposalDBDAOPriRpAfilVOMnlChkRSQL(){
		setQuery();
		...
		query.append("FileName : RFAAffiliateProposalDBDAOPriRpAfilVOMnlChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
