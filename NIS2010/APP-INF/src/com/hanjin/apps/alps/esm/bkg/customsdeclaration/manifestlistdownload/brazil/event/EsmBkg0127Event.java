...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.brazil.vo.BrManifestListDetailVO;
...
public class EsmBkg0127Event extends EventSupport {
	...
	/**
	 * @param brManifestListCondVO the brManifestListCondVO to set
	 */
	...
	/**
	 * @param brManifestListDetailVO the brManifestListDetailVO to set
	 */
	public void setBrManifestListDetailVO(
			BrManifestListDetailVO brManifestListDetailVO) {
	...
	/**
	 * @param brCmModiVOs the brCmModiVOs to set
	 */
	public void setBrCmModiVOs(BrCmModiVO[] brCmModiVOs){
		if(brCmModiVOs != null){
			BrCmModiVO[] tmpVOs = Arrays.copyOf(brCmModiVOs, brCmModiVOs.length);
			this.brCmModiVOs = tmpVOs;
		}
	}
	...
	public BrCnpiNcmByCntrModiVO[] getBrCnpiNcmByCntrModiVOs() {
		...
		if (this.brCnpiNcmByCntrModiVOs != null) {
	...
	/**
	 * @param brCnpiNcmByCntrModiVOs the brCnpiNcmByCntrModiVOs to set
	 */
	public void setBrCnpiNcmByCntrModiVOs(BrCnpiNcmByCntrModiVO[] brCnpiNcmByCntrModiVOs){
		if(brCnpiNcmByCntrModiVOs != null){
			BrCnpiNcmByCntrModiVO[] tmpVOs = Arrays.copyOf(brCnpiNcmByCntrModiVOs, brCnpiNcmByCntrModiVOs.length);
			this.brCnpiNcmByCntrModiVOs = tmpVOs;
		}
	}
	...
	/**
	 * @param brManifestTransmitVO the brManifestTransmitVO to set
	 */
	...
	public BrManifestTransmitVO[] getBrManifestTransmitVOs() {
		...
		if (this.brManifestTransmitVOs != null) {
	...
	/**
	 * @param brManifestTransmitVOs the brManifestTransmitVOs to set
	 */
	public void setBrManifestTransmitVOs(BrManifestTransmitVO[] brManifestTransmitVOs){
		if(brManifestTransmitVOs != null){
			BrManifestTransmitVO[] tmpVOs = Arrays.copyOf(brManifestTransmitVOs, brManifestTransmitVOs.length);
			this.brManifestTransmitVOs = tmpVOs;
		}
	}
