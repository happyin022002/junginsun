...
public class Kor24BkgCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24BkgCustVO> models = new ArrayList<Kor24BkgCustVO>();
	...
	public Kor24BkgCustVO() {}

	public Kor24BkgCustVO(String ibflag, String pagerows, String cBcsTp, String cCntCd, String cCustCd, String cCustName, String cCustAddr, String cCustTel) {
		this.cCntCd = cCntCd;
		this.ibflag = ibflag;
	 ...
	 */
	public Kor24BkgCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCustomerInfoVO[]
	 */
	public Kor24BkgCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BkgCustVO model = null;
	 ...
	 * @return SearchCustomerInfoVO[]
	 */
	public Kor24BkgCustVO[] getSearchCustomerInfoVOs(){
		Kor24BkgCustVO[] vos = (Kor24BkgCustVO[])models.toArray(new Kor24BkgCustVO[models.size()]);
		return vos;
	}
