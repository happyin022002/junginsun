...
*@FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVODSQL.java
...
public class SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVODSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplHdrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from pri_sg_blpl_hdr" ).append("\n"); 
		query.append("" ).append("\n"); 
