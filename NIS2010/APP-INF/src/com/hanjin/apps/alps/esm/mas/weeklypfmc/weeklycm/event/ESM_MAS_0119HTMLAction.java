...
*@FileName : ESM_MAS_0119HTMLAction.java
...
public class ESM_MAS_0119HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0119HTMLAction 객체를 생성
	 */
	public ESM_MAS_0119HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0119Event event = new EsmMas0119Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMasTmlTrfGrpVOS((MasTmlTrfGrpVO[])getVOs(request, MasTmlTrfGrpVO .class,""));
		}
