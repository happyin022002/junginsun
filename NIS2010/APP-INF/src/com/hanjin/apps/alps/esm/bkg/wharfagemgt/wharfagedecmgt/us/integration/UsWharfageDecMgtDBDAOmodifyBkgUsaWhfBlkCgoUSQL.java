...
*@FileName : UsWharfageDecMgtDBDAOmodifyBkgUsaWhfBlkCgoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOmodifyBkgUsaWhfBlkCgoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyBkgUsaWhfBlkCgo
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOmodifyBkgUsaWhfBlkCgoUSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOmodifyBkgUsaWhfBlkCgoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_USA_WHF_BLK_CGO SET" ).append("\n"); 
		query.append("CMDT_DESC = @[cmdt_desc]" ).append("\n"); 
		query.append(",	USA_WHF_RAT_UT_CD = @[usa_whf_rat_ut_cd]" ).append("\n"); 
