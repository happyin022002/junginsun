...
*@FileName : VesselVVDListVO.java
*@FileTitle : VesselVVDListVO
*Open Issues :
*Change history :
...
public class VesselVVDListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VesselVVDListVO> models = new ArrayList<VesselVVDListVO>();
	 ...
	 */
	public VesselVVDListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VesselVVDListVO[]
	 */
	public VesselVVDListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VesselVVDListVO model = null;
	...
	public VesselVVDListVO[] getVesselVVDListVOs(){
		VesselVVDListVO[] vos = (VesselVVDListVO[])models.toArray(new VesselVVDListVO[models.size()]);
		return vos;
	}
