...
*@FileName : ESM_BKG_0947HTMLAction.java
...
public class ESM_BKG_0947HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0947HTMLAction 객체를 생성
     */
    public ESM_BKG_0947HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0947Event event = new EsmBkg0947Event();
        ...
        if(command.isCommand(FormCommand.INIT) || command.isCommand(FormCommand.SEARCH)) {
            ...
            event.setDispoCdDetailVOs((DispoCdDetailVO[])getVOs(request, DispoCdDetailVO.class));
        }
