...
*@FileName : AuthorizationAssignmentDBDAOUsrAuthHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AuthorizationAssignmentDBDAOUsrAuthHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_AUTH_APRO_USR_HIS 테이블 INSERT
	  * </pre>
	  */
	public AuthorizationAssignmentDBDAOUsrAuthHisCSQL(){
		setQuery();
		...
		query.append("FileName : AuthorizationAssignmentDBDAOUsrAuthHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_AUTH_APRO_USR_HIS" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("		 			(SELECT NVL(MAX(AUTH_APRO_HIS_SEQ),0)+1 FROM PRI_AUTH_APRO_USR_HIS)" ).append("\n"); 
		query.append("				  , @[prc_ctrt_tp_cd]" ).append("\n"); 
		query.append("				  , @[prc_usr_auth_tp_cd]" ).append("\n"); 
		query.append("				  , @[auth_apro_usr_id]" ).append("\n"); 
		query.append("				  , @[auth_apro_usr_ofc_cd]" ).append("\n"); 
