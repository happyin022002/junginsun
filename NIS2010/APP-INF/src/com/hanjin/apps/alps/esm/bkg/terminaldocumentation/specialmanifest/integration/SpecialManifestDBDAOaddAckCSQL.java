...
public class SpecialManifestDBDAOaddAckCSQL implements ISQLTemplate{
	...
	public SpecialManifestDBDAOaddAckCSQL(){
		...
		params.put("msg_ack_ref_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("msg_ack_cd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("	,MSG_KEY_CTNT" ).append("\n"); 
		query.append("	,VVD_CD" ).append("\n"); 
		query.append("	,IO_BND_CD" ).append("\n"); 
		query.append("	,PORT_CD" ).append("\n"); 
		query.append("    ,MSG_ACK_CD" ).append("\n"); 
		query.append("    ,MSG_ACK_REF_NO" ).append("\n"); 
		...
		query.append("    ,@[upd_usr_id]" ).append("\n"); 
		query.append("    ,SYSDATE  " ).append("\n"); 
		query.append("	,@[org_msg_key]" ).append("\n"); 
		query.append("	,@[vvd_cd]" ).append("\n"); 
		query.append("	,@[io_bnd_cd]" ).append("\n"); 
		query.append("	,@[port_cd]" ).append("\n"); 
		query.append("    ,@[msg_ack_cd]" ).append("\n"); 
