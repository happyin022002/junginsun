...
public class BLIssuanceDBDAOAddOblRcvByIbdCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL', SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[otr_doc_rcv_ofc_cd]))" ).append("\n"); 
		query.append(", @[ibd_doc_rcv_flg]" ).append("\n"); 
		query.append(", @[ibd_doc_rcv_ofc_cd]    -- Login Office Code" ).append("\n"); 
		query.append(", @[ibd_doc_rcv_usr_id]    -- Login User ID" ).append("\n"); 
		query.append(", GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL', SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[ibd_doc_rcv_ofc_cd]))" ).append("\n"); 
