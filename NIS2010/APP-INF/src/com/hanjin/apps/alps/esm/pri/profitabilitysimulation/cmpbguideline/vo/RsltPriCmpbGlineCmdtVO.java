...
*@FileName : RsltPriCmpbGlineCmdtVO.java
*@FileTitle : RsltPriCmpbGlineCmdtVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGlineCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGlineCmdtVO> models = new ArrayList<RsltPriCmpbGlineCmdtVO>();
	...
	public RsltPriCmpbGlineCmdtVO() {}

	public RsltPriCmpbGlineCmdtVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq, String cmdtSeq, String prcCmdtTpCd, String prcCmdtDefCd, String creUsrId, String creDt, String updUsrId, String updDt, String prcCmdtDefNm) {
		this.updDt = updDt;
		this.bseSeq = bseSeq;
	 ...
	 * @param request
	 * @return RsltPriCmpbGlineCmdtVO[]
	 */
	public RsltPriCmpbGlineCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGlineCmdtVO[]
	 */
	public RsltPriCmpbGlineCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGlineCmdtVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGlineCmdtVO();
				if (updDt[i] != null)
		...
		return getRsltPriCmpbGlineCmdtVOs();
	}
	 ...
	 * @return RsltPriCmpbGlineCmdtVO[]
	 */
	public RsltPriCmpbGlineCmdtVO[] getRsltPriCmpbGlineCmdtVOs(){
		RsltPriCmpbGlineCmdtVO[] vos = (RsltPriCmpbGlineCmdtVO[])models.toArray(new RsltPriCmpbGlineCmdtVO[models.size()]);
		return vos;
	}
