...
*@FileName : Jp24ManifestListDownloadDBDAOAddAdvJpCustomerCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24ManifestListDownloadDBDAOAddAdvJpCustomerCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24ManifestListDownloadDBDAOAddAdvJpCustomerCSQL(){
		setQuery();
		...
		query.append("FileName : Jp24ManifestListDownloadDBDAOAddAdvJpCustomerCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_ADV_JP_CUST" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("        @[cust_cnt_cd]," ).append("\n"); 
		query.append("        @[cust_nm]," ).append("\n"); 
		query.append("        DECODE(@[cust_addr], '', @[cust_nm], @[cust_addr])," ).append("\n"); 
		query.append("        @[cust_zip_id]," ).append("\n"); 
		query.append("        NVL(@[phn_no], (SELECT OFC_PHN_NO" ).append("\n"); 
