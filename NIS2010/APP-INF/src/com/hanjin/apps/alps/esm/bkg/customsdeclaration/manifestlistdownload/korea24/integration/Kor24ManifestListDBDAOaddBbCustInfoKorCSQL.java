...
*@FileName : Kor24ManifestListDBDAOaddBbCustInfoKorCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOaddBbCustInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOaddBbCustInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOaddBbCustInfoKorCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                    FROM BKG_CSTMS_ADV_KR_BL BB,MDM_LOCATION A1, MDM_COUNTRY B1, MDM_LOCATION A2, MDM_COUNTRY B2" ).append("\n"); 
