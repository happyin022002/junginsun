...
*@FileName : RFADurationProposalDBDAOPropCpPriRpDurCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFADurationProposalDBDAOPropCpPriRpDurCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Copy PRI_RP_DUR Insert
	  * </pre>
	  */
	public RFADurationProposalDBDAOPropCpPriRpDurCSQL(){
		setQuery();
		...
		query.append("FileName : RFADurationProposalDBDAOPropCpPriRpDurCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
