...
/**
 * ESM_PRI_7031 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_PRI_7031HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author SEO MI JIN
 * @see ESM_PRI_7031HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmPri7031Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	public EsmPri7031Event(){}
