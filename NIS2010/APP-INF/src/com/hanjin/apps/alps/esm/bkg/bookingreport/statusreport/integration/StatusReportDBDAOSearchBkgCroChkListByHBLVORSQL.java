...
*@FileName : StatusReportDBDAOSearchBkgCroChkListByHBLVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOSearchBkgCroChkListByHBLVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * House B/L에 따른 Cross check 리스트를 조회해 온다.
	  * </pre>
	  */
	public StatusReportDBDAOSearchBkgCroChkListByHBLVORSQL(){
		setQuery();
		...
		query.append("FileName : StatusReportDBDAOSearchBkgCroChkListByHBLVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         ,DECODE(C.CNTR_MF_NO, NULL, 'N', 'Y') CM_DS" ).append("\n"); 
		...
		query.append("                      WHEN NVL(H_S.CUST_NM,'N') = 'N' AND (POL_V.SHPR_NM_FLG = 'E' OR POD_V.SHPR_NM_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.SHPR_NM_FLG, POD_V.SHPR_NM_FLG) END  AS B_CUST_NM_S" ).append("\n"); 
		query.append("                      " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(H_S.CUST_ADDR,'N') <> 'N'  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN NVL(H_S.CUST_ADDR,'N') = 'N' AND (POL_V.SHPR_ADDR_FLG = 'E' OR POD_V.SHPR_ADDR_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.SHPR_ADDR_FLG, POD_V.SHPR_ADDR_FLG) END  AS B_CUST_ADDR_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_S.CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					  WHEN NVL(H_S.CTY_NM,'N') = 'N' AND (POL_V.SHPR_CTY_FLG = 'E' OR POD_V.SHPR_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					  ELSE NVL(POL_V.SHPR_CTY_FLG, POD_V.SHPR_CTY_FLG) END  AS B_CUST_CT_S" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_S.CUST_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					  WHEN NVL(H_S.CUST_CNT_CD,'N') = 'N' AND (POL_V.SHPR_CNT_FLG= 'E' OR POD_V.SHPR_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					  ELSE NVL(POL_V.SHPR_CNT_FLG, POD_V.SHPR_CNT_FLG) END  AS B_CUST_CN_S" ).append("\n"); 
		query.append("---------------------  CONSIGNEE	" ).append("\n"); 
		query.append("              " ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_C.CUST_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					  WHEN NVL(H_C.CUST_NM,'N') = 'N' AND (POL_V.CNEE_NM_FLG = 'E' OR POD_V.CNEE_NM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					  ELSE NVL(POL_V.CNEE_NM_FLG, POD_V.CNEE_NM_FLG) END  AS B_CUST_NM_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_C.CUST_ADDR,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					  WHEN NVL(H_C.CUST_ADDR,'N') = 'N' AND (POL_V.CNEE_ADDR_FLG = 'E' OR POD_V.CNEE_ADDR_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					  ELSE NVL(POL_V.CNEE_ADDR_FLG, POD_V.CNEE_ADDR_FLG) END  AS B_CUST_ADDR_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_C.CTY_NM,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					  WHEN NVL(H_C.CTY_NM,'N') = 'N' AND (POL_V.CNEE_CTY_FLG = 'E' OR POD_V.CNEE_CTY_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					  ELSE NVL(POL_V.CNEE_CTY_FLG, POD_V.CNEE_CTY_FLG) END  AS B_CUST_CT_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_C.STE_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					 WHEN NVL(H_C.STE_CD,'N') = 'N' AND (POL_V.CNEE_STE_FLG = 'E' OR POD_V.CNEE_STE_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					 ELSE NVL(POL_V.CNEE_STE_FLG, POD_V.CNEE_STE_FLG) END  AS B_CUST_ST_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			  ,CASE WHEN NVL(H_C.CUST_CNT_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("					 WHEN NVL(H_C.CUST_CNT_CD,'N') = 'N' AND (POL_V.CNEE_CNT_FLG = 'E' OR POD_V.CNEE_CNT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("					 ELSE NVL(POL_V.CNEE_CNT_FLG, POD_V.CNEE_CNT_FLG) END  AS B_CUST_CN_C" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("---------------------    NOTIFY     " ).append("\n"); 
		query.append("         " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(H_N.CUST_NM,'N') <> 'N'  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN NVL(H_N.CUST_NM,'N') = 'N' AND (POL_V.NTFY_NM_FLG = 'E' OR POD_V.NTFY_NM_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.NTFY_NM_FLG, POD_V.NTFY_NM_FLG) END  AS B_CUST_NM_N" ).append("\n"); 
		query.append("                            " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(H_N.CUST_ADDR,'N') <> 'N'  THEN  'Y' " ).append("\n"); 
		query.append("                      WHEN NVL(H_N.CUST_ADDR,'N') = 'N' AND (POL_V.NTFY_ADDR_FLG = 'E' OR POD_V.NTFY_ADDR_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(POL_V.NTFY_ADDR_FLG, POD_V.NTFY_ADDR_FLG) END  AS B_CUST_ADDR_N" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("              ,CASE WHEN NVL(HBL.PCK_QTY,0) = NVL(VVD.CM_PCK,0)  THEN  'Y'" ).append("\n"); 
		query.append("                      WHEN (POL_V.CNTR_PCK_FLG = 'E' OR POD_V.CNTR_PCK_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(NVL(POL_V.CNTR_PCK_FLG, POD_V.CNTR_PCK_FLG),'N') END  AS B_PCK_QTY_CHK" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(HBL.HBL_WGT,0)  = NVL(VVD.CM_WGT,0)  THEN  'Y'" ).append("\n"); 
		query.append("                      WHEN (POL_V.CNTR_WGT_FLG = 'E' OR POD_V.CNTR_WGT_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(NVL(POL_V.CNTR_WGT_FLG, POD_V.CNTR_WGT_FLG),'N') END  AS B_HBL_WGT_CHK" ).append("\n"); 
		query.append("                            " ).append("\n"); 
		query.append("              ,CASE WHEN NVL(HBL.CMDT_MEAS_QTY,0) = NVL(VVD.CM_MEAS,0)  THEN  'Y'" ).append("\n"); 
		query.append("                      WHEN (POL_V.CNTR_MEAS_FLG = 'E' OR POD_V.CNTR_MEAS_FLG = 'E') THEN 'E' " ).append("\n"); 
		query.append("                      ELSE NVL(NVL(POL_V.CNTR_MEAS_FLG, POD_V.CNTR_MEAS_FLG),'N') END  AS B_MEAS_QTY_CHK" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                	WHEN NVL(VVD.CM_MK,'N') = 'N' AND (POL_V.CNTR_MF_MK_FLG = 'E' OR POD_V.CNTR_MF_MK_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_MK_FLG, POD_V.CNTR_MF_MK_FLG) END  AS B_CNTR_MF_MK_DESC" ).append("\n"); 
		query.append("          " ).append("\n"); 
		query.append("          	  ,CASE WHEN NVL(VVD.CM_DS,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(VVD.CM_DS,'N') = 'N' AND (POL_V.CNTR_MF_DESC_FLG= 'E' OR POD_V.CNTR_MF_DESC_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_DESC_FLG, POD_V.CNTR_MF_DESC_FLG) END  AS B_CNTR_MF_GDS_DESC" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("              ,NVL(VVD.CM_AMS,'N')                              AS B_CNTR_MF_NO" ).append("\n"); 
		...
		query.append("                	WHEN NVL(VVD.HAMO_TRF_CD,'N') = 'N' AND (POL_V.CNTR_MF_CMDT_FLG = 'E' OR POD_V.CNTR_MF_CMDT_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_CMDT_FLG, POD_V.CNTR_MF_CMDT_FLG) END  AS B_CNTR_MF_HTS" ).append("\n"); 
		query.append("           " ).append("\n"); 
		query.append("           	  ,CASE WHEN NVL(VVD.CMDT_HS_CD,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(VVD.CMDT_HS_CD,'N') = 'N' AND (POL_V.CNTR_MF_NCM_FLG = 'E' OR POD_V.CNTR_MF_NCM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_NCM_FLG, POD_V.CNTR_MF_NCM_FLG) END  AS B_CNTR_MF_HS" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("           	  ,CASE WHEN NVL(VVD.NCM_NO,'N') <> 'N'  THEN  'Y'" ).append("\n"); 
		query.append("                	WHEN NVL(VVD.NCM_NO,'N') = 'N' AND (POL_V.CNTR_MF_NCM_FLG = 'E' OR POD_V.CNTR_MF_NCM_FLG = 'E') THEN 'E'" ).append("\n"); 
		query.append("                	ELSE NVL(POL_V.CNTR_MF_NCM_FLG, POD_V.CNTR_MF_NCM_FLG) END  AS B_CNTR_MF_NCM" ).append("\n"); 
		query.append("            " ).append("\n"); 
		...
		query.append("   -- OR B_CNTR_MF_HS = 'E'" ).append("\n"); 
