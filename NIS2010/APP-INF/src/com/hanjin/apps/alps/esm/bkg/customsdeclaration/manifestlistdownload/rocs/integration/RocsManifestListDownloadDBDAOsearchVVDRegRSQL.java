...
public class RocsManifestListDownloadDBDAOsearchVVDRegRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT skd.VSL_CD||skd.SKD_VOY_NO||skd.SKD_DIR_CD vvd_number,to_char(SKD.VPS_ETA_DT,'YYYY-MM-DD') vps_eta_dt ,VSL.VSL_ENG_NM,MST.VSL_CALL_REF_NO" ).append("\n"); 
		...
		query.append("	AND mst.VSL_CALL_REF_STS_CD(+) <> 'C'" ).append("\n"); 
