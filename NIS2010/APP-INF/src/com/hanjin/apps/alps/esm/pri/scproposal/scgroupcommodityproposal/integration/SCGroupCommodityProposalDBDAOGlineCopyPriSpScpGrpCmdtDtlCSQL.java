...
*@FileName : SCGroupCommodityProposalDBDAOGlineCopyPriSpScpGrpCmdtDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAOGlineCopyPriSpScpGrpCmdtDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_SP_SCP_GRP_CMDT_DTL Insert
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAOGlineCopyPriSpScpGrpCmdtDtlCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAOGlineCopyPriSpScpGrpCmdtDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.GRP_CMDT_SEQ) AS GRP_CMDT_SEQ" ).append("\n"); 
		query.append(", DENSE_RANK() OVER(PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.GRP_CMDT_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.GRP_CMDT_SEQ, B.GRP_CMDT_DTL_SEQ) AS GRP_CMDT_DTL_SEQ" ).append("\n"); 
