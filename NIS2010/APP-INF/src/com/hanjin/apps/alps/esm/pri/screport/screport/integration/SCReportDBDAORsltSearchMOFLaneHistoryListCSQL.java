...
*@FileName : SCReportDBDAORsltSearchMOFLaneHistoryListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCReportDBDAORsltSearchMOFLaneHistoryListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Korea MOF Filing (Base Table) - Scope & Location History
	  * </pre>
	  */
	public SCReportDBDAORsltSearchMOFLaneHistoryListCSQL(){
		setQuery();
		...
		query.append("FileName : SCReportDBDAORsltSearchMOFLaneHistoryListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_MOF_LANE_MAPG_HIS" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("	@[org_dest_tp_cd]," ).append("\n"); 
		query.append("	@[mapg_seq]," ).append("\n"); 
		query.append("	(SELECT NVL(MAX(HIS_SEQ),0)+1 FROM PRI_MOF_LANE_MAPG_HIS)," ).append("\n"); 
		query.append("	@[loc_cd]," ).append("\n"); 
		query.append("	@[mof_lane_cd]," ).append("\n"); 
		query.append("	@[mof_loc_id]," ).append("\n"); 
		query.append("	@[mof_loc_nm]," ).append("\n"); 
