...
*@FileName : ESM_COA_0144HTMLAction.java
...
public class ESM_COA_0144HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0144HTMLAction 객체를 생성
	 */
	public ESM_COA_0144HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0144Event event = new EsmCoa0144Event();
		

		event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setShipperVO((ShipperVO)getVO(request, ShipperVO .class));
		}
