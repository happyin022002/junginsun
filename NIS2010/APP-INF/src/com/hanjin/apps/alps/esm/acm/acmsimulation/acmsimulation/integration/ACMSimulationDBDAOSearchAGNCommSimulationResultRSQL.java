...
*@FileName : ACMSimulationDBDAOSearchAGNCommSimulationResultRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOSearchAGNCommSimulationResultRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ACMSimulationDBDAOSearchAGNCommSimulationResult
	  * </pre>
	  */
	public ACMSimulationDBDAOSearchAGNCommSimulationResultRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOSearchAGNCommSimulationResultRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("       SUM(DECODE(SIGN(INSTR('GKHSC', A.AC_TP_CD)), 1, A.PPD_AMT, 0)) AS PPD_AMT," ).append("\n"); 
		...
		query.append("       SUM(DECODE(SIGN(INSTR('GKHSC', A.AC_TP_CD)), 1, A.IF_AMT, 0)) AS USD_AMT," ).append("\n"); 
		query.append("       MAX(PAY_XCH_RT) AS PAY_XCH_RT," ).append("\n"); 
		query.append("       A.CURR_CD," ).append("\n"); 
		query.append("       SUM(DECODE(SIGN(INSTR('GKHSC', A.AC_TP_CD)), 1, PAY_IF_AMT, 0)) AS PAY_IF_AMT," ).append("\n"); 
		...
		query.append("       ACM_SIM_BKG_INFO B," ).append("\n"); 
