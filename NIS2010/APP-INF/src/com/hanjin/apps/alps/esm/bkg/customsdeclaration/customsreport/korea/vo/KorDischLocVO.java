...
*@FileName : KorDischLocVO.java
*@FileTitle : KorDischLocVO
*Open Issues :
*Change history :
...
public class KorDischLocVO extends DischLocVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDischLocVO> models = new ArrayList<KorDischLocVO>();
	...
	public KorDischLocVO() {}

	public KorDischLocVO(String ibflag, String pagerows, String otrDchgCd, String ydCd, String locCd, String locNm, String portCd, String slanCd, String skdDirCd, String edoTrsmFlg) {
	 ...
	 */
	public KorDischLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDischLocVO[]
	 */
	public KorDischLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDischLocVO model = null;
	 ...
	 * @return KorDischLocVO[]
	 */
	public KorDischLocVO[] getKorDischLocVOs(){
		KorDischLocVO[] vos = (KorDischLocVO[])models.toArray(new KorDischLocVO[models.size()]);
		return vos;
	}
