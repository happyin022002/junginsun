...
public class ArrivalNoticeDBDAOsearchManualValInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("/* Code validation 수기이행을 위해 작성된 프로그램으로 정규 프로그램이 아님 ( With 문 관리대상 아님 ) - Comment Park Mangeon */" ).append("\n"); 
		...
		query.append("AND TRIM(REPLACE(BCST.CUST_NM, CHR(10) || CHR(13) , '')) IS NOT NULL -- 고객명 없으면 처리안함 (20090716)" ).append("\n"); 
