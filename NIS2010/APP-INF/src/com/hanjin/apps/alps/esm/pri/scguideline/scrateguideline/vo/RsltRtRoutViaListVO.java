 ...
 *@FileName : OrgPriSgRtRoutViaVO.java
 *@FileTitle : OrgPriSgRtRoutViaVO
 *Open Issues :
 *Change history :
...
public class RsltRtRoutViaListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<RsltRtRoutViaListVO> models = new ArrayList<RsltRtRoutViaListVO>();
	...
	public RsltRtRoutViaListVO() {
	}

	public RsltRtRoutViaListVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String prcCustTpCd,
			String cmdtHdrSeq, String routSeq, String orgDestTpCd, String routViaSeq, String routViaPortTpCd,
			String routViaPortDefCd, String routViaPortDefNm, String creUsrId, String creDt, String updUsrId,
			String updDt) {
	...
	public RsltRtRoutViaListVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public RsltRtRoutViaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRtRoutViaListVO model = null;
		...
		try {
			...
			String[] routViaPortDefNm = (JSPUtil.getParameter(request, prefix + "rout_via_port_def_nm".trim(), length));
		...
		return getOrgPriSgRtRoutViaVOs();
	}

	public RsltRtRoutViaListVO[] getOrgPriSgRtRoutViaVOs() {
		RsltRtRoutViaListVO[] vos = (RsltRtRoutViaListVO[]) models.toArray(new RsltRtRoutViaListVO[models.size()]);
		return vos;
	}
	...
	public void onDataFormat() {
		this.routViaPortTpCd = this.routViaPortTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "")
				.replaceAll(":", "");
		...
		this.routViaSeq = this.routViaSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":",
				"");
		this.routViaPortDefNm = this.routViaPortDefNm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "")
				.replaceAll(":", "");
		this.orgDestTpCd = this.orgDestTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":",
				"");
		this.updDt = this.updDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.creDt = this.creDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.routViaPortDefCd = this.routViaPortDefCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "")
				.replaceAll(":", "");
