...
*@FileName : CustMainDBDAOCheckGrpCustCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustMainDBDAOCheckGrpCustCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Check Group Customer Code
	  * </pre>
	  */
	public CustMainDBDAOCheckGrpCustCodeRSQL(){
		setQuery();
		...
		query.append("FileName : CustMainDBDAOCheckGrpCustCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
