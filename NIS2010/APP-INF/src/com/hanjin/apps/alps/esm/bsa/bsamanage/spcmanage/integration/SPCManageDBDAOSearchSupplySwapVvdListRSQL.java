...
public class SPCManageDBDAOSearchSupplySwapVvdListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2014.01.14 김시몬 [선반영] COST_YRMON을 SLS_YRMON 으로 변경
	...
	public void setQuery(){
		...
		query.append("  NVL(C.MNL_FLG,'N') MNL_FLG ," ).append("\n"); 
		...
		query.append("  DECODE(C.VOP_CD, 'SML', '0', '1') AS VOP_FLG," ).append("\n"); 
		query.append("  C.VSL_CAPA," ).append("\n"); 
		query.append("  C.VSL_CAPA," ).append("\n"); 
		query.append("  C.BSA_CAPA," ).append("\n"); 
		query.append("  NVL(C.FNL_HJS_BSA_CAPA, 0) AS FNL_HJS_BSA_CAPA," ).append("\n"); 
		query.append("  NVL(C.CO_BSA_CAPA, 0) CO_BSA_CAPA," ).append("\n"); 
		query.append("  NVL(C.HJS_BSA_RTO, 0)*100 AS HJS_BSA_RTO," ).append("\n"); 
		query.append("  NVL(C.CHTR_BSA_RTO, 0)*100 AS CHTR_BSA_RTO," ).append("\n"); 
		query.append("  NVL(C.HJS_BSA_BFR_SUB_CAPA, 0) AS HJS_BSA_BFR_SUB_CAPA," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY C.MNL_FLG," ).append("\n"); 
		...
		query.append("		C.HJS_BSA_BFR_SUB_CAPA, " ).append("\n"); 
		query.append("		C.REV_PORT_CD, " ).append("\n"); 
