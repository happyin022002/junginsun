...
*@FileName : LaneSimulationDBDAOMultiSimBunkerCostDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimBunkerCostDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimBunkerCostDSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimBunkerCostDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM COA_SIM_BNK_COST" ).append("\n"); 
