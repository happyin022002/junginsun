...
*@FileName : SCTransportationAdditionalChargeProposalDBDAOExclPriSpScpTrspAddChgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCTransportationAdditionalChargeProposalDBDAOExclPriSpScpTrspAddChgRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * excel upload시 PRI_SP_SCP_TRSP_ADD_CHG 테이블 조회
	  * </pre>
	  */
	public SCTransportationAdditionalChargeProposalDBDAOExclPriSpScpTrspAddChgRSQL(){
		setQuery();
		...
		query.append("FileName : SCTransportationAdditionalChargeProposalDBDAOExclPriSpScpTrspAddChgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	DECODE(DIR_CALL_FLG, 'Y', '1', '0') AS DIR_CALL_FLG" ).append("\n"); 
		...
		query.append("ORDER BY ADD_CHG_SEQ" ).append("\n"); 
