...
*@FileName : FeederChargeGuideLineDBDAOModifyFDRMainConfirmCurUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOModifyFDRMainConfirmCurUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify FDR Main Confirm Cur
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOModifyFDRMainConfirmCurUSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOModifyFDRMainConfirmCurUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET CFM_DT     = SYSDATE" ).append("\n"); 
		query.append("     , FIC_PROP_STS_CD = @[fic_prop_sts_cd]" ).append("\n"); 
