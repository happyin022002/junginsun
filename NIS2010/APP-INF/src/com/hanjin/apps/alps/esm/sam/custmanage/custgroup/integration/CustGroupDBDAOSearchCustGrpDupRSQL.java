...
*@FileName : CustGroupDBDAOSearchCustGrpDupRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustGroupDBDAOSearchCustGrpDupRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Customer Group ID dup check
	  * </pre>
	  */
	public CustGroupDBDAOSearchCustGrpDupRSQL(){
		setQuery();
		...
		query.append("FileName : CustGroupDBDAOSearchCustGrpDupRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
