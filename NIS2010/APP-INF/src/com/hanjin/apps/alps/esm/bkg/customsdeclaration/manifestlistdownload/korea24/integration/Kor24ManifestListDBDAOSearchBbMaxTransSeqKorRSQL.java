...
*@FileName : Kor24ManifestListDBDAOSearchBbMaxTransSeqKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchBbMaxTransSeqKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchBbMaxTransSeqKorRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchBbMaxTransSeqKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
