...
public class CstmsVvdInfoVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String maxCvyRefNo = null;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("max_cvy_ref_no", getMaxCvyRefNo());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("max_cvy_ref_no", "maxCvyRefNo");
    ...
    public void setMaxCvyRefNo(String maxCvyRefNo) {
        this.maxCvyRefNo = maxCvyRefNo;
    }

    public String getMaxCvyRefNo() {
        return this.maxCvyRefNo;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setMaxCvyRefNo(JSPUtil.getParameter(request, prefix + "max_cvy_ref_no", ""));
    }
    ...
    public CstmsVvdInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] maxCvyRefNo = (JSPUtil.getParameter(request, prefix + "max_cvy_ref_no", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (maxCvyRefNo[i] != null) 
		    		model.setMaxCvyRefNo(maxCvyRefNo[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.maxCvyRefNo = this.maxCvyRefNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
