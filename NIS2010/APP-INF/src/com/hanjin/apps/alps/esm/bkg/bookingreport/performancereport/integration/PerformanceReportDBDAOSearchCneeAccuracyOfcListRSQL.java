...
public class PerformanceReportDBDAOSearchCneeAccuracyOfcListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               DECODE(BD.RGN_OFC_CD,'TYOIB','SHARC',BD.RGN_OFC_CD) RGN_OFC_CD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        AND    DECODE(SUBSTR(BD.POR_CD,1,2),'JP',BK.BKG_OFC_CD,BD.BKG_OFC_CD) = BK.BKG_OFC_CD" ).append("\n"); 
		query.append("        AND    BD.GSO_OFC_CD <> 'SHADKJ' " ).append("\n"); 
		query.append("        AND    BD.BKG_OFC_CD <> 'SHADKJ'" ).append("\n"); 
		query.append("	    AND    DECODE(SUBSTR(BD.POR_CD,1,2),'JP',BD.POR_CD,BK.POR_CD) = BK.POR_CD  " ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("#if (${gso} != '') " ).append("\n"); 
		query.append("   AND BD.GSO_OFC_CD = @[gso]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("             , BD.GSO_OFC_CD" ).append("\n"); 
		query.append("             , BK.BKG_OFC_CD" ).append("\n"); 
		query.append("             , BD.SUB_GRP_CTNT) BK" ).append("\n"); 
