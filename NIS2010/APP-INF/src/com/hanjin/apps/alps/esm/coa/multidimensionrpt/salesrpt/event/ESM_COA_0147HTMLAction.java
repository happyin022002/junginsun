...
*@FileName : ESM_COA_0147HTMLAction.java
...
public class ESM_COA_0147HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0147HTMLAction 객체를 생성
	 */
	public ESM_COA_0147HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0147Event event = new EsmCoa0147Event();
