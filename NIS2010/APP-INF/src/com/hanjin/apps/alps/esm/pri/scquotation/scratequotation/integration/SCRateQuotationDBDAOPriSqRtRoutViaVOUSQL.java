...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutViaVOUSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutViaVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutViaVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutViaVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_RT_ROUT_VIA SET" ).append("\n"); 
