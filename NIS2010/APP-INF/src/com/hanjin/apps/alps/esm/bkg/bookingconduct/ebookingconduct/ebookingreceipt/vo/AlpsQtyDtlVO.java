...
*@FileName : AlpsQtyDtlVO.java
*@FileTitle : AlpsQtyDtlVO
*Open Issues :
*Change history :
...
public class AlpsQtyDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AlpsQtyDtlVO> models = new ArrayList<AlpsQtyDtlVO>();
	 ...
	 * @return AlpsQtyDtlVO[]
	 */
	public AlpsQtyDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AlpsQtyDtlVO[]
	 */
	public AlpsQtyDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AlpsQtyDtlVO model = null;
	 ...
	 * @return AlpsQtyDtlVO[]
	 */
	public AlpsQtyDtlVO[] getAlpsQtyDtlVOs(){
		AlpsQtyDtlVO[] vos = (AlpsQtyDtlVO[])models.toArray(new AlpsQtyDtlVO[models.size()]);
		return vos;
	}
