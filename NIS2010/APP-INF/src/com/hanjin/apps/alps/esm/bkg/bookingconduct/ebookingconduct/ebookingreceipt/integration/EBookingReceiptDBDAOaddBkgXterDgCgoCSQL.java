...
*@FileName : EBookingReceiptDBDAOaddBkgXterDgCgoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterDgCgoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterDgCgoCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterDgCgoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_DG_CGO" ).append("\n"); 
		query.append("(" ).append("\n"); 
