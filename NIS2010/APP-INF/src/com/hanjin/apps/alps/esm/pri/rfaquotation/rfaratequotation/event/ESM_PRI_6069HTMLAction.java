...
public class ESM_PRI_6069HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6069HTMLAction 객체를 생성
	 */
	public ESM_PRI_6069HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6069Event event = new EsmPri6069Event();

		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriRqRtScgVOS((PriRqRtScgVO[])getVOs(request, PriRqRtScgVO .class,""));
		}
