...
*@FileName : Kor24ManifestListDBDAOsearchBbNotTransmitCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchBbNotTransmitCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchBbNotTransmitCheckRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchBbNotTransmitCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
