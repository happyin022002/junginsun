...
*@FileName : FICCostInterfaceDBDAOCopyTariffFdrProgressDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCopyTariffFdrProgressDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CopyTariffFdrProgressData
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCopyTariffFdrProgressDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCopyTariffFdrProgressDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
