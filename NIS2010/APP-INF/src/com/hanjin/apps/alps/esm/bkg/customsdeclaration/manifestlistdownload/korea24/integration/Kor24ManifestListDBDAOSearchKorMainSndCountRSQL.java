...
*@FileName : Kor24ManifestListDBDAOSearchKorMainSndCountRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchKorMainSndCountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 한국세관 Main 테이블에 해당 BKG에 대한 Data가 전송되었는지 확인한다.
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchKorMainSndCountRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchKorMainSndCountRSQL").append("\n");
		query.append("*/").append("\n");
	}
