...
*@FileName : AusSearchContainerForMVO.java
*@FileTitle : AusSearchContainerForMVO
*Open Issues :
*Change history :
...
public class AusSearchContainerForMVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AusSearchContainerForMVO> models = new ArrayList<AusSearchContainerForMVO>();
	...
	public AusSearchContainerForMVO() {}

	public AusSearchContainerForMVO(String ibflag, String pagerows, String cntrnbr, String punit, String pkg, String cntrwgt, String cntrtype, String sealnbr, String socInd, String fmInd, String rfInd, String dgInd, String akInd, String bkInd, String temp, String tunit, String humidity, String vent, String measure, String rdtype, String cmdtDesc, String cmdtcd, String rfRemark, String rfdryInd, String ovf, String ovr, String ovh, String ovlw, String ovrw, String ovwgt, String voidSlot, String stwgReq, String cntrNo) {
		this.socInd = socInd;
		this.ovrw = ovrw;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setHumidity(JSPUtil.getParameter(request, "humidity", ""));
	 ...
	 * @param request
	 * @return AusSearchContainerForMVO[]
	 */
	public AusSearchContainerForMVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusSearchContainerForMVO[]
	 */
	public AusSearchContainerForMVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusSearchContainerForMVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AusSearchContainerForMVO();
				if (socInd[i] != null)
		...
		return getAusSearchContainerForMVOs();
	}
	 ...
	 * @return AusSearchContainerForMVO[]
	 */
	public AusSearchContainerForMVO[] getAusSearchContainerForMVOs(){
		AusSearchContainerForMVO[] vos = (AusSearchContainerForMVO[])models.toArray(new AusSearchContainerForMVO[models.size()]);
		return vos;
	}
