...
*@FileName : CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Simulatoin을 위해 Cost Detail Temp Data 생성
	  * 
	  * * History
	  * 2015.06.26 CHM-201536492 Split05-주간 MAS Open에 따른 타모듈 프로그램 적용 요청
	  * </pre>
	  */
	public CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOCSQL(){
		setQuery();
		...
		query.append("FileName : CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_PRS_CTRT_SMRY_COST_TMP (" ).append("\n"); 
		...
		query.append("	, TEU_FRT_REV" ).append("\n"); 
		...
		query.append(") --CMSummaryDBDAOPriPrsCtrtSmryCostTmpVOCSQL.Query" ).append("\n"); 
		...
		query.append("	SELECT  /*+ materialize LEADING(HDR SMRY @V0 SR_CST_DTL) USE_NL(HDR SMRY SR_CST_DTL) */  HDR.RFA_NO , HDR.PROP_NO, HDR.AMDT_SEQ, HDR.CTRT_EFF_DT, HDR.CTRT_EXP_DT" ).append("\n"); 
		...
		query.append("			FROM PRI_RP_HDR HDR, PRI_RP_DUR DUR" ).append("\n"); 
		query.append("			WHERE HDR.RFA_NO IN ( SELECT PRC_CTRT_NO FROM PRI_PRS_CM_SMRY_SIM_TMP WHERE PRC_CTRT_TP_CD = 'R' )" ).append("\n"); 
		...
		query.append("		, MN.TEU_FRT_REV           " ).append("\n"); 
		query.append("		, MN.PRS_RESPB_CM_UC_AMT   " ).append("\n"); 
		query.append("		, MN.PRS_PFIT_CM_UC_AMT    " ).append("\n"); 
		query.append("		, MN.PRS_RESPB_OPFIT_UC_AMT" ).append("\n"); 
		query.append("		, MN.PRS_CRNT_LOD_QTY      " ).append("\n"); 
		query.append("		, MN.PRS_RESPB_CMPB_AMT" ).append("\n"); 
		query.append("		, MN.PRS_PFIT_CMPB_AMT " ).append("\n"); 
		query.append("		, MN.PRS_RESPB_OPB_AMT " ).append("\n"); 
		...
		query.append("			, MN.PROP_APRO_OFC_CD" ).append("\n"); 
		query.append("			, MN.PRS_CUST_TP_CD	" ).append("\n"); 
		query.append("			, (MN.TEU_FRT_REV           / MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT) AS TEU_FRT_REV" ).append("\n"); 
		query.append("			, (MN.PRS_RESPB_CM_UC_AMT   / MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT) AS PRS_RESPB_CM_UC_AMT" ).append("\n"); 
		query.append("			, (MN.PRS_PFIT_CM_UC_AMT    / MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT) AS PRS_PFIT_CM_UC_AMT" ).append("\n"); 
		query.append("			, (MN.PRS_RESPB_OPFIT_UC_AMT/ MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT) AS PRS_RESPB_OPFIT_UC_AMT" ).append("\n"); 
		query.append("			, MN.PRS_CRNT_LOD_QTY      / MN.REFER_WK_CNT AS PRS_CRNT_LOD_QTY" ).append("\n"); 
		query.append("			, (MN.PRS_RESPB_CM_AMT/ MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT)	AS PRS_RESPB_CMPB_AMT -- 주당 CMPB는 주당CM/주당LOAD, 연산순서는 관련없으나 가독성을 높이기 위해()를 사용." ).append("\n"); 
		query.append("			, (MN.PRS_PFIT_CM_AMT     / MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT)	AS PRS_PFIT_CMPB_AMT" ).append("\n"); 
		query.append("			, (MN.PRS_RESPB_OP_AMT     / MN.REFER_WK_CNT) / (MN.PRS_CRNT_LOD_QTY / MN.REFER_WK_CNT) AS PRS_RESPB_OPB_AMT" ).append("\n"); 
		query.append("			, MN.REFER_WK_CNT" ).append("\n"); 
		query.append("			, MN.ESTIMATE_WK_CNT" ).append("\n"); 
		query.append("		FROM (" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("				, SUM( CKEY.TEU_FRT_REV*CKEY.PRS_CRNT_LOD_QTY)		AS TEU_FRT_REV " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_RESPB_CM_UC_AMT*CKEY.PRS_CRNT_LOD_QTY)	AS PRS_RESPB_CM_UC_AMT " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_PFIT_CM_UC_AMT*CKEY.PRS_CRNT_LOD_QTY)		AS PRS_PFIT_CM_UC_AMT " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_RESPB_OPFIT_UC_AMT*CKEY.PRS_CRNT_LOD_QTY)	AS PRS_RESPB_OPFIT_UC_AMT " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_CRNT_LOD_QTY)		AS PRS_CRNT_LOD_QTY " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_RESPB_CMPB_AMT*CKEY.PRS_CRNT_LOD_QTY)		AS PRS_RESPB_CM_AMT " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_PFIT_CMPB_AMT*CKEY.PRS_CRNT_LOD_QTY)		AS PRS_PFIT_CM_AMT " ).append("\n"); 
		query.append("				, SUM( CKEY.PRS_RESPB_OPB_AMT*CKEY.PRS_CRNT_LOD_QTY)		AS PRS_RESPB_OP_AMT " ).append("\n"); 
		...
		query.append("			FROM  VW_RFA_KEY_LIST CKEY" ).append("\n"); 
		query.append("				, VW_RFA_TOT_WEEK_PER_RFA_NO WK_PER_SC" ).append("\n"); 
		query.append("			WHERE NOT EXISTS ( SELECT /*+ QB_NAME(V1) */  'F' FROM VW_RFA_EST_ACT_1ST_VALUE V1 WHERE V1.PRC_CTRT_NO = CKEY.PRC_CTRT_NO AND V1.PRC_CTRT_NO IS NOT NULL)" ).append("\n"); 
		query.append("				AND CKEY.RFA_NO = WK_PER_SC.RFA_NO" ).append("\n"); 
		query.append("#if( ${frm_ori_rout_cd} != '' )" ).append("\n"); 
		query.append("		-- origin" ).append("\n"); 
		query.append("		AND CKEY.ORG_LOC_DEF_CD= @[frm_ori_rout_cd]" ).append("\n"); 
		...
		query.append("		HDR.SC_NO , HDR.PROP_NO, HDR.AMDT_SEQ, HDR.CTRT_EFF_DT, HDR.CTRT_EXP_DT " ).append("\n"); 
		query.append("		,SR_CST_DTL.PRS_YRMON, SR_CST_DTL.PRS_WK, SR_CST_DTL.PRC_CTRT_TP_CD, SR_CST_DTL.PRC_CTRT_NO" ).append("\n"); 
		query.append("		, SR_CST_DTL.SVC_SCP_CD, SR_CST_DTL.VSL_SLAN_DIR_CD, SR_CST_DTL.TRD_CD, SR_CST_DTL.SUB_TRD_CD" ).append("\n"); 
		query.append("		, SR_CST_DTL.RLANE_CD, SR_CST_DTL.PRC_CGO_TP_CD, SR_CST_DTL.ORG_LOC_TP_CD, SR_CST_DTL.ORG_LOC_DEF_CD,SR_CST_DTL. DEST_LOC_TP_CD, SR_CST_DTL.DEST_LOC_DEF_CD" ).append("\n"); 
		query.append("		,SR_CST_DTL.TEU_FRT_REV, SR_CST_DTL.PRS_RESPB_CM_UC_AMT, SR_CST_DTL.PRS_PFIT_CM_UC_AMT, SR_CST_DTL.PRS_RESPB_OPFIT_UC_AMT, SR_CST_DTL.PRS_CRNT_LOD_QTY, SR_CST_DTL.PRS_RESPB_CMPB_AMT, SR_CST_DTL.PRS_PFIT_CMPB_AMT, SR_CST_DTL.PRS_RESPB_OPB_AMT" ).append("\n"); 
		...
		query.append("		, SMRY.PRS_CUST_TP_CD" ).append("\n"); 
		query.append("	FROM (" ).append("\n"); 
		query.append("			    SELECT /*+ ORDERED USE_NL(HDR DUR) */ HDR.SC_NO, HDR.PROP_NO, DUR.AMDT_SEQ, DUR.CTRT_EFF_DT, DUR.CTRT_EXP_DT" ).append("\n"); 
		query.append("			    ,ROW_NUMBER() OVER (PARTITION BY HDR.SC_NO, DUR.PROP_NO ORDER BY DUR.AMDT_SEQ DESC) RN " ).append("\n"); 
		query.append("			    FROM  PRI_SP_HDR HDR, PRI_SP_DUR DUR" ).append("\n"); 
		...
		query.append("	SELECT /*+ materialize */" ).append("\n"); 
		query.append("		PROP_NO , AMDT_SEQ,SC_NO" ).append("\n"); 
		query.append("		,ACTUAL_WK_CNT" ).append("\n"); 
		query.append("		,DECODE(ESTIMATE_WK_CNT	,1,0,ESTIMATE_WK_CNT	) AS ESTIMATE_WK_CNT	-- 현재주차만 걸릴경우 제외시킨다." ).append("\n"); 
		query.append("		,REFER_WK_CNT" ).append("\n"); 
		query.append("	FROM (" ).append("\n"); 
		...
		query.append("			) AS REFER_WK_CNT" ).append("\n"); 
		query.append("		FROM (" ).append("\n"); 
		query.append("				SELECT  DISTINCT SC_NO, PROP_NO, AMDT_SEQ, CTRT_EFF_DT, CTRT_EXP_DT" ).append("\n"); 
		...
		query.append("			FROM  VW_KEY_LIST CKEY" ).append("\n"); 
		query.append("				, VW_TOT_WEEK_PER_SC_NO WK_PER_SC" ).append("\n"); 
		query.append("			WHERE NOT EXISTS ( SELECT /*+ QB_NAME(V1) */  'F' FROM VW_EST_ACT_1ST_VALUE V1 WHERE V1.PRC_CTRT_NO = CKEY.PRC_CTRT_NO AND V1.PRC_CTRT_NO IS NOT NULL)" ).append("\n"); 
		query.append("				AND CKEY.SC_NO = WK_PER_SC.SC_NO" ).append("\n"); 
		query.append("#if( ${frm_ori_rout_cd} != '' )" ).append("\n"); 
		query.append("		-- origin" ).append("\n"); 
		query.append("		AND CKEY.ORG_LOC_DEF_CD= @[frm_ori_rout_cd]" ).append("\n"); 
		...
		query.append("		, MN.PRS_PFIT_CMPB_AMT " ).append("\n"); 
		query.append("		, MN.PRS_RESPB_OPB_AMT " ).append("\n"); 
		query.append("		, RANK() OVER( PARTITION BY 	 MN.PRC_CTRT_TP_CD " ).append("\n"); 
		query.append("						, MN.PRC_CTRT_NO    " ).append("\n"); 
		query.append("						, MN.SVC_SCP_CD     " ).append("\n"); 
		query.append("						, MN.VSL_SLAN_DIR_CD" ).append("\n"); 
		query.append("						, MN.TRD_CD         " ).append("\n"); 
		...
		query.append("						, MN.DEST_LOC_TP_CD " ).append("\n"); 
		query.append("						, MN.DEST_LOC_DEF_CD" ).append("\n"); 
		query.append("				ORDER BY 	DT_LIST.COST_YRMON" ).append("\n"); 
		query.append("						, DT_LIST.COST_WK" ).append("\n"); 
