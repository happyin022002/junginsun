...
public class BlDocCustVO extends AbstractValueObject {
    ...
    //ExCustLglEngNm ex_cust_lgl_eng_nm
    /* Column Info */
    ...
    /* Column Info */
    private String shIdaGstRgstNo = null;

    /* Column Info */
    private String cnIdaGstRgstNo = null;

    /* Column Info */
    private String nfIdaGstRgstNo = null;

    /* Column Info */
    private String shCustPhnNo = null;
    ...
    /* Column Info */
    private String cnCustPhnNo = null;

    /* Column Info */
    private String nfCustPhnNo = null;

    /* Column Info */
    private String cnCoChnTpCd = null;

    /* Column Info */
    private String nfCoChnTpCd = null;
    ...
    public BlDocCustVO(String ibflag, String pagerows, String bkgNo, String shCustCntCd, String shCustSeq, String shCustLglEngNm, String shCustNm, String shAddrPrnFlg, String shCustAddr, String shCustCtyNm, String shCustSteCd, String shCstmsDeclCntCd, String shCustZipId, String shEurCstmsStNm, String shEoriNo, String shCustTp, String shMdmAddress, String cnCustCntCd, String cnCustSeq, String cnCustLglEngNm, String cnCustNm, String cnAddrPrnFlg, String cnCustAddr, String cnCustCtyNm, String cnCustSteCd, String cnCstmsDeclCntCd, String cnCustZipId, String cnCustFaxNo, String cnCustEml, String cnEurCstmsStNm, String cnEoriNo, String cnCustTp, String cnMdmAddress, String nfCustCntCd, String nfCustSeq, String nfCustLglEngNm, String nfCustNm, String nfAddrPrnFlg, String nfCustAddr, String nfCustCtyNm, String nfCustSteCd, String nfCstmsDeclCntCd, String nfCustZipId, String nfCustFaxNo, String nfCustEml, String nfEurCstmsStNm, String nfEoriNo, String nfCustTp, String nfMdmAddress, String ffCustCntCd, String ffCustSeq, String ffCustLglEngNm, String ffCustNm, String ffCustAddr, String ffAddrPrnFlg, String ffCustCtyNm, String ffCustSteCd, String ffCstmsDeclCntCd, String ffCustZipId, String ffCustFaxNo, String ffCustEml, String ffCustTp, String ffMdmAddress, String anCustCntCd, String anCustSeq, String anCustLglEngNm, String anCustNm, String anCustAddr, String anAddrPrnFlg, String anCustSteCd, String anCstmsDeclCntCd, String anCustZipId, String anCustFaxNo, String anCustEml, String anCustTp, String anMdmAddress, String exCustCntCd, String exCustSeq, String exCustNm, String exAddrPrnFlg, String brCustCntCd, String brCustSeq, String brCustNm, String brCustAddr, String exCustLglEngNm, String alocStsCd, String isRatedFlg, String actCustListExistFlg, String nonRtStsCd, String endUsrNm, String shIdaGstRgstNo, String cnIdaGstRgstNo, String nfIdaGstRgstNo, String shCustPhnNo, String shCustFaxNo, String shCustEml, String cnCustPhnNo, String nfCustPhnNo, String cnCoChnTpCd, String nfCoChnTpCd) {
        ...
        this.shIdaGstRgstNo = shIdaGstRgstNo;
        this.cnIdaGstRgstNo = cnIdaGstRgstNo;
        this.nfIdaGstRgstNo = nfIdaGstRgstNo;
        this.shCustPhnNo = shCustPhnNo;
        this.shCustFaxNo = shCustFaxNo;
        this.shCustEml = shCustEml;
        this.cnCustPhnNo = cnCustPhnNo;
        this.nfCustPhnNo = nfCustPhnNo;
        this.cnCoChnTpCd = cnCoChnTpCd;
        this.nfCoChnTpCd = nfCoChnTpCd;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        this.hashColumns.put("end_usr_nm", getEndUsrNm());
        ...
        this.hashColumns.put("sh_ida_gst_rgst_no", getShIdaGstRgstNo());
        this.hashColumns.put("cn_ida_gst_rgst_no", getCnIdaGstRgstNo());
        this.hashColumns.put("nf_ida_gst_rgst_no", getNfIdaGstRgstNo());
        this.hashColumns.put("sh_cust_phn_no", getShCustPhnNo());
        this.hashColumns.put("sh_cust_fax_no", getShCustFaxNo());
        this.hashColumns.put("sh_cust_eml", getShCustEml());
        this.hashColumns.put("cn_cust_phn_no", getCnCustPhnNo());
        this.hashColumns.put("nf_cust_phn_no", getNfCustPhnNo());
        this.hashColumns.put("cn_co_chn_tp_cd", getCnCoChnTpCd());
        this.hashColumns.put("nf_co_chn_tp_cd", getNfCoChnTpCd());
    ...
    public HashMap<String, String> getFieldNames() {
        this.hashFields.put("end_usr_nm", "endUsrNm");
        ...
        this.hashFields.put("sh_ida_gst_rgst_no", "shIdaGstRgstNo");
        this.hashFields.put("cn_ida_gst_rgst_no", "cnIdaGstRgstNo");
        this.hashFields.put("nf_ida_gst_rgst_no", "nfIdaGstRgstNo");
        this.hashFields.put("sh_cust_phn_no", "shCustPhnNo");
        this.hashFields.put("sh_cust_fax_no", "shCustFaxNo");
        this.hashFields.put("sh_cust_eml", "shCustEml");
        this.hashFields.put("cn_cust_phn_no", "cnCustPhnNo");
        this.hashFields.put("nf_cust_phn_no", "nfCustPhnNo");
        this.hashFields.put("cn_co_chn_tp_cd", "cnCoChnTpCd");
        this.hashFields.put("nf_co_chn_tp_cd", "nfCoChnTpCd");
    ...
    public void setShIdaGstRgstNo(String shIdaGstRgstNo) {
        this.shIdaGstRgstNo = shIdaGstRgstNo;
    }

    public String getShIdaGstRgstNo() {
        return this.shIdaGstRgstNo;
    }

    public void setCnIdaGstRgstNo(String cnIdaGstRgstNo) {
        this.cnIdaGstRgstNo = cnIdaGstRgstNo;
    }

    public String getCnIdaGstRgstNo() {
        return this.cnIdaGstRgstNo;
    }

    public void setNfIdaGstRgstNo(String nfIdaGstRgstNo) {
        this.nfIdaGstRgstNo = nfIdaGstRgstNo;
    }

    public String getNfIdaGstRgstNo() {
        return this.nfIdaGstRgstNo;
    }

    public void setShCustPhnNo(String shCustPhnNo) {
        this.shCustPhnNo = shCustPhnNo;
    }

    public String getShCustPhnNo() {
        return this.shCustPhnNo;
    }
    ...
    public void setCnCustPhnNo(String cnCustPhnNo) {
        this.cnCustPhnNo = cnCustPhnNo;
    }

    public String getCnCustPhnNo() {
        return this.cnCustPhnNo;
    }

    public void setNfCustPhnNo(String nfCustPhnNo) {
        this.nfCustPhnNo = nfCustPhnNo;
    }

    public String getNfCustPhnNo() {
        return this.nfCustPhnNo;
    }

    public void setCnCoChnTpCd(String cnCoChnTpCd) {
        this.cnCoChnTpCd = cnCoChnTpCd;
    }

    public String getCnCoChnTpCd() {
        return this.cnCoChnTpCd;
    }

    public void setNfCoChnTpCd(String nfCoChnTpCd) {
        this.nfCoChnTpCd = nfCoChnTpCd;
    }

    public String getNfCoChnTpCd() {
        return this.nfCoChnTpCd;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        setEndUsrNm(JSPUtil.getParameter(request, prefix + "end_usr_nm", ""));
        ...
        setShIdaGstRgstNo(JSPUtil.getParameter(request, prefix + "sh_ida_gst_rgst_no", ""));
        setCnIdaGstRgstNo(JSPUtil.getParameter(request, prefix + "cn_ida_gst_rgst_no", ""));
        setNfIdaGstRgstNo(JSPUtil.getParameter(request, prefix + "nf_ida_gst_rgst_no", ""));
        setShCustPhnNo(JSPUtil.getParameter(request, prefix + "sh_cust_phn_no", ""));
        ...
        setCnCustPhnNo(JSPUtil.getParameter(request, prefix + "cn_cust_phn_no", ""));
        setNfCustPhnNo(JSPUtil.getParameter(request, prefix + "nf_cust_phn_no", ""));
        setCnCoChnTpCd(JSPUtil.getParameter(request, prefix + "cn_co_chn_tp_cd", ""));
        setNfCoChnTpCd(JSPUtil.getParameter(request, prefix + "nf_co_chn_tp_cd", ""));
    }
    ...
    public BlDocCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            String[] endUsrNm = (JSPUtil.getParameter(request, prefix + "end_usr_nm", length));
            ...
            String[] shIdaGstRgstNo = (JSPUtil.getParameter(request, prefix + "sh_ida_gst_rgst_no", length));
            String[] cnIdaGstRgstNo = (JSPUtil.getParameter(request, prefix + "cn_ida_gst_rgst_no", length));
            String[] nfIdaGstRgstNo = (JSPUtil.getParameter(request, prefix + "nf_ida_gst_rgst_no", length));
            String[] shCustPhnNo = (JSPUtil.getParameter(request, prefix + "sh_cust_phn_no", length));
            ...
            String[] cnCustPhnNo = (JSPUtil.getParameter(request, prefix + "cn_cust_phn_no", length));
            String[] nfCustPhnNo = (JSPUtil.getParameter(request, prefix + "nf_cust_phn_no", length));
            String[] cnCoChnTpCd = (JSPUtil.getParameter(request, prefix + "cn_co_chn_tp_cd", length));
	    	String[] nfCoChnTpCd = (JSPUtil.getParameter(request, prefix + "nf_co_chn_tp_cd", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (endUsrNm[i] != null)
                    model.setEndUsrNm(endUsrNm[i]);
                if (shIdaGstRgstNo[i] != null)
                    model.setShIdaGstRgstNo(shIdaGstRgstNo[i]);
                if (cnIdaGstRgstNo[i] != null)
                    model.setCnIdaGstRgstNo(cnIdaGstRgstNo[i]);
                if (nfIdaGstRgstNo[i] != null)
                    model.setNfIdaGstRgstNo(nfIdaGstRgstNo[i]);
                if (shCustPhnNo[i] != null)
                    model.setShCustPhnNo(shCustPhnNo[i]);
                if (shCustFaxNo[i] != null)
                    model.setShCustFaxNo(shCustFaxNo[i]);
                if (shCustEml[i] != null)
                    model.setShCustEml(shCustEml[i]);
                if (cnCustPhnNo[i] != null)
                    model.setCnCustPhnNo(cnCustPhnNo[i]);
                if (nfCustPhnNo[i] != null)
                    model.setNfCustPhnNo(nfCustPhnNo[i]);
                if (cnCoChnTpCd[i] != null) 
		    		model.setCnCoChnTpCd(cnCoChnTpCd[i]);
				if (nfCoChnTpCd[i] != null) 
		    		model.setNfCoChnTpCd(nfCoChnTpCd[i]);
	...
	*/
    public void unDataFormat() {
        this.endUsrNm = this.endUsrNm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.shIdaGstRgstNo = this.shIdaGstRgstNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cnIdaGstRgstNo = this.cnIdaGstRgstNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.nfIdaGstRgstNo = this.nfIdaGstRgstNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.shCustPhnNo = this.shCustPhnNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.cnCustPhnNo = this.cnCustPhnNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.nfCustPhnNo = this.nfCustPhnNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.cnCoChnTpCd = this.cnCoChnTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.nfCoChnTpCd = this.nfCoChnTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
