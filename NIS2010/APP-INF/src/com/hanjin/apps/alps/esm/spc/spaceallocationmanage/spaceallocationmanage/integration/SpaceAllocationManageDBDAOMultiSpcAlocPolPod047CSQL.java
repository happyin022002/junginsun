...
*@FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod047CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOMultiSpcAlocPolPod047CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2011.09.22 김종준 [CHM-201113515-01] SPC내에서 사용하고 있는 Tag Library 제거 작업중 기존 쿼리 수정
	  * 2011.09.26 김종준 [CHM-201113515-01] SPC내에서 사용하고 있는 Tag Library 제거 작업중 기존 쿼리 수정
	  * 2013.03.22 김시몬 [CHM-201322502] 성수기 선복운영 개선을 위한 T/F추진 MDM_DTL_REV_LANE 삭제체크 추가
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOMultiSpcAlocPolPod047CSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod047CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("           DECODE(NVL(@[del_cd], '00000'), 'OTHERS', 'XXXXX', NVL(@[del_cd], '00000'))                        AS DEST_LOC_CD    ,                          " ).append("\n"); 
		...
		query.append("                      WHERE OFC_CD       = P.SLS_OFC_CD" ).append("\n"); 
		...
		query.append("			        AND SUBSTR(P.POL_CD, 1, 5)        = LLOC.LOC_CD" ).append("\n"); 
		query.append("			        AND SUBSTR(P.POD_CD, 1, 5)        = DLOC.LOC_CD " ).append("\n"); 
		...
		query.append("               -- AND P.POD_CD       <> DECODE(LENGTH(P.POD_CD), 5, '00000', '0000000') " ).append("\n"); 
		...
		query.append("                   P.MNL_ALOC_RMK       ," ).append("\n"); 
		query.append("                   P.USR_ID             ," ).append("\n"); 
		query.append("                   P.ALOC_GDT, P.DT	," ).append("\n"); 
		query.append("                   -- 2014.08.01 컬럼추가" ).append("\n"); 
		query.append("                   P.CUST_CNT_CD	,                             " ).append("\n"); 
		query.append("                   P.CUST_SEQ		,                             " ).append("\n"); 
		query.append("                   P.CTRT_NO		,                             " ).append("\n"); 
		...
		query.append("                   MDM_REV_LANE RL" ).append("\n"); 
		query.append("             WHERE P.RLANE_CD = RL.RLANE_CD" ).append("\n"); 
		query.append("	      -- AN.POD_CD = DECODE(LENGTH(P.POD_CD), 5, '00000', '0000000')     " ).append("\n"); 
		query.append("	       AND P.DEST_LOC_CD     = '00000' " ).append("\n"); 
