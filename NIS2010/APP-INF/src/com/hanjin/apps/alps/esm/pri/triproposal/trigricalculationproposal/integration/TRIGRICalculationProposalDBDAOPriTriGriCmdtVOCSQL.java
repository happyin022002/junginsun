...
*@FileName : TRIGRICalculationProposalDBDAOPriTriGriCmdtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAOPriTriGriCmdtVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriTriGriCmdtVO Insert
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAOPriTriGriCmdtVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAOPriTriGriCmdtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRI_GRI_CMDT (" ).append("\n"); 
