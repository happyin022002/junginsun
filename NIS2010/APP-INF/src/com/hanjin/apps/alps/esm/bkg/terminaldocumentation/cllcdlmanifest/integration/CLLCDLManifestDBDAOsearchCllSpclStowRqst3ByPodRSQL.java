...
public class CLLCDLManifestDBDAOsearchCllSpclStowRqst3ByPodRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            " ).append("\n"); 
		query.append("			DECODE(SUM(OLBP_20), 0, '', SUM(OLBP_20)) OLBP_20," ).append("\n"); 
		query.append("			DECODE(SUM(OLBP_40), 0, '', SUM(OLBP_40)) OLBP_40," ).append("\n"); 
		query.append("			DECODE(SUM(OLBP_40H), 0, '', SUM(OLBP_40H)) OLBP_40H ," ).append("\n"); 
		query.append("            DECODE(SUM(OLBP_45), 0, '', SUM(OLBP_45)) OLBP_45," ).append("\n"); 
		query.append("            " ).append("\n"); 
		...
		query.append("      " ).append("\n"); 
		query.append("            DECODE(SUM(UDMX_20), 0, '', SUM(UDMX_20)) UDMX_20," ).append("\n"); 
		query.append("			DECODE(SUM(UDMX_40), 0, '', SUM(UDMX_40)) UDMX_40," ).append("\n"); 
		query.append("			DECODE(SUM(UDMX_40H), 0, '', SUM(UDMX_40H)) UDMX_40H ," ).append("\n"); 
		query.append("            DECODE(SUM(UDMX_45), 0, '', SUM(UDMX_45)) UDMX_45," ).append("\n"); 
		query.append("            " ).append("\n"); 
		...
		query.append("                    " ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0),0)) OLBP_20 ," ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'4',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'4',BQ.OP_CNTR_QTY,0),0)) OLBP_40 ," ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '4', 0, '7', 0,  BQ.OP_CNTR_QTY),0),0,'',DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '4', 0, '7', 0,  BQ.OP_CNTR_QTY),0)) OLBP_40H ," ).append("\n"); 
		query.append("                    DECODE(DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'OLBP',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0),0)) OLBP_45 ," ).append("\n"); 
		query.append("                    " ).append("\n"); 
		...
		query.append("                   " ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2',BQ.OP_CNTR_QTY,0),0)) UDMX_20 ," ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'4',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'4',BQ.OP_CNTR_QTY,0),0)) UDMX_40 ," ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '4', 0, '7', 0,  BQ.OP_CNTR_QTY),0),0,'',DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'2', 0, '4', 0, '7', 0,  BQ.OP_CNTR_QTY),0)) UDMX_40H ,                    " ).append("\n"); 
		query.append("					DECODE(DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0),0),0,'',DECODE(BK.STWG_CD,'UDMX',DECODE(SUBSTR(BQ.CNTR_TPSZ_CD,2,1),'7',BQ.OP_CNTR_QTY,0),0)) UDMX_45 ," ).append("\n"); 
		query.append("           " ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) OLBP_20 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) OLBP_40 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0, 1), 0) OLBP_40H ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 0) OLBP_45 ," ).append("\n"); 
		query.append("      " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 'UDAK', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) UDMX_20 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 'UDAK', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) UDMX_40 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0, 1), 'UDAK', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0, 1), 0) UDMX_40H ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 'UDAK', DECODE(SUBSTR(CLL.CNTR_TPSZ_CD, 2, 1), '7', 1, 0),  0) UDMX_45 ," ).append("\n"); 
		query.append("      " ).append("\n"); 
