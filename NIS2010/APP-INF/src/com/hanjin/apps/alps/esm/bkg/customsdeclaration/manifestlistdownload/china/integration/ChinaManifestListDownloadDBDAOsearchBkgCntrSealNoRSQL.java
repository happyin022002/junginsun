...
public class ChinaManifestListDownloadDBDAOsearchBkgCntrSealNoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		BB.BKG_CGO_TP_CD			AS BKG_CGO_TP_CD," ).append("\n"); 
		query.append("        NVL(CS.CNTR_SEAL_NO, '') 	AS SEAL_NO," ).append("\n"); 
		query.append("    	NVL(CS.SEAL_PTY_TP_CD, '')	AS SEAL_PTY_TP_CD," ).append("\n"); 
		query.append("    	NVL(CS.SEAL_KND_CD, '')		AS SEAL_KND_CD," ).append("\n"); 
