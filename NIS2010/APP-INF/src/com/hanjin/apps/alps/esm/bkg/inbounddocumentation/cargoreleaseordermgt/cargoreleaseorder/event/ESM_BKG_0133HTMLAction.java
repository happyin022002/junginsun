...
*@FileName : ESM_BKG_0133HTMLAction.java
...
public class ESM_BKG_0133HTMLAction extends HTMLActionSupport {
     ...
     */
    public ESM_BKG_0133HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0133Event로 파싱하여 request에 셋팅<br>
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0133Event event = new EsmBkg0133Event();

        String rqstNo	= "";
        String tpCd		= "";
        String rvwFlg	= "";
        
        rvwFlg = request.getParameter("frm_edo_rvw_flg");
        event.setRvwFlg(rvwFlg);
        
        log.debug("===================================");
        log.debug("    ESM_BKG_0133HTMLAction Start   " + request.getParameter("frm_edo_rqst_no"));
        log.debug("===================================");
