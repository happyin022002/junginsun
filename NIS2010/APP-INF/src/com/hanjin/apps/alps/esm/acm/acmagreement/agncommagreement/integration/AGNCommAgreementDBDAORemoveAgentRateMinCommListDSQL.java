...
*@FileName : AGNCommAgreementDBDAORemoveAgentRateMinCommListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAORemoveAgentRateMinCommListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommAgreementDBDAORemoveAgentRateMinCommListDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAORemoveAgentRateMinCommListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
