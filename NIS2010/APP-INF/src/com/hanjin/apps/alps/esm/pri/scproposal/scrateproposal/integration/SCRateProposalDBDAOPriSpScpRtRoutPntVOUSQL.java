...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutPntVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutPntVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutPntVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutPntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
