...
*@FileName : AGNCommCalculationDBDAOSearchAGNCommMassCalListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommCalculationDBDAOSearchAGNCommMassCalListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommCalculationDBDAOSearchAGNCommMassCalListRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommCalculationDBDAOSearchAGNCommMassCalListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MAX(A.BKG_NO) AS BKG_NO" ).append("\n"); 
