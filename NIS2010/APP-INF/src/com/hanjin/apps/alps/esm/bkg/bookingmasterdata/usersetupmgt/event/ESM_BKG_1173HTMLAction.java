...
*@FileName : ESM_BKG_1173HTMLAction.java
...
public class ESM_BKG_1173HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1173HTMLAction 객체를 생성
	 */
	public ESM_BKG_1173HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1173Event event = new EsmBkg1173Event();
		log.debug("***** ESM_BKG_1173HTMLAction : " + command.getCommand());
		
		if(command.isCommand(FormCommand.SEARCH)) {
           
            event.setBkgTroOfcCd(JSPUtil.getParameter(request, "bkg_tro_ofc_cd", ""));
		} else if(command.isCommand(FormCommand.MULTI)) {
            event.setTroRmkStupVOs((TroRmkStupVO[])getVOs(request, TroRmkStupVO.class, ""));
		}
