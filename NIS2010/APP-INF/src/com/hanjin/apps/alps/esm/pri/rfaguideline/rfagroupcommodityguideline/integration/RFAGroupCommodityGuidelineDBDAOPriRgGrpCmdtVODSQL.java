...
*@FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVODSQL.java
...
public class RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_RG_GRP_CMDT" ).append("\n"); 
