...
*@FileName : IHCGuideLineDBDAOAddIHCTariffDurationAmendCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOAddIHCTariffDurationAmendCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add IHC Tariff Duration Amend
	  * </pre>
	  */
	public IHCGuideLineDBDAOAddIHCTariffDurationAmendCSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOAddIHCTariffDurationAmendCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRF_IHC_DUR (" ).append("\n"); 
		...
		query.append("         , @[upd_usr_id]" ).append("\n"); 
		query.append("         , SYSDATE" ).append("\n"); 
		query.append("      FROM PRI_TRF_IHC_DUR  " ).append("\n"); 
