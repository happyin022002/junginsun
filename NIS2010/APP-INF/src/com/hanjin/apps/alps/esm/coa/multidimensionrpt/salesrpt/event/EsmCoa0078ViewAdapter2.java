 ...
 * @since J2EE 1.6
 */
public class EsmCoa0078ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmCoa0078ViewAdapter2(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmCoa0078ViewAdapter2 ########### [START]");
		...
		log.debug("########### EsmCoa0078ViewAdapter2 ########### [END]");        
