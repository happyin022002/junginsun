...
public class SpaceAllocationManageVO extends AbstractValueObject{
	...
	private String doubleCallChk = null;
	...
	/**
	 * @return the doubleCallChk
	 */
	public String getDoubleCallChk() {
		return doubleCallChk;
	}

	/**
	 * @param doubleCallChk the doubleCallChk to set
	 */
	public void setDoubleCallChk(String doubleCallChk) {
		this.doubleCallChk = doubleCallChk;
	}	
