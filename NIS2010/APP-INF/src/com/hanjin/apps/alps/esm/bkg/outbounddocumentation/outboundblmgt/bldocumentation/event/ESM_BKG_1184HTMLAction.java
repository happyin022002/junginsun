...
*@FileName 		: ESM_BKG_1184HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_BKG_1184HTMLAction extends HTMLActionSupport {
	/*
	 * 
	 */
	...
	/**
	 * ESM_BKG_1184HTMLAction 객체를 생성
	 */
	public ESM_BKG_1184HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1184Event event = new EsmBkg1184Event();

		if(command.isCommand(FormCommand.SEARCHLIST)){
			event.setXterVgmRqstListInputVO((XterVgmRqstListInputVO)getVO(request, XterVgmRqstListInputVO.class));
		}else if(command.isCommand(FormCommand.MULTI)){
			event.setXterVgmRqstListVOs((XterVgmRqstListVO[])getVOs(request, XterVgmRqstListVO.class));
		}
