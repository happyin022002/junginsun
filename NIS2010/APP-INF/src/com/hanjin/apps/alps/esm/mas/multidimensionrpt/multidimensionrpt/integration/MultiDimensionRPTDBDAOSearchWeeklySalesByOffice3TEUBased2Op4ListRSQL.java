...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased2Op4ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased2Op4ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased2Op4ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased2Op4ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		                       ,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.CO_AMT,'O|BIZ', B2.N4TH_HJS_SLS_AMT,B2.N4TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("		                       ) " ).append("\n"); 
		...
		query.append("		                       ,'LOAD0000', DECODE(SUBSTR (B2.CNTR_TPSZ_CD, -1),'2', B2.ESTM_PL_AMT, '3', B2.ESTM_PL_AMT, B2.ESTM_PL_AMT * 2) " ).append("\n"); 
		query.append("		                       ,'BSA00000', B2.N4TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("		                       ,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.CO_AMT,'O|BIZ', B2.N4TH_HJS_SLS_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("		                       ) " ).append("\n"); 
		query.append("		          ,'R', DECODE (B2.STND_COST_CD " ).append("\n"); 
		query.append("		                       ,'LOAD0000', DECODE(SUBSTR(B2.CNTR_TPSZ_CD, -1),'2', B2.RA_PL_AMT, '3', B2.RA_PL_AMT, B2.RA_PL_AMT * 2) " ).append("\n"); 
		query.append("		                       ,'92404011', DECODE(@[f_ofc_vw],'L', 0, 'C', DECODE(@[f_ofc_lvl],'1',0, B2.RA_PL_AMT))  " ).append("\n"); 
		...
		query.append("				,NVL (SUM (DECODE (A3.STND_COST_TP_CD " ).append("\n"); 
		query.append("				                 ,'O', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("				                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N4TH_CO_AMT,'O|BIZ', A2.N4TH_HJS_SLS_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("				                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("				                              ) " ).append("\n"); 
		query.append("				                 ,0 " ).append("\n"); 
		query.append("				                 ) " ).append("\n"); 
		...
		query.append("                 -- Initial Network Cost(SML Sales/Slot Cht-out->All Network Cost by VVD->Total)" ).append("\n"); 
		query.append("                 , SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM MAS_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF','VF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                            THEN NVL(A2.N4TH_HJS_SLS_AMT,0) + NVL(A2.N4TH_CO_AMT,0) - NVL(A2.N1ST_ASGN_AMT,0) ELSE 0 END) INIT_COST" ).append("\n"); 
		query.append("                 -- T/S Cost Amount" ).append("\n"); 
		query.append("                 , SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM MAS_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF','VF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                            THEN A2.N4TH_ASGN_AMT ELSE 0 END) TS_ALOC" ).append("\n"); 
		query.append("				 , 0 AS GEN_EXPN" ).append("\n"); 
