...
public class AgencyCommissionDBDAOSearchAgnOtrCommCostListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      , A1.COMM_LOC_CD  COMM_LOC_CD" ).append("\n"); 
		query.append("      ,DECODE(A1.COMM_LOC_CD, 'XXX', 'Common', A1.COMM_LOC_CD) COMM_LOC_NM" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	  ,DECODE(A1.MAS_COST_SRC_CD, '512691', 'Location', '512692', 'Country', '512693', 'Common') DIV_STND" ).append("\n"); 
		query.append("      ,A2.MAS_COST_SRC_CD_NM " ).append("\n"); 
		...
		query.append("  FROM MAS_OTR_COMM A1 " ).append("\n"); 
		query.append("      ,MAS_COST_SRC_ACCT A2 " ).append("\n"); 
		...
		query.append("   AND A1.MAS_COST_SRC_CD = A2.MAS_COST_SRC_CD" ).append("\n"); 
		query.append("   AND (A1.MAS_COST_SRC_CD = '512691' OR LENGTH(A1.COMM_LOC_CD) < 4)" ).append("\n"); 
		query.append("ORDER BY A1.MAS_COST_SRC_CD DESC" ).append("\n"); 
