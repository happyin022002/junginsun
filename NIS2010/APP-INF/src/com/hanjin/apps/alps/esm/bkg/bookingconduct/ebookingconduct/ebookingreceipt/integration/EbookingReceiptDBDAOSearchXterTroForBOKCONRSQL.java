...
*@FileName : EbookingReceiptDBDAOSearchXterTroForBOKCONRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EbookingReceiptDBDAOSearchXterTroForBOKCONRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EbookingReceiptDBDAOSearchXterTroForBOKCONRSQL(){
		setQuery();
		...
		query.append("FileName : EbookingReceiptDBDAOSearchXterTroForBOKCONRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("--searchXterTroForAck" ).append("\n"); 
		query.append("SELECT  '{I_BKG_TRO'                                                       ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_SEQ:'       || NVL(T.TRO_SEQ,         X.TRO_SEQ)           ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_ACUST_NM:'  || NVL(T.ACT_SHPR_NM,     X.ACT_SHPR_NM)       ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_PERSON:'    || NVL(T.CNTC_PSON_NM,    X.CNTC_PSON_NM)      ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_TEL:'       || NVL(T.ACT_SHPR_PHN_NO, X.CNTC_PHN_NO_CTNT)  ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_DOOR_LOC:'  || NVL(T.DOR_PST_NO,      X.DOR_LOC_CD)        ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_REMARK:'    || NVL(T.DIFF_RMK,        X.TRO_RMK)           ||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_POL_YD_LOC:'|| NVL(T.RTN_LOC_CD,      X.FULL_RTN_YD_LOC_CD)||CHR(10)||" ).append("\n"); 
		query.append("        'IB_TRO_POL_YD_NM:' || NVL(T.RTN_YD_NM,       X.FULL_RTN_YD_NM)    ||CHR(10)||" ).append("\n"); 
		query.append("        '}I_BKG_TRO'                                                       ||CHR(10) FLAT_FILE" ).append("\n"); 
		query.append("  FROM BKG_XTER_TRO X," ).append("\n"); 
