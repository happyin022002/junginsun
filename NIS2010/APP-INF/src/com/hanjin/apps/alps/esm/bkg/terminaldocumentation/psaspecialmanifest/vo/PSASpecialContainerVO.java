...
public class PSASpecialContainerVO extends PSADgListDetailVO {
	...
	List<PSAFeederNameVO> 		psaFedderNameLloydList = null; // Fedder Name, Lloyd No List
	...
	public List<PSAFeederNameVO> getPsaFedderNameLloydList() {
		return psaFedderNameLloydList;
	}

	public void setPsaFedderNameLloydList(
			List<PSAFeederNameVO> psaFedderNameLloydList) {
		this.psaFedderNameLloydList = psaFedderNameLloydList;
	}
