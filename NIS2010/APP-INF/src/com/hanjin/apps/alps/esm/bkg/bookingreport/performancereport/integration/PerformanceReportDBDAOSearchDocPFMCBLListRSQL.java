...
*@FileName : PerformanceReportDBDAOSearchDocPFMCBLListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchDocPFMCBLListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchDocPFMCBLListRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchDocPFMCBLListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,DP.DOC_KND_STS_CD CLASS_TYPE" ).append("\n"); 
		...
		query.append("      ,DECODE(DP.DOC_PROC_RSLT_TP_CD, 'I','N','1','N','N','N','Y')  BKG_STS" ).append("\n"); 
		...
		query.append("				WHERE DECODE(SUBSTR(BDPO.POR_CD,1,2),'JP',DP.BKG_OFC_CD,BDPO.BKG_OFC_CD) = DP.BKG_OFC_CD  " ).append("\n"); 
		query.append("				AND DECODE(SUBSTR(BDPO.POR_CD,1,2),'JP',BDPO.POR_CD,BKG.POR_CD) = BKG.POR_CD " ).append("\n"); 
