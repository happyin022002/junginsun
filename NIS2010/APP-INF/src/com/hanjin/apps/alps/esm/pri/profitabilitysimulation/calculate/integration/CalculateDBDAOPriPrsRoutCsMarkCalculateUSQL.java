...
*@FileName : CalculateDBDAOPriPrsRoutCsMarkCalculateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CalculateDBDAOPriPrsRoutCsMarkCalculateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CalculateDBDAOPriPrsRoutCsMarkCalculateUSQL(){
		setQuery();
		...
		query.append("FileName : CalculateDBDAOPriPrsRoutCsMarkCalculateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET  COST_ROUT_CS_FLG = 'Y'" ).append("\n"); 
		query.append(", PRS_ROUT_CS_BAT_MK_KNT = PRS_ROUT_CS_BAT_MK_KNT +1" ).append("\n"); 
