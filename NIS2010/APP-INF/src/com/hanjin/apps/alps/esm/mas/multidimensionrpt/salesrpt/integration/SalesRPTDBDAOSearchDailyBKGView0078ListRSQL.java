...
public class SalesRPTDBDAOSearchDailyBKGView0078ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("			        ,SUM(NVL(B2.BKG_REV,0)+NVL(B2.BKG_OFT_REV,0)+NVL(B2.BKG_MISC_REV,0)+NVL(B2.SCR_CHG_REV,0)+NVL(B2.DMDT_COM_AMT,0)) - " ).append("\n"); 
		...
		query.append("			        ,SUM(DECODE('${f_pro_vw}', 'P', NVL(A6.PA_OP_COST_TTL_AMT, 0),'R', 0 )) AS OP_COST " ).append("\n"); 
		...
		query.append("			      ,MAS_BKG_EXPN_DTL  B2" ).append("\n"); 
		query.append("                  ,MAS_BKG_OP_EXPN_DTL A6 " ).append("\n"); 
		query.append("			      ,MAS_OFC_LVL B3       " ).append("\n"); 
		query.append("			#if(${f_isshpr}=='Y')      " ).append("\n"); 
		...
		query.append(" 			#end" ).append("\n"); 
		query.append("		        AND B2.BKG_NO         = A6.BKG_NO(+)" ).append("\n"); 
		query.append("        		AND B2.CNTR_TPSZ_CD   = A6.CNTR_TPSZ_CD(+)" ).append("\n"); 
		query.append("		        AND B2.COST_ROUT_NO   = A6.COST_ROUT_NO(+)" ).append("\n"); 
		...
		query.append("			        ,SUM(DECODE('${f_pro_vw}', 'P', NVL(B2.PA_CM_COST_TTL_AMT,0),   'R', NVL(B2.RA_CM_COST_TTL_AMT, 0) ))  CM_COST " ).append("\n"); 
