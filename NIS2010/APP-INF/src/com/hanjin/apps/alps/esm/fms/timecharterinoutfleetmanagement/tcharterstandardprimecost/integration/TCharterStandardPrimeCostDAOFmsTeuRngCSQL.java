...
*@FileName : TCharterStandardPrimeCostDAOFmsTeuRngCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterStandardPrimeCostDAOFmsTeuRngCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TEU Range Target Insert
	  * </pre>
	  */
	public TCharterStandardPrimeCostDAOFmsTeuRngCSQL(){
		setQuery();
		...
		params.put("hir_aply_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TCharterStandardPrimeCostDAOFmsTeuRngCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into fms_teu_rng (" ).append("\n"); 
		...
		query.append("@[rng_yr]," ).append("\n"); 
		query.append("FMS_TEU_RNG_RNG_SEQ.nextval," ).append("\n"); 
		query.append("@[rng_fm_qty]," ).append("\n"); 
		query.append("@[rng_to_qty]," ).append("\n"); 
		query.append("@[hir_aply_flg]," ).append("\n"); 
		query.append("@[mkt_rt_aply_flg]," ).append("\n"); 
