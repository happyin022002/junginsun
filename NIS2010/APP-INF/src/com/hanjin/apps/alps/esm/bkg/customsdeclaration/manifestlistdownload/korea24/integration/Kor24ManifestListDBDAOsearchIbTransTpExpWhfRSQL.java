...
*@FileName : Kor24ManifestListDBDAOsearchIbTransTpExpWhfRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchIbTransTpExpWhfRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchIbTransTpExpWhfRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchIbTransTpExpWhfRSQL").append("\n");
		query.append("*/").append("\n");
	}
