 ...
 * @FileName : ESM_ACM_0040HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_ACM_0040HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0040Event event = new EsmAcm0040Event();

		if (command.isCommand(FormCommand.SEARCHLIST)) {
			event.setMdmCustomerGroupVO((MdmCustomerGroupVO)getVO(request, MdmCustomerGroupVO.class));
		}
