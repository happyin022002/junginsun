...
*@FileName : ChinaManifestListDownloadDBDAOsearchChinaVslRgstFromVskPortSkdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOsearchChinaVslRgstFromVskPortSkdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOsearchChinaVslRgstFromVskPortSkdRSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOsearchChinaVslRgstFromVskPortSkdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       TO_CHAR(VPS_ETA_DT, 'YYYY-MM-DD') AS ETA_DT," ).append("\n"); 
		query.append("       TO_CHAR(VPS_ETD_DT, 'YYYY-MM-DD') AS ETD_DT" ).append("\n"); 
		query.append("" ).append("\n"); 
