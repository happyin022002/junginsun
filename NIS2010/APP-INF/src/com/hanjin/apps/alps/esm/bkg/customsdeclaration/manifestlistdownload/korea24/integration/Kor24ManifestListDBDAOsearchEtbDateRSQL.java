...
*@FileName : Kor24ManifestListDBDAOsearchEtbDateRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchEtbDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * O/B 일경우 ETB Date를 구한다.
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchEtbDateRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchEtbDateRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("AND VPS_PORT_CD = @[in_pol]" ).append("\n");
