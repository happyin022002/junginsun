...
*@FileName : RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_RP_SCP_GRP_LOC_DTL Insert
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocDtlCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOGlineCopyPriRpScpGrpLocDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY B.SVC_SCP_CD,B.GLINE_SEQ,B.GRP_LOC_SEQ) AS GRP_LOC_SEQ" ).append("\n"); 
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD,B.GLINE_SEQ,B.GRP_LOC_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD,B.GLINE_SEQ,B.GRP_LOC_SEQ,B.GRP_LOC_DTL_SEQ) AS GRP_LOC_DTL_SEQ" ).append("\n"); 
