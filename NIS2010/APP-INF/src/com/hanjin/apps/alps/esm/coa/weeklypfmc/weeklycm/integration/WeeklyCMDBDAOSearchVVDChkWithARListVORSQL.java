...
public class WeeklyCMDBDAOSearchVVDChkWithARListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",DECODE(A.TRD_CD    ,NULL, 'AR Only', DECODE(B.TRD_CD, NULL, 'COA Only', 'BOTH') ) RSLT" ).append("\n"); 
		...
		query.append("RIGHT OUTER JOIN  /* AR ONLY 찾기 위해(COA_MON_VVD_IF 에만 있는 항차)*/" ).append("\n"); 
