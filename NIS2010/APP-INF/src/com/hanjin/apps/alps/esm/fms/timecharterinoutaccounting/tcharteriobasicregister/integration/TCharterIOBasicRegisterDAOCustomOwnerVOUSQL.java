...
public class TCharterIOBasicRegisterDAOCustomOwnerVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOBasicRegisterDAOCustomOwnerVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("update fms_owner set" ).append("\n"); 
		query.append("ownr_nm = @[ownr_nm]," ).append("\n"); 
		query.append("flet_ownr_tp_cd = @[flet_ownr_tp_cd]," ).append("\n"); 
		query.append("upd_usr_id = @[upd_usr_id]," ).append("\n"); 
		query.append("upd_dt = sysdate" ).append("\n"); 
		query.append("where	ownr_seq = @[ownr_seq]" ).append("\n"); 
