...
*@FileName : GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocDtlVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	B.LOC_NM AS LOC_NM" ).append("\n"); 
		query.append("FROM PRI_CMPB_GRP_LOC_DTL A" ).append("\n"); 
