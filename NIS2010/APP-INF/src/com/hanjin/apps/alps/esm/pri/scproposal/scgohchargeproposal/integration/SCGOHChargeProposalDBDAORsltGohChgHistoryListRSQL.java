...
*@FileName : SCGOHChargeProposalDBDAORsltGohChgHistoryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGOHChargeProposalDBDAORsltGohChgHistoryListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SC GOH Amend History List 조회
	  * 2012.02.23 이석준[CHM-201216153-01] S/C Amendment History 화면 기능 개선 요청
	  * </pre>
	  */
	public SCGOHChargeProposalDBDAORsltGohChgHistoryListRSQL(){
		setQuery();
		...
		query.append("FileName : SCGOHChargeProposalDBDAORsltGohChgHistoryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
