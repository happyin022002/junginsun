...
*@FileName : ESM_MAS_063HTMLAction.java
 ...
 *
 * @author Chilseo_Park
 * @see ESM_MAS_063Event , ESM_MAS_063EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_MAS_0063HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0063HTMLAction 객체를 생성
	 */
	public ESM_MAS_0063HTMLAction() {
		// 
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_MAS_063Event로 파싱하여 request에 셋팅<br>
	 *
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0063Event event = new EsmMas0063Event();
