...
*@FileName : ESM_PRI_2029HTMLAction.java
...
public class ESM_PRI_2029HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2029Event event = new EsmPri2029Event();
		if (command.isCommand(FormCommand.SEARCHLIST)) {
			SearchGuidelineRouteInquiryVO searchGuidelineRouteInquiryVO = (SearchGuidelineRouteInquiryVO) getVO(request, SearchGuidelineRouteInquiryVO.class);
			String pntLocCd = searchGuidelineRouteInquiryVO.getPntLocCd();
			if( pntLocCd != null ){
				String[] pntLocCds = pntLocCd.split(",");
				searchGuidelineRouteInquiryVO.setPntLocCds(pntLocCds);
			}			
			event.setSearchGuidelineRouteInquiryVO(searchGuidelineRouteInquiryVO);
		}
		return event;
	}
