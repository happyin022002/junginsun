...
*@FileName : LaneSimulationDBDAOModifyTMLOPDysListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOModifyTMLOPDysListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOModifyTMLOPDysListUSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOModifyTMLOPDysListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE coa_sim_tml_op_dys" ).append("\n"); 
		query.append("SET sea_dys          = @[sea_dys]," ).append("\n"); 
		query.append("port_dys         = @[port_dys]," ).append("\n"); 
		query.append("ttl_tz_dys       = @[ttl_tz_dys]," ).append("\n"); 
		query.append("aply_voy_rto     = @[aply_voy_rto]," ).append("\n"); 
