...
*@FileName : ESM_SPC_0086HTMLAction.java
...
public class ESM_SPC_0086HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0086HTMLAction 객체를 생성
	 */
	public ESM_SPC_0086HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0086Event event = new EsmSpc0086Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSpcTgtVvdVOs((SpcTgtVvdVO[])getVOs(request, SpcTgtVvdVO .class,""));
