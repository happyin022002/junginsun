...
*@FileName : ESM_BKG_0441HTMLAction.java
...
public class ESM_BKG_0441HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0441HTMLAction 객체를 생성
	 */
	public ESM_BKG_0441HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0441Event event = new EsmBkg0441Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgDpcsOfcTmVOS((BkgDpcsOfcTmVO[])getVOs(request, BkgDpcsOfcTmVO .class,""));
			event.setBkgDpcsOfcTmVO((BkgDpcsOfcTmVO)getVO(request, BkgDpcsOfcTmVO .class));
		}
