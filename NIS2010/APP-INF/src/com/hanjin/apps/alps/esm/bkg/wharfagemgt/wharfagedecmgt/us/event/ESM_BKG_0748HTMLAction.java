 ...
 *@FileName : ESM_BKG_0748HTMLAction.java
 ...
 * @see EsmBkg0748Event 참조
 * @since J2EE 1.4
 */
public class ESM_BKG_0748HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0748HTMLAction 객체를 생성
	 */
	public ESM_BKG_0748HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0748Event event = new EsmBkg0748Event();
		if (command.isCommand(FormCommand.SEARCH))
		{
			event.setUsWhfExceptCmdtListCondVO((UsWhfExceptCmdtListCondVO) getVO(request,
					UsWhfExceptCmdtListCondVO.class));
		}
		else if (command.isCommand(FormCommand.MULTI))
		{
			event.setUsWhfExceptCmdtVOs((UsWhfExceptCmdtVO[]) getVOs(request, UsWhfExceptCmdtVO.class));
		}
