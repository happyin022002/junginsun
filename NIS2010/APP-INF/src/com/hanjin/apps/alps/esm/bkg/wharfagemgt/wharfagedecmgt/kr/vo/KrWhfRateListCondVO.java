...
*@FileName : KrWhfRateListCondVO.java
*@FileTitle : KrWhfRateListCondVO
*Open Issues :
*Change history :
...
public class KrWhfRateListCondVO extends WhfRateListCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfRateListCondVO> models = new ArrayList<KrWhfRateListCondVO>();
	...
	public KrWhfRateListCondVO() {}

	public KrWhfRateListCondVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String blNo, 
			String whfBndCd, String whfDeclNo, String vvd) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 */
	public KrWhfRateListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfRateListCondVO[]
	 */
	public KrWhfRateListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfRateListCondVO model = null;
		...
		return getKrWhfRateListCondVOs();
	}
	 ...
	 * @return KrWhfRateListCondVO[]
	 */
	public KrWhfRateListCondVO[] getKrWhfRateListCondVOs(){
		KrWhfRateListCondVO[] vos = (KrWhfRateListCondVO[])models.toArray(new KrWhfRateListCondVO[models.size()]);
		return vos;
	}
