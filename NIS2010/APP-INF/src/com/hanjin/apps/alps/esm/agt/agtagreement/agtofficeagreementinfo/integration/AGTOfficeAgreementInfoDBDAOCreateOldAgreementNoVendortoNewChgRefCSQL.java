...
*@FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewChgRefCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewChgRefCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewChgRefCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewChgRefCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AGT_AGN_CHG_REF" ).append("\n"); 
