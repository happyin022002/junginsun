...
*@FileName : ESM_MAS_0152HTMLAction.java
...
public class ESM_MAS_0152HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0152HTMLAction 객체를 생성
	 */
	public ESM_MAS_0152HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0152Event event = new EsmMas0152Event();		
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMasMonMiscRevPreTeuVOS((MasMonMiscRevPreTeuVO[])getVOs(request, MasMonMiscRevPreTeuVO .class,""));
