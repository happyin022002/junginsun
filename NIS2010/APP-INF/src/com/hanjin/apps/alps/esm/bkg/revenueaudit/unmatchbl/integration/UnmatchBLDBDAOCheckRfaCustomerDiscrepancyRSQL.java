...
public class UnmatchBLDBDAOCheckRfaCustomerDiscrepancyRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("        SELECT NULL CUST_CNT_CD,  NULL CUST_SEQ,  'SPOT GUIDE'" ).append("\n"); 
		query.append("        FROM   DUAL" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("        SELECT NULL CUST_CNT_CD,  NULL CUST_SEQ,  'MASTER'" ).append("\n"); 
		query.append("        FROM   DUAL" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        /* SPOT GUIDE */" ).append("\n"); 
		query.append("        SELECT  NULL CUST_CNT_CD ," ).append("\n"); 
		...
		query.append("        WHERE   RM.PROP_NO  = RF.PROP_NO" ).append("\n"); 
		query.append("        AND     RM.AMDT_SEQ = RF.AMDT_SEQ" ).append("\n"); 
		query.append("        AND     RM.RFA_CTRT_TP_CD = 'G'" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		...
		query.append("        WHERE   RM.PROP_NO  = RF.PROP_NO" ).append("\n"); 
		query.append("        AND     RM.AMDT_SEQ = RF.AMDT_SEQ" ).append("\n"); 
		query.append("        AND     RM.RFA_CTRT_TP_CD = 'M'" ).append("\n"); 
