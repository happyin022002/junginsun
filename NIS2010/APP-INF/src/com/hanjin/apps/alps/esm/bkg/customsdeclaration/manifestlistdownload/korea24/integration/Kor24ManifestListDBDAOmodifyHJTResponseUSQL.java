...
*@FileName : Kor24ManifestListDBDAOmodifyHJTResponseUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyHJTResponseUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyHJTResponseUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyHJTResponseUSQL").append("\n");
		query.append("*/").append("\n");
	}
