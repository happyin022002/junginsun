...
*@FileName : ESM_BKG_0721HTMLAction.java
...
public class ESM_BKG_0721HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0721HTMLAction 객체를 생성
	 */
	public ESM_BKG_0721HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0721Event event = new EsmBkg0721Event();
		...
		if(command.isCommand(FormCommand.DEFAULT)||command.isCommand(FormCommand.SEARCH)) {
			...
			event.setBkgClzTmVOs((BkgClzTmVO[])getVOs(request,BkgClzTmVO.class));
		}
