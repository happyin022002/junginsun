...
*@FileName : RFARateQuotationDBDAOPriRqScgAdjVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqScgAdjVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqScgAdjVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqScgAdjVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO pri_rq_scg_adj(" ).append("\n"); 
		...
		query.append("@[qttn_no]," ).append("\n"); 
		query.append("@[qttn_ver_no]," ).append("\n"); 
		query.append("(select nvl(max(scg_adj_seq),0)+1 from pri_rq_scg_adj where  qttn_no = @[qttn_no] and qttn_ver_no = @[qttn_ver_no]) ," ).append("\n"); 
		query.append("@[prc_cmdt_tp_cd]," ).append("\n"); 
		query.append("@[prc_cmdt_def_cd]," ).append("\n"); 
		query.append("@[org_loc_tp_cd]," ).append("\n"); 
		query.append("@[org_loc_def_cd]," ).append("\n"); 
