 ...
 * @see EsmBis0000Event 참조
 * @since J2EE 1.5
 */

public class ESM_BIS_0000HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0000HTMLAction 객체를 생성
     */
    public ESM_BIS_0000HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBis0000Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBis0000Event event = new EsmBis0000Event();
		...
		if (command.isCommand(FormCommand.SEARCH)){
			...
			event.setBisManualListVOS((BisManualListVO[])getVOs(request, BisManualListVO .class,""));
			event.setBisManualListVO((BisManualListVO)getVO(request, BisManualListVO .class,""));
			event.setFromDt(fromDt);
			event.setToDt(toDt);	
		}
