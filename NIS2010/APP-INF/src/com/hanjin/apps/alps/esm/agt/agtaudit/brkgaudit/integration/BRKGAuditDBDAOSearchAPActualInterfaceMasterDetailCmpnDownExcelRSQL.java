...
*@FileName : BRKGAuditDBDAOSearchAPActualInterfaceMasterDetailCmpnDownExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BRKGAuditDBDAOSearchAPActualInterfaceMasterDetailCmpnDownExcelRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BRKGAuditDBDAOSearchAPActualInterfaceMasterDetailCmpnDownExcelRSQL(){
		setQuery();
		...
		query.append("FileName : BRKGAuditDBDAOSearchAPActualInterfaceMasterDetailCmpnDownExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		   ROUND(SUM(A.ACT_IF_COMM_AMT), 2) AS NET_AMT," ).append("\n"); 
		query.append("		   ROUND(SUM(A.ACT_IF_COMM_AMT * NVL(A.INV_TAX_RT, 0) / 100), 2) AS VAT," ).append("\n"); 
		query.append("		   ROUND(SUM(A.ACT_IF_COMM_AMT + (A.ACT_IF_COMM_AMT * NVL(A.INV_TAX_RT, 0) / 100)), 2) AS TOT_AMT," ).append("\n"); 
		...
		query.append("       AND A.COMM_PROC_STS_CD" ).append("\n"); 
		query.append("        IN" ).append("\n"); 
		query.append("         ( 'CE','IC','CS','CM','CA'" ).append("\n"); 
		query.append("         )" ).append("\n"); 
		...
		query.append("             FROM AGT_CMPN_COMM F" ).append("\n"); 
