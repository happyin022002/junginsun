...
*@FileName : ScOftAutoRatingDBDAOAddSurchargreAutoratingListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScOftAutoRatingDBDAOAddSurchargreAutoratingListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ScOftAutoRatingDBDAOAddSurchargreAutoratingList
	  * </pre>
	  */
	public ScOftAutoRatingDBDAOAddSurchargreAutoratingListCSQL(){
		setQuery();
		...
		params.put("rt_typ_note_conv_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ScOftAutoRatingDBDAOAddSurchargreAutoratingListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[usr_id]," ).append("\n"); 
		query.append("NVL((select max(OFRT_SEQ) FROM BKG_AUTO_RT_OCN_FRT_TMP),0)+1," ).append("\n"); 
		query.append("@[cntr_tpsz_cd]," ).append("\n"); 
		query.append("@[eq_subst_cntr_tpsz_cd]," ).append("\n"); 
		query.append("@[ctrt_cntr_tpsz_cd]," ).append("\n"); 
		query.append("@[rcv_term_cd]," ).append("\n"); 
