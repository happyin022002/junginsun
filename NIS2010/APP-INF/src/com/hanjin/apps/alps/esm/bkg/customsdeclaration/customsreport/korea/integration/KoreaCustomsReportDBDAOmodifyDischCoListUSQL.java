...
*@FileName : KoreaCustomsReportDBDAOmodifyDischCoListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOmodifyDischCoListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Discharging Company List 수정
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOmodifyDischCoListUSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOmodifyDischCoListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_DCHG_CO" ).append("\n"); 
		query.append("   SET CSTMS_DCHG_CO_NM = @[cstms_dchg_co_nm]" ).append("\n"); 
