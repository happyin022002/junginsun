...
*@FileName : EsmMas0321Event.java
*@FileTitle : EsmMas0321Event
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0321 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0321HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Jong-Ock KIM
 * @see ESM_MAS_0321HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0321Event extends EventSupport {
	...
	private BunkerTariffCostVO[] bunkerTariffCostVOs = null;
	
	public EsmMas0321Event(){}
	...
	public BunkerTariffCostVO[] getBunkerTariffCostVOs() {
		return bunkerTariffCostVOs;
	}

	public void setBunkerTariffCostVOs(BunkerTariffCostVO[] bunkerTariffCostVOs) {
		this.bunkerTariffCostVOs = bunkerTariffCostVOs;
	}
}
