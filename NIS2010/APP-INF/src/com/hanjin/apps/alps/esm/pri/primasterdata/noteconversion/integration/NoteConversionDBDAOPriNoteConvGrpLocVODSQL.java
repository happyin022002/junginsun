...
*@FileName : NoteConversionDBDAOPriNoteConvGrpLocVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NoteConversionDBDAOPriNoteConvGrpLocVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NoteConversionDBDAOPriNoteConvGrpLocVODSQL(){
		setQuery();
		...
		query.append("FileName : NoteConversionDBDAOPriNoteConvGrpLocVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_NOTE_CONV_GRP_LOC" ).append("\n"); 
