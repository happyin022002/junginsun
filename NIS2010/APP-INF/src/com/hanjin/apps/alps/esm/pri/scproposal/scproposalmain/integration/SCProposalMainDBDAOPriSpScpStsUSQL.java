...
*@FileName : SCProposalMainDBDAOPriSpScpStsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAOPriSpScpStsUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCProposalMainDBDAOPriSpScpStsUSQL
	  * </pre>
	  */
	public SCProposalMainDBDAOPriSpScpStsUSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAOPriSpScpStsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SP_SCP_MN MN" ).append("\n"); 
		...
		query.append("#if (${update_all} == 'N')" ).append("\n"); 
