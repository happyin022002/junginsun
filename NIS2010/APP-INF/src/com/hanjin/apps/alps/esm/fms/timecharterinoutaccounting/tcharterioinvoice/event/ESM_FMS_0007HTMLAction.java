...
*@FileName : ESM_FMS_0007HTMLAction.java
...
public class ESM_FMS_0007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0018HTMLAction 객체를 생성
	 */
	public ESM_FMS_0007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0007Event event = new EsmFms0007Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondSearchManhourListVO((CondSearchManhourListVO)getVO(request, CondSearchManhourListVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setCondSearchManhourListVO((CondSearchManhourListVO)getVO(request, CondSearchManhourListVO .class));
			event.setCustomManHrChgVOS((CustomManHrChgVO[])getVOs(request, CustomManHrChgVO .class, ""));
		}
