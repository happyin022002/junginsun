...
public class EBookingReceiptDBDAOsearchXterDescForRejectEdiRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT DECODE(SUBSTR(XTER_SNDR_ID, 1, 4), 'INTT', REPLACE(GDS_DESC,CHR(13)||CHR(10),CHR(10)||'DESC:'), 'TRAD', REPLACE(GDS_DESC,CHR(13)||CHR(10),CHR(10)||'DESC:'), NULL) BL_DESC" ).append("\n"); 
