 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_1178HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1178HTMLAction 객체를 생성
	 */
	public ESM_BKG_1178HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
			...
			EsmBkg1178Event event = new EsmBkg1178Event();
