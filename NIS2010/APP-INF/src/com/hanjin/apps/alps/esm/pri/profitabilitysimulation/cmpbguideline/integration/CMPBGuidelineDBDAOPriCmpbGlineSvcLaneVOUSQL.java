...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineSvcLaneVOUSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineSvcLaneVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineSvcLaneVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_SVC_LANE SET" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineSvcLaneVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}