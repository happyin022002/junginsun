...
*@FileName : VoMakeDAOSalesOffiRepoConditionVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VoMakeDAOSalesOffiRepoConditionVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VoMakeDAOSalesOffiRepoConditionVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.mas.multidimensionrpt.salesrpt.vo").append("\n"); 
		query.append("FileName : VoMakeDAOSalesOffiRepoConditionVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		'' AS F_ISSC,                                      " ).append("\n"); 
		query.append("		'' AS F_OTR_KEY_ACCT,                              " ).append("\n"); 
		query.append("		'' AS F_SA_TRD_GROUP_CD,                           " ).append("\n"); 
		query.append("		'' AS F_USR_OFC_LVL,                               " ).append("\n"); 
		query.append("		'' AS F_ISTPSZ,                                    " ).append("\n"); 
		query.append("		'' AS F_OFC_TEAM_CD,                               " ).append("\n"); 
		query.append("		'' AS F_OFC_LVL,                                   " ).append("\n"); 
		query.append("		'' AS F_R_MONTH_STS,                               " ).append("\n"); 
		query.append("		'' AS F_FM_WK,                                     " ).append("\n"); 
		query.append("		'' AS F_IAS_SECTER_STS,                            " ).append("\n"); 
		query.append("		'' AS F_SC_STS,                                    " ).append("\n"); 
		...
		query.append("		'' AS F_OFC_LVL2,                                  " ).append("\n"); 
		query.append("		'' AS F_PRD_CD,                                    " ).append("\n"); 
		query.append("		'' AS F_OFC_LVL1,                                  " ).append("\n"); 
		query.append("		'' AS F_INCLUDE_TS,                                " ).append("\n"); 
		query.append("		'' AS F_OFC_CD,                                    " ).append("\n"); 
		query.append("		'' AS F_PREV_WEEK,                                 " ).append("\n"); 
		query.append("		'' AS F_PRO_LVL,                                   " ).append("\n"); 
		query.append("		'' AS F_SUB_TRD_CD,                                " ).append("\n"); 
		query.append("		'' AS F_EXCEL,                                     " ).append("\n"); 
		query.append("		'' AS F_YEAR2,                                     " ).append("\n"); 
		query.append("		'' AS F_ISWEEK,                                    " ).append("\n"); 
		query.append("		'' AS F_ISVVD,                                     " ).append("\n"); 
		query.append("		'' AS F_STP_FLG,                                   " ).append("\n"); 
		query.append("		'' AS F_POL_CD,                                    " ).append("\n"); 
		query.append("		'' AS F_REV_POD_CD,                                " ).append("\n"); 
		query.append("		'' AS F_ISROUTE,                                   " ).append("\n"); 
		query.append("		'' AS F_ISSHPR,                                    " ).append("\n"); 
		query.append("		'' AS F_ISBKG,                                     " ).append("\n"); 
		query.append("		'' AS F_REP_CMDT_CD,                               " ).append("\n"); 
		query.append("		'' AS F_RFA_NO,      " ).append("\n"); 
		query.append("		'' AS F_MN_SCTR                    " ).append("\n"); 
		query.append("" ).append("\n"); 
