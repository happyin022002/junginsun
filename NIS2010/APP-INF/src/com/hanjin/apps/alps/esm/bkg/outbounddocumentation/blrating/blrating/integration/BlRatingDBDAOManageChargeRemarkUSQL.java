...
public class BlRatingDBDAOManageChargeRemarkUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  #if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("	INSERT INTO BKG_RT_HIS(BKG_NO, CORR_NO, DIFF_RMK, RT_INTER_RMK, DOC_INTER_RMK, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT,BKG_RT_WHF_EXPT_CD)" ).append("\n"); 
		query.append("	VALUES(@[bkg_no], 'TMP0000001', @[diff_rmk], @[inter_rmk], @[doc_inter_rmk], @[user_id], sysdate, @[user_id], sysdate, null)" ).append("\n"); 
		query.append("  #else " ).append("\n"); 
		query.append("	INSERT INTO BKG_RATE(BKG_NO, DIFF_RMK, RT_INTER_RMK, DOC_INTER_RMK, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT,BKG_RT_WHF_EXPT_CD)" ).append("\n"); 
		query.append("	VALUES(@[bkg_no], @[diff_rmk], @[inter_rmk], @[doc_inter_rmk], @[user_id], sysdate, @[user_id], sysdate, null)" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("      , RT_INTER_RMK = @[inter_rmk]" ).append("\n"); 
		query.append("      , DOC_INTER_RMK = @[doc_inter_rmk]" ).append("\n"); 
