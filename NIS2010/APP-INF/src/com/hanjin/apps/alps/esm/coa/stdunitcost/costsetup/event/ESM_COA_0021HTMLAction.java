...
*@FileName : ESM_COA_0021HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.coa.stdunitcost.costsetup 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author Kim Ki Dae
 * @see EsmCoa0021Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_0021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0021HTMLAction 객체를 생성
	 */
	public ESM_COA_0021HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCoa0021Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0021Event event = new EsmCoa0021Event();  		
