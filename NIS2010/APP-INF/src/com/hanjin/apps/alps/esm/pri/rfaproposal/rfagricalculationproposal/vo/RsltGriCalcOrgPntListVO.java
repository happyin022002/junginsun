...
*@FileName : RsltGriCalcOrgPntListVO.java
*@FileTitle : RsltGriCalcOrgPntListVO
*Open Issues :
*Change history :
...
public class RsltGriCalcOrgPntListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltGriCalcOrgPntListVO> models = new ArrayList<RsltGriCalcOrgPntListVO>();
...
/**
	 ...
	 * @param request
	 * @return RsltGriCalcOrgPntListVO[]
	 */
	public RsltGriCalcOrgPntListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltGriCalcOrgPntListVO[]
	 */
	public RsltGriCalcOrgPntListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltGriCalcOrgPntListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltGriCalcOrgPntListVO();
				if (updDt[i] != null)
		...
		return getRsltGriCalcOrgPntListVOs();
	}
	 ...
	 * @return RsltGriCalcOrgPntListVO[]
	 */
	public RsltGriCalcOrgPntListVO[] getRsltGriCalcOrgPntListVOs(){
		RsltGriCalcOrgPntListVO[] vos = (RsltGriCalcOrgPntListVO[])models.toArray(new RsltGriCalcOrgPntListVO[models.size()]);
		return vos;
	}
