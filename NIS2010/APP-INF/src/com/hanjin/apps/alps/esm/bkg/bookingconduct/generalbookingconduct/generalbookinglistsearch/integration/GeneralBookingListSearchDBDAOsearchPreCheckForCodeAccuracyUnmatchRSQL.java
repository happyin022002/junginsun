...
*@FileName : GeneralBookingListSearchDBDAOsearchPreCheckForCodeAccuracyUnmatchRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingListSearchDBDAOsearchPreCheckForCodeAccuracyUnmatchRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralBookingListSearchDBDAOsearchPreCheckForCodeAccuracyUnmatchRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingListSearchDBDAOsearchPreCheckForCodeAccuracyUnmatchRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                               AND (TO_DATE(@[vps_etd_dt_end], 'YYYYMMDD') +1)  -- DURATION (OPTIO함L 2)" ).append("\n"); 
