...
*@FileName : BLInformationMgtDBDAOCaSummaryReportInVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLInformationMgtDBDAOCaSummaryReportInVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLInformationMgtDBDAOCaSummaryReportInVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bis.blinformationmgt.blinformationmgt.integration").append("\n"); 
		query.append("FileName : BLInformationMgtDBDAOCaSummaryReportInVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
