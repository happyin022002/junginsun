...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportBySalesOfcRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportBySalesOfcRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportBySalesOfcRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportBySalesOfcRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,BKG.RGN_CNT" ).append("\n"); 
		query.append("      ,BKG.OFC_CNT" ).append("\n"); 
		...
		query.append("              ,BKG.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("              ,BKG.OB_SLS_OFC_CD" ).append("\n"); 
		query.append("              ,(SELECT SUBSTR(LOC_CD,0,2) FROM MDM_ORGANIZATION WHERE OFC_CD = BKG.SLS_RGN_OFC_CD) RGN_CNT            " ).append("\n"); 
		query.append("              ,(SELECT SUBSTR(LOC_CD,0,2) FROM MDM_ORGANIZATION WHERE OFC_CD = BKG.OB_SLS_OFC_CD) OFC_CNT" ).append("\n"); 
