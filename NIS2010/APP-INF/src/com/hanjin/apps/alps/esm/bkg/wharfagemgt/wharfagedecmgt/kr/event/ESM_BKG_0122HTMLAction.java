 ...
 *@FileName : ESM_BKG_0122HTMLAction.java
 *@FileTitle : ESM_BKG_0122HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0122HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0122Event event = new EsmBkg0122Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setKrWhfVslInfoCondVO ( (KrWhfVslInfoCondVO)getVO( request, KrWhfVslInfoCondVO.class ) );
		} else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setKrWhfCgoClassCondVO( (KrWhfCgoClassCondVO)getVO( request, KrWhfCgoClassCondVO.class ) ); 
