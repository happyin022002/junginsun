...
*@FileName : Kor24ManifestListDBDAOsearchFullEmpCntrSumRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchFullEmpCntrSumRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchFullEmpCntrSumRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchFullEmpCntrSumRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("HAVING SUBSTR(MAX(TO_CHAR(TRNS_SEQ, '00')||NVL(DELT_FLG, 'N')), 4) != 'Y') T, BKG_CSTMS_ADV_KR_BL T2, BKG_CSTMS_ADV_KR_CNTR C" ).append("\n");
