 ...
 * 2012.11.19 윤태승
 * 1.0 Creation
 * 2012.12.13 [CHM-201221941] 미얀마 세관 EDI 기능 수정 요청
=========================================================*/

package com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.basic;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.integration.MyanmarCustomsTransmissionDBDAO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.BkgCstmsMySndLogDtlVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.BkgCstmsMySndLogVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestCntrSealNoInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestCustomerInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestLocInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestMarkInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestTransmitVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestVslInfoVO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestBlInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.myanmar.vo.MyanmarManifestDescInfoVO;
 ...
 * - NIS2010-Myanmar Customs Manifest 비지니스 로직을 처리한다.<br>
 * 
 * @author Tae Seung Yun  
 * @see EventResponse,MyanmarCustomsTransmissionBC 각 DAO 클래스 참조
 * @since J2EE 1.4
 */
public class MyanmarCustomsTransmissionBCImpl extends CustomsTransmissionBCImpl {
	// Database Access Object
	private transient MyanmarCustomsTransmissionDBDAO dbDao = null;

	/**
	 * MyanmarCustomsTransmissionBCImpl 객체 생성<br>
	 * MyanmarCustomsTransmissionBCImpl 생성한다.<br>
	 */
	...
	public String transmitManifest(ManifestTransmitVO[] manifestTransmitVOs, SignOnUserAccount account) throws EventException {
		...
		// VSL 정보
		MyanmarManifestVslInfoVO 				myanmarVslInfoVO 			= null;
		// Location 정보
		List<MyanmarManifestLocInfoVO> 			myanmarLocInfoList 			= null;
		// Customer 정보
		List<MyanmarManifestCustomerInfoVO> 	myanmarCustomerInfoList 	= null;
		// Mark 정보
		MyanmarManifestMarkInfoVO 				myanmarManifestMarkInfoVO 	= null;
		// Container Seal 정보
		List<MyanmarManifestCntrSealNoInfoVO> 	myanmarCntrSealNoInfoList 	= null;
		//Container Input 정보
		MyanmarManifestListCntrInfoVO 			myanmarCntrInputList 		= null;
		...
		// SEND DATE
		String sndDt = null;
		MyanmarManifestListBlInfoVO temp = null;
		...
		try
		{
			...
			if( myanmarBlInputList != null ){
				...
				for( blSeIdx = 0; blSeIdx < myanmarBlInputList.size(); blSeIdx++) {
					...
					flatFile.append("BLNBR:")			.append("SMLM"+myanmarBlInputList.get(blSeIdx).getBlNo()).append("\n");
...
//			List<BkgCstmsMySndLogDtlVO> bkgCstmsMySndLogDtlList = new ArrayList<BkgCstmsMySndLogDtlVO>();
			...
			if (myanmarBlInputList != null){			
				for( blSeIdx = 0; blSeIdx < myanmarBlInputList.size(); blSeIdx++) {
					if(bkgCstmsMySndLogVO != null && myanmarVslInfoVO != null) {
						bkgCstmsMySndLogVO.setMmMfSndIndCd(myanmarVslInfoVO.getStatus());
						bkgCstmsMySndLogVO.setFltFileRefNo(flatFileRefNo);
						bkgCstmsMySndLogVO.setVvd(myanmarVslInfoVO.getVvd());
