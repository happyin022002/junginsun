...
*@FileName : KorCustomsTransmissionDBDAOmakeAutoIMFMODFlatFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeAutoIMFMODFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeAutoIMFMODFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeAutoIMFMODFlatFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
