...
*@FileName : BangladeshManifestTransmitVO.java
*@FileTitle : BangladeshManifestTransmitVO
*Open Issues :
*Change history :
...
public class BangladeshManifestTransmitVO extends ManifestTransmitVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<BangladeshManifestTransmitVO> models = new ArrayList<BangladeshManifestTransmitVO>();
	...
	public BangladeshManifestTransmitVO() {}

	public BangladeshManifestTransmitVO(String ibflag, String pagerows, String etaDt, String authNo, String delCd, String vslNm, String etdDt, String blNo, String actWgt, String bkgNo, String polCd, String carrierNo, String wgtUtCd, String measQty, String bkgCgoTpCd, String pckQty, String regNo, String pckTpCd, String measUtCd, String customsOfficeCode, String vvd, String callPort, String vslCd, String skdVoyNo, String skdDirCd, String podCd) {
		this.vslCd = vslCd;
		this.etaDt = etaDt;
		this.blNo = blNo;
	 ...
	 * @param request
	 * @return BangladeshManifestTransmitVO[]
	 */
	public BangladeshManifestTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BangladeshManifestTransmitVO[]
	 */
	public BangladeshManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BangladeshManifestTransmitVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BangladeshManifestTransmitVO();
				if (vslCd[i] != null)
		...
		return getBangladeshManifestTransmitVOs();
	}
	...
	public BangladeshManifestTransmitVO[] getBangladeshManifestTransmitVOs(){
		BangladeshManifestTransmitVO[] vos = (BangladeshManifestTransmitVO[])models.toArray(new BangladeshManifestTransmitVO[models.size()]);
		return vos;
	}
