...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorCntrDgVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorDiscEtbVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorDiscHeadInfoVO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorImpPrtBlInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorImpPrtCntrVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorImpPrtCustVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorImpPrtLocNmVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorImpPrtMsnVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorImpPrtVslNmVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorMrnCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorMrnInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorMrnVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorMsnInfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorOFMCustVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorPntBlQtyVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorPntCustNmVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.korea.vo.KorPntDchgLocVO;
...
public class KoreaCustomsReportDBDAO extends DBDAOSupport 
{
	...
	/**
	 * 한국 세관에 적하 목록 전송할 Discharging Company 리스트 조회
	 * 
	 * @param KorDischCoCondVO korDischCoCondVO
	 * @return KorDischCoVO[]
	 * @exception DAOException
	 */
	@SuppressWarnings("unchecked")
	public KorDischCoVO[] searchDischCoList(KorDischCoCondVO korDischCoCondVO) throws DAOException {
		KorDischCoVO[] korDischCoVOs = null;
		List<KorDischCoVO> korDischCoVOList = null;
		DBRowSet dbRowset = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		//parameter Setting
		Map<String, String> mapVO = korDischCoCondVO.getColumnValues();
		param.putAll(mapVO);
		velParam.putAll(mapVO);
		
		try{
			if(korDischCoCondVO != null) {
				
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new KoreaCustomsReportDBDAOsearchDischCoListRSQL(), param, velParam);
				korDischCoVOList = (List)RowSetUtil.rowSetToVOs(dbRowset, KorDischCoVO.class);
				if (korDischCoVOList!=null) korDischCoVOs = korDischCoVOList.toArray(new KorDischCoVO[0]);
			}
		}catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage(), se);
	 ...
	 * Discharging CY Code List 삭제
	 * 
	 * @param KorDischCoCondVO[] korDischCoCondVOs
	 * @exception DAOException
	 */
	public void removeDischCoList(KorDischCoCondVO[] korDischCoCondVOs) throws DAOException
	{
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try {
			for(int i=0; i < korDischCoCondVOs.length; i++) {
				mapVO = korDischCoCondVOs[i].getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				new SQLExecuter("").executeUpdate((ISQLTemplate) new KoreaCustomsReportDBDAOremoveDischCoListDSQL(),param, velParam);
			}
		}catch(SQLException se) 
		{
			log.error(se.getMessage(), se);
	 ...
	 * @exception DAOException
	 */
	public void addDischCoList(KorDischCoCondVO[] korDischCoCondVOs) throws DAOException
	{
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try {
			for(int i=0; i < korDischCoCondVOs.length; i++) {
				...
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				new SQLExecuter("").executeUpdate((ISQLTemplate) new KoreaCustomsReportDBDAOaddDischCoListCSQL(),param, velParam);
			}
		}catch(SQLException se) 
		{
			log.error(se.getMessage(), se);
	 ...
	 * @exception DAOException
	 */
	public void modifyDischCoList(KorDischCoCondVO[] korDischCoCondVOs) throws DAOException
	{
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try {
			for(int i=0; i < korDischCoCondVOs.length; i++) {
				...
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				new SQLExecuter("").executeUpdate((ISQLTemplate) new KoreaCustomsReportDBDAOmodifyDischCoListUSQL(),param, velParam);
			}
		}catch(SQLException se) 
		{
			log.error(se.getMessage(), se);
	...
	/**
	 * 수신 상세 내역 조회
	 * @param KorRcvHistDtlCondVO rcvHistDtlCondVO
	 * @return KorRcvHistDtlVO[]
	 * @exception DAOException
	 */
	@SuppressWarnings("unchecked")
	
	public List<KorRcvHistDtlVO> searchRcvHistDtl(KorRcvHistDtlCondVO rcvHistDtlCondVO) throws DAOException
	{
		List<KorRcvHistDtlVO> list = null;
		DBRowSet dbRowset = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		try {
			if (rcvHistDtlCondVO != null) {
				Map<String, String> mapVO = rcvHistDtlCondVO.getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
			}
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new KoreaCustomsReportDBDAOsearchRcvHistDtlRSQL(), param, velParam);
			if (dbRowset==null) return null;
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, KorRcvHistDtlVO.class);
		}
		catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage(), se);
