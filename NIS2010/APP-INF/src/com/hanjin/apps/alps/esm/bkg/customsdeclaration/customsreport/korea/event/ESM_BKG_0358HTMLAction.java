...
*@FileName : ESM_BKG_0358HTMLAction.java
*@FileTitle : ESM_BKG_0358HTMLAction
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0358HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 2792293631096541043L;

	public ESM_BKG_0358HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		// EVENT 생성
		EsmBkg0358Event event = new EsmBkg0358Event();
		
		// COMMAND 구분에 따른 처리
		if(command.isCommand(FormCommand.SEARCH)) 
    	{
			// 조회의 경우 처리
			KorMrnCondVO korMrnCondVO = (KorMrnCondVO)getVO(request, KorMrnCondVO.class);
			event.setKorMrnCondVO(korMrnCondVO);
    	}
