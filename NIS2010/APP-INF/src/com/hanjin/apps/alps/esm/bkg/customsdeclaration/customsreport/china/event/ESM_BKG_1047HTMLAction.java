...
*@FileName : ESM_BKG_1047HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_1047HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1047HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1047HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1047Event event = new EsmBkg1047Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			transmitHistCondVO = (ChinaTransmitHistCondVO)getVO(request, ChinaTransmitHistCondVO.class);
			event.setChinaTransmitHistCondVO((ChinaTransmitHistCondVO)transmitHistCondVO);
		} 
