...
public class NetworkCostDBDAOSearchBunkerTariffYmListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * [CHM-201215754-01] [COA] Bunker Fee 화면 개발 건 쿼리 변경
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("      , (SELECT COA_GET_BNK_LTST_WK_FNC(SUBSTR(D1.SLS_YRMON,1,4),D1.COST_WK,D1.SLAN_CD,D1.RLANE_CD,D1.VSL_CD,D1.DIR_CD) FROM DUAL) FOIL_12_DESC" ).append("\n"); 
		query.append("   FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
