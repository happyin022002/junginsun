...
*@FileName : ESM_MAS_0081HTMLAction.java
...
public class ESM_MAS_0081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0081HTMLAction 객체를 생성
	 */
	public ESM_MAS_0081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0081Event event = new EsmMas0081Event();
