...
public class ESM_PRI_2067HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2067Event event = new EsmPri2067Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setRsltRtListVerticalExcelForAeeAewVOs((RsltRtListVerticalExcelForAeeAewVO[]) getVOs(request, RsltRtListVerticalExcelForAeeAewVO.class, ""));
