...
public class RocsSearchCmInfoVO extends AbstractValueObject {
	...
	public RocsSearchCmInfoVO(String ibflag, String pagerows, String cmSeqNo, String cmPkgNo, String cmPkgCd, String cmHsCd, String cmDesc, String cmWgt, String cmWgtU, String cmCntrNo) {
		this.ibflag = ibflag;
	...
	public RocsSearchCmInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cmCntrNo = (JSPUtil.getParameter(request, prefix	+ "cm_cntr_no".trim(), length));
			String[] cmDesc = (JSPUtil.getParameter(request, prefix	+ "cm_desc".trim(), length));
			String[] cmWgtU = (JSPUtil.getParameter(request, prefix	+ "cm_wgt_u".trim(), length));
			String[] cmSeqNo = (JSPUtil.getParameter(request, prefix	+ "cm_seq_no".trim(), length));
			String[] cmPkgCd = (JSPUtil.getParameter(request, prefix	+ "cm_pkg_cd".trim(), length));
			String[] cmPkgNo = (JSPUtil.getParameter(request, prefix	+ "cm_pkg_no".trim(), length));
			String[] cmWgt = (JSPUtil.getParameter(request, prefix	+ "cm_wgt".trim(), length));
			String[] cmHsCd = (JSPUtil.getParameter(request, prefix	+ "cm_hs_cd".trim(), length));
