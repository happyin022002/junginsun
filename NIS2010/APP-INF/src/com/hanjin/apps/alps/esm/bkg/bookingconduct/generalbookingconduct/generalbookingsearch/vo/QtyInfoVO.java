...
public class QtyInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<QtyInfoVO> models = new ArrayList<QtyInfoVO>();
	...
	public QtyInfoVO(String ibflag, String pagerows, String psaSerNo, String subPsaSerNo, String psaIfCd, String bkgNo, String bkgSeq, String cntrTpszCd, String cntrQty, String ydCd, String usrId) {
		this.bkgNo = bkgNo;
...
/**
	 ...
	 * @return QtyInfoVO[]
	 */
	public QtyInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return QtyInfoVO[]
	 */
	public QtyInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		QtyInfoVO model = null;
	...
	public QtyInfoVO[] getQtyInfoVOs(){
		QtyInfoVO[] vos = (QtyInfoVO[])models.toArray(new QtyInfoVO[models.size()]);
		return vos;
	}
