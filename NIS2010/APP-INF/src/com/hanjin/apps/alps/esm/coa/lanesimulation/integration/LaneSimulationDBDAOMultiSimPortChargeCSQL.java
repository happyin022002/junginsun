...
*@FileName : LaneSimulationDBDAOMultiSimPortChargeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimPortChargeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimPortChargeCSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimPortChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COA_SIM_PORT_CHG(" ).append("\n"); 
