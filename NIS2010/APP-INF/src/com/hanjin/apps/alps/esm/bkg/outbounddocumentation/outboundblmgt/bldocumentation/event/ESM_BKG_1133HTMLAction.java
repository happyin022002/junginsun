 ...
 *@FileName : ESM_BKG_360HTMLAction.java
...
public class ESM_BKG_1133HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;

    /**
     * ESM_BKG_360HTMLAction 객체를 생성
     */
    public ESM_BKG_1133HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg1133Event event = new EsmBkg1133Event();
        
        if (command.isCommand(FormCommand.SEARCH)){
			event.setBkgCustShpRqstVO((BkgCustShpRqstVO) getVO(request, BkgCustShpRqstVO.class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			
			event.setBkgCustShpRqstVOs((BkgCustShpRqstVO[])getVOs(request, BkgCustShpRqstVO .class));
