...
*@FileName : ESM_PRI_4023HTMLAction.java
...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.pri.primasterdata.organization.event;
...
public class ESM_PRI_4023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_4023HTMLAction 객체를 생성
	 */
	public ESM_PRI_4023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri4023Event event = new EsmPri4023Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMdmOrzVO((MdmOrzVO)getVO(request, MdmOrzVO .class));
		}
