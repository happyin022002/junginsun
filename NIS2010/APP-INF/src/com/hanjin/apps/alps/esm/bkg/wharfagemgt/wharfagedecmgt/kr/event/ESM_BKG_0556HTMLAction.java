 ...
 *@FileName : ESM_BKG_0556HTMLAction.java
 *@FileTitle : ESM_BKG_0556HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_BKG_0556HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0556HTMLAction 객체를 생성
	 */
	public ESM_BKG_0556HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0556Event event = new EsmBkg0556Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			
			event.setKrWhfCommInvListCondVO( (KrWhfCommInvListCondVO)getVO(request, KrWhfCommInvListCondVO.class) );  
		} 		
