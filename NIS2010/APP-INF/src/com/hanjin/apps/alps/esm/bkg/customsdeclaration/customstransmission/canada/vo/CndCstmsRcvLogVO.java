...
*@FileName : CstmsRcvLogVO.java
*@FileTitle : CstmsRcvLogVO
*Open Issues :
*Change history :
 ...
 */
public class CndCstmsRcvLogVO extends CstmsRcvLogVO {

    private static final long serialVersionUID = 1L;

    private Collection<CndCstmsRcvLogVO> models = new ArrayList<CndCstmsRcvLogVO>();
    ...
    /* Column Info */
    private List<BkgCstmsAdvSndLogVO> bkgCstmsAdvSndSwgLogVOs = null;
	 ...
	 * @return updUsrId
	 */
    public List<BkgCstmsAdvSndLogVO> getBkgCstmsAdvSndSwgLogVOs() {
        return bkgCstmsAdvSndSwgLogVOs;
    }
	 ...
	 * @param updUsrId
	 */
    public void setBkgCstmsAdvSndSwgLogVOs(List<BkgCstmsAdvSndLogVO> bkgCstmsAdvSndSwgLogVOs) {
        this.bkgCstmsAdvSndSwgLogVOs = bkgCstmsAdvSndSwgLogVOs;
    }
	 ...
	 */
    public CndCstmsRcvLogVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CndCstmsRcvLogVO[]
	 */
    public CndCstmsRcvLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        CndCstmsRcvLogVO model = null;
	 ...
	 * @return CndCstmsRcvLogVO[]
	 */
    public CndCstmsRcvLogVO[] getCndCstmsRcvLogVOs() {
        CndCstmsRcvLogVO[] vos = (CndCstmsRcvLogVO[]) models.toArray(new CndCstmsRcvLogVO[models.size()]);
        return vos;
    }
