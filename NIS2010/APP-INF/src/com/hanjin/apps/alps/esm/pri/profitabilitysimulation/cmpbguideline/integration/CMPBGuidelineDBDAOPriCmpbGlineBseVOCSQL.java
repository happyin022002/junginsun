...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineBseVOCSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineBseVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineBseVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineBseVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}