...
public class StatusManageDBDAOSearchQtaEstablishingStatusListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * [CHM-201537722] [CSR 전환건] QTA Establishing Status Management 화면 내 신규칼럼 추가(업데이트 유저 이름 나오게 함)
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("            AND INTG_CD_VAL_CTNT = SQM_VER_STS_CD" ).append("\n"); 
		query.append("         ) AS SQM_VER_STS_DESC" ).append("\n"); 
		...
		query.append("    FROM SQM_QTA_STEP_VER A, COM_USER B" ).append("\n"); 
