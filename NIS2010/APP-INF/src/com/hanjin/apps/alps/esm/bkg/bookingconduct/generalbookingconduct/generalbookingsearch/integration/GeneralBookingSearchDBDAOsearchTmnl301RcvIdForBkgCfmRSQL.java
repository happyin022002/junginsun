...
*@FileName : GeneralBookingSearchDBDAOsearchTmnl301RcvIdForBkgCfmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingSearchDBDAOsearchTmnl301RcvIdForBkgCfmRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchTmnl301RcvIdForBkgCfm
	  * </pre>
	  */
	public GeneralBookingSearchDBDAOsearchTmnl301RcvIdForBkgCfmRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingSearchDBDAOsearchTmnl301RcvIdForBkgCfmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT EDI_RCV_ID, PORT_CD, EDI_ID" ).append("\n"); 
