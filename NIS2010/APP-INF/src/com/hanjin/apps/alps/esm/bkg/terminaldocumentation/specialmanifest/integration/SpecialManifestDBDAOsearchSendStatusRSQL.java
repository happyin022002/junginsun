...
*@FileName : SpecialManifestDBDAOsearchSendStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchSendStatusRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchSendStatusRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchSendStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(*), 0, 'N', 'Y') SEND_STATUS" ).append("\n"); 
