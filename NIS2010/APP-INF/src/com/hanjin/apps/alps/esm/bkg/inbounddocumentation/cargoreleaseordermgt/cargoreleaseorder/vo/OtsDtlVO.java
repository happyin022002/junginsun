...
public class OtsDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OtsDtlVO> models = new ArrayList<OtsDtlVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		setAdjLstUpdDt(JSPUtil.getParameter(request, "adj_lst_upd_dt", ""));
		setAdjFrtAmt(JSPUtil.getParameter(request, "adj_frt_amt", ""));
		setPreCfmOfcCurrRto(JSPUtil.getParameter(request, "pre_cfm_ofc_curr_rto", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setCfmOfcCurrRto(JSPUtil.getParameter(request, "cfm_ofc_curr_rto", ""));
		setInvLstUpdDt(JSPUtil.getParameter(request, "inv_lst_upd_dt", ""));
		setBalWfgAmt(JSPUtil.getParameter(request, "bal_wfg_amt", ""));
		setBalRsvUsdAmt(JSPUtil.getParameter(request, "bal_rsv_usd_amt", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setPreCfmUsdRto(JSPUtil.getParameter(request, "pre_cfm_usd_rto", ""));
		setBalWfgUsdAmt(JSPUtil.getParameter(request, "bal_wfg_usd_amt", ""));
		setInvCttAmt(JSPUtil.getParameter(request, "inv_ctt_amt", ""));
		setCltCttAmt(JSPUtil.getParameter(request, "clt_ctt_amt", ""));
		setBalCttUsdAmt(JSPUtil.getParameter(request, "bal_ctt_usd_amt", ""));
		setBalFrtAmt(JSPUtil.getParameter(request, "bal_frt_amt", ""));
		setCltWfgAmt(JSPUtil.getParameter(request, "clt_wfg_amt", ""));
		setCltBlNo(JSPUtil.getParameter(request, "clt_bl_no", ""));
		setPpdAmt(JSPUtil.getParameter(request, "ppd_amt", ""));
		setBalLstUpdDt(JSPUtil.getParameter(request, "bal_lst_upd_dt", ""));
		setBalFrtOfcCurrAmt(JSPUtil.getParameter(request, "bal_frt_ofc_curr_amt", ""));
		setAdjCttAmt(JSPUtil.getParameter(request, "adj_ctt_amt", ""));
		setInvRsvAmt(JSPUtil.getParameter(request, "inv_rsv_amt", ""));
		setCltFrtAmt(JSPUtil.getParameter(request, "clt_frt_amt", ""));
		setAdjTaxAmt(JSPUtil.getParameter(request, "adj_tax_amt", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setInvWfgAmt(JSPUtil.getParameter(request, "inv_wfg_amt", ""));
		setCltLstUpdDt(JSPUtil.getParameter(request, "clt_lst_upd_dt", ""));
		setWrtfAmt(JSPUtil.getParameter(request, "wrtf_amt", ""));
		setInvTaxAmt(JSPUtil.getParameter(request, "inv_tax_amt", ""));
		setAdjWfgAmt(JSPUtil.getParameter(request, "adj_wfg_amt", ""));
		setPpdLstUpdDt(JSPUtil.getParameter(request, "ppd_lst_upd_dt", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setBalRsvAmt(JSPUtil.getParameter(request, "bal_rsv_amt", ""));
		setBalCttAmt(JSPUtil.getParameter(request, "bal_ctt_amt", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setBalCttOfcCurrAmt(JSPUtil.getParameter(request, "bal_ctt_ofc_curr_amt", ""));
		setCltRsvAmt(JSPUtil.getParameter(request, "clt_rsv_amt", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setBalTaxUsdAmt(JSPUtil.getParameter(request, "bal_tax_usd_amt", ""));
		setBlCurrCd(JSPUtil.getParameter(request, "bl_curr_cd", ""));
		setBalTaxOfcCurrAmt(JSPUtil.getParameter(request, "bal_tax_ofc_curr_amt", ""));
		setInvNo(JSPUtil.getParameter(request, "inv_no", ""));
		setOfcCd(JSPUtil.getParameter(request, "ofc_cd", ""));
		setBalFrtUsdAmt(JSPUtil.getParameter(request, "bal_frt_usd_amt", ""));
		setInvFrtAmt(JSPUtil.getParameter(request, "inv_frt_amt", ""));
		setBalTaxAmt(JSPUtil.getParameter(request, "bal_tax_amt", ""));
		setAdjRsvAmt(JSPUtil.getParameter(request, "adj_rsv_amt", ""));
		setCltTaxAmt(JSPUtil.getParameter(request, "clt_tax_amt", ""));
		setCfmUsdRto(JSPUtil.getParameter(request, "cfm_usd_rto", ""));
		setWrtfLstUpdDt(JSPUtil.getParameter(request, "wrtf_lst_upd_dt", ""));
		setBalWfgOfcCurrAmt(JSPUtil.getParameter(request, "bal_wfg_ofc_curr_amt", ""));
		setBalRsvOfcCurrAmt(JSPUtil.getParameter(request, "bal_rsv_ofc_curr_amt", ""));
	}
	 ...
	 * @return OtsDtlVO[]
	 */
	public OtsDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OtsDtlVO[]
	 */
	public OtsDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OtsDtlVO model = null;
	...
	public OtsDtlVO[] getOtsDtlVOs(){
		OtsDtlVO[] vos = (OtsDtlVO[])models.toArray(new OtsDtlVO[models.size()]);
		return vos;
	}
