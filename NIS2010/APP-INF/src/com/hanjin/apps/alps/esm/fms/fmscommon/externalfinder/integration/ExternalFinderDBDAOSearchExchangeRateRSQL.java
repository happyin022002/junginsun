...
*@FileName : ExternalFinderDBDAOSearchExchangeRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExternalFinderDBDAOSearchExchangeRateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ExternalFinderDBDAOSearchExchangeRateRSQL
	  * </pre>
	  */
	public ExternalFinderDBDAOSearchExchangeRateRSQL(){
		setQuery();
		...
		query.append("FileName : ExternalFinderDBDAOSearchExchangeRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND CURR_CD = 'KRW'" ).append("\n"); 
