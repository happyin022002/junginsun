...
*@FileName : RFARateProposalDBDAORqCpPriRpScpRtRoutPntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORqCpPriRpScpRtRoutPntCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RqCpPriRpScpRtRoutPnt
	  * </pre>
	  */
	public RFARateProposalDBDAORqCpPriRpScpRtRoutPntCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORqCpPriRpScpRtRoutPntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,PRI_RQ_RT_ROUT_PNT S" ).append("\n"); 
