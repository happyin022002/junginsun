...
*@FileName : ESM_BKG_1424HTMLAction.java
...
public class ESM_BKG_1424HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1424HTMLAction 객체를 생성
	 */
	public ESM_BKG_1424HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1424Event event = new EsmBkg1424Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setIranDthBKGListForAuditVO((IranDthBKGListForAuditVO)getVO(request,IranDthBKGListForAuditVO.class));
		}
