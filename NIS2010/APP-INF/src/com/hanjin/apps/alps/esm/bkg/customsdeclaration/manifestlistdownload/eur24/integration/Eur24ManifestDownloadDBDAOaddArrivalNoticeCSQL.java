...
*@FileName : Eur24ManifestDownloadDBDAOaddArrivalNoticeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOaddArrivalNoticeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 구주세관 Vessel Arrival Notice 입력
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOaddArrivalNoticeCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOaddArrivalNoticeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
