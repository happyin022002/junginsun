...
*@FileName : NoteConversionDBDAOPriNoteConvGrpLocDtlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NoteConversionDBDAOPriNoteConvGrpLocDtlVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NoteConversionDBDAOPriNoteConvGrpLocDtlVOCSQL(){
		setQuery();
		...
		query.append("FileName : NoteConversionDBDAOPriNoteConvGrpLocDtlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_NOTE_CONV_GRP_LOC_DTL (" ).append("\n"); 
