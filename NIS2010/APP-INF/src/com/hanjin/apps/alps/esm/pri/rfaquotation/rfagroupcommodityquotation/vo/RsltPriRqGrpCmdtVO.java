...
*@FileName : RsltPriRqGrpCmdtVO.java
*@FileTitle : RsltPriRqGrpCmdtVO
*Open Issues :
*Change history :
...
public class RsltPriRqGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRqGrpCmdtVO> models = new ArrayList<RsltPriRqGrpCmdtVO>();
	...
	public RsltPriRqGrpCmdtVO() {}

	public RsltPriRqGrpCmdtVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public RsltPriRqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqGrpCmdtVO[]
	 */
	public RsltPriRqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqGrpCmdtVO model = null;
	 ...
	 * @return RsltPriRqGrpCmdtVO[]
	 */
	public RsltPriRqGrpCmdtVO[] getRsltPriRqGrpCmdtVOs(){
		RsltPriRqGrpCmdtVO[] vos = (RsltPriRqGrpCmdtVO[])models.toArray(new RsltPriRqGrpCmdtVO[models.size()]);
		return vos;
	}
