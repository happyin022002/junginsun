...
*@FileName : SpacecontrolinquiryDBDAOAddTsPlanGuideAtchCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAOAddTsPlanGuideAtchCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [T/S Plan & guide Attach]을 [추가]합니다.
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAOAddTsPlanGuideAtchCSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAOAddTsPlanGuideAtchCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPC_TS_PLN_GID_FILE_STO " ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("	FROM SPC_TS_PLN_GID_FILE_STO" ).append("\n"); 
