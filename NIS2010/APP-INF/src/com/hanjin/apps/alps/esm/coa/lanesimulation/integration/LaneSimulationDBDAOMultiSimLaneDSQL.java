...
public class LaneSimulationDBDAOMultiSimLaneDSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DELETE FROM COA_SIM_SVC_LANE" ).append("\n"); 
		query.append("#elseif(${tname} == '2')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_VSL_SET_INFO" ).append("\n"); 
		query.append("#elseif(${tname} == '3')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_INTR_TRNS_VOL" ).append("\n"); 
		query.append("#elseif(${tname} == '4')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_RPT_MST" ).append("\n"); 
		query.append("#elseif(${tname} == '5')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_VOL_PRJ" ).append("\n"); 
		query.append("#elseif(${tname} == '6')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_CTRB_MGN_COST" ).append("\n"); 
		query.append("#elseif(${tname} == '7')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_BNK_COST" ).append("\n"); 
		query.append("#elseif(${tname} == '8')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_NTWK_COST" ).append("\n"); 
		query.append("#elseif(${tname} == '9')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_SMRY_RPT" ).append("\n"); 
		query.append("#elseif(${tname} == '10')" ).append("\n"); 
		query.append("DELETE FROM COA_SIM_TML_OP_DYS" ).append("\n"); 
