...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteMaxSeqRSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select (NVL(Max(note_seq),0) + 1) as note_seq" ).append("\n"); 
