...
/**
 * ESM_MAS_0121 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0121HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author SHKIM
 * @see ESM_MAS_0121HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmMas0121Event extends EventSupport {
	...
	/** Table Value Object 조회 조건 및 단건 처리  */
	private MasLaneDirConvVO masLaneDirConvVO = null;
	
	/** Table Value Object Multi Data 처리 */
	private MasLaneDirConvVO[] masLaneDirConvVOs = null;
	
	/** 입력 Data 처리 */
	private SearchConditionVO searchConditionVO = null;

	public EsmMas0121Event(){}
	...
	public void setMasLaneDirConvVO(MasLaneDirConvVO masLaneDirConvVO){
		this. masLaneDirConvVO = masLaneDirConvVO;
	}

	public void setMasLaneDirConvVOS(MasLaneDirConvVO[] masLaneDirConvVOs){
		this. masLaneDirConvVOs = masLaneDirConvVOs;
	}
	...
	public MasLaneDirConvVO getMasLaneDirConvVO(){
		return masLaneDirConvVO;
	}

	public MasLaneDirConvVO[] getMasLaneDirConvVOS(){
		return masLaneDirConvVOs;
	}
