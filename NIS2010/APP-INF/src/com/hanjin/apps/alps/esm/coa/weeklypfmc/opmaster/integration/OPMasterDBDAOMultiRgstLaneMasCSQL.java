...
*@FileName : OPMasterDBDAOMultiRgstLaneMasCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiRgstLaneMasCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiRgstLaneMasCSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiRgstLaneMasCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_LANE_RGST (" ).append("\n"); 
