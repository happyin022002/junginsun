...
/**
 * ESM_COA_0174 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_COA_0174HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Choi In Kyung
 * @see ESM_COA_0174HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmCoa0174Event extends EventSupport {
	...
	/** Constructor */
	public EsmCoa0174Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmCoa0174Event";
	}
