...
public class CargoReleaseOrderDBDAOsearchEdiFullCntrRlseOrderEurDtlInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           || 'EUR_RELEASE_DT:'                || NVL(TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC(@[rlse_ofc_cd]) ),'YYYYMMDD'),'')   || CHR(10)" ).append("\n"); 
		query.append("           || 'EUR_EXPIRY_DT:'                 || NVL(DECODE(@[rlse_exp_dt],NULL,NULL,@[rlse_exp_dt]||'2359'),'')		   || CHR(10)" ).append("\n"); 
