...
*@FileName : AusDgManifestListDownloadDBDAOmodifyDgInqBySeqUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusDgManifestListDownloadDBDAOmodifyDgInqBySeqUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusDgManifestListDownloadDBDAOmodifyDgInqBySeqUSQL(){
		setQuery();
		...
		query.append("FileName : AusDgManifestListDownloadDBDAOmodifyDgInqBySeqUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",   PCK_DESC = @[eur_pck_desc]" ).append("\n"); 
