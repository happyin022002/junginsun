...
public class RocsManifestListDownloadDBDAOsearchInboundBlListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT VVD_NM, VVD_NUMBER, POD_CLPT_IND_SEQ, FRM_CRN_NUMBER, MAX(CNTR_TPSZ_DESC) CNTR_TPSZ_DESC," ).append("\n"); 
		...
		query.append("(SELECT VVD_NM, VVD_NUMBER, POD_CLPT_IND_SEQ, FRM_CRN_NUMBER, CNTR_TPSZ_DESC, CNTR_NO||CNTR_TPSZ_CD CNTR_NO_CD," ).append("\n"); 
		...
		query.append("    NVL(A.POD_CLPT_IND_SEQ,'1') AS POD_CLPT_IND_SEQ," ).append("\n"); 
		...
		query.append("	AND   NVL(A.POD_CLPT_IND_SEQ, '1') = @[frm_pod_clpt_ind_seq]" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("    GROUP BY  VVD_NM, VVD_NUMBER, POD_CLPT_IND_SEQ, FRM_CRN_NUMBER," ).append("\n"); 
