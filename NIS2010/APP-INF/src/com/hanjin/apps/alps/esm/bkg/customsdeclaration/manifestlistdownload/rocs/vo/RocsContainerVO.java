...
public class RocsContainerVO extends ManifestListDetailVO {
	...
	private List<RocsSearchVslInfoVO> rocsSearchVslInfoVOs;
	...
	public List<RocsSearchVslInfoVO> getRocsSearchVslInfoVOs() {
		return rocsSearchVslInfoVOs;
	}


	public void setRocsSearchVslInfoVOs(List<RocsSearchVslInfoVO> rocsSearchVslInfoVOs) {
		this.rocsSearchVslInfoVOs = rocsSearchVslInfoVOs;
	}
