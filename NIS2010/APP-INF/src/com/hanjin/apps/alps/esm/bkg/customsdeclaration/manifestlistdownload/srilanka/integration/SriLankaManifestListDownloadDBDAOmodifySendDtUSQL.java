...
*@FileName : SriLankaManifestListDownloadDBDAOmodifySendDtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SriLankaManifestListDownloadDBDAOmodifySendDtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SriLankaManifestListDownloadDBDAOmodifySendDtUSQL(){
		setQuery();
		...
		query.append("FileName : SriLankaManifestListDownloadDBDAOmodifySendDtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
