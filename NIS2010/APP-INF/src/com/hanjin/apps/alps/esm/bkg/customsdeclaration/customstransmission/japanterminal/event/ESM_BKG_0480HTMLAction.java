...
*@FileName : ESM_BKG_0480HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0480HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0480HTMLAction 객체를 생성 
	 */
	public ESM_BKG_0480HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0480Event event = new EsmBkg0480Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setBkgJapanTerminalEdiVOS((BkgJapanTerminalEdiVO[])getVOs(request, BkgJapanTerminalEdiVO .class,""));
