...
*@FileName : Kor24ManifestListDBDAOmodifyEmpTransmitDateUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyEmpTransmitDateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyEmpTransmitDateUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyEmpTransmitDateUSQL").append("\n");
		query.append("*/").append("\n");
	}
