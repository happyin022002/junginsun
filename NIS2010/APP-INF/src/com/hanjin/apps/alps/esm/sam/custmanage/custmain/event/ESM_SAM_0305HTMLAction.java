...
*@FileName : ESM_SAM_0305HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_SAM_0305HTMLAction extends HTMLActionSupport {

    /**
     * ESM_SAM_0301HTMLAction 객체를 생성
     */
    public ESM_SAM_0305HTMLAction() {
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_SAM_0305Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSam0305Event event = new EsmSam0305Event(cust_cd, cust_nm, ofc_cd, iPage, include, cust, zip_cd, cust_grp_id, loc_cd, ste_cd, srep_cd, delt_flg);            	
