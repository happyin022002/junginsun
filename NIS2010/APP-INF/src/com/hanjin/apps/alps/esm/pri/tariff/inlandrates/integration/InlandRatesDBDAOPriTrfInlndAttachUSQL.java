...
*@FileName : InlandRatesDBDAOPriTrfInlndAttachUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRatesDBDAOPriTrfInlndAttachUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndAttachUSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndAttachUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET ATCH_FILE_ID     = @[atch_file_id]" ).append("\n"); 
