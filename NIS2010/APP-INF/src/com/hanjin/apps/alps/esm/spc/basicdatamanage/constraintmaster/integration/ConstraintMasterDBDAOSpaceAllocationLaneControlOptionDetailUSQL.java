...
*@FileName : ConstraintMasterDBDAOSpaceAllocationLaneControlOptionDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintMasterDBDAOSpaceAllocationLaneControlOptionDetailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SpaceAllocationManageDBDAOSpaceAllocationLaneControlOptionDetailUSQL- 패키지 이동으로 신규 생성
	  ...
	  * ConstraintMasterDBDAOSpaceAllocationLaneControlOptionDetailUSQL.Query - 패키지 이동으로 신규 생성
	  * </pre>
	  */
	public ConstraintMasterDBDAOSpaceAllocationLaneControlOptionDetailUSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintMasterDBDAOSpaceAllocationLaneControlOptionDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
