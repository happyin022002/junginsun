...
*@FileName : SearchBasicCmcbMasUcPfmcVO.java
*@FileTitle : SearchBasicCmcbMasUcPfmcVO
*Open Issues :
*Change history :
...
public class SearchBasicCmcbMasUcPfmcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBasicCmcbMasUcPfmcVO> models = new ArrayList<SearchBasicCmcbMasUcPfmcVO>();
	...
	public SearchBasicCmcbMasUcPfmcVO() {}

	public SearchBasicCmcbMasUcPfmcVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String subTrdCd, String rlaneCd, String dirCd, String polCd, String podCd, String iasRgnCd, String masPaCmUcAmt, String masRaCmUcAmt, String paCmUcAmt, String raCmUcAmt, String polCallSeq, String podCallSeq) {
		this.trdCd = trdCd;
		this.bseYr = bseYr;
...
/**
	 ...
	 * @param request
	 * @return SearchBasicCmcbMasUcPfmcVO[]
	 */
	public SearchBasicCmcbMasUcPfmcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBasicCmcbMasUcPfmcVO[]
	 */
	public SearchBasicCmcbMasUcPfmcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBasicCmcbMasUcPfmcVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBasicCmcbMasUcPfmcVO();
				if (trdCd[i] != null)
		...
		return getSearchBasicCmcbMasUcPfmcVOs();
	}
	 ...
	 * @return SearchBasicCmcbMasUcPfmcVO[]
	 */
	public SearchBasicCmcbMasUcPfmcVO[] getSearchBasicCmcbMasUcPfmcVOs(){
		SearchBasicCmcbMasUcPfmcVO[] vos = (SearchBasicCmcbMasUcPfmcVO[])models.toArray(new SearchBasicCmcbMasUcPfmcVO[models.size()]);
		return vos;
	}
