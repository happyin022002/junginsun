...
*@FileName : BookingUtilDBDAOSearchUsaFrobRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingUtilDBDAOSearchUsaFrobRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 vvd 안에 미국 port를 거치는지 조회한다.
	  * </pre>
	  */
	public BookingUtilDBDAOSearchUsaFrobRSQL(){
		setQuery();
		...
		query.append("FileName : BookingUtilDBDAOSearchUsaFrobRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND SUBSTR(@[pol_cd], 1, 2) <> 'US'--POL이 CANADA일 때는 제외" ).append("\n"); 
		query.append("AND SUBSTR(@[pod_cd], 1, 2) <> 'US'--POD가 CANADA일 때는 제외" ).append("\n"); 
