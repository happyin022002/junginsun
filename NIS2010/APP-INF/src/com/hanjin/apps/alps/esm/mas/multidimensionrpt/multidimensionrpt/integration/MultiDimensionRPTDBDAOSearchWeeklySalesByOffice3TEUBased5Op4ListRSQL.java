...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op4ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op4ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op4ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased5Op4ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		   ,16, ((INCOME_TOTAL - CM_COST) - N4TH_HJS_SLS_AMT - N4TH_CO_AMT - CMMT_COST - INTER_TS)   /* CMMT0001 */" ).append("\n"); 
		...
		query.append("			,SUM (N4TH_HJS_SLS_AMT) N4TH_HJS_SLS_AMT " ).append("\n"); 
		...
		query.append("				         ) " ).append("\n"); 
		query.append("				    ,0 " ).append("\n"); 
		query.append("				    ) AS N4TH_HJS_SLS_AMT " ).append("\n"); 
		query.append("				,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("                            THEN A2.N4TH_ASGN_AMT ELSE 0 END) TS_ALOC" ).append("\n"); 
		query.append("				 , 0 AS GEN_EXPN" ).append("\n"); 
		query.append("				 , 0 AS VSL_CHTR_REV, NVL " ).append("\n"); 
		query.append("					   (SUM " ).append("\n"); 
		query.append("					       (CASE " ).append("\n"); 
		query.append("					           WHEN A3.STND_COST_CD IN ('72100000') THEN " ).append("\n"); 
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
