...
*@FileName : UsWharfageDecMgtDBDAOmodifyBkgUsaWhfExptCmdtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOmodifyBkgUsaWhfExptCmdtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyBkgUsaWhfExptCmdt
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOmodifyBkgUsaWhfExptCmdtUSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOmodifyBkgUsaWhfExptCmdtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_USA_WHF_EXPT_CMDT SET" ).append("\n"); 
		query.append("KW_NM1 = @[kw_nm1]" ).append("\n"); 
		query.append(",	KW_NM2 = @[kw_nm2]" ).append("\n"); 
