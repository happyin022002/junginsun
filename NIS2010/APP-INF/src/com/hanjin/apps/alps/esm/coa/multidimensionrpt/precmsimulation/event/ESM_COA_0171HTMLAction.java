...
*@FileName : ESM_COA_0171HTMLAction.java
...
public class ESM_COA_0171HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0171HTMLAction 객체를 생성
	 */
	public ESM_COA_0171HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0171Event event = new EsmCoa0171Event();
