...
*@FileName : ESM_SPC_0087HTMLAction.java
...
public class ESM_SPC_0087HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0087HTMLAction 객체를 생성
	 */
	public ESM_SPC_0087HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0087Event event = new EsmSpc0087Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			...
			event.setSearchTsPlanGuideListVO((SearchTsPlanGuideListVO)getVO(request, SearchTsPlanGuideListVO .class));
			...
			event.setSearchTsPlanGuideListVOS((SearchTsPlanGuideListVO[])getVOs(request, SearchTsPlanGuideListVO .class));
