 ...
 * @see	..
 */
public class AlpsCmVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<AlpsCmVO>  models =	new	ArrayList<AlpsCmVO>();
	...
	public AlpsCmVO(String hamoTrfCd,String ncmNo,String cntrMfWgt,String cntrMfMkDesc,String cntrMfDtlDesc,String pagerows,String ibflag,String poNo,String cntrNo,String wgtUtCd,String measQty,String pckQty,String cntrMfSeq,String cntrMfGdsDesc,String pckTpCd,String measUtCd,String cntrMfNo,String cmdtHsCd,String dcgoSeq,String cntrTpszCd,String ncmMultiNo,String wpmTrtCd)	{
 ...
 //	Getters	and	Setters
	...
	*/
	 ...
	 * @return AlpsCmVO[]
	 */
	public AlpsCmVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return AlpsCmVO[]
	 */
	public AlpsCmVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		AlpsCmVO model = null;
	...
	public AlpsCmVO[]	 getAlpsCmVOs(){
		AlpsCmVO[] vos = (AlpsCmVO[])models.toArray(new	AlpsCmVO[models.size()]);
		return vos;
		}
