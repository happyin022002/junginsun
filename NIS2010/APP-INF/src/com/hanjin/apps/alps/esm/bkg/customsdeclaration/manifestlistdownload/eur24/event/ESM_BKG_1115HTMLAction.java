...
*@FileName : ESM_BKG_1115HTMLAction.java
...
public class ESM_BKG_1115HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1115HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1115HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1115Event event = new EsmBkg1115Event();
		EU24RcvErrorCodeTableVO vo = new EU24RcvErrorCodeTableVO(); 
		if(command.isCommand(FormCommand.SEARCH)) {
			vo = (EU24RcvErrorCodeTableVO)getVO(request, EU24RcvErrorCodeTableVO.class);
			event.setEU24RcvErrorCodeTableVO(vo);
		}   
