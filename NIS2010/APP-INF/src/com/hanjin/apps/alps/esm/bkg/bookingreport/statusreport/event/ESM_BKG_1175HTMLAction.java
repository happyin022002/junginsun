...
public class ESM_BKG_1175HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1083HTMLAction 객체를 생성
	 */
	public ESM_BKG_1175HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1175Event event = new EsmBkg1175Event();
		

		if(command.isCommand(FormCommand.INIT)) {
			event.setSurchageSummaryInVO((SurchageSummaryInVO)getVO(request, SurchageSummaryInVO .class));
