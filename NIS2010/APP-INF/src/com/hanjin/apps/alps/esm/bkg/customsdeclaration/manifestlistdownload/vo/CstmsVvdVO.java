...
*@FileName : CstmsVvdVO.java
*@FileTitle : CstmsVvdVO
*Open Issues :
*Change history :
...
public class CstmsVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstmsVvdVO> models = new ArrayList<CstmsVvdVO>();
	...
	public CstmsVvdVO(String ibflag, String pagerows, String slanCd, String vslCd, String skdVoyNo, String skdDirCd, String vvdCd, String crrCd, String polCd, String vpsEtbDt, String crnWrkCmncDt, String vpsPortCd, String vpsEtaDt, String cvyRefNo) {
		this.ibflag = ibflag;
	...
	public CstmsVvdVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CstmsVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstmsVvdVO model = null;
	...
	public CstmsVvdVO[] getCstmsVvdVOs(){
		CstmsVvdVO[] vos = (CstmsVvdVO[])models.toArray(new CstmsVvdVO[models.size()]);
		return vos;
	}
