...
*@FileName : CargoReleaseOrderDBDAOAddKorDoCustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOAddKorDoCustCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 사업자명(위임자 또는 수입자) 과 그 사업자등록번호를 등록하는 SQL
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOAddKorDoCustCSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOAddKorDoCustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_DO_ATTY (" ).append("\n"); 
		query.append("ATTY_BIZ_NO," ).append("\n"); 
