...
*@FileName : SCRateProposalDBDAORsltPriSurchargeViewAllVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriSurchargeViewAllVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriSurchargeViewAllVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriSurchargeViewAllVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("	,NVL(REPLACE(F.GRI_NOTE_CTNT      , '^|^', '' ) ,' ')   AS GRI_RNOTE_CTNT       " ).append("\n"); 
		query.append("	,NVL(REPLACE(F.SURCHARGE_NOTE_CTNT, '^|^', '' ) ,' ')   AS SURCHARGE_RNOTE_CTNT " ).append("\n"); 
		query.append("	,NVL(REPLACE(F.DEMDET_NOTE_CTNT   , '^|^', '' ) ,' ')   AS DEMDET_RNOTE_CTNT    " ).append("\n"); 
		query.append("	,NVL(REPLACE(F.OTHERS_NOTE_CTNT   , '^|^', '' ) ,' ')   AS OTHERS_RNOTE_CTNT    " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,NVL(REPLACE(H.GRI_NOTE_CTNT      , '^|^', '' ) ,' ')   AS GRI_CNOTE_CTNT       " ).append("\n"); 
		query.append("	,NVL(REPLACE(H.SURCHARGE_NOTE_CTNT, '^|^', '' ) ,' ')   AS SURCHARGE_CNOTE_CTNT " ).append("\n"); 
		query.append("	,NVL(REPLACE(H.DEMDET_NOTE_CTNT   , '^|^', '' ) ,' ')   AS DEMDET_CNOTE_CTNT    " ).append("\n"); 
		query.append("	,NVL(REPLACE(H.OTHERS_NOTE_CTNT   , '^|^', '' ) ,' ')   AS OTHERS_CNOTE_CTNT    " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	,DECODE(G.DIR_CALL_FLG,'Y','YES','NO') AS DIR_CALL_FLG" ).append("\n"); 
		...
		query.append("	, DENSE_RANK() OVER (PARTITION BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD ORDER BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ ) AS SEQ" ).append("\n"); 
		...
		query.append("		      ,CMDT_HDR_SEQ" ).append("\n"); 
		query.append("		      ,ROUT_SEQ" ).append("\n"); 
		query.append("		      , SUBSTR( MAX(SYS_CONNECT_BY_PATH(DECODE(NOTE_CLSS_CD,'G',NOTE_CTNT,''), '^|^')), 4)   AS GRI_NOTE_CTNT" ).append("\n"); 
		query.append("		      , SUBSTR( MAX(SYS_CONNECT_BY_PATH(DECODE(NOTE_CLSS_CD,'S',NOTE_CTNT,''), '^|^')), 4)   AS SURCHARGE_NOTE_CTNT" ).append("\n"); 
		query.append("		      , SUBSTR( MAX(SYS_CONNECT_BY_PATH(DECODE(NOTE_CLSS_CD,'D',NOTE_CTNT,''), '^|^')), 4)   AS DEMDET_NOTE_CTNT" ).append("\n"); 
		query.append("		      , SUBSTR( MAX(SYS_CONNECT_BY_PATH(DECODE(NOTE_CLSS_CD,'O',NOTE_CTNT,''), '^|^')), 4)   AS OTHERS_NOTE_CTNT" ).append("\n"); 
		query.append("		  FROM (SELECT PROP_NO" ).append("\n"); 
		query.append("			      ,AMDT_SEQ" ).append("\n"); 
		query.append("			      ,SVC_SCP_CD" ).append("\n"); 
		query.append("			      ,GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("			, SUM( PRI_SCG.ADJ_SCG_USD_AMT ) OVER( PARTITION BY PRI_ROUT.PROP_NO, PRI_ROUT.AMDT_SEQ, PRI_ROUT.SVC_SCP_CD, PRI_ROUT.GEN_SPCL_RT_TP_CD, PRI_ROUT.CMDT_HDR_SEQ, PRI_ROUT.ROUT_SEQ, PRI_ROUT.RT_SEQ ) AS TOT_SURCHARGE" ).append("\n"); 
		query.append("		FROM PRI_SP_SCP_RT_SCG_ROUT PRI_ROUT" ).append("\n"); 
		query.append("			, PRI_SP_SCP_RT_SCG PRI_SCG" ).append("\n"); 
		...
		query.append("			AND PRI_ROUT.GEN_SPCL_RT_TP_CD = 'G'" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	AND I.GEN_SPCL_RT_TP_CD = ACT_CUST.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append(" ORDER BY  A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ" ).append("\n"); 
		query.append(" ,A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
