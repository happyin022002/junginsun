...
*@FileName : RsltPriCmpbGrpCmdtDtlVO.java
*@FileTitle : RsltPriCmpbGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGrpCmdtDtlVO> models = new ArrayList<RsltPriCmpbGrpCmdtDtlVO>();
	...
	public RsltPriCmpbGrpCmdtDtlVO() {}

	public RsltPriCmpbGrpCmdtDtlVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String grpCmdtSeq, String grpCmdtDtlSeq, String prcCmdtTpCd, String prcCmdtDefCd, String creUsrId, String creDt, String updUsrId, String updDt, String prcCmdtDefNm) {
		this.updDt = updDt;
	 ...
	 */
	public RsltPriCmpbGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGrpCmdtDtlVO[]
	 */
	public RsltPriCmpbGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGrpCmdtDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGrpCmdtDtlVO();
				if (updDt[i] != null)
		...
		return getRsltPriCmpbGrpCmdtDtlVOs();
	}
	 ...
	 * @return RsltPriCmpbGrpCmdtDtlVO[]
	 */
	public RsltPriCmpbGrpCmdtDtlVO[] getRsltPriCmpbGrpCmdtDtlVOs(){
		RsltPriCmpbGrpCmdtDtlVO[] vos = (RsltPriCmpbGrpCmdtDtlVO[])models.toArray(new RsltPriCmpbGrpCmdtDtlVO[models.size()]);
		return vos;
	}
