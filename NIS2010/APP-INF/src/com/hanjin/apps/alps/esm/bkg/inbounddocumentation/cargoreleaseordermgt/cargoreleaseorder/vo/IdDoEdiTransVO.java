...
public class IdDoEdiTransVO extends AbstractValueObject {
    ...
    */
    ...
    private Collection<IdDoEdiTransVO> models = new ArrayList<IdDoEdiTransVO>();
    ...
    public IdDoEdiTransVO() {
    }

    public IdDoEdiTransVO(String ibflag, String pagerows, String discLocCd, String bkgNo, String eventTp, String selfTrnsFlg, String rlseSeq, String creUsrId, String updUsrId, String ediId, String ediSndRsltCd, String usrId, String ofcCd, String doNo) {
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setEdiSndRsltCd(JSPUtil.getParameter(request, prefix + "edi_snd_rslt_cd", ""));
        setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
        setDiscLocCd(JSPUtil.getParameter(request, prefix + "disc_loc_cd", ""));
        setOfcCd(JSPUtil.getParameter(request, prefix + "ofc_cd", ""));
        setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
        setBkgNo(JSPUtil.getParameter(request, prefix + "bkg_no", ""));
        setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
        setUsrId(JSPUtil.getParameter(request, prefix + "usr_id", ""));
        setEventTp(JSPUtil.getParameter(request, prefix + "event_tp", ""));
	 ...
	 * @param request
	 * @return IdDoEdiTransVO[]
	 */
    public IdDoEdiTransVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return IdDoEdiTransVO[]
	 */
    public IdDoEdiTransVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        IdDoEdiTransVO model = null;
	 ...
	 * @return IdDoEdiTransVO[]
	 */
    public IdDoEdiTransVO[] getIdDoEdiTransVOs() {
        IdDoEdiTransVO[] vos = (IdDoEdiTransVO[]) models.toArray(new IdDoEdiTransVO[models.size()]);
        return vos;
    }
