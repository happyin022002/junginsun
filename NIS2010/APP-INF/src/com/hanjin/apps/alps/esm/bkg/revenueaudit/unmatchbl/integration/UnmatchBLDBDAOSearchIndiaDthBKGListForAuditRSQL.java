...
*@FileName : UnmatchBLDBDAOSearchIndiaDthBKGListForAuditRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOSearchIndiaDthBKGListForAuditRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * India의 DTH BKG LIST 를 조회한다
	  * </pre>
	  */
	public UnmatchBLDBDAOSearchIndiaDthBKGListForAuditRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOSearchIndiaDthBKGListForAuditRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = OTH.RAT_UT_CD AND ROWNUM=1) = U.CNTR_SZ_CD" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		...
		query.append("            OR (" ).append("\n"); 
		query.append("                RAT_UT_CD IN ('20', '40', 'HC', '45', '53')" ).append("\n"); 
		query.append("                AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = DTH.RAT_UT_CD AND ROWNUM=1) = U.CNTR_SZ_CD" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		...
		query.append("               RAT_UT_CD||' / '||" ).append("\n"); 
		query.append("               TRIM(TO_CHAR(CHG_AMT, '999,999,999.00'))" ).append("\n"); 
		query.append("        FROM BKG_CHG_RT NST" ).append("\n"); 
		query.append("        WHERE BKG_NO = C.BKG_NO" ).append("\n"); 
		query.append("        AND CHG_CD = 'NST'" ).append("\n"); 
		query.append("        AND FRT_INCL_XCLD_DIV_CD = 'N'" ).append("\n"); 
		query.append("        AND (RAT_UT_CD = C.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("            OR RAT_UT_CD IN ('BX', 'BL')" ).append("\n"); 
		query.append("            OR (" ).append("\n"); 
		query.append("                RAT_UT_CD IN ('20', '40', 'HC', '45', '53')" ).append("\n"); 
		query.append("                AND ( SELECT A.CNTR_SZ_CD FROM PRI_RAT_UT A WHERE A.RAT_UT_CD = NST.RAT_UT_CD AND ROWNUM=1) = U.CNTR_SZ_CD" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("            )" ).append("\n"); 
		query.append("        AND ROWNUM = 1) NST," ).append("\n"); 
		...
		query.append("        NVL(DECODE(R.IDA_THC_AUD_STS_CD,'E','U','Y','S',R.IDA_THC_AUD_STS_CD),'N') AUD_STS_CD," ).append("\n"); 
		...
		query.append("AND B.POL_CD LIKE 'IN%'" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("AND B.POD_CD LIKE 'IN%'" ).append("\n"); 
		...
		query.append("AND NVL(R.IDA_THC_AUD_STS_CD,'N') = DECODE(@[aud_sts_cd],'S','Y','U','E','N')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("       BKG.OTH," ).append("\n"); 
		query.append("       BKG.DTH," ).append("\n"); 
		query.append("       BKG.NST," ).append("\n"); 
		...
		query.append("       WHERE TRSP_COST_DTL_MOD_CD = 'LS'" ).append("\n"); 
