...
public class RsltPriSpDurHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpDurHisVO> models = new ArrayList<RsltPriSpDurHisVO>();
	...
	public RsltPriSpDurHisVO() {}

	public RsltPriSpDurHisVO(String ibflag, String pagerows, String ctrtEffDt, String ctrtExpDt, String effDt, String expDt, String srcInfoNm, String prcProgStsNm, String acptUsrNm, String acptDt, String amdtSeq, String n1stCmncAmdtSeq) {
		this.effDt = effDt;
		this.ibflag = ibflag;
		this.acptDt = acptDt;
	 ...
	 */
	public RsltPriSpDurHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpDurHisVO[]
	 */
	public RsltPriSpDurHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpDurHisVO model = null;
	 ...
	 * @return RsltPriSpDurHisVO[]
	 */
	public RsltPriSpDurHisVO[] getRsltPriSpDurHisVOs(){
		RsltPriSpDurHisVO[] vos = (RsltPriSpDurHisVO[])models.toArray(new RsltPriSpDurHisVO[models.size()]);
		return vos;
	}
