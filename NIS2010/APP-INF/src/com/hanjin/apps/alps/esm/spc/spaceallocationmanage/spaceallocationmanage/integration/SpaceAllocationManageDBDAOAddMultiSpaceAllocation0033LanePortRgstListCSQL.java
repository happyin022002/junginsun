...
*@FileName : SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033LanePortRgstListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033LanePortRgstListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMultiSpaceAllocation0033LanePortRgstList
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033LanePortRgstListCSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOAddMultiSpaceAllocation0033LanePortRgstListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPC_LANE_PORT_RGST" ).append("\n"); 
		query.append("VALUES(" ).append("\n"); 
		query.append("  @[rep_trd_cd]" ).append("\n"); 
		query.append(", @[sub_trd_cd]" ).append("\n"); 
		query.append(", @[rlane_cd]" ).append("\n"); 
		query.append(", @[dir_cd]" ).append("\n"); 
		query.append(", REPLACE(@[eff_fm_dt], '-', '')" ).append("\n"); 
		query.append(", REPLACE(@[eff_to_dt], '-', '')" ).append("\n"); 
