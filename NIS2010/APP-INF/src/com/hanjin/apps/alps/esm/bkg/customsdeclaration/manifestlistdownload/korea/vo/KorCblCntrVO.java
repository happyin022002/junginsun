...
*@FileName : KorCblCntrVO.java
*@FileTitle : KorCblCntrVO
*Open Issues :
*Change history :
...
public class KorCblCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorCblCntrVO> models = new ArrayList<KorCblCntrVO>();
	...
	public KorCblCntrVO(String ibflag, String pagerows, String cBlNo, String bkgNo, String cstmsDeclTpCd, String dmstPortCd, String cntrNo) {
...
/**
	 ...
	 * @return KorCblCntrVO[]
	 */
	public KorCblCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCblCntrVO[]
	 */
	public KorCblCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCblCntrVO model = null;
	 ...
	 * @return KorCblCntrVO[]
	 */
	public KorCblCntrVO[] getKorCblCntrVOs(){
		KorCblCntrVO[] vos = (KorCblCntrVO[])models.toArray(new KorCblCntrVO[models.size()]);
		return vos;
	}
