...
public class ChinaManifestListDownloadDBDAOsearchManifestDetailListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        'SMLM'||BKG.BL_NO AS BL,   /*BL*/" ).append("\n"); 
		...
		query.append("        REPLACE(REPLACE(BL.CSTMS_DESC,CHR(13)||CHR(10),' '),CHR(9),' ') AS CSTMS_DESC," ).append("\n"); 
		...
		query.append("ORDER BY 'SMLM'||BKG.BL_NO, SC.CNTR_NO" ).append("\n"); 
