...
*@FileName : InlandRatesDBDAOPriTrfInlndProgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRatesDBDAOPriTrfInlndProgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndProgVODSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndProgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRF_INLND_PROG" ).append("\n"); 
