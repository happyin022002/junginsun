...
*@FileName : OPCostDBDAOStndUseQtyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPCostDBDAOStndUseQtyUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPCostDBDAOStndUseQtyUSQL(){
		setQuery();
		...
		query.append("FileName : OPCostDBDAOStndUseQtyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_STND_USE_QTY" ).append("\n"); 
		query.append("   SET VVD_BSA_CAPA = @[vvd_bsa_capa]" ).append("\n"); 
