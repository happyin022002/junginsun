...
public class RptItmStupVO extends AbstractValueObject {
	...
	/* Column Info */
	private String lodgCfmRmk = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("lodg_cfm_rmk", getLodgCfmRmk());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("lodg_cfm_rmk", "lodgCfmRmk");
	 ...
	 * @return lodgCfmRmk
	 */
	public String getLodgCfmRmk() {
		return this.lodgCfmRmk;
	}
	 ...
	 * @param lodgCfmRmk
	 */
	public void setLodgCfmRmk(String lodgCfmRmk){
		this.lodgCfmRmk = lodgCfmRmk;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setLodgCfmRmk(JSPUtil.getParameter(request, prefix + "lodg_cfm_rmk", ""));
	...
	public RptItmStupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] lodgCfmRmk = (JSPUtil.getParameter(request, prefix	+ "lodg_cfm_rmk", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (lodgCfmRmk[i] != null)
					model.setLodgCfmRmk(lodgCfmRmk[i]);
				if (emlCtnt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.lodgCfmRmk = this.lodgCfmRmk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
