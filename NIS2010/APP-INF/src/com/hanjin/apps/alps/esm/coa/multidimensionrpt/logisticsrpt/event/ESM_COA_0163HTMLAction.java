...
*@FileName : ESM_COA_0163HTMLAction.java
...
public class ESM_COA_0163HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0163HTMLAction 객체를 생성
	 */
	public ESM_COA_0163HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {		
		...
		EsmCoa0163Event event = new EsmCoa0163Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchUSInlandCost0163ListVO((SearchUSInlandCost0163ListVO)getVO(request, SearchUSInlandCost0163ListVO .class));
