...
**@FileName : ESM_MAS_0328HTMLAction.java
 ...
 * @author Je Ryang Yoo
 * @see EsmMas0328Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0328HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0328HTMLAction 객체를 생성
	 */
	public ESM_MAS_0328HTMLAction() {}//
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0328Event event = new EsmMas0328Event();  		
