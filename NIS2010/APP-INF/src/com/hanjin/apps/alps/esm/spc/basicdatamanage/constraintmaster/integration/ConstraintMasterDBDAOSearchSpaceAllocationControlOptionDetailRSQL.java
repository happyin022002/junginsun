...
*@FileName : ConstraintMasterDBDAOSearchSpaceAllocationControlOptionDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConstraintMasterDBDAOSearchSpaceAllocationControlOptionDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * ConstraintMasterDBDAOSearchSpaceAllocationControlOptionDetailRSQL.Query- 패키지 이동으로 신규 생성
	  * </pre>
	  */
	public ConstraintMasterDBDAOSearchSpaceAllocationControlOptionDetailRSQL(){
		setQuery();
		...
		query.append("FileName : ConstraintMasterDBDAOSearchSpaceAllocationControlOptionDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
