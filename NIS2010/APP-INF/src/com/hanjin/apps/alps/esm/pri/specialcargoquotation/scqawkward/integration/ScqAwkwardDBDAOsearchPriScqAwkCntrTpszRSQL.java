...
*@FileName : ScqAwkwardDBDAOsearchPriScqAwkCntrTpszRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOsearchPriScqAwkCntrTpszRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqAwkwardDBDAOsearchPriScqAwkCntrTpszRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.specialcargoquotation.scqawkward.integration").append("\n"); 
		query.append("FileName : ScqAwkwardDBDAOsearchPriScqAwkCntrTpszRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND CNTR_TP_CD IN('A','F','O','P','S','C')" ).append("\n"); 
