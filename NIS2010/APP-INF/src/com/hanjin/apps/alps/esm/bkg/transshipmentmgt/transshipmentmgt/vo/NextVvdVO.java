...
public class NextVvdVO extends AbstractValueObject {
	...
	public NextVvdVO(String ibflag, String pagerows, String nextVvd, String slanCd, String opCd, String etd, String eta, String relayTmnl, String relaySeq, String nextTmnl, String nextSeq) {
		this.eta = eta;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("relay_seq", getRelaySeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("relay_seq", "relaySeq");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setNextSeq(JSPUtil.getParameter(request, prefix + "next_seq", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setSlanCd(JSPUtil.getParameter(request, prefix + "slan_cd", ""));
		setRelayTmnl(JSPUtil.getParameter(request, prefix + "relay_tmnl", ""));
		setEtd(JSPUtil.getParameter(request, prefix + "etd", ""));
		setOpCd(JSPUtil.getParameter(request, prefix + "op_cd", ""));
		setRelaySeq(JSPUtil.getParameter(request, prefix + "relay_seq", ""));
		setNextVvd(JSPUtil.getParameter(request, prefix + "next_vvd", ""));
		setNextTmnl(JSPUtil.getParameter(request, prefix + "next_tmnl", ""));
	...
	public NextVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] relaySeq = (JSPUtil.getParameter(request, prefix	+ "relay_seq", length));
