...
public class QtaAdjustmentDBDAOManageSpcAlocIfCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * * 2016.08.22 [CHM-201643045] IAS Trade Alloc Confirm 기능 활성화
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("        ,NVL((SELECT N4TH_PRNT_OFC_CD FROM SQM_ORGANIZATION_V WHERE OFC_CD =  A1.SLS_RGN_OFC_CD)," ).append("\n"); 
		query.append("             (SELECT RGN_OFC_CD FROM SQM_QTA_OFC WHERE RGN_OFC_CD = A1.SLS_RGN_OFC_CD)) AS RGN_OFC_CD" ).append("\n"); 
		...
		query.append("     AND A1.SLS_RGN_OFC_CD IS NOT NULL" ).append("\n"); 
		...
		query.append("                        FROM SQM_ALOC_QTA Q" ).append("\n"); 
