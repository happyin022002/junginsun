...
*@FileName : KorManifestListDBDAOSearchNotTransmitCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchNotTransmitCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchNotTransmitCheckRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchNotTransmitCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
