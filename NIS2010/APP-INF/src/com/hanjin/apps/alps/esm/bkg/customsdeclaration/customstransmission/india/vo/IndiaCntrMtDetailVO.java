...
public class IndiaCntrMtDetailVO extends AbstractValueObject {
	...
	/* Column Info */
	private String idaMrnLineOprId = null;
	...
	public IndiaCntrMtDetailVO(String ibflag, String pagerows, String callSgnNo, String skdVoyNo, String idaDeclVslNo, String vslDeclDt, String idaLineNo, String tmp0, String cntrNo, String cntrSealNo, String idaAgnId, String cnmvStsCd, String pckQty, String cntrWgt, String cntrTpszCd, String socFlg, String idaMrnLineOprId) {
		...
		this.idaMrnLineOprId = idaMrnLineOprId;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ida_mrn_line_opr_id", getIdaMrnLineOprId());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ida_mrn_line_opr_id", "idaMrnLineOprId");
	...
	/**
	 * Column Info
	 * @return Marine Line Operator ID
	 */
	public String getIdaMrnLineOprId() {
		return this.idaMrnLineOprId;
	}
	...
	/**
	 * Column Info
	 * @param idaMrnLineOprId
	 */
	public void setIdaMrnLineOprId(String idaMrnLineOprId) {
		this.idaMrnLineOprId = idaMrnLineOprId;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIdaMrnLineOprId(JSPUtil.getParameter(request, "ida_mrn_line_opr_id", ""));
	}
	...
	public IndiaCntrMtDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] idaMrnLineOprId = (JSPUtil.getParameter(request, prefix	+ "ida_mrn_line_opr_id", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (idaMrnLineOprId[i] != null)
					model.setIdaMrnLineOprId(idaMrnLineOprId[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.idaMrnLineOprId = this.idaMrnLineOprId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
