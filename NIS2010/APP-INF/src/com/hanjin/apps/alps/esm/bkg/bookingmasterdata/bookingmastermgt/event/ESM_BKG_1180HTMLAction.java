...
*@FileName : ESM_BKG_1180HTMLAction.java
...
public class ESM_BKG_1180HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1180HTMLAction 객체를 생성
	 */
	public ESM_BKG_1180HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1180Event event = new EsmBkg1180Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgHandlingOfficeSetupVOS((BkgHandlingOfficeSetupVO[])getVOs(request, BkgHandlingOfficeSetupVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgHandlingOfficeSetupVO((BkgHandlingOfficeSetupVO)getVO(request, BkgHandlingOfficeSetupVO .class));
		}
