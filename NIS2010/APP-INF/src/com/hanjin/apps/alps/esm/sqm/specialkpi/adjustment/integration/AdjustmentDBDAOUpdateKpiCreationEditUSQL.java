...
*@FileName : AdjustmentDBDAOUpdateKpiCreationEditUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AdjustmentDBDAOUpdateKpiCreationEditUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateKpiCreationEdit
	  * </pre>
	  */
	public AdjustmentDBDAOUpdateKpiCreationEditUSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentDBDAOUpdateKpiCreationEditUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
