...
*@FileName : ESM_BKG_0570HTMLAction.java
...
public class ESM_BKG_0570HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0570HTMLAction 객체를 생성
	 */
	public ESM_BKG_0570HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0570Event event = new EsmBkg0570Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {

			String blNo 	= JSPUtil.getParameter(request, "bl_no");
			String corrNo 	= JSPUtil.getParameter(request, "corr_no");
			
			event.setBlNo(blNo);
			event.setCorrNo(corrNo);			
		}
