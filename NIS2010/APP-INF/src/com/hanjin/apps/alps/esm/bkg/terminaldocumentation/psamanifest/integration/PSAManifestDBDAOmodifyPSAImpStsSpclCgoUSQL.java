...
*@FileName : PSAManifestDBDAOmodifyPSAImpStsSpclCgoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOmodifyPSAImpStsSpclCgoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSA Import Status Special Cargo정보를 수정한다.
	  * </pre>
	  */
	public PSAManifestDBDAOmodifyPSAImpStsSpclCgoUSQL(){
		setQuery();
		...
		params.put("ld_ins1",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ld_ins2",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ld_ins3",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : PSAManifestDBDAOmodifyPSAImpStsSpclCgoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_PSA_IMP_STS_SPCL" ).append("\n"); 
		query.append("SET" ).append("\n"); 
		query.append("RC_TEMP  = @[rf_flg]," ).append("\n"); 
		query.append("OVR_DIM_HGT  = @[ovr_dim_hgt]," ).append("\n"); 
		query.append("OVR_FNT_DIM_LEN  = @[ovr_fnt_dim_len]," ).append("\n"); 
		query.append("OVR_BAK_DIM_LEN  = @[ovr_bak_dim_len]," ).append("\n"); 
		query.append("OVR_LF_DIM_WDT  = @[ovr_lf_dim_wdt]," ).append("\n"); 
		query.append("OVR_RT_DIM_WDT  = @[ovr_rt_dim_wdt]," ).append("\n"); 
		...
		query.append("PSA_STWG_TP_ID = NVL(@[ld_ins1],'  ')||NVL(@[ld_ins2],'  ')||NVL(@[ld_ins3],'  ')," ).append("\n"); 
		query.append("DCHG_OVR_SZ_FLG  = @[dchg_ovr_sz_flg]," ).append("\n"); 
		query.append("DIR_DE_FLG  = NVL(@[dir_de_flg],'N')," ).append("\n"); 
