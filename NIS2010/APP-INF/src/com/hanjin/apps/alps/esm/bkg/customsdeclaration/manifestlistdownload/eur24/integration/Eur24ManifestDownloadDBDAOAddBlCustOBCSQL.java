...
*@FileName : Eur24ManifestDownloadDBDAOAddBlCustOBCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBlCustOBCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBlCustOBCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBlCustOBCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO BKG_CSTMS_EUR_IO_CUST( BND_TP_CD, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, CUST_CNT_CD, CUST_SEQ, BL_NO, CSTMS_PORT_CD, BKG_CUST_TP_CD, CUST_NM, CUST_ADDR, CUST_CTY_NM, EUR_CSTMS_ST_NM, EORI_NO,CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT, CSTMS_DECL_CNT_CD, CUST_ZIP_ID)" ).append("\n"); 
