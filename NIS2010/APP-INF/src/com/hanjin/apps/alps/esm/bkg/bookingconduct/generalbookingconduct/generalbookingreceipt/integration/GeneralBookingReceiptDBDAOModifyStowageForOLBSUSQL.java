...
*@FileName : GeneralBookingReceiptDBDAOModifyStowageForOLBSUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingReceiptDBDAOModifyStowageForOLBSUSQL implements ISQLTemplate{
	...
	public GeneralBookingReceiptDBDAOModifyStowageForOLBSUSQL(){
		...
		query.append("FileName : GeneralBookingReceiptDBDAOModifyStowageForOLBSUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" STWG_CD = 'OLBS'" ).append("\n"); 
		query.append(", BLCK_STWG_CD = 'LBS'" ).append("\n"); 
		...
		query.append("                WHERE HRD_CDG_ID = 'STWG_OLBS'" ).append("\n"); 
		...
		query.append("AND (   SELECT COUNT(1) FROM BKG_VVD WHERE BKG_NO = @[bkg_no] AND VSL_PRE_PST_CD <> 'T'" ).append("\n"); 
		query.append("    ) = 0 " ).append("\n"); 
