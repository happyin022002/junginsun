...
public class CLLCDLManifestDBDAOsearchCllCdlNoCntrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             WHERE VVD.VSL_CD     = SUBSTR(@[in_vvd_cd],1,4)" ).append("\n"); 
		...
		query.append("		#end" ).append("\n"); 
		query.append("		#if (${pol_split_no} != '')  -- Add. 2015.02.09.  CHM-201533845 " ).append("\n"); 
		query.append("			   AND NVL(VVD.POL_CLPT_IND_SEQ,'1') = @[pol_split_no] " ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("		#if (${pod_split_no} != '')  -- Add. 2015.02.09.  CHM-201533845 " ).append("\n"); 
