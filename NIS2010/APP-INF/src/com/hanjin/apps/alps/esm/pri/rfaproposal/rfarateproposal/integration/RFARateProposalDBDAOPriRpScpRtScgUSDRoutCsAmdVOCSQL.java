...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgUSDRoutCsAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgUSDRoutCsAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgUSDRoutCsAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgUSDRoutCsAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RP_SCP_RT_USD_ROUT_CS(" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("SELECT   SCG.PROP_NO" ).append("\n"); 
		...
		query.append("    PRI_RP_SCP_RT_USD_ROUT_CS SCG" ).append("\n"); 
