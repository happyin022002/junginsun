...
*@FileName : SCRateQuotationDBDAORsltPrsSurchargeDetailApplicableRouteRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPrsSurchargeDetailApplicableRouteRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPrsSurchargeDetailApplicableRouteRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPrsSurchargeDetailApplicableRouteRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
