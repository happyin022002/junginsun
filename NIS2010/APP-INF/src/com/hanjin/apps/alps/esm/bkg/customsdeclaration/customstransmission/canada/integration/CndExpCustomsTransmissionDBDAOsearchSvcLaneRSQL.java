...
*@FileName : CndExpCustomsTransmissionDBDAOsearchSvcLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchSvcLaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchSvcLaneRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchSvcLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
