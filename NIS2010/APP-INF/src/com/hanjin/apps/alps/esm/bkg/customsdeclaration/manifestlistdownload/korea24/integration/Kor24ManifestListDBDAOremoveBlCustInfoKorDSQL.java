...
*@FileName : Kor24ManifestListDBDAOremoveBlCustInfoKorDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOremoveBlCustInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOremoveBlCustInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOremoveBlCustInfoKorDSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_ADV_KR_CUST" ).append("\n");
		query.append("WHERE   (BKG_NO, CSTMS_DECL_TP_CD, BKG_CUST_TP_CD, DMST_PORT_CD) IN" ).append("\n");
		query.append("        (   SELECT  KC.BKG_NO,  KC.CSTMS_DECL_TP_CD, KC.BKG_CUST_TP_CD, KC.DMST_PORT_CD" ).append("\n");
		query.append("            FROM    BKG_CSTMS_ADV_KR_BL KT, BKG_CSTMS_ADV_KR_CUST KC" ).append("\n");
