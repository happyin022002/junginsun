...
*@FileName : RFARateQuotationDBDAOPriRqRtVODSQL.java
...
public class RFARateQuotationDBDAOPriRqRtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
