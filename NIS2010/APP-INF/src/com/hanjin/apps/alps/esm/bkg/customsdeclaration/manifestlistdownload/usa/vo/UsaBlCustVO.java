...
public class UsaBlCustVO extends AbstractValueObject {
	...
	public UsaBlCustVO(String ibflag, String pagerows, String cntCd, String blNo, String bkgCustTpCd, String custCntCd, String custSeq, String custNm, String custAddr, String phnNo, String faxNo) {
		this.phnNo = phnNo;
		this.ibflag = ibflag;
		this.custNm = custNm;
		this.cntCd = cntCd;
