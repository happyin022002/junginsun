...
public class BkgCstmsKrVvdSmryVO extends AbstractValueObject {
	...
	/* Column Info */
	private String ttlTsMty45ftQty = null;
	/* Column Info */
	...
	/* Column Info */
	private String ttlTsMtyTeuQty = null;
	/* Column Info */
	...
	/* Column Info */
	private String ttlTsMtyFeuQty = null;
	/* Column Info */
	...
	public BkgCstmsKrVvdSmryVO(String ibflag, String pagerows, String vslCd, String smpBlKnt, String etaDt, String ttlTsTeuQty, String mstBlKnt, String ttlMeasUtCd, String loclCstmsPrtCd, String mrnNo, String ttlMty45ftQty, String ttlTsMty45ftQty, String inType, String noneBlInType, String polCd, String cnslBlKnt, String userId, String vslCallSgnCd, String updUsrId, String vvdSeq, String transPreCnt, String joCrrKnt, String ttlTsFeuQty, String oldSndChk, String mrnChkNo, String dchgRptSndDt, String loclCstmsCd, String skdVoyNo, String fDate, String dchgMzdCd, String vvd, String podCd, String creUsrId, String ttlWgt, String ttlMeasQty, String ttlLcFeuQty, String whfNotice, String creDt, String cstmsDchgCd, String ttlTs45ftQty, String callYear, String ttlTsMtyTeuQty, String ttlFullKnt, String ttlLcTeuQty, String ttlLc45ftQty, String krVslCallSgnCd, String mfSndDt, String ttlTsMtyFeuQty, String callKnt, String ttlPckQty, String portCd, String rspnRcvDt, String vslCntCd, String mfSndUsrId, String ttlMtyTeuQty, String ttlMtyFeuQty, String updDt, String ioTmlLocCd, String vslNm, String shpCoCd, String ttlWgtUtCd, String etdDt, String ioBndCd, String mtyBlKnt, String bdAreaCd, String skdDirCd, String ttlMtyKnt, String dchgRptSndUsrId, String ttlPckUtCd, String ktPa, String podTml, String obDeclTpCd, String tDate, String mfSndRcvrId, String bdAreaChk, String crrInCyChk) {
		this.vslCd = vslCd;
		...
		this.polCd = polCd;
		this.inType = inType;
		this.ttlTsMty45ftQty = ttlTsMty45ftQty;
		...
		this.ttlTsMtyFeuQty = ttlTsMtyFeuQty;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ttl_ts_mty_45ft_qty", getTtlTsMty45ftQty());
		...
		this.hashColumns.put("whf_notice", getWhfNotice());
		...
		this.hashColumns.put("ttl_ts_mty_teu_qty", getTtlTsMtyTeuQty());
		...
		this.hashColumns.put("ttl_ts_mty_feu_qty", getTtlTsMtyFeuQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ttl_ts_mty_45ft_qty", "ttlTsMty45ftQty");
		...
		this.hashFields.put("whf_notice", "whfNotice");
		...
		this.hashFields.put("ttl_ts_mty_teu_qty", "ttlTsMtyTeuQty");
		...
		this.hashFields.put("ttl_ts_mty_feu_qty", "ttlTsMtyFeuQty");
	...
	/**
	 * Column Info
	 * @return ttlTsMty45ftQty
	 */
	public String getTtlTsMty45ftQty() {
		return this.ttlTsMty45ftQty;
	}
	 ...
	 * @return whfNotice
	 */
	public String getWhfNotice() {
		return this.whfNotice;
	}
	...
	/**
	 * Column Info
	 * @return ttlTsMtyTeuQty
	 */
	public String getTtlTsMtyTeuQty() {
		return this.ttlTsMtyTeuQty;
	}
	...
	/**
	 * Column Info
	 * @return ttlTsMtyFeuQty
	 */
	public String getTtlTsMtyFeuQty() {
		return this.ttlTsMtyFeuQty;
	}
	...
	/**
	 * Column Info
	 * @param ttlTsMty45ftQty
	 */
	public void setTtlTsMty45ftQty(String ttlTsMty45ftQty) {
		this.ttlTsMty45ftQty = ttlTsMty45ftQty;
	}
	 ...
	 * @param whfNotice
	 */
	public void setWhfNotice(String whfNotice) {
		this.whfNotice = whfNotice;
	}
	...
	/**
	 * Column Info
	 * @param ttlTsMtyTeuQty
	 */
	public void setTtlTsMtyTeuQty(String ttlTsMtyTeuQty) {
		this.ttlTsMtyTeuQty = ttlTsMtyTeuQty;
	}
	...
	/**
	 * Column Info
	 * @param ttlTsMtyFeuQty
	 */
	public void setTtlTsMtyFeuQty(String ttlTsMtyFeuQty) {
		this.ttlTsMtyFeuQty = ttlTsMtyFeuQty;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTtlMty45ftQty(JSPUtil.getParameter(request, prefix + "ttl_mty_45ft_qty", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setPolCd(JSPUtil.getParameter(request, prefix + "pol_cd", ""));
		setInType(JSPUtil.getParameter(request, prefix + "in_type", ""));
		setTtlTsMty45ftQty(JSPUtil.getParameter(request, prefix + "ttl_ts_mty_45ft_qty", ""));
		...
		setTtlTsFeuQty(JSPUtil.getParameter(request, prefix + "ttl_ts_feu_qty", ""));
		...
		setDchgRptSndDt(JSPUtil.getParameter(request, prefix + "dchg_rpt_snd_dt", ""));
		setLoclCstmsCd(JSPUtil.getParameter(request, prefix + "locl_cstms_cd", ""));
		setSkdVoyNo(JSPUtil.getParameter(request, prefix + "skd_voy_no", ""));
		setFDate(JSPUtil.getParameter(request, prefix + "f_date", ""));
		...
		setTtlLcFeuQty(JSPUtil.getParameter(request, prefix + "ttl_lc_feu_qty", ""));
		setWhfNotice(JSPUtil.getParameter(request, prefix + "whf_notice", ""));
		setCreDt(JSPUtil.getParameter(request, prefix + "cre_dt", ""));
		setCstmsDchgCd(JSPUtil.getParameter(request, prefix + "cstms_dchg_cd", ""));
		setTtlTs45ftQty(JSPUtil.getParameter(request, prefix + "ttl_ts_45ft_qty", ""));
		setCallYear(JSPUtil.getParameter(request, prefix + "call_year", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setTtlTsMtyTeuQty(JSPUtil.getParameter(request, prefix + "ttl_ts_mty_teu_qty", ""));
		setTtlFullKnt(JSPUtil.getParameter(request, prefix + "ttl_full_knt", ""));
		setTtlLcTeuQty(JSPUtil.getParameter(request, prefix + "ttl_lc_teu_qty", ""));
		setTtlLc45ftQty(JSPUtil.getParameter(request, prefix + "ttl_lc_45ft_qty", ""));
		...
		setTtlTsMtyFeuQty(JSPUtil.getParameter(request, prefix + "ttl_ts_mty_feu_qty", ""));
		...
		setTtlMtyTeuQty(JSPUtil.getParameter(request, prefix + "ttl_mty_teu_qty", ""));
		setTtlMtyFeuQty(JSPUtil.getParameter(request, prefix + "ttl_mty_feu_qty", ""));
		setUpdDt(JSPUtil.getParameter(request, prefix + "upd_dt", ""));
		setIoTmlLocCd(JSPUtil.getParameter(request, prefix + "io_tml_loc_cd", ""));
		setTtlWgtUtCd(JSPUtil.getParameter(request, prefix + "ttl_wgt_ut_cd", ""));
		setShpCoCd(JSPUtil.getParameter(request, prefix + "shp_co_cd", ""));
	...
	public BkgCstmsKrVvdSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ttlTsMty45ftQty = (JSPUtil.getParameter(request, prefix	+ "ttl_ts_mty_45ft_qty", length));
			...
			String[] whfNotice = (JSPUtil.getParameter(request, prefix	+ "whf_notice", length));
			...
			String[] ttlTsMtyTeuQty = (JSPUtil.getParameter(request, prefix	+ "ttl_ts_mty_teu_qty", length));
			...
			String[] ttlTsMtyFeuQty = (JSPUtil.getParameter(request, prefix	+ "ttl_ts_mty_feu_qty", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ttlTsMty45ftQty[i] != null)
					model.setTtlTsMty45ftQty(ttlTsMty45ftQty[i]);
				if (cnslBlKnt[i] != null)
				...
				if (whfNotice[i] != null)
					model.setWhfNotice(whfNotice[i]);
				if (creDt[i] != null)
				...
				if (ttlTsMtyTeuQty[i] != null)
					model.setTtlTsMtyTeuQty(ttlTsMtyTeuQty[i]);
				...
				if (ttlTsMtyFeuQty[i] != null)
					model.setTtlTsMtyFeuQty(ttlTsMtyFeuQty[i]);
				if (callKnt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.ttlTsMty45ftQty = this.ttlTsMty45ftQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.whfNotice = this.whfNotice .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ttlTsMtyTeuQty = this.ttlTsMtyTeuQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ttlTsMtyFeuQty = this.ttlTsMtyFeuQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
