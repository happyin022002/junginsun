...
*@FileName : Kor24ManifestListDBDAOAddReBlInfoKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOAddReBlInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOAddReBlInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOAddReBlInfoKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_ADV_KR_BL " ).append("\n");
