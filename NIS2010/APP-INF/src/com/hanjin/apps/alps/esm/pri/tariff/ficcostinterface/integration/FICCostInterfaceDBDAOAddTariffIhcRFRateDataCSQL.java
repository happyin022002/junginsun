...
*@FileName : FICCostInterfaceDBDAOAddTariffIhcRFRateDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOAddTariffIhcRFRateDataCSQL implements ISQLTemplate{
	...
	public FICCostInterfaceDBDAOAddTariffIhcRFRateDataCSQL(){
		...
		query.append("FileName : FICCostInterfaceDBDAOAddTariffIhcRFRateDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                       SUBSTR(B.LOC_NOD_CD, 1, 5) PNT_LOC_CD," ).append("\n"); 
		query.append("                       SUBSTR(B.PORT_NOD_CD, 1, 5) BSE_PORT_LOC_CD," ).append("\n"); 
		query.append("                       SUBSTR(B.HUB_NOD_CD, 1, 5) HUB_LOC_CD," ).append("\n"); 
		query.append("                       B.LOC_NOD_CD PNT_NOD_CD," ).append("\n"); 
		query.append("                       B.HUB_NOD_CD HUB_NOD_CD," ).append("\n"); 
		query.append("                       B.PORT_NOD_CD BSE_PORT_NOD_CD," ).append("\n"); 
		query.append("                       A.LOC_GRP_NO IHC_COST_LOC_GRP_NO," ).append("\n"); 
		query.append("                       B.RCV_DE_TERM_CD RCV_DE_TERM_CD," ).append("\n"); 
		query.append("                       CASE" ).append("\n"); 
		query.append("                           WHEN B.TRSP_CRR_MOD_CD IN ( 'WD','WR','RW') THEN 'B'" ).append("\n"); 
		query.append("                           WHEN B.TRSP_CRR_MOD_CD = 'RD' THEN 'R'" ).append("\n"); 
		query.append("                           WHEN B.TRSP_CRR_MOD_CD ='TD' THEN 'T'" ).append("\n"); 
		query.append("                           WHEN B.TRSP_CRR_MOD_CD IN ('WT', 'TW') THEN 'U'" ).append("\n"); 
		query.append("                           WHEN B.TRSP_CRR_MOD_CD IN ('RT', 'TR') THEN 'A'" ).append("\n"); 
		query.append("                       END  PRC_TRSP_MOD_CD," ).append("\n"); 
		query.append("                       TPB_GET_USD_AMT_FNC(B.RF_20FT_TTL_COST_AMT, A.CURR_CD, F.ACCT_XCH_RT_YRMON) GLINE_20FT_FRT_RT_AMT," ).append("\n"); 
		query.append("                       TPB_GET_USD_AMT_FNC(B.RF_40FT_TTL_COST_AMT, A.CURR_CD, F.ACCT_XCH_RT_YRMON) GLINE_40FT_FRT_RT_AMT," ).append("\n"); 
		query.append("                       TPB_GET_USD_AMT_FNC(B.RF_20FT_TTL_COST_AMT, A.CURR_CD, F.ACCT_XCH_RT_YRMON) COST_20FT_FRT_RT_AMT," ).append("\n"); 
		query.append("                       TPB_GET_USD_AMT_FNC(B.RF_40FT_TTL_COST_AMT, A.CURR_CD, F.ACCT_XCH_RT_YRMON) COST_40FT_FRT_RT_AMT," ).append("\n"); 
		query.append("                       B.RF_20FT_TTL_COST_AMT LOCL_CURR_COST_20FT_FRT_RT_AMT," ).append("\n"); 
		query.append("                       B.RF_40FT_TTL_COST_AMT LOCL_CURR_COST_40FT_FRT_RT_AMT," ).append("\n"); 
		query.append("                #if(${rhq_cd} == 'NYCRA')" ).append("\n"); 
		query.append("                       TPB_GET_USD_AMT_FNC(NVL(A.RAIL_20FT_BZC_COST_TTL_AMT,0) + NVL(A.RAIL_20FT_FUEL_SCG_TTL_AMT,0) + NVL(A.TRK_20FT_BZC_COST_TTL_AMT,0) + NVL(A.TRK_20FT_FUEL_SCG_TTL_AMT,0), A.CURR_CD, F.ACCT_XCH_RT_YRMON) TRSP_20FT_COST_AMT," ).append("\n"); 
		query.append("                       TPB_GET_USD_AMT_FNC(NVL(A.RAIL_40FT_BZC_COST_TTL_AMT,0) + NVL(A.RAIL_40FT_FUEL_SCG_TTL_AMT,0) + NVL(A.TRK_40FT_BZC_COST_TTL_AMT,0) + NVL(A.TRK_40FT_FUEL_SCG_TTL_AMT,0), A.CURR_CD, F.ACCT_XCH_RT_YRMON) TRSP_40FT_COST_AMT," ).append("\n"); 
		...
		query.append("                            AOC_USA_INLND_TRF_DTL A, AOC_USA_INLND_RF_TRF_DTL B,	" ).append("\n"); 
		query.append("                         #end" ).append("\n"); 
		query.append("                         #if(${rhq_cd} == 'HAMRU') " ).append("\n"); 
		query.append("                            AOC_EUR_INLND_TRF_DTL A, AOC_EUR_INLND_RF_TRF_DTL B," ).append("\n"); 
		query.append("                         #end    " ).append("\n"); 
		query.append("                         #if(${rhq_cd} == 'SINRS') " ).append("\n"); 
		query.append("                            AOC_CHN_INLND_TRF_DTL A, AOC_CHN_INLND_RF_TRF_DTL B," ).append("\n"); 
		query.append("                         #end" ).append("\n"); 
