...
*@FileName : ESM_AGT_0005HTMLAction.java
...
public class ESM_AGT_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0005HTMLAction 객체를 생성
	 */
	public ESM_AGT_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0005Event event = new EsmAgt0005Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setAgtChargeDeductionVO((AgtChargeDeductionVO)getVO(request, AgtChargeDeductionVO .class));
		}
