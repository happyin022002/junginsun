...
public class MalaysiaCustomsTransmissionDBDAOSearchCustomerInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT    DECODE(C.BKG_CUST_TP_CD,'S','CZ','C','CN','F','FW','N','NI') CUSTOMER_TYPE" ).append("\n"); 
		...
		query.append("AND       C.BKG_CUST_TP_CD IN ('C','F','N','S') /* A Also notify 제외 2017.08.25 */" ).append("\n"); 
