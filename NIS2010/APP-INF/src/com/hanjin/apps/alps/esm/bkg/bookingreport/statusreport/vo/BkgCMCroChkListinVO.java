...
public class BkgCMCroChkListinVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCMCroChkListinVO> models = new ArrayList<BkgCMCroChkListinVO>();
	 ...
	 */
	public BkgCMCroChkListinVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCMCroChkListinVO[]
	 */
	public BkgCMCroChkListinVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCMCroChkListinVO model = null;
	...
	public BkgCMCroChkListinVO[] getBkgCMCroChkListinVOs(){
		BkgCMCroChkListinVO[] vos = (BkgCMCroChkListinVO[])models.toArray(new BkgCMCroChkListinVO[models.size()]);
		return vos;
	}
