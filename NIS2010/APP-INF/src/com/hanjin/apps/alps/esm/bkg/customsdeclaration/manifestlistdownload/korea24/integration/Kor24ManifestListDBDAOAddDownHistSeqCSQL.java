...
*@FileName : Kor24ManifestListDBDAOAddDownHistSeqCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOAddDownHistSeqCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOAddDownHistSeqCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOAddDownHistSeqCSQL").append("\n");
		query.append("*/").append("\n");
	}
