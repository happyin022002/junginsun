...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutPntMaxSeqRSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutPntMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutPntMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutPntMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(MAX(ROUT_PNT_SEQ)+1,1) AS MAX_SEQ" ).append("\n"); 
