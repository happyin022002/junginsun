...
*@FileName : ESM_MAS_0082HTMLAction.java
 ...
 * @see EsmMas0082Event 참조
 * @since J2EE 1.6
 */

public class ESM_MAS_0082HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0082HTMLAction 객체를 생성
	 */
	public ESM_MAS_0082HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0082Event event = new EsmMas0082Event();
