...
public class CostStructureDBDAOSearchSoCodeListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        FROM MAS_ACT_GRP_COST_MAPG " ).append("\n"); 
		query.append("        WHERE COST_ACT_GRP_CD = '$key'" ).append("\n"); 
		query.append("          AND MAS_COST_SRC_CD = A.MAS_COST_SRC_CD" ).append("\n"); 
		...
		query.append("   MAS_COST_SRC_ACCT A" ).append("\n"); 
		query.append("  ,MAS_STND_ACCT B" ).append("\n"); 
		query.append("  ,MAS_SUB_GRP_COST C" ).append("\n"); 
