...
*@FileName : NetworkCostDBDAOAverageUCVesselUtDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOAverageUCVesselUtDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOAverageUCVesselUtDetailCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOAverageUCVesselUtDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL MAS_POOL_UT_COST_DTL_PRC" ).append("\n"); 
		query.append("(" ).append("\n"); 
