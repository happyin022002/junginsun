...
*@FileName : ESM_BKG_5002HTMLAction.java
...
public class ESM_BKG_5002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_5002HTMLAction 객체를 생성
	 */
	public ESM_BKG_5002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg5002Event event = new EsmBkg5002Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setUnStlRdnReportVO((UnStlRdnReportVO)getVO(request, UnStlRdnReportVO .class));
		}
