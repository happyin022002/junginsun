...
*@FileName : EServiceCompensationDBDAOPriRpHdrVORFANoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EServiceCompensationDBDAOPriRpHdrVORFANoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EServiceCompensationDBDAOPriRpHdrVORFANoRSQL(){
		setQuery();
		...
		query.append("FileName : EServiceCompensationDBDAOPriRpHdrVORFANoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(SELECT" ).append("\n"); 
		query.append("TRIM(RFA_NO)" ).append("\n"); 
