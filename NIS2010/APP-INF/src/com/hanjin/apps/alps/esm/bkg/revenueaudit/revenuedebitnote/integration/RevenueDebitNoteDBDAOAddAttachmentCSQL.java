...
*@FileName : RevenueDebitNoteDBDAOAddAttachmentCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOAddAttachmentCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOAddAttachmentCSQL(){
		setQuery();
		...
		query.append("FileName : RevenueDebitNoteDBDAOAddAttachmentCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
