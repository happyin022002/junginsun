...
public class BkgTsCoffTmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<BkgTsCoffTmVO> models = new ArrayList<BkgTsCoffTmVO>();
	...
	public BkgTsCoffTmVO() {}

	public BkgTsCoffTmVO(String ibflag, String pagerows, String vvd, String polCd, String ydCd, String bkgOfcCd, String bkgClzStsCd, String bkgClzStsNm, String ofcCd, String updUsrId, String usrNm, String updDt, String vslCd, String skdVoyNo, String skdDirCd, String clptIndSeq) {
	 ...
	 */
	public BkgTsCoffTmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCoffTmListVO[]
	 */
	public BkgTsCoffTmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgTsCoffTmVO model = null;
	 ...
	 * @return BkgCoffTmListVO[]
	 */
	public BkgTsCoffTmVO[] getBkgCoffTmListVOs(){
		BkgTsCoffTmVO[] vos = (BkgTsCoffTmVO[])models.toArray(new BkgTsCoffTmVO[models.size()]);
		return vos;
	}
