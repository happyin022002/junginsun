 ...
 * @since J2EE 1.6
 */
public class SearchProposalChartListBackEndJob extends BackEndCommandSupport{
	...
	public DBRowSet doStart() throws Exception {
		...
		try {
			...
			List<RsltPrsProposalSummaryChartTargetListVO>  vo = dbDao.searchProposalChartTargetList(inPrsProposalCmSummaryVO);
			dbDao.addPriPrsCmSmrySimTmpTargetList(vo);
			rowSet = dbDao.searchProposalChartList(inPrsProposalCmSummaryVO,vo);
