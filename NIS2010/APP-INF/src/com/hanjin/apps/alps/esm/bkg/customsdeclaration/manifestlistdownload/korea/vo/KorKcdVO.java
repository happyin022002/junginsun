...
public class KorKcdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorKcdVO> models = new ArrayList<KorKcdVO>();
	...
	public KorKcdVO(String ibflag, String pagerows, String cstmsDeclTpCd, String bkgNo, String trnsSeq, String dmstPortCd, String vvd) {
		this.vvd = vvd;
...
/**
	 ...
	 * @return KorKcdVO[]
	 */
	public KorKcdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorKcdVO[]
	 */
	public KorKcdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorKcdVO model = null;
	 ...
	 * @return KorKcdVO[]
	 */
	public KorKcdVO[] getKorKcdVOs(){
		KorKcdVO[] vos = (KorKcdVO[])models.toArray(new KorKcdVO[models.size()]);
		return vos;
	}
