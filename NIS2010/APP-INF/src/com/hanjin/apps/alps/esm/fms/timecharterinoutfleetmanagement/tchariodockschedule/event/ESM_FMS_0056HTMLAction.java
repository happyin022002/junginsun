...
*@FileName : ESM_FMS_0056HTMLAction.java
*@FileTitle : D/Dock Schedule Review - Graph/Print
*Open Issues :
*Change history :
...
public class ESM_FMS_0056HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0055HTMLAction 객체를 생성
	 */
	public ESM_FMS_0056HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0056Event event = new EsmFms0056Event();
