		   ...
		   int vvd_port_cnt = 0;//VVD별 PORT 개수
			...
			for(int i = 0 ; i < realCnt ; i++){
				...
				if(!vvdSeq.equals(groupVvvdSeq)){
					...
					//>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 2 Row sked<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
					sked.append("  <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD>");//td 1~4 
					sked.append("  <TD BOLD=\"TRUE\"><![CDATA[VESSEL]]></TD>");//td5
					sked.append("  <TD DATA-ALIGN=\"daLeft\" BOLD=\"TRUE\"><![CDATA[SKED]]></TD>");//td6
					...
					local.append("  <TD DATA-ALIGN=\"daLeft\" BOLD=\"TRUE\"><![CDATA[Local]]></TD>");//td 6
					...
					ts.append("  <TD DATA-ALIGN=\"daLeft\" BOLD=\"TRUE\"><![CDATA[T/S]]></TD>");//td 6
					...
					mty.append("  <TD DATA-ALIGN=\"daLeft\" BOLD=\"TRUE\"><![CDATA[MTY]]></TD>");//td 6
					...
					ttl.append("  <TD DATA-ALIGN=\"daLeft\" BOLD=\"TRUE\"><![CDATA[TTL]]></TD>");//td 6
					...
					pfmc.append("  <TD DATA-ALIGN=\"daLeft\" BOLD=\"TRUE\"><![CDATA[PFMC]]></TD>");//td6
				...
				title.append("  <TD BOLD=\"TRUE\" DATA-ALIGN=\"daCenter\"><![CDATA[").append(nowColValues.get("vps_port_cd")).append("]]></TD>\n");
				title.append("  <TD BOLD=\"TRUE\" DATA-ALIGN=\"daCenter\"><![CDATA[").append(nowColValues.get("vps_port_cd")).append("]]></TD>\n");
				title.append("  <TD BOLD=\"TRUE\" DATA-ALIGN=\"daCenter\"><![CDATA[").append(nowColValues.get("vps_port_cd")).append("]]></TD>\n");
				...
				rawdata.append("  <TD DATA-ALIGN=\"daCenter\"><![CDATA[").append(nowColValues.get("vps_port_cd")).append("]]></TD>\n");
			...
			if(realCnt > 0){
				...
				sbufXML.append(" <TR MERGE=\"FALSE\">\n");
				sbufXML.append("  <TD><![CDATA[]]></TD>\n");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\" BGCOLOR=\"246, 225, 236\"><![CDATA[IPC]]></TD>\n");				
				sbufXML.append("  <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD>");
				sbufXML.append("  <TD  DATA-ALIGN=\"daRight\"><![CDATA[").append(nowColValues.get("tot_lod_ipc_e")).append("]]></TD>\n");
				sbufXML.append("  <TD  DATA-ALIGN=\"daRight\"><![CDATA[").append(nowColValues.get("tot_lod_ipc_w")).append("]]></TD>\n");
				sbufXML.append(makeTailData(0));
				sbufXML.append(" </TR>\n");
				
				sbufXML.append(" <TR MERGE=\"FALSE\">\n");
				sbufXML.append("  <TD><![CDATA[]]></TD>\n");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\" BGCOLOR=\"246, 225, 236\"><![CDATA[TPS]]></TD>\n");				
				sbufXML.append("  <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD>");
				sbufXML.append("  <TD  DATA-ALIGN=\"daRight\"><![CDATA[").append(nowColValues.get("tot_lod_tps_e")).append("]]></TD>\n");
				sbufXML.append("  <TD  DATA-ALIGN=\"daRight\"><![CDATA[").append(nowColValues.get("tot_lod_tps_w")).append("]]></TD>\n");
				sbufXML.append(makeTailData(0));
				sbufXML.append(" </TR>\n");
				
				sbufXML.append(" <TR MERGE=\"FALSE\">\n");
				sbufXML.append("  <TD><![CDATA[]]></TD>\n");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\" BGCOLOR=\"246, 225, 236\"><![CDATA[EUR]]></TD>\n");				
				sbufXML.append("  <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD> <TD><![CDATA[]]></TD>");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\"><![CDATA[").append(nowColValues.get("tot_lod_eur_e")).append("]]></TD>\n");
				sbufXML.append("  <TD DATA-ALIGN=\"daRight\"><![CDATA[").append(nowColValues.get("tot_lod_eur_w")).append("]]></TD>\n");
				sbufXML.append(makeTailData(0));
				sbufXML.append(" </TR>\n");
