...
*@FileName : ESM_SPC_0015HTMLAction.java
...
public class ESM_SPC_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0015HTMLAction 객체를 생성
	 */
	public ESM_SPC_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0015Event event = new EsmSpc0015Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSpcNshwRfltVOS((SpcNshwRfltVO[])getVOs(request, SpcNshwRfltVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchNoShowReflectionListVO((SearchNoShowReflectionListVO)getVO(request, SearchNoShowReflectionListVO .class));
		}
