 ...
 *@FileName : ESM_AGT_006HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.agt.agtagreement 화면을 통해 서버로 전송되는 HTML DOM 객체의
...
public class ESM_AGT_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_AGT_0006HTMLAction 객체를 생성
	 */
	public ESM_AGT_0006HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0006Event event = new EsmAgt0006Event();

		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setAgtGeogOfcVO((AgtGeogOfcVO) getVO(request, AgtGeogOfcVO.class));
		}
