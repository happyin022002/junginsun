...
*@FileName : RFAAffiliateProposalDBDAOPriRpAfilAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAAffiliateProposalDBDAOPriRpAfilAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCAffiliateProposalDBDAOPriRpAfilAmdVOCSQL
	  * </pre>
	  */
	public RFAAffiliateProposalDBDAOPriRpAfilAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAAffiliateProposalDBDAOPriRpAfilAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_RP_AFIL" ).append("\n"); 
