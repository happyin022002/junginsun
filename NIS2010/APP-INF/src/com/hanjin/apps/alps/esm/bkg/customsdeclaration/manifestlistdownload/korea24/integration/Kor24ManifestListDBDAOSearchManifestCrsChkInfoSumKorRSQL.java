...
*@FileName : Kor24ManifestListDBDAOSearchManifestCrsChkInfoSumKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchManifestCrsChkInfoSumKorRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Kor24ManifestListDBDAOSearchManifestCrsChkInfoSumKor
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchManifestCrsChkInfoSumKorRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchManifestCrsChkInfoSumKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("MAX(( /*+ INDEX_DESC(AAA XPKBKG_CSTMS_ADV_KR_VVD_SMRY) */" ).append("\n");
