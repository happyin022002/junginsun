...
*@FileName : KorAmendManifestTransmitVO.java
*@FileTitle : KorAmendManifestTransmitVO
*Open Issues :
*Change history :
...
public class KorAmendManifestTransmitVO extends AmendManifestTransmitVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorAmendManifestTransmitVO> models = new ArrayList<KorAmendManifestTransmitVO>();
	 ...
	 */
	public KorAmendManifestTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorAmendManifestTransmitVO[]
	 */
	public KorAmendManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorAmendManifestTransmitVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new KorAmendManifestTransmitVO();
				if (cancelFlg[i] != null)
		...
		return getKorAmendManifestTransmitVOs();
	}
	 ...
	 * @return KorAmendManifestTransmitVO[]
	 */
	public KorAmendManifestTransmitVO[] getKorAmendManifestTransmitVOs(){
		KorAmendManifestTransmitVO[] vos = (KorAmendManifestTransmitVO[])models.toArray(new KorAmendManifestTransmitVO[models.size()]);
		return vos;
	}
