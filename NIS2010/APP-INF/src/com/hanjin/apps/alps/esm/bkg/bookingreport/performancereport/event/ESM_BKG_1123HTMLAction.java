...
*@FileName : ESM_BKG_0620HTMLAction.java
...
public class ESM_BKG_1123HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0620HTMLAction 객체를 생성
	 */
	public ESM_BKG_1123HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1123Event event = new EsmBkg1123Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTroEurStatusListInVO((TroEurStatusListInVO)getVO(request, TroEurStatusListInVO .class));
