...
public class KorMrnCreateCondVO extends MrnCreateCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorMrnCreateCondVO> models = new ArrayList<KorMrnCreateCondVO>();
	...
	public KorMrnCreateCondVO() {}

	public KorMrnCreateCondVO(String ibflag, String pagerows, String mrnNo, String ioBndCd, String vvd1, String portCd, String vvd2, String vvd, String mrnChkNo, String userId) {
		this.vvd = vvd;
		this.ibflag = ibflag;
	 ...
	 */
	public KorMrnCreateCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMrnCreateInfoCondVO[]
	 */
	public KorMrnCreateCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMrnCreateCondVO model = null;
	 ...
	 * @return KorMrnCreateInfoCondVO[]
	 */
	public KorMrnCreateCondVO[] getKorMrnCreateInfoCondVOs(){
		KorMrnCreateCondVO[] vos = (KorMrnCreateCondVO[])models.toArray(new KorMrnCreateCondVO[models.size()]);
		return vos;
	}
