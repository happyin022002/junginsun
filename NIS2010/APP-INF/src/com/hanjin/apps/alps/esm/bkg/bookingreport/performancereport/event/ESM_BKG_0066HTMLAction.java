...
*@FileName : ESM_BKG_0066HTMLAction.java
...
public class ESM_BKG_0066HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0066HTMLAction 객체를 생성
     */
    public ESM_BKG_0066HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0066Event event = new EsmBkg0066Event();
		
		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((DocTurnTimeInVO) getVO(request, DocTurnTimeInVO.class));
