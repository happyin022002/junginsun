...
*@FileName : SpacecontrolinquiryDBDAO021AllocPortViewList4ByPortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAO021AllocPortViewList4ByPortRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Daily Forecast Status 화면 내 BKG Status(RHQ) 탭 조회- BKG View
	  ...
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAO021AllocPortViewList4ByPortRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAO021AllocPortViewList4ByPortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("           B.DEL_CD         ,--del" ).append("\n"); 
		...
		query.append("                     @[del_cd]              AS DEL_CD , --DEL추가" ).append("\n"); 
		...
		query.append("           B.SUB_TRD_CD," ).append("\n"); 
		query.append("           B.RLANE_CD  ," ).append("\n"); 
		query.append("           DECODE(A.PORT_DIV, 'POR', POL_YD_CD, 'POL', POL_YD_CD, POD_YD_CD) AS PORT," ).append("\n"); 
		...
		query.append("           B.SUB_TRD_CD," ).append("\n"); 
		query.append("           B.RLANE_CD  ," ).append("\n"); 
		query.append("           DECODE(A.PORT_DIV, 'POR', POL_YD_CD, 'POL', POL_YD_CD, POD_YD_CD)," ).append("\n"); 
		...
		query.append("                   A.SUB_TRD_CD," ).append("\n"); 
		query.append("                   A.RLANE_CD  ," ).append("\n"); 
		query.append("                   DECODE(A.PORT_DIV, 'POR', B.POL_NOD_CD, 'POL', NVL(BV.POL_YD_CD, B.POL_NOD_CD), 'POD', NVL(BV.POD_YD_CD, B.POD_NOD_CD), B.POD_NOD_CD)AS PORT," ).append("\n"); 
		...
		query.append("                             || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), '5', Q.OP_CNTR_QTY, '9', Q.OP_CNTR_QTY, '8', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000')	--R9,R8 에 대해서 R5과 동일하게 HC으로 처리되도록 추가" ).append("\n"); 
		...
		query.append("                             CUBE(Z2.SUB_TRD_CD, Z2.RLANE_CD, Z2.DIR_CD, Z2.AQ_CD,  Z2.PORT, Z2.OFC_CD " ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("                             Z2.TRD_CD," ).append("\n"); 
		query.append("                             Z2.SUB_TRD_CD," ).append("\n"); 
		query.append("                             CUBE(Z2.RLANE_CD, Z2.DIR_CD, Z2.AQ_CD,  Z2.PORT, Z2.OFC_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${checkVvd5} == 'Y')" ).append("\n"); 
		query.append("                                 ,NUM_1" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("                                 )" ).append("\n"); 
		query.append("                      HAVING     (NOT (AQ_CD IS NULL AND Z2.PORT IS NOT NULL))" ).append("\n"); 
		...
		query.append("                             AND (NOT (PORT IS NULL AND  OFC_CD IS NOT NULL))" ).append("\n"); 
		query.append("#if(${checkVvd5} == 'Y')" ).append("\n"); 
		...
		query.append("#if ((${port_div} == 'DEL' && ${del_cd} != '') || (${port_div} == 'POR' && ${por_cd} != ''))" ).append("\n"); 
		query.append("AND (" ).append("\n"); 
		query.append("#foreach( $key in $new_dur )" ).append("\n"); 
		query.append("         Z4.BKG${key}1 > 0 OR " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("Z4.BKG11>0" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("#end" ).append("\n"); 
