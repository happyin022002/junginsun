...
*@FileName : EServiceCompensationDBDAOMdmSvcScpLmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EServiceCompensationDBDAOMdmSvcScpLmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EServiceCompensationDBDAOMdmSvcScpLmtRSQL(){
		setQuery();
		...
		query.append("FileName : EServiceCompensationDBDAOMdmSvcScpLmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
