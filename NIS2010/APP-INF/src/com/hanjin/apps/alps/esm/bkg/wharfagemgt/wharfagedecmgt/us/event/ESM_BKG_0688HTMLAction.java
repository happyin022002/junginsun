 ...
 *@FileName : ESM_BKG_0688HTMLAction.java
 ...
 * @see EsmBkg0688Event 참조
 * @since J2EE 1.4
 */
public class ESM_BKG_0688HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0688HTMLAction 객체를 생성
	 */
	public ESM_BKG_0688HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0688Event event = new EsmBkg0688Event();
