...
*@FileName : CargoReleaseOrderDBDAOsearchCaCgoRlseList2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOsearchCaCgoRlseList2RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CargoReleaseOrderDBDAOsearchCaCgoRlseList2RSQL
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOsearchCaCgoRlseList2RSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOsearchCaCgoRlseList2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
