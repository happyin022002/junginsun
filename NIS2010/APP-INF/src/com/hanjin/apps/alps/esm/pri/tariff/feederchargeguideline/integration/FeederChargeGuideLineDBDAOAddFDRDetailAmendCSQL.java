...
*@FileName : FeederChargeGuideLineDBDAOAddFDRDetailAmendCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOAddFDRDetailAmendCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add FDR Detail Amend
	  * 
	  * *History
	  * 2013.03.16 [CHM-201534279] 전지예 Pricing Feeder/IHC tariff 45" 칼럼 추가 안
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOAddFDRDetailAmendCSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOAddFDRDetailAmendCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
