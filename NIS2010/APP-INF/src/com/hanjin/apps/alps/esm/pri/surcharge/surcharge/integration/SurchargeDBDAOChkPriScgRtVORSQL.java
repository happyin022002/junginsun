...
*@FileName : SurchargeDBDAOChkPriScgRtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeDBDAOChkPriScgRtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SurchargeDBDAOChkPriScgRtVORSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeDBDAOChkPriScgRtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("   AND WDR_FLG = (DECODE(@[wdr_flg], 1, 'Y', 'N')) " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${scg_crte_dy_knt} != '')" ).append("\n"); 
		query.append("   AND SCG_CRTE_DY_KNT = @[scg_crte_dy_knt]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND SCG_CRTE_DY_KNT IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${scg_prd_tp_cd} != '')" ).append("\n"); 
		query.append("   AND SCG_PRD_TP_CD = @[scg_prd_tp_cd]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND SCG_PRD_TP_CD IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${scg_prd_crte_cd} != '')" ).append("\n"); 
		query.append("   AND SCG_PRD_CRTE_CD = @[scg_prd_crte_cd]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND SCG_PRD_CRTE_CD IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${rc_air_cond_tp_cd} != '')" ).append("\n"); 
		query.append("   AND RC_AIR_COND_TP_CD = @[rc_air_cond_tp_cd]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND RC_AIR_COND_TP_CD IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${ctrt_dt} != '')" ).append("\n"); 
		query.append("   AND CTRT_DT = TO_DATE(@[ctrt_dt], 'YYYYMMDD')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND CTRT_DT IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${fd_grd_flg} != '')" ).append("\n"); 
		query.append("   AND FD_GRD_FLG = @[fd_grd_flg]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND FD_GRD_FLG IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${cnt_cd} != '')" ).append("\n"); 
		query.append("   AND CNT_CD = @[cnt_cd]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND CNT_CD IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${ste_cd} != '')" ).append("\n"); 
		query.append("   AND STE_CD = @[ste_cd]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND STE_CD IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${arr_dt} != '')" ).append("\n"); 
		query.append("   AND ARR_DT = TO_DATE(@[arr_dt], 'YYYYMMDD')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("   AND ARR_DT IS NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
