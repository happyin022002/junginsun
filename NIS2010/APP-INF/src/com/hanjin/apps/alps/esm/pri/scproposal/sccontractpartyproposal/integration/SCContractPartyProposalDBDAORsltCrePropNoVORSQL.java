...
*@FileName : SCContractPartyProposalDBDAORsltCrePropNoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCContractPartyProposalDBDAORsltCrePropNoVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCContractPartyProposalDBDAORsltCrePropNoVORSQL
	  * </pre>
	  */
	public SCContractPartyProposalDBDAORsltCrePropNoVORSQL(){
		setQuery();
		...
		query.append("FileName : SCContractPartyProposalDBDAORsltCrePropNoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
