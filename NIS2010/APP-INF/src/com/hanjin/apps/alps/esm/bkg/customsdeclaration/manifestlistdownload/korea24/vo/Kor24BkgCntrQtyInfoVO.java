...
*@FileName : Kor24BkgCntrQtyInfoVO.java
*@FileTitle : Kor24BkgCntrQtyInfoVO
*Open Issues :
*Change history :
...
public class Kor24BkgCntrQtyInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24BkgCntrQtyInfoVO> models = new ArrayList<Kor24BkgCntrQtyInfoVO>();
	 ...
	 * @param request
	 * @return Kor24BkgCntrQtyInfoVO[]
	 */
	public Kor24BkgCntrQtyInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24BkgCntrQtyInfoVO[]
	 */
	public Kor24BkgCntrQtyInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BkgCntrQtyInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24BkgCntrQtyInfoVO();
				if (cntrWgt[i] != null)
		...
		return getKor24BkgCntrQtyInfoVOs();
	}
	...
	public Kor24BkgCntrQtyInfoVO[] getKor24BkgCntrQtyInfoVOs(){
		Kor24BkgCntrQtyInfoVO[] vos = (Kor24BkgCntrQtyInfoVO[])models.toArray(new Kor24BkgCntrQtyInfoVO[models.size()]);
		return vos;
	}
