 ...
 * ------------------------------------------------------
 * history 
 * 2011.03.30 김영철 [CHM-201109395] Korea Wharfage 보완 요청 - 변수 초기화 작업
=========================================================*/
...
import com.hanjin.apps.alps.esm.bkg.wharfagemgt.wharfagedecmgt.kr.vo.KrWhfBkgChkVO;
...
import com.hanjin.apps.alps.esm.bkg.wharfagemgt.wharfagedecmgt.kr.vo.KrWhfBlChkVO;
...
import com.hanjin.apps.alps.esm.bkg.wharfagemgt.wharfagedecmgt.kr.vo.KrWhfCommInvVO;
...
import com.hanjin.apps.alps.esm.bkg.wharfagemgt.wharfagedecmgt.kr.vo.KrWhfDecChkVO;
...
/**
 * NIS2010 KrWharfageDecMgtDBDAO <br>
...
public class KrWharfageDecMgtDBDAO extends DBDAOSupport {
	...
	/**
	 * BKG 마스터 중 WHF 신고 누락 분이 있는지 조회
	 * 
	 * @param  KrWhfBlChkListCondVO krWhfBkgChkListCondVO
	 * @return List<WhfBkgChkVO>
	 * @throws DAOException
	 */
	@SuppressWarnings("unchecked")
	public List<WhfBkgChkVO> searchKrWhfBkgChkList( KrWhfBkgChkListCondVO krWhfBkgChkListCondVO ) throws DAOException {
		DBRowSet dbRowset = null;
		List<WhfBkgChkVO> list = null;
		...
		try
		{
			if (krWhfBkgChkListCondVO != null)
			{
				Map<String, String> mapVO = krWhfBkgChkListCondVO.getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
			}
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new KrWharfageDecMgtDBDAOsearchKrWhfBkgChkListRSQL(), param, velParam);
			list = (List) RowSetUtil.rowSetToVOs(dbRowset, KrWhfBkgChkVO.class);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<KrWhfBlInfoVO> searchKrWhfCgoClass2( List<KrWhfBkgChkListCondVO> krwhfBkgChkListCondVOs) throws DAOException {
		DBRowSet dbRowset = null;
		List<KrWhfBlInfoVO> list = null;
		...
		try
		{
			if (krwhfBkgChkListCondVOs != null)
			{
				StringBuffer sbBlNo = new StringBuffer();
//				for(Iterator iterator = krwhfBkgChkListCondVOs.iterator();iterator.hasNext();){
				for(int i = 0; i < krwhfBkgChkListCondVOs.size(); i++){
					KrWhfBkgChkListCondVO krWhfBkgChkListCondVO = krwhfBkgChkListCondVOs.get(i);
					if (i > 0) {
						sbBlNo.append(",");
					}
					sbBlNo.append("'");
					sbBlNo.append(krWhfBkgChkListCondVO.getBlNo());
					sbBlNo.append("'");
					
				}
				if(krwhfBkgChkListCondVOs.size() > 0 ){
					Map<String, String> mapVO = krwhfBkgChkListCondVOs.get(0).getColumnValues();
					param.putAll(mapVO);
					velParam.putAll(mapVO);
					param.put("bl_nos", sbBlNo.toString());
					velParam.put("bl_nos", sbBlNo.toString());
				}
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new KrWharfageDecMgtDBDAOsearchKrWhfCgoClass2RSQL(), param, velParam);
				list = (List) RowSetUtil.rowSetToVOs(dbRowset, KrWhfBlInfoVO.class);
			}
		}
		catch (SQLException se)
...
//	 */
//	@SuppressWarnings("unchecked")
//	public List<KrWhfBlInfoVO> searchKrWhfCgoClass2( KrWhfBkgChkListCondVO[] krwhfBkgChkListCondVOs) throws DAOException {
//		DBRowSet dbRowset = null;
//		List<KrWhfBlInfoVO> list = null;
//		
//		Map<String, Object> param = new HashMap<String, Object>();
...
//					KrWhfBkgChkListCondVO krWhfBkgChkListCondVO = krwhfBkgChkListCondVOs[i];
//					if (i > 0) {
//						sbBlNo.append(",");
//					}
//					sbBlNo.append("'");
...
//					
//				}
//				Map<String, String> mapVO = krwhfBkgChkListCondVOs[0].getColumnValues();
//				param.putAll(mapVO);
//				velParam.putAll(mapVO);
//				param.put("bl_nos", sbBlNo.toString());
//				velParam.put("bl_nos", sbBlNo.toString());
...
//	}
	...
	/**
	 * 한국 WHF 신고 대상 BL별 Rate 삭제
	 * 
	 * @param  List<BkgKrWhfRtVO> bkgKrWhfRtVOs
	 * @throws DAOException
	 */
	public void removeBkgKrWhfRt ( List<BkgKrWhfRtVO> bkgKrWhfRtVOs ) throws DAOException {
		...
		try
		{
			...
			if (bkgKrWhfRtVOs.size() > 0)
			{
				updCnt = sqlExe.executeBatch((ISQLTemplate) new KrWharfageDecMgtDBDAOmodifyBkgKrWhfRtDSQL(),
						bkgKrWhfRtVOs, null);
				for (int i = 0; i < updCnt.length; i++)
				{
					if (updCnt[i] == Statement.EXECUTE_FAILED)
	 ...
	 */
	@SuppressWarnings("unchecked")
	public KrWhfPortRtVO searchKrWhfCntrPortRt( String sPortCd, String sWhfBndCd, String sWhfVolDcCD, String sVvd  ) throws DAOException {
		DBRowSet dbRowset = null;
		List<KrWhfPortRtVO> list = null;
		KrWhfPortRtVO krWhfPortRtVO = new KrWhfPortRtVO();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public KrWhfPortRtVO searchKrWhfBlkPortRt( String sPortCd, String sWhfBndCd, String sWhfVolDcCD, String sVvd ) throws DAOException {
		DBRowSet dbRowset = null;
		List<KrWhfPortRtVO> list = null;
		KrWhfPortRtVO krWhfPortRtVO = new KrWhfPortRtVO();
	...
	/**
	 * Wharfage 신고 인터페이스 History insert
	 * 
	 * @param KrWhfDecCondVO krWhfDecCondVO
	 ...
	 * @throws DAOException
	 */
	public String addBkgKrWhfDecHis(KrWhfDecCondVO krWhfDecCondVO, SignOnUserAccount account) throws DAOException {
		...
		try
		{
			...
			new SQLExecuter("").executeUpdate(
					(ISQLTemplate) new KrWharfageDecMgtDBDAOaddBkgkrWhfDecHisCSQL(), param, velParam);
		
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new KrWharfageDecMgtDBDAOsearchkrWhfDecHisRSQL(), param, velParam);
			if(dbRowset.next())
	...
	/**
	 * Wharfage 신고 인터페이스 History Update
	 * 
	 * @param KrWhfDecCondVO krWhfDecCondVO
	 ...
	 * @throws DAOException
	 */
	public void modifyWhfDecHis(KrWhfDecCondVO krWhfDecCondVO, String returnValues, String hisSeq, String whfDeclIfFlg) throws DAOException {
		...
		{
			Map<String, String> mapVO = krWhfDecCondVO.getColumnValues();
			mapVO.put("return_values", returnValues);
			mapVO.put("his_seq", hisSeq);
			mapVO.put("whf_decl_if_flg", whfDeclIfFlg);
			velParam.putAll(mapVO);
			param.putAll(mapVO);
			
			new SQLExecuter("").executeUpdate(
					(ISQLTemplate) new KrWharfageDecMgtDBDAOmodifyWhfDecHisUSQL(), param, velParam);
	 ...
	 * @throws DAOException
	 */
	public String searchKrWhfDecHisChk( KrWhfDecCondVO krWhfDecCondVO ) throws DAOException {
		...
		try
		{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate) new KrWharfageDecMgtDBDAOsearchKrWhfDecHisChkRSQL(), param, velParam);
			if(dbRowset.next())
