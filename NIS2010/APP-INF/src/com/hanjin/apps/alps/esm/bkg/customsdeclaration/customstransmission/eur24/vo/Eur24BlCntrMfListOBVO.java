...
*@FileName : Eur24BlCntrMfListOBVO.java
*@FileTitle : Eur24BlCntrMfListOBVO
*Open Issues :
*Change history :
...
public class Eur24BlCntrMfListOBVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eur24BlCntrMfListOBVO> models = new ArrayList<Eur24BlCntrMfListOBVO>();
...
/**
	 ...
	 * @param request
	 * @return Eur24BlCntrMfListOBVO[]
	 */
	public Eur24BlCntrMfListOBVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eur24BlCntrMfListOBVO[]
	 */
	public Eur24BlCntrMfListOBVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eur24BlCntrMfListOBVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Eur24BlCntrMfListOBVO();
				if (updDt[i] != null)
		...
		return getEur24BlCntrMfListOBVOs();
	}
	 ...
	 * @return Eur24BlCntrMfListOBVO[]
	 */
	public Eur24BlCntrMfListOBVO[] getEur24BlCntrMfListOBVOs(){
		Eur24BlCntrMfListOBVO[] vos = (Eur24BlCntrMfListOBVO[])models.toArray(new Eur24BlCntrMfListOBVO[models.size()]);
		return vos;
	}
