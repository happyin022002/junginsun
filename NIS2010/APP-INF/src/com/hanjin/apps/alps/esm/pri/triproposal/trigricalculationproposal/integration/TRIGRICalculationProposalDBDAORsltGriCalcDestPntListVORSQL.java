...
*@FileName : TRIGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAORsltGriCalcDestPntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_TRI_GRI_ROUT_PNT A" ).append("\n"); 
		...
		query.append("ORDER BY DECODE(ROUT_PNT_LOC_TP_CD, 'C', '1', 'L', '2'), ROUT_PNT_LOC_DEF_CD" ).append("\n"); 
