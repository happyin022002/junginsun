...
*@FileName : SpecialCargoReceiptDBDAOModifyPsaCntrTempUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOModifyPsaCntrTempUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOModifyPsaCntrTempUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOModifyPsaCntrTempUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET RC_TEMP = @[cdo_temp]," ).append("\n"); 
