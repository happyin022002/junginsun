...
public class SpeckalCargoReceiptDBDAOsearchChnProhibitRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND    SKD1.VPS_PORT_CD= DG.ATTR_CTNT3" ).append("\n"); 
		query.append("AND    SKD1.VPS_ETA_DT >= TO_DATE(DG.ATTR_CTNT4,'YYYY/MM/DD HH24:MI:SS')" ).append("\n"); 
		query.append("AND    SKD1.VPS_ETA_DT <=  TO_DATE(DG.ATTR_CTNT5,'YYYY/MM/DD HH24:MI:SS')" ).append("\n"); 
		query.append("AND    SUBSTR(@[imdg_clss_cd],1,1)  = ATTR_CTNT2" ).append("\n"); 
		query.append("AND    'DG_PRT'      = DG.HRD_CDG_ID " ).append("\n"); 
		query.append("AND    'PORT'              = DG.ATTR_CTNT1" ).append("\n"); 
		query.append("AND          'POD'        = DG.ATTR_CTNT7" ).append("\n"); 
		query.append("AND    'Y'           = DG.ATTR_CTNT10" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		...
		query.append("AND    'DG_PRT'      = DG.HRD_CDG_ID " ).append("\n"); 
		query.append("AND    'PORT'              = DG.ATTR_CTNT1" ).append("\n"); 
		query.append("AND          'POL'        = DG.ATTR_CTNT7 " ).append("\n"); 
		query.append("AND    'Y'           = DG.ATTR_CTNT10" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		...
		query.append("AND   B.HRD_CDG_ID = 'DG_MARMARA_SEA'" ).append("\n"); 
		query.append("--AND   A.POL_CD LIKE B.ATTR_CTNT1 || '%'" ).append("\n"); 
		query.append("AND   A.POD_CD = B.ATTR_CTNT2" ).append("\n"); 
