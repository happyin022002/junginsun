...
*@FileName : RFADurationProposalDBDAOPriRpDurVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFADurationProposalDBDAOPriRpDurVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFADurationProposalDBDAOPriRpDurVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFADurationProposalDBDAOPriRpDurVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[prop_no]          ," ).append("\n"); 
		query.append("@[amdt_seq]         ," ).append("\n"); 
		query.append("TO_DATE(@[ctrt_eff_dt],'YYYY-MM-DD')      ," ).append("\n"); 
		query.append("TO_DATE(@[ctrt_exp_dt],'YYYY-MM-DD')      ," ).append("\n"); 
		query.append("@[prc_prog_sts_cd]  ," ).append("\n"); 
		query.append("@[src_info_cd]      ," ).append("\n"); 
		query.append("@[acpt_usr_id]      ," ).append("\n"); 
		query.append("@[acpt_ofc_cd]      ," ).append("\n"); 
