...
*@FileName : Eur24ManifestDownloadDBDAOModifyBlCustOBCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOModifyBlCustOBCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOModifyBlCustOBCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOModifyBlCustOBCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("UPDATE BKG_CSTMS_EUR_IO_CUST" ).append("\n"); 
