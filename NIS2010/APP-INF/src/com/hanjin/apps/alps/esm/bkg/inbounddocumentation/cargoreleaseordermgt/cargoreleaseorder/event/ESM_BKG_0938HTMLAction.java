...
*@FileName       : ESM_BKG_0938HTMLAction.java
 ...
 * @author An Jin Eung
 * @see EsmBkg0938Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_0938HTMLAction extends HTMLActionSupport {
    ...
    /**
     * ESM_BKG_0938HTMLAction 객체를 생성
     */
    public ESM_BKG_0938HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0938Event로 파싱하여 request에 셋팅<br>
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0938Event event = new EsmBkg0938Event();

        log.debug("===================================");
        log.debug("    ESM_BKG_0938HTMLAction Start   ");
        log.debug("===================================");
...
//            event.setCrntCtnt(request.getParameter("blIss_obl_rdem_flg")); //Original B/L회수여부
            ...
            /* 
            String oblRdemKnt = request.getParameter("blIss_obl_rdem_knt");
            String blOtrDocRcvCd = request.getParameter("blIss_bl_otr_doc_rcv_cd");
            String otrDocCgorFlg = request.getParameter("blIss_otr_doc_cgor_flg");
            String doHldFlg = request.getParameter("refInfo_do_hld_flg");
           */
          ...
          /* 필요 없음 ( 삭제 대상)   
            euDoRlse.setOblRdemKnt(oblRdemKnt);
            euDoRlse.setBlOtrDocRcvCd(blOtrDocRcvCd);
            euDoRlse.setOtrDocCgorFlg(otrDocCgorFlg);
            euDoRlse.setDoHldFlg(doHldFlg);
          */  
