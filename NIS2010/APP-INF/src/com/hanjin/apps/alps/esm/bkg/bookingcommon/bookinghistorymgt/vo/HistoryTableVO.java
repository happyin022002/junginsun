...
public class HistoryTableVO {
	...
	private List<BkgCntrMfDescDtlVO>  bkgCntrMfDescDtlVOs  = new ArrayList<BkgCntrMfDescDtlVO>();
	...
	private List<BkgTroVO>            oldBkgTroVOs            = new ArrayList<BkgTroVO>();
	private List<BkgTroDtlVO>         oldBkgTroDtlVOs         = new ArrayList<BkgTroDtlVO>();
	private List<BkgTroSpclCgoSeqVO>  oldBkgTroSpclCgoSeqVOs  = new ArrayList<BkgTroSpclCgoSeqVO>();
	...
	private List<BkgEtcHisVO>		  BkgEtcHisVOs		   = new ArrayList<BkgEtcHisVO>();	
	private List<BkgInetBlPrnAuthVO>  bkgInetBlPrnAuthVO   = new ArrayList<BkgInetBlPrnAuthVO>();	
	...
	private BkgCntrMfDescDtlVO  bkgCntrMfDescDtlVO  = null;
	...
	private BkgTroVO            oldBkgTroVO            = null;
	private BkgTroDtlVO         oldBkgTroDtlVO         = null;
	private BkgTroSpclCgoSeqVO  oldBkgTroSpclCgoSeqVO  = null;
...
//	private BkgCntrMfDescDtlVO[]  arrBkgCntrMfDescDtlVO  = null;
...
//	private BkgDocIssRdemVO[]     arrBkgDocIssRdemVO     = null;
	...
	/**
	 * @return the bkgCntrMfDescDtlVOs
	 */
	public List<BkgCntrMfDescDtlVO> getBkgCntrMfDescDtlVOs() {
		return bkgCntrMfDescDtlVOs;
	}
	/**
	 * @param bkgCntrMfDescDtlVOs the bkgCntrMfDescDtlVOs to set
	 */
	public void setBkgCntrMfDescDtlVOs(List<BkgCntrMfDescDtlVO> bkgCntrMfDescDtlVOs) {
		this.bkgCntrMfDescDtlVOs = bkgCntrMfDescDtlVOs;
	}
	/**
	...
	/**
	 * @return the bkgCntrMfDescDtlVO
	 */
	public BkgCntrMfDescDtlVO getBkgCntrMfDescDtlVO() {
		return bkgCntrMfDescDtlVO;
	}
	/**
	 * @param bkgCntrMfDescDtlVO the bkgCntrMfDescDtlVO to set
	 */
	public void setBkgCntrMfDescDtlVO(BkgCntrMfDescDtlVO bkgCntrMfDescDtlVO) {
		this.bkgCntrMfDescDtlVO = bkgCntrMfDescDtlVO;
	}
	/**
...
//	}
//	/**
//	 * @return the arrBkgCntrMfDescDtlVO
//	 */
//	public BkgCntrMfDescDtlVO[] getArrBkgCntrMfDescDtlVO() {
//		return arrBkgCntrMfDescDtlVO;
//	}
//	/**
//	 * @param arrBkgCntrMfDescDtlVO the arrBkgCntrMfDescDtlVO to set
//	 */
//	public void setArrBkgCntrMfDescDtlVO(BkgCntrMfDescDtlVO[] arrBkgCntrMfDescDtlVO) {
//		this.arrBkgCntrMfDescDtlVO = arrBkgCntrMfDescDtlVO;
//	}
//	/**
...
//	}
	 ...
	 * @return BkgEtcHisVOs
	 */
	public List<BkgEtcHisVO> getBkgEtcHisVOs() {
		return BkgEtcHisVOs;
	}
	/**
	 * @param bkgEtcHisVOs
	 */
	public void setBkgEtcHisVOs(List<BkgEtcHisVO> bkgEtcHisVOs) {
		this.BkgEtcHisVOs = bkgEtcHisVOs;
	}
	public List<BkgTroVO> getOldBkgTroVOs() {
		return oldBkgTroVOs;
	}
	public void setOldBkgTroVOs(List<BkgTroVO> oldBkgTroVOs) {
		this.oldBkgTroVOs = oldBkgTroVOs;
	}
	public List<BkgTroDtlVO> getOldBkgTroDtlVOs() {
		return oldBkgTroDtlVOs;
	}
	public void setOldBkgTroDtlVOs(List<BkgTroDtlVO> oldBkgTroDtlVOs) {
		this.oldBkgTroDtlVOs = oldBkgTroDtlVOs;
	}
	public List<BkgTroSpclCgoSeqVO> getOldBkgTroSpclCgoSeqVOs() {
		return oldBkgTroSpclCgoSeqVOs;
	}
	public void setOldBkgTroSpclCgoSeqVOs(
			List<BkgTroSpclCgoSeqVO> oldBkgTroSpclCgoSeqVOs) {
		this.oldBkgTroSpclCgoSeqVOs = oldBkgTroSpclCgoSeqVOs;
	}
	public BkgTroVO getOldBkgTroVO() {
		return oldBkgTroVO;
	}
	public void setOldBkgTroVO(BkgTroVO oldBkgTroVO) {
		this.oldBkgTroVO = oldBkgTroVO;
	}
	public BkgTroDtlVO getOldBkgTroDtlVO() {
		return oldBkgTroDtlVO;
	}
	public void setOldBkgTroDtlVO(BkgTroDtlVO oldBkgTroDtlVO) {
		this.oldBkgTroDtlVO = oldBkgTroDtlVO;
	}
	public BkgTroSpclCgoSeqVO getOldBkgTroSpclCgoSeqVO() {
		return oldBkgTroSpclCgoSeqVO;
	}
	public void setOldBkgTroSpclCgoSeqVO(BkgTroSpclCgoSeqVO oldBkgTroSpclCgoSeqVO) {
		this.oldBkgTroSpclCgoSeqVO = oldBkgTroSpclCgoSeqVO;
	}
	public List<BkgInetBlPrnAuthVO> getBkgInetBlPrnAuthVO() {
		return bkgInetBlPrnAuthVO;
	}
	public void setBkgInetBlPrnAuthVO(List<BkgInetBlPrnAuthVO> bkgInetBlPrnAuthVO) {
		this.bkgInetBlPrnAuthVO = bkgInetBlPrnAuthVO;
	}
}
