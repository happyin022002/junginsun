...
*@FileName : TRIGRICalculationProposalDBDAOPriTriGriRtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIGRICalculationProposalDBDAOPriTriGriRtVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriTriGriRtVO Insert
	  * </pre>
	  */
	public TRIGRICalculationProposalDBDAOPriTriGriRtVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIGRICalculationProposalDBDAOPriTriGriRtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRI_GRI_RT (" ).append("\n"); 
