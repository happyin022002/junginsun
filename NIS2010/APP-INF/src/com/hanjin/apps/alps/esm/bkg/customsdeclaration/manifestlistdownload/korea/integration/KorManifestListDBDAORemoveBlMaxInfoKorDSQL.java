...
*@FileName : KorManifestListDBDAORemoveBlMaxInfoKorDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAORemoveBlMaxInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchMaxTransSeqKor에서 구한 seq보다 큰 BL 데이터를 삭제한다. (Delete된 Count정보를 갖고있는다)
	  * </pre>
	  */
	public KorManifestListDBDAORemoveBlMaxInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAORemoveBlMaxInfoKorDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
