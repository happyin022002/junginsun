...
*@FileName : SCRateQuotationDBDAOPriSqRtScgRoutAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtScgRoutAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtScgRoutAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtScgRoutAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
