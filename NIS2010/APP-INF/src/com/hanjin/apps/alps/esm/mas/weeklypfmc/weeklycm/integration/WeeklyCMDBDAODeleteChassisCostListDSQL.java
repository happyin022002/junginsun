...
*@FileName : WeeklyCMDBDAODeleteChassisCostListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAODeleteChassisCostListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAODeleteChassisCostListDSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAODeleteChassisCostListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MAS_CHSS_COST_UPLD" ).append("\n"); 
