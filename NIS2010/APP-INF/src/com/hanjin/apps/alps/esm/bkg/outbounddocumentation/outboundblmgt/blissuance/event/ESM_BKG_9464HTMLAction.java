...
*@FileName : ESM_BKG_9464HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_9464HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9464HTMLAction 객체를 생성
	 */
	public ESM_BKG_9464HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9464Event event = new EsmBkg9464Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBlCertiRqstVO((BlCertiRqstVO)getVO(request, BlCertiRqstVO.class));
		}
