...
*@FileName : KoreaCustomsReportDBDAOsearchDGClassRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchDGClassRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DG Application 의 위험물 Class No 추출
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchDGClassRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchDGClassRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
