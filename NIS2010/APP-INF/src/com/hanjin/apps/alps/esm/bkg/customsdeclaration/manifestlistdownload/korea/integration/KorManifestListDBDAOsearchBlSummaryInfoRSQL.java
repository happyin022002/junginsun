...
*@FileName : KorManifestListDBDAOsearchBlSummaryInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchBlSummaryInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchBlSummaryInfoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchBlSummaryInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , MIN(DECODE(LENGTH(BD_AREA_CD),10,'Y','N')) BD_AREA_CHK" ).append("\n"); 
		query.append("	 , MIN(DECODE(LENGTH(CSTMS_CRR_IN_LOC_WH_CD),8,'Y','N')) CRR_IN_CY_CHK" ).append("\n"); 
