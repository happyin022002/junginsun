...
*@FileName : ESM_MAS_0015HTMLAction.java
...
public class ESM_MAS_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0015HTMLAction 객체를 생성
	 */
	public ESM_MAS_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0015Event event = new EsmMas0015Event();
