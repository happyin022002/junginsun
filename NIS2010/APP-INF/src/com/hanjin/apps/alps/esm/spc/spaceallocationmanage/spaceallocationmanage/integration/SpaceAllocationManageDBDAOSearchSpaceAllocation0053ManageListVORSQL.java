...
public class SpaceAllocationManageDBDAOSearchSpaceAllocation0053ManageListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2014.07.16 차상영 [CHM-201431081] SPC Allocation Control Option 추가 보완
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("           CO.CTRL_D2_FLG," ).append("\n"); 
		query.append("           CO.CTRL_D4_FLG," ).append("\n"); 
		...
		query.append("           CO.CTRL_RD_FLG     ," ).append("\n"); 
		query.append("           CO.CTRL_ECC_FLG     ," ).append("\n"); 
		query.append("           CO.CTRL_LOC_FLG     ," ).append("\n"); 
		query.append("           CO.CTRL_USA_SVC_MOD_FLG ," ).append("\n"); 
		query.append("           CO.CTRL_ACCT_FLG     ," ).append("\n"); 
		query.append("		   CO.CTRL_DEST_LVL_CD	," ).append("\n"); 
		query.append("           DECODE(CO.CTRL_LVL_CD, 'D', 'POD', 'L', 'POL', 'O', 'OFC', 'T','Dest', 'OFC*') AS CTRL_PORT_FLG," ).append("\n"); 
		query.append("           CO.CTRL_WGT_FLG," ).append("\n"); 
		query.append("           CO.ACCT_GRP_CTRL_FLG," ).append("\n"); 
		query.append("           CA.VVD         ," ).append("\n"); 
		query.append("           CA.WEEK       " ).append("\n"); 
		query.append("      FROM (" ).append("\n"); 
		query.append("              SELECT SPC_GET_REP_TRD_FNC(C.RLANE_CD)    AS REP_TRD_CD    ," ).append("\n"); 
		query.append("                     SPC_GET_REP_SUB_TRD_FNC(C.RLANE_CD)AS REP_SUB_TRD_CD," ).append("\n"); 
		...
		query.append("                 AND SPC_GET_REP_TRD_FNC(C.RLANE_CD) = @[trade]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${subtrade} != '')" ).append("\n"); 
		query.append("                 AND SPC_GET_REP_SUB_TRD_FNC(C.RLANE_CD) = @[subtrade]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                 AND C.TRD_CD     = SPC_GET_REP_TRD_FNC(C.RLANE_CD)" ).append("\n"); 
		query.append("                 AND C.SUB_TRD_CD = SPC_GET_REP_SUB_TRD_FNC(C.RLANE_CD)" ).append("\n"); 
		...
		query.append("         M.CTRL_D2_FLG     ," ).append("\n"); 
		query.append("         M.CTRL_D4_FLG     ," ).append("\n"); 
		...
		query.append("         M.CTRL_RD_FLG     ,         " ).append("\n"); 
		query.append("         M.CTRL_PORT_FLG   ," ).append("\n"); 
		query.append("         M.CTRL_WGT_FLG    ," ).append("\n"); 
		query.append("         M.CTRL_ECC_FLG     ," ).append("\n"); 
		query.append("         M.CTRL_LOC_FLG     ," ).append("\n"); 
		query.append("         M.CTRL_USA_SVC_MOD_FLG ," ).append("\n"); 
		query.append("         M.CTRL_ACCT_FLG    ," ).append("\n"); 
		query.append("		 M.CTRL_DEST_LVL_CD	," ).append("\n"); 
		query.append("         M.ACCT_GRP_CTRL_FLG," ).append("\n"); 
		query.append("         FC.FOR_VOLUM      ," ).append("\n"); 
		query.append("         FC.FOR_D2         ," ).append("\n"); 
		query.append("         FC.FOR_D4         ," ).append("\n"); 
		...
		query.append("                   ROUND(SUM(Z.FOR_D2))     AS FOR_D2    ," ).append("\n"); 
		query.append("                   ROUND(SUM(Z.FOR_D4))     AS FOR_D4    ," ).append("\n"); 
		...
		query.append("                   ROUND(SUM(Z.FOR_RD))     AS FOR_RD    ," ).append("\n"); 
		...
		query.append("                             SF.CFM_20FT_DRY_QTY AS FOR_D2," ).append("\n"); 
		query.append("                             SF.CFM_40FT_DRY_QTY AS FOR_D4," ).append("\n"); 
		...
		query.append("                             SF.CFM_RD_QTY       AS FOR_RD," ).append("\n"); 
