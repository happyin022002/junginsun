...
*@FileName : SurchargeAutoRatingDBDAOAddObsChgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeAutoRatingDBDAOAddObsChgCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2107.07.31 iylee 한국의 경우는 C/A 끊는 주체가 서울(SELSC)이고 PPD 는 부산(PUSSO)이므로 3rd party를 설정하지 않도록 한다
	  * </pre>
	  */
	public SurchargeAutoRatingDBDAOAddObsChgCSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeAutoRatingDBDAOAddObsChgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , @[chg_cd] -- OBS" ).append("\n"); 
		query.append("    , @[curr_cd]" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("    , ( SELECT A.DP_SEQ FROM MDM_CHARGE A WHERE A.CHG_CD='OBS' AND DELT_FLG='N' )" ).append("\n"); 
