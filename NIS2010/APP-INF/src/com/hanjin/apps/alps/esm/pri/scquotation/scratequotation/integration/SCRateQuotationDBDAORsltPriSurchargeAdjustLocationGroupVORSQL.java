...
*@FileName : SCRateQuotationDBDAORsltPriSurchargeAdjustLocationGroupVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriSurchargeAdjustLocationGroupVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriSurchargeAdjustLocationGroupVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriSurchargeAdjustLocationGroupVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_sq_rt_rout_pnt rout_pnt" ).append("\n"); 
		...
		query.append("FROM pri_sq_rt_rout_via rout_via" ).append("\n"); 
		...
		query.append(", pri_sq_grp_loc grp_loc" ).append("\n"); 
