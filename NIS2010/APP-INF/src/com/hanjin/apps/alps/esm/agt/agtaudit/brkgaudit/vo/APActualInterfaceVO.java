...
public class APActualInterfaceVO extends AbstractValueObject {
	...
	public APActualInterfaceVO(String ibflag, String pagerows, String payDt, String totAmt, String ifDate, String searchDtTo, String blNo, String vndr, String fwdrName, String blNos, String payAmt, String ftuUseCtnt1, String searchDtFr, String csrNo, String apOfcCd, String totCnt, String ifFlg, String fwdr, String rcvFlg, String ifRsn, String bkgNo, String rcvRsn, String payMzdLuCd, String ifOption, String vndrSeq, String ffCntCd, String vat, String netAmt) {
		this.payDt = payDt;
		this.totAmt = totAmt;
		this.ifDate = ifDate;
		this.vat = vat;
