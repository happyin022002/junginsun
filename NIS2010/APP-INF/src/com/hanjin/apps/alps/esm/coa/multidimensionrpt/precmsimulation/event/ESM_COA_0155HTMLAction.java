...
*@FileName : ESM_COA_0155HTMLAction.java
*@FileTitle : RMK PopUp
*Open Issues :
*Change history :
...
public class ESM_COA_0155HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0155HTMLAction 객체를 생성
	 */
	public ESM_COA_0155HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0155Event event = new EsmCoa0155Event();
