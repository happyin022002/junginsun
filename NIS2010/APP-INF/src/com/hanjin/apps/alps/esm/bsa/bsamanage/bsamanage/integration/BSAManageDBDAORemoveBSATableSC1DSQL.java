...
*@FileName : BSAManageDBDAORemoveBSATableSC1DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveBSATableSC1DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveBSATableSC1DSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveBSATableSC1DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   BSA_OP_CD = 'S'" ).append("\n"); 
