...
=========================================================*/
package com.hanjin.apps.alps.esm.mas.lanesimulation;
...
import com.hanjin.apps.alps.esm.mas.lanesimulation.basic.LaneSimulationBC;
import com.hanjin.apps.alps.esm.mas.lanesimulation.basic.LaneSimulationBCImpl;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0051Event;
...
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0054Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0150Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0151Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0164Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0165Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0166Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0167Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0168Event;
import com.hanjin.apps.alps.esm.mas.lanesimulation.event.EsmMas0169Event;
...
import com.hanjin.apps.alps.esm.mas.lanesimulation.vo.SearchSimCalcVO;
...
/**
 * 1. 기능 : ALPS-MAS Business Logic ServiceCommand<br> 
 * 2. 처리 개요 :<p>
...
public class LaneSimulationSC extends ServiceCommandSupport {
    ...
    public EventResponse perform(Event e) throws EventException {
        ...
        if (e.getEventName().equalsIgnoreCase("EsmMas0051Event")) {
        ...
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0052Event")){
        ...
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0053Event")){
        ...
        } else if(e.getEventName().equalsIgnoreCase("EsmMas0054Event")){
        ...
        } else if(e.getEventName().equalsIgnoreCase("EsmMas0150Event")){ //Create Continent Pair Table
        ...
        } else if(e.getEventName().equalsIgnoreCase("EsmMas0151Event")){ //Create Consumption Matrix by Class
        ...
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0164Event")){ //IAS T/S Volume                         
        	if(e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)){                                                                 
        		eventResponse = searchNonOpExpnList(e);                                                                                    
        	}else if(e.getFormCommand().isCommand(FormCommand.MULTI01)){                                                                
        		eventResponse = multiNonOpExpn(e);                                                                                         
        	}                                                                                                                           
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0165Event")){ //File Mgmt
        	if(e.getFormCommand().isCommand(FormCommand.SEARCH)){
        ...
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0166Event")){ //BSA by VVD
        	if(e.getFormCommand().isCommand(FormCommand.SEARCH)){
        		eventResponse = searchBSAbyVVDList(e);
        	}else{
        		eventResponse = searchComBoCdList0166(e);
        	}            	
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0167Event")){
        ...
        } else if(e.getEventName().equalsIgnoreCase("EsmMas0168Event")){//Creation (Variant Change)
        ...
        }else if(e.getEventName().equalsIgnoreCase("EsmMas0169Event")){ //IAS T/S Volume                         
        	if(e.getFormCommand().isCommand(FormCommand.SEARCHLIST01)){                                                                 
    ...
    private EventResponse searchLaneInfoList(Event e) throws EventException {
		...
		EsmMas0051Event event = (EsmMas0051Event)e;
	...
	/**
	 * 1. 기능 : master sheet row delet 이벤트 처리(ESM_MAS_051)
   	 * <p>
   	 * 2. 처리개요 :  <p>
   	 *    - LaneSimulation대한 Sheet1 리스트 조회 이벤트 처리<p>
   	 * 3. 주의사항 : <p>
	...
	/**
	 * 1. 기능 : master sheet multi 이벤트 처리(ESM_MAS_051)
   	 * <p>
   	 * 2. 처리개요 :  <p>
   	 *    - LaneSimulation대한 Sheet1 리스트 조회 이벤트 처리<p>
   	 * 3. 주의사항 : <p>
    ...
    /**
     * 1. 기능 : detail sheet 조회 이벤트 처리(ESM_MAS_051)<p>
     * 2. 처리개요 :  <p>
	...
	/**
	 * 1. 기능 : detail sheet multi 이벤트 처리(ESM_MAS_051)
   	 * <p>
   	 * 2. 처리개요 :  <p>
	...
	/**
	 * ESM_MAS_0169 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
    ...
    private EventResponse searchTSVolumeList(Event e) throws EventException {                                                         
    	// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체                                                                   
    	GeneralEventResponse eventResponse = new GeneralEventResponse();                                                                                             
    	EsmMas0169Event event = (EsmMas0169Event)e;
    	try {                                                                                                                           
    		LaneSimulationBC command = new LaneSimulationBCImpl();                             
    ...
    private EventResponse searchFileMgmtList(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0165Event event = (EsmMas0165Event)e;
		LaneSimulationBC command = new LaneSimulationBCImpl();
		try {
	...
	/**
	 * ESM_MAS_0166 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	...
	private EventResponse searchBSAbyVVDList(Event e) throws EventException {
    	// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0166Event event = (EsmMas0166Event)e;
    	try {
    		LaneSimulationBC command = new LaneSimulationBCImpl();    		
...
//    		eventResponse.setRsVoList(list);
    ...
    private EventResponse searchSimYardList(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0052Event event = (EsmMas0052Event)e;
    	try {
    		LaneSimulationBC command = new LaneSimulationBCImpl();    		
...
//		try {
//			System.out.println("aaaaaaaaaaaaaa=="+event.getMasSimTmlInfoVOS().length);
//			
//			//vo = command.multiSimPortInfo(event.getMasSimTmlInfoVOS());
...
////		MasSimTmlInfoVO masSimTmlInfoVO = masSimTmlInfoVOs.get(0);
////		masSimTmlInfoVOs.set(0, masSimTmlInfoVO);
////		grpVO.setMasSimTmlInfoVOs(event.getMasSimTmlInfoVOs);
//		
//		GeneralEventResponse eventResponse = new GeneralEventResponse();
//		LaneSimulationBC command = new LaneSimulationBCImpl();
//		try {
//			SearchSimCalcVO rtnVo = command.multiSimPortCalc(grpVO);
//			//MasSimTmlInfoVO masterVO = rtnVo.getMasSimTmlInfoVO();
...
//###########################################################################################################	
   ...
   * 
    ...
    private EventResponse searchSimCgoCostList(Event e) throws EventException {
    	EsmMas0053Event event = (EsmMas0053Event)e;
    	GeneralEventResponse eventResponse = new GeneralEventResponse();
    	try {
    		LaneSimulationBC command = new LaneSimulationBCImpl();
    		SearchSimConditionVO vo = event.getSearchSimConditionVO();
	...
	public EventResponse modifySimCMCost(Event e) throws EventException {
		...
		try {
            ...
            SearchSimConditionVO vo = event.getSearchSimConditionVO();
	    	vo.setFSimDt(vo.getFSimDt().replace("-",""));
	    	MasSimCtrbMgnCostVO[] vos = event.getSimCtrbMgnCostVOS();
	    	for(int i=0;i<vos.length;i++) {
	    		vos[i].setSimDt(vos[i].getSimDt().replace("-",""));
	    	}	    	
	...
	public EventResponse multiSimPortCharge(Event e) throws EventException {
		...
		try {
	    	...
	    	SearchSimConditionVO vo = event.getSearchSimConditionVO();
	    	vo.setFSimDt(vo.getFSimDt().replace("-",""));
	    	MasSimPortChgVO[] vos = event.getSimPortChgVOS();
	    	for(int i=0;i<vos.length;i++) {
	    		vos[i].setSimDt(vos[i].getSimDt().replace("-",""));
	    	}
    ...
    private EventResponse createSimBunkerList(Event e) throws EventException {
		...
		try {
			...
			SearchSimConditionVO vo = event.getSearchSimConditionVO();
	    	vo.setFSimDt(vo.getFSimDt().replace("-",""));
	    	MasSimBnkCostVO[] vos = event.getSimBnkCostVOS();
	    	for(int i=0;i<vos.length;i++) {
	    		vos[i].setSimDt(vos[i].getSimDt().replace("-",""));
	    	}
	...
	public EventResponse searchSimDailyHireList(Event e) throws EventException {
		...
		try {
			LaneSimulationBC command = new LaneSimulationBCImpl();
			MasSimCtrbMgnCostVO convo = event.getMasSimCtrbMgnCostVO();
	    	convo.setSimDt(convo.getSimDt().replace("-",""));			
			SearchSimDailyHireInfoVO vo = command.searchSimDailyHireList(event.getMasSimCtrbMgnCostVO());
	...
	public EventResponse multiSimDailyHire(Event e) throws EventException {
		...
		try {
			...
			CreateSimDailyHireVO vo = event.getCreateSimDailyHireVO();
	    	vo.setFSimDt(vo.getFSimDt().replace("-",""));
	    	MasSimDlyHirVO[] vos = event.getSimDlyHirVOS();
	    	for(int i=0;i<vos.length;i++) {
	    		vos[i].setSimDt(vos[i].getSimDt().replace("-",""));
	    	}
	...
	public EventResponse createSimNWCost(Event e) throws EventException {
		...
		try {
			LaneSimulationBC command = new LaneSimulationBCImpl();
			begin();
			MasSimCtrbMgnCostVO vo = event.getMasSimCtrbMgnCostVO();
	    	vo.setSimDt(vo.getSimDt().replace("-",""));
			int rtnVal = command.createSimNWCost(event.getMasSimCtrbMgnCostVO(),account);
			if(rtnVal > 0) {
				eventResponse.setETCData("result", "OK");
			}
			commit();
    ...
    private EventResponse searchSimNWCostList(Event e) throws EventException {
		...
		try {
			...
			MasSimCtrbMgnCostVO convo = event.getMasSimCtrbMgnCostVO();
	    	convo.setSimDt(convo.getSimDt().replace("-",""));
			SearchSimDailyHireInfoVO vo = command.searchSimNWCostList(event.getMasSimCtrbMgnCostVO());
			eventResponse.setRs(vo.getDbRowset());
		} catch (EventException de) {
			log.error("err " + de.toString(), de);
			throw new EventException(de.getMessage());
    ...
    private EventResponse searchSimAfterOcenaTSList(Event e) throws EventException {
		...
		try {
			...
			MasSimCtrbMgnCostVO convo = event.getMasSimCtrbMgnCostVO();
	    	convo.setSimDt(convo.getSimDt().replace("-",""));
			SearchSimDailyHireInfoVO vo = command.searchSimAfterOcenaTSList(event.getMasSimCtrbMgnCostVO());
			eventResponse.setRs(vo.getDbRowset());
		} catch (EventException de) {
			log.error("err " + de.toString(), de);
			throw new EventException(de.getMessage());
	...
	public EventResponse multiTOCHire(Event e) throws EventException {
    	EsmMas0167Event event = (EsmMas0167Event)e;
        GeneralEventResponse eventResponse = new GeneralEventResponse();
		try {
			begin();
			LaneSimulationBC command = new LaneSimulationBCImpl();
	...
	/**
	 * ESM_MAS_0150 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
    ...
    private EventResponse searchSimContiPairList(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0150Event event = (EsmMas0150Event)e;
		LaneSimulationBC command = new LaneSimulationBCImpl();
		try {
    ...
    private EventResponse searchSimConsumList(Event e) throws EventException {
    	// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EsmMas0151Event event = (EsmMas0151Event)e;
		LaneSimulationBC command = new LaneSimulationBCImpl();
    	try {
    		List<MasBnkCsmVO> list = command.searchSimConsumList(event.getMasBnkCsmVO());
    		eventResponse.setRsVoList(list);
		} catch(EventException ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler(ex).getMessage());
    ...
    private EventResponse multiSimConsum(Event e) throws EventException {
    	...
    	try {
    		begin();
    		command.multiSimConsum(event.getMasBnkCsmVOS(), account);
    		commit();
    	} catch(EventException ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler(ex).getMessage());
...
/*====================================================================================================================================*/	
    ...
    private EventResponse searchSimReportNoList(Event e) throws EventException {
        // 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
    	GeneralEventResponse eventResponse = new GeneralEventResponse();
    	EsmMas0054Event event = (EsmMas0054Event)e;
    	LaneSimulationBC command = new LaneSimulationBCImpl();
   ...
   /**
    ...
    private EventResponse searchSimReportMasterCount(Event e) throws EventException{
        // 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체
    	GeneralEventResponse eventResponse = new GeneralEventResponse();
    	EsmMas0168Event event = (EsmMas0168Event)e;
    	LaneSimulationBC command = new LaneSimulationBCImpl();
    	int cnt = 0;
        try {        	
        	SearchSimLaneListConditionVO convo = event.getSearchSimLaneListConditionVO();
   ...
   /**
    ...
    private EventResponse searchNonOpExpnList(Event e) throws EventException {                                                         
    	// 사용자 요청의 결과(DB Result Set, 객체, 값 등)을 담은 객체                                                                   
    	GeneralEventResponse eventResponse = new GeneralEventResponse();                                                                                             
    	EsmMas0164Event event = (EsmMas0164Event)e;
    	try {                                                                                                                           
    		LaneSimulationBC command = new LaneSimulationBCImpl();     
    		SearchConditionVO vo = event.getSearchConditionVO();
    		vo.setFSimDt(vo.getFSimDt().replace("-",""));
    		List<MasSimNonOpExpnVO> list = command.searchNonOpExpnList(event.getSearchConditionVO());
    		eventResponse.setRsVoList(list);                                                                                
    	} catch (EventException de) {                                                                                                   
    		log.error("err " + de.toString(), de);                                                                                        
    		throw new EventException(de.getMessage());                                                                                    
    ...
    private EventResponse multiNonOpExpn(Event e) throws EventException {                                                              
    	...
    	try {                                                                                                                           
    		begin();                                                                                                                      
    		LaneSimulationBC command = new LaneSimulationBCImpl();
    		command.multiNonOpExpn(event.getMasSimNonOpExpnVOS(),account);  
    		commit();                                                                                                                     
    	} catch (EventException de) {                                                                                                   
    		rollback();                                                                                                                   
    		log.error("err " + de.toString(), de);                                                                                        
    ...
    /**
	 * ESM_MAS_0051 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
    ...
    /**
	 * ESM_MAS_0053 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
    ...
    /**
	 * ESM_MAS_0054 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	...
	/**
	 * ESM_MAS_0151 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
	...
	/**
	 * ESM_MAS_0165 : 공통코드 조회 이벤트 처리<br>
	 * 
	 * @param e Event
	 * @return response EventResponse
	 * @exception EventException
