...
*@FileName : CMSummaryDBDAORsltPriMdmSlsRepRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMSummaryDBDAORsltPriMdmSlsRepRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMSummaryDBDAORsltPriMdmSlsRepRSQL(){
		setQuery();
		...
		query.append("FileName : CMSummaryDBDAORsltPriMdmSlsRepRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
