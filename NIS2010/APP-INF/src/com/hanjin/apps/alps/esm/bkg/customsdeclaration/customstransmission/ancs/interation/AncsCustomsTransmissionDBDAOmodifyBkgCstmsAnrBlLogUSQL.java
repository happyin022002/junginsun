...
*@FileName : AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrBlLogUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrBlLogUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrBlLogUSQL(){
		setQuery();
		...
		query.append("FileName : AncsCustomsTransmissionDBDAOmodifyBkgCstmsAnrBlLogUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_ANR_BL_LOG" ).append("\n"); 
