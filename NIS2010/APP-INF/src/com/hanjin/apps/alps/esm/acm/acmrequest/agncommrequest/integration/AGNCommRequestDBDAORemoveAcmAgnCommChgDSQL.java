...
*@FileName : AGNCommRequestDBDAORemoveAcmAgnCommChgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAORemoveAcmAgnCommChgDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommRequestDBDAORemoveAcmAgnCommChgDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAORemoveAcmAgnCommChgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_AGN_COMM_CHG" ).append("\n"); 
