...
*@FileName : MyanmarManifestListCondVO.java
*@FileTitle : MyanmarManifestListCondVO
*Open Issues :
*Change history :
...
public class MyanmarManifestListCondVO extends ManifestListCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<MyanmarManifestListCondVO> models = new ArrayList<MyanmarManifestListCondVO>();
	...
	public MyanmarManifestListCondVO() {}

	public MyanmarManifestListCondVO(String ibflag, String pagerows, String polGubun, String vslNm, String vslCallsign, String eta, String etd, String frmPortCd, String tsTpCd, String sMode, String sVvd, String sPolCd, String sPodCd, String sTrunkPorCd, String sTrunkPolCd, String sTrunkPodCd, String sTrunkDelCd, String sStatus) {
		this.sMode = sMode;
		this.sPodCd = sPodCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public MyanmarManifestListCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MyanmarManifestListCondVO[]
	 */
	public MyanmarManifestListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MyanmarManifestListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MyanmarManifestListCondVO();
				if (sMode[i] != null)
		...
		return getMyanmarManifestListCondVOs();
	}
	...
	public MyanmarManifestListCondVO[] getMyanmarManifestListCondVOs(){
		MyanmarManifestListCondVO[] vos = (MyanmarManifestListCondVO[])models.toArray(new MyanmarManifestListCondVO[models.size()]);
		return vos;
	}
