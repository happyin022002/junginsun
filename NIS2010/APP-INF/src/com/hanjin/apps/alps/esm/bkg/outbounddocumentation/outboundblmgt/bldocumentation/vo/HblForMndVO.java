...
*@FileName : HblForMndVO.java
*@FileTitle : HblForMndVO
*Open Issues :
*Change history :
...
public class HblForMndVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<HblForMndVO> models = new ArrayList<HblForMndVO>();
	...
	public HblForMndVO(String ibflag, String pagerows, String bkgNo, String hblSeq, String blMkDesc, String blGdsDesc, String cntrMfGdsDesc, String creUsrId, String updUsrId) {
	 ...
	 * @return HblForMndVO[]
	 */
	public HblForMndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return HblForMndVO[]
	 */
	public HblForMndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HblForMndVO model = null;
	 ...
	 * @return HblForMndVO[]
	 */
	public HblForMndVO[] getHblForMndVOs(){
		HblForMndVO[] vos = (HblForMndVO[])models.toArray(new HblForMndVO[models.size()]);
		return vos;
	}
