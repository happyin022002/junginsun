...
*@FileName : CndExpManifestListDownloadDBDAOsearchBkgCntrMfDescRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchBkgCntrMfDescRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchBkgCntrMfDescRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchBkgCntrMfDescRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,NVL(M.HAMO_TRF_CD, M.CMDT_HS_CD)			AS HAMO_CMDT_CD" ).append("\n"); 
