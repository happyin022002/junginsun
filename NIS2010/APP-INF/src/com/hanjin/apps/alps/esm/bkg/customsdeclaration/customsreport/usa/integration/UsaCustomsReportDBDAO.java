...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.LocCdVO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.RailHistoryListCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.RcvHistListCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.RcvHistListDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.ReceivedFileCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.ReceivedFileDetailVO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaAmsReportBaplieListVO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaMiTransmitHistoryDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaScacReportDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaTransmitHistFileCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaTransmitHistFileDetailVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaTransmitHistListCondVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customsreport.usa.vo.UsaTransmitHistListDetailVO;
...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.usa.integration.UsaCustomsTransmissionDBDAOsearchMinClptSeqRSQL;
...
//				int endNo = pageNo * pageRows;
	...
	public List<AmsReportListDetailVO> searchAmsReportListbyDate(UsaAmsReportListCondVO usaAmsReportListCondVO)throws DAOException {
		...
		Map<String, Object> velParam = new HashMap<String, Object>();
		try{
			if (usaAmsReportListCondVO != null){
				Map<String, String> mapVO = usaAmsReportListCondVO.getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				int pageNo = Integer.parseInt("".equals(usaAmsReportListCondVO.getPageNo()) ? "1"
						: usaAmsReportListCondVO.getPageNo());
				int pageRows = Integer.parseInt("".equals(usaAmsReportListCondVO.getPagerows()) ? "1000"
						: usaAmsReportListCondVO.getPagerows());
				int startNo = (pageNo - 1) * pageRows + 1;
				int endNo = pageNo * pageRows;
				...
				//Discrepancy 조회시 
				if ("Y".equals(usaAmsReportListCondVO.getSearchDiscrepancy())){
					endNo = 999999999;
				}
				...
				if("ISF5".equals(usaAmsReportListCondVO.getGeneralOrRail())){
					if ("".equals(usaAmsReportListCondVO.getDateSearch())){
						dbRowset = new SQLExecuter("DEFAULT").executeQuery(
							(ISQLTemplate) new UsaCustomsReportDBDAOsearchMinClptSeqRSQL(), param, velParam);
						if (dbRowset.next()){
					...
					dbRowset = new SQLExecuter("DEFAULT").executeQuery((ISQLTemplate) new UsaCustomsReportDBDAOsearchUsaAmsReportIsf5ListRSQL(), param, velParam);
					...
					dbRowset = new SQLExecuter("DEFAULT").executeQuery((ISQLTemplate) new UsaCustomsReportDBDAOsearchAmsReportListbyDateRSQL(), param, velParam);
					...
					// BAPLIE
					dbRowset = new SQLExecuter("DEFAULT").executeQuery((ISQLTemplate) new UsaCustomsReportDBDAOsearchAmsReportBaplieListRSQL(), param, velParam);
					list2 = (List) RowSetUtil.rowSetToVOs(dbRowset, UsaAmsReportBaplieListVO.class);
				}
			}//end of usaAmsReportListCondVO != null
