...
public class WeeklyCMDBDAOSearchVslRgstCountRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               ,COA_VSL_SUB_TRD_CAPA A2" ).append("\n"); 
		...
		query.append("       ,COA_MON_VVD B3 /* 다시 변경 2009.10.15 */" ).append("\n"); 
		query.append("        /* COA_MON_VVD 테이블은 Report 즉 실적을 보는 통계쪽에서만 없애는 것이고 일반 화면에서는 그대로 사용함.*/" ).append("\n"); 
		query.append("        /*,COA_BKG_EXPN_DTL B3 변경 2009.09.10*/" ).append("\n"); 
