...
public class EsmBkg059601Event extends EventSupport {
	...
	public SearchBDRTimeVO[] getSearchBDRTimeVOS(){
		SearchBDRTimeVO[] rtnVOs = null;
		if (this.searchBDRTimeVOs != null) {
			rtnVOs = new SearchBDRTimeVO[searchBDRTimeVOs.length];
			System.arraycopy(searchBDRTimeVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
