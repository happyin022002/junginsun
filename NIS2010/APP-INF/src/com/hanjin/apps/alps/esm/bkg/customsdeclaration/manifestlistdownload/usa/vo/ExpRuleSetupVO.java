...
*@FileName : ExpRuleSetupVO.java
*@FileTitle : ExpRuleSetupVO
*Open Issues :
*Change history :
...
public class ExpRuleSetupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ExpRuleSetupVO> models = new ArrayList<ExpRuleSetupVO>();
...
/**
	 ...
	 * @param request
	 * @return ExpRuleSetupVO[]
	 */
	public ExpRuleSetupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ExpRuleSetupVO[]
	 */
	public ExpRuleSetupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ExpRuleSetupVO model = null;
	 ...
	 * @return ExpRuleSetupVO[]
	 */
	public ExpRuleSetupVO[] getExpRuleSetupVOs(){
		ExpRuleSetupVO[] vos = (ExpRuleSetupVO[])models.toArray(new ExpRuleSetupVO[models.size()]);
		return vos;
	}
