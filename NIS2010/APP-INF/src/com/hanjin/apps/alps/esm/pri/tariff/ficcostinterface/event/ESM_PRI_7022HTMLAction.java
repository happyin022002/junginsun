 ...
 *@FileName : ESM_PRI_7002HTMLAction
 ...
 * 
 * @author BOBAE KIM
 * @see EsmPri7022Event 참조
 * @since J2EE 1.6
 */

public class ESM_PRI_7022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 7116963942112395646L;

	/**
	 * ESM_PRI_7022HTMLAction 객체를 생성
	 */
	public ESM_PRI_7022HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7022Event event = new EsmPri7022Event();
		if (command.isCommand(FormCommand.SEARCH)) {

		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setTariffCodeMappingVOs((TariffCodeMappingVO[]) getVOs(request, TariffCodeMappingVO.class));
		}
		return event;
	}
