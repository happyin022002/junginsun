...
*@FileName : PRICommonDBDAOPrsRpExchangeRateYrMonRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAOPrsRpExchangeRateYrMonRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_rp_scp_mn prs_xch_rt_yrmon 을 조회한다. 조회조건 (prop_no , amdt_seq , svc_scp_cd )
	  * </pre>
	  */
	public PRICommonDBDAOPrsRpExchangeRateYrMonRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAOPrsRpExchangeRateYrMonRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
