...
*@FileName : ESM_BKG_1507HTMLAction.java
...
public class ESM_BKG_1507HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1507HTMLAction 객체를 생성
	 */
	public ESM_BKG_1507HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1507Event event = new EsmBkg1507Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgNo(JSPUtil.getNullNoTrim(request.getParameter("bkg_no")));
		}
