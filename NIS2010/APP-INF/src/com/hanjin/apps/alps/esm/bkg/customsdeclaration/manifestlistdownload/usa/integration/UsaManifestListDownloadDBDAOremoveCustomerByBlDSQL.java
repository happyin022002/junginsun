...
*@FileName : UsaManifestListDownloadDBDAOremoveCustomerByBlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaManifestListDownloadDBDAOremoveCustomerByBlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaManifestListDownloadDBDAOremoveCustomerByBlDSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.usa.integration").append("\n"); 
		query.append("FileName : UsaManifestListDownloadDBDAOremoveCustomerByBlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_ADV_CUST" ).append("\n"); 
