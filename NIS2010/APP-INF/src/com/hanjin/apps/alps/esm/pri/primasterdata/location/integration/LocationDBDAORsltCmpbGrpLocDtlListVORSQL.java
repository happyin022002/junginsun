...
*@FileName : LocationDBDAORsltCmpbGrpLocDtlListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAORsltCmpbGrpLocDtlListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_CMPB_GRP_LOC_DTL 조회
	  * </pre>
	  */
	public LocationDBDAORsltCmpbGrpLocDtlListVORSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAORsltCmpbGrpLocDtlListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
