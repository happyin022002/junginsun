...
public class SalesRPTDBDAOSearchRPTbyOfc070List11RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,NVL(SUM(DECODE(B1.COST_WK, SUBSTR(@[f_prev_week], 5, 2), TOT_REV - CM_COST - OP_COST)),0)    AS PREV_BKG_OP" ).append("\n"); 
		query.append("      ,NVL(SUM(DECODE(B1.COST_WK, SUBSTR(@[f_curr_week], 5, 2), TOT_REV - CM_COST - OP_COST)),0)    AS CURR_BKG_OP" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(@[f_pro_vw],'P', 0,'R',A2.RA_OP_COST_TTL_AMT)),0)                     AS OP_COST" ).append("\n"); 
		...
		query.append("          ,COA_BKG_SVC_TRNS_SMRY A2" ).append("\n"); 
		query.append("          ,COA_OFC_LVL A3" ).append("\n"); 
