...
public class UnmatchBLDBDAOCheckScOftDiscrepancyRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        NVL(SOC_FLG,'N') SOC_FLG," ).append("\n"); 
		...
		query.append("                BR.SOC_FLG      ," ).append("\n"); 
		...
		query.append("                NVL(RA.SOC_FLG,'N') SOC_FLG," ).append("\n"); 
		...
		query.append("                RA.CHG_CD       ," ).append("\n"); 
		query.append("                RA.CGO_CATE_CD  ," ).append("\n"); 
		query.append("                NVL(RA.SOC_FLG,'N')," ).append("\n"); 
		query.append("                RA.RCV_TERM_CD  ," ).append("\n"); 
		query.append("                RA.DE_TERM_CD   ," ).append("\n"); 
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN DECODE(CK.BL_FLG, 'Y', 'Y', 'N') = 'Y' THEN 1" ).append("\n"); 
		...
		query.append("FROM (" ).append("\n"); 
		query.append("        SELECT  R1.OFT_CMB_SEQ        ," ).append("\n"); 
		query.append("            SUM(BU.RAT_AS_QTY) OVER (PARTITION BY BU.CHG_CD, BU.RAT_UT_CD, BU.CGO_CATE_CD, BU.SOC_FLG, BU.RCV_TERM_CD, BU.DE_TERM_CD) B_QTY," ).append("\n"); 
		query.append("            SUM(BU.RAT_AS_QTY) OVER (PARTITION BY BU.CHG_CD) B_TTL_QTY," ).append("\n"); 
		query.append("            SUM(R1.RAT_AS_QTY) OVER (PARTITION BY R1.OFT_CMB_SEQ, R1.CHG_CD, R1.RAT_UT_CD, R1.CGO_CATE_CD, R1.SOC_FLG, R1.RCV_TERM_CD, R1.DE_TERM_CD) R_QTY," ).append("\n"); 
		...
		query.append("                ) R1" ).append("\n"); 
		query.append("                LEFT OUTER JOIN BU" ).append("\n"); 
