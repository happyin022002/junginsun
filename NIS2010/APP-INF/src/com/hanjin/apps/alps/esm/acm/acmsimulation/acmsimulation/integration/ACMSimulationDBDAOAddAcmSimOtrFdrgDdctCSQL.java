...
*@FileName : ACMSimulationDBDAOAddAcmSimOtrFdrgDdctCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddAcmSimOtrFdrgDdctCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Own Feederage 공제 금액 조회 후 저장.
	  * </pre>
	  */
	public ACMSimulationDBDAOAddAcmSimOtrFdrgDdctCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddAcmSimOtrFdrgDdctCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM (SELECT @[sim_no] AS SIM_NO," ).append("\n"); 
