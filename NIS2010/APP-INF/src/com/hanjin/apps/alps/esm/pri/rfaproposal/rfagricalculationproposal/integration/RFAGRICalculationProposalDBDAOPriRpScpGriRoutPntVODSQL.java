...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRoutPntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriRoutPntVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriRoutPntVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRoutPntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
