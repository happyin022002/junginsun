...
*@FileName : ESM_MAS_0022HTMLAction.java
...
public class ESM_MAS_0022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0022HTMLAction 객체를 생성
	 */
	public ESM_MAS_0022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0022Event event = new EsmMas0022Event();
