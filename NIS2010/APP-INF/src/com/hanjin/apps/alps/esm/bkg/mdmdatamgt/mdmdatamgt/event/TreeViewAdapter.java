 ...
 * @since J2EE 1.5
 */
public class TreeViewAdapter extends ViewAdapter {
    ...
    protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
        ...
        for(int i=0;i<realCnt;i++){
            ...
            sbufXML.append(" <TR");
            if(!getNull(colValues.get("level")).equals("")){
                sbufXML.append(" LEVEL=\"");
                sbufXML.append(getNull(colValues.get("level")));
                sbufXML.append("\"");
            }
    ...
    protected String makeDataTag(DBRowSet rs,String prefix) {
        ...
        try{
            ...
            while (rs.next()) {
                sb.append(" <TR");
                if(!getNull(rs.getObject("level")).equals("")){
                    sb.append(" LEVEL=\"");
                    sb.append(getNull(rs.getObject("level")));
                    sb.append("\"");
                }
