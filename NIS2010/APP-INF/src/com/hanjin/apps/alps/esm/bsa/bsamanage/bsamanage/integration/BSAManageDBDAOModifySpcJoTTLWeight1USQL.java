...
*@FileName : BSAManageDBDAOModifySpcJoTTLWeight1USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifySpcJoTTLWeight1USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySpcJoTTLWeight1
	  * </pre>
	  */
	public BSAManageDBDAOModifySpcJoTTLWeight1USQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifySpcJoTTLWeight1USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT NVL(SUM(DECODE(B.BSA_OP_JB_CD, '007', B.SPC_CTRL_SLT_CAPA)), 0) * NVL(SUM(DECODE(B.BSA_OP_JB_CD, '008', B.SPC_CTRL_SLT_CAPA)), 0)  CRR_BSA_CAPA," ).append("\n"); 
		query.append("NVL(SUM(DECODE(B.BSA_OP_JB_CD, '007', B.SPC_CTRL_SLT_CAPA)), 0) * NVL(SUM(DECODE(B.BSA_OP_JB_CD, '008', B.SPC_CTRL_SLT_CAPA)), 0)  SPC_CTRL_SLT_CAPA" ).append("\n"); 
		...
		query.append("AND B.BSA_OP_JB_CD IN ('007', '008')" ).append("\n"); 
		query.append(")" ).append("\n"); 
