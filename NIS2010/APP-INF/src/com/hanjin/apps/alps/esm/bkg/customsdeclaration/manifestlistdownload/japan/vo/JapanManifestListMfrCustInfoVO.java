...
public class JapanManifestListMfrCustInfoVO extends ManifestListDetailVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<JapanManifestListMfrCustInfoVO> models = new ArrayList<JapanManifestListMfrCustInfoVO>();
	 ...
	 */
	public JapanManifestListMfrCustInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JapanManifestListMfrCustInfoVO[]
	 */
	public JapanManifestListMfrCustInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JapanManifestListMfrCustInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new JapanManifestListMfrCustInfoVO();
				if (custSeq2[i] != null)
	 ...
	 * @return JapanManifestListMfrCustInfoVO[]
	 */
	public JapanManifestListMfrCustInfoVO[] getJapanManifestListMfrCustInfoVOs(){
		JapanManifestListMfrCustInfoVO[] vos = (JapanManifestListMfrCustInfoVO[])models.toArray(new JapanManifestListMfrCustInfoVO[models.size()]);
		return vos;
	}
