...
*@FileName : Kor24EmpBlInfoVO.java
*@FileTitle : Kor24EmpBlInfoVO
*Open Issues :
*Change history :
...
public class Kor24EmpBlInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24EmpBlInfoVO> models = new ArrayList<Kor24EmpBlInfoVO>();
	...
	public Kor24EmpBlInfoVO() {}

	public Kor24EmpBlInfoVO(String ibflag, String pagerows, String usrId, String cstmsBlNo, String cstmsDeclTpCd, String dmstPortCd, String trnsSeq, String subNo) {
...
/**
	 ...
	 * @param request
	 * @return Kor24EmpBlInfoVO[]
	 */
	public Kor24EmpBlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24EmpBlInfoVO[]
	 */
	public Kor24EmpBlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24EmpBlInfoVO model = null;
	 ...
	 * @return Kor24EmpBlInfoVO[]
	 */
	public Kor24EmpBlInfoVO[] getKor24EmpBlInfoVOs(){
		Kor24EmpBlInfoVO[] vos = (Kor24EmpBlInfoVO[])models.toArray(new Kor24EmpBlInfoVO[models.size()]);
		return vos;
	}
