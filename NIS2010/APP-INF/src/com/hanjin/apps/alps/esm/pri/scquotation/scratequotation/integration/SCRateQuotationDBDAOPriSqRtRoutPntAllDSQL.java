...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutPntAllDSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutPntAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutPntAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutPntAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
