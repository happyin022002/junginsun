...
*@FileName : ui_pri_0005HTMLAction.java
...
public class ESM_PRI_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ui_pri_0005HTMLAction 객체를 생성
	 */
	public ESM_PRI_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0005Event event = new EsmPri0005Event();
...
//			log.debug("*********************************************************");
			...
			event.getStndnoteglinevo().setPrisgstndnotehdrvo((PriSgStndNoteHdrVO)getVO(request, PriSgStndNoteHdrVO .class));
			event.getStndnoteglinevo().setPrisgstndnotevos((PriSgStndNoteVO[])getVOs(request, PriSgStndNoteVO .class,"sheet1_"));
			event.getStndnoteglinevo().setPrisgstndnotectntvos((PriSgStndNoteCtntVO[])getVOs(request, PriSgStndNoteCtntVO .class,"sheet2_"));
			event.setRsltPriSgStndNoteHdrCopyVO((RsltPriSgStndNoteHdrCopyVO)getVO(request, RsltPriSgStndNoteHdrCopyVO .class));
		}
			...
			event.setRsltPriSgStndNoteCtntVO((RsltPriSgStndNoteCtntVO)getVO(request, RsltPriSgStndNoteCtntVO .class));
		}
