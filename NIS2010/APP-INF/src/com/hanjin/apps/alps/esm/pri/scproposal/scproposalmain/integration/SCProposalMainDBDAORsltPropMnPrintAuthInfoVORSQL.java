...
*@FileName : SCProposalMainDBDAORsltPropMnPrintAuthInfoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORsltPropMnPrintAuthInfoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAORsltPropMnPrintAuthInfoVORSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORsltPropMnPrintAuthInfoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         , MN.AMDT_SEQ AMDT_SEQ" ).append("\n"); 
		...
		query.append("-- [CHM-201537786] SC 다운로드 보안 강화_1차 보완 START" ).append("\n"); 
		query.append(", " ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append(" SELECT C.USR_ID" ).append("\n"); 
		query.append("   FROM PRI_SP_MN A" ).append("\n"); 
		query.append("      , MDM_SLS_REP B" ).append("\n"); 
		query.append("      , COM_USER C" ).append("\n"); 
		query.append(" WHERE A.PROP_SREP_CD = B.SREP_CD" ).append("\n"); 
		query.append("   AND B.EMPE_CD = C.USR_ID" ).append("\n"); 
		query.append("   AND A.PROP_NO =  MN.PROP_NO" ).append("\n"); 
		query.append("   AND A.AMDT_SEQ = ( SELECT MAX(AMDT_SEQ) FROM PRI_SP_MN WHERE PROP_NO = MN.PROP_NO )  " ).append("\n"); 
		query.append("   AND ROWNUM = 1 " ).append("\n"); 
		query.append(") AS MAX_PROP_USR_ID" ).append("\n"); 
		query.append("-- [CHM-201537786] SC 다운로드 보안 강화_1차 보완 END" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("FROM   PRI_SP_MN MN" ).append("\n"); 
		query.append("     , PRI_SP_HDR HDR" ).append("\n"); 
