...
*@FileName : ESM_BKG_0507HTMLAction.java
...
public class ESM_BKG_0507HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0507HTMLAction 객체를 생성
	 */
	public ESM_BKG_0507HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0507Event event = new EsmBkg0507Event();
		
		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH02)) {
			event.setTransmitHistListCondVO((TransmitHistListCondVO)getVO(request, UsaTransmitHistListCondVO.class));
		}
