...
*@FileName : CostAssignDBDAOUpdateCoaBkgExpnDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostAssignDBDAOUpdateCoaBkgExpnDtlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG cancel 시 CoaBkgExpnDtl 테이블 Cancel Status Update
	  ...
	  * </pre>
	  */
	public CostAssignDBDAOUpdateCoaBkgExpnDtlUSQL(){
		setQuery();
		...
		query.append("FileName : CostAssignDBDAOUpdateCoaBkgExpnDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
