...
*@FileName : Eur24ManifestDownloadDBDAOSearchRcvMsgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOSearchRcvMsgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOSearchRcvMsgRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOSearchRcvMsgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" ,TO_CLOB(DECODE(C.ACK_RCV_STS_CD, 'A', 'Accepted', 'R', 'Rejected', 'H', 'Hold', 'L', 'Release', 'CA', 'Add Info.', 'AL', 'Accepted with loading permission', 'Do not load')) REMARK1" ).append("\n"); 
		query.append(" , 1 AS ERR_IMG" ).append("\n"); 
		query.append(" , NULL AS ERR_ID" ).append("\n"); 
		query.append("FROM  BKG_CSTMS_ADV_EUR_RCV C" ).append("\n"); 
		...
		query.append("FROM BKG_CSTMS_ADV_EUR_RCV_ERR" ).append("\n"); 
		query.append("WHERE EDI_RCV_DT  = TO_CHAR(TO_DATE(@[edi_rcv_dt], 'YYYYMMDDHH24MISS'), 'YYYYMMDD')" ).append("\n"); 
		query.append("  AND EDI_RCV_SEQ = @[edi_rcv_seq]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UNION ALL  " ).append("\n"); 
