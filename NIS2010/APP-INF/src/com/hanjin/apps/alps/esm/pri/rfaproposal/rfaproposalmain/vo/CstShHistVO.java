...
public class CstShHistVO extends AbstractValueObject {
	...
	public CstShHistVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String termTypeCd) {
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTermTypeCd(JSPUtil.getParameter(request, "term_type_cd", ""));
