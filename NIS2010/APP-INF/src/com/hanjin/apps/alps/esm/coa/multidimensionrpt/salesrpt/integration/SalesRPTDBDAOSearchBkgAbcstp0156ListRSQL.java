...
public class SalesRPTDBDAOSearchBkgAbcstp0156ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",DECODE(A1.RA_ACCT_CD, '91401011', DECODE('${f_stp_flg}','I', 'STP REVENUE', 'O', 'STP COST'), A3.COA_COST_SRC_CD_NM) COA_COST_SRC_CD_NM" ).append("\n"); 
		...
		query.append("FROM COA_BKG_SVC_TRNS_PRC A1" ).append("\n"); 
		query.append(",COA_OFC_ROUT_MAPG A2" ).append("\n"); 
		query.append(",COA_COST_SRC_ACCT A3" ).append("\n"); 
		...
		query.append(",COA_RGST_BKG A5" ).append("\n"); 
		query.append(",COA_MON_VVD  A6" ).append("\n"); 
		query.append("WHERE A1.SLS_ACT_CD   = A2.SLS_ACT_CD" ).append("\n"); 
		query.append("AND A1.OFC_CLSS_CD  = A2.OFC_CLSS_CD" ).append("\n"); 
		query.append("AND A1.RA_ACCT_CD   = A3.COA_COST_SRC_CD" ).append("\n"); 
		...
		query.append(",DECODE(A1.RA_ACCT_CD, '91401011', DECODE('${f_stp_flg}','I', 'STP REVENUE', 'O', 'STP COST'), A3.COA_COST_SRC_CD_NM)" ).append("\n"); 
