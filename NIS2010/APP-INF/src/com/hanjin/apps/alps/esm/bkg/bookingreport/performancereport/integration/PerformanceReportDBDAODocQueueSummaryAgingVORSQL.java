...
*@FileName : PerformanceReportDBDAODocQueueSummaryAgingVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAODocQueueSummaryAgingVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PerformanceReportDBDAODocQueueSummaryAgingVORSQL
	  * </pre>
	  */
	public PerformanceReportDBDAODocQueueSummaryAgingVORSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAODocQueueSummaryAgingVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       P_D1," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(P_D1, 0, 0, (P_D1 / TOTAL) * 100), 2), '990.99')) AS P_D1_PER," ).append("\n"); 
		query.append("       P_D3," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(P_D3, 0, 0, (P_D3 / TOTAL) * 100), 2), '990.99')) AS P_D3_PER," ).append("\n"); 
		query.append("       P_D5," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(P_D5, 0, 0, (P_D5 / TOTAL) * 100), 2), '990.99')) AS P_D5_PER," ).append("\n"); 
		query.append("       F_D1," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(F_D1, 0, 0, (F_D1 / TOTAL) * 100), 2), '990.99')) AS F_D1_PER," ).append("\n"); 
		query.append("       F_D3," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(F_D3, 0, 0, (F_D3 / TOTAL) * 100), 2), '990.99')) AS F_D3_PER," ).append("\n"); 
		query.append("       F_D5," ).append("\n"); 
		query.append("       TRIM(TO_CHAR(ROUND(DECODE(F_D5, 0, 0, (F_D5 / TOTAL) * 100), 2), '990.99')) AS F_D5_PER" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                        WHEN 0 >= PED_DD AND PED_DD <= 2 AND SR_WRK_STS_CD = 'P' THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS P_D1," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN 3 >= PED_DD AND PED_DD <= 5 AND SR_WRK_STS_CD = 'P' THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS P_D3," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN 5 <= PED_DD AND SR_WRK_STS_CD = 'P' THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS P_D5," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN 0 >= PED_DD AND PED_DD <= 2 AND SR_WRK_STS_CD = 'F' THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS F_D1," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN 3 >= PED_DD AND PED_DD <= 5 AND SR_WRK_STS_CD = 'F' THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS F_D3," ).append("\n"); 
		query.append("               SUM(CASE" ).append("\n"); 
		query.append("                        WHEN 5 <= PED_DD AND SR_WRK_STS_CD = 'F' THEN 1" ).append("\n"); 
		query.append("                        ELSE 0" ).append("\n"); 
		query.append("                   END) AS F_D5" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("          FROM (SELECT (SELECT INTG_CD_VAL_DESC" ).append("\n"); 
		...
		query.append("                                                      AND ROWNUM = 1)) AS REGION," ).append("\n"); 
		...
		query.append("                       BKG_GET_CONV_INTVAL_TIME_FNC((SYSDATE - A.CRNT_DT), 'DD') AS PED_DD," ).append("\n"); 
		...
		query.append("                      AND A.SR_WRK_STS_CD IN ('P', 'F')" ).append("\n"); 
		query.append("#if (${bkg_no} == '')" ).append("\n"); 
