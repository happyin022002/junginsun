...
public class CaCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CaCustVO> models = new ArrayList<CaCustVO>();
	...
	public CaCustVO(String ibflag, String pagerows, String itemHdr, String hisCateNm, String preCtnt, String crntCtnt) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return CaCustVO[]
	 */
	public CaCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CaCustVO[]
	 */
	public CaCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CaCustVO model = null;
	 ...
	 * @return CaCustVO[]
	 */
	public CaCustVO[] getCaCustVOs(){
		CaCustVO[] vos = (CaCustVO[])models.toArray(new CaCustVO[models.size()]);
		return vos;
	}
