...
*@FileName : EsmCoa0179ViewAdapter.java
...
* =========================================================
* History
* 2011.05.26 최성민 [CHM-201006017-01] COA 약정율 로직 추가 - 사용하지 않는 컬럼 제거
* =========================================================*/
...
/**
 * ESM_COA_0179 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0179ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0179ViewAdapter(){
    	super();
    }
