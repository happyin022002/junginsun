...
*@FileName : SpacecontrolinquiryDBDAO021AllocPortViewListHOSubOfcRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAO021AllocPortViewListHOSubOfcRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 이전 쿼리 SpacecontrolinquiryDBDAO021AllocPortViewListRSQL 참고
	  * 
	  ...
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAO021AllocPortViewListHOSubOfcRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAO021AllocPortViewListHOSubOfcRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("           B.FL_ETD_DT ,B.BSA_WGT" ).append("\n"); 
		...
		query.append("              ,A1.ALOC_CTRL_TP_CD AS ORG_ALOC_CTRL_TP_CD " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                 AND A.SUB_OFC_CD = B.SLS_OFC_CD " ).append("\n"); 
		query.append("#if (${pol_cd} != '')" ).append("\n"); 
		...
		query.append("		           DECODE(TRD_CD||LOD_SPL_CNG_FLG,'IASY',SUM(BKG_WGT),BSA_WGT) AS BSA_WGT,  -- 2013.03.28 수송량으로 BSA 대체" ).append("\n"); 
		query.append("		           LOD_SPL_CNG_FLG," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("                            Z4.TRD_CD, Z4.SUB_TRD_CD, Z4.RLANE_CD, Z4.DIR_CD, Z4.AQ_CD, Z4.VVD1, Z4.OFC_CD, Z4.SUB_OFC_CD, DECODE(Z4.T2, 'Y', 'Z', NVL(Z4.CUST_CTRL_CD,0)) " ).append("\n"); 
		query.append(" " ).append("\n"); 
		...
		query.append("                        MAX(Z3.QTA${key}1) OVER(PARTITION BY Z3.DEST, Z3.TRD_CD, Z3.SUB_TRD_CD, Z3.RLANE_CD, Z3.DIR_CD, Z3.AQ_CD, Z3.OFC_CD, Z3.SUB_OFC_CD, Z3.CUST_CTRL_CD, Z3.GID) " ).append("\n"); 
		query.append("                   ELSE" ).append("\n"); 
		query.append("                        MAX(Z3.QTA${key}1) OVER(PARTITION BY Z3.DEST, Z3.TRD_CD, Z3.SUB_TRD_CD, Z3.RLANE_CD, Z3.DIR_CD, Z3.AQ_CD, Z3.OFC_CD, Z3.SUB_OFC_CD, Z3.CUST_CTRL_CD, Z3.GID, Z3.VVD${key})" ).append("\n"); 
		...
		query.append("                   MAX(Z3.MDL${key}1) OVER (PARTITION BY Z3.DEST, Z3.TRD_CD, Z3.SUB_TRD_CD, Z3.RLANE_CD, Z3.DIR_CD, Z3.AQ_CD, Z3.OFC_CD, Z3.SUB_OFC_CD) AS MDL_TTL${key}1," ).append("\n"); 
		query.append("                   ROUND(DECODE(MAX(Z3.QTA${key}1) OVER (PARTITION BY Z3.DEST, Z3.TRD_CD, Z3.SUB_TRD_CD, Z3.RLANE_CD, Z3.DIR_CD, Z3.AQ_CD, Z3.OFC_CD, Z3.SUB_OFC_CD, Z3.CUST_CTRL_CD, Z3.GID, Z3.VVD${key}), 0," ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append("                                0, " ).append("\n"); 
		query.append("                                Z3.FCT${key}1 * 100 / MAX(Z3.QTA${key}1) OVER (PARTITION BY Z3.DEST, Z3.TRD_CD, Z3.SUB_TRD_CD, Z3.RLANE_CD, Z3.DIR_CD, Z3.AQ_CD, Z3.OFC_CD, Z3.SUB_OFC_CD, Z3.CUST_CTRL_CD, Z3.GID, Z3.VVD${key})" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                            , CASE WHEN SUB_OFC_CD IS NULL AND CUST_CTRL_CD IS NULL AND " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                ( " ).append("\n"); 
		...
		query.append("                              CUBE(Z2.SUB_TRD_CD, Z2.DEST, Z2.RLANE_CD, Z2.DIR_CD, Z2.AQ_CD, Z2.OFC_CD, Z2.SUB_OFC_CD, Z2.CUST_CTRL_CD, USA_BKG_MOD_CD, ACCT_CD, DEST_LOC_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("                              Z2.TRD_CD    ," ).append("\n"); 
		query.append("                              Z2.SUB_TRD_CD," ).append("\n"); 
		query.append("                              CUBE(Z2.RLANE_CD, Z2.DEST, Z2.DIR_CD, Z2.AQ_CD, Z2.OFC_CD, Z2.SUB_OFC_CD, Z2.CUST_CTRL_CD, USA_BKG_MOD_CD, ACCT_CD, DEST_LOC_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${checkVvd1} == 'Y')" ).append("\n"); 
		query.append("                                   ,NUM_1" ).append("\n"); 
		...
		query.append("	#if (${subtrade1} == '')" ).append("\n"); 
		query.append("                              Z2.TRD_CD  ," ).append("\n"); 
		query.append("                              CUBE(Z2.SUB_TRD_CD, Z2.RLANE_CD, Z2.DIR_CD, Z2.AQ_CD, Z2.OFC_CD, Z2.SUB_OFC_CD, Z2.CUST_CTRL_CD, USA_BKG_MOD_CD, DEST_LOC_CD, ACCT_CD" ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		query.append("                              Z2.TRD_CD    ," ).append("\n"); 
		query.append("                              Z2.SUB_TRD_CD," ).append("\n"); 
		query.append("                              CUBE(Z2.RLANE_CD, Z2.DIR_CD, Z2.AQ_CD, Z2.OFC_CD, Z2.SUB_OFC_CD, Z2.CUST_CTRL_CD, USA_BKG_MOD_CD, DEST_LOC_CD, ACCT_CD" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("#if(${checkVvd1} == 'Y')" ).append("\n"); 
		query.append("                                   ,NUM_1" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("                                 AND (NOT (RLANE_CD IS NOT NULL AND AQ_CD IS NULL AND SUB_OFC_CD IS NULL AND CUST_CTRL_CD IS NULL AND USA_BKG_MOD_CD IS NOT NULL AND (ACCT_CD IS NOT NULL OR DEST_LOC_CD IS NOT NULL)))" ).append("\n"); 
		query.append("                                 AND (NOT (RLANE_CD IS NOT NULL AND AQ_CD IS NULL AND SUB_OFC_CD IS NULL AND CUST_CTRL_CD IS NULL AND ACCT_CD IS NOT NULL AND (USA_BKG_MOD_CD IS NOT NULL OR DEST_LOC_CD IS NOT NULL)))" ).append("\n"); 
		query.append("                                 AND (NOT (RLANE_CD IS NOT NULL AND AQ_CD IS NULL AND SUB_OFC_CD IS NULL AND CUST_CTRL_CD IS NULL AND DEST_LOC_CD IS NOT NULL AND (ACCT_CD IS NOT NULL OR USA_BKG_MOD_CD IS NOT NULL)))                                 " ).append("\n"); 
		query.append("								 AND OFC_CD IS NULL AND CUST_CTRL_CD IS NULL " ).append("\n"); 
		query.append("                                 AND SUB_OFC_CD IS NULL AND CUST_CTRL_CD IS NULL " ).append("\n"); 
		query.append("                                 AND" ).append("\n"); 
		query.append("                                    ( " ).append("\n"); 
		query.append("                                        (USA_BKG_MOD_CD IS NOT NULL AND ACCT_CD IS NULL AND DEST_LOC_CD IS NULL) OR " ).append("\n"); 
		query.append("                                        (ACCT_CD IS NOT NULL AND USA_BKG_MOD_CD IS NULL AND DEST_LOC_CD IS NULL) OR " ).append("\n"); 
		...
		query.append("   AND NOT ( Z4.AQ_CD <> '+' AND Z4.OFC_CD <> '+' AND Z4.SUB_OFC_CD <> '+' AND USA_BKG_MOD_CD <> '+'  AND (NVL(Z4.ACCT_NM, '+') = '+' OR DEST_LOC_CD='+'))  " ).append("\n"); 
		...
		query.append("         DECODE(SUB_OFC_CD  , 'TOTAL', '00000', OFC_CD, '0000', SUB_OFC_CD)," ).append("\n"); 
