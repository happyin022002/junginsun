...
public class SCRateGuidelineDBDAOPriSgRtMqcRngVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtMqcRngVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("insert into pri_sg_rt_mqc_rng (" ).append("\n"); 
		...
		query.append("@[gline_seq]," ).append("\n"); 
		query.append("@[prc_cust_tp_cd]," ).append("\n"); 
		query.append("nvl((select /*+ index_desc(pri_sg_rt_mqc_rng XPKPRI_SG_RT_MQC_RNG)  */" ).append("\n"); 
		query.append("mqc_rng_seq" ).append("\n"); 
		query.append("from pri_sg_rt_mqc_rng" ).append("\n"); 
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtMqcRngVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}