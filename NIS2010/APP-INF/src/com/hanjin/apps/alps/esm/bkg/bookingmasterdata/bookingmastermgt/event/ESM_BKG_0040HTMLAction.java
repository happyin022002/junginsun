...
*@FileName : ESM_BKG_0040HTMLAction.java
...
public class ESM_BKG_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0040HTMLAction 객체를 생성
	 */
	public ESM_BKG_0040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0040Event event = new EsmBkg0040Event();
        log.debug("::CALL::> ESM_BKG_0040HTMLAction - " + command.getCommand());
      
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgCstmsAdvScacVOS((BkgCstmsAdvScacVO[])getVOs(request, BkgCstmsAdvScacVO .class,"sheet1_"));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgCstmsAdvScacVO((BkgCstmsAdvScacVO)getVO(request, BkgCstmsAdvScacVO .class));
		}
