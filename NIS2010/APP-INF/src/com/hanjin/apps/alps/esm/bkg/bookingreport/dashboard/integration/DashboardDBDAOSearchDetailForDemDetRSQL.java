...
*@FileName : DashboardDBDAOSearchDetailForDemDetRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DashboardDBDAOSearchDetailForDemDetRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * General + Dem / Det Detail 항목을 조회한다.
	  * </pre>
	  */
	public DashboardDBDAOSearchDetailForDemDetRSQL(){
		setQuery();
		...
		query.append("FileName : DashboardDBDAOSearchDetailForDemDetRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", SUM( T2.BIL_AMT ) AS BIL_AMT" ).append("\n"); 
		...
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("  AND DB.BKG_NO           = T1.BKG_NO" ).append("\n"); 
		...
		query.append("  AND T2.DMDT_CHG_STS_CD  NOT IN ('N', 'E', 'D', 'P')" ).append("\n"); 
		query.append("  AND NOT (T2.DUL_TP_EXPT_FLG = 'Y' AND SUBSTR(T2.DMDT_TRF_CD, 1, 1) = 'D')" ).append("\n"); 
		query.append("  AND BIL_AMT             != 0" ).append("\n"); 
		...
		query.append(", T2.DMDT_TRF_CD" ).append("\n"); 
		query.append(", T2.BZC_TRF_CURR_CD" ).append("\n"); 
		query.append("ORDER BY DB.BKG_NO" ).append("\n"); 
