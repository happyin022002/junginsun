...
*@FileName : RFARateProposalDBDAOPriRpScpRtRoutPntVOMSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtRoutPntVOMSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtRoutPntVOMSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtRoutPntVOMSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
