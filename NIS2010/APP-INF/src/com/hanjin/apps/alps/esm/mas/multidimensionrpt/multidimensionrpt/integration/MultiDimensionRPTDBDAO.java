 ...
 * 2008.12.15 박은주 N200811270012 MAS_BKG CM 기준 변경 [072]
 ...
 * 2009.02.04 김태윤 N200901210016 - MAS_조직개편 관련 기능 수정 [063], [067]
 ...
 * 2009.03.03 박은주 N200902260022 MAS_조직 Code 변경 및 ABC/STP 관련[072]
 * 2009.03.26 박은주 : 품질검토결과 수정사항 반영                   
 * 2009.04.03 김종열 N200903170124 MAS_Multi-dimension report 조회권한 변경 
              (searchMultiDimension063List,searchMultiDimension065List,searchMultiDimension067List)
 * 2009.04.03 배진환 N200903170122 MAS_Multi-dimension report 조회권한 변경 searchWeeklySalesByOffice3TEUBased1List, searchWeeklySalesByOffice3TEUBased2List, searchWeeklySalesByOffice3TEUBased3List
...
public class MultiDimensionRPTDBDAO extends DBDAOSupport {
	 ...
	 *  - f_sch_mode '1': ENIS[ESM_MAS_0063GS]
	 *  			 '2': ENIS[ESM_MAS_0063GS2]
	 *  			 '3': ENIS[ESM_MAS_0065GS, ESM_MAS_0067GS2]
	 *  			 '4': ENIS[ESM_MAS_0067GS]
	 */
	...
	/**
	 * MultiDimensionRPT의 데이타 모델에 해당되는 값을 불러온다.<br> - 사용 프로그램 : ESM_MAS_072
	 * 
	 * @param RepoPfmcConditionVO vo
	 * @return DBRowSet
	 * @throws DAOException
	...
	/**
	 * MAS_RPT_AUTH_MGMT 여러 데이타 모델을 지정된 ibflag 값에 따라 DB에 반영한다.(수정)<br>
	 * ESM_MAS_0130 수정
	 * @param List<MasRptAuthMgmtVO> updModels
	 * @return int[]
	 * @throws DAOException
	 * @throws Exception
	 */
	public int[] modifyMultiReportView(List<MasRptAuthMgmtVO> updModels) throws DAOException,Exception {
		int updCnt[] = null;
		try {
			SQLExecuter sqlExe = new SQLExecuter("");
			if(updModels.size() > 0){
				updCnt = sqlExe.executeBatch((ISQLTemplate)new MultiDimensionRPTDBDAOMasRptAuthMgmtVOUSQL(), updModels,null);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<MasUtCostCreStsVO> searchProfitLossCreationStatus(RepoPfmcConditionVO repoPfmcConditionVO) throws DAOException {
		DBRowSet dbRowset = null;
	...
	/**
     * P&L by agreement - By Account<br>
     * 사용 프로그램 : ESM_MAS_072
     * 
     * @param RepoPfmcConditionVO vo
     * @param List<String> cols
     ...
     * @throws DAOException
     */
    public DBRowSet searchWeeklySalesByOffice3TEUBased9List(RepoPfmcConditionVO vo, List<String> cols) throws DAOException {
        DBRowSet dbRowset = null;
        //query parameter
        Map<String, Object> param = new HashMap<String, Object>();
        //velocity parameter
        ...
        try{
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased9ListRSQL(), param, velParam);
        } catch(SQLException se) {
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage());
        } catch(Exception ex) {
    ...
    /**
     * P&L by agreement - By Lane/Bound <br>
     * 사용 프로그램 : ESM_MAS_072
     * 
     * @param RepoPfmcConditionVO vo
     * @param List<String> cols
     ...
     * @throws DAOException
     */
    public DBRowSet searchWeeklySalesByOffice3TEUBased10List(RepoPfmcConditionVO vo, List<String> cols) throws DAOException {
        DBRowSet dbRowset = null;
        //query parameter
        Map<String, Object> param = new HashMap<String, Object>();
        //velocity parameter
        ...
        try{
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased10ListRSQL(), param, velParam);
        } catch(SQLException se) {
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage());
        } catch(Exception ex) {
     ...
     * @throws DAOException
     */
    public DBRowSet searchWeeklySalesByOffice3TEUBased11List(RepoPfmcConditionVO vo, List<String> cols) throws DAOException {
        DBRowSet dbRowset = null;
        //query parameter
        Map<String, Object> param = new HashMap<String, Object>();
        //velocity parameter
        ...
        try{
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased11ListRSQL(), param, velParam);
        } catch(SQLException se) {
            log.error(se.getMessage(),se);
            throw new DAOException(new ErrorHandler(se).getMessage());
        } catch(Exception ex) {
	...
	/**
	 * MultiDimensionRPT의 데이타 모델에 해당되는 값을 불러온다.<br> - 사용 프로그램 : ESM_MAS_073
	 * 
	 * @param RepoPfmcConditionVO repoPfmcConditionVO
	...
	/**
	 * P&L By Lane Adjustment - Total<br>
	 * 사용 프로그램 : ESM_MAS_0192
	 * 
	 * @param RepoPfmcConditionVO vo
	 * @return DBRowSet
	 * @throws DAOException
	 */
	public DBRowSet searchPlAdjustmentTotalList(RepoPfmcConditionVO vo) throws DAOException {
		DBRowSet dbRowset = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchPlAdjustmentTotalListRSQL(), param, velParam);
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch(Exception ex) {
	...
	/**
	 * P&L By Lane Adjustment - Trade<br>
	 * 사용 프로그램 : ESM_MAS_0192
	 * 
	 * @param RepoPfmcConditionVO vo
	 * @param List<String> cols
	 ...
	 * @throws DAOException
	 */
	public DBRowSet searchPlAdjustmentTradeList(RepoPfmcConditionVO vo, List<String> cols) throws DAOException {
		DBRowSet dbRowset = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchPlAdjustmentTradeListRSQL(), param, velParam);
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch(Exception ex) {
	 ...
	 * @throws DAOException
	 */
	public DBRowSet searchPlAdjustmentVVDList(RepoPfmcConditionVO vo, List<String> cols) throws DAOException {
		DBRowSet dbRowset = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchPlAdjustmentVVDListRSQL(), param, velParam);
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch(Exception ex) {
	 ...
	 * @throws DAOException
	 */
//	public String searchYdToRhq(String yd_cd) throws DAOException {
	public List<SearchCondition0153VO> searchYdToRhq(SearchCondition0153VO vo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MultiDimensionRPTDBDAOSearchYdToRhqRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, SearchCondition0153VO .class);
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch(Exception ex) {
