...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkRoutDtlTmpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkRoutDtlTmpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_ROUT_DTL_TMP 테이블 삭제
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkRoutDtlTmpDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkRoutDtlTmpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  PRI_SCQ_AWK_ROUT_DTL_TMP" ).append("\n"); 
