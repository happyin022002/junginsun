...
*@FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOGlineCopyPriSpScpRtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Guideline Copy PRI_SP_SCP_RT Insert
	  * </pre>
	  */
	public SCRateProposalDBDAOGlineCopyPriSpScpRtCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOGlineCopyPriSpScpRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.RT_SEQ) AS RT_SEQ" ).append("\n"); 
		...
		query.append(", A.CMDT_HDR_SEQ" ).append("\n"); 
		query.append(", A.OLD_CMDT_HDR_SEQ" ).append("\n"); 
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, A.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.PRC_CUST_TP_CD, A.CMDT_HDR_SEQ, B.ROUT_SEQ) AS ROUT_SEQ" ).append("\n"); 
		query.append(", B.ROUT_SEQ AS OLD_ROUT_SEQ" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		...
		query.append(", PRI_SG_RT_CMDT_ROUT B" ).append("\n"); 
		...
		query.append("AND   H.PRC_CUST_TP_CD = B.PRC_CUST_TP_CD" ).append("\n"); 
		query.append("AND   H.CMDT_HDR_SEQ = B.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("AND   H.ROUT_SEQ = B.ROUT_SEQ" ).append("\n"); 
		query.append("AND   J.PROP_NO = A.PROP_NO" ).append("\n"); 
		query.append("AND   J.AMDT_SEQ = A.AMDT_SEQ" ).append("\n"); 
		query.append("AND   I.PROP_NO = J.PROP_NO" ).append("\n"); 
		query.append("AND   I.AMDT_SEQ = J.AMDT_SEQ" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append(") A" ).append("\n"); 
		query.append(", PRI_SG_RT B" ).append("\n"); 
		query.append(", PRI_SP_MQC D" ).append("\n"); 
		query.append(", PRI_SP_SCP_MQC C" ).append("\n"); 
		query.append("WHERE B.SVC_SCP_CD = A.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   B.GLINE_SEQ = A.GLINE_SEQ" ).append("\n"); 
		query.append("AND   B.PRC_CUST_TP_CD = A.PRC_CUST_TP_CD" ).append("\n"); 
		query.append("AND   B.CMDT_HDR_SEQ = A.OLD_CMDT_HDR_SEQ" ).append("\n"); 
		query.append("AND   B.ROUT_SEQ = A.OLD_ROUT_SEQ" ).append("\n"); 
		query.append("AND   D.PROP_NO = A.PROP_NO" ).append("\n"); 
		...
		query.append("AND   DECODE(C.PROP_SCP_MQC_QTY, 0, D.PROP_MQC_QTY, C.PROP_SCP_MQC_QTY) BETWEEN B.MQC_RNG_FM_QTY AND B.MQC_RNG_TO_QTY" ).append("\n"); 
