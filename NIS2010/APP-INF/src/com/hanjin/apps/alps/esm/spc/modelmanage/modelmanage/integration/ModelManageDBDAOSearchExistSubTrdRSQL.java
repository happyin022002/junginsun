...
*@FileName : ModelManageDBDAOSearchExistSubTrdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAOSearchExistSubTrdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 지정된 Trade 에 실적이 존재하는 Sub Trade를 조회합니다.
	  * [CHM-201322502-01] SPC 프로젝트 - 성수기 선복운영 개선을 위한 T/F추진
	  * </pre>
	  */
	public ModelManageDBDAOSearchExistSubTrdRSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAOSearchExistSubTrdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT SUB_TRD_CD" ).append("\n"); 
