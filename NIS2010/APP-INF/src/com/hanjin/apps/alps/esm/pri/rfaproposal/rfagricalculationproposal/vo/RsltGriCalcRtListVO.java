...
*@FileName : RsltGriCalcRtListVO.java
*@FileTitle : RsltGriCalcRtListVO
*Open Issues :
*Change history :
...
public class RsltGriCalcRtListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltGriCalcRtListVO> models = new ArrayList<RsltGriCalcRtListVO>();
	...
	public RsltGriCalcRtListVO() {}

	public RsltGriCalcRtListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String griRtSeq, String ratUtCd, String prcCgoTpCd, String currCd, String griRtAmt, String griRtRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setGriRtSeq(JSPUtil.getParameter(request, prefix + "gri_rt_seq", ""));
	 ...
	 * @param request
	 * @return RsltGriCalcRtListVO[]
	 */
	public RsltGriCalcRtListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltGriCalcRtListVO[]
	 */
	public RsltGriCalcRtListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltGriCalcRtListVO model = null;
		...
		return getRsltGriCalcRtListVOs();
	}
	 ...
	 * @return RsltGriCalcRtListVO[]
	 */
	public RsltGriCalcRtListVO[] getRsltGriCalcRtListVOs(){
		RsltGriCalcRtListVO[] vos = (RsltGriCalcRtListVO[])models.toArray(new RsltGriCalcRtListVO[models.size()]);
		return vos;
	}
