...
public class KorCustomsTransmissionDBDAOmakeMACAMDFlatFileRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		''								    	||'~'||		/*	Shipper Name2 G4	*/" ).append("\n"); 
		query.append("		''								    	||'~'||		/*	Shipper Name3 G4	*/" ).append("\n"); 
		query.append("		''									  	||'~'||		/*	Shipper Addr 1		*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper Addr 2		*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper Addr 3		*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper Addr 4	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper Addr 5	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper CITY	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper CNT 5	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	Shipper TEL 5	G4	*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		''								    	||'~'||		/*	CNEE Name 1			*/" ).append("\n"); 
		query.append("		''								    	||'~'||		/*	CNEE Name 2			*/" ).append("\n"); 
		query.append("		''								    	||'~'||		/*	CNEE Name 3			*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	CNEE Addr 1			*/" ).append("\n"); 
		query.append("		''										||'~'||		/*	CNEE Addr 2			*/" ).append("\n"); 
		query.append("		''										||'~'||		/*	CNEE Addr 3			*/" ).append("\n"); 
		query.append("		''										||'~'||		/*	CNEE Addr 4			*/" ).append("\n"); 
		query.append("		''										||'~'||		/*	CNEE Addr 5			*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	CNEE CITY	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	CNEE CNT 5	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	CNEE TEL 5	G4	*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		''										||'~'||		/*	NTFY Name 1			*/" ).append("\n"); 
		query.append("		''										||'~'||		/*	NTFY Name 2			*/" ).append("\n"); 
		query.append("		''										||'~'||		/*	NTFY Name 3			*/" ).append("\n"); 
		...
		query.append("		''									 	||'~'||		/*	NTFY CITY	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	NTFY CNT 5	G4	*/" ).append("\n"); 
		query.append("		''									 	||'~'||		/*	NTFY TEL 5	G4	*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		(" ).append("\n"); 
