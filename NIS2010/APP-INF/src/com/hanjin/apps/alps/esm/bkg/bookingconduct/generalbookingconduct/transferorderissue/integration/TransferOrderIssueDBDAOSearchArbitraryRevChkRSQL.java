...
*@FileName : TransferOrderIssueDBDAOSearchArbitraryRevChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOSearchArbitraryRevChkRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TransferOrderIssueDBDAOSearchArbitraryRevChk
	  * </pre>
	  */
	public TransferOrderIssueDBDAOSearchArbitraryRevChkRSQL(){
		setQuery();
		...
		query.append("FileName : TransferOrderIssueDBDAOSearchArbitraryRevChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
