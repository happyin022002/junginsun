...
*@FileName : Kor24ManifestListDBDAOSearchManifestCrsChkInfoKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchManifestCrsChkInfoKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchManifestCrsChkInfoKorRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchManifestCrsChkInfoKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("AND 0 = ( SELECT COUNT(*) FROM BKG_CSTMS_ADV_KR_XPT_LIC AA" ).append("\n");
		...
		query.append("A.PCK_QTY," ).append("\n");
		query.append("A.PCK_TP_CD      ," ).append("\n");
		query.append("A.CNTR_TTL_WGT   ," ).append("\n");
		query.append("A.WGT_UT_CD      ," ).append("\n");
		query.append("A.MEAS_QTY       ," ).append("\n");
		...
		query.append("FROM BKG_CSTMS_ADV_KR_BL A, BKG_CSTMS_ADV_KR_XPT_LIC LIC" ).append("\n");
		...
		query.append("FROM BKG_CSTMS_ADV_KR_BL BB" ).append("\n");
		...
		query.append("AND ( NVL(A.PCK_QTY,0) <> NVL(B.PCK_QTY,1) OR NVL(A.PCK_TP_CD,' ') <> NVL(B.PCK_TP_CD,'A')" ).append("\n");
		query.append("OR  NVL(A.ACT_WGT,0) <> NVL(B.CNTR_TTL_WGT,1) --OR NVL(A.WGT_UT_CD,' ') <> NVL(B.WGT_UT_CD,'A')" ).append("\n");
		...
		query.append("END)" ).append("\n");
		query.append("FROM BKG_XPT_IMP_LIC BB, BKG_CSTMS_ADV_KR_XPT_LIC AA" ).append("\n");
		query.append("WHERE BB.BKG_NO = A.BKG_NO" ).append("\n");
