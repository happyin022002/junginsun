...
*@FileName       : EsmSqm0040ViewAdapter.java
 ...
 * @since SQM USER
 */
public class EsmSqm0040ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			sbufXML.append("	<TD"  + color + ">" + getNull(colValues.get("dir_cd")) + "</TD>");
			...
			sbufXML.append("	<TD"  + color + ">" + getNull(colValues.get("gid_lod_potn_rto")) + "</TD>");
			sbufXML.append("	<TD"  + color + ">" + getNull(colValues.get("lod_potn_rto")) + "</TD>");
			sbufXML.append("	<TD"  + color + ">" + getNull(colValues.get("gid_rev_potn_rto")) + "</TD>");
			sbufXML.append("	<TD"  + color + ">" + getNull(colValues.get("rev_potn_rto")) + "</TD>");
