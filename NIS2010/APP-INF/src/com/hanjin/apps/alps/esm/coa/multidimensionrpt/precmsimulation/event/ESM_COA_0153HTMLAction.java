...
*@FileName : ESM_COA_0153HTMLAction.java
...
import com.hanjin.apps.alps.esm.coa.multidimensionrpt.precmsimulation.vo.PreCMSimulationRoutVO;
...
public class ESM_COA_0153HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0153HTMLAction 객체를 생성
	 */
	public ESM_COA_0153HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0153Event event = new EsmCoa0153Event();
