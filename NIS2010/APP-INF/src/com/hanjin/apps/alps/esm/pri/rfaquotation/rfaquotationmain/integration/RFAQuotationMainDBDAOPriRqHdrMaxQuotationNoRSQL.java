...
*@FileName : RFAQuotationMainDBDAOPriRqHdrMaxQuotationNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAQuotationMainDBDAOPriRqHdrMaxQuotationNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAOPriRqHdrMaxQuotationNoRSQL(){
		setQuery();
		...
		query.append("FileName : RFAQuotationMainDBDAOPriRqHdrMaxQuotationNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  (SUBSTR(@[qttn_ofc_cd],0,3) || SUBSTR(TO_CHAR(SYSDATE,'YYYYMMDD'),3,2) || 'R' ||" ).append("\n"); 
		...
		query.append("FROM    PRI_RQ_HDR" ).append("\n"); 
