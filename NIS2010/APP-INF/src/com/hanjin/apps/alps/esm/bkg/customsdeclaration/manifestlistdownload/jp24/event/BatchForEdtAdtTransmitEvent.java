...
public class BatchForEdtAdtTransmitEvent extends EventSupport {

	private static final long serialVersionUID = 1L;

	/** Table Value Object 조회 조건 및 단건 처리  */
	private DepartureTimeVO[] departureTimeVOs = null;


	public BatchForEdtAdtTransmitEvent() {}

	
	public DepartureTimeVO[] getDepartureTimeVOs() {
		return departureTimeVOs;
	}

	public void setDepartureTimeVOs(DepartureTimeVO[] departureTimeVOs) {
		this.departureTimeVOs = departureTimeVOs;
	}
