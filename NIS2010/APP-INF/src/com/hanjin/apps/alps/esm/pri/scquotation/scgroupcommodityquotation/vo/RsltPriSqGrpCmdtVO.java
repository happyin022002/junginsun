...
*@FileName : RsltPriSqGrpCmdtVO.java
*@FileTitle : RsltPriSqGrpCmdtVO
*Open Issues :
*Change history :
...
public class RsltPriSqGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqGrpCmdtVO> models = new ArrayList<RsltPriSqGrpCmdtVO>();
	...
	public RsltPriSqGrpCmdtVO() {}

	public RsltPriSqGrpCmdtVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriSqGrpCmdtVO[]
	 */
	public RsltPriSqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqGrpCmdtVO[]
	 */
	public RsltPriSqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqGrpCmdtVO model = null;
	 ...
	 * @return RsltPriSqGrpCmdtVO[]
	 */
	public RsltPriSqGrpCmdtVO[] getRsltPriSqGrpCmdtVOs(){
		RsltPriSqGrpCmdtVO[] vos = (RsltPriSqGrpCmdtVO[])models.toArray(new RsltPriSqGrpCmdtVO[models.size()]);
		return vos;
	}
