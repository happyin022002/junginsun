 ...
 * 1.0 최초 생성
 * 
 * Change history : 2008.02.18 ESM_MAS_132번 화면 source 삭제
...
*  2010.02.12 임옥영 : Line No. 91 :  : shall be matched with type of parameter(MasCntrRepoShtgInfoVO[] vs MasCntrRepoRuleVO[])
 * 2010.02.19 임옥영 소스품질검토 결과 반영 Line No. 92 :  : shall be matched with name of parameter(masCntrRepoShtgInfoVO  vs masCntrRepoRuleVO)
...
/**
 * ALPS-MAS Business Logic Command Interface<br> - ALPS-MAS에 대한 비지니스 로직에 대한 인터페이스<br>
 * 
 * @author Sangwook_Nam
 * @see 
 * @since J2EE 1.6
