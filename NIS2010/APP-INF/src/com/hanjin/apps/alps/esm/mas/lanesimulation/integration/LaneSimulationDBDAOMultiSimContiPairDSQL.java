...
*@FileName : LaneSimulationDBDAOMultiSimContiPairDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiSimContiPairDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * multiSimContiPair 삭제
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiSimContiPairDSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiSimContiPairDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE from mas_sim_dtl_rev_lane" ).append("\n"); 
