...
*@FileName : ACMCommonDBDAOGetAROfficeByRhqLevelLowListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMCommonDBDAOGetAROfficeByRhqLevelLowListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCommonDBDAOGetAROfficeByRhqLevelLowListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMCommonDBDAOGetAROfficeByRhqLevelLowListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                          WHERE USR_ID = @[value0]" ).append("\n"); 
		...
		query.append("                               FROM ACM_OFC_INFO" ).append("\n"); 
		query.append("                              WHERE (SELECT OFC_CD " ).append("\n"); 
		query.append("                                       FROM COM_USER" ).append("\n"); 
		query.append("                                      WHERE USR_ID = @[value0]" ).append("\n"); 
		query.append("                                        AND NVL(USE_FLG, 'Y') = 'Y') IN (OFC_CD,AGN_CD)" ).append("\n"); 
