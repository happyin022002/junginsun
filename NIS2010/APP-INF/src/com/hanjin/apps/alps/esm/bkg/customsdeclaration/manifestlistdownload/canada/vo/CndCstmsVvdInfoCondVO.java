...
public class CndCstmsVvdInfoCondVO extends CstmsVvdInfoCondVO {
    ...
    /* Column Info */
    private String sVpsEtdDt = null;

    /* Column Info */
    private String eVpsEtdDt = null;
    ...
    public CndCstmsVvdInfoCondVO(String ibflag, String pagerows, String eVpsEtaDt, String sVpsEtaDt, String vvdCd, String cvyRefNo, String slanCd, String vpsPortCd, String crrCd, String sVpsEtdDt, String eVpsEtdDt) {
        ...
        this.sVpsEtdDt = sVpsEtdDt;
        this.eVpsEtdDt = eVpsEtdDt;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("s_vps_etd_dt", getSVpsEtdDt());
        this.hashColumns.put("e_vps_etd_dt", getEVpsEtdDt());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("s_vps_etd_dt", "sVpsEtdDt");
        this.hashFields.put("e_vps_etd_dt", "eVpsEtdDt");
    ...
    public void setSVpsEtdDt(String sVpsEtdDt) {
        this.sVpsEtdDt = sVpsEtdDt;
    }

    public String getSVpsEtdDt() {
        return this.sVpsEtdDt;
    }

    public void setEVpsEtdDt(String eVpsEtdDt) {
        this.eVpsEtdDt = eVpsEtdDt;
    }

    public String getEVpsEtdDt() {
        return this.eVpsEtdDt;
    }

    public void fromRequest(HttpServletRequest request) {
        setSVpsEtaDt(JSPUtil.getParameter(request, "s_vps_eta_dt", ""));
        setEVpsEtaDt(JSPUtil.getParameter(request, "e_vps_eta_dt", ""));
        setSVpsEtdDt(JSPUtil.getParameter(request, "s_vps_etd_dt", ""));
        setEVpsEtdDt(JSPUtil.getParameter(request, "e_vps_etd_dt", ""));
    ...
    public CndCstmsVvdInfoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] sVpsEtdDt = (JSPUtil.getParameter(request, prefix + "s_vps_etd_dt", length));
	    	String[] eVpsEtdDt = (JSPUtil.getParameter(request, prefix + "e_vps_etd_dt", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (sVpsEtdDt[i] != null) 
		    		model.setSVpsEtdDt(sVpsEtdDt[i]);
				if (eVpsEtdDt[i] != null) 
		    		model.setEVpsEtdDt(eVpsEtdDt[i]);
	...
	*/
    public void onDataFormat() {
        ...
        this.sVpsEtdDt = this.sVpsEtaDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.eVpsEtdDt = this.eVpsEtaDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
