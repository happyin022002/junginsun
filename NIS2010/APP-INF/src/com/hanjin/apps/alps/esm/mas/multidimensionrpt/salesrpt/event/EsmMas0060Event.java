...
*@FileName : EsmMas0060Event.java
*@FileTitle : EsmMas0060Event
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0060 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0060HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Ki Dae
 * @see ESM_MAS_0060HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0060Event extends EventSupport {
	...
	/** Constructor */
	public EsmMas0060Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmMas0060Event";
	}
