 ...
 *@FileName : ESM_PRI_7033HTMLAction.java
...
public class ESM_PRI_7033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_7033HTMLAction 객체를 생성
	 */
	public ESM_PRI_7033HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7033Event event = new EsmPri7033Event();
