...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntActVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntActVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ALL ACCEPT 시 ACCEPT할 데이터가 존재하는지 조회한다.
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntActVORSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntActVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
