...
*@FileName : Kor24ManifestListDBDAOSearchCustInfoCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchCustInfoCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchCustInfoCheckRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchCustInfoCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
