...
*@FileName : UnmatchBLDBDAOBkgRevUmchBkgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOBkgRevUmchBkgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UnmatchBLDBDAOBkgRevUmchBkgVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.nis2010.esm.bkg.revenueaudit.unmatchbl.integration").append("\n"); 
		query.append("FileName : UnmatchBLDBDAOBkgRevUmchBkgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}