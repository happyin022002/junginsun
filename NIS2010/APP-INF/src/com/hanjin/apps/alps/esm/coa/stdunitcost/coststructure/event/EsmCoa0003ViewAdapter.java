...
* [TMO][COA/TRS] 구주 HJL 운송 Commission Fee 추정로직 변경
=========================================================*/
    	...
    	try{
			...
			if(rowSet != null){
				while (rowSet.next()) {		
					...
					strBuilder.append("\n<TD><![CDATA["+JSPUtil.getNull(rowSet.getString("coa_cost_src_prt_cd"))+"]]></TD>");
					strBuilder.append("\n<TD><![CDATA["+JSPUtil.getNull(rowSet.getString("cost_src_sys_cd"))+"]]></TD>");
					strBuilder.append("\n<TD><![CDATA["+JSPUtil.getNull(rowSet.getString("cost_src_mon"))+"]]></TD>");
					strBuilder.append("\n<TD><![CDATA["+JSPUtil.getNull(rowSet.getString("coa_cost_src_cd"))+"]]></TD>");
					strBuilder.append("\n<TD><![CDATA["+JSPUtil.getNull(rowSet.getString("coa_cost_src_cd_nm"))+"]]></TD>");
