...
public class DubaiManifestListDownloadDBDAOaddBkgCstmsDuBlCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            ,MK_NO_CTNT" ).append("\n"); 
		query.append("            ,DU_CMDT_CD" ).append("\n"); 
		query.append("            ,CASE WHEN NVL(INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 5), 0) = 0 THEN SUBSTR(CMDT_DESC, 1, 100)" ).append("\n"); 
		query.append("                  WHEN LENGTH(SUBSTR(CMDT_DESC, 1, INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 5))) > 100" ).append("\n"); 
		query.append("                       THEN SUBSTR(CMDT_DESC, 1, INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 4)-1) " ).append("\n"); 
		query.append("                  WHEN LENGTH(SUBSTR(CMDT_DESC, 1, INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 4))) > 100" ).append("\n"); 
		query.append("                       THEN SUBSTR(CMDT_DESC, 1, INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 3)-1) " ).append("\n"); 
		query.append("                  WHEN LENGTH(SUBSTR(CMDT_DESC, 1, INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 3))) > 100" ).append("\n"); 
		query.append("                       THEN SUBSTR(CMDT_DESC, 1, INSTR(CMDT_DESC, CHR(13)||CHR(10), 1, 2)-1) " ).append("\n"); 
