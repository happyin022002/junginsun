...
public class KorManifestListDBDAOsearchVVDInfoKorRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("TO_CHAR(KV.ETD_DT, 'YYYY-MM-DD HH24MI') ETD_DT, /** ETD **/ " ).append("\n"); 
		...
		query.append("'SMLM' SHP_CO_CD, /** Shipping Co. Code **/ " ).append("\n"); 
		query.append("DECODE(KV.LOCL_CSTMS_CD,NULL,DECODE(KV.PORT_CD,'KRINC','020','KRGIN', '020', 'KRPUS', '030', 'KRKAN', '062','KRPTK','016','KRUSN','110'),KV.LOCL_CSTMS_CD) LOCL_CSTMS_CD, /** Local Customs **/ " ).append("\n"); 
		query.append("DECODE(KV.LOCL_CSTMS_PRT_CD,NULL,DECODE(KV.PORT_CD,'KRINC','10','KRGIN','10','KRPUS', DECODE(KV.IO_BND_CD,'I', '27','10'), 'KRKAN', '10','KRPTK','10','KRUSN','10'),KV.LOCL_CSTMS_PRT_CD) LOCL_CSTMS_PRT_CD, /** Local Customs **/ " ).append("\n"); 
		...
		query.append("DECODE(KV.CSTMS_DCHG_CD, NULL, DECODE(KV.PORT_CD,'KRPUS','030197004','KRKAN','062112001','KRINC','020116001','KRPTK','016105001','KRUSN','110109004','KRGIN','020112001','030197004'), KV.CSTMS_DCHG_CD) CSTMS_DCHG_CD, /** Discharge Company **/        " ).append("\n"); 
		...
		query.append("DECODE(KV.PORT_CD,'KRPUS', 20, 'KRGIN', 50,'KRINC',30,'KRKAN',622,'KRPTK',31,'KRUSN',820,0) KT_PA, /** kt_pa **/ " ).append("\n"); 
