...
*@FileName : SPCManageDBDAOAddmultiBsaVvdPortDwnCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPCManageDBDAOAddmultiBsaVvdPortDwnCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Step Up/Down by VVD  Detail 저장 쿼리
	  * </pre>
	  */
	public SPCManageDBDAOAddmultiBsaVvdPortDwnCSQL(){
		setQuery();
		...
		query.append("FileName : SPCManageDBDAOAddmultiBsaVvdPortDwnCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
