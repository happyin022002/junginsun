...
*@FileName : Eur24ManifestDownloadDBDAORemoveBlDangerousCntrOBDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBlDangerousCntrOBDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_CSTMS_EUR_DG_CGO delete
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBlDangerousCntrOBDSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBlDangerousCntrOBDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_EUR_IO_DG_CGO" ).append("\n"); 
