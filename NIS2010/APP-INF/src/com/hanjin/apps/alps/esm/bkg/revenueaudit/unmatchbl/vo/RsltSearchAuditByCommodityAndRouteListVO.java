...
*@FileName : RsltSearchAuditByCommodityAndRouteListVO.java
*@FileTitle : RsltSearchAuditByCommodityAndRouteListVO
*Open Issues :
*Change history :
...
public class RsltSearchAuditByCommodityAndRouteListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltSearchAuditByCommodityAndRouteListVO> models = new ArrayList<RsltSearchAuditByCommodityAndRouteListVO>();
...
/**
	 ...
	 */
	public RsltSearchAuditByCommodityAndRouteListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltSearchAuditByCommodityAndRouteListVO[]
	 */
	public RsltSearchAuditByCommodityAndRouteListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltSearchAuditByCommodityAndRouteListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltSearchAuditByCommodityAndRouteListVO();
				if (rtAplyDt[i] != null)
		...
		return getRsltSearchAuditByCommodityAndRouteListVOs();
	}
	 ...
	 * @return RsltSearchAuditByCommodityAndRouteListVO[]
	 */
	public RsltSearchAuditByCommodityAndRouteListVO[] getRsltSearchAuditByCommodityAndRouteListVOs(){
		RsltSearchAuditByCommodityAndRouteListVO[] vos = (RsltSearchAuditByCommodityAndRouteListVO[])models.toArray(new RsltSearchAuditByCommodityAndRouteListVO[models.size()]);
		return vos;
	}
