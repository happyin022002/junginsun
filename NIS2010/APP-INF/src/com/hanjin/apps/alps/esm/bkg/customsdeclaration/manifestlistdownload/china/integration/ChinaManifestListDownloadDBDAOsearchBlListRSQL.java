...
public class ChinaManifestListDownloadDBDAOsearchBlListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("VVD.SKD_DIR_CD||CHR(9)||" ).append("\n"); 
		...
		query.append("AND VVD.VSL_PRE_PST_CD||VSL_SEQ = (SELECT MAX(VSL_PRE_PST_CD||VSL_SEQ) FROM BKG_VVD" ).append("\n"); 
		...
		query.append("RPAD(REPLACE(REPLACE(NVL(BCD.CSTMS_DESC,' '),CHR(13)||CHR(10),' '),CHR(9),' '),256)||CHR(9)||" ).append("\n"); 
		...
		query.append("NVL(BCD.MEAS_QTY,0)||CHR(9)||" ).append("\n"); 
		query.append("NVL(BCD.MEAS_UT_CD,' ')||CHR(9)||" ).append("\n"); 
		...
		query.append("DECODE(B.DEL_NOD_CD,'CNJXGM1',B.DEL_NOD_CD,VVD.POD_YD_CD)) BL_NO" ).append("\n"); 
