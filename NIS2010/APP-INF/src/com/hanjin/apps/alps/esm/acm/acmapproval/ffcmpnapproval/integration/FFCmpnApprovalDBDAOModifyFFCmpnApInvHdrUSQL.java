...
*@FileName : FFCmpnApprovalDBDAOModifyFFCmpnApInvHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCmpnApprovalDBDAOModifyFFCmpnApInvHdrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyFFCmpnApInvHdr
	  * </pre>
	  */
	public FFCmpnApprovalDBDAOModifyFFCmpnApInvHdrUSQL(){
		setQuery();
		...
		query.append("FileName : FFCmpnApprovalDBDAOModifyFFCmpnApInvHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
