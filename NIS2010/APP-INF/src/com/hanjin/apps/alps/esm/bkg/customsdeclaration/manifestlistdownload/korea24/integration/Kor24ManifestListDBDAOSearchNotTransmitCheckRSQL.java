...
*@FileName : Kor24ManifestListDBDAOSearchNotTransmitCheckRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchNotTransmitCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG별 전송되지 않은 데이터 Count를 구한다.
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchNotTransmitCheckRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchNotTransmitCheckRSQL").append("\n");
		query.append("*/").append("\n");
	}
