...
*@FileName : SpacecontrolinquiryDBDAOSearchSpaceControlInquiry058QtyListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAOSearchSpaceControlInquiry058QtyListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAOSearchSpaceControlInquiry058QtyListVORSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAOSearchSpaceControlInquiry058QtyListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    SELECT @[lane] 	AS RLANE_CD  , -- argument값" ).append("\n"); 
		query.append("           @[vsl_cd]    	AS VSL_CD    , -- argument값" ).append("\n"); 
		query.append("           @[skd_voy_no]    AS SKD_VOY_NO, -- argument값" ).append("\n"); 
		query.append("           @[skd_dir_cd]    AS SKD_DIR_CD, -- argument값" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", POL_PORT_SEQ AS (" ).append("\n"); 
		query.append("SELECT DISTINCT P.BASE_VVD," ).append("\n"); 
		query.append("       C1.SEQ AS SRC," ).append("\n"); 
		query.append("       C2.SEQ AS IOC_SEQ," ).append("\n"); 
		query.append("       DECODE(C2.SEQ, 1, 'OCN', 2, 'IPC', 3, 'T/S', 4, 'MT', 5, 'TOTAL') AS IOC_CD," ).append("\n"); 
		query.append("       P.YD_CD    AS POL_CD," ).append("\n"); 
		query.append("       P.CLPT_SEQ AS POL_SEQ," ).append("\n"); 
		query.append("       P.BSA" ).append("\n"); 
		query.append("  FROM CUR_PORTS P ," ).append("\n"); 
		query.append("       COPY C1," ).append("\n"); 
		query.append("       COPY C2" ).append("\n"); 
		...
		query.append("                       POL.IOC_CD," ).append("\n"); 
		...
		query.append("                  FROM POL_PORT_SEQ POL ," ).append("\n"); 
		...
		query.append("                                                 --WHERE A.SRC = 1 --TEST" ).append("\n"); 
		query.append("                                                 " ).append("\n"); 
		query.append("                                             ) Z," ).append("\n"); 
		...
		query.append("                                             " ).append("\n"); 
		query.append("                                   ) Z" ).append("\n"); 
		query.append("                             --WHERE SRC = 1" ).append("\n"); 
		query.append("                             " ).append("\n"); 
		query.append("                         ) Z," ).append("\n"); 
		...
		query.append(" ORDER BY P.SRC , P.POL_SEQ, P.IOC_SEQ , P.POD_SEQ" ).append("\n"); 
