...
*@FileName : RFARateQuotationDBDAORsltCmpbViewAllListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltCmpbViewAllListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltCmpbViewAllListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltCmpbViewAllListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT RT.QTTN_NO,RT.QTTN_VER_NO,RT.CMDT_HDR_SEQ,RT.ROUT_SEQ,RT.RT_SEQ" ).append("\n"); 
		...
		query.append("FROM PRI_RQ_RT RT" ).append("\n"); 
		query.append(", VW_PRI_RQ_RT_CMDT C" ).append("\n"); 
		query.append(", VW_PRI_RQ_RT_ROUT_PNT_ORI OP" ).append("\n"); 
		query.append(", VW_PRI_RQ_RT_ROUT_PNT_DEST DP" ).append("\n"); 
		query.append(", VW_PRI_RQ_RT_ROUT_VIA_ORI OV" ).append("\n"); 
		query.append(", VW_PRI_RQ_RT_ROUT_VIA_DEST DV" ).append("\n"); 
		query.append(", PRI_RQ_RT_CMDT D" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("ORDER BY RT_SEQ, N1ST_ORD_REF, N2ND_ORD_REF, RT_SEQ" ).append("\n"); 
