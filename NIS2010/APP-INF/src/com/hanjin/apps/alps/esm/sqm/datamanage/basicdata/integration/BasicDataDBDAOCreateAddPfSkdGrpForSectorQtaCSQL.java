...
public class BasicDataDBDAOCreateAddPfSkdGrpForSectorQtaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * --데이터 가져올때 주차가 아니라 월을 기준으로 가져오도록 수정
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("--                          AND A2.COST_WK      BETWEEN  AND  --월기준으로 변경" ).append("\n"); 
		query.append("                          AND SUBSTR(A2.COST_YRMON, 5) BETWEEN (CASE WHEN @[f_bse_qtr_cd] = '1Q' THEN '01' WHEN @[f_bse_qtr_cd] = '2Q' THEN '04' WHEN @[f_bse_qtr_cd] = '3Q' THEN '07' WHEN @[f_bse_qtr_cd] = '4Q' THEN '10' ELSE '01' END) " ).append("\n"); 
		...
		query.append("--   ,SQM_SCTR_PF_GRP C2" ).append("\n"); 
		query.append("    ,(SELECT DISTINCT " ).append("\n"); 
		query.append("            BSE_TP_CD" ).append("\n"); 
		query.append("           ,BSE_YR" ).append("\n"); 
		query.append("           ,BSE_QTR_CD" ).append("\n"); 
