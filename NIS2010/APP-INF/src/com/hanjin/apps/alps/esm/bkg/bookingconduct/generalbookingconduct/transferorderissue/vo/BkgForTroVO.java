...
*@FileName : BkgForTroVO.java
*@FileTitle : BkgForTroVO
*Open Issues :
*Change history :
...
public class BkgForTroVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgForTroVO> models = new ArrayList<BkgForTroVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("spcl_hide_flg", getFdGrdFlg());
...
/**
	 ...
	 * @return BkgForTroVO[]
	 */
	public BkgForTroVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgForTroVO[]
	 */
	public BkgForTroVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgForTroVO model = null;
		...
		try {
			...
			String[] spclHideFlg = (JSPUtil.getParameter(request, prefix	+ "spcl_hide_flgs", length));
	 ...
	 * @return BkgForTroVO[]
	 */
	public BkgForTroVO[] getBkgForTroVOs(){
		BkgForTroVO[] vos = (BkgForTroVO[])models.toArray(new BkgForTroVO[models.size()]);
		return vos;
	}
