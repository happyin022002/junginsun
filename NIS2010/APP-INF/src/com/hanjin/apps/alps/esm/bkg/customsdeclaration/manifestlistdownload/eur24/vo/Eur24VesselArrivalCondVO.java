...
public class Eur24VesselArrivalCondVO extends VesselArrivalCondVO {
	...
	/* Column Info */
	private String cstmsPortClptIndSeq = null;
	...
	public Eur24VesselArrivalCondVO(String ibflag, String pagerows, String chkAll, String pAckStatus, String eurEdiMsgTpId, String ediRcvDt, String vvd, String cstmsYdCd, String cntrNo, String ediRcvSeq, String cvyRefNo, String blNo, String cstmsPortCd, String formBlNo, String cstmsPortClptIndSeq) {
		...
		this.cstmsPortClptIndSeq = cstmsPortClptIndSeq;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cstms_port_clpt_ind_seq", getCstmsPortClptIndSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cstms_port_clpt_ind_seq", "cstmsPortClptIndSeq");
	...
	/**
	 * Column Info
	 * @return cstmsPortClptIndSeq
	 */
	public String getCstmsPortClptIndSeq() {
		return this.cstmsPortClptIndSeq;
	}
	...
	/**
	 * Column Info
	 * @param cstmsPortClptIndSeq
	 */
	public void setCstmsPortClptIndSeq(String cstmsPortClptIndSeq) {
		this.cstmsPortClptIndSeq = cstmsPortClptIndSeq;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCstmsPortClptIndSeq(JSPUtil.getParameter(request, prefix + "cstms_port_clpt_ind_seq", ""));
	}
	...
	public Eur24VesselArrivalCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cstmsPortClptIndSeq = (JSPUtil.getParameter(request, prefix	+ "cstms_port_clpt_ind_seq", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (cstmsPortClptIndSeq[i] != null)
					model.setCstmsPortClptIndSeq(cstmsPortClptIndSeq[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.cstmsPortClptIndSeq = this.cstmsPortClptIndSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
