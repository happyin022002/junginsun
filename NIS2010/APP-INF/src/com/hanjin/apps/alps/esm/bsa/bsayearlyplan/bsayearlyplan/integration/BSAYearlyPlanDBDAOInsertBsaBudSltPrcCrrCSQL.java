...
*@FileName : BSAYearlyPlanDBDAOInsertBsaBudSltPrcCrrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOInsertBsaBudSltPrcCrrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSA_BUD_SLT_PRC_CRR 데이타를 입력한다.
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOInsertBsaBudSltPrcCrrCSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOInsertBsaBudSltPrcCrrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BSA_BUD_SLT_PRC_CRR (" ).append("\n"); 
		...
		query.append("         B.SLT_PRC_CAPA      ," ).append("\n"); 
		query.append("         @[cre_usr_id]       ," ).append("\n"); 
		query.append("         SYSDATE             ," ).append("\n"); 
		query.append("         @[upd_usr_id]       ," ).append("\n"); 
		query.append("         SYSDATE" ).append("\n"); 
		query.append("    FROM BSA_BUD_SLT_PRC A," ).append("\n"); 
