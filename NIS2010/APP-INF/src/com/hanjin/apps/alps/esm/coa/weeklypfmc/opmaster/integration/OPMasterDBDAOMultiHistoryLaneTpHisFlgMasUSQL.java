...
*@FileName : OPMasterDBDAOMultiHistoryLaneTpHisFlgMasUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistoryLaneTpHisFlgMasUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistoryLaneTpHisFlgMasUSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistoryLaneTpHisFlgMasUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_LANE_RGST A SET " ).append("\n"); 
