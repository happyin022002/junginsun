...
*@FileName : SearchApSlipInterfaceVO.java
*@FileTitle : SearchApSlipInterfaceVO
*Open Issues :
*Change history :
...
public class SearchApSlipInterfaceVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchApSlipInterfaceVO> models = new ArrayList<SearchApSlipInterfaceVO>();
	...
	public SearchApSlipInterfaceVO() {}

	public SearchApSlipInterfaceVO(String ibflag, String pagerows, String csrUsrId, String slpOfcCd, String usrEml, String usrNm) {
		this.ibflag = ibflag;
		this.usrNm = usrNm;
		this.usrEml = usrEml;
...
/**
	 ...
	 * @param request
	 * @return SearchApSlipInterfaceVO[]
	 */
	public SearchApSlipInterfaceVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchApSlipInterfaceVO[]
	 */
	public SearchApSlipInterfaceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchApSlipInterfaceVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchApSlipInterfaceVO();
				if (ibflag[i] != null)
		...
		return getSearchApSlipInterfaceVOs();
	}
	 ...
	 * @return SearchApSlipInterfaceVO[]
	 */
	public SearchApSlipInterfaceVO[] getSearchApSlipInterfaceVOs(){
		SearchApSlipInterfaceVO[] vos = (SearchApSlipInterfaceVO[])models.toArray(new SearchApSlipInterfaceVO[models.size()]);
		return vos;
	}
