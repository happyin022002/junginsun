...
public class FullCostDBDAOSearchMonthNodeCostListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *  MAS_NOD_AVG_STND_COST 테이블의 데이터 조회 (Empty)
	  * History------------------------------------
	...
	public void setQuery(){
		...
		query.append("           FROM MAS_COST_SRC_ACCT B, MAS_STND_ACCT C           " ).append("\n"); 
		...
		query.append("  WHERE M.MAS_COST_SRC_CD = K.MAS_COST_SRC_CD           " ).append("\n"); 
		query.append("GROUP BY M.STND_COST_CD, CUBE(K.MAS_COST_SRC_CD), K.LOCL_CURR_CD" ).append("\n"); 
