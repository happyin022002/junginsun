...
*@FileName : ScqBreakbulkDBDAOsearchPriScqBbNewRqstNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqBreakbulkDBDAOsearchPriScqBbNewRqstNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchPriScqBbNewRqstNo
	  * </pre>
	  */
	public ScqBreakbulkDBDAOsearchPriScqBbNewRqstNoRSQL(){
		setQuery();
		...
		query.append("FileName : ScqBreakbulkDBDAOsearchPriScqBbNewRqstNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE SUBSTR(SCQ_RQST_NO,1,11) = SUBSTR(@[rqst_ofc_cd],1,3)||TO_CHAR(SYSDATE,'YYYYMMDD')" ).append("\n"); 
