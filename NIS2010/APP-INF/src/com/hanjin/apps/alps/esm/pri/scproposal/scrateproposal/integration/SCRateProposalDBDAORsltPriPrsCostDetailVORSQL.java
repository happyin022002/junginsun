...
*@FileName : SCRateProposalDBDAORsltPriPrsCostDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriPrsCostDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriPrsCostDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriPrsCostDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* prop_no,amdt_seq,svc_scp_cd,gen_spcl_rt_tp_cd,cmdt_hdr_seq,rout_seq,rt_seq, rout_cs_no,rout_cs_src_dt,cost_tp  파라메터 추가*/" ).append("\n"); 
		query.append("" ).append("\n"); 
