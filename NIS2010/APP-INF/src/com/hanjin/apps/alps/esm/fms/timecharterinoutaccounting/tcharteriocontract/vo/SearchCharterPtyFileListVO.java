...
*@FileName : SearchCharterPtyFileListVO.java
*@FileTitle : SearchCharterPtyFileListVO
*Open Issues :
*Change history :
...
public class SearchCharterPtyFileListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCharterPtyFileListVO> models = new ArrayList<SearchCharterPtyFileListVO>();
	...
	public SearchCharterPtyFileListVO() {}

	public SearchCharterPtyFileListVO(String ibflag, String pagerows, String fileSeq, String fletFileTpCd, String fileNm, String fileDesc, String fileDownload, String fileSavId, String effDt, String expDt, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFletFileTpCd(JSPUtil.getParameter(request, prefix + "flet_file_tp_cd", ""));
	 ...
	 * @param request
	 * @return SearchCharterPtyFileListVO[]
	 */
	public SearchCharterPtyFileListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCharterPtyFileListVO[]
	 */
	public SearchCharterPtyFileListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCharterPtyFileListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchCharterPtyFileListVO();
				if (updDt[i] != null)
		...
		return getSearchCharterPtyFileListVOs();
	}
	 ...
	 * @return SearchCharterPtyFileListVO[]
	 */
	public SearchCharterPtyFileListVO[] getSearchCharterPtyFileListVOs(){
		SearchCharterPtyFileListVO[] vos = (SearchCharterPtyFileListVO[])models.toArray(new SearchCharterPtyFileListVO[models.size()]);
		return vos;
	}
