...
*@FileName : CostManageDBDAOUpdateBasicCmcbForIasSectorListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostManageDBDAOUpdateBasicCmcbForIasSectorListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Basic CMCB for IAS Sector List를 수정한다.
	  * </pre>
	  */
	public CostManageDBDAOUpdateBasicCmcbForIasSectorListUSQL(){
		setQuery();
		...
		query.append("FileName : CostManageDBDAOUpdateBasicCmcbForIasSectorListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SQM_SCTR_PAIR_COST" ).append("\n"); 
