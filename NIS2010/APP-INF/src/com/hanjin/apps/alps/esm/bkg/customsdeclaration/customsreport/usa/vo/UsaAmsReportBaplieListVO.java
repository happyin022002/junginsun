...
public class UsaAmsReportBaplieListVO extends AmsReportListDetailVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaAmsReportBaplieListVO> models = new ArrayList<UsaAmsReportBaplieListVO>();
	...
	public UsaAmsReportBaplieListVO() {}

	public UsaAmsReportBaplieListVO(String ibflag, String pagerows, String cntrNo, String oprCd, String pol, String pod, String sztp, String fe, String stiPos, String imdg, String unno, String searchVvdCd, String lPol, String sentTime, String oPod, String custResult, String custRspn, String description, String receiveDate, String vvd, String excludeca, String vslEngNm, String vslVoy, String crrCd, String tmp1, String tmp2, String tmp3, String tmp4, String tmp5, String fmInd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cust_rspn", getCustRspn());
		this.hashColumns.put("description", getDescription());
		this.hashColumns.put("receive_date", getReceiveDate());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cust_rspn", "custRspn");
		this.hashFields.put("description", "description");
		this.hashFields.put("receive_date", "receiveDate");
	 ...
	 * @return custRspn
	 */
	public String getCustRspn() {
		return this.custRspn;
	}
	 ...
	 * @param custRspn
	 */
	public void setCustRspn(String custRspn) {
		this.custRspn = custRspn;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCustRspn(JSPUtil.getParameter(request, prefix + "cust_rspn", ""));
		setDescription(JSPUtil.getParameter(request, prefix + "description", ""));
		setReceiveDate(JSPUtil.getParameter(request, prefix + "receive_date", ""));
		...
		setFmInd(JSPUtil.getParameter(request, prefix + "fmInd", ""));		
	 ...
	 * @param request
	 * @return UsaAmsReportBaplieListVO[]
	 */
	public UsaAmsReportBaplieListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaAmsReportBaplieListVO[]
	 */
	public UsaAmsReportBaplieListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaAmsReportBaplieListVO model = null;
		...
		try {
			...
			String[] custRspn = (JSPUtil.getParameter(request, prefix	+ "cust_rspn", length));
			String[] description = (JSPUtil.getParameter(request, prefix	+ "description", length));
			String[] receiveDate = (JSPUtil.getParameter(request, prefix	+ "receive_date", length));
			...
			String[] fmInd = (JSPUtil.getParameter(request, prefix	+ "fmInd", length));			
			
			
			for (int i = 0; i < length; i++) {
				model = new UsaAmsReportBaplieListVO();
				if (excludeca[i] != null)
				...
				if (custRspn[i] != null)
					model.setCustRspn(custRspn[i]);
				if (description[i] != null)
					model.setDescription(description[i]);
				if (receiveDate[i] != null)
					model.setReceiveDate(receiveDate[i]);
				if (tmp2[i] != null)
		...
		return getUsaAmsReportBaplieListVOs();
	}
	 ...
	 */
	public UsaAmsReportBaplieListVO[] getUsaAmsReportBaplieListVOs(){
		UsaAmsReportBaplieListVO[] vos = (UsaAmsReportBaplieListVO[])models.toArray(new UsaAmsReportBaplieListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.custRspn = this.custRspn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.description = this.description .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.receiveDate = this.receiveDate .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
