...
*@FileName : HongKongManifestListCondVO.java
*@FileTitle : HongKongManifestListCondVO
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.5
 */
public class HongKongManifestListCondVO extends ManifestListCondVO{

	private static final long serialVersionUID = 1L;
	
	private Collection<HongKongManifestListCondVO> models = new ArrayList<HongKongManifestListCondVO>();
	...
	public HongKongManifestListCondVO() {}

	public HongKongManifestListCondVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, 
	...
	public HongKongManifestListCondVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public HongKongManifestListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HongKongManifestListCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new HongKongManifestListCondVO();
				if (ibflag[i] != null)
		...
		return getHongKongManifestListCondVOs();
	}

	public HongKongManifestListCondVO[] getHongKongManifestListCondVOs(){
		HongKongManifestListCondVO[] vos = (HongKongManifestListCondVO[])models.toArray(new HongKongManifestListCondVO[models.size()]);
		return vos;
	}
