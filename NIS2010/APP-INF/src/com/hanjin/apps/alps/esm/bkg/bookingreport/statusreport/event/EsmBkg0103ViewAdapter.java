...
*@FileName : EsmBkg0103ViewAdapter.java
 ...
 * @since J2EE 1.6  
 */
public class EsmBkg0103ViewAdapter extends ViewAdapter {
...
//		sbufXML.append("\n<DATA TOTAL='").append(totCnt*2+Integer.parseInt(colValues.get("orderby_cnt"))).append("'>\n");
		sbufXML.append("\n<DATA>\n");
		...
		for(int i=0;i<realCnt;i++){
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rnum")).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[BKG]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("bkg_sts_cd")).append("]]></TD>\n");  //BST
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("non_rt_sts_cd")).append("]]></TD>\n");  //No Rate Status			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("si_flg")).append("]]></TD>\n");      //SR
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pre_contrat")).append("]]></TD>\n");      //Spot guide RFA or Dummy NO
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("now_contrat")).append("]]></TD>\n");      //Current RFA
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("bkg_no")).append("]]></TD>\n");      //Booking No
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("shpr_name")).append("]]></TD>\n");   //Shipper
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("svc_scp_cd")).append("]]></TD>\n");  //SVC Scope			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("bkg_mea_qty")).append("]]></TD>\n"); //MEA
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pck_qty")).append("]]></TD>\n");   //pkg_qty
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pck_tp_cd")).append("]]></TD>\n");   //pkg_qty
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("dcgo_flg")).append("]]></TD>\n");    //DG
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rc_flg")).append("]]></TD>\n");      //RF
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("fd_grd_flg")).append("]]></TD>\n");  //FG
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("stwg_cd")).append("]]></TD>\n");  	//STWG
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("blck_stwg_cd")).append("]]></TD>\n");	//Block STWG			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("itn_flg")).append("]]></TD>\n");      //ITN
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("caed_flg")).append("]]></TD>\n");     //CAED
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("shp_call_no")).append("]]></TD>\n");     ///*CRN No.*/
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("bkg_ofc_cd")).append("]]></TD>\n");   //B.OFC
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("ctrt_ofc_cd")).append("]]></TD>\n");  //O.OFC
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("ob_sls_ofc_cd")).append("]]></TD>\n");//L.OFC
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("ofc_team_cd")).append("]]></TD>\n");	//L.SUB-OFC
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("remark")).append("]]></TD>\n");       //Remark
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("inter_remark")).append("]]></TD>\n");       //Remark
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_inter_remark")).append("]]></TD>\n");       //Remark
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_xter_remark")).append("]]></TD>\n");       //Remark
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rate_chk_sts")).append("]]></TD>\n");//Rate Check Status
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("sc_no")).append("]]></TD>\n");        //S/C No
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("inter_remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_inter_remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_xter_remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("mty_pkup_yd_cd")).append("]]></TD>\n");//MTY_PKUP_YD_CD 			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("etb_dt")).append("]]></TD>\n");//ETB Date			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("sail_dt")).append("]]></TD>\n");//Sailing Date
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rtro_knd_cd_nm")).append("]]></TD>\n");//OFT Change after PCT			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("cost_wk")).append("]]></TD>\n");//REV.WEEK 			
			sbufXML.append("	</TR>\n");
			sbufXML.append("	\n");
			sbufXML.append("	<TR>\n");
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("cnee_name")).append("]]></TD>\n");     //Consignee
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("del_cd")).append("]]></TD>\n");        //DEL
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("commodity")).append("]]></TD>\n");     //Commodity
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("feu")).append("]]></TD>\n");           //FEU
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("svc_scp_cd")).append("]]></TD>\n");  //SVC Scope			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("bkg_actwgt_qty")).append("]]></TD>\n");//WGT(KGS)
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pc")).append("]]></TD>\n");           //PC
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("stwg_cd")).append("]]></TD>\n");  	//STWG
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("blck_stwg_cd")).append("]]></TD>\n"); //BLOCK STWG			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("itn_type")).append("]]></TD>\n");     //ITN Type
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("caed_type")).append("]]></TD>\n");    //CAED Type
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("vsl_eng_nm")).append("]]></TD>\n");    //Vessel_name
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("doc_usr_id")).append("]]></TD>\n");   //BKG STF
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("ctrt_srep_cd")).append("]]></TD>\n"); //C.SREP
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_xter_remark")).append("]]></TD>\n");       //Remark
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rate_chk_sts")).append("]]></TD>\n");//Rate Check Status
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rfa_no")).append("]]></TD>\n");       //RFA NO
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("inter_remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_inter_remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("chg_xter_remark_detail")).append("]]></TD>\n");//Remark Hidden
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("mty_pkup_dt")).append("]]></TD>\n");//MTY_PKUP_DT			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("etb_dt")).append("]]></TD>\n");//ETB Date			
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("sail_dt")).append("]]></TD>\n");//Sailing Date
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rtro_knd_cd_nm")).append("]]></TD>\n");//OFT Change after PCT
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("cost_wk")).append("]]></TD>\n");//REV.WEEK			

			sbufXML.append("		<TD><![CDATA[").append(colValues.get("act_cust_code")).append("]]></TD>\n");       //RFA NO
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("act_cust_name")).append("]]></TD>\n");//Remark Hidden
		...
		//sbufXML.append("<ETC KEY='orderby_cnt'><![CDATA[").append(orderbyCnt).append("]]></ETC>");
