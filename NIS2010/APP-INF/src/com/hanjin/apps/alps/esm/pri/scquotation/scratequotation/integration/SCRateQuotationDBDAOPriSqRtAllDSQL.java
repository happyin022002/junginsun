...
*@FileName : SCRateQuotationDBDAOPriSqRtAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
