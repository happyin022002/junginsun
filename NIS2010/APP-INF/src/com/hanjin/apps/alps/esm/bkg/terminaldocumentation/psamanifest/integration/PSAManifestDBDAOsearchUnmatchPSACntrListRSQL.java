...
*@FileName : PSAManifestDBDAOsearchUnmatchPSACntrListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSAManifestDBDAOsearchUnmatchPSACntrListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSAManifestDBDAOsearchUnmatchPSACntrListRSQL(){
		setQuery();
		...
		query.append("FileName : PSAManifestDBDAOsearchUnmatchPSACntrListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", SUBSTR(PSA_CNTR_TPSZ_CD,1,2) CNTR_TP_CD" ).append("\n"); 
		...
		query.append(", SPCL_CGO_DTL_CTNT SPECIAL" ).append("\n"); 
