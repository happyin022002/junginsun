...
*@FileName : PerformanceReportDBDAOsearchEBkgSiPfmcListByBkgOfcRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOsearchEBkgSiPfmcListByBkgOfcRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOsearchEBkgSiPfmcListByBkgOfcRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOsearchEBkgSiPfmcListByBkgOfcRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--1.Case1 => Kind of Report = Booking Office, Kind of Report = Month" ).append("\n"); 
		query.append("--REPORT_TYPE:B, DURATION: M,W,D" ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${report_type} == 'BR') " ).append("\n"); 
		query.append("--********************************************************************************************" ).append("\n"); 
		query.append("--Month,WEEK" ).append("\n"); 
		query.append("--********************************************************************************************" ).append("\n"); 
		query.append("SELECT	SUB.*" ).append("\n"); 
		query.append("	,CASE WHEN (SI_TTL - ( BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + BL_WEB_SWB )) > 0 " ).append("\n"); 
		query.append("			THEN (SI_TTL - (BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + BL_WEB_SWB ))" ).append("\n"); 
		query.append("		 ELSE 0 END BL_PENDING" ).append("\n"); 
		query.append("	,ROUND(((BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL+BL_WEB_SWB ) " ).append("\n"); 
		query.append("		/ DECODE((BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL +BL_WEB_SWB+ " ).append("\n"); 
		query.append("			(CASE WHEN (SI_TTL - ( BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + BL_WEB_SWB )) > 0 " ).append("\n"); 
		query.append("				THEN (SI_TTL - (BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + BL_WEB_SWB ))" ).append("\n"); 
		query.append("			ELSE 0 END)),0,1,(BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + " ).append("\n"); 
		query.append("			(CASE WHEN (SI_TTL - ( BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + BL_WEB_SWB )) > 0 " ).append("\n"); 
		query.append("				THEN (SI_TTL - (BL_NIS + BL_EDI + BL_WEB_OBL + BL_SWB_EMAIL + BL_WEB_SWB ))" ).append("\n"); 
		...
		query.append("        'BR' REPORT_TYPE" ).append("\n"); 
		...
		query.append("		,SUM(DECODE(NVL(BK.XTER_BKG_RQST_CD, 'NIS'), 'EDI', 1,'SEA',1,'DAK',1,0)) BKG_EDI" ).append("\n"); 
		...
		query.append("        ,SUM(DECODE(NVL(BK.XTER_SI_CD, 'NIS'), 'EDI', 1, 'SEA', 1, 'DAK', 1, 0)) SI_EDI" ).append("\n"); 
		...
		query.append("		,SUM(DECODE((SELECT BKG_NO FROM BKG_NTC_HIS" ).append("\n"); 
		...
		query.append("	#elseif (${sc_rfa_type} == 'T') " ).append("\n"); 
		...
		query.append("AND     SCI.IOC_CD = 'O'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${zone_cd} == 'IPT') " ).append("\n"); 
		query.append("/* zone_cd IPT*/" ).append("\n"); 
		query.append("--AND (SELECT CONTI_CD FROM MDM_LOCATION WHERE LOC_CD = BK.POR_CD) = (SELECT CONTI_CD FROM MDM_LOCATION WHERE LOC_CD = BK.DEL_CD) " ).append("\n"); 
		query.append("AND     SCI.IOC_CD = 'I'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append(",'' REGION_CD	" ).append("\n"); 
		query.append(",'' GSO	" ).append("\n"); 
		query.append(",'' OFC_CD	" ).append("\n"); 
		query.append(",'' DURATION	" ).append("\n"); 
		query.append(",'' BKG_TTL	" ).append("\n"); 
		query.append(",'' BKG_NIS	" ).append("\n"); 
		query.append(",'' BKG_EDI	" ).append("\n"); 
		query.append(",'' BKG_WEB	" ).append("\n"); 
		query.append(",'' BKG_GTN	" ).append("\n"); 
		query.append(",'' BKG_DESKTOP	" ).append("\n"); 
		query.append(",'' BKG_INTTRA	" ).append("\n"); 
		query.append(",'' BKG_CSM	" ).append("\n"); 
		query.append(",'' BKG_SVC	" ).append("\n"); 
		query.append(",'' SI_TTL	" ).append("\n"); 
		query.append(",'' SI_NIS	" ).append("\n"); 
		query.append(",'' SI_EDI" ).append("\n"); 
		query.append(",'' SI_EML	" ).append("\n"); 
		query.append(",'' SI_ULD" ).append("\n"); 
		query.append(",'' SI_WEB	" ).append("\n"); 
		query.append(",'' SI_GTN	" ).append("\n"); 
		query.append(",'' SI_DESKTOP	" ).append("\n"); 
		query.append(",'' SI_INTTRA	" ).append("\n"); 
		query.append(",'' SI_CSM	" ).append("\n"); 
		query.append(",'' SI_SIM" ).append("\n"); 
		query.append(",'' SI_SVC	" ).append("\n"); 
		query.append(",'' BL_TTL_OBL	" ).append("\n"); 
		query.append(",'' BL_TTL_SWB	" ).append("\n"); 
		query.append(",'' BL_NIS	" ).append("\n"); 
		query.append(",'' BL_PENDING	" ).append("\n"); 
		query.append(",'' BL_EDI	" ).append("\n"); 
		query.append(",'' BL_WEB_OBL	" ).append("\n"); 
		query.append(",'' BL_WEB_SWB	" ).append("\n"); 
		query.append(",'' BL_SWB_EMAIL	" ).append("\n"); 
		query.append(",'' BL_SVC	" ).append("\n"); 
		query.append(",'' BKG_OFC	" ).append("\n"); 
		query.append(",'' SAL_OFC	" ).append("\n"); 
		query.append(",'' VVD_CD	" ).append("\n"); 
		query.append(",'' DURATION_OPT	" ).append("\n"); 
		...
		query.append(",'' DOC_TP_L	" ).append("\n"); 
		query.append(",'' SC_RFA_TYPE	" ).append("\n"); 
		...
		query.append(",'' BK_KIND	" ).append("\n"); 
		query.append(",'' BK_DT	" ).append("\n"); 
		query.append(",'' BK_USR_ID	" ).append("\n"); 
		query.append(",'' BK_USR_NM	" ).append("\n"); 
		query.append(",'' SI_KIND	" ).append("\n"); 
		query.append(",'' SI_DT	" ).append("\n"); 
		query.append(",'' SI_USR_ID	" ).append("\n"); 
		query.append(",'' SI_USR_NM	" ).append("\n"); 
		query.append(",'' BL_KIND	" ).append("\n"); 
		query.append(",'' BL_DT	" ).append("\n"); 
		query.append(",'' BL_USR_ID	" ).append("\n"); 
		query.append(",'' BL_USR_NM	" ).append("\n"); 
		query.append(",'' ADM_USR_ID	" ).append("\n"); 
		...
		query.append(",'' OBL_SND_ADM_USR_ID	" ).append("\n"); 
