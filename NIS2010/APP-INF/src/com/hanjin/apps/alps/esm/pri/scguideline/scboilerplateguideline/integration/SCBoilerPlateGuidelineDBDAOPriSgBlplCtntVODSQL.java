...
*@FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVODSQL.java
...
public class SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVODSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOPriSgBlplCtntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from pri_sg_blpl_ctnt" ).append("\n"); 
		query.append("where	blpl_hdr_seq = @[blpl_hdr_seq]" ).append("\n"); 
		query.append("#if (${blpl_seq} != '')" ).append("\n"); 
		query.append("and	blpl_seq = @[blpl_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${blpl_ctnt_seq} != '')" ).append("\n"); 
