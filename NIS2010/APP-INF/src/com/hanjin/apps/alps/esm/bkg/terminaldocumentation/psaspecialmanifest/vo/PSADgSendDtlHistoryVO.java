...
*@FileName : PSADgSendDtlHistoryVO.java
*@FileTitle : PSADgSendDtlHistoryVO
*Open Issues :
*Change history :
...
public class PSADgSendDtlHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSADgSendDtlHistoryVO> models = new ArrayList<PSADgSendDtlHistoryVO>();
	...
	public PSADgSendDtlHistoryVO() {}

	public PSADgSendDtlHistoryVO(String ibflag, String pagerows, String eurEdiMsgTpId, String msgSndNo, String ediRspnSeq, String blNo, String cntrNo, String cntrCgoSeq, String dgBlRefNo, String dgItmRefNo, String creUsrId, String creDt, String updUsrId, String updDt, String keyVal) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return PSADgSendDtlHistoryVO[]
	 */
	public PSADgSendDtlHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSADgSendDtlHistoryVO[]
	 */
	public PSADgSendDtlHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSADgSendDtlHistoryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PSADgSendDtlHistoryVO();
				if (updDt[i] != null)
		...
		return getPSADgSendDtlHistoryVOs();
	}
	 ...
	 * @return PSADgSendDtlHistoryVO[]
	 */
	public PSADgSendDtlHistoryVO[] getPSADgSendDtlHistoryVOs(){
		PSADgSendDtlHistoryVO[] vos = (PSADgSendDtlHistoryVO[])models.toArray(new PSADgSendDtlHistoryVO[models.size()]);
		return vos;
	}
