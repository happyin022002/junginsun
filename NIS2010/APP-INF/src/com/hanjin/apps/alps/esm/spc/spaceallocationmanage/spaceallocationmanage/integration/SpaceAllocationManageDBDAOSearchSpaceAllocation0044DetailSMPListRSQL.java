...
*@FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0044DetailSMPListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSearchSpaceAllocation0044DetailSMPListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [ESM_SPC_0044] 성수기 항차의 detail 정보를 조회합니다.
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSearchSpaceAllocation0044DetailSMPListRSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0044DetailSMPListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  DECODE(H.DIR_CD, NULL, '200001-01', COST_YRWK||'-'||VER_SEQ)" ).append("\n"); 
		query.append("                  FROM SPC_MDL_VER_MST M" ).append("\n"); 
		query.append("                 WHERE SUBSTR(T.SLS_YRMON, 1, 4)||T.COST_WK BETWEEN VER_ST_YRWK AND VER_END_YRWK" ).append("\n"); 
		query.append("                   AND CFM_FLG = 'Y'" ).append("\n"); 
		query.append("                   AND TRD_CD = T.TRD_CD" ).append("\n"); 
		...
		query.append("                   AND CO.SKD_DIR_CD = T.DIR_CD ) AS CTRL_LVL," ).append("\n"); 
		...
		query.append("           AND H.TRD_CD (+) = T.TRD_CD" ).append("\n"); 
		query.append("           AND H.RLANE_CD (+) = T.RLANE_CD" ).append("\n"); 
		query.append("           AND H.DIR_CD (+) = T.DIR_CD " ).append("\n"); 
		...
		query.append("           MAX(CTRL_LVL) AS CTRL_LVL," ).append("\n"); 
		...
		query.append("                   '1' POD_PORT_MAX_SEQ," ).append("\n"); 
		query.append("                   '1' POD_YD_SEQ" ).append("\n"); 
		query.append("              FROM BASE V ) Z" ).append("\n"); 
		...
		query.append("               SKD_DIR_CD," ).append("\n"); 
		query.append("               COST_YR_WK," ).append("\n"); 
		query.append("               SUBSTR(SEASON, 1, 6)," ).append("\n"); 
		query.append("               SUBSTR(SEASON, 8)," ).append("\n"); 
		query.append("               POL_CD ," ).append("\n"); 
		query.append("               POD_CD ," ).append("\n"); 
		query.append("               IOC_CD ," ).append("\n"); 
		query.append("               EDIT," ).append("\n"); 
		...
		query.append("               DEL_CD AS RFA_DEL_CD," ).append("\n"); 
		query.append("               RFA_NO," ).append("\n"); 
		query.append("               CUST_CTRL_CD" ).append("\n"); 
		query.append("          FROM (SELECT CUST_CD AS SHP_CUST_CD," ).append("\n"); 
		query.append("                       POL_CD," ).append("\n"); 
		query.append("                       POD_CD," ).append("\n"); 
		...
		query.append("                  FROM (SELECT (SELECT CUST_CNT_CD||LPAD(CUST_SEQ, 6, '0')" ).append("\n"); 
		...
		query.append("                                   AND B.CUST_CNT_CD = 'CN' ) CUST_CD," ).append("\n"); 
		...
		query.append("                                         WHERE TRD_CD = 'AES' ) S" ).append("\n"); 
		...
		query.append("                                   AND M.RFA_NO IS NOT NULL ) C" ).append("\n"); 
		...
		query.append("                                   AND C.COST_YRWK   = SUBSTR(P.SEASON, 1, 6)      -- 20140814 수정" ).append("\n"); 
		query.append("                                   AND C.VER_SEQ     = SUBSTR(P.SEASON, 8)         -- 20140814 수정" ).append("\n"); 
		query.append("                                   AND C.CUST_CNT_CD = BAR.CUST_CNT_CD" ).append("\n"); 
		query.append("                                   AND C.CUST_SEQ = BAR.CUST_SEQ), 'C') AS CUST_CTRL_CD," ).append("\n"); 
		...
		query.append("--									AND OFC.OFC_CD           = BAR.SLS_OFC_CD--SPC_SCR_OFC_CONV_FNC(BAR.SLS_OFC_CD)" ).append("\n"); 
		...
		query.append("--									AND OFC.OFC_CD           = SPC_SCR_OFC_CONV_FNC(BAR.SLS_OFC_CD)" ).append("\n"); 
		...
		query.append("        SELECT B.SEASON," ).append("\n"); 
		query.append("               B.VER_SEQ," ).append("\n"); 
		query.append("               T.IOC_TS_CD," ).append("\n"); 
		query.append("               T.SLS_RHQ_CD," ).append("\n"); 
		query.append("               T.SLS_AQ_CD," ).append("\n"); 
		query.append("               T.SLS_RGN_OFC_CD," ).append("\n"); 
		query.append("               T.SLS_OFC_CD ," ).append("\n"); 
		query.append("               T.CFM_TTL_QTY," ).append("\n"); 
		query.append("               T.CFM_40FT_HC_QTY," ).append("\n"); 
		query.append("               T.CFM_45FT_HC_QTY," ).append("\n"); 
		query.append("               T.CFM_53FT_QTY," ).append("\n"); 
		query.append("               T.CFM_RF_QTY," ).append("\n"); 
		query.append("               T.CFM_TTL_WGT," ).append("\n"); 
		...
		query.append("               T.POL_YD_IND_SEQ ," ).append("\n"); 
		query.append("               T.POD_YD_IND_SEQ ," ).append("\n"); 
		query.append("               T.CUST_SEQ ," ).append("\n"); 
		query.append("               T.TRD_CD ," ).append("\n"); 
		query.append("               T.SC_NO ," ).append("\n"); 
		query.append("               T.RFA_NO," ).append("\n"); 
		query.append("               T.USA_BKG_MOD_CD," ).append("\n"); 
		query.append("               T.DEST_LOC_CD," ).append("\n"); 
		query.append("               T.FCAST_20FT_DRY_QTY," ).append("\n"); 
		query.append("               T.FCAST_40FT_DRY_QTY," ).append("\n"); 
		query.append("               T.FCAST_RD_QTY," ).append("\n"); 
		query.append("               T.CFM_20FT_DRY_QTY," ).append("\n"); 
		query.append("               T.CFM_40FT_DRY_QTY," ).append("\n"); 
		query.append("               T.CFM_RD_QTY," ).append("\n"); 
		query.append("               T.USD_BKG_20FT_DRY_QTY," ).append("\n"); 
		query.append("               T.USD_BKG_40FT_DRY_QTY," ).append("\n"); 
		query.append("               T.USD_BKG_RD_QTY" ).append("\n"); 
		...
		query.append("       B.N2ND_PRNT_OFC_CD AS RHQ_OFC_CD," ).append("\n"); 
		query.append("       CUST_CTRL_CD," ).append("\n"); 
		...
		query.append("       POD_CD ," ).append("\n"); 
		query.append("       DEL_CD ," ).append("\n"); 
		query.append("       DECODE(US_MOD, '+', GUIDE, 0) AS GUIDE_OLD," ).append("\n"); 
		query.append("       GUIDE_TTL," ).append("\n"); 
		query.append("       CASE " ).append("\n"); 
		query.append("       WHEN CUST_CTRL_CD = '+'                                   " ).append("\n"); 
		query.append("	   THEN BKG_QUOTA" ).append("\n"); 
		query.append("       WHEN CUST_CTRL_CD = 'C' AND POL_CD = '+' AND POD_CD = '+' AND US_MOD = '+' AND ACCOUNT_CD = '+'" ).append("\n"); 
		query.append("           THEN BKG_QUOTA - GUIDE_TTL" ).append("\n"); 
		query.append("          -- US_MOD 별 구분이 없으므로 조건 추가" ).append("\n"); 
		query.append("       WHEN CUST_CTRL_CD <> '+' AND POL_CD = '+' AND POD_CD = '+' AND US_MOD = '+' AND ACCOUNT_CD = '+'" ).append("\n"); 
		query.append("           THEN GUIDE" ).append("\n"); 
		query.append("       WHEN US_MOD <> '+'" ).append("\n"); 
		query.append("           THEN 0" ).append("\n"); 
		query.append("       ELSE GUIDE" ).append("\n"); 
		query.append("       END AS GUIDE," ).append("\n"); 
		query.append("       " ).append("\n"); 
		query.append("       CASE " ).append("\n"); 
		query.append("       WHEN CUST_CTRL_CD <> '+' THEN 0" ).append("\n"); 
		query.append("       ELSE BKG_QUOTA" ).append("\n"); 
		query.append("       END AS  BKG_QUOTA," ).append("\n"); 
		query.append("       CMB_AVG," ).append("\n"); 
		query.append("       (" ).append("\n"); 
		query.append("                       CASE" ).append("\n"); 
		query.append("                         WHEN NVL(CMB4, 0) > 0 THEN (" ).append("\n"); 
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                         WHEN NVL(CMB3, 0) > 0 THEN CMB4 - CMB3" ).append("\n"); 
		...
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                         WHEN NVL(CMB2, 0) > 0 THEN CMB3 - CMB2" ).append("\n"); 
		...
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                         WHEN NVL(CMB1, 0) > 0 THEN CMB2 - CMB1" ).append("\n"); 
		...
		query.append("       (" ).append("\n"); 
		query.append("                       CASE" ).append("\n"); 
		query.append("                         WHEN NVL(CMB_WGT4, 0) > 0 THEN (" ).append("\n"); 
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                         WHEN NVL(CMB_WGT3, 0) > 0 THEN CMB_WGT4 - CMB_WGT3" ).append("\n"); 
		...
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                         WHEN NVL(CMB_WGT2, 0) > 0 THEN CMB_WGT3 - CMB_WGT2" ).append("\n"); 
		...
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                         WHEN NVL(CMB_WGT1, 0) > 0 THEN CMB_WGT2 - CMB_WGT1" ).append("\n"); 
		...
		query.append("  FROM (SELECT EDIT," ).append("\n"); 
		query.append("               REP_TRD_CD," ).append("\n"); 
		query.append("               TRD_CD," ).append("\n"); 
		query.append("               IOC_CD," ).append("\n"); 
		...
		query.append("               --2014.08.19 Guide로직 HO와 동일하게 맞춤" ).append("\n"); 
		query.append("               MAX(GUIDE) OVER (PARTITION BY REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD) AS GUIDE_TTL, " ).append("\n"); 
		...
		query.append("                 #end" ).append("\n"); 
		query.append("                   AND Z.IOC_CD <> 'EQ' ) AS CMB_AVG," ).append("\n"); 
		query.append("               (SELECT ROUND((SUM(BAR.BKG_REV) + SUM(BAR.DMDT_COM_AMT) - SUM(BAR.ESTM_CM_COST_AMT)) / DECODE(SUM(BAR.BKG_TTL_QTY), 0, 1, SUM(BAR.BKG_TTL_QTY)))" ).append("\n"); 
		query.append("                  FROM WK_CMB BAR" ).append("\n"); 
		query.append("                 WHERE BAR.OFC_CD = Z.OFC_CD" ).append("\n"); 
		...
		query.append("                   AND BAR.CUST_CTRL_CD  = NVL(Z.CUST_CTRL_CD, '0')" ).append("\n"); 
		query.append("                   AND Z.IOC_CD <> 'E'" ).append("\n"); 
		query.append("                   AND RNUM = 2 " ).append("\n"); 
		query.append("                   -- 20140805 추가(S)" ).append("\n"); 
		query.append("                   AND DECODE(BAR.US_MOD, 'OTH', 'OTHERS', BAR.US_MOD) = NVL(Z.US_MOD, '00000')" ).append("\n"); 
		query.append("                   AND DECODE(BAR.ACCOUNT_CD, 'XX999999', 'OTHERS', BAR.ACCOUNT_CD)   = NVL(Z.ACCOUNT_CD, '000')" ).append("\n"); 
		query.append("                   AND DECODE(BAR.DEL_CD, 'XXXXX', 'OTHERS', BAR.DEL_CD)  = NVL(Z.DEL_CD, '00000')" ).append("\n"); 
		...
		query.append("                   AND BAR.CUST_CTRL_CD  = NVL(Z.CUST_CTRL_CD, '0')" ).append("\n"); 
		query.append("                   AND Z.IOC_CD <> 'E'" ).append("\n"); 
		query.append("                   AND RNUM = 3 " ).append("\n"); 
		query.append("                   -- 20140805 추가(S)" ).append("\n"); 
		query.append("                   AND DECODE(BAR.US_MOD, 'OTH', 'OTHERS', BAR.US_MOD) = NVL(Z.US_MOD, '00000')" ).append("\n"); 
		query.append("                   AND DECODE(BAR.ACCOUNT_CD, 'XX999999', 'OTHERS', BAR.ACCOUNT_CD)   = NVL(Z.ACCOUNT_CD, '000')" ).append("\n"); 
		query.append("                   AND DECODE(BAR.DEL_CD, 'XXXXX', 'OTHERS', BAR.DEL_CD)  = NVL(Z.DEL_CD, '00000')" ).append("\n"); 
		...
		query.append("                   AND BAR.CUST_CTRL_CD  = NVL(Z.CUST_CTRL_CD, '0')" ).append("\n"); 
		query.append("                   AND Z.IOC_CD <> 'E'" ).append("\n"); 
		query.append("                   AND RNUM = 4 " ).append("\n"); 
		query.append("--                   -- 20140805 추가(S)" ).append("\n"); 
		query.append("                   AND DECODE(BAR.US_MOD, 'OTH', 'OTHERS', BAR.US_MOD) = NVL(Z.US_MOD, '00000')" ).append("\n"); 
		query.append("                   AND DECODE(BAR.ACCOUNT_CD, 'XX999999', 'OTHERS', BAR.ACCOUNT_CD)   = NVL(Z.ACCOUNT_CD, '000')" ).append("\n"); 
		query.append("                   AND DECODE(BAR.DEL_CD, 'XXXXX', 'OTHERS', BAR.DEL_CD)  = NVL(Z.DEL_CD, '00000')" ).append("\n"); 
		...
		query.append("          FROM (SELECT DECODE(DECODE(REP_TRD_CD, TRD_CD, DECODE(MAX(CTRL_LVL), 'O', 1, 'U', 2, 'A', 3, 'L', 4, 'D', 5, 'T', 6), " ).append("\n"); 
		query.append("			DECODE( (SELECT CTRL_LVL FROM BASE) , 'T' , 6 , 5 ) ), DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(US_MOD, NULL, 0, 1) + DECODE(ACCOUNT_CD, NULL, 0, 1) + DECODE(POL_CD, NULL, 0, 1) + DECODE(POD_CD, NULL, 0, 1) + DECODE(DEL_CD, NULL, 0, 1), 1, 0) AS EDIT," ).append("\n"); 
		query.append("                       -- DECODE(DECODE(REP_TRD_CD, TRD_CD, DECODE(MAX(CTRL_LVL), 'O', 1, 'L', 2, 'D', 3), 3), DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(POL_CD, NULL, 0, 1) + DECODE(POD_CD, NULL, 0, 1), 1, 0) AS EDIT," ).append("\n"); 
		query.append("                       REP_TRD_CD," ).append("\n"); 
		query.append("                       TRD_CD ," ).append("\n"); 
		query.append("                       IOC_CD ," ).append("\n"); 
		query.append("                       OFC_CD," ).append("\n"); 
		...
		query.append("                       DECODE(DECODE(DECODE(REP_TRD_CD, TRD_CD, DECODE(MAX(CTRL_LVL), 'O', 1, 'L', 4, 'D', 5), 6), + DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(POL_CD, NULL, 0, 1) + DECODE(POD_CD, NULL, 0, 1), 1, 0), 1, MAX(SPC_CTRL_ALOC_RMK) , NULL) AS SPC_CTRL_ALOC_RMK ," ).append("\n"); 
		query.append("                       DECODE(DECODE(DECODE(REP_TRD_CD, TRD_CD, DECODE(MAX(CTRL_LVL), 'O', 1, 'L', 4, 'D', 5), 6), + DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(POL_CD, NULL, 0, 1) + DECODE(POD_CD, NULL, 0, 1), 1, 0), 1, MAX(SPC_CTRL_ALOC_POL_RMK), NULL) AS SPC_CTRL_ALOC_POL_RMK," ).append("\n"); 
		query.append("                       DECODE(DECODE(DECODE(REP_TRD_CD, TRD_CD, DECODE(MAX(CTRL_LVL), 'O', 1, 'L', 4, 'D', 5), 6), + DECODE(CUST_CTRL_CD, NULL, 0, 1) + DECODE(POL_CD, NULL, 0, 1) + DECODE(POD_CD, NULL, 0, 1), 1, 0), 1, MAX(SPC_CTRL_ALOC_POD_RMK), NULL) AS SPC_CTRL_ALOC_POD_RMK," ).append("\n"); 
		query.append("                       POL_SEQ," ).append("\n"); 
		query.append("                       POD_SEQ," ).append("\n"); 
		...
		query.append("                  FROM (SELECT U.REP_TRD_CD," ).append("\n"); 
		...
		query.append("                               MAX(CTRL_LVL) AS CTRL_LVL," ).append("\n"); 
		query.append("                               SUM(U.GUIDE) AS GUIDE," ).append("\n"); 
		...
		query.append("                                       -- 현재 OPTION 상태에서 판단" ).append("\n"); 
		query.append("--                                       B.US_MOD AS US_MOD," ).append("\n"); 
		query.append("                                       CASE WHEN M.CTRL_USA = 'Y' THEN" ).append("\n"); 
		query.append("                                       DECODE(NVL(T.USA_BKG_MOD_CD, 'OTH'), 'OTH', 'OTHERS', T.USA_BKG_MOD_CD)" ).append("\n"); 
		query.append("                                       ELSE" ).append("\n"); 
		query.append("                                       'OTHERS'" ).append("\n"); 
		query.append("                                       END AS US_MOD," ).append("\n"); 
		query.append("--                                       B.ACCOUNT_CD AS ACCOUNT_CD," ).append("\n"); 
		query.append("                                       -- 2014.08.08 변경" ).append("\n"); 
		query.append("                                       CASE WHEN M.CTRL_ACCOUNT = 'Y' THEN" ).append("\n"); 
		query.append("                                       -- 2015.01.09" ).append("\n"); 
		...
		query.append("															  AND D.DIR_CD            = OFC.DIR_CD " ).append("\n"); 
		query.append("															  AND D.ALOC_CTRL_TP_CD   = OFC.ALOC_CTRL_TP_CD " ).append("\n"); 
		query.append("															  AND OFC.OFC_CD          = T.SLS_OFC_CD" ).append("\n"); 
		...
		query.append("                                       --MAX(B.CTRL_LVL) AS CTRL_LVL," ).append("\n"); 
		query.append("                                       B.CTRL_LVL AS CTRL_LVL," ).append("\n"); 
		...
		query.append("                                   -- 2014.08.08 union all 이후 GROUP BY로 변경" ).append("\n"); 
		...
		query.append("                                       DECODE(T.USA_BKG_MOD_CD, 'X', 'OTHERS', 'OTH', 'OTHERS', T.USA_BKG_MOD_CD) AS US_MOD," ).append("\n"); 
		...
		query.append("                                       -- 2014.08.14" ).append("\n"); 
		query.append("                                       DECODE(T.SLS_RGN_OFC_CD, B.OFC_CD, T.ASGN_20FT_DRY_QTY , 0) AS AD_D2 ," ).append("\n"); 
		query.append("                                       DECODE(T.SLS_RGN_OFC_CD, B.OFC_CD, T.ASGN_40FT_DRY_QTY , 0) AS AD_D4 ," ).append("\n"); 
		query.append("                                       DECODE(T.SLS_RGN_OFC_CD, B.OFC_CD, T.ASGN_RD_QTY , 0) AS AD_RD" ).append("\n"); 
		query.append("                                       , 0 AS BS_TEU--2015.04.30 KIMSW" ).append("\n"); 
		query.append("                                       , 0 AS BS_WGT--2015.04.30 KIMSW" ).append("\n"); 
		query.append("                                  FROM SPC_ALOC_CUST_POL_POD T," ).append("\n"); 
		query.append("                                       VSL_PORT_SKD B, " ).append("\n"); 
		query.append("                                       BASE M" ).append("\n"); 
		query.append("                                 WHERE T.TRD_CD = B.TRD_CD" ).append("\n"); 
		query.append("                                   AND T.RLANE_CD = B.RLANE_CD" ).append("\n"); 
		...
		query.append("                                   AND T.POD_YD_IND_SEQ = B.POD_YD_SEQ" ).append("\n"); 
		query.append("                                   AND (T.SLS_RGN_OFC_CD = B.OFC_CD" ).append("\n"); 
		query.append("                                            OR T.SLS_OFC_CD = B.OFC_CD)" ).append("\n"); 
		...
		query.append("                                       CASE" ).append("\n"); 
		query.append("                                       WHEN A.AES_FLG = 'Y' THEN NVL(RD.CUST_CTRL_CD, 'C')" ).append("\n"); 
		...
		query.append("                                       , BS_TEU--2015.04.30 KIMSW" ).append("\n"); 
		query.append("                                       , BS_WGT--2015.04.30 KIMSW" ).append("\n"); 
		query.append("                                  FROM (SELECT /*+ OPT_PARAM('_COMPLEX_VIEW_MERGING', 'FALSE') */" ).append("\n"); 
		query.append("                                          DECODE(T.VSL_PRE_PST_CD, 'T', DECODE(T.IOC_CD, 'O', 'OCN', 'I', 'IPC', ''), 'T/S') AS IOC_CD," ).append("\n"); 
		query.append("                                               T.REP_TRD_CD," ).append("\n"); 
		query.append("                                               T.TRD_CD ," ).append("\n"); 
		query.append("                                               T.SLS_OFC_CD AS OFC_CD," ).append("\n"); 
		query.append("                                               CASE WHEN T.TRD_CD = 'AES'" ).append("\n"); 
		query.append("                                                     AND T.RFA_NO IS NULL" ).append("\n"); 
		query.append("                                                     AND T.SHP_CUST_CNT_CD = 'CN'" ).append("\n"); 
		query.append("                                                     AND T.IOC_CD != 'T'" ).append("\n"); 
		query.append("                                                     AND T.SC_NO IS NULL THEN 'Y'" ).append("\n"); 
		query.append("                                               ELSE 'N'" ).append("\n"); 
		query.append("                                               END AS AES_FLG," ).append("\n"); 
		query.append("                                               NVL(C.CUST_CTRL_CD, 'C') AS CUST_CTRL_CD," ).append("\n"); 
		query.append("                                               T.US_MOD," ).append("\n"); 
		query.append("                                               T.ACCOUNT_CD," ).append("\n"); 
		...
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 1, 14), 0)) AS BT_TEU ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 15, 14), 0)) AS BT_20 ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 29, 14), 0)) AS BT_40 ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 43, 14), 0)) AS BT_D2 ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 57, 14), 0)) AS BT_D4 ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 71, 14), 0)) AS BT_HC," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 85, 14), 0)) AS BT_45," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 99, 14), 0)) AS BT_53 ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 113, 14), 0)) AS BT_RF ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 127, 14), 0)) AS BT_RD ," ).append("\n"); 
		query.append("                                               TO_NUMBER(NVL(SUBSTR(T.VAL, 141, 14), 0)) AS BT_WGT ,BKG_VOL_VGM, BKG_WGT_VGM," ).append("\n"); 
		...
		query.append("                                               T.SHP_CUST_CNT_CD||LPAD(T.SHP_CUST_SEQ, 6, '0') AS SHP_CUST_CD," ).append("\n"); 
		query.append("                                               T.BKG_POL_CD," ).append("\n"); 
		query.append("                                               T.BKG_POD_CD" ).append("\n"); 
		query.append("                                               , DECODE( NVL( ALOC_STS_CD , 'X') , 'S' , TO_NUMBER(NVL(SUBSTR(T.VAL, 1, 14), 0)), 'A' , TO_NUMBER(NVL(SUBSTR(T.VAL, 1, 14), 0))) AS BS_TEU" ).append("\n"); 
		query.append("                                               , DECODE( NVL( ALOC_STS_CD , 'X') , 'S' , TO_NUMBER(NVL(SUBSTR(T.VAL, 141, 14), 0)), 'A' , TO_NUMBER(NVL(SUBSTR(T.VAL, 141, 14), 0))) AS BS_WGT" ).append("\n"); 
		query.append("                                          FROM (SELECT BV.VSL_PRE_PST_CD," ).append("\n"); 
		...
		query.append("                                                       CASE WHEN M.CTRL_ACCOUNT = 'Y' THEN" ).append("\n"); 
		query.append("                                                        NVL((" ).append("\n"); 
		query.append("                                                        -- 2014.12.03 Individual Account : account code, actual/cmdt : contract " ).append("\n"); 
		...
		query.append("                                                            'OTHERS'" ).append("\n"); 
		query.append("                                                       END AS ACCOUNT_CD," ).append("\n"); 
		query.append("                                                       SPC_GET_SMP_AMEND_FNC(B.TRD_CD, B.SEASON, B.VER_SEQ, BKG.SC_NO) AS SC_NO," ).append("\n"); 
		...
		query.append("                                                       SPC_GET_SMP_AMEND_FNC(B.TRD_CD, B.SEASON, B.VER_SEQ, DECODE(SUBSTR(BKG.RFA_NO, 1, 3), 'DUM', '', BKG.RFA_NO)) AS RFA_NO," ).append("\n"); 
		...
		query.append("                                                       B.POD_SEQ," ).append("\n"); 
		query.append("                                                       B.CTRL_LVL ," ).append("\n"); 
		query.append("                                                       (SELECT TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), '2', 1, 2) * Q.OP_CNTR_QTY), 'FM0000000000.000') || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), '2', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000') || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), '4', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000')" ).append("\n"); 
		...
		query.append("                                                               || TO_CHAR(SUM(DECODE(SUBSTR(Q.CNTR_TPSZ_CD, 1, 2), 'D4', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000') || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), '5', Q.OP_CNTR_QTY, '9', Q.OP_CNTR_QTY, '8', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000') --R9,R8에 대해서 R5과 동일하게 HC으로 처리되도록 추가" ).append("\n"); 
		query.append("                                                               || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), '7', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000') || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), 'W', Q.OP_CNTR_QTY, 0) + DECODE(SPC_GET_CNTR_SZ_FNC(Q.CNTR_TPSZ_CD), 'X', Q.OP_CNTR_QTY, 0)), 'FM0000000000.000') || TO_CHAR(SUM(DECODE(SPC_GET_CNTR_TP_FNC(Q.CNTR_TPSZ_CD), 'R', Q.OP_CNTR_QTY - Q.EQ_SUBST_CGO_QTY, 0)), 'FM0000000000.000')" ).append("\n"); 
		query.append("--2014.07.22" ).append("\n"); 
		query.append("                                                               || TO_CHAR(SUM(" ).append("\n"); 
		query.append("                                                                                                                                                       CASE" ).append("\n"); 
		query.append("                                                                                                                                                         WHEN Q.CNTR_TPSZ_CD LIKE 'R%'" ).append("\n"); 
		query.append("                                                                           AND Q.EQ_SUBST_CNTR_TPSZ_CD LIKE 'D%' THEN Q.EQ_SUBST_CGO_QTY" ).append("\n"); 
		query.append("                                                                                                                                                         ELSE 0" ).append("\n"); 
		query.append("                                                                                                                                                       END), 'FM0000000000.000') || TO_CHAR((BD.ACT_WGT * DECODE(BD.WGT_UT_CD, 'LBS', 0.00045, 0.001)) + SUM(Q.OP_CNTR_QTY * (SELECT TS.CNTR_TPSZ_TARE_WGT" ).append("\n"); 
		...
		query.append("                                                   AND DRLAN.FM_CONTI_CD = (SELECT SPC_CONTI_CONV_FNC(MLOC.CONTI_CD, B.RLANE_CD)" ).append("\n"); 
		query.append("                                                          FROM MDM_LOCATION MLOC" ).append("\n"); 
		query.append("                                                         WHERE MLOC.LOC_CD = BV.POL_CD )" ).append("\n"); 
		query.append("                                                   AND DRLAN.TO_CONTI_CD = (SELECT SPC_CONTI_CONV_FNC(MLOC.CONTI_CD, B.RLANE_CD)" ).append("\n"); 
		query.append("                                                          FROM MDM_LOCATION MLOC" ).append("\n"); 
		...
		query.append("                                               SPC_MDL_CUST_CTRL C" ).append("\n"); 
		query.append("                                         WHERE T.SEASON = C.COST_YRWK(+)" ).append("\n"); 
		query.append("                                           AND T.VER_SEQ = C.VER_SEQ(+)" ).append("\n"); 
		query.append("                                           AND T.TRD_CD = C.TRD_CD(+)" ).append("\n"); 
		query.append("                                           AND NVL(T.SC_NO, NVL(T.RFA_NO, ' ')) = NVL(C.SC_NO(+), NVL(C.RFA_NO(+), ' '))" ).append("\n"); 
		query.append("--AND DECODE(T.TRD_CD, 'AES', NVL(T.RFA_NO,' '), NVL(T.SC_NO,' ')) = DECODE(T.TRD_CD, 'AES', NVL(C.RFA_NO(+),' '), NVL(C.SC_NO(+),NVL(T.SC_NO,' ')))" ).append("\n"); 
		query.append("                                           AND T.CTRT_CUST_CNT_CD = C.CUST_CNT_CD(+)" ).append("\n"); 
		query.append("                                           AND T.CTRT_CUST_SEQ = C.CUST_SEQ(+) ) A," ).append("\n"); 
		query.append("                                       RFA_BKG_DATA RD" ).append("\n"); 
		...
		query.append("                                       MAX(VPS.CTRL_LVL) AS CTRL_LVL," ).append("\n"); 
		query.append("                                       0 AS GUIDE ," ).append("\n"); 
		...
		query.append("                                   AND MQ.RGN_OFC_CD IN (SELECT OFC_CD" ).append("\n"); 
		query.append("                                          FROM SPC_OFC_LVL" ).append("\n"); 
		query.append("                                         WHERE B.COST_YR || B.COST_WK BETWEEN OFC_APLY_FM_YRWK AND OFC_APLY_TO_YRWK" ).append("\n"); 
		query.append("                                           AND N4TH_PRNT_OFC_CD = VPS.OFC_CD" ).append("\n"); 
		query.append("                                           AND OFC_LVL IN ('4'," ).append("\n"); 
		...
		query.append("                                       (SELECT SUBSTR(POL_CD, 1, 5) POL_CD," ).append("\n"); 
		query.append("                                               MIN(POL_SEQ) POL_SEQ" ).append("\n"); 
		query.append("                                          FROM VSL_PORT_SKD" ).append("\n"); 
		query.append("                                         GROUP BY SUBSTR(POL_CD, 1, 5)) DBL_POL," ).append("\n"); 
		query.append("                                       (SELECT SUBSTR(POD_CD, 1, 5) POD_CD," ).append("\n"); 
		...
		query.append("                                       0 AS BT_D4," ).append("\n"); 
		query.append("                                       0 AS BT_RD ," ).append("\n"); 
		query.append("                                       DECODE(T.SLS_RGN_OFC_CD, B.OFC_CD, T.ASGN_20FT_DRY_QTY , 0) AS AP_D2 ," ).append("\n"); 
		query.append("                                       DECODE(T.SLS_RGN_OFC_CD, B.OFC_CD, T.ASGN_40FT_DRY_QTY , 0) AS AP_D4 ," ).append("\n"); 
		query.append("                                       DECODE(T.SLS_RGN_OFC_CD, B.OFC_CD, T.ASGN_RD_QTY , 0) AS AP_RD ," ).append("\n"); 
		query.append("                                       -- 2014.08.14" ).append("\n"); 
		...
		query.append("                                       'Guide' AS FLAG," ).append("\n"); 
		query.append("                                       DECODE(B.IOC_CD, 'O', 'OCN', 'I', 'IPC', 'T', 'T/S') AS IOC_CD," ).append("\n"); 
		query.append("                                       B.REP_TRD_CD," ).append("\n"); 
		query.append("                                       B.TRD_CD ," ).append("\n"); 
		query.append("                                       T.SLS_RGN_OFC_CD AS OFC_CD," ).append("\n"); 
		query.append("                                       T.CUST_CTRL_CD," ).append("\n"); 
		query.append("                                       'OTHERS' AS US_MOD," ).append("\n"); 
		query.append("                                       -- 2014.08.12 Guide는 customer별 setting" ).append("\n"); 
		query.append("--                                     CASE WHEN M.CTRL_ACCOUNT = 'Y' THEN" ).append("\n"); 
		query.append("--                                       NVL((SELECT D.CTRL_LOC_ACCT_CD" ).append("\n"); 
		query.append("--                                              FROM SPC_ALOC_LANE_CTRL_OPT_DTL D" ).append("\n"); 
		query.append("--                                             WHERE M.RLANE_CD                           = D.RLANE_CD" ).append("\n"); 
		...
		query.append("--                                               AND M.SKD_DIR_CD                         = D.DIR_CD " ).append("\n"); 
		query.append("--                                               AND D.ALOC_CTRL_TP_CD                    = 'A'  " ).append("\n"); 
		query.append("--                                               AND D.CTRL_LOC_ACCT_CD                   = T.CUST_CNT_CD ||LPAD(T.CUST_SEQ,6,'0')                                        " ).append("\n"); 
		query.append("--                                       ),'OTHERS')" ).append("\n"); 
		query.append("--                                       ELSE" ).append("\n"); 
		query.append("--                                       'OTHERS'" ).append("\n"); 
		query.append("--                                     END AS ACCOUNT_CD," ).append("\n"); 
		...
		query.append("                                       , 0 AS BS_TEU--2015.04.30 KIMSW" ).append("\n"); 
		query.append("                                       , 0 AS BS_WGT--2015.04.30 KIMSW" ).append("\n"); 
		query.append("                                  FROM SPC_MDL_CUST_REV_LANE T," ).append("\n"); 
		query.append("                                       BASE B" ).append("\n"); 
		query.append("                                 WHERE T.COST_YRWK = SUBSTR(B.SEASON, 1, 6)" ).append("\n"); 
		query.append("                                   AND T.VER_SEQ = SUBSTR(B.SEASON, 8)" ).append("\n"); 
		query.append("                                   AND T.TRD_CD = B.TRD_CD" ).append("\n"); 
		query.append("                                   AND T.RLANE_CD = B.RLANE_CD" ).append("\n"); 
		query.append("                                   AND T.SLS_RGN_OFC_CD = B.OFC_CD" ).append("\n"); 
		query.append("                                   AND B.HH_FLG = 'Y' ) U" ).append("\n"); 
		...
		query.append("                            OR ROUND(SUM(GUIDE), 1) > 0" ).append("\n"); 
		...
		query.append("                            OR ROUND(SUM(BT_TEU), 1) > 0 ) Z" ).append("\n"); 
		query.append("                 GROUP BY GROUPING SETS ((REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POL_SEQ, POD_CD, POD_SEQ, DEL_CD)," ).append("\n"); 
		query.append("                                         (REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD, POL_SEQ, POD_CD, POD_SEQ), " ).append("\n"); 
		query.append("                                         (REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD, POL_CD,POL_SEQ), " ).append("\n"); 
		query.append("                                         (REP_TRD_CD ,TRD_CD, IOC_CD, OFC_CD, CUST_CTRL_CD, US_MOD, ACCOUNT_CD), " ).append("\n"); 
		query.append("                                         (REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD, CUST_CTRL_CD, US_MOD), " ).append("\n"); 
		query.append("                                         (REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD, CUST_CTRL_CD)," ).append("\n"); 
		query.append("                                         (REP_TRD_CD, TRD_CD, IOC_CD, OFC_CD), " ).append("\n"); 
		query.append("--                                         (REP_TRD_CD, TRD_CD, IOC_CD, CUST_CTRL_CD), " ).append("\n"); 
		query.append("                                         (REP_TRD_CD, TRD_CD, IOC_CD) " ).append("\n"); 
		query.append("                                         )" ).append("\n"); 
		query.append("                HAVING (POL_CD IS NULL" ).append("\n"); 
		query.append("                            OR POL_CD <> SUBSTR('0000000', 1, LENGTH(POL_CD)))" ).append("\n"); 
		query.append("                   AND (POD_CD IS NULL" ).append("\n"); 
		query.append("                            OR POD_CD <> SUBSTR('0000000', 1, LENGTH(POD_CD)))" ).append("\n"); 
		...
		query.append("                            OR ROUND(SUM(AD_WGT), 1) >= 0" ).append("\n"); 
		query.append("                            OR ROUND(SUM(AP_WGT), 1) >= 0" ).append("\n"); 
		query.append("                            OR ROUND(SUM(BT_TEU), 1) > 0 ) ) Z )  A,                      " ).append("\n"); 
		query.append("       (SELECT B1.OFC_CD, B1.N2ND_PRNT_OFC_CD " ).append("\n"); 
		query.append("         FROM SPC_OFC_LVL B1, BASE_KEY B2" ).append("\n"); 
		query.append("        WHERE B2.YEAR||B2.WEEK BETWEEN B1.OFC_APLY_FM_YRWK AND B1.OFC_APLY_TO_YRWK ) B" ).append("\n"); 
		...
		query.append("[CHM-201325983-01] 동일화주에 SC 여러개인 경우로 인해 FCAST가 잘못 조회됨" ).append("\n"); 
