...
*@FileName : searchAlpsBkgVO.java
*@FileTitle : searchAlpsBkgVO
*Open Issues :
*Change history :
...
public class searchAlpsBkgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchAlpsBkgVO> models = new ArrayList<searchAlpsBkgVO>();
	...
	public searchAlpsBkgVO() {}

	public searchAlpsBkgVO(String ibflag, String pagerows, String bkgNo, String pctlNo, String mstBkgNo, String mnlBkgNoFlg, String bkgUpldStsCd, String bkgUpldStsNm, String blNo, String docTpCd, String shCnt, String shSeq, String shNm, String ffCnt, String ffSeq, String ffNm, String obSrepCd, String obSlsOfcCd, String vvd, String vslEngNm, String porCd, String porYdCd, String porNm, String polCd, String polYdCd, String polNm, String podCd, String podYdCd, String podNm, String delCd, String delYdCd, String delNm, String preRlyPortCd, String pstRlyPortCd, String fnlDestCd, String fnlDestNm, String rcvTerm, String dlvTerm, String frtTermCd, String ctrtType, String ctrtSc, String ctrtRfa, String twnSoNo, String cmdtCd, String cmdtNm, String repCmdtCd, String repCmdtNm, String usaCstmsFileCd, String cndCstmsFileCd, String actWgt, String wgtUtCd, String dcgoFlg, String rcFlg, String awkCgoFlg, String bbCgoFlg, String socFlg, String flexHgtFlg, String doorDate, String loadingDate, String deliveryDate, String mtyPkupYdCd, String pkupDate, String fullRtnYdCd, String xterRmk, String interRmk, String autoNotification, String bdrFlg, String caFlg, String bkCntcPsonNm, String bkCntcPsonPhnNo, String bkCntcPsonMphnNo, String bkCntcPsonFaxNo, String bkCntcPsonEml, String siCntcPsonNm, String siCntcPsonPhnNo, String siCntcPsonMphnNo, String siCntcPsonFaxNo, String siCntcPsonEml, String bkgStsCd, String xterBkgRqstCd, String xterBkgRqstRefNo, String siFlg, String xterSiCd, String xterSiRefNo, String taaNo) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ctrt_rfa", getCtrtRfa());
		...
		this.hashColumns.put("ctrt_sc", getCtrtSc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ctrt_rfa", "ctrtRfa");
		...
		this.hashFields.put("ctrt_sc", "ctrtSc");
	 ...
	 * @param ctrtRfa
	 */
	public void setCtrtRfa(String ctrtRfa) {
		this.ctrtRfa = ctrtRfa;
	}
	 ...
	 * @param ctrtSc
	 */
	public void setCtrtSc(String ctrtSc) {
		this.ctrtSc = ctrtSc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCtrtRfa(JSPUtil.getParameter(request, prefix + "ctrt_rfa", ""));
		...
		setCtrtSc(JSPUtil.getParameter(request, prefix + "ctrt_sc", ""));
	 ...
	 * @param request
	 * @return searchAlpsBkgVO[]
	 */
	public searchAlpsBkgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchAlpsBkgVO[]
	 */
	public searchAlpsBkgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchAlpsBkgVO model = null;
		...
		try {
			...
			String[] ctrtRfa = (JSPUtil.getParameter(request, prefix	+ "ctrt_rfa", length));
			...
			String[] ctrtSc = (JSPUtil.getParameter(request, prefix	+ "ctrt_sc", length));
	 ...
	 * @return searchAlpsBkgVO[]
	 */
	public searchAlpsBkgVO[] getsearchAlpsBkgVOs(){
		searchAlpsBkgVO[] vos = (searchAlpsBkgVO[])models.toArray(new searchAlpsBkgVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ctrtRfa = this.ctrtRfa .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ctrtSc = this.ctrtSc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
