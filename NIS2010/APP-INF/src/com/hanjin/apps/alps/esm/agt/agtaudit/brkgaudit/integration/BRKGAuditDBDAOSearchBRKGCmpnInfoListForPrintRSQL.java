...
*@FileName : BRKGAuditDBDAOSearchBRKGCmpnInfoListForPrintRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BRKGAuditDBDAOSearchBRKGCmpnInfoListForPrintRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_AGT_0018 화면 print 이벤드 조회
	  * </pre>
	  */
	public BRKGAuditDBDAOSearchBRKGCmpnInfoListForPrintRSQL(){
		setQuery();
		...
		query.append("FileName : BRKGAuditDBDAOSearchBRKGCmpnInfoListForPrintRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ROUND(SUM(A.ACT_IF_COMM_AMT + (A.ACT_IF_COMM_AMT * NVL(A.INV_TAX_RT, 0) / 100)), 2) AMOUNT," ).append("\n"); 
