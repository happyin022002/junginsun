...
*@FileName : BSAYearlyPlanDBDAOSearchTEUPrcSwapListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOSearchTEUPrcSwapListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOSearchTEUPrcSwapListRSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOSearchTEUPrcSwapListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        FROM " ).append("\n"); 
		query.append("            MAS_MON_VVD_YRY_PLN A1," ).append("\n"); 
		query.append("            MAS_LANE_RGST A2," ).append("\n"); 
		query.append("            BSA_BUD_VVD_MST A3," ).append("\n"); 
		query.append("            BSA_BUD_VVD_CRR_PERF A4" ).append("\n"); 
		...
		query.append("  AND A3.VSL_CD = @[txtvslCd] " ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("#if (${txtskdVoyNo} != '')" ).append("\n"); 
		query.append("  AND A3.SKD_VOY_NO = @[txtskdVoyNo] " ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("#if (${txtdirCd} != '')" ).append("\n"); 
		query.append("  AND A3.SKD_DIR_CD = @[txtdirCd] " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("--	 and a4.crr_bsa_capa >0  -- 이것으로 인해 선사별로 금액이 없는 항차에 대해서 조회가 안되는 형상이 발생 따라서 제거 함 " ).append("\n"); 
		query.append("    ) B1       " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY B1.COST_YRWK " ).append("\n"); 
		query.append("       ,B1.TRD_CD " ).append("\n"); 
		query.append("       ,B1.SUB_TRD_CD " ).append("\n"); 
		query.append("       ,B1.SLAN_CD " ).append("\n"); 
		query.append("       ,B1.RLANE_CD " ).append("\n"); 
