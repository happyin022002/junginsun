...
/**
 * ESM_MAS_0175 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0175HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Choi In Kyung
 * @see ESM_MAS_0175HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0175Event extends EventSupport {
	...
	/** Constructor */
	public EsmMas0175Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmMas0175Event";
	}
