...
*@FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddGlineCopyCSQL.java
...
public class SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddGlineCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddGlineCopyCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocVOAddGlineCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
