...
*@FileName : KoreaCustomsReportDBDAOsearchImpCgoManiPrtCNTRDgClssInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchImpCgoManiPrtCNTRDgClssInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Import Cargo Manifest Print를 위한 Container Information과 DG Class Code를 조회한다.
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchImpCgoManiPrtCNTRDgClssInfoRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchImpCgoManiPrtCNTRDgClssInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", NVL(DG.CLSS,DECODE(SUBSTR(TO_CHAR(RF.CDO_TEMP),1,1),'-',TO_CHAR(RF.CDO_TEMP)||'℃','0','0'||'℃',NULL,NULL,'+'||TO_CHAR(RF.CDO_TEMP)||'℃')) DG_CLSS" ).append("\n"); 
		...
		query.append("(SELECT DISTINCT CNTR_NO, CDO_TEMP" ).append("\n"); 
		query.append("FROM BKG_RF_CGO" ).append("\n"); 
		query.append("WHERE BKG_NO = @[bkg_no]) RF" ).append("\n"); 
