...
*@FileName : RsltPriRpAfilVO.java
*@FileTitle : RsltPriRpAfilVO
*Open Issues :
*Change history :
...
public class RsltPriRpAfilVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRpAfilVO> models = new ArrayList<RsltPriRpAfilVO>();
	 ...
	 * @param request
	 * @return RsltPriRpAfilVO[]
	 */
	public RsltPriRpAfilVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRpAfilVO[]
	 */
	public RsltPriRpAfilVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRpAfilVO model = null;
	 ...
	 * @return RsltPriRpAfilVO[]
	 */
	public RsltPriRpAfilVO[] getRsltPriRpAfilVOs(){
		RsltPriRpAfilVO[] vos = (RsltPriRpAfilVO[])models.toArray(new RsltPriRpAfilVO[models.size()]);
		return vos;
	}
