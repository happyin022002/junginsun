...
*@FileName : KrWhfBkgInfoCondVO.java
*@FileTitle : KrWhfBkgInfoCondVO
*Open Issues :
*Change history :
...
public class KrWhfBkgInfoCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfBkgInfoCondVO> models = new ArrayList<KrWhfBkgInfoCondVO>();
	...
	public KrWhfBkgInfoCondVO() {}

	public KrWhfBkgInfoCondVO(String ibflag, String pagerows, String whfBndCd, String vvd, String portCd, String podCd, String amount, String polCd, String bkgNo, String blNo) {
		this.amount = amount;
		this.podCd = podCd;
		this.vvd = vvd;
		this.bkgNo = bkgNo;
	 ...
	 */
	public KrWhfBkgInfoCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfBkgInfoCondVO[]
	 */
	public KrWhfBkgInfoCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfBkgInfoCondVO model = null;
	 ...
	 * @return KrWhfBkgInfoCondVO[]
	 */
	public KrWhfBkgInfoCondVO[] getKrWhfBkgInfoCondVOs(){
		KrWhfBkgInfoCondVO[] vos = (KrWhfBkgInfoCondVO[])models.toArray(new KrWhfBkgInfoCondVO[models.size()]);
		return vos;
	}
