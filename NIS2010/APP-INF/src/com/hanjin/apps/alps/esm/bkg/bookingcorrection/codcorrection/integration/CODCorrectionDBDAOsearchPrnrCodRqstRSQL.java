...
public class CODCorrectionDBDAOsearchPrnrCodRqstRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", to_char(GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL', SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(cod.cod_rqst_ofc_cd)), 'yyyy/mm/dd') rqst_dt" ).append("\n"); 
		query.append(", (select CRR_CD from mdm_vsl_cntr vsl where vsl.vsl_cd = rhnd_vvd.vsl_cd) carrier_cd" ).append("\n"); 
		query.append(", 'HJS' operation_team" ).append("\n"); 
