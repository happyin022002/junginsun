...
*@FileName : ESM_BKG_0986HTMLAction.java
 ...
 * @see EsmBkg0986Event 참조
 * @since J2EE 1.5
 */

public class ESM_BKG_0986HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0986HTMLAction 객체를 생성
     */
    public ESM_BKG_0986HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0986Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0986Event event = new EsmBkg0986Event();
