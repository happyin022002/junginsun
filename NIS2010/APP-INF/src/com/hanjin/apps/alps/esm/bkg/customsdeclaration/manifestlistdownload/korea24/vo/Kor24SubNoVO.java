...
*@FileName : Kor24SubNoVO.java
*@FileTitle : Kor24SubNoVO
*Open Issues :
*Change history :
...
public class Kor24SubNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24SubNoVO> models = new ArrayList<Kor24SubNoVO>();
	...
	public Kor24SubNoVO(String ibflag, String pagerows, String subNo, String inVvd, String ibPort, String podTmlCd) {
		this.inVvd = inVvd;
...
/**
	 ...
	 * @return Kor24SubNoVO[]
	 */
	public Kor24SubNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24SubNoVO[]
	 */
	public Kor24SubNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24SubNoVO model = null;
	 ...
	 * @return Kor24SubNoVO[]
	 */
	public Kor24SubNoVO[] getKor24SubNoVOs(){
		Kor24SubNoVO[] vos = (Kor24SubNoVO[])models.toArray(new Kor24SubNoVO[models.size()]);
		return vos;
	}
