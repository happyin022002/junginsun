...
*@FileName : ESM_BKG_00502HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0502HTMLAction extends HTMLActionSupport 
{

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0215HTMLAction 객체를 생성
	 */
	public ESM_BKG_0502HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0502Event event = new EsmBkg0502Event();
    	
    	if(command.isCommand(FormCommand.SEARCH)) {
			event.setKorTransHistVO((KorTransHistVO)getVO(request, KorTransHistVO.class));
    	} 
