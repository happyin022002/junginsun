 ...
 *
 * @author 김경섭 
 * @see ESM_BKG_1186HTMLAction 참조
 * @since J2EE 1.4 
 */

public class EsmBkg1186Event extends EventSupport {

	/** Table Value Object 조회 조건 및 단건 처리  */
	private VgmStatusReportVO infoVO = null;
	
	/** Table Value Object Multi Data 처리 */
	private VgmStatusReportVO[] infoVOs = null;
	
	
	public VgmStatusReportVO getInfoVO() {
		return infoVO;
	}

	public void setInfoVO(VgmStatusReportVO infoVO) {
		this.infoVO = infoVO;
	}

	public EsmBkg1186Event(){}
	
	private static final long serialVersionUID = 1L;
	
	//2015.03.01 Secure Coding 적용 [CWE-495]
	public VgmStatusReportVO[] getInfoVOs() {
		VgmStatusReportVO[] rtnVOs = null;
		if (this.infoVOs != null) {
			rtnVOs = new VgmStatusReportVO[infoVOs.length];
	...
	public void setInfoVOs(VgmStatusReportVO[] infoVOs) {
		if (infoVOs != null) {
			VgmStatusReportVO[] tmpVOs = new VgmStatusReportVO[infoVOs.length];
