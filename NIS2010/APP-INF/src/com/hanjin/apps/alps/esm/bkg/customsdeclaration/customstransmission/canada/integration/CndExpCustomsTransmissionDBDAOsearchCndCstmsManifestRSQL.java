...
*@FileName : CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchCndCstmsManifestRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,(SELECT TO_CHAR(Z1.VPS_ETD_DT,'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		...
		query.append("  FROM  BKG_CSTMS_AMER_BL A" ).append("\n"); 
		query.append("       ,BKG_CSTMS_AMER_CNTR B" ).append("\n"); 
		...
		query.append("   AND  L1.IO_BND_CD(+) = 'O'" ).append("\n"); 
