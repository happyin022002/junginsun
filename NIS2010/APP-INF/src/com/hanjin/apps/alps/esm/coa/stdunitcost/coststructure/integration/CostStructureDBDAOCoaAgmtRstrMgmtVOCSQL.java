...
*@FileName : CostStructureDBDAOCoaAgmtRstrMgmtVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOCoaAgmtRstrMgmtVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostStructureDBDAOCoaAgmtRstrMgmtVOCSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOCoaAgmtRstrMgmtVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO COA_AGMT_RSTR_MGMT B1" ).append("\n"); 
