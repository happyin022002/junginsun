...
*@FileName : NetworkCostDBDAOModifyOwnDailyHireCreationStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOModifyOwnDailyHireCreationStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOModifyOwnDailyHireCreationStatusUSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOModifyOwnDailyHireCreationStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   ,'OWDH' CM_UC_CD" ).append("\n"); 
