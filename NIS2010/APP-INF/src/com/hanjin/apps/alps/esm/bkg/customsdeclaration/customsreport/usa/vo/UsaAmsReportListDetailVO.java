...
public class UsaAmsReportListDetailVO extends AmsReportListDetailVO {
	...
	/* Column Info */
	private String cgoDestTypeNm = null;
	/* Column Info */
	private String cstmsClrTpNm = null;
	/* Column Info */
	private String chkQty = null;
	/* Column Info */
	...
	public UsaAmsReportListDetailVO(String ibflag, String pagerows, String cntCd, String dspoCd, String mblNo, String amsFileNo, String filer, String mfStsCd, String cstmsMfTpCd, String podCd, String delCd, String hubLocCd, String cntrNo, String cntrTpszCd, String frtCltFlg, String oblRdemFlg, String ibdTrspNo, String ibdTrspTpCd, String freeTrdZnFlg, String ibdTrspIssDt, String ibdTrspAcptDt, String ibdTrspArrDt, String ibdTrspArrAcptDt, String ibdTrspXptDt, String ibdTrspXptAcptDt, String rcvTermCd, String deTermCd, String arrDt, String scNo, String cstmsDspoNm, String polCd, String bkgNo, String vvd, String railCrrRefNo, String usaIbTrspNo, String pkupNo, String pkupReleased, String pkupDate, String cstmsClrCd, String rnum, String total, String bkgCustTpCd, String seq, String blCnt, String custNm, String cntrPrtFlg, String master, String rlseEdi, String sumCmQty, String rQty, String rlseQty, String rBilling, String feu, String teu, String cFlag, String cgoDestTypeNm, String cstmsClrTpNm, String chkQty, String taaNo, String tPolEtd, String tPodEta) {
		...
		this.teu = teu;
		this.cFlag = cFlag;
		this.cgoDestTypeNm = cgoDestTypeNm;
		this.cstmsClrTpNm = cstmsClrTpNm;
		this.chkQty = chkQty;
		this.taaNo = taaNo;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cgo_dest_type_nm", getCgoDestTypeNm());
		this.hashColumns.put("cstms_clr_tp_nm", getCstmsClrTpNm());		
		this.hashColumns.put("chk_qty", getChkQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cgo_dest_type_nm", "cgoDestTypeNm");
		this.hashFields.put("cstms_clr_tp_nm", "cstmsClrTpNm");
		this.hashFields.put("chk_qty", "chkQty");
	...
	/**
	 * Column Info
	 * @return cgoDestTypeNm
	 */
	public String getCgoDestTypeNm() {
		return cgoDestTypeNm;
	}

	/**
	 * Column Info
	 * @return getCstmsClrTpNm
	 */
	public String getCstmsClrTpNm() {
		return cstmsClrTpNm;
	}
	 ...
	 * @param cgoDestTypeNm
	 */
	public void setCgoDestTypeNm(String cgoDestTypeNm) {
		cgoDestTypeNm = cgoDestTypeNm;
	}
	 ...
	 * @param cstmsClrTpNm
	 */
	public void setCstmsClrTpNm(String cstmsClrTpNm) {
		cstmsClrTpNm = cstmsClrTpNm;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCgoDestTypeNm(JSPUtil.getParameter(request, prefix + "cgo_dest_type_nm", ""));
		setCstmsClrTpNm(JSPUtil.getParameter(request, prefix + "cstms_clr_tp_nm", ""));		
		setChkQty(JSPUtil.getParameter(request, prefix + "chk_qty", ""));
	...
	public UsaAmsReportListDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cgoDestTypeNm = (JSPUtil.getParameter(request, prefix	+ "cgo_dest_type_nm", length));
			String[] cstmsClrTpNm = (JSPUtil.getParameter(request, prefix	+ "cstms_clr_tp_nm", length));
			String[] chkQty = (JSPUtil.getParameter(request, prefix	+ "chk_qty", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (cgoDestTypeNm[i] != null)
					model.setCgoDestTypeNm(cgoDestTypeNm[i]);
				if (cstmsClrTpNm[i] != null)
					model.setCstmsClrTpNm(cstmsClrTpNm[i]);				
				if (chkQty[i] != null)
					model.setChkQty(chkQty[i]);			
				if (taaNo[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.cgoDestTypeNm = this.cgoDestTypeNm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.cstmsClrTpNm = this.cstmsClrTpNm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
		this.chkQty = this.chkQty.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
