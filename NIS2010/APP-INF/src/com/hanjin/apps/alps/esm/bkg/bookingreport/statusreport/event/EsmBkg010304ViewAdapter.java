 ...
 * @since J2EE 1.6
 */
public class EsmBkg010304ViewAdapter extends ViewAdapter {
...
//	                boolean isSave = isSaveCommand(event);
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("rf_cmdt")) 	.append(" ]]></TD>\n");  // Commodity 
			...
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("fdo_temp")) 	.append("]]></TD>\n"); 	// Temp      
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("humid_no")) 	.append("]]></TD>\n"); 	// Humid(%)  
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("cntr_vent_tp_cd")).append("]]></TD>\n"); // Vent      
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("ctrl_atms_flg"), " ")) 	.append("]]></TD>\n"); // CA        
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("modi_atms_flg"), " ")) 	.append("]]></TD>\n"); // HM        
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("humid_ctrl_flg"), " ")) 	.append("]]></TD>\n"); // HT
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("atfc_atms_flg"), " ")) 	.append("]]></TD>\n"); // HT  
			...
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("cdo_temp")) 	.append("]]></TD>\n"); 	// C         
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("fdo_temp")) 	.append("]]></TD>\n"); 	// F         
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("vltg_no")) 	.append("]]></TD>\n"); 	// Voltage   
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pwr_spl_cbl_flg")).append("]]></TD>\n"); // Gen       
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("ctrl_atms_flg"), " ")) 	.append("]]></TD>\n"); // CA        
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("modi_atms_flg"), " ")) 	.append("]]></TD>\n"); // HM        
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("humid_ctrl_flg"), " ")) 	.append("]]></TD>\n"); // HT
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("atfc_atms_flg"), " ")) 	.append("]]></TD>\n"); // HT
