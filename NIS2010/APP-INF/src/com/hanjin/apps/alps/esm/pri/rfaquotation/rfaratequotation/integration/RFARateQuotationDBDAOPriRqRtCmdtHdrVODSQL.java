...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtHdrVODSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtHdrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtHdrVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtHdrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
