...
*@FileName : EBookingReceiptDBDAOModifyPreviousBookingRequestStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOModifyPreviousBookingRequestStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOModifyPreviousBookingRequestStatusUSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOModifyPreviousBookingRequestStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND BKG_UPLD_STS_CD = 'N'" ).append("\n"); 
		query.append("AND SYS_UPLD_FLG = 'N'" ).append("\n"); 
