...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriRtVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriRtVO Update
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriRtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_GRI_RT SET " ).append("\n"); 
		query.append("	RAT_UT_CD = @[rat_ut_cd]" ).append("\n"); 
		query.append(",	PRC_CGO_TP_CD = @[prc_cgo_tp_cd]" ).append("\n"); 
		query.append(",	CURR_CD = @[curr_cd]" ).append("\n"); 
		query.append(",	GRI_RT_AMT = @[gri_rt_amt]" ).append("\n"); 
		query.append(",	GRI_RT_RTO = @[gri_rt_rto]" ).append("\n"); 
