...
*@FileName : ESM_COA_0148HTMLAction.java
...
public class ESM_COA_0148HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0148HTMLAction 객체를 생성
	 */
	public ESM_COA_0148HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0148Event event = new EsmCoa0148Event();
		

		event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setBKGDetail0148VO((BKGDetail0148VO)getVO(request, BKGDetail0148VO .class));
		}
