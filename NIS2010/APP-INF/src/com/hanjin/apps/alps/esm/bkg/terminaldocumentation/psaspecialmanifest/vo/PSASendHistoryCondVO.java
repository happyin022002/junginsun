...
*@FileName : PSASendHistoryCondVO.java
*@FileTitle : PSASendHistoryCondVO
*Open Issues :
*Change history :
...
public class PSASendHistoryCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSASendHistoryCondVO> models = new ArrayList<PSASendHistoryCondVO>();
	...
	public PSASendHistoryCondVO() {}

	public PSASendHistoryCondVO(String ibflag, String pagerows, String dType, String vvdCd, String portCd, String sndDtFrom, String sndDtTo, String blNo, String cntrNo, String msgType, String callGubun, String rcvData) {
...
/**
	 ...
	 */
	public PSASendHistoryCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSASendHistoryCondVO[]
	 */
	public PSASendHistoryCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSASendHistoryCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PSASendHistoryCondVO();
				if (callGubun[i] != null)
		...
		return getPSASendHistoryCondVOs();
	}
	 ...
	 * @return PSASendHistoryCondVO[]
	 */
	public PSASendHistoryCondVO[] getPSASendHistoryCondVOs(){
		PSASendHistoryCondVO[] vos = (PSASendHistoryCondVO[])models.toArray(new PSASendHistoryCondVO[models.size()]);
		return vos;
	}
