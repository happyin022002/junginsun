...
*@FileName : Kor24CustomsTransmissionDBDAOsearchMaxPortalSndLogSeqRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchMaxPortalSndLogSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchMaxPortalSndLogSeqRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchMaxPortalSndLogSeqRSQL").append("\n");
		query.append("*/").append("\n");
	}
