...
*@FileName : RFARateProposalDBDAOPriRpScpRtRoutViaAmdBasicVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtRoutViaAmdBasicVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Master RFA에서 가져온 Rate Route Via 데이터를 Basic Rate에 넣는다.
	  * Basic이 가지고 있는 Route만 수행한다.
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtRoutViaAmdBasicVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtRoutViaAmdBasicVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       PRI_RP_SCP_RT_ROUT_VIA M,-- Master" ).append("\n"); 
		query.append("       BASIC_RFA_INFO BSC_INFO," ).append("\n"); 
		query.append("       PRI_RP_SCP_RT_ROUT_VIA B -- Basic" ).append("\n"); 
		...
		query.append("   AND B.ROUT_VIA_SEQ = M.ROUT_VIA_SEQ" ).append("\n"); 
