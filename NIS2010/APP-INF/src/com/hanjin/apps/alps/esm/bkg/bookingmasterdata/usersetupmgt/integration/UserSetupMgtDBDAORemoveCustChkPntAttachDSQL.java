...
*@FileName : UserSetupMgtDBDAORemoveCustChkPntAttachDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAORemoveCustChkPntAttachDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAORemoveCustChkPntAttachDSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAORemoveCustChkPntAttachDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_ATCH_FILE" ).append("\n"); 
