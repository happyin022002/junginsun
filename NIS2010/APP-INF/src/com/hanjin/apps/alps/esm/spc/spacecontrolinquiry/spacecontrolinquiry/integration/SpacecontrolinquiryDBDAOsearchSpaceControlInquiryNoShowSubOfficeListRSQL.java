...
*@FileName : SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowSubOfficeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowSubOfficeListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchSpaceControlInquiryNoShowSubOfficeList
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowSubOfficeListRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAOsearchSpaceControlInquiryNoShowSubOfficeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       AND V.SLS_YRMON = P.P_YEAR||P.R_MONTH" ).append("\n"); 
		...
		query.append("           PARAMS      P" ).append("\n"); 
		query.append("#if (${mon_flg} == 'Y')" ).append("\n"); 
		query.append("     WHERE V.SLS_YRMON = P.P_YEAR||P.R_MONTH" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		...
		query.append("       AND P.VVD      IS NULL" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(", NSHW_DATA_SUB AS (" ).append("\n"); 
		query.append("    SELECT R.SLS_RGN_OFC_CD AS RGN_OFC_CD," ).append("\n"); 
		query.append("           R.SLS_OFC_CD     AS OFC_CD    ," ).append("\n"); 
		...
		query.append("           SPC_GET_NSHW_SHRTFLL_FNC('D', SUM(R.FCAST_LOD_QTY), SUM(R.ALOC_LOD_QTY), SUM(R.BKG_LOD_QTY)) AS SHORTFALL," ).append("\n"); 
		query.append("           5 AS LVL" ).append("\n"); 
		query.append("      FROM SPC_NSHW_RSLT R," ).append("\n"); 
		query.append("           VVDS          P" ).append("\n"); 
		query.append("     WHERE R.ALOC_DDCT_BSE_CD = P.TYPE" ).append("\n"); 
		query.append("       AND R.OFC_KND_CD       = '4'" ).append("\n"); 
		...
		query.append("  GROUP BY R.SLS_RGN_OFC_CD," ).append("\n"); 
		...
		query.append("    SELECT R.SLS_OFC_CD AS RGN_OFC_CD," ).append("\n"); 
		...
		query.append("           DECODE(R.TRD_CD, NULL, 0, 1) + DECODE(R.RLANE_CD, NULL, 0, 1) + DECODE(R.VSL_CD, NULL, 0, 1) + DECODE(R.SLS_OFC_CD, NULL, 0, 1) AS LVL" ).append("\n"); 
		query.append("      FROM NSHW_DATA_OFC R" ).append("\n"); 
		query.append("  GROUP BY GROUPING SETS (" ).append("\n"); 
		query.append("                           (R.TRD_CD, R.SUB_TRD_CD, R.RLANE_CD, R.VSL_CD, R.SKD_VOY_NO, R.SKD_DIR_CD, R.DIR_CD, R.COST_YR, R.COST_WK, R.SLS_OFC_CD)," ).append("\n"); 
		query.append("                           (R.TRD_CD, R.SUB_TRD_CD, R.RLANE_CD, R.VSL_CD, R.SKD_VOY_NO, R.SKD_DIR_CD, R.DIR_CD, R.COST_YR, R.COST_WK)," ).append("\n"); 
		query.append("                           (R.TRD_CD, R.SUB_TRD_CD, R.RLANE_CD)," ).append("\n"); 
		query.append("                           (R.TRD_CD)" ).append("\n"); 
		query.append("                         )" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("         RATIO, LVL" ).append("\n"); 
		query.append("    FROM (" ).append("\n"); 
		query.append("            SELECT R.RGN_OFC_CD   ," ).append("\n"); 
		...
		query.append("                   R.COST_YR      ," ).append("\n"); 
		query.append("                   R.COST_WK      ," ).append("\n"); 
		query.append("                   R.FCAST_LOD_QTY," ).append("\n"); 
		query.append("                   R.ALOC_LOD_QTY ," ).append("\n"); 
		query.append("                   R.BKG_LOD_QTY  ," ).append("\n"); 
		query.append("                   R.SHORTFALL    ," ).append("\n"); 
		query.append("                   TO_CHAR(ROUND(DECODE(R.FCAST_LOD_QTY, 0, 0, R.SHORTFALL / R.FCAST_LOD_QTY * 100), 2), 'FM99990.00') AS RATIO," ).append("\n"); 
		query.append("                   R.LVL" ).append("\n"); 
		query.append("              FROM NSHW_DATA R" ).append("\n"); 
		query.append("            UNION ALL" ).append("\n"); 
		query.append("            SELECT R.RGN_OFC_CD   ," ).append("\n"); 
		query.append("                   R.OFC_CD       ," ).append("\n"); 
		query.append("                   R.TRD_CD       ," ).append("\n"); 
		...
		query.append("                   TO_CHAR(ROUND(DECODE(R.FCAST_LOD_QTY, 0, 0, R.SHORTFALL / R.FCAST_LOD_QTY * 100), 2), 'FM99990.00') AS RATIO," ).append("\n"); 
		query.append("                   R.LVL" ).append("\n"); 
		query.append("              FROM NSHW_DATA_SUB R" ).append("\n"); 
		query.append("         )" ).append("\n"); 
		query.append("ORDER BY NVL(TRD_CD    , ' ')," ).append("\n"); 
		query.append("		 NVL(SUB_TRD_CD    , ' ')," ).append("\n"); 
		query.append("         NVL(RLANE_CD  , ' ')," ).append("\n"); 
		query.append("         NVL(COST_YR   , ' ')," ).append("\n"); 
		query.append("         NVL(COST_WK   , ' ')," ).append("\n"); 
		query.append("         NVL(VVD       , ' ')," ).append("\n"); 
		query.append("		 NVL(DIR_CD    , ' ')," ).append("\n"); 
		query.append("         NVL(RGN_OFC_CD, ' ')," ).append("\n"); 
		query.append("         NVL(DECODE(OFC_CD, RGN_OFC_CD, '1', OFC_CD), ' ')" ).append("\n"); 
