...
public class ESM_PRI_0070HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0070Event event = new EsmPri0070Event();

		if (command.isCommand(FormCommand.MODIFY01)) {
			event.setPriSpScpRtActCustVOS((PriSpScpRtActCustVO[]) getVOs(request, PriSpScpRtActCustVO.class, ""));
