...
public class RsltAuthorityVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltAuthorityVO> models = new ArrayList<RsltAuthorityVO>();
	...
	public RsltAuthorityVO() {}

	public RsltAuthorityVO(String ibflag, String pagerows, String reqUsrFlg, String aproUsrFlg) {
		this.ibflag = ibflag;
	 ...
	 */
	public RsltAuthorityVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltAuthorityVO[]
	 */
	public RsltAuthorityVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltAuthorityVO model = null;
	 ...
	 * @return RsltAuthorityVO[]
	 */
	public RsltAuthorityVO[] getRsltAuthorityVOs(){
		RsltAuthorityVO[] vos = (RsltAuthorityVO[])models.toArray(new RsltAuthorityVO[models.size()]);
		return vos;
	}
