...
*@FileName : CsScreenDBDAOsearchCstmsClearInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CsScreenDBDAOsearchCstmsClearInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchCstmsClearInfo 조회
	  * </pre>
	  */
	public CsScreenDBDAOsearchCstmsClearInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CsScreenDBDAOsearchCstmsClearInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,TO_CHAR(B.CSTMS_CLR_LST_DT,'YYYY/MM/DD HH24:MI')   AS CSTMS_CLR_LST_DT" ).append("\n"); 
