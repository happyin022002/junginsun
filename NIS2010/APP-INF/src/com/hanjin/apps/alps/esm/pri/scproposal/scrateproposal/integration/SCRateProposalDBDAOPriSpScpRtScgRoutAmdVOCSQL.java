...
*@FileName : SCRateProposalDBDAOPriSpScpRtScgRoutAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtScgRoutAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCRateProposalDBDAOPriSpScpRtScgRoutAmdVOCSQL
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtScgRoutAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtScgRoutAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SCG.RCV_TERM_CD," ).append("\n"); 
		query.append("SCG.DE_TERM_CD," ).append("\n"); 
		query.append("@[cre_usr_id]           ," ).append("\n"); 
		query.append("SYSDATE                 ," ).append("\n"); 
		query.append("@[upd_usr_id]           ," ).append("\n"); 
		query.append("SYSDATE" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("PRI_SP_SCP_RT_SCG_ROUT SCG," ).append("\n"); 
