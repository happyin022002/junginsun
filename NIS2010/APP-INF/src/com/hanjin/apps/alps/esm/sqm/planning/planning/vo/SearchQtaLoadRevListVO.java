...
public class SearchQtaLoadRevListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String paCmUAmt = null;
	/* Column Info */
	private String raCmUAmt = null;
	/* Column Info */
	...
	public SearchQtaLoadRevListVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String qtaStepCd, String qtaVerNo, String trdCd, String rlaneCd, String dirCd, String vvd, String vslCd, String skdVoyNo, String skdDirCd, String convDirCd, String subTrdCd, String fnlBsaCapa, String ldfRto, String grsRpbRev, String paCmUcAmt, String raCmUcAmt, String bseWk, String hulBndCd, String paCmUAmt, String raCmUAmt, String lodQty, String gRev, String paCmC, String raCmC, String paCm, String raCm) {
		...
		this.paCm = paCm;
		this.paCmUAmt = paCmUAmt;
		this.raCmUAmt = raCmUAmt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pa_cm_u_amt", getPaCmUAmt());
		this.hashColumns.put("ra_cm_u_amt", getRaCmUAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pa_cm_u_amt", "paCmUAmt");
		this.hashFields.put("ra_cm_u_amt", "raCmUAmt");
	 ...
	 * @return paCmUAmt
	 */
	public String getPaCmUAmt() {
		return this.paCmUAmt;
	}
	 ...
	 * @return raCmUAmt
	 */
	public String getRaCmUAmt() {
		return this.raCmUAmt;
	}
	 ...
	 * @param paCmUAmt
	 */
	public void setPaCmUAmt(String paCmUAmt) {
		this.paCmUAmt = paCmUAmt;
	}
	 ...
	 * @param raCmUAmt
	 */
	public void setRaCmUAmt(String raCmUAmt) {
		this.raCmUAmt = raCmUAmt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPaCmUAmt(JSPUtil.getParameter(request, prefix + "pa_cm_u_amt", ""));
		setRaCmUAmt(JSPUtil.getParameter(request, prefix + "ra_cm_u_amt", ""));
	...
	public SearchQtaLoadRevListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] paCmUAmt = (JSPUtil.getParameter(request, prefix	+ "pa_cm_u_amt", length));
			String[] raCmUAmt = (JSPUtil.getParameter(request, prefix	+ "ra_cm_u_amt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (paCmUAmt[i] != null)
					model.setPaCmUAmt(paCmUAmt[i]);
				if (raCmUAmt[i] != null)
					model.setRaCmUAmt(raCmUAmt[i]);
				if (skdDirCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.paCmUAmt = this.paCmUAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.raCmUAmt = this.raCmUAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
