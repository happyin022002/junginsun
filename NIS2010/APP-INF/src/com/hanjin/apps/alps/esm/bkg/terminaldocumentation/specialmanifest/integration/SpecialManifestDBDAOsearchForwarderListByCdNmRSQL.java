...
*@FileName : SpecialManifestDBDAOsearchForwarderListByCdNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialManifestDBDAOsearchForwarderListByCdNmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialManifestDBDAOsearchForwarderListByCdNmRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialManifestDBDAOsearchForwarderListByCdNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", ANR_FWRD_ID OLD_ANR_FWRD_ID" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${anr_fwrd_id} != '')" ).append("\n"); 
		query.append("AND	UPPER(ANR_FWRD_ID) LIKE '%' || UPPER(@[anr_fwrd_id]) || '%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${fwrd_nm} != '')" ).append("\n"); 
		query.append("AND	UPPER(FWRD_NM) LIKE '%' || UPPER(@[fwrd_nm]) || '%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("ORDER BY ANR_FWRD_ID" ).append("\n"); 
