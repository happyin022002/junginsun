...
*@FileName : KorOrgBlVO.java
*@FileTitle : KorOrgBlVO
*Open Issues :
*Change history :
...
public class KorOrgBlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorOrgBlVO> models = new ArrayList<KorOrgBlVO>();
	...
	public KorOrgBlVO(String ibflag, String pagerows, String blNo, String portTmlCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return KorOrgBlVO[]
	 */
	public KorOrgBlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorOrgBlVO[]
	 */
	public KorOrgBlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorOrgBlVO model = null;
	 ...
	 * @return KorOrgBlVO[]
	 */
	public KorOrgBlVO[] getKorOrgBlVOs(){
		KorOrgBlVO[] vos = (KorOrgBlVO[])models.toArray(new KorOrgBlVO[models.size()]);
		return vos;
	}
