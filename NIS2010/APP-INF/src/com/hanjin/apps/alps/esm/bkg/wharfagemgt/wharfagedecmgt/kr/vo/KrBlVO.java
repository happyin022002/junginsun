...
public class KrBlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrBlVO> models = new ArrayList<KrBlVO>();
	...
	public KrBlVO(String ibflag, String pagerows, String blNo, String bkgNo, String vslCd, String skdVoyNo, String skdDirCd, 
			String polCd, String podCd, String porCd, String delCd, String bkgStsCd, String rcvTermCd, String deTermCd, 
			String pckQty, String pckTpCd, String actWgt, String wgtUtCd, String measQty, String measUtCd, String revenue, 
			String amount, String whfBndCd) {
	 ...
	 * @return KrBlVO[]
	 */
	public KrBlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrBlVO[]
	 */
	public KrBlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrBlVO model = null;
	 ...
	 * @return KrBlVO[]
	 */
	public KrBlVO[] getKrBlVOs(){
		KrBlVO[] vos = (KrBlVO[])models.toArray(new KrBlVO[models.size()]);
		return vos;
	}
