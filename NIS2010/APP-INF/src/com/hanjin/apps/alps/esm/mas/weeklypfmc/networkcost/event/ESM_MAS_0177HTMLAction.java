...
*@FileName : ESM_MAS_0177HTMLAction.java
...
public class ESM_MAS_0177HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0177HTMLAction 객체를 생성
	 */
	public ESM_MAS_0177HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0177Event event = new EsmMas0177Event();
