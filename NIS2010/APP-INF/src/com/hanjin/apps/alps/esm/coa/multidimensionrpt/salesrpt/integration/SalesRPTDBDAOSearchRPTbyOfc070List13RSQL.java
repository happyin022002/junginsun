...
public class SalesRPTDBDAOSearchRPTbyOfc070List13RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  ,ROUND(COA_BKG_OP,10)                                 AS COA_BKG_OP " ).append("\n"); 
		query.append("  ,ROUND(QTA_BKG_OP,10)                                 AS QTA_BKG_OP " ).append("\n"); 
		query.append("  ,ROUND(COA_BKG_OP + BALANCE_SVC+BALANCE_CONT,10)      AS COA_OP  " ).append("\n"); 
		...
		query.append("  ,ROUND(COA_CM + BALANCE_SVC + BALANCE_CONT,10)        AS COA_BRANCH_CM  /*(COA_CM+NET_STP_REV)*/ " ).append("\n"); 
		...
		query.append("  ,ROUND(DECODE(COA_LOAD,0,0,COA_BKG_OP/COA_LOAD),10)   AS COA_OPB      " ).append("\n"); 
		...
		query.append("  ,ROUND(DECODE(SIGN(QTA_CM),   -1,DECODE(SIGN((COA_CM + BALANCE_SVC + BALANCE_CONT)),-1,DECODE(QTA_CM,0,0,1+(QTA_CM-(COA_CM + BALANCE_SVC + BALANCE_CONT))/QTA_CM)),DECODE(SIGN((COA_CM + BALANCE_SVC + BALANCE_CONT)),1,DECODE(QTA_CM,0,0,(COA_CM + BALANCE_SVC + BALANCE_CONT)/QTA_CM)))*100,10)        AS BRANCH_CM_CHNG " ).append("\n"); 
		query.append("  ,ROUND(DECODE(SIGN(QTA_BKG_OP),-1,DECODE(SIGN((COA_BKG_OP + BALANCE_SVC + BALANCE_CONT)),-1,DECODE(QTA_BKG_OP,0,0,1+(QTA_BKG_OP-(COA_BKG_OP + BALANCE_SVC + BALANCE_CONT))/QTA_BKG_OP)),DECODE(SIGN((COA_BKG_OP + BALANCE_SVC + BALANCE_CONT)),1,DECODE(QTA_BKG_OP,0,0,(COA_BKG_OP + BALANCE_SVC + BALANCE_CONT)/QTA_BKG_OP)))*100,10)    AS COA_OP_CHNG " ).append("\n"); 
		query.append("  ,ROUND(DECODE(SIGN(QTA_BKG_OP),-1,DECODE(SIGN(COA_BKG_OP),-1,DECODE(QTA_BKG_OP,0,0,1+(QTA_BKG_OP-COA_BKG_OP)/QTA_BKG_OP)),DECODE(SIGN(COA_BKG_OP),1,DECODE(QTA_BKG_OP,0,0,COA_BKG_OP/QTA_BKG_OP)))*100,10) AS BKG_OP_CHNG " ).append("\n"); 
		query.append("  ,ROUND((DECODE(COA_LOAD,0,0,COA_REV/COA_LOAD) - DECODE(QTA_LOAD,0,0,QTA_REV/QTA_LOAD)),10)                       AS RPB_CHNG " ).append("\n"); 
		query.append("  ,ROUND(DECODE(COA_LOAD,0,0,COA_BKG_OP/COA_LOAD)-DECODE(QTA_LOAD,0,0,QTA_BKG_OP/QTA_LOAD),10)                     AS OPB_CHNG " ).append("\n"); 
		...
		query.append("  ,ROUND(DECODE(COA_BKG_OP,0,0,NVL(RATIO_TO_REPORT(COA_BKG_OP) OVER(),0)* 100),5)                                 AS COA_OP_SHARE " ).append("\n"); 
		...
		query.append("      ,NVL(SUM(TOT_REV-CM_COST-OP_COST),0) AS COA_BKG_OP " ).append("\n"); 
		...
		query.append("          ,SUM(DECODE(SUBSTR(A2.CNTR_TPSZ_CD,-1,1),'2',NVL(A2.BKG_QTY,0),'3',NVL(A2.BKG_QTY,0),NVL(A2.BKG_QTY,0)*2)) AS COA_QTY " ).append("\n"); 
