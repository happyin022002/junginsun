...
*@FileName : UnmatchBLDBDAORsltSearchAuditByHangerInstallationListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAORsltSearchAuditByHangerInstallationListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchAuditByHangerInstallationListVO
	  * </pre>
	  */
	public UnmatchBLDBDAORsltSearchAuditByHangerInstallationListVORSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAORsltSearchAuditByHangerInstallationListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    SELECT	(SELECT DECODE(BL.BDR_FLG, 'Y', 'Yes', 'No') FROM BKG_BL_DOC BL WHERE BK.BKG_NO=BL.BKG_NO)  BDR_FLG," ).append("\n"); 
		...
		query.append("    AND    CASE" ).append("\n"); 
		query.append("                WHEN    BK.TAA_NO IS NOT NULL THEN  BK.TAA_NO" ).append("\n"); 
		query.append("                WHEN    BK.RFA_NO IS NOT NULL THEN  BK.TAA_NO" ).append("\n"); 
		query.append("                ELSE    BK.SC_NO" ).append("\n"); 
		...
		query.append("        #end" ).append("\n"); 
		query.append("    /*******************************************************************************************" ).append("\n"); 
		query.append("    HANGER 정보가 있는 것만 SELECT 한다." ).append("\n"); 
		query.append("    *******************************************************************************************/" ).append("\n"); 
		...
		query.append("                           BQ.CRR_HNGR_QTY > 0" ).append("\n"); 
		query.append("                           OR  BQ.MER_HNGR_QTY > 0" ).append("\n"); 
		query.append("                          )" ).append("\n"); 
		query.append("                  )  " ).append("\n"); 
		query.append("                  " ).append("\n"); 
		query.append(")   ," ).append("\n"); 
		...
		query.append("            NVL(BQ.EQ_SUBST_CNTR_TPSZ_CD, BQ.CNTR_TPSZ_CD)  CTRT_CNTR_TPSZ_CD   ," ).append("\n"); 
		query.append("            BQ.OP_CNTR_QTY          ," ).append("\n"); 
		query.append("            BQ.CRR_HNGR_SGL_BAR_QTY ," ).append("\n"); 
		query.append("            BQ.CRR_HNGR_DBL_BAR_QTY ," ).append("\n"); 
		query.append("            BQ.CRR_HNGR_TPL_BAR_QTY ," ).append("\n"); 
		query.append("            BQ.CRR_HNGR_QTY         ," ).append("\n"); 
		query.append("            BQ.MER_HNGR_QTY         ," ).append("\n"); 
		query.append("            ROW_NUMBER() OVER ( PARTITION BY BQ.BKG_NO ORDER BY NVL(BQ.EQ_SUBST_CNTR_TPSZ_CD, BQ.CNTR_TPSZ_CD) ) DP_SEQ" ).append("\n"); 
		...
		query.append("    AND     BR.CHG_CD  = 'GOH'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT   DENSE_RANK() OVER( ORDER BY 		BK.BKG_RHQ_CD        ," ).append("\n"); 
		query.append("                                            BK.BKG_OFC_CD        ," ).append("\n"); 
		...
		query.append("          AND UB.BKG_REV_AUD_TP_CD='H' " ).append("\n"); 
		...
		query.append("        BQ.CTRT_CNTR_TPSZ_CD AS CTRT_CNTR_TPSZ_CD2 ," ).append("\n"); 
		query.append("        BQ.OP_CNTR_QTY          ," ).append("\n"); 
		query.append("        BQ.CRR_HNGR_SGL_BAR_QTY ," ).append("\n"); 
		query.append("        BQ.CRR_HNGR_DBL_BAR_QTY ," ).append("\n"); 
		query.append("        BQ.CRR_HNGR_TPL_BAR_QTY ," ).append("\n"); 
		...
		query.append("         FROM   BK  ," ).append("\n"); 
		query.append("                ( SELECT ROWNUM DP_SEQ FROM DUAL CONNECT BY LEVEL <= 10 )   CP  /* 10 은 MAX 로 예상되는 상수값 */" ).append("\n"); 
