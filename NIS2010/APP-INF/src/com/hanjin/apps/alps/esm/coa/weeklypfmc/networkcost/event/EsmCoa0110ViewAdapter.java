...
*@FileName : EsmCoa0110ViewAdapter.java
*@FileTitle : EsmCoa0110ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0110ViewAdapter extends DefaultViewAdapter {
	
    public EsmCoa0110ViewAdapter(){
    	super();
    }
