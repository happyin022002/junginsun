 ...
 *@FileName : ESM_PRI_2028HTMLAction.java
...
public class ESM_PRI_2028HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2028Event event = new EsmPri2028Event();
		...
		if (command.isCommand(FormCommand.MODIFY01)) {
			...
			if ("A".equals(hdrVO.getFicRtTpCd())) {
				if ("AEE".equals(hdrVO.getSvcScpCd())) {
