...
*@FileName : RFAProposalMainDBDAOPriRpScpMnCmSummaryVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpScpMnCmSummaryVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpScpMnCmSummaryVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpScpMnCmSummaryVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_RP_SCP_MN A" ).append("\n"); 
		...
		query.append("      FROM  PRI_RP_SCP_RT_CMDT_ROUT CR" ).append("\n"); 
