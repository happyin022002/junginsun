...
*@FileName : ESM_MAS_0141HTMLAction.java
...
public class ESM_MAS_0141HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0141HTMLAction 객체를 생성
	 */
	public ESM_MAS_0141HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0141Event event = new EsmMas0141Event();	
