...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVOUSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineCustVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineCustVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_CUST SET" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}