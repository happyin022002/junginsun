...
*@FileName : SCRateProposalDBDAORsltPriSurchargeAdjustCommodityDetailVORSQL.java
...
public class SCRateProposalDBDAORsltPriSurchargeAdjustCommodityDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriSurchargeAdjustCommodityDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriSurchargeAdjustCommodityDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM  pri_sp_scp_grp_cmdt_dtl cmdt_dtl" ).append("\n"); 
