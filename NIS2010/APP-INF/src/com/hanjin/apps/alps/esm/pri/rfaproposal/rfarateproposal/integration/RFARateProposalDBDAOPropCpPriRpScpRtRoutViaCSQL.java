...
*@FileName : RFARateProposalDBDAOPropCpPriRpScpRtRoutViaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropCpPriRpScpRtRoutViaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_RT_ROUT_VIA Insert
	  * </pre>
	  */
	public RFARateProposalDBDAOPropCpPriRpScpRtRoutViaCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropCpPriRpScpRtRoutViaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
