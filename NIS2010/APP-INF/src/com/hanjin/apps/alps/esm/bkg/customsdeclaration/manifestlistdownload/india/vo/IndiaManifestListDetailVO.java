...
*@FileName : IndiaManifestListDetailVO.java
*@FileTitle : IndiaManifestListDetailVO
*Open Issues :
*Change history :
...
public class IndiaManifestListDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<IndiaManifestListDetailVO> models = new ArrayList<IndiaManifestListDetailVO>();
	...
	public IndiaManifestListDetailVO() {}

	public IndiaManifestListDetailVO(String ibflag, String pagerows, String igmNo, String igmDate, String vslNm, String etaDt, String blNo, String mergeBlNo, String groupSeq, String hblNo, String polCd, String podCd, String podNodCd, String delCd, String delNodCd, String entryTp, String destCd, String cfsCd, String ial, String modeTrans, String customerName, String blCustTp, String hblInd, String bcdDesc, String itemTp, String bdAreaCd, String trnsOprId, String idaLineNo, String vvdCd, String downCheck) {
		this.ial = ial;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setGroupSeq(JSPUtil.getParameter(request, prefix + "group_seq", ""));
		...
		setIgmDate(JSPUtil.getParameter(request, prefix + "igm_date", ""));
	 ...
	 */
	public IndiaManifestListDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return IndiaManifestListDetailVO[]
	 */
	public IndiaManifestListDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		IndiaManifestListDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new IndiaManifestListDetailVO();
				if (ial[i] != null)
					model.setIal(ial[i]);
				if (idaLineNo[i] != null)
		...
		return getIndiaManifestListDetailVOs();
	}
	...
	public IndiaManifestListDetailVO[] getIndiaManifestListDetailVOs(){
		IndiaManifestListDetailVO[] vos = (IndiaManifestListDetailVO[])models.toArray(new IndiaManifestListDetailVO[models.size()]);
		return vos;
	}
