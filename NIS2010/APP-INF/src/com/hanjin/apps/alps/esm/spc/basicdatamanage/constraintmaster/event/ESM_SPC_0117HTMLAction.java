...
*@FileName : ESM_SPC_0117HTMLAction.java
...
public class ESM_SPC_0117HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0117HTMLAction 객체를 생성
	 */
	public ESM_SPC_0117HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0117Event event = new EsmSpc0117Event();
		log.debug("***** ESM_BKG_0117HTMLAction : " + command.getCommand());
		
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO.class));
			event.setBkgInfoListVOs((BkgInfoListVO[])getVOs(request, BkgInfoListVO.class));
