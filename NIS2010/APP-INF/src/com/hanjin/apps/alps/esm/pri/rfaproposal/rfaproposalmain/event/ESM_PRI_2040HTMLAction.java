...
*@FileName : ESM_PRI_0036HTMLAction.java
...
public class ESM_PRI_2040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0036HTMLAction 객체를 생성
	 */
	public ESM_PRI_2040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2040Event event = new EsmPri2040Event();
...
//		}else 
		...
		} else if(command.isCommand(FormCommand.MULTI02)) { // ESM_PRI_2240 Master RFA Amend 
			event.setCstPriRpAmendVO((CstPriRpAmendVO)getVO(request, CstPriRpAmendVO .class));
		}
