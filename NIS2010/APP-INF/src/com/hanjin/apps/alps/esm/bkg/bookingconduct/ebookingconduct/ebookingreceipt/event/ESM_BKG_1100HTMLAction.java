...
*@FileName : ESM_BKG_1100HTMLAction.java
...
public class ESM_BKG_1100HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1100HTMLAction 객체를 생성
	 */
	public ESM_BKG_1100HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1100Event event = new EsmBkg1100Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEBookingControlMgmtVO((EBookingControlMgmtVO)getVO(request, EBookingControlMgmtVO .class));
		} else if(command.isCommand(FormCommand.MODIFY01)) {
			event.setEBookingControlMgmtVOs((EBookingControlMgmtVO[])getVOs(request, EBookingControlMgmtVO .class,""));
