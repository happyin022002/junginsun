...
*@FileName : FFCommCalculationDBDAOAddFFCommZeroSumExcluCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOAddFFCommZeroSumExcluCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FF Compensation 이 ERP 로 I/F 이후에 ACM_FAC_EXCLU_SET 을 등록 하여 지급하지 말아야 하는 Fowarder 로 등록 된 경우 
	  * - 커미션 생성 하여 ZeroSum 처리
	  * </pre>
	  */
	public FFCommCalculationDBDAOAddFFCommZeroSumExcluCSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOAddFFCommZeroSumExcluCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND (BKG_NO,BKG_FF_CNT_CD,BKG_FF_SEQ,FF_CMPN_SEQ) IN (" ).append("\n"); 
		query.append("    SELECT BKG_NO,BKG_FF_CNT_CD,BKG_FF_SEQ,MAX(FF_CMPN_SEQ)" ).append("\n"); 
		query.append("    FROM ACM_FF_CMPN" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		query.append("    AND BKG_NO = @[bkg_no]" ).append("\n"); 
		query.append("    AND FF_CMPN_STS_CD = 'IF'" ).append("\n"); 
		query.append("    GROUP BY BKG_NO,BKG_FF_CNT_CD,BKG_FF_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
