...
@WebService(name="TCharterIOInvoiceVMS0020001WSProxyPortType", serviceName="TCharterIOInvoiceVMS0020001WSProxy", targetNamespace="http://www.hanjin.com/integration/alps")
@SOAPBinding(style=SOAPBinding.Style.DOCUMENT,use=SOAPBinding.Use.LITERAL, parameterStyle=SOAPBinding.ParameterStyle.WRAPPED)
@WLHttpTransport(contextPath="/hanjin/webservices", serviceUri="/TCharterIOInvoiceVMS0020001WSProxy", portName="TCharterIOInvoiceVMS0020001WSProxyPort")
