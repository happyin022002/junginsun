...
*@FileName : IHCGuideLineDBDAOModifyIHCGuidelineConfirmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOModifyIHCGuidelineConfirmUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modify IHCGuideline confirm date
	  * </pre>
	  */
	public IHCGuideLineDBDAOModifyIHCGuidelineConfirmUSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOModifyIHCGuidelineConfirmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
