...
*@FileName : Eur24ManifestDownloadDBDAOSearchVesselArrivalNotice1RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOSearchVesselArrivalNotice1RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 구주24 Vessel Arrival Notice
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOSearchVesselArrivalNotice1RSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOSearchVesselArrivalNotice1RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          AND CSTMS_DIV_ID = 'EU_SML_STF'" ).append("\n"); 
		query.append("          AND DELT_FLG = 'N'" ).append("\n"); 
		query.append("          AND ATTR_CTNT1 = @[upd_usr_id]" ).append("\n"); 
		query.append("          AND ROWNUM = 1), 'N') AS EU_STF_FLG," ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append("  X.* ," ).append("\n"); 
		query.append("  TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC', TO_DATE(BKG_GET_TOKEN_FNC(EDI, 1),'YYYYMMDDHH24MISS')  , BKG_GET_TOKEN_FNC(EDI, 8) ), 'YYYY-MM-DD HH24:MI') AS EDI_RCV_DT," ).append("\n"); 
		query.append("  TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC', TO_DATE(BKG_GET_TOKEN_FNC(EDI, 1),'YYYYMMDDHH24MISS')  , 'GMT' ), 'YYYY-MM-DD HH24:MI') AS EDI_RCV_DT_GMT," ).append("\n"); 
		...
		query.append("                                  , 'CA', 'Add Info.', 'AL', 'Accepted with loading permission', 'H', 'Hold'" ).append("\n"); 
		...
		query.append("      TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC', EV.UPD_DT, EV.UPD_OFC_CD ), 'YYYY-MM-DD HH24:MI') UPD_DT," ).append("\n"); 
		query.append("      TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC', EV.UPD_DT, 'GMT'), 'YYYY-MM-DD HH24:MI') UPD_DT_GMT," ).append("\n"); 
		...
		query.append("            DECODE(VSL.CRR_CD, 'UAC', TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD')|| ' 12:00', 'HPL', TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD')|| ' 12:00', 'MSK', TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD')|| ' 12:00', 'EGL', TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD')|| ' 12:00', TO_CHAR(XXX.CSTMS_ESTM_ARR_DT, 'YYYY-MM-DD HH24')||':00')" ).append("\n"); 
		...
		query.append("                      END" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                 WHEN VPS.SLAN_CD = 'WA2'" ).append("\n"); 
		query.append("                 THEN" ).append("\n"); 
		query.append("                      CASE WHEN TO_CHAR(VPS.INIT_ETA_DT,'D') = '6'" ).append("\n"); 
		query.append("                           THEN TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD')|| ' 12:00'" ).append("\n"); 
		query.append("                           ELSE TO_CHAR(TRUNC(VPS.INIT_ETA_DT, 'IW') + 4, 'YYYY-MM-DD') || ' 12:00'" ).append("\n"); 
		query.append("                      END" ).append("\n"); 
		query.append("                      " ).append("\n"); 
		query.append("                 WHEN VPS.SLAN_CD = 'WAF'" ).append("\n"); 
		query.append("                 THEN" ).append("\n"); 
		query.append("                      CASE WHEN TO_CHAR(VPS.INIT_ETA_DT,'D') = '3'" ).append("\n"); 
		query.append("                           THEN TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD')|| ' 12:00'" ).append("\n"); 
		query.append("                           ELSE TO_CHAR(TRUNC(VPS.INIT_ETA_DT, 'IW') + 1, 'YYYY-MM-DD') || ' 12:00'" ).append("\n"); 
		query.append("                      END" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                ELSE " ).append("\n"); 
		query.append("                    DECODE(VSL.CRR_CD, 'UAC', TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD')|| ' 12:00', 'HPL', TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD')|| ' 12:00', 'MSK', TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD')|| ' 12:00', 'EGL', TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD')|| ' 12:00', TO_CHAR(VPS.INIT_ETA_DT, 'YYYY-MM-DD HH24')||':00')" ).append("\n"); 
		query.append("            END" ).append("\n"); 
		query.append("            " ).append("\n"); 
		...
		query.append("                                )" ).append("\n"); 
		query.append("                    ) ||','|| SND.SND_USR_ID ||','||TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC',SND.SND_DT, B.OFC_CD), 'YYYY-MM-DD HH24:MI')||','||TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC',SND.SND_DT, 'GMT'), 'YYYY-MM-DD HH24:MI')||','|| B.OFC_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("      AND VPS.CLPT_IND_SEQ = NVL(@[cstms_port_clpt_ind_seq], '1')" ).append("\n"); 
