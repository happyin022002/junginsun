...
public class RepoPfmcConditionVO extends AbstractValueObject {
	...
	/* Column Info */
    private String fIskoreanB = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("f_iskorean_b", getFIskoreanB());
		...
		this.hashColumns.put("f_wk_flg", getFWkFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("f_iskorean_b", "fIskoreanB");
		...
		this.hashFields.put("f_wk_flg", "fWkFlg");
     ...
     * @return fIskoreanA
     */
    public String getFIskoreanB() {
        return this.fIskoreanB;
    }
     ...
     * @param fIskoreanB
     */
    public void setFIskoreanB(String fIskoreanB) {
        this.fIskoreanB = fIskoreanB;
    }
	 ...
	 * @param fWkFlg
	 */
	public void setFWkFlg(String fWkFlg) {
		this.fWkFlg = fWkFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFIskoreanB(JSPUtil.getParameter(request, prefix + "f_iskorean_b", ""));
		...
		setFWkFlg(JSPUtil.getParameter(request, prefix + "f_wk_flg", ""));
	}
	...
	public RepoPfmcConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] fIskoreanB = (JSPUtil.getParameter(request, prefix  + "f_iskorean_b", length));
			...
			String[] fWkFlg = (JSPUtil.getParameter(request, prefix	+ "f_wk_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (fIskoreanB[i] != null)
                    model.setFIskoreanB(fIskoreanB[i]);
				if (fTrdDirCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.fIskoreanB = this.fIskoreanB .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.fWkFlg = this.fWkFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
