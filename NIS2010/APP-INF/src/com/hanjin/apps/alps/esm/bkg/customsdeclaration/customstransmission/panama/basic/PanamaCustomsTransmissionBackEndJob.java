...
public class PanamaCustomsTransmissionBackEndJob extends BackEndCommandSupport{
	...
	public Object doStart() throws Exception {
		try {
			...
			{
				CustomsTransmissionBC command = new PanamaCustomsTransmissionBCImpl();
				command.transmitManifest(manifestTransmitVO, account);
				
				ManifestListDownloadBC maniCommand = new PanamaManifestListDownloadBCImpl();
				maniCommand.modifySendHist(manifestTransmitVO, account);
			} 
		} catch (Exception ex) {
