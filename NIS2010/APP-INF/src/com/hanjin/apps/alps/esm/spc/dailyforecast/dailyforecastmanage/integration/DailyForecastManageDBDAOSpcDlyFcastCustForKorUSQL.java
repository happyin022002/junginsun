...
*@FileName : DailyForecastManageDBDAOSpcDlyFcastCustForKorUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DailyForecastManageDBDAOSpcDlyFcastCustForKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DailyForecastManageDBDAOSpcDlyFcastCustForKorUSQL(){
		setQuery();
		...
		query.append("FileName : DailyForecastManageDBDAOSpcDlyFcastCustForKorUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       FCAST_20FT_QTY      = @[fcast_20ft_qty]     ," ).append("\n"); 
		query.append("       FCAST_40FT_QTY      = @[fcast_40ft_qty]     ," ).append("\n"); 
		...
		query.append("       CFM_TTL_QTY         = @[fcast_ttl_qty]      ," ).append("\n"); 
		query.append("       CFM_40FT_HC_QTY     = @[fcast_40ft_hc_qty]  ," ).append("\n"); 
		query.append("       CFM_45FT_HC_QTY     = @[fcast_45ft_hc_qty]  ," ).append("\n"); 
		query.append("       CFM_53FT_QTY        = @[fcast_53ft_qty]     ," ).append("\n"); 
		query.append("       CFM_RF_QTY          = @[fcast_rf_qty]       ," ).append("\n"); 
		query.append("       CFM_TTL_WGT         = @[fcast_ttl_wgt]      ," ).append("\n"); 
		query.append("       USD_BKG_TTL_QTY     = @[usd_bkg_ttl_qty]    ," ).append("\n"); 
		query.append("       USD_BKG_20FT_QTY    = DECODE(@[view_type], 'TEU', TO_NUMBER(@[usd_bkg_20ft_qty]) - TO_NUMBER(@[usd_bkg_40ft_qty]) * 2, TO_NUMBER(@[usd_bkg_20ft_qty]))," ).append("\n"); 
		query.append("       USD_BKG_40FT_QTY    = DECODE(@[view_type], 'FEU', TO_NUMBER(@[usd_bkg_40ft_qty]) - TO_NUMBER(@[usd_bkg_20ft_qty]) / 2, TO_NUMBER(@[usd_bkg_40ft_qty]))," ).append("\n"); 
		...
		query.append("   AND NVL(SC_NO, 'XX') = COALESCE(@[sc_no], SC_NO, 'XX')" ).append("\n"); 
