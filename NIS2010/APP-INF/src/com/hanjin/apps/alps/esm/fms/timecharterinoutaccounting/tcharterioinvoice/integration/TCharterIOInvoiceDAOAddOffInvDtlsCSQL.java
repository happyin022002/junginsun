...
public class TCharterIOInvoiceDAOAddOffInvDtlsCSQL implements ISQLTemplate{
	...
	public TCharterIOInvoiceDAOAddOffInvDtlsCSQL(){
		...
		params.put("vnor_itm_val2",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("	MODI_VNOR_ITM_UT_CD," ).append("\n"); 
		query.append("	MODI_VNOR_ITM_VAL," ).append("\n"); 
		query.append("	MODI_VNOR_ITM_PRC," ).append("\n"); 
		...
		query.append("	    	(SELECT MAX(NVL(INV_SEQ,1))" ).append("\n"); 
		...
		query.append("	@[vnor_itm_val2]," ).append("\n"); 
		query.append("	@[vnor_itm_prc]," ).append("\n"); 
		query.append("	@[vnor_seq]," ).append("\n"); 
		query.append("	@[vnor_itm_seq]" ).append("\n"); 
		query.append(")" ).append("\n"); 
