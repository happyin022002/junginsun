...
*@FileName : SCProposalMainDBDAOChkInitFileDtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAOChkInitFileDtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCProposalMainDBDAOChkInitFileDtRSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAOChkInitFileDtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                        AND FMC_FILE_TP_CD = 'S' -- 최초 sending 날짜 기준 체크" ).append("\n"); 
		query.append("                      )" ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append("               ) " ).append("\n"); 
		query.append("        )" ).append("\n"); 
