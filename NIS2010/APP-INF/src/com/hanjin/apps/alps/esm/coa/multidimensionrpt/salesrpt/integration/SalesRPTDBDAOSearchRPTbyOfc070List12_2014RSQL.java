...
public class SalesRPTDBDAOSearchRPTbyOfc070List12_2014RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  ,DECODE(IAS_RGN_CD,NULL,NULL,COA_GET_CD_NM_FNC('CD03218', IAS_RGN_CD)) IAS_RGN_CD" ).append("\n"); 
		query.append("  ,DECODE(HUL_BND_CD,NULL,NULL,COA_GET_CD_NM_FNC('CD03217', HUL_BND_CD)) HUL_BND_CD" ).append("\n"); 
		...
		query.append("  ,NVL(MN_SCTR_FLG, 'Sector') AS MN_SCTR_FLG" ).append("\n"); 
		...
		query.append("      ,NVL(SUM(AA.VVD_BSA_CAPA),0)            AS COA_BSA " ).append("\n"); 
		query.append("      ,NVL(SUM(AA.COA_QTY),0)                 AS COA_LOAD " ).append("\n"); 
		query.append("      ,NVL(SUM(AA.FR_REV),0)                  AS COA_REV " ).append("\n"); 
		query.append("      ,NVL(SUM(AA.TOT_REV-CM_COST),0)         AS COA_CM " ).append("\n"); 
		query.append("      ,NVL(SUM(AA.CM_COST),0)                 AS COA_CM_COST " ).append("\n"); 
		...
		query.append("             ,COA_OFC_LVL A4 " ).append("\n"); 
		query.append("             ,COA_LANE_RGST A5 " ).append("\n"); 
		query.append("          WHERE 1=1 " ).append("\n"); 
		query.append("            AND A1.TRD_CD           = A3.TRD_CD " ).append("\n"); 
		query.append("            AND A1.RLANE_CD         = A3.RLANE_CD " ).append("\n"); 
		...
		query.append("	AND (MN_SCTR_FLG = 'Sector' OR MN_SCTR_FLG = '' OR MN_SCTR_FLG IS NULL)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
