...
*@FileName : SCRateQuotationDBDAORsltPriSurchargeLastAccessDateVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriSurchargeLastAccessDateVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriSurchargeLastAccessDateVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriSurchargeLastAccessDateVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM PRI_SQ_RT_SCG_ROUT" ).append("\n"); 
