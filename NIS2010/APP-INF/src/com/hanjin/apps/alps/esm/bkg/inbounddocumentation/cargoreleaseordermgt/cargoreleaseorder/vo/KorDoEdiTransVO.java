...
public class KorDoEdiTransVO extends AbstractValueObject {
	...
	private Collection<KorDoEdiTransVO> models = new ArrayList<KorDoEdiTransVO>();
	...
	public KorDoEdiTransVO() {}

	public KorDoEdiTransVO(String ibflag, String pagerows, String discLocCd, String bkgNo, String doType, String selfTrnsFlg, String rlseSeq, String creUsrId, String updUsrId, String ediId, String ediSndRsltCd, String usrId, String ofcCd) {
	 ...
	 * @param request
	 * @return KorDoEdiTransVO[]
	 */
	public KorDoEdiTransVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDoEdiTransVO[]
	 */
	public KorDoEdiTransVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDoEdiTransVO model = null;
	 ...
	 * @return KorDoEdiTransVO[]
	 */
	public KorDoEdiTransVO[] getKorDoEdiTransVOs(){
		KorDoEdiTransVO[] vos = (KorDoEdiTransVO[])models.toArray(new KorDoEdiTransVO[models.size()]);
		return vos;
	}
