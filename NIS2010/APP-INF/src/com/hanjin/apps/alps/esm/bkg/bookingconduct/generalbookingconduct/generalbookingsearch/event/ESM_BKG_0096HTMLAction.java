...
*@FileName : ESM_BKG_0096HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.bkg.generalbookingconduct 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESM_BKG_0096HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0096HTMLAction 객체를 생성
	 */
	public ESM_BKG_0096HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0096Event event = new EsmBkg0096Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setYardAssignVO(yardAssignVO);
			event.getYardAssignVO().setQtyInfoVOs((QtyInfoVO[])getVOs(request,QtyInfoVO.class,""));
		}
