...
*@FileName : ESM_PRI_9051_02HTMLAction.java
...
public class ESM_PRI_9051_02HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_9051_02HTMLAction 객체를 생성
	 */
	public ESM_PRI_9051_02HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri905102Event event = new EsmPri905102Event();
		...
		if (command.isCommand(FormCommand.SEARCH01)) {
	    	...
	    	for (int i = 0; i < vos.length; i++) {
				...
				vos[i].setPrcUsrAuthTpCd(request.getParameter("prc_usr_auth_tp_cd"));
			}
	    	...
	    	for (int i = 0; i < hisvos.length; i++) {
	    		...
	    		hisvos[i].setPrcUsrAuthTpCd(request.getParameter("prc_usr_auth_tp_cd"));
			}
