...
*@FileName : RocsManifestLiatDownloadDBDAOremoveRocsBlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RocsManifestLiatDownloadDBDAOremoveRocsBlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RocsManifestLiatDownloadDBDAOremoveRocsBlDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE BKG_CSTMS_RTM_BL" ).append("\n"); 
		...
		query.append("FileName : RocsManifestLiatDownloadDBDAOremoveRocsBlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}