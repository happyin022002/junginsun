...
*@FileName : DaoNameDAOSPCLCmpnCSRDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DaoNameDAOSPCLCmpnCSRDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DaoNameDAOSPCLCmpnCSRDetailVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.acm.acmapproval.spclcmpnapproval.vo ").append("\n"); 
		query.append("FileName : DaoNameDAOSPCLCmpnCSRDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("/* FFCMPNCSRDETAIL */" ).append("\n"); 
