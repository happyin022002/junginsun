...
*@FileName : SCRateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT ROUT_PNT_LOC_DEF_CD AS CD , ROUT_PNT_LOC_DEF_CD AS NM" ).append("\n"); 
