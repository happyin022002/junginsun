...
*@FileName : ESM_COA_0018HTMLAction.java
...
public class ESM_COA_0018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0018HTMLAction 객체를 생성
	 */
	public ESM_COA_0018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0018Event event = new EsmCoa0018Event();

		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCoaCntrRepoCrVOS((CoaCntrRepoCrVO[])getVOs(request, CoaCntrRepoCrVO .class,""));
		}
