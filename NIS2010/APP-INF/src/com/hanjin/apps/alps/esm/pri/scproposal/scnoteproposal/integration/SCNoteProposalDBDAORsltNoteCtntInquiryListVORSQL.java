...
*@FileName : SCNoteProposalDBDAORsltNoteCtntInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAORsltNoteCtntInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RsltNoteCtntInquiryListVO
	  * </pre>
	  */
	public SCNoteProposalDBDAORsltNoteCtntInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAORsltNoteCtntInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
