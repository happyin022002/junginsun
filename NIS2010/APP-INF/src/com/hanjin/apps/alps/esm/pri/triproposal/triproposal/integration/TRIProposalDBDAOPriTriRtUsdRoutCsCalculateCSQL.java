...
*@FileName : TRIProposalDBDAOPriTriRtUsdRoutCsCalculateCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtUsdRoutCsCalculateCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtUsdRoutCsCalculateCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtUsdRoutCsCalculateCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	(	@[tri_prop_no], @[amdt_seq], @[rout_cs_no],@[rout_cs_src_dt] " ).append("\n"); 
		query.append("		, 'N' , 'CALC', SYSDATE,'CALC',SYSDATE )  	" ).append("\n"); 
		query.append("	" ).append("\n"); 
