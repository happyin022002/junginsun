...
*@FileName : ESM_MAS_0341HTMLAction.java
...
public class ESM_MAS_0341HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0341HTMLAction 객체를 생성
	 */
	public ESM_MAS_0341HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0341Event event = new EsmMas0341Event();
		...
		if(command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO.class));
	        event.setSearchAgrdNtwkAllocByAgmtInterVO((SearchAgrdNtwkAllocByAgmtInterVO)getVO(request, SearchAgrdNtwkAllocByAgmtInterVO.class));         
