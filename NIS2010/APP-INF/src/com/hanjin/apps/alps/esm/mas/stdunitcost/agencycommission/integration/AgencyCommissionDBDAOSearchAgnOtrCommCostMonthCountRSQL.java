...
*@FileName : AgencyCommissionDBDAOSearchAgnOtrCommCostMonthCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgencyCommissionDBDAOSearchAgnOtrCommCostMonthCountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgencyCommissionDBDAOSearchAgnOtrCommCostMonthCountRSQL(){
		setQuery();
		...
		query.append("FileName : AgencyCommissionDBDAOSearchAgnOtrCommCostMonthCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM  MAS_OTR_COMM  A" ).append("\n"); 
