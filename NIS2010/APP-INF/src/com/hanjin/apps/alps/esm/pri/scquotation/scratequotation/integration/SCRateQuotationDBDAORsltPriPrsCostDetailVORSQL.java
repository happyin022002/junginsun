...
*@FileName : SCRateQuotationDBDAORsltPriPrsCostDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriPrsCostDetailVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *    Cost Detail 화면(  PRI_6062) 에서 Cost Detail List를 추출하는 쿼리
	  * 2015.06.30 최성환 [CHM-201536493] Split03-주간 MAS Open에 따른 타모듈 프로그램 적용 요청
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriPrsCostDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriPrsCostDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* qttn_no,qttn_ver_no,gen_spcl_rt_tp_cd,cmdt_hdr_seq,rout_seq,rt_seq, rout_cs_no,rout_cs_src_dt,cost_tp  파라메터 추가*/" ).append("\n"); 
		...
		query.append("            AND A3.REV_YRMON(+) = MAS_BZC_COST_YRMON_FNC('')--'200903' -- MAS_BZC_COST_YRMON_FNC('', '')" ).append("\n"); 
