...
*@FileName : Kor24ManifestListDBDAOsearchIBManifestKorRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchIBManifestKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchIBManifestKorRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchIBManifestKorRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("FROM   BKG_CSTMS_ADV_KR_BL O, BKG_CSTMS_ADV_KR_BL I" ).append("\n");
