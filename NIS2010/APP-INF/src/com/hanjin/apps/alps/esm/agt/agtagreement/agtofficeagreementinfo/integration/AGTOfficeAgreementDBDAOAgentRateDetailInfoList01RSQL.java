...
*@FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateDetailInfoList01RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Cntr_inp_term_cd 에 결과를 setting 하기 위해 select
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateDetailInfoList01RSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateDetailInfoList01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--                           AND agmt_ofc_cty_cd  = 'SHA'   --:agmt_ofc_cty_cd /* 이 항목은 삭제함 */" ).append("\n"); 
		...
		query.append("AND    OTR_LVL_CD = '1' )) T START WITH NO = 1 CONNECT BY NOCYCLE PRIOR NO = NO - 1" ).append("\n"); 
