...
*@FileName : OutstandingVO.java
*@FileTitle : OutstandingVO
*Open Issues :
*Change history :
...
public class OutstandingVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OutstandingVO> models = new ArrayList<OutstandingVO>();
	...
	public OutstandingVO() {}

	public OutstandingVO(String ibflag, String pagerows, String ofcCd, String cltBlNo, String invNo, String ofcCurrCd, String otsBkgNo, String otsDueDt, String otsStlFlg, String xchRtTpCd, String cltRmk, String otsGrpTpCd, String otsOccrTpCd, String n1stCltRqstDt, String n2ndCltRqstDt, String n3rdCltRqstDt, String lstCltOfcCd, String lstUpdChkDt, String xtraRmk1, String xtraRmk2, String xtraRmk3, String creDt, String creUsrId, String updDt, String updUsrId) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setN3rdCltRqstDt(JSPUtil.getParameter(request, "n3rd_clt_rqst_dt", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setN2ndCltRqstDt(JSPUtil.getParameter(request, "n2nd_clt_rqst_dt", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setOtsStlFlg(JSPUtil.getParameter(request, "ots_stl_flg", ""));
		setOtsBkgNo(JSPUtil.getParameter(request, "ots_bkg_no", ""));
		setOtsGrpTpCd(JSPUtil.getParameter(request, "ots_grp_tp_cd", ""));
		setOfcCurrCd(JSPUtil.getParameter(request, "ofc_curr_cd", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setOtsOccrTpCd(JSPUtil.getParameter(request, "ots_occr_tp_cd", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setOtsDueDt(JSPUtil.getParameter(request, "ots_due_dt", ""));
		setCltBlNo(JSPUtil.getParameter(request, "clt_bl_no", ""));
		setInvNo(JSPUtil.getParameter(request, "inv_no", ""));
		setLstCltOfcCd(JSPUtil.getParameter(request, "lst_clt_ofc_cd", ""));
		setLstUpdChkDt(JSPUtil.getParameter(request, "lst_upd_chk_dt", ""));
		setOfcCd(JSPUtil.getParameter(request, "ofc_cd", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setN1stCltRqstDt(JSPUtil.getParameter(request, "n1st_clt_rqst_dt", ""));
		setXtraRmk2(JSPUtil.getParameter(request, "xtra_rmk2", ""));
		setXtraRmk1(JSPUtil.getParameter(request, "xtra_rmk1", ""));
		setXtraRmk3(JSPUtil.getParameter(request, "xtra_rmk3", ""));
		setCltRmk(JSPUtil.getParameter(request, "clt_rmk", ""));
	}
	 ...
	 */
	public OutstandingVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OutstandingVO[]
	 */
	public OutstandingVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OutstandingVO model = null;
	 ...
	 * @return OutstandingVO[]
	 */
	public OutstandingVO[] getOutstandingVOs(){
		OutstandingVO[] vos = (OutstandingVO[])models.toArray(new OutstandingVO[models.size()]);
		return vos;
	}
