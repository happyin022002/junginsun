...
*@FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOUSQL.java
...
public class SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_GRP_LOC_DTL SET" ).append("\n"); 
