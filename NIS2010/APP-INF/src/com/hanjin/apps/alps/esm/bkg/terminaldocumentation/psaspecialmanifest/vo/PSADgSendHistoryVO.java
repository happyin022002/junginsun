...
*@FileName : PSADgSendHistoryVO.java
*@FileTitle : PSADgSendHistoryVO
*Open Issues :
*Change history :
...
public class PSADgSendHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSADgSendHistoryVO> models = new ArrayList<PSADgSendHistoryVO>();
...
/**
	 ...
	 * @param request
	 * @return PSADgSendHistoryVO[]
	 */
	public PSADgSendHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSADgSendHistoryVO[]
	 */
	public PSADgSendHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSADgSendHistoryVO model = null;
	 ...
	 * @return PSADgSendHistoryVO[]
	 */
	public PSADgSendHistoryVO[] getPSADgSendHistoryVOs(){
		PSADgSendHistoryVO[] vos = (PSADgSendHistoryVO[])models.toArray(new PSADgSendHistoryVO[models.size()]);
		return vos;
	}
