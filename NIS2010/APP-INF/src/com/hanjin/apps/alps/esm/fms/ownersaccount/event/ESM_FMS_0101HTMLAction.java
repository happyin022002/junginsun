...
*@FileName : ESM_FMS_0101HTMLAction.java
...
public class ESM_FMS_0101HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0101HTMLAction 객체를 생성
	 */
	public ESM_FMS_0101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0101Event event = new EsmFms0101Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondOwnrAcctForCnclVO((CondOwnrAcctForCnclVO)getVO(request, CondOwnrAcctForCnclVO .class));
		}
