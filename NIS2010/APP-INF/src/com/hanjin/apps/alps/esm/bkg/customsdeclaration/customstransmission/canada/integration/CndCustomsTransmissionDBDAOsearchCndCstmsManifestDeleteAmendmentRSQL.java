...
*@FileName : CndCustomsTransmissionDBDAOsearchCndCstmsManifestDeleteAmendmentRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsTransmissionDBDAOsearchCndCstmsManifestDeleteAmendmentRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CndCustomsTransmissionDBDAOsearchCndCstmsManifestDeleteAmendmentRSQL
	  * </pre>
	  */
	public CndCustomsTransmissionDBDAOsearchCndCstmsManifestDeleteAmendmentRSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsTransmissionDBDAOsearchCndCstmsManifestDeleteAmendmentRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(TB.FULL_MTY_CD, 'F', BKG_GET_CSTMS_ADV_ERR_CD_FNC(TB.BKG_NO, TB.MH, 'CA')) AS ERROR" ).append("\n"); 
		...
		query.append("           	  ,( " ).append("\n"); 
		query.append("                SELECT DOC_PERF_DELT_FLG" ).append("\n"); 
		query.append("                FROM BKG_DOC_PROC_SKD" ).append("\n"); 
		query.append("                WHERE BKG_NO = TB2.BL_NO" ).append("\n"); 
		query.append("                AND BKG_DOC_PROC_TP_CD = 'CA_SND'" ).append("\n"); 
		...
		query.append("                            ELSE 'N' " ).append("\n"); 
		query.append("                            END BDR_FLG" ).append("\n"); 
		query.append("                      ,ROW_NUMBER() OVER(PARTITION BY BKG.BL_NO ORDER BY NVL(LOG.SND_DT, TO_DATE('19900101','YYYY-MM-DD HH24:MI')) DESC) AS LOG_RNUM" ).append("\n"); 
		query.append("                  FROM (" ).append("\n"); 
		...
		query.append("                              ,'0' AS CND_CSTMS_FILE_CD" ).append("\n"); 
		query.append("                              ,BKG.BL_NO AS MBL_NO" ).append("\n"); 
		query.append("                              ,BKG.BKG_STS_CD" ).append("\n"); 
		query.append("                              ,BKG.VSL_CD || BKG.SKD_VOY_NO || BKG.SKD_DIR_CD AS T_VVD_CD" ).append("\n"); 
		query.append("                              ,BKG.POL_CD AS BKG_POL_CD" ).append("\n"); 
