...
*@FileName : WeeklyCMDBDAOModifyExceptionListMgmtListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOModifyExceptionListMgmtListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Exception List Unit 수정
	  * </pre>
	  */
	public WeeklyCMDBDAOModifyExceptionListMgmtListUSQL(){
		setQuery();
		...
		params.put("scno_scccd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : WeeklyCMDBDAOModifyExceptionListMgmtListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_CHSS_EXPT_LIST" ).append("\n"); 
		...
		query.append("	COST_EXPT_FLG = @[cost_expt_flg]," ).append("\n"); 
		query.append("	UPD_USR_ID = @[upd_usr_id]," ).append("\n"); 
		query.append("	UPD_DT = SYSDATE" ).append("\n"); 
		query.append("WHERE SC_NO||SCC_CD = NVL(@[scno_scccd],SC_NO||SCC_CD)" ).append("\n"); 
