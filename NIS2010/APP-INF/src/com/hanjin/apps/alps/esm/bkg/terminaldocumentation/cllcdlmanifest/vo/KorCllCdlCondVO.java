...
public class KorCllCdlCondVO extends AbstractValueObject {
	...
	/* Column Info */
	private String inBkgAlocStsCd = null;
	/* Column Info */
	...
	public KorCllCdlCondVO(String ibflag, String pagerows, String inBkgAlocStsCd, String inRcFlg, String inStwgCd, String inBkgStsCd, String inListType, String inPorCd, String inPodYdCd, String inHngrFlg, String inDelCd, String inCntrNo, String inAwkCgoFlg, String inSccCd, String inOfcCd, String inPrctFlg, String inRdCgoFlg, String inSpclCgoType, String inPodCd, String inBbCgoFlg, String inPodTs, String inOfcCdType, String inOrgTrnsSvdModCd, String inRcvTermCd, String inOrderByType, String podSplitNo, String inPolYdCd, String inCntrCfmFlg, String polSplitNo, String inDeTermCd, String inIncludingType, String inPolTs, String inDcgoFlg, String inPolCd, String inCntrTpszCd, String inVvdCd, String inHotDeFlg, String inBkgCgoTpCd, String backgroundJobKey, String inBkgNo, String inSocFlg, String inCntrMatch, String inDestTrnsSvcModCd, String thaiOfc) {
		this.inBkgAlocStsCd = inBkgAlocStsCd;
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("in_bkg_aloc_sts_cd", getInBkgAlocStsCd());
		...
		this.hashColumns.put("thai_ofc", getThaiOfc());
	...
	public HashMap<String, String> getFieldNames(){
		this.hashFields.put("in_bkg_aloc_sts_cd", "inBkgAlocStsCd");
		...
		this.hashFields.put("thai_ofc", "thaiOfc");
	...
	/**
	 * Column Info
	 * @return inBkgAlocStsCd
	 */
	public String getInBkgAlocStsCd() {
		return this.inBkgAlocStsCd;
	}
	...
	/**
	 * Column Info
	 * @param inBkgAlocStsCd
	 */
	public void setInBkgAlocStsCd(String inBkgAlocStsCd) {
		this.inBkgAlocStsCd = inBkgAlocStsCd;
	}
	 ...
	 * @param thaiOfc
	 */
	public void setThaiOfc(String thaiOfc) {
		this.thaiOfc = thaiOfc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setInBkgAlocStsCd(JSPUtil.getParameter(request, prefix + "in_bkg_aloc_sts_cd", ""));
		setInRcFlg(JSPUtil.getParameter(request, prefix + "in_rc_flg", ""));
		setInStwgCd(JSPUtil.getParameter(request, prefix + "in_stwg_cd", ""));
		...
		setInHngrFlg(JSPUtil.getParameter(request, prefix + "in_hngr_flg", ""));
		...
		setInSccCd(JSPUtil.getParameter(request, prefix + "in_scc_cd", ""));
		setInOfcCd(JSPUtil.getParameter(request, prefix + "in_ofc_cd", ""));
		setInPrctFlg(JSPUtil.getParameter(request, prefix + "in_prct_flg", ""));
		setInRdCgoFlg(JSPUtil.getParameter(request, prefix + "in_rd_cgo_flg", ""));
		setInSpclCgoType(JSPUtil.getParameter(request, prefix + "in_spcl_cgo_type", ""));
		setInPodCd(JSPUtil.getParameter(request, prefix + "in_pod_cd", ""));
		setInBbCgoFlg(JSPUtil.getParameter(request, prefix + "in_bb_cgo_flg", ""));
		setInPodTs(JSPUtil.getParameter(request, prefix + "in_pod_ts", ""));
		setInOfcCdType(JSPUtil.getParameter(request, prefix + "in_ofc_cd_type", ""));
		setInOrgTrnsSvdModCd(JSPUtil.getParameter(request, prefix + "in_org_trns_svd_mod_cd", ""));
		setInRcvTermCd(JSPUtil.getParameter(request, prefix + "in_rcv_term_cd", ""));
		setInOrderByType(JSPUtil.getParameter(request, prefix + "in_order_by_type", ""));
		...
		setThaiOfc(JSPUtil.getParameter(request, prefix + "thai_ofc", ""));
		setPolSplitNo(JSPUtil.getParameter(request, prefix + "pol_split_no", ""));
		setInDeTermCd(JSPUtil.getParameter(request, prefix + "in_de_term_cd", ""));
		setInIncludingType(JSPUtil.getParameter(request, prefix + "in_including_type", ""));
		setInDcgoFlg(JSPUtil.getParameter(request, prefix + "in_dcgo_flg", ""));
		setInPolTs(JSPUtil.getParameter(request, prefix + "in_pol_ts", ""));
		setInCntrTpszCd(JSPUtil.getParameter(request, prefix + "in_cntr_tpsz_cd", ""));
		...
		setInHotDeFlg(JSPUtil.getParameter(request, prefix + "in_hot_de_flg", ""));
		setBackgroundJobKey(JSPUtil.getParameter(request, prefix + "background_job_key", ""));
		setInBkgNo(JSPUtil.getParameter(request, prefix + "in_bkg_no", ""));
		setInSocFlg(JSPUtil.getParameter(request, prefix + "in_soc_flg", ""));
		setInDestTrnsSvcModCd(JSPUtil.getParameter(request, prefix + "in_dest_trns_svc_mod_cd", ""));
		setInCntrMatch(JSPUtil.getParameter(request, prefix + "in_cntr_match", ""));
	}
	...
	public KorCllCdlCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] inBkgAlocStsCd = (JSPUtil.getParameter(request, prefix	+ "in_bkg_aloc_sts_cd", length));
			...
			String[] thaiOfc = (JSPUtil.getParameter(request, prefix	+ "thai_ofc", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (inBkgAlocStsCd[i] != null)
					model.setInBkgAlocStsCd(inBkgAlocStsCd[i]);
				if (inRcFlg[i] != null)
	...
	*/
	public void unDataFormat(){
		this.inBkgAlocStsCd = this.inBkgAlocStsCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.thaiOfc = this.thaiOfc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
