...
*@FileName : KrWharfageDecMgtDBDAOsearchKrWhfCgoClass2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOsearchKrWhfCgoClass2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOsearchKrWhfCgoClass2RSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOsearchKrWhfCgoClass2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  SUM(CASE WHEN SUBSTR(B.CNTR_TPSZ_CD, 2, 1) IN ('4', '5') AND B.RCV_TERM_CD NOT IN ('I', 'T') THEN DECODE(A.WHF_BND_CD,'OM',DECODE(B.CNTR_VOL_QTY,0,1,B.CNTR_VOL_QTY),'IM',DECODE(B.CNTR_VOL_QTY,0,1,B.CNTR_VOL_QTY),B.CNTR_VOL_QTY)" ).append("\n"); 
		query.append("                           ELSE 0" ).append("\n"); 
		query.append("                      END) AS WHF_CNTR_40FT_QTY," ).append("\n"); 
		query.append("                  SUM(CASE WHEN SUBSTR(B.CNTR_TPSZ_CD, 2, 1) NOT IN ('2', '4', '5') AND B.RCV_TERM_CD NOT IN ('I', 'T') THEN DECODE(A.WHF_BND_CD,'OM',DECODE(B.CNTR_VOL_QTY,0,1,B.CNTR_VOL_QTY),'IM',DECODE(B.CNTR_VOL_QTY,0,1,B.CNTR_VOL_QTY),B.CNTR_VOL_QTY)" ).append("\n"); 
		query.append("                           ELSE 0" ).append("\n"); 
