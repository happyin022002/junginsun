...
public class AusCustomsTransmissionDBDAOsearchBlGeneralForMRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           DECODE(SUBSTR(B.POL_CD,1,2),'AU',DECODE(B.RCV_TERM_CD,'S','LCL','FCL')," ).append("\n"); 
		query.append("           DECODE(SUBSTR(B.POD_CD,1,2),'AU',DECODE(B.DE_TERM_CD,'S','LCL','FCL'))) cargotype," ).append("\n"); 
