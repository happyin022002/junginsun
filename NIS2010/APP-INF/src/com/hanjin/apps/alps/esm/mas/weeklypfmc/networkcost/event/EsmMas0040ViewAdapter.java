...
*@FileName : EsmMas0040ViewAdapter.java
*@FileTitle : EsmMas0040ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0040 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmMas0040ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0040ViewAdapter(){
    	super();
    }
