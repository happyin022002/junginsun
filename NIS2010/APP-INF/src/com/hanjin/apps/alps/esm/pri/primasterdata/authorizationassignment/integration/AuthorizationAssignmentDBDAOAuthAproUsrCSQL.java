...
*@FileName : AuthorizationAssignmentDBDAOAuthAproUsrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AuthorizationAssignmentDBDAOAuthAproUsrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_AUTH_APRO_USR 테이블 INSERT
	  * </pre>
	  */
	public AuthorizationAssignmentDBDAOAuthAproUsrCSQL(){
		setQuery();
		...
		params.put("auth_apro_usr_ofc_cd",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.primasterdata.authorizationassignment.integration").append("\n"); 
		query.append("FileName : AuthorizationAssignmentDBDAOAuthAproUsrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_AUTH_APRO_USR" ).append("\n"); 
		query.append("    USING (SELECT @[auth_apro_usr_id] NEW_AUTH_APRO_USR_ID" ).append("\n"); 
		query.append("     			 ,@[prc_ctrt_tp_cd] NEW_PRC_CTRT_TP_CD" ).append("\n"); 
		query.append("    			 ,@[prc_usr_auth_tp_cd] NEW_PRC_USR_AUTH_TP_CD" ).append("\n"); 
		query.append("    		 FROM DUAL)" ).append("\n"); 
		query.append("    ON (AUTH_APRO_USR_ID = NEW_AUTH_APRO_USR_ID AND PRC_CTRT_TP_CD = NEW_PRC_CTRT_TP_CD AND PRC_USR_AUTH_TP_CD = NEW_PRC_USR_AUTH_TP_CD)" ).append("\n"); 
