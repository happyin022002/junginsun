...
*@FileName : SCRateProposalDBDAOPriSpScpRtScgAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtScgAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCRateProposalDBDAOPriSpScpRtScgAmdVOCSQL
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtScgAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtScgAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_SP_SCP_RT_SCG SCG," ).append("\n"); 
