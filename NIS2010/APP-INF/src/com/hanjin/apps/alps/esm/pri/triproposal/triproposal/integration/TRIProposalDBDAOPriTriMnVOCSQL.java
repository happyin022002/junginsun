...
*@FileName : TRIProposalDBDAOPriTriMnVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriMnVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriMnVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriMnVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRI_MN (" ).append("\n"); 
