...
*@FileName : IHCGuideLineDBDAOAddIHCGuidelineMainAmendCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOAddIHCGuidelineMainAmendCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add IHC Guideline Main Amend
	  * </pre>
	  */
	public IHCGuideLineDBDAOAddIHCGuidelineMainAmendCSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOAddIHCGuidelineMainAmendCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
