...
*@FileName : IHCGuideLineDBDAOModifyIHCGuidelineMainAmendUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOModifyIHCGuidelineMainAmendUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modify IHC Guideline Main EXP_DT
	  * </pre>
	  */
	public IHCGuideLineDBDAOModifyIHCGuidelineMainAmendUSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOModifyIHCGuidelineMainAmendUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
