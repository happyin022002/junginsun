...
*@FileName : OwnersAccountDBDAOSearchAtchFileListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnersAccountDBDAOSearchAtchFileListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Owner's Account 첨부파일목록을 조회
	  * </pre>
	  */
	public OwnersAccountDBDAOSearchAtchFileListRSQL(){
		setQuery();
		...
		query.append("FileName : OwnersAccountDBDAOSearchAtchFileListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND F.ATCH_FILE_OA_LNK_ID LIKE @[csr_no] || '%'" ).append("\n"); 
