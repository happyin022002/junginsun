...
public class PlanningDBDAOSearchQtaSetUpHeadOfficeListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,A4.OB_DIV_CD" ).append("\n"); 
		query.append("      ,SUBSTR(A2.HUL_BND_CD, 1, 1) || '/' || SUBSTR(A2.HUL_BND_CD, 2) AS HUL_BND_CD" ).append("\n"); 
		...
		query.append("      ,SQM_QTA_POTN_MGMT A3" ).append("\n"); 
		...
		query.append("   AND A2.HUL_BND_CD  = @[f_trd_dir]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("   AND A3.RLANE_CD    = DECODE(UPPER(A4.RLANE_CD), 'ALL', A3.RLANE_CD, A4.RLANE_CD)" ).append("\n"); 
