...
public class MultiDimensionRPTDBDAOSearchPfitLssRptItmListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			AND STND_COST_TP_CD IN ('S','C',@[str_display],DECODE(@[f_tab],'Y','U')) " ).append("\n"); 
		...
		query.append("			AND STND_COST_CD NOT IN ('OPCOST01','OPCOST02', 'NTCOINIT', 'NTCOALOC')" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
