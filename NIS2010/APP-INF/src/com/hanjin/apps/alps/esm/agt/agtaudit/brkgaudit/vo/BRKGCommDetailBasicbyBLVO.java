...
*@FileName : BRKGCommDetailBasicbyBLVO.java
*@FileTitle : BRKGCommDetailBasicbyBLVO
*Open Issues :
*Change history :
...
public class BRKGCommDetailBasicbyBLVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BRKGCommDetailBasicbyBLVO> models = new ArrayList<BRKGCommDetailBasicbyBLVO>();
	...
	public BRKGCommDetailBasicbyBLVO() {}

	public BRKGCommDetailBasicbyBLVO(String ibflag, String pagerows, String vslDepDt, String bkgNo, String blNo, String shprCntSeq, String shprNm, String frtFwrdCntSeq, String vndrCntSeq, String frtFwrdNm, String commVsl, String bkgPorCd, String bkgPolCd, String bkgPodCd, String bkgDelCd, String brogRefNo, String fmcNo, String scNo, String rfaNo, String brogKndCd) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBrogRefNo(JSPUtil.getParameter(request, "brog_ref_no", ""));
		setVndrCntSeq(JSPUtil.getParameter(request, "vndr_cnt_seq", ""));
	 ...
	 */
	public BRKGCommDetailBasicbyBLVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BRKGCommDetailBasicbyBLVO[]
	 */
	public BRKGCommDetailBasicbyBLVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BRKGCommDetailBasicbyBLVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BRKGCommDetailBasicbyBLVO();
		...
		return getBRKGCommDetailBasicbyBLVOs();
	}
	...
	public BRKGCommDetailBasicbyBLVO[] getBRKGCommDetailBasicbyBLVOs(){
		BRKGCommDetailBasicbyBLVO[] vos = (BRKGCommDetailBasicbyBLVO[])models.toArray(new BRKGCommDetailBasicbyBLVO[models.size()]);
		return vos;
	}
