...
*@FileName : ESM_COA_0160HTMLAction.java
...
public class ESM_COA_0160HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0160HTMLAction 객체를 생성
	 */
	public ESM_COA_0160HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0160Event event = new EsmCoa0160Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			
			event.setGetVariableheader2VO((GetVariableheader2VO)getVO(request, GetVariableheader2VO.class));
			event.setCoaAgmtRstrMgmtConditionVOS((CoaAgmtRstrMgmtConditionVO[])getVOs(request, CoaAgmtRstrMgmtConditionVO .class));
