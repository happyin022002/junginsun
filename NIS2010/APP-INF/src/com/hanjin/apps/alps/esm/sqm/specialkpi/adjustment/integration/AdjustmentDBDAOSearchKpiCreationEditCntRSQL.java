...
*@FileName : AdjustmentDBDAOSearchKpiCreationEditCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AdjustmentDBDAOSearchKpiCreationEditCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchKpiCreationEditCnt
	  * </pre>
	  */
	public AdjustmentDBDAOSearchKpiCreationEditCntRSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentDBDAOSearchKpiCreationEditCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
