...
public class ExCntrTransmitCondVO extends AbstractValueObject {
	...
	private String formHjsPol = null;
	...
	public ExCntrTransmitCondVO(String ibflag, String pagerows, String inCntrNo, String inCrYard, 
			...
			String formHaulMode, String formTranMode, String formGrsWgt, String formHjsVvd, String creUsrId, String updUsrId, 
			String formHjsPol, String formCntrType) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("form_hjs_pol", getFormHjsPol());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("form_hjs_pol", "formHjsPol");
	...
	public String getFormHjsPol() {
		return formHjsPol;
	}

	public void setFormHjsPol(String formHjsPol) {
		this.formHjsPol = formHjsPol;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFormHjsPol(JSPUtil.getParameter(request, prefix + "form_hjs_pol", ""));
	...
	public ExCntrTransmitCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] formHjsPol = (JSPUtil.getParameter(request, prefix	+ "form_hjs_pol", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (formHjsPol[i] != null)
					model.setFormHjsPol(updUsrId[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.formHjsPol = this.formHjsPol .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
