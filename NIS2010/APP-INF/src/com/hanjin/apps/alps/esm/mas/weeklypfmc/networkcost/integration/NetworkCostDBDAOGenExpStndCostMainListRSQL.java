...
*@FileName : NetworkCostDBDAOGenExpStndCostMainListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOGenExpStndCostMainListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * General Expense Pre OP Cost 를 조회한다.
	  * 2015.03.18 컬럼 속성명 변경으로 수정(GEN_EXPN_AMT,ADD_EXPN_AMT)
	  * </pre>
	  */
	public NetworkCostDBDAOGenExpStndCostMainListRSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOGenExpStndCostMainListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   A.EFF_FM_YRMON||' ~ '||A.EFF_TO_YRMON AS EFF_FM_TO_YRMON," ).append("\n"); 
		query.append("       A.GEN_EXPN_AMT AS GEN_EXPN," ).append("\n"); 
		query.append("       A.ADD_EXPN_AMT AS ADD_EXPN," ).append("\n"); 
		query.append("       A.GEN_EXPN_AMT + A.ADD_EXPN_AMT AS FIN_EXPN       " ).append("\n"); 
		query.append("       " ).append("\n"); 
		...
		query.append("   AND B.TRD_CD      LIKE @[f_trd_cd]||'%'" ).append("\n"); 
		query.append("   AND B.RLANE_CD    LIKE @[f_rlane_cd]||'%'" ).append("\n"); 
		query.append("   AND B.DIR_CD      LIKE @[f_dir_cd]||'%'" ).append("\n"); 
		query.append("" ).append("\n"); 
