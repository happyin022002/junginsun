...
*@FileName       : ESM_SQM_0040HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmSqm0040Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0040HTMLAction 객체를 생성
	 */
	public ESM_SQM_0040HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0040Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSqm0040Event event = new EsmSqm0040Event();
