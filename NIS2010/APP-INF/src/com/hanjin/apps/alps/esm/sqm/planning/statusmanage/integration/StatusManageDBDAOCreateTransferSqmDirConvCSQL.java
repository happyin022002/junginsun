...
*@FileName : StatusManageDBDAOCreateTransferSqmDirConvCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateTransferSqmDirConvCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Transfer 시 연간 정보로 1Q SQM_DIR_CONV 생성
	  * </pre>
	  */
	public StatusManageDBDAOCreateTransferSqmDirConvCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateTransferSqmDirConvCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
