...
public class SPCManageDBDAOSearchSpcSlotInfoByVvdOnVesselListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("--        ,MAX(FREE_ADD_TEU_CAPA) FREE_ADD_TEU_CAPA" ).append("\n"); 
		query.append("--        ,MAX(FREE_ADD_WGT) FREE_ADD_WGT" ).append("\n"); 
		query.append("--        ,MAX(N2ND_FNL_HJS_BSA_CAPA) N2ND_FNL_HJS_BSA_CAPA" ).append("\n"); 
		query.append("--        ,MAX(SPC_CTRL_SLT_CAPA) SPC_CTRL_SLT_CAPA" ).append("\n"); 
		query.append("--        ,MAX(SPC_OTR_SWAP_FLG) SPC_OTR_SWAP_FLG" ).append("\n"); 
		...
		query.append("--            ,C.FREE_ADD_TEU_CAPA" ).append("\n"); 
		query.append("--            ,C.FREE_ADD_WGT" ).append("\n"); 
		query.append("--            ,C.N2ND_FNL_HJS_BSA_CAPA" ).append("\n"); 
		query.append("--            ,D.SPC_CTRL_SLT_CAPA" ).append("\n"); 
		query.append("--            ,DECODE(C.SPC_OTR_SWAP_FLG, 'Y', 'YES') SPC_OTR_SWAP_FLG" ).append("\n"); 
		...
		query.append("    #end" ).append("\n"); 
		query.append("        UNION ALL   --HAVING NVL(crr_bsa_capa, 0) > 0" ).append("\n"); 
		...
		query.append("                ,C.VOP_CD" ).append("\n"); 
		query.append("                ,C.BSA_CAPA" ).append("\n"); 
		query.append("                ,D.CRR_CD   --,D.CRR_BSA_CAPA" ).append("\n"); 
		query.append("                ,D.BSA_OP_JB_CD" ).append("\n"); 
		query.append("                ,0 BSA" ).append("\n"); 
		query.append("--              ,0 FREE_ADD_TEU_CAPA" ).append("\n"); 
		query.append("--              ,0 FREE_ADD_WGT" ).append("\n"); 
		query.append("--              ,0 N2ND_FNL_HJS_BSA_CAPA" ).append("\n"); 
		query.append("--              ,0 SPC_CTRL_SLT_CAPA" ).append("\n"); 
		query.append("--              ,NULL SPC_OTR_SWAP_FLG" ).append("\n"); 
