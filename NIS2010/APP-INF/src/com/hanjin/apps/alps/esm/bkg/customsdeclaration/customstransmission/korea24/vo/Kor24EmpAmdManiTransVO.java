...
*@FileTitle : <Kor24EmpAmdManiTransVO.java
*@FileTitle : Kor24EmpAmdManiTransVO
*Open Issues :
*Change history :
 ...
 * @author 박상훈
 * @since J2EE 1.6
 * @see EmpAmdManiTransVO
 */

public class Kor24EmpAmdManiTransVO extends EmpAmdManiTransVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24EmpAmdManiTransVO> models = new ArrayList<Kor24EmpAmdManiTransVO>();
	...
	public Kor24EmpAmdManiTransVO() {}

	public Kor24EmpAmdManiTransVO(String ibflag, String pagerows, String ibTsSeq, String ibTsCblno, String ibTsPort, String ibTsBkgno, String ibTsType, String ibTsVvd, String corrCd, String corrReason, String usrId, String subNo, String blNo, String receiver, String ofcCd) {
...
/**
	 ...
	 * @param request
	 * @return Kor24EmpAmdManiTransVO[]
	 */
	public Kor24EmpAmdManiTransVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24EmpAmdManiTransVO[]
	 */
	public Kor24EmpAmdManiTransVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24EmpAmdManiTransVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24EmpAmdManiTransVO();
				if (ibTsBkgno[i] != null)
		...
		return getKor24EmpAmdManiTransVOs();
	}
	 ...
	 * @return Kor24EmpAmdManiTransVO[]
	 */
	public Kor24EmpAmdManiTransVO[] getKor24EmpAmdManiTransVOs(){
		Kor24EmpAmdManiTransVO[] vos = (Kor24EmpAmdManiTransVO[])models.toArray(new Kor24EmpAmdManiTransVO[models.size()]);
		return vos;
	}
