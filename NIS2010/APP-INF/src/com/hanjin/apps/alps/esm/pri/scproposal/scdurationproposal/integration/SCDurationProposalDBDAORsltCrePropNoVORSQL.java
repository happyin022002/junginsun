...
*@FileName : SCDurationProposalDBDAORsltCrePropNoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCDurationProposalDBDAORsltCrePropNoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCDurationProposalDBDAORsltCrePropNoVORSQL(){
		setQuery();
		...
		query.append("FileName : SCDurationProposalDBDAORsltCrePropNoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
