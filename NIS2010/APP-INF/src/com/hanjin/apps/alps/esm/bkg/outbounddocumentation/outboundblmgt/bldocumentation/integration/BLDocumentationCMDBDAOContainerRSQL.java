...
public class BLDocumentationCMDBDAOContainerRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",      DECODE(SUBSTR(CNTR_TPSZ_CD, 1, 1), 'R', DECODE(A.RC_FLG, 'Y', 'N', 'Y'), NVL(A.RC_FLG, 'Y')) RD_CGO_FLG" ).append("\n"); 
		...
		query.append("        FROM   BKG_IMG_STO SA, BKG_DG_CGO_HIS SB" ).append("\n"); 
		...
		query.append(",      A.ONE_WY_FREE_FLG" ).append("\n"); 
		query.append(",      A.MF_CFM_FLG" ).append("\n"); 
		query.append(",      A.LBP_FLG" ).append("\n"); 
		query.append(",	   A.VGM_WGT " ).append("\n"); 
		query.append(",      A.VGM_WGT_UT_CD" ).append("\n"); 
		query.append(",	   TO_CHAR(A.VGM_VRFY_DT,'YYYY-MM-DD') VGM_VRFY_DT" ).append("\n"); 
		query.append(",	   TO_CHAR(A.VGM_DTMN_DT,'YYYY-MM-DD') VGM_DTMN_DT" ).append("\n"); 
