...
*@FileName : ESM_PRI_8103HTMLAction.java
...
public class ESM_PRI_8103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_8103HTMLAction 객체를 생성
	 */
	public ESM_PRI_8103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri8103Event event = new EsmPri8103Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) { //Commodity
			event.setPriScqAwkCmdtListVO((PriScqAwkCmdtListVO)getVO(request, PriScqAwkCmdtListVO .class));
		}
