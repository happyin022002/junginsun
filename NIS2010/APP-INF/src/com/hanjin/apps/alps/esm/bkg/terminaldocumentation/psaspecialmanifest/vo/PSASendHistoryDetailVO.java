...
*@FileName : PSASendHistoryDetailVO.java
*@FileTitle : PSASendHistoryDetailVO
*Open Issues :
*Change history :
...
public class PSASendHistoryDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSASendHistoryDetailVO> models = new ArrayList<PSASendHistoryDetailVO>();
	...
	public PSASendHistoryDetailVO() {}

	public PSASendHistoryDetailVO(String ibflag, String pagerows, String psaEdiMsgTpId, String msgRcvNo, String rcvLogSeq, String rcvLogErrSeq, String cstmsErrId, String cstmsErrMsg, String cstmsErrRefNo1, String cstmsErrRefNo2, String creUsrId, String creDt, String updUsrId, String updDt, String psaVslNm, String ibVvdCd, String obVvdCd, String cntrNo, String cntrHndlKndCd, String errCntrStsCd, String tnkCntrTpszFlg, String ttlPckQty, String ttlPckTpNm, String dgTtlWgt, String imoNo, String imdgUnNo, String cntrTtlKnt, String cntrTtlErrKnt, String cntrTtlScsKnt, String imdgPckGrpCd, String flshPntCdoTemp, String eurPckDesc, String sndDt, String blNo, String vvdCd, String msgFuncId, String eurDgDeclTpCd, String pckQty, String scrFileNo, String portCd, String tranId, String ackDt, String autoSndTpCd, String netWgt, String aproDt, String cntrCgoSeq, String ackRcvStsCd, String hzdDesc, String prpShpNm, String msgSndNo, String grsWgt, String imdgClssCd, String sndUsrId, String psaDgDeclTpCd) {
...
/**
	 ...
	 * @param request
	 * @return PSASendHistoryDetailVO[]
	 */
	public PSASendHistoryDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSASendHistoryDetailVO[]
	 */
	public PSASendHistoryDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSASendHistoryDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PSASendHistoryDetailVO();
				if (ibVvdCd[i] != null)
		...
		return getPSASendHistoryDetailVOs();
	}
	 ...
	 * @return PSASendHistoryDetailVO[]
	 */
	public PSASendHistoryDetailVO[] getPSASendHistoryDetailVOs(){
		PSASendHistoryDetailVO[] vos = (PSASendHistoryDetailVO[])models.toArray(new PSASendHistoryDetailVO[models.size()]);
		return vos;
	}
