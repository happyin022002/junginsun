...
public class KorCorrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorCorrVO> models = new ArrayList<KorCorrVO>();
	...
	public KorCorrVO(String ibflag, String pagerows, String submitChk, String blNo, String portCd, String cstmsDeclTpCd, String vvd, String ioBndCd) {
		this.vvd = vvd;
		this.ibflag = ibflag;
	 ...
	 * @return KorCorrVO[]
	 */
	public KorCorrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCorrVO[]
	 */
	public KorCorrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCorrVO model = null;
	 ...
	 * @return KorCorrVO[]
	 */
	public KorCorrVO[] getKorCorrVOs(){
		KorCorrVO[] vos = (KorCorrVO[])models.toArray(new KorCorrVO[models.size()]);
		return vos;
	}
