...
public class UsaCustomsReportDBDAOsearchToBeDeletedListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			AND C.VSL_PRE_PST_CD		= 'S'" ).append("\n"); 
		query.append("			AND C.VSL_SEQ				= 1" ).append("\n"); 
		...
		query.append("#if (${trunkfirst} == 'S') " ).append("\n"); 
		query.append("				AND A.VSL_PRE_PST_CD		= 'S'" ).append("\n"); 
		...
		query.append("	AND D.VSL_PRE_PST_CD		= 'T'  " ).append("\n"); 
		...
		query.append("                    WHERE FM_BKG_NO = B.BL_NO" ).append("\n"); 
