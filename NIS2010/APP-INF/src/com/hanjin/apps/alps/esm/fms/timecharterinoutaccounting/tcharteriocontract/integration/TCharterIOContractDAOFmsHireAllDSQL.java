...
public class TCharterIOContractDAOFmsHireAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOContractDAOFmsHireAllDSQL
	  * </pre>
	  */
	public TCharterIOContractDAOFmsHireAllDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("delete from fms_hire" ).append("\n"); 
		...
		query.append("FileName : TCharterIOContractDAOFmsHireAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}