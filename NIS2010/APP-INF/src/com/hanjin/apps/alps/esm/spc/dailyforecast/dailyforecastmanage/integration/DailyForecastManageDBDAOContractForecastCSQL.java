...
*@FileName : DailyForecastManageDBDAOContractForecastCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DailyForecastManageDBDAOContractForecastCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DailyForecastManageDBDAOContractForecastCSQL(){
		setQuery();
		...
		query.append("FileName : DailyForecastManageDBDAOContractForecastCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SPC_CTRT_FCAST_CUST (" ).append("\n"); 
		...
		query.append("         '1'           AS POL_IND_SEQ   ," ).append("\n"); 
		query.append("         '1'           AS POD_IND_SEQ   ," ).append("\n"); 
		query.append("         '1'           AS POL_YD_IND_SEQ," ).append("\n"); 
		query.append("         '1'           AS POD_YD_IND_SEQ," ).append("\n"); 
