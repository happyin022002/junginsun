...
public class ESM_COA_0120HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0120HTMLAction 객체를 생성
	 */
	public ESM_COA_0120HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0120Event event = new EsmCoa0120Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCoaSsnlSltMgmtUtVOS((CoaSsnlSltMgmtUtVO[])getVOs(request, CoaSsnlSltMgmtUtVO .class,""));
		}
