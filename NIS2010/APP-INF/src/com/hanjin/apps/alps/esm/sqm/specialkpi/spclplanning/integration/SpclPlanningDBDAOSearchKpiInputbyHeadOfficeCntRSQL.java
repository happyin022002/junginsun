...
*@FileName : SpclPlanningDBDAOSearchKpiInputbyHeadOfficeCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpclPlanningDBDAOSearchKpiInputbyHeadOfficeCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SpclPlanningDBDAOSearchKpiInputbyHeadOfficeCnt
	  * </pre>
	  */
	public SpclPlanningDBDAOSearchKpiInputbyHeadOfficeCntRSQL(){
		setQuery();
		...
		query.append("FileName : SpclPlanningDBDAOSearchKpiInputbyHeadOfficeCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
