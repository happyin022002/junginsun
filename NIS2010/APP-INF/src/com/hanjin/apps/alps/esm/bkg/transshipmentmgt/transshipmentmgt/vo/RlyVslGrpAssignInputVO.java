...
public class RlyVslGrpAssignInputVO extends AbstractValueObject {
	...
	/* Column Info */
	private String blankFormerVvd = null;
	/* Column Info */
	private String blankPostVvd = null;
	/* Page Number */
	...
	public RlyVslGrpAssignInputVO(String ibflag, String pagerows, String relayportCd, String relayportYardCd, String etbFrom, String etbTo, String formerVvd, String nextVvd, String nextPort, String polCd, String podCd, String blankFormerVvd, String blankPostVvd) {
		this.podCd = podCd;
		this.polCd = polCd;
		this.ibflag = ibflag;
		...
		this.blankFormerVvd = blankFormerVvd;
		this.blankPostVvd = blankPostVvd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("blank_former_vvd", getBlankFormerVvd());
		this.hashColumns.put("blank_post_vvd", getBlankPostVvd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("blank_former_vvd", "blankFormerVvd");
		this.hashFields.put("blank_post_vvd", "blankPostVvd");
	...
	public String getBlankFormerVvd() {
		return blankFormerVvd;
	}

	public String getBlankPostVvd() {
		return blankPostVvd;
	}
	...
	public void setBlankPostVvd(String blankPostVvd) {
		this.blankPostVvd = blankPostVvd;
	}
	public void setBlankFormerVvd(String blankFormerVvd) {
		this.blankFormerVvd = blankFormerVvd;
	}
