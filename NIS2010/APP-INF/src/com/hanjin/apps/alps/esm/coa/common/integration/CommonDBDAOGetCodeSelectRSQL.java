...
public class CommonDBDAOGetCodeSelectRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                   WHEN OFC_N4TH_LVL_CD IN('SHARC', 'SINRS', 'HAMRU', 'NYCRA','SELIB','TYOIB')" ).append("\n"); 
		query.append("                      THEN OFC_N4TH_LVL_CD" ).append("\n"); 
		query.append("                   ELSE OFC_N4TH_LVL_TP_CD" ).append("\n"); 
		query.append("                END" ).append("\n"); 
		query.append("                END" ).append("\n"); 
		...
		query.append("   	    #end " ).append("\n"); 
		query.append(" 	 ORDER BY CUST_LGL_ENG_NM" ).append("\n"); 
		query.append("#elseif (${methodname} == 'searchTotCoaCodeList')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*COA CODE ComboList항목을 가져온다*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	SELECT STND_COST_CD CODE" ).append("\n"); 
		query.append("		  ,STND_COST_NM NAME " ).append("\n"); 
		query.append("	  FROM COA_STND_ACCT " ).append("\n"); 
		query.append("	 WHERE (MGRP_COST_CD in ('OV','OF') AND STND_COST_CD != '54600000' )" ).append("\n"); 
		...
		query.append("   	   AND OFC_TP_CD  <> 'AQ' " ).append("\n"); 
		query.append("   	   AND OFC_CD NOT IN('SHARC', 'HAMRU', 'NYCRA', 'SINRS','SELIB','TYOIB')" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("		  FROM (" ).append("\n"); 
		query.append("		                SELECT  OFC_N5TH_LVL_CD CODE FROM COA_OFC_LVL WHERE OFC_N5TH_LVL_TP_CD IS NOT NULL   			/*AND COST_YRMON = TO_CHAR(SYSDATE, 'YYYYMM') 월별관리*/" ).append("\n"); 
		query.append("		          UNION SELECT  OFC_N6TH_LVL_CD CODE FROM COA_OFC_LVL WHERE OFC_N6TH_LVL_TP_CD IS NOT NULL  	/* AND COST_YRMON = TO_CHAR(SYSDATE, 'YYYYMM') 월별관리*/" ).append("\n"); 
		query.append("		          UNION SELECT  OFC_N7TH_LVL_CD CODE FROM COA_OFC_LVL WHERE OFC_N7TH_LVL_TP_CD IS NOT NULL 	/*AND COST_YRMON = TO_CHAR(SYSDATE, 'YYYYMM') 월별관리*/" ).append("\n"); 
		...
		query.append("		  FROM COA_TML_TRF_GRP" ).append("\n"); 
		...
		query.append("		FROM   COA_STND_ACCT " ).append("\n"); 
		query.append("		WHERE (MGRP_COST_CD = 'OV' OR MGRP_COST_CD = 'OF') " ).append("\n"); 
		query.append("		AND   NVL(DELT_FLG,'N') = 'N'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("/*coa_office_level_v에서 본부코드를 가져온다*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("			         FROM COA_OFC_LVL)" ).append("\n"); 
		query.append("		 WHERE OFC_N3RD_LVL_CD IN ('HAMRU', 'SHARC', 'NYCRA', 'SINRS','SELIB','TYOIB')" ).append("\n"); 
		...
		query.append("			         FROM COA_OFC_LVL" ).append("\n"); 
		query.append("			        WHERE OFC_N3RD_LVL_CD IN ('HAMRU', 'NYCRA', 'SHARC', 'SINRS','SELIB','TYOIB')" ).append("\n"); 
		query.append("			        UNION ALL" ).append("\n"); 
		...
		query.append("	                         ,'CD00941',DECODE(A.PFIT_LVL_DFLT_CD,'Y', 'SELECTED')" ).append("\n"); 
		query.append("	                         ,'CD02979',DECODE(A.PFIT_LVL_DFLT_CD,'Y', 'SELECTED')) SELOPT " ).append("\n"); 
		...
		query.append("	                                'CD02979',A.PFIT_LVL_CD) " ).append("\n"); 
		...
		query.append("	                                'CD02979',A.PFIT_LVL_SLCT_FLG) " ).append("\n"); 
		query.append("	  AND  A.OFC_LVL          = @[ofclvl1] " ).append("\n"); 
		query.append("	 UNION ALL" ).append("\n"); 
		query.append("	 SELECT 'M','CM2',''" ).append("\n"); 
		query.append("	 FROM DUAL" ).append("\n"); 
		query.append("	 WHERE @[ofclvl0] = 'CD02979'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif (${methodname} == 'searchSubGRPCostList')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/*COA Sub Group 항목을 가져온다  정렬 수정 */" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("#if(${code} == 'HJS')" ).append("\n"); 
		...
		query.append("	   AND COA_COST_SRC_CD 	= @[code2]" ).append("\n"); 
		query.append("	#end	   " ).append("\n"); 
