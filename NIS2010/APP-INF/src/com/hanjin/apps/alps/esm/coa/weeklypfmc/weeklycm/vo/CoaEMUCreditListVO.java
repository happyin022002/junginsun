...
*@FileName : CoaEMUCreditListVO.java
*@FileTitle : CoaEMUCreditListVO
*Open Issues :
*Change history :
...
public class CoaEMUCreditListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaEMUCreditListVO> models = new ArrayList<CoaEMUCreditListVO>();
...
/**
	 ...
	 */
	public CoaEMUCreditListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaEMUCreditListVO[]
	 */
	public CoaEMUCreditListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaEMUCreditListVO model = null;
	...
	public CoaEMUCreditListVO[] getCoaEMUCreditListVOs(){
		CoaEMUCreditListVO[] vos = (CoaEMUCreditListVO[])models.toArray(new CoaEMUCreditListVO[models.size()]);
		return vos;
	}
