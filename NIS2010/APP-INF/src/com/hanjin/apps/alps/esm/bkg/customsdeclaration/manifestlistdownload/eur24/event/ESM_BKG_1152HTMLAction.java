...
*@FileName : ESM_BKG_1152HTMLAction.java
...
public class ESM_BKG_1152HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1120HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1152HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1152Event event = new EsmBkg1152Event();
		Eu24EXSListVO vo = new Eu24EXSListVO(); 
		if(command.isCommand(FormCommand.SEARCH)) {
			vo = (Eu24EXSListVO)getVO(request, Eu24EXSListVO.class);
			event.setEu24EXSListVO(vo);
		}   
