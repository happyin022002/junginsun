...
*@FileName : ESM_BSA_0042HTMLAction.java
*@FileTitle : ESM_BSA_0042HTMLAction
*Open Issues :
*Change history :
...
public class ESM_BSA_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BSA_0042HTMLAction 객체를 생성
	 */
	public ESM_BSA_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmBsa0042Event event = new EsmBsa0042Event();
