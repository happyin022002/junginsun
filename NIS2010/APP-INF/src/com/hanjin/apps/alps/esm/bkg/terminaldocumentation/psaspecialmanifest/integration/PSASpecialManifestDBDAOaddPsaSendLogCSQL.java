...
*@FileName : PSASpecialManifestDBDAOaddPsaSendLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOaddPsaSendLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSASpecialManifestDBDAOaddPsaSendLogCSQL(){
		setQuery();
		...
		query.append("FileName : PSASpecialManifestDBDAOaddPsaSendLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_PSA_DG_SND (" ).append("\n"); 
