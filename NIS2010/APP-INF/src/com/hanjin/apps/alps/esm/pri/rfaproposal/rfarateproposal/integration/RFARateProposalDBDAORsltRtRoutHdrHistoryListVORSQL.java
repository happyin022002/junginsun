...
*@FileName : RFARateProposalDBDAORsltRtRoutHdrHistoryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtRoutHdrHistoryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtRoutHdrHistoryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtRoutHdrHistoryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          FROM (SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, CMDT_HDR_SEQ, 0 AS ROUT_SEQ" ).append("\n"); 
		...
		query.append("                 GROUP BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, CMDT_HDR_SEQ" ).append("\n"); 
		query.append("                UNION" ).append("\n"); 
		query.append("                SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, CMDT_HDR_SEQ, 0 AS ROUT_SEQ" ).append("\n"); 
