...
*@FileName : EBookingReceiptDBDAOSearchAlpsAkRiderListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOSearchAlpsAkRiderListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EBookingReceiptDBDAOSearchAlpsAkRiderListRSQL
	  * </pre>
	  */
	public EBookingReceiptDBDAOSearchAlpsAkRiderListRSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOSearchAlpsAkRiderListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
