...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutViaCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutViaCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpRtRoutViaCopyToProposal
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutViaCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutViaCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,PRI_SQ_RT_ROUT_VIA S" ).append("\n"); 
