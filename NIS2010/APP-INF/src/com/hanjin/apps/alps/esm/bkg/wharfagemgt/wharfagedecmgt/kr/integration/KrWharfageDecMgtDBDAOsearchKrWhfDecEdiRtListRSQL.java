...
*@FileName : KrWharfageDecMgtDBDAOsearchKrWhfDecEdiRtListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KrWharfageDecMgtDBDAOsearchKrWhfDecEdiRtListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KrWharfageDecMgtDBDAOsearchKrWhfDecEdiRtListRSQL(){
		setQuery();
		...
		query.append("FileName : KrWharfageDecMgtDBDAOsearchKrWhfDecEdiRtListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" A.VOL AS RTON" ).append("\n"); 
		query.append(",A.IND AS DSCH_IND" ).append("\n"); 
		query.append(",A.DC  AS DC_CD" ).append("\n"); 
		query.append(",A.REA AS DC_REASON" ).append("\n"); 
		query.append(",A.UNIT AS UNIT" ).append("\n"); 
		query.append(",A.VOL*UNIT AS AMOUNT" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT SUM(A.TTL_TON_QTY) VOL , UNLD_TP_CD IND, DECODE(@[port_cd]   ,'KRINC',DECODE(KR_WHF_DC_CD,'1','6','4','9',KR_WHF_DC_CD)," ).append("\n"); 
		query.append("																	 'KRGIN',DECODE(KR_WHF_DC_CD,'1','6','4','9',KR_WHF_DC_CD)," ).append("\n"); 
		query.append("																	 'KRKAN',''," ).append("\n"); 
		query.append("																	 KR_WHF_DC_CD) DC ," ).append("\n"); 
