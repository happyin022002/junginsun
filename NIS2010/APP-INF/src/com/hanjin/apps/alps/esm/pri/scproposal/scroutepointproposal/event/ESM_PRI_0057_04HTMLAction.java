...
*@FileName : ESM_PRI_0057_04HTMLAction.java
...
public class ESM_PRI_0057_04HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0057_04HTMLAction 객체를 생성
	 */
	public ESM_PRI_0057_04HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri005704Event event = new EsmPri005704Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriSpScpRoutPntVO((PriSpScpRoutPntVO)getVO(request, PriSpScpRoutPntVO .class));
