...
*@FileName : KorAutoImfSndVO.java
*@FileTitle : KorAutoImfSndVO
*Open Issues :
*Change history :
...
public class KorAutoImfSndVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorAutoImfSndVO> models = new ArrayList<KorAutoImfSndVO>();
	...
	public KorAutoImfSndVO() {}

	public KorAutoImfSndVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorAutoImfSndVO[]
	 */
	public KorAutoImfSndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorAutoImfSndVO[]
	 */
	public KorAutoImfSndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorAutoImfSndVO model = null;
	 ...
	 * @return KorAutoImfSndVO[]
	 */
	public KorAutoImfSndVO[] getKorAutoImfSndVOs(){
		KorAutoImfSndVO[] vos = (KorAutoImfSndVO[])models.toArray(new KorAutoImfSndVO[models.size()]);
		return vos;
	}
