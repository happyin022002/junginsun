...
*@FileName : EsmMas0112GSViewAdapter.java
*@FileTitle : EsmMas0112GSViewAdapter
*Open Issues :
*Change history :
...
/**
 * EsmMas0112GSViewAdapter 에 대한 ViewAdapter<br>
 *  EsmMas0112GSViewAdapter 작성<br>
 *
 * @author 박수훈
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0112GSViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0112GSViewAdapter(){
    	super();
    }
