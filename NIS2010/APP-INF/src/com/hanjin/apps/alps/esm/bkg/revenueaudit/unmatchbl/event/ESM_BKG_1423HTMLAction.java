...
*@FileName : ESM_BKG_1423HTMLAction.java
...
public class ESM_BKG_1423HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1423HTMLAction 객체를 생성
	 */
	public ESM_BKG_1423HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1423Event event = new EsmBkg1423Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setIndiaDthBKGListForAuditVO((IndiaDthBKGListForAuditVO)getVO(request,IndiaDthBKGListForAuditVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI01)) {
			event.setIndiaDthBKGListForAuditVOs((IndiaDthBKGListForAuditVO[])getVOs(request, IndiaDthBKGListForAuditVO.class, ""));
		}
