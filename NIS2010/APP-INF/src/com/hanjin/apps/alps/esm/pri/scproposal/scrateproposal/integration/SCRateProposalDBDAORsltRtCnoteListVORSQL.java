...
*@FileName : SCRateProposalDBDAORsltRtCnoteListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtCnoteListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtCnoteListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtCnoteListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,LAG(NOTE_CONV_MAPG_ID) OVER(PARTITION BY PROP_NO, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ, CMDT_NOTE_SEQ ORDER BY AMDT_SEQ) AS PREV_NOTE_CONV_MAPG_ID" ).append("\n"); 
		query.append("              ,ACPT_USR_ID" ).append("\n"); 
		query.append("              ,ACPT_OFC_CD" ).append("\n"); 
