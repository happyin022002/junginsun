...
*@FileName : UserSetupMgtDBDAOModifyBkgChkPntItemUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAOModifyBkgChkPntItemUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAOModifyBkgChkPntItemUSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAOModifyBkgChkPntItemUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CHK_PNT_ITM" ).append("\n"); 
		query.append("   SET CHK_PNT_ITM_NM = @[chk_pnt_itm_nm]" ).append("\n"); 
