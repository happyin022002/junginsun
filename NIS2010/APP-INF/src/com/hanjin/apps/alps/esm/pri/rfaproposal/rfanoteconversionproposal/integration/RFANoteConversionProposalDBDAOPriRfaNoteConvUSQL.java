...
*@FileName : RFANoteConversionProposalDBDAOPriRfaNoteConvUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteConversionProposalDBDAOPriRfaNoteConvUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFANoteConversionProposalDBDAOPriRfaNoteConvUSQL(){
		setQuery();
		...
		params.put("pre_note_conv_mapg_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RFANoteConversionProposalDBDAOPriRfaNoteConvUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	  NOTE_CONV_MAPG_ID			= @[pre_note_conv_mapg_id]-- 새거" ).append("\n"); 
		query.append("	, EFF_DT					= TO_DATE(@[eff_dt], 'YYYYMMDD')" ).append("\n"); 
		query.append("	, EXP_DT					= TO_DATE(@[exp_dt], 'YYYYMMDD')" ).append("\n"); 
		query.append("    , SRC_INFO_CD = 'NW'" ).append("\n"); 
		query.append("    , PRC_PROG_STS_CD = 'A'" ).append("\n"); 
		query.append("WHERE NOTE_CONV_MAPG_ID	= @[note_conv_mapg_id] -- 기존" ).append("\n"); 
