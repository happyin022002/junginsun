...
*@FileName : SalesRPTDBDAOSearchBKGDetail0148ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesRPTDBDAOSearchBKGDetail0148ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SalesRPTDBDAOSearchBKGDetail0148ListRSQL(){
		setQuery();
		...
		query.append("FileName : SalesRPTDBDAOSearchBKGDetail0148ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , CM_COST                            AS CMC      -- CM_COST" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET)         AS CM       -- REV(BKG_REV+BKG_OFT_REV+BKG_MISC_REV+SCR_CHG_REV)-CM_COST" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET-CM2_COST) AS CM2" ).append("\n"); 
		query.append("      , OP_COST                  AS OPC      -- OP_COST" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET-OP_COST) AS OP       -- CM-OP_COST" ).append("\n"); 
		query.append("      ,(BKG_REV/LOAD)                     AS G_RPB    -- REV/LOAD" ).append("\n"); 
		query.append("      , CM_COST                           AS CM_COST" ).append("\n"); 
		query.append("      , CM2_COST                           AS CM2_COST -- OWN FEEDER COST" ).append("\n"); 
		query.append("      , CM_COST/LOAD                      AS CMCOST   -- CM_COST/LOAD " ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET)/LOAD    AS CMB      -- CM/LOAD" ).append("\n"); 
		query.append("      , OP_COST                   AS OP_COST " ).append("\n"); 
		query.append("      , OP_COST/LOAD            AS OPCOST   -- OP_COST/LOAD" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET-OP_COST)/LOAD AS OPB -- OP/LOAD" ).append("\n"); 
		...
		query.append("           ,SUM(DECODE(@[f_pro_vw], 'P', NVL(A6.PA_OP_COST_TTL_AMT, 0), 0)) OP_COST" ).append("\n"); 
		...
		query.append("        AND B.BKG_NO         = A6.BKG_NO(+)" ).append("\n"); 
		query.append("        AND B.CNTR_TPSZ_CD   = A6.CNTR_TPSZ_CD(+)" ).append("\n"); 
		query.append("        AND B.COST_ROUT_NO   = A6.COST_ROUT_NO(+)" ).append("\n"); 
		...
		query.append("               ,B.BKG_POR_CD, B.BKG_POL_CD, B.BKG_POD_CD, B.BKG_DEL_CD" ).append("\n"); 
		query.append("               ,B.BKG_NO" ).append("\n"); 
