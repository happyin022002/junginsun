...
*@FileName : SearchFleetStatusListVO.java
*@FileTitle : SearchFleetStatusListVO
*Open Issues :
*Change history :
...
public class SearchFleetStatusListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchFleetStatusListVO> models = new ArrayList<SearchFleetStatusListVO>();
	 ...
	 */
	public SearchFleetStatusListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchFleetStatusListVO[]
	 */
	public SearchFleetStatusListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchFleetStatusListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchFleetStatusListVO();
	 ...
	 * @return SearchFleetStatusListVO[]
	 */
	public SearchFleetStatusListVO[] getSearchFleetStatusListVOs(){
		SearchFleetStatusListVO[] vos = (SearchFleetStatusListVO[])models.toArray(new SearchFleetStatusListVO[models.size()]);
		return vos;
	}
