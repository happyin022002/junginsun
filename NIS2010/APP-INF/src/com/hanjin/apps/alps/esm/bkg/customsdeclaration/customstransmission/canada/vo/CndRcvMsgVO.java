...
public class CndRcvMsgVO extends RcvMsgVO { // extends 수정추가.

	private static final long serialVersionUID = 1L;
	
	private Collection<CndRcvMsgVO> models = new ArrayList<CndRcvMsgVO>();
	 ...
	 * @return UsaRcvMsgVO[]
	 */
	public CndRcvMsgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaRcvMsgVO[]
	 */
	public CndRcvMsgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndRcvMsgVO model = null;
	 ...
	 * @return UsaRcvMsgVO[]
	 */
	public CndRcvMsgVO[] getUsaRcvMsgVOs(){
		CndRcvMsgVO[] vos = (CndRcvMsgVO[])models.toArray(new CndRcvMsgVO[models.size()]);
		return vos;
	}
