...
*@FileName : EsmCoa0072ViewAdapter5.java
*@FileTitle : EsmCoa0072ViewAdapter5
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0072ViewAdapter5 extends DefaultViewAdapter {
	
    public EsmCoa0072ViewAdapter5(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmCoa0072ViewAdapter5 ########### [START]");
    	...
    	try{	
			...
			if (rowSet != null) {
				...
				while (rowSet[1].next()) {
					...
					strBuilder.append("\n<TD>").append(JSPUtil.getNull(rowSet[1].getString("status"))).append("</TD>");
		...
		log.debug("########### EsmCoa0072ViewAdapter5 ########### [END]");        
