...
*@FileTitle : <Kor24AutoMacSndDtlVO.java
*@FileTitle : Kor24AutoMacSndDtlVO
*Open Issues :
*Change history :
...
public class Kor24AutoMacSndDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24AutoMacSndDtlVO> models = new ArrayList<Kor24AutoMacSndDtlVO>();
	...
	public Kor24AutoMacSndDtlVO() {}

	public Kor24AutoMacSndDtlVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq, String ediSndMsg) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return Kor24AutoMacSndDtlVO[]
	 */
	public Kor24AutoMacSndDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24AutoMacSndDtlVO[]
	 */
	public Kor24AutoMacSndDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24AutoMacSndDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24AutoMacSndDtlVO();
				if (ofcCd[i] != null)
		...
		return getKor24AutoMacSndDtlVOs();
	}
	 ...
	 * @return Kor24AutoMacSndDtlVO[]
	 */
	public Kor24AutoMacSndDtlVO[] getKor24AutoMacSndDtlVOs(){
		Kor24AutoMacSndDtlVO[] vos = (Kor24AutoMacSndDtlVO[])models.toArray(new Kor24AutoMacSndDtlVO[models.size()]);
		return vos;
	}
