...
public class BangladeshCustomsTransmissionDBDAOsearchBlGeneralRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("           		'BLPKGU:'||BDC.PCK_TP_CD||CHR(10)||  " ).append("\n"); 
		...
		query.append("      	FROM   BKG_BOOKING BKG, BKG_CUSTOMER BCC, BKG_CUSTOMER BCS, BKG_CUSTOMER BCN, BKG_BL_DOC BDC" ).append("\n"); 
