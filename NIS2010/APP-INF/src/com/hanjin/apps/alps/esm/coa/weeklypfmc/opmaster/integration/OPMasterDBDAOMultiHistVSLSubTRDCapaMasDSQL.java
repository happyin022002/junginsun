...
*@FileName : OPMasterDBDAOMultiHistVSLSubTRDCapaMasDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistVSLSubTRDCapaMasDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiHistVSLSubTRDCapaMas
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistVSLSubTRDCapaMasDSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistVSLSubTRDCapaMasDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
