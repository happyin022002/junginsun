...
*@FileName : WeeklyCMDBDAOMasSltMgmtUtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOMasSltMgmtUtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOMasSltMgmtUtVOUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOMasSltMgmtUtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_SLT_MGMT_UT A" ).append("\n"); 
