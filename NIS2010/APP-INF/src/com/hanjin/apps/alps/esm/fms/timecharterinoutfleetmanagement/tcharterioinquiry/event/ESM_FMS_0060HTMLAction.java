...
*@FileName : ESM_FMS_0060HTMLAction.java
...
public class ESM_FMS_0060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0060HTMLAction 객체를 생성
	 */
	public ESM_FMS_0060HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0060Event event = new EsmFms0060Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondSearchFleetStatusVO((CondSearchFleetStatusVO)getVO(request, CondSearchFleetStatusVO .class));
			event.setCondSearchFleetStatusSumVO((CondSearchFleetStatusSumVO)getVO(request, CondSearchFleetStatusSumVO .class));
		}
