...
*@FileName : MultiMasMonVvdVO.java
*@FileTitle : MultiMasMonVvdVO
*Open Issues :
*Change history :
...
public class MultiMasMonVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MultiMasMonVvdVO> models = new ArrayList<MultiMasMonVvdVO>();
...
/**
	 ...
	 * @param request
	 * @return MultiMasMonVvdVO[]
	 */
	public MultiMasMonVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MultiMasMonVvdVO[]
	 */
	public MultiMasMonVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MultiMasMonVvdVO model = null;
	...
	public MultiMasMonVvdVO[] getMultiMasMonVvdVOs(){
		MultiMasMonVvdVO[] vos = (MultiMasMonVvdVO[])models.toArray(new MultiMasMonVvdVO[models.size()]);
		return vos;
	}
