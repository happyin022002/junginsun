...
public class DemDet3rdDBDAOSearchDEMDET3RDListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND   A.STND_COST_CD = B.MAS_COST_SRC_CD --201110월 이전만 사용 (STND CD와 동일한 SRC CD만 사용하였음)" ).append("\n"); 
		query.append("AND   A.COST_ASS_BSE_CD = D.INTG_CD_VAL_CTNT" ).append("\n"); 
		query.append("ORDER BY CNTR_TPSZ_CD, C.STND_COST_NM, B.MAS_COST_SRC_CD_NM" ).append("\n"); 
