...
*@FileName : PriTrfInlndHistoryVO.java
*@FileTitle : PriTrfInlndHistoryVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.pri.tariff.inlandrates.vo;
...
public class PriTrfInlndHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriTrfInlndHistoryVO> models = new ArrayList<PriTrfInlndHistoryVO>();
...
/**
	 ...
	 */
	public PriTrfInlndHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriTrfInlndHistoryVO[]
	 */
	public PriTrfInlndHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriTrfInlndHistoryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriTrfInlndHistoryVO();
				if (updDt[i] != null)
		...
		return getPriTrfInlndHistoryVOs();
	}
	 ...
	 * @return PriTrfInlndHistoryVO[]
	 */
	public PriTrfInlndHistoryVO[] getPriTrfInlndHistoryVOs(){
		PriTrfInlndHistoryVO[] vos = (PriTrfInlndHistoryVO[])models.toArray(new PriTrfInlndHistoryVO[models.size()]);
		return vos;
	}
