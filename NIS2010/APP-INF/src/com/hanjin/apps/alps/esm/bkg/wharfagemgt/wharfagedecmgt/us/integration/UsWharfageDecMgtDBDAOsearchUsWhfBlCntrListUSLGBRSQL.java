...
*@FileName : UsWharfageDecMgtDBDAOsearchUsWhfBlCntrListUSLGBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsWharfageDecMgtDBDAOsearchUsWhfBlCntrListUSLGBRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchUsWhfBlCntrListUSLGB
	  * </pre>
	  */
	public UsWharfageDecMgtDBDAOsearchUsWhfBlCntrListUSLGBRSQL(){
		setQuery();
		...
		query.append("FileName : UsWharfageDecMgtDBDAOsearchUsWhfBlCntrListUSLGBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",   DECODE(TB.USA_WHF_EXPT_FLG, NULL, 'N', 'Y') AS USA_WHF_EXPT_FLG" ).append("\n"); 
		...
		query.append("          ,(SELECT W.CMDT_SEQ" ).append("\n"); 
		query.append("              FROM BKG_USA_WHF_EXPT_CMDT W" ).append("\n"); 
		query.append("             WHERE W.PORT_CD = @[port]" ).append("\n"); 
		...
		query.append("          ,BKG_GET_USLGB_WHF_TRSP_TP_FNC(A.BKG_NO, D.CNTR_NO, @[bound], @[port]) AS USA_WHF_TRSP_TP_CD" ).append("\n"); 
		...
		query.append("   AND  DECODE(TB.USA_WHF_EXPT_FLG, NULL, 'N', 'Y') = RT.USA_WHF_EXPT_FLG(+)" ).append("\n"); 
