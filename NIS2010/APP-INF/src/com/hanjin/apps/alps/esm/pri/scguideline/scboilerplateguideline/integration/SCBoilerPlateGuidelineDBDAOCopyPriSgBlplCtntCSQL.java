...
*@FileName : SCBoilerPlateGuidelineDBDAOCopyPriSgBlplCtntCSQL.java
...
public class SCBoilerPlateGuidelineDBDAOCopyPriSgBlplCtntCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBoilerPlateGuidelineDBDAOCopyPriSgBlplCtntCSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateGuidelineDBDAOCopyPriSgBlplCtntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
