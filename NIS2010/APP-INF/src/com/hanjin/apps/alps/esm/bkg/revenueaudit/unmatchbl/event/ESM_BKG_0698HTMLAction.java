...
public class ESM_BKG_0698HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0698HTMLAction 객체를 생성
	 */
	public ESM_BKG_0698HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0698Event event = new EsmBkg0698Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltUnmatchDiffAmountVO((RsltUnmatchDiffAmountVO)getVO(request, RsltUnmatchDiffAmountVO .class));
		}
