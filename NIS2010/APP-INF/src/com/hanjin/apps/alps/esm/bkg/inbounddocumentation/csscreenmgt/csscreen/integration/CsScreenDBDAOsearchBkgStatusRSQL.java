...
*@FileName : CsScreenDBDAOsearchBkgStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CsScreenDBDAOsearchBkgStatusRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CsScreenDBDAOsearchBkgStatusRSQL(){
		setQuery();
		...
		query.append("FileName : CsScreenDBDAOsearchBkgStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
