...
*@FileName : ESM_BKG_1069HTMLAction.java
...
public class ESM_BKG_1069HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1069HTMLAction 객체를 생성
	 */
	public ESM_BKG_1069HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1069Event event = new EsmBkg1069Event();
        log.debug("::CALL::> ESM_BKG_1069_HTMLAction - " + command.getCommand());
