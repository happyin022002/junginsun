...
*@FileName : ESM_BKG_1090HTMLAction.java
...
public class ESM_BKG_1090HTMLAction extends HTMLActionSupport { 

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1090HTMLAction 객체를 생성
	 */
	public ESM_BKG_1090HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1090Event event = new EsmBkg1090Event();
		...
		event.setChargeAdjustmentVO((ChargeAdjustmentVO)getVO(request, ChargeAdjustmentVO .class));
