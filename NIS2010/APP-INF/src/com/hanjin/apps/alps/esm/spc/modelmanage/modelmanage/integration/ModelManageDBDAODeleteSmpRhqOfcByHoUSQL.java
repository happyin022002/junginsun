...
*@FileName : ModelManageDBDAODeleteSmpRhqOfcByHoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAODeleteSmpRhqOfcByHoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SMP화면 내 HO탭에서 RHQ, OFC delete시 해당 office로 생성되어 있는 정보들의 delt_flg을 Y로, RLANE_ADJ_QTY을 0으로 수정한다.
	  * [CHM-201322502-01] SPC 프로젝트 - 성수기 선복운영 개선을 위한 T/F추진
	  * 2014.02.04 [CHM-201428383-01] RFA 로직 추가
	  * 2014.05.16 [CHM-201430353] SMP / AES 보완요청 - SC 입력 기능 추가
	  * </pre>
	  */
	public ModelManageDBDAODeleteSmpRhqOfcByHoUSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAODeleteSmpRhqOfcByHoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
