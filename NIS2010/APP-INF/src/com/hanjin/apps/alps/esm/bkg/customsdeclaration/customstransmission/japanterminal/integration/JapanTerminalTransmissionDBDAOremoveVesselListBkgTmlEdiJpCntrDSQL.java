...
*@FileName : JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpCntrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpCntrDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_TML_EDI_JP_CNTR 에서 잘못 나간 VVD bkg 정보 삭제
	  * </pre>
	  */
	public JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpCntrDSQL(){
		setQuery();
		...
		query.append("FileName : JapanTerminalTransmissionDBDAOremoveVesselListBkgTmlEdiJpCntrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_TML_EDI_JP_CNTR" ).append("\n"); 
