...
*@FileName : Kor24ManifestListDBDAOmodifyEmpCorrInfoUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyEmpCorrInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyEmpCorrInfoUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyEmpCorrInfoUSQL").append("\n");
		query.append("*/").append("\n");
	}
