...
*@FileName : JapanCustomsTransmissionDBDAOmodifySysAckStsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanCustomsTransmissionDBDAOmodifySysAckStsUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanCustomsTransmissionDBDAOmodifySysAckStsUSQL(){
		setQuery();
		...
		query.append("FileName : JapanCustomsTransmissionDBDAOmodifySysAckStsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE JP_SND_LOG_ID = RTRIM(@[msg_tp])" ).append("\n"); 
