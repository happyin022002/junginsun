...
public class JapanManifestListDownloadDBDAOmodifyJpcusBlCntrUSQL implements ISQLTemplate{
	...
	public JapanManifestListDownloadDBDAOmodifyJpcusBlCntrUSQL(){
		...
		params.put("cntr_seal_no5",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("cntr_seal_no6",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("cntr_seal_no3",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("cntr_seal_no4",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(",	CNTR_SEAL_NO2 = @[cntr_seal_no2]" ).append("\n"); 
		query.append(",	CNTR_SEAL_NO3 = @[cntr_seal_no3]" ).append("\n"); 
		query.append(",	CNTR_SEAL_NO4 = @[cntr_seal_no4]" ).append("\n"); 
		query.append(",	CNTR_SEAL_NO5 = @[cntr_seal_no5]" ).append("\n"); 
		query.append(",	CNTR_SEAL_NO6 = @[cntr_seal_no6]" ).append("\n"); 
