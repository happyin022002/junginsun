...
*@FileName : RsltCopyRoutHdrSmryListVO.java
*@FileTitle : RsltCopyRoutHdrSmryListVO
*Open Issues :
*Change history :
...
public class RsltCopyRoutHdrSmryListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltCopyRoutHdrSmryListVO> models = new ArrayList<RsltCopyRoutHdrSmryListVO>();
	...
	public RsltCopyRoutHdrSmryListVO() {}

	public RsltCopyRoutHdrSmryListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String cmdtHdrSeq, String routSeq, String orgRoutPntLocDefCd, String rcvDeTermCdOri, String orgRoutViaPortDefCd, String destRoutViaPortDefCd, String destRoutPntLocDefCd, String rcvDeTermCdDest, String noteConvSeq, String effDt, String expDt, String bkgDirCallFlg, String bkgTsPortDefCd, String bkgSlanCd, String bkgVvdCd, String noteConvChgCd, String ndCnt, String naCnt, String acCnt, String upCnt, String rowProperties, String bletDpSeqProp, String noteDpSeq, String prevD2, String prevD4, String prevD5, String currD2, String currD4, String currD5, String prevD2Dg, String prevD4Dg, String prevD5Dg, String currD2Dg, String currD4Dg, String currD5Dg, String n1stCmncAmdtSeq, String orgN1stCmncAmdtSeq, String creUsrId, String creDt, String updUsrId, String updDt, String ficRtUseStsCd, String orgCyDorRtTpCd, String destCyDorRtTpCd, String orgBsePortLocCd, String destBsePortLocCd, String mstRfaNo, String mstRoutId, String newPropNo, String ofcCd) {
...
/**
	 ...
	 * @param request
	 * @return RsltCopyRoutHdrSmryListVO[]
	 */
	public RsltCopyRoutHdrSmryListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltCopyRoutHdrSmryListVO[]
	 */
	public RsltCopyRoutHdrSmryListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltCopyRoutHdrSmryListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltCopyRoutHdrSmryListVO();
		...
		return getRsltCopyRoutHdrSmryListVOs();
	}
	 ...
	 * @return RsltCopyRoutHdrSmryListVO[]
	 */
	public RsltCopyRoutHdrSmryListVO[] getRsltCopyRoutHdrSmryListVOs(){
		RsltCopyRoutHdrSmryListVO[] vos = (RsltCopyRoutHdrSmryListVO[])models.toArray(new RsltCopyRoutHdrSmryListVO[models.size()]);
		return vos;
	}
