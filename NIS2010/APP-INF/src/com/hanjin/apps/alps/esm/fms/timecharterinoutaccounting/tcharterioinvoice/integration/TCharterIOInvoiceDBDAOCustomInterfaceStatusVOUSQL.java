...
*@FileName : TCharterIOInvoiceDBDAOCustomInterfaceStatusVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDBDAOCustomInterfaceStatusVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 자발적, 비자발적 오류 처리할 전표에 대한 취소 작업 진행한다
	  * </pre>
	  */
	public TCharterIOInvoiceDBDAOCustomInterfaceStatusVOUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDBDAOCustomInterfaceStatusVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
