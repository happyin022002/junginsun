...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtRoutVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtCmdtRoutVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtRoutVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtRoutVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_RT_CMDT_ROUT SET" ).append("\n"); 
		query.append("DIR_CALL_FLG = DECODE(@[dir_call_flg],'0','N','1','Y')" ).append("\n"); 
