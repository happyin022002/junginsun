...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOAddCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOAddCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOAddCopyCSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOAddCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_CMPB_GLINE_ROUT_PNT (" ).append("\n"); 
