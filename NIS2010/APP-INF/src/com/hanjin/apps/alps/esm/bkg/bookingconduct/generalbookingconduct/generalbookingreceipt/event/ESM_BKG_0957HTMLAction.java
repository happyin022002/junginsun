...
*@FileName : ESM_BKG_0957HTMLAction.java
...
public class ESM_BKG_0957HTMLAction  extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0957HTMLAction 객체를 생성
	 */
	public ESM_BKG_0957HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0957Event event = new EsmBkg0957Event();

		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgNo(request.getParameter("bkg_no"));
			event.setCustTpCd(request.getParameter("cust_tp_cd"));
		}
