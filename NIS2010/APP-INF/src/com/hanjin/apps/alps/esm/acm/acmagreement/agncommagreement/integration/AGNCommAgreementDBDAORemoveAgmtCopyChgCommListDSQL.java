...
*@FileName : AGNCommAgreementDBDAORemoveAgmtCopyChgCommListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAORemoveAgmtCopyChgCommListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Remove Agmt Copy Chg Comm List
	  * </pre>
	  */
	public AGNCommAgreementDBDAORemoveAgmtCopyChgCommListDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAORemoveAgmtCopyChgCommListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
