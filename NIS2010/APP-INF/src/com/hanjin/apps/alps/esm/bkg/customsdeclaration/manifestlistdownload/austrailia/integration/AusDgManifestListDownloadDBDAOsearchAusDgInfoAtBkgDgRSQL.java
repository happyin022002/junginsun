...
*@FileName : AusDgManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusDgManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 호주 DG Save 되기 전 Data 조회 쿼리
	  * </pre>
	  */
	public AusDgManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL(){
		setQuery();
		...
		query.append("FileName : AusDgManifestListDownloadDBDAOsearchAusDgInfoAtBkgDgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
