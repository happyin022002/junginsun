...
public class ESM_PRI_6003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6003HTMLAction 객체를 생성
	 */
	public ESM_PRI_6003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6003Event event = new EsmPri6003Event();
		
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltCmpbGuidelineVO((RsltCmpbGuidelineVO)getVO(request, RsltCmpbGuidelineVO .class));
		}
