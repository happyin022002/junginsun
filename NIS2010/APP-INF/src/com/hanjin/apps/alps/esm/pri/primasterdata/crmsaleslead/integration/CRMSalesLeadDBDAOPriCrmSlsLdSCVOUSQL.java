...
*@FileName : CRMSalesLeadDBDAOPriCrmSlsLdSCVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CRMSalesLeadDBDAOPriCrmSlsLdSCVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CRMSalesLeadDBDAOPriCrmSlsLdSCVOUSQL(){
		setQuery();
		...
		query.append("FileName : CRMSalesLeadDBDAOPriCrmSlsLdSCVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE SLS_LD_NO = (SELECT SLS_LD_NO FROM PRI_SP_MN" ).append("\n"); 
