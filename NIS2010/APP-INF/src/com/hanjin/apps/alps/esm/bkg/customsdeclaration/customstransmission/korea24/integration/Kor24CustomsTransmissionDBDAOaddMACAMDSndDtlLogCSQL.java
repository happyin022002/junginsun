...
*@FileName : Kor24CustomsTransmissionDBDAOaddMACAMDSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddMACAMDSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MACAMD Send Detail Log를 add한다.
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddMACAMDSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddMACAMDSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
