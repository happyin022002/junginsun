...
*@FileName : ACMSimulationDBDAOSearchAGNCommMassSimExcelListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOSearchAGNCommMassSimExcelListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agent Commission Mass Simulation 리스트를 조회한다.
	  * </pre>
	  */
	public ACMSimulationDBDAOSearchAGNCommMassSimExcelListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOSearchAGNCommMassSimExcelListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
