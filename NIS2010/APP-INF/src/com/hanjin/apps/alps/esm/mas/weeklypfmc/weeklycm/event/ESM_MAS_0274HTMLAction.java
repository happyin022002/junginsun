...
**@FileName : ESM_MAS_0274HTMLAction.java
 ...
 * @author Je Ryang Yoo
 * @see EsmMas0274Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0274HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0274HTMLAction 객체를 생성
	 */
	public ESM_MAS_0274HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0274Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0274Event event = new EsmMas0274Event();  	
    			
		// 조회
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setStorageCalExcepNodeVO((StorageCalExcepNodeVO)getVO(request, StorageCalExcepNodeVO.class));			
		}
		// 저장
		else if(command.isCommand(FormCommand.MULTI)) {			
			event.setStorageCalExcepNodeVOs((StorageCalExcepNodeVO[])getVOs(request, StorageCalExcepNodeVO.class, ""));			
		}		
		// Include Sub Office Code를 가져옴
