...
*@FileName : ESM_BKG_0932HTMLAction.java
...
public class ESM_BKG_0932HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0932HTMLAction 객체를 생성
	 */
	public ESM_BKG_0932HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0932Event event = new EsmBkg0932Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setKorCllRemarkVO((KorCllRemarkVO)getVO(request, KorCllRemarkVO .class));
		}
