 ...
 *@FileName : WharfageDecMgtBCImpl.java
 *@FileTitle : UI_BKG-업무번호
 *Open Issues :
 *Change history :
...
/**
 * ALPS-WharfageMgt Business Logic Basic Command implementation<br>
 * - ALPS-WharfageMgt 대한 비지니스 로직을 처리한다.<br>
 * 
 * @author JAE YOEB JEUNG
 * @see 
 * @since J2EE 1.4
 */
public abstract class WharfageDecMgtBCImpl extends BasicCommandSupport implements WharfageDecMgtBC {
	 ...
	 * @throws EventException
	 */
	public void sendWhfDeclFax(List<BkgUsaWhfSndHisVO> bkgUsaWhfSndHisVOs, SignOnUserAccount account) throws EventException {
	}
	 ...
	 * @throws EventException
	 */
	public void sendWhfDeclEml(List<BkgUsaWhfSndHisVO> bkgUsaWhfSndHisVOs, SignOnUserAccount account) throws EventException {
	}
	 ...
	 * @throws EventException
	 */
	public void sendWhfExptTsEml(List<BkgUsaWhfSndHisVO> bkgUsaWhfSndHisVOs, SignOnUserAccount account) throws EventException{}
	 ...
	 * @throws EventException
	 */
	public void sendWhfExptTsFax(List<BkgUsaWhfSndHisVO> bkgUsaWhfSndHisVOs, SignOnUserAccount account) throws EventException{}
	 ...
	 * 
	 * @param usrId userid
	 * @param manifestTransmitVO 전송정보
	 * @param pgmNo 화면id
	 * @return String BackEndJob Key
	 * @throws EventException
	 */
	public String startBackEndJob(SignOnUserAccount account, WhfDecCondVO whfDecCondVO, String pgmNo)
			throws EventException {
		return null;
	}
