...
*@FileName : KorManifestListDBDAOsearchCblNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchCblNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchCblNoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchCblNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
