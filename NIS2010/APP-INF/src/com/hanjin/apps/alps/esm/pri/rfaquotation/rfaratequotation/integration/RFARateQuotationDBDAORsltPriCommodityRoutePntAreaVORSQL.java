...
*@FileName : RFARateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriCommodityRoutePntAreaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
