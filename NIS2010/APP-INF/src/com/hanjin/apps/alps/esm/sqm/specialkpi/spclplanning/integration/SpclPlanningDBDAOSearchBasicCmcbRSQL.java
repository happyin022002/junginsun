...
*@FileName : SpclPlanningDBDAOSearchBasicCmcbRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpclPlanningDBDAOSearchBasicCmcbRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SpclPlanningDBDAOSearchBasicCmcb
	  * 2015.11.19 김용습 [CHM-201538495] [CSR 전환건] Basic CMCB 화면 보완 (Trade Direction 칼럼 추가, Row Add 버튼 로직 수정)
	  * </pre>
	  */
	public SpclPlanningDBDAOSearchBasicCmcbRSQL(){
		setQuery();
		...
		query.append("FileName : SpclPlanningDBDAOSearchBasicCmcbRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM SQM_SPCL_LANE_OFC_COST A1, MAS_LANE_RGST MAS" ).append("\n"); 
		...
		query.append("   AND A1.BSE_QTR_CD    = @[f_bse_qtr_cd]   --All이 아닐때 필수" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY A1.RHQ_CD, A1.TRD_CD, A1.RLANE_CD, A1.DIR_CD, A1.CONV_DIR_CD, A1.RGN_OFC_CD, A1.BSE_QTR_CD" ).append("\n"); 
