...
import com.hanjin.bizcommon.erpcom.jms.integration.SendQueueEAIDAO;
...
import com.hanjin.irep.enisEsm.ESM0620001Document;
import com.hanjin.irep.enisEsm.ESM0620001Document.ESM0620001;
import com.hanjin.irep.enisEsm.ESM0620001Document.ESM0620001.DataArea.ROWSETCollection;
import com.hanjin.irep.enisEsm.ESM0620001Document.ESM0620001.DataArea.ROWSETCollection.ROWRequest;
...
//				invoiceReq.setHATTRIBUTE1((String)rowSet.getString("HDR_ATTR_CTNT1"));
	...
	/**
	 * JMS 연동 / 비동기<br>
	 * 범한EDI 전송용 (ESM_AGT_010,  ESM_AGT_036) Agent Commission 내역을 Request or Approval(Audit)시 NIS로 인터페이스한다.<br>
	 * 모든 데이타를 한번에 연동 처리한다.<br>
	 * 
	 * @param DBRowSet rowSet
	 * @throws DAOException
