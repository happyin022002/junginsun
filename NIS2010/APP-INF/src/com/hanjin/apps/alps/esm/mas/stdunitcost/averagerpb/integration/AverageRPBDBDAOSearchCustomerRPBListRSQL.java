...
*@FileName : AverageRPBDBDAOSearchCustomerRPBListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AverageRPBDBDAOSearchCustomerRPBListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchCustomerRPBList
	  * </pre>
	  */
	public AverageRPBDBDAOSearchCustomerRPBListRSQL(){
		setQuery();
		...
		query.append("FileName : AverageRPBDBDAOSearchCustomerRPBListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , RPB_CUST_NO" ).append("\n"); 
		...
		query.append("FROM MAS_MON_CUST_RPB" ).append("\n"); 
