...
*@FileName : ESM_COA_0073HTMLAction.java
 ...
 *
 * @author KimJongBeom
 * @see EsmCoa0073Event , ESM_COA_0073EventResponse 참조
 * @since J2EE 1.4
 */ 

public class ESM_COA_0073HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0073Event event = new EsmCoa0073Event();
