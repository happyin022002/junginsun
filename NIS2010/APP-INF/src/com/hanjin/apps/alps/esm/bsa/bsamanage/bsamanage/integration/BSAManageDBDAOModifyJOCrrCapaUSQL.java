...
*@FileName : BSAManageDBDAOModifyJOCrrCapaUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOModifyJOCrrCapaUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyJOCrrCapa UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOModifyJOCrrCapaUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOModifyJOCrrCapaUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
