...
*@FileName : RFARateProposalDBDAOPropAmendCpPriRpScpRtRoutViaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropAmendCpPriRpScpRtRoutViaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPropAmendCpPriRpScpRtRoutViaCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropAmendCpPriRpScpRtRoutViaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("     , S.ROUT_VIA_SEQ" ).append("\n"); 
		...
		query.append("FROM  PRI_RP_SCP_RT_ROUT_VIA S" ).append("\n"); 
