...
*@FileName : AGTOfficeAgreementDBDAOAgentRateAgnAgmtVerSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgentRateAgnAgmtVerSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agn_agmt_ver_seq 를 조회
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgentRateAgnAgmtVerSeqRSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgentRateAgnAgmtVerSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(MAX(AGN_AGMT_VER_SEQ) + 1, 1) AS AGN_AGMT_VER_SEQ" ).append("\n"); 
