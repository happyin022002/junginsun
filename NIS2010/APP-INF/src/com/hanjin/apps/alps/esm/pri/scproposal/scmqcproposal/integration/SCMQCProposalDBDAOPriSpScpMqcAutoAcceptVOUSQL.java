...
*@FileName : SCMQCProposalDBDAOPriSpScpMqcAutoAcceptVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCMQCProposalDBDAOPriSpScpMqcAutoAcceptVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal 일 때 자동 accept
	  * </pre>
	  */
	public SCMQCProposalDBDAOPriSpScpMqcAutoAcceptVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCMQCProposalDBDAOPriSpScpMqcAutoAcceptVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FNL_MQC_QTY     = PROP_SCP_MQC_QTY" ).append("\n"); 
