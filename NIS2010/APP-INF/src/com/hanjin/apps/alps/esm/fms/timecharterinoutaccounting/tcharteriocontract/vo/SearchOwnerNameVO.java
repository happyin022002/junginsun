...
*@FileName : SearchOwnerNameVO.java
*@FileTitle : SearchOwnerNameVO
*Open Issues :
*Change history :
...
public class SearchOwnerNameVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOwnerNameVO> models = new ArrayList<SearchOwnerNameVO>();
	 ...
	 * @return 
	 */
	public SearchOwnerNameVO() {}
	
	/**
	 * 생성자
	 * @param String ibflag, String pagerows, String lglEngNm, String ownrNm
	 * @return 
	 */
	public SearchOwnerNameVO(String ibflag, String pagerows, String lglEngNm, String ownrNm) {
		this.ibflag = ibflag;
		this.ownrNm = ownrNm;
	...
	public SearchOwnerNameVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public SearchOwnerNameVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOwnerNameVO model = null;
		...
		try {
			...
			String[] lglEngNm = (JSPUtil.getParameter(request, prefix	+ "lgl_eng_nm".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchOwnerNameVO();
				if (ibflag[i] != null)
		...
		return getSearchOwnerNameVOs();
	}

	public SearchOwnerNameVO[] getSearchOwnerNameVOs(){
		SearchOwnerNameVO[] vos = (SearchOwnerNameVO[])models.toArray(new SearchOwnerNameVO[models.size()]);
		return vos;
	}
