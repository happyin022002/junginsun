...
*@FileName : WeeklyCMDBDAOMasMonVvdVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOMasMonVvdVOUSQL implements ISQLTemplate{
	...
	public WeeklyCMDBDAOMasMonVvdVOUSQL(){
		...
		query.append("FileName : WeeklyCMDBDAOMasMonVvdVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_MON_VVD VVD" ).append("\n"); 
