...
*@FileName : Kor24ManifestListDBDAOSearchDangerInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchDangerInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchDangerInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchDangerInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(IMDG_CLSS_CD,' ') A_IMO_CLASS" ).append("\n");
		query.append("  FROM BKG_DG_CGO" ).append("\n");
		query.append(" WHERE BKG_NO = @[a_bkg_no]" ).append("\n");
		query.append("   AND DCGO_SEQ < 4" ).append("\n");
