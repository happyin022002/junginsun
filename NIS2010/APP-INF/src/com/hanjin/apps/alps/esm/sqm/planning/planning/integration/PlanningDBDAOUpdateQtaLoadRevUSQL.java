...
public class PlanningDBDAOUpdateQtaLoadRevUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2016.06.24 [CHM-201642265] Planning IAS-IP Supply 에외처리
	  * </pre>
	  */
	...
	public void setQuery(){
		query.append("UPDATE SQM_QTA_LOD_REV " ).append("\n"); 
		query.append("   SET LDF_RTO      = @[ldf_rto] " ).append("\n"); 
		query.append("      ,GRS_RPB_REV  = @[grs_rpb_rev] " ).append("\n"); 
		query.append("      ,LOD_QTY      = DECODE(SUB_TRD_CD, 'IP',@[lod_qty], 0)" ).append("\n"); 
