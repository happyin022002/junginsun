...
*@FileName : ESM_FMS_0097HTMLAction.java
...
public class ESM_FMS_0097HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0097HTMLAction 객체를 생성
	 */
	public ESM_FMS_0097HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0097Event event = new EsmFms0097Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondSearchOwnerAccountVO((CondSearchOwnerAccountVO)getVO(request, CondSearchOwnerAccountVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setCondSearchOwnerAccountVO((CondSearchOwnerAccountVO)getVO(request, CondSearchOwnerAccountVO .class));
			event.setSearchNewOwnerAccountListVOS((SearchNewOwnerAccountListVO[])getVOs(request, SearchNewOwnerAccountListVO .class, "sheet_"));
