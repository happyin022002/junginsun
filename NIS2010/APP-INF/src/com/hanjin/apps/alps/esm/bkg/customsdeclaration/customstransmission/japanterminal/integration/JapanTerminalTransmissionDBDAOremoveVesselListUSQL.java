...
*@FileName : JapanTerminalTransmissionDBDAOremoveVesselListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanTerminalTransmissionDBDAOremoveVesselListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 배치 스케줄 삭제 flg update 쿼리
	  * </pre>
	  */
	public JapanTerminalTransmissionDBDAOremoveVesselListUSQL(){
		setQuery();
		...
		query.append("FileName : JapanTerminalTransmissionDBDAOremoveVesselListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_TML_EDI_JP_BAT_VVD_SKD " ).append("\n"); 
