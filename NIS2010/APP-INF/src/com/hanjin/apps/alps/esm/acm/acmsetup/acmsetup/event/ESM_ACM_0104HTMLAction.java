...
*@FileName : ESM_ACM_0104HTMLAction.java
 ...
 * @see EsmAcm0104Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0104HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0104HTMLAction 객체를 생성
	 */
	public ESM_ACM_0104HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0104Event event = new EsmAcm0104Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCntrTpSelectVO((CntrTpSelectVO)getVO(request, CntrTpSelectVO.class));
		}
