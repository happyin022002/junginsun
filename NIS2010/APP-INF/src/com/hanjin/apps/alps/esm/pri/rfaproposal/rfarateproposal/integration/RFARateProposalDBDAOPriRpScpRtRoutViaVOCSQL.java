...
*@FileName : RFARateProposalDBDAOPriRpScpRtRoutViaVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtRoutViaVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtRoutViaVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtRoutViaVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
