...
*@FileName : NetworkCostDBDAOCoaMonVvdPortOpDysVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOCoaMonVvdPortOpDysVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkCostDBDAOCoaMonVvdPortOpDysVOUSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOCoaMonVvdPortOpDysVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_MON_VVD_PORT_OP_DYS SET" ).append("\n"); 
