...
*@FileName : SearchSltChtrCreRStatusListVO.java
*@FileTitle : SearchSltChtrCreRStatusListVO
*Open Issues :
*Change history :
...
public class SearchSltChtrCreRStatusListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSltChtrCreRStatusListVO> models = new ArrayList<SearchSltChtrCreRStatusListVO>();
	...
	public SearchSltChtrCreRStatusListVO() {}

	public SearchSltChtrCreRStatusListVO(String ibflag, String pagerows, String sltTpCd, String sltTpNm, String vopCd, String incmBzcChtrCd, String incmSubLseCd, String incmCrsChtrCd, String expnBzcChtrCd, String expnSubChtrCd, String expnCrsChtrCd, String opCreStsCd, String creSlctFlg) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSltTpNm(JSPUtil.getParameter(request, "slt_tp_nm", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return SearchSltChtrCreRStatusListVO[]
	 */
	public SearchSltChtrCreRStatusListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSltChtrCreRStatusListVO[]
	 */
	public SearchSltChtrCreRStatusListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSltChtrCreRStatusListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSltChtrCreRStatusListVO();
		...
		return getSearchSltChtrCreRStatusListVOs();
	}
	 ...
	 * @return SearchSltChtrCreRStatusListVO[]
	 */
	public SearchSltChtrCreRStatusListVO[] getSearchSltChtrCreRStatusListVOs(){
		SearchSltChtrCreRStatusListVO[] vos = (SearchSltChtrCreRStatusListVO[])models.toArray(new SearchSltChtrCreRStatusListVO[models.size()]);
		return vos;
	}
