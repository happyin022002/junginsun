...
*@FileName : ESM_MAS_052HTMLAction.java
 ...
 *
 * @author Park Eun Ju
 * @see EsmMas0052Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0052HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_MAS_0052HTMLAction 객체를 생성
     */
    public ESM_MAS_0052HTMLAction() {
    	//
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_MAS_052Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0052Event event = new EsmMas0052Event();
