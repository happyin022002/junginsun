...
*@FileName : GeneralBookingSearchDBDAOaddCustAdvisoryNoticeDetailByUploadCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingSearchDBDAOaddCustAdvisoryNoticeDetailByUploadCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * War, Vessel Damage, Vessel dealy 등 Emergemcy Case 가 발생 한 VVD 별 대상 연락 처 정보를 등록한다.
	  * </pre>
	  */
	public GeneralBookingSearchDBDAOaddCustAdvisoryNoticeDetailByUploadCSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingSearchDBDAOaddCustAdvisoryNoticeDetailByUploadCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   AND BK.BL_NO = BC.BL_NO" ).append("\n"); 
