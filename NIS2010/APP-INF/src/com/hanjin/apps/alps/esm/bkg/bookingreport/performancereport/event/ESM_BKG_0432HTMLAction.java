...
*@FileName : ESM_BKG_0432HTMLAction.java
 ...
 * @see EsmBkg0432Event 참조
 * @since J2EE 1.5
 */

public class ESM_BKG_0432HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0421HTMLAction 객체를 생성
     */
    public ESM_BKG_0432HTMLAction() {}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsmBkg0432Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0432Event event = new EsmBkg0432Event();
		event.setSearchPerfVolByRegionGroupInVO ((SearchPerfVolByRegionGroupInVO) getVO(request, SearchPerfVolByRegionGroupInVO.class));
