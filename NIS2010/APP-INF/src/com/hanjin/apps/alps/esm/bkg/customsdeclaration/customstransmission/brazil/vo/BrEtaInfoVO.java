...
*@FileName : BrEtaInfoVO.java
*@FileTitle : BrEtaInfoVO
*Open Issues :
*Change history :
...
public class BrEtaInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BrEtaInfoVO> models = new ArrayList<BrEtaInfoVO>();
	
	/* Column Info */
	private String blpod1 = "";
	/* Column Info */
	private String bvvd1 = "";
	/* Column Info */
	private String poletd1 = "";
	/* Column Info */
	private String vslLloydcode1 = "";
	/* Column Info */
	private String blpol1 = "";
	/* Column Info */
	private String podeta1 = "";
	/* Page Number */
	private String pagerows = "";
	/* Column Info */
	private String podetd1 = "";
	/* Column Info */
	private String vslCallsign1 = "";
	/* Column Info */
	private String vslFullname1 = "";
	/* Column Info */
	private String opCode = "";
	/* VO Data Value( C:Creation, U:Update, D:Delete ) */
	private String ibflag = "";
	/* Column Info */
	private String polFullname1 = "";
	/* Column Info */
	private String poleta1 = "";
	/* Column Info */
	private String bvvdLane = "";
	/* Column Info */
	private String vvdRefNo1 = "";
	/* Column Info */
	private String podFullname1 = "";
	...
	public BrEtaInfoVO(String ibflag, String pagerows, String bvvd1, String bvvdLane, String vslCallsign1, String vslLloydcode1, String vslFullname1, String vvdRefNo1, String blpol1, String polFullname1, String blpod1, String podFullname1, String poleta1, String poletd1, String podeta1, String podetd1, String opCode) {
		this.blpod1 = blpod1;
		this.bvvd1 = bvvd1;
	 ...
	 * @return BrEtaInfoVO[]
	 */
	public BrEtaInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BrEtaInfoVO[]
	 */
	public BrEtaInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BrEtaInfoVO model = null;
		...
		try {
			String[] blpod1 = (JSPUtil.getParameter(request, prefix	+ "blpod1".trim(), length));
			String[] bvvd1 = (JSPUtil.getParameter(request, prefix	+ "bvvd1".trim(), length));
			String[] poletd1 = (JSPUtil.getParameter(request, prefix	+ "poletd1".trim(), length));
			String[] vslLloydcode1 = (JSPUtil.getParameter(request, prefix	+ "vsl_lloydcode1".trim(), length));
			String[] blpol1 = (JSPUtil.getParameter(request, prefix	+ "blpol1".trim(), length));
			String[] podeta1 = (JSPUtil.getParameter(request, prefix	+ "podeta1".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			String[] podetd1 = (JSPUtil.getParameter(request, prefix	+ "podetd1".trim(), length));
			String[] vslCallsign1 = (JSPUtil.getParameter(request, prefix	+ "vsl_callsign1".trim(), length));
			String[] vslFullname1 = (JSPUtil.getParameter(request, prefix	+ "vsl_fullname1".trim(), length));
			String[] opCode = (JSPUtil.getParameter(request, prefix	+ "op_code".trim(), length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag".trim(), length));
			String[] polFullname1 = (JSPUtil.getParameter(request, prefix	+ "pol_fullname1".trim(), length));
			String[] poleta1 = (JSPUtil.getParameter(request, prefix	+ "poleta1".trim(), length));
			String[] bvvdLane = (JSPUtil.getParameter(request, prefix	+ "bvvd_lane".trim(), length));
			String[] vvdRefNo1 = (JSPUtil.getParameter(request, prefix	+ "vvd_ref_no1".trim(), length));
			String[] podFullname1 = (JSPUtil.getParameter(request, prefix	+ "pod_fullname1".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new BrEtaInfoVO();
				if (blpod1[i] != null)
	 ...
	 * @return BrEtaInfoVO[]
	 */
	public BrEtaInfoVO[] getBrEtaInfoVOs(){
		BrEtaInfoVO[] vos = (BrEtaInfoVO[])models.toArray(new BrEtaInfoVO[models.size()]);
		return vos;
	}
