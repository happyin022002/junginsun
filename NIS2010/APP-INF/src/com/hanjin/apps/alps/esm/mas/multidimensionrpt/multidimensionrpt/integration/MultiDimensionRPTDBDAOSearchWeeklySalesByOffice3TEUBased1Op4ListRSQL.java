...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased1Op4ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased1Op4ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased1Op4ListRSQL(){
		setQuery();
		...
		params.put("f_iskorean",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased1Op4ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("											,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.N4TH_CO_AMT,'O|BIZ', B2.N4TH_ESTM_PL_AMT,B2.N4TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("										) " ).append("\n"); 
		...
		query.append("					/* N200902110080   MAS_SINWA 실적 조회 권한 관련 DECODE(SUBSTR(?, 1, 4), 'SHAA', 'SINWA', '') */" ).append("\n"); 
		...
		query.append("				           ,'4', DECODE(SUBSTR(DECODE(@[f_chkprd], 'M', B1.COST_YRMON, B1.SLS_YRMON), 1, 4), '2008', DECODE(B4.OFC_N4TH_LVL_CD, 'NYCNA', B4.OFC_N4TH_LVL_CD, B4.OFC_N4TH_LVL_TP_CD)" ).append("\n"); 
		query.append("				                                                   , '2007', DECODE(B4.OFC_N4TH_LVL_CD, 'NYCNA', B4.OFC_N4TH_LVL_CD, B4.OFC_N4TH_LVL_TP_CD)" ).append("\n"); 
		query.append("				                                                   , DECODE(B4.OFC_N4TH_LVL_CD, 'SHADSC', B4.OFC_N4TH_LVL_TP_CD, B4.OFC_N4TH_LVL_CD)) /* SHADSC만 AREA*/" ).append("\n"); 
		...
		query.append("			#end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		 GROUP BY B1.TRD_CD, L1.HUL_BND_CD, B2.STND_COST_CD " ).append("\n"); 
		...
		query.append("											,'LOAD0000', DECODE(SUBSTR (B2.CNTR_TPSZ_CD, -1),'2', B2.N4TH_ESTM_PL_AMT, '3', B2.N4TH_ESTM_PL_AMT, B2.N4TH_ESTM_PL_AMT * 2) " ).append("\n"); 
		query.append("											,'BSA00000', B2.N4TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("											,DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', B2.N4TH_CO_AMT,'O|BIZ', B2.N4TH_ESTM_PL_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("										) " ).append("\n"); 
		query.append("							,'R', DECODE (B2.STND_COST_CD " ).append("\n"); 
		query.append("										,'LOAD0000', DECODE(SUBSTR(B2.CNTR_TPSZ_CD, -1),'2', B2.RA_PL_AMT, '3', B2.RA_PL_AMT, B2.RA_PL_AMT * 2) " ).append("\n"); 
		query.append("										,'92404011', DECODE(@[f_ofc_vw],'L', 0, 'C', DECODE(@[f_ofc_lvl],'1',0, B2.RA_PL_AMT)) " ).append("\n"); 
		...
		query.append("					                                     ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N4TH_CO_AMT,'O|BIZ', A2.N4TH_ESTM_PL_AMT, A2.N4TH_ESTM_PL_AMT) " ).append("\n"); 
		...
		query.append("						                                 ,'4', DECODE(SUBSTR(DECODE(@[f_chkprd], 'M', A1.COST_YRMON, A1.SLS_YRMON), 1, 4), '2008', DECODE(A4.OFC_N4TH_LVL_CD, 'NYCNA', A4.OFC_N4TH_LVL_CD, A4.OFC_N4TH_LVL_TP_CD)" ).append("\n"); 
		query.append("						                                                                         , '2007', DECODE(A4.OFC_N4TH_LVL_CD, 'NYCNA', A4.OFC_N4TH_LVL_CD, A4.OFC_N4TH_LVL_TP_CD)" ).append("\n"); 
		query.append("						                                                                         , DECODE(A4.OFC_N4TH_LVL_CD, 'SHADSC', A4.OFC_N4TH_LVL_TP_CD, A4.OFC_N4TH_LVL_CD)) /* SHADSC만 AREA */" ).append("\n"); 
		...
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_TP_CD " ).append("\n"); 
		query.append("					                 ,'O', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("					                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N4TH_CO_AMT,'O|BIZ', A2.N4TH_ESTM_PL_AMT,V.NTWK_HIR_COST_AMT) " ).append("\n"); 
		query.append("					                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ,0 " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					,DECODE (@[f_iskorean], '1', A2.SGRP_KR_DESC, A2.SGRP_COST_CD_DESC) SGRP_COST_CD_DESC   /*조건:한글여부 //f_isKorean */" ).append("\n"); 
		query.append("					,DECODE (@[f_iskorean], '1', A2.KR_RPT_ITM_DESC, A2.RPT_ITM_DESC) RPT_ITM_DESC " ).append("\n"); 
