...
*@FileName : AGTCustomerInfoDBDAOFACCustomerToShipperInterestListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCustomerInfoDBDAOFACCustomerToShipperInterestListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTCustomerInfoDBDAOFACCustomerToShipperInterestListDSQL(){
		setQuery();
		...
		query.append("FileName : AGTCustomerInfoDBDAOFACCustomerToShipperInterestListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM AGT_FAC_CUST_RLT" ).append("\n"); 
