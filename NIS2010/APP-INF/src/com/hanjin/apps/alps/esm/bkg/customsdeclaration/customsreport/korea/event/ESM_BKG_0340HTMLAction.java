...
*@FileName : ESM_BKG_0340HTMLAction.java
*@FileTitle : ESM_BKG_0340HTMLAction
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0340HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 2792293631096541043L;

	public ESM_BKG_0340HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		// EVENT 생성
		EsmBkg0340Event event = new EsmBkg0340Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) 
    	{
    		...
    		// RD 인쇄를 위한 조회
    		KorDischPrintCondVO[] condVOs = (KorDischPrintCondVO[])getVOs(request, KorDischPrintCondVO.class);
    		event.setKorDischPrintCondVOs(condVOs);
    	}
