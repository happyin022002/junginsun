...
*@FileName : DgSendHistoryVO.java
*@FileTitle : DgSendHistoryVO
*Open Issues :
*Change history :
...
public class DgSendHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DgSendHistoryVO> models = new ArrayList<DgSendHistoryVO>();
	...
	/* Column Info */
	private String dgDeclTpCd = null;
	/* Column Info */
	...
	public DgSendHistoryVO() {}

	public DgSendHistoryVO(String ibflag, String pagerows, String updDt, String ediMsgTpId, String vslCd, String msgDesc, String autoSndTpCd, String creDt, String skdVoyNo, String sndDt, String skdDirCd, String sndUsrId, String creUsrId, String vvdCd, String msgFuncId, String dgDeclTpCd, String portCd, String msgSndNo, String updUsrId, String keyVal) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dg_decl_tp_cd", getDgDeclTpCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dg_decl_tp_cd", "dgDeclTpCd");
	 ...
	 * @return dgDeclTpCd
	 */
	public String getDgDeclTpCd() {
		return this.dgDeclTpCd;
	}
	 ...
	 * @param dgDeclTpCd
	 */
	public void setDgDeclTpCd(String dgDeclTpCd) {
		this.dgDeclTpCd = dgDeclTpCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDgDeclTpCd(JSPUtil.getParameter(request, prefix + "dg_decl_tp_cd", ""));
	 ...
	 * @param request
	 * @return DgSendHistoryVO[]
	 */
	public DgSendHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DgSendHistoryVO[]
	 */
	public DgSendHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DgSendHistoryVO model = null;
		...
		try {
			...
			String[] dgDeclTpCd = (JSPUtil.getParameter(request, prefix	+ "dg_decl_tp_cd", length));
			String[] keyVal = (JSPUtil.getParameter(request, prefix	+ "key_val", length));
			
			for (int i = 0; i < length; i++) {
				model = new DgSendHistoryVO();
				if (updDt[i] != null)
				...
				if (dgDeclTpCd[i] != null)
					model.setDgDeclTpCd(dgDeclTpCd[i]);
				if (keyVal[i] != null)
	 ...
	 * @return DgSendHistoryVO[]
	 */
	public DgSendHistoryVO[] getDgSendHistoryVOs(){
		DgSendHistoryVO[] vos = (DgSendHistoryVO[])models.toArray(new DgSendHistoryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.dgDeclTpCd = this.dgDeclTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
