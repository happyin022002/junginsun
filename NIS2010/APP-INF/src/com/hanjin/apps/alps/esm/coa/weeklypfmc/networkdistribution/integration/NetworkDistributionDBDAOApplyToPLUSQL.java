...
*@FileName : NetworkDistributionDBDAOApplyToPLUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOApplyToPLUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkDistributionDBDAOApplyToPLUSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOApplyToPLUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_PFIT_LSS_SMRY SET" ).append("\n"); 
		query.append("ESTM_PL_AMT = 0" ).append("\n"); 
