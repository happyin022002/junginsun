...
*@FileName : ESM_MAS_0318HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class ESM_MAS_0318HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0318HTMLAction 객체를 생성
	 */
	public ESM_MAS_0318HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0318Event event = new EsmMas0318Event();  		
    	...
    	if(command.isCommand(FormCommand.INIT)) {
			...
			event.setStndUseQtyVOs((StndUseQtyVO[])getVOs(request, StndUseQtyVO.class));
