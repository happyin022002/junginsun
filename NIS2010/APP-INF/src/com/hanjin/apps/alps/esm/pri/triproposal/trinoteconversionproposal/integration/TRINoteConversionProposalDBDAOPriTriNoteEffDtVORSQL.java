...
*@FileName : TRINoteConversionProposalDBDAOPriTriNoteEffDtVORSQL.java
...
public class TRINoteConversionProposalDBDAOPriTriNoteEffDtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRINoteConversionProposalDBDAOPriTriNoteEffDtVORSQL(){
		setQuery();
		...
		query.append("FileName : TRINoteConversionProposalDBDAOPriTriNoteEffDtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NOTE_SEQ" ).append("\n"); 
		...
		query.append("#if (${HAS_NOTE_SEQ} == 'Y')" ).append("\n"); 
