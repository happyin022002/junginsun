...
*@FileName : RFARateQuotationDBDAOPriRqRtScgRoutCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtScgRoutCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtScgRoutCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtScgRoutCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
