...
*@FileName : ESM_FMS_0072HTMLAction.java
...
public class ESM_FMS_0072HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0072HTMLAction 객체를 생성
	 */
	public ESM_FMS_0072HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0072Event event = new EsmFms0072Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomManHrListVOS((CustomManHrListVO[])getVOs(request, CustomManHrListVO .class, ""));
		}
