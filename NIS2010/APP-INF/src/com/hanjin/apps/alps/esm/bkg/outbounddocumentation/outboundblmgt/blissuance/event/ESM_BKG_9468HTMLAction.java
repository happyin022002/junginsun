...
*@FileName : ESM_BKG_9468HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_9468HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9468HTMLAction 객체를 생성
	 */
	public ESM_BKG_9468HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9468Event event = new EsmBkg9468Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgCustBlPprMgmtHisVO((BkgCustBlPprMgmtHisVO)getVO(request, BkgCustBlPprMgmtHisVO.class)); 
		}
