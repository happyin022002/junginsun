 ...
 *@FileName : ArrNtcCneeInfoVO.java
 *@FileTitle : ArrNtcCneeInfoVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class ArrNtcCneeInfoVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<ArrNtcCneeInfoVO>  models =	new	ArrayList<ArrNtcCneeInfoVO>();
 ...
 //	Getters	and	Setters
	...
	*/
	 ...
	 * @param request
	 * @return ArrNtcCneeInfoVO[]
	 */
	public ArrNtcCneeInfoVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return ArrNtcCneeInfoVO[]
	 */
	public ArrNtcCneeInfoVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		ArrNtcCneeInfoVO model = null;
	 ...
	 * @return ArrNtcCneeInfoVO[]
	 */
	public ArrNtcCneeInfoVO[]	 getArrNtcCneeInfoVOs(){
		ArrNtcCneeInfoVO[] vos = (ArrNtcCneeInfoVO[])models.toArray(new	ArrNtcCneeInfoVO[models.size()]);
		return vos;
		}
