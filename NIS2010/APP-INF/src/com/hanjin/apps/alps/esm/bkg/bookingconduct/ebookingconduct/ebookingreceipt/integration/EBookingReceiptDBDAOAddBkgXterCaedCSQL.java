...
*@FileName : EBookingReceiptDBDAOAddBkgXterCaedCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOAddBkgXterCaedCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_XTER_CAED INSERT
	  * </pre>
	  */
	public EBookingReceiptDBDAOAddBkgXterCaedCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOAddBkgXterCaedCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_CAED" ).append("\n"); 
		query.append("(" ).append("\n"); 
