...
*@FileName : PercentBaseChargeDBDAOAddPercentBaseChargeCSQL.java
...
public class PercentBaseChargeDBDAOAddPercentBaseChargeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PercentBaseChargeDBDAOAddPercentBaseChargeCSQL(){
		setQuery();
		...
		query.append("FileName : PercentBaseChargeDBDAOAddPercentBaseChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
