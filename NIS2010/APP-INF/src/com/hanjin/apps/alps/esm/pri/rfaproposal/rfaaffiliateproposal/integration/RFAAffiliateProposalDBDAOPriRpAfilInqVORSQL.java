...
*@FileName : RFAAffiliateProposalDBDAOPriRpAfilInqVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAAffiliateProposalDBDAOPriRpAfilInqVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Affiliate Inquiry search
	  * </pre>
	  */
	public RFAAffiliateProposalDBDAOPriRpAfilInqVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAAffiliateProposalDBDAOPriRpAfilInqVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,ADDR.BZET_ADDR CUST_ADDR" ).append("\n"); 
		...
		query.append("AND A.CUST_CNT_CD 		 = ADDR.CUST_CNT_CD" ).append("\n"); 
		query.append("AND A.CUST_SEQ 			 = ADDR.CUST_SEQ" ).append("\n"); 
