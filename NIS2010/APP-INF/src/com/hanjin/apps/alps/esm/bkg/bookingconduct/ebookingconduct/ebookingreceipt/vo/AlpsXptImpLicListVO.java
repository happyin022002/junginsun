...
*@FileName : AlpsXptImpLicListVO.java
*@FileTitle : AlpsXptImpLicListVO
*Open Issues :
*Change history :
...
public class AlpsXptImpLicListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AlpsXptImpLicListVO> models = new ArrayList<AlpsXptImpLicListVO>();
	...
	public String getBrShprTaxId() {
		return this.brShprTaxId;
	}

	public String getBrCneeTaxId() {
		return this.brCneeTaxId;
	}

	public String getBrNtfyTaxId() {
		return this.brNtfyTaxId;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setVinCtnt(JSPUtil.getParameter(request, prefix + "vin_ctnt", ""));
	}
	 ...
	 */
	public AlpsXptImpLicListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AlpsXptImpLicListVO[]
	 */
	public AlpsXptImpLicListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AlpsXptImpLicListVO model = null;
		...
		return getAlpsXptImpLicListVOs();
	}
	...
	public AlpsXptImpLicListVO[] getAlpsXptImpLicListVOs(){
		AlpsXptImpLicListVO[] vos = (AlpsXptImpLicListVO[])models.toArray(new AlpsXptImpLicListVO[models.size()]);
		return vos;
	}
