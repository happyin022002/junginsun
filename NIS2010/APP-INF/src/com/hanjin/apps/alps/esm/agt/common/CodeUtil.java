...
/**
 * ENIS-AGT Code List Utility<br>
 * - ENIS-AGT에 대한 코드 리스트 조회 유틸리티<br>
 *
...
public class CodeUtil extends BasicCommandSupport {
    ...
    public Collection getCodeSelect(String codeItem, String code) throws EventException {
        ...
        try {
        	...
        	}else if(codeItem.equalsIgnoreCase("arOfcListCmpn")){				// 4. Revenue lane List
        		dRs = codedao.searchArOfcListCmpn(code);
        	}else if(codeItem.equalsIgnoreCase("arOfcAgmtCmpn")){				// 4. Revenue lane List
        		dRs = codedao.searchArOfcAgmtCmpn(code);
        	}
     ...
     * @throws EventException
     */
    public HashMap<String, String> searchCustomerName(String param1) throws EventException {
    	String rtnStr = "";
    	DBRowSet dRs = null;
    	HashMap<String, String> rtnHash = new HashMap<String, String>();
    	
        try {
        	rtnHash = codedao.searchCustomerName(param1);
