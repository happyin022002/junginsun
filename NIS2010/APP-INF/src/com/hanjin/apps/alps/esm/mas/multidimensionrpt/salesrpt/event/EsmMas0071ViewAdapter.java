...
*@FileName : EsmMas0071ViewAdapter.java
*@FileTitle : EsmMas0071ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0071 에 대한 ViewAdapter<br>
 * - ESM_MAS_0071HTMLAction에서 작성<br>
 *
 * @author 김기식
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0071ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0071ViewAdapter(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0071ViewAdapter ########### [START]");
		...
		log.debug("########### EsmMas0071ViewAdapter ########### [END]");        
