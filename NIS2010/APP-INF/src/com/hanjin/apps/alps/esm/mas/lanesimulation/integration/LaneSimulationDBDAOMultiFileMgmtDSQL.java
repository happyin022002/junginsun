...
*@FileName : LaneSimulationDBDAOMultiFileMgmtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOMultiFileMgmtDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Lane Simulation 데이터 총괄 삭제
	  * </pre>
	  */
	public LaneSimulationDBDAOMultiFileMgmtDSQL(){
		setQuery();
		...
		query.append("FileName : LaneSimulationDBDAOMultiFileMgmtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${sim_rpt_no} != '')" ).append("\n"); 
