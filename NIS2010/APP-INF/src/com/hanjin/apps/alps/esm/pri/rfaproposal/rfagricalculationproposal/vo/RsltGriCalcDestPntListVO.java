...
*@FileName : RsltGriCalcDestPntListVO.java
*@FileTitle : RsltGriCalcDestPntListVO
*Open Issues :
*Change history :
...
public class RsltGriCalcDestPntListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltGriCalcDestPntListVO> models = new ArrayList<RsltGriCalcDestPntListVO>();
	...
	public RsltGriCalcDestPntListVO() {}

	public RsltGriCalcDestPntListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String orgDestTpCd, String griRoutPntSeq, String routPntLocTpCd, String routPntLocDefCd, String routPntLocDefNm, String rcvDeTermCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setGriRoutPntSeq(JSPUtil.getParameter(request, prefix + "gri_rout_pnt_seq", ""));
	 ...
	 * @param request
	 * @return RsltGriCalcDestPntListVO[]
	 */
	public RsltGriCalcDestPntListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltGriCalcDestPntListVO[]
	 */
	public RsltGriCalcDestPntListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltGriCalcDestPntListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltGriCalcDestPntListVO();
				if (updDt[i] != null)
		...
		return getRsltGriCalcDestPntListVOs();
	}
	 ...
	 * @return RsltGriCalcDestPntListVO[]
	 */
	public RsltGriCalcDestPntListVO[] getRsltGriCalcDestPntListVOs(){
		RsltGriCalcDestPntListVO[] vos = (RsltGriCalcDestPntListVO[])models.toArray(new RsltGriCalcDestPntListVO[models.size()]);
		return vos;
	}
