...
*@FileName : RsltPriRqRtRoutViaVO.java
*@FileTitle : RsltPriRqRtRoutViaVO
*Open Issues :
*Change history :
...
public class RsltPriRqRtRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRqRtRoutViaVO> models = new ArrayList<RsltPriRqRtRoutViaVO>();
	...
	public RsltPriRqRtRoutViaVO() {}

	public RsltPriRqRtRoutViaVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String routSeq, String orgDestTpCd, String routViaSeq, String routViaPortTpCd, String routViaPortDefCd, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt, String routViaPortDefNm) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriRqRtRoutViaVO[]
	 */
	public RsltPriRqRtRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqRtRoutViaVO[]
	 */
	public RsltPriRqRtRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqRtRoutViaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriRqRtRoutViaVO();
				if (updDt[i] != null)
		...
		return getRsltPriRqRtRoutViaVOs();
	}
	 ...
	 * @return RsltPriRqRtRoutViaVO[]
	 */
	public RsltPriRqRtRoutViaVO[] getRsltPriRqRtRoutViaVOs(){
		RsltPriRqRtRoutViaVO[] vos = (RsltPriRqRtRoutViaVO[])models.toArray(new RsltPriRqRtRoutViaVO[models.size()]);
		return vos;
	}
