...
*@FileName : EQBalanceDBDAOCoaCntrRepoShtgInfoVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOCoaCntrRepoShtgInfoVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQBalanceDBDAOCoaCntrRepoShtgInfoVOUSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOCoaCntrRepoShtgInfoVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  COA_CNTR_REPO_SHTG_INFO" ).append("\n"); 
