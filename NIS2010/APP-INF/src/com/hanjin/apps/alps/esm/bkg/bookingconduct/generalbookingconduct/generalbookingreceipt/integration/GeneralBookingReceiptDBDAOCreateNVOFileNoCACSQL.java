...
*@FileName : GeneralBookingReceiptDBDAOCreateNVOFileNoCACSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingReceiptDBDAOCreateNVOFileNoCACSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralBookingReceiptDBDAOCreateNVOFileNoCACSQL
	  * </pre>
	  */
	public GeneralBookingReceiptDBDAOCreateNVOFileNoCACSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingReceiptDBDAOCreateNVOFileNoCACSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
