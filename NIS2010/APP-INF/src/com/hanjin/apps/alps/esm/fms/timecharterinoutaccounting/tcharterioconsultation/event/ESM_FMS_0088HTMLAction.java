...
*@FileName : ESM_FMS_0088HTMLAction.java
...
public class ESM_FMS_0088HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0088HTMLAction 객체를 생성
	 */
	public ESM_FMS_0088HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		 ...
		 * COMMAND03 : GW Result
		 */
		if(command.isCommand(FormCommand.MULTI10)) {
