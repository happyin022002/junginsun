...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op4ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op4ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op4ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op4ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("							 , 'LOAD0000', DECODE(SUBSTR (B2.CNTR_TPSZ_CD, -1),'2', B2.N4TH_ESTM_PL_AMT, '3', B2.N4TH_ESTM_PL_AMT, B2.N4TH_ESTM_PL_AMT * 2)" ).append("\n"); 
		query.append("							 , 'BSA00000', B2.N4TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("							 , DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz]" ).append("\n"); 
		query.append("                                    , 'O|CHT', B2.N4TH_CO_AMT" ).append("\n"); 
		query.append("                                    , 'O|BIZ', DECODE(B2.STND_COST_CD, '51102000', B2.ADJ_N4TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , '51302000', B2.ADJ_N4TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , '65000000', B2.ADJ_N4TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , B2.N4TH_HJS_SLS_AMT)" ).append("\n"); 
		query.append("                                    , DECODE(B2.STND_COST_CD, '51102000', B2.ADJ_N4TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , '51302000', B2.ADJ_N4TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , '65000000', B2.ADJ_N4TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , B2.N4TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("							 ) " ).append("\n"); 
		...
		query.append("			                           ,'P', (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR)  - VSL_CHTR_REV" ).append("\n"); 
		query.append("			                           ,'R', DECODE (@[f_ofc_lvl] " ).append("\n"); 
		query.append("			                                        ,'1', (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR)  - VSL_CHTR_REV" ).append("\n"); 
		query.append("			                                        , (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR)  - VSL_CHTR_REV" ).append("\n"); 
		query.append("			                                        ) " ).append("\n"); 
		query.append("			                           ) " ).append("\n"); 
		query.append("			                   / LOAD_TEU " ).append("\n"); 
		...
		query.append("			   ,16, ((INCOME_TOTAL - CM_COST) - N4TH_ESTM_PL_AMT - N4TH_CO_AMT - CMMT_COST - INTER_TS)   /* CMMT0001 */ " ).append("\n"); 
		...
		query.append("				,SUM (N4TH_ESTM_PL_AMT) N4TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("				,SUM (N4TH_CO_AMT) N4TH_CO_AMT " ).append("\n"); 
		...
		query.append("					,NVL(SUM(DECODE(A3.STND_COST_CD,'BSA00000', DECODE (@[f_pro_vw],'P', A2.N4TH_ESTM_PL_AMT,'R', A2.RA_PL_AMT),0)),0) AS SUPPLY " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		query.append("					                 ,'LOAD0000', DECODE (@[f_pro_vw] " ).append("\n"); 
		query.append("					                                     ,'P', DECODE(SUBSTR(A2.CNTR_TPSZ_CD,-1),'2', A2.N4TH_ESTM_PL_AMT, '3', A2.N4TH_ESTM_PL_AMT, A2.N4TH_ESTM_PL_AMT * 2) " ).append("\n"); 
		...
		query.append("					                                     ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N4TH_CO_AMT,'O|BIZ', A2.N4TH_HJS_SLS_AMT, A2.N4TH_ESTM_PL_AMT) " ).append("\n"); 
		...
		query.append("                                                    DECODE(A3.STND_COST_CD, '51102000', A2.ADJ_N4TH_HJS_SLS_AMT, '51302000', A2.ADJ_N4TH_HJS_SLS_AMT, A2.N4TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                                    DECODE(A3.STND_COST_CD, '51102000', A2.ADJ_N4TH_ESTM_PL_AMT, '51302000', A2.ADJ_N4TH_ESTM_PL_AMT, A2.N4TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("					                                      ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                                      ) " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) AS N4TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) AS N4TH_CO_AMT " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("                               THEN NVL(A2.N4TH_HJS_SLS_AMT,0) + NVL(A2.N4TH_CO_AMT,0) - NVL(A2.N4TH_ASGN_AMT,0) ELSE 0 END) INIT_COST" ).append("\n"); 
		query.append("                    -- T/S Cost Amount" ).append("\n"); 
		query.append("                    , SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM COA_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                               THEN A2.N4TH_ASGN_AMT ELSE 0 END) TS_ALOC" ).append("\n"); 
		...
		query.append("					                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N4TH_CO_AMT,'O|BIZ' ,               " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N4TH_HJS_SLS_AMT, A2.N4TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N4TH_ESTM_PL_AMT, V.NTWK_HIR_COST_AMT)) " ).append("\n"); 
		query.append("					                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ,0 " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) + SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM COA_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                               THEN A2.N4TH_ASGN_AMT ELSE 0 END) AS OP_COST " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		query.append("					                 ,'TSCTRB00', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("					                                     ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N4TH_CO_AMT,'O|BIZ', A2.N4TH_HJS_SLS_AMT,A2.N4TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("					                                     ,'R', A2.RA_PL_AMT " ).append("\n"); 
		...
		query.append("					,0 N4TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("					,0 AS N4TH_CO_AMT " ).append("\n"); 
