...
*@FileName : KorCustomsTransmissionDBDAOmakeAutoMACAMDCorrFlatFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeAutoMACAMDCorrFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeAutoMACAMDCorrFlatFileRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.korea.integration ").append("\n"); 
		query.append("FileName : KorCustomsTransmissionDBDAOmakeAutoMACAMDCorrFlatFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
