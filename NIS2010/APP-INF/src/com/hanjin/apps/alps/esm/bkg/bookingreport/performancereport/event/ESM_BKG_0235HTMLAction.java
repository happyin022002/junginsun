...
*@FileName : ESM_BKG_0235HTMLAction.java
...
public class ESM_BKG_0235HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0235HTMLAction 객체를 생성
	 */
	public ESM_BKG_0235HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0235Event event = new EsmBkg0235Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.MULTI) || command.isCommand(FormCommand.COMMAND01) ) {
