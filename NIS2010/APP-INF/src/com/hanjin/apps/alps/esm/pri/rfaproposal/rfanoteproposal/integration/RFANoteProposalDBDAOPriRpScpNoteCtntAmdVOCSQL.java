...
*@FileName : RFANoteProposalDBDAOPriRpScpNoteCtntAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteProposalDBDAOPriRpScpNoteCtntAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFANoteProposalDBDAOPriRpScpNoteCtntAmdVOCSQL
	  * </pre>
	  */
	public RFANoteProposalDBDAOPriRpScpNoteCtntAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFANoteProposalDBDAOPriRpScpNoteCtntAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("PRI_RP_SCP_NOTE_CTNT" ).append("\n"); 
