...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkMnDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkMnDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * - 나머지 테이블들은 ForCopy 용으로 작성한 SQL 을 재활용 함
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkMnDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkMnDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PRI_SCQ_AWK_MN  " ).append("\n"); 
