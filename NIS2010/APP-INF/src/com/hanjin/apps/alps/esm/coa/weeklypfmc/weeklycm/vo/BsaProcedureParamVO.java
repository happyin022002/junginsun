...
*@FileName : BsaProcedureParamVO.java
*@FileTitle : BsaProcedureParamVO
*Open Issues :
*Change history :
...
public class BsaProcedureParamVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaProcedureParamVO> models = new ArrayList<BsaProcedureParamVO>();
	...
	public BsaProcedureParamVO() {}

	public BsaProcedureParamVO(String ibflag, String pagerows, String pYear, String pWeek, String pDuration, String pStep, String pOnlyStep, String pBsa, String pTrdCd, String pRlaneCd, String pIocCd, String pVslCd, String pSkdVoyNo, String pDirCd, String pUserId, String pErrCd, String pErrMsg) {
		this.pVslCd = pVslCd;
		this.pDirCd = pDirCd;
		this.pStep = pStep;
		this.pBsa = pBsa;
	 ...
	 * @param request
	 * @return BsaProcedureParamVO[]
	 */
	public BsaProcedureParamVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaProcedureParamVO[]
	 */
	public BsaProcedureParamVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaProcedureParamVO model = null;
		...
		return getBsaProcedureParamVOs();
	}
	 ...
	 * @return BsaProcedureParamVO[]
	 */
	public BsaProcedureParamVO[] getBsaProcedureParamVOs(){
		BsaProcedureParamVO[] vos = (BsaProcedureParamVO[])models.toArray(new BsaProcedureParamVO[models.size()]);
		return vos;
	}
