...
*@FileName : AGNCommRequestDBDAOGetCHGCommAmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOGetCHGCommAmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGNCommRequestDBDAOGetCHGCommAmtRSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOGetCHGCommAmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(SUM(COMM_AMT), 0) AS USD_CHG_COMM" ).append("\n"); 
		query.append("     , NVL(SUM(PAY_COMM_AMT), 0) AS PAY_CHG_COMM" ).append("\n"); 
