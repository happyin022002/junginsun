...
public class ESM_BKG_0236HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		event.setEBkgSiTurnTimeInVO ((EBkgSiTurnTimeInVO) getVO(request, EBkgSiTurnTimeInVO.class));
		if(command.isCommand(FormCommand.SEARCH03)) {

			event.setEBkgSiTurnTimeInVOs((EBkgSiTurnTimeInVO[])getVOs(request, EBkgSiTurnTimeInVO.class,"sheet1_"));			
			
		}else if(command.isCommand(FormCommand.SEARCH04)) {
			EBkgSiTurnTimeInVO[] eBkgSiTurnTimeInVOs = (EBkgSiTurnTimeInVO[])getVOs(request, EBkgSiTurnTimeInVO.class,"sheet2_");
			event.setEBkgSiTurnTimeInVOs(eBkgSiTurnTimeInVOs); 
		}
