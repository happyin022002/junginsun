...
*@FileName : SCRateGuidelineDBDAOPriSgRtCmdtRnoteGlineMainCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAOPriSgRtCmdtRnoteGlineMainCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAOPriSgRtCmdtRnoteGlineMainCopyCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SG_RT_CMDT_RNOTE" ).append("\n"); 
		...
		query.append("FileName : SCRateGuidelineDBDAOPriSgRtCmdtRnoteGlineMainCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}