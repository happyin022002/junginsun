...
public class ESM_BKG_0565HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0427HTMLAction 객체를 생성
	 */
	public ESM_BKG_0565HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0565Event event = new EsmBkg0565Event();
		
		if (command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltBkgRevDrNotesPerformanceVO((RsltBkgRevDrNotesPerformanceVO) getVO(request,	RsltBkgRevDrNotesPerformanceVO.class));
		} 
