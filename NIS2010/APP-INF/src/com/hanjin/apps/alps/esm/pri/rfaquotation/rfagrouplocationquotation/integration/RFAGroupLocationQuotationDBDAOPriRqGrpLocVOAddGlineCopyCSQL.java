...
*@FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocVOAddGlineCopyCSQL.java
...
public class RFAGroupLocationQuotationDBDAOPriRqGrpLocVOAddGlineCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationQuotationDBDAOPriRqGrpLocVOAddGlineCopyCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocVOAddGlineCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
