...
*@FileName : BookingMasterMgtDBDAOBkgdocClzSetVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOBkgdocClzSetVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingMasterMgtDBDAOBkgdocClzSetVODSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOBkgdocClzSetVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_DOC_CLZ_SET SET " ).append("\n"); 
