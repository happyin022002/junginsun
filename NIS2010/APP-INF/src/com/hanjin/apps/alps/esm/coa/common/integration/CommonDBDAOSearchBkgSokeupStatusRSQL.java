...
public class CommonDBDAOSearchBkgSokeupStatusRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT A.BKG_NO, A.COA_BAT_RMK, A.CRE_USR_ID , TO_CHAR(B.COST_BAT_DT, 'YYYY/MM/DD HH24:MI:SS') FINISH_TIME, '' COA_BAT_CD, '' COA_BAT_SEQ, 'S' STATUS" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("SELECT A.BKG_NO, A.COA_BAT_RMK, A.CRE_USR_ID, '' FINISH_TIME, C.COA_BAT_CD , TO_CHAR(C.COA_BAT_SEQ) COA_BAT_SEQ," ).append("\n"); 
