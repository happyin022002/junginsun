...
*@FileName : Kor24ManifestListDBDAOAddVVDInfoCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOAddVVDInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOAddVVDInfoCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : Kor24ManifestListDBDAOAddVVDInfoCSQL").append("\n");
		query.append("*/").append("\n");
	}
}