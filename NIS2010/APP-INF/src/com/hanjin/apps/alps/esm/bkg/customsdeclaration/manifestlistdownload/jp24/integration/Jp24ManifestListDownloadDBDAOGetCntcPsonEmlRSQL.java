...
*@FileName : Jp24ManifestListDownloadDBDAOGetCntcPsonEmlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24ManifestListDownloadDBDAOGetCntcPsonEmlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24ManifestListDownloadDBDAOGetCntcPsonEmlRSQL(){
		setQuery();
		...
		query.append("FileName : Jp24ManifestListDownloadDBDAOGetCntcPsonEmlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("  FROM (SELECT CNTC_PSON_EML" ).append("\n"); 
		...
		query.append("         ORDER BY BKG_CNTC_PSON_TP_CD)" ).append("\n"); 
		query.append("" ).append("\n"); 
