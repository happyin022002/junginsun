...
*@FileName : RsltPriCmpbGlineRoutViaVO.java
*@FileTitle : RsltPriCmpbGlineRoutViaVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGlineRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGlineRoutViaVO> models = new ArrayList<RsltPriCmpbGlineRoutViaVO>();
	...
	public RsltPriCmpbGlineRoutViaVO() {}

	public RsltPriCmpbGlineRoutViaVO(String ibflag, String pagerows, String glineSeq, String prsCustTpCd, String bseSeq, String orgDestTpCd, String routViaSeq, String routViaPortTpCd, String routViaPortDefCd, String creUsrId, String creDt, String updUsrId, String updDt, String svcScpCd, String creOfcCd, String routViaPortDefNm) {
		this.bseSeq = bseSeq;
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriCmpbGlineRoutViaVO[]
	 */
	public RsltPriCmpbGlineRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGlineRoutViaVO[]
	 */
	public RsltPriCmpbGlineRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGlineRoutViaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGlineRoutViaVO();
				if (bseSeq[i] != null)
		...
		return getRsltPriCmpbGlineRoutViaVOs();
	}
	 ...
	 * @return RsltPriCmpbGlineRoutViaVO[]
	 */
	public RsltPriCmpbGlineRoutViaVO[] getRsltPriCmpbGlineRoutViaVOs(){
		RsltPriCmpbGlineRoutViaVO[] vos = (RsltPriCmpbGlineRoutViaVO[])models.toArray(new RsltPriCmpbGlineRoutViaVO[models.size()]);
		return vos;
	}
