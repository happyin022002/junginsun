...
*@FileName : Kor24FullEmpSumVO.java
*@FileTitle : Kor24FullEmpSumVO
*Open Issues :
*Change history :
...
public class Kor24FullEmpSumVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24FullEmpSumVO> models = new ArrayList<Kor24FullEmpSumVO>();
	...
	public Kor24FullEmpSumVO() {}

	public Kor24FullEmpSumVO(String ibflag, String pagerows, String cntFull, String cntEmpty) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public Kor24FullEmpSumVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24FullEmpSumVO[]
	 */
	public Kor24FullEmpSumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24FullEmpSumVO model = null;
	 ...
	 * @return Kor24FullEmpSumVO[]
	 */
	public Kor24FullEmpSumVO[] getKor24FullEmpSumVOs(){
		Kor24FullEmpSumVO[] vos = (Kor24FullEmpSumVO[])models.toArray(new Kor24FullEmpSumVO[models.size()]);
		return vos;
	}
