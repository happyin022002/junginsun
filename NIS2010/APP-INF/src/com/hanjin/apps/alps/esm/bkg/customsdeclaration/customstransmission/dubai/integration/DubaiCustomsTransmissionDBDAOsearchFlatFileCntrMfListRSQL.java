...
public class DubaiCustomsTransmissionDBDAOsearchFlatFileCntrMfListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(SUBSTR(BL.DU_CNTR_SVC_TP_CD, 2,1), 'L', NVL(SUBSTR(REPLACE(MF.CNTR_MF_MK_DESC, CHR(13)||CHR(10), ''),1,200), 'NIL'), 'NIL')" ).append("\n"); 
		query.append("       AS CNTR_MF_MK_DESC" ).append("\n"); 
		query.append("      ,SUBSTR(REPLACE(MF.CNTR_MF_GDS_DESC, CHR(13)||CHR(10), ''), 1, 100) AS CNTR_MF_GDS_DESC" ).append("\n"); 
