...
*@FileName : EsmSpc0042ViewAdapter3.java
 ...
 * @since CHOI Yun Sung
 */
public class EsmSpc0042ViewAdapter3 extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		try{
			...
			String row = conditionVO.getPagerows();
			String acct= "";
			if(rowSet1 != null && rowSet1.first()){
				acct= rowSet1.getString("ACCT");
			}
			
			sbufXML.append("<DATA TOTAL='1'>\n");
			sbufXML.append("<TR ROW='"+row+"'>");
			sbufXML.append("	<TD COL='flag'>R</TD>");
			sbufXML.append("	<TD COL='mnl_flg'>Y</TD>");
			sbufXML.append("	<TD COL='acct'>" + acct + "</TD>");
			sbufXML.append("</TR>\n");
			sbufXML.append("</DATA>\n");
