...
/**
 * ESM_BSA_0042 에 대한 ViewAdapter<br>
 * - ESM_BSA_0042HTMLAction에서 작성<br>
 *
 * @author 이행지
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmBsa0042ViewAdapter extends DefaultViewAdapter {
	
    public EsmBsa0042ViewAdapter(){
    	super();
    }
