...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportByShipCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportByShipCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportByShipCodeRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportByShipCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,BKG.CUST_CNT_CD " ).append("\n"); 
		query.append("      ,BKG.CUST_SEQ " ).append("\n"); 
