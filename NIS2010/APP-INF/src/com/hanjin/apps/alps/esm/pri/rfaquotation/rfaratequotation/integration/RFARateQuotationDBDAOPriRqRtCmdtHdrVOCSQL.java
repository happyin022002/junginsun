...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtHdrVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtCmdtHdrVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtHdrVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtHdrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	SYSDATE" ).append("\n"); 
		query.append(",	NVL(@[fic_rt_tp_cd], 'G')" ).append("\n"); 
		query.append(")" ).append("\n"); 
