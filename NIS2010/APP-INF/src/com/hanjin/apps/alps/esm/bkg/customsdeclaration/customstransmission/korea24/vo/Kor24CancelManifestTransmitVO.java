...
*@FileTitle : <Kor24CancelManifestTransmitVO.java
*@FileTitle : Kor24CancelManifestTransmitVO
*Open Issues :
*Change history :
...
public class Kor24CancelManifestTransmitVO extends CancelManifestTransmitVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CancelManifestTransmitVO> models = new ArrayList<Kor24CancelManifestTransmitVO>();
...
/**
	 ...
	 */
	public Kor24CancelManifestTransmitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24CancelManifestTransmitVO[]
	 */
	public Kor24CancelManifestTransmitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CancelManifestTransmitVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24CancelManifestTransmitVO();
		...
		return getKor24CancelManifestTransmitVOs();
	}
	 ...
	 * @return Kor24CancelManifestTransmitVO[]
	 */
	public Kor24CancelManifestTransmitVO[] getKor24CancelManifestTransmitVOs(){
		Kor24CancelManifestTransmitVO[] vos = (Kor24CancelManifestTransmitVO[])models.toArray(new Kor24CancelManifestTransmitVO[models.size()]);
		return vos;
	}
