...
public class BkgDataVO extends AbstractValueObject {
	...
	/* Column Info */
	private String doubleCallLaneCheck = null;
	/* Page Number */
	...
	/* Column Info */
	private String bkgYdCdDel = null;
	/* Column Info */
	...
	public BkgDataVO(String ibflag, String pagerows, String bkgStsCd, String polCd, String podCd, String bkgCgoTpCd, String spclHideFlg, String delCd, String bkgYdCdDel, String slanCd, String doubleCallLaneCheck, String interRmk, String dcgoFlg, String prctFlg, String bkgNo) {
		this.bkgCgoTpCd = bkgCgoTpCd;
		this.bkgStsCd = bkgStsCd;
		this.delCd = delCd;
		this.doubleCallLaneCheck = doubleCallLaneCheck;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("double_call_lane_check", getDoubleCallLaneCheck());
		...
		this.hashColumns.put("bkg_yd_cd_del", getBkgYdCdDel());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("double_call_lane_check", "doubleCallLaneCheck");
		...
		this.hashFields.put("bkg_yd_cd_del", "bkgYdCdDel");
	...
	/**
	 * Column Info
	 * @return doubleCallLaneCheck
	 */
	public String getDoubleCallLaneCheck() {
		return this.doubleCallLaneCheck;
	}
	 ...
	 * @return bkgYdCdDel
	 */
	public String getBkgYdCdDel() {
		return this.bkgYdCdDel;
	}
	...
	/**
	 * Column Info
	 * @param doubleCallLaneCheck
	 */
	public void setDoubleCallLaneCheck(String doubleCallLaneCheck) {
		this.doubleCallLaneCheck = doubleCallLaneCheck;
	}
	 ...
	 * @param bkgYdCdDel
	 */
	public void setBkgYdCdDel(String bkgYdCdDel) {
		this.bkgYdCdDel = bkgYdCdDel;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDoubleCallLaneCheck(JSPUtil.getParameter(request, prefix + "double_call_lane_check", ""));
		...
		setBkgYdCdDel(JSPUtil.getParameter(request, prefix + "bkg_yd_cd_del", ""));
	...
	public BkgDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] doubleCallLaneCheck = (JSPUtil.getParameter(request, prefix	+ "double_call_lane_check", length));
			...
			String[] bkgYdCdDel = (JSPUtil.getParameter(request, prefix	+ "bkg_yd_cd_del", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (doubleCallLaneCheck[i] != null)
					model.setDoubleCallLaneCheck(doubleCallLaneCheck[i]);
				if (pagerows[i] != null)
				...
				if (bkgYdCdDel[i] != null)
					model.setBkgYdCdDel(bkgYdCdDel[i]);
				if (bkgNo[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.doubleCallLaneCheck = this.doubleCallLaneCheck .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.bkgYdCdDel = this.bkgYdCdDel .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
