...
*@FileName : MTCostDBDAOSearchMTCost3ListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTCostDBDAOSearchMTCost3ListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COA_MTY_CNTR_ROUT_PERF 테이블의 데이터 조회    - 품질향상
	  * </pre>
	  */
	public MTCostDBDAOSearchMTCost3ListVORSQL(){
		setQuery();
		...
		query.append("FileName : MTCostDBDAOSearchMTCost3ListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
