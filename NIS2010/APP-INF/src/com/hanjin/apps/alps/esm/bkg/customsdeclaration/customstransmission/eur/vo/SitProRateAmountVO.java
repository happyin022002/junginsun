...
public class SitProRateAmountVO extends AbstractValueObject {
	...
	public SitProRateAmountVO(String ibflag, String pagerows, String fctype, String rate, String revenueton, String ppd, String cct, String currencycode, String exchrate, String tariff, String pertype, String rateofc) {
		this.ibflag = ibflag;
		this.rate = rate;
		this.tariff = tariff;
