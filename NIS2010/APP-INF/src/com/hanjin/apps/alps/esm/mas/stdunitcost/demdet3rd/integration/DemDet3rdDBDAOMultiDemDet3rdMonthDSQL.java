...
*@FileName : DemDet3rdDBDAOMultiDemDet3rdMonthDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDet3rdDBDAOMultiDemDet3rdMonthDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDet3rdDBDAOMultiDemDet3rdMonthDSQL(){
		setQuery();
		...
		query.append("FileName : DemDet3rdDBDAOMultiDemDet3rdMonthDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
