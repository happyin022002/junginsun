...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportByRepComRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportByRepComRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportByRepComRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportByRepComRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,BKG.REP_CMDT_NM" ).append("\n"); 
