...
*@FileName : WeeklyCMDBDAOCoaTmlTrfGrpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOCoaTmlTrfGrpVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOCoaTmlTrfGrpVOCSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOCoaTmlTrfGrpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COA_TML_TRF_GRP" ).append("\n"); 
