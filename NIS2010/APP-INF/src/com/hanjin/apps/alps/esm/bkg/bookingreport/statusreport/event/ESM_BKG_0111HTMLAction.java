...
public class ESM_BKG_0111HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0111HTMLAction 객체를 생성
	 */
	public ESM_BKG_0111HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0111Event event = new EsmBkg0111Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgCMCroChkListinVO((BkgCMCroChkListinVO)getVO(request, BkgCMCroChkListinVO .class));
		}
