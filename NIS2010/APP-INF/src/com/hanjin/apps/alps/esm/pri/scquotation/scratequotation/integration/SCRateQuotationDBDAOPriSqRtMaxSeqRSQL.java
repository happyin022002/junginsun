...
*@FileName : SCRateQuotationDBDAOPriSqRtMaxSeqRSQL.java
...
public class SCRateQuotationDBDAOPriSqRtMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
