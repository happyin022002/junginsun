...
*@FileName : UI_PRI_0001_03HTMLAction.java
...
public class ESM_PRI_0001_03HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0001_03HTMLAction 객체를 생성
	 */
	public ESM_PRI_0001_03HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri000103Event event = new EsmPri000103Event();
		
		if(command.isCommand(FormCommand.MULTI)) {		
			GrpCmdtGlineVO vo = new GrpCmdtGlineVO();
			vo.setPriSgGrpCmdtVOS((PriSgGrpCmdtVO[])getVOs(request, PriSgGrpCmdtVO.class, "sheet1_"));
			vo.setPriSgGrpCmdtDtlVOS((PriSgGrpCmdtDtlVO[])getVOs(request, PriSgGrpCmdtDtlVO.class, "sheet2_"));

			event.setGrpCmdtGlineVO(vo);			
		} else if (command.isCommand(FormCommand.SEARCH20)) {
			event.setPriSgGrpCmdtVO((PriSgGrpCmdtVO) getVO(request,
					PriSgGrpCmdtVO.class));
