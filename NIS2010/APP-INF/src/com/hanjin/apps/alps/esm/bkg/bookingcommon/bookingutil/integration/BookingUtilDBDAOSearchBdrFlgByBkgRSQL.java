...
*@FileName : BookingUtilDBDAOSearchBdrFlgByBkgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingUtilDBDAOSearchBdrFlgByBkgRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Bkg No로 BDR Flag를 조회한다.
	  * </pre>
	  */
	public BookingUtilDBDAOSearchBdrFlgByBkgRSQL(){
		setQuery();
		...
		query.append("FileName : BookingUtilDBDAOSearchBdrFlgByBkgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
