...
*@FileName : ESM_BKG_0449HTMLAction.java
...
public class ESM_BKG_0449HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0449HTMLAction 객체를 생성
	 */
	public ESM_BKG_0449HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0449Event event = new EsmBkg0449Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDpcsSiSplitBkgCntrCompareResultVO((DpcsSiSplitBkgCntrCompareResultVO)getVO(request, DpcsSiSplitBkgCntrCompareResultVO .class));
			event.setDpcsSiSplitBkgCntrCompareResultVOS((DpcsSiSplitBkgCntrCompareResultVO[])getVOs(request, DpcsSiSplitBkgCntrCompareResultVO .class,""));
		}
		return  event;
	}
