...
*@FileName : StatusReportDBDAOSearchBLStatusListSpecialCargo4RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusReportDBDAOSearchBLStatusListSpecialCargo4RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * StatusReportDBDAOSearchBLStatusListSpecialCargo4RSQL
	  * </pre>
	  */
	public StatusReportDBDAOSearchBLStatusListSpecialCargo4RSQL(){
		setQuery();
		...
		params.put("sp_cargo_ge",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : StatusReportDBDAOSearchBLStatusListSpecialCargo4RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                FROM ( " ).append("\n"); 
		query.append("                        SELECT " ).append("\n"); 
		query.append("                             	  DECODE(CNTR_TPSZ_CD,'D2',CNTR_VOL_QTY,0) AS D2" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'Q4',CNTR_VOL_QTY,0) AS Q4" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'D4',CNTR_VOL_QTY,0) AS D4" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'R2',CNTR_VOL_QTY,0) AS R2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'D5',CNTR_VOL_QTY,0) AS D5" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'R4',CNTR_VOL_QTY,0) AS R4" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'D7',CNTR_VOL_QTY,0) AS D7" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'R5',CNTR_VOL_QTY,0) AS R5" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'F2',CNTR_VOL_QTY,0) AS F2" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'T2',CNTR_VOL_QTY,0) AS T2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'F4',CNTR_VOL_QTY,0) AS F4" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'T4',CNTR_VOL_QTY,0) AS T4" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'F5',CNTR_VOL_QTY,0) AS F5" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'P2',CNTR_VOL_QTY,0) AS P2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'O2',CNTR_VOL_QTY,0) AS O2" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'P4',CNTR_VOL_QTY,0) AS P4" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'O4',CNTR_VOL_QTY,0) AS O4" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'Z4',CNTR_VOL_QTY,0) AS Z4" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'Q2',CNTR_VOL_QTY,0) AS Q2" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'Z2',CNTR_VOL_QTY,0) AS Z2" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'D3',CNTR_VOL_QTY,0) AS D3" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'D9',CNTR_VOL_QTY,0) AS D9" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'DX',CNTR_VOL_QTY,0) AS DX" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'R9',CNTR_VOL_QTY,0) AS R9" ).append("\n"); 
		query.append("                                , DECODE(CNTR_TPSZ_CD,'O5',CNTR_VOL_QTY,0) AS O5" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                                , DECODE(GREATEST('2', SUBSTR(CNTR_TPSZ_CD, 2, 1)), '2', NVL(CNTR_VOL_QTY, 0), 0)AS TEU" ).append("\n"); 
		query.append("                                , DECODE(GREATEST('2', SUBSTR(CNTR_TPSZ_CD, 2, 1)), '2', 0, NVL(CNTR_VOL_QTY, 0))AS FEU" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("                                , SUBSTR(VB.XTER_RMK,1,200) AS REMARK_DETAIL" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                                , RF.CNTR_NO AS CNTR_NO" ).append("\n"); 
		query.append("                                 /* T/S */" ).append("\n"); 
		query.append("                                , RF.CNTR_TPSZ_CD AS CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                , RF.CMDT_CD AS CMDT_CD" ).append("\n"); 
		query.append("                                  /* Commodity */" ).append("\n"); 
		query.append("                                , RF.CMDT_DESC AS RF_CMDT" ).append("\n"); 
		query.append("                                  /* C */" ).append("\n"); 
		query.append("								, TRIM(TO_CHAR(RF.CDO_TEMP ,'999,999,990.999')) CDO_TEMP" ).append("\n"); 
		query.append("                                  /* F */" ).append("\n"); 
		query.append("								, TRIM(TO_CHAR(RF.FDO_TEMP ,'999,999,990.999')) FDO_TEMP" ).append("\n"); 
		query.append("                                  /* Voltage */" ).append("\n"); 
		query.append("                                , RF.VLTG_NO AS VLTG_NO" ).append("\n"); 
		query.append("                                  /* Humid */" ).append("\n"); 
		query.append("                                , RF.HUMID_NO AS HUMID_NO" ).append("\n"); 
		query.append("                                  /* vent */" ).append("\n"); 
		query.append("                                , RF.VENT_RTO AS CNTR_VENT_TP_CD" ).append("\n"); 
		query.append("                                   /* gen */" ).append("\n"); 
		query.append("                                , RF.PWR_SPL_CBL_FLG AS PWR_SPL_CBL_FLG" ).append("\n"); 
		query.append("                                  /* CA */" ).append("\n"); 
		query.append("                                , RF.CTRL_ATMS_FLG AS CTRL_ATMS_FLG" ).append("\n"); 
		query.append("                                  /* MA */" ).append("\n"); 
		query.append("                                , RF.MODI_ATMS_FLG AS MODI_ATMS_FLG" ).append("\n"); 
		query.append("                                  /* HM */" ).append("\n"); 
		query.append("                                , RF.HUMID_CTRL_FLG AS HUMID_CTRL_FLG" ).append("\n"); 
		query.append("                                  /* AA */                                " ).append("\n"); 
		query.append("								, RF.ATFC_ATMS_FLG AS ATFC_ATMS_FLG " ).append("\n"); 
		query.append("                                  /* Net */" ).append("\n"); 
		query.append("								, TRIM(TO_CHAR(RF.NET_WGT ,'999,999,990.999')) NET_WGT" ).append("\n"); 
		query.append("                                  /* WGT  */" ).append("\n"); 
		query.append("                                , TRIM(TO_CHAR(NVL(GRS_WGT,0) ,'999,999,999,990.999')) GRS_WGT" ).append("\n"); 
		query.append("                                  /* PKG */" ).append("\n"); 
		query.append("                                , RF.PCK_QTY||RF.PCK_TP_CD AS PKG" ).append("\n"); 
		query.append("                                  /* AT */" ).append("\n"); 
		query.append("                                ,  RF.SPCL_CGO_APRO_CD AS SPCL_CGO_APRO_CD" ).append("\n"); 
		query.append("	   							, RF.RC_SEQ AS CGO_SEQ " ).append("\n"); 
		query.append("								 /* RD QTY*/" ).append("\n"); 
		...
		query.append("                                     WHEN (SELECT COUNT(*) FROM BKG_BL_CERTI K WHERE K.BL_NO = vb.BKG_NO AND K.BL_CERTI_STS_CD IN ('I') AND K.TMPLT_FLG = 'N') = 0 AND" ).append("\n"); 
		query.append("                                          (SELECT COUNT(*) FROM BKG_BL_CERTI K WHERE K.BL_NO = vb.BL_NO  AND K.BL_CERTI_STS_CD = 'C' AND K.TMPLT_FLG = 'N') = 0 AND" ).append("\n"); 
		query.append("                                          NVL((SELECT 'Y' FROM BKG_IMG_STO K WHERE K.BKG_NO = vb.BL_NO AND K.RIDR_TP_CD = 'K' AND ROWNUM =1 ),'N') != 'Y'" ).append("\n"); 
		...
		query.append("                                AND VB.BKG_NO = RF.BKG_NO" ).append("\n"); 
		query.append("                                AND VB.RC_FLG ='Y'" ).append("\n"); 
		query.append("                                AND VB.OB_SREP_CD = SR.SREP_CD(+)" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                                             AND SR.OFC_TEAM_CD = @[l_team_cd]" ).append("\n"); 
		query.append("                                           #end" ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		...
		query.append("                                           #end                                 " ).append("\n"); 
		query.append("                                                   " ).append("\n"); 
		query.append("											/* 103 sp_cargo_ge        */" ).append("\n"); 
		query.append("                                           #if (${sp_cargo_ge} != '')  " ).append("\n"); 
		query.append("											AND RF.PWR_SPL_CBL_FLG = @[sp_cargo_ge]" ).append("\n"); 
		query.append("										   #end                                      " ).append("\n"); 
