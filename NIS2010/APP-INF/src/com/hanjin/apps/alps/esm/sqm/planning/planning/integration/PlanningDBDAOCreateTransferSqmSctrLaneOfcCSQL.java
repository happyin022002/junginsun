...
*@FileName : PlanningDBDAOCreateTransferSqmSctrLaneOfcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOCreateTransferSqmSctrLaneOfcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [SQM_SCTR_LANE_OFC] 데이터를 1Q로 복사한다.
	  * </pre>
	  */
	public PlanningDBDAOCreateTransferSqmSctrLaneOfcCSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOCreateTransferSqmSctrLaneOfcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
