...
*@FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlGlineCpVOCSQL
	  * </pre>
	  */
	public SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityProposalDBDAOPriSpScpGrpCmdtDtlGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[amdt_seq]," ).append("\n"); 
		query.append("@[svc_scp_cd]," ).append("\n"); 
		query.append("DENSE_RANK() OVER (ORDER BY CMDT.GRP_CMDT_SEQ) GRP_CMDT_SEQ," ).append("\n"); 
		query.append("DENSE_RANK() OVER (PARTITION BY CMDT.GRP_CMDT_SEQ ORDER BY CMDT.GRP_CMDT_DTL_SEQ) GRP_CMDT_DTL_SEQ," ).append("\n"); 
		...
		query.append("PRI_SG_GRP_CMDT_DTL CMDT" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("AND CMDT.PRC_CUST_TP_CD = @[prc_prog_sts_cd]" ).append("\n"); 
