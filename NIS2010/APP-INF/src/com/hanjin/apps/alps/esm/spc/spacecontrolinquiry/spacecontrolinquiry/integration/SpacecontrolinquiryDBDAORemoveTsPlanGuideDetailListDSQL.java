...
*@FileName : SpacecontrolinquiryDBDAORemoveTsPlanGuideDetailListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAORemoveTsPlanGuideDetailListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [T/S Plan & guide Detail]을 [삭제]합니다.
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAORemoveTsPlanGuideDetailListDSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAORemoveTsPlanGuideDetailListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SPC_TS_PLN_GID_DTL" ).append("\n"); 
