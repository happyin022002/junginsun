...
*@FileName : SearchTaxDetailEvidenceListVO.java
*@FileTitle : SearchTaxDetailEvidenceListVO
*Open Issues :
*Change history :
...
public class SearchTaxDetailEvidenceListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchTaxDetailEvidenceListVO> models = new ArrayList<SearchTaxDetailEvidenceListVO>();
	...
	public SearchTaxDetailEvidenceListVO() {}

	public SearchTaxDetailEvidenceListVO(String ibflag, String pagerows, String itmNm, String splAmt, String taxAmt, String totalAmt) {
		this.ibflag = ibflag;
		this.taxAmt = taxAmt;
		this.splAmt = splAmt;
	 ...
	 */
	public SearchTaxDetailEvidenceListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTaxDetailEvidenceListVO[]
	 */
	public SearchTaxDetailEvidenceListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchTaxDetailEvidenceListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchTaxDetailEvidenceListVO();
				if (ibflag[i] != null)
		...
		return getSearchTaxDetailEvidenceListVOs();
	}
	 ...
	 * @return SearchTaxDetailEvidenceListVO[]
	 */
	public SearchTaxDetailEvidenceListVO[] getSearchTaxDetailEvidenceListVOs(){
		SearchTaxDetailEvidenceListVO[] vos = (SearchTaxDetailEvidenceListVO[])models.toArray(new SearchTaxDetailEvidenceListVO[models.size()]);
		return vos;
	}
