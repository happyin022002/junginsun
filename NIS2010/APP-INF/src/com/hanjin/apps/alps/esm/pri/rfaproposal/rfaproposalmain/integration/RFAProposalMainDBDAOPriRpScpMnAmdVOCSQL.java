...
*@FileName : RFAProposalMainDBDAOPriRpScpMnAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAOPriRpScpMnAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFAProposalMainDBDAO PriRpScpMnCpVO
	  * </pre>
	  */
	public RFAProposalMainDBDAOPriRpScpMnAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAOPriRpScpMnAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SVC_SCP_CD," ).append("\n"); 
		query.append("DECODE(SIGN(TO_DATE(@[eff_dt],'YYYY-MM-DD') - TRUNC(EFF_DT)), -1, EFF_DT, TO_DATE(@[eff_dt],'YYYY-MM-DD'))," ).append("\n"); 
		query.append("EXP_DT," ).append("\n"); 
		query.append("PROP_SCP_SREP_CD," ).append("\n"); 
		query.append("PROP_SCP_OFC_CD," ).append("\n"); 
		query.append("PROP_SCP_STS_CD," ).append("\n"); 
		...
		query.append("PRI_RP_SCP_MN" ).append("\n"); 
