...
*@FileName : SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033VVDLanePortRgstListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033VVDLanePortRgstListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyMultiSpaceAllocation0033VVDLanePortRgstList
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033VVDLanePortRgstListUSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033VVDLanePortRgstListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SPC_IRR_LANE_PORT_RGST" ).append("\n"); 
