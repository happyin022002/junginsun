...
*@FileName : TCharterIOInvoiceDBDAOAddFmsConsultationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDBDAOAddFmsConsultationCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FmsConsultation 테이블에 데이터 저장 한다.
	  * </pre>
	  */
	public TCharterIOInvoiceDBDAOAddFmsConsultationCSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDBDAOAddFmsConsultationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
