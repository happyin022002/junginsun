...
public class GeneralBookingSearchDBDAOsearchEdi301BlPoInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	||	'PO_NO:'	   ||REPLACE(REPLACE(NVL(refDtl.PO_NO,' '),CHR(13)||CHR(10),''),CHR(10),'')|| CHR(10)" ).append("\n"); 
		...
		query.append("	||	'PO_DESC:'	   ||REPLACE(REPLACE(NVL(refDtl.ITM_DESC,' '),CHR(13),' '),CHR(10),' ') || CHR(10)" ).append("\n"); 
