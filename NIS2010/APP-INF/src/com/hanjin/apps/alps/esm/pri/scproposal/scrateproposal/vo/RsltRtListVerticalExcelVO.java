...
public class RsltRtListVerticalExcelVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("frc_usd_amt", getFrcUsdAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("frc_usd_amt", "frcUsdAmt");
	 ...
	 * @return frcUsdAmt
	 */
	public String getFrcUsdAmt() {
		return this.frcUsdAmt;
	}
	 ...
	 * @param frcUsdAmt
	 */
	public void setFrcUsdAmt(String frcUsdAmt) {
		this.frcUsdAmt = frcUsdAmt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFrcUsdAmt(JSPUtil.getParameter(request, "frc_usd_amt", ""));
	...
	public RsltRtListVerticalExcelVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] frcUsdAmt = (JSPUtil.getParameter(request, prefix	+ "frc_usd_amt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (frcUsdAmt[i] != null)
					model.setFrcUsdAmt(frcUsdAmt[i]);
				if (ifcUsdAmt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.frcUsdAmt = this.frcUsdAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
