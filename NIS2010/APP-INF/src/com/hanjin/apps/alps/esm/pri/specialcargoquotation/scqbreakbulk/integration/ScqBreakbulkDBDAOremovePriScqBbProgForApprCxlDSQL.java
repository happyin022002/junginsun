...
*@FileName : ScqBreakbulkDBDAOremovePriScqBbProgForApprCxlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqBreakbulkDBDAOremovePriScqBbProgForApprCxlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * PRI_SCQ_PROG 테이블의 Approval 기록을 삭제 한다.
	  * </pre>
	  */
	public ScqBreakbulkDBDAOremovePriScqBbProgForApprCxlDSQL(){
		setQuery();
		...
		query.append("FileName : ScqBreakbulkDBDAOremovePriScqBbProgForApprCxlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  PRI_SCQ_PROG" ).append("\n"); 
