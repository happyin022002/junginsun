...
*@FileName : KorManifestListDBDAOSearchCustomerInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchCustomerInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchCustomerInfoRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchCustomerInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
