...
*@FileName : Kor24ManifestListDBDAOSearchCntCdTpSRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchCntCdTpSRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchCntCdTpSRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchCntCdTpSRSQL").append("\n");
		query.append("*/").append("\n");
	}
