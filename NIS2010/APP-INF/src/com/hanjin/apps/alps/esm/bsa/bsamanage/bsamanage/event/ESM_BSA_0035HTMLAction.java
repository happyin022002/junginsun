...
*@FileName : ESM_BSA_0035HTMLAction.java
*@FileTitle : Overlapped Contract Inquiry
*Open Issues :
*Change history :
 ...
 * @author Kim Ki Dae
 * @see EsmBsa0035Event 참조
 * @since J2EE 1.6
 */
public class ESM_BSA_0035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * TESTHTMLAction 객체를 생성
	 */
	public ESM_BSA_0035HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmBsa0035Event로 파싱하여 request에 셋팅<br>
	 * @param request HttpServletRequest HttpRequest
	 * @return Event Event interface를 구현한 객체
	 * @exception HTMLActionException
	 */
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("################# ESM_BSA_0035HTMLAction.perform() ############################[START]");
    	FormCommand command = FormCommand.fromRequest(request);
    	EsmBsa0035Event event = new EsmBsa0035Event();
		...
		log.debug("################# ESM_BSA_0035HTMLAction.perform() ############################[END]");
