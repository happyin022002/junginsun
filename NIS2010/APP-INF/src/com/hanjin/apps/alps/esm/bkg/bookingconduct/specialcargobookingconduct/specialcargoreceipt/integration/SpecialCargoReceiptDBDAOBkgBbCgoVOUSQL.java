...
public class SpecialCargoReceiptDBDAOBkgBbCgoVOUSQL implements ISQLTemplate{
	...
	public SpecialCargoReceiptDBDAOBkgBbCgoVOUSQL(){
		...
		params.put("cgo_lodg_sd_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("cgo_dchg_mzd_cd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(",   CGO_LODG_SD_CD = @[cgo_lodg_sd_cd]" ).append("\n"); 
		...
		query.append(",   CGO_DCHG_MZD_CD =@[cgo_dchg_mzd_cd]" ).append("\n"); 
