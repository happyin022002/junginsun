...
*@FileName : EBookingReceiptDBDAOaddBkgXterRqstMiscCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EBookingReceiptDBDAOaddBkgXterRqstMiscCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EBookingReceiptDBDAOaddBkgXterRqstMiscCSQL(){
		setQuery();
		...
		query.append("FileName : EBookingReceiptDBDAOaddBkgXterRqstMiscCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_XTER_RQST_MISC" ).append("\n"); 
		query.append("(" ).append("\n"); 
