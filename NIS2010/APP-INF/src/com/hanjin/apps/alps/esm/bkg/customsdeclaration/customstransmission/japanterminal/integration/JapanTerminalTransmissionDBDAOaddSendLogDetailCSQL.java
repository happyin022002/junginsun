...
*@FileName : JapanTerminalTransmissionDBDAOaddSendLogDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanTerminalTransmissionDBDAOaddSendLogDetailCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Japan Send log Detail 저장
	  * </pre>
	  */
	public JapanTerminalTransmissionDBDAOaddSendLogDetailCSQL(){
		setQuery();
		...
		query.append("FileName : JapanTerminalTransmissionDBDAOaddSendLogDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
