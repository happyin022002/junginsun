...
public class SalesRPTDBDAOSearchRouteDetail0147ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET)         AS CM" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET-CM2_COST) AS CM2" ).append("\n"); 
		query.append("      ,OP_COST                  AS OPC" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV+DEM_DET-CM_COST-OP_COST) AS OP" ).append("\n"); 
		...
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET)/LOAD    AS CMB" ).append("\n"); 
		query.append("      ,OP_COST                   AS OP_COST" ).append("\n"); 
		query.append("      ,OP_COST/LOAD            AS OPCOST" ).append("\n"); 
		query.append("      ,(BKG_REV+MISC_REV-CM_COST+DEM_DET-OP_COST)/LOAD AS OPB" ).append("\n"); 
