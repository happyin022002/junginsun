...
*@FileName : EsmMas0114ViewAdapter.java
*@FileTitle : EsmMas0114ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0114 에 대한 ViewAdapter<br>
 * - ESM_MAS_0114HTMLAction에서 작성<br>
 *
 * @author 김기대
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0114ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0114ViewAdapter(){
    	super();
    }
