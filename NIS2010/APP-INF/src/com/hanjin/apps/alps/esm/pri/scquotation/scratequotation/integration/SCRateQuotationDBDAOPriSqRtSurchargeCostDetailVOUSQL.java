...
*@FileName : SCRateQuotationDBDAOPriSqRtSurchargeCostDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtSurchargeCostDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtSurchargeCostDetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtSurchargeCostDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  PRI_SQ_RT A" ).append("\n"); 
		query.append("   SET  PRS_SCG_AMT = (SELECT SUM(ADJ_SCG_USD_AMT) FROM PRI_SQ_RT_SCG B " ).append("\n"); 
