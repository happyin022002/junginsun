...
public class LaneSimulationDBDAOCreateSimNWCostCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_SIM_NTWK_COST(SIM_DT, SIM_NO, SECT_NO, VSL_CD, TML_CD, VSL_DBL_CALL_SEQ, " ).append("\n"); 
		...
		query.append("	                      FROM MAS_SIM_TML_OP_DYS A1 " ).append("\n"); 
		query.append("	                          ,MAS_SIM_PORT_CHG A2 " ).append("\n"); 
		query.append("	                      WHERE A1.SIM_DT   = A2.SIM_DT " ).append("\n"); 
		query.append("	                        AND A1.SIM_NO   = A2.SIM_NO " ).append("\n"); 
		...
		query.append("	                      FROM MAS_SIM_DLY_HIR " ).append("\n"); 
		...
		query.append("	                     ,MAS_SIM_INTR_TRNS_VOL B4 " ).append("\n"); 
