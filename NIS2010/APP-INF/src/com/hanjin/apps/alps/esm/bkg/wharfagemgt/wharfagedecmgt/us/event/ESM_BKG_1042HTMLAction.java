 ...
 *@FileName : ESM_BKG_1042HTMLAction.java
 ...
 * @see EsmBkg1042Event 참조
 * @since J2EE 1.4
 */
public class ESM_BKG_1042HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1042HTMLAction 객체를 생성
	 */
	public ESM_BKG_1042HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1042Event event = new EsmBkg1042Event();
