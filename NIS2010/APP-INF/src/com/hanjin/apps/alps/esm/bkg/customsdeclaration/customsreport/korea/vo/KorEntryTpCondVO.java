...
*@FileName : KorEntryTpCondVO.java
*@FileTitle : KorEntryTpCondVO
*Open Issues :
*Change history :
...
public class KorEntryTpCondVO extends EntryTpCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorEntryTpCondVO> models = new ArrayList<KorEntryTpCondVO>();
	...
	public KorEntryTpCondVO() {}

	public KorEntryTpCondVO(String ibflag, String pagerows, String cntCd, String cstmsEntrCd, String entrNm, String usrId) {
		this.ibflag = ibflag;
		this.entrNm = entrNm;
		this.usrId = usrId;
	 ...
	 */
	public KorEntryTpCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorEntryTpCondVO[]
	 */
	public KorEntryTpCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorEntryTpCondVO model = null;
	...
	public KorEntryTpCondVO[] getKorEntryTpCondVOs(){
		KorEntryTpCondVO[] vos = (KorEntryTpCondVO[])models.toArray(new KorEntryTpCondVO[models.size()]);
		return vos;
	}
