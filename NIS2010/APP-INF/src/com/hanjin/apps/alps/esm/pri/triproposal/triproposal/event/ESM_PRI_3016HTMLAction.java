 ...
 *@FileName : ESM_PRI_3016HTMLAction.java
 *@FileTitle : ESM_PRI_3016HTMLAction
 *Open Issues :
 *Change history :
...
public class ESM_PRI_3016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_3016HTMLAction 객체를 생성
	 */
	public ESM_PRI_3016HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3016Event event = new EsmPri3016Event();
