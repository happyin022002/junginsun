...
*@FileName : KorDiscFlatFileVO.java
*@FileTitle : KorDiscFlatFileVO
*Open Issues :
*Change history :
...
public class KorDiscFlatFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorDiscFlatFileVO> models = new ArrayList<KorDiscFlatFileVO>();
	...
	public KorDiscFlatFileVO() {}

	public KorDiscFlatFileVO(String ibflag, String pagerows, String mrnNo, String cstmsDschCd, String loclCstmsCd, String loclCstmsPrtCd, String bkgNo, String cBlNo, String vvd, String portCd, String ioBndCd, String inType, String podCd, String polCd, String blData, String cstmsDeclTpCd, String cntrData, String userId) {
...
/**
	 ...
	 */
	public KorDiscFlatFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorDiscFlatFileVO[]
	 */
	public KorDiscFlatFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorDiscFlatFileVO model = null;
	 ...
	 * @return KorDiscFlatFileVO[]
	 */
	public KorDiscFlatFileVO[] getKorDiscFlatFileVOs(){
		KorDiscFlatFileVO[] vos = (KorDiscFlatFileVO[])models.toArray(new KorDiscFlatFileVO[models.size()]);
		return vos;
	}
