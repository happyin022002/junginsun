...
public class EsmBkg0631Event extends EventSupport {
	...
	public void setRbcvesselVOS(RbcvesselVO[] rbcvesselVOs){
		if(rbcvesselVOs != null){
			RbcvesselVO[] tmpVOs = new RbcvesselVO[rbcvesselVOs.length];
			System.arraycopy(rbcvesselVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	public RbcvesselVO[] getRbcvesselVOS(){
		...
		if (this.rbcvesselVOs != null) {
			rtnVOs = new RbcvesselVO[rbcvesselVOs.length];
			System.arraycopy(rbcvesselVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
