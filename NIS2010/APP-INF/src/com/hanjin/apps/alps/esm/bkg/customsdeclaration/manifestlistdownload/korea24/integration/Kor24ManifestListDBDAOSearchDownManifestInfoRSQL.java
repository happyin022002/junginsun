...
*@FileName : Kor24ManifestListDBDAOSearchDownManifestInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchDownManifestInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchDownManifestInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchDownManifestInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  TB.BL_NO BL_NO," ).append("\n"); 
		...
		query.append("		TB.CNTR_NO CNTR_NO," ).append("\n"); 
		query.append("		DECODE(@[kt_port],'KRPUS',DECODE(TB.FE,'P',@[in_bound]||TO_CHAR(SYSDATE,'Y')||TO_CHAR(SYSDATE,'MM')||DECODE(LENGTH(TO_CHAR(BKG_CSTMS_KR_BL_SEQ.NEXTVAL)),1,TO_CHAR(BKG_CSTMS_KR_BL_SEQ.NEXTVAL),CHR(BKG_CSTMS_KR_BL_SEQ.NEXTVAL+55))||SUBSTR(TB.CNTR_NO,5),TB.BL_NO),TB.BL_NO) C_BL_NO" ).append("\n"); 
