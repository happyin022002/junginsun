...
*@FileName : DblEdiInfoVO.java
*@FileTitle : DblEdiInfoVO
*Open Issues :
*Change history :
...
public class DblEdiInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DblEdiInfoVO> models = new ArrayList<DblEdiInfoVO>();
	...
	public DblEdiInfoVO(String ibflag, String pagerows, String bkgNo, String preRlyPortCd, String pstRlyPortCd, String vslCd, String skdVoyNo, String skdDirCd) {
		this.vslCd = vslCd;
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return DblEdiInfoVO[]
	 */
	public DblEdiInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DblEdiInfoVO[]
	 */
	public DblEdiInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DblEdiInfoVO model = null;
	 ...
	 * @return DblEdiInfoVO[]
	 */
	public DblEdiInfoVO[] getDblEdiInfoVOs(){
		DblEdiInfoVO[] vos = (DblEdiInfoVO[])models.toArray(new DblEdiInfoVO[models.size()]);
		return vos;
	}
