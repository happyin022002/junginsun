...
*@FileName : ESM_MAS_0251HTMLAction.java
*@FileTitle : ESM_MAS_0251HTMLAction
*Open Issues :
 ...
 * @since J2EE 1.6
 */
public class ESM_MAS_0251HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0041HTMLAction 객체를 생성
	 */
	public ESM_MAS_0251HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0251Event event = new EsmMas0251Event();  		
    	
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
		    event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO.class));
		} else if(command.isCommand(FormCommand.MULTI01)) {
		    event.setSearchUCbyCustomerListVOs((SearchUCbyCustomerListVO[])getVOs(request, SearchUCbyCustomerListVO.class, ""));
		}
