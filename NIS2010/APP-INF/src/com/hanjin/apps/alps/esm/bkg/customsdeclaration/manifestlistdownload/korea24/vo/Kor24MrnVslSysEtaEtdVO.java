...
*@FileName : Kor24MrnVslSysEtaEtdVO.java
*@FileTitle : Kor24MrnVslSysEtaEtdVO
*Open Issues :
*Change history :
...
public class Kor24MrnVslSysEtaEtdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24MrnVslSysEtaEtdVO> models = new ArrayList<Kor24MrnVslSysEtaEtdVO>();
	...
	public Kor24MrnVslSysEtaEtdVO() {}

	public Kor24MrnVslSysEtaEtdVO(String ibflag, String pagerows, String mrnNo, String mrnChkNo, String actionTime, String etaDt, String etdDt, String vslFlag, String vslEngNm, String vslCallSign, String curdate, String inVvd, String inBound, String inPol, String inPod) {
		this.inVvd = inVvd;
		this.inPod = inPod;
	 ...
	 */
	public Kor24MrnVslSysEtaEtdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24MrnVslSysEtaEtdVO[]
	 */
	public Kor24MrnVslSysEtaEtdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24MrnVslSysEtaEtdVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24MrnVslSysEtaEtdVO();
				if (inVvd[i] != null)
		...
		return getKor24MrnVslSysEtaEtdVOs();
	}
	 ...
	 * @return Kor24MrnVslSysEtaEtdVO[]
	 */
	public Kor24MrnVslSysEtaEtdVO[] getKor24MrnVslSysEtaEtdVOs(){
		Kor24MrnVslSysEtaEtdVO[] vos = (Kor24MrnVslSysEtaEtdVO[])models.toArray(new Kor24MrnVslSysEtaEtdVO[models.size()]);
		return vos;
	}
