...
public class CndCstmsRcvHisListCondVO extends CstmsRcvHisListCondVO {
    ...
    public CndCstmsRcvHisListCondVO(String ibflag, String pagerows, String polCd, String vvdCd, String rcvMsgTpId, String rcvDtFlg, String sRcvDt, String eRcvDt, String podCd, String blNo, String sRcvTm, String eRcvTm, String a6AtaOnly) {
        this.podCd = podCd;
        this.eRcvDt = eRcvDt;
        this.sRcvDt = sRcvDt;
        this.polCd = polCd;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("a6_ata_only", getA6AtaOnly());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("a6_ata_only", "a6AtaOnly");
    ...
    public void setA6AtaOnly(String a6AtaOnly) {
        this.a6AtaOnly = a6AtaOnly;
    }

    public String getA6AtaOnly() {
        return this.a6AtaOnly;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setA6AtaOnly(JSPUtil.getParameter(request, "a6_ata_only", ""));
    ...
    public CndCstmsRcvHisListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] a6AtaOnly = (JSPUtil.getParameter(request, prefix + "a6_ata_only", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (a6AtaOnly[i] != null) 
		    		model.setA6AtaOnly(a6AtaOnly[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.a6AtaOnly = this.a6AtaOnly.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
