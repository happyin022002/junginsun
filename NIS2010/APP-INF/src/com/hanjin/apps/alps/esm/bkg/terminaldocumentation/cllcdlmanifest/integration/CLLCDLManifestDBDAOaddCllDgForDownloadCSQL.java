...
*@FileName : CLLCDLManifestDBDAOaddCllDgForDownloadCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CLLCDLManifestDBDAOaddCllDgForDownloadCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CLLCDLManifestDBDAOaddCllDgForDownloadCSQL(){
		setQuery();
		...
		query.append("FileName : CLLCDLManifestDBDAOaddCllDgForDownloadCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_TML_CLL_DG_CGO" ).append("\n"); 
		...
		query.append("	@[bkg_no]," ).append("\n"); 
		query.append("	@[cntr_no]," ).append("\n"); 
		query.append("	@[cll_dg_seq] + 1," ).append("\n"); 
		query.append("	@[imdg_un_no]," ).append("\n"); 
		query.append("	@[imdg_clss_cd]," ).append("\n"); 
		query.append("	@[dg_desc]," ).append("\n"); 
		query.append("	@[emer_cntc_phn_no]," ).append("\n"); 
