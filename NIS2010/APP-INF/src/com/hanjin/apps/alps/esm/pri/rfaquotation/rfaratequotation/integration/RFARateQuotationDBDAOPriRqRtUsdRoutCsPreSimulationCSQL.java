...
*@FileName : RFARateQuotationDBDAOPriRqRtUsdRoutCsPreSimulationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtUsdRoutCsPreSimulationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtUsdRoutCsPreSimulationCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtUsdRoutCsPreSimulationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RQ_RT_USD_ROUT_CS(" ).append("\n"); 
		query.append("QTTN_NO, QTTN_VER_NO, CMDT_HDR_SEQ, ROUT_SEQ, RT_SEQ, ROUT_CS_NO, ROUT_CS_SRC_DT" ).append("\n"); 
