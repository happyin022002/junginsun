...
*@FileName : ESM_SPC_0096HTMLAction.java
...
public class ESM_SPC_0096HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0030HTMLAction 객체를 생성
	 */
	public ESM_SPC_0096HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0096Event event = new EsmSpc0096Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setModelPfmcVO((ModelPfmcVO)getVO(request, ModelPfmcVO .class));
		}
