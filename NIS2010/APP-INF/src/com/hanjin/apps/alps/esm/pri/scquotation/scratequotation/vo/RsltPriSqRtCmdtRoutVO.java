...
*@FileName : RsltPriSqRtCmdtRoutVO.java
*@FileTitle : RsltPriSqRtCmdtRoutVO
*Open Issues :
*Change history :
...
public class RsltPriSqRtCmdtRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqRtCmdtRoutVO> models = new ArrayList<RsltPriSqRtCmdtRoutVO>();
	...
	public RsltPriSqRtCmdtRoutVO() {}

	public RsltPriSqRtCmdtRoutVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String genSpclRtTpCd, String cmdtHdrSeq, String routSeq, String dirCallFlg, String orgRoutPntLocDefCd, String orgRoutViaPortDefCd, String destRoutViaPortDefCd, String destRoutPntLocDefCd, String rn) {
	 ...
	 * @param request
	 * @return RsltPriSqRtCmdtRoutVO[]
	 */
	public RsltPriSqRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqRtCmdtRoutVO[]
	 */
	public RsltPriSqRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqRtCmdtRoutVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSqRtCmdtRoutVO();
		...
		return getRsltPriSqRtCmdtRoutVOs();
	}
	 ...
	 * @return RsltPriSqRtCmdtRoutVO[]
	 */
	public RsltPriSqRtCmdtRoutVO[] getRsltPriSqRtCmdtRoutVOs(){
		RsltPriSqRtCmdtRoutVO[] vos = (RsltPriSqRtCmdtRoutVO[])models.toArray(new RsltPriSqRtCmdtRoutVO[models.size()]);
		return vos;
	}
