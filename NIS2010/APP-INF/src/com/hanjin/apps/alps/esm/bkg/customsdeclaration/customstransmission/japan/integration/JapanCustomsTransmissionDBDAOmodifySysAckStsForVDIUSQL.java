...
*@FileName : JapanCustomsTransmissionDBDAOmodifySysAckStsForVDIUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanCustomsTransmissionDBDAOmodifySysAckStsForVDIUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanCustomsTransmissionDBDAOmodifySysAckStsForVDIUSQL(){
		setQuery();
		...
		query.append("FileName : JapanCustomsTransmissionDBDAOmodifySysAckStsForVDIUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
