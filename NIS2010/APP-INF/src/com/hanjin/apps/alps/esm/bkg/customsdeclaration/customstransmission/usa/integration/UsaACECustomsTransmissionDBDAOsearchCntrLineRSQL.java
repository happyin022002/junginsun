...
*@FileName : UsaACECustomsTransmissionDBDAOsearchCntrLineRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaACECustomsTransmissionDBDAOsearchCntrLineRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UsaACECustomsTransmissionDBDAOsearchCntrLineRSQL
	  * </pre>
	  */
	public UsaACECustomsTransmissionDBDAOsearchCntrLineRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.usa.integration").append("\n"); 
		query.append("FileName : UsaACECustomsTransmissionDBDAOsearchCntrLineRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
