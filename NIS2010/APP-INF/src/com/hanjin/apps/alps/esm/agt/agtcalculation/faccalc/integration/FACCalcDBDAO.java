...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.apps.alps.esm.agt.agtcalculation.faccalc.integration;
...
//				act_comm_amt = fac_calc_amt*(bkg_fac_rt/100);
			...
			{ //20080324-sunganj : Double Rate 추가
				...
				queryStr04.append("                             AND QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
				...
				queryStr04.append("                             AND BK2.BL_NO_TP              <>  '9' \n");
...
//			}
	...
	public HashMap createFACTPSZSummation(HashMap bkgMap) throws DAOException
	{
		...
		try
		{
			...
			queryStr.append("                                        ( \n");
			queryStr.append("                                     CASE \n");
			queryStr.append("                                     WHEN BKG.BL_NO_TP = '9' \n");
			queryStr.append("                                     THEN '0' \n");
			queryStr.append("                                     ELSE BK2.BL_NO_TP \n");
			queryStr.append("                                      END \n");
			queryStr.append("                                        ) \n");
