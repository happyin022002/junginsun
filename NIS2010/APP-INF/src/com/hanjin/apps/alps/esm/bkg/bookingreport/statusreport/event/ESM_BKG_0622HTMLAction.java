...
*@FileName : ESM_BKG_0622HTMLAction.java
...
public class ESM_BKG_0622HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0622HTMLAction 객체를 생성
	 */
	public ESM_BKG_0622HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0622Event event = new EsmBkg0622Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setOutBdMvntStsNtcListInVO((OutBdMvntStsNtcListInVO)getVO(request, OutBdMvntStsNtcListInVO.class));
			event.setOutBdMvntStsNtcListSumVO((OutBdMvntStsNtcListSumVO)getVO(request, OutBdMvntStsNtcListSumVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) { 
			event.setOutBdMvntStsNtcListInVO((OutBdMvntStsNtcListInVO)getVO(request, OutBdMvntStsNtcListInVO.class));  
			event.setOutBdMvntStsNtcListInVOS((OutBdMvntStsNtcListInVO[])getVOs(request, OutBdMvntStsNtcListInVO.class));
		} 
