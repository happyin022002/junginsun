...
*@FileName : SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_GRP_LOC_DTL Insert
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocDtlCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",PRI_SP_SCP_GRP_LOC_DTL B" ).append("\n"); 
