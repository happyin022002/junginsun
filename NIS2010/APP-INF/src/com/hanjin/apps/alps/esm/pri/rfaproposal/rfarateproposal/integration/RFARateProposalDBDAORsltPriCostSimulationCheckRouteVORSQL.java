...
*@FileName : RFARateProposalDBDAORsltPriCostSimulationCheckRouteVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltPriCostSimulationCheckRouteVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltPriCostSimulationCheckRouteVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltPriCostSimulationCheckRouteVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, PNT.PROP_NO, PNT.AMDT_SEQ, PNT.SVC_SCP_CD,PNT.CMDT_HDR_SEQ, PNT.ORG_DEST_TP_CD,PNT.ROUT_SEQ " ).append("\n"); 
		query.append("	FROM PRI_RP_SCP_RT_ROUT_PNT PNT" ).append("\n"); 
		query.append("	    , PRI_RP_SCP_GRP_LOC GRP" ).append("\n"); 
		query.append("	    , PRI_RP_SCP_GRP_LOC_DTL GRP_DTL" ).append("\n"); 
		...
		query.append("		, PROP_NO, AMDT_SEQ, SVC_SCP_CD,CMDT_HDR_SEQ, ORG_DEST_TP_CD,ROUT_SEQ " ).append("\n"); 
