...
*@FileName : ESM_BKG_1034HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESM_BKG_1034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1034HTMLAction 객체를 생성
	 */
	public ESM_BKG_1034HTMLAction() {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1034Event event = new EsmBkg1034Event();
