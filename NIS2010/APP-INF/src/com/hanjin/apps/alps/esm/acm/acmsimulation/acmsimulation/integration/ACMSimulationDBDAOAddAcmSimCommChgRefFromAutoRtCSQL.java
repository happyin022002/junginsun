...
*@FileName : ACMSimulationDBDAOAddAcmSimCommChgRefFromAutoRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddAcmSimCommChgRefFromAutoRtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Auto rating을 이용한 Surcharge 정보 조회.
	  * </pre>
	  */
	public ACMSimulationDBDAOAddAcmSimCommChgRefFromAutoRtCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddAcmSimCommChgRefFromAutoRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
