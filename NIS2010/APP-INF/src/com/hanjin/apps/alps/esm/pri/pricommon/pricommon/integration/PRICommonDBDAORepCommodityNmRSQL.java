...
*@FileName : PRICommonDBDAORepCommodityNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAORepCommodityNmRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RepCommodityNm select
	  * </pre>
	  */
	public PRICommonDBDAORepCommodityNmRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAORepCommodityNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
