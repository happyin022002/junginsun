...
*@FileName : ESM_COA_063Event.java
...
/**
 * ESM_COA_063 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_COA_063HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
public class EsmCoa0063Event extends EventSupport {
	...
	/**
	 * ESM_COA_063Event 객체를 생성
	 */
	public EsmCoa0063Event(){
		//
	}
