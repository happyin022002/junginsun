...
*@FileName : SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LaneRgstListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LaneRgstListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyMultiSpaceAllocation0033LaneRgstList
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LaneRgstListUSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOModifyMultiSpaceAllocation0033LaneRgstListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SPC_LANE_RGST" ).append("\n"); 
