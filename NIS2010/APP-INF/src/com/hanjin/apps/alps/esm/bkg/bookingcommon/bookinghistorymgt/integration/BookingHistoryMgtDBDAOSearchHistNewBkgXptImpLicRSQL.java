...
public class BookingHistoryMgtDBDAOSearchHistNewBkgXptImpLicRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("        UNION ALL " ).append("\n"); 
		query.append("        SELECT DECODE(NOW.IO_BND_CD, 'O', 'Export', 'Import')||' > NIGERIA' HIS_CATE_NM                " ).append("\n"); 
		query.append("                , DECODE(NOW.IO_BND_CD, 'O','EXS NO. : ' || '','ENS NO. : ' || '') PRE_CTNT                " ).append("\n"); 
		...
		query.append("         WHERE NOW.BKG_NO = @[bkg_no] " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("           AND NOW.CNT_CD = 'NG'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if ($field_list.size() > 0)" ).append("\n"); 
		query.append("           AND (BKG_NO, IO_BND_CD, XPT_IMP_SEQ) NOT IN (" ).append("\n"); 
		query.append("           #foreach($field_id in ${field_list}) " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("        UNION ALL " ).append("\n"); 
		query.append("        SELECT DECODE(NOW.IO_BND_CD, 'O', 'Export', 'Import')||' > TOGO' HIS_CATE_NM                " ).append("\n"); 
		query.append("                , DECODE(NOW.IO_BND_CD, 'O','ECTN NO.(OB) : ' || '','ECTN NO.(IB) : ' || '') PRE_CTNT                " ).append("\n"); 
		...
		query.append("         WHERE NOW.BKG_NO = @[bkg_no] " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("           AND NOW.CNT_CD = 'TG'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if ($field_list.size() > 0)" ).append("\n"); 
		query.append("           AND (BKG_NO, IO_BND_CD, XPT_IMP_SEQ) NOT IN (" ).append("\n"); 
		query.append("           #foreach($field_id in ${field_list}) " ).append("\n"); 
		...
		query.append("#end " ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(NOW.IO_BND_CD, 'O', 'Export', 'Import')||' > CNPJ NO.' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'SHPR : ' || '' PRE_CTNT" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(NOW.IO_BND_CD, 'O', 'Export', 'Import')||' > CNPJ NO.' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'CNEE : ' || '' PRE_CTNT" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(NOW.IO_BND_CD, 'O', 'Export', 'Import')||' > CNPJ NO.' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'NTFY : ' || '' PRE_CTNT" ).append("\n"); 
		...
		query.append("#end " ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(NOW.IO_BND_CD, 'O', 'Export', 'Import')||' > TURKEY' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'SHPR : ' || '' PRE_CTNT" ).append("\n"); 
		...
		query.append("         WHERE NOW.BKG_NO = @[bkg_no] " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("           AND NOW.CNT_CD = 'TR'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if ($field_list.size() > 0)" ).append("\n"); 
		query.append("           AND (BKG_NO, IO_BND_CD, XPT_IMP_SEQ) NOT IN (" ).append("\n"); 
		query.append("           #foreach($field_id in ${field_list}) " ).append("\n"); 
