...
*@FileName : CostAssignDBDAORemoveCoaComCostParaDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostAssignDBDAORemoveCoaComCostParaDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COA_COM_COST_PARA 테이블 data 삭제
	  * </pre>
	  */
	public CostAssignDBDAORemoveCoaComCostParaDSQL(){
		setQuery();
		...
		query.append("FileName : CostAssignDBDAORemoveCoaComCostParaDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
