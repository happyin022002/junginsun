...
*@FileName : ESM_BKG_0226HTMLAction.java
...
public class ESM_BKG_0226HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0226HTMLAction 객체를 생성
	 */
	public ESM_BKG_0226HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0226Event event = new EsmBkg0226Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEBkgSiUploadStsReportInVO((EBkgSiUploadStsReportInVO)getVO(request, EBkgSiUploadStsReportInVO .class));
		}
		return  event;
	}
