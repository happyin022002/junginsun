...
public class Kor24BlCustInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24BlCustInfoVO> models = new ArrayList<Kor24BlCustInfoVO>();
	...
	public Kor24BlCustInfoVO() {}

	public Kor24BlCustInfoVO(String ibflag, String pagerows, String vvd, String portCd, String inType, String ioBndCd, String podCd, String polCd, String podTml) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.polCd = polCd;
		this.inType = inType;
	 ...
	 */
	public Kor24BlCustInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsKrCustVO[]
	 */
	public Kor24BlCustInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24BlCustInfoVO model = null;
	 ...
	 * @return BkgCstmsKrCustVO[]
	 */
	public Kor24BlCustInfoVO[] getBkgCstmsKrCustVOs(){
		Kor24BlCustInfoVO[] vos = (Kor24BlCustInfoVO[])models.toArray(new Kor24BlCustInfoVO[models.size()]);
		return vos;
	}
