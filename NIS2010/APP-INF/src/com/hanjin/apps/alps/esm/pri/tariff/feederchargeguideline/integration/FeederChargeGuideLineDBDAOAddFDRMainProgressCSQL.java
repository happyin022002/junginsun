...
*@FileName : FeederChargeGuideLineDBDAOAddFDRMainProgressCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOAddFDRMainProgressCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add FDR Main Progress
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOAddFDRMainProgressCSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOAddFDRMainProgressCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRF_FDR_PROG (" ).append("\n"); 
		...
		query.append("                FROM PRI_TRF_FDR_PROG" ).append("\n"); 
