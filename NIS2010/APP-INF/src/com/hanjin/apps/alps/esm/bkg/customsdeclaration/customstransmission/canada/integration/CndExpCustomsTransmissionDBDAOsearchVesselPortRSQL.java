...
*@FileName : CndExpCustomsTransmissionDBDAOsearchVesselPortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchVesselPortRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchVesselPortRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchVesselPortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
