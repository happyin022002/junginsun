...
*@FileName       : ESM_COA_078HTMLAction.java
*@FileTitle      : 
*Open Issues     :
*Change history  :
 ...
 *
 * @author Park Eun Ju
 * @see ESM_COA_078Event , ESM_COA_078EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_COA_0078HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_COA_078HTMLAction 객체를 생성
	 */
	public ESM_COA_0078HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_COA_078Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0078Event event = new EsmCoa0078Event();
