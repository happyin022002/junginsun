...
*@FileName : RsltBkgRevDrAmtVO.java
*@FileTitle : RsltBkgRevDrAmtVO
*Open Issues :
*Change history :
...
public class RsltBkgRevDrAmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltBkgRevDrAmtVO> models = new ArrayList<RsltBkgRevDrAmtVO>();
	...
	public RsltBkgRevDrAmtVO() {}

	public RsltBkgRevDrAmtVO(String ibflag, String pagerows, String rdnNo, String rvisSeq, String currCd, String drAmt, String creUsrId, String creDt, String updUsrId, String updDt, String usdAmount) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("usd_amount", getUsdAmount());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("usd_amount", "usdAmount");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setUsdAmount(JSPUtil.getParameter(request, "usd_amount", ""));
	 ...
	 * @param request
	 * @return RsltBkgRevDrAmtVO[]
	 */
	public RsltBkgRevDrAmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltBkgRevDrAmtVO[]
	 */
	public RsltBkgRevDrAmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltBkgRevDrAmtVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				if (usdAmount[i] != null)
					model.setUsdAmount(usdAmount[i]);
				if (updUsrId[i] != null)
	 ...
	 * @return RsltBkgRevDrAmtVO[]
	 */
	public RsltBkgRevDrAmtVO[] getRsltBkgRevDrAmtVOs(){
		RsltBkgRevDrAmtVO[] vos = (RsltBkgRevDrAmtVO[])models.toArray(new RsltBkgRevDrAmtVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.usdAmount = this.usdAmount .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
