...
*@FileName : ESM_BKG_0238HTMLAction.java
...
public class ESM_BKG_0238HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0238HTMLAction 객체를 생성
	 */
	public ESM_BKG_0238HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0238Event event = new EsmBkg0238Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgChkPntItemVOs((BkgChkPntItemVO[])getVOs(request, BkgChkPntItemVO .class,"sheet1_"));
		}	else if(command.isCommand(FormCommand.MULTI01)) {
			event.setBkgChkPntItemTpVOs((BkgChkPntItemTpVO[])getVOs(request, BkgChkPntItemTpVO .class,"sheet2_"));
		}		
