...
*@FileName : ArApprovalDBDAOUpdateAproGwUrlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ArApprovalDBDAOUpdateAproGwUrlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ArApprovalDBDAOUpdateAproGwUrlUSQL(){
		setQuery();
		...
		query.append("FileName : ArApprovalDBDAOUpdateAproGwUrlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
