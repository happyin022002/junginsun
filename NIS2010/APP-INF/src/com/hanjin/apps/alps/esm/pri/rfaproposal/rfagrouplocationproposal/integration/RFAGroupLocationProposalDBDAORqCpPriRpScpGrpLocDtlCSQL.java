...
*@FileName : RFAGroupLocationProposalDBDAORqCpPriRpScpGrpLocDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAORqCpPriRpScpGrpLocDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RqCpPriRpScpGrpLocDtl
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAORqCpPriRpScpGrpLocDtlCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAORqCpPriRpScpGrpLocDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RP_SCP_GRP_LOC_DTL (" ).append("\n"); 
		...
		query.append("                         ORDER BY C.QTTN_NO, C.QTTN_VER_NO,C.GRP_LOC_SEQ) AS GRP_LOC_SEQ" ).append("\n"); 
		query.append("     , DENSE_RANK() OVER(PARTITION BY C.QTTN_NO, C.QTTN_VER_NO, C.GRP_LOC_SEQ" ).append("\n"); 
		query.append("                         ORDER BY C.QTTN_NO, C.QTTN_VER_NO, C.GRP_LOC_SEQ, C.GRP_LOC_DTL_SEQ) AS GRP_LOC_DTL_SEQ" ).append("\n"); 
		query.append("     , C.LOC_CD" ).append("\n"); 
		query.append("     , 'I' AS PRC_PROG_STS_CD" ).append("\n"); 
		query.append("     , C.SRC_INFO_CD" ).append("\n"); 
		query.append("     , 0 AS N1ST_CMNC_DT" ).append("\n"); 
		query.append("     , @[cre_usr_id] AS CRE_USR_ID" ).append("\n"); 
		query.append("     , SYSDATE AS CRE_DT" ).append("\n"); 
		query.append("     , @[upd_usr_id] AS UPD_USR_ID" ).append("\n"); 
		query.append("     , SYSDATE AS UPD_DT" ).append("\n"); 
		query.append("FROM	PRI_RQ_MN A" ).append("\n"); 
		query.append(",	PRI_RQ_GRP_LOC B" ).append("\n"); 
		query.append(",	PRI_RQ_GRP_LOC_DTL C" ).append("\n"); 
