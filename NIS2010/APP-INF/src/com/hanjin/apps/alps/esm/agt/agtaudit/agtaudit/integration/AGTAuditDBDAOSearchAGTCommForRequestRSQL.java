...
*@FileName : AGTAuditDBDAOSearchAGTCommForRequestRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOSearchAGTCommForRequestRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchAGTCommForRequest
	  * </pre>
	  */
	public AGTAuditDBDAOSearchAGTCommForRequestRSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOSearchAGTCommForRequestRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("           SUM(DECODE(SIGN(INSTR('GNKHSROCD',A.AC_TP_CD)),1,ACT_IF_LOCL_COMM_AMT,0))                      AS LCL_AMT," ).append("\n"); 
		...
		query.append("#if(${sts_dv} == '0')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD" ).append("\n"); 
		query.append("        IN" ).append("\n"); 
		query.append("         ( 'CS','CE','IC','CA'" ).append("\n"); 
		query.append("         )" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '1')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD = 'CS'" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '2')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD = 'CE'" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '3')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD = 'CA'" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '4')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD = 'IC'" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '5')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD IN ('RS','RM')" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '6')" ).append("\n"); 
		query.append("       AND A.COMM_PROC_STS_CD = 'AS'" ).append("\n"); 
		query.append("#elseif(${sts_dv} == '7')" ).append("\n"); 
		...
		query.append("       AND A.COMM_VSL_CD||A.COMM_SKD_VOY_NO||A.COMM_SKD_DIR_CD||A.COMM_REV_DIR_CD LIKE @[s_vvd]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("       AND C.CRE_DT" ).append("\n"); 
		query.append("   BETWEEN TO_DATE(@[search_dt_fr],'YYYY-MM-DD')" ).append("\n"); 
		query.append("       AND TO_DATE(@[search_dt_to],'YYYY-MM-DD')+0.999999" ).append("\n"); 
		...
		query.append("       AND TO_DATE(A.SAIL_ARR_DT,'YYYY-MM-DD')" ).append("\n"); 
		query.append("   BETWEEN TO_DATE(@[search_dt_fr],'YYYY-MM-DD')" ).append("\n"); 
		query.append("       AND TO_DATE(@[search_dt_to],'YYYY-MM-DD')" ).append("\n"); 
		...
		query.append("           A.AR_OFC_CD," ).append("\n"); 
		query.append("           A.AGN_CD," ).append("\n"); 
		query.append("		   DECODE(A.XCH_RT_APLY_LVL,'1',A.VVD_XCH_RT,'2',A.MON_XCH_RT,'4',A.MON_XCH_RT,A.DLY_XCH_RT)" ).append("\n"); 
