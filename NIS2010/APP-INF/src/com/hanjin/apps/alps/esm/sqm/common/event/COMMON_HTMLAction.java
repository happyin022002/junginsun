...
*@FileName       : COMMON_HTMLAction.java
*@FileTitle      : COMMON_HTMLAction
*Open Issues     :
*Change history  :
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.sqm.common 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class COMMON_HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	
	/**
	 * COMMON_HTMLAction 객체를 생성
	 */
	public COMMON_HTMLAction() {}
