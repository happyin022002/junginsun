...
*@FileName : EsmMas0029ViewAdapter.java
*@FileTitle : EsmMas0029ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0029 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmMas0029ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0029ViewAdapter(){
    	super();
    }
