...
*@FileName : RFANoteConversionProposalDBDAORsltNoteCtntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFANoteConversionProposalDBDAORsltNoteCtntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFANoteConversionProposalDBDAORsltNoteCtntListVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : RFANoteConversionProposalDBDAORsltNoteCtntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}