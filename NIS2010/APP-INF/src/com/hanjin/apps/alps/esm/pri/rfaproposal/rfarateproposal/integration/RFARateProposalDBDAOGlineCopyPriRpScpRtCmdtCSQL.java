...
*@FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOGlineCopyPriRpScpRtCmdtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOGlineCopyPriRpScpRtCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD,B.GLINE_SEQ,B.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD,B.GLINE_SEQ,B.CMDT_HDR_SEQ,B.CMDT_SEQ) AS CMDT_SEQ" ).append("\n"); 
