...
*@FileName : PRICommonDBDAORpScpLocationGroupNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAORpScpLocationGroupNmRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Guideline Group Loaction Name R
	  * </pre>
	  */
	public PRICommonDBDAORpScpLocationGroupNmRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAORpScpLocationGroupNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT PRC_GRP_LOC_DESC NM" ).append("\n"); 
		...
		query.append("AND (@[etc4] IS NULL OR ORG_DEST_TP_CD = 'B' OR ORG_DEST_TP_CD = @[etc4])" ).append("\n"); 
		query.append("AND PRC_GRP_LOC_CD = @[cd]" ).append("\n"); 
		query.append("AND EXISTS (SELECT 'OK'" ).append("\n"); 
		query.append("FROM PRI_RP_SCP_GRP_LOC_DTL S" ).append("\n"); 
