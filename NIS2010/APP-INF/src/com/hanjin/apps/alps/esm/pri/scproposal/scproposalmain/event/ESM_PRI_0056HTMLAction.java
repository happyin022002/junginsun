...
*@FileName : ESM_PRI_0056HTMLAction.java
...
public class ESM_PRI_0056HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0056HTMLAction 객체를 생성
	 */
	public ESM_PRI_0056HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0056Event event = new EsmPri0056Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCstPriSpHdrVO((CstPriSpHdrVO)getVO(request, CstPriSpHdrVO.class));
		}
