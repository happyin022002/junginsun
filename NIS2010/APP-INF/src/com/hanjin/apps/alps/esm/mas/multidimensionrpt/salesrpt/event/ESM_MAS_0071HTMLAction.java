 ...
 *@FileName 		: ESM_MAS_071HTMLAction.java
 ...
 *
 * @author Park Eun Ju 
 * @see ESM_MAS_070Event , ESM_MAS_070EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_MAS_0071HTMLAction extends HTMLActionSupport {
	 ...
	 */
	public ESM_MAS_0071HTMLAction() {
		//
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_MAS_070Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0071Event event = new EsmMas0071Event();
