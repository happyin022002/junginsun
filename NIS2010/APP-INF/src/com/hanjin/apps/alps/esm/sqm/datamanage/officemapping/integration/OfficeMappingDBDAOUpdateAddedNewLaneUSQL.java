...
*@FileName : OfficeMappingDBDAOUpdateAddedNewLaneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OfficeMappingDBDAOUpdateAddedNewLaneUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OfficeMappingDBDAOUpdateAddedNewLaneUSQL(){
		setQuery();
		...
		query.append("FileName : OfficeMappingDBDAOUpdateAddedNewLaneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SQM_QTA_NEW_LANE" ).append("\n"); 
