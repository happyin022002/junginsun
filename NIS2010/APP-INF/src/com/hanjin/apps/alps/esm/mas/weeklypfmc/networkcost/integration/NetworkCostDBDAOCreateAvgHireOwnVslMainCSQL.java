...
*@FileName : NetworkCostDBDAOCreateAvgHireOwnVslMainCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkCostDBDAOCreateAvgHireOwnVslMainCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AVG-hire by Own-VSL (PA) 의 정보를 생성한다.
	  * </pre>
	  */
	public NetworkCostDBDAOCreateAvgHireOwnVslMainCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkCostDBDAOCreateAvgHireOwnVslMainCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , @[f_year]||@[f_mon]" ).append("\n"); 
		query.append("    , '' " ).append("\n"); 
		query.append("    , '' " ).append("\n"); 
