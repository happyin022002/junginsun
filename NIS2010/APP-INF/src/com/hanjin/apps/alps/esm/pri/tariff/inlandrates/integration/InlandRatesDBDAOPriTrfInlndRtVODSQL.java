...
*@FileName : InlandRatesDBDAOPriTrfInlndRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRatesDBDAOPriTrfInlndRtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndRtVODSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRF_INLND_RT" ).append("\n"); 
		...
		query.append("#if (${main_del_yn} == 'N') " ).append("\n"); 
