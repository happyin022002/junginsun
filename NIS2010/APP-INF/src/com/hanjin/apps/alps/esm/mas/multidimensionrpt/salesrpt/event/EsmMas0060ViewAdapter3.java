...
*@FileName : EsmMas0060ViewAdapter3.java
*@FileTitle : EsmMas0060ViewAdapter3
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0060ViewAdapter3 extends DefaultViewAdapter {
	
    public EsmMas0060ViewAdapter3(){
    	super();
    }
