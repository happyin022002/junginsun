...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpRtCmdtCopyToProposal
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY B.QTTN_NO, B.QTTN_VER_NO, B.GEN_SPCL_RT_TP_CD, B.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("                          ORDER BY B.QTTN_NO, B.QTTN_VER_NO, B.GEN_SPCL_RT_TP_CD, B.CMDT_HDR_SEQ, B.CMDT_SEQ) AS CMDT_SEQ" ).append("\n"); 
		...
		query.append("    ,PRI_SQ_RT_CMDT B" ).append("\n"); 
		query.append("    ,PRI_SQ_MN C" ).append("\n"); 
		query.append("WHERE B.QTTN_NO = A.QTTN_NO" ).append("\n"); 
		query.append("AND   B.QTTN_VER_NO = A.QTTN_VER_NO" ).append("\n"); 
		query.append("AND   B.GEN_SPCL_RT_TP_CD = A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
