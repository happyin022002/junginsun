...
public class SalesRPTDBDAOSearchInqSrcDtTpsz0035ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2015.08.31 [CHM-201536992] 손진환 Split14-[그룹사 표준 코드 시행] HJS 프로그램 대응 및 데이타 마이그레이션 작업 요청
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("  , 'T/S_PORT' TS_PORT" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("    ,'CM_COST_$key' CM_COST_$key" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("        ,'CM2_COST_$key' CM2_COST_$key" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("			" ).append("\n"); 
		...
		query.append("	" ).append("\n"); 
		query.append("	#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("    ,'CM_$key' CM_$key" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("        ,'CM2_$key' CM2_$key" ).append("\n"); 
		query.append("        #end    " ).append("\n"); 
		query.append("    #end					" ).append("\n"); 
		query.append("			" ).append("\n"); 
		query.append("	#if(${f_pro_vw} =='P')" ).append("\n"); 
		query.append("	  ,'CM Total'	CM_TOTAL" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("        ,'CM2 Total'	CM2_TOTAL" ).append("\n"); 
		query.append("        #end  	  " ).append("\n"); 
		query.append("	#elseif (${f_pro_vw} =='R')		" ).append("\n"); 
		query.append("	  ,'BKG CM Total' CM_TOTAL" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("        ,'BKG CM2 Total' CM2_TOTAL" ).append("\n"); 
		query.append("        #end  	  " ).append("\n"); 
		query.append("	#end  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	  ,'DEM/DET' DMDT_COST" ).append("\n"); 
		query.append("	  " ).append("\n"); 
		query.append("	  #foreach($key in ${allcols}) " ).append("\n"); 
		query.append("      ,'OP_COST_$key' OP_COST_$key" ).append("\n"); 
		query.append("    #end	" ).append("\n"); 
		query.append("    ,'OP Cost Total' OP_COST_TOTAL" ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("    #foreach($key in ${allcols}) " ).append("\n"); 
		query.append("      ,'BKG OP_$key' BKG_OP_$key" ).append("\n"); 
		query.append("    #end	" ).append("\n"); 
		query.append("    ,'BKG OP Total'	 BKG_OP_TOTAL" ).append("\n"); 
		query.append("	#end  " ).append("\n"); 
		query.append("	  		" ).append("\n"); 
		...
		query.append("  ,CNEE_NM  /*CNEE*/   " ).append("\n"); 
		...
		query.append("  " ).append("\n"); 
		query.append("  #foreach($key in ${allcols}) " ).append("\n"); 
		query.append("    ,CM_COST_$key" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("         ,CM2_COST_$key" ).append("\n"); 
		query.append("        #end     " ).append("\n"); 
		query.append("  #end	" ).append("\n"); 
		query.append("   " ).append("\n"); 
		...
		query.append("        #end 	" ).append("\n"); 
		query.append("	#foreach($key in ${allcols}) 	 " ).append("\n"); 
		query.append("      ,CM_$key" ).append("\n"); 
		query.append("     #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("     ,CM2_$key" ).append("\n"); 
		query.append("	 #end    " ).append("\n"); 
		query.append("    #end		        " ).append("\n"); 
		query.append("	,CM_TOTAL 	" ).append("\n"); 
		query.append("	#if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("  	,CM2_TOTAL 	" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	#if(${f_pro_lvl} =='O' && ${f_pro_vw} =='R' )" ).append("\n"); 
		query.append("		,DMDT_COST " ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("      ,OP_COST_$key" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("		,OP_COST_TOTAL	" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("      ,BKG_OP_$key" ).append("\n"); 
		query.append("    #end	" ).append("\n"); 
		query.append("		,BKG_OP_TOTAL " ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		...
		query.append("  ,REPLACE(A2.SHPR_NM ,CHR(29),' ')                       AS BL_SHPR_NM  " ).append("\n"); 
		...
		query.append("  " ).append("\n"); 
		query.append("  #foreach($key in ${allcols}) " ).append("\n"); 
		query.append("    ,TO_CHAR(SUM(DECODE(A2.SPCL_CNTR_TPSZ_CD, '$key',  DECODE(@[f_pro_vw],'P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT)))) AS CM_COST_$key" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("         ,TO_CHAR(SUM(DECODE(A2.SPCL_CNTR_TPSZ_CD, '$key',  DECODE(@[f_pro_vw],'P',NVL(A2.OWN_FDR_AMT,0),'R',NVL(A2.OWN_FDR_AMT,0))))) AS CM2_COST_$key" ).append("\n"); 
		query.append("        #end     " ).append("\n"); 
		query.append("  #end	" ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append("	,TO_CHAR(SUM(DECODE(@[f_pro_vw],'P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT)))  AS CM_COST_TOTAL" ).append("\n"); 
		query.append("        #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("          ,TO_CHAR(SUM(DECODE(@[f_pro_vw],'P',NVL(A2.OWN_FDR_AMT,0),'R',NVL(A2.OWN_FDR_AMT,0))))  AS CM2_COST_TOTAL" ).append("\n"); 
		query.append("        #end 	" ).append("\n"); 
		query.append("	#foreach($key in ${allcols}) 	 " ).append("\n"); 
		query.append("      ,TO_CHAR(SUM(DECODE(A2.SPCL_CNTR_TPSZ_CD, '$key',  A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV-DECODE(@[f_pro_vw],'P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT)))) AS CM_$key" ).append("\n"); 
		query.append("     #if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("     ,TO_CHAR(SUM(DECODE(A2.SPCL_CNTR_TPSZ_CD, '$key',  A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV-DECODE(@[f_pro_vw],'P',(A2.PA_CM_COST_TTL_AMT + NVL(A2.OWN_FDR_AMT,0)),'R',(A2.RA_CM_COST_TTL_AMT+NVL(A2.OWN_FDR_AMT,0)) )))) AS CM2_$key" ).append("\n"); 
		query.append("	 #end    " ).append("\n"); 
		query.append("    #end		        " ).append("\n"); 
		query.append("	,TO_CHAR(SUM(A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV - DECODE(@[f_pro_vw],'P',A2.PA_CM_COST_TTL_AMT,'R',A2.RA_CM_COST_TTL_AMT)))  AS CM_TOTAL 	" ).append("\n"); 
		query.append("	#if (${f_pro_lvl} =='M')" ).append("\n"); 
		query.append("  	,TO_CHAR(SUM(A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV - DECODE(@[f_pro_vw],'P',(A2.PA_CM_COST_TTL_AMT + NVL(A2.OWN_FDR_AMT,0)) ,'R',(A2.RA_CM_COST_TTL_AMT+ NVL(A2.OWN_FDR_AMT,0)))))  AS CM2_TOTAL 	" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	#if(${f_pro_lvl} =='O' && ${f_pro_vw} =='R' )" ).append("\n"); 
		query.append("		,TO_CHAR(SUM(A2.DMDT_COM_AMT))  AS DMDT_COST " ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("      ,TO_CHAR(SUM(DECODE(A2.SPCL_CNTR_TPSZ_CD, '$key',  DECODE(@[f_pro_vw],'P',0,'R',A2.RA_OP_COST_TTL_AMT + A2.DMDT_COM_AMT)))) AS OP_COST_$key" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("		,TO_CHAR(SUM(DECODE(@[f_pro_vw],'P',0,'R',A2.RA_OP_COST_TTL_AMT + A2.DMDT_COM_AMT)))                              AS OP_COST_TOTAL	" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("      ,TO_CHAR(SUM(DECODE(A2.SPCL_CNTR_TPSZ_CD, '$key',  DECODE(@[f_pro_vw],'P',0,'R',(A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV) - A2.RA_CM_COST_TTL_AMT - A2.RA_OP_COST_TTL_AMT)))) AS BKG_OP_$key" ).append("\n"); 
		query.append("    #end	" ).append("\n"); 
		query.append("		,TO_CHAR(SUM(A2.BKG_REV+A2.BKG_OFT_REV+A2.BKG_MISC_REV+A2.SCR_CHG_REV) - SUM(NVL(A2.RA_CM_COST_TTL_AMT,0)) - SUM(NVL(A2.RA_OP_COST_TTL_AMT, 0)))                              AS BKG_OP_TOTAL " ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("  #if(${f_include_ts} =='Y' && ${f_rlane_cd} != 'RBCCO')" ).append("\n"); 
		...
		query.append("   MAX(CGO_RCV_DT) AS CGO_RCV_DT" ).append("\n"); 
		...
		query.append("    #end" ).append("\n"); 
		query.append("  #else			" ).append("\n"); 
		query.append("    AND DECODE(@[f_usr_ofc_lvl],'1',A4.OFC_N1ST_LVL_CD,'2',A4.OFC_N2ND_LVL_CD,'3',A4.OFC_N3RD_LVL_CD,'4',A4.OFC_N4TH_LVL_CD,'5',A4.OFC_N5TH_LVL_CD,'6',A4.OFC_N6TH_LVL_CD,'7',A4.OFC_N7TH_LVL_CD) IN (@[f_usr_ofc_cd], DECODE(SUBSTR(@[f_usr_ofc_cd], 1, 4), 'SHAR', 'SINRS', '')) " ).append("\n"); 
		query.append("  #end  " ).append("\n"); 
		query.append("" ).append("\n"); 
