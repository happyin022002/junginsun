...
*@FileName : ESM_AGT_0019HTMLAction.java
...
public class ESM_AGT_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0019HTMLAction 객체를 생성
	 */
	public ESM_AGT_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0019Event event = new EsmAgt0019Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGlEstmRevVvdVO((GlEstmRevVvdVO)getVO(request, GlEstmRevVvdVO .class));
		}
