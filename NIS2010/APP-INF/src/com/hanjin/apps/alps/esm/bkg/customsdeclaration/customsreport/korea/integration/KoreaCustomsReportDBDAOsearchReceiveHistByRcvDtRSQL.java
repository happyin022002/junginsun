...
*@FileName : KoreaCustomsReportDBDAOsearchReceiveHistByRcvDtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchReceiveHistByRcvDtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 관세청에서 수신된 응답문서들의 현황을 Receive Date로 조회
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchReceiveHistByRcvDtRSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchReceiveHistByRcvDtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , RLOG.RCV_SEQ RCV_SEQ" ).append("\n"); 
		...
		query.append("   AND RLOG.RCV_DT >= TO_DATE(@[from_dt]||'000000', 'YYYY-MM-DDHH24MISS') " ).append("\n"); 
		query.append("   AND RLOG.RCV_DT <= TO_DATE(@[to_dt]  ||'235959', 'YYYY-MM-DDHH24MISS')" ).append("\n"); 
