...
*@FileName : ESM_MAS_0178HTMLAction.java
...
public class ESM_MAS_0178HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0178HTMLAction 객체를 생성
	 */
	public ESM_MAS_0178HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0178Event event = new EsmMas0178Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchIasSubCdListVOS((SearchIasSubCdListVO[])getVOs(request, SearchIasSubCdListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchIasSubCdListVO((SearchIasSubCdListVO)getVO(request, SearchIasSubCdListVO .class));
		}
