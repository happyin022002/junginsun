...
public class UsCustSvcInstrsVO extends AbstractValueObject {
	...
	/* Column Info */
	private String instrRmkTpCd = null;
	...
	public UsCustSvcInstrsVO(String ibflag, String pagerows, String bkgNo, String instrRmkSeq, String instrRmk, String creUsrId, String updUsrId, String usrNm, String updLoclDt, String updLoclGdt, String ediEvntOfcCd, String instrRmkTpCd) {
		...
		this.instrRmkTpCd = instrRmkTpCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("instr_rmk_tp_cd", getInstrRmkTpCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("instr_rmk_tp_cd", "instrRmkTpCd");
	 ...
	 * @return instrRmkTpCd
	 */
	public String getInstrRmkTpCd() {
		return this.instrRmkTpCd;
	}
	 ...
	 * @param instrRmkTpCd
	 */
	public void setInstrRmkTpCd(String instrRmkTpCd) {
		this.instrRmkTpCd = instrRmkTpCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setInstrRmkTpCd(JSPUtil.getParameter(request, prefix + "instr_rmk_tp_cd", ""));
	}
	...
	public UsCustSvcInstrsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] instrRmkTpCd = (JSPUtil.getParameter(request, prefix + "instr_rmk_tp_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (instrRmkTpCd[i] != null)
					model.setInstrRmkTpCd(instrRmkTpCd[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.instrRmkTpCd = this.instrRmkTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
