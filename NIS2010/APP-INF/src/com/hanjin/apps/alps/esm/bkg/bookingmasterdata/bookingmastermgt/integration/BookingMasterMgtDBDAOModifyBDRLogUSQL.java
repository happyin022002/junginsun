...
*@FileName : BookingMasterMgtDBDAOModifyBDRLogUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingMasterMgtDBDAOModifyBDRLogUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BDR LOG 수정-Manual로 BDR을 처리하는 화면(UI_BKG-0596)
	  * </pre>
	  */
	public BookingMasterMgtDBDAOModifyBDRLogUSQL(){
		setQuery();
		...
		query.append("FileName : BookingMasterMgtDBDAOModifyBDRLogUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#elseif (${rdo_trunk_feeder} == 'F') " ).append("\n"); 
		query.append(",   FDR_BDR_CRE_USR_ID = @[upd_usr_id]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${ibflag} == 'D') " ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append(",	TRNK_MNL_BDR_FLG  = 'N'" ).append("\n"); 
		query.append(",	TRNK_MNL_BDR_DT = ''" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",	TRNK_BDR_FLG = 'N'	" ).append("\n"); 
		query.append(",	TRNK_AUTO_BDR_FLG = 'N'" ).append("\n"); 
		query.append(",	TRNK_AUTO_BDR_DT = ''" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append(",	FDR_MNL_BDR_FLG		= 'N'" ).append("\n"); 
		query.append(",	FDR_MNL_BDR_DT = ''" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",	FDR_BDR_FLG = 'N'	" ).append("\n"); 
		query.append(",	FDR_AUTO_BDR_FLG = 'N'	" ).append("\n"); 
		...
		query.append(",	TRNK_MNL_BDR_DT =SYSDATE" ).append("\n"); 
		query.append("	#elseif (${rdo_trunk_feeder} == 'F') " ).append("\n"); 
		query.append(",	FDR_BDR_FLG = 'Y'" ).append("\n"); 
		query.append(",	FDR_MNL_BDR_FLG		= 'Y'" ).append("\n"); 
		query.append(",	FDR_MNL_BDR_DT = SYSDATE" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
