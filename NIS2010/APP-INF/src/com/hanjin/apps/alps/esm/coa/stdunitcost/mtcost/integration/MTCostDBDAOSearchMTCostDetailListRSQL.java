...
public class MTCostDBDAOSearchMTCostDetailListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                           FROM COA_MTY_CNTR_ROUT_DTL A" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("           " ).append("\n"); 
		query.append("--===============================================================================  " ).append("\n"); 
		query.append("                    AND (COA_LOC_FNC(YD_CD2,'ECC') IN('USLGB','USLAX') " ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD3,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD4,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD5,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD6,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD7,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD8,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD9,'ECC') IN('USLGB','USLAX')" ).append("\n"); 
		query.append("                        OR COA_LOC_FNC(YD_CD10,'ECC') IN('USLGB','USLAX') )" ).append("\n"); 
		query.append("--===============================================================================  " ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("       GROUP BY COST_YRMON" ).append("\n"); 
		query.append("              , ECC_CD" ).append("\n"); 
