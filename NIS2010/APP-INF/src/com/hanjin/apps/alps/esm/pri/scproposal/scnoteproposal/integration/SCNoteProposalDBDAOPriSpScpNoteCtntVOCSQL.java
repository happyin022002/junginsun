...
*@FileName : SCNoteProposalDBDAOPriSpScpNoteCtntVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCNoteProposalDBDAOPriSpScpNoteCtntVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCNoteProposalDBDAOPriSpScpNoteCtntVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCNoteProposalDBDAOPriSpScpNoteCtntVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[chg_cd]" ).append("\n"); 
		query.append(",@[note_ctnt]" ).append("\n"); 
		query.append(",DECODE(@[note_conv_flg], '1', 'Y', 'N')" ).append("\n"); 
		query.append(",@[dp_seq]" ).append("\n"); 
		query.append(",@[note_conv_mapg_id]" ).append("\n"); 
		query.append(",@[note_chg_tp_cd]" ).append("\n"); 
