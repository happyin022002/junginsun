...
public class UserSetupMgtDBDAOaddInternetAuthCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    INSERT (USR_ID    , RGST_USR_ID   , RGST_DT, DELT_FLG, CRE_USR_ID, CRE_DT , UPD_USR_ID, UPD_DT, INET_AUTH_LMT_FLG)" ).append("\n"); 
		query.append("    VALUES (@[usr_id] , @[upd_usr_id] , SYSDATE, 'N'     , @[upd_usr_id] , SYSDATE, @[upd_usr_id] , SYSDATE , DECODE(@[inet_auth_lmt_flg],'1','Y','N'))" ).append("\n"); 
