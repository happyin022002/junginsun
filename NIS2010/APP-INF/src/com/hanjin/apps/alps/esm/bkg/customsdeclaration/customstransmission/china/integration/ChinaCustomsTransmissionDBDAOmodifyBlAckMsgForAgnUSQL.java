...
*@FileName : ChinaCustomsTransmissionDBDAOmodifyBlAckMsgForAgnUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChinaCustomsTransmissionDBDAOmodifyBlAckMsgForAgnUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaCustomsTransmissionDBDAOmodifyBlAckMsgForAgnUSQL(){
		setQuery();
		...
		query.append("FileName : ChinaCustomsTransmissionDBDAOmodifyBlAckMsgForAgnUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("   SET CHN_CSTMS_AGN_ACK_TP_CD = TRIM(@[chn_cstms_ack_tp_cd])," ).append("\n"); 
		query.append("       AGN_ACK_CTNT = TRIM(@[ack_ctnt])," ).append("\n"); 
		query.append("       AGN_ACK_UPD_DT = SYSDATE" ).append("\n"); 
		query.append("" ).append("\n"); 
