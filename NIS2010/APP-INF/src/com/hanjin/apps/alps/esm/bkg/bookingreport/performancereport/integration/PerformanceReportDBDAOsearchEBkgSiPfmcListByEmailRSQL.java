...
*@FileName : PerformanceReportDBDAOsearchEBkgSiPfmcListByEmailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOsearchEBkgSiPfmcListByEmailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_BKG_0235 : e-S/I Performance Report by e-Mail
	  * * 2013.03.11 [CHM-201323202] e-SVC Performance Report 항목 분리 요청
	  * </pre>
	  */
	public PerformanceReportDBDAOsearchEBkgSiPfmcListByEmailRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOsearchEBkgSiPfmcListByEmailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("--e-Booking & S/I by Email 실적 조회 " ).append("\n"); 
		query.append("--Booking Office, Kind of Report = Month" ).append("\n"); 
		query.append("--REPORT_TYPE:Booking Report, DURATION: M" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("     , COUNT(DISTINCT XX.BKG_NO) BKG_TTL" ).append("\n"); 
		query.append("     , SUM(SI_CNT) SI_TTL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                      AND BKG_NO = XX.BKG_NO), 0),0)) SI_EML" ).append("\n"); 
		...
		query.append("                      AND DOC_TP_CD = 'S'" ).append("\n"); 
		query.append("                      AND BKG_NO = XX.BKG_NO), 0),0)) SI_ULD" ).append("\n"); 
		...
		query.append("GROUP BY XX.DPCS, XX.BKG_OFC_CD, XX.DURATION, REG.REGION, GSO.GSO" ).append("\n"); 
		query.append("ORDER BY XX.DPCS, REG.REGION, GSO.GSO, XX.BKG_OFC_CD, XX.DURATION" ).append("\n"); 
