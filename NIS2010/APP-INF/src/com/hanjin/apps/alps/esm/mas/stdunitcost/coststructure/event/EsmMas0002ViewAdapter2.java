...
*@FileName : EsmMas0002ViewAdapter2.java
*@FileTitle : EsmMas0002ViewAdapter2
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0002ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmMas0002ViewAdapter2(){
    	super();
    }
