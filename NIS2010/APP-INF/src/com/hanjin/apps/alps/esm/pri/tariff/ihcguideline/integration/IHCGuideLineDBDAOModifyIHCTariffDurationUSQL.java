...
*@FileName : IHCGuideLineDBDAOModifyIHCTariffDurationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IHCGuideLineDBDAOModifyIHCTariffDurationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modify IHC Tariff Duation
	  * </pre>
	  */
	public IHCGuideLineDBDAOModifyIHCTariffDurationUSQL(){
		setQuery();
		...
		query.append("FileName : IHCGuideLineDBDAOModifyIHCTariffDurationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
