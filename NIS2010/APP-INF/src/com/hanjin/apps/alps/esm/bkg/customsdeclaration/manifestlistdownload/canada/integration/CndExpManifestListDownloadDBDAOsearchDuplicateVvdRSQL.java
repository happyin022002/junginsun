...
*@FileName : CndExpManifestListDownloadDBDAOsearchDuplicateVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchDuplicateVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchDuplicateVvdRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchDuplicateVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
