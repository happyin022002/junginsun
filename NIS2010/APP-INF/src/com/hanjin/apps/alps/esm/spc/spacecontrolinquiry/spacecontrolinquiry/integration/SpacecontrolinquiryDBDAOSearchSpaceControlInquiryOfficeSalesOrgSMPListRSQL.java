...
*@FileName : SpacecontrolinquiryDBDAOSearchSpaceControlInquiryOfficeSalesOrgSMPListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAOSearchSpaceControlInquiryOfficeSalesOrgSMPListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [ESM_SPC_0028] 성수기 by OFC 정보를 조회합니다.
	  ...
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAOSearchSpaceControlInquiryOfficeSalesOrgSMPListRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAOSearchSpaceControlInquiryOfficeSalesOrgSMPListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("               WHERE M.TRD_CD = P.TRD_CD" ).append("\n"); 
		...
		query.append("           (" ).append("\n"); 
		query.append("              SELECT LVL.OFC_LVL FROM SPC_OFC_LVL LVL WHERE LVL.OFC_CD = P.OFC_CD" ).append("\n"); 
		query.append("              AND SUBSTR(V.SLS_YRMON, 1, 4)||V.COST_WK BETWEEN LVL.OFC_APLY_FM_YRWK AND LVL.OFC_APLY_TO_YRWK" ).append("\n"); 
		...
		query.append("           NVL(DECODE(ACO.CTRL_ECC_FLG,'Y','C',DECODE(ACO.CTRL_LOC_FLG,'Y','L','N')),'N') AS CTRL_DEST, -- E = ECC, L = LOCATION" ).append("\n"); 
		...
		query.append("           P.OFC_LVL" ).append("\n"); 
		query.append("		   , BSE_QTR_CD" ).append("\n"); 
		query.append("		   , P.BSE_YR" ).append("\n"); 
		...
		query.append("       AND P.OFC_CD = M.SLS_RGN_OFC_CD" ).append("\n"); 
		query.append("     GROUP BY DECODE(SUBSTR(M.TRD_CD, 1, 1), 'I', 'I', 'O'), M.SLS_RGN_OFC_CD, CUST_CNT_CD, CUST_SEQ, CUST_CTRL_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("       DECODE(CUST_CTRL_CD, 'C', DECODE(USA_BKG_MOD_CD,'',MAX(BKG_QTA) OVER (PARTITION BY IOC_TS_CD, OFC_CD) - MAX(SMP) OVER (PARTITION BY IOC_TS_CD, OFC_CD),0) , SMP) AS SMP, -- 20140818 변경" ).append("\n"); 
		query.append("       (" ).append("\n"); 
		...
		query.append("           WHERE BAR.OFC_CD  = OFC_CD" ).append("\n"); 
		query.append("             AND BAR.POL_YD_CD = NVL(SUBSTR(POL_CD,1,5),' ')" ).append("\n"); 
		query.append("             AND BAR.POD_YD_CD = NVL(SUBSTR(POD_CD,1,5),' ')" ).append("\n"); 
		query.append("             -- 20140728 추가(S)" ).append("\n"); 
		query.append("             AND BAR.USA_BKG_MOD_CD = NVL(USA_BKG_MOD_CD,' ')" ).append("\n"); 
		query.append("             AND BAR.CUST_ACCT      = NVL(CUST_ACCT1     ,' ')" ).append("\n"); 
		query.append("             AND BAR.DEST_LOC_CD    = NVL(DEST_LOC_CD1   ,' ') " ).append("\n"); 
		query.append("             " ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("       CASE WHEN CUST_CTRL_CD IS NULL THEN 1" ).append("\n"); 
		query.append("            WHEN USA_BKG_MOD_CD IS NULL THEN 2" ).append("\n"); 
		query.append("            WHEN CUST_ACCT1 IS NULL THEN 3" ).append("\n"); 
		query.append("            WHEN POL_CD IS NULL THEN 4" ).append("\n"); 
		query.append("            WHEN POD_CD IS NULL THEN 5" ).append("\n"); 
		query.append("            WHEN DEST_LOC_CD1 IS NULL THEN 6" ).append("\n"); 
		query.append("            ELSE 7" ).append("\n"); 
		query.append("       END AS LVL," ).append("\n"); 
		query.append("       OFC_LVL,NVL(BKG_VOL_VGM,0) AS BKG_VOL_VGM,NVL(BKG_WGT_VGM,0) AS BKG_WGT_VGM" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        SELECT IOC_TS_CD," ).append("\n"); 
		query.append("               OFC_CD," ).append("\n"); 
		...
		query.append("               MAX(BKG_QTA)    AS BKG_QTA," ).append("\n"); 
		...
		query.append("               NVL(MAX(ALC_20),0)  AS ALC_20  ," ).append("\n"); 
		query.append("               NVL(MAX(ALC_40),0)  AS ALC_40  ," ).append("\n"); 
		...
		query.append("               MAX(FRM_VOL) AS FRM_VOL ," ).append("\n"); 
		query.append("               MAX(FRM_20)  AS FRM_20  ," ).append("\n"); 
		query.append("               MAX(FRM_40)  AS FRM_40  ," ).append("\n"); 
		query.append("               MAX(FRM_HC)  AS FRM_HC  ," ).append("\n"); 
		query.append("               MAX(FRM_45)  AS FRM_45  ," ).append("\n"); 
		query.append("               MAX(FRM_53)  AS FRM_53  ," ).append("\n"); 
		query.append("               MAX(FRM_RF)  AS FRM_RF  ," ).append("\n"); 
		query.append("               MAX(FRM_WGT) AS FRM_WGT ," ).append("\n"); 
		query.append("               MAX(FRM_D2)  AS FRM_D2  ," ).append("\n"); 
		query.append("               MAX(FRM_D4)  AS FRM_D4  ," ).append("\n"); 
		query.append("               MAX(FRM_RD)  AS FRM_RD  ,               " ).append("\n"); 
		query.append("               MAX(WAT_VOL) AS WAT_VOL ," ).append("\n"); 
		query.append("               MAX(WAT_20)  AS WAT_20  ," ).append("\n"); 
		query.append("               MAX(WAT_40)  AS WAT_40  ," ).append("\n"); 
		query.append("               MAX(WAT_HC)  AS WAT_HC  ," ).append("\n"); 
		query.append("               MAX(WAT_45)  AS WAT_45  ," ).append("\n"); 
		query.append("               MAX(WAT_53)  AS WAT_53  ," ).append("\n"); 
		query.append("               MAX(WAT_RF)  AS WAT_RF  ," ).append("\n"); 
		query.append("               MAX(WAT_WGT) AS WAT_WGT ," ).append("\n"); 
		query.append("               MAX(WAT_D2)  AS WAT_D2  ," ).append("\n"); 
		query.append("               MAX(WAT_D4)  AS WAT_D4  ," ).append("\n"); 
		query.append("               MAX(WAT_RD)  AS WAT_RD  ,               " ).append("\n"); 
		query.append("               MAX(CTRL_PORT) AS CTRL_PORT,    " ).append("\n"); 
		query.append("               MAX(OFC_LVL)   AS OFC_LVL,  " ).append("\n"); 
		query.append("			   MAX(BKG_VOL_VGM) AS BKG_VOL_VGM ," ).append("\n"); 
		query.append("               MAX(BKG_WGT_VGM) AS BKG_WGT_VGM " ).append("\n"); 
		query.append("          FROM (" ).append("\n"); 
		query.append("                SELECT IOC_TS_CD," ).append("\n"); 
		query.append("                       OFC_CD," ).append("\n"); 
		query.append("                       CUST_CTRL_CD," ).append("\n"); 
		...
		query.append("                       WAT_D4  ," ).append("\n"); 
		query.append("                       WAT_RD  ,                       " ).append("\n"); 
		query.append("                       NVL(CTRL_PORT,'N') AS CTRL_PORT," ).append("\n"); 
		query.append("                       --6 - (GU1 + GC1 + GP1 + GP2 + GD1) AS LVL," ).append("\n"); 
		query.append("                       OFC_LVL,BKG_VOL_VGM,BKG_WGT_VGM" ).append("\n"); 
		query.append("                  FROM (  " ).append("\n"); 
		...
		query.append("                                 SUM(Z.SMP) AS SMP," ).append("\n"); 
		...
		query.append("                                           P.CTRL_RD      ,NULL AS BKG_VOL_VGM,NULL AS BKG_WGT_VGM                                           " ).append("\n"); 
		...
		query.append("                                           NVL((SELECT MAX(CUST_CTRL_CD) -- 20130424 추가" ).append("\n"); 
		...
		query.append("                                                  AND Z.CUST_CNT_CD        = C.CUST_CNT_CD" ).append("\n"); 
		query.append("                                                  AND Z.CUST_SEQ           = C.CUST_SEQ" ).append("\n"); 
		query.append("                                                  AND NVL(Z.SC_NO, NVL(Z.RFA_NO,' ')) = NVL(C.SC_NO, NVL(C.RFA_NO,' '))" ).append("\n"); 
		query.append("                                                  --AND DECODE(P.TRD_CD, 'AES', NVL(Z.RFA_NO,' '), NVL(Z.SC_NO,' ')) = DECODE(P.TRD_CD, 'AES', NVL(C.RFA_NO,' '), NVL(C.SC_NO,NVL(Z.SC_NO,' ')))" ).append("\n"); 
		query.append("                                           ),'C') AS CUST_CTRL_CD," ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		query.append("                                           Z.USA_BKG_MOD_CD," ).append("\n"); 
		...
		query.append("                                           P.CTRL_RD      ,NULL AS BKG_VOL_VGM,NULL AS BKG_WGT_VGM" ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		query.append("                                      FROM SPC_ALOC_CUST_POL_POD Z," ).append("\n"); 
		query.append("                                           BASE             P" ).append("\n"); 
		...
		query.append("                                           CTRL_RD  ,BKG_VOL_VGM,BKG_WGT_VGM" ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("                                      FROM " ).append("\n"); 
		query.append("                                           (  SELECT " ).append("\n"); 
		query.append("                                                      OFC_CD" ).append("\n"); 
		...
		query.append("                                           " ).append("\n"); 
		query.append("                                           NULL AS BKG_QTA," ).append("\n"); 
		query.append("                                           ADJ_QTY AS SMP," ).append("\n"); 
		query.append("                                           NULL AS FCT_VOL," ).append("\n"); 
		query.append("                                           NULL AS FCT_HC ," ).append("\n"); 
		query.append("                                           NULL AS FCT_45 ," ).append("\n"); 
		query.append("                                           NULL AS FCT_53 ," ).append("\n"); 
		...
		query.append("                                           NULL AS FRM_WGT," ).append("\n"); 
		query.append("                                           -- 20140728 추가(S)" ).append("\n"); 
		query.append("                                           NULL AS FIRM_D2 ," ).append("\n"); 
		query.append("                                           NULL AS FIRM_D4 ," ).append("\n"); 
		query.append("                                           NULL AS FIRM_RD ," ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		query.append("                                           NULL AS WAT_VOL," ).append("\n"); 
		query.append("                                           NULL AS WAT_20 ," ).append("\n"); 
		query.append("                                           NULL AS WAT_40 ," ).append("\n"); 
		...
		query.append("                                           NULL AS WAT_RD ," ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		query.append("                                           NULL AS CTRL_PORT    ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_WGT     ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_40HC    ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_45HC    ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_53FT    ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_RF      ," ).append("\n"); 
		query.append("                                           NULL AS OFC_LVL      ," ).append("\n"); 
		query.append("                                           -- 20140728 추가(S)" ).append("\n"); 
		query.append("                                           NULL AS CTRL_D2  ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_D4  ," ).append("\n"); 
		query.append("                                           NULL AS CTRL_RD  ,NULL AS BKG_VOL_VGM,NULL AS BKG_WGT_VGM" ).append("\n"); 
		query.append("                                      FROM SMP_DATA" ).append("\n"); 
		query.append("                              ) Z" ).append("\n"); 
		query.append("                        GROUP BY GROUPING SETS (" ).append("\n"); 
		query.append("                                                 (Z.IOC_TS_CD, Z.OFC_CD, Z.CUST_CTRL_CD, Z.USA_BKG_MOD_CD, Z.CUST_ACCT, Z.POL_CD, Z.POD_CD, Z.DEST_LOC_CD)," ).append("\n"); 
		query.append("                                                 (Z.IOC_TS_CD, Z.OFC_CD, Z.CUST_CTRL_CD, Z.USA_BKG_MOD_CD, Z.CUST_ACCT, Z.POL_CD, Z.POD_CD)," ).append("\n"); 
		query.append("                                                 (Z.IOC_TS_CD, Z.OFC_CD, Z.CUST_CTRL_CD, Z.USA_BKG_MOD_CD, Z.CUST_ACCT, Z.POL_CD)," ).append("\n"); 
		query.append("                                                 (Z.IOC_TS_CD, Z.OFC_CD, Z.CUST_CTRL_CD, Z.USA_BKG_MOD_CD, Z.CUST_ACCT)," ).append("\n"); 
		query.append("                                                 (Z.IOC_TS_CD, Z.OFC_CD, Z.CUST_CTRL_CD, Z.USA_BKG_MOD_CD)," ).append("\n"); 
		query.append("                                                 (Z.IOC_TS_CD, Z.OFC_CD, Z.CUST_CTRL_CD)," ).append("\n"); 
		...
		query.append("          OFC_CD," ).append("\n"); 
		query.append("          NVL(CUST_CTRL_CD,'0')," ).append("\n"); 
		query.append("          NVL(USA_BKG_MOD_CD,'0')," ).append("\n"); 
		query.append("          NVL(CUST_ACCT1,'0')," ).append("\n"); 
		query.append("          NVL(POL_CD, '0')," ).append("\n"); 
		query.append("          NVL(POD_CD, '0')," ).append("\n"); 
		query.append("          NVL(DEST_LOC_CD1,'0')" ).append("\n"); 
		query.append("/*" ).append("\n"); 
		query.append("[CHM-201322502-01] SPC 프로젝트 - 성수기 선복운영 개선을 위한 T/F추진" ).append("\n"); 
		query.append("[Trouble Shooting] 진마리아 SC Join 오류 수정" ).append("\n"); 
