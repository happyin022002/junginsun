...
public class LaneSimulationDBDAOCreateSimSummaryReportAddAccntCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("MERGE INTO COA_SIM_SMRY_RPT D1" ).append("\n"); 
		...
		query.append("FROM COA_SIM_VSL_SET_INFO A1, COA_TM_CHTR_OUT_HIR A2" ).append("\n"); 
		...
		query.append(",COA_SIM_SMRY_RPT C2" ).append("\n"); 
		query.append("WHERE 1 = 1" ).append("\n"); 
