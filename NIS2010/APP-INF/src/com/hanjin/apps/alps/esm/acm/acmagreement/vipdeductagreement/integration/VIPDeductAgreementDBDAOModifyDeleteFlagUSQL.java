...
*@FileName : VIPDeductAgreementDBDAOModifyDeleteFlagUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VIPDeductAgreementDBDAOModifyDeleteFlagUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VIP Agreement delete flag check
	  * </pre>
	  */
	public VIPDeductAgreementDBDAOModifyDeleteFlagUSQL(){
		setQuery();
		...
		query.append("FileName : VIPDeductAgreementDBDAOModifyDeleteFlagUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
