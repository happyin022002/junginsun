...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtRoutVOAddCopyToQuotationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtCmdtRoutVOAddCopyToQuotationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtRoutVOAddCopyToQuotationCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtRoutVOAddCopyToQuotationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SQ_RT_CMDT_ROUT (" ).append("\n"); 
		...
		query.append(",	@[upd_usr_id]" ).append("\n"); 
		query.append(",	SYSDATE" ).append("\n"); 
		query.append("FROM    PRI_SQ_RT_CMDT_ROUT" ).append("\n"); 
		...
		query.append("AND	GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd_from]" ).append("\n"); 
