...
*@FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0033BSACapaListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSearchSpaceAllocation0033BSACapaListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSpaceAllocation0033BSACapaList
	  * 
	  * 2013.11.26 진마리아 [CHM-201326854] SAQ project로 인한 SPC 변경건_FNC 우선제거
	  * 2017.1.23 SM상선 전환에 따른 소스변경 
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSearchSpaceAllocation0033BSACapaListRSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSearchSpaceAllocation0033BSACapaListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT NVL(B.CRR_BSA_CAPA, 0)     AS CODE," ).append("\n"); 
		query.append("				NVL(B.CRR_BSA_CAPA, 0)     AS NAME" ).append("\n"); 
		...
		query.append("                 AND NOT (B.CRR_BSA_CAPA = 0 OR B.CRR_BSA_CAPA IS NULL) " ).append("\n"); 
