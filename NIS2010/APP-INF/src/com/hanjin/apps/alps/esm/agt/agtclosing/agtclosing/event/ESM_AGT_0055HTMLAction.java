...
*@FileName : ESM_AGT_0055HTMLAction.java
...
public class ESM_AGT_0055HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0032HTMLAction 객체를 생성
	 */
	public ESM_AGT_0055HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0055Event event = new EsmAgt0055Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEstmPerfRptListVO((EstmPerfRptListVO)getVO(request, EstmPerfRptListVO .class));
		}
