...
*@FileName : RsltPriSpBlplVO.java
*@FileTitle : RsltPriSpBlplVO
*Open Issues :
*Change history :
...
public class RsltPriSpBlplVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpBlplVO> models = new ArrayList<RsltPriSpBlplVO>();
	...
	/* Column Info */
	private String maxDpSeqCtnt = null;
	...
	public RsltPriSpBlplVO(String ibflag, String pagerows, String propNo, String amdtSeq, String blplSeq, String blplTitNm, String dpSeq, String n1stCmncAmdtSeq, String effDt, String expDt, String srcInfoCd, String srcInfoDtl, String prcProgStsCd, String prcProgStsDtl, String acptUsrId, String acptOfcCd, String acptDt, String maxDpSeq, String maxDpSeqCtnt) {
		...
		this.expDt = expDt;
		this.maxDpSeqCtnt = maxDpSeqCtnt;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("max_dp_seq", getMaxDpSeq());
		...
		this.hashColumns.put("max_dp_seq_ctnt", getMaxDpSeqCtnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("max_dp_seq", "maxDpSeq");
		...
		this.hashFields.put("max_dp_seq_ctnt", "maxDpSeqCtnt");
	 ...
	 * @return maxDpSeq
	 */
	public String getMaxDpSeq() {
		return this.maxDpSeq;
	}
	 ...
	 * @return maxDpSeqCtnt
	 */
	public String getMaxDpSeqCtnt() {
		return this.maxDpSeqCtnt;
	}
	 ...
	 * @param maxDpSeq
	 */
	public void setMaxDpSeq(String maxDpSeq) {
		this.maxDpSeq = maxDpSeq;
	}
	 ...
	 * @param maxDpSeqCtnt
	 */
	public void setMaxDpSeqCtnt(String maxDpSeqCtnt) {
		this.maxDpSeqCtnt = maxDpSeqCtnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMaxDpSeq(JSPUtil.getParameter(request, prefix + "max_dp_seq", ""));
		setBlplSeq(JSPUtil.getParameter(request, prefix + "blpl_seq", ""));
		...
		setMaxDpSeqCtnt(JSPUtil.getParameter(request, prefix + "max_dp_seq_ctnt", ""));
	}
	 ...
	 */
	public RsltPriSpBlplVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpBlplVO[]
	 */
	public RsltPriSpBlplVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpBlplVO model = null;
		...
		try {
			...
			String[] maxDpSeq = (JSPUtil.getParameter(request, prefix	+ "max_dp_seq", length));
			...
			String[] maxDpSeqCtnt = (JSPUtil.getParameter(request, prefix	+ "max_dp_seq_ctnt", length));
			
			for (int i = 0; i < length; i++) {
				model = new RsltPriSpBlplVO();
				if (dpSeq[i] != null)
				...
				if (maxDpSeqCtnt[i] != null)
					model.setMaxDpSeqCtnt(maxDpSeqCtnt[i]);
				models.add(model);
			}
	 ...
	 * @return RsltPriSpBlplVO[]
	 */
	public RsltPriSpBlplVO[] getRsltPriSpBlplVOs(){
		RsltPriSpBlplVO[] vos = (RsltPriSpBlplVO[])models.toArray(new RsltPriSpBlplVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.maxDpSeq = this.maxDpSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.maxDpSeqCtnt = this.maxDpSeqCtnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
