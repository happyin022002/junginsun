...
*@FileName : SearchLaneOfficeListVO.java
*@FileTitle : SearchLaneOfficeListVO
*Open Issues :
*Change history :
...
public class SearchLaneOfficeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchLaneOfficeListVO> models = new ArrayList<SearchLaneOfficeListVO>();
	...
	public SearchLaneOfficeListVO() {}

	public SearchLaneOfficeListVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String dirCd, String rhqCd, String rgnOfcCd, String sqmActFlg, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String subTrdCd, String fUsrId) {
		this.rhqCd = rhqCd;
...
/**
	 ...
	 * @param request
	 * @return SearchLaneOfficeListVO[]
	 */
	public SearchLaneOfficeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchLaneOfficeListVO[]
	 */
	public SearchLaneOfficeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchLaneOfficeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchLaneOfficeListVO();
				if (rhqCd[i] != null)
		...
		return getSearchLaneOfficeListVOs();
	}
	...
	public SearchLaneOfficeListVO[] getSearchLaneOfficeListVOs(){
		SearchLaneOfficeListVO[] vos = (SearchLaneOfficeListVO[])models.toArray(new SearchLaneOfficeListVO[models.size()]);
		return vos;
	}
