...
*@FileName : ESM_BKG_1064HTMLAction.java
...
public class ESM_BKG_1064HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1064HTMLAction 객체를 생성
	 */
	public ESM_BKG_1064HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1064Event event = new EsmBkg1064Event();
		

		if(command.isCommand(FormCommand.COMMAND01)) {			
			PkupNoRptEmlUpldVO req = new PkupNoRptEmlUpldVO();
			
			req.setEmlFrom(JSPUtil.getParameter(request, "rail_cd"));
			req.setPkupNoRptEmlCtntVOs((PkupNoRptEmlCtntVO[])getVOs(request, PkupNoRptEmlCtntVO.class, "sheet1_"));
			
			event.setPkupNoRptEmlUpldVO(req);			
		}
		else if(command.isCommand(FormCommand.COMMAND02)) {			
			event.setPkupNoRptVOs((PkupNoRptVO[])getVOs(request, PkupNoRptVO.class, "sheet1_"));
		}
