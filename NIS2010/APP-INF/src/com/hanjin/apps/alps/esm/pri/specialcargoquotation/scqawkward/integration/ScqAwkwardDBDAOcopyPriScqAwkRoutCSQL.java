...
*@FileName : ScqAwkwardDBDAOcopyPriScqAwkRoutCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOcopyPriScqAwkRoutCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqAwkwardDBDAOcopyPriScqAwkRoutCSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOcopyPriScqAwkRoutCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,   @[cre_usr_id]" ).append("\n"); 
		query.append("    ,   SYSDATE" ).append("\n"); 
		query.append("FROM    PRI_SCQ_AWK_ROUT_TMP" ).append("\n"); 
