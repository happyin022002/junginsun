...
* 2013.10.01 전윤주 [CHM-201326927] act_rat_flg, auto_rat_flg 추가
...
public class PriScgRtVO extends AbstractValueObject {
	...
	/* Column Info */
	private String scgRqstProcCd = null;
	/* Column Info */
	private String scgRqstStsCd = null;
	/* Column Info */
	private String scgRqstSeq = null;
	/* Column Info */
	...
	public PriScgRtVO(String ibflag, String pagerows, String svcScpCd, String chgCd, String scgSeq, String effDt, String orgEffDt, String orgExpDt, String expDt, String subTrdCd, String vslSlanCd, String porTpCd, String porDefCd, String polTpCd, String polDefCd, String podTpCd, String podDefCd, String delTpCd, String delDefCd, String tsPortCd, String tmlCd, String orgTrspModCd, String destTrspModCd, String usaSvcModCd, String prcRcvTermCd, String prcDeTermCd, String prcHngrBarTpCd, String dirCallFlg, String minCgoWgt, String maxCgoWgt, String cmdtCd, String scgGrpCmdtCd, String prcCgoTpCd, String scgImdgClssCd, String ratUtCd, String currCd, String scgAmt, String payTermCd, String wdrFlg, String socFlg, String ioGaCd, String deltFlg, String scgRmk, String cnlTzCd, String scgCrteDyKnt, String scgPrdTpCd, String scgPrdCrteCd, String psaNo, String rcAirCondTpCd, String ctrtDt, String actRatFlg, String autoRatFlg, String prnHdnFlg, String steCd, String cntCd, String fdGrdFlg, String arrDt, String creUsrId, String creDt, String updUsrId, String updDt, String lvl1, String lvl2, String lvl3, String lvl4, String seq, String updUsrNm, String scgRqstProcCd, String scgRqstStsCd, String scgRqstSeq, String rqstUsrId, String rqstDt, String aproUsrId, String aproDt, String trdCd, String cd, String nm) {
		this.scgRmk = scgRmk;
		...
		this.arrDt = arrDt;
		this.scgRqstProcCd = scgRqstProcCd;
		this.scgRqstStsCd = scgRqstStsCd;
		this.scgRqstSeq = scgRqstSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("org_eff_dt", getOrgEffDt());
		...
		this.hashColumns.put("scg_rqst_proc_cd", getScgRqstProcCd());
		this.hashColumns.put("scg_rqst_sts_cd", getScgRqstStsCd());
		this.hashColumns.put("scg_rqst_seq", getScgRqstSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("org_eff_dt", "orgEffDt");
		...
		this.hashFields.put("scg_rqst_proc_cd", "scgRqstProcCd");
		this.hashFields.put("scg_rqst_sts_cd", "scgRqstStsCd");
		this.hashFields.put("scg_rqst_seq", "scgRqstSeq");
	 ...
	 * @return orgEffDt
	 */
	public String getOrgEffDt() {
		return this.orgEffDt;
	}
	...
	/**
	 * Column Info
	 * @return scgRqstProcCd
	 */
	public String getScgRqstProcCd() {
		return this.scgRqstProcCd;
	}
	 ...
	 * @return scgRqstStsCd
	 */
	public String getScgRqstStsCd() {
		return this.scgRqstStsCd;
	}
	 ...
	 * @return scgRqstSeq
	 */
	public String getScgRqstSeq() {
		return this.scgRqstSeq;
	}
	 ...
	 * @param orgEffDt
	 */
	public void setOrgEffDt(String orgEffDt) {
		this.orgEffDt = orgEffDt;
	}
	 ...
	 * @param scgRqstProcCd
	 */
	public void setScgRqstProcCd(String scgRqstProcCd) {
		this.scgRqstProcCd = scgRqstProcCd;
	}
	 ...
	 * @param scgRqstStsCd
	 */
	public void setScgRqstStsCd(String scgRqstStsCd) {
		this.scgRqstStsCd = scgRqstStsCd;
	}
	 ...
	 * @param scgRqstSeq
	 */
	public void setScgRqstSeq(String scgRqstSeq) {
		this.scgRqstSeq = scgRqstSeq;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRcAirCondTpCd(JSPUtil.getParameter(request, prefix + "rcAirCondTpCd", ""));
		setCtrtDt(JSPUtil.getParameter(request, prefix + "ctrtDt", ""));
		setActRatFlg(JSPUtil.getParameter(request, prefix + "actRatFlg", ""));
		setAutoRatFlg(JSPUtil.getParameter(request, prefix + "autoRatFlg", ""));
		setPrnHdnFlg(JSPUtil.getParameter(request, prefix + "prnHdnFlg", ""));
		setSteCd(JSPUtil.getParameter(request, prefix + "steCd", ""));
		setCntCd(JSPUtil.getParameter(request, prefix + "cntCd", ""));
		setFdGrdFlg(JSPUtil.getParameter(request, prefix + "fdGrdFlg", ""));
		...
		setOrgEffDt(JSPUtil.getParameter(request, prefix + "org_eff_dt", ""));
		...
		setScgRqstProcCd(JSPUtil.getParameter(request, prefix + "scg_rqst_proc_cd", ""));
		setScgRqstStsCd(JSPUtil.getParameter(request, prefix + "scg_rqst_sts_cd", ""));
		setScgRqstSeq(JSPUtil.getParameter(request, prefix + "scg_rqst_seq", ""));
	...
	public PriScgRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] orgEffDt = (JSPUtil.getParameter(request, prefix	+ "org_eff_dt", length));
			...
			String[] scgRqstProcCd = (JSPUtil.getParameter(request, prefix	+ "scg_rqst_proc_cd", length));
			String[] scgRqstStsCd = (JSPUtil.getParameter(request, prefix	+ "scg_rqst_sts_cd", length));
			String[] scgRqstSeq = (JSPUtil.getParameter(request, prefix	+ "scg_rqst_seq", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (scgRqstProcCd[i] != null)
					model.setScgRqstProcCd(scgRqstProcCd[i]);
				if (scgRqstStsCd[i] != null)
					model.setScgRqstStsCd(scgRqstStsCd[i]);
				if (scgRqstSeq[i] != null)
					model.setScgRqstSeq(scgRqstSeq[i]);
				if (rqstUsrId[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.orgEffDt = this.orgEffDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.scgRqstProcCd = this.scgRqstProcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.scgRqstStsCd = this.scgRqstStsCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.scgRqstSeq = this.scgRqstSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
