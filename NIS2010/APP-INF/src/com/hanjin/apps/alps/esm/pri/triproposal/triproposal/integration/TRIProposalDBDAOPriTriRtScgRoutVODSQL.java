...
*@FileName : TRIProposalDBDAOPriTriRtScgRoutVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgRoutVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRI_RT_SCG_ROUT Delete
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgRoutVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgRoutVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_SCG_ROUT" ).append("\n"); 
