...
public class CndCustomsTransmissionDBDAOsearchMinClptSeqRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          ,DECODE(NVL(MIN(VVD.VSL_CD), 'SMXX'), 'SMXX', 'N', 'SMYY', 'N', 'SMZZ', 'N', 'Y') AS VSL_SKD_FLG" ).append("\n"); 
		...
		query.append("    SELECT MIN(CLPT_SEQ) AS CLPT_SEQ" ).append("\n"); 
		query.append("          ,DECODE(SUBSTR(@[vvd_cd],1,4), 'SMXX', 'N', 'SMYY', 'N', 'SMZZ', 'N', 'Y') AS VSL_SKD_FLG" ).append("\n"); 
