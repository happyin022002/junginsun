...
*@FileName : AusSearchBlChargeTotalVO.java
*@FileTitle : AusSearchBlChargeTotalVO
*Open Issues :
*Change history :
...
public class AusSearchBlChargeTotalVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AusSearchBlChargeTotalVO> models = new ArrayList<AusSearchBlChargeTotalVO>();
	...
	public AusSearchBlChargeTotalVO() {}

	public AusSearchBlChargeTotalVO(String ibflag, String pagerows, String ppdTotal, String cctTotal, String totalCur) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return AusSearchBlChargeTotalVO[]
	 */
	public AusSearchBlChargeTotalVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusSearchBlChargeTotalVO[]
	 */
	public AusSearchBlChargeTotalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusSearchBlChargeTotalVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AusSearchBlChargeTotalVO();
				if (ibflag[i] != null)
		...
		return getAusSearchBlChargeTotalVOs();
	}
	 ...
	 * @return AusSearchBlChargeTotalVO[]
	 */
	public AusSearchBlChargeTotalVO[] getAusSearchBlChargeTotalVOs(){
		AusSearchBlChargeTotalVO[] vos = (AusSearchBlChargeTotalVO[])models.toArray(new AusSearchBlChargeTotalVO[models.size()]);
		return vos;
	}
