...
*@FileName : BSAYearlyPlanDBDAOMultiBsaBudJntOpCrrCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOMultiBsaBudJntOpCrrCapaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSA_BUD_JNT_OP_CRR_CAPA Merge
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOMultiBsaBudJntOpCrrCapaCSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOMultiBsaBudJntOpCrrCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BSA_BUD_JNT_OP_CRR_CAPA A" ).append("\n"); 
