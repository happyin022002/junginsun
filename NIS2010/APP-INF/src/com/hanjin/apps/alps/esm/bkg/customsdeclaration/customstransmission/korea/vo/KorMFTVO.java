...
public class KorMFTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorMFTVO> models = new ArrayList<KorMFTVO>();
	...
	public KorMFTVO(String ibflag, String pagerows, String mrnNo, String sndDt, String mrnChkNo) {
		this.ibflag = ibflag;
	 ...
	 * @return KorMFTVO[]
	 */
	public KorMFTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorMFTVO[]
	 */
	public KorMFTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorMFTVO model = null;
	 ...
	 * @return KorMFTVO[]
	 */
	public KorMFTVO[] getKorMFTVOs(){
		KorMFTVO[] vos = (KorMFTVO[])models.toArray(new KorMFTVO[models.size()]);
		return vos;
	}
