...
*@FileName : PerformanceReportDBDAOAddQueueHistoryByAutoUploadCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOAddQueueHistoryByAutoUploadCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * WEB SI Auto Upload 처리된 Queue의 Input History 기록
	  * </pre>
	  */
	public PerformanceReportDBDAOAddQueueHistoryByAutoUploadCSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOAddQueueHistoryByAutoUploadCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     ) SR_HIS_SEQ," ).append("\n"); 
		query.append("     'ID' SR_STS_CD," ).append("\n"); 
		...
		query.append("     'HOMEPAGE' ATND_USR_ID," ).append("\n"); 
		...
		query.append("     'HOMEPAGE' CRE_USR_ID," ).append("\n"); 
		query.append("     SYSDATE CRE_DT," ).append("\n"); 
		query.append("     'HOMEPAGE' UPD_USR_ID," ).append("\n"); 
