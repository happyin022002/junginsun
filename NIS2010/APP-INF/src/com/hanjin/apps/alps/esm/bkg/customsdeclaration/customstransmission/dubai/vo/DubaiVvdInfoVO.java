...
public class DubaiVvdInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DubaiVvdInfoVO> models = new ArrayList<DubaiVvdInfoVO>();
...
/**
	 ...
	 * @return VvdInfoVO[]
	 */
	public DubaiVvdInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VvdInfoVO[]
	 */
	public DubaiVvdInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DubaiVvdInfoVO model = null;
	 ...
	 * @return VvdInfoVO[]
	 */
	public DubaiVvdInfoVO[] getVvdInfoVOs(){
		DubaiVvdInfoVO[] vos = (DubaiVvdInfoVO[])models.toArray(new DubaiVvdInfoVO[models.size()]);
		return vos;
	}
