...
*@FileName : PriTrfRuleHistoryVO.java
*@FileTitle : PriTrfRuleHistoryVO
*Open Issues :
*Change history :
...
public class PriTrfRuleHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriTrfRuleHistoryVO> models = new ArrayList<PriTrfRuleHistoryVO>();
	...
	public PriTrfRuleHistoryVO() {}

	public PriTrfRuleHistoryVO(String ibflag, String pagerows, String trfPfxCd, String trfNo, String trfRuleNo, String amdtSeq, String trfRuleNm, String trfRuleCtnt, String trfRuleChgCd, String trfRuleAmdtTpCd, String effDt, String expDt, String pubDt, String rqstOfcCd, String aproOfcCd, String trfRuleStsCd, String creUsrId, String creDt, String updUsrId, String updDt, String accessDt, String ruleNo, String ruleNm) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRuleNo(JSPUtil.getParameter(request, prefix + "rule_no", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setTrfRuleAmdtTpCd(JSPUtil.getParameter(request, prefix + "trf_rule_amdt_tp_cd", ""));
		setEffDt(JSPUtil.getParameter(request, prefix + "eff_dt", ""));
		setRuleNm(JSPUtil.getParameter(request, prefix + "rule_nm", ""));
	 ...
	 */
	public PriTrfRuleHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriTrfRuleHistoryVO[]
	 */
	public PriTrfRuleHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriTrfRuleHistoryVO model = null;
		...
		try {
			...
			String[] ruleNo = (JSPUtil.getParameter(request, prefix	+ "rule_no", length));
			...
			String[] ruleNm = (JSPUtil.getParameter(request, prefix	+ "rule_nm", length));
		...
		return getPriTrfRuleHistoryVOs();
	}
	 ...
	 * @return PriTrfRuleHistoryVO[]
	 */
	public PriTrfRuleHistoryVO[] getPriTrfRuleHistoryVOs(){
		PriTrfRuleHistoryVO[] vos = (PriTrfRuleHistoryVO[])models.toArray(new PriTrfRuleHistoryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ruleNo = this.ruleNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ruleNm = this.ruleNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
