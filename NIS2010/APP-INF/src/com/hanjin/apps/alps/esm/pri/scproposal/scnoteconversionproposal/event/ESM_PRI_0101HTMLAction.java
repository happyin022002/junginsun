...
*@FileName : ESM_PRI_0101HTMLAction.java
...
public class ESM_PRI_0101HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0101HTMLAction 객체를 생성
	 */
	public ESM_PRI_0101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0101Event event = new EsmPri0101Event();
