...
*@FileName : RFARateProposalDBDAOPriRpScpRtVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,	FIC_PROP_RT_AMT = @[fic_prop_rt_amt]" ).append("\n"); 
		query.append("		,	COFFR_FRT_RT_AMT = @[coffr_frt_rt_amt]" ).append("\n"); 
		query.append("		,	FIC_COFFR_RT_AMT = @[fic_coffr_rt_amt]" ).append("\n"); 
		query.append("		,	FNL_FRT_RT_AMT = @[fnl_frt_rt_amt]" ).append("\n"); 
		query.append("		,	FIC_FNL_RT_AMT = @[fic_fnl_rt_amt]" ).append("\n"); 
		query.append("		,	OPTM_TRSP_MOD_FLG = NVL(@[optm_trsp_mod_flg], 'N')" ).append("\n"); 
		query.append("		,	FIC_RT_USE_STS_CD = NVL(@[fic_rt_use_sts_cd], 'X')" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("		,	FIC_FNL_RT_AMT = DECODE(@[prc_prog_sts_cd], 'A', FIC_PROP_RT_AMT, 'I', NULL)" ).append("\n"); 
		...
		query.append("#if (${fic_gline_rt_amt}!='')" ).append("\n"); 
		query.append("		,	FIC_GLINE_RT_AMT = DECODE(@[fic_gline_rt_amt], 'N/A', NULL,  NVL(@[fic_gline_rt_amt], NULL))" ).append("\n"); 
		query.append("		,	FIC_GLINE_UPD_DT = DECODE(@[fic_gline_rt_amt], 'N/A', NULL, SYSDATE)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${fic_org_gline_rt_amt}!='')" ).append("\n"); 
		query.append("		,	FIC_ORG_GLINE_RT_AMT = DECODE(@[fic_org_gline_rt_amt], 'N/A', NULL, NVL(@[fic_org_gline_rt_amt], NULL))" ).append("\n"); 
		query.append("		,	FIC_ORG_GLINE_UPD_DT = DECODE(@[fic_org_gline_rt_amt], 'N/A', NULL, SYSDATE)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${fic_dest_gline_rt_amt} != '')" ).append("\n"); 
		query.append("		,	FIC_DEST_GLINE_RT_AMT = DECODE(@[fic_dest_gline_rt_amt], 'N/A', NULL, NVL(@[fic_dest_gline_rt_amt], NULL))" ).append("\n"); 
		query.append("		,	FIC_DEST_GLINE_UPD_DT = DECODE(@[fic_dest_gline_rt_amt], 'N/A', NULL, SYSDATE)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
