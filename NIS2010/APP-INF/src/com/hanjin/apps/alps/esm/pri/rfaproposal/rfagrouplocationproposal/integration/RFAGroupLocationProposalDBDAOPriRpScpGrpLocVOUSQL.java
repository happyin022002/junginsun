...
*@FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationProposalDBDAOPriRpScpGrpLocVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationProposalDBDAOPriRpScpGrpLocVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationProposalDBDAOPriRpScpGrpLocVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RP_SCP_GRP_LOC SET" ).append("\n"); 
		query.append("ORG_DEST_TP_CD   = NVL(@[org_dest_tp_cd],ORG_DEST_TP_CD)," ).append("\n"); 
