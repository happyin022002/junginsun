...
* 
* =========================================================*/
package com.hanjin.apps.alps.esm.agt.agtcalculation.agtcalc.integration;
...
//2011.07.07 이정수 R4J		ResultSet rs06 = null;			// DB ResultSet
...
//2011.07.07 이정수 R4J		PreparedStatement ps06 = null;	// 정적파싱을 지원하는 SQL Statement
		...
		selectQuery03.append("   AND NVL (a.slan_cd, '*') = 'ALL' \n");
		...
		finally
		{
			...
			closeResultSet(rs04);
			closeResultSet(rs05);
//2011.07.07 이정수 R4J			closeResultSet(rs06);
			closeResultSet(rs10);
			closeStatement(ps);
			closeStatement(ps01);
			closeStatement(ps02);
			...
			closeStatement(ps04);
			closeStatement(ps05);
//2011.07.07 이정수 R4J			closeStatement(ps06);
			closeStatement(ps07);
			closeStatement(ps08);
			closeStatement(ps09);
			closeStatement(ps10);
	...
	public HashMap searchAGTFinanceAccountInfo(HashMap agtMap) throws DAOException
	{
		...
		try
		{
			...
			double og_comm_amt = 0; //CHU: 서남아 BROKERAGE 계산을 위해 사용
...
//2011.07.07 이정수 R4J							og_comm_amt = Double.parseDouble(checkNull((String) actMap.get("OG_COMM_AMOUNT")) == "" ? "0" : (String) actMap.get("OG_COMM_AMOUNT"));
							og_comm_amt = Double.parseDouble("".equals(checkNull((String) actMap.get("OG_COMM_AMOUNT"))) ? "0" : (String) actMap.get("OG_COMM_AMOUNT"));
							if (!checkNull((String) actMap.get("COMM_PROC_STS_RSN")).equals(""))
							{
								log.debug("\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"+
										"\n// 에러처리" +
	...
	public HashMap<String, String> getAGTAGMTMasterInfo(Connection con, String ar_ofc_cd, String finc_ofc_cd, String eff_dt, String bkg_no, String io_bnd_cd, String ac_tp_cd) throws DAOException
	{
		...
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            -- * 2009-12-29 : CHM-200901976 : 두바이 현지법인 전환 관련 하드코딩 요청(2010년 01월01일 이후 DXBBA는 DXBBB로 변경) \n");
		selectQuery01.append("                            WHEN INP.FINC_OFC_CD = 'DXBBA' \n");
		selectQuery01.append("                             AND INP.SAIL_ARR_DT > '20091231' \n");
		selectQuery01.append("                            THEN 'DXBBB' \n");
		selectQuery01.append("                            WHEN INP.FINC_OFC_CD = 'DXBBB' \n");
		selectQuery01.append("                             AND INP.SAIL_ARR_DT < '20100101' \n");
		selectQuery01.append("                            THEN 'DXBBA' \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            -- * 2009-07-22 : N200907030050 : AR Office 관련하여 BOMBA 는 BOMBB 로 변경 \n");
		selectQuery01.append("                            WHEN INP.AR_OFC_CD   = 'BOMBA' \n");
		selectQuery01.append("                            THEN 'BOMBB' \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            ELSE INP.FINC_OFC_CD \n");
		selectQuery01.append("                             END                                      AS FINC_OFC_CD, \n");
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            -- * 2009-12-29 : CHM-200901976 : 두바이 현지법인 전환 관련 하드코딩 요청(2010년 01월01일 이후 DXBBA는 DXBBB로 변경) \n");
		selectQuery01.append("                            WHEN INP.AR_OFC_CD   = 'DXBBA' \n");
		selectQuery01.append("                             AND INP.SAIL_ARR_DT > '20091231' \n");
		selectQuery01.append("                            THEN 'DXBBB' \n");
		selectQuery01.append("                            WHEN INP.AR_OFC_CD   = 'DXBBB' \n");
		selectQuery01.append("                             AND INP.SAIL_ARR_DT < '20100101' \n");
		selectQuery01.append("                            THEN 'DXBBA' \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            -- * 2009-07-22 : N200907030050 : AR Office 관련하여 BOMBA 는 BOMBB 로 변경 \n");
		...
		selectQuery01.append("                            THEN 'BOMBB' \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            ELSE INP.AR_OFC_CD \n");
		selectQuery01.append("                             END                                      AS AR_OFC_CD, \n");
		selectQuery01.append("                                 INP.SAIL_ARR_DT, \n");
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            -- * (kevin) 2009-04-13 : N200904090070 : TPEBB 대리점비 재계산 요청 \n");
		selectQuery01.append("                            -- * (kevin) 2009-04-08 TPEBB의 경우 2009-03-01 이전 데이터는 Vendor Sequence를 '183214' → '103755' 변경. \n");
		selectQuery01.append("                            -- * 시스템은 구조적으로 한 계약이 두개의 Vendor을 갖지 못하게 되어 있으므로 이렇게 하드코딩 함. \n");
		selectQuery01.append("                            WHEN INP.FINC_OFC_CD = 'TPEBB' \n");
		selectQuery01.append("                             AND INP.SAIL_ARR_DT < '20090301' \n");
		selectQuery01.append("                            THEN 103755 \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            -- * 20100601 -- CDA-CS 요청으로 추가 \n");
		selectQuery01.append("                            -- * 1. 일본지점 Shimizu 지역 총대리점 승계(양도) 사유 \n");
		selectQuery01.append("                            -- *    1) 현 Shimizu 대리점인 Ashai Kaiun은 합작형태로 운영되는 업체이며 \n");
		selectQuery01.append("                            -- *       (Suzuyo 50%, Amano Kaisoten 20% & Aoki Trans 30%), Shimizu지역에서의 지속적인 \n");
		selectQuery01.append("                            -- *       Handling volume 감소로 인한 적자 누적으로, 불가피하게 2010. 5월 31일부로 \n");
		selectQuery01.append("                            -- *       폐업예정이며, Ashai Kaiun는 모회사인 Aoki Trans로 흡수합병. \n");
		selectQuery01.append("                            -- *    2) 현행 대리점 계약을 동일한 조건으로 Ashai Kaiun의 모회사인 Aoki Trans가 승계 (주소 및 Tel No 동일) \n");
		selectQuery01.append("                            -- * \n");
		selectQuery01.append("                            -- * 2. 요청사항 \n");
		selectQuery01.append("                            -- *    2010년 6월 1일 부 SMZBS 대리점 업체가 ASAHI KAIUN(Vendor code: 113728) 에서 \n");
		selectQuery01.append("                            -- *    Aoki Trans(Vendor code: 105636) 으로 변경 되는 바 동사항을 MDM Office Detail에 반영 부탁드립니다. \n");
		selectQuery01.append("                            -- *    참고로 Vendor 코드를 제외하고는 기존과 동일하게 반영 부탁드립니다. \n");
		selectQuery01.append("                            WHEN INP.FINC_OFC_CD = 'SMZBS' \n");
		selectQuery01.append("                             AND INP.SAIL_ARR_DT < '20100601' \n");
		selectQuery01.append("                            THEN 113728 \n");
		selectQuery01.append("                            -------------------------------------------------------------------------------------------------------------------- \n");
		selectQuery01.append("                            ELSE NULL \n");
		selectQuery01.append("                             END                                      AS VNDR_SEQ \n");
...
//		selectQuery05.append("     AND cre_usr_id != 'COST' \n");
	...
	public HashMap searchAGTAGMTRateInfo(Connection con, HashMap actMap, HashMap agtMap) throws DAOException
	{
		...
		selectQuery01.append("                             AND QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		selectQuery01.append("                             AND \n");
		selectQuery01.append("                               ( \n");
		...
		selectQuery01.append("                             AND BK2.BL_NO_TP            <>  '9' \n");
		...
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            WHEN 'BSLBA' = MDI.MODI_OFC_CD \n");
		selectQuery01.append("                            THEN 'BSLBA' \n");
		selectQuery01.append("                            WHEN 'GLWBA' = POL.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN 'GLWBA' \n");
		selectQuery01.append("                            ELSE AGT_OFC_NEW_OLD_FNC (POR.FINC_CTRL_OFC_CD) \n");
		selectQuery01.append("                             END                                                                       AS POR_FINC_CTRL_OFC_CD, \n");
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            WHEN 'BSLBA' = MDI.MODI_OFC_CD \n");
		selectQuery01.append("                            THEN MDO.AR_OFC_CD \n");
		selectQuery01.append("                            WHEN 'GLWBA' = POL.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (OOL.AR_OFC_CD) \n");
		selectQuery01.append("                            ELSE AGT_OFC_NEW_OLD_FNC (OOR.AR_OFC_CD) \n");
		selectQuery01.append("                             END                                                                       AS POR_AR_OFC_CD, \n");
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            WHEN 'BSLBA' = MDI.MODI_OFC_CD \n");
		selectQuery01.append("                            THEN MDO.AP_OFC_CD \n");
		selectQuery01.append("                            WHEN 'GLWBA' = POL.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (OOL.AP_OFC_CD) \n");
		selectQuery01.append("                            ELSE AGT_OFC_NEW_OLD_FNC (OOR.AP_OFC_CD) \n");
		...
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (POL.FINC_CTRL_OFC_CD)                            AS POL_FINC_CTRL_OFC_CD, \n");
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (OOL.AR_OFC_CD)                                   AS POL_AR_OFC_CD, \n");
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (OOL.AP_OFC_CD)                                   AS POL_AP_OFC_CD, \n");
		...
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (POD.FINC_CTRL_OFC_CD)                            AS POD_FINC_CTRL_OFC_CD, \n");
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (OOD.AR_OFC_CD)                                   AS POD_AR_OFC_CD, \n");
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (OOD.AP_OFC_CD)                                   AS POD_AP_OFC_CD, \n");
		...
		selectQuery01.append("                            THEN 'GLWBA' \n");
		selectQuery01.append("                            ELSE AGT_OFC_NEW_OLD_FNC (DEL.FINC_CTRL_OFC_CD) \n");
		selectQuery01.append("                             END                                                                       AS DEL_FINC_CTRL_OFC_CD, \n");
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            WHEN 'BUDBB' = BRT.CLT_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (DAR.AR_OFC_CD) \n");
		selectQuery01.append("                            WHEN 'BUDBB' = POD.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (OOD.AR_OFC_CD) \n");
		selectQuery01.append("                            WHEN 'GLWBA' = POD.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (OOD.AR_OFC_CD) \n");
		selectQuery01.append("                            ELSE AGT_OFC_NEW_OLD_FNC (OEL.AR_OFC_CD) \n");
		selectQuery01.append("                             END                                                                       AS DEL_AR_OFC_CD, \n");
		selectQuery01.append("                            CASE \n");
		selectQuery01.append("                            WHEN 'BUDBB' = BRT.CLT_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (DAR.AP_OFC_CD) \n");
		selectQuery01.append("                            WHEN 'BUDBB' = POD.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (OOD.AP_OFC_CD) \n");
		selectQuery01.append("                            WHEN 'GLWBA' = POD.FINC_CTRL_OFC_CD \n");
		selectQuery01.append("                            THEN AGT_OFC_NEW_OLD_FNC (OOD.AP_OFC_CD) \n");
		selectQuery01.append("                            ELSE AGT_OFC_NEW_OLD_FNC (OEL.AP_OFC_CD) \n");
		...
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (BKG.BKG_OFC_CD)                                  AS BKG_OFC_CD, \n");
		selectQuery01.append("                                 MDI.MODI_OFC_CD                                                       AS BKG_FINC_CTRL_OFC_CD, \n");
		selectQuery01.append("                                 MDO.AR_OFC_CD                                                         AS BKG_AR_OFC_CD, \n");
		selectQuery01.append("                                 MDL.LOC_CD                                                            AS BKG_OFC_LOC_CD, \n");
		selectQuery01.append("                                 NVL (AGT_OFC_NEW_OLD_FNC (BKG.OB_SLS_OFC_CD), BKG.OB_SLS_OFC_CD)    AS BKG_SLS_OFC_CD, \n");
		selectQuery01.append("                                 NVL (AGT_OFC_NEW_OLD_FNC (BKG.OB_SLS_OFC_CD), BKG.OB_SLS_OFC_CD)    AS BKG_SLS_FINC_CTRL_OFC_CD, \n");
		...
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (DECODE (BRT.CLT_OFC_CD, 'BSLBA', DAR.AR_OFC_CD, BRT.CLT_OFC_CD )) AS BSL_DEL_AR_OFC_CD, \n");
		selectQuery01.append("                                 AGT_OFC_NEW_OLD_FNC (DECODE (BRT.CLT_OFC_CD, 'BSLBA', DAR.AP_OFC_CD, BRT.CLT_OFC_CD )) AS BSL_DEL_AP_OFC_CD, \n");
		...
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (BRT.CLT_OFC_CD)       = DAR.OFC_CD(+) \n");
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (BKG.BKG_OFC_CD)       = MDI.OFC_CD(+) \n");
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (BKG.OB_SLS_OFC_CD)    = SLS.OFC_CD(+) \n");
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (POR.FINC_CTRL_OFC_CD) = OOR.OFC_CD(+) \n");
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (POL.FINC_CTRL_OFC_CD) = OOL.OFC_CD(+) \n");
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (POD.FINC_CTRL_OFC_CD) = OOD.OFC_CD(+) \n");
		selectQuery01.append("                             AND AGT_OFC_NEW_OLD_FNC (DEL.FINC_CTRL_OFC_CD) = OEL.OFC_CD(+) \n");
	...
	public HashMap processAGTBKGCancelInfo(HashMap actMap, String bkg_no) throws DAOException
	{
		...
		insertQuery02.append("                                       AND QT2.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		...
		insertQuery02.append("                                       AND BK2.BL_NO_TP               <>  '9' \n");
		...
		insertQuery02.append("                                       AND BKG.BKG_NO                   = AGN.BKG_NO \n");
		insertQuery02.append("                              ) \n");
		insertQuery02.append("                            AND QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
...
//		selectQuery02.append("   AND bkg_no_split = ? \n");
	...
	public double searchAGTChargeDecdutionInfoWithCharge(Connection con, HashMap actMap, String repChgCd) throws DAOException
	{
		...
		insertQuery.append("                                                   AND BK2.BL_NO_TP               <>  '9' \n");
		insertQuery.append("                                                   AND BK2.BKG_STS_CD             <>  'X' \n");
		insertQuery.append("                                                   AND BKG.BKG_NO                   = INP.BKG_NO \n");
		insertQuery.append("                                          ) \n");
		insertQuery.append("                                        AND QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		insertQuery.append("--[END]-------------------------------------------------------------------------------------------------- \n");
		insertQuery.append("--[JUSTIFICATION]---------------------------------------------------------------------------------------- \n");
...
//		insertQuery01.append("                          , SUM(a.trsp_lvl) trsp_lvl \n");
		// 2011.06.09 over size error 수정.
		insertQuery01.append("                          , MAX(a.trsp_lvl) trsp_lvl \n");
...
//		insertQuery01.append("                          , DECODE(ltrim(a.n2nd_nod_cd), null, 0, 1) + DECODE(ltrim(a.n3rd_nod_cd), null, 0, 1) + DECODE(ltrim(a.n4th_nod_cd), null, 0, 1)  trsp_lvl \n");
		...
		insertQuery01.append("                          ( \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       ? AS CHG_APLY_AREA_CD \n");
		insertQuery01.append("                                  FROM DUAL \n");
		insertQuery01.append("                          ) INP \n");
		insertQuery01.append("                      WHERE a.bkg_no = ? \n");
		insertQuery01.append("                        AND a.stnd_cost_cd = b.stnd_cost_cd \n");
		insertQuery01.append("                        AND DECODE (a.rout_tz_mod_cd, 'WD', 'F', 'H') = ? \n");
		insertQuery01.append("                        AND b.coa_cost_src_prt_cd = 'CO' \n");
//		insertQuery01.append("                        AND b.sgrp_cost_cd_desc = 'Full Trans' \n");
		insertQuery01.append("                        AND b.stnd_cost_cd in('51102000','51301011','51301021','51301031','51301041','51301051','51301061','51301081') \n");
		insertQuery01.append("                        AND EXISTS \n");
		insertQuery01.append("                          ( \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- BKG.POR에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_BOOKING BKG \n");
		insertQuery01.append("                                 WHERE BKG.BKG_NO = a.BKG_NO \n");
		insertQuery01.append("                                   AND BKG.POR_CD \n");
		insertQuery01.append("                                    IN \n");
		insertQuery01.append("                                     ( \n");
		insertQuery01.append("                                       SUBSTR (a.NOD_CD, 1, 5), \n");
		insertQuery01.append("                                       SUBSTR (a.TO_NOD_CD, 1, 5) \n");
		insertQuery01.append("                                     ) \n");
		insertQuery01.append("                                   AND INP.CHG_APLY_AREA_CD = 'O' \n");
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- BKG.POL에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_BOOKING BKG \n");
		insertQuery01.append("                                 WHERE BKG.BKG_NO = a.BKG_NO \n");
		insertQuery01.append("                                   AND BKG.POL_CD \n");
		insertQuery01.append("                                    IN \n");
		insertQuery01.append("                                     ( \n");
		insertQuery01.append("                                       SUBSTR (a.NOD_CD, 1, 5), \n");
		insertQuery01.append("                                       SUBSTR (a.TO_NOD_CD, 1, 5) \n");
		...
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- VVD.POL(Origin)에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_VVD BVV \n");
		insertQuery01.append("                                 WHERE BVV.BKG_NO         = a.BKG_NO \n");
		insertQuery01.append("                                   AND BVV.VSL_PRE_PST_CD = 'S' \n");
		insertQuery01.append("                                   AND BVV.POL_CD \n");
		insertQuery01.append("                                    IN \n");
		insertQuery01.append("                                     ( \n");
		insertQuery01.append("                                       SUBSTR (a.NOD_CD, 1, 5), \n");
		insertQuery01.append("                                       SUBSTR (a.TO_NOD_CD, 1, 5) \n");
		...
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- VVD.POD(Origin)에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_VVD BVV \n");
		insertQuery01.append("                                 WHERE BVV.BKG_NO         = a.BKG_NO \n");
		insertQuery01.append("                                   AND BVV.VSL_PRE_PST_CD = 'S' \n");
		insertQuery01.append("                                   AND BVV.POL_CD \n");
		...
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- Full Pickup Yard에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_BOOKING BKG \n");
		insertQuery01.append("                                 WHERE BKG.BKG_NO = a.BKG_NO \n");
		insertQuery01.append("                                   AND SUBSTR (BKG.FULL_PKUP_YD_CD, 1, 5) = SUBSTR (a.NOD_CD, 1, 5) \n");
		insertQuery01.append("                                   AND INP.CHG_APLY_AREA_CD = 'O' \n");
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- BKG.POD에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_BOOKING BKG \n");
		insertQuery01.append("                                 WHERE BKG.BKG_NO = a.BKG_NO \n");
		insertQuery01.append("                                   AND BKG.POD_CD \n");
		insertQuery01.append("                                    IN \n");
		insertQuery01.append("                                     ( \n");
		insertQuery01.append("                                       SUBSTR (a.NOD_CD, 1, 5), \n");
		insertQuery01.append("                                       SUBSTR (a.TO_NOD_CD, 1, 5) \n");
		insertQuery01.append("                                     ) \n");
		insertQuery01.append("                                   AND INP.CHG_APLY_AREA_CD = 'D' \n");
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- BKG.DEL에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_BOOKING BKG \n");
		insertQuery01.append("                                 WHERE BKG.BKG_NO = a.BKG_NO \n");
		insertQuery01.append("                                   AND BKG.DEL_CD \n");
		insertQuery01.append("                                    IN \n");
		insertQuery01.append("                                     ( \n");
		insertQuery01.append("                                       SUBSTR (a.NOD_CD, 1, 5), \n");
		insertQuery01.append("                                       SUBSTR (a.TO_NOD_CD, 1, 5) \n");
		...
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- VVD.POL(Destination)에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_VVD BVV \n");
		insertQuery01.append("                                 WHERE BVV.BKG_NO         = a.BKG_NO \n");
		insertQuery01.append("                                   AND BVV.VSL_PRE_PST_CD = 'U' \n");
		insertQuery01.append("                                   AND BVV.POL_CD \n");
		insertQuery01.append("                                    IN \n");
		insertQuery01.append("                                     ( \n");
		insertQuery01.append("                                       SUBSTR (a.NOD_CD, 1, 5), \n");
		...
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- VVD.POD(Destination)에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_VVD BVV \n");
		insertQuery01.append("                                 WHERE BVV.BKG_NO         = a.BKG_NO \n");
		insertQuery01.append("                                   AND BVV.VSL_PRE_PST_CD = 'U' \n");
		insertQuery01.append("                                   AND BVV.POL_CD \n");
		...
		insertQuery01.append("                             UNION ALL \n");
		insertQuery01.append("                                SELECT \n");
		insertQuery01.append("                                       1                                      -- Empty Return Yard에서 발생한 TRSP건 추출 \n");
		insertQuery01.append("                                  FROM BKG_BOOKING BKG \n");
		insertQuery01.append("                                 WHERE BKG.BKG_NO = a.BKG_NO \n");
		insertQuery01.append("                                   AND SUBSTR (BKG.MTY_RTN_YD_CD, 1, 5) = SUBSTR (a.TO_NOD_CD, 1, 5) \n");
		insertQuery01.append("                                   AND INP.CHG_APLY_AREA_CD = 'D' \n");
		insertQuery01.append("                          ) \n");
		insertQuery01.append("                   GROUP BY a.bkg_no \n");
		insertQuery01.append("                          , a.coa_cost_src_cd \n");
...
//2011.07.07 이정수 R4J			double total_sum_oft = Double.parseDouble(checkNull((String)actMap.get("TOTAL_SUM_OFT"))==""? "0":(String)actMap.get("TOTAL_SUM_OFT"));
			double total_sum_oft = Double.parseDouble("".equals(checkNull((String)actMap.get("TOTAL_SUM_OFT"))) ? "0":(String)actMap.get("TOTAL_SUM_OFT"));
//2011.07.07 이정수 R4J			double sum_chg_ddct_amt = Double.parseDouble(checkNull((String)actMap.get("SUM_CHG_DDCT_AMT"))==""? "0":(String)actMap.get("SUM_CHG_DDCT_AMT"));
			double sum_chg_ddct_amt = Double.parseDouble("".equals(checkNull((String)actMap.get("SUM_CHG_DDCT_AMT"))) ? "0":(String)actMap.get("SUM_CHG_DDCT_AMT"));
//2011.07.07 이정수 R4J			double sum_fee_amt = Double.parseDouble(checkNull((String)actMap.get("SUM_FEE_AMT"))==""? "0":(String)actMap.get("SUM_FEE_AMT"));
			double sum_fee_amt = Double.parseDouble("".equals(checkNull((String)actMap.get("SUM_FEE_AMT"))) ? "0":(String)actMap.get("SUM_FEE_AMT"));
//2011.07.07 이정수 R4J			double sum_dra_amt = Double.parseDouble(checkNull((String)actMap.get("SUM_DRA_AMT"))==""? "0":(String)actMap.get("SUM_DRA_AMT"));
			double sum_dra_amt = Double.parseDouble("".equals(checkNull((String)actMap.get("SUM_DRA_AMT"))) ? "0":(String)actMap.get("SUM_DRA_AMT"));
//2011.07.07 이정수 R4J			double bkg_comm_rt = (Double.parseDouble(checkNull((String)actMap.get("BKG_COMM_RT"))==""? "0":(String)actMap.get("BKG_COMM_RT"))) / 100;
			double bkg_comm_rt = (Double.parseDouble("".equals(checkNull((String)actMap.get("BKG_COMM_RT"))) ? "0":(String)actMap.get("BKG_COMM_RT"))) / 100;
...
//2011.07.07 이정수 R4J			double addinAmt = Double.parseDouble(checkNull((String)actMap.get("ADDIN_AMT"))==""? "0":(String)actMap.get("ADDIN_AMT"));
			double addinAmt = Double.parseDouble("".equals(checkNull((String)actMap.get("ADDIN_AMT"))) ? "0":(String)actMap.get("ADDIN_AMT"));
//			double box_qty = Double.parseDouble(checkNull((String)actMap.get("BOX_QTY"))==""? "0":(String)actMap.get("BOX_QTY"));
//2011.07.07 이정수 R4J			double fx_comm_amt = Double.parseDouble(checkNull((String)actMap.get("FX_COMM_AMT"))==""? "0":(String)actMap.get("FX_COMM_AMT"));
			double fx_comm_amt = Double.parseDouble("".equals(checkNull((String)actMap.get("FX_COMM_AMT"))) ? "0":(String)actMap.get("FX_COMM_AMT"));
			
			double comm_conv_amount = 0;	// JP 이나 아닐때 환율 컨버전값
//2011.07.07 이정수 R4J			double agn_agmt_rt = Double.parseDouble(checkNull((String)actMap.get("AGN_AGMT_RT"))==""? "0":(String)actMap.get("AGN_AGMT_RT")); 		// Insert 시 agn_agmt_rt 컬럼 insert 값
			double agn_agmt_rt = Double.parseDouble("".equals(checkNull((String)actMap.get("AGN_AGMT_RT"))) ? "0":(String)actMap.get("AGN_AGMT_RT")); 
			
			double usd_locl_xch_rt = 0;		// Insert 시 vvd_xch_rt, mon_xhc_rt, dly_xch_rt  컬럼 insert 값
			double og_comm_amount = 0; //CHU: 서남아 BROKERAGE 계산을 위해 사용
			double og_cmpn_amount = 0; //CHU: 남미 서안 BROKERAGE 계산을 위해 사용
//2011.07.07 이정수 R4J			String og_comm_amount_str = checkNull((String)actMap.get("OG_COMM_AMOUNT"))==""? "0":(String)actMap.get("OG_COMM_AMOUNT");
			String og_comm_amount_str = "".equals(checkNull((String)actMap.get("OG_COMM_AMOUNT"))) ? "0":(String)actMap.get("OG_COMM_AMOUNT");
			
			if (!og_comm_amount_str.equals(""))
			{
				og_comm_amount = Double.parseDouble(og_comm_amount_str);
			}
			og_cmpn_amount = calcCompansationAmount(con, bkg_no);
			...
			if (curr_cd.equals("USD"))
			{
				if (io_bnd_cd.equals("O") && ac_tp_cd.equals("G"))
				{
					 ...
					 //* Outbound시 POL의 location Code 가 SINWA 산하 Office 이고, POD의 Conti Code가 E(유럽)인 경우
					 //* Inbound시  POD의 location Code 가 SINWA 산하 Office 이고, POL의 Conti Code가 E(유럽)인 경우
					comm_amount = (total_sum_oft + addinAmt - (og_comm_amount + og_cmpn_amount + sum_chg_ddct_amt + sum_fee_amt + sum_dra_amt)) * bkg_comm_rt;
//					comm_amount = (total_sum_oft - (og_comm_amount + sum_chg_ddct_amt + sum_fee_amt + sum_dra_amt)) * bkg_comm_rt;
					...
					log.debug("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
							...
							+ "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
							+ "comm_amount("+comm_amount+") = total_sum_oft("+total_sum_oft+") - (og_comm_amount("+og_comm_amount+") + og_cmpn_amount("+og_cmpn_amount+") + sum_chg_ddct_amt("+sum_chg_ddct_amt+") + sum_fee_amt("+sum_fee_amt+") + sum_dra_amt("+sum_dra_amt+")) * bkg_comm_rt("+bkg_comm_rt+")"
							+ "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
							);
				}
				else
...
//					comm_amount = (total_sum_oft + addinAmt - (sum_chg_ddct_amt + sum_fee_amt + sum_dra_amt)) * bkg_comm_rt;
			...
			{
//2011.07.07 이정수 R4J				double og_comm_amt = Double.parseDouble(checkNull((String)actMap.get("OG_COMM_AMOUNT"))==""? "0":(String)actMap.get("OG_COMM_AMOUNT"));
				double og_comm_amt = Double.parseDouble("".equals(checkNull((String)actMap.get("OG_COMM_AMOUNT"))) ? "0":(String)actMap.get("OG_COMM_AMOUNT"));
...
//2011.07.07 이정수 R4J			double agn_agmt_rt = Double.parseDouble(checkNull((String)actMap.get("AGN_AGMT_RT"))==""? "0":(String)actMap.get("AGN_AGMT_RT"));
			double agn_agmt_rt = Double.parseDouble("".equals(checkNull((String)actMap.get("AGN_AGMT_RT"))) ? "0":(String)actMap.get("AGN_AGMT_RT"));
...
//			}
	...
	public HashMap createAGTBKGCommInfo(Connection con, HashMap actMap) throws DAOException
	{
		...
		ResultSet rs01 = null; // DB ResultSet
		ResultSet rs02 = null; // DB ResultSet
//2011.11.28 이정수 R4J-Null Dereferencing 수정		ResultSet rs03 = null; // DB ResultSet
		PreparedStatement selectPs01 = null; // 정적파싱을 지원하는 SQL Statement
		PreparedStatement selectPs02 = null; // 정적파싱을 지원하는 SQL Statement
//2011.11.28 이정수 R4J-Null Dereferencing 수정		PreparedStatement selectPs03 = null; // 정적파싱을 지원하는 SQL Statement
		PreparedStatement insertPs01 = null; // 정적파싱을 지원하는 SQL Statement
		PreparedStatement deletePs01 = null; // 정적파싱을 지원하는 SQL Statement
		PreparedStatement deletePs02 = null; // 정적파싱을 지원하는 SQL Statement
		...
		try
		{
			...
			if (!curr_cd.equals("USD"))
			{
//2011.07.07 이정수 R4J				act_comm_amt = Double.parseDouble(checkNull((String) actMap.get("COMM_CONV_AMOUNT")) == "" ? "0" : (String) actMap.get("COMM_CONV_AMOUNT"));
				act_comm_amt = Double.parseDouble("".equals(checkNull((String) actMap.get("COMM_CONV_AMOUNT")))  ? "0" : (String) actMap.get("COMM_CONV_AMOUNT"));
//2011.07.07 이정수 R4J				act_locl_comm_amt = Double.parseDouble(checkNull((String) actMap.get("COMM_AMOUNT")) == "" ? "0" : (String) actMap.get("COMM_AMOUNT"));
				act_locl_comm_amt = Double.parseDouble("".equals(checkNull((String) actMap.get("COMM_AMOUNT")))  ? "0" : (String) actMap.get("COMM_AMOUNT"));
			...
			{
//2011.07.07 이정수 R4J				act_comm_amt = Double.parseDouble(checkNull((String) actMap.get("COMM_AMOUNT")) == "" ? "0" : (String) actMap.get("COMM_AMOUNT"));
				act_comm_amt = Double.parseDouble("".equals(checkNull((String) actMap.get("COMM_AMOUNT")))  ? "0" : (String) actMap.get("COMM_AMOUNT"));
//2011.07.07 이정수 R4J				act_locl_comm_amt = Double.parseDouble(checkNull((String) actMap.get("COMM_CONV_AMOUNT")) == "" ? "0" : (String) actMap.get("COMM_CONV_AMOUNT"));
				act_locl_comm_amt = Double.parseDouble("".equals(checkNull((String) actMap.get("COMM_CONV_AMOUNT")))  ? "0" : (String) actMap.get("COMM_CONV_AMOUNT"));
			...
			if ((curr_cd.equals("USD") && (act_if_comm_amt) != 0) || (!curr_cd.equals("USD") && (act_if_locl_comm_amt) != 0)) {
				...
				{
//2011.07.07 이정수 R4J					insertPs01.setDouble(i++, roundValue(Double.parseDouble(checkNull((String) actMap.get("SUM_CHG_DDCT_AMT")) == "" ? "0" : (String) actMap.get("SUM_CHG_DDCT_AMT")) + Double.parseDouble(checkNull((String) actMap.get("OG_COMM_AMOUNT")) == "" ? "0" : (String) actMap.get("OG_COMM_AMOUNT"))));
					insertPs01.setDouble(i++, roundValue(Double.parseDouble("".equals(checkNull((String) actMap.get("SUM_CHG_DDCT_AMT"))) ? "0" : (String) actMap.get("SUM_CHG_DDCT_AMT")) + Double.parseDouble("".equals(checkNull((String) actMap.get("OG_COMM_AMOUNT"))) ? "0" : (String) actMap.get("OG_COMM_AMOUNT"))));

				}
				else
				{
//2011.07.07 이정수 R4J					insertPs01.setDouble(i++, roundValue(Double.parseDouble(checkNull((String) actMap.get("SUM_CHG_DDCT_AMT")) == "" ? "0" : (String) actMap.get("SUM_CHG_DDCT_AMT"))));
					insertPs01.setDouble(i++, roundValue(Double.parseDouble("".equals(checkNull((String) actMap.get("SUM_CHG_DDCT_AMT"))) ? "0" : (String) actMap.get("SUM_CHG_DDCT_AMT")) + Double.parseDouble("".equals(checkNull((String) actMap.get("OG_COMM_AMOUNT"))) ? "0" : (String) actMap.get("OG_COMM_AMOUNT"))));

				}

//2011.07.07 이정수 R4J				insertPs01.setDouble(i++, roundValue(Double.parseDouble("".equals(checkNull((String) actMap.get("SUM_FEE_AMT"))) ? "0" : (String) actMap.get("SUM_FEE_AMT"))));
				insertPs01.setDouble(i++, roundValue(Double.parseDouble("".equals(checkNull((String) actMap.get("SUM_FEE_AMT"))) ? "0" : (String) actMap.get("SUM_FEE_AMT"))));
				
//2011.07.07 이정수 R4J				insertPs01.setDouble(i++, roundValue(Double.parseDouble(checkNull((String) actMap.get("SUM_DRA_AMT")) == "" ? "0" : (String) actMap.get("SUM_DRA_AMT"))));
				insertPs01.setDouble(i++, roundValue(Double.parseDouble("".equals(checkNull((String) actMap.get("SUM_DRA_AMT"))) ? "0" : (String) actMap.get("SUM_DRA_AMT"))));
				
				String ac_tp_cd = checkNull((String) actMap.get("AC_TP_CD"));
				if (ac_tp_cd.equals("G") || ac_tp_cd.equals("K") || ac_tp_cd.equals("C") || ac_tp_cd.equals("N"))
				{
//2011.07.07 이정수 R4J					insertPs01.setDouble(i++, (Double.parseDouble(checkNull((String) actMap.get("AGN_AGMT_RT")) == "" ? "0" : (String) actMap.get("AGN_AGMT_RT"))) * 100);
					insertPs01.setDouble(i++, (Double.parseDouble("".equals(checkNull((String) actMap.get("AGN_AGMT_RT"))) ? "0" : (String) actMap.get("AGN_AGMT_RT"))) * 100);

				}
				else
				{
//2011.07.07 이정수 R4J					insertPs01.setDouble(i++, (Double.parseDouble(checkNull((String) actMap.get("AGN_AGMT_RT")) == "" ? "0" : (String) actMap.get("AGN_AGMT_RT"))));
					insertPs01.setDouble(i++, (Double.parseDouble("".equals(checkNull((String) actMap.get("AGN_AGMT_RT"))) ? "0" : (String) actMap.get("AGN_AGMT_RT"))));
				...
				log.debug("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZ");
		...
		finally
		{
			closeResultSet(rs01);
			closeResultSet(rs02);
//			closeResultSet(rs03); // 라인추가 : ResultSet Not Closed 오류해결 - 이용희수석 요청 메일('FW: [ENIS] JDBC Not Closed 발생 내역_052909')에 근거
			closeStatement(selectPs01);
			closeStatement(selectPs02);
//			closeStatement(selectPs03);
			closeStatement(insertPs01);
	...
	public HashMap createAGTTPSZCommInfo(Connection con, HashMap actMap) throws DAOException
	{
		...
		insertQuery.append("                          WHERE AGD.BKG_NO    = ? --'GOA019057200' \n");
		insertQuery.append("                            AND AGD.AGN_CD    = ? --'GOABB' \n");
		insertQuery.append("                            AND AGD.IO_BND_CD = ? --'O' \n");
		insertQuery.append("                            AND AGD.AC_TP_CD  = ? --'G' \n");
		insertQuery.append("                            AND AGD.AC_SEQ    = ? --'1' \n");
		...
		insertQuery.append("                                      FROM AGT_BKG_REV_DTL QTY \n");
		insertQuery.append("                                     WHERE QTY.BKG_NO = AGN.BKG_NO \n");
		...
		insertQuery.append("                                SUM (QTY.BKG_VOL_QTY)                       AS BKG_VOL_QTY, \n");
		insertQuery.append("                                RATIO_TO_REPORT (SUM (QTY.BKG_VOL_QTY)) \n");
		...
		insertQuery.append("                                     WHERE AGN.BKG_NO    = ? --'GOA019057200' \n");
		insertQuery.append("                                       AND AGN.AGN_CD    = ? --'GOABB' \n");
		insertQuery.append("                                       AND AGN.IO_BND_CD = ? --'O' \n");
		insertQuery.append("                                       AND AGN.AC_TP_CD  = ? --'G' \n");
		insertQuery.append("                                       AND AGN.AC_SEQ    = ? --'1' \n");
...
//		updateQuery.append("               "      DECODE (SIGN (CST.UNIT_COST), -1, 0, CST.uNIT_COST)  AS CQT_ESTM_UC_AMT, \n");
...
//		upDateQuery.append("                                                       REV.CNTP_TPSZ_CD, \n");
...
//		updateQuery.append("           CPA_COST_ASS_BSE_CD = CST_COST_ASS_BSE_CD \n");
		...
		updateQuery.append("                                                  WHEN SUBSTR (AGN.AGN_CD, 4, 2) = 'BB' \n");
		updateQuery.append("                                                  THEN 0 \n");
		updateQuery.append("                                                  WHEN TZD.OP_CNTR_QTY           = 0 \n");
		updateQuery.append("                                                  THEN 0 \n");
		...
		updateQuery.append("                                                                        AND BK2.BL_NO_TP          <>  '9' \n");
		updateQuery.append("                                                                        AND BK2.BKG_STS_CD        <>  'X' \n");
		updateQuery.append("                                                                        AND BKG.BKG_NO              = INF.BKG_NO \n");
		updateQuery.append("                                                                        AND QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		...
		updateQuery.append("                                                       TZD.QTY_RATIO, \n");
		updateQuery.append("                                                       TZD.OP_CNTR_QTY \n");
		updateQuery.append("                                                HAVING COMM_STND_COST_CD IS NOT NULL \n");
		...
		updateQuery.append("                                          ( \n");
		updateQuery.append("                                                SELECT \n");
		updateQuery.append("                                                       CPN.BKG_NO, \n");
		updateQuery.append("                                                       CPN.COMM_STND_COST_CD, \n");
		updateQuery.append("                                                       TZD.CNTR_TPSZ_CD, \n");
		updateQuery.append("                                                       TZD.QTY_RATIO, \n");
		updateQuery.append("                                                       ROUND (SUM (CPN.ACT_IF_COMM_AMT), 2)                AS UNIT_COST, \n");
		updateQuery.append("                                                       TZD.OP_CNTR_QTY, \n");
		updateQuery.append("                                                       TZD.RNUM, \n");
		updateQuery.append("                                                       TZD.MNUM \n");
		updateQuery.append("                                                  FROM AGT_CMPN_COMM CPN, \n");
		updateQuery.append("                                                     ( \n");
		updateQuery.append("                                                           SELECT \n");
		updateQuery.append("                                                                  INF.BKG_NO, \n");
		updateQuery.append("                                                                  QTY.CNTR_TPSZ_CD, \n");
		...
		updateQuery.append("                                                                  QTY.CNTR_TPSZ_CD \n");
		updateQuery.append("                                                     ) TZD \n");
		updateQuery.append("                                                 WHERE CPN.BKG_NO       = TZD.BKG_NO \n");
		updateQuery.append("                                              GROUP BY CPN.BKG_NO, \n");
		updateQuery.append("                                                       CPN.COMM_STND_COST_CD, \n");
		updateQuery.append("                                                       TZD.CNTR_TPSZ_CD, \n");
		updateQuery.append("                                                       TZD.MNUM, \n");
		updateQuery.append("                                                       TZD.RNUM, \n");
		updateQuery.append("                                                       TZD.QTY_RATIO, \n");
		updateQuery.append("                                                       TZD.OP_CNTR_QTY \n");
		updateQuery.append("                                              ORDER BY CPN.COMM_STND_COST_CD, \n");
		updateQuery.append("                                                       TZD.CNTR_TPSZ_CD \n");
		updateQuery.append("                                          ) DST \n");
		updateQuery.append("                               ) AGT, \n");
		updateQuery.append("                               ( \n");
...
//			
	 ...
	 * Outbound시 POL의 location Code 가 SINWA 산하 Office 이고, POD의 Conti Code가 E(유럽)인 경우
	 * Inbound시  POD의 location Code 가 SINWA 산하 Office 이고, POL의 Conti Code가 E(유럽)인 경우
	 * BL에 명시된 항목만 처리(NIS에서 table sync받은 Tariff는 적용하지 않음)
	...
	public HashMap searchSAsiaEurFrcInfo(Connection con, HashMap actMap, HashMap agtMap) throws DAOException
	{
		...
		selectQuery.append("      WHEN BCR.CHG_CD = 'PRM' \n");
		selectQuery.append("      THEN 0 \n");
		selectQuery.append("      WHEN BCR.CURR_CD = 'USD' \n");
		selectQuery.append("      THEN BCR.CHG_AMT \n");
		selectQuery.append("      WHEN NVL (GXR.USD_LOCL_XCH_RT, 0) = 0 \n");
		selectQuery.append("      THEN 0 \n");
		selectQuery.append("      ELSE BCR.CHG_AMT / GXR.USD_LOCL_XCH_RT \n");
		...
		selectQuery.append("         ) \n");
		selectQuery.append("         , 0 \n");
		selectQuery.append("         )                               AS ADDIN_AMT \n");
		selectQuery.append("      FROM BKG_BOOKING                   BKG, \n");
		selectQuery.append("           BKG_CHG_RT                    BCR, \n");
		...
		selectQuery.append("                      ? AS AR_OFC_CD, \n");
		selectQuery.append("                      ? AS GRS_NET_DIV_CD \n");
		selectQuery.append("                 FROM DUAL \n");
		selectQuery.append("         ) INP \n");
		selectQuery.append("     WHERE BCR.BKG_NO                          = INP.BKG_NO \n");
		selectQuery.append("       AND BKG.BKG_NO                          = INP.BKG_NO \n");
		selectQuery.append("       AND NVL (BCR.FRT_INCL_XCLD_DIV_CD, 'N') = 'N' \n");
		selectQuery.append("       AND GXR.CURR_CD                         = BCR.CURR_CD \n");
		...
		selectQuery.append("       END \n");
		selectQuery.append("       AND 1 = \n");
		selectQuery.append("      CASE \n");
		selectQuery.append("      WHEN INP.GRS_NET_DIV_CD                  = 'G' \n");
		selectQuery.append("       AND BCR.CHG_CD                          = 'PRM' \n");
		...
		selectQuery.append("      THEN 1 \n");
		selectQuery.append("      WHEN INP.GRS_NET_DIV_CD                  = 'G' \n");
		selectQuery.append("      THEN 0 \n");
		selectQuery.append("      WHEN BCR.CHG_CD                          = 'FRC' \n");
		selectQuery.append("       AND INP.SA_DT                          >= '20100101' \n");
//		2011.12.15 [CSR 선반영] FRC 계산 로직 (Net Revenue = OFT + FRC - Transportation Cost from COA) 으로 원복. LIVE 반영 2011.11.16 예정
//		selectQuery.append("       AND (SELECT NVL(AR_HD_QTR_OFC_CD,'X') FROM MDM_ORGANIZATION WHERE OFC_CD = INP.AR_OFC_CD ) IN ('SHAAS' , 'SINWA') \n");		
		selectQuery.append("      THEN 1 \n");
		selectQuery.append("      WHEN BCR.CHG_CD                          = 'ERC' \n");
		selectQuery.append("       AND INP.SA_DT                          >= '20100115' \n");
		selectQuery.append("      THEN 1 \n");
		selectQuery.append("      WHEN BCR.CHG_CD                          = 'GRI' \n");
	 ...
	 * CHM-201002498 : FRC 불공제 로직 추가 반영 요청 --TPEBB, SZPBB 커미션 계산시 FRC 불공제 로직 반영.
	 * CHM-201002433 : ERC 를 OFT 추가 산입 로직 요청
	 * CMPN_RF_TEU_RT, CMPN_RF_FEU_RT 추가
	 * @param con Connection
	 * @param bkg_no String 
	 * @return double
	 * @throws DAOException
	 */
	public double calcCompansationAmount(Connection con, String bkg_no) throws DAOException
	{
		double cmpnAmt				= 0;
		double cmpnActAmt			= 0;
		int cmpnSeq					= 0;
		...
		PreparedStatement deletePs	= null;					// 정적파싱을 지원하는 SQL Statement
		PreparedStatement deletePs01= null;					// 정적파싱을 지원하는 SQL Statement
		PreparedStatement merge01Ps	= null;					// 정적파싱을 지원하는 SQL Statement
		PreparedStatement merge02Ps	= null;					// 정적파싱을 지원하는 SQL Statement
		PreparedStatement selectPs	= null;					// 정적파싱을 지원하는 SQL Statement
		PreparedStatement selectPs01= null;					// 정적파싱을 지원하는 SQL Statement
		PreparedStatement selectPs02= null;					// 정적파싱을 지원하는 SQL Statement
		int i = 1;											// PreparedStatement에 bind 변수를 넣을시 증가되는 변수
		...
		StringBuffer deleteQuery01	= new StringBuffer();
		StringBuffer merge01Query	= new StringBuffer();
		StringBuffer merge02Query	= new StringBuffer();
		StringBuffer selectQuery	= new StringBuffer();
		StringBuffer selectQuery01	= new StringBuffer();
		StringBuffer selectQuery02	= new StringBuffer();

		deleteQuery.append("    DELETE AGT_CMPN_COMM CPN \n");
		deleteQuery.append("     WHERE CPN.COMM_PROC_STS_CD <> 'IF' \n");
		deleteQuery.append("       AND CPN.BKG_NO = ? --:BKG_NO \n");

		merge01Query.append("     MERGE \n");
		merge01Query.append("      INTO AGT_CMPN_COMM TBL \n");
		merge01Query.append("     USING \n");
		merge01Query.append("         ( \n");
		merge01Query.append("               SELECT \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_NO             ELSE ENR.BKG_NO             END AS BKG_NO, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_OCCR_INFO_CD  ELSE ENR.COMM_OCCR_INFO_CD  END AS COMM_OCCR_INFO_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.AR_OFC_CD          ELSE ENR.AR_OFC_CD          END AS AR_OFC_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.AP_OFC_CD          ELSE ENR.AP_OFC_CD          END AS AP_OFC_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_STND_COST_CD  ELSE ENR.COMM_STND_COST_CD  END AS COMM_STND_COST_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_PROC_STS_CD   ELSE ENR.COMM_PROC_STS_CD   END AS COMM_PROC_STS_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_PROC_RSLT_RSN ELSE ENR.COMM_PROC_RSLT_RSN END AS COMM_PROC_RSLT_RSN, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_SLAN_CD       ELSE ENR.COMM_SLAN_CD       END AS COMM_SLAN_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_VSL_CD        ELSE ENR.COMM_VSL_CD        END AS COMM_VSL_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_SKD_VOY_NO    ELSE ENR.COMM_SKD_VOY_NO    END AS COMM_SKD_VOY_NO, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_SKD_DIR_CD    ELSE ENR.COMM_SKD_DIR_CD    END AS COMM_SKD_DIR_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.COMM_REV_DIR_CD    ELSE ENR.COMM_REV_DIR_CD    END AS COMM_REV_DIR_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_REF_NO        ELSE ENR.CMPN_REF_NO        END AS CMPN_REF_NO, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.FRT_FWRD_CNT_CD    ELSE ENR.FRT_FWRD_CNT_CD    END AS FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.FRT_FWRD_SEQ       ELSE ENR.FRT_FWRD_SEQ       END AS FRT_FWRD_SEQ, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.VNDR_CNT_CD        ELSE ENR.VNDR_CNT_CD        END AS VNDR_CNT_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.VNDR_SEQ           ELSE ENR.VNDR_SEQ           END AS VNDR_SEQ, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.VSL_DEP_DT         ELSE ENR.VSL_DEP_DT         END AS VSL_DEP_DT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_DIV_CD        ELSE ENR.CMPN_DIV_CD        END AS CMPN_DIV_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_BKG_RT        ELSE ENR.CMPN_BKG_RT        END AS CMPN_BKG_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_CHG_CTNT      ELSE ENR.CMPN_CHG_CTNT      END AS CMPN_CHG_CTNT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_BX_RT         ELSE ENR.CMPN_BX_RT         END AS CMPN_BX_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_BX_QTY         ELSE ENR.BKG_BX_QTY         END AS BKG_BX_QTY, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_TEU_RT        ELSE ENR.CMPN_TEU_RT        END AS CMPN_TEU_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_TEU_QTY        ELSE ENR.BKG_TEU_QTY        END AS BKG_TEU_QTY, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_FEU_RT        ELSE ENR.CMPN_FEU_RT        END AS CMPN_FEU_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_FEU_QTY        ELSE ENR.BKG_FEU_QTY        END AS BKG_FEU_QTY, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_RF_RT         ELSE ENR.CMPN_RF_RT         END AS CMPN_RF_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_RF_QTY         ELSE ENR.BKG_RF_QTY         END AS BKG_RF_QTY, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_RF_TEU_RT     ELSE ENR.CMPN_RF_TEU_RT     END AS CMPN_RF_TEU_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_RF_TEU_QTY     ELSE ENR.BKG_RF_TEU_QTY     END AS BKG_RF_TEU_QTY, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_RF_FEU_RT     ELSE ENR.CMPN_RF_FEU_RT     END AS CMPN_RF_FEU_RT, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.BKG_RF_FEU_QTY     ELSE ENR.BKG_RF_FEU_QTY     END AS BKG_RF_FEU_QTY, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.CMPN_KND_CD        ELSE ENR.CMPN_KND_CD        END AS CMPN_KND_CD, \n");
		merge01Query.append("                 CASE WHEN ENR.BKG_NO IS NULL THEN PCA.AGMT_RT_SEQ        ELSE ENR.CMPN_RT_SEQ        END AS CMPN_RT_SEQ, \n");
		merge01Query.append("                      NVL (PCA.CMPN_SEQ, 1)                                                               AS CMPN_SEQ, \n");
		merge01Query.append("                      NVL (PCA.ACT_PRE_COMM_AMT, 0)                                                       AS ACT_PRE_COMM_AMT, \n");
		merge01Query.append("                      NVL (ENR.ACT_COMM_AMT, 0)                                                           AS ACT_COMM_AMT, \n");
		merge01Query.append("                      NVL (ENR.ACT_COMM_AMT, 0) - NVL (PCA.ACT_PRE_COMM_AMT, 0)                           AS ACT_IF_COMM_AMT \n");
		merge01Query.append("                 FROM \n");
		merge01Query.append("                    ( -- ENRICH \n");
		merge01Query.append("                          SELECT \n");
		merge01Query.append("                                 UNF.BKG_NO, \n");
		merge01Query.append("                                 UNF.POL_CD                             AS COMM_OCCR_INFO_CD, \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                            ORG.AR_OFC_CD \n");
		merge01Query.append("                                       FROM MDM_ORGANIZATION ORG \n");
		merge01Query.append("                                      WHERE ORG.OFC_CD = UNF.FINC_CTRL_OFC_CD \n");
		merge01Query.append("                                        AND ROWNUM     = 1 \n");
		merge01Query.append("                               )                                        AS AR_OFC_CD, \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                            ORG.AP_OFC_CD \n");
		merge01Query.append("                                       FROM MDM_ORGANIZATION ORG \n");
		merge01Query.append("                                      WHERE ORG.OFC_CD = UNF.FINC_CTRL_OFC_CD \n");
		merge01Query.append("                                        AND ROWNUM     = 1 \n");
		merge01Query.append("                               )                                        AS AP_OFC_CD, \n");
		merge01Query.append("                                 '512641'                               AS COMM_STND_COST_CD, \n");
		merge01Query.append("                                 'CS'                                   AS COMM_PROC_STS_CD, \n");
		merge01Query.append("                                 'Commission Calculation OK!'           AS COMM_PROC_RSLT_RSN, \n");
		merge01Query.append("                                 BKG.SLAN_CD                            AS COMM_SLAN_CD, \n");
		merge01Query.append("                                 --RLANE_CD COMM_RLANE_CD, \n");
		merge01Query.append("                                 BKG.VSL_CD                             AS COMM_VSL_CD, \n");
		merge01Query.append("                                 BKG.SKD_VOY_NO                         AS COMM_SKD_VOY_NO, \n");
		merge01Query.append("                                 BKG.SKD_DIR_CD                         AS COMM_SKD_DIR_CD, \n");
		merge01Query.append("                                 BKG.REV_DIR_CD                         AS COMM_REV_DIR_CD, \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                      SELECT \n");
		merge01Query.append("                                             MAX (CUST_REF_NO_CTNT) \n");
		merge01Query.append("                                        FROM BKG_REFERENCE FMC \n");
		merge01Query.append("                                       WHERE FMC.BKG_NO        = UNF.BKG_NO \n");
		merge01Query.append("                                         AND FMC.BKG_REF_TP_CD = 'FMCN' \n");
		merge01Query.append("                                         AND ROWNUM            = 1 \n");
		merge01Query.append("                               )                                        AS CMPN_REF_NO, \n");
		merge01Query.append("                                 ACR.CMPN_CNT_CD                        AS FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                                 ACR.CUST_SEQ                           AS FRT_FWRD_SEQ, \n");
		merge01Query.append("                                 ACC.VNDR_CNT_CD, \n");
		merge01Query.append("                                 ACC.VNDR_SEQ, \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT /*+INDEX(VSK_VSL_PORT_SKD XPKVSK_VSL_PORT_SKD) */ \n");
		merge01Query.append("                                            SKD.VPS_ETD_DT \n");
		merge01Query.append("                                       FROM VSK_VSL_PORT_SKD SKD, \n");
		merge01Query.append("                                            BKG_VVD          BVV \n");
		merge01Query.append("                                      WHERE SKD.VSL_CD                      = NVL (BVV.VSL_CD, '*') \n");
		merge01Query.append("                                        AND SKD.SKD_VOY_NO                  = NVL (BVV.SKD_VOY_NO, '*') \n");
		merge01Query.append("                                        AND SKD.SKD_DIR_CD                  = NVL (BVV.SKD_DIR_CD, '*') \n");
		merge01Query.append("                                        AND SKD.VPS_PORT_CD                 = NVL (BVV.POL_CD, '*') \n");
		merge01Query.append("                                        AND NVL (SKD.SKD_CNG_STS_CD, ' ') <>  'S' \n");
		merge01Query.append("                                        AND BVV.VSL_PRE_PST_CD              = 'T' \n");
		merge01Query.append("                                        AND BVV.BKG_NO                      = UNF.BKG_NO \n");
		merge01Query.append("                                        AND ROWNUM                          = 1 \n");
		merge01Query.append("                                )                                       AS VSL_DEP_DT, \n");
		merge01Query.append("                                 ACR.CMPN_DIV_CD, \n");
		merge01Query.append("                                 ACR.CMPN_BKG_RT                        AS CMPN_BKG_RT, \n");
		merge01Query.append("                                 NVL (RTRIM (ACR.CMPN_CHG_CTNT), ' ')   AS CMPN_CHG_CTNT, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_BX_RT,  0)               AS CMPN_BX_RT, \n");
		merge01Query.append("                                 UNF.BKG_BX_QTY, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_TEU_RT, 0)               AS CMPN_TEU_RT, \n");
		merge01Query.append("                                 UNF.BKG_TEU_QTY, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_FEU_RT, 0)               AS CMPN_FEU_RT, \n");
		merge01Query.append("                                 UNF.BKG_FEU_QTY, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_RF_RT,  0)               AS CMPN_RF_RT, \n");
		merge01Query.append("                                 UNF.BKG_RF_QTY, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_RF_TEU_RT,  0)           AS CMPN_RF_TEU_RT, \n");
		merge01Query.append("                                 UNF.BKG_RF_TEU_QTY, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_RF_FEU_RT,  0)           AS CMPN_RF_FEU_RT, \n");
		merge01Query.append("                                 UNF.BKG_RF_FEU_QTY, \n");
		merge01Query.append("                                 ACR.FM_EFF_DT, \n");
		merge01Query.append("                                 ACR.TO_EFF_DT, \n");
		merge01Query.append("                                 NVL (ACR.CMPN_KND_CD, 'F')             AS CMPN_KND_CD, \n");
		merge01Query.append("                            CASE \n");
		merge01Query.append("                            WHEN 'BA' = ACR.CMPN_DIV_CD \n");
		merge01Query.append("                            THEN \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                       CASE NVL (ACR.CMPN_BKG_RT, 0) \n");
		merge01Query.append("                                       WHEN 0 \n");
		merge01Query.append("                                       THEN 0 \n");
		merge01Query.append("                                       ELSE ROUND (NVL ( SUM (BRT.CHG_AMT), 0) * (NVL (ACR.CMPN_BKG_RT, 0) / 100), 2) \n");
		merge01Query.append("                                        END \n");
		merge01Query.append("                                       FROM BKG_CHG_RT BRT \n");
		merge01Query.append("                                      WHERE BRT.BKG_NO           = UNF.BKG_NO \n");
		merge01Query.append("                                        AND FRT_INCL_XCLD_DIV_CD = 'N' \n");
		merge01Query.append("                                        AND CURR_cd              = 'USD' \n");
		merge01Query.append("                               ) \n");
		merge01Query.append("                            WHEN 'BF' = ACR.CMPN_DIV_CD \n");
		merge01Query.append("                            THEN \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                       CASE NVL (ACR.CMPN_BKG_RT, 0) \n");
		...
		merge01Query.append("                                        AND FRT_INCL_XCLD_DIV_CD = 'N' \n");
		merge01Query.append("                                        AND CURR_cd              = 'USD' \n");
		merge01Query.append("                                        AND BRT.CHG_CD \n");
		merge01Query.append("                                         IN \n");
		merge01Query.append("                                          ( \n");
		merge01Query.append("                                            'OFT', 'GRI' \n");
		merge01Query.append("                                          ) \n");
		merge01Query.append("                               ) \n");
		merge01Query.append("                            WHEN 'BS' = ACR.CMPN_DIV_CD \n");
		merge01Query.append("                            THEN \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                       CASE NVL (ACR.CMPN_BKG_RT, 0) \n");
		...
		merge01Query.append("                                        AND FRT_INCL_XCLD_DIV_CD = 'N' \n");
		merge01Query.append("                                        AND CURR_cd              = 'USD' \n");
		merge01Query.append("                                        AND ACR.CMPN_CHG_CTNT LIKE '%' || BRT.CHG_CD || '%' \n");
		merge01Query.append("                               ) \n");
		merge01Query.append("                            WHEN 'CA' = ACR.CMPN_DIV_CD \n");
		merge01Query.append("                            THEN NVL (ACR.CMPN_BX_RT, 0) * UNF.BKG_BX_QTY \n");
		merge01Query.append("                            WHEN 'CS' = ACR.CMPN_DIV_CD \n");
		merge01Query.append("                            THEN NVL (ACR.CMPN_BX_RT,     0) * UNF.BKG_BX_QTY \n");
		merge01Query.append("                               + NVL (ACR.CMPN_TEU_RT,    0) * UNF.BKG_TEU_QTY \n");
		merge01Query.append("                               + NVL (ACR.CMPN_FEU_RT,    0) * UNF.BKG_FEU_QTY \n");
		merge01Query.append("                              -- + NVL (ACR.CMPN_RF_RT,     0) * UNF.BKG_RF_QTY \n");
		merge01Query.append("                               + NVL (ACR.CMPN_RF_TEU_RT, 0) * UNF.BKG_RF_TEU_QTY \n");
		merge01Query.append("                               + NVL (ACR.CMPN_RF_FEU_RT, 0) * UNF.BKG_RF_FEU_QTY \n");
		merge01Query.append("                             END AS ACT_COMM_AMT, \n");
		merge01Query.append("                                 RANK () OVER \n");
		merge01Query.append("                               ( ORDER BY \n");
		merge01Query.append("                            CASE TO_CHAR (ACR.CUST_SEQ,'FM000000') \n");
		merge01Query.append("                            WHEN '999999' \n");
		merge01Query.append("                            THEN '0' \n");
		merge01Query.append("                            ELSE '1' \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                              || \n");
		merge01Query.append("                            CASE NVL (ACR.SHPR_CNT_CD, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '0' \n");
		merge01Query.append("                            ELSE '1' \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                              || TO_CHAR \n");
		merge01Query.append("                               ( NVL (REPLACE (ACR.POR_GRP_TP_CD, '*','0'), '0') \n");
		merge01Query.append("                               + NVL (REPLACE (ACR.POL_GRP_TP_CD, '*','0'), '0') \n");
		merge01Query.append("                               + NVL (REPLACE (ACR.POD_GRP_TP_CD, '*','0'), '0') \n");
		merge01Query.append("                               , 'FM00' \n");
		merge01Query.append("                               ) \n");
		merge01Query.append("                              || \n");
		merge01Query.append("                            CASE NVL (ACR.SC_NO, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '0' \n");
		merge01Query.append("                            ELSE '1' \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                              || \n");
		merge01Query.append("                            CASE NVL (ACR.RFA_NO, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '0' \n");
		merge01Query.append("                            ELSE '1' \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                              || ACR.FM_EFF_DT \n");
		merge01Query.append("                              || TO_CHAR (9000 - ACR.CMPN_RT_SEQ, 'FM0000') DESC \n");
		merge01Query.append("                               ) AS ODR, \n");
		merge01Query.append("                                 ACR.CMPN_RT_SEQ \n");
		merge01Query.append("                            FROM AGT_CMPN_AGMT_RT   ACR, \n");
		merge01Query.append("                                 BKG_BOOKING        BKG, \n");
		merge01Query.append("                                 AGT_CMPN_CUST_MTCH ACC, \n");
		merge01Query.append("                               ( -- UNF: UNFOLD \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                            BKG.BKG_NO, \n");
		merge01Query.append("                                          ( \n");
		merge01Query.append("                                                SELECT \n");
		merge01Query.append("                                                       BCU.CUST_CNT_CD||TO_CHAR (BCU.CUST_SEQ, 'FM000000') \n");
		merge01Query.append("                                                  FROM BKG_CUSTOMER BCU \n");
		merge01Query.append("                                                 WHERE BCU.BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                   AND BCU.BKG_CUST_TP_CD ='F' \n");
		merge01Query.append("                                                   AND ROWNUM = 1 \n");
		merge01Query.append("                                          )                                                 AS FRT_FWDR, \n");
		merge01Query.append("                                          ( \n");
		merge01Query.append("                                                SELECT \n");
		merge01Query.append("                                                       BCU.CUST_CNT_CD||TO_CHAR (BCU.CUST_SEQ, 'FM000000') \n");
		merge01Query.append("                                                  FROM BKG_CUSTOMER BCU \n");
		merge01Query.append("                                                 WHERE BCU.BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                   AND BCU.BKG_CUST_TP_CD ='S' \n");
		merge01Query.append("                                                   AND ROWNUM = 1 \n");
		merge01Query.append("                                          )                                                 AS SHPR, \n");
		merge01Query.append("                                            BKG.POR_CD, \n");
		merge01Query.append("                                            POR.RGN_CD                                      AS POR_RGN_CD, \n");
		merge01Query.append("                                            POR.CNT_CD                                      AS POR_CNT_CD, \n");
		merge01Query.append("                                            POR.SCONTI_CD                                   AS POR_SCONTI_CD, \n");
		merge01Query.append("                                            POR.CONTI_CD                                    AS POR_CONTI_CD, \n");
		merge01Query.append("                                            BKG.POL_CD, \n");
		merge01Query.append("                                            POL.RGN_CD                                      AS POL_RGN_CD, \n");
		merge01Query.append("                                            POL.CNT_CD                                      AS POL_CNT_CD, \n");
		merge01Query.append("                                            POL.SCONTI_CD                                   AS POL_SCONTI_CD, \n");
		merge01Query.append("                                            POL.CONTI_CD                                    AS POL_CONTI_CD, \n");
		merge01Query.append("                                            POL.FINC_CTRL_OFC_CD, \n");
		merge01Query.append("                                            BKG.POD_CD, \n");
		merge01Query.append("                                            POD.RGN_CD                                      AS POD_RGN_CD, \n");
		merge01Query.append("                                            POD.CNT_CD                                      AS POD_CNT_CD, \n");
		merge01Query.append("                                            POD.SCONTI_CD                                   AS POD_SCONTI_CD, \n");
		merge01Query.append("                                            POD.CONTI_CD                                    AS POD_CONTI_CD, \n");
		merge01Query.append("                                            QTY.BKG_BX_QTY, \n");
		merge01Query.append("                                            QTY.BKG_RF_QTY, \n");
		merge01Query.append("                                            QTY.BKG_TEU_QTY, \n");
		merge01Query.append("                                            QTY.BKG_FEU_QTY, \n");
		merge01Query.append("                                            QTY.BKG_RF_TEU_QTY, \n");
		merge01Query.append("                                            QTY.BKG_RF_FEU_QTY, \n");
		merge01Query.append("                                            BKG.CMDT_CD, \n");
		merge01Query.append("                                            BKG.REP_CMDT_CD, \n");
		merge01Query.append("                                            BKG.SC_NO, \n");
		merge01Query.append("                                          ( \n");
		merge01Query.append("                                                SELECT \n");
		merge01Query.append("                                                       SMN.REAL_CUST_CNT_CD \n");
		merge01Query.append("                                                    || TO_CHAR (SMN.REAL_CUST_SEQ, 'FM000000') \n");
		merge01Query.append("                                                  FROM PRI_SP_MN  SMN, \n");
		merge01Query.append("                                                       PRI_SP_HDR SHD \n");
		merge01Query.append("                                                 WHERE SHD.PROP_NO     = SMN.PROP_NO \n");
		merge01Query.append("                                                   AND SHD.SC_NO       = BKG.SC_NO \n");
		merge01Query.append("                                                   AND SMN.PROP_STS_CD = 'A' \n");
		merge01Query.append("                                                   AND QTY.RT_APLY_DT \n");
		merge01Query.append("                                               BETWEEN SMN.EFF_DT \n");
		merge01Query.append("                                                   AND SMN.EXP_DT \n");
		merge01Query.append("                                                   AND ROWNUM = 1 \n");
		merge01Query.append("                                          ) AS SC_REAL_CUST, \n");
		merge01Query.append("                                            BKG.RFA_NO, \n");
		merge01Query.append("                                          ( \n");
		merge01Query.append("                                                SELECT \n");
		merge01Query.append("                                                       RMN.CTRT_CUST_CNT_CD \n");
		merge01Query.append("                                                    || TO_CHAR (RMN.CTRT_CUST_SEQ, 'FM000000') \n");
		merge01Query.append("                                                  FROM PRI_RP_MN  RMN, \n");
		merge01Query.append("                                                       PRI_RP_HDR RHD \n");
		merge01Query.append("                                                 WHERE RHD.PROP_NO     = RMN.PROP_NO \n");
		merge01Query.append("                                                   AND RHD.RFA_NO      = BKG.RFA_NO \n");
		merge01Query.append("                                                   AND RMN.PROP_STS_CD = 'A' \n");
		merge01Query.append("                                                   AND QTY.RT_APLY_DT \n");
		merge01Query.append("                                               BETWEEN RMN.EFF_DT \n");
		merge01Query.append("                                                   AND RMN.EXP_DT \n");
		merge01Query.append("                                                   AND ROWNUM = 1 \n");
		merge01Query.append("                                          ) AS RFA_CTRTR, \n");
		merge01Query.append("                                            QTY.RT_APLY_DT \n");
		merge01Query.append("                                       FROM BKG_BOOKING      BKG, \n");
		merge01Query.append("                                            MDM_LOCATION     POR, \n");
		merge01Query.append("                                            MDM_LOCATION     POL, \n");
		merge01Query.append("                                            MDM_LOCATION     POD, \n");
		merge01Query.append("                                          ( -- QTY: QUANTITY \n");
		merge01Query.append("                                                SELECT \n");
		merge01Query.append("                                                       MAX (BKG.BKG_NO)                                                                                                                   AS BKG_NO, \n");
		merge01Query.append("                                                       MAX (EDT.RT_APLY_DT)                                                                                                               AS RT_APLY_DT, \n");
		merge01Query.append("                                                       NVL (SUM (QTY.OP_CNTR_QTY), 0)                                                                                                     AS BKG_BX_QTY, \n");
		merge01Query.append("                                                       NVL \n");
		merge01Query.append("                                                     ( SUM \n");
		merge01Query.append("                                                     ( \n");
		merge01Query.append("                                                  CASE \n");
		merge01Query.append("                                                  WHEN QTY.CNTR_TPSZ_CD LIKE 'R%' \n");
		merge01Query.append("                                                  THEN QTY.OP_CNTR_QTY \n");
		merge01Query.append("                                                  ELSE 0 \n");
		merge01Query.append("                                                   END \n");
		merge01Query.append("                                                     ) , 0 \n");
		merge01Query.append("                                                     )                                                   AS BKG_RF_QTY, \n");
		merge01Query.append("                                                       NVL \n");
		merge01Query.append("                                                     ( SUM \n");
		merge01Query.append("                                                     ( \n");
		merge01Query.append("                                                  CASE \n");
		merge01Query.append("                                                  WHEN QTY.CNTR_TPSZ_CD NOT LIKE 'R%' \n");
		merge01Query.append("                                                   AND QTY.CNTR_TPSZ_CD LIKE '%2' \n");
		merge01Query.append("                                                  THEN QTY.OP_CNTR_QTY \n");
		merge01Query.append("                                                  ELSE 0 \n");
		merge01Query.append("                                                   END \n");
		merge01Query.append("                                                     ) , 0 \n");
		merge01Query.append("                                                     )                                                   AS BKG_TEU_QTY, \n");
		merge01Query.append("                                                       NVL \n");
		merge01Query.append("                                                     ( SUM \n");
		merge01Query.append("                                                     ( \n");
		merge01Query.append("                                                  CASE \n");
		merge01Query.append("                                                  WHEN QTY.CNTR_TPSZ_CD NOT LIKE 'R%' \n");
		merge01Query.append("                                                   AND QTY.CNTR_TPSZ_CD NOT LIKE '%2' \n");
		merge01Query.append("                                                  THEN QTY.OP_CNTR_QTY \n");
		merge01Query.append("                                                  ELSE 0 \n");
		merge01Query.append("                                                   END \n");
		merge01Query.append("                                                     ) , 0 \n");
		merge01Query.append("                                                     )                                                   AS BKG_FEU_QTY, \n");
		merge01Query.append("                                                       NVL \n");
		merge01Query.append("                                                     ( SUM \n");
		merge01Query.append("                                                     ( \n");
		merge01Query.append("                                                  CASE \n");
		...
		merge01Query.append("                                                   END \n");
		merge01Query.append("                                                     ) , 0 \n");
		merge01Query.append("                                                     )                                                   AS BKG_RF_TEU_QTY, \n");
		merge01Query.append("                                                       NVL \n");
		merge01Query.append("                                                     ( SUM \n");
		merge01Query.append("                                                     ( \n");
		merge01Query.append("                                                  CASE \n");
		...
		merge01Query.append("                                                   END \n");
		merge01Query.append("                                                     ) , 0 \n");
		merge01Query.append("                                                     )                                                   AS BKG_RF_FEU_QTY \n");
		merge01Query.append("                                                  FROM BKG_BL_DOC   DOC, \n");
		merge01Query.append("                                                       BKG_BOOKING  BKG, \n");
		merge01Query.append("                                                       BKG_BOOKING  BK2, \n");
		merge01Query.append("                                                       BKG_QUANTITY QTY, \n");
		merge01Query.append("                                                     ( -- EDT \n");
		merge01Query.append("                                                       --;)----------------------------------------------------------------------------------------------- \n");
		merge01Query.append("                                                       --;) <APPLICATION DATE> \n");
		merge01Query.append("                                                       --;) 1. RATE APPLICATION DATE를 구한다. \n");
		merge01Query.append("                                                       --;) 2. CARGO RECEIVE DATE를 구한다. \n");
		merge01Query.append("                                                       --;) 3. 첫 출항 일자를 구한다. \n");
		merge01Query.append("                                                       --;)----------------------------------------------------------------------------------------------- \n");
		merge01Query.append("                                                           SELECT \n");
		merge01Query.append("                                                                  BKG.BKG_NO, \n");
		merge01Query.append("                                                                  NVL \n");
		...
		merge01Query.append("                                                                ( \n");
		merge01Query.append("                                                                      SELECT \n");
		merge01Query.append("                                                                             RAT.RT_APLY_DT \n");
		merge01Query.append("                                                                        FROM BKG_RATE RAT \n");
		merge01Query.append("                                                                       WHERE RAT.BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                                ), \n");
		merge01Query.append("                                                             CASE \n");
		merge01Query.append("                                                             WHEN \n");
		merge01Query.append("                                                                ( \n");
		merge01Query.append("                                                                      SELECT \n");
		merge01Query.append("                                                                             SUM (CNTR_VOL_QTY) Y1 \n");
		merge01Query.append("                                                                        FROM BKG_CONTAINER \n");
		merge01Query.append("                                                                       WHERE BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                                ) \n");
		merge01Query.append("                                                                = \n");
		merge01Query.append("                                                                ( \n");
		merge01Query.append("                                                                      SELECT \n");
		merge01Query.append("                                                                             NVL (SUM (QTY.OP_CNTR_QTY), 0) \n");
		merge01Query.append("                                                                        FROM BKG_QUANTITY QTY \n");
		merge01Query.append("                                                                       WHERE QTY.BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                                         AND QTY.CNTR_TPSZ_CD \n");
		merge01Query.append("                                                                      NOT IN \n");
		merge01Query.append("                                                                           ( \n");
		merge01Query.append("                                                                             'Q2','Q4' \n");
		merge01Query.append("                                                                           ) \n");
		merge01Query.append("                                                                ) \n");
		merge01Query.append("                                                              AND SUBSTR (BKG.POR_CD, 1, 2) = 'US' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.POR_CD, 1, 2) = 'MX' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.POR_CD, 1, 2) = 'CA' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.POR_CD, 1, 2) = 'BR' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.DEL_CD, 1, 2) = 'US' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.DEL_CD, 1, 2) = 'MX' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.DEL_CD, 1, 2) = 'CA' \n");
		merge01Query.append("                                                               OR SUBSTR (BKG.DEL_CD, 1, 2) = 'BR' \n");
		merge01Query.append("                                                             THEN \n");
		merge01Query.append("                                                                ( \n");
		merge01Query.append("                                                                      SELECT \n");
		merge01Query.append("                                                                        CASE \n");
		merge01Query.append("                                                                        WHEN MAX (A.CGO_RCV_DT) IS NULL THEN NULL \n");
		merge01Query.append("                                                                        WHEN MAX (A.CGO_RCV_DT) + 180 > SYSDATE \n");
		merge01Query.append("                                                                        THEN MAX (A.CGO_RCV_DT) \n");
		merge01Query.append("                                                                        ELSE NULL \n");
		merge01Query.append("                                                                         END RT_APLY_DT \n");
		merge01Query.append("                                                                        FROM BKG_CONTAINER A, \n");
		merge01Query.append("                                                                             BKG_BOOKING B \n");
		merge01Query.append("                                                                       WHERE A.BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                                         AND B.BKG_NO = BKG.BKG_NO \n");
		merge01Query.append("                                                                ) \n");
		merge01Query.append("                                                             ELSE \n");
		merge01Query.append("                                                                ( \n");
		merge01Query.append("                                                                      SELECT \n");
		merge01Query.append("                                                                             MAX (INIT_ETD_DT) \n");
		merge01Query.append("                                                                        FROM BKG_BOOKING      BK, \n");
		merge01Query.append("                                                                             BKG_VVD          VVD, \n");
		merge01Query.append("                                                                             VSK_VSL_PORT_SKD VSK \n");
		merge01Query.append("                                                                       WHERE BK.BKG_NO        = BKG.BKG_NO \n");
		merge01Query.append("                                                                         AND BK.BKG_NO        = VVD.BKG_NO \n");
		merge01Query.append("                                                                         AND BK.POL_CD        = VVD.POL_CD \n");
		merge01Query.append("                                                                         AND VVD.VSL_CD       = VSK.VSL_CD \n");
		merge01Query.append("                                                                         AND VVD.SKD_VOY_NO   = VSK.SKD_VOY_NO \n");
		merge01Query.append("                                                                         AND VVD.SKD_DIR_CD   = VSK.SKD_DIR_CD \n");
		merge01Query.append("                                                                         AND VVD.POL_CD       = VSK.VPS_PORT_CD \n");
		merge01Query.append("                                                                ) \n");
		merge01Query.append("                                                              END \n");
		merge01Query.append("                                                                ) AS RT_APLY_DT \n");
		merge01Query.append("                                                             FROM BKG_BOOKING BKG \n");
		merge01Query.append("                                                            WHERE BKG.BKG_NO = ? -- :BKG_NO \n");
		merge01Query.append("                                                     ) EDT \n");
		merge01Query.append("                                                 WHERE QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		merge01Query.append("                                                   AND QTY.BKG_NO       = DOC.BKG_NO \n");
		merge01Query.append("                                                   AND \n");
		merge01Query.append("                                                     ( \n");
		merge01Query.append("                                                       BKG.BKG_NO       = DOC.BKG_NO \n");
		merge01Query.append("                                                    OR \n");
		merge01Query.append("                                                       BKG.BL_NO        = DOC.MST_CVRD_BL_NO \n");
		merge01Query.append("                                                     ) \n");
		merge01Query.append("                                                   AND BK2.BKG_NO       = DOC.BKG_NO \n");
		merge01Query.append("                                                   AND BK2.BL_NO_TP   <>  '9' \n");
		merge01Query.append("                                                   AND BK2.BKG_STS_CD <>  'X' \n");
		merge01Query.append("                                                   AND BKG.BKG_NO       = EDT.BKG_NO \n");
		merge01Query.append("                                          ) QTY \n");
		merge01Query.append("                                      WHERE BKG.POR_CD           = POR.LOC_CD \n");
		merge01Query.append("                                        AND BKG.POL_CD           = POL.LOC_CD \n");
		merge01Query.append("                                        AND BKG.POD_CD           = POD.LOC_CD \n");
		merge01Query.append("                                        AND BKG.BKG_NO           = QTY.BKG_NO \n");
		merge01Query.append("                               ) UNF \n");
		merge01Query.append("                           WHERE BKG.BKG_NO      = UNF.BKG_NO \n");
		merge01Query.append("                             AND ACC.CUST_CNT_CD = ACR.CMPN_CNT_CD \n");
		merge01Query.append("                             AND ACC.CUST_SEQ    = ACR.CUST_SEQ \n");
		merge01Query.append("                             AND ACR.CMPN_CNT_CD || TO_CHAR (ACR.CUST_SEQ, 'FM000000') || ACR.CMPN_KND_CD \n");
		merge01Query.append("                              IN \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                 UNF.FRT_FWDR     || 'F', SUBSTR (UNF.FRT_FWDR, 1, 2)     || '999999' || 'F', \n");
		merge01Query.append("                                 UNF.SHPR         || 'S', SUBSTR (UNF.SHPR, 1, 2)         || '999999' || 'S', \n");
		merge01Query.append("                                 UNF.RFA_CTRTR    || 'R', SUBSTR (UNF.RFA_CTRTR, 1, 2)    || '999999' || 'R', \n");
		merge01Query.append("                                 UNF.SC_REAL_CUST || 'C', SUBSTR (UNF.SC_REAL_CUST, 1, 2) || '999999' || 'C' \n");
		merge01Query.append("                               ) \n");	
		merge01Query.append("                              /*  Effective Date 로직  */    \n");
		merge01Query.append("                             AND ACR.FM_EFF_DT <= TO_CHAR(UNF.RT_APLY_DT,'YYYYMMDD')   \n");
		merge01Query.append("                             AND ACR.TO_EFF_DT >= TO_CHAR(UNF.RT_APLY_DT,'YYYYMMDD')   \n");
		merge01Query.append("                              /* POR Location 해당 ROUTE별로 존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.POR_ROUT_CD, '*') \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.POR_GRP_TP_CD, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '*' \n");
		merge01Query.append("                            WHEN '5' \n");
		merge01Query.append("                            THEN UNF.POR_CD \n");
		merge01Query.append("                            WHEN '4' \n");
		merge01Query.append("                            THEN UNF.POR_RGN_CD \n");
		merge01Query.append("                            WHEN '3' \n");
		merge01Query.append("                            THEN UNF.POR_CNT_CD \n");
		merge01Query.append("                            WHEN '2' \n");
		merge01Query.append("                            THEN UNF.POR_SCONTI_CD \n");
		merge01Query.append("                            WHEN '1' \n");
		merge01Query.append("                            THEN UNF.POR_CONTI_CD \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                              /* POL Location 해당 ROUTE별로 존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.POL_ROUT_CD, '*') \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.POL_GRP_TP_CD, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '*' \n");
		merge01Query.append("                            WHEN '5' \n");
		merge01Query.append("                            THEN UNF.POL_CD \n");
		merge01Query.append("                            WHEN '4' \n");
		merge01Query.append("                            THEN UNF.POL_RGN_CD \n");
		merge01Query.append("                            WHEN '3' \n");
		merge01Query.append("                            THEN UNF.POL_CNT_CD \n");
		merge01Query.append("                            WHEN '2' \n");
		merge01Query.append("                            THEN UNF.POL_SCONTI_CD \n");
		merge01Query.append("                            WHEN '1' \n");
		merge01Query.append("                            THEN UNF.POL_CONTI_CD \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                              /* POD Location 해당 ROUTE별로 존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.POD_ROUT_CD, '*') \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.POD_GRP_TP_CD, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '*' \n");
		merge01Query.append("                            WHEN '5' \n");
		merge01Query.append("                            THEN UNF.POD_CD \n");
		merge01Query.append("                            WHEN '4' \n");
		merge01Query.append("                            THEN UNF.POD_RGN_CD \n");
		merge01Query.append("                            WHEN '3' \n");
		merge01Query.append("                            THEN UNF.POD_CNT_CD \n");
		merge01Query.append("                            WHEN '2' \n");
		merge01Query.append("                            THEN UNF.POD_SCONTI_CD \n");
		merge01Query.append("                            WHEN '1' \n");
		merge01Query.append("                            THEN UNF.POD_CONTI_CD \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                             /* SHIPPER가 존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.SHPR_CNT_CD, '*') || NVL (ACR.SHPR_SEQ, 0) \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.SHPR_CNT_CD, '*') || NVL (ACR.SHPR_SEQ, 0) \n");
		merge01Query.append("                            WHEN '*0' \n");
		merge01Query.append("                            THEN '*0' \n");
		merge01Query.append("                            ELSE \n");
		merge01Query.append("                               ( \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                            NVL (BCU.CUST_CNT_CD, '*')||NVL(BCU.CUST_SEQ, 0) \n");
		merge01Query.append("                                       FROM BKG_CUSTOMER BCU \n");
		merge01Query.append("                                      WHERE BCU.BKG_NO = UNF.BKG_NO \n");
		merge01Query.append("                                        AND BCU.BKG_CUST_TP_CD ='S' \n");
		merge01Query.append("                                        AND ROWNUM = 1 \n");
		merge01Query.append("                               ) \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                             /* RFA NO가 존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.RFA_NO, '*') \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.RFA_NO, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '*' \n");
		merge01Query.append("                            ELSE NVL (UNF.RFA_NO, '*') \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                             /* SC NO가 존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.SC_NO, '*') \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.SC_NO, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN '*' \n");
		merge01Query.append("                            ELSE NVL (UNF.SC_NO, '*') \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                             /* REP COMMODITY, COMMODITY가  존재하는지 */ \n");
		merge01Query.append("                             AND NVL (ACR.CMDT_CD, '*') \n");
		merge01Query.append("                               = \n");
		merge01Query.append("                            CASE NVL (ACR.CMDT_TP_CD, '*') \n");
		merge01Query.append("                            WHEN '*' \n");
		merge01Query.append("                            THEN NVL (ACR.CMDT_CD, '*') \n");
		merge01Query.append("                            WHEN '2' \n");
		merge01Query.append("                            THEN UNF.REP_CMDT_CD \n");
		merge01Query.append("                            WHEN '3' \n");
		merge01Query.append("                            THEN UNF.CMDT_CD \n");
		merge01Query.append("                             END \n");
		merge01Query.append("                    ) ENR FULL OUTER JOIN \n");
		merge01Query.append("                    ( -- PCA: PREVIOUS COMMISSION AMOUNT \n");
		merge01Query.append("                          SELECT \n");
		merge01Query.append("                                 CPN.BKG_NO, \n");
		merge01Query.append("                                 CPN.CMPN_SEQ + 1 AS CMPN_SEQ, \n");
		merge01Query.append("                                 CPN.COMM_OCCR_INFO_CD, \n");
		merge01Query.append("                                 CPN.AR_OFC_CD, \n");
		merge01Query.append("                                 CPN.AP_OFC_CD, \n");
		merge01Query.append("                                 CPN.COMM_STND_COST_CD, \n");
		merge01Query.append("                                 'CS' AS COMM_PROC_STS_CD, \n");
		merge01Query.append("                                 'Cancelled Booking, C/Aed Booking Info! or Changed Agent Agreements!' AS COMM_PROC_RSLT_RSN, \n");
		merge01Query.append("                                 CPN.COMM_SLAN_CD, \n");
		merge01Query.append("                                 CPN.COMM_VSL_CD, \n");
		merge01Query.append("                                 CPN.COMM_SKD_VOY_NO, \n");
		merge01Query.append("                                 CPN.COMM_SKD_DIR_CD, \n");
		merge01Query.append("                                 CPN.COMM_REV_DIR_CD, \n");
		merge01Query.append("                                 CPN.CMPN_REF_NO, \n");
		merge01Query.append("                                 CPN.FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                                 CPN.FRT_FWRD_SEQ, \n");
		merge01Query.append("                                 CPN.VNDR_CNT_CD, \n");
		merge01Query.append("                                 CPN.VNDR_SEQ, \n");
		merge01Query.append("                                 CPN.VSL_DEP_DT, \n");
		merge01Query.append("                                 CPN.CMPN_DIV_CD, \n");
		merge01Query.append("                                 CPN.CMPN_BKG_RT, \n");
		merge01Query.append("                                 CPN.CMPN_CHG_CTNT, \n");
		merge01Query.append("                                 CPN.CMPN_BX_RT, \n");
		merge01Query.append("                                 CPN.BKG_BX_QTY, \n");
		merge01Query.append("                                 CPN.CMPN_TEU_RT, \n");
		merge01Query.append("                                 CPN.BKG_TEU_QTY, \n");
		merge01Query.append("                                 CPN.CMPN_FEU_RT, \n");
		merge01Query.append("                                 CPN.BKG_FEU_QTY, \n");
		merge01Query.append("                                 CPN.CMPN_RF_RT, \n");
		merge01Query.append("                                 CPN.BKG_RF_QTY, \n");
		merge01Query.append("                                 CPN.CMPN_RF_TEU_RT, \n");
		merge01Query.append("                                 CPN.BKG_RF_TEU_QTY, \n");
		merge01Query.append("                                 CPN.CMPN_RF_FEU_RT, \n");
		merge01Query.append("                                 CPN.BKG_RF_FEU_QTY, \n");
		merge01Query.append("                                 CPN.CMPN_KND_CD, \n");
		merge01Query.append("                                 BIF.ACT_PRE_COMM_AMT, \n");
		merge01Query.append("                                 0 AS ACT_COMM_AMT, \n");
		merge01Query.append("                                 - BIF.ACT_PRE_COMM_AMT AS ACT_IF_COMM_AMT, \n");
		merge01Query.append("                                 CPN.AGMT_CNT_CD, \n");
		merge01Query.append("                                 CPN.AGMT_CUST_SEQ, \n");
		merge01Query.append("                                 CPN.AGMT_RT_SEQ, \n");
		merge01Query.append("                                 CPN.CRE_USR_ID, \n");
		merge01Query.append("                                 CPN.CRE_DT, \n");
		merge01Query.append("                                 CPN.UPD_USR_ID, \n");
		merge01Query.append("                                 CPN.UPD_DT \n");
		merge01Query.append("                            FROM AGT_CMPN_COMM CPN, \n");
		merge01Query.append("                               ( -- BIF: BEFORE INTERFACED COMMISSION \n");
		merge01Query.append("                                     SELECT \n");
		merge01Query.append("                                            CP2.BKG_NO, \n");
		merge01Query.append("                                            MAX (CP2.CMPN_SEQ)        AS CMPN_SEQ, \n");
		merge01Query.append("                                            SUM (CP2.ACT_IF_COMM_AMT) AS ACT_PRE_COMM_AMT \n");
		merge01Query.append("                                       FROM AGT_CMPN_COMM CP2 \n");
		merge01Query.append("                                      WHERE CP2.BKG_NO = ? -- :BKG_NO \n");
		merge01Query.append("                                        AND CP2.COMM_PROC_STS_CD = 'IF' \n");
		merge01Query.append("                                   GROUP BY CP2.BKG_NO \n");
		merge01Query.append("                                     HAVING SUM (CP2.ACT_IF_COMM_AMT) <> 0 \n");
		merge01Query.append("                               ) BIF -- BEFORE INTERFACED COMMISSION \n");
		merge01Query.append("                           WHERE CPN.BKG_NO   = BIF.BKG_NO \n");
		merge01Query.append("                             AND CPN.CMPN_SEQ = BIF.CMPN_SEQ \n");
		merge01Query.append("                    ) PCA -- PREVIOUS COMMISSION AMOUNT \n");
		merge01Query.append("                  ON \n");
		merge01Query.append("                   ( \n");
		merge01Query.append("                     ENR.ODR    = 1 \n");
		merge01Query.append("                 AND ENR.BKG_NO = PCA.BKG_NO \n");
		merge01Query.append("                   ) \n");
		merge01Query.append("         ) PSD \n");
		merge01Query.append("        ON \n");
		merge01Query.append("         ( \n");
		merge01Query.append("           TBL.BKG_NO   = PSD.BKG_NO \n");
		merge01Query.append("       AND TBL.CMPN_SEQ = PSD.CMPN_SEQ \n");
		merge01Query.append("         ) \n");
		merge01Query.append("      WHEN MATCHED \n");
		merge01Query.append("      THEN \n");
		merge01Query.append("               UPDATE \n");
		merge01Query.append("                  SET TBL.COMM_OCCR_INFO_CD   = PSD.COMM_OCCR_INFO_CD, \n");
		merge01Query.append("                      TBL.AR_OFC_CD           = PSD.AR_OFC_CD, \n");
		merge01Query.append("                      TBL.AP_OFC_CD           = PSD.AP_OFC_CD, \n");
		merge01Query.append("                      TBL.COMM_STND_COST_CD   = PSD.COMM_STND_COST_CD, \n");
		merge01Query.append("                      TBL.COMM_PROC_STS_CD    = PSD.COMM_PROC_STS_CD, \n");
		merge01Query.append("                      TBL.COMM_PROC_RSLT_RSN  = PSD.COMM_PROC_RSLT_RSN, \n");
		merge01Query.append("                      TBL.COMM_SLAN_CD        = PSD.COMM_SLAN_CD, \n");
		merge01Query.append("                      TBL.COMM_VSL_CD         = PSD.COMM_VSL_CD, \n");
		merge01Query.append("                      TBL.COMM_SKD_VOY_NO     = PSD.COMM_SKD_VOY_NO, \n");
		merge01Query.append("                      TBL.COMM_SKD_DIR_CD     = PSD.COMM_SKD_DIR_CD, \n");
		merge01Query.append("                      TBL.COMM_REV_DIR_CD     = PSD.COMM_REV_DIR_CD, \n");
		merge01Query.append("                      TBL.CMPN_REF_NO         = PSD.CMPN_REF_NO, \n");
		merge01Query.append("                      TBL.FRT_FWRD_CNT_CD     = PSD.FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                      TBL.FRT_FWRD_SEQ        = PSD.FRT_FWRD_SEQ, \n");
		merge01Query.append("                      TBL.VNDR_CNT_CD         = PSD.VNDR_CNT_CD, \n");
		merge01Query.append("                      TBL.VNDR_SEQ            = PSD.VNDR_SEQ, \n");
		merge01Query.append("                      TBL.VSL_DEP_DT          = PSD.VSL_DEP_DT, \n");
		merge01Query.append("                      TBL.CMPN_DIV_CD         = PSD.CMPN_DIV_CD, \n");
		merge01Query.append("                      TBL.CMPN_BKG_RT         = PSD.CMPN_BKG_RT, \n");
		merge01Query.append("                      TBL.CMPN_CHG_CTNT       = PSD.CMPN_CHG_CTNT, \n");
		merge01Query.append("                      TBL.CMPN_BX_RT          = PSD.CMPN_BX_RT, \n");
		merge01Query.append("                      TBL.BKG_BX_QTY          = PSD.BKG_BX_QTY, \n");
		merge01Query.append("                      TBL.CMPN_TEU_RT         = PSD.CMPN_TEU_RT, \n");
		merge01Query.append("                      TBL.BKG_TEU_QTY         = PSD.BKG_TEU_QTY, \n");
		merge01Query.append("                      TBL.CMPN_FEU_RT         = PSD.CMPN_FEU_RT, \n");
		merge01Query.append("                      TBL.BKG_FEU_QTY         = PSD.BKG_FEU_QTY, \n");
//		merge01Query.append("                      TBL.CMPN_RF_RT          = PSD.CMPN_RF_RT, \n");
//		merge01Query.append("                      TBL.BKG_RF_QTY          = PSD.BKG_RF_QTY, \n");
		merge01Query.append("                      TBL.CMPN_RF_TEU_RT      = PSD.CMPN_RF_TEU_RT, \n");
		merge01Query.append("                      TBL.BKG_RF_TEU_QTY      = PSD.BKG_RF_TEU_QTY, \n");
		merge01Query.append("                      TBL.CMPN_RF_FEU_RT      = PSD.CMPN_RF_FEU_RT, \n");
		merge01Query.append("                      TBL.BKG_RF_FEU_QTY      = PSD.BKG_RF_FEU_QTY, \n");
		merge01Query.append("                      TBL.CMPN_KND_CD         = PSD.CMPN_KND_CD, \n");
		merge01Query.append("                      TBL.ACT_PRE_COMM_AMT    = PSD.ACT_PRE_COMM_AMT, \n");
		merge01Query.append("                      TBL.ACT_COMM_AMT        = PSD.ACT_COMM_AMT, \n");
		merge01Query.append("                      TBL.ACT_IF_COMM_AMT     = PSD.ACT_IF_COMM_AMT, \n");
		merge01Query.append("                      TBL.AGMT_CNT_CD         = PSD.FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                      TBL.AGMT_CUST_SEQ       = PSD.FRT_FWRD_SEQ, \n");
		merge01Query.append("                      TBL.AGMT_RT_SEQ         = PSD.CMPN_RT_SEQ, \n");
		merge01Query.append("                      TBL.UPD_USR_ID          = 'COMMISSION', \n");
		merge01Query.append("                      TBL.UPD_DT              = SYSDATE \n");
		merge01Query.append("      WHEN NOT MATCHED \n");
		merge01Query.append("      THEN \n");
		merge01Query.append("               INSERT \n");
		merge01Query.append("                    ( \n");
		merge01Query.append("                      BKG_NO, \n");
		merge01Query.append("                      CMPN_SEQ, \n");
		merge01Query.append("                      COMM_OCCR_INFO_CD, \n");
		merge01Query.append("                      AR_OFC_CD, \n");
		merge01Query.append("                      AP_OFC_CD, \n");
		merge01Query.append("                      COMM_STND_COST_CD, \n");
		merge01Query.append("                      COMM_PROC_STS_CD, \n");
		merge01Query.append("                      COMM_PROC_RSLT_RSN, \n");
		merge01Query.append("                      COMM_SLAN_CD, \n");
		merge01Query.append("                      COMM_VSL_CD, \n");
		merge01Query.append("                      COMM_SKD_VOY_NO, \n");
		merge01Query.append("                      COMM_SKD_DIR_CD, \n");
		merge01Query.append("                      COMM_REV_DIR_CD, \n");
		merge01Query.append("                      CMPN_REF_NO, \n");
		merge01Query.append("                      FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                      FRT_FWRD_SEQ, \n");
		merge01Query.append("                      VNDR_CNT_CD, \n");
		merge01Query.append("                      VNDR_SEQ, \n");
		merge01Query.append("                      VSL_DEP_DT, \n");
		merge01Query.append("                      CMPN_DIV_CD, \n");
		merge01Query.append("                      CMPN_BKG_RT, \n");
		merge01Query.append("                      CMPN_CHG_CTNT, \n");
		merge01Query.append("                      CMPN_BX_RT, \n");
		merge01Query.append("                      BKG_BX_QTY, \n");
		merge01Query.append("                      CMPN_TEU_RT, \n");
		merge01Query.append("                      BKG_TEU_QTY, \n");
		merge01Query.append("                      CMPN_FEU_RT, \n");
		merge01Query.append("                      BKG_FEU_QTY, \n");
//		merge01Query.append("                      CMPN_RF_RT, \n");
//		merge01Query.append("                      BKG_RF_QTY, \n");
		merge01Query.append("                      CMPN_RF_TEU_RT, \n");
		merge01Query.append("                      BKG_RF_TEU_QTY, \n");
		merge01Query.append("                      CMPN_RF_FEU_RT, \n");
		merge01Query.append("                      BKG_RF_FEU_QTY, \n");
		merge01Query.append("                      CMPN_KND_CD, \n");
		merge01Query.append("                      ACT_PRE_COMM_AMT, \n");
		merge01Query.append("                      ACT_COMM_AMT, \n");
		merge01Query.append("                      ACT_IF_COMM_AMT, \n");
		merge01Query.append("                      AGMT_CNT_CD, \n");
		merge01Query.append("                      AGMT_CUST_SEQ, \n");
		merge01Query.append("                      AGMT_RT_SEQ, \n");
		merge01Query.append("                      CRE_USR_ID, \n");
		merge01Query.append("                      CRE_DT, \n");
		merge01Query.append("                      UPD_USR_ID, \n");
		merge01Query.append("                      UPD_DT \n");
		merge01Query.append("                    ) \n");
		merge01Query.append("               VALUES \n");
		merge01Query.append("                    ( \n");
		merge01Query.append(" \n");
		merge01Query.append("                       PSD.BKG_NO, \n");
		merge01Query.append("                       PSD.CMPN_SEQ, \n");
		merge01Query.append("                       PSD.COMM_OCCR_INFO_CD, \n");
		merge01Query.append("                       PSD.AR_OFC_CD, \n");
		merge01Query.append("                       PSD.AP_OFC_CD, \n");
		merge01Query.append("                       PSD.COMM_STND_COST_CD, \n");
		merge01Query.append("                       PSD.COMM_PROC_STS_CD, \n");
		merge01Query.append("                       PSD.COMM_PROC_RSLT_RSN, \n");
		merge01Query.append("                       PSD.COMM_SLAN_CD, \n");
		merge01Query.append("                       PSD.COMM_VSL_CD, \n");
		merge01Query.append("                       PSD.COMM_SKD_VOY_NO, \n");
		merge01Query.append("                       PSD.COMM_SKD_DIR_CD, \n");
		merge01Query.append("                       PSD.COMM_REV_DIR_CD, \n");
		merge01Query.append("                       PSD.CMPN_REF_NO, \n");
		merge01Query.append("                       PSD.FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                       PSD.FRT_FWRD_SEQ, \n");
		merge01Query.append("                       PSD.VNDR_CNT_CD, \n");
		merge01Query.append("                       PSD.VNDR_SEQ, \n");
		merge01Query.append("                       PSD.VSL_DEP_DT, \n");
		merge01Query.append("                       PSD.CMPN_DIV_CD, \n");
		merge01Query.append("                       PSD.CMPN_BKG_RT, \n");
		merge01Query.append("                       PSD.CMPN_CHG_CTNT, \n");
		merge01Query.append("                       PSD.CMPN_BX_RT, \n");
		merge01Query.append("                       PSD.BKG_BX_QTY, \n");
		merge01Query.append("                       PSD.CMPN_TEU_RT, \n");
		merge01Query.append("                       PSD.BKG_TEU_QTY, \n");
		merge01Query.append("                       PSD.CMPN_FEU_RT, \n");
		merge01Query.append("                       PSD.BKG_FEU_QTY, \n");
//		merge01Query.append("                       PSD.CMPN_RF_RT, \n");
//		merge01Query.append("                       PSD.BKG_RF_QTY, \n");
		merge01Query.append("                       PSD.CMPN_RF_TEU_RT, \n");
		merge01Query.append("                       PSD.BKG_RF_TEU_QTY, \n");
		merge01Query.append("                       PSD.CMPN_RF_FEU_RT, \n");
		merge01Query.append("                       PSD.BKG_RF_FEU_QTY, \n");
		merge01Query.append("                       PSD.CMPN_KND_CD, \n");
		merge01Query.append("                       PSD.ACT_PRE_COMM_AMT, \n");
		merge01Query.append("                       PSD.ACT_COMM_AMT, \n");
		merge01Query.append("                       PSD.ACT_IF_COMM_AMT, \n");
		merge01Query.append("                       PSD.FRT_FWRD_CNT_CD, \n");
		merge01Query.append("                       PSD.FRT_FWRD_SEQ, \n");
		merge01Query.append("                       PSD.CMPN_RT_SEQ, \n");
		merge01Query.append("                       'COMMSSION', \n");
		merge01Query.append("                       SYSDATE, \n");
		merge01Query.append("                       'COMMSSION', \n");
		merge01Query.append("                       SYSDATE \n");
		merge01Query.append("                    ) \n");

		merge02Query.append("     MERGE \n");
		merge02Query.append("      INTO AGT_CMPN_COMM_DTL TBL \n");
		merge02Query.append("     USING \n");
		merge02Query.append("         ( --PSD: PROCESSED \n");
		merge02Query.append("               SELECT \n");
		merge02Query.append("                 CASE \n");
		merge02Query.append("                 WHEN TOB.BKG_NO IS NULL \n");
		merge02Query.append("                 THEN AIS.BKG_NO \n");
		merge02Query.append("                 ELSE TOB.BKG_NO \n");
		merge02Query.append("                  END                                                            AS BKG_NO, \n");
		merge02Query.append("                 CASE \n");
		merge02Query.append("                 WHEN TOB.CNTR_TPSZ_CD IS NULL \n");
		merge02Query.append("                 THEN AIS.CNTR_TPSZ_CD \n");
		merge02Query.append("                 ELSE TOB.CNTR_TPSZ_CD \n");
		merge02Query.append("                  END                                                            AS CNTR_TPSZ_CD, \n");
		merge02Query.append("                 CASE \n");
		merge02Query.append("                 WHEN TOB.CMPN_SEQ IS NULL \n");
		merge02Query.append("                 THEN AIS.CMPN_SEQ \n");
		merge02Query.append("                 ELSE TOB.CMPN_SEQ \n");
		merge02Query.append("                  END                                                            AS CMPN_SEQ, \n");
		merge02Query.append("                      TOB.BKG_VOL_QTY                                            AS BKG_VOL_QTY, \n");
		merge02Query.append("                CASE \n");
		merge02Query.append("                WHEN TOB.RNUM = TOB.MNUM \n");
		merge02Query.append("                THEN ROUND (TOB.ACT_COMM_AMT * TOB.QTY_RATIO, 2) \n");
		merge02Query.append("                   + TOB.ACT_COMM_AMT \n");
		merge02Query.append("                   - SUM (ROUND (TOB.ACT_COMM_AMT * TOB.QTY_RATIO, 2)) \n");
		merge02Query.append("                     OVER (ORDER BY TOB.CNTR_TPSZ_CD DESC) \n");
		merge02Query.append("                ELSE ROUND (TOB.ACT_COMM_AMT * TOB.QTY_RATIO, 2) \n");
		merge02Query.append("                 END                                                             AS ACT_USD_COMM_AMT, \n");
		merge02Query.append("                     'COMMISSION'                                                AS UPD_USR_ID, \n");
		merge02Query.append("                     SYSDATE                                                     AS UPD_DT, \n");
		merge02Query.append("                     'COMMISSION'                                                AS CRE_USR_ID, \n");
		merge02Query.append("                     SYSDATE                                                     AS CRE_DT \n");
		merge02Query.append("                FROM \n");
		merge02Query.append("                   ( \n");
		merge02Query.append("                         SELECT \n");
		merge02Query.append("                                CPD.BKG_NO, \n");
		merge02Query.append("                                CPD.CMPN_SEQ, \n");
		merge02Query.append("                                CPD.CNTR_TPSZ_CD, \n");
		merge02Query.append("                                CPD.BKG_VOL_QTY, \n");
		merge02Query.append("                                CPD.ACT_USD_COMM_AMT, \n");
		merge02Query.append("                                CPD.UPD_USR_ID, \n");
		merge02Query.append("                                CPD.UPD_DT, \n");
		merge02Query.append("                                CPD.CRE_USR_ID, \n");
		merge02Query.append("                                CPD.CRE_DT \n");
		merge02Query.append("                           FROM AGT_CMPN_COMM_DTL CPD \n");
		merge02Query.append("                          WHERE CPD.BKG_NO         = ? --:BKG_NO \n");
		merge02Query.append("                            AND CPD.CMPN_SEQ \n");
		merge02Query.append("                              = \n");
		merge02Query.append("                              ( \n");
		merge02Query.append("                         SELECT \n");
		merge02Query.append("                                MAX (CP2.CMPN_SEQ) \n");
		merge02Query.append("                           FROM AGT_CMPN_COMM CP2 \n");
		merge02Query.append("                          WHERE CP2.BKG_NO           = CPD.BKG_NO \n");
		merge02Query.append("                              ) \n");
		merge02Query.append("                   ) AIS -- AS_IS DISTRIBUTION AMOUNT \n");
		merge02Query.append("          FULL OUTER \n");
		merge02Query.append("                JOIN \n");
		merge02Query.append("                   ( \n");
		merge02Query.append("                         SELECT \n");
		merge02Query.append("                                RANK() OVER(ORDER BY QTY.CNTR_TPSZ_CD DESC) AS RNUM, \n");
		merge02Query.append("                              ( \n");
		merge02Query.append("                                    SELECT \n");
		merge02Query.append("                                           COUNT (DISTINCT QT2.CNTR_TPSZ_CD) \n");
		merge02Query.append("                                      FROM BKG_BL_DOC   DOC, \n");
		merge02Query.append("                                           BKG_BOOKING  BKG, \n");
		merge02Query.append("                                           BKG_BOOKING  BK2, \n");
		merge02Query.append("                                           BKG_QUANTITY QT2 \n");
		merge02Query.append("                                     WHERE QT2.BKG_NO                   = DOC.BKG_NO \n");
		merge02Query.append("                                       AND QT2.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		merge02Query.append("                                       AND \n");
		merge02Query.append("                                         ( \n");
		merge02Query.append("                                           BKG.BKG_NO                   = DOC.BKG_NO \n");
		merge02Query.append("                                        OR \n");
		merge02Query.append("                                           BKG.BL_NO                    = DOC.MST_CVRD_BL_NO \n");
		merge02Query.append("                                         ) \n");
		merge02Query.append("                                       AND BK2.BKG_NO                   = DOC.BKG_NO \n");
		merge02Query.append("                                       AND BK2.BL_NO_TP               <>  '9' \n");
		merge02Query.append("                                       AND BK2.BKG_STS_CD             <>  'X' \n");
		merge02Query.append("                                       AND BKG.BKG_NO                   = MST.BKG_NO \n");
		merge02Query.append("                              )                                             AS MNUM, \n");
		merge02Query.append("                                MST.BKG_NO                                  AS BKG_NO, \n");
		merge02Query.append("                                MAX (MST.CMPN_SEQ)                          AS CMPN_SEQ, \n");
		merge02Query.append("                                MAX (MST.ACT_COMM_AMT)                      AS ACT_COMM_AMT, \n");
		merge02Query.append("                                QTY.CNTR_TPSZ_CD, \n");
		merge02Query.append("                                SUM (QTY.OP_CNTR_QTY)                       AS BKG_VOL_QTY, \n");
		merge02Query.append("                                RATIO_TO_REPORT (SUM (QTY.OP_CNTR_QTY)) \n");
		merge02Query.append("                                OVER (PARTITION BY MST.BKG_NO)              AS QTY_RATIO \n");
		merge02Query.append("                           FROM BKG_QUANTITY QTY, \n");
		merge02Query.append("                              ( --mst: Master \n");
		merge02Query.append("                                    SELECT \n");
		merge02Query.append("                                           CPN.BKG_NO, \n");
		merge02Query.append("                                           CPN.CMPN_SEQ, \n");
		merge02Query.append("                                           CPN.ACT_COMM_AMT \n");
		merge02Query.append("                                      FROM AGT_CMPN_COMM CPN \n");
		merge02Query.append("                                     WHERE CPN.BKG_NO           = ? --:BKG_NO \n");
		merge02Query.append("                                       AND CPN.COMM_PROC_STS_CD = 'CS' \n");
		merge02Query.append("                                       AND CPN.CMPN_SEQ \n");
		merge02Query.append("                                         = \n");
		merge02Query.append("                                         ( \n");
		merge02Query.append("                                    SELECT \n");
		merge02Query.append("                                           MAX (CP2.CMPN_SEQ) \n");
		merge02Query.append("                                      FROM AGT_CMPN_COMM CP2 \n");
		merge02Query.append("                                     WHERE CP2.BKG_NO           = CPN.BKG_NO \n");
		merge02Query.append("                                       AND CP2.COMM_PROC_STS_CD = CPN.COMM_PROC_STS_CD \n");
		merge02Query.append("                                         ) \n");
		merge02Query.append("                              ) MST \n");
		merge02Query.append("                          WHERE QTY.BKG_NO \n");
		merge02Query.append("                             IN \n");
		merge02Query.append("                              ( \n");
		merge02Query.append("                                    SELECT \n");
		merge02Query.append("                                           DOC.BKG_NO \n");
		merge02Query.append("                                      FROM BKG_BL_DOC  DOC, \n");
		merge02Query.append("                                           BKG_BOOKING BKG, \n");
		merge02Query.append("                                           BKG_BOOKING BK2 \n");
		merge02Query.append("                                     WHERE \n");
		merge02Query.append("                                         ( \n");
		merge02Query.append("                                           BKG.BKG_NO                   = DOC.BKG_NO \n");
		merge02Query.append("                                        OR \n");
		merge02Query.append("                                           BKG.BL_NO                    = DOC.MST_CVRD_BL_NO \n");
		...
		merge02Query.append("                                       AND BKG.BKG_NO                   = MST.BKG_NO \n");
		merge02Query.append("                              ) \n");
		merge02Query.append("                            AND QTY.CNTR_TPSZ_CD NOT LIKE 'Q%' \n");
		merge02Query.append("                       GROUP BY MST.BKG_NO, \n");
		merge02Query.append("                                QTY.CNTR_TPSZ_CD \n");
		merge02Query.append("                       ORDER BY QTY.CNTR_TPSZ_CD DESC \n");
		merge02Query.append("                   ) TOB -- TO_BE DISTRIBUTION AMOUNT \n");
		merge02Query.append("                  ON \n");
		merge02Query.append("                   ( \n");
		merge02Query.append("                     AIS.BKG_NO       = TOB.BKG_NO \n");
		merge02Query.append("                 AND AIS.CMPN_SEQ     = TOB.CMPN_SEQ \n");
		merge02Query.append("                 AND AIS.CNTR_TPSZ_CD = TOB.CNTR_TPSZ_CD \n");
		merge02Query.append("                   ) \n");
		merge02Query.append("        ) PCD -- PROCESSED \n");
		merge02Query.append("        ON \n");
		merge02Query.append("         ( TBL.BKG_NO         = PCD.BKG_NO \n");
		merge02Query.append("       AND TBL.CMPN_SEQ       = PCD.CMPN_SEQ \n");
		merge02Query.append("       AND TBL.CNTR_TPSZ_CD   = PCD.CNTR_TPSZ_CD \n");
		merge02Query.append("         ) \n");
		merge02Query.append("      WHEN MATCHED \n");
		merge02Query.append("      THEN \n");
		merge02Query.append("               UPDATE \n");
		merge02Query.append("                  SET TBL.BKG_VOL_QTY       = PCD.BKG_VOL_QTY, \n");
		merge02Query.append("                      TBL.ACT_USD_COMM_AMT  = PCD.ACT_USD_COMM_AMT, \n");
		merge02Query.append("                      TBL.UPD_USR_ID        = PCD.UPD_USR_ID, \n");
		merge02Query.append("                      TBL.UPD_DT            = PCD.UPD_DT \n");
		merge02Query.append("               DELETE \n");
		merge02Query.append("                WHERE PCD.BKG_VOL_QTY IS NULL \n");
		merge02Query.append("      WHEN NOT MATCHED \n");
		merge02Query.append("      THEN \n");
		merge02Query.append("    INSERT \n");
		merge02Query.append("         ( \n");
		merge02Query.append("           BKG_NO, \n");
		merge02Query.append("           CMPN_SEQ, \n");
		merge02Query.append("           CNTR_TPSZ_CD, \n");
		merge02Query.append("           BKG_VOL_QTY, \n");
		merge02Query.append("           ACT_USD_COMM_AMT, \n");
		merge02Query.append("           UPD_USR_ID, \n");
		merge02Query.append("           UPD_DT, \n");
		merge02Query.append("           CRE_USR_ID, \n");
		merge02Query.append("           CRE_DT \n");
		merge02Query.append("         ) \n");
		merge02Query.append("    VALUES \n");
		merge02Query.append("         ( \n");
		merge02Query.append("           PCD.BKG_NO, \n");
		merge02Query.append("           PCD.CMPN_SEQ, \n");
		merge02Query.append("           PCD.CNTR_TPSZ_CD, \n");
		merge02Query.append("           PCD.BKG_VOL_QTY, \n");
		merge02Query.append("           PCD.ACT_USD_COMM_AMT, \n");
		merge02Query.append("           PCD.UPD_USR_ID, \n");
		merge02Query.append("           PCD.UPD_DT, \n");
		merge02Query.append("           PCD.CRE_USR_ID, \n");
		merge02Query.append("           PCD.CRE_DT \n");
		merge02Query.append("         ) \n");


		selectQuery.append("    SELECT \n");
		selectQuery.append("           NVL (SUM(CPN.ACT_IF_COMM_AMT), 0) AS CMPN_AMT \n");
		selectQuery.append("      FROM AGT_CMPN_COMM CPN \n");
		selectQuery.append("     WHERE CPN.COMM_PROC_STS_CD <>  'CE' \n");
		selectQuery.append("       AND CPN.BKG_NO             = ? --:BKG_NO \n");

		selectQuery01.append("    SELECT \n");
		selectQuery01.append("           MAX(CPN.CMPN_SEQ) AS CMPN_SEQ \n");
		selectQuery01.append("      FROM AGT_CMPN_COMM CPN \n");
		selectQuery01.append("     WHERE CPN.BKG_NO             = ? --:BKG_NO \n");
		
		selectQuery02.append("    SELECT \n");
		selectQuery02.append("           ACT_IF_COMM_AMT AS CMPN_ACT_AMT \n");
		selectQuery02.append("      FROM AGT_CMPN_COMM CPN \n");
		selectQuery02.append("     WHERE BKG_NO = ? \n");
		selectQuery02.append("       AND CMPN_SEQ = ? \n");
		
		deleteQuery01.append("	 DELETE FROM AGT_CMPN_COMM \n");
		deleteQuery01.append("         WHERE BKG_NO =  ? \n");
		deleteQuery01.append("           AND CMPN_SEQ = ? \n");
		...
		try
		{
			...
			deletePs.setString(i++, bkg_no);
			log.debug("\n Delete Before Calculation Result :\n    " + ((LoggableStatement)deletePs).getQueryString());
			deletePs.executeUpdate();

			i = 1;
			merge01Ps = new LoggableStatement(con, merge01Query.toString());
			merge01Ps.setString(i++, bkg_no);
			merge01Ps.setString(i++, bkg_no);
			log.debug("\n Calculate Compansation Amount :\n    " + ((LoggableStatement)merge01Ps).getQueryString());
			merge01Ps.executeUpdate();
			

			i = 1;
			merge02Ps = new LoggableStatement(con, merge02Query.toString());
			merge02Ps.setString(i++, bkg_no);
			merge02Ps.setString(i++, bkg_no);
			log.debug("\n TP/SZ Distribution for Compansation result :\n    " + ((LoggableStatement)merge02Ps).getQueryString());
			merge02Ps.executeUpdate();
			...
			if ( rs.next() )
			{
				cmpnAmt = rs.getDouble("CMPN_AMT");
			}
			
			i = 1;
			selectPs01 = new LoggableStatement(con, selectQuery01.toString());
			selectPs01.setString(i++, bkg_no);
			rs1 = selectPs01.executeQuery();
			if ( rs1.next() )
			{
				cmpnSeq = rs1.getInt("CMPN_SEQ");
			}
			
			log.debug("~~~~~~~~~~~~cmpnAmt~~~~~~~~~~"+cmpnAmt);
			log.debug("~~~~~~~~~~~~cmpnSeq~~~~~~~~~~"+cmpnSeq);
			
			if(cmpnSeq > 1){
				i = 1;
				selectPs02 = new LoggableStatement(con, selectQuery02.toString());
				selectPs02.setString(i++, bkg_no);
				selectPs02.setInt(i++, cmpnSeq);
				log.debug("\n SQL1 : \n" + ((LoggableStatement)selectPs02).getQueryString());
				rs2 = selectPs02.executeQuery();		
				
				if ( rs2.next() )
				{
					cmpnActAmt = rs2.getDouble("CMPN_ACT_AMT");
				}
			}
			
			log.debug("~~~~~~~~~~~~cmpnActAmt~~~~~~~~~~"+cmpnActAmt);
			
			if (cmpnActAmt == 0 && cmpnSeq > 1)
			{
				// Delete
				i = 1;
				deletePs01 = new LoggableStatement(con, deleteQuery01.toString());
				deletePs01.setString(i++, bkg_no);
				deletePs01.setInt(i++, cmpnSeq);
				log.debug("\n SQL1 : \n" + ((LoggableStatement)deletePs01).getQueryString());
				deletePs01.executeUpdate();
			}
		...
		finally
		{
			...
			closeStatement(merge01Ps);
			closeStatement(merge02Ps);
			closeStatement(selectPs);
			closeStatement(selectPs01);
			closeStatement(selectPs02);
			closeStatement(deletePs01);
