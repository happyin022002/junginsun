...
*@FileName : OPMasterDBDAOMultiHistVSLSubTRDCapaDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistVSLSubTRDCapaDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiHistVSLSubTRDCapa DELETE
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistVSLSubTRDCapaDSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistVSLSubTRDCapaDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
