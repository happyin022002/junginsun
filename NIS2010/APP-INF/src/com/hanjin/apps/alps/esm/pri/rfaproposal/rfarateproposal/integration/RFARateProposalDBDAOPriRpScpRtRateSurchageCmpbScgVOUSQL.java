...
*@FileName : RFARateProposalDBDAOPriRpScpRtRateSurchageCmpbScgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtRateSurchageCmpbScgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtRateSurchageCmpbScgVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtRateSurchageCmpbScgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_RP_SCP_RT RT" ).append("\n"); 
		...
		query.append("        FROM PRI_RP_SCP_RT_SCG" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("        GROUP BY PROP_NO ,AMDT_SEQ ,SVC_SCP_CD ,CMDT_HDR_SEQ ,ROUT_SEQ ,RT_SEQ" ).append("\n"); 
