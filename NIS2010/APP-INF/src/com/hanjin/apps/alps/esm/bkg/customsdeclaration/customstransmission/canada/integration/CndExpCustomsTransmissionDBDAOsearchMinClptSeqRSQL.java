...
*@FileName : CndExpCustomsTransmissionDBDAOsearchMinClptSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchMinClptSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchMinClptSeqRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchMinClptSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
