...
*@FileName : TAAProposalDBDAOPriTaaMnVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TAAProposalDBDAOPriTaaMnVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TAAProposalDBDAOPriTaaMnVODSQL(){
		setQuery();
		...
		query.append("FileName : TAAProposalDBDAOPriTaaMnVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TAA_MN" ).append("\n"); 
