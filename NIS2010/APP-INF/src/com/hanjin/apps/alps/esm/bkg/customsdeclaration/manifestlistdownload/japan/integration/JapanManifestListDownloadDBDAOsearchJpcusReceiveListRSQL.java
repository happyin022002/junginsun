...
*@FileName : JapanManifestListDownloadDBDAOsearchJpcusReceiveListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOsearchJpcusReceiveListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOsearchJpcusReceiveListRSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOsearchJpcusReceiveListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ROW_NUMBER() OVER(ORDER BY JP_SVC_ID,RCV_DT) AS RN," ).append("\n"); 
