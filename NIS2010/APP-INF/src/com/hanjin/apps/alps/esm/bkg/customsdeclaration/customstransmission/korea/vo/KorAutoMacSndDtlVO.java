...
*@FileName : KorAutoMacSndDtlVO.java
*@FileTitle : KorAutoMacSndDtlVO
*Open Issues :
*Change history :
...
public class KorAutoMacSndDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorAutoMacSndDtlVO> models = new ArrayList<KorAutoMacSndDtlVO>();
	...
	public KorAutoMacSndDtlVO() {}

	public KorAutoMacSndDtlVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq, String ediSndMsg) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return KorAutoMacSndDtlVO[]
	 */
	public KorAutoMacSndDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorAutoMacSndDtlVO[]
	 */
	public KorAutoMacSndDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorAutoMacSndDtlVO model = null;
	 ...
	 * @return KorAutoMacSndDtlVO[]
	 */
	public KorAutoMacSndDtlVO[] getKorAutoMacSndDtlVOs(){
		KorAutoMacSndDtlVO[] vos = (KorAutoMacSndDtlVO[])models.toArray(new KorAutoMacSndDtlVO[models.size()]);
		return vos;
	}
