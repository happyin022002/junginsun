...
*@FileName : CargoReleaseOrderDBDAOmodifyUsCgoRlseEdiUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CargoReleaseOrderDBDAOmodifyUsCgoRlseEdiUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CargoReleaseOrderDBDAOmodifyUsCgoRlseEdiUSQL(){
		setQuery();
		...
		query.append("FileName : CargoReleaseOrderDBDAOmodifyUsCgoRlseEdiUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       FRT_CLT_LST_DT	= DECODE(@[frt_clt_flg],FRT_CLT_FLG,FRT_CLT_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('NYCSC') ))," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${obl_rdem_flg} != '' )" ).append("\n"); 
		query.append("       OBL_RDEM_FLG	    = @[obl_rdem_flg]," ).append("\n"); 
		query.append("       OBL_RDEM_LST_DT	= DECODE(@[obl_rdem_flg],OBL_RDEM_FLG,OBL_RDEM_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('NYCSC') ))," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${cstms_clr_cd} != '' )" ).append("\n"); 
		query.append("       CSTMS_CLR_CD	    = (SELECT @[cstms_clr_cd] FROM BKG_CSTMS_ADV_BL WHERE CNT_CD = 'US' AND BL_NO = @[bl_no]) ," ).append("\n"); 
		query.append("       CSTMS_CLR_LST_DT	= (SELECT DECODE(@[cstms_clr_cd],CSTMS_CLR_CD,CSTMS_CLR_LST_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('NYCSC') ))" ).append("\n"); 
		query.append("                             FROM BKG_CSTMS_ADV_BL WHERE CNT_CD = 'US' AND BL_NO = @[bl_no])," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("                                     TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',sysdate,GLOBALDATE_PKG.GET_LOCCD_FNC('NYCSC')),'YYYYMMDDHH24MISS')))," ).append("\n"); 
		...
		query.append("        GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',SYSDATE,GLOBALDATE_PKG.GET_LOCCD_FNC('NYCSC') )," ).append("\n"); 
