...
*@FileName : ESM_BKG_0655HTMLAction.java
*@FileTitle : SC Search
*Open Issues :
*Change history :
...
public class ESM_BKG_0655HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0655HTMLAction 객체를 생성
	 */
	public ESM_BKG_0655HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0655Event event = new EsmBkg0655Event();
