...
*@FileName : NetworkDistributionDBDAOMultiLaneTSUnitCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOMultiLaneTSUnitCostCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiLaneTSUnitCost INSERT
	  * </pre>
	  */
	public NetworkDistributionDBDAOMultiLaneTSUnitCostCSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOMultiLaneTSUnitCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_LANE_TS_UT_COST (" ).append("\n"); 
