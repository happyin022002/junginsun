...
//		}		//주석처리 - 사용안함(추후삭제)
			...
			vo.setPriSpMnVOs((PriSpMnVO[])getVOs(request, PriSpMnVO.class, "sheet1_"));
			vo.setPriSpProgVOs((PriSpProgVO[])getVOs(request, PriSpProgVO.class, "sheet1_"));
			vo.getPriSpProgVOs()[0].setProgOfcCd(JSPUtil.getParameter(request, "sheet1_lst_prog_apro_ofc_cd"));
			vo.getPriSpProgVOs()[0].setProgUsrId(JSPUtil.getParameter(request, "sheet1_prop_apro_staff_id"));
			event.setScPropProgVO(vo);
