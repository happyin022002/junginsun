...
*@FileName : ESM_PRI_0060HTMLAction.java
...
public class ESM_PRI_0060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0060HTMLAction 객체를 생성
	 */
	public ESM_PRI_0060HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0060Event event = new EsmPri0060Event();

		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRsltSearchSCRateSearchListVO((RsltSearchSCRateSearchListVO)getVO(request, RsltSearchSCRateSearchListVO.class));
		}
			...
			event.setRsltSearchSCRateSearchBulletListVO((RsltSearchSCRateSearchBulletListVO)getVO(request, RsltSearchSCRateSearchBulletListVO.class));
		}
