...
*@FileName : CommodityDBDAOPriSgGrpCmdtDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOPriSgGrpCmdtDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sg_grp_cmdt_dtl 테이블 조회
	  * </pre>
	  */
	public CommodityDBDAOPriSgGrpCmdtDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOPriSgGrpCmdtDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
