...
*@FileName : ArrNtcInfoListVO.java
*@FileTitle : ArrNtcInfoListVO
*Open Issues :
*Change history :
...
public class ArrNtcInfoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<ArrNtcInfoListVO> models = new ArrayList<ArrNtcInfoListVO>();
	...
	/* Column Info */
	private String vslFlgCntNm = null;
	...
	public ArrNtcInfoListVO() {}

	public ArrNtcInfoListVO(String ibflag, String pagerows, String bkgNo, String vslCd, String skdVoyNo, String skdDirCd, String vslNm, String blNo, String deTermCd, String delCd, String hubLocCd, String podArrDt, String delArrDt, String pkupAvalDt, String pkupFreeDt, String podFirms, String pkupYdCd, String pkupFirms, String rtnYdCd, String anFomCd, String diffRmk, String chnAgnCd, String ntcRvisFlg, String isValidated, String vvd, String cntrType, String seq, String podCd, String locGood, String vslFlg, String vslFlgCntNm) {
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("loc_good", getLocGood());
		this.hashColumns.put("vsl_flg", getVslFlg());
		this.hashColumns.put("vsl_flg_cnt_nm", getVslFlgCntNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("loc_good", "locGood");
		this.hashFields.put("vsl_flg", "vslFlg");
		this.hashFields.put("vsl_flg_cnt_nm", "vslFlgCntNm");
	 ...
	 * @return vslFlgCntNm
	 */
	public String getVslFlgCntNm() {
		return this.vslFlgCntNm;
	}
	 ...
	 * @param vslFlgCntNm
	 */
	public void setVslFlgCntNm (String vslFlgCntNm) {
		this.vslFlgCntNm = vslFlgCntNm;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLocGood(JSPUtil.getParameter(request, "loc_good", ""));
		setVslFlg(JSPUtil.getParameter(request, "vsl_flg", ""));
		setVslFlgCntNm(JSPUtil.getParameter(request, "vsl_flg_cnt_nm", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return ArrNtcInfoListVO[]
	 */
	public ArrNtcInfoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ArrNtcInfoListVO[]
	 */
	public ArrNtcInfoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ArrNtcInfoListVO model = null;
		...
		try {
			...
			String[] locGood = (JSPUtil.getParameter(request, prefix	+ "loc_good", length));
			String[] vslFlg = (JSPUtil.getParameter(request, prefix	+ "vsl_flg", length));
			String[] vslFlgCntNm = (JSPUtil.getParameter(request, prefix	+ "vsl_flg_cnt_nm", length));

			for (int i = 0; i < length; i++) {
				model = new ArrNtcInfoListVO();
				if (vslCd[i] != null)
				...
				if (vslFlgCntNm[i] != null)
					model.setVslFlgCntNm(vslFlgCntNm[i]);
				models.add(model);
			}
	 ...
	 * @return ArrNtcInfoListVO[]
	 */
	public ArrNtcInfoListVO[] getArrNtcInfoListVOs(){
		ArrNtcInfoListVO[] vos = (ArrNtcInfoListVO[])models.toArray(new ArrNtcInfoListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.vslFlgCntNm = this.vslFlgCntNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
