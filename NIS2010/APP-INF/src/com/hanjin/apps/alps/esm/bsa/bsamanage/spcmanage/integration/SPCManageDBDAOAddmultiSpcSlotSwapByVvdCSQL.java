...
*@FileName : SPCManageDBDAOAddmultiSpcSlotSwapByVvdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPCManageDBDAOAddmultiSpcSlotSwapByVvdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Bsa_Vvd_Swap_Info  Insert  쿼리
	  * </pre>
	  */
	public SPCManageDBDAOAddmultiSpcSlotSwapByVvdCSQL(){
		setQuery();
		...
		query.append("FileName : SPCManageDBDAOAddmultiSpcSlotSwapByVvdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BSA_VVD_SWAP_INFO (" ).append("\n"); 
		...
		query.append(",	SLT_SWAP_RLANE_CD" ).append("\n"); 
		query.append(",	SLS_TEU_CAPA" ).append("\n"); 
		query.append(",	SLS_WGT" ).append("\n"); 
		query.append(",	PUR_TEU_CAPA" ).append("\n"); 
		query.append(",	PUR_WGT" ).append("\n"); 
		query.append(",	SLT_SWAP_VVD_CD" ).append("\n"); 
		query.append(",	SLT_SWAP_TEU_CAPA" ).append("\n"); 
		query.append(",	SLT_SWAP_WGT" ).append("\n"); 
		query.append(",	SLT_SWAP_AMT" ).append("\n"); 
