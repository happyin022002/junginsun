...
*@FileName : FFCommCalculationDBDAOModifyAGNBKGInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOModifyAGNBKGInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOModifyAGNBKGInfoUSQL
	  * 
	  ...
	  * </pre>
	  */
	public FFCommCalculationDBDAOModifyAGNBKGInfoUSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOModifyAGNBKGInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                           END," ).append("\n"); 
		query.append("                           VV1.VSL_CD || VV1.SKD_VOY_NO || VV1.SKD_DIR_CD || NVL((SELECT NVL(POD_RLANE_DIR_CD, RLANE_DIR_CD) AS RLANE_DIR_CD" ).append("\n"); 
		...
		query.append("                                          THEN 'CFDR' || TO_CHAR(SYSDATE, 'YYMM') || 'EE'" ).append("\n"); 
		query.append("                           END," ).append("\n"); 
		query.append("                           VV2.VSL_CD || VV2.SKD_VOY_NO || VV2.SKD_DIR_CD || NVL((SELECT NVL(POD_RLANE_DIR_CD, RLANE_DIR_CD) AS RLANE_DIR_CD" ).append("\n"); 
		query.append("                                                                                  FROM AR_FINC_DIR_CONV" ).append("\n"); 
		...
		query.append("                                          THEN 'CFDR' || TO_CHAR(SYSDATE, 'YYMM') || 'EE'" ).append("\n"); 
		query.append("                           END," ).append("\n"); 
		query.append("                           VV3.VSL_CD || VV3.SKD_VOY_NO || VV3.SKD_DIR_CD || NVL((SELECT NVL(POD_RLANE_DIR_CD, RLANE_DIR_CD) AS RLANE_DIR_CD" ).append("\n"); 
		query.append("                                                                                  FROM AR_FINC_DIR_CONV" ).append("\n"); 
		...
		query.append("                                          THEN 'CFDR' || TO_CHAR(SYSDATE, 'YYMM') || 'EE'" ).append("\n"); 
		query.append("                           END," ).append("\n"); 
		query.append("                           VV4.VSL_CD || VV4.SKD_VOY_NO || VV4.SKD_DIR_CD || NVL((SELECT NVL(POD_RLANE_DIR_CD, RLANE_DIR_CD) AS RLANE_DIR_CD" ).append("\n"); 
		query.append("                                                                                  FROM AR_FINC_DIR_CONV" ).append("\n"); 
		...
		query.append("    TBL.REV_VVD_CD = CASE WHEN PSD.WDR_CHK = 1 AND PSD.TRNK_VSL_CD IN ('SMXX', 'SMYY', 'SMZZ')" ).append("\n"); 
		query.append("                            THEN 'CNTC' || TO_CHAR(SYSDATE, 'YYMM') || 'MM'" ).append("\n"); 
		...
		query.append("    CASE WHEN PSD.WDR_CHK = 1 AND PSD.TRNK_VSL_CD IN ('SMXX', 'SMYY', 'SMZZ')" ).append("\n"); 
		query.append("           THEN 'CNTC' || TO_CHAR(SYSDATE, 'YYMM') || 'MM'" ).append("\n"); 
		query.append("         ELSE PSD.REV_VVD_CD" ).append("\n"); 
		query.append("    END," ).append("\n"); 
