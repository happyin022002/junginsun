...
*@FileName : EQHoldingDBDAORemoveEqHoldingCostDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQHoldingDBDAORemoveEqHoldingCostDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQHoldingDBDAORemoveEqHoldingCostDSQL(){
		setQuery();
		...
		query.append("FileName : EQHoldingDBDAORemoveEqHoldingCostDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MAS_HLD_COST" ).append("\n"); 
