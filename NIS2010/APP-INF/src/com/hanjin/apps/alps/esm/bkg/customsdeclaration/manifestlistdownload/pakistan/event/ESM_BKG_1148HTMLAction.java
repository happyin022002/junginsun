 ...
 *@FileName : ESM_BKG_1148HTMLAction.java
...
public class ESM_BKG_1148HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1148HTMLAction 객체를 생성 
	 */
	public ESM_BKG_1148HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1148Event event = new EsmBkg1148Event();

    	ManifestListCondVO manifestListCondVO = new PakistanManifestListCondVO();
		 
		if(command.isCommand(FormCommand.SEARCH)) {
			manifestListCondVO = (PakistanManifestListCondVO)getVO(request, PakistanManifestListCondVO.class);
			event.setPakistanManifestListCondVO((PakistanManifestListCondVO)manifestListCondVO);
