...
*@FileName : CommodityDBDAOPriSpScpGrpCmdtDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOPriSpScpGrpCmdtDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pri_sp_scp_grp_cmdt_dtl 테이블 조회
	  * </pre>
	  */
	public CommodityDBDAOPriSpScpGrpCmdtDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOPriSpScpGrpCmdtDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
