...
public class SriLankaManifestListDownloadDBDAOaddVesselArrivalCSQL implements ISQLTemplate{
	...
	public SriLankaManifestListDownloadDBDAOaddVesselArrivalCSQL(){
		...
		params.put("cstms_vvd_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("msg_ref_no",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("	(IO_BND_CD, VSL_RGST_NO, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, PORT_CD, VSL_NM, " ).append("\n"); 
		query.append("	 ETA_DT, ETD_DT, CAP_NM, VSL_CNT_CD, SVC_PRE_PORT_CD, SHP_AGN_NM, " ).append("\n"); 
		query.append("	 LOCL_SHP_AGN_NM, CRE_DT, CRE_USR_ID,UPD_USR_ID,UPD_DT,CSTMS_VVD_CD, MSG_REF_NO)" ).append("\n"); 
		query.append("VALUES" ).append("\n"); 
		query.append("	(@[io_bnd_cd], @[vsl_rgst_no], @[vsl_cd], @[skd_voy_no],@[skd_dir_cd] ,@[port_cd], NVL(@[vsl_nm],''), " ).append("\n"); 
		...
		query.append("     @[cstms_vvd_cd],@[msg_ref_no])" ).append("\n"); 
