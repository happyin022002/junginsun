...
*@FileName : ScOftAutoRatingDBDAOcheckOftRateMatchRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScOftAutoRatingDBDAOcheckOftRateMatchRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScOftAutoRatingDBDAOcheckOftRateMatchRSQL(){
		setQuery();
		...
		query.append("FileName : ScOftAutoRatingDBDAOcheckOftRateMatchRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
