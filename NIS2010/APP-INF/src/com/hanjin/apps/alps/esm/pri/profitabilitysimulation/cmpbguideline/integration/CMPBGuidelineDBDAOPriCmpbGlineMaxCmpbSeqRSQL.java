...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineMaxCmpbSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriCmpbGlineMaxCmpbSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineMaxCmpbSeqRSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineMaxCmpbSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(MAX(CMPB_SEQ)+1,1) AS MAX_CMPB_SEQ" ).append("\n"); 
