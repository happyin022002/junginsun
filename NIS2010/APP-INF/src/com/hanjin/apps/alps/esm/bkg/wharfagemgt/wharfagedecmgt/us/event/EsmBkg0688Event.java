...
/**
 * ESM_BKG_0688 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_BKG_0688HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * 
 * @author Kim Min Jeong
 * @see ESM_BKG_0688HTMLAction 참조
 * @since J2EE 1.4
 */
public class EsmBkg0688Event extends EventSupport {
