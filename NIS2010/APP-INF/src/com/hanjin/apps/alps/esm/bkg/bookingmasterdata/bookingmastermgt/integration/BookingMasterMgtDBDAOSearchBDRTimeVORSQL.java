...
public class BookingMasterMgtDBDAOSearchBDRTimeVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",       T.BDR_RSN_CD" ).append("\n"); 
		query.append(",       T.BDR_RSN_RMK" ).append("\n"); 
		query.append(",       T.BDR_CXL_USR_ID" ).append("\n"); 
		query.append(",       TO_CHAR(T.BDR_CXL_DT,'YYYY-MM-DD HH24:MI:SS') BDR_CXL_DT" ).append("\n"); 
		...
		query.append(",       G.BDR_RSN_CD" ).append("\n"); 
		query.append(",       G.BDR_RSN_RMK" ).append("\n"); 
		query.append(",       G.BDR_CXL_USR_ID" ).append("\n"); 
		query.append(",       G.BDR_CXL_DT" ).append("\n"); 
		query.append("  FROM BKG_BOOKING A," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${bkg_no} == '' && ${rhq_ofc_cd} != '')" ).append("\n"); 
		query.append(" AND  @[rhq_ofc_cd] = (SELECT OFC_CD FROM COM_USER WHERE USR_ID = G.BDR_CXL_USR_ID)" ).append("\n"); 
		query.append(" AND G.BDR_CXL_USR_ID IS NOT NULL" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${bkg_no} == '' && ${from_dt} != '' && ${to_dt} != '')" ).append("\n"); 
		query.append(" AND  G.BDR_CXL_DT BETWEEN TO_DATE(@[from_dt],'YYYY-MM-DD') AND TO_DATE(@[to_dt],'YYYY-MM-DD')+0.99999" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("" ).append("\n"); 
