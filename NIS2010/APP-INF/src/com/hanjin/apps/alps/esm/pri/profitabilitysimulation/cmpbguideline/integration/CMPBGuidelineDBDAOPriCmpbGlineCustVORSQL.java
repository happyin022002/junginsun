...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVORSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineCustVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineCustVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FROM PRI_CMPB_GLINE_CUST" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}