...
*@FileName : ACMReportDBDAORemoveReportGroupListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMReportDBDAORemoveReportGroupListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMReportDBDAORemoveReportGroupListDSQL(){
		setQuery();
		...
		query.append("FileName : ACMReportDBDAORemoveReportGroupListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE AGT_RPT_ITM_INFO_MST" ).append("\n"); 
