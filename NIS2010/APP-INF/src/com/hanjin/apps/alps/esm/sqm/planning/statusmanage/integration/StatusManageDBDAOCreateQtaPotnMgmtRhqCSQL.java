...
*@FileName : StatusManageDBDAOCreateQtaPotnMgmtRhqCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateQtaPotnMgmtRhqCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * "Basic Data Creation" & "Lane-Office Relation Setting" 의 데이터를 이용하여 "QTA Set up by RHQ_OB Loading", "QTA Set up by RHQ_NON OB Contract", "QTA Set up by RHQ_OB Contract" 화면의 데이터를 생성
	  * [CHM-201328244] IAS Sector Sales 판매시스템 개발
	  * 20160422 CHM-201641278 [SQM] IAS Trade 판매목표 수립 Portion 연결 시스템 수정 요청 CSR
	  * </pre>
	  */
	public StatusManageDBDAOCreateQtaPotnMgmtRhqCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateQtaPotnMgmtRhqCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
