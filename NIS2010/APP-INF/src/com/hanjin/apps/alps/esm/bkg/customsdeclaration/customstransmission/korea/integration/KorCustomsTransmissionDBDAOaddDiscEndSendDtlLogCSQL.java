...
*@FileName : KorCustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOaddDiscEndSendDtlLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
