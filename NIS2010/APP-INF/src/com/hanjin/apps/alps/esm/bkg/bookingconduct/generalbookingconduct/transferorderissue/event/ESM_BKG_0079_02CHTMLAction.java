...
public class ESM_BKG_0079_02CHTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setCmdt     (JSPUtil.getNullNoTrim(request.getParameter("cmdt")));
			event.setReceiver (JSPUtil.getNullNoTrim(request.getParameter("receiver")));
			event.setOther    (JSPUtil.getNullNoTrim(request.getParameter("other")));
			event.setCustNtc  (JSPUtil.getNullNoTrim(request.getParameter("cust_ntc")));
			event.setSlctCntr (JSPUtil.getNullNoTrim(request.getParameter("slct_cntr")));
