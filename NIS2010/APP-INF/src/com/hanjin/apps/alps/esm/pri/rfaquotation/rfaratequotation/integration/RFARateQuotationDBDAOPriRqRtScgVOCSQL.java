...
*@FileName : RFARateQuotationDBDAOPriRqRtScgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtScgVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *    Surcharge Detail 생성 ( UI_PRI_6018, UC-PRI-062 )
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtScgVOCSQL(){
		setQuery();
		...
		params.put("trf_scg_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtScgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RQ_RT_SCG(" ).append("\n"); 
