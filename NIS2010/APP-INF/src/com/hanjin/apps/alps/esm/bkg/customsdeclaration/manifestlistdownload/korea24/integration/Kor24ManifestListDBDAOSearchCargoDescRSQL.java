...
*@FileName : Kor24ManifestListDBDAOSearchCargoDescRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchCargoDescRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchCargoDescRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchCargoDescRSQL").append("\n");
		query.append("*/").append("\n");
	}
}