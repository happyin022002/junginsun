...
*@FileName : ESM_BKG_2006HTMLAction.java
*@FileTitle : INV I/F Status Inquiry
*Open Issues :
*Change history :
...
public class ESM_BKG_2006HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_2006HTMLAction 객체를 생성
     */
    public ESM_BKG_2006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg2006Event event = new EsmBkg2006Event();

		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((InvIfDiffVO) getVO(request, InvIfDiffVO.class));
		}
