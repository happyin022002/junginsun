...
*@FileName : GNAExpCreByOfcVO.java
*@FileTitle : GNAExpCreByOfcVO
*Open Issues :
*Change history :
...
public class GNAExpCreByOfcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<GNAExpCreByOfcVO> models = new ArrayList<GNAExpCreByOfcVO>();
	...
	public GNAExpCreByOfcVO() {}

	public GNAExpCreByOfcVO(String ibflag, String pagerows, String costYrmon, String ofcCd, String loclCurrCd, String ofcGrpNo, String budLoclAmt, String budUsdAmt, String expnUsdAmt, String usdLoclXchRt, String creUsrId, String creDt, String updUsrId, String updDt) {
...
/**
	 ...
	 */
	public GNAExpCreByOfcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return GNAExpCreByOfcVO[]
	 */
	public GNAExpCreByOfcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		GNAExpCreByOfcVO model = null;
	...
	public GNAExpCreByOfcVO[] getGNAExpCreByOfcVOs(){
		GNAExpCreByOfcVO[] vos = (GNAExpCreByOfcVO[])models.toArray(new GNAExpCreByOfcVO[models.size()]);
		return vos;
	}
