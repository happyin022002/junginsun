...
public class GeneralBookingListSearchDBDAOSearchBkgListForCompFirmRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  #if(${s_cust_cnt_cd} == '' )" ).append("\n"); 
		query.append("     and sh.cust_nm      like '%'||@[s_cust_nm]||'%'" ).append("\n"); 
		query.append("  #end   " ).append("\n"); 
		query.append("#end   " ).append("\n"); 
		...
		query.append("  #if(${f_cust_cnt_cd} == '') " ).append("\n"); 
		query.append("     and ff.cust_nm      like '%'||@[f_cust_nm]||'%'" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("#end   " ).append("\n"); 
		...
		query.append("   and nvl(bk.aloc_sts_cd, 'F') = @[aloc_sts_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${aloc_sts_cd} != 'F' && ${aloc_svc_cd} != '')    " ).append("\n"); 
		query.append("   and bk.aloc_svc_cd = @[aloc_svc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#end   " ).append("\n"); 
