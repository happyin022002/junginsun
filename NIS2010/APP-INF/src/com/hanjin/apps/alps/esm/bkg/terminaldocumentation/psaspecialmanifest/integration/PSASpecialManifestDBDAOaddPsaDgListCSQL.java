...
*@FileName : PSASpecialManifestDBDAOaddPsaDgListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOaddPsaDgListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSASpecialManifestDBDAOaddPsaDgListCSQL(){
		setQuery();
		...
		query.append("FileName : PSASpecialManifestDBDAOaddPsaDgListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_DG (" ).append("\n"); 
