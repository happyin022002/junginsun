...
*@FileName : FFCommCalculationDBDAORemoveFFDetailNotIFDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAORemoveFFDetailNotIFDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAORemoveFFDetailNotIFDSQL
	  * </pre>
	  */
	public FFCommCalculationDBDAORemoveFFDetailNotIFDSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAORemoveFFDetailNotIFDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM ACM_FF_CMPN_DTL" ).append("\n"); 
