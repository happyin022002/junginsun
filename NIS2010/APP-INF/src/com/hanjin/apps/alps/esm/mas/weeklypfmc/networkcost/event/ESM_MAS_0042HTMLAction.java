...
*@FileName : ESM_MAS_0042HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */ 
public class ESM_MAS_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0042HTMLAction 객체를 생성
	 */
	public ESM_MAS_0042HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0042Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0042Event event = new EsmMas0042Event();   	
    	
		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.MULTI01)) {
			...
			event.setSearchOtherVesselDailyHireListVOs((SearchOtherVesselDailyHireListVO[])getVOs(request, SearchOtherVesselDailyHireListVO.class, ""));
