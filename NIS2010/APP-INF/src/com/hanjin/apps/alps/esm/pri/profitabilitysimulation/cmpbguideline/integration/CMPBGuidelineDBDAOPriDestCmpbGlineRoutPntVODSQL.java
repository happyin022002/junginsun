...
*@FileName : CMPBGuidelineDBDAOPriDestCmpbGlineRoutPntVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriDestCmpbGlineRoutPntVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * base seq 별 Dest 별 삭제
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriDestCmpbGlineRoutPntVODSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriDestCmpbGlineRoutPntVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_CMPB_GLINE_ROUT_PNT" ).append("\n"); 
