...
public class LaneSimulationDBDAOCreateSimDailyHireCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_SIM_DLY_HIR(SIM_DT, SIM_NO, VSL_CD, SGRP_COST_CD, VSL_DLY_COST_AMT, VSL_DLY_UC_AMT, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT) " ).append("\n"); 
		...
		query.append("             ,MAS_OWN_VSL_DLY_HIR A2 " ).append("\n"); 
		query.append("             ,MAS_CHRG_VSL_DLY_HIR A3 " ).append("\n"); 
		query.append("             ,MAS_STND_ACCT A4 " ).append("\n"); 
		query.append("             ,MAS_TM_CHTR_OUT_HIR A5 " ).append("\n"); 
		query.append("             ,( " ).append("\n"); 
