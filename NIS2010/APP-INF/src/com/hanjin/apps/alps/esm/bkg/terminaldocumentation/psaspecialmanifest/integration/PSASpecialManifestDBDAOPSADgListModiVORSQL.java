...
*@FileName : PSASpecialManifestDBDAOPSADgListModiVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSASpecialManifestDBDAOPSADgListModiVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSADgListModiVO 생성을 위해 사용
	  * </pre>
	  */
	public PSASpecialManifestDBDAOPSADgListModiVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.terminaldocumentation.psaspecialmanifest.integration").append("\n"); 
		query.append("FileName : PSASpecialManifestDBDAOPSADgListModiVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
