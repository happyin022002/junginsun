...
*@FileName : FFCmpnCSRValidCheckVO.java
*@FileTitle : FFCmpnCSRValidCheckVO
*Open Issues :
*Change history :
...
public class FFCmpnCSRValidCheckVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FFCmpnCSRValidCheckVO> models = new ArrayList<FFCmpnCSRValidCheckVO>();
	...
	public FFCmpnCSRValidCheckVO() {}

	public FFCmpnCSRValidCheckVO(String ibflag, String pagerows, String bkgNo, String bkgCreDt, String bkgStsCd, String ffCmpnSeq) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return FFCmpnCSRValidCheckVO[]
	 */
	public FFCmpnCSRValidCheckVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FFCmpnCSRValidCheckVO[]
	 */
	public FFCmpnCSRValidCheckVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FFCmpnCSRValidCheckVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new FFCmpnCSRValidCheckVO();
				if (bkgNo[i] != null)
		...
		return getFFCmpnCSRValidCheckVOs();
	}
	 ...
	 * @return FFCmpnCSRValidCheckVO[]
	 */
	public FFCmpnCSRValidCheckVO[] getFFCmpnCSRValidCheckVOs(){
		FFCmpnCSRValidCheckVO[] vos = (FFCmpnCSRValidCheckVO[])models.toArray(new FFCmpnCSRValidCheckVO[models.size()]);
		return vos;
	}
