...
*@FileName : ESM_BKG_1601HTMLAction.java
...
public class ESM_BKG_1601HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1601HTMLAction 객체를 생성
	 */
	public ESM_BKG_1601HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1601Event event = new EsmBkg1601Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChargeAmendAuthRequestListVO((ChargeAmendAuthRequestListVO)getVO(request, ChargeAmendAuthRequestListVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI01)) {
			event.setChargeAmendAuthRequestListVOs((ChargeAmendAuthRequestListVO[])getVOs(request, ChargeAmendAuthRequestListVO.class, ""));
		}
