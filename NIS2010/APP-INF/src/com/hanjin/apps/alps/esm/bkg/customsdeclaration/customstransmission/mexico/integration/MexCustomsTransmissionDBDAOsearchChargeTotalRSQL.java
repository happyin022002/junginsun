...
*@FileName : MexCustomsTransmissionDBDAOsearchChargeTotalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MexCustomsTransmissionDBDAOsearchChargeTotalRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DWKIM, 0370, OUTVO : MxChargeTotalVO
	  * </pre>
	  */
	public MexCustomsTransmissionDBDAOsearchChargeTotalRSQL(){
		setQuery();
		...
		query.append("FileName : MexCustomsTransmissionDBDAOsearchChargeTotalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
