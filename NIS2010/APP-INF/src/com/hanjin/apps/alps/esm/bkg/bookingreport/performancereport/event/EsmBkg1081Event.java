...
public class EsmBkg1081Event extends EventSupport {
	...
	public void setAutoratingReportVOS(AutoratingReportVO[] autoratingReportVOs){
		if(autoratingReportVOs != null){
			AutoratingReportVO[] tmpVOs = new AutoratingReportVO[autoratingReportVOs.length];
			System.arraycopy(autoratingReportVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	public AutoratingReportVO[] getAutoratingReportVOS(){
		...
		if (this.autoratingReportVOs != null) {
			rtnVOs = new AutoratingReportVO[autoratingReportVOs.length];
			System.arraycopy(autoratingReportVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
