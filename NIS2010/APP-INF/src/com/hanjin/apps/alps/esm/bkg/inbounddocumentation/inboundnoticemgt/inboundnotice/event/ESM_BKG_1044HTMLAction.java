...
*@FileName : ESM_BKG_1044HTMLAction.java
 ...
 * @author Son Yun Seuk
 * @see EsmBkg1044Event 참조
 * @since J2EE 1.4
 */

public class ESM_BKG_1044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1044HTMLAction 객체를 생성
	 */
	public ESM_BKG_1044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException 
	{
		...
		EsmBkg1044Event event = new EsmBkg1044Event();
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgIbCmdtCntcVOs((BkgIbCmdtCntcVO[]) getVOs(request, BkgIbCmdtCntcVO.class));
		}else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgIbCmdtCntcVO((BkgIbCmdtCntcVO) getVO(request, BkgIbCmdtCntcVO.class));
		}
