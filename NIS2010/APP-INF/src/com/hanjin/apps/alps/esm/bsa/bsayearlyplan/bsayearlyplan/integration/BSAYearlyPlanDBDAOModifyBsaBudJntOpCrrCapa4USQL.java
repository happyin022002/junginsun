...
*@FileName : BSAYearlyPlanDBDAOModifyBsaBudJntOpCrrCapa4USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOModifyBsaBudJntOpCrrCapa4USQL implements ISQLTemplate{
	...
	/**
	  ...
	  *                                                        - BSA Creation/Update(Yearly Plan) - Joint Operating 수정시 Weight Update 
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOModifyBsaBudJntOpCrrCapa4USQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOModifyBsaBudJntOpCrrCapa4USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        (CRR_BSA_CAPA) = (SELECT NVL(SUM(DECODE(B.BSA_OP_JB_CD, '007', B.SPC_CTRL_SLT_CAPA)), 0) * NVL(SUM(DECODE(B.BSA_OP_JB_CD, '008', B.SPC_CTRL_SLT_CAPA)), 0)  CRR_BSA_CAPA" ).append("\n"); 
