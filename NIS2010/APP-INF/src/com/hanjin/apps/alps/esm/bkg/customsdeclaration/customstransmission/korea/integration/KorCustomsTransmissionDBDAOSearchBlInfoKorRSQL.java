...
*@FileName : KorCustomsTransmissionDBDAOSearchBlInfoKorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOSearchBlInfoKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOSearchBlInfoKorRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("BKG_CSTMS_KR_BL T2," ).append("\n"); 
		query.append("BKG_CSTMS_KR_CNTR C" ).append("\n"); 
		...
		query.append("FileName : KorCustomsTransmissionDBDAOSearchBlInfoKorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}