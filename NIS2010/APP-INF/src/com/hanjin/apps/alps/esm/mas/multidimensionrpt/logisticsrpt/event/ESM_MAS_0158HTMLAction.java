...
*@FileName : ESM_MAS_0158HTMLAction.java
...
public class ESM_MAS_0158HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0158HTMLAction 객체를 생성
	 */
	public ESM_MAS_0158HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0158Event event = new EsmMas0158Event();
