 ...
 *@FileName : ESM_BKG_960HTMLAction.java
...
public class ESM_BKG_0960HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;

    /**
     * ESM_BKG_960HTMLAction 객체를 생성
     */
    public ESM_BKG_0960HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0960Event event = new EsmBkg0960Event();
        log.debug("***** ESM_BKG_960HTMLAction : " + command.getCommand());
