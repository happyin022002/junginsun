...
public class KrWharfageDecMgtDBDAOsearchKrWhfDecEdiVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",DECODE(@[whf_bnd_cd],'ON','OO','OT','OO','OM','OO',@[whf_bnd_cd]) AS IO_IND" ).append("\n"); 
		query.append(",DECODE(@[whf_bnd_cd],'ON','OO','OT','OO','OM','OO',@[whf_bnd_cd]) AS SND_IND" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append(",DECODE(@[port_cd]" ).append("\n"); 
		...
		query.append("				,' ') AS DSCH_COM /*  선사/대리점 코드    */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
