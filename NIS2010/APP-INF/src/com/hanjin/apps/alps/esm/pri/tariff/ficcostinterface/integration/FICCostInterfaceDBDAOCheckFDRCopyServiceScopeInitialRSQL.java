...
*@FileName : FICCostInterfaceDBDAOCheckFDRCopyServiceScopeInitialRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCheckFDRCopyServiceScopeInitialRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CheckFDRCopyServiceScopeInitial
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCheckFDRCopyServiceScopeInitialRSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCheckFDRCopyServiceScopeInitialRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
