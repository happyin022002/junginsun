...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutPntPasteVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriRoutPntPasteVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriRoutPntPasteVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutPntPasteVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_GRI_ROUT_PNT (" ).append("\n"); 
		...
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_GRI_ROUT_PNT_CPY CPY" ).append("\n"); 
		...
		query.append("		OR ( 	ROUT_PNT_LOC_TP_CD = 'G' " ).append("\n"); 
		...
		query.append("									AND A.PRC_GRP_LOC_CD = CPY.ROUT_PNT_LOC_DEF_CD" ).append("\n"); 
		query.append("							)" ).append("\n"); 
		query.append("			)" ).append("\n"); 
		query.append("	)" ).append("\n"); 
