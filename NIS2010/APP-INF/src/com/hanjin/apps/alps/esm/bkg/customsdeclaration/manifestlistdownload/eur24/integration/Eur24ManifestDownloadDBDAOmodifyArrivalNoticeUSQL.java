...
*@FileName : Eur24ManifestDownloadDBDAOmodifyArrivalNoticeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOmodifyArrivalNoticeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Original Country/Port및 First Office code를 수정하는 코드
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOmodifyArrivalNoticeUSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOmodifyArrivalNoticeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	N1ST_CLPT_CD = @[n1st_clpt_cd],	" ).append("\n"); 
		query.append("	RVIS_N1ST_CLPT_CD = @[rvis_n1st_clpt_cd],	" ).append("\n"); 
		query.append("	LST_CLPT_CD = @[lst_clpt_cd],    " ).append("\n"); 
		...
		query.append("	CSTMS_YD_CD = @[cstms_yd_cd]," ).append("\n"); 
