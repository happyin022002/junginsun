...
*@FileName : ESM_MAS_0013HTMLAction.java
...
public class ESM_MAS_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0013HTMLAction 객체를 생성
	 */
	public ESM_MAS_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0013Event event = new EsmMas0013Event();
		
		event.setSearchConditionVO((SearchConditionVO)getVO(request, SearchConditionVO .class));
		if(command.isCommand(FormCommand.MULTI)) {
//			event.setEqHoldingCostVOS((EqHoldingCostVO[])getVOs(request, EqHoldingCostVO .class,""));
			event.setEqCntrHldCostVOS((EqCntrHldCostVO[])getVOs(request, EqCntrHldCostVO .class,""));
