...
*@FileName : ESM_BKG_1422HTMLAction.java
...
public class ESM_BKG_1422HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1422HTMLAction 객체를 생성
	 */
	public ESM_BKG_1422HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("\n\n\n\n\n   ESM_BKG_1422HTMLAction aaaaaaaaaaaaaaaa  Start \n\n\n\n");

		
    	FormCommand command = FormCommand.fromRequest(request);
		EsmBkg1422Event event = new EsmBkg1422Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setWscBkgListForAuditSchVO((WscBkgListForAuditSchVO)getVO(request, WscBkgListForAuditSchVO .class));
		}
