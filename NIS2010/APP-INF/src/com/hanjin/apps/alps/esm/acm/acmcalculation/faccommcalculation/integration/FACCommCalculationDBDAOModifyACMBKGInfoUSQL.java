...
*@FileName : FACCommCalculationDBDAOModifyACMBKGInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FACCommCalculationDBDAOModifyACMBKGInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FACCommCalculationDBDAOModifyACMBKGInfoUSQL
	  * </pre>
	  */
	public FACCommCalculationDBDAOModifyACMBKGInfoUSQL(){
		setQuery();
		...
		query.append("FileName : FACCommCalculationDBDAOModifyACMBKGInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT FRT.BKG_NO," ).append("\n"); 
		...
		query.append("  (SELECT INP.BKG_NO," ).append("\n"); 
		...
		query.append("     SUM(CASE WHEN BCR.FRT_TERM_CD = 'P' AND BCR.CHG_CD = 'OFT' AND BCR.CURR_CD = 'USD' THEN BCR.CHG_AMT" ).append("\n"); 
		query.append("              WHEN BCR.FRT_TERM_CD = 'P' AND BCR.CHG_CD = 'OFT' AND NVL(MXR.USD_LOCL_XCH_RT, 0) <> 0" ).append("\n"); 
		query.append("                THEN BCR.CHG_AMT / MXR.USD_LOCL_XCH_RT" ).append("\n"); 
		query.append("              ELSE 0" ).append("\n"); 
		query.append("         END" ).append("\n"); 
		query.append("     ) AS BKG_PPD_FRT_AMT," ).append("\n"); 
		query.append("     SUM(CASE WHEN BCR.FRT_TERM_CD = 'P' AND BCR.CHG_CD = 'OFT' THEN 0" ).append("\n"); 
		query.append("              WHEN BCR.FRT_TERM_CD = 'P' AND BCR.CURR_CD = 'USD'" ).append("\n"); 
		query.append("                THEN BCR.CHG_AMT" ).append("\n"); 
		query.append("              WHEN BCR.FRT_TERM_CD = 'P' AND NVL(MXR.USD_LOCL_XCH_RT, 0) <> 0" ).append("\n"); 
		query.append("                THEN BCR.CHG_AMT / MXR.USD_LOCL_XCH_RT" ).append("\n"); 
		query.append("              ELSE 0" ).append("\n"); 
		query.append("         END" ).append("\n"); 
		query.append("     ) AS BKG_PPD_OTR_AMT," ).append("\n"); 
		query.append("     SUM(CASE WHEN BCR.FRT_TERM_CD = 'C' AND BCR.CHG_CD = 'OFT' AND BCR.CURR_CD = 'USD' THEN BCR.CHG_AMT" ).append("\n"); 
		query.append("              WHEN BCR.FRT_TERM_CD = 'C' AND BCR.CHG_CD = 'OFT' AND NVL(MXR.USD_LOCL_XCH_RT, 0) <> 0" ).append("\n"); 
		query.append("                THEN BCR.CHG_AMT / MXR.USD_LOCL_XCH_RT" ).append("\n"); 
		query.append("              ELSE 0" ).append("\n"); 
		query.append("         END" ).append("\n"); 
		query.append("     ) AS BKG_CLT_FRT_AMT," ).append("\n"); 
		query.append("     SUM(CASE WHEN BCR.FRT_TERM_CD = 'C' AND BCR.CHG_CD = 'OFT' THEN 0" ).append("\n"); 
		query.append("              WHEN BCR.FRT_TERM_CD = 'C' AND BCR.CURR_CD = 'USD' THEN BCR.CHG_AMT" ).append("\n"); 
		query.append("              WHEN BCR.FRT_TERM_CD = 'C' AND NVL(MXR.USD_LOCL_XCH_RT, 0) <> 0" ).append("\n"); 
		query.append("                THEN BCR.CHG_AMT / MXR.USD_LOCL_XCH_RT" ).append("\n"); 
		query.append("              ELSE 0" ).append("\n"); 
		query.append("         END" ).append("\n"); 
		...
		query.append("        @[ff_cnt_cd] AS FRT_FWRD_CNT_CD," ).append("\n"); 
		query.append("        @[ff_cust_seq] AS FRT_FWRD_SEQ," ).append("\n"); 
		...
		query.append("     AND MXR.ACCT_XCH_RT_YRMON IN (SELECT CASE WHEN RAT.RT_APLY_DT IS NOT NULL" ).append("\n"); 
		query.append("                                                 THEN TO_CHAR (LEAST (RAT.RT_APLY_DT, SYSDATE), 'YYYYMM')" ).append("\n"); 
		query.append("                                               WHEN RAT.RT_APLY_DT IS NULL AND (SELECT NVL(SUM(CNTR_VOL_QTY), 0)" ).append("\n"); 
		...
		query.append("                                                 THEN (SELECT CASE WHEN MAX(BCN.CGO_RCV_DT) IS NULL" ).append("\n"); 
		...
		query.append("                                                       WHERE BCN.BKG_NO = BKG.BKG_NO" ).append("\n"); 
		query.append("                                                 )" ).append("\n"); 
		query.append("                                               ELSE (SELECT TO_CHAR(LEAST(MAX(VSK.INIT_ETD_DT), SYSDATE), 'YYYYMM')" ).append("\n"); 
		...
		query.append(") PSD ON (TBL.BKG_NO = PSD.BKG_NO)" ).append("\n"); 
		query.append("WHEN MATCHED THEN" ).append("\n"); 
		query.append("UPDATE" ).append("\n"); 
		query.append("  SET TBL.BL_NO = PSD.BL_NO," ).append("\n"); 
