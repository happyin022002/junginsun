...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplHdrSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplHdrSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * boiler plate header seq
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplHdrSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplHdrSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MIN(BLPL_HDR_SEQ) BLPL_HDR_SEQ" ).append("\n"); 
