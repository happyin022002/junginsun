...
*@FileName : BLDocumentationCMDBDAOsearchVGMOutboundRcvIdForMVMTRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationCMDBDAOsearchVGMOutboundRcvIdForMVMTRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EDI 322로부터 VGM update된 것이 있다면 EDI setup에 설정된 yard에 한해 Vermas O/B EDI 전송
	  * </pre>
	  */
	public BLDocumentationCMDBDAOsearchVGMOutboundRcvIdForMVMTRSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationCMDBDAOsearchVGMOutboundRcvIdForMVMTRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   AND (   (EY.PRNR_SUB_LNK_CD = BK.POL_NOD_CD  AND MSG.EDI_MSG_IND_CD IN ('15')) --입력된 찾아진 POL과 같음" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                       )" ).append("\n"); 
		query.append("                ) " ).append("\n"); 
		...
		query.append("                        AND MSG.MSG_TP_DESC                      = '1'" ).append("\n"); 
		query.append("           AND MSG.EDI_MSG_TP_ID      = 'VERMAS'" ).append("\n"); 
		query.append("           AND msg.EDI_MSG_IND_CD     IN ('15')" ).append("\n"); 
