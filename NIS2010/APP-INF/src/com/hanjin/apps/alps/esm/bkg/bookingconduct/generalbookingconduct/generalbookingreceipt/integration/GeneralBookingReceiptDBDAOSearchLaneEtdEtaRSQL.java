...
public class GeneralBookingReceiptDBDAOSearchLaneEtdEtaRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       POD_CLPT_IND_SEQ_LIST," ).append("\n"); 
		...
		query.append("               POL_CLPT_IND_SEQ," ).append("\n"); 
		query.append("               POD_CLPT_IND_SEQ," ).append("\n"); 
		query.append("               MIN (POD_CLPT_IND_SEQ) OVER() MIN_POD_CLPT_IND_SEQ" ).append("\n"); 
		query.append("          FROM (" ).append("\n"); 
		...
		query.append("                , to_char(pol.vps_etd_dt,'yyyy-mm-dd hh:mi') etd" ).append("\n"); 
		query.append("                , to_char(pod.vps_eta_dt,'yyyy-mm-dd hh:mi') eta" ).append("\n"); 
		...
		query.append("      )" ).append("\n"); 
		query.append(" WHERE POD_CLPT_IND_SEQ = MIN_POD_CLPT_IND_SEQ" ).append("\n"); 
