...
*@FileName : RFARateProposalDBDAOPriRpScpRtScgCpAmendCancelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtScgCpAmendCancelCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Amend Cancel시 PriRpScpRtScg 테이블 데이터 복구
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtScgCpAmendCancelCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtScgCpAmendCancelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
