...
public class UserAuthListModiVO extends AuthSetupListVO {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("chg_pod", getChgPod());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("chg_pod", "chgPod");
	 ...
	 * @param chgPod
	 */
	public void setChgPod(String chgPod) {
		this.chgPod = chgPod;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setChgPod(JSPUtil.getParameter(request, prefix + "chg_pod", ""));
	...
	public UserAuthListModiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] chgPod = (JSPUtil.getParameter(request, prefix	+ "chg_pod", length));
	...
	*/
	public void unDataFormat(){
		...
		this.chgPod = this.chgPod .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
	}
}
