...
*@FileName : ScqAwkwardDBDAOmodifyPriScqAwkMnForApprCxlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOmodifyPriScqAwkMnForApprCxlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * PRI_SCQ_AWK_MN 테이블의 Status 를 현재 최종 상태로 변경 한다.
	  * </pre>
	  */
	public ScqAwkwardDBDAOmodifyPriScqAwkMnForApprCxlUSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOmodifyPriScqAwkMnForApprCxlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  PRI_SCQ_AWK_MN" ).append("\n"); 
