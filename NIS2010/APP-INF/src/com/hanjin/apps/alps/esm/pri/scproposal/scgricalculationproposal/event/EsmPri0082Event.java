...
/**
 * UI_PRI_0082 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - UI_PRI_0082HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 * 
 * @author Sungsoo, Park
 * @see ESM_PRI_0082HTMLAction 참조
 * @since J2EE 1.4
 */

public class EsmPri0082Event extends EventSupport {

	private static final long serialVersionUID = 1L;
    private PriSpScpRtActCustVO priSpScpRtActCustVO = null;

	public EsmPri0082Event() {
	}
