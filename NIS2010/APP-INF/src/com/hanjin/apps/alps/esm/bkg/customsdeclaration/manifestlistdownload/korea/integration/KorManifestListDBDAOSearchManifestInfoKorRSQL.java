...
*@FileName : KorManifestListDBDAOSearchManifestInfoKorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchManifestInfoKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchManifestInfoKorRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchManifestInfoKorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", NVL(A.CSTMS_CRR_IN_LOC_WH_CD, ' ') CSTMS_CRR_IN_LOC_WH_CD  /* 추가 */" ).append("\n"); 
		query.append(", A.SI_FLG" ).append("\n"); 
		...
		query.append("AND DECODE(LENGTH(@[in_pod_tmnl]),7,PORT_TML_CD,' ') = DECODE(LENGTH(@[in_pod_tmnl]),7,@[in_pod_tmnl],' ')" ).append("\n"); 
		...
		query.append("		CSTMS_DECL_TP_CD = 'I' AND BKG_CGO_TP_CD <> 'P'))" ).append("\n"); 
		query.append("	#elseif(${sel_type} == 'T')" ).append("\n"); 
		query.append("        CSTMS_DECL_TP_CD = 'T' AND BKG_CGO_TP_CD = 'P'))	" ).append("\n"); 
		query.append("	#elseif(${sel_type} == 'R')" ).append("\n"); 
		query.append("        CSTMS_DECL_TP_CD = 'T' AND BKG_CGO_TP_CD <> 'P'))	" ).append("\n"); 
		...
		query.append("B.CSTMS_CRR_IN_LOC_WH_CD," ).append("\n"); 
