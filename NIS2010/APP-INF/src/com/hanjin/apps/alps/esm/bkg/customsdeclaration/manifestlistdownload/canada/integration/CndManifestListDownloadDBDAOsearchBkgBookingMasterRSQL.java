...
*@FileName : CndManifestListDownloadDBDAOsearchBkgBookingMasterRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndManifestListDownloadDBDAOsearchBkgBookingMasterRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchBkgBookingMaster
	  * </pre>
	  */
	public CndManifestListDownloadDBDAOsearchBkgBookingMasterRSQL(){
		setQuery();
		...
		query.append("FileName : CndManifestListDownloadDBDAOsearchBkgBookingMasterRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , NVL(PCK.USA_CSTMS_PCK_CD, 'PKG') AS AMS_PCK_TP_CD" ).append("\n"); 
		...
		query.append("      , CASE WHEN SUBSTR(V.POD_CD, 1, 2) = 'CA' AND SUBSTR(B.DEL_CD, 1,2) = 'CA' THEN '24' " ).append("\n"); 
