 ...
 *@FileName : ESM_PRI_2079HTMLAction.java
...
public class ESM_PRI_2079HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri2079Event event = new EsmPri2079Event();
