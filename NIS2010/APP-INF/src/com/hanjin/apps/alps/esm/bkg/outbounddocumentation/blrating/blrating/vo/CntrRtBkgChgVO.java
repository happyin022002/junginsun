...
*@FileName : CntrRtBkgChgVO.java
*@FileTitle : CntrRtBkgChgVO
*Open Issues :
*Change history :
...
public class CntrRtBkgChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrRtBkgChgVO> models = new ArrayList<CntrRtBkgChgVO>();
	...
	public CntrRtBkgChgVO() {}

	public CntrRtBkgChgVO(String ibflag, String pagerows, String bkgNo, String rtSeq, String dpSeq, String chgCd, String trfItmNo, String currCd, String chgUtAmt, String ratAsQty, String ratUtCd, String chgAmt, String frtInclXcldDivCd, String frtTermCd, String n3ptyRcvOfcCd, String n3ptyCustCntCd, String n3ptyCustSeq, String cgoCateCd, String rcvTermCd, String deTermCd, String imdgClssCd, String invStsCd, String prnHdnFlg, String autoRatCd, String aplyXchRto, String agmtRatUtCd, String creUsrId, String updUsrId) {
		this.dpSeq = dpSeq;
		this.currCd = currCd;
	 ...
	 * @param request
	 * @return CntrRtBkgChgVO[]
	 */
	public CntrRtBkgChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrRtBkgChgVO[]
	 */
	public CntrRtBkgChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrRtBkgChgVO model = null;
	 ...
	 * @return CntrRtBkgChgVO[]
	 */
	public CntrRtBkgChgVO[] getCntrRtBkgChgVOs(){
		CntrRtBkgChgVO[] vos = (CntrRtBkgChgVO[])models.toArray(new CntrRtBkgChgVO[models.size()]);
		return vos;
	}
