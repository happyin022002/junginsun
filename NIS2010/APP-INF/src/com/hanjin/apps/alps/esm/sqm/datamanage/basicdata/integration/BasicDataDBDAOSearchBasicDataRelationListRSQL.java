...
*@FileName : BasicDataDBDAOSearchBasicDataRelationListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BasicDataDBDAOSearchBasicDataRelationListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Basic Data Relation 조회
	  * </pre>
	  */
	public BasicDataDBDAOSearchBasicDataRelationListRSQL(){
		setQuery();
		...
		query.append("FileName : BasicDataDBDAOSearchBasicDataRelationListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     AND TEAM_CD     = @[f_ho_team_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${f_ob_div_cd} != '' && ${f_ob_div_cd} != 'All')" ).append("\n"); 
		query.append("     AND OB_DIV_CD   = @[f_ob_div_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
