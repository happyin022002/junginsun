...
*@FileName : RsltExpChkVO.java
*@FileTitle : RsltExpChkVO
*Open Issues :
*Change history :
...
public class RsltExpChkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltExpChkVO> models = new ArrayList<RsltExpChkVO>();
	...
	public RsltExpChkVO(String ibflag, String pagerows, String svcScpCd, String ctrtEffDt, String ctrtExpDt, String cnt) {
		this.ibflag = ibflag;
		this.cnt = cnt;
	 ...
	 * @return RsltExpChkVO[]
	 */
	public RsltExpChkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltExpChkVO[]
	 */
	public RsltExpChkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltExpChkVO model = null;
	 ...
	 * @return RsltExpChkVO[]
	 */
	public RsltExpChkVO[] getRsltExpChkVOs(){
		RsltExpChkVO[] vos = (RsltExpChkVO[])models.toArray(new RsltExpChkVO[models.size()]);
		return vos;
	}
