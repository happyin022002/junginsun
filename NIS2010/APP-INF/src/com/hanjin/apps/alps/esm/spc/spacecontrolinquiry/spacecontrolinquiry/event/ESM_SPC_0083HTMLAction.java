...
*@FileName : ESM_SPC_0083HTMLAction.java
...
public class ESM_SPC_0083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0083HTMLAction 객체를 생성
	 */
	public ESM_SPC_0083HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSpc0083Event event = new EsmSpc0083Event();
		event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));

		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchWeeklyLfByPolPodListVO((SearchWeeklyLfByPolPodListVO)getVO(request, SearchWeeklyLfByPolPodListVO .class));
