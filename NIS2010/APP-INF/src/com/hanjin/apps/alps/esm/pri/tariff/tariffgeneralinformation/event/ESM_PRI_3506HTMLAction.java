...
*@FileName : ESM_PRI_3506HTMLAction.java
...
public class ESM_PRI_3506HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3506HTMLAction 객체를 생성
	 */
	public ESM_PRI_3506HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri3506Event event = new EsmPri3506Event();
		return  event;
	}
