...
*@FileName : ESM_MAS_168HTMLAction.java
 ...
 *
 * @author Park Eun Ju
 * @see EsmMas0168Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0168HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0168HTMLAction 객체를 생성
	 */
	public ESM_MAS_0168HTMLAction() {
		//
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0168Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0168Event event = new EsmMas0168Event();
