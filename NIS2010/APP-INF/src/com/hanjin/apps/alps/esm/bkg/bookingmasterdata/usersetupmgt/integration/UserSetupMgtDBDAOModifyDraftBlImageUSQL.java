...
*@FileName : UserSetupMgtDBDAOModifyDraftBlImageUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAOModifyDraftBlImageUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UserSetupMgtDBDAOModifyDraftBlImageUSQL
	  * </pre>
	  */
	public UserSetupMgtDBDAOModifyDraftBlImageUSQL(){
		setQuery();
		...
		query.append("FileName : UserSetupMgtDBDAOModifyDraftBlImageUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CUST_BL_IMG_STUP " ).append("\n"); 
		query.append("SET RAT_FLG = DECODE(@[rat_flg],1,'Y','N')," ).append("\n"); 
