...
*@FileName : CntrInfoListVO.java
*@FileTitle : CntrInfoListVO
*Open Issues :
*Change history :
...
public class CntrInfoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrInfoListVO> models = new ArrayList<CntrInfoListVO>();
	 ...
	 */
	public CntrInfoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrInfoListVO[]
	 */
	public CntrInfoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrInfoListVO model = null;
		...
		try {
			...
			String[] cntrHlgFlg = (JSPUtil.getParameter(request, prefix	+ "cntr_hlg_flg", length));
			...
			String[] cntrTaxExptFlg = (JSPUtil.getParameter(request, prefix	+ "cntr_tax_expt_flg", length));
			...
			String[] rmkBlDpFlg = (JSPUtil.getParameter(request, prefix	+ "rmk_bl_dp_flg", length));
	...
	public CntrInfoListVO[] getCntrInfoListVOs(){
		CntrInfoListVO[] vos = (CntrInfoListVO[])models.toArray(new CntrInfoListVO[models.size()]);
		return vos;
	}
