...
package com.hanjin.apps.alps.esm.pri.primasterdata.organization.vo;
...
public class MdmOrzVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmOrzVO> models = new ArrayList<MdmOrzVO>();
	...
	public MdmOrzVO(String ibflag, String pagerows, String ofcTpCd, String ofcCd, String ofcEngNm, String locCd, String prntOfcCd) {
		this.ofcCd = ofcCd;
		this.locCd = locCd;
		this.ibflag = ibflag;
	 ...
	 * @return MdmOrzVO[]
	 */
	public MdmOrzVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmOrzVO[]
	 */
	public MdmOrzVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MdmOrzVO model = null;
	...
	public MdmOrzVO[] getMdmOrzVOs(){
		MdmOrzVO[] vos = (MdmOrzVO[])models.toArray(new MdmOrzVO[models.size()]);
		return vos;
	}
