...
*@FileName : CndCstmsBlMainVO.java
*@FileTitle : CndCstmsBlMainVO
*Open Issues :
*Change history :
...
public class CndCstmsBlMainVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CndCstmsBlMainVO> models = new ArrayList<CndCstmsBlMainVO>();
	...
	public CndCstmsBlMainVO() {}

	public CndCstmsBlMainVO(String ibflag, String pagerows, String blNo, String cstmsFileTpCd, String mfStsCd, String cstmsMfTpCd, String cstmsTrsmStsCd, String mBlNo, String vvdCd, String porCd, String polCd, String podCd, String vpsEtaDt, String delCd, String pckQty, String amsPckTpCd, String cgoWgt, String wgtUtCd, String hubLocCd, String ibdLocGdsDesc, String bkgNo, String frtCltFlg, String oblRdemFlg, String trspTpId, String bdrFlg, String fullMtyCd, String hblCount, String ccnNo, String inTzYdCd1, String inTzYdCd2, String inTzYdZipId, String inTzYdNm, String inTzYdAddr, String inTzYdCtyNm, String inTzYdSteCd, String inTzYdCntCd, String diffRmk, String tBdrFlg, String rnum, String podNodCd) {
		this.porCd = porCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("t_bdr_flg", getTBdrFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("t_bdr_flg", "tBdrFlg");
	 ...
	 * @param tBdrFlg
	 */
	public void setTBdrFlg(String tBdrFlg) {
		this.tBdrFlg = tBdrFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setHblCount(JSPUtil.getParameter(request, prefix + "hbl_count", ""));
		setInTzYdCtyNm(JSPUtil.getParameter(request, prefix + "in_tz_yd_cty_nm", ""));
		setCgoWgt(JSPUtil.getParameter(request, prefix + "cgo_wgt", ""));
		setMBlNo(JSPUtil.getParameter(request, prefix + "m_bl_no", ""));
		setCcnNo(JSPUtil.getParameter(request, prefix + "ccn_no", ""));
		setTBdrFlg(JSPUtil.getParameter(request, prefix + "t_bdr_flg", ""));
		...
		setInTzYdCd1(JSPUtil.getParameter(request, prefix + "in_tz_yd_cd1", ""));
		setInTzYdCd2(JSPUtil.getParameter(request, prefix + "in_tz_yd_cd2", ""));
	 ...
	 */
	public CndCstmsBlMainVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CndCstmsBlMainVO[]
	 */
	public CndCstmsBlMainVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndCstmsBlMainVO model = null;
		...
		try {
			...
			String[] mBlNo = (JSPUtil.getParameter(request, prefix	+ "m_bl_no", length));
			String[] ccnNo = (JSPUtil.getParameter(request, prefix	+ "ccn_no", length));
			String[] tBdrFlg = (JSPUtil.getParameter(request, prefix	+ "t_bdr_flg", length));
			...
			String[] inTzYdCd1 = (JSPUtil.getParameter(request, prefix	+ "in_tz_yd_cd1", length));
			String[] inTzYdCd2 = (JSPUtil.getParameter(request, prefix	+ "in_tz_yd_cd2", length));
	 ...
	 * @return CndCstmsBlMainVO[]
	 */
	public CndCstmsBlMainVO[] getCndCstmsBlMainVOs(){
		CndCstmsBlMainVO[] vos = (CndCstmsBlMainVO[])models.toArray(new CndCstmsBlMainVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tBdrFlg = this.tBdrFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
