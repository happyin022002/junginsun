...
*@FileName : TaiwanCustomsTransmissionDBDAOsearchMsgHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TaiwanCustomsTransmissionDBDAOsearchMsgHeaderRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TaiwanCustomsTransmissionDBDAOsearchMsgHeaderRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.taiwan.integration").append("\n"); 
		query.append("FileName : TaiwanCustomsTransmissionDBDAOsearchMsgHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("RPAD(NVL(TRIM('NISBKG'),' '),20,' ')||" ).append("\n"); 
		query.append("RPAD(NVL(TRIM('KORCUS'),' '),20,' ')||" ).append("\n"); 
