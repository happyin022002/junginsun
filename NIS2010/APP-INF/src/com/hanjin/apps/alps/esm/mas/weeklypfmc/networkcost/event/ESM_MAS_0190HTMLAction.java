...
*@FileName : ESM_MAS_0190HTMLAction.java
 ...
 * @author 유제량
 * @see EsmMas0190Event 참조
 * @since J2EE 1.6
 */ 
public class ESM_MAS_0190HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0190HTMLAction 객체를 생성
	 */
	public ESM_MAS_0190HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0190Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0190Event event = new EsmMas0190Event();
    	
		if(command.isCommand(FormCommand.SEARCH)||command.isCommand(FormCommand.COMMAND01)) {			
			event.setNetworkCostExceptionListVO((NetworkCostExceptionListVO)getVO(request, NetworkCostExceptionListVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {			
			event.setNetworkCostExceptionListVOs((NetworkCostExceptionListVO[])getVOs(request, NetworkCostExceptionListVO.class, ""));
