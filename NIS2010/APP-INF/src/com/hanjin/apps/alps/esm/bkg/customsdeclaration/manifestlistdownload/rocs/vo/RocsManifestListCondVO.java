...
public class RocsManifestListCondVO extends ManifestListCondVO{
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("frm_pod_clpt_ind_seq", getPodClptIndSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("frm_pod_clpt_ind_seq", "podClptIndSeq");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPodClptIndSeq(JSPUtil.getParameter(request, "frm_pod_clpt_ind_seq", ""));		
	}
	...
	public RocsManifestListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] podClptIndSeq = (JSPUtil.getParameter(request, prefix	+ "frm_pod_clpt_ind_seq".trim(), length));
