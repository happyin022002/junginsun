...
*@FileName : LocationDBDAORsltCmpbGrpLocListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAORsltCmpbGrpLocListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAORsltCmpbGrpLocListVORSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAORsltCmpbGrpLocListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", (GRP_LOC_SEQ||'|'||CRE_OFC_CD||'|'||GLINE_SEQ) GRP_LOC_SEQ" ).append("\n"); 
