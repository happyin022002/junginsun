...
*@FileName : KorManifestListDBDAOmodifyKcdTpInElnoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOmodifyKcdTpInElnoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOmodifyKcdTpInElnoUSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOmodifyKcdTpInElnoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_KR_XPT_LIC" ).append("\n"); 
