...
public class SPCLCmpnAuditDBDAOSearchSPCLCmpnAuditListRSQL implements ISQLTemplate{
	...
	public SPCLCmpnAuditDBDAOSearchSPCLCmpnAuditListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.acm.acmaudit.spclcmpnaudit.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("           NVL (A.SPCL_CMPN_STS_CD, ' ')                    AS SPCL_CMPN_STS_CD," ).append("\n"); 
		...
		query.append("                  AND S.SPCL_CMPN_STS_CD    = 'IF'" ).append("\n"); 
		...
		query.append("   				  AND S.SPCL_VSL_CD||S.SPCL_SKD_VOY_NO||S.SPCL_SKD_DIR_CD IN (${vvd_cd})    --## ${}로 받음" ).append("\n"); 
		query.append("   #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                  )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("             GROUP BY S.BKG_NO" ).append("\n"); 
