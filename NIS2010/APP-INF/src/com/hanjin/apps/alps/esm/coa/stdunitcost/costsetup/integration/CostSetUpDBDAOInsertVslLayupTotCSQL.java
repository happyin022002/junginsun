...
public class CostSetUpDBDAOInsertVslLayupTotCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("    (SELECT COST_YR||EQ_WK FROM COA_WK_PRD WHERE COST_YR = SUBSTR(REPLACE(@[cost_yrmon],'-',''),1,4) AND COST_WK = SUBSTR(REPLACE(@[cost_yrmon],'-',''),5,2))" ).append("\n"); 
