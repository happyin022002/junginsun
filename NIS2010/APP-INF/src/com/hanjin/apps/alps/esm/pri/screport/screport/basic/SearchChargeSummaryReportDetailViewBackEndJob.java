...
*@FileName : SearchChargeSummaryReportDetailViewBackEndJob.java
 ...
 * @since J2EE 1.6
 */
public class SearchChargeSummaryReportDetailViewBackEndJob extends BackEndCommandSupport{
	...
	public List doStart() throws Exception {
		List list = null;
		try {
			list = dbDao.searchChargeSummaryReportDetailView(this.rptSearchChargeSummaryReportSummaryViewVO);
