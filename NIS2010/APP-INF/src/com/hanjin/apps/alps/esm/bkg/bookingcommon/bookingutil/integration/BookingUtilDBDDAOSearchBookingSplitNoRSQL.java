...
*@FileName : BookingUtilDBDDAOSearchBookingSplitNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingUtilDBDDAOSearchBookingSplitNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Booking no로 split no들을 조회한다.
	  * </pre>
	  */
	public BookingUtilDBDDAOSearchBookingSplitNoRSQL(){
		setQuery();
		...
		query.append("FileName : BookingUtilDBDDAOSearchBookingSplitNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	TAA_NO TRF_LNR_ITM_NO" ).append("\n"); 
