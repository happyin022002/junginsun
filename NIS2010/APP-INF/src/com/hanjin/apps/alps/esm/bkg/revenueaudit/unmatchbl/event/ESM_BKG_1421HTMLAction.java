...
*@FileName : ESM_BKG_1421HTMLAction.java
...
public class ESM_BKG_1421HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1421HTMLAction 객체를 생성
	 */
	public ESM_BKG_1421HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1421Event event = new EsmBkg1421Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setNonAutoratedChargeVO((NonAutoratedChargeVO)getVO(request, NonAutoratedChargeVO.class));
		}
