...
*@FileName : RFAGuidelineMainDBDAOGlineCpCheckTermsExistRSQL.java
...
public class RFAGuidelineMainDBDAOGlineCpCheckTermsExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGuidelineMainDBDAOGlineCpCheckTermsExistRSQL(){
		setQuery();
		...
		query.append("FileName : RFAGuidelineMainDBDAOGlineCpCheckTermsExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--AND   B.GLINE_SEQ = 0" ).append("\n"); 
		...
		query.append("EXISTS (" ).append("\n"); 
		query.append("SELECT 'X'" ).append("\n"); 
		query.append("FROM PRI_SG_RT_ROUT_PNT E" ).append("\n"); 
		query.append("WHERE E.SVC_SCP_CD = D.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   E.GLINE_SEQ = D.GLINE_SEQ" ).append("\n"); 
		query.append("AND   E.PRC_CUST_TP_CD = D.PRC_CUST_TP_CD" ).append("\n"); 
		query.append("AND   E.CMDT_HDR_SEQ = D.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("AND   E.ROUT_SEQ = D.ROUT_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("OR EXISTS (" ).append("\n"); 
		query.append("SELECT 'X'" ).append("\n"); 
		query.append("FROM PRI_SG_RT_ROUT_VIA F" ).append("\n"); 
		query.append("WHERE F.SVC_SCP_CD = D.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   F.GLINE_SEQ = D.GLINE_SEQ" ).append("\n"); 
		query.append("AND   F.PRC_CUST_TP_CD = D.PRC_CUST_TP_CD" ).append("\n"); 
		query.append("AND   F.CMDT_HDR_SEQ = D.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("AND   F.ROUT_SEQ = D.ROUT_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("OR EXISTS (" ).append("\n"); 
		query.append("SELECT 'X'" ).append("\n"); 
		query.append("FROM PRI_SG_RT_CMDT_RNOTE G" ).append("\n"); 
		query.append("WHERE G.SVC_SCP_CD = D.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   G.GLINE_SEQ = D.GLINE_SEQ" ).append("\n"); 
		query.append("AND   G.PRC_CUST_TP_CD = D.PRC_CUST_TP_CD" ).append("\n"); 
		query.append("AND   G.CMDT_HDR_SEQ = D.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("AND   G.ROUT_SEQ = D.ROUT_SEQ" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("OR EXISTS (" ).append("\n"); 
		query.append("SELECT 'X'" ).append("\n"); 
		...
		query.append("AND   DECODE(BB.PRC_CUST_TP_CD,@[prc_cust_tp_cd],1,NULL,1,0) = 1" ).append("\n"); 
		...
		query.append("SELECT SVC_SCP_CD" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '13',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_LOC_CHK" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '14',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_CMDT_CHK" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '51',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_ARB_ORG_CHK" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '52',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_ARB_DES_CHK" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '16',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_GOH_CHK" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '71',DECODE(AMDT_FLG, 'Y', 1, 0),0) +" ).append("\n"); 
		query.append("DECODE(PROP_SCP_TERM_TP_CD, '72',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_RATE_CHK" ).append("\n"); 
		query.append(",    SUM(DECODE(PROP_SCP_TERM_TP_CD, '31',DECODE(AMDT_FLG, 'Y', 1, 0),0)) AS OLD_NOTE_CHK" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_AMDT_SMRY" ).append("\n"); 
		query.append("WHERE PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("AND   AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("AND   PROP_SCP_TERM_TP_CD IN ('13','14','51','52','16','71','72','31')" ).append("\n"); 
