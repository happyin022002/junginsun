...
public class QtaInquiryDBDAOSearchCurrQtaReptIasSectorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * * 2014.07.22 이혜민 Raw data Export시 load가 0 이 아닌것만 나오도록 HAVING SUM(A1.LOD_QTY) <> 0 추가
	...
	public void setQuery(){
		query.append("#if (${f_bse_tp_cd} == 'Q') -- 분기 조회시에만 타도록 함" ).append("\n"); 
		...
		query.append("#if (${f_chk_week} == 'W')" ).append("\n"); 
		query.append("#if (${f_bse_tp_cd} == 'Q')  " ).append("\n"); 
		query.append("       , NVL(SUBSTR(A3.SLS_YRMON,0,4),A1.BSE_YR)   " ).append("\n"); 
		query.append("#end   " ).append("\n"); 
		query.append("       , BSE_WK" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${f_chk_vvd} == 'V' )" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${f_bse_tp_cd} == 'Q') -- 여기서부터 맨 아래까지는 분기 조회시에만 타는 로직" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("        AND BSE_YR = DECODE(@[f_bse_qtr_cd], '4Q', @[f_bse_yr] + 1, @[f_bse_yr])" ).append("\n"); 
		query.append("        AND BSE_QTR_CD = DECODE(@[f_bse_qtr_cd], '1Q', '2Q', '2Q', '3Q', '3Q', '4Q', '4Q', '1Q')" ).append("\n"); 
		query.append("        AND TRD_CD       = 'IAS'" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("#if (${f_sub_trd_cd} != '' && ${f_sub_trd_cd} != 'All')" ).append("\n"); 
		query.append("        AND SUB_TRD_CD = @[f_sub_trd_cd]" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND A1.QTA_RLSE_VER_NO = SUBSTR(DECODE(@[f_bse_qtr_cd], '4Q', @[f_bse_yr] + 1, @[f_bse_yr]), 3)||DECODE(@[f_bse_qtr_cd], '1Q', '2Q', '2Q', '3Q', '3Q', '4Q', '4Q', '1Q')||'02'" ).append("\n"); 
		query.append("AND A1.BSE_TP_CD = 'Q'" ).append("\n"); 
		query.append("AND A1.BSE_YR = DECODE(@[f_bse_qtr_cd], '4Q', @[f_bse_yr] + 1, @[f_bse_yr])" ).append("\n"); 
		query.append("AND A1.BSE_QTR_CD = DECODE(@[f_bse_qtr_cd], '1Q', '2Q', '2Q', '3Q', '3Q', '4Q', '4Q', '1Q')" ).append("\n"); 
		query.append("AND A1.OFC_VW_CD = @[f_ofc_vw_cd]" ).append("\n"); 
		query.append("AND A4.DELT_FLG = 'N'" ).append("\n"); 
		query.append("#if (${f_rlane_cd} != '' && ${f_rlane_cd} != 'All')" ).append("\n"); 
		query.append("AND A1.RLANE_CD = @[f_rlane_cd]" ).append("\n"); 
