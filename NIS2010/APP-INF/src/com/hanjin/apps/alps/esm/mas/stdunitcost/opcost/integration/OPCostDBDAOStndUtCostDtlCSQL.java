...
*@FileName : OPCostDBDAOStndUtCostDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPCostDBDAOStndUtCostDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPCostDBDAOStndUtCostDtlCSQL(){
		setQuery();
		...
		query.append("FileName : OPCostDBDAOStndUtCostDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL NISADM.MAS_STND_UT_COST_DTL_PRC" ).append("\n"); 
		query.append("(" ).append("\n"); 
