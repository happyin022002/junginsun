...
*@FileName : Kor24ManifestListDBDAOaddCrossInfoKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOaddCrossInfoKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOaddCrossInfoKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOaddCrossInfoKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_KR_RMK" ).append("\n");
		query.append("(" ).append("\n");
