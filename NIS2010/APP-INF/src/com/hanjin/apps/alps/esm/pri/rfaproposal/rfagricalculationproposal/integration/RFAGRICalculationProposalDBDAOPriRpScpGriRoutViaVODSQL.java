...
*@FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRoutViaVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGRICalculationProposalDBDAOPriRpScpGriRoutViaVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGriRoutViaVO Delete
	  * </pre>
	  */
	public RFAGRICalculationProposalDBDAOPriRpScpGriRoutViaVODSQL(){
		setQuery();
		...
		query.append("FileName : RFAGRICalculationProposalDBDAOPriRpScpGriRoutViaVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
