...
*@FileName : IndonesiaCustomsTransmissionDBDAOsearchManifestDetail1ListByOpt04RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IndonesiaCustomsTransmissionDBDAOsearchManifestDetail1ListByOpt04RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchManifestDetail1ListByOpt04
	  * </pre>
	  */
	public IndonesiaCustomsTransmissionDBDAOsearchManifestDetail1ListByOpt04RSQL(){
		setQuery();
		...
		query.append("FileName : IndonesiaCustomsTransmissionDBDAOsearchManifestDetail1ListByOpt04RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${bound_cd} == 'I') " ).append("\n"); 
		query.append(" WHERE @[mf_tp_cd] = '04I'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${bound_cd} == 'O') " ).append("\n"); 
		query.append(" WHERE @[mf_tp_cd] = '08X'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
