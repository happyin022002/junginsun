...
*@FileName : SCTransportationAdditionalChargeProposalDBDAORsltAddChgListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCTransportationAdditionalChargeProposalDBDAORsltAddChgListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Arbitrary, IHC 리스트 조회
	  * </pre>
	  */
	public SCTransportationAdditionalChargeProposalDBDAORsltAddChgListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCTransportationAdditionalChargeProposalDBDAORsltAddChgListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 ,(SELECT NOTE_DP_SEQ FROM PRI_SP_SCP_TRSP_ADD_CHG" ).append("\n"); 
		...
		query.append("	   ) PRE_NOTE_DP_SEQ" ).append("\n"); 
