...
*@FileName : CndExpManifestListDownloadDBDAOsearchBkgCustomerCneeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchBkgCustomerCneeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchBkgCustomerCnee
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchBkgCustomerCneeRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchBkgCustomerCneeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE B.POD_CD = L.LOC_CD" ).append("\n"); 
