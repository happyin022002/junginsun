...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtVO2CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtVO2CSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Table agt_agn_agmt Insert #2(Copy)
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtVO2CSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtVO2CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
