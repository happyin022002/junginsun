...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.manifestlistdownload.canada.vo.CndVesselVO;
...
/**
 * NIS2010 CndManifestListDownloadDBDAO <br>
...
public class CndManifestListDownloadDBDAO extends DBDAOSupport {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<ManifestListDetailVO> searchCndCstmsMfList(CndCstmsMfListCondVO cndCstmsMfListCondVO)
			throws DAOException {
		DBRowSet dbRowset = null;
	 ...
	 * @throws DAOException
	 */
	public boolean checkIfCCNAval(String vslCd, String skdVoyNo, String skdDirCd) throws DAOException {
		DBRowSet dbRowset = null;
		...
		try
		{
			...
			dbRowset = new SQLExecuter("").executeQuery(
					(ISQLTemplate) new CndManifestListDownloadDBDAOcheckIfCCNAvalRSQL(), param, null);
			if (dbRowset.next())
			{
				isCCNNo = true;
			}
	...
	public void mergeSelectBkgCstmsAdvBl(BkgCstmsAdvBlVO bkgCstmsAdvBlVO) throws DAOException {
		try
		{
			...
			{
				sqlExe.executeUpdate((ISQLTemplate) new CndManifestListDownloadDBDAOaddBkgCstmsAdvBlCSQL(),
						bkgCstmsAdvBlVO.getColumnValues(), null);
			}
			else
			{
				sqlExe.executeUpdate((ISQLTemplate) new CndManifestListDownloadDBDAOmodifyBkgCstmsAdvBl3USQL(),
						bkgCstmsAdvBlVO.getColumnValues(), null);
			}
		}
		catch (SQLException se)
	...
	public CstmsHldVO searchCstmsAlertFlag(BkgCstmsAdvRcvLogVO bkgCstmsAdvRcvLogVO) throws DAOException {
		...
		try{
			...
			param.put("hld_type", bkgCstmsAdvRcvLogVO.getCndAckRcvId());
