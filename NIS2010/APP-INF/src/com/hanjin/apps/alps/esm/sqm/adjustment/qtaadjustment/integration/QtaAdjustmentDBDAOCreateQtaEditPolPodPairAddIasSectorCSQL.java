...
public class QtaAdjustmentDBDAOCreateQtaEditPolPodPairAddIasSectorCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                  ,(" ).append("\n"); 
		query.append("                    SELECT MAX(PF_GRP_CD) FROM SQM_SCTR_PAIR_MGMT A1" ).append("\n"); 
		...
		query.append("                  ,SYSDATE" ).append("\n"); 
		query.append("            FROM SQM_SCTR_LANE_OFC A1, SQM_CFM_TGT_VVD A2, SQM_SCTR_PAIR_COST A3" ).append("\n"); 
