...
/**
 * ESM_SPC_0116 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_SPC_0116HTMLAction에서 작성.<br>
...
public class EsmSpc0116Event extends EventSupport {
	...
	private BkgListForCompFirmBySPCVO[] bkgListForCompFirmBySPCVOs = null;
	...
	public BkgListForCompFirmBySPCVO[] getBkgListForCompFirmBySPCVOs() {
		BkgListForCompFirmBySPCVO[] rtnVOs = null;
		if (this.bkgListForCompFirmBySPCVOs != null) {
			rtnVOs = new BkgListForCompFirmBySPCVO[bkgListForCompFirmBySPCVOs.length];
			System.arraycopy(bkgListForCompFirmBySPCVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}

	public void setBkgListForCompFirmBySPCVOs(BkgListForCompFirmBySPCVO[] bkgListForCompFirmBySPCVOs) {
		if (bkgListForCompFirmBySPCVOs != null) {
			BkgListForCompFirmBySPCVO[] tmpVOs = new BkgListForCompFirmBySPCVO[bkgListForCompFirmBySPCVOs.length];
			System.arraycopy(bkgListForCompFirmBySPCVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.bkgListForCompFirmBySPCVOs = tmpVOs;
		}
	}
