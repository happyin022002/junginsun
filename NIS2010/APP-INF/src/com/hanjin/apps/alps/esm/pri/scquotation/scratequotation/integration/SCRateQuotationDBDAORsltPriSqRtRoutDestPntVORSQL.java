...
*@FileName : SCRateQuotationDBDAORsltPriSqRtRoutDestPntVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAORsltPriSqRtRoutDestPntVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAORsltPriSqRtRoutDestPntVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAORsltPriSqRtRoutDestPntVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
