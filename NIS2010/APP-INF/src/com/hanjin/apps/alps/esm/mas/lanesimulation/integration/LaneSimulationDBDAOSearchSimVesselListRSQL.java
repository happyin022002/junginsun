...
public class LaneSimulationDBDAOSearchSimVesselListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        B.VOP_CD,DECODE(B.VOP_CD,'SML',1,0) VOP_FLG, A.SKD_DIR_CD, " ).append("\n"); 
		...
		query.append("  FROM MAS_SIM_SVC_LANE A, " ).append("\n"); 
		query.append("       MAS_SIM_VSL_SET_INFO B," ).append("\n"); 
		query.append("       (" ).append("\n"); 
		...
		query.append("         C.VSL_OSHP_CD, B.VOP_CD, DECODE(B.VOP_CD,'SML',1,0) VOP_FLG," ).append("\n"); 
		...
		query.append("                          FROM MAS_SIM_VSL_SET_INFO D " ).append("\n"); 
		...
		query.append("                       ) " ).append("\n"); 
		query.append(" UNION ALL " ).append("\n"); 
		query.append(" SELECT  'I' FLAG, DECODE(NVL(C.VSL_CD, '*'), '*', 'Y', 'N') VSL_FLG, C.VSL_CHG, B.VSL_CD, B.VSL_CLSS_CAPA, C.VSL_OSHP_CD, B.VOP_CD, DECODE(B.VOP_CD,'SML',1,0) VOP_FLG, " ).append("\n"); 
		query.append("         @[dir_cd] SKD_DIR_CD,B.VSL_CAPA, B.BSA_CAPA, B.FNL_HJS_BSA_CAPA, 0 LDF_RTO, " ).append("\n"); 
		query.append("         0 OTR_CRR_BSA_CAPA1, 0 OTR_CRR_BSA_CAPA2,0 OTR_CRR_BSA_CAPA3,0 OTR_CRR_BSA_CAPA4,0 OTR_CRR_BSA_CAPA5, " ).append("\n"); 
		query.append("         0 HJS_BFR_BSA_CAPA, " ).append("\n"); 
		query.append("         0 SUB_LSE_CAPA1, 0 SUB_LSE_CAPA2,  0 SUB_LSE_CAPA3,  0 SUB_LSE_CAPA4,  0 SUB_LSE_CAPA5, " ).append("\n"); 
