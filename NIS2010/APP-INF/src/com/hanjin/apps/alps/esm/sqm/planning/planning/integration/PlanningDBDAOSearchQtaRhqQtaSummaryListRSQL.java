...
*@FileName : PlanningDBDAOSearchQtaRhqQtaSummaryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanningDBDAOSearchQtaRhqQtaSummaryListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PlanningDBDAOSearchQtaRhqQtaSummaryListRSQL(){
		setQuery();
		...
		query.append("FileName : PlanningDBDAOSearchQtaRhqQtaSummaryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  ,SUM(V.OFC_QTY) / 53 AS RHQ_WK_QTY" ).append("\n"); 
		query.append("                  ,SUM(V.OFC_REV) / 53 AS RHQ_WK_REV" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("                  ,SUM(V.OFC_QTY) / 13 AS RHQ_WK_QTY" ).append("\n"); 
		query.append("                  ,SUM(V.OFC_REV) / 13 AS RHQ_WK_REV" ).append("\n"); 
