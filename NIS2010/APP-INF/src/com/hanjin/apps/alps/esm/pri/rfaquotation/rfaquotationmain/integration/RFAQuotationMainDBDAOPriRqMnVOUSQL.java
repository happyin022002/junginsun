...
*@FileName : RFAQuotationMainDBDAOPriRqMnVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAQuotationMainDBDAOPriRqMnVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAOPriRqMnVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAQuotationMainDBDAOPriRqMnVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	ESTM_MQC_QTY = @[estm_mqc_qty]" ).append("\n"); 
		query.append(",	PRC_CUST_TP_CD = @[prc_cust_tp_cd]" ).append("\n"); 
		query.append(",	QTTN_SREP_CD = @[qttn_srep_cd]" ).append("\n"); 
		query.append(",	PRS_XCH_RT_YRMON = @[prs_xch_rt_yrmon]" ).append("\n"); 
