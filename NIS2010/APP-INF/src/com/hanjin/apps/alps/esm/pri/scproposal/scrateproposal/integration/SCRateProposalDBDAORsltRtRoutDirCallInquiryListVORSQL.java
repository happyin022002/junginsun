...
*@FileName : SCRateProposalDBDAORsltRtRoutDirCallInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtRoutDirCallInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtRoutDirCallInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtRoutDirCallInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
