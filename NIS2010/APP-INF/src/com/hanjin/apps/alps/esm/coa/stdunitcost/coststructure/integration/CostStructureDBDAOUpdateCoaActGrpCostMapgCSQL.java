...
*@FileName : CostStructureDBDAOUpdateCoaActGrpCostMapgCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostStructureDBDAOUpdateCoaActGrpCostMapgCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COA_ACT_GRP_COST_MAPG 테이블 싱크
	  * </pre>
	  */
	public CostStructureDBDAOUpdateCoaActGrpCostMapgCSQL(){
		setQuery();
		...
		query.append("FileName : CostStructureDBDAOUpdateCoaActGrpCostMapgCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
