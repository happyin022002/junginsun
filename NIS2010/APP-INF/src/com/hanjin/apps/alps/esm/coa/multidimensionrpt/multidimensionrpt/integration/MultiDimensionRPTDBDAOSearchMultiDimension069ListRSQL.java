...
public class MultiDimensionRPTDBDAOSearchMultiDimension069ListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("FROM (SELECT /*+ ORDERED INDEX(A4 XAK1COA_MON_VVD) */  " ).append("\n"); 
		...
		query.append("    FROM COA_MON_VVD A4" ).append("\n"); 
		query.append("		,COA_RGST_BKG A3" ).append("\n"); 
		query.append("		,COA_BKG_REV_DTL B2" ).append("\n"); 
		query.append("		,COA_CNTR_REPO_IDX_ITM A1		 " ).append("\n"); 
