...
public class ESM_PRI_6063HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6016HTMLAction 객체를 생성
	 */
	public ESM_PRI_6063HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6063Event event = new EsmPri6063Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			RsltPriPrsCostListVO[] vos = (RsltPriPrsCostListVO[])getVOs(request, RsltPriPrsCostListVO .class);
			event.setRsltPriPrsCostListVOS(vos);	
			PriRqRtUsdRoutCsVO routCsVO = (PriRqRtUsdRoutCsVO)getVO(request, PriRqRtUsdRoutCsVO .class);
			event.setPriRqRtUsdRoutCsVO(routCsVO); 
