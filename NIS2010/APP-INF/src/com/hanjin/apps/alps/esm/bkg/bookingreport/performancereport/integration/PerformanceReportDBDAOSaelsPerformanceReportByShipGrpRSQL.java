...
*@FileName : PerformanceReportDBDAOSaelsPerformanceReportByShipGrpRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSaelsPerformanceReportByShipGrpRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSaelsPerformanceReportByShipGrpRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSaelsPerformanceReportByShipGrpRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,BKG.CUST_GRP_ID" ).append("\n"); 
		...
		query.append("              ,MCUST.CUST_GRP_ID" ).append("\n"); 
		query.append("              ,(SELECT REPLACE(CUST_LGL_ENG_NM, CHR(13) || CHR(10), ' ') FROM MDM_CUSTOMER WHERE CUST_CNT_CD = CUS.CUST_CNT_CD AND CUST_SEQ = CUS.CUST_SEQ) CUST_NM" ).append("\n"); 
