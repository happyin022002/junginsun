...
*@FileName : RFAProposalMainDBDAORsltCopyRoutHdrSmryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORsltCopyRoutHdrSmryListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFARateProposalDBDAORsltRoutHdrSmryListVORSQL 의 copy화면용
	  * </pre>
	  */
	public RFAProposalMainDBDAORsltCopyRoutHdrSmryListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORsltCopyRoutHdrSmryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , (NVL(F.ND_CNT, 0) + NVL(H.ND_CNT, 0)) AS ND_CNT" ).append("\n"); 
		query.append("      , (NVL(F.NA_CNT, 0) + NVL(H.NA_CNT, 0)) AS NA_CNT" ).append("\n"); 
		query.append("      , (NVL(F.AC_CNT, 0) + NVL(H.AC_CNT, 0)) AS AC_CNT" ).append("\n"); 
		query.append("      , (NVL(F.UP_CNT, 0) + NVL(H.UP_CNT, 0)) AS UP_CNT" ).append("\n"); 
		query.append("      , DECODE(A.AMDT_SEQ" ).append("\n"); 
		query.append("          ,0" ).append("\n"); 
		query.append("          ,DECODE(NVL(F.NA_CNT, 0) + NVL(H.NA_CNT, 0)" ).append("\n"); 
		query.append("                 ,0" ).append("\n"); 
		query.append("                 ,'color:blue;'" ).append("\n"); 
		query.append("                 ,'')" ).append("\n"); 
		query.append("          ,DECODE(NVL(F.NA_CNT, 0) + NVL(H.NA_CNT, 0)" ).append("\n"); 
		query.append("                 ,0" ).append("\n"); 
		query.append("                 ,DECODE(NVL(F.UP_CNT, 0) + NVL(H.UP_CNT, 0)" ).append("\n"); 
		query.append("                        ,0" ).append("\n"); 
		query.append("                        ,''" ).append("\n"); 
		query.append("                        ,'color:blue;')" ).append("\n"); 
		query.append("                 ,'color:red;')) AS ROW_PROPERTIES" ).append("\n"); 
		query.append("      ,DECODE(NVL(F.ND_CNT, 0) + NVL(H.ND_CNT, 0)" ).append("\n"); 
		query.append("             ,0" ).append("\n"); 
