...
*@FileName : BSAManageDBDAOMultiOverostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiOverostCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSAManageDBDAOMultiOverostCSQL
	  * </pre>
	  */
	public BSAManageDBDAOMultiOverostCSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiOverostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL BSA_MULTI_OCN_OVR_USD_PRC(" ).append("\n"); 
