...
*@FileName : Kor24ManifestListDBDAOsearchIbTsMtInfoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchIbTsMtInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchIbTsMtInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchIbTsMtInfoRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		...
		query.append("FROM    BKG_CSTMS_ADV_KR_BL A, BKG_CSTMS_ADV_KR_CNTR B" ).append("\n");
