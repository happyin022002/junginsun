...
public class UsaManifestListDownloadDBDAOmodifyTransStageUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("MF_SND_DT = DECODE(@[command], 'MI', GLOBALDATE_PKG.TIME_CONV_FNC ('KRACY', sysdate, 'USNYC'), MF_SND_DT)," ).append("\n"); 
		query.append("AMDT_SND_DT = DECODE(@[command], 'AI', GLOBALDATE_PKG.TIME_CONV_FNC ('KRACY', sysdate, 'USNYC'), AMDT_SND_DT)" ).append("\n"); 
