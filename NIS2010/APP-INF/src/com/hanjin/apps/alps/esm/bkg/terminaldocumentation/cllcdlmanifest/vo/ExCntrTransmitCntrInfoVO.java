...
*@FileName : ExCntrTransmitCntrInfoVO.java
*@FileTitle : ExCntrTransmitCntrInfoVO
*Open Issues :
*Change history :
...
public class ExCntrTransmitCntrInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ExCntrTransmitCntrInfoVO> models = new ArrayList<ExCntrTransmitCntrInfoVO>();
	...
	public ExCntrTransmitCntrInfoVO() {}

	public ExCntrTransmitCntrInfoVO(String ibflag, String pagerows, String bkh, String cntrown, String measureUnit, String cntrtrm, String bkwgt, String ovrw, String measure, String tunit, String sealnbr, String ovh, String dgInd, String cntrtrw, String ovwgt, String ovr, String akInd, String ovwgtUnit, String rdtype, String rfdryInd, String stwgReq, String voidSlot, String ovlw, String fmInd, String cntrgwgt, String socind, String vent, String rfRemark, String cntrnbr, String pkg, String bkInd, String bkwgtu, String ovf, String cntrwgt, String cntrtype, String rfInd, String cmdtDesc, String cntrNo, String bkw, String punit, String cntrWgtUnit, String haulage, String temp, String bkl, String cmdtcd, String vgmVrfyDt, String vgmWgt, String vgmWgtUtCd, String vgmVrfySigCtnt, String vgmMzdTpCd) {
		this.bkh = bkh;
...
/**
	 ...
	 * @param request
	 * @return ExCntrTransmitCntrInfoVO[]
	 */
	public ExCntrTransmitCntrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ExCntrTransmitCntrInfoVO[]
	 */
	public ExCntrTransmitCntrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ExCntrTransmitCntrInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ExCntrTransmitCntrInfoVO();
				if (bkh[i] != null)
					model.setBkh(bkh[i]);
		...
		return getExCntrTransmitCntrInfoVOs();
	}
	 ...
	 * @return ExCntrTransmitCntrInfoVO[]
	 */
	public ExCntrTransmitCntrInfoVO[] getExCntrTransmitCntrInfoVOs(){
		ExCntrTransmitCntrInfoVO[] vos = (ExCntrTransmitCntrInfoVO[])models.toArray(new ExCntrTransmitCntrInfoVO[models.size()]);
		return vos;
	}
