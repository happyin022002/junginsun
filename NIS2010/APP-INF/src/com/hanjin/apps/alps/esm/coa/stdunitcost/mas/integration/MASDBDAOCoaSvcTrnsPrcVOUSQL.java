...
*@FileName : MASDBDAOCoaSvcTrnsPrcVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MASDBDAOCoaSvcTrnsPrcVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MASDBDAOCoaSvcTrnsPrcVOUSQL(){
		setQuery();
		...
		query.append("FileName : MASDBDAOCoaSvcTrnsPrcVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_SVC_TRNS_PRC" ).append("\n"); 
