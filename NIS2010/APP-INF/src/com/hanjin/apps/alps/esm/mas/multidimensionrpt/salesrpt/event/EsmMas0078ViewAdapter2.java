...
/**
 * ESM_MAS_0078 에 대한 ViewAdapter<br>
 * - ESM_MAS_0078HTMLAction에서 작성<br>
 *
 * @author 김기식
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0078ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmMas0078ViewAdapter2(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0078ViewAdapter2 ########### [START]");
    	...
    	try{
			...
			for(int i =0; i <rowCount; i++)	{
				...
				//strBuilder.append("\n      <TD><![CDATA["+ JSPUtil.getNull(listVo.getStpRev())         +"]]></TD>");
				//strBuilder.append("\n      <TD><![CDATA["+ JSPUtil.getNull(listVo.getOtherAbc())       +"]]></TD>");
				//strBuilder.append("\n      <TD><![CDATA["+ JSPUtil.getNull(listVo.getStpNetIncome())  +"]]></TD>");
		...
		log.debug("########### EsmMas0078ViewAdapter2 ########### [END]");        
