 ...
 * @since J2EE 1.6
 */
public class EsmBkg1123ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for (int i = 0; i < realCnt; i++) {
			...
			d2 += Float.parseFloat(JSPUtil.getNull(colValues.get("d2")));
			d4 += Float.parseFloat(JSPUtil.getNull(colValues.get("d4")));
			d5 += Float.parseFloat(JSPUtil.getNull(colValues.get("d5")));
			d7 += Float.parseFloat(JSPUtil.getNull(colValues.get("d7")));
			d8 += Float.parseFloat(JSPUtil.getNull(colValues.get("d8")));
			d9 += Float.parseFloat(JSPUtil.getNull(colValues.get("d9")));
			dw += Float.parseFloat(JSPUtil.getNull(colValues.get("dw")));
			dx += Float.parseFloat(JSPUtil.getNull(colValues.get("dx")));
			r2 += Float.parseFloat(JSPUtil.getNull(colValues.get("r2")));
			r4 += Float.parseFloat(JSPUtil.getNull(colValues.get("r4")));
			r5 += Float.parseFloat(JSPUtil.getNull(colValues.get("r5")));
			r9 += Float.parseFloat(JSPUtil.getNull(colValues.get("r9")));
			f2 += Float.parseFloat(JSPUtil.getNull(colValues.get("f2")));
			f4 += Float.parseFloat(JSPUtil.getNull(colValues.get("f4")));
			f5 += Float.parseFloat(JSPUtil.getNull(colValues.get("f5")));
			o2 += Float.parseFloat(JSPUtil.getNull(colValues.get("o2")));
			o4 += Float.parseFloat(JSPUtil.getNull(colValues.get("o4")));
			o5 += Float.parseFloat(JSPUtil.getNull(colValues.get("o5")));
			s2 += Float.parseFloat(JSPUtil.getNull(colValues.get("s2")));
			s4 += Float.parseFloat(JSPUtil.getNull(colValues.get("s4")));
			t2 += Float.parseFloat(JSPUtil.getNull(colValues.get("t2")));
			t4 += Float.parseFloat(JSPUtil.getNull(colValues.get("t4")));
			a2 += Float.parseFloat(JSPUtil.getNull(colValues.get("a2")));
			a4 += Float.parseFloat(JSPUtil.getNull(colValues.get("a4")));
			a5 += Float.parseFloat(JSPUtil.getNull(colValues.get("a5")));
			p2 += Float.parseFloat(JSPUtil.getNull(colValues.get("p2")));
			p4 += Float.parseFloat(JSPUtil.getNull(colValues.get("p4")));
			z2 += Float.parseFloat(JSPUtil.getNull(colValues.get("z2")));
			z4 += Float.parseFloat(JSPUtil.getNull(colValues.get("z4")));
			...
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("bl_no"))).append("]]></TD>\n");
			...
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("cfm_flg"))).append("]]></TD>\n");
			...
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("cntr_pkup_dt"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("rqst_dt"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("cntr_pkup_yd_cd"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("cntr_rtn_yd_cd"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("rcv_term_cd"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("de_term_cd"))).append("]]></TD>\n");			
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("so_flg"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("wo_flg"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("zone_code"))).append("]]></TD>\n");
			...
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("so_number"))).append("]]></TD>\n");
			sbufXML.append("		<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("wo_number"))).append("]]></TD>\n");
...
//			sbufXML.append("	\n");
		...
		if (realCnt > 0) {
			tot_sum = d2 + d4 + d5 + d7 + d8 + d9 + dw + dx + r2 + r4 + r5 + f2 + f4 + f5 + o2 + o4 + o5 + s2 + s4 + t2 + t4 + a2 + a4 + a5 + p2 + p4 + z2 + z4 + r9;
			...
			sbufXML.append("<ETC KEY='r9'><![CDATA[").append(r9).append("]]></ETC>");
