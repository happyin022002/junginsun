...
public class WeeklyCMDBDAOSearchEMUPfmcListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                 WHEN (SELECT MNL_FLG " ).append("\n"); 
		query.append("                         FROM MAS_CNTR_REPO_SPLS_DEL_RTO" ).append("\n"); 
		query.append("                        WHERE COST_YRMON = @[f_cost_yrmon]" ).append("\n"); 
		query.append("                          AND CNTR_TPSZ_CD = REPLACE(E1.CNTR_TPSZ_CD ,'RD','R')" ).append("\n"); 
		query.append("                          AND POR_ECC_CD = E1.ORG_LOC_CD" ).append("\n"); 
		query.append("                          AND DEL_ECC_CD = E1.DEST_LOC_CD) = 'Y' THEN" ).append("\n"); 
		query.append("                      (SELECT ADJ_RT_AMT " ).append("\n"); 
		query.append("                         FROM MAS_CNTR_REPO_SPLS_DEL_RTO" ).append("\n"); 
		query.append("                        WHERE COST_YRMON = @[f_cost_yrmon]" ).append("\n"); 
		query.append("                          AND CNTR_TPSZ_CD = REPLACE(E1.CNTR_TPSZ_CD ,'RD','R')" ).append("\n"); 
		query.append("                          AND POR_ECC_CD = E1.ORG_LOC_CD" ).append("\n"); 
		query.append("                          AND DEL_ECC_CD = E1.DEST_LOC_CD)" ).append("\n"); 
		...
		query.append("                                                        AND LOC_CD           = MAS_LOC_FNC(A1.LOC_CD, 'LCC')" ).append("\n"); 
		...
		query.append("                                                        AND CNTR_TPSZ_CD     = A1.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                                        AND CNTR_ORG_DEST_CD = A1.CNTR_ORG_DEST_CD" ).append("\n"); 
		query.append("                                                        AND LOC_CD           = MAS_LOC_FNC(A1.LOC_CD, 'RCC')" ).append("\n"); 
		...
		query.append("                                       FROM MAS_REPO_IF_MGMT A1" ).append("\n"); 
		query.append("                                          , MAS_FULL_ECC_IMBAL A2 /* IMBAL_RTO 가져오기 위해 JOIN */                                        " ).append("\n"); 
		...
		query.append("                                               FROM MAS_MTY_ECC_UT_COST" ).append("\n"); 
		query.append("                                              WHERE COST_YRMON = A1.COST_YRMON" ).append("\n"); 
		query.append("                                                AND ECC_CD = MAS_LOC_FNC(A1.ECC_CD, 'LCC')" ).append("\n"); 
		query.append("                                                AND CNTR_TPSZ_CD = A1.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                                AND CNTR_ORG_DEST_CD = A1.CNTR_ORG_DEST_CD" ).append("\n"); 
		...
		query.append("                                               FROM MAS_MTY_ECC_UT_COST" ).append("\n"); 
		query.append("                                              WHERE COST_YRMON = A1.COST_YRMON" ).append("\n"); 
		query.append("                                                AND ECC_CD = MAS_LOC_FNC(A1.ECC_CD, 'RCC')" ).append("\n"); 
		query.append("                                                AND CNTR_TPSZ_CD = A1.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                                AND CNTR_ORG_DEST_CD = A1.CNTR_ORG_DEST_CD" ).append("\n"); 
		query.append("                                                AND CNTR_IO_VOL_STS_CD = A1.CNTR_IO_VOL_STS_CD" ).append("\n"); 
		query.append("                                                AND COST_LOC_GRP_CD = 'R'" ).append("\n"); 
		...
		query.append("                                        AND CNTR_ORG_DEST_CD = C1.CNTR_ORG_DEST_CD" ).append("\n"); 
		query.append("                                        AND COST_LOC_GRP_CD  = 'R'" ).append("\n"); 
		query.append("                                        AND ECC_CD           = MAS_LOC_FNC(C1.ECC_CD, 'RCC')" ).append("\n"); 
		query.append("                                        AND CNTR_TPSZ_CD     = C1.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                            ) SIM_POD_STEV_RCC" ).append("\n"); 
		query.append("                       FROM MAS_MTY_DEST_COST C1" ).append("\n"); 
		query.append("                          , (" ).append("\n"); 
		query.append("                                     SELECT CNTR_TPSZ_CD TPSZ_CD" ).append("\n"); 
		query.append("                                       FROM MAS_SPCL_REPO_CNTR_RGST" ).append("\n"); 
		query.append("                                      WHERE NVL(REPO_FLG, 'N') = 'Y'" ).append("\n"); 
		...
		query.append("              FROM MAS_CNTR_REPO_SHTG_INFO A1, MAS_CNTR_REPO_ROUT_ECC A2" ).append("\n"); 
		query.append("             WHERE A1.COST_YRMON = @[f_cost_yrmon]" ).append("\n"); 
		query.append("               AND A1.CNTR_TPSZ_CD = REPLACE(@[f_cntr_tpsz_cd], 'RD', 'R')" ).append("\n"); 
		query.append("               AND A1.ECC_CD = @[f_from_ecc_cd]" ).append("\n"); 
		...
		query.append("      FROM mas_cntr_repo_spls_del_rto A1, MAS_CNTR_REPO_ROUT_ECC A2" ).append("\n"); 
		query.append("      WHERE 1=1" ).append("\n"); 
		...
		query.append("      AND   A2.RCC_CD = MAS_LOC_FNC(A1.DEL_ECC_CD,'RCC')" ).append("\n"); 
		query.append("      AND   A2.ECC_CD = A1.DEL_ECC_CD" ).append("\n"); 
		query.append("      AND   A2.CNTR_TPSZ_CD = DECODE(SUBSTR(A1.CNTR_TPSZ_CD, 1, 1), 'D', 'D', A1.CNTR_TPSZ_CD)" ).append("\n"); 
		query.append("      AND   A2.DEL_REPO_FLG = 'Y' " ).append("\n"); 
		query.append("  ) E2," ).append("\n"); 
		query.append("  MAS_CNTR_REPO_ROUT_ECC E3, " ).append("\n"); 
		query.append("  MAS_CNTR_REPO_ROUT_ECC E4" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
