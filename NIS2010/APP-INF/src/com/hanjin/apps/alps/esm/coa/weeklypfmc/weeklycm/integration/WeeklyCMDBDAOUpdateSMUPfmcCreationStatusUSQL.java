...
*@FileName : WeeklyCMDBDAOUpdateSMUPfmcCreationStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOUpdateSMUPfmcCreationStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOUpdateSMUPfmcCreationStatusUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOUpdateSMUPfmcCreationStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'SMSM' CM_UC_CD" ).append("\n"); 
