...
public class CLLCDLManifestDBDAOsearchCllCdlForODCYRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       , REPLACE(TRANSLATE(NVL(CU.CUST_NM, ''), CHR(13)||CHR(10), ' '), '''', ' ') AS CNEE_NM" ).append("\n"); 
		query.append("       " ).append("\n"); 
		...
		query.append("       , REPLACE(TRANSLATE(NVL(CU2.CUST_NM, ''), CHR(13)||CHR(10), ' '), '''', ' ') AS SHPR_NM" ).append("\n"); 
		...
		query.append("       , REPLACE(TRANSLATE(NVL(CU.CUST_NM, ''), CHR(13)||CHR(10), ' '), '''', ' ') " ).append("\n"); 
		query.append("       " ).append("\n"); 
		...
		query.append("       , REPLACE(TRANSLATE(NVL(CU2.CUST_NM, ''), CHR(13)||CHR(10), ' '), '''', ' ') " ).append("\n"); 
