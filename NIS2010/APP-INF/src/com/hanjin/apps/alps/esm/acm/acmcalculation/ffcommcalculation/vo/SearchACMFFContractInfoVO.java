...
*@FileName : SearchACMFFContractInfoVO.java
*@FileTitle : SearchACMFFContractInfoVO
*Open Issues :
*Change history :
...
public class SearchACMFFContractInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchACMFFContractInfoVO> models = new ArrayList<SearchACMFFContractInfoVO>();
	...
	public SearchACMFFContractInfoVO() {}

	public SearchACMFFContractInfoVO(String ibflag, String pagerows, String ppdOfcCd, String cltOfcCd, String ppayrCntCd, String cgoRcvDt, String n3ptyRcvOfcCd) {
...
/**
	 ...
	 */
	public SearchACMFFContractInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchACMFFContractInfoVO[]
	 */
	public SearchACMFFContractInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchACMFFContractInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchACMFFContractInfoVO();
				if (ppdOfcCd[i] != null)
		...
		return getSearchACMFFContractInfoVOs();
	}
	 ...
	 * @return SearchACMFFContractInfoVO[]
	 */
	public SearchACMFFContractInfoVO[] getSearchACMFFContractInfoVOs(){
		SearchACMFFContractInfoVO[] vos = (SearchACMFFContractInfoVO[])models.toArray(new SearchACMFFContractInfoVO[models.size()]);
		return vos;
	}
