...
public class FullCntrRlseOrderSearchVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("in_del", getInDel());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sent_flg", "sengFlg");
		this.hashFields.put("in_del", "inDel");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInDel(JSPUtil.getParameter(request, "in_del", ""));
	}
	...
	public FullCntrRlseOrderSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] inDel = (JSPUtil.getParameter(request, prefix	+ "in_del", length));
	...
	*/
	public void unDataFormat(){
		...
		this.inDel = this.inDel .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
