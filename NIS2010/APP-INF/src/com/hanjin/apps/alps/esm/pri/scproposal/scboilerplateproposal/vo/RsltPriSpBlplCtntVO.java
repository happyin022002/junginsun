...
*@FileName : RsltPriSpBlplCtntVO.java
*@FileTitle : RsltPriSpBlplCtntVO
*Open Issues :
*Change history :
...
public class RsltPriSpBlplCtntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpBlplCtntVO> models = new ArrayList<RsltPriSpBlplCtntVO>();
	 ...
	 */
	public RsltPriSpBlplCtntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpBlplCtntVO[]
	 */
	public RsltPriSpBlplCtntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpBlplCtntVO model = null;
		...
		return getRsltPriSpBlplCtntVOs();
	}
	 ...
	 * @return RsltPriSpBlplCtntVO[]
	 */
	public RsltPriSpBlplCtntVO[] getRsltPriSpBlplCtntVOs(){
		RsltPriSpBlplCtntVO[] vos = (RsltPriSpBlplCtntVO[])models.toArray(new RsltPriSpBlplCtntVO[models.size()]);
		return vos;
	}
