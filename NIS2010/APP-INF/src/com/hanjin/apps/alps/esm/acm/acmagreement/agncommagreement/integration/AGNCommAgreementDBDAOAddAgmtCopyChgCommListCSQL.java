...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyChgCommListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyChgCommListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add Agmt Copy Chg Comm List
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyChgCommListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyChgCommListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_AGN_AGMT_CHG_COMM" ).append("\n"); 
