...
*@FileName : JapanManifestListDownloadDBDAOremoveJpcusBlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOremoveJpcusBlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOremoveJpcusBlUSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOremoveJpcusBlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("JP_BL_STS_CD = 'D'" ).append("\n"); 
