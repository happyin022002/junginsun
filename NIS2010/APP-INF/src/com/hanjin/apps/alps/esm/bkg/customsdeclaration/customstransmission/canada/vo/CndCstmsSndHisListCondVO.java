...
public class CndCstmsSndHisListCondVO extends CstmsSndHisListCondVO {
    ...
    public CndCstmsSndHisListCondVO(String ibflag, String pagerows, String office, String usrId, String podCd, String polCd, String vvdCd, String trsmMsgTpId, String sndDtFlg, String sSndDt, String eSndDt, String blNo, String sSndTm, String eSndTm, String ioBondCd) {
        this.office = office;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("io_bond_cd", getIoBondCd());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("io_bond_cd", "ioBondCd");
    ...
    public void setIoBondCd(String ioBondCd) {
        this.ioBondCd = ioBondCd;
    }

    public String getIoBondCd() {
        return this.ioBondCd;
    }
    ...
    public CndCstmsSndHisListCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] ioBondCd = (JSPUtil.getParameter(request, prefix + "io_bond_cd", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.ioBondCd = this.ioBondCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
