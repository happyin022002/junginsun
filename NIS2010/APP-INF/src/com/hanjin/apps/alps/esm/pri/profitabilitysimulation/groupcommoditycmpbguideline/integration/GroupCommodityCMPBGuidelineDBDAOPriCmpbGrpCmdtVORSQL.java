...
*@FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVORSQL(){
		setQuery();
		...
		query.append("FileName : GroupCommodityCMPBGuidelineDBDAOPriCmpbGrpCmdtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY PRC_GRP_CMDT_CD, PRC_GRP_CMDT_DESC" ).append("\n"); 
