...
*@FileName : Kor24CustomsTransmissionDBDAOaddMACAMDModiCdSndDtlLogCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOaddMACAMDModiCdSndDtlLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MACAMD 정정부호 전송 내역을 Detail LOG Table로 전송일 및 Flat File 내용 저장
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOaddMACAMDModiCdSndDtlLogCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOaddMACAMDModiCdSndDtlLogCSQL").append("\n");
		query.append("*/").append("\n");
	}
