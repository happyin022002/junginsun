...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkYdDtlTmpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkYdDtlTmpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_YD_DTL_TMP 테이블 삭제
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkYdDtlTmpDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkYdDtlTmpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  PRI_SCQ_AWK_YD_DTL_TMP" ).append("\n"); 
