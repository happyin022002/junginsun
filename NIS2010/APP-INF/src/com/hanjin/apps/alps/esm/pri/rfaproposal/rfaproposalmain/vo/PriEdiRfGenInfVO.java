...
*@FileName : PriEdiRfGenInfVO.java
*@FileTitle : PriEdiRfGenInfVO
*Open Issues :
*Change history :
...
public class PriEdiRfGenInfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriEdiRfGenInfVO> models = new ArrayList<PriEdiRfGenInfVO>();
	...
	public PriEdiRfGenInfVO() {}

	public PriEdiRfGenInfVO(String ibflag, String pagerows, String propNo, String amdtSeq, String rfaNo, String ctrtCustCntCd, String ctrtCustSeq, String propOfcCd, String propSrepCd, String ctrtEffDt, String ctrtExpDt, String eaiDt, String eaiSts) {
	 ...
	 * @param request
	 * @return PriEdiRfGenInfVO[]
	 */
	public PriEdiRfGenInfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriEdiRfGenInfVO[]
	 */
	public PriEdiRfGenInfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriEdiRfGenInfVO model = null;
	 ...
	 * @return PriEdiRfGenInfVO[]
	 */
	public PriEdiRfGenInfVO[] getPriEdiRfGenInfVOs(){
		PriEdiRfGenInfVO[] vos = (PriEdiRfGenInfVO[])models.toArray(new PriEdiRfGenInfVO[models.size()]);
		return vos;
	}
