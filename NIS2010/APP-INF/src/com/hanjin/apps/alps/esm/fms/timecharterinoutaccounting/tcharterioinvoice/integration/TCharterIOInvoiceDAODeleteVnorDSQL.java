...
*@FileName : TCharterIOInvoiceDAODeleteVnorDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAODeleteVnorDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInvoiceDAODeleteVnorDSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDAODeleteVnorDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM FMS_VNOR F" ).append("\n"); 
