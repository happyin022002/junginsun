...
*@FileName : ScBkgInformVO.java
*@FileTitle : ScBkgInformVO
*Open Issues :
*Change history :
...
public class ScBkgInformVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScBkgInformVO> models = new ArrayList<ScBkgInformVO>();
	...
	public ScBkgInformVO() {}

	public ScBkgInformVO(String ibflag, String pagerows, String bkgNo, String svcScpCd, String bdrCngFlg, String cntrCdrDt, String bkgCgoTpCd, String cmdtCd, String cmdtNm, String repCmdtCd, String actWgt, String measQty, String measUtCd, String bkgPorCd, String bkgPolCd, String bkgPodCd, String delCd, String vvPolCd, String vvPodCd, String rcvTermCd, String deTermCd, String special, String frtTermCd, String repCmdtNm, String fScNo, String bkgVvd, String portSkpFlg, String slanCd, String srepEml, String usrEml, String obSrepEml, String scpCd, String etdDt, String aplyTp, String cgoRcvDt) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("fsc_no", getFScNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("fsc_no", "fScNo");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFScNo(JSPUtil.getParameter(request, "fsc_no", ""));
		setBkgVvd(JSPUtil.getParameter(request, "bkg_vvd", ""));
		setPortSkpFlg(JSPUtil.getParameter(request, "port_skp_flg", ""));
	 ...
	 */
	public ScBkgInformVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScBkgInformVO[]
	 */
	public ScBkgInformVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScBkgInformVO model = null;
		...
		try {
			...
			String[] fScNo = (JSPUtil.getParameter(request, prefix	+ "fsc_no", length));
	...
	public ScBkgInformVO[] getScBkgInformVOs(){
		ScBkgInformVO[] vos = (ScBkgInformVO[])models.toArray(new ScBkgInformVO[models.size()]);
		return vos;
	}
