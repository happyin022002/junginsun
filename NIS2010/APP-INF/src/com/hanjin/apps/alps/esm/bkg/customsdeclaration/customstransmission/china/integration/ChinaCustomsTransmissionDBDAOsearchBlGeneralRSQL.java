...
public class ChinaCustomsTransmissionDBDAOsearchBlGeneralRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        DECODE(RK.TRSM_MSG_TP_ID,'9','Original','0','Original','5','Change','3','Delete') AS TRSM_MSG_TP_ID," ).append("\n"); 
		...
		query.append("        REPLACE(REPLACE(REPLACE(NVL(MKD.CMDT_DESC, ' '), CHR(13)||CHR(10),'@*'), CHR(34),' '),CHR(9),' ') AS CMDT_DESC2," ).append("\n"); 
		query.append("        REPLACE(REPLACE(REPLACE(NVL(MK.BL_MK_DESC, ' '), CHR(13)||CHR(10),'@*'), CHR(34),' '),CHR(9),' ') AS BL_MK_DESC," ).append("\n"); 
