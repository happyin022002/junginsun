...
public class DocHistVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DocHistVO> models = new ArrayList<DocHistVO>();
	...
	public DocHistVO(String ibflag, String pagerows, String item, String creDt, String gmtDt, String creUsrId, String office, String remark, String reason) {
		this.office = office;
...
/**
	 ...
	 * @return DocHistVO[]
	 */
	public DocHistVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DocHistVO[]
	 */
	public DocHistVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DocHistVO model = null;
	 ...
	 * @return DocHistVO[]
	 */
	public DocHistVO[] getDocHistVOs(){
		DocHistVO[] vos = (DocHistVO[])models.toArray(new DocHistVO[models.size()]);
		return vos;
	}
