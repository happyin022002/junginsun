...
*@FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24OBDgCntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOAddBkgCstmsEu24OBDgCntrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24ManifestDownloadDBDAOAddBkgCstmsEu24OBDgCntrCSQL
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOAddBkgCstmsEu24OBDgCntrCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOAddBkgCstmsEu24OBDgCntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_CSTMS_EUR_IO_DG_CGO" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("   BND_TP_CD,   VSL_CD,      SKD_VOY_NO,       SKD_DIR_CD,       BL_NO,       CSTMS_PORT_CD, CNTR_NO, DCGO_SEQ" ).append("\n"); 
		...
		query.append("  'O',             X.VSL_CD,       X.SKD_VOY_NO,      X.SKD_DIR_CD,  X.BL_NO,         X.CSTMS_PORT_CD, X.CNTR_NO,   DG.DCGO_SEQ" ).append("\n"); 
