...
*@FileName : RFARateProposalDBDAORsltRnoteNoteConvListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRnoteNoteConvListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rnote에 따른 Conversion 데이터 조회
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRnoteNoteConvListRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRnoteNoteConvListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
