...
*@FileName : SearchWeeklyTargetVVD0030ListVO.java
*@FileTitle : SearchWeeklyTargetVVD0030ListVO
*Open Issues :
*Change history :
...
public class SearchWeeklyTargetVVD0030ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchWeeklyTargetVVD0030ListVO> models = new ArrayList<SearchWeeklyTargetVVD0030ListVO>();
	...
	public SearchWeeklyTargetVVD0030ListVO() {}
	 ...
	 */
	public SearchWeeklyTargetVVD0030ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchWeeklyTargetVVD0030ListVO[]
	 */
	public SearchWeeklyTargetVVD0030ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchWeeklyTargetVVD0030ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchWeeklyTargetVVD0030ListVO();
				if (iocCd[i] != null)
		...
		return getSearchWeeklyTargetVVD0030ListVOs();
	}
	...
	public SearchWeeklyTargetVVD0030ListVO[] getSearchWeeklyTargetVVD0030ListVOs(){
		SearchWeeklyTargetVVD0030ListVO[] vos = (SearchWeeklyTargetVVD0030ListVO[])models.toArray(new SearchWeeklyTargetVVD0030ListVO[models.size()]);
		return vos;
	}
