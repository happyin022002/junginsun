...
import com.hanjin.irep.enisEsm.ESM0570001Document;
import com.hanjin.irep.enisEsm.ESM0570001Document.ESM0570001;
import com.hanjin.irep.enisEsm.ESM0570001Document.ESM0570001.DataArea.ContractRateCollection;
import com.hanjin.irep.enisEsm.ESM0570001Document.ESM0570001.DataArea.ContractRateCollection.ContractRateRequest;
import com.hanjin.irep.enisEsm.ESM0570001Document.ESM0570001.DataArea.ContractRateCollection.ContractRateResponse;
...
/**
 * eNIS-agt에 대한 EAI 처리를 담당<br> - eNIS-agt Business Logic을 처리하기 위한 EAI 작업수행.<br>
 * 
...
public class AGTCustomerAgreementInfoEAIDAO extends EAIDAOSupport {
	 ...
	 * (ESM_AGT_008) 구주 FAC 계약 요율의 정보를 등록,수정,삭제 후 NIS 에 Interface 한다.<br>
...
//				String[] recipientsEml_arr = "muezero@gmail.com;".split(";");
				...
				log.debug("agtFacAgmtRtVOS[0].getRecipientsName()==>"+agtFacAgmtRtVOS[0].getRecipientsName());
