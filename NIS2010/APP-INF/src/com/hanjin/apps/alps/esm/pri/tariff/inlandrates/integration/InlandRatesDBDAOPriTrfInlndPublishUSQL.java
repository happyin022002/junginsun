...
*@FileName : InlandRatesDBDAOPriTrfInlndPublishUSQL.java
...
public class InlandRatesDBDAOPriTrfInlndPublishUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRatesDBDAOPriTrfInlndPublishUSQL(){
		setQuery();
		...
		query.append("FileName : InlandRatesDBDAOPriTrfInlndPublishUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
