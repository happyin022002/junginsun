...
*@FileName : SCRateProposalDBDAOPriSpScpScgAdjVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpScgAdjVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpScgAdjVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpScgAdjVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO pri_sp_scp_scg_adj(" ).append("\n"); 
		...
		query.append("(select nvl(max(scg_adj_seq),0)+1" ).append("\n"); 
		query.append("from pri_sp_scp_scg_adj" ).append("\n"); 
		query.append("where  prop_no = @[prop_no] and amdt_seq = @[amdt_seq] and svc_scp_cd = @[svc_scp_cd] and gen_spcl_rt_tp_cd=@[gen_spcl_rt_tp_cd])," ).append("\n"); 
		query.append("@[prop_no]," ).append("\n"); 
		query.append("@[amdt_seq]," ).append("\n"); 
		query.append("@[svc_scp_cd]," ).append("\n"); 
		query.append("@[gen_spcl_rt_tp_cd]," ).append("\n"); 
