...
*@FileName : AGNCommRequestDBDAORemoveAcmAgnCommTrspDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAORemoveAcmAgnCommTrspDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveAcmAgnCommTrsp
	  * </pre>
	  */
	public AGNCommRequestDBDAORemoveAcmAgnCommTrspDSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAORemoveAcmAgnCommTrspDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE ACM_AGN_COMM_TRSP" ).append("\n"); 
