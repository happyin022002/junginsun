...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineBseVOUSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineBseVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineBseVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_BSE SET" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineBseVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}