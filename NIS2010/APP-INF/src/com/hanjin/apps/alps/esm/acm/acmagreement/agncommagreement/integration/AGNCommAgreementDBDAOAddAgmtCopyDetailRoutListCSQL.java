...
*@FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailRoutListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommAgreementDBDAOAddAgmtCopyDetailRoutListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAgmtCopyDetailRoutList
	  * </pre>
	  */
	public AGNCommAgreementDBDAOAddAgmtCopyDetailRoutListCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommAgreementDBDAOAddAgmtCopyDetailRoutListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
