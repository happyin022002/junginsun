...
*@FileName : ESM_BKG_9456HTMLAction.java
...
public class ESM_BKG_9456HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9456HTMLAction 객체를 생성
	 */
	public ESM_BKG_9456HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9456Event event = new EsmBkg9456Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgCstmsChnAgnStupVOs((BkgCstmsChnAgnStupVO[])getVOs(request, BkgCstmsChnAgnStupVO .class,""));
		}
		else if((command.isCommand(FormCommand.SEARCH)) || command.isCommand(FormCommand.COMMAND01)) {
			event.setBkgCstmsChnAgnCdVO((BkgCstmsChnAgnCdVO)getVO(request, BkgCstmsChnAgnCdVO .class));
		}
