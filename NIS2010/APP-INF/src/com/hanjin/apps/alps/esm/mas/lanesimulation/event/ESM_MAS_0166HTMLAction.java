...
*@FileName       : ESM_MAS_166HTMLAction.java
*@FileTitle      : 
*Open Issues     :
*Change history  :
 ...
 *
 * @author eunju park
 * @see EsmMas0166Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0166HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
    /**
     * ESM_MAS_0166HTMLAction 객체를 생성
     */
    public ESM_MAS_0166HTMLAction() {
    	//
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 ESM_MAS_166Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0166Event event = new EsmMas0166Event();
