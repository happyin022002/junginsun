...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutPntVOUSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutPntVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutPntVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutPntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_RT_ROUT_PNT SET" ).append("\n"); 
