...
*@FileName : UsCgoRlseBkbcFlatFileVO.java
*@FileTitle : UsCgoRlseBkbcFlatFileVO
*Open Issues :
*Change history :
...
public class UsCgoRlseBkbcFlatFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsCgoRlseBkbcFlatFileVO> models = new ArrayList<UsCgoRlseBkbcFlatFileVO>();
	...
	public UsCgoRlseBkbcFlatFileVO() {}

	public UsCgoRlseBkbcFlatFileVO(String ibflag, String pagerows, String flatFileHeader, String dupFlatFileHeader, String snpFileHeader, String flatFileBody, String flatFileVvd) {
	 ...
	 * @param request
	 * @return UsCgoRlseBkbcFlatFileVO[]
	 */
	public UsCgoRlseBkbcFlatFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsCgoRlseBkbcFlatFileVO[]
	 */
	public UsCgoRlseBkbcFlatFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsCgoRlseBkbcFlatFileVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsCgoRlseBkbcFlatFileVO();
		...
		return getUsCgoRlseBkbcFlatFileVOs();
	}
	 ...
	 * @return UsCgoRlseBkbcFlatFileVO[]
	 */
	public UsCgoRlseBkbcFlatFileVO[] getUsCgoRlseBkbcFlatFileVOs(){
		UsCgoRlseBkbcFlatFileVO[] vos = (UsCgoRlseBkbcFlatFileVO[])models.toArray(new UsCgoRlseBkbcFlatFileVO[models.size()]);
		return vos;
	}
