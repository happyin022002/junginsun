...
public class BLDocumentationCMDBDAOmodifyBkgCntrPartialFlgUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", CNTR_WGT     = CASE WHEN @[target_bkg] <> @[source_bkg] THEN TRUNC(CNTR_WGT / @[partial_count], 2)" ).append("\n"); 
		query.append("WHEN @[target_bkg] =  @[source_bkg] THEN CNTR_WGT - (TRUNC(CNTR_WGT / @[partial_count], 2) * (@[partial_count] - 1)) END" ).append("\n"); 
		query.append("" ).append("\n"); 
