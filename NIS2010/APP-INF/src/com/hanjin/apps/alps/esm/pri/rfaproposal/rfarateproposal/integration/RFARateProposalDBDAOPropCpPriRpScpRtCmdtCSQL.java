...
*@FileName : RFARateProposalDBDAOPropCpPriRpScpRtCmdtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropCpPriRpScpRtCmdtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_RP_SCP_RT_CMDT Insert
	  * </pre>
	  */
	public RFARateProposalDBDAOPropCpPriRpScpRtCmdtCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropCpPriRpScpRtCmdtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                          ORDER BY B.PROP_NO, B.AMDT_SEQ, B.SVC_SCP_CD, B.CMDT_HDR_SEQ, B.CMDT_SEQ) AS CMDT_SEQ" ).append("\n"); 
