...
*@FileName : CndExpCustomsTransmissionDBDAOAddSendLogByCntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOAddSendLogByCntrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOAddSendLogByCntrCSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOAddSendLogByCntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    CRE_DT, UPD_USR_ID, UPD_DT, VVD_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("    ,@[hidden_vvd]" ).append("\n"); 
