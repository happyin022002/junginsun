 ...
 * @since J2EE 1.6
 */
public class ESM_BKG_1221HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg1221Event event = new EsmBkg1221Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			
			event. setIndDecCondVO((IndDecCondVO) getVO(request, IndDecCondVO.class));
		}
