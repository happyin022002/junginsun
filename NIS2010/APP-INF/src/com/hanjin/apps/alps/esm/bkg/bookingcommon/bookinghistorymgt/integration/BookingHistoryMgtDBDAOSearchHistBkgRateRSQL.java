...
public class BookingHistoryMgtDBDAOSearchHistBkgRateRSQL implements ISQLTemplate{
	...
	public BookingHistoryMgtDBDAOSearchHistBkgRateRSQL(){
		...
		params.put("doc_inter_rmk",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rt_inter_rmk",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT 'Bill Type' HIS_CATE_NM" ).append("\n"); 
		query.append("                , (SELECT INTG_CD_VAL_CTNT||' : '||INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("                     FROM COM_INTG_CD_DTL" ).append("\n"); 
		query.append("                    WHERE INTG_CD_ID = 'CD01639'" ).append("\n"); 
		query.append("                      AND INTG_CD_VAL_CTNT = @[rt_bl_tp_cd]) PRE_CTNT" ).append("\n"); 
		query.append("                , (SELECT INTG_CD_VAL_CTNT||' : '||INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("                     FROM COM_INTG_CD_DTL" ).append("\n"); 
		query.append("                    WHERE INTG_CD_ID = 'CD01639'" ).append("\n"); 
		query.append("                      AND INTG_CD_VAL_CTNT = NOW.RT_BL_TP_CD) CRNT_CTNT" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("          FROM BKG_RT_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO(+)  = @[bkg_no]" ).append("\n"); 
		query.append("	       AND NOW.CORR_NO(+) = 'TMP0000001' " ).append("\n"); 
		...
		query.append("		      , NVL(TRIM(@[diff_rmk]), ' ') PRE_CTNT" ).append("\n"); 
		query.append("              , NVL(TRIM(NOW.DIFF_RMK), ' ') CRNT_CTNT" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("     	 FROM BKG_RT_HIS NOW" ).append("\n"); 
		query.append("    	WHERE NOW.BKG_NO(+) = @[bkg_no]" ).append("\n"); 
		query.append("      	  AND NOW.CORR_NO(+) = 'TMP0000001'" ).append("\n"); 
		...
		query.append("		      , NVL(TRIM(@[rt_inter_rmk]), ' ') PRE_CTNT" ).append("\n"); 
		query.append("              , NVL(TRIM(NOW.RT_INTER_RMK), ' ') CRNT_CTNT" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("     	 FROM BKG_RT_HIS NOW" ).append("\n"); 
		query.append("    	WHERE NOW.BKG_NO(+) = @[bkg_no]" ).append("\n"); 
		query.append("      	  AND NOW.CORR_NO(+) = 'TMP0000001'" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("		UNION ALL" ).append("\n"); 
		query.append("		SELECT 'REMARK FOR DOC CENTER ' HIS_CATE_NM" ).append("\n"); 
		query.append("		      , NVL(TRIM(@[doc_inter_rmk]), ' ') PRE_CTNT" ).append("\n"); 
		query.append("              , NVL(TRIM(NOW.DOC_INTER_RMK), ' ') CRNT_CTNT" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("     	 FROM BKG_RT_HIS NOW" ).append("\n"); 
		query.append("    	WHERE NOW.BKG_NO(+) = @[bkg_no]" ).append("\n"); 
		query.append("      	  AND NOW.CORR_NO(+) = 'TMP0000001'" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("		UNION ALL" ).append("\n"); 
		query.append("		SELECT 'SELF CHECK' HIS_CATE_NM" ).append("\n"); 
		query.append("		      , @[grp_rat_chk_flg] PRE_CTNT" ).append("\n"); 
		query.append("              , GRP_RAT_CHK_FLG CRNT_CTNT" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("     	 FROM BKG_RT_HIS NOW" ).append("\n"); 
		query.append("    	WHERE NOW.BKG_NO(+) = @[bkg_no]" ).append("\n"); 
		query.append("      	  AND NOW.CORR_NO(+) = 'TMP0000001'" ).append("\n"); 
