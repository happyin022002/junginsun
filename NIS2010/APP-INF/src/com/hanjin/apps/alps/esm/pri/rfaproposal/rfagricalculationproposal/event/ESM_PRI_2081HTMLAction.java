...
public class ESM_PRI_2081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2081HTMLAction 객체를 생성
	 */
	public ESM_PRI_2081HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2081Event event = new EsmPri2081Event();
