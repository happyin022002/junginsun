...
*@FileName : Kor24ExpCorrVO.java
*@FileTitle : Kor24ExpCorrVO
*Open Issues :
*Change history :
...
public class Kor24ExpCorrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ExpCorrVO> models = new ArrayList<Kor24ExpCorrVO>();
...
/**
	 ...
	 * @param request
	 * @return Kor24ExpCorrVO[]
	 */
	public Kor24ExpCorrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24ExpCorrVO[]
	 */
	public Kor24ExpCorrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ExpCorrVO model = null;
	...
	public Kor24ExpCorrVO[] getKor24ExpCorrVOs(){
		Kor24ExpCorrVO[] vos = (Kor24ExpCorrVO[])models.toArray(new Kor24ExpCorrVO[models.size()]);
		return vos;
	}
