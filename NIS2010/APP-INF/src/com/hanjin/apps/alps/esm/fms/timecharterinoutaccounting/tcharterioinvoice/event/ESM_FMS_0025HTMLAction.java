...
*@FileName : ESM_FMS_0025HTMLAction.java
...
public class ESM_FMS_0025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0025HTMLAction 객체를 생성
	 */
	public ESM_FMS_0025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0025Event event = new EsmFms0025Event();
