...
*@FileName : ESM_FMS_0051HTMLAction.java
...
public class ESM_FMS_0051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0051HTMLAction 객체를 생성
	 */
	public ESM_FMS_0051HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0051Event event = new EsmFms0051Event();
		
		if(   command.isCommand(FormCommand.SEARCH)
		   || command.isCommand(FormCommand.MULTI) ) {
			event.setBnkYrmon(request.getParameter("bnk_yrmon"));
