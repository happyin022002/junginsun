...
*@FileName : SpacecontrolinquiryDBDAO021AllocPortViewList6ByPreRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpacecontrolinquiryDBDAO021AllocPortViewList6ByPreRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpacecontrolinquiryDBDAO021AllocPortViewList6ByPreRSQL(){
		setQuery();
		...
		query.append("FileName : SpacecontrolinquiryDBDAO021AllocPortViewList6ByPreRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    SELECT   DISTINCT PRE.TRD_CD" ).append("\n"); 
		...
		query.append("                                                       SELECT MAX(SUBSTR(M1.SLS_YRMON, 1, 4)||M1.COST_WK)" ).append("\n"); 
		...
		query.append("                   0 AS PRE_BKG_QTY," ).append("\n"); 
		query.append("                   0 AS TODAT_BKG_QTY," ).append("\n"); 
		query.append("                   0 AS RGN_ALOC_QTY," ).append("\n"); 
		query.append("                   0 AS ALOC_QTY" ).append("\n"); 
		...
		query.append("           DECODE(C1.CPY_NO, 1, DECODE(RNUM , C1.CPY_NO, PRE_BKG_QTY, 0), 0) AS FCT11," ).append("\n"); 
		query.append("           DECODE(C1.CPY_NO, 1, DECODE(RNUM , C1.CPY_NO, TODAY_BKG_QTY, 0), 0) AS BKG11," ).append("\n"); 
		...
		query.append("           DECODE(C1.CPY_NO, 2, DECODE(RNUM , C1.CPY_NO, PRE_BKG_QTY, 0), 0) AS FCT21," ).append("\n"); 
		query.append("           DECODE(C1.CPY_NO, 2, DECODE(RNUM , C1.CPY_NO, TODAY_BKG_QTY, 0), 0) AS BKG21," ).append("\n"); 
		...
		query.append("           DECODE(C1.CPY_NO, 3, DECODE(RNUM , C1.CPY_NO, PRE_BKG_QTY, 0), 0) AS FCT31," ).append("\n"); 
		query.append("           DECODE(C1.CPY_NO, 3, DECODE(RNUM , C1.CPY_NO, TODAY_BKG_QTY, 0), 0) AS BKG31," ).append("\n"); 
		...
		query.append("           DECODE(C1.CPY_NO, 4, DECODE(RNUM , C1.CPY_NO, PRE_BKG_QTY, 0), 0) AS FCT41," ).append("\n"); 
		query.append("           DECODE(C1.CPY_NO, 4, DECODE(RNUM , C1.CPY_NO, TODAY_BKG_QTY, 0), 0) AS BKG41," ).append("\n"); 
		...
		query.append("           DECODE(C1.CPY_NO, 5, DECODE(RNUM , C1.CPY_NO, PRE_BKG_QTY, 0), 0) AS FCT51," ).append("\n"); 
		query.append("           DECODE(C1.CPY_NO, 5, DECODE(RNUM , C1.CPY_NO, TODAY_BKG_QTY, 0), 0) AS BKG51," ).append("\n"); 
		...
		query.append("           DECODE(C1.CPY_NO, 6, DECODE(RNUM , C1.CPY_NO, PRE_BKG_QTY, 0), 0) AS FCT61," ).append("\n"); 
		query.append("           DECODE(C1.CPY_NO, 6, DECODE(RNUM , C1.CPY_NO, TODAY_BKG_QTY, 0), 0) AS BKG61," ).append("\n"); 
