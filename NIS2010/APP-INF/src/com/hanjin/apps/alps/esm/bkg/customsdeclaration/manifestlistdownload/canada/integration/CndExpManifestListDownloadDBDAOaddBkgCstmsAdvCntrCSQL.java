...
*@FileName : CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCntrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCntrCSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOaddBkgCstmsAdvCntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO  BKG_CSTMS_AMER_CNTR" ).append("\n"); 
		query.append("        (" ).append("\n"); 
