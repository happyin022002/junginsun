...
*@FileName : ESM_MAS_066Event.java
...
/**
 * ESM_MAS_066 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESM_MAS_066HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
public class EsmMas0066Event extends EventSupport {
	...
	/**
	 * ESM_MAS_066Event 객체를 생성
	 */
	public EsmMas0066Event(){
		//
	}
