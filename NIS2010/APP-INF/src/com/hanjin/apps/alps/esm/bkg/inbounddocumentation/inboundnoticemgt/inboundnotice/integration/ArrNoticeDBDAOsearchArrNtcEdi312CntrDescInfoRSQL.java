...
*@FileName : ArrNoticeDBDAOsearchArrNtcEdi312CntrDescInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ArrNoticeDBDAOsearchArrNtcEdi312CntrDescInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchArrNtcEdi312CntrDescInfo
	  * </pre>
	  */
	public ArrNoticeDBDAOsearchArrNtcEdi312CntrDescInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ArrNoticeDBDAOsearchArrNtcEdi312CntrDescInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       || '}CNTR_DESC' || CHR(10) cntr_desc_info" ).append("\n"); 
