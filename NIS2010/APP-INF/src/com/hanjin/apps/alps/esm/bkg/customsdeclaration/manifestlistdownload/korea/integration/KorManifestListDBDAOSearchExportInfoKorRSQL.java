...
*@FileName : KorManifestListDBDAOSearchExportInfoKorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchExportInfoKorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchExportInfoKorRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOSearchExportInfoKorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
