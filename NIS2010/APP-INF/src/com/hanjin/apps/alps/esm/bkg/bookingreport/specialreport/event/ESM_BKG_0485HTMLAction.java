...
*@FileName : ESM_BKG_0485HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esm.bkg.bookingreport.BookingReportSC 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author Ilmin Lee
 * @see BookingReportSCEvent 참조
 * @since J2EE 1.6
 */

public class ESM_BKG_0485HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0485HTMLAction 객체를 생성
	 */
	public ESM_BKG_0485HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0485Event event = new EsmBkg0485Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSpecialCargoManifestInfoVO((SpecialCargoManifestInfoVO)getVO(request, SpecialCargoManifestInfoVO .class));
