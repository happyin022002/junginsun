...
*@FileName : ESM_ACM_0038HTMLAction.java
 ...
 * @see EsmAcm0038Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0038HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_00038TMLAction 객체를 생성
	 */
	public ESM_ACM_0038HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0038Event event = new EsmAcm0038Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setFeederageInfoVO((FeederageInfoVO)getVO(request, FeederageInfoVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setFeederageInfoVOs((FeederageInfoVO[])getVOs(request, FeederageInfoVO.class, ""));
		}
