 ...
 *@FileName : ESM_BKG_1087HTMLAction.java
 ...
 * @see EsmBkg1087Event 참조
 * @since J2EE 1.4
 */
public class ESM_BKG_1087HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_1087HTMLAction 객체를 생성
	 */
	public ESM_BKG_1087HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1087Event event = new EsmBkg1087Event();
		...
		{	
			event.setCstmsBlVOs((DubaiCstmsBlVO[]) getVOs(request, DubaiCstmsBlVO.class));
		}
