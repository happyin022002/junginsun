...
public class Eur24ManifestDownloadDBDAOReactivateMrnNoUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  MVMT_REF_NO = ( SELECT MVMT_REF_NO" ).append("\n"); 
		query.append("                    FROM ( SELECT MVMT_REF_NO" ).append("\n"); 
		query.append("                                  , ROW_NUMBER() OVER( ORDER BY CRE_DT DESC) SEQ" ).append("\n"); 
