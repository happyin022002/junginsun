...
*@FileName : RFAProposalMainDBDAORqCpPriRpScpAmdtSmryVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAProposalMainDBDAORqCpPriRpScpAmdtSmryVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RqCpPriRpScpAmdtSmry
	  * </pre>
	  */
	public RFAProposalMainDBDAORqCpPriRpScpAmdtSmryVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFAProposalMainDBDAORqCpPriRpScpAmdtSmryVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE INTG_CD_ID = 'CD01740'" ).append("\n"); 
