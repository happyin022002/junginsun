...
*@FileName : Kor24ManifestListDBDAOsearchOrgBlNoRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchOrgBlNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchOrgBlNoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchOrgBlNoRSQL").append("\n");
		query.append("*/").append("\n");
	}
