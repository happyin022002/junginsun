...
*@FileName : ESM_BKG_0384HTMLAction.java
...
public class ESM_BKG_0384HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0384HTMLAction 객체를 생성
	 */
	public ESM_BKG_0384HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0384Event event = new EsmBkg0384Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBkgUsrTmpltVOS((BkgUsrTmpltVO[])getVOs(request, BkgUsrTmpltVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBkgUsrTmpltVO((BkgUsrTmpltVO)getVO(request, BkgUsrTmpltVO .class));
		}
