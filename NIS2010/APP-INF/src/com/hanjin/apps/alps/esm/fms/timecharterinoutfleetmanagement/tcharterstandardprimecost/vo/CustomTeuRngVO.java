...
*@FileName : CustomTeuRngVO.java
*@FileTitle : CustomTeuRngVO
*Open Issues :
*Change history :
...
public class CustomTeuRngVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomTeuRngVO> models = new ArrayList<CustomTeuRngVO>();
	...
	public CustomTeuRngVO() {}

	public CustomTeuRngVO(String ibflag, String pagerows, String rngYr, String rngSeq, String rngFmQty, String rngToQty, String hirAplyFlg, String mktRtAplyFlg, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.ibflag = ibflag;
	...
	public CustomTeuRngVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CustomTeuRngVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomTeuRngVO model = null;
		...
		return getCustomTeuRngVOs();
	}

	public CustomTeuRngVO[] getCustomTeuRngVOs(){
		CustomTeuRngVO[] vos = (CustomTeuRngVO[])models.toArray(new CustomTeuRngVO[models.size()]);
		return vos;
	}
