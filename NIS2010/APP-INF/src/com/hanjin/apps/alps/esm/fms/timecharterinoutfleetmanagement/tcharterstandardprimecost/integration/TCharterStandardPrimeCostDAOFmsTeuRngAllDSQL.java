...
public class TCharterStandardPrimeCostDAOFmsTeuRngAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TEU Range Target Delete All
	  * </pre>
	  */
	public TCharterStandardPrimeCostDAOFmsTeuRngAllDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("delete from fms_teu_rng" ).append("\n"); 
