...
*@FileName : ESM_FMS_0026HTMLAction.java
...
public class ESM_FMS_0026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0026HTMLAction 객체를 생성
	 */
	public ESM_FMS_0026HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0026Event event = new EsmFms0026Event();
