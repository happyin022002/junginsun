...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineCheckDurationAddCopyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriCmpbGlineCheckDurationAddCopyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineCheckDurationAddCopyRSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineCheckDurationAddCopyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(A.GLINE_SEQ,-1) AS GLINE_SEQ" ).append("\n"); 
