...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.acm.acmhistory.agncommagmthistory.integration;
...
public class AgncommagmthistoryDBDAOSearchAgncommagmthistoryListRSQL implements ISQLTemplate{
	...
	public AgncommagmthistoryDBDAOSearchAgncommagmthistoryListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.acm.acmhistory.agncommagmthistory.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("		   GLOBALDATE_PKG.TIME_CONV_OFC_FNC('PUSBO',A.CRE_DT,@[login_ofc]) AS CRE_LOCL_DT," ).append("\n"); 
		...
		query.append("		   GLOBALDATE_PKG.TIME_CONV_OFC_FNC('PUSBO',B.CRE_DT,@[login_ofc]) AS CRE_LOCL_DT," ).append("\n"); 
