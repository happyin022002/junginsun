...
*@FileName : ESM_BKG_1063_01HTMLAction.java
...
public class ESM_BKG_1063_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1063HTMLAction 객체를 생성
	 */
	public ESM_BKG_1063_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPkupNoMnlUpldSearchVO((PkupNoMnlUpldSearchVO)getVO(request, PkupNoMnlUpldSearchVO .class));
		}
