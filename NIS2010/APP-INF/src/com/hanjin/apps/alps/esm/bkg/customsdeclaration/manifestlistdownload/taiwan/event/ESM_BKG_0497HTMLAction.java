...
*@FileName : ESM_BKG_0497HTMLAction.java
...
public class ESM_BKG_0497HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0282HTMLAction 객체를 생성 
	 */
	public ESM_BKG_0497HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0497Event event = new EsmBkg0497Event();
    	 
		if(command.isCommand(FormCommand.MULTI)) { 			 		
			 event.setTaiwanManifestTransmitVOs((TaiwanManifestTransmitVO[])getVOs(request, TaiwanManifestTransmitVO.class,"sheet1_"));
		}
