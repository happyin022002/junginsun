...
*@FileName : UI_BKG_0900HTMLAction.java
*@FileTitle : Attach File Storage
*Open Issues :
*Change history :
...
public class ESM_BKG_0900HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_BKG_0900HTMLAction 객체를 생성
	 */
	public ESM_BKG_0900HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("[START:: perform ESM_BKG_0900HTMLAction  ]==========");

		EsmBkg0900Event event = new EsmBkg0900Event();

		FormCommand command = FormCommand.fromRequest(request);
		if(command.isCommand(FormCommand.SEARCH)) {
			log.debug("[START:: ESM_BKG_0900HTMLAction SEARCH ]==========");
			WarningReportInVO warningReportInVO = (WarningReportInVO)getVO(request, WarningReportInVO.class);
			event.setWarningReportInVO(warningReportInVO);
			log.debug("[END:: ESM_BKG_0900HTMLAction SEARCH ]==========");
		}

		request.setAttribute("Event", event);
		log.debug("[END:: perform ESM_BKG_0900HTMLAction  ]==========");
		return  event;
	}
