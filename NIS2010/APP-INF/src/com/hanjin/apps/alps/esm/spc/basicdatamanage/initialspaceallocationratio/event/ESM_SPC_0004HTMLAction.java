...
*@FileName : ESM_SPC_0004HTMLAction.java
...
public class ESM_SPC_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0004HTMLAction 객체를 생성
	 */
	public ESM_SPC_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0004Event event = new EsmSpc0004Event();
		SpcInitAlocRtoVO spcInitAlocRtoVO = new SpcInitAlocRtoVO();
		SpcInitAlocRtoVO[] spcInitAlocRtoVOs = null;
		
		if(command.isCommand(FormCommand.MULTI)) {
			spcInitAlocRtoVOs = spcInitAlocRtoVO.fromRequestGridArrayList(request, "");
			event.setSpcInitAlocRtoVOS(spcInitAlocRtoVOs);
		}
