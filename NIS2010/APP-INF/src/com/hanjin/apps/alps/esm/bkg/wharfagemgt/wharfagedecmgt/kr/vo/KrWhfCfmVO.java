...
*@FileName : KrWhfCfmVO.java
*@FileTitle : KrWhfCfmVO
*Open Issues :
*Change history :
...
public class KrWhfCfmVO extends BkgKrWhfCfmVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<KrWhfCfmVO> models = new ArrayList<KrWhfCfmVO>();
	...
	public KrWhfCfmVO(String ibflag, String pagerows, String ofcCd, String cfmUsrId, String updDt) {
		this.updDt = updDt;
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
	 ...
	 * @return KrWhfCfmVO[]
	 */
	public KrWhfCfmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KrWhfCfmVO[]
	 */
	public KrWhfCfmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KrWhfCfmVO model = null;
	 ...
	 * @return KrWhfCfmVO[]
	 */
	public KrWhfCfmVO[] getKrWhfCfmVOs(){
		KrWhfCfmVO[] vos = (KrWhfCfmVO[])models.toArray(new KrWhfCfmVO[models.size()]);
		return vos;
	}
