...
*@FileName : SCGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAORsltGriCalcOrgViaListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
