...
*@FileName : RsltPriSqGrpCmdtDtlVO.java
*@FileTitle : RsltPriSqGrpCmdtDtlVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.pri.scquotation.scgroupcommodityquotation.vo;
...
public class RsltPriSqGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqGrpCmdtDtlVO> models = new ArrayList<RsltPriSqGrpCmdtDtlVO>();
	...
	public RsltPriSqGrpCmdtDtlVO() {}

	public RsltPriSqGrpCmdtDtlVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String grpCmdtDtlSeq, String prcCmdtTpCd, String prcCmdtDefCd, String prcCmdtDefNm, String srcInfoCd, String srcInfoNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltPriSqGrpCmdtDtlVO[]
	 */
	public RsltPriSqGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqGrpCmdtDtlVO[]
	 */
	public RsltPriSqGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqGrpCmdtDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriSqGrpCmdtDtlVO();
				if (updDt[i] != null)
		...
		return getRsltPriSqGrpCmdtDtlVOs();
	}
	 ...
	 * @return RsltPriSqGrpCmdtDtlVO[]
	 */
	public RsltPriSqGrpCmdtDtlVO[] getRsltPriSqGrpCmdtDtlVOs(){
		RsltPriSqGrpCmdtDtlVO[] vos = (RsltPriSqGrpCmdtDtlVO[])models.toArray(new RsltPriSqGrpCmdtDtlVO[models.size()]);
		return vos;
	}
