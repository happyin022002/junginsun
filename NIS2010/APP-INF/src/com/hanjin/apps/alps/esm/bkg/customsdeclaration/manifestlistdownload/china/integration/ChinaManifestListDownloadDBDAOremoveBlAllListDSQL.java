...
*@FileName : ChinaManifestListDownloadDBDAOremoveBlAllListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChinaManifestListDownloadDBDAOremoveBlAllListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChinaManifestListDownloadDBDAOremoveBlAllListDSQL(){
		setQuery();
		...
		query.append("FileName : ChinaManifestListDownloadDBDAOremoveBlAllListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
