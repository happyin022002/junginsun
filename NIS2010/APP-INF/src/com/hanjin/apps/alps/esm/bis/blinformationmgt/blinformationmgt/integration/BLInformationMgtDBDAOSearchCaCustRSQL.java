...
*@FileName : BLInformationMgtDBDAOSearchCaCustRSQL.java
...
public class BLInformationMgtDBDAOSearchCaCustRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLInformationMgtDBDAOSearchCaCustRSQL(){
		setQuery();
		...
		query.append("FileName : BLInformationMgtDBDAOSearchCaCustRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("from bis_cust_his" ).append("\n"); 
		...
		query.append("CUST_CTY_NM||'/'||CUST_STE_CD||'/'||CUST_ZIP_ID||'/'||CSTMS_DECL_CNT_CD addr_cd," ).append("\n"); 
		query.append("CUST_FAX_NO||'/'||CUST_EML fax_eml" ).append("\n"); 
		query.append("from bis_cust_his BCH" ).append("\n"); 
		query.append("where bkg_no = @[bkg_no]" ).append("\n"); 
		...
		query.append(") ca, bis_correction cor" ).append("\n"); 
