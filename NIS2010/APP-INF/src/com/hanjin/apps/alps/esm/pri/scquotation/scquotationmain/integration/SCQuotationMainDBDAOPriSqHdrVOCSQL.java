...
*@FileName : SCQuotationMainDBDAOPriSqHdrVOCSQL.java
...
public class SCQuotationMainDBDAOPriSqHdrVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCQuotationMainDBDAOPriSqHdrVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCQuotationMainDBDAOPriSqHdrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
