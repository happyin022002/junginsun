 ...
 *@FileName : ESM_PRI_7027HTMLAction.java
 ...
 * 
 * @author LEE EUN SUP
 * @see EsmPri7027Event 참조
 * @since J2EE 1.6
 */
public class ESM_PRI_7027HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 7116963942112395646L;

	/**
	 * ESM_PRI_7027HTMLAction 객체를 생성
	 */
	public ESM_PRI_7027HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri7027Event event = new EsmPri7027Event();
