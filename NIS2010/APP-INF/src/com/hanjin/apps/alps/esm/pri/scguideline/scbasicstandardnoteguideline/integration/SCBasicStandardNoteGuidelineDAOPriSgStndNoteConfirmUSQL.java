...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteConfirmUSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteConfirmUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteConfirmUSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteConfirmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
