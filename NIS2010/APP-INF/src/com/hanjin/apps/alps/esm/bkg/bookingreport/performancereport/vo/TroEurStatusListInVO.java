...
public class TroEurStatusListInVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TroEurStatusListInVO> models = new ArrayList<TroEurStatusListInVO>();
	...
	/* Column Info */
	private String doorDtFr = null;
	/* Column Info */
	private String doorDtTo = null;
	/* Column Info */
	private String rcvTermYdCd = null;
	/* Column Info */
	...
	public TroEurStatusListInVO() {}

	public TroEurStatusListInVO(String ibflag, String pagerows, String rnum, String blNo, String troSeq, String troSubSeq, String actShprNm, String cntcPsonNm, String dorLocCd, String teuA, String teuB, String cntrTpszCd, String troQty, String dorArrDt, String pkupLocCd, String rtnLocCd, String rcvTermCd, String deTermCd, String soFlg, String soNumber, String woFlg, String woNumber, String rqstDt, String diffRmk, String porCd, String polCd, String podCd, String delCd, String slanCd, String vvdCd, String eqCtrlOfcCd, String troOfcCd, String ownrTrkFlg, String custCntCd, String custSeq, String custNm, String pkupYdCd, String docUsrId, String bkgDtFr, String bkgDtTo, String bkgStsCd, String troDtFr, String troDtTo, String pupDtFr, String pupDtTo, String troStaff, String dcgoFlg, String awkCgoFlg, String bbCgoFlg, String rdCgoFlg, String rcFlg, String zoneCode, String hLineType, String dLineType, String mdst, String ioBndCd, String d2, String d4, String d5, String d7, String d8, String d9, String dw, String dx, String r2, String r4, String r5, String f2, String f4, String f5, String o2, String o4, String s2, String s4, String t2, String t4, String a2, String a4, String p2, String p4, String z2, String z4, String o5, String totSum, String subgroupTitle ,String locCd, 
			                    String locYdCd ,String doorDtFr , String doorDtTo ,String rcvTermYdCd ,String cfmFlg, String cntrPkupDt, String cntrPkupYdCd , String cntrRtnYdCd ,String bkgOfcCd , String bkgStaff ,String r9 , String a5) {
		this.p4 = p4;
		this.p2 = p2;
		this.z4 = z4;
		this.d9 = d9;
		...
		this.r2 = r2;
		this.r4 = r4;
		this.troStaff = troStaff;
		this.r5 = r5;
		this.locCd = locCd;
		this.locYdCd = locYdCd;
		this.doorDtFr = doorDtFr;
		this.doorDtTo = doorDtTo;
		this.rcvTermYdCd = rcvTermYdCd;
		this.cfmFlg = cfmFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("so_number", getSoNumber());
		this.hashColumns.put("wo_flg", getWoFlg());
		this.hashColumns.put("wo_number", getWoNumber());
		...
		this.hashColumns.put("tro_staff", getTroStaff());
		this.hashColumns.put("r5", getR5());
		this.hashColumns.put("loc_cd", getLocCd());
		this.hashColumns.put("loc_yd_cd", getLocYdCd());
		this.hashColumns.put("door_dt_fr", getDoorDtFr());
		this.hashColumns.put("door_dt_to", getDoorDtTo());
		this.hashColumns.put("rcv_term_yd_cd", getRcvTermYdCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("so_number", "soNumber");
		this.hashFields.put("wo_flg", "woFlg");
		this.hashFields.put("wo_number", "woNumber");
		...
		this.hashFields.put("tro_staff", "troStaff");
		this.hashFields.put("r5", "r5");
		this.hashFields.put("loc_cd", "locCd");
		this.hashFields.put("loc_yd_cd", "locYdCd");
		this.hashFields.put("door_dt_fr", "doorDtFr");
		this.hashFields.put("door_dt_to", "doorDtTo");
		this.hashFields.put("rcv_term_yd_cd", "rcvTermYdCd");
		...
		this.hashFields.put("bkg_staff", "bkStaff");
	 ...
	 * @return the troStaff
	 */
	public String getTroStaff() {
		return troStaff;
	}

	/**
	 * @param troStaff the troStaff to set
	 */
	public void setTroStaff(String troStaff) {
		this.troStaff = troStaff;
	}

	/**
	 * @param troOfcCd the troOfcCd to set
	 */
	 ...
	 * @return the doorDtFr
	 */
	public String getDoorDtFr() {
		return doorDtFr;
	}

	/**
	 * @param doorDtFr the doorDtFr to set
	 */
	public void setDoorDtFr(String doorDtFr) {
		this.doorDtFr = doorDtFr;
	}
	 ...
	 * @return the doorDtTo
	 */
	public String getDoorDtTo() {
		return doorDtTo;
	}

	/**
	 * @param doorDtTo the doorDtTo to set
	 */
	public void setDoorDtTo(String doorDtTo) {
		this.doorDtTo = doorDtTo;
	}

	/**
	 * @param locYdCd the locYdCd to set
	 */
	...
	/**
	 * @return the rcvTermYdCd
	 */
	public String getRcvTermYdCd() {
		return rcvTermYdCd;
	}

	/**
	 * @param rcvTermYdCd the rcvTermYdCd to set
	 */
	public void setRcvTermYdCd(String rcvTermYdCd) {
		this.rcvTermYdCd = rcvTermYdCd;
	}
	...
	/**
	 * @param cntrPkupDt the cntrPkupDt to set
	 */
	...
	/**
	 * @param cntrPkupYdCd the cntrPkupYdCd to set
	 */
	...
	/**
	 * @param cntrRtnYdCd the cntrRtnYdCd to set
	 */
	...
	/**
	 * @param bkgStaff the bkgStaff to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTroOfcCd(JSPUtil.getParameter(request, "tro_ofc_cd", ""));
		...
		setSoNumber(JSPUtil.getParameter(request, "so_number", ""));
		setWoFlg(JSPUtil.getParameter(request, "wo_flg", ""));
		setWoNumber(JSPUtil.getParameter(request, "wo_number", ""));
		...
		setTroStaff(JSPUtil.getParameter(request, "tro_staff", ""));
		setR5(JSPUtil.getParameter(request, "r5", ""));
		setLocCd(JSPUtil.getParameter(request, "loc_cd", ""));
		setLocYdCd(JSPUtil.getParameter(request, "loc_yd_cd", ""));
		setDoorDtFr(JSPUtil.getParameter(request, "door_dt_fr", ""));
		setDoorDtTo(JSPUtil.getParameter(request, "door_dt_to", ""));
		setRcvTermYdCd(JSPUtil.getParameter(request, "rcv_term_yd_cd", ""));
	 ...
	 */
	public TroEurStatusListInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TroStatusListInVO[]
	 */
	public TroEurStatusListInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TroEurStatusListInVO model = null;
		...
		try {
			...
			String[] soNumber = (JSPUtil.getParameter(request, prefix	+ "so_number", length));
			String[] woFlg = (JSPUtil.getParameter(request, prefix	+ "wo_flg", length));
			String[] woNumber = (JSPUtil.getParameter(request, prefix	+ "wo_number", length));
			...
			String[] troStaff = (JSPUtil.getParameter(request, prefix	+ "tro_staff", length));
			...
			String[] doorDtFr = (JSPUtil.getParameter(request, prefix	+ "door_dt_fr", length));
			String[] doorDtTo = (JSPUtil.getParameter(request, prefix	+ "door_dt_to", length));
			String[] rcvTermYdCd = (JSPUtil.getParameter(request, prefix	+ "rcv_term_yd_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new TroEurStatusListInVO();
				if (p4[i] != null)
					model.setP4(p4[i]);
				if (p2[i] != null)
					model.setP2(p2[i]);
				...
				if (doorDtFr[i] != null)
					model.setDoorDtFr(doorDtFr[i]);
				if (doorDtTo[i] != null)
					model.setDoorDtTo(doorDtTo[i]);
				if (rcvTermYdCd[i] != null)
					model.setRcvTermYdCd(rcvTermYdCd[i]);
				if (r9[i] != null)
					model.setR9(r9[i]);
				if (o5[i] != null)
					model.setO5(o5[i]);
	 ...
	 * @return TroStatusListInVO[]
	 */
	public TroEurStatusListInVO[] getTroStatusListInVOs(){
		TroEurStatusListInVO[] vos = (TroEurStatusListInVO[])models.toArray(new TroEurStatusListInVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.troStaff = this.troStaff .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.doorDtFr = this.doorDtFr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.doorDtTo = this.doorDtTo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rcvTermYdCd = this.rcvTermYdCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
