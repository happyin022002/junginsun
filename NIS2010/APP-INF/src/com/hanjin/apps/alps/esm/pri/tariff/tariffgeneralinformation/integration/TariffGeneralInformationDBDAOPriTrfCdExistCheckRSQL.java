...
*@FileName : TariffGeneralInformationDBDAOPriTrfCdExistCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffGeneralInformationDBDAOPriTrfCdExistCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff Code의 존재 유무를 체크한다.
	  * </pre>
	  */
	public TariffGeneralInformationDBDAOPriTrfCdExistCheckRSQL(){
		setQuery();
		...
		query.append("FileName : TariffGeneralInformationDBDAOPriTrfCdExistCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
