...
*@FileName : ESM_PRI_3599HTMLAction.java
...
public class ESM_PRI_3599HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3599HTMLAction 객체를 생성
	 */
	public ESM_PRI_3599HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3599Event event = new EsmPri3599Event();
		

		event.setInPriTrfRuleDiffVO((InPriTrfRuleDiffVO)getVO(request, InPriTrfRuleDiffVO .class));
