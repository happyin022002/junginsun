...
*@FileName : RFAQuotationMainDBDAORsltPriRqMnVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAQuotationMainDBDAORsltPriRqMnVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAORsltPriRqMnVORSQL(){
		setQuery();
		...
		query.append("FileName : RFAQuotationMainDBDAORsltPriRqMnVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	DECODE(NVL(B.ESTM_MQC_QTY,''),0,'',B.ESTM_MQC_QTY) AS ESTM_MQC_QTY" ).append("\n"); 
