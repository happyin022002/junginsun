...
*@FileName : SCRoutePointProposalDBDAOPropCpPriSpScpRoutPntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRoutePointProposalDBDAOPropCpPriSpScpRoutPntCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_ROUT_PNT Insert
	  * </pre>
	  */
	public SCRoutePointProposalDBDAOPropCpPriSpScpRoutPntCSQL(){
		setQuery();
		...
		query.append("FileName : SCRoutePointProposalDBDAOPropCpPriSpScpRoutPntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", SVC_SCP_CD" ).append("\n"); 
		query.append(", ORG_DEST_TP_CD" ).append("\n"); 
		query.append(", DENSE_RANK() OVER (PARTITION BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, ORG_DEST_TP_CD" ).append("\n"); 
		query.append("ORDER BY PROP_NO, AMDT_SEQ, SVC_SCP_CD, ORG_DEST_TP_CD, ROUT_PNT_SEQ) AS ROUT_PNT_SEQ" ).append("\n"); 
		query.append(", ROUT_PNT_LOC_TP_CD" ).append("\n"); 
		query.append(", ROUT_PNT_LOC_DEF_CD" ).append("\n"); 
