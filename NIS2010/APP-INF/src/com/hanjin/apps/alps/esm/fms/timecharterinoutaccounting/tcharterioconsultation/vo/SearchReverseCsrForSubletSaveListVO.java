...
public class SearchReverseCsrForSubletSaveListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchReverseCsrForSubletSaveListVO> models = new ArrayList<SearchReverseCsrForSubletSaveListVO>();
	 ...
	 */
	public SearchReverseCsrForSubletSaveListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchReverseCsrForSubletListVO[]
	 */
	public SearchReverseCsrForSubletSaveListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchReverseCsrForSubletSaveListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchReverseCsrForSubletSaveListVO();
	 ...
	 * @return SearchReverseCsrForSubletListVO[]
	 */
	public SearchReverseCsrForSubletSaveListVO[] getSearchReverseCsrForSubletListVOs(){
		SearchReverseCsrForSubletSaveListVO[] vos = (SearchReverseCsrForSubletSaveListVO[])models.toArray(new SearchReverseCsrForSubletSaveListVO[models.size()]);
		return vos;
	}
