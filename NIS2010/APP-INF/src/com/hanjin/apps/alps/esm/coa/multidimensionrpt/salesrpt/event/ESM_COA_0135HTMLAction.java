 ...
 *
 * @author Ari
 * @see ESM_COA_135Event , ESM_COA_135EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_COA_0135HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_COA_135HTMLAction 객체를 생성
	 */
	public ESM_COA_0135HTMLAction() {
		//
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESM_COA_135Event로 파싱하여 request에 셋팅<br>
	 *
	...
	public Event perform(HttpServletRequest request) {
		...
		EsmCoa0135Event event = new EsmCoa0135Event();
