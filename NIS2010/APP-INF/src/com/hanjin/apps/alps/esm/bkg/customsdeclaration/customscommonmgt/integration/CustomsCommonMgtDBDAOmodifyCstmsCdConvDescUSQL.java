...
*@FileName : CustomsCommonMgtDBDAOmodifyCstmsCdConvDescUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomsCommonMgtDBDAOmodifyCstmsCdConvDescUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyCstmsCdConvDesc
	  * </pre>
	  */
	public CustomsCommonMgtDBDAOmodifyCstmsCdConvDescUSQL(){
		setQuery();
		...
		query.append("FileName : CustomsCommonMgtDBDAOmodifyCstmsCdConvDescUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_CD_CONV_DESC" ).append("\n"); 
		query.append("SET CSTMS_CD_DESC = @[cstms_cd_desc]," ).append("\n"); 
