...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtRoutVOAddGlineCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtCmdtRoutVOAddGlineCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtRoutVOAddGlineCopyCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtRoutVOAddGlineCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",		ORG_CY_DOR_RT_TP_CD" ).append("\n"); 
		query.append(",		DEST_CY_DOR_RT_TP_CD" ).append("\n"); 
		query.append("FROM    PRI_RG_RT_CMDT_ROUT" ).append("\n"); 
