...
*@FileTitle : <Kor24MacamdVO.java
*@FileTitle : Kor24MacamdVO
*Open Issues :
*Change history :
...
public class Kor24MacamdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24MacamdVO> models = new ArrayList<Kor24MacamdVO>();
...
/**
	 ...
	 * @param request
	 * @return Kor24MacamdVO[]
	 */
	public Kor24MacamdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24MacamdVO[]
	 */
	public Kor24MacamdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24MacamdVO model = null;
	 ...
	 * @return Kor24MacamdVO[]
	 */
	public Kor24MacamdVO[] getKor24MacamdVOs(){
		Kor24MacamdVO[] vos = (Kor24MacamdVO[])models.toArray(new Kor24MacamdVO[models.size()]);
		return vos;
	}
