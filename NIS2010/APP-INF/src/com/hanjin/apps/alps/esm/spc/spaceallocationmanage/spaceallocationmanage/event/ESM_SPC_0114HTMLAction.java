...
*@FileName : ESM_SPC_0114HTMLAction.java
...
public class ESM_SPC_0114HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0114HTMLAction 객체를 생성
	 */
	public ESM_SPC_0114HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0114Event event = new EsmSpc0114Event();
