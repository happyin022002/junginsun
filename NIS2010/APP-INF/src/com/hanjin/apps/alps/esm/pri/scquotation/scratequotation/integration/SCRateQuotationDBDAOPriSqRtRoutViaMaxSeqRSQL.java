...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutViaMaxSeqRSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutViaMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutViaMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutViaMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
