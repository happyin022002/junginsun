...
*@FileName : ESM_PRI_8004HTMLAction.java
...
public class ESM_PRI_8004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_8004HTMLAction 객체를 생성
	 */
	public ESM_PRI_8004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri8004Event event = new EsmPri8004Event();
		
//		if(command.isCommand(FormCommand.SEARCH01)) {
//			event.setPriScqAwkHdrVO((PriScqAwkHdrVO)getVO(request, PriScqAwkHdrVO .class));
//		}
//		else if(command.isCommand(FormCommand.SEARCH02)) {
//			event.setPriScqAwkCgoVO((PriScqAwkCgoVO)getVO(request, PriScqAwkCgoVO .class));
//		}
