...
*@FileName : StatusManageDBDAOCreateTransferSqmQtaLodRevCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateTransferSqmQtaLodRevCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Transfer 시 연간 정보로 1Q SQM_QTA_LOD_REV 생성
	  * </pre>
	  */
	public StatusManageDBDAOCreateTransferSqmQtaLodRevCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateTransferSqmQtaLodRevCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SQM_QTA_LOD_REV (" ).append("\n"); 
		...
		query.append("      ,L.LOD_QTY" ).append("\n"); 
		query.append("      ,@[f_usr_id] AS CRE_USR_ID" ).append("\n"); 
		query.append("      ,SYSDATE     AS CRE_DT" ).append("\n"); 
		query.append("      ,@[f_usr_id] AS UPD_USR_ID" ).append("\n"); 
		query.append("      ,SYSDATE     AS UPD_DT" ).append("\n"); 
		query.append("  FROM SQM_QTA_TGT_VVD T" ).append("\n"); 
		query.append("      ,SQM_QTA_LOD_REV L" ).append("\n"); 
