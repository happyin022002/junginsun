...
*@FileName : FICCostInterfaceDBDAOAddTariffFeederHeaderDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOAddTariffFeederHeaderDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_TRF_FDR_HDR SAVE
	  * </pre>
	  */
	public FICCostInterfaceDBDAOAddTariffFeederHeaderDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOAddTariffFeederHeaderDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
