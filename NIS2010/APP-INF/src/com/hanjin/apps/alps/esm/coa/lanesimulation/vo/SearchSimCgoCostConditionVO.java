...
*@FileName : SearchSimCgoCostConditionVO.java
*@FileTitle : SearchSimCgoCostConditionVO
*Open Issues :
*Change history :
...
public class SearchSimCgoCostConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSimCgoCostConditionVO> models = new ArrayList<SearchSimCgoCostConditionVO>();
	...
	public SearchSimCgoCostConditionVO() {}

	public SearchSimCgoCostConditionVO(String ibflag, String pagerows, String simDt, String simNo, String slanCd, String header) {
		this.ibflag = ibflag;
		this.slanCd = slanCd;
		this.simDt = simDt;
		this.simNo = simNo;
	 ...
	 */
	public SearchSimCgoCostConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchSimCgoCostConditionVO[]
	 */
	public SearchSimCgoCostConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSimCgoCostConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchSimCgoCostConditionVO();
				if (ibflag[i] != null)
		...
		return getSearchSimCgoCostConditionVOs();
	}
	 ...
	 * @return SearchSimCgoCostConditionVO[]
	 */
	public SearchSimCgoCostConditionVO[] getSearchSimCgoCostConditionVOs(){
		SearchSimCgoCostConditionVO[] vos = (SearchSimCgoCostConditionVO[])models.toArray(new SearchSimCgoCostConditionVO[models.size()]);
		return vos;
	}
