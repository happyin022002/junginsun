...
*@FileName : KorManifestListDBDAOAddExportNoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOAddExportNoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOAddExportNoCSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOAddExportNoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(TRIM(@[prt_lodg_flg]),'N'), '0'," ).append("\n"); 
