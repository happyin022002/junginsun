...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutViaCpyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriRoutViaCpyVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriRoutViaCpyVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriRoutViaCpyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_GRI_ROUT_VIA_CPY (" ).append("\n"); 
