...
*@FileName : OwnersAccountDBDAOOwnersAccountCsulSlpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnersAccountDBDAOOwnersAccountCsulSlpUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 전표 취소 시 원전표의 CSR_NO 를 PAIR로 넣어준다   
	  * </pre>
	  */
	public OwnersAccountDBDAOOwnersAccountCsulSlpUSQL(){
		setQuery();
		...
		query.append("FileName : OwnersAccountDBDAOOwnersAccountCsulSlpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET PAIR_SLP_TP_CD = @[pair_slp_tp_cd]," ).append("\n"); 
		query.append("       PAIR_SLP_FUNC_CD = @[pair_slp_func_cd]," ).append("\n"); 
		query.append("       PAIR_SLP_OFC_CD = @[pair_slp_ofc_cd]," ).append("\n"); 
		query.append("       PAIR_SLP_ISS_DT = @[pair_slp_iss_dt]," ).append("\n"); 
		query.append("       PAIR_SLP_SER_NO = @[pair_slp_ser_no]," ).append("\n"); 
		query.append("       PAIR_SLP_SEQ_NO = @[pair_slp_seq_no]" ).append("\n"); 
