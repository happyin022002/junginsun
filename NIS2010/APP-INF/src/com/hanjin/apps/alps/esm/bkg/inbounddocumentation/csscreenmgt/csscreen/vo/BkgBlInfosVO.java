...
*@FileName : BkgBlInfosVO.java
*@FileTitle : BkgBlInfosVO
*Open Issues :
*Change history :
...
public class BkgBlInfosVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgBlInfosVO> models = new ArrayList<BkgBlInfosVO>();
	...
	public BkgBlInfosVO(String ibflag, String pagerows, String bkgNo, String splitFlg, String blNo, String blTpCd, String cstmsDesc) {
	 ...
	 * @return BkgBlInfosVO[]
	 */
	public BkgBlInfosVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgBlInfosVO[]
	 */
	public BkgBlInfosVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgBlInfosVO model = null;
	 ...
	 * @return BkgBlInfosVO[]
	 */
	public BkgBlInfosVO[] getBkgBlInfosVOs(){
		BkgBlInfosVO[] vos = (BkgBlInfosVO[])models.toArray(new BkgBlInfosVO[models.size()]);
		return vos;
	}
