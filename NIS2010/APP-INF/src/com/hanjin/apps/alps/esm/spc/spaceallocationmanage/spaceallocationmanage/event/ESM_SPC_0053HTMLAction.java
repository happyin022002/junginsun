...
*@FileName : ESM_SPC_0053HTMLAction.java
...
public class ESM_SPC_0053HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0053HTMLAction 객체를 생성
	 */
	public ESM_SPC_0053HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0053Event event = new EsmSpc0053Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST)) {
			//event.setSearchSpaceAllocation0053ManageListVO((SearchSpaceAllocation0053ManageListVO)getVO(request, SearchSpaceAllocation0053ManageListVO .class));
