...
*@FileName : ModelManageDBDAOUpdSmpRaplyCfmFlgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAOUpdSmpRaplyCfmFlgUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPC_MDL_CUST_REV_LANE 테이블의 raply_cfm_flg 정보를 업데이트 한다.
	  * </pre>
	  */
	public ModelManageDBDAOUpdSmpRaplyCfmFlgUSQL(){
		setQuery();
		...
		params.put("raply_cfm_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ModelManageDBDAOUpdSmpRaplyCfmFlgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET RAPLY_CFM_FLG = @[raply_cfm_flg]" ).append("\n"); 
		...
		query.append("   AND ROWNUM           = DECODE(@[rlane_cd], NULL, '1', ROWNUM)" ).append("\n"); 
