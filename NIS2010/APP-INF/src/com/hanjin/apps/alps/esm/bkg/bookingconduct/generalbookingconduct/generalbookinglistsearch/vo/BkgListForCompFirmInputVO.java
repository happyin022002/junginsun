...
public class BkgListForCompFirmInputVO extends AbstractValueObject {
	...
	public BkgListForCompFirmInputVO(String ibflag, String pagerows, String bkgVvdCd, String vslPrePostCd, String polCd, String podCd, String repCmdt, String bkgOfcCd, String obSlsOfcCd, String sCustCntCd, String sCustSeq, String sCustNm, String fCustCntCd, String fCustSeq, String fCustNm, String bkgNo,  String sBkgCreDt, String eBkgCreDt, String bkgStsCd, String alocStsCd, String alocSvcCd) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAlocSvcCd(JSPUtil.getParameter(request, "aloc_svc_cd", ""));
	}
	...
	public BkgListForCompFirmInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] alocStsCd = (JSPUtil.getParameter(request, prefix	+ "aloc_sts_cd".trim(), length));
			String[] alocSvcCd = (JSPUtil.getParameter(request, prefix	+ "aloc_svc_cd".trim(), length));
