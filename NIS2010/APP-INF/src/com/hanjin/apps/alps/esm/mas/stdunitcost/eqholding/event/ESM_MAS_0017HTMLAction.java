...
*@FileName : ESM_MAS_0017HTMLAction.java
 ...
 * @see EsmMas0017Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0017HTMLAction 객체를 생성
	 */
	public ESM_MAS_0017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0017Event event = new EsmMas0017Event();  		
    	    	
    	
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setCntrPdmInvtVO((CntrPdmInvtVO)getVO(request, CntrPdmInvtVO.class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setCntrPdmInvtVOs((CntrPdmInvtVO[])getVOs(request, CntrPdmInvtVO.class, ""));
		}
