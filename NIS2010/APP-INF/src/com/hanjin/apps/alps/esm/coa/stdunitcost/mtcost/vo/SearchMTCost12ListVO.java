...
*@FileName : SearchMTCost12ListVO.java
*@FileTitle : SearchMTCost12ListVO
*Open Issues :
*Change history :
...
public class SearchMTCost12ListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchMTCost12ListVO> models = new ArrayList<SearchMTCost12ListVO>();
	...
	public SearchMTCost12ListVO() {}

	public SearchMTCost12ListVO(String ibflag, String pagerows, String costYrmon, String fcntrEccCd, String cntrTpszCd, String eqStatus, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty) {
...
/**
	 ...
	 */
	public SearchMTCost12ListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMTCost12ListVO[]
	 */
	public SearchMTCost12ListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchMTCost12ListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchMTCost12ListVO();
		...
		return getSearchMTCost12ListVOs();
	}
	 ...
	 * @return SearchMTCost12ListVO[]
	 */
	public SearchMTCost12ListVO[] getSearchMTCost12ListVOs(){
		SearchMTCost12ListVO[] vos = (SearchMTCost12ListVO[])models.toArray(new SearchMTCost12ListVO[models.size()]);
		return vos;
	}
