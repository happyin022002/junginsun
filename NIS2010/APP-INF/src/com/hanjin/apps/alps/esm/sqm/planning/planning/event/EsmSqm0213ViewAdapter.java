...
*@FileName       : EsmSqm0213ViewAdapter.java
 ...
 * @since SQM USER
 */
public class EsmSqm0213ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
            ...
            sbufXML.append("<TD>" + getNull(colValues.get("sqm_mn_sctr_flg")) + "</TD>");
            
            sbufXML.append("<TD>" + getNull(colValues.get("pre_lod_qty"))     + "</TD>");
            sbufXML.append("<TD>" + getNull(colValues.get("pre_grs_rpb_rev")) + "</TD>");
            sbufXML.append("<TD></TD>");
