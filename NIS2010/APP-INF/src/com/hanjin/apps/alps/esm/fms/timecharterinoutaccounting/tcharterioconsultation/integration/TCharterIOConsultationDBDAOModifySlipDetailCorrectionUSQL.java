...
*@FileName : TCharterIOConsultationDBDAOModifySlipDetailCorrectionUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOModifySlipDetailCorrectionUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOConsultationDBDAOModifySlipDetailCorrectionUSQL
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOModifySlipDetailCorrectionUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOModifySlipDetailCorrectionUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CSR_DESC = @[csr_desc]," ).append("\n"); 
