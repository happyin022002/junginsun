...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,DENSE_RANK() OVER(PARTITION BY SVC_SCP_CD, GLINE_SEQ, PRC_CUST_TP_CD, CMDT_HDR_SEQ ORDER BY CMDT_SEQ) AS CMDT_SEQ" ).append("\n"); 
		query.append("        ,PRC_CMDT_TP_CD" ).append("\n"); 
		query.append("        ,PRC_CMDT_DEF_CD" ).append("\n"); 
		...
		query.append("                ,C.CMDT_SEQ" ).append("\n"); 
