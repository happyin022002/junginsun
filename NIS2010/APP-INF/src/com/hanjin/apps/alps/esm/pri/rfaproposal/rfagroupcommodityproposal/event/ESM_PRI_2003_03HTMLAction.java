...
public class ESM_PRI_2003_03HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0003_03HTMLAction 객체를 생성
	 */
	public ESM_PRI_2003_03HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri200303Event event = new EsmPri200303Event();
		
		if(command.isCommand(FormCommand.MULTI01)) { //save			
			GrpCmdtPropVO vo = new GrpCmdtPropVO();
			vo.setPriRpScpGrpCmdtVOs((PriRpScpGrpCmdtVO[])getVOs(request, PriRpScpGrpCmdtVO .class,"sheet1_"));
			vo.setPriRpScpGrpCmdtDtlVOs((PriRpScpGrpCmdtDtlVO[])getVOs(request, PriRpScpGrpCmdtDtlVO .class,"sheet2_"));
			vo.setPriRpScpGrpCmdtVO((PriRpScpGrpCmdtVO)getVO(request, PriRpScpGrpCmdtVO .class));
			...
			event.setPriRpScpGrpCmdtVOS((PriRpScpGrpCmdtVO[])getVOs(request, PriRpScpGrpCmdtVO .class));
		}		
