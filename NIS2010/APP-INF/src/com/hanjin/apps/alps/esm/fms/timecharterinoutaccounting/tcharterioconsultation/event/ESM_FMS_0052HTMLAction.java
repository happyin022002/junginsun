...
*@FileName : ESM_FMS_0052HTMLAction.java
...
public class ESM_FMS_0052HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0052HTMLAction 객체를 생성
	 */
	public ESM_FMS_0052HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0052Event event = new EsmFms0052Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setSlipAproFlg(request.getParameter("slip_apro_flg"));
