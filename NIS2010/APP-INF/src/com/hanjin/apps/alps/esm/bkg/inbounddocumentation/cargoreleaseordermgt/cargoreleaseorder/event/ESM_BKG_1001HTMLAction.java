...
*@FileName : ESM_BKG_1001HTMLAction.java
...
public class ESM_BKG_1001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1001HTMLAction 객체를 생성
	 */
	public ESM_BKG_1001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1001Event event = new EsmBkg1001Event();
