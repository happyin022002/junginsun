...
*@FileName : ESM_BKG_9460HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESM_BKG_9460HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9460HTMLAction 객체를 생성
	 */
	public ESM_BKG_9460HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9460Event event = new EsmBkg9460Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setN3ptyBlRqstVO((N3ptyBlRqstVO)getVO(request, N3ptyBlRqstVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setN3ptyBlRqstVOs((N3ptyBlRqstVO[])getVOs(request, N3ptyBlRqstVO.class, ""));
		}
