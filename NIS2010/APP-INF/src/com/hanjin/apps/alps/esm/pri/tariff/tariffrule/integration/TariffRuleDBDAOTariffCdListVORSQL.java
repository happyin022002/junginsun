...
*@FileName : TariffRuleDBDAOTariffCdListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffRuleDBDAOTariffCdListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * tariff code list를 조회한다.
	  * </pre>
	  */
	public TariffRuleDBDAOTariffCdListVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.pri.tariff.tariffrule.integration").append("\n"); 
		query.append("FileName : TariffRuleDBDAOTariffCdListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" ORDER BY A.TRF_PFX_CD DESC, A.TRF_NO" ).append("\n"); 
