...
*@FileName : ScqListDBDAOsearchAwkBbCgoAlistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqListDBDAOsearchAwkBbCgoAlistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqListDBDAOsearchAwkBbCgoAlistRSQL(){
		setQuery();
		...
		query.append("FileName : ScqListDBDAOsearchAwkBbCgoAlistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND PROG_STS_CD NOT IN ('T','C')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
