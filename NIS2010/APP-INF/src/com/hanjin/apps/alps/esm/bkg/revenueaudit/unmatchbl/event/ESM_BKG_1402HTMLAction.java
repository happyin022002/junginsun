...
*@FileName : ESM_BKG_1402HTMLAction.java
...
public class ESM_BKG_1402HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1402HTMLAction 객체를 생성
	 */
	public ESM_BKG_1402HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		log.debug("\n\n\n\n\n   ESM_BKG_1402HTMLAction aaaaaaaaaaaaaaaa  Start \n\n\n\n");	
    	FormCommand command = FormCommand.fromRequest(request);
		EsmBkg1402Event event = new EsmBkg1402Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRetroActFilterSchVO((RetroActFilterSchVO)getVO(request, RetroActFilterSchVO.class));
		}
