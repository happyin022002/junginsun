...
*@FileName : ESM_BKG_0018HTMLAction.java
*@FileTitle : EMS_BKG-0018
*Open Issues :
*Change history :
...
public class ESM_BKG_0018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EMS_BKG_0018HTMLAction 객체를 생성
	 */
	public ESM_BKG_0018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0018Event event = new EsmBkg0018Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPanamaVesselCondVO((PanamaVesselCondVO)getVO(request, PanamaVesselCondVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setPanamaVesselVOS((PanamaVesselVO[])getVOs(request, PanamaVesselVO.class,""));
		} 
