...
*@FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrDSQL.java
...
public class SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrDSQL(){
		setQuery();
		...
		query.append("FileName : SCBasicStandardNoteGuidelineDAOPriSgStndNoteHdrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from pri_sg_stnd_note_hdr" ).append("\n"); 
