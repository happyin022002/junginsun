...
*@FileName : PickUpNoticeDBDAOdeletePkupNtcDtlByBkgNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PickUpNoticeDBDAOdeletePkupNtcDtlByBkgNoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PickUpNoticeDBDAOdeletePkupNtcDtlByBkgNoDSQL(){
		setQuery();
		...
		query.append("FileName : PickUpNoticeDBDAOdeletePkupNtcDtlByBkgNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE BKG_PKUP_NTC_DTL " ).append("\n"); 
