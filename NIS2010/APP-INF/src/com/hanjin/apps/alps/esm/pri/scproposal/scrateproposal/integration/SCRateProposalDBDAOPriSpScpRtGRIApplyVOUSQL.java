...
*@FileName : SCRateProposalDBDAOPriSpScpRtGRIApplyVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtGRIApplyVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtGRIApplyVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtGRIApplyVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                      ,ROW_NUMBER() OVER(PARTITION BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ, A.RT_SEQ ORDER BY  X.GRI_GRP_SEQ) AS RN" ).append("\n"); 
		query.append("                  FROM PRI_SP_SCP_RT A" ).append("\n"); 
		query.append("                      ,PRI_SP_SCP_RT_CMDT B" ).append("\n"); 
		query.append("		      -- 20171121 송민석 FIXED RATE CHECK된것은 GRI에서 제외 하기 위해 추가함 시작" ).append("\n"); 
		query.append("		      ,PRI_SP_SCP_RT_CMDT_ROUT CMDT_ROUT" ).append("\n"); 
		query.append("		      -- 20171121 송민석 FIXED RATE CHECK된것은 GRI에서 제외 하기 위해 추가함 종료" ).append("\n"); 
		query.append("                      ,PRI_SP_SCP_RT_ACT_CUST C" ).append("\n"); 
		query.append("                      ,PRI_SP_SCP_RT_ROUT_PNT D" ).append("\n"); 
		query.append("                      ,PRI_SP_SCP_RT_ROUT_VIA E" ).append("\n"); 
		query.append("                      ,PRI_SP_SCP_RT_ROUT_VIA F" ).append("\n"); 
		query.append("                      ,PRI_SP_SCP_RT_ROUT_PNT G" ).append("\n"); 
		query.append("                      ,(SELECT A.PROP_NO" ).append("\n"); 
		query.append("                              ,A.AMDT_SEQ" ).append("\n"); 
		query.append("                              ,A.SVC_SCP_CD" ).append("\n"); 
		query.append("                              ,A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                         GROUP BY A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ, A.RT_SEQ) I" ).append("\n"); 
		query.append("                      ,(SELECT A.PROP_NO" ).append("\n"); 
		query.append("                              ,A.AMDT_SEQ" ).append("\n"); 
		query.append("                              ,A.SVC_SCP_CD" ).append("\n"); 
		query.append("                              ,A.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                          FROM PRI_SP_SCP_GRI_GRP      A" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_CMDT     B" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_ACT_CUST C" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_ROUT_PNT D" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_ROUT_VIA E" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_ROUT_VIA F" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_ROUT_PNT G" ).append("\n"); 
		query.append("                              ,PRI_SP_SCP_GRI_RT       H" ).append("\n"); 
		query.append("                         WHERE A.PROP_NO = B.PROP_NO(+)" ).append("\n"); 
		query.append("                           AND A.AMDT_SEQ = B.AMDT_SEQ(+)" ).append("\n"); 
		query.append("                           AND A.SVC_SCP_CD = B.SVC_SCP_CD(+)" ).append("\n"); 
		query.append("                           AND A.GEN_SPCL_RT_TP_CD = B.GEN_SPCL_RT_TP_CD(+)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("		  -- 20171121 송민석 FIXED RATE CHECK된것은 GRI에서 제외 하기 위해 추가함 시작" ).append("\n"); 
		query.append("		   AND A.PROP_NO = CMDT_ROUT.PROP_NO" ).append("\n"); 
		query.append("		   AND A.AMDT_SEQ = CMDT_ROUT.AMDT_SEQ" ).append("\n"); 
		query.append("		   AND A.SVC_SCP_CD = CMDT_ROUT.SVC_SCP_CD" ).append("\n"); 
		query.append("		   AND A.GEN_SPCL_RT_TP_CD = CMDT_ROUT.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("		   AND A.CMDT_HDR_SEQ = CMDT_ROUT.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("		   AND A.ROUT_SEQ = CMDT_ROUT.ROUT_SEQ" ).append("\n"); 
		query.append("		   AND NVL(CMDT_ROUT.FX_RT_FLG,'N') != 'Y'" ).append("\n"); 
		query.append("		  -- 20171121 송민석 FIXED RATE CHECK된것은 GRI에서 제외 하기 위해 추가함 종료" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                   AND A.PROP_NO = C.PROP_NO(+)" ).append("\n"); 
		query.append("                   AND A.AMDT_SEQ = C.AMDT_SEQ(+)" ).append("\n"); 
		...
		query.append("                   AND A.GEN_SPCL_RT_TP_CD = X.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		...
		query.append("                           AND A.GEN_SPCL_RT_TP_CD = Y.GEN_SPCL_RT_TP_CD" ).append("\n"); 
