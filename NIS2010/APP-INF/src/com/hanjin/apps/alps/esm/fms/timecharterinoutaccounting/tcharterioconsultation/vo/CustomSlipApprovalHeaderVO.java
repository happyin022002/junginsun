...
*@FileName : CustomSlipApprovalHeaderVO.java
*@FileTitle : CustomSlipApprovalHeaderVO
*Open Issues :
*Change history :
...
public class CustomSlipApprovalHeaderVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomSlipApprovalHeaderVO> models = new ArrayList<CustomSlipApprovalHeaderVO>();
	...
	/* Column Info */
	private String mgmtUrgCfmFlg = null;
	/* Column Info */
	private String mgmtUrgCfmDt	 = null;	
	...
	public CustomSlipApprovalHeaderVO(String ibflag, String pagerows, String csrNo, String csrTpCd, String invDt, String invTermDt, String glDt, String vndrNo, String csrAmt, String payAmt, String payDt, String csrCurrCd, String vndrTermNm, String invDesc, String attrCateNm, String attrCtnt1, String attrCtnt2, String attrCtnt3, String attrCtnt4, String attrCtnt5, String attrCtnt6, String attrCtnt7, String attrCtnt8, String attrCtnt9, String attrCtnt10, String attrCtnt11, String attrCtnt12, String attrCtnt13, String attrCtnt14, String attrCtnt15, String gloAttrCtnt1, String gloAttrCtnt2, String gloAttrCtnt3, String gloAttrCtnt4, String gloAttrCtnt5, String gloAttrCtnt6, String gloAttrCtnt7, String gloAttrCtnt8, String gloAttrCtnt9, String gloAttrCtnt10, String gloAttrCtnt11, String gloAttrCtnt12, String gloAttrCtnt13, String gloAttrCtnt14, String gloAttrCtnt15, String gloAttrCtnt16, String gloAttrCtnt17, String gloAttrCtnt18, String srcCtnt, String payMzdLuCd, String payGrpLuCd, String coaCoCd, String coaRgnCd, String coaCtrCd, String coaAcctCd, String coaVvdCd, String coaInterCoCd, String coaFtuN1stCd, String coaFtuN2ndCd, String ppdNo, String ppdDtrbNo, String ppdAplyAmt, String ppdGlDt, String aproFlg, String taxDeclFlg, String errCsrNo, String ifFlg, String ifDt, String ifErrRsn, String ppayAplyFlg, String tjOfcCd, String actXchRt, String impErrFlg, String rcvErrFlg, String taxCurrXchFlg, String usrEml, String impErrRsn, String rcvErrRsn, String ftuUseCtnt1, String ftuUseCtnt2, String ftuUseCtnt3, String ftuUseCtnt4, String ftuUseCtnt5, String creDt, String creUsrId, String eaiEvntDt, String aftActFlg, String estmErrRsn, String cxlDt, String urgPayFlg, String acctXchRtYrmon, String csrUsdAmt, String mgmtUrgCfmFlg, String mgmtUrgCfmDt) {
		...
		this.mgmtUrgCfmFlg = mgmtUrgCfmFlg;
		this.mgmtUrgCfmDt = mgmtUrgCfmDt;			
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mgmt_urg_cfm_flg", getMgmtUrgCfmFlg());
		this.hashColumns.put("mgmt_urg_cfm_dt", getMgmtUrgCfmDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mgmt_urg_cfm_flg", "mgmtUrgCfmFlg");
		this.hashFields.put("mgmt_urg_cfm_dt", "mgmtUrgCfmDt");		
	...
	/**
	 * Column Info
	 * @return mgmtUrgCfmFlg
	 */
	public String getMgmtUrgCfmFlg() {
		return this.mgmtUrgCfmFlg;
	}
	 ...
	 * @return mgmtUrgCfmDt
	 */
	public String getMgmtUrgCfmDt() {
		return this.mgmtUrgCfmDt;
	}
	 ...
	 * @param mgmtUrgCfmFlg
	 */
	public void setMgmtUrgCfmFlg(String mgmtUrgCfmFlg) {
		this.mgmtUrgCfmFlg = mgmtUrgCfmFlg;
	}
	 ...
	 * @param mgmtUrgCfmDt
	 */
	public void setMgmtUrgCfmDt(String mgmtUrgCfmDt) {
		this.mgmtUrgCfmDt = mgmtUrgCfmDt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCxlDt(JSPUtil.getParameter(request, "cxl_dt", ""));
		...
		setUrgPayFlg(JSPUtil.getParameter(request, "urg_pay_flg", ""));
		setAcctXchRtYrmon(JSPUtil.getParameter(request, "acct_xch_rt_yrmon", ""));
		setCsrUsdAmt(JSPUtil.getParameter(request, "csr_usd_amt", ""));
		setMgmtUrgCfmFlg(JSPUtil.getParameter(request, "mgmt_urg_cfm_flg", ""));
		setMgmtUrgCfmDt(JSPUtil.getParameter(request, "mgmt_urg_cfm_dt", ""));		
	 ...
	 * @param request
	 * @return CustomSlipApprovalHeaderVO[]
	 */
	public CustomSlipApprovalHeaderVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomSlipApprovalHeaderVO[]
	 */
	public CustomSlipApprovalHeaderVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomSlipApprovalHeaderVO model = null;
		...
		try {
			...
			String[] urgPayFlg = (JSPUtil.getParameter(request, prefix	+ "urg_pay_flg", length));
			...
			String[] mgmtUrgCfmFlg = (JSPUtil.getParameter(request, prefix	+ "mgmt_urg_cfm_flg", length));
			String[] mgmtUrgCfmDt = (JSPUtil.getParameter(request, prefix	+ "mgmt_urg_cfm_dt", length));			
			
			for (int i = 0; i < length; i++) {
				model = new CustomSlipApprovalHeaderVO();
				if (impErrFlg[i] != null)
				...
				if (mgmtUrgCfmFlg[i] != null)
					model.setMgmtUrgCfmFlg(mgmtUrgCfmFlg[i]);
				if (mgmtUrgCfmDt[i] != null)
					model.setMgmtUrgCfmDt(mgmtUrgCfmDt[i]);
		...
		return getCustomSlipApprovalHeaderVOs();
	}
	 ...
	 * @return CustomSlipApprovalHeaderVO[]
	 */
	public CustomSlipApprovalHeaderVO[] getCustomSlipApprovalHeaderVOs(){
		CustomSlipApprovalHeaderVO[] vos = (CustomSlipApprovalHeaderVO[])models.toArray(new CustomSlipApprovalHeaderVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.mgmtUrgCfmFlg = this.mgmtUrgCfmFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.mgmtUrgCfmDt = this.mgmtUrgCfmDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
