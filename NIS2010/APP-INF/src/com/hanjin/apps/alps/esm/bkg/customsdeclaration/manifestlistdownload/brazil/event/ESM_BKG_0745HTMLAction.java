...
*@FileName : ESM_BKG_0745HTMLAction.java
...
public class ESM_BKG_0745HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0745HTMLAction 객체를 생성
	 */
	public ESM_BKG_0745HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0745Event event = new EsmBkg0745Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBrHsCdCondVO((BrHsCdCondVO)getVO(request, BrHsCdCondVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setBrHsCdDetailVOs((BrHsCdDetailVO[])getVOs(request, BrHsCdDetailVO.class));
		} 
