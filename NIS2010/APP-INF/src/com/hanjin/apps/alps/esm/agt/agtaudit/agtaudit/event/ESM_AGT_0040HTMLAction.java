...
*@FileName : ESM_AGT_0040HTMLAction.java
...
public class ESM_AGT_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0040HTMLAction 객체를 생성
	 */
	public ESM_AGT_0040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0040Event event = new EsmAgt0040Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setAgtCommBkgInfoVO((AgtCommBkgInfoVO)getVO(request, AgtCommBkgInfoVO .class));
		}

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setAgtRptItmInfoDtlVO((AgtRptItmInfoDtlVO)getVO(request, AgtRptItmInfoDtlVO .class));
		}
