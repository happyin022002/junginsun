...
*@FileName : KorManifestListDBDAOAddCntrListKorCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOAddCntrListKorCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * B/L List check후 조회된 CNTR count(=searchBKGCNTRList) 만큼 Insert된다.
	  * </pre>
	  */
	public KorManifestListDBDAOAddCntrListKorCSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOAddCntrListKorCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
