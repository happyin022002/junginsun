...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkRoutDtlForCopyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkRoutDtlForCopyDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkRoutDtlForCopyDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkRoutDtlForCopyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PRI_SCQ_AWK_ROUT_DTL        " ).append("\n"); 
