 ...
 *@FileName : ESM_PRI_2090HTMLAction.java
...
public class ESM_PRI_2090HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2090Event event = new EsmPri2090Event();
