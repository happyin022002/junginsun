...
*@FileName : MailContentsParamVO.java
*@FileTitle : MailContentsParamVO
*Open Issues :
*Change history :
...
public class MailContentsParamVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MailContentsParamVO> models = new ArrayList<MailContentsParamVO>();
	...
	public MailContentsParamVO() {}

	public MailContentsParamVO(String ibflag, String pagerows, String vvd, String polCd, String blNo, String polNm, String vslEngNm, String callSgnNo, String podCd, String podNm) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.podNm = podNm;
		this.polCd = polCd;
...
/**
	 ...
	 * @param request
	 * @return MailContentsParamVO[]
	 */
	public MailContentsParamVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MailContentsParamVO[]
	 */
	public MailContentsParamVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MailContentsParamVO model = null;
		...
		return getMailContentsParamVOs();
	}
	 ...
	 * @return MailContentsParamVO[]
	 */
	public MailContentsParamVO[] getMailContentsParamVOs(){
		MailContentsParamVO[] vos = (MailContentsParamVO[])models.toArray(new MailContentsParamVO[models.size()]);
		return vos;
	}
