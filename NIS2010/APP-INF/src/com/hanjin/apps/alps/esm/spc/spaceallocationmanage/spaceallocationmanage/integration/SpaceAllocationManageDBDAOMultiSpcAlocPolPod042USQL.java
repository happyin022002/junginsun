...
public class SpaceAllocationManageDBDAOMultiSpcAlocPolPod042USQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                     DECODE(SUB_OFC_CNT, 0, ASGN_20FT_DRY_QTY , A.BKG_AVAL_20FT_DRY_QTY)," ).append("\n"); 
		query.append("                     DECODE(SUB_OFC_CNT, 0, ASGN_40FT_DRY_QTY , A.BKG_AVAL_40FT_DRY_QTY)," ).append("\n"); 
		query.append("                     DECODE(SUB_OFC_CNT, 0, ASGN_RD_QTY , A.BKG_AVAL_RD_QTY)," ).append("\n"); 
		...
		query.append("                     DECODE(@[del_cd], 'OTHERS', 'XXXXX', @[del_cd]) AS DEST_LOC_CD," ).append("\n"); 
		...
		query.append("                               @[asgn_d2_qty]      AS ASGN_20FT_DRY_QTY," ).append("\n"); 
		query.append("                               @[asgn_d4_qty]      AS ASGN_40FT_DRY_QTY," ).append("\n"); 
		query.append("                               @[asgn_rd_qty]      AS ASGN_RD_QTY" ).append("\n"); 
