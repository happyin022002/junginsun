...
*@FileName : CustomOffInvDtlVO.java
*@FileTitle : CustomOffInvDtlVO
*Open Issues :
*Change history :
...
public class CustomOffInvDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomOffInvDtlVO> models = new ArrayList<CustomOffInvDtlVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vnor_itm_val2", getVnorItmVal2());		
	...
	public CustomOffInvDtlVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CustomOffInvDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomOffInvDtlVO model = null;
		...
		return getCustomOffInvDtlVOs();
	}

	public CustomOffInvDtlVO[] getCustomOffInvDtlVOs(){
		CustomOffInvDtlVO[] vos = (CustomOffInvDtlVO[])models.toArray(new CustomOffInvDtlVO[models.size()]);
		return vos;
	}
