...
*@FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod044DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOMultiSpcAlocPolPod044DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOMultiSpcAlocPolPod044DSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod044DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND DEST_LOC_CD  = SUBSTR('00000', 1, LENGTH(DEST_LOC_CD))" ).append("\n"); 
