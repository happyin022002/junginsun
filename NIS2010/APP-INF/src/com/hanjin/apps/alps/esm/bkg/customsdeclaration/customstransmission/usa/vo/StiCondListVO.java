...
*@FileName : StiCondListVO.java
*@FileTitle : StiCondListVO
*Open Issues :
*Change history :
...
public class StiCondListVO extends StowageManifestCondVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<StiCondListVO> models = new ArrayList<StiCondListVO>();
	...
	public StiCondListVO() {}

	public StiCondListVO(String ibflag, String pagerows, String vvd, String allerror, String lastpol, String pol, String pod, String cntropr, String excludeca, String pageno, String tmp1, String tmp2, String tmp3, String tmp4, String tmp5) {
	 ...
	 * @param request
	 * @return StiCondListVO[]
	 */
	public StiCondListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StiCondListVO[]
	 */
	public StiCondListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StiCondListVO model = null;
	 ...
	 * @return StiCondListVO[]
	 */
	public StiCondListVO[] getStiCondListVOs(){
		StiCondListVO[] vos = (StiCondListVO[])models.toArray(new StiCondListVO[models.size()]);
		return vos;
	}
