...
*@FileName : Kor24ManifestListDBDAOsearchBondAreaCdRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOsearchBondAreaCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOsearchBondAreaCdRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOsearchBondAreaCdRSQL").append("\n");
		query.append("*/").append("\n");
	}
