...
*@FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOAddCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOAddCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOAddCopyCSQL(){
		setQuery();
		...
		query.append("FileName : MqcRangeCMPBGuidelineDBDAOPriCmpbGlineMqcRngVOAddCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_CMPB_GLINE_MQC_RNG (" ).append("\n"); 
