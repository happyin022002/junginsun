...
*@FileName : Eur24CustomsTransmissionDBDAOAddSendLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24CustomsTransmissionDBDAOAddSendLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Eur24CustomsTransmissionDBDAOAddSendLogCSQL
	  * </pre>
	  */
	public Eur24CustomsTransmissionDBDAOAddSendLogCSQL(){
		setQuery();
		...
		query.append("FileName : Eur24CustomsTransmissionDBDAOAddSendLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO  BKG_CSTMS_ADV_EUR_SND" ).append("\n"); 
		...
		query.append("   CRE_USR_ID,             CRE_DT,        UPD_USR_ID,    UPD_DT,        SND_USR_OFC_CD,   CSTMS_ESTM_ARR_DT" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("   @[vsl_cd],              @[skd_voy_no], @[skd_dir_cd], @[bl_no],      @[cstms_port_cd], @[edi_snd_msg_ctnt]," ).append("\n"); 
		query.append("   @[cre_usr_id],          SYSDATE,       @[cre_usr_id], SYSDATE,       @[snd_ofc_cd],    TO_DATE(substr(@[unload_loc_eta], 1, 16), 'yyyymmddhh24miss')" ).append("\n"); 
		query.append(")" ).append("\n"); 
