...
*@FileName : RFARateQuotationDBDAOPriRqScgAdjVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqScgAdjVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqScgAdjVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqScgAdjVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
