 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0470HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0470HTMLAction 객체를 생성 
	 */
	public ESM_BKG_0470HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0470Event event = new EsmBkg0470Event();
    	VesselArrivalCondVO vesselArrivalCondVO = new VesselArrivalCondVO();
    	VesselArrivalVO vesselArrivalVO = new VesselArrivalVO();
    	VesselArrivalTransmitVO vesselArrivalTransmitVO = new VesselArrivalTransmitVO();
    	if(command.isCommand(FormCommand.SEARCH)) {
    		vesselArrivalCondVO = (JapanVesselArrivalCondVO)getVO(request, JapanVesselArrivalCondVO.class);
			event.setJapanVesselArrivalCondVO((JapanVesselArrivalCondVO)vesselArrivalCondVO);
		} else if(command.isCommand(FormCommand.MULTI)) { 
			vesselArrivalVO = (JapanVesselArrivalVO)getVO(request, JapanVesselArrivalVO.class);
			event.setJapanVesselArrivalVO((JapanVesselArrivalVO)vesselArrivalVO);
		} else if(command.isCommand(FormCommand.MULTI01)) { 
			vesselArrivalTransmitVO = (JapanVesselArrivalTransmitVO)getVO(request, JapanVesselArrivalTransmitVO.class);
			event.setJapanVesselArrivalTransmitVO((JapanVesselArrivalTransmitVO)vesselArrivalTransmitVO);
		} 
