...
*@FileName : RocsSearchRocsReceiveLogVO.java
*@FileTitle : RocsSearchRocsReceiveLogVO
*Open Issues :
*Change history :
...
public class RocsSearchRocsReceiveLogVO extends ReceiveLogVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchRocsReceiveLogVO> models = new ArrayList<RocsSearchRocsReceiveLogVO>();
	...
	public RocsSearchRocsReceiveLogVO() {}

	public RocsSearchRocsReceiveLogVO(String ibflag, String pagerows, String msgSeq, String ediSndMsg) {
		this.ibflag = ibflag;
		this.msgSeq = msgSeq;
	 ...
	 * @param request
	 * @return RocsSearchRocsReceiveLogVO[]
	 */
	public RocsSearchRocsReceiveLogVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchRocsReceiveLogVO[]
	 */
	public RocsSearchRocsReceiveLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchRocsReceiveLogVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RocsSearchRocsReceiveLogVO();
				if (ibflag[i] != null)
		...
		return getRocsSearchRocsReceiveLogVOs();
	}
	 ...
	 * @return RocsSearchRocsReceiveLogVO[]
	 */
	public RocsSearchRocsReceiveLogVO[] getRocsSearchRocsReceiveLogVOs(){
		RocsSearchRocsReceiveLogVO[] vos = (RocsSearchRocsReceiveLogVO[])models.toArray(new RocsSearchRocsReceiveLogVO[models.size()]);
		return vos;
	}
