...
*@FileName : MultiCoaMonVvdVO.java
*@FileTitle : MultiCoaMonVvdVO
*Open Issues :
*Change history :
...
public class MultiCoaMonVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MultiCoaMonVvdVO> models = new ArrayList<MultiCoaMonVvdVO>();
...
/**
	 ...
	 * @param request
	 * @return MultiCoaMonVvdVO[]
	 */
	public MultiCoaMonVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MultiCoaMonVvdVO[]
	 */
	public MultiCoaMonVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MultiCoaMonVvdVO model = null;
	...
	public MultiCoaMonVvdVO[] getMultiCoaMonVvdVOs(){
		MultiCoaMonVvdVO[] vos = (MultiCoaMonVvdVO[])models.toArray(new MultiCoaMonVvdVO[models.size()]);
		return vos;
	}
