...
/**
 * ESM_COA_0173 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_COA_0173HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Choi In Kyung
 * @see ESM_COA_0173HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmCoa0173Event extends EventSupport {
	...
	/** Constructor */
	public EsmCoa0173Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmCoa0173Event";
	}
