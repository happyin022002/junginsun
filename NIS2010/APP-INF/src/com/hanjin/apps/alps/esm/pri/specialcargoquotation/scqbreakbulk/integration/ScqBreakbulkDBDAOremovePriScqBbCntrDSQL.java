...
*@FileName : ScqBreakbulkDBDAOremovePriScqBbCntrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqBreakbulkDBDAOremovePriScqBbCntrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScqBreakbulkDBDAOremovePriScqBbCntrDSQL(){
		setQuery();
		...
		query.append("FileName : ScqBreakbulkDBDAOremovePriScqBbCntrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
