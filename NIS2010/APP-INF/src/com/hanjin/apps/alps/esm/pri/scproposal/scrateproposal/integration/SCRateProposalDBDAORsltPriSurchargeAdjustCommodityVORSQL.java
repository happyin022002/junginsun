...
*@FileName : SCRateProposalDBDAORsltPriSurchargeAdjustCommodityVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltPriSurchargeAdjustCommodityVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltPriSurchargeAdjustCommodityVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltPriSurchargeAdjustCommodityVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM pri_sp_scp_rt_cmdt rt_cmdt" ).append("\n"); 
		...
		query.append(", pri_sp_scp_grp_cmdt grp_cmdt" ).append("\n"); 
