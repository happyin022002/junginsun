...
public class BLIssuanceDBDAOsearchMultiNtcHisRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DECODE(SND.FAX_PROC_STS_CD,1,2,2,2,3,2,4,2,5,3,6,4,1)," ).append("\n"); 
		...
		query.append("AND    @[ntc_knd_cd] = HIS.NTC_KND_CD(+)  /*KIND(BL : Draft B/L(Outbound), ID : Draft B/L(Inbound), WB : Waybill, BK : BookingReceiptNotice, SS : Simple S/I */" ).append("\n"); 
