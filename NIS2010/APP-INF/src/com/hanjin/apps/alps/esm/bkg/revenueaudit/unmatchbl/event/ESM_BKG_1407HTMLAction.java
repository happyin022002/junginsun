...
*@FileName : ESM_BKG_1407HTMLAction.java
...
public class ESM_BKG_1407HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1407HTMLAction 객체를 생성
	 */
	public ESM_BKG_1407HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1407Event event = new EsmBkg1407Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScNoteConversionVO((ScNoteConversionVO)getVO(request, ScNoteConversionVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI01)) {
			event.setScNoteConversionVOS((ScNoteConversionVO[])getVOs(request, ScNoteConversionVO.class, ""));
		}
