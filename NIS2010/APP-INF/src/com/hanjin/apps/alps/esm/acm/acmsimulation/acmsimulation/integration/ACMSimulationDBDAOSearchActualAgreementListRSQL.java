...
*@FileName : ACMSimulationDBDAOSearchActualAgreementListRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOSearchActualAgreementListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOSearchActualAgreementListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOSearchActualAgreementListRSQL").append("\n");
		query.append("*/").append("\n");
	}
