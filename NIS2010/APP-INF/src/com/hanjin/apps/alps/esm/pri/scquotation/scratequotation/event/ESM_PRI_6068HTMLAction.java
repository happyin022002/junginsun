...
public class ESM_PRI_6068HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6068HTMLAction 객체를 생성
	 */
	public ESM_PRI_6068HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6068Event event = new EsmPri6068Event();

		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriSqRtScgVOS((PriSqRtScgVO[])getVOs(request, PriSqRtScgVO .class,""));
		}
