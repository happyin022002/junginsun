...
*@FileName : AgencyCommissionDBDAOCoaOtrCommVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgencyCommissionDBDAOCoaOtrCommVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgencyCommissionDBDAOCoaOtrCommVOUSQL(){
		setQuery();
		...
		query.append("FileName : AgencyCommissionDBDAOCoaOtrCommVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_OTR_COMM" ).append("\n"); 
