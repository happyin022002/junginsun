...
*@FileName : ESM_COA_0048HTMLAction.java
...
public class ESM_COA_0048HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0048HTMLAction 객체를 생성
	 */
	public ESM_COA_0048HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmCoa0048Event event = new EsmCoa0048Event();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setCoaInterPrcUtCostVOs((CoaInterPrcUtCostVO[])getVOs(request, CoaInterPrcUtCostVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setCoaInterPrcUtCostVO((CoaInterPrcUtCostVO)getVO(request, CoaInterPrcUtCostVO .class));
