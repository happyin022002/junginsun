...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntAmendVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplCtntAmendVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * delete amend 후 detail update
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplCtntAmendVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplCtntAmendVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
