...
*@FileName : AGNCommRequestDBDAOAddAcmAgnCommChgFromAutoRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommRequestDBDAOAddAcmAgnCommChgFromAutoRtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Surcharge 공제 금액 계산. Booking Auto Rating 사용
	  * </pre>
	  */
	public AGNCommRequestDBDAOAddAcmAgnCommChgFromAutoRtCSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommRequestDBDAOAddAcmAgnCommChgFromAutoRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            FROM ACM_AGN_COMM_CHG_REF R," ).append("\n"); 
		query.append("              ACM_AGN_AGMT_DTL D," ).append("\n"); 
