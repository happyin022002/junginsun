...
*@FileName : ESM_FMS_0042HTMLAction.java
...
public class ESM_FMS_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0042HTMLAction 객체를 생성
	 */
	public ESM_FMS_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0042Event event = new EsmFms0042Event();

 		if(command.isCommand(FormCommand.SEARCH)) {
 			event.setCsrNo(request.getParameter("csr_no"));
 			
 			if(request.getParameter("slp_no") != null) {
