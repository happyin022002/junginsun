...
*@FileName : SCGroupLocationProposalDBDAOPriSpScpGrpLocGlineCpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAOPriSpScpGrpLocGlineCpVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAOPriSpScpGrpLocGlineCpVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAOPriSpScpGrpLocGlineCpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("pri_sg_grp_loc loc" ).append("\n"); 
		query.append("" ).append("\n"); 
