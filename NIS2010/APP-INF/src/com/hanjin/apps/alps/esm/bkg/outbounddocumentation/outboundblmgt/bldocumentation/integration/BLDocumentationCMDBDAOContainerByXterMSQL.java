...
*@FileName : BLDocumentationCMDBDAOContainerByXterMSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationCMDBDAOContainerByXterMSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLDocumentationCMDBDAOContainerByXterMSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationCMDBDAOContainerByXterMSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO BKG_CONTAINER" ).append("\n"); 
		query.append("USING dual ON (BKG_NO = @[bkg_no] AND CNTR_NO = @[cntr_no])" ).append("\n"); 
		query.append("WHEN MATCHED THEN" ).append("\n"); 
		query.append("UPDATE SET" ).append("\n"); 
		query.append("CNTR_TPSZ_CD     = @[cntr_tpsz_cd]" ).append("\n"); 
		query.append(",    CNMV_STS_CD      = @[cnmv_sts_cd]" ).append("\n"); 
		query.append(",    CNTR_DP_SEQ      = @[seq]" ).append("\n"); 
		...
		query.append(",    CNTR_PRT_FLG     = DECODE(@[cntr_prt_flg], '1', 'Y', '0', 'N', @[cntr_prt_flg])" ).append("\n"); 
		...
		query.append(",    CNTR_TAX_EXPT_FLG" ).append("\n"); 
		...
		query.append(",    ''" ).append("\n"); 
		query.append(",    ''" ).append("\n"); 
		query.append(",    DECODE(@[cntr_prt_flg], '1', 'Y', '0', 'N', @[cntr_prt_flg])" ).append("\n"); 
		query.append(",    ''" ).append("\n"); 
		query.append(",    @[cntr_vol_qty]" ).append("\n"); 
		query.append(",    @[adv_shtg_cd]" ).append("\n"); 
		...
		query.append(",    DECODE(@[rd_cgo_flg], '1', 'Y', 'N')" ).append("\n"); 
		query.append(",    DECODE(@[hngr_flg], '1', 'Y', 'N')" ).append("\n"); 
		query.append(",    DECODE(@[soc_flg], '1', 'Y', 'N')" ).append("\n"); 
		query.append(",    'N'" ).append("\n"); 
		query.append(",    @[eq_subst_tpsz_cd]" ).append("\n"); 
		...
		query.append(",    ''" ).append("\n"); 
		query.append(",    @[diff_rmk]" ).append("\n"); 
		query.append(",    DECODE(@[cntr_cfm_flg], '1', 'Y', 'N')" ).append("\n"); 
		query.append(",    ''" ).append("\n"); 
		query.append(",    'N'" ).append("\n"); 
		query.append(",    'N'" ).append("\n"); 
		query.append(",    @[cre_usr_id]" ).append("\n"); 
