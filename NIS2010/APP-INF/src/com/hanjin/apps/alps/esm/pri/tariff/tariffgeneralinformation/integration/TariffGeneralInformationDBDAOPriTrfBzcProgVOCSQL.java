...
*@FileName : TariffGeneralInformationDBDAOPriTrfBzcProgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffGeneralInformationDBDAOPriTrfBzcProgVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff Basic Progress 정보를 Insert 한다.
	  * </pre>
	  */
	public TariffGeneralInformationDBDAOPriTrfBzcProgVOCSQL(){
		setQuery();
		...
		query.append("FileName : TariffGeneralInformationDBDAOPriTrfBzcProgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_TRF_BZC_PROG" ).append("\n"); 
		query.append("    (" ).append("\n"); 
		query.append("    TRF_PFX_CD" ).append("\n"); 
		query.append("   ,TRF_NO" ).append("\n"); 
		query.append("   ,AMDT_SEQ" ).append("\n"); 
		query.append("   ,TRF_BZC_PROG_SEQ" ).append("\n"); 
		...
		query.append("       ,@[trf_no]" ).append("\n"); 
		query.append("       ,@[amdt_seq]" ).append("\n"); 
		query.append("       ,NVL(MAX(TRF_BZC_PROG_SEQ)+1, 1)" ).append("\n"); 
		query.append("       ,@[trf_bzc_sts_cd]" ).append("\n"); 
		query.append("       ,@[prog_usr_id]" ).append("\n"); 
		query.append("       ,@[prog_ofc_cd]" ).append("\n"); 
		...
		query.append("       ,@[upd_usr_id]" ).append("\n"); 
		query.append("       ,SYSDATE" ).append("\n"); 
		query.append("  FROM  PRI_TRF_BZC_PROG" ).append("\n"); 
