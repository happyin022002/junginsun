...
*@FileName : UnmatchBLDBDAOCheckRfaApplicationDateDiscrepancyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UnmatchBLDBDAOCheckRfaApplicationDateDiscrepancyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UnmatchBLDBDAOCheckRfaApplicationDateDiscrepancyRSQL
	  * 
	  ...
	  * </pre>
	  */
	public UnmatchBLDBDAOCheckRfaApplicationDateDiscrepancyRSQL(){
		setQuery();
		...
		query.append("FileName : UnmatchBLDBDAOCheckRfaApplicationDateDiscrepancyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("*******************************************************************************************/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT  BK.RFA_NO      ," ).append("\n"); 
		...
		query.append("        (" ).append("\n"); 
		query.append("        /* RFA Duration */" ).append("\n"); 
		query.append("        SELECT  SD.CTRT_EFF_DT    ," ).append("\n"); 
		query.append("                SD.CTRT_EXP_DT" ).append("\n"); 
		query.append("        FROM    RF  ," ).append("\n"); 
		query.append("                PRI_RP_SCP_DUR  SD" ).append("\n"); 
		query.append("        WHERE   SD.PROP_NO      = RF.PROP_NO" ).append("\n"); 
		query.append("        AND     SD.AMDT_SEQ     = RF.AMDT_SEQ" ).append("\n"); 
		query.append("        AND     SD.SVC_SCP_CD   = RF.SVC_SCP_CD" ).append("\n"); 
		...
		query.append("        AND     SD.PROP_NO      = RH.PROP_NO" ).append("\n"); 
		query.append("        AND     SD.SVC_SCP_CD   = BK.SVC_SCP_CD" ).append("\n"); 
		query.append("        ) SD" ).append("\n"); 
		query.append("WHERE   NOT EXISTS  ( SELECT 'X' FROM RF )" ).append("\n"); 
		...
		query.append("          THEN  'Y'" ).append("\n"); 
		query.append("        WHEN      BK.REV_APLY_TP_CD <> 'C'" ).append("\n"); 
		query.append("              AND BK.RT_APLY_DT = NVL(BK.POL_ETD_DT, BK.RT_APLY_DT)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("          THEN  'Y'" ).append("\n"); 
		query.append("        ELSE  'N'" ).append("\n"); 
		query.append("        END" ).append("\n"); 
