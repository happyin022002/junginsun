...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esm.acm.acmrequest;

import java.util.List;

import com.hanjin.apps.alps.esm.acm.acmrequest.agncommrequest.basic.AGNCommRequestBC;
import com.hanjin.apps.alps.esm.acm.acmrequest.agncommrequest.basic.AGNCommRequestBCImpl;
import com.hanjin.apps.alps.esm.acm.acmrequest.agncommrequest.event.EsmAcm0006Event;
import com.hanjin.apps.alps.esm.acm.acmrequest.agncommrequest.event.EsmAcm0105Event;
...
import com.hanjin.apps.alps.esm.acm.acmrequest.batmanagement.basic.BATManagementBC;
import com.hanjin.apps.alps.esm.acm.acmrequest.batmanagement.basic.BATManagementBCImpl;
import com.hanjin.apps.alps.esm.acm.acmrequest.batmanagement.event.EsmAcm0032Event;
import com.hanjin.apps.alps.esm.acm.acmrequest.batmanagement.vo.BATManagementVO;
import com.hanjin.apps.alps.esm.acm.acmrequest.otrcommrequest.basic.OTRCommRequestBC;
import com.hanjin.apps.alps.esm.acm.acmrequest.otrcommrequest.basic.OTRCommRequestBCImpl;
import com.hanjin.apps.alps.esm.acm.acmrequest.otrcommrequest.event.EsmAcm0014Event;
...
public class ACMRequestSC extends ServiceCommandSupport {
	...
	private EventResponse requestAGNCommRequest(Event e) throws EventException {
		...
		try{
			begin();
			command.requestAGNCommRequest(event.getAGNCommRequestVOs(), account, event.getAGNCommRequestVO().getAcTpCd());
...
//	}
	...
	private EventResponse searchCalcDtlBkgRevenue(Event e) throws EventException {
		...
		try{
			...
			List<CalcDtlBkgRevenueVO> list9 = command.searchCalcDtlChargeComm(event.getCalcDtlBkgRevenueVO());		// 2017.08.25 Charge Commission 추가
			eventResponse.setRsVoList(list9);
			List<CalcDtlBkgRevenueVO> list10 = command.searchCalcDtlTrsCstAcmDeduction(event.getCalcDtlBkgRevenueVO());
