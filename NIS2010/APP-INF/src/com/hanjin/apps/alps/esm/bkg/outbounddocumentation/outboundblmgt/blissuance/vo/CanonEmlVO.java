...
*@FileName : CanonEmlVO.java
*@FileTitle : CanonEmlVO
*Open Issues :
*Change history :
...
public class CanonEmlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CanonEmlVO> models = new ArrayList<CanonEmlVO>();
	...
	public CanonEmlVO(String ibflag, String pagerows, String bkgNo, String atdDt, String coNm, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String creUsrId, String updUsrId) {
		this.vslCd = vslCd;
	 ...
	 * @return CanonEmlVO[]
	 */
	public CanonEmlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CanonEmlVO[]
	 */
	public CanonEmlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CanonEmlVO model = null;
	 ...
	 * @return CanonEmlVO[]
	 */
	public CanonEmlVO[] getCanonEmlVOs(){
		CanonEmlVO[] vos = (CanonEmlVO[])models.toArray(new CanonEmlVO[models.size()]);
		return vos;
	}
