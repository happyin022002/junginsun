...
public class Eur24CustomsTransmissionDBDAOsearchDiversionRequestRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                " ).append("\n"); 
		query.append("             ELSE " ).append("\n"); 
		query.append("                DECODE(VSL.CRR_CD, 'UAC', TO_CHAR(ACT.INIT_ETA_DT, 'YYYYMMDD')||'120000', 'HPL', TO_CHAR(ACT.INIT_ETA_DT, 'YYYYMMDD')||'120000', 'MSK', TO_CHAR(ACT.INIT_ETA_DT, 'YYYYMMDD')||'120000', 'EGL', TO_CHAR(ACT.INIT_ETA_DT, 'YYYYMMDD')||'120000', TO_CHAR(ACT.INIT_ETA_DT, 'YYYYMMDDHH24')||'0000')" ).append("\n"); 
		query.append("        END" ).append("\n"); 
		...
		query.append("  'CA' PT_TYPE," ).append("\n"); 
		query.append("  '' PT_TIN," ).append("\n"); 
		query.append("  'BEKO000001' PT_EORI," ).append("\n"); 
		query.append("  'SM Line Corporation, Seoul' PT_NAME," ).append("\n"); 
		query.append("  'SM LINE CORPORATION, 25 GUKJEGEUMYUNG-RO 2-GIL, YEONGDEUNGPO-GU, SEOUL, KOREA' PT_ADDRESS," ).append("\n"); 
		query.append("  '' PT_STREET," ).append("\n"); 
		query.append("  'SEOUL' PT_CITY," ).append("\n"); 
		query.append("  '' PT_POSTAL_CD," ).append("\n"); 
		query.append("  'KR' PT_CNT_CD," ).append("\n"); 
		...
		query.append("  AND ACT.CLPT_IND_SEQ = NVL(@[cstms_port_clpt_ind_seq], '1')" ).append("\n"); 
