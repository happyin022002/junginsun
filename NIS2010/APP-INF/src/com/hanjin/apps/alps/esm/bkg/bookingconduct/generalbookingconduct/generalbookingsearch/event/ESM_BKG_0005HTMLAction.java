...
*@FileName : ESM_BKG_0005HTMLAction.java
...
public class ESM_BKG_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0005HTMLAction 객체를 생성
	 */
	public ESM_BKG_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0005Event event = new EsmBkg0005Event();

	   if(command.isCommand(FormCommand.SEARCH)) {
		   event.setBkgCustAvcNtcSndHisSchVO((BkgCustAvcNtcSndHisSchVO)getVO(request, BkgCustAvcNtcSndHisSchVO .class));
