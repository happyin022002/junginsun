...
*@FileName : USDomesticDBDAOModifyDomSavUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USDomesticDBDAOModifyDomSavUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public USDomesticDBDAOModifyDomSavUSQL(){
		setQuery();
		...
		query.append("FileName : USDomesticDBDAOModifyDomSavUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET USA_DMST_SAV_UT_AMT = REPLACE(@[usa_dmst_sav_ut_amt], ',', '')" ).append("\n"); 
