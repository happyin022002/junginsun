...
*@FileName : ConfirmHldNtcSendListVO.java
*@FileTitle : ConfirmHldNtcSendListVO
*Open Issues :
*Change history :
...
public class ConfirmHldNtcSendListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ConfirmHldNtcSendListVO> models = new ArrayList<ConfirmHldNtcSendListVO>();
	...
	/* Column Info */
	private String n3ptyBilNoYn = null;
	/* Column Info */
	...
	public ConfirmHldNtcSendListVO(String ibflag, String pagerows, String bkgNo, String ntcSeq, String hldNtcTpCd, String cstmsHldNtcFomCd, String cstmsHldLocCd, String custCntCd, String custSeq, String custCd, String custNm, String cstmsPreHldCd, String preHldDt, String cstmsCfmHldCd, String cfmHldDt, String n3ptyBilNoYn, String hldEclzOblFlg, String hldDiffRmk, String blNo, String vvd, String podCd, String delCd, String ofcCd, String custCntcTpCd, String faxNo, String ntcEml, String ntcWdYn, String hldFaxSndDt, String hldEmlSndDt, String hldSndDt, String hldFaxSndRsltNm, String hldEmlSndRsltNm, String hldFaxSndRslt, String hldEmlSndRslt) {
		...
		this.ntcEml = ntcEml;
		this.ibflag = ibflag;
		this.n3ptyBilNoYn = n3ptyBilNoYn;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("n3pty_bil_no_yn", getN3ptyBilNoYn());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("n3pty_bil_no_yn", "n3ptyBilNoYn");
	 ...
	 * @return n3ptyBilNoYn
	 */
	public String getN3ptyBilNoYn() {
		return this.n3ptyBilNoYn;
	}
	 ...
	 * @param n3ptyBilNoYn
	 */
	public void setN3ptyBilNoYn(String n3ptyBilNoYn) {
		this.n3ptyBilNoYn = n3ptyBilNoYn;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCfmHldDt(JSPUtil.getParameter(request, "cfm_hld_dt", ""));
		...
		setCstmsCfmHldCd(JSPUtil.getParameter(request, "cstms_cfm_hld_cd", ""));
		...
		setN3ptyBilNoYn(JSPUtil.getParameter(request, "n3pty_bil_no_yn", ""));
	 ...
	 * @param request
	 * @return ConfirmHldNtcSendListVO[]
	 */
	public ConfirmHldNtcSendListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ConfirmHldNtcSendListVO[]
	 */
	public ConfirmHldNtcSendListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ConfirmHldNtcSendListVO model = null;
		...
		try {
			...
			String[] n3ptyBilNoYn = (JSPUtil.getParameter(request, prefix	+ "n3pty_bil_no_yn", length));
			...
			for (int i = 0; i < length; i++) {
				model = new ConfirmHldNtcSendListVO();
				if (preHldDt[i] != null)
				...
				if (n3ptyBilNoYn[i] != null)
					model.setN3ptyBilNoYn(n3ptyBilNoYn[i]);
		...
		return getConfirmHldNtcSendListVOs();
	}
	...
	public ConfirmHldNtcSendListVO[] getConfirmHldNtcSendListVOs(){
		ConfirmHldNtcSendListVO[] vos = (ConfirmHldNtcSendListVO[])models.toArray(new ConfirmHldNtcSendListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.n3ptyBilNoYn = this.n3ptyBilNoYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
