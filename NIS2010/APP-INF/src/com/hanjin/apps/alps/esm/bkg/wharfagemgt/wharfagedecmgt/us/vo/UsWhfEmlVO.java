...
*@FileName : UsWhfEmlVO.java
*@FileTitle : UsWhfEmlVO
*Open Issues :
*Change history :
...
public class UsWhfEmlVO extends WhfEmlVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsWhfEmlVO> models = new ArrayList<UsWhfEmlVO>();
	...
	public UsWhfEmlVO(String ibflag, String pagerows, String portCd, String portSeq, String ydCd, String brthDesc, String bilRcvPtyNm) {
	 ...
	 * @return UsWhfEmlVO[]
	 */
	public UsWhfEmlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsWhfEmlVO[]
	 */
	public UsWhfEmlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsWhfEmlVO model = null;
	...
	public UsWhfEmlVO[] getUsWhfEmlVOs(){
		UsWhfEmlVO[] vos = (UsWhfEmlVO[])models.toArray(new UsWhfEmlVO[models.size()]);
		return vos;
	}
