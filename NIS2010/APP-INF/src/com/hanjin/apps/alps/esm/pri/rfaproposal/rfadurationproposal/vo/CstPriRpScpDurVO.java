...
*@FileName : CstPriRpScpDurVO.java
*@FileTitle : CstPriRpScpDurVO
*Open Issues :
*Change history :
...
public class CstPriRpScpDurVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstPriRpScpDurVO> models = new ArrayList<CstPriRpScpDurVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setScpSave(JSPUtil.getParameter(request, "scp_save", ""));
	 ...
	 */
	public CstPriRpScpDurVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstPriRpScpDurVO[]
	 */
	public CstPriRpScpDurVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstPriRpScpDurVO model = null;
	...
	public CstPriRpScpDurVO[] getCstPriRpScpDurVOs(){
		CstPriRpScpDurVO[] vos = (CstPriRpScpDurVO[])models.toArray(new CstPriRpScpDurVO[models.size()]);
		return vos;
	}
