...
*@FileName : CndExpManifestListDownloadDBDAOsearchBkgCustomerShprRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpManifestListDownloadDBDAOsearchBkgCustomerShprRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchBkgCustomerShpr
	  * </pre>
	  */
	public CndExpManifestListDownloadDBDAOsearchBkgCustomerShprRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpManifestListDownloadDBDAOsearchBkgCustomerShprRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE B.BKG_OFC_CD = O.OFC_CD" ).append("\n"); 
