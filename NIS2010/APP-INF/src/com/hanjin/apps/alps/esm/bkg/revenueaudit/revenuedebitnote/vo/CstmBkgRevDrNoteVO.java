...
*@FileName : CstmBkgRevDrNoteVO.java
*@FileTitle : CstmBkgRevDrNoteVO
*Open Issues :
*Change history :
...
public class CstmBkgRevDrNoteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CstmBkgRevDrNoteVO> models = new ArrayList<CstmBkgRevDrNoteVO>();
	...
	public CstmBkgRevDrNoteVO() {}

	public CstmBkgRevDrNoteVO(String ibflag, String pagerows, String rdnNo, String rvisSeq, String issOfcCd, String rctRhqCd, String rctOfcCd, String respbOfcCd, String umchTpCd, String umchSubTpCd, String rdnIssRsnCd, String rdnIssDt, String umchRmk, String rdnStsCd, String rdnStsNm, String creUsrId, String creDt, String updUsrId, String updDt, String bkgNo, String bkgCorrNo, String blNo, String scRfaNo, String stsUpdDt, String respbRhqCd, String revAudToolCd, String revAudToolNm, String blNoChk, String blNoTp, String receiverRmk, String bkgNoSplit, String progSeq, String rdnRmk, String rdnKndCd, String invNo, String vvdCd, String n3ptyNo, String atchFileLnkId) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRevAudToolNm(JSPUtil.getParameter(request, "rev_aud_tool_nm", ""));
		...
		setRdnStsNm(JSPUtil.getParameter(request, "rdn_sts_nm", ""));
		setRevAudToolCd(JSPUtil.getParameter(request, "rev_aud_tool_cd", ""));
		...
		setReceiverRmk(JSPUtil.getParameter(request, "receiver_rmk", ""));
		...
		setStsUpdDt(JSPUtil.getParameter(request, "sts_upd_dt", ""));
	 ...
	 * @param request
	 * @return CstmBkgRevDrNoteVO[]
	 */
	public CstmBkgRevDrNoteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstmBkgRevDrNoteVO[]
	 */
	public CstmBkgRevDrNoteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CstmBkgRevDrNoteVO model = null;
	 ...
	 * @return CstmBkgRevDrNoteVO[]
	 */
	public CstmBkgRevDrNoteVO[] getCstmBkgRevDrNoteVOs(){
		CstmBkgRevDrNoteVO[] vos = (CstmBkgRevDrNoteVO[])models.toArray(new CstmBkgRevDrNoteVO[models.size()]);
		return vos;
	}
