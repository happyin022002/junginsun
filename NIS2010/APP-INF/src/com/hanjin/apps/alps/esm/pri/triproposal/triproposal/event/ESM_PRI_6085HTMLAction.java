...
*@FileName : ESM_PRI_6085HTMLAction.java
...
public class ESM_PRI_6085HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6085HTMLAction 객체를 생성
	 */
	public ESM_PRI_6085HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6085Event event = new EsmPri6085Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriTriRtScgVOS((PriTriRtScgVO[])getVOs(request, PriTriRtScgVO .class,""));
		}
