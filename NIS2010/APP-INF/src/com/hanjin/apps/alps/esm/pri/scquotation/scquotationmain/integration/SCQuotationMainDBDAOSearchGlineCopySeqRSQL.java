...
*@FileName : SCQuotationMainDBDAOSearchGlineCopySeqRSQL.java
...
public class SCQuotationMainDBDAOSearchGlineCopySeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCQuotationMainDBDAOSearchGlineCopySeqRSQL(){
		setQuery();
		...
		query.append("FileName : SCQuotationMainDBDAOSearchGlineCopySeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
