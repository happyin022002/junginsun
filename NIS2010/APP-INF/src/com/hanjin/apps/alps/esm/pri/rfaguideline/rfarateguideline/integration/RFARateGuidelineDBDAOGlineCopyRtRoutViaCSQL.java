...
*@FileName : RFARateGuidelineDBDAOGlineCopyRtRoutViaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOGlineCopyRtRoutViaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOGlineCopyRtRoutViaCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOGlineCopyRtRoutViaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_RG_RT_ROUT_VIA (" ).append("\n"); 
		...
		query.append(", DENSE_RANK() OVER (PARTITION BY G.SVC_SCP_CD, G.GLINE_SEQ, G.CMDT_HDR_SEQ, G.ROUT_SEQ, F.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("ORDER BY G.SVC_SCP_CD, G.GLINE_SEQ, G.CMDT_HDR_SEQ, G.ROUT_SEQ, F.ORG_DEST_TP_CD, F.ROUT_VIA_SEQ) AS ROUT_VIA_SEQ" ).append("\n"); 
