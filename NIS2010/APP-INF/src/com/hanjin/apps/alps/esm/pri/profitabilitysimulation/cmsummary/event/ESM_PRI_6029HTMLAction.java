...
*@FileName : ESM_PRI_6029HTMLAction.java
...
public class ESM_PRI_6029HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6029HTMLAction 객체를 생성
	 */
	public ESM_PRI_6029HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6029Event event = new EsmPri6029Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltPriCMSummaryCustomerListVO((RsltPriCMSummaryCustomerListVO)getVO(request, RsltPriCMSummaryCustomerListVO .class));
