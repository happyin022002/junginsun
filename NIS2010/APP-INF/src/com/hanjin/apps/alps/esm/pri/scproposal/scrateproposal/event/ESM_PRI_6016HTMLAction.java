...
public class ESM_PRI_6016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6016HTMLAction 객체를 생성
	 */
	public ESM_PRI_6016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6016Event event = new EsmPri6016Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			RsltPriPrsCostListVO[] vos = (RsltPriPrsCostListVO[])getVOs(request, RsltPriPrsCostListVO .class);
			event.setRsltPriPrsCostListVOS(vos);	
			PriSpScpRtUsdRoutCsVO routCsVO = (PriSpScpRtUsdRoutCsVO)getVO(request, PriSpScpRtUsdRoutCsVO .class);
			event.setPriSpScpRtUsdRoutCsVO(routCsVO); 
