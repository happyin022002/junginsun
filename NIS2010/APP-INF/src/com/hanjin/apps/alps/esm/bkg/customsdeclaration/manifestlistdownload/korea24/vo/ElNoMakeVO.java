...
*@FileName : ElNoMakeVOVO.java
*@FileTitle : ElNoMakeVOVO
*Open Issues :
*Change history :
...
public class ElNoMakeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ElNoMakeVO> models = new ArrayList<ElNoMakeVO>();
	...
	public ElNoMakeVO(String ibflag, String pagerows, String bkgNo, String bkgNoSplit, String ktPort) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return ElNoMakeVOVO[]
	 */
	public ElNoMakeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ElNoMakeVOVO[]
	 */
	public ElNoMakeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ElNoMakeVO model = null;
	 ...
	 * @return ElNoMakeVOVO[]
	 */
	public ElNoMakeVO[] getElNoMakeVOVOs(){
		ElNoMakeVO[] vos = (ElNoMakeVO[])models.toArray(new ElNoMakeVO[models.size()]);
		return vos;
	}
