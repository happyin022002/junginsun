...
*@FileName : RFARateQuotationDBDAORsltPriRqRtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriRqRtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriRqRtVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriRqRtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", 	A.FIC_QTTN_RT_AMT" ).append("\n"); 
		...
		query.append(",	A.FIC_ORG_QTTN_RT_AMT	" ).append("\n"); 
		...
		query.append(",	A.FIC_DEST_QTTN_RT_AMT	" ).append("\n"); 
		...
		query.append(",	 PRI_RQ_HDR C" ).append("\n"); 
