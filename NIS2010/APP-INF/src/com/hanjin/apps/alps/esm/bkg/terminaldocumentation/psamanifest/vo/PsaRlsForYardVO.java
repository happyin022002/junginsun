...
*@FileName : PsaRlsForYardVO.java
*@FileTitle : PsaRlsForYardVO
*Open Issues :
*Change history :
...
public class PsaRlsForYardVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsaRlsForYardVO> models = new ArrayList<PsaRlsForYardVO>();
	...
	public PsaRlsForYardVO() {}

	public PsaRlsForYardVO(String ibflag, String pagerows, String psaSerNo, String subPsaSerNo, String psaIfCd, String bkgNo, String bkgSeq, String cntrTpszCd, String cntrQty, String ydCd, String usrId) {
		this.bkgNo = bkgNo;
...
/**
	 ...
	 * @param request
	 * @return PsaRlsForYardVO[]
	 */
	public PsaRlsForYardVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsaRlsForYardVO[]
	 */
	public PsaRlsForYardVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsaRlsForYardVO model = null;
	 ...
	 * @return PsaRlsForYardVO[]
	 */
	public PsaRlsForYardVO[] getPsaRlsForYardVOs(){
		PsaRlsForYardVO[] vos = (PsaRlsForYardVO[])models.toArray(new PsaRlsForYardVO[models.size()]);
		return vos;
	}
