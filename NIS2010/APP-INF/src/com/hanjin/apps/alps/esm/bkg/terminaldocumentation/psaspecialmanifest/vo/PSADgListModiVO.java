...
*@FileName : PSADgListModiVO.java
*@FileTitle : PSADgListModiVO
*Open Issues :
*Change history :
...
public class PSADgListModiVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSADgListModiVO> models = new ArrayList<PSADgListModiVO>();
...
/**
	 ...
	 */
	public PSADgListModiVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSADgListModiVO[]
	 */
	public PSADgListModiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSADgListModiVO model = null;
	...
	public PSADgListModiVO[] getPSADgListModiVOs(){
		PSADgListModiVO[] vos = (PSADgListModiVO[])models.toArray(new PSADgListModiVO[models.size()]);
		return vos;
	}
