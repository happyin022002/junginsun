...
*@FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod2ndSmpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOMultiSpcAlocPolPod2ndSmpCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOMultiSpcAlocPolPod2ndSmpCSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOMultiSpcAlocPolPod2ndSmpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    MAIN.CUST_CTRL_CD        ," ).append("\n"); 
		query.append("    " ).append("\n"); 
		...
		query.append("        D.TS_FLG,  " ).append("\n"); 
		query.append("        D.MNL_FLG ," ).append("\n"); 
		query.append("        --20140812 추가" ).append("\n"); 
		query.append("        D.USA_BKG_MOD_CD," ).append("\n"); 
		...
		query.append("    )  INFO, SPC_ALOC_CUST_POL_POD MAIN" ).append("\n"); 
		...
		query.append("        AND   INFO.CUST_CTRL_CD = MAIN.CUST_CTRL_CD" ).append("\n"); 
		query.append("        " ).append("\n"); 
