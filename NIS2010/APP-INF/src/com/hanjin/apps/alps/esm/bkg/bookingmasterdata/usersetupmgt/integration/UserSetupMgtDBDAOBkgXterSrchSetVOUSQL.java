...
*@FileName : UserSetupMgtDBDAOBkgXterSrchSetVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserSetupMgtDBDAOBkgXterSrchSetVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserSetupMgtDBDAOBkgXterSrchSetVOUSQL(){
		setQuery();
		...
		params.put("set_slct_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("xter_bkg_rqst_sts_cd",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.bookingmasterdata.usersetupmgt.integration").append("\n"); 
		query.append("FileName : UserSetupMgtDBDAOBkgXterSrchSetVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE bkg_xter_srch_set SET " ).append("\n"); 
		query.append("	set_slct_flg = decode(@[set_slct_flg],1,'Y','N')" ).append("\n"); 
		query.append(",	upd_usr_id = @[upd_usr_id]" ).append("\n"); 
		query.append(",	upd_dt = sysdate" ).append("\n"); 
		query.append(",	doc_tp_cd = @[doc_tp_cd]" ).append("\n"); 
		query.append(",	bkg_upld_sts_cd = @[bkg_upld_sts_cd]" ).append("\n"); 
		query.append(",	non_rt_sts_cd = @[non_rt_sts_cd]" ).append("\n"); 
		query.append(",	xter_bkg_rqst_sts_cd = @[xter_bkg_rqst_sts_cd]" ).append("\n"); 
		query.append(",	xter_rqst_via_cd = @[xter_rqst_via_cd]" ).append("\n"); 
		query.append(",	org_cnt_cd = @[org_cnt_cd]" ).append("\n"); 
		query.append(",	del_conti_cd = @[del_conti_cd]" ).append("\n"); 
		...
		query.append(",	cust_seq = decode(@[cust_seq], 0, null, @[cust_seq])" ).append("\n"); 
