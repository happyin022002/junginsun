...
public class GeneralBookingReceiptDBDAOSearchBlDocCustRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		, CASE WHEN SUBSTR(BK.POD_CD,1,2) = 'IN' AND SH.EORI_NO IS NULL THEN MDM_SH.IDA_GST_RGST_NO" ).append("\n"); 
		query.append("			   WHEN SUBSTR(BK.POD_CD,1,2) = 'CN' AND SH.EORI_NO IS NULL THEN MDM_SH.CO_CHN_NO" ).append("\n"); 
		query.append("               ELSE SH.EORI_NO" ).append("\n"); 
		query.append("          END  SH_EORI_NO" ).append("\n"); 
		...
		query.append("		,MDM_SH.IDA_GST_RGST_NO SH_IDA_GST_RGST_NO" ).append("\n"); 
		query.append("		, sh.CUST_PHN_NO									SH_CUST_PHN_NO" ).append("\n"); 
		query.append("		, sh.CUST_FAX_NO									SH_CUST_FAX_NO" ).append("\n"); 
		query.append("		, sh.CUST_EML										SH_CUST_EML" ).append("\n"); 
		...
		query.append("		, cn.CUST_PHN_NO									CN_CUST_PHN_NO" ).append("\n"); 
		...
		query.append("		, CN.CO_CHN_TP_CD									CN_CO_CHN_TP_CD" ).append("\n"); 
		query.append("		, CASE WHEN SUBSTR(BK.POD_CD,1,2) = 'IN' AND CN.EORI_NO IS NULL THEN MDM_CN.IDA_GST_RGST_NO" ).append("\n"); 
		query.append("			   WHEN SUBSTR(BK.POD_CD,1,2) = 'CN' AND INSTR(CN.CUST_NM, 'TO ORDER') = 0 AND CN.EORI_NO IS NULL THEN MDM_CN.CO_CHN_NO" ).append("\n"); 
		query.append("               ELSE CN.EORI_NO" ).append("\n"); 
		query.append("          END  CN_EORI_NO" ).append("\n"); 
		...
		query.append("        , MDM_CN.IDA_GST_RGST_NO CN_IDA_GST_RGST_NO" ).append("\n"); 
		...
		query.append("		, nf.CUST_PHN_NO									NF_CUST_PHN_NO" ).append("\n"); 
		...
		query.append("		, NF.CO_CHN_TP_CD									NF_CO_CHN_TP_CD" ).append("\n"); 
		query.append("		, CASE WHEN SUBSTR(BK.POD_CD,1,2) = 'IN' AND NF.EORI_NO IS NULL THEN MDM_NF.IDA_GST_RGST_NO" ).append("\n"); 
		query.append("			   WHEN SUBSTR(BK.POD_CD,1,2) = 'CN' AND INSTR(CN.CUST_NM, 'TO ORDER') > 0 AND NF.EORI_NO IS NULL THEN MDM_NF.CO_CHN_NO" ).append("\n"); 
		query.append("               ELSE NF.EORI_NO" ).append("\n"); 
		query.append("          END  NF_EORI_NO" ).append("\n"); 
		...
		query.append("        , MDM_NF.IDA_GST_RGST_NO NF_IDA_GST_RGST_NO" ).append("\n"); 
		...
		query.append("        , mdm_ex.CUST_LGL_ENG_NM 							EX_CUST_LGL_ENG_NM --jsy" ).append("\n"); 
		...
		query.append("        , bk.NON_RT_STS_CD 									NON_RT_STS_CD" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("		, sh.END_USR_NM										END_USR_NM" ).append("\n"); 
		...
		query.append("        , mdm_customer mdm_ex  --jsy" ).append("\n"); 
		...
		query.append("  and ex.cust_cnt_cd  = mdm_ex.cust_cnt_cd(+) --jsy" ).append("\n"); 
