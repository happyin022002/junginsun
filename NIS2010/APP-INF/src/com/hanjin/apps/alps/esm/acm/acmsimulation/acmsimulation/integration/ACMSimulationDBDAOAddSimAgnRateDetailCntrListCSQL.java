...
*@FileName : ACMSimulationDBDAOAddSimAgnRateDetailCntrListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOAddSimAgnRateDetailCntrListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOAddSimAgnRateDetailCntrListCSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOAddSimAgnRateDetailCntrListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO ACM_SIM_AGMT_DTL_CNTR" ).append("\n"); 
