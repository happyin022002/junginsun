...
*@FileName : RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOAddGlineCopyTPWCSQL.java
...
public class RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOAddGlineCopyTPWCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOAddGlineCopyTPWCSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupCommodityQuotationDBDAOPriRqGrpCmdtVOAddGlineCopyTPWCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
