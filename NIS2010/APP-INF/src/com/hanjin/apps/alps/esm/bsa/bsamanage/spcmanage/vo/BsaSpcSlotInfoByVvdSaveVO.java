...
public class BsaSpcSlotInfoByVvdSaveVO extends AbstractValueObject {
	...
	public BsaSpcSlotInfoByVvdSaveVO(String ibflag, String pagerows, String bsaZrFlg, String costYrwk, String trdCd, String subTrdCd, String slanCd, String rlaneCd, String vslLaneTpCd, String vslCd, String skdVoyNo, String skdDirCd, String vopCd, String crrCd, String bsaCapa, String fnlHjsBsaCapa, String crrBsaCapa, String freeAddTeuCapa, String freeAddWgt, String n2ndFnlHjsBsaCapa, String spcCtrtSltCapa, String spcOtrSwapFlg, String slsTeuCapa, String purTeuCapa, String sltSwapTeuCapa, String iocCd, String bsaOpCd, String n1stPortEtdDt, String header, String rdoopjob, String creUsrId) {
		this.vslCd = vslCd;
	...
	public BsaSpcSlotInfoByVvdSaveVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				if (n2ndFnlHjsBsaCapa[i] != null)		model.setN2ndFnlHjsBsaCapa(n2ndFnlHjsBsaCapa[i]);
