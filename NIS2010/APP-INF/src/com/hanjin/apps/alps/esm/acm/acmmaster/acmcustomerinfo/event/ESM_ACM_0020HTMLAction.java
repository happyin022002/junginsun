...
*@FileName : ESM_ACM_0020HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0020Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0020HTMLAction 객체를 생성
	 */
	public ESM_ACM_0020HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0020Event event = new EsmAcm0020Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setFFCmpnExSettingVO((FFCmpnExSettingVO)getVO(request, FFCmpnExSettingVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setFFCmpnExSettingVOs((FFCmpnExSettingVO[])getVOs(request, FFCmpnExSettingVO.class, ""));
		}
