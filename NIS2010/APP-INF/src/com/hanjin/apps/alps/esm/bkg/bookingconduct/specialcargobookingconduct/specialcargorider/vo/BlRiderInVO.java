...
public class BlRiderInVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<BlRiderInVO> models = new ArrayList<BlRiderInVO>();
	...
	public BlRiderInVO(String ibflag, String pagerows, String bkgNo,  String ridrTpCd) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return BlRiderInVO[]
	 */
	public BlRiderInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BlRiderInVO[]
	 */
	public BlRiderInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BlRiderInVO model = null;
	 ...
	 * @return BlRiderInVO[]
	 */
	public BlRiderInVO[] getBlRiderInVOs(){
		BlRiderInVO[] vos = (BlRiderInVO[])models.toArray(new BlRiderInVO[models.size()]);
		return vos;
	}
