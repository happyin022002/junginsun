...
*@FileName : ESM_FMS_0002HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - NIS2010.src.com.hanjin.apps.nis2010.esm.fms.timecharterinoutaccounting 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author JUNGYOONTAE
 * @see EsmFms0002Event 참조
 * @since J2EE 1.5
 */
 
public class ESM_FMS_0002HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESM_FMS_0002HTMLAction 객체를 생성
	 */
	public ESM_FMS_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0002Event event = new EsmFms0002Event();	// table value object
