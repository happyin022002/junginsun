...
*@FileName : RsltPriSqMnVO.java
*@FileTitle : RsltPriSqMnVO
*Open Issues :
*Change history :
...
public class RsltPriSqMnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSqMnVO> models = new ArrayList<RsltPriSqMnVO>();
	 ...
	 */
	public RsltPriSqMnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSqMnVO[]
	 */
	public RsltPriSqMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSqMnVO model = null;
	 ...
	 * @return RsltPriSqMnVO[]
	 */
	public RsltPriSqMnVO[] getRsltPriSqMnVOs(){
		RsltPriSqMnVO[] vos = (RsltPriSqMnVO[])models.toArray(new RsltPriSqMnVO[models.size()]);
		return vos;
	}
