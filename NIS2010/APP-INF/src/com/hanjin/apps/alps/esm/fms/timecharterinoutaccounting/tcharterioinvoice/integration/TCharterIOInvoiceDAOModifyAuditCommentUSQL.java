...
*@FileName : TCharterIOInvoiceDAOModifyAuditCommentUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInvoiceDAOModifyAuditCommentUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInvoiceDAOModifyAuditCommentUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInvoiceDAOModifyAuditCommentUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET VNOR_ITM_FLET_RMK = @[vnor_itm_flet_rmk]" ).append("\n"); 
