...
*@FileName : SearchLaneBDRTimeVO.java
*@FileTitle : SearchLaneBDRTimeVO
*Open Issues :
*Change history :
...
public class SearchLaneBDRTimeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchLaneBDRTimeVO> models = new ArrayList<SearchLaneBDRTimeVO>();
	 ...
	 * @param request
	 * @return SearchLaneBDRTimeVO[]
	 */
	public SearchLaneBDRTimeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchLaneBDRTimeVO[]
	 */
	public SearchLaneBDRTimeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchLaneBDRTimeVO model = null;
		...
		try {
			...
			String[] bdrCreFlg = (JSPUtil.getParameter(request, prefix	+ "bdr_cre_flg", length));
		...
		return getSearchLaneBDRTimeVOs();
	}
	 ...
	 * @return SearchLaneBDRTimeVO[]
	 */
	public SearchLaneBDRTimeVO[] getSearchLaneBDRTimeVOs(){
		SearchLaneBDRTimeVO[] vos = (SearchLaneBDRTimeVO[])models.toArray(new SearchLaneBDRTimeVO[models.size()]);
		return vos;
	}
