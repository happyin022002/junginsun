...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op5ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op5ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op5ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op5ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                    , 'O|CHT', B2.N5TH_CO_AMT" ).append("\n"); 
		query.append("                                    , 'O|BIZ', DECODE(B2.STND_COST_CD, '51102000', B2.ADJ_N5TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , '51302000', B2.ADJ_N5TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , '65000000', B2.ADJ_N5TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , B2.N5TH_HJS_SLS_AMT)" ).append("\n"); 
		query.append("                                    , DECODE(B2.STND_COST_CD, '51102000', B2.ADJ_N5TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , '51302000', B2.ADJ_N5TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , '65000000', B2.ADJ_N5TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , B2.N5TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("							 ) " ).append("\n"); 
		...
		query.append("							 ) " ).append("\n"); 
		query.append("					 ) " ).append("\n"); 
		query.append("			) + NVL(SUM (B2.ADJ_TRD_OTR_FNL_AMT),0) AS AMT " ).append("\n"); 
		...
		query.append("			   ,16, ((INCOME_TOTAL - CM_COST) - N5TH_ESTM_PL_AMT - N5TH_CO_AMT - CMMT_COST - INTER_TS)   /* CMMT0001 */ " ).append("\n"); 
		...
		query.append("				,SUM (N5TH_ESTM_PL_AMT) N5TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("				,SUM (N5TH_CO_AMT) N5TH_CO_AMT " ).append("\n"); 
		...
		query.append("                                                    DECODE(A3.STND_COST_CD, '51102000', A2.ADJ_N5TH_HJS_SLS_AMT, '51302000', A2.ADJ_N5TH_HJS_SLS_AMT, A2.N5TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                                    DECODE(A3.STND_COST_CD, '51102000', A2.ADJ_N5TH_ESTM_PL_AMT, '51302000', A2.ADJ_N5TH_ESTM_PL_AMT, A2.N5TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("					                                      ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                                      ) " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) + NVL(SUM (A2.ADJ_TRD_OTR_FNL_AMT),0) AS OP_COST " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) AS N5TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) AS N5TH_CO_AMT " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("				         ) " ).append("\n"); 
		query.append("				    ,0 " ).append("\n"); 
		query.append("				    ) + NVL(SUM (A2.ADJ_TRD_OTR_FNL_AMT),0) AS OP_COST01 " ).append("\n"); 
		...
		query.append("					                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N5TH_CO_AMT,'O|BIZ' ,               " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N5TH_HJS_SLS_AMT, A2.N5TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N5TH_ESTM_PL_AMT, V.NTWK_HIR_COST_AMT)) " ).append("\n"); 
		query.append("					                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ,0 " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					,0 N5TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("					,0 AS N5TH_CO_AMT " ).append("\n"); 
