...
public class NetworkCostDBDAOSearchNWCreListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",(CASE WHEN STND_COST_CD = '53101000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '53102000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '53200000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54100000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54250000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54300000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54200000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54150000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54450000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54180000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54550000' THEN 'HJS'" ).append("\n"); 
		query.append("WHEN STND_COST_CD = '54350000' THEN 'HJS'" ).append("\n"); 
		query.append("ELSE ''" ).append("\n"); 
