...
*@FileName : HoldNoticeDBDAOcopyHldNtcPreFormCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HoldNoticeDBDAOcopyHldNtcPreFormCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 기 입력된 Pre-Hold Notice Setup 정보를 Copy한다.
	  * </pre>
	  */
	public HoldNoticeDBDAOcopyHldNtcPreFormCSQL(){
		setQuery();
		...
		query.append("FileName : HoldNoticeDBDAOcopyHldNtcPreFormCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
