...
*@FileName : AGTCommonDBDAOSearchAROfficeAgmtCmpnRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCommonDBDAOSearchAROfficeAgmtCmpnRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchAROfficeAgmtCmpn
	  * </pre>
	  */
	public AGTCommonDBDAOSearchAROfficeAgmtCmpnRSQL(){
		setQuery();
		...
		query.append("FileName : AGTCommonDBDAOSearchAROfficeAgmtCmpnRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AGT_CMPN_AGMT_RT CAR" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("AND OR2.AR_OFC_CD = CAR.AR_OFC_CD" ).append("\n"); 
