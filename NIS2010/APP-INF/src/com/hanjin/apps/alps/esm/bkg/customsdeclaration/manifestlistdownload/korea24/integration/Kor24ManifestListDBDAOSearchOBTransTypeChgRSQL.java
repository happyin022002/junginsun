...
*@FileName : Kor24ManifestListDBDAOSearchOBTransTypeChgRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchOBTransTypeChgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchOBTransTypeChgRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchOBTransTypeChgRSQL").append("\n");
		query.append("*/").append("\n");
	}
