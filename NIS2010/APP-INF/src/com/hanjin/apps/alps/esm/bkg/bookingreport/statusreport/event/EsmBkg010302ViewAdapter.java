...
*@FileName : EsmBkg0103_02ViewAdapter.java
*@FileTitle : Booking Status Report BREAK BULK
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmBkg010302ViewAdapter extends ViewAdapter {
...
//	                boolean isSave = isSaveCommand(event);
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("trunk_vvd"))          .append(" ]]></TD>\n"); // T.VVD         
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("slan_cd"))     .append(" ]]></TD>\n"); // Lane     
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("bb_cmdt"))          .append(" ]]></TD>\n"); // Commodity       
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("grs_wgt"))          .append("]]></TD>\n"); // WGT(KGS)        
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pkg"))              .append("]]></TD>\n"); // PKG             
			sbufXML.append("		<TD><![CDATA[").append(colValues.get("pkg"))              .append("]]></TD>\n"); // PKG             
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("dim_len"))          .append("]]></TD>\n"); // Length          
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("dim_wdt"))          .append("]]></TD>\n");// Width           
			sbufXML.append("		<TD><![CDATA[ ").append(colValues.get("dim_hgt"))          .append("]]></TD>\n"); // Height          
