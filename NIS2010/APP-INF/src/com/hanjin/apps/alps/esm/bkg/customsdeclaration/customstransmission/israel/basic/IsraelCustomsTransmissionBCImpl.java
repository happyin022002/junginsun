...
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.IsraelManifestTransmitVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlCMinfoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlCntrMfDescVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlCntrSealNoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlCntrVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlCustVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlDgCgoVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlGeneralVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.searchBlRouteCountryVO;
import com.hanjin.apps.alps.esm.bkg.customsdeclaration.customstransmission.israel.vo.sendHistoryVO;
 ...
 * @since J2EE 1.4
 */
public class IsraelCustomsTransmissionBCImpl extends CustomsTransmissionBCImpl {
...
//				pSendYn = ((IsraelManifestTransmitVO)manifestTransmitVOs[0]).getPSendYn(); 
				...
				for (int q = 0; q < manifestTransmitVOs.length; q++) {
					...
					tsTpCd = israelManifestTransmitVO.getTsTpCd(); // Add. 2015.03.09
					...
					//************************* Bl info 조회 ****************************
					searchBlGeneralVOs = dbDao.searchBlGeneral(blNo, vslCd, skdVoyNo, skdDirCd, cstmsPortCd, tsTpCd);
...
//					flatFileHeader = bookingUtil.searchCstmsEdiHeader(sender, receiver+cstmsPortCd.substring(0, 2), blinfoVO.getMsgIdCd());
					...
					bfTemp.append("PT_NAME:").append("SM Line Corporation, Seoul").append("\n");
					bfTemp.append("PT_ADDRESS:").append("SM LINE CORPORATION, 25 GUKJEGEUMYUNG-RO 2-GIL, YEONGDEUNGPO-GU, SEOUL, KOREA").append("\n");
