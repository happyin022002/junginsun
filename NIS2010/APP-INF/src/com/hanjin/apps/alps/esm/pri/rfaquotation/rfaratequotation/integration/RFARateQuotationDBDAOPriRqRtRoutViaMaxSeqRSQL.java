...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutViaMaxSeqRSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutViaMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutViaMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutViaMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(MAX(ROUT_VIA_SEQ)+1,1) AS MAX_SEQ" ).append("\n"); 
