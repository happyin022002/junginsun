...
*@FileName : ESM_FMS_0076HTMLAction.java
...
public class ESM_FMS_0076HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0076HTMLAction 객체를 생성
	 */
	public ESM_FMS_0076HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0076Event event = new EsmFms0076Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccountItemListVO((SearchAccountItemListVO)getVO(request, SearchAccountItemListVO.class));
			...
			event.setDirection(request.getParameter("direction"));
			event.setRevYrmon(request.getParameter("rev_yrmon"));
		}
		
		event.setFletAcctCateCd(request.getParameter("flet_acct_cate_cd"));
