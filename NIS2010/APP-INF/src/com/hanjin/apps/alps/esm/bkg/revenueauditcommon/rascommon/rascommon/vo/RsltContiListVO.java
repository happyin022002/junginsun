...
*@FileName : RsltContiListVO.java
*@FileTitle : RsltContiListVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esm.bkg.revenueauditcommon.rascommon.rascommon.vo;
...
public class RsltContiListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltContiListVO> models = new ArrayList<RsltContiListVO>();
	...
	public RsltContiListVO() {}

	public RsltContiListVO(String ibflag, String pagerows, String contiCd, String contiNm) {
...
/**
	 ...
	 * @param request
	 * @return RsltContiListVO[]
	 */
	public RsltContiListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltContiListVO[]
	 */
	public RsltContiListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltContiListVO model = null;
	 ...
	 * @return RsltContiListVO[]
	 */
	public RsltContiListVO[] getRsltContiListVOs(){
		RsltContiListVO[] vos = (RsltContiListVO[])models.toArray(new RsltContiListVO[models.size()]);
		return vos;
	}
