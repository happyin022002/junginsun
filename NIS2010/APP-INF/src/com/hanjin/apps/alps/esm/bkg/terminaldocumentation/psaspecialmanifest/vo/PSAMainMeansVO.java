...
*@FileName : PSAMainMeansVO.java
*@FileTitle : PSAMainMeansVO
*Open Issues :
*Change history :
...
public class PSAMainMeansVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PSAMainMeansVO> models = new ArrayList<PSAMainMeansVO>();
	 ...
	 */
	public PSAMainMeansVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PSAMainMeansVO[]
	 */
	public PSAMainMeansVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PSAMainMeansVO model = null;
	 ...
	 * @return PSAMainMeansVO[]
	 */
	public PSAMainMeansVO[] getPSAMainMeansVOs(){
		PSAMainMeansVO[] vos = (PSAMainMeansVO[])models.toArray(new PSAMainMeansVO[models.size()]);
		return vos;
	}
