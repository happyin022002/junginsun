...
*@FileName : RsltTriRoutOrgPntVO.java
*@FileTitle : RsltTriRoutOrgPntVO
*Open Issues :
*Change history :
...
public class RsltTriRoutOrgPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltTriRoutOrgPntVO> models = new ArrayList<RsltTriRoutOrgPntVO>();
	...
	public RsltTriRoutOrgPntVO() {}

	public RsltTriRoutOrgPntVO(String ibflag, String pagerows, String triPropNo, String orgDestTpCd, String routPntSeq, String routPntLocCd, String routPntLocNm, String prcTrspModCd, String rcvDeTermCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return RsltTriRoutOrgPntVO[]
	 */
	public RsltTriRoutOrgPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltTriRoutOrgPntVO[]
	 */
	public RsltTriRoutOrgPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltTriRoutOrgPntVO model = null;
		...
		return getRsltTriRoutOrgPntVOs();
	}
	 ...
	 * @return RsltTriRoutOrgPntVO[]
	 */
	public RsltTriRoutOrgPntVO[] getRsltTriRoutOrgPntVOs(){
		RsltTriRoutOrgPntVO[] vos = (RsltTriRoutOrgPntVO[])models.toArray(new RsltTriRoutOrgPntVO[models.size()]);
		return vos;
	}
