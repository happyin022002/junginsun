...
*@FileName : ESM_ACM_0013HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see EsmAcm0013Event 참조
 * @since J2EE 1.6
 */

public class ESM_ACM_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_ACM_0013HTMLAction 객체를 생성
	 */
	public ESM_ACM_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAcm0013Event event = new EsmAcm0013Event();
		...
		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH02)
			...
			event.setReturnCSRMasterVO((ReturnCSRMasterVO)getVO(request, ReturnCSRMasterVO.class));
		}
		return  event;
	}
