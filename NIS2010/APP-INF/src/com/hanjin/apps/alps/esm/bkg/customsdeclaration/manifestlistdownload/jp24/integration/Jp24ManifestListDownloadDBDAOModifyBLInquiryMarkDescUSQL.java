...
*@FileName : Jp24ManifestListDownloadDBDAOModifyBLInquiryMarkDescUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24ManifestListDownloadDBDAOModifyBLInquiryMarkDescUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24ManifestListDownloadDBDAOModifyBLInquiryMarkDescUSQL(){
		setQuery();
		...
		query.append("FileName : Jp24ManifestListDownloadDBDAOModifyBLInquiryMarkDescUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_ADV_JP_MK" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("   SET CMDT_HS_CD = @[cmdt_hs_cd]," ).append("\n"); 
