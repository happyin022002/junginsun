...
public class PerformanceReportDBDAOManageQtyCntrCoposite2CSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('KRPUS', SYSDATE - 1, BK.POL_CD), 'yyyymmdd')  V_RMK" ).append("\n"); 
		...
		query.append(",TO_CHAR(GLOBALDATE_PKG.TIME_CONV_FNC('KRPUS', SYSDATE - 1, BK.POL_CD), 'yyyymmdd')" ).append("\n"); 
		query.append(")" ).append("\n"); 
