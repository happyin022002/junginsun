...
*@FileName : ESM_PRI_6075HTMLAction.java
...
public class ESM_PRI_6075HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6075HTMLAction 객체를 생성
	 */
	public ESM_PRI_6075HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6075Event event = new EsmPri6075Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			PriSqRtCmdtRoutSetVO vo = (PriSqRtCmdtRoutSetVO)getVO(request, PriSqRtCmdtRoutSetVO.class);
			PriSqRtCmdtRoutVO[] routVOs = (PriSqRtCmdtRoutVO[])getVOs(request, PriSqRtCmdtRoutVO .class,"");
			vo.setPriSqRtCmdtRoutVOS(routVOs);
			event.setPriSqRtCmdtRoutSetVO(vo);
		}
