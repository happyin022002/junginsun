...
*@FileName : MasterDataMgtDBDAOBkgIdaSacMstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MasterDataMgtDBDAOBkgIdaSacMstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MasterDataMgtDBDAOBkgIdaSacMstUSQL(){
		setQuery();
		...
		query.append("FileName : MasterDataMgtDBDAOBkgIdaSacMstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_IDA_SAC_MST SET " ).append("\n"); 
