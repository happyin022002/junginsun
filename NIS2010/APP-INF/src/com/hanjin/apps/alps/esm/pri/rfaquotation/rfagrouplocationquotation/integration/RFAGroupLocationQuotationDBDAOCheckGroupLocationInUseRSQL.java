...
*@FileName : RFAGroupLocationQuotationDBDAOCheckGroupLocationInUseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationQuotationDBDAOCheckGroupLocationInUseRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationQuotationDBDAOCheckGroupLocationInUseRSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationQuotationDBDAOCheckGroupLocationInUseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
