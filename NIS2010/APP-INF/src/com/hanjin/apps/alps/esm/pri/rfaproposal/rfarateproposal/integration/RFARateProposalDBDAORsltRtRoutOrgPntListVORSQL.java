...
*@FileName : RFARateProposalDBDAORsltRtRoutOrgPntListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltRtRoutOrgPntListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAORsltRtRoutOrgPntListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltRtRoutOrgPntListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ACPT_OFC_CD ACPT_USR_NM," ).append("\n"); 
		...
		query.append("      ,BSE_PORT_LOC_CD" ).append("\n"); 
		query.append("      ,BSE_PORT_DEF_CD" ).append("\n"); 
		query.append("	  ,CY_DOR_RT_TP_CD ORG_CY_DOR_RT_TP_CD" ).append("\n"); 
		...
		query.append("                                                           WHERE PROP_NO = A.PROP_NO" ).append("\n"); 
		query.append("                                                           AND AMDT_SEQ = A.N1ST_CMNC_AMDT_SEQ" ).append("\n"); 
		query.append("                                                           AND SVC_SCP_CD = A.SVC_SCP_CD), SVC_SCP_CD, 'O', ROUT_PNT_LOC_DEF_CD, RCV_DE_TERM_CD, NULL, 'N')" ).append("\n"); 
		...
		query.append("                                                           WHERE PROP_NO = A.PROP_NO" ).append("\n"); 
		query.append("                                                           AND AMDT_SEQ = A.N1ST_CMNC_AMDT_SEQ" ).append("\n"); 
		query.append("                                                           AND SVC_SCP_CD = A.SVC_SCP_CD), SVC_SCP_CD, 'O', ROUT_PNT_LOC_DEF_CD, BSE_PORT_LOC_CD, RCV_DE_TERM_CD, PRC_TRSP_MOD_CD)" ).append("\n"); 
		...
		query.append("			  ,(SELECT T.ORG_CY_DOR_RT_TP_CD FROM  PRI_RP_SCP_RT_CMDT_ROUT T WHERE  T.PROP_NO =  PNT.PROP_NO AND T.AMDT_SEQ = PNT.AMDT_SEQ AND T.SVC_SCP_CD = PNT.SVC_SCP_CD AND T.CMDT_HDR_SEQ = PNT.CMDT_HDR_SEQ AND T.ROUT_SEQ = PNT.ROUT_SEQ) CY_DOR_RT_TP_CD" ).append("\n"); 
		...
		query.append("           AND ORG_DEST_TP_CD = 'O') A" ).append("\n"); 
		query.append(" WHERE NEXT_N1ST_CMNC_AMDT_SEQ IS NULL" ).append("\n"); 
		query.append("    OR N1ST_CMNC_AMDT_SEQ <> NEXT_N1ST_CMNC_AMDT_SEQ) G" ).append("\n"); 
