...
public class UsaCustomsTransmissionDBDAOsearchCFlagTERSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                   AND SUBSTR(IBD.IBD_TRSP_NO, 1,3) = 'V5N' " ).append("\n"); 
		query.append("                   AND SUBSTR(RS.ENTR_NO, 1,3) = 'V5N' " ).append("\n"); 
		query.append("                   AND SUBSTR(@[icr_et_no], 1,3) = 'V5N'" ).append("\n"); 
