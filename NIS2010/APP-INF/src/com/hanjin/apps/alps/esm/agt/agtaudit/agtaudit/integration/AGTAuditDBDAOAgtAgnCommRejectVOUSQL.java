...
*@FileName : AGTAuditDBDAOAgtAgnCommRejectVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOAgtAgnCommRejectVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_comm update Reject
	  * </pre>
	  */
	public AGTAuditDBDAOAgtAgnCommRejectVOUSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOAgtAgnCommRejectVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
