...
*@FileName : AGTCommonDBDAOSearchFACAROfficeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTCommonDBDAOSearchFACAROfficeListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchFACAROfficeList
	  * </pre>
	  */
	public AGTCommonDBDAOSearchFACAROfficeListRSQL(){
		setQuery();
		...
		query.append("FileName : AGTCommonDBDAOSearchFACAROfficeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("C.OFC_CD AS SUB_OFC" ).append("\n"); 
		query.append("FROM (SELECT" ).append("\n"); 
