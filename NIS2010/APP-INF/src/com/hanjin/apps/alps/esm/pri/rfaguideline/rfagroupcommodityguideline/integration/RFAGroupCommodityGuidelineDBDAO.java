...
/**
 * NIS2010 RFAGroupCommodityGuidelineDAO <br>
...
public class RFAGroupCommodityGuidelineDBDAO extends DBDAOSupport {
	...
	/**
	 * TPW Group Commodity List를 조회한다.<br>
	 *
	...
	public List<PriScgGrpCmdtVO> searchGRIGroupCommodityGuidelineList(PriScgGrpCmdtVO priScgGrpCmdtVO) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new RFAGroupCommodityGuidelineDBDAOPriScgGrpCmdtVORSQL(), param, velParam);
	...
	public void addGroupCommodityGuideline(PriGriGrpCmdtVO priGriGrpCmdtVO) throws DAOException,Exception {
		...
		try {
			...
			SQLExecuter sqlExe = new SQLExecuter("");
			int result = sqlExe.executeUpdate((ISQLTemplate)new RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtVOCSQL(), param, velParam);
			if(result == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to insert SQL");
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
	...
	public void addGroupCommodityGuidelineDetail(PriGriGrpCmdtVO priGriGrpCmdtVO) throws DAOException,Exception {
		...
		try {
			...
			SQLExecuter sqlExe = new SQLExecuter("");
			int result = sqlExe.executeUpdate((ISQLTemplate)new RFAGroupCommodityGuidelineDBDAOPriRgGrpCmdtListCSQL(), param, velParam);
			if(result == Statement.EXECUTE_FAILED)
				throw new DAOException("Fail to insert SQL");
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
