...
*@FileName : BkgBlForSplitVO.java
*@FileTitle : BkgBlForSplitVO
*Open Issues :
*Change history :
...
public class BkgBlForSplitVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgBlForSplitVO> models = new ArrayList<BkgBlForSplitVO>();
	
	/* Column Info */
	private String multiSplitFlg = null;
	/* Column Info */
	...
	public BkgBlForSplitVO() {}

	public BkgBlForSplitVO(String ibflag, String pagerows, String splitFlg, String porCd, String stopOffLocCd, String remark, String bkgStsCd, String bdrFlg, String fdGrdFlg, String rf, String advShtgCd, String blNo, String pctlNo, String dg, String polCd, String railBlkCd, String prctFlg, String wgtUtCd, String measQty, String pckQty, String stwgCd, String bb, String pckTpCd, String measUtCd, String troFlg, String troTp, String oblIssFlg, String firstVvd, String delCd, String tvvd, String actWgt, String bkgClose, String ak, String podCd, String bkgNo, String spclHideFlg, String hngrFlg, String ediHldFlg, String bkgCgoTpCd, String ltFlg, String multiSplitFlg, String hotDeFlg, String spclHideLnrFlg, String fumgLocCd, String crrSocFlg, String vehCmdtFlg) {
		this.multiSplitFlg = multiSplitFlg;
		this.porCd = porCd;
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("multi_split_flg", getMultiSplitFlg());
	...
	public HashMap<String, String> getFieldNames(){
		this.hashFields.put("multi_split_flg", "multiSplitFlg");
	...
	/**
	 * Column Info
	 * @return multiSplitFlg
	 */
	public String getMultiSplitFlg() {
		return this.multiSplitFlg;
	}
	 ...
	 * @param multiSplitFlg
	 */
	public void setMultiSplitFlg(String multiSplitFlg) {
		this.multiSplitFlg = multiSplitFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setMultiSplitFlg(JSPUtil.getParameter(request, prefix + "multi_split_flg", ""));
	 ...
	 */
	public BkgBlForSplitVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgBlForSplitVO[]
	 */
	public BkgBlForSplitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgBlForSplitVO model = null;
		...
		try {
			String[] multiSplitFlg = (JSPUtil.getParameter(request, prefix	+ "multi_split_flg", length));
			...
			for (int i = 0; i < length; i++) {
				model = new BkgBlForSplitVO();
				if (multiSplitFlg[i] != null)
					model.setMultiSplitFlg(multiSplitFlg[i]);
				if (porCd[i] != null)
	 ...
	 * @return BkgBlForSplitVO[]
	 */
	public BkgBlForSplitVO[] getBkgBlForSplitVOs(){
		BkgBlForSplitVO[] vos = (BkgBlForSplitVO[])models.toArray(new BkgBlForSplitVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		this.multiSplitFlg = this.multiSplitFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
