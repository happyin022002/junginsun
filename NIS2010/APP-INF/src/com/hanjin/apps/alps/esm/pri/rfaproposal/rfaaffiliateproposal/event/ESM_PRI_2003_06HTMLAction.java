...
public class ESM_PRI_2003_06HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0025HTMLAction 객체를 생성
	 */
	public ESM_PRI_2003_06HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri200306Event event = new EsmPri200306Event();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriRpAfilVOS((PriRpAfilVO[])getVOs(request, PriRpAfilVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriRpAfilVO((PriRpAfilVO)getVO(request, PriRpAfilVO .class));
		}
			...
			event.setCstPriRpAfilVO((CstPriRpAfilVO)getVO(request, CstPriRpAfilVO .class));
		}		
