...
*@FileName : EsmMas0059ViewAdapter.java
*@FileTitle : EsmMas0059ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0059ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0059ViewAdapter(){
    	super();
    }
