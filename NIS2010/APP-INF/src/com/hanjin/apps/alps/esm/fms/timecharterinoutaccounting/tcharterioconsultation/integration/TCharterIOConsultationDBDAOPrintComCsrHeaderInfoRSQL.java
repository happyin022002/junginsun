...
*@FileName : TCharterIOConsultationDBDAOPrintComCsrHeaderInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOPrintComCsrHeaderInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOPrintComCsrHeaderInfoRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOPrintComCsrHeaderInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                TO_CHAR(H.CSR_AMT, '999,999,999,990.00')" ).append("\n"); 
