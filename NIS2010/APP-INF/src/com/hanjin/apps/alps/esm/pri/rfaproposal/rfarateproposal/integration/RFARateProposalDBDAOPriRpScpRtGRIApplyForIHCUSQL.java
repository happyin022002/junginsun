...
*@FileName : RFARateProposalDBDAOPriRpScpRtGRIApplyForIHCUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtGRIApplyForIHCUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rate AEE/AEW의 Calculate Apply 처리
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtGRIApplyForIHCUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtGRIApplyForIHCUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       B.T_FIC_RT_USE_STS_CD," ).append("\n"); 
		query.append("       B.T_OPTM_TRSP_MOD_FLG," ).append("\n"); 
		query.append("       (SELECT DECODE(NVL(B.DR20_GUIDE_AMT, 'N/A'), 'N/A', '', CASE" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = B.LOCL_CURR_CD THEN B.DR_LOCL_20FT_AMT" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = 'USD' THEN B.DR20_GUIDE_AMT" ).append("\n"); 
		query.append("                         ELSE" ).append("\n"); 
		query.append("                          TO_CHAR((SELECT USD_LOCL_XCH_RT * NVL(B.DR20_GUIDE_AMT, 0)" ).append("\n"); 
		...
		query.append("          FROM DUAL) DR20_GUIDE_AMT," ).append("\n"); 
		query.append("       (SELECT DECODE(NVL(B.RF20_GUIDE_AMT, 'N/A'), 'N/A', '', CASE" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = B.LOCL_CURR_CD THEN B.RF_LOCL_20FT_AMT" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = 'USD' THEN B.RF20_GUIDE_AMT" ).append("\n"); 
		query.append("                         ELSE" ).append("\n"); 
		query.append("                          TO_CHAR((SELECT USD_LOCL_XCH_RT * NVL(B.RF20_GUIDE_AMT, 0)" ).append("\n"); 
		query.append("                             FROM GL_MON_XCH_RT" ).append("\n"); 
		query.append("                            WHERE ACCT_XCH_RT_YRMON = (SELECT MAX(ACCT_XCH_RT_YRMON) FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_LVL = '1' AND CURR_CD = A.CURR_CD)" ).append("\n"); 
		query.append("                                  AND ACCT_XCH_RT_LVL = '1'" ).append("\n"); 
		query.append("                                  AND CURR_CD = A.CURR_CD))" ).append("\n"); 
		query.append("                       END)" ).append("\n"); 
		query.append("          FROM DUAL) RF20_GUIDE_AMT," ).append("\n"); 
		query.append("       (SELECT DECODE(NVL(B.DG20_GUIDE_AMT, 'N/A'), 'N/A', '', CASE" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = B.LOCL_CURR_CD THEN B.DG_LOCL_20FT_AMT" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = 'USD' THEN B.DG20_GUIDE_AMT" ).append("\n"); 
		query.append("                         ELSE" ).append("\n"); 
		query.append("                          TO_CHAR((SELECT USD_LOCL_XCH_RT * NVL(B.DG20_GUIDE_AMT, 0)" ).append("\n"); 
		query.append("                             FROM GL_MON_XCH_RT" ).append("\n"); 
		query.append("                            WHERE ACCT_XCH_RT_YRMON = (SELECT MAX(ACCT_XCH_RT_YRMON) FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_LVL = '1' AND CURR_CD = A.CURR_CD)" ).append("\n"); 
		query.append("                                  AND ACCT_XCH_RT_LVL = '1'" ).append("\n"); 
		query.append("                                  AND CURR_CD = A.CURR_CD))" ).append("\n"); 
		query.append("                       END)" ).append("\n"); 
		query.append("          FROM DUAL) DG20_GUIDE_AMT," ).append("\n"); 
		query.append("       (SELECT DECODE(NVL(B.DR40_GUIDE_AMT, 'N/A'), 'N/A', '', CASE" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = B.LOCL_CURR_CD THEN B.DR_LOCL_40FT_AMT" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = 'USD' THEN B.DR40_GUIDE_AMT" ).append("\n"); 
		query.append("                         ELSE" ).append("\n"); 
		query.append("                          TO_CHAR((SELECT USD_LOCL_XCH_RT * NVL(B.DR40_GUIDE_AMT, 0)" ).append("\n"); 
		query.append("                             FROM GL_MON_XCH_RT" ).append("\n"); 
		query.append("                            WHERE ACCT_XCH_RT_YRMON = (SELECT MAX(ACCT_XCH_RT_YRMON) FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_LVL = '1' AND CURR_CD = A.CURR_CD)" ).append("\n"); 
		query.append("                                  AND ACCT_XCH_RT_LVL = '1'" ).append("\n"); 
		query.append("                                  AND CURR_CD = A.CURR_CD))" ).append("\n"); 
		query.append("                       END)" ).append("\n"); 
		query.append("          FROM DUAL) DR40_GUIDE_AMT," ).append("\n"); 
		query.append("       (SELECT DECODE(NVL(B.RF40_GUIDE_AMT, 'N/A'), 'N/A', '', CASE" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = B.LOCL_CURR_CD THEN B.RF_LOCL_40FT_AMT" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = 'USD' THEN B.RF40_GUIDE_AMT" ).append("\n"); 
		query.append("                         ELSE" ).append("\n"); 
		query.append("                          TO_CHAR((SELECT USD_LOCL_XCH_RT * NVL(B.RF40_GUIDE_AMT, 0)" ).append("\n"); 
		query.append("                             FROM GL_MON_XCH_RT" ).append("\n"); 
		query.append("                            WHERE ACCT_XCH_RT_YRMON = (SELECT MAX(ACCT_XCH_RT_YRMON) FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_LVL = '1' AND CURR_CD = A.CURR_CD)" ).append("\n"); 
		query.append("                                  AND ACCT_XCH_RT_LVL = '1'" ).append("\n"); 
		query.append("                                  AND CURR_CD = A.CURR_CD))" ).append("\n"); 
		query.append("                       END)" ).append("\n"); 
		query.append("          FROM DUAL) RF40_GUIDE_AMT," ).append("\n"); 
		query.append("       (SELECT DECODE(NVL(B.DG40_GUIDE_AMT, 'N/A'), 'N/A', '', CASE" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = B.LOCL_CURR_CD THEN B.DG_LOCL_40FT_AMT" ).append("\n"); 
		query.append("                         WHEN A.CURR_CD = 'USD' THEN B.DG40_GUIDE_AMT" ).append("\n"); 
		query.append("                         ELSE" ).append("\n"); 
		query.append("                          TO_CHAR((SELECT USD_LOCL_XCH_RT * NVL(B.DG40_GUIDE_AMT, 0)" ).append("\n"); 
		query.append("                             FROM GL_MON_XCH_RT" ).append("\n"); 
		query.append("                            WHERE ACCT_XCH_RT_YRMON = (SELECT MAX(ACCT_XCH_RT_YRMON) FROM GL_MON_XCH_RT WHERE ACCT_XCH_RT_LVL = '1' AND CURR_CD = A.CURR_CD)" ).append("\n"); 
		query.append("                                  AND ACCT_XCH_RT_LVL = '1'" ).append("\n"); 
		query.append("                                  AND CURR_CD = A.CURR_CD))" ).append("\n"); 
		query.append("                       END)" ).append("\n"); 
		query.append("          FROM DUAL) DG40_GUIDE_AMT" ).append("\n"); 
		...
		query.append("               A.FIC_RT_USE_STS_CD," ).append("\n"); 
		query.append("               A.OPTM_TRSP_MOD_FLG," ).append("\n"); 
		query.append("               REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 1) AS T_FIC_RT_USE_STS_CD," ).append("\n"); 
		query.append("               REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 2) AS T_OPTM_TRSP_MOD_FLG," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 3)) AS DR20_GUIDE_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 4)) AS RF20_GUIDE_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 5)) AS DG20_GUIDE_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 6)) AS DR40_GUIDE_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 7)) AS RF40_GUIDE_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 8)) AS DG40_GUIDE_AMT," ).append("\n"); 
		query.append("               REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 9) AS LOCL_CURR_CD," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 10)) AS DR_LOCL_20FT_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 11)) AS RF_LOCL_20FT_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 12)) AS DG_LOCL_20FT_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 13)) AS DR_LOCL_40FT_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 14)) AS RF_LOCL_40FT_AMT," ).append("\n"); 
		query.append("               TRIM(REGEXP_SUBSTR(T.FIC_GUIDE_AMT, '[^|]+', 1, 15)) AS DG_LOCL_40FT_AMT" ).append("\n"); 
		query.append("          FROM PRI_RP_SCP_RT A," ).append("\n"); 
		query.append("               (SELECT A.PROP_NO," ).append("\n"); 
		query.append("                       A.AMDT_SEQ," ).append("\n"); 
		query.append("                       A.SVC_SCP_CD," ).append("\n"); 
		...
		query.append("                       (SELECT PRI_FIC_RATE_CALCULATE_PKG.PRI_getFICRateByRouteV2_FNC(A.PROP_NO, A.AMDT_SEQ, A.SVC_SCP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ) FROM DUAL) AS FIC_GUIDE_AMT" ).append("\n"); 
		query.append("                  FROM PRI_RP_SCP_RT A," ).append("\n"); 
		...
		query.append("      ,FIC_GLINE_RT_AMT       = CASE " ).append("\n"); 
		query.append("                                     WHEN RAT_UT_CD = 'D2' OR RAT_UT_CD = 'R2'" ).append("\n"); 
		query.append("                                       THEN DECODE(PRC_CGO_TP_CD, 'DR', DR20_GUIDE_AMT, 'DG', DG20_GUIDE_AMT, 'RF', RF20_GUIDE_AMT)" ).append("\n"); 
		query.append("                                     WHEN RAT_UT_CD = 'D4' OR RAT_UT_CD = 'R4' OR RAT_UT_CD = 'D5' OR RAT_UT_CD = 'R5' " ).append("\n"); 
		query.append("                                       THEN DECODE(PRC_CGO_TP_CD, 'DR', DR40_GUIDE_AMT, 'DG', DG40_GUIDE_AMT, 'RF', RF40_GUIDE_AMT) " ).append("\n"); 
		query.append("                                END" ).append("\n"); 
		query.append("      ,FIC_RT_USE_STS_CD      = T_FIC_RT_USE_STS_CD" ).append("\n"); 
		query.append("      ,OPTM_TRSP_MOD_FLG      = T_OPTM_TRSP_MOD_FLG  " ).append("\n"); 
		query.append("      ,FIC_GLINE_UPD_DT       = SYSDATE          " ).append("\n"); 
		query.append("      ,FIC_COFFR_RT_AMT       = DECODE(AMDT_SEQ, 0, FIC_COFFR_RT_AMT, NULL)" ).append("\n"); 
		query.append("      ,FIC_FNL_RT_AMT         = DECODE(AMDT_SEQ, 0, FIC_FNL_RT_AMT, NULL)   " ).append("\n"); 
		query.append("      ,FIC_PROP_RT_AMT        = NVL(CASE " ).append("\n"); 
		query.append("                                     WHEN RAT_UT_CD = 'D2' OR RAT_UT_CD = 'R2'" ).append("\n"); 
		query.append("                                       THEN DECODE(PRC_CGO_TP_CD, 'DR', DR20_GUIDE_AMT, 'DG', DG20_GUIDE_AMT, 'RF', RF20_GUIDE_AMT)" ).append("\n"); 
		query.append("                                     WHEN RAT_UT_CD = 'D4' OR RAT_UT_CD = 'R4' OR RAT_UT_CD = 'D5' OR RAT_UT_CD = 'R5' " ).append("\n"); 
		query.append("                                       THEN DECODE(PRC_CGO_TP_CD, 'DR', DR40_GUIDE_AMT, 'DG', DG40_GUIDE_AMT, 'RF', RF40_GUIDE_AMT) " ).append("\n"); 
