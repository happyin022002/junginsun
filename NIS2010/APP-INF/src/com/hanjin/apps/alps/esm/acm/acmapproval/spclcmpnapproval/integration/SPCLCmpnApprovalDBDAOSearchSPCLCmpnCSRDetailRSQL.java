...
public class SPCLCmpnApprovalDBDAOSearchSPCLCmpnCSRDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               ROUND((SUM(A.IF_AMT) * NVL(A.INV_TAX_RT, 0) / 100), 2) AS INV_AMT, " ).append("\n"); 
		...
		query.append("         GROUP BY A.CSR_NO, A.vndr_seq, A.INV_TAX_RT,A.AP_OFC_CD,A.SPCL_OCCR_INFO_CD " ).append("\n"); 
		query.append("" ).append("\n"); 
