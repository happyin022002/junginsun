...
*@FileName : KorManifestListDBDAOSearchRegNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOSearchRegNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchRegNoRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : KorManifestListDBDAOSearchRegNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}