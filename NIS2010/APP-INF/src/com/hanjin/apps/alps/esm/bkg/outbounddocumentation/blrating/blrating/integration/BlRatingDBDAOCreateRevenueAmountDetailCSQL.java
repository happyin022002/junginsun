...
*@FileName : BlRatingDBDAOCreateRevenueAmountDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOCreateRevenueAmountDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOCreateRevenueAmountDetailCSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOCreateRevenueAmountDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_REV_DTL (" ).append("\n"); 
		query.append("   BKG_NO, " ).append("\n"); 
		query.append("   REV_COST_SEQ, " ).append("\n"); 
		query.append("   REV_DTL_SEQ, DP_SEQ, " ).append("\n"); 
		...
		query.append("   NOTE_RT_SEQ,PROP_NO,AMDT_SEQ,SVC_SCP_CD,GEN_SPCL_RT_TP_CD,CMDT_HDR_SEQ,ROUT_SEQ,FX_RT_FLG, MST_RFA_ROUT_ID," ).append("\n"); 
		query.append("   CRE_USR_ID, CRE_DT, " ).append("\n"); 
		query.append("   UPD_USR_ID, UPD_DT) " ).append("\n"); 
		query.append("VALUES (" ).append("\n"); 
		query.append("   @[bkg_no], " ).append("\n"); 
		query.append("   (SELECT MAX(REV_COST_SEQ)" ).append("\n"); 
		query.append("    FROM BKG_REV_COST" ).append("\n"); 
		query.append("    WHERE BKG_NO = @[bkg_no])," ).append("\n"); 
		query.append("   (SELECT  NVL(MAX(REV_DTL_SEQ),0)+1 AS SEQ " ).append("\n"); 
