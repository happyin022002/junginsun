...
public class ESM_BKG_0740HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;

    /**
     * ESM_BKG_0740HTMLAction 객체를 생성
     */
    public ESM_BKG_0740HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EsmBkg0740Event event = new EsmBkg0740Event();
        log.debug("***** ESM_BKG_0740HTMLAction : " + command.getCommand());
