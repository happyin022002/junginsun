...
*@FileName : SurchargeDBDAOPriScgRtVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SurchargeDBDAOPriScgRtVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete Pri Surcharge Rate
	  * </pre>
	  */
	public SurchargeDBDAOPriScgRtVODSQL(){
		setQuery();
		...
		query.append("FileName : SurchargeDBDAOPriScgRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
