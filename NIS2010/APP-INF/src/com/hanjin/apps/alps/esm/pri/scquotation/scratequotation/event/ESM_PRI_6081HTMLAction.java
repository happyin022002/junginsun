...
*@FileName : ESM_PRI_6081HTMLAction.java
...
public class ESM_PRI_6081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6081HTMLAction 객체를 생성
	 */
	public ESM_PRI_6081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6081Event event = new EsmPri6081Event();
		
 
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRsltPriSurchargeAdjustLocationGroupVO((RsltPriSurchargeAdjustLocationGroupVO)getVO(request, RsltPriSurchargeAdjustLocationGroupVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH02)) {
			event.setRsltPriSurchargeAdjustLocationGroupDetailVO((RsltPriSurchargeAdjustLocationGroupDetailVO)getVO(request, RsltPriSurchargeAdjustLocationGroupDetailVO .class));
		}		
