...
public class TCharterStandardPrimeCostDAOFmsMktRtAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Hire Base Input Delete All
	  * </pre>
	  */
	public TCharterStandardPrimeCostDAOFmsMktRtAllDSQL(){
		setQuery();
