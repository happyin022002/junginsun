...
*@FileName : MxVvdModeVO.java
*@FileTitle : MxVvdModeVO
*Open Issues :
*Change history :
...
public class MxVvdModeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MxVvdModeVO> models = new ArrayList<MxVvdModeVO>();
	...
	public MxVvdModeVO(String ibflag, String pagerows, String vslPrePstCd) {
		this.ibflag = ibflag;
	 ...
	 * @return MxVvdModeVO[]
	 */
	public MxVvdModeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MxVvdModeVO[]
	 */
	public MxVvdModeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MxVvdModeVO model = null;
	 ...
	 * @return MxVvdModeVO[]
	 */
	public MxVvdModeVO[] getMxVvdModeVOs(){
		MxVvdModeVO[] vos = (MxVvdModeVO[])models.toArray(new MxVvdModeVO[models.size()]);
		return vos;
	}
