...
public class Kor24VslInfoNManifestVO extends VslInfoNManifestVO {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24VslInfoNManifestVO> models = new ArrayList<Kor24VslInfoNManifestVO>();
	/* VVD INFO */
	...
	public Kor24VslInfoNManifestVO() {}

	public Kor24VslInfoNManifestVO(String ibflag, String pagerows, String vvd, String polCd, String podCd, String tmlCd, String inType, String blNo, String ioBndCd, String receiver) {
		this.podCd = podCd;
		this.vvd = vvd;
		this.inType = inType;
		this.polCd = polCd;
	 ...
	 */
	public Kor24VslInfoNManifestVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24VslInfoNManifestCondVO[]
	 */
	public Kor24VslInfoNManifestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24VslInfoNManifestVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24VslInfoNManifestVO();
				if (podCd[i] != null)
	 ...
	 * @return Kor24VslInfoNManifestCondVO[]
	 */
	public Kor24VslInfoNManifestVO[] getKor24VslInfoNManifestCondVOs(){
		Kor24VslInfoNManifestVO[] vos = (Kor24VslInfoNManifestVO[])models.toArray(new Kor24VslInfoNManifestVO[models.size()]);
		return vos;
	}
