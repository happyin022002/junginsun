...
*@FileName : WeeklyCMDBDAOMasInterOwnTmlCostVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOMasInterOwnTmlCostVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESM_MAS_118 TML 단가 수정
	  * </pre>
	  */
	public WeeklyCMDBDAOMasInterOwnTmlCostVOUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOMasInterOwnTmlCostVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_INTER_OWN_TML_COST A" ).append("\n"); 
		...
		query.append("        INSERT (COST_YRMON, TML_CD, TML_TRF_ITM_CD, TML_TRF_DTL_CD, CNTR_TPSZ_CD, MAS_COST_SRC_CD" ).append("\n"); 
		...
		query.append("        VALUES (B.COST_YRMON, B.TML_CD, B.TML_TRF_ITM_CD, B.TML_TRF_DTL_CD, B.CNTR_TPSZ_CD, B.MAS_COST_SRC_CD" ).append("\n"); 
		...
		query.append("           SET A.MAS_COST_SRC_CD = B.MAS_COST_SRC_CD, A.TML_UT_CD = B.TML_UT_CD, A.LOCL_CURR_CD = B.LOCL_CURR_CD" ).append("\n"); 
