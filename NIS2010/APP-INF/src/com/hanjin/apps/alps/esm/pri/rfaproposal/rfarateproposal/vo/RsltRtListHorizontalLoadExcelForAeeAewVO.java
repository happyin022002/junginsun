...
*@FileName : RsltRtListHorizontalLoadExcelForAeeAewVO.java
*@FileTitle : RsltRtListHorizontalLoadExcelForAeeAewVO
*Open Issues :
*Change history :
...
public class RsltRtListHorizontalLoadExcelForAeeAewVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltRtListHorizontalLoadExcelForAeeAewVO> models = new ArrayList<RsltRtListHorizontalLoadExcelForAeeAewVO>();
...
/**
	 ...
	 * @param request
	 * @return RsltRtListHorizontalLoadExcelForAeeAewVO[]
	 */
	public RsltRtListHorizontalLoadExcelForAeeAewVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltRtListHorizontalLoadExcelForAeeAewVO[]
	 */
	public RsltRtListHorizontalLoadExcelForAeeAewVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRtListHorizontalLoadExcelForAeeAewVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltRtListHorizontalLoadExcelForAeeAewVO();
		...
		return getRsltRtListHorizontalLoadExcelForAeeAewVOs();
	}
	...
	public RsltRtListHorizontalLoadExcelForAeeAewVO[] getRsltRtListHorizontalLoadExcelForAeeAewVOs(){
		RsltRtListHorizontalLoadExcelForAeeAewVO[] vos = (RsltRtListHorizontalLoadExcelForAeeAewVO[])models.toArray(new RsltRtListHorizontalLoadExcelForAeeAewVO[models.size()]);
		return vos;
	}
