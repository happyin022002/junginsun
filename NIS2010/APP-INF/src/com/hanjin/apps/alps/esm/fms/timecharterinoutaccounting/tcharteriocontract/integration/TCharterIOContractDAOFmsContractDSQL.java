...
public class TCharterIOContractDAOFmsContractDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOContractDAOFmsContractDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("delete from fms_contract" ).append("\n"); 
		...
		query.append("FileName : TCharterIOContractDAOFmsContractDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}