...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased9ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased9ListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CSR 1191] MAS 운항비 약정률 (P/L by agreement - By Account)
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased9ListRSQL(){
		setQuery();
		...
		params.put("f_iskorean_b",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased9ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                    , 'O|BIZ', B2.HJS_SLS_AMT" ).append("\n"); 
		...
		query.append("				AND (B3.STND_COST_TP_CD IN ('S','C','O','G',@[str_display])  /* strDisplay( f_pro_obj P->O,A,B) */" ).append("\n"); 
		...
		query.append("					AND B3.STND_COST_TP_CD IN ('S','C','O','G') " ).append("\n"); 
		query.append("				#end" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		...
		query.append("		 /* 계정별 비용집계 - 여기엔 실제 T/S 적용 전 순수 Network Cost만 나옴, 약정률도 나오지 않음. */" ).append("\n"); 
		query.append("		SELECT   /*+ ORDERED */ " ).append("\n"); 
		query.append("			 B1.TRD_CD " ).append("\n"); 
		query.append("			,R.HUL_BND_CD" ).append("\n"); 
		...
		query.append("				   ,31, 'OPCOSTEX' 	" ).append("\n"); 
		query.append("			   	   ,32, 'OPCOSTIN' 	" ).append("\n"); 
		query.append("			   	   ,33, 'OPCB0000' 	" ).append("\n"); 
		query.append("			   	   ,34, 'BOPTTLEX' 	" ).append("\n"); 
		query.append("			   	   ,35, 'BOPTTLIN' 	" ).append("\n"); 
		query.append("			   	   ,36, 'BOPB0000' 		 " ).append("\n"); 
		query.append("			       ) STND_COST_CD " ).append("\n"); 
		...
		query.append("               ,9, (INCOME_TOTAL - (CM_COST + SPC_CHTR))   /* CMCTOTAL (CM(Net Revenue) Total) */" ).append("\n"); 
		query.append("               ,10, DECODE (LOAD_TEU,0, 0, (INCOME_TOTAL - (CM_COST + SPC_CHTR)) / LOAD_TEU)   /* CMB00000 (CM(Net Revenue)/TEU) */" ).append("\n"); 
		...
		query.append("   			   ,31, (OP_COST - VSL_INT)	" ).append("\n"); 
		query.append("			   ,32, OP_COST " ).append("\n"); 
		query.append("			   ,33, DECODE (LOAD_TEU, 0, 0, (OP_COST - VSL_INT) / LOAD_TEU)" ).append("\n"); 
		query.append("			   ,34, (INCOME_TOTAL - CM_COST) - (OP_COST - VSL_INT)  /* OP(excluding interest) */ " ).append("\n"); 
		query.append("               ,35, (INCOME_TOTAL - CM_COST) - OP_COST              /* OP(including interest) */ " ).append("\n"); 
		query.append("               ,36, DECODE (LOAD_TEU,0,0, ((INCOME_TOTAL - CM_COST) - (OP_COST - VSL_INT)) / LOAD_TEU )  /* OP(excluding)/TEU */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			   ) AS AMT " ).append("\n"); 
		query.append("			   " ).append("\n"); 
		query.append("			   " ).append("\n"); 
		...
		query.append("                -- 약정률은 실제 T/S 배부 전 데이터를 이용해야하기 때문에 TS alloc, CO 금액 제외" ).append("\n"); 
		...
		query.append("				,0 CO_AMT -- 약정률은 실제 T/S 배부 전 데이터를 이용해야하기 때문에 TS alloc, CO 금액 제외" ).append("\n"); 
		...
		query.append("				,0 TS_ALOC -- 약정률은 실제 T/S 배부 전 데이터를 이용해야하기 때문에 TS alloc, CO 금액 제외" ).append("\n"); 
		...
		query.append("                                                    A2.HJS_SLS_AMT, " ).append("\n"); 
		query.append("                                                    A2.ESTM_PL_AMT) " ).append("\n"); 
		query.append("					                                      ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                                      ) " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					,NVL (SUM (CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM MAS_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF' ,'VF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                                       THEN NVL(A2.HJS_SLS_AMT,0) + NVL(A2.CO_AMT,0) - NVL(A2.N1ST_ASGN_AMT,0)" ).append("\n"); 
		query.append("                                    WHEN A3.STND_COST_TP_CD IN ('O', 'G')" ).append("\n"); 
		query.append("                                            AND A3.STND_COST_CD NOT IN ( SELECT STND_COST_CD FROM MAS_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF' ,'VF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("					                   THEN DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("					                                ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz]" ).append("\n"); 
		query.append("                                                                ,'O|CHT', A2.CO_AMT" ).append("\n"); 
		query.append("                                                                ,'O|BIZ' , A2.HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                , A2.ESTM_PL_AMT) " ).append("\n"); 
		query.append("					                                ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                                ) " ).append("\n"); 
		query.append("					                ELSE 0 " ).append("\n"); 
		...
		query.append("                                            A2.N4TH_HJS_SLS_AMT, " ).append("\n"); 
		query.append("                                            A2.N4TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("				                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("				                              ) " ).append("\n"); 
		query.append("				                 ,0 " ).append("\n"); 
		query.append("				                 ) " ).append("\n"); 
		...
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("	                                       ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.CO_AMT,'O|BIZ', A2.HJS_SLS_AMT, NVL(A2.HJS_SLS_AMT,0) + NVL(A2.CO_AMT,0) - NVL(A2.N1ST_ASGN_AMT,0)) " ).append("\n"); 
		query.append("	                                       ,'R', NVL(A2.HJS_SLS_AMT,0) + NVL(A2.CO_AMT,0) - NVL(A2.N1ST_ASGN_AMT,0)" ).append("\n"); 
		query.append("	                                       ) " ).append("\n"); 
		query.append("					           ELSE 0 " ).append("\n"); 
		query.append("					        END " ).append("\n"); 
		query.append("					       ) " ).append("\n"); 
		...
		query.append("					" ).append("\n"); 
		query.append("					#if(${f_pro_vw} =='P' && ${f_pro_lvl} =='O')" ).append("\n"); 
		query.append("						AND (A3.STND_COST_TP_CD IN ('S','C','O','G',@[str_display])  /* f_pro_obj P->O,A,B */" ).append("\n"); 
		query.append("							OR A3.STND_COST_CD IN ('OPCTOTAL','OPB00000','BOPTOTAL','BOPB0000')) " ).append("\n"); 
		query.append("					#else" ).append("\n"); 
		query.append("						AND A3.STND_COST_TP_CD IN ('S','C','O','G') " ).append("\n"); 
		query.append("					#end	" ).append("\n"); 
		query.append("		                                       " ).append("\n"); 
		...
		query.append("					WHERE CPY_NO BETWEEN 1 AND 36 " ).append("\n"); 
		...
		query.append("					,DECODE (@[f_iskorean_b], '1', A2.SGRP_KR_DESC, A2.SGRP_COST_CD_DESC) SGRP_COST_CD_DESC   /*조건:한글여부 //f_isKorean */" ).append("\n"); 
		query.append("					,DECODE (@[f_iskorean_b], '1', A2.KR_RPT_ITM_DESC, A2.RPT_ITM_DESC) RPT_ITM_DESC " ).append("\n"); 
		...
		query.append("				#if(${f_pro_vw} =='P' && ${f_pro_lvl} =='O')" ).append("\n"); 
		query.append("					AND (a2.stnd_cost_tp_cd IN ('S','C','O','G',@[str_display])  /* f_pro_obj P->O,A,B */" ).append("\n"); 
		...
		query.append("					#elseif (${f_pro_lvl} =='O')" ).append("\n"); 
		query.append("						AND A2.STND_COST_TP_CD IN ('S','C','O','G') " ).append("\n"); 
		query.append("					#end" ).append("\n"); 
		query.append("				#end	" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("		#end" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("	AND STND_COST_CD NOT IN ('OPCOST01', 'OPCOST02', 'NTCOALOC')  -- OP Cost Total(Pooling), OPCOST02(Pooling), T/S Cost 숨김 처리 (P&L by agreement)" ).append("\n"); 
