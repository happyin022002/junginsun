...
*@FileName : Kor24ManifestListDBDAOModifyDownHistKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOModifyDownHistKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOModifyDownHistKorUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : Kor24ManifestListDBDAOModifyDownHistKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
}