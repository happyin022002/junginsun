...
*@FileName : ESM_BKG_0161HTMLAction.java
...
public class ESM_BKG_0161HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0161HTMLAction 객체를 생성
	 */
	public ESM_BKG_0161HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0161Event event = new EsmBkg0161Event();
