...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOUSQL.java
...
public class CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GLINE_ROUT_PNT SET" ).append("\n"); 
		...
		query.append(",	ROUT_PNT_SEQ = @[rout_pnt_seq]" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineRoutPntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}