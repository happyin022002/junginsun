...
*@FileName : ZDAOOblRdemVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ZDAOOblRdemVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ZDAOOblRdemVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.integration").append("\n"); 
		query.append("FileName : ZDAOOblRdemVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'' as obl_clr_cd" ).append("\n"); 
		query.append(",'' as obl_ds_po_cd" ).append("\n"); 
		query.append(",'' as obl_loc_cd" ).append("\n"); 
		...
		query.append(",'' as obl_chk" ).append("\n"); 
		query.append(",'' as obl_chk_cnt" ).append("\n"); 
