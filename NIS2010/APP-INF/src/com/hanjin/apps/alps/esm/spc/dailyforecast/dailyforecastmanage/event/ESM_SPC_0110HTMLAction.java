...
*@FileName : ESM_SPC_0110HTMLAction.java
...
public class ESM_SPC_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0102HTMLAction 객체를 생성
	 */
	public ESM_SPC_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSpc0110Event event = new EsmSpc0110Event();
    	SearchDailyForecastManageListVO searchDailyForecastManageListVO = new SearchDailyForecastManageListVO();
		

		if(command.isCommand(FormCommand.MULTI01)) {
			event.setSearchDailyForecastManageListVOS(searchDailyForecastManageListVO.fromRequestGrid(request, ""));
		}		
