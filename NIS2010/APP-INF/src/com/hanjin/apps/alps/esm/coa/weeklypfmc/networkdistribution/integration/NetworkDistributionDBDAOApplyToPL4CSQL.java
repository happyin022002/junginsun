...
*@FileName : NetworkDistributionDBDAOApplyToPL4CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOApplyToPL4CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkDistributionDBDAOApplyToPL4CSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOApplyToPL4CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                      AND (A.TRD_CD, A.RLANE_CD, A.DIR_CD, A.IOC_CD)" ).append("\n"); 
		query.append("			        	     NOT IN (" ).append("\n"); 
		query.append("									SELECT TRD_CD,  RLANE_CD, DIR_CD, IOC_CD" ).append("\n"); 
