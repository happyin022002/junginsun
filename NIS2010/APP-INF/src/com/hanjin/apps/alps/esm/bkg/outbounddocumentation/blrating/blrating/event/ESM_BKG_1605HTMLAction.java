...
*@FileName : ESM_BKG_1605HTMLAction.java
...
public class ESM_BKG_1605HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1605HTMLAction 객체를 생성
	 */
	public ESM_BKG_1605HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1605Event event = new EsmBkg1605Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGroupRatingVO((GroupRatingVO)getVO(request, GroupRatingVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI01)) {
			event.setGroupRatingVOs((GroupRatingVO[])getVOs(request, GroupRatingVO.class, "sheet1_"));
		}
