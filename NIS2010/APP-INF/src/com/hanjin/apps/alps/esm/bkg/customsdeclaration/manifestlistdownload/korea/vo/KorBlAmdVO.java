...
*@FileName : KorBlAmdVO.java
*@FileTitle : KorBlAmdVO
*Open Issues :
*Change history :
...
public class KorBlAmdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorBlAmdVO> models = new ArrayList<KorBlAmdVO>();
	 ...
	 * @return KorBlAmdVO[]
	 */
	public KorBlAmdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorBlAmdVO[]
	 */
	public KorBlAmdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorBlAmdVO model = null;
	 ...
	 * @return KorBlAmdVO[]
	 */
	public KorBlAmdVO[] getKorBlAmdVOs(){
		KorBlAmdVO[] vos = (KorBlAmdVO[])models.toArray(new KorBlAmdVO[models.size()]);
		return vos;
	}
