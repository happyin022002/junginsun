...
*@FileName : ESM_PRI_6003HTMLAction.java
...
public class ESM_PRI_6004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6003HTMLAction 객체를 생성
	 */
	public ESM_PRI_6004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6004Event event = new EsmPri6004Event();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriCmpbGlineMqcRngVOS((PriCmpbGlineMqcRngVO[])getVOs(request, PriCmpbGlineMqcRngVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriCmpbGlineMqcRngVO((PriCmpbGlineMqcRngVO)getVO(request, PriCmpbGlineMqcRngVO .class));
		}
