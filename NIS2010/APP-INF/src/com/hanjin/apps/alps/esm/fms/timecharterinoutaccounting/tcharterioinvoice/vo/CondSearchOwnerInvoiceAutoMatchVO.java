...
*@FileName : CondSearchOwnerInvoiceAutoMatchVO.java
*@FileTitle : CondSearchOwnerInvoiceAutoMatchVO
*Open Issues :
*Change history :
...
public class CondSearchOwnerInvoiceAutoMatchVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CondSearchOwnerInvoiceAutoMatchVO> models = new ArrayList<CondSearchOwnerInvoiceAutoMatchVO>();
	...
	public CondSearchOwnerInvoiceAutoMatchVO() {}

	public CondSearchOwnerInvoiceAutoMatchVO(String ibflag, String pagerows, String sheetNo, String vslCd, String effDt1, String aproFlg, String stlFlg, String locCd, String effDt2) {
		this.ibflag = ibflag;
	...
	public CondSearchOwnerInvoiceAutoMatchVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CondSearchOwnerInvoiceAutoMatchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CondSearchOwnerInvoiceAutoMatchVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CondSearchOwnerInvoiceAutoMatchVO();
				if (ibflag[i] != null)
	...
	public CondSearchOwnerInvoiceAutoMatchVO[] getCondSearchOwnerInvoiceVOs(){
		CondSearchOwnerInvoiceAutoMatchVO[] vos = (CondSearchOwnerInvoiceAutoMatchVO[])models.toArray(new CondSearchOwnerInvoiceAutoMatchVO[models.size()]);
		return vos;
	}
