 ...
 *@FileName : EMS_PRI_2051HTMLAction.java
...
public class ESM_PRI_2051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2051HTMLAction 객체를 생성
	 */
	public ESM_PRI_2051HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2051Event event = new EsmPri2051Event();
