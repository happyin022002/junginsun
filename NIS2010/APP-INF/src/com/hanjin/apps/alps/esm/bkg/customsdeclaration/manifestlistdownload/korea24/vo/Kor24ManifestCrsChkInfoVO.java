...
*@FileName : Kor24ManifestCrsChkInfoVO.java
*@FileTitle : Kor24ManifestCrsChkInfoVO
*Open Issues :
*Change history :
...
public class Kor24ManifestCrsChkInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ManifestCrsChkInfoVO> models = new ArrayList<Kor24ManifestCrsChkInfoVO>();
	...
	public Kor24ManifestCrsChkInfoVO() {}
...
/**
	 ...
	 */
	public Kor24ManifestCrsChkInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24ManifestCrsChkInfoVO[]
	 */
	public Kor24ManifestCrsChkInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ManifestCrsChkInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new Kor24ManifestCrsChkInfoVO();
				if (inVvd[i] != null)
		...
		return getKor24ManifestCrsChkInfoVOs();
	}
	...
	public Kor24ManifestCrsChkInfoVO[] getKor24ManifestCrsChkInfoVOs(){
		Kor24ManifestCrsChkInfoVO[] vos = (Kor24ManifestCrsChkInfoVO[])models.toArray(new Kor24ManifestCrsChkInfoVO[models.size()]);
		return vos;
	}
