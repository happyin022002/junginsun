...
*@FileName : RsltRfaPRSCMDataVO.java
*@FileTitle : RsltRfaPRSCMDataVO
*Open Issues :
*Change history :
...
public class RsltRfaPRSCMDataVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltRfaPRSCMDataVO> models = new ArrayList<RsltRfaPRSCMDataVO>();
	...
	public RsltRfaPRSCMDataVO() {}

	public RsltRfaPRSCMDataVO(String ibflag, String pagerows, String prsCrntCmAmt, String prsEstmCmAmt) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return RsltRfaPRSCMDataVO[]
	 */
	public RsltRfaPRSCMDataVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltRfaPRSCMDataVO[]
	 */
	public RsltRfaPRSCMDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRfaPRSCMDataVO model = null;
	 ...
	 * @return RsltRfaPRSCMDataVO[]
	 */
	public RsltRfaPRSCMDataVO[] getRsltRfaPRSCMDataVOs(){
		RsltRfaPRSCMDataVO[] vos = (RsltRfaPRSCMDataVO[])models.toArray(new RsltRfaPRSCMDataVO[models.size()]);
		return vos;
	}
