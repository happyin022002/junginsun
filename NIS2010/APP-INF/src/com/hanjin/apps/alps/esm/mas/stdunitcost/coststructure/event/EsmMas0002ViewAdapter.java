...
*@FileName : EsmMas0002ViewAdapter.java
*@FileTitle : EsmMas0002ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmMas0002ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0002ViewAdapter(){
    	super();
    }
	    ...
	    if(totCnt > 0){
	    	try{
	            ...
	            for(int i=0; i<totCnt; i++){
	                ...
	                strBuilder.append("    <TD><![CDATA["+JSPUtil.getNull((String)colValues.get("krn_cost_full_desc"))+"]]></TD>");
    	...
    	try{
		    ...
		    if(totCnt > 0){
	                ...
	                while(rs.next()){
		                ...
		                strBuilder.append("    <TD><![CDATA["+JSPUtil.getNull((String)rs.getString("krn_cost_full_desc"))+"]]></TD>");
