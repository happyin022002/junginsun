...
*@FileName : GeneralBookingSearchDBDAOSearchBlHistSiRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralBookingSearchDBDAOSearchBlHistSiRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralBookingSearchDBDAOSearchBlHistSiRSQL
	  ...
	  * </pre>
	  */
	public GeneralBookingSearchDBDAOSearchBlHistSiRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralBookingSearchDBDAOSearchBlHistSiRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT HIS_SEQ,HIS_DTL_SEQ,ITEM_HDR,HIS_CATE_NM," ).append("\n"); 
		query.append("       TO_CLOB(PRE_CTNT) PRE_CTNT," ).append("\n"); 
		query.append("       TO_CLOB(PRE_CTNT_ORG) PRE_CTNT_ORG," ).append("\n"); 
		query.append("       TO_CLOB(CRNT_CTNT) CRNT_CTNT," ).append("\n"); 
		query.append("       TO_CLOB(CRNT_CTNT_ORG) CRNT_CTNT_ORG," ).append("\n"); 
		query.append("       CRE_USR_ID,OFFICE,CRE_DT,GMT_DT,CORR_NO" ).append("\n"); 
		...
		query.append("        , DECODE(DTL.CRE_USR_ID, 'WEB', DTL.UPD_USR_ID, USR.USR_NM) CRE_USR_ID" ).append("\n"); 
		...
		query.append("ORDER BY 1, 2, 11" ).append("\n"); 
		query.append(") " ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ index_desc(his XPKBKG_HIS_MST)*/" ).append("\n"); 
		query.append("                   HIS_SEQ" ).append("\n"); 
		query.append("              FROM BKG_HIS_MST HIS" ).append("\n"); 
		query.append("             WHERE HIS.BKG_NO = XTM.BKG_NO " ).append("\n"); 
		query.append("               AND HIS.EVNT_DT < XTM.UPLD_DT" ).append("\n"); 
		query.append("               AND ROWNUM = 1), 0) + 1 AS HIS_SEQ," ).append("\n"); 
		query.append("       0 HIS_DTL_SEQ," ).append("\n"); 
		query.append("       'WEB auto upload' AS ITEM_HDR," ).append("\n"); 
		query.append("       'DESCRIPTION OF GOODS' AS HIS_CATE_NM," ).append("\n"); 
		query.append("       CASE WHEN DBMS_LOB.getlength(XTM.OLD_GDS_DESC) > 200 THEN TO_CLOB('View Detail')" ).append("\n"); 
		query.append("            ELSE XTM.OLD_GDS_DESC" ).append("\n"); 
		query.append("       END PRE_CTNT,       " ).append("\n"); 
		query.append("       XTM.OLD_GDS_DESC PRE_CTNT_ORG," ).append("\n"); 
		query.append("       CASE WHEN DBMS_LOB.getlength(BM.CMDT_DESC) > 200 THEN TO_CLOB('View Detail')" ).append("\n"); 
		query.append("            ELSE BM.CMDT_DESC" ).append("\n"); 
		query.append("        END CRNT_CTNT," ).append("\n"); 
		query.append("       XTM.GDS_DESC CRNT_CTNT_ORG," ).append("\n"); 
		query.append("       ''," ).append("\n"); 
		query.append("       ''," ).append("\n"); 
		query.append("       TO_CHAR (XTM.UPLD_DT, 'YYYY-MM-DD HH24:MI') CRE_DT," ).append("\n"); 
		query.append("       TO_CHAR (XTM.UPLD_GDT, 'YYYY-MM-DD HH24:MI') CRE_GDT," ).append("\n"); 
		query.append("       '' CORR_NO" ).append("\n"); 
		query.append("  FROM BKG_XTER_RQST_MST XTM," ).append("\n"); 
		query.append("	   BKG_BL_MK_DESC BM" ).append("\n"); 
		query.append(" WHERE XTM.XTER_SNDR_ID = @[xter_sndr_id]" ).append("\n"); 
		query.append("   AND XTM.XTER_RQST_NO = @[xter_rqst_no]" ).append("\n"); 
		query.append("   AND XTM.XTER_RQST_SEQ = @[xter_rqst_seq]" ).append("\n"); 
		query.append("   AND XTM.BKG_NO = BM.BKG_NO" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT NVL((SELECT /*+ index_desc(his XPKBKG_HIS_MST)*/" ).append("\n"); 
		query.append("                   HIS_SEQ" ).append("\n"); 
		query.append("              FROM BKG_HIS_MST HIS" ).append("\n"); 
		...
		query.append("       0 HIS_DTL_SEQ," ).append("\n"); 
		query.append("       'WEB auto upload' AS ITEM_HDR," ).append("\n"); 
		query.append("       'MARKS' AS HIS_CATE_NM," ).append("\n"); 
		query.append("       CASE WHEN DBMS_LOB.getlength(XTM.OLD_MK_DESC) > 200 THEN TO_CLOB('View Detail')" ).append("\n"); 
		query.append("            ELSE XTM.OLD_MK_DESC" ).append("\n"); 
		query.append("       END PRE_CTNT,   " ).append("\n"); 
		query.append("       XTM.OLD_MK_DESC PRE_CTNT_ORG," ).append("\n"); 
		query.append("       CASE WHEN DBMS_LOB.getlength(BM.MK_DESC) > 200 THEN TO_CLOB('View Detail')" ).append("\n"); 
		query.append("            ELSE BM.MK_DESC" ).append("\n"); 
		query.append("        END CRNT_CTNT," ).append("\n"); 
		query.append("       BM.MK_DESC CRNT_CTNT_ORG," ).append("\n"); 
		query.append("       ' '," ).append("\n"); 
		query.append("       ' '," ).append("\n"); 
		query.append("       TO_CHAR (XTM.UPLD_DT, 'YYYY-MM-DD HH24:MI') CRE_DT," ).append("\n"); 
		query.append("       TO_CHAR (XTM.UPLD_GDT, 'YYYY-MM-DD HH24:MI') CRE_GDT," ).append("\n"); 
		...
		query.append("   AND XTM.XTER_RQST_SEQ = @[xter_rqst_seq]" ).append("\n"); 
		query.append("    AND XTM.BKG_NO = BM.BKG_NO" ).append("\n"); 
		query.append("ORDER BY 1 DESC, 2, 11" ).append("\n"); 
