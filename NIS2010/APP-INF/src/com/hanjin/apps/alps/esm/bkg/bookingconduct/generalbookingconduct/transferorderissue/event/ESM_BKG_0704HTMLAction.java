...
public class ESM_BKG_0704HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		/* param */
    	String bkgNo    = JSPUtil.getParameter(request, "bkg_no".trim(),     "");
    	String bkgStsCd = JSPUtil.getParameter(request, "bkg_sts_cd".trim(), "");

    	EsmBkg0704Event event = new EsmBkg0704Event(bkgNo, bkgStsCd);
