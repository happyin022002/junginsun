...
*@FileTitle : <Kor24MakeSubNoVO.java
*@FileTitle : Kor24MakeSubNoVO
*Open Issues :
*Change history :
...
public class Kor24MakeSubNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24MakeSubNoVO> models = new ArrayList<Kor24MakeSubNoVO>();
	...
	public Kor24MakeSubNoVO() {}

	public Kor24MakeSubNoVO(String ibflag, String pagerows, String subNo, String vvd, String ioBndCd, String podLoc, String polLoc) {
		this.vvd = vvd;
		this.ibflag = ibflag;
		this.polLoc = polLoc;
		this.subNo = subNo;
	 ...
	 * @param request
	 * @return Kor24MakeSubNoVO[]
	 */
	public Kor24MakeSubNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24MakeSubNoVO[]
	 */
	public Kor24MakeSubNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24MakeSubNoVO model = null;
	 ...
	 * @return Kor24MakeSubNoVO[]
	 */
	public Kor24MakeSubNoVO[] getKor24MakeSubNoVOs(){
		Kor24MakeSubNoVO[] vos = (Kor24MakeSubNoVO[])models.toArray(new Kor24MakeSubNoVO[models.size()]);
		return vos;
	}
