...
*@FileName : ESM_SPC_0033HTMLAction.java
...
public class ESM_SPC_0033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0033HTMLAction 객체를 생성
	 */
	public ESM_SPC_0033HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EsmSpc0033Event event = new EsmSpc0033Event();
		
		event.setSearchSpaceAllocation0033LaneRgstVO((SearchSpaceAllocation0033LaneRgstVO)getVO(request, SearchSpaceAllocation0033LaneRgstVO .class));
		event.setSearchSpaceAllocation0033LaneRgstVOS((SearchSpaceAllocation0033LaneRgstVO[])getVOs(request, SearchSpaceAllocation0033LaneRgstVO .class,""));
