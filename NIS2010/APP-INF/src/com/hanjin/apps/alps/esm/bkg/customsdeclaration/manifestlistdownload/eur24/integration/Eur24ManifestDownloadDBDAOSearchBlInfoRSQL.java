...
public class Eur24ManifestDownloadDBDAOSearchBlInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("					   AND CLPT_IND_SEQ  = NVL( XXX.EU_1ST_PORT_CLPT_SEQ,'1')" ).append("\n"); 
		query.append("                       AND ROWNUM = 1" ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		...
		query.append("						(" ).append("\n"); 
		query.append("							DECODE(NVL(NISADM.BKG_GET_TOKEN_FNC(TOT_CM_DATA,6),0),0,'N','Y') ='N' " ).append("\n"); 
		query.append("							OR NVL(NISADM.BKG_GET_TOKEN_FNC(TOT_CM_DATA,6),0) != NVL(NISADM.BKG_GET_TOKEN_FNC(TOT_CM_DATA,7),0)" ).append("\n"); 
		query.append("						)" ).append("\n"); 
		...
		query.append("				ELSE DECODE(NVL(NISADM.BKG_GET_TOKEN_FNC(TOT_CM_DATA,6),0),0,'N','Y')" ).append("\n"); 
		...
		query.append("			      AND    CLPT_IND_SEQ = NVL( BL.CSTMS_CLPT_IND_SEQ, '1')" ).append("\n"); 
		...
		query.append("          WHERE MSG_RCV_NO = (SELECT MAX(MSG_SND_NO) MSG_SND_NO" ).append("\n"); 
		...
		query.append("  NVL(BL.CSTMS_CLPT_IND_SEQ,'1') AS EU_1ST_PORT_CLPT_SEQ," ).append("\n"); 
