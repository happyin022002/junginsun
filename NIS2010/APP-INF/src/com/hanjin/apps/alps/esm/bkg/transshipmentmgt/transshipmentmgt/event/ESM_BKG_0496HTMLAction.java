...
*@FileName : ESM_BKG_0496HTMLAction.java
...
public class ESM_BKG_0496HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0496HTMLAction 객체를 생성
	 */
	public ESM_BKG_0496HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0496Event event = new EsmBkg0496Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTSRemainListInputVO((TSRemainListInputVO)getVO(request, TSRemainListInputVO .class));
		}
