...
*@FileName       : ESM_SQM_0007HTMLAction.java
 ...
 * @author JEONGMIN CHO
 * @see EsmSqm0007Event 참조
 * @since J2EE 1.6
 */

public class ESM_SQM_0007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SQM_0007HTMLAction 객체를 생성
	 */
	public ESM_SQM_0007HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmSqm0007Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSqm0007Event event = new EsmSqm0007Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setSqmQtaOfcVOS((SqmQtaOfcVO[])getVOs(request, SqmQtaOfcVO .class,""));
		}
