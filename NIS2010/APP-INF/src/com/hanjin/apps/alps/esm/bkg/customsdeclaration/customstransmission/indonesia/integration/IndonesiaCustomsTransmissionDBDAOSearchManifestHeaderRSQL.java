...
public class IndonesiaCustomsTransmissionDBDAOSearchManifestHeaderRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("MAX(DECODE(C.CLPT_SEQ, B.LAST_CLPT_SEQ, TO_CHAR(C.VPS_ETA_DT, 'YYYYMMDDHHMISS'), NULL)) AS LAST_CLPT_ETA_DT" ).append("\n"); 
		...
		query.append("MIN(DECODE(B.VPS_PORT_CD, @[port_cd], B.CLPT_SEQ, NULL)) PORT_CLPT_SEQ" ).append("\n"); 
