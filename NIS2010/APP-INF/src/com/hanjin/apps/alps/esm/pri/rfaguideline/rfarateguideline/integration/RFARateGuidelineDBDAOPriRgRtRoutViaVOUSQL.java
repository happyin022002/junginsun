...
*@FileName : RFARateGuidelineDBDAOPriRgRtRoutViaVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateGuidelineDBDAOPriRgRtRoutViaVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateGuidelineDBDAOPriRgRtRoutViaVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateGuidelineDBDAOPriRgRtRoutViaVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RG_RT_ROUT_VIA" ).append("\n"); 
		query.append("SET ROUT_VIA_PORT_TP_CD  = @[rout_via_port_tp_cd]" ).append("\n"); 
