...
*@FileName : TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdSummaryDischargingRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdSummaryDischargingRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdSummaryDischargingRSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOInquiryDBDAOSearchRfStatusInquiryByVvdSummaryDischargingRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    SELECT COUNT(C.ID) AS discharging " ).append("\n"); 
		...
		query.append("    GROUP BY C.PORT_CD, C.CALL_IND" ).append("\n"); 
