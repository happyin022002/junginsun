...
*@FileName : AGNCommApprovalDBDAOModifyCsrHeaderAcmAgnOtrComm3InfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGNCommApprovalDBDAOModifyCsrHeaderAcmAgnOtrComm3InfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GW기안시(P) AL을 PS로 업데이트
	  * </pre>
	  */
	public AGNCommApprovalDBDAOModifyCsrHeaderAcmAgnOtrComm3InfoUSQL(){
		setQuery();
		...
		query.append("FileName : AGNCommApprovalDBDAOModifyCsrHeaderAcmAgnOtrComm3InfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  AND A.AC_STS_CD = 'AL'" ).append("\n"); 
