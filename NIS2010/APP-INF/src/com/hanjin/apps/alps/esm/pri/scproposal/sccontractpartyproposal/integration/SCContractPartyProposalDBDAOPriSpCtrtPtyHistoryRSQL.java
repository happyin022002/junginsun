...
*@FileName : SCContractPartyProposalDBDAOPriSpCtrtPtyHistoryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCContractPartyProposalDBDAOPriSpCtrtPtyHistoryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SC Contract Party Amend History 조회
	  * 2012.02.23 이석준[CHM-201216153-01] S/C Amendment History 화면 기능 개선 요청
	  * </pre>
	  */
	public SCContractPartyProposalDBDAOPriSpCtrtPtyHistoryRSQL(){
		setQuery();
		...
		query.append("FileName : SCContractPartyProposalDBDAOPriSpCtrtPtyHistoryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    (SELECT USR_NM FROM COM_USER WHERE USR_ID = A.ACPT_USR_ID)||' / '||A.ACPT_OFC_CD ACPT_USR_ID," ).append("\n"); 
