...
*@FileName : ESM_BKG_1156HTMLAction.java
...
public class ESM_BKG_1156HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1156HTMLAction 객체를 생성
	 */
	public ESM_BKG_1156HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1156Event event = new EsmBkg1156Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGso  (JSPUtil.getParameter(request, "gso"));
		}
