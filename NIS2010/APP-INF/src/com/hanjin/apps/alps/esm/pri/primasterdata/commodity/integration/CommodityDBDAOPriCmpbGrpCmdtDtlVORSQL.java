...
*@FileName : CommodityDBDAOPriCmpbGrpCmdtDtlVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOPriCmpbGrpCmdtDtlVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_CMPB_GRP_CMDT_DTL 테이블 조회
	  * </pre>
	  */
	public CommodityDBDAOPriCmpbGrpCmdtDtlVORSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOPriCmpbGrpCmdtDtlVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
