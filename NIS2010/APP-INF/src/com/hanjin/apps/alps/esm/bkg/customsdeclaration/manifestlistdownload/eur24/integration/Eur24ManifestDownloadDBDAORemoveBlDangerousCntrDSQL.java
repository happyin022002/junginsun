...
*@FileName : Eur24ManifestDownloadDBDAORemoveBlDangerousCntrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAORemoveBlDangerousCntrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAORemoveBlDangerousCntrDSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAORemoveBlDangerousCntrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BKG_CSTMS_EUR_DG_CGO" ).append("\n"); 
