...
*@FileName : Kor24CustomsTransmissionDBDAOmodifyCUSREPSndLogUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOmodifyCUSREPSndLogUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOmodifyCUSREPSndLogUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOmodifyCUSREPSndLogUSQL").append("\n");
		query.append("*/").append("\n");
	}
