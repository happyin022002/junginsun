...
*@FileName : BlRatingDBDAOSearchBkgRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BlRatingDBDAOSearchBkgRateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BlRatingDBDAOSearchBkgRateRSQL(){
		setQuery();
		...
		query.append("FileName : BlRatingDBDAOSearchBkgRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",REV_AUD_DT" ).append("\n"); 
