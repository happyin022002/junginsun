...
*@FileName : ESM_MAS_0114HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author Kim Ki Dae
 * @see EsmMas0114Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0114HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0114HTMLAction 객체를 생성
	 */
	public ESM_MAS_0114HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0114Event event = new EsmMas0114Event();  		
