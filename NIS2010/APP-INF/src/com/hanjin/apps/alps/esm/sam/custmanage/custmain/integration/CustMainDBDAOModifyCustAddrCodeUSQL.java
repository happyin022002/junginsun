...
*@FileName : CustMainDBDAOModifyCustAddrCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustMainDBDAOModifyCustAddrCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustMainDBDAOModifyCustAddrCodeUSQL(){
		setQuery();
		...
		query.append("FileName : CustMainDBDAOModifyCustAddrCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   " ).append("\n"); 
		query.append("   BZET_NM          = @[bzet_nm]" ).append("\n"); 
		...
		query.append(",  PRMRY_CHK_FLG	= decode(@[prmry_chk_flg],'1','Y',null,'N','0','N',@[prmry_chk_flg])" ).append("\n"); 
