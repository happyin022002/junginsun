...
*@FileName : NetworkDistributionDBDAOApplyToPLOP41CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class NetworkDistributionDBDAOApplyToPLOP41CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public NetworkDistributionDBDAOApplyToPLOP41CSQL(){
		setQuery();
		...
		query.append("FileName : NetworkDistributionDBDAOApplyToPLOP41CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MAS_PFIT_LSS_SMRY C1 USING " ).append("\n"); 
		...
		query.append("	      , B1.ESTM_PL_AMT " ).append("\n"); 
		query.append("	      , B1.HJS_SLS_AMT " ).append("\n"); 
		query.append("	      , B1.CO_AMT " ).append("\n"); 
		query.append("	      , B2.OP_LANE_TP_CD " ).append("\n"); 
		query.append("	      , @[upd_usr_id] UPD_USR_ID " ).append("\n"); 
		query.append("	      , SYSDATE UPD_DT " ).append("\n"); 
		query.append("	FROM    MAS_PFIT_LSS_SMRY B1 " ).append("\n"); 
		...
		query.append("	   SET C1.N4TH_ESTM_PL_AMT = C2.ESTM_PL_AMT " ).append("\n"); 
		query.append("	      ,C1.N4TH_HJS_SLS_AMT = C2.HJS_SLS_AMT " ).append("\n"); 
		query.append("	      ,C1.N4TH_CO_AMT      = C2.CO_AMT " ).append("\n"); 
