...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op6ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op6ListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op6ListRSQL(){
		setQuery();
		...
		params.put("f_iskorean_a",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased4Op6ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, CASE  WHEN @[f_op_view] ='OP1' AND C2.RPT_ITM_DESC = 'OPCOST01' THEN 'OP Cost Total(OP5)'" ).append("\n"); 
		query.append("			WHEN @[f_op_view] ='OP1' AND C2.RPT_ITM_DESC = 'OPCOST02' THEN 'OP-OP5'" ).append("\n"); 
		query.append("			WHEN @[f_op_view] ='OP4' AND C2.RPT_ITM_DESC = 'OPCOST01' THEN 'OP Cost Total(OP6)'" ).append("\n"); 
		query.append("			WHEN @[f_op_view] ='OP4' AND C2.RPT_ITM_DESC = 'OPCOST02' THEN 'OP4-OP6'" ).append("\n"); 
		query.append("			WHEN @[f_op_view] ='OP5' AND C2.RPT_ITM_DESC = 'OPCOST01' THEN 'OP Cost Total(OP5)'" ).append("\n"); 
		query.append("			WHEN @[f_op_view] ='OP6' AND C2.RPT_ITM_DESC = 'OPCOST01' THEN 'OP Cost Total(OP6)'" ).append("\n"); 
		query.append("			ELSE  C2.RPT_ITM_DESC END AS RPT_ITM_DESC" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,C2.RPT_ITM_COLR_FLG " ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		#foreach($key in ${allcols}) " ).append("\n"); 
		query.append("			,SUM(CASE WHEN (C2.TRD_CD = '$key' AND C2.HUL_BND_CD = 'HH') THEN NVL (C1.AMT, 0) ELSE 0 END) AS HH_AMT$velocityCount" ).append("\n"); 
		query.append("			,SUM(CASE WHEN (C2.TRD_CD = '$key' AND C2.HUL_BND_CD = 'BH') THEN NVL (C1.AMT, 0) ELSE 0 END) AS BH_AMT$velocityCount" ).append("\n"); 
		query.append("			,SUM(CASE WHEN (C2.TRD_CD = '$key' AND C2.HUL_BND_CD = 'M') THEN NVL (C1.AMT, 0) ELSE 0 END) AS DIR_M_AMT$velocityCount" ).append("\n"); 
		query.append("			,SUM(CASE WHEN  C2.TRD_CD = '$key' THEN NVL (C1.AMT, 0) ELSE 0 END) AS TRD_AMT$velocityCount" ).append("\n"); 
		query.append("		#end " ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		,SUM(CASE WHEN  C2.TRD_CD = 'COM' THEN NVL (C1.AMT, 0) ELSE 0 END) AS COM_AMT" ).append("\n"); 
		...
		query.append("							 , 'LOAD0000', DECODE(SUBSTR (B2.CNTR_TPSZ_CD, -1),'2', B2.N6TH_ESTM_PL_AMT, '3', B2.N6TH_ESTM_PL_AMT, B2.N6TH_ESTM_PL_AMT * 2)" ).append("\n"); 
		query.append("							 , 'BSA00000', B2.N6TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("							 , DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz]" ).append("\n"); 
		query.append("                                    , 'O|CHT', B2.N6TH_CO_AMT" ).append("\n"); 
		query.append("                                    , 'O|BIZ', DECODE(B2.STND_COST_CD, '51102000', B2.ADJ_N6TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , '51302000', B2.ADJ_N6TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , '65000000', B2.ADJ_N6TH_HJS_SLS_AMT" ).append("\n"); 
		query.append("                                                                     , B2.N6TH_HJS_SLS_AMT)" ).append("\n"); 
		query.append("                                    , DECODE(B2.STND_COST_CD, '51102000', B2.ADJ_N6TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , '51302000', B2.ADJ_N6TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , '65000000', B2.ADJ_N6TH_ESTM_PL_AMT" ).append("\n"); 
		query.append("                                                            , B2.N6TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("							 ) " ).append("\n"); 
		...
		query.append("							 ) " ).append("\n"); 
		query.append("					 ) " ).append("\n"); 
		query.append("			) + NVL(SUM (B2.N6TH_ADJ_OTR_FNL_AMT),0) AS AMT " ).append("\n"); 
		...
		query.append("			,COA_OFC_LVL B4 " ).append("\n"); 
		query.append("            , COA_LANE_RGST R" ).append("\n"); 
		query.append("			,COA_VVD_HIR V" ).append("\n"); 
		query.append("		WHERE B1.VSL_CD        = B2.VSL_CD " ).append("\n"); 
		query.append("			AND B1.SKD_VOY_NO    = B2.SKD_VOY_NO " ).append("\n"); 
		query.append("			AND B1.DIR_CD        = B2.SKD_DIR_CD " ).append("\n"); 
		query.append("			AND B1.TRD_CD        = B2.TRD_CD " ).append("\n"); 
		...
		query.append("		#end			" ).append("\n"); 
		query.append("       GROUP BY A1.STND_COST_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		 UNION ALL " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${f_year} < 2014)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		 /*-- Other Expense ---*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("         SELECT A1.TRD_CD" ).append("\n"); 
		query.append("              , A1.DIR_CD AS HUL_BND_CD" ).append("\n"); 
		query.append("              , A2.STND_COST_CD" ).append("\n"); 
		query.append("              , SUM(DECODE(A1.RLANE_CD, SUBSTR(A2.STND_COST_CD, 1, 5), A1.OTR_EXPN_AMT)) AS AMT" ).append("\n"); 
		query.append("           FROM COA_MNL_COST_STUP A1" ).append("\n"); 
		...
		query.append("		    #end         " ).append("\n"); 
		query.append("			#if(${f_ias_rgn_cd} !='') " ).append("\n"); 
		query.append("				AND 'XX' = @[f_ias_rgn_cd] " ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("			#if(${f_trd_dir_cd} !='') " ).append("\n"); 
		query.append("				AND 'XX' = @[f_trd_dir_cd] " ).append("\n"); 
		query.append("			#end      " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("            AND A2.STND_COST_TP_CD = 'U'" ).append("\n"); 
		query.append("            AND A2.RPT_VW_CD       = 'P'" ).append("\n"); 
		query.append("            AND A1.RLANE_CD        = SUBSTR(A2.STND_COST_CD, 1, 5)" ).append("\n"); 
		query.append("            AND A1.COST_WK <> 'XX' " ).append("\n"); 
		query.append("            AND A1.RLANE_CD <>  'MTYTT'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	UNION ALL" ).append("\n"); 
		query.append("		   /*-- ABC/STP 비용집계 ---*/" ).append("\n"); 
		query.append("		SELECT   /*+ ORDERED */" ).append("\n"); 
		query.append("			 B1.TRD_CD " ).append("\n"); 
		query.append("			,R.HUL_BND_CD" ).append("\n"); 
		...
		query.append("		FROM COA_MON_VVD B1 " ).append("\n"); 
		query.append("			,COA_PFIT_LSS_SVC_TRNS_PRC B2 " ).append("\n"); 
		query.append("			,COA_PFIT_LSS_RPT_ITM B3 " ).append("\n"); 
		query.append("			,COA_OFC_LVL B4 " ).append("\n"); 
		query.append("            , COA_LANE_RGST R" ).append("\n"); 
		query.append("		WHERE B1.VSL_CD        = B2.VSL_CD " ).append("\n"); 
		...
		query.append("			              ,'P', (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) - VSL_CHTR_REV " ).append("\n"); 
		query.append("			              ,'R', DECODE (@[f_ofc_lvl] " ).append("\n"); 
		query.append("			                           ,'1', (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) - VSL_CHTR_REV /* DEM/DET 비용삭제 */ " ).append("\n"); 
		query.append("			                           , (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) - VSL_CHTR_REV " ).append("\n"); 
		query.append("			                           ) " ).append("\n"); 
		query.append("			              )   /* CMCTOTAL (CM(Net Revenue) Total) */" ).append("\n"); 
		query.append("			   ,10, DECODE (LOAD_TEU " ).append("\n"); 
		query.append("			               ,0, 0 " ).append("\n"); 
		query.append("			               , (DECODE (@[f_pro_vw] " ).append("\n"); 
		query.append("			                           ,'P', (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) " ).append("\n"); 
		query.append("			                           ,'R', DECODE (@[f_ofc_lvl] " ).append("\n"); 
		query.append("			                                        ,'1', (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) " ).append("\n"); 
		query.append("			                                        , (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) " ).append("\n"); 
		query.append("			                                        ) " ).append("\n"); 
		query.append("			                           ) " ).append("\n"); 
		query.append("			                   / LOAD_TEU " ).append("\n"); 
		query.append("			                 ) " ).append("\n"); 
		query.append("			               )   /* CMB00000 (CM(Net Revenue)/TEU) */ " ).append("\n"); 
		...
		query.append("			   ,16, ((INCOME_TOTAL - CM_COST) - N6TH_ESTM_PL_AMT - N6TH_CO_AMT - CMMT_COST - INTER_TS)   /* CMMT0001 */ " ).append("\n"); 
		query.append("			   ,17, DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("			               ,'P', 0 " ).append("\n"); 
		query.append("			               ,'R', DECODE(@[f_ofc_vw],'L', 0, 'C', DECODE (@[f_ofc_lvl],'1', 0, (INCOME_TOTAL - DEM_DET) - (CM_COST + SPC_CHTR) + (STP_REV-ABC_OTH_COND) + (ABC_OTH - STP_COST))) " ).append("\n"); 
		...
		query.append("				,SUM (ABC_OTH) ABC_OTH  /*65901021 ABC FOR STP EXPENSE(MINUS COST)*/" ).append("\n"); 
		...
		query.append("				,SUM (N6TH_ESTM_PL_AMT) N6TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("				,SUM (N6TH_CO_AMT) N6TH_CO_AMT " ).append("\n"); 
		...
		query.append("					,NVL(SUM(DECODE(A3.STND_COST_CD,'BSA00000', DECODE (@[f_pro_vw],'P', A2.N6TH_ESTM_PL_AMT,'R', A2.RA_PL_AMT),0)),0) AS SUPPLY " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		query.append("					                 ,'LOAD0000', DECODE (@[f_pro_vw] " ).append("\n"); 
		query.append("					                                     ,'P', DECODE(SUBSTR(A2.CNTR_TPSZ_CD,-1),'2', A2.N6TH_ESTM_PL_AMT, '3', A2.N6TH_ESTM_PL_AMT, A2.N6TH_ESTM_PL_AMT * 2) " ).append("\n"); 
		...
		query.append("					                                     ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT, A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		...
		query.append("					           WHEN A3.STND_COST_CD IN ('43102011', '43201011', '43207011') THEN " ).append("\n"); 
		query.append("					           			DECODE (@[f_pro_vw] " ).append("\n"); 
		query.append("                                           ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT, A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("                                           ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		...
		query.append("					,NVL(SUM(CASE " ).append("\n"); 
		query.append("					           WHEN A3.STND_COST_CD IN ('43102011') THEN " ).append("\n"); 
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("                                           ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("                                           ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		...
		query.append("					                              ,DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("					                                      ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ'," ).append("\n"); 
		query.append("                                                    DECODE(A3.STND_COST_CD, '51102000', A2.ADJ_N6TH_HJS_SLS_AMT, '51302000', A2.ADJ_N6TH_HJS_SLS_AMT, A2.N6TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                                    DECODE(A3.STND_COST_CD, '51102000', A2.ADJ_N6TH_ESTM_PL_AMT, '51302000', A2.ADJ_N6TH_ESTM_PL_AMT, A2.N6TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("					                                      ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                                      ) " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					           WHEN A3.STND_COST_CD IN ('65901011') THEN " ).append("\n"); 
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("                                           ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("                                           ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		...
		query.append("					   (SUM " ).append("\n"); 
		query.append("					       (CASE " ).append("\n"); 
		query.append("					           WHEN A3.STND_COST_CD IN ('92404011') THEN " ).append("\n"); 
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("                                           ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("                                           ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		...
		query.append("					   (SUM " ).append("\n"); 
		query.append("					       (CASE " ).append("\n"); 
		query.append("					           WHEN A3.STND_COST_CD IN ('65901021') THEN " ).append("\n"); 
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("                                           ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("                                           ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		...
		query.append("					                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ' ,               " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N6TH_HJS_SLS_AMT, A2.N6TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N6TH_ESTM_PL_AMT, A2.N6TH_ESTM_PL_AMT)) " ).append("\n"); 
		query.append("					                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ,0 " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    )  + NVL(SUM (A2.N6TH_ADJ_OTR_FNL_AMT),0) AS OP_COST " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) AS N6TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("					         ) " ).append("\n"); 
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) AS N6TH_CO_AMT " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		...
		query.append("					   (SUM " ).append("\n"); 
		query.append("					       (CASE " ).append("\n"); 
		query.append("					           WHEN A3.STND_COST_CD IN ('92202013','92202014') THEN " ).append("\n"); 
		query.append("					           		DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("                                           ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("                                           ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("                                           ) " ).append("\n"); 
		...
		query.append("				         ) " ).append("\n"); 
		query.append("				    ,0 " ).append("\n"); 
		query.append("				    ) + NVL(SUM (A2.N6TH_ADJ_OTR_FNL_AMT),0) AS OP_COST01 " ).append("\n"); 
		query.append("                    ,0 AS BU_COST" ).append("\n"); 
		query.append("                    -- Initial Network Cost" ).append("\n"); 
		query.append("                    , SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM COA_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                               THEN NVL(A2.N6TH_HJS_SLS_AMT,0) + NVL(A2.N6TH_CO_AMT,0) - NVL(A2.N6TH_ASGN_AMT,0) ELSE 0 END) INIT_COST" ).append("\n"); 
		query.append("                    -- T/S Cost Amount" ).append("\n"); 
		query.append("                    , SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM COA_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                               THEN A2.N6TH_ASGN_AMT ELSE 0 END) TS_ALOC" ).append("\n"); 
		...
		query.append("					                              ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ' ,               " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N6TH_HJS_SLS_AMT, A2.N6TH_HJS_SLS_AMT), " ).append("\n"); 
		query.append("                                            DECODE(A3.STND_COST_CD, '65000000', A2.ADJ_N6TH_ESTM_PL_AMT, V.NTWK_HIR_COST_AMT)) " ).append("\n"); 
		query.append("					                              ,'R', A2.RA_PL_AMT " ).append("\n"); 
		query.append("					                              ) " ).append("\n"); 
		query.append("					                 ,0 " ).append("\n"); 
		query.append("					                 ) " ).append("\n"); 
		...
		query.append("					    ,0 " ).append("\n"); 
		query.append("					    ) + SUM(CASE WHEN A3.STND_COST_CD IN ( SELECT STND_COST_CD FROM COA_STND_ACCT WHERE MGRP_COST_CD IN ('OV', 'OF') AND STND_COST_CD <> '54600000') " ).append("\n"); 
		query.append("                               THEN A2.N6TH_ASGN_AMT ELSE 0 END) AS OP_COST " ).append("\n"); 
		query.append("					,NVL (SUM (DECODE (A3.STND_COST_CD " ).append("\n"); 
		query.append("					                 ,'TSCTRB00', DECODE (@[f_pro_vw]" ).append("\n"); 
		query.append("					                                     ,'P', DECODE(@[f_pro_lvl]||'|'||@[f_chtbiz],'O|CHT', A2.N6TH_CO_AMT,'O|BIZ', A2.N6TH_HJS_SLS_AMT,A2.N6TH_ESTM_PL_AMT) " ).append("\n"); 
		query.append("					                                     ,'R', A2.RA_PL_AMT " ).append("\n"); 
		...
		query.append("#if(${f_year} < 2014)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("					/* STE REV, ABC OTH */" ).append("\n"); 
		query.append("				SELECT    /*+ ORDERED */  " ).append("\n"); 
		query.append("					 A1.TRD_CD " ).append("\n"); 
		query.append("                    ,R.HUL_BND_CD" ).append("\n"); 
		query.append("					,0 AS VOYAGE " ).append("\n"); 
		...
		query.append("					,0 N6TH_ESTM_PL_AMT " ).append("\n"); 
		query.append("					,0 AS N6TH_CO_AMT " ).append("\n"); 
		...
		query.append("					, 0 AS VSL_CHTR_REV" ).append("\n"); 
		query.append("					FROM COA_MON_VVD A1 " ).append("\n"); 
		query.append("						,COA_PFIT_LSS_SVC_TRNS_PRC A2 " ).append("\n"); 
		query.append("						,COA_PFIT_LSS_RPT_ITM A3 " ).append("\n"); 
		query.append("						,COA_OFC_LVL A4 " ).append("\n"); 
		query.append("					    , COA_LANE_RGST R" ).append("\n"); 
		query.append("					WHERE A1.VSL_CD        = A2.VSL_CD " ).append("\n"); 
		...
		query.append("                      , 0 AS DEM_DET" ).append("\n"); 
		query.append("                      , 0 AS OP_COST01" ).append("\n"); 
		query.append("                      , SUM(OTR_EXPN_AMT) BU_COST" ).append("\n"); 
		query.append("					  , 0 AS INIT_COST		-- Initial Network Cost" ).append("\n"); 
		query.append("					  , 0 AS TS_ALOC		-- T/S Cost Amount" ).append("\n"); 
		query.append("					  , 0 AS GEN_EXPN" ).append("\n"); 
		query.append("					  , 0 AS VSL_CHTR_REV" ).append("\n"); 
		...
		query.append("				#end	                " ).append("\n"); 
		query.append("						       " ).append("\n"); 
		query.append("				GROUP BY A1.TRD_CD, L1.HUL_BND_CD " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("              UNION ALL" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("					) " ).append("\n"); 
		query.append("				GROUP BY TRD_CD, HUL_BND_CD" ).append("\n"); 
		query.append("				) B1 " ).append("\n"); 
		query.append("				, (SELECT CPY_NO AS RNUM " ).append("\n"); 
		query.append("					FROM COM_CPY_NO " ).append("\n"); 
		query.append("					WHERE CPY_NO BETWEEN 1 AND 31" ).append("\n"); 
		...
		query.append("					,DECODE (@[f_iskorean_a], '1', A2.SGRP_KR_DESC, A2.SGRP_COST_CD_DESC) SGRP_COST_CD_DESC   /*조건:한글여부 //f_isKorean */" ).append("\n"); 
		query.append("					,DECODE (@[f_iskorean_a], '1', A2.KR_RPT_ITM_DESC, A2.RPT_ITM_DESC) RPT_ITM_DESC " ).append("\n"); 
		query.append("					,A2.RPT_DP_SEQ " ).append("\n"); 
		query.append("					,A2.RPT_ITM_COLR_FLG " ).append("\n"); 
		query.append("				FROM ( " ).append("\n"); 
		query.append("					 SELECT DISTINCT TRD_CD, HUL_BND_CD FROM COA_LANE_RGST WHERE DELT_FLG = 'N' UNION ALL" ).append("\n"); 
		query.append("                     SELECT DISTINCT TRD_CD, 'M' HUL_BND_CD FROM COA_LANE_RGST WHERE DELT_FLG = 'N' UNION ALL" ).append("\n"); 
		...
		query.append("		" ).append("\n"); 
		query.append("				#if(${f_pro_vw} =='P' && ${f_pro_lvl} =='O')" ).append("\n"); 
		query.append("					AND (a2.stnd_cost_tp_cd IN ('S','C','O','U',@[str_display])  /* f_pro_obj P->O,A,B */" ).append("\n"); 
