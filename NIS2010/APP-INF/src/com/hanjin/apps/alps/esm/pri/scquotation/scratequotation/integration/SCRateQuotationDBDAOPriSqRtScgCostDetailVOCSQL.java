...
*@FileName : SCRateQuotationDBDAOPriSqRtScgCostDetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtScgCostDetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtScgCostDetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtScgCostDetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          PRI_SQ_RT_CMDT_ROUT     RD  ," ).append("\n"); 
		query.append("          PRI_SQ_RT_USD_ROUT_CS   RR  ," ).append("\n"); 
		...
		query.append("    FN.GEN_SPCL_RT_TP_CD AS GEN_SPCL_RT_TP_CD," ).append("\n"); 
		...
		query.append("    (A.QTTN_NO, A.QTTN_VER_NO, A.GEN_SPCL_RT_TP_CD, A.CMDT_HDR_SEQ, A.ROUT_SEQ, A.RT_SEQ," ).append("\n"); 
		...
		query.append("    (B.QTTN_NO, B.QTTN_VER_NO, B.GEN_SPCL_RT_TP_CD, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.RT_SEQ," ).append("\n"); 
