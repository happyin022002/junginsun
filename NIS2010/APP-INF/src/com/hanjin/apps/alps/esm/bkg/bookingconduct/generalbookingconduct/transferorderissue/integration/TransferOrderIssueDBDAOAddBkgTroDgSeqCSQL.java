...
*@FileName : TransferOrderIssueDBDAOAddBkgTroDgSeqCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class TransferOrderIssueDBDAOAddBkgTroDgSeqCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TransferOrderIssueDBDAOAddBkgTroDgSeqCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO BKG_TRO_DG_SEQ (" ).append("\n");
		...
		query.append(",	@[rtn_tro_flg]" ).append("\n");
		query.append(",	@[tro_seq]" ).append("\n");
		query.append(",    NVL((SELECT /*+ INDEX_DESC(BKG_TRO_DG_SEQ XPKBKG_TRO_DG_SEQ) */" ).append("\n");
		query.append("TRO_DCGO_SEQ" ).append("\n");
		query.append("FROM BKG_TRO_DG_SEQ" ).append("\n");
		...
		query.append("FileName : TransferOrderIssueDBDAOAddBkgTroDgSeqCSQL").append("\n");
		query.append("*/").append("\n");
	}
}