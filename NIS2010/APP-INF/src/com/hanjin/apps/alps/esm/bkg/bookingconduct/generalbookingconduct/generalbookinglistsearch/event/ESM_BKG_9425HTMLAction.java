...
*@FileName : ESM_BKG_9425HTMLAction.java
...
public class ESM_BKG_9425HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_9425HTMLAction 객체를 생성
	 */
	public ESM_BKG_9425HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg9425Event event = new EsmBkg9425Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.COMMAND01)) {
			event.setEmptyBkgListInputVO((EmptyBkgListInputVO)getVO(request, EmptyBkgListInputVO .class));
		}
