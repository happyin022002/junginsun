...
*@FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtRoutPntCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOGlineCopyPriRpScpRtRoutPntCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOGlineCopyPriRpScpRtRoutPntCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOGlineCopyPriRpScpRtRoutPntCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, A.CMDT_HDR_SEQ" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, A.CMDT_HDR_SEQ, B.ROUT_SEQ) AS ROUT_SEQ" ).append("\n"); 
		...
		query.append(", DENSE_RANK() OVER (PARTITION BY B.SVC_SCP_CD, B.GLINE_SEQ, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("ORDER BY B.SVC_SCP_CD, B.GLINE_SEQ, B.CMDT_HDR_SEQ, B.ROUT_SEQ, B.ORG_DEST_TP_CD, B.ROUT_PNT_SEQ) AS ROUT_PNT_SEQ" ).append("\n"); 
		...
		query.append("FROM ROUT A" ).append("\n"); 
