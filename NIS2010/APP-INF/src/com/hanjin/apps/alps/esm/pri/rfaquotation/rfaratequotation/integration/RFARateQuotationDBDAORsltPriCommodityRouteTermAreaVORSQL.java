...
*@FileName : RFARateQuotationDBDAORsltPriCommodityRouteTermAreaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltPriCommodityRouteTermAreaVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltPriCommodityRouteTermAreaVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltPriCommodityRouteTermAreaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",(SELECT MDM_TERM.INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL MDM_TERM WHERE INTG_CD_ID = 'CD02071' AND MDM_TERM.INTG_CD_VAL_CTNT = MN.RCV_DE_TERM_CD) AS NM" ).append("\n"); 
		query.append("FROM PRI_RQ_RT_ROUT_PNT MN" ).append("\n"); 
