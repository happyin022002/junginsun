...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtRoutRefCopyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtRoutRefCopyVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agt_Agn_Agmt_Rout_Ref 테이블에 copy
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtRoutRefCopyVOCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtRoutRefCopyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AGT_AGN_ROUT_REF (AGMT_OFC_CD," ).append("\n"); 
