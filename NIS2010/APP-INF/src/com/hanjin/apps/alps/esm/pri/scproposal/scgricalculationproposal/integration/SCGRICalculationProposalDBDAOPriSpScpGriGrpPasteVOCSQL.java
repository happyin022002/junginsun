...
*@FileName : SCGRICalculationProposalDBDAOPriSpScpGriGrpPasteVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGRICalculationProposalDBDAOPriSpScpGriGrpPasteVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGRICalculationProposalDBDAOPriSpScpGriGrpPasteVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCGRICalculationProposalDBDAOPriSpScpGriGrpPasteVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_GRI_GRP (" ).append("\n"); 
		...
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		query.append(",	sysdate" ).append("\n"); 
		query.append("FROM PRI_SP_SCP_GRI_GRP_CPY" ).append("\n"); 
