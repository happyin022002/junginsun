...
*@FileName : EsmMas0004GSViewAdapter.java
 ...
 * @since J2EE 1.6
 */
public class EsmMas0004GS2ViewAdapter extends DefaultViewAdapter {
	
    public EsmMas0004GS2ViewAdapter(){
    	super();
    }
...
//					} else {
//						strBuilder.append("    <TD><![CDATA["+JSPUtil.getNull((String)colValues.get("mas_cost_src_cd_nm"))+"]]</TD>");
//					}
