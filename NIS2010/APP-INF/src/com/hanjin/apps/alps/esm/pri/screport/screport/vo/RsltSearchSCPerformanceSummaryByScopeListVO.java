...
*@FileName : RsltSearchSCPerformanceSummaryByScopeListVO.java
*@FileTitle : RsltSearchSCPerformanceSummaryByScopeListVO
*Open Issues :
*Change history :
...
public class RsltSearchSCPerformanceSummaryByScopeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltSearchSCPerformanceSummaryByScopeListVO> models = new ArrayList<RsltSearchSCPerformanceSummaryByScopeListVO>();
	...
	public RsltSearchSCPerformanceSummaryByScopeListVO() {}

	public RsltSearchSCPerformanceSummaryByScopeListVO(String ibflag, String pagerows, String rhqCd, String propAproOfcCd, String ctrtCustSlsOfcCd, String keyAcctFlg, String scNo, String ctrtPtyNm, String ctrtCustSrepCd, String prcCtrtCustTpCd, String svcScpCd, String fnlMqcQty, String ctrtEffDt, String ctrtExpDt, String opCntrQty, String mqcPerf, String proRtMqcPerf) {
		this.rhqCd = rhqCd;
...
/**
	 ...
	 * @param request
	 * @return RsltSearchSCPerformanceSummaryByScopeListVO[]
	 */
	public RsltSearchSCPerformanceSummaryByScopeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltSearchSCPerformanceSummaryByScopeListVO[]
	 */
	public RsltSearchSCPerformanceSummaryByScopeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltSearchSCPerformanceSummaryByScopeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltSearchSCPerformanceSummaryByScopeListVO();
				if (rhqCd[i] != null)
		...
		return getRsltSearchSCPerformanceSummaryByScopeListVOs();
	}
	 ...
	 * @return RsltSearchSCPerformanceSummaryByScopeListVO[]
	 */
	public RsltSearchSCPerformanceSummaryByScopeListVO[] getRsltSearchSCPerformanceSummaryByScopeListVOs(){
		RsltSearchSCPerformanceSummaryByScopeListVO[] vos = (RsltSearchSCPerformanceSummaryByScopeListVO[])models.toArray(new RsltSearchSCPerformanceSummaryByScopeListVO[models.size()]);
		return vos;
	}
