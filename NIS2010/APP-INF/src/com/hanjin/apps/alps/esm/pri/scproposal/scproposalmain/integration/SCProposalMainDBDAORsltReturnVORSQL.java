...
*@FileName : SCProposalMainDBDAORsltReturnVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCProposalMainDBDAORsltReturnVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Returned 가 terms를 조회한다.
	  * </pre>
	  */
	public SCProposalMainDBDAORsltReturnVORSQL(){
		setQuery();
		...
		query.append("FileName : SCProposalMainDBDAORsltReturnVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
