...
*@FileName : TRIProposalDBDAOPriTriRtScgRoutCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgRoutCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgRoutCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgRoutCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_TRI_RT_SCG_ROUT A" ).append("\n"); 
		query.append("USING (" ).append("\n"); 
		query.append("SELECT TRI_PROP_NO, AMDT_SEQ" ).append("\n"); 
