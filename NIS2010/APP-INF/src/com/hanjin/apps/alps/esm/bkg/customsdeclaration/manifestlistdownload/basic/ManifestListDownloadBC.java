 ...
 * @since J2EE 1.4
 */
public interface ManifestListDownloadBC {
	 ...
	 * @exception EventException
	 */
	public void manageManifestForDl(ManifestModificationVO[] manifestModificationVOs, SignOnUserAccount account) throws EventException;	
	 ...
	 * @exception EventException
	 */
	public void manageManifestForMfs(ManifestModificationVO[] manifestModificationVOs, SignOnUserAccount account) throws EventException;	
	 ...
	 * @exception EventException
	 */
	public List<VesselArrivalDetailVO> searchVesselArrival(VesselArrivalCondVO vesselArrivalCondVO , SignOnUserAccount account) throws EventException;
	...
	public List<CrnVO> searchCRN(String vslCallRefNo,String vslCd,String skdVoyNo,String skdDirCd) throws EventException;	
	...
	/**
	 *  신고 대상 Marks & Description 정보를 세관 테이블 내에 생성한다.
	 * 
	 * @param MfrMndModificationVO mfrMndModificationVO
	 * @param SignOnUserAccount account
	 * @exception EventException
	 */
	public void manageMfrMnd(MfrMndModificationVO mfrMndModificationVO, SignOnUserAccount account) throws EventException;	
	
	/**
	 *  Manifest Registration(MFR)에서 Cust 정보 수정
	 * 
	 * @param MfrMndModificationVO mfrMndModificationVO
	 * @param SignOnUserAccount account
	 * @exception EventException
	 */
	public void removeJpcusBlMd(MfrMndModificationVO mfrMndModificationVO, SignOnUserAccount account) throws EventException;	
	 ...
	 * @exception EventException
	 */
	public void confirmManifestList(ManifestConfirmationVO[] manifestConfirmationVOs, SignOnUserAccount account) throws EventException;
	...
	public List<ManifestListDetailVO> searchManifestListForRocsBl(ManifestListCondVO manifestListCondVO) throws EventException;
	...
	/**
	 *  VVD,Port 등 입력 후 조회한 세관 CMF 신고 대상 List를 세관 테이블 내로 다운받는다.
	 * 
	 * @param ManifestModificationVO manifestModificationVO
     * @param SignOnUserAccount account 
	 * @exception EventException
	 ...
	 */
	public List<BkgHrdCdgCtntVO> searchAncsLane()
			throws EventException;	
...
//	 * @exception EventException
//	 */
//	public List<VesselArrivalDetailVO> searchVesselFIArrival(VesselArrivalCondVO vesselArrivalCondVO) throws EventException;
    ...
    */	 
	 ...
	 * 
	 * @param UsCustomsStatusNoticeVO usCustomsStatusNoticeVO
	 * @exception EventException
	*/	 	 
