...
*@FileName : AgencyCommissionDBDAOMasOtrCommVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgencyCommissionDBDAOMasOtrCommVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgencyCommissionDBDAOMasOtrCommVOCSQL(){
		setQuery();
		...
		query.append("FileName : AgencyCommissionDBDAOMasOtrCommVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
