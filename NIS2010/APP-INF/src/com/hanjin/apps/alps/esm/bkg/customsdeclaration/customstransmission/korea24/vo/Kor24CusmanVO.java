...
*@FileTitle : <Kor24CusmanVO.java
*@FileTitle : Kor24CusmanVO
*Open Issues :
*Change history :
...
public class Kor24CusmanVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24CusmanVO> models = new ArrayList<Kor24CusmanVO>();
...
/**
	 ...
	 */
	public Kor24CusmanVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24CusmanVO[]
	 */
	public Kor24CusmanVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24CusmanVO model = null;
	 ...
	 * @return Kor24CusmanVO[]
	 */
	public Kor24CusmanVO[] getKor24CusmanVOs(){
		Kor24CusmanVO[] vos = (Kor24CusmanVO[])models.toArray(new Kor24CusmanVO[models.size()]);
		return vos;
	}
