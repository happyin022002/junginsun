...
*@FileName : SpecialCargoReceiptDBDAOModifyBkgAwkCgoVolUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoReceiptDBDAOModifyBkgAwkCgoVolUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 awk 의 volumn을 container 기준으로 update한다.
	  * </pre>
	  */
	public SpecialCargoReceiptDBDAOModifyBkgAwkCgoVolUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoReceiptDBDAOModifyBkgAwkCgoVolUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO BKG_AWK_CGO SPCL" ).append("\n"); 
