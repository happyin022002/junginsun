...
*@FileName : LaneSimulationDBDAOModifySimCMCostCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneSimulationDBDAOModifySimCMCostCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneSimulationDBDAOModifySimCMCostCSQL(){
		setQuery();
		...
		params.put("cgo_var_uc_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("cgo_var_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LaneSimulationDBDAOModifySimCMCostCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",CGO_VAR_UC_AMT" ).append("\n"); 
		query.append(",CGO_VAR_AMT" ).append("\n"); 
