...
*@FileName : EQBalanceDBDAOCoaCntrRepoCrVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQBalanceDBDAOCoaCntrRepoCrVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQBalanceDBDAOCoaCntrRepoCrVOUSQL(){
		setQuery();
		...
		query.append("FileName : EQBalanceDBDAOCoaCntrRepoCrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COA_CNTR_REPO_CR" ).append("\n"); 
