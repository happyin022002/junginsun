...
public class PerformanceReportDBDAOVesselUtilizationStatusReportOutVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", TRIM(TO_CHAR(TTL_E+TTL_S,'999,999,990.9')) AS TTL_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TTL_W+TTL_N,'999,999,990.9')) AS TTL_W" ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_LOCAL_E+SUB_TOT_LOD_LOCAL_S,'999,999,990.9')) AS SUB_TOT_LOD_LOCAL_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_TS_E+SUB_TOT_LOD_TS_S,'999,999,990.9')) AS SUB_TOT_LOD_TS_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_IPC_E+SUB_TOT_LOD_IPC_S,'999,999,990.9')) AS SUB_TOT_LOD_IPC_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_TPS_E+SUB_TOT_LOD_TPS_S,'999,999,990.9')) AS SUB_TOT_LOD_TPS_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_EUR_E+SUB_TOT_LOD_EUR_S,'999,999,990.9')) AS SUB_TOT_LOD_EUR_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_MTY_E+SUB_TOT_LOD_MTY_S,'999,999,990.9')) AS SUB_TOT_LOD_MTY_E" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_LOCAL_W+SUB_TOT_LOD_LOCAL_N,'999,999,990.9')) AS SUB_TOT_LOD_LOCAL_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_TS_W+SUB_TOT_LOD_TS_N,'999,999,990.9')) AS SUB_TOT_LOD_TS_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_IPC_W+SUB_TOT_LOD_IPC_N,'999,999,990.9')) AS SUB_TOT_LOD_IPC_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_TPS_W+SUB_TOT_LOD_TPS_N,'999,999,990.9')) AS SUB_TOT_LOD_TPS_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_EUR_W+SUB_TOT_LOD_EUR_N,'999,999,990.9')) AS SUB_TOT_LOD_EUR_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(SUB_TOT_LOD_MTY_W+SUB_TOT_LOD_MTY_N,'999,999,990.9')) AS SUB_TOT_LOD_MTY_W" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(", TRIM(TO_CHAR(LOD_LOCAL, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_LOCAL,0,'','('||TRIM(TO_CHAR(PRE_LOD_LOCAL,'999,999,990.9'))||')'),'') AS LOD_LOCAL" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(LOD_TS, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_TS,0,'','('||TRIM(TO_CHAR(PRE_LOD_TS,'999,999,990.9'))||')'),'') AS LOD_TS" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(LOD_IPC, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_IPC,0,'','('||TRIM(TO_CHAR(PRE_LOD_IPC,'999,999,990.9'))||')'),'') AS LOD_IPC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(LOD_TPS, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_TPS,0,'','('||TRIM(TO_CHAR(PRE_LOD_TPS,'999,999,990.9'))||')'),'') AS LOD_TPS" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(LOD_EUR, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_EUR,0,'','('||TRIM(TO_CHAR(PRE_LOD_EUR,'999,999,990.9'))||')'),'') AS LOD_EUR" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(LOD_MTY, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_MTY,0,'','('||TRIM(TO_CHAR(PRE_LOD_MTY,'999,999,990.9'))||')'),'') AS LOD_MTY" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(LOD_TTL, '999,999,990.9'))||DECODE(PORT_SEQ,1,DECODE(PRE_LOD_LOCAL+PRE_LOD_TS+PRE_LOD_MTY,0,'','('||TRIM(TO_CHAR(PRE_LOD_LOCAL+PRE_LOD_TS+PRE_LOD_MTY,'999,999,990.9'))||')'),'') AS LOD_TTL" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(", DECODE(PORT_SEQ,1, DECODE(PRE_LOD_LOCAL+PRE_LOD_TS+PRE_LOD_MTY,0,'', TRIM(TO_CHAR(PRE_LOD_LOCAL+PRE_LOD_TS+PRE_LOD_MTY,'999,999,990.9'))), " ).append("\n"); 
		query.append("                     DECODE(PRE_DIS_LOCAL+PRE_DIS_TS+PRE_DIS_MTY,0,'', '-'||TRIM(TO_CHAR(PRE_DIS_LOCAL+PRE_DIS_TS+PRE_DIS_MTY,'999,999,990.9'))) ) AS LAST_PORT_LOADING" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/* 이전배에서 내린 수량을 표시한다.*/" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_LOCAL, '999,999,990.9'))||DECODE(PRE_DIS_LOCAL,0,'','('||TRIM(TO_CHAR(PRE_DIS_LOCAL,'999,999,990.9'))||')') AS DIS_LOCAL " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_TS, '999,999,990.9'))||DECODE(PRE_DIS_TS,0,'','('||TRIM(TO_CHAR(PRE_DIS_TS,'999,999,990.9'))||')') AS DIS_TS " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_IPC, '999,999,990.9'))||DECODE(PRE_DIS_IPC,0,'','('||TRIM(TO_CHAR(PRE_DIS_IPC,'999,999,990.9'))||')') AS DIS_IPC " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_TPS, '999,999,990.9'))||DECODE(PRE_DIS_TPS,0,'','('||TRIM(TO_CHAR(PRE_DIS_TPS,'999,999,990.9'))||')') AS DIS_TPS " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_EUR, '999,999,990.9'))||DECODE(PRE_DIS_EUR,0,'','('||TRIM(TO_CHAR(PRE_DIS_EUR,'999,999,990.9'))||')') AS DIS_EUR " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_MTY, '999,999,990.9'))||DECODE(PRE_DIS_MTY,0,'','('||TRIM(TO_CHAR(PRE_DIS_MTY,'999,999,990.9'))||')') AS DIS_MTY " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(DIS_TTL, '999,999,990.9'))||DECODE(PRE_DIS_LOCAL+PRE_DIS_TS+PRE_DIS_MTY,0,'','('||TRIM(TO_CHAR(PRE_DIS_LOCAL+PRE_DIS_TS+PRE_DIS_MTY,'999,999,990.9'))||')')  AS DIS_TTL " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_LOCAL,'999,999,990.9')) AS ROB_LOCAL" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_TS,'999,999,990.9')) AS ROB_TS" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_IPC,'999,999,990.9')) AS ROB_IPC" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_TPS,'999,999,990.9')) AS ROB_TPS" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_EUR,'999,999,990.9')) AS ROB_EUR" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_MTY,'999,999,990.9')) AS ROB_MTY" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(ROB_TOT,'999,999,990.9')) AS ROB_TOT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", ROUND((ROB_TOT)/DECODE(BSA,0,1,BSA)*100) AS PORT_LOD_PCT_INT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_LOCAL_E+TOT_LOD_LOCAL_S,'999,999,990.9')) AS TOT_LOD_LOCAL_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_TS_E+TOT_LOD_TS_S,'999,999,990.9')) AS TOT_LOD_TS_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_IPC_E+TOT_LOD_IPC_S,'999,999,990.9')) AS TOT_LOD_IPC_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_TPS_E+TOT_LOD_TPS_S,'999,999,990.9')) AS TOT_LOD_TPS_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_EUR_E+TOT_LOD_EUR_S,'999,999,990.9')) AS TOT_LOD_EUR_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_MTY_E+TOT_LOD_MTY_S,'999,999,990.9')) AS TOT_LOD_MTY_E" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_LOCAL_W+TOT_LOD_LOCAL_N,'999,999,990.9')) AS TOT_LOD_LOCAL_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_TS_W+TOT_LOD_TS_N,'999,999,990.9')) AS TOT_LOD_TS_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_IPC_W+TOT_LOD_IPC_N,'999,999,990.9')) AS TOT_LOD_IPC_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_TPS_W+TOT_LOD_TPS_N,'999,999,990.9')) AS TOT_LOD_TPS_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_EUR_W+TOT_LOD_EUR_N,'999,999,990.9')) AS TOT_LOD_EUR_W" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_MTY_W+TOT_LOD_MTY_N,'999,999,990.9')) AS TOT_LOD_MTY_W" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_BSA_E+TOT_BSA_S,'999,999,990.9')) AS TOT_BSA_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_BSA_W+TOT_BSA_N,'999,999,990.9')) AS TOT_BSA_W  " ).append("\n"); 
		...
		query.append(" " ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_E+TOT_LOD_S,'999,999,990.9')) AS TOT_LOD_E" ).append("\n"); 
		query.append(", TRIM(TO_CHAR(TOT_LOD_W+TOT_LOD_N,'999,999,990.9')) AS TOT_LOD_W" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    SELECT" ).append("\n"); 
		...
		query.append("                                                                                                       (SELECT SUM(FNL_HJS_BSA_CAPA) FNL_HJS_BSA_CAPA" ).append("\n"); 
		...
		query.append("                                                                                                       MAS_MON_VVD MAS" ).append("\n"); 
		...
		query.append("                                                                                                AND    SKD.VSL_CD = MAS.VSL_CD(+)" ).append("\n"); 
		query.append("                                                                                                AND    SKD.SKD_VOY_NO = MAS.SKD_VOY_NO(+)" ).append("\n"); 
		query.append("                                                                                                AND    SKD.SKD_DIR_CD = MAS.DIR_CD(+)" ).append("\n"); 
		query.append("                                                                                                AND    WKY_TGT_FLG(+) ='Y'" ).append("\n"); 
		query.append("                                                                                                #if (${trd_cd} != 'All')" ).append("\n"); 
		query.append("                                                                                                   AND MAS.TRD_CD = @[trd_cd]" ).append("\n"); 
		query.append("                                                                                                #end" ).append("\n"); 
		query.append("                                                                                                #if (${sub_trd_cd} != 'All')" ).append("\n"); 
		query.append("                                                                                                   AND MAS.SUB_TRD_CD = @[sub_trd_cd]" ).append("\n"); 
		query.append("                                                                                                #end" ).append("\n"); 
		query.append("                                                                                                #if (${vsl_slan_dir_cd} != 'All')" ).append("\n"); 
		query.append("                                                                                                   AND MAS.DIR_CD = @[vsl_slan_dir_cd]" ).append("\n"); 
		query.append("                                                                                                #end" ).append("\n"); 
		query.append("                                                                                                #if (${cost_year} != '' &&  ${dt_tp} == '1')" ).append("\n"); 
		query.append("                                                                                                   AND MAS.COST_YRMON = @[cost_yrmon]" ).append("\n"); 
		query.append("                                                                                                #end" ).append("\n"); 
		query.append("                                                                                                #if (${cost_wk} != '' &&  ${dt_tp} == '1')" ).append("\n"); 
		query.append("                                                                                                   AND MAS.COST_WK = @[cost_wk]" ).append("\n"); 
		query.append("                                                                                                #end                                                                " ).append("\n"); 
