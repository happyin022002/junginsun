...
*@FileName : RsltPriSpAfilInqVO.java
*@FileTitle : RsltPriSpAfilInqVO
*Open Issues :
*Change history :
...
public class RsltPriSpAfilInqVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriSpAfilInqVO> models = new ArrayList<RsltPriSpAfilInqVO>();
	 ...
	 * @param request
	 * @return RsltPriSpAfilInqVO[]
	 */
	public RsltPriSpAfilInqVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriSpAfilInqVO[]
	 */
	public RsltPriSpAfilInqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriSpAfilInqVO model = null;
	 ...
	 * @return RsltPriSpAfilInqVO[]
	 */
	public RsltPriSpAfilInqVO[] getRsltPriSpAfilInqVOs(){
		RsltPriSpAfilInqVO[] vos = (RsltPriSpAfilInqVO[])models.toArray(new RsltPriSpAfilInqVO[models.size()]);
		return vos;
	}
