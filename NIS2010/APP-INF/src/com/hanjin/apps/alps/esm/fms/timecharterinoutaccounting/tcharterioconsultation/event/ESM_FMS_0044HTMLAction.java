...
*@FileName : ESM_FMS_0044HTMLAction.java
...
public class ESM_FMS_0044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0044HTMLAction 객체를 생성
	 */
	public ESM_FMS_0044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FormCommand command = FormCommand.fromRequest(request);
 		EsmFms0044Event event = new EsmFms0044Event();
