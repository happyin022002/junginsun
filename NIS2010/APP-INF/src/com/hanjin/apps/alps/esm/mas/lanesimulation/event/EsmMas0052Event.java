...
*@FileName : ESM_MAS_052Event.java
...
import com.hanjin.apps.alps.esm.mas.lanesimulation.vo.CreateSimVolProjConditionVO;
...
/**
 *  1. 기능 : ESM_MAS_052 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 *  2. 처리개요 : <p>
 *    - ESM_MAS_052HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
 public class EsmMas0052Event extends MASEvent {
	private static final long serialVersionUID = 1L;
    /**
     * EsmMas0052Event생성자함수
     */
    public EsmMas0052Event(){
    	//
    }
    /*
	...
	private MasSimTmlInfoVO masSimTmlInfoVO = null;
	private MasSimTmlInfoVO[] masSimTmlInfoVOS = null;
	...
	public MasSimTmlInfoVO[] getMasSimTmlInfoVOS() {
		return masSimTmlInfoVOS;
	}

	public void setMasSimTmlInfoVOS(MasSimTmlInfoVO[] masSimTmlInfoVOS) {
		this.masSimTmlInfoVOS = masSimTmlInfoVOS;
	}

	public MasSimTmlInfoVO getMasSimTmlInfoVO() {
		return masSimTmlInfoVO;
	}

	public void setMasSimTmlInfoVO(MasSimTmlInfoVO masSimTmlInfoVO) {
		this.masSimTmlInfoVO = masSimTmlInfoVO;
	}
