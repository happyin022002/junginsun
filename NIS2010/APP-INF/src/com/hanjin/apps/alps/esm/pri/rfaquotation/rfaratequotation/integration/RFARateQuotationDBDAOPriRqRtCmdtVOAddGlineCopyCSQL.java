...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtVOAddGlineCopyCSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtVOAddGlineCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtVOAddGlineCopyCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtVOAddGlineCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
