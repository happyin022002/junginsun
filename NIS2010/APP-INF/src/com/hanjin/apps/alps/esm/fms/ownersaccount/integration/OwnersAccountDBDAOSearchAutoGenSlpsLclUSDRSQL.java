...
*@FileName : OwnersAccountDBDAOSearchAutoGenSlpsLclUSDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnersAccountDBDAOSearchAutoGenSlpsLclUSDRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * Local Currency가 USD일때
	  * </pre>
	  */
	public OwnersAccountDBDAOSearchAutoGenSlpsLclUSDRSQL(){
		setQuery();
		...
		query.append("FileName : OwnersAccountDBDAOSearchAutoGenSlpsLclUSDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
