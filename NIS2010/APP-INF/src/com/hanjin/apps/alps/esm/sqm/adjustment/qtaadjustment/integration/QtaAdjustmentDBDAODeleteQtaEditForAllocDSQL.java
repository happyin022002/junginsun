...
*@FileName : QtaAdjustmentDBDAODeleteQtaEditForAllocDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class QtaAdjustmentDBDAODeleteQtaEditForAllocDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public QtaAdjustmentDBDAODeleteQtaEditForAllocDSQL(){
		setQuery();
		...
		query.append("FileName : QtaAdjustmentDBDAODeleteQtaEditForAllocDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE SQM_ALOC_QTA" ).append("\n"); 
