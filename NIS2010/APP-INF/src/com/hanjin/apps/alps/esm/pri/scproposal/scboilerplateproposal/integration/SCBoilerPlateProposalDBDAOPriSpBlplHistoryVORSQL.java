...
*@FileName : SCBoilerPlateProposalDBDAOPriSpBlplHistoryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCBoilerPlateProposalDBDAOPriSpBlplHistoryVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Boiler Plate Title History 조회
	  * 2012.02.23 이석준[CHM-201216153-01] S/C Amendment History 화면 기능 개선 요청
	  * </pre>
	  */
	public SCBoilerPlateProposalDBDAOPriSpBlplHistoryVORSQL(){
		setQuery();
		...
		query.append("FileName : SCBoilerPlateProposalDBDAOPriSpBlplHistoryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , T.BLPL_SEQ              " ).append("\n"); 
		query.append("	 , T.BLPL_TIT_NM             " ).append("\n"); 
		query.append("	 , T.DP_SEQ             " ).append("\n"); 
		query.append("	 , T.N1ST_CMNC_AMDT_SEQ             " ).append("\n"); 
		query.append("	 , T.EFF_DT             " ).append("\n"); 
		query.append("	 , T.EXP_DT              " ).append("\n"); 
		query.append("	 , T.SRC_INFO_CD            " ).append("\n"); 
		query.append("	 , T.SRC_INFO_DTL            " ).append("\n"); 
		query.append("	 , T.PRC_PROG_STS_CD            " ).append("\n"); 
		query.append("	 , T.PRC_PROG_STS_DTL            " ).append("\n"); 
		query.append("	 , T.ACPT_USR_ID            " ).append("\n"); 
		query.append("	 , T.ACPT_OFC_CD            " ).append("\n"); 
		query.append("	 , T.ACPT_DT            " ).append("\n"); 
		query.append("	 , T.ACPT_USR_NM" ).append("\n"); 
		...
		query.append("						 WHERE PROP_NO = M.PROP_NO AND AMDT_SEQ = M.AMDT_SEQ-1 )  END  EXP_DT              " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("   		   AND EXISTS ( SELECT 'X' FROM PRI_SP_BLPL_CTNT " ).append("\n"); 
		query.append("             	 		 WHERE PROP_NO 		= A.PROP_NO " ).append("\n"); 
		query.append("				   		   AND AMDT_SEQ 	= A.AMDT_SEQ " ).append("\n"); 
		query.append("				   		   AND BLPL_SEQ 	= A.BLPL_SEQ" ).append("\n"); 
		...
		query.append("ORDER BY T.DP_SEQ, T.BLPL_SEQ, T.AMDT_SEQ" ).append("\n"); 
