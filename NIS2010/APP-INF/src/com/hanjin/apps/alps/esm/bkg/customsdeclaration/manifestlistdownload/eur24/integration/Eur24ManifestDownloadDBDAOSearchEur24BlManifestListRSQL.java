...
public class Eur24ManifestDownloadDBDAOSearchEur24BlManifestListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("--     , COUNT(DISTINCT DECODE(RESULT2,'AL',BL_NO,NULL)) OVER()  AS AL_CNT" ).append("\n"); 
		...
		query.append("                       , CASE WHEN CNTR_PK1 = 0 OR CNTR_PK1 != CM_PK_SUM THEN DECODE(BB_CGO_FLG,'Y','N','E') " ).append("\n"); 
		query.append("                              WHEN CNTR_PK_LMT_FLG = 'Y' THEN 'E'" ).append("\n"); 
		query.append("                              ELSE 'Y' " ).append("\n"); 
		query.append("                         END AS CNTR_PK" ).append("\n"); 
		...
		query.append("                                         , CASE WHEN CNTR_PK1 > 99999 THEN 'Y'" ).append("\n"); 
		query.append("                                                ELSE 'N'" ).append("\n"); 
		query.append("                                           END AS CNTR_PK_LMT_FLG" ).append("\n"); 
		...
		query.append("                                         , CASE WHEN (DECODE(NVL(NISADM.BKG_GET_TOKEN_FNC(CM_DATA,6),0),0,'N','Y') ='N' " ).append("\n"); 
		query.append("                                                      OR NVL(NISADM.BKG_GET_TOKEN_FNC(CM_DATA,6),0) != NVL(NISADM.BKG_GET_TOKEN_FNC(CM_DATA,7),0) )" ).append("\n"); 
		...
		query.append("                                                ELSE DECODE(NVL(NISADM.BKG_GET_TOKEN_FNC(CM_DATA,6),0),0,'N','Y')" ).append("\n"); 
		...
		query.append("                                                                    AND SND.BL_NO = X.BL_NO" ).append("\n"); 
		query.append("                                                                    AND SND.MSG_SND_NO = X.MSG_SND_NO),2),'Y')  AS UPD_FLG" ).append("\n"); 
		query.append("                                      FROM (" ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		...
		query.append(" #end" ).append("\n"); 
		query.append(" #if (${to_snd_flg} == 'Y')" ).append("\n"); 
		query.append("     AND UPD_FLG = 'N'" ).append("\n"); 
		query.append(" #end" ).append("\n"); 
		query.append("" ).append("\n"); 
