...
public class ESM_BKG_0921HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0921HTMLAction 객체를 생성
	 */
	public ESM_BKG_0921HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0921Event event = new EsmBkg0921Event();
		...
		String boundCd = JSPUtil.getNullNoTrim(JSPUtil.getParameter(request, "bound_cd".trim(), ""));
