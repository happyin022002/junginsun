...
* 1.0 Creation
* History
* 2012.02.02 이석준[CHM-201215685] CHSS_EXPT_FLG, GRI_APPL_FLG, NEW_SCG_FLG 컬럼 추가
...
public class RsltPropMnScpInqListVO extends AbstractValueObject {
	...
	public RsltPropMnScpInqListVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String propScpAproOfcCd, String propScpOfcCd, String propScpMqcQty, String cntrLodUtCd, String unitNm, String propScpSrepCd, String ctrtEffDt, String ctrtExpDt, String propScpStsCd, String propScpSts, String chssExptFlg,String griApplFlg,String newScgFlg) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setChssExptFlg(JSPUtil.getParameter(request, "chss_expt_flg", ""));
		setGriApplFlg(JSPUtil.getParameter(request,  "gri_appl_flg", ""));
		setNewScgFlg(JSPUtil.getParameter(request,  "new_scg_flg", ""));		
	}
