...
*@FileName : ESM_SPC_0029HTMLAction.java
*@FileTitle : Send Mail
*Open Issues :
*Change history :
...
public class ESM_SPC_0029HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0029HTMLAction 객체를 생성
	 */
	public ESM_SPC_0029HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0029Event event = new EsmSpc0029Event();
