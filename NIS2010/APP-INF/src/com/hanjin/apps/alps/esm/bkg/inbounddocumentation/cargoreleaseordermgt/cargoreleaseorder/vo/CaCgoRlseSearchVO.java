...
*@FileName : CaCgoRlseSearchVO.java
*@FileTitle : CaCgoRlseSearchVO
*Open Issues :
*Change history :
...
public class CaCgoRlseSearchVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CaCgoRlseSearchVO> models = new ArrayList<CaCgoRlseSearchVO>();
	...
	public CaCgoRlseSearchVO() {}

	public CaCgoRlseSearchVO(String ibflag, String pagerows, String blNo, String vvd, String podCd, String delCd, String hubLocCd, String mrnTmlEdiSndCd, String frtCltFlg, String oblRdemFlg, String cstmsClrCd, String startDate, String startTime, String endDate, String endTime, String dtlBlNo) {
	 ...
	 * @param request
	 * @return CaCgoRlseSearchVO[]
	 */
	public CaCgoRlseSearchVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CaCgoRlseSearchVO[]
	 */
	public CaCgoRlseSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CaCgoRlseSearchVO model = null;
	 ...
	 * @return CaCgoRlseSearchVO[]
	 */
	public CaCgoRlseSearchVO[] getCaCgoRlseSearchVOs(){
		CaCgoRlseSearchVO[] vos = (CaCgoRlseSearchVO[])models.toArray(new CaCgoRlseSearchVO[models.size()]);
		return vos;
	}
