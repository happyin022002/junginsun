...
*@FileName : CstmsSndLogDtlVO.java
*@FileTitle : CstmsSndLogDtlVO
*Open Issues :
*Change history :
...
public class CndCstmsSndLogDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CndCstmsSndLogDtlVO> models = new ArrayList<CndCstmsSndLogDtlVO>();
	...
	public CndCstmsSndLogDtlVO() {}

	public CndCstmsSndLogDtlVO(String ibflag, String pagerows, String ediSndLogCtnt) {
		this.ibflag = ibflag;
	 ...
	 */
	public CndCstmsSndLogDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CstmsSndLogDtlVO[]
	 */
	public CndCstmsSndLogDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CndCstmsSndLogDtlVO model = null;
	 ...
	 * @return CstmsSndLogDtlVO[]
	 */
	public CndCstmsSndLogDtlVO[] getCstmsSndLogDtlVOs(){
		CndCstmsSndLogDtlVO[] vos = (CndCstmsSndLogDtlVO[])models.toArray(new CndCstmsSndLogDtlVO[models.size()]);
		return vos;
	}
