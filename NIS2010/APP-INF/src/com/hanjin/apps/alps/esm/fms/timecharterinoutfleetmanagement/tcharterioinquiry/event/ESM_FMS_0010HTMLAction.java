...
*@FileName : ESM_FMS_0010HTMLAction.java
...
public class ESM_FMS_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0010HTMLAction 객체를 생성
	 */
	public ESM_FMS_0010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0010Event event = new EsmFms0010Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFletCtrtNo(request.getParameter("fletCtrtNo"));
			event.setHirNo(request.getParameter("hirNo"));
		}
