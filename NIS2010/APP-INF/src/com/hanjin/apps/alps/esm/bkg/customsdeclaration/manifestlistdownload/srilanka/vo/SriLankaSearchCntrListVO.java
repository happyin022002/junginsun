...
*@FileName : SriLankaSearchCntrListVO.java
*@FileTitle : SriLankaSearchCntrListVO
*Open Issues :
*Change history :
...
public class SriLankaSearchCntrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SriLankaSearchCntrListVO> models = new ArrayList<SriLankaSearchCntrListVO>();
	...
	public SriLankaSearchCntrListVO() {}

	public SriLankaSearchCntrListVO(String ibflag, String pagerows, String cntrWgt, String delCd, String blNo, String blTotal, String cntrNo, String cntrTpszCd, String wgtUtCd, String measQty, String seq, String pckQty, String cntrSealNo, String measUtCd, String pckTpCd, String polCd, String podCd, String vvdPod, String vvdPol) {
...
/**
	 ...
	 * @param request
	 * @return SriLankaSearchCntrListVO[]
	 */
	public SriLankaSearchCntrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SriLankaSearchCntrListVO[]
	 */
	public SriLankaSearchCntrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SriLankaSearchCntrListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SriLankaSearchCntrListVO();
				if (cntrWgt[i] != null)
		...
		return getSriLankaSearchCntrListVOs();
	}
	 ...
	 * @return SriLankaSearchCntrListVO[]
	 */
	public SriLankaSearchCntrListVO[] getSriLankaSearchCntrListVOs(){
		SriLankaSearchCntrListVO[] vos = (SriLankaSearchCntrListVO[])models.toArray(new SriLankaSearchCntrListVO[models.size()]);
		return vos;
	}
