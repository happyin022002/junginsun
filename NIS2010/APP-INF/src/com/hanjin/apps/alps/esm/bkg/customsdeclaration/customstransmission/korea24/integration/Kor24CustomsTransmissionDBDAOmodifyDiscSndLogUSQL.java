...
*@FileName : Kor24CustomsTransmissionDBDAOmodifyDiscSndLogUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOmodifyDiscSndLogUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOmodifyDiscSndLogUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOmodifyDiscSndLogUSQL").append("\n");
		query.append("*/").append("\n");
	}
