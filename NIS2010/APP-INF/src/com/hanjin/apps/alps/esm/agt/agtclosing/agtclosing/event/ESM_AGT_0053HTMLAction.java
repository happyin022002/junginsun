...
public class ESM_AGT_0053HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_AGT_0032HTMLAction 객체를 생성
	 */
	public ESM_AGT_0053HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0053Event event = new EsmAgt0053Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchCSRInquiryDetailVO((SearchCSRInquiryDetailVO)getVO(request, SearchCSRInquiryDetailVO .class));
		}
