...
*@FileName : GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocVOUSQL.java
...
public class GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocVOUSQL(){
		setQuery();
		...
		query.append("FileName : GroupLocationCMPBGuidelineDBDAOPriCmpbGrpLocVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_CMPB_GRP_LOC SET" ).append("\n"); 
