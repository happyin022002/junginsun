...
*@FileName : WeeklyCMDBDAODeleteUCbyCustomerListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAODeleteUCbyCustomerListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Unit Cost by Customer (Door. CY Exception) - Delete
	  * </pre>
	  */
	public WeeklyCMDBDAODeleteUCbyCustomerListDSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAODeleteUCbyCustomerListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
