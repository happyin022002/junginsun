...
public class EsmBkg1141Event extends EventSupport {
	...
	private MalaysiaManifestListCondVO[] malaysiaManifestListCondVOs = null;
	...
	private MalaysiaManifestTransmitVO[] malaysiaManifestTransmitVOs = null;
	...
	public MalaysiaManifestListCondVO[] getMalaysiaManifestListCondVOs() {
		return malaysiaManifestListCondVOs;
	}

	public void setMalaysiaManifestListCondVOs(
			MalaysiaManifestListCondVO[] malaysiaManifestListCondVOs) {
		this.malaysiaManifestListCondVOs = malaysiaManifestListCondVOs;
	}
	...
	public void setMalaysiaManifestTransmitVO(
			MalaysiaManifestTransmitVO malaysiaManifestTransmitVO) {
		this.malaysiaManifestTransmitVO = malaysiaManifestTransmitVO;
	}

	public MalaysiaManifestTransmitVO[] getMalaysiaManifestTransmitVOs() {
		return malaysiaManifestTransmitVOs;
	}

	public void setMalaysiaManifestTransmitVOs(
			MalaysiaManifestTransmitVO[] malaysiaManifestTransmitVOs) {
		this.malaysiaManifestTransmitVOs = malaysiaManifestTransmitVOs;
	}
