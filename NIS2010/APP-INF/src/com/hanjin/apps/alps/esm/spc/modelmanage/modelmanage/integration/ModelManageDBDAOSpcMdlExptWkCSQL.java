...
*@FileName : ModelManageDBDAOSpcMdlExptWkCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAOSpcMdlExptWkCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ModelManageDBDAOSpcMdlExptWkCSQL(){
		setQuery();
		...
		params.put("expt_yrwk",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ModelManageDBDAOSpcMdlExptWkCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
