...
*@FileName : RFATransportationAdditionalChargeProposalDBDAORsltArbChgHistoryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFATransportationAdditionalChargeProposalDBDAORsltArbChgHistoryListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Arbitrary Amend History List 조회
	  * </pre>
	  */
	public RFATransportationAdditionalChargeProposalDBDAORsltArbChgHistoryListRSQL(){
		setQuery();
		...
		query.append("FileName : RFATransportationAdditionalChargeProposalDBDAORsltArbChgHistoryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , (SELECT USR_NM FROM COM_USER WHERE USR_ID = A.ACPT_USR_ID)||' / '||A.ACPT_OFC_CD AS ACPT_USR_NM" ).append("\n"); 
