...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtCtrtRefVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtCtrtRefVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_ctrt_ref 테이블에서 조건 데이터 삭제
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtCtrtRefVODSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtCtrtRefVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
