...
*@FileName : UsaInbondManifestDetailVO.java
*@FileTitle : UsaInbondManifestDetailVO
*Open Issues :
*Change history :
...
public class UsaInbondManifestDetailVO extends InbondManifestDetailVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaInbondManifestDetailVO> models = new ArrayList<UsaInbondManifestDetailVO>();
	...
	public UsaInbondManifestDetailVO() {}

	public UsaInbondManifestDetailVO(String ibflag, String pagerows, String cntrNo, String blNo, String vvd, String delCd, String ibdTrspNo, String ibdTpCd, String arrDt, String trspIssDt, String arrTime, String trspIssTime, String usaLstLocCd, String mjrIbdAuthDt, String mjrIbdAuthTime, String xptDt, String xptTime, String xptAcptDt, String xptAcptTime, String cnmvStsCd, String podCd, String hubLocCd, String frtCltFlg, String oblRdemFlg, String cstmsClrCd, String arrFlg, String xptFlg, String trspAuthDt, String trspAuthTime, String pkupNo, String ydCd, String avalDt, String blCntrFlag, String usdate, String arrDtBefore, String xptDtBefore) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setXptDtBefore(JSPUtil.getParameter(request, "xpt_dt_before", ""));
		...
		setUsdate(JSPUtil.getParameter(request, "usdate", ""));
		...
		setArrDtBefore(JSPUtil.getParameter(request, "arr_dt_before", ""));
	 ...
	 */
	public UsaInbondManifestDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaInbondManifestDetailVO[]
	 */
	public UsaInbondManifestDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaInbondManifestDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaInbondManifestDetailVO();
		...
		return getUsaInbondManifestDetailVOs();
	}
	 ...
	 * @return UsaInbondManifestDetailVO[]
	 */
	public UsaInbondManifestDetailVO[] getUsaInbondManifestDetailVOs(){
		UsaInbondManifestDetailVO[] vos = (UsaInbondManifestDetailVO[])models.toArray(new UsaInbondManifestDetailVO[models.size()]);
		return vos;
	}
