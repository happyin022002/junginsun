...
*@FileName : RFARateQuotationDBDAOPriRqRtCmdtRoutVODSQL.java
...
public class RFARateQuotationDBDAOPriRqRtCmdtRoutVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtCmdtRoutVODSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtCmdtRoutVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
