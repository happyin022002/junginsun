...
*@FileName : EsmCoa0060ViewAdapter3.java
*@FileTitle : EsmCoa0060ViewAdapter3
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0060ViewAdapter3 extends DefaultViewAdapter {
	
    public EsmCoa0060ViewAdapter3(){
    	super();
    }
