...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutViaAllDSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutViaAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutViaAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutViaAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
