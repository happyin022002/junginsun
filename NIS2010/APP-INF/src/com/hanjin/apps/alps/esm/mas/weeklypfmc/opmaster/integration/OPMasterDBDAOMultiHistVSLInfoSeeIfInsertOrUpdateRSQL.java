...
*@FileName : OPMasterDBDAOMultiHistVSLInfoSeeIfInsertOrUpdateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistVSLInfoSeeIfInsertOrUpdateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistVSLInfoSeeIfInsertOrUpdateRSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistVSLInfoSeeIfInsertOrUpdateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select VSL_APLY_FM_DT FROM" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("          AND A.VSL_CD    = @[vsl_cd]) A" ).append("\n"); 
		...
		query.append("WHERE AA.VSL_APLY_FM_DT = TO_CHAR(SYSDATE, 'YYYY-MM-DD')" ).append("\n"); 
