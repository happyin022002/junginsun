...
*@FileName : BSAYearlyPlanDBDAOInsertBsaBudSltChtrCrrCapaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAYearlyPlanDBDAOInsertBsaBudSltChtrCrrCapaCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSA_BUD_SLT_CHTR_CRR_CAPA 데이타를 입력한다.
	  * </pre>
	  */
	public BSAYearlyPlanDBDAOInsertBsaBudSltChtrCrrCapaCSQL(){
		setQuery();
		...
		query.append("FileName : BSAYearlyPlanDBDAOInsertBsaBudSltChtrCrrCapaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
