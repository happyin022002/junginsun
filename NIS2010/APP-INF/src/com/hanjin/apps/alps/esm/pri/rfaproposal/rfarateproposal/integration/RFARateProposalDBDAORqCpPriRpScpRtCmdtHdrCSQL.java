...
*@FileName : RFARateProposalDBDAORqCpPriRpScpRtCmdtHdrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORqCpPriRpScpRtCmdtHdrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RqCpPriRpScpRtCmdtHdr
	  * </pre>
	  */
	public RFARateProposalDBDAORqCpPriRpScpRtCmdtHdrCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORqCpPriRpScpRtCmdtHdrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY A.QTTN_NO, A.QTTN_VER_NO" ).append("\n"); 
		query.append("                          ORDER BY A.QTTN_NO, A.QTTN_VER_NO, A.CMDT_HDR_SEQ) AS BLET_DP_SEQ" ).append("\n"); 
