...
*@FileName : PriScqBbHdrVO.java
*@FileTitle : PriScqBbHdrVO
*Open Issues :
*Change history :
...
public class PriScqBbHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriScqBbHdrVO> models = new ArrayList<PriScqBbHdrVO>();
	
	/* Column Info */
	private String maxCntrGrpNo = null;
	/* Column Info */
	...
	/* Column Info */
	private String aproRtAmt = null;
	/* Column Info */
	private String progStsNm = null;
	/* VO Data Value( C:Creation, U:Update, D:Delete ) */
	private String ibflag = null;
	/* Column Info */
	private String lastCntrGrpUsrId = null;
	/* Column Info */
	...
	public PriScqBbHdrVO() {}

	public PriScqBbHdrVO(String ibflag, String pagerows, String scqRqstNo, String scqVerNo, String progStsCd, String rqstOfcCd, String rqstSrepCd, String polCd, String polYdCd, String podCd, String podYdCd, String svcScpCd, String custCntCd, String custSeq, String rcvTermCd, String deTermCd, String propEffDt, String propExpDt, String aproEffDt, String aproExpDt, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String aproOfcCd, String spclCgoTpCd, String progSeq, String pgProgStsCd, String progOfcCd, String progUsrNm, String progUsrId, String progDt, String progRmk, String rqstSrepNm, String custLglEngNm, String progStsNm, String auth, String tsLocCd, String tsYdCd, String propRtAmt, String aproRtAmt, String lastFlg, String preProgStsCd, String rsltFlg, String maxCntrGrpNo, String lastCntrGrpUsrId, String laneCd, String vvdCd, String vpsEtaDt, String actCustCntCd, String actCustSeq, String actCustNm, String scqBidFlg, String measSysCd, String measSysCdVw) {
		this.maxCntrGrpNo = maxCntrGrpNo;
		this.auth = auth;
		...
		this.updDt = updDt;
		this.aproRtAmt = aproRtAmt;
		this.progStsNm = progStsNm;
		this.ibflag = ibflag;
		this.lastCntrGrpUsrId = lastCntrGrpUsrId;
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("max_cntr_grp_no", getMaxCntrGrpNo());
		...
		this.hashColumns.put("ts_yd_cd", getTsYdCd());
		...
		this.hashColumns.put("apro_rt_amt", getAproRtAmt());
		this.hashColumns.put("prog_sts_nm", getProgStsNm());
		this.hashColumns.put("ibflag", getIbflag());
		this.hashColumns.put("last_cntr_grp_usr_id", getLastCntrGrpUsrId());
	...
	public HashMap<String, String> getFieldNames(){
		this.hashFields.put("max_cntr_grp_no", "maxCntrGrpNo");
		...
		this.hashFields.put("ts_yd_cd", "tsYdCd");
		...
		this.hashFields.put("apro_rt_amt", "aproRtAmt");
		this.hashFields.put("prog_sts_nm", "progStsNm");
		this.hashFields.put("ibflag", "ibflag");
		this.hashFields.put("last_cntr_grp_usr_id", "lastCntrGrpUsrId");
	 ...
	 * @return maxCntrGrpNo
	 */
	public String getMaxCntrGrpNo() {
		return this.maxCntrGrpNo;
	}
	 ...
	 * @return aproRtAmt
	 */
	public String getAproRtAmt() {
		return this.aproRtAmt;
	}
	...
	/**
	 * Column Info
	 * @return lastCntrGrpUsrId
	 */
	public String getLastCntrGrpUsrId() {
		return this.lastCntrGrpUsrId;
	}
	 ...
	 * @return propRtAmt
	 */
	public String getPropRtAmt() {
		return this.propRtAmt;
	}
	 ...
	 * @param maxCntrGrpNo
	 */
	public void setMaxCntrGrpNo(String maxCntrGrpNo) {
		this.maxCntrGrpNo = maxCntrGrpNo;
	}
	 ...
	 * @param tsYdCd
	 */
	public void setTsYdCd(String tsYdCd) {
		this.tsYdCd = tsYdCd;
	}
	 ...
	 * @param aproRtAmt
	 */
	public void setAproRtAmt(String aproRtAmt) {
		this.aproRtAmt = aproRtAmt;
	}
	...
	/**
	 * Column Info
	 * @param lastCntrGrpUsrId
	 */
	public void setLastCntrGrpUsrId(String lastCntrGrpUsrId) {
		this.lastCntrGrpUsrId = lastCntrGrpUsrId;
	}
	 ...
	 * @param propRtAmt
	 */
	public void setPropRtAmt(String propRtAmt) {
		this.propRtAmt = propRtAmt;
	}
	 ...
	 * @param tsLocCd
	 */
	public void setTsLocCd(String tsLocCd) {
		this.tsLocCd = tsLocCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setMaxCntrGrpNo(JSPUtil.getParameter(request, prefix + "max_cntr_grp_no", ""));
		...
		setTsYdCd(JSPUtil.getParameter(request, prefix + "ts_yd_cd", ""));
		...
		setAproRtAmt(JSPUtil.getParameter(request, prefix + "apro_rt_amt", ""));
		setProgStsNm(JSPUtil.getParameter(request, prefix + "prog_sts_nm", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setLastCntrGrpUsrId(JSPUtil.getParameter(request, prefix + "last_cntr_grp_usr_id", ""));
	 ...
	 */
	public PriScqBbHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriScqBbHdrVO[]
	 */
	public PriScqBbHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriScqBbHdrVO model = null;
		...
		try {
			String[] maxCntrGrpNo = (JSPUtil.getParameter(request, prefix	+ "max_cntr_grp_no", length));
			...
			String[] tsYdCd = (JSPUtil.getParameter(request, prefix	+ "ts_yd_cd", length));
			...
			String[] aproRtAmt = (JSPUtil.getParameter(request, prefix	+ "apro_rt_amt", length));
			String[] progStsNm = (JSPUtil.getParameter(request, prefix	+ "prog_sts_nm", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] lastCntrGrpUsrId = (JSPUtil.getParameter(request, prefix	+ "last_cntr_grp_usr_id", length));
			...
			String[] propRtAmt = (JSPUtil.getParameter(request, prefix	+ "prop_rt_amt", length));
			...
			String[] tsLocCd = (JSPUtil.getParameter(request, prefix	+ "ts_loc_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new PriScqBbHdrVO();
				if (maxCntrGrpNo[i] != null)
					model.setMaxCntrGrpNo(maxCntrGrpNo[i]);
				if (auth[i] != null)
				...
				if (aproRtAmt[i] != null)
					model.setAproRtAmt(aproRtAmt[i]);
				if (progStsNm[i] != null)
					model.setProgStsNm(progStsNm[i]);
				if (ibflag[i] != null)
					model.setIbflag(ibflag[i]);
				if (lastCntrGrpUsrId[i] != null)
					model.setLastCntrGrpUsrId(lastCntrGrpUsrId[i]);
	...
	public PriScqBbHdrVO[] getPriScqBbHdrVOs(){
		PriScqBbHdrVO[] vos = (PriScqBbHdrVO[])models.toArray(new PriScqBbHdrVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		this.maxCntrGrpNo = this.maxCntrGrpNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.tsYdCd = this.tsYdCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.aproRtAmt = this.aproRtAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.progStsNm = this.progStsNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.lastCntrGrpUsrId = this.lastCntrGrpUsrId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.propRtAmt = this.propRtAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.tsLocCd = this.tsLocCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
