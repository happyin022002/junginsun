...
*@FileName : PerformanceReportDBDAOSearchReportByRaterUserGroupListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchReportByRaterUserGroupListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchReportByRaterUserGroupListVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esm.bkg.bookingreport.performancereport.integration").append("\n"); 
		query.append("FileName : PerformanceReportDBDAOSearchReportByRaterUserGroupListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
