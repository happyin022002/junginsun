...
public class Eur24ManifestDownloadDBDAOSearchVesselFIArrivalNoticeRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC', TO_DATE(BKG_GET_TOKEN_FNC(EDI, 1),'YYYYMMDDHH24MISS')  , BKG_GET_TOKEN_FNC(EDI, 8) ), 'YYYYMMDD') AS EDI_RCV_DT," ).append("\n"); 
