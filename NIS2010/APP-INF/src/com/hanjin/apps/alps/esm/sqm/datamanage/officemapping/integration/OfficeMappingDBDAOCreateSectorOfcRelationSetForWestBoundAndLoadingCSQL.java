...
*@FileName : OfficeMappingDBDAOCreateSectorOfcRelationSetForWestBoundAndLoadingCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OfficeMappingDBDAOCreateSectorOfcRelationSetForWestBoundAndLoadingCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *  - 타임아웃 방지를 위해 OfficeMappingDBDAOCreateSectorOfcRelationSetCSQL.Query의 데이터를 나누어 생성되게 함(여기서는 W 바운드의 Loading 데이터만 생성)
	  * 2015.08.10 김용습 SQM_ACT_FLG 가져오는 서브쿼리에 A1.PF_GRP_CD  = A3.PF_GRP_CD 추가
	  * </pre>
	  */
	public OfficeMappingDBDAOCreateSectorOfcRelationSetForWestBoundAndLoadingCSQL(){
		setQuery();
		...
		query.append("FileName : OfficeMappingDBDAOCreateSectorOfcRelationSetForWestBoundAndLoadingCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
