...
*@FileName : AusCustomsTransmissionDBDAOsearchContainerDangerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AusCustomsTransmissionDBDAOsearchContainerDangerRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AusCustomsTransmissionDBDAOsearchContainerDangerRSQL(){
		setQuery();
		...
		query.append("FileName : AusCustomsTransmissionDBDAOsearchContainerDangerRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		NVL(DG.PRP_SHP_NM,'') shp_nm," ).append("\n"); 
		query.append("		NVL(DG.EMER_CNTC_PHN_NO_CTNT,'') phone," ).append("\n"); 
		query.append("		'' page_list," ).append("\n"); 
		query.append("		NVL(UN.FLSH_PNT_TEMP_CTNT,0) flsh_temp," ).append("\n"); 
		query.append("		'' flsh_unit," ).append("\n"); 
		query.append("		REPLACE(NVL(DG.DIFF_RMK,''),CHR(13)||CHR(10),'') dg_remark" ).append("\n"); 
		query.append("		 " ).append("\n"); 
