...
*@FileName : Eur24ManifestDownloadDBDAOSearchEU24EDIHoldHistoryOBRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Eur24ManifestDownloadDBDAOSearchEU24EDIHoldHistoryOBRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Eur24ManifestDownloadDBDAOSearchEU24EDIHoldHistoryOBRSQL(){
		setQuery();
		...
		query.append("FileName : Eur24ManifestDownloadDBDAOSearchEU24EDIHoldHistoryOBRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC('SELSC',RCV.CRE_DT, SND_USR_OFC_CD ), 'YYYY-MM-DD HH24:MI:SS') AS LOCAL_TIME" ).append("\n"); 
		...
		query.append("   AND SND.BL_NO           = @[p_bl_no]" ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append(" ORDER BY GMT_TIME DESC )A" ).append("\n"); 
		query.append(" WHERE ROWNUM =1" ).append("\n"); 
		query.append(" AND RESULT IN ('Hold Release', 'Hold(Doc.)')" ).append("\n"); 
