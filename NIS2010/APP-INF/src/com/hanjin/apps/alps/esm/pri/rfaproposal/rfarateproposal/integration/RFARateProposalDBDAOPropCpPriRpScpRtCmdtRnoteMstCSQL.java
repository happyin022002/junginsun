...
*@FileName : RFARateProposalDBDAOPropCpPriRpScpRtCmdtRnoteMstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPropCpPriRpScpRtCmdtRnoteMstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPropCpPriRpScpRtCmdtRnoteMstCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPropCpPriRpScpRtCmdtRnoteMstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    )" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(", NOTE_CONTS AS (" ).append("\n"); 
		query.append("    SELECT A.PROP_NO" ).append("\n"); 
		query.append("         ,A.AMDT_SEQ" ).append("\n"); 
		query.append("         ,A.SVC_SCP_CD" ).append("\n"); 
		...
		query.append("         FROM PRI_RP_SCP_RT_CMDT_RNOTE A, PRI_RFA_NOTE_CONV B, CMDT_ROUT C" ).append("\n"); 
		...
		query.append("     , NOTE_CONV_CHG_CD NOTE_CTNT" ).append("\n"); 
		...
		query.append("AND   N.PROP_NO = R.PROP_NO" ).append("\n"); 
		query.append("AND   N.AMDT_SEQ = R.AMDT_SEQ" ).append("\n"); 
		query.append("AND   N.SVC_SCP_CD = R.SVC_SCP_CD" ).append("\n"); 
		query.append("AND   N.CMDT_HDR_SEQ = R.OLD_CMDT_HDR_SEQ" ).append("\n"); 
		query.append("AND   N.ROUT_SEQ = R.OLD_ROUT_SEQ" ).append("\n"); 
