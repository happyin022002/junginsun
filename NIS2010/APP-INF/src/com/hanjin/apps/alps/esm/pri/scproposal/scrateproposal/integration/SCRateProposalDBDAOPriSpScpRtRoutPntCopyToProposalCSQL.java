...
*@FileName : SCRateProposalDBDAOPriSpScpRtRoutPntCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtRoutPntCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpRtRoutPntCopyToProposal
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtRoutPntCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtRoutPntCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DENSE_RANK() OVER (PARTITION BY S.QTTN_NO, S.QTTN_VER_NO, S.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("                                     , S.CMDT_HDR_SEQ, S.ROUT_SEQ, S.ORG_DEST_TP_CD" ).append("\n"); 
		query.append("                          ORDER BY S.QTTN_NO, S.QTTN_VER_NO, S.GEN_SPCL_RT_TP_CD" ).append("\n"); 
		query.append("                                 , S.CMDT_HDR_SEQ, S.ROUT_SEQ, S.ORG_DEST_TP_CD, S.ROUT_PNT_SEQ) AS ROUT_PNT_SEQ" ).append("\n"); 
		...
		query.append("    ,PRI_SQ_RT_ROUT_PNT S" ).append("\n"); 
