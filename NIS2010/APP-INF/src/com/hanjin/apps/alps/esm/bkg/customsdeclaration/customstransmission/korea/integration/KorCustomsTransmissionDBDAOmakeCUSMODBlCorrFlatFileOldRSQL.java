...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSMODBlCorrFlatFileOldRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSMODBlCorrFlatFileOldRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSMODBlCorrFlatFileOldRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSMODBlCorrFlatFileOldRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
