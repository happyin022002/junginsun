...
*@FileName : RFARateProposalDBDAOPriRpScpRtSurchargeCostDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtSurchargeCostDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtSurchargeCostDetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtSurchargeCostDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET  PRS_SCG_AMT = (SELECT SUM(ADJ_SCG_USD_AMT) FROM PRI_RP_SCP_RT_SCG B " ).append("\n"); 
