...
*@FileName : SCLoadingAgentProposalDBDAOPriSpScpLodgAgnInquiryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCLoadingAgentProposalDBDAOPriSpScpLodgAgnInquiryVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpLodgAgnInquiryVO
	  * </pre>
	  */
	public SCLoadingAgentProposalDBDAOPriSpScpLodgAgnInquiryVORSQL(){
		setQuery();
		...
		query.append("FileName : SCLoadingAgentProposalDBDAOPriSpScpLodgAgnInquiryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" ORDER BY A.CUST_CNT_CD||LPAD(A.CUST_SEQ, 6, '0')" ).append("\n"); 
