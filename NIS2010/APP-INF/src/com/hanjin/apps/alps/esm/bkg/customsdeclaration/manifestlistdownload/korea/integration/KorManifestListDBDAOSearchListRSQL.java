...
public class KorManifestListDBDAOSearchListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOSearchListRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		//query.append(", NVL(B.BKG_NO,' ') || NVL(B.BKG_NO_SPLIT,'  ') AS BKG_NO" ).append("\n"); 
		...
		query.append(", DECODE(DECODE(TRIM(NVL(C.CSTMS_CLR_TP_CD,' ')||NVL(C.CSTMS_DCHG_LOC_WH_CD,' ')),'',0," ).append("\n"); 
		query.append("LENGTH(TRIM(NVL(C.CSTMS_CLR_TP_CD,' ')||NVL(C.CSTMS_DCHG_LOC_WH_CD,' ')))),0,'N','Y') BAC" ).append("\n"); 
		...
		query.append(", DECODE(DECODE(TRIM(NVL(C.CSTMS_CLR_TP_CD,' ')||NVL(C.CSTMS_DCHG_LOC_WH_CD,' ')),'',0," ).append("\n"); 
		query.append("LENGTH(TRIM(NVL(C.CSTMS_CLR_TP_CD,' ')||NVL(C.CSTMS_DCHG_LOC_WH_CD,' ')))),0,'N','Y') HIDDEN4" ).append("\n"); 
		...
		//query.append("AND B.BKG_NO_SPLIT  = E.bkg_no_split" ).append("\n"); 
		...
		//query.append("AND B.BKG_NO_SPLIT  = C.BKG_NO_SPLIT(+)" ).append("\n"); 
