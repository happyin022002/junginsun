...
*@FileName : EsmMas0047Event.java
*@FileTitle : EsmMas0047Event
*Open Issues :
*Change history :
...
/**
 * ESM_MAS_0047 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_MAS_0047HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Ki Dae
 * @see ESM_MAS_0047HTMLAction 참조
 * @since J2EE 1.6
 */
public class EsmMas0047Event extends EventSupport {
	...
	/** Constructor */
	public EsmMas0047Event(){}	
	
	/** return Name of Event*/
	public String getEventName(){
		return "EsmMas0047Event";
	}
