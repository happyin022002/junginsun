...
public class SalesRPTDBDAOsearchBkg0061List3RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                 FROM MAS_BKG_COST_ACT_GRP_SMRY A" ).append("\n"); 
		query.append("                                     ,MAS_BKG_COST_SRC_DTL B" ).append("\n"); 
		...
		query.append("                           AND (CASE WHEN A1.STND_COST_CD IN ('52101013', '52201013', '52101012', '52201012')" ).append("\n"); 
		query.append("                                        THEN '52101014'" ).append("\n"); 
		query.append("                                     WHEN A1.STND_COST_CD IN ('52301013', '52301012')" ).append("\n"); 
		query.append("                                        THEN '52301014'" ).append("\n"); 
		query.append("                                     WHEN A1.STND_COST_CD IN ('52401013', '52401012')" ).append("\n"); 
		query.append("                                        THEN '52401014'" ).append("\n"); 
		query.append("                                     WHEN A1.STND_COST_CD IN ('52601013', '52601012')" ).append("\n"); 
		query.append("                                        THEN '52601014'" ).append("\n"); 
		query.append("                                     ELSE A1.STND_COST_CD" ).append("\n"); 
		query.append("                                 END) = A3.STND_COST_CD " ).append("\n"); 
		query.append("                           AND A3.STND_COST_CD NOT IN ( '52101013', '52201013', '52101012', '52201012'" ).append("\n"); 
		...
		query.append("                       , SUM(D2.ESTM_USD_TTL_AMT)         AS AMT" ).append("\n"); 
		...
		query.append("                #if ( ${f_rout_no} != 'All' )" ).append("\n"); 
		query.append("                                    AND A.COST_ROUT_NO = @[f_rout_no]" ).append("\n"); 
		query.append("                #end" ).append("\n"); 
		query.append("                #if ( ${f_cntr_tpsz_cd} != '' )" ).append("\n"); 
