 ...
 *@FileName : ESM_PRI_2086HTMLAction.java
...
public class ESM_PRI_2086HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_2086HTMLAction 객체를 생성
	 */
	public ESM_PRI_2086HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2086Event event = new EsmPri2086Event();
