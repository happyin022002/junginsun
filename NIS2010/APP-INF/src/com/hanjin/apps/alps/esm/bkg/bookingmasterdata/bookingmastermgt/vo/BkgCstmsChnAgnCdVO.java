...
*@FileName : BkgCstmsChnAgnCdVO.java
*@FileTitle : BkgCstmsChnAgnCdVO
*Open Issues :
*Change history :
...
public class BkgCstmsChnAgnCdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsChnAgnCdVO> models = new ArrayList<BkgCstmsChnAgnCdVO>();
	...
	public BkgCstmsChnAgnCdVO() {}

	public BkgCstmsChnAgnCdVO(String ibflag, String pagerows, String agnCtrlOfcCd, String podCd, String chnCstmsAgnCd, String slanCd, String chnCstmsAgnNm) {
		this.podCd = podCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public BkgCstmsChnAgnCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsChnAgnCdVO[]
	 */
	public BkgCstmsChnAgnCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsChnAgnCdVO model = null;
	...
	public BkgCstmsChnAgnCdVO[] getBkgCstmsChnAgnCdVOs(){
		BkgCstmsChnAgnCdVO[] vos = (BkgCstmsChnAgnCdVO[])models.toArray(new BkgCstmsChnAgnCdVO[models.size()]);
		return vos;
	}
