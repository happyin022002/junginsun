...
*@FileName : SendFmcFileCorrectedCopyBackEndJob.java
*@FileTitle : S/C Send FMC FileCorrectedCopy Webservice 
*Open Issues :
*Change history :
...
/**
 * S/C Send FMC FileCorrectedCopy Webservice 비지니스 트랜잭션을 처리한다.
 * 
 * @author Song Ho Jin
 * @see SCProposalMainDBDAO
 * @since J2EE 1.6
 */
public class SendFmcFileCorrectedCopyBackEndJob extends BackEndCommandSupport{
	...
	/**
	 * S/C Send FMC FileCorrectedCopy Webservice 조건을 셋팅한다. <br>
	 *  
	 ...
	 * @exception
	 */	
	public void setSendFmcFileCorrectedCopyVO( CstPriSpMnFileDtVO fileDtVo, SignOnUserAccount account) {
		this.fileDtVo = fileDtVo;
		this.account = account;
	}

	/**
	 * S/C Send FMC FileCorrectedCopy Webservice 을 수행한다. <br>
	 *  
