...
*@FileName : RevenueDebitNoteDBDAOBkgRevDrNotesStatusSummaryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RevenueDebitNoteDBDAOBkgRevDrNotesStatusSummaryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDN Status Summary를 조회한다.
	  * </pre>
	  */
	public RevenueDebitNoteDBDAOBkgRevDrNotesStatusSummaryRSQL(){
		setQuery();
		...
		query.append("FileName : RevenueDebitNoteDBDAOBkgRevDrNotesStatusSummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(RDN_NO) TTL_CNT," ).append("\n"); 
		query.append("       SUM(USD_AMT) TTL_USD_AMT," ).append("\n"); 
		query.append("       SUM(CASE WHEN STL_PRD_DYS BETWEEN 0 AND 10 THEN 1 ELSE 0 END) WITHIN_10_DYS," ).append("\n"); 
		query.append("       SUM(CASE WHEN STL_PRD_DYS BETWEEN 11 AND 20 THEN 1 ELSE 0 END) WITHIN_20_DYS," ).append("\n"); 
		query.append("       SUM(CASE WHEN STL_PRD_DYS > 20 THEN 1 ELSE 0 END) OVER_20_DYS," ).append("\n"); 
		query.append("       ROUND(SUM(CASE WHEN STL_PRD_DYS > 20 THEN 1 ELSE 0 END)/COUNT(RDN_NO) * 100,2) OVER_20_DYS_RTO" ).append("\n"); 
