...
*@FileName : RsltPriRqGrpLocDtlVO.java
*@FileTitle : RsltPriRqGrpLocDtlVO
*Open Issues :
*Change history :
...
public class RsltPriRqGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriRqGrpLocDtlVO> models = new ArrayList<RsltPriRqGrpLocDtlVO>();
	...
	public RsltPriRqGrpLocDtlVO() {}

	public RsltPriRqGrpLocDtlVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpLocSeq, String grpLocDtlSeq, String locCd, String locNm, String srcInfoCd, String srcInfoNm, String creUsrId, String creDt, String updUsrId, String updDt, String svcScpCd) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public RsltPriRqGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriRqGrpLocDtlVO[]
	 */
	public RsltPriRqGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriRqGrpLocDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriRqGrpLocDtlVO();
				if (updDt[i] != null)
		...
		return getRsltPriRqGrpLocDtlVOs();
	}
	 ...
	 * @return RsltPriRqGrpLocDtlVO[]
	 */
	public RsltPriRqGrpLocDtlVO[] getRsltPriRqGrpLocDtlVOs(){
		RsltPriRqGrpLocDtlVO[] vos = (RsltPriRqGrpLocDtlVO[])models.toArray(new RsltPriRqGrpLocDtlVO[models.size()]);
		return vos;
	}
