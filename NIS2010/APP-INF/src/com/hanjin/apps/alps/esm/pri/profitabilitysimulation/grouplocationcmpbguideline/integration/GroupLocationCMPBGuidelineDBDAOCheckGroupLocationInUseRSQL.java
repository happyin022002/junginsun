...
*@FileName : GroupLocationCMPBGuidelineDBDAOCheckGroupLocationInUseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GroupLocationCMPBGuidelineDBDAOCheckGroupLocationInUseRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GroupLocationCMPBGuidelineDBDAOCheckGroupLocationInUseRSQL(){
		setQuery();
		...
		query.append("FileName : GroupLocationCMPBGuidelineDBDAOCheckGroupLocationInUseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND PRS_CUST_TP_CD  = @[cre_usr_id]" ).append("\n"); 
