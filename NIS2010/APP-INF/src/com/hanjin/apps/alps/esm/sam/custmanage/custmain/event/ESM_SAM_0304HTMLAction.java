...
*@FileName : ESM_SAM_0304HTMLAction.java
*@FileTitle : customer
*Open Issues :
*Change history :
...
public class ESM_SAM_0304HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0304HTMLAction 객체를 생성
	 */
	public ESM_SAM_0304HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmSam0304Event event = new EsmSam0304Event(cust_cnt_cd, cust_nm, loc_cd, cust_rgst_no, match_rule, iPage);            	
