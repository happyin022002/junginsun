...
public class GeneralBookingSearchDBDAOSearchBkgInfoForHistRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("WHERE SKD.VSL_CD      = DECODE(N1ST_VVD.VSL_CD, 'HJXX', 'X', 'HJYY', 'X', 'HJZZ', 'X', N1ST_VVD.VSL_CD)" ).append("\n"); 
		...
		query.append(", (SELECT TO_CHAR(SKD.VPS_ETB_DT, 'YYYY-MM-DD')" ).append("\n"); 
		query.append("FROM VSK_VSL_PORT_SKD SKD" ).append("\n"); 
		query.append("WHERE SKD.VSL_CD      = DECODE(TRNK_VVD.VSL_CD, 'HJXX', 'X', 'HJYY', 'X', 'HJZZ', 'X', TRNK_VVD.VSL_CD)" ).append("\n"); 
