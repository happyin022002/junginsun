...
*@FileName : ESM_BKG_0361_02HTMLAction.java
*@FileTitle : Export/Import Information(KOR)
*Open Issues :
*Change history :
...
public class ESM_BKG_0361_02HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0361_02HTMLAction 객체를 생성
	 */
	public ESM_BKG_0361_02HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        log.debug("##### CALL:ESM_BKG_0361_02HTMLAction - " + command.getCommand());
