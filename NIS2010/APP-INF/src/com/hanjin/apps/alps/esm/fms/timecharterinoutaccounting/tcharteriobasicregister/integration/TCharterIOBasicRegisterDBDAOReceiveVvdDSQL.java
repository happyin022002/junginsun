...
*@FileName : TCharterIOBasicRegisterDBDAOReceiveVvdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOBasicRegisterDBDAOReceiveVvdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TCharterIOBasicRegisterDBDAOReceiveVvdDSQL
	  * </pre>
	  */
	public TCharterIOBasicRegisterDBDAOReceiveVvdDSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOBasicRegisterDBDAOReceiveVvdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
