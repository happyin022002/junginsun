...
*@FileName : ModelManageDBDAOUpdateSmpDlyFcastCustAmendUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ModelManageDBDAOUpdateSmpDlyFcastCustAmendUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ModelManageDBDAOUpdateSmpDlyFcastCustAmendUSQL(){
		setQuery();
		...
		query.append("FileName : ModelManageDBDAOUpdateSmpDlyFcastCustAmendUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SPC_DLY_FCAST_CUST C" ).append("\n"); 
