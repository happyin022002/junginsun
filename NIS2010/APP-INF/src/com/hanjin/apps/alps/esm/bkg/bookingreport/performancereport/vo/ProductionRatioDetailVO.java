...
*@FileName : ProductionRatioDetailVO.java
*@FileTitle : ProductionRatioDetailVO
*Open Issues :
*Change history :
...
public class ProductionRatioDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ProductionRatioDetailVO> models = new ArrayList<ProductionRatioDetailVO>();
	...
	public ProductionRatioDetailVO() {}

	public ProductionRatioDetailVO(String ibflag, String pagerows, String rgnOfcCd, String bkgOfcCd, String bkgNo, String srWrkStsDt, String blDocInpFlg, String blRtFlg, String blAudFlg, String pndFlg, String srWrkStsCd, String fntOfcRtnCd) {
		this.pndFlg = pndFlg;
...
/**
	 ...
	 * @param request
	 * @return ProductionRatioDetailVO[]
	 */
	public ProductionRatioDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ProductionRatioDetailVO[]
	 */
	public ProductionRatioDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ProductionRatioDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ProductionRatioDetailVO();
				if (pndFlg[i] != null)
		...
		return getProductionRatioDetailVOs();
	}
	 ...
	 * @return ProductionRatioDetailVO[]
	 */
	public ProductionRatioDetailVO[] getProductionRatioDetailVOs(){
		ProductionRatioDetailVO[] vos = (ProductionRatioDetailVO[])models.toArray(new ProductionRatioDetailVO[models.size()]);
		return vos;
	}
