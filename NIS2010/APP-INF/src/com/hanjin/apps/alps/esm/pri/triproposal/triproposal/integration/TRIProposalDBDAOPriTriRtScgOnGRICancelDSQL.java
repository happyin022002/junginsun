...
*@FileName : TRIProposalDBDAOPriTriRtScgOnGRICancelDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgOnGRICancelDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgOnGRICancelDSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgOnGRICancelDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_TRI_RT_SCG T" ).append("\n"); 
