...
*@FileName : RFARateQuotationDBDAORsltRtListVerticalExcelForIHCVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAORsltRtListVerticalExcelForIHCVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Quotation Vertical Download
	  * </pre>
	  */
	public RFARateQuotationDBDAORsltRtListVerticalExcelForIHCVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAORsltRtListVerticalExcelForIHCVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                 ,NVL(T.QTTN_RT_AMT, 0)- NVL(T.FIC_QTTN_RT_AMT, 0) AS QTTN_BOF_AMT" ).append("\n"); 
		query.append("                                 ,LPAD(T.CMDT_HDR_SEQ, 5, '0') || '|' || LPAD(T.ROUT_SEQ, 5, '0') || '|' ||" ).append("\n"); 
		query.append("                                  LPAD(ROW_NUMBER() OVER(PARTITION BY T.QTTN_NO, T.QTTN_VER_NO, T.CMDT_HDR_SEQ, T.ROUT_SEQ " ).append("\n"); 
