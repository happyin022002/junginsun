...
*@FileName : Jp24ManifestListDownloadDBDAOSearchErrorReportForAmrCmrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Jp24ManifestListDownloadDBDAOSearchErrorReportForAmrCmrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Jp24ManifestListDownloadDBDAOSearchErrorReportForAmrCmrRSQL(){
		setQuery();
		...
		query.append("FileName : Jp24ManifestListDownloadDBDAOSearchErrorReportForAmrCmrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       (SELECT REPLACE(M.ATTR_CTNT4, '\r', '\n')" ).append("\n"); 
		...
		query.append("       (SELECT REPLACE(M.ATTR_CTNT5, '\r', '\n')" ).append("\n"); 
		query.append("          FROM BKG_CSTMS_CD_CONV_CTNT M" ).append("\n"); 
		query.append("         WHERE M.ATTR_CTNT1 = C.ATTR_CTNT1" ).append("\n"); 
		...
		query.append("                                                      FROM BKG_CSTMS_ADV_JP_RCV_LOG" ).append("\n"); 
		query.append("                                                     WHERE BKG_NO = @[bl_no]" ).append("\n"); 
		query.append("                                                       AND JP_MSG_TP_ID = @[jp_msg_tp_id])) RSLT" ).append("\n"); 
		query.append("" ).append("\n"); 
