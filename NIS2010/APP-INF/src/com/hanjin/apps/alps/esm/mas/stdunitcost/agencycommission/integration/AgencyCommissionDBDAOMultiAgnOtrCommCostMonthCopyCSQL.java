...
*@FileName : AgencyCommissionDBDAOMultiAgnOtrCommCostMonthCopyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgencyCommissionDBDAOMultiAgnOtrCommCostMonthCopyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgencyCommissionDBDAOMultiAgnOtrCommCostMonthCopyCSQL(){
		setQuery();
		...
		query.append("FileName : AgencyCommissionDBDAOMultiAgnOtrCommCostMonthCopyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT  INTO MAS_OTR_COMM (" ).append("\n"); 
