...
*@FileName : ESM_PRI_6039HTMLAction.java
...
public class ESM_PRI_6036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6036HTMLAction 객체를 생성
	 */
	public ESM_PRI_6036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6036Event event = new EsmPri6036Event();
		

		if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriCmpbGlineMnVO((PriCmpbGlineMnVO) getVO(request, PriCmpbGlineMnVO.class));
			event.setRsltDurationCreationOfficeVO((RsltDurationCreationOfficeVO) getVO(request, RsltDurationCreationOfficeVO.class));
		}
