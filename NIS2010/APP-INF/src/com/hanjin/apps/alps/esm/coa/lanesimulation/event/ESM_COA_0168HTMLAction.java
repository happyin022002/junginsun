...
*@FileName : ESM_COA_168HTMLAction.java
 ...
 *
 * @author Park Eun Ju
 * @see EsmCoa0168Event 참조
 * @since J2EE 1.6
 */
public class ESM_COA_0168HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_COA_0168HTMLAction 객체를 생성
	 */
	public ESM_COA_0168HTMLAction() {
		//
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmCoa0168Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmCoa0168Event event = new EsmCoa0168Event();
  	    if(command.isCommand(FormCommand.SEARCHLIST)){
  	    	...
  	    	event.setMultiSimSummaryRptVOS((MultiSimSummaryRptVO[])getVOs(request, MultiSimSummaryRptVO .class));
  	    } else {
  	    	event.setSearchSimLaneListConditionVO((SearchSimLaneListConditionVO)getVO(request, SearchSimLaneListConditionVO .class));
  	    }
		return  event;
