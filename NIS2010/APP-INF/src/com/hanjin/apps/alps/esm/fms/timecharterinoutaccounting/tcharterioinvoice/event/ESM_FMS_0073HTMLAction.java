...
*@FileName : ESM_FMS_0073HTMLAction.java
 ...
 * @author JUNGYOONTAE
 * @see EsmFms0073Event 참조
 * @since J2EE 1.5
 */

public class ESM_FMS_0073HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_FMS_0073HTMLAction 객체를 생성
	 */
	public ESM_FMS_0073HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmFms0073Event event = new EsmFms0073Event();
		
		String off_prefix = "off_";

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCondSearchOffhireInvoiceVmsVO((CondSearchOffhireInvoiceVmsVO)getVO(request, CondSearchOffhireInvoiceVmsVO.class));
			
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomOffhExpnVOS((CustomOffhExpnVO[])getVOs(request, CustomOffhExpnVO.class, off_prefix));
