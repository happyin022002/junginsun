...
*@FileName : BLDocumentationCMDBDAOModifyBkgCustShpRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLDocumentationCMDBDAOModifyBkgCustShpRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BkgCustShpRqst 수정 쿼리
	  * </pre>
	  */
	public BLDocumentationCMDBDAOModifyBkgCustShpRqstUSQL(){
		setQuery();
		...
		query.append("FileName : BLDocumentationCMDBDAOModifyBkgCustShpRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
