...
import com.hanjin.apps.alps.esm.pri.pricommon.pricommon.integration.PRICommonDBDAOSearchTariffCodeNameRSQL;
...
public class TariffCodeDBDAO extends DBDAOSupport {
	 ...
	 * 
	 * @param RsltSvcScpCdVO rsltSvcScpCdVO List<String> checkVoList
