...
*@FileName : KoreaCustomsReportDBDAOsearchTransHistByETARSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KoreaCustomsReportDBDAOsearchTransHistByETARSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KoreaCustomsReportDBDAOsearchTransHistByETARSQL(){
		setQuery();
		...
		query.append("FileName : KoreaCustomsReportDBDAOsearchTransHistByETARSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND TO_CHAR(ETA_DT, 'YYYYMMDD') BETWEEN @[in_snd_dt_s] AND @[in_snd_dt_e]" ).append("\n"); 
