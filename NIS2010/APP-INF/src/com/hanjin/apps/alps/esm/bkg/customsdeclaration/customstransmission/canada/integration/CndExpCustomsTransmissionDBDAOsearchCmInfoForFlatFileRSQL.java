...
*@FileName : CndExpCustomsTransmissionDBDAOsearchCmInfoForFlatFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchCmInfoForFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchCmInfoForFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchCmInfoForFlatFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM  BKG_CSTMS_AMER_CNTR_MF CM" ).append("\n"); 
		...
		query.append("           FROM BKG_CSTMS_AMER_BL BL, BKG_DG_CGO DG" ).append("\n"); 
		...
		query.append("   AND  CM.IO_BND_CD    = 'O'" ).append("\n"); 
