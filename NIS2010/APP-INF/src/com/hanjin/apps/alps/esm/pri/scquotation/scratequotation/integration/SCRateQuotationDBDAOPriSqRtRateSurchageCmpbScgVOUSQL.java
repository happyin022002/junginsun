...
*@FileName : SCRateQuotationDBDAOPriSqRtRateSurchageCmpbScgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtRateSurchageCmpbScgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRateSurchageCmpbScgVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRateSurchageCmpbScgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_SQ_RT RT" ).append("\n"); 
		...
		query.append("        FROM PRI_SQ_RT_SCG" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("        GROUP BY QTTN_NO ,QTTN_VER_NO ,GEN_SPCL_RT_TP_CD ,CMDT_HDR_SEQ ,ROUT_SEQ ,RT_SEQ" ).append("\n"); 
