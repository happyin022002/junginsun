...
public class FFCommCalculationDBDAOSearchFFAGMTRateInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  TO_CHAR(A.FF_SEQ, 'FM000000') FF_SEQ," ).append("\n"); 
		query.append("  A.SHPR_CNT_CD," ).append("\n"); 
		query.append("  TO_CHAR(A.SHPR_SEQ, 'FM000000') SHPR_SEQ," ).append("\n"); 
		query.append("  A.FF_DIV_CD," ).append("\n"); 
		query.append("  A.FF_BKG_RT," ).append("\n"); 
		query.append("  NVL(RTRIM(A.FF_CHG_CTNT), ' ') FF_CHG_CTNT," ).append("\n"); 
		query.append("  NVL(A.FF_BX_AMT, 0) FF_BX_AMT," ).append("\n"); 
		query.append("  NVL(A.FF_TEU_AMT, 0) FF_TEU_AMT," ).append("\n"); 
		query.append("  NVL(A.FF_FEU_AMT, 0) FF_FEU_AMT," ).append("\n"); 
		query.append("  NVL(A.FF_RF_AMT, 0) FF_RF_AMT," ).append("\n"); 
		...
		query.append("    FROM (SELECT NVL(SHPR_CNT_CD, '*') || NVL(SHPR_SEQ, 0) X" ).append("\n"); 
		...
		query.append("    SELECT MAX(X)" ).append("\n"); 
		query.append("    FROM (SELECT NVL(SC_NO, '*') X" ).append("\n"); 
		query.append("          FROM ACM_FF_AGMT" ).append("\n"); 
		query.append("          WHERE FF_CNT_CD = @[bkg_ff_cnt_cd]" ).append("\n"); 
		query.append("            AND FF_SEQ = TO_NUMBER(NVL(@[ff_cust_seq_tmp], @[bkg_ff_seq]))" ).append("\n"); 
		query.append("            AND NVL(SHPR_CNT_CD, '*') IN (@[shpr_cnt_cd], '*')" ).append("\n"); 
		...
		query.append("    SELECT MAX(X)" ).append("\n"); 
		query.append("    FROM (SELECT NVL(RFA_NO, '*') X" ).append("\n"); 
		query.append("          FROM ACM_FF_AGMT" ).append("\n"); 
		query.append("          WHERE FF_CNT_CD = @[bkg_ff_cnt_cd]" ).append("\n"); 
		query.append("            AND FF_SEQ = TO_NUMBER(NVL(@[ff_cust_seq_tmp], @[bkg_ff_seq]))" ).append("\n"); 
		query.append("            AND NVL(SHPR_CNT_CD, '*') IN (@[shpr_cnt_cd], '*')" ).append("\n"); 
		...
		query.append("    SELECT MAX(X)" ).append("\n"); 
		query.append("    FROM (SELECT NVL(CMDT_CD, '*') X" ).append("\n"); 
		query.append("          FROM ACM_FF_AGMT" ).append("\n"); 
		query.append("          WHERE FF_CNT_CD = @[bkg_ff_cnt_cd]" ).append("\n"); 
		query.append("            AND FF_SEQ = TO_NUMBER(NVL(@[ff_cust_seq_tmp], @[bkg_ff_seq]))" ).append("\n"); 
		query.append("            AND NVL(SHPR_CNT_CD, '*') IN (@[shpr_cnt_cd], '*')" ).append("\n"); 
		...
		query.append("    )" ).append("\n"); 
		query.append("  )" ).append("\n"); 
		query.append("  AND NVL(A.CMDT_TP_CD, '*') IN (SELECT MAX(NVL(CMDT_TP_CD, '*'))" ).append("\n"); 
		query.append("                                 FROM ACM_FF_AGMT" ).append("\n"); 
		query.append("                                 WHERE FF_CNT_CD = @[bkg_ff_cnt_cd]" ).append("\n"); 
		query.append("                                   AND FF_SEQ = TO_NUMBER(NVL(@[ff_cust_seq_tmp], @[bkg_ff_seq]))" ).append("\n"); 
		query.append("                                   AND NVL(SHPR_CNT_CD, '*') IN (@[shpr_cnt_cd], '*')" ).append("\n"); 
