...
public class KorCustomsTransmissionDBDAOMakeFlatFileMasterInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DECODE(@[resnd_chk],'P',RPAD('SMLM0001',20), RPAD('SSSMLM0001', 20))|| /* Sender ID */" ).append("\n"); 
		query.append("DECODE(@[resnd_chk],'P',DECODE(@[kt_pa],20,RPAD('KMPAE010',20),30,RPAD('KMPAE030',20),622,RPAD('KMPAE050',20),31,RPAD('KMPAE030',20)),RPAD('KTNETULHS4G',20))|| /*ReceiverID*/" ).append("\n"); 
		...
		query.append("'AGENCY:' ||'SM LINE CORPORATION' ||CHR(10)|| /* 선박대리점명 */" ).append("\n"); 
		...
		query.append("'VSLCOM_CODE:' ||DECODE(SUBSTR(@[svr_id],1,1),'D','OS-L-2001',DECODE(DECODE(@[ob_type],'N',@[pod_loc],@[pol_loc]),'KRPUS','OS-L-2001','OS-L-2001')) ||CHR(10)|| /* 해수부 선사코드 */" ).append("\n"); 
