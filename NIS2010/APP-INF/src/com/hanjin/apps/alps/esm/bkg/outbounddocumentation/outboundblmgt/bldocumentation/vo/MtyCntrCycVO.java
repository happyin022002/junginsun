...
*@FileName : MtyCntrCycVO.java
*@FileTitle : MtyCntrCycVO
*Open Issues :
*Change history :
...
public class MtyCntrCycVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyCntrCycVO> models = new ArrayList<MtyCntrCycVO>();
	...
	public MtyCntrCycVO(String ibflag, String pagerows, String cnmvCycNo, String cnmvIdNo, String cnmvYr, String cnmvStsCd, String orgFmLocCd) {
	 ...
	 * @return MtyCntrCycVO[]
	 */
	public MtyCntrCycVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyCntrCycVO[]
	 */
	public MtyCntrCycVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyCntrCycVO model = null;
	 ...
	 * @return MtyCntrCycVO[]
	 */
	public MtyCntrCycVO[] getMtyCntrCycVOs(){
		MtyCntrCycVO[] vos = (MtyCntrCycVO[])models.toArray(new MtyCntrCycVO[models.size()]);
		return vos;
	}
