...
*@FileName : KorManifestListDBDAOsearchObTransTpExpWhfRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDBDAOsearchObTransTpExpWhfRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDBDAOsearchObTransTpExpWhfRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDBDAOsearchObTransTpExpWhfRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
