...
*@FileName : StatusManageDBDAOCreateTransferSqmQtaLaneOfcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusManageDBDAOCreateTransferSqmQtaLaneOfcCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Qta Transfer 시 연간 정보로 1Q SQM_QTA_LANE_OFC 생성
	  * </pre>
	  */
	public StatusManageDBDAOCreateTransferSqmQtaLaneOfcCSQL(){
		setQuery();
		...
		query.append("FileName : StatusManageDBDAOCreateTransferSqmQtaLaneOfcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
