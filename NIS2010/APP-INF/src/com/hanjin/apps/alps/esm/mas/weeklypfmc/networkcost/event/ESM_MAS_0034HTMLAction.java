...
*@FileName : ESM_MAS_0034HTMLAction.java
...
public class ESM_MAS_0034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0034HTMLAction 객체를 생성
	 */
	public ESM_MAS_0034HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmMas0034Event event = new EsmMas0034Event();
