...
*@FileName : RsltPriCmpbGlineRoutPntVO.java
*@FileTitle : RsltPriCmpbGlineRoutPntVO
*Open Issues :
*Change history :
...
public class RsltPriCmpbGlineRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltPriCmpbGlineRoutPntVO> models = new ArrayList<RsltPriCmpbGlineRoutPntVO>();
	...
	public RsltPriCmpbGlineRoutPntVO() {}

	public RsltPriCmpbGlineRoutPntVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq, String orgDestTpCd, String routPntSeq, String routPntLocTpCd, String routPntLocDefCd, String rcvDeTermCd, String creUsrId, String creDt, String updUsrId, String updDt, String routPntLocDefNm, String rcvDeTermNm) {
		this.updDt = updDt;
		this.bseSeq = bseSeq;
	 ...
	 * @param request
	 * @return RsltPriCmpbGlineRoutPntVO[]
	 */
	public RsltPriCmpbGlineRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltPriCmpbGlineRoutPntVO[]
	 */
	public RsltPriCmpbGlineRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltPriCmpbGlineRoutPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltPriCmpbGlineRoutPntVO();
				if (updDt[i] != null)
		...
		return getRsltPriCmpbGlineRoutPntVOs();
	}
	 ...
	 * @return RsltPriCmpbGlineRoutPntVO[]
	 */
	public RsltPriCmpbGlineRoutPntVO[] getRsltPriCmpbGlineRoutPntVOs(){
		RsltPriCmpbGlineRoutPntVO[] vos = (RsltPriCmpbGlineRoutPntVO[])models.toArray(new RsltPriCmpbGlineRoutPntVO[models.size()]);
		return vos;
	}
