...
*@FileName : SCRateProposalDBDAOPriSpScpRtScgRoutCostDetailVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtScgRoutCostDetailVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtScgRoutCostDetailVODSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtScgRoutCostDetailVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_SP_SCP_RT_SCG_ROUT A" ).append("\n"); 
