...
*@FileName : Kor24ManifestListDBDAOmodifyVVDInfoKorUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyVVDInfoKorUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyVVDInfoKorUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyVVDInfoKorUSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_ADV_KR_VVD_SMRY KV" ).append("\n");
		...
		query.append("AND ((@[in_type] IN ('A','B','C','D','M') AND KV.OB_DECL_TP_CD IN ('A','B','C','D','M'))" ).append("\n");
		query.append("OR (@[in_type] = 'N' AND KV.OB_DECL_TP_CD = @[in_type]))" ).append("\n");
