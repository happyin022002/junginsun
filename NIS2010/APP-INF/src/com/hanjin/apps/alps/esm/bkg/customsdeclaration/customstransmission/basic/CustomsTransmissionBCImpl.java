 ...
 * @since J2EE 1.4
 */
public abstract class CustomsTransmissionBCImpl extends BasicCommandSupport implements CustomsTransmissionBC {
	 ...
	 * @exception EventException
	 */
	public String transmitTmlManifest ( ManifestTransmitVO manifestTransmitVO , SignOnUserAccount account) 
		throws EventException {
		return null;
	}
	 ...
	 * @exception EventException
	 */
	public String makeCstmsFlatFileCusrep(String vslCd, String skdVoyNo, String skdDirCd, String transFlag, SignOnUserAccount account) throws EventException {
		return null;
	}
	 ...
	 * 
	 * @param account 세션정보
	 * @param AustrailiaManifestTransmitVOs 전송정보
	 * @param pgmNo 화면id
	 * @return String BackEndJob Key
	 * @throws EventException
	 */
	 ...
	 * 
	 * @param account 세션정보
	 * @param hongKongManifestTransmitVOs 전송정보
	 * @param pgmNo 화면id
	 * @return String BackEndJob Key
	 * @throws EventException
	 */
	 ...
	 * 
	 * @param account 세션정보
	 * @param taiwanManifestTransmitVOs 전송정보
	 * @param pgmNo 화면id
	 * @return String BackEndJob Key
	 * @throws EventException
	 */
	 ...
	 */
	@Override
	public void transmitManifest(CstmsManifestVO[] cstmsManifestVOs, SignOnUserAccount account) throws EventException {
