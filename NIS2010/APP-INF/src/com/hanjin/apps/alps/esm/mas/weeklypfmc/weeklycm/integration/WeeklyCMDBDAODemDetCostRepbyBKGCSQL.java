...
*@FileName : WeeklyCMDBDAODemDetCostRepbyBKGCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAODemDetCostRepbyBKGCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Cost Report by BKG 를 Save(저장 중 - insert) 한다.
	  * </pre>
	  */
	public WeeklyCMDBDAODemDetCostRepbyBKGCSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAODemDetCostRepbyBKGCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_CHSS_PDM_UPLD(" ).append("\n"); 
		query.append("	POOL_CD," ).append("\n"); 
		query.append("	SCC_CD," ).append("\n"); 
		query.append("	BZC_RT," ).append("\n"); 
		query.append("	TAX_PCT," ).append("\n"); 
