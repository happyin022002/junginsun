...
*@FileName : Kor24ManifestListDBDAOmodifyTransmitDateUSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOmodifyTransmitDateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOmodifyTransmitDateUSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOmodifyTransmitDateUSQL").append("\n");
		query.append("*/").append("\n");
	}
