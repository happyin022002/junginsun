...
public class BkgSrFaxVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBkgNoMtchStsCd(JSPUtil.getParameter(request, "bkg_no_mtch_sts_cd", ""));
	}
	...
	public BkgSrFaxVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] orgBkgNo = (JSPUtil.getParameter(request, prefix	+ "org_bkg_no".trim(), length));
			String[] bkgNoMtchStsCd = (JSPUtil.getParameter(request, prefix	+ "bkg_no_mtch_sts_cd".trim(), length));
