...
*@FileName : XterHbl1VO.java
*@FileTitle : XterHbl1VO
*Open Issues :
*Change history :
...
public class XterHbl1VO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<XterHbl1VO> models = new ArrayList<XterHbl1VO>();
	 ...
	 * @return XterHbl1VO[]
	 */
	public XterHbl1VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return XterHbl1VO[]
	 */
	public XterHbl1VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		XterHbl1VO model = null;
	 ...
	 * @return XterHbl1VO[]
	 */
	public XterHbl1VO[] getXterHbl1VOs(){
		XterHbl1VO[] vos = (XterHbl1VO[])models.toArray(new XterHbl1VO[models.size()]);
		return vos;
	}
