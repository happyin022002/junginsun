...
*@FileName : PriRqRtCmdtGrpListVO.java
*@FileTitle : PriRqRtCmdtGrpListVO
*Open Issues :
*Change history :
...
public class PriRqRtCmdtGrpListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtCmdtGrpListVO> models = new ArrayList<PriRqRtCmdtGrpListVO>();
	...
	public PriRqRtCmdtGrpListVO() {}

	public PriRqRtCmdtGrpListVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String prcCmdtDefCd, String ficRtTpCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return PriRqRtCmdtGrpListVO[]
	 */
	public PriRqRtCmdtGrpListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtCmdtGrpListVO[]
	 */
	public PriRqRtCmdtGrpListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtCmdtGrpListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriRqRtCmdtGrpListVO();
				if (ibflag[i] != null)
		...
		return getPriRqRtCmdtGrpListVOs();
	}
	 ...
	 * @return PriRqRtCmdtGrpListVO[]
	 */
	public PriRqRtCmdtGrpListVO[] getPriRqRtCmdtGrpListVOs(){
		PriRqRtCmdtGrpListVO[] vos = (PriRqRtCmdtGrpListVO[])models.toArray(new PriRqRtCmdtGrpListVO[models.size()]);
		return vos;
	}
