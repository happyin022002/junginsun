...
*@FileName : ACMSimulationDBDAOModifySimAgnRateMasterListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMSimulationDBDAOModifySimAgnRateMasterListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMSimulationDBDAOModifySimAgnRateMasterListUSQL(){
		setQuery();
		...
		query.append("FileName : ACMSimulationDBDAOModifySimAgnRateMasterListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE ACM_SIM_AGMT_MST" ).append("\n"); 
