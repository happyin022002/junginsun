...
*@FileName : ESM_PRI_3005HTMLAction.java
...
public class ESM_PRI_3005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_3005HTMLAction 객체를 생성
	 */
	public ESM_PRI_3005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri3005Event event = new EsmPri3005Event();
				
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriTriNoteVO((PriTriNoteVO)getVO(request, PriTriNoteVO .class));
			event.setPriTriNoteConvListVOs((PriTriNoteConvListVO[])getVOs(request, PriTriNoteConvListVO .class,"sheet1_"));
		}
			...
			event.setPriTriNoteConvListVO((PriTriNoteConvListVO)getVO(request, PriTriNoteConvListVO .class));
		}
		else {
			event.setPriTriNoteConvVO((PriTriNoteConvVO)getVO(request, PriTriNoteConvVO .class));
		}
