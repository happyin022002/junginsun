 ...
 *@FileName : ESM_PRI_6098HTMLAction.java
...
public class ESM_PRI_6098HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_6098HTMLAction 객체를 생성
	 */
	public ESM_PRI_6098HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6098Event event = new EsmPri6098Event();
		...
		rateQuotationVO.setInOrgDestTpCd(JSPUtil.getParameter(request, "in_org_dest_tp_cd", ""));
		if (command.isCommand(FormCommand.SEARCH01)) {
			...
			rateQuotationVO.setPriRqRtLoadExcelGuidelineCheckVO((PriRqRtLoadExcelGuidelineCheckVO) getVO(request, PriRqRtLoadExcelGuidelineCheckVO.class));
			rateQuotationVO.setPriRqRtLoadExcelGuidelineCheckVOs((PriRqRtLoadExcelGuidelineCheckVO[]) getVOs(request, PriRqRtLoadExcelGuidelineCheckVO.class, ""));
		} else if (command.isCommand(FormCommand.MODIFY01)) {
			rateQuotationVO.setPriRqRtCmdtHdrVO((PriRqRtCmdtHdrVO) getVO(request, PriRqRtCmdtHdrVO.class));
			rateQuotationVO.setRsltPriRqRtListVerticalExcelForAddOnTariffVOs((RsltPriRqRtListVerticalExcelForAddOnTariffVO[]) getVOs(request, RsltPriRqRtListVerticalExcelForAddOnTariffVO.class, ""));
		}
