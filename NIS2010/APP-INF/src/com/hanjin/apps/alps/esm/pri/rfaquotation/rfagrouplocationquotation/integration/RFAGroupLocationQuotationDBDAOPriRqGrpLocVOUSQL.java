...
*@FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocVOUSQL.java
...
public class RFAGroupLocationQuotationDBDAOPriRqGrpLocVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationQuotationDBDAOPriRqGrpLocVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_GRP_LOC SET" ).append("\n"); 
