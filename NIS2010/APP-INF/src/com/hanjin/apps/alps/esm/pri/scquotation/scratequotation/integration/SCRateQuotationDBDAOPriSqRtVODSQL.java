...
*@FileName : SCRateQuotationDBDAOPriSqRtVODSQL.java
...
public class SCRateQuotationDBDAOPriSqRtVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtVODSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
