...
public class ESM_PRI_0021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_PRI_0021HTMLAction 객체를 생성
	 */
	public ESM_PRI_0021HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsmPri0021Event event = new EsmPri0021Event();
		event.setRsltRtRoutPntListVO((RsltRtRoutPntListVO) getVO(request, RsltRtRoutPntListVO.class));
