...
public class Kor24RateHeadVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24RateHeadVO> models = new ArrayList<Kor24RateHeadVO>();
	...
	public Kor24RateHeadVO() {}

	public Kor24RateHeadVO(String ibflag, String pagerows, String kcdTp, String whfInd) {
		this.ibflag = ibflag;
		this.whfInd = whfInd;
		this.kcdTp = kcdTp;
	 ...
	 */
	public Kor24RateHeadVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExemptWhfVO[]
	 */
	public Kor24RateHeadVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24RateHeadVO model = null;
	 ...
	 * @return SearchExemptWhfVO[]
	 */
	public Kor24RateHeadVO[] getSearchExemptWhfVOs(){
		Kor24RateHeadVO[] vos = (Kor24RateHeadVO[])models.toArray(new Kor24RateHeadVO[models.size()]);
		return vos;
	}
