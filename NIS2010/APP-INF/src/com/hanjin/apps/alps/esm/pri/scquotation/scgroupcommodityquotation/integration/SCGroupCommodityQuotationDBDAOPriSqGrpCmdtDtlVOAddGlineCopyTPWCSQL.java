...
*@FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddGlineCopyTPWCSQL.java
...
public class SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddGlineCopyTPWCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddGlineCopyTPWCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityQuotationDBDAOPriSqGrpCmdtDtlVOAddGlineCopyTPWCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
