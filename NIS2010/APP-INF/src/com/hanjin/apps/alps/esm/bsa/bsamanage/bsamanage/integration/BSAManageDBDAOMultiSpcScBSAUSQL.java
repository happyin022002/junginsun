...
*@FileName : BSAManageDBDAOMultiSpcScBSAUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAOMultiSpcScBSAUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiSpcScBSA UPDATE
	  * </pre>
	  */
	public BSAManageDBDAOMultiSpcScBSAUSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAOMultiSpcScBSAUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
