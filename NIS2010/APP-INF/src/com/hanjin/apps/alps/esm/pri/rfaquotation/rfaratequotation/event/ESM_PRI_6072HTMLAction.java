...
public class ESM_PRI_6072HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_6019HTMLAction 객체를 생성
	 */
	public ESM_PRI_6072HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri6072Event event = new EsmPri6072Event();
	
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPriRqScgAdjVOS((PriRqScgAdjVO[])getVOs(request, PriRqScgAdjVO .class,""));
