...
*@FileName : ESM_MAS_0060HTMLAction.java
 ...
 * @author Kim Ki Dae
 * @see EsmMas0060Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_MAS_0060HTMLAction 객체를 생성
	 */
	public ESM_MAS_0060HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0060Event event = new EsmMas0060Event();  		
