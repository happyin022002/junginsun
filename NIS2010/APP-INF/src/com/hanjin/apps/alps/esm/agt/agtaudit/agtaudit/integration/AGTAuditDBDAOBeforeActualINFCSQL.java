...
*@FileName : AGTAuditDBDAOBeforeActualINFCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTAuditDBDAOBeforeActualINFCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTAuditDBDAOBeforeActualINFCSQL(){
		setQuery();
		...
		query.append("FileName : AGTAuditDBDAOBeforeActualINFCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("'IC'                       AS COMM_PROC_STS_CD," ).append("\n"); 
		query.append("'Interface Cancel!'        AS COMM_PROC_STS_RSN," ).append("\n"); 
		query.append("NULL                       AS COMM_APRO_NO," ).append("\n"); 
		...
		query.append("@[act_pre_comm_amt]       AS ACT_PRE_COMM_AMT," ).append("\n"); 
		query.append("@[act_comm_amt]           AS ACT_COMM_AMT," ).append("\n"); 
		query.append("@[act_if_comm_amt]        AS ACT_IF_COMM_AMT," ).append("\n"); 
		query.append("@[act_pre_locl_comm_amt]  AS ACT_PRE_LOCL_COMM_AMT," ).append("\n"); 
		query.append("@[act_locl_comm_amt]      AS ACT_LOCL_COMM_AMT," ).append("\n"); 
		query.append("@[act_if_locl_comm_amt]   AS ACT_IF_LOCL_COMM_AMT," ).append("\n"); 
		...
		query.append("NULL                       AS AC_RQST_USR_ID," ).append("\n"); 
		query.append("NULL                       AS AC_RQST_USR_EML," ).append("\n"); 
		query.append("NULL                       AS AC_RQST_DT," ).append("\n"); 
