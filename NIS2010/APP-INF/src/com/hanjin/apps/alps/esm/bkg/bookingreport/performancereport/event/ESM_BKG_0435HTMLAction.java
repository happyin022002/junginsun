...
*@FileName : ESM_BKG_0435HTMLAction.java
...
public class ESM_BKG_0435HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0435HTMLAction 객체를 생성
	 */
	public ESM_BKG_0435HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0435Event event = new EsmBkg0435Event();
		

		if(command.isCommand(FormCommand.SEARCH02)) {
            event.setSiTurnTimeVO((SiTurnTimeVO)getVO(request, SiTurnTimeVO .class));
