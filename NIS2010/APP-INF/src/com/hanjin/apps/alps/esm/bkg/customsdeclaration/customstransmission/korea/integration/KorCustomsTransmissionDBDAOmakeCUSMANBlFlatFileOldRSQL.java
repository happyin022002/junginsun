...
*@FileName : KorCustomsTransmissionDBDAOmakeCUSMANBlFlatFileOldRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorCustomsTransmissionDBDAOmakeCUSMANBlFlatFileOldRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorCustomsTransmissionDBDAOmakeCUSMANBlFlatFileOldRSQL(){
		setQuery();
		...
		query.append("FileName : KorCustomsTransmissionDBDAOmakeCUSMANBlFlatFileOldRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
