...
public class GeneralBookingReceiptDBDAOAddBkgRefernceCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#elseif(${bkg_ref_tp_cd}== 'MSLD')" ).append("\n"); 
		query.append("			, 'MSLD' AS BKG_REF_TP_CD" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		...
		query.append("	   ), 1), " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("	   @[bkg_ref_tp_cd], Replace(Replace(@[cust_ref_no_ctnt],CHR(13),''),CHR(10),''), @[cntr_no], " ).append("\n"); 
		query.append("	   @[cntr_mf_seq], @[cpy_desc_flg], @[cre_usr_id], " ).append("\n"); 
