...
/**
 * ESM_PRI_0041 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  ESM_PRI_0041HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author SEO MI JIN
 * @see ESM_PRI_0041HTMLAction 참조
 * @since J2EE 1.6
 */

public class EsmPri0041Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	public EsmPri0041Event(){}
