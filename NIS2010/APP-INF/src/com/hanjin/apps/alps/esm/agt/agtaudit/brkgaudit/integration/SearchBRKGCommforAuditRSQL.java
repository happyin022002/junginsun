...
*@FileName : SearchBRKGCommforAuditRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SearchBRKGCommforAuditRSQL implements ISQLTemplate{
