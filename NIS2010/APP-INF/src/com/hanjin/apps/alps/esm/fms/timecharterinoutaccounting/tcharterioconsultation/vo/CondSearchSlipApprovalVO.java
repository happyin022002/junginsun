...
public class CondSearchSlipApprovalVO extends AbstractValueObject {
	...
	public CondSearchSlipApprovalVO(String ibflag, String pagerows, String fromCreDt, String csrNo, String vslCd, String toEffDt, String fromEffDt, String toCreDt, String slipAproFlg, String vatSlpTpCd, String screenGubun, String cond) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("condition", getCond());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("condition", "cond");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setScreenGubun(JSPUtil.getParameter(request, "screen_gubun", ""));	
		setCond(JSPUtil.getParameter(request, "condition", ""));	
	}
	...
	public CondSearchSlipApprovalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cond = (JSPUtil.getParameter(request, prefix	+ "condition", length));	
	...
	*/
	public void unDataFormat(){
		...
		this.cond = this.cond .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");	
	}
}
