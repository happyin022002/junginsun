 ...
 * @see EsmAgt0057Event , ESM_AGT_007EventResponse 참조
 * @since J2EE 1.4
 */
public class ESM_AGT_0057HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESM_AGT_0057HTMLAction 객체를 생성
	 */
	public ESM_AGT_0057HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmAgt0057Event event = new EsmAgt0057Event();

		switch (command.getCommand()) {
		case FormCommand.SEARCH:
			event.setAgtScsAgmtRtVO((AgtScsAgmtRtVO) getVO(request, AgtScsAgmtRtVO.class));
			break;
		case FormCommand.MULTI:
			event.setAgtScsAgmtRtVOS((AgtScsAgmtRtVO[]) getVOs(request, AgtScsAgmtRtVO.class, ""));
			event.setAgtScsAgmtRtVO((AgtScsAgmtRtVO) getVO(request, AgtScsAgmtRtVO.class));
			break;
		}
