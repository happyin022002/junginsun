...
*@FileName : CostManageDBDAOUpdateAddBasicCmcbUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostManageDBDAOUpdateAddBasicCmcbUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostManageDBDAOUpdateAddBasicCmcbUSQL(){
		setQuery();
		...
		query.append("FileName : CostManageDBDAOUpdateAddBasicCmcbUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO SQM_QTA_LANE_OFC_COST A1 USING" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("       SET A1.PA_CM_UC_AMT = A2.PA_CM_UC_AMT" ).append("\n"); 
