...
*@FileName : ESM_PRI_0003_04HTMLAction.java
...
public class ESM_PRI_0003_04HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_0003_04HTMLAction 객체를 생성
	 */
	public ESM_PRI_0003_04HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri000304Event event = new EsmPri000304Event();
		...
		if(command.isCommand(FormCommand.SEARCH01)) {
		...
		} else if(command.isCommand(FormCommand.SEARCH03)) { //font style 조회
			event.setCstPriSpScpTrspAddChgVO((CstPriSpScpTrspAddChgVO)getVO(request, CstPriSpScpTrspAddChgVO .class));
			...
			event.setPriSpScpTrspAddChgVOS((PriSpScpTrspAddChgVO[])getVOs(request, PriSpScpTrspAddChgVO .class));
		} else if(command.isCommand(FormCommand.MULTI07)) { //Accept All
			event.setCstArbAcceptVO((CstArbAcceptVO)getVO(request, CstArbAcceptVO .class));		
		} else if(command.isCommand(FormCommand.MULTI08)) { //AcceptCancel All 
			event.setCstArbAcceptVO((CstArbAcceptVO)getVO(request, CstArbAcceptVO .class));				
		} else {
			event.setCstPriSpScpTrspAddChgVO((CstPriSpScpTrspAddChgVO)getVO(request, CstPriSpScpTrspAddChgVO .class));
		}
