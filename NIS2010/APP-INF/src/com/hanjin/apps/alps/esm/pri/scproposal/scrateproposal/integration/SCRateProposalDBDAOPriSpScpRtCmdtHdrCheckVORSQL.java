...
*@FileName : SCRateProposalDBDAOPriSpScpRtCmdtHdrCheckVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCmdtHdrCheckVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Commodity Header만 있는 경우를 조회한다.
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCmdtHdrCheckVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCmdtHdrCheckVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}