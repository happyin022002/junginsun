...
*@FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOUSQL.java
...
public class RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationQuotationDBDAOPriRqGrpLocDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RQ_GRP_LOC_DTL SET" ).append("\n"); 
