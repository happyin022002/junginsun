...
*@FileName : RocsSearchRocsReceiveListVO.java
*@FileTitle : RocsSearchRocsReceiveListVO
*Open Issues :
*Change history :
...
public class RocsSearchRocsReceiveListVO extends ReceiveLogVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchRocsReceiveListVO> models = new ArrayList<RocsSearchRocsReceiveListVO>();
	...
	public RocsSearchRocsReceiveListVO() {}

	public RocsSearchRocsReceiveListVO(String ibflag, String pagerows, String rtmEdiMsgTpCd, String msgSndDt, String blNo, String rtmEdiErrId, String errDesc, String errCtnt, String ofcCd, String creUsrId, String rowcnt, String vvdNumber, String polCd, String podCd, String hist, String podClptIndSeq) {
	 ...
	 * @param request
	 * @return RocsSearchRocsReceiveListVO[]
	 */
	public RocsSearchRocsReceiveListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchRocsReceiveListVO[]
	 */
	public RocsSearchRocsReceiveListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchRocsReceiveListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RocsSearchRocsReceiveListVO();
				if (errCtnt[i] != null)
		...
		return getRocsSearchRocsReceiveListVOs();
	}
	 ...
	 * @return RocsSearchRocsReceiveListVO[]
	 */
	public RocsSearchRocsReceiveListVO[] getRocsSearchRocsReceiveListVOs(){
		RocsSearchRocsReceiveListVO[] vos = (RocsSearchRocsReceiveListVO[])models.toArray(new RocsSearchRocsReceiveListVO[models.size()]);
		return vos;
	}
