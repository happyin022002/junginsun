...
public class KorCustomsTransmissionDBDAOMakeFlatFileMACAMDRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("RPAD('SMLM0001',20)||						                        /*	- Sender ID	*/" ).append("\n"); 
		...
		query.append("'SCAC:'			||'SMLM'               	||CHR(10)||	/*	SCAC			*/" ).append("\n"); 
		query.append("'CARRIER_CD:'	||DECODE(@[kt_pa2],20,'OS-L-2001','OS-L-2001')    ||CHR(10)||     /*	선사/대리점 코드	        */" ).append("\n"); 
		...
		query.append("'DISC_CO_CD:'	||@[disc_co]                                 	||CHR(10)||	/*	하역회사 부호     */" ).append("\n"); 
