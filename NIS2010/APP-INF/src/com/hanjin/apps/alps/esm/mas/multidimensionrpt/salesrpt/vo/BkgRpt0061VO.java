...
public class BkgRpt0061VO extends AbstractValueObject {
	...
	/* Column Info */
	private String mtyPkupEcc = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mty_pkup_ecc", getMtyPkupEcc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mty_pkup_ecc", "mtyPkupEcc");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRtBlTpNm(JSPUtil.getParameter(request, "rt_bl_tp_nm", ""));
		setMtyPkupLoc(JSPUtil.getParameter(request, "mty_pkup_loc", ""));
		setMtyPkupEcc(JSPUtil.getParameter(request, "mty_pkup_ecc", ""));
		setMtyRtnLoc(JSPUtil.getParameter(request, "mty_rtn_loc", ""));
		setMtyRtnEcc(JSPUtil.getParameter(request, "mty_rtn_ecc", ""));
	}
	...
	public BkgRpt0061VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] mtyPkupEcc = (JSPUtil.getParameter(request, prefix	+ "mty_pkup_ecc", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (mtyPkupEcc[i] != null)
					model.setMtyPkupEcc(mtyPkupEcc[i]);
				if (mtyRtnLoc[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.mtyPkupEcc = this.mtyPkupEcc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
