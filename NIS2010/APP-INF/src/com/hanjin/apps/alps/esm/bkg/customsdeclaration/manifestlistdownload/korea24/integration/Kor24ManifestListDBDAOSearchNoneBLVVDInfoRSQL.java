...
*@FileName : Kor24ManifestListDBDAOSearchNoneBLVVDInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchNoneBLVVDInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchNoneBLVVDInfoRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchNoneBLVVDInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
