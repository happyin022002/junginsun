...
*@FileName : RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFAGroupLocationGuidelineDBDAOPriRgGrpLocDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_RG_GRP_LOC_DTL SET" ).append("\n"); 
