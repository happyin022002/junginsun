...
*@FileName : FrgnExchangeTransactionVO.java
*@FileTitle : FrgnExchangeTransactionVO
*Open Issues :
*Change history :
...
public class FrgnExchangeTransactionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FrgnExchangeTransactionVO> models = new ArrayList<FrgnExchangeTransactionVO>();
	...
	public FrgnExchangeTransactionVO() {}

	public FrgnExchangeTransactionVO(String ibflag, String pagerows, String fromEffDt, String toEffDt, String vslCd, String supplierCd, String originCsrNo, String matchCsrNo, String transactCd, String newCsrNo, String slpOfcCd, String csrNo, String effDt, String vvd, String apDesc, String attachLink, String attachCnt, String curr, String amt, String usdAmt, String glDate, String matchCsrUsdAmt, String loclXchRtAmt, String transactionCsrNo, String aproStep, String selectCheck, String ori1CsrNo, String ori2CsrNo, String atchFileFletKnt) {
...
/**
	 ...
	 */
	public FrgnExchangeTransactionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FrgnExchangeTransactionVO[]
	 */
	public FrgnExchangeTransactionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FrgnExchangeTransactionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new FrgnExchangeTransactionVO();
				if (aproStep[i] != null)
		...
		return getFrgnExchangeTransactionVOs();
	}
	 ...
	 * @return FrgnExchangeTransactionVO[]
	 */
	public FrgnExchangeTransactionVO[] getFrgnExchangeTransactionVOs(){
		FrgnExchangeTransactionVO[] vos = (FrgnExchangeTransactionVO[])models.toArray(new FrgnExchangeTransactionVO[models.size()]);
		return vos;
	}
