...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutViaVOCSQL.java
...
public class RFARateQuotationDBDAOPriRqRtRoutViaVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutViaVOCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutViaVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
