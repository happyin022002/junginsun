...
*@FileName : Kor24ManifestListDBDAOSearchExportInfoDNRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchExportInfoDNRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchExportInfoDNRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchExportInfoDNRSQL").append("\n");
		query.append("*/").append("\n");
	}
