...
*@FileName : ESM_SAM_0306HTMLAction.java
*@FileTitle : customer
*Open Issues :
*Change history :
...
public class ESM_SAM_0306HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SAM_0302HTMLAction 객체를 생성
	 */
	public ESM_SAM_0306HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSam0306Event event = new EsmSam0306Event();
