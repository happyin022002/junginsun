...
*@FileName : WeeklyCMDBDAOMasTmlTrfGrpVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WeeklyCMDBDAOMasTmlTrfGrpVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WeeklyCMDBDAOMasTmlTrfGrpVOUSQL(){
		setQuery();
		...
		query.append("FileName : WeeklyCMDBDAOMasTmlTrfGrpVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MAS_TML_TRF_GRP" ).append("\n"); 
		query.append("SET MAS_COST_SRC_CD = @[mas_cost_src_cd]" ).append("\n"); 
