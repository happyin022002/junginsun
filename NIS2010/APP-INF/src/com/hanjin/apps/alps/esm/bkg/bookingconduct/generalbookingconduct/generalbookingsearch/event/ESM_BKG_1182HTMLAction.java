...
public class ESM_BKG_1182HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1182HTMLAction 객체를 생성
	 */
	public ESM_BKG_1182HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("[START::  ESM_BKG_1182HTMLAction  ]==========");

		EsmBkg1182Event event = new EsmBkg1182Event();
		String[] keys =null;
