...
*@FileName : KorCustChkVO.java
*@FileTitle : KorCustChkVO
*Open Issues :
*Change history :
...
public class KorCustChkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<KorCustChkVO> models = new ArrayList<KorCustChkVO>();
	...
	public KorCustChkVO(String ibflag, String pagerows, String bkgNo, String cstmsDeclTpCd, String portCd, String trnsSeq) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return KorCustChkVO[]
	 */
	public KorCustChkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return KorCustChkVO[]
	 */
	public KorCustChkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		KorCustChkVO model = null;
	 ...
	 * @return KorCustChkVO[]
	 */
	public KorCustChkVO[] getKorCustChkVOs(){
		KorCustChkVO[] vos = (KorCustChkVO[])models.toArray(new KorCustChkVO[models.size()]);
		return vos;
	}
