 ...
 *@FileName : ESM_PRI_0115HTMLAction.java
...
public class ESM_PRI_0115HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri0115Event event = new EsmPri0115Event();
