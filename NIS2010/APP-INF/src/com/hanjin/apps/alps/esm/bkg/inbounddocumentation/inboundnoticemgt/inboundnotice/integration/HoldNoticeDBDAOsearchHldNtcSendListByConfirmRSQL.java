...
public class HoldNoticeDBDAOsearchHldNtcSendListByConfirmRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("               ,NVL(HNDTL.HLD_EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',EMSD.EML_DT,LOC.LOC_CD )) AS HLD_EML_SND_DT" ).append("\n"); 
		...
		query.append("                           > NVL(TO_CHAR( NVL(HNDTL.HLD_EML_SND_DT,GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL',EMSD.EML_DT,LOC.LOC_CD )), 'YYYYMMDDHH24MISS'),'00000000000000')                                                                                                            " ).append("\n"); 
