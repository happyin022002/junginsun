...
*@FileName : ACMCommonDBDAOGetCoaLaneRgstListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ACMCommonDBDAOGetCoaLaneRgstListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ACMCommonDBDAOGetCoaLaneRgstListRSQL(){
		setQuery();
		...
		query.append("FileName : ACMCommonDBDAOGetCoaLaneRgstListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT RLANE_CD AS VALUE0" ).append("\n"); 
		query.append("FROM MAS_LANE_RGST" ).append("\n"); 
		query.append("WHERE TRD_CD = @[value0]" ).append("\n"); 
