...
*@FileName : SCRateProposalDBDAOPriSpScpRtCnoteVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtCnoteVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtCnoteVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtCnoteVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
