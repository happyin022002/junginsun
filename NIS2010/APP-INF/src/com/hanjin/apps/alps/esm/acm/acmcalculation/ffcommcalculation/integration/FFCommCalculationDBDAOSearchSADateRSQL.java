...
*@FileName : FFCommCalculationDBDAOSearchSADateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FFCommCalculationDBDAOSearchSADateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FFCommCalculationDBDAOSearchSADateRSQL
	  * 
	  ...
	  * </pre>
	  */
	public FFCommCalculationDBDAOSearchSADateRSQL(){
		setQuery();
		...
		query.append("FileName : FFCommCalculationDBDAOSearchSADateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  DECODE(A.VSL_SEQ, 0, (SELECT NVL(MAX(C.VSL_SEQ), 0) + 1" ).append("\n"); 
		query.append("                        FROM BKG_VVD C" ).append("\n"); 
		query.append("                        WHERE BKG_NO = A.BKG_NO" ).append("\n"); 
		query.append("                          AND VSL_PRE_PST_CD = 'S'" ).append("\n"); 
		query.append("                       ), A.VSL_SEQ) VSL_SEQ," ).append("\n"); 
		query.append("  A.VSL_PRE_PST_CD VSL_PRE_PST_CD," ).append("\n"); 
		...
		query.append("  NVL(B.CONTI_CD, '*') OS_CONTI_CD," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("SELECT 'ITS' SA_DT_DIV," ).append("\n"); 
		...
		query.append("  NVL(A.SLAN_CD, '*') SLAN_CD," ).append("\n"); 
		query.append("  NVL(A.POL_CD, '*') VSL_POL_CD," ).append("\n"); 
		query.append("  NVL(B.CONTI_CD, '*') IS_CONTI_CD," ).append("\n"); 
		query.append("  NVL(A.POD_CD, '*') VSL_POD_CD," ).append("\n"); 
