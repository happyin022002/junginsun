...
*@FileName : FeederChargeGuideLineDBDAOModifyFDRTariffDurationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FeederChargeGuideLineDBDAOModifyFDRTariffDurationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Modify FDR Tariff Duration
	  * </pre>
	  */
	public FeederChargeGuideLineDBDAOModifyFDRTariffDurationUSQL(){
		setQuery();
		...
		query.append("FileName : FeederChargeGuideLineDBDAOModifyFDRTariffDurationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
