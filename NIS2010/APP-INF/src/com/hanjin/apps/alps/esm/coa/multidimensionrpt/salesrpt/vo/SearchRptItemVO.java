...
*@FileName : SearchRptItemVO.java
*@FileTitle : SearchRptItemVO
*Open Issues :
*Change history :
...
public class SearchRptItemVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchRptItemVO> models = new ArrayList<SearchRptItemVO>();
	...
	public SearchRptItemVO() {}

	public SearchRptItemVO(String ibflag, String pagerows, String rptItmDesc, String rptItmColNm) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return SearchRptItemVO[]
	 */
	public SearchRptItemVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchRptItemVO[]
	 */
	public SearchRptItemVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchRptItemVO model = null;
	 ...
	 * @return SearchRptItemVO[]
	 */
	public SearchRptItemVO[] getSearchRptItemVOs(){
		SearchRptItemVO[] vos = (SearchRptItemVO[])models.toArray(new SearchRptItemVO[models.size()]);
		return vos;
	}
