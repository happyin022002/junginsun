...
*@FileName : FICCostInterfaceDBDAOCopyTariffIhcRateDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOCopyTariffIhcRateDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CopyTariffIhcRateData
	  * 2013.02.07 [CHM-201322859] 서미진 copy 시 weight 컬럼 추가
	  * </pre>
	  */
	public FICCostInterfaceDBDAOCopyTariffIhcRateDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOCopyTariffIhcRateDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
