...
*@FileName : ESM_PRI_4033HTMLAction.java
...
public class ESM_PRI_4033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_4033HTMLAction 객체를 생성
	 */
	public ESM_PRI_4033HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri4033Event event = new EsmPri4033Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPriScgAplyDtRuleVO((PriScgAplyDtRuleVO)getVO(request, PriScgAplyDtRuleVO .class));
		} else if(command.isCommand(FormCommand.MULTI01)) {
			event.setPriScgAplyDtRuleVOs((PriScgAplyDtRuleVO[])getVOs(request, PriScgAplyDtRuleVO .class));
