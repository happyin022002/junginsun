...
public class CLLCDLManifestDBDAOsearchSpclStowRqst3ByMlbRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       " ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) OLBP_20 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) OLBP_40 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0, 1), 0) OLBP_40H ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'OLBP', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 0) OLBP_45 ," ).append("\n"); 
		query.append("      " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 'UDAK', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 1, 0), 0) UDMX_20 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 'UDAK', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '4', 1, 0), 0) UDMX_40 ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0, 1), 'UDAK', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '2', 0, '4', 0, '7', 0, 1), 0) UDMX_40H ," ).append("\n"); 
		query.append("      DECODE(CLL.STWG_CD, 'UDMX', DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '7', 1, 0), 'UDAK',  DECODE(SUBSTR(BQ.CNTR_TPSZ_CD, 2, 1), '7', 1, 0),0) UDMX_45 ," ).append("\n"); 
		query.append("      " ).append("\n"); 
