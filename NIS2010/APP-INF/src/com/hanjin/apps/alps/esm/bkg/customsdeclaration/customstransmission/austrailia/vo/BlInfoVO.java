...
public class BlInfoVO extends AbstractValueObject {
	...
	private Collection<BlInfoVO> models = new ArrayList<BlInfoVO>();
	...
	public BlInfoVO(String ibflag, String pagerows, String blNo, String shippingRef, String polCd, String podCd, String dType, String vvdCd, String portCd) {
		this.podCd = podCd;
...
/**
	 ...
	 * @return BlInfoVO[]
	 */
	public BlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BlInfoVO[]
	 */
	public BlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BlInfoVO model = null;
	...
	public BlInfoVO[] getBlInfoVOs(){
		BlInfoVO[] vos = (BlInfoVO[])models.toArray(new BlInfoVO[models.size()]);
		return vos;
	}
