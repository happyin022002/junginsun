...
*@FileName : Eur24BlCMinfoListVO.java
*@FileTitle : Eur24BlCMinfoListVO
*Open Issues :
*Change history :
...
public class Eur24BlCMinfoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Eur24BlCMinfoListVO> models = new ArrayList<Eur24BlCMinfoListVO>();
...
/**
	 ...
	 * @param request
	 * @return Eur24BlCMinfoListVO[]
	 */
	public Eur24BlCMinfoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Eur24BlCMinfoListVO[]
	 */
	public Eur24BlCMinfoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Eur24BlCMinfoListVO model = null;
		...
		return getEur24BlCMinfoListVOs();
	}
	 ...
	 * @return Eur24BlCMinfoListVO[]
	 */
	public Eur24BlCMinfoListVO[] getEur24BlCMinfoListVOs(){
		Eur24BlCMinfoListVO[] vos = (Eur24BlCMinfoListVO[])models.toArray(new Eur24BlCMinfoListVO[models.size()]);
		return vos;
	}
