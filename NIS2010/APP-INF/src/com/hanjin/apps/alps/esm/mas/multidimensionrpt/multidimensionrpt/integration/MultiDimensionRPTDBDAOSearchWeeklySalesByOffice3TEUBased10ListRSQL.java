...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased10ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased10ListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CSR 1191] MAS 운항비 약정률 (P/L by agreement - By Lane/Bound)
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased10ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased10ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			#end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		 GROUP BY B1.SLS_YRMON " ).append("\n"); 
		query.append("				,B1.TRD_CD " ).append("\n"); 
		query.append("				,B1.SUB_TRD_CD " ).append("\n"); 
		query.append("				,B1.RLANE_CD " ).append("\n"); 
		query.append("				,B1.IOC_CD " ).append("\n"); 
		...
		query.append("				,SUM (OP_COST) - SUM(TS_ALOC) + SUM (CO_AMT) + SUM (GEN_EXPN) OP_COST " ).append("\n"); 
		...
		query.append("                 -- 약정률은 실제 T/S 배부 전 데이터를 이용해야하기 때문에 TS alloc, CO 금액 제외" ).append("\n"); 
		query.append("			    ,SUM (OP_COST) - SUM(TS_ALOC) + SUM (CO_AMT) - SUM (OP_COST01) OP_COST02" ).append("\n"); 
