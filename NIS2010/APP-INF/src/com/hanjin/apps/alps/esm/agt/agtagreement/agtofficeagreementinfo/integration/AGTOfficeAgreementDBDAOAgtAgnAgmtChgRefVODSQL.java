...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtChgRefVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtChgRefVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * agt_agn_chg_ref 테이블에 조건의 데이터 삭제
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtChgRefVODSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtChgRefVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
