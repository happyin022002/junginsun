...
public class CmdMarkVO extends AbstractValueObject {
	...
	public CmdMarkVO(String ibflag, String pagerows, String cmdMarkAll, String cmdMarkLen) {
	...
	public void fromRequest(HttpServletRequest request) {
		setCmdMarkAll(JSPUtil.getParameter(request, "cmd_mark_all", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setCmdMarkLen(JSPUtil.getParameter(request, "cmd_mark_len", ""));
	...
	public CmdMarkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] cmdMarkAll = (JSPUtil.getParameter(request, prefix	+ "cmd_mark_all".trim(), length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag".trim(), length));
			String[] cmdMarkLen = (JSPUtil.getParameter(request, prefix	+ "cmd_mark_len".trim(), length));
