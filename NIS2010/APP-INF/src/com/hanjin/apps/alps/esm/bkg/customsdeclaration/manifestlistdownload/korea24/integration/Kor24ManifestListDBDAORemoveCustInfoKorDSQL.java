...
*@FileName : Kor24ManifestListDBDAORemoveCustInfoKorDSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAORemoveCustInfoKorDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 한국세관 Customer정보를 삭제한다.
	  * </pre>
	  */
	public Kor24ManifestListDBDAORemoveCustInfoKorDSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAORemoveCustInfoKorDSQL").append("\n");
		query.append("*/").append("\n");
	}
