...
*@FileName : ESM_SPC_105HTMLAction.java
...
public class ESM_SPC_0105HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_105HTMLAction 객체를 생성
	 */
	public ESM_SPC_0105HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0105Event event = new EsmSpc0105Event();
