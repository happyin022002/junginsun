...
*@FileName : ESM_BKG_0472HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_0472HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0472HTMLAction 객체를 생성 
	 */
	public ESM_BKG_0472HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmBkg0472Event event = new EsmBkg0472Event();
    	ReceiveLogCondVO receiveLogCondVO = new ReceiveLogCondVO();
    	if(command.isCommand(FormCommand.SEARCH)) {
    		receiveLogCondVO = (JapanReceiveLogCondVO)getVO(request, JapanReceiveLogCondVO.class);
			event.setJapanReceiveLogCondVO((JapanReceiveLogCondVO)receiveLogCondVO);
		} 	
