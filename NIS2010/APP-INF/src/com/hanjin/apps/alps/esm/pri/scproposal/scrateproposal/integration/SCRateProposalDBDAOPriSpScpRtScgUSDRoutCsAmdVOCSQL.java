...
*@FileName : SCRateProposalDBDAOPriSpScpRtScgUSDRoutCsAmdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAOPriSpScpRtScgUSDRoutCsAmdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCRateProposalDBDAOPriSpScpRtScgUSDRoutCsAmdVOCSQL
	  * </pre>
	  */
	public SCRateProposalDBDAOPriSpScpRtScgUSDRoutCsAmdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAOPriSpScpRtScgUSDRoutCsAmdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PRI_SP_SCP_RT_USD_ROUT_CS(" ).append("\n"); 
		...
		query.append("SCG.GEN_SPCL_RT_TP_CD," ).append("\n"); 
		query.append("SCG.CMDT_HDR_SEQ," ).append("\n"); 
		query.append("SCG.ROUT_SEQ," ).append("\n"); 
		query.append("SCG.RT_SEQ," ).append("\n"); 
		query.append("SCG.ROUT_CS_NO," ).append("\n"); 
		query.append("SCG.ROUT_CS_SRC_DT," ).append("\n"); 
		query.append("SCG.USD_ROUT_CS_SEL_FLG," ).append("\n"); 
		query.append("@[cre_usr_id]           ," ).append("\n"); 
		query.append("SYSDATE                 ," ).append("\n"); 
		query.append("@[upd_usr_id]           ," ).append("\n"); 
		query.append("SYSDATE" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("PRI_SP_SCP_RT_USD_ROUT_CS SCG," ).append("\n"); 
