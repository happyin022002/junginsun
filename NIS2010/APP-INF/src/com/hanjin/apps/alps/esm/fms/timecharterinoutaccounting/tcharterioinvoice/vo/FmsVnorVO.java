...
public class FmsVnorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FmsVnorVO> models = new ArrayList<FmsVnorVO>();
...
/**
	 ...
	 * @return FmsVnorVO[]
	 */
	public FmsVnorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FmsVnorVO[]
	 */
	public FmsVnorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FmsVnorVO model = null;
	 ...
	 * @return FmsVnorVO[]
	 */
	public FmsVnorVO[] getFmsVnorVOs(){
		FmsVnorVO[] vos = (FmsVnorVO[])models.toArray(new FmsVnorVO[models.size()]);
		return vos;
	}
