...
*@FileName : NetworkDistributionCommonVO.java
*@FileTitle : NetworkDistributionCommonVO
*Open Issues :
*Change history :
 ...
 */
public class NetworkDistributionCommonVO extends AbstractValueObject {	

	private static final long serialVersionUID = 1L;

	private Collection<NetworkDistributionCommonVO> models = new ArrayList<NetworkDistributionCommonVO>();
    ...
    /* Array Column Info */
    private String fm_trd_cd_1     	= null;
    private String fm_rlane_cd_1   	= null;
    private String fm_ioc_cd_1     	= null;
    private String fm_skd_dir_cd_1 	= null;
    ...
    public NetworkDistributionCommonVO() {}

    public NetworkDistributionCommonVO(String ibflag
                      , String pagerows) {
        this.ibflag = ibflag;
     ...
     * @param fm_trd_cd_1
     */
    public void setFmTrdCd1(String fm_trd_cd_1) {
        this.fm_trd_cd_1 = fm_trd_cd_1;
    }
    /**
     * Array Column Info
     * @return fm_trd_cd_1
     */
    public String getFmTrdCd1() {
        return this.fm_trd_cd_1;
    }
     ...
     * @param fm_rlane_cd_1
     */
    public void setFmRlaneCd1(String fm_rlane_cd_1) {
        this.fm_rlane_cd_1 = fm_rlane_cd_1;
    }
    /**
     * Array Column Info
     * @return fm_rlane_cd_1
     */
    public String getFmRlaneCd1() {
        return this.fm_rlane_cd_1;
    }
     ...
     * @param fm_ioc_cd_1
     */
    public void setFmIocCd1(String fm_ioc_cd_1) {
        this.fm_ioc_cd_1 = fm_ioc_cd_1;
    }
    /**
     * Array Column Info
     * @return fm_ioc_cd_1
     */
    public String getFmIocCd1() {
        return this.fm_ioc_cd_1;
    }
    
    /**
     * Array Column Info
     * @param fm_skd_dir_cd_1
     */
    public void setFmSkdDirCd1(String fm_skd_dir_cd_1) {
        this.fm_skd_dir_cd_1 = fm_skd_dir_cd_1;
    }
    /**
     * Array Column Info
     * @return fm_skd_dir_cd_1
     */
    public String getFmSkdDirCd1() {
        return this.fm_skd_dir_cd_1;
    }    
	 ...
	 */
	public NetworkDistributionCommonVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NetworkDistributionCommonVO[]
	 */
	public NetworkDistributionCommonVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NetworkDistributionCommonVO model = null;
		...
		try {
			...
			String[] fm_trd_cd_1     = (JSPUtil.getParameter(request, prefix + "fm_trd_cd_1"    , length));
			String[] fm_rlane_cd_1   = (JSPUtil.getParameter(request, prefix + "fm_rlane_cd_1"  , length));
			String[] fm_ioc_cd_1     = (JSPUtil.getParameter(request, prefix + "fm_ioc_cd_1"    , length));
			String[] fm_skd_dir_cd_1 = (JSPUtil.getParameter(request, prefix + "fm_skd_dir_cd_1", length)); 			
			String[] rank = (JSPUtil.getParameter(request, prefix + "rank", length));
			String[] row_type = (JSPUtil.getParameter(request, prefix + "row_type", length));
			
			for (int i = 0; i < length; i++) {
				model = new NetworkDistributionCommonVO();
				if (ibflag[i] != null)		model.setIbflag(ibflag[i]);
				if (pagerows[i] != null)	model.setPagerows(pagerows[i]);
				
				if (fm_trd_cd_1[i]     != null)	model.setFmTrdCd1(fm_trd_cd_1[i]);
				if (fm_rlane_cd_1[i]   != null)	model.setFmRlaneCd1(fm_rlane_cd_1[i]);
				if (fm_ioc_cd_1[i]     != null)	model.setFmIocCd1(fm_ioc_cd_1[i]);
				if (fm_skd_dir_cd_1[i] != null)	model.setFmSkdDirCd1(fm_skd_dir_cd_1[i]);
				if (rank[i] != null)	model.setRank(rank[i]);
				if (row_type[i] != null)	model.setRowType(row_type[i]);
				models.add(model);
			}
		...
		return getNetworkDistributionCommonVOs();
	}
	...
	public NetworkDistributionCommonVO[] getNetworkDistributionCommonVOs(){
		return (NetworkDistributionCommonVO[])models.toArray(new NetworkDistributionCommonVO[models.size()]);
	}
	...
	*/
    ...
    //#####################################################################################################
    //#####################################################################################################  	
	private Collection<NetworkDistributionCommonVO> indirectModels = new ArrayList<NetworkDistributionCommonVO>();
	
	/**
	* NetworkDistributionCommonVO[] 배열을 셋팅
	*/
	public void setIndirectNetworkDistributionCommonVOs(NetworkDistributionCommonVO[] vos){
	 ...
	 * @return NetworkDistributionCommonVO[]
	 */
	public NetworkDistributionCommonVO[] getIndirectNetworkDistributionCommonVOs(){
		return (NetworkDistributionCommonVO[])indirectModels.toArray(new NetworkDistributionCommonVO[indirectModels.size()]);
	}	
	...
	private NetworkDistributionCommonVO[] m_voArray = null;
	...
	/** 등록 리스트 Getter */
	public List getMultiCreateList3(){	
		return createList3;
	}
	/** 등록 리스트 Setter */
	public void setMultiCreateList3(List list){	
		createList3 = list;
	}	
	...
	/**
	* NetworkDistributionCommonVO[] 배열을 리턴
	*/
	public NetworkDistributionCommonVO[] getNetworkDistributionCommonVOArray(){
		return m_voArray;
	}	
	/**
	* NetworkDistributionCommonVO[] 배열을 셋팅
	*/
	public void setNetworkDistributionCommonVOArray(NetworkDistributionCommonVO[] voArray){
		m_voArray = voArray;
	}	
    //추가3############################################################################################## END
    //#####################################################################################################
	...
	/* DB List 객체  */
	List<NetworkDistributionCommonVO> m_voList = null;	
	...
	/** DB List Getter */
	public List<NetworkDistributionCommonVO> getListSet() {
		return m_voList;
	}

	/** DB List Setter */
	public void setListSet(List<NetworkDistributionCommonVO> voList) {
	...
	/* iterator List Info */
	private List<NetworkDistributionCommonVO> m_iteratorVoList = null;	
	 ...
	 */
	public List<NetworkDistributionCommonVO> getIteratorVoList() {
	 ...
	 */
	public void setIteratorVoList(List<NetworkDistributionCommonVO> iteratorVoList) {
	 ...
	 * @return List<String>
	 */
	public List<NetworkDistributionCommonVO> seperationParameterVo(String sparameter1, String sparameter2, String sSeperate) {
		List<String> tempArrList1 = null;
		List<String> tempArrList2 = null;
		List<NetworkDistributionCommonVO> arrlist = null;
		...
		if( !sparameter1.equals("") && !sparameter2.equals("") ) {
			...
			arrlist = new ArrayList<NetworkDistributionCommonVO>();
			...
			if(cnt1 == cnt2){
				for(int i=0; i<cnt1; i++){
					NetworkDistributionCommonVO vo = new NetworkDistributionCommonVO();
