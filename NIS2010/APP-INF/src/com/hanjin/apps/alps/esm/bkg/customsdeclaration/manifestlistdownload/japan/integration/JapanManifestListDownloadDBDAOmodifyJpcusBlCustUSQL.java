...
*@FileName : JapanManifestListDownloadDBDAOmodifyJpcusBlCustUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JapanManifestListDownloadDBDAOmodifyJpcusBlCustUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JapanManifestListDownloadDBDAOmodifyJpcusBlCustUSQL(){
		setQuery();
		...
		query.append("FileName : JapanManifestListDownloadDBDAOmodifyJpcusBlCustUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE BKG_CSTMS_JP_BL_CUST SET" ).append("\n"); 
		...
		query.append(",	PHN_NO = NVL(@[phn_no], (SELECT OFC_PHN_NO" ).append("\n"); 
