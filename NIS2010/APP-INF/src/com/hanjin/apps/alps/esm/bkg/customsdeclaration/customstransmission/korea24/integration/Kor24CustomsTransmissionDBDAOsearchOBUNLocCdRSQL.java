...
*@FileName : Kor24CustomsTransmissionDBDAOsearchOBUNLocCdRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOsearchOBUNLocCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOsearchOBUNLocCdRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOsearchOBUNLocCdRSQL").append("\n");
		query.append("*/").append("\n");
	}
