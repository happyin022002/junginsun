...
public class BookingHistoryMgtDBDAOSearchHistBkgXptImpLicRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", @[aes_tp_prn_flg] AES_TP_PRN_FLG" ).append("\n"); 
		...
		query.append(", @[ng_exs_ens_no] NG_EXS_ENS_NO" ).append("\n"); 
		query.append(", @[tg_ectn_no] TG_ECTN_NO" ).append("\n"); 
		...
		query.append("                , TRIM(" ).append("\n"); 
		query.append("                  DECODE(NOW.AES_INLND_TRNS_NO, '','',DECODE(SUBSTR(NOW.UPD_USR_ID,1,3),'WEB','WEB('||SUBSTR(NOW.UPD_USR_ID,5)||') AES ITN:','AES ITN:'))||NOW.AES_INLND_TRNS_NO|| " ).append("\n"); 
		query.append("                  DECODE(NOW.AES_PTA_NO1, '','',DECODE(SUBSTR(NOW.UPD_USR_ID,1,3),'WEB','WEB('||SUBSTR(NOW.UPD_USR_ID,5)||') PTA:','PTA:'))||NOW.AES_PTA_NO1||' '||NOW.AES_PTA_NO2||' '||TO_CHAR(NOW.AES_PTA_DT,'MM-DD-YYYY')||" ).append("\n"); 
		query.append("                  DECODE(NOW.AES_PTU_NO, '','',DECODE(SUBSTR(NOW.UPD_USR_ID,1,3),'WEB','WEB('||SUBSTR(NOW.UPD_USR_ID,5)||') PTU:','PTU:'))||NOW.AES_PTU_NO||' '||TO_CHAR(NOW.AES_PTU_DT,'MM-DD-YYYY')||" ).append("\n"); 
		query.append("                  DECODE(NOW.AES_DWN_NO, '','',DECODE(SUBSTR(NOW.UPD_USR_ID,1,3),'WEB','WEB('||SUBSTR(NOW.UPD_USR_ID,5)||') DOWN:','DOWN:'))||NOW.AES_DWN_NO||' '||TO_CHAR(NOW.AES_DWN_DT,'MM-DD-YYYY')||" ).append("\n"); 
		query.append("                  DECODE(NOW.AES_EXPT_ID, '','',DECODE(SUBSTR(NOW.UPD_USR_ID,1,3),'WEB','WEB('||SUBSTR(NOW.UPD_USR_ID,5)||') EXCEPTION:','EXCEPTION:'))||(SELECT INTG_CD_VAL_DP_DESC" ).append("\n"); 
		query.append("                                                                  FROM COM_INTG_CD_DTL" ).append("\n"); 
		query.append("                                                                 WHERE INTG_CD_ID = 'CD02570'" ).append("\n"); 
		query.append("                                                                   AND INTG_CD_VAL_CTNT = NOW.AES_EXPT_ID)||" ).append("\n"); 
		query.append("                  DECODE(NOW.AES_EXPT_CTNT, '','',DECODE(SUBSTR(NOW.UPD_USR_ID,1,3),'WEB','WEB('||SUBSTR(NOW.UPD_USR_ID,5)||') EXCEPTION:','EXCEPTION:'))||' '||NOW.AES_EXPT_CTNT) CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'EXPORT', 'IMPORT')||'-USA' HIS_CATE_NM" ).append("\n"); 
		query.append("                , TRIM(DECODE(OLD.VIN_CTNT, '','','VIN No.:')||' '||OLD.VIN_CTNT" ).append("\n"); 
		query.append("                  ) PRE_CTNT " ).append("\n"); 
		query.append("                , TRIM(DECODE(NOW.VIN_CTNT, '','','VIN No.:')||' '||NOW.VIN_CTNT) CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("           AND OLD.CNT_CD          = 'US'" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT 'AES PRINT FLAG' HIS_CATE_NM ," ).append("\n"); 
		query.append("               OLD.AES_TP_PRN_FLG PRE_CTNT ," ).append("\n"); 
		query.append("               NOW.AES_TP_PRN_FLG CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO       = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("           AND NOW.IO_BND_CD  = OLD.IO_BND_CD" ).append("\n"); 
		query.append("           AND NOW.XPT_IMP_SEQ  = OLD.XPT_IMP_SEQ" ).append("\n"); 
		query.append("           AND NOW.AES_TP_PRN_FLG IS NOT NULL" ).append("\n"); 
		query.append("           AND OLD.AES_TP_PRN_FLG IS NOT NULL" ).append("\n"); 
		query.append("           AND NOW.AES_INLND_TRNS_NO IS NOT NULL" ).append("\n"); 
		query.append("           AND OLD.AES_INLND_TRNS_NO IS NOT NULL" ).append("\n"); 
		query.append("           AND OLD.CNT_CD = 'US'" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > CNPJ NO.' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'SHPR : ' || OLD.SHPR_TAX_NO PRE_CTNT" ).append("\n"); 
		query.append("                , 'SHPR : ' || NOW.SHPR_TAX_NO CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > CNPJ NO.' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'CNEE : ' || OLD.CNEE_TAX_NO PRE_CTNT" ).append("\n"); 
		query.append("                , 'CNEE : ' || NOW.CNEE_TAX_NO CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > CNPJ NO.' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'NTFY : ' || OLD.NTFY_TAX_NO PRE_CTNT" ).append("\n"); 
		query.append("                , 'NTFY : ' || NOW.NTFY_TAX_NO CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("           AND OLD.CNT_CD          = 'BR'" ).append("\n"); 
		query.append(" 		UNION ALL " ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > NIGERIA' HIS_CATE_NM " ).append("\n"); 
		query.append("                , DECODE(OLD.IO_BND_CD, 'O', 'EXS NO. : ' || OLD.NG_EXS_ENS_NO, 'ENS NO. :' || OLD.NG_EXS_ENS_NO) PRE_CTNT" ).append("\n"); 
		query.append("                , DECODE(NOW.IO_BND_CD, 'O', 'EXS NO. : ' || NOW.NG_EXS_ENS_NO, 'ENS NO. :' || NOW.NG_EXS_ENS_NO) CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("           AND NOW.IO_BND_CD   (+) = OLD.IO_BND_CD" ).append("\n"); 
		query.append("           AND NOW.XPT_IMP_SEQ (+) = OLD.XPT_IMP_SEQ" ).append("\n"); 
		query.append("           AND OLD.CNT_CD          = 'NG'" ).append("\n"); 
		query.append("		UNION ALL " ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > TOGO' HIS_CATE_NM " ).append("\n"); 
		query.append("                , DECODE(OLD.IO_BND_CD, 'O', 'ECTN NO.(OB) : ' || OLD.TG_ECTN_NO, 'ECTN NO.(IB) :' || OLD.TG_ECTN_NO) PRE_CTNT" ).append("\n"); 
		query.append("                , DECODE(NOW.IO_BND_CD, 'O', 'ECTN NO.(OB) : ' || NOW.TG_ECTN_NO, 'ECTN NO.(IB) :' || NOW.TG_ECTN_NO) CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("           AND NOW.IO_BND_CD   (+) = OLD.IO_BND_CD" ).append("\n"); 
		query.append("           AND NOW.XPT_IMP_SEQ (+) = OLD.XPT_IMP_SEQ" ).append("\n"); 
		query.append("           AND OLD.CNT_CD          = 'TG'" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > TURKEY' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'SHPR : ' || OLD.TR_SHPR_TAX_ID PRE_CTNT" ).append("\n"); 
		query.append("                , 'SHPR : ' || NOW.TR_SHPR_TAX_ID CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("           AND NOW.IO_BND_CD   (+) = OLD.IO_BND_CD" ).append("\n"); 
		query.append("           AND NOW.XPT_IMP_SEQ (+) = OLD.XPT_IMP_SEQ" ).append("\n"); 
		query.append("           AND OLD.CNT_CD          = 'TR'" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > TURKEY' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'CNEE : ' || OLD.TR_CNEE_TAX_ID PRE_CTNT" ).append("\n"); 
		query.append("                , 'CNEE : ' || NOW.TR_CNEE_TAX_ID CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("        UNION ALL" ).append("\n"); 
		query.append("        SELECT DECODE(OLD.IO_BND_CD, 'O', 'Export', 'Import')||' > TURKEY' HIS_CATE_NM" ).append("\n"); 
		query.append("                , 'NTFY : ' || OLD.TR_NTFY_TAX_ID PRE_CTNT" ).append("\n"); 
		query.append("                , 'NTFY : ' || NOW.TR_NTFY_TAX_ID CRNT_CTNT" ).append("\n"); 
		query.append("          FROM OLD" ).append("\n"); 
		query.append("#if (${ca_flg} == 'Y')" ).append("\n"); 
		query.append("             , BKG_XPT_IMP_LIC_HIS NOW" ).append("\n"); 
		query.append("         WHERE NOW.BKG_NO      (+) = OLD.BKG_NO" ).append("\n"); 
		...
		query.append("                 DECODE(OLD.B13A_XPT_NO1, '','','B13A:')||TO_CHAR(TO_DATE(OLD.B13A_XPT_DT, 'YYYY-MM-DD HH24:MI:SS'),'YYYY-MM-DD HH24:MI')||' '||OLD.B13A_XPT_NO1||OLD.B13A_XPT_NO2||" ).append("\n"); 
		...
		query.append("                 DECODE(NOW.B13A_XPT_NO1, '','','B13A:')||TO_CHAR(NOW.B13A_XPT_DT, 'YYYY-MM-DD HH24:MI')||' '||NOW.B13A_XPT_NO1||NOW.B13A_XPT_NO2||" ).append("\n"); 
