...
*@FileName : ESM_SPC_0044HTMLAction.java
...
public class ESM_SPC_0044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_SPC_0044HTMLAction 객체를 생성
	 */
	public ESM_SPC_0044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmSpc0044Event event = new EsmSpc0044Event();
...
//			event.setSearchSpaceAllocation0044MasterListVO((SearchSpaceAllocation0044MasterListVO)getVO(request, SearchSpaceAllocation0044MasterListVO .class));
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCHLIST02)) {
//			event.setSearchSpaceAllocation0044DetailListVO((SearchSpaceAllocation0044DetailListVO)getVO(request, SearchSpaceAllocation0044DetailListVO .class));
			event.setConditionVO((ConditionVO)getVO(request, ConditionVO .class));
		}
