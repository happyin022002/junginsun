...
*@FileName : TCharterIOConsultationDBDAOCustomApInterfaceStatusVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TCharterIOConsultationDBDAOCustomApInterfaceStatusVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2012-08-27[김상근] 전표에 대한 Reject 작업을 진행한다.
	  * </pre>
	  */
	public TCharterIOConsultationDBDAOCustomApInterfaceStatusVOUSQL(){
		setQuery();
		...
		query.append("FileName : TCharterIOConsultationDBDAOCustomApInterfaceStatusVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
