...
*@FileName : ContinentCodeVO.java
*@FileTitle : ContinentCodeVO
*Open Issues :
*Change history :
...
public class ContinentCodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ContinentCodeVO> models = new ArrayList<ContinentCodeVO>();
	...
	public ContinentCodeVO() {}

	public ContinentCodeVO(String ibflag, String pagerows, String eaiIfId, String contiCd, String contiNm, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return ContinentCodeVO[]
	 */
	public ContinentCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ContinentCodeVO[]
	 */
	public ContinentCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ContinentCodeVO model = null;
	 ...
	 * @return ContinentCodeVO[]
	 */
	public ContinentCodeVO[] getContinentCodeVOs(){
		ContinentCodeVO[] vos = (ContinentCodeVO[])models.toArray(new ContinentCodeVO[models.size()]);
		return vos;
	}
