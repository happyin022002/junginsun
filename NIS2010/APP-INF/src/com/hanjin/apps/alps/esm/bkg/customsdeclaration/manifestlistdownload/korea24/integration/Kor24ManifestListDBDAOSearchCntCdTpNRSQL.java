...
*@FileName : Kor24ManifestListDBDAOSearchCntCdTpNRSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOSearchCntCdTpNRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOSearchCntCdTpNRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : Kor24ManifestListDBDAOSearchCntCdTpNRSQL").append("\n");
		query.append("*/").append("\n");
	}
}