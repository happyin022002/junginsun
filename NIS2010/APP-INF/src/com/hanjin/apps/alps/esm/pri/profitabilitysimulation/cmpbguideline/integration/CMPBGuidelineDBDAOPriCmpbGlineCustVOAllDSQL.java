...
*@FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVOAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOPriCmpbGlineCustVOAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOPriCmpbGlineCustVOAllDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM PRI_CMPB_GLINE_CUST" ).append("\n"); 
		...
		query.append("FileName : CMPBGuidelineDBDAOPriCmpbGlineCustVOAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}