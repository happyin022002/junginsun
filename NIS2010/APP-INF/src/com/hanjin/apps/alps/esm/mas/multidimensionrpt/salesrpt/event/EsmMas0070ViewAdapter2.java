...
* 2013.01.22 박SAQ->SQM [CHM-201322564] Office report vs QTA에 “R.Month Display” 기능 추가 요청
 ...
 * @since J2EE 1.6
 */
public class EsmMas0070ViewAdapter2 extends DefaultViewAdapter {
	
    public EsmMas0070ViewAdapter2(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0070ViewAdapter2 ########### [START]");
...
//			          if (pro_vw.equals("R")){ 
//			          	if (ofc_vw.equals("C")){ 
						  //-- STP Revenue:Net STP Income:Branch CM --%> SAQ->SQM
...
//							  if(ofc_vw.equals("C") && pro_lvl.equals("O")){ SAQ->SQM  
...
//			          if (pro_vw.equals("R")&&pro_lvl.equals("O")){ SAQ->SQM
//				          //-- BKG OPB --%>
...
//			          }
		...
		log.debug("########### EsmMas0070ViewAdapter2 ########### [END]");        
