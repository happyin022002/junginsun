...
*@FileName : SpaceAllocationManageDBDAOSearchScNoValidForFixedRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSearchScNoValidForFixedRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSearchScNoValidForFixedRSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSearchScNoValidForFixedRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
