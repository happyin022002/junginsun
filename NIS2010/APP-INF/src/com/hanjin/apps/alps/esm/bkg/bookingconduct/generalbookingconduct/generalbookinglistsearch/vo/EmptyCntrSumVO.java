...
public class EmptyCntrSumVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String sumA5 = null;

    /* Column Info */
    private String sumDx = null;

    /* Column Info */
    private String sumO7 = null;
    ...
    public EmptyCntrSumVO(String ibflag, String pagerows, String sumD2, String sumD4, String sumD5, String sumD7, String sumR2, String sumR9, String sumR5, String sumF2, String sumF4, String sumF5, String sumO2, String sumO4, String sumA2, String sumA4, String sumS2, String sumS4, String sumA5, String sumDx, String sumO7, String sumO5) {
        this.sumO4 = sumO4;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("sum_r9", getSumR9());
        ...
        this.hashColumns.put("sum_a5", getSumA5());
        this.hashColumns.put("sum_dx", getSumDx());
        this.hashColumns.put("sum_o7", getSumO7());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("sum_r9", "sumR9");
        ...
        this.hashFields.put("sum_a5", "sumA5");
        this.hashFields.put("sum_dx", "sumDx");
        this.hashFields.put("sum_o7", "sumO7");
	 ...
	 * @param sumR9
	 */
    public void setSumR9(String sumR9) {
        this.sumR9 = sumR9;
    }
    ...
    public void setSumO7(String sumO7) {
        this.sumO7 = sumO7;
    }

    public String getSumO7() {
        return this.sumO7;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setSumR9(JSPUtil.getParameter(request, "sum_r9", ""));
        ...
        setSumA5(JSPUtil.getParameter(request, "sum_a5", ""));
        setSumDx(JSPUtil.getParameter(request, "sum_dx", ""));
    }
    ...
    public EmptyCntrSumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] sumR9 = (JSPUtil.getParameter(request, prefix + "sum_r9", length));
            ...
            String[] sumA5 = (JSPUtil.getParameter(request, prefix + "sum_a5", length));
            String[] sumDx = (JSPUtil.getParameter(request, prefix + "sum_dx", length));
            String[] sumO7 = (JSPUtil.getParameter(request, prefix + "sum_o7", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (sumA5[i] != null)
                    model.setSumA5(sumA5[i]);
                if (sumDx[i] != null)
                    model.setSumDx(sumDx[i]);
                if (sumO7[i] != null)
                    model.setSumO7(sumO7[i]);
                if (sumO5[i] != null) 
	...
	*/
    public void unDataFormat() {
        ...
        this.sumR9 = this.sumR9.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.sumA5 = this.sumA5.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.sumDx = this.sumDx.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.sumO7 = this.sumO7.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
