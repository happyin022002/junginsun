...
*@FileName : ESM_BKG_0616HTMLAction.java
...
public class ESM_BKG_0616HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0616HTMLAction 객체를 생성
	 */
	public ESM_BKG_0616HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0616Event event = new EsmBkg0616Event();


		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setBkgListForTmlEdiInputVO((BkgListForTmlEdiInputVO)getVO(request, BkgListForTmlEdiInputVO .class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setFwrdRefVvdVOs((FwrdRefVvdVO[])getVOs(request, FwrdRefVvdVO.class,"sheet1_"));
