 ...
 *@FileName : ESM_PRI_2035HTMLAction.java
...
public class ESM_PRI_2035HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2035Event event = new EsmPri2035Event();
