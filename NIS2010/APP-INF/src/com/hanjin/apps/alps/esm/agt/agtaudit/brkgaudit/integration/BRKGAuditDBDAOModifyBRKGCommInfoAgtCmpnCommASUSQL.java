...
*@FileName : BRKGAuditDBDAOModifyBRKGCommInfoAgtCmpnCommASUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BRKGAuditDBDAOModifyBRKGCommInfoAgtCmpnCommASUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyBRKGCommInfoAgtCmpnCommAS
	  * </pre>
	  */
	public BRKGAuditDBDAOModifyBRKGCommInfoAgtCmpnCommASUSQL(){
		setQuery();
		...
		query.append("FileName : BRKGAuditDBDAOModifyBRKGCommInfoAgtCmpnCommASUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   ,COMM_PROC_RSLT_RSN = 'Paid!!' " ).append("\n"); 
