...
*@FileName : ScqAwkwardDBDAOremovePriScqAwkRoutSmryTmpDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScqAwkwardDBDAOremovePriScqAwkRoutSmryTmpDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRI_SCQ_AWK_ROUT_SMRY_TMP 테이블 삭제
	  * </pre>
	  */
	public ScqAwkwardDBDAOremovePriScqAwkRoutSmryTmpDSQL(){
		setQuery();
		...
		query.append("FileName : ScqAwkwardDBDAOremovePriScqAwkRoutSmryTmpDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  PRI_SCQ_AWK_ROUT_SMRY_TMP" ).append("\n"); 
