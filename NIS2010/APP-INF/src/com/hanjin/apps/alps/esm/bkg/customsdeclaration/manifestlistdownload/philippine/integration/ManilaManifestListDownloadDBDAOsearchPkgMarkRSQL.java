...
public class ManilaManifestListDownloadDBDAOsearchPkgMarkRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Manila 세관에 신고할 대상 Package Marks 정보를 조회한다.
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("		       'SMLM'||BKG.BL_NO bl_no4," ).append("\n"); 
		query.append("		        BKG_SPCLCHAR_CONV_CLOB_FNC(NVL(TO_CLOB(BMD.MK_DESC),' '),'J') desc_good2," ).append("\n"); 
		...
		query.append("		       'SMLM'||BKG.BL_NO bl_no," ).append("\n"); 
		query.append("		       BKG_SPCLCHAR_CONV_CLOB_FNC(NVL(BMD.BL_MK_DESC,' '),'Y') desc_good," ).append("\n"); 
