...
*@FileName : RFARateProposalDBDAOPriRpScpRtCmdtRoutEstmCostDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAOPriRpScpRtCmdtRoutEstmCostDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateProposalDBDAOPriRpScpRtCmdtRoutEstmCostDetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAOPriRpScpRtCmdtRoutEstmCostDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO PRI_RP_SCP_RT_CMDT_ROUT A " ).append("\n"); 
		...
		query.append("		      ,ROW_NUMBER() OVER(PARTITION BY A.PROP_NO,A.AMDT_SEQ,A.SVC_SCP_CD,A.CMDT_HDR_SEQ,A.ROUT_SEQ " ).append("\n"); 
		...
		query.append("              ,PRI_RP_SCP_RT B" ).append("\n"); 
