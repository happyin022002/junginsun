...
*@FileName : RFARateQuotationDBDAOPriRqRtRoutViaVOAddCopyToQuotationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateQuotationDBDAOPriRqRtRoutViaVOAddCopyToQuotationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFARateQuotationDBDAOPriRqRtRoutViaVOAddCopyToQuotationCSQL(){
		setQuery();
		...
		query.append("FileName : RFARateQuotationDBDAOPriRqRtRoutViaVOAddCopyToQuotationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
