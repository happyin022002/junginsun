...
public class KorCllSpclStowRqstDetailVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String olbs40h = null;

    /* Column Info */
    private String olbs20 = null;
    ...
    /* Column Info */
    private String olbl20 = null;

    /* Column Info */
    private String olbl40 = null;

    /* Column Info */
    private String olbl40h = null;

    /* Column Info */
    private String olbl45 = null;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("olbs_45", getOlbs45());
        ...
        this.hashColumns.put("olbs_40", getOlbs40());
        ...
        this.hashColumns.put("olbs_40h", getOlbs40h());
        this.hashColumns.put("olbs_20", getOlbs20());
        ...
        this.hashColumns.put("olbl_20", getOlbl20());
        this.hashColumns.put("olbl_40", getOlbl40());
        this.hashColumns.put("olbl_40h", getOlbl40h());
        this.hashColumns.put("olbl_45", getOlbl45());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("olbs_45", "olbs45");
        ...
        this.hashFields.put("olbs_40", "olbs40");
        ...
        this.hashFields.put("olbs_40h", "olbs40h");
        this.hashFields.put("olbs_20", "olbs20");
        ...
        this.hashFields.put("olbl_20", "olbl20");
        this.hashFields.put("olbl_40", "olbl40");
        this.hashFields.put("olbl_40h", "olbl40h");
        this.hashFields.put("olbl_45", "olbl45");
	 ...
	 * @param olbs45
	 */
    public void setOlbs45(String olbs45) {
        this.olbs45 = olbs45;
    }
	 ...
	 * @param olbs40
	 */
    public void setOlbs40(String olbs40) {
        this.olbs40 = olbs40;
    }
	 ...
	 * @param olbs40h
	 */
    public void setOlbs40h(String olbs40h) {
        this.olbs40h = olbs40h;
    }
	 ...
	 * @param olbs20
	 */
    public void setOlbs20(String olbs20) {
        this.olbs20 = olbs20;
    }
    ...
    public void setOlbl20(String olbl20) {
        this.olbl20 = olbl20;
    }

    public String getOlbl20() {
        return this.olbl20;
    }

    public void setOlbl40(String olbl40) {
        this.olbl40 = olbl40;
    }

    public String getOlbl40() {
        return this.olbl40;
    }

    public void setOlbl40h(String olbl40h) {
        this.olbl40h = olbl40h;
    }

    public String getOlbl40h() {
        return this.olbl40h;
    }

    public void setOlbl45(String olbl45) {
        this.olbl45 = olbl45;
    }

    public String getOlbl45() {
        return this.olbl45;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setOlbs45(JSPUtil.getParameter(request, prefix + "olbs_45", ""));
        ...
        setOlbs40(JSPUtil.getParameter(request, prefix + "olbs_40", ""));
        ...
        setOlbs40h(JSPUtil.getParameter(request, prefix + "olbs_40h", ""));
        setOlbs20(JSPUtil.getParameter(request, prefix + "olbs_20", ""));
        ...
        setOlbl20(JSPUtil.getParameter(request, prefix + "olbl_20", ""));
        setOlbl40(JSPUtil.getParameter(request, prefix + "olbl_40", ""));
        setOlbl40h(JSPUtil.getParameter(request, prefix + "olbl_40h", ""));
        setOlbl45(JSPUtil.getParameter(request, prefix + "olbl_45", ""));
    }
    ...
    public KorCllSpclStowRqstDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] olbs45 = (JSPUtil.getParameter(request, prefix + "olbs_45", length));
            ...
            String[] olbs40 = (JSPUtil.getParameter(request, prefix + "olbs_40", length));
            ...
            String[] olbs40h = (JSPUtil.getParameter(request, prefix + "olbs_40h", length));
            String[] olbs20 = (JSPUtil.getParameter(request, prefix + "olbs_20", length));
            ...
            String[] olbl20 = (JSPUtil.getParameter(request, prefix + "olbl_20", length));
            String[] olbl40 = (JSPUtil.getParameter(request, prefix + "olbl_40", length));
	    	String[] olbl40h = (JSPUtil.getParameter(request, prefix + "olbl_40h", length));
	    	String[] olbl45 = (JSPUtil.getParameter(request, prefix + "olbl_45", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (olbs40h[i] != null)
                    model.setOlbs40h(olbs40h[i]);
                if (olbs20[i] != null)
                    model.setOlbs20(olbs20[i]);
                if (odab20[i] != null)
                ...
                if (olbl20[i] != null)
                    model.setOlbl20(olbl20[i]);
                if (olbl40[i] != null) 
		    		model.setOlbl40(olbl40[i]);
				if (olbl40h[i] != null) 
		    		model.setOlbl40h(olbl40h[i]);
				if (olbl45[i] != null) 
		    		model.setOlbl45(olbl45[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.olbs45 = this.olbs45.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.olbs40 = this.olbs40.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.olbs40h = this.olbs40h.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.olbs20 = this.olbs20.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.olbl20 = this.olbl20.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.olbl40 = this.olbl40.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.olbl40h = this.olbl40h.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.olbl45 = this.olbl45.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
