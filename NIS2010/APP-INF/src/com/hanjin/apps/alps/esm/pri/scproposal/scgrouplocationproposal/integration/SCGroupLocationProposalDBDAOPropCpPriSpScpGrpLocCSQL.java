...
*@FileName : SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proposal Scope Copy PRI_SP_SCP_GRP_LOC Insert
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAOPropCpPriSpScpGrpLocCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
