...
public class SCRateGuidelineDBDAORsltRtRoutHdrListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                      ,ROW_NUMBER() OVER(PARTITION BY SVC_SCP_CD, GLINE_SEQ, PRC_CUST_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ ORDER BY SVC_SCP_CD, GLINE_SEQ, PRC_CUST_TP_CD, CMDT_HDR_SEQ, ROUT_SEQ, DECODE(NOTE_CLSS_CD, 'G', '1', 'S', '2', 'D', '3', 'C', '4', 'O', '5', '99')) AS RN" ).append("\n"); 
