...
*@FileName : BLInformationMgtDBDAOCaSummaryReportOutVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BLInformationMgtDBDAOCaSummaryReportOutVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BLInformationMgtDBDAOCaSummaryReportOutVORSQL(){
		setQuery();
		...
		query.append("FileName : BLInformationMgtDBDAOCaSummaryReportOutVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'CHAMP'                                      AS SLS_RHQ_CD" ).append("\n"); 
