...
**@FileName : ESM_MAS_0272HTMLAction.java
 ...
 * @author Jong-Ock KIM
 * @see EsmMas0272Event 참조
 * @since J2EE 1.6
 */
public class ESM_MAS_0272HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * ESM_MAS_0272HTMLAction 객체를 생성
	 */
	public ESM_MAS_0272HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsmMas0272Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsmMas0272Event event = new EsmMas0272Event();  	
    			
		// 조회
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFullStorageDailyCalcVO((FullStorageDailyCalcVO)getVO(request, FullStorageDailyCalcVO.class));			
		}
		else {
