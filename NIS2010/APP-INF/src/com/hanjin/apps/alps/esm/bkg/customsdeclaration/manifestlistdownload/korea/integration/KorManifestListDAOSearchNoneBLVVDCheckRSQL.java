...
*@FileName : KorManifestListDAOSearchNoneBLVVDCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KorManifestListDAOSearchNoneBLVVDCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KorManifestListDAOSearchNoneBLVVDCheckRSQL(){
		setQuery();
		...
		query.append("FileName : KorManifestListDAOSearchNoneBLVVDCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
