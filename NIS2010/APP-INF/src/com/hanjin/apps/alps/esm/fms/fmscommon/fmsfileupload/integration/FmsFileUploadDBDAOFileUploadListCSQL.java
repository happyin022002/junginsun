...
*@FileName : FmsFileUploadDBDAOFileUploadListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FmsFileUploadDBDAOFileUploadListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FmsFileUploadDBDAOFileUploadListCSQL
	  * </pre>
	  */
	public FmsFileUploadDBDAOFileUploadListCSQL(){
		setQuery();
		...
		query.append("FileName : FmsFileUploadDBDAOFileUploadListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO FMS_ATCH_FILE" ).append("\n"); 
		...
		query.append(" ,(SELECT NVL(MAX(ATCH_FILE_LNK_SEQ),0)+1 FROM FMS_ATCH_FILE WHERE ATCH_FILE_LNK_ID = @[atch_file_lnk_id]) AS ATCH_FILE_LNK_SEQ" ).append("\n"); 
