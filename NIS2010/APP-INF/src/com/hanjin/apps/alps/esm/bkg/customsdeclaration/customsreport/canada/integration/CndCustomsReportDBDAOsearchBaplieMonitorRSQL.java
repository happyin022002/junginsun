...
*@FileName : CndCustomsReportDBDAOsearchBaplieMonitorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndCustomsReportDBDAOsearchBaplieMonitorRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CA AMS Baplie Monitoring Report 조회
	  * </pre>
	  */
	public CndCustomsReportDBDAOsearchBaplieMonitorRSQL(){
		setQuery();
		...
		query.append("FileName : CndCustomsReportDBDAOsearchBaplieMonitorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          AND A.TRSM_MSG_TP_ID='A6A'" ).append("\n"); 
		...
		query.append("-- V1 : L.Foreign Port 에 대한 체크 (CA 바로전 PORT인지)" ).append("\n"); 
