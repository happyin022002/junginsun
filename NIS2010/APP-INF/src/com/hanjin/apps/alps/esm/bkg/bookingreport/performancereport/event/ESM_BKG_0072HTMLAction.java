...
public class ESM_BKG_0072HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * ESM_BKG_0072HTMLAction 객체를 생성
     */
    public ESM_BKG_0072HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0072Event event = new EsmBkg0072Event();

		if (command.isCommand(FormCommand.SEARCH)){
			event.setInfoVO((BDRBookingStatusListVO) getVO(request, BDRBookingStatusListVO.class));
		}
