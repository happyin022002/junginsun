...
*@FileName : SpaceAllocationManageDBDAOSPCAllocBKGCountSMPRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpaceAllocationManageDBDAOSPCAllocBKGCountSMPRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpaceAllocationManageDBDAOSPCAllocBKGCountSMPRSQL(){
		setQuery();
		...
		query.append("FileName : SpaceAllocationManageDBDAOSPCAllocBKGCountSMPRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("									   AND @[dir_cd]                          = D.DIR_CD " ).append("\n"); 
		...
		query.append("-- 계산할때만 실수를 정수로 표현(.5 미만은 버림, 이상은 올림) - 신혜성부장님요청,2015.06.16" ).append("\n"); 
