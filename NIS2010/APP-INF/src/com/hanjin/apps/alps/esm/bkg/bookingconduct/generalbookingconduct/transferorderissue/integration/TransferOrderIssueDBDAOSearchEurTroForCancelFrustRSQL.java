...
public class TransferOrderIssueDBDAOSearchEurTroForCancelFrustRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                        WHEN DTL.IO_BND_CD = 'I' THEN MAX(DTL.TRO_SUB_SEQ)" ).append("\n"); 
		query.append("                        ELSE MIN(DTL.TRO_SUB_SEQ)" ).append("\n"); 
		query.append("                      END" ).append("\n"); 
		query.append("                 FROM BKG_EUR_TRO_DTL DTL" ).append("\n"); 
		query.append("                WHERE DTL.BKG_NO = MST.BKG_NO" ).append("\n"); 
		query.append("                  AND DTL.TRO_SEQ = MST.TRO_SEQ" ).append("\n"); 
		query.append("                  AND DTL.IO_BND_CD = MST.IO_BND_CD" ).append("\n"); 
		query.append("                  AND DTL.DOR_ADDR_TP_CD = 'D'" ).append("\n"); 
		query.append("                GROUP BY DTL.IO_BND_CD ), 1) TRO_SUB_SEQ" ).append("\n"); 
