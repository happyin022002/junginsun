...
*@FileName : BSAManageDBDAORemoveBSATableSC3DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BSAManageDBDAORemoveBSATableSC3DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BSAManageDBDAORemoveBSATableSC3DSQL(){
		setQuery();
		...
		query.append("FileName : BSAManageDBDAORemoveBSATableSC3DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM BSA_SLT_CHTR_BZC" ).append("\n"); 
