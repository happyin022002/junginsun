	...
	*@FileName : InpPrsSurchargeDetailApplicableRouteVO.java
	*@FileTitle : InpPrsSurchargeDetailApplicableRouteVO
	*Open Issues :
	*Change history :
	...
	* 1.0 Creation
	...
	package com.hanjin.apps.alps.esm.pri.profitabilitysimulation.profitabilitysimulation.vo;
	...
	public class InpPrsSurchargeDetailApplicableRouteVO extends AbstractValueObject {

		private static final long serialVersionUID = 1L;
		
		private Collection<InpPrsSurchargeDetailApplicableRouteVO> models = new ArrayList<InpPrsSurchargeDetailApplicableRouteVO>();
		...
		public InpPrsSurchargeDetailApplicableRouteVO() {}

		public InpPrsSurchargeDetailApplicableRouteVO(String ibflag, String pagerows,String qttnNo,String qttnVerNo, String propNo,String triPropNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String cmdtHdrSeq, String routSeq, String rtSeq, String porCd, String polCd, String podCd, String delCd, String rcvTermCd, String deTermCd, String creDt, String creYmd, String rdTermCd) {
			this.porCd = porCd;
			this.creYmd = creYmd;
		 ...
		 */
		public InpPrsSurchargeDetailApplicableRouteVO[] fromRequestGrid(HttpServletRequest request) {
		 ...
		 * @return InpPrsSurchargeDetailApplicableRouteVO[]
		 */
		public InpPrsSurchargeDetailApplicableRouteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
			InpPrsSurchargeDetailApplicableRouteVO model = null;
			...
			try {
				...
				for (int i = 0; i < length; i++) {
					model = new InpPrsSurchargeDetailApplicableRouteVO();
					if (porCd[i] != null)
			...
			return getInpPrsSurchargeDetailApplicableRouteVOs();
		}
		...
		public InpPrsSurchargeDetailApplicableRouteVO[] getInpPrsSurchargeDetailApplicableRouteVOs(){
			InpPrsSurchargeDetailApplicableRouteVO[] vos = (InpPrsSurchargeDetailApplicableRouteVO[])models.toArray(new InpPrsSurchargeDetailApplicableRouteVO[models.size()]);
			return vos;
		}
