...
public class RsltRfaRtListHorizontalExcelVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltRfaRtListHorizontalExcelVO> models = new ArrayList<RsltRfaRtListHorizontalExcelVO>();
	...
	public RsltRfaRtListHorizontalExcelVO() {}
...
//		setIfcDry20(JSPUtil.getParameter(request, "ifc_dry20", ""));
	 ...
	 */
	public RsltRfaRtListHorizontalExcelVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltRtListHorizontalExcelVO[]
	 */
	public RsltRfaRtListHorizontalExcelVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltRfaRtListHorizontalExcelVO model = null;
...
//			String[] ifcDry20 = (JSPUtil.getParameter(request, prefix	+ "ifc_dry20", length));
			...
			for (int i = 0; i < length; i++) {
				model = new RsltRfaRtListHorizontalExcelVO();
//				if (bucDry40[i] != null)
...
//					model.setIfcDry20(ifcDry20[i]);
	 ...
	 * @return RsltRtListHorizontalExcelVO[]
	 */
	public RsltRfaRtListHorizontalExcelVO[] getRsltRtListHorizontalExcelVOs(){
		RsltRfaRtListHorizontalExcelVO[] vos = (RsltRfaRtListHorizontalExcelVO[])models.toArray(new RsltRfaRtListHorizontalExcelVO[models.size()]);
		return vos;
	}
