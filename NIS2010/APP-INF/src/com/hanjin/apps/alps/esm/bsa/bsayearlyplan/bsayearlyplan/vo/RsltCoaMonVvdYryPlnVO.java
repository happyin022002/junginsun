...
*@FileName : RsltCoaMonVvdYryPlnVO.java
*@FileTitle : RsltCoaMonVvdYryPlnVO
*Open Issues :
*Change history :
...
public class RsltCoaMonVvdYryPlnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RsltCoaMonVvdYryPlnVO> models = new ArrayList<RsltCoaMonVvdYryPlnVO>();
...
/**
	 ...
	 * @param request
	 * @return RsltCoaMonVvdYryPlnVO[]
	 */
	public RsltCoaMonVvdYryPlnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RsltCoaMonVvdYryPlnVO[]
	 */
	public RsltCoaMonVvdYryPlnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RsltCoaMonVvdYryPlnVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RsltCoaMonVvdYryPlnVO();
		...
		return getRsltCoaMonVvdYryPlnVOs();
	}
	 ...
	 * @return RsltCoaMonVvdYryPlnVO[]
	 */
	public RsltCoaMonVvdYryPlnVO[] getRsltCoaMonVvdYryPlnVOs(){
		RsltCoaMonVvdYryPlnVO[] vos = (RsltCoaMonVvdYryPlnVO[])models.toArray(new RsltCoaMonVvdYryPlnVO[models.size()]);
		return vos;
	}
