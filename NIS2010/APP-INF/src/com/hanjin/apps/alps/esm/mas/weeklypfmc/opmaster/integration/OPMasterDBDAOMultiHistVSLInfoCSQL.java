...
*@FileName : OPMasterDBDAOMultiHistVSLInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OPMasterDBDAOMultiHistVSLInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OPMasterDBDAOMultiHistVSLInfoCSQL(){
		setQuery();
		...
		query.append("FileName : OPMasterDBDAOMultiHistVSLInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("set VSL_TP_CD = @[vsl_tp_cd]" ).append("\n"); 
		...
		query.append("    ,BSA_VSL_FLG = @[bsa_vsl_flg]" ).append("\n"); 
		...
		query.append("and TO_CHAR(VSL_APLY_FM_DT, 'YYYYMMDD') = TO_CHAR(SYSDATE, 'YYYYMMDD')" ).append("\n"); 
		...
		query.append("     @[vsl_cd]" ).append("\n"); 
		query.append(",CASE WHEN @[auto_flg] = 'Y' THEN (SELECT NVL(MAX(VSL_SEQ),0) seq FROM MAS_VSL_RGST WHERE VSL_CD = @[vsl_cd]) + 1" ).append("\n"); 
		query.append("      ELSE TO_NUMBER(@[vsl_seq])" ).append("\n"); 
		query.append("      END" ).append("\n"); 
		query.append("    ,@[vvd_cd]" ).append("\n"); 
		query.append(", CASE WHEN @[auto_flg] = 'Y' THEN TO_DATE(TO_CHAR(SYSDATE,'YYYYMMDD'), 'YYYYMMDD') " ).append("\n"); 
		query.append("       ELSE TO_DATE(@[vsl_aply_fm_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("       END" ).append("\n"); 
		query.append(", CASE WHEN @[auto_flg] = 'Y' THEN TO_DATE('99991231','YYYYMMDD')" ).append("\n"); 
		query.append("       ELSE TO_DATE(@[vsl_aply_to_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("       END" ).append("\n"); 
		query.append("    ,@[vsl_tp_cd]" ).append("\n"); 
		query.append("    ,@[vsl_oshp_cd]" ).append("\n"); 
		query.append("    ,@[vop_cd]" ).append("\n"); 
		...
		query.append("    ,@[upd_usr_id]" ).append("\n"); 
		query.append("    ,sysdate" ).append("\n"); 
		query.append(", CASE WHEN @[auto_flg] = 'Y' THEN 'N'" ).append("\n"); 
		query.append("       ELSE NVL(@[trd_chk_flg], 'N')" ).append("\n"); 
		query.append("       END" ).append("\n"); 
		query.append("	,@[vsl_prc]" ).append("\n"); 
		query.append("	,@[vsl_prc_rto]" ).append("\n"); 
