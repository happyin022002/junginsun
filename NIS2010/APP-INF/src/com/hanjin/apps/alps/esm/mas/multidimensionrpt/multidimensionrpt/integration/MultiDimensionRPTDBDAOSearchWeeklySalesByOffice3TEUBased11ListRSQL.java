...
*@FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased11ListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased11ListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CSR 1191] MAS 운항비 약정률 (P/L by agreement - By VVD)
	  * </pre>
	  */
	public MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased11ListRSQL(){
		setQuery();
		...
		query.append("FileName : MultiDimensionRPTDBDAOSearchWeeklySalesByOffice3TEUBased11ListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			#end" ).append("\n"); 
		query.append("		" ).append("\n"); 
		query.append("		 GROUP BY B1.COST_YRMON " ).append("\n"); 
		query.append("				,B1.SLS_YRMON " ).append("\n"); 
		query.append("				,B1.COST_WK" ).append("\n"); 
		query.append("				,B1.TRD_CD " ).append("\n"); 
		query.append("				,B1.SUB_TRD_CD " ).append("\n"); 
