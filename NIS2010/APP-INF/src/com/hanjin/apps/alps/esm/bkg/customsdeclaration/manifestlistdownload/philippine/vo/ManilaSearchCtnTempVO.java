...
*@FileName : ManilaSearchCtnTempVO.java
*@FileTitle : ManilaSearchCtnTempVO
*Open Issues :
*Change history :
 ...
 */
public class ManilaSearchCtnTempVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ManilaSearchCtnTempVO> models = new ArrayList<ManilaSearchCtnTempVO>();
	...
	public ManilaSearchCtnTempVO() {}

	public ManilaSearchCtnTempVO(String ibflag, String pagerows, String ofcCd, String regNo, String blNo, String cntrNo, String cntrTpsz, String cgoTp, String cntrSealNo, String cntrSealNo2, String cntrSealNo3, String sealPtyCd, String seq) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return ManilaSearchCtnTempVO[]
	 */
	public ManilaSearchCtnTempVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ManilaSearchCtnTempVO[]
	 */
	public ManilaSearchCtnTempVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ManilaSearchCtnTempVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ManilaSearchCtnTempVO();
				if (ibflag[i] != null) 
		...
		return getManilaSearchCtnTempVOs();
	}
	 ...
	 * @return ManilaSearchCtnTempVO[]
	 */
	public ManilaSearchCtnTempVO[] getManilaSearchCtnTempVOs(){
		ManilaSearchCtnTempVO[] vos = (ManilaSearchCtnTempVO[])models.toArray(new ManilaSearchCtnTempVO[models.size()]);
		return vos;
	}
