...
*@FileName : CMPBGuidelineDBDAOLoadExcelCheckLocRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CMPBGuidelineDBDAOLoadExcelCheckLocRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CMPBGuidelineDBDAOLoadExcelCheckLocRSQL(){
		setQuery();
		...
		query.append("FileName : CMPBGuidelineDBDAOLoadExcelCheckLocRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
