...
*@FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewRoutRefCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewRoutRefCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewRoutRefCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementInfoDBDAOCreateOldAgreementNoVendortoNewRoutRefCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO AGT_AGN_ROUT_REF" ).append("\n"); 
