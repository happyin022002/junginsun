...
*@FileTitle : <Kor24AutoMacSndVO.java
*@FileTitle : Kor24AutoMacSndVO
*Open Issues :
*Change history :
...
public class Kor24AutoMacSndVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24AutoMacSndVO> models = new ArrayList<Kor24AutoMacSndVO>();
	...
	public Kor24AutoMacSndVO() {}

	public Kor24AutoMacSndVO(String ibflag, String pagerows, String sndDt, String ofcCd, String fltFileRefNo, String usrId, String vvdCd, String polCd, String blNo, String subNo, String sndSeq, String ediSndMsg) {
		this.ofcCd = ofcCd;
		this.sndSeq = sndSeq;
		this.polCd = polCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return Kor24AutoMacSndVO[]
	 */
	public Kor24AutoMacSndVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Kor24AutoMacSndVO[]
	 */
	public Kor24AutoMacSndVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24AutoMacSndVO model = null;
	 ...
	 * @return Kor24AutoMacSndVO[]
	 */
	public Kor24AutoMacSndVO[] getKor24AutoMacSndVOs(){
		Kor24AutoMacSndVO[] vos = (Kor24AutoMacSndVO[])models.toArray(new Kor24AutoMacSndVO[models.size()]);
		return vos;
	}
