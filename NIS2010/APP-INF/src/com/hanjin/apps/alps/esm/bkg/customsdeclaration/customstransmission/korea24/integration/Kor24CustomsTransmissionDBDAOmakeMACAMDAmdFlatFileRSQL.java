...
*@FileName : Kor24CustomsTransmissionDBDAOmakeMACAMDAmdFlatFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Kor24CustomsTransmissionDBDAOmakeMACAMDAmdFlatFileRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24CustomsTransmissionDBDAOmakeMACAMDAmdFlatFileRSQL(){
		setQuery();
		...
		query.append("FileName : Kor24CustomsTransmissionDBDAOmakeMACAMDAmdFlatFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
