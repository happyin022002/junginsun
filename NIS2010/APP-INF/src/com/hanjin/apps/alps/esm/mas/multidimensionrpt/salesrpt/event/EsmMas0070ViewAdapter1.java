 ...
 * @since J2EE 1.6
 */
public class EsmMas0070ViewAdapter1 extends DefaultViewAdapter {
	
    public EsmMas0070ViewAdapter1(){
    	super();
    }
    ...
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EsmMas0070ViewAdapter ########### [START]");
...
//					if (pro_vw.equals("R")&&pro_lvl.equals("O")){
		...
		log.debug("########### EsmMas0070ViewAdapter ########### [END]");        
