...
*@FileName : FICCostInterfaceDBDAOAddTariffFeederDurationDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FICCostInterfaceDBDAOAddTariffFeederDurationDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT - PRI_TRF_FDR_DUR
	  * </pre>
	  */
	public FICCostInterfaceDBDAOAddTariffFeederDurationDataCSQL(){
		setQuery();
		...
		query.append("FileName : FICCostInterfaceDBDAOAddTariffFeederDurationDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
