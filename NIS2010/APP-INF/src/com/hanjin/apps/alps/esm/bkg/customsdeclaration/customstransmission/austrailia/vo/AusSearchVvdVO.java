...
*@FileName : AusSearchVvdVO.java
*@FileTitle : AusSearchVvdVO
*Open Issues :
*Change history :
...
public class AusSearchVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AusSearchVvdVO> models = new ArrayList<AusSearchVvdVO>();
	...
	public AusSearchVvdVO() {}

	public AusSearchVvdVO(String ibflag, String pagerows, String vslCallsign, String vslLloydcode, String vslFullname, String msgFunc) {
	...
	public void fromRequest(HttpServletRequest request) {
		setMsgFunc(JSPUtil.getParameter(request, "msg_func", ""));
	 ...
	 * @param request
	 * @return AusSearchVvdVO[]
	 */
	public AusSearchVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AusSearchVvdVO[]
	 */
	public AusSearchVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AusSearchVvdVO model = null;
	 ...
	 * @return AusSearchVvdVO[]
	 */
	public AusSearchVvdVO[] getAusSearchVvdVOs(){
		AusSearchVvdVO[] vos = (AusSearchVvdVO[])models.toArray(new AusSearchVvdVO[models.size()]);
		return vos;
	}
