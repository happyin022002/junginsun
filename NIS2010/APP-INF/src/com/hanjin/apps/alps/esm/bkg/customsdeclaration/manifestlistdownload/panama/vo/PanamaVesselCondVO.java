...
public class PanamaVesselCondVO extends VesselCondVO {
	...
	public PanamaVesselCondVO(String ibflag, String pagerows, String vpsEtaEndDt, String vslCd, String skdDirCd, String skdVoyNo, String vpsEtaStartDt, String slanCd, String transSts) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
		this.slanCd = slanCd;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTransSts(JSPUtil.getParameter(request, "trans_sts", ""));
