...
*@FileName : SCRateQuotationDBDAOPriSqRtRoutPntVOUSQL.java
...
public class SCRateQuotationDBDAOPriSqRtRoutPntVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtRoutPntVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtRoutPntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_RT_ROUT_PNT SET" ).append("\n"); 
