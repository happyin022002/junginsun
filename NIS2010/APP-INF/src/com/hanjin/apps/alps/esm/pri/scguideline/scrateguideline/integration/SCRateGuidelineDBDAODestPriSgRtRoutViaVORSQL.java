...
*@FileName : SCRateGuidelineDBDAODestPriSgRtRoutViaVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateGuidelineDBDAODestPriSgRtRoutViaVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateGuidelineDBDAODestPriSgRtRoutViaVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCRateGuidelineDBDAODestPriSgRtRoutViaVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}