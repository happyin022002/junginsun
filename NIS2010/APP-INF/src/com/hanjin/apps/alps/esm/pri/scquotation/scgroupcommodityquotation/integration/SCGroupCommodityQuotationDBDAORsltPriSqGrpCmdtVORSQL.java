...
*@FileName : SCGroupCommodityQuotationDBDAORsltPriSqGrpCmdtVORSQL.java
...
public class SCGroupCommodityQuotationDBDAORsltPriSqGrpCmdtVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupCommodityQuotationDBDAORsltPriSqGrpCmdtVORSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupCommodityQuotationDBDAORsltPriSqGrpCmdtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
