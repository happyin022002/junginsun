...
*@FileName : RFARateProposalDBDAORsltAllRtSpotListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFARateProposalDBDAORsltAllRtSpotListVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Accept All Spot List
	  * </pre>
	  */
	public RFARateProposalDBDAORsltAllRtSpotListVORSQL(){
		setQuery();
		...
		query.append("FileName : RFARateProposalDBDAORsltAllRtSpotListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND A.AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("   AND A.SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("   AND NVL(A.FIC_RT_TP_CD,'G') = NVL(DECODE(@[fic_rt_tp_cd], 'null','G', @[fic_rt_tp_cd]), 'G')" ).append("\n"); 
