...
*@FileName : ESM_PRI_2054HTMLAction.java
...
public class ESM_PRI_2054HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_PRI_2054HTMLAction 객체를 생성
	 */
	public ESM_PRI_2054HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmPri2054Event event = new EsmPri2054Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRsltRfaAproRqstRefByOfcVO((RsltRfaAproRqstRefByOfcVO)getVO(request, RsltRfaAproRqstRefByOfcVO.class));
		}
