...
*@FileName : ESM_BKG_0155HTMLAction.java
...
public class ESM_BKG_0155HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0155HTMLAction 객체를 생성
	 */
	public ESM_BKG_0155HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0155Event event = new EsmBkg0155Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCllCondVO((CllCondVO)getVO(request, CllCondVO .class));
		}	
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setCllDetailVOs((CllDetailVO[])getVOs(request, CllDetailVO .class,""));
		}		
