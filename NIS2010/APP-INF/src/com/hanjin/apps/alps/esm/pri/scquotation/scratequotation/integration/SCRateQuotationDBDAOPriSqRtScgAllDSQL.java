...
*@FileName : SCRateQuotationDBDAOPriSqRtScgAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateQuotationDBDAOPriSqRtScgAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtScgAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtScgAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
