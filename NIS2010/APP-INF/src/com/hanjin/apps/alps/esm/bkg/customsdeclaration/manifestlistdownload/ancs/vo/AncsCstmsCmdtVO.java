...
*@FileName : AncsCstmsCmdtVO.java
*@FileTitle : AncsCstmsCmdtVO
*Open Issues :
*Change history :
...
public class AncsCstmsCmdtVO extends BlDetailVO {

	private static final long serialVersionUID = 1L;
	
	private Collection<AncsCstmsCmdtVO> models = new ArrayList<AncsCstmsCmdtVO>();
	...
	public AncsCstmsCmdtVO() {}

	public AncsCstmsCmdtVO(String ibflag, String pagerows, String vvd, String vslCd, String skdVoyNo, String skdDirCd, String bkgNo, String cntrNo, String cntrSeq, String declFlg, String pckQty, String pckTpCd, String cntrMfWgt, String wgtUtCd, String cntrMfDesc) {
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return AncsCstmsCmdtVO[]
	 */
	public AncsCstmsCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AncsCstmsCmdtVO[]
	 */
	public AncsCstmsCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AncsCstmsCmdtVO model = null;
	...
	public AncsCstmsCmdtVO[] getAncsCstmsCmdtVOs(){
		AncsCstmsCmdtVO[] vos = (AncsCstmsCmdtVO[])models.toArray(new AncsCstmsCmdtVO[models.size()]);
		return vos;
	}
