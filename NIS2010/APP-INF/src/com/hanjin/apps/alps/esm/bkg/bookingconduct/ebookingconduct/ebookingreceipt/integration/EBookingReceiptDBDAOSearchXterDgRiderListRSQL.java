...
public class EBookingReceiptDBDAOSearchXterDgRiderListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",(SELECT CNTR_NO ||' / '|| NVL(CNTR_CGO_SEQ,'1') FROM BKG_xter_DG_CGO WHERE XTER_SNDR_ID = @[sender_id] and XTER_RQST_SEQ = @[rqst_seq] and XTER_RQST_NO=MAIN_TABLE.XTER_RQST_NO and DCGO_SEQ = MAIN_TABLE.CARGO_SEQ)  AS CARGO_CONTAIN" ).append("\n"); 
