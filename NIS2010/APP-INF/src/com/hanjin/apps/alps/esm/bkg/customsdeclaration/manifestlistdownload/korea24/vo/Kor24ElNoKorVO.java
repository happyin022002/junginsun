...
public class Kor24ElNoKorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<Kor24ElNoKorVO> models = new ArrayList<Kor24ElNoKorVO>();
	...
	public Kor24ElNoKorVO() {}

	public Kor24ElNoKorVO(String ibflag, String pagerows, String bkgNo, String bkgNoSplit, String ktPort) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
	 ...
	 * @return CreatorVO[]
	 */
	public Kor24ElNoKorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreatorVO[]
	 */
	public Kor24ElNoKorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Kor24ElNoKorVO model = null;
	 ...
	 * @return CreatorVO[]
	 */
	public Kor24ElNoKorVO[] getCreatorVOs(){
		Kor24ElNoKorVO[] vos = (Kor24ElNoKorVO[])models.toArray(new Kor24ElNoKorVO[models.size()]);
		return vos;
	}
