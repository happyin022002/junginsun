...
*@FileName : ESM_BKG_0464HTMLAction.java
...
public class ESM_BKG_0464HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0464HTMLAction 객체를 생성
	 */
	public ESM_BKG_0464HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0464Event event = new EsmBkg0464Event();
		

		if(command.isCommand(FormCommand.SEARCH02)) {
            event.setProductionRatioVO((ProductionRatioVO)getVO(request, ProductionRatioVO .class));
