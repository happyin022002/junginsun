...
*@FileName : PRICommonDBDAORgLocationGroupNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PRICommonDBDAORgLocationGroupNmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PRICommonDBDAORgLocationGroupNmRSQL(){
		setQuery();
		...
		query.append("FileName : PRICommonDBDAORgLocationGroupNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND (@[etc3] IS NULL OR ORG_DEST_TP_CD = 'B' OR ORG_DEST_TP_CD = @[etc3])" ).append("\n"); 
