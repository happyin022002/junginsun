...
public class ChnMnlBkgNoGenCondVO extends AbstractValueObject {
	...
	public ChnMnlBkgNoGenCondVO(String ibflag, String pagerows, String bkgNo, String chnAgnCd, String bkgNoUseFlg, String bkgCreDt, String creOfcCd, String docUsrId, String creUsrId, String updUsrId, String fmCreDt, String toCreDt, String noOfBkg, String actChnAgnCd, String actCreOfcCd, String actCreUsrId) {
	...
	public void fromRequest(HttpServletRequest request) {
		setNoOfBkg(JSPUtil.getParameter(request, "no_of_bkg", ""));
		setFmCreDt(JSPUtil.getParameter(request, "fm_cre_dt", ""));
		setDocUsrId(JSPUtil.getParameter(request, "doc_usr_id", ""));
		setActCreOfcCd(JSPUtil.getParameter(request, "act_cre_ofc_cd", ""));
		...
		setActCreUsrId(JSPUtil.getParameter(request, "act_cre_usr_id", ""));
		setChnAgnCd(JSPUtil.getParameter(request, "chn_agn_cd", ""));
		setBkgNoUseFlg(JSPUtil.getParameter(request, "bkg_no_use_flg", ""));
		setactChnAgnCd(JSPUtil.getParameter(request, "act_chn_agn_cd", ""));
