...
public class NetworkCostDBDAOCreateDailyHireFromFMSCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("INSERT INTO MAS_VSL_CHRG_IF" ).append("\n"); 
		...
		query.append("                              ,ROW_NUMBER() OVER(PARTITION BY M.FLET_CTRT_NO ORDER BY M.FLET_CTRT_NO, M.VSL_CD, D.EFF_DT) SEQ" ).append("\n"); 
