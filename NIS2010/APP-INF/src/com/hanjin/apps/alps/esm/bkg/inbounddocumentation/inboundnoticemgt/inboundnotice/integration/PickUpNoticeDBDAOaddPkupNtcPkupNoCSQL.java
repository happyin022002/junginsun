...
public class PickUpNoticeDBDAOaddPkupNtcPkupNoCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	@[bkg_no]" ).append("\n"); 
		query.append(",	@[cntr_no]" ).append("\n"); 
		query.append(",   (SELECT DECODE(SUBSTR(BK.DEL_CD,1,2),'US','PHXSA',MDM.EQ_CTRL_OFC_CD) EQ_CTRL_OFC_CD " ).append("\n"); 
		query.append("     FROM MDM_LOCATION MDM, BKG_BOOKING BK" ).append("\n"); 
		query.append("     WHERE LOC_CD = BK.DEL_CD" ).append("\n"); 
