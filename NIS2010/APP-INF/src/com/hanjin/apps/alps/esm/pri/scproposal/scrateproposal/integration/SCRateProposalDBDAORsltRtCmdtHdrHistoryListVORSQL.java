...
*@FileName : SCRateProposalDBDAORsltRtCmdtHdrHistoryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtCmdtHdrHistoryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * * 2016.01.01 현성길 [CHM-201639679] S/C 4000자 글자수 제한
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtCmdtHdrHistoryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtCmdtHdrHistoryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM PRI_SP_SCP_RT_CMDT_HDR A, MN" ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		...
		query.append("                                  FROM PRI_SP_SCP_RT_CMDT A, MN" ).append("\n"); 
		...
		query.append("                                                            AND A.SRC_INFO_CD <> DECODE(MN.LGCY_IF_FLG, 'Y', 'AD', 'X')" ).append("\n"); 
		...
		query.append("                  FROM PRI_SP_SCP_RT_ACT_CUST A, MN" ).append("\n"); 
		query.append("                 WHERE PROP_NO = @[prop_no]" ).append("\n"); 
		query.append("                   AND AMDT_SEQ = @[amdt_seq]" ).append("\n"); 
		query.append("                   AND SVC_SCP_CD = @[svc_scp_cd]" ).append("\n"); 
		query.append("                   AND GEN_SPCL_RT_TP_CD = @[gen_spcl_rt_tp_cd]" ).append("\n"); 
		query.append("                   AND SRC_INFO_CD <> DECODE(LGCY_IF_FLG, 'Y', 'AD', 'X')) K" ).append("\n"); 
		query.append("         START WITH RN = 1" ).append("\n"); 
		query.append("        CONNECT BY PRIOR CMDT_HDR_SEQ = CMDT_HDR_SEQ" ).append("\n"); 
		...
		query.append("          FROM (SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ" ).append("\n"); 
		...
		query.append("                SELECT PROP_NO, AMDT_SEQ, SVC_SCP_CD, GEN_SPCL_RT_TP_CD, CMDT_HDR_SEQ" ).append("\n"); 
