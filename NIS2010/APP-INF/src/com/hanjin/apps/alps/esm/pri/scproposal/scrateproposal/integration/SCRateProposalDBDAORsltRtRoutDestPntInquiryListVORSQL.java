...
*@FileName : SCRateProposalDBDAORsltRtRoutDestPntInquiryListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCRateProposalDBDAORsltRtRoutDestPntInquiryListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateProposalDBDAORsltRtRoutDestPntInquiryListVORSQL(){
		setQuery();
		...
		query.append("FileName : SCRateProposalDBDAORsltRtRoutDestPntInquiryListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
