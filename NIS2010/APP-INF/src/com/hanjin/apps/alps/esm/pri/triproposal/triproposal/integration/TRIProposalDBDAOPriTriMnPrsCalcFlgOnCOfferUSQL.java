...
*@FileName : TRIProposalDBDAOPriTriMnPrsCalcFlgOnCOfferUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriMnPrsCalcFlgOnCOfferUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriMnPrsCalcFlgOnCOfferUSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriMnPrsCalcFlgOnCOfferUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	PRS_RT_CMPB_CALC_FLG = DECODE(@[prop_sts_cd], 'R', 'Y', 'N')" ).append("\n"); 
