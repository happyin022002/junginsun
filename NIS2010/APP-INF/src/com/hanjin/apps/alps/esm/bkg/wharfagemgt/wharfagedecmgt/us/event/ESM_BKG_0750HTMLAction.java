 ...
 *@FileName : ESM_BKG_0750HTMLAction.java
 ...
 * @see EsmBkg0750Event 참조
 * @since J2EE 1.4
 */
public class ESM_BKG_0750HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_0750HTMLAction 객체를 생성
	 */
	public ESM_BKG_0750HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg0750Event event = new EsmBkg0750Event();
		if (command.isCommand(FormCommand.SEARCH))
		{
			event.setUsWhfPortRtListCondVO((UsWhfPortRtListCondVO) getVO(request, UsWhfPortRtListCondVO.class));
		}
		else if (command.isCommand(FormCommand.MULTI))
		{
			event.setUsWhfPortRtVOs((UsWhfPortRtVO[]) getVOs(request, UsWhfPortRtVO.class));
		}
