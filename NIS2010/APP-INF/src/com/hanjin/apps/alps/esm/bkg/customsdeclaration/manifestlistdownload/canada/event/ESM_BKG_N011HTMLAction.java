/*=========================================================
 *Copyright(c) SMLines
 *@FileName : ESM_BKG_N010HTMLAction
 ...
 * @since J2EE 1.4
 */
public class ESM_BKG_N011HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;

	/**
	 * ESM_BKG_N011HTMLAction 객체를 생성
	 */
	public ESM_BKG_N011HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
	    	...
	    	EsmBkgN011Event event = new EsmBkgN011Event();
			

			if(command.isCommand(FormCommand.SEARCH)) {
				event.setCndCstmsVslCrnNoVO((CndCstmsVslCrnNoVO)getVO(request, CndCstmsVslCrnNoVO.class));
