...
*@FileName : BkgCustAvcNtcSndHisVO.java
*@FileTitle : BkgCustAvcNtcSndHisVO
*Open Issues :
*Change history :
...
public class BkgCustAvcNtcSndHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCustAvcNtcSndHisVO> models = new ArrayList<BkgCustAvcNtcSndHisVO>();
	...
	public BkgCustAvcNtcSndHisVO() {}

	public BkgCustAvcNtcSndHisVO(String ibflag, String pagerows, String vvd, String blNo, String cntrNo, String polCd, String podCd, String delCd, String custTp, String custNm, String sntFaxNoEml, String sntRmk, String sntRsltCd, String sntRsltCtnt, String sntDt, String sntOfcCd, String sntUsrId, String ntcSndRqstDt, String ntcSndDt, String srcDatTpCd) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSntDt(JSPUtil.getParameter(request, prefix + "snt_dt", ""));
	 ...
	 * @param request
	 * @return BkgCustAvcNtcSndHisVO[]
	 */
	public BkgCustAvcNtcSndHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCustAvcNtcSndHisVO[]
	 */
	public BkgCustAvcNtcSndHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCustAvcNtcSndHisVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCustAvcNtcSndHisVO();
		...
		return getBkgCustAvcNtcSndHisVOs();
	}
	 ...
	 * @return BkgCustAvcNtcSndHisVO[]
	 */
	public BkgCustAvcNtcSndHisVO[] getBkgCustAvcNtcSndHisVOs(){
		BkgCustAvcNtcSndHisVO[] vos = (BkgCustAvcNtcSndHisVO[])models.toArray(new BkgCustAvcNtcSndHisVO[models.size()]);
		return vos;
	}
