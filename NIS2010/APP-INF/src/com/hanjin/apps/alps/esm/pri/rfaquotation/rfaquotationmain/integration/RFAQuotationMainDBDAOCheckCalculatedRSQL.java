...
*@FileName : RFAQuotationMainDBDAOCheckCalculatedRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAQuotationMainDBDAOCheckCalculatedRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAQuotationMainDBDAOCheckCalculatedRSQL(){
		setQuery();
		...
		query.append("FileName : RFAQuotationMainDBDAOCheckCalculatedRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  COUNT(A1.QTTN_NO) AS CNT_CAL       " ).append("\n"); 
		query.append("FROM    (       " ).append("\n"); 
		query.append("        SELECT A.QTTN_NO AS QTTN_NO" ).append("\n"); 
		...
		query.append("        AND    A.PRS_RT_CMPB_CALC_FLG = 'Y'" ).append("\n"); 
