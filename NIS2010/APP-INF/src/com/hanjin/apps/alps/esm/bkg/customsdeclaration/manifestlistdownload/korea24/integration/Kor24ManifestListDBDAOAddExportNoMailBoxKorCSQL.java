...
*@FileName : Kor24ManifestListDBDAOAddExportNoMailBoxKorCSQL.java
*@FileTitle :
*Open Issues :
*Change history :
...
public class Kor24ManifestListDBDAOAddExportNoMailBoxKorCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Kor24ManifestListDBDAOAddExportNoMailBoxKorCSQL(){
		setQuery();
		...
		query.append("FileName : Kor24ManifestListDBDAOAddExportNoMailBoxKorCSQL").append("\n");
		query.append("*/").append("\n");
	}
