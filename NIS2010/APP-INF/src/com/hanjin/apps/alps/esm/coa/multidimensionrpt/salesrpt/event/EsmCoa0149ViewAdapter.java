...
*@FileName : EsmCoa0149ViewAdapter.java
*@FileTitle : EsmCoa0149ViewAdapter
*Open Issues :
*Change history :
...
/**
 * ESM_COA_0149 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EsmCoa0149ViewAdapter extends DefaultViewAdapter {

    public EsmCoa0149ViewAdapter(){
    	super();
    }
	/**
