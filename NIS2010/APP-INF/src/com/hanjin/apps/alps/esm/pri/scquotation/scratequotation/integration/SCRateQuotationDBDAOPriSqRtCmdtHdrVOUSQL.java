...
*@FileName : SCRateQuotationDBDAOPriSqRtCmdtHdrVOUSQL.java
...
public class SCRateQuotationDBDAOPriSqRtCmdtHdrVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCRateQuotationDBDAOPriSqRtCmdtHdrVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCRateQuotationDBDAOPriSqRtCmdtHdrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PRI_SQ_RT_CMDT_HDR SET" ).append("\n"); 
