...
public class LogisticsRPTDBDAOSearchUSInlandCost0163ListVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                      , COA_LOC_FNC(ROUT_ORG_NOD_CD,'ECC')  AS FM_ECC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(ROUT_ORG_NOD_CD,'LCC')  AS FM_LCC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(ROUT_ORG_NOD_CD,'RCC')  AS FM_RCC" ).append("\n"); 
		query.append("                      , HUB_NOD_CD                          AS HUB_NOD" ).append("\n"); 
		query.append("                      , SUBSTR(HUB_NOD_CD,1,5)              AS HUB_LOC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(HUB_NOD_CD,'ECC')       AS HUB_ECC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(HUB_NOD_CD,'LCC')       AS HUB_LCC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(HUB_NOD_CD,'RCC')       AS HUB_RCC" ).append("\n"); 
		query.append("                      , ROUT_DEST_NOD_CD                    AS TO_NOD" ).append("\n"); 
		query.append("                      , SUBSTR(ROUT_DEST_NOD_CD,1,5)        AS TO_LOC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(ROUT_DEST_NOD_CD,'ECC') AS TO_ECC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(ROUT_DEST_NOD_CD,'LCC') AS TO_LCC" ).append("\n"); 
		query.append("                      , COA_LOC_FNC(ROUT_DEST_NOD_CD,'RCC') AS TO_RCC" ).append("\n"); 
		...
		query.append("           FROM COA_LNK_AVG_STND_COST A1" ).append("\n"); 
		query.append("              , LOC A2" ).append("\n"); 
		query.append("          WHERE COST_YRMON = CASE WHEN COA_BZC_COST_YRMON_FNC('')<TO_CHAR(SYSDATE,'yyyymm') THEN COA_BZC_COST_YRMON_FNC('') " ).append("\n"); 
		...
		query.append("                                 ,A2.TO_RCC " ).append("\n"); 
		query.append("                                 ) " ).append("\n"); 
		query.append("            AND ((FULL_MTY_CD = 'F' AND COST_LOC_GRP_CD = 'C' AND COA_COST_SRC_CD IN ('TRLCRD','TRLCTD','TRDRTD','SCFURD','SCFUTD')) OR " ).append("\n"); 
		query.append("                 (FULL_MTY_CD = 'M' AND COA_COST_SRC_CD IN ('TRMTRD','TRMTTD','SMFURD','SMFUTD')) )" ).append("\n"); 
		...
		query.append("              , B1.COA_COST_SRC_CD" ).append("\n"); 
		...
		query.append("                   FROM COA_LNK_AVG_STND_COST A1" ).append("\n"); 
		query.append("                      , LOC A2" ).append("\n"); 
		query.append("                  WHERE COST_YRMON = CASE WHEN COA_BZC_COST_YRMON_FNC('')<TO_CHAR(SYSDATE,'yyyymm') " ).append("\n"); 
		query.append("                                          THEN COA_BZC_COST_YRMON_FNC('') ELSE TO_CHAR(SYSDATE,'yyyymm') END" ).append("\n"); 
		query.append("                    AND CNTR_TPSZ_CD  <> 'BOX'" ).append("\n"); 
		query.append("                    AND LNK_FM_NOD_CD IN (A2.FM_LOC" ).append("\n"); 
		query.append("                                         ,A2.FM_ECC" ).append("\n"); 
		query.append("                                         ,A2.FM_LCC" ).append("\n"); 
		...
		query.append("                              , MAX(DECODE(A1.COA_COST_SRC_CD,'TRLCRD','Y')) AS R_TRLCRD_FLG" ).append("\n"); 
		query.append("                              , MAX(DECODE(A1.COA_COST_SRC_CD,'SCFURD','Y')) AS R_SCFURD_FLG" ).append("\n"); 
		...
		query.append("                            AND A1.COA_COST_SRC_CD IN ('TRLCRD','SCFURD')" ).append("\n"); 
		...
		query.append("                                      , MAX(DECODE(A1.COA_COST_SRC_CD,DECODE(@[f_group],'CY','TRLCTD','Door','TRDRTD'),'Y')) AS T_TRCK_FLG" ).append("\n"); 
		query.append("                                      , NULL AS T_SCFUTD_FLG" ).append("\n"); 
		query.append("                                   FROM LNK A1" ).append("\n"); 
		query.append("                                      , LOC A2" ).append("\n"); 
		query.append("                                  WHERE A1.FULL_MTY_CD = 'F'" ).append("\n"); 
		query.append("                                    AND A1.COA_COST_SRC_CD = DECODE(@[f_group],'CY','TRLCTD','Door','TRDRTD')" ).append("\n"); 
		query.append("                                    AND A1.LNK_FM_NOD_CD || A1.LNK_TO_NOD_CD " ).append("\n"); 
		...
		query.append("                                                 ELSE STND_COST_USD_AMT END) AS T_LOC_AMT" ).append("\n"); 
		query.append("                                      , NULL AS T_TRCK_FLG" ).append("\n"); 
		query.append("                                      , MAX(DECODE(A1.COA_COST_SRC_CD,'SCFUTD','Y')) AS T_SCFUTD_FLG" ).append("\n"); 
		query.append("                                   from LNK A1" ).append("\n"); 
		query.append("                                      , LOC A2" ).append("\n"); 
		query.append("                                  WHERE A1.FULL_MTY_CD = 'F'" ).append("\n"); 
		query.append("                                    AND A1.COA_COST_SRC_CD = 'SCFUTD'" ).append("\n"); 
		query.append("                                    AND A1.LNK_FM_NOD_CD || A1.LNK_TO_NOD_CD" ).append("\n"); 
		query.append("                                        IN ( CASE WHEN A2.ISHUB = 'Y' THEN DECODE(A2.INOUT,'I', A2.HUB_LOC, 'O', A2.FM_LOC) WHEN A2.ISHUB = 'N' THEN A2.FM_LOC END" ).append("\n"); 
		query.append("                                          || CASE WHEN A2.ISHUB = 'Y' THEN DECODE(A2.INOUT,'I', A2.TO_LOC, 'O', A2.HUB_LOC) WHEN A2.ISHUB = 'N' THEN A2.TO_LOC END)" ).append("\n"); 
		query.append("                               GROUP BY A2.FM_LOC" ).append("\n"); 
		...
		query.append("									  , DECODE(A1.COA_COST_SRC_CD,DECODE(A2.ISHUB,'Y', 'TRMTRD', 'TRMTTD'),'Y') AS M_TRMT_FLG" ).append("\n"); 
		query.append("									  , DECODE(A1.COA_COST_SRC_CD,DECODE(A2.ISHUB,'Y', 'SMFURD', 'SMFUTD'),'Y') AS M_SCMT_FLG" ).append("\n"); 
		query.append("								   FROM LNK A1" ).append("\n"); 
		query.append("									  , LOC A2" ).append("\n"); 
		query.append("								  WHERE A1.FULL_MTY_CD  = 'M'" ).append("\n"); 
		query.append("									AND A1.COA_COST_SRC_CD IN (DECODE(A2.ISHUB,'Y', 'TRMTRD', 'TRMTTD'), DECODE(A2.ISHUB,'Y', 'SMFURD', 'SMFUTD'))" ).append("\n"); 
