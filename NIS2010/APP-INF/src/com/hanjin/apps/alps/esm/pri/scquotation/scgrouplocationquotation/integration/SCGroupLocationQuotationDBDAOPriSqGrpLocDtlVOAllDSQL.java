...
*@FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAllDSQL.java
...
public class SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAllDSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationQuotationDBDAOPriSqGrpLocDtlVOAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
