...
*@FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtRtCopyVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AGTOfficeAgreementDBDAOAgtAgnAgmtRtCopyVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agt_Agn_Agmt_Rt 테이블에 copy
	  * </pre>
	  */
	public AGTOfficeAgreementDBDAOAgtAgnAgmtRtCopyVOCSQL(){
		setQuery();
		...
		query.append("FileName : AGTOfficeAgreementDBDAOAgtAgnAgmtRtCopyVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
