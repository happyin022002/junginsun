...
*@FileName : TRIProposalDBDAOPriTriRtScgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TRIProposalDBDAOPriTriRtScgVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *    Surcharge Detail 생성 ( UI_PRI_6085  )
	  * </pre>
	  */
	public TRIProposalDBDAOPriTriRtScgVOCSQL(){
		setQuery();
		...
		query.append("FileName : TRIProposalDBDAOPriTriRtScgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into pri_tri_rt_scg(" ).append("\n"); 
