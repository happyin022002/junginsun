...
*@FileName : SCContractPartyProposalDBDAOPriSpCtrtPtyVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCContractPartyProposalDBDAOPriSpCtrtPtyVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCContractPartyProposalDBDAOPriSpCtrtPtyVOUSQL(){
		setQuery();
		...
		query.append("FileName : SCContractPartyProposalDBDAOPriSpCtrtPtyVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	POA_ATCH_FILE_ID      = @[poa_atch_file_id]" ).append("\n"); 
