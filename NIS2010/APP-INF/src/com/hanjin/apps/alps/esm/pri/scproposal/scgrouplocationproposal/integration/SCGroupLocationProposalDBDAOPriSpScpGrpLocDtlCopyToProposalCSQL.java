...
*@FileName : SCGroupLocationProposalDBDAOPriSpScpGrpLocDtlCopyToProposalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGroupLocationProposalDBDAOPriSpScpGrpLocDtlCopyToProposalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PriSpScpGrpLocDtlCopyToProposal
	  * </pre>
	  */
	public SCGroupLocationProposalDBDAOPriSpScpGrpLocDtlCopyToProposalCSQL(){
		setQuery();
		...
		query.append("FileName : SCGroupLocationProposalDBDAOPriSpScpGrpLocDtlCopyToProposalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	PRI_SQ_GRP_LOC_DTL C" ).append("\n"); 
