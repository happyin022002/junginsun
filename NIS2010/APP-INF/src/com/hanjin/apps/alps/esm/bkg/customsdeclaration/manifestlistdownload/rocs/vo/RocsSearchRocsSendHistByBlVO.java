...
*@FileName : RocsSearchRocsSendHistByBlVO.java
*@FileTitle : RocsSearchRocsSendHistByBlVO
*Open Issues :
*Change history :
...
public class RocsSearchRocsSendHistByBlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RocsSearchRocsSendHistByBlVO> models = new ArrayList<RocsSearchRocsSendHistByBlVO>();
	...
	public RocsSearchRocsSendHistByBlVO() {}

	public RocsSearchRocsSendHistByBlVO(String ibflag, String pagerows, String rtmEdiMsgTpCd, String msgSndDt, String blNo, String vvdNumber, String ofcCd, String creUsrId, String rowcnt, String polCd, String podCd, String hist, String podClptIndSeq) {
		this.podCd = podCd;
		this.ofcCd = ofcCd;
		this.polCd = polCd;
	 ...
	 * @param request
	 * @return RocsSearchRocsSendHistByBlVO[]
	 */
	public RocsSearchRocsSendHistByBlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RocsSearchRocsSendHistByBlVO[]
	 */
	public RocsSearchRocsSendHistByBlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RocsSearchRocsSendHistByBlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new RocsSearchRocsSendHistByBlVO();
				if (podCd[i] != null)
		...
		return getRocsSearchRocsSendHistByBlVOs();
	}
	 ...
	 * @return RocsSearchRocsSendHistByBlVO[]
	 */
	public RocsSearchRocsSendHistByBlVO[] getRocsSearchRocsSendHistByBlVOs(){
		RocsSearchRocsSendHistByBlVO[] vos = (RocsSearchRocsSendHistByBlVO[])models.toArray(new RocsSearchRocsSendHistByBlVO[models.size()]);
		return vos;
	}
