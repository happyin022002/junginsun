...
*@FileName : CndExpCustomsTransmissionDBDAOsearchLocalTimeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CndExpCustomsTransmissionDBDAOsearchLocalTimeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CndExpCustomsTransmissionDBDAOsearchLocalTimeRSQL(){
		setQuery();
		...
		query.append("FileName : CndExpCustomsTransmissionDBDAOsearchLocalTimeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
