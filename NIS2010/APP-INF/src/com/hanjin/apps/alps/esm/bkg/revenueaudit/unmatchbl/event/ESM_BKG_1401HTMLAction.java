...
*@FileName : ESM_BKG_1401HTMLAction.java
...
public class ESM_BKG_1401HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_1401HTMLAction 객체를 생성
	 */
	public ESM_BKG_1401HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsmBkg1401Event event = new EsmBkg1401Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setAwkwardBKGListForAuditVO((AwkwardBKGListForAuditVO)getVO(request, AwkwardBKGListForAuditVO.class));
		}
		
		if(command.isCommand(FormCommand.SEARCH02)) {
			event.setBKGvsBayPlanVO((BKGvsBayPlanVO)getVO(request, BKGvsBayPlanVO.class));
		}
//		else if(command.isCommand(FormCommand.MULTI01)) {
//			event.setAwkwardBKGListForAuditVOS((AwkwardBKGListForAuditVO[])getVOs(request, AwkwardBKGListForAuditVO.class, ""));
//		}
