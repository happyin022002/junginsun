...
*@FileName : ChargeCalculationDBDAOSearchDuplicateChargeDeletionOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchDuplicateChargeDeletionOfficeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchDuplicateChargeDeletionOfficeRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchDuplicateChargeDeletionOfficeRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchDuplicateChargeDeletionOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select  WM_CONCAT(distinct T2.CHG_DELT_OFC_CD)	as OFC_CD" ).append("\n"); 
