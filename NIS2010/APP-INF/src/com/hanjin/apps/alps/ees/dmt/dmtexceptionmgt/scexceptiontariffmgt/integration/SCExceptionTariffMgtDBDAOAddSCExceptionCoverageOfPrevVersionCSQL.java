...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionCoverageOfPrevVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionCoverageOfPrevVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 이전 버전의 모든 S/C Exception Tariff Multi Coverage 정보를 신규 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionCoverageOfPrevVersionCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionCoverageOfPrevVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
