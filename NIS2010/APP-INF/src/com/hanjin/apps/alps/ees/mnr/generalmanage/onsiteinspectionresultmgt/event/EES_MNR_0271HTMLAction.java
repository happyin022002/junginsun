...
*@FileName : EES_MNR_0271HTMLAction.java
...
public class EES_MNR_0271HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0271HTMLAction 객체를 생성
	 */
	public EES_MNR_0271HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EesMnr0271Event event = new EesMnr0271Event();
		FormCommand command = FormCommand.fromRequest(request);
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMnrOnSiteVO((MnrOnSiteVO)getVO(request, MnrOnSiteVO.class));
			event.setMnrOnSite2VO((MnrOnSite2VO)getVO(request, MnrOnSite2VO.class));
		}
