...
*@FileName : EES_DMT_2021HTMLAction.java
...
public class EES_DMT_2021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_2021HTMLAction 객체를 생성
	 */
	public EES_DMT_2021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesDmt2021Event event = new EesDmt2021Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setAfterBkgRqstAproStsParamVO((AfterBkgRqstAproStsParamVO)getVO(request, AfterBkgRqstAproStsParamVO.class));
		}
