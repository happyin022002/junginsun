...
*@FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList03RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchBasicTariffDetailList03RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchBasicTariffDetailList03RSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList03RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND     DMDT_TRF_CD = @[xVal01]" ).append("\n"); 
		...
		query.append("ORDER BY DMDT_CNTR_TP_CD" ).append("\n"); 
