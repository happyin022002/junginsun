...
public class MTYEquipmentForecastDBDAOsearcForecastAccuracyListByFactorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2013-01-21  CHM-201322369, Location 검색조건 추가, 신용찬 수석
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(GROUPING(A.LOC_CD),1,SUM(ABS(A.A5_QTY)),DECODE(GROUPING(A.YRWK),1,SUM(ABS(A.A5_QTY)),SUM(A.A5_QTY))) A5_QTY" ).append("\n"); 
		query.append("      ,DECODE(GROUPING(A.LOC_CD),1,SUM(ABS(A.DX_QTY)),DECODE(GROUPING(A.YRWK),1,SUM(ABS(A.DX_QTY)),SUM(A.DX_QTY))) DX_QTY" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("             ,SUM(DECODE(A.CNTR_TPSZ_CD,'A5',A.CNTR_QTY,0)) A5_QTY" ).append("\n"); 
		query.append("             ,SUM(DECODE(A.CNTR_TPSZ_CD,'DX',A.CNTR_QTY,0)) DX_QTY" ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("        SELECT  " ).append("\n"); 
		query.append("                A.BOUND" ).append("\n"); 
		...
		query.append("                         #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                              ,DECODE(C.DP_SEQ,1,'D2',2,'D4',3,'D5',4,'D7',5,'R2',6,'R5',7,'R9',8,'O2',9,'S2',10,'O4',11,'S4',12,'F2',13,'A2',14,'F4',15,'A4',16,'F5',17,'O5',18,'A5') CNTR_TPSZ_CD" ).append("\n"); 
		...
		query.append("                                                17,O5_FCAST_QTY," ).append("\n"); 
		query.append("                                                18,A5_FCAST_QTY," ).append("\n"); 
		query.append("                                                " ).append("\n"); 
		...
		query.append("                           ,(SELECT LEVEL DP_SEQ FROM DUAL CONNECT BY LEVEL <= 18) C " ).append("\n"); 
		...
		query.append("					#else" ).append("\n"); 
		query.append("                    WHERE  A.CNTR_TPSZ_CD IN('D2','D4','D5','D7','R2','R5','R9','O2','S2','O4','S4','F2','A2','F4','A4','F5','O5','A5','DX')" ).append("\n"); 
		query.append("					#end" ).append("\n"); 
		query.append("                    GROUP BY DECODE(A.MTY_BAL_TP_CD,'1','MG','OP'),A.YRWK,A.LOC_CD,A.CNTR_TPSZ_CD" ).append("\n"); 
		...
		query.append("					 					   #else" ).append("\n"); 
		query.append("										   AND  C.CNTR_TPSZ_CD IN('D2','D4','D5','D7','R2','R5','R9','O2','S2','O4','S4','F2','A2','F4','A4','F5','O5','A5','DX')" ).append("\n"); 
		query.append("										   #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("ORDER BY DECODE(A.BOUND,'OP',1,2), A.LOC_CD,A.DP_SEQ,A.YRWK" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append("		  ELSE " ).append("\n"); 
		query.append("		    ( CASE WHEN A.DP_SEQ||B.R9_QTY+C.R9_QTY = '40' THEN " ).append("\n"); 
		query.append("		          NULL" ).append("\n"); 
		query.append("		      ELSE " ).append("\n"); 
		query.append("		          DECODE(B.R9_QTY,0,100, (C.R9_QTY/B.R9_QTY)*100)" ).append("\n"); 
		query.append("		      END)" ).append("\n"); 
		...
		query.append("		  ELSE " ).append("\n"); 
		query.append("		    ( CASE WHEN A.DP_SEQ||B.O5_QTY+C.O5_QTY = '40' THEN " ).append("\n"); 
		query.append("		          NULL" ).append("\n"); 
		query.append("		      ELSE " ).append("\n"); 
		query.append("		          DECODE(B.O5_QTY,0,100, (C.O5_QTY/B.O5_QTY)*100)" ).append("\n"); 
		query.append("		      END)" ).append("\n"); 
		...
		query.append("		  ELSE " ).append("\n"); 
		query.append("		    ( CASE WHEN A.DP_SEQ||B.A5_QTY+C.A5_QTY = '40' THEN " ).append("\n"); 
		query.append("		          NULL" ).append("\n"); 
		query.append("		      ELSE " ).append("\n"); 
		query.append("		          DECODE(B.A5_QTY,0,100, (C.A5_QTY/B.A5_QTY)*100)" ).append("\n"); 
		query.append("		      END)" ).append("\n"); 
		query.append("		  END) AS A5_QTY" ).append("\n"); 
		query.append("	   ,(CASE WHEN A.DP_SEQ <> '4' THEN " ).append("\n"); 
		query.append("		       A.DX_QTY" ).append("\n"); 
		query.append("		  ELSE " ).append("\n"); 
		query.append("		    ( CASE WHEN A.DP_SEQ||B.DX_QTY+C.DX_QTY = '40' THEN " ).append("\n"); 
		query.append("		          NULL" ).append("\n"); 
		query.append("		      ELSE " ).append("\n"); 
		query.append("		          DECODE(B.DX_QTY,0,100, (C.DX_QTY/B.DX_QTY)*100)" ).append("\n"); 
		query.append("		      END)" ).append("\n"); 
		query.append("		  END) AS DX_QTY" ).append("\n"); 
		...
		query.append("ORDER BY DECODE(A.BOUND,'OP',1,2),LOC_CD,DP_SEQ,YRWK" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("       A.BOUND" ).append("\n"); 
		...
		query.append("       ,DECODE(A.DP_SEQ,4,DECODE(B.R9_QTY,NULL,'',LTRIM(TO_CHAR(ROUND(B.R9_QTY,1),'9,999,990.9'))||'%'),5,LTRIM(TO_CHAR(EQR_FCAST_EVAL_FNC(ABS(ROUND(B.R9_QTY,1))))),LTRIM(TO_CHAR(ROUND(A.R9_QTY,1),'999,999,999,999'))) R9_QTY" ).append("\n"); 
		...
		query.append("       ,DECODE(A.DP_SEQ,4,DECODE(B.O5_QTY,NULL,'',LTRIM(TO_CHAR(ROUND(B.O5_QTY,1),'9,999,990.9'))||'%'),5,LTRIM(TO_CHAR(EQR_FCAST_EVAL_FNC(ABS(ROUND(B.O5_QTY,1))))),LTRIM(TO_CHAR(ROUND(A.O5_QTY,1),'999,999,999,999'))) O5_QTY" ).append("\n"); 
		query.append("       ,DECODE(A.DP_SEQ,4,DECODE(B.A5_QTY,NULL,'',LTRIM(TO_CHAR(ROUND(B.A5_QTY,1),'9,999,990.9'))||'%'),5,LTRIM(TO_CHAR(EQR_FCAST_EVAL_FNC(ABS(ROUND(B.A5_QTY,1))))),LTRIM(TO_CHAR(ROUND(A.A5_QTY,1),'999,999,999,999'))) A5_QTY" ).append("\n"); 
		query.append("       ,DECODE(A.DP_SEQ,4,DECODE(B.DX_QTY,NULL,'',LTRIM(TO_CHAR(ROUND(B.DX_QTY,1),'9,999,990.9'))||'%'),5,LTRIM(TO_CHAR(EQR_FCAST_EVAL_FNC(ABS(ROUND(B.DX_QTY,1))))),LTRIM(TO_CHAR(ROUND(A.DX_QTY,1),'999,999,999,999'))) DX_QTY" ).append("\n"); 
		...
		query.append("  #end" ).append("\n"); 
		query.append("  #if (${loc_tp_cd} == 'L' && ${loc_cd} =='CNHKG' )" ).append("\n"); 
		query.append("   AND A.LOC_CD <> 'ZZZZ9'" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
