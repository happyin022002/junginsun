...
*@FileName : EES_MNR_0097HTMLAction.java
...
public class EES_MNR_0097HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0096HTMLAction 객체를 생성
	 */
	public EES_MNR_0097HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0097Event event = new EesMnr0097Event();
