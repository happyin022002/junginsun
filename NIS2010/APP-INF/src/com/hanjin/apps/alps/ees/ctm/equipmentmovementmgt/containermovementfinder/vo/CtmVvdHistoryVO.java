...
*@FileName : CtmVvdHistoryVO.java
*@FileTitle : CtmVvdHistoryVO
*Open Issues :
*Change history :
...
public class CtmVvdHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CtmVvdHistoryVO> models = new ArrayList<CtmVvdHistoryVO>();
	...
	public CtmVvdHistoryVO() {}

	public CtmVvdHistoryVO(String ibflag, String pagerows, String cntrNo, String cnmvCycNo, String vvdCd, String porCd, String podCd, String polCd, String delCd, String bkgNo, String blNo, String repCmdtNm, String pCntrno, String checkDigit, String pDate1, String pDate2) {
		this.porCd = porCd;
	 ...
	 * @param request
	 * @return CtmVvdHistoryVO[]
	 */
	public CtmVvdHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CtmVvdHistoryVO[]
	 */
	public CtmVvdHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CtmVvdHistoryVO model = null;
	 ...
	 * @return CtmVvdHistoryVO[]
	 */
	public CtmVvdHistoryVO[] getCtmVvdHistoryVOs(){
		CtmVvdHistoryVO[] vos = (CtmVvdHistoryVO[])models.toArray(new CtmVvdHistoryVO[models.size()]);
		return vos;
	}
