...
/**
 * ees_mnr_S304 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - EES_MNR_S304HTMLAction 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author 김완규
 * @see EES_MNR_S304HTMLAction 참조
 * @since J2EE 1.6
 */    
 
public class EesMnrS304Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	public EesMnrS304Event(){}     
