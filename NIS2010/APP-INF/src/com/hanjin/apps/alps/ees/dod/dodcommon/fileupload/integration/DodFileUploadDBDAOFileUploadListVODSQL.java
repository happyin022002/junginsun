...
*@FileName : DodFileUploadDBDAOFileUploadListVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodFileUploadDBDAOFileUploadListVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodFileUploadDBDAOFileUploadListVODSQL(){
		setQuery();
		...
		query.append("FileName : DodFileUploadDBDAOFileUploadListVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DOD_ATCH_FILE" ).append("\n"); 
