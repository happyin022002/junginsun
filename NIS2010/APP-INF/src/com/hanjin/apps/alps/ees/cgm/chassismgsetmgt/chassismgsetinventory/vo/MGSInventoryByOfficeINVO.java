...
*@FileName : MGSInventoryByOfficeINVO.java
*@FileTitle : MGSInventoryByOfficeINVO
*Open Issues :
*Change history :
...
public class MGSInventoryByOfficeINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSInventoryByOfficeINVO> models = new ArrayList<MGSInventoryByOfficeINVO>();
	...
	public MGSInventoryByOfficeINVO() {}

	public MGSInventoryByOfficeINVO(String ibflag, String pagerows, String eqKndCd, String inqFmDys, String inqToDys, String crntOfcCd, String stsEvntOfcCd, String eqTpszCdTotal, String eqTpszCdUmg, String eqTpszCdClg) {
	 ...
	 */
	public MGSInventoryByOfficeINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSInventoryByOfficeINVO[]
	 */
	public MGSInventoryByOfficeINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSInventoryByOfficeINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSInventoryByOfficeINVO();
		...
		return getMGSInventoryByOfficeINVOs();
	}
	...
	public MGSInventoryByOfficeINVO[] getMGSInventoryByOfficeINVOs(){
		MGSInventoryByOfficeINVO[] vos = (MGSInventoryByOfficeINVO[])models.toArray(new MGSInventoryByOfficeINVO[models.size()]);
		return vos;
	}
