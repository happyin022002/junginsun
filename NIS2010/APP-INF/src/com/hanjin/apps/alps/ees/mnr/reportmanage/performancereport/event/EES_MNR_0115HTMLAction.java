...
*@FileName : EES_MNR_0115HTMLAction.java
...
public class EES_MNR_0115HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0115HTMLAction 객체를 생성
	 */
	public EES_MNR_0115HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0115Event event = new EesMnr0115Event();
		
		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRepairExpensePFMCINVO((RepairExpensePFMCINVO)getVO(request, RepairExpensePFMCINVO .class));
		}	
