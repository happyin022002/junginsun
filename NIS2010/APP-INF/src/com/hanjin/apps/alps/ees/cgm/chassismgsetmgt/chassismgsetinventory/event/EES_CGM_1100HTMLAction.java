...
*@FileName : EES_CGM_1100HTMLAction.java
...
public class EES_CGM_1100HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1100HTMLAction 객체를 생성
	 */
	public EES_CGM_1100HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1100Event event = new EesCgm1100Event();
		
		CHSInventoryByOnhireYearINVO cHSInventoryByOnhireYearINVO = new CHSInventoryByOnhireYearINVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			cHSInventoryByOnhireYearINVO = (CHSInventoryByOnhireYearINVO)getVO(request, CHSInventoryByOnhireYearINVO .class);
			event.setCHSInventoryByOnhireYearINVO(cHSInventoryByOnhireYearINVO);
		}
		return  event;
	}
