...
public class DemandNotePreviewParmVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String rdVarNmFlg = null;
    ...
    public DemandNotePreviewParmVO(String ibflag, String pagerows, String sessionUsrId, String sessionOfcCd, String callToRdTp, String dmdtTrfCd, String dmdtChgStsCd, String bkgNo, String payerCd, String ofcCd, String idaTaxApplTm, String usrCntCd, String condIdaSacCd, String rdVarNmFlg) {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("rd_var_nm_flg", getRdVarNmFlg());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("rd_var_nm_flg", "rdVarNmFlg");
    ...
    public void setRdVarNmFlg(String rdVarNmFlg) {
        this.rdVarNmFlg = rdVarNmFlg;
    }

    public String getRdVarNmFlg() {
        return this.rdVarNmFlg;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setCondIdaSacCd(JSPUtil.getParameter(request, "cond_ida_sac_cd", ""));
        setRdVarNmFlg(JSPUtil.getParameter(request, "rd_var_nm_flg", ""));
    }
    ...
    public DemandNotePreviewParmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] rdVarNmFlg = (JSPUtil.getParameter(request, prefix + "rd_var_nm_flg", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (rdVarNmFlg[i] != null) 
		    		model.setRdVarNmFlg(rdVarNmFlg[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.rdVarNmFlg = this.rdVarNmFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
