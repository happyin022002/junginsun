...
*@FileName 		: EES_CGM_1220HTMLAction.java
...
public class EES_CGM_1220HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1220HTMLAction 객체를 생성
	 */
	public EES_CGM_1220HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1220Event event = new EesCgm1220Event();

		event.setCHSScExceptionINVO((CHSScExceptionINVO)getVO(request, CHSScExceptionINVO.class));
