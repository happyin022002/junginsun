...
public class CgmChssPoolINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CgmChssPoolINVO> models = new ArrayList<CgmChssPoolINVO>();
	...
	public CgmChssPoolINVO() {}

	public CgmChssPoolINVO(String ibflag, String pagerows, String chssPoolCd, String chssPoolNm, String poolMgmtCoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
	...
	public CgmChssPoolINVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public CgmChssPoolINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CgmChssPoolINVO model = null;
	...
	public CgmChssPoolINVO[] getCgmChssPoolVOs(){
		CgmChssPoolINVO[] vos = (CgmChssPoolINVO[])models.toArray(new CgmChssPoolINVO[models.size()]);
		return vos;
	}
