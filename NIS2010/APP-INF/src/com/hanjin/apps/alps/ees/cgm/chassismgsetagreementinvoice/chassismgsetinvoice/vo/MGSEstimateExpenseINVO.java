...
*@FileName : MGSEstimateExpenseINVO.java
*@FileTitle : MGSEstimateExpenseINVO
*Open Issues :
*Change history :
...
public class MGSEstimateExpenseINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSEstimateExpenseINVO> models = new ArrayList<MGSEstimateExpenseINVO>();
...
/**
	 ...
	 */
	public MGSEstimateExpenseINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSEstimateExpenseINVO[]
	 */
	public MGSEstimateExpenseINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSEstimateExpenseINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSEstimateExpenseINVO();
				if (vslCd[i] != null)
		...
		return getMGSEstimateExpenseINVOs();
	}
	...
	public MGSEstimateExpenseINVO[] getMGSEstimateExpenseINVOs(){
		MGSEstimateExpenseINVO[] vos = (MGSEstimateExpenseINVO[])models.toArray(new MGSEstimateExpenseINVO[models.size()]);
		return vos;
	}
