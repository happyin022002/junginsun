...
*@FileName : LeasePlanDBDAOLongTermCNTRDeliveryPlanAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LeasePlanDBDAOLongTermCNTRDeliveryPlanAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LeasePlanDBDAOLongTermCNTRDeliveryPlanAllDSQL(){
		setQuery();
		...
		query.append("FileName : LeasePlanDBDAOLongTermCNTRDeliveryPlanAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
