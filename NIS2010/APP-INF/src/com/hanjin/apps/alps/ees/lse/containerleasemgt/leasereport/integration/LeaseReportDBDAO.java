...
* 1.0 Creation
* =======================================================
* 2010.10.14 남궁진호 [CHM-201006506-01] Report Type 쿼리 통합수정
* 			 searchOffHireResultvsDOLSummaryData
...
/**
  ...
  public ReportSearchVO searchOnHireResultbyLocationAgreementSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
...
//      list = (List)RowSetUtil.rowSetToVOs(dbRowset, ReportSearchVO.class);
      rsVo.setTysz(reportSearchVO.getTysz());
...
public List<ReportSearchVO> searchOnHireResultbyLocationAgreementDetailData(ReportSearchVO reportSearchVO) throws DAOException {
  ...
  try{
    ...
    if(reportSearchVO != null){
        ...
        param.put("term_change"       , reportSearchVO.getTermChange());
        param.put("dii"               , reportSearchVO.getDii());
        param.put("cntr_no"           , reportSearchVO.getCntrno());
        ...
        velParam.put("term_change"      , reportSearchVO.getTermChange());
        velParam.put("dii"              , reportSearchVO.getDii());
        velParam.put("cntr_no"           , reportSearchVO.getCntrno());
    }
   ...
   */
   @SuppressWarnings("unchecked")
  public ReportSearchVO searchOffHireResultbyLocationAgreementSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
    DBRowSet dbRowset = null;
    ReportSearchVO rsVo = new ReportSearchVO();
   ...
   */
   @SuppressWarnings("unchecked")
  public List<ReportSearchVO> searchOffHireResultbyLocationAgreementDetailData(ReportSearchVO reportSearchVO) throws DAOException {
	int currentPage = reportSearchVO.getIPage();
  	int startNo = PAGE_SIZE_1000 * (currentPage -1) +1;
  	int endNo   = PAGE_SIZE_1000 *  currentPage;
    DBRowSet dbRowset = null;
   ...
   */
   @SuppressWarnings("unchecked")
  public List<UsingDayDetailVO> searchOffHireResultAvgUsingDayDetailData(SearchParamVO searchParamVO) throws DAOException {
     ...
     */
       @SuppressWarnings("unchecked")
    public ReportSearchVO searchOnHireResultbyTermLessorSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
      DBRowSet dbRowset = null;
      ReportSearchVO rsVo = new ReportSearchVO();
   ...
   public int searchOnHireResultbyTermLessorCountData(ReportSearchVO reportSearchVO) throws DAOException {
    ...
    public List<ReportSearchVO> searchOnHireResultbyTermLessorDetailData(ReportSearchVO reportSearchVO) throws DAOException {
       ...
       */
         @SuppressWarnings("unchecked")
      public ReportSearchVO searchOffHireResultByTermLessorSummaryData (ReportSearchVO reportSearchVO) throws DAOException {
        DBRowSet dbRowset = null;
        ReportSearchVO rsVo = new ReportSearchVO();
     ...
     public int searchOffHireResultByTermLessorCountData (ReportSearchVO reportSearchVO) throws DAOException {
       ...
       */
       @SuppressWarnings("unchecked")
      public List<ReportSearchVO> searchOffHireResultByTermLessorDetailData (ReportSearchVO reportSearchVO) throws DAOException {
    	 int currentPage = reportSearchVO.getIPage();
      	 int startNo = PAGE_SIZE_1000 * (currentPage -1) +1;
      	 int endNo   = PAGE_SIZE_1000 *  currentPage;
         DBRowSet dbRowset = null;
       ...
       */
       @SuppressWarnings("unchecked")
       public ReportSearchVO searchOffHireResultvsDOLSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
         DBRowSet dbRowset = null;
         ReportSearchVO rsVo = new ReportSearchVO();
         ...
         try{
           ...
           if(reportSearchVO != null){
               ...
               arrAgmtSeq = JSPUtil.convertStringToArrayList(JSPUtil.replace(reportSearchVO.getAgmtSeq(),",","|"));
               ...
               param.put("agmt_seq_str"        , arrAgmtSeq);
               ...
               velParam.put("agmt_seq_str"            , arrAgmtSeq);
...
*/
        ...
        */
        @SuppressWarnings("unchecked")
       public List<ReportSearchVO> searchOffHireResultvsDOLDetailData(ReportSearchVO reportSearchVO) throws DAOException {
    ...
    public List<InventorySummaryVO> searchTotalContainerInventorySummaryListData(SearchParamVO searchParamVO) throws DAOException {
     ...
     /**
      * HJS의 관리하는 자가 및 임차장비의 상세 전체건수를 조회합니다.<br>
      *
      * @param  SearchParamVO searchParamVO
      * @return int
      * @throws DAOException
	 ...
	 */
    @SuppressWarnings("unchecked")
    public List<SubLeaseOutSummaryVO> searchSubLeaseOutContainerSummaryListData(SearchParamVO searchParamVO) throws DAOException {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<SubLeaseOutDetailVO> searchSubLeaseOutContainerDetailData(SearchParamVO searchParamVO) throws DAOException {
    	int currentPage = searchParamVO.getIPage();
   	    int startNo = PAGE_SIZE_1000 * (currentPage -1) +1;
   	    int endNo   = PAGE_SIZE_1000 *  currentPage;
     ...
     */
     @SuppressWarnings("unchecked")
     public ReportSearchVO searchOnHireReportbyRccSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
       DBRowSet dbRowset = null;
       ReportSearchVO rsVo = new ReportSearchVO();
       //query parameter
       Map<String, Object> param = new HashMap<String, Object>();
      ...
      */
      @SuppressWarnings("unchecked")
      public ReportSearchVO searchOnHireReportbyMonthSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
        DBRowSet dbRowset = null;
        ReportSearchVO rsVo = new ReportSearchVO();
        //query parameter
        Map<String, Object> param = new HashMap<String, Object>();
       ...
       */
       @SuppressWarnings("unchecked")
       public ReportSearchVO searchOffHireReportbyRccSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
         DBRowSet dbRowset = null;
         ReportSearchVO rsVo = new ReportSearchVO();
         //query parameter
         Map<String, Object> param = new HashMap<String, Object>();
        ...
        */
        @SuppressWarnings("unchecked")
        public ReportSearchVO searchOffHireReportbyMonthSummaryData(ReportSearchVO reportSearchVO) throws DAOException {
          DBRowSet dbRowset = null;
          ReportSearchVO rsVo = new ReportSearchVO();
          //query parameter
          Map<String, Object> param = new HashMap<String, Object>();
