...
*@FileName : CHSConfirmPayableAmountINVO.java
*@FileTitle : CHSConfirmPayableAmountINVO
*Open Issues :
*Change history :
...
public class CHSConfirmPayableAmountINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSConfirmPayableAmountINVO> models = new ArrayList<CHSConfirmPayableAmountINVO>();
	...
	/* Column Info */
	private String parentCostYrmonSeq = null;	// grid의 cost_yrmon_seq 와 중복을 피하기 위함
	/* Column Info */
...
/**
	 ...
	 */
	public CHSConfirmPayableAmountINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSConfirmPayableAmountINVO[]
	 */
	public CHSConfirmPayableAmountINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSConfirmPayableAmountINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSConfirmPayableAmountINVO();
		...
		return getCHSConfirmPayableAmountINVOs();
	}
	...
	public CHSConfirmPayableAmountINVO[] getCHSConfirmPayableAmountINVOs(){
		CHSConfirmPayableAmountINVO[] vos = (CHSConfirmPayableAmountINVO[])models.toArray(new CHSConfirmPayableAmountINVO[models.size()]);
		return vos;
	}
