...
*@FileName : OnewaySimulateDBDAOSearchDailyCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnewaySimulateDBDAOSearchDailyCountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OnewaySimulateDBDAOSearchDailyCountRSQL(){
		setQuery();
		...
		query.append("FileName : OnewaySimulateDBDAOSearchDailyCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("count(fcast_dt) FCAST_COUNT" ).append("\n"); 
