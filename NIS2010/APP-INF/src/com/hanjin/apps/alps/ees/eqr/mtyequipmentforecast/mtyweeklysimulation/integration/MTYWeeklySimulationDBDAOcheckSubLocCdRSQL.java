...
*@FileName : MTYWeeklySimulationDBDAOcheckSubLocCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYWeeklySimulationDBDAOcheckSubLocCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYWeeklySimulationDBDAOcheckSubLocCdRSQL(){
		setQuery();
		...
		query.append("FileName : MTYWeeklySimulationDBDAOcheckSubLocCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	#if(${loc_type_code} == 'RE')  -- RCC(by ECC) 일때 조건" ).append("\n"); 
