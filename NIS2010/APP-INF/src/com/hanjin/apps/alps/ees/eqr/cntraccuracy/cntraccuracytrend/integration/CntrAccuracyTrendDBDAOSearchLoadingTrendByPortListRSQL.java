...
*@FileName : CntrAccuracyTrendDBDAOSearchLoadingTrendByPortListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrAccuracyTrendDBDAOSearchLoadingTrendByPortListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Loading Trend By Port 조회
	  * - 2014-01-15 , AFRICA PORT 를 EUROPE 으로 병합, 신용찬
	  * - 2014-02-03, SKIP PORT 제거, MT LOADING PORT IND SEQ 조건 추가, 신용찬
	  * - 2014-04-28, MTY, FULL BKG 데이터 추출 수정, 신용찬
	  * </pre>
	  */
	public CntrAccuracyTrendDBDAOSearchLoadingTrendByPortListRSQL(){
		setQuery();
		...
		query.append("FileName : CntrAccuracyTrendDBDAOSearchLoadingTrendByPortListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    --AND   (SELECT X.CONTI_CD FROM MDM_LOCATION X WHERE X.LOC_CD = A.LST_LODG_PORT_CD) = E.CONTI_CD  -- MAS MON VVD의 LAST CALLING LOADING PORT 의 대륙의 PORT만 조회(LOADING만 조회)" ).append("\n"); 
		query.append("    -- 수정후 (2014-01-15, AFRICA PORT 를 EUROPE 으로 병합, 신용찬)" ).append("\n"); 
		query.append("    AND   (SELECT DECODE(X.CONTI_CD, 'F', 'E', X.CONTI_CD) FROM MDM_LOCATION X WHERE X.LOC_CD = A.LST_LODG_PORT_CD) = DECODE(E.CONTI_CD, 'F', 'E', E.CONTI_CD)  -- MAS MON VVD의 LAST CALLING LOADING PORT 의 대륙의 PORT만 조회(LOADING만 조회)" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("-- TRADE, LANE 없는 VVD 만을 위한 조회" ).append("\n"); 
		query.append(",DUMMY_HEAD_ONLYVVD AS" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("    SELECT DISTINCT            " ).append("\n"); 
		query.append("           A.VSL_CD||A.SKD_VOY_NO||A.DIR_CD VVD " ).append("\n"); 
		query.append("          ,A.VSL_CD" ).append("\n"); 
		...
		query.append("        --AND   B.MTY_PLN_SHW_FLG = 'Y' (조건제거, 2013-10-16, 정길수)" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		...
		query.append("          --,1 CLPT_IND_SEQ " ).append("\n"); 
		query.append("          ,POL_CLPT_IND_SEQ CLPT_IND_SEQ  -- 2014-02-03 로직변경, 신용찬     " ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("    (" ).append("\n"); 
		query.append("        SELECT A.VSL_CD" ).append("\n"); 
		query.append("              ,A.SKD_VOY_NO" ).append("\n"); 
		query.append("              ,A.SKD_DIR_CD" ).append("\n"); 
		query.append("              ,A.SLAN_CD VSL_LANE_CD -- 2014-02-03 로직변경, 신용찬  " ).append("\n"); 
		query.append("              ,A.POL_YD_CD" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(TPSZ_CD, 'A2', CNTR_QTY)), 0) QTY_A2" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(TPSZ_CD, 'A4', CNTR_QTY)), 0) QTY_A4" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(TPSZ_CD, 'A5', CNTR_QTY)), 0) QTY_A5" ).append("\n"); 
		query.append("          --,1 CLPT_IND_SEQ " ).append("\n"); 
		query.append("          ,POL_CLPT_IND_SEQ CLPT_IND_SEQ  -- 2014-02-03 로직변경, 신용찬         " ).append("\n"); 
		query.append("                                           " ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("    (" ).append("\n"); 
		query.append("/* --2014.04.28 MODIFIED BY YONGCHAN SHIN" ).append("\n"); 
		query.append("        SELECT A.VSL_CD" ).append("\n"); 
		query.append("              ,A.SKD_VOY_NO" ).append("\n"); 
		query.append("              ,A.SKD_DIR_CD" ).append("\n"); 
		...
		query.append("            ,MDM_CNTR_TP_SZ C" ).append("\n"); 
		query.append("            ,BKG_BOOKING D" ).append("\n"); 
		query.append("            ,DUMMY_HEAD_ONLYVVD Z" ).append("\n"); 
		query.append("        WHERE A.VSL_CD          = Z.VSL_CD" ).append("\n"); 
		query.append("        AND   A.SKD_VOY_NO      = Z.SKD_VOY_NO" ).append("\n"); 
		query.append("        AND   A.SKD_DIR_CD      = Z.DIR_CD" ).append("\n"); 
		query.append("        AND   A.POL_YD_CD       = Z.YD_CD        " ).append("\n"); 
		query.append("        AND   A.POL_CLPT_IND_SEQ= Z.CLPT_IND_SEQ" ).append("\n"); 
		query.append("        AND   A.VSL_PRE_PST_CD  = 'T' --TRUNK" ).append("\n"); 
		query.append("        AND   A.VSL_CD          = D.VSL_CD" ).append("\n"); 
		query.append("        AND   A.SKD_VOY_NO      = D.SKD_VOY_NO" ).append("\n"); 
		query.append("        AND   A.SKD_DIR_CD      = D.SKD_DIR_CD" ).append("\n"); 
		query.append("        AND   A.POL_YD_CD       = D.POL_NOD_CD " ).append("\n"); 
		query.append("        AND   A.BKG_NO          = D.BKG_NO" ).append("\n"); 
		query.append("        AND   D.BKG_CGO_TP_CD   = 'P'  --EMPTY        " ).append("\n"); 
		query.append("        AND   A.BKG_NO          = B.BKG_NO" ).append("\n"); 
		query.append("        AND   B.CNTR_TPSZ_CD    = C.CNTR_TPSZ_CD     " ).append("\n"); 
		query.append("    )" ).append("\n"); 
		query.append("    " ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'L', DECODE(B.CNTR_TPSZ_CD, 'A2', B.CNTR_QTY))),0) F_L_A2" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'L', DECODE(B.CNTR_TPSZ_CD, 'A4', B.CNTR_QTY))),0) F_L_A4" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'L', DECODE(B.CNTR_TPSZ_CD, 'A5', B.CNTR_QTY))),0) F_L_A5" ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'D', B.CNTR_QTY)),0) F_D_BOX      " ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'D', DECODE(B.CNTR_TPSZ_CD, 'D2', B.CNTR_QTY))),0) F_D_D2" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'D', DECODE(B.CNTR_TPSZ_CD, 'D4', B.CNTR_QTY))),0) F_D_D4" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'D', DECODE(B.CNTR_TPSZ_CD, 'A2', B.CNTR_QTY))),0) F_D_A2" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'D', DECODE(B.CNTR_TPSZ_CD, 'A4', B.CNTR_QTY))),0) F_D_A4" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'D', DECODE(B.CNTR_TPSZ_CD, 'A5', B.CNTR_QTY))),0) F_D_A5" ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'O', B.CNTR_QTY)),0) F_O_BOX      " ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'O', DECODE(B.CNTR_TPSZ_CD, 'D2', B.CNTR_QTY))),0) F_O_D2" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'O', DECODE(B.CNTR_TPSZ_CD, 'D4', B.CNTR_QTY))),0) F_O_D4" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'O', DECODE(B.CNTR_TPSZ_CD, 'A2', B.CNTR_QTY))),0) F_O_A2" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'O', DECODE(B.CNTR_TPSZ_CD, 'A4', B.CNTR_QTY))),0) F_O_A4" ).append("\n"); 
		query.append("          ,NVL(SUM(DECODE(B.MTY_FULL_BKG_BX_DIV_CD, 'O', DECODE(B.CNTR_TPSZ_CD, 'A5', B.CNTR_QTY))),0) F_O_A5" ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("    FROM EQR_CTRL_FULL_LOD_SNAP A" ).append("\n"); 
		query.append("        ,EQR_CTRL_FULL_LOD_SNAP_DTL B" ).append("\n"); 
		query.append("        ,DUMMY_HEAD_ONLYVVD X" ).append("\n"); 
		query.append("    WHERE A.VSL_CD     = B.VSL_CD" ).append("\n"); 
		query.append("    AND   A.SKD_VOY_NO = B.SKD_VOY_NO" ).append("\n"); 
		query.append("    AND   A.SKD_DIR_CD = B.SKD_DIR_CD" ).append("\n"); 
		query.append("    AND   A.POL_YD_CD  = B.POL_YD_CD   " ).append("\n"); 
		...
		query.append("    AND   B.SKD_DIR_CD = X.DIR_CD" ).append("\n"); 
		query.append("    AND   B.POL_YD_CD  = X.YD_CD  " ).append("\n"); 
		query.append("    AND   B.CLPT_SEQ   = X.CLPT_SEQ     " ).append("\n"); 
		query.append("    GROUP BY A.VSL_CD" ).append("\n"); 
		query.append("          ,A.SKD_VOY_NO" ).append("\n"); 
		query.append("          ,A.SKD_DIR_CD" ).append("\n"); 
		query.append("          ,A.POL_YD_CD  " ).append("\n"); 
		...
		query.append("    FROM MAS_LANE_RGST    B" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT E.LCC_CD" ).append("\n"); 
		...
		query.append("      ,NVL(B.QTY_A5,0)  P_A5" ).append("\n"); 
		...
		query.append("      ,NVL(C.QTY_A5,0)  M_A5" ).append("\n"); 
		...
		query.append("      ,NVL(D.F_L_A5,0) F_L_A5" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("      ,NVL(D.F_D_A5,0) F_D_A5" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("    ,(" ).append("\n"); 
		query.append("        SELECT A.ECC_CD, A.LCC_CD, A.SCC_CD, B.LOC_CD, C.YD_CD " ).append("\n"); 
		query.append("        FROM MDM_EQ_ORZ_CHT A" ).append("\n"); 
		query.append("            ,MDM_LOCATION B" ).append("\n"); 
		query.append("            ,MDM_YARD     C" ).append("\n"); 
		query.append("        WHERE A.SCC_CD = B.SCC_CD" ).append("\n"); 
		query.append("        AND   B.LOC_CD = C.LOC_CD" ).append("\n"); 
		query.append("--        AND   C.YD_CD  = 'NLRTMYW'     " ).append("\n"); 
		...
		query.append("AND   A.YD_CD      = E.YD_CD(+)  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("-- AVERAGE 쿼리 ---------------------------------------" ).append("\n"); 
		...
		query.append("          ,ROUND(AVG(P_A5     ))  P_A5  " ).append("\n"); 
		...
		query.append("          ,ROUND(AVG(M_A5     ))  M_A5     " ).append("\n"); 
		...
		query.append("          ,ROUND(AVG(DF_A5_A  ))  DF_A5_A  " ).append("\n"); 
		...
		query.append("          ,ROUND(AVG(F_L_A5   ))  F_L_A5   " ).append("\n"); 
		...
		query.append("          ,ROUND(AVG(F_D_A5   ))  F_D_A5 " ).append("\n"); 
		...
		query.append("      ,YD_CD" ).append("\n"); 
		query.append("      ,WEEK" ).append("\n"); 
		query.append("      ,'ZZZTTL' SLAN_CD" ).append("\n"); 
		query.append("      ,'' VVD" ).append("\n"); 
		query.append("      ,'' VPS_ETA_DT" ).append("\n"); 
		query.append("      ,'' VPS_ETD_DT" ).append("\n"); 
		query.append("      ,'' FCBF_DT" ).append("\n"); 
		...
		query.append("      ,SUM(F_L_A5   )" ).append("\n"); 
		...
		query.append("      ,SUM(F_D_A5   )" ).append("\n"); 
		...
		query.append("      ,WEEK" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("-- AVERAGE : LCC, ECC, WEEK, SLAN_CD 의 AVG 를 LCC, ECC, SLAN_CD 으로 AVG" ).append("\n"); 
		query.append("UNION ALL      " ).append("\n"); 
		query.append("SELECT LCC_CD" ).append("\n"); 
		query.append("      ,ECC_CD" ).append("\n"); 
		query.append("      ,'XXXXXXX' YD_CD" ).append("\n"); 
		...
		query.append("      ,ROUND(AVG(P_A5     ))" ).append("\n"); 
		...
		query.append("      ,ROUND(AVG(M_A5     ))" ).append("\n"); 
		...
		query.append("      ,ROUND(AVG(DF_A5_A  ))" ).append("\n"); 
		...
		query.append("      ,ROUND(AVG(F_L_A5   ))" ).append("\n"); 
		...
		query.append("      ,ROUND(AVG(F_D_A5   ))" ).append("\n"); 
		...
		query.append("      ,SUM(P_A5     )  P_A5   " ).append("\n"); 
		...
		query.append("      ,SUM(M_A5     )  M_A5   " ).append("\n"); 
		...
		query.append("      ,SUM(DF_A5_A  )  DF_A5_A  " ).append("\n"); 
		...
		query.append("      ,SUM(F_L_A5   )  F_L_A5   " ).append("\n"); 
		...
		query.append("      ,SUM(F_D_A5   )  F_D_A5 " ).append("\n"); 
		...
		query.append("UNION ALL      " ).append("\n"); 
		query.append("SELECT 'ZZZTTL' LCC_CD" ).append("\n"); 
		query.append("      ,'' ECC_CD" ).append("\n"); 
		query.append("      ,'' YD_CD" ).append("\n"); 
		query.append("      ,'' WEEK" ).append("\n"); 
		query.append("      ,SLAN_CD" ).append("\n"); 
