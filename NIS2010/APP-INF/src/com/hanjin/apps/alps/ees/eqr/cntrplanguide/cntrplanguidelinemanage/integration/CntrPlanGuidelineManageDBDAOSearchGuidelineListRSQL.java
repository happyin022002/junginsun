...
public class CntrPlanGuidelineManageDBDAOSearchGuidelineListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * - modified lane search condition 
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(M.A5_QTY,0,'',M.A5_QTY) A5_QTY" ).append("\n"); 
		query.append("	  ,M.A5_UT" ).append("\n"); 
		...
		query.append("       ,CASE WHEN M.ORG_EQ_GLINE_SEQ IS NULL THEN 'O'" ).append("\n"); 
		query.append("	        WHEN NVL(M.A5_QTY,0) <> NVL(M.OLD_A5_QTY,0) THEN 'D'" ).append("\n"); 
		query.append("	        WHEN NVL(M.A5_QTY,0) =  NVL(M.OLD_A5_QTY,0) THEN 'S'" ).append("\n"); 
		query.append("	   END AS OLD_A5_QTY" ).append("\n"); 
		query.append("	  ,CASE WHEN M.ORG_EQ_GLINE_SEQ IS NULL THEN 'O'" ).append("\n"); 
		query.append("	        WHEN NVL(M.A5_UT,' ') <> NVL(M.OLD_A5_UT,' ') THEN 'D'" ).append("\n"); 
		query.append("	        WHEN NVL(M.A5_UT,' ') =  NVL(M.OLD_A5_UT,' ') THEN 'S'" ).append("\n"); 
		query.append("	   END AS OLD_A5_UT" ).append("\n"); 
		query.append("      ,CASE WHEN M.ORG_EQ_GLINE_SEQ IS NULL THEN 'O'" ).append("\n"); 
		...
		query.append("              ,TO_CHAR(SUM(DECODE(A.CNTR_TPSZ_CD,'A5',A.PRIO_SEQ,''))) A5_UT" ).append("\n"); 
		...
		query.append("              ,'' OLD_A5_QTY" ).append("\n"); 
		query.append("              ,TO_CHAR(SUM(DECODE(A.CNTR_TPSZ_CD,'A5',A.OLD_PRIO_SEQ,''))) OLD_A5_UT" ).append("\n"); 
		...
		query.append("              ,TO_CHAR(SUM(DECODE(A.CNTR_TPSZ_CD,'A5',A.EQ_GLINE_VAL,''))) A5_QTY" ).append("\n"); 
		query.append("              ,MAX(DECODE(A.CNTR_TPSZ_CD,'A5',A.EQ_GLINE_TP_CD,'')) A5_UT" ).append("\n"); 
		...
		query.append("              ,TO_CHAR(SUM(DECODE(A.CNTR_TPSZ_CD,'A5',A.OLD_EQ_GLINE_VAL,''))) OLD_A5_QTY" ).append("\n"); 
		query.append("              ,MAX(DECODE(A.CNTR_TPSZ_CD,'A5',A.OLD_EQ_GLINE_TP_CD,'')) OLD_A5_UT" ).append("\n"); 
		query.append("              ,A.REPO_GLINE_RMK" ).append("\n"); 
