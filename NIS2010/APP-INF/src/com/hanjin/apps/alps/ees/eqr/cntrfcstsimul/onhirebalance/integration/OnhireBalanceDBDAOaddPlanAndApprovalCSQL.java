...
*@FileName : OnhireBalanceDBDAOaddPlanAndApprovalCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnhireBalanceDBDAOaddPlanAndApprovalCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_ONH_PLN_APRO 에 데이터를 INSERT 한다
	  * </pre>
	  */
	public OnhireBalanceDBDAOaddPlanAndApprovalCSQL(){
		setQuery();
		...
		query.append("FileName : OnhireBalanceDBDAOaddPlanAndApprovalCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_CTRL_ONH_PLN_APRO" ).append("\n"); 
		query.append("(    " ).append("\n"); 
		query.append("       ONH_PLN_YRWK" ).append("\n"); 
		query.append("     , LCC_CD" ).append("\n"); 
		query.append("     , EQ_LSTM_CD" ).append("\n"); 
		query.append("     , LSE_PLN_SEQ" ).append("\n"); 
		query.append("     , ONH_PKUP_YRWK" ).append("\n"); 
