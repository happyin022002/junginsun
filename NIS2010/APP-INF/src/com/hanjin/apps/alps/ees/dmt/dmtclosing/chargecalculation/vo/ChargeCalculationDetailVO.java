...
public class ChargeCalculationDetailVO extends AbstractValueObject {
	...
	private List<ExceptionCostVO> exceptionCostVOs = null;
	...
	public List<ExceptionCostVO> getExceptionCostVOs() {
		return exceptionCostVOs;
	}

	public void setExceptionCostVOs(List<ExceptionCostVO> exceptionCostVOs) {
		this.exceptionCostVOs = exceptionCostVOs;
	}
