...
*@FileName : TotalLossMgtDBDAOremoveTotalLossDtlGRPDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TotalLossMgtDBDAOremoveTotalLossDtlGRPDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeTotalLossDTLData
	  * </pre>
	  */
	public TotalLossMgtDBDAOremoveTotalLossDtlGRPDataDSQL(){
		setQuery();
		...
		query.append("FileName : TotalLossMgtDBDAOremoveTotalLossDtlGRPDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
