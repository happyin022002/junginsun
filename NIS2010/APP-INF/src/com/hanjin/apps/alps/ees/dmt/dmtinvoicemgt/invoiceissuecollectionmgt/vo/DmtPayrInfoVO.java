...
public class DmtPayrInfoVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSndCycCd(JSPUtil.getParameter(request, "snd_cyc_cd", ""));
		setOtsShGrpCd(JSPUtil.getParameter(request, "ots_sh_grp_cd", ""));
		setSndCntrListFlg(JSPUtil.getParameter(request, "snd_cntr_list_flg", ""));
		setSndInvFlg(JSPUtil.getParameter(request, "snd_inv_flg", ""));
	}
