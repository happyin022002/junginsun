...
*@FileName : CntrPlanGuidelineManageDBDAOModifyDischargingValueGuidelineUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAOModifyDischargingValueGuidelineUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAOModifyDischargingValueGuidelineUSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAOModifyDischargingValueGuidelineUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EQR_CTRL_DCHG_GLINE_VAL" ).append("\n"); 
		query.append("   SET EQ_GLINE_TP_CD 	= @[eq_gline_tp_cd]" ).append("\n"); 
		query.append("      ,EQ_GLINE_VAL 	= @[eq_gline_val]" ).append("\n"); 
