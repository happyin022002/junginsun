...
*@FileName : ChassisMgsetOnOffhireDBDAOaddCHSFoundAutoStatusHistoryDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOaddCHSFoundAutoStatusHistoryDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOaddCHSFoundAutoStatusHistoryDataCSQL(){
		setQuery();
		...
		params.put("mvmts_dt",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.integration").append("\n"); 
		query.append("FileName : ChassisMgsetOnOffhireDBDAOaddCHSFoundAutoStatusHistoryDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",TO_DATE(@[mvmts_dt] ,'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append(",@[sts_evnt_ofc_cd]" ).append("\n"); 
		query.append(",@[cre_usr_id]" ).append("\n"); 
