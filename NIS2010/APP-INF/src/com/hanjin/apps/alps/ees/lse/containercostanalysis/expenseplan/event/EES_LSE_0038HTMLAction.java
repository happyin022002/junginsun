...
*@FileName : EES_LSE_0038HTMLAction.java
...
public class EES_LSE_0038HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0033HTMLAction 객체를 생성
	 */
	public EES_LSE_0038HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0038Event event = new EesLse0038Event();
