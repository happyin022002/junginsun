...
*@FileName : EES_EQR_0120HTMLAction.java
*@FileTitle : L/T Off-Hire 정보 조회/수정
*Open Issues :
*Change history :
* No.	Ver.		Modifier           		modifier date    explanation
* 1		1.0		ShinYongChan		2006-09-27		1.0 최초 생성
...
public class EES_EQR_0120HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0120HTMLAction 객체를 생성
	 */
	public EES_EQR_0120HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0120Event event = new EesEqr0120Event();
		...
		// Save 버튼 클릭시
			...
			event.setEqrLongTermOffhCondVOS(new EqrLongTermOffhCondVO().fromRequestGridArrayList(request, tpsztype));
		}
