...
*@FileName : EES_MNR_0202HTMLAction.java
...
public class EES_MNR_0202HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0202HTMLAction 객체를 생성
	 */
	public EES_MNR_0202HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0202Event event = new EesMnr0202Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTirePurcharseByItemINVO((TirePurcharseByItemINVO)getVO(request, TirePurcharseByItemINVO .class));
		}
