...
public class EES_MNR_0118HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0118HTMLAction 객체를 생성
	 */
	public EES_MNR_0118HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0118Event event = new EesMnr0118Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRepairPFMCByTSINVO((RepairPFMCByTSINVO)getVO(request, RepairPFMCByTSINVO .class));
		}
