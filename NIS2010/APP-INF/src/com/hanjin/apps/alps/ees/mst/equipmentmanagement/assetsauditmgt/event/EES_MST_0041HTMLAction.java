...
*@FileName : EES_MST_0041HTMLAction.java
...
public class EES_MST_0041HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0041HTMLAction 객체를 생성
	 */
	public EES_MST_0041HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0041Event event = new EesMst0041Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setAssetsOptionVO((AssetsOptionVO)getVO(request, AssetsOptionVO .class));
