...
*@FileName : EesEqr1066ConditionVO.java
*@FileTitle : EesEqr1066ConditionVO
*Open Issues :
*Change history :
...
public class EesEqr1066ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1066ConditionVO> models = new ArrayList<EesEqr1066ConditionVO>();
...
/**
	 ...
	 */
	public EesEqr1066ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1066ConditionVO[]
	 */
	public EesEqr1066ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1066ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1066ConditionVO();
				if (subtrade[i] != null)
		...
		return getEesEqr1066ConditionVOs();
	}
	 ...
	 * @return EesEqr1066ConditionVO[]
	 */
	public EesEqr1066ConditionVO[] getEesEqr1066ConditionVOs(){
		EesEqr1066ConditionVO[] vos = (EesEqr1066ConditionVO[])models.toArray(new EesEqr1066ConditionVO[models.size()]);
		return vos;
	}
