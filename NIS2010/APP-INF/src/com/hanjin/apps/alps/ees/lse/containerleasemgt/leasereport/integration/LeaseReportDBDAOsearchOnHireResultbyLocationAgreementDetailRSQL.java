...
*@FileName : LeaseReportDBDAOsearchOnHireResultbyLocationAgreementDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LeaseReportDBDAOsearchOnHireResultbyLocationAgreementDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2010.12.13 진마리아 [CHM-201007442-01] LT일때 Per-Diem LCC로 변경
	  * 2010.12.16 이윤정[CHM-201007787-01] Detail Data조회 오류 수정
	  * </pre>
	  */
	public LeaseReportDBDAOsearchOnHireResultbyLocationAgreementDetailRSQL(){
		setQuery();
		...
		query.append("FileName : LeaseReportDBDAOsearchOnHireResultbyLocationAgreementDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ,POL_ETD_DT ETD_DT" ).append("\n"); 
		query.append("        ,POD_ETA_DT ETA_DT" ).append("\n"); 
		query.append("        , VVD   " ).append("\n"); 
		query.append("FROM    (" ).append("\n"); 
		query.append("/* CASE 1 */" ).append("\n"); 
		query.append("        SELECT    ROWNUM AS ROW_SEQ" ).append("\n"); 
		...
		query.append("                        NVL(T12.CNTR_STS_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T13.MFT_DT + 1" ).append("\n"); 
		query.append("                  ELSE " ).append("\n"); 
		query.append("                        NVL(T12.CNTR_STS_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T10.CNTR_STS_EVNT_DT + 1" ).append("\n"); 
		...
		query.append("                               (SELECT  ( NVL(T12.CNTR_STS_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T13.MFT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * N1ST_CHG_AMT" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.LOC_CD              (+) = DECODE(T15.LSTM_CD, 'LT', T10.LCC_CD, 'KRSEL')" ).append("\n"); 
		...
		query.append("                               (SELECT  ( NVL(T12.CNTR_STS_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T13.MFT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * AVG(N1ST_CHG_AMT)" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.AGMT_CHG_VAL        (+) = 1" ).append("\n"); 
		...
		query.append("                               (SELECT  ( NVL(T12.CNTR_STS_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) - T10.CNTR_STS_EVNT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * N1ST_CHG_AMT" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.LOC_CD              (+) = DECODE(T15.LSTM_CD, 'LT', T10.LCC_CD, 'KRSEL')" ).append("\n"); 
		...
		query.append("                                AND     RT.CNTR_TPSZ_CD        (+) = T13.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                AND     RT.CNTR_RNTL_CHG_TP_CD (+) = 'PDGV')," ).append("\n"); 
		query.append("                               (SELECT  ( NVL(T12.CNTR_STS_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) - T10.CNTR_STS_EVNT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * AVG(N1ST_CHG_AMT)" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.AGMT_CHG_VAL        (+) = 1" ).append("\n"); 
		...
		query.append("               AND     RT.CNTR_TPSZ_CD        = T13.CNTR_TPSZ_CD " ).append("\n"); 
		query.append("               AND     TO_CHAR(T12.CNTR_STS_EVNT_DT, 'YYYYMMDD') BETWEEN PERIOD_STDT AND PERIOD_EDDT ) AS DPP" ).append("\n"); 
		...
		query.append("       FROM    (" ).append("\n"); 
		query.append("                SELECT  /*+ INDEX(T01 XAK1MST_CNTR_STS_HIS) */" ).append("\n"); 
		query.append("                        T01.CNTR_NO, T01.CNTR_STS_SEQ, T01.YD_CD, T01.AGMT_CTY_CD, T01.AGMT_SEQ, T01.CNTR_STS_EVNT_DT, T01.CNTR_STS_CD, T01.CNTR_LSTM_CNG_FLG" ).append("\n"); 
		...
		query.append("        AND     T10.CNTR_NO            > @[cntr_no]" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		...
		query.append("       	AND   T13.CNTR_TPSZ_CD = @[detail_cntr_tp_sz]" ).append("\n"); 
		query.append("       	#end           " ).append("\n"); 
		...
		query.append("                , T10.DTL_RCC" ).append("\n"); 
		query.append("                #if (${loc_tp} == 'R' ) " ).append("\n"); 
		...
		query.append("                , CASE WHEN ( T15.LSTM_CD = 'OW' OR T15.LSTM_CD = 'LP' OR T15.LSTM_CD = 'OL' ) THEN " ).append("\n"); 
		query.append("                        NVL(T10.LSO_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T13.MFT_DT + 1" ).append("\n"); 
		query.append("                  ELSE " ).append("\n"); 
		query.append("                        NVL(T10.LSO_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T10.LSI_EVNT_DT + 1" ).append("\n"); 
		query.append("                  END                                       AS USEDDAYS" ).append("\n"); 
		...
		query.append("            		  CASE WHEN T15.LSTM_CD IN('OW','LP','OL') " ).append("\n"); 
		query.append("                          THEN NVL( " ).append("\n"); 
		query.append("                               (SELECT  ( NVL(T10.LSO_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T13.MFT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * N1ST_CHG_AMT" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.LOC_CD              (+) = DECODE(T15.LSTM_CD, 'LT', T10.LSI_LCC_CD, 'KRSEL')" ).append("\n"); 
		query.append("                                AND     RT.AGMT_CHG_VAL        (+) = 1" ).append("\n"); 
		query.append("                                AND     RT.CNTR_TPSZ_CD        (+) = T13.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                AND     RT.CNTR_RNTL_CHG_TP_CD (+) = 'PDGV')," ).append("\n"); 
		query.append("                               (SELECT  ( NVL(T10.LSO_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) -  T13.MFT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * AVG(N1ST_CHG_AMT)" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.AGMT_CHG_VAL        (+) = 1" ).append("\n"); 
		...
		query.append("                                AND     RT.CNTR_RNTL_CHG_TP_CD (+) = 'PDGV'))" ).append("\n"); 
		query.append("                          ELSE  NVL( " ).append("\n"); 
		query.append("                               (SELECT  ( NVL(T10.LSO_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) - T10.LSI_EVNT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * N1ST_CHG_AMT" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.LOC_CD              (+) = DECODE(T15.LSTM_CD, 'LT', T10.LSI_LCC_CD, 'KRSEL')" ).append("\n"); 
		...
		query.append("                                AND     RT.CNTR_TPSZ_CD        (+) = T13.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("                                AND     RT.CNTR_RNTL_CHG_TP_CD (+) = 'PDGV')," ).append("\n"); 
		query.append("                               (SELECT  ( NVL(T10.LSO_EVNT_DT, TO_DATE(TO_CHAR(SYSDATE,'RRRR/MM/DD'),'RRRR/MM/DD')) - T10.LSI_EVNT_DT - NVL(T10.RNTL_CHG_FREE_DYS , 0 ) + 1 ) * AVG(N1ST_CHG_AMT)" ).append("\n"); 
		query.append("                                FROM    LSE_AGMT_RT RT" ).append("\n"); 
		query.append("                                WHERE   RT.AGMT_CTY_CD         (+) = T10.AGMT_CTY_CD" ).append("\n"); 
		query.append("                                AND     RT.AGMT_SEQ            (+) = T10.AGMT_SEQ" ).append("\n"); 
		query.append("                                AND     RT.AGMT_CHG_VAL        (+) = 1" ).append("\n"); 
		...
		query.append("               AND     RT.CNTR_TPSZ_CD        = T13.CNTR_TPSZ_CD " ).append("\n"); 
		query.append("               AND     TO_CHAR(T10.LSO_EVNT_DT, 'YYYYMMDD') BETWEEN P_PERIOD_STDT AND P_PERIOD_EDDT ) AS DPP" ).append("\n"); 
		query.append("            ,BKG.BKG_NO" ).append("\n"); 
		query.append("            ,BKG.POL_CD" ).append("\n"); 
		query.append("            ,BKG.POR_CD" ).append("\n"); 
		query.append("            ,BKG.POD_CD" ).append("\n"); 
		...
		query.append("                FROM    (SELECT /*+ INDEX(T01 XAK1MST_CNTR_STS_HIS) USE_NL(T01 T02) */" ).append("\n"); 
		...
		query.append("WHERE	1=1" ).append("\n"); 
		query.append("#if (${detail_rcc} != '')" ).append("\n"); 
		query.append("AND     RCC = DTL_RCC" ).append("\n"); 
		query.append("#end" ).append("\n"); 
