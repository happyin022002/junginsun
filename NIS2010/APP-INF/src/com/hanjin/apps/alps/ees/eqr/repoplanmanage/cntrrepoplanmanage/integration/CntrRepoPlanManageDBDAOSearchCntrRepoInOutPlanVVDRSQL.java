...
*@FileName : CntrRepoPlanManageDBDAOSearchCntrRepoInOutPlanVVDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAOSearchCntrRepoInOutPlanVVDRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAOSearchCntrRepoInOutPlanVVDRSQL(){
		setQuery();
		...
		params.put("yrwk3",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("yrwk2",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("yrwk1",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CntrRepoPlanManageDBDAOSearchCntrRepoInOutPlanVVDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND TO_CHAR(VSL_ETD_DT,'YYYYMMDD') BETWEEN (SELECT WK_ST_DT FROM EQR_WK_PRD WHERE PLN_YR || PLN_WK =  @[yrwk1] )" ).append("\n"); 
		query.append("AND (SELECT WK_END_DT  FROM EQR_WK_PRD WHERE PLN_YR || PLN_WK = @[yrwk2] )" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("AND TO_CHAR(VSL_ETB_DT,'YYYYMMDD') >= (SELECT WK_ST_DT FROM EQR_WK_PRD WHERE PLN_YR || PLN_WK = @[yrwk3] )" ).append("\n"); 
