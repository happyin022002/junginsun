...
*@FileName : ExpenseMgtDBDAOremoveWODetailByPayINVSeqDataDSQLDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExpenseMgtDBDAOremoveWODetailByPayINVSeqDataDSQLDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeWODetailByPayINVSeqDataDSQL
	  * </pre>
	  */
	public ExpenseMgtDBDAOremoveWODetailByPayINVSeqDataDSQLDSQL(){
		setQuery();
		...
		query.append("FileName : ExpenseMgtDBDAOremoveWODetailByPayINVSeqDataDSQLDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
