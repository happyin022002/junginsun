...
*@FileName : CntrForecastManageDBDAOSearchCntrGenerationForecastedDayRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOSearchCntrGenerationForecastedDayRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * eqr_ob_fcast + eqr_ib_bkg_fcast  테이블 데이터 조회(Forecasted/Day)
	  * 
	  * <Change History>
	  * 1	2009.08.12	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrForecastManageDBDAOSearchCntrGenerationForecastedDayRSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOSearchCntrGenerationForecastedDayRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TO_CHAR(TO_DATE (A.FCAST_DEL_DT, 'yyyymmdd'),'DY','NLS_DATE_LANGUAGE=AMERICAN') ST_DY," ).append("\n"); 
		...
		query.append("GROUP BY" ).append("\n"); 
		query.append("SCNR_ID, A.FCAST_DEL_YRWK, A.CO_CD, A.FM_ECC_CD, A.TO_ECC_CD, A.FCAST_DEL_DT" ).append("\n"); 
		query.append("ORDER BY" ).append("\n"); 
		query.append("SCNR_ID, A.FCAST_DEL_YRWK, A.FM_ECC_CD, A.TO_ECC_CD, A.FCAST_DEL_DT" ).append("\n"); 
