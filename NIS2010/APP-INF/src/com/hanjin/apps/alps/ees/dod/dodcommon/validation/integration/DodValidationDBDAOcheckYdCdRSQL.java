...
*@FileName : DodValidationDBDAOcheckYdCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodValidationDBDAOcheckYdCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodValidationDBDAOcheckYdCdRSQL(){
		setQuery();
		...
		query.append("FileName : DodValidationDBDAOcheckYdCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE YD_CD = @[s_value]" ).append("\n"); 
