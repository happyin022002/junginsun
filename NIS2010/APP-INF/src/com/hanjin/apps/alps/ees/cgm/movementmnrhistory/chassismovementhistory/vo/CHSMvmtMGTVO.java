...
public class CHSMvmtMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSMvmtMGTVO> models = new ArrayList<CHSMvmtMGTVO>();
...
/**
	 ...
	 * @return CHSMvmtMGTVO[]
	 */
	public CHSMvmtMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSMvmtMGTVO[]
	 */
	public CHSMvmtMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSMvmtMGTVO model = null;
	...
	public CHSMvmtMGTVO[] getCHSMvmtMGTVOs(){
		CHSMvmtMGTVO[] vos = (CHSMvmtMGTVO[])models.toArray(new CHSMvmtMGTVO[models.size()]);
		return vos;
	}
