...
*@FileName : MGSInventoryDtlINVO.java
*@FileTitle : MGSInventoryDtlINVO
*Open Issues :
*Change history :
...
public class MGSInventoryDtlINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSInventoryDtlINVO> models = new ArrayList<MGSInventoryDtlINVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDispCd(JSPUtil.getParameter(request, "disp_cd", ""));
	}
	 ...
	 */
	public MGSInventoryDtlINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSInventoryDtlINVO[]
	 */
	public MGSInventoryDtlINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSInventoryDtlINVO model = null;
		...
		return getMGSInventoryDtlINVOs();
	}
	...
	public MGSInventoryDtlINVO[] getMGSInventoryDtlINVOs(){
		MGSInventoryDtlINVO[] vos = (MGSInventoryDtlINVO[])models.toArray(new MGSInventoryDtlINVO[models.size()]);
		return vos;
	}
