...
*@FileName : EES_DMT_6014HTMLAction.java
...
public class EES_DMT_6014HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * EES_DMT_6014HTMLAction 객체를 생성
     */
    public EES_DMT_6014HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt6014Event event = new EesDmt6014Event();
        
        if(command.isCommand(FormCommand.SEARCH)) {
            event.setAfterBookingFileLetterVO ((AfterBookingFileLetterVO )getVO(request, AfterBookingFileLetterVO  .class));
        }
