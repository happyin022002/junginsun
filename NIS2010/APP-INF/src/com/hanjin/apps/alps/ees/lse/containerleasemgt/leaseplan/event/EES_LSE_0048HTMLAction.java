...
public class EES_LSE_0048HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_LSE_0048HTMLAction 객체를 생성
	 */
	public EES_LSE_0048HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0048Event event = new EesLse0048Event();
		...
		if ( command.isCommand(FormCommand.SEARCH) 
		  || command.isCommand(FormCommand.SEARCH01) ) {
			...
			event.setPlanSearchVO((PlanSearchVO)getVO(request, PlanSearchVO.class));
			event.setLeasePlanVOs((LeasePlanVO[])getVOs(request, LeasePlanVO.class,"sheet1_"));
		}
