...
*@FileName : MGSTermStatusINVO.java
*@FileTitle : MGSTermStatusINVO
*Open Issues :
*Change history :
...
public class MGSTermStatusINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSTermStatusINVO> models = new ArrayList<MGSTermStatusINVO>();
...
/**
	 ...
	 */
	public MGSTermStatusINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSTermStatusINVO[]
	 */
	public MGSTermStatusINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSTermStatusINVO model = null;
	...
	public MGSTermStatusINVO[] getMGSTermStatusINVOs(){
		MGSTermStatusINVO[] vos = (MGSTermStatusINVO[])models.toArray(new MGSTermStatusINVO[models.size()]);
		return vos;
	}
