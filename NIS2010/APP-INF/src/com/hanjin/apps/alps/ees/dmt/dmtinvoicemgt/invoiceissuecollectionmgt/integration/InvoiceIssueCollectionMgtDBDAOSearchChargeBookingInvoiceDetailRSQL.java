...
*@FileName : InvoiceIssueCollectionMgtDBDAOSearchChargeBookingInvoiceDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOSearchChargeBookingInvoiceDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOSearchChargeBookingInvoiceDetailRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOSearchChargeBookingInvoiceDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, B.DUL_TP_EXPT_FLG" ).append("\n"); 
