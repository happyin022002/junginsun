...
*@FileName : EES_CGM_1115HTMLAction.java
...
public class EES_CGM_1115HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1115HTMLAction 객체를 생성
	 */
	public EES_CGM_1115HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1115Event event = new EesCgm1115Event();
		
		CHSEspReportINVO cHSEspReportINVO = new CHSEspReportINVO(); 
		if(command.isCommand(FormCommand.SEARCH)) {
			cHSEspReportINVO = (CHSEspReportINVO)getVO(request, CHSEspReportINVO .class);
			event.setCHSEspReportINVO(cHSEspReportINVO);
