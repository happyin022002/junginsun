...
*@FileName : RepairMgtDBDAOmodifyEstimateDTLDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOmodifyEstimateDTLDataUSQL implements ISQLTemplate{
	...
	public RepairMgtDBDAOmodifyEstimateDTLDataUSQL(){
		...
		query.append("FileName : RepairMgtDBDAOmodifyEstimateDTLDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MNR_RPR_RQST_DTL DTL" ).append("\n"); 
		query.append("   SET (DTL.RPR_LBR_HRS," ).append("\n"); 
		query.append("        DTL.RPR_LBR_BZC_HRS," ).append("\n"); 
		...
		query.append("           AND TMP_DTL_SEQ = DTL.RPR_RQST_DTL_SEQ)" ).append("\n"); 
