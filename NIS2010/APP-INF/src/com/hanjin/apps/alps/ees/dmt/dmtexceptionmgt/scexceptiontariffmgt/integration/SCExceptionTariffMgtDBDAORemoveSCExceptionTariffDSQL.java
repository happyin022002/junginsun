...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionTariffDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionTariffDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff 의 선택한 Group Seq. 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionTariffDSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionTariffDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_SC_EXPT_GRP" ).append("\n"); 
