...
*@FileName : InvoiceIssueCollectionMgtDBDAOAddInvoiceRateBatchCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOAddInvoiceRateBatchCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice 의 Charge 에 대한 Rate 정보를 일괄적으로 한 번에 입력처리하는 쿼리
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOAddInvoiceRateBatchCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOAddInvoiceRateBatchCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
