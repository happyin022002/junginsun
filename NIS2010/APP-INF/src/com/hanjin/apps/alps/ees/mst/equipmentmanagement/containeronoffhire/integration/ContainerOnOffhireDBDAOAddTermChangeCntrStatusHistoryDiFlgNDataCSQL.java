...
*@FileName : ContainerOnOffhireDBDAOAddTermChangeCntrStatusHistoryDiFlgNDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerOnOffhireDBDAOAddTermChangeCntrStatusHistoryDiFlgNDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddTermChangeCntrStatusHistoryDiFlgNData
	  * </pre>
	  */
	public ContainerOnOffhireDBDAOAddTermChangeCntrStatusHistoryDiFlgNDataCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerOnOffhireDBDAOAddTermChangeCntrStatusHistoryDiFlgNDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    CASE " ).append("\n"); 
		query.append("            WHEN @[di_flag] = 'N' THEN " ).append("\n"); 
		query.append("				DECODE(LEVEL,1, NVL((SELECT  /*+ INDEX_DESC(A XAK1MST_CNTR_STS_HIS) */ A.YD_CD" ).append("\n"); 
		...
		query.append("                                 AND     ROWNUM =1),@[yd_cd])" ).append("\n"); 
		query.append("                            ,2,NULL)" ).append("\n"); 
		query.append("    END PRNR_YD_CD, " ).append("\n"); 
		query.append("    CASE " ).append("\n"); 
		query.append("      WHEN @[di_flag] = 'N' THEN " ).append("\n"); 
		query.append("				DECODE(LEVEL,1, NVL((SELECT  /*+ INDEX_DESC(A XAK1MST_CNTR_STS_HIS) */ A.CNTR_STS_SEQ" ).append("\n"); 
		query.append("                                 FROM    MST_CNTR_STS_HIS A" ).append("\n"); 
		query.append("                                 WHERE   A.CNTR_NO = @[cntr_no]" ).append("\n"); 
		query.append("                                 AND     A.CNTR_STS_CD = 'LSI'" ).append("\n"); 
		query.append("                                 AND     ROWNUM =1), @[cntr_sts_seq])" ).append("\n"); 
		query.append("                            ,2,NULL)" ).append("\n"); 
