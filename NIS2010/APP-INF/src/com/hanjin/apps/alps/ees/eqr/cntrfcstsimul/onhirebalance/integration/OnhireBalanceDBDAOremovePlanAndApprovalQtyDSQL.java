...
*@FileName : OnhireBalanceDBDAOremovePlanAndApprovalQtyDSQL.java
...
public class OnhireBalanceDBDAOremovePlanAndApprovalQtyDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_ONH_PLN_APRO_QTY 에 데이터를 DELETE 한다
	  * </pre>
	  */
	public OnhireBalanceDBDAOremovePlanAndApprovalQtyDSQL(){
		setQuery();
		...
		query.append("FileName : OnhireBalanceDBDAOremovePlanAndApprovalQtyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE EQR_CTRL_ONH_PLN_APRO_QTY" ).append("\n"); 
