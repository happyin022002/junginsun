...
*@FileName : SCExceptionTariffMgtDBDAOModifyVersionSTSUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOModifyVersionSTSUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C 의 Version 정보를 변경해 주는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOModifyVersionSTSUSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOModifyVersionSTSUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("SET		DMDT_EXPT_VER_STS_CD = @[dmdt_expt_ver_sts_cd]" ).append("\n"); 
