...
public class InvoiceIssueCollectionMgtDBDAOSheepOptionOfcShOptUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", CRE_DT		    = NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[isof]),SYSDATE)" ).append("\n"); 
		query.append(", UPD_USR_ID	    = @[usid]" ).append("\n"); 
		query.append(", UPD_DT		    = NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[isof]),SYSDATE)" ).append("\n"); 
