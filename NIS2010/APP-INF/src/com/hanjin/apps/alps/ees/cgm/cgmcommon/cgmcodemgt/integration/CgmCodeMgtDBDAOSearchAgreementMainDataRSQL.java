...
*@FileName : CgmCodeMgtDBDAOSearchAgreementMainDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOSearchAgreementMainDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CgmCodeMgtDB.SearchAgreementMainData
	  * </pre>
	  */
	public CgmCodeMgtDBDAOSearchAgreementMainDataRSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOSearchAgreementMainDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TO_CHAR(A.AGMT_DT,'YYYY-MM-DD') AS CRE_DT" ).append("\n"); 
