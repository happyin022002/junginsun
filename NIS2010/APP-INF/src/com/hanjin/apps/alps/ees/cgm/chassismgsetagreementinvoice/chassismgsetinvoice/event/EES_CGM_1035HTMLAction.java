...
*@FileName : EES_CGM_1035HTMLAction.java
...
public class EES_CGM_1035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1035HTMLAction 객체를 생성
	 */
	public EES_CGM_1035HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1035Event event = new EesCgm1035Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSInvoiceInquiryINVO((CHSInvoiceInquiryINVO)getVO(request, CHSInvoiceInquiryINVO .class));
