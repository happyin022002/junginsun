...
public class CntrMstHeadVO extends AbstractValueObject {
	...
	public CntrMstHeadVO(String ibflag, String pagerows, String cntrNo, String chkDgt, String aciacDivCd, String cntrTpszCd, String lstmCd, String cntrTpszIsoCd, String cntrOldVanFlg, String ownrCoCd, String cntrUseCoCd, String mnrSldChk) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mnr_sld_chk", getMnrSldChk());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mnr_sld_chk", "mnrSldChk");
	 ...
	 * @return lstmCd
	 */
	public String getMnrSldChk() {
		return this.mnrSldChk;
	}
	 ...
	 * @param lstmCd
	 */
	public void setMnrSldChk(String mnrSldChk) {
		this.mnrSldChk = mnrSldChk;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLstmCd(JSPUtil.getParameter(request, "mnr_sld_chk", ""));
	...
	public CntrMstHeadVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] mnrSldChk = (JSPUtil.getParameter(request, prefix	+ "mnr_sld_chk".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (mnrSldChk[i] != null)
					model.setMnrSldChk(mnrSldChk[i]);
				if (pagerows[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.mnrSldChk = this.mnrSldChk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
