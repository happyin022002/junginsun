...
public class MTYEquipmentForecastDBDAOsearchMtyBalanceOtherListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,TO_CHAR(A.D2_FCAST_QTY+A.D4_FCAST_QTY+A.D5_FCAST_QTY+A.D7_FCAST_QTY+A.R2_FCAST_QTY+A.R5_FCAST_QTY+A.R9_FCAST_QTY+A.O2_FCAST_QTY+A.S2_FCAST_QTY+A.O4_FCAST_QTY+A.S4_FCAST_QTY+A.F2_FCAST_QTY+A.A2_FCAST_QTY+A.F4_FCAST_QTY+A.A4_FCAST_QTY+A.A5_FCAST_QTY+A.F5_FCAST_QTY,'9,999,999')   G_TOTAL    " ).append("\n"); 
		...
		query.append("    ,TO_CHAR(A.R2_FCAST_QTY+A.R5_FCAST_QTY+A.R9_FCAST_QTY+A.O2_FCAST_QTY+A.S2_FCAST_QTY+A.O4_FCAST_QTY+A.S4_FCAST_QTY+A.O5_FCAST_QTY+A.F2_FCAST_QTY+A.A2_FCAST_QTY+A.F4_FCAST_QTY+A.A4_FCAST_QTY+A.A5_FCAST_QTY+A.F5_FCAST_QTY,'9,999,999') S_TOTAL" ).append("\n"); 
		...
		query.append("    ,A.A5_FCAST_QTY" ).append("\n"); 
		...
		query.append("        ,NVL(A.A5_FCAST_QTY,0) A5_FCAST_QTY" ).append("\n"); 
