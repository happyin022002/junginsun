...
*@FileName : CgmYardMGTVO.java
*@FileTitle : CgmYardMGTVO
*Open Issues :
*Change history :
...
public class YardMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<YardMGTVO> models = new ArrayList<YardMGTVO>();
	 ...
	 * @param ofcCd
	 */
	public YardMGTVO(String ibflag, String pagerows, String ydCd, String ydNm, String ofcCd) {
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
		this.ydCd = ydCd;
		this.ydNm = ydNm;
	 ...
	 * @return CgmYardMGTVO[]
	 */
	public YardMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CgmYardMGTVO[]
	 */
	public YardMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		YardMGTVO model = null;
	...
	public YardMGTVO[] getCgmYardMGTVOs(){
		YardMGTVO[] vos = (YardMGTVO[])models.toArray(new YardMGTVO[models.size()]);
		return vos;
	}
