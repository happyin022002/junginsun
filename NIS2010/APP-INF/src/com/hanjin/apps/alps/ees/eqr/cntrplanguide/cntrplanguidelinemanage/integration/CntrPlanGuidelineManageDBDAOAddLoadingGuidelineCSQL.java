...
*@FileName : CntrPlanGuidelineManageDBDAOAddLoadingGuidelineCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAOAddLoadingGuidelineCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Loading Guideline Add
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAOAddLoadingGuidelineCSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAOAddLoadingGuidelineCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_CTRL_LODG_GLINE(" ).append("\n"); 
