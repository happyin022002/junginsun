...
*@FileName : EES_EQR_0139HTMLAction.java
...
public class EES_EQR_0139HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0139HTMLAction 객체를 생성
	 */
	public EES_EQR_0139HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {		
		EesEqr0139Event event = new EesEqr0139Event();
