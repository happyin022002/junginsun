...
*@FileName : EES_EQR_6003HTMLAction.java
...
public class EES_EQR_6003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_6003HTMLAction 객체를 생성
	 */
	public EES_EQR_6003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr6003Event event = new EesEqr6003Event();
