...
*@FileName : ITurnTimePerformanceFinderDAOTTSearchOptionInGereralVO RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TurnTimePerformanceMgtDBDAOsearchPortTurnTimeListByLaneVVDSummaryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TurnTimePerformanceMgtDBDAOsearchPortTurnTimeListByLaneVVDSummaryRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FROM    (" ).append("\n"); 
		query.append("SELECT	T.VSL_CD||T.SKD_VOY_NO||T.SKD_DIR_CD	VVD," ).append("\n"); 
		...
		query.append("AND	T.VL_LOC_CD	=	@[pol]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${lane} != '')" ).append("\n"); 
		query.append("AND	T.SLAN_CD	=	NVL( @[lane],T.SLAN_CD)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${vvd} != '')" ).append("\n"); 
		query.append("AND	T.VSL_CD||T.SKD_VOY_NO||T.SKD_DIR_CD	=	NVL( @[vvd],T.SLAN_CD)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("GROUP BY" ).append("\n"); 
		query.append("ROLLUP(VVD)," ).append("\n"); 
		query.append("DECODE(Y.NO,'1','XX','2','YY')" ).append("\n"); 
		query.append("ORDER BY vvd,XXX" ).append("\n"); 

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.cim.cntroperationperformancemgt.turntimeperformancemgt.integration").append("\n"); 
		query.append("FileName : TurnTimePerformanceMgtDBDAOsearchPortTurnTimeListByLaneVVDSummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}