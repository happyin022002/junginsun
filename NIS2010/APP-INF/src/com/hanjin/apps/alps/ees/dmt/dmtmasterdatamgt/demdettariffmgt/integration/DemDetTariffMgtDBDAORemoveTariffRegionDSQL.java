...
*@FileName : DemDetTariffMgtDBDAORemoveTariffRegionDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAORemoveTariffRegionDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAORemoveTariffRegionDSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAORemoveTariffRegionDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_TRF_RGN" ).append("\n"); 
