...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionBBGAuthRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionBBGAuthRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionBBGAuthRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionBBGAuthRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionBBGAuthRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   and  T2.USR_ROLE_CD      = 'DMT06'" ).append("\n"); 
