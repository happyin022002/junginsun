...
*@FileName : EES_EQR_7002HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.enis.ees.eqr.eqtransportplannperform 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 *
 * @author dev098
 * @see EesEqr7002Event 참조
 * @since J2EE 1.6
 */
public class EES_EQR_7002HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * EES_EQR_1049HTMLAction 객체를 생성
     */
    public EES_EQR_7002HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesEqr7002Event event = new EesEqr7002Event();
