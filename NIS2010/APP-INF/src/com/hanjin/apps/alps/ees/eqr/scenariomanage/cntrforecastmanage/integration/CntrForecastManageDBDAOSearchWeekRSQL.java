...
*@FileName : CntrForecastManageDBDAOSearchWeekRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOSearchWeekRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrForecastManageDBDAOSearchWeekRSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOSearchWeekRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT (ROWNUM)SEQ, PLN_YR, PLN_WK, PLN_MON" ).append("\n"); 
		query.append("FROM EQR_WK_PRD" ).append("\n"); 
		query.append("WHERE  PLN_YR || PLN_WK >= @[yyyywk]" ).append("\n"); 
		query.append(")B" ).append("\n"); 
		query.append("WHERE SEQ =  20" ).append("\n"); 
