...
*@FileName : DemDetTariffMgtDBDAOConfirmRgnBasicTariffUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOConfirmRgnBasicTariffUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Basic Tariff Creation - Confirm
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOConfirmRgnBasicTariffUSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOConfirmRgnBasicTariffUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
