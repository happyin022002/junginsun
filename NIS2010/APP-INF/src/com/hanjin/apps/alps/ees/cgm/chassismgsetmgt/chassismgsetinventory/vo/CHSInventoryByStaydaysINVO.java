...
*@FileName : CHSInventoryByStaydaysINVO.java
*@FileTitle : CHSInventoryByStaydaysINVO
*Open Issues :
*Change history :
...
public class CHSInventoryByStaydaysINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInventoryByStaydaysINVO> models = new ArrayList<CHSInventoryByStaydaysINVO>();
	 ...
	 */
	public CHSInventoryByStaydaysINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInventoryByStaydaysINVO[]
	 */
	public CHSInventoryByStaydaysINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInventoryByStaydaysINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSInventoryByStaydaysINVO();
		...
		return getCHSInventoryByStaydaysINVOs();
	}
	 ...
	 * @return CHSInventoryByStaydaysINVO[]
	 */
	public CHSInventoryByStaydaysINVO[] getCHSInventoryByStaydaysINVOs(){
		CHSInventoryByStaydaysINVO[] vos = (CHSInventoryByStaydaysINVO[])models.toArray(new CHSInventoryByStaydaysINVO[models.size()]);
		return vos;
	}
