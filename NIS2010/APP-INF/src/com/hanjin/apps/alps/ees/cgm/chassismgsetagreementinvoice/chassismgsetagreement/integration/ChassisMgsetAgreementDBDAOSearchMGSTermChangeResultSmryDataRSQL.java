...
*@FileName : ChassisMgsetAgreementDBDAOSearchMGSTermChangeResultSmryDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOSearchMGSTermChangeResultSmryDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.SearchMGSTermChangeResultSmryData
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOSearchMGSTermChangeResultSmryDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOSearchMGSTermChangeResultSmryDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(SUM(EQ_TPSZ_CD_CLG),0) AS EQ_TPSZ_CD_CLG," ).append("\n"); 
		query.append("NVL(SUM(EQ_TPSZ_CD_UMG),0) AS EQ_TPSZ_CD_UMG" ).append("\n"); 
		...
		query.append("MIN(DECODE(B.EQ_TPSZ_CD,'CLG',1)) AS EQ_TPSZ_CD_CLG," ).append("\n"); 
		query.append("MIN(DECODE(B.EQ_TPSZ_CD,'UMG',1)) AS EQ_TPSZ_CD_UMG" ).append("\n"); 
