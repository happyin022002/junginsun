...
*@FileName : EES_CTM_0463HTMLAction.java
...
public class EES_CTM_0463HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0463HTMLAction 객체를 생성
	 */
	public EES_CTM_0463HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0463Event event = new EesCtm0463Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEventDateUpdateHistoryParmVO((EventDateUpdateHistoryParmVO)getVO(request, EventDateUpdateHistoryParmVO .class));
		}
