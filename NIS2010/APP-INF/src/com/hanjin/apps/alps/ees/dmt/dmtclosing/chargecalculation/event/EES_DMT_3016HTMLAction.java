...
*@FileName : EES_DMT_3016HTMLAction.java
...
public class EES_DMT_3016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3016HTMLAction 객체를 생성
	 */
	public EES_DMT_3016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt3016Event event = new EesDmt3016Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setOPMTChargeParmVO((OPMTChargeParmVO)getVO(request, OPMTChargeParmVO .class));
