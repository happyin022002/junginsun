...
*@FileName : CntrRepoPlanManageDBDAODeleteOnOffPlanDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAODeleteOnOffPlanDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ONF_HIR_PLN 테이블 데이터 삭제
	  * 
	  * <Change History>
	  * 1	2009.09.22	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAODeleteOnOffPlanDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanManageDBDAODeleteOnOffPlanDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
