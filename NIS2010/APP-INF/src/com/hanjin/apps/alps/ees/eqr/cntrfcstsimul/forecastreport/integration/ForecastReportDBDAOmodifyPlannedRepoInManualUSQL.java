...
*@FileName : ForecastReportDBDAOmodifyPlannedRepoInManualUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOmodifyPlannedRepoInManualUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INTO EQR_CTRL_PLN_REPO_IN 에 Planned Repo In Manual 데이터 수정/입력 (merge)
	  * </pre>
	  */
	public ForecastReportDBDAOmodifyPlannedRepoInManualUSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOmodifyPlannedRepoInManualUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EQR_CTRL_PLN_REPO_IN" ).append("\n"); 
