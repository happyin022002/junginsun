...
*@FileName : CgmValidationDBDAOsearchCgmAgmtNoDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmValidationDBDAOsearchCgmAgmtNoDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CGM Agreement No 정보를 조회한다.
	  * </pre>
	  */
	public CgmValidationDBDAOsearchCgmAgmtNoDataRSQL(){
		setQuery();
		...
		query.append("FileName : CgmValidationDBDAOsearchCgmAgmtNoDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   AGMT_ISS_OFC_CD   = @[ctrt_ofc_cd]" ).append("\n"); 
