...
*@FileName : CgmCodeMgtDBDAOAddCPSScExptListDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOAddCPSScExptListDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception List를 입력한다.
	  * </pre>
	  */
	public CgmCodeMgtDBDAOAddCPSScExptListDataCSQL(){
		setQuery();
		...
		params.put("sc_cust_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CgmCodeMgtDBDAOAddCPSScExptListDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CGM_CPS_SC_EXPT_LIST" ).append("\n"); 
		query.append("(" ).append("\n"); 
