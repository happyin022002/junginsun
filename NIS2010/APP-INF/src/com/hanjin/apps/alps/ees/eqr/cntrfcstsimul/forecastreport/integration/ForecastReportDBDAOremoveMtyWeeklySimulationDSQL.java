...
*@FileName : ForecastReportDBDAOremoveMtyWeeklySimulationDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOremoveMtyWeeklySimulationDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 기존에 입력된 MTY Weekly simulation 정보를 삭제한다
	  * </pre>
	  */
	public ForecastReportDBDAOremoveMtyWeeklySimulationDSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOremoveMtyWeeklySimulationDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/*" ).append("\n"); 
		query.append("--  1.정의 : EQR_CTRL_MTY_WKY_SIM 수정쿼리" ).append("\n"); 
		...
		query.append("*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("DELETE FROM EQR_CTRL_MTY_WKY_SIM" ).append("\n"); 
