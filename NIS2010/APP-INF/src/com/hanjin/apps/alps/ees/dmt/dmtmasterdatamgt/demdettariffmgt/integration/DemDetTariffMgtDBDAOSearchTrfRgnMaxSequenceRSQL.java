...
*@FileName : DemDetTariffMgtDBDAOSearchTrfRgnMaxSequenceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchTrfRgnMaxSequenceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Coverage(Continent, Country, Region, Location, Yard), Orgin_Destination(Continent, Country, Region, Location) 에 대한 Max Sequence
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchTrfRgnMaxSequenceRSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchTrfRgnMaxSequenceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MAX(TRF_SEQ),0) AS TRF_SEQ" ).append("\n"); 
