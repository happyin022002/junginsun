...
*@FileName : EES_MST_0025HTMLAction.java
...
public class EES_MST_0025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0025HTMLAction 객체를 생성
	 */
	public EES_MST_0025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0025Event event = new EesMst0025Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setLostFoundVOs((LostFoundVO[])getVOs(request, LostFoundVO .class,""));
		}
