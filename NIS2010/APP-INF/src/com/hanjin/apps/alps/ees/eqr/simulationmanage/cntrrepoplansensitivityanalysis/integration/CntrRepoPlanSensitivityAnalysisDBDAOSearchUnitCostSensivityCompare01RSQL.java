...
*@FileName : CntrRepoPlanSensitivityAnalysisDBDAOSearchUnitCostSensivityCompare01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanSensitivityAnalysisDBDAOSearchUnitCostSensivityCompare01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoPlanSensitivityAnalysisDBDAOSearchUnitCostSensivityCompare01RSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanSensitivityAnalysisDBDAOSearchUnitCostSensivityCompare01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND B.TRSP_MOD_CD = @[sheetcostcd]" ).append("\n"); 
