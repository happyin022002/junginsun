...
*@FileName : EES_DMT_1101HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class EES_DMT_1101HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_1003HTMLAction 객체를 생성
	 */
	public EES_DMT_1101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt1101Event event = new EesDmt1101Event();
        log.debug("::CALL::> EES_DMT_1101HTMLAction - " + command.getCommand());
        
		if(command.isCommand(FormCommand.MULTI)) {
			event.setDmtTariffTypeVO((DmtTariffTypeVO)getVO(request, DmtTariffTypeVO.class ));
			event.setToDmtTariffTypeVO((ToDmtTariffTypeVO)getVO(request, ToDmtTariffTypeVO.class ));
		}
