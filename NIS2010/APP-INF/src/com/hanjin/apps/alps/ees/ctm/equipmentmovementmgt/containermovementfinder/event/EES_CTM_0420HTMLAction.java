...
*@FileName : EES_CTM_0420HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0420HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0420HTMLAction 객체를 생성
	 */
	public EES_CTM_0420HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0420Event event = new EesCtm0420Event();
		event.setSearchEDIResultVO((SearchEDIResultVO)getVO(request, SearchEDIResultVO.class));
