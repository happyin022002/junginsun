...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOsearchTmnlMBByLogiticWiseByTrendRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOsearchTmnlMBByLogiticWiseByTrendRSQL implements ISQLTemplate{
	...
	public EQMatchBackNLoadFactorMgtDBDAOsearchTmnlMBByLogiticWiseByTrendRSQL(){
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOsearchTmnlMBByLogiticWiseByTrendRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("O.RCC_CD" ).append("\n"); 
		query.append("#end) */" ).append("\n"); 
		query.append("SUBSTR(T.YD_CD, 1, 5)	LOC_CD,     /* inquiryLevel */" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${company} == 'L')" ).append("\n"); 
		query.append("AND T.MVMT_CO_CD = 'L'      /* H :HJS, S :SEN, L:Hanjin Logistics */" ).append("\n"); 
		query.append("#elseif(${company} == 'E')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("*/" ).append("\n"); 
		query.append("SUBSTR(T.YD_CD, 1, 5)," ).append("\n"); 
		query.append("T.YD_CD," ).append("\n"); 
		...
		query.append("GROUP BY X.LOC_CD, X.YARD_CD, X.DSP_SEQ, X.TPSZ, DECODE(Y.NO,'1','AA','2','BB','3','CC','4','DD')" ).append("\n"); 
		query.append("--ORDER BY X.LOC_CD, X.YARD_CD, X.DSP_SEQ" ).append("\n"); 
		...
		query.append("--T.YD_CD YARD_CD," ).append("\n"); 
		query.append("'ZZZZZZZ' YARD_CD," ).append("\n"); 
		query.append("T.CNTR_TPSZ_CD TPSZ," ).append("\n"); 
		query.append("W.DAY_SEQ DAY_SEQ," ).append("\n"); 
		query.append("S.DP_SEQ DSP_SEQ," ).append("\n"); 
		query.append("SUM (T.IB_QTY) IN_QTY," ).append("\n"); 
		...
		query.append("GROUP BY X.LOC_CD, X.YARD_CD, X.DSP_SEQ, X.TPSZ, DECODE(Y.NO,'1','AA','2','BB','3','CC','4','DD')" ).append("\n"); 
		query.append("--ORDER BY X.LOC_CD, X.YARD_CD, X.DSP_SEQ" ).append("\n"); 
		query.append("ORDER BY LOC_CD, YARD_CD, IBFLAG, LINE" ).append("\n"); 
