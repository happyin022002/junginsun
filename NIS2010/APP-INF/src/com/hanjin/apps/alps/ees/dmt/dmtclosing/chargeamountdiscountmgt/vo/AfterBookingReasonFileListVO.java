...
*@FileName : AfterBookingReasonFileListVO.java
*@FileTitle : AfterBookingReasonFileListVO
*Open Issues :
*Change history :
...
public class AfterBookingReasonFileListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AfterBookingReasonFileListVO> models = new ArrayList<AfterBookingReasonFileListVO>();
	...
	public AfterBookingReasonFileListVO() {}

	public AfterBookingReasonFileListVO(String ibflag, String pagerows, String aftExptDarNo, String aftBkgFileDivCd, String detail1Type, String detail2Type, String detail3Type, String detail4Type, String detail5Type, String detail6Type, String detail7Type, String detail8Type, String detail9Type) {
...
/**
	 ...
	 * @param request
	 * @return AfterBookingReasonFileListVO[]
	 */
	public AfterBookingReasonFileListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AfterBookingReasonFileListVO[]
	 */
	public AfterBookingReasonFileListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AfterBookingReasonFileListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AfterBookingReasonFileListVO();
		...
		return getAfterBookingReasonFileListVOs();
	}
	 ...
	 * @return AfterBookingReasonFileListVO[]
	 */
	public AfterBookingReasonFileListVO[] getAfterBookingReasonFileListVOs(){
		AfterBookingReasonFileListVO[] vos = (AfterBookingReasonFileListVO[])models.toArray(new AfterBookingReasonFileListVO[models.size()]);
		return vos;
	}
