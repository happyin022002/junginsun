...
*@FileName : EES_DMT_7002HTMLAction.java
*@FileTitle : Remark(s)
*Open Issues :
*Change history :
...
import com.hanjin.apps.alps.ees.dmt.dmtperformanceanalysis.chargecollectionreport.vo.CollectionOfficeFinderVO;
...
public class EES_DMT_7002HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt7002Event event = new EesDmt7002Event();
        

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setCollectionOfficeFinderVO((CollectionOfficeFinderVO)getVO(request, CollectionOfficeFinderVO .class));
        }
