...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_INLND_TRSP_EXE_PLN  테이블의 특정 ref id, repo plan id 삭제
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
