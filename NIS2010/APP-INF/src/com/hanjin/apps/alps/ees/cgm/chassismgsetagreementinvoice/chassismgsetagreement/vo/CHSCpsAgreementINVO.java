...
*@FileName : CHSCpsAgreementINVO.java
*@FileTitle : CHSCpsAgreementINVO
*Open Issues :
*Change history :
...
public class CHSCpsAgreementINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSCpsAgreementINVO> models = new ArrayList<CHSCpsAgreementINVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("chk_yd_cd", getChkYdCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("chk_yd_cd", "chkYdCd");
	 ...
	 * @param chkYdCd
	 */
	public void setChkYdCd(String chkYdCd) {
		this.chkYdCd = chkYdCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setChkYdCd(JSPUtil.getParameter(request, prefix + "chk_yd_cd", ""));
	 ...
	 */
	public CHSCpsAgreementINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSCpsAgreementINVO[]
	 */
	public CHSCpsAgreementINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSCpsAgreementINVO model = null;
		...
		try {
			...
			String[] chkYdCd = (JSPUtil.getParameter(request, prefix	+ "chk_yd_cd", length));
		...
		return getCHSCpsAgreementINVOs();
	}
	...
	public CHSCpsAgreementINVO[] getCHSCpsAgreementINVOs(){
		CHSCpsAgreementINVO[] vos = (CHSCpsAgreementINVO[])models.toArray(new CHSCpsAgreementINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.chkYdCd = this.chkYdCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
