...
*@FileName : ContainerMovementValidationDBDAOgetContainerYardRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementValidationDBDAOgetContainerYardRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementValidationDBDAOgetContainerYardRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementValidationDBDAOgetContainerYardRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       A.HJS_CRE_FLG," ).append("\n"); 
		...
		query.append("               MM.HJS_CRE_FLG," ).append("\n"); 
		...
		query.append("                       CASE WHEN SYS_AREA_GRP_ID = RGN_CD THEN 'Y' ELSE 'N' END HJS_CRE_FLG," ).append("\n"); 
		query.append("                       IMDT_EXT_FLG," ).append("\n"); 
		query.append("                       HJS_CRE_FLG NEW_FLG" ).append("\n"); 
		...
		query.append("                 WHERE CNTR_NO LIKE DECODE(@[cntr_no], NULL, '9999999999999999', 'SMCU', '9999999999999999', @[cntr_no])||'%'" ).append("\n"); 
