...
public class MBSearchOptionInGereralVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tnRoute", getTnRoute());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tnRoute", "tnRoute");
	 ...
	 * @param enRoute the enRoute to set
	 */
	public void setTnRoute(String tnRoute) {
		this.tnRoute = tnRoute;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTnRoute(JSPUtil.getParameter(request, "tnRoute", ""));
	}
	...
	public MBSearchOptionInGereralVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] tnRoute = (JSPUtil.getParameter(request, prefix	+ "tnRoute".trim(), length));
	...
	*/
	public void unDataFormat(){
		...
		this.tnRoute = this.tnRoute .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
