...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHireExecuteQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHireExecuteQtyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHireExecuteQtyCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertOnOffHireExecuteQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_ONF_HIR_EXE_PLN_QTY (" ).append("\n"); 
