...
*@FileName : EES_CGM_2028HTMLAction.java
...
public class EES_CGM_2028HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2028HTMLAction 객체를 생성
	 */
	public EES_CGM_2028HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2028Event event = new EesCgm2028Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			MGSTermChangeResultINVO mgsTermChangeResultINVO = (MGSTermChangeResultINVO)getVO(request, MGSTermChangeResultINVO.class);
			event.setMgsTermChangeResultINVO(mgsTermChangeResultINVO);
		}
