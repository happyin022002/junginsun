...
public class InvoiceIssueCollectionMgtDBDAOSearchIssuedInvoiceSumByPayerRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				   --AND  ('R' = SUBSTR(A.DMDT_INV_NO,3,1) OR 'T' = SUBSTR(A.DMDT_INV_NO,3,1))" ).append("\n"); 
		query.append("				   AND  (" ).append("\n"); 
		query.append("							CASE " ).append("\n"); 
		query.append("								-- INDIA 일 경우, INVOICE NO 자리수가 다름." ).append("\n"); 
		query.append("								WHEN (SELECT SUBSTR(LOC_CD, 0, 2) FROM MDM_ORGANIZATION WHERE OFC_CD = A.CRE_OFC_CD) = 'IN'  AND A.CRE_DT >= (SELECT TO_DATE(ATTR_CTNT1, 'YYYYMMDDHH24MI') FROM DMT_HRD_CDG_CTNT WHERE HRD_CDG_ID = 'IDA_TAX_APPL_DT') THEN" ).append("\n"); 
		query.append("									SUBSTR(A.DMDT_INV_NO, 4, 1)" ).append("\n"); 
		query.append("								ELSE" ).append("\n"); 
		query.append("									SUBSTR(A.DMDT_INV_NO, 3, 1)" ).append("\n"); 
		query.append("							END" ).append("\n"); 
		query.append("						) IN ('R', 'T')" ).append("\n"); 
		...
		query.append("				  FROM  DMT_INV_MN A" ).append("\n"); 
		query.append("				 WHERE  1 = 1" ).append("\n"); 
		query.append("				 --AND  'M' = SUBSTR(DMDT_INV_NO,3,1)" ).append("\n"); 
		query.append("				   AND  (" ).append("\n"); 
		query.append("							CASE " ).append("\n"); 
		query.append("								-- INDIA 일 경우, INVOICE NO 자리수가 다름." ).append("\n"); 
		query.append("								WHEN (SELECT SUBSTR(LOC_CD, 0, 2) FROM MDM_ORGANIZATION WHERE OFC_CD = A.CRE_OFC_CD) = 'IN'  AND A.CRE_DT >= (SELECT TO_DATE(ATTR_CTNT1, 'YYYYMMDDHH24MI') FROM DMT_HRD_CDG_CTNT WHERE HRD_CDG_ID = 'IDA_TAX_APPL_DT') THEN" ).append("\n"); 
		...
		query.append("				  FROM  DMT_INV_MN A" ).append("\n"); 
		query.append("				 WHERE  1 = 1" ).append("\n"); 
		query.append("				 --AND  'M' = SUBSTR(A.DMDT_INV_NO,3,1)" ).append("\n"); 
		query.append("				   AND  (" ).append("\n"); 
		query.append("							CASE " ).append("\n"); 
		query.append("								-- INDIA 일 경우, INVOICE NO 자리수가 다름." ).append("\n"); 
		query.append("								WHEN (SELECT SUBSTR(LOC_CD, 0, 2) FROM MDM_ORGANIZATION WHERE OFC_CD = A.CRE_OFC_CD) = 'IN'  AND A.CRE_DT >= (SELECT TO_DATE(ATTR_CTNT1, 'YYYYMMDDHH24MI') FROM DMT_HRD_CDG_CTNT WHERE HRD_CDG_ID = 'IDA_TAX_APPL_DT') THEN" ).append("\n"); 
