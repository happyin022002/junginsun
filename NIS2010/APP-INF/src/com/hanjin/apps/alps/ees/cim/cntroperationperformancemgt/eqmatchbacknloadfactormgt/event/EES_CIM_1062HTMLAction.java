 ...
 * @since J2EE 1.4
 */
public class EES_CIM_1062HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_CIM_1062HTMLAction 객체를 생성
	 */
	public EES_CIM_1062HTMLAction() {}
	
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EesCim1062Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim1062Event event = new EesCim1062Event(); 	 
			
		if(command.isCommand(FormCommand.MULTI)) { 
			event.setSearchOptionByLocationVO((SearchOptionByLocationVO)getVO(request, SearchOptionByLocationVO .class));
			event.setResultByLocationVOS((ResultByLocationVO[])getVOs(request, ResultByLocationVO .class,""));
		}	    
