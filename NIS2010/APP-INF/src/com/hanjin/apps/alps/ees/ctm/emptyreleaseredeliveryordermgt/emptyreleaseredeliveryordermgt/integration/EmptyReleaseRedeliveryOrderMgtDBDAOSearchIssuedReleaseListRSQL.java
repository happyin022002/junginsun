...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchIssuedReleaseListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("         NVL(STK.STK_GATE_IO_CD, 'O') AS BD," ).append("\n"); 
		...
		query.append("			WHEN STK.STK_ISS_CD = 'D' THEN 'EDI : '||TO_CHAR (STK.STK_EVNT_DT, 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		...
		query.append("				AND T1.VSL_CD = STK.VSL_CD" ).append("\n"); 
		query.append("				AND T1.SKD_VOY_NO = STK.SKD_VOY_NO" ).append("\n"); 
		query.append("				AND T1.SKD_DIR_CD = STK.SKD_DIR_CD" ).append("\n"); 
		...
		query.append("         STK.VSL_CD," ).append("\n"); 
		query.append("         STK.SKD_VOY_NO," ).append("\n"); 
		query.append("         STK.SKD_DIR_CD" ).append("\n"); 
