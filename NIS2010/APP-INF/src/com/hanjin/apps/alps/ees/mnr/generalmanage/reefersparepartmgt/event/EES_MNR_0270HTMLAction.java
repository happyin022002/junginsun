...
*@FileName : EES_MNR_0270HTMLAction.java
...
public class EES_MNR_0270HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0270Event event = new EesMnr0270Event();
