...
*@FileName : ChassisMgsetInvoiceDBDAOsearchCHSInvoiceInqListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOsearchCHSInvoiceInqListDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOsearchCHSInvoiceInqListDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOsearchCHSInvoiceInqListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("#if(${in_pgm_no} == 'EES_CGM_1208')" ).append("\n"); 
		query.append("    SELECT " ).append("\n"); 
		query.append("        T1.CHSS_POOL_CD" ).append("\n"); 
		...
		query.append("        CGM_PAY_INV T1, AP_PAY_INV T2, COM_USER T3, MDM_VENDOR T4, CGM_AGREEMENT T5" ).append("\n"); 
		query.append("    WHERE" ).append("\n"); 
		query.append("        T1.EQ_KND_CD = 'Z'" ).append("\n"); 
		...
		query.append("        AND T1.AGMT_OFC_CTY_CD = T5.AGMT_OFC_CTY_CD" ).append("\n"); 
		query.append("        AND T1.AGMT_SEQ = T5.AGMT_SEQ" ).append("\n"); 
		query.append("        AND T1.AGMT_VER_NO = T5.AGMT_VER_NO" ).append("\n"); 
		query.append("        AND T5.AGMT_LSTM_CD = 'ZP'" ).append("\n"); 
		query.append("    #if (${cost_yrmon} == 'cost_month')" ).append("\n"); 
