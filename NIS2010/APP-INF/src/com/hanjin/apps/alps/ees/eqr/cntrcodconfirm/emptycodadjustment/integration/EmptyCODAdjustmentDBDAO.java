 ...
 * - ALPS-COD Confirm system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
...
public class EmptyCODAdjustmentDBDAO extends DBDAOSupport {
	...
	public String insertMTYREPOPlanPORT(String vvd, String lane, String bay, String version, String remark,
		...
		try {
			...
			param2.put("a5_qty", checkStringInteger(emptyCODVVDPortVO.getA5()));
			param2.put("p2_qty", "0");
			param2.put("p4_qty", "0");
			...
			if (flagVLD.equals("D")) {
				...
				param3.put("a5_qty", checkStringInteger(emptyCODVVDPortVO.getA5()));
				param3.put("p2_qty", "0");
				param3.put("p4_qty", "0");
