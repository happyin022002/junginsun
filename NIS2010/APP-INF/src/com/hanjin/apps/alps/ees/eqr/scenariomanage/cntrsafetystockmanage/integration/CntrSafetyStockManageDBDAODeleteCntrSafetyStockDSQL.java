...
*@FileName : CntrSafetyStockManageDBDAODeleteCntrSafetyStockDSQL.java
...
public class CntrSafetyStockManageDBDAODeleteCntrSafetyStockDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 	- EQR_SCNR_ECC_SFT_STK
	  * </pre>
	  */
	public CntrSafetyStockManageDBDAODeleteCntrSafetyStockDSQL(){
		setQuery();
		...
		query.append("FileName : CntrSafetyStockManageDBDAODeleteCntrSafetyStockDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_SCNR_ECC_SFT_STK" ).append("\n"); 
