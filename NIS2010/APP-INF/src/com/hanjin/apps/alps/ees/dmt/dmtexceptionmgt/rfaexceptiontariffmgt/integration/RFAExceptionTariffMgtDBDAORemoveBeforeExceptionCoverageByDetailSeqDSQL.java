...
*@FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageByDetailSeqDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageByDetailSeqDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Before Booking Request 의 선택된 Detail Seq. 에 해당되는 모든 Coverage 정보를 삭제한다.
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageByDetailSeqDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionCoverageByDetailSeqDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
