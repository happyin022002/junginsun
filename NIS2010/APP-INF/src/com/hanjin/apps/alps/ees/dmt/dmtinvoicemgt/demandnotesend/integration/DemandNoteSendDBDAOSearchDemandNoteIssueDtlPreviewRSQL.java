...
public class DemandNoteSendDBDAOSearchDemandNoteIssueDtlPreviewRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("SELECT  B.VSL_CD || B.SKD_VOY_NO || B.SKD_DIR_CD             AS VVD_CD" ).append("\n"); 
		...
		query.append("                      ,'9', R.CNTR_R9_RT_AMT " ).append("\n"); 
		...
		query.append("        AND     NVL(C.BZC_DMDT_DE_TERM_CD, 'N') = R.DMDT_DE_TERM_CD" ).append("\n"); 
