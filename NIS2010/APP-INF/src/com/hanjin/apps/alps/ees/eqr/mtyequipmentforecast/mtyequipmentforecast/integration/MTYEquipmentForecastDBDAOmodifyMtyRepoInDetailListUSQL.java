...
*@FileName : MTYEquipmentForecastDBDAOmodifyMtyRepoInDetailListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOmodifyMtyRepoInDetailListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOmodifyMtyRepoInDetailListUSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOmodifyMtyRepoInDetailListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EQR_MTY_BAL_RPT_DCHG_MNL         " ).append("\n"); 
