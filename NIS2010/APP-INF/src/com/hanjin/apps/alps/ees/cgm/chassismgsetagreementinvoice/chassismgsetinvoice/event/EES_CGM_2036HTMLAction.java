...
*@FileName : EES_CGM_2036HTMLAction.java
...
public class EES_CGM_2036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2036HTMLAction 객체를 생성
	 */
	public EES_CGM_2036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesCgm2036Event event = new EesCgm2036Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMGSInvoiceInquiryINVO((MGSInvoiceInquiryINVO)getVO(request, MGSInvoiceInquiryINVO .class));
