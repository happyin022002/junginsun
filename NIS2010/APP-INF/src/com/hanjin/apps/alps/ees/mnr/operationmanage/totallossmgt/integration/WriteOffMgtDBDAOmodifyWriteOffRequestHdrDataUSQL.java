...
*@FileName : WriteOffMgtDBDAOmodifyWriteOffRequestHdrDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WriteOffMgtDBDAOmodifyWriteOffRequestHdrDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WriteOffMgtDBDAOmodifyWriteOffRequestHdrDataUSQL(){
		setQuery();
		...
		params.put("wrtf_rqst_ofc_cd",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.mnr.operationmanage.totallossmgt.integration ").append("\n"); 
		query.append("FileName : WriteOffMgtDBDAOmodifyWriteOffRequestHdrDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET WRTF_RQST_OFC_CD = @[wrtf_rqst_ofc_cd]," ).append("\n"); 
		query.append("WRTF_RQST_DT = SYSDATE," ).append("\n"); 
		query.append("WRTF_RQST_USR_ID = @[upd_usr_id]," ).append("\n"); 
