...
*@FileName : ChassisMgsetInvoiceDBDAOAddCHSNuPoolChargeMainDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOAddCHSNuPoolChargeMainDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.AddCHSNuPoolChargeMainData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOAddCHSNuPoolChargeMainDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOAddCHSNuPoolChargeMainDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("POOL_MAX_RT_AMT," ).append("\n"); 
		query.append("POOL_MIN_RT_AMT," ).append("\n"); 
