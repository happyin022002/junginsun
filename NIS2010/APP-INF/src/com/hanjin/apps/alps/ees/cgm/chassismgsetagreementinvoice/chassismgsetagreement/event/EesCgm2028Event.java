...
public class EesCgm2028Event extends EventSupport {
	...
	public MGSTermChangeResultINVO[] getMgsTermChangeResultINVOS() {
		return mgsTermChangeResultINVOS;
	}

	public void setMgsTermChangeResultINVOS(
			MGSTermChangeResultINVO[] mgsTermChangeResultINVOS) {
		this.mgsTermChangeResultINVOS = mgsTermChangeResultINVOS;
	}
