...
*@FileName : ChassisMgsetInvoiceDBDAOSearchCHSCpsInvoiceListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchCHSCpsInvoiceListDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchCHSCpsInvoiceListDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchCHSCpsInvoiceListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	ABS(A.INV_CR_SMRY_AMT) AS INV_CR_SMRY_AMT," ).append("\n"); 
		query.append("	A.INV_TAX_SMRY_AMT," ).append("\n"); 
		query.append("	A.INV_SMRY_AMT - A.INV_TAX_SMRY_AMT + ABS(A.INV_CR_SMRY_AMT) AS LSE_CHG_SMRY_AMT" ).append("\n"); 
		...
		query.append("    AND A.CHSS_MGST_INV_KND_CD = 'ZP'" ).append("\n"); 
		query.append("#if(${cost_ofc_cd} != 'SELCON' && ${cost_ofc_cd} != 'NYCRA')" ).append("\n"); 
