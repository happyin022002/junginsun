...
*@FileName : CHSUtilFactorMGTVO.java
*@FileTitle : CHSUtilFactorMGTVO
*Open Issues :
*Change history :
...
public class CHSUtilFactorMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSUtilFactorMGTVO> models = new ArrayList<CHSUtilFactorMGTVO>();
	...
	public CHSUtilFactorMGTVO() {}

	public CHSUtilFactorMGTVO(String ibflag, String pagerows, String locCd, String ydCd, String cntrDryRfIndCd, String eg5PreKntQty, String cnmvStsCd, String cntrPsnStsCd, String chssUsgRto, String updUsrId, String creUsrId) {
	 ...
	 */
	public CHSUtilFactorMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSUtilFactorMGTVO[]
	 */
	public CHSUtilFactorMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSUtilFactorMGTVO model = null;
	...
	public CHSUtilFactorMGTVO[] getCHSUtilFactorMGTVOs(){
		CHSUtilFactorMGTVO[] vos = (CHSUtilFactorMGTVO[])models.toArray(new CHSUtilFactorMGTVO[models.size()]);
		return vos;
	}
