...
*@FileName : CPSCHSSPoolINVO.java
*@FileTitle : CPSCHSSPoolINVO
*Open Issues :
*Change history :
...
public class CPSCHSSPoolINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CPSCHSSPoolINVO> models = new ArrayList<CPSCHSSPoolINVO>();
	...
	/* Column Info */
	private String chkChssPoolCd = null;
	/* Column Info */
	...
	public CPSCHSSPoolINVO() {}

	public CPSCHSSPoolINVO(String ibflag, String pagerows, String chssPoolCd, String chssPoolNm, String vndrSeq, String vndrLglEngNm, String creUsrId, String creDt, String updUsrId, String updDt, String chkChssPoolCd, String chkVndrSeq) {
		this.updDt = updDt;
		...
		this.chkChssPoolCd = chkChssPoolCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("chk_chss_pool_cd", getChkChssPoolCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("chk_chss_pool_cd", "chkChssPoolCd");
	...
	/**
	 * Column Info
	 * @return chkChssPoolCd
	 */
	public String getChkChssPoolCd() {
		return this.chkChssPoolCd;
	}
	 ...
	 * @param chkChssPoolCd
	 */
	public void setChkChssPoolCd(String chkChssPoolCd) {
		this.chkChssPoolCd = chkChssPoolCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setChssPoolNm(JSPUtil.getParameter(request, prefix + "chss_pool_nm", ""));
		setChkChssPoolCd(JSPUtil.getParameter(request, prefix + "chk_chss_pool_cd", ""));
	 ...
	 */
	public CPSCHSSPoolINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CPSCHSSPoolINVO[]
	 */
	public CPSCHSSPoolINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CPSCHSSPoolINVO model = null;
		...
		try {
			...
			String[] chkChssPoolCd = (JSPUtil.getParameter(request, prefix	+ "chk_chss_pool_cd", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new CPSCHSSPoolINVO();
				if (updDt[i] != null)
				...
				if (chkChssPoolCd[i] != null)
					model.setChkChssPoolCd(chkChssPoolCd[i]);
				if (updUsrId[i] != null)
	...
	public CPSCHSSPoolINVO[] getCPSCHSSPoolINVOs(){
		CPSCHSSPoolINVO[] vos = (CPSCHSSPoolINVO[])models.toArray(new CPSCHSSPoolINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.chkChssPoolCd = this.chkChssPoolCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
