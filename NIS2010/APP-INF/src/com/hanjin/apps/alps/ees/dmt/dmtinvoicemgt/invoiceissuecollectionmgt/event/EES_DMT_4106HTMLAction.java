...
*@FileName : EES_DMT_4106HTMLAction.java
...
public class EES_DMT_4106HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_4106HTMLAction 객체를 생성
	 */
	public EES_DMT_4106HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt4106Event event = new EesDmt4106Event();
		
		log.debug("\n::CALL::> EES_DMT_4106HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.MULTI)){
			event.setCancelInvoiceParamVO((CancelInvoiceParamVO)getVO(request, CancelInvoiceParamVO.class));
		}
		return  event;
	}
