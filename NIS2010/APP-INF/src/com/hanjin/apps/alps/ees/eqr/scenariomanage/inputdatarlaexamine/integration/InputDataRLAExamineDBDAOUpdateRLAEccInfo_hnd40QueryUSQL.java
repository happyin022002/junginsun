...
*@FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd40QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd40QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC  테이블에 대한 HDL 40feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd40QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd40QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
