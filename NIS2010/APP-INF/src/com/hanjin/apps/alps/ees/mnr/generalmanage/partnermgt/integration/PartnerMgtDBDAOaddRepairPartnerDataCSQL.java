...
*@FileName : PartnerMgtDBDAOaddRepairPartnerDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerMgtDBDAOaddRepairPartnerDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RepairPartner add	한다.
	  * </pre>
	  */
	public PartnerMgtDBDAOaddRepairPartnerDataCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : PartnerMgtDBDAOaddRepairPartnerDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}