...
*@FileName : MTYEquipmentForecastDBDAOsearchMtyBalanceDischargedListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOsearchMtyBalanceDischargedListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOsearchMtyBalanceDischargedListRSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOsearchMtyBalanceDischargedListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        WHERE A.ETD_DT BETWEEN TO_DATE(@[wk_st_dt], 'YYYY/MM/DD') AND TO_DATE((SELECT TO_CHAR(NEXT_DAY(SYSDATE, 2)-7, 'YYYY/MM/DD') FROM DUAL), 'YYYY/MM/DD')+0.99999  -- LCC별 시작일부터 이번주 월요일까지                        " ).append("\n"); 
