...
*@FileName : DodValidationDBDAOcheckBkgNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodValidationDBDAOcheckBkgNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodValidationDBDAOcheckBkgNoRSQL(){
		setQuery();
		...
		query.append("FileName : DodValidationDBDAOcheckBkgNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE BKG_NO = @[s_value]" ).append("\n"); 
