...
*@FileName : EES_EQR_7003HTMLAction.java
 ...
 *
 * @author dev098
 * @see EesEqr7003Event 참조
 * @since J2EE 1.6
 */
public class EES_EQR_7003HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * EES_EQR_1049HTMLAction 객체를 생성
     */
    public EES_EQR_7003HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesEqr7003Event event = new EesEqr7003Event();
