...
*@FileName : EES_LSE_0046HTMLAction.java
...
public class EES_LSE_0046HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0046HTMLAction 객체를 생성
	 */
	public EES_LSE_0046HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0046Event event = new EesLse0046Event();

		if ( command.isCommand(FormCommand.SEARCH) ) {
			event.setOffHirePlanSearchVO((OffHirePlanSearchVO)getVO(request, OffHirePlanSearchVO.class));
		} else if ( command.isCommand(FormCommand.MULTI) ) {
			event.setOffHirePlanSearchVO((OffHirePlanSearchVO)getVO(request, OffHirePlanSearchVO.class));
			event.setOffHirePlanRccVOs((OffHirePlanRccVO[])getVOs(request, OffHirePlanRccVO.class, "sheet1_"));
		}
