...
public class SurplusAreaDBDAOSearchPortSurplusAreaRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append(", CASE WHEN NVL(A.A5_B_$key,'N')<>'Y' AND A.CODE IN ('INP','RD','RI','OH','DI','SI','INM','OP','RL','RO','OT','DO','SO','FBB')" ).append("\n"); 
		query.append("       THEN CEIL((" ).append("\n"); 
		query.append("    #foreach( $key in ${arrweek1})" ).append("\n"); 
		query.append("        #if($velocityCount > 1 )" ).append("\n"); 
		query.append("                         +" ).append("\n"); 
		...
		query.append("    #end    " ).append("\n"); 
		query.append("                                 )/3) ELSE A.A5_$key END A5_$key" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#foreach( $key in ${arrweek2}) -- 현재,미래3주 " ).append("\n"); 
		...
		query.append(",CASE WHEN R.CNTR_TPSZ_CD||R.FCAST_YRWK='A5$key' THEN MAX(NVL(R.MNL_INP,'')) ELSE '' END A5_B_$key" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#foreach($key in ${arrweek})-- 전체 7주" ).append("\n"); 
		...
		query.append(",CASE WHEN R.CNTR_TPSZ_CD||R.FCAST_YRWK='A5$key' THEN SUM(NVL(R.QTY,0)) ELSE 0 END A5_$key" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("    SELECT " ).append("\n"); 
