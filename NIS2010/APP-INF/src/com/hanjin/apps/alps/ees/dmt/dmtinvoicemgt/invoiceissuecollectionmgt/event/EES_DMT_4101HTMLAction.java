...
*@FileName : EES_DMT_4101HTMLAction.java
*@FileTitle : Remark(s)
*Open Issues :
*Change history :
...
public class EES_DMT_4101HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt4101Event event = new EesDmt4101Event();
        

        if(command.isCommand(FormCommand.SEARCH)) {
            event.setSheetSetSearchOptionVO((SheetSetSearchOptionVO)getVO(request, SheetSetSearchOptionVO .class));
