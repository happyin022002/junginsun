...
public class AvailableOffHireDBDAOAvailableOffHireContainerDetailCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        -- As-Is 요청한 사용자의 Office가 위치한 RCC와 현재 장비가 위치한 RCC를 비교할 경우, RCC가 서로 다를 경우 업무 처리를 할 수 없는 경우 발생." ).append("\n"); 
		query.append("        -- 요청한 Change Office별 Off-Hire 승인 업무 처리 (2012.09.18 HJS 정필성 차장)" ).append("\n"); 
