...
*@FileName : EES_CIM_0008HTMLAction.java
...
public class EES_CIM_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0008HTMLAction 객체를 생성
	 */
	public EES_CIM_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0008Event event = new EesCim0008Event();
		

		event.setInvtSmryVO((InvtSmryVO)getVO(request, InvtSmryVO .class));
		...
		String eqr_loc_type_code = request.getParameter("eqr_loc_type_code");
		String eqr_loc_cd = request.getParameter("eqr_loc_cd");
		event.setAttribute("eqr_loc_type_code", eqr_loc_type_code);
		event.setAttribute("eqr_loc_cd", eqr_loc_cd);
