...
*@FileName 		: EES_CGM_1155HTMLAction.java
...
public class EES_CGM_1155HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1155HTMLAction 객체를 생성
	 */
	public EES_CGM_1155HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1155Event event = new EesCgm1155Event();

		event.setChsPoolSCCReportINVO((CHSPoolSCCReportINVO)getVO(request, CHSPoolSCCReportINVO.class));
