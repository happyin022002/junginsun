...
public class MTYRepositionPerformanceAnalysisDBDAOMTYCNTRPERFInDetailVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("WITH MVMT AS(" ).append("\n"); 
		...
		query.append("        (SELECT M.CRNT_VSL_CD||M.CRNT_SKD_VOY_NO||M.CRNT_SKD_DIR_CD" ).append("\n"); 
		...
		query.append("(SELECT   /*+ INDEX_DESC ( MM XFN1CTM_MOVEMENT ) */ " ).append("\n"); 
		query.append("          REPLACE(SUBSTR(CC.CUST_NM,1,50),CHR(13)||CHR(10),' ')" ).append("\n"); 
		...
		query.append("        C.CNTR_HNGR_BAR_ATCH_KNT AS HNGRBARKNT," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${mtymvmt} != 'MTOPOP-MT')" ).append("\n"); 
		query.append("		B.RCV_TERM_CD AS rcvterm," ).append("\n"); 
		query.append("		B.DE_TERM_CD AS determ" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("		'' AS rcvterm," ).append("\n"); 
		query.append("		'' AS determ" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("		,(SELECT C.VNDR_SEQ" ).append("\n"); 
		query.append("		  FROM MDM_VENDOR C" ).append("\n"); 
		query.append("		  WHERE M.VNDR_SEQ = C.VNDR_SEQ(+)" ).append("\n"); 
		...
		query.append(" FROM MVMT A, BKG_VVD PRE, BKG_VVD PST" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("  AND A.bkgNo = PRE.BKG_NO(+)" ).append("\n"); 
		query.append("  AND 'S' = PRE.VSL_PRE_PST_CD(+)					" ).append("\n"); 
		query.append("  AND A.PRE_RLY_PORT_CD= PRE.POD_CD(+)					" ).append("\n"); 
		query.append("  AND A.bkgNo = PST.BKG_NO(+)					" ).append("\n"); 
		query.append("  AND A.PST_RLY_PORT_CD= PST.POL_CD(+)					" ).append("\n"); 
		...
		query.append("                TO_CHAR(MM.CNMV_EVNT_DT,'YYYY-MM-DD HH24:MI')  /*  PRE_MVMT_EVNT_DT */" ).append("\n"); 
		query.append("           FROM CTM_MOVEMENT MM" ).append("\n"); 
		query.append("          WHERE MM.CNTR_NO = A.CNTRNO" ).append("\n"); 
		query.append("            AND MM.CNMV_YR || TO_CHAR(MM.CNMV_SEQ, '0000') ||MM.CNMV_SPLIT_NO <" ).append("\n"); 
		...
		query.append("               M.CNTR_NO AS cntrNo," ).append("\n"); 
		query.append("               M.CNTR_TPSZ_CD AS tpsz," ).append("\n"); 
		query.append("               'VD-MT-VL' AS mvmt, " ).append("\n"); 
		query.append("               M.ORG_YD_CD AS yard ," ).append("\n"); 
		query.append("               TO_CHAR(M.CNMV_EVNT_DT,'YYYY-MM-DD HH24:MI') AS POST_EVENTDATE," ).append("\n"); 
		query.append("               M.MVMT_CRE_TP_CD AS autoFlag," ).append("\n"); 
		query.append("               B.SLAN_CD AS lane," ).append("\n"); 
		...
		query.append("                TO_CHAR(MM.CNMV_EVNT_DT,'YYYY-MM-DD HH24:MI')  /*  PRE_MVMT_EVNT_DT */" ).append("\n"); 
		query.append("           FROM CTM_MOVEMENT MM" ).append("\n"); 
		query.append("          WHERE MM.CNTR_NO = AAA.CNTRNO" ).append("\n"); 
		query.append("            AND MM.CNMV_YR || TO_CHAR(MM.CNMV_SEQ, '0000') ||MM.CNMV_SPLIT_NO <" ).append("\n"); 
		...
		query.append("                       MM.CNMV_YR  " ).append("\n"); 
		query.append("                 FROM CTM_MOVEMENT MM" ).append("\n"); 
		query.append("			    WHERE MM.CNTR_NO = AA.CNTRNO  " ).append("\n"); 
		query.append("				  AND MM.CNMV_YR || TO_CHAR(MM.CNMV_SEQ, '0000') ||MM.CNMV_SPLIT_NO <         " ).append("\n"); 
		...
		query.append("				WHERE MM.CNTR_NO = AA.CNTRNO  " ).append("\n"); 
		query.append("				  AND MM.CNMV_YR || TO_CHAR(MM.CNMV_SEQ, '0000') ||MM.CNMV_SPLIT_NO <         " ).append("\n"); 
		query.append("					  AA.PRE_CNMV_YR||TO_CHAR(AA.PRE_CNMV_SEQ,'0000')||AA.PRE_CNMV_SPLIT_NO" ).append("\n"); 
		query.append("                  AND ROWNUM = 1     " ).append("\n"); 
		...
		query.append("                              M.CNTR_NO AS cntrNo," ).append("\n"); 
		query.append("                              M.CNTR_TPSZ_CD AS tpsz," ).append("\n"); 
		query.append("                              'VD-MT-(TN or EN)-MT-VL' AS mvmt, " ).append("\n"); 
		query.append("                              M.ORG_YD_CD AS yard ," ).append("\n"); 
		query.append("                              TO_CHAR(M.CNMV_EVNT_DT,'YYYY-MM-DD HH24:MI') AS POST_EVENTDATE," ).append("\n"); 
		query.append("                              M.MVMT_CRE_TP_CD AS autoFlag," ).append("\n"); 
		query.append("                              B.SLAN_CD AS lane," ).append("\n"); 
		...
		query.append("         HNGRBARKNT," ).append("\n"); 
		query.append("		 SC_RFA_NO_TAA," ).append("\n"); 
		query.append("		 SHPR," ).append("\n"); 
		query.append(" 		 CNEE," ).append("\n"); 
		query.append("		 RCVTERM," ).append("\n"); 
		query.append("		 DETERM," ).append("\n"); 
		query.append("         VNDR_SEQ," ).append("\n"); 
		query.append("         VNDR_ABBR_NM," ).append("\n"); 
		...
		query.append("#elseif(${inquiryLevel} == 'R')" ).append("\n"); 
		query.append("                           AND G.RCC_CD = @[location]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("                        )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("      )" ).append("\n"); 
		...
		query.append("          M.CNTR_NO AS CNTRNO," ).append("\n"); 
		query.append("          M.CNTR_TPSZ_CD AS TPSZ," ).append("\n"); 
		query.append("          'MO' AS MVMT," ).append("\n"); 
		query.append("          M.ORG_YD_CD AS YARD ," ).append("\n"); 
		query.append("          M.CNMV_EVNT_DT AS EVENTDATE," ).append("\n"); 
		query.append("          M.MVMT_CRE_TP_CD AS AUTOFLAG," ).append("\n"); 
		query.append("          B.SLAN_CD AS LANE," ).append("\n"); 
		...
		query.append("          /* ----------------> 2014.05.08 by Chang Young Kim (AA Young Du Lee) : VVD Type & Name Condition Add (E) */" ).append("\n"); 
		query.append("          M.BKG_NO AS BKGNO," ).append("\n"); 
		query.append("          B.POR_CD as POR,  " ).append("\n"); 
		query.append("          B.POL_CD AS POL," ).append("\n"); 
		query.append("          B.POD_CD AS POD," ).append("\n"); 
		query.append("          B.DEL_CD AS DEL," ).append("\n"); 
		query.append("          B.PRE_RLY_PORT_CD," ).append("\n"); 
		query.append("          B.PST_RLY_PORT_CD,  " ).append("\n"); 
		query.append("          M.CNTR_DMG_FLG AS DAMAGE," ).append("\n"); 
		query.append("          M.CNTR_DISP_FLG AS DISPOSAL," ).append("\n"); 
