...
*@FileName : EES_CIM_0002HTMLAction.java
...
public class EES_CIM_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0001HTMLAction 객체를 생성
	 */
	public EES_CIM_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EesCim0002Event event = new EesCim0002Event();
