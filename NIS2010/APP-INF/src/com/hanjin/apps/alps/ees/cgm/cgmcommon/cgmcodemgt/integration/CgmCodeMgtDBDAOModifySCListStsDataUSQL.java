...
*@FileName : CgmCodeMgtDBDAOModifySCListStsDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOModifySCListStsDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	  * 2014-04-04 by Jonghee HAN CSR Ticket : CHM-201429628, Title : Pricing-S/C Creation and Amendation 시, Amend Button 활성화 요청 - Amend 완료후 최종 입력된 Effective Date(Filed Date), Expire Date에 맞게  Chassis S/C Exception List 의 Date를 변경하는 로직 (신규)
	  * -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	  * </pre>
	  */
	public CgmCodeMgtDBDAOModifySCListStsDataUSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOModifySCListStsDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE	CGM_SC_EXPT_LIST A" ).append("\n"); 
