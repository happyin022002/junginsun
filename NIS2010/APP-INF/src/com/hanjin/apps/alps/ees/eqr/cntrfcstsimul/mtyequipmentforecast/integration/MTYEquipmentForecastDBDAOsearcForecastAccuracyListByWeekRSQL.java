...
public class MTYEquipmentForecastDBDAOsearcForecastAccuracyListByWeekRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                               FROM DUAL CONNECT BY LEVEL <= 18" ).append("\n"); 
		...
		query.append("					#else" ).append("\n"); 
		query.append("                    WHERE  A.CNTR_TPSZ_CD IN('D2','D4','D5','D7','R2','R5','R9','O2','S2','O4','S4','F2','A2','F4','A4','A5','F5','O5','DX')" ).append("\n"); 
		query.append("					#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("					 					   #else" ).append("\n"); 
		query.append("										   AND  C.CNTR_TPSZ_CD IN('D2','D4','D5','D7','R2','R5','R9','O2','S2','O4','S4','F2','A2','F4','A4','A5','F5','O5','DX')" ).append("\n"); 
		query.append("										   #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	   ,(CASE WHEN A.DP_SEQ||A.LOC_CD = '4ZZZZ9' OR  A.DP_SEQ||A.YRWK = '4999999' THEN DECODE(B.A5_QTY,0,100, (C.A5_QTY/B.A5_QTY)*100)" ).append("\n"); 
		query.append("			  ELSE (CASE WHEN A.DP_SEQ||B.A5_QTY+C.A5_QTY = '40' THEN NULL" ).append("\n"); 
		query.append("															     ELSE A.A5_QTY" ).append("\n"); 
		query.append("				    END)" ).append("\n"); 
		...
		query.append("	   ,(CASE WHEN A.DP_SEQ||A.LOC_CD = '4ZZZZ9' OR  A.DP_SEQ||A.YRWK = '4999999' THEN DECODE(B.DX_QTY,0,100, (C.DX_QTY/B.DX_QTY)*100)" ).append("\n"); 
		query.append("			  ELSE (CASE WHEN A.DP_SEQ||B.DX_QTY+C.DX_QTY = '40' THEN NULL" ).append("\n"); 
		query.append("															     ELSE A.DX_QTY" ).append("\n"); 
		query.append("				    END)" ).append("\n"); 
		query.append("		 END) AS DX_QTY" ).append("\n"); 
		query.append("FROM LV_QTY_LIST A" ).append("\n"); 
		query.append("   , LV_QTY_LIST B " ).append("\n"); 
		query.append("   , LV_QTY_LIST C " ).append("\n"); 
		...
		query.append("       ,DECODE(A.DP_SEQ,2,LTRIM(TO_CHAR(A.A5_QTY,'999,999,999,999')),3,LTRIM(TO_CHAR(A.A5_QTY,'999,999,999,999')),4,DECODE(A.A5_QTY,NULL,'',LTRIM(TO_CHAR(ROUND(A.A5_QTY,1),'999,999,990.9'))||'%'),LTRIM(TO_CHAR(A.A5_QTY,'999,999,999,999'))) A5_QTY" ).append("\n"); 
		...
		query.append("       ,DECODE(A.DP_SEQ,2,LTRIM(TO_CHAR(A.DX_QTY,'999,999,999,999')),3,LTRIM(TO_CHAR(A.DX_QTY,'999,999,999,999')),4,DECODE(A.DX_QTY,NULL,'',LTRIM(TO_CHAR(ROUND(A.DX_QTY,1),'999,999,990.9'))||'%'),LTRIM(TO_CHAR(A.DX_QTY,'999,999,999,999'))) DX_QTY" ).append("\n"); 
		...
		query.append("       	  ,'0' QTY22" ).append("\n"); 
		query.append("          ,'0' QTY23" ).append("\n"); 
		query.append("       	  ,'0' QTY24" ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("        SELECT A.BOUND" ).append("\n"); 
		query.append("              ,A.LOC_CD" ).append("\n"); 
