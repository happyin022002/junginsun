...
*@FileName : EES_MNR_0098HTMLAction.java
...
public class EES_MNR_0098HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0098HTMLAction 객체를 생성
	 */
	public EES_MNR_0098HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0098Event event = new EesMnr0098Event();
