...
*@FileName : EesEqr1051ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EesEqr1051ViewAdapter extends ViewAdapter {
...
//		EesEqr1051ConditionVO conditionVO = (EesEqr1051ConditionVO) commonRsVO.getConditionVO();
		...
		try{
			while ( rs.next() ){
				...
				for( int j=1; j<=colCnt; j++ ){			
					sbufXML.append("<TD><![CDATA[" + getNull(rs.getString(j))+ "]]></TD>");
				}
