...
*@FileName : LongstayingUnclaimEQFlaggingDBDAOSrchCondByOfcCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LongstayingUnclaimEQFlaggingDBDAOSrchCondByOfcCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LongstayingUnclaimEQFlaggingDBDAOSrchCondByOfcCdRSQL(){
		setQuery();
		...
		query.append("FileName : LongstayingUnclaimEQFlaggingDBDAOSrchCondByOfcCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND O.OFC_CD = @[ofc_cd]   -- 로긴 OFFICE CODE" ).append("\n"); 
