...
*@FileName : EES_MNR_0113HTMLAction.java
 ...
 * @see EesMnr0113Event 참조
 * @since J2EE 1.6           
 */

public class EES_MNR_0113HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 8965860574617993296L;

	/**
	 * EES_MNR_0113HTMLAction 객체를 생성
	 */	
	public EES_MNR_0113HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0113Event event = new EesMnr0113Event();

		//조회 
		if(command.isCommand(FormCommand.SEARCH)) {  
			event.setHangerInventoryListINVO((HangerInventoryListINVO)getVO(request, HangerInventoryListINVO .class));
		}     
		//저장
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomNewHangerInventoryListVOs((CustomNewHangerInventoryListVO[])getVOs(request, CustomNewHangerInventoryListVO .class,""));
		}    
