...
*@FileName : DemDetTariffMgtDBDAORemoveTariffGroupDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAORemoveTariffGroupDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAORemoveTariffGroupDSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAORemoveTariffGroupDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_TRF_GRP" ).append("\n"); 
