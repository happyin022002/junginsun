...
*@FileName : ChassisMgsetAgreementDBDAOModifyMGSAgreementMainDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAOModifyMGSAgreementMainDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.ModifyMGSAgreementMainData
	  * -- 2014.11 10만불 결제관련 
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAOModifyMGSAgreementMainDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAOModifyMGSAgreementMainDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
