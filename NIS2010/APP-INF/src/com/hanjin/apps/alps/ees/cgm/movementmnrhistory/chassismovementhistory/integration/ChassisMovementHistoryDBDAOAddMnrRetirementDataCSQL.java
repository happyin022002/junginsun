...
*@FileName : ChassisMovementHistoryDBDAOAddMnrRetirementDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMovementHistoryDBDAOAddMnrRetirementDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMovementHistoryDBDAOAddMnrRetirementDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMovementHistoryDBDAOAddMnrRetirementDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",(SELECT DECODE(MAX(SYS_SEQ)+1,NULL,1,MAX(SYS_SEQ)+1) FROM CGM_CHSS_MVMT_HIS WHERE CHSS_NO= @[chss_no] )" ).append("\n"); 
