...
*@FileName : InvoiceIssueCollectionMgtDBDAOModifyInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOModifyInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOModifyInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOModifyInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET  TAX_RTO       = @[tax_rto]" ).append("\n"); 
		...
		query.append("       ,CUST_CNTC_PNT_SEQ     = @[cust_cntc_pnt_seq]" ).append("\n"); 
