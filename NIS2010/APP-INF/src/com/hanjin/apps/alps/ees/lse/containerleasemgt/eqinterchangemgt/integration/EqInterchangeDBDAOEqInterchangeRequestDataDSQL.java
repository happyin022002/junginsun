...
*@FileName : EqInterchangeDBDAOEqInterchangeRequestDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EqInterchangeDBDAOEqInterchangeRequestDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EqInterchangeDBDAOEqInterchangeRequestDataDSQL(){
		setQuery();
		...
		query.append("FileName : EqInterchangeDBDAOEqInterchangeRequestDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM LSE_EQ_ITCHG_RQST" ).append("\n"); 
