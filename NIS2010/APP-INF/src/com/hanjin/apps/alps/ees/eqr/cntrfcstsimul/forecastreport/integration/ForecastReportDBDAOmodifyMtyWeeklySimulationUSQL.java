...
*@FileName : ForecastReportDBDAOmodifyMtyWeeklySimulationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOmodifyMtyWeeklySimulationUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ForecastReportDBDAOmodifyMtyWeeklySimulationUSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOmodifyMtyWeeklySimulationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("UPDATE EQR_CTRL_MTY_WKY_SIM" ).append("\n"); 
