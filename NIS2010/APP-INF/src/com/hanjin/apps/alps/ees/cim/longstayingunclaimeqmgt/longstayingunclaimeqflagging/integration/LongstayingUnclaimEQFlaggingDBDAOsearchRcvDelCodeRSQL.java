...
*@FileName : LongstayingUnclaimEQFlaggingDBDAOsearchRcvDelCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LongstayingUnclaimEQFlaggingDBDAOsearchRcvDelCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LongstayingUnclaimEQFlaggingDBDAOsearchRcvDelCodeRSQL(){
		setQuery();
		...
		query.append("FileName : LongstayingUnclaimEQFlaggingDBDAOsearchRcvDelCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE INTG_CD_ID = @[code_flg]" ).append("\n"); 
