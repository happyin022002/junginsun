...
public class AgreementRegistrationVO {
	...
	/** Lease Agreement AGMT Attach Tab Value Object Search Data 처리 */
	private List<AgreementFileUploadVO> agreementFileUploadVOs = null;
	...
	/** Lease Agreement Pic Tab Value Object Multi Data 처리 */
	private AgreementFileUploadVO[] agreementFileUpldVOs = null;
	...
	/**
	 * @param agreementFileUploadVOs the agreementFileUploadVOs to set
	 */
	public void setAgreementFileUploadVOs(List<AgreementFileUploadVO> agreementFileUploadVOs) {
		this.agreementFileUploadVOs = agreementFileUploadVOs;
	}

	/**
	 * @return the agreementFileUploadVOs
	 */
	public List<AgreementFileUploadVO> getAgreementFileUploadVOs() {
		return agreementFileUploadVOs;
	}	

	/**
	 * @param agreementFileUploadVOs the agreementFileUploadVOs to set
	 */
	public void setAgreementFileUploadVO(AgreementFileUploadVO[] agreementFileUpldVOs) {
		this.agreementFileUpldVOs = agreementFileUpldVOs;
	}

	/**
	 * @return the agreementFileUploadVOs
	 */
	public AgreementFileUploadVO[] getAgreementFileUploadVO() {
		return agreementFileUpldVOs;
	}		
}