...
*@FileName 		: EES_CGM_1156HTMLAction.java
...
public class EES_CGM_1156HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1155HTMLAction 객체를 생성
	 */
	public EES_CGM_1156HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EesCgm1156Event event = new EesCgm1156Event();
		
		event.setChsSCNOReportINVO((CHSSCNOReportINVO)getVO(request, CHSSCNOReportINVO.class));
