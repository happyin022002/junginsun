...
*@FileName : CntrPlanGuidelineManageDBDAODelDischargingValueGuidelineDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAODelDischargingValueGuidelineDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete DischargingValueGuideline
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAODelDischargingValueGuidelineDSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAODelDischargingValueGuidelineDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE EQR_CTRL_DCHG_GLINE_VAL" ).append("\n"); 
