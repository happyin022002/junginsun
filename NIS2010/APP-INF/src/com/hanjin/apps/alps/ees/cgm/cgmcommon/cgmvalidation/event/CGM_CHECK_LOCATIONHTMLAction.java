...
*@FileName : CHECK_LOCATIONHTMLAction.java
...
public class CGM_CHECK_LOCATIONHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CHECK_LOCATIONHTMLAction 객체를 생성
	 */
	public CGM_CHECK_LOCATIONHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CgmCheckLocationEvent event = new CgmCheckLocationEvent();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setLocationMGTVO((LocationMGTVO)getVO(request, LocationMGTVO .class));
