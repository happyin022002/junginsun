...
*@FileName : CHSOnHireINVO.java
*@FileTitle : CHSOnHireINVO
*Open Issues :
*Change history :
...
public class CHSOnHireINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSOnHireINVO> models = new ArrayList<CHSOnHireINVO>();
	 ...
	 */
	public CHSOnHireINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSOnHireINVO[]
	 */
	public CHSOnHireINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSOnHireINVO model = null;
	 ...
	 * @return CHSOnHireINVO[]
	 */
	public CHSOnHireINVO[] getCHSOnHireINVOs(){
		CHSOnHireINVO[] vos = (CHSOnHireINVO[])models.toArray(new CHSOnHireINVO[models.size()]);
		return vos;
	}
