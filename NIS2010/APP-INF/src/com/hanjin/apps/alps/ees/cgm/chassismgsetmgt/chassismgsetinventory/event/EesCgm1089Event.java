...
public class EesCgm1089Event extends EventSupport {
	...
	public CHSInventoryGeneralINVO[] getChsInventoryGeneralINVOS() {
		return chsInventoryGeneralINVOS;
	}

	public void setChsInventoryGeneralINVOS(
			CHSInventoryGeneralINVO[] chsInventoryGeneralINVOS) {
		this.chsInventoryGeneralINVOS = chsInventoryGeneralINVOS;
	}
