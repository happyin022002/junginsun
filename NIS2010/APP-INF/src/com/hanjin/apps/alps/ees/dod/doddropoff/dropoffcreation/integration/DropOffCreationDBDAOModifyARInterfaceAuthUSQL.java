...
*@FileName : DropOffCreationDBDAOModifyARInterfaceAuthUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DropOffCreationDBDAOModifyARInterfaceAuthUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AR Interface 전송을 완료하고 DOD_DRP_OFF_CHG 테이블의 AUTH_APRO_RQST_NO컬럼값을 업데이트한다.
	  * </pre>
	  */
	public DropOffCreationDBDAOModifyARInterfaceAuthUSQL(){
		setQuery();
		...
		query.append("FileName : DropOffCreationDBDAOModifyARInterfaceAuthUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET AUTH_APRO_RQST_NO = @[auth_apro_rqst_no]" ).append("\n"); 
