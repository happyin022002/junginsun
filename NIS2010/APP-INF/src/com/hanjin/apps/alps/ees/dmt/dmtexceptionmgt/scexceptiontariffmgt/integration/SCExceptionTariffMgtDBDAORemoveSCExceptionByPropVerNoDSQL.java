...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionByPropVerNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionByPropVerNoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Prop No. 와 Ver No. 에 해당되는 S/C Exception Group 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionByPropVerNoDSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionByPropVerNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
