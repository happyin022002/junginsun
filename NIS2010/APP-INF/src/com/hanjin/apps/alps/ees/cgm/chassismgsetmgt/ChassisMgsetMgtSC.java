...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.ees.cgm.chassismgsetmgt;
...
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.basic.ChassisMgsetInventoryBC;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.basic.ChassisMgsetInventoryBCImpl;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1089Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1091Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1092Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1094Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1098Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1100Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1102Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1103Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1111Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1112Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1113Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1114Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1115Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1153Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm1154Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2075Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2076Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2077Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2078Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2079Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2084Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2209Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2210Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2213Event;
...
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1001Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1002Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1003Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1005Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1006Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1007Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1008Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1009Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1010Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1016Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1017Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1018Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1019Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1146Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1151Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1152Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2001Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2004Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2006Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2007Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2011Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2012Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2018Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2019Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2020Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2083Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2211Event;
import com.hanjin.apps.alps.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2212Event;
...
public class ChassisMgsetMgtSC extends ServiceCommandSupport {
	 ...
	 */
	public void doEnd() {
		log.debug("ChassisMgsetMgtSC 종료");
	}
	...
	public EventResponse perform(Event e) throws EventException {
		try
		{
			...
			}else if (e.getEventName().equalsIgnoreCase("EesCgm2075Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchMGSInventoryDetailService(e);
				}
				else if (e.getFormCommand().isCommand(FormCommand.DEFAULT)) {
					eventResponse = searchEesCgm2075DefaultService(e);
				}
			...
			}else if (e.getEventName().equalsIgnoreCase("EesCgm1151Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchCHSOffHireReportbyMonthSummaryService(e);
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm1152Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchCHSOnHireReportbyMonthSummaryService(e);
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm1153Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchCHSAssetsSmryListService(e);
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm1154Event")){		
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
					eventResponse = searchCHSAssetsDetailListService(e);				
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm2209Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchMGSAssetsSmryListService(e);
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm2210Event")){		
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
					eventResponse = searchMGSAssetsDetailListService(e);				
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm2211Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchMGSOffHireReportbyMonthSummaryService(e);
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm2212Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){
					eventResponse = searchMGSOnHireReportbyMonthSummaryService(e);
				}
			}else if (e.getEventName().equalsIgnoreCase("EesCgm2213Event")) {
				if (e.getFormCommand().isCommand(FormCommand.SEARCH)){   // 조회
					eventResponse = searchBareMGSetService(e);
				}else if (e.getFormCommand().isCommand(FormCommand.COMMAND01)){  // MGSET NO 유효성 검사
					eventResponse = searchMGSetNoService(e);
				}else if (e.getFormCommand().isCommand(FormCommand.COMMAND02)){ // MGSET 의 타입 검색
					eventResponse = searchEqTpszCdService(e);
				}else if (e.getFormCommand().isCommand(FormCommand.COMMAND03)){ // Container no 유효성 검사 
					eventResponse = checkBareMGSetContNoData(e);
				}else if (e.getFormCommand().isCommand(FormCommand.COMMAND04)){  // CLG 타입의 MVMT, DAY 검사
					eventResponse = searchBareMGSetCLGData(e);
				}else if (e.getFormCommand().isCommand(FormCommand.COMMAND05)){  // CHASSIS NO 유효성 검사
					eventResponse = checkBareMGSetChsNoData(e);
				}else if (e.getFormCommand().isCommand(FormCommand.COMMAND06)){  // UMG 타입의 MVMT, DAY 검사
					eventResponse = searchBareMGSetUMGData(e);
				}else if (e.getFormCommand().isCommand(FormCommand.MULTI01)){  // 입력,수정,삭제
					eventResponse = multiMGSetDefaultData(e);
				}
			}
	 ...
	 * chassis 및 M.G.Set 장비의 Type Size List 를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 ...
	 * Eq Type size 정보를 생성 및 수정, 삭제 처리한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	...
	/**
	 * [EES_CGM_1001] : [Retrieve] <br>
	 * chassis 및 M.G.Set 장비의 Type Size를 가진 장비가 있는지(CGM_EQUIPMENT) 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * chassis의 Eq spec 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1002] : [Retrieve] <br>
	 * chassis의 Eq spec 에 해당하는 장비들이 있는지 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * chassis의 Eq spec 정보를 생성 및 수정한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * chassis의 Eq spec 정보를 삭제한다. Remove <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * Eq Master 기본 정보를 조회한다. EQ No(change) <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			CHSEqOffHireMGTVO chsEquipmentMGTVO = command.searchCHSOffhireInfoBasic(event.getChsEquipmentINVO());
	 ...
	 *  Eq Off-hire 수행에 필요한 Verify <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  장비 반납(Eq Offhire) 수행한다. Off-Hire Confim <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("XXXXXXXXX").getUserMessage());
	 ...
	 *  Eq Master 기본 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  Eq Off-hire 수행에 필요한 Verify 처리. <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  장비 반납(Eq Offhire) 수행한다. Off-Hire Confirm <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("XXXXXXXXX").getUserMessage());
	 ...
	 * M.G.Set 장비의 Eq spec 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_2001] : [Retrieve] <br>
	 * M.G.Set 장비의 Eq spec 정보가 중복되지는 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * M.G.Set 장비의 Eq spec 정보를 생성 및 수정한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * M.G.Set 장비의 Eq spec 정보를 삭제한다. Remove <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 *  Eq On-hire, Off-hire 내역을 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Chassis 의 Registration 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1006] : [Retrieve] <br>
	 * 서버에 중복된 Alias No 존재 여부 조회. Retrieve <br>주1)
	 *
	 * @param e Event
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Chassis 의 Registration 정보를 생성 및 수정한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * chassis Pool 을 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * chassis Pool 을 Manage 한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("XXXXXXXXX").getUserMessage());
	...
	/**
	 * [EES_CGM_1017] : [Save] <br>
	 * Lost 장비 를 Found 처리 한다 . Save <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("XXXXXXXXX").getUserMessage());
	 ...
	 * Chassis Eq Master 기본 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  장비 Lost 내역 summary 를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			log.debug("☆★☆ searchCHSEqinfoService  Check=========================="+chsEquipmentMGTVO);
	 ...
	 * M.G.Set Eq Master 기본 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_2006] : [Retrieve] <br>
	 * ChassisMgsetOnOffhire의 MGSET에 ATTACH된 샤시를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * M.G.Set Eq Master 기본 정보를 수정한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	private EventResponse modifyMGSEquipmentService(Event e) throws EventException {
		...
		try{
			...
			if(mGSEquipmentINVO.getMasterSaveFlag().equals("ATDTONLY"))
			{
				...
				com.hanjin.apps.alps.ees.cgm.movementmnrhistory.chassismgsetattachdetachhistory.vo.MGSAtdtHistoryMGTVO[] mGSAtdtHistoryMGTVOs = new com.hanjin.apps.alps.ees.cgm.movementmnrhistory.chassismgsetattachdetachhistory.vo.MGSAtdtHistoryMGTVO[1];
				mGSAtdtHistoryMGTVOs[0] = new com.hanjin.apps.alps.ees.cgm.movementmnrhistory.chassismgsetattachdetachhistory.vo.MGSAtdtHistoryMGTVO();
...
//			log.debug("☆★☆ searchCHSEqinfoService  Check=========================="+chsEquipmentMGTVO);
	 ...
	 * 장비 현황(status) History 를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			log.debug("☆★☆ searchCHSEqinfoService  Check=========================="+chsEquipmentMGTVO);
	 ...
	 * chassis 및 M.G.Set 장비의 SerialNo 중복 체크. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1005] : [Retrieve] <br>
	 * chassis 및 M.G.Set 장비의 SerialNo FM-TO 중복 체크. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1005] : [Retrieve] <br>
	 * chassis Eq spec 정보를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1005] : [Retrieve] <br>
	 * Eq Own Master(LOT) 리스트를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Own Master(Lot 정보) 생성시 해당 내용 저장 및, Master Update 를 수행한다. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			Map<String, Object> responseData = command.manageCHSOwnMasterBasic(event.getCHSSpecINVOS(),account);
			...
			//개발시 로그찍어서 데이타 입력 확인 한후 ROLLBACK을 지울것.
			//rollback();
			commit();
		}catch(EventException ex){
			rollback();
	 ...
	 *  장비 현황 Status 를 변경 및 삭제 처리한다. Save <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setETCData((Map<String,String>)responseData.get(WebKeys.ER_ETCDATA));
	 ...
	 *  장비 현황 Status 삭제 처리한다. Delete <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setETCData((Map<String,String>)responseData.get(WebKeys.ER_ETCDATA));
	 ...
	 * M.G.Set 장비의 Eq spec 중복 여부를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_2004] : [Retrieve] <br>
	 * M.G.Set 장비의 Eq Own Master(LOT) 리스트를 조회한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 *  On-Hire 시킬 Chassis No가 유효한지 체크한다 Change(Chassis No) <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  On-Hire 시 기존에 등록되어 있는 Chassis 의 chss_veh_id_no, chss_tit_no, chss_als_no 가 있는지 체크한다.  Change(Vehicle ID No/Title No/Alias No1/Alias No2) <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  On-Hire 시 기존에 등록되어 있는 Chassis 의 chss_veh_id_no, chss_tit_no, chss_als_no 가 있는지 체크한다. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  Eq On-hire 수행에 필요한 Verify 처리. Verify <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *   장비 임차(Eq Onhire) 수행한다  On-Hire Confirm.<br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			rollback();
	 ...
	 * Chassis Inventory 에 count 된 장비별 상세 list 를 조회. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * M.G.Set Inventory 에 count 된 장비별 상세 list 를 조회. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Chassis 기본적 인벤토리 조회 화면인 General Inventory 산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  On-Hire 를 시킬 M.G.Set No가 유효한지 체크한다. . Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_2007] : [Retrieve] <br>
	 *  On-Hire 를 시킬 Model No. 를 바꾸면 해당하는 voltage, fuel capacity  . Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			rollback();
	 ...
	 *  ERP FA I/F 대상 장비 리스트  Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 *  ERP FA I/F 대상 장비 리스트  Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Inventory By staying days 산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 ...
	 * Chassis Long Staying Environment 를 조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	...
	private EventResponse searchCHSLongstayEnvService (Event e) throws EventException {
		try
		{
			...
			CHSLongStaydaysEnvINVO cHSLongStaydaysEnvINVO = null;
	 ...
	 * Chassis Long Staying Environment 를 변경한다.. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * Inventory By Agreement 산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	 ...
	 * Inventory By On-hire year  산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	 ...
	 * Chassis Variation Status Inquiry 를 조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Chassis Variation Status Detail Inquiry 를 조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * 각 SCC별 및 Yard별 Chassis 운용 Practice를 수치화하여 Factor로 조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	private EventResponse searchCHSUtilFactorService  (Event e) throws EventException {
		try
		{
			...
			CHSUtilFactorINVO cHSUtilFactorINVO = null;
	...
	/**
	 * [EES_CGM_1111] : [Retrieve] <br>
	 * 각 SCC별 및 Yard별 Chassis 운용 Practice를 수치화하여 세부 Factor를  조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * 각 SCC별 및 Yard별 Chassis 운용 Practice를 수치화하여 Factor로 설정한다.. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			rollback();
	 ...
	 * Chassis Utilization report 산출한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	private EventResponse searchCHSUtilizationRptService  (Event e) throws EventException {
		try
		{
			...
			CHSUtilizationINVO cHSUtilizationINVO = null;
	 ...
	 * 조회 조건별 Historical Report 산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	private EventResponse searchCHSHistoricalReportService (Event e) throws EventException {
		try
		{
			...
			CHSHistoricalRptINVO cHSHistoricalRptINVO = null;
	 ...
	 * ESP(Equipment Standard Pool)  Report 산출 변수를 조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	private EventResponse searchCHSEspFactorService(Event e) throws EventException {
		try
		{
			...
			CHSEspFactorINVO cHSEspFactorINVO = null;
	 ...
	 * ESP(Equipment Standard Pool) Report 산출 변수를 설정한다.. Manage <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			eventResponse.setUserMessage(new ErrorHandler("CGM00002").getUserMessage());
	 ...
	 * ESP(Equipment Standard Pool)  Report BackEndJob Key 생성.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1115] : [Retrieve] <br>
	 * ESP(Equipment Standard Pool)  Report BackEndJob Status Check .. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1115] : [Retrieve] <br>
	 * ESP(Equipment Standard Pool)  Report BackEndJob결과 산출 .. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Lost 된 장비 중 대해 Movement 발생 건에 대해 Found 대상 건으로 조회한다.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * Found Chassis Auto Creation 화면에서 EDI 오류 데이터등, 삭제처리할 Data를 Movement Data를 Update 및 삭제처리한다. Delete <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			rollback();
	 ...
	 *  장비분실시 Lost 처리 한다. Found Creation <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
...
//			rollback();
	 ...
	 * 기본적 인벤토리 조회 화면인 M.G.Set Inventory Summary 산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	 ...
	 * M.G.Set Inventory Detail SEARCH Service<br>
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	 * @exception EventException
	 */
	private EventResponse searchMGSInventoryDetailService(Event e) throws EventException {
		try
		{
			GeneralEventResponse eventResponse = new GeneralEventResponse();
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2075Event event = (EesCgm2075Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			List<MGSInventoryDetailMGTVO> list = command.searchMGSInventoryDetailBasic(event.getMGSInventoryDetailINVO());
			eventResponse.setRsVoList(list);
	...
	/**
	 * [EES_CGM_2075] : [Default] <br>
	 * M.G.Set Inventory Detail DEFAULT Service<br>
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 */
	private EventResponse searchEesCgm2075DefaultService(Event e) throws EventException {
		try
		{
			GeneralEventResponse eventResponse = new GeneralEventResponse();
...
//			eventResponse.setRsVoList(list1);
	 ...
	 * Inventory By Lessor, Agreement 산출.. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	 ...
	 * Inventory By Lessor, Term 산출(Lessor, Lease Term 별 장비 Inventory).. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	 ...
	 * Inventory By Office 산출( Office 별 장비 Inventory).. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse GeneralEventResponse
	...
	/**
	 * [EES_CGM_1102] : [Retrieve] <br>
	 * Chassis Variation Status Inquiry BackEndJob Key 생성.. Retrieve <br>주1)
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 * @exception EventException
	...
	/**
	 * [EES_CGM_1102] : [Retrieve] <br>
	 * Chassis Variation Status Inquiry BackEndJob Status Check .. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1102] : [Retrieve] <br>
	 * Chassis Variation Status Inquiry BackEndJob결과 산출 .. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1103] : [Retrieve] <br>
	 * Chassis Variation Status Detail Inquiry BackEndJob Key 생성.. Retrieve <br>주1)
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 */
	...
	/**
	 * [EES_CGM_1103] : [Retrieve] <br>
	 * Chassis Variation Status Detail Inquiry BackEndJob Status Check .. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	...
	/**
	 * [EES_CGM_1103] : [Retrieve] <br>
	 * Chassis Variation Status Detail Inquiry BackEndJob결과 산출 .. Retrieve <br>주1)
	 *
	 * @param e
	 * @throws EventException
	 * @return eventResponse EventResponse
	 ...
	 * @exception EventException
	 */
	private EventResponse searchCHSOffHireReportbyMonthSummaryService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try {
			EesCgm1151Event event = (EesCgm1151Event)e;

			ChassisMgsetOnOffhireBC command = new ChassisMgsetOnOffhireBCImpl();
			OnOffHireSummarybyMonthVO rsVo = command.searchCHSOffHireReportbyMonthSummaryBasic(event.getReportSearchConditionVO());
			...
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("CGM20032",new String[]{}).getMessage(), ex);
		}
		return eventResponse;
	}
	
	/**
	 * EES_CGM_1152 : Retrieve<br>
	 * 월별로 임차한 실적을 조회
	 *
	 * @param Event e
	 * @return EventResponse response
	 * @exception EventException
	 */
	private EventResponse searchCHSOnHireReportbyMonthSummaryService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try {
			EesCgm1152Event event = (EesCgm1152Event)e;

			ChassisMgsetOnOffhireBC command = new ChassisMgsetOnOffhireBCImpl();
			OnOffHireSummarybyMonthVO rsVo = command.searchCHSOnHireReportbyMonthSummaryBasic(event.getReportSearchConditionVO());
	 ...
	 * @exception EventException
	 */		
	private EventResponse searchCHSAssetsSmryListService(Event e) throws EventException {		
		// PDTO(Data Transfer Object including Parameters)
		EesCgm1153Event event = (EesCgm1153Event)e;
		ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
		GeneralEventResponse eventResponse = new GeneralEventResponse();
	    try{		
			List<CHSAssetsSmryVO> list = command.searchCHSAssetsSmryListBasic(event.getChsAssetsOptionVO());
			eventResponse.setRsVoList(list);
		}catch(EventException ex){
			throw ex;
		}catch(Exception ex){
	 ...
	 * @exception EventException
	 */		
	private EventResponse searchCHSAssetsDetailListService(Event e) throws EventException {	
		// PDTO(Data Transfer Object including Parameters)
		EesCgm1154Event event = (EesCgm1154Event)e;
		ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
		GeneralEventResponse eventResponse = new GeneralEventResponse();
	    try{		
			List<CHSAssetsDetailVO> list = command.searchCHSAssetsDetailListBasic(event.getChsAssetsSmryVO());
			eventResponse.setRsVoList(list);
		}catch(EventException ex){
			throw ex;
		}catch(Exception ex){
	 ...
	 * @exception EventException
	 */		
	private EventResponse searchMGSAssetsSmryListService(Event e) throws EventException {		
		// PDTO(Data Transfer Object including Parameters)
		EesCgm2209Event event = (EesCgm2209Event)e;
		ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
		GeneralEventResponse eventResponse = new GeneralEventResponse();
	    try{		
			List<CHSAssetsSmryVO> list = command.searchCHSAssetsSmryListBasic(event.getChsAssetsOptionVO());
	 ...
	 * @exception EventException
	 */		
	private EventResponse searchMGSAssetsDetailListService(Event e) throws EventException {	
		// PDTO(Data Transfer Object including Parameters)
		EesCgm2210Event event = (EesCgm2210Event)e;
		ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
		GeneralEventResponse eventResponse = new GeneralEventResponse();
	    try{		
			List<CHSAssetsDetailVO> list = command.searchCHSAssetsDetailListBasic(event.getChsAssetsSmryVO());
	 ...
	 * @exception EventException
	 */
	private EventResponse searchMGSOffHireReportbyMonthSummaryService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try {
			EesCgm2211Event event = (EesCgm2211Event)e;
	 ...
	 * @exception EventException
	 */
	private EventResponse searchMGSOnHireReportbyMonthSummaryService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try {
			EesCgm2212Event event = (EesCgm2212Event)e;
	...
	/**
	 * EES_CGM_2213 : Retrieve<br>
	 *
	 * @param Event e
	 * @return EventResponse response
	 * @exception EventException
	 */
	private EventResponse searchBareMGSetService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			List<MGSBareMVMTDataVO> list = command.searchBareMGSet (event.getMGSBareMVMTDataVO());
			eventResponse.setRsVoList(list);
	...
	/**
	 * EES_CGM_2213 :MGSetNo Retrieve<br>
	 * 
	 * @param Event e
	 * @return EventResponse response
	 * @exception EventException
	 */
	private EventResponse searchMGSetNoService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			String chk_mgset = command.searchMGSetNo (event.getMGSBareMVMTDataVO());
			eventResponse.setETCData("chkMgset", chk_mgset);
	...
	/**
	 * EES_CGM_2213 : EqTpszCd Retrieve<br>
	 * 
	 *
	 * @param Event e
	 * @return EventResponse response
	 * @exception EventException
	 */
	private EventResponse searchEqTpszCdService(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			String[] eq_tpsz_cd = command.searchEqTpszCd (event.getMGSBareMVMTDataVO());
			eventResponse.setETCData("eq_tpsz_cd", eq_tpsz_cd[0]);
			eventResponse.setETCData("org_yd_cd",  eq_tpsz_cd[1]);
		}catch(Exception ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("CGM20032").getMessage(), ex);
		}
	 ...
	 * @exception EventException
	 */
	private EventResponse checkBareMGSetContNoData(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			String chkEqno = command.checkBareMGSetContNoData (event.getMGSBareMVMTDataVO());
			eventResponse.setETCData("chk_eqno", chkEqno);
		}catch(Exception ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("CGM20032").getMessage(), ex);
		}
	 ...
	 * @exception EventException
	 */
	private EventResponse searchBareMGSetCLGData(Event e) throws EventException{
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			String[] chkChsNo = command.searchBareMGSetCLGData (event.getMGSBareMVMTDataVO());
			eventResponse.setETCData("mvmt", chkChsNo[0]);
			eventResponse.setETCData("lsdays", chkChsNo[1]);
		}catch(Exception ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("CGM20032").getMessage(), ex);
		}
	 ...
	 * @exception EventException
	 */
	private EventResponse checkBareMGSetChsNoData(Event e) throws EventException {
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			String chkChsno = command.checkBareMGSetChsNoData (event.getMGSBareMVMTDataVO());
			eventResponse.setETCData("chk_chsno", chkChsno);
		}catch(Exception ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("CGM20032").getMessage(), ex);
		}
	 ...
	 * @exception EventException
	 */
	private EventResponse searchBareMGSetUMGData(Event e) throws EventException{
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		try
		{
			// PDTO(Data Transfer Object including Parameters)
			EesCgm2213Event event = (EesCgm2213Event)e;
			ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
			String[] chkChsNo = command.searchBareMGSetUMGData (event.getMGSBareMVMTDataVO());
			eventResponse.setETCData("mvmt", chkChsNo[0]);
			eventResponse.setETCData("lsdays", chkChsNo[1]);
		}catch(Exception ex) {
			log.error("err " + ex.toString(), ex);
	 ...
	 * @exception EventException
	 */
	private EventResponse multiMGSetDefaultData(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EesCgm2213Event event = (EesCgm2213Event)e;
		ChassisMgsetInventoryBC command = new ChassisMgsetInventoryBCImpl();
		try{
			begin();
			command.multiMGSetDefaultData(event.getMGSBareMVMTDataVOs(), account);
