...
*@FileName : ProcurementOptionVO.java
*@FileTitle : ProcurementOptionVO
*Open Issues :
*Change history :
...
public class ProcurementOptionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ProcurementOptionVO> models = new ArrayList<ProcurementOptionVO>();
	...
	public ProcurementOptionVO() {}

	public ProcurementOptionVO(String ibflag, String pagerows, String plnYr, String cntrTpszCd, String bseDt) {
		this.bseDt = bseDt;
		this.ibflag = ibflag;
		this.plnYr = plnYr;
	 ...
	 * @param request
	 * @return ProcurementOptionVO[]
	 */
	public ProcurementOptionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ProcurementOptionVO[]
	 */
	public ProcurementOptionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ProcurementOptionVO model = null;
		...
		return getProcurementOptionVOs();
	}
	 ...
	 * @return ProcurementOptionVO[]
	 */
	public ProcurementOptionVO[] getProcurementOptionVOs(){
		ProcurementOptionVO[] vos = (ProcurementOptionVO[])models.toArray(new ProcurementOptionVO[models.size()]);
		return vos;
	}
