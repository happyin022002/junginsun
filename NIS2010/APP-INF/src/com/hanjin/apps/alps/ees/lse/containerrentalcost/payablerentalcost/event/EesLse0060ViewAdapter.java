...
*@FileName : EesLse0060ViewAdapter.java
*@FileTitle : EesLse0060ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0060 에 대한 ViewAdapter<br>
 * - EES_LSE_0060HTMLAction에서 작성<br>
 *
 * @author 남궁진호
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EesLse0060ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0060ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0060ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
    	ReportSearchPayableVO rsVo = (ReportSearchPayableVO)list.get(0);
		...
		log.debug("########### EesLse0060ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
