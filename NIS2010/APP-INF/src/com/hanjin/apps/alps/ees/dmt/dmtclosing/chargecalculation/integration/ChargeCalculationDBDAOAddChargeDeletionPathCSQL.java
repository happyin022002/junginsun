...
*@FileName : ChargeCalculationDBDAOAddChargeDeletionPathCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOAddChargeDeletionPathCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOAddChargeDeletionPathCSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOAddChargeDeletionPathCSQL(){
		setQuery();
		...
		params.put("chg_delt_path_cpls_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("chg_delt_path_lvl",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChargeCalculationDBDAOAddChargeDeletionPathCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
