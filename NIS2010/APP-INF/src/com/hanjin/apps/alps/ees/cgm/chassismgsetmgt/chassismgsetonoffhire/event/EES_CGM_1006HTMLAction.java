...
*@FileName : EES_CGM_1006HTMLAction.java
...
public class EES_CGM_1006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1006HTMLAction 객체를 생성
	 */
	public EES_CGM_1006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1006Event event = new EesCgm1006Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCHSEquipmentINVOS((CHSEquipmentINVO[])getVOs(request, CHSEquipmentINVO .class, ""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSEquipmentINVO((CHSEquipmentINVO)getVO(request, CHSEquipmentINVO .class));
		}
