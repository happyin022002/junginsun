...
public class GeneralCodeSearchMgtDBDAOsearchUnitPriceDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(SUBSTR(REPLACE(@[request_dt],'-',''), 1,6), 'USD', @[curr_cd], NVL(A.MNR_DISP_TRF_TOT,0)) AS MNR_DISP_TRF_TOT," ).append("\n"); 
		query.append("MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(SUBSTR(REPLACE(@[request_dt],'-',''), 1,6), 'USD', @[curr_cd], NVL(A.MNR_DISP_TRF_AVG,0)) AS MNR_DISP_TRF_AVG," ).append("\n"); 
