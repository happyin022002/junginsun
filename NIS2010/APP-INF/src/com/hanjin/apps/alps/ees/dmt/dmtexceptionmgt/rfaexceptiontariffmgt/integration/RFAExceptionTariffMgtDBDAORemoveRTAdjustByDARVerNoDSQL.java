...
*@FileName : RFAExceptionTariffMgtDBDAORemoveRTAdjustByDARVerNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveRTAdjustByDARVerNoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DAR No. 와 Version No. 에 해당되는 Rate Adjustment 정보를 삭제한다.
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveRTAdjustByDARVerNoDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveRTAdjustByDARVerNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
