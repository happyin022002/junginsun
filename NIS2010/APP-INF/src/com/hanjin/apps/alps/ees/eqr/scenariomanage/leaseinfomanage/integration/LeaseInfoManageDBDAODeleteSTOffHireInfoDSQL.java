...
*@FileName : LeaseInfoManageDBDAODeleteSTOffHireInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LeaseInfoManageDBDAODeleteSTOffHireInfoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_SHRT_TERM_OFFH_COND 테이블 데이터 삭제
	  * </pre>
	  */
	public LeaseInfoManageDBDAODeleteSTOffHireInfoDSQL(){
		setQuery();
		...
		query.append("FileName : LeaseInfoManageDBDAODeleteSTOffHireInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
