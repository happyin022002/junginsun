...
*@FileName : RFAExceptionTariffMgtDBDAOSearchRFATariffByAPVLNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchRFATariffByAPVLNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * APVL No. 에 해당되는 APVL OFC, DAR No., Version, Status 정보를 조회하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchRFATariffByAPVLNoRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchRFATariffByAPVLNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",   LPAD(RFA_EXPT_VER_SEQ, 3, '0') AS RFA_EXPT_VER_SEQ" ).append("\n"); 
