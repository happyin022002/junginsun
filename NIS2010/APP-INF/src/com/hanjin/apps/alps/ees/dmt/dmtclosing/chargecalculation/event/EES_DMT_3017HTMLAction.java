...
*@FileName : EES_DMT_3017HTMLAction.java
...
public class EES_DMT_3017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3017HTMLAction 객체를 생성
	 */
	public EES_DMT_3017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt3017Event event = new EesDmt3017Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInactiveInputVO((InactiveInputVO)getVO(request, InactiveInputVO .class));
		} else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setInactiveReasonVO((InactiveReasonVO)getVO(request, InactiveReasonVO .class));
		}
