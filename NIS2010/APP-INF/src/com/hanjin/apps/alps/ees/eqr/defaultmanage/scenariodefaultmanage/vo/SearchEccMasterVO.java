...
*@FileName : searchDefaultECCInfoVO.java
*@FileTitle : searchDefaultECCInfoVO
*Open Issues :
*Change history :
* No.	Ver.		Modifier           		modifier date    explanation
* 1      	1.0      	Lee Byoung Hun	2009.07.01		1.0 최초 생성
*
...
public class SearchEccMasterVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEccMasterVO> models = new ArrayList<SearchEccMasterVO>();
	
	/* Column Info */
	private String hndl45ftCostAmt = null;
	/* Column Info */
	private String stoMinQty = null;
	/* Column Info */
	private String exptStoQty = null;
	/* Column Info */
	private String sttl45ftCostAmt = null;
	/* Column Info */
	private String stoMaxQty = null;
	/* Column Info */
	...
	public SearchEccMasterVO() {}

	public SearchEccMasterVO(String ibflag, String pagerows, String eccCd, String stoMaxQty, String stoMinQty, String stoFreeQty, String wkyMaxHndlQty, String wkyMinHndlQty, String tsDivFlg, String stv20ftCostAmt, String stv40ftCostAmt, String stv45ftCostAmt, String sto20ftCostAmt, String sto40ftCostAmt, String sto45ftCostAmt, String hndl20ftCostAmt, String hndl40ftCostAmt, String hndl45ftCostAmt, String sttl20ftCostAmt, String sttl40ftCostAmt, String sttl45ftCostAmt, String exptFmYrwk, String exptToYrwk, String exptStoQty, String exptWkyHndlQty, String timegap) {
		this.hndl45ftCostAmt = hndl45ftCostAmt;
		this.stoMinQty = stoMinQty;
		this.exptStoQty = exptStoQty;
		this.sttl45ftCostAmt = sttl45ftCostAmt;
		this.stoMaxQty = stoMaxQty;
	 ...
	 * @return stoMinQty
	 */
	public String getStoMinQty() {
		return this.stoMinQty;
	}
	 ...
	 * @return stoMaxQty
	 */
	public String getStoMaxQty() {
		return this.stoMaxQty;
	}
	 ...
	 * @param stoMinQty
	 */
	public void setStoMinQty(String stoMinQty) {
		this.stoMinQty = stoMinQty;
	}
	 ...
	 * @param stoMaxQty
	 */
	public void setStoMaxQty(String stoMaxQty) {
		this.stoMaxQty = stoMaxQty;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setStoMinQty(JSPUtil.getParameter(request, "sto_min_qty", ""));
		...
		setStoMaxQty(JSPUtil.getParameter(request, "sto_max_qty", ""));
	 ...
	 * @param request
	 * @return searchDefaultECCInfoVO[]
	 */
	public SearchEccMasterVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchDefaultECCInfoVO[]
	 */
	public SearchEccMasterVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEccMasterVO model = null;
		...
		try {
			...
			String[] stoMinQty = (JSPUtil.getParameter(request, prefix	+ "sto_min_qty", length));
			...
			String[] stoMaxQty = (JSPUtil.getParameter(request, prefix	+ "sto_max_qty", length));
		...
		return getsearchDefaultECCInfoVOs();
	}
	 ...
	 * @return searchDefaultECCInfoVO[]
	 */
	public SearchEccMasterVO[] getsearchDefaultECCInfoVOs(){
		SearchEccMasterVO[] vos = (SearchEccMasterVO[])models.toArray(new SearchEccMasterVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.stoMinQty = this.stoMinQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.stoMaxQty = this.stoMaxQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
