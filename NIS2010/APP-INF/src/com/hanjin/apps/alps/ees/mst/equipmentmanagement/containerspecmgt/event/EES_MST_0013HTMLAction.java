...
*@FileName : EES_MST_0013HTMLAction.java
...
public class EES_MST_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0013HTMLAction 객체를 생성
	 */
	public EES_MST_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0013Event event = new EesMst0013Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMdmEqOrzChtVO((EqOrgSccVO)getVO(request, EqOrgSccVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setEqOrgYardVO((EqOrgYardVO)getVO(request, EqOrgYardVO .class));
		}
