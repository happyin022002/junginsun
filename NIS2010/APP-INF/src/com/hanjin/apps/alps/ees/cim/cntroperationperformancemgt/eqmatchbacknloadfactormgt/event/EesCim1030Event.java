 ...
 * @since J2EE 1.4
 */
public class EesCim1030Event extends EventSupport {
	...
	private SearchCargoFlowMapDetailVO searchCargoFlowMapDetailVO = null;
	
	/** Table Value Object 조회 조건 및 단건 처리  */
	private SearchOptionByFromToVO searchOptionByFromToVO = null;
	
	
	public EesCim1030Event(){}
	...
	/**
	 * @param directionWise the directionWise to set
	 */
	...
	/**
	 * @param locCnty the locCnty to set
	 */
	...
	/**
	 * @param inquiryWise2 the inquiryWise2 to set
	 */
	...
	/**
	 * @param inquiryWise1 the inquiryWise1 to set
	 */
	...
	/**
	 * @return the searchCargoFlowMapDetailVO
	 */
	public SearchCargoFlowMapDetailVO getSearchCargoFlowMapDetailVO() {
		return searchCargoFlowMapDetailVO;
	}

	/**
	 * @param searchCargoFlowMapDetailVO the searchCargoFlowMapDetailVO to set
	 */
	public void setSearchCargoFlowMapDetailVO(SearchCargoFlowMapDetailVO searchCargoFlowMapDetailVO) {
		this. searchCargoFlowMapDetailVO = searchCargoFlowMapDetailVO;
	}
