...
*@FileName : BKGRequestInfoVO.java
*@FileTitle : BKGRequestInfoVO
*Open Issues :
*Change history :
...
public class BKGRequestInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BKGRequestInfoVO> models = new ArrayList<BKGRequestInfoVO>();
	 ...
	 */
	public BKGRequestInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BKGRequestInfoVO[]
	 */
	public BKGRequestInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BKGRequestInfoVO model = null;
	 ...
	 * @return BKGRequestInfoVO[]
	 */
	public BKGRequestInfoVO[] getBKGRequestInfoVOs(){
		BKGRequestInfoVO[] vos = (BKGRequestInfoVO[])models.toArray(new BKGRequestInfoVO[models.size()]);
		return vos;
	}
