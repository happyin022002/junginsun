...
*@FileName : EES_MNR_0228HTMLAction.java
...
public class EES_MNR_0228HTMLAction extends HTMLActionSupport {
 
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0228HTMLAction 객체를 생성
	 */
	public EES_MNR_0228HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0228Event event = new EesMnr0228Event();
