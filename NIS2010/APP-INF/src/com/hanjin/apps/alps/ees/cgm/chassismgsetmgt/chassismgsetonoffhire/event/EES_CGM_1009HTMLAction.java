...
*@FileName : EES_CGM_1009HTMLAction.java
...
public class EES_CGM_1009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1009HTMLAction 객체를 생성
	 */
	public EES_CGM_1009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1009Event event = new EesCgm1009Event();
        log.debug("::CALL::> EES_CGM_1009HTMLAction - " +request);
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setChsOffHireMGTVOs((CHSOffHireMGTVO[])getVOs(request, CHSOffHireMGTVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsOffHireINVO((CHSOffHireINVO)getVO(request, CHSOffHireINVO .class));
		}
