...
*@FileName : MTYEquipmentForecastDBDAOremoveMtyRepoInDetailListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOremoveMtyRepoInDetailListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_MTY_BAL_RPT_DCHG_MNL 테이블 정보 삭제
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOremoveMtyRepoInDetailListDSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOremoveMtyRepoInDetailListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_MTY_BAL_RPT_DCHG_MNL " ).append("\n"); 
