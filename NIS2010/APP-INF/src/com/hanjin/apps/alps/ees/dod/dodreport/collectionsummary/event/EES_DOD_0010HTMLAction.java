...
*@FileName : EES_DOD_0010HTMLAction.java   
 ...
 * @since J2EE 1.4 
 */
public class EES_DOD_0010HTMLAction extends HTMLActionSupport {
     ...
     */
    public EES_DOD_0010HTMLAction() {
    }

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EesDod0010Event로 파싱하여 request에 셋팅<br>
	 *
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDod0010Event event = new EesDod0010Event();
		event.setAttribute("KEY", request.getParameter("backendjob_key"));

		if(command.isCommand(FormCommand.SEARCH)){ 
			event.setSumbyOfcDetailVO((SumbyOfcDetailVO)getVO(request, SumbyOfcDetailVO.class));
 		}
