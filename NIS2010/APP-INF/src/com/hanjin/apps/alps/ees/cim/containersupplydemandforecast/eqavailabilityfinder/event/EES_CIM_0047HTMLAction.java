...
*@FileName : EES_CIM_0047HTMLAction.java
*@FileTitle : PickUp
*Open Issues :
*Change history :
...
public class EES_CIM_0047HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0047HTMLAction 객체를 생성
	 */
	public EES_CIM_0047HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0047Event event = new EesCim0047Event();
