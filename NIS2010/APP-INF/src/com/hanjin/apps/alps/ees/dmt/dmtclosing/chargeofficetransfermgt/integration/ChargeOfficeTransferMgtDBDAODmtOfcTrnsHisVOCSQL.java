...
*@FileName : ChargeOfficeTransferMgtDBDAODmtOfcTrnsHisVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeOfficeTransferMgtDBDAODmtOfcTrnsHisVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeOfficeTransferMgtDBDAODmtOfcTrnsHisVORSQL.Query
	  * </pre>
	  */
	public ChargeOfficeTransferMgtDBDAODmtOfcTrnsHisVOCSQL(){
		setQuery();
		...
		params.put("trns_rsn",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChargeOfficeTransferMgtDBDAODmtOfcTrnsHisVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
