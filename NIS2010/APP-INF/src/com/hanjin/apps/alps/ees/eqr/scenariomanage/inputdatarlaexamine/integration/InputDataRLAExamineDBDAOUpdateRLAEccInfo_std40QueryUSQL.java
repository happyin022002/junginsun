...
*@FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_std40QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLAEccInfo_std40QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC  테이블에 대한 40feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLAEccInfo_std40QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_std40QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
