...
*@FileName : EesEqr0086ViewAdapter.java
...
/**
 * EES_EQR_0086 IBSheet XML 생성<br>
 ...
 * @since J2EE 1.6
 */
public class EesEqr0086ViewAdapter extends ViewAdapter {
...
//				sb.append("	<TR EDIT ='"+JSPUtil.getNull(rs.getString("delstatus"))+"'>");
//				for (int j=0; j < colCount; j++) {
//					sb.append("<TD EDIT ='"+JSPUtil.getNull(rs.getString("delstatus"))+"'><![CDATA[" + JSPUtil.getNull(rs.getString(i++)) + "]]></TD>");
//				}
//				i = 1;
//				sb.append("</TR>\n");
//			}
