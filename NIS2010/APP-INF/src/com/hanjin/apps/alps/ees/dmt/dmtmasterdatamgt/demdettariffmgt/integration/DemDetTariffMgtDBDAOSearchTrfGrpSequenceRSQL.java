...
*@FileName : DemDetTariffMgtDBDAOSearchTrfGrpSequenceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchTrfGrpSequenceRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchTrfGrpSequenceRSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchTrfGrpSequenceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MAX(TRF_GRP_SEQ),0) AS TRF_GRP_SEQ" ).append("\n"); 
