...
*@FileName : CntrForecastManageDBDAOSearchCntrGenerationBookedDayRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOSearchCntrGenerationBookedDayRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * eqr_ob_fcast + eqr_ib_bkg_fcast  테이블 데이터 조회(Booked/Day)
	  * 
	  * <Change History>
	  * 1	2009.08.12	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrForecastManageDBDAOSearchCntrGenerationBookedDayRSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOSearchCntrGenerationBookedDayRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
