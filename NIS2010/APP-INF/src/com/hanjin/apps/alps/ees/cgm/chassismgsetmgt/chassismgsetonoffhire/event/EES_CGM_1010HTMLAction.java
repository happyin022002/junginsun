...
*@FileName : EES_CGM_1010HTMLAction.java
...
public class EES_CGM_1010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1010HTMLAction 객체를 생성
	 */
	public EES_CGM_1010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1010Event event = new EesCgm1010Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSOnOffhireSummaryINVO((CHSOnOffhireSummaryINVO)getVO(request, CHSOnOffhireSummaryINVO .class));
		}
