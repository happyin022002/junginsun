...
*@FileName : EES_EQR_0045HTMLAction.java
...
public class EES_EQR_0045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0045HTMLAction 객체를 생성
	 */
	public EES_EQR_0045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0045Event event = new EesEqr0045Event();
		
		// Retrieve 버튼 클릭시
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEesEqr0045ConditionVO((EesEqr0045ConditionVO)getVO(request, EesEqr0045ConditionVO .class));
		}
