...
*@FileName : EqInterchangeDBDAOAvailableOnewaySummaryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EqInterchangeDBDAOAvailableOnewaySummaryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EqInterchangeDBDAOAvailableOnewaySummaryRSQL(){
		setQuery();
		...
		query.append("FileName : EqInterchangeDBDAOAvailableOnewaySummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")," ).append("\n"); 
		query.append("SUMMARY AS" ).append("\n"); 
		...
		query.append("     , SUM(DECODE(CNTR_TPSZ_CD, '$key',  DECODE(STS,'M','1','A',ONH_QTY), NULL, 0, 0)) AS $col_name" ).append("\n"); 
		...
		query.append("       ,A.AGMT_SEQ" ).append("\n"); 
		query.append("       ,A.CRE_DT APP_DT" ).append("\n"); 
		...
		query.append(" WHERE A.CONTI_FROM = B.LOC_CD(+)) AA," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY STS" ).append("\n"); 
		query.append("        ,RCC_CD" ).append("\n"); 
		query.append("        ,LCC_CD" ).append("\n"); 
		query.append("        ,ECC_CD" ).append("\n"); 
		query.append("        ,TRD" ).append("\n"); 
		...
		query.append("SELECT *" ).append("\n"); 
		query.append("  FROM" ).append("\n"); 
		query.append("(SELECT '1' SN" ).append("\n"); 
		query.append("       ,'SML CY' STS" ).append("\n"); 
		query.append("       ,RCC_CD" ).append("\n"); 
		query.append("       ,LCC_CD" ).append("\n"); 
		query.append("       ,ECC_CD" ).append("\n"); 
		query.append("       ,TRD" ).append("\n"); 
		query.append("       ,OFF_HIRE_LOC" ).append("\n"); 
		query.append("       ,'OF' LSTM_CD" ).append("\n"); 
		query.append("#foreach($key IN ${cntr_tpsz_cd_seq})" ).append("\n"); 
		query.append("#set ($col_name='CNTR'+$velocityCount+'_QTY')" ).append("\n"); 
		query.append("      ,SUM ($col_name) AS $col_name" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("  FROM SUMMARY" ).append("\n"); 
		query.append(" WHERE 1=1" ).append("\n"); 
		query.append("   AND STS = 'M'" ).append("\n"); 
		query.append("GROUP BY STS" ).append("\n"); 
		query.append("        ,RCC_CD" ).append("\n"); 
		...
		query.append("#if (${sts} != 'A') " ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT '2' SN" ).append("\n"); 
		query.append("       ,'S.Total' STS" ).append("\n"); 
		query.append("       ,'' RCC_CD" ).append("\n"); 
		query.append("       ,'' LCC_CD" ).append("\n"); 
		query.append("       ,'' ECC_CD" ).append("\n"); 
		query.append("       ,'' TRD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("UNION ALL   " ).append("\n"); 
		query.append("SELECT '3' SN" ).append("\n"); 
		query.append("       ,'LESSOR CY' STS" ).append("\n"); 
		query.append("       ,RCC_CD" ).append("\n"); 
		query.append("       ,LCC_CD" ).append("\n"); 
		query.append("       ,ECC_CD" ).append("\n"); 
		query.append("       ,TRD" ).append("\n"); 
		...
		query.append("        ,TRD" ).append("\n"); 
		query.append("        ,OFF_HIRE_LOC" ).append("\n"); 
		query.append("#if (${sts} != 'M')   " ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT '4' SN" ).append("\n"); 
		query.append("       ,'S.Total' STS" ).append("\n"); 
		query.append("       ,'' RCC_CD" ).append("\n"); 
		query.append("       ,'' LCC_CD" ).append("\n"); 
		query.append("       ,'' ECC_CD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT '5' SN" ).append("\n"); 
		query.append("       ,'Total' STS" ).append("\n"); 
		query.append("       ,'' RCC_CD" ).append("\n"); 
		query.append("       ,'' LCC_CD" ).append("\n"); 
		query.append("       ,'' ECC_CD" ).append("\n"); 
		query.append("       ,'' TRD" ).append("\n"); 
		...
		query.append("  FROM SUMMARY" ).append("\n"); 
		query.append("#if (${sts} == 'A')" ).append("\n"); 
		query.append("  WHERE STS = 'A'" ).append("\n"); 
		query.append("#elseif (${sts} == 'M')" ).append("\n"); 
		query.append("  WHERE STS = 'M'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(" ORDER BY SN" ).append("\n"); 
