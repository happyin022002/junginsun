...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOSearchLocationMBByLogisticRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOSearchLocationMBByLogisticRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Domestic Match Back Main
	  * </pre>
	  */
	public EQMatchBackNLoadFactorMgtDBDAOSearchLocationMBByLogisticRSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOSearchLocationMBByLogisticRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--	WHERE Y.NO = '4'" ).append("\n"); 
		query.append("GROUP BY" ).append("\n"); 
		query.append("		X.LOC_CD," ).append("\n"); 
