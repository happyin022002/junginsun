...
*@FileName : DodFileUploadDBDAOFileUploadListVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodFileUploadDBDAOFileUploadListVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodFileUploadDBDAOFileUploadListVOUSQL(){
		setQuery();
		...
		query.append("FileName : DodFileUploadDBDAOFileUploadListVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DOD_ATCH_FILE" ).append("\n"); 
