...
*@FileName : RepairMgtDBDAORemoveAcepChkDetailForWODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAORemoveAcepChkDetailForWODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * --ACEP Check List Detail List - Simple Wor Order
	  * </pre>
	  */
	public RepairMgtDBDAORemoveAcepChkDetailForWODSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAORemoveAcepChkDetailForWODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM     MNR_ACEP_CHK_LIST_DTL AD" ).append("\n"); 
		query.append("WHERE    1 = 1" ).append("\n"); 
		query.append("AND      AD.ACEP_SEQ IN" ).append("\n"); 
		query.append("         (" ).append("\n"); 
