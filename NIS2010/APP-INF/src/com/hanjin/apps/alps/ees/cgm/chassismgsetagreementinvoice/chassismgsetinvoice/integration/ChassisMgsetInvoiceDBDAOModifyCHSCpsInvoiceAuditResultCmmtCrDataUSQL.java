...
*@FileName : ChassisMgsetInvoiceDBDAOModifyCHSCpsInvoiceAuditResultCmmtCrDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOModifyCHSCpsInvoiceAuditResultCmmtCrDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOModifyCHSCpsInvoiceAuditResultCmmtCrDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOModifyCHSCpsInvoiceAuditResultCmmtCrDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CGM_LSE_CHG_CMMT_CR_DTL" ).append("\n"); 
		query.append("   SET CMMT_20FT_AMT = @[cmmt_20ft_amt]" ).append("\n"); 
		query.append("     , CMMT_40FT_AMT = @[cmmt_40ft_amt]" ).append("\n"); 
		query.append("     , CMMT_45FT_AMT = @[cmmt_45ft_amt]" ).append("\n"); 
		...
		query.append("   AND CMMT_CR_CD      = @[cmmt_cr_cd]" ).append("\n"); 
