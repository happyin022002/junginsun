...
*@FileName : CHSPayableInvoiceCreationINVO.java
*@FileTitle : CHSPayableInvoiceCreationINVO
*Open Issues :
*Change history :
...
public class CHSPayableInvoiceCreationINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSPayableInvoiceCreationINVO> models = new ArrayList<CHSPayableInvoiceCreationINVO>();
	...
	/* Column Info */
	private String invCrSmryAmt = null;
	/* Column Info */
	private String invTaxSmryAmt = null;
	/* Column Info */
	...
	public CHSPayableInvoiceCreationINVO(String ibflag, String pagerows, String eqKndCd, String intgCdValCtnt, String costOfcCd, String vndrSeq, String chssMgstInvKndCd, String chssMgstInvStsCd, String payInvSeq, String costYrmon, String revVvd, String invNo, String revVslCd, String revSkdVoyNo, String revSkdDirCd, String revDirCd, String chgSmryAmt, String invTaxCltTpCd, String invTaxRt, String csrNo, String invSmryAmt, String status, String statusCd, String chgCreSeq, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String agmtNo, String eqNo, String eqTpszCd, String chgCd, String costCd, String acctCd, String currCd, String payTaxAmt, String payCrAmt, String payLseChgAmt, String creUsrId, String updUsrId, String invRcvDt, String invIssDt, String invEffDt, String invCfmDt, String genPayTermCd, String invAmt, String invRgstNo, String chssPoolCd, String invCustEqNo, String invCrSmryAmt, String invTaxSmryAmt, String lseChgSmryAmt) {
		...
		this.invCrSmryAmt = invCrSmryAmt;
		this.invTaxSmryAmt = invTaxSmryAmt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inv_cr_smry_amt", getInvCrSmryAmt());
		this.hashColumns.put("inv_tax_smry_amt", getInvTaxSmryAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inv_cr_smry_amt", "invCrSmryAmt");
		this.hashFields.put("inv_tax_smry_amt", "invTaxSmryAmt");
	 ...
	 * @return invCrSmryAmt
	 */
	public String getInvCrSmryAmt() {
		return this.invCrSmryAmt;
	}
	
	/**
	 * Column Info
	 * @return invTaxSmryAmt
	 */
	public String getInvTaxSmryAmt() {
		return this.invTaxSmryAmt;
	}
	 ...
	 * @param invCrSmryAmt
	 */
	public void setInvCrSmryAmt(String invCrSmryAmt) {
		this.invCrSmryAmt = invCrSmryAmt;
	}
	 ...
	 * @param invTaxSmryAmt
	 */
	public void setInvTaxSmryAmt(String invTaxSmryAmt) {
		this.invTaxSmryAmt = invTaxSmryAmt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInvCrSmryAmt(JSPUtil.getParameter(request, "inv_cr_smry_amt", ""));
		setInvTaxSmryAmt(JSPUtil.getParameter(request, "inv_tax_smry_amt", ""));
	 ...
	 */
	public CHSPayableInvoiceCreationINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSPayableInvoiceCreationINVO[]
	 */
	public CHSPayableInvoiceCreationINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSPayableInvoiceCreationINVO model = null;
		...
		try {
			...
			String[] invCrSmryAmt = (JSPUtil.getParameter(request, prefix	+ "inv_cr_smry_amt", length));
			String[] invTaxSmryAmt = (JSPUtil.getParameter(request, prefix	+ "inv_tax_smry_amt", length));
			String[] lseChgSmryAmt = (JSPUtil.getParameter(request, prefix	+ "lse_chg_smry_amt", length));
			
			for (int i = 0; i < length; i++) {
				model = new CHSPayableInvoiceCreationINVO();
				if (currCd[i] != null)
				...
				if (invCrSmryAmt[i] != null)
					model.setInvCrSmryAmt(invCrSmryAmt[i]);
				if (invTaxSmryAmt[i] != null)
					model.setInvTaxSmryAmt(invTaxSmryAmt[i]);
		...
		return getCHSPayableInvoiceCreationINVOs();
	}
	...
	public CHSPayableInvoiceCreationINVO[] getCHSPayableInvoiceCreationINVOs(){
		CHSPayableInvoiceCreationINVO[] vos = (CHSPayableInvoiceCreationINVO[])models.toArray(new CHSPayableInvoiceCreationINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.invCrSmryAmt = this.invCrSmryAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.invTaxSmryAmt = this.invTaxSmryAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
