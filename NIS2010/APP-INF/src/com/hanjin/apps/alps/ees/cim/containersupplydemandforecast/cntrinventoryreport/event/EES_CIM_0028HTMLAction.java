...
*@FileName : EES_CIM_0028HTMLAction.java
...
public class EES_CIM_0028HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0028HTMLAction 객체를 생성
	 */
	public EES_CIM_0028HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0028Event event = new EesCim0028Event();
		

		event.setStockSmryVO((StockSmryVO)getVO(request, StockSmryVO .class));
		event.setStockSmryVOS((StockSmryVO[])getVOs(request, StockSmryVO .class,""));
