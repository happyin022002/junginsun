...
*@FileName : EES_EQR_1102HTMLAction.java
 ...
 * @see EesEqr1102Event , EES_EQR_1007EventResponse 참조
 * @since J2EE 1.4
 */
@SuppressWarnings("serial")
public class EES_EQR_1102HTMLAction extends HTMLActionSupport {

	/**
	 * EES_EQR_1007HTMLAction 객체를 생성
	 */
	public EES_EQR_1102HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesEqr1102Event event = new EesEqr1102Event();
