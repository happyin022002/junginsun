...
*@FileName : CntrPlanGuidelineManageDBDAODelDischargingGuidelineDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAODelDischargingGuidelineDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete DischargingGuideline
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAODelDischargingGuidelineDSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAODelDischargingGuidelineDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE EQR_CTRL_DCHG_GLINE" ).append("\n"); 
