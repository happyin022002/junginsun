...
*@FileName : EES_MNR_0212HTMLAction.java
...
public class EES_MNR_0212HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0212HTMLAction 객체를 생성
	 */
	public EES_MNR_0212HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesMnr0212Event event = new EesMnr0212Event();
    	OfficeInfoGRPVO officeInfoGRPVO = new OfficeInfoGRPVO();
    	OfficeCodeINVO officeCodeINVO    = new OfficeCodeINVO();
    	officeCodeINVO.setOfcCd(request.getParameter("ofc_cd"));
    	officeInfoGRPVO.setOfficeCodeINVO(officeCodeINVO);
    	//grpvo.setOfficeCodeINVO((OfficeCodeINVO)getVO(request, OfficeCodeINVO.class));
    	//if(command.isCommand(FormCommand.SEARCH)) {
	    event.setOfficeInfoGRPVO(officeInfoGRPVO);
		//}
