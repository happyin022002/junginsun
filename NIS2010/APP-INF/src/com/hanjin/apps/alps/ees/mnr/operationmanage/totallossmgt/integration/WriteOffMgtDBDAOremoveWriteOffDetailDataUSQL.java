...
*@FileName : WriteOffMgtDBDAOremoveWriteOffDetailDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WriteOffMgtDBDAOremoveWriteOffDetailDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WriteOffMgtDBDAOremoveWriteOffDetailDataUSQL(){
		setQuery();
		...
		query.append("FileName : WriteOffMgtDBDAOremoveWriteOffDetailDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET WRTF_NO = ''," ).append("\n"); 
		query.append("WRTF_CLT_AMT = ''," ).append("\n"); 
