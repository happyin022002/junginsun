...
*@FileName : EES_MNR_0238HTMLAction.java
...
public class EES_MNR_0238HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0238HTMLAction 객체를 생성
	 */
	public EES_MNR_0238HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0238Event event = new EesMnr0238Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRepairPFMCByWOINVO((RepairPFMCByWOINVO)getVO(request, RepairPFMCByWOINVO .class));
		}
