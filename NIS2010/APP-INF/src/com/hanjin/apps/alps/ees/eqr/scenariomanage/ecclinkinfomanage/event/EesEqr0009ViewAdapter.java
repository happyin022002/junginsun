...
*@FileName : EesEqr0009ViewAdapter.java
*@FileTitle : EesEqr0009ViewAdapter
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.5
 */
public class EesEqr0009ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		EesEqr0009ConditionVO conditionVO = (EesEqr0009ConditionVO) commonRsVO.getConditionVO();
