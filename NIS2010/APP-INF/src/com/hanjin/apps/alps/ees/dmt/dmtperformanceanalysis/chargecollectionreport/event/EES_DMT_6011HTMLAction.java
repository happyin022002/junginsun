...
public class EES_DMT_6011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_6011HTMLAction 객체를 생성
	 */
	public EES_DMT_6011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt6011Event event = new EesDmt6011Event();
		

		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setYearlyCollectionByRHQVO((YearlyCollectionByRHQVO)getVO(request, YearlyCollectionByRHQVO .class));
