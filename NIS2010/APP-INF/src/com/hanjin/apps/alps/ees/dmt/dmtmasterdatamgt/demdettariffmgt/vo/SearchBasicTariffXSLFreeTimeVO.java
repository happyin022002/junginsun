...
*@FileName : SearchBasicTariffXSLFreeTimeVO.java
*@FileTitle : SearchBasicTariffXSLFreeTimeVO
*Open Issues :
*Change history :
...
public class SearchBasicTariffXSLFreeTimeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBasicTariffXSLFreeTimeVO> models = new ArrayList<SearchBasicTariffXSLFreeTimeVO>();
	...
	public SearchBasicTariffXSLFreeTimeVO() {}

	public SearchBasicTariffXSLFreeTimeVO(String ibflag, String pagerows, String svrId, String dmdtTrfCd, String trfSeq, String trfGrpSeq, String trfFtSeq, String ftFmQty, String freeTime, String ftDys, String creUsrId, String creDt, String creOfcCd, String updUsrId, String updDt, String updOfcCd, String usrId, String ofcCd, String dmdtDeTermCd, String dmdtDeTermNm ) {
		this.updDt = updDt;
	 ...
	 */
	public SearchBasicTariffXSLFreeTimeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBasicTariffXSLFreeTimeVO[]
	 */
	public SearchBasicTariffXSLFreeTimeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBasicTariffXSLFreeTimeVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBasicTariffXSLFreeTimeVO();
				if (updDt[i] != null)
		...
		return getSearchBasicTariffXSLFreeTimeVOs();
	}
	 ...
	 * @return SearchBasicTariffXSLFreeTimeVO[]
	 */
	public SearchBasicTariffXSLFreeTimeVO[] getSearchBasicTariffXSLFreeTimeVOs(){
		SearchBasicTariffXSLFreeTimeVO[] vos = (SearchBasicTariffXSLFreeTimeVO[])models.toArray(new SearchBasicTariffXSLFreeTimeVO[models.size()]);
		return vos;
	}
