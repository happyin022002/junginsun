...
public class SummaryReportByCustomerVO extends AbstractValueObject {
	...
	/* Column Info */
	private String bzFtDys = null;
	/* Column Info */
	private String exFtDys = null;
	/* Column Info */
	private String usedFt = null;
	/* Column Info */
	private String stygDys = null;
	/* Column Info */
	private String arIfCntr = null;
	/* Column Info */
	private String arIfAmt = null;
	...
	public SummaryReportByCustomerVO(String ibflag, String pagerows, String ord, String scNo, String rfaNo, String scRfaNo, String custCd, String custNm, String ctrtOfc, String dmdtOfc, String trfCd, String cvrCd, String porCd, String polCd, String podCd, String delCd, String ttlSty, String ttlCntr, String avgSty, String ttlOver, String overCntr, String avgOver, String currCd, String incurCntr, String incurAmt, String cmdtCntr, String cmdtAmt, String exptCntr, String exptAmt, String dcCntr, String dcAmt, String billCntr, String bzFtDys, String exFtDys, String usedFt, String stygDys, String billAmt, String invCntr, String invAmt, String collCntr, String collAmt, String arIfCntr, String arIfAmt) {
		...
		this.bzFtDys = bzFtDys;
		this.exFtDys = exFtDys;
		this.usedFt = usedFt;
		this.stygDys = stygDys;
		this.arIfCntr = arIfCntr;
		this.arIfAmt = arIfAmt;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bz_ft_dys", getBzFtDys());
		this.hashColumns.put("ex_ft_dys", getExFtDys());
		this.hashColumns.put("used_ft", getUsedFt());
		this.hashColumns.put("styg_dys", getStygDys());
		this.hashColumns.put("ar_if_cntr", getArIfCntr());
		this.hashColumns.put("ar_if_amt", getArIfAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("bz_ft_dys", "bzFtDys");
		this.hashFields.put("ex_ft_dys", "exFtDys");
		this.hashFields.put("used_ft", "usedFt");
		this.hashFields.put("styg_dys", "stygDys");
		this.hashFields.put("ar_if_cntr", "arIfCntr");
		this.hashFields.put("ar_if_amt", "arIfAmt");
	 ...
	 * @param bzFtDys
	 */
	public void setBzFtDys(String bzFtDys) {
		this.bzFtDys = bzFtDys;
	}
	 ...
	 * @param exFtDys
	 */
	public void setExFtDys(String exFtDys) {
		this.exFtDys = exFtDys;
	}
	 ...
	 * @param usedFt
	 */
	public void setUsedFt(String usedFt) {
		this.usedFt = usedFt;
	}
	 ...
	 * @param stygDys
	 */
	public void setStygDys(String stygDys) {
		this.stygDys = stygDys;
	}
	
	public String getArIfCntr() {
		return arIfCntr;
	}

	public void setArIfCntr(String arIfCntr) {
		this.arIfCntr = arIfCntr;
	}

	public String getArIfAmt() {
		return arIfAmt;
	}

	public void setArIfAmt(String arIfAmt) {
		this.arIfAmt = arIfAmt;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setBzFtDys(JSPUtil.getParameter(request, prefix + "bz_ft_dys", ""));
		setExFtDys(JSPUtil.getParameter(request, prefix + "ex_ft_dys", ""));
		setUsedFt(JSPUtil.getParameter(request, prefix + "used_ft", ""));
		setStygDys(JSPUtil.getParameter(request, prefix + "styg_dys", ""));
		setArIfCntr(JSPUtil.getParameter(request, prefix + "ar_if_cntr", ""));
		setArIfAmt(JSPUtil.getParameter(request, prefix + "ar_if_amt", ""));
	}
	...
	public SummaryReportByCustomerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] bzFtDys = (JSPUtil.getParameter(request, prefix	+ "bz_ft_dys", length));
			String[] exFtDys = (JSPUtil.getParameter(request, prefix	+ "ex_ft_dys", length));
			String[] usedFt = (JSPUtil.getParameter(request, prefix	+ "used_ft", length));
			String[] stygDys = (JSPUtil.getParameter(request, prefix	+ "styg_dys", length));
			String[] arIfCntr = (JSPUtil.getParameter(request, prefix	+ "ar_if_cntr", length));
			String[] arIfAmt = (JSPUtil.getParameter(request, prefix	+ "ar_if_amt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (bzFtDys[i] != null)
					model.setBzFtDys(bzFtDys[i]);
				if (exFtDys[i] != null)
					model.setExFtDys(exFtDys[i]);
				if (usedFt[i] != null)
					model.setUsedFt(usedFt[i]);
				if (stygDys[i] != null)
					model.setStygDys(stygDys[i]);
				if (arIfCntr[i] != null)
					model.setArIfCntr(arIfCntr[i]);
				if (arIfAmt[i] != null)
					model.setArIfAmt(arIfAmt[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.bzFtDys = this.bzFtDys .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	    this.exFtDys = this.exFtDys .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	    this.usedFt = this.usedFt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	    this.stygDys = this.stygDys .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	    this.arIfCntr = this.arIfCntr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	    this.arIfAmt = this.arIfAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
