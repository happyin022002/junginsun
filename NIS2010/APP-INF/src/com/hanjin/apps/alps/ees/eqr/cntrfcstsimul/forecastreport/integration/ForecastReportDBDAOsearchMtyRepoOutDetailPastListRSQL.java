...
*@FileName : ForecastReportDBDAOsearchMtyRepoOutDetailPastListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOsearchMtyRepoOutDetailPastListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Reposition Out Detail 세부데이터 조회
	  * </pre>
	  */
	public ForecastReportDBDAOsearchMtyRepoOutDetailPastListRSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOsearchMtyRepoOutDetailPastListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("WITH REPO_OUT_RESULT AS (  " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("        AND   A.WKY_SIM_TP_CD = 'RO'" ).append("\n"); 
		...
		query.append(" " ).append("\n"); 
		query.append("    FROM REPO_OUT_RESULT       " ).append("\n"); 
