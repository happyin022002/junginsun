...
*@FileName : TimeClockStopMgtDBDAODmtTimeClockStopCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TimeClockStopMgtDBDAODmtTimeClockStopCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INSERT DmtTimeClockStop
	  * </pre>
	  */
	public TimeClockStopMgtDBDAODmtTimeClockStopCSQL(){
		setQuery();
		...
		query.append("FileName : TimeClockStopMgtDBDAODmtTimeClockStopCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("             @[upd_ofc_cd]," ).append("\n"); 
		query.append("             @[all_yd_flg]," ).append("\n"); 
		query.append("             Trim(@[dmdt_bkg_term_ctnt])" ).append("\n"); 
		query.append("            )" ).append("\n"); 
