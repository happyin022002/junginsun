...
*@FileName : LongstayingUnclaimEQFlaggingDBDAOSearchEqSplsDfctStsRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LongstayingUnclaimEQFlaggingDBDAOSearchEqSplsDfctStsRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [EES_CIM_0060] EQ Balance Report Input
	  * => 저장전 데이터 분류를 위한 확인 조회
	  * </pre>
	  */
	public LongstayingUnclaimEQFlaggingDBDAOSearchEqSplsDfctStsRSQL(){
		setQuery();
		...
		query.append("FileName : LongstayingUnclaimEQFlaggingDBDAOSearchEqSplsDfctStsRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT * FROM CIM_EQ_SPLS_DFCT_STS" ).append("\n"); 
