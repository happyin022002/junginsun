...
public class DisposalCandidateFlagINVO extends AbstractValueObject {
	...
	public DisposalCandidateFlagINVO(String ibflag, String pagerows, String selectCd, String costOfcCd, String fryear, String fGubuns, String mnrDispTrfTpCd, String eqKndCd, String eqTpszCd, String tocal, String toyear, String locationCd, String fromcal, String rqstEqNo) {
...
/**
	...
	public DisposalCandidateFlagINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] selectCd = (JSPUtil.getParameter(request, prefix	+ "select_cd", length));
			String[] costOfcCd = (JSPUtil.getParameter(request, prefix	+ "cost_ofc_cd", length));
			String[] fryear = (JSPUtil.getParameter(request, prefix	+ "fryear", length));
			...
			String[] toyear = (JSPUtil.getParameter(request, prefix	+ "toyear", length));
