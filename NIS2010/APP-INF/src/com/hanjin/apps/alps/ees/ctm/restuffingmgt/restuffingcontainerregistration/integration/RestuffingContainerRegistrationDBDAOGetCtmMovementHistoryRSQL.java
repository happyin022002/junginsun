...
public class RestuffingContainerRegistrationDBDAOGetCtmMovementHistoryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SUBSTR (CNTR_NO, 0, 10) AS CNTR_NO," ).append("\n"); 
		query.append("SUBSTR (CNTR_NO, 11, 1) AS CHECK_DIGIT," ).append("\n"); 
		...
		query.append("WHERE CNTR_NO = @[cntr_no]||@[check_digit]" ).append("\n"); 
		query.append("#if (${flg} == '1')" ).append("\n"); 
