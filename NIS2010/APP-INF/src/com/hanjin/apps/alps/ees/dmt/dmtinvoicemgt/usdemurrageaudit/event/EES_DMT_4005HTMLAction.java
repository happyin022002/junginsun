...
*@FileName : EES_DMT_4005HTMLAction.java
...
public class EES_DMT_4005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_4005HTMLAction 객체를 생성
	 */
	public EES_DMT_4005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt4005Event event = new EesDmt4005Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setChargeForAuditParmVOS((ChargeForAuditParmVO[])getVOs(request, ChargeForAuditParmVO .class, ""));
