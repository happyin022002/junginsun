...
*@FileName : MDM_CURRENCYHTMLAction.java
...
public class CGM_CURRENCYHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * MDM_CURRENCYHTMLAction 객체를 생성
	 */
	public CGM_CURRENCYHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CgmCurrencyEvent event = new CgmCurrencyEvent();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMdmCurrencyMGTVO((MdmCurrencyMGTVO)getVO(request, MdmCurrencyMGTVO .class));
		}
