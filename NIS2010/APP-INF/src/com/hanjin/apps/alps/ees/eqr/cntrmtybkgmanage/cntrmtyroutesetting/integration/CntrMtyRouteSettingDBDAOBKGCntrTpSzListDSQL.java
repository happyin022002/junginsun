...
*@FileName : CntrMtyRouteSettingDBDAOBKGCntrTpSzListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrMtyRouteSettingDBDAOBKGCntrTpSzListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CntrMtyRouteSettingDBDAOBKGCntrTpSzList
	  * </pre>
	  */
	public CntrMtyRouteSettingDBDAOBKGCntrTpSzListDSQL(){
		setQuery();
		...
		query.append("FileName : CntrMtyRouteSettingDBDAOBKGCntrTpSzListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
