...
*@FileName : ScenarioDefaultManageDBDAODeleteYearDomesticPlanDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScenarioDefaultManageDBDAODeleteYearDomesticPlanDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * eqr_dmst_pln 테이블 데이터 삭제
	  * </pre>
	  */
	public ScenarioDefaultManageDBDAODeleteYearDomesticPlanDSQL(){
		setQuery();
		...
		query.append("FileName : ScenarioDefaultManageDBDAODeleteYearDomesticPlanDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_DMST_PLN" ).append("\n"); 
