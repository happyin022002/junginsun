...
*@FileName : EES_MNR_0266HTMLAction.java
...
public class EES_MNR_0266HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * EES_MNR_0266HTMLAction 객체를 생성
	 */
	public EES_MNR_0266HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0266Event event = new EesMnr0266Event();

		if(command.isCommand(FormCommand.MULTI)){
			event.setRFVessleSparePartCodeVO((RFVessleSparePartCodeVO)getVO(request, RFVessleSparePartCodeVO.class));
			event.setRFVessleSparePartCodeVOs((RFVessleSparePartCodeVO[])getVOs(request, RFVessleSparePartCodeVO .class));
		}	
