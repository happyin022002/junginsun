...
*@FileName : RepairMgtDBDAOsearchUsedEstimateByAGMTDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOsearchUsedEstimateByAGMTDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchUsedEstimateByAGMTData
	  * </pre>
	  */
	public RepairMgtDBDAOsearchUsedEstimateByAGMTDataRSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOsearchUsedEstimateByAGMTDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND RPR_STS_CD <> 'HD'" ).append("\n"); 
