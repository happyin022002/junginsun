...
*@FileName : EesEqr1083ConditionVO.java
*@FileTitle : EesEqr1083ConditionVO
*Open Issues :
*Change history :
...
public class EesEqr1083ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1083ConditionVO> models = new ArrayList<EesEqr1083ConditionVO>();
	...
	public EesEqr1083ConditionVO() {}

	public EesEqr1083ConditionVO(String ibflag, String pagerows, String repoPlnId, String searchFlag, String repoFlag, String fcastYrwk, String locCd, String locGrpCd, String inpYrwk, String tpCd, String repoPlnYrwk, String wkStDt, String wkEndDt, String currFlag, String yard) {
...
/**
	 ...
	 */
	public EesEqr1083ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1083ConditionVO[]
	 */
	public EesEqr1083ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1083ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1083ConditionVO();
		...
		return getEesEqr1083ConditionVOs();
	}
	...
	public EesEqr1083ConditionVO[] getEesEqr1083ConditionVOs(){
		EesEqr1083ConditionVO[] vos = (EesEqr1083ConditionVO[])models.toArray(new EesEqr1083ConditionVO[models.size()]);
		return vos;
	}
