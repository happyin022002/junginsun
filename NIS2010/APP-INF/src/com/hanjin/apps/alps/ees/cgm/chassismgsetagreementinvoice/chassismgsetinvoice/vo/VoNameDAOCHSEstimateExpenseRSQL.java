...
*@FileName : VoNameDAOCHSEstimateExpenseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VoNameDAOCHSEstimateExpenseRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VoNameDAOCHSEstimateExpenseRSQL
	  * </pre>
	  */
	public VoNameDAOCHSEstimateExpenseRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.vo").append("\n"); 
		query.append("FileName : VoNameDAOCHSEstimateExpenseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
