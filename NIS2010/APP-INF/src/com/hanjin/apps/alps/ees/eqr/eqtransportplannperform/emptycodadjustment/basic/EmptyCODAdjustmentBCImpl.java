...
/**
 * ALPS-EQTransportPlanNPerform Business Logic Basic Command implementation<br>
 * - ALPS-EQTransportPlanNPerform에 대한 비지니스 로직을 처리한다.<br>
 * 
...
public class EmptyCODAdjustmentBCImpl extends BasicCommandSupport implements EmptyCODAdjustmentBC {
	...
	public List<MTYREPOByPeriodVO> searchMTYREPOByPeriod(MTYREPOByPeriodOptionVO mTYREPOByPeriodOptionVO)
		...
		try {
		//	log.debug("####### EQTransportPlanNPerformSC.searchMTYREPOByPeriod 1043 시작");
		...
		//	log.debug("####### EQTransportPlanNPerformSC.searchMTYREPOByPeriod 1043 끝");
			return list2;
