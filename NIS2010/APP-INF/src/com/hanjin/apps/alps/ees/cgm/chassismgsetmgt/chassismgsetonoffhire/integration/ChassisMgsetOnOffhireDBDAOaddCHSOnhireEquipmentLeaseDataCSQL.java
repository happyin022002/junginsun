...
*@FileName : ChassisMgsetOnOffhireDBDAOaddCHSOnhireEquipmentLeaseDataCSQL.java
...
public class ChassisMgsetOnOffhireDBDAOaddCHSOnhireEquipmentLeaseDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOaddCHSOnhireEquipmentLeaseDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOaddCHSOnhireEquipmentLeaseDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
