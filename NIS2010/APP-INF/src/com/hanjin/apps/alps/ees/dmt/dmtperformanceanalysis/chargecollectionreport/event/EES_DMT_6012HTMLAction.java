...
public class EES_DMT_6012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_6012HTMLAction 객체를 생성
	 */
	public EES_DMT_6012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt6012Event event = new EesDmt6012Event();
		

		if(command.isCommand(FormCommand.SEARCH01) || command.isCommand(FormCommand.SEARCH)) {
			event.setTmnlVvdLfdVO((TmnlVvdLfdVO)getVO(request, TmnlVvdLfdVO .class));
		}
