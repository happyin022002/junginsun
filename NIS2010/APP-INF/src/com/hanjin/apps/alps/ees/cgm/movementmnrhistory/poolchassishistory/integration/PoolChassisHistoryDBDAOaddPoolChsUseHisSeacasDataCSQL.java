...
public class PoolChassisHistoryDBDAOaddPoolChsUseHisSeacasDataCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("@[chss_no]" ).append("\n"); 
		query.append(", to_date(@[onh_dt],'DD-MON-YY HH24:MI:SS', 'NLS_DATE_LANGUAGE = American')" ).append("\n"); 
		query.append(", decode(@[offh_dt],null,null,'NULL',null,'null',null,'',null,to_date(@[offh_dt],'DD/MON/yy HH24:MI:SS', 'NLS_DATE_LANGUAGE = American') )" ).append("\n"); 
		query.append(", @[pool_chss_usd_dys]" ).append("\n"); 
