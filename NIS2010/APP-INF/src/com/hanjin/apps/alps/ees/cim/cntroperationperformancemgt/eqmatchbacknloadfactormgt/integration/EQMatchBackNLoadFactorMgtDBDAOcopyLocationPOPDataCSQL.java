...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOcopyLocationPOPDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOcopyLocationPOPDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQMatchBackNLoadFactorMgtDBDAOcopyLocationPOPDataCSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOcopyLocationPOPDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("USR_ID || 'SAVEFORMAT'" ).append("\n"); 
		query.append(",RCC_CD" ).append("\n"); 
		query.append(",ECC_CD" ).append("\n"); 
		query.append(",ECC_LVL" ).append("\n"); 
		query.append(",USE_FLG" ).append("\n"); 
