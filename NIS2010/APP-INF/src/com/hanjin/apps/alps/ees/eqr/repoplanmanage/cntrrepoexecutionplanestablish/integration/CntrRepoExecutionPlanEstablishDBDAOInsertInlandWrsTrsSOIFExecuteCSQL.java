...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * WRS-->TRS--> EQR 로 전해진 SO IF EXECUTE 정보 입력  대상테이블 : EQR_INLND_TRSP_EXE_PLN
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
