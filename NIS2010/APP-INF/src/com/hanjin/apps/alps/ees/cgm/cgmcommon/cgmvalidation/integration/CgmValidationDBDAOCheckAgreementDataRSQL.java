...
*@FileName : CgmValidationDBDAOCheckAgreementDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmValidationDBDAOCheckAgreementDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CgmValidationDBDAOCheckAgreementDataRSQL(){
		setQuery();
		...
		query.append("FileName : CgmValidationDBDAOCheckAgreementDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
