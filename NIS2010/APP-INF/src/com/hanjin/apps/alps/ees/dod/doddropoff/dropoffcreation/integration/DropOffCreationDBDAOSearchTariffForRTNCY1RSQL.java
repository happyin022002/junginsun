...
*@FileName : DropOffCreationDBDAOSearchTariffForRTNCY1RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DropOffCreationDBDAOSearchTariffForRTNCY1RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DropOffCreationDBDAOSearchTariffForRTNCY1RSQL(){
		setQuery();
		...
		query.append("FileName : DropOffCreationDBDAOSearchTariffForRTNCY1RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("						   " ).append("\n"); 
		query.append("          FROM BKG_EUR_TRO G," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("           AND G.IO_BND_CD = 'I'" ).append("\n"); 
