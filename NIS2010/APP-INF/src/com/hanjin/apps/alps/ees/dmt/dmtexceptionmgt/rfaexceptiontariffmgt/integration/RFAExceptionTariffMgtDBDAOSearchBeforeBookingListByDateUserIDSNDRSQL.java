...
*@FileName : RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserIDSNDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserIDSNDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(RFA DATE, Sent)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserIDSNDRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserIDSNDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
