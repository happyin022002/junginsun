...
*@FileName : ChargeCalculationDBDAOModifyChargeDeletionRequestStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOModifyChargeDeletionRequestStatusUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOModifyChargeDeletionRequestStatusUSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOModifyChargeDeletionRequestStatusUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOModifyChargeDeletionRequestStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("update  DMT_CHG_DELT_RQST_APRO  T1" ).append("\n"); 
		query.append("set  T1.DMDT_DELT_RQST_STS_CD = @[dmdt_delt_rqst_sts_cd]" ).append("\n"); 
		query.append(",T1.UPD_USR_ID            = @[cre_usr_id]" ).append("\n"); 
		query.append(",T1.UPD_DT                = nvl(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[cre_ofc_cd]), sysdate)" ).append("\n"); 
		query.append(",T1.UPD_OFC_CD            = @[cre_ofc_cd]" ).append("\n"); 
		query.append(",T1.INACT_APRO_NO         = @[inact_apro_no]" ).append("\n"); 
