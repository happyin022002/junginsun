...
//	}		 
 ...
 /**
	 ...
	 */
	 @SuppressWarnings("unchecked")
	public List<SalesFcstDtlVO> searchEqFcstDetail(SalesFcstDtlVO salesFcstDtlVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<SalesFcstDtlVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			if(salesFcstDtlVO != null) {
				Map<String, String> mapVO = salesFcstDtlVO.getColumnValues();
				
				param.putAll(mapVO);
				velParam.putAll(mapVO);
			}
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MTYEquipmentForecastDBDAOsearchEqFcstDetailRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, SalesFcstDtlVO .class);
	 ...
	 * @return List<SalesProjectionHistVO>
	 * @exception EventException
	 */
	 @SuppressWarnings("unchecked")
	public List<SalesProjectionHistVO> searchEqFcstHist(SalesProjectionHistVO salesProjectionHistVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<SalesProjectionHistVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			if(salesProjectionHistVO != null) {
				Map<String, String> mapVO = salesProjectionHistVO.getColumnValues();
				
				param.putAll(mapVO);
				velParam.putAll(mapVO);
			}
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MTYEquipmentForecastDBDAOsearchEqFcstHistRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, SalesProjectionHistVO .class);
