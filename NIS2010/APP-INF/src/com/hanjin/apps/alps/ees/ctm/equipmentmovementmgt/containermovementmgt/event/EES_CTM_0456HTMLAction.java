...
*@FileName : EES_CTM_0456HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0456HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0456HTMLAction 객체를 생성
	 */
	public EES_CTM_0456HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0456Event event = new EesCtm0456Event();

		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchPreVLVDListVOS((SearchPreVLVDListVO[])getVOs(request, SearchPreVLVDListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchPreVLVDListVO((SearchPreVLVDListVO)getVO(request, SearchPreVLVDListVO .class));
		}
