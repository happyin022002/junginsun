...
public class PoolChassisHistoryDBDAOsearchPoolMvmtCompareDtlDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",HJS_ONHDT" ).append("\n"); 
		query.append(",HJS_ONHYD" ).append("\n"); 
		query.append(",HJS_OFFHDT" ).append("\n"); 
		query.append(",HJS_OFFHYD" ).append("\n"); 
		query.append(",HJS_USDY" ).append("\n"); 
		...
		query.append(",HJS_OFFHYD" ).append("\n"); 
		query.append(",HJS_USDY" ).append("\n"); 
		query.append(",SUM(HJS_USDY) OVER (PARTITION BY CHSS_NO,CNTR_NO) HJS_SMRY" ).append("\n"); 
		query.append(",MGMT_ONHDT" ).append("\n"); 
		query.append(",MGMT_ONHYD" ).append("\n"); 
		query.append(",MGMT_OFFHDT" ).append("\n"); 
		query.append(",MGMT_OFFHYD" ).append("\n"); 
		...
		query.append("CHSS_NO" ).append("\n"); 
		query.append(",CNTR_NO" ).append("\n"); 
		query.append(", NVL(HJS_ONHDT , MGMT_ONHDT)  ONHDT" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if ( ${gubun} == 'M'  )" ).append("\n"); 
		query.append("and nvl(HJS_SMRY,9999999999) = nvl(MGMT_SMRY      ,9999999999)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("and nvl(HJS_SMRY,9999999999) <>  nvl(MGMT_SMRY      ,9999999999)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
