...
*@FileName : DemandNoteSendDBDAOSearchSheetOptionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemandNoteSendDBDAOSearchSheetOptionRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemandNoteSendDBDAOSearchSheetOptionRSQL(){
		setQuery();
		...
		query.append("FileName : DemandNoteSendDBDAOSearchSheetOptionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
