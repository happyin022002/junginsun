...
*@FileName : ESS_MNR_0056HTMLAction.java
...
public class EES_MNR_0056HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0009HTMLAction 객체를 생성
	 */
	public EES_MNR_0056HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0056Event event = new EesMnr0056Event();
		//저장
		if(command.isCommand(FormCommand.MULTI)) { 
			event.setRFSparePartInventoryListVOs((RFSparePartInventoryListVO[])getVOs(request, RFSparePartInventoryListVO .class,"sheet1_"));

		}
		//조회
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setRFSparePartInventoryMgtINVO((RFSparePartInventoryMgtINVO)getVO(request, RFSparePartInventoryMgtINVO .class));
		}     
