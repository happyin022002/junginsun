 ...
 * @since J2EE 1.5
 */
public class EesEqr1059ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(DBRowSet rs,String prefix) {
		...
		try{
			...
			while (rs.next()) { 
				if( rs.getString("COLOR").equals("0") ) {
					rowBgColor = "";
				} else if( rs.getString("COLOR").equals("1") ) {
					rowBgColor = " BGCOLOR=\"201,213,235\" ";
				} else if( rs.getString("COLOR").equals("2") ) {
					rowBgColor = " BGCOLOR=\"236,231,247\" ";
				} else if( rs.getString("COLOR").equals("3") ) {
