...
*@FileName : ChsMgsSendGWAgreementInfoDBDAO.java
...
/**
 * ALPS ChsMgsSendGWAgreementInfoDBDAO <br>
 * - ALPS - G/W 전송 xmlData Agreement Info를 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author Chang Young Kim
 * @see ChsMgsSendGWAgreementInfoBCImpl 참조
 * @since J2EE 1.4
 */
public class ChsMgsSendGWAgreementInfoDBDAO extends DBDAOSupport {
	...
	public List<ComCsrRequestAgmtVO> printComCsrAgmtInfo(String csrNo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new ChsMgsSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL(), param, velParam);		  
	...
	public List<ComCsrRequestAgmtVO> printComCsrAgmtInfo2(String csrNo) throws DAOException {
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new ChsMgsSendGWAgreementInfoDBDAOPrintComCsrAgmtInfo2RSQL(), param, velParam);		  
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, ComCsrRequestAgmtVO.class);		 
