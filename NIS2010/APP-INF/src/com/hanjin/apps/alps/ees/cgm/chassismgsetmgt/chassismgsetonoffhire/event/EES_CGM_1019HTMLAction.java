...
*@FileName : EES_CGM_1019HTMLAction.java
...
public class EES_CGM_1019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1019HTMLAction 객체를 생성
	 */
	public EES_CGM_1019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1019Event event = new EesCgm1019Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsLostResultINVO((CHSLostResultINVO)getVO(request, CHSLostResultINVO .class));
		}
