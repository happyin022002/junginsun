...
*@FileName : EES_LSE_0102HTMLAction.java
...
public class EES_LSE_0102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0102HTMLAction 객체를 생성
	 */
	public EES_LSE_0102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0102Event event = new EesLse0102Event();
		
		if ( command.isCommand(FormCommand.SEARCH) ) {
			event.setInInterrstServiceVO((InInterrstServiceVO)getVO(request, InInterrstServiceVO .class));
		} 
