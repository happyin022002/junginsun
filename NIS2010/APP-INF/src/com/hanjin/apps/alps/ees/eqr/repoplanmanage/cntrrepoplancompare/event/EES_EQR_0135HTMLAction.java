...
*@FileName : EES_EQR_0135HTMLAction.java
...
public class EES_EQR_0135HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0135HTMLAction 객체를 생성
	 */
	public EES_EQR_0135HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0135Event event = new EesEqr0135Event();
		
		event.setEesEqr0135ConditionVO((EesEqr0135ConditionVO)getVO(request, EesEqr0135ConditionVO .class));
