...
*@FileName : CntrPlanGuidelineManageDBDAOCheckGuidelineKeyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAOCheckGuidelineKeyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_GLINE_HDR PK CHECK
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAOCheckGuidelineKeyRSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAOCheckGuidelineKeyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL2(EQ_GLINE_SEQ,'Y','N') CHECK_FLG" ).append("\n"); 
		query.append("  FROM ${table_name} A" ).append("\n"); 
		...
		query.append("   AND A.EQ_GLINE_SEQ = @[eq_gline_seq]" ).append("\n"); 
