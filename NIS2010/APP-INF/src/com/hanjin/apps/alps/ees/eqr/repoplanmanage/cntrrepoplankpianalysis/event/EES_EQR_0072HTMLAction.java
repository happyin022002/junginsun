...
*@FileName : EES_EQR_0072HTMLAction.java
...
public class EES_EQR_0072HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0072HTMLAction 객체를 생성
	 */
	public EES_EQR_0072HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0072Event event = new EesEqr0072Event();
		
		event.setEesEqr0072ConditionVO((EesEqr0072ConditionVO)getVO(request, EesEqr0072ConditionVO .class));
