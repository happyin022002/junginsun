 ...
 * @since J2EE 1.5   
 */
public class EesCim10162ViewAdapter extends ViewAdapter {
...
//	                int colCnt = realColNms.length;
	                ...
	                String xTpsz = JSPUtil.getNull(colValues.get("tpsz"));
	                sbufXML.append("<TD ><![CDATA["+ JSPUtil.getNull(colValues.get("loccode"))+"]]></TD>\n");
					if(xTpsz.equals("Average")){
		                sbufXML.append("<TD BGCOLOR ='201, 213, 235'><![CDATA["+ xTpsz+"]]></TD>\n");
		                sbufXML.append("<TD BGCOLOR ='201, 213, 235'><![CDATA["+ JSPUtil.getNull(colValues.get("division"))+"]]></TD>\n");
		                sbufXML.append("<TD BGCOLOR ='201, 213, 235'><![CDATA["+ JSPUtil.getNull(colValues.get("total"))+"]]></TD>\n");
		                String num = "";
		                int xx = 1;
		                for (int j = 0 ; j < 26 ; j++) {
							if(xx < 10){
...
//                            double xTempVal = Double.parseDouble(xTempStrVal);
                            sbufXML.append("<TD BGCOLOR ='201, 213, 235'><![CDATA["+xTempStrVal+"]]></TD>\n");
		                        
		                    
		                } // for (int j = 0 ; j < 26 ; j++) {
					}
					else{
		                sbufXML.append("<TD ><![CDATA["+ xTpsz+"]]></TD>\n");
