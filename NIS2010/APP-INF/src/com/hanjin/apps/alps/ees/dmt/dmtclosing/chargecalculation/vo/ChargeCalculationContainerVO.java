...
public class ChargeCalculationContainerVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String emlRcvrAddr = null;

    /* Column Info */
    private String deltCngHisSeq = null;

    /* Column Info */
    private String deltSpecRsnRmkYn = null;

    /* Column Info */
    private String sndToEdiYn = null;

    /* Column Info */
    private String chgDeltSpecRsnRmk = null;

    /* Column Info */
    private String drCancelBtnFlg = null;
    ...
    /* Column Info */
    private String inactStsNm = null;

    /* Column Info */
    private String dmdtExptRqstStsCd = null;

    /* Column Info */
    private String dmdtExptRqstStsColor = null;
    ...
    public ChargeCalculationContainerVO(String ibflag, String pagerows, String svrId, String dmdtChgStsCd, String cntrNo, String cntrTpszCd, String fmMvmtYdCd, String toMvmtYdCd, String fmMvmtStsCd, String toMvmtStsCd, String dmdtTrfCd, String ftDys, String fxFtOvrDys, String orgFtOvrDys, String fmMvmtDt, String toMvmtDt, String ftCmncDt, String ftEndDt, String bzcTrfCurrCd, String orgChgAmt, String scRfaExptAmt, String aftExptDcAmt, String bilAmt, String bkgNo, String blNo, String vvdCd, String lane, String porCd, String polCd, String podCd, String delCd, String bkgRcvTermCd, String bkgDeTermCd, String scNo, String rfaNo, String acust, String chgType, String chgSeq, String socFlg, String li, String ch, String dO, String rlseOfc, String cltOfcCd, String ofcTrnsFlg, String rollOvr, String webIndFlg, String cntrCycNo, String dmdtChgLocDivCd, String ofcCd, String ofcRhqCd, String payerCd, String payerNm, String shipperCd, String shipperNm, String cneeCd, String cneeNm, String ntfyCd, String ntfyNm, String arActCd, String arActNm, String svcProvdrCd, String svcProvdrNm, String arCurrCd, String dmdtChgStsDesc, String dmdtInvNo, String issDt, String invChgAmt, String dmdtArIfCd, String webCreDt, String webMtyDt, String webNtfyPicNm, String vpsEtaDt, String vpsEtbDt, String vpsEtdDt, String preRlyPortCd, String pstRlyPortCd, String rdTermCd, String cmdtCd, String cmdtNm, String repCmdtCd, String repCmdtNm, String slsOfcCd, String dmdtCntrTpCd, String dmdtBkgCgoTpCd, String dmdtTrfAplyTpCd, String bzcTrfSeq, String bzcTrfGrpSeq, String rfaExptDarNo, String rfaExptMapgSeq, String rfaExptVerSeq, String rfaRqstDtlSeq, String scExptVerSeq, String scExptGrpSeq, String xcldFlgs, String corrRmk, String mtDt, String cntrInvAmt, String dmdtChgDeltRsnCd, String dmdtChgDeltSpecRsnCd, String deltSpecRsnRmkSeq, String usrId, String invDtlSeq, String partialMark, String mvmtUmchSeq, String fmMvmtYr, String fmMvmtSeq, String fmMvmtSplitNo, String toMvmtYr, String toMvmtSeq, String toMvmtSplitNo, String rfaExptAproNo, String aftExptAproNo, String aftExptDarNo, String aftExptAdjSeq, String cfmDt, String cfmUsrId, String cfmOfcCd, String creDt, String creUsrId, String calcDt, String webCreUsrId, String webNtfyPicTelcmNo, String custCntCd, String actCustSeq, String creOfcCd, String rlseDt, String custSeq, String actCntCd, String vslCd, String skdVoyNo, String skdDirCd, String ioBndCd, String webCancelFlg, String seq, String cnt, String graceEndDt, String invXchRt, String invCurrCd, String demFtEndDt, String detFtEndDt, String detFtOvrDys, String dulTpExptFlg, String cxlBkgChgFlg, String genBal, String rqstUsrId, String rqstOfcCd, String rqstDt, String deltSeq, String deltRsnDesc, String dmdtDeltRqstStsCd, String bkgQty, String incurQty, String incurCntrTeuKnt, String exptQty, String exptCntrTeuKnt, String incurAmt, String exptDys, String exptCostAmt, String bkgCntrTeu, String arIfDt, String opBkgNo, String uclmFlg, String bzcDmdtDeTermCd, String bzcDmdtDeTermNm, String notCreBalFlg, String ovrDue, String bzcTrfAplyDt, String scRfaExptAplyDt, String fmMvmtDtTime, String toMvmtDtTime, String chgOfcCd, String fileSavId, String chgDeltProcSts, String chgDeltUsrId, String chgDeltUsrYn, String chgDeltPathCd, String chgDeltStsCd, String emlSndYn, String emlSndNo, String emlRcvrAddr, String deltCngHisSeq, String deltSpecRsnRmkYn, String sndToEdiYn, String chgDeltSpecRsnRmk, String drCancelBtnFlg, String inactRqstNo, String inactAproNo, String inactStsNm, String dmdtExptRqstStsCd, String dmdtExptRqstStsColor, String dmdtExptRqstStsCdDesc, String scRfaExptOvrDys) {
        ...
        this.emlRcvrAddr = emlRcvrAddr;
        this.deltCngHisSeq = deltCngHisSeq;
        this.deltSpecRsnRmkYn = deltSpecRsnRmkYn;
        this.sndToEdiYn = sndToEdiYn;
        this.chgDeltSpecRsnRmk = chgDeltSpecRsnRmk;
        this.drCancelBtnFlg = drCancelBtnFlg;
        this.inactRqstNo = inactRqstNo;
        this.inactAproNo = inactAproNo;
        this.inactStsNm = inactStsNm;
        this.dmdtExptRqstStsCd = dmdtExptRqstStsCd;
        this.dmdtExptRqstStsColor = dmdtExptRqstStsColor;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("eml_rcvr_addr", getEmlRcvrAddr());
        this.hashColumns.put("delt_cng_his_seq", getDeltCngHisSeq());
        this.hashColumns.put("delt_spec_rsn_rmk_yn", getDeltSpecRsnRmkYn());
        this.hashColumns.put("snd_to_edi_yn", getSndToEdiYn());
        this.hashColumns.put("chg_delt_spec_rsn_rmk", getChgDeltSpecRsnRmk());
        this.hashColumns.put("dr_cancel_btn_flg", getDrCancelBtnFlg());
        this.hashColumns.put("inact_rqst_no", getInactRqstNo());
        this.hashColumns.put("inact_apro_no", getInactAproNo());
        this.hashColumns.put("inact_sts_mn", getInactStsNm());
        this.hashColumns.put("dmdt_expt_rqst_sts_cd", getDmdtExptRqstStsCd());
        this.hashColumns.put("dmdt_expt_rqst_sts_color", getDmdtExptRqstStsColor());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("eml_rcvr_addr", "emlRcvrAddr");
        this.hashFields.put("delt_cng_his_seq", "deltCngHisSeq");
        this.hashFields.put("delt_spec_rsn_rmk_yn", "deltSpecRsnRmkYn");
        this.hashFields.put("snd_to_edi_yn", "sndToEdiYn");
        this.hashFields.put("chg_delt_spec_rsn_rmk", "chgDeltSpecRsnRmk");
        this.hashFields.put("dr_cancel_btn_flg", "drCancelBtnFlg");
        this.hashFields.put("inact_rqst_no", "inactRqstNo");
        this.hashFields.put("inact_apro_no", "inactAproNo");
        this.hashFields.put("inact_sts_nm", "inactStsNm");
        this.hashFields.put("dmdt_expt_rqst_sts_cd", "dmdtExptRqstStsCd");
        this.hashFields.put("dmdt_expt_rqst_sts_color", "dmdtExptRqstStsColor");
	 ...
	 * @return emlRcvrAddr
	 */
    public String getEmlRcvrAddr() {
        return this.emlRcvrAddr;
    }
    ...
    /**
	 * Column Info
	 * @return deltSpecRsnRmkYn
	 */
    public String getDeltSpecRsnRmkYn() {
        return this.deltSpecRsnRmkYn;
    }
	 ...
	 * @return sndToEdiYn
	 */
    public String getSndToEdiYn() {
        return this.sndToEdiYn;
    }
    ...
    /**
	 * Column Info
	 * @return drCancelBtnFlg
	 */
    public String getDrCancelBtnFlg() {
        return this.drCancelBtnFlg;
    }
	 ...
	 * @param emlRcvrAddr
	 */
    public void setEmlRcvrAddr(String emlRcvrAddr) {
        this.emlRcvrAddr = emlRcvrAddr;
    }
    ...
    /**
	 * Column Info
	 * @param deltSpecRsnRmkYn
	 */
    public void setDeltSpecRsnRmkYn(String deltSpecRsnRmkYn) {
        this.deltSpecRsnRmkYn = deltSpecRsnRmkYn;
    }
	 ...
	 * @param sndToEdiYn
	 */
    public void setSndToEdiYn(String sndToEdiYn) {
        this.sndToEdiYn = sndToEdiYn;
    }
    ...
    public String getInactStsNm() {
        return inactStsNm;
    }

    public void setInactStsNm(String inactStsNm) {
        this.inactStsNm = inactStsNm;
    }

    /**
	 * Column Info
	 * @param drCancelBtnFlg
	 */
    public void setDrCancelBtnFlg(String drCancelBtnFlg) {
        this.drCancelBtnFlg = drCancelBtnFlg;
    }
    ...
    public String getDmdtExptRqstStsColor() {
        return dmdtExptRqstStsColor;
    }

    public void setDmdtExptRqstStsColor(String dmdtExptRqstStsColor) {
        this.dmdtExptRqstStsColor = dmdtExptRqstStsColor;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setEmlRcvrAddr(JSPUtil.getParameter(request, prefix + "eml_rcvr_addr", ""));
        setDeltCngHisSeq(JSPUtil.getParameter(request, prefix + "delt_cng_his_seq", ""));
        setDeltSpecRsnRmkYn(JSPUtil.getParameter(request, prefix + "delt_spec_rsn_rmk_yn", ""));
        setSndToEdiYn(JSPUtil.getParameter(request, prefix + "snd_to_edi_yn", ""));
        setChgDeltSpecRsnRmk(JSPUtil.getParameter(request, prefix + "chg_delt_spec_rsn_rmk", ""));
        setDrCancelBtnFlg(JSPUtil.getParameter(request, prefix + "dr_cancel_btn_flg", ""));
        setDrCancelBtnFlg(JSPUtil.getParameter(request, prefix + "dr_cancel_btn_flg", ""));
        ...
        setInactStsNm(JSPUtil.getParameter(request, prefix + "inact_sts_nm", ""));
        setDmdtExptRqstStsCd(JSPUtil.getParameter(request, prefix + "dmdt_expt_rqst_sts_cd", ""));
        setDmdtExptRqstStsCdDesc(JSPUtil.getParameter(request, prefix + "dmdt_expt_rqst_sts_color", ""));
        setDmdtExptRqstStsColor(JSPUtil.getParameter(request, prefix + "dmdt_expt_rqst_sts_cd_desc", ""));
    ...
    public ChargeCalculationContainerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] emlRcvrAddr = (JSPUtil.getParameter(request, prefix + "eml_rcvr_addr", length));
            String[] deltCngHisSeq = (JSPUtil.getParameter(request, prefix + "delt_cng_his_seq", length));
            String[] deltSpecRsnRmkYn = (JSPUtil.getParameter(request, prefix + "delt_spec_rsn_rmk_yn", length));
            String[] sndToEdiYn = (JSPUtil.getParameter(request, prefix + "snd_to_edi_yn", length));
            String[] chgDeltSpecRsnRmk = (JSPUtil.getParameter(request, prefix + "chg_delt_spec_rsn_rmk", length));
            String[] drCancelBtnFlg = (JSPUtil.getParameter(request, prefix + "dr_cancel_btn_flg", length));
            ...
            String[] inactStsNm = (JSPUtil.getParameter(request, prefix + "inact_sts_nm", length));
            String[] dmdtExptRqstStsCd = (JSPUtil.getParameter(request, prefix + "dmdt_expt_rqst_sts_cd", length));
            String[] dmdtExptRqstStsColor = (JSPUtil.getParameter(request, prefix + "dmdt_expt_rqst_sts_color", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (emlRcvrAddr[i] != null)
                    model.setEmlRcvrAddr(emlRcvrAddr[i]);
                if (deltCngHisSeq[i] != null)
                    model.setDeltCngHisSeq(deltCngHisSeq[i]);
                if (deltSpecRsnRmkYn[i] != null)
                    model.setDeltSpecRsnRmkYn(deltSpecRsnRmkYn[i]);
                if (sndToEdiYn[i] != null)
                    model.setSndToEdiYn(sndToEdiYn[i]);
                if (chgDeltSpecRsnRmk[i] != null)
                    model.setChgDeltSpecRsnRmk(chgDeltSpecRsnRmk[i]);
                if (drCancelBtnFlg[i] != null)
                    model.setDrCancelBtnFlg(drCancelBtnFlg[i]);
                if (inactRqstNo[i] != null)
                    model.setInactRqstNo(inactRqstNo[i]);
                if (inactAproNo[i] != null)
                    model.setInactAproNo(inactAproNo[i]);
                if (inactStsNm[i] != null)
                    model.setInactStsNm(inactStsNm[i]);
                if (dmdtExptRqstStsCd[i] != null)
                    model.setDmdtExptRqstStsCd(dmdtExptRqstStsCd[i]);
                if (dmdtExptRqstStsColor[i] != null)
                    model.setDmdtExptRqstStsColor(dmdtExptRqstStsColor[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.emlRcvrAddr = this.emlRcvrAddr.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.deltCngHisSeq = this.deltCngHisSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.deltSpecRsnRmkYn = this.deltSpecRsnRmkYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.sndToEdiYn = this.sndToEdiYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chgDeltSpecRsnRmk = this.chgDeltSpecRsnRmk.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.drCancelBtnFlg = this.drCancelBtnFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.inactStsNm = this.inactStsNm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.dmdtExptRqstStsCd = this.dmdtExptRqstStsCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.dmdtExptRqstStsColor = this.dmdtExptRqstStsColor.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
