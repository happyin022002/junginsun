...
*@FileName : WriteOffMgtDBDAOsearchWriteOffApprovalInquiryDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WriteOffMgtDBDAOsearchWriteOffApprovalInquiryDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DESC Enter..
	  * 1. [CHM-201431331] 2014-07-25, AR_HD_QTR_OFC_CD 조건추가, 신용찬
	  * </pre>
	  */
	public WriteOffMgtDBDAOsearchWriteOffApprovalInquiryDataRSQL(){
		setQuery();
		...
		query.append("FileName : WriteOffMgtDBDAOsearchWriteOffApprovalInquiryDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM MNR_TTL_LSS_RQST_HDR MTLRH" ).append("\n"); 
		query.append("    ,MNR_TTL_LSS_RQST_DTL MTLRD" ).append("\n"); 
		query.append("    ,MNR_WRTF_RQST_HDR MWRH" ).append("\n"); 
		...
		query.append("AND MTLRH.RQST_OFC_CD  = C.OFC_CD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if(${eq_knd_cd} != ''&&${eq_knd_cd} != 'ALL')" ).append("\n"); 
		query.append("	AND MTLRD.EQ_KND_CD = @[eq_knd_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${respb_ofc_cd} != '')" ).append("\n"); 
		query.append("	AND MTLRH.RESPB_OFC_CD = @[respb_ofc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
