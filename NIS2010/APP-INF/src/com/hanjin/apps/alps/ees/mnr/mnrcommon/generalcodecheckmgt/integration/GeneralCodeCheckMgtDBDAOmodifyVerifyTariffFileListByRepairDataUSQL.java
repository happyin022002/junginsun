...
*@FileName : GeneralCodeCheckMgtDBDAOmodifyVerifyTariffFileListByRepairDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeCheckMgtDBDAOmodifyVerifyTariffFileListByRepairDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 수정 - Tariff File Verify Repair
	  * </pre>
	  */
	public GeneralCodeCheckMgtDBDAOmodifyVerifyTariffFileListByRepairDataUSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeCheckMgtDBDAOmodifyVerifyTariffFileListByRepairDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND NVL(A.INP_MSG2,'') NOT IN (SELECT EQ_CEDEX_OTR_CD" ).append("\n"); 
