...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionLastApprovalStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionLastApprovalStatusRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionLastApprovalStatusRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionLastApprovalStatusRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionLastApprovalStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select  CHG_DELT_STS_CD" ).append("\n"); 
		...
		query.append("   and  T1.CHG_DELT_PATH_LVL   = " ).append("\n"); 
		query.append("        (" ).append("\n"); 
		...
		query.append("						CHG_DELT_PATH_CPLS_FLG = 'Y' or CHG_DELT_STS_CD in ('A', 'J')" ).append("\n"); 
		query.append("					)" ).append("\n"); 
		query.append("        )" ).append("\n"); 
