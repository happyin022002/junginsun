...
*@FileName : EES_CTM_0437HTMLAction.java
...
public class EES_CTM_0437HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0437HTMLAction 객체를 생성
	 */
	public EES_CTM_0437HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0437Event event = new EesCtm0437Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchCorrectionHistoryVO((SearchCorrectionHistoryVO)getVO(request, SearchCorrectionHistoryVO.class));
