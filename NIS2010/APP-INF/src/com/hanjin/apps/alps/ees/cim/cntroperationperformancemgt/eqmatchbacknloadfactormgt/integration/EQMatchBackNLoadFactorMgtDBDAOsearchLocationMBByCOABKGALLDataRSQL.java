...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByCOABKGALLDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByCOABKGALLDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchLocationMBByCOABKGALLData
	  * </pre>
	  */
	public EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByCOABKGALLDataRSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByCOABKGALLDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" 	 #end" ).append("\n"); 
		query.append("	'ALL' AS TRD1" ).append("\n"); 
		...
		query.append("	(" ).append("\n"); 
		query.append("    	 'TPS'	" ).append("\n"); 
		query.append("  		,'AES'" ).append("\n"); 
		query.append("  		,'TAS'" ).append("\n"); 
		query.append("  		,'IAS'" ).append("\n"); 
		query.append("  		,'EMS'" ).append("\n"); 
		query.append("  		,'IES'" ).append("\n"); 
		query.append("  		,'IMS'	 	" ).append("\n"); 
		query.append("	)" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("    GROUP BY C.ECC_CD,E.ECC_CD,A.SPCL_CNTR_TPSZ_CD,TRD_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
