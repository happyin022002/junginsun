...
*@FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionVersionProgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveBeforeExceptionVersionProgDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Version 에 해당되는 모든 Before Exceptio Request 의 Detail 정보가 삭제되었다면, Version Prog 정보도 삭제한다.
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveBeforeExceptionVersionProgDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveBeforeExceptionVersionProgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_RFA_EXPT_TRF_PROG" ).append("\n"); 
