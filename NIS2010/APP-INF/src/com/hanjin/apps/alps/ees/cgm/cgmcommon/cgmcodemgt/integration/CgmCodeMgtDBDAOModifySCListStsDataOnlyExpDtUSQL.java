...
*@FileName : CgmCodeMgtDBDAOModifySCListStsDataOnlyExpDtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOModifySCListStsDataOnlyExpDtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *                  S/C Exception List 의 Expiry date를 PRI 와 같은 Date로 수정
	  * ------------------------------------------------------------------------------------------------------------------------------------------------------
	  * </pre>
	  */
	public CgmCodeMgtDBDAOModifySCListStsDataOnlyExpDtUSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOModifySCListStsDataOnlyExpDtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
