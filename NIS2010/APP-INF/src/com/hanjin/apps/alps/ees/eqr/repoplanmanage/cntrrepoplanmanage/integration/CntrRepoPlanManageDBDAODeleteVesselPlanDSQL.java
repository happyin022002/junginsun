...
*@FileName : CntrRepoPlanManageDBDAODeleteVesselPlanDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAODeleteVesselPlanDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_VSL_LODG_DCHG_PLN 테이블 데이터 삭제
	  * 
	  * <Change History>
	  * 1	2009.09.22	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAODeleteVesselPlanDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanManageDBDAODeleteVesselPlanDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_VSL_LODG_DCHG_PLN" ).append("\n"); 
