...
*@FileName : MTYWeeklySimulationDBDAOcheckMtyWeeklySimulationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYWeeklySimulationDBDAOcheckMtyWeeklySimulationRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 기존에 입력된 mty weekly data가 있는지 체크한다.
	  * </pre>
	  */
	public MTYWeeklySimulationDBDAOcheckMtyWeeklySimulationRSQL(){
		setQuery();
		...
		query.append("FileName : MTYWeeklySimulationDBDAOcheckMtyWeeklySimulationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/*" ).append("\n"); 
		query.append("--  1.정의 : EQR_MTY_WKY_SIM 중복확인쿼리" ).append("\n"); 
		...
		query.append("                " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT COUNT(1) DUP " ).append("\n"); 
		query.append(" FROM EQR_MTY_WKY_SIM" ).append("\n"); 
