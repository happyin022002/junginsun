...
*@FileName : SearchRepairExpensePFMCListDataVO.java
*@FileTitle : SearchRepairExpensePFMCListDataVO
*Open Issues :
*Change history :
...
public class SearchRepairExpensePFMCListDataVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchRepairExpensePFMCListDataVO> models = new ArrayList<SearchRepairExpensePFMCListDataVO>();
	...
	public SearchRepairExpensePFMCListDataVO() {}

	public SearchRepairExpensePFMCListDataVO(String ibflag, String pagerows, String rhq, String ofcCd, String currCd, String pln511511, String pfmc511511, String pln511521, String pfmc511521, String pln511531, String pfmc511531, String pln511541, String pfmc511541, String pln511551, String pfmc511551, String pln511561, String pfmc511561) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setPln511561(JSPUtil.getParameter(request, prefix + "pln_511561", ""));
		setPln511551(JSPUtil.getParameter(request, prefix + "pln_511551", ""));
		setCurrCd(JSPUtil.getParameter(request, prefix + "curr_cd", ""));
		setPln511541(JSPUtil.getParameter(request, prefix + "pln_511541", ""));
		setPfmc511531(JSPUtil.getParameter(request, prefix + "pfmc_511531", ""));
		setPfmc511521(JSPUtil.getParameter(request, prefix + "pfmc_511521", ""));
		setPfmc511541(JSPUtil.getParameter(request, prefix + "pfmc_511541", ""));
		setPfmc511561(JSPUtil.getParameter(request, prefix + "pfmc_511561", ""));
		setPfmc511551(JSPUtil.getParameter(request, prefix + "pfmc_511551", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setOfcCd(JSPUtil.getParameter(request, prefix + "ofc_cd", ""));
		setPfmc511511(JSPUtil.getParameter(request, prefix + "pfmc_511511", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setPln511521(JSPUtil.getParameter(request, prefix + "pln_511521", ""));
		setPln511511(JSPUtil.getParameter(request, prefix + "pln_511511", ""));
		setPln511531(JSPUtil.getParameter(request, prefix + "pln_511531", ""));
	 ...
	 * @param request
	 * @return SearchRepairExpensePFMCListDataVO[]
	 */
	public SearchRepairExpensePFMCListDataVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchRepairExpensePFMCListDataVO[]
	 */
	public SearchRepairExpensePFMCListDataVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchRepairExpensePFMCListDataVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchRepairExpensePFMCListDataVO();
				if (pln511561[i] != null)
		...
		return getSearchRepairExpensePFMCListDataVOs();
	}
	 ...
	 * @return SearchRepairExpensePFMCListDataVO[]
	 */
	public SearchRepairExpensePFMCListDataVO[] getSearchRepairExpensePFMCListDataVOs(){
		SearchRepairExpensePFMCListDataVO[] vos = (SearchRepairExpensePFMCListDataVO[])models.toArray(new SearchRepairExpensePFMCListDataVO[models.size()]);
		return vos;
	}
