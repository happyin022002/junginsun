...
*@FileName : ChargeCalculationDBDAODmtChgPreCalcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAODmtChgPreCalcCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChargeCalculationDBDAODmtChgPreCalcCSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAODmtChgPreCalcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_CHG_PRE_CALC" ).append("\n"); 
		query.append("(" ).append("\n"); 
