...
*@FileName : ChassisMgsetInvoiceDBDAOAddCHSPayableAmountDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOAddCHSPayableAmountDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.AddCHSPayableAmountData
	  * 2015 조직코드개편 Chang-Young Kim
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOAddCHSPayableAmountDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOAddCHSPayableAmountDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
