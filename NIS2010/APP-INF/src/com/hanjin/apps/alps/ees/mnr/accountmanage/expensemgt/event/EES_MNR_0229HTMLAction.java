...
*@FileName : EES_MNR_0229HTMLAction.java
...
public class EES_MNR_0229HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0229HTMLAction 객체를 생성
	 */
	public EES_MNR_0229HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0229Event event = new EesMnr0229Event(); 

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGLEstimateINVO((GLEstimateINVO)getVO(request, GLEstimateINVO .class)); 
