...
*@FileName : EesCim10183ViewAdapter.java
 ...
 * @since J2EE 1.5   
 */
public class EesCim10233ViewAdapter extends ViewAdapter {
    ...
    protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
        ...
        for(int i=0;i<realCnt;i++){
            ...
            String xTpSz = JSPUtil.getNull(colValues.get("vvd"));
			if(xTpSz.equals("Total")){
            ...
            sbufXML.append("<TD><![CDATA["+JSPUtil.getNull(colValues.get("yard_cd"))+"]]></TD>\n");
