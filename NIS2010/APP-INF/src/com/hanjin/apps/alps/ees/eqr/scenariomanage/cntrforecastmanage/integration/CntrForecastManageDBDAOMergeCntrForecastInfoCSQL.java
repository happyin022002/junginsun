...
*@FileName : CntrForecastManageDBDAOMergeCntrForecastInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOMergeCntrForecastInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_OB_FCAST 테이블 입력/수정
	  * 
	  * <Change History>
	  * 1	2009.08.12	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrForecastManageDBDAOMergeCntrForecastInfoCSQL(){
		setQuery();
		...
		params.put("fcast_del_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("fcast_dt2",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CntrForecastManageDBDAOMergeCntrForecastInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EQR_OB_FCAST A" ).append("\n"); 
		...
		query.append(", @[fcast_dt2] FCAST_DT" ).append("\n"); 
