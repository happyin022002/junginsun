...
*@FileName : EES_MNR_0095HTMLAction.java
...
public class EES_MNR_0095HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0095HTMLAction 객체를 생성
	 */
	public EES_MNR_0095HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0095Event event = new EesMnr0095Event();
		...
		//Office의 지역이 US인지 체크
			...
			event.setRqstOfcCd(request.getParameter("rqst_ofc_cd"));
		}	
