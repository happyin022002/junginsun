...
*@FileName : ChargeCalculationDBDAOAddChgDeltCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOAddChgDeltCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOAddChgDeltCSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOAddChgDeltCSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOAddChgDeltCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_CHG_DELT_PATH" ).append("\n"); 
		query.append("	(" ).append("\n"); 
		...
		query.append("	   ,CHG_DELT_PATH_LVL" ).append("\n"); 
		query.append("	   ,CHG_DELT_STS_CD" ).append("\n"); 
		query.append("	   ,CHG_DELT_PATH_CPLS_FLG" ).append("\n"); 
		...
		query.append("	   ,T2.CHG_DELT_PATH_LVL" ).append("\n"); 
		query.append("	   ,T2.CHG_DELT_STS_CD" ).append("\n"); 
		query.append("	   ,T2.CHG_DELT_PATH_CPLS_FLG" ).append("\n"); 
		...
		query.append("				   ,DECODE(T1.DMDT_BRNC_FLG, 'Y', 'A', ' ') 	AS CHG_DELT_STS_CD" ).append("\n"); 
		query.append("				   ,DECODE(T1.DMDT_BRNC_FLG, 'Y', 'Y', 'N')		AS CHG_DELT_PATH_CPLS_FLG" ).append("\n"); 
		...
		query.append("				   ,DECODE(T1.DMDT_RHQ_FLG, 'Y', 'A', ' ') 		AS CHG_DELT_STS_CD" ).append("\n"); 
		query.append("			       ,DECODE(T1.DMDT_RHQ_FLG, 'Y', 'Y', 'N') 		AS CHG_DELT_PATH_CPLS_FLG" ).append("\n"); 
		query.append("				   ,@[cre_usr_id]								AS CRE_USR_ID" ).append("\n"); 
		query.append("				   ,@[cre_ofc_cd]								AS CRE_OFC_CD" ).append("\n"); 
		query.append("			  FROM  DMT_CHG_DELT_PATH_STUP  T1" ).append("\n"); 
		query.append("			 WHERE  EXISTS" ).append("\n"); 
		...
		query.append("				   ,DECODE(T1.DMDT_HO_FLG, 'Y', 'A', ' ') 	    AS CHG_DELT_STS_CD" ).append("\n"); 
		query.append("			       ,DECODE(T1.DMDT_HO_FLG, 'Y', 'Y', 'N')  		AS CHG_DELT_PATH_CPLS_FLG" ).append("\n"); 
