...
*@FileName : EccLinkInfoManageDBDAODeleteEccLinkInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EccLinkInfoManageDBDAODeleteEccLinkInfoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC_LNK 테이블 데이터 삭제
	  * </pre>
	  */
	public EccLinkInfoManageDBDAODeleteEccLinkInfoDSQL(){
		setQuery();
		...
		query.append("FileName : EccLinkInfoManageDBDAODeleteEccLinkInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_SCNR_ECC_LNK" ).append("\n"); 
