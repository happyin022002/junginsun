...
*@FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_sht20QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLAEccInfo_sht20QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC  테이블에 대한 SHT 20feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLAEccInfo_sht20QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_sht20QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
