...
*@FileName : EES_EQR_0092HTMLAction.java
*@FileTitle : Total
*Open Issues :
*Change history :
...
public class EES_EQR_0092HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0092HTMLAction 객체를 생성
	 */
	public EES_EQR_0092HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0092Event event = new EesEqr0092Event();
