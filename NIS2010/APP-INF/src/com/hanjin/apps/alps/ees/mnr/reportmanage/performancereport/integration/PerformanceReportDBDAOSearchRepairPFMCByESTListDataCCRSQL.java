...
public class PerformanceReportDBDAOSearchRepairPFMCByESTListDataCCRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    SUM(DECODE(RD.MNR_VRFY_TP_CD,'NS',1,'NC',1,'NR',1,'ND',1,'NZ',1,0)) NS_CNT," ).append("\n"); 
		query.append("	SUM(" ).append("\n"); 
		query.append("	CASE " ).append("\n"); 
		query.append("	  WHEN RD.MNR_VRFY_TP_CD = 'NS'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'NC'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'NR'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'ND'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'NZ' THEN MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(RH.CRE_DT, 'YYYYMM'), RH.CURR_CD, DECODE(@[curr_cd], 'Y', 'USD', RH.CURR_CD), RD.MNR_WRK_AMT)" ).append("\n"); 
		query.append("	  ELSE 0" ).append("\n"); 
		query.append("	END" ).append("\n"); 
		query.append("	) AS NS_AMT," ).append("\n"); 
		query.append("	SUM(DECODE(RD.MNR_VRFY_TP_CD,'NT',1,'LN',1,'LC',1,'LR',1,'LD',1,'LZ',1,0)) NT_CNT," ).append("\n"); 
		query.append("	SUM(" ).append("\n"); 
		query.append("	CASE " ).append("\n"); 
		query.append("	  WHEN RD.MNR_VRFY_TP_CD = 'NT' " ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'LN'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'LC'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'LR'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'LD'" ).append("\n"); 
		query.append("	       OR RD.MNR_VRFY_TP_CD = 'LZ' THEN MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(RH.CRE_DT, 'YYYYMM'), RH.CURR_CD, DECODE(@[curr_cd], 'Y', 'USD', RH.CURR_CD), RD.MNR_WRK_AMT)" ).append("\n"); 
		query.append("	  ELSE 0" ).append("\n"); 
		query.append("	END" ).append("\n"); 
		query.append("	) AS NT_AMT," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY RH.COST_OFC_CD,VD.VNDR_SEQ,RH.EQ_TPSZ_CD" ).append("\n"); 
