...
*@FileName : EesLse0090ViewAdapter.java
*@FileTitle : EesLse0090ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0090 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EesLse0090ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0090ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0090ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesLse0090ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
