...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.ees.mnr.generalmanage.partnermgt.event;
...
public class EES_MNR_0155HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0155HTMLAction 객체를 생성
	 */
	public EES_MNR_0155HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0155Event event = new EesMnr0155Event();
		//저장
		if(command.isCommand(FormCommand.MULTI)) { 

			event.setCustomMnrPartnerVO((CustomMnrPartnerVO)getVO(request, CustomMnrPartnerVO .class));
			event.setCustomMnrPartnerVOs((CustomMnrPartnerVO[])getVOs(request, CustomMnrPartnerVO .class,"sheet1_"));
			event.setCustomMnrPrnrCntcPntVOs((CustomMnrPrnrCntcPntVO[])getVOs(request, CustomMnrPrnrCntcPntVO.class,"sheet2_"));
		
		}
		//조회
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setDisposalPartnerMgtINVO((DisposalPartnerMgtINVO)getVO(request, DisposalPartnerMgtINVO .class));
		}     
		//상태변경
