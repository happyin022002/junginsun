...
public class RepairMgtDBDAOmodifyWEBInvoiceResultDTLinkDataUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("-- MODIFIED BY SHIN YONGCHAN, 2014-09-24" ).append("\n"); 
		...
		query.append("--WHERE (MNR_ORD_OFC_CTY_CD, MNR_ORD_SEQ, ORD_DTL_SEQ)" ).append("\n"); 
		query.append("--IN ( SELECT MNR_ORD_OFC_CTY_CD, MNR_ORD_SEQ, ORD_DTL_SEQ" ).append("\n"); 
		query.append("--     FROM MNR_PAY_INV_TMP" ).append("\n"); 
