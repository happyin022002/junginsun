...
*@FileName : ChassisMovementHistoryDBDAOaddCHSBareMvmtDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMovementHistoryDBDAOaddCHSBareMvmtDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMovementHistoryDBDAOaddCHSBareMvmtDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMovementHistoryDBDAOaddCHSBareMvmtDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[mvmt_sts_cd]" ).append("\n"); 
		query.append(",(SELECT DECODE(MAX(SYS_SEQ)+1,NULL,1,MAX(SYS_SEQ)+1) FROM CGM_CHSS_MVMT_HIS WHERE CHSS_NO= @[eq_no] AND MVMT_DT = TO_DATE(@[mvmt_dt_day] || ' ' || @[mvmt_dt_hd] ,'YYYY-MM-DD HH24:MI:SS') )" ).append("\n"); 
