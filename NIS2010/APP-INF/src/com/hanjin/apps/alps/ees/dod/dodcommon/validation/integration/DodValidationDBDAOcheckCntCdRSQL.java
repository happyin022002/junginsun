...
*@FileName : DodValidationDBDAOcheckCntCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodValidationDBDAOcheckCntCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodValidationDBDAOcheckCntCdRSQL(){
		setQuery();
		...
		query.append("FileName : DodValidationDBDAOcheckCntCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE CNT_CD = @[s_value]" ).append("\n"); 
