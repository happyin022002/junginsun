...
*@FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddBeforeExceptionVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Exception Tariff Version 정보를 입력하기 위한 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddBeforeExceptionVersionCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddBeforeExceptionVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
