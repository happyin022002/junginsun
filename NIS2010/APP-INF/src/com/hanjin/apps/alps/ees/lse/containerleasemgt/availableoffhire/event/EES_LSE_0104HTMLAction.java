...
*@FileName : EES_LSE_0020HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_LSE_0104HTMLAction extends HTMLActionSupport {
	/*
	 * 객체직렬화 버젼 UID
	 */
	...
	/**
	 * EES_LSE_0104HTMLAction 객체를 생성
	 */
	public EES_LSE_0104HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0104Event event = new EesLse0104Event();

		switch(command.getCommand()) {
			case FormCommand.SEARCH :	//조회
				event.setAvailableOffHireContainerListVO((AvailableOffHireContainerListVO)getVO(request, AvailableOffHireContainerListVO .class));
				break;
