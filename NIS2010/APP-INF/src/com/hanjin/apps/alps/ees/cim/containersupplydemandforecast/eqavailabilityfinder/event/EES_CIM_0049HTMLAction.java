...
*@FileName : EES_CIM_0049HTMLAction.java
*@FileTitle : IG Detail
*Open Issues :
*Change history :
...
public class EES_CIM_0049HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0049HTMLAction 객체를 생성
	 */
	public EES_CIM_0049HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0049Event event = new EesCim0049Event();
