...
*@FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOModifyBeforeExceptionStatusUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request - Before Booking Request 의 상태를 변경하기 위한 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOModifyBeforeExceptionStatusUSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if(${dmdt_expt_rqst_sts_cd} == 'A')" ).append("\n"); 
		query.append(",	RFA_EXPT_APRO_NO = @[rfa_expt_apro_no]" ).append("\n"); 
		query.append(",	APRO_USR_ID = @[apro_usr_id]" ).append("\n"); 
		query.append(",	APRO_DT = NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[upd_ofc_cd]),SYSDATE)" ).append("\n"); 
