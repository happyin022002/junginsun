...
public class SCExceptionTariffMgtDBDAOSearchTieredFreeTimeBySCRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	  ,NEW.FT_SEQ" ).append("\n"); 
		query.append("	  ,NEW.CNTR_FM_QTY" ).append("\n"); 
		query.append("	  ,NEW.CNTR_TO_QTY" ).append("\n"); 
		query.append("	  ,NEW.FT_DYS" ).append("\n"); 
		...
		query.append(" AND  NEW.FT_SEQ  = OLD.FT_SEQ(+)" ).append("\n"); 
		query.append("ORDER BY NEW.SC_EXPT_GRP_SEQ, NEW.FT_SEQ" ).append("\n"); 
