...
* 1      1.0     ChangHoChae     2006-09-20      최초 생성
* 2      1.42   HaengJi, Lee       2009-02-10      신규프로젝트 No  - [ S2Q-09P-004 ], Bay Plan I/F 화면추가에 따른 메소드 추가 - searchBayPlan
* 3		 1.43   HaengJi, Lee       2009-04-22		CSR No - N200904200110 : VVD Add 추가기능으로 인해 SEARCH10에 해당하는 로직 추가
* 4		 2.0    EunHo Chung       2009-07-30		New FrameWork 변경
* 5		2.1	Lee Byoung Hun	2010.05.11		CSR No : CHM-201003779 - FormCommand.SEARCH11 추가
=========================================================*/
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.ees.eqr 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_COMMONHTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	if(f_cmd.isCommand(FormCommand.SEARCH01) || f_cmd.isCommand(FormCommand.SEARCH12)) {
        	...
        	String tmp                    = JSPUtil.getParameter(request, "tmp".trim(),"");   // 하드코딩 여부
        	...
        	event.getEesCommonConditionVO().setTmp(tmp);
		}        	
