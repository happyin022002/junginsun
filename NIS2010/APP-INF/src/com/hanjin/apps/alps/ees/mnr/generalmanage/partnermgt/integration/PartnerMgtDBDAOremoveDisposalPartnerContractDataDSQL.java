...
*@FileName : PartnerMgtDBDAOremoveDisposalPartnerContractDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerMgtDBDAOremoveDisposalPartnerContractDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RepairPartnerContract remove	한다.
	  * </pre>
	  */
	public PartnerMgtDBDAOremoveDisposalPartnerContractDataDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerMgtDBDAOremoveDisposalPartnerContractDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
