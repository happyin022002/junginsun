...
*@FileName : EES_CIM_5003HTMLAction.java
...
public class EES_EQR_5003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_5003HTMLAction 객체를 생성
	 */
	public EES_EQR_5003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr5003Event event = new EesEqr5003Event();
