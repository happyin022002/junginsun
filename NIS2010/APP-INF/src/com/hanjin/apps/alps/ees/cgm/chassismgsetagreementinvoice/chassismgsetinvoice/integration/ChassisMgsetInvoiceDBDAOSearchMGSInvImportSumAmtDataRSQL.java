...
public class ChassisMgsetInvoiceDBDAOSearchMGSInvImportSumAmtDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    A.AGMT_VER_NO,    -- 추가된 조건, 2014-05-12, YongChan Shin" ).append("\n"); 
		query.append("    A.COST_YRMON,     -- 추가된 조건, 2014-05-12, YongChan Shin" ).append("\n"); 
		query.append("    A.COST_YRMON_SEQ, -- 추가된 조건, 2014-05-12, YongChan Shin" ).append("\n"); 
