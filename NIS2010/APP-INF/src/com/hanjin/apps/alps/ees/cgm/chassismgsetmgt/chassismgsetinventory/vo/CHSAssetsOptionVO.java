...
*@FileName : CHSAssetsOptionVO.java
*@FileTitle : CHSAssetsOptionVO
*Open Issues :
*Change history :
...
public class CHSAssetsOptionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSAssetsOptionVO> models = new ArrayList<CHSAssetsOptionVO>();
	...
	public CHSAssetsOptionVO() {}

	public CHSAssetsOptionVO(String ibflag, String pagerows, String lotCntrPfxCd, 
			String fmPrd, String toPrd, String locTpCd, String locCd, String cntrPfxCd, 
			String fmSerNo, String toSerNo, String lstmCd, String cntrTpszCd, String mftrVndrSeq, 
			String mftDt, String ctrtQty, String sldQty, String tllQty, String donQty, 
			String scrQty, String asetQty, String lstQty, String sboQty, String muoQty, 
			String lsoQty, String dioQty, String actQty, String eqKndCd) {
		this.tllQty = tllQty;
	 ...
	 */
	public CHSAssetsOptionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AssetsOptionVO[]
	 */
	public CHSAssetsOptionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSAssetsOptionVO model = null;
	 ...
	 * @return AssetsOptionVO[]
	 */
	public CHSAssetsOptionVO[] getAssetsOptionVOs(){
		CHSAssetsOptionVO[] vos = (CHSAssetsOptionVO[])models.toArray(new CHSAssetsOptionVO[models.size()]);
		return vos;
	}
