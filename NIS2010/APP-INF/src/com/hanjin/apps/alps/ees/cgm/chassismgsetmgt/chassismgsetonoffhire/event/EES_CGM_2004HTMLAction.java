...
*@FileName : EES_CGM_2004HTMLAction.java
...
public class EES_CGM_2004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2004HTMLAction 객체를 생성
	 */
	public EES_CGM_2004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2004Event event = new EesCgm2004Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMGSSpecINVOS((MGSSpecINVO[])getVOs(request, MGSSpecINVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setMGSSpecINVO((MGSSpecINVO)getVO(request, MGSSpecINVO .class));
		}
