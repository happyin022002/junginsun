...
*@FileName : MTYWeeklySimulationDBDAOaddMtyWeeklySimulationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYWeeklySimulationDBDAOaddMtyWeeklySimulationCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYWeeklySimulationDBDAOaddMtyWeeklySimulationCSQL(){
		setQuery();
		...
		query.append("FileName : MTYWeeklySimulationDBDAOaddMtyWeeklySimulationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/*" ).append("\n"); 
		query.append("--  1.정의     : EQR_MTY_WKY_SIM 삭제쿼리" ).append("\n"); 
		...
		query.append("             " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("INSERT INTO EQR_MTY_WKY_SIM" ).append("\n"); 
		query.append("(" ).append("\n"); 
