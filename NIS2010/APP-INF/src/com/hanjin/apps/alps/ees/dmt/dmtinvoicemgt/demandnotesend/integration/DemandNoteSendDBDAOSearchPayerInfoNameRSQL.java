...
*@FileName : DemandNoteSendDBDAOSearchPayerInfoNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemandNoteSendDBDAOSearchPayerInfoNameRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemandNoteSendDBDAOSearchPayerInfoNameRSQL(){
		setQuery();
		...
		query.append("FileName : DemandNoteSendDBDAOSearchPayerInfoNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
