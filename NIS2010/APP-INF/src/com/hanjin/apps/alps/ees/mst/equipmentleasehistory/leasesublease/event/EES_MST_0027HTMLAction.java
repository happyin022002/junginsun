...
*@FileName : EES_MST_0027HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.ees.mst.equipmentleasehistory 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_MST_0027HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0027HTMLAction 객체를 생성
	 */
	public EES_MST_0027HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0027Event event = new EesMst0027Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCntrStatusOptionVO((CntrStatusOptionVO)getVO(request, CntrStatusOptionVO .class));
		}
