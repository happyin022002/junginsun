...
public class ChassisMgsetInvoiceDBDAOsearchMGSEstimateExpenseCalcDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("ELSE NVL(T1.ACTUAL_AMT, T1.ESTIMATE_AMT)" ).append("\n"); 
		...
		query.append("          SUM(B.INV_LSE_CHG_AMT) CHG_AMT," ).append("\n"); 
		...
		query.append("          AND B.COST_YRMON BETWEEN SUBSTR(@[period_eddt], 1, 4)||'01' AND @[period_eddt]" ).append("\n"); 
		query.append("          AND A.EQ_KND_CD = 'G'" ).append("\n"); 
		query.append("          AND B.LSE_CHG_AUD_STS_CD != 'H'" ).append("\n"); 
		...
		query.append("        AND SUBSTR( E.GL_DT,1,6) BETWEEN SUBSTR(@[period_eddt], 1, 4)||'01' AND @[period_eddt]" ).append("\n"); 
