...
*@FileName : CntrForecastManageDBDAOUpdateCntrForecastInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOUpdateCntrForecastInfoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrForecastManageDBDAOUpdateCntrForecastInfoUSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOUpdateCntrForecastInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("UPDATE SET A.CNTR_VOL_QTY = @[cntr_vol_qty]" ).append("\n"); 
