...
*@FileName : PayableRentalCostDBDAOLessorInvoiceFileImportUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PayableRentalCostDBDAOLessorInvoiceFileImportUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PayableRentalCostDBDAOLessorInvoiceFileImportUSQL(){
		setQuery();
		...
		query.append("FileName : PayableRentalCostDBDAOLessorInvoiceFileImportUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET    LSE_PAY_CHG_TP_NM = @[lse_pay_chg_tp_nm]" ).append("\n"); 
