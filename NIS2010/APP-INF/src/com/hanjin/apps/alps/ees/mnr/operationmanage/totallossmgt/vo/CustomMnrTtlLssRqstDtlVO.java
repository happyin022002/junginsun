...
public class CustomMnrTtlLssRqstDtlVO extends AbstractValueObject {
	...
	public CustomMnrTtlLssRqstDtlVO(String ibflag, String pagerows, String payerCode, String ttlLssNo, String mnrPrnrSeq, String ttlLssCmplDt, String cntCd, String bankNm, String arChkNo, String lstmCd, String updUsrId, String ttlLssCmplCd, String csrNo, String ttlLssN3ptyTpCd, String dispNo, String ttlLssBilAmt, String dpcValAmt, String vndrCustSeq, String eqTpszCd, String creUsrId, String ttlLssPlcNm, String usaEdiCd, String eqOwnrFlg, String mnrSwiftNo, String ttlLssCfmFlg, String lessorNm, String ifTrcSeq, String tempSeq, String bankAcctNo, String currCd, String ttlLssDtlStsCd, String payInvSeq, String mnrPrnrCntCd, String creDt, String ttlLssYdCd, String ttlLssExpnAmt, String rqstEqNo, String n3ptyNo, String ttlLssBilDt, String invRgstNo, String updDt, String ttlLssDtlSeq, String eqKndCd, String ttlLssIncmAmt, String invNo, String ydCd, String mnrInvTpCd, String dtlRmk, String respbOfcCd, String payerName, String crEndDt, String buyerCode, String buyerName, String wrtfNo, String wrtfCltAmt, String amtLoss, String wrtfStsCd, String wrtfStsNm) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("wrtf_sts_nm", getWrtfStsNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("wrtf_sts_nm", "wrtfStsNm");
	 ...
	 * @return wrtfStsNm
	 */
	public String getWrtfStsNm() {
		return this.wrtfStsNm;
	}
	 ...
	 * @param wrtfStsNm
	 */
	public void setWrtfStsNm(String wrtfStsNm) {
		this.wrtfStsNm = wrtfStsNm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setWrtfStsNm(JSPUtil.getParameter(request, prefix + "wrtf_sts_nm", ""));
	}
	...
	public CustomMnrTtlLssRqstDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] wrtfStsNm = (JSPUtil.getParameter(request, prefix	+ "wrtf_sts_nm", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (wrtfStsNm[i] != null)
					model.setWrtfStsNm(wrtfStsNm[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.wrtfStsNm = this.wrtfStsNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
