...
*@FileName : ChassisMgsetAgreementDBDAORemoveMGSAgreementMainDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAORemoveMGSAgreementMainDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetAgreementDB.RemoveMGSAgreementMainData
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAORemoveMGSAgreementMainDataDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : ChassisMgsetAgreementDBDAORemoveMGSAgreementMainDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}