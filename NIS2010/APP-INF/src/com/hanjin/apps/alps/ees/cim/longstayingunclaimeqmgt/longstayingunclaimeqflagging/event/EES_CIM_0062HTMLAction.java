...
public class EES_CIM_0062HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0062HTMLAction 객체를 생성
	 */
	public EES_CIM_0062HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0062Event event = new EesCim0062Event();
		
		if(command.isCommand(FormCommand.MULTI)) {		// Save
			event.setMailingServiceSettingListVOS ((MailingServiceSettingListVO[])getVOs(request, MailingServiceSettingListVO.class,""));
		}
