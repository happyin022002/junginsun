...
*@FileName : LongstayingUnclaimEQFlaggingDBDAOEccCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LongstayingUnclaimEQFlaggingDBDAOEccCdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ECC Combo Setting Value
	  * </pre>
	  */
	public LongstayingUnclaimEQFlaggingDBDAOEccCdRSQL(){
		setQuery();
		...
		query.append("FileName : LongstayingUnclaimEQFlaggingDBDAOEccCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT B.ECC_CD" ).append("\n"); 
		...
		query.append("   AND B.LCC_CD = @[lcc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("ORDER BY B.ECC_CD" ).append("\n"); 
