...
public class InterfaceMgtDBDAOaddTempEstimateHDRDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2014-04-03 SR Ticket : SRM-201443664, Title : ALPS problem - EDI estimates SWISSTERMINAL - Cost CTRL Office BSLBA problem by Jonghee HAN Agreement에서 등록한 Cost office Get Logic -> ORDER BY CRE_DT로 변경 
	  * -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("	          (" ).append("\n"); 
		query.append("		         SELECT ROW_NUMBER() OVER(ORDER BY UPD_DT DESC) ROWNM, CTRL_OFC_CD" ).append("\n"); 
