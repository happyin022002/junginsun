...
*@FileName : CHSEspFactorINVO.java
*@FileTitle : CHSEspFactorINVO
*Open Issues :
*Change history :
...
public class CHSEspFactorINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSEspFactorINVO> models = new ArrayList<CHSEspFactorINVO>();
	...
	public CHSEspFactorINVO() {}

	public CHSEspFactorINVO(String ibflag, String pagerows, String sccCd, String espAdjKndCd, String espCalcFactor, String cntr20ftAdjVal, String cntr40ftAdjVal, String cntr45ftAdjVal, String cntrR5AdjVal, String creUsrId, String updUsrId) {
	 ...
	 */
	public CHSEspFactorINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSEspFactorINVO[]
	 */
	public CHSEspFactorINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSEspFactorINVO model = null;
	...
	public CHSEspFactorINVO[] getCHSEspFactorINVOs(){
		CHSEspFactorINVO[] vos = (CHSEspFactorINVO[])models.toArray(new CHSEspFactorINVO[models.size()]);
		return vos;
	}
