...
*@FileName : EES_CGM_1206HTMLAction.java
*@FileTitle : EES_CGM_1206
*Open Issues :
*Change history :
 ...
 * @see EesCgm1206Event 참조
 * @since J2EE 1.4
 */

public class EES_CGM_1206HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1206HTMLAction 객체를 생성
	 */
	public EES_CGM_1206HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EesCgm1206Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1206Event event = new EesCgm1206Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCpsCHSSPoolINVO((CPSCHSSPoolINVO)getVO(request, CPSCHSSPoolINVO .class));
			...
			event.setCpsCHSSPoolINVOS((CPSCHSSPoolINVO[])getVOs(request, CPSCHSSPoolINVO .class));
		}
