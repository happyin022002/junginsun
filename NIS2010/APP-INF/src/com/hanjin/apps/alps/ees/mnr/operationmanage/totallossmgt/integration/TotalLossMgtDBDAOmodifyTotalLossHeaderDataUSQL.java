...
public class TotalLossMgtDBDAOmodifyTotalLossHeaderDataUSQL implements ISQLTemplate{
	...
	public TotalLossMgtDBDAOmodifyTotalLossHeaderDataUSQL(){
		...
		params.put("acc_skd_dir_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("acc_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("acc_vsl_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("acc_port_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("acc_skd_voy_no",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("     	,RQST_DT = DECODE(@[ttl_lss_sts_cd],'HS',null,'HR',SYSDATE,TO_DATE(@[rqst_dt], 'yyyy-mm-dd'))               " ).append("\n"); 
		...
		query.append("		,ACC_FLG = DECODE(@[ttl_lss_rsn_cd], 'TRS', 'Y', 'N')" ).append("\n"); 
		query.append("		,ACC_DT = TO_DATE(@[acc_dt],'yyyy-mm-dd')" ).append("\n"); 
		query.append("		,ACC_VSL_CD = @[acc_vsl_cd]" ).append("\n"); 
		query.append("		,ACC_SKD_VOY_NO = @[acc_skd_voy_no]" ).append("\n"); 
		query.append("		,ACC_SKD_DIR_CD = @[acc_skd_dir_cd]" ).append("\n"); 
		query.append("		,ACC_PORT_CD = @[acc_port_cd]" ).append("\n"); 
