...
*@FileName : MGSConfirmPayableAmountINVO.java
*@FileTitle : MGSConfirmPayableAmountINVO
*Open Issues :
*Change history :
...
public class MGSConfirmPayableAmountINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSConfirmPayableAmountINVO> models = new ArrayList<MGSConfirmPayableAmountINVO>();
...
/**
	 ...
	 */
	public MGSConfirmPayableAmountINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSConfirmPayableAmountINVO[]
	 */
	public MGSConfirmPayableAmountINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSConfirmPayableAmountINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSConfirmPayableAmountINVO();
		...
		return getMGSConfirmPayableAmountINVOs();
	}
	...
	public MGSConfirmPayableAmountINVO[] getMGSConfirmPayableAmountINVOs(){
		MGSConfirmPayableAmountINVO[] vos = (MGSConfirmPayableAmountINVO[])models.toArray(new MGSConfirmPayableAmountINVO[models.size()]);
		return vos;
	}
