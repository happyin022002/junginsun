...
*@FileName : EES_MNR_0258HTMLAction.java
...
public class EES_MNR_0258HTMLAction extends HTMLActionSupport {
 
	private static final long serialVersionUID = 1L;
	
	/**
	 * EES_MNR_0258HTMLAction 객체를 생성
	 */
	public EES_MNR_0258HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0258Event event = new EesMnr0258Event();
