...
*@FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList06RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchBasicTariffDetailList06RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchBasicTariffDetailList06RSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchBasicTariffDetailList06RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                ,E.CNTR_R9_RT_AMT" ).append("\n"); 
		query.append("                ,E.FT_OVR_DYS AS FT_OVR_DYS" ).append("\n"); 
		...
		query.append("ORDER BY FT_OVR_DYS" ).append("\n"); 
