...
*@FileName : CEDEXCodeMgtDBDAOsearchCodeRelationByDamageDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CEDEXCodeMgtDBDAOsearchCodeRelationByDamageDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CEDEXCodeMgtDBDAOsearchCodeRelationByDamageDataRSQL(){
		setQuery();
		...
		query.append("FileName : CEDEXCodeMgtDBDAOsearchCodeRelationByDamageDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DECODE(C.EQ_CEDEX_RLT_TP_CD,NULL,'CTD',C.EQ_CEDEX_RLT_TP_CD) EQ_CEDEX_RLT_TP_CD," ).append("\n"); 
		...
		query.append("WHERE EQ_CEDEX_OTR_TP_CD = 'DMG'" ).append("\n"); 
		...
		query.append("WHERE EQ_CEDEX_RLT_TP_CD = 'CTD'" ).append("\n"); 
