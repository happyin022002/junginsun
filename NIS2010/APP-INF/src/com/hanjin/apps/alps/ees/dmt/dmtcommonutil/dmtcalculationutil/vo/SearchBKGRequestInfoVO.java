...
*@FileName : SearchBKGRequestInfoVO.java
*@FileTitle : SearchBKGRequestInfoVO
*Open Issues :
*Change history :
...
public class SearchBKGRequestInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBKGRequestInfoVO> models = new ArrayList<SearchBKGRequestInfoVO>();
	 ...
	 * @param request
	 * @return SearchBKGRequestInfoVO[]
	 */
	public SearchBKGRequestInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBKGRequestInfoVO[]
	 */
	public SearchBKGRequestInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBKGRequestInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBKGRequestInfoVO();
				if (porCd[i] != null)
		...
		return getSearchBKGRequestInfoVOs();
	}
	 ...
	 * @return SearchBKGRequestInfoVO[]
	 */
	public SearchBKGRequestInfoVO[] getSearchBKGRequestInfoVOs(){
		SearchBKGRequestInfoVO[] vos = (SearchBKGRequestInfoVO[])models.toArray(new SearchBKGRequestInfoVO[models.size()]);
		return vos;
	}
