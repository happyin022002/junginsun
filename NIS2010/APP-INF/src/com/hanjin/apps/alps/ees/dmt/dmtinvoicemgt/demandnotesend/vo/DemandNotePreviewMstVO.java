...
public class DemandNotePreviewMstVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("hjs_ref", getHjsRef());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("hjs_ref", "hjsRef");
	 ...
	 * @param hjsRef
	 */
	public void setHjsRef(String hjsRef) {
		this.hjsRef = hjsRef;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		setAddress01(JSPUtil.getParameter(request, "address01", ""));
		setOfcAdd03(JSPUtil.getParameter(request, "ofc_add03", ""));
		setShNum(JSPUtil.getParameter(request, "sh_num", ""));
		setTaxAmtPrnFlg(JSPUtil.getParameter(request, "tax_amt_prn_flg", ""));
		setSheetRemark09(JSPUtil.getParameter(request, "sheet_remark09", ""));
		setSheetRemark08(JSPUtil.getParameter(request, "sheet_remark08", ""));
		setHjsRef(JSPUtil.getParameter(request, "hjs_ref", ""));
		setSheetRemark07(JSPUtil.getParameter(request, "sheet_remark07", ""));
		setSheetRemark06(JSPUtil.getParameter(request, "sheet_remark06", ""));
		setDmdtTrfNm(JSPUtil.getParameter(request, "dmdt_trf_nm", ""));
		setHeader02(JSPUtil.getParameter(request, "header02", ""));
		setSheetRemark05(JSPUtil.getParameter(request, "sheet_remark05", ""));
		setHeader01(JSPUtil.getParameter(request, "header01", ""));
		setSheetRemark04(JSPUtil.getParameter(request, "sheet_remark04", ""));
		setSheetRemark03(JSPUtil.getParameter(request, "sheet_remark03", ""));
		setPhnFaxPrnFlg(JSPUtil.getParameter(request, "phn_fax_prn_flg", ""));
		setSheetRemark02(JSPUtil.getParameter(request, "sheet_remark02", ""));
		setOfcAdd01(JSPUtil.getParameter(request, "ofc_add01", ""));
		setSheetRemark01(JSPUtil.getParameter(request, "sheet_remark01", ""));
		setOfcAdd02(JSPUtil.getParameter(request, "ofc_add02", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setSheetRemark10(JSPUtil.getParameter(request, "sheet_remark10", ""));
		setHeader07(JSPUtil.getParameter(request, "header07", ""));
		setCustVatPrnFlg(JSPUtil.getParameter(request, "cust_vat_prn_flg", ""));
		setSheetRemark11(JSPUtil.getParameter(request, "sheet_remark11", ""));
		setHeader08(JSPUtil.getParameter(request, "header08", ""));
		setTitle(JSPUtil.getParameter(request, "title", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setHeader09(JSPUtil.getParameter(request, "header09", ""));
		setHeader03(JSPUtil.getParameter(request, "header03", ""));
		setHeader04(JSPUtil.getParameter(request, "header04", ""));
		setTaxNm(JSPUtil.getParameter(request, "tax_nm", ""));
		setHeader05(JSPUtil.getParameter(request, "header05", ""));
		setHeader06(JSPUtil.getParameter(request, "header06", ""));
		setCustVat(JSPUtil.getParameter(request, "cust_vat", ""));
		setPrintDate(JSPUtil.getParameter(request, "print_date", ""));
		setHeader10(JSPUtil.getParameter(request, "header10", ""));
		setSheetRemark13(JSPUtil.getParameter(request, "sheet_remark13", ""));
		setSheetRemark12(JSPUtil.getParameter(request, "sheet_remark12", ""));
		setBilToLocDivCd(JSPUtil.getParameter(request, "bil_to_loc_div_cd", ""));
		setSheetRemark14(JSPUtil.getParameter(request, "sheet_remark14", ""));
	...
	public DemandNotePreviewMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] hjsRef = (JSPUtil.getParameter(request, prefix	+ "hjs_ref", length));
	...
	*/
	public void unDataFormat(){
		...
		this.hjsRef = this.hjsRef .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
