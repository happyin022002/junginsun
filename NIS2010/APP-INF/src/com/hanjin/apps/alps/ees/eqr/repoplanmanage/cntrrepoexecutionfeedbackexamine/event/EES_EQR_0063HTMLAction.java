...
*@FileName : EES_EQR_0063HTMLAction.java
...
public class EES_EQR_0063HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0063HTMLAction 객체를 생성
	 */
	public EES_EQR_0063HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0063Event event = new EesEqr0063Event();
		
		// Retrieve 버튼 클릭시
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setEesEqr0063ConditionVO((EesEqr0063ConditionVO)getVO(request, EesEqr0063ConditionVO .class));
		}
		
		// sheet1에 duble click입력 시
