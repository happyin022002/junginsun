...
*@FileName : EES_MNR_0195HTMLAction.java
...
public class EES_MNR_0195HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0195HTMLAction 객체를 생성
	 */
	public EES_MNR_0195HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0195Event event = new EesMnr0195Event();
			
		TotalLossInfoGRPVO totalLossInfoGRPVO = new TotalLossInfoGRPVO();
		
		//조회
		if(command.isCommand(FormCommand.SEARCH)) {	
			totalLossInfoGRPVO.setTotalLossInfoINVO((TotalLossInfoINVO)getVO(request, TotalLossInfoINVO.class));
		}
		event.setTotalLossInfoGRPVO(totalLossInfoGRPVO);     	           
