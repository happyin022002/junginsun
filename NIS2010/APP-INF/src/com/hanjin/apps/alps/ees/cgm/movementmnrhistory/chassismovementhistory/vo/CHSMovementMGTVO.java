...
public class CHSMovementMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSMovementMGTVO> models = new ArrayList<CHSMovementMGTVO>();
	 ...
	 */
	public CHSMovementMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return chassisMovementMGTVO[]
	 */
	public CHSMovementMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSMovementMGTVO model = null;
	 ...
	 * @return chassisMovementMGTVO[]
	 */
	public CHSMovementMGTVO[] getchassisMovementMGTVOs(){
		CHSMovementMGTVO[] vos = (CHSMovementMGTVO[])models.toArray(new CHSMovementMGTVO[models.size()]);
		return vos;
	}
