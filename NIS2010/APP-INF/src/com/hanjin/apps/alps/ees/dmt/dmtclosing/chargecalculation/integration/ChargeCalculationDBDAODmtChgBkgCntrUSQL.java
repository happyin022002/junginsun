...
*@FileName : ChargeCalculationDBDAODmtChgBkgCntrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAODmtChgBkgCntrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAODmtChgBkgCntrUSQL.Query
	  * </pre>
	  */
	public ChargeCalculationDBDAODmtChgBkgCntrUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAODmtChgBkgCntrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
