...
*@FileName : CHSInvoiceInquiryINVO.java
*@FileTitle : CHSInvoiceInquiryINVO
*Open Issues :
*Change history :
...
public class CHSInvoiceInquiryINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInvoiceInquiryINVO> models = new ArrayList<CHSInvoiceInquiryINVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInPgmNo(JSPUtil.getParameter(request, "in_pgm_no", ""));
	 ...
	 */
	public CHSInvoiceInquiryINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInvoiceInquiryINVO[]
	 */
	public CHSInvoiceInquiryINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInvoiceInquiryINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSInvoiceInquiryINVO();
		...
		return getCHSInvoiceInquiryINVOs();
	}
	...
	public CHSInvoiceInquiryINVO[] getCHSInvoiceInquiryINVOs(){
		CHSInvoiceInquiryINVO[] vos = (CHSInvoiceInquiryINVO[])models.toArray(new CHSInvoiceInquiryINVO[models.size()]);
		return vos;
	}
