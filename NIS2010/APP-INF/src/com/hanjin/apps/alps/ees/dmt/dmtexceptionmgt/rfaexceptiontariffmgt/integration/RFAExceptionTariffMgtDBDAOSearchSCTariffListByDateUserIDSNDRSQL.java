...
*@FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserIDSNDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserIDSNDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(SC, DATE, Sent)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserIDSNDRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserIDSNDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
