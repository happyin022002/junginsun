...
*@FileName : CntrPlanGuidelineManageDBDAOModifyGuidelineHeaderUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAOModifyGuidelineHeaderUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Update Remark Guideline Header
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAOModifyGuidelineHeaderUSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAOModifyGuidelineHeaderUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET REPO_GLINE_RMK = @[repo_gline_rmk]" ).append("\n"); 
