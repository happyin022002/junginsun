...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOSearchCargoFlowMapSumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOSearchCargoFlowMapSumRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EQMatchBackNLoadFactorMgtDBDAOSearchCargoFlowMapSumRSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOSearchCargoFlowMapSumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 	Z.loc_cd," ).append("\n"); 
		query.append("		SUM(Z.total) total," ).append("\n"); 
		query.append("		SUM(Z.qty_0) qty_0," ).append("\n"); 
		query.append("		SUM(Z.qty_1) qty_1," ).append("\n"); 
		query.append("		SUM(Z.qty_2) qty_2," ).append("\n"); 
		query.append("		SUM(Z.qty_3) qty_3," ).append("\n"); 
		query.append("		SUM(Z.qty_4) qty_4," ).append("\n"); 
		query.append("		SUM(Z.qty_5) qty_5," ).append("\n"); 
		query.append("		SUM(Z.qty_6) qty_6," ).append("\n"); 
		query.append("		SUM(Z.qty_7) qty_7," ).append("\n"); 
		query.append("		SUM(Z.qty_8) qty_8," ).append("\n"); 
		query.append("		SUM(Z.qty_9) qty_9," ).append("\n"); 
		query.append("		SUM(Z.qty_10) qty_10," ).append("\n"); 
		query.append("		SUM(Z.qty_11) qty_11," ).append("\n"); 
		query.append("		SUM(Z.qty_12) qty_12," ).append("\n"); 
		query.append("		SUM(Z.qty_13) qty_13," ).append("\n"); 
		query.append("		SUM(Z.qty_14) qty_14," ).append("\n"); 
		query.append("		SUM(Z.qty_15) qty_15," ).append("\n"); 
		query.append("		SUM(Z.qty_16) qty_16," ).append("\n"); 
		query.append("		SUM(Z.qty_17) qty_17," ).append("\n"); 
		query.append("		SUM(Z.qty_18) qty_18," ).append("\n"); 
		query.append("		SUM(Z.qty_19) qty_19," ).append("\n"); 
		query.append("		SUM(Z.qty_20) qty_20," ).append("\n"); 
		query.append("		SUM(Z.qty_21) qty_21," ).append("\n"); 
		query.append("		SUM(Z.qty_22) qty_22," ).append("\n"); 
		query.append("		SUM(Z.qty_23) qty_23," ).append("\n"); 
		query.append("		SUM(Z.qty_24) qty_24," ).append("\n"); 
		query.append("		SUM(Z.qty_25) qty_25," ).append("\n"); 
		query.append("		SUM(Z.qty_26) qty_26," ).append("\n"); 
		query.append("		SUM(Z.qty_27) qty_27," ).append("\n"); 
		query.append("		SUM(Z.qty_28) qty_28," ).append("\n"); 
		query.append("		SUM(Z.qty_29) qty_29," ).append("\n"); 
		query.append("		SUM(Z.qty_30) qty_30," ).append("\n"); 
		query.append("		SUM(Z.qty_31) qty_31," ).append("\n"); 
		query.append("		SUM(Z.qty_32) qty_32," ).append("\n"); 
		query.append("		SUM(Z.qty_33) qty_33," ).append("\n"); 
		query.append("		SUM(Z.qty_34) qty_34," ).append("\n"); 
		query.append("		SUM(Z.qty_35) qty_35," ).append("\n"); 
		query.append("		SUM(Z.qty_36) qty_36," ).append("\n"); 
		query.append("		SUM(Z.qty_37) qty_37," ).append("\n"); 
		query.append("		SUM(Z.qty_38) qty_38," ).append("\n"); 
		query.append("		SUM(Z.qty_39) qty_39" ).append("\n"); 
		...
		query.append("ORDER BY X.LOC_FST, X.LOC_SND1, X.LOC_SND2" ).append("\n"); 
		query.append(") Z" ).append("\n"); 
		query.append("GROUP BY Z.loc_cd" ).append("\n"); 
		query.append("ORDER BY Z.loc_cd" ).append("\n"); 
