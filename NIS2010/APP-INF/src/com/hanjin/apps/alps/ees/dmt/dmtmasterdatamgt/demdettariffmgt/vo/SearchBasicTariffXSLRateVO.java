...
*@FileName : SearchBasicTariffXSLRateVO.java
*@FileTitle : SearchBasicTariffXSLRateVO
*Open Issues :
*Change history :
...
public class SearchBasicTariffXSLRateVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchBasicTariffXSLRateVO> models = new ArrayList<SearchBasicTariffXSLRateVO>();
	...
	public SearchBasicTariffXSLRateVO() {}

	public SearchBasicTariffXSLRateVO(String ibflag, String pagerows, String svrId, String dmdtTrfCd, String trfSeq, String trfGrpSeq, String trfRtSeq, String overDay, String ftOvrDys, String cntr20ftRtAmt, String cntr40ftRtAmt, String cntrHcRtAmt, String cntr45ftRtAmt, String creUsrId, String creDt, String creOfcCd, String updUsrId, String updDt, String updOfcCd, String usrId, String ofcCd, String cntrR9RtAmt, String dmdtDeTermCd, String dmdtDeTermNm) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cntrR9RtAmt", getCntrR9RtAmt());
	 ...
	 */
	public SearchBasicTariffXSLRateVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchBasicTariffXSLRateVO[]
	 */
	public SearchBasicTariffXSLRateVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchBasicTariffXSLRateVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchBasicTariffXSLRateVO();
				if (updDt[i] != null)
		...
		return getSearchBasicTariffXSLRateVOs();
	}
	 ...
	 * @return SearchBasicTariffXSLRateVO[]
	 */
	public SearchBasicTariffXSLRateVO[] getSearchBasicTariffXSLRateVOs(){
		SearchBasicTariffXSLRateVO[] vos = (SearchBasicTariffXSLRateVO[])models.toArray(new SearchBasicTariffXSLRateVO[models.size()]);
		return vos;
	}
