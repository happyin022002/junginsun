...
*@FileName : RepairMgtDBDAOaddExtraWOHeaderDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOaddExtraWOHeaderDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addExtraWOHeaderData
	  * </pre>
	  */
	public RepairMgtDBDAOaddExtraWOHeaderDataCSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOaddExtraWOHeaderDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
