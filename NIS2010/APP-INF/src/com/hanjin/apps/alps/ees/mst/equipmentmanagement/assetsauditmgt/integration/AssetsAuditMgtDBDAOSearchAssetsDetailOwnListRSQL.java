...
*@FileName : AssetsAuditMgtDBDAOSearchAssetsDetailOwnListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AssetsAuditMgtDBDAOSearchAssetsDetailOwnListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchAssetsDetailOwnList
	  * </pre>
	  */
	public AssetsAuditMgtDBDAOSearchAssetsDetailOwnListRSQL(){
		setQuery();
		...
		query.append("FileName : AssetsAuditMgtDBDAOSearchAssetsDetailOwnListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
