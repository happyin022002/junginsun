...
*@FileName : EES_CTM_0407HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.apls.ees.ctm.equipmentmovementmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0407HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0407HTMLAction 객체를 생성
	 */
	public EES_CTM_0407HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0407Event event = new EesCtm0407Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCtmMovementVOS((CusCtmMovementVO[])getVOs(request, CusCtmMovementVO .class,""));
		}
