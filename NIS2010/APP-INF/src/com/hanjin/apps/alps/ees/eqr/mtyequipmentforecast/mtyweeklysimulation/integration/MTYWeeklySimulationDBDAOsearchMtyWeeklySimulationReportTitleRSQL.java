...
*@FileName : MTYWeeklySimulationDBDAOsearchMtyWeeklySimulationReportTitleRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYWeeklySimulationDBDAOsearchMtyWeeklySimulationReportTitleRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYWeeklySimulationDBDAOsearchMtyWeeklySimulationReportTitleRSQL(){
		setQuery();
		...
		query.append("FileName : MTYWeeklySimulationDBDAOsearchMtyWeeklySimulationReportTitleRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
