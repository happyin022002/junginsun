...
*@FileName : OnsiteInspectionResultMgtDBDAOUpdateHeaderUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnsiteInspectionResultMgtDBDAOUpdateHeaderUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 사용자가 지정한 Yard, Vendor, Date에 해당하는 M&R Onsite Inspection Result Header를 갱신
	  * </pre>
	  */
	public OnsiteInspectionResultMgtDBDAOUpdateHeaderUSQL(){
		setQuery();
		...
		params.put("brnc_insp_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hdbrn_insp_flg",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.mnr.generalmanage.onsiteinspectionresultmgt.integration").append("\n"); 
		query.append("FileName : OnsiteInspectionResultMgtDBDAOUpdateHeaderUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MNR_ONSITE_INSP_RSLT" ).append("\n"); 
		...
		query.append("INSP_OFC_CD = @[insp_ofc_cd]," ).append("\n"); 
		query.append("BRNC_INSP_FLG = DECODE(@[brnc_insp_flg], 'on', 'Y', 'N')," ).append("\n"); 
		query.append("HDBRN_INSP_FLG = DECODE(@[hdbrn_insp_flg], 'on', 'Y', 'N')" ).append("\n"); 
