 ...
 * @since J2EE 1.6
 */
public class OnewaySimulateBackEndJob extends BackEndCommandSupport{
...
//		}
		...
		//0010화면에서 호출이 되었을때 
	       ...
	       // String new_scnd_id         = "";
	        String new_repo_id           = (String)hm.get("new_repo_pln");
	        ...
	        String   run_id_no           = (String)hm.get("run_id");
	        String weekStdt  = "";
	        
	      try {
				String usr_id        = (String)hm.get("user_id");;
			//	new_scnd_id           = commonBC.createNewScnario_id(old_scnario_id);  // 새로운 scnario id을 생성한다. 
			//	new_repo_id           = commonBC.createNewRepoPlan_id(sim_pln_id);  // 새로운 repo_plan_id을 생성한다.
				...
				//EesEqr0049ConditionVO에 데이터를 setting 
