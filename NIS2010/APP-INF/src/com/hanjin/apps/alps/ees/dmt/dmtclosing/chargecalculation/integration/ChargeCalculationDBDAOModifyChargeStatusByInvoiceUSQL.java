...
*@FileName : ChargeCalculationDBDAOModifyChargeStatusByInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOModifyChargeStatusByInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChargeCalculationDBDAOModifyChargeStatusByInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOModifyChargeStatusByInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET		DMDT_CHG_STS_CD =	@[dmdt_chg_sts_cd]" ).append("\n"); 
