...
*@FileName : EES_MNR_0030HTMLAction.java
...
public class EES_MNR_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0030HTMLAction 객체를 생성
	 */
	public EES_MNR_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0030Event event = new EesMnr0030Event();
			
		ESTWOMainGRPVO eSTWOMainGRPVO = new ESTWOMainGRPVO();
		
		//Master 조회 리스트
		if(command.isCommand(FormCommand.SEARCH)) {		  
			eSTWOMainGRPVO.setESTWOMainINVO((ESTWOMainINVO)getVO(request, ESTWOMainINVO .class));
		}
		//Detail 조회 리스트
		...
		//저장		 
			...
			//디테일 데이타								 
			eSTWOMainGRPVO.setArrayCustomESTWOMainINFOVOs((CustomESTWOMainINFOVO[])getVOs(request, CustomESTWOMainINFOVO.class));
		}	
		event.setESTWOMainGRPVO(eSTWOMainGRPVO);     	           
