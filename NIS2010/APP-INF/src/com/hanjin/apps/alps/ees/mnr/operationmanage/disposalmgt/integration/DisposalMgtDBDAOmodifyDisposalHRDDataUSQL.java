...
*@FileName : DisposalMgtDBDAOmodifyDisposalHRDDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DisposalMgtDBDAOmodifyDisposalHRDDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyDisposalHRDData
	  * </pre>
	  */
	public DisposalMgtDBDAOmodifyDisposalHRDDataUSQL(){
		setQuery();
		...
		query.append("FileName : DisposalMgtDBDAOmodifyDisposalHRDDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET A.DISP_STS_CD = @[disp_sts_cd]" ).append("\n"); 
