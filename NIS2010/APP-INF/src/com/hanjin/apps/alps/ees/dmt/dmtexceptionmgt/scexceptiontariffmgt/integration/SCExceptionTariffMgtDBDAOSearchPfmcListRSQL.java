...
*@FileName : SCExceptionTariffMgtDBDAOSearchPfmcListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchPfmcListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchPfmcListRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchPfmcListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , SC_EXPT_PERF_RQST_SEQ" ).append("\n"); 
		...
		query.append("  FROM DMT_SC_EXPT_PERF_RQST" ).append("\n"); 
