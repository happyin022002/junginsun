...
*@FileName : MGSOnHireMGTVO.java
*@FileTitle : MGSOnHireMGTVO
*Open Issues :
*Change history :
...
public class MGSOnHireMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSOnHireMGTVO> models = new ArrayList<MGSOnHireMGTVO>();
	 ...
	 */
	public MGSOnHireMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSOnHireMGTVO[]
	 */
	public MGSOnHireMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSOnHireMGTVO model = null;
	...
	public MGSOnHireMGTVO[] getMGSOnHireMGTVOs(){
		MGSOnHireMGTVO[] vos = (MGSOnHireMGTVO[])models.toArray(new MGSOnHireMGTVO[models.size()]);
		return vos;
	}
