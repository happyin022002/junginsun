...
*@FileName : RFAExceptionTariffMgtDBDAOAddNewAPRONoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOAddNewAPRONoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 새로운 DAR Approval No. 를 채번 테이블에 입력하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOAddNewAPRONoCSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOAddNewAPRONoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_RQST_APRO_NO (" ).append("\n"); 
		query.append("APRO_OFC_CD" ).append("\n"); 
		query.append(",	DAR_DIV_CD" ).append("\n"); 
		query.append(",	DAR_APRO_YRMON" ).append("\n"); 
		query.append(",	DAR_APRO_SEQ" ).append("\n"); 
