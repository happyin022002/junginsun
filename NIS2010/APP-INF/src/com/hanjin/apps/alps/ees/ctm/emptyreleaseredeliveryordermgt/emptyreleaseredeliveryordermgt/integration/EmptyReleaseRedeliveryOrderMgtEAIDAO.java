...
/**
 * ALPS EmptyReleaseRedeliveryOrderMgtEAIDAO <br>
 * - ALPS-EmptyReleaseRedeliveryOrderMgt system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 *
 * @author KIM, Sang Soo
...
public class EmptyReleaseRedeliveryOrderMgtEAIDAO extends EAIDAOSupport{
	...
	public String sendEdi(String flatFile) throws Exception {
		...
		//LIVE
		String target = SubSystemConfigFactory.get("CTM.ALPSCTM_UBIZHJS_VENDOR.IBMMQ.URL");
		String transfertype = SubSystemConfigFactory.get("CTM.ALPSCTM_UBIZHJS_VENDOR.IBMMQ.TRANSFERTYPE");
		String channel = SubSystemConfigFactory.get("CTM.ALPSCTM_UBIZHJS_VENDOR.IBMMQ.CHANNEL");
		String factory = SubSystemConfigFactory.get("CTM.ALPSCTM_UBIZHJS_VENDOR.IBMMQ.FACTORY");
		String queue = SubSystemConfigFactory.get("CTM.ALPSCTM_UBIZHJS_VENDOR.IBMMQ.QUEUE");
		String targetclient = SubSystemConfigFactory.get("CTM.ALPSCTM_UBIZHJS_VENDOR.IBMMQ.TARGETCLIENT");
