...
*@FileName : DemDetTariffMgtDBDAOAddTrfRgnCfmHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOAddTrfRgnCfmHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOAddTrfRgnCfmHisCSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOAddTrfRgnCfmHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_TRF_RGN_CFM_HIS (" ).append("\n"); 
		...
		query.append(",	@[dmdt_trf_cd]" ).append("\n"); 
		query.append(",	@[trf_seq]" ).append("\n"); 
		query.append(",	(SELECT NVL(MAX(RGN_CFM_SEQ),0)+1 FROM DMT_TRF_RGN_CFM_HIS" ).append("\n"); 
