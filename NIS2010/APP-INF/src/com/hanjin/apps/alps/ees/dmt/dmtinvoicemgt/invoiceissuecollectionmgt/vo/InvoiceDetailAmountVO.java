...
*@FileName : InvoiceDetailAmountVO.java
*@FileTitle : InvoiceDetailAmountVO
*Open Issues :
*Change history :
...
public class InvoiceDetailAmountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvoiceDetailAmountVO> models = new ArrayList<InvoiceDetailAmountVO>();
	...
	public InvoiceDetailAmountVO() {}

	public InvoiceDetailAmountVO(String ibflag, String pagerows, String cntrInvAmt, String dmdtInvNo, String creOfcCd, String invDtlSeq) {
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCntrInvAmt(JSPUtil.getParameter(request, "cntr_inv_amt", ""));
	 ...
	 * @param request
	 * @return InvoiceDetailAmountVO[]
	 */
	public InvoiceDetailAmountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvoiceDetailAmountVO[]
	 */
	public InvoiceDetailAmountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvoiceDetailAmountVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new InvoiceDetailAmountVO();
				if (ibflag[i] != null)
		...
		return getInvoiceDetailAmountVOs();
	}
	 ...
	 * @return InvoiceDetailAmountVO[]
	 */
	public InvoiceDetailAmountVO[] getInvoiceDetailAmountVOs(){
		InvoiceDetailAmountVO[] vos = (InvoiceDetailAmountVO[])models.toArray(new InvoiceDetailAmountVO[models.size()]);
		return vos;
	}
