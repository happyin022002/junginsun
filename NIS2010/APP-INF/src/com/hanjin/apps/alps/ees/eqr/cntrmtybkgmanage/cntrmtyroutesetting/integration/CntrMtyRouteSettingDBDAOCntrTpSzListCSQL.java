...
*@FileName : CntrMtyRouteSettingDBDAOCntrTpSzListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrMtyRouteSettingDBDAOCntrTpSzListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrMtyRouteSettingDBDAOCntrTpSzListCSQL(){
		setQuery();
		...
		query.append("FileName : CntrMtyRouteSettingDBDAOCntrTpSzListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_CTRL_ROUT_SET_TP_SZ" ).append("\n"); 
		query.append("      (" ).append("\n"); 
