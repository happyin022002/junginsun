...
*@FileName : CHSTermChangeResultINVO.java
*@FileTitle : CHSTermChangeResultINVO
*Open Issues :
*Change history :
...
public class CHSTermChangeResultINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSTermChangeResultINVO> models = new ArrayList<CHSTermChangeResultINVO>();
	 ...
	 */
	public CHSTermChangeResultINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSTermChangeResultINVO[]
	 */
	public CHSTermChangeResultINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSTermChangeResultINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSTermChangeResultINVO();
		...
		return getCHSTermChangeResultINVOs();
	}
	...
	public CHSTermChangeResultINVO[] getCHSTermChangeResultINVOs(){
		CHSTermChangeResultINVO[] vos = (CHSTermChangeResultINVO[])models.toArray(new CHSTermChangeResultINVO[models.size()]);
		return vos;
	}
