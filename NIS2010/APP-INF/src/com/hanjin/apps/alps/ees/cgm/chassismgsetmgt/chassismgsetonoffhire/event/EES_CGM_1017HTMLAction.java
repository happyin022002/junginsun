...
*@FileName : EES_CGM_1017HTMLAction.java
...
public class EES_CGM_1017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1017HTMLAction 객체를 생성
	 */
	public EES_CGM_1017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1017Event event = new EesCgm1017Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsFoundLostINVO((CHSFoundLostINVO)getVO(request, CHSFoundLostINVO .class));
		} else if(command.isCommand(FormCommand.MULTI01)) {
			event.setChsFoundLostMGTVO((CHSFoundLostMGTVO)getVO(request, CHSFoundLostMGTVO .class));
