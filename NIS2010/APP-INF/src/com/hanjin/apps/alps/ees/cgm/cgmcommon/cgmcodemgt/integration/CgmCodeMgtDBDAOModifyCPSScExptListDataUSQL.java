...
*@FileName : CgmCodeMgtDBDAOModifyCPSScExptListDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOModifyCPSScExptListDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception List를 수정한다.
	  * </pre>
	  */
	public CgmCodeMgtDBDAOModifyCPSScExptListDataUSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOModifyCPSScExptListDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CGM_CPS_SC_EXPT_LIST" ).append("\n"); 
		...
		query.append("    SC_CUST_TP_CD = @[sc_cust_tp_cd]," ).append("\n"); 
