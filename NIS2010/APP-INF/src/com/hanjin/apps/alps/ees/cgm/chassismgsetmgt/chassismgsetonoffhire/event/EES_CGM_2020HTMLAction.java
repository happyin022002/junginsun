...
*@FileName : EES_CGM_2020HTMLAction.java
...
public class EES_CGM_2020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2020HTMLAction 객체를 생성
	 */
	public EES_CGM_2020HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2020Event event = new EesCgm2020Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMgsLostResultINVO((MGSLostResultINVO)getVO(request, MGSLostResultINVO .class));
		}
