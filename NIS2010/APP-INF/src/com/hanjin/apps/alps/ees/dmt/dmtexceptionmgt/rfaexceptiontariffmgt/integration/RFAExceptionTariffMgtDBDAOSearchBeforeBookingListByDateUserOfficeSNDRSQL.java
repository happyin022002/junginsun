...
*@FileName : RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserOfficeSNDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserOfficeSNDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(BeforeBooking, DATE-Office, Sent)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserOfficeSNDRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchBeforeBookingListByDateUserOfficeSNDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	TTL.VER_NO" ).append("\n"); 
		...
		query.append("SELECT	RFA_TRF.RFA_EXPT_DAR_NO AS DAR_NO" ).append("\n"); 
		...
		query.append(",	RFA_TRF.RFA_EXPT_VER_SEQ" ).append("\n"); 
		query.append(",	RFA_TRF.DMDT_EXPT_RQST_STS_CD" ).append("\n"); 
		...
		query.append("AND RFA_TRF.DMDT_EXPT_RQST_STS_CD 	= 'R'" ).append("\n"); 
		...
		query.append(",	LPAD(RFA_TRF.RFA_EXPT_VER_SEQ, 3, '0') AS VER_NO" ).append("\n"); 
		query.append(",	RFA_TRF.RFA_EXPT_APRO_NO AS APVL_NO" ).append("\n"); 
		query.append(",	RFA_TRF_PROG2.PROG_OFC_CD AS REQ_OFC_CD" ).append("\n"); 
		query.append(",	DECODE(RFA_TRF.DMDT_EXPT_RQST_STS_CD, 'C', '', RFA_TRF_PROG.PROG_OFC_CD) AS APRO_OFC_CD" ).append("\n"); 
		query.append(",	TO_CHAR(RFA_TRF.UPD_DT, 'YYYY-MM-DD') AS UPD_DT" ).append("\n"); 
		query.append(",	RFA_TRF.PROP_NO" ).append("\n"); 
		query.append(",	RFA_TRF.RFA_EXPT_DAR_NO" ).append("\n"); 
		query.append(",	RFA_TRF.RFA_EXPT_MAPG_SEQ" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("WHERE	TTL.PROP_NO 			= RP_HDR.PROP_NO" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND TTL.RFA_EXPT_DAR_NO 			= RFA_TRF_DTL.RFA_EXPT_DAR_NO" ).append("\n"); 
		query.append("AND TTL.RFA_EXPT_MAPG_SEQ 		= RFA_TRF_DTL.RFA_EXPT_MAPG_SEQ" ).append("\n"); 
		query.append("AND TTL.RFA_EXPT_VER_SEQ 		= RFA_TRF_DTL.RFA_EXPT_VER_SEQ" ).append("\n"); 
