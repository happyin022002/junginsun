...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOCreateOnOffHireSoDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOCreateOnOffHireSoDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_REPO_EXE_SO_IF 테이블에 OnOff Hire의 SO 정보 입력 - 한진만 해당
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOCreateOnOffHireSoDataCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOCreateOnOffHireSoDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
