...
*@FileName : EmptyReleaseRedeliveryOrderMgtDBDAOCimTerritoryVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseRedeliveryOrderMgtDBDAOCimTerritoryVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyReleaseRedeliveryOrderMgtDBDAOCimTerritoryVOCSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseRedeliveryOrderMgtDBDAOCimTerritoryVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CIM_TERRITORY (" ).append("\n"); 
