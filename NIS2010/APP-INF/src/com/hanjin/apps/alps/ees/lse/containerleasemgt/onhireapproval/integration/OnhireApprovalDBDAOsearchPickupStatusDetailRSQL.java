...
public class OnhireApprovalDBDAOsearchPickupStatusDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      , V2.PKUP_DT                                                    AS DUE_DT" ).append("\n"); 
		query.append("      , V2.VNDR_NM                                                    AS LESSOR" ).append("\n"); 
		query.append("      , TO_CHAR(V1.CNTR_STS_EVNT_DT, 'YYYY-MM-DD')                    AS ON_HIRE_DT" ).append("\n"); 
		...
		query.append("FROM  ( SELECT  A.CNTR_STS_SEQ" ).append("\n"); 
		...
		query.append("                , A.LSEE_VNDR_SEQ VNDR_NM" ).append("\n"); 
		query.append("                , TO_CHAR(A.PKUP_DUE_DT, 'YYYY-MM-DD') AS PKUP_DT" ).append("\n"); 
		query.append("                , A.AGMT_CTY_CD" ).append("\n"); 
		query.append("                , A.AGMT_SEQ" ).append("\n"); 
		query.append("                , B.CNTR_TPSZ_CD" ).append("\n"); 
