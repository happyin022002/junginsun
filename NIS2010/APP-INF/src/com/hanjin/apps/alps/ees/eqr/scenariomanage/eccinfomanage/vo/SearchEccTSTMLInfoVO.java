...
*@FileName : SearchEccTSTMLInfoVO.java
*@FileTitle : SearchEccTSTMLInfoVO
*Open Issues :
*Change history :
...
public class SearchEccTSTMLInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEccTSTMLInfoVO> models = new ArrayList<SearchEccTSTMLInfoVO>();
	...
	public SearchEccTSTMLInfoVO() {}

	public SearchEccTSTMLInfoVO(String ibflag, String pagerows, String fmSlanCd, String laneDirCd, String toSlanCd, String fmYdCd, String toYdCd, String ts20ftUcAmt, String ts40ftUcAmt, String ts45ftUcAmt, String scnrId1, String eccCd1) {
		this.eccCd1 = eccCd1;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("scnr_id1", getScnrId1());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("scnr_id1", "scnrId1");
	 ...
	 * @param scnrId1
	 */
	public void setScnrId1(String scnrId1) {
		this.scnrId1 = scnrId1;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setScnrId1(JSPUtil.getParameter(request, "scnr_id1", ""));
	 ...
	 * @param request
	 * @return SearchEccTSTMLInfoVO[]
	 */
	public SearchEccTSTMLInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEccTSTMLInfoVO[]
	 */
	public SearchEccTSTMLInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEccTSTMLInfoVO model = null;
		...
		try {
			...
			String[] scnrId1 = (JSPUtil.getParameter(request, prefix	+ "scnr_id1", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchEccTSTMLInfoVO();
				if (eccCd1[i] != null)
		...
		return getSearchEccTSTMLInfoVOs();
	}
	 ...
	 * @return SearchEccTSTMLInfoVO[]
	 */
	public SearchEccTSTMLInfoVO[] getSearchEccTSTMLInfoVOs(){
		SearchEccTSTMLInfoVO[] vos = (SearchEccTSTMLInfoVO[])models.toArray(new SearchEccTSTMLInfoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.scnrId1 = this.scnrId1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
