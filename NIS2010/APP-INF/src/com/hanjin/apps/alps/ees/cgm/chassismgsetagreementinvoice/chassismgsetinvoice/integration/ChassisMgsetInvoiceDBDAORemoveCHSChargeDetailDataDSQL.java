...
public class ChassisMgsetInvoiceDBDAORemoveCHSChargeDetailDataDSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    AND (AGMT_OFC_CTY_CD, AGMT_SEQ, COST_YRMON_SEQ) IN (" ).append("\n"); 
		query.append("        SELECT AGMT_OFC_CTY_CD, AGMT_SEQ, COST_YRMON_SEQ FROM CGM_LSE_CHG_HDR" ).append("\n"); 
		query.append("        WHERE" ).append("\n"); 
		query.append("	       COST_YRMON = @[cost_yrmon]" ).append("\n"); 
