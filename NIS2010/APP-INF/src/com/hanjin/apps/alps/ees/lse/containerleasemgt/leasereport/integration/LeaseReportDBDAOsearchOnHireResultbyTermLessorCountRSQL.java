...
*@FileName : LeaseReportDBDAOsearchOnHireResultbyTermLessorCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LeaseReportDBDAOsearchOnHireResultbyTermLessorCountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 임차장비 임차실적 조회 (On-Hire Result by Lease Term/Lessor-Option) 전체건수를 조회한다.
	  ...
	  * 2010.12.13 장창수 [CHM-201007442-01] LT일때 Per-Diem LCC로 변경
	  * </pre>
	  */
	public LeaseReportDBDAOsearchOnHireResultbyTermLessorCountRSQL(){
		setQuery();
		...
		query.append("FileName : LeaseReportDBDAOsearchOnHireResultbyTermLessorCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
