...
*@FileName : UncollectedCargoDBDAOSearchCommonCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOSearchCommonCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CommonCode Combo 데이터 조회 
	  * </pre>
	  */
	public UncollectedCargoDBDAOSearchCommonCodeRSQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAOSearchCommonCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		INTG_CD_VAL_DP_DESC AS CODE_DESC" ).append("\n"); 
