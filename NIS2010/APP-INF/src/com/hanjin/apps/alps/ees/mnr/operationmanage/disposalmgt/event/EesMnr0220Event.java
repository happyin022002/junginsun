 ...
 * @see EES_MNR_0220HTMLAction 참조
 * @since J2EE 1.4
 */
   
public class EesMnr0220Event extends EventSupport {
	...
	private DisposalPriceFileListINVO eQFlagMgtINVO = null;
    
	public EesMnr0220Event(){}
	
	public DisposalPriceFileListINVO getEQFlagMgtINVO() {
		return eQFlagMgtINVO;
	}

	public void setEQFlagMgtINVO(DisposalPriceFileListINVO flagMgtINVO) {
