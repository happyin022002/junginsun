...
*@FileName : BeforeExceptionTariffVO.java
*@FileTitle : BeforeExceptionTariffVO
*Open Issues :
*Change history :
...
public class BeforeExceptionTariffVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BeforeExceptionTariffVO> models = new ArrayList<BeforeExceptionTariffVO>();
	...
	public BeforeExceptionTariffVO() {}

	public BeforeExceptionTariffVO(String ibflag, String pagerows, String rqstOfcCd, String rqstUsrNm, String aproOfcCd, String aproUsrNm, String scApvlNo, String rfaExptDarNo, String addDys, String ttlDys, String xcldSatFlg, String xcldSunFlg, String xcldHolFlg, String currCd, String cntrFtRtAmt, String scRfaExptAplyDt, String scRfaExptOvrDys, String scRfaExptAmt, String bzcTrfCurrCd) {
...
/**
	 ...
	 */
	public BeforeExceptionTariffVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BeforeExceptionTariffVO[]
	 */
	public BeforeExceptionTariffVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BeforeExceptionTariffVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BeforeExceptionTariffVO();
		...
		return getBeforeExceptionTariffVOs();
	}
	 ...
	 * @return BeforeExceptionTariffVO[]
	 */
	public BeforeExceptionTariffVO[] getBeforeExceptionTariffVOs(){
		BeforeExceptionTariffVO[] vos = (BeforeExceptionTariffVO[])models.toArray(new BeforeExceptionTariffVO[models.size()]);
		return vos;
	}
