...
*@FileName : ForecastReportDummyWeekVO_NEW.java
*@FileTitle : ForecastReportDummyWeekVO_NEW
*Open Issues :
*Change history :
...
public class ForecastReportDummyWeekVO extends AbstractValueObject {
	...
	public ForecastReportDummyWeekVO(String ibflag, String pagerows, String c0, String c0F, String f1, String f1F, String f2, String f2F, String f3, String f3F, String f4, String f4F, String f5, String f5F, String f6, String f6F, String f7, String f7F, String f8, String f8F, String f9, String f9F, String p1, String p1F, String p2, String p2F) {
		this.p1 = p1;
		this.p2 = p2;
		this.ibflag = ibflag;
		this.p2F = p2F;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("f8", getF8());
		this.hashColumns.put("f9_f", getF9F());
		this.hashColumns.put("f9", getF9());
		...
		this.hashColumns.put("f8_f", getF8F());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("f8", "f8");
		this.hashFields.put("f9_f", "f9F");
		this.hashFields.put("f9", "f9");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setF8(JSPUtil.getParameter(request, prefix + "f8", ""));
		setF9F(JSPUtil.getParameter(request, prefix + "f9_f", ""));
		setF9(JSPUtil.getParameter(request, prefix + "f9", ""));
		...
		setF8F(JSPUtil.getParameter(request, prefix + "f8_f", ""));
	 ...
	 * @param request
	 * @return ForecastReportDummyWeekVO_NEW[]
	 */
	...
	public ForecastReportDummyWeekVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] f8 = (JSPUtil.getParameter(request, prefix	+ "f8", length));
			String[] f9F = (JSPUtil.getParameter(request, prefix	+ "f9_f", length));
			String[] f9 = (JSPUtil.getParameter(request, prefix	+ "f9", length));
			...
			String[] f8F = (JSPUtil.getParameter(request, prefix	+ "f8_f", length));
	...
	*/
	public void unDataFormat(){
		...
		this.f8 = this.f8 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.f9F = this.f9F .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.f9 = this.f9 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.f8F = this.f8F .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
