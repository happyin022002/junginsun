...
*@FileName : EesCgm2212ViewAdapter.java
*@FileTitle : EesCgm2212ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_CGM_2212 에 대한 ViewAdapter<br>
 * - EES_CGM_2212HTMLAction에서 작성<br>
 *
 * @author 남궁진호
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EesCgm2212ViewAdapter extends DefaultViewAdapter {
	
    public EesCgm2212ViewAdapter(){
    	super();
    }
    
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesCgm2212ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesCgm2212ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
