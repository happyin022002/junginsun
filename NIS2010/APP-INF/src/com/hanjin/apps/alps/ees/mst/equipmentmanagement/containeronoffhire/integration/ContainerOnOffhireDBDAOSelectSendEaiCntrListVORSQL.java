...
public class ContainerOnOffhireDBDAOSelectSendEaiCntrListVORSQL implements ISQLTemplate{
	...
	public ContainerOnOffhireDBDAOSelectSendEaiCntrListVORSQL(){
		...
		params.put("ser_range",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("   ,'SML_GAAP_BOOK' BOOK_TYPE_CODE" ).append("\n"); 
		...
		query.append("WHERE 1 = 1   " ).append("\n"); 
		query.append("#if (${hid_type} == '0') " ).append("\n"); 
		query.append("AND A.CNTR_NO BETWEEN SUBSTR(@[ser_range], 1, 10)||'0' AND SUBSTR(@[ser_range], 1, 4)||SUBSTR(@[ser_range], 12, 6)||'9'" ).append("\n"); 
