...
*@FileName : TimeClockStopMgtDBDAODmtTimeClockStopNoSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TimeClockStopMgtDBDAODmtTimeClockStopNoSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TimeClockStopMgtDBDAODmtTimeClockStopNoSeqRSQL(){
		setQuery();
		...
		query.append("FileName : TimeClockStopMgtDBDAODmtTimeClockStopNoSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT /*+ INDEX_DESC(A XPKDMT_TM_CLK_STOP_NO) */" ).append("\n"); 
