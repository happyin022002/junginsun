...
*@FileName : ChargeCalculationDBDAOBookingContainerBackupByOfficeTransferCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOBookingContainerBackupByOfficeTransferCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addBookingContainerBackupByOfficeTransfer
	  * </pre>
	  */
	public ChargeCalculationDBDAOBookingContainerBackupByOfficeTransferCSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOBookingContainerBackupByOfficeTransferCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO DMT_CHG_BKG_CNTR_BKUP" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append(",CNTR_NO" ).append("\n"); 
		query.append(",CNTR_CYC_NO" ).append("\n"); 
		query.append(",CHG_BKG_CNTR_BKUP_SEQ.NEXTVAL" ).append("\n"); 
		query.append(",CNTR_TPSZ_CD" ).append("\n"); 
		query.append(",BKG_NO" ).append("\n"); 
		query.append(",BL_NO" ).append("\n"); 
		query.append(",VNDR_SEQ" ).append("\n"); 
