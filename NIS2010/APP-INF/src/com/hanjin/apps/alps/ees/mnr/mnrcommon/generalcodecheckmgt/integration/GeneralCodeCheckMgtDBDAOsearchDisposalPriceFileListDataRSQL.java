...
*@FileName : GeneralCodeCheckMgtDBDAOsearchDisposalPriceFileListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeCheckMgtDBDAOsearchDisposalPriceFileListDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralCodeCheckMgtDBDAOsearchDisposalPriceFileListDataRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeCheckMgtDBDAOsearchDisposalPriceFileListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(A.INP_MSG4,'SS') AS INP_MSG4," ).append("\n"); 
		query.append("B.MNR_CD_DP_DESC AS INP_MSG5," ).append("\n"); 
		query.append("DECODE(NVL(A.INP_MSG4,'SS'),'SS',1,0) AS CHECKBOX" ).append("\n"); 
		...
		query.append("ORDER BY A.TMP_DTL_SEQ" ).append("\n"); 
