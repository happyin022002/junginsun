...
*@FileName : EES_CIM_1083HTMLAction.java
*@FileTitle : MTY Repo Other
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EES_EQR_1083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1048HTMLAction 객체를 생성
	 */
	public EES_EQR_1083HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1083Event event = new EesEqr1083Event();
		...
		event.setEesEqr1083ConditionVO((EesEqr1083ConditionVO)getVO(request, EesEqr1083ConditionVO .class));
