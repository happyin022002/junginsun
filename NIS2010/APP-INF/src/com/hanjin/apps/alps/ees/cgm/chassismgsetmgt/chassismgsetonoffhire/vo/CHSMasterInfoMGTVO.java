...
*@FileName : CHSMasterInfoMGTVO.java
*@FileTitle : CHSMasterInfoMGTVO
*Open Issues :
*Change history :
...
public class CHSMasterInfoMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSMasterInfoMGTVO> models = new ArrayList<CHSMasterInfoMGTVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setChssTareWgtKgs(JSPUtil.getParameter(request, "chss_tare_wgt_kgs", ""));
	 ...
	 * @param request
	 * @return CHSMasterInfoMGTVO[]
	 */
	public CHSMasterInfoMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSMasterInfoMGTVO[]
	 */
	public CHSMasterInfoMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSMasterInfoMGTVO model = null;
	 ...
	 * @return CHSMasterInfoMGTVO[]
	 */
	public CHSMasterInfoMGTVO[] getCHSMasterInfoMGTVOs(){
		CHSMasterInfoMGTVO[] vos = (CHSMasterInfoMGTVO[])models.toArray(new CHSMasterInfoMGTVO[models.size()]);
		return vos;
	}
