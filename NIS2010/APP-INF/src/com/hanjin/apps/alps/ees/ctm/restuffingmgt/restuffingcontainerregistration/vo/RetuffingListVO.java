...
public class RetuffingListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<RetuffingListVO> models = new ArrayList<RetuffingListVO>();
	...
	public RetuffingListVO[] fromRequestGrid(HttpServletRequest request) {
	...
	public RetuffingListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RetuffingListVO model = null;
	...
	public RetuffingListVO[] getiRetuffingListVOs(){
		RetuffingListVO[] vos = (RetuffingListVO[])models.toArray(new RetuffingListVO[models.size()]);
		return vos;
	}
	/**
	 * Column Info
