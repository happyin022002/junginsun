...
*@FileName : EES_DOD_0012HTMLAction.java
...
public class EES_DOD_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DOD_0012HTMLAction 객체를 생성
	 */
	public EES_DOD_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDod0012Event event = new EesDod0012Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchDodDrpOffChgVO((SearchDodDrpOffChgVO)getVO(request, SearchDodDrpOffChgVO .class));
			event.setAuthAproRqstNo(StringUtil.xssFilter(request.getParameter("auth_apro_rqst_no")));
		}
