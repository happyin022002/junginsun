...
public class MTYEquipmentForecastDBDAOsearchOpmgFcstReference2BkgRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(B.CODE,1,B.W1_A5,DECODE(@[w1_f],'Y',NVL(B.W1_A5,0),'')) W1_A5" ).append("\n"); 
		...
		query.append("      ,DECODE(B.CODE,1,B.W2_A5,DECODE(@[w2_f],'Y',NVL(B.W2_A5,0),'')) W2_A5" ).append("\n"); 
		...
		query.append("      ,DECODE(B.CODE,1,B.W3_A5,DECODE(@[w3_f],'Y',NVL(B.W3_A5,0),'')) W3_A5" ).append("\n"); 
		...
		query.append("      ,DECODE(B.CODE,1,B.W4_A5,DECODE(@[w4_f],'Y',NVL(B.W4_A5,0),'')) W4_A5" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(WEEK, @[w1], DECODE(CNTR_TPSZ_CD, 'A5', CNTR_QTY))),0) W1_A5" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(WEEK, @[w2], DECODE(CNTR_TPSZ_CD, 'A5', CNTR_QTY))),0) W2_A5" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(WEEK, @[w3], DECODE(CNTR_TPSZ_CD, 'A5', CNTR_QTY))),0) W3_A5" ).append("\n"); 
		...
		query.append("          ,NVL(SUM(DECODE(WEEK, @[w4], DECODE(CNTR_TPSZ_CD, 'A5', CNTR_QTY))),0) W4_A5" ).append("\n"); 
