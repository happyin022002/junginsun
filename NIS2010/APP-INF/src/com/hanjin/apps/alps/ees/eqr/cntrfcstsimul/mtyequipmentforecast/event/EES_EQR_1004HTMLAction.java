...
*@FileName : EES_EQR_1004HTMLAction.java
...
public class EES_EQR_1004HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_1004HTMLAction 객체를 생성
	 */
	public EES_EQR_1004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1004Event event = new EesEqr1004Event();
		...
		String create_chk_box 	 = request.getParameter("create_chk_box");
		...
		event.setAttribute("create_chk_box", 	create_chk_box);
		
		event.setSalesFcstDtlVO((SalesFcstDtlVO)getVO(request, SalesFcstDtlVO .class));
