...
*@FileName : MNR_INTERFACE_THUMBNAIL_ZIP_HTMLAction.java
*@FileTitle : MNR_INTERFACE_THUMBNAIL_ZIP_HTMLAction
*Open Issues :
*Change history :
...
public class MNR_INTERFACE_THUMBNAIL_ZIP_HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * MNR_COM_HTMLAction 객체를 생성
	 */  
	public MNR_INTERFACE_THUMBNAIL_ZIP_HTMLAction() {}	
