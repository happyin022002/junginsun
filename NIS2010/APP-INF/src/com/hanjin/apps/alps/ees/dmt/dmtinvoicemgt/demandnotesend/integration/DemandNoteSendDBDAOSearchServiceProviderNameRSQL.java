...
*@FileName : DemandNoteSendDBDAOSearchServiceProviderNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemandNoteSendDBDAOSearchServiceProviderNameRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemandNoteSendDBDAOSearchServiceProviderNameRSQL(){
		setQuery();
		...
		query.append("FileName : DemandNoteSendDBDAOSearchServiceProviderNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
