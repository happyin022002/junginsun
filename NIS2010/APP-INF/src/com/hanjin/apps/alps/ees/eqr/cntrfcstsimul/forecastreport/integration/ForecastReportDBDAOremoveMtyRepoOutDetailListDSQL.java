...
*@FileName : ForecastReportDBDAOremoveMtyRepoOutDetailListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOremoveMtyRepoOutDetailListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_BAL_RPT_LODG_MNL 삭제
	  * </pre>
	  */
	public ForecastReportDBDAOremoveMtyRepoOutDetailListDSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOremoveMtyRepoOutDetailListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_CTRL_BAL_RPT_LODG_MNL " ).append("\n"); 
