...
public class EES_EQR_5010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_5001HTMLAction 객체를 생성
	 */
	public EES_EQR_5010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr5010Event event = new EesEqr5010Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setMtyWeeklySimulationOptionVOS((MtyWeeklySimulationOptionVO[])getVOs(request, MtyWeeklySimulationOptionVO .class, ""));
