...
public class InvoiceIssueVO extends AbstractValueObject {
	...
	// Exception 차액 관련 Flag 추가
	/* Column Info */
	private String orgChgAmtFlg = null;
	/* Column Info */
	private String exptAmtFlg = null;
	/* Column Info */
	private String aftExptDcAmtFlg = null;
	/* Column Info */
	private String bilAmtFlg = null;
	/* Column Info */
	...
	public InvoiceIssueVO(String ibflag, String pagerows, String dmdtChgLocDivCd, String bzcTrfCurrCd, String cntrCycNo, String exptAmt, String aftExptDcAmt, String chgSeq, String bilAmt, String ftCmncDt, String gb, String fxFtOvrDys, String svrId, String dmdtChgStsCd, String ftDys, String cntrNo, String cntrTpszCd, String fmMvmtDt, String bzcTrfGrpSeq, String bzcTrfSeq, String ftEndDt, String orgChgAmt, String dmdtTrfCd, String toMvmtDt, String dmdtInvNo, String orgFtOvrDys, String rfaExptDarNo, String rfaExptMapgSeq, String rfaExptVerSeq, String rfaRqstDtlSeq, String scNo, String scExptVerSeq, String scExptGrpSeq, String rtDtlGrp, String cmdtExptAmt, String dmdtTrfAplyTpCd, String invBillAmt, String invChgTot, String ofcTrnsFlg, String chgOfcCd, String bkgNo, String fmMvmtYdCd, String bzcDmdtDeTermCd, String bzcDmdtDeTermNm, String bzcTrfAplyDt, String scRfaExptAplyDt, String uncolAmt, String colCharge, String colTax, String orgChgAmtFlg, String exptAmtFlg, String aftExptDcAmtFlg, String bilAmtFlg, String dulTpExptFlg) {
		...
		this.orgChgAmtFlg = orgChgAmtFlg;
		this.exptAmtFlg = exptAmtFlg;
		this.aftExptDcAmtFlg = aftExptDcAmtFlg;
		this.bilAmtFlg = bilAmtFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("org_chg_amt_flg", getOrgChgAmtFlg());
		this.hashColumns.put("expt_amt_flg", getExptAmtFlg());
		this.hashColumns.put("aft_expt_dc_amt_flg", getAftExptDcAmtFlg());
		this.hashColumns.put("bil_amt_flg", getBilAmtFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("org_chg_amt_flg", "orgChgAmtFlg");
		this.hashFields.put("expt_amt_flg", "exptAmtFlg");
		this.hashFields.put("aft_expt_dc_amt_flg", "aftExptDcAmtFlg");
		this.hashFields.put("bil_amt_flg", "bilAmtFlg");
	...
	public String getOrgChgAmtFlg() {
		return orgChgAmtFlg;
	}

	public void setOrgChgAmtFlg(String orgChgAmtFlg) {
		this.orgChgAmtFlg = orgChgAmtFlg;
	}

	public String getExptAmtFlg() {
		return exptAmtFlg;
	}

	public void setExptAmtFlg(String exptAmtFlg) {
		this.exptAmtFlg = exptAmtFlg;
	}

	public String getAftExptDcAmtFlg() {
		return aftExptDcAmtFlg;
	}

	public void setAftExptDcAmtFlg(String aftExptDcAmtFlg) {
		this.aftExptDcAmtFlg = aftExptDcAmtFlg;
	}

	public String getBilAmtFlg() {
		return bilAmtFlg;
	}

	public void setBilAmtFlg(String bilAmtFlg) {
		this.bilAmtFlg = bilAmtFlg;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOrgChgAmt(JSPUtil.getParameter(request, prefix + "fm_mvmt_yd_cd", ""));
		...
		setOrgChgAmtFlg(JSPUtil.getParameter(request, prefix + "org_chg_amt_flg", ""));
		setExptAmtFlg(JSPUtil.getParameter(request, prefix + "expt_amt_flg", ""));
		setAftExptDcAmtFlg(JSPUtil.getParameter(request, prefix + "aft_expt_dc_amt_flg", ""));
		setBilAmtFlg(JSPUtil.getParameter(request, prefix + "bil_amt_flg", ""));
	...
	public InvoiceIssueVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] orgChgAmtFlg = (JSPUtil.getParameter(request, prefix	+ "org_chg_amt_flg", length));
			String[] exptAmtFlg = (JSPUtil.getParameter(request, prefix	+ "expt_amt_flg", length));
			String[] aftExptDcAmtFlg = (JSPUtil.getParameter(request, prefix	+ "aft_expt_dc_amt_flg", length));
			String[] bilAmtFlg = (JSPUtil.getParameter(request, prefix	+ "bil_amt_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (orgChgAmtFlg[i] != null)
					model.setOrgChgAmtFlg(orgChgAmtFlg[i]);					
				if (exptAmtFlg[i] != null)
					model.setExptAmtFlg(exptAmtFlg[i]);					
				if (aftExptDcAmtFlg[i] != null)
					model.setAftExptDcAmtFlg(aftExptDcAmtFlg[i]);					
				if (bilAmtFlg[i] != null)
					model.setBilAmtFlg(bilAmtFlg[i]);					
	...
	*/
	public void unDataFormat(){
		...
		this.orgChgAmtFlg = this.orgChgAmtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.exptAmtFlg = this.exptAmtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.aftExptDcAmtFlg = this.aftExptDcAmtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.bilAmtFlg = this.bilAmtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
