...
public class GeneralCodeCheckMgtDBDAOmodifyVerifyLocalTariffFileListByStandardTariffDataUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       , L.INP_MSG4 = 'SU'" ).append("\n"); 
		query.append("WHERE    1 = 1" ).append("\n"); 
		query.append("AND      L.TMP_SEQ = @[tmp_seq]" ).append("\n"); 
		query.append("AND      L.INP_MSG17||L.INP_MSG1||L.INP_MSG2||L.INP_MSG6||L.INP_MSG7||L.INP_MSG10||L.INP_MSG11||L.INP_MSG12||L.INP_MSG13||L.INP_MSG8||L.INP_MSG9||L.INP_MSG14 NOT IN" ).append("\n"); 
		query.append("         (" ).append("\n"); 
		query.append("           SELECT   S.COST_GRP_CD||S.EQ_CMPO_CD||S.EQ_RPR_CD||S.TRF_DIV_CD||S.DTL_DESC||S.MNR_RNG_TP_CD||S.VOL_TP_CD||S.RPR_QTY||S.RPR_SZ_NO||S.FM_RNG_SZ_NO||S.TO_RNG_SZ_NO||CASE WHEN S.RPR_LBR_HRS < 1 AND S.RPR_LBR_HRS > 0 THEN '0'||TO_CHAR(S.RPR_LBR_HRS) ELSE TO_CHAR(S.RPR_LBR_HRS) END" ).append("\n"); 
