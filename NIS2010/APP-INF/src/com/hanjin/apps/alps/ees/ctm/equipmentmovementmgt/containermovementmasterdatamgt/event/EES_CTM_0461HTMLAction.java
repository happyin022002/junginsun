...
*@FileName : EES_CTM_0461HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.equipmentmovementmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_CTM_0461HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0461HTMLAction 객체를 생성
	 */
	public EES_CTM_0461HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0461Event event = new EesCtm0461Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setUsLmsLocationListVOS((UsAmsLocationListVO[])getVOs(request, UsAmsLocationListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setUsLmsLocationListVO((UsAmsLocationListVO)getVO(request, UsAmsLocationListVO .class));
		}
