...
public class EES_MST_0045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_00045HTMLAction 객체를 생성
	 */
	public EES_MST_0045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0045Event event = new EesMst0045Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEqAverageUsingDayVO((EqAverageUsingDayVO)getVO(request, EqAverageUsingDayVO .class));
		}
