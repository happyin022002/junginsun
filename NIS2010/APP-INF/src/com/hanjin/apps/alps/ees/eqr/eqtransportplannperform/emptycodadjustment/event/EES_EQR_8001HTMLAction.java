...
*@FileName : EES_EQR_8001HTMLAction.java
 ...
 *
 * @author dev098
 * @see EesEqr8001Event 참조
 * @since J2EE 1.6
 */
public class EES_EQR_8001HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * EES_EQR_1049HTMLAction 객체를 생성
     */
    public EES_EQR_8001HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesEqr8001Event event = new EesEqr8001Event();
