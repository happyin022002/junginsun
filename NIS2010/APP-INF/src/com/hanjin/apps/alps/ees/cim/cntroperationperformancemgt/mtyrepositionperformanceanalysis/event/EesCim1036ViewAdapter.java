 ...
 * @since J2EE 1.5   
 */
public class EesCim1036ViewAdapter extends ViewAdapter {
...
//	        String[] realColNms=getColHeader(vo);
	        ...
	        for(int i=0;i<realCnt;i++){
	            ...
	            if( i > 0 ){
	                ...
	                if("".equals(JSPUtil.getNull(colValues.get("loccode02")))){
...
//	                int colCnt = realColNms.length;
	                ...
	                sbufXML.append("<TD><![CDATA["+JSPUtil.getNull(colValues.get("loccode01"))+"]]></TD>\n");
	                if("".equals(JSPUtil.getNull(colValues.get("loccode02")))){
	                	sbufXML.append("<TD><![CDATA[Total]]></TD>\n");
	                }
	                else{
	                	sbufXML.append("<TD><![CDATA["+JSPUtil.getNull(colValues.get("loccode02"))+"]]></TD>\n");
	                }
	                sbufXML.append("<TD ><![CDATA["+ JSPUtil.getNull(colValues.get("counttotal"))+"]]></TD>\n");
	                String num = "";
	                int xx = 1;
	                for (int j = 0 ; j < 40 ; j++) {
						if(xx < 10){
