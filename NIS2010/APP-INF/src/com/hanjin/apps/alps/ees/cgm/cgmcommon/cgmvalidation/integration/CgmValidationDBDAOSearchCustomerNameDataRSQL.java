...
*@FileName : CgmValidationDBDAOSearchCustomerNameDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmValidationDBDAOSearchCustomerNameDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CgmValidationDBDAOSearchCustomerNameDataRSQL(){
		setQuery();
		...
		query.append("FileName : CgmValidationDBDAOSearchCustomerNameDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
