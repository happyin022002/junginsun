...
*@FileName : EES_CTM_0404HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0404HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0404HTMLAction 객체를 생성
	 */
	public EES_CTM_0404HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0404Event event = new EesCtm0404Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchEDIMovementListVO((SearchEDIMovementListVO)getVO(request, SearchEDIMovementListVO.class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchEDIMovementListVOS((SearchEDIMovementListVO[])getVOs(request, SearchEDIMovementListVO.class,""));
		}
