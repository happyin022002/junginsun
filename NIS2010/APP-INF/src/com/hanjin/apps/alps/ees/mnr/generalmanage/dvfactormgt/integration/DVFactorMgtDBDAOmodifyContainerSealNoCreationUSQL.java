...
*@FileName : DVFactorMgtDBDAOmodifyContainerSealNoCreationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DVFactorMgtDBDAOmodifyContainerSealNoCreationUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DVFactorMgtDBDAOmodifyContainerSealNoCreationUSQL(){
		setQuery();
		...
		params.put("upd_chk2",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : DVFactorMgtDBDAOmodifyContainerSealNoCreationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MNR_SEAL_PLN" ).append("\n"); 
		query.append("SET PLN_YRMON = @[fr_year]||@[pln_month]," ).append("\n"); 
		query.append("PLN_SEQ = @[pln_seq]," ).append("\n"); 
		query.append("OFC_CD = @[ofc_cd]," ).append("\n"); 
		query.append("VNDR_SEQ = @[vndr_seq]," ).append("\n"); 
		query.append("SEAL_NO_PFX_NM = @[seal_no_pfx_nm]," ).append("\n"); 
		query.append("N1ST_SER_RNG_SEAL_NO = @[n1st_ser_rng_seal_no]," ).append("\n"); 
		query.append("LST_SER_RNG_SEAL_NO = @[lst_ser_rng_seal_no]," ).append("\n"); 
		query.append("CNTR_SEAL_LOST_QTY = @[cntr_seal_lost_qty]," ).append("\n"); 
		query.append("SEAL_KND_NM = @[seal_knd_nm]," ).append("\n"); 
		query.append("UPD_DT = DECODE(@[upd_chk2], 'Y', sysdate, 'N', TO_DATE(@[upd_dt], 'YYYY-MM-DD HH24:MI:SS.%'))" ).append("\n"); 
