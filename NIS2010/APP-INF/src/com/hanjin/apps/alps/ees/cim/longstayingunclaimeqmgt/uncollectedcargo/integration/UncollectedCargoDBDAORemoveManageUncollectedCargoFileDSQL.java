...
*@FileName : UncollectedCargoDBDAORemoveManageUncollectedCargoFileDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAORemoveManageUncollectedCargoFileDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UncollectedCargoDBDAORemoveManageUncollectedCargoFileDSQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAORemoveManageUncollectedCargoFileDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
