...
*@FileName : CHSEstimateExpenseINVO.java
*@FileTitle : CHSEstimateExpenseINVO
*Open Issues :
*Change history :
...
public class CHSEstimateExpenseINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSEstimateExpenseINVO> models = new ArrayList<CHSEstimateExpenseINVO>();
	 ...
	 */
	public CHSEstimateExpenseINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSEstimateExpenseINVO[]
	 */
	public CHSEstimateExpenseINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSEstimateExpenseINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSEstimateExpenseINVO();
				if (vslCd[i] != null)
		...
		return getCHSEstimateExpenseINVOs();
	}
	...
	public CHSEstimateExpenseINVO[] getCHSEstimateExpenseINVOs(){
		CHSEstimateExpenseINVO[] vos = (CHSEstimateExpenseINVO[])models.toArray(new CHSEstimateExpenseINVO[models.size()]);
		return vos;
	}
