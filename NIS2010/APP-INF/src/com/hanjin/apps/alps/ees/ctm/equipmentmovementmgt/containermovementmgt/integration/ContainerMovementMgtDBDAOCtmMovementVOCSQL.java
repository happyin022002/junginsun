...
public class ContainerMovementMgtDBDAOCtmMovementVOCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             @[cntr_xch_cd], 'SML'," ).append("\n"); 
		...
		query.append("             DECODE (SUBSTR(@[cntr_id], 1, 4), null, '', SUBSTR(@[cntr_id], 1, 4))," ).append("\n"); 
		query.append("             DECODE (SUBSTR(@[cntr_id], 5, 4), null, '', SUBSTR(@[cntr_id], 5, 4))," ).append("\n"); 
		query.append("             DECODE (SUBSTR(@[cntr_id], 9, 1), null, '', SUBSTR(@[cntr_id], 9, 1))," ).append("\n"); 
		...
		query.append("			 SUBSTR(@[org_yd_cd],1,2)" ).append("\n"); 
		query.append("            )" ).append("\n"); 
