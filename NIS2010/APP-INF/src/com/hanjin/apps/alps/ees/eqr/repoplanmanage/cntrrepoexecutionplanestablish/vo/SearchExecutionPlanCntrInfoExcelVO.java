...
public class SearchExecutionPlanCntrInfoExcelVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchExecutionPlanCntrInfoExcelVO> models = new ArrayList<SearchExecutionPlanCntrInfoExcelVO>();
	 ...
	 */
	public SearchExecutionPlanCntrInfoExcelVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExecutionPlanCntrListVO[]
	 */
	public SearchExecutionPlanCntrInfoExcelVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchExecutionPlanCntrInfoExcelVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchExecutionPlanCntrInfoExcelVO();
	 ...
	 * @return SearchExecutionPlanCntrListVO[]
	 */
	public SearchExecutionPlanCntrInfoExcelVO[] getSearchExecutionPlanCntrListVOs(){
		SearchExecutionPlanCntrInfoExcelVO[] vos = (SearchExecutionPlanCntrInfoExcelVO[])models.toArray(new SearchExecutionPlanCntrInfoExcelVO[models.size()]);
		return vos;
	}
