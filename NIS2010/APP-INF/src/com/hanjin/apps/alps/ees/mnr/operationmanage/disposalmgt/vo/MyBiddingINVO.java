...
public class MyBiddingINVO extends AbstractValueObject {
	...
	/* Column Info */
	private String dispLocalDt = null;
	/* Column Info */
	...
	public MyBiddingINVO(String ibflag, String pagerows, String result, String selectedDispNo, String dispStDtFm, String dispNo, String spPtalId, String eqKndCd, String ofcCd, String programId, String biddingStatus, String eqNo, String dispUtTpCd, String dispStDtTo, String locationType, String locationCountryCd, String dispLocalDt) {
		this.result = result;
		this.selectedDispNo = selectedDispNo;
		this.dispStDtFm = dispStDtFm;
		this.dispNo = dispNo;
		this.spPtalId = spPtalId;
		this.dispLocalDt = dispLocalDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("disp_local_dt", getDispLocalDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("disp_local_dt", "dispLocalDt");
	 ...
	 * @return dispLocalDt
	 */
	public String getDispLocalDt() {
		return this.dispLocalDt;
	}
	 ...
	 * @param dispLocalDt
	 */
	public void setDispLocalDt(String dispLocalDt) {
		this.dispLocalDt = dispLocalDt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDispStDtFm(JSPUtil.getParameter(request, prefix + "disp_st_dt_fm", ""));
		setDispNo(JSPUtil.getParameter(request, prefix + "disp_no", ""));
		setSpPtalId(JSPUtil.getParameter(request, prefix + "sp_ptal_id", ""));
		setDispLocalDt(JSPUtil.getParameter(request, prefix + "disp_local_dt", ""));
		...
		setDispStDtTo(JSPUtil.getParameter(request, prefix + "disp_st_dt_to", ""));
		setDispUtTpCd(JSPUtil.getParameter(request, prefix + "disp_ut_tp_cd", ""));
		setLocationType(JSPUtil.getParameter(request, prefix + "location_type", ""));
		setLocationCountryCd(JSPUtil.getParameter(request, prefix + "location_country_cd", ""));
	}
	...
	public MyBiddingINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dispLocalDt = (JSPUtil.getParameter(request, prefix	+ "disp_local_dt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (dispLocalDt[i] != null)
					model.setDispLocalDt(dispLocalDt[i]);
				if (eqKndCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.dispLocalDt = this.dispLocalDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
