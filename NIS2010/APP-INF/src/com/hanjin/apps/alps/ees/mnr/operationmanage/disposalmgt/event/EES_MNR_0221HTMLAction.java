...
*@FileName : EES_MNR_0221HTMLAction.java
...
import com.hanjin.apps.alps.ees.mnr.operationmanage.disposalmgt.vo.SoldEQFileListINVO;
...
public class EES_MNR_0221HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0221HTMLAction 객체를 생성
	 */
	public EES_MNR_0221HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0221Event event = new EesMnr0221Event();
		SoldEQFileListGRPVO soldEQFileListGRPVO = new SoldEQFileListGRPVO();
		
		if(command.isCommand(FormCommand.MULTI)) { 
			soldEQFileListGRPVO.setArrayCustomMnrDatVrfyVO((CustomMnrDatVrfyVO[])getVOs(request, CustomMnrDatVrfyVO.class,""));
			soldEQFileListGRPVO.setSoldEQFileListINVO((SoldEQFileListINVO)getVO(request, SoldEQFileListINVO.class));
		}  
		event.setSoldEQFileListGRPVO(soldEQFileListGRPVO);
