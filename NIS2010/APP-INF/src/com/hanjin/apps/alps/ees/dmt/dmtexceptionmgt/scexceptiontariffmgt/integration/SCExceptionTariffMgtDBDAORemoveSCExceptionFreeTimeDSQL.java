...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimeDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Tariff 의 선택한 Group Seq. 에 포함된 모든 FreeTime 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimeDSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_SC_EXPT_FREE_TM" ).append("\n"); 
