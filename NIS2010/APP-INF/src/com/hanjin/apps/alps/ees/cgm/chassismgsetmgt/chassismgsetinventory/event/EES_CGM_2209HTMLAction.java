...
*@FileName : EES_CGM_2209HTMLAction.java
...
public class EES_CGM_2209HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2209HTMLAction 객체를 생성
	 */
	public EES_CGM_2209HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesCgm2209Event event = new EesCgm2209Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsAssetsOptionVO((CHSAssetsOptionVO)getVO(request, CHSAssetsOptionVO .class));
		}
