...
*@FileName : EES_MST_0040HTMLAction.java
 ...
 * @author Jung Ho Min
 * @see EquipmentOperationPlanEvent 참조
 * @since J2EE 1.6
 */

public class EES_MST_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0040HTMLAction 객체를 생성
	 */
	public EES_MST_0040HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EquipmentOperationPlanEvent로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0040Event event = new EesMst0040Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setProcurementDetailVO((ProcurementDetailVO)getVO(request, ProcurementDetailVO.class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setProcurementDetailVOS((ProcurementDetailVO[])getVOs(request, ProcurementDetailVO.class,""));			
		}
