...
public class CntrRepoExecutionPlanEstablishDBDAOSearchOnOffHireCntrRepoPlanRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("#foreach(${key} in ${tpszArr})" ).append("\n"); 
		query.append(",NVL(SUM(${key}COST),0)    ${key}COST" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("#foreach(${key} in ${tpszArr})" ).append("\n"); 
		query.append(",NVL(SUM(${key}BASICRATIO),0) ${key}BASICRATIO --HIDDEN" ).append("\n"); 
		query.append(",NVL(SUM(${key}BASICVOL),0)   ${key}BASICVOL   --HIDDEN" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("AND   A.ONF_HIR_DIV_CD = F.ITEM(+)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("-- user location" ).append("\n"); 
		query.append("#if(${userECC} != '')" ).append("\n"); 
		query.append("AND A.ECC_CD IN ( ${userLocWhere} )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("-- FROMTO" ).append("\n"); 
		query.append("-- CSR No:N200906040080 의거 Fm ETD, To ETA 조건 추가" ).append("\n"); 
		...
		query.append(",DECODE(A.ONF_HIR_DIV_CD, 'F', A.ECC_CD, ' ')" ).append("\n"); 
		query.append(",DECODE(A.ONF_HIR_DIV_CD, 'O', A.ECC_CD, ' ')" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("--        	        SELECT A.REPO_PLN_ID, A.PLN_YRWK, A.REF_ID, NVL(COUNT(*), 0) TRSPCOUNT" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("A.REPO_PLN_ID" ).append("\n"); 
		query.append(", A.PLN_YRWK" ).append("\n"); 
		query.append(", A.PLN_SEQ" ).append("\n"); 
		...
		query.append("--                      AND INNER.ONF_HIR_DIV_CD = OUTER.SO_IF_DIV_CD" ).append("\n"); 
		query.append("--                      AND INNER.CNTR_TPSZ_CD = OUTER.CNTR_TPSZ_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("AND SUBSTR(OUTER.FM_YD_CD, 0, 5) = B.SCC_CD" ).append("\n"); 
		...
		query.append(") B" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("--modified by shin yongchan - 20080125 (CSR : R200801154869)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY" ).append("\n"); 
