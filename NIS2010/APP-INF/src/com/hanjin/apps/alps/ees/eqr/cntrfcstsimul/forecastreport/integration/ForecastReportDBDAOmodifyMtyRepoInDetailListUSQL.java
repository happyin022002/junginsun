...
*@FileName : ForecastReportDBDAOmodifyMtyRepoInDetailListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOmodifyMtyRepoInDetailListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ForecastReportDBDAOmodifyMtyRepoInDetailListUSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOmodifyMtyRepoInDetailListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EQR_CTRL_BAL_RPT_DCHG_MNL         " ).append("\n"); 
