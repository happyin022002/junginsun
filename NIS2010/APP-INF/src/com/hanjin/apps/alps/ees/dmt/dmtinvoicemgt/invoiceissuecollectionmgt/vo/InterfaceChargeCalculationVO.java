...
public class InterfaceChargeCalculationVO extends AbstractValueObject {
	...
	/* Column Info */
	private String sbcFlg = null;
	/* Column Info */
	private String kkcFlg = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sbc_flg", getSbcFlg());
		this.hashColumns.put("kkc_flg", getKkcFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sbc_flg", "sbcFlg");
		this.hashFields.put("kkc_flg", "kkcFlg");
	...
	public String getSbcFlg() {
		return sbcFlg;
	}

	public void setSbcFlg(String sbcFlg) {
		this.sbcFlg = sbcFlg;
	}

	public String getKkcFlg() {
		return kkcFlg;
	}

	public void setKkcFlg(String kkcFlg) {
		this.kkcFlg = kkcFlg;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSbcFlg(JSPUtil.getParameter(request, prefix + "sbc_flg", ""));
		setKkcFlg(JSPUtil.getParameter(request, prefix + "kkc_flg", ""));
	}
	...
	public InterfaceChargeCalculationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sbcFlg = (JSPUtil.getParameter(request, prefix	+ "sbc_flg", length));
			String[] kkcFlg = (JSPUtil.getParameter(request, prefix	+ "kkc_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (sbcFlg[i] != null)
					model.setSbcFlg(sbcFlg[i]);
				if (kkcFlg[i] != null)
					model.setKkcFlg(kkcFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.sbcFlg = this.sbcFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.kkcFlg = this.kkcFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
