...
*@FileName : EqInterchangeDBDAOsearchEqInterchangeReqNumberDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EqInterchangeDBDAOsearchEqInterchangeReqNumberDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EqInterchangeDBDAOsearchEqInterchangeReqNumberDataRSQL(){
		setQuery();
		...
		query.append("FileName : EqInterchangeDBDAOsearchEqInterchangeReqNumberDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT LSE_ITCHG_RQST_NO REQ_NO" ).append("\n"); 
		...
		query.append("GROUP BY LSE_ITCHG_RQST_NO" ).append("\n"); 
		query.append("ORDER BY LSE_ITCHG_RQST_NO DESC" ).append("\n"); 
