...
*@FileName : ContainerMovementMgtDBDAOCheckCntrExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOCheckCntrExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *  - 해당 Container가 Booking에 붙어 있는지 확인하기 위한 조회
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOCheckCntrExistRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOCheckCntrExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
