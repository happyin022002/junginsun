...
*@FileName : EES_CGM_2019HTMLAction.java
...
public class EES_CGM_2019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2019HTMLAction 객체를 생성
	 */
	public EES_CGM_2019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2019Event event = new EesCgm2019Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMgsFoundLostINVO((MGSFoundLostINVO)getVO(request, MGSFoundLostINVO .class));
		} else if(command.isCommand(FormCommand.MULTI01)) {
			event.setMgsFoundLostMGTVO((MGSFoundLostMGTVO)getVO(request, MGSFoundLostMGTVO .class));
