...
*@FileName : WriteOffMgtDBDAOsearchMaxWriteOffNoDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WriteOffMgtDBDAOsearchMaxWriteOffNoDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WriteOffMgtDBDAOsearchMaxWriteOffNoDataRSQL(){
		setQuery();
		...
		query.append("FileName : WriteOffMgtDBDAOsearchMaxWriteOffNoDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MAX(WRTF_NO), '') WRTF_NO" ).append("\n"); 
		...
		query.append("AND TTL_LSS_NO IN (SELECT DISTINCT TTL_LSS_NO" ).append("\n"); 
