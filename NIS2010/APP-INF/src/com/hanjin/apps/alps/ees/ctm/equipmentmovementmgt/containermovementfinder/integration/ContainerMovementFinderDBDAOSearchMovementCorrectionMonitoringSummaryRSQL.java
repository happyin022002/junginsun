...
*@FileName : ContainerMovementFinderDBDAOSearchMovementCorrectionMonitoringSummaryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementFinderDBDAOSearchMovementCorrectionMonitoringSummaryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 20160425 HongSeongPill Movement Correction Monitoring Summary
	  * </pre>
	  */
	public ContainerMovementFinderDBDAOSearchMovementCorrectionMonitoringSummaryRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementFinderDBDAOSearchMovementCorrectionMonitoringSummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,C.YD_CD AS ORG_YD_CD" ).append("\n"); 
		...
		query.append("      ,4 - ROUND(LOG(2, GROUPING_ID(RCC_CD,LCC_CD,YD_CD,INTG_CD_VAL_CTNT) + 1)) AS LVL" ).append("\n"); 
		...
		query.append("                        (C.RCC_CD, C.LCC_CD, C.YD_CD, C.INTG_CD_VAL_CTNT,C.INTG_CD_VAL_DESC)," ).append("\n"); 
		query.append("                        (C.RCC_CD, C.LCC_CD, C.YD_CD)," ).append("\n"); 
		query.append("                        (C.RCC_CD, C.LCC_CD)," ).append("\n"); 
		query.append("                        (C.RCC_CD)" ).append("\n"); 
		query.append("                       ) " ).append("\n"); 
		query.append("ORDER BY C.RCC_CD, C.LCC_CD NULLS FIRST, C.YD_CD NULLS FIRST, C.INTG_CD_VAL_CTNT NULLS FIRST" ).append("\n"); 
