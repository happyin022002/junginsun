...
*@FileName : DodFileUploadDBDAOFileUploadListVOTrfRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodFileUploadDBDAOFileUploadListVOTrfRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DOD Charge tariff 에 각 해당하는 첨부파일 목록을 가져온다.
	  * </pre>
	  */
	public DodFileUploadDBDAOFileUploadListVOTrfRSQL(){
		setQuery();
		...
		query.append("FileName : DodFileUploadDBDAOFileUploadListVOTrfRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM DOD_DRP_OFF_CHG_TRF D, DOD_ATCH_FILE F, COM_UPLD_FILE C" ).append("\n"); 
