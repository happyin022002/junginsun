...
*@FileName : PerformanceReportDBDAOSearchTirePurchaseByItemListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchTirePurchaseByItemListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchTirePurchaseByItemListData
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchTirePurchaseByItemListDataRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchTirePurchaseByItemListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ) " ).append("\n"); 
		query.append("ORDER BY PRI, RHQ, OFC, SUP_CD, SUP_NM, BRAND_NM, CUR, TYPE2" ).append("\n"); 
