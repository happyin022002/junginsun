...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ONF_HIR_EXE_PLN 테이블의 특정 ref id, repo plan id 삭제
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("EQR_ONF_HIR_EXE_PLN" ).append("\n"); 
