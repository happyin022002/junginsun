...
*@FileName : OfficeSubVO.java
*@FileTitle : OfficeSubVO
*Open Issues :
*Change history :
...
public class OfficeSubVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OfficeSubVO> models = new ArrayList<OfficeSubVO>();
	...
	public OfficeSubVO(String ibflag, String pagerows, String ofcCd, String prntOfcCd) {
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return OfficeSubVO[]
	 */
	public OfficeSubVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OfficeSubVO[]
	 */
	public OfficeSubVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OfficeSubVO model = null;
	 ...
	 * @return OfficeSubVO[]
	 */
	public OfficeSubVO[] getOfficeSubVOs(){
		OfficeSubVO[] vos = (OfficeSubVO[])models.toArray(new OfficeSubVO[models.size()]);
		return vos;
	}
