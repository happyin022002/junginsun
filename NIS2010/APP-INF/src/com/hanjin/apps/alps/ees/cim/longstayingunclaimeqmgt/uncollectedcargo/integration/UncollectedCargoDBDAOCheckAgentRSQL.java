...
*@FileName : UncollectedCargoDBDAOCheckAgentRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOCheckAgentRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 유효한 Branch/Agent 인지 Check  
	  * </pre>
	  */
	public UncollectedCargoDBDAOCheckAgentRSQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAOCheckAgentRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	o.ofc_cd agent" ).append("\n"); 
		query.append("FROM 	MDM_ORGANIZATION O " ).append("\n"); 
		query.append("WHERE 	1 = 1" ).append("\n"); 
		query.append("   		AND	o.ofc_cd = @[agent]" ).append("\n"); 
