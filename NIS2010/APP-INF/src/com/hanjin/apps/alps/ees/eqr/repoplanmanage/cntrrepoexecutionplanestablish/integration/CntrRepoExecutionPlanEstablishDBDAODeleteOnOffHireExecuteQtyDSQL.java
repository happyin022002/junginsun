...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteQtyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteQtyDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteQtyDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteOnOffHireExecuteQtyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
