...
public class EES_MNR_0248HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0248HTMLAction 객체를 생성
	 */
	public EES_MNR_0248HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0248Event event = new EesMnr0248Event();
		if(command.isCommand(FormCommand.COMMAND01)) {
			event.setRepairPFMCByEqNoINVO((RepairPFMCByEqNoINVO)getVO(request, RepairPFMCByEqNoINVO .class));
		}	
