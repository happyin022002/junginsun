...
*@FileName : DropOffCreationDBDAOSearchARInvoiceIFMnVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DropOffCreationDBDAOSearchARInvoiceIFMnVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DropOffCreationDBDAOSearchARInvoiceIFMnVORSQL(){
		setQuery();
		...
		query.append("FileName : DropOffCreationDBDAOSearchARInvoiceIFMnVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       BE.IO_BND_CD IO_BND_CD," ).append("\n"); 
		query.append("       (SELECT A.AR_OFC_CD" ).append("\n"); 
		query.append("		  FROM MDM_ORGANIZATION A" ).append("\n"); 
		query.append("		 WHERE A.OFC_CD = @[tro_ib_cfm_ofc_cd]" ).append("\n"); 
		...
		query.append("   AND BE.CFM_OFC_CD = D.TRO_IB_CFM_OFC_CD" ).append("\n"); 
		query.append("   AND BE.IO_BND_CD = 'I'" ).append("\n"); 
		query.append("   AND B.BKG_NO = D.BKG_NO" ).append("\n"); 
		query.append("   AND B.BKG_NO = BE.BKG_NO" ).append("\n"); 
		query.append("   AND BE.CNTR_NO = D.CNTR_NO" ).append("\n"); 
		query.append("   AND BE.CNTR_TPSZ_CD = D.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("   AND BE.TRO_SEQ = (SELECT MAX(TT.TRO_SEQ)" ).append("\n"); 
		query.append("                       FROM BKG_EUR_TRO TT" ).append("\n"); 
		query.append("                 	  WHERE TT.BKG_NO = BE.BKG_NO" ).append("\n"); 
		query.append("                   		AND TT.CNTR_NO = BE.CNTR_NO" ).append("\n"); 
