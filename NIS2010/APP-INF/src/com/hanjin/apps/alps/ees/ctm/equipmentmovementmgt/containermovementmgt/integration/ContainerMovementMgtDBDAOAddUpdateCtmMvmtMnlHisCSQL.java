...
*@FileName : ContainerMovementMgtDBDAOAddUpdateCtmMvmtMnlHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOAddUpdateCtmMvmtMnlHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOAddUpdateCtmMvmtMnlHisCSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOAddUpdateCtmMvmtMnlHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  NVL(@[cntr_dmg_flg], CNTR_DMG_FLG) AS CNTR_DMG_FLG," ).append("\n"); 
		query.append("  NVL(DECODE(@[fcntr_flg], 'F', 'Y', 'M', 'N', 'E', 'N', @[fcntr_flg]), FCNTR_FLG) AS FCNTR_FLG," ).append("\n"); 
		...
		query.append("  SUBST_RULE_CD," ).append("\n"); 
		query.append("  NVL(@[spcl_cgo_flg], SPCL_CGO_FLG) AS SPCL_CGO_FLG," ).append("\n"); 
		...
		query.append("  CNTR_RFUB_FLG," ).append("\n"); 
		query.append("  NVL(@[cntr_disp_flg], CNTR_DISP_FLG) AS CNTR_DISP_FLG," ).append("\n"); 
		query.append("  NVL(@[imdt_ext_flg], IMDT_EXT_FLG) AS IMDT_EXT_FLG," ).append("\n"); 
