...
*@FileName : EesLse0039ViewAdapter.java
*@FileTitle : EesLse0039ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0039 에 대한 ViewAdapter<br>
 * - EES_LSE_0039HTMLAction에서 작성<br>
 *
 * @author 남궁진호
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EesLse0039ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0039ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0039ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesLse0039ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
