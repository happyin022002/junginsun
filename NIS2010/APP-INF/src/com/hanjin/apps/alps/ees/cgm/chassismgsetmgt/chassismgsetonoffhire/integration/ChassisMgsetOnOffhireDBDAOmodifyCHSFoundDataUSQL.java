...
*@FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSFoundDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOmodifyCHSFoundDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOmodifyCHSFoundDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSFoundDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",CHSS_MVMT_DT = TO_DATE(@[f_evnt_dt] ,'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append(",CHSS_MVMT_STS_CD = 'BI'" ).append("\n"); 
		query.append(",GATE_IO_CD = 'I'" ).append("\n"); 
