...
*@FileName : CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_45QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_45QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ECC_LNK 테이블에 대한 TZ 45feet amount  수정
	  * </pre>
	  */
	public CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_45QueryUSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_45QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET  TZ_45FT_COST_AMT  = ${curr_cost}" ).append("\n"); 
