...
/**
 * ALPS CNTRInventoryReportDAO <br>
...
public class CNTRInventoryReportDBDAO extends DBDAOSupport {
	...
	*/
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<InvtSmryVO> searchInvtOptmStkList(InvtOptionVO invtOptionVO) throws DAOException {
		DBRowSet dbRowset = null;
		List<InvtSmryVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CNTRInventoryReportDBDAOsearchLandInvtOptmStkListRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, InvtSmryVO.class);
		}catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<InvtOptionVO> searchYearWk() throws DAOException {
		DBRowSet dbRowset = null;
		List<InvtOptionVO> list = null;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		Map<String, Object> velParam = new HashMap<String, Object>();
		try{
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CNTRInventoryReportDBDAOsearchYearWeekListRSQL(), param, velParam);
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, InvtOptionVO.class);
		}catch(SQLException se){
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
	...
	public List<InvtSmryVO> searchSeaInvtListByPolPod(InvtOptionVO invtOptionVO) throws DAOException {
		...
		try{
			...
			if(invtOptionVO != null){
				if( "POL".equals (invtOptionVO.getPolPodWise())||"POD".equals (invtOptionVO.getPolPodWise())){
					...
					dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CNTRInventoryReportDBDAOsearchSeaInvtListByETAPodRSQL(), param, velParam);
				}
			}
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, InvtSmryVO.class);
		}catch(SQLException se){
