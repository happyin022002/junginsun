...
*@FileName : EES_EQR_0132HTMLAction.java
...
public class EES_EQR_0132HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0132HTMLAction 객체를 생성
	 */
	public EES_EQR_0132HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0132Event event = new EesEqr0132Event();
		

		String target =JSPUtil.getParameter(request, "target".trim(), "");  	// target (e-mail/Fax)
		String job_cd = JSPUtil.getParameter(request, "job_cd".trim(), "");  	// rd_code
		String user_id = JSPUtil.getParameter(request, "user_id".trim(), ""); //user id
		
		event.setTarget(target);
		event.setJobCd(job_cd);
