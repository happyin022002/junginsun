...
import com.hanjin.apps.alps.ees.mnr.operationmanage.disposalmgt.vo.DisposalPriceFileListINVO;
...
public class EES_MNR_0220HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0139HTMLAction 객체를 생성
	 */
	public EES_MNR_0220HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0220Event event = new EesMnr0220Event(); 
		  	 
		if(command.isCommand(FormCommand.MULTI)) {            
			event.setCustomMnrDatVrfyVOS((CustomMnrDatVrfyVO[])getVOs(request, CustomMnrDatVrfyVO .class,""));
			event.setEQFlagMgtINVO((DisposalPriceFileListINVO)getVO(request, DisposalPriceFileListINVO .class));
		}  
