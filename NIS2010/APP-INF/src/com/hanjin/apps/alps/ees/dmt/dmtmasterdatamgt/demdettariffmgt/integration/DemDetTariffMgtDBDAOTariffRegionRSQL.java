...
*@FileName : DemDetTariffMgtDBDAOTariffRegionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOTariffRegionRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOTariffRegionRSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOTariffRegionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
