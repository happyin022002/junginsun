...
*@FileName : MTYRepositionPerformanceAnalysisDBDAOREPOResultInGeneralFromRSQLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYRepositionPerformanceAnalysisDBDAOREPOResultInGeneralFromRSQLRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYRepositionPerformanceAnalysisDBDAOREPOResultInGeneralFromRSQLRSQL(){
		setQuery();
		...
		query.append("FileName : MTYRepositionPerformanceAnalysisDBDAOREPOResultInGeneralFromRSQLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			SELECT	/*+ ORDERED INDEX(T XAK10CIM_PORT_REPO) */" ).append("\n"); 
		query.append("        #else" ).append("\n"); 
		query.append("            SELECT /*+ ORDERED INDEX(T XAK11CIM_PORT_REPO) */" ).append("\n"); 
		...
		query.append("                    CIM_PORT_REPO	T," ).append("\n"); 
		query.append("					CIM_TP_SZ_DP_SEQ S" ).append("\n"); 
		query.append("                WHERE   T.VL_DT BETWEEN  TO_DATE(@[from], 'YYYYMMDD') + .0 AND TO_DATE(@[to], 'YYYYMMDD') + .99999" ).append("\n"); 
		query.append(" 	   	 		#elseif (${period} == 'W')" ).append("\n"); 
		query.append("        	  	  EQR_WK_PRD W," ).append("\n"); 
		query.append("                  CIM_PORT_REPO	T," ).append("\n"); 
		query.append("				  CIM_TP_SZ_DP_SEQ S" ).append("\n"); 
		query.append("                  WHERE T.VL_DT BETWEEN TO_DATE(W.WK_ST_DT,'YYYYMMDD') AND TO_DATE(W.WK_END_DT,'YYYYMMDD')+0.9999 " ).append("\n"); 
		query.append("                   AND  W.PLN_YR||W.PLN_WK	BETWEEN @[from]	AND @[to]" ).append("\n"); 
		query.append("				#end" ).append("\n"); 
		query.append("  			#end" ).append("\n"); 
