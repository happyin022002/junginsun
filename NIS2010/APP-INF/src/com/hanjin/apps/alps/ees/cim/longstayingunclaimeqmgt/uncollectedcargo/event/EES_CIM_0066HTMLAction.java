...
*@FileName : EES_CIM_0066HTMLAction.java
...
public class EES_CIM_0066HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0066HTMLAction 객체를 생성
	 */
	public EES_CIM_0066HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0066Event event = new EesCim0066Event();
		
		if(command.isCommand(FormCommand.MULTI01)) {
			event.setSearchUncollectedCargoFileVOS((SearchUncollectedCargoFileVO[])getVOs(request, SearchUncollectedCargoFileVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchUncollectedCargoFileVO((SearchUncollectedCargoFileVO)getVO(request, SearchUncollectedCargoFileVO .class));
		}
