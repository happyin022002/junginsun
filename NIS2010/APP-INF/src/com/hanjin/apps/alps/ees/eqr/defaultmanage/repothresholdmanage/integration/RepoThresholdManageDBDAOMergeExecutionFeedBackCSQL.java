...
*@FileName : RepoThresholdManageDBDAOMergeExecutionFeedBackCSQL.java
...
public class RepoThresholdManageDBDAOMergeExecutionFeedBackCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_REPO_EXE_PLN_FB 테이블의 데이터 수정/입력
	  * </pre>
	  */
	public RepoThresholdManageDBDAOMergeExecutionFeedBackCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : RepoThresholdManageDBDAOMergeExecutionFeedBackCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}