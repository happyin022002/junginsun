...
*@FileName : CNTRInventoryReportDBDAOmodifyOptmStkLccUpdIdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CNTRInventoryReportDBDAOmodifyOptmStkLccUpdIdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CNTRInventoryReportDBDAOmodifyOptmStkLccUpdIdUSQL(){
		setQuery();
		...
		query.append("FileName : CNTRInventoryReportDBDAOmodifyOptmStkLccUpdIdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
