...
*@FileName : EES_CIM_0028ViewAdapter
 ...
 * @since J2EE 1.5   
 */
public class EesCim0028ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			if ( colValues.get("loc_type_code").equals("4")) {
				...
				if ( Integer.parseInt(colValues.get("cntr_qty").trim().replace(",", "")) >= 0 ) {
					sbufXML.append("<TD EDIT='FALSE' COLOR='BLUE'><![CDATA["+JSPUtil.getNull(colValues.get("cntr_qty"))+"]]></TD>\n");
				} else {
					sbufXML.append("<TD EDIT='FALSE' COLOR='RED'><![CDATA["+JSPUtil.getNull(colValues.get("cntr_qty"))+"]]></TD>\n");
				}
			}
