...
*@FileName : EQAvailabilityFinderDBDAOsearchAvailPickUpListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQAvailabilityFinderDBDAOsearchAvailPickUpListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 금일 Pick-up된(PUP, Picked Up) 컨테이너 수량을 확인하는 화면
	  * </pre>
	  */
	public EQAvailabilityFinderDBDAOsearchAvailPickUpListRSQL(){
		setQuery();
		...
		query.append("FileName : EQAvailabilityFinderDBDAOsearchAvailPickUpListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE A.CNTR_AVAL_FCAST_TP_CD='PU'" ).append("\n"); 
