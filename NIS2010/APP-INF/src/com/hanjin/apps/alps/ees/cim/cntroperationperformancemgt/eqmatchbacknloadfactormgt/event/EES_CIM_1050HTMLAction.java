...
*@FileName : EES_CIM_1050HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.ees.cim.cntroperationperformancemgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_CIM_1050HTMLAction extends HTMLActionSupport {

    private static final long serialVersionUID = 1L;
    /**
     * EES_CIM_1050HTMLAction 객체를 생성
     */
    public EES_CIM_1050HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesCim1050Event event = new EesCim1050Event();
        if(command.isCommand(FormCommand.SEARCH)) {
            event.setSearchOptionByTradeLaneVvdVO((SearchOptionByTradeLaneVvdVO)getVO(request, SearchOptionByTradeLaneVvdVO .class));
			...
			String backendjob_key = request.getParameter("backendjob_key");
			event.setAttribute("KEY", backendjob_key);
		}
