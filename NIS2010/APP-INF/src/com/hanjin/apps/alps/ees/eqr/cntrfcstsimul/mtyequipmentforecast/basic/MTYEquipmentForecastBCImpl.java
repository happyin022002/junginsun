...
* 2014.02.05 신용찬 [CHM-201428796] SELCTY --> SELCOE 로 변경 
* 2015-08-10 신용찬 [CHM-201537079] SELCOE --> SELOPE
=========================================================*/ 
		...
		try {
			...
			for( int i=0; i<opmgFcstInputVOs.length; i++ ){
				if("Y".equals(opmgFcstInputVOs[i].getW4Ef())){
					...
					mtyBalanceListVO.setA5FcastQty(opmgFcstInputVOs[i].getW4A5());
				...
				if("Y".equals(opmgFcstInputVOs[i].getW5Ef())){
					...
					mtyBalanceListVO.setA5FcastQty(opmgFcstInputVOs[i].getW5A5());
				...
				if("Y".equals(opmgFcstInputVOs[i].getW6Ef())){
					...
					mtyBalanceListVO.setA5FcastQty(opmgFcstInputVOs[i].getW6A5());
				...
				if("Y".equals(opmgFcstInputVOs[i].getW7Ef())){
					...
					mtyBalanceListVO.setA5FcastQty(opmgFcstInputVOs[i].getW7A5());
				...
				if("Y".equals(opmgFcstInputVOs[i].getW8Ef())){                    
					MtyBalanceListVO mtyBalanceListVO = new MtyBalanceListVO();     
					                                                                
					mtyBalanceListVO.setD2FcastQty(opmgFcstInputVOs[i].getW8D2());  
					mtyBalanceListVO.setD4FcastQty(opmgFcstInputVOs[i].getW8D4());  
					mtyBalanceListVO.setD5FcastQty(opmgFcstInputVOs[i].getW8D5());  
					mtyBalanceListVO.setD7FcastQty(opmgFcstInputVOs[i].getW8D7());  
					mtyBalanceListVO.setR2FcastQty(opmgFcstInputVOs[i].getW8R2());  
					mtyBalanceListVO.setR5FcastQty(opmgFcstInputVOs[i].getW8R5());  
					mtyBalanceListVO.setR9FcastQty(opmgFcstInputVOs[i].getW8R9());  
					mtyBalanceListVO.setO2FcastQty(opmgFcstInputVOs[i].getW8O2());  
					mtyBalanceListVO.setS2FcastQty(opmgFcstInputVOs[i].getW8S2());  
					mtyBalanceListVO.setO4FcastQty(opmgFcstInputVOs[i].getW8O4());  
					mtyBalanceListVO.setS4FcastQty(opmgFcstInputVOs[i].getW8S4());  
					mtyBalanceListVO.setF2FcastQty(opmgFcstInputVOs[i].getW8F2());  
					mtyBalanceListVO.setA2FcastQty(opmgFcstInputVOs[i].getW8A2());  
					mtyBalanceListVO.setF4FcastQty(opmgFcstInputVOs[i].getW8F4());  
					mtyBalanceListVO.setA4FcastQty(opmgFcstInputVOs[i].getW8A4());  
					mtyBalanceListVO.setA5FcastQty(opmgFcstInputVOs[i].getW8A5());  
					mtyBalanceListVO.setF5FcastQty(opmgFcstInputVOs[i].getW8F5());  
					mtyBalanceListVO.setO5FcastQty(opmgFcstInputVOs[i].getW8O5());  
                                                                          
					mtyBalanceListVO.setFcastYrwk(opmgFcstInputVOs[i].getW8Wk());   
					mtyBalanceListVO.setFcastYrwk0(opmgFcstInputVOs[i].getW8Wk());  
					mtyBalanceListVO.setInpYrwk(opmgFcstInputVOs[i].getW3Wk());     
					mtyBalanceListVO.setLocCd(opmgFcstInputVOs[i].getLocCd());      
					mtyBalanceListVO.setLocGrpCd(opmgFcstInputVOs[i].getLocGrpCd());
					mtyBalanceListVO.setTpCd(opmgFcstInputVOs[i].getMtyBalTpCd());  
				...
				if("Y".equals(opmgFcstInputVOs[i].getW9Ef())){                    
					MtyBalanceListVO mtyBalanceListVO = new MtyBalanceListVO();     
					                                                                
					mtyBalanceListVO.setD2FcastQty(opmgFcstInputVOs[i].getW9D2());  
					mtyBalanceListVO.setD4FcastQty(opmgFcstInputVOs[i].getW9D4());  
					mtyBalanceListVO.setD5FcastQty(opmgFcstInputVOs[i].getW9D5());  
					mtyBalanceListVO.setD7FcastQty(opmgFcstInputVOs[i].getW9D7());  
					mtyBalanceListVO.setR2FcastQty(opmgFcstInputVOs[i].getW9R2());  
					mtyBalanceListVO.setR5FcastQty(opmgFcstInputVOs[i].getW9R5());  
					mtyBalanceListVO.setR9FcastQty(opmgFcstInputVOs[i].getW9R9());  
					mtyBalanceListVO.setO2FcastQty(opmgFcstInputVOs[i].getW9O2());  
					mtyBalanceListVO.setS2FcastQty(opmgFcstInputVOs[i].getW9S2());  
					mtyBalanceListVO.setO4FcastQty(opmgFcstInputVOs[i].getW9O4());  
					mtyBalanceListVO.setS4FcastQty(opmgFcstInputVOs[i].getW9S4());  
					mtyBalanceListVO.setF2FcastQty(opmgFcstInputVOs[i].getW9F2());  
					mtyBalanceListVO.setA2FcastQty(opmgFcstInputVOs[i].getW9A2());  
					mtyBalanceListVO.setF4FcastQty(opmgFcstInputVOs[i].getW9F4());  
					mtyBalanceListVO.setA4FcastQty(opmgFcstInputVOs[i].getW9A4());  
					mtyBalanceListVO.setA5FcastQty(opmgFcstInputVOs[i].getW9A5());  
					mtyBalanceListVO.setF5FcastQty(opmgFcstInputVOs[i].getW9F5());  
					mtyBalanceListVO.setO5FcastQty(opmgFcstInputVOs[i].getW9O5());  
                                                                          
					mtyBalanceListVO.setFcastYrwk(opmgFcstInputVOs[i].getW9Wk());   
					mtyBalanceListVO.setFcastYrwk0(opmgFcstInputVOs[i].getW9Wk());  
					mtyBalanceListVO.setInpYrwk(opmgFcstInputVOs[i].getW3Wk());     
					mtyBalanceListVO.setLocCd(opmgFcstInputVOs[i].getLocCd());      
					mtyBalanceListVO.setLocGrpCd(opmgFcstInputVOs[i].getLocGrpCd());
					mtyBalanceListVO.setTpCd(opmgFcstInputVOs[i].getMtyBalTpCd());  
	...
	public void manageMtyBalanceOther(MtyBalRptOtrVO[] mtyBalRptOtrVOs, SignOnUserAccount account) throws EventException
	{
		try {
			...
			if(mtyBalRptOtrVOs != null) {
				...
				// 저장가능여부 로직은 오픈당시에 결정, 2013-12-05, 신용찬
...
//				}
				...
				// SELCTY --> SELCOE 조직개편으로 변경, 2014-02-05, 신용찬
				// SELCOE --> SELOPE 로 변경, 2015-08-10
				//if ( !account.getOfc_cd().substring(0, 6).equals("SELCOE") ) { 
				//if ( !account.getOfc_cd().substring(0, 6).equals("SELOPE") ) {
				if ( !account.getOfc_cd().substring(0, 6).equals("SELCTY") ) {	
					saveFlag= validationUpdateAval(locCd,inputYearWeek,"1");	//message : FCST revision for accuracy evaluation only available by 17:00, Friday
	 ...
	 * 
	 * @param SalesFcstDtlVO salesFcstDtlVO
	 * @return List<SalesFcstDtlVO>
	 * @exception EventException
	 */
	public List<SalesFcstDtlVO> searchEqFcstDetail(SalesFcstDtlVO salesFcstDtlVO) throws EventException {
		try {
			return dbDao.searchEqFcstDetail(salesFcstDtlVO);
		} catch (DAOException ex) {
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("EQR10028", new String[]{"Sales Projection Detail Retrieve"}).getMessage(),ex);
		}
	}
	 ...
	 * 
	 * @param SalesProjectionHistVO salesProjectionHistVO
	 * @param SignOnUserAccount account
	 * @return String
	 * @exception EventException
	 */
	public String searchEqFcstHist(SalesProjectionHistVO salesProjectionHistVO, SignOnUserAccount account) throws EventException {
		MTYEquipmentForecastBackEndJobHist backEndJob = new MTYEquipmentForecastBackEndJobHist();
		backEndJob.setJobType("MTYEquipmentForecastHist");
		backEndJob.setSalesProjectionHistVO(salesProjectionHistVO);
		
		BackEndJobManager backEndJobManager = new BackEndJobManager();
		try {
			return backEndJobManager.execute(backEndJob, account.getUsr_id(), "MTYEquipmentForecast BackEndJob");
		} catch (Exception ex) { 
			log.error("err " + ex.toString(), ex);
			throw new EventException(new ErrorHandler("EQR10028", new String[]{"Sales Projection History"}).getMessage(),ex);
		}
	}
}