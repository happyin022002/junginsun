...
import com.hanjin.apps.alps.ees.mnr.generalmanage.cedexcodemgt.vo.DivisionCodeINVO;
...
public class EES_MNR_0225HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_MNR_0003HTMLAction 객체를 생성
	 */
	public EES_MNR_0225HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesMnr0225Event event = new EesMnr0225Event();  
    	DivisionCodeGRPVO divisionCodeGRPVO = new DivisionCodeGRPVO();
    	 	
		if(command.isCommand(FormCommand.SEARCH)) {         
			divisionCodeGRPVO.setDivisionCodeINVO((DivisionCodeINVO)getVO(request, DivisionCodeINVO.class));
		}  else if(command.isCommand(FormCommand.MULTI)) {  
			divisionCodeGRPVO.setDivisionCodeINVO((DivisionCodeINVO)getVO(request, DivisionCodeINVO.class));
			divisionCodeGRPVO.setArrCustomMnrCdRltVOS((CustomMnrCdRltVO[])getVOs(request, CustomMnrCdRltVO .class,""));
		}				   	
		event.setDivisionCodeGRPVO(divisionCodeGRPVO);   	
