...
*@FileName : EES_CGM_2022HTMLAction.java
...
public class EES_CGM_2022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_2022HTMLAction 객체를 생성
	 */
	public EES_CGM_2022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm2022Event event = new EesCgm2022Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {	
			event.setMgsAgreementListINVO((MGSAgreementListINVO)getVO(request, MGSAgreementListINVO .class));
		}
