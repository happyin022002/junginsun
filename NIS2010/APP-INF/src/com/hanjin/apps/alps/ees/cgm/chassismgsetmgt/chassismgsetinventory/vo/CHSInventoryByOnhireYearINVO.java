...
*@FileName : CHSInventoryByOnhireYearINVO.java
*@FileTitle : CHSInventoryByOnhireYearINVO
*Open Issues :
*Change history :
...
public class CHSInventoryByOnhireYearINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInventoryByOnhireYearINVO> models = new ArrayList<CHSInventoryByOnhireYearINVO>();
	...
	public CHSInventoryByOnhireYearINVO() {}
	 ...
	 */
	public CHSInventoryByOnhireYearINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInventoryByOnhireYearINVO[]
	 */
	public CHSInventoryByOnhireYearINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInventoryByOnhireYearINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSInventoryByOnhireYearINVO();
				if (location[i] != null)
		...
		return getCHSInventoryByOnhireYearINVOs();
	}
	 ...
	 * @return CHSInventoryByOnhireYearINVO[]
	 */
	public CHSInventoryByOnhireYearINVO[] getCHSInventoryByOnhireYearINVOs(){
		CHSInventoryByOnhireYearINVO[] vos = (CHSInventoryByOnhireYearINVO[])models.toArray(new CHSInventoryByOnhireYearINVO[models.size()]);
		return vos;
	}
