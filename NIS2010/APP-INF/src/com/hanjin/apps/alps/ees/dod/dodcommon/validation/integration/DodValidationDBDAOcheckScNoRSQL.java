...
*@FileName : DodValidationDBDAOcheckScNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodValidationDBDAOcheckScNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Pricing SC_NO 유효성 체크
	  * </pre>
	  */
	public DodValidationDBDAOcheckScNoRSQL(){
		setQuery();
		...
		query.append("FileName : DodValidationDBDAOcheckScNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE SC_NO = @[s_value]" ).append("\n"); 
