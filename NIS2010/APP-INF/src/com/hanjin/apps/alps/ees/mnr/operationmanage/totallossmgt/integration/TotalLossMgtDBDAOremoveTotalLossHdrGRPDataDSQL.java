...
*@FileName : TotalLossMgtDBDAOremoveTotalLossHdrGRPDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TotalLossMgtDBDAOremoveTotalLossHdrGRPDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeTotalLossHDRData
	  * </pre>
	  */
	public TotalLossMgtDBDAOremoveTotalLossHdrGRPDataDSQL(){
		setQuery();
		...
		query.append("FileName : TotalLossMgtDBDAOremoveTotalLossHdrGRPDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
