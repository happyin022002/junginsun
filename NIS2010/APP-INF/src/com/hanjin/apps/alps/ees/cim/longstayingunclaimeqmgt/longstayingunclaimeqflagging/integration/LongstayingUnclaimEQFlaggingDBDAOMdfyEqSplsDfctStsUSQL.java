...
*@FileName : LongstayingUnclaimEQFlaggingDBDAOMdfyEqSplsDfctStsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LongstayingUnclaimEQFlaggingDBDAOMdfyEqSplsDfctStsUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [EES_CIM_0060] EQ Balance Report Input => update
	  * </pre>
	  */
	public LongstayingUnclaimEQFlaggingDBDAOMdfyEqSplsDfctStsUSQL(){
		setQuery();
		...
		query.append("FileName : LongstayingUnclaimEQFlaggingDBDAOMdfyEqSplsDfctStsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CIM_EQ_SPLS_DFCT_STS" ).append("\n"); 
		query.append("set SPLS_DFCT_STS_CTNT = @[spls_dfct_sts_ctnt]" ).append("\n"); 
		query.append(",CFM_FLG = @[cfm_flg]" ).append("\n"); 
		query.append(",STS_RMK = @[sts_rmk]" ).append("\n"); 
