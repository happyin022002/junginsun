...
*@FileName : EES_CIM_0071HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.ees.cim.longstayingunclaimeqmgt.uncollectedcargo.EES_CIM_0071 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author DO-HYUN KIM
 * @see EesCim0071Event 참조
 * @since J2EE 1.6
 */

public class EES_CIM_0071HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0071HTMLAction 객체를 생성
	 */
	public EES_CIM_0071HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0071Event event = new EesCim0071Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchUncollectedGlMonXchRtListVO((SearchUncollectedGlMonXchRtListVO)getVO(request, SearchUncollectedGlMonXchRtListVO .class));
		}
