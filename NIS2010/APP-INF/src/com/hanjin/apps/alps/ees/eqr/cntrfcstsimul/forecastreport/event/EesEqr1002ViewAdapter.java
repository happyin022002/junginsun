 ...
 * @since J2EE 1.5
 */
public class EesEqr1002ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(DBRowSet rs,String prefix) {
		...
		try{
			...
			while (rs.next()) { 
				if( rs.getString("CODE").equals("RI") || rs.getString("CODE").equals("OT") || rs.getString("CODE").equals("IF") ) {
					rowBgColor = " BGCOLOR=\"246,250,251\" ";
				} else if( rs.getString("CODE").equals("OF") || rs.getString("CODE").equals("RO")) {
					rowBgColor = " BGCOLOR=\"255,234,234\" ";
				} else if( rs.getString("CODE").equals("BA") ) {
					rowBgColor = " BGCOLOR=\"208,236,127\" ";
				} else if( rs.getString("CODE").equals("IN") || rs.getString("CODE").equals("IC") ) {
