...
*@FileName : CgmCodeMgtDBDAOModifyVersionStatusDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOModifyVersionStatusDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CgmCodeMgtDBDAOModifyVersionStatusDataUSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOModifyVersionStatusDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("SET		CHSS_EXPT_VER_STS_CD = @[chss_expt_ver_sts_cd]" ).append("\n"); 
