...
*@FileName : GeneralCodeCheckMgtDBDAOcheckComponentCodeDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralCodeCheckMgtDBDAOcheckComponentCodeDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * checkComponentCodeData
	  * </pre>
	  */
	public GeneralCodeCheckMgtDBDAOcheckComponentCodeDataRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralCodeCheckMgtDBDAOcheckComponentCodeDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND A.EQ_CMPO_CD = @[check_value]" ).append("\n"); 
