...
*@FileName : ChassisMgsetAgreementDBDAORemoveCHSCpsAgreementMainDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetAgreementDBDAORemoveCHSCpsAgreementMainDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Master 정보를 삭제한다.
	  * </pre>
	  */
	public ChassisMgsetAgreementDBDAORemoveCHSCpsAgreementMainDataDSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetAgreementDBDAORemoveCHSCpsAgreementMainDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
