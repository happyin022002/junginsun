...
*@FileName : SearchOfferInquiryVO.java
*@FileTitle : SearchOfferInquiryVO
*Open Issues :
*Change history :
...
public class SearchOfferInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOfferInquiryVO> models = new ArrayList<SearchOfferInquiryVO>();
	...
	/* Column Info */
	private String fmToConti = null;
	/* Column Info */
	private String lstmCd = null;
	/* Column Info */
	private String lseItchgRqstQty = null;
	/* Column Info */
	...
	public SearchOfferInquiryVO(String ibflag, String pagerows, String lseItchgRqstNo, String lseItchgRqstSeq, String lstmCd, String lrVndrSeq, String fmLocCd, String cntrTpszCd, String lseLocGrpCd, String toLocCd, String fmCostAmt, String toCostAmt, String rqstQty, String lseFreeDys, String pkupUtAmt, String addTtlCostAmt, String pkupCrAmt, String ttlSavAmt, String lseItchgAuthNo, String lseItchgAuthSeq, String agmtCtyCd, String agmtSeq, String lseItchgOffrQty, String lseItchgAuthQty, String deltFlg, String authNo, String locFm, String locTo, String tpszCd, String vndrSeq, String locTp, String vndrAbbrNm, String locFmTp, String periodStdt, String periodEddt, String authFlg, String porSave, String pucCost, String saveUc, String lseItchgRqstQty, String fmToConti) {
		...
		this.fmToConti = fmToConti;
		this.lstmCd = lstmCd;
		this.lseItchgRqstQty = lseItchgRqstQty;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("fm_to_conti", getFmToConti());
		this.hashColumns.put("lstm_cd", getLstmCd());
		this.hashColumns.put("lse_itchg_rqst_qty", getLseItchgRqstQty());
		this.hashColumns.put("loc_fm_tp", getLocFmTp());
		...
		this.hashColumns.put("save_uc", getSaveUc());
		...
		this.hashColumns.put("por_save", getPorSave());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("fm_to_conti", "fmToConti");
		this.hashFields.put("lstm_cd", "lstmCd");
		this.hashFields.put("lse_itchg_rqst_qty", "lseItchgRqstQty");
		this.hashFields.put("loc_fm_tp", "locFmTp");
		...
		this.hashFields.put("save_uc", "saveUc");
		...
		this.hashFields.put("por_save", "porSave");
	 ...
	 * @return fmToConti
	 */
	public String getFmToConti() {
		return this.fmToConti;
	}
	...
	/**
	 * Column Info
	 * @return lseItchgRqstQty
	 */
	public String getLseItchgRqstQty() {
		return this.lseItchgRqstQty;
	}
	 ...
	 * @param fmToConti
	 */
	public void setFmToConti(String fmToConti) {
		this.fmToConti = fmToConti;
	}
	...
	/**
	 * Column Info
	 * @param lseItchgRqstQty
	 */
	public void setLseItchgRqstQty(String lseItchgRqstQty) {
		this.lseItchgRqstQty = lseItchgRqstQty;
	}
	 ...
	 * @param saveUc
	 */
	public void setSaveUc(String saveUc) {
		this.saveUc = saveUc;
	}
	 ...
	 * @param porSave
	 */
	public void setPorSave(String porSave) {
		this.porSave = porSave;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFmToConti(JSPUtil.getParameter(request, prefix + "fm_to_conti", ""));
		setLstmCd(JSPUtil.getParameter(request, prefix + "lstm_cd", ""));
		setLseItchgRqstQty(JSPUtil.getParameter(request, prefix + "lse_itchg_rqst_qty", ""));
		setLocFmTp(JSPUtil.getParameter(request, prefix + "loc_fm_tp", ""));
		...
		setSaveUc(JSPUtil.getParameter(request, prefix + "save_uc", ""));
		...
		setPorSave(JSPUtil.getParameter(request, prefix + "por_save", ""));
	 ...
	 */
	public SearchOfferInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOfferInquiryVO[]
	 */
	public SearchOfferInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOfferInquiryVO model = null;
		...
		try {
			...
			String[] fmToConti = (JSPUtil.getParameter(request, prefix	+ "fm_to_conti", length));
			String[] lstmCd = (JSPUtil.getParameter(request, prefix	+ "lstm_cd", length));
			String[] lseItchgRqstQty = (JSPUtil.getParameter(request, prefix	+ "lse_itchg_rqst_qty", length));
			String[] locFmTp = (JSPUtil.getParameter(request, prefix	+ "loc_fm_tp", length));
			...
			String[] saveUc = (JSPUtil.getParameter(request, prefix	+ "save_uc", length));
			...
			String[] porSave = (JSPUtil.getParameter(request, prefix	+ "por_save", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOfferInquiryVO();
				if (authFlg[i] != null)
				...
				if (fmToConti[i] != null)
					model.setFmToConti(fmToConti[i]);
				if (lstmCd[i] != null)
					model.setLstmCd(lstmCd[i]);
				if (lseItchgRqstQty[i] != null)
					model.setLseItchgRqstQty(lseItchgRqstQty[i]);
				if (locFmTp[i] != null)
					model.setLocFmTp(locFmTp[i]);
				if (toCostAmt[i] != null)
		...
		return getSearchOfferInquiryVOs();
	}
	...
	public SearchOfferInquiryVO[] getSearchOfferInquiryVOs(){
		SearchOfferInquiryVO[] vos = (SearchOfferInquiryVO[])models.toArray(new SearchOfferInquiryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.fmToConti = this.fmToConti .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.lstmCd = this.lstmCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.lseItchgRqstQty = this.lseItchgRqstQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.locFmTp = this.locFmTp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.saveUc = this.saveUc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.porSave = this.porSave .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
