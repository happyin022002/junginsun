 ...
 * @since J2EE 1.6
 */
public class EES_LSE_0020HTMLAction extends HTMLActionSupport {
	/*
	 * 객체직렬화 버젼 UID
	 */
	...
	/**
	 * EES_LSE_0020HTMLAction 객체를 생성
	 */
	public EES_LSE_0020HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0020Event event = new EesLse0020Event();
