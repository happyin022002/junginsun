...
*@FileName : EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByLogisticWiseInSummaryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByLogisticWiseInSummaryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Domestic Match-Back (M/B %)
	  * </pre>
	  */
	public EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByLogisticWiseInSummaryRSQL(){
		setQuery();
		...
		query.append("FileName : EQMatchBackNLoadFactorMgtDBDAOsearchLocationMBByLogisticWiseInSummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("'00000' LOC_CD," ).append("\n"); 
		query.append("'00000' DIVISION," ).append("\n"); 
		...
		query.append("					 #elseif( ${locationBy} == 'RC' || ${locationBy} == 'AC' || ${locationBy} == 'CC')" ).append("\n"); 
		...
		query.append("					CIM_YD_LOC_MTCH_BAK_SMRY	T," ).append("\n"); 
		...
		query.append("			#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			/* tnRoute */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			#if (${tnRoute} == 'E')" ).append("\n"); 
		query.append("			AND T.TN_ROUT_FLG =	'N'" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("			#if (${tnRoute} == 'O')" ).append("\n"); 
		query.append("			AND T.TN_ROUT_FLG =	'Y'" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("GROUP BY" ).append("\n"); 
		query.append("		X.LOC_CD," ).append("\n"); 
		query.append("        DECODE(Y.NO,'1','AA','2','BB','3','CC','4','DD')" ).append("\n"); 
		query.append("" ).append("\n"); 
