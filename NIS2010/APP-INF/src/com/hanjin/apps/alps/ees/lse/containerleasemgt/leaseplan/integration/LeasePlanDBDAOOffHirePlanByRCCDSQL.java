...
*@FileName : LeasePlanDBDAOOffHirePlanByRCCDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LeasePlanDBDAOOffHirePlanByRCCDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LeasePlanDBDAOOffHirePlanByRCCDSQL(){
		setQuery();
		...
		query.append("FileName : LeasePlanDBDAOOffHirePlanByRCCDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    OFFH_YRMON = @[offh_yrmon]" ).append("\n"); 
		...
		query.append("AND    OFFH_LOC_CD = @[offh_loc_cd]" ).append("\n"); 
