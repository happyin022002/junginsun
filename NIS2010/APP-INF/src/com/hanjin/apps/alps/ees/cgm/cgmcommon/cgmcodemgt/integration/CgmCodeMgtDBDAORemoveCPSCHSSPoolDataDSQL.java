...
*@FileName : CgmCodeMgtDBDAORemoveCPSCHSSPoolDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAORemoveCPSCHSSPoolDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CPS Neutral Pool을 삭제한다.
	  * </pre>
	  */
	public CgmCodeMgtDBDAORemoveCPSCHSSPoolDataDSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAORemoveCPSCHSSPoolDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
