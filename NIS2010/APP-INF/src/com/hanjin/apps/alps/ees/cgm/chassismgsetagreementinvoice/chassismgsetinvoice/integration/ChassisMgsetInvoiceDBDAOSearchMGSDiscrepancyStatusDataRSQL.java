...
*@FileName : ChassisMgsetInvoiceDBDAOSearchMGSDiscrepancyStatusDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchMGSDiscrepancyStatusDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.SearchMGSDiscrepancyStatusData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchMGSDiscrepancyStatusDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchMGSDiscrepancyStatusDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND B.PAY_LSE_CHG_STS_CD = 'D'" ).append("\n"); 
