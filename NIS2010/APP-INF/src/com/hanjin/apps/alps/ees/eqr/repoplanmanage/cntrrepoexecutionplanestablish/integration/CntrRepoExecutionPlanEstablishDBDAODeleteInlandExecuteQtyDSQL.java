...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteQtyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteQtyDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_INLND_TRSP_EXE_PLN_QTY  테이블의 특정 ref id, repo plan id 삭제
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteQtyDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteInlandExecuteQtyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("EQR_INLND_TRSP_EXE_PLN_QTY" ).append("\n"); 
