...
*@FileName : SCExceptionTariffMgtDBDAOSearchSCExceptionListByPropNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchSCExceptionListByPropNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Prop No. 에 해당되는 모든 SC Exception 정보를 조회하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchSCExceptionListByPropNoRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchSCExceptionListByPropNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",   (" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT  /*+ INDEX_ASC(DMT_SC_EXPT_VER_PROG XPKDMT_SC_EXPT_VER_PROG) */ TO_CHAR(PROG_DT, 'YYYY-MM-DD') AS PROG_DT" ).append("\n"); 
		query.append("FROM    DMT_SC_EXPT_VER_PROG" ).append("\n"); 
		query.append("WHERE   PROP_NO 			 = SP_HDR.PROP_NO" ).append("\n"); 
		query.append("AND SC_EXPT_VER_SEQ 	 = SC_VER.SC_EXPT_VER_SEQ" ).append("\n"); 
		query.append("AND DMDT_EXPT_VER_STS_CD IN ('A', 'L')" ).append("\n"); 
