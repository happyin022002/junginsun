...
*@FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchNoIssueReleaseListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchNoIssueReleaseListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyReleaseRedeliveryOrderMgtDBDAOSearchNoIssueReleaseListRSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchNoIssueReleaseListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/** RELEASE-01 **/" ).append("\n"); 
		...
		query.append("            CMO.FM_NOD_CD AS EMPTY_CY," ).append("\n"); 
		query.append("            CMO.FM_NOD_CD AS ORG_EMPTY_CY," ).append("\n"); 
		query.append("            MV.VNDR_SEQ AS S_P," ).append("\n"); 
		query.append("            MV.VNDR_LGL_ENG_NM AS VNDR_LGL_ENG_NM," ).append("\n"); 
		query.append("            TO_CHAR (CMO.N1ST_NOD_PLN_DT, 'YYYY-MM-DD') AS PD_DATE_DISP," ).append("\n"); 
		query.append("            TO_CHAR (CMO.N1ST_NOD_PLN_DT, 'YYYY-MM-DD') AS PD_DATE," ).append("\n"); 
		...
		query.append("                    ORD.FM_NOD_CD," ).append("\n"); 
		...
		query.append("           #end" ).append("\n"); 
		query.append("                AND ORD.FM_NOD_CD = MY.YD_CD" ).append("\n"); 
		...
		query.append("   GROUP BY CMO.CRE_OFC_CD," ).append("\n"); 
		query.append("            CMO.TRSP_BND_CD," ).append("\n"); 
		query.append("            CMO.TRSP_CRR_MOD_CD," ).append("\n"); 
		query.append("            NVL (BB.PRE_RLY_PORT_CD, BB.POL_CD)," ).append("\n"); 
		query.append("            NVL (BB.PST_RLY_PORT_CD, BB.POD_CD)," ).append("\n"); 
		query.append("            CMO.FM_NOD_CD," ).append("\n"); 
		query.append("            MV.VNDR_SEQ," ).append("\n"); 
		query.append("            MV.VNDR_LGL_ENG_NM," ).append("\n"); 
		query.append("            TO_CHAR (CMO.N1ST_NOD_PLN_DT, 'YYYY-MM-DD')," ).append("\n"); 
		query.append("            CMO.EQ_NO," ).append("\n"); 
		query.append("            CMO.EQ_TPSZ_CD," ).append("\n"); 
		query.append("            CMO.FAX_NO," ).append("\n"); 
		query.append("            CMO.YD_EML," ).append("\n"); 
		query.append("            CMO.BKG_NO," ).append("\n"); 
		query.append("            CMO.BL_NO," ).append("\n"); 
		query.append("            BB.VSL_CD||BB.SKD_VOY_NO||BB.SKD_DIR_CD," ).append("\n"); 
		query.append("            CMO.TRSP_WO_OFC_CTY_CD," ).append("\n"); 
		query.append("            CMO.TRSP_WO_SEQ," ).append("\n"); 
		...
		query.append("#if (${wo_no} == '')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("/** RELEASE-02 **/" ).append("\n"); 
		...
		query.append("            NVL (BB.PRE_RLY_PORT_CD, BB.POL_CD) AS POL," ).append("\n"); 
		query.append("            NVL (BB.PST_RLY_PORT_CD, BB.POD_CD) AS POD," ).append("\n"); 
		query.append("            TRO.CNTR_PKUP_YD_CD AS EMPTY_CY," ).append("\n"); 
		query.append("            TRO.CNTR_PKUP_YD_CD AS ORG_EMPTY_CY," ).append("\n"); 
		query.append("            NULL AS S_P," ).append("\n"); 
		query.append("            '' AS VNDR_LGL_ENG_NM," ).append("\n"); 
		query.append("            TO_CHAR (TRO.CNTR_PKUP_DT, 'YYYY-MM-DD') AS PD_DATE_DISP," ).append("\n"); 
		query.append("            TO_CHAR (TRO.CNTR_PKUP_DT, 'YYYY-MM-DD') AS PD_DATE," ).append("\n"); 
		...
		query.append("      WHERE 1 = 1" ).append("\n"); 
		query.append("       #if ((${bkg_no} == '' && ${bl_no} == '' && ${cntr_no} == '' && ${wo_no} == '') && (${p_date1} != '' && ${p_date2} != ''))" ).append("\n"); 
		query.append("            AND TRO.CNTR_PKUP_DT BETWEEN TO_DATE (@[p_date1], 'YYYY-MM-DD') AND TO_DATE (@[p_date2], 'YYYY-MM-DD') + 0.99999" ).append("\n"); 
		query.append("       #end" ).append("\n"); 
		query.append("            AND CT.CNTR_STK_TERR_CD = @[territory]" ).append("\n"); 
		...
		query.append("       #end" ).append("\n"); 
		query.append("       #if (${p_yard2} != '')" ).append("\n"); 
		query.append("            AND TRO.CNTR_PKUP_YD_CD = @[p_yard1]||@[p_yard2]" ).append("\n"); 
		query.append("       #elseif (${p_yard1} != '')" ).append("\n"); 
		query.append("            AND TRO.CNTR_PKUP_YD_CD LIKE @[p_yard1]||'%'" ).append("\n"); 
		query.append("       #end" ).append("\n"); 
		query.append("       #if (${lcc_cd} != '')" ).append("\n"); 
		query.append("            AND MC.LCC_CD LIKE @[lcc_cd]||'%'" ).append("\n"); 
		query.append("            AND MC.SCC_CD = ML.SCC_CD" ).append("\n"); 
		...
		query.append("       #end" ).append("\n"); 
		query.append("            AND TRO.CNTR_PKUP_YD_CD = MY.YD_CD" ).append("\n"); 
		...
		query.append("           #end" ).append("\n"); 
		query.append("           #if (${cntr_tpsz_cd} != '')" ).append("\n"); 
		query.append("                AND ORD.CNTR_TPSZ_CD IN (${cntr_tpsz_cd})" ).append("\n"); 
		query.append("           #end" ).append("\n"); 
		query.append("                AND CT.CNTR_STK_TERR_CD = @[territory]" ).append("\n"); 
		query.append("                AND CT.OFC_CD = @[office]" ).append("\n"); 
		query.append("                AND MY.YD_CD LIKE CT.CNT_CD||'%'" ).append("\n"); 
		...
		query.append("                                   AND STK.SO_SEQ = ORD.TRSP_SO_SEQ" ).append("\n"); 
		query.append("                                   AND STK.TRSP_SO_TP_CD = DECODE (ORD.TRSP_COST_DTL_MOD_CD, 'DR', 'C', 'CN', 'S', 'CF', 'S', 'ER', 'R', ORD.TRSP_COST_DTL_MOD_CD))" ).append("\n"); 
		query.append("                AND (ORD.TRSP_COST_DTL_MOD_CD = 'ER' OR ORD.TRSP_COST_DTL_MOD_CD = 'CF')    /** Carriou **/" ).append("\n"); 
		query.append("                AND ORD.TRSP_COST_DTL_MOD_CD = NVL (@[bkg_no], ORD.TRSP_COST_DTL_MOD_CD)" ).append("\n"); 
		...
		query.append("   GROUP BY CMO.CRE_OFC_CD," ).append("\n"); 
		query.append("            CMO.TRSP_CRR_MOD_CD," ).append("\n"); 
		query.append("            CMO.TRSP_COST_DTL_MOD_CD," ).append("\n"); 
		query.append("            CMO.FM_NOD_CD," ).append("\n"); 
		query.append("            MV.VNDR_SEQ," ).append("\n"); 
		query.append("            MV.VNDR_LGL_ENG_NM," ).append("\n"); 
		query.append("            TO_CHAR (CMO.TRSP_MTY_RQST_DT, 'YYYY-MM-DD')," ).append("\n"); 
		query.append("            CMO.EQ_NO," ).append("\n"); 
		query.append("            CMO.EQ_TPSZ_CD," ).append("\n"); 
		query.append("            CMO.TO_NOD_CD," ).append("\n"); 
		query.append("            CMO.FAX_NO," ).append("\n"); 
		query.append("            CMO.YD_EML," ).append("\n"); 
		query.append("            CMO.TRSP_WO_OFC_CTY_CD," ).append("\n"); 
		query.append("            CMO.TRSP_WO_SEQ" ).append("\n"); 
