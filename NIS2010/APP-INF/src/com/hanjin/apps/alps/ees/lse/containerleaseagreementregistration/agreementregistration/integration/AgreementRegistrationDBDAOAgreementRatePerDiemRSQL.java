...
*@FileName : AgreementRegistrationDBDAOAgreementRatePerDiemRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementRegistrationDBDAOAgreementRatePerDiemRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Lease Agreement Per-diem Rate Search
	  * </pre>
	  */
	public AgreementRegistrationDBDAOAgreementRatePerDiemRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementRegistrationDBDAOAgreementRatePerDiemRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
