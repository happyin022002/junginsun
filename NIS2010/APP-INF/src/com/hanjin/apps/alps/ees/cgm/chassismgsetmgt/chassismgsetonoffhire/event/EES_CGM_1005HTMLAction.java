...
*@FileName : EES_CGM_1005HTMLAction.java
...
public class EES_CGM_1005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1005HTMLAction 객체를 생성
	 */
	public EES_CGM_1005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1005Event event = new EesCgm1005Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCHSSpecINVOS((CHSSpecINVO[])getVOs(request, CHSSpecINVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {
			log.debug("********** : " + FormCommand.SEARCH01);
			event.setCHSSpecINVO((CHSSpecINVO)getVO(request, CHSSpecINVO.class));
		}
