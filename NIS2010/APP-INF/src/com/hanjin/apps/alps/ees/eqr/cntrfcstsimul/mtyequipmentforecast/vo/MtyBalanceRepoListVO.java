...
public class MtyBalanceRepoListVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("repo_out_rmk", getRepoOutRmk());
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRepoOutRmk(JSPUtil.getParameter(request, "repo_out_rmk", ""));	
	}
	...
	public MtyBalanceRepoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] repoOutRmk = (JSPUtil.getParameter(request, prefix	+ "repo_out_rmk", length));			
