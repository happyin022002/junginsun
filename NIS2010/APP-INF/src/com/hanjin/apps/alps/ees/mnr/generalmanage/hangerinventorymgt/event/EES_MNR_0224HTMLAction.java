...
*@FileName : EES_MNR_0224HTMLAction.java
 ...
 * @see EesMnr0224Event 참조
 * @since J2EE 1.6           
 */

public class EES_MNR_0224HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0224HTMLAction 객체를 생성
	 */	
	public EES_MNR_0224HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0224Event event = new EesMnr0224Event();
		...
		//저장
			...
			event.setCustomHangerInventoryListVOs((CustomHangerInventoryListVO[])getVOs(request, CustomHangerInventoryListVO .class,""));
		}    
