...
*@FileName : EqInterchangeDBDAOsearchEqInterchangeApprovalDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EqInterchangeDBDAOsearchEqInterchangeApprovalDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  *  Eq Interchange Approval Data 조회
	  * </pre>
	  */
	public EqInterchangeDBDAOsearchEqInterchangeApprovalDataRSQL(){
		setQuery();
		...
		query.append("FileName : EqInterchangeDBDAOsearchEqInterchangeApprovalDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  LCC_CD             AS LOC_FM_LCC," ).append("\n"); 
