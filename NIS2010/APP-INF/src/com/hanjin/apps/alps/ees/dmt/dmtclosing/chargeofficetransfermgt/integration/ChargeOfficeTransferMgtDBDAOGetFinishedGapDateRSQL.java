...
*@FileName : ChargeOfficeTransferMgtDBDAOGetFinishedGapDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeOfficeTransferMgtDBDAOGetFinishedGapDateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChargeOfficeTransferMgtDBDAOGetFinishedGapDateRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeOfficeTransferMgtDBDAOGetFinishedGapDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	(NVL(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[ofc_cd]),SYSDATE) - TO_MVMT_DT) GAP_DATE" ).append("\n"); 
