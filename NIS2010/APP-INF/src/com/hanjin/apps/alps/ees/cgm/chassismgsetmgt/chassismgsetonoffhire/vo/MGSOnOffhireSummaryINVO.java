...
public class MGSOnOffhireSummaryINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSOnOffhireSummaryINVO> models = new ArrayList<MGSOnOffhireSummaryINVO>();
	...
	public MGSOnOffhireSummaryINVO() {}
	 ...
	 * @param vndrSeq
	 */
	public MGSOnOffhireSummaryINVO(String ibflag, String pagerows, String evntDtStr, String evntDtEnd, String eqAsetStsCd, String strGubun, String location, String sccCd, String stsEvntYdCd, String agmtLstmCd, String kind, String vndrSeq) {
	 ...
	 */
	public MGSOnOffhireSummaryINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSEqOnOffhireSummaryINVO[]
	 */
	public MGSOnOffhireSummaryINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSOnOffhireSummaryINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSOnOffhireSummaryINVO();
				if (strGubun[i] != null)
	 ...
	 * @return CHSEqOnOffhireSummaryINVO[]
	 */
	public MGSOnOffhireSummaryINVO[] getCHSEqOnOffhireSummaryINVOs(){
		MGSOnOffhireSummaryINVO[] vos = (MGSOnOffhireSummaryINVO[])models.toArray(new MGSOnOffhireSummaryINVO[models.size()]);
		return vos;
	}
