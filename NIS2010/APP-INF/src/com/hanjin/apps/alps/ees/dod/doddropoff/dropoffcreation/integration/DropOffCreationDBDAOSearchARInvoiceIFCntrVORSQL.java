...
*@FileName : DropOffCreationDBDAOSearchARInvoiceIFCntrVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DropOffCreationDBDAOSearchARInvoiceIFCntrVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AR 전송을 위한 Invoice Container Data를 읽어온다.
	  * </pre>
	  */
	public DropOffCreationDBDAOSearchARInvoiceIFCntrVORSQL(){
		setQuery();
		...
		query.append("FileName : DropOffCreationDBDAOSearchARInvoiceIFCntrVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
