...
*@FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSSpecDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOmodifyCHSSpecDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOmodifyCHSSpecDataUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE CGM_EQ_LOT" ).append("\n"); 
		query.append("SET FINC_VNDR_SEQ = @[finc_vndr_seq]," ).append("\n"); 
		...
		query.append("AND EQ_LOT_NO BETWEEN @[eq_pfx_cd]||@[fm_ser_no] AND @[eq_pfx_cd]||@[to_ser_no]" ).append("\n"); 

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.nis2010.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.integration").append("\n"); 
		query.append("FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSSpecDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}