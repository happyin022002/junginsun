...
public class GeneralCodeSearchMgtDBDAOsearchCustomerInfoDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("MNR_COMMON_PKG.MNR_CONV_PARTNER_CD_FNC(A.CUST_SEQ, A.CUST_CNT_CD) CUST_CD," ).append("\n"); 
		query.append("A.CUST_CNT_CD," ).append("\n"); 
		query.append("MNR_COMMON_PKG.MNR_CONV_PARTNER_CD_FNC(A.CUST_SEQ) CUST_SEQ," ).append("\n"); 
		...
		query.append("DECODE(A.RVIS_CNTR_CUST_TP_CD,'B','BCO','Non-BCO') AS RVIS_CNTR_CUST_TP_CD," ).append("\n"); 
		query.append("A.CUST_GRP_ID" ).append("\n"); 
		query.append("FROM MDM_CUSTOMER A, MDM_CUST_ADDR B" ).append("\n"); 
