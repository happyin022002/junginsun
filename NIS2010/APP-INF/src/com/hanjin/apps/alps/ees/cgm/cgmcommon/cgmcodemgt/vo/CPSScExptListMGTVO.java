...
*@FileName : CPSScExptListMGTVO.java
*@FileTitle : CPSScExptListMGTVO
*Open Issues :
*Change history :
...
public class CPSScExptListMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CPSScExptListMGTVO> models = new ArrayList<CPSScExptListMGTVO>();
...
/**
	 ...
	 */
	public CPSScExptListMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CPSScExptListMGTVO[]
	 */
	public CPSScExptListMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CPSScExptListMGTVO model = null;
	...
	public CPSScExptListMGTVO[] getCPSScExptListMGTVOs(){
		CPSScExptListMGTVO[] vos = (CPSScExptListMGTVO[])models.toArray(new CPSScExptListMGTVO[models.size()]);
		return vos;
	}
