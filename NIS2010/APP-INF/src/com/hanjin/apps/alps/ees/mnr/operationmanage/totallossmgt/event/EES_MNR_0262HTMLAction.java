...
*@FileName : EES_MNR_0262HTMLAction.java
...
public class EES_MNR_0262HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0262HTMLAction 객체를 생성
	 */
	public EES_MNR_0262HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0262Event event = new EesMnr0262Event();
...
//		}	
		//저장
			...
			totalLossGRPVO.setArrCustomApprovalStepHistoryVOs(((CustomApprovalStepHistoryVO[])getVOs(request, CustomApprovalStepHistoryVO.class, "" ))); 
