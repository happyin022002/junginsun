...
*@FileName : SCExceptionTariffMgtDBDAOSearchNextGroupSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchNextGroupSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SC Exception Tariff Group 정보를 입력하기 위해 다음 Sequence 를 조회하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchNextGroupSeqRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchNextGroupSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}