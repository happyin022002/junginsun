...
*@FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionCoverageUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOModifyBeforeExceptionCoverageUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Exception Terms Entry 에 대한  Multi Origin or Destination 수정용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOModifyBeforeExceptionCoverageUSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionCoverageUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_RFA_EXPT_CVRG_CMB SET" ).append("\n"); 
		query.append("CVRG_CONTI_CD = NVL(@[cvrg_conti_cd], ' ')" ).append("\n"); 
		query.append(",	CVRG_CNT_CD = NVL(@[cvrg_cnt_cd], ' ')" ).append("\n"); 
		query.append(",	CVRG_RGN_CD = NVL(@[cvrg_rgn_cd], ' ')" ).append("\n"); 
		query.append(",	CVRG_STE_CD = NVL(@[cvrg_ste_cd], ' ')" ).append("\n"); 
		query.append(",	CVRG_LOC_CD = NVL(@[cvrg_loc_cd], ' ')" ).append("\n"); 
		query.append(",	ORG_DEST_CONTI_CD = NVL(@[org_dest_conti_cd], ' ')" ).append("\n"); 
		query.append(",	ORG_DEST_CNT_CD = NVL(@[org_dest_cnt_cd], ' ')" ).append("\n"); 
		query.append(",	ORG_DEST_RGN_CD = NVL(@[org_dest_rgn_cd], ' ')" ).append("\n"); 
		query.append(",	ORG_DEST_STE_CD = NVL(@[org_dest_ste_cd], ' ')" ).append("\n"); 
		query.append(",	ORG_DEST_LOC_CD = NVL(@[org_dest_loc_cd], ' ')" ).append("\n"); 
