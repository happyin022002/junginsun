...
*@FileName : RepairMgtDBDAOaddEstimateDTLDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOaddEstimateDTLDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RepairMgtDBDAOaddEstimateDTLDataCSQL(){
		setQuery();
		...
		params.put("rpr_rqst_dtl_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RepairMgtDBDAOaddEstimateDTLDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[xch_mtrl_cost_amt]" ).append("\n"); 
		query.append(",@[mtrl_reco_amt]" ).append("\n"); 
		query.append(",DECODE(NVL(@[mnr_lr_acct_flg],'0'),'0','N','Y')" ).append("\n"); 
		query.append(",DECODE(NVL(@[n3pty_flg],'0'),'0','N','Y')" ).append("\n"); 
		query.append(",@[n3pty_bil_lbr_hrs]" ).append("\n"); 
		query.append(",@[n3pty_bil_lbr_rt]" ).append("\n"); 
		query.append(",NVL(@[n3pty_bil_lbr_hrs] * @[n3pty_bil_lbr_rt],0)" ).append("\n"); 
		query.append(",@[n3pty_bil_mtrl_cost_amt]" ).append("\n"); 
		query.append(",@[mnr_agmt_amt]" ).append("\n"); 
		query.append(",@[mnr_wrk_amt]" ).append("\n"); 
		query.append(",@[n3pty_bil_amt]" ).append("\n"); 
