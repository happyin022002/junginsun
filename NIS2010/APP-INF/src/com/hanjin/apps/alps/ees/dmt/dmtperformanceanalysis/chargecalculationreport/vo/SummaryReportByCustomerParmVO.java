...
public class SummaryReportByCustomerParmVO extends AbstractValueObject {
	...
	/* Column Info */
	private String fmAplyDt = null;
	/* Column Info */
	private String toAplyDt = null;
	/* Column Info */
	...
	public SummaryReportByCustomerParmVO(String ibflag, String pagerows, String currFlg, String startDt, String endDt, String dmdtTrfCd, String ofcFlg, String ofcCd, String schFlg, String scRfaNo, String scNo, String rfaNo, String ctrtOfc, String custCd, String cvrCd, String porCd, String polCd, String podCd, String delCd, String optDate, String costYrmon, String fmAplyDt, String toAplyDt, String custType, String custFlg) {
		...
		this.fmAplyDt = fmAplyDt;
		this.toAplyDt = toAplyDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("fm_aply_dt", getFmAplyDt());
		this.hashColumns.put("to_aply_dt", getToAplyDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("fm_aply_dt", "fmAplyDt");
		this.hashFields.put("to_aply_dt", "toAplyDt");
	 ...
	 * @return fmAplyDt
	 */
	public String getFmAplyDt() {
		return this.fmAplyDt;
	}
	 ...
	 * @return toAplyDt
	 */
	public String getToAplyDt() {
		return this.toAplyDt;
	}
	 ...
	 * @param fmAplyDt
	 */
	public void setFmAplyDt(String fmAplyDt) {
		this.fmAplyDt = fmAplyDt;
	}
	/**
	 * Column Info
	 * @param toAplyDt
	 */
	public void setToAplyDt(String toAplyDt) {
		this.toAplyDt = toAplyDt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setOptDate(JSPUtil.getParameter(request, "opt_date", ""));
		setCostYrmon(JSPUtil.getParameter(request, "cost_yrmon", ""));
		setFmAplyDt(JSPUtil.getParameter(request, "fm_aply_dt", ""));
		setToAplyDt(JSPUtil.getParameter(request, "to_aply_dt", ""));
		setCustType(JSPUtil.getParameter(request, "cust_type", ""));
		setCustFlg(JSPUtil.getParameter(request, "cust_flg", ""));
	}
	...
	public SummaryReportByCustomerParmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] fmAplyDt = (JSPUtil.getParameter(request, prefix	+ "fm_aply_dt", length));
			String[] toAplyDt = (JSPUtil.getParameter(request, prefix	+ "to_aply_dt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (fmAplyDt[i] != null)
					model.setFmAplyDt(fmAplyDt[i]);
				if (toAplyDt[i] != null)
					model.setToAplyDt(toAplyDt[i]);
				if (custType[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.fmAplyDt = fmAplyDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.toAplyDt = this.toAplyDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
