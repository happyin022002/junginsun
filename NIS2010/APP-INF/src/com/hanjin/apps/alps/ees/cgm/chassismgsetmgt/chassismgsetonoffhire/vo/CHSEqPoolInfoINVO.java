...
*@FileName : CHSEqPoolInfoINVO.java
*@FileTitle : CHSEqPoolInfoINVO
*Open Issues :
*Change history :
...
public class CHSEqPoolInfoINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSEqPoolInfoINVO> models = new ArrayList<CHSEqPoolInfoINVO>();
	 ...
	 */
	public CHSEqPoolInfoINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSEqPoolInfoINVO[]
	 */
	public CHSEqPoolInfoINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSEqPoolInfoINVO model = null;
	...
	public CHSEqPoolInfoINVO[] getCHSEqPoolInfoINVOs(){
		CHSEqPoolInfoINVO[] vos = (CHSEqPoolInfoINVO[])models.toArray(new CHSEqPoolInfoINVO[models.size()]);
		return vos;
	}
