...
*@FileName : OnewaySimulateDBDAOSearchRepoPlanIdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnewaySimulateDBDAOSearchRepoPlanIdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * repo_pln_id의 존재 여부 확인
	  * </pre>
	  */
	public OnewaySimulateDBDAOSearchRepoPlanIdRSQL(){
		setQuery();
		...
		query.append("FileName : OnewaySimulateDBDAOSearchRepoPlanIdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
