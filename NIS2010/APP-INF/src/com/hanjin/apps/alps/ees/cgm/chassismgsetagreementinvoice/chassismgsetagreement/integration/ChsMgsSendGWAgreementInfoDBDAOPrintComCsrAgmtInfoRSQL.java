...
*@FileName : ChsMgsSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChsMgsSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChsMgsSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ChsMgsSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND A.GW_UQ_DOC_NO is not null" ).append("\n"); 
