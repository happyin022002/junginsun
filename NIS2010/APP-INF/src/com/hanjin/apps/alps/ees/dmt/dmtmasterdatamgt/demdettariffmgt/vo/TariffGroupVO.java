...
public class TariffGroupVO extends AbstractValueObject {
	...
	/* Column Info */
	private String xtnFlg = null;
	/* Column Info */
	private String xtnEffDt = null;
	/* Column Info */
	private String xtnExpDt = null;
	/* Column Info */
	private String bzcTrfXtnFlg = null;
	...
	public TariffGroupVO(String ibflag, String pagerows, String svrId, String dmdtTrfCd, String trfSeq, String dmdtDeTermCd, String trfGrpSeq, String dmdtBzcTrfGrpNm, String effDt, String dmdtTrfGrpTpCd, String expDt, String xcldSatFlg, String xcldSunFlg, String xcldHolFlg, String dmdtChgCmncTpCd, String cmncHr, String currCd, String cfmFlg, String creUsrId, String creDt, String creOfcCd, String updUsrId, String updDt, String updOfcCd, String usrId, String ofcCd, String dmdtDeTermNm, String xtnFlg, String xtnEffDt, String xtnExpDt, String bzcTrfXtnFlg ) {
		...
		this.xtnFlg = xtnFlg;
		this.xtnEffDt = xtnEffDt;
		this.xtnExpDt = xtnExpDt;
		this.bzcTrfXtnFlg = bzcTrfXtnFlg;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("xtn_flg", getXtnFlg());
		this.hashColumns.put("xtn_eff_dt", getXtnEffDt());
		this.hashColumns.put("xtn_exp_dt", getXtnExpDt());
		this.hashColumns.put("bzc_trf_xtn_flg", getBzcTrfXtnFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("xtn_flg", "xtnFlg");
		this.hashFields.put("xtn_eff_dt", "xtnEffDt");
		this.hashFields.put("xtn_exp_dt", "xtnExpDt");
		this.hashFields.put("bzc_trf_xtn_flg", "bzcTrfXtnFlg");
	...
	public String getXtnFlg() {
		return xtnFlg;
	}

	public void setXtnFlg(String xtnFlg) {
		this.xtnFlg = xtnFlg;
	}

	public String getXtnEffDt() {
		return xtnEffDt;
	}

	public void setXtnEffDt(String xtnEffDt) {
		this.xtnEffDt = xtnEffDt;
	}

	public String getXtnExpDt() {
		return xtnExpDt;
	}

	public void setXtnExpDt(String xtnExpDt) {
		this.xtnExpDt = xtnExpDt;
	}

	public String getBzcTrfXtnFlg() {
		return bzcTrfXtnFlg;
	}

	public void setBzcTrfXtnFlg(String bzcTrfXtnFlg) {
		this.bzcTrfXtnFlg = bzcTrfXtnFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setXtnFlg(JSPUtil.getParameter(request, "xtn_flg", ""));
		setXtnEffDt(JSPUtil.getParameter(request, "xtn_eff_dt", ""));
		setXtnExpDt(JSPUtil.getParameter(request, "xtn_exp_dt", ""));
		setBzcTrfXtnFlg(JSPUtil.getParameter(request, "bzc_trf_xtn_flg", ""));
	}
	...
	public TariffGroupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] xtnFlg = (JSPUtil.getParameter(request, prefix	+ "xtn_flg", length));
			String[] xtnEffDt = (JSPUtil.getParameter(request, prefix	+ "xtn_eff_dt", length));
			String[] xtnExpDt = (JSPUtil.getParameter(request, prefix	+ "xtn_exp_dt", length));
			String[] bzcTrfXtnFlg = (JSPUtil.getParameter(request, prefix	+ "bzc_trf_xtn_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (xtnFlg[i] != null)
					model.setXtnFlg(xtnFlg[i]);	
				if (xtnEffDt[i] != null)
					model.setXtnEffDt(xtnEffDt[i]);	
				if (xtnExpDt[i] != null)
					model.setXtnExpDt(xtnExpDt[i]);	
				if (bzcTrfXtnFlg[i] != null)
					model.setBzcTrfXtnFlg(bzcTrfXtnFlg[i]);	
	...
	*/
	public void unDataFormat(){
		...
		this.xtnFlg = this.xtnFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.xtnEffDt = this.xtnEffDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.xtnExpDt = this.xtnExpDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.bzcTrfXtnFlg = this.bzcTrfXtnFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
