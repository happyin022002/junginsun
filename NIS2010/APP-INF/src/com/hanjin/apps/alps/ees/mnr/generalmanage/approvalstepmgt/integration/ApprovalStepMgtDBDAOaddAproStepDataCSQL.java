...
*@FileName : ApprovalStepMgtDBDAOaddAproStepDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalStepMgtDBDAOaddAproStepDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalStepMgtDBDAOaddAproStepDataCSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalStepMgtDBDAOaddAproStepDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MNR_APRO_STEP" ).append("\n"); 
		query.append("(" ).append("\n"); 
