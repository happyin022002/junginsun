...
*@FileName : CEDEXCodeMgtDBDAOremoveDivisionCodeDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CEDEXCodeMgtDBDAOremoveDivisionCodeDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeDivisionCodeData
	  * </pre>
	  */
	public CEDEXCodeMgtDBDAOremoveDivisionCodeDataDSQL(){
		setQuery();
		...
		query.append("FileName : CEDEXCodeMgtDBDAOremoveDivisionCodeDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
