...
*@FileName : UncollectedCargoDBDAOCreateManageUncollectedCargoFileCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOCreateManageUncollectedCargoFileCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UncollectedCargoDBDAOCreateManageUncollectedCargoFileCSQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAOCreateManageUncollectedCargoFileCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	)" ).append("\n"); 
		query.append("VALUES (@[uc_cs_no]" ).append("\n"); 
		query.append("	,@[uc_cgo_file_id]" ).append("\n"); 
		query.append("	,@[file_no_seq]" ).append("\n"); 
		query.append("	,' '" ).append("\n"); 
		query.append("	,@[file_desc]" ).append("\n"); 
