...
*@FileName : EES_CIM_1036HTMLAction.java
...
public class EES_CIM_1036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1036HTMLAction 객체를 생성
	 */
	public EES_CIM_1036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim1036Event event = new EesCim1036Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setREPOResultSearchOptionByLocation((REPOResultSearchOptionByLocationVO)getVO(request, REPOResultSearchOptionByLocationVO .class));
		}
