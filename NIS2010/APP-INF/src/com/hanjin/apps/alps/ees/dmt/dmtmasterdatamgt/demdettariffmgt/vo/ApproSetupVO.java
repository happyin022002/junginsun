...
*@FileName : ApproSetupVO.java
*@FileTitle : ApproSetupVO
*Open Issues :
*Change history :
...
public class ApproSetupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ApproSetupVO> models = new ArrayList<ApproSetupVO>();
	...
	public ApproSetupVO(String ibflag, String pagerows, String dmdtExptAproTpCd, String ofcLvl, String dmdtOfcCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return ApproSetupVO[]
	 */
	public ApproSetupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ApproSetupVO[]
	 */
	public ApproSetupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ApproSetupVO model = null;
	 ...
	 * @return ApproSetupVO[]
	 */
	public ApproSetupVO[] getApproSetupVOs(){
		ApproSetupVO[] vos = (ApproSetupVO[])models.toArray(new ApproSetupVO[models.size()]);
		return vos;
	}
