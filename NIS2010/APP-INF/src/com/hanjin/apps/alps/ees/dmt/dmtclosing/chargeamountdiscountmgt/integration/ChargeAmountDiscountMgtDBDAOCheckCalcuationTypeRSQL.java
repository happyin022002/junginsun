...
*@FileName : ChargeAmountDiscountMgtDBDAOCheckCalcuationTypeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeAmountDiscountMgtDBDAOCheckCalcuationTypeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Charge Container 에 등록된 데이터에서 Calculation Type 을 체크하는 쿼리
	  * </pre>
	  */
	public ChargeAmountDiscountMgtDBDAOCheckCalcuationTypeRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeAmountDiscountMgtDBDAOCheckCalcuationTypeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	COUNT(CHG_CALC.SYS_AREA_GRP_ID)" ).append("\n"); 
		...
		query.append("AND CHG_CALC.DMDT_CHG_STS_CD <> 'T'" ).append("\n"); 
