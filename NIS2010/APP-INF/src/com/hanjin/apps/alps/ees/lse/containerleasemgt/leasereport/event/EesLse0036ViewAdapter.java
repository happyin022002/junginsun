...
*@FileName : EesLse0036ViewAdapter.java
*@FileTitle : EesLse0036ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0036 에 대한 ViewAdapter<br>
 * - EES_LSE_0036HTMLAction에서 작성<br>
 *
 * @author 남궁진호
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EesLse0036ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0036ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0036ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
    	...
    	try{
		    ...
		    if(totCnt > 0){
	    		while(rowSet.next()){
					...
					strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)rowSet.getString("supplier"	))+"]]></TD>");
		...
		log.debug("########### EesLse0036ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
