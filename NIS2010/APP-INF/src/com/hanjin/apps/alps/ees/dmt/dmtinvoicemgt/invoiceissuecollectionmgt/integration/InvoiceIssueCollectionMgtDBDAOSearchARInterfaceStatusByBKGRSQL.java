...
public class InvoiceIssueCollectionMgtDBDAOSearchARInterfaceStatusByBKGRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#if (${chg_cd} == '') ##ALL 을 선택 했을 경우" ).append("\n"); 
		query.append("AND C.CHG_CD IN ('DMR','DTC','CDD')" ).append("\n"); 
		query.append("#elseif (${chg_cd} == 'DEM')" ).append("\n"); 
		query.append("AND C.CHG_CD = 'DMR'" ).append("\n"); 
		query.append("#elseif (${chg_cd} == 'DET')" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${type} == '')  ##ALL 을 선택 했을 경우" ).append("\n"); 
		...
		query.append("AND M.REV_SRC_CD NOT IN ('DM','DT','CD')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("## AND M.AR_IF_NO = 'HAMM803243'" ).append("\n"); 
