...
*@FileName : SCExceptionTariffMgtDBDAOModifySCExceptionRatesUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOModifySCExceptionRatesUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Terms Entry 의 등록된 Group 의 하위정보인 Rate Adjustment 정보를 수정하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOModifySCExceptionRatesUSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOModifySCExceptionRatesUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_SC_EXPT_RT_ADJ SET " ).append("\n"); 
		query.append("	FT_FM_DYS = @[ft_fm_dys]" ).append("\n"); 
		query.append(",	FT_TO_DYS = @[ft_to_dys]" ).append("\n"); 
