...
*@FileName : OnewaySimulateDBDAOSearchOneWayMaxRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnewaySimulateDBDAOSearchOneWayMaxRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ONE_WY_OFFR에서 One Way Offer Max정보 검색 각 TPSZ별의 최대값
	  * </pre>
	  */
	public OnewaySimulateDBDAOSearchOneWayMaxRSQL(){
		setQuery();
		...
		query.append("FileName : OnewaySimulateDBDAOSearchOneWayMaxRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("## ----swql----" ).append("\n"); 
		query.append("#foreach( ${key} in ${cntrTpSzList})" ).append("\n"); 
		query.append("NVL( MAX(OFFER${key.field1}),0)    OFF${key.field1}" ).append("\n"); 
