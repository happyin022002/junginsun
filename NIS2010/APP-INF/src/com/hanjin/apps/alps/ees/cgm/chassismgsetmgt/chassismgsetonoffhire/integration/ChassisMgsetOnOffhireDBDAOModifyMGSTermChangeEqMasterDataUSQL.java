...
*@FileName : ChassisMgsetOnOffhireDBDAOModifyMGSTermChangeEqMasterDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOModifyMGSTermChangeEqMasterDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetOnOffhireDB.ModifyMGSTermChangeEqMasterData
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOModifyMGSTermChangeEqMasterDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOModifyMGSTermChangeEqMasterDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET AGMT_OFC_CTY_CD = @[agmt_ofc_cty_cd]," ).append("\n"); 
		...
		query.append("ONH_OFC_CD = @[onh_ofc_cd]," ).append("\n"); 
		query.append("ONH_DT = TO_DATE(@[onh_dt],'YYYYMMDD')," ).append("\n"); 
		query.append("EQ_STS_SEQ = @[eq_sts_seq]," ).append("\n"); 
