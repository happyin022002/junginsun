...
*@FileName : SCExceptionTariffMgtDBDAOSearchBBApprovalPathApprovalUserRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchBBApprovalPathApprovalUserRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCExceptionTariffMgtDBDAOSearchBBApprovalPathApprovalUserRSQL
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchBBApprovalPathApprovalUserRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchBBApprovalPathApprovalUserRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
