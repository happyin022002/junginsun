...
*@FileName : MTYEquipmentForecastDBDAOaddMtyRepoInDetailListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOaddMtyRepoInDetailListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOaddMtyRepoInDetailListCSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOaddMtyRepoInDetailListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_MTY_BAL_RPT_DCHG_MNL" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("            FROM EQR_MTY_BAL_RPT_DCHG_MNL" ).append("\n"); 
