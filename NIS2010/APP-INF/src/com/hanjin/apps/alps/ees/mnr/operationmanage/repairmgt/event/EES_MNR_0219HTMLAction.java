...
public class EES_MNR_0219HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0139HTMLAction 객체를 생성
	 */
	public EES_MNR_0219HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0219Event event = new EesMnr0219Event(); 
		  	 
		if(command.isCommand(FormCommand.MULTI)) {            
			event.setCustomMnrDatVrfyVOS((CustomMnrDatVrfyVO[])getVOs(request, CustomMnrDatVrfyVO .class,""));
			event.setEQFlagMgtINVO((VerifyEQTypeSizeFlagFileListINVO)getVO(request, VerifyEQTypeSizeFlagFileListINVO .class));
		}  
