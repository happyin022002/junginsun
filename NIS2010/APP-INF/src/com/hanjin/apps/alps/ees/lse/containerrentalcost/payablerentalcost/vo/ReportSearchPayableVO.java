...
public class ReportSearchPayableVO extends AbstractValueObject {
	...
	public ReportSearchPayableVO(String ibflag, String pagerows, String lesee, String reportType, String gto, String pdm, String periodStdt, String locCd
			                   , String cntrTpszCd, String jan, String lstmCd, String dpp, String lon, String status, String agmtSeq, String receivable
			                   , String pcr, String lof, String qty, String puc, String oct, String periodYear, String feb, String nov, String vndrSeq
			                   , String gti, String company, String abbrNm, String div, String gTtl, String dio, String dec, String chargeTypeCd
			                   , String ttl5, String ttl4, String agmtCtyCd, String ttl3, String ttl2, String mar, String ttl1, String dii, String locTp
			                   , String may, String apr, String q4, String q2, String d2, String o2, String s2, String r2, String a2, String t2, String f2
			                   , String p2, String d5, String d4, String o4, String s4, String a4, String f5, String t4, String f4, String r5, String p4
			                   , String r4, String d7, String r7, String d9, String d8, String dx, String dw, String d3, String jul, String jun, String dcr
			                   , String doc, String sep, String aug, String chargeType, String periodEddt, String costYrmon, String agmtNo, String tysz
			                   , String sttl1, String sttl2, String sttl3, String sttl4, String sttl5, String payable, String wdp, String crd, String oth
			                   , String xx) {
		this.sttl3 = sttl3;
		this.sttl4 = sttl4;
		this.lesee = lesee;
	...
	public void fromRequest(HttpServletRequest request) {
		setSttl3(JSPUtil.getParameter(request, "sttl_3", ""));
		setSttl4(JSPUtil.getParameter(request, "sttl_4", ""));
		setLesee(JSPUtil.getParameter(request, "lesee", ""));
		setSttl1(JSPUtil.getParameter(request, "sttl_1", ""));
		setSttl2(JSPUtil.getParameter(request, "sttl_2", ""));
		...
		setSttl5(JSPUtil.getParameter(request, "sttl_5", ""));
		...
		setPayable(JSPUtil.getParameter(request, "payable", ""));
		...
		setWdp(JSPUtil.getParameter(request, "wdp", ""));
		...
		setXx(JSPUtil.getParameter(request, "xx", ""));
	}
	...
	public ReportSearchPayableVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] sttl3 = (JSPUtil.getParameter(request, prefix	+ "sttl_3", length));
			String[] sttl4 = (JSPUtil.getParameter(request, prefix	+ "sttl_4", length));
			String[] lesee = (JSPUtil.getParameter(request, prefix	+ "lesee", length));
			String[] sttl1 = (JSPUtil.getParameter(request, prefix	+ "sttl_1", length));
			String[] sttl2 = (JSPUtil.getParameter(request, prefix	+ "sttl_2", length));
			...
			String[] sttl5 = (JSPUtil.getParameter(request, prefix	+ "sttl_5", length));
			...
			String[] payable = (JSPUtil.getParameter(request, prefix	+ "payable", length));
			...
			String[] ttl5 = (JSPUtil.getParameter(request, prefix	+ "ttl_5", length));
			...
			String[] wdp = (JSPUtil.getParameter(request, prefix	+ "wdp", length));
			...
			String[] xx = (JSPUtil.getParameter(request, prefix	+ "xx", length));
