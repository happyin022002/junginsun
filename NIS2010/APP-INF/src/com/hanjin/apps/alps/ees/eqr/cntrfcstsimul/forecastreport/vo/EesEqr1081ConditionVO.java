...
*@FileName : EesEqr1081ConditionVO.java
*@FileTitle : EesEqr1081ConditionVO
*Open Issues :
*Change history :
...
public class EesEqr1081ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1081ConditionVO> models = new ArrayList<EesEqr1081ConditionVO>();
	...
	public EesEqr1081ConditionVO() {}

	public EesEqr1081ConditionVO(String ibflag, String pagerows, String repoPlnId, String searchFlag, String repoFlag, String fcastYrwk, String locCd, String locGrpCd, String inpYrwk, String tpCd, String repoPlnYrwk, String wkStDt, String wkEndDt, String currFlag, String yard) {
...
/**
	 ...
	 */
	public EesEqr1081ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1081ConditionVO[]
	 */
	public EesEqr1081ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1081ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1081ConditionVO();
		...
		return getEesEqr1081ConditionVOs();
	}
	...
	public EesEqr1081ConditionVO[] getEesEqr1081ConditionVOs(){
		EesEqr1081ConditionVO[] vos = (EesEqr1081ConditionVO[])models.toArray(new EesEqr1081ConditionVO[models.size()]);
		return vos;
	}
