...
*@FileName : ApprovalStepMgtDBDAOremoveAproStepHisDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalStepMgtDBDAOremoveAproStepHisDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalStepMgtDBDAOremoveAproStepHisDataDSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalStepMgtDBDAOremoveAproStepHisDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE APRO_USR_ID IS NULL" ).append("\n"); 
