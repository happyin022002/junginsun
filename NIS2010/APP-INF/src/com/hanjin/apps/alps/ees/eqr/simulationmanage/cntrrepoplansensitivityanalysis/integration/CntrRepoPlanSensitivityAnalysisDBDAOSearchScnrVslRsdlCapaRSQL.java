...
*@FileName : CntrRepoPlanSensitivityAnalysisDBDAOSearchScnrVslRsdlCapaRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanSensitivityAnalysisDBDAOSearchScnrVslRsdlCapaRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_VSL_RSDL_CAPA 테이블에서 RESIDUAL SPACE 조회
	  * </pre>
	  */
	public CntrRepoPlanSensitivityAnalysisDBDAOSearchScnrVslRsdlCapaRSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanSensitivityAnalysisDBDAOSearchScnrVslRsdlCapaRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  TTL_RSDL_SPC                                                   \\n\");" ).append("\n"); 
