...
public class ForecastAccuracyListVO extends AbstractValueObject {
	...
	public ForecastAccuracyListVO(String ibflag, String pagerows, String dpSeq, String f2Qty, String totQty, String s2Qty, String f5Qty, String locCd, String yrwk, String d2Qty, String o4Qty, String a4Qty, String a5Qty, String eval, String a2Qty, String factor, String d7Qty, String s4Qty, String r2Qty, String o2Qty, String viewFlag, String d4Qty, String r5Qty, String r9Qty, String d5Qty, String bound, String f4Qty, String o5Qty, String dxQty) {
		this.dpSeq = dpSeq;
		this.f2Qty = f2Qty;
		this.totQty = totQty;
		this.f5Qty = f5Qty;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dx_qty", getDxQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dx_qty", "dxQty");
	 ...
	 * @param dxQty
	 */
	public void setDxQty(String dxQty) {
		this.dxQty = dxQty;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDxQty(JSPUtil.getParameter(request, prefix + "dx_qty", ""));
	...
	public ForecastAccuracyListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dxQty = (JSPUtil.getParameter(request, prefix	+ "dx_qty", length));
	...
	*/
	public void unDataFormat(){
		...
		this.dxQty = this.dxQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
