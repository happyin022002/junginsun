...
*@FileName : RepoConstraintDBDAOUpdateEmptyRepoConstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepoConstraintDBDAOUpdateEmptyRepoConstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * eqr_scnr_repo_cnst 테이블 데이터 수정( 테이블을 삭제후 새로 입력한다. )
	  * </pre>
	  */
	public RepoConstraintDBDAOUpdateEmptyRepoConstUSQL(){
		setQuery();
		...
		query.append("FileName : RepoConstraintDBDAOUpdateEmptyRepoConstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
