...
*@FileName : EES_MNR_0246HTMLAction.java
...
public class EES_MNR_0246HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * EES_MNR_0246HTMLAction 객체를 생성
	 */
	public EES_MNR_0246HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0246Event event = new EesMnr0246Event();

		switch(command.getCommand()) {
			case FormCommand.SEARCH :	//조회
				event.setDisposalPFMCByBuyerVO((DisposalPFMCByBuyerVO)getVO(request, DisposalPFMCByBuyerVO .class));
			default :	//do nothing
		}
