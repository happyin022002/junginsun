...
*@FileName : DisposalMgtDBDAOsearchDisposalCancelledInquiryListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DisposalMgtDBDAOsearchDisposalCancelledInquiryListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DisposalMgtDBDAOsearchDisposalCancelledInquiryListDataRSQL
	  * </pre>
	  */
	public DisposalMgtDBDAOsearchDisposalCancelledInquiryListDataRSQL(){
		setQuery();
		...
		query.append("FileName : DisposalMgtDBDAOsearchDisposalCancelledInquiryListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,NVL((SELECT DECODE(OTS_STL_FLG,'Y','Settled','N','Not Settled')" ).append("\n"); 
		query.append("			  FROM BKG_OUTSTANDING BO" ).append("\n"); 
		query.append("			  WHERE BO.CLT_BL_NO = A.INV_NO" ).append("\n"); 
		...
		query.append("		,NVL(IAA.INV_AMT, A.TTL_AMT) AS TTL_AMT" ).append("\n"); 
		query.append("        ,MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(A.ISS_DT, 'YYYYMM'), A.CURR_CD, 'USD', NVL(IAA.INV_AMT, A.TTL_AMT)) AS USD_TTL_AMT" ).append("\n"); 
		query.append("	    , TO_CHAR(A.CXL_DT, 'YYYY-MM-DD') CXL_DT" ).append("\n"); 
		query.append("	    , A.CXL_INV_SEQ AS CXL_INV_SEQ" ).append("\n"); 
		query.append("	    , A.CXL_USR_ID" ).append("\n"); 
		...
		query.append("        ,TO_CHAR(A.INV_DUE_DT, 'yyyy-mm-dd') INV_DUE_DT" ).append("\n"); 
		query.append("FROM MNR_CXL_RCV_INV_WRK A, MNR_PARTNER B, MDM_CURRENCY E, INV_AR_IF_MN IAI, INV_AR_AMT IAA" ).append("\n"); 
		...
		query.append("	AND A.INV_NO     = IAI.BL_SRC_NO(+)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("	AND NVL(IAA.INV_AMT, A.TTL_AMT) < 0" ).append("\n"); 
		query.append("ORDER BY INV_NO" ).append("\n"); 
		query.append("	, A.CXL_INV_SEQ" ).append("\n"); 
