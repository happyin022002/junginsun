...
public class DeleteInquiryByOfficeDetailVO extends AbstractValueObject {
	...
	/* Column Info */
	private String deltSpecRsnDesc = null;
	...
	public DeleteInquiryByOfficeDetailVO(String ibflag, String pagerows, String svrId, String dmdtChgStsCd, String ofcCd, String ofcRhqCd, String deltRsnDesc, String dmdtTrfCd, String cntrNo, String cntrTpszCd, String fmMvmtYdCd, String toMvmtYdCd, String fmMvmtStsCd, String toMvmtStsCd, String ftDys, String fxFtOvrDys, String fmMvmtDt, String toMvmtDt, String ftCmncDt, String ftEndDt, String bzcTrfCurrCd, String orgChgAmt, String scRfaExptAmt, String aftExptDcAmt, String bilAmt, String bkgNo, String blNo, String vvdCd, String lane, String porCd, String polCd, String podCd, String delCd, String bkgRcvTermCd, String bkgDeTermCd, String scNo, String rfaNo, String chgType, String chgSeq, String socFlg, String li, String ch, String dO, String ofcTrnsFlg, String rollOvr, String cntrCycNo, String dmdtChgLocDivCd, String corrRmk, String payerCd, String payerNm, String shipperCd, String shipperNm, String cneeCd, String cneeNm, String ntfyCd, String ntfyNm, String arActCd, String arActNm, String svcProvdrCd, String svcProvdrNm, String delDt, String delOfc, String delUsrNm,String status, String ofcCdDeltRsnCdList, String deltSpecRsnDesc) {
		...
		this.deltSpecRsnDesc = deltSpecRsnDesc;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("delt_spec_rsn_desc", getDeltSpecRsnDesc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("delt_spec_rsn_desc", "deltSpecRsnDesc");
	...
	public String getDeltSpecRsnDesc() {
		return deltSpecRsnDesc;
	}

	public void setDeltSpecRsnDesc(String deltSpecRsnDesc) {
		this.deltSpecRsnDesc = deltSpecRsnDesc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDeltSpecRsnDesc(JSPUtil.getParameter(request, prefix + "delt_spec_rsn_desc", ""));
	...
	public DeleteInquiryByOfficeDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] deltSpecRsnDesc = (JSPUtil.getParameter(request, prefix	+ "delt_spec_rsn_desc", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (deltSpecRsnDesc[i] != null)
					model.setDeltSpecRsnDesc(deltSpecRsnDesc[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.deltSpecRsnDesc = this.deltSpecRsnDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
