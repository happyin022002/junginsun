...
*@FileName : EQGeneralInfoINVO.java
*@FileTitle : EQGeneralInfoINVO
*Open Issues :
*Change history :
...
public class EQGeneralInfoINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EQGeneralInfoINVO> models = new ArrayList<EQGeneralInfoINVO>();
	...
	public EQGeneralInfoINVO() {}

	public EQGeneralInfoINVO(String ibflag, String pagerows, String prntColValue, String typeSizeSearchInd, String orderByColNm, String prntColNm, String tableNm, String cdColNm, String eqType, String eqNo, String descColNm, String kndCd, String totalLossDate, String comCodeSearchInd, String costType) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cost_type", getCostType());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cost_type", "costType");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCostType(JSPUtil.getParameter(request, "cost_type", ""));
	 ...
	 */
	public EQGeneralInfoINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EQGeneralInfoINVO[]
	 */
	public EQGeneralInfoINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EQGeneralInfoINVO model = null;
		...
		try {
			...
			String[] costType = (JSPUtil.getParameter(request, prefix	+ "cost_type", length));
	 ...
	 * @return EQGeneralInfoINVO[]
	 */
	public EQGeneralInfoINVO[] getEQGeneralInfoINVOs(){
		EQGeneralInfoINVO[] vos = (EQGeneralInfoINVO[])models.toArray(new EQGeneralInfoINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.costType = this.costType .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
