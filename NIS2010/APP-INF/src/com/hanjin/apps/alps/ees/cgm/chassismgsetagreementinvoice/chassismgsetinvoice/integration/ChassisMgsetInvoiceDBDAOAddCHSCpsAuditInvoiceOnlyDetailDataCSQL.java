...
*@FileName : ChassisMgsetInvoiceDBDAOAddCHSCpsAuditInvoiceOnlyDetailDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOAddCHSCpsAuditInvoiceOnlyDetailDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOAddCHSCpsAuditInvoiceOnlyDetailDataCSQL(){
		setQuery();
		...
		params.put("pay_tax_rt_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pay_bil_ut_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pay_lse_rt_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pay_lse_use_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("inv_lse_chg_amt_ttl",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pay_lse_chg_amt_ttl",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pay_lse_chg_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pay_tax_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOAddCHSCpsAuditInvoiceOnlyDetailDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INV_LSE_CHG_AMT_TTL," ).append("\n"); 
		query.append("PAY_TAX_RT_AMT," ).append("\n"); 
		query.append("PAY_LSE_CHG_AMT_TTL," ).append("\n"); 
