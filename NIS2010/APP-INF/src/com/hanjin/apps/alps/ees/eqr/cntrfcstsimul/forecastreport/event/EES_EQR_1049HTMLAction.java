...
*@FileName : EES_EQR_1049HTMLAction.java
*@FileTitle : EES_EQR_1049HTMLAction
*Open Issues :
*Change history :
...
public class EES_EQR_1049HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1049HTMLAction 객체를 생성
	 */
	public EES_EQR_1049HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1049Event event = new EesEqr1049Event();
		...
		event.setEesEqr1049ConditionVO((EesEqr1049ConditionVO)getVO(request, EesEqr1049ConditionVO .class));
