...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.ees.lse.containerleasemgt.immediateexit.vo;
...
public class SearchParamVO extends AbstractValueObject {
	...
	private Logger log = Logger.getLogger("com.hanjin.apps.alps.ees.lse.containerleasemgt.immediateexit.vo");
	...
	/**
	 * @param cntrNoList the cntrNoList to set
	 */
	 ...
	 * Constructor
	 */
	public SearchParamVO(String ibflag, String chkCntr, String cntrNo, String cntrNoList, String agmtCtyCd, String agmtSeq,
	...
	public SearchParamVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] cntrNoList = (JSPUtil.getParameter(request, prefix	+ "cntr_no_list".trim(), length));
