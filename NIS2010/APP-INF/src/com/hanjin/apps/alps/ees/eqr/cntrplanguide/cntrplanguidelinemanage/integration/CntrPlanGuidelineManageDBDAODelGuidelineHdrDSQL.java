...
*@FileName : CntrPlanGuidelineManageDBDAODelGuidelineHdrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineManageDBDAODelGuidelineHdrDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DELETE GUIDELINE HEADER
	  * </pre>
	  */
	public CntrPlanGuidelineManageDBDAODelGuidelineHdrDSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineManageDBDAODelGuidelineHdrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE EQR_CTRL_GLINE_HDR" ).append("\n"); 
