...
*@FileName : RFAExceptionTariffMgtDBDAOModifyNewDARNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOModifyNewDARNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 새로운 DAR No. 를 채번 테이블에 수정하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOModifyNewDARNoUSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOModifyNewDARNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_ADJ_RQST_NO SET" ).append("\n"); 
