...
*@FileName : MtyRailDetailVO.java
*@FileTitle : MtyRailDetailVO
*Open Issues :
*Change history :
...
public class MtyRailDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyRailDetailVO> models = new ArrayList<MtyRailDetailVO>();
	...
	public MtyRailDetailVO() {}

	public MtyRailDetailVO(String ibflag, String pagerows, String gubun, String eqNo, String mt, String mvmtStsCd) {
...
/**
	 ...
	 * @param request
	 * @return MtyRailDetailVO[]
	 */
	public MtyRailDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyRailDetailVO[]
	 */
	public MtyRailDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyRailDetailVO model = null;
	 ...
	 * @return MtyRailDetailVO[]
	 */
	public MtyRailDetailVO[] getMtyRailDetailVOs(){
		MtyRailDetailVO[] vos = (MtyRailDetailVO[])models.toArray(new MtyRailDetailVO[models.size()]);
		return vos;
	}
