...
public class AfterProgressVO extends AbstractValueObject {
	...
	/* Column Info */
	private String aftBkgPathCd = null;
	/* Column Info */
	private String ucCgoPsblFlg = null;
	/* Column Info */
	private String gnteLtrCd = null;
	...
	public AfterProgressVO(String ibflag, String pagerows, String aftExptDarNo, String dmdtExptRqstStsCd, String dmdtExptRqstStsDesc, String rqstUsrId, String rqstOfcCd, String rqstDt, String aftBkgAproNo, String aproUsrId, String aproDt, String aproOfcCd, String rhqOfcCd, String scNo, String rfaNo, String blNo, String custCd, String custNm, String msgDt, String progSeq, String progRmk, String progDt, String progUsrId, String progOfcCd, String jobKey, String creUsrId, String creDt, String creOfcCd, String updUsrId, String updDt, String updOfcCd, String backendJobFlag, String popupFlag, String dmdtExptRqstRsnCd, String aftBkgPathCd, String ucCgoPsblFlg, String gnteLtrCd) {
		...
		this.aftBkgPathCd = aftBkgPathCd;
		this.ucCgoPsblFlg = ucCgoPsblFlg;
		this.gnteLtrCd = gnteLtrCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("aft_bkg_path_cd", getAftBkgPathCd());
		this.hashColumns.put("uc_cgo_psbl_flg", getUcCgoPsblFlg());
		this.hashColumns.put("gnte_ltr_cd", getGnteLtrCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("aft_bkg_path_cd", "aftBkgPathCd");
		this.hashFields.put("uc_cgo_psbl_flg", "ucCgoPsblFlg");
		this.hashFields.put("gnte_ltr_cd", "gnteLtrCd");
	...
	public String getAftBkgPathCd() {
		return aftBkgPathCd;
	}

	public void setAftBkgPathCd(String aftBkgPathCd) {
		this.aftBkgPathCd = aftBkgPathCd;
	}

	public String getUcCgoPsblFlg() {
		return ucCgoPsblFlg;
	}

	public void setUcCgoPsblFlg(String ucCgoPsblFlg) {
		this.ucCgoPsblFlg = ucCgoPsblFlg;
	}

	public String getGnteLtrCd() {
		return gnteLtrCd;
	}

	public void setGnteLtrCd(String gnteLtrCd) {
		this.gnteLtrCd = gnteLtrCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDmdtExptRqstRsnCd(JSPUtil.getParameter(request, prefix + "dmdt_expt_rqst_rsn_cd", ""));
		setAftBkgPathCd(JSPUtil.getParameter(request, prefix + "aft_bkg_path_cd", ""));
		setUcCgoPsblFlg(JSPUtil.getParameter(request, prefix + "uc_cgo_psbl_flg", ""));
		setGnteLtrCd(JSPUtil.getParameter(request, prefix + "gnte_ltr_cd", ""));
	}
	...
	public AfterProgressVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] aftBkgPathCd = (JSPUtil.getParameter(request, prefix	+ "aft_bkg_path_cd", length));
			String[] ucCgoPsblFlg = (JSPUtil.getParameter(request, prefix	+ "uc_cgo_psbl_flg", length));
			String[] gnteLtrCd = (JSPUtil.getParameter(request, prefix	+ "gnte_ltr_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (aftBkgPathCd[i] != null)
					model.setAftBkgPathCd(aftBkgPathCd[i]);
				if (ucCgoPsblFlg[i] != null)
					model.setUcCgoPsblFlg(ucCgoPsblFlg[i]);
				if (gnteLtrCd[i] != null)
					model.setGnteLtrCd(gnteLtrCd[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.aftBkgPathCd = this.aftBkgPathCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ucCgoPsblFlg = this.ucCgoPsblFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.gnteLtrCd = this.gnteLtrCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
