	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		try{
			while ( rs.next() ){
				...
				if(rs.getString("sub_trd_cd").equals("ZTTL")) { // G.TTL 에 대한 치환
				...
				if(rs.getString("week").equals("999999")) { // AVG 에 대한 치환
					sbufXML.append("	<TD "+bgColor+" >TTL</TD>"); // 의도적인 공백
				}else {
				...
				if(sort_flag.equals("8") || sort_flag.equals("4") || sort_flag.equals("2") ){ // TTL 은 VOID, BSA, LF 를 빈칸으로 처리
