...
public class RepairMgtDBDAOsearchIFEstimateHRDDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT   A.RQST_EQ_NO" ).append("\n"); 
		...
		query.append("       , TO_CHAR(GLOBALDATE_PKG.TIME_CONV_OFC_FNC(MNR_COMMON_PKG.MNR_GET_HOOFC_FNC(),A.RQST_DT,@[cur_ofc_cd]),'YYYY-MM-DD') AS RQST_DT" ).append("\n"); 
		...
		query.append("       , NVL(A.RCT_RPR_FLG,'N') AS RCT_RPR_FLG" ).append("\n"); 
		query.append("       , A.VRFY_RSLT_RMK" ).append("\n"); 
