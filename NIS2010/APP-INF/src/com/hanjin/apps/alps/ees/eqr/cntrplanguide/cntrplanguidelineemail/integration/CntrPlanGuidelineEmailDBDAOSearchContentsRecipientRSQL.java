...
*@FileName : CntrPlanGuidelineEmailDBDAOSearchContentsRecipientRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrPlanGuidelineEmailDBDAOSearchContentsRecipientRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GUIDELINE EMAIL 의 수신자 메일주소 조회
	  * - CHM-201537079, 2015-08-10, 신용찬, 표준코드 변환
	  * </pre>
	  */
	public CntrPlanGuidelineEmailDBDAOSearchContentsRecipientRSQL(){
		setQuery();
		...
		query.append("FileName : CntrPlanGuidelineEmailDBDAOSearchContentsRecipientRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT A.GLINE_RCPT_EML " ).append("\n"); 
		...
		query.append("AND C.AR_HD_QTR_OFC_CD NOT IN ('NYCRA','HAMRU','SHARC','SINRS')" ).append("\n"); 
