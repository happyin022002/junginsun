...
*@FileName : RateMgtDBDAOsearchAgmtAtchDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RateMgtDBDAOsearchAgmtAtchDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RateMgtDBDAOsearchAgmtAtchDataRSQL
	  * </pre>
	  */
	public RateMgtDBDAOsearchAgmtAtchDataRSQL(){
		setQuery();
		...
		query.append("FileName : RateMgtDBDAOsearchAgmtAtchDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT ATCH_FILE_SEQ" ).append("\n"); 
		query.append("     , GW_UQ_DOC_NO" ).append("\n"); 
		query.append("     , GW_UQ_DOC_TIT_NM" ).append("\n"); 
		query.append("FROM MNR_AGMT_ATCH" ).append("\n"); 
