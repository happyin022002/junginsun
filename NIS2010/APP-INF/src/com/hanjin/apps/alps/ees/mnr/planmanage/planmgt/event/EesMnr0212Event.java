...
public class EesMnr0212Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	private OfficeInfoGRPVO officeInfoGRPVO = null;
	...
	public OfficeInfoGRPVO getOfficeInfoGRPVO() {
		return officeInfoGRPVO;
	}


	public void setOfficeInfoGRPVO(OfficeInfoGRPVO officeInfoGRPVO) {
		this.officeInfoGRPVO = officeInfoGRPVO;
	}
