...
public class PayerInfoParamVO extends AbstractValueObject {
	...
	public PayerInfoParamVO(String ibflag, String pagerows, String sCustCd, String sOfcCd, String sBkgNo, String sPodCd, String sPodCntCd, String sCustGubun, String svrId) {
		this.sPodCd = sPodCd;
		this.ibflag = ibflag;
