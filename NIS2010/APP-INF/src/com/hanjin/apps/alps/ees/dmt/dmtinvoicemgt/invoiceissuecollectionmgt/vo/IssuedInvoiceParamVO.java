...
public class IssuedInvoiceParamVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String sTaaNo = null;

    /* Column Info */
    private String sDmdtCollCd = null;

    /* Column Info */
    private String idaTaxApplTm = null;

    /* Column Info */
    private String srchTpCd = null;
    ...
    public IssuedInvoiceParamVO(String ibflag, String pagerows, String sOfcCd, String sIssueOfc, String sDmdtTrfCd, String sGroupBy, String sChgType, String dateCntr, String fmCfmDt, String toCfmDt, String sBkgNo, String sBlNo, String sCntrNo, String sCustCd, String sScNo, String sRfaNo, String sInvoiceNo, String dmdtChgStsCds, String sDmdtArIfCd, String sDmdtInvStsCd, String sOfcCheck, String sIssueFm, String sIssueTo, String sInvOverFm, String sInvOverTo, String sIssueUsrId, String sInvCheck, String sPayerCd, String sCustGubun, String caller, String ofcCd, String pgmId, String sessionRhqOfcCd, String invFlg, String usrCntCd, String dmdtVtInvStsCd, String dmdtVtInvNo, String dmdtVtInvYn, String usrOfcCd, String btnId, String sFmDt, String sToDt, String sTaaNo, String sDmdtCollCd, String idaTaxApplTm, String srchTpCd) {
        ...
        this.sFmDt = sFmDt;
        this.sToDt = sToDt;
        this.sDmdtCollCd = sDmdtCollCd;
        this.idaTaxApplTm = idaTaxApplTm;
        this.srchTpCd = srchTpCd;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("s_taa_no", getSTaaNo());
        ...
        this.hashColumns.put("s_dmdt_coll_cd", getsDmdtCollCd());
        this.hashColumns.put("ida_tax_appl_tm", getIdaTaxApplTm());
        this.hashColumns.put("srch_tp_cd", getSrchTpCd());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("s_taa_no", "sTaaNo");
        ...
        this.hashFields.put("s_dmdt_coll_cd", "sDmdtCollCd");
        this.hashFields.put("ida_tax_appl_tm", "idaTaxApplTm");
        this.hashFields.put("srch_tp_cd", "srchTpCd");
    ...
    public String getSTaaNo() {
        return sTaaNo;
    }

    public void setSTaaNo(String sTaaNo) {
        this.sTaaNo = sTaaNo;
    }
    ...
    public String getsDmdtCollCd() {
        return sDmdtCollCd;
    }

    public void setsDmdtCollCd(String sDmdtCollCd) {
        this.sDmdtCollCd = sDmdtCollCd;
    }
    ...
    public void setSrchTpCd(String srchTpCd) {
        this.srchTpCd = srchTpCd;
    }

    public String getSrchTpCd() {
        return this.srchTpCd;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setSTaaNo(JSPUtil.getParameter(request, prefix + "s_taa_no", ""));
        ...
        setsDmdtCollCd(JSPUtil.getParameter(request, prefix + "s_dmdt_coll_cd", ""));
        setIdaTaxApplTm(JSPUtil.getParameter(request, prefix + "ida_tax_appl_tm", ""));
        setSrchTpCd(JSPUtil.getParameter(request, prefix + "srch_tp_cd", ""));
    }
    ...
    public IssuedInvoiceParamVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] sTaaNo = (JSPUtil.getParameter(request, prefix + "s_taa_no", length));
            ...
            String[] sDmdtCollCd = (JSPUtil.getParameter(request, prefix + "s_dmdt_coll_cd", length));
            String[] idaTaxApplTm = (JSPUtil.getParameter(request, prefix + "ida_tax_appl_tm", length));
            String[] srchTpCd = (JSPUtil.getParameter(request, prefix + "srch_tp_cd", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (sDmdtCollCd[i] != null)
                    model.setsDmdtCollCd(sDmdtCollCd[i]);
                if (idaTaxApplTm[i] != null)
                    model.setIdaTaxApplTm(idaTaxApplTm[i]);
                if (srchTpCd[i] != null) 
		    		model.setSrchTpCd(srchTpCd[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.sTaaNo = this.sTaaNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.sDmdtCollCd = this.sDmdtCollCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.idaTaxApplTm = this.idaTaxApplTm.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.srchTpCd = this.srchTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
