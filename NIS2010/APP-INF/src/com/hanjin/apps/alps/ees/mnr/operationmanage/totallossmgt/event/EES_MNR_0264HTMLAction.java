...
*@FileName : EES_MNR_0264HTMLAction.java
...
public class EES_MNR_0264HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0262HTMLAction 객체를 생성
	 */
	public EES_MNR_0264HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0264Event event = new EesMnr0264Event();
