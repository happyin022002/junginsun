...
*@FileName : EmptyCODAdjustmentDBDAOEmptyCODVVDVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyCODAdjustmentDBDAOEmptyCODVVDVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyCODAdjustmentDBDAOEmptyCODVVDVOCSQL(){
		setQuery();
		...
		params.put("mnlinpflg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : EmptyCODAdjustmentDBDAOEmptyCODVVDVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	''" ).append("\n"); 
		query.append(",	NVL(@[mnlinpflg],'N')" ).append("\n"); 
