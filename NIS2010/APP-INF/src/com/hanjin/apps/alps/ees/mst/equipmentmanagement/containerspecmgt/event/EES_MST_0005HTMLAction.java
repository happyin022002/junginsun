...
*@FileName : EES_MST_0005HTMLAction.java
...
public class EES_MST_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0005HTMLAction 객체를 생성
	 */
	public EES_MST_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0005Event event = new EesMst0005Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMstIsoCntrTpSzVOS((MstIsoCntrTpSzVO[])getVOs(request, MstIsoCntrTpSzVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setMstIsoCntrTpSzVO((MstIsoCntrTpSzVO)getVO(request, MstIsoCntrTpSzVO .class));
		}
