...
*@FileName : ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByCntrStsDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByCntrStsDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByCntrStsDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInventoryDBDAOsearchCHSHistoricalReportByCntrStsDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE" ).append("\n"); 
		query.append("A.CNTR_PSN_STS_CD IN ($cntr_psn_sts_cd)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
