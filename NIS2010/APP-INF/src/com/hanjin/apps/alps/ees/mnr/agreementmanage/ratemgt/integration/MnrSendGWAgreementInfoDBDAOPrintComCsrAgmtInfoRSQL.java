...
*@FileName : MnrSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MnrSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MnrSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL(){
		setQuery();
		...
		query.append("FileName : MnrSendGWAgreementInfoDBDAOPrintComCsrAgmtInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND T.GW_UQ_DOC_NO is not null" ).append("\n"); 
