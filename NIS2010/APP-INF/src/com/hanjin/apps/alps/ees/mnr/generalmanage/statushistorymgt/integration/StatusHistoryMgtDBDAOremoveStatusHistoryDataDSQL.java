...
*@FileName : StatusHistoryMgtDBDAOremoveStatusHistoryDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusHistoryMgtDBDAOremoveStatusHistoryDataDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StatusHistoryMgtDBDAOremoveStatusHistoryDataDSQL(){
		setQuery();
		...
		query.append("FileName : StatusHistoryMgtDBDAOremoveStatusHistoryDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND MNR_STS_DTL_SEQ = @[mnr_sts_dtl_seq]" ).append("\n"); 
