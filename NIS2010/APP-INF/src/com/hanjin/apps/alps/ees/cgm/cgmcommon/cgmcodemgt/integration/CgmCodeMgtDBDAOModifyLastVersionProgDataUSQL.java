...
*@FileName : CgmCodeMgtDBDAOModifyLastVersionProgDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOModifyLastVersionProgDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CgmCodeMgtDBDAOModifyLastVersionProgDataUSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOModifyLastVersionProgDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE	CGM_SC_EXPT_VER_PROG SC_VER_PROG SET		" ).append("\n"); 
		...
		query.append("    ,   FT_FLG      = @[ft_flg]" ).append("\n"); 
