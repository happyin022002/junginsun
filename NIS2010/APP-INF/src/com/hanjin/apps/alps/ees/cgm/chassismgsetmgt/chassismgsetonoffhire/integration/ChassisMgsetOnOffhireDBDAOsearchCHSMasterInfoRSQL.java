...
public class ChassisMgsetOnOffhireDBDAOsearchCHSMasterInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       F.CHSS_TARE_WGT CHSS_TARE_WGT_KGS, -- CGM_EQ_SPEC(UNIT: KG)" ).append("\n"); 
		...
		query.append("       A.AGMT_OFC_CTY_CD||A.AGMT_SEQ AS AGREEMENT_NO," ).append("\n"); 
		...
		query.append("        CGM_EQ_SPEC F" ).append("\n"); 
		...
		query.append("   AND A.EQ_SPEC_NO = F.EQ_SPEC_NO(+)" ).append("\n"); 
		query.append("   AND A.EQ_TPSZ_CD = F.EQ_TPSZ_CD(+)" ).append("\n"); 
		query.append("" ).append("\n"); 
