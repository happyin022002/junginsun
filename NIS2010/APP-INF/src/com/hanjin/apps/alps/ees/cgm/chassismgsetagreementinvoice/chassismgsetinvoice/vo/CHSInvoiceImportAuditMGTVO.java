...
*@FileName : CHSInvoiceImportAuditMGTVO.java
*@FileTitle : CHSInvoiceImportAuditMGTVO
*Open Issues :
*Change history :
...
public class CHSInvoiceImportAuditMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInvoiceImportAuditMGTVO> models = new ArrayList<CHSInvoiceImportAuditMGTVO>();
...
/**
	 ...
	 */
	public CHSInvoiceImportAuditMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInvoiceImportAuditMGTVO[]
	 */
	public CHSInvoiceImportAuditMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInvoiceImportAuditMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSInvoiceImportAuditMGTVO();
		...
		return getCHSInvoiceImportAuditMGTVOs();
	}
	 ...
	 * @return CHSInvoiceImportAuditMGTVO[]
	 */
	public CHSInvoiceImportAuditMGTVO[] getCHSInvoiceImportAuditMGTVOs(){
		CHSInvoiceImportAuditMGTVO[] vos = (CHSInvoiceImportAuditMGTVO[])models.toArray(new CHSInvoiceImportAuditMGTVO[models.size()]);
		return vos;
	}
