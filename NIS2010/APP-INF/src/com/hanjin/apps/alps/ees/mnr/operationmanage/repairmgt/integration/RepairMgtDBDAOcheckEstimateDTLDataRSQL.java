...
*@FileName : RepairMgtDBDAOcheckEstimateDTLDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepairMgtDBDAOcheckEstimateDTLDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RepairMgtDBDAOcheckEstimateDTLDataRSQL(){
		setQuery();
		...
		query.append("FileName : RepairMgtDBDAOcheckEstimateDTLDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
