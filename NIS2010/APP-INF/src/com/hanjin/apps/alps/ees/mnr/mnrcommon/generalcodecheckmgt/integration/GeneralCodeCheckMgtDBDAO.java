...
public class GeneralCodeCheckMgtDBDAO extends DBDAOSupport {
	 ...
	 * @exception DAOException
	 */ 
	public int modifyCalculateEstimateResultNs(EstimateINVO estimateINVO) throws DAOException,Exception {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {	 
			...
			result = sqlExe.executeUpdate((ISQLTemplate)new GeneralCodeCheckMgtDBDAOmodifyCalculateEstimateResultNsUSQL(), param, velParam);
			
			if(result == Statement.EXECUTE_FAILED)     
				throw new DAOException("Fail to Update modifyCalculateEstimateResultNs"); 
		} catch (SQLException se) { 
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage()); 
		}catch(Exception ex){ 
	 ...
	 * @exception DAOException
	 */ 
	public int modifyCalculateEstimateResultNt(EstimateINVO estimateINVO) throws DAOException,Exception {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {	 
			...
			result = sqlExe.executeUpdate((ISQLTemplate)new GeneralCodeCheckMgtDBDAOmodifyCalculateEstimateResultNtUSQL(), param, velParam);
			
			if(result == Statement.EXECUTE_FAILED)     
				throw new DAOException("Fail to Update modifyCalculateEstimateResultNt"); 
		} catch (SQLException se) { 
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage()); 
		}catch(Exception ex){ 
	 ...
	 * @exception DAOException
	 */
	public int modifyVerifyLocalTariffManHourByStandardTariff(VerifyTariffFileListINVO verifyTariffFileListINVO) throws DAOException,Exception {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try { 
			...
			result = sqlExe.executeUpdate((ISQLTemplate)new GeneralCodeCheckMgtDBDAOModifyVerifyLocalTariffManHourByStandardTariffUSQL(), param, velParam);
			
			if(result == Statement.EXECUTE_FAILED)     
				throw new DAOException("Fail to Update ModifyVerifyLocalTariffManHourByStandardTariff"); 
		} catch (SQLException se) { 
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage()); 
		}catch(Exception ex){ 
	...
	/**
	 * [EES_MNR_0252]EDI전송완료후 MNR_RPR_RQST_DTL의 MNR_VRFY_TP_CD컬럼정보를 수정 합니다. <br>
	 *
	 * @param List<CustomMnrDatVrfyVO> customMnrDatVrfyVOs
	 * @exception DAOException
	 */
	public void modifyVerifyEstimateVrfyTpCd(List<CustomMnrDatVrfyVO> customMnrDatVrfyVOs) throws DAOException,Exception {
		try {				 
			SQLExecuter sqlExe = new SQLExecuter("");  
			int updCnt[] = null;	  	
			
			if(customMnrDatVrfyVOs.size() > 0){        
				updCnt = sqlExe.executeBatch((ISQLTemplate)new GeneralCodeCheckMgtDBDAOmodifyVerifyEstimateVrfyTpCdUSQL(), customMnrDatVrfyVOs,null);
				
				for(int i = 0; i < updCnt.length; i++){  
					if(updCnt[i]== Statement.EXECUTE_FAILED)     
						throw new DAOException("Fail to modifyVerifyEstimateVrfyTpCd No"+ i + " SQL"); 
				}	          
			}
		} catch (SQLException se) { 
			log.error(se.getMessage(),se);
