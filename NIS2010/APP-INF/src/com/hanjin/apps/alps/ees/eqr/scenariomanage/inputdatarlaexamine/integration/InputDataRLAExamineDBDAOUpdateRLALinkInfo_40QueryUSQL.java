...
*@FileName : InputDataRLAExamineDBDAOUpdateRLALinkInfo_40QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLALinkInfo_40QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC_LNK 테이블에 대한 40feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLALinkInfo_40QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLALinkInfo_40QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TZ_40FT_COST_AMT   	= @[tz_40ft_cost_amt]" ).append("\n"); 
