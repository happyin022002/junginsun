...
*@FileName : ChassisMgsetInvoiceDBDAOSearchCHSChargeCreationListDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOSearchCHSChargeCreationListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.SearchCHSChargeCreationListData
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOSearchCHSChargeCreationListDataRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOSearchCHSChargeCreationListDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	B.COST_YRMON_SEQ" ).append("\n"); 
