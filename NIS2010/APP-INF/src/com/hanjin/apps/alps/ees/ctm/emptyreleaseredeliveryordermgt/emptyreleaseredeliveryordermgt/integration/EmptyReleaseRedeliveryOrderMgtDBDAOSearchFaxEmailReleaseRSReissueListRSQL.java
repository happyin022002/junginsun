...
*@FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSReissueListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSReissueListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSReissueListRSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSReissueListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Release - R,S - Reissued */" ).append("\n"); 
