...
*@FileName : InputDataRLAExamineDBDAOUpdateRLALinkInfo_45QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLALinkInfo_45QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC_LNK 테이블에 대한 45feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLALinkInfo_45QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLALinkInfo_45QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TZ_45FT_COST_AMT   	= @[tz_45ft_cost_amt]" ).append("\n"); 
