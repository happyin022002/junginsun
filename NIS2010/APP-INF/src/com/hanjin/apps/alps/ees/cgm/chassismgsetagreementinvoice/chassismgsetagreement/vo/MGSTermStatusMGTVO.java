...
*@FileName : MGSTermStatusMGTVO.java
*@FileTitle : MGSTermStatusMGTVO
*Open Issues :
*Change history :
...
public class MGSTermStatusMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSTermStatusMGTVO> models = new ArrayList<MGSTermStatusMGTVO>();
	 ...
	 */
	public MGSTermStatusMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSTermStatusMGTVO[]
	 */
	public MGSTermStatusMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSTermStatusMGTVO model = null;
	 ...
	 * @return MGSTermStatusMGTVO[]
	 */
	public MGSTermStatusMGTVO[] getMGSTermStatusMGTVOs(){
		MGSTermStatusMGTVO[] vos = (MGSTermStatusMGTVO[])models.toArray(new MGSTermStatusMGTVO[models.size()]);
		return vos;
	}
