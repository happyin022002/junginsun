...
*@FileName : EES_EQR_0050HTMLAction.java
...
public class EES_EQR_0050HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0050HTMLAction 객체를 생성
	 */
	public EES_EQR_0050HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0050Event event = new EesEqr0050Event();
		
		event.setRunIdNo(JSPUtil.getParameter(request, "run_id_no".trim(), ""));
		event.setPercentage(JSPUtil.getParameter(request, "percentage".trim(), ""));
		event.setCancel(JSPUtil.getParameter(request, "cancel".trim(), ""));
