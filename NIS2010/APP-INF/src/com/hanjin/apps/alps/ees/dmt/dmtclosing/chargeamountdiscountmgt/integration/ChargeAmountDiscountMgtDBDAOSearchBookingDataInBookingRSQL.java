...
*@FileName : ChargeAmountDiscountMgtDBDAOSearchBookingDataInBookingRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeAmountDiscountMgtDBDAOSearchBookingDataInBookingRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DAR No. 나 B/L No. 입력시 Booking 테이블에서 Booking 정보를 조회하는 쿼리
	  * </pre>
	  */
	public ChargeAmountDiscountMgtDBDAOSearchBookingDataInBookingRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeAmountDiscountMgtDBDAOSearchBookingDataInBookingRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
