...
*@FileName : ScenarioDefaultManageDBDAOMergeYearNewVanPlanCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScenarioDefaultManageDBDAOMergeYearNewVanPlanCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScenarioDefaultManageDBDAOMergeYearNewVanPlanCSQL(){
		setQuery();
		...
		query.append("FileName : ScenarioDefaultManageDBDAOMergeYearNewVanPlanCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
