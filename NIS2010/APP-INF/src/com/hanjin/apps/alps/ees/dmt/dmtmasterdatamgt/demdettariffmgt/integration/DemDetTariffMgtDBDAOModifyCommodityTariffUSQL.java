...
*@FileName : DemDetTariffMgtDBDAOModifyCommodityTariffUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOModifyCommodityTariffUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOModifyCommodityTariffUSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOModifyCommodityTariffUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_CMDT_GRP SET" ).append("\n"); 
