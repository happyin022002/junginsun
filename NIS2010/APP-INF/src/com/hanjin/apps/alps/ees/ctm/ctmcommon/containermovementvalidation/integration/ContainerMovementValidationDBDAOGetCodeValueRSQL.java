...
*@FileName : ContainerMovementValidationDBDAOGetCodeValueRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementValidationDBDAOGetCodeValueRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementValidationDBDAOGetCodeValueRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.ctm.ctmcommon.containermovementvalidation.integration").append("\n"); 
		query.append("FileName : ContainerMovementValidationDBDAOGetCodeValueRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
