...
*@FileName : CHSInventoryByVariationDtlINVO.java
*@FileTitle : CHSInventoryByVariationDtlINVO
*Open Issues :
*Change history :
...
public class CHSInventoryByVariationDtlINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInventoryByVariationDtlINVO> models = new ArrayList<CHSInventoryByVariationDtlINVO>();
	 ...
	 */
	public CHSInventoryByVariationDtlINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInventoryByVariationDtlINVO[]
	 */
	public CHSInventoryByVariationDtlINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInventoryByVariationDtlINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSInventoryByVariationDtlINVO();
		...
		return getCHSInventoryByVariationDtlINVOs();
	}
	 ...
	 * @return CHSInventoryByVariationDtlINVO[]
	 */
	public CHSInventoryByVariationDtlINVO[] getCHSInventoryByVariationDtlINVOs(){
		CHSInventoryByVariationDtlINVO[] vos = (CHSInventoryByVariationDtlINVO[])models.toArray(new CHSInventoryByVariationDtlINVO[models.size()]);
		return vos;
	}
