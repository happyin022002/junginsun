...
*@FileName : ContainerSupplyDemandPlanDBDAOValidationEqPriceDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerSupplyDemandPlanDBDAOValidationEqPriceDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Validation EqPriceData
	  * </pre>
	  */
	public ContainerSupplyDemandPlanDBDAOValidationEqPriceDataRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerSupplyDemandPlanDBDAOValidationEqPriceDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM MST_EQ_PUR_PRC" ).append("\n"); 
