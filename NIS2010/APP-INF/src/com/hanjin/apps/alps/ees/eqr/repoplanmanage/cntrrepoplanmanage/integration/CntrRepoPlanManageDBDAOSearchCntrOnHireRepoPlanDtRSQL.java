...
*@FileName : CntrRepoPlanManageDBDAOSearchCntrOnHireRepoPlanDtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAOSearchCntrOnHireRepoPlanDtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAOSearchCntrOnHireRepoPlanDtRSQL(){
		setQuery();
		...
		params.put("term_3",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.eqr.repoplanmanage.cntrrepoplanmanage.integration").append("\n"); 
		query.append("FileName : CntrRepoPlanManageDBDAOSearchCntrOnHireRepoPlanDtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${typeby_3} == 'E')" ).append("\n"); 
		...
		query.append(", (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("#if (${typeby_3} == 'R')" ).append("\n"); 
		query.append("RCC_CD" ).append("\n"); 
		query.append("#elseif (${typeby_3} == 'C')" ).append("\n"); 
		query.append("CNT_CD" ).append("\n"); 
		query.append("#elseif (${typeby_3} == 'L')" ).append("\n"); 
		...
		query.append("#if (${type_3} != '' && $arrAtEccCd.size() > 0)" ).append("\n"); 
		query.append(", (SELECT ECC_CD FROM EQR_ECC_MST WHERE 1 = 1" ).append("\n"); 
		query.append("#if (${type_3} == 'R')" ).append("\n"); 
		query.append("AND RCC_CD" ).append("\n"); 
		query.append("#elseif (${type_3} == 'L')" ).append("\n"); 
		...
		query.append("#if (${term_3} != '')" ).append("\n"); 
		query.append("AND CNTR_LSTM_CD = @[term_3]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${type_3} != '')" ).append("\n"); 
		query.append("AND (PLN.ECC_CD = C.ECC_CD)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("AND PLN.PLN_YRWK BETWEEN '${fmplnyr_3}${fmplnwk_3}' AND '${toplnyr_3}${toplnwk_3}'" ).append("\n"); 
