...
*@FileName : EES_DMT_7008HTMLAction.java
...
public class EES_DMT_7008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7008HTMLAction 객체를 생성
	 */
	public EES_DMT_7008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7008Event event = new EesDmt7008Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setApprovalRequestUserVO((ApprovalRequestUserVO)getVO(request, ApprovalRequestUserVO .class));
		} 
