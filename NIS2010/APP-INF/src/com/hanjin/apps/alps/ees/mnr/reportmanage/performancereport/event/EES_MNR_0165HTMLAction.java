...
*@FileName : EES_MNR_0165HTMLAction.java
...
public class EES_MNR_0165HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0165HTMLAction 객체를 생성
	 */
	public EES_MNR_0165HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0165Event event = new EesMnr0165Event();

		switch(command.getCommand()) {
			case FormCommand.SEARCH :	//조회
				event.setDisposalPFMCByOfficeVO((DisposalPFMCByOfficeVO)getVO(request, DisposalPFMCByOfficeVO .class));
				//event.setDisposalPFMCByRegionGRPVO((DisposalPFMCByRegionGRPVO)getVO(request, DisposalPFMCByRegionGRPVO .class));
			default :	//do nothing
		}
