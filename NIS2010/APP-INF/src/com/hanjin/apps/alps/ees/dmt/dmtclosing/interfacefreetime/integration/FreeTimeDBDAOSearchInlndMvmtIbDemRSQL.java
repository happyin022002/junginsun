...
*@FileName : FreeTimeDBDAOSearchInlndMvmtIbDemRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FreeTimeDBDAOSearchInlndMvmtIbDemRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FreeTimeDBDAOSearchInlndMvmtIbDemRSQL
	  * </pre>
	  */
	public FreeTimeDBDAOSearchInlndMvmtIbDemRSQL(){
		setQuery();
		...
		query.append("FileName : FreeTimeDBDAOSearchInlndMvmtIbDemRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,'DEL'									AS DMDT_CHG_LOC_DIV_CD" ).append("\n"); 
		query.append("	   " ).append("\n"); 
		...
		query.append("		)" ).append("\n"); 
		query.append("   AND  T1.MVMT_STS_CD = 'IC'	   " ).append("\n"); 
