...
*@FileName : CHSInvoiceImportAuditINVO.java
*@FileTitle : CHSInvoiceImportAuditINVO
*Open Issues :
*Change history :
...
public class CHSInvoiceImportAuditINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInvoiceImportAuditINVO> models = new ArrayList<CHSInvoiceImportAuditINVO>();
	...
	/* Column Info */
	private String invCustEqTpszNm = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inv_cust_eq_tpsz_nm", getInvCustEqTpszNm());
		...
		this.hashColumns.put("cmb_inv_tp", getCmbInvTp());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inv_cust_eq_tpsz_nm", "invCustEqTpszNm");
		...
		this.hashFields.put("cmb_inv_tp", "cmbInvTp");
	...
	/**
	 * Column Info
	 * @return invCustEqTpszCd
	 */
	public String getInvCustEqTpszNm() {
		return this.invCustEqTpszNm;
	}
	...
	/**
	 * Column Info
	 * @param invCustEqTpszNm
	 */
	public void setInvCustEqTpszNm(String invCustEqTpszNm) {
		this.invCustEqTpszNm = invCustEqTpszNm;
	}
	 ...
	 * @return cmbInvTp
	 */
	public String getCmbInvTp() {
		return this.cmbInvTp;
	}
	 ...
	 * @return cmbInvTp
	 */
	public void setCmbInvTp(String cmbInvTp) {
		this.cmbInvTp = cmbInvTp;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setInvCustEqTpszNm(JSPUtil.getParameter(request, prefix + "inv_cust_eq_tpsz_nm", ""));
		...
		setCmbInvTp(JSPUtil.getParameter(request, prefix + "cmb_inv_tp", ""));
	}
	 ...
	 */
	public CHSInvoiceImportAuditINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInvoiceImportAuditINVO[]
	 */
	public CHSInvoiceImportAuditINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInvoiceImportAuditINVO model = null;
		...
		try {
			...
			String[] invCustEqTpszNm = (JSPUtil.getParameter(request, prefix	+ "inv_cust_eq_tpsz_nm", length));
			...
			String[] cmbInvTp = (JSPUtil.getParameter(request, prefix + "cmb_inv_tp", length));
			
			for (int i = 0; i < length; i++) {
				model = new CHSInvoiceImportAuditINVO();
				...
				if (invCustEqTpszNm[i] != null)
					model.setInvCustEqTpszNm(invCustEqTpszNm[i]);
		...
		return getCHSInvoiceImportAuditINVOs();
	}
	...
	public CHSInvoiceImportAuditINVO[] getCHSInvoiceImportAuditINVOs(){
		CHSInvoiceImportAuditINVO[] vos = (CHSInvoiceImportAuditINVO[])models.toArray(new CHSInvoiceImportAuditINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.invCustEqTpszNm = this.invCustEqTpszNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.cmbInvTp = this.cmbInvTp.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
