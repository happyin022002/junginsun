...
*@FileName : SCExceptionTariffMgtDBDAOSearchOneStopMultiApprovalYnRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchOneStopMultiApprovalYnRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCExceptionTariffMgtDBDAOSearchOneStopMultiApprovalYnRSQL
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchOneStopMultiApprovalYnRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchOneStopMultiApprovalYnRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("						  from  DMT_SC_EXPT_VER_PROG T" ).append("\n"); 
		query.append("						 where  PROP_NO         =  @[prop_no]" ).append("\n"); 
		query.append("						   and  SC_EXPT_VER_SEQ = to_number(@[sc_expt_ver_seq])" ).append("\n"); 
		...
		query.append("									   and  SC_EXPT_VER_SEQ      = T.SC_EXPT_VER_SEQ" ).append("\n"); 
		query.append("									   and  DMDT_EXPT_VER_STS_CD in ('T', 'R')" ).append("\n"); 
		query.append("								)" ).append("\n"); 
		query.append("					)" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("			  from  DMT_SC_EXPT_APRO_PATH" ).append("\n"); 
		query.append("			 where  PROP_NO         = @[prop_no]" ).append("\n"); 
		query.append("			   and  SC_EXPT_VER_SEQ = to_number(@[sc_expt_ver_seq])" ).append("\n"); 
		...
		query.append("			select  case when count(1) = 2 then 1 else 0 end as MULTI_APRO_YN" ).append("\n"); 
		query.append("			  from  DMT_SC_EXPT_APRO_PATH_USR " ).append("\n"); 
		query.append("			 where  PROP_NO         = @[prop_no]" ).append("\n"); 
		query.append("			   and  SC_EXPT_VER_SEQ = to_number(@[sc_expt_ver_seq])" ).append("\n"); 
		query.append("			   and  DMDT_EXPT_APRO_PATH_CD in ('BBG', 'V.P')" ).append("\n"); 
