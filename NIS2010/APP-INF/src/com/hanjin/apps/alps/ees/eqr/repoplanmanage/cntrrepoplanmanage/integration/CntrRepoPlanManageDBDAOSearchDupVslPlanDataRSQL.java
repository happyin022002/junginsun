...
*@FileName : CntrRepoPlanManageDBDAOSearchDupVslPlanDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAOSearchDupVslPlanDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchDupVslPlanData
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAOSearchDupVslPlanDataRSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanManageDBDAOSearchDupVslPlanDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND LDIS_TS_FLG = 'N'" ).append("\n"); 
