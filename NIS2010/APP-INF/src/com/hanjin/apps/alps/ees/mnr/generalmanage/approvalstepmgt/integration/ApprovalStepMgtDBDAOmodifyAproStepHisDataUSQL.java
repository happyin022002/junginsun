...
*@FileName : ApprovalStepMgtDBDAOmodifyAproStepHisDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalStepMgtDBDAOmodifyAproStepHisDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalStepMgtDBDAOmodifyAproStepHisDataUSQL(){
		setQuery();
		...
		params.put("pre_apro_usr_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ApprovalStepMgtDBDAOmodifyAproStepHisDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE APRO_USR_ID = @[pre_apro_usr_id]" ).append("\n"); 
