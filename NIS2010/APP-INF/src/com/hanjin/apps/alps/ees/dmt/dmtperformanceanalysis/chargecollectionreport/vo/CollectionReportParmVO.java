...
*@FileName : CollectionReportParmVO.java
*@FileTitle : CollectionReportParmVO
*Open Issues :
*Change history :
...
public class CollectionReportParmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CollectionReportParmVO> models = new ArrayList<CollectionReportParmVO>();
	...
	public CollectionReportParmVO() {}

	public CollectionReportParmVO(String ibflag, String pagerows, String grpFlg, String ofcFlg, String dmdtCntrTpCd, String startDt, String endDt, String ofcCd, String currFlg, String dmdtTrfCd, String dtlFlg, String chgFlg, String ioBndFlg, String uclmFlg) {
		this.endDt = endDt;
	 ...
	 */
	public CollectionReportParmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CollectionReportParmVO[]
	 */
	public CollectionReportParmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CollectionReportParmVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CollectionReportParmVO();
				if (endDt[i] != null)
		...
		return getCollectionReportParmVOs();
	}
	...
	public CollectionReportParmVO[] getCollectionReportParmVOs(){
		CollectionReportParmVO[] vos = (CollectionReportParmVO[])models.toArray(new CollectionReportParmVO[models.size()]);
		return vos;
	}
