...
*@FileName : EES_DOD_0002HTMLAction.java
...
public class EES_DOD_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DOD_0002HTMLAction 객체를 생성
	 */
	public EES_DOD_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDod0002Event event = new EesDod0002Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setSpclCdSeq(request.getParameter("spcl_cd_seq"));
		}
		return  event;
	}
