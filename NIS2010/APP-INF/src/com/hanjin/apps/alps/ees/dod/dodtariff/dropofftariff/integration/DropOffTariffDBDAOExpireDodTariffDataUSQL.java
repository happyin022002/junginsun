...
*@FileName : DropOffTariffDBDAOExpireDodTariffDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DropOffTariffDBDAOExpireDodTariffDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DropOffTariffDBDAOExpireDodTariffDataUSQL(){
		setQuery();
		...
		query.append("FileName : DropOffTariffDBDAOExpireDodTariffDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       drp_off_chg_trf_exp_flg = 'Y'," ).append("\n"); 
		query.append("	   DRP_OFF_CHG_TRF_EXP_DT = TO_CHAR(SYSDATE, 'YYYYMMDD')," ).append("\n"); 
