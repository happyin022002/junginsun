...
public class HolidayMgtDBDAOHolidayCountByRHQRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        									WHEN    SYS_AREA_GRP_ID IN ('KOR', 'JPN') THEN" ).append("\n"); 
		query.append("            										CNT_CD" ).append("\n"); 
		query.append("											WHEN    @[svr_id] = 'VVO' THEN CNT_CD" ).append("\n"); 
		query.append("        									ELSE" ).append("\n"); 
		query.append("            										SYS_AREA_GRP_ID" ).append("\n"); 
		query.append("											END     = DECODE(@[svr_id], 'KOR', 'KR', 'JPN', 'JP', 'VVO', 'RU', @[svr_id])" ).append("\n"); 
		query.append("								)" ).append("\n"); 
		query.append("					" ).append("\n"); 
