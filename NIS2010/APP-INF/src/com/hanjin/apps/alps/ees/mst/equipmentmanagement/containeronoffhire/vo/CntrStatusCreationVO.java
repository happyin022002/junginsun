...
public class CntrStatusCreationVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("seflg", getSeflg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("seflg", "seflg");
...
/**
   ...
   */
	 ...
	 * @return the seflg
	 */
	public String getSeflg() {
		return seflg;
	}

	/**
	 * @param seflg the seflg to set
	 */
	public void setSeflg(String seflg) {
		this.seflg = seflg;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSeflg(JSPUtil.getParameter(request, prefix + "seflg", ""));
	...
	public CntrStatusCreationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] seflg = (JSPUtil.getParameter(request, prefix	+ "seflg", length));
	...
	*/
	public void unDataFormat(){
		...
		this.seflg = this.seflg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
