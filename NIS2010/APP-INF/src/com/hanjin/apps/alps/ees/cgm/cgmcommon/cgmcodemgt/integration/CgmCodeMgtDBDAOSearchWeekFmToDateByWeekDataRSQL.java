...
*@FileName : CgmCodeMgtDBDAOSearchWeekFmToDateByWeekDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOSearchWeekFmToDateByWeekDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * chungpa 20090825 WEEK로 WEEK정보 조회
	  * </pre>
	  */
	public CgmCodeMgtDBDAOSearchWeekFmToDateByWeekDataRSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOSearchWeekFmToDateByWeekDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE t1.PLN_YR = @[eq_spec_no]" ).append("\n"); 
		query.append("AND t1.PLN_WK = @[eq_knd_cd]" ).append("\n"); 
