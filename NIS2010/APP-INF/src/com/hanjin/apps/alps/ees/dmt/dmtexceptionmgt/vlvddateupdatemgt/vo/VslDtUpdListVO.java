...
*@FileName : VslDtUpdListVO.java
*@FileTitle : VslDtUpdListVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.ees.dmt.dmtexceptionmgt.vlvddateupdatemgt.vo;
...
public class VslDtUpdListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VslDtUpdListVO> models = new ArrayList<VslDtUpdListVO>();
	...
	public VslDtUpdListVO() {}

	public VslDtUpdListVO(String ibflag, String pagerows, String seq, String lane, String vvd, String eta, String etd, String firstvl, String lastvl, String vldaten, String vldateb, String updated, String updateo, String updatei, String updaten, String clptIndSeq, String pfEta, String pfEtb, String pfEtd) {
		this.eta = eta;
	 ...
	 */
	public VslDtUpdListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VslDtUpdListVO[]
	 */
	public VslDtUpdListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VslDtUpdListVO model = null;
	...
	public VslDtUpdListVO[] getVslDtUpdListVOs(){
		VslDtUpdListVO[] vos = (VslDtUpdListVO[])models.toArray(new VslDtUpdListVO[models.size()]);
		return vos;
	}
