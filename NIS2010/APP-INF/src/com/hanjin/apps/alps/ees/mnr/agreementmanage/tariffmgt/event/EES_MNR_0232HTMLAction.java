...
*@FileName : EES_MNR_0232HTMLAction.java
...
public class EES_MNR_0232HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0232HTMLAction 객체를 생성
	 */
	public EES_MNR_0232HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesMnr0232Event event = new EesMnr0232Event();

    	switch(command.getCommand()) {
			case FormCommand.SEARCH :	//조회
				event.setDisposalTariffQuarterVO((DisposalTariffQuarterVO)getVO(request, DisposalTariffQuarterVO .class));
