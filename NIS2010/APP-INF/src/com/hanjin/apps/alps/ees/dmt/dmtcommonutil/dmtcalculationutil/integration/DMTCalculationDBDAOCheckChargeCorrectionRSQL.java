...
*@FileName : DMTCalculationDBDAOCheckChargeCorrectionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationDBDAOCheckChargeCorrectionRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DMTCalculationDBDAOCheckChargeCorrectionRSQL(){
		setQuery();
		...
		query.append("FileName : DMTCalculationDBDAOCheckChargeCorrectionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
