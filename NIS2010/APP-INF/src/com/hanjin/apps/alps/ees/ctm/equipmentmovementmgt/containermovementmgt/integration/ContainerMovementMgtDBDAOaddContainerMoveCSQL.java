...
public class ContainerMovementMgtDBDAOaddContainerMoveCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  NVL (DECODE (@[fcntr_flg], 'F', 'Y', 'M', 'N', 'E', 'N', @[fcntr_flg]), 'N')," ).append("\n"); 
		...
		query.append("  DECODE(@[mvmt_inp_tp_cd], 'SPP', NVL(@[bkg_no], @[bl_no]), @[bkg_no])," ).append("\n"); 
		query.append("  @[bkg_knt]," ).append("\n"); 
		query.append("  DECODE(@[mvmt_inp_tp_cd], 'SPP', NVL(@[bl_no], @[bkg_no]), @[bl_no])," ).append("\n"); 
