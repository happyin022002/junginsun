...
*@FileName : SearchUncollectedVolDtlListVO.java
*@FileTitle : SearchUncollectedVolDtlListVO
*Open Issues :
*Change history :
...
public class SearchUncollectedVolDtlListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchUncollectedVolDtlListVO> models = new ArrayList<SearchUncollectedVolDtlListVO>();
	...
	public SearchUncollectedVolDtlListVO() {}

	public SearchUncollectedVolDtlListVO(String ibflag, String pagerows, String sel, String ucCsNo, String bkgNo, String blNo, String cntrNo, String cntrTpszCd, String volDtlGb, String hndlBrncCd, String hndlHdlrUsrId) {
		this.bkgNo = bkgNo;
		this.ibflag = ibflag;
		this.ucCsNo = ucCsNo;
		this.cntrNo = cntrNo;
...
/**
	 ...
	 */
	public SearchUncollectedVolDtlListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchUncollectedVolDtlListVO[]
	 */
	public SearchUncollectedVolDtlListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchUncollectedVolDtlListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchUncollectedVolDtlListVO();
				if (bkgNo[i] != null)
		...
		return getSearchUncollectedVolDtlListVOs();
	}
	...
	public SearchUncollectedVolDtlListVO[] getSearchUncollectedVolDtlListVOs(){
		SearchUncollectedVolDtlListVO[] vos = (SearchUncollectedVolDtlListVO[])models.toArray(new SearchUncollectedVolDtlListVO[models.size()]);
		return vos;
	}
