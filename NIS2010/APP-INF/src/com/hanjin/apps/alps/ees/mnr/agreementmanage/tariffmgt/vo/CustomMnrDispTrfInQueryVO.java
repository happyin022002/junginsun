...
*@FileName : CustomMnrDispTrfInQueryVO.java
*@FileTitle : CustomMnrDispTrfInQueryVO
*Open Issues :
*Change history :
...
public class CustomMnrDispTrfInQueryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMnrDispTrfInQueryVO> models = new ArrayList<CustomMnrDispTrfInQueryVO>();
	...
	/* Column Info */
	private String mnrDispTrfGrpNm = null;
	/* Column Info */
	...
	public CustomMnrDispTrfInQueryVO() {}

	public CustomMnrDispTrfInQueryVO(String ibflag, String pagerows, String mnrDispTrfSeq, String mnrDispTrfGrpCd, String mnrDispTrfGrpNm, String ctrlOfcCd, String locCd, String currCd, String effDt, String mnrDispTrfStsCd, String mnrDispTrfStsNm, String mnrDispTrfTpCd, String mnrDispTrfTpNm, String title, String ts01, String ts02, String ts03, String ts04, String ts05, String ts06, String ts07, String ts08, String ts09, String ts10, String ts11, String ts12, String ts13, String ts14, String ts15, String ts16, String ts17, String ts18, String ts19, String ts20, String ts21, String ts22, String ts23, String ts24, String ts25, String ts26, String ts27, String ts28, String ts29, String ts30) {
		this.currCd = currCd;
		this.ts21 = ts21;
		this.ts22 = ts22;
		...
		this.ts16 = ts16;
		this.ts29 = ts29;
		this.mnrDispTrfGrpNm = mnrDispTrfGrpNm;
		this.ts27 = ts27;
		this.ts28 = ts28;
		this.ts25 = ts25;
		this.ts26 = ts26;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mnr_disp_trf_grp_nm", getMnrDispTrfGrpNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mnr_disp_trf_grp_nm", "mnrDispTrfGrpNm");
	...
	/**
	 * Column Info
	 * @return mnrDispTrfGrpNm
	 */
	public String getMnrDispTrfGrpNm() {
		return this.mnrDispTrfGrpNm;
	}
	...
	/**
	 * Column Info
	 * @param mnrDispTrfGrpNm
	 */
	public void setMnrDispTrfGrpNm(String mnrDispTrfGrpNm) {
		this.mnrDispTrfGrpNm = mnrDispTrfGrpNm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTs21(JSPUtil.getParameter(request, prefix + "ts21", ""));
		setTs22(JSPUtil.getParameter(request, prefix + "ts22", ""));
		setMnrDispTrfSeq(JSPUtil.getParameter(request, prefix + "mnr_disp_trf_seq", ""));
		setTs20(JSPUtil.getParameter(request, prefix + "ts20", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setMnrDispTrfStsCd(JSPUtil.getParameter(request, prefix + "mnr_disp_trf_sts_cd", ""));
		setEffDt(JSPUtil.getParameter(request, prefix + "eff_dt", ""));
		setLocCd(JSPUtil.getParameter(request, prefix + "loc_cd", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setTitle(JSPUtil.getParameter(request, prefix + "title", ""));
		setMnrDispTrfStsNm(JSPUtil.getParameter(request, prefix + "mnr_disp_trf_sts_nm", ""));
		setTs15(JSPUtil.getParameter(request, prefix + "ts15", ""));
		setTs14(JSPUtil.getParameter(request, prefix + "ts14", ""));
		setTs13(JSPUtil.getParameter(request, prefix + "ts13", ""));
		setTs12(JSPUtil.getParameter(request, prefix + "ts12", ""));
		setTs19(JSPUtil.getParameter(request, prefix + "ts19", ""));
		setTs18(JSPUtil.getParameter(request, prefix + "ts18", ""));
		setTs17(JSPUtil.getParameter(request, prefix + "ts17", ""));
		setMnrDispTrfTpNm(JSPUtil.getParameter(request, prefix + "mnr_disp_trf_tp_nm", ""));
		setTs16(JSPUtil.getParameter(request, prefix + "ts16", ""));
		setTs29(JSPUtil.getParameter(request, prefix + "ts29", ""));
		setMnrDispTrfGrpNm(JSPUtil.getParameter(request, prefix + "mnr_disp_trf_grp_nm", ""));
		setTs27(JSPUtil.getParameter(request, prefix + "ts27", ""));
		setTs28(JSPUtil.getParameter(request, prefix + "ts28", ""));
		setTs25(JSPUtil.getParameter(request, prefix + "ts25", ""));
		setTs26(JSPUtil.getParameter(request, prefix + "ts26", ""));
		setTs23(JSPUtil.getParameter(request, prefix + "ts23", ""));
		setTs10(JSPUtil.getParameter(request, prefix + "ts10", ""));
		setTs24(JSPUtil.getParameter(request, prefix + "ts24", ""));
		setTs11(JSPUtil.getParameter(request, prefix + "ts11", ""));
		...
		setMnrDispTrfGrpCd(JSPUtil.getParameter(request, prefix + "mnr_disp_trf_grp_cd", ""));
		setTs09(JSPUtil.getParameter(request, prefix + "ts09", ""));
		setTs02(JSPUtil.getParameter(request, prefix + "ts02", ""));
		setTs01(JSPUtil.getParameter(request, prefix + "ts01", ""));
		setTs04(JSPUtil.getParameter(request, prefix + "ts04", ""));
		setTs30(JSPUtil.getParameter(request, prefix + "ts30", ""));
		setTs03(JSPUtil.getParameter(request, prefix + "ts03", ""));
		setTs06(JSPUtil.getParameter(request, prefix + "ts06", ""));
		setTs05(JSPUtil.getParameter(request, prefix + "ts05", ""));
		setTs08(JSPUtil.getParameter(request, prefix + "ts08", ""));
		setTs07(JSPUtil.getParameter(request, prefix + "ts07", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return CustomMnrDispTrfInQueryVO[]
	 */
	public CustomMnrDispTrfInQueryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomMnrDispTrfInQueryVO[]
	 */
	public CustomMnrDispTrfInQueryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrDispTrfInQueryVO model = null;
		...
		try {
			...
			String[] mnrDispTrfGrpNm = (JSPUtil.getParameter(request, prefix	+ "mnr_disp_trf_grp_nm", length));
			...
			for (int i = 0; i < length; i++) {
				model = new CustomMnrDispTrfInQueryVO();
				if (currCd[i] != null)
				...
				if (mnrDispTrfGrpNm[i] != null)
					model.setMnrDispTrfGrpNm(mnrDispTrfGrpNm[i]);
				if (ts27[i] != null)
		...
		return getCustomMnrDispTrfInQueryVOs();
	}
	 ...
	 * @return CustomMnrDispTrfInQueryVO[]
	 */
	public CustomMnrDispTrfInQueryVO[] getCustomMnrDispTrfInQueryVOs(){
		CustomMnrDispTrfInQueryVO[] vos = (CustomMnrDispTrfInQueryVO[])models.toArray(new CustomMnrDispTrfInQueryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.mnrDispTrfGrpNm = this.mnrDispTrfGrpNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
