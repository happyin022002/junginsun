...
*@FileName : OnhireBalanceDBDAOaddPlanAndApprovalQtyCSQL.java
...
public class OnhireBalanceDBDAOaddPlanAndApprovalQtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_ONH_PLN_APRO_QTY 에 데이터를 INSERT 한다
	  * </pre>
	  */
	public OnhireBalanceDBDAOaddPlanAndApprovalQtyCSQL(){
		setQuery();
		...
		query.append("FileName : OnhireBalanceDBDAOaddPlanAndApprovalQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_CTRL_ONH_PLN_APRO_QTY" ).append("\n"); 
		query.append("(    " ).append("\n"); 
