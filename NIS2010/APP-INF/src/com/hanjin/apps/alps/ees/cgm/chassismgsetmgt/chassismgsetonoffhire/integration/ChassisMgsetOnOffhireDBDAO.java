...
/**
 * ALPS ChassisMgsetOnOffhireDAO <br>
 * - ALPS-ChassisMgsetMgt system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 *
 * @author Eui-su Park
...
// 			}
	...
	/**
     * 월별로 반납한 실적을 조회<br>
     * (Off-Hire Report Summary By Month )
     * @param  ReportSearchConditionVO reportSearchConditionVO
     * @return OnOffHireSummarybyMonthVO
     * @throws DAOException
     */
     @SuppressWarnings("unchecked")
     public OnOffHireSummarybyMonthVO searchCHSOffHireReportbyMonthSummaryData(ReportSearchConditionVO reportSearchConditionVO) throws DAOException {
       DBRowSet dbRowset = null;
       OnOffHireSummarybyMonthVO rsvo = new  OnOffHireSummarybyMonthVO();
       ...
       try{
         if(reportSearchConditionVO != null){

       	  List<String> arrLstmCd = null;
          List<String> arrTpsz   = null;

             arrLstmCd = JSPUtil.convertStringToArrayList(JSPUtil.replace(reportSearchConditionVO.getLstmCd(),",","|"));
             arrTpsz   = JSPUtil.convertStringToArrayList(JSPUtil.replace(reportSearchConditionVO.getArrTpszCd(),",","|"));

             param.put("loc_tp"              , reportSearchConditionVO.getLocTp());
             param.put("loc_cd"              , reportSearchConditionVO.getCrntLocCd());
             param.put("lstm_cd"             , arrLstmCd);
             param.put("lstm_cd_str"         , reportSearchConditionVO.getLstmCd());
             param.put("period_stdt"         , reportSearchConditionVO.getPeriodStdt().replaceAll("-", ""));
             param.put("period_eddt"         , reportSearchConditionVO.getPeriodEddt().replaceAll("-", ""));
             param.put("arrTpsz"             , arrTpsz);
             param.put("term_change"         , reportSearchConditionVO.getTermChange());
             param.put("dio"                 , reportSearchConditionVO.getDio());
             param.put("np"                  , reportSearchConditionVO.getNp());
             param.put("eq_knd_cd"           , reportSearchConditionVO.getEqKndCd());

             velParam.put("loc_tp"           , reportSearchConditionVO.getLocTp());
             velParam.put("loc_cd"           , reportSearchConditionVO.getCrntLocCd());
             velParam.put("lstm_cd"          , arrLstmCd);
             velParam.put("lstm_cd_str"      , reportSearchConditionVO.getLstmCd());
             velParam.put("period_stdt"      , reportSearchConditionVO.getPeriodStdt().replaceAll("-", ""));
             velParam.put("period_eddt"      , reportSearchConditionVO.getPeriodEddt().replaceAll("-", ""));
             velParam.put("arrTpsz"          , arrTpsz);
             velParam.put("term_change"      , reportSearchConditionVO.getTermChange());
             velParam.put("dio"              , reportSearchConditionVO.getDio());
             velParam.put("np"              , reportSearchConditionVO.getNp());
         }

      	  dbRowset = new SQLExecuter("").executeQuery(new ChassisMgsetOnOffhireDBDAOSearchCHSOffHireReportbyMonthSummaryDataRSQL(), param, velParam);
      	  
      	rsvo.setDbRowset(dbRowset);
      	rsvo.setArrTpszCd(reportSearchConditionVO.getArrTpszCd());
//         list = (List)RowSetUtil.rowSetToVOs(dbRowset, CHSOnHireSummarybyMonthVO.class);
     ...
     */
     @SuppressWarnings("unchecked")
     public OnOffHireSummarybyMonthVO searchCHSOnHireReportbyMonthSummaryData(ReportSearchConditionVO reportSearchConditionVO) throws DAOException {
       DBRowSet dbRowset = null;
       OnOffHireSummarybyMonthVO rsvo = new  OnOffHireSummarybyMonthVO();
       ...
       try{
         if(reportSearchConditionVO != null){
          ...
          List<String> arrTpsz   = null;
             ...
             param.put("arrTpsz"             , arrTpsz);
             param.put("term_change"         , reportSearchConditionVO.getTermChange());
             param.put("dii"                 , reportSearchConditionVO.getDii());
             param.put("np"                  , reportSearchConditionVO.getNp());
             param.put("eq_knd_cd"           , reportSearchConditionVO.getEqKndCd());
             ...
             velParam.put("arrTpsz"          , arrTpsz);
             velParam.put("term_change"      , reportSearchConditionVO.getTermChange());
             velParam.put("dii"              , reportSearchConditionVO.getDii());
             velParam.put("np"              , reportSearchConditionVO.getNp());
         }

      	  dbRowset = new SQLExecuter("").executeQuery(new ChassisMgsetOnOffhireDBDAOSearchCHSOnHireReportbyMonthSummaryDataRSQL(), param, velParam);
...
//         list = (List)RowSetUtil.rowSetToVOs(dbRowset, CHSOnHireSummarybyMonthVO.class);
 	 ...
 	 *
  	 ...
  	 * @exception DAOException
  	 */
 	public void removeMGSByMNRSoldCancelData(List<IFMnrFlagVO> iFMnrFlagVOList) throws DAOException {
 		try {
 			SQLExecuter sqlExe = new SQLExecuter("");
 			if(iFMnrFlagVOList.size() > 0){
 				sqlExe.executeBatch((ISQLTemplate)new ChassisMgsetOnOffhireDBDAORemoveMGSByMNRSoldCancelDataDSQL(), iFMnrFlagVOList, null);
 			}
 		} catch (SQLException se) {
 			log.error(se.getMessage(), se);
 			throw new DAOException(new ErrorHandler(se).getMessage());
 	 ...
 	 *
  	 ...
  	 * @exception DAOException
  	 */
 	public void modifyMGSByMNRSoldCancelData(List<IFMnrFlagVO> iFMnrFlagVOList) throws DAOException {
 		try {
 			SQLExecuter sqlExe = new SQLExecuter("");
 			if(iFMnrFlagVOList.size() > 0){
 				sqlExe.executeBatch((ISQLTemplate)new ChassisMgsetOnOffhireDBDAOModifyMGSByMNRSoldCancelDataUSQL(), iFMnrFlagVOList, null);
 			}
 		} catch (SQLException se) {
 			log.error(se.getMessage(), se);
 			throw new DAOException(new ErrorHandler(se).getMessage());
 	 ...
 	 *
  	 ...
  	 * @exception DAOException
  	 */
 	public void removeCHSByMNRSoldCancelData(List<IFMnrFlagVO> iFMnrFlagVOList) throws DAOException {
 		try {
 			SQLExecuter sqlExe = new SQLExecuter("");
 			if(iFMnrFlagVOList.size() > 0){
 				sqlExe.executeBatch((ISQLTemplate)new ChassisMgsetOnOffhireDBDAORemoveCHSByMNRSoldCancelDataDSQL(), iFMnrFlagVOList, null);
 			}
 		} catch (SQLException se) {
 			log.error(se.getMessage(), se);
 			throw new DAOException(new ErrorHandler(se).getMessage());
 	 ...
 	 *
  	 ...
  	 * @exception DAOException
  	 */
 	public void modifyCHSByMNRSoldCancelData(List<IFMnrFlagVO> iFMnrFlagVOList) throws DAOException {
 		try {
 			SQLExecuter sqlExe = new SQLExecuter("");
 			if(iFMnrFlagVOList.size() > 0){
 				sqlExe.executeBatch((ISQLTemplate)new ChassisMgsetOnOffhireDBDAOModifyCHSByMNRSoldCancelDataUSQL(), iFMnrFlagVOList, null);
 			}
 		} catch (SQLException se) {
 			log.error(se.getMessage(), se);
 			throw new DAOException(new ErrorHandler(se).getMessage());
