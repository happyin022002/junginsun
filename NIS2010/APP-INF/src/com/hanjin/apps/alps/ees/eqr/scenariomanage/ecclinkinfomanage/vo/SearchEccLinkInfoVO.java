...
*@FileName : SearchEccLinkInfoVO.java
*@FileTitle : SearchEccLinkInfoVO
*Open Issues :
*Change history :
* No.	Ver.		Modifier           		modifier date    explanation
* 1      	1.0      	Lee Byoung Hun	2009.07.27		1.0 최초 생성
*
...
public class SearchEccLinkInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEccLinkInfoVO> models = new ArrayList<SearchEccLinkInfoVO>();
	...
	public SearchEccLinkInfoVO() {}

	public SearchEccLinkInfoVO(String ibflag, String pagerows, String fmEccCd, String toEccCd, String trspModCd, String tzDys, String tz20ftCostAmt, String tz40ftCostAmt, String tz45ftCostAmt, String cntrMaxCapaQty, String cntrVolUtCd, String trspFreqKnt, String exptFmYrwk, String exptToYrwk, String exptMaxCapaQty, String exptVolUtCd, String scnrId) {
	 ...
	 * @param request
	 * @return SearchEccLinkInfoVO[]
	 */
	public SearchEccLinkInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEccLinkInfoVO[]
	 */
	public SearchEccLinkInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEccLinkInfoVO model = null;
		...
		return getSearchEccLinkInfoVOs();
	}
	 ...
	 * @return SearchEccLinkInfoVO[]
	 */
	public SearchEccLinkInfoVO[] getSearchEccLinkInfoVOs(){
		SearchEccLinkInfoVO[] vos = (SearchEccLinkInfoVO[])models.toArray(new SearchEccLinkInfoVO[models.size()]);
		return vos;
	}
