...
*@FileName : ChassisMovementHistoryDBDAOaddCHSMovementDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMovementHistoryDBDAOaddCHSMovementDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 장비 Lost 관련 'XX' movement 를 입력한다.    
	  * </pre>
	  */
	public ChassisMovementHistoryDBDAOaddCHSMovementDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMovementHistoryDBDAOaddCHSMovementDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[mvmt_sts_cd]" ).append("\n"); 
		query.append(",(SELECT DECODE(MAX(SYS_SEQ)+1,NULL,1,MAX(SYS_SEQ)+1) FROM CGM_CHSS_MVMT_HIS WHERE CHSS_NO= @[chss_no] AND MVMT_DT = TO_DATE(@[cnmv_evnt_dt]   ,'YYYY-MM-DD HH24:MI:SS') )" ).append("\n"); 
