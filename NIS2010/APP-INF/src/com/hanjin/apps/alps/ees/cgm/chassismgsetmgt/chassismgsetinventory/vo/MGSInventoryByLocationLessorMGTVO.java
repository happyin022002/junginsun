...
*@FileName : MGSInventoryByLocationLessorMGTVO.java
*@FileTitle : MGSInventoryByLocationLessorMGTVO
*Open Issues :
*Change history :
...
public class MGSInventoryByLocationLessorMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSInventoryByLocationLessorMGTVO> models = new ArrayList<MGSInventoryByLocationLessorMGTVO>();
	...
	public MGSInventoryByLocationLessorMGTVO() {}

	public MGSInventoryByLocationLessorMGTVO(String ibflag, String pagerows, String eqKndCd, String location, String crntLocCd, String crntYdCd, String vndrSeq, String vndrLglEngNm, String locCd, String eqTpszCdTotal, String eqTpszCdUmg, String eqTpszCdClg) {
		this.locCd = locCd;
		this.ibflag = ibflag;
	 ...
	 */
	public MGSInventoryByLocationLessorMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSInventoryByLocationLessorMGTVO[]
	 */
	public MGSInventoryByLocationLessorMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSInventoryByLocationLessorMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSInventoryByLocationLessorMGTVO();
				if (locCd[i] != null)
		...
		return getMGSInventoryByLocationLessorMGTVOs();
	}
	...
	public MGSInventoryByLocationLessorMGTVO[] getMGSInventoryByLocationLessorMGTVOs(){
		MGSInventoryByLocationLessorMGTVO[] vos = (MGSInventoryByLocationLessorMGTVO[])models.toArray(new MGSInventoryByLocationLessorMGTVO[models.size()]);
		return vos;
	}
