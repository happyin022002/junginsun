...
*@FileName : EES_CTM_0414HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0414HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0414HTMLAction 객체를 생성
	 */
	public EES_CTM_0414HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0414Event event = new EesCtm0414Event();
		...
		if(command.isCommand(FormCommand.SEARCH02)) {
			...
			event.setSearchEDIMovementListVOS((SearchEDIMovementListVO[])getVOs(request, SearchEDIMovementListVO.class,"sheet1_"));
			event.setCtmMovementVOS((MVMTBookingInfoVO[])getVOs(request, MVMTBookingInfoVO.class,"sheet2_"));
			event.setCusCtmMovementVOS((CusCtmMovementVO[])getVOs(request, CusCtmMovementVO.class,"sheet2_"));
		}
