...
*@FileName : EES_CGM_1108HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.ees.cgm.movementmnrhistory 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_CGM_1108HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1108HTMLAction 객체를 생성
	 */
	public EES_CGM_1108HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1108Event event = new EesCgm1108Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSMvmtINVO((CHSMvmtINVO)getVO(request, CHSMvmtINVO .class));
		} else if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setChsMvmtBareMGTVOs((CHSMvmtBareMGTVO[])getVOs(request, CHSMvmtBareMGTVO .class,""));
