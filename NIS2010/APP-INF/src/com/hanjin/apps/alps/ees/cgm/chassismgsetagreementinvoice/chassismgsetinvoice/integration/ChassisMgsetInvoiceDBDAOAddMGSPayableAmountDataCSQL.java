...
*@FileName : ChassisMgsetInvoiceDBDAOAddMGSPayableAmountDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOAddMGSPayableAmountDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChassisMgsetInvoiceDB.AddMGSPayableAmountData
	  * 2015 조직코드개편 Chang-Young Kim
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOAddMGSPayableAmountDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOAddMGSPayableAmountDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    	'LS' AS CHSS_MGST_INV_KND_CD," ).append("\n"); 
		...
		query.append("    	NVL(SUM(B.PAY_LSE_CHG_AMT),0) + NVL(SUM(B.PAY_CR_AMT),0) + NVL(SUM(B.PAY_TAX_AMT),0) AS CHG_SMRY_AMT," ).append("\n"); 
		query.append("    	NVL(SUM(B.PAY_LSE_CHG_AMT),0) + NVL(SUM(B.PAY_CR_AMT),0) + NVL(SUM(B.PAY_TAX_AMT),0) AS INV_SMRY_AMT," ).append("\n"); 
