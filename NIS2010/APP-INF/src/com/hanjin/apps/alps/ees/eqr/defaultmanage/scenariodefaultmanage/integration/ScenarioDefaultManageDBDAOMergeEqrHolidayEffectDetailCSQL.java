...
*@FileName : ScenarioDefaultManageDBDAOMergeEqrHolidayEffectDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScenarioDefaultManageDBDAOMergeEqrHolidayEffectDetailCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_HOL_EFF_RTO 테이블에 정보 입력/수정
	  * </pre>
	  */
	public ScenarioDefaultManageDBDAOMergeEqrHolidayEffectDetailCSQL(){
		setQuery();
		...
		params.put("wk_dy_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hol_eff_yrwk",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hol_eff_rto",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.eqr.defaultmanage.scenariodefaultmanage.integration ").append("\n"); 
		query.append("FileName : ScenarioDefaultManageDBDAOMergeEqrHolidayEffectDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EQR_HOL_EFF_RTO A" ).append("\n"); 
		...
		query.append("@[hol_eff_yrwk] AS HOL_EFF_YRWK ," ).append("\n"); 
		query.append("@[io_bnd_cd] AS IO_BND_CD ," ).append("\n"); 
		query.append("@[wk_dy_cd] AS WK_DY_CD" ).append("\n"); 
		...
		query.append("HOL_EFF_YRWK," ).append("\n"); 
		query.append("IO_BND_CD," ).append("\n"); 
		query.append("WK_DY_CD," ).append("\n"); 
		query.append("HOL_EFF_RTO," ).append("\n"); 
