...
*@FileName : RFAExceptionTariffMgtDBDAOSearchBeforeAPROListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchBeforeAPROListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request - Before Booking Request 의 DAR No. 의 VER No. 별 승인번호 정보를 조회하기 위한 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchBeforeAPROListRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchBeforeAPROListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND	(RFA_EXPT_APRO_NO IS NOT NULL OR RFA_EXPT_APRO_NO <> '')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("RFA_EXPT_DAR_NO 	= @[rfa_expt_dar_no]" ).append("\n"); 
