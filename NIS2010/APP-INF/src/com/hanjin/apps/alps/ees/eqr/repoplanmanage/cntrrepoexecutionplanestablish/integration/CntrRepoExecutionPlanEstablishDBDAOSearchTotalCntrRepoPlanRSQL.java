...
public class CntrRepoExecutionPlanEstablishDBDAOSearchTotalCntrRepoPlanRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",SUM(TOTALCOST)		AS T5_TOTALCOST" ).append("\n"); 
		query.append("#foreach ( $key in ${arrtpsz} )" ).append("\n"); 
		query.append(",SUM(${key}COST)	AS T5_${key}COST" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append(",'Both' 			COMPANY" ).append("\n"); 
		...
		query.append("AND	A.FM_ECC      = C.FM_ECC_CD" ).append("\n"); 
		query.append("AND	A.TO_ECC      = C.TO_ECC_CD" ).append("\n"); 
		...
		query.append("AND	A.REPO_PLN_ID = @[repo_pln_id]" ).append("\n"); 
		query.append("#if ( ${userEcc} != '' )" ).append("\n"); 
		query.append("AND (SUBSTR(A.FM_YD_CD, 0, 5) IN (SELECT SCC_CD FROM MDM_EQ_ORZ_CHT WHERE ECC_CD IN ( ${userEccText} ))" ).append("\n"); 
		query.append("OR SUBSTR(A.TO_YD_CD, 0, 5) IN (SELECT SCC_CD FROM MDM_EQ_ORZ_CHT WHERE ECC_CD IN ( ${userEccText} )))" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if ( ${fmtoat} == 1 )" ).append("\n"); 
		query.append("AND	A.PLN_YRWK BETWEEN @[fm_plnyrwk] AND  @[to_plnyrwk]" ).append("\n"); 
		query.append("#if( ${fromstatus} != '' )" ).append("\n"); 
		...
		query.append(",MDM_EQ_ORZ_CHT B" ).append("\n"); 
		query.append(",MDM_EQ_ORZ_CHT C" ).append("\n"); 
		query.append("WHERE	SUBSTR(OUTER.FM_YD_CD, 0, 5) = B.SCC_CD" ).append("\n"); 
		...
		query.append("ORDER BY 1, ITEM, FM_ECC||TO_ECC, REF_ID||SORTNUM" ).append("\n"); 
