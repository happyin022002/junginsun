...
*@FileName : UncollectedCargoDBDAOCheckBLNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOCheckBLNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * B/L No 가 Invlide 한지 Check 
	  * </pre>
	  */
	public UncollectedCargoDBDAOCheckBLNoRSQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAOCheckBLNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
