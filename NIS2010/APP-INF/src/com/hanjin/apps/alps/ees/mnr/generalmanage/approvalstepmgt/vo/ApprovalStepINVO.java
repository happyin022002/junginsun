...
*@FileName : ApprovalStepINVO.java
*@FileTitle : ApprovalStepINVO
*Open Issues :
*Change history :
...
public class ApprovalStepINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ApprovalStepINVO> models = new ArrayList<ApprovalStepINVO>();
	...
	public ApprovalStepINVO() {}

	public ApprovalStepINVO(String ibflag, String pagerows, String workTpFlg, String updDt, String aproStepSeq, String creDt, String ofcTpCd, String mnrAproJbCd, String aproDt, String aproRmk, String ofcCd, String creUsrId, String rowSeq, String aproUsrId, String usrNm, String updUsrId, String wrtfNo, String apstsCd) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("work_tp_flg", getWorkTpFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("work_tp_flg", "workTpFlg");
	 ...
	 * @return workTpFlg
	 */
	public String getWorkTpFlg() {
		return this.workTpFlg;
	}
	 ...
	 * @param workTpFlg
	 */
	public void setWorkTpFlg(String workTpFlg) {
		this.workTpFlg = workTpFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setWorkTpFlg(JSPUtil.getParameter(request, prefix + "work_tp_flg", ""));
	 ...
	 */
	public ApprovalStepINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ApprovalStepINVO[]
	 */
	public ApprovalStepINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ApprovalStepINVO model = null;
		...
		try {
			...
			String[] workTpFlg = (JSPUtil.getParameter(request, prefix	+ "work_tp_flg", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] wrtfNo = (JSPUtil.getParameter(request, prefix	+ "wrtf_no", length));
			
			for (int i = 0; i < length; i++) {
				model = new ApprovalStepINVO();
				if (updDt[i] != null)
				...
				if (workTpFlg[i] != null)
					model.setWorkTpFlg(workTpFlg[i]);
				if (updUsrId[i] != null)
	 ...
	 * @return ApprovalStepINVO[]
	 */
	public ApprovalStepINVO[] getApprovalStepINVOs(){
		ApprovalStepINVO[] vos = (ApprovalStepINVO[])models.toArray(new ApprovalStepINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.workTpFlg = this.workTpFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
