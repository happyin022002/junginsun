...
*@FileName : MGSEstimateExpenseMGTVO.java
*@FileTitle : MGSEstimateExpenseMGTVO
*Open Issues :
*Change history :
...
public class MGSEstimateExpenseMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSEstimateExpenseMGTVO> models = new ArrayList<MGSEstimateExpenseMGTVO>();
...
/**
	 ...
	 */
	public MGSEstimateExpenseMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSEstimateExpenseMGTVO[]
	 */
	public MGSEstimateExpenseMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSEstimateExpenseMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSEstimateExpenseMGTVO();
				if (vslCd[i] != null)
		...
		return getMGSEstimateExpenseMGTVOs();
	}
	...
	public MGSEstimateExpenseMGTVO[] getMGSEstimateExpenseMGTVOs(){
		MGSEstimateExpenseMGTVO[] vos = (MGSEstimateExpenseMGTVO[])models.toArray(new MGSEstimateExpenseMGTVO[models.size()]);
		return vos;
	}
