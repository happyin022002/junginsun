...
*@FileName : IncomeMgtDBDAOmodifyReceivableInvoiceStatusDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IncomeMgtDBDAOmodifyReceivableInvoiceStatusDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * IncomeMgtDBDAOmodifyReceivableInvoiceStatusDataUSQL
	  * </pre>
	  */
	public IncomeMgtDBDAOmodifyReceivableInvoiceStatusDataUSQL(){
		setQuery();
		...
		query.append("FileName : IncomeMgtDBDAOmodifyReceivableInvoiceStatusDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${mnr_inv_sts_cd} == 'HS')" ).append("\n"); 
