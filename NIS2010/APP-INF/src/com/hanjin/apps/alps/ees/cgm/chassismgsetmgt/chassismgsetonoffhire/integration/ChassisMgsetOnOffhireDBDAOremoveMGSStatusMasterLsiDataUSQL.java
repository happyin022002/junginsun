...
*@FileName : ChassisMgsetOnOffhireDBDAOremoveMGSStatusMasterLsiDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOremoveMGSStatusMasterLsiDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOremoveMGSStatusMasterLsiDataUSQL(){
setQuery();
		...
		params.put("gmt_ver_no",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOremoveMGSStatusMasterLsiDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}