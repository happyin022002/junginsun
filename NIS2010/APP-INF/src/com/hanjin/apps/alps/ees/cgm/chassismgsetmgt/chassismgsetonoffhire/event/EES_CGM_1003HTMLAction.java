...
*@FileName : EES_CGM_1003HTMLAction.java
...
public class EES_CGM_1003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1003HTMLAction 객체를 생성
	 */
	public EES_CGM_1003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1003Event event = new EesCgm1003Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSMasterInfoINVO((CHSMasterInfoINVO)getVO(request, CHSMasterInfoINVO .class));
		}
