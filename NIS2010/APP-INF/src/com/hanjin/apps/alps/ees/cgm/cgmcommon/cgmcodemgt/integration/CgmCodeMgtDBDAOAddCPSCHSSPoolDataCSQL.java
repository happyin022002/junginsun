...
*@FileName : CgmCodeMgtDBDAOAddCPSCHSSPoolDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOAddCPSCHSSPoolDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CPS Neutral Pool을 입력한다.
	  * </pre>
	  */
	public CgmCodeMgtDBDAOAddCPSCHSSPoolDataCSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOAddCPSCHSSPoolDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CGM_CPS_POOL_LIST" ).append("\n"); 
		query.append("(" ).append("\n"); 
