...
*@FileName : CntrRepoPlanManageDBDAOSearchDupOnHirePlnDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanManageDBDAOSearchDupOnHirePlnDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchDupOnHirePlnData
	  * </pre>
	  */
	public CntrRepoPlanManageDBDAOSearchDupOnHirePlnDataRSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanManageDBDAOSearchDupOnHirePlnDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
