...
*@FileName : EES_MNR_S308HTMLAction.java
...
/**
 * HTTP Parser<br>  
 * - EES_MNR_S308 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author 함형석  
 * @see EesMnrS308Event.java 참조 
 * @since J2EE 1.6           
 */ 

public class EES_MNR_S308HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_S308HTMLAction 객체를 생성
	 */	 
	public EES_MNR_S308HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnrS308Event event = new EesMnrS308Event();
