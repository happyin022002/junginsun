...
*@FileName : ChargeCalculationDBDAOSearchChargeChangeStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeChangeStatusRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeChangeStatusRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeChangeStatusRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeChangeStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${dmdt_chg_sts_cd} == 'A')   " ).append("\n"); 
		query.append("   and  DMDT_CHG_STS_CD     not in ('I', 'D')" ).append("\n"); 
		query.append("#elseif (${dmdt_chg_sts_cd} == 'J')      " ).append("\n"); 
