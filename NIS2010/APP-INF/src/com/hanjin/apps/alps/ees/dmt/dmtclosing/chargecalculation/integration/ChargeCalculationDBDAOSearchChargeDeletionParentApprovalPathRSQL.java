...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionParentApprovalPathRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionParentApprovalPathRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionParentApprovalPathRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionParentApprovalPathRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionParentApprovalPathRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
