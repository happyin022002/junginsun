...
*@FileName : SearchUserRoleInfoListVO.java
*@FileTitle : SearchUserRoleInfoListVO
*Open Issues :
*Change history :
...
public class SearchUserRoleInfoListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchUserRoleInfoListVO> models = new ArrayList<SearchUserRoleInfoListVO>();
	...
	public SearchUserRoleInfoListVO() {}

	public SearchUserRoleInfoListVO(String ibflag, String pagerows, String usrId, String usrNm, String usrLoclNm, String ofcCd, String usrRoleCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public SearchUserRoleInfoListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchUserRoleInfoListVO[]
	 */
	public SearchUserRoleInfoListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchUserRoleInfoListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchUserRoleInfoListVO();
				if (updDt[i] != null)
		...
		return getSearchUserRoleInfoListVOs();
	}
	...
	public SearchUserRoleInfoListVO[] getSearchUserRoleInfoListVOs(){
		SearchUserRoleInfoListVO[] vos = (SearchUserRoleInfoListVO[])models.toArray(new SearchUserRoleInfoListVO[models.size()]);
		return vos;
	}
