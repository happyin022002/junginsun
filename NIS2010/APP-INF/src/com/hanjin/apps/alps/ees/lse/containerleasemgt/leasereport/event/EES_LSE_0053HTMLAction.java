...
*@FileName : EES_LSE_0053HTMLAction.java
...
public class EES_LSE_0053HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0053HTMLAction 객체를 생성
	 */
	public EES_LSE_0053HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0053Event event = new EesLse0053Event();
