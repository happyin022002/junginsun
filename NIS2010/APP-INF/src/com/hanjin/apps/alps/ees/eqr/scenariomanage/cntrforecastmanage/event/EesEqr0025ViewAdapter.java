...
*@FileName : EesEqr0025ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EesEqr0025ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		EesEqr0025ConditionVO conditionVO = (EesEqr0025ConditionVO) commonRsVO.getConditionVO();
