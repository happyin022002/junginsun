...
*@FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSIssuedListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSIssuedListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSIssuedListRSQL(){
		setQuery();
		...
		query.append("FileName : EmptyReleaseRedeliveryOrderMgtDBDAOSearchFaxEmailReleaseRSIssuedListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Release - R,S - Issued */" ).append("\n"); 
		...
		query.append("AND TRSP_CRR_MOD_CD = @[mode_cd]" ).append("\n"); 
		query.append("AND EQ_TPSZ_CD = @[tp]" ).append("\n"); 
		query.append("AND FM_NOD_CD = @[empty_cy]" ).append("\n"); 
		query.append("/*********************************/" ).append("\n"); 
		query.append("#if (${type_cd} == 'R')" ).append("\n"); 
		query.append("AND CRE_OFC_CD = @[i_office]" ).append("\n"); 
		query.append("AND ORD.TRSP_COST_DTL_MOD_CD = 'ER'" ).append("\n"); 
		query.append("#elseif (${type_cd} == 'S')" ).append("\n"); 
		query.append("AND ORD.TRSP_COST_DTL_MOD_CD = 'CF'" ).append("\n"); 
		...
		query.append("/*********************************/" ).append("\n"); 
		query.append("AND TRSP_WO_OFC_CTY_CD IS NOT NULL" ).append("\n"); 
