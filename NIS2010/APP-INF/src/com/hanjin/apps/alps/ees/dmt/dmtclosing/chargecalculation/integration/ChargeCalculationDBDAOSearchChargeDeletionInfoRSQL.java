...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionInfoRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select  OFC_CD		as CHG_OFC_CD " ).append("\n"); 
		query.append("       ,(" ).append("\n"); 
		...
		query.append("	    )			as DELT_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
