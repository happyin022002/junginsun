...
*@FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd20QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd20QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC  테이블에 대한 HDL 20feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd20QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_hnd20QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
