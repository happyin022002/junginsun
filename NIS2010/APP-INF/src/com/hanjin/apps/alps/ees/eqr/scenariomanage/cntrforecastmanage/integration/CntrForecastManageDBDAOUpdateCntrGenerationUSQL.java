...
*@FileName : CntrForecastManageDBDAOUpdateCntrGenerationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOUpdateCntrGenerationUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrForecastManageDBDAOUpdateCntrGenerationUSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOUpdateCntrGenerationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
