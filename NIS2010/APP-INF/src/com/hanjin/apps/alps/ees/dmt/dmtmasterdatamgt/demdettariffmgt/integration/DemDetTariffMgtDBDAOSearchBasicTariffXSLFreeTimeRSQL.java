...
*@FileName : DemDetTariffMgtDBDAOSearchBasicTariffXSLFreeTimeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchBasicTariffXSLFreeTimeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchBasicTariffXSLFreeTimeRSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchBasicTariffXSLFreeTimeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        , FT_FM_QTY ||'-'|| DECODE(FT_TO_QTY, 0, '', FT_TO_QTY ) AS FREE_TIME" ).append("\n"); 
		...
		query.append("ORDER BY FT_FM_QTY" ).append("\n"); 
