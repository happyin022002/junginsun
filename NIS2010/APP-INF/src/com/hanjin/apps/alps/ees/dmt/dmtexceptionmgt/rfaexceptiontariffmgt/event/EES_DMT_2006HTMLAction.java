...
*@FileName : EES_DMT_2006HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.ees.dmt.dmtexceptionmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_DMT_2006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_2006HTMLAction 객체를 생성
	 */
	public EES_DMT_2006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt2006Event event = new EesDmt2006Event();
		
		//Request Detail 조회
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBeforeAfterStatusInputVO((BeforeAfterStatusInputVO)getVO(request, BeforeAfterStatusInputVO .class));
		}
