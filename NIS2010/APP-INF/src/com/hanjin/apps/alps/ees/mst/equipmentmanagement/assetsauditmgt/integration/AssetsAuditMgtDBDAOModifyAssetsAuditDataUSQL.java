...
*@FileName : AssetsAuditMgtDBDAOModifyAssetsAuditDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AssetsAuditMgtDBDAOModifyAssetsAuditDataUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyAssetsAuditData
	  * </pre>
	  */
	public AssetsAuditMgtDBDAOModifyAssetsAuditDataUSQL(){
		setQuery();
		...
		params.put("diff_rmk_m",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AssetsAuditMgtDBDAOModifyAssetsAuditDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MST_EQ_ASET_AUD" ).append("\n"); 
		query.append("SET" ).append("\n"); 
		query.append("DIFF_RMK = @[diff_rmk_m]" ).append("\n"); 
