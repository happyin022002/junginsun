...
public class MTYEquipmentForecastDBDAOsearchMtyBalanceReferenceListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          ,TO_CHAR(TO_DATE(A.WK_ST_DT , 'YYYYMMDD') -27 -X.REPO_ADD_DYS, 'YYYYMMDD') WK_ST_DT" ).append("\n"); 
		query.append("          ,TO_CHAR(TO_DATE(A.WK_END_DT, 'YYYYMMDD') -13 -X.REPO_ADD_DYS, 'YYYYMMDD') WK_END_DT" ).append("\n"); 
		...
		query.append("      ,TO_CHAR(A.R9_FCAST_QTY,'9,999,999') R9_FCAST_QTY" ).append("\n"); 
		...
		query.append("      ,TO_CHAR(A.O5_FCAST_QTY,'9,999,999') O5_FCAST_QTY  " ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("    SELECT A.DP_SEQ" ).append("\n"); 
		query.append("          ,A.TITLE" ).append("\n"); 
		...
		query.append("          ,A.R9_QTY   R9_FCAST_QTY" ).append("\n"); 
		...
		query.append("          ,A.O5_QTY   O5_FCAST_QTY" ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("    (  " ).append("\n"); 
		query.append("    #if (${search_flag} == '1')" ).append("\n"); 
		query.append("        ----Sound MT,Damage MT" ).append("\n"); 
		query.append("        SELECT B.DP_SEQ" ).append("\n"); 
		...
		query.append("        FROM " ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("            SELECT DECODE(A.DMG_FLG,'N',1,2) DP_SEQ,A.CNTR_TPSZ_CD,CNTR_QTY" ).append("\n"); 
		query.append("            FROM  CIM_ETC_INVT A" ).append("\n"); 
		query.append("            WHERE A.CO_CD           = 'H'" ).append("\n"); 
		query.append("            AND   A.INVT_USE_TP_CD  = '3'" ).append("\n"); 
		...
		query.append("                    SUM(DECODE(A.CNTR_TPSZ_CD,'R9',DECODE(B.DP_SEQ,1,IB_QTY,2,FS_IB_QTY,3,OB_QTY,4,FS_OB_QTY),0)) R9_QTY," ).append("\n"); 
		...
		query.append("                    SUM(DECODE(A.CNTR_TPSZ_CD,'O5',DECODE(B.DP_SEQ,1,IB_QTY,2,FS_IB_QTY,3,OB_QTY,4,FS_OB_QTY),0)) O5_QTY" ).append("\n"); 
		query.append("            FROM " ).append("\n"); 
		query.append("            (" ).append("\n"); 
		...
		query.append("                FROM CIM_LOC_MTCH_BAK_SMRY A" ).append("\n"); 
		query.append("                    ,LV_DUMMY_WEEK B " ).append("\n"); 
		...
		query.append("                AND   A.TN_ROUT_FLG = 'N'" ).append("\n"); 
		...
		query.append("               ROUND(SUM(R9_QTY)/3) R9_QTY," ).append("\n"); 
		...
		query.append("               ROUND(SUM(O5_QTY)/3) O5_QTY" ).append("\n"); 
		query.append("        FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		...
		query.append("                   SUM(A.R9_FCAST_QTY) R9_QTY," ).append("\n"); 
		...
		query.append("                   SUM(A.O5_FCAST_QTY) O5_QTY" ).append("\n"); 
		...
		query.append("                   NVL(SUM(DECODE(A.CNTR_TPSZ_CD,'R9',QTY,0)),0) R9_QTY," ).append("\n"); 
		...
		query.append("                   NVL(SUM(DECODE(A.CNTR_TPSZ_CD,'O5',QTY,0)),0) O5_QTY" ).append("\n"); 
		query.append("            FROM" ).append("\n"); 
		query.append("            (" ).append("\n"); 
		query.append("                SELECT DECODE(SIGN(F.WK_END_DT1 - TRUNC(A.ESTM_DT)),-1,6,5) DP_SEQ," ).append("\n"); 
		...
		query.append("                              CIM_MTY_GEN_TURN_TM G1," ).append("\n"); 
		query.append("                              CIM_MTY_GEN_TURN_TM G2" ).append("\n"); 
		...
		query.append("                  ,ROUND(SUM(A.D2_QTY)/3, 0) D2_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.D4_QTY)/3, 0) D4_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.D5_QTY)/3, 0) D5_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.D7_QTY)/3, 0) D7_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.R2_QTY)/3, 0) R2_QTY  " ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.R5_QTY)/3, 0) R5_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.R9_QTY)/3, 0) R9_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.O2_QTY)/3, 0) O2_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.S2_QTY)/3, 0) S2_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.O4_QTY)/3, 0) O4_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.S4_QTY)/3, 0) S4_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.F2_QTY)/3, 0) F2_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.A2_QTY)/3, 0) A2_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.F4_QTY)/3, 0) F4_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.A4_QTY)/3, 0) A4_QTY" ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.F5_QTY)/3, 0) F5_QTY   " ).append("\n"); 
		query.append("                  ,ROUND(SUM(A.O5_QTY)/3, 0) O5_QTY   " ).append("\n"); 
		query.append("            FROM " ).append("\n"); 
		query.append("            (      " ).append("\n"); 
		query.append("              " ).append("\n"); 
		...
		query.append("                (" ).append("\n"); 
		query.append("                    SELECT VSL_CD, SKD_VOY_NO, SKD_DIR_CD,SLAN_CD,VPS_PORT_CD,YD_CD, VPS_ETB_DT, X.SEQ" ).append("\n"); 
		query.append("                    FROM VSK_VSL_PORT_SKD" ).append("\n"); 
		query.append("                        ,REPO_IN_WEEK X" ).append("\n"); 
		query.append("                    WHERE VPS_PORT_CD IN (" ).append("\n"); 
		...
		query.append("                                                             )" ).append("\n"); 
		query.append("                                         )" ).append("\n"); 
		query.append("                    AND   VPS_ETB_DT BETWEEN TO_DATE(X.WK_ST_DT, 'YYYYMMDD') AND TO_DATE(X.WK_END_DT, 'YYYYMMDD')+0.99999                 " ).append("\n"); 
		...
		query.append("                               ,VPS_ETB_DT ETB_DT" ).append("\n"); 
		...
		query.append("                 ,LV_DUMMY_WEEK B" ).append("\n"); 
		query.append("                 ,LV_YD_LIST C" ).append("\n"); 
		...
		query.append("        ) A" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("        -- REPO OUT (2012.05.23 신용찬 [CHM-201217713] Balance Report 기능 Logic 수정)" ).append("\n"); 
		query.append("        UNION ALL" ).append("\n"); 
		...
		query.append("        FROM " ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("            SELECT NVL(SUM(B.D2_FCAST_QTY)/3,0) D2_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.D4_FCAST_QTY)/3,0) D4_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.D5_FCAST_QTY)/3,0) D5_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.D7_FCAST_QTY)/3,0) D7_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.R2_FCAST_QTY)/3,0) R2_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.R5_FCAST_QTY)/3,0) R5_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.R9_FCAST_QTY)/3,0) R9_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.O2_FCAST_QTY)/3,0) O2_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.S2_FCAST_QTY)/3,0) S2_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.O4_FCAST_QTY)/3,0) O4_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.S4_FCAST_QTY)/3,0) S4_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.F2_FCAST_QTY)/3,0) F2_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.A2_FCAST_QTY)/3,0) A2_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.F4_FCAST_QTY)/3,0) F4_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.A4_FCAST_QTY)/3,0) A4_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.F5_FCAST_QTY)/3,0) F5_QTY" ).append("\n"); 
		query.append("                  ,NVL(SUM(B.O5_FCAST_QTY)/3,0) O5_QTY" ).append("\n"); 
		query.append("            FROM LV_YD_LIST Y" ).append("\n"); 
		query.append("                ,EQR_MTY_BAL_RPT_REPO_OUT B " ).append("\n"); 
		query.append("                ,(" ).append("\n"); 
		query.append("                     SELECT TO_DATE(A.WK_ST_DT,'YYYYMMDD') -27 WK_ST_DT," ).append("\n"); 
		query.append("                            TO_DATE(A.WK_END_DT,'YYYYMMDD')-13 WK_END_DT" ).append("\n"); 
		query.append("                     FROM EQR_WK_PRD A" ).append("\n"); 
		query.append("                     WHERE A.PLN_YR = SUBSTR(@[fcast_yrwk],1,4)" ).append("\n"); 
		query.append("                     AND   A.PLN_WK = SUBSTR(@[fcast_yrwk],5)" ).append("\n"); 
		query.append("                 ) C" ).append("\n"); 
		query.append("            WHERE B.FM_ETD_DT BETWEEN C.WK_ST_DT AND C.WK_END_DT+0.99999" ).append("\n"); 
		query.append("            AND   Y.YD_CD         = B.FM_YD_CD" ).append("\n"); 
		query.append("            AND   B.LOC_GRP_CD(+) = @[loc_grp_cd]  -- E:ECC, L:LCC, S:SCC (2012-05-22, ADDED BY SHIN YONGCHAN, CHM-201217713)           " ).append("\n"); 
		query.append("        ) A" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
