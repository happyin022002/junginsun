...
*@FileName : EES_DMT_4014HTMLAction.java
*@FileTitle : Basic Tariff Creation
*Open Issues :
*Change history :
*@LastModifyDate : 2009. 6. 4.
*@LastModifier : 김태균
*@LastVersion : 1.0
* 2009. 6. 4. 김태균
* 1.0 Creation
 ...
 * @since J2EE 1.4
 */
public class EES_DMT_4014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_1003HTMLAction 객체를 생성
	 */
	public EES_DMT_4014HTMLAction() {}


	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EesDmt4014Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt4014Event event = new EesDmt4014Event();
        log.debug("::CALL::> EES_DMT_4014HTMLAction - " + command.getCommand());
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setBasicTarriffVOs((BasicTariffVO[])getVOs(request, BasicTariffVO.class ));
		}
