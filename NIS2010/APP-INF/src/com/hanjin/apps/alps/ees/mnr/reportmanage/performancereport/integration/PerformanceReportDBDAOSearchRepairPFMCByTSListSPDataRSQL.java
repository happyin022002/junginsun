...
*@FileName : PerformanceReportDBDAOSearchRepairPFMCByTSListSPDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceReportDBDAOSearchRepairPFMCByTSListSPDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchRepairPFMCByTSListSPData
	  * </pre>
	  */
	public PerformanceReportDBDAOSearchRepairPFMCByTSListSPDataRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceReportDBDAOSearchRepairPFMCByTSListSPDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                        WHERE 1=1" ).append("\n"); 
		query.append("						#if (${eq_type} != 'A' && ${eq_type} != 'A,U,Z,G')" ).append("\n"); 
		query.append("							AND	A.EQ_KND_CD IN (" ).append("\n"); 
		query.append("								#foreach ($user_eqTypes IN ${eqTypes})" ).append("\n"); 
		query.append("									#if($velocityCount < $eqTypes.size())" ).append("\n"); 
		query.append("										'$user_eqTypes'," ).append("\n"); 
		query.append("									#else" ).append("\n"); 
		...
		query.append("       OH.COST_OFC_CD OFC_CD,     " ).append("\n"); 
		query.append("       OH.VNDR_SEQ SP_CD," ).append("\n"); 
		query.append("       MAX((SELECT MV.VNDR_LGL_ENG_NM FROM MDM_VENDOR MV WHERE MV.VNDR_SEQ = OH.VNDR_SEQ AND ROWNUM =1)) SP_NM," ).append("\n"); 
		query.append("       DECODE(@[curr_cd],'Y','USD',MAX(OH.CURR_CD)) AS CURR_CD,         " ).append("\n"); 
		query.append("       C.DCOL DCOL,        " ).append("\n"); 
		...
		query.append("            SUM(DECODE(P.TS01, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS01, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS02, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS02, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS03, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS03, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS04, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS04, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS05, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS05, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS06, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS06, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS07, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS07, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS08, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS08, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS09, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS09, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS10, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS10, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS11, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS11, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS12, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS12, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS13, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS13, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS14, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS14, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS15, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS15, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS16, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS16, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS17, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS17, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS18, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS18, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS19, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS19, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS20, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS20, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS21, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS21, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS22, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS22, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS23, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS23, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS24, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS24, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS25, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS25, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS26, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS26, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS27, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS27, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS28, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS28, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS29, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS29, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("       WHEN C.DCOL = 'S' THEN " ).append("\n"); 
		query.append("            SUM(DECODE(P.TS30, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		query.append("       WHEN C.DCOL = 'Z' THEN " ).append("\n"); 
		query.append("            ROUND(SUM(DECODE(P.TS30, OD.EQ_TPSZ_CD, MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(OH.CRE_DT, 'YYYYMM'), OH.CURR_CD, DECODE(@[curr_cd],'Y','USD',OH.CURR_CD), OD.COST_AMT)))" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${eq_type} != 'A' && ${eq_type} != 'A,U,Z,G') " ).append("\n"); 
		query.append("AND OH.EQ_KND_CD IN (" ).append("\n"); 
		query.append("	#foreach ($user_eqTypes IN ${eqTypes})" ).append("\n"); 
		query.append("		#if($velocityCount < $eqTypes.size())" ).append("\n"); 
		query.append("			'$user_eqTypes'," ).append("\n"); 
		query.append("		#else" ).append("\n"); 
		...
		query.append("AND   OH.VNDR_SEQ   = TO_NUMBER(@[vndr_seq])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if ((${manu_yr_fr} != '' && ${manu_yr_to} != '') || ${lstm_cd} != 'A' || ${mkr_nm} != 'A') " ).append("\n"); 
		...
		query.append("ORDER BY MAX(MNR_COMMON_PKG.MNR_GET_RHQ_OFC_FNC(OH.COST_OFC_CD)), OH.COST_OFC_CD, OH.VNDR_SEQ, C.DCOL" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("    RSV.RHQ, RSV.OFC_CD, MNR_COMMON_PKG.MNR_CONV_PARTNER_CD_FNC(RSV.SP_CD) AS SP_CD, RSV.SP_NM, RSV.CURR_CD, RSV.DCOL," ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("    SELECT" ).append("\n"); 
		query.append("    'AAA' AS RHQ, 'OFFICE' AS OFC_CD, 0 AS SP_CD, '' AS SP_NM, '' AS CURR_CD," ).append("\n"); 
		query.append("                        '' AS DCOL, '0' AS DCOL2," ).append("\n"); 
		...
		query.append("    UNION ALL" ).append("\n"); 
		query.append("    SELECT A.RHQ ,A.OFC_CD, A.SP_CD, A.SP_NM, A.CURR_CD, " ).append("\n"); 
		query.append("         DECODE(DCOL, 'Q', 'QTY', 'S', 'AMT', 'Z', 'AVG') DCOL," ).append("\n"); 
		...
		query.append("ORDER BY RSV.RHQ, RSV.OFC_CD, RSV.SP_CD, RSV.DCOL2" ).append("\n"); 
