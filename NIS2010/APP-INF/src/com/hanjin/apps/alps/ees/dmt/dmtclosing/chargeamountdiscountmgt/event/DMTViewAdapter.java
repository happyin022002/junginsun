	...
	private String[] initRealColNames(Object obj) {
		...
		if (obj instanceof AfterBKGListVO) {
			...
			return new String[]{"ibflag",			"Seq",				"dmdt_chg_sts_cd",		"dmdt_ar_if_cd",	"cntr_no",
								"cntr_tpsz_cd",		"ofc_cd",			"fm_mvmt_yd_cd",		"chg_seq_desc",	    "ft_dys",	   "fx_ft_ovr_dys",
								"bzc_trf_curr_cd",	"bil_amt",			"aft_expt_dc_amt",      "bil_aft_dc_amt",   "ft_adj_flg",  "ft_add_dys",
