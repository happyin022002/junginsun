...
public class InvoiceIssueCollectionMgtDBDAOSearchInvoiceDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        , NVL(D.BZC_DMDT_DE_TERM_CD, 'N')       AS BZC_DMDT_DE_TERM_CD" ).append("\n"); 
		...
		query.append("        , TO_CHAR(D.BZC_TRF_APLY_DT    , 'YYYY-MM-DD')    AS BZC_TRF_APLY_DT" ).append("\n"); 
		query.append("        , TO_CHAR(D.SC_RFA_EXPT_APLY_DT, 'YYYY-MM-DD')    AS SC_RFA_EXPT_APLY_DT" ).append("\n"); 
		query.append("		, B.BIL_AMT*INV_XCH_RT AS UNCOL_AMT" ).append("\n"); 
