...
public class MtyWeeklySimulationOptionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyWeeklySimulationOptionVO> models = new ArrayList<MtyWeeklySimulationOptionVO>();
...
/**
	 ...
	 */
	public MtyWeeklySimulationOptionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyWeeklySimulationOptionVO[]
	 */
	public MtyWeeklySimulationOptionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyWeeklySimulationOptionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MtyWeeklySimulationOptionVO();
				if (cntrTpsz[i] != null)
	...
	public MtyWeeklySimulationOptionVO[] getMtyWeeklySimulationOptionVOs(){
		MtyWeeklySimulationOptionVO[] vos = (MtyWeeklySimulationOptionVO[])models.toArray(new MtyWeeklySimulationOptionVO[models.size()]);
		return vos;
	}
