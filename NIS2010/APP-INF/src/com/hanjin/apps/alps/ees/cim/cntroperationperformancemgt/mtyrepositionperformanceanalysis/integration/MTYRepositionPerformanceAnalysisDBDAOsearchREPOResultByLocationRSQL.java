...
public class MTYRepositionPerformanceAnalysisDBDAOsearchREPOResultByLocationRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			#end" ).append("\n"); 
		query.append("			#if (${company} == 'H') " ).append("\n"); 
		query.append("			AND		T.MVMT_CO_CD			IN ( 'H', 'S' )			/* company */	/* 주의요 !!!! */" ).append("\n"); 
		query.append("			#elseif (${company} == 'L') " ).append("\n"); 
		query.append("			AND		T.MVMT_CO_CD			IN ( 'L' )				/* company */	/* 주의요 !!!! */" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("			#if (${inquirylevel} == 'L')" ).append("\n"); 
