...
*@FileName : DMTCalculationDBDAOSearchDualTypeExceptionBySCRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCalculationDBDAOSearchDualTypeExceptionBySCRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchDualTypeExceptionBySC
	  * </pre>
	  */
	public DMTCalculationDBDAOSearchDualTypeExceptionBySCRSQL(){
		setQuery();
		...
		query.append("FileName : DMTCalculationDBDAOSearchDualTypeExceptionBySCRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  FROM     DMT_DUL_TP_EXPT C" ).append("\n"); 
		...
		query.append("            	   AND     NVL(DMDT_CNTR_CGO_TP_CD, @[cntr_cgo_tp])	= @[cntr_cgo_tp]" ).append("\n"); 
		query.append("            	   AND     IO_BND_CD       		=   @[io_bnd_cd]" ).append("\n"); 
		query.append("            	   AND     DMDT_CTRT_EXPT_TP_CD =   'S'" ).append("\n"); 
		...
		query.append("	#end	" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("		   AND ( PROP_NO = ( SELECT PROP_NO FROM PRI_SP_HDR WHERE SC_NO = @[sc_no] ) OR PROP_NO IS NULL )" ).append("\n"); 
