...
*@FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSLostDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetOnOffhireDBDAOmodifyCHSLostDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMgsetOnOffhireDBDAOmodifyCHSLostDataUSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetOnOffhireDBDAOmodifyCHSLostDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",CRNT_YD_CD   = @[l_evnt_yd_cd]" ).append("\n"); 
		query.append(",CRNT_LOC_CD  = SUBSTR(@[l_evnt_yd_cd],0,5)" ).append("\n"); 
		query.append(",CHSS_MVMT_DT = TO_DATE(@[l_evnt_dt] ,'YYYY-MM-DD HH24:MI:SS')" ).append("\n"); 
		query.append(",GATE_IO_CD = 'O'" ).append("\n"); 
