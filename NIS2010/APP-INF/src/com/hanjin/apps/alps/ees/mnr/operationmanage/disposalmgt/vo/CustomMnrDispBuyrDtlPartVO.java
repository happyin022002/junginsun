...
public class CustomMnrDispBuyrDtlPartVO extends AbstractValueObject {
	...
	/* Column Info */
	private String vndrBidTms = null;
	/* Column Info */
	...
	public CustomMnrDispBuyrDtlPartVO(String ibflag, String pagerows, String updDt, String partUtAmt, String vndrBidTms, String dispNo, String mnrDispCfmStsCd, String mnrDispDtlRmk, String confirmSt, String vndrLglEngNm, String creDt, String mnrPrnrCntCd, String dispQty, String dispCfmQty, String dispDtlSeq, String eqTpszCd, String mnrPrnrSeq, String creUsrId, String dispUtTpCd, String mnrDispCfmUsrId, String updUsrId, String mnrDispCfmDt, String mnrPrnrId) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vndr_bid_tms", getVndrBidTms());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("vndr_bid_tms", "vndrBidTms");
	 ...
	 * @return vndrBidTms
	 */
	public String getVndrBidTms() {
		return this.vndrBidTms;
	}
	 ...
	 * @param vndrBidTms
	 */
	public void setVndrBidTms(String vndrBidTms) {
		this.vndrBidTms = vndrBidTms;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMnrDispCfmStsCd(JSPUtil.getParameter(request, prefix + "mnr_disp_cfm_sts_cd", ""));
		setMnrDispDtlRmk(JSPUtil.getParameter(request, prefix + "mnr_disp_dtl_rmk", ""));
		setConfirmSt(JSPUtil.getParameter(request, prefix + "confirm_st", ""));
		...
		setMnrDispCfmUsrId(JSPUtil.getParameter(request, prefix + "mnr_disp_cfm_usr_id", ""));
		setUpdUsrId(JSPUtil.getParameter(request, prefix + "upd_usr_id", ""));
		setVndrBidTms(JSPUtil.getParameter(request, prefix + "vndr_bid_tms", ""));
		setMnrPrnrId(JSPUtil.getParameter(request, prefix + "mnr_prnr_id", ""));
		setMnrDispCfmDt(JSPUtil.getParameter(request, prefix + "mnr_disp_cfm_dt", ""));
	}
	...
	public CustomMnrDispBuyrDtlPartVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] vndrBidTms = (JSPUtil.getParameter(request, prefix	+ "vndr_bid_tms", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (vndrBidTms[i] != null)
					model.setVndrBidTms(vndrBidTms[i]);
				if (mnrPrnrId[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.vndrBidTms = this.vndrBidTms .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
