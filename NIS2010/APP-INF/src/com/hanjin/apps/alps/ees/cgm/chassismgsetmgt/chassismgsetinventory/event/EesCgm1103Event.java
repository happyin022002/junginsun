...
public class EesCgm1103Event extends EventSupport {
	...
	public CHSInventoryByVariationDtlMGTVO[] getCHSInventoryByVariationDtlMGTVOs() {
		return cHSInventoryByVariationDtlMGTVOs;
	}

	public void setCHSInventoryByVariationDtlMGTVOs(
			CHSInventoryByVariationDtlMGTVO[] inventoryByVariationDtlMGTVOs) {
		cHSInventoryByVariationDtlMGTVOs = inventoryByVariationDtlMGTVOs;
	}
