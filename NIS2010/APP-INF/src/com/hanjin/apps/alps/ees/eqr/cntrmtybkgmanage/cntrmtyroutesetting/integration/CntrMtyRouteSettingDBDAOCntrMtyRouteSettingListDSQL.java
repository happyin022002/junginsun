...
*@FileName : CntrMtyRouteSettingDBDAOCntrMtyRouteSettingListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrMtyRouteSettingDBDAOCntrMtyRouteSettingListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrMtyRouteSettingDBDAOCntrMtyRouteSettingListDSQL(){
		setQuery();
		...
		query.append("FileName : CntrMtyRouteSettingDBDAOCntrMtyRouteSettingListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EQR_CTRL_ROUT_SET" ).append("\n"); 
