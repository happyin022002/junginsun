...
*@FileName : TariffMgtDBDAOcheckDisposalTariffHeaderDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TariffMgtDBDAOcheckDisposalTariffHeaderDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TariffMgtDBDAOcheckDisposalTariffHeaderDataRSQL(){
		setQuery();
		...
		query.append("FileName : TariffMgtDBDAOcheckDisposalTariffHeaderDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(A.MNR_DISP_TRF_SEQ) CNT" ).append("\n"); 
