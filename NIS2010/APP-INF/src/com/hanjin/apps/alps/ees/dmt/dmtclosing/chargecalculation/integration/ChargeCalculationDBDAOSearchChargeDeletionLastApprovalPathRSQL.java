...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionLastApprovalPathRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionLastApprovalPathRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionLastApprovalPathRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionLastApprovalPathRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionLastApprovalPathRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("					select  CHG_DELT_PATH_LVL" ).append("\n"); 
		...
		query.append("				 ) >= " ).append("\n"); 
		query.append("				 (" ).append("\n"); 
		query.append("					select  nvl(max(CHG_DELT_PATH_LVL), 1)" ).append("\n"); 
		query.append("					  from  DMT_CHG_DELT_PATH  T1" ).append("\n"); 
		query.append("					 where  T1.SYS_AREA_GRP_ID         = @[svr_id]" ).append("\n"); 
		query.append("					   and  T1.CNTR_NO        	       = @[cntr_no]" ).append("\n"); 
		query.append("					   and  T1.CNTR_CYC_NO 		       = to_number(@[cntr_cyc_no])" ).append("\n"); 
		...
		query.append("					   and  T1.CHG_OFC_CD 		       = @[ofc_cd]" ).append("\n"); 
		query.append("					   and  T1.DELT_SEQ 		       = to_number(@[delt_seq])" ).append("\n"); 
		query.append("                       and  T1.CHG_DELT_PATH_CPLS_FLG  = 'Y'" ).append("\n"); 
		query.append("				 ) " ).append("\n"); 
