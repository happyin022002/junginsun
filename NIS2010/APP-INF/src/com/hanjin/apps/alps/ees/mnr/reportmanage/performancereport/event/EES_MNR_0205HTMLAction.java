...
*@FileName : EES_MNR_0205HTMLAction.java
...
public class EES_MNR_0205HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0205HTMLAction 객체를 생성
	 */
	public EES_MNR_0205HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0205Event event = new EesMnr0205Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTireReplacementINVO((TireReplacementINVO)getVO(request, TireReplacementINVO .class));
		}
