...
public class EES_CGM_1154HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1154HTMLAction 객체를 생성
	 */
	public EES_CGM_1154HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1154Event event = new EesCgm1154Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsAssetsSmryVO((CHSAssetsSmryVO)getVO(request, CHSAssetsSmryVO .class));
		}
