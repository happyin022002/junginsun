...
*@FileName : MTYEquipmentForecastDBDAOsearchMtyRepoInDetailListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYEquipmentForecastDBDAOsearchMtyRepoInDetailListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYEquipmentForecastDBDAOsearchMtyRepoInDetailListRSQL(){
		setQuery();
		...
		query.append("FileName : MTYEquipmentForecastDBDAOsearchMtyRepoInDetailListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    -- REPO IN DETAIL(EES_EQR_5009에서 수기입력)" ).append("\n"); 
		...
		query.append("            AND	  B.VSL_CD			= R.VSL_CD  (+)" ).append("\n"); 
		query.append("            AND	  B.SKD_VOY_NO		= R.SKD_VOY_NO (+)" ).append("\n"); 
		query.append("            AND	  B.SKD_DIR_CD		= R.SKD_DIR_CD (+)" ).append("\n"); 
		query.append("            AND	  'I'           	= R.COD_CFM_DIV_CD (+)    " ).append("\n"); 
		query.append("            GROUP BY A.VSL_CD" ).append("\n"); 
		query.append("                    ,A.SKD_VOY_NO" ).append("\n"); 
		query.append("                    ,A.SKD_DIR_CD" ).append("\n"); 
		query.append("                    ,B.SLAN_CD" ).append("\n"); 
		...
		query.append("                    ,R.DIFF_RMK" ).append("\n"); 
		query.append("                                " ).append("\n"); 
		query.append("            UNION ALL            " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("    " ).append("\n"); 
		query.append(") " ).append("\n"); 
		query.append("--ORDER BY LVL ASC , CRE_SEQ DESC, TO_ETB_DT ASC" ).append("\n"); 
