...
/**
 * ALPS PoolChassisHistoryDBDAO <br>
...
public class PoolChassisHistoryDBDAO extends DBDAOSupport {
	...
	/**
	 * Pool movement & SML Movement 비교, match/unmatch summary  정보 조회  [EES_CGM_1142]  <br>
	 * 
	...
	/**
	 * Pool movement & SML Movement 비교, match/unmatch summary 조회 조회 [EES_CGM_1141] <br>
	 * 
	 * @param poolMvmtINVO PoolMvmtINVO 
	 * @return List<PoolMvmtCompareSmryMGTVO>
	 * @exception DAOException
