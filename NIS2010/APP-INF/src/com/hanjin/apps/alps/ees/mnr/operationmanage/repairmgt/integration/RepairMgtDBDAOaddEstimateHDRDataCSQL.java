...
public class RepairMgtDBDAOaddEstimateHDRDataCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       , @[mnr_inp_tp_cd]" ).append("\n"); 
		query.append("       , @[cost_ofc_cd]" ).append("\n"); 
		query.append("       , ( SELECT NVL(MAX(EM.RQST_DT),SYSDATE) FROM MNR_RPR_RQST_HDR EM WHERE EM.RQST_EQ_NO = @[rqst_eq_no] AND EM.RPR_RQST_SEQ = @[rpr_rqst_seq] )" ).append("\n"); 
		query.append("       , @[rqst_usr_id]" ).append("\n"); 
		query.append("       , @[mnr_meas_ut_cd]" ).append("\n"); 
		query.append("       , @[apro_ofc_cd]" ).append("\n"); 
		...
		query.append("         END AS MNR_WARR_FLG" ).append("\n"); 
		query.append("       , CASE WHEN @[rpr_rqst_ver_no] = '1' THEN" ).append("\n"); 
		query.append("                   (" ).append("\n"); 
		query.append("                     SELECT   CASE WHEN COUNT(1) > 0 THEN 'Y' ELSE 'N' END" ).append("\n"); 
		query.append("                     FROM     MNR_RPR_RQST_HDR EM" ).append("\n"); 
		query.append("                     WHERE    1 = 1" ).append("\n"); 
		query.append("                     AND      EM.RQST_EQ_NO = @[rqst_eq_no]" ).append("\n"); 
		query.append("                     AND      EM.RPR_RQST_SEQ < @[rpr_rqst_seq]" ).append("\n"); 
		query.append("                     AND      EM.VNDR_SEQ = @[vndr_seq]" ).append("\n"); 
		query.append("                     AND      EM.RPR_RQST_LST_VER_FLG = 'Y'" ).append("\n"); 
		query.append("                     AND      EM.RPR_STS_CD <> 'HD'" ).append("\n"); 
		query.append("                     AND      EM.RQST_DT >= TRUNC(SYSDATE) - 45" ).append("\n"); 
		query.append("                     AND      ROWNUM = 1" ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		query.append("              ELSE" ).append("\n"); 
		query.append("                   (" ).append("\n"); 
		query.append("                     SELECT   NVL(MAX(EM.RCT_RPR_FLG),'N')" ).append("\n"); 
		query.append("                     FROM     MNR_RPR_RQST_HDR EM" ).append("\n"); 
		query.append("                     WHERE    1 = 1" ).append("\n"); 
		query.append("                     AND      EM.RQST_EQ_NO = @[rqst_eq_no]" ).append("\n"); 
		query.append("                     AND      EM.RPR_RQST_SEQ = @[rpr_rqst_seq]" ).append("\n"); 
		query.append("                   )" ).append("\n"); 
		query.append("         END AS RCT_RPR_FLG" ).append("\n"); 
		query.append("       , @[vrfy_rslt_rmk]" ).append("\n"); 
		query.append("       , @[cre_usr_id]" ).append("\n"); 
		...
		query.append("WHERE    1 = 1" ).append("\n"); 
		query.append("AND      EQ_NO = @[rqst_eq_no]" ).append("\n"); 
