...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionCommodityOfPrevVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionCommodityOfPrevVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 이전 버전의 모든 S/C Exception Tariff Commodity 정보를 신규 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionCommodityOfPrevVersionCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionCommodityOfPrevVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
