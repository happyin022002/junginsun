...
*@FileName : EesEqr1049ConditionVO.java
*@FileTitle : EesEqr1049ConditionVO
*Open Issues :
*Change history :
...
public class EesEqr1049ConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EesEqr1049ConditionVO> models = new ArrayList<EesEqr1049ConditionVO>();
	...
	public EesEqr1049ConditionVO() {}

	public EesEqr1049ConditionVO(String ibflag, String pagerows, String searchFlag, String repoFlag, String fcastYrwk, String locCd, String locGrpCd, String inpYrwk, String tpCd, String repoPlnYrwk, String wkStDt, String wkEndDt, String currFlag, String yard) {
...
/**
	 ...
	 */
	public EesEqr1049ConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EesEqr1049ConditionVO[]
	 */
	public EesEqr1049ConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EesEqr1049ConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EesEqr1049ConditionVO();
		...
		return getEesEqr1049ConditionVOs();
	}
	...
	public EesEqr1049ConditionVO[] getEesEqr1049ConditionVOs(){
		EesEqr1049ConditionVO[] vos = (EesEqr1049ConditionVO[])models.toArray(new EesEqr1049ConditionVO[models.size()]);
		return vos;
	}
