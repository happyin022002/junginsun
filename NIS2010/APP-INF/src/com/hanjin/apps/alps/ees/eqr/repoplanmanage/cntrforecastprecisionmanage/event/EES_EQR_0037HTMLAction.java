...
*@FileName : EES_EQR_0037HTMLAction.java
...
public class EES_EQR_0037HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0037HTMLAction 객체를 생성
	 */
	public EES_EQR_0037HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0037Event event = new EesEqr0037Event();
		
		// Retrieve 버튼 클릭시
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setEesEqr0037ConditionVO((EesEqr0037ConditionVO)getVO(request, EesEqr0037ConditionVO .class));
		}
