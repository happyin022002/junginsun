...
*@FileName : EES_MNR_0120HTMLAction.java
...
public class EES_MNR_0120HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0120HTMLAction 객체를 생성
	 */
	public EES_MNR_0120HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0120Event event = new EesMnr0120Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRepairPFMCBySPINVO((RepairPFMCBySPINVO)getVO(request, RepairPFMCBySPINVO .class));
		}
