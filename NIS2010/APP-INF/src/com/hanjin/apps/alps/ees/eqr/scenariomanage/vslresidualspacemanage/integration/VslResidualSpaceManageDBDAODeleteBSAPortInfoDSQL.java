...
*@FileName : VslResidualSpaceManageDBDAODeleteBSAPortInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VslResidualSpaceManageDBDAODeleteBSAPortInfoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_BSA_PORT 테이블 삭제
	  * </pre>
	  */
	public VslResidualSpaceManageDBDAODeleteBSAPortInfoDSQL(){
		setQuery();
		...
		query.append("FileName : VslResidualSpaceManageDBDAODeleteBSAPortInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
