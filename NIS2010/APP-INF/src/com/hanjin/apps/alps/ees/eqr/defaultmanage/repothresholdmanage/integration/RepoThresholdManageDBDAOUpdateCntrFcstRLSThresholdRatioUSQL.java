...
*@FileName : RepoThresholdManageDBDAOUpdateCntrFcstRLSThresholdRatioUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepoThresholdManageDBDAOUpdateCntrFcstRLSThresholdRatioUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_OB_FCAST_RED_LGT_ALT 테이블에 ratio 수정
	  * </pre>
	  */
	public RepoThresholdManageDBDAOUpdateCntrFcstRLSThresholdRatioUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("RLA_RTO          = @[rla_qty]," ).append("\n"); 
		...
		query.append("FileName : RepoThresholdManageDBDAOUpdateCntrFcstRLSThresholdRatioUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}