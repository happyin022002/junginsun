...
*@FileName : EES_EQR_6002HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.ees.eqr.eqtransportplannperform 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_EQR_6002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_6002HTMLAction 객체를 생성
	 */
	public EES_EQR_6002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr6002Event event = new EesEqr6002Event();
