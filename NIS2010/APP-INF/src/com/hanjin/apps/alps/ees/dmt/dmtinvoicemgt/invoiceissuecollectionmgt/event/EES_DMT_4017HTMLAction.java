...
*@FileName : EES_DMT_4017HTMLAction.java
...
public class EES_DMT_4017HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt4017Event event = new EesDmt4017Event();
        ...
        if(command.isCommand(FormCommand.SEARCH)) {
            ...
            event.setOtsInquiryParmVO((OtsInquiryParmVO)getVO(request, OtsInquiryParmVO .class));
            OTSCleanListVO[] oTSCleanListVOs = (OTSCleanListVO[]) getVOs(request, OTSCleanListVO.class, "");
            event.setoTSCleanListVOs(oTSCleanListVOs);
        }
