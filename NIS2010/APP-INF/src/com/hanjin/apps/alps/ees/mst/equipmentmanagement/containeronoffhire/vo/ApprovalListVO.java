...
public class ApprovalListVO extends AbstractValueObject {
	...
	public ApprovalListVO(String ibflag, String pagerows, String cntrOnhAuthNo, String cntrTpszCd, String newVanTpCd, String onhQty, String pickQty, String pkupDueDt, String minOnhDys, String pkupChgAmt, String pkupChgCrAmt, String liftOnChg, String freeDys, String lonChg, String cntrSpecNo, String dol, String ecc, String balance) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dol", getDol());
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDol(JSPUtil.getParameter(request, "dol", ""));
	...
	public ApprovalListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dol = (JSPUtil.getParameter(request, prefix	+ "dol", length));
	...
	*/
	public void unDataFormat(){
		...
		this.dol = this.dol .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
