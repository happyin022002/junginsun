...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.ees.ctm.restuffingmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0458HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_04HTMLAction 객체를 생성
	 */
	public EES_CTM_0458HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0458Event event = new EesCtm0458Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBookingQTY((BookingQTYVO)getVO(request, BookingQTYVO .class));
		}
