...
*@FileName : ChargeAmountDiscountMgtDBDAOSearchAfterBookingDetailReasonListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeAmountDiscountMgtDBDAOSearchAfterBookingDetailReasonListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeAmountDiscountMgtDBDAOSearchAfterBookingDetailReasonList
	  * </pre>
	  */
	public ChargeAmountDiscountMgtDBDAOSearchAfterBookingDetailReasonListRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeAmountDiscountMgtDBDAOSearchAfterBookingDetailReasonListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
