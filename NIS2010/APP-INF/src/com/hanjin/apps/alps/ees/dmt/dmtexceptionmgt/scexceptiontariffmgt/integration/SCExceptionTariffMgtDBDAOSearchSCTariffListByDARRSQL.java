...
*@FileName : SCExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SC & RFA Exception Inquiry (SC, DAR) 조회쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOSearchSCTariffListByDARRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
