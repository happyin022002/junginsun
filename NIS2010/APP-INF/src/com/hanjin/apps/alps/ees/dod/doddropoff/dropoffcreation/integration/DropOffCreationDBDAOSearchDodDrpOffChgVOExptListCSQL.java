...
*@FileName : DropOffCreationDBDAOSearchDodDrpOffChgVOExptListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DropOffCreationDBDAOSearchDodDrpOffChgVOExptListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Booking-TRO에 데이터 중 Location과 cntr rtn yd cd가 다른 confirm한 데이터 중 면제 대상을 가져와서 
	  * DOD_DRP_OFF_CHG테이블에 insert한다.
	  * </pre>
	  */
	public DropOffCreationDBDAOSearchDodDrpOffChgVOExptListCSQL(){
		setQuery();
		...
		query.append("FileName : DropOffCreationDBDAOSearchDodDrpOffChgVOExptListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  INTO DOD_DRP_OFF_CHG" ).append("\n"); 
		...
		query.append("       A.CFM_DT TRO_IB_CFM_DT," ).append("\n"); 
		query.append("       A.DEL_CD DEL_CD," ).append("\n"); 
		query.append("       A.CNTR_RTN_YD_CD CNTR_RTN_YD_CD," ).append("\n"); 
		query.append("       A.CNTR_RTN_DT CNTR_RTN_DT," ).append("\n"); 
		...
		query.append("       0 SCV_FEE_AMT," ).append("\n"); 
