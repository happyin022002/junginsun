...
*@FileName : DtocFreeTimeParmVO.java
*@FileTitle : DtocFreeTimeParmVO
*Open Issues :
*Change history :
...
public class DtocFreeTimeParmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DtocFreeTimeParmVO> models = new ArrayList<DtocFreeTimeParmVO>();
	...
	public DtocFreeTimeParmVO() {}

	public DtocFreeTimeParmVO(String ibflag, String pagerows, String cntrNo, String cnmvCycNo, String efftDt, String fmYdCd) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return DtocFreeTimeParmVO[]
	 */
	public DtocFreeTimeParmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DtocFreeTimeParmVO[]
	 */
	public DtocFreeTimeParmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DtocFreeTimeParmVO model = null;
	 ...
	 * @return DtocFreeTimeParmVO[]
	 */
	public DtocFreeTimeParmVO[] getDtocFreeTimeParmVOs(){
		DtocFreeTimeParmVO[] vos = (DtocFreeTimeParmVO[])models.toArray(new DtocFreeTimeParmVO[models.size()]);
		return vos;
	}
