...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteQtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * WRS-->TRS--> EQR 로 전해진 SO IF EXECUTE 정보 입력 대상테이블 : EQR_INLND_TRSP_EXE_PLN_QTY
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteQtyCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFExecuteQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
