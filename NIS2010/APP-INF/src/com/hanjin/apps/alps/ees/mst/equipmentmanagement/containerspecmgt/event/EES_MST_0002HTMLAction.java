...
*@FileName : EES_MST_0002HTMLAction.java
...
public class EES_MST_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0002HTMLAction 객체를 생성
	 */
	public EES_MST_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0002Event event = new EesMst0002Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setContainerTypeSizeCodeVOS((ContainerTypeSizeCodeVO[])getVOs(request, ContainerTypeSizeCodeVO.class, ""));
		}
