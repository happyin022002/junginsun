...
*@FileName : DodValidationDBDAOcheckLocCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodValidationDBDAOcheckLocCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodValidationDBDAOcheckLocCdRSQL(){
		setQuery();
		...
		query.append("FileName : DodValidationDBDAOcheckLocCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE LOC_CD = @[s_value]" ).append("\n"); 
