...
*@FileName : EES_MNR_0111HTMLAction.java
 ...
 * @see EesMnr0111Event 참조
 * @since J2EE 1.6           
 */

public class EES_MNR_0111HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0111HTMLAction 객체를 생성
	 */	
	public EES_MNR_0111HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0111Event event = new EesMnr0111Event();
