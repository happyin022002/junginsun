...
*@FileName : ChassisMovementHistoryDBDAOSearchCtmMvmtSourceDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMovementHistoryDBDAOSearchCtmMvmtSourceDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ChassisMovementHistoryDBDAOSearchCtmMvmtSourceDataRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.cgm.movementmnrhistory.chassismovementhistory.integration").append("\n"); 
		query.append("FileName : ChassisMovementHistoryDBDAOSearchCtmMvmtSourceDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE CNMV_EXE_TO_DT IS NOT NULL AND  ROWNUM=1) I" ).append("\n"); 
		...
		query.append("'X' FROM CGM_CHSS_MVMT_HIS  B" ).append("\n"); 
