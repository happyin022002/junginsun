...
*@FileName : InvoiceIssueCollectionMgtDBDAOAddInvoiceDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueCollectionMgtDBDAOAddInvoiceDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueCollectionMgtDBDAOAddInvoiceDetailCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueCollectionMgtDBDAOAddInvoiceDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[chg_seq]" ).append("\n"); 
		query.append(",	@[cntr_tpsz_cd]" ).append("\n"); 
		query.append(",	TO_DATE(@[fm_mvmt_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	TO_DATE(@[to_mvmt_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	@[ft_dys]" ).append("\n"); 
		query.append(",	TO_DATE(@[ft_cmnc_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	TO_DATE(@[ft_end_dt],'YYYY-MM-DD')" ).append("\n"); 
		query.append(",	@[fx_ft_ovr_dys]" ).append("\n"); 
		query.append(",	@[xcld_sat_flg]" ).append("\n"); 
		query.append(",	@[xcld_sun_flg]" ).append("\n"); 
		query.append(",	@[xcld_hol_flg]" ).append("\n"); 
