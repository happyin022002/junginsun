...
*@FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeRCVRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeRCVRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(SC, DATE-Office, Receive)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeRCVRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeRCVRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT	DISTINCT 'CC' AS TO_CC" ).append("\n"); 
		...
		query.append("WHERE   PROP_NO = SC_VER.PROP_NO" ).append("\n"); 
		...
		query.append(",	(" ).append("\n"); 
		query.append("SELECT  /*+ INDEX_DESC(DMT_SC_EXPT_VER_PROG XPKDMT_SC_EXPT_VER_PROG) */ DECODE(SC_VER.DMDT_EXPT_VER_STS_CD, 'D', '', PROG_OFC_CD)" ).append("\n"); 
		query.append("FROM    DMT_SC_EXPT_VER_PROG" ).append("\n"); 
		query.append("WHERE   PROP_NO = SC_VER.PROP_NO" ).append("\n"); 
		query.append("AND SC_EXPT_VER_SEQ = SC_VER.SC_EXPT_VER_SEQ" ).append("\n"); 
		...
		query.append(",   TO_CHAR(SC_VER.UPD_DT, 'YYYY-MM-DD') AS UPD_DT" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("WHERE	SC_VER.DELT_FLG = 'N'" ).append("\n"); 
		...
		query.append("AND SC_GRP.SC_EXPT_GRP_SEQ = SC_CVRG.SC_EXPT_GRP_SEQ" ).append("\n"); 
		query.append("AND (SC_CVRG.CNT_CD, SC_CVRG.RGN_CD, SC_CVRG.STE_CD, SC_CVRG.LOC_CD) IN" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT	LOC.CNT_CD" ).append("\n"); 
		query.append(", 	DECODE(SC_CVRG.RGN_CD, ' ', ' ', DECODE(LOC.CNT_CD, 'CA', ' ', 'US', ' ', LOC.RGN_CD))" ).append("\n"); 
		query.append(",	DECODE(SC_CVRG.STE_CD, ' ', ' ', DECODE(LOC.CNT_CD, 'CA', LOC.CNT_CD, 'US', LOC.STE_CD, ' '))" ).append("\n"); 
		query.append(", 	DECODE(SC_CVRG.LOC_CD, ' ', ' ', LOC.LOC_CD)" ).append("\n"); 
		...
		query.append("AND	ROWNUM = 1" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("AND SC_VER_PROG.PROG_OFC_CD IN" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("#foreach( $ofc_cd in ${ofc_cd_list} )" ).append("\n"); 
		query.append("#if($velocityCount < $ofc_cd_list.size()) '$ofc_cd', #else '$ofc_cd' #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("WHERE	SC_VER.PROP_NO = SC_VER_PROG.PROP_NO" ).append("\n"); 
		query.append("AND	SC_VER.SC_EXPT_VER_SEQ = SC_VER_PROG.SC_EXPT_VER_SEQ" ).append("\n"); 
		query.append("AND SC_VER.DMDT_EXPT_VER_STS_CD = 'R'" ).append("\n"); 
		query.append("AND SC_VER.DELT_FLG = 'N'" ).append("\n"); 
		query.append("AND SC_VER.UPD_DT BETWEEN TO_DATE(@[fm_dt], 'YYYY-MM-DD') AND TO_DATE(@[to_dt], 'YYYY-MM-DD') + 0.99999" ).append("\n"); 
		query.append("AND SC_VER_PROG.PROG_SEQ =" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("AND ROWNUM = 1" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("AND SP_MN.PROP_APRO_OFC_CD IN" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("#foreach( $ofc_cd in ${ofc_cd_list} )" ).append("\n"); 
		query.append("#if($velocityCount < $ofc_cd_list.size()) '$ofc_cd', #else '$ofc_cd' #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
