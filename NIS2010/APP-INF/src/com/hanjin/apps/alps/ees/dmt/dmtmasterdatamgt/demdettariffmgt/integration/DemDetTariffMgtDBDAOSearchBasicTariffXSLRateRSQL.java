...
*@FileName : DemDetTariffMgtDBDAOSearchBasicTariffXSLRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOSearchBasicTariffXSLRateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOSearchBasicTariffXSLRateRSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOSearchBasicTariffXSLRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        , FT_OVR_DYS ||'-'|| DECODE(FT_UND_DYS, 0, '', FT_UND_DYS) AS OVER_DAY" ).append("\n"); 
