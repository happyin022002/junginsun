...
*@FileName : EES_DMT_2018HTMLAction.java
...
public class EES_DMT_2018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_2018HTMLAction 객체를 생성
	 */
	public EES_DMT_2018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt2018Event event = new EesDmt2018Event();
		...
		//checkBalanceCharge
		else if (command.isCommand(FormCommand.SEARCH08)||command.isCommand(FormCommand.SEARCH10)
