...
public class PerformanceReportDBDAOSearchTireReplacementListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DECODE(OD.COST_CD, 'MRZSTP', OD.RPR_QTY) P_QTY," ).append("\n"); 
		query.append("DECODE(OD.COST_CD, 'MRZSTR', OD.RPR_QTY) U_QTY," ).append("\n"); 
		query.append("DECODE(OD.COST_CD, 'MRZSTP'," ).append("\n"); 
		query.append("MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(SYSDATE, 'YYYYMM'), OH.CURR_CD, 'USD', OD.COST_AMT)) P_AMT," ).append("\n"); 
		query.append("DECODE(OD.COST_CD, 'MRZSTR'," ).append("\n"); 
		query.append("MNR_COMMON_PKG.MNR_CAL_CURR_RATE_FNC(TO_CHAR(SYSDATE, 'YYYYMM'), OH.CURR_CD, 'USD', OD.COST_AMT)) U_AMT" ).append("\n"); 
