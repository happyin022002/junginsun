...
*@FileName : EES_EQR_0127HTMLAction.java
...
public class EES_EQR_0127HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0127HTMLAction 객체를 생성
	 */
	public EES_EQR_0127HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0127Event event = new EesEqr0127Event();
		
		String scnrId = JSPUtil.getParameter(request, "run_id_no".trim(), "");
		event.setScnrId(scnrId);
