...
*@FileName : UncollectedCargoDBDAOModifyUncollectedCreationMstrInfo3USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOModifyUncollectedCreationMstrInfo3USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Handling Office의 RHQ 소속 유저는 Reopen만 저장할 수 있음. 
	  * </pre>
	  */
	public UncollectedCargoDBDAOModifyUncollectedCreationMstrInfo3USQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAOModifyUncollectedCreationMstrInfo3USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
