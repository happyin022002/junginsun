...
*@FileName : PoolUseddysMGTVO.java
*@FileTitle : PoolUseddysMGTVO
*Open Issues :
*Change history :
...
public class PoolUseddysMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PoolUseddysMGTVO> models = new ArrayList<PoolUseddysMGTVO>();
	...
	/* Column Info */
	private String fileImpProcStsNm = null;
	/* Column Info */
	...
	public PoolUseddysMGTVO() {}

	public PoolUseddysMGTVO(String ibflag, String pagerows, String updDt, String chssPoolCd, String fileImpDt, String creDt, String onhLocNm, String saveChk, String savFileNm, String creUsrId, String costYrmon, String impRsltDesc, String orgFileNm, String fileImpProcStsNm, String offhLocNm, String fileSeq, String rowNo, String updUsrId, String fileImpProcStsCd, String chssNo, String cntrNo, String onhDt, String offhDt, String poolChssUsdDys) {
		this.updDt = updDt;
		...
		this.cntrNo = cntrNo;
		this.fileImpProcStsNm = fileImpProcStsNm;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("file_imp_proc_sts_nm", getFileImpProcStsNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("file_imp_proc_sts_nm", "fileImpProcStsNm");
	...
	/**
	 * Column Info
	 * @return fileImpProcStsNm
	 */
	public String getFileImpProcStsNm() {
		return this.fileImpProcStsNm;
	}
	...
	/**
	 * Column Info
	 * @param fileImpProcStsNm
	 */
	public void setFileImpProcStsNm(String fileImpProcStsNm) {
		this.fileImpProcStsNm = fileImpProcStsNm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFileImpProcStsNm(JSPUtil.getParameter(request, prefix + "file_imp_proc_sts_nm", ""));
	 ...
	 */
	public PoolUseddysMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PoolUseddysMGTVO[]
	 */
	public PoolUseddysMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PoolUseddysMGTVO model = null;
		...
		try {
			...
			String[] fileImpProcStsNm = (JSPUtil.getParameter(request, prefix	+ "file_imp_proc_sts_nm", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (fileImpProcStsNm[i] != null)
					model.setFileImpProcStsNm(fileImpProcStsNm[i]);
				if (offhLocNm[i] != null)
	...
	public PoolUseddysMGTVO[] getPoolUseddysMGTVOs(){
		PoolUseddysMGTVO[] vos = (PoolUseddysMGTVO[])models.toArray(new PoolUseddysMGTVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.fileImpProcStsNm = this.fileImpProcStsNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
