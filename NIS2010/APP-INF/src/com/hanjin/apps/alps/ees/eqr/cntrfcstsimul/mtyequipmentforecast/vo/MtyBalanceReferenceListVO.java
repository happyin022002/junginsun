...
*@FileName : MtyBalanceReferenceListVO.java
*@FileTitle : MtyBalanceReferenceListVO
*Open Issues :
*Change history :
...
public class MtyBalanceReferenceListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyBalanceReferenceListVO> models = new ArrayList<MtyBalanceReferenceListVO>();
	...
	public MtyBalanceReferenceListVO() {}

	public MtyBalanceReferenceListVO(String ibflag, String pagerows, String dpSeq, String d7FcastQty, String a2FcastQty, String d5FcastQty, String fcastYrwk0, String totalFcastQty, String r2FcastQty, String o2FcastQty, String title, String r9FcastQty, String dTotal, String gTotal, String tpCd, String a4FcastQty, String a5FcastQty, String d2FcastQty, String r5FcastQty, String s4FcastQty, String s2FcastQty, String sTotal, String f4FcastQty, String f5FcastQty, String o4FcastQty, String d4FcastQty, String f2FcastQty, String o5FcastQty, String item) {
		this.dpSeq = dpSeq;
...
/**
	 ...
	 */
	public MtyBalanceReferenceListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyBalanceReferenceListVO[]
	 */
	public MtyBalanceReferenceListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyBalanceReferenceListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MtyBalanceReferenceListVO();
				if (dpSeq[i] != null)
		...
		return getMtyBalanceReferenceListVOs();
	}
	...
	public MtyBalanceReferenceListVO[] getMtyBalanceReferenceListVOs(){
		MtyBalanceReferenceListVO[] vos = (MtyBalanceReferenceListVO[])models.toArray(new MtyBalanceReferenceListVO[models.size()]);
		return vos;
	}
