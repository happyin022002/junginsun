...
public class EES_DMT_3007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_3007HTMLAction 객체를 생성
	 */
	public EES_DMT_3007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt3007Event event = new EesDmt3007Event();
		
		log.debug("\n::CALL::> EES_DMT_3007HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setDemandNotePreviewParmVO((DemandNotePreviewParmVO)getVO(request, DemandNotePreviewParmVO .class));
		}
		return  event;
	}
