...
*@FileName : EES_MNR_0157HTMLAction.java
...
/**
 * HTTP Parser<br>  
 * - EES_MNR_0157 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @author 박명신  
 * @see EesMnr0157Event.java 참조 
 * @since J2EE 1.6           
 */ 

public class EES_MNR_0157HTMLAction extends HTMLActionSupport {
	
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0157HTMLAction 객체를 생성
	 */	 
	public EES_MNR_0157HTMLAction() {}
	  
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EesMnr0157Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0157Event event = new EesMnr0157Event();
