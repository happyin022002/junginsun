...
*@FileName : CustomMnrPrnrCntcPntVO.java
*@FileTitle : CustomMnrPrnrCntcPntVO
*Open Issues :
*Change history :
...
public class CustomMnrPrnrCntcPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomMnrPrnrCntcPntVO> models = new ArrayList<CustomMnrPrnrCntcPntVO>();
	...
	public CustomMnrPrnrCntcPntVO() {}

	public CustomMnrPrnrCntcPntVO(String ibflag, String pagerows, String updDt, String phnNo, String creDt, String mnrPrnrAddr, String mnrPrnrCreDtlSeq, String mnrPrnrCreSeq, String cntcDivCd, String ofcCd, String creUsrId, String mnrPrnrRmk, String mnrPrnrEml, String cntCd, String prmryChkFlg, String mnrCntcPrnrNm, String faxNo, String intlFaxNo, String aplyFlg, String updUsrId, String intlPhnNo, String deltFlg) {
		this.updDt = updDt;
		this.phnNo = phnNo;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMnrPrnrCreDtlSeq(JSPUtil.getParameter(request, prefix + "mnr_prnr_cre_dtl_seq", ""));
	 ...
	 * @param request
	 * @return CustomMnrPrnrCntcPntVO[]
	 */
	public CustomMnrPrnrCntcPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomMnrPrnrCntcPntVO[]
	 */
	public CustomMnrPrnrCntcPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomMnrPrnrCntcPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CustomMnrPrnrCntcPntVO();
				if (updDt[i] != null)
		...
		return getCustomMnrPrnrCntcPntVOs();
	}
	...
	public CustomMnrPrnrCntcPntVO[] getCustomMnrPrnrCntcPntVOs(){
		CustomMnrPrnrCntcPntVO[] vos = (CustomMnrPrnrCntcPntVO[])models.toArray(new CustomMnrPrnrCntcPntVO[models.size()]);
		return vos;
	}
