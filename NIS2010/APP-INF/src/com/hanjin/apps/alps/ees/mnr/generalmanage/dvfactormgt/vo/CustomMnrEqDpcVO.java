...
public class CustomMnrEqDpcVO extends AbstractValueObject {
	 ...
	 */
	public CustomMnrEqDpcVO(String ibflag, String pagerows, String eqDpcYr, String cdId, String eqKndCd, String currCd, String eqInitPrc, String eqDpcRt, String eqMtrlCd, String creUsrId, String creDt, String updUsrId, String updDt, String cdDesc) {
		this.updDt = updDt;
		this.currCd = currCd;
		this.creDt = creDt;
		this.cdId = cdId;
