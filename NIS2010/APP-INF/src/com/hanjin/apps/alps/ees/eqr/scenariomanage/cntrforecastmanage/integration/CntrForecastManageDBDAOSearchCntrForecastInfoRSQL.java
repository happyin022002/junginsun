...
*@FileName : CntrForecastManageDBDAOSearchCntrForecastInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOSearchCntrForecastInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 컨테이너 forecast 정보 조회 EQR_AVG_FCAST, EQR_SCNR_MST,  eqr_ob_fcast, eqr_sls_inp_fcast,  eqr_sls_stat_fcast
	  * 
	  * <Change History>
	  * 1	2009.08.12	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrForecastManageDBDAOSearchCntrForecastInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOSearchCntrForecastInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SCNR_ID, A.FCAST_YRWK, A.CO_CD, A.FM_ECC_CD, A.TO_ECC_CD, A.CNTR_TPSZ_CD, FCAST_DT" ).append("\n"); 
		query.append(")A" ).append("\n"); 
		query.append("GROUP BY" ).append("\n"); 
		query.append("A.SCNR_ID, A.FCAST_YRWK, A.CO_CD, A.TO_ECC_CD, A.FM_ECC_CD, A.FCAST_DEL_DT, A.FCAST_DEL_YRWK" ).append("\n"); 
