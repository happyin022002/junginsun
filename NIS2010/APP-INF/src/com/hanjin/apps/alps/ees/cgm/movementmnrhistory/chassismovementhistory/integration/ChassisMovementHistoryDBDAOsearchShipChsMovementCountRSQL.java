...
*@FileName : ChassisMovementHistoryDBDAOsearchShipChsMovementCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMovementHistoryDBDAOsearchShipChsMovementCountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Shipper's Chassis의 Movement 전체건수를 조회합니다.
	  * </pre>
	  */
	public ChassisMovementHistoryDBDAOsearchShipChsMovementCountRSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMovementHistoryDBDAOsearchShipChsMovementCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM   (SELECT  A.CHSS_NO, A.MVMT_DT, A.YD_CD, A.LOC_CD, A.GATE_IO_CD," ).append("\n"); 
