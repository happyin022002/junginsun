...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertTrunkVesselAndFeederCntrRepoPlanCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertTrunkVesselAndFeederCntrRepoPlanCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_VSL_LODG_DCHG_EXE_PLN 신규입력
	  * 
	  * ---- Change History
	  * CSR No             Modified Date   Modifier              Description
	  * ------------------------------------------------------------------
	  * R200711054303     2007-11-22      shin yongchan     Fixed Plan & Plan 간 실행계획 구분
	  * N200712170011     2007-12-28      shin yongchan     UNIT, FROM, TO COST 정보 복사
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertTrunkVesselAndFeederCntrRepoPlanCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertTrunkVesselAndFeederCntrRepoPlanCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
