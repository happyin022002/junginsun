...
public class TotalLossMgtDBDAOaddTotalLossHeaderDataCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" ,ACC_FLG" ).append("\n"); 
		query.append(" ,ACC_DT" ).append("\n"); 
		query.append(" ,ACC_VSL_CD" ).append("\n"); 
		query.append(" ,ACC_SKD_VOY_NO" ).append("\n"); 
		query.append(" ,ACC_SKD_DIR_CD" ).append("\n"); 
		query.append(" ,ACC_PORT_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		...
		query.append(" ,@[upd_usr_id]" ).append("\n"); 
		query.append(" ,SYSDATE" ).append("\n"); 
		query.append(" ,DECODE(@[ttl_lss_rsn_cd], 'TRS', 'Y', 'N')" ).append("\n"); 
		query.append(" ,TO_DATE(@[acc_dt],'yyyy-mm-dd')" ).append("\n"); 
		query.append(" ,@[acc_vsl_cd]" ).append("\n"); 
		query.append(" ,@[acc_skd_voy_no]" ).append("\n"); 
		query.append(" ,@[acc_skd_dir_cd]" ).append("\n"); 
		query.append(" ,@[acc_port_cd]" ).append("\n"); 
