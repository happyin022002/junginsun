...
*@FileName : RFAExceptionTariffMgtDBDAORemoveMultiCoverageByVerNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAORemoveMultiCoverageByVerNoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Ver No. 에 해당되는Multi Origin or Dest. 정보를 삭제하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAORemoveMultiCoverageByVerNoDSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAORemoveMultiCoverageByVerNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
