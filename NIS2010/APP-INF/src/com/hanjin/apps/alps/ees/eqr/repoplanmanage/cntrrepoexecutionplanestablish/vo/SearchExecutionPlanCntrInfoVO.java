...
*@FileName : SearchExecutionPlanCntrInfoVO.java
...
public class SearchExecutionPlanCntrInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchExecutionPlanCntrInfoVO> models = new ArrayList<SearchExecutionPlanCntrInfoVO>();
	 ...
	 */
	public SearchExecutionPlanCntrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExecutionPlanCntrListVO[]
	 */
	public SearchExecutionPlanCntrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchExecutionPlanCntrInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchExecutionPlanCntrInfoVO();
	 ...
	 * @return SearchExecutionPlanCntrListVO[]
	 */
	public SearchExecutionPlanCntrInfoVO[] getSearchExecutionPlanCntrListVOs(){
		SearchExecutionPlanCntrInfoVO[] vos = (SearchExecutionPlanCntrInfoVO[])models.toArray(new SearchExecutionPlanCntrInfoVO[models.size()]);
		return vos;
	}
