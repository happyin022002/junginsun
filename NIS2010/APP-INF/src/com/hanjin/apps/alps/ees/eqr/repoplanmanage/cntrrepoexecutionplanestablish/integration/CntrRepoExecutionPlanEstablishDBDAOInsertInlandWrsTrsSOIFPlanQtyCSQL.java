...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFPlanQtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFPlanQtyCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFPlanQtyCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOInsertInlandWrsTrsSOIFPlanQtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_INLND_TRSP_PLN_QTY (" ).append("\n"); 
