...
*@FileName : SCExceptionTariffMgtDBDAOAddVersionPROGCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddVersionPROGCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C 의 Version 상태가 변경될 때 그 이력을 입력하기 위한 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddVersionPROGCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddVersionPROGCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
