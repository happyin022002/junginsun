...
*@FileName : ContainerMovementMgtDBDAOCusCtmMovementRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOCusCtmMovementRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 컨테이너 이동 정보 마스터 (POL. POD등 추가)
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOCusCtmMovementRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.ctm.equipmentmovementmgt.containermovementmgt.integration").append("\n"); 
		query.append("FileName : ContainerMovementMgtDBDAOCusCtmMovementRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
