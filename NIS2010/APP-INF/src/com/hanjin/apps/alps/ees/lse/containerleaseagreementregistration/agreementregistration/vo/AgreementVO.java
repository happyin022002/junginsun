...
public class AgreementVO extends AbstractValueObject {
	...
	/* Column Info */
	private String lseAgmtDocNo = null;
	/* Column Info */
	private String lseAgmtDocDesc = null;
	/* Column Info */
	private String dpcRtoVal = null;
	...
	public AgreementVO(String ibflag, String pagerows, String agmtNo, String agmtCtyCd, String agmtSeq, String agmtLstVerSeq, String vndrSeq
			         ...
			         , String lseCtrtNo, String creDt, String updDt, String agmtActFlg ,String lseAgmtDocNo , String lseAgmtDocDesc ,String dpcRtoVal) {
		this.currCd = currCd;
		...
		this.lseAgmtDocNo = lseAgmtDocNo;
		this.lseAgmtDocDesc = lseAgmtDocDesc;
		this.dpcRtoVal = dpcRtoVal;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("lse_agmt_doc_no", getLseAgmtDocNo());
		this.hashColumns.put("lse_agmt_doc_desc", getLseAgmtDocDesc());
		this.hashColumns.put("dpc_rto_val", getDpcRtoVal());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("lse_agmt_doc_no", "lseAgmtDocNo");
		this.hashFields.put("lse_agmt_doc_desc", "lseAgmtDocDesc");
		this.hashFields.put("dpc_rto_val", "dpcRtoVal");
	...
	public String getLseAgmtDocNo() {
		return lseAgmtDocNo;
	}

	public void setLseAgmtDocNo(String lseAgmtDocNo) {
		this.lseAgmtDocNo = lseAgmtDocNo;
	}

	public String getLseAgmtDocDesc() {
		return lseAgmtDocDesc;
	}

	public void setLseAgmtDocDesc(String lseAgmtDocDesc) {
		this.lseAgmtDocDesc = lseAgmtDocDesc;
	}

	
	public String getDpcRtoVal() {
		return dpcRtoVal;
	}

	public void setDpcRtoVal(String dpcRtoVal) {
		this.dpcRtoVal = dpcRtoVal;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLseAgmtDocNo(JSPUtil.getParameter(request, "lse_agmt_doc_no", ""));
		setLseAgmtDocDesc(JSPUtil.getParameter(request, "lse_agmt_doc_desc", ""));
		setDpcRtoVal(JSPUtil.getParameter(request, "dpc_rto_val", ""));
	}
	...
	public AgreementVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] lseAgmtDocNo = (JSPUtil.getParameter(request, prefix	+ "lse_agmt_doc_no".trim(), length));
			String[] lseAgmtDocDesc = (JSPUtil.getParameter(request, prefix	+ "lse_agmt_doc_desc".trim(), length));
			String[] dpcRtoVal  = (JSPUtil.getParameter(request, prefix	+ "dpc_rto_val".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (lseAgmtDocNo[i] != null)
					model.setLseAgmtDocNo(lseAgmtDocNo[i]);
				if (lseAgmtDocDesc[i] != null)
					model.setLseAgmtDocDesc(lseAgmtDocDesc[i]);
				if (dpcRtoVal[i] != null)
					model.setDpcRtoVal(dpcRtoVal[i]);
			    models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.lseAgmtDocNo = this.lseAgmtDocNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.lseAgmtDocDesc = this.lseAgmtDocDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.dpcRtoVal  = this.dpcRtoVal.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
