 ...
 *@FileName : CntrCodConfirmSC.java
 *@FileTitle : COD Confirm
 *Open Issues :
 *Change history :
 ...
 * 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.ees.eqr.cntrcodconfirm;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.basic.EmptyCODAdjustmentBC;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.basic.EmptyCODAdjustmentBCImpl;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1054Event;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1024Event;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1056Event;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1023Event;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1057Event;
import com.hanjin.apps.alps.ees.eqr.cntrcodconfirm.emptycodadjustment.event.EesEqr1021Event;
...
/**
 * ALPS - COD Confirm Business Logic ServiceCommand -
 * ALPS - COD Confirm 대한 비지니스 트랜잭션을 처리한다.
 * 
...
public class CntrCodConfirmSC extends ServiceCommandSupport {
	...
	public EventResponse perform(Event e) throws EventException {
		...
		if (e.getEventName().equalsIgnoreCase("EesEqr1021Event")) {
		...
		else if (e.getEventName().equalsIgnoreCase("EesEqr1054Event")) {
		...
		else if (e.getEventName().equalsIgnoreCase("EesEqr1024Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
		...
		else if (e.getEventName().equalsIgnoreCase("EesEqr1056Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
		...
		else if (e.getEventName().equalsIgnoreCase("EesEqr1057Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
				eventResponse = searchDamageHangerMTYList(e);
			}
		}
		else if (e.getEventName().equalsIgnoreCase("EesEqr1023Event")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
	...
	private EventResponse searchMTYREPOByPeriod(Event e) throws EventException {
		log.debug("####### CntrCodConfirmSC.searchMTYREPOByPeriod 1023 시작");
		EesEqr1023Event event = (EesEqr1023Event) e;
		EmptyCODAdjustmentBC command = new EmptyCODAdjustmentBCImpl();
		...
		log.debug("####### CntrCodConfirmSC.searchMTYREPOByPeriod 1023 끝");
		return eventResponse;
	}
	...
	private EventResponse searchDamageHangerMTYList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		EesEqr1057Event event = (EesEqr1057Event) e;
		EmptyCODAdjustmentBC command = new EmptyCODAdjustmentBCImpl();
	...
	private EventResponse searchRevenueMTYList(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		EesEqr1056Event event = (EesEqr1056Event) e;
	...
	private EventResponse deleteConfirmation(Event e) throws EventException {
		...
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EesEqr1024Event event = (EesEqr1024Event) e;
		EmptyCODAdjustmentBC command = new EmptyCODAdjustmentBCImpl();
		try {
			begin();
			String vvd = (String) event.getAttribute("vvd");
	...
	private EventResponse searchVVDInformation(Event e) throws EventException {
		log.debug("####### CntrCodConfirmSC.searchVVDInformation 1024 시작");
		// PDTO(Data Transfer Object including Parameters)
		...
		eventResponse.setETCData(etcData);
		log.debug("####### CntrCodConfirmSC.searchVVDInformation 1024 끝");
		return eventResponse;
	}
	...
	private EventResponse searchYardNETBByVVDPort(Event e) throws EventException {
		log.debug("####### CntrCodConfirmSC.searchYardNETBByVVDPort 1024 시작");
		// PDTO(Data Transfer Object including Parameters)
		EesEqr1024Event event = (EesEqr1024Event) e;
		...
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		eventResponse.setRsVoList(list);
		log.debug("####### CntrCodConfirmSC.searchYardNETBByVVDPort 1024 끝");
		return eventResponse;
	}

	/**
	 * EES_CIM_1024 : Retrieve <br>
	...
	private EventResponse manageCODByVVD(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EesEqr1021Event event = (EesEqr1021Event) e;
		EmptyCODAdjustmentBC command = new EmptyCODAdjustmentBCImpl();
		try {
			begin();
	...
	private EventResponse searchVvdRemark(Event e) throws EventException {
		...
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		EmptyCODAdjustmentBC command = new EmptyCODAdjustmentBCImpl();
		EesEqr1054Event event = (EesEqr1054Event) e;
		String remark = "";
		try {
