...
*@FileName : DemDetTariffMgtDBDAOupdateBasicTariffNotiListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAOupdateBasicTariffNotiListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DemDetTariffMgtDBDAOupdateBasicTariffNotiListUSQL
	  * </pre>
	  */
	public DemDetTariffMgtDBDAOupdateBasicTariffNotiListUSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAOupdateBasicTariffNotiListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET TRF_MNG_USR_ID = @[trf_mng_usr_id]" ).append("\n"); 
		...
		query.append("AND DMDT_DE_TERM_CD = NVL(@[dmdt_de_term_cd],' ')" ).append("\n"); 
