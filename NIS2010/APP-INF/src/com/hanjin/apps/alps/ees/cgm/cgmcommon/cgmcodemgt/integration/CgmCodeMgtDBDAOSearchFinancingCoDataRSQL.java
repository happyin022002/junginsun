...
*@FileName : CgmCodeMgtDBDAOSearchFinancingCoDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOSearchFinancingCoDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CgmCodeMgtDBDAOSearchFinancingCoDataRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("WHERE A.CNTR_VNDR_SVC_CD = 'CPT'" ).append("\n"); 
		...
		query.append("FileName : CgmCodeMgtDBDAOSearchFinancingCoDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}