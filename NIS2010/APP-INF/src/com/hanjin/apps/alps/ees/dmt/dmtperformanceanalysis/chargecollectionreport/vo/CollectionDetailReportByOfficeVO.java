...
public class CollectionDetailReportByOfficeVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("inv_ots_day", getInvOtsDay());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("inv_ots_day", "invOtsDay");
    ...
    public void setInvOtsDay(String invOtsDay) {
        this.invOtsDay = invOtsDay;
    }

    public String getInvOtsDay() {
        return this.invOtsDay;
    }
    ...
    public CollectionDetailReportByOfficeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] custNm = (JSPUtil.getParameter(request, prefix + "custNm", length));
            String[] year = (JSPUtil.getParameter(request, prefix + "year", length));
            String[] month = (JSPUtil.getParameter(request, prefix + "month", length));
            String[] invOtsDay = (JSPUtil.getParameter(request, prefix + "inv_ots_day", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (invOtsDay[i] != null) 
		    		model.setInvOtsDay(invOtsDay[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.invOtsDay = this.invOtsDay.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
