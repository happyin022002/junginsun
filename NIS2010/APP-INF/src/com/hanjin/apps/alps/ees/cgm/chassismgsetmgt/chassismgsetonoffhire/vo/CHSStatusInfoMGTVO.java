...
*@FileName : CHSStatusInfoMGTVO.java
*@FileTitle : CHSStatusInfoMGTVO
*Open Issues :
*Change history :
...
public class CHSStatusInfoMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSStatusInfoMGTVO> models = new ArrayList<CHSStatusInfoMGTVO>();
	...
	/* Column Info */
	private String stsEvntDt2 = null;
	...
	public CHSStatusInfoMGTVO() {}

	public CHSStatusInfoMGTVO(String ibflag, String pagerows, String onhYdCd, String no, String vndrLglEngNm, String creDt, String crntYdCd, String stsEvntYdCd, String onhDt, String stsEvntDt2, String eqNo, String eqAsetStsCd, String onhOfcCd, String stsEvntDt, String stsEvntOfcCd, String aciacDivNm, String agmtRefNo, String agreeement, String agmtSeq, String agmtLstmCd, String aciacDivCd, String eqTpszCd, String creUsrId, String termCngSeq, String vndrSeq, String agmtOfcCtyCd, String crntLocCd, String agmtVerNo, String eqStsSeq, String chkVal) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("sts_evnt_dt2", getStsEvntDt2());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("sts_evnt_dt2", "stsEvntDt2");
	 ...
	 * @return stsEvntDt2
	 */
	public String getStsEvntDt2() {
		return this.stsEvntDt2;
	}
	 ...
	 * @param stsEvntDt2
	 */
	public void setStsEvntDt2(String stsEvntDt2) {
		this.stsEvntDt2 = stsEvntDt2;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setStsEvntDt2(JSPUtil.getParameter(request, prefix + "sts_evnt_dt2", ""));
	 ...
	 */
	public CHSStatusInfoMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSStatusInfoMGTVO[]
	 */
	public CHSStatusInfoMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSStatusInfoMGTVO model = null;
		...
		try {
			...
			String[] stsEvntDt2 = (JSPUtil.getParameter(request, prefix	+ "sts_evnt_dt2", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (stsEvntDt2[i] != null)
					model.setStsEvntDt2(stsEvntDt2[i]);
				if (ibflag[i] != null)
	...
	public CHSStatusInfoMGTVO[] getCHSStatusInfoMGTVOs(){
		CHSStatusInfoMGTVO[] vos = (CHSStatusInfoMGTVO[])models.toArray(new CHSStatusInfoMGTVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.stsEvntDt2 = this.stsEvntDt2 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
