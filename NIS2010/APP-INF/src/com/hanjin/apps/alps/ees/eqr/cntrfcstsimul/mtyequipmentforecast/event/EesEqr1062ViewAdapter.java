...
*@FileName : EesEqr1062ViewAdapter
 ...
 * @since J2EE 1.5   
 */
public class EesEqr1062ViewAdapter extends ViewAdapter {
...
//				}
			...
			int a5_qty_color = colValues.get("a5_qty").indexOf("-");
			String a5_qty_fontcolor = "";
			if ( a5_qty_color != -1)  a5_qty_fontcolor = color; 			
			...
			int dx_qty_color = colValues.get("dx_qty").indexOf("-");
			String dx_qty_fontcolor = "";
			if ( dx_qty_color != -1)  dx_qty_fontcolor = color; 
			...
			sbufXML.append("<TD FontColor='"+a5_qty_fontcolor+"'><![CDATA["+JSPUtil.getNull(colValues.get("a5_qty"   		))+"]]></TD>\n");
			sbufXML.append("<TD FontColor='"+dx_qty_fontcolor+"'><![CDATA["+JSPUtil.getNull(colValues.get("dx_qty"   		))+"]]></TD>\n");
