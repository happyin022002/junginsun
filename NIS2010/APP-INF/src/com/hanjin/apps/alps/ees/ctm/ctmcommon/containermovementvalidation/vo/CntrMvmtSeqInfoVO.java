...
*@FileName : CntrMvmtSeqInfoVO.java
*@FileTitle : CntrMvmtSeqInfoVO
*Open Issues :
*Change history :
...
public class CntrMvmtSeqInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntrMvmtSeqInfoVO> models = new ArrayList<CntrMvmtSeqInfoVO>();
	...
	public CntrMvmtSeqInfoVO() {}

	public CntrMvmtSeqInfoVO(String ibflag, String pagerows, String cnmvLvlNo, String fcntrFlg) {
		this.ibflag = ibflag;
	 ...
	 */
	public CntrMvmtSeqInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntrMvmtSeqInfoVO[]
	 */
	public CntrMvmtSeqInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntrMvmtSeqInfoVO model = null;
	 ...
	 * @return CntrMvmtSeqInfoVO[]
	 */
	public CntrMvmtSeqInfoVO[] getCntrMvmtSeqInfoVOs(){
		CntrMvmtSeqInfoVO[] vos = (CntrMvmtSeqInfoVO[])models.toArray(new CntrMvmtSeqInfoVO[models.size()]);
		return vos;
	}
