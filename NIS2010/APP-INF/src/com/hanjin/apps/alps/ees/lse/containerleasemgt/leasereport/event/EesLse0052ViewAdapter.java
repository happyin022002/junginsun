...
*@FileName : EesLse0052ViewAdapter.java
*@FileTitle : EesLse0052ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0052 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EesLse0052ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0052ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0052ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesLse0052ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
