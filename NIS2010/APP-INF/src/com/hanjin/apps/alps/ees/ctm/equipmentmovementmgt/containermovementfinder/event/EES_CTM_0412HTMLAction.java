...
*@FileName : UI_CTM_0412HTMLAction.java
...
public class EES_CTM_0412HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_CTM_0412HTMLAction 객체를 생성
	 */
	public EES_CTM_0412HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0412Event event = new EesCtm0412Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCtmMvmtIrrVO((CtmMvmtIrrVO)getVO(request, CtmMvmtIrrVO .class));
		}
