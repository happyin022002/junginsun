...
public class RepairMgtDBDAOsearchRepairInquiryListDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2013.05.30 조경완 [CHM-201324808-01] [MNR-자체개선] M&R > Repair > Repair Inquiry W/O Type Option 동작 오류 보완
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("#if (${wo_type} == 'EST' || ${wo_type} == 'ALL')" ).append("\n"); 
		...
		query.append("WHERE A.PRNT_CD_ID = 'CD00020'" ).append("\n"); 
		...
		query.append("WHERE MNR_CD_ID = MOH.COST_CD" ).append("\n"); 
		query.append("AND ROWNUM = 1) AS COST_CD_NM," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if ( ${wo_type} != 'EST' && ${wo_type} != 'ALL' && ${rqst_eq_no} != '')" ).append("\n"); 
		...
		query.append("#elseif(${wo_type} == 'ALL' )" ).append("\n"); 
		query.append("AND MOH.MNR_WO_TP_CD(+) = 'EST'" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${wo_type} == 'ALL' && ${rqst_eq_no} == '')" ).append("\n"); 
		...
		query.append("AND RTRIM(MOH.MNR_WO_TP_CD) IN ('SPL','RFS','EXT')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(") RST" ).append("\n"); 
		query.append("WHERE 1 = 1" ).append("\n"); 
		query.append("#if (${status_cd} == 'IP')" ).append("\n"); 
