...
*@FileName : ReeferSparePartMgtDBDAOmodifyVesselSparePartInventoryDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReeferSparePartMgtDBDAOmodifyVesselSparePartInventoryDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReeferSparePartMgtDBDAOmodifyVesselSparePartInventoryDataUSQL(){
		setQuery();
		...
		params.put("spr_prt_del_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ReeferSparePartMgtDBDAOmodifyVesselSparePartInventoryDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MNR_VSL_SPR_PRT_INVT SET" ).append("\n"); 
		query.append("		SPR_UT_SHR_CD = @[spr_ut_shr_cd]" ).append("\n"); 
		query.append("        ,DELT_FLG   = @[spr_prt_del_flg]" ).append("\n"); 
		query.append("        ,UPD_USR_ID        = @[upd_usr_id]" ).append("\n"); 
		query.append("        ,UPD_DT = sysdate " ).append("\n"); 
		query.append("WHERE	SPR_PRT_INVT_NO = @[spr_prt_invt_no]" ).append("\n"); 
		query.append("AND SPR_PRT_INVT_VER_SEQ = @[spr_prt_ver_seq]" ).append("\n"); 
