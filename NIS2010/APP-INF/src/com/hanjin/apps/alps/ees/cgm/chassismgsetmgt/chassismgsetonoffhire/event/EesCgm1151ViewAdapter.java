...
*@FileName : EesCgm1151ViewAdapter.java
*@FileTitle : EesCgm1151ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_CGM_1152 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EesCgm1151ViewAdapter extends DefaultViewAdapter {
	
    public EesCgm1151ViewAdapter(){
    	super();
    }
    
    protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesCgm1152ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesCgm1152ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
