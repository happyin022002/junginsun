...
*@FileName : EES_MNR_0265HTMLAction.java
...
public class EES_MNR_0265HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0262HTMLAction 객체를 생성
	 */
	public EES_MNR_0265HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0265Event event = new EesMnr0265Event();
			
		ApprovalStepGRPVO approvalStepGRPVO = new ApprovalStepGRPVO();
			
		//리스트  조회 
		if(command.isCommand(FormCommand.MULTI)){
			approvalStepGRPVO.setCustomMnrAproStepVOs((CustomMnrAproStepVO[])getVOs(request, CustomMnrAproStepVO .class));
		}	
		//리스트  조회 
