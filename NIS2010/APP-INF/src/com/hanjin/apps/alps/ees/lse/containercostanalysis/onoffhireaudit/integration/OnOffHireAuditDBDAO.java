...
/**
 * NIS2010 IOnOffHireAuditDBDAO <br>
 * - NIS2010-ContainerCostAnalysis system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author Jin Jun Sung
...
public class OnOffHireAuditDBDAO extends DBDAOSupport {
	...
	/**
	* OnOffHireAuditDBDAO의 데이타 모델에 해당되는 값을 불러온다.<br>
	* Lessor & HJS를 비교하여 Audit Result 한 결과 저장시 삭제후 저장시 삭제
	...
	*/
	...
	/**
	 * OnhireApprovalDBDAO의 데이타 모델에 해당되는 값을 불러온다.<br>
	 * Lessor & HJS를 비교하여 Audit Result 한 결과 저장
	 * 
	 * @param  OnOffHireAuditDetailVO onOffHireAuditDetailVO
	 * @param  String audVerSeq
	 * @param  int audSeq
