...
*@FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeSNDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeSNDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DEM/DET Adjustment Request & Approval Status 조회(SC, DATE-Office, Sent)용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeSNDRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchSCTariffListByDateUserOfficeSNDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",   SC_VER_PROG2.PROG_OFC_CD AS REQ_OFC_CD" ).append("\n"); 
		query.append(",	DECODE(SC_VER.DMDT_EXPT_VER_STS_CD, 'D', '', SC_VER_PROG.PROG_OFC_CD) AS APRO_OFC_CD" ).append("\n"); 
		query.append(",   TO_CHAR(SC_VER_PROG.PROG_DT, 'YYYY-MM-DD') AS UPD_DT" ).append("\n"); 
		query.append(",   SC_VER.PROP_NO" ).append("\n"); 
		query.append(",   SP_PTY.CUST_CNT_CD || LPAD(SP_PTY.CUST_SEQ, 6, '0') AS CUST_CD" ).append("\n"); 
		query.append(",   CUST.CUST_LGL_ENG_NM AS CUST_NM" ).append("\n"); 
