...
*@FileName : HolidayMgtDBDAOHolidayCountByAllRHQRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class HolidayMgtDBDAOHolidayCountByAllRHQRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 모든 RHQ 에 해당되는 Country, Region, State, Location 별로 등록된 휴일 총 일 수 를 구하는 쿼리
	  * </pre>
	  */
	public HolidayMgtDBDAOHolidayCountByAllRHQRSQL(){
		setQuery();
		...
		query.append("FileName : HolidayMgtDBDAOHolidayCountByAllRHQRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
