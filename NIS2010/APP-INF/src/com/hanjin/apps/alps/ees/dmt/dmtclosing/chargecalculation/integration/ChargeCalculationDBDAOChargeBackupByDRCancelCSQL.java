...
*@FileName : ChargeCalculationDBDAOChargeBackupByDRCancelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOChargeBackupByDRCancelCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DRCancel에 따른 Balance Charge Delete 이전에 Charge Backup Table에 Insert한다
	  * </pre>
	  */
	public ChargeCalculationDBDAOChargeBackupByDRCancelCSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOChargeBackupByDRCancelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
