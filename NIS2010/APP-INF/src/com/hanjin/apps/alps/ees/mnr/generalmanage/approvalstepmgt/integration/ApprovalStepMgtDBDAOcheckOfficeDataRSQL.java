...
*@FileName : ApprovalStepMgtDBDAOcheckOfficeDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalStepMgtDBDAOcheckOfficeDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalStepMgtDBDAOcheckOfficeDataRSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalStepMgtDBDAOcheckOfficeDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  COUNT(A.OFC_CD)" ).append("\n"); 
