...
*@FileName : EES_EQR_1051HTMLAction.java
...
public class EES_EQR_1051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_1051HTMLAction 객체를 생성
	 */
	public EES_EQR_1051HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		EesEqr1051Event event = new EesEqr1051Event();
	
		event.setEesEqr1051ConditionVO((EesEqr1051ConditionVO)getVO(request, EesEqr1051ConditionVO .class));
