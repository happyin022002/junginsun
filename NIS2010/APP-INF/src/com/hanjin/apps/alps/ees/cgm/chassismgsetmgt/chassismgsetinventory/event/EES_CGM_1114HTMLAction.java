...
*@FileName : EES_CGM_1114HTMLAction.java
...
public class EES_CGM_1114HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1114HTMLAction 객체를 생성
	 */
	public EES_CGM_1114HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1114Event event = new EesCgm1114Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCHSEspFactorINVOs((CHSEspFactorINVO[])getVOs(request, CHSEspFactorINVO.class, ""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCHSEspFactorINVO((CHSEspFactorINVO)getVO(request, CHSEspFactorINVO .class));
		}
