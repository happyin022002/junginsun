...
*@FileName : ForecastReportDBDAOaddMtyRepoOutDetailListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOaddMtyRepoOutDetailListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_CTRL_BAL_RPT_LODG_MNL 데이터 입력
	  * </pre>
	  */
	public ForecastReportDBDAOaddMtyRepoOutDetailListCSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOaddMtyRepoOutDetailListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EQR_CTRL_BAL_RPT_LODG_MNL" ).append("\n"); 
		query.append("(" ).append("\n"); 
