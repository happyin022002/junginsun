...
*@FileName : ChassisMgsetInvoiceDBDAOaddCHSLeaseInvoiceDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChassisMgsetInvoiceDBDAOaddCHSLeaseInvoiceDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * chungpa 20091208 CGM_LSE_INV_TMP 일괄 insert
	  * </pre>
	  */
	public ChassisMgsetInvoiceDBDAOaddCHSLeaseInvoiceDataCSQL(){
		setQuery();
		...
		query.append("FileName : ChassisMgsetInvoiceDBDAOaddCHSLeaseInvoiceDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
