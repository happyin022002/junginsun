...
*@FileName : MGSChargeCreationMGTVO.java
*@FileTitle : MGSChargeCreationMGTVO
*Open Issues :
*Change history :
...
public class MGSChargeCreationMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSChargeCreationMGTVO> models = new ArrayList<MGSChargeCreationMGTVO>();
	 ...
	 * @param request
	 * @return MGSChargeCreationMGTVO[]
	 */
	public MGSChargeCreationMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSChargeCreationMGTVO[]
	 */
	public MGSChargeCreationMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSChargeCreationMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSChargeCreationMGTVO();
				if (agmtEffDt[i] != null)
				...
				if (costYrmonSeq[i] != null)
					model.setCostYrmon(costYrmonSeq[i]);
				models.add(model);
			}
		...
		return getMGSChargeCreationMGTVOs();
	}
	 ...
	 * @return MGSChargeCreationMGTVO[]
	 */
	public MGSChargeCreationMGTVO[] getMGSChargeCreationMGTVOs(){
		MGSChargeCreationMGTVO[] vos = (MGSChargeCreationMGTVO[])models.toArray(new MGSChargeCreationMGTVO[models.size()]);
		return vos;
	}
