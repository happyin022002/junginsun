...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOCreateEccInternalSoDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOCreateEccInternalSoDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_REPO_EXE_SO_IF 테이블에 ECC INTERANL의 SO 정보 입력 - 한진만 해당
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOCreateEccInternalSoDataCSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOCreateEccInternalSoDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
