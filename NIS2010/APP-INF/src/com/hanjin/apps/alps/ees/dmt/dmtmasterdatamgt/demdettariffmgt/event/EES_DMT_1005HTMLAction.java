...
*@FileName : EES_DMT_1005HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class EES_DMT_1005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_1003HTMLAction 객체를 생성
	 */
	public EES_DMT_1005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt1005Event event = new EesDmt1005Event();
        log.debug("::CALL::> EES_DMT_1005HTMLAction - " + command.getCommand());
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setCommodityTariffVOs(commodityTariffVO.fromRequestGrid(request));
		}
