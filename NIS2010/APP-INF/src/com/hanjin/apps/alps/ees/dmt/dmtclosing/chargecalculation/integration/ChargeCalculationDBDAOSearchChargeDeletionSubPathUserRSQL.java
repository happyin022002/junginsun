...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionSubPathUserRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionSubPathUserRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionSubPathUserRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionSubPathUserRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionSubPathUserRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            when count(1) = 0 then 'N' " ).append("\n"); 
		query.append("            when max(T1.CHG_DELT_STS_CD) <> @[chg_delt_sts_cd] then 'Y'" ).append("\n"); 
		query.append("            else 'N'" ).append("\n"); 
		query.append("        end" ).append("\n"); 
		query.append("  from  DMT_CHG_DELT_CNG_HIS  T1 " ).append("\n"); 
		...
		query.append("   and  T1.DELT_CNG_HIS_SEQ =" ).append("\n"); 
		query.append("		(" ).append("\n"); 
		query.append("			select  max(DELT_CNG_HIS_SEQ)" ).append("\n"); 
		query.append("			  from  DMT_CHG_DELT_CNG_HIS" ).append("\n"); 
		...
		query.append("			   and  CHG_OFC_CD 		    = T1.CHG_OFC_CD" ).append("\n"); 
		query.append("			   and  DELT_SEQ 		    = T1.DELT_SEQ" ).append("\n"); 
		query.append("			   and  CHG_DELT_PATH_LVL   < decode(T1.CHG_DELT_PATH_CD, 'BBG', 1, 'RHQ', 2, 'HDO', 3, 0)" ).append("\n"); 
