...
*@FileName : RepoThresholdManageDBDAOMergeExecutionFeedBackExptCSQL.java
...
public class RepoThresholdManageDBDAOMergeExecutionFeedBackExptCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_REPO_EXE_PLN_FB_EXPT 테이블의 데이터 수정/입력
	  * </pre>
	  */
	public RepoThresholdManageDBDAOMergeExecutionFeedBackExptCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("MERGE INTO EQR_REPO_EXE_PLN_FB_EXPT I" ).append("\n"); 
		query.append("USING" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("@[loc_grp_cd] AS LOC_GRP_CD" ).append("\n"); 
		query.append(",@[loc_cd] AS LOC_CD" ).append("\n"); 
		query.append(",@[fb_itm_cd] AS FB_ITM_CD" ).append("\n"); 
		query.append(",@[fb_itm_bse_cd] AS FB_ITM_BSE_CD" ).append("\n"); 
		query.append(",@[cntr_tpsz_cd] AS CNTR_TPSZ_CD" ).append("\n"); 
		query.append("FROM DUAL" ).append("\n"); 
		query.append(") M" ).append("\n"); 
		query.append("ON" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("I.LOC_GRP_CD     = M.LOC_GRP_CD" ).append("\n"); 
		query.append("AND I.LOC_CD = M.LOC_CD" ).append("\n"); 
		query.append("AND I.FB_ITM_CD = M.FB_ITM_CD" ).append("\n"); 
		query.append("AND I.FB_ITM_BSE_CD = M.FB_ITM_BSE_CD" ).append("\n"); 
		query.append("AND I.CNTR_TPSZ_CD  = M.CNTR_TPSZ_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("WHEN MATCHED THEN" ).append("\n"); 
		query.append("UPDATE" ).append("\n"); 
		query.append("SET I.FB_RTO    		= @[fb_rto]," ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("I.LOC_GRP_CD" ).append("\n"); 
		query.append(",I.LOC_CD" ).append("\n"); 
		...
		query.append("FileName : RepoThresholdManageDBDAOMergeExecutionFeedBackExptCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}