...
*@FileName : CntrForecastManageDBDAOSearchCntrGenerationAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAOSearchCntrGenerationAllRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * eqr_ob_fcast + eqr_ib_bkg_fcast  테이블 데이터 조회(All)
	  * 
	  * <Change History>
	  * 1	2009.08.12	Lee ByoungHun	최초작성
	  * </pre>
	  */
	public CntrForecastManageDBDAOSearchCntrGenerationAllRSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAOSearchCntrGenerationAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("GROUP BY" ).append("\n"); 
		query.append("SCNR_ID, A.FCAST_YRWK, A.CO_CD, FM_ECC_CD, TO_ECC_CD, A.CNTR_TPSZ_CD, FCAST_DT" ).append("\n"); 
		query.append(")A" ).append("\n"); 
		query.append("GROUP BY" ).append("\n"); 
		query.append("A.SCNR_ID, A.FCAST_YRWK, A.CO_CD, A.TO_ECC_CD, A.FM_ECC_CD" ).append("\n"); 
		query.append("ORDER BY" ).append("\n"); 
		query.append("A.SCNR_ID, A.FCAST_YRWK, A.TO_ECC_CD, A.FM_ECC_CD" ).append("\n"); 
