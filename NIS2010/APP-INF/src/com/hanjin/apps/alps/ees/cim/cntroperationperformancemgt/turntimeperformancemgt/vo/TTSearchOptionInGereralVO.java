...
public class TTSearchOptionInGereralVO extends AbstractValueObject {
	...
	/* Column Info */
	private String tpsztitle = null;
	/* Column Info */
	private String loctitle = null;
	/* Column Info */
	private String locvalue = null;
	/* Column Info */
	...
	public String getTpszTitle() {
		return tpsztitle;
	}

	public void setTpszTitle(String tpsztitle) {
		this.tpsztitle = tpsztitle;
	}
	...
	public TTSearchOptionInGereralVO(String ibflag, String pagerows, String period, String from, String to,
			...
			String mvmtPairDivision, String mvmtPair1, String mvmtPair2, String tpsztitle, String loctitle, String locvalue, String convalue) {
		this.enRoute = enRoute;
		this.period = period;
		this.ibflag = ibflag;
		this.from = from;
	...
	public HashMap<String, String> getColumnValues() {
		...
		this.hashColumns.put("tpsztitle", getTpszTitle());
		this.hashColumns.put("loctitle", getLocTitle());
		this.hashColumns.put("locvalue", getLocValue());
		this.hashColumns.put("convalue", getConValue());
	...
	public HashMap<String, String> getFieldNames() {
		...
		this.hashFields.put("tpsztitle", "tpsztitle");
		this.hashFields.put("loctitle", "loctitle");
		this.hashFields.put("locvalue", "locvalue");
		this.hashFields.put("convalue", "convalue");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTpszTitle(JSPUtil.getParameter(request, "tpsztitle", ""));
		setLocTitle(JSPUtil.getParameter(request, "loctitle", ""));
		setLocValue(JSPUtil.getParameter(request, "locvalue", ""));
		setConValue(JSPUtil.getParameter(request, "convalue", ""));
	...
	public TTSearchOptionInGereralVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] tpsztitle = (JSPUtil.getParameter(request, prefix + "tpsztitle".trim(), length));
			String[] loctitle = (JSPUtil.getParameter(request, prefix + "loctitle".trim(), length));
			String[] locvalue = (JSPUtil.getParameter(request, prefix + "locvalue".trim(), length));
			String[] convalue = (JSPUtil.getParameter(request, prefix + "convalue".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (tpsztitle[i] != null)
					model.setTpszTitle(tpsztitle[i]);
				if (loctitle[i] != null)
					model.setLocTitle(loctitle[i]);
				if (locvalue[i] != null)
					model.setLocValue(locvalue[i]);
				if (convalue[i] != null)
					model.setConValue(convalue[i]);
				if (pagerows[i] != null)
	...
	public void onDataFormat() {
		...
		this.tpsztitle = this.tpsztitle.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.loctitle = this.loctitle.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.locvalue = this.locvalue.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.convalue = this.convalue.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
