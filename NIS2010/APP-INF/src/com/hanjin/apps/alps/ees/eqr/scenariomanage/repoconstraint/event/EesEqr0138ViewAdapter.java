...
*@FileName : EesEqr0138ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class EesEqr0138ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		EesEqr0138ConditionVO conditionVO = (EesEqr0138ConditionVO) commonRsVO.getConditionVO();
		DBRowSet rs = commonRsVO.getDbRowset();
		
		String statusType = conditionVO.getStatus();
		...
		try{
			...
			while (rs.next()) { 
				sb.append("	<TR EDIT=\"" + statusType + "\"><![CDATA[");
