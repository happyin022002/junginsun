...
*@FileName : EES_MNR_0105HTMLAction.java
...
public class EES_MNR_0105HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0105HTMLAction 객체를 생성
	 */
	public EES_MNR_0105HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0105Event event = new EesMnr0105Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTotalLossLessorReportINVO((TotalLossLessorReportINVO)getVO(request, TotalLossLessorReportINVO .class));
		}
