...
package com.hanjin.apps.alps.ees.eqr.mtyequipmentforecast.mtyweeklysimulation.vo;
...
public class MtyWeeklySimulationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyWeeklySimulationVO> models = new ArrayList<MtyWeeklySimulationVO>();
...
/**
	 ...
	 */
	public MtyWeeklySimulationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyWeeklySimulationVO[]
	 */
	public MtyWeeklySimulationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyWeeklySimulationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MtyWeeklySimulationVO();
				if (f2Q[i] != null)
					model.setF2Q(f2Q[i]);
				if (sort[i] != null)
	...
	public MtyWeeklySimulationVO[] getMtyWeeklySimulationVOs(){
		MtyWeeklySimulationVO[] vos = (MtyWeeklySimulationVO[])models.toArray(new MtyWeeklySimulationVO[models.size()]);
		return vos;
	}
