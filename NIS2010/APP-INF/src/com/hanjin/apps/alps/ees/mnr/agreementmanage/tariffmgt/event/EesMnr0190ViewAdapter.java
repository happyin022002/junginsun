...
public class EesMnr0190ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		for(int i=0;i<realCnt;i++){
			...
			String errWarnFlg = colValues.get("inp_msg3");
			...
			if(rowMsg.equals("SS")) {
				...
				sbufXML.append("<TD EDIT=\"FALSE\"><![CDATA[");sbufXML.append(JSPUtil.getNull(colValues.get("inp_msg3")));sbufXML.append("]]></TD>");
				...
				if(errWarnFlg.equals("W")) {
					sbufXML.append("  <TD EDIT=\"TRUE\"><![CDATA[");sbufXML.append(JSPUtil.getNull(colValues.get("checkbox")));sbufXML.append("]]></TD>");
				} else{
				...
				sbufXML.append("<TD EDIT=\"TRUE\"><![CDATA[");sbufXML.append(JSPUtil.getNull(colValues.get("inp_msg3")));sbufXML.append("]]></TD>");
