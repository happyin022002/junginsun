...
*@FileName : VslResidualSpaceManageDBDAOUpdateVslRsdlSpaceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VslResidualSpaceManageDBDAOUpdateVslRsdlSpaceUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * EQR_SCNR_VSL_RSDL_CAPA 테이블에 데이터 수정
	  * </pre>
	  */
	public VslResidualSpaceManageDBDAOUpdateVslRsdlSpaceUSQL(){
		setQuery();
		...
		query.append("FileName : VslResidualSpaceManageDBDAOUpdateVslRsdlSpaceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EQR_SCNR_VSL_RSDL_CAPA SET" ).append("\n"); 
		query.append("VSL_BSA_SPC		= @[vsl_bsa_spc]" ).append("\n"); 
		query.append(",	VSL_FULL_SPC	= @[vsl_full_spc]" ).append("\n"); 
		query.append(",	VSL_DEAD_SPC	= @[vsl_dead_spc]" ).append("\n"); 
		query.append(",	VSL_SPC			= @[vsl_spc]" ).append("\n"); 
		query.append(",	TTL_RSDL_SPC	= @[ttl_rsdl_spc]" ).append("\n"); 
