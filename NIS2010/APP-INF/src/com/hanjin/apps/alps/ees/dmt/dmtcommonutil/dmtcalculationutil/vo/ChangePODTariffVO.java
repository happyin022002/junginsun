...
*@FileName : ChangePODTariffVO.java
*@FileTitle : ChangePODTariffVO
*Open Issues :
*Change history :
...
public class ChangePODTariffVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ChangePODTariffVO> models = new ArrayList<ChangePODTariffVO>();
	...
	public ChangePODTariffVO() {}

	public ChangePODTariffVO(String ibflag, String pagerows, String contiCd, String cntCd, String rgnCd, String steCd, String locCd) {
	 ...
	 */
	public ChangePODTariffVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ChangePODTariffVO[]
	 */
	public ChangePODTariffVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ChangePODTariffVO model = null;
	 ...
	 * @return ChangePODTariffVO[]
	 */
	public ChangePODTariffVO[] getChangePODTariffVOs(){
		ChangePODTariffVO[] vos = (ChangePODTariffVO[])models.toArray(new ChangePODTariffVO[models.size()]);
		return vos;
	}
