...
*@FileName : BkgContainerLastVO.java
*@FileTitle : BkgContainerLastVO
*Open Issues :
*Change history :
...
public class BkgContainerLastVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgContainerLastVO> models = new ArrayList<BkgContainerLastVO>();
	...
	public BkgContainerLastVO() {}

	public BkgContainerLastVO(String ibflag, String pagerows, String bkgNo, String cnmvCycNo, String vslCd, String skdVoyNo, String skdDirCd, String bkgCgoTpCd, String podCd, String delCd, String bbCgoFlg, String mtySplitAvalCd) {
		this.podCd = podCd;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return BkgContainerLastVO[]
	 */
	public BkgContainerLastVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgContainerLastVO[]
	 */
	public BkgContainerLastVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgContainerLastVO model = null;
	 ...
	 * @return BkgContainerLastVO[]
	 */
	public BkgContainerLastVO[] getBkgContainerLastVOs(){
		BkgContainerLastVO[] vos = (BkgContainerLastVO[])models.toArray(new BkgContainerLastVO[models.size()]);
		return vos;
	}
