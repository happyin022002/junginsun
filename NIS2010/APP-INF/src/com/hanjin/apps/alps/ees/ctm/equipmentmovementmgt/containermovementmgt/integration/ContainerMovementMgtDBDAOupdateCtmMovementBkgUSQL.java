...
*@FileName : ContainerMovementMgtDBDAOupdateCtmMovementBkgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOupdateCtmMovementBkgUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOupdateCtmMovementBkgUSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOupdateCtmMovementBkgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET BKG_NO = @[bkg_no],                     -- PARAM" ).append("\n"); 
		query.append("       UPD_DT = SYSDATE," ).append("\n"); 
		query.append("       BL_NO = @[bkg_no],                      -- PARAM" ).append("\n"); 
