...
public class DisposalPriceFileListINVO extends AbstractValueObject {
    
	private static final long serialVersionUID = 1L;
	 
	private Collection<DisposalPriceFileListINVO> models = new ArrayList<DisposalPriceFileListINVO>();
	...
	public DisposalPriceFileListINVO() {}

	/**
	 * EQFlagMgtINVO 객체를 생성   
	 */
	public DisposalPriceFileListINVO(String ibflag, String pagerows, String tmpSeq, String eqType, String dmgFlag) {
	 ...
	 */
	public DisposalPriceFileListINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EQFlagMgtINVO[]
	 */
	public DisposalPriceFileListINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DisposalPriceFileListINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new DisposalPriceFileListINVO();
				if (dmgFlag[i] != null)
	 ...
	 * @return EQFlagMgtINVO[]
	 */
	public DisposalPriceFileListINVO[] getEQFlagMgtINVOs(){
		DisposalPriceFileListINVO[] vos = (DisposalPriceFileListINVO[])models.toArray(new DisposalPriceFileListINVO[models.size()]);
		return vos;
	}
