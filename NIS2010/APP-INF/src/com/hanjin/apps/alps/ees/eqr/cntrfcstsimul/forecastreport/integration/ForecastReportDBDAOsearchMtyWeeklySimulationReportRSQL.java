...
public class ForecastReportDBDAOsearchMtyWeeklySimulationReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,DECODE(A.CODE,'BA','','SP','','ST','',A.A5$key) A5$key" ).append("\n"); 
		...
		query.append("              ,NVL(SUM(A.A5$key),0) A5$key  " ).append("\n"); 
		query.append("          #end      " ).append("\n"); 
		query.append("        FROM" ).append("\n"); 
		query.append("        (" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		...
		query.append("                      ,SUM(NVL(DECODE(A.CNTR_TPSZ_CD||A.WEEK, 'A5$key', A.CNTR_QTY),0)) A5$key" ).append("\n"); 
		...
		query.append("                      ,SUM(NVL(DECODE(A.CNTR_TPSZ_CD||A.MONTH, 'A5$key', A.CNTR_QTY),0)) A5$key" ).append("\n"); 
		query.append("                #end" ).append("\n"); 
		query.append("            #end" ).append("\n"); 
		query.append("                FROM" ).append("\n"); 
		query.append("                (" ).append("\n"); 
