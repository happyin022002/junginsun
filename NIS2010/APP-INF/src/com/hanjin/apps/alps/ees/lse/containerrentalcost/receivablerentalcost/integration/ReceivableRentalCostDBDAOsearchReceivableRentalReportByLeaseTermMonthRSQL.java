...
*@FileName : ReceivableRentalCostDBDAOsearchReceivableRentalReportByLeaseTermMonthRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceivableRentalCostDBDAOsearchReceivableRentalReportByLeaseTermMonthRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Receivable Invoice 한 결과에 대하여 Lease Term , Month별로 실적을 조회
	  * </pre>
	  */
	public ReceivableRentalCostDBDAOsearchReceivableRentalReportByLeaseTermMonthRSQL(){
		setQuery();
		...
		query.append("FileName : ReceivableRentalCostDBDAOsearchReceivableRentalReportByLeaseTermMonthRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   DISTINCT TO_CHAR(A.VNDR_SEQ)  VNDR_SEQ," ).append("\n"); 
		query.append("   SUBSTR(NVL(VNDR.VNDR_ABBR_NM, '   '), 1, 3) ABBR_NM ," ).append("\n"); 
		query.append("   NVL(D.LSTM_CD , '  ') LSTM_CD," ).append("\n"); 
		...
		query.append("  MST_CONTAINER D , PARAM P" ).append("\n"); 
		...
		query.append(" #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("GROUP BY A.VNDR_SEQ,SUBSTR(NVL(VNDR.VNDR_ABBR_NM, '   '), 1, 3), d.LSTM_CD )" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		...
		query.append("                ORDER BY LSTM_CD  , ABBR_NM1 ) AAA , ( SELECT LSTM_CD," ).append("\n"); 
		query.append("                                                          LSTM_NM," ).append("\n"); 
		query.append("                                                          DP_SEQ " ).append("\n"); 
		query.append("                                                       FROM MST_LSE_TERM" ).append("\n"); 
		query.append("                                                       ORDER BY DP_SEQ ) BBB" ).append("\n"); 
		query.append("                 WHERE AAA.LSTM_CD =  BBB.LSTM_CD" ).append("\n"); 
		query.append("                 ORDER BY BBB.DP_SEQ )" ).append("\n"); 
		query.append("          UNION ALL" ).append("\n"); 
		query.append("          SELECT" ).append("\n"); 
		...
		query.append("          SUM(G_TTL)" ).append("\n"); 
		query.append("          FROM XXX" ).append("\n"); 
		query.append("		  GROUP BY 3" ).append("\n"); 
