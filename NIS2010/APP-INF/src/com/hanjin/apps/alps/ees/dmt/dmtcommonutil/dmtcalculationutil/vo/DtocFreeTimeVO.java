...
*@FileName : DtocFreeTimeVO.java
*@FileTitle : DtocFreeTimeVO
*Open Issues :
*Change history :
...
public class DtocFreeTimeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DtocFreeTimeVO> models = new ArrayList<DtocFreeTimeVO>();
	...
	public DtocFreeTimeVO() {}

	public DtocFreeTimeVO(String ibflag, String pagerows, String cntrTpszCd, String bkgNo, String dcgoFlg, String rcFlg, String awkCgoFlg, String rdCgoFlg, String bbCgoFlg, String socFlg, String cntrPrtFlg, String advShtgCd, String porCd, String porContiCd, String porCntCd, String porRgnCd, String porSteCd, String polCd, String polContiCd, String polCntCd, String polRgnCd, String polSteCd, String delCd, String delContiCd, String delCntCd, String delRgnCd, String delSteCd, String yrdCd, String yrdContiCd, String yrdCntCd, String yrdRgnCd, String yrdSteCd, String deTermCd, String rcvTermCd, String cmdtCd, String scNo, String rfaNo, String repCmdtCd) {
		this.porCd = porCd;
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rep_cmdt_cd", "cmdtCd");
	 ...
	 */
	public DtocFreeTimeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DtocFreeTimeVO[]
	 */
	public DtocFreeTimeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DtocFreeTimeVO model = null;
	 ...
	 * @return DtocFreeTimeVO[]
	 */
	public DtocFreeTimeVO[] getDtocFreeTimeVOs(){
		DtocFreeTimeVO[] vos = (DtocFreeTimeVO[])models.toArray(new DtocFreeTimeVO[models.size()]);
		return vos;
	}
