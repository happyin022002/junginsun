...
*@FileName : EesLse0054ViewAdapter.java
*@FileTitle : EesLse0054ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0054 에 대한 ViewAdapter<br>
 * - EES_LSE_0054HTMLAction에서 작성<br>
 *
 * @author 남궁진호
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EesLse0054ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0054ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0054ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
    	...
    	try{
		    ...
		    if(totCnt > 0){
	    		while(rowSet.next()){
					...
					strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)rowSet.getString("location"	))+"]]></TD>");
					...
					strBuilder.append("  <TD><![CDATA["+JSPUtil.getNull((String)rowSet.getString("scc_cd"	))+"]]></TD>");
					strBuilder.append("</TR>\n");
	    		}
		    }
		...
		log.debug("########### EesLse0054ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
