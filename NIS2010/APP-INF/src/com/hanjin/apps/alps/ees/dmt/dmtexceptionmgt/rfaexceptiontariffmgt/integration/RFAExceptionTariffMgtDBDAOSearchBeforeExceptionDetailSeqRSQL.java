...
*@FileName : RFAExceptionTariffMgtDBDAOSearchBeforeExceptionDetailSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOSearchBeforeExceptionDetailSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Before Booking Request Version 에 최상위 Detail Seq. 를 조회하는 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOSearchBeforeExceptionDetailSeqRSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOSearchBeforeExceptionDetailSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	NVL(MAX(RFA_RQST_DTL_SEQ), 0) + 1" ).append("\n"); 
