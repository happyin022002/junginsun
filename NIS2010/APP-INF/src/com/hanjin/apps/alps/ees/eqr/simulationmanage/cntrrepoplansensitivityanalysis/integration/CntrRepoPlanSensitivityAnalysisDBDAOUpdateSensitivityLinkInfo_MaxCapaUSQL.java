...
*@FileName : CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_MaxCapaUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_MaxCapaUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ECC_LNK 테이블에 대한 CNTR MAX CAPA QTY 수정
	  * </pre>
	  */
	public CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_MaxCapaUSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_MaxCapaUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CNTR_MAX_CAPA_QTY = ${curr_limit}" ).append("\n"); 
