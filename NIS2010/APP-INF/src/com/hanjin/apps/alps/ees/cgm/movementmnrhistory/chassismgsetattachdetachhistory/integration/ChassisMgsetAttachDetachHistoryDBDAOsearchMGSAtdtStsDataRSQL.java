...
public class ChassisMgsetAttachDetachHistoryDBDAOsearchMGSAtdtStsDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",MAX(DECODE(CC.EQ_TPSZ_CD,'UMG',CC.CHSS_NO,CC.CNTR_NO)) CNTR_NO1" ).append("\n"); 
		query.append(",MAX(DECODE(CC.EQ_TPSZ_CD,'UMG',CC.CHSS_NO,CC.CNTR_NO)) CNTR_NO2" ).append("\n"); 
