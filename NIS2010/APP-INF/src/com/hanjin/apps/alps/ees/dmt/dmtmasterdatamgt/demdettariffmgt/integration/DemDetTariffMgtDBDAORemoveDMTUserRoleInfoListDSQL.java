...
*@FileName : DemDetTariffMgtDBDAORemoveDMTUserRoleInfoListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DemDetTariffMgtDBDAORemoveDMTUserRoleInfoListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DMT User별 Role 정보를 삭제 합니다.
	  * </pre>
	  */
	public DemDetTariffMgtDBDAORemoveDMTUserRoleInfoListDSQL(){
		setQuery();
		...
		query.append("FileName : DemDetTariffMgtDBDAORemoveDMTUserRoleInfoListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM DMT_USR_ROLE_MTCH" ).append("\n"); 
