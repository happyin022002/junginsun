...
public class EES_MST_0048HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MST_0048HTMLAction 객체를 생성
	 */
	public EES_MST_0048HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMst0048Event event = new EesMst0048Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEqMftPlanOptionVO((EqMftPlanOptionVO)getVO(request, EqMftPlanOptionVO.class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setEqMftPlanListVOs((EqMftPlanListVO[])getVOs(request, EqMftPlanListVO.class,""));			
		}
