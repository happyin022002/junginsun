...
*@FileName : EES_CGM_1112HTMLAction.java
...
public class EES_CGM_1112HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1112HTMLAction 객체를 생성
	 */
	public EES_CGM_1112HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1112Event event = new EesCgm1112Event();
		
		CHSUtilizationINVO cHSUtilizationINVO = new CHSUtilizationINVO();
				
		if(command.isCommand(FormCommand.SEARCH)) {
			cHSUtilizationINVO = (CHSUtilizationINVO)getVO(request, CHSUtilizationINVO .class);
			event.setCHSUtilizationINVO(cHSUtilizationINVO);
		}		
		return  event;
	}
