...
*@FileName : EES_CIM_1040HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class EES_EQR_1040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1040HTMLAction 객체를 생성
	 */
	public EES_EQR_1040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1040Event event = new EesEqr1040Event();
		...
		String wk_end_dt    = request.getParameter("wk_end_dt");
		...
		event.setAttribute("wk_end_dt", wk_end_dt);	
		...
		event.setPlannedRepoInVO((PlannedRepoInVO)getVO(request, PlannedRepoInVO .class));
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPlannedRepoInVOS((PlannedRepoInVO[])getVOs(request, PlannedRepoInVO .class,""));
		}
