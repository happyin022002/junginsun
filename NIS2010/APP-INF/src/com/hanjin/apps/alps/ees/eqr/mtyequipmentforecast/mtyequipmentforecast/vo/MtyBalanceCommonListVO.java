...
public class MtyBalanceCommonListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MtyBalanceCommonListVO> models = new ArrayList<MtyBalanceCommonListVO>();
	...
	public MtyBalanceCommonListVO() {}

	public MtyBalanceCommonListVO(String ibflag, String pagerows, String ydCd, String ydNm, String dateListByWeek) {
	 ...
	 */
	public MtyBalanceCommonListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyBalanceCommonListVO[]
	 */
	public MtyBalanceCommonListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MtyBalanceCommonListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MtyBalanceCommonListVO();
	 ...
	 * @return MtyBalanceCommonListVO[]
	 */
	public MtyBalanceCommonListVO[] getMtyBalanceCommonListVOs(){
		MtyBalanceCommonListVO[] vos = (MtyBalanceCommonListVO[])models.toArray(new MtyBalanceCommonListVO[models.size()]);
		return vos;
	}
