...
*@FileName : MGSInvoiceInquiryMGTVO.java
*@FileTitle : MGSInvoiceInquiryMGTVO
*Open Issues :
*Change history :
...
public class MGSInvoiceInquiryMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSInvoiceInquiryMGTVO> models = new ArrayList<MGSInvoiceInquiryMGTVO>();
	 ...
	 */
	public MGSInvoiceInquiryMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSInvoiceInquiryMGTVO[]
	 */
	public MGSInvoiceInquiryMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSInvoiceInquiryMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSInvoiceInquiryMGTVO();
		...
		return getMGSInvoiceInquiryMGTVOs();
	}
	...
	public MGSInvoiceInquiryMGTVO[] getMGSInvoiceInquiryMGTVOs(){
		MGSInvoiceInquiryMGTVO[] vos = (MGSInvoiceInquiryMGTVO[])models.toArray(new MGSInvoiceInquiryMGTVO[models.size()]);
		return vos;
	}
