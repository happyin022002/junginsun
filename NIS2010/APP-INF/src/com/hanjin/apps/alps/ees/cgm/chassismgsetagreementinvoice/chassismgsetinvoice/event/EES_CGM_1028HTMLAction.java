...
*@FileName : EES_CGM_1028HTMLAction.java
...
public class EES_CGM_1028HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1028HTMLAction 객체를 생성
	 */
	public EES_CGM_1028HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1028Event event = new EesCgm1028Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setChsLessorAgmtMatchingINVOS((CHSLessorAgmtMatchingINVO[])getVOs(request, CHSLessorAgmtMatchingINVO.class, ""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setChsLessorAgmtMatchingINVO((CHSLessorAgmtMatchingINVO)getVO(request, CHSLessorAgmtMatchingINVO.class));
		}
