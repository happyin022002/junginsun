...
*@FileName : EES_DMT_4018HTMLAction.java
...
public class EES_DMT_4018HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        EesDmt4018Event event = new EesDmt4018Event();
        ...
        if(command.isCommand(FormCommand.SEARCH)) {
        	...
        	OTSCleanDetailExcelListVO[] OTSCleanDetailExcelListVOs = (OTSCleanDetailExcelListVO[]) getVOs(request, OTSCleanDetailExcelListVO.class, "");
            event.setoTSCleanDetailExcelListVOs(OTSCleanDetailExcelListVOs);
        }
