...
*@FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionRateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOModifyBeforeExceptionRateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RFA Exception Terms Entry 에 대한 Rate Adjustment 수정용 쿼리
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOModifyBeforeExceptionRateUSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionRateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_RFA_EXPT_RT SET " ).append("\n"); 
		...
		query.append(",	CNTR_R9_RT_AMT = @[cntr_r9_rt_amt]" ).append("\n"); 
		...
		query.append("AND	RFA_EXPT_RT_SEQ = @[rfa_expt_rt_seq]" ).append("\n"); 
