...
*@FileName : EES_EQR_0071HTMLAction.java
...
public class EES_EQR_0071HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0071HTMLAction 객체를 생성
	 */
	public EES_EQR_0071HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0071Event event = new EesEqr0071Event();
		
		// Retrieve 버튼 클릭시
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setEesEqr0071ConditionVO((EesEqr0071ConditionVO)getVO(request, EesEqr0071ConditionVO .class));
		}
