...
public class EmptyReleaseRedeliveryOrderMgtDBDAOManageSTKSendFaxEmailCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("TO_DATE (TO_CHAR (GLOBALDATE_PKG.TIME_CONV_FNC ('KRSEL', SYSDATE, GLOBALDATE_PKG.GET_LOCCD_FNC(@[user_ofc])), 'YYYY-MM-DD HH24:MI'), 'YYYY-MM-DD HH24:MI')," ).append("\n"); 
		query.append("'MT'," ).append("\n"); 
		query.append("@[job_seq]," ).append("\n"); 
		query.append("GLOBALDATE_PKG.TIME_CONV_FNC ('KRSEL', SYSDATE, SUBSTR(@[empty_cy], 1, 5))," ).append("\n"); 
		query.append("GLOBALDATE_PKG.TIME_CONV_FNC ('KRSEL', SYSDATE, SUBSTR(@[empty_cy], 1, 5))," ).append("\n"); 
