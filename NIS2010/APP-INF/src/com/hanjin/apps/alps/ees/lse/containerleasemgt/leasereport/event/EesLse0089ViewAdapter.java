...
*@FileName : EesLse0089ViewAdapter.java
*@FileTitle : EesLse0089ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0089 에 대한 ViewAdapter<br>
 * - EES_LSE_0089HTMLAction에서 작성<br>
 *
 * @author 남궁진호
 * @see HTMLAction 참조
 * @since J2EE 1.6
 */
public class EesLse0089ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0089ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0089ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesLse0089ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
