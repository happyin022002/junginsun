...
*@FileName : EES_CGM_1022HTMLAction.java
...
public class EES_CGM_1022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1022HTMLAction 객체를 생성
	 */
	public EES_CGM_1022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1022Event event = new EesCgm1022Event();
