...
*@FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_str40QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InputDataRLAExamineDBDAOUpdateRLAEccInfo_str40QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_ECC  테이블에 대한 STO 40feet amount  수정
	  * </pre>
	  */
	public InputDataRLAExamineDBDAOUpdateRLAEccInfo_str40QueryUSQL(){
		setQuery();
		...
		query.append("FileName : InputDataRLAExamineDBDAOUpdateRLAEccInfo_str40QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
