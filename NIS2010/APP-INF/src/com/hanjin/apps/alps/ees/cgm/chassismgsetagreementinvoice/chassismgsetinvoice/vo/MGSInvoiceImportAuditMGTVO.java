...
*@FileName : MGSInvoiceImportAuditMGTVO.java
*@FileTitle : MGSInvoiceImportAuditMGTVO
*Open Issues :
*Change history :
...
public class MGSInvoiceImportAuditMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSInvoiceImportAuditMGTVO> models = new ArrayList<MGSInvoiceImportAuditMGTVO>();
...
/**
	 ...
	 */
	public MGSInvoiceImportAuditMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSInvoiceImportAuditMGTVO[]
	 */
	public MGSInvoiceImportAuditMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSInvoiceImportAuditMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MGSInvoiceImportAuditMGTVO();
		...
		return getMGSInvoiceImportAuditMGTVOs();
	}
	 ...
	 * @return MGSInvoiceImportAuditMGTVO[]
	 */
	public MGSInvoiceImportAuditMGTVO[] getMGSInvoiceImportAuditMGTVOs(){
		MGSInvoiceImportAuditMGTVO[] vos = (MGSInvoiceImportAuditMGTVO[])models.toArray(new MGSInvoiceImportAuditMGTVO[models.size()]);
		return vos;
	}
