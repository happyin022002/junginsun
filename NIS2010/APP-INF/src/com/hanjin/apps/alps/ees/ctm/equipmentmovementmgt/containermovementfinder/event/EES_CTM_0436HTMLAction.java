...
*@FileName : EES_CTM_0436HTMLAction.java
...
public class EES_CTM_0436HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0436HTMLAction 객체를 생성
	 */
	public EES_CTM_0436HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0436Event event = new EesCtm0436Event();
		

		if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01) || command.isCommand(FormCommand.SEARCH02)  || command.isCommand(FormCommand.SEARCH03) || command.isCommand(FormCommand.SEARCH04) || command.isCommand(FormCommand.SEARCH05)) {
			event.setSearchMovementHistoryMonitorListVO((SearchMovementHistoryMonitorListVO)getVO(request, SearchMovementHistoryMonitorListVO.class));
		}
