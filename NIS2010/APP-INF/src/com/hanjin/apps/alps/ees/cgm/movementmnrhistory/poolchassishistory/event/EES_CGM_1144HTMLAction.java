...
*@FileName : EES_CGM_1144HTMLAction.java
...
public class EES_CGM_1144HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1144HTMLAction 객체를 생성
	 */
	public EES_CGM_1144HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1144Event event = new EesCgm1144Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPoolMnrHistoryINVO((PoolMnrHistoryINVO)getVO(request, PoolMnrHistoryINVO .class));
		}
