...
*@FileName : DodValidationDBDAOcheckCntrNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DodValidationDBDAOcheckCntrNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DodValidationDBDAOcheckCntrNoRSQL(){
		setQuery();
		...
		query.append("FileName : DodValidationDBDAOcheckCntrNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE CNTR_NO = @[s_value]" ).append("\n"); 
