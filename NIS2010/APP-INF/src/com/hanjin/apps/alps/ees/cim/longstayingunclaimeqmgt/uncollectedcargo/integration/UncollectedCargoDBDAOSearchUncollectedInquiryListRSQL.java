...
*@FileName : UncollectedCargoDBDAOSearchUncollectedInquiryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOSearchUncollectedInquiryListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UncollectedCargoDBDAOSearchUncollectedInquiryListRSQL(){
		setQuery();
		...
		query.append("FileName : UncollectedCargoDBDAOSearchUncollectedInquiryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , (SELECT CNTR_TPSZ_CD FROM MST_CONTAINER WHERE CNTR_NO = AA.CNTR_NO) AS CNTR_TPSZ_CD" ).append("\n"); 
		...
		query.append("    , UC_CGO_RHQ_MM_DESC" ).append("\n"); 
		query.append("    , UC_CGO_HO_MM_DESC" ).append("\n"); 
		...
		query.append("		, (NVL(DTL.OTS_OFT_AMT,0) + NVL(DTL.OTS_OTR_AMT,0) + NVL(DTL.OTS_DMDT_AMT,0) + NVL(DTL.OTS_STO_AMT,0) + NVL(DTL.OTS_OTR_COST_AMT,0)) AS OTS_OTR_COST_AMT" ).append("\n"); 
		query.append("		, DTL.OTS_RCVR_AMT" ).append("\n"); 
		query.append("		, (NVL(DTL.OTS_OFT_AMT,0) + NVL(DTL.OTS_OTR_AMT,0) + NVL(DTL.OTS_DMDT_AMT,0) + NVL(DTL.OTS_STO_AMT,0) + NVL(DTL.OTS_OTR_COST_AMT,0)) - NVL(DTL.OTS_RCVR_AMT,0) AS NET_LOSS" ).append("\n"); 
		...
		query.append("           ) CMDT  " ).append("\n"); 
		query.append("        , SUBSTR (DTL.FACT_FND_ACT_DESC, 1, 3900) FACT_FND_ACT_DESC" ).append("\n"); 
		query.append("        , DTL.HNDL_OFC_OPIN_DESC" ).append("\n"); 
		query.append("        , DTL.KNTR_OFC_OPIN_DESC" ).append("\n"); 
		query.append("        , DTL.UC_CGO_RHQ_MM_DESC" ).append("\n"); 
		query.append("        , DTL.UC_CGO_HO_MM_DESC   " ).append("\n"); 
		query.append("        , TO_CHAR(CGO.UPD_DT, 'YYYY-MM-DD') UPD_DT      " ).append("\n"); 
		...
		query.append("   ORDER BY CGO.UC_CS_NO" ).append("\n"); 
