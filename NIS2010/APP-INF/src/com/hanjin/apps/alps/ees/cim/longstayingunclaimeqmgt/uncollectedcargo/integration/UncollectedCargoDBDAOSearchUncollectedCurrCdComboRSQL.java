...
*@FileName : UncollectedCargoDBDAOSearchUncollectedCurrCdComboRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UncollectedCargoDBDAOSearchUncollectedCurrCdComboRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UncollectedCargoDBDAOSearchUncollectedCurrCdComboRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.cim.longstayingunclaimeqmgt.uncollectedcargo.integration").append("\n"); 
		query.append("FileName : UncollectedCargoDBDAOSearchUncollectedCurrCdComboRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
