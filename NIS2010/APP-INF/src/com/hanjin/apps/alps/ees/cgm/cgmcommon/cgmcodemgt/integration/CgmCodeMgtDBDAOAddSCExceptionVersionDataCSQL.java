...
*@FileName : CgmCodeMgtDBDAOAddSCExceptionVersionDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CgmCodeMgtDBDAOAddSCExceptionVersionDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CgmCodeMgtDBDAOAddSCExceptionVersionDataCSQL(){
		setQuery();
		...
		query.append("FileName : CgmCodeMgtDBDAOAddSCExceptionVersionDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CGM_SC_EXPT_VER (" ).append("\n"); 
