...
public class ChargeAmountDiscountMgtDBDAOModifyAfterBookingDARUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("	,	AFT_BKG_CM_AMT = @[aft_bkg_cm_amt]" ).append("\n"); 
		query.append("	,	AFT_BKG_XCH_RT = @[xch_rt]" ).append("\n"); 
		query.append("	,	AFT_BKG_XCH_RT_LVL = DECODE(@[xch_rt_lvl],'V','1','M','2','')" ).append("\n"); 
		query.append("" ).append("\n"); 
