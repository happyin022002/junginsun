...
*@FileName : CntrRepoPlanOptiExecuteDBDAOSearchMonitorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanOptiExecuteDBDAOSearchMonitorRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 실시간으로 엔진 running 상태를 체크를 한다.
	  * </pre>
	  */
	public CntrRepoPlanOptiExecuteDBDAOSearchMonitorRSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanOptiExecuteDBDAOSearchMonitorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
