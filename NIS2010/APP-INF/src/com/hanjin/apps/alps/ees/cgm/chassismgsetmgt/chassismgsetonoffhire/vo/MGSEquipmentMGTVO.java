...
*@FileName : MGSEquipmentMGTVO.java
*@FileTitle : MGSEquipmentMGTVO
*Open Issues :
*Change history :
...
public class MGSEquipmentMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGSEquipmentMGTVO> models = new ArrayList<MGSEquipmentMGTVO>();
	...
	/* Column Info */
	private String disposalChk = null;
	/* Column Info */
	...
	/* Column Info */
	private String chssTareWgtKgs = null;
	...
	public MGSEquipmentMGTVO() {}

	public MGSEquipmentMGTVO(String ibflag, String pagerows, String eqNo, String aciacDivCd, String eqTpszCd, String agmtLstmCd, String crntYdCd, String mftDt, String eqSpecNo, String mgstMchnSerNo, String mgstVltgCapa, String mgstFuelCapa, String mgstRunHrs, String mgstRunHrsUpdDt, String mgstWarrEndDt, String onhOfcCd, String onhDt, String agreementNo, String agmtRefNo, String creDt, String creUsrId, String updDt, String updUsrId, String eqKndCd, String vndrSeq, String cntrChk, String chsChk, String atchCntr, String atchChs, String bareChk, String damageChk, String disposalChk, String chssTareWgt, String chssTareWgtKgs) {
		...
		this.mftDt = mftDt;
		this.disposalChk = disposalChk;
		this.chsChk = chsChk;
		this.creUsrId = creUsrId;
		this.vndrSeq = vndrSeq;
		this.chssTareWgt = chssTareWgt;
		this.chssTareWgtKgs = chssTareWgtKgs;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("disposal_chk", getDisposalChk());
		this.hashColumns.put("chs_chk", getChsChk());
		this.hashColumns.put("cre_usr_id", getCreUsrId());
		this.hashColumns.put("vndr_seq", getVndrSeq());
		this.hashColumns.put("chss_tare_wgt", getChssTareWgt());
		this.hashColumns.put("chss_tare_wgt_kgs", getChssTareWgtKgs());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("disposal_chk", "disposalChk");
		this.hashFields.put("chs_chk", "chsChk");
		this.hashFields.put("cre_usr_id", "creUsrId");
		this.hashFields.put("vndr_seq", "vndrSeq");
		this.hashFields.put("chss_tare_wgt", "chssTareWgt");
		this.hashFields.put("chss_tare_wgt_kgs", "chssTareWgtKgs");
	 ...
	 * @return disposalChk
	 */
	public String getDisposalChk() {
		return this.disposalChk;
	}
	...
	/**
	 * Column Info
	 * @return chssTareWgtKgs
	 */
	public String getChssTareWgtKgs() {
		return this.chssTareWgtKgs;
	}
	 ...
	 * @param disposalChk
	 */
	public void setDisposalChk(String disposalChk) {
		this.disposalChk = disposalChk;
	}
	...
	/**
	 * Column Info
	 * @param chssTareWgtKgs
	 */
	public void setChssTareWgtKgs(String chssTareWgtKgs) {
		this.chssTareWgtKgs = chssTareWgtKgs;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDisposalChk(JSPUtil.getParameter(request, prefix + "disposal_chk", ""));
		setChsChk(JSPUtil.getParameter(request, prefix + "chs_chk", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setVndrSeq(JSPUtil.getParameter(request, prefix + "vndr_seq", ""));
		setChssTareWgt(JSPUtil.getParameter(request, prefix + "chss_tare_wgt", ""));
		setChssTareWgtKgs(JSPUtil.getParameter(request, prefix + "chss_tare_wgt_kgs", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return MGSEquipmentMGTVO[]
	 */
	public MGSEquipmentMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGSEquipmentMGTVO[]
	 */
	public MGSEquipmentMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGSEquipmentMGTVO model = null;
		...
		try {
			...
			String[] disposalChk = (JSPUtil.getParameter(request, prefix	+ "disposal_chk", length));
			...
			String[] chssTareWgtKgs = (JSPUtil.getParameter(request, prefix	+ "chss_tare_wgt_kgs", length));
			
			for (int i = 0; i < length; i++) {
				model = new MGSEquipmentMGTVO();
				...
				if (disposalChk[i] != null)
					model.setDisposalChk(disposalChk[i]);
				if (chsChk[i] != null)
				...
				if (chssTareWgtKgs[i] != null)
					model.setChssTareWgtKgs(chssTareWgtKgs[i]);
				models.add(model);
			}
	 ...
	 * @return MGSEquipmentMGTVO[]
	 */
	public MGSEquipmentMGTVO[] getMGSEquipmentMGTVOs(){
		MGSEquipmentMGTVO[] vos = (MGSEquipmentMGTVO[])models.toArray(new MGSEquipmentMGTVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.disposalChk = this.disposalChk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.chssTareWgtKgs = this.chssTareWgtKgs .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
