...
*@FileName : EES_EQR_001HTMLAction.java
 ...
 *
 * @author chung eun ho
 * @see EesEqr0001Event 참조
 * @since J2EE 1.6
 */
public class EES_EQR_0001HTMLAction extends HTMLActionSupport {
	...
	/**
	 * EES_EQR_001HTMLAction 객체를 생성
	 */
	public EES_EQR_0001HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EES_EQR_001Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EesEqr0001Event event = new EesEqr0001Event();
...
//		 Save 버튼 클릭시 
		if(f_cmd.isCommand(FormCommand.MULTI)) {	
			EqrInpDatRedLgtAltVO vos = new EqrInpDatRedLgtAltVO();
		    event.setEqrInpDatRedLgtAltVOS(vos.fromRequestGrid(request)); // 변경 될 DTD setting (EqrInpDatRedLgtAltVO[])getVOs(request, EqrInpDatRedLgtAltVO .class,"")
		}
		
        event.setCommandClassName("DefaultManageSC");
