...
*@FileName : ChargeCalculationDBDAOModifyChargeDeletionEmlSndNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOModifyChargeDeletionEmlSndNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOModifyChargeDeletionEmlSndNoUSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOModifyChargeDeletionEmlSndNoUSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOModifyChargeDeletionEmlSndNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("update  DMT_CHG_DELT_CNG_HIS " ).append("\n"); 
		...
		query.append("   and  DELT_CNG_HIS_SEQ    = to_number(@[delt_cng_his_seq])" ).append("\n"); 
