...
*@FileName : EES_CIM_0060HTMLAction.java
...
public class EES_CIM_0060HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_0060HTMLAction 객체를 생성
	 */
	public EES_CIM_0060HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCim0060Event event = new EesCim0060Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRhqCd(request.getParameter("rhq_cd"));
			event.setPeriodWeek(request.getParameter("period_week"));
			...
			event.setCimEqSplsDfctStsVOS ((CimEqSplsDfctStsVO[])getVOs(request, CimEqSplsDfctStsVO.class,""));
		}
