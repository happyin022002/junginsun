...
*@FileName : CntrRepoExecutionPlanEstablishDBDAODeleteInlandSoDataDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAODeleteInlandSoDataDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Inland EQR_REPO_EXE_SO_IF       삭제   ( 해당 REF_ID )
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAODeleteInlandSoDataDSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAODeleteInlandSoDataDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
