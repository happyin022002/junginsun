...
*@FileName : EES_LSE_0034HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_LSE_0034HTMLAction extends HTMLActionSupport {
	/*
	 * 객체직렬화 버젼 UID
	 */
	...
	/**
	 * EES_LSE_0034HTMLAction 객체를 생성
	 */
	public EES_LSE_0034HTMLAction() {
		//do nothing
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException { 
		...
		EesLse0034Event event = new EesLse0034Event();
		
		switch(command.getCommand()) {
			case FormCommand.SEARCH01 :	//유효성 검증
			case FormCommand.SEARCH :	//조회			
				event.setPlanSearchVO((PlanSearchVO)getVO(request, PlanSearchVO.class));
				break;
			case FormCommand.MULTI :	//멀티
				event.setLeasePlanVOs((LeasePlanVO[])getVOs(request, LeasePlanVO.class));	
				break;
			default :	//do nothing
		}
