...
*@FileName : EesEqr0007ViewAdapter.java
*@FileTitle : EesEqr0007ViewAdapter
*Open Issues :
*Change history :
* No.	Ver.		Modifier           			modifier date    explanation
* 1      	1.0      	Lee Byoung Hun		2009.07.20		1.0 최초 생성
*
 ...
 * @since J2EE 1.5
 */
public class EesEqr0007ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		EesEqr0007ConditionVO conditionVO = (EesEqr0007ConditionVO) commonRsVO.getConditionVO();
		List<AbstractValueObject> resultVOList = commonRsVO.getResultVOList();
		...
		for(int i=0;i<realCnt;i++){
			Map<String, String> colValues = resultVOList.get(i).getColumnValues();
