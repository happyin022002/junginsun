...
*@FileName : SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfPrevVersionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfPrevVersionCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 이전 버전의 모든 S/C Exception Tariff Free Time 정보를 신규 버전으로 생성하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfPrevVersionCSQL(){
		setQuery();
		...
		query.append("FileName : SCExceptionTariffMgtDBDAOAddSCExceptionFreeTimeOfPrevVersionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
