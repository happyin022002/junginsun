...
*@FileName : EES_MNR_0272HTMLAction.java
*@FileTitle : On-site Inspection Result Detail Pop Up
*Open Issues :
*Change history :
...
public class EES_MNR_0272HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0272HTMLAction 객체를 생성
	 */
	public EES_MNR_0272HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EesMnr0272Event event = new EesMnr0272Event();
		FormCommand command = FormCommand.fromRequest(request);
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMnrOnSiteVO((MnrOnSiteVO)getVO(request, MnrOnSiteVO.class));
			event.setMnrOnSiteVOs((MnrOnSiteVO[])getVOs(request, MnrOnSiteVO.class,"sheet1_"));
