...
*@FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimesDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimesDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * S/C Exception Terms Entry 의 하위 Tiered Free Time 을 삭제하는 쿼리
	  * </pre>
	  */
	public SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimesDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SCExceptionTariffMgtDBDAORemoveSCExceptionFreeTimesDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}