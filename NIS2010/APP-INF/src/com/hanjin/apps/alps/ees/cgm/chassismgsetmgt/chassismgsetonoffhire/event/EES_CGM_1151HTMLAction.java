...
*@FileName : EES_CGM_1151HTMLAction.java
...
public class EES_CGM_1151HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CGM_1151HTMLAction 객체를 생성
	 */
	public EES_CGM_1151HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCgm1151Event event = new EesCgm1151Event();
