...
public class ExpenseMgtDBDAOaddPayableInvoiceDataCSQL implements ISQLTemplate{
	...
	public ExpenseMgtDBDAOaddPayableInvoiceDataCSQL(){
		...
		params.put("env_chg_tax",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(",ENV_CHG_TAX" ).append("\n"); 
		...
		query.append(",sysdate" ).append("\n"); 
		query.append(",@[file_seq]" ).append("\n"); 
		query.append(",REPLACE (NVL(@[env_chg_tax],'0'), ',', '')-- 인도지역에서 부과하는 SBC Tax(환경부담금)" ).append("\n"); 
		query.append(")" ).append("\n"); 
