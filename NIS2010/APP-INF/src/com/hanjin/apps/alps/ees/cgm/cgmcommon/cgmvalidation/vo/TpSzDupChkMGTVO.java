...
*@FileName : TpSzDupChkMGTVO.java
*@FileTitle : TpSzDupChkMGTVO
*Open Issues :
*Change history :
...
public class TpSzDupChkMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TpSzDupChkMGTVO> models = new ArrayList<TpSzDupChkMGTVO>();
	...
	public TpSzDupChkMGTVO() {}

	public TpSzDupChkMGTVO(String ibflag, String pagerows, String eqTpszCd, String eqKndCd, String eqTpszRepCd, String diffDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public TpSzDupChkMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TpSzDupChkMGTVO[]
	 */
	public TpSzDupChkMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TpSzDupChkMGTVO model = null;
	...
	public TpSzDupChkMGTVO[] getTpSzDupChkMGTVOs(){
		TpSzDupChkMGTVO[] vos = (TpSzDupChkMGTVO[])models.toArray(new TpSzDupChkMGTVO[models.size()]);
		return vos;
	}
