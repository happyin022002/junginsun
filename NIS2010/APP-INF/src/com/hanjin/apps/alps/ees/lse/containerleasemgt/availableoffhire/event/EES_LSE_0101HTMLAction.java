...
*@FileName : EES_LSE_0101HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_LSE_0101HTMLAction extends HTMLActionSupport {
	/*
	 * 객체직렬화 버젼 UID
	 */
	...
	/**
	 * EES_LSE_0101HTMLAction 객체를 생성
	 */
	public EES_LSE_0101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0101Event event = new EesLse0101Event();
