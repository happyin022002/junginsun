...
*@FileName : SearchVslRsdlSpaceVO.java
*@FileTitle : SearchVslRsdlSpaceVO
*Open Issues :
*Change history :
...
public class SearchVslRsdlSpaceVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchVslRsdlSpaceVO> models = new ArrayList<SearchVslRsdlSpaceVO>();
	...
	public SearchVslRsdlSpaceVO() {}

	public SearchVslRsdlSpaceVO(String ibflag, String pagerows, String coCd, String fcastYrwk, String ecc_cd, String vslLaneCd, String vvd, String vslBsaSpc, String vslFullSpc, String vslDeadSpc, String vslRsdlSpc, String vslSpc, String ttlRsdlSpc, String scnrId) {
		this.coCd = coCd;
		this.scnrId = scnrId;
	 ...
	 * @param ecc_cd
	 */
	public void setEccCd(String ecc_cd) {
		this.ecc_cd = ecc_cd;
	}
	 ...
	 * @param request
	 * @return SearchVslRsdlSpaceVO[]
	 */
	public SearchVslRsdlSpaceVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchVslRsdlSpaceVO[]
	 */
	public SearchVslRsdlSpaceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchVslRsdlSpaceVO model = null;
		...
		try {
			...
			String[] ecc_cd = (JSPUtil.getParameter(request, prefix	+ "ecc_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchVslRsdlSpaceVO();
				if (coCd[i] != null)
		...
		return getSearchVslRsdlSpaceVOs();
	}
	 ...
	 * @return SearchVslRsdlSpaceVO[]
	 */
	public SearchVslRsdlSpaceVO[] getSearchVslRsdlSpaceVOs(){
		SearchVslRsdlSpaceVO[] vos = (SearchVslRsdlSpaceVO[])models.toArray(new SearchVslRsdlSpaceVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ecc_cd = this.ecc_cd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
