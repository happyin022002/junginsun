...
*@FileName : OnewaySimulateDBDAOSearchOneWayMain01RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnewaySimulateDBDAOSearchOneWayMain01RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OnewaySimulateDBDAOSearchOneWayMain01RSQL(){
		setQuery();
		...
		query.append("FileName : OnewaySimulateDBDAOSearchOneWayMain01RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SUM(A.PLAN${key.field1}) + (${key.field2} - SUM(A.PLAN${key.field1}))" ).append("\n"); 
		query.append("END" ).append("\n"); 
		query.append("END   PLNA${key.field1}" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(", A.numm" ).append("\n"); 
		query.append(", @[repo_pln_id] repo_pln_id" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		...
		query.append(", TO_ECC_CD" ).append("\n"); 
		query.append("#foreach( ${key} in ${cntrTpSzList})" ).append("\n"); 
		query.append(", ROUND(${key.field1}/DECODE(${key.field1}SUM,0,1,${key.field1}SUM) * ${key.field2}  ,0)  OFFER${key.field1}" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(", 'O/F Offer' Division" ).append("\n"); 
		query.append(", '2' numm" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
