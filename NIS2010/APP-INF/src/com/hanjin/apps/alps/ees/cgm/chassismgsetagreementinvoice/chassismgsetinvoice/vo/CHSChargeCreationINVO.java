...
*@FileName : CHSChargeCreationINVO.java
*@FileTitle : CHSChargeCreationINVO
*Open Issues :
*Change history :
...
public class CHSChargeCreationINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSChargeCreationINVO> models = new ArrayList<CHSChargeCreationINVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setComboPool(JSPUtil.getParameter(request, "combo_pool", ""));
		setInvNo(JSPUtil.getParameter(request, "inv_no", ""));
		setOrgInvNo(JSPUtil.getParameter(request, "org_inv_no", ""));
		setCmbInvTp(JSPUtil.getParameter(request, "cmb_inv_tp", ""));
	 ...
	 */
	public CHSChargeCreationINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSChargeCreationINVO[]
	 */
	public CHSChargeCreationINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSChargeCreationINVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSChargeCreationINVO();
				if (agmtEffDt[i] != null)
		...
		return getCHSChargeCreationINVOs();
	}
	...
	public CHSChargeCreationINVO[] getCHSChargeCreationINVOs(){
		CHSChargeCreationINVO[] vos = (CHSChargeCreationINVO[])models.toArray(new CHSChargeCreationINVO[models.size()]);
		return vos;
	}
