...
*@FileName : ContainerMovementMgtDBDAOsearchBookingInfoByBkgNoAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMgtDBDAOsearchBookingInfoByBkgNoAllRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMgtDBDAOsearchBookingInfoByBkgNoAllRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMgtDBDAOsearchBookingInfoByBkgNoAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("BKG_DOC_PROC_SKD D" ).append("\n"); 
