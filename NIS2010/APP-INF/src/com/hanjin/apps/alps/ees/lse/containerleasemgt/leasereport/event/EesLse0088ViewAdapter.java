...
*@FileName : EesLse0088ViewAdapter.java
*@FileTitle : EesLse0088ViewAdapter
*Open Issues :
*Change history :
...
/**
 * EES_LSE_0088 에 대한 ViewAdapter<br>
 ...
 * @since J2EE 1.6
 */
public class EesLse0088ViewAdapter extends DefaultViewAdapter {
	
    public EesLse0088ViewAdapter(){ 
    	super();
    }
    
    @SuppressWarnings("unchecked")
	protected String makeDataTag(List<AbstractValueObject> list, String prefix) {
    	log.debug("########### EesLse0088ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [START]");
		...
		log.debug("########### EesLse0088ViewAdapter.makeDataTag(List<AbstractValueObject> list, String prefix) ########### [END]");
	    return strBuilder.toString();
	}
