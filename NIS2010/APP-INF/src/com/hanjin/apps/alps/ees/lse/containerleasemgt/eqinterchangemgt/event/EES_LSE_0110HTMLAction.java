...
*@FileName : EES_LSE_0110HTMLAction.java
...
public class EES_LSE_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0110HTMLAction 객체를 생성
	 */
	public EES_LSE_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0110Event event = new EesLse0110Event();
          log.info("===================");
		if(command.isCommand(FormCommand.SEARCH)) {
			 log.info("===================");
			event.setSearchOfferInquiryVO((SearchOfferInquiryVO)getVO(request, SearchOfferInquiryVO .class));
		}
		return  event;
	}
