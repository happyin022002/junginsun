...
*@FileName : CHSCpsPayableInvoiceCreationINVO.java
*@FileTitle : CHSCpsPayableInvoiceCreationINVO
*Open Issues :
*Change history :
...
public class CHSCpsPayableInvoiceCreationINVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSCpsPayableInvoiceCreationINVO> models = new ArrayList<CHSCpsPayableInvoiceCreationINVO>();
	...
	/* Column Info */
	private String parentAgmtOfcCtyCd = null;
	/* Column Info */
	private String parentAgmtSeq = null;
	/* Column Info */
	private String parentAgmtVerNo = null;
	/* Column Info */
	private String parentCostYrmonSeq = null;
	/* Column Info */
	private String parentChssCopInvTpCd = null;
	...
	public CHSCpsPayableInvoiceCreationINVO(String ibflag, String pagerows, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String costYrmon, String eqNo, String chgCd, String chgSeq, String eqKndCd, String lseChgAudStsCd, String lseChgAudRsltRsnCd, String lseUseDys, String lseRtAmt, String lseChgAmt, String eqOnhDt, String eqOnhLocCd, String eqOffhDt, String eqOffhLocCd, String eqBilStDt, String eqBilEndDt, String invNo, String invRefNo, String invEqNo, String invCustEqNo, String invEqOnhDt, String invEqOnhLocNm, String invEqOffhDt, String invEqOffhLocNm, String invBilStDt, String invBilEndDt, String invLseUseDys, String invLseRtAmt, String invLseChgAmt, String invTaxAmt, String invCrAmt, String audUmchEqStsEvntYdCd, String audUmchEqAsetStsCd, String audUmchEqStsEvntDt, String payLseChgStsCd, String payLseUseDys, String payLseRtAmt, String payLseChgAmt, String payCrAmt, String payTaxAmt, String payInvSeq, String costCd, String acctCd, String payChgAudRmk, String creUsrId, String creDt, String updUsrId, String updDt, String eqTpszCd, String eqFmYdCd, String eqFmMvmtCd, String eqFmMvmtDt, String eqToYdCd, String eqToMvmtCd, String eqToMvmtDt, String invYdCd, String invBilUtDys, String invBkgNo, String invBkgTermCd, String invScNo, String invCustCntCd, String invCustSeq, String payBilUtDys, String invLseChgTtlAmt, String invTaxRtAmt, String payLseChgTtlAmt, String payTaxRtAmt, String lseBilUtDys, String lseChgTtlAmt, String lseTaxRtAmt, String lseTaxAmt, String chgCreSeq, String costYrmonSeq, String parentAgmtOfcCtyCd, String parentAgmtSeq, String parentAgmtVerNo, String parentCostYrmonSeq, String parentChssCopInvTpCd) {
		...
		this.parentAgmtOfcCtyCd = parentAgmtOfcCtyCd;
		this.parentAgmtSeq = parentAgmtSeq;
		this.parentAgmtVerNo = parentAgmtVerNo;
		this.parentCostYrmonSeq = parentCostYrmonSeq;
		this.parentChssCopInvTpCd = parentChssCopInvTpCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("parent_agmt_ofc_cty_cd", getParentAgmtOfcCtyCd());
		this.hashColumns.put("parent_agmt_seq", getParentAgmtSeq());
		this.hashColumns.put("parent_agmt_ver_no", getParentAgmtVerNo());
		this.hashColumns.put("parent_cost_yrmon_seq", getParentCostYrmonSeq());
		this.hashColumns.put("parent_chss_cop_inv_tp_cd", getParentChssCopInvTpCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("parent_agmt_ofc_cty_cd", "parentAgmtOfcCtyCd");
		this.hashFields.put("parent_agmt_seq", "parentAgmtSeq");
		this.hashFields.put("parent_agmt_ver_no", "parentAgmtVerNo");
		this.hashFields.put("parent_cost_yrmon_seq", "parentCostYrmonSeq");
		this.hashFields.put("parent_chss_cop_inv_tp_cd", "parentChssCopInvTpCd");
	...
	/**
	 * Column Info
	 * @return parentAgmtOfcCtyCd
	 */
	public String getParentAgmtOfcCtyCd() {
		return this.parentAgmtOfcCtyCd;
	}
	
	/**
	 * Column Info
	 * @return parentAgmtSeq
	 */
	public String getParentAgmtSeq() {
		return this.parentAgmtSeq;
	}
	
	/**
	 * Column Info
	 * @return parentAgmtVerNo
	 */
	public String getParentAgmtVerNo() {
		return this.parentAgmtVerNo;
	}
	
	/**
	 * Column Info
	 * @return parentCostYrmonSeq
	 */
	public String getParentCostYrmonSeq() {
		return parentCostYrmonSeq;
	}
	
	/**
	 * Column Info
	 * @return parentChssCopInvTpCd
	 */
	public String getParentChssCopInvTpCd() {
		return this.parentChssCopInvTpCd;
	}
	 ...
	 * @return parentAgmtOfcCtyCd
	 */
	public void setParentAgmtOfcCtyCd(String parentAgmtOfcCtyCd) {
		this.parentAgmtOfcCtyCd = parentAgmtOfcCtyCd;
	}
	 ...
	 * @return parentAgmtSeq
	 */
	public void setParentAgmtSeq(String parentAgmtSeq) {
		this.parentAgmtSeq = parentAgmtSeq;
	}
	 ...
	 * @return parentAgmtVerNo
	 */
	public void setParentAgmtVerNo(String parentAgmtVerNo) {
		this.parentAgmtVerNo = parentAgmtVerNo;
	}
	 ...
	 * @return parentCostYrmonSeq
	 */
	public void setParentCostYrmonSeq(String parentCostYrmonSeq) {
		this.parentCostYrmonSeq = parentCostYrmonSeq;
	}
	 ...
	 * @return parentChssCopInvTpCd
	 */
	public void setParentChssCopInvTpCd(String parentChssCopInvTpCd) {
		this.parentChssCopInvTpCd = parentChssCopInvTpCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setParentAgmtOfcCtyCd(JSPUtil.getParameter(request, prefix + "parent_agmt_ofc_cty_cd", ""));
		setParentAgmtSeq(JSPUtil.getParameter(request, prefix + "parent_agmt_seq", ""));
		setParentAgmtVerNo(JSPUtil.getParameter(request, prefix + "parent_agmt_ver_no", ""));
		setParentCostYrmonSeq(JSPUtil.getParameter(request, prefix + "parent_cost_yrmon_seq", ""));
		setParentChssCopInvTpCd(JSPUtil.getParameter(request, prefix + "parent_chss_cop_inv_tp_cd", ""));
	}
	 ...
	 */
	public CHSCpsPayableInvoiceCreationINVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSCpsPayableInvoiceCreationINVO[]
	 */
	public CHSCpsPayableInvoiceCreationINVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSCpsPayableInvoiceCreationINVO model = null;
		...
		try {
			...
			String[] parentAgmtOfcCtyCd = (JSPUtil.getParameter(request, prefix + "parent_agmt_ofc_cty_cd", length));
			String[] parentAgmtSeq = (JSPUtil.getParameter(request, prefix + "parent_agmt_seq", length));
			String[] parentAgmtVerNo = (JSPUtil.getParameter(request, prefix + "parent_agmt_ver_no", length));
			String[] parentCostYrmonSeq = (JSPUtil.getParameter(request, prefix	+ "parent_cost_yrmon_seq", length));
			String[] parentChssCopInvTpCd = (JSPUtil.getParameter(request, prefix + "parent_chss_cop_inv_tp_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new CHSCpsPayableInvoiceCreationINVO();
				...
				if (parentAgmtOfcCtyCd[i] != null)
					model.setParentAgmtOfcCtyCd(parentAgmtOfcCtyCd[i]);
				if (parentAgmtSeq[i] != null)
					model.setParentAgmtSeq(parentAgmtSeq[i]);
				if (parentAgmtVerNo[i] != null)
					model.setParentAgmtVerNo(parentAgmtVerNo[i]);
				if (parentCostYrmonSeq[i] != null)
					model.setParentCostYrmonSeq(parentCostYrmonSeq[i]);
				if (parentChssCopInvTpCd[i] != null)
					model.setParentChssCopInvTpCd(parentChssCopInvTpCd[i]);
				models.add(model);
			}
		...
		return getCHSCpsPayableInvoiceCreationINVOs();
	}
	...
	public CHSCpsPayableInvoiceCreationINVO[] getCHSCpsPayableInvoiceCreationINVOs(){
		CHSCpsPayableInvoiceCreationINVO[] vos = (CHSCpsPayableInvoiceCreationINVO[])models.toArray(new CHSCpsPayableInvoiceCreationINVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.parentAgmtOfcCtyCd = this.parentAgmtOfcCtyCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.parentAgmtSeq = this.parentAgmtSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.parentAgmtVerNo = this.parentAgmtVerNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.parentCostYrmonSeq = this.parentCostYrmonSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.parentChssCopInvTpCd = this.parentChssCopInvTpCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
