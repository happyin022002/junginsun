...
*@FileName : ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOUSQL(){
		setQuery();
		...
		query.append("FileName : ContainerMovementMasterDataMgtDBDAOCtmMvmtStsVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET MVMT_STS_NM = @[mvmt_sts_nm]," ).append("\n"); 
		query.append("DEST_YD_FLG = 'N'," ).append("\n"); 
