...
/**
 * EES_LSE_0107 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  EES_LSE_0107HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Jin Jun Sung
 * @see EES_LSE_0107HTMLAction 참조
 * @since J2EE 1.6
 */

public class EesLse0107Event extends EventSupport {
	...
	public EesLse0107Event(){}
	
	public void setEqInterchangeReqVO(EqInterchangeReqVO eqInterchangeReqVO){
		this. eqInterchangeReqVO = eqInterchangeReqVO;
	}

	public void setEqInterchangeReqVOS(EqInterchangeReqVO[] eqInterchangeReqVOs){
		this. eqInterchangeReqVOs = eqInterchangeReqVOs;
	}

	public EqInterchangeReqVO getEqInterchangeReqVO(){
