...
*@FileName : MTYWeeklySimulationDBDAOremoveMtyWeeklySimulationDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MTYWeeklySimulationDBDAOremoveMtyWeeklySimulationDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MTYWeeklySimulationDBDAOremoveMtyWeeklySimulationDSQL(){
		setQuery();
		...
		query.append("FileName : MTYWeeklySimulationDBDAOremoveMtyWeeklySimulationDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("DELETE FROM EQR_MTY_WKY_SIM" ).append("\n"); 
