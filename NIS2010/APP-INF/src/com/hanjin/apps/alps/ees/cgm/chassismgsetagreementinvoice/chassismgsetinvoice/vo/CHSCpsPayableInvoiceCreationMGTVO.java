...
*@FileName : CHSCpsPayableInvoiceCreationMGTVO.java
*@FileTitle : CHSCpsPayableInvoiceCreationMGTVO
*Open Issues :
*Change history :
...
public class CHSCpsPayableInvoiceCreationMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSCpsPayableInvoiceCreationMGTVO> models = new ArrayList<CHSCpsPayableInvoiceCreationMGTVO>();
	...
	/* Column Info */
	private String lseChgAudRsltRsnNm = null;
	/* Column Info */
	...
	/* Column Info */
	private String invGateActId = null;
	/* Column Info */
	private String invBilModRmk = null;
	/* Column Info */
	private String eqMtyMvmtDt = null;
	/* Column Info */
	private String eqMtyMvmtYdCd = null;
	/* Column Info */
	private String eqToScNo = null;
	/* Column Info */
	private String eqToBkgNo = null;
	/* Column Info */
	private String eqToBkgTermCd = null;
	/* Column Info */
	...
	public CHSCpsPayableInvoiceCreationMGTVO(String ibflag, String pagerows, String agmtOfcCtyCd, String agmtSeq, String agmtVerNo, String costYrmon, String eqNo, String chgCd, String chgSeq, String eqKndCd, String lseChgAudStsCd, String lseChgAudRsltRsnCd, String lseUseDys, String lseRtAmt, String lseChgAmt, String eqOnhDt, String eqOnhLocCd, String eqOffhDt, String eqOffhLocCd, String eqBilStDt, String eqBilEndDt, String invNo, String invRefNo, String invEqNo, String invCustEqNo, String invEqOnhDt, String invEqOnhLocNm, String invEqOffhDt, String invEqOffhLocNm, String invBilStDt, String invBilEndDt, String invLseUseDys, String invLseRtAmt, String invLseChgAmt, String invTaxAmt, String invCrAmt, String audUmchEqStsEvntYdCd, String audUmchEqAsetStsCd, String audUmchEqStsEvntDt, String payLseChgStsCd, String payLseUseDys, String payLseRtAmt, String payLseChgAmt, String payCrAmt, String payTaxAmt, String payInvSeq, String costCd, String acctCd, String payChgAudRmk, String creUsrId, String creDt, String updUsrId, String updDt, String eqTpszCd, String eqFmYdCd, String eqFmMvmtCd, String eqFmMvmtDt, String eqToYdCd, String eqToMvmtCd, String eqToMvmtDt, String invYdCd, String invBilUtDys, String invBkgNo, String invBkgTermCd, String invScNo, String invCustCntCd, String invCustSeq, String payBilUtDys, String invLseChgTtlAmt, String invTaxRtAmt, String payLseChgTtlAmt, String payTaxRtAmt, String lseBilUtDys, String lseChgTtlAmt, String lseTaxRtAmt, String lseTaxAmt, String diffBilUt, String agmtNo, String lseChgAudRsltRsnNm, String invGateActId, String invBilModRmk, String eqMtyMvmtDt, String eqMtyMvmtYdCd, String eqToScNo, String eqToBkgNo, String eqToBkgTermCd, String costYrmonSeq, String vndrPayChgRmk, String vndrPayChgCmtCtnt, String vndrPayChgCrStyCtnt, String vndrPayChgCrDueCtnt) {
		...
		this.lseChgAudRsltRsnNm = lseChgAudRsltRsnNm;
		...
		this.invGateActId = invGateActId;
		this.invBilModRmk = invBilModRmk;
		this.eqMtyMvmtDt = eqMtyMvmtDt;
		this.eqMtyMvmtYdCd = eqMtyMvmtYdCd;
		this.eqToScNo = eqToScNo;
		this.eqToBkgNo = eqToBkgNo;
		this.eqToBkgTermCd = eqToBkgTermCd;
		this.setCostYrmonSeq(costYrmonSeq);
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("diff_bil_ut", getDiffBilUt());
		...
		this.hashColumns.put("lse_chg_aud_rslt_rsn_nm", getLseChgAudRsltRsnNm());
		...
		this.hashColumns.put("inv_gate_act_id", getInvGateActId());
		this.hashColumns.put("inv_bil_mod_rmk", getInvBilModRmk());
		this.hashColumns.put("eq_mty_mvmt_dt", getEqMtyMvmtDt());
		this.hashColumns.put("eq_mty_mvmt_yd_cd", getEqMtyMvmtYdCd());
		this.hashColumns.put("eq_to_sc_no", getEqToScNo());
		this.hashColumns.put("eq_to_bkg_no", getEqToBkgNo());
		this.hashColumns.put("eq_to_bkg_term_cd", getEqToBkgTermCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("diff_bil_ut", "diffBilUt");
		...
		this.hashFields.put("lse_chg_aud_rslt_rsn_nm", "lseChgAudRsltRsnNm");
		...
		this.hashFields.put("inv_gate_act_id", "invGateActId");
		this.hashFields.put("inv_bil_mod_rmk", "invBilModRmk");
		this.hashFields.put("eq_mty_mvmt_dt", "eqMtyMvmtDt");
		this.hashFields.put("eq_mty_mvmt_yd_cd", "eqMtyMvmtYdCd");
		this.hashFields.put("eq_to_sc_no", "eqToScNo");
		this.hashFields.put("eq_to_bkg_no", "eqToBkgNo");
		this.hashFields.put("eq_to_bkg_term_cd", "eqToBkgTermCd");
	 ...
	 * @return diffBilUt
	 */
	public String getDiffBilUt() {
		return this.diffBilUt;
	}
	...
	/**
	 * Column Info
	 * @return lseChgAudRsltRsnNm
	 */
	public String getLseChgAudRsltRsnNm() {
		return this.lseChgAudRsltRsnNm;
	}
	 ...
	 * @return invGateActId
	 */
	public String getInvGateActId() {
		return this.invGateActId;
	}
	 ...
	 * @return invBilModRmk
	 */
	public String getInvBilModRmk() {
		return this.invBilModRmk;
	}
	 ...
	 * @return eqMtyMvmtDt
	 */
	public String getEqMtyMvmtDt() {
		return this.eqMtyMvmtDt;
	}
	
	/**
	 * Column Info
	 * @return eqMtyMvmtYdCd
	 */
	public String getEqMtyMvmtYdCd() {
		return this.eqMtyMvmtYdCd;
	}
	 ...
	 * @return eqToScNo
	 */
	public String getEqToScNo() {
		return this.eqToScNo;
	}
	 ...
	 * @return eqToBkgNo
	 */
	public String getEqToBkgNo() {
		return this.eqToBkgNo;
	}
	
	/**
	 * Column Info
	 * @return eqToBkgTermCd
	 */
	public String getEqToBkgTermCd() {
		return this.eqToBkgTermCd;
	}
	 ...
	 * @param diffBilUt
	 */
	public void setDiffBilUt(String diffBilUt) {
		this.diffBilUt = diffBilUt;
	}
	...
	/**
	 * Column Info
	 * @param lseChgAudRsltRsnNm
	 */
	public void setLseChgAudRsltRsnNm(String lseChgAudRsltRsnNm) {
		this.lseChgAudRsltRsnNm = lseChgAudRsltRsnNm;
	}
	 ...
	 * @param invGateActId
	 */
	public void setInvGateActId(String invGateActId) {
		this.invGateActId = invGateActId;
	}
	 ...
	 * @param invBilModRmk
	 */
	public void setInvBilModRmk(String invBilModRmk) {
		this.invBilModRmk = invBilModRmk;
	}
	 ...
	 * @param eqMtyMvmtDt
	 */
	public void setEqMtyMvmtDt(String eqMtyMvmtDt) {
		this.eqMtyMvmtDt = eqMtyMvmtDt;
	}
	 ...
	 * @param eqMtyMvmtYdCd
	 */
	public void setEqMtyMvmtYdCd(String eqMtyMvmtYdCd) {
		this.eqMtyMvmtYdCd = eqMtyMvmtYdCd;
	}
	 ...
	 * @param eqToScNo
	 */
	public void setEqToScNo(String eqToScNo) {
		this.eqToScNo = eqToScNo;
	}
	 ...
	 * @param eqToBkgNo
	 */
	public void setEqToBkgNo(String eqToBkgNo) {
		this.eqToBkgNo = eqToBkgNo;
	}
	 ...
	 * @param eqToBkgTermCd
	 */
	public void setEqToBkgTermCd(String eqToBkgTermCd) {
		this.eqToBkgTermCd = eqToBkgTermCd;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDiffBilUt(JSPUtil.getParameter(request, prefix + "diff_bil_ut", ""));
		...
		setLseChgAudRsltRsnNm(JSPUtil.getParameter(request, prefix + "lse_chg_aud_rslt_rsn_nm", ""));
		...
		setInvGateActId(JSPUtil.getParameter(request, prefix + "inv_gate_act_id", ""));
		setInvBilModRmk(JSPUtil.getParameter(request, prefix + "inv_bil_mod_rmk", ""));
		setEqMtyMvmtDt(JSPUtil.getParameter(request, prefix + "eq_mty_mvmt_dt", ""));
		setEqMtyMvmtYdCd(JSPUtil.getParameter(request, prefix + "eq_mty_mvmt_yd_cd", ""));
		setEqToScNo(JSPUtil.getParameter(request, prefix + "eq_to_sc_no", ""));
		setEqToBkgNo(JSPUtil.getParameter(request, prefix + "eq_to_bkg_no", ""));
		setEqToBkgTermCd(JSPUtil.getParameter(request, prefix + "eq_to_bkg_term_cd", ""));
	 ...
	 * @param request
	 * @return CHSCpsPayableInvoiceCreationMGTVO[]
	 */
	public CHSCpsPayableInvoiceCreationMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSCpsPayableInvoiceCreationMGTVO[]
	 */
	public CHSCpsPayableInvoiceCreationMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSCpsPayableInvoiceCreationMGTVO model = null;
		...
		try {
			...
			String[] diffBilUt = (JSPUtil.getParameter(request, prefix	+ "diff_bil_ut", length));
			...
			String[] lseChgAudRsltRsnNm = (JSPUtil.getParameter(request, prefix	+ "lse_chg_aud_rslt_rsn_nm", length));
			...
			String[] invGateActId = (JSPUtil.getParameter(request, prefix	+ "inv_gate_act_id", length));
			String[] invBilModRmk = (JSPUtil.getParameter(request, prefix	+ "inv_bil_mod_rmk", length));
			String[] eqMtyMvmtDt = (JSPUtil.getParameter(request, prefix	+ "eq_mty_mvmt_dt", length));
			String[] eqMtyMvmtYdCd = (JSPUtil.getParameter(request, prefix	+ "eq_mty_mvmt_yd_cd", length));
			String[] eqToScNo = (JSPUtil.getParameter(request, prefix	+ "eq_to_sc_no", length));
			String[] eqToBkgNo = (JSPUtil.getParameter(request, prefix	+ "eq_to_bkg_no", length));
			String[] eqToBkgTermCd = (JSPUtil.getParameter(request, prefix	+ "eq_to_bkg_term_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new CHSCpsPayableInvoiceCreationMGTVO();
				...
				if (diffBilUt[i] != null)
					model.setDiffBilUt(diffBilUt[i]);
				...
				if (lseChgAudRsltRsnNm[i] != null)
					model.setLseChgAudRsltRsnNm(lseChgAudRsltRsnNm[i]);
				if (eqFmYdCd[i] != null)
				...
				if (invGateActId[i] != null)
					model.setInvGateActId(invGateActId[i]);
				if (invBilModRmk[i] != null)
					model.setInvBilModRmk(invBilModRmk[i]);
				if (eqMtyMvmtDt[i] != null)
					model.setEqMtyMvmtDt(eqMtyMvmtDt[i]);
				if (eqMtyMvmtYdCd[i] != null)
					model.setEqMtyMvmtYdCd(eqMtyMvmtYdCd[i]);
				if (eqToScNo[i] != null)
					model.setEqToScNo(eqToScNo[i]);
				if (eqToBkgNo[i] != null)
					model.setEqToBkgNo(eqToBkgNo[i]);
				if (eqToBkgTermCd[i] != null)
					model.setEqToBkgTermCd(eqToBkgTermCd[i]);
		...
		return getCHSCpsPayableInvoiceCreationMGTVOs();
	}
	 ...
	 * @return CHSCpsPayableInvoiceCreationMGTVO[]
	 */
	public CHSCpsPayableInvoiceCreationMGTVO[] getCHSCpsPayableInvoiceCreationMGTVOs(){
		CHSCpsPayableInvoiceCreationMGTVO[] vos = (CHSCpsPayableInvoiceCreationMGTVO[])models.toArray(new CHSCpsPayableInvoiceCreationMGTVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.diffBilUt = this.diffBilUt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.lseChgAudRsltRsnNm = this.lseChgAudRsltRsnNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.invGateActId = this.invGateActId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.invBilModRmk = this.invBilModRmk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.eqMtyMvmtDt = this.eqMtyMvmtDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.eqMtyMvmtYdCd = this.eqMtyMvmtYdCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.eqToScNo = this.eqToScNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.eqToBkgNo = this.eqToBkgNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.eqToBkgTermCd = this.eqToBkgTermCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
