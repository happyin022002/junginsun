...
*@FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionOtherTariffProgStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RFAExceptionTariffMgtDBDAOModifyBeforeExceptionOtherTariffProgStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RFAExceptionTariffMgtDBDAOModifyBeforeExceptionOtherTariffProgStatusUSQL(){
		setQuery();
		...
		query.append("FileName : RFAExceptionTariffMgtDBDAOModifyBeforeExceptionOtherTariffProgStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE DMT_RFA_EXPT_TRF_PROG SET" ).append("\n"); 
		query.append("DMDT_EXPT_RQST_STS_CD = 'C'" ).append("\n"); 
