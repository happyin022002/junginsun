...
*@FileName : InvoiceNoGenVO.java
*@FileTitle : InvoiceNoGenVO
*Open Issues :
*Change history :
 ...
 */
public class InvoiceNoGenVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvoiceNoGenVO> models = new ArrayList<InvoiceNoGenVO>();
	...
	public InvoiceNoGenVO() {}

	public InvoiceNoGenVO(String ibflag, String pagerows, String dmdtInvNo, String errMsgCd, String errMsg) {
		this.ibflag = ibflag;
	 ...
	 */
	public InvoiceNoGenVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvoiceNoGenVO[]
	 */
	public InvoiceNoGenVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvoiceNoGenVO model = null;
	 ...
	 * @return InvoiceNoGenVO[]
	 */
	public InvoiceNoGenVO[] getInvoiceNoGenVOs(){
		InvoiceNoGenVO[] vos = (InvoiceNoGenVO[])models.toArray(new InvoiceNoGenVO[models.size()]);
		return vos;
	}
