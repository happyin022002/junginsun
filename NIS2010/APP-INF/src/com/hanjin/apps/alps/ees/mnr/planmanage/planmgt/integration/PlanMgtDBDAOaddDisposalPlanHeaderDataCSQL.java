...
*@FileName : PlanMgtDBDAOaddDisposalPlanHeaderDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PlanMgtDBDAOaddDisposalPlanHeaderDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Disposal Planning Header 입력
	  * </pre>
	  */
	public PlanMgtDBDAOaddDisposalPlanHeaderDataCSQL(){
		setQuery();
		...
		query.append("FileName : PlanMgtDBDAOaddDisposalPlanHeaderDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
