...
public class ContainerMovementMgtDBDAOGetAutoCreStsListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				       DECODE (A.FCNTR_FLG, 'Y', 'F', 'M') AS FCNTR_FLG," ).append("\n"); 
		query.append("                       A.BKG_CGO_TP_CD," ).append("\n"); 
		query.append("                       A.MVMT_EDI_TP_CD," ).append("\n"); 
		...
		query.append("                         WHERE CNMV_EVNT_DT BETWEEN TO_DATE (@[p_date1], 'YYYY-MM-DD') AND TO_DATE (@[p_date2], 'YYYY-MM-DD') + .99999 " ).append("\n"); 
		...
		query.append(" WHERE TAR_DATE BETWEEN TO_DATE (@[p_date1], 'YYYY-MM-DD') AND TO_DATE (@[p_date2], 'YYYY-MM-DD') + .99999" ).append("\n"); 
		query.append("#if (${cre_tp_cd} != '')" ).append("\n"); 
		query.append("   AND MVMT_CRE_TP_CD = @[cre_tp_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
