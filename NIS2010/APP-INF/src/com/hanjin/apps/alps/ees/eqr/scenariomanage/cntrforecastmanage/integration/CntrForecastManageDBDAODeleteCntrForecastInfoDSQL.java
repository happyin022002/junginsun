...
*@FileName : CntrForecastManageDBDAODeleteCntrForecastInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrForecastManageDBDAODeleteCntrForecastInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CntrForecastManageDBDAODeleteCntrForecastInfoDSQL(){
		setQuery();
		...
		query.append("FileName : CntrForecastManageDBDAODeleteCntrForecastInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM  EQR_OB_FCAST" ).append("\n"); 
