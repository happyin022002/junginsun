...
*@FileName : OnewaySimulateDBDAOSearchDailyMaxRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnewaySimulateDBDAOSearchDailyMaxRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OnewaySimulateDBDAOSearchDailyMaxRSQL(){
		setQuery();
		...
		query.append("FileName : OnewaySimulateDBDAOSearchDailyMaxRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("MAX(ROUND(CNTR_VOL_QTY / ${dailycount} * ${vol} )) MAXVALUE" ).append("\n"); 
