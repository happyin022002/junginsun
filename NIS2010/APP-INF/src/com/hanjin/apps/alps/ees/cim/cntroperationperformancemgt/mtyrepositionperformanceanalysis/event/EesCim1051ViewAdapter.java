 ...
 * @since J2EE 1.5   
 */
public class EesCim1051ViewAdapter extends ViewAdapter {
...
//	        String[] realColNms=getColHeader(vo);
	        ...
	        for(int i=0;i<realCnt;i++){
                ...
                if(!"".equals(JSPUtil.getNull(colValues.get("inout")))){
                	sbufXML.append("<TR>\n");
//	                int colCnt = realColNms.length;
	                
	                sbufXML.append("<TD><![CDATA["+JSPUtil.getNull(colValues.get("inout"))+"]]></TD>\n");
	                ...
	                for (int j = 0 ; j < 13 ; j++) {
	                    ...
	                    xx++;
                            ...
                            sbufXML.append("<TD><![CDATA["+JSPUtil.getNull(colValues.get("count"+num))+"]]></TD>\n");
