...
*@FileName : CHSInventoryByVariationMGTVO.java
*@FileTitle : CHSInventoryByVariationMGTVO
*Open Issues :
*Change history :
...
public class CHSInventoryByVariationMGTVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CHSInventoryByVariationMGTVO> models = new ArrayList<CHSInventoryByVariationMGTVO>();
	 ...
	 */
	public CHSInventoryByVariationMGTVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CHSInventoryByVariationMGTVO[]
	 */
	public CHSInventoryByVariationMGTVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CHSInventoryByVariationMGTVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CHSInventoryByVariationMGTVO();
		...
		return getCHSInventoryByVariationMGTVOs();
	}
	...
	public CHSInventoryByVariationMGTVO[] getCHSInventoryByVariationMGTVOs(){
		CHSInventoryByVariationMGTVO[] vos = (CHSInventoryByVariationMGTVO[])models.toArray(new CHSInventoryByVariationMGTVO[models.size()]);
		return vos;
	}
