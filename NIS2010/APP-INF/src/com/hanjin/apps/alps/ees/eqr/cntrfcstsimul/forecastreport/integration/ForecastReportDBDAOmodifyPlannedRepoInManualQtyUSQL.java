...
*@FileName : ForecastReportDBDAOmodifyPlannedRepoInManualQtyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ForecastReportDBDAOmodifyPlannedRepoInManualQtyUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INTO EQR_CTRL_PLN_REPO_IN_QTY 에 Planned Repo In Manual 데이터 수정/입력 (merge)
	  * </pre>
	  */
	public ForecastReportDBDAOmodifyPlannedRepoInManualQtyUSQL(){
		setQuery();
		...
		query.append("FileName : ForecastReportDBDAOmodifyPlannedRepoInManualQtyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- EQR_CTRL_PLN_REPO_IN_QTY 입력/수정   " ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append("MERGE INTO EQR_CTRL_PLN_REPO_IN_QTY" ).append("\n"); 
		query.append("USING DUAL   " ).append("\n"); 
		query.append("ON (     FCAST_YRWK      = @[fcast_yrwk]               " ).append("\n"); 
		...
		query.append("     INSERT ( FCAST_YRWK      " ).append("\n"); 
		...
		query.append("     VALUES ( @[fcast_yrwk]      " ).append("\n"); 
		query.append("            , @[vsl_cd]          " ).append("\n"); 
		query.append("            , @[skd_voy_no]      " ).append("\n"); 
		query.append("            , @[skd_dir_cd]      " ).append("\n"); 
		query.append("            , @[pln_repo_sts_cd] " ).append("\n"); 
