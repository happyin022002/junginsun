...
public class ForecastReportListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ForecastReportListVO> models = new ArrayList<ForecastReportListVO>();
	...
	/* Column Info */
	private String repoOutRmk  = null;	
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("repoOutRmk", getRepoOutRmk());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("repo_out_rmk", "repoOutRmk");	
	 ...
	 * @return repoOutRmk
	 */
	public String getRepoOutRmk() {
		return this.repoOutRmk;
	}
	 ...
	 * @param ofcCd
	 */
	public void setRepoOutRmk(String repoOutRmk) {
		this.repoOutRmk = repoOutRmk;
	}	
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRepoOutRmk(JSPUtil.getParameter(request, "repoOutRmk", ""));	
	 ...
	 */
	public ForecastReportListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MtyBalanceRepoListVO[]
	 */
	public ForecastReportListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ForecastReportListVO model = null;
		...
		try {
			...
			String[] repoOutRmk = (JSPUtil.getParameter(request, prefix	+ "repoOutRmk", length));	
			...
			for (int i = 0; i < length; i++) {
				model = new ForecastReportListVO();
				if (total[i] != null)
				...
				if (repoOutRmk[i] != null)
					model.setRepoOutRmk(repoOutRmk[i]);	
	 ...
	 * @return MtyBalanceRepoListVO[]
	 */
	public ForecastReportListVO[] getMtyBalanceRepoListVOs(){
		ForecastReportListVO[] vos = (ForecastReportListVO[])models.toArray(new ForecastReportListVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.repoOutRmk = this.repoOutRmk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");			
