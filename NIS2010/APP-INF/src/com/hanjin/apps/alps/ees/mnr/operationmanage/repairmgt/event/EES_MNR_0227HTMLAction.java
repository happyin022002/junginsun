...
*@FileName : EES_MNR_0227HTMLAction.java
...
public class EES_MNR_0227HTMLAction extends HTMLActionSupport {
 
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0227HTMLAction 객체를 생성
	 */
	public EES_MNR_0227HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0227Event event = new EesMnr0227Event();
