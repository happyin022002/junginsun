...
public class DisposalMgtDBDAOsearchMyBiddingLocalTimeListDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT   GLOBALDATE_PKG.TIME_CONV_OFC_FNC(( SELECT MNR_CD_ID FROM MNR_GEN_CD WHERE PRNT_CD_ID = 'HOOFC' AND ROWNUM = 1 ), SYSDATE, MNR_COMMON_PKG.MNR_GET_SPPOFC_FNC(@[sp_ptal_id])) AS DISP_LOCAL_DT" ).append("\n"); 
