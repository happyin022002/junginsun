...
*@FileName : EES_MNR_0194HTMLAction.java
...
public class EES_MNR_0194HTMLAction extends HTMLActionSupport {
 
	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0191HTMLAction 객체를 생성
	 */
	public EES_MNR_0194HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0194Event event = new EesMnr0194Event();
		//조회  	
