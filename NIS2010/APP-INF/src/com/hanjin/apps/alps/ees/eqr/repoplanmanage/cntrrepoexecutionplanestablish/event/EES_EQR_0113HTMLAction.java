...
*@FileName : EES_EQR_0113HTMLAction.java
...
public class EES_EQR_0113HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_EQR_0113HTMLAction 객체를 생성
	 */
	public EES_EQR_0113HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr0113Event event = new EesEqr0113Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setEesEqr0113ConditionVO((EesEqr0113ConditionVO)getVO(request, EesEqr0113ConditionVO .class));
		}
