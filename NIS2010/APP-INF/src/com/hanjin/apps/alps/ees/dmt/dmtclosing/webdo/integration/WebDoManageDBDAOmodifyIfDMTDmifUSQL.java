...
*@FileName : WebDoManageDBDAOmodifyIfDMTDmifUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WebDoManageDBDAOmodifyIfDMTDmifUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DMDT_TRF_CD 가 DMIF 일 경우 update
	  * </pre>
	  */
	public WebDoManageDBDAOmodifyIfDMTDmifUSQL(){
		setQuery();
		...
		query.append("FileName : WebDoManageDBDAOmodifyIfDMTDmifUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET WEB_MTY_DT = TO_DATE(?, 'YYYY-MM-DD')," ).append("\n"); 
