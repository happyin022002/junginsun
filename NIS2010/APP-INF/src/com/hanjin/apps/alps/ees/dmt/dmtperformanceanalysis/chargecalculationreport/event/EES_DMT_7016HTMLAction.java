...
*@FileName : EES_DMT_7016HTMLAction.java
...
public class EES_DMT_7016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_DMT_7016HTMLAction 객체를 생성
	 */
	public EES_DMT_7016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesDmt7016Event event = new EesDmt7016Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setUsLfdEdiAudidtParmVO((UsLfdEdiAudidtParmVO)getVO(request, UsLfdEdiAudidtParmVO .class));
		}
