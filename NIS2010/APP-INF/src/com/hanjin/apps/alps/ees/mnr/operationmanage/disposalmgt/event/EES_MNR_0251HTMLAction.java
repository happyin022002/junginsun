...
*@FileName : EES_MNR_0251HTMLAction.java
...
public class EES_MNR_0251HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_MNR_0251HTMLAction 객체를 생성
	 */
	public EES_MNR_0251HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0251Event event = new EesMnr0251Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDisposalSoldINVO((DisposalSoldINVO)getVO(request, DisposalSoldINVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setCustomMnrDispCancelVOS((CustomMnrDispCancelVO[])getVOs(request, CustomMnrDispCancelVO.class, ""));
		}
