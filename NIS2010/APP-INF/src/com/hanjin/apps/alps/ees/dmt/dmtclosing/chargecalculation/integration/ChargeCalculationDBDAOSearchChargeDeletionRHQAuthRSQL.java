...
*@FileName : ChargeCalculationDBDAOSearchChargeDeletionRHQAuthRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ChargeCalculationDBDAOSearchChargeDeletionRHQAuthRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ChargeCalculationDBDAOSearchChargeDeletionRHQAuthRSQL
	  * </pre>
	  */
	public ChargeCalculationDBDAOSearchChargeDeletionRHQAuthRSQL(){
		setQuery();
		...
		query.append("FileName : ChargeCalculationDBDAOSearchChargeDeletionRHQAuthRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   and  T2.USR_ROLE_CD      = 'DMT02'" ).append("\n"); 
