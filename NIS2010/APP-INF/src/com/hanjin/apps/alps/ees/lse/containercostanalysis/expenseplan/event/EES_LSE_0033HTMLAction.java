...
*@FileName : EES_LSE_0033HTMLAction.java
...
public class EES_LSE_0033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_LSE_0033HTMLAction 객체를 생성
	 */
	public EES_LSE_0033HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesLse0033Event event = new EesLse0033Event();
		
		switch(command.getCommand()) {
			case FormCommand.SEARCH :	//조회
				event.setPlnYr(request.getParameter("pln_yr"));
				event.setVerSeq(request.getParameter("ver_seq"));
				event.setCmdType(request.getParameter("cmd_type"));
				break;
			case FormCommand.MULTI :	//멀티
				event.setExpensePlanVOs((ExpensePlanVO[])getVOs(request, ExpensePlanVO.class));	
				break;	
			default :	//do nothing
		}
