...
*@FileName : DMTCommonDBDAOLocationCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DMTCommonDBDAOLocationCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DMTCommonDBDAOLocationCdRSQL(){
		setQuery();
		...
		query.append("FileName : DMTCommonDBDAOLocationCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
