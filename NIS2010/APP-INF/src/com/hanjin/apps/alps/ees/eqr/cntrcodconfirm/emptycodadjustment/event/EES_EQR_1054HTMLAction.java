...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.ees.eqr.cntrcodconfirm 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class EES_EQR_1054HTMLAction extends HTMLActionSupport {
	 ...
	 * HttpRequst의 정보를 cntrcodconfirmEvent로 파싱하여 request에 셋팅<br>
