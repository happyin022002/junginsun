...
*@FileName : AssetsSmryVO.java
*@FileTitle : AssetsSmryVO
*Open Issues :
*Change history :
...
public class AssetsSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AssetsSmryVO> models = new ArrayList<AssetsSmryVO>();
	...
	/* Column Info */
	private String lsiQty = null;
	/* Column Info */
	private String muiQty = null;
	/* Column Info */
	private String diiQty = null;
	/* Column Info */
	private String fndQty = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("lsi_qty", getLsiQty());
		this.hashColumns.put("mui_qty", getMuiQty());
		this.hashColumns.put("dii_qty", getDiiQty());
		this.hashColumns.put("fnd_qty", getFndQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("lsi_qty", "lsiQty");
		this.hashFields.put("mui_qty", "muiQty");
		this.hashFields.put("dii_qty", "diiQty");
		this.hashFields.put("fnd_qty", "fndQty");
	 ...
	 * @param lsiQty 
	 */
	public void setLsiQty(String lsiQty) {
		this.lsiQty = lsiQty;
	}
	 ...
	 * @param muiQty 
	 */
	public void setMuiQty(String muiQty) {
		this.muiQty = muiQty;
	}
	 ...
	 * @param diiQty 
	 */
	public void setDiiQty(String diiQty) {
		this.diiQty = diiQty;
	}
	 ...
	 * @param fndQty 
	 */
	public void setFndQty(String fndQty) {
		this.fndQty = fndQty;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLsiQty(JSPUtil.getParameter(request, "lsi_qty", ""));
		setMuiQty(JSPUtil.getParameter(request, "mui_qty", ""));
		setDiiQty(JSPUtil.getParameter(request, "dii_qty", ""));
		setFndQty(JSPUtil.getParameter(request, "fnd_qty", ""));
	 ...
	 * @return AssetsSmryVO[]
	 */
	public AssetsSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AssetsSmryVO[]
	 */
	public AssetsSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AssetsSmryVO model = null;
		...
		try {
			...
			String[] lsiQty = (JSPUtil.getParameter(request, prefix	+ "lsi_qty", length));
			String[] muiQty = (JSPUtil.getParameter(request, prefix	+ "mui_qty", length));
			String[] diiQty = (JSPUtil.getParameter(request, prefix	+ "dii_qty", length));
			String[] fndQty = (JSPUtil.getParameter(request, prefix	+ "fnd_qty", length));
			for (int i = 0; i < length; i++) {
				model = new AssetsSmryVO();
				if (tllQty[i] != null)
				...
				if (lsiQty[i] != null)
					model.setLsiQty(lsiQty[i]);
				if (muiQty[i] != null)
					model.setMuiQty(muiQty[i]);
				if (diiQty[i] != null)
					model.setDiiQty(diiQty[i]);
				if (fndQty[i] != null)
					model.setFndQty(fndQty[i]);
				models.add(model);
			}
	 ...
	 * @return AssetsSmryVO[]
	 */
	public AssetsSmryVO[] getAssetsSmryVOs(){
		AssetsSmryVO[] vos = (AssetsSmryVO[])models.toArray(new AssetsSmryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.lsiQty = this.lsiQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.muiQty = this.muiQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.diiQty = this.diiQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.fndQty = this.fndQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
