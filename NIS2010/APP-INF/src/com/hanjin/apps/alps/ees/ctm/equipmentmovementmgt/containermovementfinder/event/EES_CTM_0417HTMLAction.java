...
*@FileName : EES_CTM_0417HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class EES_CTM_0417HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0417HTMLAction 객체를 생성
	 */
	public EES_CTM_0417HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0417Event event = new EesCtm0417Event();
		event.setSearchEDIErrorVO((SearchEDIErrorVO)getVO(request, SearchEDIErrorVO.class));
