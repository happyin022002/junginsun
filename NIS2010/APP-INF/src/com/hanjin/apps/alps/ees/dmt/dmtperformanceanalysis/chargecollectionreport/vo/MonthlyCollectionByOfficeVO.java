...
public class MonthlyCollectionByOfficeVO extends AbstractValueObject {
	...
	/* Column Info */
	private String arIfMAmt = null;
	/* Column Info */
	private String arIfOthAmt = null;
	/* Column Info */
	...
	public MonthlyCollectionByOfficeVO(String ibflag, String pagerows, String ofcCd, String tariff, String ioBnd, String currCd, String billCntr, String billAmt, String invCntr, String invAmt, String invMCntr, String invMAmt, String collCntr, String collAmt, String collMCntr, String collMAmt, String collOthAmt, String arIfCntr, String arIfAmt, String arIfMAmt, String arIfOthAmt, String ofcRhqCd, String year, String month, String ctrlOfcCd) {
		this.currCd = currCd;
		...
		this.arIfMAmt = arIfMAmt;
		this.arIfOthAmt = arIfOthAmt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ar_if_m_amt", getArIfMAmt());
		this.hashColumns.put("ar_if_oth_amt", getArIfOthAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ar_if_m_amt", "arIfMAmt");
		this.hashFields.put("ar_if_oth_amt", "arIfOthAmt");
	...
	public String getArIfMAmt() {
		return arIfMAmt;
	}

	public void setArIfMAmt(String arIfMAmt) {
		this.arIfMAmt = arIfMAmt;
	}

	public String getArIfOthAmt() {
		return arIfOthAmt;
	}

	public void setArIfOthAmt(String arIfOthAmt) {
		this.arIfOthAmt = arIfOthAmt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setArIfCntr(JSPUtil.getParameter(request, "ar_if_cntr", ""));
		setArIfAmt(JSPUtil.getParameter(request, "ar_if_amt", ""));
		setArIfMAmt(JSPUtil.getParameter(request, "ar_if_m_amt", ""));
		setArIfOthAmt(JSPUtil.getParameter(request, "ar_if_oth_amt", ""));
	...
	public MonthlyCollectionByOfficeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] arIfMAmt = (JSPUtil.getParameter(request, prefix	+ "ar_if_m_amt", length));
			String[] arIfOthAmt = (JSPUtil.getParameter(request, prefix	+ "ar_if_oth_amt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (arIfMAmt[i] != null)
					model.setArIfMAmt(arIfMAmt[i]);
				if (arIfOthAmt[i] != null)
					model.setArIfOthAmt(arIfOthAmt[i]);
				if (ofcRhqCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.arIfMAmt = this.arIfMAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.arIfOthAmt = this.arIfOthAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
