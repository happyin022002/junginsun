...
*@FileName : EccInfoManageDBDAOSearchEccTSTMLInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EccInfoManageDBDAOSearchEccTSTMLInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_SCNR_TS_TML 테이블 데이터 조회
	  * </pre>
	  */
	public EccInfoManageDBDAOSearchEccTSTMLInfoRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append(",SCNR_ID SCNR_ID1         -- HIDDEN" ).append("\n"); 
		query.append(",ECC_CD ECC_CD1          -- HIDDEN" ).append("\n"); 
		query.append("FROM EQR_SCNR_TS_TML" ).append("\n"); 
		...
		query.append("FileName : EccInfoManageDBDAOSearchEccTSTMLInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}