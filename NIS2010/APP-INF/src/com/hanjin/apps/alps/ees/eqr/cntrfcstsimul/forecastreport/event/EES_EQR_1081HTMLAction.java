...
*@FileName : EES_CIM_1081HTMLAction.java
*@FileTitle : MTY Repo In
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EES_EQR_1081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CIM_1048HTMLAction 객체를 생성
	 */
	public EES_EQR_1081HTMLAction() {} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesEqr1081Event event = new EesEqr1081Event();
		...
		event.setEesEqr1081ConditionVO((EesEqr1081ConditionVO)getVO(request, EesEqr1081ConditionVO .class));
