...
*@FileName : CntrRepoExecutionPlanEstablishDBDAOUpdateInitOnOffHireExecuteUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoExecutionPlanEstablishDBDAOUpdateInitOnOffHireExecuteUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ONF_HIR_EXE_PLN 삭제   ( 해당 REF_ID )
	  * so flag 초기화
	  * </pre>
	  */
	public CntrRepoExecutionPlanEstablishDBDAOUpdateInitOnOffHireExecuteUSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoExecutionPlanEstablishDBDAOUpdateInitOnOffHireExecuteUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SO_RQST_DT= NULL" ).append("\n"); 
		query.append(",	SO_ISS_FLG = NULL" ).append("\n"); 
		query.append(",	NON_SO_ISS_FLG = NULL" ).append("\n"); 
