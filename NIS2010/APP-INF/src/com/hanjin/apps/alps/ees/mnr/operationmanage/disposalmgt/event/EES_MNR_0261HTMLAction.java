...
*@FileName : EES_MNR_0261HTMLAction.java
 ...
 * @author 신혜정
 * @see EesMnr0261Event 참조
 * @since J2EE 1.4
 */    
   
public class EES_MNR_0261HTMLAction extends HTMLActionSupport {
 
	private static final long serialVersionUID = 1L;
	
	/**
	 * EES_MNR_0261HTMLAction 객체를 생성
	 */
	public EES_MNR_0261HTMLAction() {}
    
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EesMnr0261Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesMnr0261Event event = new EesMnr0261Event();
				
		//조회  	
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDisposalNVO((DisposalNVO)getVO(request, DisposalNVO .class));
