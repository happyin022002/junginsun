...
*@FileName : ContainerMovementValidationDBDAOSearchCodeExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerMovementValidationDBDAOSearchCodeExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerMovementValidationDBDAOSearchCodeExistRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.ees.ctm.ctmcommon.containermovementvalidation.integration").append("\n"); 
		query.append("FileName : ContainerMovementValidationDBDAOSearchCodeExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 1 AS COLUMN_NM" ).append("\n"); 
