...
public class LeaseReportDBDAOsearchOffHireResultvsDOLSummaryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2010.10.14 남궁진호 [CHM-201006506-01]  DOL = OffHire --> DOL이 없어도 OffHire 실적을 가져오도록 수정함. 
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("                                                                 #foreach($key IN ${agmt_seq_str})" ).append("\n"); 
		query.append("                                                                     #if($velocityCount < $agmt_seq_str.size())" ).append("\n"); 
		query.append("                                                                         '$key'," ).append("\n"); 
		query.append("                                                                     #else" ).append("\n"); 
		query.append("                                                                         '$key'" ).append("\n"); 
		query.append("                                                                     #end" ).append("\n"); 
		...
		query.append("                                #end" ).append("\n"); 
		query.append("                                " ).append("\n"); 
		query.append("                                GROUP BY  A.SCC_CD , A.AGMT_CTY_CD, A.AGMT_SEQ , A.CNTR_TPSZ_CD" ).append("\n"); 
		...
		query.append("        AGMT_NO     ," ).append("\n"); 
		query.append("        DECODE(DIV, 1, 'DOL', 2 , 'Off-Hired' , 3, 'Balance', 4, 'Current MT' )            AS DIV     ," ).append("\n"); 
