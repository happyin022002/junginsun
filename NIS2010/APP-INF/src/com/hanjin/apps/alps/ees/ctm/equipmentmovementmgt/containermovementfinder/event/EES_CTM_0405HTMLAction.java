...
*@FileName : EES_CTM_0405HTMLAction.java
...
public class EES_CTM_0405HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EES_CTM_0405HTMLAction 객체를 생성
	 */
	public EES_CTM_0405HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EesCtm0405Event event = new EesCtm0405Event();


		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchEmptyBookingListVO((SearchEmptyBookingListVO)getVO(request, SearchEmptyBookingListVO .class));
		}
