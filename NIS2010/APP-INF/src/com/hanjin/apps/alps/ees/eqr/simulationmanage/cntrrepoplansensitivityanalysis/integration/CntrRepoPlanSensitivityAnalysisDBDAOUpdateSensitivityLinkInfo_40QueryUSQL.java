...
*@FileName : CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_40QueryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_40QueryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_ECC_LNK 테이블에 대한 TZ 40feet amount  수정
	  * </pre>
	  */
	public CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_40QueryUSQL(){
		setQuery();
		...
		query.append("FileName : CntrRepoPlanSensitivityAnalysisDBDAOUpdateSensitivityLinkInfo_40QueryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET  TZ_40FT_COST_AMT  = ${curr_cost}" ).append("\n"); 
