...
*@FileName : ScenarioManageDBDAOUpdateScenarioIDUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScenarioManageDBDAOUpdateScenarioIDUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScenarioManageDBDAOUpdateScenarioIDUSQL(){
		setQuery();
		...
		query.append("FileName : ScenarioManageDBDAOUpdateScenarioIDUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
