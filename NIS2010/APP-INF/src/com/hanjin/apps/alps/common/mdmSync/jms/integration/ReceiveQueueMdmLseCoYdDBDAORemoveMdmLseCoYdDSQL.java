...
*@FileName : ReceiveQueueMdmLseCoYdDBDAORemoveMdmLseCoYdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmLseCoYdDBDAORemoveMdmLseCoYdDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmLseCoYdDBDAORemoveMdmLseCoYdDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmLseCoYdDBDAORemoveMdmLseCoYdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* ReceiveQueueMdmLseCoYdDBDAO - removeMDM_LSE_CO_YD() */" ).append("\n"); 
