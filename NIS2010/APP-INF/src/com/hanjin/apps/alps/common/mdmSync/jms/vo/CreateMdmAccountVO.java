...
public class CreateMdmAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CreateMdmAccountVO> models = new ArrayList<CreateMdmAccountVO>();
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pnd_tgt_flg", "acctgMngTpCd");
	 ...
	 */
	public CreateMdmAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchMdmAccountVO[]
	 */
	public CreateMdmAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
	 ...
	 * @return SearchMdmAccountVO[]
	 */
	public CreateMdmAccountVO[] getSearchMdmAccountVOs(){
		CreateMdmAccountVO[] vos = (CreateMdmAccountVO[])models.toArray(new CreateMdmAccountVO[models.size()]);
		return vos;
	}
