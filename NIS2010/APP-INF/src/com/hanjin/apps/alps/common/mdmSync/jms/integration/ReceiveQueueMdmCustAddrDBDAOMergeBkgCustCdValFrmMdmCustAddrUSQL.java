...
*@FileName : ReceiveQueueMdmCustAddrDBDAOMergeBkgCustCdValFrmMdmCustAddrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCustAddrDBDAOMergeBkgCustCdValFrmMdmCustAddrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * mdm_cust_addr 가 update 될 때 처리 (bkg_cust_cd_val 에도 update 처리)
	  * </pre>
	  */
	public ReceiveQueueMdmCustAddrDBDAOMergeBkgCustCdValFrmMdmCustAddrUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCustAddrDBDAOMergeBkgCustCdValFrmMdmCustAddrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
