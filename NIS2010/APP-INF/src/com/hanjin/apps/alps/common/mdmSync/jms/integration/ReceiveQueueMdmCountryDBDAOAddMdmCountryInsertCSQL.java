...
*@FileName : ReceiveQueueMdmCountryDBDAOAddMdmCountryInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCountryDBDAOAddMdmCountryInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmCountryDBDAOAddMdmCountryInsertCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCountryDBDAOAddMdmCountryInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_COUNTRY (" ).append("\n"); 
