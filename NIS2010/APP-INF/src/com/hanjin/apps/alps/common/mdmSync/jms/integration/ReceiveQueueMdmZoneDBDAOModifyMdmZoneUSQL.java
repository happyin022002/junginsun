...
*@FileName : ReceiveQueueMdmZoneDBDAOModifyMdmZoneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmZoneDBDAOModifyMdmZoneUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmZoneDBDAOModifyMdmZoneUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmZoneDBDAOModifyMdmZoneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			 	loc_cd          = @[loc_cd] ,cgo_hndl_tm_hrs = @[cgo_hndl_tm_hrs] ,dist_ut_cd      = @[dist_ut_cd] ,lnk_dist        = @[lnk_dist] ,	" ).append("\n"); 
		query.append("			 	tztm_hrs        = @[tztm_hrs] ,cre_usr_id      = @[cre_usr_id] ,                                        	" ).append("\n"); 
