...
*@FileName : ReceiveQueueMdmZnGeneralDBDAOModifyMdmZnGeneralUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmZnGeneralDBDAOModifyMdmZnGeneralUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmZnGeneralDBDAOModifyMdmZnGeneralUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmZnGeneralDBDAOModifyMdmZnGeneralUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE mdm_zone SET                                        				" ).append("\n"); 
		query.append("			 					zn_nm           = @[zn_nm] ,rep_yd_cd       = @[rep_yd_cd] ,				" ).append("\n"); 
		query.append("			 	loc_cd          = @[loc_cd] ,cgo_hndl_tm_hrs = @[cgo_hndl_tm_hrs] ,dist_ut_cd      = @[dist_ut_cd] ,            " ).append("\n"); 
		query.append("			 	lnk_dist        = @[lnk_dist] ,tztm_hrs        = @[tztm_hrs] ,cre_usr_id      = @[cre_usr_id] ,            " ).append("\n"); 
