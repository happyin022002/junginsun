...
*@FileName : ReceiveQueueMdmVendorCustomerGeneralDBDAOModifyMdmVendorInclChkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVendorCustomerGeneralDBDAOModifyMdmVendorInclChkUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CHK_ 접두어 컬럼을 포함하여 update 처리한다. MDM019-0001 interface 에서 호출된다.
	  * </pre>
	  */
	public ReceiveQueueMdmVendorCustomerGeneralDBDAOModifyMdmVendorInclChkUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVendorCustomerGeneralDBDAOModifyMdmVendorInclChkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("chk_de_addr1        = HJSEAI_PKG.h_decode(@[chk_de_addr1], 'UTF8' ,'UTF8')," ).append("\n"); 
