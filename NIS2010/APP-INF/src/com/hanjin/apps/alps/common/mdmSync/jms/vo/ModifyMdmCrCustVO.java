...
*@FileName : ModifyMdmCrCustVO.java
*@FileTitle : ModifyMdmCrCustVO
*Open Issues :
*Change history :
...
public class ModifyMdmCrCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ModifyMdmCrCustVO> models = new ArrayList<ModifyMdmCrCustVO>();
...
/**
	 ...
	 * @param request
	 * @return ModifyMdmCrCustVO[]
	 */
	public ModifyMdmCrCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ModifyMdmCrCustVO[]
	 */
	public ModifyMdmCrCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ModifyMdmCrCustVO model = null;
	 ...
	 * @return ModifyMdmCrCustVO[]
	 */
	public ModifyMdmCrCustVO[] getModifyMdmCrCustVOs(){
		ModifyMdmCrCustVO[] vos = (ModifyMdmCrCustVO[])models.toArray(new ModifyMdmCrCustVO[models.size()]);
		return vos;
	}
