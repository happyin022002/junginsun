...
*@FileName : ReceiveQueueMdmSvcScpLaneDBDAOModifyMdmSvcScpLaneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmSvcScpLaneDBDAOModifyMdmSvcScpLaneUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmSvcScpLaneDBDAOModifyMdmSvcScpLaneUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmSvcScpLaneDBDAOModifyMdmSvcScpLaneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CRE_USR_ID = @[cre_usr_id]" ).append("\n"); 
