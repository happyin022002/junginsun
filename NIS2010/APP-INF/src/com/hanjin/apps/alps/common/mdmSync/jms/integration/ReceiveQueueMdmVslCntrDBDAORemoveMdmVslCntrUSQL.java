...
*@FileName : ReceiveQueueMdmVslCntrDBDAORemoveMdmVslCntrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVslCntrDBDAORemoveMdmVslCntrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmVslCntrDBDAORemoveMdmVslCntrUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVslCntrDBDAORemoveMdmVslCntrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
