...
*@FileName : ReceiveQueueMdmSvcScpLmtDBDAODeleteMdmSvcScpLmtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmSvcScpLmtDBDAODeleteMdmSvcScpLmtDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * mdm_svc_scp_lmt 테이블의 delt_flg='Y' 변경
	  * </pre>
	  */
	public ReceiveQueueMdmSvcScpLmtDBDAODeleteMdmSvcScpLmtDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmSvcScpLmtDBDAODeleteMdmSvcScpLmtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--AND		svc_scp_lmt_seq = [svc_scp_lmt_seq]" ).append("\n"); 
