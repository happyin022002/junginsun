...
*@FileName : ReceiveQueueMdmCurrencyDBDAORemoveMdmCurrencyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCurrencyDBDAORemoveMdmCurrencyDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * mdm_currency 테이블에서 삭제
	  * </pre>
	  */
	public ReceiveQueueMdmCurrencyDBDAORemoveMdmCurrencyDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCurrencyDBDAORemoveMdmCurrencyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
