...
public class MdmYardVO extends AbstractValueObject {
	...
	/* Column Info */
	private String avgDwllHors = null;
	/* Column Info */
	private String minDwllHors = null;
	/* Column Info */
	private String ydFtHors = null;
	/* Column Info */
	...
	public MdmYardVO(String ibflag, String pagerows, String ydCd, String ydNm, String locCd, String n1stVndrCntCd, String n1stVndrSeq, String n2ndVndrCntCd, String n2ndVndrSeq, String n3rdVndrCntCd, String n3rdVndrSeq, String ofcCd, String ydChrCd, String ydFctyTpMrnTmlFlg, String ydFctyTpCyFlg, String ydFctyTpCfsFlg, String ydFctyTpRailRmpFlg, String ydOshpCd, String bdYdFlg, String onfHirYdFlg, String repZnCd, String ydAddr, String zipCd, String intlPhnNo, String dryAvgDwllHrs, String dryMinDwllHrs, String dryYdFtHrs, String avgDwllHors, String minDwllHors, String ydFtHors, String ydLoclLangNm, String ydLoclLangAddr, String phnNo, String faxNo, String ydPicNm, String ydCeoNm, String gateOpnHrmnt, String gateClzHrmnt, String holGateOpnHrmnt, String holGateClzHrmnt, String sunGateOpnHrmnt, String sunGateClzHrmnt, String satGateOpnHrmnt, String satGateClzHrmnt, String ydCgoClzHrmntMsg, String ydRmk, String brthNo, String ydBrthLen, String ydBrthAlngSdDesc, String ydBrthDpthChnlKnt, String ydTtlSpc, String ydActSpc, String ydHjsSpc, String ydHndlCapa, String ydRfRcpt440vKnt, String ydRfRcpt220vKnt, String ydRfRcptDulKnt, String ydOpSysCd, String ydInrlFlg, String ydCfsSpc, String mnrShopFlg, String ydHndlYr, String ydTtlVolTeuKnt, String ydTtlVolBxKnt, String ydHjsVolTeuKnt, String ydHjsVolBxKnt, String ydPstPgcKnt, String ydPgcKnt, String trstrKnt, String frkKnt, String ydStrdlCrrKnt, String ydTrctKnt, String ydTopLftKnt, String tmlChssKnt, String eirSvcFlg, String tmlProdKnt, String ydCstmsNo, String ydFctyTpPsdoYdFlg, String ydEml, String demIbCltFlg, String demObCltFlg, String bkgPodYdFlg, String ydFctyTpBrgRmpFlg, String bfrOfcCd, String bfrOfcCngDt, String modiYdCd, String dmdtOfcCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String repYdTpCd, String hubYdFlg, String eaiEvntDt, String eaiIfId) {
		...
		this.avgDwllHors = avgDwllHors;
		this.minDwllHors = minDwllHors;
		this.ydFtHors = ydFtHors;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rf_avg_dwll_hrs", getAvgDwllHors());
		this.hashColumns.put("rf_min_dwll_hrs", getMinDwllHors());
		this.hashColumns.put("rf_yd_ft_hrs", getYdFtHors());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rf_avg_dwll_hrs", "avgDwllHors");
		this.hashFields.put("rf_min_dwll_hrs", "minDwllHors");
		this.hashFields.put("rf_yd_ft_hrs", "ydFtHors");
	 ...
	 * @return avgDwllHors
	 */
	public String getAvgDwllHors() {
		return this.avgDwllHors;
	}
	 ...
	 * @return minDwllHors
	 */
	public String getMinDwllHors() {
		return this.minDwllHors;
	}
	 ...
	 * @return ydFtHors
	 */
	public String getYdFtHors() {
		return this.ydFtHors;
	}
	 ...
	 * @param avgDwllHors
	 */
	public void setAvgDwllHors(String avgDwllHors) {
		this.avgDwllHors = avgDwllHors;
	}
	 ...
	 * @param minDwllHors
	 */
	public void setMinDwllHors(String minDwllHors) {
		this.minDwllHors = minDwllHors;
	}
	 ...
	 * @param ydFtHors
	 */
	public void setYdFtHors(String ydFtHors) {
		this.ydFtHors = ydFtHors;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		setYdCgoClzHrmntMsg(JSPUtil.getParameter(request, "yd_cgo_clz_hrmnt_msg", ""));
		setYdTrctKnt(JSPUtil.getParameter(request, "yd_trct_knt", ""));
		setYdActSpc(JSPUtil.getParameter(request, "yd_act_spc", ""));
		setHolGateClzHrmnt(JSPUtil.getParameter(request, "hol_gate_clz_hrmnt", ""));
		setYdBrthDpthChnlKnt(JSPUtil.getParameter(request, "yd_brth_dpth_chnl_knt", ""));
		setYdRfRcpt220vKnt(JSPUtil.getParameter(request, "yd_rf_rcpt_220v_knt", ""));
		setYdFctyTpBrgRmpFlg(JSPUtil.getParameter(request, "yd_fcty_tp_brg_rmp_flg", ""));
		setHolGateOpnHrmnt(JSPUtil.getParameter(request, "hol_gate_opn_hrmnt", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setLocCd(JSPUtil.getParameter(request, "loc_cd", ""));
		setDemObCltFlg(JSPUtil.getParameter(request, "dem_ob_clt_flg", ""));
		setYdRmk(JSPUtil.getParameter(request, "yd_rmk", ""));
		setYdTtlVolBxKnt(JSPUtil.getParameter(request, "yd_ttl_vol_bx_knt", ""));
		setBrthNo(JSPUtil.getParameter(request, "brth_no", ""));
		setN3rdVndrCntCd(JSPUtil.getParameter(request, "n3rd_vndr_cnt_cd", ""));
		setBfrOfcCngDt(JSPUtil.getParameter(request, "bfr_ofc_cng_dt", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setYdHjsVolTeuKnt(JSPUtil.getParameter(request, "yd_hjs_vol_teu_knt", ""));
		setRepZnCd(JSPUtil.getParameter(request, "rep_zn_cd", ""));
		setYdFctyTpCyFlg(JSPUtil.getParameter(request, "yd_fcty_tp_cy_flg", ""));
		setPhnNo(JSPUtil.getParameter(request, "phn_no", ""));
		setTrstrKnt(JSPUtil.getParameter(request, "trstr_knt", ""));
		setN2ndVndrSeq(JSPUtil.getParameter(request, "n2nd_vndr_seq", ""));
		setSunGateOpnHrmnt(JSPUtil.getParameter(request, "sun_gate_opn_hrmnt", ""));
		setYdCeoNm(JSPUtil.getParameter(request, "yd_ceo_nm", ""));
		setTmlProdKnt(JSPUtil.getParameter(request, "tml_prod_knt", ""));
		setYdPicNm(JSPUtil.getParameter(request, "yd_pic_nm", ""));
		setYdHndlYr(JSPUtil.getParameter(request, "yd_hndl_yr", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setYdCfsSpc(JSPUtil.getParameter(request, "yd_cfs_spc", ""));
		setYdChrCd(JSPUtil.getParameter(request, "yd_chr_cd", ""));
		setN1stVndrCntCd(JSPUtil.getParameter(request, "n1st_vndr_cnt_cd", ""));
		setZipCd(JSPUtil.getParameter(request, "zip_cd", ""));
		setN2ndVndrCntCd(JSPUtil.getParameter(request, "n2nd_vndr_cnt_cd", ""));
		setYdNm(JSPUtil.getParameter(request, "yd_nm", ""));
		setFaxNo(JSPUtil.getParameter(request, "fax_no", ""));
		setYdOshpCd(JSPUtil.getParameter(request, "yd_oshp_cd", ""));
		setSunGateClzHrmnt(JSPUtil.getParameter(request, "sun_gate_clz_hrmnt", ""));
		setHubYdFlg(JSPUtil.getParameter(request, "hub_yd_flg", ""));
		setDeltFlg(JSPUtil.getParameter(request, "delt_flg", ""));
		setYdStrdlCrrKnt(JSPUtil.getParameter(request, "yd_strdl_crr_knt", ""));
		setYdRfRcptDulKnt(JSPUtil.getParameter(request, "yd_rf_rcpt_dul_knt", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setYdFctyTpPsdoYdFlg(JSPUtil.getParameter(request, "yd_fcty_tp_psdo_yd_flg", ""));
		setRepYdTpCd(JSPUtil.getParameter(request, "rep_yd_tp_cd", ""));
		setYdTopLftKnt(JSPUtil.getParameter(request, "yd_top_lft_knt", ""));
		setYdPstPgcKnt(JSPUtil.getParameter(request, "yd_pst_pgc_knt", ""));
		setYdInrlFlg(JSPUtil.getParameter(request, "yd_inrl_flg", ""));
		setYdFctyTpCfsFlg(JSPUtil.getParameter(request, "yd_fcty_tp_cfs_flg", ""));
		setYdHjsSpc(JSPUtil.getParameter(request, "yd_hjs_spc", ""));
		setYdPgcKnt(JSPUtil.getParameter(request, "yd_pgc_knt", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setModiYdCd(JSPUtil.getParameter(request, "modi_yd_cd", ""));
		setYdTtlVolTeuKnt(JSPUtil.getParameter(request, "yd_ttl_vol_teu_knt", ""));
		setYdHjsVolBxKnt(JSPUtil.getParameter(request, "yd_hjs_vol_bx_knt", ""));
		setN1stVndrSeq(JSPUtil.getParameter(request, "n1st_vndr_seq", ""));
		setGateClzHrmnt(JSPUtil.getParameter(request, "gate_clz_hrmnt", ""));
		setDemIbCltFlg(JSPUtil.getParameter(request, "dem_ib_clt_flg", ""));
		setBfrOfcCd(JSPUtil.getParameter(request, "bfr_ofc_cd", ""));
		setSatGateOpnHrmnt(JSPUtil.getParameter(request, "sat_gate_opn_hrmnt", ""));
		setN3rdVndrSeq(JSPUtil.getParameter(request, "n3rd_vndr_seq", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setYdCstmsNo(JSPUtil.getParameter(request, "yd_cstms_no", ""));
		setYdTtlSpc(JSPUtil.getParameter(request, "yd_ttl_spc", ""));
		setDmdtOfcCd(JSPUtil.getParameter(request, "dmdt_ofc_cd", ""));
		setYdBrthAlngSdDesc(JSPUtil.getParameter(request, "yd_brth_alng_sd_desc", ""));
		setGateOpnHrmnt(JSPUtil.getParameter(request, "gate_opn_hrmnt", ""));
		setYdFctyTpRailRmpFlg(JSPUtil.getParameter(request, "yd_fcty_tp_rail_rmp_flg", ""));
		setYdFctyTpMrnTmlFlg(JSPUtil.getParameter(request, "yd_fcty_tp_mrn_tml_flg", ""));
		setOnfHirYdFlg(JSPUtil.getParameter(request, "onf_hir_yd_flg", ""));
		setYdHndlCapa(JSPUtil.getParameter(request, "yd_hndl_capa", ""));
		setEaiEvntDt(JSPUtil.getParameter(request, "eai_evnt_dt", ""));
		setEaiIfId(JSPUtil.getParameter(request, "eai_if_id", ""));
		setYdRfRcpt440vKnt(JSPUtil.getParameter(request, "yd_rf_rcpt_440v_knt", ""));
		setMnrShopFlg(JSPUtil.getParameter(request, "mnr_shop_flg", ""));
		setEirSvcFlg(JSPUtil.getParameter(request, "eir_svc_flg", ""));
		setTmlChssKnt(JSPUtil.getParameter(request, "tml_chss_knt", ""));
		setOfcCd(JSPUtil.getParameter(request, "ofc_cd", ""));
		setSatGateClzHrmnt(JSPUtil.getParameter(request, "sat_gate_clz_hrmnt", ""));
		setYdCd(JSPUtil.getParameter(request, "yd_cd", ""));
		setFrkKnt(JSPUtil.getParameter(request, "frk_knt", ""));
		setYdBrthLen(JSPUtil.getParameter(request, "yd_brth_len", ""));
		setYdAddr(JSPUtil.getParameter(request, "yd_addr", ""));
		setYdOpSysCd(JSPUtil.getParameter(request, "yd_op_sys_cd", ""));
		setBdYdFlg(JSPUtil.getParameter(request, "bd_yd_flg", ""));
		setYdEml(JSPUtil.getParameter(request, "yd_eml", ""));
		setBkgPodYdFlg(JSPUtil.getParameter(request, "bkg_pod_yd_flg", ""));
		setIntlPhnNo(JSPUtil.getParameter(request, "intl_phn_no", ""));
		setDryAvgDwllHrs(JSPUtil.getParameter(request, "dry_avg_dwll_hrs", ""));
		setDryMinDwllHrs(JSPUtil.getParameter(request, "dry_min_dwll_hrs", ""));
		setDryYdFtHrs(JSPUtil.getParameter(request, "dry_yd_ft_hrs", ""));
		setAvgDwllHors(JSPUtil.getParameter(request, "rf_avg_dwll_hrs", ""));
		setMinDwllHors(JSPUtil.getParameter(request, "rf_min_dwll_hrs", ""));
		setYdFtHors(JSPUtil.getParameter(request, "rf_yd_ft_hrs", ""));
		setYdLoclLangNm(JSPUtil.getParameter(request, "yd_locl_lang_nm", ""));
		setYdLoclLangAddr(JSPUtil.getParameter(request, "yd_locl_lang_addr", ""));
	}
	...
	public MdmYardVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] avgDwllHors = (JSPUtil.getParameter(request, prefix	+ "rf_avg_dwll_hrs", length));
			String[] minDwllHors = (JSPUtil.getParameter(request, prefix	+ "rf_min_dwll_hrs", length));
			String[] ydFtHors = (JSPUtil.getParameter(request, prefix	+ "rf_yd_ft_hrs", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (avgDwllHors[i] != null)
					model.setAvgDwllHors(avgDwllHors[i]);
				if (minDwllHors[i] != null)
					model.setMinDwllHors(minDwllHors[i]);
				if (ydFtHors[i] != null)
					model.setYdFtHors(ydFtHors[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.avgDwllHors = this.avgDwllHors .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.minDwllHors = this.minDwllHors .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ydFtHors = this.ydFtHors .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
