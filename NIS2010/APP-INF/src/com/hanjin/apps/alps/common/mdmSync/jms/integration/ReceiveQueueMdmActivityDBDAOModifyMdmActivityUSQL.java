...
*@FileName : ReceiveQueueMdmActivityDBDAOModifyMdmActivityUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmActivityDBDAOModifyMdmActivityUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmActivityDBDAOModifyMdmActivityUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmActivityDBDAOModifyMdmActivityUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("act_nm      = @[act_nm]," ).append("\n"); 
