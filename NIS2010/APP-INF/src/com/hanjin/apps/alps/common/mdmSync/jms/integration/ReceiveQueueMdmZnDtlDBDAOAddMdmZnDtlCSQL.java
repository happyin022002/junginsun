...
*@FileName : ReceiveQueueMdmZnDtlDBDAOAddMdmZnDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmZnDtlDBDAOAddMdmZnDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmZnDtlDBDAOAddMdmZnDtlCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmZnDtlDBDAOAddMdmZnDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	cre_dt     ,upd_usr_id ,upd_dt     ,eai_evnt_dt ,eai_if_id, delt_flg            		" ).append("\n"); 
		query.append(" )                                                                      " ).append("\n"); 
		...
		query.append("	to_date(@[eai_evnt_dt] ,'yyyymmddhh24miss') ,@[eai_if_id] , @[delt_flg]                                          	" ).append("\n"); 
		query.append(" )" ).append("\n"); 
