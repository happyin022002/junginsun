...
*@FileName : ReceiveQueueMdmRegionDBDAOAddMdmRegionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmRegionDBDAOAddMdmRegionCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmRegionDBDAOAddMdmRegionCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmRegionDBDAOAddMdmRegionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO mdm_region (" ).append("\n"); 
