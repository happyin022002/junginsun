...
*@FileName : ReceiveQueueMdmEqOrzChtDBDAORemoveMdmEqOrzChtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmEqOrzChtDBDAORemoveMdmEqOrzChtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_EQ_ORZ_CHT.DELT_FLG 'Y' 로 변경
	  * </pre>
	  */
	public ReceiveQueueMdmEqOrzChtDBDAORemoveMdmEqOrzChtUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmEqOrzChtDBDAORemoveMdmEqOrzChtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_EQ_ORZ_CHT SET " ).append("\n"); 
