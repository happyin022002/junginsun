...
*@FileName : ReceiveQueueMdmSlsRepDBDAORemoveMdmSlsRepDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmSlsRepDBDAORemoveMdmSlsRepDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmSlsRepDBDAORemoveMdmSlsRepDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmSlsRepDBDAORemoveMdmSlsRepDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET srep_sts_cd  = 'Y'," ).append("\n"); 
