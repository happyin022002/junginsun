...
*@FileName : ReceiveQueueMdmRepCmdtDBDAORemoveMdmRepCmdtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmRepCmdtDBDAORemoveMdmRepCmdtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmRepCmdtDBDAORemoveMdmRepCmdtUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmRepCmdtDBDAORemoveMdmRepCmdtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE mdm_rep_cmdt" ).append("\n"); 
