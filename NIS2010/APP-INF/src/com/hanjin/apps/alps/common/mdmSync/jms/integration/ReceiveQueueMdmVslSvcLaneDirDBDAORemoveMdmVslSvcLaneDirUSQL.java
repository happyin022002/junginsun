...
*@FileName : ReceiveQueueMdmVslSvcLaneDirDBDAORemoveMdmVslSvcLaneDirUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVslSvcLaneDirDBDAORemoveMdmVslSvcLaneDirUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveMdmVslSvcLaneDir
	  * </pre>
	  */
	public ReceiveQueueMdmVslSvcLaneDirDBDAORemoveMdmVslSvcLaneDirUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVslSvcLaneDirDBDAORemoveMdmVslSvcLaneDirUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
