...
*@FileName : ReceiveQueueMdmDaylightDBDAOModifyMdmDaylightUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmDaylightDBDAOModifyMdmDaylightUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM Dayligt Saving Time Update
	  * </pre>
	  */
	public ReceiveQueueMdmDaylightDBDAOModifyMdmDaylightUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmDaylightDBDAOModifyMdmDaylightUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_DYLGT_SAV_TM SET" ).append("\n"); 
		...
		query.append("ST_DST_DT = SUBSTR(@[st_dst_dt],1,8)," ).append("\n"); 
		query.append("ST_DST_HRMNT = @[st_dst_hrmnt]," ).append("\n"); 
		query.append("END_DST_HRMNT = @[end_dst_hrmnt]," ).append("\n"); 
		query.append("END_DST_DT = SUBSTR(@[end_dst_dt],1,8)," ).append("\n"); 
