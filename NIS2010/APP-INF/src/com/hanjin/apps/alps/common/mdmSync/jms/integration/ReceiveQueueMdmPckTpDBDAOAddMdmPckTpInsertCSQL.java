...
*@FileName : ReceiveQueueMdmPckTpDBDAOAddMdmPckTpInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmPckTpDBDAOAddMdmPckTpInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmPckTpDBDAOAddMdmPckTpInsertCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmPckTpDBDAOAddMdmPckTpInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO mdm_pck_tp" ).append("\n"); 
		query.append("(" ).append("\n"); 
