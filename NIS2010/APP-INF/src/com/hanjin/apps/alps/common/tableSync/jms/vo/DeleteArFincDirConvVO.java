...
*@FileName : DeleteTableArFinDirConvVO.java
*@FileTitle : DeleteTableArFinDirConvVO
*Open Issues :
*Change history :
...
public class DeleteArFincDirConvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DeleteArFincDirConvVO> models = new ArrayList<DeleteArFincDirConvVO>();
	...
	public DeleteArFincDirConvVO() {}

	public DeleteArFincDirConvVO(String ibflag, String pagerows, String slanCd, String scontiCd, String slanDirCd, String rlaneDirCd, String eaiEvntDt) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return DeleteTableArFinDirConvVO[]
	 */
	public DeleteArFincDirConvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DeleteTableArFinDirConvVO[]
	 */
	public DeleteArFincDirConvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DeleteArFincDirConvVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new DeleteArFincDirConvVO();
				if (ibflag[i] != null)
		...
		return getDeleteTableArFinDirConvVOs();
	}
	 ...
	 * @return DeleteTableArFinDirConvVO[]
	 */
	public DeleteArFincDirConvVO[] getDeleteTableArFinDirConvVOs(){
		DeleteArFincDirConvVO[] vos = (DeleteArFincDirConvVO[])models.toArray(new DeleteArFincDirConvVO[models.size()]);
		return vos;
	}
