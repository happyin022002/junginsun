...
*@FileName : ReceiveQueueMdmContinentDBDAOAddMdmContinentUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmContinentDBDAOAddMdmContinentUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMdmContinentUpdate
	  * </pre>
	  */
	public ReceiveQueueMdmContinentDBDAOAddMdmContinentUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmContinentDBDAOAddMdmContinentUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE mdm_continent SET" ).append("\n"); 
		query.append("conti_nm    = @[conti_nm],cre_usr_id  = @[cre_usr_id]," ).append("\n"); 
