...
public class MdmSubcontinentVO extends AbstractValueObject {
	...
	public MdmSubcontinentVO(String ibflag, String pagerows, String scontiCd, String contiCd, String scontiNm, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String className, String eaiIfId) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("class_name", getClassName());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("class_name", "className");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setClassName(JSPUtil.getParameter(request, "class_name", ""));
	...
	public MdmSubcontinentVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] className = (JSPUtil.getParameter(request, prefix	+ "class_name", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (className[i] != null)
					model.setClassName(className[i]);
				if (eaiEvntDt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.className = this.className .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
