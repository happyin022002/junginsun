...
*@FileName : ModifyTableGlMonXchRtVO.java
*@FileTitle : ModifyTableGlMonXchRtVO
*Open Issues :
*Change history :
...
public class ModifyGlMonXchRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ModifyGlMonXchRtVO> models = new ArrayList<ModifyGlMonXchRtVO>();
	...
	public ModifyGlMonXchRtVO() {}

	public ModifyGlMonXchRtVO(String ibflag, String pagerows, String usdLoclXchRt, String loclKrwXchRt, String usdKrwXchRt, String updDt, String deltFlg, String creDt, String eaiEvntDt, String acctXchRtYrmon, String acctXchRtLvl, String currCd) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return ModifyTableGlMonXchRtVO[]
	 */
	public ModifyGlMonXchRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ModifyTableGlMonXchRtVO[]
	 */
	public ModifyGlMonXchRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ModifyGlMonXchRtVO model = null;
		...
		return getModifyTableGlMonXchRtVOs();
	}
	 ...
	 * @return ModifyTableGlMonXchRtVO[]
	 */
	public ModifyGlMonXchRtVO[] getModifyTableGlMonXchRtVOs(){
		ModifyGlMonXchRtVO[] vos = (ModifyGlMonXchRtVO[])models.toArray(new ModifyGlMonXchRtVO[models.size()]);
		return vos;
	}
