...
*@FileName : ReceiveQueueMdmTradeDBDAOAddMdmTradeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmTradeDBDAOAddMdmTradeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmTradeDBDAOAddMdmTradeCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmTradeDBDAOAddMdmTradeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO mdm_trade (" ).append("\n"); 
		...
		query.append("    modi_trd_cd," ).append("\n"); 
		...
		query.append("    @[ofc_cd]     ," ).append("\n"); 
		query.append("    TO_DATE(@[st_eff_dt], 'yyyymmddhh24miss')," ).append("\n"); 
		query.append("    TO_DATE(@[end_eff_dt], 'yyyymmddhh24miss')," ).append("\n"); 
		query.append("    @[eai_if_id]" ).append("\n"); 
		query.append(")" ).append("\n"); 
