...
*@FileName : ReceiveQueueMdmGrpCmdtDBDAORemoveMdmGrpCmdtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmGrpCmdtDBDAORemoveMdmGrpCmdtDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmGrpCmdtDBDAORemoveMdmGrpCmdtDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmGrpCmdtDBDAORemoveMdmGrpCmdtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
