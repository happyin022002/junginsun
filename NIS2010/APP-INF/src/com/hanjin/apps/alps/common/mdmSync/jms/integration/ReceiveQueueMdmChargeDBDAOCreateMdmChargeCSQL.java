...
*@FileName : ReceiveQueueMdmChargeDBDAOCreateMdmChargeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmChargeDBDAOCreateMdmChargeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmChargeDBDAOCreateMdmChargeCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmChargeDBDAOCreateMdmChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    chg_cd,                 chg_nm,                 frt_chg_tp_cd,              sen_chg_acct_cd," ).append("\n"); 
		query.append("    hjs_chg_acct_cd,        rep_chg_cd,             chg_rev_tp_cd,              chg_aply_tp_cd," ).append("\n"); 
		query.append("    chg_aply_area_cd,       cy_rd_term_flg,         cfs_rd_term_flg,            dor_rd_term_flg," ).append("\n"); 
		query.append("    na_rd_term_flg,         tkl_tml_flg,            aply_svc_mod_flg,           use_co_tp_cd," ).append("\n"); 
		query.append("    auto_rat_flg,           sen_grp_chg_cd,         chg_edi_cd,                 dp_seq," ).append("\n"); 
		query.append("    chg_sts_cd,             cre_usr_id,             cre_dt,                     upd_usr_id," ).append("\n"); 
		...
		query.append("    @[na_rd_term_flg],      @[tkl_tml_flg],         @[aply_svc_mod_flg],        @[use_co_tp_cd]," ).append("\n"); 
		query.append("    @[auto_rat_flg],        @[sen_grp_chg_cd],      @[chg_edi_cd],              @[dp_seq]," ).append("\n"); 
		query.append("    @[chg_sts_cd],          @[cre_usr_id],			TO_DATE(@[cre_dt],'YYYYMMDDHH24MISS'),          @[upd_usr_id]," ).append("\n"); 
