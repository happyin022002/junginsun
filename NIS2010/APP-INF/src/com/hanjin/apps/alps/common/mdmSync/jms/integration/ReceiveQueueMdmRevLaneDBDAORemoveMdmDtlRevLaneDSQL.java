...
*@FileName : ReceiveQueueMdmRevLaneDBDAORemoveMdmDtlRevLaneDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmRevLaneDBDAORemoveMdmDtlRevLaneDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmRevLaneDBDAORemoveMdmDtlRevLaneDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmRevLaneDBDAORemoveMdmDtlRevLaneDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
