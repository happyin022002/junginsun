...
*@FileName : ReceiveQueueMdmGrpCmdtDBDAOModifyMdmGrpCmdtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmGrpCmdtDBDAOModifyMdmGrpCmdtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmGrpCmdtDBDAOModifyMdmGrpCmdtUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmGrpCmdtDBDAOModifyMdmGrpCmdtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE mdm_grp_cmdt" ).append("\n"); 
		query.append("   SET grp_cmdt_eng_nm = @[grp_cmdt_eng_nm]," ).append("\n"); 
