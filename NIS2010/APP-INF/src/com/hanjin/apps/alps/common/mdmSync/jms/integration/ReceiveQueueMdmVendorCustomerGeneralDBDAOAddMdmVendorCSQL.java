...
*@FileName : ReceiveQueueMdmVendorCustomerGeneralDBDAOAddMdmVendorCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVendorCustomerGeneralDBDAOAddMdmVendorCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_VENDOR 에 data 를 insert
	  * </pre>
	  */
	public ReceiveQueueMdmVendorCustomerGeneralDBDAOAddMdmVendorCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVendorCustomerGeneralDBDAOAddMdmVendorCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
