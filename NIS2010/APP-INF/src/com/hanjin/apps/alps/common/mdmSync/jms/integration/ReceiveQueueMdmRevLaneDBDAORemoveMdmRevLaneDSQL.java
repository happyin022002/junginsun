...
*@FileName : ReceiveQueueMdmRevLaneDBDAORemoveMdmRevLaneDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmRevLaneDBDAORemoveMdmRevLaneDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmRevLaneDBDAORemoveMdmRevLaneDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmRevLaneDBDAORemoveMdmRevLaneDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
