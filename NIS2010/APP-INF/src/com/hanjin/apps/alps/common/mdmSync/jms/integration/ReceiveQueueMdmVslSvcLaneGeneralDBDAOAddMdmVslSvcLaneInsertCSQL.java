...
*@FileName : ReceiveQueueMdmVslSvcLaneGeneralDBDAOAddMdmVslSvcLaneInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVslSvcLaneGeneralDBDAOAddMdmVslSvcLaneInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMdmVslSvcLaneInsert
	  * </pre>
	  */
	public ReceiveQueueMdmVslSvcLaneGeneralDBDAOAddMdmVslSvcLaneInsertCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVslSvcLaneGeneralDBDAOAddMdmVslSvcLaneInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO mdm_vsl_svc_lane " ).append("\n"); 
		query.append("( " ).append("\n"); 
		...
		query.append("      @[vsl_slan_nm]," ).append("\n"); 
		query.append("      @[vsl_svc_tp_cd]," ).append("\n"); 
		query.append("      SUBSTR(@[st_eff_dt], 1, 8)," ).append("\n"); 
		query.append("      SUBSTR(@[end_eff_dt], 1, 8)," ).append("\n"); 
		query.append("      @[vsl_slan_skd_tp_cd]," ).append("\n"); 
		query.append("      @[ofc_cd]," ).append("\n"); 
		query.append("      @[co_cd]," ).append("\n"); 
		query.append("      @[vsl_tp_cd]," ).append("\n"); 
