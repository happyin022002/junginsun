...
*@FileName : ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMdmCstmsPckTpInsert
	  * </pre>
	  */
	public ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpInsertCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO mdm_cstms_pck_tp" ).append("\n"); 
		query.append("(" ).append("\n"); 
