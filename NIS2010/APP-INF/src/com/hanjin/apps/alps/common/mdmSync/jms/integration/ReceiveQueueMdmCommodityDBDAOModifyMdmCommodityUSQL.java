...
*@FileName : ReceiveQueueMdmCommodityDBDAOModifyMdmCommodityUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCommodityDBDAOModifyMdmCommodityUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmCommodityDBDAOModifyMdmCommodityUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCommodityDBDAOModifyMdmCommodityUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET cmdt_nm         = @[cmdt_nm]," ).append("\n"); 
