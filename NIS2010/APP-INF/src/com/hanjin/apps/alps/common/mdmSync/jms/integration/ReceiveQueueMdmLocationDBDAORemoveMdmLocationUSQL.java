...
*@FileName : ReceiveQueueMdmLocationDBDAORemoveMdmLocationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmLocationDBDAORemoveMdmLocationUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmLocationDBDAORemoveMdmLocationUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmLocationDBDAORemoveMdmLocationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
