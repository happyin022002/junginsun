...
*@FileName : ReceiveQueueMdmCntrTpDBDAORemoveMdmCntrTpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCntrTpDBDAORemoveMdmCntrTpUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_CNTR_TP.DELT_FLG 'Y' 로 변경
	  * </pre>
	  */
	public ReceiveQueueMdmCntrTpDBDAORemoveMdmCntrTpUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCntrTpDBDAORemoveMdmCntrTpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
