...
*@FileName : ReceiveQueueApLuValDBDAOAddApLuValCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueApLuValDBDAOAddApLuValCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueApLuValDBDAOAddApLuValCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueApLuValDBDAOAddApLuValCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO ap_lu_val" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("lu_tp_ind_cd" ).append("\n"); 
		query.append(", lu_cd" ).append("\n"); 
		query.append(", lu_delt_flg" ).append("\n"); 
		query.append(", lu_ctnt" ).append("\n"); 
		query.append(", lu_desc" ).append("\n"); 
		query.append(", lu_st_act_dt" ).append("\n"); 
		query.append(", lu_end_act_dt" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("HJSEAI_PKG.h_decode(@[lu_tp_ind_cd]		, 'UTF8', 'UTF8')" ).append("\n"); 
		query.append(", HJSEAI_PKG.h_decode(@[lu_cd]		 	, 'UTF8', 'UTF8')" ).append("\n"); 
		query.append(", @[lu_delt_flg]" ).append("\n"); 
		query.append(", HJSEAI_PKG.h_decode(@[lu_ctnt]		, 'UTF8', 'UTF8')" ).append("\n"); 
		query.append(", HJSEAI_PKG.h_decode(@[lu_desc]		, 'UTF8', 'UTF8')" ).append("\n"); 
		query.append(", to_date(@[lu_st_act_dt]				, 'yyyymmddhh24miss')" ).append("\n"); 
		query.append(", to_date(@[lu_end_act_dt]				, 'yyyymmddhh24miss')" ).append("\n"); 
