...
public class SearchMdmActivityVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setActDesc(JSPUtil.getParameter(request, "act_desc", ""));
		...
		setUpdAvalFlg(JSPUtil.getParameter(request, "upd_aval_flg", ""));
		...
		setActTpCd(JSPUtil.getParameter(request, "act_tp_cd", ""));
		setCopSkdLgcTpCd(JSPUtil.getParameter(request, "cop_skd_lgc_tp_cd", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setActOpTpCd(JSPUtil.getParameter(request, "act_op_tp_cd", ""));
		setFullMtyCd(JSPUtil.getParameter(request, "full_mty_cd", ""));
		setEstmStndEdiStsCd(JSPUtil.getParameter(request, "estm_stnd_edi_sts_cd", ""));
	 ...
	 * @return MdmActivityVO[]
	 */
	public SearchMdmActivityVO[] getMdmActivityVOs(){
