...
*@FileName : ReceiveQueueMdmCntrTySzDBDAORemoveMdmCntrTpSzUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCntrTySzDBDAORemoveMdmCntrTpSzUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_CNTR_TP_SZ.DELT_FLG 'Y' 로 변경
	  * </pre>
	  */
	public ReceiveQueueMdmCntrTySzDBDAORemoveMdmCntrTpSzUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCntrTySzDBDAORemoveMdmCntrTpSzUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
