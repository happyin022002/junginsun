...
*@FileName : ReceiveQueueMdmVslSvcLaneDirDBDAOAddMdmVslSvcLaneDirUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVslSvcLaneDirDBDAOAddMdmVslSvcLaneDirUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMdmVslSvcLaneDirUpdate
	  * </pre>
	  */
	public ReceiveQueueMdmVslSvcLaneDirDBDAOAddMdmVslSvcLaneDirUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVslSvcLaneDirDBDAOAddMdmVslSvcLaneDirUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
