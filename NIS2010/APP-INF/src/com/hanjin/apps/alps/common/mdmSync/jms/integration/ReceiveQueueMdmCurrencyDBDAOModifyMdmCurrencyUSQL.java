...
*@FileName : ReceiveQueueMdmCurrencyDBDAOModifyMdmCurrencyUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCurrencyDBDAOModifyMdmCurrencyUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmCurrencyDBDAOModifyMdmCurrencyUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCurrencyDBDAOModifyMdmCurrencyUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("fm_eff_dt    = to_date(@[fm_eff_dt],'yyyymmddhh24miss')," ).append("\n"); 
		query.append("to_eff_dt    = to_date(@[to_eff_dt],'yyyymmddhh24miss')," ).append("\n"); 
