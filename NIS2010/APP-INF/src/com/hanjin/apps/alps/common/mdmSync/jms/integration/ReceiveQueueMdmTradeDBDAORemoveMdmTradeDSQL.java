...
*@FileName : ReceiveQueueMdmTradeDBDAORemoveMdmTradeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmTradeDBDAORemoveMdmTradeDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmTradeDBDAORemoveMdmTradeDSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmTradeDBDAORemoveMdmTradeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
