...
*@FileName : SearchMdmOrganizationVO.java
*@FileTitle : SearchMdmOrganizationVO
*Open Issues :
*Change history :
...
public class SearchMdmOrganizationVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAgnKndCd(JSPUtil.getParameter(request, "agn_knd_cd", ""));
		...
		setBilCurrCd(JSPUtil.getParameter(request, "bil_curr_cd", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setFxCurrRt(JSPUtil.getParameter(request, "fx_curr_rt", ""));
		setOfcCmmcCd(JSPUtil.getParameter(request, "ofc_cmmc_cd", ""));
		setLocCd(JSPUtil.getParameter(request, "loc_cd", ""));
		setRepCustCntCd(JSPUtil.getParameter(request, "rep_cust_cnt_cd", ""));
		setTeamMgrNm(JSPUtil.getParameter(request, "team_mgr_nm", ""));
		setClzDt(JSPUtil.getParameter(request, "clz_dt", ""));
		setOfcZipCd(JSPUtil.getParameter(request, "ofc_zip_cd", ""));
		setOfcAddr(JSPUtil.getParameter(request, "ofc_addr", ""));
		setModiOfcCd(JSPUtil.getParameter(request, "modi_ofc_cd", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setCommIfIndCd(JSPUtil.getParameter(request, "comm_if_ind_cd", ""));
		setApOfcCd(JSPUtil.getParameter(request, "ap_ofc_cd", ""));
		setTeamFaxNo(JSPUtil.getParameter(request, "team_fax_no", ""));
		setArCurrCd(JSPUtil.getParameter(request, "ar_curr_cd", ""));
		setAsaCrTermDys(JSPUtil.getParameter(request, "asa_cr_term_dys", ""));
		setArHdQtrOfcCd(JSPUtil.getParameter(request, "ar_hd_qtr_ofc_cd", ""));
		setFaxIp(JSPUtil.getParameter(request, "fax_ip", ""));
		setFincHideFlg(JSPUtil.getParameter(request, "finc_hide_flg", ""));
		setSubsCoFlg(JSPUtil.getParameter(request, "subs_co_flg", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setOfcRfaScUseFlg(JSPUtil.getParameter(request, "ofc_rfa_sc_use_flg", ""));
		setOfcRmk(JSPUtil.getParameter(request, "ofc_rmk", ""));
		setVndrSeq(JSPUtil.getParameter(request, "vndr_seq", ""));
		setOfcUrl(JSPUtil.getParameter(request, "ofc_url", ""));
		setRepCustSeq(JSPUtil.getParameter(request, "rep_cust_seq", ""));
		setApEuroCurrUseFlg(JSPUtil.getParameter(request, "ap_euro_curr_use_flg", ""));
		setApCtrCd(JSPUtil.getParameter(request, "ap_ctr_cd", ""));
		setOfcRepEml(JSPUtil.getParameter(request, "ofc_rep_eml", ""));
		setOfcFaxNo(JSPUtil.getParameter(request, "ofc_fax_no", ""));
		setDocRcvrHideFlg(JSPUtil.getParameter(request, "doc_rcvr_hide_flg", ""));
		setOfcTaxId(JSPUtil.getParameter(request, "ofc_tax_id", ""));
		setDeltFlg(JSPUtil.getParameter(request, "delt_flg", ""));
		setOfcLoclLangAddr(JSPUtil.getParameter(request, "ofc_locl_lang_addr", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setOfcEngNm(JSPUtil.getParameter(request, "ofc_eng_nm", ""));
		setBkgSvrSrchRoutCd(JSPUtil.getParameter(request, "bkg_svr_srch_rout_cd", ""));
		setArCtrCd(JSPUtil.getParameter(request, "ar_ctr_cd", ""));
		setIbCrTermDys(JSPUtil.getParameter(request, "ib_cr_term_dys", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setUsaBrkBrncRqstCtrlOfcCd(JSPUtil.getParameter(request, "usa_brk_brnc_rqst_ctrl_ofc_cd", ""));
		...
		setSlsOfcUseFlg(JSPUtil.getParameter(request, "sls_ofc_use_flg", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setOfcKndCd(JSPUtil.getParameter(request, "ofc_knd_cd", ""));
		setPrcOfcCd(JSPUtil.getParameter(request, "prc_ofc_cd", ""));
		setGlCtrCd(JSPUtil.getParameter(request, "gl_ctr_cd", ""));
		setOfcPsonKnt(JSPUtil.getParameter(request, "ofc_pson_knt", ""));
		setApHoAcctCd(JSPUtil.getParameter(request, "ap_ho_acct_cd", ""));
		setOpnDt(JSPUtil.getParameter(request, "opn_dt", ""));
		setEaiEvntDt(JSPUtil.getParameter(request, "eai_evnt_dt", ""));
		setFincPsdoOfcFlg(JSPUtil.getParameter(request, "finc_psdo_ofc_flg", ""));
		...
		setOfcSlsDeltFlg(JSPUtil.getParameter(request, "ofc_sls_delt_flg", ""));
	...
	public SearchMdmOrganizationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		return getSearchMdmOrganizationVOs();
	}
	 ...
	 * @return SearchMdmOrganizationVO[]
	 */
	public SearchMdmOrganizationVO[] getSearchMdmOrganizationVOs(){
