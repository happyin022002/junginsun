...
*@FileName : ReceiveQueueMdmRegionDBDAOModifyMdmRegionUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmRegionDBDAOModifyMdmRegionUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmRegionDBDAOModifyMdmRegionUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmRegionDBDAOModifyMdmRegionUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE mdm_region" ).append("\n"); 
		query.append("   SET rgn_nm       = @[rgn_nm]    ," ).append("\n"); 
		...
		query.append(" WHERE rgn_cd       = @[rgn_cd]" ).append("\n"); 
