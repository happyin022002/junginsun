...
*@FileName : ReceiveQueueMdmRepChgDBDAOModifyMdmRepChgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmRepChgDBDAOModifyMdmRepChgUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmRepChgDBDAOModifyMdmRepChgUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmRepChgDBDAOModifyMdmRepChgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("rep_chg_nm   = @[rep_chg_nm]," ).append("\n"); 
