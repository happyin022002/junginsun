...
*@FileName : ReceiveQueueMdmStateDBDAOModifyMdmStateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmStateDBDAOModifyMdmStateUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmStateDBDAOModifyMdmStateUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmStateDBDAOModifyMdmStateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET ste_nm       = @[ste_nm]    ," ).append("\n"); 
