...
*@FileName : ReceiveQueueMdmVndrCntcPntDBDAOModifyMdmVndrCntcPntUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmVndrCntcPntDBDAOModifyMdmVndrCntcPntUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_VNDR_CNTC_PNT Update
	  * </pre>
	  */
	public ReceiveQueueMdmVndrCntcPntDBDAOModifyMdmVndrCntcPntUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmVndrCntcPntDBDAOModifyMdmVndrCntcPntUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
