...
*@FileName : ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddMdmCstmsPckTpUpdate
	  * </pre>
	  */
	public ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCstmsPckTpDBDAOAddMdmCstmsPckTpUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE mdm_cstms_pck_tp" ).append("\n"); 
