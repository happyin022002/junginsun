...
*@FileName : ReceiveQueueMdmCstmsPckTpDBDAORemoveMdmCstmsPckTpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmCstmsPckTpDBDAORemoveMdmCstmsPckTpUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmCstmsPckTpDBDAORemoveMdmCstmsPckTpUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmCstmsPckTpDBDAORemoveMdmCstmsPckTpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
