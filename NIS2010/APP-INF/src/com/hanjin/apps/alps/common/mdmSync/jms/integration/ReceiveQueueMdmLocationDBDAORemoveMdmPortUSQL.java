...
*@FileName : ReceiveQueueMdmLocationDBDAORemoveMdmPortUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveQueueMdmLocationDBDAORemoveMdmPortUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveQueueMdmLocationDBDAORemoveMdmPortUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveQueueMdmLocationDBDAORemoveMdmPortUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
