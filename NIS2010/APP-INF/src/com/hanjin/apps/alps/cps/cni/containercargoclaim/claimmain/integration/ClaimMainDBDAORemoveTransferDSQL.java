...
*@FileName : ClaimMainDBDAORemoveTransferDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAORemoveTransferDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ClaimMainDBDAORemoveTransferDSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAORemoveTransferDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CNI_CGO_CLM_TRNS" ).append("\n"); 
