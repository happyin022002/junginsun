...
*@FileName : GEMMasterCodeMgtDBDAOSearchToOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMMasterCodeMgtDBDAOSearchToOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAOSearchToOfficeRSQL(){
		setQuery();
		...
		query.append("FileName : GEMMasterCodeMgtDBDAOSearchToOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT '1' SORT1,'ALL' CODE FROM   DUAL UNION ALL" ).append("\n"); 
		query.append("SELECT '2' SORT1, OFC_CD CODE" ).append("\n"); 
		query.append("FROM   GEM_OFFICE" ).append("\n"); 
		query.append("WHERE  OFC_CO_DIV_CD = 'O'" ).append("\n"); 
