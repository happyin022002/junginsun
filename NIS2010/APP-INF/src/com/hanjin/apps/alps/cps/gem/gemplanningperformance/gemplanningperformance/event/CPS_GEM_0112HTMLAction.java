...
*@FileName : CPS_GEM_0015HTMLAction.java
 ...
 * @see CpsGem0015Event 참조
 * @since J2EE 1.4
 */

public class CPS_GEM_0112HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0112HTMLAction 객체를 생성
	 */
	public CPS_GEM_0112HTMLAction() {}
 
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsGem0112Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0112Event event = new CpsGem0112Event();		
		
		//[Retrieve]
		if(command.isCommand(FormCommand.INIT)) {	
			
			RsltSlpErrorInformationVO dto = (RsltSlpErrorInformationVO)getVO(request, RsltSlpErrorInformationVO .class);
			event.setRsltSlpErrorInformationVO(dto);
