...
*@FileName : CustomDryWetClaimVO.java
*@FileTitle : CustomDryWetClaimVO
*Open Issues :
*Change history :
...
public class CustomDryWetClaimVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomDryWetClaimVO> models = new ArrayList<CustomDryWetClaimVO>();
	...
	/* Column Info */
	private String dwClmStsCdOrg = null;
	/* Column Info */
	...
	public CustomDryWetClaimVO() {}

	public CustomDryWetClaimVO(String ibflag, String pagerows, String dwClmNo, String dwClmTpCd, String dwCoCd, String dwClmRefVvdNo, String vslEngNm, String inciPlcTpCd, String inciOccrDt, String creOfcCd, String hdlrOfcCd, String hdlrUsrId, String tmBarDt, String litDt, String dwClmStsCd, String dwClmStsCdOrg, String dwClmAttDefTpCd, String prlmClmNtfyDt, String csClzDt, String arbtDt, String clmtClmPtyNo, String clmtCtnt, String insurClmPtyNo, String ddctUsdAmt, String deftClmPtyNo, String deftCtnt, String lablPtyClmPtyNo, String lablPtyCtnt, String lablPtyTmBarDt, String clmLoclCurrCd, String clmLoclAmt, String fmalClmRcvDt, String clmXchRt, String clmUsdAmt, String clmStlLoclCurrCd, String clmStlLoclAmt, String clmStlDt, String clmStlXchRt, String clmStlUsdAmt, String lablPtyFileLoclCurrCd, String lablPtyFileLoclAmt, String lablPtyFileDt, String lablPtyFileXchRt, String lablPtyFileUsdAmt, String lablPtyRcvrLoclCurrCd, String lablPtyRcvrLoclAmt, String lablPtyRcvrDt, String lablPtyRcvrXchRt, String lablPtyRcvrUsdAmt, String insurFileLoclCurrCd, String insurFileLoclAmt, String insurFileDt, String insurFileXchRt, String insurFileUsdAmt, String insurRcvrLoclCurrCd, String insurRcvrLoclAmt, String insurRcvrDt, String insurRcvrXchRt, String insurRcvrUsdAmt, String dwClmCsDesc, String inciDevDesc, String hdlrStlOpinDesc, String clmtAgnClmPtyNo, String clmtAgnTpCd, String clmtAgnApntDt, String clmtAgnRefNo, String deftAgnClmPtyNo, String deftAgnTpCd, String deftAgnApntDt, String deftAgnRefNo, String trnsFlg, String clmTrnsAuthCd, String trnsSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		...
		this.dwClmStsCdOrg = dwClmStsCdOrg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dw_clm_sts_cd_org", getDwClmStsCdOrg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dw_clm_sts_cd_org", "dwClmStsCdOrg");
	...
	/**
	 * Column Info
	 * @return dwClmStsCdOrg
	 */
	public String getDwClmStsCdOrg() {
		return this.dwClmStsCdOrg;
	}
	 ...
	 * @param dwClmStsCdOrg
	 */
	public void setDwClmStsCdOrg(String dwClmStsCdOrg) {
		this.dwClmStsCdOrg = dwClmStsCdOrg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDwClmStsCdOrg(JSPUtil.getParameter(request, prefix + "dw_clm_sts_cd_org", ""));
	 ...
	 */
	public CustomDryWetClaimVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomDryWetClaimVO[]
	 */
	public CustomDryWetClaimVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomDryWetClaimVO model = null;
		...
		try {
			...
			String[] dwClmStsCdOrg = (JSPUtil.getParameter(request, prefix	+ "dw_clm_sts_cd_org", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (dwClmStsCdOrg[i] != null)
					model.setDwClmStsCdOrg(dwClmStsCdOrg[i]);
		...
		return getCustomDryWetClaimVOs();
	}
	 ...
	 * @return CustomDryWetClaimVO[]
	 */
	public CustomDryWetClaimVO[] getCustomDryWetClaimVOs(){
		CustomDryWetClaimVO[] vos = (CustomDryWetClaimVO[])models.toArray(new CustomDryWetClaimVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.dwClmStsCdOrg = this.dwClmStsCdOrg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
