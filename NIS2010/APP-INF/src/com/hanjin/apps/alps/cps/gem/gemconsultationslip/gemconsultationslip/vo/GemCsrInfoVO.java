...
*@FileName : GemCsrInfoVO.java
*@FileTitle : GemCsrInfoVO
*Open Issues :
*Change history :
...
public class GemCsrInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<GemCsrInfoVO> models = new ArrayList<GemCsrInfoVO>();
	...
	public GemCsrInfoVO(String ibflag, String pagerows, String aproUsrJbTitNm, String result, String csrNo, String requestId, String xmlData, String sysDocId, String aproUsrNm, String userTp, String resultMsg, String agmtDocCfmCd, String userId, String sysTp, String gwAgmtDocCfmCd, String ofcCd, String csrAproTpCd) {
...
/**
	 ...
	 * @return GemCsrInfoVO[]
	 */
	public GemCsrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return GemCsrInfoVO[]
	 */
	public GemCsrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		GemCsrInfoVO model = null;
	 ...
	 * @return GemCsrInfoVO[]
	 */
	public GemCsrInfoVO[] getGemCsrInfoVOs(){
		GemCsrInfoVO[] vos = (GemCsrInfoVO[])models.toArray(new GemCsrInfoVO[models.size()]);
		return vos;
	}
