...
*@FileName : InsuranceDBDAORemoveInsuranceContractDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InsuranceDBDAORemoveInsuranceContractDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InsuranceDBDAORemoveInsuranceContractDSQL(){
		setQuery();
		...
		query.append("FileName : InsuranceDBDAORemoveInsuranceContractDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CNI_INSUR_CTRT" ).append("\n"); 
