...
public class VO extends AbstractValueObject {
	...
	private Collection<VO> models = new ArrayList<VO>();
...
/**
	 ...
	 * @return VO[]
	 */
	public VO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VO[]
	 */
	public VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VO model = null;
	 ...
	 */
	public VO[] getVOs(){
		VO[] vos = (VO[])models.toArray(new VO[models.size()]);
		return vos;
	}
