...
*@FileName : CustomPremiumVO.java
*@FileTitle : CustomPremiumVO
*Open Issues :
*Change history :
...
public class CustomPremiumVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CustomPremiumVO> models = new ArrayList<CustomPremiumVO>();
	...
	/* Column Info */
	private String insurClmPtyPrmNo = null;
	/* Column Info */
	...
	public CustomPremiumVO() {}

	public CustomPremiumVO(String ibflag, String pagerows, String insurTpCd, String insurPlcyYr, String insurClmPtyNo, String insurClmPtyPrmNo, String insurPrmTpCd, String ttlLoclAmt, String ttlCurrCd, String ttlXchRt, String ttlUsdAmt, String ttlDueDt, String ttlPayDt, String adjLoclAmt, String adjCurrCd, String adjXchRt, String adjUsdAmt, String adjDueDt, String adjPayDt, String rfndLoclAmt, String rfndCurrCd, String rfndXchRt, String rfndUsdAmt, String rfndDueDt, String rfndPayDt, String otsLoclAmt, String otsCurrCd, String otsXchRt, String otsUsdAmt, String otsDueDt, String otsPayDt, String diffRmk, String creUsrId, String updUsrId) {
		...
		this.insurClmPtyPrmNo = insurClmPtyPrmNo;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("insur_clm_pty_prm_no", getInsurClmPtyPrmNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("insur_clm_pty_prm_no", "insurClmPtyPrmNo");
	...
	/**
	 * Column Info
	 * @return insurClmPtyPrmNo
	 */
	public String getInsurClmPtyPrmNo() {
		return this.insurClmPtyPrmNo;
	}
	...
	/**
	 * Column Info
	 * @param insurClmPtyPrmNo
	 */
	public void setInsurClmPtyPrmNo(String insurClmPtyPrmNo) {
		this.insurClmPtyPrmNo = insurClmPtyPrmNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInsurClmPtyPrmNo(JSPUtil.getParameter(request, "insur_clm_pty_prm_no", ""));
	 ...
	 */
	public CustomPremiumVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomPremiumVO[]
	 */
	public CustomPremiumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CustomPremiumVO model = null;
		...
		try {
			...
			String[] insurClmPtyPrmNo = (JSPUtil.getParameter(request, prefix	+ "insur_clm_pty_prm_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (insurClmPtyPrmNo[i] != null)
					model.setInsurClmPtyPrmNo(insurClmPtyPrmNo[i]);
				if (adjXchRt[i] != null)
	 ...
	 * @return CustomPremiumVO[]
	 */
	public CustomPremiumVO[] getCustomPremiumVOs(){
		CustomPremiumVO[] vos = (CustomPremiumVO[])models.toArray(new CustomPremiumVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.insurClmPtyPrmNo = this.insurClmPtyPrmNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
