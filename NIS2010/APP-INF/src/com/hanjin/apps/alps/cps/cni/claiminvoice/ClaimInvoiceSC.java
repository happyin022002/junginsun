 ...
 * 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.cps.cni.claiminvoice;
...
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.basic.PaymentInvoiceBC;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.basic.PaymentInvoiceBCImpl;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.event.CpsCni0045Event;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.event.CpsCni0048Event;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.vo.ArRevenueVVDVO;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.vo.CsrManagerListCondVO;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.vo.CsrManagerListVO;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.vo.PaymentInvoiceInfoVO;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.vo.PaymentInvoiceVO;
import com.hanjin.apps.alps.cps.cni.claiminvoice.paymentinvoice.vo.VendorInfoVO;
	...
	public EventResponse perform(Event e) throws EventException {
		...
		if ("CpsCni0045Event".equalsIgnoreCase(eventName)) {							
			...
			if (cmd.isCommand(FormCommand.SEARCHLIST01)) {
				return searchPaymentInvoiceList(e);
			// [row double click]
			} else if (cmd.isCommand(FormCommand.SEARCHLIST02)) {
				return searchPaymentInvoiceInfo(e);				
			// [Save]
			} else if (cmd.isCommand(FormCommand.MULTI)) {
				return managePaymentInvoice(e);
			} 
 		// ---------------------------------------------------------------------------
		...
		// ---------------------------------------------------------------------------
				...
				// [Retrieve]
				if (cmd.isCommand(FormCommand.SEARCHLIST01)) {
					return searchCsrManagerList(e);
				// [default]
				} else if (cmd.isCommand(FormCommand.DEFAULT)) {
					return searchCsrManagerOpen(e);
				} 
			}
