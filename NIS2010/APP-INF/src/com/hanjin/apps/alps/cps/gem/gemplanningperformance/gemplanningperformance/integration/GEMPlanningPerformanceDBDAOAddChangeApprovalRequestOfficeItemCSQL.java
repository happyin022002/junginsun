...
*@FileName : GEMPlanningPerformanceDBDAOAddChangeApprovalRequestOfficeItemCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOAddChangeApprovalRequestOfficeItemCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * DESC :  Item의 기존 OFC_CD 를 변경될 OFC_CD 로 생성 한다.
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOAddChangeApprovalRequestOfficeItemCSQL(){
		setQuery();
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOAddChangeApprovalRequestOfficeItemCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO GEM_ITEM" ).append("\n"); 
