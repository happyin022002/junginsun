 ...
 *@FileName : GEMConsultaionCOM010R001ReceiveWSProxy.java
 *@FileTitle : WS Receive(COM010_R001)
 *Open Issues :
 *Change history :
...
import com.hanjin.apps.alps.cps.gem.gemconsultationslip.GEMConsultationSlipSC;
...
import com.hanjin.irep.alpsws.COM010R001Document;
import com.hanjin.irep.alpsws.COM010R001Document.COM010R001;
import com.hanjin.irep.alpsws.COM010R001Document.COM010R001.DataArea;
import com.hanjin.irep.alpsws.COM010R001Document.COM010R001.DataArea.CSRInfoResponse;
import com.hanjin.irep.alpsws.COM010R001Document.COM010R001.DataArea.CSRInfoReturn;

/**
 * GEMConsultaionReceiveWSProxy.java
...
@WebService(name="GEMConsultaionCOM010R001ReceiveWSProxyPortType", serviceName="GEMConsultaionCOM010R001ReceiveWSProxy",
targetNamespace="http://www.hanjin.com/integration/alps")

@SOAPBinding(style=SOAPBinding.Style.DOCUMENT, use=SOAPBinding.Use.LITERAL, parameterStyle=SOAPBinding.ParameterStyle.WRAPPED)

@WLHttpTransport(contextPath="/hanjin/webservices", serviceUri="/GEMConsultaionCOM010R001ReceiveWSProxy",  portName="GEMConsultaionCOM010R001ReceiveWSProxyPort")

public class GEMConsultaionCOM010R001ReceiveWSProxy {

	protected transient Logger log = Logger.getLogger(this.getClass().getName());
		
	/**
	 * WS Receive(COM010_R001)<br>
	 * 
	 * @param COM010R001Document com010R001Document
	 * @return 
	 * @throws EventException 
	 * @exception EventException, XmlException, Exception
	 */
	@WebMethod()
	public String com010R001ReceiveWS(COM010R001Document com010R001Document) throws DAOException, EventException {
		
		GEMConsultationSlipSC sc = new GEMConsultationSlipSC();
		
		//WebService EAI Result
		String EAIResult = "Failure";
		
		// ========= Validation Parameters for WebServices ========= 
		if( com010R001Document == null || "".equals(com010R001Document) )
		{
		...
		COM010R001 com010R001doc = com010R001Document.getCOM010R001();
		log.error(":::::>>> com010R001Document : " + com010R001Document);
					
		DataArea data = com010R001doc.getDataArea();		
		...
		try {		
			...
			if (vos != null && vos.length > 0) {				
				GemCsrInfoVO vo = new GemCsrInfoVO();
