...
*@FileName : GEMPlanningPerformanceDBDAOAddSubsActRsltSmryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOAddSubsActRsltSmryCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOAddSubsActRsltSmryCSQL(){
		setQuery();
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOAddSubsActRsltSmryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
