...
*@FileName : GEMMasterCodeMgtDBDAOModifyAccountInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMMasterCodeMgtDBDAOModifyAccountInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 회계코드 기준 정보 및 일반관리비 비용코드와 매핑 정보 수정
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAOModifyAccountInfoUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("update gem_acct_mtx set" ).append("\n"); 
		query.append("krn_nm = @[krn_nm]," ).append("\n"); 
		query.append("eng_nm = @[eng_nm]," ).append("\n"); 
		query.append("krn_desc = @[krn_desc]," ).append("\n"); 
		query.append("eng_desc = @[eng_desc]," ).append("\n"); 
		...
		query.append("FileName : GEMMasterCodeMgtDBDAOModifyAccountInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}