...
*@FileName : GEMPlanningPerformanceDBDAOModifyChangeApprovalAuthOfficeItemUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOModifyChangeApprovalAuthOfficeItemUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * DESC :  GEN_EXPN_APRO_AUTH_OFC_CD를 변경한다.
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOModifyChangeApprovalAuthOfficeItemUSQL(){
		setQuery();
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOModifyChangeApprovalAuthOfficeItemUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE GEM_ITEM" ).append("\n"); 
		query.append("   SET GEN_EXPN_APRO_AUTH_OFC_CD = @[bfr_ofc_cd]" ).append("\n"); 
		...
		query.append("   AND GEN_EXPN_APRO_AUTH_OFC_CD = @[ofc_cd]" ).append("\n"); 
