...
*@FileName : GEMConsultationSlipDBDAOAddCSRRequesCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOAddCSRRequesCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CSR 처음인 001을 insert 한다.
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOAddCSRRequesCSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOAddCSRRequesCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
