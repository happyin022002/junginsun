...
*@FileName : CPS_GEM_9999HTMLAction.java
...
public class CPS_GEM_9999HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_9999HTMLAction 객체를 생성
	 */
	public CPS_GEM_9999HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem9999Event event = new CpsGem9999Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST) ||
		   ...
		   command.isCommand(FormCommand.SEARCHLIST03)) {
			...
			event.setGemCngOfcVOs((GemCngOfcVO[])getVOs(request, GemCngOfcVO .class,""));
		}
