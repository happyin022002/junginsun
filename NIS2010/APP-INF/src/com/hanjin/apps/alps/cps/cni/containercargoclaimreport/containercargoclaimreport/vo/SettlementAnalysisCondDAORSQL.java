...
*@FileName : SettlementAnalysisCondDAORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementAnalysisCondDAORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SettlementAnalysisCond
	  * </pre>
	  */
	public SettlementAnalysisCondDAORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.cps.cni.containercargoclaimreport.containercargoclaimreport.vo").append("\n"); 
		query.append("FileName : SettlementAnalysisCondDAORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
