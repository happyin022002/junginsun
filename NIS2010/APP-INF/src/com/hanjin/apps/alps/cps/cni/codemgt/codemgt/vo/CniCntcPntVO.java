...
*@FileName : CniCntcPntVO.java
*@FileTitle : CniCntcPntVO
*Open Issues :
*Change history :
...
public class CniCntcPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CniCntcPntVO> models = new ArrayList<CniCntcPntVO>();
	...
	public CniCntcPntVO(String ibflag, String pagerows, String clmPtyNo, String clmCntcPntSeq, String cntcPntNm, String intlPhnNo, String cntcPntPhnNo, String intlFaxNo, String cntcPntFaxNo, String cntcPntEml, String cntcPntRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return CniCntcPntVO[]
	 */
	public CniCntcPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CniCntcPntVO[]
	 */
	public CniCntcPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CniCntcPntVO model = null;
	 ...
	 * @return CniCntcPntVO[]
	 */
	public CniCntcPntVO[] getCniCntcPntVOs(){
		CniCntcPntVO[] vos = (CniCntcPntVO[])models.toArray(new CniCntcPntVO[models.size()]);
		return vos;
	}
