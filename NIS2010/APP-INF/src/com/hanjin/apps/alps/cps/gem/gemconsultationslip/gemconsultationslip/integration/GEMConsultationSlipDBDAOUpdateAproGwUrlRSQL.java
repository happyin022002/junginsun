...
*@FileName : GEMConsultationSlipDBDAOUpdateAproGwUrlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOUpdateAproGwUrlRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * G/W에서 넘어온 결과를 udpate를 한다.
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOUpdateAproGwUrlRSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOUpdateAproGwUrlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
