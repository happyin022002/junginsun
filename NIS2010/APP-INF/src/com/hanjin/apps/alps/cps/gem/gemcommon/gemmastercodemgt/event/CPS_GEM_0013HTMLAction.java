...
*@FileName : CPS_GEM_0013HTMLAction.java
...
public class CPS_GEM_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0013HTMLAction 객체를 생성
	 */
	public CPS_GEM_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0013Event event = new CpsGem0013Event();
