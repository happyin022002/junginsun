...
*@FileName : GEMConsultationSlipDBDAOSearchGwUserIdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOSearchGwUserIdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Usr id 에 대한 EP ID 조회
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOSearchGwUserIdRSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOSearchGwUserIdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
