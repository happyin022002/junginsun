...
* 2.처리내역
*   Transfer 화면에서 데이터 변경후 저장시
*   Claim Main쪽에서 Accept일때만 저장가능하도록 변경
=========================================================*/
...
import com.hanjin.apps.alps.cps.cni.containercargoclaim.incidentsurvey.integration.ClaimMainDBDAOModifySurveyUsdAmtUSQL;
...
public class ClaimMainDBDAO extends DBDAOSupport {
     ...
     */
    @SuppressWarnings("unchecked")
    public CMSServiceVO searchCMSService(String cgoClmNo) throws DAOException {        
        	
        DBRowSet dbRowset = null;
        
        List<CMSServiceVO> list = null;     
        ...
        try{    
            ...
            dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new ClaimMainDBDAOSearchCMSServiceRSQL(), param, velParam);
            
            list = (List)RowSetUtil.rowSetToVOs(dbRowset, CMSServiceVO.class);
     ...
     */
    @SuppressWarnings("unchecked")
    public void modifyGwStatus(GwApproveStatusVO vo) throws DAOException {        
        try{    
			SQLExecuter sqlExe = new SQLExecuter("");
			Map<String, Object> velParam = new HashMap<String, Object>();			
			Map<String , String> paramMap = vo.getColumnValues();	
			velParam.putAll(paramMap);
			
			sqlExe.executeUpdate((ISQLTemplate) new ClaimMainDBDAOModifyGwStatusUSQL(), paramMap, velParam);
    ...
    public void modifyTransferClaimMain(String cgoClmNo , String updUsrId , String hdlrUsrId, String hdlrOfcCd, String clmTrnsAuthCd  ) throws DAOException {    	  
        ...
        try{    
			...
			paramMap.put("clm_trns_auth_cd", clmTrnsAuthCd);
