...
*@FileName : CPS_GEM_0010HTMLAction.java
...
public class CPS_GEM_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0010HTMLAction 객체를 생성
	 */
	public CPS_GEM_0010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0010Event event = new CpsGem0010Event();
		...
		if(command.isCommand(FormCommand.SEARCH)||
		   ...
		   command.isCommand(FormCommand.SEARCHLIST03)) {
			...
			event.setExpenseInqVO((ExpenseInqVO)getVO(request, ExpenseInqVO .class));
		}
