...
*@FileName : GEMCommonDBDAOSearchSubsMinorListByOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMCommonDBDAOSearchSubsMinorListByOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMCommonDBDAOSearchSubsMinorListByOfficeRSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.nis2010.cps.gem.gemcommon.gemcommon.integration").append("\n"); 
		query.append("FileName : GEMCommonDBDAOSearchSubsMinorListByOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}