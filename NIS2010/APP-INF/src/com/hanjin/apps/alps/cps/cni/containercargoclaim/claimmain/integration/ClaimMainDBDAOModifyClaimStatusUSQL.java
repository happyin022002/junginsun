...
*@FileName : ClaimMainDBDAOModifyClaimStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAOModifyClaimStatusUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Cargo Claim Status 수정
	  * </pre>
	  */
	public ClaimMainDBDAOModifyClaimStatusUSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAOModifyClaimStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${cgo_clm_sts_cd} == 'C')" ).append("\n"); 
		query.append(", CS_CLZ_DT = TO_CHAR(CNI_GET_GMT_FNC(@[upd_usr_id]),'YYYYMMDD')" ).append("\n"); 
		query.append(", CS_CLZ_OFC_CD = (SELECT OFC_CD FROM COM_USER WHERE USR_ID = @[upd_usr_id])" ).append("\n"); 
		query.append(", CS_CLZ_USR_ID = @[upd_usr_id]" ).append("\n"); 
