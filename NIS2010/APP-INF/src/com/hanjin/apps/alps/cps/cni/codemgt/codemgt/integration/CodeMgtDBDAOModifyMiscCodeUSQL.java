...
*@FileName : CodeMgtDBDAOModifyMiscCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgtDBDAOModifyMiscCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgtDBDAOModifyMiscCodeUSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgtDBDAOModifyMiscCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CNI_MISC_CD SET" ).append("\n"); 
		query.append("DP_SEQ =  @[dp_seq]" ).append("\n"); 
		query.append(",	CLM_MISC_NM = @[clm_misc_nm]" ).append("\n"); 
		query.append(",	CLM_MISC_RMK = @[clm_misc_rmk]" ).append("\n"); 
