...
*@FileName : CPS_CNI_0312HTMLAction.java
*@FileTitle : Transfer
*Open Issues :
*Change history :
 ...
 * HTTP Parser<br>
 * @author 양정란
 * @see CpsCni0312Event 참조
 * @since J2EE 1.4
 */

public class CPS_CNI_0312HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_CNI_0312HTMLAction 객체를 생성
	 */
	public CPS_CNI_0312HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsCni0312Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0312Event event = new CpsCni0312Event();
