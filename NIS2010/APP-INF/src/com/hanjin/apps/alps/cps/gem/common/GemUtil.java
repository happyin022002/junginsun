...
=========================================================*/
package com.hanjin.apps.alps.cps.gem.common;
...
public class GemUtil {
	...
	public static  BigDecimal getLclToKrwAmt(BigDecimal lclAmt , BigDecimal utVal , BigDecimal usdKrwXchRt , BigDecimal usdLoclXchRt) {
		...
		BigDecimal krwAmt = lclAmt.multiply(utVal).divide(new BigDecimal(1000));
		BigDecimal krwRatio = 
				usdKrwXchRt.divide(usdLoclXchRt, 4, BigDecimal.ROUND_CEILING);
