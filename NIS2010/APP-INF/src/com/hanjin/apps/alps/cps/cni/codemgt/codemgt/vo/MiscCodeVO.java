...
*@FileName : MiscCodeVO.java
*@FileTitle : MiscCodeVO
*Open Issues :
*Change history :
...
public class MiscCodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MiscCodeVO> models = new ArrayList<MiscCodeVO>();
	...
	public MiscCodeVO(String ibflag, String pagerows, String clssClmMiscCd, String clmMiscCd, String dpSeq, String clmMiscAbbrNm, String clmMiscNm, String oldClmMiscCd, String clmMiscRmk, String creOfcCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.dpSeq = dpSeq;
	 ...
	 * @return MiscCodeVO[]
	 */
	public MiscCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MiscCodeVO[]
	 */
	public MiscCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MiscCodeVO model = null;
	 ...
	 * @return MiscCodeVO[]
	 */
	public MiscCodeVO[] getMiscCodeVOs(){
		MiscCodeVO[] vos = (MiscCodeVO[])models.toArray(new MiscCodeVO[models.size()]);
		return vos;
	}
