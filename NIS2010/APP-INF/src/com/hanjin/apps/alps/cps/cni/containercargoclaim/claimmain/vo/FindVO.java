...
public class FindVO extends AbstractValueObject {
	...
	/* Column Info */
	private String clmCurrCd = null;
	/* Column Info */
	private String clmUsdAmt = null;
	/* Column Info */
	private String cgoClmStlUsdAmt = null;
	/* Column Info */
	private String cgoClmStlCurrCd = null;
	...
	public FindVO(String ibflag, String pagerows, String cgoClmDivCd, String cgoClmNo, String cgoClmRefBlNo, String cgoClmRefCntrNo, String trnkRefVvdNo, String clmAreaCd, String hdlrOfcCd, String hdlrUsrId, String stsCd, String fmalClmRcvDt, String cgoClmInciNo, String crmVocNo, String updDt, String clmtClmTpCd, String claimant, String clmtLoclAmt, String cgoClmStlTpCd, String cgoClmStlLoclAmt, String liableParty, String clmPtyAbbrNm, String insurRefNo, String pastCgoClmNo, String rowNum, String total, String clmCurrCd, String clmUsdAmt, String cgoClmStlUsdAmt, String cgoClmStlCurrCd) {
		...
		this.clmCurrCd = clmCurrCd;
		this.clmUsdAmt = clmUsdAmt;
		this.cgoClmStlUsdAmt = cgoClmStlUsdAmt;
		this.cgoClmStlCurrCd = cgoClmStlCurrCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("clmt_locl_curr_cd", getClmCurrCd());
		this.hashColumns.put("clmt_usd_amt", getClmUsdAmt());
		this.hashColumns.put("cgo_clm_stl_usd_amt", getCgoClmStlUsdAmt());
		this.hashColumns.put("cgo_clm_stl_locl_curr_cd", getCgoClmStlCurrCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("clmt_locl_curr_cd", "clmCurrCd");
		this.hashFields.put("clmt_usd_amt", "clmUsdAmt");
		this.hashFields.put("cgo_clm_stl_usd_amt", "cgoClmStlUsdAmt");
		this.hashFields.put("cgo_clm_stl_locl_curr_cd", "cgoClmStlCurrCd");
	 ...
	 * @return clmCurrCd
	 */
	public String getClmCurrCd() {
		return this.clmCurrCd;
	}
	/**
	 * Column Info
	 * @return clmUsdAmt
	...
	/**
	 * Column Info
	 * @return cgoClmStlCurrCd
	 */
	public String getCgoClmStlCurrCd() {
		return this.cgoClmStlCurrCd;
	}
	 ...
	 * @param clmCurrCd
	 */
	public void setClmCurrCd(String clmCurrCd) {
		this.clmCurrCd = clmCurrCd;
	}
	...
	/**
	 * Column Info
	 * @param cgoClmStlCurrCd
	 */
	public void setCgoClmStlCurrCd(String cgoClmStlCurrCd) {
		this.cgoClmStlCurrCd = cgoClmStlCurrCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setClmCurrCd(JSPUtil.getParameter(request, "clmt_locl_curr_cd", ""));
		setClmUsdAmt(JSPUtil.getParameter(request, "clmt_usd_amt", ""));
		setCgoClmStlUsdAmt(JSPUtil.getParameter(request, "cgo_clm_stl_usd_amt", ""));
		setCgoClmStlCurrCd(JSPUtil.getParameter(request, "cgo_clm_stl_locl_curr_cd", ""));
	}
	...
	public FindVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] clmCurrCd = (JSPUtil.getParameter(request, prefix	+ "clmt_locl_curr_cd", length));
			String[] clmUsdAmt = (JSPUtil.getParameter(request, prefix	+ "clmt_usd_amt", length));
			String[] cgoClmStlUsdAmt = (JSPUtil.getParameter(request, prefix	+ "cgo_clm_stl_usd_amt", length));
			String[] cgoClmStlCurrCd = (JSPUtil.getParameter(request, prefix	+ "cgo_clm_stl_locl_curr_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (clmCurrCd[i] != null)
					model.setClmCurrCd(clmCurrCd[i]);
				if (clmUsdAmt[i] != null)
					model.setClmUsdAmt(clmUsdAmt[i]);
				if (cgoClmStlUsdAmt[i] != null)
					model.setCgoClmStlUsdAmt(cgoClmStlUsdAmt[i]);
				if (cgoClmStlCurrCd[i] != null)
					model.setCgoClmStlCurrCd(cgoClmStlCurrCd[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.clmCurrCd = this.clmCurrCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.cgoClmStlCurrCd = this.cgoClmStlCurrCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
