...
*@FileName : GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestApprovalStepUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestApprovalStepUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * DESC : ApprovalStep의 기존 OFC_CD 를 변경될 OFC_CD 로 업데이트 한다.
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestApprovalStepUSQL(){
		setQuery();
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestApprovalStepUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
