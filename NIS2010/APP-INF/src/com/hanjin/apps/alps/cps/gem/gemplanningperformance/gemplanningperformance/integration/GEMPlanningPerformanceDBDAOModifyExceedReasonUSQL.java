...
*@FileName : GEMPlanningPerformanceDBDAOModifyExceedReasonUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOModifyExceedReasonUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOModifyExceedReasonUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("SET GEN_EXPN_OVR_RTO_RSN = @[gen_expn_ovr_rto_rsn]," ).append("\n"); 
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOModifyExceedReasonUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}