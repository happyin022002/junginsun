...
*@FileName : CPS_CNI_0020HTMLAction.java
 ...
 * HTTP Parser<br>
 * @author 양정란
 * @see CpsCni0020Event 참조  
 * @since J2EE 1.4   
 */

public class CPS_CNI_0020HTMLAction extends HTMLActionSupport {    

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_CNI_0020HTMLAction 객체를 생성
	 */
	public CPS_CNI_0020HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0020Event event = new CpsCni0020Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)||command.isCommand(FormCommand.PRINT)) {
			// 조회조건
			SettlementAnalysisCondVO dto = (SettlementAnalysisCondVO)getVO(request, SettlementAnalysisCondVO.class);
			event.setSettlementAnalysisCondVO(dto);
		} 
