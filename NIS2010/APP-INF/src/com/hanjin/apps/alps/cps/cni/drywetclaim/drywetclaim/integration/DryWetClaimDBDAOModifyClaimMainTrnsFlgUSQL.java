...
*@FileName : DryWetClaimDBDAOModifyClaimMainTrnsFlgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DryWetClaimDBDAOModifyClaimMainTrnsFlgUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Transfer Accept 할 경우 Main 에 Trns_flg 값 변경
	  * </pre>
	  */
	public DryWetClaimDBDAOModifyClaimMainTrnsFlgUSQL(){
		setQuery();
		...
		query.append("FileName : DryWetClaimDBDAOModifyClaimMainTrnsFlgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
