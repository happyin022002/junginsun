 ...
 *@FileName : GEMDetailRequestExpenseRqstNoBackEndBCImpl.java
 *@FileTitle : 
 *Open Issues :
 *Change history :
 *@LastModifyDate : 
...
public class GEMDetailRequestExpenseRqstNoBackEndJob extends BackEndCommandSupport {
	 ...
	 */
	@Override
	public List<DetailRequestExpenseRqstNoVO> doStart() throws Exception {
		this.dbDao = new GEMPlanningPerformanceDBDAO();
		try {			
			return dbDao.searchDetailByRequestExpenseRqstNo(this.searchYearlyExpenseVO);						
