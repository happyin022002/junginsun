...
*@FileName : ClaimMainDBDAOSearchImpendingTBMainClaimListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAOSearchImpendingTBMainClaimListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ClaimMainDBDAOSearchImpendingTBMainClaimListRSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAOSearchImpendingTBMainClaimListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", CLMT_CLM_PTY_NM" ).append("\n"); 
		...
		query.append("OFC_CD = HDLR_OFC_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("CLM_AREA_CD" ).append("\n"); 
		query.append(", HDLR_OFC_CD" ).append("\n"); 
		query.append(", HDLR_USR_ID" ).append("\n"); 
		query.append(", CGO_CLM_CLZ_CD||CGO_CLM_STS_CD            AS CGO_CLM_STS_CD" ).append("\n"); 
		query.append(", CNI_GET_PTY_NM_FNC (CLMT_CLM_PTY_NO, '2') AS CLMT_CLM_PTY_NM" ).append("\n"); 
		query.append(", (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("USR_EML" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		...
		query.append("WHERE" ).append("\n"); 
		query.append("USR_ID = HDLR_USR_ID" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("USR_EML" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		...
		query.append("WHERE" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("TM_BAR_DT   >= TO_CHAR (CNI_GET_GMT_FNC (@[usr_id]), 'YYYYMMDD')" ).append("\n"); 
		query.append("AND TM_BAR_DT    <= TO_CHAR (CNI_GET_GMT_FNC (@[usr_id]) + INTERVAL '15' DAY, 'YYYYMMDD')" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("AND CGO_CLM_STS_CD NOT IN ('P', 'C', 'X')" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("WHERE" ).append("\n"); 
