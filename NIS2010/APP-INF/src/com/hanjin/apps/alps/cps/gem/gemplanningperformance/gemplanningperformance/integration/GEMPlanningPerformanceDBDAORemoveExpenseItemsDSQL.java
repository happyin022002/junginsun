...
*@FileName : GEMPlanningPerformanceDBDAORemoveExpenseItemsDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAORemoveExpenseItemsDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAORemoveExpenseItemsDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : GEMPlanningPerformanceDBDAORemoveExpenseItemsDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}