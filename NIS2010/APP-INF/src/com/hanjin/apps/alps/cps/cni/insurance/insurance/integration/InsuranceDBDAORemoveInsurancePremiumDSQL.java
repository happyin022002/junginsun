...
*@FileName : InsuranceDBDAORemoveInsurancePremiumDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InsuranceDBDAORemoveInsurancePremiumDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Insurance Premium 을 삭제한다
	  * </pre>
	  */
	public InsuranceDBDAORemoveInsurancePremiumDSQL(){
		setQuery();
		...
		query.append("FileName : InsuranceDBDAORemoveInsurancePremiumDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CNI_INSUR_PRM" ).append("\n"); 
