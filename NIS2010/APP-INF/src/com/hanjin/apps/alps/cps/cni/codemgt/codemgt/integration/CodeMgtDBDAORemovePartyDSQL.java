...
*@FileName : CodeMgtDBDAORemovePartyDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgtDBDAORemovePartyDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgtDBDAORemovePartyDSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgtDBDAORemovePartyDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CNI_PARTY" ).append("\n"); 
