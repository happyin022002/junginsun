...
*@FileName : IncidentSurveyDBDAOSearchSurveyExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IncidentSurveyDBDAOSearchSurveyExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IncidentSurveyDBDAOSearchSurveyExistRSQL(){
		setQuery();
		...
		query.append("FileName : IncidentSurveyDBDAOSearchSurveyExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
