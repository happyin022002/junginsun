...
*@FileName : CPS_CNI_0308HTMLAction.java
...
public class CPS_CNI_0308HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CPS_CNI_0308HTMLAction 객체를 생성
	 */
	public CPS_CNI_0308HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsCni0308Event event = new CpsCni0308Event();

		FormCommand command = FormCommand.fromRequest(request);
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVslCd(request.getParameter("vsl_cd"));
			event.setVslNm(request.getParameter("vsl_eng_nm"));
		}
