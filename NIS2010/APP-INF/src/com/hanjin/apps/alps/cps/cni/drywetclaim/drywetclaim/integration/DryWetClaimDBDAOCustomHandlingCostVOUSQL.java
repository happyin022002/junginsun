...
*@FileName : DryWetClaimDBDAOCustomHandlingCostVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DryWetClaimDBDAOCustomHandlingCostVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 Case 관련 발생된 제 처리비용을 변경한다
	  * </pre>
	  */
	public DryWetClaimDBDAOCustomHandlingCostVOUSQL(){
		setQuery();
		...
		query.append("FileName : DryWetClaimDBDAOCustomHandlingCostVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE CNI_DW_CLM_COST SET" ).append("\n"); 
		...
		query.append(",	PAY_DT = @[pay_dt]" ).append("\n"); 
