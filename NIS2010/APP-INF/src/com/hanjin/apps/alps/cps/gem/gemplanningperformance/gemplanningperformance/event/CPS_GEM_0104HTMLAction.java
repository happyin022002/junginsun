...
*@FileName : CPS_GEM_0104HTMLAction.java
*@FileTitle : Assigned Expense
*Open Issues :
*Change history :
...
public class CPS_GEM_0104HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0104HTMLAction 객체를 생성
	 */
	public CPS_GEM_0104HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0104Event event = new CpsGem0104Event();		
		//[open]
