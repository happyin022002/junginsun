...
*@FileName : ContainerCargoClaimReportDBDAOSearchCargoClaimReportInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerCargoClaimReportDBDAOSearchCargoClaimReportInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ContainerCargoClaimReportDBDAOSearchCargoClaimReportInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerCargoClaimReportDBDAOSearchCargoClaimReportInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  , CNI_GET_PTY_NM_FNC (A.INSUR_CLM_PTY_NO, '2') INSUR_PTY_NM" ).append("\n"); 
		query.append("  , CNI_GET_PTY_NM_FNC (A.CLMT_CLM_PTY_NO, '2') CLMT_PTY_NM" ).append("\n"); 
		query.append("  , CNI_GET_PTY_NM_FNC (A.CLM_AGN_CLM_PTY_NO, '2') AGN_PTY_NM" ).append("\n"); 
		...
		query.append("  , A.N3RD_LABL_PTY_CD" ).append("\n"); 
		query.append("  , A.CLM_INCI_PLC_TP_CD" ).append("\n"); 
		query.append("  , A.FACT_FND_DESC" ).append("\n"); 
		query.append("  , A.CLM_RVW_DESC" ).append("\n"); 
		query.append("  , CNI_GET_PTY_NM_FNC (A.LABL_CLM_PTY_NO, '2') LABL_PTY_PTY_NM" ).append("\n"); 
