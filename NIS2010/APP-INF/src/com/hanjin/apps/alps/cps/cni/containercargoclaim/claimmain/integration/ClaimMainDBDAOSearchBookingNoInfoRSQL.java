...
*@FileName : ClaimMainDBDAOSearchBookingNoInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAOSearchBookingNoInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ClaimMainDBDAOSearchBookingNoInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAOSearchBookingNoInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
