...
*@FileName : CPS_CNI_0029HTMLAction.java
...
/**
 * CPS_CNI_0029  Misc Code Inquiry
 * HTTP Parser<br>
 * @author 박제성
 * @see CpsCni0029Event 참조
 * @since J2EE 1.6
 */

public class CPS_CNI_0029HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0029Event event = new CpsCni0029Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01) ||
			...
			String clmMiscNm = JSPUtil.getParameter(request, "clm_misc_nm","");
			event.setClmMiscNm(clmMiscNm);
