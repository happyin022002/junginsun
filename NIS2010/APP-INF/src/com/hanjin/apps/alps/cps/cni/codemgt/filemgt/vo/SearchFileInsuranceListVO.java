...
*@FileName : SearchFileInsuranceListVO.java
*@FileTitle : SearchFileInsuranceListVO
*Open Issues :
*Change history :
...
public class SearchFileInsuranceListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchFileInsuranceListVO> models = new ArrayList<SearchFileInsuranceListVO>();
	...
	public SearchFileInsuranceListVO() {}

	public SearchFileInsuranceListVO(String ibflag, String pagerows, String clmFileSeq, String clmFileTpCd, String clmBztpCd, String fileSavId, String fileNm, String fileDesc, String dwClmNo, String insurTpCd, String insurPlcyYr, String instInsurTpCd, String instInsurPlcyYr, String insurClmPtyNo, String instPrmInsurTpCd, String fileDownload, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SearchFileInsuranceListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchFileInsuranceListVO[]
	 */
	public SearchFileInsuranceListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchFileInsuranceListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchFileInsuranceListVO();
				if (updDt[i] != null)
		...
		return getSearchFileInsuranceListVOs();
	}
	 ...
	 * @return SearchFileInsuranceListVO[]
	 */
	public SearchFileInsuranceListVO[] getSearchFileInsuranceListVOs(){
		SearchFileInsuranceListVO[] vos = (SearchFileInsuranceListVO[])models.toArray(new SearchFileInsuranceListVO[models.size()]);
		return vos;
	}
