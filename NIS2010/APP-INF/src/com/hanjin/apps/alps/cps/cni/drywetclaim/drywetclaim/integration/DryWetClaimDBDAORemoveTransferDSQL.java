...
*@FileName : DryWetClaimDBDAORemoveTransferDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DryWetClaimDBDAORemoveTransferDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DryWetClaimDBDAORemoveTransferDSQL(){
		setQuery();
		...
		query.append("FileName : DryWetClaimDBDAORemoveTransferDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM CNI_DW_TRNS    " ).append("\n"); 
