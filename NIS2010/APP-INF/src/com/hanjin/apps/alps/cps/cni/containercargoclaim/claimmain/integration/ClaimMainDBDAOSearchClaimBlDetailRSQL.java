...
*@FileName : ClaimMainDBDAOSearchClaimBlDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAOSearchClaimBlDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ClaimMainDBDAOSearchClaimBlDetailRSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAOSearchClaimBlDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" ORDER BY MN_BL_FLG DESC  " ).append("\n"); 
