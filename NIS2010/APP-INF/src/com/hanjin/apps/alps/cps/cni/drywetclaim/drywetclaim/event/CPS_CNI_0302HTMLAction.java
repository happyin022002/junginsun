...
*@FileName : CPS_CNI_0302HTMLAction.java
*@FileTitle : Status
*Open Issues :
*Change history :
...
public class CPS_CNI_0302HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CPS_CNI_0302HTMLAction 객체를 생성
	 */
	public CPS_CNI_0302HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsCni0302Event event = new CpsCni0302Event();

		FormCommand command = FormCommand.fromRequest(request);
		
		if(command.isCommand(FormCommand.SEARCH)) {
 			event.setCondSearchStatusListVO((CondSearchStatusListVO)getVO(request, CondSearchStatusListVO.class));
		}
