...
*@FileName : GEMConsultationSlipDBDAOSearchConsultaionInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOSearchConsultaionInquiryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * inquiry 화면에서 데이터를 조회를 해온다.
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOSearchConsultaionInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOSearchConsultaionInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    (" ).append("\n"); 
		query.append("    SELECT A.SUBS_CSR_NO" ).append("\n"); 
		query.append("          ,A.SUBS_OFC_CD" ).append("\n"); 
		query.append("          ,B.SUBS_CSR_SEQ" ).append("\n"); 
		query.append("          ,B.GEN_EXPN_CD" ).append("\n"); 
		query.append("          ,B.GEN_EXPN_NM" ).append("\n"); 
		query.append("          ,DECODE(A.EXPN_DIV_CD,'S','Salary & Allowance','W','Welfare','E','Entertainment','M','Management & Other') EXPN_DIV_CD" ).append("\n"); 
		query.append("          ,A.INP_DT" ).append("\n"); 
		query.append("          ,A.INV_DT" ).append("\n"); 
		query.append("          ,A.INV_CURR_CD" ).append("\n"); 
		query.append("          ,A.INV_LOCL_TTL_AMT" ).append("\n"); 
		query.append("          ,A.INV_USD_TTL_AMT" ).append("\n"); 
		query.append("          ,A.PAY_VNDR_NM" ).append("\n"); 
		query.append("          ,A.APRO_RSLT_CD" ).append("\n"); 
		query.append("          ,A.APRO_DT" ).append("\n"); 
		query.append("          ,D.LVL4_TIC -- OMIT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    FROM" ).append("\n"); 
		query.append("    (" ).append("\n"); 
		query.append("        SELECT SUBS_CSR_NO" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("WHERE SUBS_CSR_SEQ = '01'" ).append("\n"); 
		query.append("ORDER BY SUBS_OFC_CD, EXPN_DIV_CD" ).append("\n"); 
