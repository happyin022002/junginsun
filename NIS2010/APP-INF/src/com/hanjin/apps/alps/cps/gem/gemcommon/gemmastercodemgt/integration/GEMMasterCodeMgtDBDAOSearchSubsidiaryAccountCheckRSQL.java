...
*@FileName : GEMMasterCodeMgtDBDAOSearchSubsidiaryAccountCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMMasterCodeMgtDBDAOSearchSubsidiaryAccountCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAOSearchSubsidiaryAccountCheckRSQL(){
		setQuery();
		...
		query.append("FileName : GEMMasterCodeMgtDBDAOSearchSubsidiaryAccountCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(*), 0, 'TRUE', 'FALSE') AS CODE" ).append("\n"); 
