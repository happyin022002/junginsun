...
*@FileName : CPS_CNI_0042HTMLAction.java
...
/**
 * CPS_GEM_0042  CCC VVD & SKD Inquiry
 * HTTP Parser<br>
 * @author 진윤오
...
public class CPS_CNI_0042HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0042Event event = new CpsCni0042Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			VvdSkdCondVO vvdSkdCondVO = (VvdSkdCondVO)getVO(request, VvdSkdCondVO.class);
			event.setVvdSkdCondVO(vvdSkdCondVO);
		}
