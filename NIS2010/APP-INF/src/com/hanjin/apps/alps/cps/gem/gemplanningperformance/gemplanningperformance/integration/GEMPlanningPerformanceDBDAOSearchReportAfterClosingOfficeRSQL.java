...
*@FileName : GEMPlanningPerformanceDBDAOSearchReportAfterClosingOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOSearchReportAfterClosingOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOSearchReportAfterClosingOfficeRSQL(){
		setQuery();
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOSearchReportAfterClosingOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT G.PRNT_OFC_CD AS LEVEL_3" ).append("\n"); 
		...
		query.append("      ,GEM_OFFICE G       " ).append("\n"); 
		...
		query.append("  AND F.OFC_CD = G.OFC_CD(+)" ).append("\n"); 
		...
		query.append("    )" ).append("\n"); 
		query.append("#end  " ).append("\n"); 
		query.append("GROUP BY G.PRNT_OFC_CD" ).append("\n"); 
		query.append("        ,F.OFC_CD" ).append("\n"); 
		query.append("ORDER BY LEVEL_3" ).append("\n"); 
		query.append("        ,F.OFC_CD" ).append("\n"); 
