...
*@FileName : GEMConsultationSlipDBDAOConsultaionCancelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOConsultaionCancelUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOConsultaionCancelUSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOConsultaionCancelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,APRO_RSLT_CD ='C'" ).append("\n"); 
