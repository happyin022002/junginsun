...
*@FileName : CPS_CNI_0303HTMLAction.java
...
public class CPS_CNI_0303HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * CPS_CNI_0303HTMLAction 객체를 생성
	 */
	public CPS_CNI_0303HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsCni0303Event event = new CpsCni0303Event();

		FormCommand command = FormCommand.fromRequest(request);
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setDwClmNo(request.getParameter("dw_clm_no"));
			event.setCustomHandlingCostVOS((CustomHandlingCostVO[])getVOs(request, CustomHandlingCostVO.class,"sheet_"));
		}
