...
*@FileName : SearchDryWetClaimCodeListVO.java
*@FileTitle : SearchDryWetClaimCodeListVO
*Open Issues :
*Change history :
...
public class SearchDryWetClaimCodeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchDryWetClaimCodeListVO> models = new ArrayList<SearchDryWetClaimCodeListVO>();
	...
	public SearchDryWetClaimCodeListVO() {}

	public SearchDryWetClaimCodeListVO(String ibflag, String pagerows, String clmMiscCd, String clmMiscNm) {
		this.ibflag = ibflag;
	 ...
	 */
	public SearchDryWetClaimCodeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchDryWetClaimCodeListVO[]
	 */
	public SearchDryWetClaimCodeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchDryWetClaimCodeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchDryWetClaimCodeListVO();
				if (ibflag[i] != null)
		...
		return getSearchDryWetClaimCodeListVOs();
	}
	 ...
	 * @return SearchDryWetClaimCodeListVO[]
	 */
	public SearchDryWetClaimCodeListVO[] getSearchDryWetClaimCodeListVOs(){
		SearchDryWetClaimCodeListVO[] vos = (SearchDryWetClaimCodeListVO[])models.toArray(new SearchDryWetClaimCodeListVO[models.size()]);
		return vos;
	}
