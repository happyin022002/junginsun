...
*@FileName : CniCgoClmLablPtyVO.java
*@FileTitle : CniCgoClmLablPtyVO
*Open Issues :
*Change history :
...
public class CniCgoClmLablPtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CniCgoClmLablPtyVO> models = new ArrayList<CniCgoClmLablPtyVO>();
	 ...
	 * @param request
	 * @return CniCgoClmLablPtyVO[]
	 */
	public CniCgoClmLablPtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CniCgoClmLablPtyVO[]
	 */
	public CniCgoClmLablPtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CniCgoClmLablPtyVO model = null;
	 ...
	 * @return CniCgoClmLablPtyVO[]
	 */
	public CniCgoClmLablPtyVO[] getCniCgoClmLablPtyVOs(){
		CniCgoClmLablPtyVO[] vos = (CniCgoClmLablPtyVO[])models.toArray(new CniCgoClmLablPtyVO[models.size()]);
		return vos;
	}
