...
*@FileName : GEMConsultationSlipDBDAOSearchLocalDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOSearchLocalDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OFFICE 별 LOCAL DATE를 구한다.
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOSearchLocalDateRSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOSearchLocalDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
