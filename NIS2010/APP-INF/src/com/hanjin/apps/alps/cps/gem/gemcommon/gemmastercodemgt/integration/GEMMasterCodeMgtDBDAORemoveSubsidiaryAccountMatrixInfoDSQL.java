...
*@FileName : GEMMasterCodeMgtDBDAORemoveSubsidiaryAccountMatrixInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMMasterCodeMgtDBDAORemoveSubsidiaryAccountMatrixInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  *   : 삭제(Delt flg 업데이트) SQL
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAORemoveSubsidiaryAccountMatrixInfoDSQL(){
		setQuery();
		...
		query.append("FileName : GEMMasterCodeMgtDBDAORemoveSubsidiaryAccountMatrixInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET DELT_FLG = DECODE(DELT_FLG, 'N', 'Y', 'N')" ).append("\n"); 
