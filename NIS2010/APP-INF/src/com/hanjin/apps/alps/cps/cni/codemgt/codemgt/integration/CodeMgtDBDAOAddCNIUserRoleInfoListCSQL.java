...
*@FileName : CodeMgtDBDAOAddCNIUserRoleInfoListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgtDBDAOAddCNIUserRoleInfoListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CNI User별 Role 정보를 생성 합니다.
	  * </pre>
	  */
	public CodeMgtDBDAOAddCNIUserRoleInfoListCSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgtDBDAOAddCNIUserRoleInfoListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("MERGE INTO CNI_USR_ROLE_MTCH" ).append("\n"); 
