...
*@FileName : CPS_CNI_0032HTMLAction.java
*@FileTitle : Incident_Claim Inquiry
*Open Issues :
*Change history :
...
/**
 * CPS_CNI_0032  Incident_Claim Inquiry
 * HTTP Parser<br>
 * @author 양정란
 * @see CpsCni0032Event 참조
 * @since J2EE 1.4
 */

public class CPS_CNI_0032HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_CNI_0032HTMLAction 객체를 생성
	 */
	public CPS_CNI_0032HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 CpsCni0032Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		CpsCni0032Event event = new CpsCni0032Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST01)||command.isCommand(FormCommand.PRINT)) {
			...
			String pageNo = JSPUtil.getParameter(request, "page_no","");
