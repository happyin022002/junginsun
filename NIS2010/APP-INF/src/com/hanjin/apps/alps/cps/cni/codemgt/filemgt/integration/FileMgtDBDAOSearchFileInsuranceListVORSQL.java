...
*@FileName : FileMgtDBDAOSearchFileInsuranceListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FileMgtDBDAOSearchFileInsuranceListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FileMgtDBDAOSearchFileInsuranceListVORSQL(){
		setQuery();
		...
		query.append("FileName : FileMgtDBDAOSearchFileInsuranceListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${insur_prm_tp_cd} == '')  " ).append("\n"); 
		query.append("WHERE	1 = 1" ).append("\n"); 
		query.append("AND		CLM_FILE_TP_CD = @[clm_file_tp_cd] " ).append("\n"); 
		query.append("AND		INSUR_TP_CD = @[insur_tp_cd] " ).append("\n"); 
		query.append("AND     INSUR_PLCY_YR = @[insur_plcy_yr] " ).append("\n"); 
		query.append("#else " ).append("\n"); 
		query.append("WHERE	1 = 1" ).append("\n"); 
		query.append("AND		CLM_FILE_TP_CD = @[clm_file_tp_cd] " ).append("\n"); 
		query.append("AND		INST_INSUR_TP_CD = @[insur_tp_cd] " ).append("\n"); 
