...
*@FileName : FileMgtDBDAORemovePremiumFileDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FileMgtDBDAORemovePremiumFileDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FileMgtDBDAORemovePremiumFileDSQL(){
		setQuery();
		...
		query.append("FileName : FileMgtDBDAORemovePremiumFileDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
