...
*@FileName : CPS_GEM_0008_02HTMLAction.java
...
public class CPS_GEM_0008_02HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0008_02HTMLAction 객체를 생성
	 */
	public CPS_GEM_0008_02HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem000802Event event = new CpsGem000802Event();
		
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setOfficeMgtVO((OfficeMgtVO)getVO(request, OfficeMgtVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setOfficeInfoVOs((OfficeInfoVO[])getVOs(request, OfficeInfoVO .class,""));
		}
