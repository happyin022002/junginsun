...
*@FileName : ClaimMainDBDAOModifyHandlingCostInvRgstNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ClaimMainDBDAOModifyHandlingCostInvRgstNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Handing Cost  의 INV_RGST_NO 수정
	  * </pre>
	  */
	public ClaimMainDBDAOModifyHandlingCostInvRgstNoUSQL(){
		setQuery();
		...
		query.append("FileName : ClaimMainDBDAOModifyHandlingCostInvRgstNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
