...
*@FileName : ContainerCargoClaimReportDBDAOSearchSettlementAnalysisListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ContainerCargoClaimReportDBDAOSearchSettlementAnalysisListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSettlementAnalysisList 조회
	  * </pre>
	  */
	public ContainerCargoClaimReportDBDAOSearchSettlementAnalysisListRSQL(){
		setQuery();
		...
		query.append("FileName : ContainerCargoClaimReportDBDAOSearchSettlementAnalysisListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        SELECT" ).append("\n"); 
		query.append("#if(${report_by} == 'CLAIM_AMOUNT' || ${report_by} == 'SETTLED_AMOUNT' || ${report_by} == 'MONTH')--CLAIM_AMOUNT , SETTLED_AMOUNT, MONTH" ).append("\n"); 
		...
		query.append("            (" ).append("\n"); 
		query.append("                SELECT" ).append("\n"); 
		query.append("#if(${report_by} == '09')--AREA" ).append("\n"); 
		query.append("					TBL.CLM_MISC_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '08')--STATUS" ).append("\n"); 
		query.append("					TBL.CLM_MISC_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'HOFC')--HOFC" ).append("\n"); 
		query.append("				    TBL.OFC_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'HANDLER')--HANDLER" ).append("\n"); 
		query.append("				    CLM_V.HDLR_USR_ID AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'LP_HOFC')--LP_HOFC" ).append("\n"); 
		query.append("				    TBL.OFC_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'LIABLE_PARTY')--LIABLE_PARTY" ).append("\n"); 
		query.append("				    TBL.CLM_PTY_ABBR_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'SURVEYOR')--SURVEYOR" ).append("\n"); 
		query.append("				    TBL.CLM_PTY_ABBR_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'ROFC')--ROFC" ).append("\n"); 
		query.append("				    FMAL_CLM_RCV_OFC_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'CLAIMANT')--CLAIMANT" ).append("\n"); 
		query.append("				    TBL.PTY_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'CLAIMANT_AGENT')--CLAIMANT_AGENT" ).append("\n"); 
		query.append("				    TBL.PTY_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'SALVAGER')--SALVAGER" ).append("\n"); 
		query.append("				    TBL.CLM_PTY_ABBR_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'INSURER')--INSURER" ).append("\n"); 
		query.append("				    TBL.CLM_PTY_ABBR_NM AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'VVD')--VVD" ).append("\n"); 
		query.append("				    TRNK_REF_VVD_NO AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'POR')--POR" ).append("\n"); 
		query.append("				    POR_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'POL')--POL" ).append("\n"); 
		query.append("				    POL_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'POD')--POD" ).append("\n"); 
		query.append("				    POD_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'DEL')--DEL" ).append("\n"); 
		query.append("				    DEL_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'FVD')--FVD" ).append("\n"); 
		query.append("					N1ST_PRE_REF_VVD_NO AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'PRE_POT')--PRE_POT" ).append("\n"); 
		query.append("					N1ST_PRE_TS_LOC_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'ON_POT')--ON_POT" ).append("\n"); 
		query.append("					N1ST_PST_TS_LOC_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'CT')--CT" ).append("\n"); 
		query.append("					CRR_TERM_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '14')--POI" ).append("\n"); 
		query.append("				    CLM_INCI_PLC_TP_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'LANE')--LANE" ).append("\n"); 
		query.append("				    SLAN_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '15')--CARGO" ).append("\n"); 
		query.append("				    CLM_CGO_TP_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '11')--TOC" ).append("\n"); 
		query.append("				    CGO_CLM_TP_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '02')--COLD1" ).append("\n"); 
		query.append("				    MJR_CLM_DMG_LSS_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '39')--CODL2" ).append("\n"); 
		query.append("				    N3RD_LABL_PTY_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'LITIGATION')--LITIGATION" ).append("\n"); 
		query.append("				    DECODE(SMNS_SVE_DT, NULL, 'N', 'Y' ) AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '07')--TOS" ).append("\n"); 
		query.append("				    CGO_CLM_STL_TP_CD AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'CLAIM_AMOUNT')--CLAIM_AMOUNT" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'SETTLED_AMOUNT')--SETTLED_AMOUNT" ).append("\n"); 
		...
		query.append("				END AS REPORT_BY" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'MONTH')--MONTH	" ).append("\n"); 
		...
		query.append("			  #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'YEAR')--YEAR" ).append("\n"); 
		query.append("			  #if(${period} == 'DOU' && ${from_period} != '')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == '39')--COLD2" ).append("\n"); 
		query.append("                  , (" ).append("\n"); 
		query.append("                        SELECT" ).append("\n"); 
		query.append("                            CLM_MISC_NM" ).append("\n"); 
		query.append("                          , CLM_MISC_CD" ).append("\n"); 
		...
		query.append("                    )" ).append("\n"); 
		query.append("                    TBL" ).append("\n"); 
		query.append("				WHERE N3RD_LABL_PTY_CD  = TBL.CLM_MISC_CD" ).append("\n"); 
		query.append("				AND N3RD_LABL_PTY_CD IS NOT NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'LITIGATION')--LITIGATION" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if(${report_by} == 'MONTH' || ${report_by} == 'YEAR')--MONTH, YEAR" ).append("\n"); 
		query.append("				WHERE 1=1" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("			  #end" ).append("\n"); 
		query.append("			  #if(${n3rd_labl_pty_cd} != '')" ).append("\n"); 
		query.append("			      AND CLM_V.N3RD_LABL_PTY_CD = @[n3rd_labl_pty_cd] --CODL2" ).append("\n"); 
		query.append("			  #end" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("#if(${report_by} == 'CLAIM_AMOUNT' || ${report_by} == 'SETTLED_AMOUNT')--CLAIM_AMOUNT or SETTLED_AMOUNT" ).append("\n"); 
		query.append("			,(" ).append("\n"); 
