...
*@FileName : DryWetClaimDBDAOAddHandlerHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DryWetClaimDBDAOAddHandlerHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DW HandlerHistory 등록
	  * </pre>
	  */
	public DryWetClaimDBDAOAddHandlerHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : DryWetClaimDBDAOAddHandlerHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
