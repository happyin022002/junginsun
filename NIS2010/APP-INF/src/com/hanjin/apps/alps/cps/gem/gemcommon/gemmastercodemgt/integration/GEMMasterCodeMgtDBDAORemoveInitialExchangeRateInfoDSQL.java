...
public class GEMMasterCodeMgtDBDAORemoveInitialExchangeRateInfoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMMasterCodeMgtDBDAORemoveInitialExchangeRateInfoDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("update gem_xch_rt set" ).append("\n"); 
		...
		query.append("FileName : GEMMasterCodeMgtDBDAORemoveInitialExchangeRateInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}