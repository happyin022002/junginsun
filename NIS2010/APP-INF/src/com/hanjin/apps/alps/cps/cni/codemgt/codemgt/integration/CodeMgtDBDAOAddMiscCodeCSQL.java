...
*@FileName : CodeMgtDBDAOAddMiscCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgtDBDAOAddMiscCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgtDBDAOAddMiscCodeCSQL(){
		setQuery();
		...
		params.put("clm_misc_abbr_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("clm_misc_rmk",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("old_clm_misc_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CodeMgtDBDAOAddMiscCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO CNI_MISC_CD (" ).append("\n"); 
