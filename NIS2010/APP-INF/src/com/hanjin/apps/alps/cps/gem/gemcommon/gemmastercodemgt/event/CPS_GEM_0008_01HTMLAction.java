...
*@FileName : CPS_GEM_0008_01HTMLAction.java
...
public class CPS_GEM_0008_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0008_01HTMLAction 객체를 생성
	 */
	public CPS_GEM_0008_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem000801Event event = new CpsGem000801Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setGemOfficeVOs((GemOfficeVO[])getVOs(request, GemOfficeVO .class,""));
		}
