...
*@FileName : CPS_CNI_0096HTMLAction.java
...
//import com.hanjin.syscommon.common.table.CniUsrRoleMtchVO;
...
public class CPS_CNI_0096HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        CpsCni0096Event event = new CpsCni0096Event();
        ...
        if(command.isCommand(FormCommand.SEARCH)) {
	         ...
	         event.setAttribute("usr_role_cd", usr_role_cd);
       	 	...
       	 	String roleCd =  JSPUtil.getParameter(request, "role_code".trim(), "");
			event.setAttribute("role_code", roleCd);
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setCniUsrRoleMtchVOs((CniUsrRoleMtchVO[])getVOs(request, CniUsrRoleMtchVO .class, ""));
