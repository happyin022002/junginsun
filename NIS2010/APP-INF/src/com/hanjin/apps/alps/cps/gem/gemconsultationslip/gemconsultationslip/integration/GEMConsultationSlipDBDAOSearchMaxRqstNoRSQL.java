...
*@FileName : GEMConsultationSlipDBDAOSearchMaxRqstNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMConsultationSlipDBDAOSearchMaxRqstNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GEMConsultationSlipDBDAOSearchMaxRqstNoRSQL(){
		setQuery();
		...
		query.append("FileName : GEMConsultationSlipDBDAOSearchMaxRqstNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
