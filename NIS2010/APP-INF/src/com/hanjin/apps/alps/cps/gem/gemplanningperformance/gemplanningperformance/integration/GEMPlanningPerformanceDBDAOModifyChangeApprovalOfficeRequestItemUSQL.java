...
*@FileName : GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestItemUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestItemUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * DESC : 기존 OFC_CD 를 변경될 OFC_CD 로 업데이트 한다.
	  * </pre>
	  */
	public GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestItemUSQL(){
		setQuery();
		...
		query.append("FileName : GEMPlanningPerformanceDBDAOModifyChangeApprovalOfficeRequestItemUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
