...
public class ContainerCargoClaimReportDBDAOSearchStatusListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   , CLM_V.N3RD_LABL_PTY_CD -- CODL2" ).append("\n"); 
		...
		query.append("   , CLM_V.INSUR_DMND_USD_AMT  AS INSUR_DMND_AMT  -- INS CAMT" ).append("\n"); 
		query.append("   , CLM_V.INSUR_RCVR_DT AS INS_DOR -- INS DOR" ).append("\n"); 
		query.append("   , CLM_V.INSUR_RCVR_USD_AMT  AS INSUR_RCVR_AMT -- INS RMAT" ).append("\n"); 
		...
		query.append("  #end" ).append("\n"); 
		query.append("  #if(${period} == 'DOSF' && ${from_period} != '')" ).append("\n"); 
		query.append("      AND CLM_V.CPLN_FILE_DT BETWEEN @[from_period]  AND @[to_period] " ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		...
		query.append("      AND CLM_V.CLM_AREA_CD IN ( ${area} ) " ).append("\n"); 
		query.append("  #end" ).append("\n"); 
