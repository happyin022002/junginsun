...
*@FileName : CPS_GEM_0105HTMLAction.java
...
public class CPS_GEM_0105HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0105HTMLAction 객체를 생성
	 */
	public CPS_GEM_0105HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0105Event event = new CpsGem0105Event();		
		//[open]
		...
		event.setRqstOfcCd(rqstOfcCd);
		String genExpnRqstTpCd = JSPUtil.getParameter(request, "gen_expn_rqst_tp_cd", "" );		
		event.setGenExpnRqstTpCd(genExpnRqstTpCd);
		
		String prgId = JSPUtil.getParameter(request, "prg_id", "");
		event.setPrgId(prgId);
