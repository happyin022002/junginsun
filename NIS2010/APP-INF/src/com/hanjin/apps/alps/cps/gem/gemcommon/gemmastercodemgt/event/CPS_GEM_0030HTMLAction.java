...
public class CPS_GEM_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * CPS_GEM_0030HTMLAction 객체를 생성
	 */
	public CPS_GEM_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		CpsGem0030Event event = new CpsGem0030Event();
		...
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			...
			event.setSubsidiaryAccountMatrixInfoVO((SubsidiaryAccountMatrixInfoVO)getVO(request, SubsidiaryAccountMatrixInfoVO .class,""));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setSubsidiaryAccountMatrixInfoVOs((SubsidiaryAccountMatrixInfoVO[])getVOs(request, SubsidiaryAccountMatrixInfoVO .class,""));
		}
