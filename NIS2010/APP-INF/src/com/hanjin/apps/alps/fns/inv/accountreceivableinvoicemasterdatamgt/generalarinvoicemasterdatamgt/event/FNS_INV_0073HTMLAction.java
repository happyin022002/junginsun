...
*@FileName : FNS_INV_0073HTMLAction.java
...
public class FNS_INV_0073HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0073HTMLAction 객체를 생성
	 */
	public FNS_INV_0073HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0073Event event = new FnsInv0073Event();
		if(command.isCommand(FormCommand.MULTI01)||command.isCommand(FormCommand.MULTI02)||command.isCommand(FormCommand.MULTI03)) {
			//event.setInvArStupOfcVOS((InvArStupOfcVO[])getVOs(request, InvArStupOfcVO .class,""));
			event.setInvArStupOfcVO((InvArStupOfcVO)getVO(request, InvArStupOfcVO .class));	
			event.setProcGB(request.getParameter("proc_gb"));
			...
			event.setArOfcCd(request.getParameter("ar_ofc_cd"));
			event.setChgCd(request.getParameter("chk_chg_cd"));
		}
