...
*@FileName : GeneralARInvoiceMasterDataMgtDBDAOInvCutOffLaneVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceMasterDataMgtDBDAOInvCutOffLaneVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralARInvoiceMasterDataMgtDBDAOInvCutOffLaneVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO INV_CUT_OFF_LANE (" ).append("\n"); 
		...
		query.append("REPLACE(@[aply_dt],'-','')" ).append("\n"); 
		query.append(",	@[ofc_rmk]" ).append("\n"); 
		query.append(",	@[cre_usr_id]" ).append("\n"); 
		...
		query.append("FileName : GeneralARInvoiceMasterDataMgtDBDAOInvCutOffLaneVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}