...
public class InvArMnVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("whfNtcNo", getWhfNtcNo());
	...
	/**
	 * @param oldArIfNo the oldArIfNo to set
	 */
	...
	/**
	 * @param invIssFlg the invIssFlg to set
	 */
	...
	/**
	 * @param whfNtcNo the whfNtcNo to set
	 */
	...
	/**
	 * @param crCurrcd the crCurrcd to set
	 */
	...
	/**
	 * @param ibCrTermDys the ibCrTermDys to set
	 */
	...
	/**
	 * @param obCrTermDys the obCrTermDys to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setWhfNtcNo(JSPUtil.getParameter(request, "whfNtcNo", ""));
		...
		setOldArIfNo(JSPUtil.getParameter(request, "old_ar_if_no", ""));
