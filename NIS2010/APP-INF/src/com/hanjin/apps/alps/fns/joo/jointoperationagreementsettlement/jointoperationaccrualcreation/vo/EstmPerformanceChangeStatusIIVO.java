...
public class EstmPerformanceChangeStatusIIVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EstmPerformanceChangeStatusIIVO> models = new ArrayList<EstmPerformanceChangeStatusIIVO>();
	
	/* Column Info */
	private String exeYrmon = null;
	/* Column Info */
	private String todayYrmon = null;
	/* Column Info */
	...
	public EstmPerformanceChangeStatusIIVO() {}

	public EstmPerformanceChangeStatusIIVO(String ibflag, String pagerows, String exeYrmon, String todayYrmon, String revYrmonFr, String revYrmonTo, String reDivrCd, String trdCd, String rlaneCd, String joCrrCd, String joStlJbCd, String diffOption, String vvd, String estmCondFlg, String estmOption, String changedOption) {
		this.exeYrmon = exeYrmon;
		this.todayYrmon = todayYrmon;
		this.trdCd = trdCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("today_yrmon", getTodayYrmon());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("today_yrmon", "todayYrmon");
	 ...
	 * @return todayYrmon
	 */
	public String getTodayYrmon() {
		return this.todayYrmon;
	}
	 ...
	 * @param todayYrmon
	 */
	public void setTodayYrmon(String todayYrmon) {
		this.todayYrmon = todayYrmon;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTodayYrmon(JSPUtil.getParameter(request, "today_yrmon", ""));
	 ...
	 */
	public EstmPerformanceChangeStatusIIVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EstmConditionVO[]
	 */
	public EstmPerformanceChangeStatusIIVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EstmPerformanceChangeStatusIIVO model = null;
		...
		try {
			...
			String[] todayYrmon = (JSPUtil.getParameter(request, prefix	+ "today_yrmon", length));
			...
			for (int i = 0; i < length; i++) {
				model = new EstmPerformanceChangeStatusIIVO();
				if (exeYrmon[i] != null)
					model.setExeYrmon(exeYrmon[i]);
				if (todayYrmon[i] != null)
					model.setTodayYrmon(todayYrmon[i]);
				if (trdCd[i] != null)
	 ...
	 * @return EstmConditionVO[]
	 */
	public EstmPerformanceChangeStatusIIVO[] getEstmPerformanceChangeStatusVOs(){
		EstmPerformanceChangeStatusIIVO[] vos = (EstmPerformanceChangeStatusIIVO[])models.toArray(new EstmPerformanceChangeStatusIIVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.todayYrmon = this.todayYrmon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
