...
*@FileName : FNS_TOT_0015HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0001HTMLAction 객체를 생성
	 */
	public FNS_TOT_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0015Event event = new FnsTot0015Event();
        log.debug("::CALL::> FNS_TOT_0015HTMLAction - " + command.getCommand());
