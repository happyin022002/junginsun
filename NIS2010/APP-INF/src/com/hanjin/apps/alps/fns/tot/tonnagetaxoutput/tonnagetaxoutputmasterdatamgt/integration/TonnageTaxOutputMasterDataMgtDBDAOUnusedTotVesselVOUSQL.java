...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Unused Vessel Over 30 Days update
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOUSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
