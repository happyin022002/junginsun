...
*@FileName : SettlementProcessDBDAOStlTgtOusRevRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOStlTgtOusRevRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Settlement Taget Ous Revenue
	  * </pre>
	  */
	public SettlementProcessDBDAOStlTgtOusRevRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOStlTgtOusRevRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     -----------------" ).append("\n"); 
		query.append("    FROM OUS_TGT O, JOO_STL_TGT S" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		...
		query.append("        FROM OUS_TGT2" ).append("\n"); 
		...
		query.append("            ,YD_CD" ).append("\n"); 
		query.append("            ,CLPT_IND_SEQ" ).append("\n"); 
		query.append("            ,( SELECT RDR_FLG FROM JOO_LODG_TGT L" ).append("\n"); 
		query.append("               WHERE L.REV_YRMON = J.REV_YRMON" ).append("\n"); 
		query.append("               AND L.REV_YRMON_SEQ = J.REV_YRMON_SEQ" ).append("\n"); 
		query.append("             ) AS RDR_FLG" ).append("\n"); 
		query.append("            ,VPS_ETD_DT" ).append("\n"); 
		query.append("            ,JO_STL_JB_CD" ).append("\n"); 
		query.append("            ,JO_STL_ITM_CD" ).append("\n"); 
		query.append("            ,RF_SCG_STL_TP_CD" ).append("\n"); 
		query.append("            ,DECODE(JO_STL_ITM_CD,'OUS',1,'R/F',2,'OTH',3) AS LEV" ).append("\n"); 
		...
		query.append("            ,REV_DIR_CD" ).append("\n"); 
		query.append("            ,SUBSTR(YD_CD,6,2) AS TML" ).append("\n"); 
		query.append("            ,DECODE(JO_STL_ITM_CD,'OUS',BSA_QTY,'0') AS OUS_KNT " ).append("\n"); 
		query.append("            ,DECODE(JO_STL_ITM_CD,'R/F',BSA_QTY,'0') AS RF_KNT" ).append("\n"); 
		query.append("            ,ACCT_CD" ).append("\n"); 
		query.append("            ,REV_SEQ" ).append("\n"); 
		query.append("            ,ACCT_YRMON" ).append("\n"); 
		query.append("            ,STL_VVD_SEQ" ).append("\n"); 
		...
		query.append("            ,N3RD_REV_ENBL_FLG" ).append("\n"); 
		query.append("            ,N3RD_REV_CRR_CD    " ).append("\n"); 
		query.append("            ,REV_ENBL_FLG AS REV_CHK" ).append("\n"); 
		query.append("            ,N2ND_REV_ENBL_FLG AS N2ND_REV_CHK" ).append("\n"); 
		query.append("            ,N3RD_REV_ENBL_FLG AS N3RD_REV_CHK" ).append("\n"); 
		query.append("            ,STL_TGT_FLG" ).append("\n"); 
		query.append("            ,STL_TGT_FLG AS STL_TGT_FLG2" ).append("\n"); 
		query.append("            ,STL_CLZ_FLG        " ).append("\n"); 
		query.append("            ,BSA_QTY  " ).append("\n"); 
		query.append("        FROM JOO_STL_TGT J" ).append("\n"); 
		query.append("        WHERE 1=1" ).append("\n"); 
		query.append("		    AND J.REV_SHW_FLG IN ('A','C','S')" ).append("\n"); 
		query.append("            AND J.REV_YRMON BETWEEN REPLACE(@[rev_yrmon_fr],'-','') AND REPLACE(@[rev_yrmon_to],'-','')" ).append("\n"); 
		query.append("		    #if (${re_divr_cd} != '')			" ).append("\n"); 
		query.append("		    AND J.RE_DIVR_CD = @[re_divr_cd]" ).append("\n"); 
		query.append("		    #end" ).append("\n"); 
		...
		query.append("		    #end" ).append("\n"); 
		query.append("		#if (${ous_yn} == '' && ${rf_yn} == ''&& ${dg_yn} == '' )" ).append("\n"); 
		query.append("			AND J.JO_STL_ITM_CD IN ('OUS','R/F','OTH')" ).append("\n"); 
		query.append("		#else" ).append("\n"); 
		query.append("		    AND (" ).append("\n"); 
		query.append("		    1!=1" ).append("\n"); 
		query.append("			#if (${ous_yn} == 'Y')" ).append("\n"); 
		query.append("		    OR J.JO_STL_ITM_CD = 'OUS'" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("			#if (${rf_yn} == 'Y')" ).append("\n"); 
		query.append("		    OR J.JO_STL_ITM_CD = 'R/F'" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("			#if (${dg_yn} == 'Y')" ).append("\n"); 
		query.append("		    OR J.JO_STL_ITM_CD = 'OTH'" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("		    )" ).append("\n"); 
		query.append("			#if (${ous_yn} == 'N' && ${rf_yn} == 'N'&& ${dg_yn} == 'N' )" ).append("\n"); 
		query.append("			AND J.JO_STL_ITM_CD IN ('OUS','R/F','OTH')" ).append("\n"); 
