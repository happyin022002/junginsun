...
*@FileName : JointOperationConsultationDBDAOIFESlipDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOIFESlipDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ERP I/F Error 시 JOO_SLIP을 삭제한다.
	  * </pre>
	  */
	public JointOperationConsultationDBDAOIFESlipDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOIFESlipDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE JOO_SLIP A" ).append("\n"); 
