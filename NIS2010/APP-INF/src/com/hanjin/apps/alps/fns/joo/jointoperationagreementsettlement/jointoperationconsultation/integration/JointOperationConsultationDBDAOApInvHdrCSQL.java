...
*@FileName : JointOperationConsultationDBDAOApInvHdrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOApInvHdrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AP_INV_HDR 테이블에 INSERT한다.
	  * </pre>
	  */
	public JointOperationConsultationDBDAOApInvHdrCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOApInvHdrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[cxl_dt]" ).append("\n"); 
		query.append(",(" ).append("\n"); 
		query.append("	SELECT TO_CHAR(A.EFF_DT,'YYYYMM') FROM JOO_CSR A" ).append("\n"); 
		query.append("	WHERE A.SLP_TP_CD||A.SLP_FUNC_CD||A.SLP_OFC_CD||TO_CHAR(TO_DATE(A.SLP_ISS_DT,'YYYYMMDD'),'RRMMDD')||A.SLP_SER_NO = @[csr_no]" ).append("\n"); 
		query.append(" )" ).append("\n"); 
		query.append(",(" ).append("\n"); 
