...
*@FileName : ARInvoiceCustomerMgtDBDAOAgentByVesselVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOAgentByVesselVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOAgentByVesselVOUSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOAgentByVesselVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE INV_VSL_AGN_CUST_CD SET" ).append("\n"); 
		query.append("VSL_CD = @[vsl_cd]," ).append("\n"); 
		query.append("AGN_CD = SUBSTR(@[agn_cd],1,5)," ).append("\n"); 
