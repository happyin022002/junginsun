...
*@FileName : FNS_JOO_0070HTMLAction.java
...
public class FNS_JOO_0070HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0070HTMLAction 객체를 생성
	 */
	public FNS_JOO_0070HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0070Event event = new FnsJoo0070Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setLetterVO((InvMcsLetterVO)getVO(request, InvMcsLetterVO .class));
		}
