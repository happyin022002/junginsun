...
*@FileName : FNS_JOO_0073HTMLAction.java
...
public class FNS_JOO_0073HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0073HTMLAction 객체를 생성
	 */
	public FNS_JOO_0073HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0073Event event = new FnsJoo0073Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setJoCrrCd   (request.getParameter("joCrrCd"));
