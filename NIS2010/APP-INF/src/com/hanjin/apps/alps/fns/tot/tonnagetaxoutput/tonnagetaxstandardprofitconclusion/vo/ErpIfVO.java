...
public class ErpIfVO extends AbstractValueObject {
	 ...
	 * @return sStlYrmon
	 */
	public String getSStlYrmon() {
		return this.sStlYrmon;
	}
	 ...
	 * @param sStlYrmon
	 */
	public void setSStlYrmon(String sStlYrmon) {
		this.sStlYrmon = sStlYrmon;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setUse(JSPUtil.getParameter(request, "use", ""));
	...
	public ErpIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] eStlYrmon = (JSPUtil.getParameter(request, prefix	+ "e_stl_yrmon".trim(), length));
			String[] vvdRmk = (JSPUtil.getParameter(request, prefix	+ "vvd_rmk".trim(), length));
			String[] creDt = (JSPUtil.getParameter(request, prefix	+ "cre_dt".trim(), length));
			String[] use = (JSPUtil.getParameter(request, prefix	+ "use".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			String[] nrtWgt = (JSPUtil.getParameter(request, prefix	+ "nrt_wgt".trim(), length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag".trim(), length));
			String[] batJbSeq = (JSPUtil.getParameter(request, prefix	+ "bat_jb_seq".trim(), length));
			String[] cntCd = (JSPUtil.getParameter(request, prefix	+ "cnt_cd".trim(), length));
			String[] nrtTongTaxAmt = (JSPUtil.getParameter(request, prefix	+ "nrt_tong_tax_amt".trim(), length));
			String[] ldbCapaQty = (JSPUtil.getParameter(request, prefix	+ "ldb_capa_qty".trim(), length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id".trim(), length));
			String[] updDt = (JSPUtil.getParameter(request, prefix	+ "upd_dt".trim(), length));
			String[] usgRt = (JSPUtil.getParameter(request, prefix	+ "usg_rt".trim(), length));
			String[] vslNm = (JSPUtil.getParameter(request, prefix	+ "vsl_nm".trim(), length));
			String[] actBsaCapa = (JSPUtil.getParameter(request, prefix	+ "act_bsa_capa".trim(), length));
			String[] ctrtDys = (JSPUtil.getParameter(request, prefix	+ "ctrt_dys".trim(), length));
			String[] tongFletTpCd = (JSPUtil.getParameter(request, prefix	+ "tong_flet_tp_cd".trim(), length));
			String[] voyDys = (JSPUtil.getParameter(request, prefix	+ "voy_dys".trim(), length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id".trim(), length));
			String[] sStlYrmon = (JSPUtil.getParameter(request, prefix	+ "s_stl_yrmon".trim(), length));
			String[] tongTaxAmt = (JSPUtil.getParameter(request, prefix	+ "tong_tax_amt".trim(), length));
			String[] perTonRev = (JSPUtil.getParameter(request, prefix	+ "per_ton_rev".trim(), length));
			String[] rSeq = (JSPUtil.getParameter(request, prefix	+ "r_seq".trim(), length));
			String[] rNum = (JSPUtil.getParameter(request, prefix	+ "r_num".trim(), length));
			String[] crtDt = (JSPUtil.getParameter(request, prefix	+ "crt_dt".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (sStlYrmon[i] != null)
					model.setSStlYrmon(sStlYrmon[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.sStlYrmon = this.sStlYrmon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.crtDt = this.crtDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
