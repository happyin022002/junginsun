...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOPendulumServicePortVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOPendulumServicePortVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PendulumServicePort(TOT_PNDLM_PORT) 삭제
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOPendulumServicePortVODSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOPendulumServicePortVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM TOT_PNDLM_PORT" ).append("\n"); 
		...
		query.append("AND	PORT_CD = @[port_nm]" ).append("\n"); 
