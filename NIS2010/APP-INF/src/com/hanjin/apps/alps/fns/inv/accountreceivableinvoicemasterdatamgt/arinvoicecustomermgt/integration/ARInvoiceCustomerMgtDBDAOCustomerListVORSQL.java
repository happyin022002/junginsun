...
*@FileName : ARInvoiceCustomerMgtDBDAOCustomerListVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOCustomerListVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOCustomerListVORSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOCustomerListVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",SUM(D.CUST_SCR_AMT) AS CUST_SCR_LOCL_AMT" ).append("\n"); 
		query.append(",B.CUST_RLSE_CTRL_FLG" ).append("\n"); 
		...
		query.append("    AND B.CR_END_DT >= to_CHAR(SYSDATE,'YYYYMMDD')" ).append("\n"); 
		query.append("    AND D.SCR_END_DT(+) >=to_CHAR(SYSDATE,'YYYYMMDD')" ).append("\n"); 
		query.append("#if (${ofc} != '' && ${ofc} != 'ALL') " ).append("\n"); 
		query.append("	AND B.CR_CLT_OFC_CD  = @[ofc]" ).append("\n"); 
		query.append("#else " ).append("\n"); 
		query.append("	AND B.CR_CLT_OFC_CD  in ( SELECT DISTINCT M3.AR_OFC_CD" ).append("\n"); 
