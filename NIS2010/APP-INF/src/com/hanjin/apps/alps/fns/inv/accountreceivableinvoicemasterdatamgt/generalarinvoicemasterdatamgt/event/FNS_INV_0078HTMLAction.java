...
*@FileName : FNS_INV_0078HTMLAction.java
...
public class FNS_INV_0078HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0078HTMLAction 객체를 생성
	 */
	public FNS_INV_0078HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0078Event event = new FnsInv0078Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setArFincDirConvVO((ArFincDirConvVO)getVO(request, ArFincDirConvVO.class));
		}
