...
*@FileName : FNS_INV_0064HTMLAction.java
...
public class FNS_INV_0064HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0064HTMLAction 객체를 생성
	 */
	public FNS_INV_0064HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0064Event event = new FnsInv0064Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setKORGiroInputVO((KORGiroInputVO)getVO(request, KORGiroInputVO .class));
