...
public class ARInvoiceCorrectionDBDAOSearchInvoiceMainForExrateListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" WHERE MN.AR_OFC_CD IN (" ).append("\n"); 
		...
		query.append("   AND DECODE(CU.CNG_INDIV_CD, 'B', TO_CHAR(BK.BL_OBRD_DT,'YYYYMMDD'), 'C', TO_CHAR(RT.RT_APLY_DT,'YYYYMMDD'), 'O', MN.SAIL_DT, MN.SAIL_ARR_DT ) BETWEEN REPLACE(@[fm_if_dt],'-','') AND REPLACE(@[to_if_dt],'-','') " ).append("\n"); 
		query.append("   AND (EXISTS (SELECT 'X' " ).append("\n"); 
		...
		query.append("               AND   DECODE(CU.CNG_INDIV_CD, 'B', TO_CHAR(BK.BL_OBRD_DT,'YYYYMMDD'), 'C', TO_CHAR(RT.RT_APLY_DT,'YYYYMMDD'), 'O', MN.SAIL_DT, MN.SAIL_ARR_DT ) between FM_DT and TO_DT" ).append("\n"); 
		...
		query.append("               AND   MN.AR_IF_NO = CHG2.AR_IF_NO" ).append("\n"); 
		query.append("               AND   VVD.CHG_CURR_CD  = CHG2.CURR_CD" ).append("\n"); 
		query.append("               AND  (( VVD.INV_XCH_RT <> NVL(CHG2.INV_XCH_RT,0) AND   VVD.INV_XCH_RT <> 0 ) OR NVL(CHG2.INV_XCH_RT,0) = 0))" ).append("\n"); 
		query.append(" UNION" ).append("\n"); 
		query.append("SELECT MN.AR_IF_NO," ).append("\n"); 
		query.append("       MN.INV_CUST_CNT_CD,  " ).append("\n"); 
		query.append("       MN.INV_CUST_SEQ, " ).append("\n"); 
		...
		query.append("               AND   CUST.INV_XCH_RT <> 0 )" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif (${run_opt} == 'O')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT MN.AR_IF_NO," ).append("\n"); 
		query.append("       MN.INV_CUST_CNT_CD,  " ).append("\n"); 
		query.append("       MN.INV_CUST_SEQ, " ).append("\n"); 
		...
		query.append("  FROM INV_AR_MN MN," ).append("\n"); 
		query.append("       INV_AR_STUP_OFC OFC" ).append("\n"); 
		query.append(" WHERE MN.AR_IF_NO IN ( SELECT MAX(MN.AR_IF_NO)" ).append("\n"); 
		query.append("                          FROM INV_AR_MN MN," ).append("\n"); 
		query.append("                               MDM_CR_CUST CU," ).append("\n"); 
		query.append("                               BKG_BL_DOC BK" ).append("\n"); 
		query.append("                         WHERE MN.AR_OFC_CD IN (" ).append("\n"); 
		...
		query.append("                           AND MN.INV_CUST_CNT_CD = CU.CUST_CNT_CD" ).append("\n"); 
		query.append("                           AND MN.INV_CUST_SEQ = CU.CUST_SEQ" ).append("\n"); 
		query.append("                           AND MN.BKG_NO = BK.BKG_NO" ).append("\n"); 
		query.append("                           AND NVL(MN.INV_DELT_DIV_CD,'N') <> 'Y'" ).append("\n"); 
		query.append("                           AND MN.XCH_RT_USD_TP_CD ='I'" ).append("\n"); 
		query.append("                           AND MN.REV_TP_CD <> 'M'" ).append("\n"); 
		query.append("                           AND CU.CNG_INDIV_CD = 'B'" ).append("\n"); 
		query.append("                           AND BK.BL_OBRD_DT BETWEEN TO_DATE(REPLACE(@[fm_if_dt],'-',''),'YYYYMMDD') AND TO_DATE(REPLACE(@[to_if_dt],'-',''),'YYYYMMDD')" ).append("\n"); 
		query.append("                         GROUP BY MN.AR_OFC_CD, MN.BL_SRC_NO" ).append("\n"); 
		query.append("                       )" ).append("\n"); 
		query.append("   AND MN.USD_XCH_RT = 0" ).append("\n"); 
		query.append("   AND MN.AR_OFC_CD = OFC.AR_OFC_CD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif (${run_opt} == 'P')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT MN.AR_IF_NO," ).append("\n"); 
		query.append("       MN.INV_CUST_CNT_CD,  " ).append("\n"); 
		query.append("       MN.INV_CUST_SEQ, " ).append("\n"); 
		...
		query.append("   AND MN.BL_INV_IF_DT BETWEEN REPLACE(@[fm_if_dt],'-','') AND REPLACE(@[to_if_dt],'-','')" ).append("\n"); 
		query.append("   AND NVL(MN.INV_DELT_DIV_CD,'N') <> 'Y'" ).append("\n"); 
		query.append("   AND MN.XCH_RT_USD_TP_CD IN ('C','P')" ).append("\n"); 
		query.append("   AND MN.USD_XCH_RT = 0" ).append("\n"); 
		query.append("   AND MN.INV_ISS_FLG <> 'Y'" ).append("\n"); 
		query.append("   AND MN.INV_CLR_FLG <> 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#end" ).append("\n"); 
