...
public class JoSettlementConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<JoSettlementConditionVO> models = new ArrayList<JoSettlementConditionVO>();
	...
	/* Column Info */
	private String ousYn = null;	
	/* Column Info */
	private String rfYn = null;	
	/* Column Info */
	private String dgYn = null;	
	...
	public JoSettlementConditionVO() {}

	public JoSettlementConditionVO(String ibflag, String pagerows, String reDivrCd, String exeYrmon, String joCrrCd, String trdCd, String rlaneCd, String revYrmonFr, String revYrmonTo, String ofcCd, String creFlg, String pageNo, String usrId, String vvd, String diff, String acctCd, String estmVvdTpCd, String adjust, String searchGubun, String joStlStsCd, String joStlItmCd, String ousYn, String rfYn, String dgYn) {
		this.creFlg = creFlg;
		this.diff = diff;
		this.adjust = adjust;		
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ous_yn", getOusYn());
		this.hashColumns.put("rf_yn", getRfYn());		
		this.hashColumns.put("dg_yn", getDgYn());		
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ous_yn", "ousYn");
		this.hashFields.put("rf_yn", "rfYn");		
		this.hashFields.put("dg_yn", "dgYn");		
	 ...
	 * @param ousYn
	 */
	public void setOusYn(String ousYn) {
		this.ousYn = ousYn;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOusYn(JSPUtil.getParameter(request, prefix + "ous_yn", ""));		
		setRfYn(JSPUtil.getParameter(request, prefix + "rf_yn", ""));
		setDgYn(JSPUtil.getParameter(request, prefix + "dg_yn", ""));		
	}
	 ...
	 */
	public JoSettlementConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SettlementConditionVO[]
	 */
	public JoSettlementConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JoSettlementConditionVO model = null;
		...
		try {
			...
			String[] ousYn = (JSPUtil.getParameter(request, prefix	+ "ous_yn", length));
			String[] rfYn = (JSPUtil.getParameter(request, prefix	+ "rf_yn", length));
			String[] dgYn = (JSPUtil.getParameter(request, prefix	+ "dg_yn", length));			
			
			for (int i = 0; i < length; i++) {
				model = new JoSettlementConditionVO();
				if (creFlg[i] != null)
				...
				if (ousYn[i] != null)
					model.setOusYn(ousYn[i]);
				if (rfYn[i] != null)
					model.setRfYn(rfYn[i]);
				if (dgYn[i] != null)
					model.setDgYn(dgYn[i]);
		...
		return getJoSettlementConditionVOs();
	}
	 ...
	 * @return SettlementConditionVO[]
	 */
	public JoSettlementConditionVO[] getJoSettlementConditionVOs(){
		JoSettlementConditionVO[] vos = (JoSettlementConditionVO[])models.toArray(new JoSettlementConditionVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ousYn = this.ousYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.rfYn = this.rfYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.dgYn = this.dgYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
	}
}
