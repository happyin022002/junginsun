...
*@FileName : JooFileUploadDBDAOCsrFileUploadListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JooFileUploadDBDAOCsrFileUploadListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JooFileUploadDBDAOCsrFileUploadListUSQL(){
		setQuery();
		...
		query.append("FileName : JooFileUploadDBDAOCsrFileUploadListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE JOO_CSR_ATCH_FILE" ).append("\n"); 
		query.append("   SET FILE_NM      = @[file_nm]" ).append("\n"); 
		query.append("      ,UPD_DT       = SYSDATE" ).append("\n"); 
		query.append("      ,UPD_USR_ID   = @[usr_id]" ).append("\n"); 
		query.append("      ,JO_AGMT_FILE_TP_CD = @[jo_agmt_file_tp_cd]" ).append("\n"); 
