...
*@FileName : ARInvoiceCorrectionDBDAOCheckTaxInvoiceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOCheckTaxInvoiceRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOCheckTaxInvoiceRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOCheckTaxInvoiceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
