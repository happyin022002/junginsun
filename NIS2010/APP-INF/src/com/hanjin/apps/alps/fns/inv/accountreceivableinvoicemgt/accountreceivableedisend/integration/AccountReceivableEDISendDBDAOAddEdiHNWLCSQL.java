...
*@FileName : AccountReceivableEDISendDBDAOAddEdiHNWLCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOAddEdiHNWLCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOAddEdiHNWLCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOAddEdiHNWLCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_EDI_HNWL" ).append("\n"); 
