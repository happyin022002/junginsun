...
*@FileName : FNS_JOO_0076HTMLAction.java
...
public class FNS_JOO_0076HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0076HTMLAction 객체를 생성
	 */
	public FNS_JOO_0076HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0076Event event = new FnsJoo0076Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setArDisabledVVDVO((ArDisabledVVDVO)getVO(request, ArDisabledVVDVO .class));
		}
