...
public class JointOperationConsultationDBDAOSlipProcessVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                    END" ).append("\n"); 
		query.append("            ELSE TO_CHAR(K.EFF_DT,'YYYY-MM-DD')                  " ).append("\n"); 
		query.append("            END AS EFF_DT" ).append("\n"); 
		query.append("	  ,TO_CHAR(K.RQST_DT,'YYYY-MM-DD') AS RQST_DT" ).append("\n"); 
		...
		query.append("      ,K.APRO_FLG " ).append("\n"); 
		query.append("      ,K.CXL_FLG " ).append("\n"); 
		query.append("      ,K.AGMT_DOC_NO" ).append("\n"); 
		query.append("      ,K.AGMT_DOC_DESC" ).append("\n"); 
		...
		query.append("AND E.SLP_TP_CD = K.SLP_TP_CD(+)" ).append("\n"); 
		query.append("AND E.SLP_FUNC_CD = K.SLP_FUNC_CD(+)" ).append("\n"); 
		query.append("AND @[slp_iss_ofc_cd] = K.SLP_OFC_CD(+)" ).append("\n"); 
		query.append("AND E.SLP_ISS_DT = K.SLP_ISS_DT(+)" ).append("\n"); 
		query.append("AND E.SLP_SER_NO = K.SLP_SER_NO(+)" ).append("\n"); 
