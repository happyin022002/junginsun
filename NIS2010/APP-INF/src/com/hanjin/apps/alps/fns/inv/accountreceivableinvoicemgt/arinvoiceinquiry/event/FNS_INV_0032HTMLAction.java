...
*@FileName : FNS_INV_0032HTMLAction.java
...
public class FNS_INV_0032HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0032HTMLAction 객체를 생성
	 */
	public FNS_INV_0032HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0032Event event = new FnsInv0032Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setNoGoodNoIssueVO((ARInvoiceNoGoodInPutVO)getVO(request, ARInvoiceNoGoodInPutVO .class));
		}
