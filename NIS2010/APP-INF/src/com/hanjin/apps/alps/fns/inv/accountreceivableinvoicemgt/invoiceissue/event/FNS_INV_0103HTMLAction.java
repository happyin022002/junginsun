...
*@FileName : FNS_INV_0103HTMLAction.java
...
public class FNS_INV_0103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0103HTMLAction 객체를 생성
	 */
	public FNS_INV_0103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0103Event event = new FnsInv0103Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCustRptId(request.getParameter("cust_rpt_id_arr"));
			event.setCPRTListVO((CPRTListVO)getVO(request, CPRTListVO .class));
			//event.setCPRTListVOs((CPRTListVO[])getVOs(request, CPRTListVO .class,""));
		}
