...
*@FileName : FNS_JOO_0065HTMLAction.java
...
public class FNS_JOO_0065HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0065HTMLAction 객체를 생성
	 */
	public FNS_JOO_0065HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0065Event event = new FnsJoo0065Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setOfccd(   JSPUtil.getParameter(request, "ofc_cd"  ));
            event.setUserid(  JSPUtil.getParameter(request, "cre_usr_id" ));
            event.setFmdt(    JSPUtil.getParameter(request, "ltr_iss_dt_fr"   ));
            event.setTodt(    JSPUtil.getParameter(request, "ltr_iss_dt_to"   ));            
		}
