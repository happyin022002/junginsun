...
public class JointOperationMasterDataMgtDBDAOFincMtxVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		AND J.CRR_CD = B.JO_CRR_CD" ).append("\n"); 
		query.append("		AND J.RLANE_CD = B.RLANE_CD" ).append("\n"); 
		query.append("		AND J.RE_DIVR_CD = B.RE_DIVR_CD" ).append("\n"); 
		query.append("	   ) AS STL_PIC_NM" ).append("\n"); 
