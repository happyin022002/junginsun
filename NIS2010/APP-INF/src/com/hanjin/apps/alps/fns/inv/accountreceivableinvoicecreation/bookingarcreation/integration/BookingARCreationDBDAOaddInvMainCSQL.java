...
*@FileName : BookingARCreationDBDAOaddInvMainCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOaddInvMainCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingARCreationDBDAOaddInvMainCSQL
	  * </pre>
	  */
	public BookingARCreationDBDAOaddInvMainCSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOaddInvMainCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[clr_dt]	" ).append("\n"); 
		query.append(",@[acct_cd]" ).append("\n"); 
		query.append(",DECODE(NVL(@[bl_inv_cfm_dt],'X'),'X','',(SELECT NVL((SELECT MAX(IF_SEQ) FROM INV_AR_MN WHERE BL_SRC_NO = @[bl_src_no] ), 0) + 1 FROM DUAL))" ).append("\n"); 
