...
*@FileName : INVCommonDBDAOSearchCommonCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class INVCommonDBDAOSearchCommonCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public INVCommonDBDAOSearchCommonCodeRSQL(){
		setQuery();
		...
		query.append("FileName : INVCommonDBDAOSearchCommonCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
