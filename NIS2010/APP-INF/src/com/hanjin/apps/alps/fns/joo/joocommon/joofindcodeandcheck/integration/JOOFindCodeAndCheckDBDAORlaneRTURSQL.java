...
*@FileName : JOOFindCodeAndCheckDBDAORlaneRTURSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAORlaneRTURSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rlane과 R/T/U, Currency를 가져오게 함
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAORlaneRTURSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAORlaneRTURSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 b.jo_stl_tgt_tp_cd as name," ).append("\n"); 
		query.append("     c.locl_curr_cd     as super_cd1," ).append("\n"); 
		query.append("     a.jo_stl_opt_cd    as super_cd2," ).append("\n"); 
		query.append("     d.jo_crr_auth_cd   as auth_cd" ).append("\n"); 
		query.append("FROM  joo_carrier      a," ).append("\n"); 
		query.append("      joo_stl_bss_port b," ).append("\n"); 
		query.append("      joo_finc_mtx     c," ).append("\n"); 
		query.append("      joo_crr_auth     d" ).append("\n"); 
		...
		query.append("and   b.jo_stl_itm_cd(+) = @[code]" ).append("\n"); 
		...
		query.append("and   d.auth_ofc_cd = @[ofc_cd]" ).append("\n"); 
