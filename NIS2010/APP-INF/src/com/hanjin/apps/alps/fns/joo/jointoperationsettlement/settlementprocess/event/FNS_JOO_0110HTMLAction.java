...
*@FileName : FNS_JOO_0110HTMLAction.java
*@FileTitle : Settlement Target
*Open Issues :
*Change history :
...
public class FNS_JOO_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0110HTMLAction 객체를 생성
	 */
	public FNS_JOO_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	FnsJoo0110Event event = new FnsJoo0110Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			event.setStlTgtVOs((StlTgtVO[])getVOs(request, StlTgtVO.class, "sheet1_"));
