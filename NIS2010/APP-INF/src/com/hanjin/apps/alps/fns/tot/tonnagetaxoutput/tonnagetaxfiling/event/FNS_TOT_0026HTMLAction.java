...
*@FileName : FNS_TOT_0026HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
 ...
 * @see FnsTot0026Event 참조
 * @since J2EE 1.4
 */

public class FNS_TOT_0026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0026HTMLAction 객체를 생성
	 */
	public FNS_TOT_0026HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0026Event event = new FnsTot0026Event();
        log.debug("::CALL::> FNS_TOT_0026HTMLAction - " + command.getCommand());
