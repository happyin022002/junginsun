...
*@FileName : FNS_JOO_0114HTMLAction.java
...
public class FNS_JOO_0114HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0103HTMLAction 객체를 생성
	 */
	public FNS_JOO_0114HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0114Event event = new FnsJoo0114Event();
						
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setStlStsVO((StlStsVO)getVO(request, StlStsVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			StlStsVO[] vos = (StlStsVO[])getVOs(request, StlStsVO .class);
			event.setStlStsVOs(vos);
		}
