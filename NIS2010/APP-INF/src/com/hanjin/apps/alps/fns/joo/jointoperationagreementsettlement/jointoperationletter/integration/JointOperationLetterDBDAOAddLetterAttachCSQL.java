...
*@FileName : JointOperationLetterDBDAOAddLetterAttachCSQL.java
*@FileTitle : A
*Open Issues :
*Change history :
...
public class JointOperationLetterDBDAOAddLetterAttachCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationLetterDBDAOAddLetterAttachCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationLetterDBDAOAddLetterAttachCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO JOO_LTR_ATCH_FILE" ).append("\n"); 
