...
*@FileName : FNS_INV_0043HTMLAction.java
...
public class FNS_INV_0043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0043HTMLAction 객체를 생성
	 */
	public FNS_INV_0043HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0043Event event = new FnsInv0043Event();
		 
		if(command.isCommand(FormCommand.SEARCH01)) {	//open
			...
			billInputVO.setOfcCd(request.getParameter("ofc").trim());
