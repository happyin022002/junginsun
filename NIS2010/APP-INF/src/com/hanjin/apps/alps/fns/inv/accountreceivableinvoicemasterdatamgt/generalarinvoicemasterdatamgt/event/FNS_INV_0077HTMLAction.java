...
*@FileName : FNS_INV_0077HTMLAction.java
...
public class FNS_INV_0077HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0077HTMLAction 객체를 생성
	 */
	public FNS_INV_0077HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0077Event event = new FnsInv0077Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setLaneOrderInPutVO((LaneOrderInPutVO)getVO(request, LaneOrderInPutVO .class));
//			event.setMdmRevLaneVO((MdmRevLaneVO)getVO(request, MdmRevLaneVO.class));
		}
