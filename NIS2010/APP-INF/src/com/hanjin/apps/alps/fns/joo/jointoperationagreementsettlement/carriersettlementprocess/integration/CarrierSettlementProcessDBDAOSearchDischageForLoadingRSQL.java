...
public class CarrierSettlementProcessDBDAOSearchDischageForLoadingRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            ,DECODE( GROUPING(FORM.POL_CD ), 0,  SUBSTR(FORM.POL_CD, 0, INSTR(FORM.POL_CD,'(')-1 )" ).append("\n"); 
		...
		query.append("               B1.POL_CD||'('||SKD.YD_CD||')'||SKD.CLPT_IND_SEQ POL_CD," ).append("\n"); 
		query.append("               B1.POL_YD_CD," ).append("\n"); 
		query.append("               SKD.CLPT_SEQ ," ).append("\n"); 
		query.append("               SKD.SKD_DIR_CD ," ).append("\n"); 
		query.append("               B1.POD_CD||'('||POD_SKD.YD_CD||')'||B1.POD_CLPT_IND_SEQ POD_CD," ).append("\n"); 
		...
		query.append("                  SELECT SKD.VPS_PORT_CD||'('||SKD.YD_CD||')'||SKD.CLPT_IND_SEQ POL_CD" ).append("\n"); 
		query.append("                  ,      SKD.SKD_DIR_CD" ).append("\n"); 
		query.append("                  ,      SKD.CLPT_SEQ   " ).append("\n"); 
