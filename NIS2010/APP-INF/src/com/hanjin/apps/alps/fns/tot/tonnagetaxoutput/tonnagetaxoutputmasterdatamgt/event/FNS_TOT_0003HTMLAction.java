...
public class FNS_TOT_0003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0003HTMLAction 객체를 생성
	 */
	public FNS_TOT_0003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0003Event event = new FnsTot0003Event();
        log.debug("::CALL::> FNS_TOT_0003HTMLAction - " + command.getCommand());
