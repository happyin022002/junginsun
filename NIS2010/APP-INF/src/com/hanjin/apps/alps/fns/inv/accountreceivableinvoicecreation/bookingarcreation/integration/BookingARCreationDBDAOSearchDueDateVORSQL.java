...
*@FileName : BookingARCreationDBDAOSearchDueDateVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOSearchDueDateVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchDueDate ( dueInputVo )
	  * return DueDateVO
	  * </pre>
	  */
	public BookingARCreationDBDAOSearchDueDateVORSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOSearchDueDateVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(DECODE(@[bnd], 'I', NVL(A.IB_CR_TERM_DYS,0),  NVL(A.OB_CR_TERM_DYS,0)),0,'N', NVL(A.CR_FLG,'N')) CUST_CR_FLG," ).append("\n"); 
