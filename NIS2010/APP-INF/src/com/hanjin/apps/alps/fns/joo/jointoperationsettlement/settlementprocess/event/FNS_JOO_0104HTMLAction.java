...
*@FileName : FNS_JOO_0104HTMLAction.java
*@FileTitle : Slot Hire Target
*Open Issues :
*Change history :
...
public class FNS_JOO_0104HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0104HTMLAction 객체를 생성
	 */
	public FNS_JOO_0104HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	FnsJoo0104Event event = new FnsJoo0104Event();
		
		event.setJoSettlementConditionVO( (JoSettlementConditionVO)getVO(request, JoSettlementConditionVO .class) );
		event.setJoEstmConditionVO( (JoEstmConditionVO)getVO(request, JoEstmConditionVO .class) );
//		event.setAttribute("key", request.getParameter("key"));

		if(command.isCommand(FormCommand.MULTI)) {
			event.setSltHirTgtVOs((SltHirTgtVO[])getVOs(request, SltHirTgtVO.class, "sheet1_"));
