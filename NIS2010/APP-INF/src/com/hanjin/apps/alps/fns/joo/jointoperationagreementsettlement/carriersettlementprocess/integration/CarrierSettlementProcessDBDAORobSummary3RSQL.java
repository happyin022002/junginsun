...
*@FileName : CarrierSettlementProcessDBDAORobSummary3RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAORobSummary3RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAORobSummary3RSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAORobSummary3RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
