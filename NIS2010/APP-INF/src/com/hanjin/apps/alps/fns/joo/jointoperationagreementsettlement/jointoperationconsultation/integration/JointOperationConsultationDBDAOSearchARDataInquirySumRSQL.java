...
*@FileName : JointOperationConsultationDBDAOSearchARDataInquirySumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOSearchARDataInquirySumRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchARDataInquirySum
	  * </pre>
	  */
	public JointOperationConsultationDBDAOSearchARDataInquirySumRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOSearchARDataInquirySumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'TOTAL' AS ACCT_YRMON," ).append("\n"); 
		query.append("CSR_LOCL_AMT," ).append("\n"); 
		query.append("STL_USD_AMT," ).append("\n"); 
		query.append("LOCL_CURR_CD" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT SUM(DECODE(S.RE_DIVR_CD, 'R', SL.CSR_LOCL_AMT / DECODE (S.LOCL_CURR_CD, 'USD', 1, (" ).append("\n"); 
		...
		query.append("GROUP BY S.LOCL_CURR_CD )Z" ).append("\n"); 
