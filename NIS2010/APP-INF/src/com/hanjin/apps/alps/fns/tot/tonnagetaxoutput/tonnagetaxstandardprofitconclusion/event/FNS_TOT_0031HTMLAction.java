...
*@FileName : FNS_TOT_0031HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0031HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0031HTMLAction 객체를 생성
	 */
	public FNS_TOT_0031HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0031Event event = new FnsTot0031Event();
        log.debug("::CALL::> FNS_TOT_0031HTMLAction - " + command.getCommand());
		...
		if(command.isCommand(FormCommand.MULTI)) {
			event.setPortStlAmtVOs((PortStlAmtVO[])getVOs(request, PortStlAmtVO.class,"sheet1_"));
			 ...
			 log.debug("::CALL::> FNS_TOT_0031HTMLAction -여기");
