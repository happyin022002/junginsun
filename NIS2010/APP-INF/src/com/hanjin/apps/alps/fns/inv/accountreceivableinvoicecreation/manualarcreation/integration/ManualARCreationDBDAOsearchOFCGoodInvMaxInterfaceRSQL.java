...
*@FileName : ManualARCreationDBDAOsearchOFCGoodInvMaxInterfaceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualARCreationDBDAOsearchOFCGoodInvMaxInterfaceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchOFCGoodInvMaxInterface
	  * </pre>
	  */
	public ManualARCreationDBDAOsearchOFCGoodInvMaxInterfaceRSQL(){
		setQuery();
		...
		query.append("FileName : ManualARCreationDBDAOsearchOFCGoodInvMaxInterfaceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
