...
*@FileName : FNS_TOT_0018HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0018HTMLAction 객체를 생성
	 */
	public FNS_TOT_0018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0018Event event = new FnsTot0018Event();
        log.debug("::CALL::> FNS_TOT_0018HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.SEARCH)) {
			
			event.setErpIfVO((ErpIfVO)getVO(request, ErpIfVO.class));
