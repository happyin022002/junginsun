...
*@FileName : FNS_INV_0085HTMLAction.java
...
public class FNS_INV_0085HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0085HTMLAction 객체를 생성
	 */
	public FNS_INV_0085HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0085Event event = new FnsInv0085Event();	
		...
		//	event.setPort(port);
			...
			event.setIndBkgVO(invoiceInquiryInPutVO);
		}
