...
*@FileName : FNS_TOT_0023HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0023HTMLAction 객체를 생성
	 */
	public FNS_TOT_0023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0023Event event = new FnsTot0023Event();
        log.debug("::CALL::> FNS_TOT_0023HTMLAction - " + command.getCommand());
