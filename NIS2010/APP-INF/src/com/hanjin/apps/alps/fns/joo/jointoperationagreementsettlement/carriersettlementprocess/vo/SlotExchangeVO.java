...
*@FileName : SlotExchangeVO.java
*@FileTitle : SlotExchangeVO
*Open Issues :
*Change history :
...
public class SlotExchangeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SlotExchangeVO> models = new ArrayList<SlotExchangeVO>();
	 ...
	 * @param request
	 * @return SlotExchangeVO[]
	 */
	public SlotExchangeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SlotExchangeVO[]
	 */
	public SlotExchangeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SlotExchangeVO model = null;
	 ...
	 * @return SlotExchangeVO[]
	 */
	public SlotExchangeVO[] getSlotExchangeVOs(){
		SlotExchangeVO[] vos = (SlotExchangeVO[])models.toArray(new SlotExchangeVO[models.size()]);
		return vos;
	}
