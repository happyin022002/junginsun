...
import com.hanjin.syscommon.common.table.JooArMnVO;
...
public class FnsJoo0026Event extends EventSupport {
	...
	public JooArMnVO[] getJooArMnVOS(){
		JooArMnVO[] rtnVOs = null;
		if (this.jooArMnVOs != null) {
			rtnVOs = new JooArMnVO[jooArMnVOs.length];
			System.arraycopy(jooArMnVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;		
	}
