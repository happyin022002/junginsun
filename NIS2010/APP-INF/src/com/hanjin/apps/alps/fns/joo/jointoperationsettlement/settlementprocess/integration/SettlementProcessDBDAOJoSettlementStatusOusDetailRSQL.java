...
*@FileName : SettlementProcessDBDAOJoSettlementStatusOusDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOJoSettlementStatusOusDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Jo 미정산 현황 - OUS/RF/OTHER(Detail)
	  * </pre>
	  */
	public SettlementProcessDBDAOJoSettlementStatusOusDetailRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOJoSettlementStatusOusDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT " ).append("\n"); 
		query.append("            MAX(T.REV_YRMON) AS REV_YRMON" ).append("\n"); 
		...
		query.append("           ,MAX(T.REV_YRMON_SEQ) AS REV_YRMON_SEQ" ).append("\n"); 
		...
		query.append(" ,AA.CRR_CD" ).append("\n"); 
		query.append(" ,AA.RE_DIVR_CD" ).append("\n"); 
		query.append(" ,AA.VSL  			" ).append("\n"); 
		query.append(" ,AA.VOY  			" ).append("\n"); 
		query.append(" ,AA.DIR 			" ).append("\n"); 
		query.append(" ,AA.PORT 			" ).append("\n"); 
		query.append(" ,AA.TML 			" ).append("\n"); 
		query.append(" ,AA.IND 			" ).append("\n"); 
		query.append(" ,'' AS RMK_TP 		" ).append("\n"); 
		query.append(" ,( " ).append("\n"); 
		query.append("    SELECT  " ).append("\n"); 
		query.append("     MAX(DECODE(J.JO_STL_ITM_CD,'OUS',STL_RMK ,'')) || ' ' || " ).append("\n"); 
		query.append("     MAX(DECODE(J.JO_STL_ITM_CD,'R/F',STL_RMK ,'')) || ' ' || " ).append("\n"); 
		query.append("     MAX(DECODE(J.JO_STL_ITM_CD,'OTH',STL_RMK ,'')) AS STL_RMK " ).append("\n"); 
		query.append("    FROM JOO_STL_TGT J" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		query.append("    AND J.REV_YRMON_SEQ = AA.REV_YRMON_SEQ" ).append("\n"); 
		query.append("    AND (J.STL_TGT_FLG = 0 AND STL_CLZ_FLG = 0)" ).append("\n"); 
		...
		query.append(" ,DECODE(AA.OUS,'1','X','0','O') AS OUS" ).append("\n"); 
		query.append(" ,DECODE(AA.RF,'1','X','0','O') AS RF 			" ).append("\n"); 
		query.append(" ,DECODE(AA.OTHER,'1','X','0','O') AS OTHER " ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("    SELECT" ).append("\n"); 
