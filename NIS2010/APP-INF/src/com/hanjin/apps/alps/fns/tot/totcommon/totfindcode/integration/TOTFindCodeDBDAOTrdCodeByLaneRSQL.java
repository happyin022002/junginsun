...
*@FileName : TOTFindCodeDBDAOTrdCodeByLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TOTFindCodeDBDAOTrdCodeByLaneRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * lane 에 따른 trade code 조회(콤보용)
	  * </pre>
	  */
	public TOTFindCodeDBDAOTrdCodeByLaneRSQL(){
		setQuery();
		...
		query.append("FileName : TOTFindCodeDBDAOTrdCodeByLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DISTINCT REP_TRD_CD CD," ).append("\n"); 
