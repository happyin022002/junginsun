...
*@FileName : ARInvoiceCustomerMgtDBDAOTemplateVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOTemplateVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOTemplateVOCSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOTemplateVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_CPRT_TMPLT	(" ).append("\n"); 
