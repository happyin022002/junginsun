 ...
 * @since J2EE 1.5
 */
public class FnsInv0014LineViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"cust_cd","cust_lgl_eng_nm","cust_rgst_no","cr_amt","cr_amt2","cr_clt_ofc_cd","ofc_cd","act_payer","locl_nm","ownr_nm","ib_cr_term_dys","ob_cr_term_dys","kr_ib_ofc_cd","locl_zip_cd"};
		...
		log.info("vo.getMaxRows()==>"+vo.getMaxRows());
		log.info("totCnt==>"+totCnt);
