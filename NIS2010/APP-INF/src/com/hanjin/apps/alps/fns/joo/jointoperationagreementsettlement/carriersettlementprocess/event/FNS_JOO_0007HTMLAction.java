...
*@FileName : FNS_JOO_0007HTMLAction.java
*@FileTitle : Slot Hire
*Open Issues :
*Change history :
...
public class FNS_JOO_0007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0007HTMLAction 객체를 생성
	 */
	public FNS_JOO_0007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0007Event event = new FnsJoo0007Event();
