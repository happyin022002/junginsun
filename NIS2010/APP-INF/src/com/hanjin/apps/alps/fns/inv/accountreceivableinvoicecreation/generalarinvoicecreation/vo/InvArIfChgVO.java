...
public class InvArIfChgVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSbcFlg(JSPUtil.getParameter(request, "sbc_flg", ""));
		setKkcFlg(JSPUtil.getParameter(request, "kkc_flg", ""));
	}
