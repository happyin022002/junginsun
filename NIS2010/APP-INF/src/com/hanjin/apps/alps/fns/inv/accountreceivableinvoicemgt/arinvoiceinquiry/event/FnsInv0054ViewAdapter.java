 ...
 *@FileName : FnsInv0054ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class FnsInv0054ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = { "","iss_dt","io_bnd_cd","bl_src_no","vvd","cust_cd","locl_curr_cd","usd_xch_rt","cre_usr_id1",
				"","inv_no","rev_tp_cd","ar_if_no","sail_arr_dt","pol_pod","chg_amt","local_total","cre_usr_id2" };
