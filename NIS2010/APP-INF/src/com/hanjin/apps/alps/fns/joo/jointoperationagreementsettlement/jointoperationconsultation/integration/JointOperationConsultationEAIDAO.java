...
/**
 * ALPS JointOperationConsultationEAIDAO <br>
 * - ALPS ERP와의 Interface를 위한 EAI DAO<br>
 * 
...
public class JointOperationConsultationEAIDAO extends EAIDAOSupport {
	 ...
	 * @param String agmtCntYn
	 * @throws DAOException
	 */
	public void sendSlipApprovalToAP(String csrNo, List<InvHdrVO> invHdrVOs, List<InvDtrbVO> invDtrbVOs, String agmtCntYn) throws DAOException {
...
//	        	}
	        	...
	        	for (int j=rowCnt; j<listSize; j++) {
	            	...
	            	setAPData(apInvoiceRequest, invHdrVOs.get(0) ,invDtrbVOs.get(j), timeStamp, listSize, currRow, agmtCntYn);
    	        ...
    	        //eai.setDestination(SubSystemConfigFactory.get("COM.ALPSJ.JMS.DESTINATION"));
	 ...
	 * @throws Exception
	 */
	private void setAPData(APInvoiceRequest invoiceReq, InvHdrVO invHdrVO, InvDtrbVO invDtrbVO, String timeStamp, int totCnt, int currRow, String agmtCntYn) throws Exception {
		...
		try {
			...
			invoiceReq.setHREFERENCEKEY1(agmtCntYn);
	...
	public void sendSlipApprovalToAR(String csrNo, List<ArMnChgVO> arMnChgVOs) throws DAOException {
	    ...
	    try {
    		...
    		for (int j=0; j<listSize; j++) {
	            ...
	            com.hanjin.irep.erp.EAIHeaderType headerType = fns0120001.addNewEAIHeader();
	            timeStamp = (new SimpleDateFormat("yyyyMMddHHmmss")).format(new Date());
