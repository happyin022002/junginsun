...
public class CusBzcAgmtVO extends AbstractValueObject {
	...
	/* Column Info */
	private String jo45ftUndTeuQty = null;
	/* Column Info */
	...
	/* Column Info */
	private String jo45ftOvrTeuQty = null;
	...
	/* Column Info */
	private String joBsaAdjTeuQty = null;
	/* Column Info */
	private String joBsaAdjWgt = null;
	/* Column Info */
	private String joAdjRmk = null;
	/* Column Info */
	private String skdDirCd = null;
	/* Column Info */
	private String joCrrFlag = null;
	/* Column Info */
	private String agmtEffYear = null;
	/* Column Info */
	private String agmtEffMon = null;
	/* Column Info */
	private String joRefCrrCd = null;
	...
	public CusBzcAgmtVO(String joBsaAdjTeuQty, String joBsaAdjWgt, String joAdjRmk, String ibflag, String pagerows, String agmtEffDt, String deltFlg, String creDt, String trdCd, String rlaneCd, String joRfGnteInterQty, String jo20ftGnteQty, String joSrcCd, String joTonWgtRndRt, String agmtExpDt, String joBkgTpCd, String jo20ftRndRt, String jo20ftTeuQty, String updUsrId, String jo45ftTeuQty, String joTonTeuQty, String updDt, String jo45ftGnteQty, String joRefNo, String jo45ftRndRt, String jo40ftGnteQty, String joCrrCd, String jo40ftTeuQty, String creUsrNm, String joRefSeq, String bsaCapa, String ofcCd, String creUsrId, String reDivrCd, String cgoTonWgt, String jo40ftRndRt, String joRfGnteOcnQty, String jo45ftOvrTeuQty, String jo45ftUndTeuQty, String skdDirCd, String joCrrFlag, String agmtEffYear, String agmtEffMon, String joRefCrrCd) {
		this.agmtEffDt = agmtEffDt;
		this.jo45ftUndTeuQty = jo45ftUndTeuQty;
		...
		this.jo45ftOvrTeuQty = jo45ftOvrTeuQty;
		this.ibflag = ibflag;
		...
		this.joBsaAdjTeuQty = joBsaAdjTeuQty;
		this.joBsaAdjWgt = joBsaAdjWgt;
		this.joAdjRmk = joAdjRmk;
		this.skdDirCd = skdDirCd;
		this.joCrrFlag = joCrrFlag;
		this.agmtEffYear = agmtEffYear;
		this.agmtEffMon = agmtEffMon;
		this.joRefCrrCd = joRefCrrCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("jo_45ft_und_teu_qty", getJo45ftUndTeuQty());
		...
		this.hashColumns.put("jo_45ft_ovr_teu_qty", getJo45ftOvrTeuQty());
		...
		this.hashColumns.put("jo_aloc_adj_teu_qty", getJoBsaAdjTeuQty());
		this.hashColumns.put("jo_aloc_adj_wgt", getJoBsaAdjWgt());
		this.hashColumns.put("jo_aloc_adj_rmk", getJoAdjRmk());
		this.hashColumns.put("skd_dir_cd", getSkdDirCd());
		this.hashColumns.put("jo_crr_flag", getJoCrrFlag());
		this.hashColumns.put("agmt_eff_year", getAgmtEffYear());
		this.hashColumns.put("agmt_eff_mon", getAgmtEffMon());
		this.hashColumns.put("jo_ref_crr_cd", getJoRefCrrCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("jo_45ft_und_teu_qty", "jo45ftUndTeuQty");
		...
		this.hashFields.put("jo_45ft_ovr_teu_qty", "jo45ftOvrTeuQty");
		...
		this.hashFields.put("jo_aloc_adj_teu_qty", "joBsaAdjTeuQty");
		this.hashFields.put("jo_aloc_adj_wgt", "joBsaAdjWgt");
		this.hashFields.put("jo_aloc_adj_rmk", "joAdjRmk");
		this.hashFields.put("skd_dir_cd", "skdDirCd");
		this.hashFields.put("jo_crr_flag", "joCrrFlag");
		this.hashFields.put("agmt_eff_year", "agmtEffYear");
		this.hashFields.put("agmt_eff_mon", "agmtEffMon");
		this.hashFields.put("jo_ref_crr_cd", "joRefCrrCd");
	...
	/**
	 * Column Info
	 * @return jo45ftUndTeuQty
	 */
	public String getJo45ftUndTeuQty() {
		return this.jo45ftUndTeuQty;
	}
	...
	/**
	 * Column Info
	 * @return jo45ftOvrTeuQty
	 */
	public String getJo45ftOvrTeuQty() {
		return this.jo45ftOvrTeuQty;
	}
	...
	/**
	 * Column Info
	 * @return joBsaAdjTeuQty
	 */
	public String getJoBsaAdjTeuQty() {
		return this.joBsaAdjTeuQty;
	}
	/**
	 * Column Info
	 * @return joBsaAdjWgt
	 */
	public String getJoBsaAdjWgt() {
		return this.joBsaAdjWgt;
	}
	/**
	 * Column Info
	 * @return joAdjRmk
	 */
	public String getJoAdjRmk() {
		return this.joAdjRmk;
	}
	 ...
	 * @return joCrrFlag
	 */
	public String getJoCrrFlag() {
		return this.joCrrFlag;
	}
	 ...
	 * @return agmtEffYear
	 */
	public String getAgmtEffYear() {
		return this.agmtEffYear;
	}
	 ...
	 * @return agmtEffMon
	 */
	public String getAgmtEffMon() {
		return this.agmtEffMon;
	}
	 ...
	 * @return joRefCrrCd
	 */
	public String getJoRefCrrCd() {
		return this.joRefCrrCd;
	}
	...
	/**
	 * Column Info
	 * @param jo45ftUndTeuQty
	 */
	public void setJo45ftUndTeuQty(String jo45ftUndTeuQty) {
		this.jo45ftUndTeuQty = jo45ftUndTeuQty;
	}
	...
	/**
	 * Column Info
	 * @param jo45ftOvrTeuQty
	 */
	public void setJo45ftOvrTeuQty(String jo45ftOvrTeuQty) {
		this.jo45ftOvrTeuQty = jo45ftOvrTeuQty;
	}
	...
	/**
	 * Column Info
	 * @param joBsaAdjTeuQty
	 */
	public void setJoBsaAdjTeuQty(String joBsaAdjTeuQty) {
		this.joBsaAdjTeuQty = joBsaAdjTeuQty;
	}
	 ...
	 * @param joBsaAdjWgt
	 */
	public void setJoBsaAdjWgt(String joBsaAdjWgt) {
		this.joBsaAdjWgt = joBsaAdjWgt;
	}
	 ...
	 * @param joAdjRmk
	 */
	public void setJoAdjRmk(String joAdjRmk) {
		this.joAdjRmk = joAdjRmk;
	}
	 ...
	 * @param joCrrFlag
	 */
	public void setJoCrrFlag(String joCrrFlag) {
		this.joCrrFlag = joCrrFlag;
	}
	 ...
	 * @param agmtEffYear
	 */
	public void setAgmtEffYear(String agmtEffYear) {
		this.agmtEffYear = agmtEffYear;
	}
	 ...
	 * @param agmtEffMon
	 */
	public void setAgmtEffMon(String agmtEffMon) {
		this.agmtEffMon = agmtEffMon;
	}
	/**
	 * Column Info
	 * @param joRefCrrCd
	 */
	public void setJoRefCrrCd(String joRefCrrCd) {
		this.joRefCrrCd = joRefCrrCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setJo45ftUndTeuQty(JSPUtil.getParameter(request, prefix + "jo_45ft_und_teu_qty", ""));
		...
		setJo45ftOvrTeuQty(JSPUtil.getParameter(request, prefix + "jo_45ft_ovr_teu_qty", ""));
		...
		setJoBsaAdjTeuQty(JSPUtil.getParameter(request, prefix + "jo_aloc_adj_teu_qty", ""));
		setJoBsaAdjWgt(JSPUtil.getParameter(request, prefix + "jo_aloc_adj_wgt", ""));
		setJoAdjRmk(JSPUtil.getParameter(request, prefix + "jo_aloc_adj_rmk", ""));
		setSkdDirCd(JSPUtil.getParameter(request, prefix + "skd_dir_cd", ""));
		setJoCrrFlag(JSPUtil.getParameter(request, prefix + "jo_crr_flag", ""));
		setAgmtEffYear(JSPUtil.getParameter(request, prefix + "agmt_eff_year", ""));
		setAgmtEffMon(JSPUtil.getParameter(request, prefix + "agmt_eff_mon", ""));
		setJoRefCrrCd(JSPUtil.getParameter(request, prefix + "jo_ref_crr_cd", ""));
	}
	...
	public CusBzcAgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] jo45ftUndTeuQty = (JSPUtil.getParameter(request, prefix	+ "jo_45ft_und_teu_qty", length));
			...
			String[] jo45ftOvrTeuQty = (JSPUtil.getParameter(request, prefix	+ "jo_45ft_ovr_teu_qty", length));
			...
			String[] joBsaAdjTeuQty = (JSPUtil.getParameter(request, prefix	+ "jo_aloc_adj_teu_qty", length));
			String[] joBsaAdjWgt = (JSPUtil.getParameter(request, prefix	+ "jo_aloc_adj_wgt", length));
			String[] joAdjRmk = (JSPUtil.getParameter(request, prefix	+ "jo_aloc_adj_rmk", length));
			String[] skdDirCd = (JSPUtil.getParameter(request, prefix	+ "skd_dir_cd", length));
			String[] joCrrFlag = (JSPUtil.getParameter(request, prefix	+ "jo_crr_flag", length));
			String[] agmtEffYear = (JSPUtil.getParameter(request, prefix	+ "agmt_eff_year", length));
			String[] agmtEffMon = (JSPUtil.getParameter(request, prefix	+ "agmt_eff_mon", length));
			String[] joRefCrrCd = (JSPUtil.getParameter(request, prefix	+ "jo_ref_crr_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new CusBzcAgmtVO();
				if (agmtEffDt[i] != null)
					model.setAgmtEffDt(agmtEffDt[i]);
				if (jo45ftUndTeuQty[i] != null)
					model.setJo45ftUndTeuQty(jo45ftUndTeuQty[i]);
				if (deltFlg[i] != null)
				...
				if (jo45ftOvrTeuQty[i] != null)
					model.setJo45ftOvrTeuQty(jo45ftOvrTeuQty[i]);
				if (ibflag[i] != null)
				...
				if (joBsaAdjTeuQty[i] != null)
					model.setJoBsaAdjTeuQty(joBsaAdjTeuQty[i]);
				if (joBsaAdjWgt[i] != null)
					model.setJoBsaAdjWgt(joBsaAdjWgt[i]);
				if (joAdjRmk[i] != null)
					model.setJoAdjRmk(joAdjRmk[i]);
				if (skdDirCd[i] != null)
					model.setSkdDirCd(skdDirCd[i]);
				if (joCrrFlag[i] != null)
					model.setJoCrrFlag(joCrrFlag[i]);
				if (agmtEffYear[i] != null)
					model.setAgmtEffYear(agmtEffYear[i]);
				if (agmtEffMon[i] != null)
					model.setAgmtEffMon(agmtEffMon[i]);
				if (joRefCrrCd[i] != null)
					model.setJoRefCrrCd(joRefCrrCd[i]);				
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.jo45ftUndTeuQty = this.jo45ftUndTeuQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.jo45ftOvrTeuQty = this.jo45ftOvrTeuQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.joBsaAdjTeuQty = this.joBsaAdjTeuQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.joBsaAdjWgt = this.joBsaAdjWgt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.joAdjRmk = this.joAdjRmk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.skdDirCd = this.skdDirCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.joCrrFlag = this.joCrrFlag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.agmtEffYear = this.agmtEffYear .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.agmtEffMon = this.agmtEffMon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.joRefCrrCd = this.joRefCrrCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
