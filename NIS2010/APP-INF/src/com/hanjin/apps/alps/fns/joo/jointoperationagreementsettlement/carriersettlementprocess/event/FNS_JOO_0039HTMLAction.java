...
*@FileName : FNS_JOO_0039HTMLAction.java
...
public class FNS_JOO_0039HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0039HTMLAction 객체를 생성
	 */
	public FNS_JOO_0039HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0039Event event = new FnsJoo0039Event();
        /**
         *  Retrieve- RLaneCd조회 
         */
		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setStlConditionVO( (StlConditionVO)getVO(request, StlConditionVO .class)   );//조회 옵션
		}
        /**
         *  Change- Check Lane 자료 조회 
         */		
        if(command.isCommand(FormCommand.SEARCHLIST02)) {     
            event.setStlConditionVO( (StlConditionVO)getVO(request, StlConditionVO .class       )   );//조회 옵션
            event.setJooSettlementVOs( (JooSettlementVO[])getVOs(request, JooSettlementVO .class)   );//check 항목.            
        }		
