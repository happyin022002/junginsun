...
*@FileName : FNS_TOT_0020HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0004HTMLAction 객체를 생성
	 */
	public FNS_TOT_0020HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0020Event event = new FnsTot0020Event();
        log.debug("::CALL::> FNS_TOT_0020HTMLAction - " + command.getCommand());
