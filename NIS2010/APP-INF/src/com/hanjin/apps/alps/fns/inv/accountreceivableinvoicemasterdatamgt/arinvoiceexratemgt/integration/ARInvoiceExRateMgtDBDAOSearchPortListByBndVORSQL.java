...
public class ARInvoiceExRateMgtDBDAOSearchPortListByBndVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		A.INV_XCH_RT INV_XCH_RT,--2010-01-09 ivs_xch_rt" ).append("\n"); 
		...
		query.append("#if ((${vps_port_cd} != 'ALL') && (${vps_port_cd} != ''))" ).append("\n"); 
		...
		query.append("	AND B.VPS_ETA_DT BETWEEN TO_DATE(@[etda_dt],'YYYYMMDD') AND TO_DATE(@[etda_dt],'YYYYMMDD') + 0.99999 --20100126 " ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("	AND B.VPS_ETD_DT BETWEEN TO_DATE(@[etda_dt],'YYYYMMDD') AND TO_DATE(@[etda_dt],'YYYYMMDD') + 0.99999 --20100126 " ).append("\n"); 
		query.append("#end" ).append("\n"); 
