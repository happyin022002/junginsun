...
*@FileName : CarrierSettlementProcessDBDAOSettlementRFVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOSettlementRFVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOSettlementRFVORSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAOSettlementRFVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , MAX(NVL(A.RVS_CMB_FLG,'N')) AS RVS_CMB_FLG" ).append("\n"); 
		...
		query.append("     , MAX(DECODE(A.JO_STL_JB_CD,'301',NVL(A.RVS_CMB_FLG,'N'))) AS RVS_CMB_FLG_20" ).append("\n"); 
		query.append("     , MAX(DECODE(A.JO_STL_JB_CD,'302',NVL(A.RVS_CMB_FLG,'N'))) AS RVS_CMB_FLG_40" ).append("\n"); 
		...
		query.append("              B.STL_CMB_SEQ, B.RVS_CMB_FLG, B.SLIP_NO, A.JO_STL_JB_CD, A.USD_SLT_BSA_QTY, A.RF_SCG_PRC, A.STL_LOCL_AMT, A.STL_SEQ, A.STL_DUP_FLG, A.STL_ADJ_FLG, A.STL_LST_FLG," ).append("\n"); 
		...
		query.append("     , A.TO_PORT_CD1" ).append("\n"); 
		query.append("     , A.VVD_SUM_AMT" ).append("\n"); 
		query.append("ORDER  BY A.SKD_DIR_CD, A.VSL_CD, A.SKD_VOY_NO, A.REV_DIR_CD, A.STL_VVD_SEQ" ).append("\n"); 
