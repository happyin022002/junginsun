...
*@FileName : FNS_JOO_0004HTMLAction.java
...
public class FNS_JOO_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0004HTMLAction 객체를 생성
	 */
	public FNS_JOO_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0004Event event = new FnsJoo0004Event();
		
		event.setMstComInputVO((MstComInputVO)getVO(request, MstComInputVO .class));
		event.setJoStlItmCd(request.getParameter("jo_stl_itm_cd"));
		event.setSkdDirCd  (request.getParameter("skd_dir_cd"));

		if(command.isCommand(FormCommand.MULTI)) {
			event.setJooStlBssPortVOS((JooStlBssPortVO[])getVOs(request, JooStlBssPortVO .class,"sheet1_"));
		}
