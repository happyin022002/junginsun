...
*@FileName : JointOperationLetterDBDAORemoveLetterStlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationLetterDBDAORemoveLetterStlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationLetterDBDAORemoveLetterStlDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationLetterDBDAORemoveLetterStlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM JOO_LTR_STL A" ).append("\n"); 
