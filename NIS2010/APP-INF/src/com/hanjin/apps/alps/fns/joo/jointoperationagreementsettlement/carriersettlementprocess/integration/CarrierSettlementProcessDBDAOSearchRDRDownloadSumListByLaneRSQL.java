...
*@FileName : CarrierSettlementProcessDBDAOSearchRDRDownloadSumListByLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOSearchRDRDownloadSumListByLaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOSearchRDRDownloadSumListByLaneRSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAOSearchRDRDownloadSumListByLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(")" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("SELECT  VVD_ETD_GROUP,OPR_CD, VVD, PORT_CD, VPS_ETD_DT, SUM(JO_SHRT_LEG_RMK_TEU_QTY) JO_SHRT_LEG_RMK_TEU_QTY , SUM(JO_SHRT_LEG_RMK_WGT) JO_SHRT_LEG_RMK_WGT," ).append("\n"); 
		query.append("        SUM(JO_SHRT_LEG_RMK_DIFF_QTY) JO_SHRT_LEG_RMK_DIFF_QTY," ).append("\n"); 
		query.append("        SUM(JO_RF_OCN_QTY) JO_RF_OCN_QTY, SUM(JO_RF_IPT_QTY) JO_RF_IPT_QTY, SUM(JO_VOID_TEU_QTY) JO_VOID_TEU_QTY, 'C' JO_SLT_RLSE_CD," ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("        MAX(VSL_CD) VSL_CD, MAX(VOY_NO) VOY_NO, MAX(DIR_CD) DIR_CD, MAX(REGION) REGION, SUM(ALC_ALLOC) ALC_ALLOC," ).append("\n"); 
		query.append("        SUM(ALC_WGT) ALC_WGT, SUM(SWAP_SLOT) SWAP_SLOT, SUM(SWAP_WGT) SWAP_WGT," ).append("\n"); 
		query.append("        SUM(ADJUST_TEU) ADJUST_TEU, SUM(ADJUST_WT) ADJUST_WT, SUM(ACT_SLOT) ACT_SLOT, SUM(ACT_WGT) ACT_WGT, " ).append("\n"); 
		query.append("        CASE" ).append("\n"); 
		query.append("           WHEN SUM (ACT_SLOT) > SUM (ADJUST_TEU) THEN" ).append("\n"); 
		query.append("              SUM (ACT_SLOT) - SUM (ADJUST_TEU)" ).append("\n"); 
		query.append("           ELSE 0" ).append("\n"); 
		query.append("        END OVER_SLOT," ).append("\n"); 
		query.append("        CASE" ).append("\n"); 
		query.append("           WHEN SUM (ACT_WGT) > SUM (ADJUST_WT) THEN" ).append("\n"); 
		query.append("              SUM (ACT_WGT) - SUM (ADJUST_WT)" ).append("\n"); 
		query.append("           ELSE 0" ).append("\n"); 
		query.append("        END OVER_WGT," ).append("\n"); 
		query.append("        SUM(LOAD_20) LOAD_20, SUM(BSA_HC20) BSA_HC20, SUM(LOAD_40) LOAD_40, SUM(BSA_HC40) BSA_HC40, SUM(LOAD_45) LOAD_45, SUM(BSA_45) BSA_45," ).append("\n"); 
		query.append("        SUM(R_O) R_O, SUM(R_I) R_I, SUM(EMPTY_TEU) EMPTY_TEU, SUM(EMPTY_WT) EMPTY_WT, MAX(REMARK) REMARK, MAX(SOURCE) SOURCE, MAX(REMARK_CONT) REMARK_CONT" ).append("\n"); 
		query.append("        " ).append("\n"); 
		query.append("FROM    (" ).append("\n"); 
		query.append("        SELECT  VVD_ETD_GROUP,                " ).append("\n"); 
		query.append("                VSL_CD, VOY_NO, DIR_CD, VVD, REGION, PORT_CD, VPS_ETD_DT, ALC_ALLOC, ALC_WGT, SWAP_SLOT, SWAP_WGT," ).append("\n"); 
		query.append("                JO_SLT_RLSE_CD, ADJUST_TEU, ADJUST_WT, ACT_SLOT, ACT_WGT, OVER_SLOT, OVER_WGT, JO_SHRT_LEG_RMK_TEU_QTY, " ).append("\n"); 
		query.append("                JO_SHRT_LEG_RMK_WGT, JO_SHRT_LEG_RMK_DIFF_QTY, LOAD_20, BSA_HC20, LOAD_40, BSA_HC40, LOAD_45, BSA_45," ).append("\n"); 
		query.append("                R_O, R_I, EMPTY_TEU, EMPTY_WT, REMARK, SOURCE, REMARK_CONT, JO_RF_OCN_QTY, JO_RF_IPT_QTY, JO_VOID_TEU_QTY," ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("                MAX(OPR_CD) KEEP (DENSE_RANK FIRST ORDER BY ACT_SLOT DESC) OVER (PARTITION BY VVD," ).append("\n"); 
		query.append("                                                                                            PORT_CD," ).append("\n"); 
		query.append("                                                                                            VPS_ETD_DT) OPR_CD" ).append("\n"); 
		query.append("        FROM    (" ).append("\n"); 
		...
		query.append("GROUP BY VVD_ETD_GROUP, OPR_CD, VVD,PORT_CD,VPS_ETD_DT" ).append("\n"); 
