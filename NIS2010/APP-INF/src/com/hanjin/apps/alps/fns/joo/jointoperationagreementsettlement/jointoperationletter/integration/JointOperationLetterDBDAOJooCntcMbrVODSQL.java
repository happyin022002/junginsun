...
*@FileName : JointOperationLetterDBDAOJooCntcMbrVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationLetterDBDAOJooCntcMbrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationLetterDBDAOJooCntcMbrVODSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationLetterDBDAOJooCntcMbrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM JOO_CNTC_MBR" ).append("\n"); 
