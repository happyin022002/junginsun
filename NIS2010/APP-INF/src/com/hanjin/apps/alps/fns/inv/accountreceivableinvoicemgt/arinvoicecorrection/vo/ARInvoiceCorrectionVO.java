...
public class ARInvoiceCorrectionVO extends AbstractValueObject {
	...
	//active or invcust chaNge flag
	private String actInvFlag = null;
	
	// other value chaNge flag
	...
	public ARInvoiceCorrectionVO(String ibflag, String pagerows, String arIfNo, String invSplitCd, String blSrcNo, String bkgNo, String bkgNoSplit, String arOfcCd, String actCustCntCd, String actCustSeq, String custLglEngNm, String custRgstNo, String invCustCntCd, String invCustSeq, String crCurrCd, String crAmt, String ibCrTermDys, String obCrTermDys, String crCltOfcCd, String vvd, String svcScpCd, String ioBndCd, String sailArrDt, String trunkVvd, String slanCd, String porCd, String polCd, String podCd, String delCd, String bkgCorrNo, String bkgCorrDt, String hjsStfCtnt, String invRefNo, String bkgRefNo, String siRefNo, String invRmk, String revTpCd, String revSrcCd, String mstBlNo, String rfaNo, String scNo, String srepCd, String cgoWgt, String cgoMeasQty, String whfDeclNo, String whfDeclCfmDt, String bkgTeuQty, String bkgFeuQty, String blInvIfDt, String blInvCfmDt, String glEffDt, String invNo, String issDt, String dueDt, String frtFwrdCntCd, String frtFwrdCustSeq,String custNm,String localVvd,String actInvFlag,String otherFlag, String znIocCd,String vslCd,String skdVoyNo, String skdDirCd, String trnkVslCd, String trnkSkdVoyNo, String trnkSkdDirCd, String whfDecNo,String crFlg,String otsSmryCd  ,String loclCurrCd ,String obrdCd ,String invDeltDivCd, String crTermDys, String custCrFlg,String xchRtN3rdTpCd, String xchRtUsdTpCd, String xchRtDt, String sailDt, String usdXchRt ,String destTrnsSvcModCd ,String invSvcScpCd) {
	...
	/**
	 * @param destTrnsSvcModCd the destTrnsSvcModCd to set
	 */
	...
	/**
	 * @param localVvd the localVvd to set
	 */
	...
	/**
	 * @param trnkVslCd the trnkVslCd to set
	 */
	...
	/**
	 * @param trnkSkdVoyNo the trnkSkdVoyNo to set
	 */
	...
	/**
	 * @param trnkSkdDirCd the trnkSkdDirCd to set
	 */
	...
	/**
	 * @param whfDecNo the whfDecNo to set
	 */
	...
	/**
	 * @param obrdCd the obrdCd to set
	 */
	...
	/**
	 * @param invDeltDivCd the invDeltDivCd to set
	 */
	...
	public void setListInvoiceChargeCorrectionVO(List<ARInvoiceChargeCorrectionVO> listInvoiceChargeCorrectionVO) {
	...
	/**
	 * @param xchRtN3rdTpCd the xchRtN3rdTpCd to set
	 */
	...
	/**
	 * @param xchRtDt the xchRtDt to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setHjsStfCtnt(JSPUtil.getParameter(request, "hjs_stf_ctnt", ""));
		...
		setLocalVvd(JSPUtil.getParameter(request, "local_vvd", ""));
		setActInvFlag(JSPUtil.getParameter(request, "act_inv_flag", ""));
		setOtherFlag(JSPUtil.getParameter(request, "other_flag", ""));
		...
		setObrdCd(JSPUtil.getParameter(request, "obrd_cd", ""));
	...
	public ARInvoiceCorrectionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] hjsStfCtnt = (JSPUtil.getParameter(request, prefix	+ "hjs_stf_ctnt", length));
			...
			String[] localVvd = (JSPUtil.getParameter(request, prefix	+ "local_vvd", length));
			String[] actInvFlag = (JSPUtil.getParameter(request, prefix	+ "act_inv_flag", length));
			...
			String[] obrdCd = (JSPUtil.getParameter(request, prefix	+ "obrd_cd", length));
