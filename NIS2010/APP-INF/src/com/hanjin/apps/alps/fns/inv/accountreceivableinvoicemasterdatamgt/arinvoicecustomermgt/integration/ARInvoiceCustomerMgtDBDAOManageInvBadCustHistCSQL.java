...
*@FileName : ARInvoiceCustomerMgtDBDAOManageInvBadCustHistCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOManageInvBadCustHistCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * INV_BAD_CUST_HIS_PROC 호출
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOManageInvBadCustHistCSQL(){
		setQuery();
		...
		params.put("in_kind",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOManageInvBadCustHistCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL INV_BAD_CUST_HIS_PROC" ).append("\n"); 
		query.append("(@[in_cust_cnt_cd]" ).append("\n"); 
		query.append(",TO_NUMBER(@[in_cust_seq])" ).append("\n"); 
		query.append(",@[in_kind]" ).append("\n"); 
