...
*@FileName : CarrierSettlementProcessDBDAOIntloadSumReportVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOIntloadSumReportVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOIntloadSumReportVOCSQL(){
		setQuery();
		...
		params.put("hid_jo_shrt_leg_rmk_sctr_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hid_jo_shrt_leg_rmk_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("hid_jo_shrt_leg_rmk_teu_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CarrierSettlementProcessDBDAOIntloadSumReportVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    ,JO_SHRT_LEG_RMK_SCTR_NM" ).append("\n"); 
		...
		query.append("    ,@[hid_jo_shrt_leg_rmk_teu_qty]   " ).append("\n"); 
		query.append("    ,@[hid_jo_shrt_leg_rmk_wgt]" ).append("\n"); 
		query.append("    ,@[hid_jo_shrt_leg_rmk_sctr_nm]" ).append("\n"); 
		query.append("    ,@[jo_rf_ocn_qty]" ).append("\n"); 
		query.append("    ,@[jo_rf_ipt_qty]" ).append("\n"); 
		query.append("    ,@[jo_void_teu_qty]" ).append("\n"); 
		query.append("    ,@[jo_aloc_adj_teu_qty]" ).append("\n"); 
