...
public class JointOperationAccrualCreationDBDAOEstmActRsltCreRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("										AND A.BSA_SLT_PRC = B.BSA_SLT_PRC" ).append("\n"); 
		...
		query.append("			        DECODE(B.ADJ_ESTM_FLG, 'Y', " ).append("\n"); 
		query.append("												CASE  WHEN  -50 <=  (B.ADJ_BSA_QTY * B.ADJ_BSA_SLT_PRC) - A.ACT_AMT " ).append("\n"); 
		...
		query.append("																										            DECODE(A.ADJ_ESTM_FLG, 'Y'," ).append("\n"); 
		query.append("																																				CASE  WHEN  -50 <=  (A.ADJ_BSA_QTY * A.ADJ_BSA_SLT_PRC) - A.ACT_AMT " ).append("\n"); 
		...
		query.append("                                   AND A.COST_YRMON BETWEEN TO_CHAR(ADD_MONTHS(TO_DATE(REPLACE(@[rev_yrmon_fr], '-', ''), 'YYYYMM'), -1), 'YYYYMM') " ).append("\n"); 
		query.append("														AND TO_CHAR(ADD_MONTHS(TO_DATE(REPLACE(@[rev_yrmon_to], '-', ''), 'YYYYMM'), +1),'YYYYMM')" ).append("\n"); 
