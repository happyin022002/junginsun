...
/**
 * FNS_INV_0127 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  FNS_INV_0127HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author 9011620
 * @see FNS_INV_0127HTMLAction 참조
 * @since J2EE 1.4
 */

public class FnsInv0127Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	private ARInvoiceBadCustomerHistoryVO arInvoiceBadCustomerHistoryVO = null;
	
	public FnsInv0127Event(){}
