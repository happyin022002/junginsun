...
*@FileName : ARInvoiceCorrectionDBDAOInvIssAtchVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOInvIssAtchVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOInvIssAtchVOUSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOInvIssAtchVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE INV_ISS_ATCH" ).append("\n"); 
