...
public class CarFinanMtrxVO extends AbstractValueObject {
	...
	/* Column Info */
	private String chgOfcGubun = null;	
	/* Column Info */
	private String stlPicNm = null;	
	/* Column Info */
	private String ofcCd = null;	
	/* Column Info */
	private String trdCd = null;
	/* Column Info */
	private String stlPicSeq = null;	
	...
	public CarFinanMtrxVO(String ibflag, String pagerows, String joCrrCd, String rlaneCd, String reDivrCd, String joStlItmCd, String custSeq, String drAcctCd, String drCtrCd, String drLocCd, String crAcctCd, String crCtrCd, String crLocCd, String joStlItmNm, String loclCurrCd, String usrId, String chgOfcGubun, String stlPicNm, String ofcCd, String trdCd, String stlPicSeq) {
		...
		this.chgOfcGubun = chgOfcGubun;		
		this.ofcCd = ofcCd;
		this.stlPicNm = stlPicNm;
		this.trdCd = trdCd;	
		this.stlPicSeq = stlPicSeq;		
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("chg_ofc_gubun", getChgOfcGubun());
		this.hashColumns.put("ofc_cd", getOfcCd());
		this.hashColumns.put("stl_pic_nm", getStlPicNm());		
		this.hashColumns.put("trd_cd", getTrdCd());		
		this.hashColumns.put("stl_pic_seq", getStlPicSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("chg_ofc_gubun", "chgOfcGubun");		
		this.hashFields.put("ofc_cd", "ofcCd");
		this.hashFields.put("stl_pic_nm", "stlPicNm");
		this.hashFields.put("trd_cd", "trdCd");
		this.hashFields.put("stl_pic_seq", "stlPicSeq");		
	...
	public String getChgOfcGubun() {
		return this.chgOfcGubun;
	}		
	public String getOfcCd() {
		return this.ofcCd;
	}
	public String getStlPicNm() {
		return this.stlPicNm;
	}
	public String getTrdCd() {
		return this.trdCd;
	}
	public String getStlPicSeq() {
		return this.stlPicSeq;
	}
	...
	public void setStlPicNm(String stlPicNm) {
		this.stlPicNm = stlPicNm;
	}
	...
	public void setStlPicSeq(String stlPicSeq) {
		this.stlPicSeq = stlPicSeq;
	}
	 ...
	 * @param chgOfcGubun
	 */
	public void setChgOfcGubun(String chgOfcGubun) {
		this.chgOfcGubun = chgOfcGubun;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setChgOfcGubun(JSPUtil.getParameter(request, "chg_ofc_gubun", ""));		
		setOfcCd(JSPUtil.getParameter(request, "ofc_cd", ""));
		setStlPicNm(JSPUtil.getParameter(request, "stl_pic_nm", ""));		
		setTrdCd(JSPUtil.getParameter(request, "trd_cd", ""));		
		setStlPicSeq(JSPUtil.getParameter(request, "stl_pic_seq", ""));		
	}
	...
	public CarFinanMtrxVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] chgOfcGubun = (JSPUtil.getParameter(request, prefix	+ "chg_ofc_gubun", length));			
			String[] ofcCd = (JSPUtil.getParameter(request, prefix	+ "ofc_cd", length));
			String[] stlPicNm = (JSPUtil.getParameter(request, prefix	+ "stl_pic_nm", length));
			String[] trdCd = (JSPUtil.getParameter(request, prefix	+ "trd_cd", length));			
			String[] stlPicSeq = (JSPUtil.getParameter(request, prefix	+ "stl_pic_seq", length));			
			...
			for (int i = 0; i < length; i++) {
				...
				if (chgOfcGubun[i] != null)
					model.setChgOfcGubun(chgOfcGubun[i]);
				if (ofcCd[i] != null)
					model.setOfcCd(ofcCd[i]);
				if (stlPicNm[i] != null)
					model.setStlPicNm(stlPicNm[i]);
				if (trdCd[i] != null)
					model.setTrdCd(trdCd[i]);
				if (stlPicSeq[i] != null)
					model.setStlPicSeq(stlPicSeq[i]);				
				models.add(model);
			}
	...
	*/
	public void onDataFormat(){
		...
		this.chgOfcGubun = this.chgOfcGubun .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
		this.ofcCd = this.ofcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.stlPicNm = this.stlPicNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
		this.trdCd = this.trdCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
		this.stlPicSeq = this.stlPicSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
	}
}
