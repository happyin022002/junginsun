...
*@FileName : MakeVODAOMcsCombinedRSQL.java
*@FileTitle : dddd
*Open Issues :
*Change history :
...
public class MakeVODAOMcsCombinedRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MakeVODAOMcsCombinedRSQL(){
		setQuery();
		...
		query.append("FileName : MakeVODAOMcsCombinedRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  ''STL_RMK," ).append("\n"); 
