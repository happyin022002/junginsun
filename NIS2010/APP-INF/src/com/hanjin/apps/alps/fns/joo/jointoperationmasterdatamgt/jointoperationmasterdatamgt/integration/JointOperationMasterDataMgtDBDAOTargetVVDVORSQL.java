...
public class JointOperationMasterDataMgtDBDAOTargetVVDVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        AND	T.REV_DIR_CD = A.REV_DIR_CD" ).append("\n"); 
		query.append("        AND T.RE_DIVR_CD = A.RE_DIVR_CD" ).append("\n"); 
		query.append("        AND T.JO_STL_ITM_CD = A.JO_STL_ITM_CD" ).append("\n"); 
		query.append("        AND T.RLANE_CD = A.RLANE_CD" ).append("\n"); 
		query.append("        AND T.JO_CRR_CD = A.JO_CRR_CD" ).append("\n"); 
