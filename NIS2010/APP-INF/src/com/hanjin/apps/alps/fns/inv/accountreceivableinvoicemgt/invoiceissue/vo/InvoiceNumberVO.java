...
public class InvoiceNumberVO extends AbstractValueObject {
	...
	public InvoiceNumberVO(String ibflag, String pagerows, String invPfxCd, String invMaxSeq, String invNo, String wrkNo, String issDt) {
		this.invNo = invNo;
		this.wrkNo = wrkNo;
		this.issDt = issDt;
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setWrkNo(JSPUtil.getParameter(request, "wrk_no", ""));
	...
	public InvoiceNumberVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] wrkNo = (JSPUtil.getParameter(request, prefix	+ "wrk_no", length));
