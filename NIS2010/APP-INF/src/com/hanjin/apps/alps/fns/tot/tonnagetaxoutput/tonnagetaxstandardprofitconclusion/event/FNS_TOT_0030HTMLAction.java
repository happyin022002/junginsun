...
*@FileName : FNS_TOT_0030HTMLAction.java
...
public class FNS_TOT_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0001HTMLAction 객체를 생성
	 */
	public FNS_TOT_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0030Event event = new FnsTot0030Event();
        log.debug("::CALL::> FNS_TOT_0030HTMLAction - " + command.getCommand());
