...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Unused Vessel Over 30 Days insert
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOCSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[stl_yr]" ).append("\n"); 
		query.append(",	@[vsl_cd]" ).append("\n"); 
		query.append(",	(SELECT NVL(MAX(VSL_SEQ)+1,1) FROM TOT_VESSEL WHERE VSL_CD = @[vsl_cd] AND STL_YR = @[stl_yr])" ).append("\n"); 
