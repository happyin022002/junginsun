...
*@FileName : JOO_EXCELHTMLAction.java
*@FileTitle : sdf
*Open Issues :
*Change history :
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.fns.joo.a 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class FNS_JOO_EXCELHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * JOO_EXCELHTMLAction 객체를 생성
	 */
	public FNS_JOO_EXCELHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJooExcelEvent event = new FnsJooExcelEvent();
