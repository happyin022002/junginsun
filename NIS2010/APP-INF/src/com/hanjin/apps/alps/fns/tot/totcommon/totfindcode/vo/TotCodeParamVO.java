...
public class TotCodeParamVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TotCodeParamVO> models = new ArrayList<TotCodeParamVO>();
	...
	public TotCodeParamVO() {}

	public TotCodeParamVO(String ibflag, String pagerows, String code, String name, String superCd1, String superCd2, String sortKey) {
		this.code = code;
		this.ibflag = ibflag;
	...
	public TotCodeParamVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public TotCodeParamVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TotCodeParamVO model = null;
	...
	public TotCodeParamVO[] getJooCodeParamVOs(){
		TotCodeParamVO[] vos = (TotCodeParamVO[])models.toArray(new TotCodeParamVO[models.size()]);
		return vos;
	}
