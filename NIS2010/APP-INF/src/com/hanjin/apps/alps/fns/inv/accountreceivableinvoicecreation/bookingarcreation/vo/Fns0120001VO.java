...
public class Fns0120001VO extends AbstractValueObject {
	...
	/* Column Info */
	private String whfDecDt = null;
	/* Column Info */
	private String whfDecVvd = null;
	/* Column Info */
	...
	public Fns0120001VO(String ibflag, String pagerows, String crInvNo, String lifid, String seq, String totalCount, String rowCount, String flag, String mainIfNo, String mainIfSer, String blNo, String blNoTp, String bkgNo, String source, String transTyp, String invNo, String caNo, String caDt, String rhq, String ofc, String actCntryCd, String actCustCd, String invCntryCd, String invCustCd, String vsl, String voy, String dir, String tVvd, String revVsl, String revVoy, String revDir, String saDt, String por, String pol, String pod, String del, String scp, String lane, String bnd, String creditMk, String slsmanCd, String dueDt, String usdAmt, String lclAmt, String whfDecNo, String siRefNo, String cttDecNo, String zoneIoc, String ifFlag, String erpIfDt, String invCoaCompany, String invCoaRegion, String invCoaCenter, String invCoaAccount, String invCoaInterCompany, String invCoaVvd, String invCoaFuture1, String invCoaFuture2, String revLane, String contNo, String creditTerm, String sailingDt, String glDt, String exRateType, String exRateCustDate, String setoffNo, String custRefNo, String hjsRefNo, String taxExRate, String taxInd, String onboardDt, String oblMk, String ctyCd, String salesOfc, String rmk, String curr, String userId, String logRgstDt, String logUpdtDt, String issDt, String slipNo, String joInd, String dtlIfNo, String dtlIfSer, String chgSeq, String chgTyp, String repChgTyp, String chgCur, String revTyp, String chgAmt, String taxAmt, String revCoaCompany, String revCoaRegion, String revCoaCenter, String revCoaAccount, String revCoaInterCompany, String revCoaVvd, String revCoaFuture1, String revCoaFuture2, String oriChgCur, String oriChgAmt, String revEffDt, String perTyp, String rate, String ratedAs, String sobId, String chgFullNm, String acct, String cntrNo, String cntrTpSz, String rfaNo, String thirdExRateType, String whfDecDt, String whfDecVvd, String whfDecOfc, String whfMrnNo, String whfNtcNo, String whfFlag, String whfCsrNo, String ctrtOfcCd, String whfDeclCxlFlg,  String rtAplyDt) {
		...
		this.flag = flag;
		this.revVoy = revVoy;
		this.whfDecDt = whfDecDt;
		this.whfDecVvd = whfDecVvd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("whf_csr_no", getWhfCsrNo());
		...
		this.hashColumns.put("whf_flag", getWhfFlag());
		...
		this.hashColumns.put("whf_dec_ofc", getWhfDecOfc());
		...
		this.hashColumns.put("whf_dec_dt", getWhfDecDt());
		this.hashColumns.put("whf_dec_vvd", getWhfDecVvd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("whf_csr_no", "whfCsrNo");
		...
		this.hashFields.put("whf_flag", "whfFlag");
		...
		this.hashFields.put("whf_dec_ofc", "whfDecOfc");
		...
		this.hashFields.put("whf_dec_dt", "whfDecDt");
		this.hashFields.put("whf_dec_vvd", "whfDecVvd");
	...
	/**
	 * @param whfDeclCxlFlg the whfDeclCxlFlg to set
	 */
	 ...
	 * @return whfCsrNo
	 */
	public String getWhfCsrNo() {
		return this.whfCsrNo;
	}
	 ...
	 * @return whfDecOfc
	 */
	public String getWhfDecOfc() {
		return this.whfDecOfc;
	}
	 ...
	 * @return whfDecDt
	 */
	public String getWhfDecDt() {
		return this.whfDecDt;
	}
	 ...
	 * @return whfDecVvd
	 */
	public String getWhfDecVvd() {
		return this.whfDecVvd;
	}
	 ...
	 * @param whfCsrNo
	 */
	public void setWhfCsrNo(String whfCsrNo) {
		this.whfCsrNo = whfCsrNo;
	}
	 ...
	 * @param whfFlag
	 */
	public void setWhfFlag(String whfFlag) {
		this.whfFlag = whfFlag;
	}
	 ...
	 * @param whfDecOfc
	 */
	public void setWhfDecOfc(String whfDecOfc) {
		this.whfDecOfc = whfDecOfc;
	}
	 ...
	 * @param whfDecDt
	 */
	public void setWhfDecDt(String whfDecDt) {
		this.whfDecDt = whfDecDt;
	}
	 ...
	 * @param whfDecVvd
	 */
	public void setWhfDecVvd(String whfDecVvd) {
		this.whfDecVvd = whfDecVvd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setLogRgstDt(JSPUtil.getParameter(request, prefix + "log_rgst_dt", ""));
		setInvCntryCd(JSPUtil.getParameter(request, prefix + "inv_cntry_cd", ""));
		setSlipNo(JSPUtil.getParameter(request, prefix + "slip_no", ""));
		setRatedAs(JSPUtil.getParameter(request, prefix + "rated_as", ""));
		setPor(JSPUtil.getParameter(request, prefix + "por", ""));
		setRevDir(JSPUtil.getParameter(request, prefix + "rev_dir", ""));
		setWhfCsrNo(JSPUtil.getParameter(request, prefix + "whf_csr_no", ""));
		setRevEffDt(JSPUtil.getParameter(request, prefix + "rev_eff_dt", ""));
		setRowCount(JSPUtil.getParameter(request, prefix + "row_count", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setZoneIoc(JSPUtil.getParameter(request, prefix + "zone_ioc", ""));
		setOriChgAmt(JSPUtil.getParameter(request, prefix + "ori_chg_amt", ""));
		setTVvd(JSPUtil.getParameter(request, prefix + "t_vvd", ""));
		setCtrtOfcCd(JSPUtil.getParameter(request, prefix + "ctrt_ofc_cd", ""));
		setRevCoaCenter(JSPUtil.getParameter(request, prefix + "rev_coa_center", ""));
		...
		setRevCoaCompany(JSPUtil.getParameter(request, prefix + "rev_coa_company", ""));
		setTaxInd(JSPUtil.getParameter(request, prefix + "tax_ind", ""));
		setPod(JSPUtil.getParameter(request, prefix + "pod", ""));
		setRhq(JSPUtil.getParameter(request, prefix + "rhq", ""));
		setPerTyp(JSPUtil.getParameter(request, prefix + "per_typ", ""));
		setChgFullNm(JSPUtil.getParameter(request, prefix + "chg_full_nm", ""));
		setSalesOfc(JSPUtil.getParameter(request, prefix + "sales_ofc", ""));
		setLogUpdtDt(JSPUtil.getParameter(request, prefix + "log_updt_dt", ""));
		setRevVsl(JSPUtil.getParameter(request, prefix + "rev_vsl", ""));
		setWhfFlag(JSPUtil.getParameter(request, prefix + "whf_flag", ""));
		...
		setInvCoaAccount(JSPUtil.getParameter(request, prefix + "inv_coa_account", ""));
		setCtyCd(JSPUtil.getParameter(request, prefix + "cty_cd", ""));
		setInvCoaFuture1(JSPUtil.getParameter(request, prefix + "inv_coa_future1", ""));
		setTaxExRate(JSPUtil.getParameter(request, prefix + "tax_ex_rate", ""));
		setInvCoaFuture2(JSPUtil.getParameter(request, prefix + "inv_coa_future2", ""));
		setInvCustCd(JSPUtil.getParameter(request, prefix + "inv_cust_cd", ""));
		setRevCoaAccount(JSPUtil.getParameter(request, prefix + "rev_coa_account", ""));
		setSetoffNo(JSPUtil.getParameter(request, prefix + "setoff_no", ""));
		setChgCur(JSPUtil.getParameter(request, prefix + "chg_cur", ""));
		setOblMk(JSPUtil.getParameter(request, prefix + "obl_mk", ""));
		...
		setInvCoaInterCompany(JSPUtil.getParameter(request, prefix + "inv_coa_inter_company", ""));
		...
		setRevCoaFuture2(JSPUtil.getParameter(request, prefix + "rev_coa_future2", ""));
		setRevCoaFuture1(JSPUtil.getParameter(request, prefix + "rev_coa_future1", ""));
		setWhfMrnNo(JSPUtil.getParameter(request, prefix + "whf_mrn_no", ""));
		setErpIfDt(JSPUtil.getParameter(request, prefix + "erp_if_dt", ""));
		setThirdExRateType(JSPUtil.getParameter(request, prefix + "third_ex_rate_type", ""));
		setInvNo(JSPUtil.getParameter(request, prefix + "inv_no", ""));
		setUsdAmt(JSPUtil.getParameter(request, prefix + "usd_amt", ""));
		setWhfDecOfc(JSPUtil.getParameter(request, prefix + "whf_dec_ofc", ""));
		setMainIfSer(JSPUtil.getParameter(request, prefix + "main_if_ser", ""));
		setCntrNo(JSPUtil.getParameter(request, prefix + "cntr_no", ""));
		setChgTyp(JSPUtil.getParameter(request, prefix + "chg_typ", ""));
		setInvCoaCenter(JSPUtil.getParameter(request, prefix + "inv_coa_center", ""));
		setScp(JSPUtil.getParameter(request, prefix + "scp", ""));
		setGlDt(JSPUtil.getParameter(request, prefix + "gl_dt", ""));
		setRevCoaVvd(JSPUtil.getParameter(request, prefix + "rev_coa_vvd", ""));
		setBlNo(JSPUtil.getParameter(request, prefix + "bl_no", ""));
		setRevCoaRegion(JSPUtil.getParameter(request, prefix + "rev_coa_region", ""));
		setCreditMk(JSPUtil.getParameter(request, prefix + "credit_mk", ""));
		setRepChgTyp(JSPUtil.getParameter(request, prefix + "rep_chg_typ", ""));
		setTransTyp(JSPUtil.getParameter(request, prefix + "trans_typ", ""));
		setUserId(JSPUtil.getParameter(request, prefix + "user_id", ""));
		setBlNoTp(JSPUtil.getParameter(request, prefix + "bl_no_tp", ""));
		setInvCoaVvd(JSPUtil.getParameter(request, prefix + "inv_coa_vvd", ""));
		...
		setDtlIfNo(JSPUtil.getParameter(request, prefix + "dtl_if_no", ""));
		setDtlIfSer(JSPUtil.getParameter(request, prefix + "dtl_if_ser", ""));
		setIfFlag(JSPUtil.getParameter(request, prefix + "if_flag", ""));
		setFlag(JSPUtil.getParameter(request, prefix + "flag", ""));
		setRevVoy(JSPUtil.getParameter(request, prefix + "rev_voy", ""));
		setWhfDecDt(JSPUtil.getParameter(request, prefix + "whf_dec_dt", ""));
		setWhfDecVvd(JSPUtil.getParameter(request, prefix + "whf_dec_vvd", ""));
		setOnboardDt(JSPUtil.getParameter(request, prefix + "onboard_dt", ""));
		setJoInd(JSPUtil.getParameter(request, prefix + "jo_ind", ""));
		setActCntryCd(JSPUtil.getParameter(request, prefix + "act_cntry_cd", ""));
		setInvCoaRegion(JSPUtil.getParameter(request, prefix + "inv_coa_region", ""));
		setChgSeq(JSPUtil.getParameter(request, prefix + "chg_seq", ""));
		setRevCoaInterCompany(JSPUtil.getParameter(request, prefix + "rev_coa_inter_company", ""));
		...
		setMainIfNo(JSPUtil.getParameter(request, prefix + "main_if_no", ""));
		setTotalCount(JSPUtil.getParameter(request, prefix + "total_count", ""));
		setContNo(JSPUtil.getParameter(request, prefix + "cont_no", ""));
		setSlsmanCd(JSPUtil.getParameter(request, prefix + "slsman_cd", ""));
		setExRateType(JSPUtil.getParameter(request, prefix + "ex_rate_type", ""));
		setSobId(JSPUtil.getParameter(request, prefix + "sob_id", ""));
		setRevLane(JSPUtil.getParameter(request, prefix + "rev_lane", ""));
		setInvCoaCompany(JSPUtil.getParameter(request, prefix + "inv_coa_company", ""));
		setVoy(JSPUtil.getParameter(request, prefix + "voy", ""));
		setRevTyp(JSPUtil.getParameter(request, prefix + "rev_typ", ""));
		setOriChgCur(JSPUtil.getParameter(request, prefix + "ori_chg_cur", ""));
		setCreditTerm(JSPUtil.getParameter(request, prefix + "credit_term", ""));
		...
		setExRateCustDate(JSPUtil.getParameter(request, prefix + "ex_rate_cust_date", ""));
		setCttDecNo(JSPUtil.getParameter(request, prefix + "ctt_dec_no", ""));
		setOfc(JSPUtil.getParameter(request, prefix + "ofc", ""));
	...
	public Fns0120001VO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] whfCsrNo = (JSPUtil.getParameter(request, prefix	+ "whf_csr_no", length));
			...
			String[] whfFlag = (JSPUtil.getParameter(request, prefix	+ "whf_flag", length));
			...
			String[] whfDecOfc = (JSPUtil.getParameter(request, prefix	+ "whf_dec_ofc", length));
			...
			String[] whfDecDt = (JSPUtil.getParameter(request, prefix	+ "whf_dec_dt", length));
			String[] whfDecVvd = (JSPUtil.getParameter(request, prefix	+ "whf_dec_vvd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (whfDecOfc[i] != null)
					model.setWhfDecOfc(whfDecOfc[i]);
				if (mainIfSer[i] != null)
				...
				if (whfDecDt[i] != null)
					model.setWhfDecDt(whfDecDt[i]);
				if (whfDecVvd[i] != null)
					model.setWhfDecVvd(whfDecVvd[i]);
				if (onboardDt[i] != null)
	...
	*/ 
	public void unDataFormat(){
		...
		this.whfCsrNo = this.whfCsrNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.whfFlag = this.whfFlag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.whfDecOfc = this.whfDecOfc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.whfDecDt = this.whfDecDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.whfDecVvd = this.whfDecVvd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
