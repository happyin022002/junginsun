...
public class JoEstmConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<JoEstmConditionVO> models = new ArrayList<JoEstmConditionVO>();
	...
	public JoEstmConditionVO() {}

	public JoEstmConditionVO(String ibflag, String pagerows, String exeYrmon, String revYrmonFr, String revYrmonTo, String reDivrCd, String trdCd, String rlaneCd, String joCrrCd, String joStlJbCd, String diffOption, String vvd, String estmCondFlg) {
	 ...
	 */
	public JoEstmConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EstmConditionVO[]
	 */
	public JoEstmConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JoEstmConditionVO model = null;
	 ...
	 * @return EstmConditionVO[]
	 */
	public JoEstmConditionVO[] getJoEstmConditionVOs(){
		JoEstmConditionVO[] vos = (JoEstmConditionVO[])models.toArray(new JoEstmConditionVO[models.size()]);
		return vos;
	}
