...
public class CsrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CsrVO> models = new ArrayList<CsrVO>();
	...
	/* Column Info */
	private String atchFileCnt = null;		
	/* Column Info */
	private String gwCtrtCnt = null;		
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("atch_file_cnt", getAtchFileCnt());		
		this.hashColumns.put("gw_ctrt_cnt", getGwCtrtCnt());		
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("atch_file_cnt", "atchFileCnt");		
		this.hashFields.put("gw_ctrt_cnt", "gwCtrtCnt");		
	 ...
	 * @return gwCtrtCnt
	 */
	public String getGwCtrtCnt() {
		return this.gwCtrtCnt;
	}
	 ...
	 * @param gwCtrtCnt
	 */
	public void setGwCtrtCnt(String gwCtrtCnt) {
		this.gwCtrtCnt = gwCtrtCnt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAtchFileCnt(JSPUtil.getParameter(request, "atch_file_cnt", ""));		
		setGwCtrtCnt(JSPUtil.getParameter(request, "gw_ctrt_cnt", ""));		
	 ...
	 * @return CsrVO[]
	 */
	public CsrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CsrVO[]
	 */
	public CsrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CsrVO model = null;
		...
		try {
			...
			String[] atchFileCnt = (JSPUtil.getParameter(request, prefix	+ "atch_file_cnt", length));			
			String[] gwCtrtCnt = (JSPUtil.getParameter(request, prefix	+ "gw_ctrt_cnt", length));			
			...
			for (int i = 0; i < length; i++) {
				...
				if (atchFileCnt[i] != null)
					model.setAtchFileCnt(atchFileCnt[i]);
				if (gwCtrtCnt[i] != null)
					model.setGwCtrtCnt(gwCtrtCnt[i]);
	...
	public CsrVO[] getCsrVOs(){
		CsrVO[] vos = (CsrVO[])models.toArray(new CsrVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.atchFileCnt = this.atchFileCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
		this.gwCtrtCnt = this.gwCtrtCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
	}
}
