...
*@FileName : SettlementProcessDBDAOexecuteJELProcedureRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOexecuteJELProcedureRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOexecuteJELProcedureRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOexecuteJELProcedureRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL JOO_ROB_CNTR_SMRY_PAS_PRC( @[pre_fr], @[pre_to], @[rlane_cd], @[p_error_code])" ).append("\n"); 
