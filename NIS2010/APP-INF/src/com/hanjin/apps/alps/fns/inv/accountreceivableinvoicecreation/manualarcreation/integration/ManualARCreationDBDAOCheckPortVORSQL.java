...
*@FileName : ManualARCreationDBDAOCheckPortVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualARCreationDBDAOCheckPortVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ManualARCreationDBDAOCheckPortVORSQL
	  * </pre>
	  */
	public ManualARCreationDBDAOCheckPortVORSQL(){
		setQuery();
		...
		query.append("FileName : ManualARCreationDBDAOCheckPortVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
