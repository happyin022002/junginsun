...
public class FileUploadListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String joAgmtFileTpCd = null;	
	...
	public FileUploadListVO(String ibflag, String pagerows, String joCrrCd, String crrCntcSeq, String fileSavId, String fileNm, String fileDownload, String updDt, String updUsrId, String csrNo, String fileSeq, String joAgmtFileTpCd) {
		this.updDt = updDt;
		...
		this.joAgmtFileTpCd = joAgmtFileTpCd;		
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("jo_agmt_file_tp_cd", getJoAgmtFileTpCd());		
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("jo_agmt_file_tp_cd", "joAgmtFileTpCd");		
	...
	/**
	 * Column Info
	 * @return joAgmtFileTpCd
	 */
	public String getJoAgmtFileTpCd() {
		return this.joAgmtFileTpCd;
	}	
	...
	/**
	 * Column Info
	 * @param joAgmtFileTpCd
	 */
	public void setJoAgmtFileTpCd(String joAgmtFileTpCd) {
		this.joAgmtFileTpCd = joAgmtFileTpCd;
	}	
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setJoAgmtFileTpCd(JSPUtil.getParameter(request, prefix + "jo_agmt_file_tp_cd", ""));		
	}
	...
	public FileUploadListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] joAgmtFileTpCd = (JSPUtil.getParameter(request, prefix	+ "jo_agmt_file_tp_cd", length));			
			...
			for (int i = 0; i < length; i++) {
				...
				if (joAgmtFileTpCd[i] != null)
					model.setJoAgmtFileTpCd(joAgmtFileTpCd[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.joAgmtFileTpCd = this.joAgmtFileTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");		
	}
}
