...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE TOT_LANE_TRD SET" ).append("\n"); 
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}