...
public class CarrierSettlementProcessDBDAOCreRfRdrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("              B.STL_CMB_SEQ, B.SLIP_NO, A.JO_STL_JB_CD, A.USD_SLT_BSA_QTY, A.RF_SCG_PRC, A.STL_LOCL_AMT, A.STL_SEQ, A.STL_DUP_FLG, A.STL_ADJ_FLG, A.STL_LST_FLG, B.RVS_CMB_FLG," ).append("\n"); 
