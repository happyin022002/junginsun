...
*@FileName : HNWLEdiBkgCustVO.java
*@FileTitle : HNWLEdiBkgCustVO
*Open Issues :
*Change history :
...
public class HNWLEdiBkgCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<HNWLEdiBkgCustVO> models = new ArrayList<HNWLEdiBkgCustVO>();
	
	/* Column Info */
	private String ffwdStatCd = null;
	/* Column Info */
	private String ffwdZipCd = null;
	/* Column Info */
	private String ffwdCityNm = null;
	/* Column Info */
	private String ffwdCntCd = null;
	/* Column Info */
	...
	public HNWLEdiBkgCustVO(String ibflag, String pagerows, String shpr1, String shpr2, String shpr3, String shpr4, String shpr5, String shprCityNm, String shprStatCd, String shprZipCd, String shprCntCd, String shprCd, String cnee1, String cnee2, String cnee3, String cnee4, String cnee5, String cneeCityNm, String cneeStatCd, String cneeZipCd, String cneeCntCd, String cneeCd, String ntfy1, String ntfy2, String ntfy3, String ntfy4, String ntfy5, String ntfyCityNm, String ntfyStatCd, String ntfyZipCd, String ntfyCntCd, String ntfyCd, String ffwd1, String ffwd2, String ffwd3, String ffwd4, String ffwd5, String ffwdCityNm, String ffwdStatCd, String ffwdZipCd, String ffwdCntCd, String ffwdCd) {
		...
		this.ntfy2 = ntfy2;
		this.ntfy1 = ntfy1;
		this.ffwdStatCd = ffwdStatCd;
		this.ffwdZipCd = ffwdZipCd;
		this.ffwdCityNm = ffwdCityNm;
		this.ffwdCntCd = ffwdCntCd;
		this.ffwdCd = ffwdCd;
		this.ffwd5 = ffwd5;
		this.ffwd4 = ffwd4;
		this.ffwd3 = ffwd3;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ffwd_stat_cd", getFfwdStatCd());
		this.hashColumns.put("ffwd_zip_cd", getFfwdZipCd());
		this.hashColumns.put("ffwd_city_nm", getFfwdCityNm());
		this.hashColumns.put("ffwd_cnt_cd", getFfwdCntCd());
		this.hashColumns.put("ffwd_cd", getFfwdCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ffwd_stat_cd", "ffwdStatCd");
		this.hashFields.put("ffwd_zip_cd", "ffwdZipCd");
		this.hashFields.put("ffwd_city_nm", "ffwdCityNm");
		this.hashFields.put("ffwd_cnt_cd", "ffwdCntCd");
		this.hashFields.put("ffwd_cd", "ffwdCd");
	 ...
	 * @param ffwdStatCd
	 */
	public void setFfwdStatCd(String ffwdStatCd) {
		this.ffwdStatCd = ffwdStatCd;
	}
	 ...
	 * @param ffwdZipCd
	 */
	public void setFfwdZipCd(String ffwdZipCd) {
		this.ffwdZipCd = ffwdZipCd;
	}
	 ...
	 * @param ffwdCityNm
	 */
	public void setFfwdCityNm(String ffwdCityNm) {
		this.ffwdCityNm = ffwdCityNm;
	}
	 ...
	 * @param ffwdCntCd
	 */
	public void setFfwdCntCd(String ffwdCntCd) {
		this.ffwdCntCd = ffwdCntCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setFfwdZipCd(JSPUtil.getParameter(request, prefix + "ffwd_zip_cd", ""));
		setFfwdCityNm(JSPUtil.getParameter(request, prefix + "ffwd_city_nm", ""));
		setFfwdStatCd(JSPUtil.getParameter(request, prefix + "ffwd_stat_cd", ""));
		setFfwdCntCd(JSPUtil.getParameter(request, prefix + "ffwd_cnt_cd", ""));
		setFfwdCd(JSPUtil.getParameter(request, prefix + "ffwd_cd", ""));
	 ...
	 */
	public HNWLEdiBkgCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return HNWLEdiBkgCustVO[]
	 */
	public HNWLEdiBkgCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		HNWLEdiBkgCustVO model = null;
		...
		try {
			...
			String[] ffwdZipCd = (JSPUtil.getParameter(request, prefix	+ "ffwd_zip_cd", length));
			String[] ffwdCityNm = (JSPUtil.getParameter(request, prefix	+ "ffwd_city_nm", length));
			String[] ffwdStatCd = (JSPUtil.getParameter(request, prefix	+ "ffwd_stat_cd", length));
			String[] ffwdCntCd = (JSPUtil.getParameter(request, prefix	+ "ffwd_cnt_cd", length));
			String[] ffwdCd = (JSPUtil.getParameter(request, prefix	+ "ffwd_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ffwdZipCd[i] != null)
					model.setFfwdZipCd(ffwdZipCd[i]);
				if (ffwdCityNm[i] != null)
					model.setFfwdCityNm(ffwdCityNm[i]);
				if (ffwdStatCd[i] != null)
					model.setFfwdStatCd(ffwdStatCd[i]);
				if (ffwdCntCd[i] != null)
					model.setFfwdCntCd(ffwdCntCd[i]);
				if (ffwdCd[i] != null)
	 ...
	 */
	public HNWLEdiBkgCustVO[] getHNWLEdiBkgCustVOs(){
		HNWLEdiBkgCustVO[] vos = (HNWLEdiBkgCustVO[])models.toArray(new HNWLEdiBkgCustVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ffwdZipCd = this.ffwdZipCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ffwdCityNm = this.ffwdCityNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ffwdStatCd = this.ffwdStatCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ffwdCntCd = this.ffwdCntCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
