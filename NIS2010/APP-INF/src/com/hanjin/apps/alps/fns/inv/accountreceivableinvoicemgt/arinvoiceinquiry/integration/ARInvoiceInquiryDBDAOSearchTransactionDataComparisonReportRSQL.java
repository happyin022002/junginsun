...
public class ARInvoiceInquiryDBDAOSearchTransactionDataComparisonReportRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", (SELECT MAX(ACCT_KRN_NM) FROM MDM_ACCOUNT WHERE ACCT_CD = C.INV_COA_ACCT_CD) ACCT_KRN_NM" ).append("\n"); 
		...
		query.append(", (SELECT MAX(ACCT_KRN_NM) FROM MDM_ACCOUNT WHERE ACCT_CD = B.REV_COA_ACCT_CD) ACCT_KRN_NM" ).append("\n"); 
		query.append(", C.CURR_CD CURR_CD" ).append("\n"); 
