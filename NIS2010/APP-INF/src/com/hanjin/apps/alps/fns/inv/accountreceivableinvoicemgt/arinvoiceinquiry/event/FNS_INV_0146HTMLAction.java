...
*@FileName : FNS_INV_0146HTMLAction.java
...
public class FNS_INV_0146HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0146HTMLAction 객체를 생성
	 */
	public FNS_INV_0146HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0146Event event = new FnsInv0146Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			String locCd = request.getParameter("loc_cd");
			String reExCd = request.getParameter("re_ex_cd");
			event.setLocCd(locCd);
			event.setReExCd(reExCd);
		}
			...
			event.setPCFRevExpnAmountVOS((PCFRevExpnAmountVO[])getVOs(request, PCFRevExpnAmountVO.class,""));
		}
