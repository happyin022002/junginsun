...
*@FileName : ARInvoiceCorrectionDBDAOInvIssAtchVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCorrectionDBDAOInvIssAtchVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCorrectionDBDAOInvIssAtchVOCSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCorrectionDBDAOInvIssAtchVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("INTO INV_ISS_ATCH (AR_OFC_CD, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, PORT_CD, TXT_NO, INV_ISS_CTNT, FONT_BOLD_FLG, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT)" ).append("\n"); 
