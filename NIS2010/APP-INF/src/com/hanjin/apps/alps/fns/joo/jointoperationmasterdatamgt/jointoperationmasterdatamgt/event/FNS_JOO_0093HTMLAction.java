...
*@FileName : FNS_JOO_0093HTMLAction.java
...
public class FNS_JOO_0093HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0093HTMLAction 객체를 생성
	 */
	public FNS_JOO_0093HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0093Event event = new FnsJoo0093Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBsaCarrieHistoryVO((BsaCarrieHistoryVO)getVO(request, BsaCarrieHistoryVO .class));
			event.setBsaCarrieHistoryVOs((BsaCarrieHistoryVO[])getVOs(request, BsaCarrieHistoryVO .class,""));
