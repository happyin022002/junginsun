...
*@FileName : AccountReceivableEDISendDBDAOSearchEdiHNWLChgTotalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchEdiHNWLChgTotalRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchEdiHNWLChgTotalRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchEdiHNWLChgTotalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT SUM(CHG_AMT) CHG_AMT," ).append("\n"); 
		...
		query.append("GROUP BY CHG.CURR_CD" ).append("\n"); 
