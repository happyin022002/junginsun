...
public class CarrierSettlementProcessDBDAOAdjustSettlementSHVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,J.FNL_HJS_BSA_QTY" ).append("\n"); 
		...
		query.append("AND    J.STL_ADJ_FLG   = 'Y'" ).append("\n"); 
		query.append("ORDER  BY J.VSL_CD||J.SKD_VOY_NO||J.SKD_DIR_CD||J.REV_DIR_CD, J.JO_STL_JB_CD, J.JO_MNU_NM DESC" ).append("\n"); 
