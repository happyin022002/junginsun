...
*@FileName : MakeVoDAOSettlementRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MakeVoDAOSettlementRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MakeVoDAOSettlementRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.fns.joo.jointoperationagreementsettlement.carriersettlementprocess.integration").append("\n"); 
		query.append("FileName : MakeVoDAOSettlementRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("''  R_BSA_QTY," ).append("\n"); 
		query.append("''  R_BSA_SLT_PRC," ).append("\n"); 
		query.append("''  R_STL_LOCL_AMT," ).append("\n"); 
		query.append("''  E_VVD," ).append("\n"); 
		query.append("''  E_BSA_QTY," ).append("\n"); 
		query.append("''  E_BSA_SLT_PRC," ).append("\n"); 
		query.append("''  E_STL_LOCL_AMT," ).append("\n"); 
		query.append("''  JO_STL_JB_CD_NM," ).append("\n"); 
