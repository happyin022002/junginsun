...
*@FileName : NikeInputVO.java
*@FileTitle : NikeInputVO
*Open Issues :
*Change history :
...
public class NikeInputVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<NikeInputVO> models = new ArrayList<NikeInputVO>();
	...
	public NikeInputVO(String ibflag, String pagerows, String ofcCd, String vvd, String blSrcNo, String retrOpt, String fmDt, String toDt, String actCustCntCd, String actCustSeq, String sentStat, String changeType, String invNo) {
...
/**
	 ...
	 * @return NikeInputVO[]
	 */
	public NikeInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return NikeInputVO[]
	 */
	public NikeInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		NikeInputVO model = null;
	 ...
	 * @return NikeInputVO[]
	 */
	public NikeInputVO[] getNikeInputVOs(){
		NikeInputVO[] vos = (NikeInputVO[])models.toArray(new NikeInputVO[models.size()]);
		return vos;
	}
