...
*@FileName : FNS_JOO_0091HTMLAction.java
...
public class FNS_JOO_0091HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0091HTMLAction 객체를 생성
	 */
	public FNS_JOO_0091HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0091Event event = new FnsJoo0091Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBsaInformationEntryVOs((BsaInformationEntryVO[])getVOs(request, BsaInformationEntryVO .class,"sheet1_"));
		}else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setBsaInformationEntryVO((BsaInformationEntryVO)getVO(request, BsaInformationEntryVO .class));
			...
			event.setBsaInformationEntryVOs((BsaInformationEntryVO[])getVOs(request, BsaInformationEntryVO .class,"sheet3_"));
		}
		return  event;
	}
