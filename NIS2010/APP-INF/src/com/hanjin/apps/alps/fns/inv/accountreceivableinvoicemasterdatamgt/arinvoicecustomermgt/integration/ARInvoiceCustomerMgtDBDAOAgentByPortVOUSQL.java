...
*@FileName : ARInvoiceCustomerMgtDBDAOAgentByPortVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOAgentByPortVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOAgentByPortVOUSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOAgentByPortVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE INV_FDR_POD_AGN_CUST_CD SET" ).append("\n"); 
		...
		query.append("WHERE FDR_POD_CD = @[fdr_pod_cd]" ).append("\n"); 
