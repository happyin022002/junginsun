...
public class FNS_TOT_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0004HTMLAction 객체를 생성
	 */
	public FNS_TOT_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0004Event event = new FnsTot0004Event();
        log.debug("::CALL::> FNS_TOT_0004HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.MULTI)) {
			 log.debug("::CALL::> MULTI ::::::::: ");
			event.setLaneVOs((LaneVO[])getVOs(request, LaneVO.class,"sheet1_"));
			//TotLaneVO[] tot = (TotLaneVO[])getVOs(request, TotLaneVO.class,"sheet1_");
			...
			event.setLaneVO((LaneVO)getVO(request, LaneVO.class));
