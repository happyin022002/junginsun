...
*@FileName : JointOperationConsultationDBDAORemoveComAproCsrDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAORemoveComAproCsrDtlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationConsultationDBDAORemoveComAproCsrDtlUSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAORemoveComAproCsrDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
