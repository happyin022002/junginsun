...
*@FileName : FNS_TOT_0028HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0028HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0028Event event = new FnsTot0028Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			String stlYrmon = JSPUtil.getParameter(request, "stl_yrmon","");
			event.setStlYrmon(stlYrmon);
			event.setNrtBsaChgVOs((NrtBsaChgVO[])getVOs(request, NrtBsaChgVO .class,""));
		}
