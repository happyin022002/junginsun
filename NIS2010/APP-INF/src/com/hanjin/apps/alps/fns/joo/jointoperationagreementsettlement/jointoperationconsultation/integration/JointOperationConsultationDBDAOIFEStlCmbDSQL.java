...
*@FileName : JointOperationConsultationDBDAOIFEStlCmbDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOIFEStlCmbDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ERP I/F Error시 Reject 처리하면 JOO_STL_CMB 삭제한다.
	  * </pre>
	  */
	public JointOperationConsultationDBDAOIFEStlCmbDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOIFEStlCmbDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE JOO_STL_CMB A" ).append("\n"); 
