...
*@FileName : FNS_JOO_0016HTMLAction.java
...
public class FNS_JOO_0016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0016HTMLAction 객체를 생성
	 */
	public FNS_JOO_0016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0016Event event = new FnsJoo0016Event();
		
		event.setCmbConditionVO((CmbConditionVO)getVO(request, CmbConditionVO.class));
		
		if (command.isCommand(FormCommand.MULTI)||command.isCommand(FormCommand.REMOVE)) {
			event.setCombinedVOS((CombinedVO[])getVOs(request, CombinedVO .class,"sheet2_"));
		}
