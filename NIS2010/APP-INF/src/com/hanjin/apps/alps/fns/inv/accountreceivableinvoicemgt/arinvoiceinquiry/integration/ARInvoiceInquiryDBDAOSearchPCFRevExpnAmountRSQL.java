...
*@FileName : ARInvoiceInquiryDBDAOSearchPCFRevExpnAmountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceInquiryDBDAOSearchPCFRevExpnAmountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search PCF Rev Expn Amount
	  * </pre>
	  */
	public ARInvoiceInquiryDBDAOSearchPCFRevExpnAmountRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceInquiryDBDAOSearchPCFRevExpnAmountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY RE_PORT_SEQ DESC" ).append("\n"); 
