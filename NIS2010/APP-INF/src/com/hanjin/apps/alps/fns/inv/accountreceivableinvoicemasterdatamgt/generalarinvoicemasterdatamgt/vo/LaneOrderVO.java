 ...
 * @since J2EE 1.4
 */
public final class LaneOrderVO implements java.io.Serializable {
	...
	public static LaneOrderVO fromRequest(HttpServletRequest request) {
		LaneOrderVO model = new LaneOrderVO();
		try {
