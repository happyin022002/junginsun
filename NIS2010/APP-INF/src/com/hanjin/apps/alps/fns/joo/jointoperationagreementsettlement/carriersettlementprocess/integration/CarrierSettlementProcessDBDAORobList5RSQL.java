...
*@FileName : CarrierSettlementProcessDBDAORobList5RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAORobList5RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAORobList5RSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAORobList5RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
