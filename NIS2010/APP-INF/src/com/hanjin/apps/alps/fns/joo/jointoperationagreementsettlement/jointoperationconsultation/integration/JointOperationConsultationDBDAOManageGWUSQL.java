...
*@FileName : JointOperationConsultationDBDAOManageGWUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOManageGWUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationConsultationDBDAOManageGWUSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOManageGWUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE JOO_CSR A" ).append("\n"); 
