...
*@FileName : SettlementProcessDBDAOMvntEvntDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOMvntEvntDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Movement Event Date 조회
	  * </pre>
	  */
	public SettlementProcessDBDAOMvntEvntDateRSQL(){
		setQuery();
		...
		params.put("clpt_ind_seq2",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SettlementProcessDBDAOMvntEvntDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            ,TO_CHAR(A.CNMV_EVNT_DT,'YYYYMMDDHH24MISS') AS CNMV_EVNT_DT ---" ).append("\n"); 
		...
		query.append("			,TO_CHAR(J.CNMV_DT,'YYYYMMDDHH24MISS') AS CNMV_DT -----" ).append("\n"); 
		...
		query.append("		--AND J.CLPT_IND_SEQ IS NULL" ).append("\n"); 
		query.append("        --AND J.CLPT_IND_SEQ IS NOT NULL" ).append("\n"); 
		query.append("		#if (${inp_yd_cd} != '')" ).append("\n"); 
		query.append("		AND A.ORG_YD_CD = @[inp_yd_cd]" ).append("\n"); 
		query.append("		#end" ).append("\n"); 
		query.append("     ) AA" ).append("\n"); 
		query.append("     WHERE 1=1" ).append("\n"); 
		...
		query.append("    ,A.ORG_YD_CD    AS INP_YD_CD" ).append("\n"); 
		query.append("    ,A.CRNT_VSL_CD" ).append("\n"); 
		query.append("    ,A.CRNT_SKD_VOY_NO" ).append("\n"); 
		query.append("    ,A.CRNT_SKD_DIR_CD" ).append("\n"); 
		query.append("    ,A.CLPT_IND_SEQ2" ).append("\n"); 
		query.append("    ,A.CLPT_IND_SEQ3" ).append("\n"); 
		query.append("    ,DECODE(A.CLPT_IND_SEQ2,'0',A.CNMV_DT,A.CNMV_EVNT_DT) AS CNMV_DT" ).append("\n"); 
		query.append("FROM MVMT_DT A" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("#if (${clpt_ind_seq2} != '')" ).append("\n"); 
		query.append("AND A.CLPT_IND_SEQ2 = TO_NUMBER(@[clpt_ind_seq2])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("SELECT A.*" ).append("\n"); 
		query.append("FROM MVMT_DT2 A" ).append("\n"); 
		query.append("ORDER BY A.CNMV_EVNT_DT ASC" ).append("\n"); 
