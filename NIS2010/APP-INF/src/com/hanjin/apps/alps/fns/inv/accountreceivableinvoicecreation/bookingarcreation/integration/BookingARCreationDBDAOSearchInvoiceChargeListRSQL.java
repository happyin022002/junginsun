...
*@FileName : BookingARCreationDBDAOSearchInvoiceChargeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOSearchInvoiceChargeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BookingARCreationDBDAOSearchInvoiceChargeListRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOSearchInvoiceChargeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${svr_id} != 'USA')" ).append("\n"); 
