...
*@FileName : TOTFindCodeDBDAOBsaTrdVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TOTFindCodeDBDAOBsaTrdVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * tot_bsa로 부터 trade를 조회
	  * </pre>
	  */
	public TOTFindCodeDBDAOBsaTrdVORSQL(){
		setQuery();
		...
		query.append("FileName : TOTFindCodeDBDAOBsaTrdVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT	TRD_CD CODE" ).append("\n"); 
