...
*@FileName : JointOperationConsultationDBDAOSearchARDataInquiryDetailSumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOSearchARDataInquiryDetailSumRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchARDataInquiryDetailSum
	  * </pre>
	  */
	public JointOperationConsultationDBDAOSearchARDataInquiryDetailSumRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOSearchARDataInquiryDetailSumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
