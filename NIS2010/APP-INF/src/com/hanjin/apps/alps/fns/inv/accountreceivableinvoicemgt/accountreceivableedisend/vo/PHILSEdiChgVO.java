...
*@FileName : PHILSEdiChgVO.java
*@FileTitle : PHILSEdiChgVO
*Open Issues :
*Change history :
...
public class PHILSEdiChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PHILSEdiChgVO> models = new ArrayList<PHILSEdiChgVO>();
	...
	public PHILSEdiChgVO() {}

	public PHILSEdiChgVO(String ibflag, String pagerows, String chgCd, String currCd, String perTpCd, String trfRtAmt, String ratAsCntrQty, String chgAmt) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return PHILSEdiChgVO[]
	 */
	public PHILSEdiChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PHILSEdiChgVO[]
	 */
	public PHILSEdiChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PHILSEdiChgVO model = null;
	 ...
	 * @return PHILSEdiChgVO[]
	 */
	public PHILSEdiChgVO[] getPHILSEdiChgVOs(){
		PHILSEdiChgVO[] vos = (PHILSEdiChgVO[])models.toArray(new PHILSEdiChgVO[models.size()]);
		return vos;
	}
