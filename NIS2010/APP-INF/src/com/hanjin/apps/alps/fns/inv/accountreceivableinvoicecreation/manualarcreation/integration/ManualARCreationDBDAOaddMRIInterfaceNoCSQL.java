...
*@FileName : ManualARCreationDBDAOaddMRIInterfaceNoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualARCreationDBDAOaddMRIInterfaceNoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ManualARCreationDBDAOaddMRIInterfaceNoCSQL
	  * </pre>
	  */
	public ManualARCreationDBDAOaddMRIInterfaceNoCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : ManualARCreationDBDAOaddMRIInterfaceNoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}