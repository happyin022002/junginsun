...
*@FileName : FNS_JOO_0044HTMLAction.java
...
public class FNS_JOO_0044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0044HTMLAction 객체를 생성
	 */
	public FNS_JOO_0044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0044Event event = new FnsJoo0044Event();
		

		event.setTaxInvYrmonFr(JSPUtil.replace(request.getParameter("tax_inv_yrmon_fr"),"-",""));
		event.setTaxInvYrmonTo(JSPUtil.replace(request.getParameter("tax_inv_yrmon_to"),"-",""));
