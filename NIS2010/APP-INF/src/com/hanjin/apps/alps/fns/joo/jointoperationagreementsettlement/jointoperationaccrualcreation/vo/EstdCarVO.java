...
public class EstdCarVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EstdCarVO> models = new ArrayList<EstdCarVO>();
	...
	public EstdCarVO(String ibflag, String pagerows, String bsaOpJbCd, String rlaneCd, String joCrrCd) {
		this.ibflag = ibflag;
	 ...
	 * @return EstdCarVO[]
	 */
	public EstdCarVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EstdCarVO[]
	 */
	public EstdCarVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EstdCarVO model = null;
	 ...
	 * @return EstdCarVO[]
	 */
	public EstdCarVO[] getEstdCarVOs(){
		EstdCarVO[] vos = (EstdCarVO[])models.toArray(new EstdCarVO[models.size()]);
		return vos;
	}
