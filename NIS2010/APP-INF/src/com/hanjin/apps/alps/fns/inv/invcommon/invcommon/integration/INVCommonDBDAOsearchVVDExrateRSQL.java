...
*@FileName : INVCommonDBDAOsearchVVDExrateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class INVCommonDBDAOsearchVVDExrateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public INVCommonDBDAOsearchVVDExrateRSQL(){
		setQuery();
		...
		query.append("FileName : INVCommonDBDAOsearchVVDExrateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
