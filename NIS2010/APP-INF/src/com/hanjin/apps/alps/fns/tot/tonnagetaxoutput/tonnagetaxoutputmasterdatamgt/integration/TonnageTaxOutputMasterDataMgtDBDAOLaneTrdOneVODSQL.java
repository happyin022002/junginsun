...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOLaneTrdOneVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOLaneTrdOneVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOLaneTrdOneVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM TOT_LANE_TRD" ).append("\n"); 
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOLaneTrdOneVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}