...
*@FileName : AccountReceivableEDISendDBDAOSearchEdiMGBMakefileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchEdiMGBMakefileRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchEdiMGBMakefile
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchEdiMGBMakefileRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchEdiMGBMakefileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                ,   '$$$MSGSTART:'||RPAD('SMLM', 20, ' ')||RPAD('MGB', 20, ' ')||RPAD('IFTFCC', 10, ' ')||'INV'||INV_NO||LTRIM(TO_CHAR(@[inv_seq], '0000')) ||CHR(10)|| " ).append("\n"); 
		query.append("                    'DOC_NO:'           ||INV_NO||TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS') ||LTRIM(TO_CHAR(@[inv_seq], '0000'))               ||CHR(10)|| " ).append("\n"); 
		query.append("                    'FUNC_CD:'          ||'9'                                               ||CHR(10)||" ).append("\n"); 
		query.append("                    'PAPER_IND:'        ||'1'                                               ||CHR(10)|| --테스트 에는 1, 실제 라이브 에서는 3으로 가야함" ).append("\n"); 
		query.append("                    'DOC_DATE:'         ||TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')                ||CHR(10)||" ).append("\n"); 
		query.append("                    'INV_NO:'           ||INV_NO                                            ||CHR(10)||" ).append("\n"); 
		query.append("					'INV_SPLIT_FILENBR:'||LTRIM(TO_CHAR(@[inv_seq], '0000'))                ||CHR(10)||" ).append("\n"); 
		query.append("                    'INV_ISSUE_DATE:'   ||ISS_DT                                            ||CHR(10)||" ).append("\n"); 
		query.append("                    'TOT_AMNT:'         ||LTRIM(TO_CHAR(TTL_AMT, '9999999990.99'))          ||CHR(10)||" ).append("\n"); 
		query.append("                    'INV_CUR:'          ||CURR_CD                                           ||CHR(10)||" ).append("\n"); 
		query.append("                    --'BL_NUM:'           ||BL_SRC_NO                                         ||CHR(10)||" ).append("\n"); 
		query.append("                    'PT_CD:'            ||'CA'  AS MST" ).append("\n"); 
		...
		query.append("                        , '{CNTR_CHARGE'			                                                       ||CHR(10)||" ).append("\n"); 
		query.append("                          'CH_TP:'        || T03.CHG_CD_CONV		                       	             ||CHR(10)||" ).append("\n"); 
		query.append("                          'CH_AMNT:'	    || LTRIM(TO_CHAR(SUM(T03.TRF_RT_AMT), '9999999990.99'))    ||CHR(10)||" ).append("\n"); 
		query.append("                          'CH_CUR:'      || T03.CURR_CD		                       	                 ||CHR(10)||" ).append("\n"); 
		query.append("						  'CH_HAWBNO:'                          	                 				  ||CHR(10)||" ).append("\n"); 
		query.append("                          'CH_CNTRNO:'   || T03.CNTR_NO		                       	                 ||CHR(10)||" ).append("\n"); 
		query.append("						  'CH_ODNO:'                          	                 				  		||CHR(10)||" ).append("\n"); 
		query.append("                          'CH_BLNO:'     || T03.BL_SRC_NO		                       	               ||CHR(10)||" ).append("\n"); 
		query.append("                          '}CNTR_CHARGE'                        AS MSSG" ).append("\n"); 
		query.append("                FROM    (" ).append("\n"); 
		query.append("                        SELECT  T02.*" ).append("\n"); 
		query.append("                                --, DECODE(T02.CHG_CD, 'OFT', 'FRT', 'OTH') AS CHG_CD_CONV" ).append("\n"); 
		query.append("                                ,T02.CHG_CD AS CHG_CD_CONV" ).append("\n"); 
		query.append("                        FROM    (" ).append("\n"); 
