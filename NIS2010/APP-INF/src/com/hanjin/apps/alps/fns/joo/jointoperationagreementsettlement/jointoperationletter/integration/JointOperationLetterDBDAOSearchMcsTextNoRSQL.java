...
*@FileName : JointOperationLetterDBDAOSearchMcsTextNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationLetterDBDAOSearchMcsTextNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationLetterDBDAOSearchMcsTextNoRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationLetterDBDAOSearchMcsTextNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
