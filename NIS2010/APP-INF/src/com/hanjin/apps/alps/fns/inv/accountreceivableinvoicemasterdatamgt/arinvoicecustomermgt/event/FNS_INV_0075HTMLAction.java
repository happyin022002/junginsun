...
*@FileName : FNS_INV_0075HTMLAction.java
...
public class FNS_INV_0075HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0075HTMLAction 객체를 생성
	 */
	public FNS_INV_0075HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0075Event event = new FnsInv0075Event();		
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSecurityInputVO((SecurityInputVO)getVO(request, SecurityInputVO .class));
		}
