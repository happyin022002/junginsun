...
*@FileName : FNS_INV_0069HTMLAction.java
...
public class FNS_INV_0069HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0069HTMLAction 객체를 생성
	 */
	public FNS_INV_0069HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0069Event event = new FnsInv0069Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDateOption(request.getParameter("date_option"));
			event.setFromDate(request.getParameter("from_date"));
			event.setToDate(request.getParameter("to_date"));
			event.setRhq(request.getParameter("rhq"));
		}
