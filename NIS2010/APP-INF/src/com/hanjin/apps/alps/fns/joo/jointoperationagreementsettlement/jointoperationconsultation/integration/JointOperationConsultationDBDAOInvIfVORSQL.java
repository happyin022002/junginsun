...
*@FileName : JointOperationConsultationDBDAOInvIfVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOInvIfVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationConsultationDBDAOInvIfVORSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOInvIfVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
