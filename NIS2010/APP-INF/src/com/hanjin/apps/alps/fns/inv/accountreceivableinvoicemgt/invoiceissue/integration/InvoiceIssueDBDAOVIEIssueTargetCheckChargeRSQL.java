...
*@FileName : InvoiceIssueDBDAOVIEIssueTargetCheckChargeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueDBDAOVIEIssueTargetCheckChargeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceIssueDBDAOVIEIssueTargetCheckChargeRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueDBDAOVIEIssueTargetCheckChargeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT SUBSTR(XMLAGG(XMLELEMENT(A, ',' ||CHG_CD) ORDER BY CHG_CD).EXTRACT( '//text()'), 2) CHG_CD" ).append("\n"); 
		query.append("  FROM (SELECT DISTINCT B.CHG_CD" ).append("\n"); 
		...
		query.append(" WHERE BB.CHG_CD = Y.HJS_CD_VAL_CTNT(+)" ).append("\n"); 
		query.append("   AND CUST_CD_VAL_DESC IS NULL" ).append("\n"); 
