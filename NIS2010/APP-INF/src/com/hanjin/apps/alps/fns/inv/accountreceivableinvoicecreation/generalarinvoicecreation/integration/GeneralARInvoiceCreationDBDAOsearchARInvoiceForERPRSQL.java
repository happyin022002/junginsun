...
*@FileName : GeneralARInvoiceCreationDBDAOsearchARInvoiceForERPRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceCreationDBDAOsearchARInvoiceForERPRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralARInvoiceCreationDBDAOsearchARInvoiceForERPRSQL
	  * </pre>
	  */
	public GeneralARInvoiceCreationDBDAOsearchARInvoiceForERPRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceCreationDBDAOsearchARInvoiceForERPRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , A.WHF_DECL_NO WHF_DEC_NO" ).append("\n"); 
		...
		query.append("     --, A.SC_NO CONT_NO" ).append("\n"); 
		query.append("     , (SELECT DECODE(SC_NO, NULL, DECODE(RFA_NO, NULL, TAA_NO, RFA_NO), SC_NO) " ).append("\n"); 
		query.append("        FROM   BKG_BOOKING" ).append("\n"); 
		query.append("        WHERE  BKG_NO = A.BKG_NO) CONT_NO" ).append("\n"); 
		...
		query.append("	 , NVL(A.CR_INV_NO,'') CR_INV_NO " ).append("\n"); 
