...
*@FileName : FNS_JOO_0045HTMLAction.java
...
public class FNS_JOO_0045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0045HTMLAction 객체를 생성
	 */
	public FNS_JOO_0045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0045Event event = new FnsJoo0045Event();
		
		event.setAdjustConditionVO((AdjustConditionVO)getVO(request, AdjustConditionVO .class));
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setAdjustSettlementVOS((AdjustSettlementVO[])getVOs(request, AdjustSettlementVO .class,"sheet1_"));
		}
