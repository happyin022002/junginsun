...
*@FileName : FNS_INV_0067HTMLAction.java
...
public class FNS_INV_0067HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0067HTMLAction 객체를 생성
	 */
	public FNS_INV_0067HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0067Event event = new FnsInv0067Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setARInvoiceInquiryInPutVO((ARInvoiceInquiryInPutVO)getVO(request, ARInvoiceInquiryInPutVO .class));
		}
