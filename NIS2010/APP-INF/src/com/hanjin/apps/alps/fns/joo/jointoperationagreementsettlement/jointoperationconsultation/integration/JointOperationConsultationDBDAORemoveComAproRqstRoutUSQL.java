...
*@FileName : JointOperationConsultationDBDAORemoveComAproRqstRoutUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAORemoveComAproRqstRoutUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Remove Com Apro Rqst Rout
	  * </pre>
	  */
	public JointOperationConsultationDBDAORemoveComAproRqstRoutUSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAORemoveComAproRqstRoutUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
