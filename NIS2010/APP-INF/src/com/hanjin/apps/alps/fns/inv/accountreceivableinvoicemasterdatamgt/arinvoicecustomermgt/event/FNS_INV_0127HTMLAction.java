...
*@FileName : FNS_INV_0127HTMLAction.java
...
public class FNS_INV_0127HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0127HTMLAction 객체를 생성
	 */
	public FNS_INV_0127HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0127Event event = new FnsInv0127Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setArInvoiceBadCustomerHistoryVO((ARInvoiceBadCustomerHistoryVO)getVO(request, ARInvoiceBadCustomerHistoryVO .class));
		}
