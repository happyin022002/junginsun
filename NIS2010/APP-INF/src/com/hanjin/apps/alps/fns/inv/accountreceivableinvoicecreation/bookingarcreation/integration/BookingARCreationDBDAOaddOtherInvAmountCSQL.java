...
*@FileName : BookingARCreationDBDAOaddOtherInvAmountCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOaddOtherInvAmountCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingARCreationDBDAOaddOtherInvAmountCSQL
	  * </pre>
	  */
	public BookingARCreationDBDAOaddOtherInvAmountCSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOaddOtherInvAmountCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                                                                  '110611')) from DUAL) " ).append("\n"); 
		query.append("     , @[inv_coa_inter_co_cd]" ).append("\n"); 
		query.append("     , @[inv_coa_vsl_cd]" ).append("\n"); 
		query.append("     , @[inv_coa_voy_no]" ).append("\n"); 
		query.append("     , @[inv_coa_skd_dir_cd]" ).append("\n"); 
