...
public class INVCommonDAOsearchAROfficeListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	 , G.EU_CNT_FLG" ).append("\n"); 
		...
		query.append("     , MDM_COUNTRY  G" ).append("\n"); 
		...
		query.append("   AND C.SYS_AREA_GRP_ID = (    SELECT DECODE(SYS_AREA_GRP_ID, 'CHN', 'CHN', C.SYS_AREA_GRP_ID) " ).append("\n"); 
