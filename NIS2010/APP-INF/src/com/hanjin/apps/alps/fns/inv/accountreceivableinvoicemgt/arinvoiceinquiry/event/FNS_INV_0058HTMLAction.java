...
*@FileName : FNS_INV_0058HTMLAction.java
...
public class FNS_INV_0058HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0058HTMLAction 객체를 생성
	 */
	public FNS_INV_0058HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0058Event event = new FnsInv0058Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInvoiceTermAnalysisInputVO(( InvoiceTermAnalysisInputVO)getVO(request,  InvoiceTermAnalysisInputVO .class));
		}
