...
*@FileName : ARInvoiceInquiryDBDAOSplitInvoiceIssueDateVOPopRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceInquiryDBDAOSplitInvoiceIssueDateVOPopRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ARInvoiceInquiryDBDAOSplitInvoiceIssueDateVOPopRSQL
	  * </pre>
	  */
	public ARInvoiceInquiryDBDAOSplitInvoiceIssueDateVOPopRSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceInquiryDBDAOSplitInvoiceIssueDateVOPopRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			  FROM INV_AR_SPLIT_ISS D" ).append("\n"); 
		query.append("			     , INV_AR_SPLIT_ISS_CHG A" ).append("\n"); 
		...
		query.append("			   	  AND D.AR_OFC_CD in (SELECT OFC_CD FROM MDM_ORGANIZATION where AR_OFC_CD = @[office] )" ).append("\n"); 
		query.append("			#end" ).append("\n"); 
		query.append("			   AND D.INV_SEQ = 1" ).append("\n"); 
		query.append("			   AND D.INV_NO   = A.INV_NO" ).append("\n"); 
		query.append("			   AND D.AR_IF_NO = B.AR_IF_NO" ).append("\n"); 
