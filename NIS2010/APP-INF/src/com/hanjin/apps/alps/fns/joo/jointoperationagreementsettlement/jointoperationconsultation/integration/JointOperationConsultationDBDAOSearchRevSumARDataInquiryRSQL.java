...
*@FileName : JointOperationConsultationDBDAOSearchRevSumARDataInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOSearchRevSumARDataInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationConsultationDBDAOSearchRevSumARDataInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOSearchRevSumARDataInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("GROUP BY S.ACCT_YRMON" ).append("\n"); 
