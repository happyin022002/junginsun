...
*@FileName : FNS_INV_0131HTMLAction.java
...
public class FNS_INV_0131HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0131HTMLAction 객체를 생성
	 */
	public FNS_INV_0131HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0131Event event = new FnsInv0131Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBlNo(request.getParameter("bl_no"));
			event.setOfc(request.getParameter("ofc"));
