...
*@FileName : SettlementProcessDBDAOCheckSltHirClzRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOCheckSltHirClzRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOCheckSltHirClzRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOCheckSltHirClzRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
