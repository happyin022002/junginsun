...
*@FileName : MGBInputVO.java
*@FileTitle : MGBInputVO
*Open Issues :
*Change history :
...
public class MGBInputVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGBInputVO> models = new ArrayList<MGBInputVO>();
	...
	public MGBInputVO(String ibflag, String pagerows, String ofcCd, String vvd, String blSrcNo, String retrOpt, String fmDt, String toDt, String actCustCntCd, String actCustSeq, String sentStat, String changeType, String invNo) {
...
/**
	 ...
	 * @return MGBInputVO[]
	 */
	public MGBInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGBInputVO[]
	 */
	public MGBInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGBInputVO model = null;
	 ...
	 * @return MGBInputVO[]
	 */
	public MGBInputVO[] getMGBInputVOs(){
		MGBInputVO[] vos = (MGBInputVO[])models.toArray(new MGBInputVO[models.size()]);
		return vos;
	}
