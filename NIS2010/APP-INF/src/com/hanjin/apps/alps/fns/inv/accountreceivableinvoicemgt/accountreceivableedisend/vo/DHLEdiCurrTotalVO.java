 ...
 * @FileName : DHLEdiCurrTotalVO.java
 * @FileTitle : DHLEdiCurrTotalVO
 * Open Issues :
 * Change history :
...
public class DHLEdiCurrTotalVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DHLEdiCurrTotalVO> models = new ArrayList<DHLEdiCurrTotalVO>();
	...
	public DHLEdiCurrTotalVO() {}

	public DHLEdiCurrTotalVO(String ibflag, String pagerows, String invPosCurrcde, String invPosCurramt, String invPosExchrate) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return DHLEdiCurrTotalVO[]
	 */
	public DHLEdiCurrTotalVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DHLEdiCurrTotalVO[]
	 */
	public DHLEdiCurrTotalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DHLEdiCurrTotalVO model = null;
	 ...
	 * @return DHLEdiCurrTotalVO[]
	 */
	public DHLEdiCurrTotalVO[] getDHLEdiCurrTotalVOs(){
		DHLEdiCurrTotalVO[] vos = (DHLEdiCurrTotalVO[])models.toArray(new DHLEdiCurrTotalVO[models.size()]);
		return vos;
	}
