...
*@FileName : ARInvoiceCustomerMgtDBDAOAgentByPortVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOAgentByPortVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOAgentByPortVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("A.FDR_POD_CD FDR_POD_CD" ).append("\n"); 
		query.append(",	A.LANE_CD LANE_CD" ).append("\n"); 
		...
		query.append("FROM INV_FDR_POD_AGN_CUST_CD A, MDM_CUSTOMER B" ).append("\n"); 
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOAgentByPortVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}