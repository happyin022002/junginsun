...
*@FileName : ARInvoiceCustomerMgtDBDAOTemplateVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOTemplateVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOTemplateVODSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOTemplateVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
