...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * lane에 해당하는 trd_code를 모두 삭제한다.
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVODSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOLaneTrdVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
