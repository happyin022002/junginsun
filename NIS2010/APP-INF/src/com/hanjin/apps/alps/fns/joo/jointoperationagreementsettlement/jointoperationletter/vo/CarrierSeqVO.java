...
*@FileName : CarrierSeqVO.java
*@FileTitle : CarrierSeqVO
*Open Issues :
*Change history :
...
public class CarrierSeqVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CarrierSeqVO> models = new ArrayList<CarrierSeqVO>();
	...
	public CarrierSeqVO(String ibflag, String pagerows, String code, String name, String joCrrCd, String customerCode) {
		this.ibflag = ibflag;
	 ...
	 * @return CarrierSeqVO[]
	 */
	public CarrierSeqVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CarrierSeqVO[]
	 */
	public CarrierSeqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CarrierSeqVO model = null;
	 ...
	 * @return CarrierSeqVO[]
	 */
	public CarrierSeqVO[] getCarrierSeqVOs(){
		CarrierSeqVO[] vos = (CarrierSeqVO[])models.toArray(new CarrierSeqVO[models.size()]);
		return vos;
	}
