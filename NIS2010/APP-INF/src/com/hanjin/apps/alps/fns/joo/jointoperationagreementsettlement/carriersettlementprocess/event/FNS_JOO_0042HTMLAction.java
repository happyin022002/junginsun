...
*@FileName : FNS_JOO_0042HTMLAction.java
...
public class FNS_JOO_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0042HTMLAction 객체를 생성
	 */
	public FNS_JOO_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0042Event event = new FnsJoo0042Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setSlotXchLaneVO(  (SlotXchLaneVO)getVO(request, SlotXchLaneVO.class)  );
		}
