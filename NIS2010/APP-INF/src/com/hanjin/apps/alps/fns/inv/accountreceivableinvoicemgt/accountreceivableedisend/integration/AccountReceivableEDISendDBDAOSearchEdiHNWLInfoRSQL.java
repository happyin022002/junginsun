...
*@FileName : AccountReceivableEDISendDBDAOSearchEdiHNWLInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchEdiHNWLInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Get Honey Well information.
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchEdiHNWLInfoRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchEdiHNWLInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM INV_EDI_HNWL" ).append("\n"); 
