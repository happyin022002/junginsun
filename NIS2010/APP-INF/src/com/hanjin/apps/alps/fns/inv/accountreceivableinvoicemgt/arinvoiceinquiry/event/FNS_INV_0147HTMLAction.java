...
*@FileName : FNS_INV_0147HTMLAction.java
...
public class FNS_INV_0147HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0147HTMLAction 객체를 생성
	 */
	public FNS_INV_0147HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0147Event event = new FnsInv0147Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPCFStatusInfoInputVO((PCFStatusInfoInputVO)getVO(request, PCFStatusInfoInputVO .class));
		}
