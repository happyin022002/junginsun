...
*@FileName : FNS_JOO_0062HTMLAction.java
...
public class FNS_JOO_0062HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0062HTMLAction 객체를 생성
	 */
	public FNS_JOO_0062HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        FnsJoo0062Event event = new FnsJoo0062Event();
        ...
        if(command.isCommand(FormCommand.SEARCHLIST01)) {
            event.setInvoiceCombinedVO(  (InvoiceCombinedVO)getVO(request, InvoiceCombinedVO.class) );
        }
