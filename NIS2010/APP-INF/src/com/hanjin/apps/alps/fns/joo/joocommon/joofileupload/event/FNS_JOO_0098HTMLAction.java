...
*@FileName : FNS_JOO_0098HTMLAction.java
 ...
 * HTTP Parser<br>
 * @author 민정호
 * @see FnsJoo0098Event 참조
 * @since J2EE 1.4
 */

public class FNS_JOO_0098HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * FNS_JOO_0098HTMLAction 객체를 생성
	 */
	public FNS_JOO_0098HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 FnsJoo0098Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		//이벤트 객체 생성 
		FnsJoo0098Event event = new FnsJoo0098Event();		
		...
		if(command.isCommand(FormCommand.SEARCH18)) {
			...
			event.setFileSeq(request.getParameter("file_seq"));			
