 ...
 * @FileName : ADIDASEdiTotalVO.java
 * @FileTitle : ADIDASEdiTotalVO
 * Open Issues :
 * Change history :
...
public class ADIDASEdiTotalVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ADIDASEdiTotalVO> models = new ArrayList<ADIDASEdiTotalVO>();
	...
	public ADIDASEdiTotalVO() {}

	public ADIDASEdiTotalVO(String ibflag, String pagerows, String invTotalAmt, String invVatBasis, String invVatRate, String invVatAmt) {
...
/**
	 ...
	 */
	public ADIDASEdiTotalVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ADIDASEdiTotalVO[]
	 */
	public ADIDASEdiTotalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ADIDASEdiTotalVO model = null;
	 ...
	 * @return ADIDASEdiTotalVO[]
	 */
	public ADIDASEdiTotalVO[] getADIDASEdiTotalVOs(){
		ADIDASEdiTotalVO[] vos = (ADIDASEdiTotalVO[])models.toArray(new ADIDASEdiTotalVO[models.size()]);
		return vos;
	}
