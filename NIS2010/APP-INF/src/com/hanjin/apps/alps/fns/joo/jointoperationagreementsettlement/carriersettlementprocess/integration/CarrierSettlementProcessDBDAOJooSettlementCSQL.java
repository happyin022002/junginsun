...
*@FileName : CarrierSettlementProcessDBDAOJooSettlementCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOJooSettlementCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * JOO_SETTLEMENT insert
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOJooSettlementCSQL(){
		setQuery();
		...
		params.put("fnl_hjs_bsa_qty",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CarrierSettlementProcessDBDAOJooSettlementCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
