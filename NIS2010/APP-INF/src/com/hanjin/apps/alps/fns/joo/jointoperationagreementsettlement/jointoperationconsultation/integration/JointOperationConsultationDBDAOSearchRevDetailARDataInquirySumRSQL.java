...
*@FileName : JointOperationConsultationDBDAOSearchRevDetailARDataInquirySumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOSearchRevDetailARDataInquirySumRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchRevDetailARDataInquirySum
	  * </pre>
	  */
	public JointOperationConsultationDBDAOSearchRevDetailARDataInquirySumRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOSearchRevDetailARDataInquirySumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT STL_USD_AMT," ).append("\n"); 
		...
		query.append(",SUM(DECODE(S.RE_DIVR_CD, 'R', SL.CSR_LOCL_AMT / DECODE (S.LOCL_CURR_CD, 'USD', 1, (" ).append("\n"); 
		query.append("SELECT NVL(EX1.USD_LOCL_XCH_RT, 1)" ).append("\n"); 
		query.append("FROM GL_MON_XCH_RT EX1" ).append("\n"); 
		query.append("WHERE EX1.CURR_CD = S.LOCL_CURR_CD" ).append("\n"); 
		query.append("AND EX1.ACCT_XCH_RT_YRMON = TO_CHAR(R.EFF_DT, 'YYYYMM')" ).append("\n"); 
		query.append("AND EX1.ACCT_XCH_RT_LVL = '1' ) ) ) )  AS CSR_LOCL_AMT" ).append("\n"); 
		...
		query.append("GROUP BY S.LOCL_CURR_CD" ).append("\n"); 
