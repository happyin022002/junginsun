...
*@FileName : FNS_INV_0088HTMLAction.java
...
public class FNS_INV_0088HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0088HTMLAction 객체를 생성
	 */
	public FNS_INV_0088HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0088Event event = new FnsInv0088Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setGeneralInvoiceVO((GeneralInvoiceVO)getVO(request, GeneralInvoiceVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setGeneralInvoiceVO((GeneralInvoiceVO)getVO(request, GeneralInvoiceVO .class));
			event.setVIECombineInvoiceVOS((VIECombineInvoiceVO[])getVOs(request, VIECombineInvoiceVO .class, "sheet1_"));
		}
