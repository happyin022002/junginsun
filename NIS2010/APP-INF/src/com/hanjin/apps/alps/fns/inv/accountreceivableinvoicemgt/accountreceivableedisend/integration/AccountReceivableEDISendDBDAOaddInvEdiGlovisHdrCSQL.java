...
*@FileName : AccountReceivableEDISendDBDAOaddInvEdiGlovisHdrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOaddInvEdiGlovisHdrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOaddInvEdiGlovisHdrCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOaddInvEdiGlovisHdrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", @[inv_no]" ).append("\n"); 
		query.append(", NVL((SELECT MAX(INV_SEQ)+1" ).append("\n"); 
