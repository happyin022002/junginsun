...
*@FileName : FNS_INV_0057HTMLAction.java
...
public class FNS_INV_0057HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0057HTMLAction 객체를 생성
	 */
	public FNS_INV_0057HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0057Event event = new FnsInv0057Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			NotissuedInputVO notissuedInputVO = (NotissuedInputVO)getVO(request, NotissuedInputVO .class); 
			
			notissuedInputVO.setArOfcCd(request.getParameter("ofc_cd"));
			
			event.setNotissuedInputVO(notissuedInputVO);
		}
