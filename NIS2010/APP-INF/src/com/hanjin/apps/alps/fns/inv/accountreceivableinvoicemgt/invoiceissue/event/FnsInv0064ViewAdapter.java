 ...
 * @since J2EE 1.5
 */
public class FnsInv0064ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"ar_ofc_cd","cust_cd","iss_dt","bl_src_no","spl_giro_amt","tot_giro_amt","due_dt","","cust_lgl_eng_nm","vvd","giro_no","tva_giro_amt","","delt_flg"};
		...
		for(int i=0;i<realColNms.length;i++){
			...
			log.debug(" ########## realColNms = "+realColNms[i]);	
			
		}
        for(int i=0;i<changedColNms.length;i++){
			
			log.debug(" ########## changedColNms = "+changedColNms[i]);	
			
		}
		*/
		//log.debug(" ########## totCnt2 = "+totCnt);	
