...
*@FileName : JOOFindCodeAndCheckDBDAOJooLanebyThreeCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAOJooLanebyThreeCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAOJooLanebyThreeCodeRSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAOJooLanebyThreeCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("substr(a.rlane_cd,0,3) as code," ).append("\n"); 
