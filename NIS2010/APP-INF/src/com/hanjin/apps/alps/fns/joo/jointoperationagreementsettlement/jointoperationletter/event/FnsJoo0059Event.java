...
/**
 * FNS_JOO_0059 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  FNS_JOO_0059HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author HAM DAE SUNG
 * @see FNS_JOO_0059HTMLAction 참조
 * @since J2EE 1.6
 */

public class FnsJoo0059Event extends EventSupport {
	...
	/**
	 * @param joLtrTpCd the joLtrTpCd to set
	 */
