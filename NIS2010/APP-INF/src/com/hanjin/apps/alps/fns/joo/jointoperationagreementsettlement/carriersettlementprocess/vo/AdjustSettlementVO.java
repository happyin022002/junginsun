...
*@FileName : AdjustSettlementVO.java
*@FileTitle : AdjustSettlementVO
*Open Issues :
*Change history :
...
public class AdjustSettlementVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AdjustSettlementVO> models = new ArrayList<AdjustSettlementVO>();
	...
	public AdjustSettlementVO() {}

	public AdjustSettlementVO(String ibflag, String pagerows, String acctYrmon, String stlVvdSeq, String stlSeq, String trdCd, String joCrrCd, String rlaneCd, String reDivrCd, String joStlItmCd, String joMnuNm, String vvd, String vslCd, String skdVoyNo, String skdDirCd, String revDirCd, String stlBzcPortCd, String etaDt, String joStlJbCd, String bsaQty, String bsaSltPrc, String bsaQty1, String bsaSltPrc1, String dtlBsaQty, String dtlBsaSltPrc, String loclCurrCd, String adjBsaQtyLoclAmt, String adjBsaSltPrcLoclAmt, String stlLoclAmt, String stlUsdAmt, String iocCd, String scontiCd, String fnlHjsBsaQty, String fnlBsaWgt, String usdSltBsaQty, String usdSltWgt, String bsaPerWgt, String fmPortCd, String toPortCd, String rfScgStlTpCd, String rfScgPrc, String stlRmk, String cmbCfmFlg, String stlTjNo, String stlCmbSeq, String stlAdjFlg, String stlLstFlg, String preAcctYrmon, String preStlVvdSeq, String preStlSeq, String ucBssPortCd, String ucBssPortEtdDt, String stlAdjIrrFlg, String stlAdjIrrRmk, String creDt, String creUsrId, String updDt, String updUsrId, String slipNo, String rn) {
		this.vslCd = vslCd;
		this.stlAdjFlg = stlAdjFlg;
		this.slipNo = slipNo;
		this.etaDt = etaDt;
		this.dtlBsaQty = dtlBsaQty;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dtl_bsa_qty", getDtlBsaQty());
		...
		this.hashColumns.put("bsa_qty1", getBsaQty1());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dtl_bsa_qty", "dtlBsaQty");
		...
		this.hashFields.put("bsa_qty1", "bsaQty1");
	 ...
	 * @return dtlBsaQty
	 */
	public String getDtlBsaQty() {
		return this.dtlBsaQty;
	}
	 ...
	 * @return dtlBsaSltPrc
	 */
	public String getDtlBsaSltPrc() {
		return this.dtlBsaSltPrc;
	}
	 ...
	 * @return bsaSltPrc1
	 */
	public String getBsaSltPrc1() {
		return this.bsaSltPrc1;
	}
	 ...
	 * @param dtlBsaQty
	 */
	public void setDtlBsaQty(String dtlBsaQty) {
		this.dtlBsaQty = dtlBsaQty;
	}
	 ...
	 * @param dtlBsaSltPrc
	 */
	public void setDtlBsaSltPrc(String dtlBsaSltPrc) {
		this.dtlBsaSltPrc = dtlBsaSltPrc;
	}
	 ...
	 * @param bsaSltPrc1
	 */
	public void setBsaSltPrc1(String bsaSltPrc1) {
		this.bsaSltPrc1 = bsaSltPrc1;
	}
	 ...
	 * @param bsaQty1
	 */
	public void setBsaQty1(String bsaQty1) {
		this.bsaQty1 = bsaQty1;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDtlBsaQty(JSPUtil.getParameter(request, "dtl_bsa_qty", ""));
		...
		setFnlHjsBsaQty(JSPUtil.getParameter(request, "fnl_hjs_bsa_qty", ""));
		...
		setBsaQty1(JSPUtil.getParameter(request, "bsa_qty1", ""));
	 ...
	 */
	public AdjustSettlementVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AdjustSettlementVO[]
	 */
	public AdjustSettlementVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AdjustSettlementVO model = null;
		...
		try {
			...
			String[] dtlBsaQty = (JSPUtil.getParameter(request, prefix	+ "dtl_bsa_qty", length));
			...
			String[] dtlBsaSltPrc = (JSPUtil.getParameter(request, prefix	+ "dtl_bsa_slt_prc", length));
			...
			String[] bsaSltPrc1 = (JSPUtil.getParameter(request, prefix	+ "bsa_slt_prc1", length));
			...
			String[] bsaQty1 = (JSPUtil.getParameter(request, prefix	+ "bsa_qty1", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (dtlBsaQty[i] != null)
					model.setDtlBsaQty(dtlBsaQty[i]);
				if (fmPortCd[i] != null)
	...
	public AdjustSettlementVO[] getAdjustSettlementVOs(){
		AdjustSettlementVO[] vos = (AdjustSettlementVO[])models.toArray(new AdjustSettlementVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.dtlBsaQty = this.dtlBsaQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.dtlBsaSltPrc = this.dtlBsaSltPrc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.bsaSltPrc1 = this.bsaSltPrc1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.bsaQty1 = this.bsaQty1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
