...
*@FileName : TonnageTaxStandardProfitConclusionDBDAOInquiryVslOwnerCharterListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxStandardProfitConclusionDBDAOInquiryVslOwnerCharterListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InquiryVslOwnerCharterList
	  * </pre>
	  */
	public TonnageTaxStandardProfitConclusionDBDAOInquiryVslOwnerCharterListRSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxStandardProfitConclusionDBDAOInquiryVslOwnerCharterListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${tong_flet_tp_cd} == 'A')" ).append("\n"); 
		query.append("                     AND  TONG_FLET_TP_CD IN ('C', 'O')" ).append("\n"); 
		query.append("#elseif(${tong_flet_tp_cd} == 'C')" ).append("\n"); 
		query.append("                     AND  TONG_FLET_TP_CD IN ('C')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("                     AND  TONG_FLET_TP_CD IN ('O')" ).append("\n"); 
