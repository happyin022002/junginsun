...
*@FileName : SettlementProcessDBDAOSearchTDRDownloadListByLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOSearchTDRDownloadListByLaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOSearchTDRDownloadListByLaneRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOSearchTDRDownloadListByLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , LPAD(VSK.CLPT_SEQ, 2, '0') || (" ).append("\n"); 
		...
		query.append("     , A.TTL_SLT_KNT AS GRAND_TTL_SLOT" ).append("\n"); 
		query.append("     , DECODE(DECODE(PRT_BSA.TRD_CD,   NULL,   NVL(ALL_BSA.JO_OVR_TON_WGT, 0), NVL(PRT_BSA.JO_OVR_TON_WGT, 0)), 0, 0, A.TTL_SLT_WGT) AS GRAND_TTL_WGT" ).append("\n"); 
		query.append("     , A.HC_20FT_FCNTR_KNT AS HC_LD_20" ).append("\n"); 
		query.append("     , A.HC_20FT_MCNTR_KNT AS HC_BSA_20" ).append("\n"); 
		query.append("     , A.HC_40FT_FCNTR_KNT AS HC_LD_40" ).append("\n"); 
		query.append("     , A.HC_40FT_MCNTR_KNT AS HC_BSA_40" ).append("\n"); 
		query.append("     , A.FCNTR_45FT_KNT AS HC_LD_45" ).append("\n"); 
		query.append("     , A.MCNTR_45FT_KNT AS HC_BSA_45" ).append("\n"); 
		query.append("     , A.AWK_CNTR_KNT AS AK_UNIT" ).append("\n"); 
		query.append("     , A.AWK_VOID_CNTR_KNT AS AK_VOID" ).append("\n"); 
		query.append("     , A.DG_20FT_CNTR_KNT AS DG_20" ).append("\n"); 
		query.append("     , A.DG_40FT_CNTR_KNT AS DG_40" ).append("\n"); 
		query.append("     , A.RF_20FT_CNTR_KNT AS RF_20_QTY" ).append("\n"); 
		query.append("     , A.RF_40FT_CNTR_KNT AS RF_40_QTY" ).append("\n"); 
		query.append("     ,(" ).append("\n"); 
		...
		query.append("         AND BB.OPR_CD     = A.CRR_CD" ).append("\n"); 
		...
		query.append("     , A.CNTR_TEU_QTY AS MT_TEU" ).append("\n"); 
		query.append("     , A.FCNTR_20FT_KNT AS FULL_20" ).append("\n"); 
		query.append("     , A.MCNTR_20FT_KNT AS MT_20" ).append("\n"); 
		query.append("     , A.FCNTR_40FT_KNT AS FULL_40" ).append("\n"); 
		query.append("     , A.MCNTR_40FT_KNT AS MT_40" ).append("\n"); 
		query.append("     , A.CNTR_WGT AS MT_WT" ).append("\n"); 
		query.append("     " ).append("\n"); 
		...
		query.append("   AND NVL(A.CRR_CD,'XXX')        = NVL(TGT.CRR_CD(+),'XXX')" ).append("\n"); 
		...
		query.append("   #end" ).append("\n"); 
		query.append("   #if (${opt_tgt} == 'C')" ).append("\n"); 
