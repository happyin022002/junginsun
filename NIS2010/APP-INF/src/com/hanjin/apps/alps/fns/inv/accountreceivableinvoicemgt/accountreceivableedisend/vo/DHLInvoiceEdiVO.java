 ...
 * @FileName : DHLInvoiceEdiVO.java
 * @FileTitle : DHLInvoiceEdiVO
 * Open Issues :
 * Change history :
 * @LastModifyDate : 2012.05.30
 * @LastModifier : 김상현
 * @LastVersion : 1.0
 * 2012.05.30 김상현 1.0 Creation
 */
...
public class DHLInvoiceEdiVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DHLInvoiceEdiVO> models = new ArrayList<DHLInvoiceEdiVO>();
	...
	public DHLInvoiceEdiVO() {}

	public DHLInvoiceEdiVO(String ibflag, String pagerows, String blSrcNo, String ttlAmt, String receipt, String podCd, String invNo, String ofcCd, String issDt, String polCd, String dueDt, String ediSndFlg, String receiptDt, String updUsrId, String ediSndDt, String fltFileRefNo) {
...
/**
	 ...
	 * @param request
	 * @return DHLInvoiceEdiVO[]
	 */
	public DHLInvoiceEdiVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DHLInvoiceEdiVO[]
	 */
	public DHLInvoiceEdiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DHLInvoiceEdiVO model = null;
	...
	public DHLInvoiceEdiVO[] getDHLInvoiceEdiVOs(){
		DHLInvoiceEdiVO[] vos = (DHLInvoiceEdiVO[])models.toArray(new DHLInvoiceEdiVO[models.size()]);
		return vos;
	}
