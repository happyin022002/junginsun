...
*@FileName : FNS_INV_0011_01HTMLAction.java
...
public class FNS_INV_0011_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0011_01HTMLAction 객체를 생성
	 */
	public FNS_INV_0011_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv001101Event event = new FnsInv001101Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setARInvoiceCorrectionVO(( ARInvoiceCorrectionVO)getVO(request,  ARInvoiceCorrectionVO .class));
		}
