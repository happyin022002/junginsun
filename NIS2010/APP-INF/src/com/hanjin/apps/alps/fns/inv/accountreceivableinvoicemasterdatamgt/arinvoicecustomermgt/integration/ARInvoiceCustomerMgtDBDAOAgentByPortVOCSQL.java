...
*@FileName : ARInvoiceCustomerMgtDBDAOAgentByPortVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOAgentByPortVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOAgentByPortVOCSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOAgentByPortVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO INV_FDR_POD_AGN_CUST_CD (" ).append("\n"); 
