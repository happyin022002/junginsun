...
*@FileName : FNS_JOO_0027HTMLAction.java
...
public class FNS_JOO_0027HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0027HTMLAction 객체를 생성
	 */
	public FNS_JOO_0027HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0027Event event = new FnsJoo0027Event();
		
		event.setErpIfFlg(request.getParameter("erp_if_flg"));
		event.setDtFlg   (request.getParameter("dt_flg"));
		event.setIssDtFr (JSPUtil.replace(request.getParameter("iss_dt_fr"),"-",""));
		event.setIssDtTo (JSPUtil.replace(request.getParameter("iss_dt_to"),"-",""));
