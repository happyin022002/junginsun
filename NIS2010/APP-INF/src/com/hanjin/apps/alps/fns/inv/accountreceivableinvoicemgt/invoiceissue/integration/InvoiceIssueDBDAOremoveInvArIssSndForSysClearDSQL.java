...
*@FileName : InvoiceIssueDBDAOremoveInvArIssSndForSysClearDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceIssueDBDAOremoveInvArIssSndForSysClearDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Issue 동작 중에 Sys Clear 동작이 발생한  Send 정보를 삭제한다.
	  * </pre>
	  */
	public InvoiceIssueDBDAOremoveInvArIssSndForSysClearDSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceIssueDBDAOremoveInvArIssSndForSysClearDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO INV_AR_ISS_SND T" ).append("\n"); 
		...
		query.append("WHEN MATCHED THEN UPDATE SET ERR_DESC = 'DELETE'" ).append("\n"); 
