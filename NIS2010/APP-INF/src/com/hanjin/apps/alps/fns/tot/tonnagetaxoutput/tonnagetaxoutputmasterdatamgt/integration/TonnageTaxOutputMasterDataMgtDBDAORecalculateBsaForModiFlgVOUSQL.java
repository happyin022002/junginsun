...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAORecalculateBsaForModiFlgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAORecalculateBsaForModiFlgVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * tot_bsa 데이터 modi_flg를 'N'으로 변경
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAORecalculateBsaForModiFlgVOUSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAORecalculateBsaForModiFlgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TOT_BSA SET" ).append("\n"); 
		query.append("MODI_FLG = 'N'" ).append("\n"); 
