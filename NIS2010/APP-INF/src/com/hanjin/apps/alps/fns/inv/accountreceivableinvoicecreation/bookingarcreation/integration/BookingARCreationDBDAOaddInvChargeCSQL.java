...
*@FileName : BookingARCreationDBDAOaddInvChargeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOaddInvChargeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingARCreationDBDAOaddInvChargeCSQL
	  * </pre>
	  */
	public BookingARCreationDBDAOaddInvChargeCSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOaddInvChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${chg_full_nm} == '')" ).append("\n"); 
		query.append(",(SELECT DECODE(@[chg_cd], 'JOP','TERMINAL STEVEDORAGE','CRC', 'MIS. REVENUE(CNTR) - EQ RENTAL',CHG_NM) FROM MDM_CHARGE WHERE CHG_CD = @[chg_cd])" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(",@[chg_full_nm]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append(",(SELECT AR_CTR_CD" ).append("\n"); 
		query.append("  FROM  (" ).append("\n"); 
		query.append("          SELECT SUBSTR(AR_CTR_CD,2) AR_CTR_CD" ).append("\n"); 
		query.append("          FROM ( SELECT '1'||AR_CTR_CD  AR_CTR_CD FROM MDM_ORGANIZATION WHERE OFC_CD = @[ofc_cd] " ).append("\n"); 
		query.append("                 UNION ALL" ).append("\n"); 
		query.append("                 SELECT '2'||INV_COA_CTR_CD AR_CTR_CD FROM INV_AR_AMT WHERE AR_IF_NO = @[ar_if_no] AND ROWNUM = 1" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		query.append("          WHERE  LENGTH(AR_CTR_CD) > 6  " ).append("\n"); 
		query.append("          ORDER BY AR_CTR_CD DESC" ).append("\n"); 
		query.append("        )" ).append("\n"); 
		...
		query.append(",@[chg_rmk]" ).append("\n"); 
		query.append(",NVL(@[mnl_flg],'N') " ).append("\n"); 
		query.append(",NVL(@[mf_div_cd],'N') -- 30" ).append("\n"); 
		query.append(",@[cre_usr_id]" ).append("\n"); 
		...
		query.append(",@[ar_if_chg_seq]" ).append("\n"); 
		query.append(",@[ttl_lss_cfm_flg]" ).append("\n"); 
		query.append(",(DECODE(@[ofc_cd], 'BOMSC', (SELECT IDA_SAC_CD FROM MDM_CHARGE WHERE CHG_CD = @[chg_cd]), ''))" ).append("\n"); 
		query.append(")" ).append("\n"); 
