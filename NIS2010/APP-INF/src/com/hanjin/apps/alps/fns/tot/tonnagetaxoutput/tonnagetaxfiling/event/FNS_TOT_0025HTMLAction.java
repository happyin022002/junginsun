...
*@FileName : FNS_TOT_0025HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
 ...
 * @see FnsTot0025Event 참조
 * @since J2EE 1.4
 */

public class FNS_TOT_0025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	
	/**
	 * FNS_TOT_0025HTMLAction 객체를 생성
	 */
	public FNS_TOT_0025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0025Event event = new FnsTot0025Event();
        log.debug("::CALL::> FNS_TOT_0025HTMLAction - " + command.getCommand());
