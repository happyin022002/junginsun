...
*@FileName : GeneralARInvoiceMasterDataMgtDBDAOremoveSurchargeDescriptionListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceMasterDataMgtDBDAOremoveSurchargeDescriptionListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * removeSurchargeDescriptionList
	  * </pre>
	  */
	public GeneralARInvoiceMasterDataMgtDBDAOremoveSurchargeDescriptionListDSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceMasterDataMgtDBDAOremoveSurchargeDescriptionListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
