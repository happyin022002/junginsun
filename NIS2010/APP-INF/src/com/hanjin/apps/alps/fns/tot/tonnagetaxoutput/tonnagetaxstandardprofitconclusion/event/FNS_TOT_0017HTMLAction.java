...
*@FileName : FNS_TOT_0017HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0001HTMLAction 객체를 생성
	 */
	public FNS_TOT_0017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0017Event event = new FnsTot0017Event();
        log.debug("::CALL::> FNS_TOT_0017HTMLAction - " + command.getCommand());

		event.setVvdStlAmtVO((VvdStlAmtVO)getVO(request, VvdStlAmtVO.class));
			
		if(command.isCommand(FormCommand.MULTI)) {
			 log.debug("::CALL::> MULTI ::::::::: ");
			 event.setVvdStlAmtVOs((VvdStlAmtVO[])getVOs(request, VvdStlAmtVO.class,"sheet1_"));
		}
