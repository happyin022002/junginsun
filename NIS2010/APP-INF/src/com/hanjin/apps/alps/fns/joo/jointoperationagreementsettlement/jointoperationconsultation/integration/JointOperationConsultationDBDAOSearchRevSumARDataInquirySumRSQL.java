...
*@FileName : JointOperationConsultationDBDAOSearchRevSumARDataInquirySumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationConsultationDBDAOSearchRevSumARDataInquirySumRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchRevSumARDataInquirySum
	  * </pre>
	  */
	public JointOperationConsultationDBDAOSearchRevSumARDataInquirySumRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationConsultationDBDAOSearchRevSumARDataInquirySumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CSR_LOCL_AMT," ).append("\n"); 
		query.append("STL_USD_AMT," ).append("\n"); 
		query.append("LOCL_CURR_CD" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("SUM(DECODE(S.RE_DIVR_CD, 'R', SL.CSR_LOCL_AMT / DECODE (S.JO_CRR_CD, 'USD', 1, (" ).append("\n"); 
