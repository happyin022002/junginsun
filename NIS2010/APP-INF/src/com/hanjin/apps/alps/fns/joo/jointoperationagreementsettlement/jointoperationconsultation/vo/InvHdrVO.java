...
public class InvHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvHdrVO> models = new ArrayList<InvHdrVO>();
	 ...
	 * @return InvHdrVO[]
	 */
	public InvHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvHdrVO[]
	 */
	public InvHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvHdrVO model = null;
	 ...
	 * @return InvHdrVO[]
	 */
	public InvHdrVO[] getInvHdrVOs(){
		InvHdrVO[] vos = (InvHdrVO[])models.toArray(new InvHdrVO[models.size()]);
		return vos;
	}
