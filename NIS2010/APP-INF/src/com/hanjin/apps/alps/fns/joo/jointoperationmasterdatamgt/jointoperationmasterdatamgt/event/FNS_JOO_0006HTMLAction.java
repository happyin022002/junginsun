...
*@FileName : FNS_JOO_0006HTMLAction.java
...
public class FNS_JOO_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0006HTMLAction 객체를 생성
	 */
	public FNS_JOO_0006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0006Event event = new FnsJoo0006Event();

		event.setMstComInputVO((MstComInputVO)getVO(request, MstComInputVO .class));
		if(command.isCommand(FormCommand.MULTI)) {
			event.setJooCrrMrgVOS((JooCrrMrgVO[])getVOs(request, JooCrrMrgVO .class,"sheet1_"));
