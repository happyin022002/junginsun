...
*@FileName : AccountReceivableEDISendDBDAOSearchEdiDHLListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchEdiDHLListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchEdiDHLListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchEdiDHLListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM (SELECT A.BL_SRC_NO BL_SRC_NO," ).append("\n"); 
		...
		query.append("        'D' AS INV_EDI_KND_CD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("      GROUP BY A.BL_SRC_NO, A.POL_CD, A.POD_CD, C.INV_NO, C.ISS_DT, A.DUE_DT" ).append("\n"); 
