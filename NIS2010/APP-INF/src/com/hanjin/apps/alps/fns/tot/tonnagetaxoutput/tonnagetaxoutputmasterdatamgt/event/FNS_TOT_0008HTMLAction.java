...
*@FileName : FNS_TOT_0008HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0001HTMLAction 객체를 생성
	 */
	public FNS_TOT_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0008Event event = new FnsTot0008Event();
        log.debug("::CALL::> FNS_TOT_0008HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.MULTI)) {
			 log.debug("::CALL::> MULTI ::::::::: ");
			 event.setPndlmPortVOs((PndlmPortVO[])getVOs(request, PndlmPortVO.class,"sheet1_"));
			 event.setOtherPndlmPortVOs((PndlmPortVO[])getVOs(request, PndlmPortVO.class,"sheet2_"));
	          
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setPndlmPortVO((PndlmPortVO)getVO(request, PndlmPortVO.class));
