...
*@FileName : JointOperationLetterDBDAORemoveMcsLetterDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationLetterDBDAORemoveMcsLetterDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationLetterDBDAORemoveMcsLetterDSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationLetterDBDAORemoveMcsLetterDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
