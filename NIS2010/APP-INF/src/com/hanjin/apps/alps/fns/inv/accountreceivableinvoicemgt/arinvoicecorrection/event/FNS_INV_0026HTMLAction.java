...
*@FileName : FNS_INV_0026HTMLAction.java
...
public class FNS_INV_0026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0026HTMLAction 객체를 생성
	 */
	public FNS_INV_0026HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {		
		...
		FnsInv0026Event event = new FnsInv0026Event();		

		if(command.isCommand(FormCommand.SEARCH)) {			
			event.setInvByVVDVo((InvByVVDVO)getVO(request, InvByVVDVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {	
			event.setARInvoiceListByVesselVOS((ARInvoiceListByVesselVO[])getVOs(request, ARInvoiceListByVesselVO .class,""));		
