...
*@FileName : FNS_INV_0002HTMLAction.java
...
public class FNS_INV_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0002HTMLAction 객체를 생성
	 */
	public FNS_INV_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {		
		...
		FnsInv0002Event event = new FnsInv0002Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			//event.setTaxInvoiceVO((TaxInvoiceVO)getVO(request, TaxInvoiceVO .class));
			event.setTaxInquiryVO((TaxInquiryVO)getVO(request, TaxInquiryVO .class));
		}
