...
public class VslVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VslVO> models = new ArrayList<VslVO>();
	...
	public VslVO(String ibflag, String pagerows, String stlYr, String vslCd, String vslSeq, String tongFletTpCd, String ctrtStDt, String ctrtEndDt, String ldbCapaQty, String deltFlg, String vslRmk, String creDt, String creUsrId, String updDt, String updUsrId, String vslEngNm, String effDt, String expDt) {
		this.updDt = updDt;
		this.stlYr = stlYr;
		this.vslCd = vslCd;
		this.vslRmk = vslRmk;
	 ...
	 * @return VslVO[]
	 */
	public VslVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VslVO[]
	 */
	public VslVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VslVO model = null;
	...
	public VslVO[] getVslVOs(){
		VslVO[] vos = (VslVO[])models.toArray(new VslVO[models.size()]);
		return vos;
	}
