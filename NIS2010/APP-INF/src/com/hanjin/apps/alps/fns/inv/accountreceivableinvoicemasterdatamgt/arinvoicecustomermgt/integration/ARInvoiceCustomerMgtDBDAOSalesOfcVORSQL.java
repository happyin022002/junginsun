...
*@FileName : ARInvoiceCustomerMgtDBDAOSalesOfcVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ARInvoiceCustomerMgtDBDAOSalesOfcVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ARInvoiceCustomerMgtDBDAOSalesOfcVORSQL(){
		setQuery();
		...
		query.append("FileName : ARInvoiceCustomerMgtDBDAOSalesOfcVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                          FROM MDM_ORGANIZATION" ).append("\n"); 
		query.append("                          WHERE OFC_CD = (SELECT AR_OFC_CD FROM MDM_ORGANIZATION" ).append("\n"); 
		query.append("											WHERE OFC_CD = @[userofc]))" ).append("\n"); 
