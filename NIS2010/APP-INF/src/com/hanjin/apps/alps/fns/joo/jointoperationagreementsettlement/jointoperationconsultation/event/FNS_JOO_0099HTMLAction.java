...
public class FNS_JOO_0099HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0099HTMLAction 객체를 생성
	 */
	public FNS_JOO_0099HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0099Event event = new FnsJoo0099Event();
		
		event.setCsrNo(request.getParameter("csr_no"));		
		if(command.isCommand(FormCommand.MULTI)){			
			event.setAgmtDocVOS((AgmtDocVO[])getVOs(request, AgmtDocVO .class,"sheet1_"));
