...
*@FileName : FNS_JOO_0029HTMLAction.java
...
public class FNS_JOO_0029HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0029HTMLAction 객체를 생성
	 */
	public FNS_JOO_0029HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0029Event event = new FnsJoo0029Event();
		
		event.setSettlementConditionVO( (SettlementConditionVO)getVO(request, SettlementConditionVO .class) );
		...
		if(command.isCommand(FormCommand.MULTI)) {
			event.setEstmActRsltVOs((EstmActRsltVO[])getVOs(request, EstmActRsltVO.class, "sheet1_"));
