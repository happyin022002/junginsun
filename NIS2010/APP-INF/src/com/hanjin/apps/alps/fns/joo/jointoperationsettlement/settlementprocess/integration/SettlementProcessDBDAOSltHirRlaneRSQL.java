...
*@FileName : SettlementProcessDBDAOSltHirRlaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOSltHirRlaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOSltHirRlaneRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOSltHirRlaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
