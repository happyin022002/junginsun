...
*@FileName : TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVORSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",(SELECT DECODE(M.VSL_SVC_TP_CD, 'I', 'Independent Operation'," ).append("\n"); 
		query.append("                                 'J', 'Joint Operation'," ).append("\n"); 
		query.append("                                 'O', 'CCA Feeder'," ).append("\n"); 
		query.append("                                 'S', 'Space Charter')" ).append("\n"); 
		query.append("  FROM MDM_VSL_SVC_LANE M" ).append("\n"); 
		query.append("  WHERE M.VSL_SLAN_CD = A.SLAN_CD" ).append("\n"); 
		query.append(" ) VSL_SVC_TP_NM" ).append("\n"); 
		...
		query.append("--2010.05.04 FEEDER 인 것은 뺀 것중에서 MAX SEQ를 구한다." ).append("\n"); 
