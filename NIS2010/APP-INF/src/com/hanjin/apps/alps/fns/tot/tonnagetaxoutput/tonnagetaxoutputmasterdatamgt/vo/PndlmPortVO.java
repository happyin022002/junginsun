...
*@FileName : PndlmPortVO.java
*@FileTitle : PndlmPortVO
*Open Issues :
*Change history :
...
public class PndlmPortVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PndlmPortVO> models = new ArrayList<PndlmPortVO>();
	...
	public PndlmPortVO(String ibflag, String pagerows, String stlYrmon, String trdCd, String slanCd, String skdDirCd, String pndlmStEndPortTpCd, String portCd, String portNm, String clptSeq, String creDt, String creUsrId, String updDt, String updUsrId) {
		this.updDt = updDt;
	 ...
	 * @return PndlmPortVO[]
	 */
	public PndlmPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PndlmPortVO[]
	 */
	public PndlmPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PndlmPortVO model = null;
		...
		try {
			...
			String[] pndlmStEndPortTpCd = (JSPUtil.getParameter(request, prefix	+ "pndlm_st_end_port_tp_cd", length));
	...
	public PndlmPortVO[] getPndlmPortVOs(){
		PndlmPortVO[] vos = (PndlmPortVO[])models.toArray(new PndlmPortVO[models.size()]);
		return vos;
	}
