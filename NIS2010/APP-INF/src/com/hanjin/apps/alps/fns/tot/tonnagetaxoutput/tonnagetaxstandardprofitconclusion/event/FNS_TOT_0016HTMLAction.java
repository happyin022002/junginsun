...
*@FileName : FNS_TOT_0016HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0001HTMLAction 객체를 생성
	 */
	public FNS_TOT_0016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0016Event event = new FnsTot0016Event();
        log.debug("::CALL::> FNS_TOT_0016HTMLAction - " + command.getCommand());

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFdrStlAmtVO((FdrStlAmtVO)getVO(request, FdrStlAmtVO.class));
			
		}else if(command.isCommand(FormCommand.MULTI)) {
			 log.debug("::CALL::> MULTI ::::::::: ");
			 event.setFdrStlAmtVOs((FdrStlAmtVO[])getVOs(request, FdrStlAmtVO.class,"sheet1_"));
		}
