...
public class MDMCustomerVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFndtDt(JSPUtil.getParameter(request, "fndt_dt", ""));
		setCntrDivFlg(JSPUtil.getParameter(request, "cntr_div_flg", ""));
		setKeyAcctEndEffDt(JSPUtil.getParameter(request, "key_acct_end_eff_dt", ""));
		setAddr(JSPUtil.getParameter(request, "addr", ""));
		setPrfCntrTpszCd(JSPUtil.getParameter(request, "prf_cntr_tpsz_cd", ""));
		setBlkCustTpCd(JSPUtil.getParameter(request, "blk_cust_tp_cd", ""));
		setSrepCd(JSPUtil.getParameter(request, "srep_cd", ""));
		setKeyAcctStEffDt(JSPUtil.getParameter(request, "key_acct_st_eff_dt", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setNvoccHjsScacCd(JSPUtil.getParameter(request, "nvocc_hjs_scac_cd", ""));
		setNvoccBdAmt(JSPUtil.getParameter(request, "nvocc_bd_amt", ""));
		setRvisCntrCustTpCd(JSPUtil.getParameter(request, "rvis_cntr_cust_tp_cd", ""));
		setBkgAltToDt(JSPUtil.getParameter(request, "bkg_alt_to_dt", ""));
		...
		setKeyAcctMgrUsrNm(JSPUtil.getParameter(request, "key_acct_mgr_usr_nm", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setCustCntCd(JSPUtil.getParameter(request, "cust_cnt_cd", ""));
		setCustGrpId(JSPUtil.getParameter(request, "cust_grp_id", ""));
		setNvoccBdStEffDt(JSPUtil.getParameter(request, "nvocc_bd_st_eff_dt", ""));
		setBkgAltCreDt(JSPUtil.getParameter(request, "bkg_alt_cre_dt", ""));
		setInvIssCurrTpCd(JSPUtil.getParameter(request, "inv_iss_curr_tp_cd", ""));
		setFincStsLvlCd(JSPUtil.getParameter(request, "finc_sts_lvl_cd", ""));
		...
		setSpclReqDesc(JSPUtil.getParameter(request, "spcl_req_desc", ""));
		setNbsClssCd1(JSPUtil.getParameter(request, "nbs_clss_cd1", ""));
		setCapiAmt(JSPUtil.getParameter(request, "capi_amt", ""));
		setNbsClssCd2(JSPUtil.getParameter(request, "nbs_clss_cd2", ""));
		setBkgAltFmDt(JSPUtil.getParameter(request, "bkg_alt_fm_dt", ""));
		setBkgAltRsn(JSPUtil.getParameter(request, "bkg_alt_rsn", ""));
		...
		setCustAbbrNm(JSPUtil.getParameter(request, "cust_abbr_nm", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setCrmRowId(JSPUtil.getParameter(request, "crm_row_id", ""));
		setPrfGrpCmdtCd(JSPUtil.getParameter(request, "prf_grp_cmdt_cd", ""));
		setCustRgstNo(JSPUtil.getParameter(request, "cust_rgst_no", ""));
		setCustStsCd(JSPUtil.getParameter(request, "cust_sts_cd", ""));
		setLstkFlg(JSPUtil.getParameter(request, "lstk_flg", ""));
		setNvoccBdEndEffDt(JSPUtil.getParameter(request, "nvocc_bd_end_eff_dt", ""));
		setRfndPsdoVndrSeq(JSPUtil.getParameter(request, "rfnd_psdo_vndr_seq", ""));
		...
		setPrfRepCmdtCd(JSPUtil.getParameter(request, "prf_rep_cmdt_cd", ""));
		setCapiCurrCd(JSPUtil.getParameter(request, "capi_curr_cd", ""));
		setEaiEvntDt(JSPUtil.getParameter(request, "eai_evnt_dt", ""));
		setCustSeq(JSPUtil.getParameter(request, "cust_seq", ""));
		setIndusDesc(JSPUtil.getParameter(request, "indus_desc", ""));
		setOfcCd(JSPUtil.getParameter(request, "ofc_cd", ""));
		setPrfSvcDesc(JSPUtil.getParameter(request, "prf_svc_desc", ""));
		setBkgAltMsg(JSPUtil.getParameter(request, "bkg_alt_msg", ""));
		setCrntVolKnt(JSPUtil.getParameter(request, "crnt_vol_knt", ""));
		setCtsNo(JSPUtil.getParameter(request, "cts_no", ""));
		setModiCustCntCd(JSPUtil.getParameter(request, "modi_cust_cnt_cd", ""));
		setEmpeKnt(JSPUtil.getParameter(request, "empe_knt", ""));
		setPrfSvcDtlDesc(JSPUtil.getParameter(request, "prf_svc_dtl_desc", ""));
		setBkgAltCreUsrId(JSPUtil.getParameter(request, "bkg_alt_cre_usr_id", ""));
	...
	public MDMCustomerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] addr = (JSPUtil.getParameter(request, prefix	+ "addr", length));
