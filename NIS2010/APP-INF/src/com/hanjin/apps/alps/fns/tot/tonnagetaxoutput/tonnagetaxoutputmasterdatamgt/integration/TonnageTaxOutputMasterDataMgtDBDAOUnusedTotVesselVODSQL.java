...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Unused Vessel Over 30 Days delelte
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVODSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOUnusedTotVesselVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM TOT_VESSEL" ).append("\n"); 
