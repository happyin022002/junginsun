...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAOSearchLaneTradeGroupForCreateTOTLANERSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAOSearchLaneTradeGroupForCreateTOTLANERSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Vsl 스케줄에서 해당월별로 실제 운항한 Lane 정보와 trade 를 가져와 조회하고 유저가 lane 별 trade 를 검토 수정할수 있도록 해당 데이터 조회
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAOSearchLaneTradeGroupForCreateTOTLANERSQL(){
		setQuery();
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAOSearchLaneTradeGroupForCreateTOTLANERSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT M.VSL_SLAN_CD" ).append("\n"); 
