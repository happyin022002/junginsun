...
*@FileName : TonnageTaxOutputMasterDataMgtDBDAORcUpPndlmVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxOutputMasterDataMgtDBDAORcUpPndlmVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * pendulum 의 최근 업데이트 일자 조회
	  * </pre>
	  */
	public TonnageTaxOutputMasterDataMgtDBDAORcUpPndlmVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : TonnageTaxOutputMasterDataMgtDBDAORcUpPndlmVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}