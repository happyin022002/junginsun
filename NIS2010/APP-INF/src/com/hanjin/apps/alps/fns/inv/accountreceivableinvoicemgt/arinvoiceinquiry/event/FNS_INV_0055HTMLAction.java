...
*@FileName : FNS_INV_0055HTMLAction.java
...
public class FNS_INV_0055HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0055HTMLAction 객체를 생성
	 */
	public FNS_INV_0055HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0055Event event = new FnsInv0055Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInvoiceIssueListInputVO((InvoiceIssueListInputVO)getVO(request, InvoiceIssueListInputVO .class));
		}
