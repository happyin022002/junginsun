...
*@FileName : JoTmpltNoVO.java
*@FileTitle : JoTmpltNoVO
*Open Issues :
*Change history :
...
public class JoTmpltNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<JoTmpltNoVO> models = new ArrayList<JoTmpltNoVO>();
	...
	public JoTmpltNoVO(String ibflag, String pagerows, String code, String name, String ofcCd, String joLtrTpCd, String userId) {
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
	 ...
	 * @return JoTmpltNoVO[]
	 */
	public JoTmpltNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JoTmpltNoVO[]
	 */
	public JoTmpltNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JoTmpltNoVO model = null;
	 ...
	 * @return JoTmpltNoVO[]
	 */
	public JoTmpltNoVO[] getJoTmpltNoVOs(){
		JoTmpltNoVO[] vos = (JoTmpltNoVO[])models.toArray(new JoTmpltNoVO[models.size()]);
		return vos;
	}
