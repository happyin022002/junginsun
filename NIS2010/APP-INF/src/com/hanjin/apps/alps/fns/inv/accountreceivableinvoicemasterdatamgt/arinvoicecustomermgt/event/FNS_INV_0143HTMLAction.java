...
*@FileName : FNS_INV_0143HTMLAction.java
...
public class FNS_INV_0143HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0143HTMLAction 객체를 생성
	 */
	public FNS_INV_0143HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0143Event event = new FnsInv0143Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setArOfcCd(request.getParameter("office"));	
			event.setIoBndCd(request.getParameter("io_bnd_cd"));		
			event.setUserOfcCd(request.getParameter("user_ofc_cd"));	
