...
*@FileName : FNS_INV_0015HTMLAction.java
...
public class FNS_INV_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0015HTMLAction 객체를 생성
	 */
	public FNS_INV_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0015Event event = new FnsInv0015Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			//event.setCustomerListVO((CustomerListVO)getVO(request, CustomerListVO .class));
			event.setCustFlag(request.getParameter("cust_flag"));	
			event.setCustRlseCtrlFlg(request.getParameter("cust_rlse_ctrl_flg"));
			event.setOfcCd(request.getParameter("ofc2"));
		}
