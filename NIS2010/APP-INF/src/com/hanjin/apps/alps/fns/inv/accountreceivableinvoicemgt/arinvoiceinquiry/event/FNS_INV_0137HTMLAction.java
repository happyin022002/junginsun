...
*@FileName : FNS_INV_0137HTMLAction.java
...
public class FNS_INV_0137HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0137HTMLAction 객체를 생성
	 */
	public FNS_INV_0137HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0137Event event = new FnsInv0137Event();
		if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setBlNos(request.getParameter("bl_nos"));
			//event.setCustomerListByBLVO((CustomerListByBLVO)getVO(request, CustomerListByBLVO .class));
		}
