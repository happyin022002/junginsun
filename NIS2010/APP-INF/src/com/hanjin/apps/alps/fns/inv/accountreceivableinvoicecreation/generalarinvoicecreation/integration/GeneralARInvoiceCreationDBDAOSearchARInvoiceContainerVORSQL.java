...
*@FileName : GeneralARInvoiceCreationDBDAOSearchARInvoiceContainerVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceCreationDBDAOSearchARInvoiceContainerVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralARInvoiceCreationDBDAOSearchARInvoiceContainerVORSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceCreationDBDAOSearchARInvoiceContainerVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
