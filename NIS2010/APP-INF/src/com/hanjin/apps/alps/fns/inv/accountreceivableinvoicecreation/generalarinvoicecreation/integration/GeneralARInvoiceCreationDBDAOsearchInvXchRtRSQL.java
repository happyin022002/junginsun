...
*@FileName : GeneralARInvoiceCreationDBDAOsearchInvXchRtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceCreationDBDAOsearchInvXchRtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GeneralARInvoiceCreationDBDAOsearchInvXchRtRSQL
	  * </pre>
	  */
	public GeneralARInvoiceCreationDBDAOsearchInvXchRtRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceCreationDBDAOsearchInvXchRtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(INV_XCH_RT, 0) INV_XCH_RT" ).append("\n"); 
