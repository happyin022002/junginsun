...
*@FileName : AccountReceivableEDISendDBDAOsearchEdiMGBListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOsearchEdiMGBListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOsearchEdiMGBListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOsearchEdiMGBListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  T03.AR_IF_NO" ).append("\n"); 
		query.append("		,T03.ISS_DT" ).append("\n"); 
		...
		query.append("        ,T03.CHG_CD AS CHG_TP_CD " ).append("\n"); 
		...
		query.append("        --,'HJSC' AS NIKE_CRR_ID " ).append("\n"); 
		...
		query.append("		 T02.AR_IF_NO " ).append("\n"); 
		...
		query.append("						AND T1.AR_OFC_CD  IN (SELECT DISTINCT DECODE (A.N3PTY_RCV_OFC_CD,'HKGSC',A.N3PTY_RCV_OFC_CD,B.PPD_RCV_OFC_CD) OFC_CD " ).append("\n"); 
		query.append("                                           FROM BKG_CHG_RT A, BKG_RATE B" ).append("\n"); 
		query.append("                                           WHERE A.BKG_NO =  B.BKG_NO" ).append("\n"); 
		query.append("                                           AND A.BKG_NO = T1.BL_SRC_NO" ).append("\n"); 
		...
		query.append("AND     T03.TRF_RT_AMT > 0" ).append("\n"); 
		query.append("AND     A.ACK_SNDR_ID(+) = 'MGB'" ).append("\n"); 
