 ...
 * @FileName : ADIDASInputVO.java
 * @FileTitle : ADIDASInputVO
 * Open Issues :
 * Change history :
 * @LastModifyDate : 2016.01.15
 * @LastModifier : 백승일
 * @LastVersion : 1.0
 * 2016.01.15 백승일 1.0 Creation
 */
...
public class ADIDASInputVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ADIDASInputVO> models = new ArrayList<ADIDASInputVO>();
	...
	public ADIDASInputVO() {}

	public ADIDASInputVO(String ibflag, String pagerows, String blSrcNo, String fmDt, String sentStat, String actCustSeq, String vvd, String toDt, String invNo, String ofcCd, String changeType, String actCustCntCd, String retrOpt, String invCustCntCd, String invCustSeq ) {
...
/**
	 ...
	 */
	public ADIDASInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ADIDASInputVO[]
	 */
	public ADIDASInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ADIDASInputVO model = null;
	 ...
	 * @return ADIDASInputVO[]
	 */
	public ADIDASInputVO[] getADIDASInputVOs(){
		ADIDASInputVO[] vos = (ADIDASInputVO[])models.toArray(new ADIDASInputVO[models.size()]);
		return vos;
	}
