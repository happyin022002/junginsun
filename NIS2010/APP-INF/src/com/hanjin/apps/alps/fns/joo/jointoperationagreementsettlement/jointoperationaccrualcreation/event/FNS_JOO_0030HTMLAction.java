...
*@FileName : UI_JOO_0030HTMLAction.java
*@FileTitle : 공동운항추정 산출
*Open Issues :
*Change history :
...
public class FNS_JOO_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_JOO_0030HTMLAction 객체를 생성
	 */
	public FNS_JOO_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0030Event event = new FnsJoo0030Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setJooEstmClzVOS((JooEstmClzVO[])getVOs(request, JooEstmClzVO .class,"sheet1_"));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setJooEstmClzVO((JooEstmClzVO)getVO(request, JooEstmClzVO .class));
		}
