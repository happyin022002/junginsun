...
public class ARInvoiceInquiryDBDAOSearchARInvoiceMainRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  A.HJS_STF_CTNT," ).append("\n"); 
		...
		query.append("                    'SGNSC', " ).append("\n"); 
		query.append("                    (SELECT DISTINCT INV_NO FROM INV_AR_ISS_DTL WHERE AR_IF_NO = A.AR_IF_NO AND INV_NO LIKE 'F%' AND ROWNUM = 1),  -- AR_OFC_CD가 SGNSC인 경우는 FRT인 INV정보만 조회한다. (2009-12-16)" ).append("\n"); 
