...
*@FileName : FNS_INV_0080HTMLAction.java
...
public class FNS_INV_0080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0080HTMLAction 객체를 생성
	 */
	public FNS_INV_0080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0080Event event = new FnsInv0080Event();
		log.info("sssssssss");
