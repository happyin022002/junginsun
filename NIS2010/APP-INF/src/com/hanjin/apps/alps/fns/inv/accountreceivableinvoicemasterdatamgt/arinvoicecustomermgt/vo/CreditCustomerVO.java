...
public class CreditCustomerVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		setPayDtDy5(JSPUtil.getParameter(request, "pay_dt_dy5", ""));
		setPayWkDyCd(JSPUtil.getParameter(request, "pay_wk_dy_cd", ""));
		setPayTpCd(JSPUtil.getParameter(request, "pay_tp_cd", ""));
