...
*@FileName : JointOperationMasterDataMgtDBDAOBzcAgmtCrrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationMasterDataMgtDBDAOBzcAgmtCrrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationMasterDataMgtDBDAOBzcAgmtCrrRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationMasterDataMgtDBDAOBzcAgmtCrrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        ROW_NUMBER() OVER( PARTITION BY B.JO_REF_NO ORDER BY B.CRE_DT, B.JO_CRR_CD ) RN#" ).append("\n"); 
