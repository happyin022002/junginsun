...
*@FileName : JOOFindCodeAndCheckDBDAOVslCodeWithoutAuthorityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAOVslCodeWithoutAuthorityRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VslCodeWithoutAuthority
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAOVslCodeWithoutAuthorityRSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAOVslCodeWithoutAuthorityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT V.VSL_CD AS CODE, V.VSL_CD AS NAME" ).append("\n"); 
		...
		query.append("AND    V.VPS_ETD_DT < SYSDATE + 365" ).append("\n"); 
		query.append("ORDER BY V.VSL_CD" ).append("\n"); 
