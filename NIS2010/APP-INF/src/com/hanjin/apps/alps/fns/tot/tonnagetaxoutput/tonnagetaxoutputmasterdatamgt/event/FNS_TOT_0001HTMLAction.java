...
*@FileName : FNS_TOT_0001HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0001HTMLAction 객체를 생성
	 */
	public FNS_TOT_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0001Event event = new FnsTot0001Event();
        log.debug("::CALL::> FNS_TOT_0001HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.MULTI)) {
			 log.debug("::CALL::> MULTI ::::::::: ");
			event.setTotVesselVOs((TotVesselVO[])getVOs(request, TotVesselVO.class,"sheet1_"));
			TotVesselVO[] tot = (TotVesselVO[])getVOs(request, TotVesselVO.class,"sheet1_");
			
			for(int i =0; i<tot.length; i++){
				log.debug("::getIbflag ::::::::: "+tot[i].getIbflag());
				log.debug("::getVslSeq ::::::::: "+tot[i].getVslSeq());
				
			}
			log.debug("::CALL::> MULTI후 ::::::::: "+event.getTotVesselVOs());
			...
			event.setVslVO((VslVO)getVO(request, VslVO.class));
			//event.setTotVesselVOS((TotVesselVO[])getVOs(request, TotVesselVO.class,"sheet1_"));
			//TotVesselVO[] aa = ((TotVesselVO[])getVOs(request, TotVesselVO.class,"sheet1_"));
			//log.debug("::CALL::> FNS_TOT_0001HTMLAction ddddd vsl_cd :: " +aa[0].getVslCd());
