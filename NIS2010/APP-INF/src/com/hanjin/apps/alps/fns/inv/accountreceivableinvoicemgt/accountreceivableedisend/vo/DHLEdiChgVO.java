...
*@FileName : DHLEdiChgVO.java
*@FileTitle : DHLEdiChgVO
*Open Issues :
*Change history :
...
public class DHLEdiChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DHLEdiChgVO> models = new ArrayList<DHLEdiChgVO>();
	...
	public DHLEdiChgVO(String ibflag, String pagerows, String fcType, String fcText, String fcPertype, String fcRevenueton, String fcRate, String fcAmount, String fcRateCurr, String fcExchrate, String fcVatInd, String fcRemarks) {
		this.fcRate = fcRate;
...
/**
	 ...
	 * @return DHLEdiChgVO[]
	 */
	public DHLEdiChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DHLEdiChgVO[]
	 */
	public DHLEdiChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DHLEdiChgVO model = null;
	 ...
	 * @return DHLEdiChgVO[]
	 */
	public DHLEdiChgVO[] getDHLEdiChgVOs(){
		DHLEdiChgVO[] vos = (DHLEdiChgVO[])models.toArray(new DHLEdiChgVO[models.size()]);
		return vos;
	}
