...
*@FileName : GeneralARInvoiceMasterDataMgtDBDAOInvArLoclChgVODSQL.java
...
public class GeneralARInvoiceMasterDataMgtDBDAOInvArLoclChgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralARInvoiceMasterDataMgtDBDAOInvArLoclChgVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM INV_AR_LOCL_CHG" ).append("\n"); 
		...
		query.append("FileName : GeneralARInvoiceMasterDataMgtDBDAOInvArLoclChgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}