...
public class GeneralARInvoiceCreationDBDAOsearchInvRevTpSrcCdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("					   , 'STO', DECODE(@[rev_tp_cd]||@[rev_src_cd], 'MOC', 'MOC', DECODE(SUBSTR(LOC_CD,1,2),'IN','XXX',@[rev_tp_cd]||@[rev_src_cd]))" ).append("\n"); 
		...
		query.append("														   --, 'MDF', '954112' " ).append("\n"); 
		query.append("                                                           , 'MRD', DECODE(@[chg_cd], 'XXX', NVL(@[acct_cd],'954113'), @[acct_cd])" ).append("\n"); 
