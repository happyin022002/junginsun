...
public class CarrierSettlementProcessDBDAOAdjustOusRDRVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       COA_TEU, COA_WGT, FNL_HJS_BSA_QTY, FNL_BSA_WGT, DIFF_TEU, DIFF_WGT, USD_SLT_BSA_QTY, USD_SLT_WGT, RDR_TEU, RDR_WGT, BSA_QTY, UC_AMT, BSA_SLT_PRC" ).append("\n"); 
		...
		query.append("       NVL(A.TEU,0) AS COA_TEU, NVL(A.WGT,0) AS COA_WGT, J.FNL_HJS_BSA_QTY, J.FNL_BSA_WGT, NVL(A.TEU,0) - J.FNL_HJS_BSA_QTY AS DIFF_TEU, NVL(A.WGT,0) - J.FNL_BSA_WGT AS DIFF_WGT," ).append("\n"); 
		...
		query.append("              J.JO_STL_ITM_CD, J.FNL_HJS_BSA_QTY, J.FNL_BSA_WGT, J.USD_SLT_BSA_QTY, J.USD_SLT_WGT, J.BSA_QTY, J.BSA_SLT_PRC, J.LOCL_CURR_CD" ).append("\n"); 
