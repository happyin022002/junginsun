...
*@FileName : FNS_INV_0074HTMLAction.java
...
public class FNS_INV_0074HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0074HTMLAction 객체를 생성
	 */
	public FNS_INV_0074HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0074Event event = new FnsInv0074Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setInvArScrVOs((InvArScrVO[])getVOs(request, InvArScrVO .class,""));
		}
