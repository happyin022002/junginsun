...
public class FNS_JOO_0086HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI)) {
			event.setBzcAgmtCrrVOs((BzcAgmtCrrVO[])getVOs(request, BzcAgmtCrrVO .class,"sheet1_"));
		}else if(command.isCommand(FormCommand.SEARCH)) {
			event.setBzcAgmtCrrVO((BzcAgmtCrrVO)getVO(request, BzcAgmtCrrVO .class));
