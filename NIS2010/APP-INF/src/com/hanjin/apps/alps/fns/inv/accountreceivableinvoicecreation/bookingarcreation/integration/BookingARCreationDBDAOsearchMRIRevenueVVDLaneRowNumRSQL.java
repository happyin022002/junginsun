...
*@FileName : BookingARCreationDBDAOsearchMRIRevenueVVDLaneRowNumRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BookingARCreationDBDAOsearchMRIRevenueVVDLaneRowNumRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BookingARCreationDBDAOsearchMRIRevenueVVDLaneRowNumRSQL
	  * </pre>
	  */
	public BookingARCreationDBDAOsearchMRIRevenueVVDLaneRowNumRSQL(){
		setQuery();
		...
		query.append("FileName : BookingARCreationDBDAOsearchMRIRevenueVVDLaneRowNumRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
