...
*@FileName : FNS_INV_0109HTMLAction.java
...
public class FNS_INV_0109HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0109HTMLAction 객체를 생성
	 */
	public FNS_INV_0109HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0109Event event = new FnsInv0109Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInvoiceIssueDateVO((InvoiceIssueDateVO)getVO(request, InvoiceIssueDateVO .class));
		}
