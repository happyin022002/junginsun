...
*@FileName : JointOperationAgreementSettlemenDAOAddSignNBankCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationAgreementSettlemenDAOAddSignNBankCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationAgreementSettlemenDAOAddSignNBankCSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationAgreementSettlemenDAOAddSignNBankCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
