...
*@FileName : JointOperationMasterDataMgtDBDAOBsaInformationEntryListForTargetExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JointOperationMasterDataMgtDBDAOBsaInformationEntryListForTargetExcelRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BsaInformationEntryListForTargetExcel
	  * </pre>
	  */
	public JointOperationMasterDataMgtDBDAOBsaInformationEntryListForTargetExcelRSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationMasterDataMgtDBDAOBsaInformationEntryListForTargetExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,A4.CRR_BSA_CAPA           -- 20150911 추가" ).append("\n"); 
		query.append("        ,A3.REV_PORT_ETD_DT" ).append("\n"); 
		...
		query.append("    AND A4.CRR_BSA_CAPA > 0  -- 추가" ).append("\n"); 
		...
		query.append("		 , A.CRR_BSA_CAPA           -- 20150911 추가" ).append("\n"); 
		query.append("         , A.REV_PORT_ETD_DT" ).append("\n"); 
		...
		query.append("         , K.VPS_ETD_DT REV_PORT_ETD_DT" ).append("\n"); 
		...
		query.append("	 , DECODE(J.JO_BSA_TEU_QTY,NULL,A.CRR_BSA_CAPA,J.JO_BSA_TEU_QTY) AS JO_BSA_TEU_QTY          -- 20150911 추가" ).append("\n"); 
		...
		query.append("FROM BSA_ALL2 A, JOO_BSA_AGMT J, COM_USER U" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		...
		query.append("    AND REPLACE(A.YRWK, '-', '') BETWEEN @[fm_yr_wk] AND @[to_yr_wk]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("    AND A.REV_PORT_ETD_DT  BETWEEN  TO_DATE(@[fm_etd_dt] || '000000', 'YYYY-MM-DDHH24MISS') AND TO_DATE(@[to_etd_dt] || '235959', 'YYYY-MM-DDHH24MISS')  " ).append("\n"); 
		query.append("#end" ).append("\n"); 
