...
*@FileName : FNS_TOT_0022HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0022HTMLAction 객체를 생성
	 */
	public FNS_TOT_0022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0022Event event = new FnsTot0022Event();
        log.debug("::CALL::> FNS_TOT_0022HTMLAction - " + command.getCommand());
