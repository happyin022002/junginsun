...
*@FileName : AccountReceivableEDISendDBDAOSearchEdiHNWLMainRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableEDISendDBDAOSearchEdiHNWLMainRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Get Honey Well main info.
	  * </pre>
	  */
	public AccountReceivableEDISendDBDAOSearchEdiHNWLMainRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableEDISendDBDAOSearchEdiHNWLMainRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  CASE WHEN (SELECT COUNT(*) FROM INV_EDI_HNWL WHERE BL_SRC_NO = @[bl_src_no]) > 0 THEN 'Y'" ).append("\n"); 
