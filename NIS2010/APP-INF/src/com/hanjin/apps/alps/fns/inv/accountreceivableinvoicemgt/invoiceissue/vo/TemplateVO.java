...
public class TemplateVO extends AbstractValueObject {
	...
	private List<CPRTInvoiceVO> listCPRTInvoiceVO = null;
	...
	public TemplateVO(String ibflag, String pagerows, String rptTmpltNm) {
		this.ibflag = ibflag;
	...
	public List<CPRTInvoiceVO> getListCPRTInvoiceVO() {
		return listCPRTInvoiceVO;
	}

	public void setListCPRTInvoiceVO(List<CPRTInvoiceVO> listCPRTInvoiceVO) {
		this.listCPRTInvoiceVO = listCPRTInvoiceVO;
	}
