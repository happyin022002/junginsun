...
*@FileName : JOOFindCodeAndCheckDBDAORDRCarrierByPeriodAndServiceLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOOFindCodeAndCheckDBDAORDRCarrierByPeriodAndServiceLaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOOFindCodeAndCheckDBDAORDRCarrierByPeriodAndServiceLaneRSQL(){
		setQuery();
		...
		query.append("FileName : JOOFindCodeAndCheckDBDAORDRCarrierByPeriodAndServiceLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM RDR_SUMMARY H," ).append("\n"); 
