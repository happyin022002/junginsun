...
public class JointOperationConsultationDBDAOCombinedVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      CASE WHEN A.STL_ADJ_FLG = 'N' THEN 'I'" ).append("\n"); 
		query.append("      ELSE " ).append("\n"); 
		query.append("        DECODE(NVL(B.STL_LOCL_AMT,0), 0, 'R', 'I')" ).append("\n"); 
		...
		query.append("           AND DTL.ACCT_YRMON || DTL.JO_CRR_CD || DTL.STL_CMB_SEQ != REPLACE(@[acct_yrmon],'-','') || @[jo_crr_cd]" ).append("\n"); 
