...
public class ARInvoiceExRateMgtDBDAOSearchEURPortListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		MAX(A.INV_XCH_RT) INV_XCH_RT , --2010-01-09 ivs_xch_rt " ).append("\n"); 
		...
		query.append("GROUP BY B.VPS_PORT_CD, B.VSL_CD,B.SKD_VOY_NO,B.SKD_DIR_CD, B.VPS_ETA_DT,B.CLPT_SEQ,B.SLAN_CD" ).append("\n"); 
