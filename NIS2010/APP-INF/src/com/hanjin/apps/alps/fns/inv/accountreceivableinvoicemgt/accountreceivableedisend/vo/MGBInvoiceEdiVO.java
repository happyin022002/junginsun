...
*@FileName : MGBInvoiceEdiVO.java
*@FileTitle : MGBInvoiceEdiVO
*Open Issues :
*Change history :
...
public class MGBInvoiceEdiVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MGBInvoiceEdiVO> models = new ArrayList<MGBInvoiceEdiVO>();
	...
	public MGBInvoiceEdiVO() {}

	public MGBInvoiceEdiVO(String ibflag, String pagerows, String arIfNo, String issDt, String cntrNo, String blSrcNo, String invNo, String invSeq, String currCd, String ttlTrfRtAmt, String chgTpCd, String trfRtAmt, String nikeFrtModId, String nikeCrrId, String ediSndFlg, String chgSeq, String mergeChk, String ackRsltCd) {
		this.arIfNo = arIfNo;
...
/**
	 ...
	 * @param request
	 * @return MGBInvoiceEdiVO[]
	 */
	public MGBInvoiceEdiVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MGBInvoiceEdiVO[]
	 */
	public MGBInvoiceEdiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MGBInvoiceEdiVO model = null;
	...
	public MGBInvoiceEdiVO[] getMGBInvoiceEdiVOs(){
		MGBInvoiceEdiVO[] vos = (MGBInvoiceEdiVO[])models.toArray(new MGBInvoiceEdiVO[models.size()]);
		return vos;
	}
