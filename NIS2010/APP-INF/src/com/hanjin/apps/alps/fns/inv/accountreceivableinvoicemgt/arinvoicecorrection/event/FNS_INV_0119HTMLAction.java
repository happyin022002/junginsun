...
*@FileName : FNS_INV_0119HTMLAction.java
...
public class FNS_INV_0119HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0119HTMLAction 객체를 생성
	 */
	public FNS_INV_0119HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsInv0119Event event = new FnsInv0119Event();
		 
		if(command.isCommand(FormCommand.MULTI)) {
			InvArEuCntVatVO[] invArEuCntVatVOs = (InvArEuCntVatVO[]) getVOs(request, InvArEuCntVatVO.class);			
			event.setInvArEuCntVatVOs(invArEuCntVatVOs);			
		}
