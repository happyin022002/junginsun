...
*@FileName : SettlementProcessDBDAOJoLoadingCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOJoLoadingCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOJoLoadingCSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOJoLoadingCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",'I'				 		AS RF_SCG_STL_TP_CD ---" ).append("\n"); 
		query.append(",SUBSTR(@[rlane_cd],1,3)		AS SLAN_CD          ---                             " ).append("\n"); 
