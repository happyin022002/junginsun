...
public class TextNoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TextNoVO> models = new ArrayList<TextNoVO>();
	...
	public TextNoVO(String ibflag, String pagerows, String joTmpltNo, String joLtrTmpltSeq) {
	 ...
	 * @return TextNoVO[]
	 */
	public TextNoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TextNoVO[]
	 */
	public TextNoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TextNoVO model = null;
	...
	public TextNoVO[] getTextNoVOs(){
		TextNoVO[] vos = (TextNoVO[])models.toArray(new TextNoVO[models.size()]);
		return vos;
	}
