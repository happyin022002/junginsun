...
*@FileName : TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : TonnageTaxStandardProfitConclusionDBDAOTaxableAmountConfirmationByDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}