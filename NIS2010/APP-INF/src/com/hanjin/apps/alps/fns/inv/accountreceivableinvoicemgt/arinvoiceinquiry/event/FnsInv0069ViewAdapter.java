 ...
 *@FileName : FnsInv0069ViewAdapter.java
 ...
 * @since J2EE 1.5
 */
public class FnsInv0069ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = { "","ar_hd_qtr_ofc_cd","ar_ofc_cd","bl_src_no","sail_arr_dt","vvd","pol_cd","curr_cd","usd_amt",
				"","cust_code","cust_lgl_eng_nm","bkg_no","bl_inv_if_dt","ar_if_no","pod_cd","chg_amt","inr_amt" };
