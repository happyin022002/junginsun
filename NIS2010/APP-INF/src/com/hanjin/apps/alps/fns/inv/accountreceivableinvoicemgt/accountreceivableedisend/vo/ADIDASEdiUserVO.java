 ...
 * @FileName : ADIDASEdiUserVO.java
 * @FileTitle : ADIDASEdiUserVO
 * Open Issues :
 * Change history :
...
public class ADIDASEdiUserVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ADIDASEdiUserVO> models = new ArrayList<ADIDASEdiUserVO>();
	...
	public ADIDASEdiUserVO() {}

	public ADIDASEdiUserVO(String ibflag, String pagerows, String ptCtaContact, String ptComNbr) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public ADIDASEdiUserVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ADIDASEdiUserVO[]
	 */
	public ADIDASEdiUserVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ADIDASEdiUserVO model = null;
	 ...
	 * @return ADIDASEdiUserVO[]
	 */
	public ADIDASEdiUserVO[] getADIDASEdiUserVOs(){
		ADIDASEdiUserVO[] vos = (ADIDASEdiUserVO[])models.toArray(new ADIDASEdiUserVO[models.size()]);
		return vos;
	}
