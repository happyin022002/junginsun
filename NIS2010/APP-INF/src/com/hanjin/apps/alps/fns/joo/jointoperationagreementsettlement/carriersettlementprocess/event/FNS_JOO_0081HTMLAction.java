...
public class FNS_JOO_0081HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0081HTMLAction 객체를 생성
	 */
	public FNS_JOO_0081HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0081Event event = new FnsJoo0081Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setLoadingQtyVO((LoadingQtyVO)getVO(request, LoadingQtyVO .class));
		}
