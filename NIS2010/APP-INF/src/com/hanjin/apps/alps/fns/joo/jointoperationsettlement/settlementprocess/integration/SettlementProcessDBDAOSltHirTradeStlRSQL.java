...
*@FileName : SettlementProcessDBDAOSltHirTradeStlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOSltHirTradeStlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOSltHirTradeStlRSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOSltHirTradeStlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
