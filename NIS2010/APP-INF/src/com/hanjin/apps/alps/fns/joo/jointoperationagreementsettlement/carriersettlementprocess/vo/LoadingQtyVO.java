...
public class LoadingQtyVO extends AbstractValueObject {
	...
	public LoadingQtyVO(String ibflag, String pagerows, String vvd, String option, String ofcCd, String polCd, String skdDirCd, String clptSeq, String polCdCnt, String headerSql, String ratehc, String rate45, String mtCnt, String mt20Cnt, String mt40Cnt, String mtHcCnt, String mt45Cnt) {
		this.mtCnt = mtCnt;
	...
	public LoadingQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] option = (JSPUtil.getParameter(request, prefix	+ "option", length));
