...
*@FileName : ManualARCreationDBDAOsearchLocalChargeExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualARCreationDBDAOsearchLocalChargeExistRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchLocalChargeExist
	  * </pre>
	  */
	public ManualARCreationDBDAOsearchLocalChargeExistRSQL(){
		setQuery();
		...
		query.append("FileName : ManualARCreationDBDAOsearchLocalChargeExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
