...
*@FileName : BackEndJobVO.java
*@FileTitle : BackEndJobVO
*Open Issues :
*Change history :
...
public class BackEndJobVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BackEndJobVO> models = new ArrayList<BackEndJobVO>();
	...
	public BackEndJobVO(String ibflag, String pagerows, String backEndJobKey) {
		this.ibflag = ibflag;
	 ...
	 * @return BackEndJobVO[]
	 */
	public BackEndJobVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BackEndJobVO[]
	 */
	public BackEndJobVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BackEndJobVO model = null;
	 ...
	 * @return BackEndJobVO[]
	 */
	public BackEndJobVO[] getBackEndJobVOs(){
		BackEndJobVO[] vos = (BackEndJobVO[])models.toArray(new BackEndJobVO[models.size()]);
		return vos;
	}
