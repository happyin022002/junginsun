...
*@FileName : SettlementProcessDBDAOPicDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SettlementProcessDBDAOPicDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SettlementProcessDBDAOPicDSQL(){
		setQuery();
		...
		query.append("FileName : SettlementProcessDBDAOPicDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM JOO_STL_PIC J" ).append("\n"); 
