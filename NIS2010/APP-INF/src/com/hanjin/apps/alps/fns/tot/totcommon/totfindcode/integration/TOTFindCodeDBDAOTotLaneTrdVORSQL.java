...
*@FileName : TOTFindCodeDBDAOTotLaneTrdVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TOTFindCodeDBDAOTotLaneTrdVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * tot lane에 해당하는 trade를 조회
	  * </pre>
	  */
	public TOTFindCodeDBDAOTotLaneTrdVORSQL(){
		setQuery();
		...
		query.append("FileName : TOTFindCodeDBDAOTotLaneTrdVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT A.VSL_SLAN_CD SUPER_CD1" ).append("\n"); 
