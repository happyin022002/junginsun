...
public class JbSkdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<JbSkdVO> models = new ArrayList<JbSkdVO>();
	...
	public JbSkdVO(String ibflag, String pagerows, String updDt, String fromDt, String batItmNm, String creDt, String batId, String jbStatus, String jbId, String jbEndDt, String toDt, String jbStDt, String effDt, String creUsrId, String jbFmYrmon, String jbToYrmon, String updUsrId, String updChk) {
		this.updDt = updDt;
		this.fromDt = fromDt;
	 ...
	 * @return JbSkdVO[]
	 */
	public JbSkdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JbSkdVO[]
	 */
	public JbSkdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JbSkdVO model = null;
	...
	public JbSkdVO[] getJbSkdVOs(){
		JbSkdVO[] vos = (JbSkdVO[])models.toArray(new JbSkdVO[models.size()]);
		return vos;
	}
