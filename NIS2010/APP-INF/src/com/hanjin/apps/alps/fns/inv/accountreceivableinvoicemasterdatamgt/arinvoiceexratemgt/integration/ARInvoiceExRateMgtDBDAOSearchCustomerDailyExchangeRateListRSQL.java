...
public class ARInvoiceExRateMgtDBDAOSearchCustomerDailyExchangeRateListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("  AND (FM_DT BETWEEN REPLACE(@[fm_dt],'-','') AND REPLACE(@[to_dt],'-','') OR TO_DT BETWEEN REPLACE(@[fm_dt],'-','') AND REPLACE(@[to_dt],'-','') OR (REPLACE(@[fm_dt],'-','') BETWEEN  FM_DT AND TO_DT) OR (REPLACE(@[to_dt],'-','') BETWEEN FM_DT AND TO_DT))" ).append("\n"); 
