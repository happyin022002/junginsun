...
*@FileName : FNS_JOO_0096HTMLAction.java
...
public class FNS_JOO_0096HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_JOO_0096HTMLAction 객체를 생성
	 */
	public FNS_JOO_0096HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsJoo0096Event event = new FnsJoo0096Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setAdditionalSlotManageVOs((AdditionalSlotManageVO[])getVOs(request, AdditionalSlotManageVO .class,""));
		}else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setAdditionalSlotManageVO((AdditionalSlotManageVO)getVO(request, AdditionalSlotManageVO .class));
