...
*@FileName : FNS_TOT_0019HTMLAction.java
*@FileTitle : TOT
*Open Issues :
*Change history :
...
public class FNS_TOT_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_TOT_0019HTMLAction 객체를 생성
	 */
	public FNS_TOT_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		FnsTot0019Event event = new FnsTot0019Event();
        log.debug("::CALL::> FNS_TOT_0019HTMLAction - " + command.getCommand());
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTotStlCfmVO((TotStlCfmVO)getVO(request, TotStlCfmVO.class));
