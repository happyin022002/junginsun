...
*@FileName : GeneralARInvoiceCreationDBDAOPrcExecEnisLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralARInvoiceCreationDBDAOPrcExecEnisLogCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ENIS_LOG 테이블에 로그를 기록한다.
	  * </pre>
	  */
	public GeneralARInvoiceCreationDBDAOPrcExecEnisLogCSQL(){
		setQuery();
		...
		query.append("FileName : GeneralARInvoiceCreationDBDAOPrcExecEnisLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
