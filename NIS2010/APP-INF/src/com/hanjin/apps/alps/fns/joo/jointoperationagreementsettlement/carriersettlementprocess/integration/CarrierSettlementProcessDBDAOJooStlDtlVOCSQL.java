...
*@FileName : CarrierSettlementProcessDBDAOJooStlDtlVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAOJooStlDtlVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAOJooStlDtlVOCSQL(){
		setQuery();
		...
		params.put("stl_dtl_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : CarrierSettlementProcessDBDAOJooStlDtlVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
