...
*@FileName : CarrierSettlementProcessDBDAORobSummaryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierSettlementProcessDBDAORobSummaryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ROB Container List Summary 조회
	  * </pre>
	  */
	public CarrierSettlementProcessDBDAORobSummaryRSQL(){
		setQuery();
		...
		query.append("FileName : CarrierSettlementProcessDBDAORobSummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
