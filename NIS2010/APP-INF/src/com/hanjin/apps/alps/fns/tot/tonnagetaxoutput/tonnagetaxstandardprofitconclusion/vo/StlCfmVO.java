...
public class StlCfmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<StlCfmVO> models = new ArrayList<StlCfmVO>();
	...
	public StlCfmVO(String ibflag, String pagerows, String stlYrmon, String tongStlBatJbSeq, String trdCd, String tongItmCd, String cfmFlg, String cfmDt, String cfmUsrId, String n1stCfmDt, String creDt, String creUsrId, String updDt, String updUsrId, String nrtYn, String useYn, String dayYn, String status) {
		this.updDt = updDt;
	 ...
	 * @param nrtYn
	 */
	public void setNrtYn(String nrtYn) {
		this.nrtYn = nrtYn;
	}
	 ...
	 * @param dayYn
	 */
	public void setDayYn(String dayYn) {
		this.dayYn = dayYn;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setUpdUsrId(JSPUtil.getParameter(request, "status", ""));
	}
	 ...
	 * @return StlCfmVO[]
	 */
	public StlCfmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StlCfmVO[]
	 */
	public StlCfmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StlCfmVO model = null;
		...
		try {
			...
			String[] nrtYn = (JSPUtil.getParameter(request, prefix	+ "nrt_yn", length));
			...
			String[] useYn = (JSPUtil.getParameter(request, prefix	+ "use_yn", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id", length));
			String[] dayYn = (JSPUtil.getParameter(request, prefix	+ "day_yn", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (useYn[i] != null)
					model.setUseYn(useYn[i]);
				if (ibflag[i] != null)
					model.setIbflag(ibflag[i]);
				if (creUsrId[i] != null)
					model.setCreUsrId(creUsrId[i]);
				if (dayYn[i] != null)
					model.setDayYn(dayYn[i]);
				if (n1stCfmDt[i] != null)
	...
	public StlCfmVO[] getStlCfmVOs(){
		StlCfmVO[] vos = (StlCfmVO[])models.toArray(new StlCfmVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.nrtYn = this.nrtYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.useYn = this.useYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.creUsrId = this.creUsrId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.dayYn = this.dayYn .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
