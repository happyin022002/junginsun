...
*@FileName : JointOperationLetterDBDAOJoTmpltNoVORSQL.java
...
public class JointOperationLetterDBDAOJoTmpltNoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JointOperationLetterDBDAOJoTmpltNoVORSQL(){
		setQuery();
		...
		query.append("FileName : JointOperationLetterDBDAOJoTmpltNoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT JO_TMPLT_NO CODE" ).append("\n"); 
