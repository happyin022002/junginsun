...
/**
 * ALPS-Joocommon Business Logic Command Interface<br>
 * - ALPS-Joocommon에 대한 비지니스 로직에 대한 인터페이스<br>
 *
...
public interface JOOFindCodeAndCheckBC {
	 ...
	 * @throws EventException
	 */
	public List<EstmPerformanceChangeStatusIIVO> searchEstmRevYrmonFrToEstmII(EstmPerformanceChangeStatusIIVO estmPerformanceChangeStatusIIVO) throws EventException;
