...
*@FileName : VOP_FCM_0043HTMLAction.java
...
public class VOP_FCM_0043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0043HTMLAction 객체를 생성
	 */
	public VOP_FCM_0043HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		VopFcm0043Event event = new VopFcm0043Event();
