...
public class ActPortSkdHisVO extends AbstractValueObject {
	...
	public ActPortSkdHisVO(String ibflag, String pagerows, String vvd, String vslSlanCd, String vpsPortCd, String oldAta, String oldAtb, String oldAtd, String oldCre, String oldUserId, String newAta, String newAtb, String newAtd, String newCre, String newUserId, String totalCnt) {
		this.newCre = newCre;
		this.oldAtd = oldAtd;
		this.newAta = newAta;
		this.oldAtb = oldAtb;
