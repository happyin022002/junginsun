...
*@FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoCallSignNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoCallSignNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoCallSignNoRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoCallSignNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
