...
*@FileName : EstimationReportDBDAOsearchMonEstmRawDataListByYdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EstimationReportDBDAOsearchMonEstmRawDataListByYdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EstimationReportDBDAOsearchMonEstmRawDataListByYdRSQL(){
		setQuery();
		...
		query.append("FileName : EstimationReportDBDAOsearchMonEstmRawDataListByYdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("GROUP BY T1.REV_YRMON, T2.RLANE_CD, T1.VSL_CD, T1.SKD_VOY_NO, T1.SKD_DIR_CD, T1.LOC_CD" ).append("\n"); 
		query.append("ORDER BY T1.REV_YRMON, T2.RLANE_CD, T1.VSL_CD, T1.SKD_VOY_NO, T1.SKD_DIR_CD, T1.LOC_CD" ).append("\n"); 
