...
*@FileName : TerminalDepartureReportDBDAOTdrCntrDetailBreakVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTdrCntrDetailBreakVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTdrCntrDetailBreakVODSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOTdrCntrDetailBreakVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM TDR_CNTR_DETAIL" ).append("\n"); 
