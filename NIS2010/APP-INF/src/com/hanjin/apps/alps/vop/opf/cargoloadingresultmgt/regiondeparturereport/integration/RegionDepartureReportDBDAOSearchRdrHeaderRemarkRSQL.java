...
*@FileName : RegionDepartureReportDBDAOSearchRdrHeaderRemarkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOSearchRdrHeaderRemarkRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDR HEADER REMAK 정보를 가져온다.
	  * </pre>
	  */
	public RegionDepartureReportDBDAOSearchRdrHeaderRemarkRSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOSearchRdrHeaderRemarkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
