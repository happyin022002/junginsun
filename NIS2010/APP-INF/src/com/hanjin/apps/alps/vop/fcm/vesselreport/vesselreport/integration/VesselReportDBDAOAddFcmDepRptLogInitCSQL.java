...
*@FileName : VesselReportDBDAOAddFcmDepRptLogInitCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselReportDBDAOAddFcmDepRptLogInitCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Create departure report log. Create Initial data.
	  * ============================================
	  * </pre>
	  */
	public VesselReportDBDAOAddFcmDepRptLogInitCSQL(){
		setQuery();
		...
		query.append("FileName : VesselReportDBDAOAddFcmDepRptLogInitCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
