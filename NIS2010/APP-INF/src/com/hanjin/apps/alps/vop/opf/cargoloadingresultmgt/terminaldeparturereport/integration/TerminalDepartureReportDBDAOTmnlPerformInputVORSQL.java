...
*@FileName : TerminalDepartureReportDBDAOTmnlPerformInputVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTmnlPerformInputVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTmnlPerformInputVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.vop.opf.cargoloadingresultmgt.terminaldeparturereport.integration").append("\n"); 
		query.append("FileName : TerminalDepartureReportDBDAOTmnlPerformInputVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM ( SELECT DECODE(C3,1,'Grand Sum',LANE) LANE," ).append("\n"); 
		query.append("              DECODE(C2,1,'Sub Sum',VVD) VVD," ).append("\n"); 
		query.append("              C1, C2, C3," ).append("\n"); 
		query.append("              CASE" ).append("\n"); 
		query.append("              WHEN C1=0 AND C2= 1 AND C3 = 0 THEN NULL" ).append("\n"); 
		...
		query.append("                     ROUND(SUM(NVL(C.ARR - R.PF_ETB_DT - (0.0/60),0)),1)                 ARR_DELAY," ).append("\n"); 
		query.append("                     ROUND(SUM(NVL(C.BRTH - C.ARR - (0.0/60),0)),1)                      ARR_WAIT," ).append("\n"); 
		query.append("                     ROUND(SUM(NVL((C.DEP - C.BRTH) - (R.PF_ETD_DT - R.PF_ETB_DT),0)),1) PORT_DELAY," ).append("\n"); 
		query.append("                     ROUND(SUM(NVL((C.DEP - C.BRTH),0)),1)                               PORT_WORK," ).append("\n"); 
		query.append("                     ROUND(SUM(NVL((C.DEP - R.PF_ETD_DT),0)),1)                          DEP_DELAY," ).append("\n"); 
		...
		query.append("                     ROUND(SUM(NVL(C.MVS/NVL((C.FL+C.MT+C.MVS),1),0)),1)                 RH_RATIO," ).append("\n"); 
		query.append("                     ROUND(SUM(NVL(C.FL+C.MT+C.MVS,0)),1)                                TOT_MVS," ).append("\n"); 
		...
		query.append("                                         AND      A.SLAN_CD         LIKE ''||'%'                                          --:lane_cd" ).append("\n"); 
		query.append("                                         AND      B.PORT_SKD_STS_CD = 'D'" ).append("\n"); 
		query.append("                                         AND      B.ACT_DEP_DT      BETWEEN TO_DATE('20090605','YYYYMMDD')                --:fm_dt" ).append("\n"); 
		query.append("                                                                    AND     TO_DATE('20090805','YYYYMMDD') + 0.99999 ) V  --:to_dt" ).append("\n"); 
		...
		query.append("                                AND    S.PORT_CD  LIKE ''||'%'                                                            --:port_cd" ).append("\n"); 
		query.append("                                AND    S.OPR_CD   ='SML'                                                                  --:carr_cd('SML')" ).append("\n"); 
		query.append("--                                AND    S.OPR_CD   <>'SML'                                                                 --:carr_cd('Other')" ).append("\n"); 
		query.append("                                AND    S.DIR_CD   LIKE ''||'%'                                                            --:dir_cd" ).append("\n"); 
		query.append("                                GROUP BY S.PORT_CD, V.LANE, S.VSL_CD||S.VOY_NO||S.DIR_CD, S.OPR_CD," ).append("\n"); 
		...
		query.append("                                       V.ETD," ).append("\n"); 
		query.append("                                       V.ETB," ).append("\n"); 
		query.append("                                       SUM(DECODE(C.SHIFT_TYPE,'B',1,0))+SUM(DECODE(C.SHIFT_TYPE,'Q',1,0)) MVS" ).append("\n"); 
		...
		query.append("                                AND    C.PORT_CD  LIKE ''||'%'                                                            --:port_cd" ).append("\n"); 
		query.append("                                AND    C.OPR_CD   ='SML'                                                                  --:carr_cd('SML')" ).append("\n"); 
		query.append("--                                AND    C.OPR_CD   <>'SML'                                                                 --:carr_cd('Other')" ).append("\n"); 
		query.append("                                AND    C.DIR_CD   LIKE ''||'%'                                                            --:dir_cd" ).append("\n"); 
		query.append("                                GROUP BY C.PORT_CD, V.LANE, C.VSL_CD||C.VOY_NO||C.DIR_CD, C.OPR_CD," ).append("\n"); 
		...
		query.append("                     TDR_HEADER T, VSK_VSL_SKD_RSLT R, VSK_VSL_SKD S" ).append("\n"); 
		...
		query.append("              AND    SUBSTR(C.VVD,9,1) = R.SUB_TRD_DIR_CD(+)" ).append("\n"); 
		...
		query.append("              AND    NVL(R.VSKD_RSLT_XCLD_CD(+),' ') NOT IN ('D','S')" ).append("\n"); 
		query.append("              GROUP BY CUBE( S.VSL_SLAN_CD, C.VVD ) )" ).append("\n"); 
		query.append("       WHERE C1 = 1 OR C2 = 1 OR C3 = 1" ).append("\n"); 
		query.append("       UNION ALL" ).append("\n"); 
		query.append("       SELECT DECODE(C3,1,'Grand TAVG',LANE) LANE," ).append("\n"); 
		query.append("              DECODE(C2,1,'Sub TAVG',VVD) VVD," ).append("\n"); 
		query.append("              C1, C2, C3," ).append("\n"); 
		query.append("              CASE" ).append("\n"); 
		query.append("              WHEN C1=0 AND C2= 1 AND C3 = 0 THEN NULL" ).append("\n"); 
		query.append("              ELSE ETB" ).append("\n"); 
		...
		query.append("                     ELSE 0" ).append("\n"); 
		query.append("                     END C3," ).append("\n"); 
		query.append("                     ROUND(AVG(NVL(C.ARR - R.PF_ETB_DT - (0.0/60),0)),1)                 ARR_DELAY," ).append("\n"); 
		query.append("                     ROUND(AVG(NVL(C.BRTH - C.ARR - (0.0/60),0)),1)                      ARR_WAIT," ).append("\n"); 
		query.append("                     ROUND(AVG(NVL((C.DEP - C.BRTH) - (R.PF_ETD_DT - R.PF_ETB_DT),0)),1) PORT_DELAY," ).append("\n"); 
		query.append("                     ROUND(AVG(NVL((C.DEP - C.BRTH),0)),1)                               PORT_WORK," ).append("\n"); 
		query.append("                     ROUND(AVG(NVL((C.DEP - R.PF_ETD_DT),0)),1)                          DEP_DELAY," ).append("\n"); 
		...
		query.append("                     ROUND(AVG(NVL(C.MVS/NVL((C.FL+C.MT+C.MVS),1),0)),1)                 RH_RATIO," ).append("\n"); 
		query.append("                     ROUND(AVG(NVL(C.FL+C.MT+C.MVS,0)),1)                                TOT_MVS," ).append("\n"); 
		...
		query.append("ORDER BY DECODE(C3,1,'ZZZZZ',LANE), DECODE(C2,1,'ZZZZZZZZZ',VVD), ETD" ).append("\n"); 
