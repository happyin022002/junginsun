...
*@FileName : IMDGCodeMgtDBDAOScgImdgUnNoVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgUnNoVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgUnNoVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IMDG_UN_NO" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgUnNoVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}