...
public class VOP_OPF_2019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_2019HTMLAction 객체를 생성
	 */
	public VOP_OPF_2019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf2019Event event = new VopOpf2019Event();
		

		if(command.isCommand(FormCommand.SEARCH03)) {
			event.setCBFSpecialStwgVO((CBFSpecialStwgVO)getVO(request, CBFSpecialStwgVO.class));
