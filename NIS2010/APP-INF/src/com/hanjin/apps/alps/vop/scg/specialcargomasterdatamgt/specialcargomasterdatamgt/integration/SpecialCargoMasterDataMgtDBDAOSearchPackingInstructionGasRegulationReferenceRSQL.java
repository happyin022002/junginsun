...
*@FileName : SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionGasRegulationReferenceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionGasRegulationReferenceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchPackingInstructionGasRegulationReference
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionGasRegulationReferenceRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionGasRegulationReferenceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
