...
*@FileName : PortTariffMgtBCDBDAOCopyPsoTrfDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAOCopyPsoTrfDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortTariffMgtBCDBDAOCopyPsoTrfDtlCSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAOCopyPsoTrfDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          @[cre_usr_id]," ).append("\n"); 
		query.append("          SYSDATE  " ).append("\n"); 
		query.append("    FROM PSO_TRF_DTL" ).append("\n"); 
