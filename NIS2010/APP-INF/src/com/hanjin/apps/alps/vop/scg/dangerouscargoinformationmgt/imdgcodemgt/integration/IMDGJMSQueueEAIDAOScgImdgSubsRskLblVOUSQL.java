...
*@FileName : IMDGJMSQueueEAIDAOScgImdgSubsRskLblVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGJMSQueueEAIDAOScgImdgSubsRskLblVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_IMDG_SUBS_RSK_LBL Update
	  * </pre>
	  */
	public IMDGJMSQueueEAIDAOScgImdgSubsRskLblVOUSQL(){
		setQuery();
		...
		query.append("FileName : IMDGJMSQueueEAIDAOScgImdgSubsRskLblVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_IMDG_SUBS_RSK_LBL " ).append("\n"); 
