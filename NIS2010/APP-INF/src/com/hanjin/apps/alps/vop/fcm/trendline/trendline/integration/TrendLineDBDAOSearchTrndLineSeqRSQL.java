...
*@FileName : TrendLineDBDAOSearchTrndLineSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAOSearchTrndLineSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrendLineDBDAOSearchTrndLineSeqRSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAOSearchTrndLineSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TRND_LINE_SEQ" ).append("\n"); 
		...
		query.append("AND TRND_LINE_CHT_TP_CD=@[trnd_line_cht_tp_cd]" ).append("\n"); 
