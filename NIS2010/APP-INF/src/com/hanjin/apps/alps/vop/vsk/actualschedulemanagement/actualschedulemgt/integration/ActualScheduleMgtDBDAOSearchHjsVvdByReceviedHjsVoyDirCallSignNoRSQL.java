...
*@FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirCallSignNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirCallSignNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirCallSignNoRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirCallSignNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
