...
public class VOP_PSO_0203HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_PSO_0203HTMLAction 객체를 생성
	 */
	public VOP_PSO_0203HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0203Event event = new VopPso0203Event();
		String strVndrSeq = (String) request.getParameter("vndrSeq");
		//parameter로 넘어온 vndrSeq를 event객체에 set한다.
		if(strVndrSeq!=null)
			event.setVndrSeq(Integer.parseInt(strVndrSeq));
