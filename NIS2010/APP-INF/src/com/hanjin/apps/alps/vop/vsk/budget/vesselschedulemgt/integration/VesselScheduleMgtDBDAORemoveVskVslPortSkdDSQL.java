...
*@FileName : VesselScheduleMgtDBDAORemoveVskVslPortSkdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAORemoveVskVslPortSkdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VVD Port Schedule 정보를 삭제합니다.
	  * 
	  * * History
	  * * 2011.02.22 진마리아 CHM-201108456-01 사업계획용 스케줄 정보 노출 대응을 위한 시스템 업데이트건
	  * </pre>
	  */
	public VesselScheduleMgtDBDAORemoveVskVslPortSkdDSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAORemoveVskVslPortSkdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
