...
*@FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoImoNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoImoNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoImoNoRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedShipCallNoImoNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
