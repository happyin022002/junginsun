...
*@FileName : BkgCllCngNtfyUserLaneInfoVO.java
*@FileTitle : BkgCllCngNtfyUserLaneInfoVO
*Open Issues :
*Change history :
...
public class BkgCllCngNtfyUserLaneInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCllCngNtfyUserLaneInfoVO> models = new ArrayList<BkgCllCngNtfyUserLaneInfoVO>();
	...
	public BkgCllCngNtfyUserLaneInfoVO() {}

	public BkgCllCngNtfyUserLaneInfoVO(String ibflag, String pagerows, String slanCd, String dirCd, String creSeq, String ofcCd, String rcvrUsrId, String rcvrEml, String phnNo, String creUsrId, String creDt, String updUsrId, String updDt, String usrNm, String rcvrUsrNm, String ofcPhnNo, String ofcFaxNo) {
		this.updDt = updDt;
		this.phnNo = phnNo;
		this.creSeq = creSeq;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return BkgCllCngNtfyUserLaneInfoVO[]
	 */
	public BkgCllCngNtfyUserLaneInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCllCngNtfyUserLaneInfoVO[]
	 */
	public BkgCllCngNtfyUserLaneInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCllCngNtfyUserLaneInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCllCngNtfyUserLaneInfoVO();
				if (updDt[i] != null)
		...
		return getBkgCllCngNtfyUserLaneInfoVOs();
	}
	 ...
	 * @return BkgCllCngNtfyUserLaneInfoVO[]
	 */
	public BkgCllCngNtfyUserLaneInfoVO[] getBkgCllCngNtfyUserLaneInfoVOs(){
		BkgCllCngNtfyUserLaneInfoVO[] vos = (BkgCllCngNtfyUserLaneInfoVO[])models.toArray(new BkgCllCngNtfyUserLaneInfoVO[models.size()]);
		return vos;
	}
