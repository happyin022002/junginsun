...
*@FileName : OwnDangerousCargoApprovalDBDAOScgAwkCgoVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgAwkCgoVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG에서 CANCEL 및 DELETE한 CARGO에 대해 SCG_AWK_CGO의 내용을 수정합니다.
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgAwkCgoVOUSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgAwkCgoVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_AWK_CGO SET" ).append("\n"); 
