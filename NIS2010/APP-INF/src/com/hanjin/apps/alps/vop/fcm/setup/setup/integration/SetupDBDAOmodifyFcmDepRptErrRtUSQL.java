...
*@FileName : SetupDBDAOmodifyFcmDepRptErrRtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupDBDAOmodifyFcmDepRptErrRtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SetupDBDAOmodifyFcmDepRptErrRtUSQL(){
		setQuery();
		...
		query.append("FileName : SetupDBDAOmodifyFcmDepRptErrRtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE FCM_DEP_RPT_ERR_RT_SET  SET  " ).append("\n"); 
