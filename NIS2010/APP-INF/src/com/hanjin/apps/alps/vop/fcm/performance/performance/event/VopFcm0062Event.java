...
*@FileName : VopFcm0062Event
*@FileTitle : VopFcm0062Event
*Open Issues :
*Change history :
...
/**
 * VOP_FCM_0062 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  VOP_FCM_0062HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Ryu Hyuk
 * @see VOP_FCM_0062HTMLAction 참조
 * @since J2EE 1.4
 */

public class VopFcm0062Event extends EventSupport {
