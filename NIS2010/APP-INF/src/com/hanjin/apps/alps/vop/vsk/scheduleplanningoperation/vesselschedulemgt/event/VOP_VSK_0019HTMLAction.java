...
*@FileName : VOP_VSK_0019HTMLAction.java
 ...
 * @author Jung Jinwoo
 * @see VopVsk0019Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0019HTMLAction 객체를 생성
	 */
	public VOP_VSK_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0019Event event = new VopVsk0019Event();
