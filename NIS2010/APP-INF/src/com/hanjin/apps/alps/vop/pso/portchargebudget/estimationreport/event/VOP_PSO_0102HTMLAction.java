...
*@FileName : VOP_PSO_0102HTMLAction.java
...
public class VOP_PSO_0102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0102HTMLAction 객체를 생성
	 */
	public VOP_PSO_0102HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		VopPso0102Event event = new VopPso0102Event();

//		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			
			event.setBudgetSmryByVvdVO((BudgetSmryByVvdVO) getVO(request,BudgetSmryByVvdVO.class)) ;
//		}
