...
public class OpfStvDmgCmpnVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setClmHndlUsrNm(JSPUtil.getParameter(request, "clm_hndl_usr_nm", ""));
	}
	...
	public OpfStvDmgCmpnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] clmHndlUsrNm = (JSPUtil.getParameter(request, prefix	+ "clm_hndl_usr_nm".trim(), length));
