...
=========================================================*/
package com.hanjin.apps.alps.vop.fcm.servicesio;

import org.apache.log4j.Logger;
import org.apache.xmlbeans.XmlException;

import com.hanjin.apps.alps.vop.fcm.vesselreport.VesselReportSC;
...
import com.hanjin.irep.alps.VMS0040001Document;
import com.hanjin.irep.alps.VMS0050001Document;
import com.hanjin.irep.alps.VMS0040001Document.VMS0040001;
import com.hanjin.irep.alps.VMS0050001Document.VMS0050001;
import com.jf.transfer.TransferEAI;

/**
 * ALPS VMS에서 EAI를 이용하여 Report 수신.<br>
 * 
 * @author Hyuk Ryu
...
public class VesselReportJMSProxy {
	...
	/**
	 * JMS Receive(VMS004_0001)<br>
	 * VMS에서 EAI를 이용하여 Departure Report 수신<br>
	 * 
	...
	public void vopFcm0001ReceiveJMS(TransferEAI eai) throws EventException {
		...
		try {
			...
			f.setCommand(FormCommand.COMMAND01);
			...
			// Departure Report Validation Check 및 Departure Report 테이블 적재
			f.setCommand(FormCommand.COMMAND02);
			vesselReportSC.perform(event);
	 ...
	 * VMS에서 EAI를 이용하여 Noon Report 수신
	 * 
	 * @param TransferEAI eai
	 * @exception EventException
	 */
