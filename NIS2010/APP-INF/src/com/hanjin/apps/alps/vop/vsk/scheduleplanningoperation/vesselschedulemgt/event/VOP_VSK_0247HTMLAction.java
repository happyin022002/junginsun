...
*@FileName : VOP_VSK_0247HTMLAction.java
 ...
 * @author Jung Jinwoo
 * @see VopVsk0247Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0247HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0247HTMLAction 객체를 생성
	 */
	public VOP_VSK_0247HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0247Event event = new VopVsk0247Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setLoadWgtVO((LoadWgtVO)getVO(request, LoadWgtVO .class));
//			event.setLoadWgtVOs((LoadWgtVO[])getVOs(request, LoadWgtVO .class, "sheet1_"));
