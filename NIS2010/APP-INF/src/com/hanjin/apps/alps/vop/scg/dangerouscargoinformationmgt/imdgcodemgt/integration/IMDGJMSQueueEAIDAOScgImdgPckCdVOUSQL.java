...
*@FileName : IMDGJMSQueueEAIDAOScgImdgPckCdVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGJMSQueueEAIDAOScgImdgPckCdVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGJMSQueueEAIDAOScgImdgPckCdVOUSQL(){
		setQuery();
		...
		query.append("FileName : IMDGJMSQueueEAIDAOScgImdgPckCdVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_IMDG_PCK_CD " ).append("\n"); 
