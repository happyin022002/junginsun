...
public class VOP_SCG_0103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0031HTMLAction 객체를 생성
	 */
	public VOP_SCG_0103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0103Event event = new VopScg0103Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgPckInstrVO((ScgPckInstrVO)getVO(request, ScgPckInstrVO .class,""));
		}
