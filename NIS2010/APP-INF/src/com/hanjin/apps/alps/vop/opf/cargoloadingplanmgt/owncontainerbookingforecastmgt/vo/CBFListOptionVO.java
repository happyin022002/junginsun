 ...
 * 2009.05.25 우지석 
 * 1.0 Creation
 * 2011.12.12 [CHM-201114818-01] Split 03-특수화물(DG) 시스템 개선 요청(Segregation Group name 변경 외 3건) : 변수 추가(HZD_CTNT)
...
public class CBFListOptionVO extends AbstractValueObject {
	...
	public CBFListOptionVO(String ibflag, String pagerows, String vslCd,
			...
			String pcCgoFlg, String allFlg, String prctFlg, String bkgStsCd, String prpShpNm, String hzdDesc, String acCntrFlg, String hzdCtnt, String podYdCd) {
		this.vslCd = vslCd;
	...
	public CBFListOptionVO[] fromRequestGrid(HttpServletRequest request,
		...
		try {
			...
			String[] acCntrFlg = (JSPUtil.getParameter(request, prefix
					+ "ac_cntr_flg", length));
			String[] hzdCtnt = (JSPUtil.getParameter(request, prefix
					+ "hzd_ctnt", length));
	...
	public void unDataFormat() {
		...
		.replaceAll("/", "").replaceAll(":", "");
		this.hzdCtnt = this.hzdCtnt.replaceAll(",", "").replaceAll("-", "")
		.replaceAll("/", "").replaceAll(":", "");
