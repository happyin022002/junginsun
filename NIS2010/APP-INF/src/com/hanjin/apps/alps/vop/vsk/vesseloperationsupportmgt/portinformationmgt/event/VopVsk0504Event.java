...
public class VopVsk0504Event extends EventSupport {
	...
	public void setVskPortCnlTrScgVOS(VskPortCnlTrScgVO[] vskPortCnlTrScgVOs){
		if(vskPortCnlTrScgVOs != null){
			VskPortCnlTrScgVO[] tmpVOs = new VskPortCnlTrScgVO[vskPortCnlTrScgVOs.length];
			System.arraycopy(vskPortCnlTrScgVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.vskPortCnlTrScgVOs = tmpVOs;
		}
		//소스보안 2015.07.20
		//this. vskPortCnlTrScgVOs = vskPortCnlTrScgVOs;
	}
	
	public VskPortCnlTrScgVO[] getVskPortCnlTrScgVOS(){
		VskPortCnlTrScgVO[] rtnVOs =  null;
		if(this.vskPortCnlTrScgVOs != null){
			rtnVOs = new VskPortCnlTrScgVO[vskPortCnlTrScgVOs.length];
			System.arraycopy(vskPortCnlTrScgVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
		//소스보안 2015.07.20
		//return vskPortCnlTrScgVOs;                          
	}
