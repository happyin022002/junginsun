/*=========================================================
*@FileName : VMS_SCG_0113HTMLAction.java
*@FileTitle : Partner’s Contact Point for SPCL CGO (Creation) - Email address by POL
*Open Issues :
*Change history :
...
public class VOP_SCG_0113HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0034HTMLAction 객체를 생성
	 */
	public VOP_SCG_0113HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0113Event event = new VopScg0113Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgCntcPntPolVOS((ScgCntcPntPolVO[])getVOs(request, ScgCntcPntPolVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgCntcPntPolVO((ScgCntcPntPolVO)getVO(request, ScgCntcPntPolVO .class));
		}
