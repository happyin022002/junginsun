...
*@FileName : getImdgClassCdVO.java
*@FileTitle : getImdgClassCdVO
*Open Issues :
*Change history :
...
public class getImdgClassCdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<getImdgClassCdVO> models = new ArrayList<getImdgClassCdVO>();
	...
	public getImdgClassCdVO() {}

	public getImdgClassCdVO(String ibflag, String pagerows, String imdgClssCd, String imdgClssCdDesc) {
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return getImdgClassCdVO[]
	 */
	public getImdgClassCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return getImdgClassCdVO[]
	 */
	public getImdgClassCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		getImdgClassCdVO model = null;
	 ...
	 * @return getImdgClassCdVO[]
	 */
	public getImdgClassCdVO[] getgetImdgClassCdVOs(){
		getImdgClassCdVO[] vos = (getImdgClassCdVO[])models.toArray(new getImdgClassCdVO[models.size()]);
		return vos;
	}
