...
*@FileName : ProformaScheduleMgtDBDAOEstVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProformaScheduleMgtDBDAOEstVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProformaScheduleMgtDBDAOEstVvdRSQL(){
		setQuery();
		...
		query.append("FileName : ProformaScheduleMgtDBDAOEstVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
