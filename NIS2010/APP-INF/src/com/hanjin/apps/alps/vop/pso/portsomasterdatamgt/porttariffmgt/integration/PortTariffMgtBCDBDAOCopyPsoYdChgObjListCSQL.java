...
*@FileName : PortTariffMgtBCDBDAOCopyPsoYdChgObjListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAOCopyPsoYdChgObjListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortTariffMgtBCDBDAOCopyPsoYdChgObjListCSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAOCopyPsoYdChgObjListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SELECT  @[new_yd_chg_no]," ).append("\n"); 
