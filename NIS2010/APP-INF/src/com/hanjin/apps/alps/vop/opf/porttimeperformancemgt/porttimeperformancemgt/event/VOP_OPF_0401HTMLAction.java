...
*@FileName : VOP_OPF_0401HTMLAction.java
...
public class VOP_OPF_0401HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0401HTMLAction 객체를 생성
	 */
	public VOP_OPF_0401HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0401Event event = new VopOpf0401Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setPerformanceSummaryVOS((PerformanceSummaryVO[])getVOs(request, PerformanceSummaryVO .class,"sheet1_"));
		}
