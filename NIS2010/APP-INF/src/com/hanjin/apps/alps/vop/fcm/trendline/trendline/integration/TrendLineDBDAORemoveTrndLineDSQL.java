...
*@FileName : TrendLineDBDAORemoveTrndLineDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAORemoveTrndLineDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrendLineDBDAORemoveTrndLineDSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAORemoveTrndLineDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM FCM_TRND_LINE" ).append("\n"); 
		...
		query.append("AND TRND_LINE_FM_DT=REPLACE(@[trnd_line_fm_dt],'-','')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${trnd_line_to_dt} != '')" ).append("\n"); 
		query.append("AND TRND_LINE_TO_DT=REPLACE(@[trnd_line_to_dt],'-','')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
