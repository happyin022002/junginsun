...
*@FileName : VOP_VSK_0111HTMLAction.java
 ...
 * @author Maria Chin
 * @see VopVsk0111Event 참조
 * @since J2EE 1.4
 */

public class VOP_VSK_0111HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VSK_GLO_HTMLAction 객체를 생성
	 */
	public VOP_VSK_0111HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopVsk0111Event event = new VopVsk0111Event();
