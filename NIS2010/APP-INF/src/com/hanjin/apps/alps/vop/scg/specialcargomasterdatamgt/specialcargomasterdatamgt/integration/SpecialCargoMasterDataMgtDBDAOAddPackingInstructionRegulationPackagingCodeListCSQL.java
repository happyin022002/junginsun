...
*@FileName : SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingCodeListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingCodeListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddPackingInstructionRegulationPackagingCodeList
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingCodeListCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingCodeListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("##INSERT INTO SCG_PCK_REGU_PKG_CD" ).append("\n"); 
