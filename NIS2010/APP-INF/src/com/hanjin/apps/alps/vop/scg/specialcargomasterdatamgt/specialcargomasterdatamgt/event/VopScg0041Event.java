...
public class VopScg0041Event extends EventSupport {
	...
	public void setScgImdgSpclProviVOS(ScgImdgSpclProviVO[] scgImdgSpclProviVOs){
		if (scgImdgSpclProviVOs != null) {
			ScgImdgSpclProviVO[] tmpVOs = new ScgImdgSpclProviVO[scgImdgSpclProviVOs.length];
			System.arraycopy(scgImdgSpclProviVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	public ScgImdgSpclProviVO[] getScgImdgSpclProviVOS(){
		...
		if (this.scgImdgSpclProviVOs != null) {
			rtnVOs = new ScgImdgSpclProviVO[scgImdgSpclProviVOs.length];
			System.arraycopy(scgImdgSpclProviVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
