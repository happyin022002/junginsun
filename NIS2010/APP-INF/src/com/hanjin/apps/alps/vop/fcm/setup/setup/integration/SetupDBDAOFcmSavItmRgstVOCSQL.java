...
*@FileName : SetupDBDAOFcmSavItmRgstVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupDBDAOFcmSavItmRgstVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * FCM_SAV_ITM_RGST 테이블에 저장
	  * 
	  * History
	  * 2012.04.04 진마리아 CHM-201216636-01 [FCM] ALPS 모델 및 DB 구조 불일치 복구
	  * </pre>
	  */
	public SetupDBDAOFcmSavItmRgstVOCSQL(){
		setQuery();
		...
		query.append("FileName : SetupDBDAOFcmSavItmRgstVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO FCM_SAV_ITM_RGST( " ).append("\n"); 
