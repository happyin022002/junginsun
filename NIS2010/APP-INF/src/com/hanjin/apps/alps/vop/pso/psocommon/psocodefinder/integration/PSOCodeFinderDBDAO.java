...
//	}
	 ...
	 * @throws DAOException
	 */
	public boolean checkVslSkdVvd(String vslCd, String skdVoyNo, String skdDirCd, String ydCd) throws DAOException {
		DBRowSet dbRowset = null;
		boolean bRet = false;
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		...
		try {
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new PSOCodeFinderDBDAOcheckVslSkdVvdRSQL(), param, velParam);
			if(dbRowset.next()){
				String strRet = dbRowset.getString(1);
				bRet = strRet.equals("0") ? false : true;
			}
