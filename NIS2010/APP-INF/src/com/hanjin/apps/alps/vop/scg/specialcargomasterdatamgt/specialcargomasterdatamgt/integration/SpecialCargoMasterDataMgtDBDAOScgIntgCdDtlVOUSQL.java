...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgIntgCdDtlVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgIntgCdDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgIntgCdDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgIntgCdDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_INTG_CD_DTL SET " ).append("\n"); 
