...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgUserVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgUserVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgUserVOUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgUserVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	JB_ENG_NM = @[jb_nm]" ).append("\n"); 
		query.append(",	XTN_PHN_NO = @[phn_no]" ).append("\n"); 
