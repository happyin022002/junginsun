...
*@FileName : SpecialCargoMasterDataMgtDBDAOModifyScgGuidDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOModifyScgGuidDtlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOModifyScgGuidDtlUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOModifyScgGuidDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_GUID_DTL" ).append("\n"); 
		query.append("       SET HDR_CTNT    = @[hdr_ctnt]" ).append("\n"); 
