...
*@FileName : OwnDangerousCargoApprovalDBDAOScgBbCgoVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgBbCgoVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG에서 CANCEL 및 DELETE한 CARGO에 대해 SCG_BB_CGO에 수정 반영 한다.
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgBbCgoVOUSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgBbCgoVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_BB_CGO SET" ).append("\n"); 
