...
public class MissingTDRCondVO extends AbstractValueObject {
	...
	public MissingTDRCondVO(String ibflag, String pagerows, String frDt, String toDt, String rhqOfcCd, String portCd, String slanCd, String crrCd, String tdrFlg, String bayplan, String svcTpCd, String exTprFlg) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bayplan", getBayplan());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("bayplan", "bayplan");
	 ...
	 * @param bayplan
	 */
	public void setBayplan(String bayplan) {
		this.bayplan = bayplan;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setBayplan(JSPUtil.getParameter(request, prefix + "bayplan", ""));
	...
	public MissingTDRCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] bayplan = (JSPUtil.getParameter(request, prefix	+ "bayplan", length));
	...
	*/
	public void unDataFormat(){
		...
		this.bayplan = this.bayplan .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
