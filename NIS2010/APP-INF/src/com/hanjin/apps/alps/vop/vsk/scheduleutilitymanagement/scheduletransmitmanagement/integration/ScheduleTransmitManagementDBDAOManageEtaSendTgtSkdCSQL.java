...
*@FileName : ScheduleTransmitManagementDBDAOManageEtaSendTgtSkdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScheduleTransmitManagementDBDAOManageEtaSendTgtSkdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CHM-201221649-01(ETA sending(Auto FAX/TLX)) 황태진
	  * VSK_VSL_PORT_SKD_TRSM_HIS 변경된 ETA 정보 갱신
	  * </pre>
	  */
	public ScheduleTransmitManagementDBDAOManageEtaSendTgtSkdCSQL(){
		setQuery();
		...
		query.append("FileName : ScheduleTransmitManagementDBDAOManageEtaSendTgtSkdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
