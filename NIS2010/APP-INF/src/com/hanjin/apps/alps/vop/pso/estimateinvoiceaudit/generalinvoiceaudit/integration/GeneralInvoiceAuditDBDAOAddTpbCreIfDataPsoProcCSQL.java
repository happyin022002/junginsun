...
*@FileName : GeneralInvoiceAuditDBDAOAddTpbCreIfDataPsoProcCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOAddTpbCreIfDataPsoProcCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOAddTpbCreIfDataPsoProcCSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOAddTpbCreIfDataPsoProcCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_CRE_IF_DATA_PSO_PRC(" ).append("\n"); 
