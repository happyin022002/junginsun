...
*@FileName : RegionDepartureReportDBDAORDRAkVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORDRAkVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDRAkVO Select Query
	  * </pre>
	  */
	public RegionDepartureReportDBDAORDRAkVORSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORDRAkVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       M.OVF       AS OVF," ).append("\n"); 
		query.append("       M.OVA       AS OA," ).append("\n"); 
		query.append("       M.OVP       AS OP," ).append("\n"); 
		query.append("       M.OVS       AS OS," ).append("\n"); 
		query.append("       M.OVH       AS OH," ).append("\n"); 
		query.append("       M.SLOT      AS VOID_TEU," ).append("\n"); 
		...
		query.append("AND    M.CARGO_TYPE = 'AK'" ).append("\n"); 
