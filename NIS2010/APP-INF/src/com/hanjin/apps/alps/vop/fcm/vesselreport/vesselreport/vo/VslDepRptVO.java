...
public class VslDepRptVO extends AbstractValueObject {
	...
	/* Page Number */
	private String overLapCnt = null;
	/* Page Number */
	private String notRcvCnt = null;
	...
	public VslDepRptVO(String ibflag, String pagerows, String vslSlanCd, String vvdCnt, String portCnt, String depRptCnt, String mssPortCnt, String mssMtchRptCnt, String overLapCnt, String notRcvCnt) {
		this.ibflag = ibflag;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("over_lap_cnt", getOverLapCnt());
		this.hashColumns.put("not_rcv_cnt", getNotRcvCnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("over_lap_cnt", "overLapCnt");
		this.hashFields.put("not_rcv_cnt", "notRcvCnt");
	 ...
	 * @return notRcvCnt
	 */
	public String getNotRcvCnt() {
		return this.notRcvCnt;
	}
	 ...
	 * @param notRcvCnt
	 */
	public void setNotRcvCnt(String notRcvCnt) {
		this.notRcvCnt = notRcvCnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOverLapCnt(JSPUtil.getParameter(request, prefix + "over_lap_cnt", ""));
		setNotRcvCnt(JSPUtil.getParameter(request, prefix + "not_rcv_cnt", ""));
	...
	public VslDepRptVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] overLapCnt = (JSPUtil.getParameter(request, prefix	+ "over_lap_cnt", length));
			String[] notRcvCnt = (JSPUtil.getParameter(request, prefix	+ "not_rcv_cnt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (overLapCnt[i] != null)
					model.setOverLapCnt(overLapCnt[i]);
				if (notRcvCnt[i] != null)
					model.setNotRcvCnt(notRcvCnt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.overLapCnt = this.overLapCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.notRcvCnt = this.notRcvCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
