...
public class BudgetPortChargeMgtDBDAOsearchSumRptByPeriodSoARSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                AND    CST.ACCT_CD = '511711'" ).append("\n"); 
		query.append("				#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                ---adding options" ).append("\n"); 
		...
		query.append("                #end                  " ).append("\n"); 
		query.append("                " ).append("\n"); 
		query.append("                GROUP  BY SUBSTR(T10.RLANE_CD, 1, 3)" ).append("\n"); 
		query.append("                         ,CST.ACCT_CD)" ).append("\n"); 
		...
		query.append("                                ,SUBSTR(T12.YD_CD, 1, 5)" ).append("\n"); 
		query.append("                                ,T11.VSL_SLAN_CD AS LANE_PORT" ).append("\n"); 
		query.append("                 " ).append("\n"); 
		...
		query.append("                         ,T10.SLAN_CD AS LANE_PORT" ).append("\n"); 
		...
		query.append("                         ,VSK.SLAN_CD AS LANE_PORT" ).append("\n"); 
