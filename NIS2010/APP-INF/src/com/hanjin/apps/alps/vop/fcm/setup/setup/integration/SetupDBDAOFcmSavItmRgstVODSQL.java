...
*@FileName : SetupDBDAOFcmSavItmRgstVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupDBDAOFcmSavItmRgstVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SetupDBDAOFcmSavItmRgstVODSQL(){
		setQuery();
		...
		query.append("FileName : SetupDBDAOFcmSavItmRgstVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM FCM_SAV_ITM_RGST" ).append("\n"); 
