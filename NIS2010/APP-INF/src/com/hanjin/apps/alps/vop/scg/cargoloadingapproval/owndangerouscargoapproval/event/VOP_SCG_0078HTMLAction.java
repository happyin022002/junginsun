...
*@FileName : VOP_SCG_0078HTMLAction.java
...
public class VOP_SCG_0078HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0078HTMLAction 객체를 생성
	 */
	public VOP_SCG_0078HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopScg0078Event event = new VopScg0078Event();
    	
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchScgRequestApvlTimeInputVO((SearchScgRequestApvlTimeInputVO)getVO(request, SearchScgRequestApvlTimeInputVO .class));
