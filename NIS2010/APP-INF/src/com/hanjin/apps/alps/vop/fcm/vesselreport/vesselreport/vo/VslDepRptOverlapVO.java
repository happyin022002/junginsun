...
*@FileName : VslDepRptOverlapVO.java
*@FileTitle : VslDepRptOverlapVO
*Open Issues :
*Change history :
...
public class VslDepRptOverlapVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VslDepRptOverlapVO> models = new ArrayList<VslDepRptOverlapVO>();
	...
	public VslDepRptOverlapVO() {}

	public VslDepRptOverlapVO(String ibflag, String pagerows, String depRptErrSeq, String vvd, String depPortCd, String clptIndSeq, String depRptErrTpCd, String vslSlanCd, String nxtPortCd, String rupDt, String rcvDt, String rcvSeq) {
		this.vvd = vvd;
...
/**
	 ...
	 */
	public VslDepRptOverlapVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VslDepRptOverlapVO[]
	 */
	public VslDepRptOverlapVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VslDepRptOverlapVO model = null;
	...
	public VslDepRptOverlapVO[] getVslDepRptOverlapVOs(){
		VslDepRptOverlapVO[] vos = (VslDepRptOverlapVO[])models.toArray(new VslDepRptOverlapVO[models.size()]);
		return vos;
	}
