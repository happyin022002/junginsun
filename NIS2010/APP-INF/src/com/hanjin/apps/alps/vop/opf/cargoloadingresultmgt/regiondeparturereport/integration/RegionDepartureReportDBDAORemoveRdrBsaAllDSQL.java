...
*@FileName : RegionDepartureReportDBDAORemoveRdrBsaAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORemoveRdrBsaAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BSA데이타를 VVD,REGION별삭제
	  * </pre>
	  */
	public RegionDepartureReportDBDAORemoveRdrBsaAllDSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORemoveRdrBsaAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE   RDR_BSA" ).append("\n"); 
