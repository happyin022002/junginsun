...
*@FileName : VOP_SCG_0072HTMLAction.java
...
public class VOP_SCG_0072HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0072HTMLAction 객체를 생성
	 */
	public VOP_SCG_0072HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0072Event event = new VopScg0072Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSegregationSimulationInputVOS((SegregationSimulationInputVO[])getVOs(request, SegregationSimulationInputVO .class));
		}
