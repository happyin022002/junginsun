...
public class TerminalDepartureReportDBDAOLoadVolSGTdrVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SUM(DECODE(D.STATUS,	@[sc_status1], DECODE(D.CARGO_TYPE, 'DG', DECODE(D.CNTR_SIZE, '2', 1, '3', 1, 0), 0), 0))                   				 DG_20_QTY," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS,	@[sc_status1], DECODE(D.CARGO_TYPE, 'DG', DECODE(D.CNTR_SIZE, '2', D.WEIGHT, '3', D.WEIGHT, 0), 0), 0))     				 DG_20_WGT," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.CARGO_TYPE, 'DG', DECODE(D.CNTR_SIZE, '4', 1, 'H', 1, 'L', 1, 0), 0), 0))           				 DG_40_QTY," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.CARGO_TYPE, 'DG', DECODE(D.CNTR_SIZE, '4', D.WEIGHT, 'H', D.WEIGHT, 'L', D.WEIGHT, 0), 0), 0))    DG_40_WGT," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS,	@[sc_status1], DECODE(D.TEMP, NULL, 0, DECODE(D.CNTR_SIZE, '2', 1, '3', 1, 0)), 0))                                       RF_20_QTY," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS,	@[sc_status1], DECODE(D.TEMP, NULL, 0, DECODE(D.CNTR_SIZE, '2', D.WEIGHT, '3', D.WEIGHT, 0)), 0))                         RF_20_WGT," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.TEMP, NULL, 0, DECODE(D.CNTR_SIZE, '4', 1, 'H', 1, 'L', 1, 0)), 0))                               RF_40_QTY," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.TEMP, NULL, 0, DECODE(D.CNTR_SIZE, '4', D.WEIGHT, 'H', D.WEIGHT, 'L', D.WEIGHT, 0)), 0))          RF_40_WGT," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.CARGO_TYPE, 'AK', DECODE(D.CNTR_SIZE, '2', 1, '3', 1, 0), 0), 0))                                 AK_20_QTY," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.CARGO_TYPE, 'AK', DECODE(D.CNTR_SIZE, '2', D.WEIGHT, '3', D.WEIGHT, 0), 0), 0))                   AK_20_WGT," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.CARGO_TYPE, 'AK', DECODE(D.CNTR_SIZE, '4', 1, 'H', 1,'L', 1, 0), 0), 0))                          AK_40_QTY," ).append("\n"); 
		query.append("SUM(DECODE(D.STATUS, @[sc_status1], DECODE(D.CARGO_TYPE, 'AK', DECODE(D.CNTR_SIZE, '4', D.WEIGHT, 'H', D.WEIGHT, 'L', D.WEIGHT, 0), 0), 0))    AK_40_WGT" ).append("\n"); 
