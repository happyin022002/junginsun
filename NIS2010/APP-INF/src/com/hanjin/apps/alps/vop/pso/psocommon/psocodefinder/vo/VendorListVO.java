...
*@FileName : VendorListVO.java
*@FileTitle : VendorListVO
*Open Issues :
*Change history :
...
public class VendorListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VendorListVO> models = new ArrayList<VendorListVO>();
	 ...
	 * @return VendorListVO[]
	 */
	public VendorListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VendorListVO[]
	 */
	public VendorListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VendorListVO model = null;
	 ...
	 * @return VendorListVO[]
	 */
	public VendorListVO[] getVendorListVOs(){
		VendorListVO[] vos = (VendorListVO[])models.toArray(new VendorListVO[models.size()]);
		return vos;
	}
