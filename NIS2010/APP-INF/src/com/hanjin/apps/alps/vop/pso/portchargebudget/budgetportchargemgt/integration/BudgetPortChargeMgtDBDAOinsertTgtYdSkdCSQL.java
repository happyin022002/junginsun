...
*@FileName : BudgetPortChargeMgtDBDAOinsertTgtYdSkdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BudgetPortChargeMgtDBDAOinsertTgtYdSkdCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BudgetPortChargeMgtDBDAOinsertTgtYdSkdCSQL(){
		setQuery();
		...
		query.append("FileName : BudgetPortChargeMgtDBDAOinsertTgtYdSkdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("MIN(DECODE(TURN_PORT_IND_CD,'Y',1,'N',1,0))" ).append("\n"); 
