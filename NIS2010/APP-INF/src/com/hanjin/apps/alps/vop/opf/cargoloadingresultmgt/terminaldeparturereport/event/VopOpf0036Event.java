...
public class VopOpf0036Event extends EventSupport {
	...
	private TdrSlotHC45VO[] tdrSlotHC45VO = null;
	
	private TdrUtilizeSlotPortVO[] tdrUtilizeSlotPortVO = null;
	
	public TdrUtilizeSlotPortVO[] getTdrUtilizeSlotPortVO() {
		TdrUtilizeSlotPortVO[] rtnVOs = null;
 		
 		if (this.tdrUtilizeSlotPortVO != null) {
 			rtnVOs = new TdrUtilizeSlotPortVO[tdrUtilizeSlotPortVO.length];
 			System.arraycopy(tdrUtilizeSlotPortVO, 0, rtnVOs, 0, rtnVOs.length);
 		 }		
 		 return rtnVOs;
	}

	public void setTdrUtilizeSlotPortVO(TdrUtilizeSlotPortVO[] tdrUtilizeSlotPortVO) {
		if (tdrUtilizeSlotPortVO != null) {
			TdrUtilizeSlotPortVO[] tmpVOs = new TdrUtilizeSlotPortVO[tdrUtilizeSlotPortVO.length];
			System.arraycopy(tdrUtilizeSlotPortVO, 0, tmpVOs, 0, tmpVOs.length);
			this.tdrUtilizeSlotPortVO = tmpVOs;
		}	
	}

	public TdrSlotHC45VO[] getTdrSlotHC45VO() {
		TdrSlotHC45VO[] rtnVOs = null;
 		
 		if (this.tdrSlotHC45VO != null) {
 			rtnVOs = new TdrSlotHC45VO[tdrSlotHC45VO.length];
 			System.arraycopy(tdrSlotHC45VO, 0, rtnVOs, 0, rtnVOs.length);
 		 }		
 		 return rtnVOs;
	}

	public void setTdrSlotHC45VO(TdrSlotHC45VO[] tdrSlotHC45VO) {
		if (tdrSlotHC45VO != null) {
			TdrSlotHC45VO[] tmpVOs = new TdrSlotHC45VO[tdrSlotHC45VO.length];
			System.arraycopy(tdrSlotHC45VO, 0, tmpVOs, 0, tmpVOs.length);
			this.tdrSlotHC45VO = tmpVOs;
		}
	}
    ...
    /**
     * @return the terminalDepartureReportConditionVO
     */
    ...
    /**
     * @param terminalDepartureReportConditionVO the terminalDepartureReportConditionVO to set
     */
    public void setTerminalDepartureReportConditionVO(
            TerminalDepartureReportConditionVO terminalDepartureReportConditionVO) {
