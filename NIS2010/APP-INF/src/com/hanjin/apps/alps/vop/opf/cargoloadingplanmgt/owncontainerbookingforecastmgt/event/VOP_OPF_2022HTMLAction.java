...
public class VOP_OPF_2022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_2019HTMLAction 객체를 생성
	 */
	public VOP_OPF_2022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopOpf2022Event event = new VopOpf2022Event();
		
   
		if(command.isCommand(FormCommand.SEARCH01)) {
			String vvd     = request.getParameter("vvd");
			String pol_clpt_ind_seq = request.getParameter("pol_clpt_ind_seq");		
			String yd_cd      = request.getParameter("yd_cd");	
			
		
			event.setAttribute("vvd", vvd);
			event.setAttribute("pol_clpt_ind_seq", pol_clpt_ind_seq);
