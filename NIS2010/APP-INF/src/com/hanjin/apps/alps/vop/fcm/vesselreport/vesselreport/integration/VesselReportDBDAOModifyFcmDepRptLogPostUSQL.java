...
*@FileName : VesselReportDBDAOModifyFcmDepRptLogPostUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselReportDBDAOModifyFcmDepRptLogPostUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Create departure report log. Update result of creation.
	  * </pre>
	  */
	public VesselReportDBDAOModifyFcmDepRptLogPostUSQL(){
		setQuery();
		...
		query.append("FileName : VesselReportDBDAOModifyFcmDepRptLogPostUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
