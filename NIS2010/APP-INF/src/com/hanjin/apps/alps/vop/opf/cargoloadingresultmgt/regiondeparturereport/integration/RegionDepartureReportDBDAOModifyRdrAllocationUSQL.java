...
*@FileName : RegionDepartureReportDBDAOModifyRdrAllocationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOModifyRdrAllocationUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAOModifyRdrAllocationUSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOModifyRdrAllocationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  RDR_ALLOCATION" ).append("\n"); 
		query.append("   SET  BSA_TYPE     = @[bsa_type]    " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",       BSA_SLOT     = @[basic_slot]     " ).append("\n"); 
		query.append(",       SWAP_SLOT    = @[swap_slot]   " ).append("\n"); 
		query.append(",       RELEASE_SLOT = @[release_slot]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",       BSA_WGT      = @[basic_wgt]     " ).append("\n"); 
