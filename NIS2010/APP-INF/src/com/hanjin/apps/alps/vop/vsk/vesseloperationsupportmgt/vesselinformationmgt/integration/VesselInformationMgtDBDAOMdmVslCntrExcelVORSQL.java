...
public class VesselInformationMgtDBDAOMdmVslCntrExcelVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Vessel Particular 의 excel format에 맞춰 데이터를 조회한다.
	  * 
	  * History
	...
	public void setQuery(){
		...
		query.append("         when 1  then a.vsl_eng_nm||a.vsl_locl_nm" ).append("\n"); 
		...
		query.append("         when 15 then case a.vsl_own_ind_cd when 'O' then 'SM Line Corporation'" ).append("\n"); 
		...
		query.append("         when 13 then 'SCNT (MT)'" ).append("\n"); 
		query.append("         when 14 then 'F.O TANK CAPACITY - 85% (MT) '" ).append("\n"); 
		query.append("         when 15 then 'D.O TANK CAPACITY - 85% (MT) '" ).append("\n"); 
		query.append("         when 16 then 'F.W TANK CAPACITY - 100% (MT)'" ).append("\n"); 
		query.append("         when 17 then 'B.W TANK CAPACITY - 100% (MT)'" ).append("\n"); 
		query.append("         when 18 then 'F.O CONSUMPTION (DAY)        '" ).append("\n"); 
		query.append("         when 19 then 'D.O CONSUMPTION (DAY)        '" ).append("\n"); 
		query.append("         when 20 then 'F.W CONSUMPTION (DAY)        '" ).append("\n"); 
		query.append("         when 21 then 'M/E MAKER                    '" ).append("\n"); 
		query.append("         when 22 then 'M/E TYPE                     '" ).append("\n"); 
		query.append("         when 23 then 'M/E BHP                      '" ).append("\n"); 
		query.append("         when 24 then 'M/E RPM                      '" ).append("\n"); 
		query.append("         when 25 then 'M/E Tier                     '" ).append("\n"); 
		query.append("         when 26 then 'G/E MAKER                    '" ).append("\n"); 
		query.append("         when 27 then 'G/E TYPE                     '" ).append("\n"); 
		query.append("         when 28 then 'G/E BHP                      '" ).append("\n"); 
		query.append("         when 29 then 'G/E RPM                      '" ).append("\n"); 
		query.append("         when 30 then 'BOW THRUST MAKER             '" ).append("\n"); 
		query.append("         when 31 then 'BOW THRUST TYPE              '" ).append("\n"); 
		query.append("         when 32 then 'BOW THRUST BHP               '" ).append("\n"); 
		query.append("         when 33 then 'BOW THRUST RPM               '" ).append("\n"); 
		...
		query.append("         when 39 then ''" ).append("\n"); 
		query.append("         else '' " ).append("\n"); 
		...
		query.append("         when 13 then DECODE(a.madn_voy_suz_net_tong_wgt,0,'',trim(to_char(a.madn_voy_suz_net_tong_wgt,'999,999,999.99')))" ).append("\n"); 
		query.append("         when 14 then DECODE(a.foil_capa,0,'',trim(to_char(a.foil_capa,'999,999,999,999.99')))" ).append("\n"); 
		query.append("         when 15 then DECODE(a.doil_capa,0,'',trim(to_char(a.doil_capa,'999,999,999,999.99')))" ).append("\n"); 
		query.append("         when 16 then DECODE(a.frsh_wtr_capa,0,'',trim(to_char(a.frsh_wtr_capa,'999,999,999,999.99')))" ).append("\n"); 
		query.append("         when 17 then DECODE(a.blst_tnk_capa,0,'',trim(to_char(a.blst_tnk_capa,'999,999,999,999.99')))" ).append("\n"); 
		query.append("         when 18 then DECODE(a.foil_csm,0,'',trim(to_char(a.foil_csm,'99,999,999.99')))" ).append("\n"); 
		query.append("         when 19 then DECODE(a.doil_csm,0,'',trim(to_char(a.doil_csm,'99,999,999.99')))" ).append("\n"); 
		query.append("         when 20 then DECODE(a.frsh_wtr_csm,0,'',trim(to_char(a.frsh_wtr_csm,'99,999,999.99')))" ).append("\n"); 
		query.append("         when 21 then a.mn_eng_mkr_nm" ).append("\n"); 
		query.append("         when 22 then a.mn_eng_tp_desc" ).append("\n"); 
		query.append("         when 23 then DECODE(a.mn_eng_bhp_pwr,0,'',trim(to_char(a.mn_eng_bhp_pwr,'99,999,999')))" ).append("\n"); 
		query.append("         when 24 then DECODE(a.mn_eng_rpm_pwr,0,'',trim(to_char(a.mn_eng_rpm_pwr,'99,999,999')))" ).append("\n"); 
		query.append("         when 25 then DECODE(a.MN_ENG_TR_KNT,0,'', 1, 'Ⅰ', 2, 'Ⅱ', 3, 'Ⅲ')" ).append("\n"); 
		query.append("         when 26 then a.gnr_mkr_nm" ).append("\n"); 
		query.append("         when 27 then a.gnr_tp_desc" ).append("\n"); 
		query.append("         when 28 then DECODE(a.gnr_bhp_pwr,0,'',trim(to_char(a.gnr_bhp_pwr,'99,999,999')))" ).append("\n"); 
		query.append("         when 29 then DECODE(a.gnr_rpm_pwr,0,'',trim(to_char(a.gnr_rpm_pwr,'99,999,999')))" ).append("\n"); 
		query.append("         when 30 then a.bwthst_mkr_nm" ).append("\n"); 
		query.append("         when 31 then a.bwthst_tp_desc" ).append("\n"); 
		query.append("         when 32 then DECODE(a.bwthst_bhp_pwr,0,'',trim(to_char(a.bwthst_bhp_pwr,'99,999,999')))" ).append("\n"); 
		query.append("         when 33 then DECODE(a.bwthst_rpm_pwr,0,'',trim(to_char(a.bwthst_rpm_pwr,'99,999,999')))" ).append("\n"); 
		query.append("         when 34 then ''" ).append("\n"); 
		query.append("         when 35 then ''" ).append("\n"); 
		query.append("         when 36 then ''" ).append("\n"); 
		query.append("         when 37 then ''" ).append("\n"); 
		...
		query.append("             , decode(mvc.vsl_locl_nm, null, null, ' ('||mvc.vsl_locl_nm||')') vsl_locl_nm" ).append("\n"); 
