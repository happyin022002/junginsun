...
*@FileName : CanalTzFeeInvDtlByVvdOwnerAccountVO.java
*@FileTitle : CanalTzFeeInvDtlByVvdOwnerAccountVO
*Open Issues :
*Change history :
...
public class CanalTzFeeInvDtlByVvdOwnerAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CanalTzFeeInvDtlByVvdOwnerAccountVO> models = new ArrayList<CanalTzFeeInvDtlByVvdOwnerAccountVO>();
	...
	/* Column Info */
	private String invAtchFileNo = null;
	...
	/* Column Info */
	private String atchFileNo = null;
	/* Column Info */
	...
	public CanalTzFeeInvDtlByVvdOwnerAccountVO(String ibflag, String pagerows, String credits, String vndrSeq, String psoBztpCd, String vslCd, String skdVoyNo, String skdDirCd, String ydCd, String callSeq, String lgsCostCd, String lgsCostFullNm, String lastInv, String rqstAmt, String balance, String diffRmk, String calcAmt, String ydChgNo, String ydChgVerSeq, String dfltXprDesc, String sysXprDesc, String dfltSysXprDesc, String invNo, String invRgstNo, String suzNetTongWgt, String loclXchRt, String trVolVal, String scgRtAmt, String flg, String vvd, String cntrPnmCapa, String atchFileNo, String invAtchFileNo, String invDesc) {
		...
		this.invAtchFileNo = invAtchFileNo;
		this.ibflag = ibflag;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inv_atch_file_no", getInvAtchFileNo());
		...
		this.hashColumns.put("atch_file_no", getAtchFileNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inv_atch_file_no", "invAtchFileNo");
		...
		this.hashFields.put("atch_file_no", "atchFileNo");
	...
	/**
	 * Column Info
	 * @return invAtchFileNo
	 */
	public String getInvAtchFileNo() {
		return this.invAtchFileNo;
	}
	 ...
	 * @param invAtchFileNo
	 */
	public void setInvAtchFileNo(String invAtchFileNo) {
		this.invAtchFileNo = invAtchFileNo;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCredits(JSPUtil.getParameter(request, prefix + "credits", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setBalance(JSPUtil.getParameter(request, prefix + "balance", ""));
		setInvAtchFileNo(JSPUtil.getParameter(request, prefix + "inv_atch_file_no", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setDfltXprDesc(JSPUtil.getParameter(request, prefix + "dflt_xpr_desc", ""));
		...
		setSysXprDesc(JSPUtil.getParameter(request, prefix + "sys_xpr_desc", ""));
		setFlg(JSPUtil.getParameter(request, prefix + "flg", ""));
		setLastInv(JSPUtil.getParameter(request, prefix + "last_inv", ""));
		setSkdVoyNo(JSPUtil.getParameter(request, prefix + "skd_voy_no", ""));
		setCalcAmt(JSPUtil.getParameter(request, prefix + "calc_amt", ""));
		setAtchFileNo(JSPUtil.getParameter(request, prefix + "atch_file_no", ""));
		...
		setDfltSysXprDesc(JSPUtil.getParameter(request, prefix + "dflt_sys_xpr_desc", ""));
		setScgRtAmt(JSPUtil.getParameter(request, prefix + "scg_rt_amt", ""));
		setTrVolVal(JSPUtil.getParameter(request, prefix + "tr_vol_val", ""));
	 ...
	 * @param request
	 * @return CanalTzFeeInvDtlByVvdOwnerAccountVO[]
	 */
	public CanalTzFeeInvDtlByVvdOwnerAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CanalTzFeeInvDtlByVvdOwnerAccountVO[]
	 */
	public CanalTzFeeInvDtlByVvdOwnerAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CanalTzFeeInvDtlByVvdOwnerAccountVO model = null;
		...
		try {
			...
			String[] invAtchFileNo = (JSPUtil.getParameter(request, prefix	+ "inv_atch_file_no", length));
			...
			String[] atchFileNo = (JSPUtil.getParameter(request, prefix	+ "atch_file_no", length));
			...
			for (int i = 0; i < length; i++) {
				model = new CanalTzFeeInvDtlByVvdOwnerAccountVO();
				if (rqstAmt[i] != null)
				...
				if (invAtchFileNo[i] != null)
					model.setInvAtchFileNo(invAtchFileNo[i]);
				if (ibflag[i] != null)
				...
				if (atchFileNo[i] != null)
					model.setAtchFileNo(atchFileNo[i]);
				if (skdDirCd[i] != null)
		...
		return getCanalTzFeeInvDtlByVvdOwnerAccountVOs();
	}
	 ...
	 * @return CanalTzFeeInvDtlByVvdOwnerAccountVO[]
	 */
	public CanalTzFeeInvDtlByVvdOwnerAccountVO[] getCanalTzFeeInvDtlByVvdOwnerAccountVOs(){
		CanalTzFeeInvDtlByVvdOwnerAccountVO[] vos = (CanalTzFeeInvDtlByVvdOwnerAccountVO[])models.toArray(new CanalTzFeeInvDtlByVvdOwnerAccountVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.invAtchFileNo = this.invAtchFileNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.atchFileNo = this.atchFileNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
