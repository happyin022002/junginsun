...
*@FileName : OnTimeResultAnalysisDBDAOManageDrwPortListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnTimeResultAnalysisDBDAOManageDrwPortListUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Drewry Report의 Target Port List를 업데이트 한다.
	  * </pre>
	  */
	public OnTimeResultAnalysisDBDAOManageDrwPortListUSQL(){
		setQuery();
		...
		query.append("FileName : OnTimeResultAnalysisDBDAOManageDrwPortListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
