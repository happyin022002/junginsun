...
*@FileName : TrendLineDBDAOSearchDirCdByNoonRptRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAOSearchDirCdByNoonRptRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrendLineDBDAOSearchDirCdByNoonRptRSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAOSearchDirCdByNoonRptRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT SKD_DIR_CD" ).append("\n"); 
		...
		query.append("ORDER BY SKD_DIR_CD" ).append("\n"); 
