...
public class GeneralInvoiceAuditDBDAOgetSameVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT  NVL(MAX('''Y'''), '''Y''')--NVL(MAX('''Y'''), '''N''')" ).append("\n"); 
		query.append("#if (${budget_flag} == 'B') " ).append("\n"); 
		query.append("FROM   vsk_bud_vsl_port_skd a, vsk_bud_vsl_port_skd b, pso_charge p, pso_chg_dtl d" ).append("\n"); 
		query.append("#else " ).append("\n"); 
		query.append("FROM   vsk_vsl_port_skd a, vsk_vsl_port_skd b, pso_charge p, pso_chg_dtl d" ).append("\n"); 
