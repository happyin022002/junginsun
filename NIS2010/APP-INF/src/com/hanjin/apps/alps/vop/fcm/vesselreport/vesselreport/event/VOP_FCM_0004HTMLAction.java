...
public class VOP_FCM_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0004HTMLAction 객체를 생성
	 */
	public VOP_FCM_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0004Event event = new VopFcm0004Event();
		...
		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01) || command.isCommand(FormCommand.SEARCH02)){
			...
			event.setFcmDepRptVO((FcmDepRptVO)getVO(request, FcmDepRptVO.class));
