...
/**
 * VOP_VSK-0054 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  VOP_VSK-0054HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Ryu Hyuk
 * @see VOP_VSK_0054HTMLAction 참조
 * @since J2EE 1.4
 */

public class VopVsk0054Event extends EventSupport {
