...
public class VOP_VSK_0031HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0030HTMLAction 객체를 생성
	 */
	public VOP_VSK_0031HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0031Event event = new VopVsk0031Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDrwPortInfoVO((DrwPortInfoVO)getVO(request, DrwPortInfoVO.class));
    		...
    		MdmLocationVO vo = (MdmLocationVO)this.getVO(request, MdmLocationVO.class);
    		vo.setLocCd(portCd);
    		event.setMdmLocationVO(vo);	
		}
		return  event;
	}
