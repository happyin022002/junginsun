...
*@FileName : StevedoreDamageMgtDBDAOOpfStvDmgAllAtchFileVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOOpfStvDmgAllAtchFileVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOOpfStvDmgAllAtchFileVODSQL(){
		setQuery();
		...
		query.append("FileName : StevedoreDamageMgtDBDAOOpfStvDmgAllAtchFileVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
