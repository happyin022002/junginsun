...
*@FileName : VOP_VSK_0250HTMLAction.java
*@FileTitle : Port SKD Information
*Open Issues :
*Change history :
...
public class VOP_VSK_0250HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0250HTMLAction 객체를 생성
	 */
	public VOP_VSK_0250HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0250Event event = new VopVsk0250Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVslPortSkdVO((VslPortSkdVO)getVO(request, VslPortSkdVO.class));
		}
