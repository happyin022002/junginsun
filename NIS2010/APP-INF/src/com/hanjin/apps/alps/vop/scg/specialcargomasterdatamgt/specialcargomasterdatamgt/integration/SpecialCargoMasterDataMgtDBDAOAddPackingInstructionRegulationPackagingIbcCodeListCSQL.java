...
*@FileName : SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingIbcCodeListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingIbcCodeListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingIbcCodeListCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOAddPackingInstructionRegulationPackagingIbcCodeListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("##INSERT INTO SCG_PCK_REGU_PKG_IBC_CD" ).append("\n"); 
