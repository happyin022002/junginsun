...
*@FileName : VOP_OPF_0046_01HTMLAction.java
...
public class VOP_OPF_0046_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0046_01HTMLAction 객체를 생성
	 */
	public VOP_OPF_0046_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf004601Event event = new VopOpf004601Event();
		
        if(command.isCommand(FormCommand.SEARCH01)) {//Port Valid Check
        ...
        if(command.isCommand(FormCommand.SEARCHLIST02)) {//Import Movement Retrieve
            event.setRDRCrtListOptionVO( (RDRCrtListOptionVO)getVO(request, RDRCrtListOptionVO .class));
        }
