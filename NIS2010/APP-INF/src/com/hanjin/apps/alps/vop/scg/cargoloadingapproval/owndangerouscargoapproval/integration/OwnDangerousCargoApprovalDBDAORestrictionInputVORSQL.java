...
*@FileName : OwnDangerousCargoApprovalDBDAORestrictionInputVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAORestrictionInputVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAORestrictionInputVORSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAORestrictionInputVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", MAX(DECODE(VP.VPS_PORT_CD||VP.CLPT_IND_SEQ,@[pol_port_cd],VP.VPS_PORT_CD,'')) POL_CD" ).append("\n"); 
		query.append(", MAX(DECODE(VP.VPS_PORT_CD||VP.CLPT_IND_SEQ,@[pod_port_cd],VP.VPS_PORT_CD,'')) POD_CD" ).append("\n"); 
		query.append(", SUM(DECODE(VP.VPS_PORT_CD||VP.CLPT_IND_SEQ,@[pol_port_cd],VP.CLPT_SEQ, 0)) POL_SEQ" ).append("\n"); 
		query.append(", SUM(DECODE(VP.VPS_PORT_CD||VP.CLPT_IND_SEQ,@[pod_port_cd],VP.CLPT_SEQ, 0)) POD_SEQ" ).append("\n"); 
		query.append("FROM VSK_VSL_PORT_SKD VP" ).append("\n"); 
		query.append("WHERE VP.VPS_PORT_CD||VP.CLPT_IND_SEQ IN(@[pol_port_cd],@[pod_port_cd])" ).append("\n"); 
		...
		query.append(", VPS.CLPT_SEQ                    ORDER_NUM2" ).append("\n"); 
		query.append(", VPS.CLPT_IND_SEQ" ).append("\n"); 
		query.append(", NVL(SKD_CNG_STS_CD,'')          SKD_CNG_STS_CD" ).append("\n"); 
