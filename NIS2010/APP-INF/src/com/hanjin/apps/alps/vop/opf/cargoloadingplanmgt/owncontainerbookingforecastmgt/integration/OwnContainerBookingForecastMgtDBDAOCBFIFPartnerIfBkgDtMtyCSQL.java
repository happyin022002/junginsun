...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtMtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtMtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PARTNER CLL의 MTY데이터 수신
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtMtyCSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtMtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        X.CNTR_TPSZ_CD,  X.CNT, 'Y',   @[cre_usr_id]," ).append("\n"); 
		...
		query.append("       AND Y.MTY_BKG_FLG = 'Y'" ).append("\n"); 
		query.append("       GROUP BY  Y.VSL_CD, Y.SKD_VOY_NO, Y.SKD_DIR_CD, Y.YD_CD, Y.POL_CLPT_IND_SEQ," ).append("\n"); 
		query.append("                 Y.CRR_CD, Y.POD_CD,     Y.CNTR_TPSZ_CD ) X" ).append("\n"); 
