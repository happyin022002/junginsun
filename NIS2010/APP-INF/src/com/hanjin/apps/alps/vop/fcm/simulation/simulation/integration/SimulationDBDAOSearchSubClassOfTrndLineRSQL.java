...
*@FileName : SimulationDBDAOSearchSubClassOfTrndLineRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SimulationDBDAOSearchSubClassOfTrndLineRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Trnd Line이 생성되어 있는 Class Sub Code를 조회한다.
	  * </pre>
	  */
	public SimulationDBDAOSearchSubClassOfTrndLineRSQL(){
		setQuery();
		...
		query.append("FileName : SimulationDBDAOSearchSubClassOfTrndLineRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
