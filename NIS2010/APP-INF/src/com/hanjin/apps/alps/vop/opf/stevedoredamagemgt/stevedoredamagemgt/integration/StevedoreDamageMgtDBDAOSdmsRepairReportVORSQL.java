...
*@FileName : StevedoreDamageMgtDBDAOSdmsRepairReportVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOSdmsRepairReportVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SdmsRepairReportVO Select Query
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOSdmsRepairReportVORSQL(){
		setQuery();
		...
		query.append("FileName : StevedoreDamageMgtDBDAOSdmsRepairReportVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'O',1,0))                            ORDER_CNT," ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'R',1,0))                            REPR_CNT," ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'C',1,0))                            COMP_CNT," ).append("\n"); 
		query.append("ROUND(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'C',R.RPR_COST_USD_AMT,0)),2)  COMP_AMT," ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q',1,0))                            QUO_CNT," ).append("\n"); 
		query.append("ROUND(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q',R.QTTN_COST_USD_AMT,0)),2) QUO_AMT" ).append("\n"); 
