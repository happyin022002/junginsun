...
public class VskPortGntrCrnVO extends AbstractValueObject {
	...
	/* Column Info */
	private String spclCgoHndlRmk = null;	
	/* Column Info */
	...
	public VskPortGntrCrnVO(String ibflag, String pagerows, String ydCd, String ydNm, String grsMaxWgt, String netMaxWgt, String clrBtwnLegWdt, String crnRchRowKnt, String cntrTrKnt, String ttlGntrCrnQty, String vslGntrCrnMaxQty, String gntrRmk, String spclCgoHndlRmk, String atchFileKnt, String creUsrId, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.netMaxWgt = netMaxWgt;
		this.cntrTrKnt = cntrTrKnt;
		this.vslGntrCrnMaxQty = vslGntrCrnMaxQty;
		this.gntrRmk = gntrRmk;
		this.spclCgoHndlRmk = spclCgoHndlRmk;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("spcl_cgo_hndl_rmk", getSpclCgoHndlRmk	());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("spcl_cgo_hndl_rmk"	, "spclCgoHndlRmk"	);
	...
	/**
	 * Column Info
	 * @return spclCgoHndlRmk
	 */
	public String getSpclCgoHndlRmk() {
		return this.spclCgoHndlRmk;
	}
	...
	/**
	 * Column Info
	 * @param spclCgoHndlRmk
	 */
	public void setSpclCgoHndlRmk(String spclCgoHndlRmk) {
		this.spclCgoHndlRmk = spclCgoHndlRmk;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSpclCgoHndlRmk	(JSPUtil.getParameter(request, "spcl_cgo_hndl_rmk"	, ""));
		setAtchFileKnt		(JSPUtil.getParameter(request, "atch_file_knt"		, ""));
	...
	public VskPortGntrCrnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] spclCgoHndlRmk = (JSPUtil.getParameter(request, prefix	+ "spcl_cgo_hndl_rmk"	, length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (spclCgoHndlRmk[i] != null)
					model.setSpclCgoHndlRmk(spclCgoHndlRmk[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.spclCgoHndlRmk = this.spclCgoHndlRmk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
