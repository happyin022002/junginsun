...
*@FileName : SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationPKGMethodRefListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationPKGMethodRefListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationPKGMethodRefListUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationPKGMethodRefListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
