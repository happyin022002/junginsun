...
*@FileName : VOP_OPF_0087HTMLAction.java
...
public class VOP_OPF_0087HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0087HTMLAction 객체를 생성
	 */
	public VOP_OPF_0087HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0087Event event = new VopOpf0087Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setOpfTmlProdRptRsnCdVOS((OpfTmlProdRptRsnCdVO[])getVOs(request, OpfTmlProdRptRsnCdVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setOpfTmlProdRptRsnCdVO((OpfTmlProdRptRsnCdVO)getVO(request, OpfTmlProdRptRsnCdVO .class));
		}
