...
public class VOP_SCG_0021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0023HTMLAction 객체를 생성
	 */
	public VOP_SCG_0021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0021Event event = new VopScg0021Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setRestrictionInputVO( (RestrictionInputVO)getVO(request, RestrictionInputVO.class));
		}
