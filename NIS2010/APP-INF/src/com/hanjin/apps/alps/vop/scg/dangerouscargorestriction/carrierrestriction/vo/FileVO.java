...
public class FileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FileVO> models = new ArrayList<FileVO>();
	
	/* Column Info */
	private String imdgCrrRstrFileSeq = null;
	/* Column Info */
	...
	public FileVO(String ibflag, String pagerows, String updDt, String fileSavId, String creUsrId, String vslOprTpCd, String creDt, String imdgCrrRstrFileSeq, String fileNm, String fileSetYn, String updUsrId) {
		this.imdgCrrRstrFileSeq = imdgCrrRstrFileSeq;
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("imdg_crr_rstr_file_seq", getImdgCrrRstrFileSeq());
	...
	public HashMap<String, String> getFieldNames(){
		this.hashFields.put("imdg_crr_rstr_file_seq", "imdgCrrRstrFileSeq");
	...
	/**
	 * Column Info
	 * @return imdgCrrRstrFileSeq
	 */
	public String getImdgCrrRstrFileSeq() {
		return this.imdgCrrRstrFileSeq;
	}
	...
	/**
	 * Column Info
	 * @param imdgCrrRstrFileSeq
	 */
	public void setImdgCrrRstrFileSeq(String imdgCrrRstrFileSeq) {
		this.imdgCrrRstrFileSeq = imdgCrrRstrFileSeq;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setImdgCrrRstrFileSeq(JSPUtil.getParameter(request, prefix + "imdg_crr_rstr_file_seq", ""));
	 ...
	 * @return FileVO[]
	 */
	public FileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FileVO[]
	 */
	public FileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FileVO model = null;
		...
		try {
			String[] imdgCrrRstrFileSeq = (JSPUtil.getParameter(request, prefix	+ "imdg_crr_rstr_file_seq", length));
			...
			for (int i = 0; i < length; i++) {
				model = new FileVO();
				if (imdgCrrRstrFileSeq[i] != null)
					model.setImdgCrrRstrFileSeq(imdgCrrRstrFileSeq[i]);
				if (updDt[i] != null)
	...
	public FileVO[] getFileVOs(){
		FileVO[] vos = (FileVO[])models.toArray(new FileVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		this.imdgCrrRstrFileSeq = this.imdgCrrRstrFileSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
