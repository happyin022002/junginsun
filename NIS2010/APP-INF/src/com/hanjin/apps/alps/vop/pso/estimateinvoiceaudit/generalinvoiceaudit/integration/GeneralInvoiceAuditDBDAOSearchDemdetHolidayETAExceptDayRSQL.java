...
*@FileName : GeneralInvoiceAuditDBDAOSearchDemdetHolidayETAExceptDayRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOSearchDemdetHolidayETAExceptDayRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * ----------------------------------------------------------
	  * 2011.07.04 진마리아 CHM-201111567-01 신규추가
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOSearchDemdetHolidayETAExceptDayRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOSearchDemdetHolidayETAExceptDayRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
