...
*@FileName : VOP_SCG_0042HTMLAction.java
...
public class VOP_SCG_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0042HTMLAction 객체를 생성
	 */
	public VOP_SCG_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0042Event event = new VopScg0042Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgPckInstrVO((ScgImdgPckInstrVO)getVO(request, ScgImdgPckInstrVO.class));			
		}
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgPckInstrVOS((ScgImdgPckInstrVO[])getVOs(request, ScgImdgPckInstrVO.class,"sheet1_"));
		}
