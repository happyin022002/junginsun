...
public class StevedoreDamageMgtDBDAOOpfStvDmgCreateVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND     S.INTG_CD_VAL_CTNT  = dmg.vsl_oshp_cntr_blk_tp_cd" ).append("\n"); 
		query.append(") AS VSL_OSHP_CNTR_BLK_TP_DESC" ).append("\n"); 
		...
		query.append(",	dmgDtl.stv_dmg_respb_pty_kwn_cd" ).append("\n"); 
		...
		query.append("FROM opf_stv_dmg dmg, opf_stv_dmg_dtl dmgDtl, VSK_VSL_SKD T01" ).append("\n"); 
		query.append("WHERE	1=1" ).append("\n"); 
		query.append("AND		dmg.stv_dmg_no LIKE @[stv_dmg_no]||'%'" ).append("\n"); 
		query.append("AND		dmg.stv_dmg_no = dmgDtl.stv_dmg_no" ).append("\n"); 
		query.append("AND		DMG.VSL_CD     = T01.VSL_CD     (+)" ).append("\n"); 
		query.append("AND		DMG.SKD_VOY_NO = T01.SKD_VOY_NO (+)" ).append("\n"); 
		query.append("AND     DMG.SKD_DIR_CD = T01.SKD_DIR_CD (+)" ).append("\n"); 
