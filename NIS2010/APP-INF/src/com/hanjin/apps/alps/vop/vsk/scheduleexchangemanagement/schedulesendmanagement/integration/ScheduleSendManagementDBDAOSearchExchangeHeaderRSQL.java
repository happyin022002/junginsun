...
*@FileName : ScheduleSendManagementDBDAOSearchExchangeHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ScheduleSendManagementDBDAOSearchExchangeHeaderRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ScheduleSendManagementDBDAOSearchExchangeHeaderRSQL(){
		setQuery();
		...
		query.append("FileName : ScheduleSendManagementDBDAOSearchExchangeHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND			X.SND_RCV_KND_CD			= 'S'" ).append("\n"); 
		query.append("AND         X.VSL_CD_CTNT               = @[vsl_cd_ctnt]" ).append("\n"); 
		query.append("AND         X.SKD_VOY_NO_CTNT           = @[skd_voy_no_ctnt]" ).append("\n"); 
		query.append("AND         X.SKD_DIR_CD_CTNT           = @[skd_dir_cd_ctnt]" ).append("\n"); 
