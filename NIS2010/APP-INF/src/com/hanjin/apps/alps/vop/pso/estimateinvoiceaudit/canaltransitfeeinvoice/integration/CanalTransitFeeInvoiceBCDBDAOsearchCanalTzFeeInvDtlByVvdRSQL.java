...
public class CanalTransitFeeInvoiceBCDBDAOsearchCanalTzFeeInvDtlByVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	       AND X.LGS_COST_CD = T1.LGS_COST_CD" ).append("\n"); 
		query.append("	       AND X.LGS_COST_CD IS NOT NULL" ).append("\n"); 
		query.append("        )ATCH_FILE_NO," ).append("\n"); 
		query.append("       (SELECT COUNT(*)" ).append("\n"); 
		query.append("          FROM PSO_CNL_TZ_ATCH_FILE X" ).append("\n"); 
		query.append("         WHERE X.VSL_CD      = substr(@[vvd], 1, 4)" ).append("\n"); 
		query.append("           AND X.SKD_VOY_NO  = substr(@[vvd], 5, 4)" ).append("\n"); 
		...
		query.append("        ) INV_ATCH_FILE_NO" ).append("\n"); 
		...
		query.append("             YD_CD," ).append("\n"); 
		query.append("             CALL_SEQ," ).append("\n"); 
		query.append("             DECODE (grp2, 1, DECODE (grp, 1, 'ZZZZZZTTL', acct_cd), lgs_cost_cd) LGS_COST_CD," ).append("\n"); 
		query.append("             (" ).append("\n"); 
		query.append("               SELECT x.lgs_cost_full_nm" ).append("\n"); 
		query.append("               FROM TES_LGS_COST x" ).append("\n"); 
		query.append("               WHERE x.lgs_cost_cd = DECODE ( grp2, 1, DECODE (grp, 1, 'ZZZZZZTTL', z.acct_cd), z.lgs_cost_cd )" ).append("\n"); 
		query.append("             ) LGS_COST_FULL_NM," ).append("\n"); 
		query.append("             DECODE (grp2, 1, DECODE (grp, 1, 'TTL', acct_cd), lgs_cost_cd) dsp_cost_cd," ).append("\n"); 
		query.append("             LAST_INV," ).append("\n"); 
		query.append("             debits RQST_AMT," ).append("\n"); 
		query.append("             DECODE ( grp2, 1, nvl(debits, 0) - nvl(credits, 0), debits-credits) BALANCE," ).append("\n"); 
		query.append("             DIFF_RMK," ).append("\n"); 
		query.append("             CALC_AMT," ).append("\n"); 
		...
		query.append("                 AND X.SO_SEQ = Z.SO_SEQ) INV_NO," ).append("\n"); 
		query.append("             (" ).append("\n"); 
		query.append("               SELECT X.INV_RGST_NO" ).append("\n"); 
		query.append("               FROM PSO_CHARGE X" ).append("\n"); 
		query.append("               WHERE X.ISS_CTY_CD = Z.ISS_CTY_CD" ).append("\n"); 
		query.append("                 AND X.SO_SEQ = Z.SO_SEQ) INV_RGST_NO," ).append("\n"); 
		query.append("             SUZ_NET_TONG_WGT," ).append("\n"); 
		query.append("             LOCL_XCH_RT," ).append("\n"); 
		query.append("             TR_VOL_VAL," ).append("\n"); 
		query.append("             SCG_RT_AMT," ).append("\n"); 
		...
		query.append("      FROM (" ).append("\n"); 
		query.append("          SELECT MAX (LGS_COST_CD) LGS_COST_CD," ).append("\n"); 
		...
		query.append("                   SUM (LAST_INV) LAST_INV" ).append("\n"); 
		query.append("            FROM (" ).append("\n"); 
		query.append("                  SELECT CNL_TZ_BZTP_CD," ).append("\n"); 
		query.append("                         C1.LGS_COST_CD," ).append("\n"); 
		query.append("                         NULL DEBITS," ).append("\n"); 
		query.append("                         RQST_AMT AS CREDITS," ).append("\n"); 
		query.append("                         CALC_AMT," ).append("\n"); 
		...
		query.append("                 PSO_CNL_TZ_FEE_DTL Y" ).append("\n"); 
		query.append("               WHERE X.CNL_TZ_BZTP_CD     = 'I'" ).append("\n"); 
		query.append("                 AND X.CNL_TZ_PROC_STS_CD = 'A'" ).append("\n"); 
		query.append("                 AND X.REV_YRMON BETWEEN TO_CHAR ( ADD_MONTHS ( TO_DATE (@[rev_yrmon], 'yyyymm'), -6 ), 'yyyymm' ) AND TO_CHAR ( ADD_MONTHS ( TO_DATE (@[rev_yrmon], 'yyyymm' ), -1 ), 'yyyymm' )" ).append("\n"); 
		query.append("                 AND X.PSO_BZTP_CD = T1.PSO_BZTP_CD" ).append("\n"); 
		...
		query.append("                 AND T1.CALL_SEQ <> X.CALL_SEQ" ).append("\n"); 
		query.append("                 AND T1.YD_CD      = X.YD_CD" ).append("\n"); 
		...
		query.append("                 AND Y.LGS_COST_CD = T2.LGS_COST_CD" ).append("\n"); 
		query.append("             ) LAST_INV " ).append("\n"); 
		...
		query.append("                  AND T2.LGS_COST_CD NOT LIKE 'CNOW%'" ).append("\n"); 
		query.append("                  )" ).append("\n"); 
		query.append("            GROUP BY ROLLUP (SUBSTR (LGS_COST_CD, 1, 4), LGS_COST_CD)" ).append("\n"); 
		query.append("           ) z" ).append("\n"); 
		query.append("      WHERE NOT ( z.calc_amt IS NULL" ).append("\n"); 
		query.append("      AND z.grp2 = 0" ).append("\n"); 
		query.append("      AND z.credits IS NULL)" ).append("\n"); 
		...
		query.append("  AND flg IN (0,2)" ).append("\n"); 
