...
*@FileName : OwnDangerousCargoApprovalDBDAOScgDgCgoVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgDgCgoVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * SCG_DG_CGO Insert
	  * History------------------------------------------------------------------------------------
	  * 2012.12.27 [CHM-201112981-01] 표준희 위험물 입력 관련 로직 변경 및 추가 요청 : HZD_CTNT, STWG_TEMP_CTNT 컬럼 추가
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgDgCgoVOCSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgDgCgoVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_DG_CGO (" ).append("\n"); 
		...
		query.append(",	STWG_TEMP_CTNT" ).append("\n"); 
		query.append(") " ).append("\n"); 
