...
/*tab5************************************start*/
	 /**
	 * Canal 단건의 데이터를 생성한다.<br>
	 * 
	 * @param VskPortDocBufTmVO vo
	 * @throws DAOException
	 */
	public void addPortCanelS(VskPortCnlPassCondVO vo) throws DAOException,Exception {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
	...
	/**
	 * Canal 단건의 데이터를 갱신한다.<br>
	 * 
	 * @param VskPortDocBufTmVO vo
	 * @return int
	 * @throws DAOException
	 */
	public int modifyPortCanelS(VskPortCnlPassCondVO vo) throws DAOException,Exception {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			SQLExecuter sqlExe = new SQLExecuter("");
			result = sqlExe.executeUpdate((ISQLTemplate)new PortInformationMgtDBDAOVskPortCnlPassCondVOUSQL(), param, velParam);
			if(result == Statement.EXECUTE_FAILED)
					throw new DAOException("Fail to insert SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(),se);
	...
	/**
	 * Canal 단건의 데이터를 삭제한다.<br>
	 * 
	 * @param VskPortDocBufTmVO vo
	 * @return int
	 * @throws DAOException
	 */
	public int removePortCanelS(VskPortCnlPassCondVO vo) throws DAOException,Exception {
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		Map<String, Object> velParam = new HashMap<String, Object>();
		...
		try {
			...
			SQLExecuter sqlExe = new SQLExecuter("");
			result = sqlExe.executeUpdate((ISQLTemplate)new PortInformationMgtDBDAOVskPortCnlPassCondVODSQL(), param, velParam);
			if(result == Statement.EXECUTE_FAILED)
					throw new DAOException("Fail to insert SQL");
		} catch (SQLException se) {
			log.error(se.getMessage(),se);
