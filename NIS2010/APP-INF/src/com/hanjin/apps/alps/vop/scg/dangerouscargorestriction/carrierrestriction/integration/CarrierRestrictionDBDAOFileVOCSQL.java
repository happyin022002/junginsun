...
*@FileName : CarrierRestrictionDBDAOFileVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierRestrictionDBDAOFileVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierRestrictionDBDAOFileVOCSQL(){
		setQuery();
		...
		query.append("FileName : CarrierRestrictionDBDAOFileVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_CRR_RSTR_FILE (" ).append("\n"); 
		query.append("	VSL_OPR_TP_CD" ).append("\n"); 
		query.append(",	IMDG_CRR_RSTR_FILE_SEQ" ).append("\n"); 
