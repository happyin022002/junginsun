...
public class ScgPrnrAproRqstCgoVO extends AbstractValueObject {
	...
	public ScgPrnrAproRqstCgoVO(String ibflag, String pagerows, String outN1stImdgPckQty, String outN1stImdgPckCd, String outN1stImdgPckDesc, String outN2ndImdgPckQty, String outN2ndImdgPckCd, String outN2ndImdgPckDesc, String maxInPckQty, String maxInPckTpCd, String cneeDtlDesc, String netExploWgt, String radaSkdNo, String radaAmt, String radaUtCd, String radaTrspNo, String diffRmk, String cgoRqstDt, String creUsrId, String creDt, String updUsrId, String updDt, String cntrRefNo, String spclCgoCateCd, String cntrTpszCd, String authDt, String authOfcCd, String authUsrId, String authStsCd, String aproRefNo, String cgoOprCd, String crrCd, String bkgRefNo, String spclCgoRqstSeq, String spclCntrSeq, String spclCgoSeq, String imdgUnNo, String imdgUnNoSeq, String imdgClssCd, String n1stImdgSubsRskLblCd, String n2ndImdgSubsRskLblCd, String n3rdImdgSubsRskLblCd, String n4thImdgSubsRskLblCd, String imdgCoGrpCd, String imdgPckGrpCd, String imdgLmtQtyFlg, String imdgExptQtyFlg, String mrnPolutFlg, String flshPntCdoTemp, String prpShpNm, String hzdDesc, String dcgoStsCd, String measQty, String measTpCd, String pckQty, String pckTpCd, String clodFlg, String spclStwgRqstDesc, String cgoLclFlg, String emerRspnGidNo, String emerRspnGidChrNo, String emerCntcPhnNo, String emerCntcPsonNm, String emerTempCtnt, String ctrlTempCtnt, String emsNo, String cmdtDesc, String ttlDimLen, String ttlDimWdt, String ttlDimHgt, String fwrdOvrDimLen, String bkwdOvrDimLen, String hgtOvrDimLen, String lfSdOvrDimLen, String rtSdOvrDimLen, String voidSltQty, String netWgt, String grsWgt, String grsCapaQty, String wgtUtCd, String psaNo, String certiNo, String inN1stImdgPckQty, String inN1stImdgPckCd, String inN1stImdgPckDesc, String inN2ndImdgPckQty, String inN2ndImdgPckCd, String inN2ndImdgPckDesc, String hcdgPckRstrDesc, String hcdgIntmdBcRstrDesc, String hcdgTnkRstrDesc, String imdgLmtQty, String imdgLmtQtyMeasUtCd, String imdgExptQtyCd, String imdgCompGrpCd, String hcdgFlg, String imdgSubsRskLblRmk, String imdgSpclProviNo, String intmdN1stImdgPckQty, String intmdN1stImdgPckCd, String intmdN1stImdgPckDesc, String intmdN2ndImdgPckQty, String intmdN2ndImdgPckCd, String intmdN2ndImdgPckDesc, String vslCd, String skdVoyNo, String skdDirCd, String slanCd, String polCd, String podCd, String dgFlg, String awkFlg, String bBFlag, String reeferFlag, String vltgNo, String fdoTemp, String cdoTemp, String ventRto, String cbmPerHrQty, String mdtFlg, String piFlg, String ltdQtyFlg, String exptQtyFlg, String segFlg, String portFlg, String crrFlg, String emerCntcPhnNoCtnt,String eaiIfFlg,String eaiEvntDt,String eaiIfId, String imdgSegrGrpNo)	{
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("crr_flg", getCrrFlg());
		...
		this.hashColumns.put("port_flg", getPortFlg());
		...
		this.hashColumns.put("mdt_flg", getMdtFlg());
		...
		this.hashColumns.put("ltd_qty_flg", getLtdQtyFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("crr_flg", "crrFlg");
		...
		this.hashFields.put("port_flg", "portFlg");
		...
		this.hashFields.put("mdt_flg", "mdtFlg");
		...
		this.hashFields.put("ltd_qty_flg", "ltdQtyFlg");
	...
	*/
	 ...
	 * @return ltdQtyFlg
	 */
	public String getLtdQtyFlg() {
		return this.ltdQtyFlg;
	}
	 ...
	 * @param crrFlg
	 */
	public void setCrrFlg(String crrFlg) {
		this.crrFlg = crrFlg;
	}
	 ...
	 * @param portFlg
	 */
	public void setPortFlg(String portFlg) {
		this.portFlg = portFlg;
	}
	 ...
	 * @param piFlg
	 */
	public void setPiFlg(String piFlg) {
		this.piFlg = piFlg;
	}
	 ...
	 * @param segFlg
	 */
	public void setSegFlg(String segFlg) {
		this.segFlg = segFlg;
	}
	 ...
	 * @param mdtFlg
	 */
	public void setMdtFlg(String mdtFlg) {
		this.mdtFlg = mdtFlg;
	}
	 ...
	 * @param ltdQtyFlg
	 */
	public void setLtdQtyFlg(String ltdQtyFlg) {
		this.ltdQtyFlg = ltdQtyFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCrrFlg(JSPUtil.getParameter(request, prefix + "crr_flg", ""));
		...
		setExptQtyFlg(JSPUtil.getParameter(request, prefix + "expt_qty_flg", ""));
		...
		setPortFlg(JSPUtil.getParameter(request, prefix + "port_flg", ""));
		...
		setPiFlg(JSPUtil.getParameter(request, prefix + "pi_flg", ""));
		...
		setSegFlg(JSPUtil.getParameter(request, prefix + "seg_flg", ""));
		...
		setMdtFlg(JSPUtil.getParameter(request, prefix + "mdt_flg", ""));
		...
		setLtdQtyFlg(JSPUtil.getParameter(request, prefix + "ltd_qty_flg", ""));
	...
	public ScgPrnrAproRqstCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] crrFlg = (JSPUtil.getParameter(request, prefix	+ "crr_flg", length));
			...
			String[] exptQtyFlg = (JSPUtil.getParameter(request, prefix	+ "expt_qty_flg", length));
			...
			String[] portFlg = (JSPUtil.getParameter(request, prefix	+ "port_flg", length));
			...
			String[] piFlg = (JSPUtil.getParameter(request, prefix	+ "pi_flg", length));
			...
			String[] segFlg = (JSPUtil.getParameter(request, prefix	+ "seg_flg", length));
			...
			String[] mdtFlg = (JSPUtil.getParameter(request, prefix	+ "mdt_flg", length));
			...
			String[] ltdQtyFlg = (JSPUtil.getParameter(request, prefix	+ "ltd_qty_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ltdQtyFlg[i] != null)
					model.setLtdQtyFlg(ltdQtyFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.crrFlg = this.crrFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.exptQtyFlg = this.exptQtyFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.portFlg = this.portFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.piFlg = this.piFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.segFlg = this.segFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.mdtFlg = this.mdtFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ltdQtyFlg = this.ltdQtyFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
