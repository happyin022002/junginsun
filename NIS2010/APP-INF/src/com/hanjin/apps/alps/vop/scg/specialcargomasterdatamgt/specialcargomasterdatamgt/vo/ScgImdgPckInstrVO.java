...
*@FileName : ScgImdgPckInstrVO.java
*@FileTitle : ScgImdgPckInstrVO
*Open Issues :
*Change history :
...
public class ScgImdgPckInstrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgImdgPckInstrVO> models = new ArrayList<ScgImdgPckInstrVO>();
	...
	/* Column Info */
	private String oldImdgPckInstrCd = null;
	/* Column Info */
	private String fileNm = null;
	/* Column Info */
	private String updUsrId = null;
	/* Column Info */
	private String imdgPckInstrSubSeq = null;
	/* Column Info */
	...
	public ScgImdgPckInstrVO() {}

	public ScgImdgPckInstrVO(String ibflag, String pagerows, String imdgPckInstrCd, String imdgPckInstrSeq, String fileSavId, String fileNm, String creUsrId, String creDt, String updUsrId, String updDt, String oldImdgPckInstrCd, String fileSetYn, String imdgPckInstrSubSeq, String pckDesc) {
		this.updDt = updDt;
		...
		this.oldImdgPckInstrCd = oldImdgPckInstrCd;
		this.fileNm = fileNm;
		this.updUsrId = updUsrId;
		this.imdgPckInstrSubSeq = imdgPckInstrSubSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("old_imdg_pck_instr_cd", getOldImdgPckInstrCd());
		this.hashColumns.put("file_nm", getFileNm());
		this.hashColumns.put("upd_usr_id", getUpdUsrId());
		this.hashColumns.put("imdg_pck_instr_sub_seq", getImdgPckInstrSubSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("old_imdg_pck_instr_cd", "oldImdgPckInstrCd");
		this.hashFields.put("file_nm", "fileNm");
		this.hashFields.put("upd_usr_id", "updUsrId");
		this.hashFields.put("imdg_pck_instr_sub_seq", "imdgPckInstrSubSeq");
	...
	/**
	 * Column Info
	 * @return oldImdgPckInstrCd
	 */
	public String getOldImdgPckInstrCd() {
		return this.oldImdgPckInstrCd;
	}
	...
	/**
	 * Column Info
	 * @return imdgPckInstrSubSeq
	 */
	public String getImdgPckInstrSubSeq() {
		return this.imdgPckInstrSubSeq;
	}
	/**
	 * Column Info
	 * @return pckDesc
	...
	/**
	 * Column Info
	 * @param oldImdgPckInstrCd
	 */
	public void setOldImdgPckInstrCd(String oldImdgPckInstrCd) {
		this.oldImdgPckInstrCd = oldImdgPckInstrCd;
	}
	...
	/**
	 * Column Info
	 * @param imdgPckInstrSubSeq
	 */
	public void setImdgPckInstrSubSeq(String imdgPckInstrSubSeq) {
		this.imdgPckInstrSubSeq = imdgPckInstrSubSeq;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setImdgPckInstrCd(JSPUtil.getParameter(request, "imdg_pck_instr_cd", ""));
		setFileSetYn(JSPUtil.getParameter(request, "file_set_yn", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setImdgPckInstrSeq(JSPUtil.getParameter(request, "imdg_pck_instr_seq", ""));
		setOldImdgPckInstrCd(JSPUtil.getParameter(request, "old_imdg_pck_instr_cd", ""));
		setFileNm(JSPUtil.getParameter(request, "file_nm", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setImdgPckInstrSubSeq(JSPUtil.getParameter(request, "imdg_pck_instr_sub_seq", ""));
	 ...
	 */
	public ScgImdgPckInstrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgImdgPckInstrVO[]
	 */
	public ScgImdgPckInstrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgImdgPckInstrVO model = null;
		...
		try {
			...
			String[] oldImdgPckInstrCd = (JSPUtil.getParameter(request, prefix	+ "old_imdg_pck_instr_cd", length));
			String[] fileNm = (JSPUtil.getParameter(request, prefix	+ "file_nm", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] imdgPckInstrSubSeq = (JSPUtil.getParameter(request, prefix	+ "imdg_pck_instr_sub_seq", length));
			String[] pckDesc = (JSPUtil.getParameter(request, prefix	+ "pck_desc", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new ScgImdgPckInstrVO();
				if (updDt[i] != null)
				...
				if (oldImdgPckInstrCd[i] != null)
					model.setOldImdgPckInstrCd(oldImdgPckInstrCd[i]);
				if (fileNm[i] != null)
					model.setFileNm(fileNm[i]);
				if (updUsrId[i] != null)
					model.setUpdUsrId(updUsrId[i]);
				if (imdgPckInstrSubSeq[i] != null)
					model.setImdgPckInstrSubSeq(imdgPckInstrSubSeq[i]);
				if (pckDesc[i] != null)
	...
	public ScgImdgPckInstrVO[] getScgImdgPckInstrVOs(){
		ScgImdgPckInstrVO[] vos = (ScgImdgPckInstrVO[])models.toArray(new ScgImdgPckInstrVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.oldImdgPckInstrCd = this.oldImdgPckInstrCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.fileNm = this.fileNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.updUsrId = this.updUsrId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.imdgPckInstrSubSeq = this.imdgPckInstrSubSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
