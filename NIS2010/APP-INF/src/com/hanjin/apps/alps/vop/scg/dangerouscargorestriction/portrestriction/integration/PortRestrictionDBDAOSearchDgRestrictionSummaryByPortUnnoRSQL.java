...
*@FileName : PortRestrictionDBDAOSearchDgRestrictionSummaryByPortUnnoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortRestrictionDBDAOSearchDgRestrictionSummaryByPortUnnoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortRestrictionDBDAOSearchDgRestrictionSummaryByPortUnnoRSQL(){
		setQuery();
		...
		query.append("FileName : PortRestrictionDBDAOSearchDgRestrictionSummaryByPortUnnoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  CASE WHEN B.IMDG_CLSS_CD IS NOT NULL THEN '√' END RESTRIC_REGYN," ).append("\n"); 
		...
		query.append("        B.IMDG_UN_NO_SEQ," ).append("\n"); 
		query.append("        (" ).append("\n"); 
		...
		query.append("WHERE   B.PORT_CD      = @[port_cd]" ).append("\n"); 
		query.append("  AND   B.IMDG_UN_NO   IS NOT NULL" ).append("\n"); 
		query.append("#if (${imdg_un_no} != '') " ).append("\n"); 
		query.append("  AND    B.IMDG_UN_NO  = @[imdg_un_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY   B.IMDG_CLSS_CD, B.IMDG_UN_NO, B.IMDG_UN_NO_SEQ" ).append("\n"); 
