 ...
 * @since J2EE 1.5
 */
public class VskComboVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VskComboVO> models = new ArrayList<VskComboVO>();
	 ...
	 * @param comboCd
	 */
	public VskComboVO(String ibflag, String pagerows, String val, String name, String desc, String comboCd) {
	 ...
	 * @return
	 */
	public VskComboVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return
	 */
	public VskComboVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VskComboVO model = null;
	 ...
	 * @return
	 */
	public VskComboVO[] getBkgComboVOs(){
		VskComboVO[] vos = (VskComboVO[])models.toArray(new VskComboVO[models.size()]);
		return vos;
	}
