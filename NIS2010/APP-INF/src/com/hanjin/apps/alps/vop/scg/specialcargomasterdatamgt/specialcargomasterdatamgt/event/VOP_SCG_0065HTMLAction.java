...
*@FileName : VOP_SCG_0065HTMLAction.java
...
public class VOP_SCG_0065HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0065HTMLAction 객체를 생성
	 */
	public VOP_SCG_0065HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0065Event event = new VopScg0065Event();
		

		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgCompGrpVOS((ScgImdgCompGrpVO[])getVOs(request, ScgImdgCompGrpVO .class,""));
		}
