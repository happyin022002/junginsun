...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoDgDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoDgDtlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoDgDtlDSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoDgDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    FROM OPF_CGO_BKG_FCAST_DG_DTL A" ).append("\n"); 
