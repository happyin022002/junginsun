...
*@FileName : TrendLineDBDAOSearchFcmTrndLineForInqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAOSearchFcmTrndLineForInqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrendLineDBDAOSearchFcmTrndLineForInqRSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAOSearchFcmTrndLineForInqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
