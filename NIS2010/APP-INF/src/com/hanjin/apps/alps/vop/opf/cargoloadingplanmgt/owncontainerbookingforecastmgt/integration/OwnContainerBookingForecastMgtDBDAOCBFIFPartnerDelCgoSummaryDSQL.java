...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSummaryDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSummaryDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSummaryDSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSummaryDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
