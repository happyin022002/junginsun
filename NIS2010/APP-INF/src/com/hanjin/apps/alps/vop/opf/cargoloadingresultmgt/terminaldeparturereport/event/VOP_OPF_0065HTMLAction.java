...
*@FileName : VOP_OPF_0065HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class VOP_OPF_0065HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UserHTMLAction 객체를 생성
	 */
	public VOP_OPF_0065HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */
    	...
    	VopOpf0065Event event = new VopOpf0065Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFleetStatusVO((FleetStatusVO)getVO(request, FleetStatusVO.class));
		}
