...
public class IMDGCodeMgtDBDAOScgImdgUnNoVOCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	@[n4th_imdg_tnk_instr_provi_cd]" ).append("\n"); 
		query.append(",	@[n5th_imdg_tnk_instr_provi_cd]" ).append("\n"); 
		query.append(",	DECODE(@[n1st_imdg_pck_instr_cd], null, null, NVL(@[n1st_imdg_pck_instr_seq], 2))   -- SCG_IMDG_PCK_INSTR 의 SEQ 와 SYNC" ).append("\n"); 
		query.append(",	DECODE(@[n2nd_imdg_pck_instr_cd], null, null, NVL(@[n2nd_imdg_pck_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n3rd_imdg_pck_instr_cd], null, null, NVL(@[n3rd_imdg_pck_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n1st_imdg_pck_provi_cd], null, null, NVL(@[n1st_imdg_pck_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n2nd_imdg_pck_provi_cd], null, null, NVL(@[n2nd_imdg_pck_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n3rd_imdg_pck_provi_cd], null, null, NVL(@[n3rd_imdg_pck_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n4th_imdg_pck_provi_cd], null, null, NVL(@[n4th_imdg_pck_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n5th_imdg_pck_provi_cd], null, null, NVL(@[n5th_imdg_pck_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n1st_imdg_ibc_instr_cd], null, null, NVL(@[n1st_imdg_ibc_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n2nd_imdg_ibc_instr_cd], null, null, NVL(@[n2nd_imdg_ibc_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n3rd_imdg_ibc_instr_cd], null, null, NVL(@[n3rd_imdg_ibc_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n4th_imdg_ibc_instr_cd], null, null, NVL(@[n4th_imdg_ibc_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n5th_imdg_ibc_instr_cd], null, null, NVL(@[n5th_imdg_ibc_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n1st_imdg_ibc_provi_cd], null, null, NVL(@[n1st_imdg_ibc_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n2nd_imdg_ibc_provi_cd], null, null, NVL(@[n2nd_imdg_ibc_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n3rd_imdg_ibc_provi_cd], null, null, NVL(@[n3rd_imdg_ibc_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n4th_imdg_ibc_provi_cd], null, null, NVL(@[n4th_imdg_ibc_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n5th_imdg_ibc_provi_cd], null, null, NVL(@[n5th_imdg_ibc_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n1st_imdg_un_tnk_instr_cd], null, null, NVL(@[n1st_imdg_un_tnk_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n2nd_imdg_un_tnk_instr_cd], null, null, NVL(@[n2nd_imdg_un_tnk_instr_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n1st_imdg_tnk_instr_provi_cd], null, null, NVL(@[n1st_imdg_tnk_instr_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n2nd_imdg_tnk_instr_provi_cd], null, null, NVL(@[n2nd_imdg_tnk_instr_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n3rd_imdg_tnk_instr_provi_cd], null, null, NVL(@[n3rd_imdg_tnk_instr_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n4th_imdg_tnk_instr_provi_cd], null, null, NVL(@[n4th_imdg_tnk_instr_provi_seq], 2))" ).append("\n"); 
		query.append(",	DECODE(@[n5th_imdg_tnk_instr_provi_cd], null, null, NVL(@[n5th_imdg_tnk_instr_provi_seq], 2))" ).append("\n"); 
		query.append(",	@[hcdg_pck_rstr_desc]" ).append("\n"); 
		query.append(",	@[hcdg_intmd_bc_rstr_desc]" ).append("\n"); 
		query.append(",	@[hcdg_tnk_rstr_desc]" ).append("\n"); 
		query.append(",	@[segr_desc]" ).append("\n"); 
