...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgCntcPntPolVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgCntcPntPolVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgCntcPntPolVOUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgCntcPntPolVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_CNTC_PNT_POL SET " ).append("\n"); 
