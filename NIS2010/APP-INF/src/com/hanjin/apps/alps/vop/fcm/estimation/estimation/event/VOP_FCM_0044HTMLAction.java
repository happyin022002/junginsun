...
*@FileName : VOP_FCM_0044HTMLAction.java
...
public class VOP_FCM_0044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0044HTMLAction 객체를 생성
	 */
	public VOP_FCM_0044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0044Event event = new VopFcm0044Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFcmRmnOilMonEndRptVO((FcmRmnOilMonEndRptVO)getVO(request, FcmRmnOilMonEndRptVO.class));		
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setFcmRmnOilMonEndRptVOs((FcmRmnOilMonEndRptVO[])getVOs(request, FcmRmnOilMonEndRptVO.class));		
		} 
