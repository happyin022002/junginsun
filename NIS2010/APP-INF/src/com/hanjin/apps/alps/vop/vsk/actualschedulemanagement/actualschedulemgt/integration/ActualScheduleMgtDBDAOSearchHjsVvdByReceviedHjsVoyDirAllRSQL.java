...
*@FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirAllRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 수신된 SML Voyage, SML Directon, Call Sign No, Yard Code를 이용한 SML에 맵핑되는 모든 VVD를 조회한다.
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirAllRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedHjsVoyDirAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  VSL_CD, SKD_VOY_NO, SKD_DIR_CD, YD_CD" ).append("\n"); 
		...
		query.append("AND    VPS_PORT_CD = @[vps_port_cd]" ).append("\n"); 
		query.append("AND    'S'        != NVL(SKD_CNG_STS_CD, ' ')" ).append("\n"); 
		query.append("GROUP BY VSL_CD, SKD_VOY_NO, SKD_DIR_CD, YD_CD" ).append("\n"); 
