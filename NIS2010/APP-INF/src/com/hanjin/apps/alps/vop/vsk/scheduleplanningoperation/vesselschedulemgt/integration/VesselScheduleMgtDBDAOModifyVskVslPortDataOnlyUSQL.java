...
public class VesselScheduleMgtDBDAOModifyVskVslPortDataOnlyUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      , TTL_DLAY_HRS           = NVL(@[ttl_dlay_hrs], '0')" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("      --::2013-04-23::--, SLAN_CD                = NVL([slan_cd], SLAN_CD)" ).append("\n"); 
		query.append("      , SLAN_CD                = (	SELECT 	VS.VSL_SLAN_CD " ).append("\n"); 
		...
		query.append("      , PHS_IO_RSN_CD          = LTRIM(@[phs_io_rsn_cd])" ).append("\n"); 
		query.append("      , PHS_IO_RMK             = LTRIM(@[phs_io_rmk])" ).append("\n"); 
