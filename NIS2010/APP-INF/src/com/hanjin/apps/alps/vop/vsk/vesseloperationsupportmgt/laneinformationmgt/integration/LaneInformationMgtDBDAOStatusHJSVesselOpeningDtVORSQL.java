...
*@FileName : LaneInformationMgtDBDAOStatusHJSVesselOpeningDtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneInformationMgtDBDAOStatusHJSVesselOpeningDtVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Status SML Vessel Opening DtVO
	  * </pre>
	  */
	public LaneInformationMgtDBDAOStatusHJSVesselOpeningDtVORSQL(){
		setQuery();
		...
		query.append("FileName : LaneInformationMgtDBDAOStatusHJSVesselOpeningDtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
