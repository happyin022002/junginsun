...
*@FileName : VesselReportDBDAOVslDepRptErrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselReportDBDAOVslDepRptErrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VesselReportDBDAOVslDepRptErrRSQL(){
		setQuery();
		...
		query.append("FileName : VesselReportDBDAOVslDepRptErrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                    , TO_CHAR(F.RUP_DT, 'YYYY-MM-DD HH24:MI:SS') AS RUP_DT" ).append("\n"); 
		query.append("                    , TO_CHAR(F.SB_ENG_DT, 'YYYY-MM-DD HH24:MI:SS') AS SB_ENG_DT" ).append("\n"); 
		...
		query.append("            AND     F.DEP_RPT_ERR_TP_CD = C.INTG_CD_VAL_CTNT" ).append("\n"); 
		query.append("            AND     C.INTG_CD_ID = 'CD03523'" ).append("\n"); 
