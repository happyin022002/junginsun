...
*@FileName : VOP_SCG_0084HTMLAction.java
...
public class VOP_SCG_0084HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_AOM_0083HTMLAction 객체를 생성
	 */
	public VOP_SCG_0084HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0084Event event = new VopScg0084Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgChemicalHistoryVOS((ScgChemicalHistoryVO[])getVOs(request, ScgChemicalHistoryVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgChemicalHistoryVO((ScgChemicalHistoryVO)getVO(request, ScgChemicalHistoryVO .class));
		}
