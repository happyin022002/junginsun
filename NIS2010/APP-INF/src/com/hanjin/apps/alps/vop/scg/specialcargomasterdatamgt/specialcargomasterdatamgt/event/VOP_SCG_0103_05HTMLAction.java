...
public class VOP_SCG_0103_05HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0031HTMLAction 객체를 생성
	 */
	public VOP_SCG_0103_05HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopScg010305Event event = new VopScg010305Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgSpclPckProviVOS((ScgSpclPckProviVO[])getVOs(request, ScgSpclPckProviVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgSpclPckProviVO((ScgSpclPckProviVO)getVO(request, ScgSpclPckProviVO .class));
		}
