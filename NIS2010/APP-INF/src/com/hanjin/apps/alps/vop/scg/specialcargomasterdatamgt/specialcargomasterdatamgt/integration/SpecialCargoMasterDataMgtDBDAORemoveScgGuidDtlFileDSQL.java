...
*@FileName : SpecialCargoMasterDataMgtDBDAORemoveScgGuidDtlFileDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAORemoveScgGuidDtlFileDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveScgGuidDtlFile
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAORemoveScgGuidDtlFileDSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAORemoveScgGuidDtlFileDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_GUID_DTL_FILE" ).append("\n"); 
