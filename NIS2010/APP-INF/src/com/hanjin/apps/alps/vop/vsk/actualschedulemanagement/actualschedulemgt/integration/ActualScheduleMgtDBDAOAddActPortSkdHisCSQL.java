...
public class ActualScheduleMgtDBDAOAddActPortSkdHisCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        FROM    VSK_ACT_PORT_SKD_HIS" ).append("\n"); 
		...
		query.append(",	@[upd_usr_id]" ).append("\n"); 
		query.append(",	SYSDATE" ).append("\n"); 
		query.append(",	TO_DATE(@[act_ata_inp_dt], 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append(",	@[act_ata_inp_usr_id]" ).append("\n"); 
		query.append(",	TO_DATE(@[act_atb_inp_dt], 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append(",	@[act_atb_inp_usr_id]" ).append("\n"); 
		query.append(",	TO_DATE(@[act_atd_inp_dt], 'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append(",	@[act_atd_inp_usr_id]" ).append("\n"); 
		query.append(")" ).append("\n"); 
