...
*@FileName : EstimationReportDBDAOsearchMonEstmRawDataListByVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EstimationReportDBDAOsearchMonEstmRawDataListByVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EstimationReportDBDAOsearchMonEstmRawDataListByVvdRSQL(){
		setQuery();
		...
		query.append("FileName : EstimationReportDBDAOsearchMonEstmRawDataListByVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("GROUP BY T1.REV_YRMON, T2.RLANE_CD, T1.VSL_CD, T1.SKD_VOY_NO, T1.SKD_DIR_CD" ).append("\n"); 
		query.append("ORDER BY T1.REV_YRMON, T2.RLANE_CD, T1.VSL_CD, T1.SKD_VOY_NO, T1.SKD_DIR_CD" ).append("\n"); 
