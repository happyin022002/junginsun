...
*@FileName : BalDiffAcctMstVO.java
*@FileTitle : BalDiffAcctMstVO
*Open Issues :
*Change history :
...
public class BalDiffAcctMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BalDiffAcctMstVO> models = new ArrayList<BalDiffAcctMstVO>();
	...
	public BalDiffAcctMstVO() {}

	public BalDiffAcctMstVO(String ibflag, String pagerows, String dt, String amt, String description) {
		this.dt = dt;
		this.amt = amt;
		this.ibflag = ibflag;
	 ...
	 */
	public BalDiffAcctMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BalDiffAcctMstVO[]
	 */
	public BalDiffAcctMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BalDiffAcctMstVO model = null;
	...
	public BalDiffAcctMstVO[] getBalDiffAcctMstVOs(){
		BalDiffAcctMstVO[] vos = (BalDiffAcctMstVO[])models.toArray(new BalDiffAcctMstVO[models.size()]);
		return vos;
	}
