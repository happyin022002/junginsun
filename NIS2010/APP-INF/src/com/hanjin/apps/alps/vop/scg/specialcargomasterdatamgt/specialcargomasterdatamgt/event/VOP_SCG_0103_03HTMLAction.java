...
public class VOP_SCG_0103_03HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0031HTMLAction 객체를 생성
	 */
	public VOP_SCG_0103_03HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopScg010303Event event = new VopScg010303Event();
		
    	if(command.isCommand(FormCommand.MULTI)) {
			event.setScgPckPkgVOS((ScgPckPkgVO[])getVOs(request, ScgPckPkgVO .class,""));
