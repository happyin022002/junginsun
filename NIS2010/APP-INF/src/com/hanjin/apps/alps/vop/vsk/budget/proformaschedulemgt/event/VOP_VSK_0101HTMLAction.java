...
*@FileName : VOP_VSK_0101HTMLAction.java
 ...
 * @author Maria Chin
 * @see VopVsk0101Event 참조
 * @since J2EE 1.4
 */

public class VOP_VSK_0101HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0101HTMLAction 객체를 생성
	 */
	public VOP_VSK_0101HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0101Event event = new VopVsk0101Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			String checkVslSkd = request.getParameter("check_vsl_skd");
			String vslSvcTpCd = request.getParameter("vsl_svc_tp_cd");
			...
			vskPfSkdDtlVO.setCheckVslSkd(checkVslSkd);
			vskPfSkdDtlVO.setVslSvcTpCd(vslSvcTpCd);
			vskPfSkdDtlVOs.set(0, vskPfSkdDtlVO);
