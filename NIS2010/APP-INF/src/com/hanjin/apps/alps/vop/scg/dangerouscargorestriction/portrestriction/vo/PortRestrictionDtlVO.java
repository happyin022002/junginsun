...
*@FileName : PortRestrictionDtlVO.java
*@FileTitle : PortRestrictionDtlVO
*Open Issues :
*Change history :
...
public class PortRestrictionDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PortRestrictionDtlVO> models = new ArrayList<PortRestrictionDtlVO>();
	 ...
	 * @param request
	 * @return PortRestrictionDtlVO[]
	 */
	public PortRestrictionDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PortRestrictionDtlVO[]
	 */
	public PortRestrictionDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PortRestrictionDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PortRestrictionDtlVO();
		...
		return getPortRestrictionDtlVOs();
	}
	 ...
	 * @return PortRestrictionDtlVO[]
	 */
	public PortRestrictionDtlVO[] getPortRestrictionDtlVOs(){
		PortRestrictionDtlVO[] vos = (PortRestrictionDtlVO[])models.toArray(new PortRestrictionDtlVO[models.size()]);
		return vos;
	}
