...
*@FileName : VOP_FCM_0013HTMLAction.java
*@FileTitle : Fuel Consumption Trendline Inquiry
*Open Issues :
*Change history :
...
public class VOP_FCM_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0013HTMLAction 객체를 생성
	 */
	public VOP_FCM_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0013Event event = new VopFcm0013Event();
