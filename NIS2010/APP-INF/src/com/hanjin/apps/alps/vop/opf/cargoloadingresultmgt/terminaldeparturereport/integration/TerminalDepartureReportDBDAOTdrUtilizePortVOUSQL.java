...
*@FileName : TerminalDepartureReportDBDAOTdrUtilizePortVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTdrUtilizePortVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTdrUtilizePortVOUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOTdrUtilizePortVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND		POD             =	@[pod]       " ).append("\n"); 
		query.append("AND		CNTR_TYPE       =	@[cntr_type] " ).append("\n"); 
		query.append("AND		CNTR_SIZE       =	@[cntr_size] " ).append("\n"); 
