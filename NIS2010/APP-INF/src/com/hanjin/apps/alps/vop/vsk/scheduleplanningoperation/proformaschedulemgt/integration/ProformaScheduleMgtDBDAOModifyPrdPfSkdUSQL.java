...
*@FileName : ProformaScheduleMgtDBDAOModifyPrdPfSkdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProformaScheduleMgtDBDAOModifyPrdPfSkdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProformaScheduleMgtDBDAOModifyPrdPfSkdUSQL(){
		setQuery();
		...
		query.append("FileName : ProformaScheduleMgtDBDAOModifyPrdPfSkdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
