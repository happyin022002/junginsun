...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSpeicalSummaryDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSpeicalSummaryDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSpeicalSummaryDSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerDelCgoSpeicalSummaryDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
