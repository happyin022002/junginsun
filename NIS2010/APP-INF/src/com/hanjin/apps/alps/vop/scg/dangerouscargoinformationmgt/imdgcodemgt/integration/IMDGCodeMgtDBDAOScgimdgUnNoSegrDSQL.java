...
*@FileName : IMDGCodeMgtDBDAOScgimdgUnNoSegrDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgimdgUnNoSegrDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgimdgUnNoSegrDSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IMDG_UN_NO_SEGR" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgimdgUnNoSegrDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}