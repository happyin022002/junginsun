...
*@FileName : LaneInformationMgtDBDAOStatusHJSVesselVSLNameVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneInformationMgtDBDAOStatusHJSVesselVSLNameVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneInformationMgtDBDAOStatusHJSVesselVSLNameVORSQL(){
		setQuery();
		...
		query.append("FileName : LaneInformationMgtDBDAOStatusHJSVesselVSLNameVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
