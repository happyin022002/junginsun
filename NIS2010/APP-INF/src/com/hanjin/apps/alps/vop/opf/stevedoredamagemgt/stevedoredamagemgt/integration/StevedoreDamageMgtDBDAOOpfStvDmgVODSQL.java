...
*@FileName : StevedoreDamageMgtDBDAOOpfStvDmgVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOOpfStvDmgVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOOpfStvDmgVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM OPF_STV_DMG" ).append("\n"); 
		...
		query.append("FileName : StevedoreDamageMgtDBDAOOpfStvDmgVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}