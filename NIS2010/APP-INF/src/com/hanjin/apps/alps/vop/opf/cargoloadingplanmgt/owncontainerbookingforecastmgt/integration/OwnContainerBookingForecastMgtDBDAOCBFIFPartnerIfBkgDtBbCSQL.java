...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtBbCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtBbCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PARTNER CLL의 BB 데이터 수신
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtBbCSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtBbCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       AND Y.BB_CGO_FLG   = 'Y'   " ).append("\n"); 
