...
*@FileName : ScgGuidanceVO.java
*@FileTitle : ScgGuidanceVO
*Open Issues :
*Change history :
...
public class ScgGuidanceVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgGuidanceVO> models = new ArrayList<ScgGuidanceVO>();
	...
	/* Column Info */
	private String msgHdrCtnt = null;
	/* Column Info */
	...
	public ScgGuidanceVO() {}

	public ScgGuidanceVO(String ibflag, String pagerows, String hdrCtnt, String spclCgoGuidCd, String spclCgoGuidSeq, String ftrCtnt, String creUsrId, String creDt, String updUsrId, String updDt, String scgFlg, String iudFlg, String msgHdrCtnt, String spclCgoGuidAtchFileSeq, String fileNm, String fileSavId, String subjectCd, String subject) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("subject_cd", getSubjectCd());
		...
		this.hashColumns.put("msg_hdr_ctnt", getMsgHdrCtnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("subject_cd", "subjectCd");
		...
		this.hashFields.put("msg_hdr_ctnt", "msgHdrCtnt");
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSubjectCd(JSPUtil.getParameter(request, prefix + "subject_cd", ""));
		...
		setMsgHdrCtnt(JSPUtil.getParameter(request, prefix + "msg_hdr_ctnt", ""));
	 ...
	 */
	public ScgGuidanceVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgGuidanceVO[]
	 */
	public ScgGuidanceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgGuidanceVO model = null;
		...
		try {
			...
			String[] subjectCd = (JSPUtil.getParameter(request, prefix	+ "subject_cd", length));
			...
			String[] msgHdrCtnt = (JSPUtil.getParameter(request, prefix	+ "msg_hdr_ctnt", length));
			String[] fileNm = (JSPUtil.getParameter(request, prefix	+ "file_nm", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			
			for (int i = 0; i < length; i++) {
				model = new ScgGuidanceVO();
				if (updDt[i] != null)
					model.setUpdDt(updDt[i]);
				if (fileSavId[i] != null)
					model.setFileSavId(fileSavId[i]);
				if (subjectCd[i] != null)
					model.setSubjectCd(subjectCd[i]);
				if (ftrCtnt[i] != null)
				...
				if (msgHdrCtnt[i] != null)
					model.setMsgHdrCtnt(msgHdrCtnt[i]);
				if (fileNm[i] != null)
	...
	public ScgGuidanceVO[] getScgGuidanceVOs(){
		ScgGuidanceVO[] vos = (ScgGuidanceVO[])models.toArray(new ScgGuidanceVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.subjectCd = this.subjectCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.msgHdrCtnt = this.msgHdrCtnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
