...
public class ProformaScheduleMgtDBDAOPfSkdVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            ,NVL(T3.VSL_SLAN_NM,'XXXX')    AS VSL_SLAN_NM" ).append("\n"); 
		query.append("            ,NVL(T3.VSL_SVC_TP_CD,'X') AS VSL_SVC_TP_CD" ).append("\n"); 
		query.append("			,NVL(T3.FDR_DIV_CD,'X') AS FDR_DIV_CD" ).append("\n"); 
		...
		query.append("				FROM VSK_BUD_VSL_SKD S" ).append("\n"); 
		...
		query.append("    FROM VSK_BUD_PF_SKD T1, VSK_BUD_PF_SKD_DTL T2, MDM_VSL_SVC_LANE T3," ).append("\n"); 
		query.append("		(" ).append("\n"); 
