...
public class CanalTzFeeInvDtlVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAtchFileNo(JSPUtil.getParameter(request, "atch_file_no", ""));
		setInvAtchFileNo(JSPUtil.getParameter(request, "inv_atch_file_no", ""));
	}
