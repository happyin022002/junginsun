...
*@FileName : VOP_OPF_0049HTMLAction.java
...
public class VOP_OPF_0049HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0049HTMLAction 객체를 생성
	 */
	public VOP_OPF_0049HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0049Event event = new VopOpf0049Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setOpfStvDmgCdVOS((OpfStvDmgCdVO[])getVOs(request, OpfStvDmgCdVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setOpfStvDmgCdVO((OpfStvDmgCdVO)getVO(request, OpfStvDmgCdVO .class));
		}
