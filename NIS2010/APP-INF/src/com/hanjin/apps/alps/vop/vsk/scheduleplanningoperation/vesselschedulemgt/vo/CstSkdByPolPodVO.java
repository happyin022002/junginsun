...
* 
* History
* 2011.07.04 진마리아 [CHM-201112011-01] VSL SKD Inquiry by Port to Port 로직 수정-INCLUDE VIRTUAL POL 추가 
...
public class CstSkdByPolPodVO extends AbstractValueObject {
	...
	/* Column Info */
	private String incVirPol = null;
	/* Column Info */
	private String polYardNm = null;
	/* Column Info */
	private String podYardNm = null;
	...
	public CstSkdByPolPodVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String vvd, String vslSlanCd, String polPort, String polYard, String polTmlCd, String polEta, String polEtb, String polEtd, String podPort, String podYard, String podTmlCd, String podEta, String podEtb, String podEtd, String delayDate, String carrierCd, String fmDt, String toDt, String incVirPol, String polYardNm, String podYardNm) {
		...
		this.polEtb = polEtb;
		this.incVirPol = incVirPol;
		this.polYardNm = polYardNm;
		this.podYardNm = podYardNm;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inc_vir_pol", getIncVirPol());
		this.hashColumns.put("pol_yard_nm", getPolYardNm());
		this.hashColumns.put("pod_yard_nm", getPodYardNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inc_vir_pol", "incVirPol");
		this.hashFields.put("pol_yard_nm", "polYardNm");
		this.hashFields.put("pod_yard_nm", "podYardNm");
	 ...
	 * @return incVirPol
	 */
	public String getIncVirPol() {
		return this.incVirPol;
	}
	 ...
	 * @return podYardNm
	 */
	public String getPodYardNm() {
		return this.podYardNm;
	}
	 ...
	 * @param incVirPol
	 */
	public void setIncVirPol(String incVirPol) {
		this.incVirPol = incVirPol;
	}
	 ...
	 * @param podYardNm
	 */
	public void setPodYardNm(String podYardNm) {
		this.podYardNm = podYardNm;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIncVirPol(JSPUtil.getParameter(request, "inc_vir_pol", ""));
		setPolYardNm(JSPUtil.getParameter(request, "pol_yard_nm", ""));
		setPodYardNm(JSPUtil.getParameter(request, "pod_yard_nm", ""));
	}
	...
	public CstSkdByPolPodVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] incVirPol = (JSPUtil.getParameter(request, prefix	+ "inc_vir_pol".trim(), length));
			String[] polYardNm = (JSPUtil.getParameter(request, prefix	+ "pol_yard_nm".trim(), length));
			String[] podYardNm = (JSPUtil.getParameter(request, prefix	+ "pod_yard_nm".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (incVirPol[i] != null)
					model.setIncVirPol(incVirPol[i]);
				if (polYardNm[i] != null)
					model.setPolYardNm(polYardNm[i]);
				if (podYardNm[i] != null)
					model.setPodYardNm(podYardNm[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.incVirPol = this.incVirPol .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.polYardNm = this.polYardNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podYardNm = this.podYardNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
