...
*@FileName : VOP_VSK_0248HTMLAction.java
...
public class VOP_VSK_0248HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0248HTMLAction 객체를 생성
	 */
	public VOP_VSK_0248HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0248Event event = new VopVsk0248Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVskPfSkdHisVO((VskPfSkdHisVO)getVO(request, VskPfSkdHisVO .class));
		}
