...
*@FileName : VOP_FCM_0041HTMLAction.java
...
public class VOP_FCM_0041HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0041HTMLAction 객체를 생성
	 */
	public VOP_FCM_0041HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0041Event event = new VopFcm0041Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMonEstmCsmVO((MonEstmCsmVO)getVO(request, MonEstmCsmVO.class));
		}else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setMonEstmCsmVOs((MonEstmCsmVO[])getVOs(request, MonEstmCsmVO.class));
