...
*@FileName : IMDGCodeMgtDBDAOScgImdgExptQtyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgExptQtyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgExptQtyRSQL(){
		setQuery();
...
//		query.append("WHERE	IMDG_EXPT_QTY_CD = @[imdg_expt_qty_cd]" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgExptQtyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}