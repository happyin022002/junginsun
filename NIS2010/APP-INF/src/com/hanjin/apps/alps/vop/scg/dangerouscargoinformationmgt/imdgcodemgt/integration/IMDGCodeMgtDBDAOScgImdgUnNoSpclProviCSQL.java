...
*@FileName : IMDGCodeMgtDBDAOScgImdgUnNoSpclProviCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgUnNoSpclProviCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ScgImdgUnNoSpclProvi 입력
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgUnNoSpclProviCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_UN_NO_SPCL_PROVI (" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgUnNoSpclProviCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}