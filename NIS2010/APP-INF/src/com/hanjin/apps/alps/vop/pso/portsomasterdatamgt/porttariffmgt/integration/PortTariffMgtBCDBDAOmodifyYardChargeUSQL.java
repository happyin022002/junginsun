...
*@FileName : PortTariffMgtBCDBDAOmodifyYardChargeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAOmodifyYardChargeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortTariffMgtBCDBDAOmodifyYardChargeUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append(",	CPLS_FLG = @[cpls_flg]" ).append("\n"); 
		...
		query.append("FileName : PortTariffMgtBCDBDAOmodifyYardChargeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}