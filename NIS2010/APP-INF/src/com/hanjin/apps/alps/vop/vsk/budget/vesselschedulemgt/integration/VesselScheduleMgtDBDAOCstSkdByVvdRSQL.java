...
public class VesselScheduleMgtDBDAOCstSkdByVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			FROM	(" ).append("\n"); 
		query.append("					SELECT 	NVL(T3.VSL_SLAN_CD	, T3.VSL_SLAN_CD	) AS VSL_SLAN_CD," ).append("\n"); 
		query.append("							NVL(T3.PF_SVC_TP_CD	, T3.PF_SVC_TP_CD	) AS PF_SVC_TP_CD," ).append("\n"); 
		query.append("							NVL(T3.PORT_CD		, T3.PORT_CD		) AS PORT_CD," ).append("\n"); 
		...
		query.append("									AND		T3.VSL_SLAN_CD	= S.VSL_SLAN_CD" ).append("\n"); 
		query.append("									AND		T3.SKD_DIR_CD	!= S.VSL_SLAN_DIR_CD" ).append("\n"); 
		...
		query.append("								(SELECT	T3.CLPT_SEQ" ).append("\n"); 
		query.append("									FROM	VSK_BUD_PF_SKD_DTL M" ).append("\n"); 
		query.append("									WHERE	1 = 1" ).append("\n"); 
		query.append("									AND		T3.VSL_SLAN_CD	= M.VSL_SLAN_CD" ).append("\n"); 
		query.append("									AND		T3.PF_SVC_TP_CD	= M.PF_SVC_TP_CD" ).append("\n"); 
		query.append("									AND		T3.SKD_DIR_CD	= " ).append("\n"); 
		query.append("								(" ).append("\n"); 
		query.append("									SELECT	S.VSL_SLAN_DIR_CD" ).append("\n"); 
		query.append("									FROM	MDM_VSL_SVC_LANE_DIR S" ).append("\n"); 
		query.append("									WHERE	1 = 1" ).append("\n"); 
		...
		query.append("									AND		S.DELT_FLG		= 'N'" ).append("\n"); 
		query.append("								)" ).append("\n"); 
		query.append("								AND		T3.PORT_CD		= M.PORT_CD" ).append("\n"); 
		query.append("								AND		T3.CLPT_SEQ		= M.CLPT_SEQ" ).append("\n"); 
		query.append("								AND     M.TURN_PORT_IND_CD != 'F'" ).append("\n"); 
		query.append("								), T3.CLPT_SEQ) AS CLPT_SEQ," ).append("\n"); 
		query.append("							DECODE(T3.SKD_DIR_CD, NULL, 'V', 'N') AS VIRT_FLG," ).append("\n"); 
		query.append("							T3.SKD_DIR_CD AS DIR_CD2" ).append("\n"); 
		query.append("					FROM  	MDM_VSL_SVC_LANE_DIR T2, VSK_BUD_PF_SKD_DTL T3" ).append("\n"); 
		query.append("					WHERE  	1	= 1" ).append("\n"); 
		query.append("					AND		T3.VSL_SLAN_CD	= T2.VSL_SLAN_CD" ).append("\n"); 
		query.append("					AND		T3.SKD_DIR_CD	= T2.VSL_SLAN_DIR_CD" ).append("\n"); 
		query.append("					AND     T3.TURN_PORT_IND_CD != 'F'" ).append("\n"); 
		query.append("					) T1, VSK_BUD_PF_SKD_DTL T2" ).append("\n"); 
		query.append("			WHERE 1 = 1" ).append("\n"); 
		...
		query.append("--   AND T1.SKD_DIR_CD    = T2.SKD_DIR_CD     (+)" ).append("\n"); 
		query.append("   AND DECODE(T1.TURN_PORT_IND_CD, 'Y', T1.SKD_DIR_CD, 'N', T1.SKD_DIR_CD, T1.TURN_SKD_DIR_CD)    = T2.SKD_DIR_CD     (+)" ).append("\n"); 
