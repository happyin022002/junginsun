...
*@FileName : VSK_GLO_HTMLAction.java
...
public class VSK_GLO_HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VSK_GLO_HTMLAction 객체를 생성
	 */
	public VSK_GLO_HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VskGloEvent event = new VskGloEvent();
...
//		}
		...
		//::0203::Lane Code POPUP(New) for BUDGET:://
   		else if (command.isCommand(FormCommand.COMMAND23)) {
			event.setVslSvcLaneforBudgetVO((VslSvcLaneforBudgetVO)getVO(request, VslSvcLaneforBudgetVO.class));
   		}
