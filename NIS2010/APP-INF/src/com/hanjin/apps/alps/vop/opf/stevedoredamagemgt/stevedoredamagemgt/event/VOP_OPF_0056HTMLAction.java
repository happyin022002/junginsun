...
*@FileName : VOP_OPF_0056HTMLAction.java
...
public class VOP_OPF_0056HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0056HTMLAction 객체를 생성
	 */
	public VOP_OPF_0056HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0056Event event = new VopOpf0056Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSdmsReportVO((SdmsReportVO)getVO(request, SdmsReportVO .class));
		}
