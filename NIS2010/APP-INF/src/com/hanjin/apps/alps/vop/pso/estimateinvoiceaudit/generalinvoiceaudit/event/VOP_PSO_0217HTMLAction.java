...
*@FileName : VOP_PSO_0216HTMLAction.java
...
public class VOP_PSO_0217HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0216HTMLAction 객체를 생성
	 */
	public VOP_PSO_0217HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0217Event event = new VopPso0217Event();
      
		if(command.isCommand(FormCommand.SEARCH01)){	
			event.setVvd(request.getParameter("vvd"));
			event.setYdCd(request.getParameter("yd_cd"));
			event.setIo(request.getParameter("io"));
			event.setYdChgNo(request.getParameter("yd_chg_no"));
			event.setYdChgVerSeq(request.getParameter("yd_chg_ver_seq"));
		}
