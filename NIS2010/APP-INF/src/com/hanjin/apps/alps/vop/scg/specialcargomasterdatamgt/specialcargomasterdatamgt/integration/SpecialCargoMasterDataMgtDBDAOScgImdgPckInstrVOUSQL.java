...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckInstrVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgImdgPckInstrVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Packing Instructions/Provisions (Creation)  수정   
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgImdgPckInstrVOUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckInstrVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_IMDG_PCK_INSTR SET " ).append("\n"); 
		query.append("	IMDG_PCK_INSTR_CD = @[imdg_pck_instr_cd]" ).append("\n"); 
