...
*@FileName : OwnContainerBookingForecastMgtDBDAOsearchCBFSpecialStwgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOsearchCBFSpecialStwgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOsearchCBFSpecialStwgRSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOsearchCBFSpecialStwgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_1],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST1_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_2],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST2_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_3],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST3_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_4],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST4_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_5],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST5_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_6],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST6_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_7],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST7_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_8],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST8_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_9],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST9_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_10],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST10_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_11],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST11_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_12],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST12_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_13],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST13_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_14],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST14_4H," ).append("\n"); 
		...
		query.append("                                     SUM(DECODE(STWG_CD,@[st_15],DECODE(SUBSTR(CNTR_TPSZ_CD,2,1),'5',1,CASE WHEN CNTR_TPSZ_CD IN ('R8', 'R9') THEN 1 ELSE 0 END),0)) ST15_4H," ).append("\n"); 
