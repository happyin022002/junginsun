...
*@FileName : RegionDepartureReportDBDAORemoveRdrBsaDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORemoveRdrBsaDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * HC45삭제시, RDR_BSA를 삭제한다.
	  * </pre>
	  */
	public RegionDepartureReportDBDAORemoveRdrBsaDSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORemoveRdrBsaDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
