...
*@FileName : VOP_OPF_2025HTMLAction.java
...
public class VOP_OPF_2025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_2025HTMLAction 객체를 생성
	 */
	public VOP_OPF_2025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopOpf2025Event event = new VopOpf2025Event();
		
   
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setCBFWgtGroupSummaryVO((CBFWgtGroupSummaryVO)getVO(request, CBFWgtGroupSummaryVO .class));
		}
			...
			event.setCBFWgtGroupSummaryVOS((CBFWgtGroupSummaryVO[])getVOs(request, CBFWgtGroupSummaryVO .class,""));
		}
