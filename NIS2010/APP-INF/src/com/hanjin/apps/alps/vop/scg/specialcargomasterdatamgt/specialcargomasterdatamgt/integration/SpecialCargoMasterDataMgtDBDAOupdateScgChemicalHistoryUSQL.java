...
*@FileName : SpecialCargoMasterDataMgtDBDAOupdateScgChemicalHistoryUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOupdateScgChemicalHistoryUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Chemical history를 update하기 위함.
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOupdateScgChemicalHistoryUSQL(){
		setQuery();
		...
		params.put("re_msg_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("re_msg_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOupdateScgChemicalHistoryUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_CHEM_HIS SET" ).append("\n"); 
		query.append("       chem_nm          = @[chem_nm]" ).append("\n"); 
		query.append("      ,chem_abst_svc_no = @[chem_abst_svc_no1]||@[chem_abst_svc_no2]||@[chem_abst_svc_no3]" ).append("\n"); 
		query.append("      ,spcl_cgo_flg     = @[spcl_cgo_flg]" ).append("\n"); 
		query.append("      ,co_nm            = @[co_nm]" ).append("\n"); 
		query.append("      ,chem_opin_knd_cd = @[chem_opin_knd_cd]" ).append("\n"); 
		...
		query.append("      ,rqst_id            = @[rqst_id]" ).append("\n"); 
		query.append("      ,rqst_dt            = @[rqst_dt]" ).append("\n"); 
		query.append("      ,re_msg_id          = @[re_msg_id]" ).append("\n"); 
		query.append("      ,re_msg_dt          = @[re_msg_dt]" ).append("\n"); 
