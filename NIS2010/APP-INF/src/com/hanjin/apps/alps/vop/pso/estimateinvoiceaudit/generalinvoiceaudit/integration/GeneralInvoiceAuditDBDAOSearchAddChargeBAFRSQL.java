...
*@FileName : GeneralInvoiceAuditDBDAOSearchAddChargeBAFRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOSearchAddChargeBAFRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BAF OBJECT를 사용하는 계정인지 아닌지를 체크하는 FLAG
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOSearchAddChargeBAFRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOSearchAddChargeBAFRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                    AND C.OBJ_LIST_NO        = '176' " ).append("\n"); 
