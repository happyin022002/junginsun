...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFSummaryIfBkgDtMtyCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFSummaryIfBkgDtMtyCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OwnContainerBookingForecastMgtDBDAOCBFIFSummaryIfBkgDtMty
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFSummaryIfBkgDtMtyCSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFSummaryIfBkgDtMtyCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        , @[upd_usr_id]" ).append("\n"); 
		query.append("        , SYSDATE" ).append("\n"); 
		query.append("        , DECODE(BKG_CGO_TP_CD,'R','Y',NULL)" ).append("\n"); 
		query.append("   FROM (" ).append("\n"); 
		query.append("SELECT Z.POD_CD, Z.MLB, Z.CNTR_TPSZ_CD, Z.CNTR_QTY, Z.CBF_SPCL_SMRY_SEQ, Z.BKG_CGO_TP_CD" ).append("\n"); 
		query.append(" FROM ( " ).append("\n"); 
		query.append("    SELECT X.POD_CD, X.MLB, X.CNTR_TPSZ_CD,  ALL_QTY - NVL(BN_QTY,0) CNTR_QTY, X.BKG_CGO_TP_CD," ).append("\n"); 
		...
		query.append("    FROM (" ).append("\n"); 
		query.append("          SELECT VVD.POD_CD, QTY.CNTR_TPSZ_CD , SUM(OP_CNTR_QTY) ALL_QTY , BKG.BKG_CGO_TP_CD," ).append("\n"); 
		...
		query.append("             AND ( BKG.BKG_CGO_TP_CD                  = 'P' OR ( BKG.BKG_CGO_TP_CD = 'R' AND BKG.DCGO_FLG = 'N'))" ).append("\n"); 
		query.append("             AND QTY.CNTR_TPSZ_CD                    NOT LIKE 'Q%'" ).append("\n"); 
		query.append("             AND SUBSTR(QTY.CNTR_TPSZ_CD,2,1)        = MCZ.CNTR_SZ_CD" ).append("\n"); 
		query.append("         GROUP BY VVD.POD_CD, QTY.CNTR_TPSZ_CD,  BKG.BKG_CGO_TP_CD, " ).append("\n"); 
		...
		query.append("          AND ((BC.BDL_BTM_FLG ='Y')  OR ( BC.BDL_BTM_FLG ='N' AND MCNTR_BDL_NO IS NOT NULL))" ).append("\n"); 
		...
		query.append("          WHERE Z.CNTR_QTY <> 0   )" ).append("\n"); 
