...
public class PortRestrictionDBDAOSearchDgSummaryByPortUnnoSeqRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND   EXISTS (SELECT 'Y' FROM SCG_IMDG_PORT_RSTR S1" ).append("\n"); 
		query.append("WHERE     S1.PORT_CD    = 'KRPUS'" ).append("\n"); 
		query.append("AND     S1.IMDG_UN_NO = AA.IMDG_UN_NO AND ROWNUM=1)" ).append("\n"); 
		query.append("ORDER BY    AA.IMDG_UN_NO, AA.IMDG_UN_NO_SEQ,AA.IMDG_CLSS_CD" ).append("\n"); 
