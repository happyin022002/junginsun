...
public class VopVsk0229Event extends EventSupport {
	...
	public BkgListByVvdVO[] getBkgListByVvdVOS() {
		...
		if(this.bkgListByVvdVOs != null){
			rtnVOs = new BkgListByVvdVO[bkgListByVvdVOs.length];
			System.arraycopy(bkgListByVvdVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
		//소스보안 2015.08
		//return bkgListByVvdVOs;
	}
	...
	public void setBkgListByVvdVOS(BkgListByVvdVO[] bkgListByVvdVOs) {
		if(bkgListByVvdVOs != null){
			BkgListByVvdVO[] tmpVOs = new BkgListByVvdVO[bkgListByVvdVOs.length];
			System.arraycopy(bkgListByVvdVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.bkgListByVvdVOs = tmpVOs;
		}
		//소스보안 2015.08
		//this.bkgListByVvdVOs = bkgListByVvdVOs;
	}
}