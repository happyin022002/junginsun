...
*@FileName : SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationImgListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationImgListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationImgListUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationImgListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_PCK_REGU_IMG" ).append("\n"); 
