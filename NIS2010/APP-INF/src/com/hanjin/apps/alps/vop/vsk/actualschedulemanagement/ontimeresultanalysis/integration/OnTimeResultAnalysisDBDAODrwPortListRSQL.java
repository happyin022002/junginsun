...
*@FileName : OnTimeResultAnalysisDBDAODrwPortListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnTimeResultAnalysisDBDAODrwPortListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Drewry Report를 관리할 Port List
	  * </pre>
	  */
	public OnTimeResultAnalysisDBDAODrwPortListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.vop.vsk.actualschedulemanagement.ontimeresultanalysis.integration").append("\n"); 
		query.append("FileName : OnTimeResultAnalysisDBDAODrwPortListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
