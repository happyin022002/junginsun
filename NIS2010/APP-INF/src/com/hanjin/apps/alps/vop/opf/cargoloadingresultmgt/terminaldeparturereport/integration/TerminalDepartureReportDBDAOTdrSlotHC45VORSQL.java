...
public class TerminalDepartureReportDBDAOTdrSlotHC45VORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DECODE(UPDATE_SYS, 'E', ROUND(HC_LD_40 / 2, 0) , HC_LD_40) AS HC_LD_40," ).append("\n"); 
		query.append("HC_BSA_40," ).append("\n"); 
		query.append("HC_OR_40," ).append("\n"); 
		query.append("HC_ADD_40," ).append("\n"); 
		query.append("DECODE(UPDATE_SYS, 'E', ROUND(HC_LD_45 / 2, 0) , HC_LD_45) AS HC_LD_45," ).append("\n"); 
		...
		query.append("NVL(H.UPDATE_SYS, 'E') AS UPDATE_SYS," ).append("\n"); 
		query.append("SUM(DECODE(C.STATUS, 'SM', DECODE(C.CNTR_TYPE, 'F', DECODE(C.CNTR_SIZE, '3', C.QTY, 0), 'E', DECODE(C.CNTR_SIZE, '3', C.QTY, 0), 0), 'SI', DECODE(C.CNTR_TYPE, 'F', DECODE(C.CNTR_SIZE, '3', C.QTY, 0), 'E', DECODE(C.CNTR_SIZE, '3', C.QTY, 0), 0), 0)) HC_LD_20," ).append("\n"); 
		query.append("HC20_QTY HC_BSA_20," ).append("\n"); 
		query.append("HC20_RAT HC_OR_20," ).append("\n"); 
		query.append("SUM(DECODE(C.STATUS, 'SM', DECODE(C.CNTR_TYPE, 'A', DECODE(C.CNTR_SIZE, '3', C.QTY, 0), 0), 'SI', DECODE(C.CNTR_TYPE, 'A', DECODE(C.CNTR_SIZE, '3', C.QTY, 0), 0))) HC_ADD_20," ).append("\n"); 
		query.append("SUM(DECODE(C.STATUS, 'SM', DECODE(C.CNTR_TYPE, 'F', DECODE(C.CNTR_SIZE, 'H', C.QTY, 0), 'E', DECODE(C.CNTR_SIZE, 'H', C.QTY, 0), 0), 'SI', DECODE(C.CNTR_TYPE, 'F', DECODE(C.CNTR_SIZE, 'H', C.QTY, 0), 'E', DECODE(C.CNTR_SIZE, 'H', C.QTY, 0), 0), 0)) HC_LD_40," ).append("\n"); 
		query.append("HC40_QTY HC_BSA_40," ).append("\n"); 
		query.append("HC40_RAT HC_OR_40," ).append("\n"); 
		query.append("SUM(DECODE(C.STATUS, 'SM', DECODE(C.CNTR_TYPE, 'A', DECODE(C.CNTR_SIZE, 'H', C.QTY, 0), 0), 'SI', DECODE(C.CNTR_TYPE, 'A', DECODE(C.CNTR_SIZE, 'H', C.QTY, 0), 0))) HC_ADD_40," ).append("\n"); 
		query.append("SUM(DECODE(C.STATUS, 'SM', DECODE(C.CNTR_TYPE, 'F', DECODE(C.CNTR_SIZE, 'L', C.QTY, 0), 'E', DECODE(C.CNTR_SIZE, 'L', C.QTY, 0), 0), 'SI', DECODE(C.CNTR_TYPE, 'F', DECODE(C.CNTR_SIZE, 'L', C.QTY, 0), 'E', DECODE(C.CNTR_SIZE, 'L', C.QTY, 0), 0), 0)) HC_LD_45," ).append("\n"); 
		query.append("QTY_45 HC_BSA_45," ).append("\n"); 
		query.append("UN_RAT_45 HC_UR_45," ).append("\n"); 
		query.append("OV_RAT_45 HC_OR_45," ).append("\n"); 
		query.append("SUM(DECODE(C.STATUS, 'SM', DECODE(C.CNTR_TYPE, 'A', DECODE(C.CNTR_SIZE, 'L', C.QTY, 0), 0), 'SI', DECODE(C.CNTR_TYPE, 'A', DECODE(C.CNTR_SIZE, 'L', C.QTY, 0), 0))) HC_ADD_45" ).append("\n"); 
		...
		query.append("GROUP BY B.OPR_CD, H.UPDATE_SYS, HC20_QTY, HC20_RAT, HC40_QTY, HC40_RAT, QTY_45, UN_RAT_45, OV_RAT_45" ).append("\n"); 
		...
		query.append("GROUP BY C.OPR_CD, H.UPDATE_SYS, HC20_QTY, HC20_RAT, HC40_QTY, HC40_RAT, QTY_45, UN_RAT_45, OV_RAT_45 )" ).append("\n"); 
