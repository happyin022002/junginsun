...
* 
* History
* 2015.08.11 이병훈 [CHM-201536635] Split11-2015년 소스 보안 품질 3단계 중 4차 작업 진행 요청
=========================================================*/
...
/**
 * VOP_VSK_0003 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  VOP_VSK_0003HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author SEO CHANG YUL
 * @see VOP_VSK_0003HTMLAction 참조
 * @since J2EE 1.4
 */

public class VopVsk0003Event extends EventSupport {
