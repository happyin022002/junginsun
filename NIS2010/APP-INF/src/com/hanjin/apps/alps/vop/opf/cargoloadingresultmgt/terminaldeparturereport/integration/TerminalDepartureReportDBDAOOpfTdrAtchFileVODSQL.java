...
*@FileName : TerminalDepartureReportDBDAOOpfTdrAtchFileVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOOpfTdrAtchFileVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TDR R/H 건별 File Attached 건을 삭제한다.
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOOpfTdrAtchFileVODSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOOpfTdrAtchFileVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  OPF_TDR_ATCH_FILE" ).append("\n"); 
