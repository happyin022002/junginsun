...
*@FileName : VOP_OPF_0046_03HTMLAction.java
...
public class VOP_OPF_0046_03HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0046_03HTMLAction 객체를 생성
	 */
	public VOP_OPF_0046_03HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf004603Event event = new VopOpf004603Event();
        ...
        if(command.isCommand(FormCommand.SEARCHLIST02)) {//Import Sub Allocation
            event.setRDRCrtListOptionVO( (RDRCrtListOptionVO)getVO(request, RDRCrtListOptionVO .class));
        }
