...
public class VopVsk0015Event extends EventSupport {
	...
	private VskVslSkdPhsIoHisVO vskVslSkdPhsIoHisVO = null;
	...
	private VskVslSkdPhsIoHisVO[] vskVslSkdPhsIoHisVOs = null;

	public VopVsk0015Event(){}
	...
	/**
	 * @return the vskVslSkdPhsIoHisVO
	 */
	public VskVslSkdPhsIoHisVO getVskVslSkdPhsIoHisVO() {
		return vskVslSkdPhsIoHisVO;
	}
	
	/**
	 * @param vskVslSkdPhsIoHisVO the vskVslSkdPhsIoHisVO to set
	 */
	public void setVskVslSkdPhsIoHisVO(
			VskVslSkdPhsIoHisVO vskVslSkdPhsIoHisVO) {
		this.vskVslSkdPhsIoHisVO = vskVslSkdPhsIoHisVO;
	}
	...
	/**
	 * @return the vskVslSkdPhsIoHisVOs
	 */
	public VskVslSkdPhsIoHisVO[] getVskVslSkdPhsIoHisVOs() {
		VskVslSkdPhsIoHisVO[] rtnVOs =  null;
		if(this.vskVslSkdPhsIoHisVOs != null){
			rtnVOs = new VskVslSkdPhsIoHisVO[vskVslSkdPhsIoHisVOs.length];
			System.arraycopy(vskVslSkdPhsIoHisVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	/**
	 * @param vskVslSkdPhsIoHisVOs the vskVslSkdPhsIoHisVOs to set
	 */
	public void setVskVslSkdPhsIoHisVOs(VskVslSkdPhsIoHisVO[] vskVslSkdPhsIoHisVOs) {
		if(vskVslSkdPhsIoHisVOs != null){
			VskVslSkdPhsIoHisVO[] tmpVOs = new VskVslSkdPhsIoHisVO[vskVslSkdPhsIoHisVOs.length];
			System.arraycopy(vskVslSkdPhsIoHisVOs, 0, tmpVOs, 0, tmpVOs.length);
			this.vskVslSkdPhsIoHisVOs = tmpVOs;
		}
	}
