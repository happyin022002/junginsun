...
*@FileName : VMS_SCG_0032HTMLAction.java
...
public class VOP_SCG_0032HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0032HTMLAction 객체를 생성
	 */
	public VOP_SCG_0032HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0032Event event = new VopScg0032Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgRgnShpOprCdVOS((ScgRgnShpOprCdVO[])getVOs(request, ScgRgnShpOprCdVO .class,""));
		}
