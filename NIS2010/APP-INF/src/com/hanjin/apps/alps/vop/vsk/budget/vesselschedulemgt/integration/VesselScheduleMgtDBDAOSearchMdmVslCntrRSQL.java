...
*@FileName : VesselScheduleMgtDBDAOSearchMdmVslCntrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOSearchMdmVslCntrRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM Vessel CNTR 정보를 조회합니다.
	  * 
	  * * History
	  * * 2011.02.22 진마리아 CHM-201108456-01 사업계획용 스케줄 정보 노출 대응을 위한 시스템 업데이트건
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOSearchMdmVslCntrRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOSearchMdmVslCntrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
