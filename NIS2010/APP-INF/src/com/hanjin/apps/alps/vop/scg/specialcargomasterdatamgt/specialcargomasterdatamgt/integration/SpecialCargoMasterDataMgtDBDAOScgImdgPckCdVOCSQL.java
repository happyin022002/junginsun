...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Packaging Code (Creation) 입력
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVOCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_PCK_CD (" ).append("\n"); 
