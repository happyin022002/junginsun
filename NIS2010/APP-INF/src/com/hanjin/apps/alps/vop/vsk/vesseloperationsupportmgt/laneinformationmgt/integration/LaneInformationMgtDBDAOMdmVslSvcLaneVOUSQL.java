...
*@FileName : LaneInformationMgtDBDAOMdmVslSvcLaneVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LaneInformationMgtDBDAOMdmVslSvcLaneVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LaneInformationMgtDBDAOMdmVslSvcLaneVOUSQL(){
		setQuery();
		...
		query.append("FileName : LaneInformationMgtDBDAOMdmVslSvcLaneVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("VSKD_FLET_GRP_CD = @[vskd_flet_grp_cd]" ).append("\n"); 
