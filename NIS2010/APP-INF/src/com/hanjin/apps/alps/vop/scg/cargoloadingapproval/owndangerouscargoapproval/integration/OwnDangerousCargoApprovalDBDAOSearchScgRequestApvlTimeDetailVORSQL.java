...
public class OwnDangerousCargoApprovalDBDAOSearchScgRequestApvlTimeDetailVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , TO_CHAR(S1.RQST_GDT, 'YYYY-MM-DD HH24:MI') RQST_DT" ).append("\n"); 
		query.append("     , S1.RQST_USR_ID     " ).append("\n"); 
		query.append("     , TO_CHAR(S1.AUTH_GDT, 'YYYY-MM-DD HH24:MI') AUTH_DT" ).append("\n"); 
		query.append("     , S1.AUTH_USR_ID" ).append("\n"); 
		query.append("     , S1.AUTH_FLG" ).append("\n"); 
		query.append("     , DECODE(S1.AUTH_FLG,'R','',CEIL((S1.AUTH_GDT-S1.RQST_GDT)*24)) TRET_GAP" ).append("\n"); 
		...
		query.append("           AND R2.AUTH_USR_ID     LIKE '%'||@[auth_usr_id]||'%'	-- USRID" ).append("\n"); 
		query.append("           #end" ).append("\n"); 
