...
*@FileName : VMS_SCG_0036HTMLAction.java
...
public class VOP_SCG_0036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0036HTMLAction 객체를 생성
	 */
	public VOP_SCG_0036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0036Event event = new VopScg0036Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchIrregularTypeCodeListVOS((SearchIrregularTypeCodeListVO[])getVOs(request, SearchIrregularTypeCodeListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchIrregularTypeCodeListVO((SearchIrregularTypeCodeListVO)getVO(request, SearchIrregularTypeCodeListVO .class));
		}
