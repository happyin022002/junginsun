...
*@FileName : CNTRInfoInputVO.java
*@FileTitle : CNTRInfoInputVO
*Open Issues :
*Change history :
...
public class CNTRInfoInputVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CNTRInfoInputVO> models = new ArrayList<CNTRInfoInputVO>();
	 ...
	 */
	public CNTRInfoInputVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CNTRInfoInputVO[]
	 */
	public CNTRInfoInputVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CNTRInfoInputVO model = null;
	 ...
	 * @return CNTRInfoInputVO[]
	 */
	public CNTRInfoInputVO[] getCNTRInfoInputVOs(){
		CNTRInfoInputVO[] vos = (CNTRInfoInputVO[])models.toArray(new CNTRInfoInputVO[models.size()]);
		return vos;
	}
