...
*@FileName : StatusHJSVesselVO.java
*@FileTitle : StatusHJSVesselVO
*Open Issues :
*Change history :
...
public class StatusHJSVesselVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<StatusHJSVesselVO> models = new ArrayList<StatusHJSVesselVO>();
	...
	public StatusHJSVesselVO() {}

	public StatusHJSVesselVO(String ibflag, String pagerows, String grp, String svcLane, String vslNm, String opt, String vslClass, String own, String cht, String oth, String ttl, String svcOpenDt, String portRot, String fre, String remark) {
		this.remark = remark;
	 ...
	 * @param request
	 * @return StatusHJSVesselVO[]
	 */
	public StatusHJSVesselVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StatusHJSVesselVO[]
	 */
	public StatusHJSVesselVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StatusHJSVesselVO model = null;
	 ...
	 * @return StatusHJSVesselVO[]
	 */
	public StatusHJSVesselVO[] getStatusHJSVesselVOs(){
		StatusHJSVesselVO[] vos = (StatusHJSVesselVO[])models.toArray(new StatusHJSVesselVO[models.size()]);
		return vos;
	}
