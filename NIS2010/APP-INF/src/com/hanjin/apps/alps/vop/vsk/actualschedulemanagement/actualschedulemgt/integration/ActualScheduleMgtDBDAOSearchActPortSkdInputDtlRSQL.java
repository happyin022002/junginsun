...
*@FileName : ActualScheduleMgtDBDAOSearchActPortSkdInputDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchActPortSkdInputDtlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchActPortSkdInputDtlRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchActPortSkdInputDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       ,RPT_ATA" ).append("\n"); 
		query.append("       ,ATA_OVER_DAYS" ).append("\n"); 
		query.append("       ,VPS_ETB_DT" ).append("\n"); 
		query.append("       ,ACT_BRTH_DT" ).append("\n"); 
		query.append("       ,RPT_ATB" ).append("\n"); 
		query.append("       ,ATB_OVER_DAYS" ).append("\n"); 
		query.append("       ,VPS_ETD_DT" ).append("\n"); 
		query.append("       ,ACT_DEP_DT" ).append("\n"); 
		query.append("       ,RPT_ATD" ).append("\n"); 
		query.append("       ,ATD_OVER_DAYS" ).append("\n"); 
		...
		query.append("                , TO_CHAR(ACT_ATA_INP_DT + ((T4.GMT_HRS - T5.GMT_HRS ) / 60 / 24 ), 'YYYYMMDDHH24MI')        AS RPT_ATA" ).append("\n"); 
		query.append("                , ROUND(T3.ACT_ATA_INP_DT + ((T4.GMT_HRS - T5.GMT_HRS ) / 60 / 24 ) " ).append("\n"); 
		query.append("                  - (T3.ACT_ARR_DT + DECODE('0', 0, 0, ('0' / 24))), 4)" ).append("\n"); 
		query.append("                  - (TO_NUMBER(NVL('24', '0')) / 24)                                                   AS ATA_OVER_DAYS" ).append("\n"); 
		...
		query.append("                , TO_CHAR(ACT_ATB_INP_DT + ((T4.GMT_HRS - T5.GMT_HRS ) / 60 / 24 ), 'YYYYMMDDHH24MI')        AS RPT_ATB" ).append("\n"); 
		query.append("                , ROUND(T3.ACT_ATB_INP_DT + ((T4.GMT_HRS - T5.GMT_HRS ) / 60 / 24 ) " ).append("\n"); 
		query.append("                  - (T3.ACT_BRTH_DT + DECODE('0', 0, 0, ('0' / 24))), 4)" ).append("\n"); 
		query.append("                  - (TO_NUMBER(NVL('24', '0')) / 24)                                                   AS ATB_OVER_DAYS" ).append("\n"); 
		...
		query.append("                , TO_CHAR(ACT_ATD_INP_DT  + ((T4.GMT_HRS - T5.GMT_HRS ) / 60 / 24 ), 'YYYYMMDDHH24MI')       AS RPT_ATD" ).append("\n"); 
		query.append("                , ROUND(T3.ACT_ATD_INP_DT + ((T4.GMT_HRS - T5.GMT_HRS ) / 60 / 24 )" ).append("\n"); 
		query.append("                  - (T3.ACT_DEP_DT + DECODE('0', 0, 0, ('0' / 24))), 4)" ).append("\n"); 
		query.append("                  - (TO_NUMBER(NVL('24', '0')) / 24)                                                   AS ATD_OVER_DAYS" ).append("\n"); 
