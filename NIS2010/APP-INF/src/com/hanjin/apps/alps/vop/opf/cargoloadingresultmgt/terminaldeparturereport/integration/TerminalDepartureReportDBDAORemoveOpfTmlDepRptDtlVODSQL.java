...
*@FileName : TerminalDepartureReportDBDAORemoveOpfTmlDepRptDtlVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAORemoveOpfTmlDepRptDtlVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAORemoveOpfTmlDepRptDtlVODSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAORemoveOpfTmlDepRptDtlVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND	CLPT_IND_SEQ = @[call_ind]" ).append("\n"); 
