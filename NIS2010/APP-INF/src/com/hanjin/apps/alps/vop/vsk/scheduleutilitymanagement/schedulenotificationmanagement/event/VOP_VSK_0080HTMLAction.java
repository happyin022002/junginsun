...
*@FileName : VOP_VSK_0080HTMLAction.java
...
public class VOP_VSK_0080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0290HTMLAction 객체를 생성
	 */
	public VOP_VSK_0080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0080Event event 	= new VopVsk0080Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVslSkdCngNotificationSetupVO((VslSkdCngNotificationSetupVO)getVO(request, VslSkdCngNotificationSetupVO.class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setVslSkdCngNotificationSetupVOs((VslSkdCngNotificationSetupVO[])getVOs(request, VslSkdCngNotificationSetupVO.class, "sheet1_"));
		}
