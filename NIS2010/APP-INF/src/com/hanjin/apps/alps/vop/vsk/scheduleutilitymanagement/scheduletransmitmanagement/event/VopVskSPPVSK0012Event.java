...
*@FileName : VopVskSPPVSK0012Event.java
*@FileTitle : Prestowage Notice (Telex) Save
*Open Issues :
*Change history :
 ...
 * @see spp_vsk_0012HTMLAction 참조
 * @since J2EE 1.6
 */

public class VopVskSPPVSK0012Event extends EventSupport {
