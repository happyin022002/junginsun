...
public class PortTariffMgtBCDBDAOModifyPsoYdChgUSQL implements ISQLTemplate{
	...
	public PortTariffMgtBCDBDAOModifyPsoYdChgUSQL(){
		...
		params.put("port_trf_url",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("port_trf_rmk",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(",	PORT_TRF_URL = @[port_trf_url]" ).append("\n"); 
		query.append(",	PORT_TRF_RMK = @[port_trf_rmk]" ).append("\n"); 
