...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFSummaryOverDmsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFSummaryOverDmsUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFSummaryOverDmsUSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFSummaryOverDmsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE OPF_CGO_BKG_FCAST_DG_DTL" ).append("\n"); 
