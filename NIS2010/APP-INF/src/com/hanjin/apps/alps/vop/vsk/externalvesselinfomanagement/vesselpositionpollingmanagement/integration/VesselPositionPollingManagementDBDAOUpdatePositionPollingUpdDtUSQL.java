...
*@FileName : VesselPositionPollingManagementDBDAOUpdatePositionPollingUpdDtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselPositionPollingManagementDBDAOUpdatePositionPollingUpdDtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdatePositionPollingUpdDt
	  * </pre>
	  */
	public VesselPositionPollingManagementDBDAOUpdatePositionPollingUpdDtUSQL(){
		setQuery();
		...
		query.append("FileName : VesselPositionPollingManagementDBDAOUpdatePositionPollingUpdDtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE	VSK_VSL_PSN_PLNG_HDR " ).append("\n"); 
