...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPCL CGO APVL for Partner Lines 의 Request File 수정
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_PRNR_APRO_RQST_FILE SET" ).append("\n"); 
