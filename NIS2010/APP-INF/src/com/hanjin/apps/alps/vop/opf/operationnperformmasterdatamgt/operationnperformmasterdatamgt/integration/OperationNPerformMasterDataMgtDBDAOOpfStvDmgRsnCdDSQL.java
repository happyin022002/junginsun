...
*@FileName : OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OperationNPerformMasterDataMgtDB OpfStvDmgRsnCd Delete
	  * </pre>
	  */
	public OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}