...
*@FileName : UNNumberVO.java
*@FileTitle : UNNumberVO
*Open Issues :
*Change history :
...
public class UNNumberVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UNNumberVO> models = new ArrayList<UNNumberVO>();
	 ...
	 * @return UNNumberVO[]
	 */
	public UNNumberVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UNNumberVO[]
	 */
	public UNNumberVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UNNumberVO model = null;
		...
		try {
			...
			String[] imdgCrrRstrExptNm = (JSPUtil.getParameter(request, prefix	+ "imdg_crr_rstr_expt_nm".trim(), length));
	 ...
	 * @return UNNumberVO[]
	 */
	public UNNumberVO[] getUNNumberVOs(){
		UNNumberVO[] vos = (UNNumberVO[])models.toArray(new UNNumberVO[models.size()]);
		return vos;
	}
