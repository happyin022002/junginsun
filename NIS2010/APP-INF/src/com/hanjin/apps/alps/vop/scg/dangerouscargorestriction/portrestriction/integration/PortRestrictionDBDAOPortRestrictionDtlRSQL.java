...
*@FileName : PortRestrictionDBDAOPortRestrictionDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortRestrictionDBDAOPortRestrictionDtlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortRestrictionDBDAOPortRestrictionDtlRSQL(){
		setQuery();
		...
		query.append("FileName : PortRestrictionDBDAOPortRestrictionDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
