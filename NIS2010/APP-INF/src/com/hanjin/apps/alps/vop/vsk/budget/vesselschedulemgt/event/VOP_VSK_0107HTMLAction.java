...
*@FileName : VOP_VSK_0107HTMLAction.java
 ...
 * @author Maria Chin
 * @see VopVsk0107Event.java 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0107HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0107HTMLAction 객체를 생성
	 */
	public VOP_VSK_0107HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0107Event event = new VopVsk0107Event();
