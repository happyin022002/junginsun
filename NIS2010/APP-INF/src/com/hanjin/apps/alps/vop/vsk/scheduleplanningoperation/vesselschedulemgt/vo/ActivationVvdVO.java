...
public class ActivationVvdVO extends AbstractValueObject {
	...
	/* Column Info */
	private String orgSkdStsCd = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("org_skd_sts_cd", getOrgSkdStsCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("org_skd_sts_cd", "orgSkdStsCd");
	 ...
	 * @return orgSkdStsCd
	 */
	public String getOrgSkdStsCd() {
		return this.orgSkdStsCd;
	}
	 ...
	 * @param orgSkdStsCd
	 */
	public void setOrgSkdStsCd(String orgSkdStsCd) {
		this.orgSkdStsCd = orgSkdStsCd;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOrgSkdStsCd(JSPUtil.getParameter(request, prefix + "org_skd_sts_cd", ""));
	...
	public ActivationVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] orgSkdStsCd = (JSPUtil.getParameter(request, prefix	+ "org_skd_sts_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (orgSkdStsCd[i] != null)
					model.setOrgSkdStsCd(orgSkdStsCd[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.orgSkdStsCd = this.orgSkdStsCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
