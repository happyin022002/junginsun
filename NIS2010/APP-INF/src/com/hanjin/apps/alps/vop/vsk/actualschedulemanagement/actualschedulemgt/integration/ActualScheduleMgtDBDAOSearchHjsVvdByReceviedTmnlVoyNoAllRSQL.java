...
*@FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedTmnlVoyNoAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchHjsVvdByReceviedTmnlVoyNoAllRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 수신된 Terminal Voyage No, SML Vessel Code, Yard Code를 이용한 SML에 맵핑되는 모든 VVD를 조회한다.
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchHjsVvdByReceviedTmnlVoyNoAllRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchHjsVvdByReceviedTmnlVoyNoAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
