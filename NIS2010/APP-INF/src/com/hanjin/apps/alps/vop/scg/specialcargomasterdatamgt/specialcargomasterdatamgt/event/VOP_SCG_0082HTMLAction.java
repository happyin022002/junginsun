...
*@FileName : VOP_AOM_0082HTMLAction.java
...
public class VOP_SCG_0082HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_AOM_0082HTMLAction 객체를 생성
	 */
	public VOP_SCG_0082HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0082Event event = new VopScg0082Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgCdVOS((ScgCdVO[])getVOs(request, ScgCdVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgCdVO((ScgCdVO)getVO(request, ScgCdVO .class));
		}
