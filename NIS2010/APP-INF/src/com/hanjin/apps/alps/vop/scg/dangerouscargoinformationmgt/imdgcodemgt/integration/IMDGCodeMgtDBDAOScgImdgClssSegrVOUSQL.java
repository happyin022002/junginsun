...
*@FileName : IMDGCodeMgtDBDAOScgImdgClssSegrVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgClssSegrVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgClssSegrVOUSQL(){
		setQuery();
