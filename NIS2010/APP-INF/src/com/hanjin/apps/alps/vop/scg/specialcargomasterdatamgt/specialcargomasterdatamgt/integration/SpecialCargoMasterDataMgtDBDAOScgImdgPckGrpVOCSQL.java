...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckGrpVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgImdgPckGrpVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Packing Group (Creation) 입력
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgImdgPckGrpVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_PCK_GRP (" ).append("\n"); 
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckGrpVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}