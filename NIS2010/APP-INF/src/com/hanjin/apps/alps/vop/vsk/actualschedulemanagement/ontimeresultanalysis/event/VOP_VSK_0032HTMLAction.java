...
*@FileName : VOP_VSK_0032HTMLAction.java
...
public class VOP_VSK_0032HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0032HTMLAction 객체를 생성
	 */
	public VOP_VSK_0032HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0032Event event = new VopVsk0032Event();
		...
		if(command.isCommand(FormCommand.SEARCH) ||
			...
			event.setResultOnTimeRatioVO((ResultOnTimeRatioVO)getVO(request, ResultOnTimeRatioVO.class));
		}
		return  event;
	}
