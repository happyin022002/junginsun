...
*@FileName : VOP_SCG_0023HTMLAction.java
...
public class VOP_SCG_0023HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0023HTMLAction 객체를 생성
	 */
	public VOP_SCG_0023HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0023Event event = new VopScg0023Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgRequestListOptionVO((ScgRequestListOptionVO)getVO(request, ScgRequestListOptionVO .class));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setScgAuthorizationVOS((ScgAuthorizationVO[])getVOs(request, ScgAuthorizationVO .class,"sheet_"));
			event.setScgPrnrAproRqstCgoVOS((ScgPrnrAproRqstCgoVO[])getVOs(request, ScgPrnrAproRqstCgoVO .class,"sheet_"));
		}
