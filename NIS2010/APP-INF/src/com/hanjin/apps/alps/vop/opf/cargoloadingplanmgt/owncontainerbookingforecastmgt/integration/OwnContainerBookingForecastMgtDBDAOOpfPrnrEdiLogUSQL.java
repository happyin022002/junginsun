...
*@FileName : OwnContainerBookingForecastMgtDBDAOOpfPrnrEdiLogUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOOpfPrnrEdiLogUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOOpfPrnrEdiLogUSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOOpfPrnrEdiLogUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE OPF_PRNR_EDI_LOG SET" ).append("\n"); 
		...
		query.append("    , EDI_VSL_NM 		= @[edi_vsl_nm]" ).append("\n"); 
		query.append("    , EDI_SKD_DIR_NM 	= @[edi_skd_dir_nm]" ).append("\n"); 
