...
*@FileName : VopVskSpp0008Event.java
*@FileTitle : ETA sending (Auto-fax) history Creation
*Open Issues :
*Change history :
...
/**
 * ETA sending (Auto-fax) history 생성
 *
 * @author Maria Chin
...
public class VopVskSPPVSK0008Event extends EventSupport {
