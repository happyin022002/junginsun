...
*@FileName : VOP_VSK_0112HTMLAction.java
 ...
 * @author Maria Chin
 * @see VopVsk0112Event 참조
 * @since J2EE 1.4
 */

public class VOP_VSK_0112HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0112HTMLAction 객체를 생성
	 */
	public VOP_VSK_0112HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0112Event event = new VopVsk0112Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			// 아래코드는 수정중
			//event.setVvdBkgStsVO((VvdBkgStsVO)getVO(request, VvdBkgStsVO .class));
			event.setSimulationVvdCheckVO((SimulationVvdCheckVO)getVO(request, SimulationVvdCheckVO.class));
		}
