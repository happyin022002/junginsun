...
public class VslRptInqVO extends AbstractValueObject {
	...
	public VslRptInqVO(String ibflag, String pagerows, String searchinfo, String searchkey, String searchcon, String toDt, String vpsPortCd, String vslCd, String fmDt, String vslSlanCd, String skdDirCd, String lastPort, String depPort) {
		this.toDt = toDt;
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dep_port", getDepPort());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dep_port", "depPort");
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDepPort(JSPUtil.getParameter(request, prefix + "dep_port", ""));
	}
	...
	public VslRptInqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] depPort = (JSPUtil.getParameter(request, prefix	+ "dep_port", length));
	...
	*/
	public void unDataFormat(){
		...
		this.depPort = this.depPort .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
