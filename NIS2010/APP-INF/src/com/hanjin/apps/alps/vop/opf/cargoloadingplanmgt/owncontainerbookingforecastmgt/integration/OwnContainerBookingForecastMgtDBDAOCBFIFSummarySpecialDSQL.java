...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFSummarySpecialDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFSummarySpecialDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFSummarySpecialDSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFSummarySpecialDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
