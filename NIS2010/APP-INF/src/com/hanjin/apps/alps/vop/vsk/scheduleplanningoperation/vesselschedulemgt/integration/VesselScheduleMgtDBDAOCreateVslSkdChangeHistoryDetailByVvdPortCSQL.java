...
*@FileName : VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryDetailByVvdPortCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryDetailByVvdPortCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Vessel Schedule 이력에 대한 VVD 및 Port 단위데이터 생성
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryDetailByVvdPortCSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryDetailByVvdPortCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
