...
*@FileName : VOP_VSK_0514HTMLAction.java
...
public class VOP_VSK_0514HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0514HTMLAction 객체를 생성
	 */
	public VOP_VSK_0514HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0514Event event = new VopVsk0514Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setVskPortTideVOS((VskPortTideVO[])getVOs(request, VskPortTideVO .class,"sheet1_"));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSHATideInformationMgtConditionVO((SHATideInformationMgtConditionVO)getVO(request, SHATideInformationMgtConditionVO .class));
		}
