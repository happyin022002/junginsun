...
*@FileName : VOP_VSK_0102HTMLAction.java
 ...
 * @author Maria Chin
 * @see VopVsk0102Event 참조
 * @since J2EE 1.4
 */

public class VOP_VSK_0102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0102HTMLAction 객체를 생성
	 */
	public VOP_VSK_0102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0102Event event = new VopVsk0102Event();
