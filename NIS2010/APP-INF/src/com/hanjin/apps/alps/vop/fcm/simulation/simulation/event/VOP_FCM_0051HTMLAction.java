...
*@FileName : VOP_FCM_0051HTMLAction.java
*@FileTitle : VOP_FCM_0051HTMLAction
*Open Issues :
*Change history :
...
/**
 * HTTP Parser<br>
 * - VOP_FCM_0051 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class VOP_FCM_0051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0051HTMLAction 객체를 생성
	 */
	public VOP_FCM_0051HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0051Event event = new VopFcm0051Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBnkReqSimVO((BnkReqSimVO)getVO(request, BnkReqSimVO.class));
		}else if(command.isCommand(FormCommand.MULTI)){
			event.setBnkReqSimVOs((BnkReqSimVO[])getVOs(request, BnkReqSimVO.class));
		}
