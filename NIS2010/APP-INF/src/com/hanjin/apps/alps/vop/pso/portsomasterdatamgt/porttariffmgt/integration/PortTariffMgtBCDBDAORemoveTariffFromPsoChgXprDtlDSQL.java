...
*@FileName : PortTariffMgtBCDBDAORemoveTariffFromPsoChgXprDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAORemoveTariffFromPsoChgXprDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSO_CHG_XPR_DTL 에서 Tariff 정보를 삭제한다.
	  * </pre>
	  */
	public PortTariffMgtBCDBDAORemoveTariffFromPsoChgXprDtlDSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAORemoveTariffFromPsoChgXprDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PSO_CHG_XPR_DTL " ).append("\n"); 
