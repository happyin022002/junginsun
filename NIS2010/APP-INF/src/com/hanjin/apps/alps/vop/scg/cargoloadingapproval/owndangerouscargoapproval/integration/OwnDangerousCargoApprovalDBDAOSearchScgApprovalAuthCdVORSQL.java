...
public class OwnDangerousCargoApprovalDBDAOSearchScgApprovalAuthCdVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		,  DECODE(A.VSL_PRE_PST_CD,'U',DECODE(G.SPCL_CGO_AUTH_CD,'N','N','Y','Y',''),NVL(G.SPCL_CGO_AUTH_CD,'R')) AS SPCL_CGO_AUTH_CD" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	ORDER BY DECODE(A.VSL_PRE_PST_CD,'U',DECODE(G.SPCL_CGO_AUTH_CD,'N','N','Y','Y',''),NVL(G.SPCL_CGO_AUTH_CD,'R'))" ).append("\n"); 
		query.append(")" ).append("\n"); 
