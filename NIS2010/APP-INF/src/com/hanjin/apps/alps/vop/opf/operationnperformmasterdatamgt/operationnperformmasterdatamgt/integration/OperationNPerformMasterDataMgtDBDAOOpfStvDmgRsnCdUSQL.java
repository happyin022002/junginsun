...
*@FileName : OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdUSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("stv_dmg_grp_cd = 'R'," ).append("\n"); 
		...
		query.append("FileName : OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}