...
*@FileName : VOP_VSK_0090HTMLAction.java
...
public class VOP_VSK_0090HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0090HTMLAction 객체를 생성
	 */
	public VOP_VSK_0090HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0090Event event = new VopVsk0090Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setEtaSendTgtVOs((EtaSendTgtVO[])getVOs(request, EtaSendTgtVO .class,"sheet1_"));
		}
