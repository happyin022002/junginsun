...
import com.hanjin.apps.alps.vop.pso.estimateinvoiceaudit.canaltransitfeeinvoice.vo.CanalTzFeeSumVO;
...
public class VopPso0019Event extends EventSupport {
	...
	/**invoice생성용 VO*/
	private AuditDataValidOwnerAccountVO[] auditDataValidOwnerAccountVOs;
	...
	/**
	 * Invoice OA VO getter
	 * @return
	 */
	public AuditDataValidOwnerAccountVO[] getAuditDataValidOwnerAccountVOs(){
		AuditDataValidOwnerAccountVO[] tmpVOs = null;
		if (this. auditDataValidOwnerAccountVOs != null) {
			tmpVOs = new AuditDataValidOwnerAccountVO[auditDataValidOwnerAccountVOs .length];
			System.arraycopy(auditDataValidOwnerAccountVOs, 0, tmpVOs, 0, tmpVOs.length);
		}
		return tmpVOs;
	}
	...
	public void setAuditDataValidOwnerAccountVOs(AuditDataValidOwnerAccountVO[] auditDataValidOwnerAccountVOs){
		if (auditDataValidOwnerAccountVOs != null) {
			AuditDataValidOwnerAccountVO[] tmpVOs = new AuditDataValidOwnerAccountVO[auditDataValidOwnerAccountVOs .length];
			System.arraycopy(auditDataValidOwnerAccountVOs, 0, tmpVOs, 0, tmpVOs.length);
			this. auditDataValidOwnerAccountVOs = tmpVOs;
		}
	}
