...
*@FileName : VOP_OPF_0405HTMLAction.java
...
public class VOP_OPF_0405HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0405HTMLAction 객체를 생성
	 */
	public VOP_OPF_0405HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0405Event event = new VopOpf0405Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPortTimeActivityVO((PortTimeActivityVO)getVO(request, PortTimeActivityVO .class));
			...
			event.setPortTimeActivityVOs((PortTimeActivityVO[])getVOs(request, PortTimeActivityVO .class, "sheet1_"));
			event.setPortTimeActivityVOs2((PortTimeActivityVO[])getVOs(request, PortTimeActivityVO .class, "sheet3_"));
		}
