...
public class SearchVVDVO extends AbstractValueObject {
	...
	public SearchVVDVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String vslEngNm, String vslSlanCd, String vslSlanNm, String vslOprTpCd, String vslOprTpNm) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
