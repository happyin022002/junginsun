...
*@FileName : RegionDepartureReportDBDAOAddRdrHC45CSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOAddRdrHC45CSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAOAddRdrHC45CSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOAddRdrHC45CSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO RDR_BSA(VSL_CD" ).append("\n"); 
		...
		query.append(",                   HC_QTY" ).append("\n"); 
		query.append(",                   HC_RAT" ).append("\n"); 
