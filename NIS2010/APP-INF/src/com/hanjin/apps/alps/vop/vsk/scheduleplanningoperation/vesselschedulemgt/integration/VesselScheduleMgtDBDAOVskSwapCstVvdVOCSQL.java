...
*@FileName : VesselScheduleMgtDBDAOVskSwapCstVvdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOVskSwapCstVvdVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VskSwapCstVvd 정보를 등록한다.
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOVskSwapCstVvdVOCSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOVskSwapCstVvdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[skd_sts_cd]," ).append("\n"); 
		query.append("(SELECT DECODE(T1.VSL_SVC_TP_CD||DECODE(T2.VSL_OWN_IND_CD, 'O', 'O', 'C')||DECODE(T2.CRR_CD, 'SML', 'H', 'X')," ).append("\n"); 
