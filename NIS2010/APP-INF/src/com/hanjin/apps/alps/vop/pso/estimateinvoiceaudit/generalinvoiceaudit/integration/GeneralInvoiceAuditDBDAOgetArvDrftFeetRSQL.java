...
*@FileName : GeneralInvoiceAuditDBDAOgetArvDrftFeetRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetArvDrftFeetRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff 비용 계산을 위해 Arrival Draft Feet를 구한다. 
	  * 2014.03.25 CHM-201429461 이윤정 [PSO] Object 중 Meter에서 Feet 변환 로직 수정
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetArvDrftFeetRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetArvDrftFeetRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
