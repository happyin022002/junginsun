...
*@FileName : SpecialCargoIrregularMgtDBDAOIrrFileListVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoIrregularMgtDBDAOIrrFileListVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Supporting Documents or Pictures 수정
	  * </pre>
	  */
	public SpecialCargoIrregularMgtDBDAOIrrFileListVOUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoIrregularMgtDBDAOIrrFileListVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_IRR_FILE_LIST SET" ).append("\n"); 
		query.append("VSL_CD = @[vsl_cd]" ).append("\n"); 
		query.append(",	SKD_VOY_NO = @[skd_voy_no]" ).append("\n"); 
		query.append(",	SKD_DIR_CD = @[skd_dir_cd]" ).append("\n"); 
		query.append(",	SPCL_CGO_IRR_SEQ = @[spcl_cgo_irr_seq]" ).append("\n"); 
		query.append(",	SPCL_CGO_IRR_FILE_SEQ = @[spcl_cgo_irr_file_seq]" ).append("\n"); 
		...
		query.append("AND	SPCL_CGO_IRR_FILE_SEQ = @[spcl_cgo_irr_file_seq]" ).append("\n"); 
