...
*@FileName : VOP_SCG_0016HTMLAction.java
...
public class VOP_SCG_0016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0016HTMLAction 객체를 생성
	 */
	public VOP_SCG_0016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0016Event event = new VopScg0016Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgAwkCgoVO((ScgAwkCgoVO)getVO(request, ScgAwkCgoVO .class));
		}
