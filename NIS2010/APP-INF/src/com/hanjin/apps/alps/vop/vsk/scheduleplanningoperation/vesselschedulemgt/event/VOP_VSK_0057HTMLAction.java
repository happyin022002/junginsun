...
*@FileName : VOP_VSK_0057HTMLAction.java
 ...
 * @author Jung Jinwoo
 * @see VopVsk0057Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0057HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0057HTMLAction 객체를 생성
	 */
	public VOP_VSK_0057HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0057Event event = new VopVsk0057Event();
