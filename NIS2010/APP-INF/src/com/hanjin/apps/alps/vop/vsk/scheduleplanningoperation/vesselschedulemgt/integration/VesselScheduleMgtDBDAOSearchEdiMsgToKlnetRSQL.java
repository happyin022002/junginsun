...
*@FileName : VesselScheduleMgtDBDAOSearchEdiMsgToKlnetRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOSearchEdiMsgToKlnetRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Daily Berth Window 화면에서 EDI 전송 실행시에 만들어 지는 EDI 메시지를 생성한다.
	  * ---------------------------------------------------------------------------------------
	  * History
	  * 2010.12.07 진마리아 선CSR CCT 구하는 로직 변경
	  * 기존 : CCT = VPS_ETA_DT + 0.5
	  * 변경 : CCT = VPS_ETB_DT - 0.416 ( 접안10시간전)
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOSearchEdiMsgToKlnetRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOSearchEdiMsgToKlnetRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        				'YARD_CD:'     || NVL(PLISM_YD_CD, ' ')							||CHR(10)||" ).append("\n"); 
