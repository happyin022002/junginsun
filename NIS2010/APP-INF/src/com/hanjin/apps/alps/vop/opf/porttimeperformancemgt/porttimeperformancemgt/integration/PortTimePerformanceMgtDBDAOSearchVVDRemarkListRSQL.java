...
*@FileName : PortTimePerformanceMgtDBDAOSearchVVDRemarkListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTimePerformanceMgtDBDAOSearchVVDRemarkListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortTimePerformanceMgtDBDAOSearchVVDRemarkListRSQL(){
		setQuery();
		...
		query.append("FileName : PortTimePerformanceMgtDBDAOSearchVVDRemarkListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , TO_CHAR(SKD_VOY_NO) SKD_VOY_NO" ).append("\n"); 
		...
		query.append("  FROM OPF_PORT_TM_RMK" ).append("\n"); 
