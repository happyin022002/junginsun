...
*@FileName : OpfStowageMgtDBDAOBayPlanCntrPositionListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OpfStowageMgtDBDAOBayPlanCntrPositionListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OpfStowageMgtDBDAOBayPlanCntrPositionList
	  * </pre>
	  */
	public OpfStowageMgtDBDAOBayPlanCntrPositionListRSQL(){
		setQuery();
		...
		query.append("FileName : OpfStowageMgtDBDAOBayPlanCntrPositionListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         , ID AS CNTR_ID" ).append("\n"); 
		query.append("         , BAY AS BAY_IDX" ).append("\n"); 
