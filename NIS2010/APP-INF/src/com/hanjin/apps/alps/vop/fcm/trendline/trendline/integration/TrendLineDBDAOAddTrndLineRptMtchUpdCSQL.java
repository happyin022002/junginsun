...
*@FileName : TrendLineDBDAOAddTrndLineRptMtchUpdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAOAddTrndLineRptMtchUpdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 기존재하는 trnd line의 Trnd Line Rpt Mtch 정보(xcld 데이터 생성)를 생성합니다.
	  * </pre>
	  */
	public TrendLineDBDAOAddTrndLineRptMtchUpdCSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAOAddTrndLineRptMtchUpdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
