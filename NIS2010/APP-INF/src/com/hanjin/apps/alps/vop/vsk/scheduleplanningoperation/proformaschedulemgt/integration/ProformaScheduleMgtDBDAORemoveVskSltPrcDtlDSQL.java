...
*@FileName : ProformaScheduleMgtDBDAORemoveVskSltPrcDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProformaScheduleMgtDBDAORemoveVskSltPrcDtlDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProformaScheduleMgtDBDAORemoveVskSltPrcDtlDSQL(){
		setQuery();
		...
		query.append("FileName : ProformaScheduleMgtDBDAORemoveVskSltPrcDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM VSK_SLT_PRC_DTL" ).append("\n"); 
