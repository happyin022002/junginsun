...
*@FileName : VslDepRptMssMtchVO.java
*@FileTitle : VslDepRptMssMtchVO
*Open Issues :
*Change history :
...
public class VslDepRptMssMtchVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VslDepRptMssMtchVO> models = new ArrayList<VslDepRptMssMtchVO>();
	...
	public VslDepRptMssMtchVO() {}

	public VslDepRptMssMtchVO(String ibflag, String pagerows, String vslSlanCd, String vvd, String clptIndSeq, String depPortCd, String nxtPortCd) {
		this.vvd = vvd;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public VslDepRptMssMtchVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VslDepRptMssMtchVO[]
	 */
	public VslDepRptMssMtchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VslDepRptMssMtchVO model = null;
	 ...
	 * @return VslDepRptMssMtchVO[]
	 */
	public VslDepRptMssMtchVO[] getVslDepRptMssMtchVOs(){
		VslDepRptMssMtchVO[] vos = (VslDepRptMssMtchVO[])models.toArray(new VslDepRptMssMtchVO[models.size()]);
		return vos;
	}
