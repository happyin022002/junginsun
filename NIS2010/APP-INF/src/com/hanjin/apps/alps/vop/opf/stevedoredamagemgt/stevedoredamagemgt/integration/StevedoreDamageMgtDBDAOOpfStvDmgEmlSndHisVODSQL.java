...
*@FileName : StevedoreDamageMgtDBDAOOpfStvDmgEmlSndHisVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOOpfStvDmgEmlSndHisVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Damage Handling User 수정에 의한 기존 담당자 정보를 삭제 합니다.
	  * -------------------------------------------------------------------------------------------
	  * 2011.10.21 김민아 [CHM-201113609-01] SDMS 신속 처리를 위한 Auto mailing 기능 추가
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOOpfStvDmgEmlSndHisVODSQL(){
		setQuery();
		...
		query.append("FileName : StevedoreDamageMgtDBDAOOpfStvDmgEmlSndHisVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
