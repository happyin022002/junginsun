...
public class IoRatioVO extends AbstractValueObject {
	...
	public IoRatioVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String turn, String slanCd, String vpsPortCd, String rlaneDirCd, String obRto, String ibRto, String rlaneCd, String revYrmon) {
		this.vslCd = vslCd;
		this.turn = turn;
		this.obRto = obRto;
