...
*@FileName : VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Vessel Schedule 최초생성시 이력테이블에 관련데이터 INSERT
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCreateVslSkdChangeHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("				,	SUBSTR(@[his_cre_usr_id],1,20)" ).append("\n"); 
		query.append("				,	SYSDATE" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("				,	'N'					AS HIS_DELT_PROHI_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
