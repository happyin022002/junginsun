...
*@FileName : CanalTransitFeeBalanceDBDAOSearchGLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CanalTransitFeeBalanceDBDAOSearchGLRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CanalTransitFeeBalanceDBDAOSearchGLRSQL(){
		setQuery();
		...
		query.append("FileName : CanalTransitFeeBalanceDBDAOSearchGLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT B.GL_DT" ).append("\n"); 
		...
		query.append(",SUM(INV_TTL_AMT) SLIP" ).append("\n"); 
		...
		query.append("GROUP  BY B.GL_DT" ).append("\n"); 
		query.append(",B.CSR_NO" ).append("\n"); 
