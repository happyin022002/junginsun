...
*@FileName : VOP_OPF_0073HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class VOP_OPF_0073HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UserHTMLAction 객체를 생성
	 */
	public VOP_OPF_0073HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */
    	...
    	VopOpf0073Event event = new VopOpf0073Event();
    	if (command.isCommand(FormCommand.SEARCH)) {
    		event.setOpfVnorSummaryVO((OpfVnorSummaryVO)getVO(request, OpfVnorSummaryVO.class));
    	}
