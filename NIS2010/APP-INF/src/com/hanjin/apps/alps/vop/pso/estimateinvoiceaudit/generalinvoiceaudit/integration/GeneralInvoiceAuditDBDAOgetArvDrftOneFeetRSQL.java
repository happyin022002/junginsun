...
*@FileName : GeneralInvoiceAuditDBDAOgetArvDrftOneFeetRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetArvDrftOneFeetRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetArvDrftOneFeetRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetArvDrftOneFeetRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  ROUND( MAX(ARR_AFTDR_HGT) * 3.281 , 2)" ).append("\n"); 
