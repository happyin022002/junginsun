...
*@FileName : TerminalDepartureReportDBDAODeleteVnorAttachFileDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAODeleteVnorAttachFileDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VNOR 의 File Attached 건을 삭제합니다.
	  * </pre>
	  */
	public TerminalDepartureReportDBDAODeleteVnorAttachFileDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAODeleteVnorAttachFileDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM OPF_ATCH_FILE" ).append("\n"); 
