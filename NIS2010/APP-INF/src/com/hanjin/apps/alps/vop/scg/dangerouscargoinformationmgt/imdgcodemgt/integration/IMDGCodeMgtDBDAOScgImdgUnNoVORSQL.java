...
*@FileName : IMDGCodeMgtDBDAOScgImdgUnNoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgUnNoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgUnNoVORSQL(){
		setQuery();
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgUnNoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
