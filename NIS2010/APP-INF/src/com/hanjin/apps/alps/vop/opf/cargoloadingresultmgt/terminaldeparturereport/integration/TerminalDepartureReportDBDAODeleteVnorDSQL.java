...
*@FileName : TerminalDepartureReportDBDAODeleteVnorDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAODeleteVnorDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAODeleteVnorDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAODeleteVnorDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM OPF_VNOR" ).append("\n"); 
