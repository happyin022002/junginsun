...
*@FileName : ProformaScheduleMgtDBDAORemoveVskSltPrcPortDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProformaScheduleMgtDBDAORemoveVskSltPrcPortDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveVskSltPrcPortDtl
	  * </pre>
	  */
	public ProformaScheduleMgtDBDAORemoveVskSltPrcPortDtlDSQL(){
		setQuery();
		...
		query.append("FileName : ProformaScheduleMgtDBDAORemoveVskSltPrcPortDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM VSK_SLT_PRC_PORT_DTL" ).append("\n"); 
