...
public class ActualScheduleMgtDBDAOSearchActualTargetLaneRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		--,	NVL(T1.ACT_CRR_CD,VC.CRR_CD)" ).append("\n"); 
		...
		query.append("AND     	T1.VSL_SLAN_CD    	!= 'GBA'" ).append("\n"); 
		...
		query.append("											, 	BKG_BOOKING S1" ).append("\n"); 
		query.append("            						WHERE   	1   = 1" ).append("\n"); 
		...
		query.append("												 (S.POD_CD 			= T2.VPS_PORT_CD AND S.POD_CLPT_IND_SEQ = T2.CLPT_IND_SEQ)" ).append("\n"); 
		query.append("												)" ).append("\n"); 
		query.append("            						AND     ROWNUM              	= 1" ).append("\n"); 
		query.append("        )" ).append("\n"); 
		query.append("GROUP BY 	T1.VSL_SLAN_CD" ).append("\n"); 
		query.append("		, 	VSL_SLAN_NM" ).append("\n"); 
		query.append("		, 	DECODE(VSL_SVC_TP_CD, 'O', 'O', 'T')" ).append("\n"); 
		query.append("		--,	NVL(T1.ACT_CRR_CD,VC.CRR_CD)" ).append("\n"); 
