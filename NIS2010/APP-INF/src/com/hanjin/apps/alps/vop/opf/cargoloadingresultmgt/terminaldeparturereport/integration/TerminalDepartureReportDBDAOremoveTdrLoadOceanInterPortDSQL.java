...
*@FileName : TerminalDepartureReportDBDAOremoveTdrLoadOceanInterPortDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOremoveTdrLoadOceanInterPortDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOremoveTdrLoadOceanInterPortDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOremoveTdrLoadOceanInterPortDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND CNTR_TYPE IN ('F','E')" ).append("\n"); 
