...
*@FileName : RegionDepartureReportDBDAORDRSlotSwapVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORDRSlotSwapVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDRSlotSwapVO Select Query
	  * </pre>
	  */
	public RegionDepartureReportDBDAORDRSlotSwapVORSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORDRSlotSwapVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       M.VSL_CD||M.VOY_NO||M.DIR_CD AS FM_VSL_CD," ).append("\n"); 
		query.append("       M.TO_OPR                     AS TO_CARR_CD," ).append("\n"); 
		query.append("       M.TO_VSL||M.TO_VOY||M.TO_DIR AS TO_VSL_CD," ).append("\n"); 
		query.append("       SUM(SLOT)                    AS TEU," ).append("\n"); 
		query.append("       SUM(WEIGHT)                  AS WEIGHT" ).append("\n"); 
		query.append("FROM   RDR_HEADER H, RDR_SLOT_SWAP M" ).append("\n"); 
		...
		query.append("GROUP BY M.OPR_CD, M.VSL_CD||M.VOY_NO||M.DIR_CD, M.TO_OPR, M.TO_VSL||M.TO_VOY||M.TO_DIR" ).append("\n"); 
