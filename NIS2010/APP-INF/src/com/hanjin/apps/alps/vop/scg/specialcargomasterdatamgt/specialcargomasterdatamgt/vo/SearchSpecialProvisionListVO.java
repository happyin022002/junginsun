...
*@FileName : searchSpecialProvisionListVO.java
*@FileTitle : searchSpecialProvisionListVO
*Open Issues :
*Change history :
...
public class SearchSpecialProvisionListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchSpecialProvisionListVO> models = new ArrayList<SearchSpecialProvisionListVO>();
	...
	public SearchSpecialProvisionListVO() {}

	public SearchSpecialProvisionListVO(String ibflag, String pagerows, String imdgSpclProviNo, String imdgSpclProviDesc, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String imdgSpclProviNo1) {
		this.updDt = updDt;
	...
	public SearchSpecialProvisionListVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public SearchSpecialProvisionListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchSpecialProvisionListVO model = null;
		...
		try {
			...
			String[] imdgSpclProviNo1 = (JSPUtil.getParameter(request, prefix	+ "imdg_spcl_provi_no1".trim(), length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchSpecialProvisionListVO();
				if (updDt[i] != null)
		...
		return getsearchSpecialProvisionListVOs();
	}

	public SearchSpecialProvisionListVO[] getsearchSpecialProvisionListVOs(){
		SearchSpecialProvisionListVO[] vos = (SearchSpecialProvisionListVO[])models.toArray(new SearchSpecialProvisionListVO[models.size()]);
		return vos;
	}
