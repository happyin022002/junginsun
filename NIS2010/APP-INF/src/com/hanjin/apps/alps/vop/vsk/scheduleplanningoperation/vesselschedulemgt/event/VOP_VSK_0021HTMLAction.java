...
*@FileName : VOP_VSK_0021HTMLAction.java
 ...
 * @author Jung Jinwoo
 * @see VopVsk0021Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0021HTMLAction 객체를 생성
	 */
	public VOP_VSK_0021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0021Event event = new VopVsk0021Event();
