...
*@FileName : VOP_VSK_0113HTMLAction.java
 ...
 * @author YONG JOON LEE
 * @see VopVsk0113Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0113HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0113HTMLAction 객체를 생성
	 */ 
	public VOP_VSK_0113HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0113Event event = new VopVsk0113Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCstSkdByPortVO((CstSkdByPortVO)getVO(request, CstSkdByPortVO .class));
			...
			event.setSearchDateVO((SearchDateVO)getVO(request, SearchDateVO .class));
