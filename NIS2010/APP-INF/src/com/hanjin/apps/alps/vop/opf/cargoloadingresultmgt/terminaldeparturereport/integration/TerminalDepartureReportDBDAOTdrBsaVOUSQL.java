...
*@FileName : TerminalDepartureReportDBDAOTdrBsaVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTdrBsaVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTdrBsaVOUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOTdrBsaVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE 	TDR_BSA" ).append("\n"); 
		query.append("SET		TTL_QTY         =	@[ttl_qty]         " ).append("\n"); 
		query.append(",		TTL_WGT         =	@[ttl_wgt]         " ).append("\n"); 
		query.append(",		HC40_QTY        =	@[hc40_qty]        " ).append("\n"); 
		query.append(",		HC40_RAT        =	@[hc40_rat]        " ).append("\n"); 
		query.append(",		HC20_QTY        =	@[hc20_qty]        " ).append("\n"); 
		query.append(",		HC20_RAT        =	@[hc20_rat]        " ).append("\n"); 
		query.append(",		QTY_45          =	@[qty_45]          " ).append("\n"); 
		query.append(",		UN_RAT_45       =	@[un_rat_45]       " ).append("\n"); 
		query.append(",		OV_RAT_45       =	@[ov_rat_45]       " ).append("\n"); 
		query.append(",		TTL_RAT         =	@[ttl_rat]         " ).append("\n"); 
		query.append(",		UPDATE_USER     =	@[update_user]     " ).append("\n"); 
		query.append(",		UPDATE_TIME     =	@[update_time]     " ).append("\n"); 
		query.append(",		TEU_WGT			=	@[teu_wgt]         " ).append("\n"); 
