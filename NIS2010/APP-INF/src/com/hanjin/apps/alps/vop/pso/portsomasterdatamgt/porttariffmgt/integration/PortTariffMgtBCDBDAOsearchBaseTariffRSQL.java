...
public class PortTariffMgtBCDBDAOsearchBaseTariffRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,NVL2(T23.FM_VAL, CASE WHEN T26.PSO_MEAS_UT_CD_DSP IN ('TIME') THEN SUBSTR(TO_CHAR(T23.FM_VAL, 'FM0000'), 1, 2) || ':' || SUBSTR(TO_CHAR(T23.FM_VAL, 'FM0000'), 3, 2)      " ).append("\n"); 
		...
		query.append("      ,NVL2(T23.TO_VAL, CASE WHEN T26.PSO_MEAS_UT_CD_DSP IN ('TIME') THEN SUBSTR(TO_CHAR(T23.TO_VAL, 'FM0000'), 1, 2) || ':' || SUBSTR(TO_CHAR(T23.TO_VAL, 'FM0000'), 3, 2)      " ).append("\n"); 
