...
*@FileName : PackingStyleCodesVO.java
*@FileTitle : PackingStyleCodesVO
*Open Issues :
*Change history :
...
public class PackingStyleCodesVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PackingStyleCodesVO> models = new ArrayList<PackingStyleCodesVO>();
	...
	/* Column Info */
	private String imdgPckTpCd1 = null;
	/* Column Info */
	...
	public PackingStyleCodesVO() {}

	public PackingStyleCodesVO(String ibflag, String pagerows, String imdgPckCd, String imdgPckDesc, String imdgPckTpCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String imdgPckTpCd1) {
		this.updDt = updDt;
		...
		this.creDt = creDt;
		this.imdgPckTpCd1 = imdgPckTpCd1;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("imdg_pck_tp_cd1", getImdgPckTpCd1());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("imdg_pck_tp_cd1", "imdgPckTpCd1");
	...
	public String getImdgPckTpCd1() {
		return this.imdgPckTpCd1;
	}
	...
	public void setImdgPckTpCd1(String imdgPckTpCd1) {
		this.imdgPckTpCd1 = imdgPckTpCd1;
		//this.imdgPckTpCd1=true;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setImdgPckTpCd1(JSPUtil.getParameter(request, "imdg_pck_tp_cd1", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setImdgPckCd(JSPUtil.getParameter(request, "imdg_pck_cd", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
	}

	public PackingStyleCodesVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public PackingStyleCodesVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PackingStyleCodesVO model = null;
		...
		try {
			...
			String[] imdgPckTpCd1 = (JSPUtil.getParameter(request, prefix	+ "imdg_pck_tp_cd1".trim(), length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id".trim(), length));
			String[] imdgPckCd = (JSPUtil.getParameter(request, prefix	+ "imdg_pck_cd".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new PackingStyleCodesVO();
				if (updDt[i] != null)
				...
				if (imdgPckTpCd1[i] != null)
					model.setImdgPckTpCd1(imdgPckTpCd1[i]);
				if (updUsrId[i] != null)
		...
		return getPackingStyleCodesVOs();
	}

	public PackingStyleCodesVO[] getPackingStyleCodesVOs(){
		PackingStyleCodesVO[] vos = (PackingStyleCodesVO[])models.toArray(new PackingStyleCodesVO[models.size()]);
		return vos;
	}
	...
	*/
	public void onDataFormat(){
		...
		this.imdgPckTpCd1 = this.imdgPckTpCd1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
