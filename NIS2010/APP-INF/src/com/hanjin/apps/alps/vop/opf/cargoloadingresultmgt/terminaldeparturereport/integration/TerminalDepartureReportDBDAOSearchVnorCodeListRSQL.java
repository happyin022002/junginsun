...
*@FileName : TerminalDepartureReportDBDAOSearchVnorCodeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOSearchVnorCodeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOSearchVnorCodeListRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOSearchVnorCodeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND SUBSTR(INTG_CD_VAL_CTNT, 0, 1) = @[intg_cd_val_ctnt]" ).append("\n"); 
