...
*@FileName : SetupDBDAOaddFcmDepRptErrRtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupDBDAOaddFcmDepRptErrRtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SetupDBDAOaddFcmDepRptErrRtCSQL(){
		setQuery();
		...
		query.append("FileName : SetupDBDAOaddFcmDepRptErrRtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO FCM_DEP_RPT_ERR_RT_SET " ).append("\n"); 
		query.append("(" ).append("\n"); 
