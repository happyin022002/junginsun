...
*@FileName : CarrierRestrictionDBDAOScgImdgCrrRstrVOCSQL.java
...
public class CarrierRestrictionDBDAOScgImdgCrrRstrVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierRestrictionDBDAOScgImdgCrrRstrVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_CRR_RSTR(" ).append("\n"); 
		...
		query.append("FileName : CarrierRestrictionDBDAOScgImdgCrrRstrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}