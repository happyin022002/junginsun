...
public class YardChargeVersionVO extends AbstractValueObject {
	...
	public YardChargeVersionVO(String ibflag, String pagerows, String rn, String ydChgNo, String ydChgVerSeq, String updUsrId, String updDt, String portTrfUrl, String portTrfRmk) {
		this.updDt = updDt;
		this.ibflag = ibflag;
		this.rn = rn;
	 ...
	 * @param portTrfRmk
	 */
	public void setPortTrfUrl(String portTrfRmk) {
		this.portTrfRmk = portTrfRmk;
	}
