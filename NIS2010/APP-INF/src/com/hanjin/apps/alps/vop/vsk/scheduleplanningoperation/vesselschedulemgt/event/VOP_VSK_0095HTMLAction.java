...
*@FileName : VOP_VSK_0095HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see VopVsk0095Event 참조
 * @since J2EE 1.6
 */

public class VOP_VSK_0095HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0095HTMLAction 객체를 생성
	 */
	public VOP_VSK_0095HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0095Event event = new VopVsk0095Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setVslSkdRepeatErpIfVO((VslSkdRepeatErpIfVO)getVO(request, VslSkdRepeatErpIfVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setVslSkdRepeatErpIfVOs((VslSkdRepeatErpIfVO[])getVOs(request, VslSkdRepeatErpIfVO.class, ""));
		}
