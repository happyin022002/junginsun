...
*@FileName : ComComboVO.java
*@FileTitle : ComComboVO
*Open Issues :
*Change history :
...
public class ComComboVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComComboVO> models = new ArrayList<ComComboVO>();
	...
	public ComComboVO(String ibflag, String pagerows, String intgCdId, String intgCdValCtnt, String intgCdValDpDesc, String intgCdValDesc) {
...
/**
	 ...
	 * @return ComComboVO[]
	 */
	public ComComboVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComComboVO[]
	 */
	public ComComboVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComComboVO model = null;
	...
	public ComComboVO[] getComComboVOs(){
		ComComboVO[] vos = (ComComboVO[])models.toArray(new ComComboVO[models.size()]);
		return vos;
	}
