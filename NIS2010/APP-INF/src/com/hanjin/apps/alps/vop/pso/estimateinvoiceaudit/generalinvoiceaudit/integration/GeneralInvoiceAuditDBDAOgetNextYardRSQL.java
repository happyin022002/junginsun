...
*@FileName : GeneralInvoiceAuditDBDAOgetNextYardRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetNextYardRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * [CHM-201533647] 다음 calling yard를 불러오기 위함.
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetNextYardRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetNextYardRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT ''''||NVL(SUBSTR(MIN(TO_CHAR(B.VPS_ETD_DT,'YYYYMMDDHH24MI')||B.YD_CD ),-7), '')||''''" ).append("\n"); 
