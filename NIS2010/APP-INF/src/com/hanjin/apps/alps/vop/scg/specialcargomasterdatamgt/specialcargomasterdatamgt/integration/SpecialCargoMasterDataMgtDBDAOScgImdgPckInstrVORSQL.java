...
public class SpecialCargoMasterDataMgtDBDAOScgImdgPckInstrVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",   IMDG_PCK_INSTR_SUB_SEQ" ).append("\n"); 
		...
		query.append("AND IMDG_PCK_INSTR_SEQ  = TO_NUMBER(@[imdg_pck_instr_seq])" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("--AND IMDG_PCK_INSTR_SEQ  = 2" ).append("\n"); 
		query.append("AND IMDG_PCK_INSTR_SEQ  = (SELECT MAX(N1ST_IMDG_PCK_INSTR_SEQ) FROM SCG_IMDG_UN_NO)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
