...
*@FileName : SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionPKGMethodRefListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionPKGMethodRefListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionPKGMethodRefListRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOSearchPackingInstructionPKGMethodRefListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,SCG_PCK_REGU_MZD P" ).append("\n"); 
		...
		query.append("   AND P.REGU_DP_NO = @[regu_dp_no]" ).append("\n"); 
		...
		query.append("   AND P.REF_DIV_NO = R.REF_DIV_NO" ).append("\n"); 
