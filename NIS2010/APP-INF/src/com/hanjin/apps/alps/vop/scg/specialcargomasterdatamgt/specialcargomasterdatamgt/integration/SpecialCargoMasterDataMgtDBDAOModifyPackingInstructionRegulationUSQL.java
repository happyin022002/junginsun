...
*@FileName : SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyPackingInstructionRegulation
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOModifyPackingInstructionRegulationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET REGU_MN_DESC = @[regu_mn_desc]" ).append("\n"); 
