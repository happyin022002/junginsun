...
*@FileName : VOP_SCG_0083HTMLAction.java
...
public class VOP_SCG_0083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_AOM_0083HTMLAction 객체를 생성
	 */
	public VOP_SCG_0083HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0083Event event = new VopScg0083Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgNonDgCgoKwVOS((ScgNonDgCgoKwVO[])getVOs(request, ScgNonDgCgoKwVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgNonDgCgoKwVO((ScgNonDgCgoKwVO)getVO(request, ScgNonDgCgoKwVO .class));
		}
