...
*@FileName : ProformaScheduleMgtDBDAOSearchPfSkdEotpDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProformaScheduleMgtDBDAOSearchPfSkdEotpDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Proforma SKD 의 EOTP Detail 정보를 조회합니다.
	  * 
	  * History
	  * 2012.10.24 CHM-201220527-01 진마리아 Departure/Noon Report 데이터를 FCM 데이터와 I/F하도록 변경 요청
	  * </pre>
	  */
	public ProformaScheduleMgtDBDAOSearchPfSkdEotpDetailRSQL(){
		setQuery();
		...
		query.append("FileName : ProformaScheduleMgtDBDAOSearchPfSkdEotpDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                     /** A Port의 Working Hour - (Lane Simulation에서 입력된 Cargo Volume / A Port의 Terminal Productivity+ Port Buffer( Document Hour + Dead Hour))" ).append("\n"); 
		...
		query.append("                                                  VSK_REMOVE_NONE_NUMERIC_FNC(S1.AVG_SPD) AVG_SPD" ).append("\n"); 
		...
		query.append("ORDER BY VSL_CLASS, VVD" ).append("\n"); 
