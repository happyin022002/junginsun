...
*@FileName : PortTariffMgtBCDBDAORemovePsoChgXprByChgNoChgVerTpCdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAORemovePsoChgXprByChgNoChgVerTpCdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSO_CHG_XPR <delete By YD_CHG_NO, YD_CHG_VER_SEQ, PSO_CHG_TP_CD>
	  * </pre>
	  */
	public PortTariffMgtBCDBDAORemovePsoChgXprByChgNoChgVerTpCdDSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAORemovePsoChgXprByChgNoChgVerTpCdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PSO_CHG_XPR A" ).append("\n"); 
