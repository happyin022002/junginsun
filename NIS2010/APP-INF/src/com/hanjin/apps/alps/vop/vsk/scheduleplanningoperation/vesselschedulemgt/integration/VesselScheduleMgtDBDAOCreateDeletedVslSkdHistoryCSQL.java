...
*@FileName : VesselScheduleMgtDBDAOCreateDeletedVslSkdHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCreateDeletedVslSkdHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Deleted VVD 및 Change Port Schedule에 대한 이력관리
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCreateDeletedVslSkdHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCreateDeletedVslSkdHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("					)	" ).append("\n"); 
		query.append("				---------------------------------------------------------------------" ).append("\n"); 
		query.append("				,	'D'						AS VSKD_CNG_TP_CD	/* D : VVD DELETE */" ).append("\n"); 
