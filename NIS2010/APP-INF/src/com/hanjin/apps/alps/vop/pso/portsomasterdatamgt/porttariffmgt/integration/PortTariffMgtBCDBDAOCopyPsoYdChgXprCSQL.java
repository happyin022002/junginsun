...
*@FileName : PortTariffMgtBCDBDAOCopyPsoYdChgXprCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAOCopyPsoYdChgXprCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortTariffMgtBCDBDAOCopyPsoYdChgXprCSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAOCopyPsoYdChgXprCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      (SELECT /*+ INDEX_DESC(Z XPKPSO_YD_CHG_XPR) */ NVL(MAX(Z.YD_CHG_XPR_NO), 0) + 1 YD_CHG_XPR_NO" ).append("\n"); 
		...
		query.append("    AND CHG_XPR_NO     = @[chg_xpr_no]" ).append("\n"); 
