...
*@FileName : OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdCSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : OperationNPerformMasterDataMgtDBDAOOpfStvDmgRsnCdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}