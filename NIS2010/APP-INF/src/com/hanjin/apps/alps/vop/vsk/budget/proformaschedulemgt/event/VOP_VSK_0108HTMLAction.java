...
*@FileName : VOP_VSK_0108HTMLAction.java
 ...
 * @see VopVsk0108Event 참조
 * @since J2EE 1.4
 */

public class VOP_VSK_0108HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0108HTMLAction 객체를 생성
	 */
	public VOP_VSK_0108HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0108Event event = new VopVsk0108Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPfSkdTypeHelpVO((PfSkdTypeHelpVO)getVO(request, PfSkdTypeHelpVO .class));
