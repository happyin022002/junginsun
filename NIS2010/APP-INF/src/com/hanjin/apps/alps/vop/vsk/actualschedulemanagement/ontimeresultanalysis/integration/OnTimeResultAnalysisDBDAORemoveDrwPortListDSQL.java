...
*@FileName : OnTimeResultAnalysisDBDAORemoveDrwPortListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OnTimeResultAnalysisDBDAORemoveDrwPortListDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Drewry Report Port List 삭제 한다.
	  * </pre>
	  */
	public OnTimeResultAnalysisDBDAORemoveDrwPortListDSQL(){
		setQuery();
		...
		query.append("FileName : OnTimeResultAnalysisDBDAORemoveDrwPortListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
