...
*@FileName : PortTimePerformanceMgtDBDAOSearchKPIPortCodeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTimePerformanceMgtDBDAOSearchKPIPortCodeListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 KPI에 속해 있는 Port Code를 조회 한다.
	  * History------------------------------------------------------------------------------------
	  ...
	  * </pre>
	  */
	public PortTimePerformanceMgtDBDAOSearchKPIPortCodeListRSQL(){
		setQuery();
		...
		query.append("FileName : PortTimePerformanceMgtDBDAOSearchKPIPortCodeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
