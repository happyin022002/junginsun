...
*@FileName : VOP_OPF_0047HTMLAction.java
...
public class VOP_OPF_0047HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0047HTMLAction 객체를 생성
	 */
	public VOP_OPF_0047HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0047Event event = new VopOpf0047Event();
        if(command.isCommand(FormCommand.SEARCH)) {
            event.setRDRSummaryVO( (RDRSummaryVO)getVO(request, RDRSummaryVO .class));
