...
public class ProformaScheduleMgtDBDAOSearchRqstSimScnrRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                FROM MDM_VSL_SVC_LANE_DIR T1, VSK_SIM_INFO T2" ).append("\n"); 
		...
		query.append("--	'4000' AS N1ST_VSL_CLSS_CD ," ).append("\n"); 
		query.append("--	'1'	AS N1ST_VSL_CLSS_KNT , " ).append("\n"); 
		...
		query.append("--									WHERE	1		= 1" ).append("\n"); 
		query.append("--									AND		SIM_DT	= '20140721'" ).append("\n"); 
		query.append("--									AND		SIM_NO	= TRIM(TO_CHAR(TO_NUMBER('1'), '000'))" ).append("\n"); 
