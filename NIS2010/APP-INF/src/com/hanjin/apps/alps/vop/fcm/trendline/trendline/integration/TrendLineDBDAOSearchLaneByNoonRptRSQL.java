...
*@FileName : TrendLineDBDAOSearchLaneByNoonRptRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAOSearchLaneByNoonRptRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrendLineDBDAOSearchLaneByNoonRptRSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAOSearchLaneByNoonRptRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("--AND REPLACE(VSL_SLAN_CD,' ','') IS NOT NULL" ).append("\n"); 
