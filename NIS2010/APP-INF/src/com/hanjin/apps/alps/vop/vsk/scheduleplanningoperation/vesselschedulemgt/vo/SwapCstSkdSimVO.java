...
public class SwapCstSkdSimVO extends AbstractValueObject {
	...
	public SwapCstSkdSimVO(String ibflag, String pagerows, String seq, String vslCd, String skdVoyNo, String skdDirCd, String vvd, String vslSlanCd, String skdStsCd, String skdVoyTpCd, String skdUsdIndCd, String pfSkdTpCd, String stPortCd, String n1stPortBrthDt, String psdoVvdCd, String coCd, String skdRmk, String creUsrId, String creDt, String updUsrId, String updDt, String vpsPortCd, String clptIndSeq, String clptSeq, String slanCd, String portSkdStsCd, String ydCd, String tmlCd, String callYdIndSeq, String pfEtaDt, String pfEtbDt, String pfEtdDt, String initEtaDt, String initEtbDt, String initEtdDt, String vpsEtaDt, String vpsEtbDt, String vpsEtdDt, String vslDlayRsnCd, String vslDlayRsnDesc, String vslDlayRsnLocCd, String shpCallNo, String shpCallNoUpdUsrId, String shpCallNoUpdDt, String tmlVslCd, String tmlVoyNo, String ftDt, String plismYdCd, String plismVslCd, String plismVoyNo, String skdCngStsCd, String turnPortFlg, String turnPortIndCd, String turnSkdVoyNo, String turnSkdDirCd, String turnClptIndSeq, String ibCgoQty, String obCgoQty, String vpsRmk, String winRmk, String phsIoRsnCd, String phsIoRmk, String skdBrthNo, String initSkdInpFlg, String ofcInpFlg, String noonRptInpFlg, String depRptInpFlg, String actInpFlg, String prtChkFlg, String ediSndKnt, String portSkpTpCd, String portSkpRsnCd, String portSkpRsnOffrRmk, String ttlDlayHrs, String tsPortCd, String usdFlg, String autoSkdCngFlg, String dlayDateText, String seaDateText, String timeDiff, String delayDate, String etaDelayFlg, String etbDelayFlg, String etdDelayFlg, String updSts, String lnkDist, String lnkSpd, String tztmHrs, String mnvrInHrs, String mnvrOutHrs, String crnKnt, String tmlProdQty, String actWrkHrs, String portBufHrs, String seaBufHrs, String portRotnSeq, String etbDyCd, String etbDyNo, String etbTmHrmnt, String etdDyCd, String etdDyNo, String etdTmHrmnt, String pfSpd, String seaBufSpd, String ibIpcgoQty, String ibOcnCgoQty, String obIpcgoQty, String obOcnCgoQty, String pfSvcTpCd, String vslSimTpCd, String bound, String rtvFlg, String diffRmk, String bnkUnitQty, String bnkUnitAmt, String peUsdTtlAmt, String simDt, String simNo, String cngLaneCd, String cngVslCd, String cngSkdVoyNo, String cngSkdDirCd, String addBnkCsmQty, String addBnkCostAmt, String tmlHndl20ftTtlQty, String tmlHndl40ftTtlQty, String tmlHndl20ftTtlAmt, String tmlHndl40ftTtlAmt, String ts20ftTtlQty, String ts40ftTtlQty, String ts20ftTtlAmt, String ts40ftTtlAmt, String usrHdnFlg, String newClptIndSeq, String bfrActFlg, String addVtPortSeq, String pfLnkDist, String pfLnkSpd, String pfSeaBufHrs, String pfPortBufHrs, String pfTztmHrs, String pfActWrkHrs, String pfMnvrOutHrs, String pfMnvrInHrs, String contiCd, String crrCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("fcm_foc_qty"	,  getFcmFocQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("fcm_foc_qty"	,  "fcmFocQty");
	 ...
	 * @return fcmFocQty
	 */
	public String getFcmFocQty() {
		return this.fcmFocQty;
	}
	...
	public void setFcmFocQty(String fcmFocQty) {
		this.fcmFocQty = fcmFocQty;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEtaDelayFlg(JSPUtil.getParameter(request, "eta_delay_flg", ""));
		...
		setDlayDateText(JSPUtil.getParameter(request, "dlay_date_text", ""));
		...
		setSeaDateText(JSPUtil.getParameter(request, "sea_date_text", ""));
		...
		setEtbDelayFlg(JSPUtil.getParameter(request, "etb_delay_flg", ""));
		...
		setBfrActFlg(JSPUtil.getParameter(request, "bfr_act_flg", ""));
		...
		setPfSpd(JSPUtil.getParameter(request, "pf_spd", ""));
		...
		setRtvFlg(JSPUtil.getParameter(request, "rtv_flg", ""));
		setEtdDelayFlg(JSPUtil.getParameter(request, "etd_delay_flg", ""));
		setPfEtbDt(JSPUtil.getParameter(request, "pf_etb_dt", ""));
		setWinRmk(JSPUtil.getParameter(request, "win_rmk", ""));
		setActInpFlg(JSPUtil.getParameter(request, "act_inp_flg", ""));
		setSkdDirCd(JSPUtil.getParameter(request, "skd_dir_cd", ""));
		setUpdSts(JSPUtil.getParameter(request, "upd_sts", ""));
		...
		setPfLnkDist   (JSPUtil.getParameter(request, "pf_lnk_dist",     ""));
		setPfLnkSpd    (JSPUtil.getParameter(request, "pf_lnk_spd",      ""));
		setPfSeaBufHrs (JSPUtil.getParameter(request, "pf_sea_buf_hrs",  ""));
		setPfPortBufHrs(JSPUtil.getParameter(request, "pf_port_buf_hrs", ""));
		setPfTztmHrs   (JSPUtil.getParameter(request, "pf_tztm_hrs",     ""));
		setPfActWrkHrs (JSPUtil.getParameter(request, "pf_act_wrk_hrs",  ""));
		setPfMnvrOutHrs(JSPUtil.getParameter(request, "pf_mnvr_out_hrs", ""));
		setPfMnvrInHrs (JSPUtil.getParameter(request, "pf_mnvr_in_hrs",  ""));
