...
*@FileName : VOP_FCM_0082HTMLAction.java
...
public class VOP_FCM_0082HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0082HTMLAction 객체를 생성
	 */
	public VOP_FCM_0082HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0082Event event = new VopFcm0082Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			FcmSavItmRgstVO fcmVslCntrItmRgstVO = (FcmSavItmRgstVO)getVO(request, FcmSavItmRgstVO.class);
			 event.setFcmSavItmRgstVO(fcmVslCntrItmRgstVO);
		}else if(command.isCommand(FormCommand.SEARCH01)) {
			FcmSavItmRgstVO fcmVslCntrItmRgstVO = (FcmSavItmRgstVO)getVO(request, FcmSavItmRgstVO.class);
			 event.setFcmSavItmRgstVO(fcmVslCntrItmRgstVO);
		}else if(command.isCommand(FormCommand.MULTI)){
			 event.setFcmSavItmRgstVOs((FcmSavItmRgstVO[])getVOs(request, FcmSavItmRgstVO.class,"sheet2_"));
		}else if(command.isCommand(FormCommand.REMOVE)){
			 event.setFcmSavItmRgstVOs((FcmSavItmRgstVO[])getVOs(request, FcmSavItmRgstVO.class,""));
		}
