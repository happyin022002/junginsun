...
*@FileName : CanalTransitFeeEstimateDBDAOremovePsoCnlTzFeeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CanalTransitFeeEstimateDBDAOremovePsoCnlTzFeeDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CanalTransitFeeEstimateDBDAOremovePsoCnlTzFeeDSQL(){
		setQuery();
		...
		query.append("FileName : CanalTransitFeeEstimateDBDAOremovePsoCnlTzFeeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from pso_cnl_tz_fee" ).append("\n"); 
