...
public class VOP_SCG_0079HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0042HTMLAction 객체를 생성
	 */
	public VOP_SCG_0079HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0079Event event = new VopScg0079Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFileVO((FileVO)getVO(request, FileVO.class));			
		}
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setFileVOs((FileVO[])getVOs(request, FileVO.class,"sheet1_"));
		}
