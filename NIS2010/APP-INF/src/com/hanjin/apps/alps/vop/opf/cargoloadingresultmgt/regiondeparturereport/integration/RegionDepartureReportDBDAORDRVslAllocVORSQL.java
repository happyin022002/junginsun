...
*@FileName : RegionDepartureReportDBDAORDRVslAllocVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORDRVslAllocVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDRVslAllocVO Select Query
	  * </pre>
	  */
	public RegionDepartureReportDBDAORDRVslAllocVORSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORDRVslAllocVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
