...
*@FileName : VOP_VSK_0103HTMLAction.java
 ...
 * @author Maria Chin
 * @see VopVsk0103Event 참조
 * @since J2EE 1.4
 */

public class VOP_VSK_0103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_VSK_0103HTMLAction 객체를 생성
	 */
	public VOP_VSK_0103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0103Event event = new VopVsk0103Event();
...
//			event.setPfSkdVOs(pfSkdVOs);
	...
	@SuppressWarnings("unchecked")
	private VopVsk0103Event makeEvent(HttpServletRequest request){
