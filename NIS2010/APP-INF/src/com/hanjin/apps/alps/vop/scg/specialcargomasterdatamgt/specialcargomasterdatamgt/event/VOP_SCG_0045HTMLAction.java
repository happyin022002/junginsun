...
*@FileName : VMS_SCG_0045HTMLAction.java
...
public class VOP_SCG_0045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0045HTMLAction 객체를 생성
	 */
	public VOP_SCG_0045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0045Event event = new VopScg0045Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgAbbrVOS((ScgImdgAbbrVO[])getVOs(request, ScgImdgAbbrVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgAbbrVO((ScgImdgAbbrVO)getVO(request, ScgImdgAbbrVO .class));
		}
