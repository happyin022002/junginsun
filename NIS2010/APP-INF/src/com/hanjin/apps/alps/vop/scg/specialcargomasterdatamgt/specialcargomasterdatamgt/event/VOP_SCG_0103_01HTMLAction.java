...
public class VOP_SCG_0103_01HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0031HTMLAction 객체를 생성
	 */
	public VOP_SCG_0103_01HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopScg010301Event event = new VopScg010301Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgPckReguVOS((ScgPckReguVO[])getVOs(request, ScgPckReguVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgPckReguVO((ScgPckReguVO)getVO(request, ScgPckReguVO .class));
		}
