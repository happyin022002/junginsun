...
*@FileName : VOP_VSK_0517HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.vop.vsk.vesseloperationsupportmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class VOP_VSK_0517HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0517HTMLAction 객체를 생성
	 */
	public VOP_VSK_0517HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0517Event event = new VopVsk0517Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVosiUpdateMonitoringConditionVO((VosiUpdateMonitoringConditionVO)getVO(request, VosiUpdateMonitoringConditionVO .class));
		}
