...
*@FileName : VOP_PSO_0042HTMLAction.java
*@FileTitle : Regulation/Contract File Upload 화면
*Open Issues :
*Change history :
...
public class VOP_PSO_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0042HTMLAction 객체를 생성
	 */
	public VOP_PSO_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0042Event event = new VopPso0042Event();
		
		FormCommand command = FormCommand.fromRequest(request);
		if(command.isCommand(FormCommand.SEARCH)) {
			PortTariffListVO portTariffListVO = (PortTariffListVO)getVO(request, PortTariffListVO.class);
			event.setPortTariffListVO(portTariffListVO);
		}
