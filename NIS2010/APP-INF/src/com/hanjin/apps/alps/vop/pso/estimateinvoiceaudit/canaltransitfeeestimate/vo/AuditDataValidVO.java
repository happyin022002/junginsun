...
*@FileName : AuditDataValidVO.java
*@FileTitle : AuditDataValidVO
*Open Issues :
*Change history :
...
public class AuditDataValidVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AuditDataValidVO> models = new ArrayList<AuditDataValidVO>();
	 ...
	 * @param request
	 * @return AuditDataValidVO[]
	 */
	public AuditDataValidVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AuditDataValidVO[]
	 */
	public AuditDataValidVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AuditDataValidVO model = null;
	...
	public AuditDataValidVO[] getAuditDataValidVOs(){
		AuditDataValidVO[] vos = (AuditDataValidVO[])models.toArray(new AuditDataValidVO[models.size()]);
		return vos;
	}
