...
public class VOP_PSO_0216HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0216HTMLAction 객체를 생성
	 */
	public VOP_PSO_0216HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0216Event event = new VopPso0216Event();

		if(command.isCommand(FormCommand.SEARCH02)){		//Vendor change
			event.setN3ptyVndrSeq(request.getParameter("n3pty_vndr_seq"));
		}
