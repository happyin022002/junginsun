...
*@FileName : OpfTdrAtchFileVO.java
*@FileTitle : OpfTdrAtchFileVO
*Open Issues :
*Change history :
...
public class OpfTdrAtchFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpfTdrAtchFileVO> models = new ArrayList<OpfTdrAtchFileVO>();
	...
	public OpfTdrAtchFileVO() {}

	public OpfTdrAtchFileVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String vpsPortCd, String clptIndSeq, String cntrHndlKndCd, String cntrNo, String atchFileSeq, String fileNm, String fileSavId, String updUsrId, String updDt, String creUsrId, String creDt, String fileDownload) {
		this.updDt = updDt;
		this.vslCd = vslCd;
...
/**
	 ...
	 */
	public OpfTdrAtchFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpfTdrAtchFileVO[]
	 */
	public OpfTdrAtchFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpfTdrAtchFileVO model = null;
	...
	public OpfTdrAtchFileVO[] getOpfTdrAtchFileVOs(){
		OpfTdrAtchFileVO[] vos = (OpfTdrAtchFileVO[])models.toArray(new OpfTdrAtchFileVO[models.size()]);
		return vos;
	}
