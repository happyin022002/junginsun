...
public class VesselScheduleMgtDBDAOSearchCoaBsaByVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("             WHEN (SEQ = 4) THEN 'Loaded cargo weight' ELSE 'Actual Loadable Weight' END LIFT_TITLE," ).append("\n"); 
		...
		query.append("										AND		V.VSL_CD        = @[wgt_vsl_cd]" ).append("\n"); 
		query.append("										AND     V.SKD_VOY_NO    = @[wgt_skd_voy_no]" ).append("\n"); 
		query.append("										AND     V.SKD_DIR_CD    = @[wgt_skd_dir_cd]" ).append("\n"); 
		...
		query.append("															WHERE   V.VSL_CD        = @[wgt_vsl_cd]" ).append("\n"); 
		query.append("															AND     V.SKD_VOY_NO    = @[wgt_skd_voy_no]" ).append("\n"); 
		query.append("															AND     V.SKD_DIR_CD    = @[wgt_skd_dir_cd]" ).append("\n"); 
		...
		query.append("												,SUM(CASE WHEN @[post_type] = 'DEPARTURE' AND POD = @[wgt_port_cd] THEN 0 ELSE TO_NUMBER(WEIGHT) END) AS WGT" ).append("\n"); 
		query.append("										FROM    BAY_PLAN T11" ).append("\n"); 
		query.append("										WHERE   1 = 1" ).append("\n"); 
		query.append("										AND     VSL_CD  = @[wgt_vsl_cd]" ).append("\n"); 
		query.append("										AND     VOY_NO  = @[wgt_skd_voy_no]" ).append("\n"); 
		query.append("										AND     DIR_CD  = @[wgt_skd_dir_cd]" ).append("\n"); 
		query.append("										AND     PORT_CD = @[wgt_port_cd]" ).append("\n"); 
		query.append("										AND     CALL_IND = @[wgt_clpt_ind_seq]" ).append("\n"); 
