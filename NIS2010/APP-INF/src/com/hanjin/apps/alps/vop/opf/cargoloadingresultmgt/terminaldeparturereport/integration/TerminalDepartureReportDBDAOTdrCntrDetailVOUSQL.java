...
public class TerminalDepartureReportDBDAOTdrCntrDetailVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	POD_ISO = @[pod]" ).append("\n"); 
		query.append(",	POD2_ISO = @[pod2]" ).append("\n"); 
		query.append(",	FPOD = @[fpod]" ).append("\n"); 
		query.append(",   UPD_SYS_CD = 'N'" ).append("\n"); 
		query.append(",   RESPB_CNTR_NO = @[respb_cntr_no]" ).append("\n"); 
		query.append(",   FE   = @[fe]" ).append("\n"); 
		...
		query.append("AND STATUS = @[status] --2014.07.10 [OPF]ALPS 통합 로그 ERROR 복구 작업 상태값 추가" ).append("\n"); 
