...
import com.hanjin.syscommon.common.table.ScgIrrFileListVO;
...
public class VopScg201301Event extends EventSupport {
	...
	public void setScgIrrFileListVOS(ScgIrrFileListVO[] scgIrrFileListVOs){
		if (scgIrrFileListVOs != null) {
			ScgIrrFileListVO[] tmpVOs = new ScgIrrFileListVO[scgIrrFileListVOs.length];
			System.arraycopy(scgIrrFileListVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	public ScgIrrFileListVO[] getScgIrrFileListVOS(){
		...
		if (this.scgIrrFileListVOs != null) {
			rtnVOs = new ScgIrrFileListVO[scgIrrFileListVOs.length];
			System.arraycopy(scgIrrFileListVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
