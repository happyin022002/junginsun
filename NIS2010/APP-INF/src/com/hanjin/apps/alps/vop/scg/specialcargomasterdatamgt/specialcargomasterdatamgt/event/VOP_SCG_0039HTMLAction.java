...
*@FileName : VMS_SCG_0039HTMLAction.java
...
public class VOP_SCG_0039HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0039HTMLAction 객체를 생성
	 */
	public VOP_SCG_0039HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0039Event event = new VopScg0039Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgMrnPolutVOS((ScgImdgMrnPolutVO[])getVOs(request, ScgImdgMrnPolutVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgMrnPolutVO((ScgImdgMrnPolutVO)getVO(request, ScgImdgMrnPolutVO .class));
		}
