...
*@FileName : VOP_SCG_0035HTMLAction.java
...
public class VOP_SCG_0035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0035HTMLAction 객체를 생성
	 */
	public VOP_SCG_0035HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0035Event event = new VopScg0035Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			event.setMdmVslSvcLaneListVOS((MdmVslSvcLaneListVO[])getVOs(request, MdmVslSvcLaneListVO .class, request.getParameter("IBPREFIX"))  );
		}
