...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionSegregationVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionSegregationVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * IMDG_CLSS_CD, IMDG_UN_NO_HLD_FLG 내용을 own BKG에 맞춰 수정함.
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionSegregationVORSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionSegregationVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
