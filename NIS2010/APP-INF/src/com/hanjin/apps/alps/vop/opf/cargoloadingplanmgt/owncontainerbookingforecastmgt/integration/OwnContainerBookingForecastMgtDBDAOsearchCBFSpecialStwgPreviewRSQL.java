...
public class OwnContainerBookingForecastMgtDBDAOsearchCBFSpecialStwgPreviewRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       DECODE(POD,'G.Total','G.Total',SUBSTR(POD,12,2)) AS POD_YD_CD," ).append("\n"); 
		...
		query.append("ORDER BY SEQ, DECODE(POD,'G.Total','ZZZZZ',SUBSTR(POD,1,5)), DECODE(POD,'G.Total','ZZZZZ',SUBSTR(POD,12,2)), DECODE(NVL(MLB,'YYY'),'S.Total','ZZZ',NVL(MLB,'YYY')) ASC" ).append("\n"); 
