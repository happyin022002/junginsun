...
*@FileName : VslSvcLaneforBudgetVO.java
*@FileTitle : VslSvcLaneforBudgetVO
*Open Issues :
*Change history :
...
public class VslSvcLaneforBudgetVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VslSvcLaneforBudgetVO> models = new ArrayList<VslSvcLaneforBudgetVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("chk_use"		, getChkUse		());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("chk_use"		, "chkUse"	);
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setChkUse	(JSPUtil.getParameter(request, "chk_use"		, ""));
	 ...
	 * @param request
	 * @return VslSvcLaneforBudgetVO[]
	 */
	public VslSvcLaneforBudgetVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VslSvcLaneforBudgetVO[]
	 */
	public VslSvcLaneforBudgetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VslSvcLaneforBudgetVO model = null;
		...
		try {
			...
			String[] chkUse 	= (JSPUtil.getParameter(request, prefix	+ "chk_use".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				model = new VslSvcLaneforBudgetVO();
		...
		return getVslSvcLaneforBudgetVOs();
	}
	 ...
	 * @return VslSvcLaneforBudgetVO[]
	 */
	public VslSvcLaneforBudgetVO[] getVslSvcLaneforBudgetVOs(){
		VslSvcLaneforBudgetVO[] vos = (VslSvcLaneforBudgetVO[])models.toArray(new VslSvcLaneforBudgetVO[models.size()]);
		return vos;
	}
