...
public class VopScg0021Event extends EventSupport {
	...
	public RestrictionInputVO[] getRestrictionInputVOS() {
		...
		if (this.restrictionInputVOs != null) {
			rtnVOs = new RestrictionInputVO[restrictionInputVOs.length];
			System.arraycopy(restrictionInputVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setRestrictionInputVO(RestrictionInputVO[] restrictionInputVOs) {
		if (restrictionInputVOs != null) {
			RestrictionInputVO[] tmpVOs = new RestrictionInputVO[restrictionInputVOs.length];
			System.arraycopy(restrictionInputVOs, 0, tmpVOs, 0, tmpVOs.length);
