...
*@FileName : StevedoreDamageMgtDBDAOSearchDamageClaimSendMailUserRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOSearchDamageClaimSendMailUserRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * mail을 보내기 위한 Stevedore Damage Claim Handling User 정보를 조회 합니다.
	  * -------------------------------------------------------------------------------------------
	  ...
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOSearchDamageClaimSendMailUserRSQL(){
		setQuery();
		...
		query.append("FileName : StevedoreDamageMgtDBDAOSearchDamageClaimSendMailUserRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
