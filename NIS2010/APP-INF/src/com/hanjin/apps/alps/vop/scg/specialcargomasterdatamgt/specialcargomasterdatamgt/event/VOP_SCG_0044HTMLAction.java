...
*@FileName : VMS_SCG_0044HTMLAction.java
...
public class VOP_SCG_0044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0044HTMLAction 객체를 생성
	 */
	public VOP_SCG_0044HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0044Event event = new VopScg0044Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgTnkTpVOS((ScgImdgTnkTpVO[])getVOs(request, ScgImdgTnkTpVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgTnkTpVO((ScgImdgTnkTpVO)getVO(request, ScgImdgTnkTpVO .class));
		}
