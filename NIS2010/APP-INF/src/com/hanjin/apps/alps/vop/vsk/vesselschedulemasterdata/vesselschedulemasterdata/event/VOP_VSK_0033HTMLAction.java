...
*@FileName : VOP_VSK_0033HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.nis2010.vop.vsk.vesselschedulemasterdata 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class VOP_VSK_0033HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0033HTMLAction 객체를 생성
	 */
	public VOP_VSK_0033HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0033Event event = new VopVsk0033Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setLocationVOs((LocationVO[])getVOs(request, LocationVO.class, "sheet1_"));
		}
