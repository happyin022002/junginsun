...
*@FileName : PerformanceDBDAOSearchFcmMonFoilSavCostExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PerformanceDBDAOSearchFcmMonFoilSavCostExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PerformanceDBDAOSearchFcmMonFoilSavCostExistRSQL(){
		setQuery();
		...
		query.append("FileName : PerformanceDBDAOSearchFcmMonFoilSavCostExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(*),0,'N','Y') IS_EXIST" ).append("\n"); 
