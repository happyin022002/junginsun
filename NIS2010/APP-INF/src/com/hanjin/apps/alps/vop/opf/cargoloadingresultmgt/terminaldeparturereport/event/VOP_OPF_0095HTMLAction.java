...
*@FileName : VOP_OPF_0095HTMLAction.java
...
public class VOP_OPF_0095HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0095HTMLAction 객체를 생성
	 */
	public VOP_OPF_0095HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0095Event event = new VopOpf0095Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMissingTDRCondVO((MissingTDRCondVO)getVO(request, MissingTDRCondVO .class));
