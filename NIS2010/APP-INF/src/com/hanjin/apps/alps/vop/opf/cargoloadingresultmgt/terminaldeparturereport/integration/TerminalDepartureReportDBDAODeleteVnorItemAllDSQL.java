...
*@FileName : TerminalDepartureReportDBDAODeleteVnorItemAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAODeleteVnorItemAllDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAODeleteVnorItemAllDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAODeleteVnorItemAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM OPF_VNOR_ITM" ).append("\n"); 
