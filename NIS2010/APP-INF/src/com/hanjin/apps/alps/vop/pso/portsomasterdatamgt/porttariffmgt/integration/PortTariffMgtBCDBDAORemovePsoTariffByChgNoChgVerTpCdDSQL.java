...
*@FileName : PortTariffMgtBCDBDAORemovePsoTariffByChgNoChgVerTpCdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAORemovePsoTariffByChgNoChgVerTpCdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSO_TARIFF <delete By YD_CHG_NO, YD_CHG_VER_SEQ, PSO_CHG_TP_CD>
	  * </pre>
	  */
	public PortTariffMgtBCDBDAORemovePsoTariffByChgNoChgVerTpCdDSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAORemovePsoTariffByChgNoChgVerTpCdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PSO_TARIFF A" ).append("\n"); 
		query.append("WHERE  1=1" ).append("\n"); 
		query.append("AND    (A.CHG_XPR_NO, A.CHG_XPR_SEQ) IN (" ).append("\n"); 
		query.append("SELECT C.CHG_XPR_NO" ).append("\n"); 
		query.append(",D.CHG_XPR_SEQ" ).append("\n"); 
