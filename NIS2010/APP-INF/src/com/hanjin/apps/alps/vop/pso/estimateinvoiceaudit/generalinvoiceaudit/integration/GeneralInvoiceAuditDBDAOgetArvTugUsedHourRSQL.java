...
*@FileName : GeneralInvoiceAuditDBDAOgetArvTugUsedHourRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetArvTugUsedHourRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetArvTugUsedHourRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetArvTugUsedHourRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
