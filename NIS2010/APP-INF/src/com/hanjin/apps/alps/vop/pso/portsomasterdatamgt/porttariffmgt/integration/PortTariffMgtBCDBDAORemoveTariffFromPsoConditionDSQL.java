...
*@FileName : PortTariffMgtBCDBDAORemoveTariffFromPsoConditionDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAORemoveTariffFromPsoConditionDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSO_CONDITION 에서 Tariff 정보를 삭제한다.
	  * </pre>
	  */
	public PortTariffMgtBCDBDAORemoveTariffFromPsoConditionDSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAORemoveTariffFromPsoConditionDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PSO_CONDITION " ).append("\n"); 
		query.append(" WHERE COND_NO IN (" ).append("\n"); 
