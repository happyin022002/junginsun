...
*@FileName : VOP_VSK_0232HTMLAction.java
...
public class VOP_VSK_0232HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0232HTMLAction 객체를 생성
	 */
	public VOP_VSK_0232HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0232Event event = new VopVsk0232Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setResultRemarkVO((ResultRemarkVO)getVO(request, ResultRemarkVO.class));
		}
