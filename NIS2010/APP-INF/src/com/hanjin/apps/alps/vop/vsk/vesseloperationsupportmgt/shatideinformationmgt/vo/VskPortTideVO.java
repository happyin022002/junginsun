...
package com.hanjin.apps.alps.vop.vsk.vesseloperationsupportmgt.shatideinformationmgt.vo;
...
public class VskPortTideVO extends AbstractValueObject {
	...
	/* Column Info */
	private String dispTideDy = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tide_yr_mon", getTideYrMon());
		...
		this.hashColumns.put("disp_tide_dy", getDispTideDy());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tide_yr_mon", "tideYrMon");
		...
		this.hashFields.put("disp_tide_dy", "dispTideDy");
	 ...
	 * @return tideYrMon
	 */
	public String getTideYrMon() {
		return this.tideYrMon;
	}
	 ...
	 * @return dispTideDy
	 */
	public String getDispTideDy() {
		return this.dispTideDy;
	}
	 ...
	 * @param tideYrMon
	 */
	public void setTideYrMon(String tideYrMon) {
		this.tideYrMon = tideYrMon;
	}
	 ...
	 * @param dispTideDy
	 */
	public void setDispTideDy(String dispTideDy) {
		this.dispTideDy = dispTideDy;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTideYrMon(JSPUtil.getParameter(request, "tide_yr_mon", ""));
		...
		setDispTideDy(JSPUtil.getParameter(request, "disp_tide_dy", ""));
	...
	public VskPortTideVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] tideYr = (JSPUtil.getParameter(request, prefix	+ "tide_yr", length));
			String[] tideYrMon = (JSPUtil.getParameter(request, prefix	+ "tide_yr_mon", length));
			String[] n2ndFmTideHrmnt = (JSPUtil.getParameter(request, prefix	+ "n2nd_fm_tide_hrmnt", length));
			String[] creDt = (JSPUtil.getParameter(request, prefix	+ "cre_dt", length));
			String[] n1stTideToHrmnt = (JSPUtil.getParameter(request, prefix	+ "n1st_tide_to_hrmnt", length));
			String[] n1stHighTideHgt = (JSPUtil.getParameter(request, prefix	+ "n1st_high_tide_hgt", length));
			String[] n1stLowTideHgt = (JSPUtil.getParameter(request, prefix	+ "n1st_low_tide_hgt", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			String[] n1stTideFmHrmnt = (JSPUtil.getParameter(request, prefix	+ "n1st_tide_fm_hrmnt", length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] locCd = (JSPUtil.getParameter(request, prefix	+ "loc_cd", length));
			String[] tideMon = (JSPUtil.getParameter(request, prefix	+ "tide_mon", length));
			String[] n2ndToTideHrmnt = (JSPUtil.getParameter(request, prefix	+ "n2nd_to_tide_hrmnt", length));
			String[] dispTideDy = (JSPUtil.getParameter(request, prefix	+ "disp_tide_dy", length));
			String[] tideDy = (JSPUtil.getParameter(request, prefix	+ "tide_dy", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] n2ndLowTideHgt = (JSPUtil.getParameter(request, prefix	+ "n2nd_low_tide_hgt", length));
			String[] n2ndHighTideHgt = (JSPUtil.getParameter(request, prefix	+ "n2nd_high_tide_hgt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (tideYrMon[i] != null)
					model.setTideYrMon(tideYrMon[i]);
				...
				if (dispTideDy[i] != null)
					model.setDispTideDy(dispTideDy[i]);
				if (tideDy[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.tideYrMon = this.tideYrMon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.dispTideDy = this.dispTideDy .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
