...
public class OwnContainerBookingForecastMgtDBDAOCBFInquirySummaryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * 2011.06.27 Ticket ID : [CHM-201111635-01]
	  * 개발자 : 이준범
	  ...
	  * 2014.08.12 HJSBIZ_CR_787  CBF-Inquiry grand total 소팅 - P.SEQ 가 널일때 999하드코딩
	  * </pre>
	  */
	...
	public void setQuery(){
		...
		query.append("     , SUBSTR(POD,12,2) AS POD_YD_CD" ).append("\n"); 
		...
		query.append("     , NVL(P.SEQ, 999) SEQ" ).append("\n"); 
		query.append("FROM   ( SELECT (POD||POD_CLPT_IND_SEQ||POD_YD_CD) AS POD, MLB, DECODE(NVL(SORT,0),0,NULL,MAX(FM)) FM, WG, MAX(WSEQ) WSEQ," ).append("\n"); 
		query.append("                GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD) P, GROUPING(MLB) M, GROUPING(SORT) S, GROUPING(WG) W," ).append("\n"); 
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD)=0 AND GROUPING(MLB)=0 AND GROUPING(SORT)=0 AND GROUPING(WG)=0 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD)=0 AND GROUPING(MLB)=0 AND GROUPING(SORT)=0 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD)=0 AND GROUPING(MLB)=1 AND GROUPING(SORT)=1 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD)=0 AND GROUPING(MLB)=0 AND GROUPING(SORT)=1 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD)=0 AND GROUPING(MLB)=1 AND GROUPING(SORT)=0 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ||POD_YD_CD)=0 AND GROUPING(MLB)=1 AND GROUPING(SORT)=0 AND GROUPING(WG)=0 THEN 1" ).append("\n"); 
		...
		query.append("         FROM ( SELECT DISTINCT O.POD POD, O.POD_CLPT_IND_SEQ, O.POD_YD_CD, O.MLB, O.FM FM, O.WG WG, O.WSEQ WSEQ," ).append("\n"); 
		...
		query.append("                FROM   ( SELECT POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, FM, SORT, WG, WSEQ," ).append("\n"); 
		...
		query.append("                                       SUM(DECODE(SUBSTR(TP,2,1),'5',DECODE(OWNR,'Y',1,CNTR_QTY),CASE WHEN TP IN ('R8', 'R9') THEN DECODE(OWNR,'Y',1,CNTR_QTY) ELSE 0 END)) FHQTY," ).append("\n"); 
		...
		query.append("                                GROUP BY POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, FM, WG, WSEQ, OPR )," ).append("\n"); 
		query.append("                                DUMY AS" ).append("\n"); 
		query.append("                                ( SELECT 'F' FM FROM DUAL" ).append("\n"); 
		query.append("                                  UNION ALL" ).append("\n"); 
		query.append("                                  SELECT 'E' FM FROM DUAL )" ).append("\n"); 
		query.append("                                SELECT S1.POD, S1.POD_CLPT_IND_SEQ, S1.POD_YD_CD, S1.MLB, S1.FM, DECODE(S1.FM,'F',1,2) SORT, S2.WG, S2.WSEQ, S1.OPR," ).append("\n"); 
		...
		query.append("                                FROM   ( SELECT POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, FM, OPR" ).append("\n"); 
		query.append("                                         FROM   ( SELECT DISTINCT POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, OPR" ).append("\n"); 
		...
		query.append("                                AND   NVL(S1.POD_YD_CD,'N') = NVL(S2.POD_YD_CD(+),'N')" ).append("\n"); 
		...
		query.append("                         GROUP BY SORT, POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, FM, WG, WSEQ ) O," ).append("\n"); 
		...
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'5',DECODE(OWNR,'Y',1,CNTR_QTY),CASE WHEN TP IN ('R8', 'R9') THEN DECODE(OWNR,'Y',1,CNTR_QTY) ELSE 0 END)) FHQTY," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'5',CNTR_GRS_WGT,CASE WHEN TP IN ('R8', 'R9') THEN CNTR_GRS_WGT ELSE 0 END))  FHWGT," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'7',DECODE(OWNR,'Y',1,CNTR_QTY),0)) SQTY," ).append("\n"); 
		...
		query.append("                                         END  >=1 )" ).append("\n"); 
		query.append("                         WHERE CNTR_RN = 1" ).append("\n"); 
		query.append("                         GROUP BY POD, POD_CLPT_IND_SEQ, POD_YD_CD,  MLB, FM, WG, WSEQ )," ).append("\n"); 
		query.append("                         DUMY AS" ).append("\n"); 
		query.append("                         ( SELECT 'F' FM FROM DUAL" ).append("\n"); 
		query.append("                           UNION ALL" ).append("\n"); 
		query.append("                           SELECT 'E' FM FROM DUAL )" ).append("\n"); 
		query.append("                         SELECT S1.POD, S1.POD_CLPT_IND_SEQ, S1.POD_YD_CD, S1.MLB, S1.FM, DECODE(S1.FM,'F',1,2) SORT, S2.WG, S2.WSEQ," ).append("\n"); 
		...
		query.append("                         FROM   ( SELECT POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, FM" ).append("\n"); 
		query.append("                                  FROM   ( SELECT DISTINCT POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB" ).append("\n"); 
		query.append("                                           FROM S ) S, DUMY ) S1, S S2" ).append("\n"); 
		query.append("                         WHERE S1.POD              = S2.POD(+)" ).append("\n"); 
		query.append("                         AND   S1.POD_CLPT_IND_SEQ = S2.POD_CLPT_IND_SEQ(+)" ).append("\n"); 
		query.append("                         AND   NVL(S1.POD_YD_CD,'N') = NVL(S2.POD_YD_CD(+),'N')" ).append("\n"); 
		...
		query.append("                AND    NVL(O.POD_YD_CD,'N') = NVL(T.POD_YD_CD,'N')" ).append("\n"); 
		...
		query.append("         GROUP BY CUBE(POD||POD_CLPT_IND_SEQ||POD_YD_CD, MLB, SORT, WG) ) A, " ).append("\n"); 
		...
		query.append("     , NVL(SUBSTR(POD,12,2),'') POD_YD_CD" ).append("\n"); 
		query.append("     , MLB" ).append("\n"); 
		...
		query.append("                                       END  >=1 )" ).append("\n"); 
		query.append("                                WHERE CNTR_RN = 1" ).append("\n"); 
		query.append("                                GROUP BY POD, POD_CLPT_IND_SEQ, POD_YD_CD, MLB, FM, WG, OPR, WSEQ )," ).append("\n"); 
		query.append("                                DUMY AS" ).append("\n"); 
		query.append("                                ( SELECT 'F' FM FROM DUAL" ).append("\n"); 
		query.append("                                  UNION ALL" ).append("\n"); 
		query.append("                                  SELECT 'E' FM FROM DUAL )" ).append("\n"); 
		...
		query.append("WHERE NVL(C4,0) = 1" ).append("\n"); 
		query.append(" )" ).append("\n"); 
		query.append("ORDER BY SEQ, DECODE(POD,'Grand Total','ZZZZZ',POD),  DECODE(POD_YD_CD,'','ZZZZZ',POD_YD_CD), NVL(MLB,'ZZZ')," ).append("\n"); 
