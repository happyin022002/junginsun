...
*@FileName : VOP_SCG_0012HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.vop.scg.vesseloperationirregularmgt 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class VOP_SCG_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0012HTMLAction 객체를 생성
	 */
	public VOP_SCG_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0012Event event = new VopScg0012Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setIrregularsVO((IrregularsVO)getVO(request, IrregularsVO .class));
		...
		event.setAttribute("pImdg_un_no", JSPUtil.getParameter(request, "pImdg_un_no", "") );
