...
public class OwnDangerousCargoApprovalDBDAOOwnApprovalRequestVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("FROM TABLE(SCG_MAIL_INFO_FNC(@[crr_cd],@[bkg_ref_no],@[spcl_cgo_rqst_seq],@[bkg_no],@[spcl_cgo_apro_rqst_seq],@[vsl_pre_pst_cd],@[vsl_seq],@[rgn_shp_opr_cd],@[scg_flg],@[send_type],@[user_id])) M" ).append("\n"); 
