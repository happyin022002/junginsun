...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtRfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtRfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PARTNER CLL의 REFEER 수신
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtRfCSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFIFPartnerIfBkgDtRfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       AND Y.RC_FLG     = 'Y'" ).append("\n"); 
