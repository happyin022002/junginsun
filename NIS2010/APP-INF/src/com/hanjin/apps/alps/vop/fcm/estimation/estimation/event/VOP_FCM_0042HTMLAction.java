...
*@FileName : VOP_FCM_0042HTMLAction.java
*@FileTitle : Monthly Estimation Expense Creation
*Open Issues :
*Change history :
...
public class VOP_FCM_0042HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_FCM_0042HTMLAction 객체를 생성
	 */
	public VOP_FCM_0042HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0042Event event = new VopFcm0042Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setFcmEstmWkCsmIfVO((FcmEstmWkCsmIfVO)getVO(request, FcmEstmWkCsmIfVO .class));	
		}
