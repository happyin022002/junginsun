...
*@FileName : SpecialCargoIrregularMgtDBDAOIrregularVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoIrregularMgtDBDAOIrregularVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoIrregularMgtDBDAOIrregularVODSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoIrregularMgtDBDAOIrregularVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IRREGULAR" ).append("\n"); 
