...
*@FileName : EstimationDBDAOMonEstmCsmVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EstimationDBDAOMonEstmCsmVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EstimationDBDAOMonEstmCsmVOCSQL(){
		setQuery();
		...
		params.put("mon_end_csm_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("act_end_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("tmp_end_port_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bod_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("estm_mon_csm_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("err_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bor_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("tmp_st_port_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("estm_sea_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pre_vvd_invt_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("voy_end_rmn_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("voy_port_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("voy_sea_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pre_estm_vvd_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("tmp_st_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("tmp_end_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("estm_port_dys",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("po_rcv_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("mon_bgn_invt_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("act_st_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("act_st_port_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("itm_err_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("voy_end_csm_wgt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("mon_end_rmn_wgt",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.vop.fcm.estimation.estimation.integration").append("\n"); 
		query.append("FileName : EstimationDBDAOMonEstmCsmVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO FCM_ESTM_MON_CSM VALUES(" ).append("\n"); 
