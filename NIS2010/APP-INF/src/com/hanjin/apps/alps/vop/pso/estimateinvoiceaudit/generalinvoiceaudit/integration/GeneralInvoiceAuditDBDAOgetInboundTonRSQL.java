...
*@FileName : GeneralInvoiceAuditDBDAOgetInboundTonRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetInboundTonRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetInboundTonRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetInboundTonRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
