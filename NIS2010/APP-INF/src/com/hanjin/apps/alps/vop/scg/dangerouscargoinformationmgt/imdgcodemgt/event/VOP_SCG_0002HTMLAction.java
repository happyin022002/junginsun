...
*@FileName : VOP_SCG_0002HTMLAction.java
...
public class VOP_SCG_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0002HTMLAction 객체를 생성
	 */
	public VOP_SCG_0002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0002Event event = new VopScg0002Event();
