...
/**
 * VOP_VSK_0014 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  VOP_VSK_0014HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Jung Jinwoo
 * @see VOP_VSK_0014HTMLAction 참조
 * @since J2EE 1.5
 */
public class VopVsk0014Event extends EventSupport {
