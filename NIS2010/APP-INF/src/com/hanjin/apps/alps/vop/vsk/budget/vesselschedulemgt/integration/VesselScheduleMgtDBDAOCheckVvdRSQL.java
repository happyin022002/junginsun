...
*@FileName : VesselScheduleMgtDBDAOCheckVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCheckVvdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCheckVvdRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCheckVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
