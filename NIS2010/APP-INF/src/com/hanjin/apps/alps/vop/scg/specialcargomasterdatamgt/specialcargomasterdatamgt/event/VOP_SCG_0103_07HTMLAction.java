...
public class VOP_SCG_0103_07HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0031HTMLAction 객체를 생성
	 */
	public VOP_SCG_0103_07HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopScg010307Event event = new VopScg010307Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgPckPtbTnkVOS((ScgPckPtbTnkVO[])getVOs(request, ScgPckPtbTnkVO .class,"t1_"));
			event.setScgPckPtbTnk2VOS((ScgPckPtbTnkVO[])getVOs(request, ScgPckPtbTnkVO .class,"t23_"));
			event.setScgPckPtbTnk3VOS((ScgPckPtbTnkVO[])getVOs(request, ScgPckPtbTnkVO .class,"t50_"));
			event.setScgPckRefVOS((ScgPckRefVO[])getVOs(request, ScgPckRefVO .class,"scgPckRef_"));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgPckPtbTnkVO((ScgPckPtbTnkVO)getVO(request, ScgPckPtbTnkVO .class));
			event.setScgPckRefVO((ScgPckRefVO)getVO(request, ScgPckRefVO .class));
		}
