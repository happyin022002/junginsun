...
*@FileName : VesselReportDBDAOVslRptInqVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselReportDBDAOVslRptInqVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VesselReportDBDAOVslRptInqVORSQL(){
		setQuery();
		...
		query.append("FileName : VesselReportDBDAOVslRptInqVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${ibflag} == '1') " ).append("\n"); 
		query.append("T1.VSL_SLAN_CD" ).append("\n"); 
		query.append("#elseif (${ibflag} == '2') " ).append("\n"); 
		query.append("T1.VSL_CD" ).append("\n"); 
		query.append("#elseif (${ibflag} == '3') " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${ibflag} == '1') " ).append("\n"); 
		query.append("GROUP BY T1.VSL_SLAN_CD ORDER BY T1.VSL_SLAN_CD	" ).append("\n"); 
		query.append("#elseif (${ibflag} == '2') " ).append("\n"); 
		query.append("GROUP BY T1.VSL_CD ORDER BY T1.VSL_CD" ).append("\n"); 
		query.append("#elseif (${ibflag} == '3') " ).append("\n"); 
		query.append("GROUP BY T2.VPS_PORT_CD ORDER BY T2.VPS_PORT_CD" ).append("\n"); 
		query.append("#else " ).append("\n"); 
		query.append("#end" ).append("\n"); 
