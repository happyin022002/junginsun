...
*@FileName : ScgImdgClssSegrListVO.java
*@FileTitle : ScgImdgClssSegrListVO
*Open Issues :
*Change history :
...
public class ScgImdgClssSegrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgImdgClssSegrListVO> models = new ArrayList<ScgImdgClssSegrListVO>();
	...
	public ScgImdgClssSegrListVO() {}

	public ScgImdgClssSegrListVO(String ibflag, String pagerows, String rowImdgClssCd, String clssCd11, String clssCd12, String clssCd15, String clssCd13, String clssCd16, String clssCd14, String clssCd21, String clssCd22, String clssCd23, String clssCd3, String clssCd41, String clssCd42, String clssCd43, String clssCd51, String clssCd52, String clssCd61, String clssCd62, String clssCd7, String clssCd8, String clssCd9) {
	 ...
	 */
	public ScgImdgClssSegrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgImdgClssSegrListVO[]
	 */
	public ScgImdgClssSegrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgImdgClssSegrListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ScgImdgClssSegrListVO();
				if (clssCd11[i] != null)
		...
		return getScgImdgClssSegrListVOs();
	}
	...
	public ScgImdgClssSegrListVO[] getScgImdgClssSegrListVOs(){
		ScgImdgClssSegrListVO[] vos = (ScgImdgClssSegrListVO[])models.toArray(new ScgImdgClssSegrListVO[models.size()]);
		return vos;
	}
