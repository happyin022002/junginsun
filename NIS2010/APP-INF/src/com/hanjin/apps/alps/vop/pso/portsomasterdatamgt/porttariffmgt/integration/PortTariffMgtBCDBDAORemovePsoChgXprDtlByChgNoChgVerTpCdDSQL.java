...
*@FileName : PortTariffMgtBCDBDAORemovePsoChgXprDtlByChgNoChgVerTpCdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAORemovePsoChgXprDtlByChgNoChgVerTpCdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PSO_CHG_XPR_DTL <delete By YD_CHG_NO, YD_CHG_VER_SEQ, PSO_CHG_TP_CD>
	  * </pre>
	  */
	public PortTariffMgtBCDBDAORemovePsoChgXprDtlByChgNoChgVerTpCdDSQL(){
		setQuery();
		...
		query.append("FileName : PortTariffMgtBCDBDAORemovePsoChgXprDtlByChgNoChgVerTpCdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE PSO_CHG_XPR_DTL A" ).append("\n"); 
		query.append("WHERE  1=1" ).append("\n"); 
		query.append("AND    A.CHG_XPR_NO IN (" ).append("\n"); 
