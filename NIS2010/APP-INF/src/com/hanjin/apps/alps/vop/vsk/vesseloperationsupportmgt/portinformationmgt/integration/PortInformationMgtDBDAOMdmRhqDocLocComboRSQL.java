...
*@FileName : PortInformationMgtDBDAOMdmRhqDocLocComboRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortInformationMgtDBDAOMdmRhqDocLocComboRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortInformationMgtDBDAOMdmRhqDocLocComboRSQL(){
		setQuery();
		...
		query.append("FileName : PortInformationMgtDBDAOMdmRhqDocLocComboRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND LOC_CD NOT IN (" ).append("\n"); 
		query.append("SELECT " ).append("\n"); 
