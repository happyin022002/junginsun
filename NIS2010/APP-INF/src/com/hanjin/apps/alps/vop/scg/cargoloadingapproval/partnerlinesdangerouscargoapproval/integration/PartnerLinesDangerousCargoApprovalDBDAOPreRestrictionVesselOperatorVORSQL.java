...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionVesselOperatorVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionVesselOperatorVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionVesselOperatorVORSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOPreRestrictionVesselOperatorVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
