...
public class YardChargeVO extends AbstractValueObject {
	...
	/* Column Info */
	private String ydChgMaxSeq = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("yd_chg_max_seq", getYdChgMaxSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("yd_chg_max_seq", "ydChgMaxSeq");
	 ...
	 * @return ydChgMaxSeq
	 */
	public String getYdChgMaxSeq() {
		return this.ydChgMaxSeq;
	}
	 ...
	 * @param ydChgMaxSeq
	 */
	public void setYdChgMaxSeq(String ydChgMaxSeq) {
		this.ydChgMaxSeq = ydChgMaxSeq;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setYdChgMaxSeq(JSPUtil.getParameter(request, "yd_chg_max_seq", ""));
	}
	...
	public YardChargeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ydChgMaxSeq = (JSPUtil.getParameter(request, prefix	+ "yd_chg_max_seq", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ydChgMaxSeq[i] != null)
					model.setYdChgVerSeq(ydChgMaxSeq[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.ydChgMaxSeq = this.ydChgMaxSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
