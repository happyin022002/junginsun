...
*@FileName : VesselScheduleMgtDBDAONextCallingPortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAONextCallingPortRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VesselScheduleMgtDBDAONextCallingPortRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAONextCallingPortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("					   AND SKD_VOY_NO = @[skd_voy_no]" ).append("\n"); 
		query.append("					   AND SKD_DIR_CD = @[skd_dir_cd]" ).append("\n"); 
		query.append("					   AND TURN_PORT_IND_CD IN ('V', 'D', 'F')" ).append("\n"); 
