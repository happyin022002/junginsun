...
*@FileName : TerminalDepartureReportDBDAOLoadImportBreakVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOLoadImportBreakVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOLoadImportBreakVORSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOLoadImportBreakVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT V.POD_CD AS POD" ).append("\n"); 
		...
		query.append("   ,   ROUND(SUM(DECODE(K.WGT_UT_CD,'KGS',K.GRS_WGT,'LBS',K.GRS_WGT*0.453599,K.GRS_WGT))/1000,1) AS WEIGHT" ).append("\n"); 
		...
		query.append("GROUP BY V.POD_CD, C.CNTR_NO" ).append("\n"); 
