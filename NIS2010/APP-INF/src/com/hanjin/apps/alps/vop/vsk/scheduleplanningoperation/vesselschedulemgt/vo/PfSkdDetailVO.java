...
*@FileName : PfSkdDetailVO.java
*@FileTitle : PfSkdDetailVO
*Open Issues :
*Change history :
...
public class PfSkdDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PfSkdDetailVO> models = new ArrayList<PfSkdDetailVO>();
	 ...
	 */
	public PfSkdDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PfSkdDetailVO[]
	 */
	public PfSkdDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PfSkdDetailVO model = null;
	 ...
	 * @return PfSkdDetailVO[]
	 */
	public PfSkdDetailVO[] getPfSkdDetailVOs(){
		PfSkdDetailVO[] vos = (PfSkdDetailVO[])models.toArray(new PfSkdDetailVO[models.size()]);
		return vos;
	}
	...
	*/
	...
	/**
	 * 비교하고자 하는 PfSkdDetailVO 객체와 Vessel Lane Code와 P/F Service Type이 동일하는지 확인한다.<br>
	 * 
	 * @param PfSkdDetailVO other
	 * @return boolean
	 */
	public boolean isSameType(PfSkdDetailVO other){
		if(this.vslSlanCd.equals(other.getVslSlanCd()) && this.pfSvcTpCd.equals(other.getPfSvcTpCd())){
			return true;
		}else{
			return false;
		}
