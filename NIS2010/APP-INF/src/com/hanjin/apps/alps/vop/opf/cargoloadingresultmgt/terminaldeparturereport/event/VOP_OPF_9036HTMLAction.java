...
*@FileName : VOP_OPF_9036HTMLAction.java
...
public class VOP_OPF_9036HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_9036HTMLAction 객체를 생성
	 */
	public VOP_OPF_9036HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf9036Event event = new VopOpf9036Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			OpfTdrAtchFileVO[] opfTdrAtchFileVOs = (OpfTdrAtchFileVO[]) getVOs(request, OpfTdrAtchFileVO.class);
			...
			if (saveIdList != null && opfTdrAtchFileVOs != null) {
				...
				for (int i = 0; i < opfTdrAtchFileVOs.length; i++) {
					OpfTdrAtchFileVO vo = opfTdrAtchFileVOs[i];
			...
			event.setOpfTdrAtchFileVO((OpfTdrAtchFileVO)getVO(request, OpfTdrAtchFileVO .class));
		}
