...
*@FileName : VopVskSpp0006Event.java
*@FileTitle : ETA sending (Auto-fax) Inquiry
*Open Issues :
*Change history :
...
public class VopVskSPPVSK0006Event extends EventSupport {
