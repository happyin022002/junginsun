...
*@FileName : GeneralInvoiceAuditDBDAOgetYearlyVesselCallPortUsRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetYearlyVesselCallPortUsRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 년동안 해당 vessel이  미국내 port에 calling하는 횟수
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetYearlyVesselCallPortUsRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetYearlyVesselCallPortUsRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
