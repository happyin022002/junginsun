...
public class OwnDangerousCargoApprovalDBDAOPreRestrictionPortVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    		 , ROW_NUMBER() OVER(PARTITION BY ST.PORT_TYPE, ST.PORT_CD ORDER BY ST.ORDER_NUM1, ST.ORDER_NUM2, DECODE(NVL(ST.IMDG_CMPTN_AUTH_DESC,''),'Prohibition',0,'',1,2)) AS NUM" ).append("\n"); 
