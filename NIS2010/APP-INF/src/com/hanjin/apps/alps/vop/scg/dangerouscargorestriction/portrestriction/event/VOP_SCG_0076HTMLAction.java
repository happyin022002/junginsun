...
*@FileName : VOP_SCG_0076HTMLAction.java
...
public class VOP_SCG_0076HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0076HTMLAction 객체를 생성
	 */
	public VOP_SCG_0076HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0076Event event = new VopScg0076Event();

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setPortRestrictonOptionVO( (PortRestrictonOptionVO)getVO(request, PortRestrictonOptionVO .class));
