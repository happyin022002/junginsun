...
public class VslSkdChgStsGRPVO {
	...
	private List<VslSkdCngUpdateVO> vslSkdEtaDelayNoticeVOs = null;
	...
	private List<String> reversedPortInfos = null;

	
	/****************************************************************
	 * 운항스케쥴 이력관리를 위한 VO,HashMap추가 ::2013-08-28::
	 */
	private List<VskVslSkdVO>				vskVslSkdVOs			= null;
	//private List<VskVslSkdVO>				updateList				= null;
	
	private Map<String, List<VskVslSkdVO>>	hmVskVslSkdVOs			= null;
	private VslSkdCngHistGroupVO			vslSkdCngHistGroupVO	= null;
	 ...
	 */
/*	public List<VskVslSkdVO> getUpdateList() {
		return updateList;
	}*/
	...
	/**
	 * @return the vslSkdEtaDelayNoticeVOs
	 */
	public List<VslSkdCngUpdateVO> getVslSkdEtaDelayNoticeVOs() {
		return vslSkdEtaDelayNoticeVOs;
	}
	
	/**
	 * @return the hmVskVslSkdVOs
	 */
	public Map<String, List<VskVslSkdVO>> getHmVskVslSkdVOs() {
		return hmVskVslSkdVOs;
	}
	
	/**
	 * @return the vslSkdCngHistGroupVO
	 */
	public VslSkdCngHistGroupVO getVslSkdCngHistGroupVO() {
		return vslSkdCngHistGroupVO;
	}
	...
	/**
	 * @param vslSkdEtaDelayNoticeVOs the vslSkdEtaDelayNoticeVOs to set
	 */
	public void setVslSkdEtaDelayNoticeVOs(List<VslSkdCngUpdateVO> vslSkdEtaDelayNoticeVOs) {
		this.vslSkdEtaDelayNoticeVOs = vslSkdEtaDelayNoticeVOs;
	}
	 ...
	 */
/*	public void setUpdateList(List<VskVslSkdVO> updateList) {
	 ...
	 * @return the hmVskVslSkdVOs
	 */
	public void setHmVskVslSkdVOs(Map<String, List<VskVslSkdVO>> hmVskVslSkdVOs) {
		this.hmVskVslSkdVOs	= hmVskVslSkdVOs;
	}
	
	/**
	 * @return the vslSkdCngHistGroupVO
	 */
	public void setVslSkdCngHistGroupVO(VslSkdCngHistGroupVO vslSkdCngHistGroupVO) {
		this.vslSkdCngHistGroupVO	= vslSkdCngHistGroupVO;
	}
	...
	/**
	 * @return the reversedPortInfos
	 */
	public List<String> getReversedPortInfos() {
		return reversedPortInfos;
	}

	/**
	 * @param reversedPortInfos the reversedPortInfos to set
	 */
	public void setReversedPortInfos(List<String> reversedPortInfos) {
		this.reversedPortInfos = reversedPortInfos;
	}
