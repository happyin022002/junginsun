...
*@FileName : CcdCommonDBDAOSearchVesselContainerIfRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CcdCommonDBDAOSearchVesselContainerIfRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Vessel Container Interface 정보를 조회합니다.
	  * </pre>
	  */
	public CcdCommonDBDAOSearchVesselContainerIfRSQL(){
		setQuery();
		...
		query.append("FileName : CcdCommonDBDAOSearchVesselContainerIfRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT BLST_TNK_CAPA" ).append("\n"); 
