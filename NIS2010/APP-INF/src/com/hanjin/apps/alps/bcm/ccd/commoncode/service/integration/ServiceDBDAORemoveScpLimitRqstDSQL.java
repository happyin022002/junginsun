...
*@FileName : ServiceDBDAORemoveScpLimitRqstDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAORemoveScpLimitRqstDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request scp code limit 삭제
	  * </pre>
	  */
	public ServiceDBDAORemoveScpLimitRqstDSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAORemoveScpLimitRqstDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_SVC_SCP_LMT_RQST" ).append("\n"); 
