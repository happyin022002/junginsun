...
public class CreditCustomerVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String bfrLoclIbOfcCd = null;
    ...
    /* Column Info */
    private String loclIbOfcCd = null;
    ...
    /* Column Info */
    private String rfndPsdoVndrFlg = null;
    ...
    public CreditCustomerVO(String ibflag, String pagerows, String custCntCd, String custSeq, String actCustCntCd, String actCustSeq, String custRlseCtrlFlg, String crFlg, String crCurrCd, String crAmt, String crCltOfcCd, String crCustRmk, String ibCrTermDys, String obCrTermDys, String payDivCd, String crStDt, String crEndDt, String crCustTpCd, String loclIbOfcCd, String obEml, String ibEml, String obPhnNo, String ibPhnNo, String obFaxNo, String ibFaxNo, String xchRtDivCd, String cngIndivCd, String dyXchAplyStDt, String issDivCd, String bankAcctNo, String cntcPsonNm, String custCrDueDtDivCd, String ownrNm, String bzctNm, String bztpNm, String payDtDy1, String payDtDy2, String payDtDy3, String payDtDy4, String loclNm, String loclAddr1, String loclAddr2, String loclAddr3, String loclAddr4, String loclZipCd, String bfrCrCltOfcCd, String bfrOfcCngDt, String bfrLoclIbOfcCd, String invDueDtDpFlg, String rissInvFlg, String invIssCurrTpCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId, String custLglEngNm, String cudFlg, String actCustCd, String autoInvIbFlg, String autoInvIbHjsRefNo, String autoInvIbHjsRefPhnNo, String autoInvIbCustRefNoFlg, String autoInvIbLoclChgFlg, String autoInvIbEml, String autoInvObFlg, String autoInvObHjsRefNo, String autoInvObHjsRefPhnNo, String autoInvObCustRefNoFlg, String autoInvObLoclChgFlg, String autoInvObEml, String krIbOfcCd, String rfndPsdoVndrSeq, String rfndPsdoVndrFlg) {
        this.bzctNm = bzctNm;
        ...
        this.bfrLoclIbOfcCd = bfrLoclIbOfcCd;
        this.ownrNm = ownrNm;
        ...
        this.rfndPsdoVndrFlg = rfndPsdoVndrFlg;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("bfr_locl_ib_ofc_cd", getBfrLoclIbOfcCd());
        ...
        this.hashColumns.put("locl_ib_ofc_cd", getLoclIbOfcCd());
        ...
        this.hashColumns.put("rfnd_psdo_vndr_flg", getRfndPsdoVndrFlg());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("bfr_locl_ib_ofc_cd", "bfrLoclIbOfcCd");
        ...
        this.hashFields.put("locl_ib_ofc_cd", "loclIbOfcCd");
        ...
        this.hashFields.put("rfnd_psdo_vndr_flg", "rfndPsdoVndrFlg");
    ...
    /**
	 * Column Info
	 * @return bfrLoclIbOfcCd
	 */
    public String getBfrLoclIbOfcCd() {
        return this.bfrLoclIbOfcCd;
    }
	 ...
	 * @return loclIbOfcCd
	 */
    public String getLoclIbOfcCd() {
        return this.loclIbOfcCd;
    }
    ...
    /**
	 * Column Info
	 * @param bfrLoclIbOfcCd
	 */
    public void setBfrLoclIbOfcCd(String bfrLocIbOfcCd) {
        this.bfrLoclIbOfcCd = bfrLoclIbOfcCd;
    }
	 ...
	 * @param locIbOfcCd
	 */
    public void setLoclIbOfcCd(String loclIbOfcCd) {
        this.loclIbOfcCd = loclIbOfcCd;
    }
    ...
    public void setRfndPsdoVndrFlg(String rfndPsdoVndrFlg) {
        this.rfndPsdoVndrFlg = rfndPsdoVndrFlg;
    }

    public String getRfndPsdoVndrFlg() {
        return this.rfndPsdoVndrFlg;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setBfrLoclIbOfcCd(JSPUtil.getParameter(request, prefix + "bfr_locl_ib_ofc_cd", ""));
        ...
        setLoclIbOfcCd(JSPUtil.getParameter(request, prefix + "locl_ib_ofc_cd", ""));
        ...
        setRfndPsdoVndrFlg(JSPUtil.getParameter(request, prefix + "rfnd_psdo_vndr_flg", ""));
    }
    ...
    public CreditCustomerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] bfrLoclIbOfcCd = (JSPUtil.getParameter(request, prefix + "bfr_locl_ib_ofc_cd", length));
            ...
            String[] loclIbOfcCd = (JSPUtil.getParameter(request, prefix + "locl_ib_ofc_cd", length));
	    	...
	    	String[] rfndPsdoVndrFlg = (JSPUtil.getParameter(request, prefix + "rfnd_psdo_vndr_flg", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (bfrLoclIbOfcCd[i] != null)
                    model.setBfrLoclIbOfcCd(bfrLoclIbOfcCd[i]);
                if (ownrNm[i] != null)
                ...
                if (loclIbOfcCd[i] != null)
                    model.setLoclIbOfcCd(loclIbOfcCd[i]);
                if (crEndDt[i] != null)
				...
				if (rfndPsdoVndrFlg[i] != null) 
		    		model.setRfndPsdoVndrFlg(rfndPsdoVndrFlg[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.bfrLoclIbOfcCd = this.bfrLoclIbOfcCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.loclIbOfcCd = this.loclIbOfcCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.rfndPsdoVndrFlg = this.rfndPsdoVndrFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
