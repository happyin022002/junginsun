...
*@FileName : PartnerDBDAOModifyCustCntcPntRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCustCntcPntRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyCustCntcPntRqst
	  * </pre>
	  */
	public PartnerDBDAOModifyCustCntcPntRqstUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCustCntcPntRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_CUST_CNTC_PNT_RQST " ).append("\n"); 
		...
		query.append("AND CUST_CNTC_PNT_SEQ = NVL(@[cust_cntc_pnt_seq], 0)" ).append("\n"); 
