...
*@FileName : GrpCommodityVO.java
*@FileTitle : GrpCommodityVO
*Open Issues :
*Change history :
...
public class GrpCommodityVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<GrpCommodityVO> models = new ArrayList<GrpCommodityVO>();
	...
	public GrpCommodityVO() {}

	public GrpCommodityVO(String ibflag, String pagerows, String grpCmdtCd, String minRepCmdtCd, String maxRepCmdtCd, String grpCmdtEngNm, String grpCmdtKrnNm, String grpCmdtJpnNm, String grpCmdtChnNm, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setGrpCmdtEngNm(JSPUtil.getParameter(request, prefix + "grp_cmdt_eng_nm", ""));
		setGrpCmdtKrnNm(JSPUtil.getParameter(request, prefix + "grp_cmdt_krn_nm", ""));
		setGrpCmdtChnNm(JSPUtil.getParameter(request, prefix + "grp_cmdt_chn_nm", ""));
		setDeltFlg(JSPUtil.getParameter(request, prefix + "delt_flg", ""));
		setCreDt(JSPUtil.getParameter(request, prefix + "cre_dt", ""));
		setMaxRepCmdtCd(JSPUtil.getParameter(request, prefix + "max_rep_cmdt_cd", ""));
		setGrpCmdtJpnNm(JSPUtil.getParameter(request, prefix + "grp_cmdt_jpn_nm", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setMinRepCmdtCd(JSPUtil.getParameter(request, prefix + "min_rep_cmdt_cd", ""));
	 ...
	 * @param request
	 * @return GrpCommodityVO[]
	 */
	public GrpCommodityVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return GrpCommodityVO[]
	 */
	public GrpCommodityVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		GrpCommodityVO model = null;
	...
	public GrpCommodityVO[] getGrpCommodityVOs(){
		GrpCommodityVO[] vos = (GrpCommodityVO[])models.toArray(new GrpCommodityVO[models.size()]);
		return vos;
	}
