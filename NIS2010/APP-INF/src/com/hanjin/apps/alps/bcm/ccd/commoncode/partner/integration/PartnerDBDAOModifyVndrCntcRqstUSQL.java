...
*@FileName : PartnerDBDAOModifyVndrCntcRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyVndrCntcRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOModifyVndrCntcRqstUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyVndrCntcRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_VNDR_CNTC_PNT_RQST " ).append("\n"); 
