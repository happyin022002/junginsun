...
*@FileName : PartnerDBDAOSearchVndrCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOSearchVndrCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOSearchVndrCodeRSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOSearchVndrCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(VNDR_SEQ,'000000') VNDR_SEQ" ).append("\n"); 
		...
		query.append("		, 'Approved' AS MST_RQST_STS_CD" ).append("\n"); 
		...
		query.append("-- 2018.01.12 삭제       ,SAP_ID" ).append("\n"); 
		query.append("-- 2018.01.12 삭제        ,BANK_ACCT_FLG" ).append("\n"); 
