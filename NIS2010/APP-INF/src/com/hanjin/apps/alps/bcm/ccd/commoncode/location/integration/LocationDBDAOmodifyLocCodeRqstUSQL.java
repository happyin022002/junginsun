...
*@FileName : LocationDBDAOmodifyLocCodeRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyLocCodeRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Location 정보를 수정합니다.
	  * </pre>
	  */
	public LocationDBDAOmodifyLocCodeRqstUSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOmodifyLocCodeRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_LOC_RQST  " ).append("\n"); 
		...
		query.append("	, PORT_INLND_FLG = @[port_inlnd_flg]" ).append("\n"); 
		...
		query.append("	, MODI_LOC_CD = @[modi_loc_cd]" ).append("\n"); 
		query.append("	, UPD_USR_ID = @[usr_id]" ).append("\n"); 
		query.append("	, UPD_DT = SYSDATE" ).append("\n"); 
		query.append("    , NEW_LOC_LAT = REPLACE(@[new_loc_lat], ',','')" ).append("\n"); 
		query.append("    , NEW_LOC_LON = REPLACE(@[new_loc_lon], ',','')" ).append("\n"); 
