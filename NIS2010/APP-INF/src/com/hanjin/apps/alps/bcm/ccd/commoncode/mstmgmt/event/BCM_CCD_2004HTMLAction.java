...
*@FileName : BCM_CCD_2004HTMLAction.java
*@FileTitle : BCM_CCD_2004
*Open Issues :
*Change history :
...
public class BCM_CCD_2004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_2004HTMLAction 객체를 생성
	 */
	public BCM_CCD_2004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd2004Event event = new BcmCcd2004Event();
		
        event.setSearchMdmHistListVO((SearchMdmHistListVO)getVO(request, SearchMdmHistListVO.class));
