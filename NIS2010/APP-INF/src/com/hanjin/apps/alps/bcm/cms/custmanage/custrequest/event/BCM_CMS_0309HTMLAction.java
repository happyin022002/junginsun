...
*@FileName : BCM_CMS_0309HTMLAction.java
*@FileTitle : customer
*Open Issues :
*Change history :
...
public class BCM_CMS_0309HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CMS_0309HTMLAction 객체를 생성
	 */
	public BCM_CMS_0309HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCms0309Event event = new BcmCms0309Event();
