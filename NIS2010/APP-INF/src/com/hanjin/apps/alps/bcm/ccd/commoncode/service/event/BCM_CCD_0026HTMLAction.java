...
*@FileName : BCM_CCD_0026HTMLAction.java
...
public class BCM_CCD_0026HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0026HTMLAction 객체를 생성
	 */
	public BCM_CCD_0026HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0026Event event = new BcmCcd0026Event();
		

		if(command.isCommand(FormCommand.SEARCH02)) {
			event.setMvmtStsCd(request.getParameter("mvmt_sts_cd"));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setMvmtStsVO((MovementStatusVO)getVO(request, MovementStatusVO .class));
		}
