...
*@FileName : ReportDBDAOYardReportRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReportDBDAOYardReportRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReportDBDAOYardReportRSQL(){
		setQuery();
		...
		query.append("FileName : ReportDBDAOYardReportRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
