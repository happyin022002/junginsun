...
public class BcmCcd0032Event extends EventSupport {
	...
	private String hiddenctrCd = null;

	private String hiddenAcctCd = null;
	...
	public String getHiddenctrCd() {
		return hiddenctrCd;
	}

	public void setHiddenctrCd(String hiddenctrCd) {
		this.hiddenctrCd = hiddenctrCd;
	}

	public String getHiddenAcctCd() {
		return hiddenAcctCd;
	}

	public void setHiddenAcctCd(String hiddenAcctCd) {
		this.hiddenAcctCd = hiddenAcctCd;
	}
