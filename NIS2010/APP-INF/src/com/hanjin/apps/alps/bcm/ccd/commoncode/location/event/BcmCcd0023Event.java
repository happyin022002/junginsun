...
/**
 * BCM_CCD_0023 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  BCM_CCD_0023HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author 
 * @see BCM_CCD_0023HTMLAction 참조
 * @since J2EE 1.6
 */

public class BcmCcd0023Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	public BcmCcd0023Event(){}
	...
	private LseComYardVO lseCoYdVO = null;
	...
	public LseComYardVO getLseCoYdVO() {
		return lseCoYdVO;
	}

	public void setLseCoYdVO(LseComYardVO lseCoYdVO) {
		this.lseCoYdVO = lseCoYdVO;
	}
