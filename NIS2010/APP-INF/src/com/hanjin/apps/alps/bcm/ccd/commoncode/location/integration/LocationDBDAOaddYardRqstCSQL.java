...
*@FileName : LocationDBDAOaddYardRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddYardRqstCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 신규 Request Yard 정보를 저장합니다.
	  * </pre>
	  */
	public LocationDBDAOaddYardRqstCSQL(){
		setQuery();
		...
		params.put("dry_avg_dwll_hrs",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rf_min_dwll_hrs",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rail_arr_ntfc_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("yd_co_spc",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("dry_min_dwll_hrs",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("rf_avg_dwll_hrs",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LocationDBDAOaddYardRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_YD_RQST ( " ).append("\n"); 
		...
		query.append("  NVL(@[yd_fcty_tp_brg_rmp_flg], 'N')," ).append("\n"); 
		...
		query.append("  REPLACE(@[yd_brth_alng_sd_desc], ',', '')," ).append("\n"); 
		...
		query.append("  REPLACE(@[yd_co_spc], ',', '')," ).append("\n"); 
		...
		query.append("  @[modi_yd_cd]," ).append("\n"); 
		query.append("  @[rail_arr_ntfc_flg]," ).append("\n"); 
		query.append("  REPLACE(@[yd_lat],',','')," ).append("\n"); 
		query.append("  REPLACE(@[yd_lon],',','')" ).append("\n"); 
		query.append(") " ).append("\n"); 
