...
*@FileName : CommodityDBDAOSearchCommodityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOSearchCommodityRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.04 조인영 Commodity 정보를 조회한다.
	  * </pre>
	  */
	public CommodityDBDAOSearchCommodityRSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOSearchCommodityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
