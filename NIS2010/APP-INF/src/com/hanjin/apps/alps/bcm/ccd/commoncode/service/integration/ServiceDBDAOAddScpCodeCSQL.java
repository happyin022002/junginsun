...
*@FileName : ServiceDBDAOAddScpCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddScpCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOAddScpCodeCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddScpCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
