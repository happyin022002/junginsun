...
*@FileName : ServiceDBDAOModifySlaneCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifySlaneCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOModifySlaneCodeUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifySlaneCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
