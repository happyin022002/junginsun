...
*@FileName : BCM_CCD_1038HTMLAction.java
*@FileTitle : Group Customer Code Duplicate Check Pop-up
*Open Issues :
*Change history :
...
public class BCM_CCD_1038HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_1038HTMLAction 객체를 생성
	 */
	public BCM_CCD_1038HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd1038Event event = new BcmCcd1038Event();
