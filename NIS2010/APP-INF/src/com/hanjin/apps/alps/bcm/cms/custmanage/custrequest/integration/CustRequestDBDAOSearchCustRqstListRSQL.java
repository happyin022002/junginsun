...
public class CustRequestDBDAOSearchCustRqstListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   , DECODE(A.RJCT_RSN_CD,'D','Duplicated','R','Reject','') RJCT_RSN_CD" ).append("\n"); 
		query.append("   , A.RJCT_RSN_RMK" ).append("\n"); 
		...
		query.append("-- N:SAVED,R:REJECTED,P:REQUEST,A:APPROVE" ).append("\n"); 
		query.append("#end" ).append("\n"); 
