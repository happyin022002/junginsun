 ...
 */
public class CreateMdmCustRepVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<CreateMdmCustRepVO> models = new ArrayList<CreateMdmCustRepVO>();
	 ...
	 */
    public CreateMdmCustRepVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreateMdmCustRepVO[]
	 */
    public CreateMdmCustRepVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
    ...
    public CreateMdmCustRepVO[] getCreateMdmCustRepVOs() {
        CreateMdmCustRepVO[] vos = (CreateMdmCustRepVO[]) models.toArray(new CreateMdmCustRepVO[models.size()]);
        return vos;
    }
