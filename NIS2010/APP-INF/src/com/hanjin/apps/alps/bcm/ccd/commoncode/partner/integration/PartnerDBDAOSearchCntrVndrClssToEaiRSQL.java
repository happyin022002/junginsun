...
*@FileName : PartnerDBDAOSearchCntrVndrClssToEaiRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOSearchCntrVndrClssToEaiRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EAI 전송을 위한 Vendor Classification 정보 조회
	  * </pre>
	  */
	public PartnerDBDAOSearchCntrVndrClssToEaiRSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOSearchCntrVndrClssToEaiRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
