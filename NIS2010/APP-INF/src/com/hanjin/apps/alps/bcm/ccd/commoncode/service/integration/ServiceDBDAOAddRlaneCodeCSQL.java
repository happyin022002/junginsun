...
*@FileName : ServiceDBDAOAddRlaneCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddRlaneCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOAddRlaneCodeCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddRlaneCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
