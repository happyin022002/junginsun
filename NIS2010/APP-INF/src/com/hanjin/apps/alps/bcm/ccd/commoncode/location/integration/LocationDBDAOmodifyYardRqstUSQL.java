...
*@FileName : LocationDBDAOmodifyYardRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyYardRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Yard 정보를 수정합니다
	  * </pre>
	  */
	public LocationDBDAOmodifyYardRqstUSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOmodifyYardRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_YD_RQST " ).append("\n"); 
		...
		query.append("    YD_CO_SPC = REPLACE(@[yd_co_spc], ',', '')," ).append("\n"); 
		...
		query.append("    YD_CO_VOL_TEU_KNT = REPLACE(@[yd_co_vol_teu_knt], ',', '')," ).append("\n"); 
		query.append("    YD_CO_VOL_BX_KNT = REPLACE(@[yd_co_vol_bx_knt], ',', '')," ).append("\n"); 
