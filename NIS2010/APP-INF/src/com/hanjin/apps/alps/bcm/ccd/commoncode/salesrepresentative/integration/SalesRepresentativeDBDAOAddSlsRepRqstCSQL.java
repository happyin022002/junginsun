...
*@FileName : SalesRepresentativeDBDAOAddSlsRepRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesRepresentativeDBDAOAddSlsRepRqstCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request SlsRepCode 생성
	  * </pre>
	  */
	public SalesRepresentativeDBDAOAddSlsRepRqstCSQL(){
		setQuery();
		...
		query.append("FileName : SalesRepresentativeDBDAOAddSlsRepRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_SLS_REP_RQST" ).append("\n"); 
