...
*@FileName : PartnerDBDAOModifyCrrRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCrrRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOModifyCrrRqstUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCrrRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_CRR_RQST " ).append("\n"); 
