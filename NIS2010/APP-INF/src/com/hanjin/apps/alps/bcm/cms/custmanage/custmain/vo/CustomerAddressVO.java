...
*@FileName : CustomerAddressVO.java
*@FileTitle : CustomerAddressVO
*Open Issues :
*Change history :
 ...
 */
public class CustomerAddressVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<CustomerAddressVO> models = new ArrayList<CustomerAddressVO>();
    ...
    public CustomerAddressVO(String ibflag, String custCd, String pagerows, String custCntCd, String custSeq, String addrTpCd, String addrSeq, String prmryChkFlg, String bzetNm, String bzetAddr, String ctyNm, String steCd, String zipCd, String cntcEml, String cntcPsonNm, String bzetRmk, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String crmRowId, String loclAddr1, String loclAddr2, String loclAddr3, String loclAddr4, String cntCd, String eaiIfId, String delFlg, String addrRowId, String cudFlg) {
	 ...
	 */
    public CustomerAddressVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CustomerAddressVO[]
	 */
    public CustomerAddressVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        CustomerAddressVO model = null;
    ...
    public CustomerAddressVO[] getCustomerAddressVOs() {
        CustomerAddressVO[] vos = (CustomerAddressVO[]) models.toArray(new CustomerAddressVO[models.size()]);
        return vos;
    }
