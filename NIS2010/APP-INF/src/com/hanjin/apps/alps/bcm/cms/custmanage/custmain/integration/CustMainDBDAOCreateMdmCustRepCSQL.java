...
*@FileName : CustMainDBDAOCreateMdmCustRepCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustMainDBDAOCreateMdmCustRepCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Create MDM Customer rep
	  * </pre>
	  */
	public CustMainDBDAOCreateMdmCustRepCSQL(){
		setQuery();
		...
		query.append("FileName : CustMainDBDAOCreateMdmCustRepCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,auto_inv_flg" ).append("\n"); 
		query.append("	,hjs_cust_svc_pic_tp_cd" ).append("\n"); 
		query.append("	,hjs_ref_no" ).append("\n"); 
		query.append("	,cust_ref_no_flg" ).append("\n"); 
		query.append("	,locl_chg_flg" ).append("\n"); 
		query.append("	,hjs_ref_eml" ).append("\n"); 
		query.append("	,delt_flg" ).append("\n"); 
		query.append("	,cre_usr_id" ).append("\n"); 
		query.append("	,cre_dt" ).append("\n"); 
		query.append("	,upd_usr_id" ).append("\n"); 
		query.append("	,upd_dt" ).append("\n"); 
		query.append("	,auto_inv_eml" ).append("\n"); 
		query.append(")" ).append("\n"); 
