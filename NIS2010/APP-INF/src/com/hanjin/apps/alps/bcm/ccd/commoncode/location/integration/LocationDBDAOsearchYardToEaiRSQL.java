...
*@FileName : LocationDBDAOsearchYardToEaiRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOsearchYardToEaiRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EAI 전송을 위한 Yard Main정보 조회
	  * </pre>
	  */
	public LocationDBDAOsearchYardToEaiRSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOsearchYardToEaiRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
