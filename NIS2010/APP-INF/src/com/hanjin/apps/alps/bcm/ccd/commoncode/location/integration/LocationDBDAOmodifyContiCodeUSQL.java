...
*@FileName : LocationDBDAOmodifyContiCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyContiCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOmodifyContiCodeUSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOmodifyContiCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	CONTI_NM = @[conti_nm]" ).append("\n"); 
