...
public class SalesRepVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("glo_usr_id", getGloUsrId());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("glo_usr_id", "gloUsrId");
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setGloUsrId(JSPUtil.getParameter(request, prefix + "glo_usr_id", ""));
    }
    ...
    public SalesRepVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] gloUsrId = (JSPUtil.getParameter(request, prefix + "glo_usr_id", length));
	...
	*/
    public void unDataFormat() {
        ...
        this.gloUsrId = this.gloUsrId.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
