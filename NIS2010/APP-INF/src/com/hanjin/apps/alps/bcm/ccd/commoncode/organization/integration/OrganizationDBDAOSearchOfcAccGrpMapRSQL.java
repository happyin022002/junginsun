...
*@FileName : OrganizationDBDAOSearchOfcAccGrpMapRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OrganizationDBDAOSearchOfcAccGrpMapRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 입력한 Office Access Group Mapping(Pop-up) 정보를 조회한다.
	  * </pre>
	  */
	public OrganizationDBDAOSearchOfcAccGrpMapRSQL(){
		setQuery();
		...
		query.append("FileName : OrganizationDBDAOSearchOfcAccGrpMapRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,OFC_CD CUR_OFC_CD" ).append("\n"); 
