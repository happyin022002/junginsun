...
public class MstMgmtDBDAO extends DBDAOSupport {
	...
	public String searchMdmHistoryCount(SearchMdmHistoryListVO searchMdmHistoryListVO) throws DAOException {
		...
		/**
		 * 
		 * @param searchMdmHistListVO
		 * @return List<MdmDatProcVO>
		 * @throws DAOException
		 */
		 @SuppressWarnings("unchecked")
		public List<SearchMdmHistListVO> searchMdmHistList(SearchMdmHistListVO searchMdmHistListVO) throws DAOException {
			 
			DBRowSet dbRowset = null;
			List<SearchMdmHistListVO> list = null;
			//query parameter
			Map<String, Object> param = new HashMap<String, Object>();
			//velocity parameter
			Map<String, Object> velParam = new HashMap<String, Object>();
			...
			try{
				if(searchMdmHistListVO != null){
					Map<String, String> mapVO = searchMdmHistListVO .getColumnValues();
					param.putAll(mapVO);
					velParam.putAll(mapVO);
				}
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new MstMgmtDBDAOSearchMdmHistListRSQL(), param, velParam);
				list = (List)RowSetUtil.rowSetToVOs(dbRowset, SearchMdmHistListVO .class);
			} catch(SQLException se) {
				log.error(se.getMessage(),se);
				throw new DAOException(new ErrorHandler(se).getMessage());
			} catch(Exception ex) {
