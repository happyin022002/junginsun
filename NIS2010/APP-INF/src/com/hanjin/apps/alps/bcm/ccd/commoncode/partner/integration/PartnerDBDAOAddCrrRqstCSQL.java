...
*@FileName : PartnerDBDAOAddCrrRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddCrrRqstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOAddCrrRqstCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddCrrRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_CRR_RQST( " ).append("\n"); 
