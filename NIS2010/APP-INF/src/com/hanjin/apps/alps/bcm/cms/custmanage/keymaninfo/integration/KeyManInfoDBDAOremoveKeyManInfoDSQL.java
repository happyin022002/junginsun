...
*@FileName : KeyManInfoDBDAOremoveKeyManInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KeyManInfoDBDAOremoveKeyManInfoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * delete customer key man
	  * </pre>
	  */
	public KeyManInfoDBDAOremoveKeyManInfoDSQL(){
		setQuery();
		...
		query.append("FileName : KeyManInfoDBDAOremoveKeyManInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_CUST_KEYMAN" ).append("\n"); 
