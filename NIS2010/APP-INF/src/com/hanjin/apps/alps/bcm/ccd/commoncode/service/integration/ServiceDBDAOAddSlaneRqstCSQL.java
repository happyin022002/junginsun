...
*@FileName : ServiceDBDAOAddSlaneRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddSlaneRqstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOAddSlaneRqstCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddSlaneRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("--INSERT INTO MDM_VSL_SVC_LANE_RQST " ).append("\n"); 
		query.append("INSERT INTO MDM_VSL_SVC_LANE" ).append("\n"); 
