...
*@FileName : AssetDBDAOModifyContainerVesselUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AssetDBDAOModifyContainerVesselUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.28 조인영 Container Vessel 정보를 수정한다.
	  * </pre>
	  */
	public AssetDBDAOModifyContainerVesselUSQL(){
		setQuery();
		...
		query.append("FileName : AssetDBDAOModifyContainerVesselUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
