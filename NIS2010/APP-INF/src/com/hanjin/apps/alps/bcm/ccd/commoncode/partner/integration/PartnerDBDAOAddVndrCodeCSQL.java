...
*@FileName : PartnerDBDAOAddVndrCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddVndrCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOAddVndrCodeCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddVndrCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_VENDOR  " ).append("\n"); 
		query.append("       (" ).append("\n"); 
