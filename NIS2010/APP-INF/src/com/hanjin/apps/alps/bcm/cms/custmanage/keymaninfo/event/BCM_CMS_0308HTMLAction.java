...
*@FileName : BCM_CMS_0003HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.bcm.cms.generalinfomanage 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 * - Parsing 한 정보를 Event로 변환, request에 담아 GeneralInfoManageSC로 실행요청<br>
 * - GeneralInfoManageSC에서
 *  View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 * @author LEECHANGWON
 * @see GeneralInfoManageEvent 참조
 * @since J2EE 1.6
 * 
 */
public class BCM_CMS_0308HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CMS_0003HTMLAction 객체를 생성
	 */
	public BCM_CMS_0308HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmCms0308Event event = new BcmCms0308Event();
