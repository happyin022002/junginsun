...
*@FileName : BCM_CMS_0301HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class BCM_CMS_0301HTMLAction extends HTMLActionSupport {

    /**
     * BCM_CMS_0301HTMLAction 객체를 생성
     */
    public BCM_CMS_0301HTMLAction() {
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 BCM_CMS_0301Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmCms0301Event event = new BcmCms0301Event(cust_grp_id, cust_grp_nm, ofc_cd, iPage, mdm_yn, delt_flg,cust_grp_abbr_nm);            	
