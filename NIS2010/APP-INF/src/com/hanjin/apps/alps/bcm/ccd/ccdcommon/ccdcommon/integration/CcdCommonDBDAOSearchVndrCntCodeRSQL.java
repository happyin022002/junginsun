...
*@FileName : CcdCommonDBDAOSearchVndrCntCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CcdCommonDBDAOSearchVndrCntCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Vender Country Code를 조회합니다.
	  * </pre>
	  */
	public CcdCommonDBDAOSearchVndrCntCodeRSQL(){
		setQuery();
		...
		query.append("FileName : CcdCommonDBDAOSearchVndrCntCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
