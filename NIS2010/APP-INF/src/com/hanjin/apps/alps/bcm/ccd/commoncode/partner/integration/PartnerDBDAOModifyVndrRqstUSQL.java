...
*@FileName : PartnerDBDAOModifyVndrRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyVndrRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOModifyVndrRqstUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyVndrRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${blk_flg} == 'Y')" ).append("\n"); 
		query.append("		,BLK_VNDR_SVC_CD = @[blk_vndr_svc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${team_flg} == 'Y')" ).append("\n"); 
		query.append("        ,VNDR_OFC_CD = @[vndr_ofc_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${inter_co_flg} == 'Y')" ).append("\n"); 
		...
		query.append("--        ,MODI_VNDR_SEQ = [modi_vndr_cd]" ).append("\n"); 
