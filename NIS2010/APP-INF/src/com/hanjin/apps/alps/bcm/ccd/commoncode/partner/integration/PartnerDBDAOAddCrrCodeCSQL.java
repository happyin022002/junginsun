...
*@FileName : PartnerDBDAOAddCrrCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddCrrCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOAddCrrCodeCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddCrrCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
