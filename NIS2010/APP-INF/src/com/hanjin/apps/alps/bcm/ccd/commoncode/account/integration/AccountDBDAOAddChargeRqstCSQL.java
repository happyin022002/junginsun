...
*@FileName : AccountDBDAOAddChargeRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountDBDAOAddChargeRqstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountDBDAOAddChargeRqstCSQL(){
		setQuery();
		...
		query.append("FileName : AccountDBDAOAddChargeRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_CHG_RQST (" ).append("\n"); 
