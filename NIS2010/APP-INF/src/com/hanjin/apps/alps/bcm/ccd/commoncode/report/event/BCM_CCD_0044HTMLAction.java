...
public class BCM_CCD_0044HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0025HTMLAction 객체를 생성
	 */
	public BCM_CCD_0044HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		BcmCcd0044Event event = new BcmCcd0044Event();
		

		event.setVendorReportVO((VendorReportVO)getVO(request, VendorReportVO .class));
