...
*@FileName : LocationDBDAOaddSubContiCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddSubContiCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Sub Continent 정보를 생성합니다.
	  * </pre>
	  */
	public LocationDBDAOaddSubContiCodeCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddSubContiCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
