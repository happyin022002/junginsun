...
public class ZoneVO extends AbstractValueObject {
    ...
    public ZoneVO(String ibflag, String pagerows, String znCd, String znNm, String cgoHndlTmHrs, String tztmHrs, String repYdCd, String lnkDist, String distUtCd, String deltFlg, String usrId, String locCd, String rqstNo, String creUsrId, String creDt, String updUsrId, String updDt, String cudFlg, String repZnFlg) {
        this.locCd = locCd;
        this.ibflag = ibflag;
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setRepZnFlg(JSPUtil.getParameter(request, prefix + "rep_zn_flg", ""));
    }
    ...
    public ZoneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] repZnFlg = (JSPUtil.getParameter(request, prefix + "rep_zn_flg", length));
