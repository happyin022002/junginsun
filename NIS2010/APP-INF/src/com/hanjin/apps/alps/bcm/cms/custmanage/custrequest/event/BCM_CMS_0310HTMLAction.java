...
*@FileName : BCM_CMS_0310HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class BCM_CMS_0310HTMLAction extends HTMLActionSupport {

    /**
     * BCM_CMS_0301HTMLAction 객체를 생성
     */
    public BCM_CMS_0310HTMLAction() {
    }
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmCms0310Event event = new BcmCms0310Event(rqst_no, cust_nm, ofc_cd, iPage, delt_flg, rqst_fm_dt, rqst_to_dt, cre_fm_dt, cre_to_dt);            	
