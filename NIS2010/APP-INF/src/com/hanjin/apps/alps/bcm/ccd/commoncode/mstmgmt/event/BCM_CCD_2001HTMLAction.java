...
public class BCM_CCD_2001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_2001HTMLAction 객체를 생성
	 */
	public BCM_CCD_2001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd2001Event event = new BcmCcd2001Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setMdmUsrAuthVO((MdmUsrAuthVO)getVO(request, MdmUsrAuthVO .class,""));
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setMdmUsrAuthVOS((MdmUsrAuthVO[])getVOs(request, MdmUsrAuthVO .class,"sheet1_"));
		}
