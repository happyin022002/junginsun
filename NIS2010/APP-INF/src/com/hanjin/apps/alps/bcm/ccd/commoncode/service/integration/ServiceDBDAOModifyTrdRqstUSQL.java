...
*@FileName : ServiceDBDAOModifyTrdRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifyTrdRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOModifyTrdRqstUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyTrdRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_TRD_RQST" ).append("\n"); 
