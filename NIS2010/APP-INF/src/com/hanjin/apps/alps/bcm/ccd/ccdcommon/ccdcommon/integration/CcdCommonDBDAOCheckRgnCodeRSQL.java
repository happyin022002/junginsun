...
*@FileName : CcdCommonDBDAOCheckRgnCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CcdCommonDBDAOCheckRgnCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_REGION 테이블에 rgnCd 에 
	  * 해당하는 정보가 있는지 유무를 리턴한다.
	  * </pre>
	  */
	public CcdCommonDBDAOCheckRgnCodeRSQL(){
		setQuery();
		...
		query.append("FileName : CcdCommonDBDAOCheckRgnCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
