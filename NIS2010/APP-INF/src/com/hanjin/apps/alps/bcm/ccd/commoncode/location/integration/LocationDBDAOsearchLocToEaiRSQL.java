...
*@FileName : LocationDBDAOsearchLocToEaiRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOsearchLocToEaiRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EAI Inteface를 위한 Location Info 조회
	  * </pre>
	  */
	public LocationDBDAOsearchLocToEaiRSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOsearchLocToEaiRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 , TO_CHAR(BFR_OFC_CNG_DT, 'YYYYMMDDHH24MISS') AS BFR_OFC_CNG_DT" ).append("\n"); 
		...
		query.append("	 , BFR_SLS_OFC_CD" ).append("\n"); 
		query.append("	 , TO_CHAR(EAI_EVNT_DT, 'YYYYMMDDHH24MISS') AS EAI_EVNT_DT" ).append("\n"); 
