...
*@FileName : ServiceDBDAORemoveSlaneDirCodeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAORemoveSlaneDirCodeDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAORemoveSlaneDirCodeDSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAORemoveSlaneDirCodeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_VSL_SVC_LANE_DIR" ).append("\n"); 
