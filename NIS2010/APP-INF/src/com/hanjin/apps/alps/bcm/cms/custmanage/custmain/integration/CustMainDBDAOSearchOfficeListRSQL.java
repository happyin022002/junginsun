...
*@FileName : CustMainDBDAOSearchOfficeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustMainDBDAOSearchOfficeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustMainDBDAOSearchOfficeListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.bcm.cms.custmanage.custmain.integration").append("\n"); 
		query.append("FileName : CustMainDBDAOSearchOfficeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
