...
public class CommodityDBDAO extends DBDAOSupport {
	...
	public void modifyCommodity(List<CommodityVO> cmdtVO) throws DAOException,Exception {
		try {
			...
			if(cmdtVO.size() > 0){
				Map<String, String> mapVO = cmdtVO.get(0).getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				
				int updCnt = sqlExe.executeUpdate((ISQLTemplate)new CommodityDBDAOModifyCommodityUSQL(), param, velParam);
	 ...
	 * @throws DAOException
	 */
	public void modifyCustPackageType(CustPackageTypeVO custPackTypeVO) throws DAOException,Exception {
		SQLExecuter sqlExe = new SQLExecuter("");
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try {
			if(custPackTypeVO != null){
				Map<String, String> mapVO = custPackTypeVO .getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				int result = sqlExe.executeUpdate((ISQLTemplate)new CommodityDBDAOModifyCustPackageTypeUSQL(), param, velParam);
	 ...
	 * 
	 * @param packTypeVOs List<PackageTypeVO>
	 * @throws DAOException
	 */
	public void modifyPackageType(PackageTypeVO packTypeVOs) throws DAOException,Exception {
		SQLExecuter sqlExe = new SQLExecuter("");
		//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
		...
		try {
			if(packTypeVOs != null){
				Map<String, String> mapVO = packTypeVOs .getColumnValues();
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				int result = sqlExe.executeUpdate((ISQLTemplate)new CommodityDBDAOModifyPackageTypeUSQL(), param, velParam);
				if(result== Statement.EXECUTE_FAILED){
					throw new DAOException("Fail to update SQL");
				}
			}
