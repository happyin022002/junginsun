...
*@FileName : BCM_CCD_0051HTMLAction.java
*@FileTitle : activity
*Open Issues :
*Change history :
...
public class BCM_CCD_0051HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0051HTMLAction 객체를 생성
	 */
	public BCM_CCD_0051HTMLAction() {}
...
//    	FormCommand command = FormCommand.fromRequest(request);
		BcmCcd0051Event event = new BcmCcd0051Event();
		

		event.setSearchOfficHierarchyVO((SearchOfficHierarchyVO)getVO(request, SearchOfficHierarchyVO .class));
