...
*@FileName : SalesRepresentativeDBDAOModifySlsRepRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesRepresentativeDBDAOModifySlsRepRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request SlsRepCode 수정
	  * </pre>
	  */
	public SalesRepresentativeDBDAOModifySlsRepRqstUSQL(){
		setQuery();
		...
		query.append("FileName : SalesRepresentativeDBDAOModifySlsRepRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_SLS_REP_RQST" ).append("\n"); 
		query.append("   SET SREP_CD = @[srep_cd]" ).append("\n"); 
		...
		query.append("      ,MODI_SREP_CD = @[modi_srep_cd]" ).append("\n"); 
