...
public class CustMainDBDAOSearchCustCodeRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",  NVOCC_BD_ST_EFF_DT Nvocc_Bd_Strt_Eff_Dt    " ).append("\n"); 
		...
		query.append(",  MCA.PRMRY_CHK_FLG" ).append("\n"); 
		...
		query.append(",  MCA.CNT_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append(",  MC.CRM_ROW_ID Cust_Addr_Row_Id" ).append("\n"); 
