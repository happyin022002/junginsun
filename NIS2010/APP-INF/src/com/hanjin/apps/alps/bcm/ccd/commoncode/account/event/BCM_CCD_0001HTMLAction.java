...
*@FileName : BCM_CCD_0001HTMLAction.java
*@FileTitle : Account
*Open Issues :
*Change history :
...
public class BCM_CCD_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0001HTMLAction 객체를 생성
	 */
	public BCM_CCD_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0001Event event = new BcmCcd0001Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setAccountVOS((AccountVO[])getVOs(request, AccountVO.class, "sheet1_"));
			
		} else if(command.isCommand(FormCommand.SEARCH)) {
			event.setAccountVO((AccountVO)getVO(request, AccountVO.class));
