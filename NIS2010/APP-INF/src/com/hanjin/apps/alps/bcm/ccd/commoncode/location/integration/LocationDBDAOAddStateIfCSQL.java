...
*@FileName : LocationDBDAOAddStateIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOAddStateIfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * State 정보 및 처리상태를 다른 시스템으로 전송하기 위해 저장한다.
	  * </pre>
	  */
	public LocationDBDAOAddStateIfCSQL(){
		setQuery();
		...
		params.put("ste_if_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LocationDBDAOAddStateIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_STATE_IF(" ).append("\n"); 
		query.append("             STE_IF_SEQ" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("    VALUES(  @[ste_if_seq]" ).append("\n"); 
		query.append("            ,@[cnt_cd]" ).append("\n"); 
		query.append("            ,@[ste_cd]" ).append("\n"); 
		query.append("            ,@[ste_nm]" ).append("\n"); 
		query.append("            ,@[delt_flg]" ).append("\n"); 
