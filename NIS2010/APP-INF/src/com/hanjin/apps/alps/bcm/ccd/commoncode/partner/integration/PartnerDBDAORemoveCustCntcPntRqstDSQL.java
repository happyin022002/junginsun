...
*@FileName : PartnerDBDAORemoveCustCntcPntRqstDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAORemoveCustCntcPntRqstDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAORemoveCustCntcPntRqstDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAORemoveCustCntcPntRqstDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_CUST_CNTC_PNT_RQST " ).append("\n"); 
