...
*@FileName : PartnerDBDAORemoveCustAddrRqstDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAORemoveCustAddrRqstDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAORemoveCustAddrRqstDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAORemoveCustAddrRqstDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_CUST_ADDR_RQST " ).append("\n"); 
