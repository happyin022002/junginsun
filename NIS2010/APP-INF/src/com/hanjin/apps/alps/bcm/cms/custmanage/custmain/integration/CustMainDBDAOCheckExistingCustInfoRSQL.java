...
*@FileName : CustMainDBDAOCheckExistingCustInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustMainDBDAOCheckExistingCustInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustMainDBDAOCheckExistingCustInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CustMainDBDAOCheckExistingCustInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
