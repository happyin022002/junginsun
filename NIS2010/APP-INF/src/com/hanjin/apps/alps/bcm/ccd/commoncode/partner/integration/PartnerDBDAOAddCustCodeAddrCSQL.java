...
*@FileName : PartnerDBDAOAddCustCodeAddrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddCustCodeAddrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_CUST_ADDR 테이블에 정보 저장
	  * </pre>
	  */
	public PartnerDBDAOAddCustCodeAddrCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddCustCodeAddrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
