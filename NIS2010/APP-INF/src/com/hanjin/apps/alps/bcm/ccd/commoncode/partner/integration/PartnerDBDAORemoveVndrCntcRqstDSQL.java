...
*@FileName : PartnerDBDAORemoveVndrCntcRqstDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAORemoveVndrCntcRqstDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 입력된 Vendor Contact 정보를 삭제한다.
	  * </pre>
	  */
	public PartnerDBDAORemoveVndrCntcRqstDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAORemoveVndrCntcRqstDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_VNDR_CNTC_PNT_RQST " ).append("\n"); 
