...
*@FileName : BCM_CMS_0302HTMLAction.java
*@FileTitle : customer
*Open Issues :
*Change history :
...
public class BCM_CMS_0302HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CMS_0302HTMLAction 객체를 생성
	 */
	public BCM_CMS_0302HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCms0302Event event = new BcmCms0302Event();
