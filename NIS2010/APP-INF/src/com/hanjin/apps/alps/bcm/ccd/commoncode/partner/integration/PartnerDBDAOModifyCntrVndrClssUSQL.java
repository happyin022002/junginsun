...
public class PartnerDBDAOModifyCntrVndrClssUSQL implements ISQLTemplate{
	...
	public PartnerDBDAOModifyCntrVndrClssUSQL(){
		...
		params.put("pre_cntr_vndr_svc_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("pre_vndr_cost_cd",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("   SET VNDR_COST_CD = @[vndr_cost_cd]" ).append("\n"); 
		query.append("	  ,CNTR_VNDR_SVC_CD = @[cntr_vndr_svc_cd] " ).append("\n"); 
		query.append("	  ,DELT_FLG = @[delt_flg]" ).append("\n"); 
		query.append("      ,UPD_USR_ID = @[upd_usr_id]" ).append("\n"); 
		query.append("      ,UPD_DT = SYSDATE" ).append("\n"); 
		query.append("WHERE 1 = 1" ).append("\n"); 
		query.append("AND VNDR_SEQ = @[vndr_seq]" ).append("\n"); 
		query.append("AND VNDR_COST_CD = @[pre_vndr_cost_cd]" ).append("\n"); 
		query.append("AND CNTR_VNDR_SVC_CD = @[pre_cntr_vndr_svc_cd]" ).append("\n"); 
