...
*@FileName : BCM_CMS_0310Event.java
...
/**
 * BCM_CMS0310 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - BCM_CMS0310HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
public class BcmCms0310Event extends EventSupport {
	     ...
	     * @param String zipCd
	     */
		public BcmCms0310Event(String rqstNo, String custNm, String ofcCd, int iPage, String deltFlg, String rqst_fm_dt, String rqst_to_dt, String cre_fm_dt, String cre_to_dt) {
	        this.rqstNo = rqstNo;
	        this.custNm = custNm;
	        this.ofcCd  = ofcCd;
	        this.iPage   = iPage;
