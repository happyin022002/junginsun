...
*@FileName : LocationDBDAOAddLocIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOAddLocIfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Location 정보 및 처리상태를 다른 시스템으로 전송하기 위해 저장한다.
	  * </pre>
	  */
	public LocationDBDAOAddLocIfCSQL(){
		setQuery();
		...
		params.put("loc_if_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LocationDBDAOAddLocIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_LOCATION_IF( " ).append("\n"); 
		query.append("             LOC_IF_SEQ" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("    VALUES(  @[loc_if_seq]" ).append("\n"); 
		query.append("            ,@[loc_cd]" ).append("\n"); 
		query.append("            ,@[scc_cd]" ).append("\n"); 
		query.append("            ,@[loc_nm]" ).append("\n"); 
		query.append("            ,@[rgn_cd]" ).append("\n"); 
		...
		query.append("            ,@[opedi_insf_id]" ).append("\n"); 
		query.append("            ,@[opedi_insf_dv_cd]" ).append("\n"); 
		query.append("            ,REPLACE(@[new_loc_lat], ',', '')" ).append("\n"); 
		query.append("            ,REPLACE(@[new_loc_lon], ',', '')" ).append("\n"); 
		query.append("            ) " ).append("\n"); 
