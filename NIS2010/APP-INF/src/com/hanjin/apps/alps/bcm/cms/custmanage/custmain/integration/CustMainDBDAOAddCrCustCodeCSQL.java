...
*@FileName : CustMainDBDAOAddCrCustCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustMainDBDAOAddCrCustCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustMainDBDAOAddCrCustCodeCSQL(){
		setQuery();
		...
		query.append("FileName : CustMainDBDAOAddCrCustCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
