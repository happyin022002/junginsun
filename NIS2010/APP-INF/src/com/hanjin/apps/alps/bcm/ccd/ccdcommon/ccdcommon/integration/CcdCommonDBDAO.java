...
import com.hanjin.apps.alps.bcm.cms.custmanage.custmain.integration.CustMainDBDAOSearchComCodeListRSQL;
...
public class CcdCommonDBDAO extends DBDAOSupport {
	...
	/**
	 * Vessel Container Interface 정보를 조회합니다.(BCM_CCD_0008)<br>
	 * 
	 * @return ContainerVesselMainIfVO
	 * @throws DAOException
	 */
	 @SuppressWarnings("unchecked")
	public ContainerVesselMainIfVO searchVesselContainerIf(String vslCd) throws DAOException {
		DBRowSet dbRowset = null;
		List<ContainerVesselMainIfVO> list = new ArrayList<ContainerVesselMainIfVO>();
		...
		try{
			...
			dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CcdCommonDBDAOSearchVesselContainerIfRSQL(), param, velParam);			
			list = (List)RowSetUtil.rowSetToVOs(dbRowset, ContainerVesselMainIfVO.class);
		} catch(SQLException se) {
			log.error(se.getMessage(),se);
			throw new DAOException(new ErrorHandler(se).getMessage());
		} catch(Exception ex) {
		...
		/**
		 * DayLight Saving Time Interface 정보를 조회합니다.(BCM_CCD_0024)<br>
		 * 
		 * @return DaySavingTimeIfVO
		 * @throws DAOException
		 */
		 @SuppressWarnings("unchecked")
		public DaySavingTimeIfVO searchDyLgtSavTmIf(String dstId) throws DAOException {
			DBRowSet dbRowset = null;
			List<DaySavingTimeIfVO> list = new ArrayList<DaySavingTimeIfVO>();
			Map<String, Object> param = new HashMap<String, Object>();	
			Map<String, Object> velParam = new HashMap<String, Object>();
			...
			try{
				...
				mapVO.put("dst_id", dstId);
				
				param.putAll(mapVO);
				velParam.putAll(mapVO);
				
				dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CcdCommonDBDAOSearchDyLgtSavTmIfRSQL(), param, velParam);			
				list = (List)RowSetUtil.rowSetToVOs(dbRowset, DaySavingTimeIfVO.class);
			} catch(SQLException se) {
				log.error(se.getMessage(),se);
				throw new DAOException(new ErrorHandler(se).getMessage());
			} catch(Exception ex) {
		 ...
		 /**
		  * Leasing Company Yard Interface 정보를 조회합니다.(BCM_CCD_0023)<br>
		  * 
		  * @return LseComYardIfVO
		  * @throws DAOException
		  */
		 @SuppressWarnings("unchecked")
		 public LseComYardIfVO searchLseCoYdIf(String lseCoYdCd) throws DAOException {
			 DBRowSet dbRowset = null;
			 List<LseComYardIfVO> list = new ArrayList<LseComYardIfVO>();
			 Map<String, Object> param = new HashMap<String, Object>();	
			 Map<String, Object> velParam = new HashMap<String, Object>();
			 ...
			 try{
				 ...
				 mapVO.put("lse_co_yd_cd", lseCoYdCd);
				 
				 param.putAll(mapVO);
				 velParam.putAll(mapVO);
				 
				 dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CcdCommonDBDAOSearchLseCoYdIfRSQL(), param, velParam);			
				 list = (List)RowSetUtil.rowSetToVOs(dbRowset, LseComYardIfVO.class);
			 } catch(SQLException se) {
				 log.error(se.getMessage(),se);
				 throw new DAOException(new ErrorHandler(se).getMessage());
			 } catch(Exception ex) {
		 ...
		 /**
		  * Organization Interface 정보를 조회합니다.(BCM_CCD_0023)<br>
		  * 
		  * @return OfficeMainIfVO
		  * @throws DAOException
		  */
		 @SuppressWarnings("unchecked")
		 public OfficeMainIfVO searchOfcCodeIf(String ofcCd) throws DAOException {
			 DBRowSet dbRowset = null;
			 List<OfficeMainIfVO> list = new ArrayList<OfficeMainIfVO>();
			 Map<String, Object> param = new HashMap<String, Object>();	
			 Map<String, Object> velParam = new HashMap<String, Object>();
			 ...
			 try{
				 ...
				 dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CcdCommonDBDAOSearchOfcCodeIfRSQL(), param, velParam);			
				 list = (List)RowSetUtil.rowSetToVOs(dbRowset, OfficeMainIfVO.class);
			 } catch(SQLException se) {
				 log.error(se.getMessage(),se);
				 throw new DAOException(new ErrorHandler(se).getMessage());
			 } catch(Exception ex) {
			...
			/**
			 * Center Code 를 체크합니다.<br>
			 * 
			 * @param String ctrCd
			 * @return DBRowSet DB 처리 결과
			 * @throws DAOException
			 */
			public DBRowSet checkCtrCode(String ctrCd) throws DAOException {
				DBRowSet dbRowset = null; // 데이터 전송을 위해 DB ResultSet을 구현한 객체		
				Map<String, Object> param = new HashMap<String, Object>();//parameter		
					try {
						if(ctrCd != null){
							param.put("f_center",ctrCd);
						}				
						dbRowset = new SQLExecuter("").executeQuery((ISQLTemplate)new CcdCommonDBDAOCheckCtrCodeRSQL(), param, null);
					} catch(SQLException se){
						log.error(se.getMessage(),se);
						throw new DAOException(new ErrorHandler(se).getMessage());			
					} catch(Exception ex){
