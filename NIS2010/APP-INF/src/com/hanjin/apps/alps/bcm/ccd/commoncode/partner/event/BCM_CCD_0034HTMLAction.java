...
*@FileName : BCM_CCD_0034HTMLAction.java
*@FileTitle : carrier
*Open Issues :
*Change history :
...
public class BCM_CCD_0034HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0034HTMLAction 객체를 생성
	 */
	public BCM_CCD_0034HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0034Event event = new BcmCcd0034Event();
