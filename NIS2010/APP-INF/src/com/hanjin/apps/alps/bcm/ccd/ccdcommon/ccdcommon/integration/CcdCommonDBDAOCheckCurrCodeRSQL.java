...
*@FileName : CcdCommonDBDAOCheckCurrCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CcdCommonDBDAOCheckCurrCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_CURRENCY 테이블에 currCd 에 
	  * 해당하는 정보가 있는지 유무를 리턴한다.
	  * </pre>
	  */
	public CcdCommonDBDAOCheckCurrCodeRSQL(){
		setQuery();
		...
		query.append("FileName : CcdCommonDBDAOCheckCurrCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
