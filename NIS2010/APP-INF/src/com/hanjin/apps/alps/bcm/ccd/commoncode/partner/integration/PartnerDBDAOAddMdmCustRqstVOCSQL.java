...
*@FileName : PartnerDBDAOAddMdmCustRqstVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddMdmCustRqstVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MdmCustRqstVO 정보를 추가한다.
	  * </pre>
	  */
	public PartnerDBDAOAddMdmCustRqstVOCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddMdmCustRqstVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_CUST_RQST(" ).append("\n"); 
		...
		query.append(",   NVL(@[rail_road_prio_flg], 'N')" ).append("\n"); 
		query.append(",   @[modi_cust_cd2]" ).append("\n"); 
		query.append(",   @[nmd_cust_flg]" ).append("\n"); 
		query.append(",   @[sprt_eml_inv_flg]" ).append("\n"); 
		query.append(") " ).append("\n"); 
