...
public class ScopeLimitVO extends AbstractValueObject {
	...
	/* Column Info */
	private String svcScpScnt = null;
	...
	public ScopeLimitVO(String ibflag, String pagerows, String rgnCd, String orgDestCd, String svcScpIndFlg, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String userId, String rqstNo, String svcScpCd, String svcScpScnt) {
		this.updDt = updDt;
		this.rgnCd = rgnCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("svc_scp_sconti", getSvcScpScnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("svc_scp_scnt", "svcScpScnt");
	 ...
	 * @param subConti
	 */
	public String getSvcScpScnt(){
		return this.svcScpScnt;
	}
	 ...
	 * @param svcScpSconti
	 */
	public void setSvcScpScnt(String svcScpScnt){
		this.svcScpScnt = svcScpScnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSvcScpScnt(JSPUtil.getParameter(request, prefix + "svc_scp_sconti", ""));
	}
	...
	public ScopeLimitVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] svcScpScnt = (JSPUtil.getParameter(request, prefix	+ "svc_scp_sconti", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (svcScpScnt[i] != null)
					model.setSvcScpScnt(svcScpScnt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.svcScpScnt = this.svcScpScnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
