...
*@FileName : ServiceDBDAOAddTrdRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddTrdRqstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOAddTrdRqstCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddTrdRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_TRD_RQST" ).append("\n"); 
