...
*@FileName : AccountDBDAOModifyRepChgCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountDBDAOModifyRepChgCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.21 조인영 Rep Charge Code 정보를 수정한다.
	  * </pre>
	  */
	public AccountDBDAOModifyRepChgCodeUSQL(){
		setQuery();
		...
		query.append("FileName : AccountDBDAOModifyRepChgCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
