...
*@FileName : ServiceDBDAOModifyMvmtStsCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifyMvmtStsCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 조회한 Movement Status Code의 상세 정보를 수정하는 쿼리
	  * </pre>
	  */
	public ServiceDBDAOModifyMvmtStsCodeUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyMvmtStsCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
