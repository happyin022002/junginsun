...
*@FileName : PartnerDBDAOModifyCntrVndrClssRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCntrVndrClssRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOModifyCntrVndrClssRqstUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCntrVndrClssRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_CNTR_VNDR_CLSS_RQST " ).append("\n"); 
