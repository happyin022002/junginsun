...
*@FileName : LocationDBDAOmodifyZoneCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyZoneCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOmodifyZoneCodeUSQL(){
		setQuery();
		...
		params.put("rep_zn_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LocationDBDAOmodifyZoneCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_ZONE " ).append("\n"); 
		query.append("SET ZN_NM = @[zn_nm]," ).append("\n"); 
		...
		query.append("	REP_ZN_FLG = @[rep_zn_flg]," ).append("\n"); 
