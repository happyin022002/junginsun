...
*@FileName : PartnerDBDAOModifyCustomerInfoCustAddrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCustomerInfoCustAddrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyCustomerInfoCustAddr
	  * </pre>
	  */
	public PartnerDBDAOModifyCustomerInfoCustAddrUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCustomerInfoCustAddrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET BZET_ADDR = @[bzet_addr]" ).append("\n"); 
