...
*@FileName : CcdCommonDBDAOCheckSubTrdCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CcdCommonDBDAOCheckSubTrdCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_SUB_TRD 테이블에 strdCd 에 
	  * 해당하는 정보가 있는지 유무를 리턴한다.
	  * </pre>
	  */
	public CcdCommonDBDAOCheckSubTrdCodeRSQL(){
		setQuery();
		...
		query.append("FileName : CcdCommonDBDAOCheckSubTrdCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
