...
*@FileName : ServiceDBDAOAddScpLimitRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddScpLimitRqstCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request scp code limit 생성
	  * </pre>
	  */
	public ServiceDBDAOAddScpLimitRqstCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddScpLimitRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_SVC_SCP_LMT_RQST" ).append("\n"); 
