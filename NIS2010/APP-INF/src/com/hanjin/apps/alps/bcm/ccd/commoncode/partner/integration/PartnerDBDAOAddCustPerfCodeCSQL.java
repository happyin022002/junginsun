...
*@FileName : PartnerDBDAOAddCustPerfCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddCustPerfCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Group Customer 코드 저장한다.
	  * </pre>
	  */
	public PartnerDBDAOAddCustPerfCodeCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddCustPerfCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
