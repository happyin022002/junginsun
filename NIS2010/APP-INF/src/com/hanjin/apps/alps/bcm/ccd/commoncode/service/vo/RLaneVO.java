...
public class RLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RLaneVO> models = new ArrayList<RLaneVO>();
...
/**
	 ...
	 */
	public RLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchRlaneCodeVO[]
	 */
	public RLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RLaneVO model = null;
	 ...
	 * @return searchRlaneCodeVO[]
	 */
	public RLaneVO[] getsearchRlaneCodeVOs(){
		RLaneVO[] vos = (RLaneVO[])models.toArray(new RLaneVO[models.size()]);
		return vos;
	}
