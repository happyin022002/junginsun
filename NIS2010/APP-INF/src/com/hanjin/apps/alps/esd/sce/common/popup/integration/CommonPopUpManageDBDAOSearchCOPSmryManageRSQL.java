...
public class CommonPopUpManageDBDAOSearchCOPSmryManageRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		     decode(sch.CNTR_NO,'SMCU0000000',' ',sch.CNTR_NO) CNTR_NO,                                                                                                                                                                                                  " ).append("\n"); 
		...
		query.append("		 mas_get_cd_nm_fnc('CD00141',MIN(scd.act_rcv_tp_cd)) || DECODE(NVL(scd.EDI_MSG_TP_CD,''),'','','('||scd.EDI_MSG_TP_CD||')')||(DECODE(MIN(scd.act_rcv_tp_cd),'4','('||MIN(scd.upd_usr_id)||')')) act_rcv_tp_cd,     " ).append("\n"); 
