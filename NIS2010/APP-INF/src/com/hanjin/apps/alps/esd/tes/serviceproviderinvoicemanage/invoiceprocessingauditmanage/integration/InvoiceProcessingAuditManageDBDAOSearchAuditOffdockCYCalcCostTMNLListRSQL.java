...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostTMNLListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostTMNLListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * AuditOffdockCYCalcCostTMNLList 조회
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostTMNLListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostTMNLListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
