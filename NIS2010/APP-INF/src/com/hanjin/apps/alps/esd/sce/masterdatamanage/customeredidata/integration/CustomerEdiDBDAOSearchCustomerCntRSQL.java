...
*@FileName : CustomerEdiDBDAOSearchCustomerCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDAOSearchCustomerCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomerEdiDBDAOSearchCustomerCntRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDAOSearchCustomerCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
