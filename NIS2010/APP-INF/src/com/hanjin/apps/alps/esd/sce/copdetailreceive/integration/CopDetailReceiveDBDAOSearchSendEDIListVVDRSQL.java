...
*@FileName : CopDetailReceiveDBDAOSearchSendEDIListVVDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOSearchSendEDIListVVDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSendEDIListVVD
	  * </pre>
	  */
	public CopDetailReceiveDBDAOSearchSendEDIListVVDRSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOSearchSendEDIListVVDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
