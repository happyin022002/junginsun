...
public class TESCommonDBDAOTesCommonRSQL implements ISQLTemplate{
	...
	public TESCommonDBDAOTesCommonRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.common.vo").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("'' mode_  -- mode_ 뒤에 _(언더바) 제거되야함" ).append("\n"); 
		query.append("-- 전체 공통에서 쓰이는 Param ID" ).append("\n"); 
		...
		query.append(", '' vrfy_tml_cd" ).append("\n"); 
		...
		query.append(", '' hjs_list_yn" ).append("\n"); 
		...
		query.append(", '' param_rvis_io_bnd_cd" ).append("\n"); 
		query.append(", '' param_rvis_locl_ts_ind_cd" ).append("\n"); 
		query.append(", '' tpsz_cd" ).append("\n"); 
		query.append(", '' clpt_ind_seq" ).append("\n"); 
		query.append(", '' call_yd_ind_seq" ).append("\n"); 
		query.append(", '' param_call_yd_ind_seq" ).append("\n"); 
		query.append(", '' call_yd_seq_chk" ).append("\n"); 
		query.append(", '' sub_ofc_cd1" ).append("\n"); 
		query.append(", '' sub_ofc_cd2" ).append("\n"); 
