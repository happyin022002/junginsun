...
*@FileName : TESInvoiceCommonDBDAOConvertEDIInvoiceTmlSoVVDListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInvoiceCommonDBDAOConvertEDIInvoiceTmlSoVVDListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ConvertEDIInvoiceTmlSoVVDList
	  * </pre>
	  */
	public TESInvoiceCommonDBDAOConvertEDIInvoiceTmlSoVVDListCSQL(){
		setQuery();
		...
		query.append("FileName : TESInvoiceCommonDBDAOConvertEDIInvoiceTmlSoVVDListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			AND V.YD_CD = A.YD_CD" ).append("\n"); 
		query.append("			UNION ALL" ).append("\n"); 
		query.append("			SELECT  SUBSTR(A.VVD_CD,1,4) VSL_CD," ).append("\n"); 
		query.append("					SUBSTR(A.VVD_CD,5,4) SKD_VOY_NO," ).append("\n"); 
		query.append("					SUBSTR(A.VVD_CD,9) SKD_DIR_CD," ).append("\n"); 
		...
		query.append("					'1' CALL_YD_IND_SEQ" ).append("\n"); 
		...
		query.append("--		/**  [CHM-201640637] 20160405: MR Invoice에 Calling Sequence추가 **/" ).append("\n"); 
		query.append("			 V.VPS_ETB_DT ATB_DT," ).append("\n"); 
		query.append("             A.VNDR_SEQ," ).append("\n"); 
		query.append("			 V.CLPT_IND_SEQ," ).append("\n"); 
		query.append("			 V.CALL_YD_IND_SEQ" ).append("\n"); 
