...
public class BkgCopManageDBDAOReviveCopsByBkgRqstUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SET COP_STS_CD = CASE WHEN CNTR_NO != 'SMCU0000000'" ).append("\n"); 
		...
		query.append("AND (CNTR_NO = 'SMCU0000000' OR EXISTS (SELECT '1' FROM BKG_CONTAINER WHERE BKG_NO = A.BKG_NO) )" ).append("\n"); 
