...
*@FileName : EdiHoldStatusReceiveDAOAddHoldStatusHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EdiHoldStatusReceiveDAOAddHoldStatusHistoryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCE_RAIL_HLD_STS_HIS 테이블에 Insert 한다.
	  * </pre>
	  */
	public EdiHoldStatusReceiveDAOAddHoldStatusHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : EdiHoldStatusReceiveDAOAddHoldStatusHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCE_RAIL_HLD_STS_HIS(" ).append("\n"); 
		...
		query.append("@[bkg_no]," ).append("\n"); 
		query.append("@[cntr_no]," ).append("\n"); 
		query.append("SCE_RAIL_HLD_STS_HIS_SEQ.NEXTVAL," ).append("\n"); 
