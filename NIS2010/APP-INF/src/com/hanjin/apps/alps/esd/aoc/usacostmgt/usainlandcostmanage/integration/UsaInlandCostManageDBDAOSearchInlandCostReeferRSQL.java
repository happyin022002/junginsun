...
*@FileName : UsaInlandCostManageDBDAOSearchInlandCostReeferRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchInlandCostReeferRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchInlandCostReeferRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOSearchInlandCostReeferRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , AOC_USA_INLND_RF_TRF_DTL R" ).append("\n"); 
