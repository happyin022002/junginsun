...
*@FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiRevCalcVolContainerListInsert
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListInsertCSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", @[modi_flg]" ).append("\n"); 
		query.append(", @[dscr_ind_cd]" ).append("\n"); 
		query.append(", DECODE(@[tml_rvis_ind_flg],'1','Y','')" ).append("\n"); 
