...
public class SingleTransportationSOManageDBDAOSearch03SingleTransportationSOManageRSQL implements ISQLTemplate{
	...
	public SingleTransportationSOManageDBDAOSearch03SingleTransportationSOManageRSQL(){
		...
		params.put("spotBidNo",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("spotBidFlg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		query.append("SELECT   X.REPO_PLN_ID" ).append("\n"); 
		...
		query.append("		,X.TRSP_SO_CMB_SEQ" ).append("\n"); 
		query.append("		,X.TRSP_COST_DTL_MOD_NAME" ).append("\n"); 
		query.append("		,X.EQ_NO" ).append("\n"); 
		query.append("		,X.EQ_TPSZ_CD" ).append("\n"); 
		query.append("		,X.TRSP_CRR_MOD_CD" ).append("\n"); 
		query.append("		,X.LESSOR" ).append("\n"); 
		query.append("		,X.LSTM_CD" ).append("\n"); 
		query.append("		,X.OWNR_CO_CD" ).append("\n"); 
		query.append("		,X.EQ_USED" ).append("\n"); 
		query.append("		,X.MOVEMENT_STS" ).append("\n"); 
		query.append("		,X.CREATION_YARD" ).append("\n"); 
		query.append("		,X.EVENT_DATE" ).append("\n"); 
		query.append("        ,X.SPOT_BID_FLG" ).append("\n"); 
		query.append("        ,X.SPOT_BID_NO" ).append("\n"); 
		query.append("        ,X.SPOT_BID_DUE_DT" ).append("\n"); 
		query.append("		,X.TRSP_MTY_RQST_DT" ).append("\n"); 
		...
		query.append("			  ,A.TTL_DIST, A.LNK_DIST_DIV_CD" ).append("\n"); 
		...
		query.append("              ,NVL(A.SPOT_BID_FLG,'N') SPOT_BID_FLG" ).append("\n"); 
		query.append("              ,A.SPOT_BID_NO" ).append("\n"); 
		query.append("              ,TO_CHAR(A.SPOT_BID_DUE_DT,'YYYY-MM-DD HH24:MI:SS') SPOT_BID_DUE_DT" ).append("\n"); 
		...
		query.append("	#elseif (${srad_date} == 'S')" ).append("\n"); 
		query.append("		AND A.LOCL_CRE_DT BETWEEN TO_DATE(@[sfrmreqdate], 'YYYYMMDD') AND TO_DATE(@[sstoreqdate], 'YYYYMMDD') + 0.99999 	" ).append("\n"); 
		query.append("	#elseif (${srad_date} == 'B')" ).append("\n"); 
		query.append("		AND A.SPOT_BID_DUE_DT BETWEEN TO_DATE(@[sfrmreqdate], 'YYYYMMDD') AND TO_DATE(@[sstoreqdate], 'YYYYMMDD') + 0.99999 	" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${spotBidFlg} != '')" ).append("\n"); 
		query.append("	AND A.SPOT_BID_FLG = @[spotBidFlg]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${spotBidNo} != '')" ).append("\n"); 
		query.append("	AND A.SPOT_BID_NO = @[spotBidNo]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
