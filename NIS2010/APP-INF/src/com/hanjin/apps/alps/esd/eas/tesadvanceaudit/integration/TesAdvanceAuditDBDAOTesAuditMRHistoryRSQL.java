...
*@FileName : TesAdvanceAuditDBDAOTesAuditMRHistoryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesAdvanceAuditDBDAOTesAuditMRHistoryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TesAdvanceAuditDBDAOTesAuditMRHistoryRSQL(){
		setQuery();
		...
		params.put("s_from_cntr_vsl_clss_capa",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_to_cntr_vsl_clss_capa",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.tesadvanceaudit.integration").append("\n"); 
		query.append("FileName : TesAdvanceAuditDBDAOTesAuditMRHistoryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${s_lane_cd} != '')" ).append("\n"); 
		query.append("   AND D.LANE_CD           = @[s_lane_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${s_cntr_vsl_clss_capa} != ''  && ${s_vsl_cd} == '')" ).append("\n"); 
		query.append("   AND D.VSL_CD IN (SELECT VSL_CD FROM MDM_VSL_CNTR WHERE CNTR_VSL_CLSS_CAPA BETWEEN @[s_from_cntr_vsl_clss_capa] AND @[s_to_cntr_vsl_clss_capa])" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${s_vsl_cd} != '')" ).append("\n"); 
		query.append("   AND D.VSL_CD            = @[s_vsl_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("  )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if ($cntr_tpsz_cds.size() > 0)" ).append("\n"); 
		query.append("  AND D.CNTR_TPSZ_CD IN (" ).append("\n"); 
		query.append("  #foreach($key in ${cntr_tpsz_cds}) " ).append("\n"); 
		query.append("    #if($velocityCount < $cntr_tpsz_cds.size()) " ).append("\n"); 
		query.append("      '$key', " ).append("\n"); 
		query.append("    #else " ).append("\n"); 
		query.append("      '$key' " ).append("\n"); 
		query.append("    #end " ).append("\n"); 
		...
		query.append("  )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY  YD_CD, VVD" ).append("\n"); 
