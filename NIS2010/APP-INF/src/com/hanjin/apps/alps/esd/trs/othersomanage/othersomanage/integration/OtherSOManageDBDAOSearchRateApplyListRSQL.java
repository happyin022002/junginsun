...
public class OtherSOManageDBDAOSearchRateApplyListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",@[PI_CTRL_OFC_CD]            /*  1   */" ).append("\n"); 
		query.append(",@[PI_VNDR_SEQ]               /*  2   */" ).append("\n"); 
		query.append(",@[PI_BASIS_DT]               /*  3   */" ).append("\n"); 
		query.append(",@[PI_WAY_TP_CD]              /*  4   */" ).append("\n"); 
		query.append(",@[PI_EQ_KND_CD]              /*  5   */" ).append("\n"); 
		query.append(",@[PI_EQ_TP_SZ_CD]            /*  6   */" ).append("\n"); 
		query.append(",@[PI_CMB_TP_CD]              /*  7   */" ).append("\n"); 
		query.append(",@[PI_CGO_TP_CD]              /*  8   */" ).append("\n"); 
		query.append(",@[PI_BOUND_CD]               /*  9   */" ).append("\n"); 
		query.append(",@[PI_CRR_MOD_CD]             /*  10   */" ).append("\n"); 
		query.append(",@[PI_COST_MOD_CD]            /*  11   */" ).append("\n"); 
		query.append(",@[PI_CUST_NOMI_TRKR_FLG]     /*  12   */" ).append("\n"); 
		query.append(",@[PI_CUST_CNT_CD]            /*  13   */" ).append("\n"); 
		query.append(",@[PI_CUST_SEQ]               /*  14   */" ).append("\n"); 
		query.append(",@[PI_RAIL_SVC_TP_CD]         /*  15   */" ).append("\n"); 
		query.append(",@[PI_CMDT_CD]                /*  16   */" ).append("\n"); 
		query.append(",@[PI_FROM_NOD_CD]            /*  17   */" ).append("\n"); 
		query.append(",@[PI_VIA_NOD_CD]             /*  18   */" ).append("\n"); 
		query.append(",@[PI_DOOR_NOD_CD]            /*  19   */" ).append("\n"); 
		query.append(",@[PI_TO_NOD_CD]              /*  20   */" ).append("\n"); 
		query.append(",@[PI_BUNDLE_CNT]             /*  21   */" ).append("\n"); 
		query.append(",@[PI_WGT_UOM]                /*  22   */" ).append("\n"); 
		query.append(",@[PI_WGT_QTY]                /*  23   */" ).append("\n"); 
