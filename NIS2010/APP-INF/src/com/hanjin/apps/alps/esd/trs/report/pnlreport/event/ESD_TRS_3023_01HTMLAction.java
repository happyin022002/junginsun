...
*@FileName : ESD_TRS_3023_01HTMLAction.java
...
* --------------------------------------------------------
* History
* 2012.07.20 변종건 [CHM-201217633] Profit & Loss Report for Europe Inland BIZ 생성
=========================================================*/
 ...
 * - ESD_TRS_3023_01SC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 *
 * @author 
 * @see EsdTrs302301Event 참조
 * @since J2EE 1.4
 */
public class ESD_TRS_3023_01HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TRS_3023_01HTMLAction 객체를 생성
	 */
	public ESD_TRS_3023_01HTMLAction(){}
...
public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs302301Event event = new EsdTrs302301Event();
