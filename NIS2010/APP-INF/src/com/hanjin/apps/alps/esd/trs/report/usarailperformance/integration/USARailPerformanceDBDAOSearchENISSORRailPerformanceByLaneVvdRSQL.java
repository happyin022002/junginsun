...
*@FileName : USARailPerformanceDBDAOSearchENISSORRailPerformanceByLaneVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchENISSORRailPerformanceByLaneVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchENISSORRailPerformance SELECT by Lane VVD
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchENISSORRailPerformanceByLaneVvdRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchENISSORRailPerformanceByLaneVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        	SUM(DECODE(SUBSTR(EQ_TPSZ_CD,2,1), '2', 1, 0) /VNDR_NO )   CNTR_20_CNT," ).append("\n"); 
		query.append("        	SUM(DECODE(SUBSTR(EQ_TPSZ_CD,2,1), '4', 1, 0) /VNDR_NO )   CNTR_40_CNT," ).append("\n"); 
		query.append("        	SUM(DECODE(SUBSTR(EQ_TPSZ_CD,2,1), '5', 1, 0) /VNDR_NO )   CNTR_40HC_CNT," ).append("\n"); 
		query.append("        	SUM(DECODE(EQ_TPSZ_CD , 'D7', 1, 0)/VNDR_NO )   CNTR_45_CNT," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("            TR.FM_NOD_CD," ).append("\n"); 
		query.append("            TR.TO_NOD_CD," ).append("\n"); 
		...
		query.append("            COUNT(YY.SUB_RAIL_SEQ) OVER(PARTITION BY YY.TRSP_SO_OFC_CTY_CD, YY.TRSP_SO_SEQ) VNDR_NO  ," ).append("\n"); 
		...
		query.append("       FROM TRS_TRSP_RAIL_BIL_ORD TR," ).append("\n"); 
