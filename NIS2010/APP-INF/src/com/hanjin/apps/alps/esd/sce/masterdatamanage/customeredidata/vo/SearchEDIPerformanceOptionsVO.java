...
*@FileName : SearchEDIPerformanceOptionsVO.java
*@FileTitle : SearchEDIPerformanceOptionsVO
*Open Issues :
*Change history :
...
public class SearchEDIPerformanceOptionsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEDIPerformanceOptionsVO> models = new ArrayList<SearchEDIPerformanceOptionsVO>();
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("edi_sts", "ediStsCon");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEdiStsCon(JSPUtil.getParameter(request, "edi_sts_con", ""));
	}
	 ...
	 */
	public SearchEDIPerformanceOptionsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEDIPerformanceOptionsVO[]
	 */
	public SearchEDIPerformanceOptionsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEDIPerformanceOptionsVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchEDIPerformanceOptionsVO();
		...
		return getSearchEDIPerformanceOptionsVOs();
	}
	 ...
	 * @return SearchEDIPerformanceOptionsVO[]
	 */
	public SearchEDIPerformanceOptionsVO[] getSearchEDIPerformanceOptionsVOs(){
		SearchEDIPerformanceOptionsVO[] vos = (SearchEDIPerformanceOptionsVO[])models.toArray(new SearchEDIPerformanceOptionsVO[models.size()]);
		return vos;
	}
