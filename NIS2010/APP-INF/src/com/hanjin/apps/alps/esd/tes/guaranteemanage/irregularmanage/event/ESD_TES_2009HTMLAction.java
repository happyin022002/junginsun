...
*@FileName : ESD_TES_2009HTMLAction.java
 ...
 * @author Kim Yong Jin
 * @see IrregularManageEvent 참조
 * @since J2EE 1.6
 */

public class ESD_TES_2009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TES_2009HTMLAction 객체를 생성
	 */
	public ESD_TES_2009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes2009Event event = new EsdTes2009Event();
		event.setSearchIrregularHdrVO( (SearchIrregularHdrVO)getVO(request, SearchIrregularHdrVO.class) );
		event.setSearchIrregularCntrListVO( (SearchIrregularCntrListVO)getVO(request, SearchIrregularCntrListVO.class) );
		return  event;
	}
