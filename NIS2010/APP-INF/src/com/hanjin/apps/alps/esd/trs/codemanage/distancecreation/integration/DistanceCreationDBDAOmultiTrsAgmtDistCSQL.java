...
*@FileName : DistanceCreationDBDAOmultiTrsAgmtDistCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DistanceCreationDBDAOmultiTrsAgmtDistCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DistanceCreationDBDAOmultiTrsAgmtDistCSQL(){
		setQuery();
		...
		tmp = java.sql.Types.LONGVARCHAR + ",N";
		arrTmp = tmp.split(",");
		if(arrTmp.length !=2){
			throw new IllegalArgumentException();
		}
		...
		query.append("FileName : DistanceCreationDBDAOmultiTrsAgmtDistCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_AGMT_DIST (" ).append("\n"); 
