...
*@FileName : SearchFeederDgCostVO.java
*@FileTitle : SearchFeederDgCostVO
*Open Issues :
*Change history :
...
public class SearchFeederDgCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchFeederDgCostVO> models = new ArrayList<SearchFeederDgCostVO>();
...
/**
	 ...
	 */
	public SearchFeederDgCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchFeederDgCostVO[]
	 */
	public SearchFeederDgCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchFeederDgCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchFeederDgCostVO();
				if (toNodCd[i] != null)
	...
	public SearchFeederDgCostVO[] getSearchFeederDgCostVOs(){
		SearchFeederDgCostVO[] vos = (SearchFeederDgCostVO[])models.toArray(new SearchFeederDgCostVO[models.size()]);
		return vos;
	}
