...
*@FileName : OceanFeederCostManageDBDAOsearchFeederCostGuidelineExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOsearchFeederCostGuidelineExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOsearchFeederCostGuidelineExistRSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOsearchFeederCostGuidelineExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
