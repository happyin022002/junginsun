...
*@FileName : CreditIncentiveStatusDBDAORemoveVslIncentiveDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAORemoveVslIncentiveDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL Incentive Delete
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAORemoveVslIncentiveDSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAORemoveVslIncentiveDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
