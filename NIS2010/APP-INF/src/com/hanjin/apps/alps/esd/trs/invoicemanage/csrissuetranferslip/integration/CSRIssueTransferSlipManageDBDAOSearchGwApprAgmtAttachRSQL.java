...
*@FileName : CSRIssueTransferSlipManageDBDAOSearchGwApprAgmtAttachRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOSearchGwApprAgmtAttachRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * G/W Approval I/F Agreement Contract 조회
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOSearchGwApprAgmtAttachRSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOSearchGwApprAgmtAttachRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT BB.AGMT_DOC_NO   AS L_ASSETCD" ).append("\n"); 
