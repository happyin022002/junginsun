...
*@FileName : TesMRStorageFreePoolHistoryVO.java
*@FileTitle : TesMRStorageFreePoolHistoryVO
*Open Issues :
*Change history :
...
public class TesMRStorageFreePoolHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesMRStorageFreePoolHistoryVO> models = new ArrayList<TesMRStorageFreePoolHistoryVO>();
	...
	public TesMRStorageFreePoolHistoryVO() {}
...
/**
	 ...
	 * @param request
	 * @return TesMRStorageFreePoolHistoryVO[]
	 */
	public TesMRStorageFreePoolHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesMRStorageFreePoolHistoryVO[]
	 */
	public TesMRStorageFreePoolHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesMRStorageFreePoolHistoryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesMRStorageFreePoolHistoryVO();
				if (ovrVolQty[i] != null)
		...
		return getTesMRStorageFreePoolHistoryVOs();
	}
	 ...
	 * @return TesMRStorageFreePoolHistoryVO[]
	 */
	public TesMRStorageFreePoolHistoryVO[] getTesMRStorageFreePoolHistoryVOs(){
		TesMRStorageFreePoolHistoryVO[] vos = (TesMRStorageFreePoolHistoryVO[])models.toArray(new TesMRStorageFreePoolHistoryVO[models.size()]);
		return vos;
	}
