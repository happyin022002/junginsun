...
*@FileName : USARailPerformanceDBDAOSearchENISInvRailPerformanceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchENISInvRailPerformanceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchENISInvRailPerformance SELECT
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchENISInvRailPerformanceRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchENISInvRailPerformanceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM" ).append("\n"); 
		query.append("     (" ).append("\n"); 
		query.append("      SELECT /*+ USE_NL(XX YY) */ " ).append("\n"); 
		...
		query.append("            SUM(DECODE(SUBSTR(Y.EQ_TPSZ_CD,2,1), '2', 1, 0)            )   CNTR_20_CNT," ).append("\n"); 
		query.append("            SUM(DECODE(SUBSTR(Y.EQ_TPSZ_CD,2,1), '2', Y.INV_BZC_AMT, 0))   CNTR_20_AMT," ).append("\n"); 
		query.append("            SUM(DECODE(SUBSTR(Y.EQ_TPSZ_CD,2,1), '4', 1, 0)            )   CNTR_40_CNT," ).append("\n"); 
		query.append("            SUM(DECODE(SUBSTR(Y.EQ_TPSZ_CD,2,1), '4', Y.INV_BZC_AMT, 0))   CNTR_40_AMT," ).append("\n"); 
		query.append("            SUM(DECODE(SUBSTR(Y.EQ_TPSZ_CD,2,1), '5', 1, 0)            )   CNTR_40HC_CNT," ).append("\n"); 
		query.append("            SUM(DECODE(SUBSTR(Y.EQ_TPSZ_CD,2,1), '5', Y.INV_BZC_AMT, 0))   CNTR_40HC_AMT," ).append("\n"); 
		query.append("            SUM(DECODE( Y.EQ_TPSZ_CD, 'D7', 1, 0))   CNTR_45_CNT," ).append("\n"); 
		query.append("            SUM(DECODE( Y.EQ_TPSZ_CD, 'D7', Y.INV_BZC_AMT ,0 )  )   CNTR_45_AMT" ).append("\n"); 
		query.append("      FROM" ).append("\n"); 
		query.append("#if( ${f_chkprd} == 'M' )" ).append("\n"); 
		...
		query.append("      AND XX.EQ_TPSZ_CD IN (SELECT INTG_CD_VAL_CTNT" ).append("\n"); 
		...
		query.append("              TO_CHAR(X.INV_CFM_DT, 'YYYYMM')," ).append("\n"); 
		query.append("#if( ${f_chkprd} == 'W' )" ).append("\n"); 
		query.append("			  X.WEEK," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("              X.INV_VNDR_SEQ," ).append("\n"); 
		query.append("			  Y.EQ_NO," ).append("\n"); 
		query.append("              DECODE(Y.TRSP_INV_CO_IND_CD, null, DECODE(Y.TRSP_SO_OFC_CTY_CD, null, 'Invoice Only','SML'), 'NIS', 'SML',Y.TRSP_INV_CO_IND_CD)," ).append("\n"); 
		query.append("              XX.TRSP_BND_CD," ).append("\n"); 
		query.append("#if( ${agmt_chk} == 'Y' )" ).append("\n"); 
		query.append("			AGMT_REF_NO," ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("			  XX.SLAN_CD," ).append("\n"); 
		query.append("              XX.VSL_CD||XX.SKD_VOY_NO||XX.SKD_DIR_CD," ).append("\n"); 
		query.append("              Y.CGO_TP_CD," ).append("\n"); 
		query.append("              Y.FM_NOD_CD," ).append("\n"); 
		query.append("              Y.TO_NOD_CD," ).append("\n"); 
		query.append("              X.INV_CURR_CD," ).append("\n"); 
		query.append("              Y.TRSP_INV_CO_IND_CD," ).append("\n"); 
		query.append("              Y.EQ_TPSZ_CD," ).append("\n"); 
		query.append("              Y.INV_BZC_AMT," ).append("\n"); 
		query.append("              LOCTO.LOC_CD," ).append("\n"); 
		query.append("              LOCTO.EQ_CTRL_OFC_CD," ).append("\n"); 
		query.append("              LOCFM.LOC_CD," ).append("\n"); 
		query.append("              LOCFM.EQ_CTRL_OFC_CD" ).append("\n"); 
