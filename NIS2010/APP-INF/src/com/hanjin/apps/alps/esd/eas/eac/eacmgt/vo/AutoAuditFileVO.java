...
*@FileName : AutoAuditFileVO.java
*@FileTitle : AutoAuditFileVO
*Open Issues :
*Change history :
...
public class AutoAuditFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AutoAuditFileVO> models = new ArrayList<AutoAuditFileVO>();
	...
	public AutoAuditFileVO() {}

	public AutoAuditFileVO(String ibflag, String pagerows, String atchFileLnkId, String atchFileLnkSeq, String fileSavId, String creOfcCd, String creUsrId, String creDt, String updUsrId, String updDt, String fileNm, String fileSize, String filePathUrl, String mdlTpCd, String rgstDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public AutoAuditFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AutoAuditFileVO[]
	 */
	public AutoAuditFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AutoAuditFileVO model = null;
	...
	public AutoAuditFileVO[] getAutoAuditFileVOs(){
		AutoAuditFileVO[] vos = (AutoAuditFileVO[])models.toArray(new AutoAuditFileVO[models.size()]);
		return vos;
	}
