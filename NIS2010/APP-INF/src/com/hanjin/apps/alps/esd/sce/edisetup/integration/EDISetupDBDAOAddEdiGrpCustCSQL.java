...
*@FileName : EDISetupDBDAOAddEdiGrpCustCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EDISetupDBDAOAddEdiGrpCustCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EDISetupDBDAOAddEdiGrpCustCSQL(){
		setQuery();
		...
		query.append("FileName : EDISetupDBDAOAddEdiGrpCustCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
