...
*@FileName : InlandLinkManageDBDAOSearchInlandLinkManageListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandLinkManageDBDAOSearchInlandLinkManageListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchInlandLinkManageList
	  * </pre>
	  */
	public InlandLinkManageDBDAOSearchInlandLinkManageListRSQL(){
		setQuery();
		...
		query.append("FileName : InlandLinkManageDBDAOSearchInlandLinkManageListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SUBSTR (l.lnk_dest_nod_cd, 6) dest_type, l.trsp_mod_cd, to_char(l.vndr_seq) vndr_seq," ).append("\n"); 
		...
		query.append("FROM prd_inlnd_each_lnk l, mdm_vendor v,TRS_AGMT_HDR a ,TRS_AGMT_APLY_VNDR AV" ).append("\n"); 
		...
		query.append("AND nvl(TO_CHAR(l.TRSP_AGMT_SEQ),'X') LIKE @[agmt_seq] ||'%'" ).append("\n"); 
		query.append("" ).append("\n"); 
