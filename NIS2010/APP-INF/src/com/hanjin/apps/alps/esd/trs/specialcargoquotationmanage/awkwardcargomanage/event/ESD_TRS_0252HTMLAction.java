...
*@FileName : ESD_TRS_0252HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESD_TRS_0252HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_0252HTMLAction 객체를 생성
	 */
	public ESD_TRS_0252HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0252Event event = new EsdTrs0252Event();
