...
*@FileName : ESD_EAS_0309HTMLAction.java
...
public class ESD_EAS_0309HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0309HTMLAction 객체를 생성
	 */
	public ESD_EAS_0309HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0309Event event = new EsdEas0309Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setHbarInquiryByBkgVO((HbarInquiryByBkgVO)getVO(request, HbarInquiryByBkgVO .class));
		}
