...
*@FileName : TESInterfaceManageDBDAOGetVndrOfcCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInterfaceManageDBDAOGetVndrOfcCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESInterfaceManageDBDAOGetVndrOfcCdRSQL(){
		setQuery();
		...
		query.append("FileName : TESInterfaceManageDBDAOGetVndrOfcCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
