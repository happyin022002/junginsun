...
*@FileName : DwellNotificationDBDAOSearchDwellCandidateTotalCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DwellNotificationDBDAOSearchDwellCandidateTotalCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Candidate Iquery의 type 별 Total을 구한다.
	  * </pre>
	  */
	public DwellNotificationDBDAOSearchDwellCandidateTotalCntRSQL(){
		setQuery();
		...
		query.append("FileName : DwellNotificationDBDAOSearchDwellCandidateTotalCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",SUM(DECODE(AA.DWLL_TM_TP_CD, 'D72', 1, 0)) Tab2Total" ).append("\n"); 
