...
*@FileName : SearchFdrCostBatchErrorVO.java
*@FileTitle : SearchFdrCostBatchErrorVO
*Open Issues :
*Change history :
...
public class SearchFdrCostBatchErrorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchFdrCostBatchErrorVO> models = new ArrayList<SearchFdrCostBatchErrorVO>();
	...
	public SearchFdrCostBatchErrorVO() {}

	public SearchFdrCostBatchErrorVO(String ibflag, String pagerows, String costTrfNo, String fmNodCd, String toNodCd, String pctlIoBndCd, String dirCd, String costErrCd, String errDesc) {
...
/**
	 ...
	 */
	public SearchFdrCostBatchErrorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchFdrCostBatchErrorVO[]
	 */
	public SearchFdrCostBatchErrorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchFdrCostBatchErrorVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchFdrCostBatchErrorVO();
				if (toNodCd[i] != null)
	...
	public SearchFdrCostBatchErrorVO[] getSearchFdrCostBatchErrorVOs(){
		SearchFdrCostBatchErrorVO[] vos = (SearchFdrCostBatchErrorVO[])models.toArray(new SearchFdrCostBatchErrorVO[models.size()]);
		return vos;
	}
