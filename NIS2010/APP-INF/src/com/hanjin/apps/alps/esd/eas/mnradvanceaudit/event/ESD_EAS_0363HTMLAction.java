...
/**
 * EDS_EAS_0363HTMLAction PDTO(Data Transfer Object including Parameters)<br>
 * @author Yulkyu Lee
 * @see EventSupport 참조
 * @since J2EE 1.4
 */
public class ESD_EAS_0363HTMLAction extends HTMLActionSupport {
	private static final long serialVersionUID = 6292978124068251371L;

	/**
     * EDS_EAS_0362HTMLAction 객체를 생성
     */
    public ESD_EAS_0363HTMLAction() {
    }
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0363Event event = new EsdEas0363Event();
		...
		if (command.isCommand(FormCommand.SEARCH)) {
			...
			event.setMnrPreAuditCriterionVOs((MNRPreAuditCriterionVO[]) getVOs(
					request, MNRPreAuditCriterionVO.class));
//			event.setMnrPreAuditCriterionVO((MNRPreAuditCriterionVO) getVO(
//					request, MNRPreAuditCriterionVO.class));
