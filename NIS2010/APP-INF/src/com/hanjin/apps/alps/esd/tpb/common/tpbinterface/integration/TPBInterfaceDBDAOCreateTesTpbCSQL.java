...
*@FileName : TPBInterfaceDBDAOCreateTesTpbCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TPBInterfaceDBDAOCreateTesTpbCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TPBInterfaceDBDAOCreateTesTpbCSQL(){
		setQuery();
		...
		params.put("csr_no_cxl_flg",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TPBInterfaceDBDAOCreateTesTpbCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
