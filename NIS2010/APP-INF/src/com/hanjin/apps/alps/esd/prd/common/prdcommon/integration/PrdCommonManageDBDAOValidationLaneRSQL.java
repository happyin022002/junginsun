...
*@FileName : PrdCommonManageDBDAOValidationLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PrdCommonManageDBDAOValidationLaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PrdCommonManageDBDAOValidationLaneRSQL(){
		setQuery();
		...
		query.append("FileName : PrdCommonManageDBDAOValidationLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT vsl_slan_nm lane_code" ).append("\n"); 
