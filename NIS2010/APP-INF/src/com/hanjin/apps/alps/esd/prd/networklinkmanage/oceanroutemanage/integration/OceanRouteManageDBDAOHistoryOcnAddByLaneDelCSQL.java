...
*@FileName : OceanRouteManageDBDAOHistoryOcnAddByLaneDelCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteManageDBDAOHistoryOcnAddByLaneDelCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * HistoryOcnAddByLaneDel
	  * </pre>
	  */
	public OceanRouteManageDBDAOHistoryOcnAddByLaneDelCSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteManageDBDAOHistoryOcnAddByLaneDelCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
