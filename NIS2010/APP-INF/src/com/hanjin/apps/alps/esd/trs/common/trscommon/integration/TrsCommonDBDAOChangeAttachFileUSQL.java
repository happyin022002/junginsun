...
*@FileName : TrsCommonDBDAOChangeAttachFileUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsCommonDBDAOChangeAttachFileUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TrsCommonDBDAOChangeAttachFileDSQL
	  * </pre>
	  */
	public TrsCommonDBDAOChangeAttachFileUSQL(){
		setQuery();
		...
		query.append("FileName : TrsCommonDBDAOChangeAttachFileUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET ATCH_FILE_LNK_ID =" ).append("\n"); 
		...
		query.append(" WHERE 1 = 1 AND APRO_NO = @[key1]" ).append("\n"); 
