...
public class GuaranteeDAOGuaranteeCommonRSQL implements ISQLTemplate{
	...
	public GuaranteeDAOGuaranteeCommonRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.guaranteemanage.guaranteemanage.vo").append("\n"); 
	...
	public void setQuery(){
		...
		query.append(", '' gnte_cust_cd_tmp	-- Container Info" ).append("\n"); 
		query.append(", '' vndr_seq_tmp		-- Container Info" ).append("\n"); 
		query.append(", '' gnte_tp_cd_tmp		-- Container Info" ).append("\n"); 
		...
		query.append(", '' gnte_no_hidden" ).append("\n"); 
		query.append(", '' irr_no_hidden" ).append("\n"); 
