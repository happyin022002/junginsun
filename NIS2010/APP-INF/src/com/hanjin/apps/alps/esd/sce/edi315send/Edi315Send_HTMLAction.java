...
import com.hanjin.apps.alps.esd.sce.edi315send.event.Edi315SendEvent;
 ...
 * @since J2EE 1.4
 */
public class Edi315Send_HTMLAction extends HTMLActionSupport{
	protected transient Logger log = Logger.getLogger(this.getClass().getName());
	public Edi315Send_HTMLAction(){
