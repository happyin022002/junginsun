...
*@FileName : AsiaOceanFeederCostManageDBDAORemoveFdrRfTrfDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAORemoveFdrRfTrfDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2012.11.21 변종건 [CHM-201220395] Add-on Tariff Management 개선 프로젝트 - AOC_CHN_FDR_RF_TRF_DTL 삭제 처리
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAORemoveFdrRfTrfDtlDSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAORemoveFdrRfTrfDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    AOC_CHN_FDR_RF_TRF_DTL" ).append("\n"); 
