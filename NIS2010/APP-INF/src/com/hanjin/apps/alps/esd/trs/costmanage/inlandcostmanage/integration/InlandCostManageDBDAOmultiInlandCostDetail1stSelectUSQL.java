...
*@FileName : InlandCostManageDBDAOmultiInlandCostDetail1stSelectUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOmultiInlandCostDetail1stSelectUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOmultiInlandCostDetail1stSelectUSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOmultiInlandCostDetail1stSelectUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
