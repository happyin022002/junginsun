...
*@FileName : OceanFeederCostManageDBDAOSearchFeederCostRFRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOSearchFeederCostRFRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * - Ocean Feeder Cost Inquiry 화면의 Reefer 조회
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOSearchFeederCostRFRSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOSearchFeederCostRFRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("FROM    TRS_FDR_COST_TRF_HDR M" ).append("\n"); 
		query.append("      , TRS_FDR_RF_COST_TRF D" ).append("\n"); 
