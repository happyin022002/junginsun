...
*@FileName : ESD_TRS_3005HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_TRS_3005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_3005HTMLAction 객체를 생성
	 */
	public ESD_TRS_3005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs3005Event event = new EsdTrs3005Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchInlandCostAccountVO((SearchInlandCostAccountVO)getVO(request, SearchInlandCostAccountVO .class));
		}
