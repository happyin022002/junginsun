...
*@FileName : AdjustmentManageDBDAOUpdateSecondReviewCloseUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AdjustmentManageDBDAOUpdateSecondReviewCloseUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 각R1~R4를 처리한 후 2nd Review 처리 종료
	  * </pre>
	  */
	public AdjustmentManageDBDAOUpdateSecondReviewCloseUSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentManageDBDAOUpdateSecondReviewCloseUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET N2ND_RVW_AVAL_FLG = NULL" ).append("\n"); 
		query.append(",STL_STS_LST_FLG = 'N'" ).append("\n"); 
		...
		query.append("SELECT MAX(DECODE(ADJ_N2ND_RVW_STS_CD,'R4','R3','R3','R2','R1'))" ).append("\n"); 
		query.append("FROM TPB_ADJ_N2ND_RVW_HIS" ).append("\n"); 
		...
		query.append("AND N2ND_RVW_AVAL_FLG = 'Y'" ).append("\n"); 
		query.append("AND ADJ_N2ND_RVW_SEQ = 1" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("AND STL_STS_LST_FLG = 'Y'" ).append("\n"); 
