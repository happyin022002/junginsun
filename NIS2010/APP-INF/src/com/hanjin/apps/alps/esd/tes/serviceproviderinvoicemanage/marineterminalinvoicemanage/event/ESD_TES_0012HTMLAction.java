 ...
 *
 * @author kimjinjoo
 * @see EsdTes0012Event , ESD_TES_012EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0012HTMLAction extends HTMLActionSupport {


	/**
	 * ESD_TES_013HTMLAction 객체를 생성
	 */
	public ESD_TES_0012HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		log.debug("\n\nESD_TES_TML_0012HTMLAction -> codeLenght = "+codeLength +"\n\n");

		EsdTes0012Event		event	= new EsdTes0012Event();
