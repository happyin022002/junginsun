...
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.BkgVerifyVO;
...
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.integration.RailBillingReqCreateDBDAO;
import com.hanjin.apps.alps.esd.trs.servicesio.sppcomplement.railbillingverifymanage.basic.RailBillingVerifyManageBC;
import com.hanjin.apps.alps.esd.trs.servicesio.sppcomplement.railbillingverifymanage.basic.RailBillingVerifyManageBCImpl;
...
//    	    			(bookingDetailList[i]).setVrfy_lang_tp_cd(langTpCd);
        	...
        	log.error("err "+ex.toString(),ex);
//        	throw new EventException(Constants.UNHANDLED_EXPT_MSG);
        	throw new EventException(Constants.INVALID_CONTAINER_MSG);
        }
