...
*@FileName : AgreementImportDBDAOMultiAgmtHdrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOMultiAgmtHdrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Header 정보 생성
	  * </pre>
	  */
	public AgreementImportDBDAOMultiAgmtHdrCSQL(){
		setQuery();
		...
		params.put("agmt_pic_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AgreementImportDBDAOMultiAgmtHdrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
