...
*@FileName : ESD_TRS_105HTMLAction.java
 ...
 * @see EsdTrs0105Event , ESD_TRS_105EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TRS_0105HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TRS_105HTMLAction 객체를 생성
	 */
	public ESD_TRS_0105HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TRS_105Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0105Event event = new EsdTrs0105Event();
