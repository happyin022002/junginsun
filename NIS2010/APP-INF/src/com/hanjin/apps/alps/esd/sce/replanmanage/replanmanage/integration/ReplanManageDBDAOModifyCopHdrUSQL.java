...
public class ReplanManageDBDAOModifyCopHdrUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("THEN SUBSTR((CASE WHEN A.COP_UPD_RMK IS NULL THEN '' ELSE A.COP_UPD_RMK || CHR(10) END) , LENGTH(TO_CHAR(SYSDATE, 'YYYYMMDDHH24MI') || '> ' || @[cop_upd_rmk]))|| TO_CHAR(SYSDATE, 'YYYYMMDDHH24MI') || '> ' || @[cop_upd_rmk]" ).append("\n"); 
