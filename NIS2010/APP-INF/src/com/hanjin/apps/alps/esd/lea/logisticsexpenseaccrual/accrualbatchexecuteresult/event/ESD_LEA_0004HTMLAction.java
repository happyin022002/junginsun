...
*@FileName : ESD_LEA_0004HTMLAction.java
...
public class ESD_LEA_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0004HTMLAction 객체를 생성
	 */
	public ESD_LEA_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0004Event event = new EsdLea0004Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchResultBookingListVO((SearchAccrualBatchResultBookingListVO)getVO(request, SearchAccrualBatchResultBookingListVO.class));
		}
