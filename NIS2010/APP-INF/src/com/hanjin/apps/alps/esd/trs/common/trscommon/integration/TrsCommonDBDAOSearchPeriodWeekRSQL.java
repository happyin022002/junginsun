...
*@FileName : TrsCommonDBDAOSearchPeriodWeekRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsCommonDBDAOSearchPeriodWeekRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrsCommonDBDAOSearchPeriodWeekRSQL(){
		setQuery();
		...
		query.append("FileName : TrsCommonDBDAOSearchPeriodWeekRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
