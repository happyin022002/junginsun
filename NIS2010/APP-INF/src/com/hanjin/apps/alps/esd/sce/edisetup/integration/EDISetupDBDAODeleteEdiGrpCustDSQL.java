...
*@FileName : EDISetupDBDAODeleteEdiGrpCustDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EDISetupDBDAODeleteEdiGrpCustDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EDISetupDBDAODeleteEdiGrpCustDSQL(){
		setQuery();
		...
		query.append("FileName : EDISetupDBDAODeleteEdiGrpCustDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
