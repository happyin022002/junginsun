...
*@FileName : InlandCostManageDBDAOsearchInlandCostDetailDeleteCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOsearchInlandCostDetailDeleteCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOsearchInlandCostDetailDeleteCheckRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.costmanage.inlandcostmanage.integration").append("\n"); 
		query.append("FileName : InlandCostManageDBDAOsearchInlandCostDetailDeleteCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
