...
/**
 * @author 9014613
 * @see EsdEas0311Event , ESD_EAS_0315EventResponse 참조
 * @since J2EE 1.6
 */
public class ESD_EAS_0311HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0315HTMLAction 객체를 생성
	 */
	public ESD_EAS_0311HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0311Event event = new EsdEas0311Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setTesRowDataVO((TesRowDataVO)getVO(request, TesRowDataVO .class));
		}
