...
*@FileName : BkgCopManageDBDAOSearchPlnSoListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOSearchPlnSoListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BkgCopManageDBDAOSearchPlnSoListRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOSearchPlnSoListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
