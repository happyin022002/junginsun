...
*@FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisDelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisDelUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisDelUSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisDelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
