...
*@FileName : ESD_AOC_3104HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3104HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3104HTMLAction 객체를 생성
	 */
	public ESD_AOC_3104HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3104Event event = new EsdAoc3104Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchInlandCostAccountVO((AsiaInlandCostAccountVO)getVO(request, AsiaInlandCostAccountVO .class));
		}
