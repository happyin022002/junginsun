...
*@FileName : UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.usacostmgt.usainlandcostmanage.integration").append("\n"); 
		query.append("FileName : UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
