...
public class SingleTransportationSOManageDBDAOModifySingleTransportationVoTrsUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       N1ST_NOD_PLN_DT = TO_DATE(@[lst_nod_pln_dt]||@[lst_nod_pln_dt_hms], 'YYYYMMDDHH24MISS'), " ).append("\n"); 
		query.append("       LST_NOD_PLN_DT = TO_DATE(@[lst_nod_pln_dt]||@[lst_nod_pln_dt_hms] , 'YYYYMMDDHH24MISS'), " ).append("\n"); 
		query.append("       DOR_NOD_PLN_DT = TO_DATE(@[dor_nod_pln_dt]||@[dor_nod_pln_dt_hms], 'YYYYMMDDHH24MISS'), " ).append("\n"); 
		...
		query.append("       PRE_PULL_FLG = @[pre_pull_flg]," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("	   IB_VVD_CD = @[ib_vvd_cd]," ).append("\n"); 
		query.append("	   OB_VVD_CD = @[ob_vvd_cd]," ).append("\n"); 
		...
		query.append("	   CNG_RSN_DESC =  REPLACE(@[cng_rsn_desc], CHR(13)||CHR(10), ' ')" ).append("\n"); 
		query.append("WHERE  TRSP_SO_OFC_CTY_CD = @[trsp_so_ofc_cty_cd] " ).append("\n"); 
		query.append("  AND  TRSP_SO_SEQ = @[trsp_so_seq]" ).append("\n"); 
		query.append("  AND  TRSP_SO_STS_CD IN ('C','R')" ).append("\n"); 
