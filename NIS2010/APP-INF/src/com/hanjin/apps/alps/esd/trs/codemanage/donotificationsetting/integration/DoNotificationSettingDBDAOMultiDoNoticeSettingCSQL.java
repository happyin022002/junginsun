...
*@FileName : DoNotificationSettingDBDAOMultiDoNoticeSettingCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DoNotificationSettingDBDAOMultiDoNoticeSettingCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DoNoticeSetting 신규 저장
	  * </pre>
	  */
	public DoNotificationSettingDBDAOMultiDoNoticeSettingCSQL(){
		setQuery();
		...
		query.append("FileName : DoNotificationSettingDBDAOMultiDoNoticeSettingCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_DO_NTFC_SET(" ).append("\n"); 
