...
*@FileName : AsiaFeederReeferCostVO.java
*@FileTitle : AsiaFeederReeferCostVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaFeederReeferCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaFeederReeferCostVO> models = new ArrayList<AsiaFeederReeferCostVO>();
...
/**
	 ...
	 */
	public AsiaFeederReeferCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaFeederReeferCostVO[]
	 */
	public AsiaFeederReeferCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaFeederReeferCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AsiaFeederReeferCostVO();
				if (toNodCd[i] != null)
	 ...
	 * @return AsiaFeederReeferCostVO[]
	 */
	public AsiaFeederReeferCostVO[] getSearchFeederReeferCostVOs(){
		AsiaFeederReeferCostVO[] vos = (AsiaFeederReeferCostVO[])models.toArray(new AsiaFeederReeferCostVO[models.size()]);
		return vos;
	}
