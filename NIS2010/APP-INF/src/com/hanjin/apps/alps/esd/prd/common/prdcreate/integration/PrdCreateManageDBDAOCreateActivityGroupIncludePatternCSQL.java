...
*@FileName : PrdCreateManageDBDAOCreateActivityGroupIncludePatternCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PrdCreateManageDBDAOCreateActivityGroupIncludePatternCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PrdCreateManageDBDAOCreateActivityGroupIncludePatternCSQL(){
		setQuery();
		...
		query.append("FileName : PrdCreateManageDBDAOCreateActivityGroupIncludePatternCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("N1ST_NOD_PLN_DT,DOR_ARR_DT,LST_NOD_ARR_DT, N2ND_NOD_CD, N3RD_NOD_CD, N4TH_NOD_CD, TRSP_MOD_CD," ).append("\n"); 
		...
		query.append("(CASE WHEN BND_RK NOT IN (NVL(GROUP_MIN_DIFF,0),NVL(GROUP_MAX_DIFF,0))  AND NVL(GROUP_MIN_DIFF,0) > 0" ).append("\n"); 
		query.append("       THEN DECODE(BND_RK,1,DECODE(PCTL_IO_BND_CD2,'T',400,'I',600,GROUP_MIN_SEQ - ((GROUP_MIN_DIFF -BND_RK) * GROUP_MIN)),GROUP_MIN_SEQ - ((GROUP_MIN_DIFF -BND_RK) * GROUP_MIN))" ).append("\n"); 
		query.append("      WHEN BND_RK NOT IN (NVL(GROUP_MIN_DIFF,0),NVL(GROUP_MAX_DIFF,0))  AND GROUP_MAX_DIFF > 0" ).append("\n"); 
		query.append("       THEN GROUP_MAX_SEQ + ((BND_RK-GROUP_MAX_DIFF) * 10)" ).append("\n"); 
		query.append("      WHEN BND_RK = GROUP_MIN_DIFF AND GROUP_MIN_DIFF > 0" ).append("\n"); 
		query.append("       THEN GROUP_MIN_SEQ" ).append("\n"); 
		query.append("      WHEN BND_RK = GROUP_MAX_DIFF AND GROUP_MAX_DIFF > 0" ).append("\n"); 
		query.append("       THEN GROUP_MAX_SEQ" ).append("\n"); 
		query.append("      WHEN COST_ACT_GRP_CD = 'COMN'" ).append("\n"); 
		query.append("       THEN 990" ).append("\n"); 
		query.append("      WHEN BND_RK =1 AND GROUP_MIN_DIFF IS NULL AND GROUP_MAX_DIFF IS NULL AND PCTL_IO_BND_CD2 ='T'" ).append("\n"); 
		query.append("       THEN 400" ).append("\n"); 
		query.append("      WHEN BND_RK =1 AND GROUP_MIN_DIFF IS NULL AND GROUP_MAX_DIFF IS NULL AND PCTL_IO_BND_CD2 ='I'" ).append("\n"); 
		query.append("       THEN 600" ).append("\n"); 
		...
		query.append("VSL_SLAN_CD,decode( PCTL_IO_BND_CD,'C', nvl(CTL_OFFICE,'CLTCO'),CTL_OFFICE) CTL_OFFICE," ).append("\n"); 
		query.append("PCTL_COST_MOD_CD,PCTL_IO_BND_CD," ).append("\n"); 
		query.append("ORG_NOD_CD,ORG_NOD_TP_CD," ).append("\n"); 
		query.append("decode( PCTL_IO_BND_CD,'C',nvl(ARR_ST_DT,TO_DATE('197708080000', 'YYYYMMDDHH24MI')), ARR_ST_DT) ARR_ST_DT," ).append("\n"); 
		query.append("DOR_ARR_DT,LST_NOD_ARR_DT,N2ND_NOD_CD,N3RD_NOD_CD,N4TH_NOD_CD,TRSP_MOD_CD," ).append("\n"); 
		...
		query.append("INV_BIL_PATT_DIV_FLG,INLND_ROUT_INCL_STTL_FLG,N1ST_AGMT_SEQ,N2ND_AGMT_SEQ,N3RD_AGMT_SEQ,N1ST_AGMT_REF_NO,N2ND_AGMT_REF_NO," ).append("\n"); 
		query.append("N3RD_AGMT_REF_NO,N1ST_TRSP_AGMT_OFC_CTY_CD,N2ND_TRSP_AGMT_OFC_CTY_CD,N3RD_TRSP_AGMT_OFC_CTY_CD," ).append("\n"); 
		...
		query.append("                           INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK))" ).append("\n"); 
		query.append("                    +13,3),'.-.',NULL)) XX2," ).append("\n"); 
		query.append("    FIRST_VALUE(BND_RK*TO_NUMBER(REGEXP_REPLACE(SUBSTR(@[pattern_str]," ).append("\n"); 
		query.append("                    DECODE(INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK),0,NULL," ).append("\n"); 
		query.append("                           INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK))" ).append("\n"); 
		query.append("                    +13,3),'.-.',NULL))" ).append("\n"); 
		query.append("                                /TO_NUMBER(REGEXP_REPLACE(SUBSTR(@[pattern_str]," ).append("\n"); 
		query.append("                    DECODE(INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK),0,NULL," ).append("\n"); 
		query.append("                           INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK))" ).append("\n"); 
		query.append("                    +13,3),'.-.',NULL)) IGNORE NULLS )" ).append("\n"); 
		...
		query.append("                        DECODE(INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK),0,NULL," ).append("\n"); 
		query.append("                               INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK))" ).append("\n"); 
		query.append("                        +13,3),'.-.',NULL)),100),0,100," ).append("\n"); 
		query.append("                   MOD(TO_NUMBER(REGEXP_REPLACE(SUBSTR(@[pattern_str]," ).append("\n"); 
		query.append("                        DECODE(INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK),0,NULL," ).append("\n"); 
		query.append("                               INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK))" ).append("\n"); 
		query.append("                        +13,3),'.-.',NULL)),100))/DECODE(BND_RK,1,1,BND_RK-1) ) IGNORE NULLS )" ).append("\n"); 
		...
		query.append("                        DECODE(INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK),0,NULL," ).append("\n"); 
		query.append("                               INSTR(REGEXP_REPLACE(@[pattern_str],'-...-','-XXX-'),REGEXP_REPLACE(SO_PLN_STR,'-...-','-XXX-'),1,SO_PLN_RK))" ).append("\n"); 
		query.append("                        +13,3),'.-.',NULL)),100))/DECODE(BND_RK,1,1,BND_RK-1))/2 ) IGNORE NULLS )" ).append("\n"); 
		query.append("                                   OVER (PARTITION BY PCTL_NO, PCTL_IO_BND_CD2 ORDER BY PCTL_SEQ ROWS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING)" ).append("\n"); 
		...
		query.append("    N1ST_VNDR_SEQ,N2ND_VNDR_SEQ,N3RD_VNDR_SEQ,INLND_ROUT_INV_BIL_PATT_CD,N1ST_RD_CRR_CD,N2ND_RD_CRR_CD,N3RD_RD_CRR_CD," ).append("\n"); 
		query.append("    PRE_NOD_CD,PRE_VNDR_SEQ,NXT_NOD_CD,NXT_VNDR_SEQ," ).append("\n"); 
		query.append("    CASE WHEN NVL(@[bkg_no],'NU') = 'NU' AND NVL(@[cop_no],'NU') = 'NU' AND NVL(@[ida_hlg_tp_cd],'NU') = 'NU' THEN TRSP_SO_STS_CD" ).append("\n"); 
		query.append("         WHEN NVL(@[cop_no],'NU') != 'NU' AND (SELECT 1 FROM PRD_SO_CNDDT_CHK CND WHERE CND.TRSP_MOD_CD = AA.TRSP_MOD_CD AND CO_CNT_CD = SUBSTR(AA.ORG_NOD_CD,1,2)) = 1   -- 인도이고 rail 이면  " ).append("\n"); 
		query.append("              THEN (SELECT DECODE(IDA_HLG_TP_CD,'M','U',TRSP_SO_STS_CD) FROM BKG_BOOKING WHERE BKG_NO = (SELECT BKG_NO FROM SCE_COP_HDR WHERE COP_NO = @[cop_no]))" ).append("\n"); 
		query.append("         WHEN NVL(@[bkg_no],'NU') != 'NU' AND (SELECT 1 FROM PRD_SO_CNDDT_CHK CND WHERE CND.TRSP_MOD_CD = AA.TRSP_MOD_CD AND CO_CNT_CD = SUBSTR(AA.ORG_NOD_CD,1,2)) = 1   -- 인도이고 rail 이면  " ).append("\n"); 
		query.append("              THEN (SELECT DECODE(IDA_HLG_TP_CD,'M','U',TRSP_SO_STS_CD) FROM BKG_BOOKING WHERE BKG_NO = @[bkg_no])" ).append("\n"); 
		query.append("         WHEN NVL(@[ida_hlg_tp_cd],'NU') != 'NU' AND (SELECT 1 FROM PRD_SO_CNDDT_CHK CND WHERE CND.TRSP_MOD_CD = AA.TRSP_MOD_CD AND CO_CNT_CD = SUBSTR(AA.ORG_NOD_CD,1,2)) = 1   -- 인도이고 rail 이면  " ).append("\n"); 
		query.append("              THEN DECODE(@[ida_hlg_tp_cd],'M','U',TRSP_SO_STS_CD) " ).append("\n"); 
		query.append("         ELSE TRSP_SO_STS_CD" ).append("\n"); 
		query.append("    END TRSP_SO_STS_CD,  " ).append("\n"); 
		...
		query.append("                    AND LEAD(COST_ACT_GRP_CD) OVER (PARTITION BY PCTL_NO,SUBSTR(ORG_NOD_CD,1,5) ORDER BY PCTL_NO,PCTL_SEQ) ='NTST'" ).append("\n"); 
		...
		query.append("                                COUNT(*) OVER(  PARTITION BY D.PCTL_NO,COST_ACT_GRP_CD, SUBSTR(ORG_NOD_CD,1,5)) CNT," ).append("\n"); 
		query.append("                                RANK() OVER(  PARTITION BY D.PCTL_NO,COST_ACT_GRP_CD, SUBSTR(ORG_NOD_CD,1,5) ORDER BY PCTL_SEQ) RNK," ).append("\n"); 
		query.append("                                (CASE" ).append("\n"); 
		...
		query.append("                                N1ST_NOD_TP_CD, --NOBZ 관련 , 20121010" ).append("\n"); 
		...
		query.append("								,CASE WHEN ( MST.POD_CD,MST.DEL_CD, MST.BKG_DE_TERM_CD)   IN ( ('USLGB','USLAX','Y'),('USLAX','USLGB','Y'),('USOAK','USSFO','Y'),('USSFO','USOAK','Y'))" ).append("\n"); 
		query.append("                                      AND ORG_NOD_CD LIKE MST.DEL_CD||'%' --del node 삭제" ).append("\n"); 
		query.append("                                      AND LAG(D.ORG_NOD_CD,1) OVER (PARTITION BY D.PCTL_NO ORDER BY D.PCTL_SEQ) LIKE MST.POD_CD||'%' --이전 node가 pod 인가" ).append("\n"); 
		query.append("                                      AND MTY_YD_FLG <>'Y' -- mty 는 아닌 " ).append("\n"); 
		query.append("                                     THEN 'X'" ).append("\n"); 
		query.append("                                     ELSE 'Y'" ).append("\n"); 
		query.append("                                END CHK_PORT_EQUALIZATION" ).append("\n"); 
		...
		query.append("                )" ).append("\n"); 
		query.append("                -----------------------------" ).append("\n"); 
		query.append("                WHERE CHK_PORT_EQUALIZATION= 'Y'" ).append("\n"); 
		query.append("                ----------------------------" ).append("\n"); 
		...
		query.append("                DECODE" ).append("\n"); 
		query.append("                (	-- 미주 구분 기준 변경 : INLND_ROUT_INV_BIL_PATT_CD 유무에서 --> I/B일 경우 POD, O/B일 경우 POL 기준으로 US, CA 로 제한 (2010.04.13 김성준 차장 / SELCOL)" ).append("\n"); 
		query.append("                    DECODE(SUBSTR(G.COST_ACT_GRP_CD,3,2),'RD',DECODE(NVL(S.US_CHK,'N'),'Y','X','')),''," ).append("\n"); 
		...
		query.append("                                    AND TRIM(TO_NOD_CD) = DECODE(LENGTH(TRIM(TO_NOD_CD)),2,SUBSTR(S.N4TH_NOD_CD,1,2),5,SUBSTR(S.N4TH_NOD_CD,1,5),7,S.N4TH_NOD_CD)" ).append("\n"); 
		...
		query.append("                    WHEN S.N3RD_TRSP_MOD_CD <> 'N' THEN" ).append("\n"); 
		...
		query.append("                    WHEN S.N2ND_TRSP_MOD_CD <> 'N' THEN" ).append("\n"); 
		...
		query.append("                            (" ).append("\n"); 
		query.append("                             CASE" ).append("\n"); 
		query.append("                                WHEN CNT2 = 0  AND (R_TERM = 'D' OR SUBSTR(PCTL_NO,1,1) ='O' OR NVL(@[ob_tro_flg],'N') = 'Y' ) " ).append("\n"); 
		query.append("									 AND LEAD(TRSP_MOD_CD) OVER (PARTITION BY PCTL_NO ORDER BY PCTL_SEQ) <> 'RD'  --NOBZ 관련 , 20121010" ).append("\n"); 
		query.append("								THEN" ).append("\n"); 
		query.append("                                   LEAD(CNT2) OVER (PARTITION BY PCTL_NO ORDER BY PCTL_SEQ)" ).append("\n"); 
		query.append("                                WHEN CNT2 = 99 AND (D_TERM = 'D' OR SUBSTR(PCTL_NO,1,1) ='I' OR NVL(@[ib_tro_flg],'N') = 'Y' ) THEN" ).append("\n"); 
		...
		query.append("								M.TRSP_MOD_CD, --NOBZ 관련 , 20121010" ).append("\n"); 
		...
		query.append("                                                           END) -- MODIFY BY MGPARK 20110314" ).append("\n"); 
		...
		query.append("								DECODE(M.PCTL_IO_BND_CD,'I',DECODE(SUBSTR(MST.POD_CD,1,2),'US','Y','CA','Y',''),'O',DECODE(SUBSTR(MST.POL_CD,1,2),'US','Y','CA','Y','')) US_CHK" ).append("\n"); 
		query.append("                                ,CASE WHEN ( MST.POD_CD,MST.DEL_CD, MST.BKG_DE_TERM_CD)   IN ( ('USLGB','USLAX','Y'),('USLAX','USLGB','Y'),('USOAK','USSFO','Y'),('USSFO','USOAK','Y'))" ).append("\n"); 
		query.append("                                      AND ORG_NOD_CD LIKE MST.POD_CD||'%' AND DEST_NOD_CD LIKE MST.DEL_CD||'%' " ).append("\n"); 
		query.append("                                      AND ORG_NOD_CD LIKE ROUT_ORG_NOD_CD AND DEST_NOD_CD LIKE ROUT_DEST_NOD_CD" ).append("\n"); 
		query.append("                                      THEN 'X'" ).append("\n"); 
		query.append("                                      ELSE 'Y'" ).append("\n"); 
		query.append("                                END CHK_PORT_EQUALIZATION  " ).append("\n"); 
		query.append("                                FROM" ).append("\n"); 
		...
		query.append("                            )" ).append("\n"); 
		query.append("                            -------------------" ).append("\n"); 
		query.append("                            WHERE CHK_PORT_EQUALIZATION ='Y'-- OR CNT2 = 99" ).append("\n"); 
		query.append("                            -------------------" ).append("\n"); 
		...
		query.append("        ORDER BY 1,2 ASC" ).append("\n"); 
		query.append("    ) AA ORDER BY PCTL_NO,PCTL_SEQ" ).append("\n"); 
		query.append(") ORDER BY 1,2" ).append("\n"); 
