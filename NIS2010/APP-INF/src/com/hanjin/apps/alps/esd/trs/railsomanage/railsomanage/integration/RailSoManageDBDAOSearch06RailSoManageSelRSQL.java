...
public class RailSoManageDBDAOSearch06RailSoManageSelRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	(" ).append("\n"); 
		query.append("		SELECT" ).append("\n"); 
		query.append("			MAX(DECODE(CLZ_TP_CD, 'F', TO_CHAR(NVL(MNL_SET_DT, SYS_SET_DT), 'YYYYMMDD HH24:MI:SS'), '')) AS RAIL_RCV_COFF_FM_DT" ).append("\n"); 
		...
		query.append("	(" ).append("\n"); 
		query.append("		SELECT" ).append("\n"); 
		query.append("			MAX(DECODE(CLZ_TP_CD, 'O', TO_CHAR(NVL(MNL_SET_DT, SYS_SET_DT), 'YYYYMMDD HH24:MI:SS'), '')) AS RAIL_RCV_COFF_TO_DT" ).append("\n"); 
		query.append("		FROM" ).append("\n"); 
		query.append("			BKG_CLZ_TM" ).append("\n"); 
		query.append("		WHERE BKG_NO = C.BKG_NO" ).append("\n"); 
		query.append("		AND	  CLZ_TP_CD = 'O'" ).append("\n"); 
		query.append("		GROUP BY" ).append("\n"); 
		query.append("			BKG_NO" ).append("\n"); 
		query.append("	) RAIL_RCV_COFF_TO_DT," ).append("\n"); 
		query.append("    TO_CHAR( GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC('PHXSA'), 'YYYYMMDD HH24:MI:SS') G_TIME " ).append("\n"); 
		query.append("FROM" ).append("\n"); 
