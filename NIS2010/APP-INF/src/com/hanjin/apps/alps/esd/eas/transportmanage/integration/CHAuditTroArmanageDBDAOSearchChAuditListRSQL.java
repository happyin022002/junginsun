...
public class CHAuditTroArmanageDBDAOSearchChAuditListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DECODE(A.BND,'I',A.dterm,'O',A.rterm) term, --2012-01-11수정" ).append("\n"); 
		query.append("A.TRO_OFC," ).append("\n"); 
		query.append("A.TRO_LOC," ).append("\n"); 
		query.append("A.tro_qty_ch," ).append("\n"); 
		...
		query.append("--TRSO.IO_BND_CD BND, --2011-12-27수정" ).append("\n"); 
		query.append("TRO.IO_BND_CD BND, --2011-12-27수정" ).append("\n"); 
		query.append("--TRSO.BKG_RCVDE_TERM_CD term, --2011-12-27수정" ).append("\n"); 
		query.append("TRO.DE_TERM_CD dterm, --2012-01-11수정  2011-12-27수정" ).append("\n"); 
		query.append("TRO.RCV_TERM_CD rterm, --2012-01-11추가" ).append("\n"); 
		query.append("TRO.TRO_OFC," ).append("\n"); 
		query.append("TRO.LOC_CD TRO_LOC," ).append("\n"); 
		query.append("TRO_QTY_CH.TRO_QTY_CH," ).append("\n"); 
		query.append("--TRSO.QTY tro_qty, --2011-12-27수정" ).append("\n"); 
		query.append("TRO.CNTR_QTY  tro_qty, --2011-12-27수정" ).append("\n"); 
		query.append("TRO.tro_rev tro_rev," ).append("\n"); 
		query.append("--TRSO.TRSO_REV tro_amt, --2011-12-27수정" ).append("\n"); 
		query.append("TRO.tro_rev tro_amt, --2011-12-27수정" ).append("\n"); 
		...
		query.append("--2014-09-02" ).append("\n"); 
		query.append("--CHG_AMT_TBL.CHG_AMT," ).append("\n"); 
		query.append("DECODE(CHG_AMT_TBL.CURR_CD,'EUR',CHG_AMT_TBL.CHG_AMT,TPB_GET_INV_CURR_CHG_FNC(CHG_AMT_TBL.CURR_CD,'EUR',CHG_AMT_TBL.CHG_AMT,CHG_AMT_TBL.UPD_DT)) CHG_AMT," ).append("\n"); 
		...
		query.append("AND CHG_CD IN ('OIH','DIH','OAR','DAR')        --2014-09-02" ).append("\n"); 
		query.append(") CHG_AMT_TBL," ).append("\n"); 
		query.append("(SELECT BKG_NO," ).append("\n"); 
		query.append("NVL(SUM(TRO_QTY_CH),0) TRO_QTY_CH" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("QTY.BKG_NO, 0 TRO_QTY_CH" ).append("\n"); 
		...
		query.append("and  GE_TRO.IO_BND_CD(+) = 'I'" ).append("\n"); 
		query.append("#elseif( ${str_s_bnd} == 'O' )" ).append("\n"); 
		query.append("and  GE_TRO.IO_BND_CD(+) = 'O'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if( ${str_blno} != '' )" ).append("\n"); 
		query.append("AND  QTY.BKG_NO  IN ( select bkg_no from bkg_booking where BL_NO = @[str_blno])" ).append("\n"); 
		query.append("#elseif( ${str_bkgno} != '' )" ).append("\n"); 
		query.append("AND QTY.BKG_NO = @[str_bkgno]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if( ( ${str_fromsodate} != '' && ${str_fromsodate} != 'YYYYMMDD' ) && ( ${str_tosodate} != '' && ${str_tosodate} != 'YYYYMMDD' ) )" ).append("\n"); 
		query.append("AND GE_TRO.CRE_DT >= TO_DATE(@[str_fromsodate],'YYYYMMDD')" ).append("\n"); 
		query.append("AND GE_TRO.CRE_DT <= TO_DATE(@[str_tosodate],'YYYYMMDD')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("QTY.BKG_NO, SUM(DECODE(EU_TRO.HLG_TP_CD, 'C', 1, 0)) TRO_QTY_CH" ).append("\n"); 
		query.append("FROM BKG_QUANTITY QTY ," ).append("\n"); 
		...
		query.append("#if( ( ${str_fromsodate} != '' && ${str_fromsodate} != 'YYYYMMDD' ) && ( ${str_tosodate} != '' && ${str_tosodate} != 'YYYYMMDD' ) )" ).append("\n"); 
		query.append("AND EU_TRO.CRE_DT >= TO_DATE(@[str_fromsodate],'YYYYMMDD')" ).append("\n"); 
		query.append("AND EU_TRO.CRE_DT <= TO_DATE(@[str_tosodate],'YYYYMMDD')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if( ${str_s_bnd} == 'I' )" ).append("\n"); 
		query.append("and  EU_TRO.IO_BND_CD(+) = 'I'" ).append("\n"); 
		query.append("#elseif( ${str_s_bnd} == 'O' )" ).append("\n"); 
		...
		query.append("AND GE_TRO.CNTR_TPSZ_CD NOT IN (" ).append("\n"); 
		query.append("SELECT CNTR_TPSZ_CD" ).append("\n"); 
		query.append("FROM BKG_QUANTITY" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("#if( ${str_blno} != '' )" ).append("\n"); 
		query.append("AND  BKG_NO  IN ( select bkg_no from bkg_booking where BL_NO = @[str_blno])" ).append("\n"); 
		query.append("#elseif( ${str_bkgno} != '' )" ).append("\n"); 
		query.append("AND BKG_NO = @[str_bkgno]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("AND 'N' = GE_TRO.RTN_TRO_FLG" ).append("\n"); 
		query.append("AND 'N' = GE_TRO.CXL_FLG" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if( ${str_blno} != '' )" ).append("\n"); 
		query.append("AND  GE_TRO.BKG_NO  IN ( select bkg_no from bkg_booking where BL_NO = @[str_blno])" ).append("\n"); 
		query.append("#elseif( ${str_bkgno} != '' )" ).append("\n"); 
		query.append("AND GE_TRO.BKG_NO = @[str_bkgno]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if( ( ${str_fromsodate} != '' && ${str_fromsodate} != 'YYYYMMDD' ) && ( ${str_tosodate} != '' && ${str_tosodate} != 'YYYYMMDD' ) )" ).append("\n"); 
		query.append("AND GE_TRO.CRE_DT >= TO_DATE(@[str_fromsodate],'YYYYMMDD')" ).append("\n"); 
		query.append("AND GE_TRO.CRE_DT <= TO_DATE(@[str_tosodate],'YYYYMMDD')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append(") TRO_QTY_CH," ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("GROUP BY  BKG_NO,IO_BND_CD,TRO_SEQ" ).append("\n"); 
		...
		query.append("GROUP BY  TRO.BKG_NO, TRO.IO_BND_CD" ).append("\n"); 
		...
		query.append("FROM" ).append("\n"); 
		query.append("BKG_CONTAINER CN" ).append("\n"); 
		query.append("WHERE  CN.BKG_NO = TRO.BKG_NO" ).append("\n"); 
		...
		query.append("MAX(BKG.RCV_TERM_CD) RCV_TERM_CD, --2012-01-11수정" ).append("\n"); 
		...
		query.append("FROM" ).append("\n"); 
		query.append("BKG_EUR_TRO TRO," ).append("\n"); 
		query.append("BKG_EUR_TRO_DTL TROA," ).append("\n"); 
		...
		query.append("'DIH', AR_CHG.CHG_AMT/c.usd_locl_xch_rt ," ).append("\n"); 
		...
		query.append("FROM" ).append("\n"); 
		query.append("INV_AR_MN AR_MN," ).append("\n"); 
		query.append("INV_AR_CHG AR_CHG," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if( ${str_vvdno} != '' )" ).append("\n"); 
		query.append("AND TRO.bkg_no  IN (" ).append("\n"); 
		...
		query.append("AND TRO.BKG_NO = CHG_AMT_TBL.BKG_NO(+)" ).append("\n"); 
		query.append("AND TRO.BKG_NO = TRO_QTY_CH.BKG_NO(+)" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='Y' and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A')  --O.2" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='D'and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A')   --O.3" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("or ( a.pod_cd = a.del_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='Y' and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') ) --I.2" ).append("\n"); 
		query.append("or ( a.pod_cd = a.del_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='D' and a.pod_cd <> a.tro_loc and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') ) --I.3" ).append("\n"); 
		...
		query.append("#elseif( ${str_s_bnd} == 'O' )" ).append("\n"); 
		query.append("and (a.sts in( 'X', 'A')    --O.1" ).append("\n"); 
		query.append("or ( a.por_cd = a.pol_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='Y' and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') ) --O.2" ).append("\n"); 
		query.append("or ( a.por_cd = a.pol_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='D' and a.pol_cd <> a.tro_loc and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A')  ) --O.3" ).append("\n"); 
		...
		query.append("#elseif( ${str_s_bnd} == 'A' )" ).append("\n"); 
		query.append("and ( a.sts in( 'X', 'A')   --I.1" ).append("\n"); 
		query.append("or ( a.pod_cd = a.del_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='Y' and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') and a.bnd = 'I') --I.2" ).append("\n"); 
		query.append("or ( a.por_cd = a.pol_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='Y' and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') and a.bnd = 'O') --O.2" ).append("\n"); 
		query.append("or ( a.pod_cd = a.del_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='D' and a.pod_cd <> a.tro_loc and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') and a.bnd = 'I') --I.3" ).append("\n"); 
		query.append("or ( a.por_cd = a.pol_cd and DECODE(A.BND,'I',A.dterm,'O',A.rterm)='D' and a.pol_cd <> a.tro_loc and a.ar_rev - a.inv_amt < 0  and a.sts not in( 'X', 'A') and a.bnd = 'O') --O.3" ).append("\n"); 
