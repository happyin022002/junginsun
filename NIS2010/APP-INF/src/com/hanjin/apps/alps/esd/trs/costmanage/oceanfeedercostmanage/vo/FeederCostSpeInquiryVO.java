...
*@FileName : FeederCostSpeInquiryVO.java
*@FileTitle : FeederCostSpeInquiryVO
*Open Issues :
*Change history :
...
public class FeederCostSpeInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FeederCostSpeInquiryVO> models = new ArrayList<FeederCostSpeInquiryVO>();
...
/**
	 ...
	 * @param request
	 * @return FeederCostSpeInquiryVO[]
	 */
	public FeederCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FeederCostSpeInquiryVO[]
	 */
	public FeederCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FeederCostSpeInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new FeederCostSpeInquiryVO();
				if (rfFxRto[i] != null)
	 ...
	 * @return FeederCostSpeInquiryVO[]
	 */
	public FeederCostSpeInquiryVO[] getFeederCostSpeInquiryVOs(){
		FeederCostSpeInquiryVO[] vos = (FeederCostSpeInquiryVO[])models.toArray(new FeederCostSpeInquiryVO[models.size()]);
		return vos;
	}
