...
*@FileName : ESD_SPE_1010HTMLAction.java
...
public class ESD_SPE_1010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SPE_1010HTMLAction 객체를 생성
	 */
	public ESD_SPE_1010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSpe1010Event event = new EsdSpe1010Event();
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setKpiPerformanceTargetVO((KpiPerformanceTargetVO)getVO(request, KpiPerformanceTargetVO .class));
		}else if(command.isCommand(FormCommand.SEARCH02)) {
			event.setKpiPerformanceTargetVO((KpiPerformanceTargetVO)getVO(request, KpiPerformanceTargetVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setKpiPerformanceTargetVOs((KpiPerformanceTargetVO[])getVOs(request, KpiPerformanceTargetVO .class, ""));
		}
