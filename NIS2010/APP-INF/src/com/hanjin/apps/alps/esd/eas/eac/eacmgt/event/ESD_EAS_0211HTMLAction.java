...
*@FileName : ESD_EAS_0211HTMLAction.java
...
public class ESD_EAS_0211HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0211HTMLAction 객체를 생성
	 */
	public ESD_EAS_0211HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0211Event event = new EsdEas0211Event();
		

		if(command.isCommand(FormCommand.MULTI01)) {
			event.setEacNtcVO((EACNtcVO)getVO(request, EACNtcVO.class));
		}else if(command.isCommand(FormCommand.SEARCH01)) {// 메일 발송 정보를 조회한다.
			event.setEacNtcVO((EACNtcVO)getVO(request, EACNtcVO.class));
		}
