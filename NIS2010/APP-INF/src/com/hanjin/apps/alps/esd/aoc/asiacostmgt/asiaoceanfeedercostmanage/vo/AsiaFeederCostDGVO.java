...
*@FileName : AsiaFeederCostDGVO.java
*@FileTitle : AsiaFeederCostDGVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaFeederCostDGVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaFeederCostDGVO> models = new ArrayList<AsiaFeederCostDGVO>();
...
/**
	 ...
	 * @param request
	 * @return AsiaFeederCostDGVO[]
	 */
	public AsiaFeederCostDGVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaFeederCostDGVO[]
	 */
	public AsiaFeederCostDGVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaFeederCostDGVO model = null;
	 ...
	 * @return AsiaFeederCostDGVO[]
	 */
	public AsiaFeederCostDGVO[] getFeederCostDGVOs(){
		AsiaFeederCostDGVO[] vos = (AsiaFeederCostDGVO[])models.toArray(new AsiaFeederCostDGVO[models.size()]);
		return vos;
	}
