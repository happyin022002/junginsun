...
*@FileName : ProductCatalogHinterlandDBDAOCopyPrdProdCtlRoutDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogHinterlandDBDAOCopyPrdProdCtlRoutDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CopyPrdProdCtlRoutDtl
	  * </pre>
	  */
	public ProductCatalogHinterlandDBDAOCopyPrdProdCtlRoutDtlCSQL(){
		setQuery();
		...
		params.put("new_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ProductCatalogHinterlandDBDAOCopyPrdProdCtlRoutDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- AOC 관련 PC 생성 로직" ).append("\n"); 
		...
		query.append("SELECT DECODE(@[new_seq], NULL, NULL, @[hd_pctl_no] || @[new_seq]) PCTL_NO, PCTL_SEQ, ORG_NOD_CD, DEST_NOD_CD, NOD_LNK_DIV_CD, PCTL_IO_BND_CD, TRSP_MOD_CD, PCTL_WTR_DIV_CD, ORG_NOD_TP_CD, DEST_NOD_TP_CD, MTY_YD_FLG, ARR_ST_DT, DEP_FSH_DT, TZ_DWLL_TM_HRS, N1ST_VNDR_SEQ, N2ND_VNDR_SEQ, N3RD_VNDR_SEQ, VSL_SLAN_CD, CRR_CD, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, GEN_AVAL_SPC, D7_AVAL_SPC, RF_AVAL_SPC, INLND_ROUT_INV_BIL_PATT_CD, INLND_ROUT_CMB_FLG, ROUT_ORG_NOD_CD, ROUT_DEST_NOD_CD, ROUT_SEQ, CNST_FLG, ORG_CLPT_IND_SEQ, DEST_CLPT_IND_SEQ, RAIL_CRR_TP_CD, INLND_ROUT_INCL_STTL_FLG, TRSP_AGMT_OFC_CTY_CD, TRSP_AGMT_SEQ, AGMT_REF_NO, CRE_USR_ID, CRE_DT, UPD_USR_ID, UPD_DT" ).append("\n"); 
		query.append("FROM PRD_PROD_CTL_ROUT_DTL" ).append("\n"); 
		query.append("WHERE PCTL_NO LIKE DECODE(@[hd_pctl_no], NULL, NULL, @[hd_pctl_no] || '0001')" ).append("\n"); 
