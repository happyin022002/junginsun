...
*@FileName : CARIssueTransferSlipManageDBDAOCreateApInvDTRB_sumDiffRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CARIssueTransferSlipManageDBDAOCreateApInvDTRB_sumDiffRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateApInvDTRB_sumDiff
	  * </pre>
	  */
	public CARIssueTransferSlipManageDBDAOCreateApInvDTRB_sumDiffRSQL(){
		setQuery();
		...
		query.append("FileName : CARIssueTransferSlipManageDBDAOCreateApInvDTRB_sumDiffRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
