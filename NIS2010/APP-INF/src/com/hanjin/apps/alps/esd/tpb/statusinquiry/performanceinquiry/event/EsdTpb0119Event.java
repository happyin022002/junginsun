...
public class EsdTpb0119Event extends EventSupport {
	...
	public SearchClosingTPBListVO[] getSearchClosingTPBListVOs() {
		return searchClosingTPBListVOs;
	}

	public void setSearchClosingTPBListVOs(
			SearchClosingTPBListVO[] searchClosingTPBListVOs) {
		this.searchClosingTPBListVOs = searchClosingTPBListVOs;
	}
