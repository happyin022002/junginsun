...
*@FileName : SpotBidWorkOrderIssueDBDAOsearchWorkOrderIssueListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpotBidWorkOrderIssueDBDAOsearchWorkOrderIssueListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpotBidWorkOrderIssueDBDAOsearchWorkOrderIssueListRSQL(){
		setQuery();
		...
		query.append("FileName : SpotBidWorkOrderIssueDBDAOsearchWorkOrderIssueListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      A.SPOT_BID_NO, TO_CHAR(A.SPOT_BID_DUE_DT, 'YYYY-MM-DD HH24:MI:SS') SPOT_BID_DUE_DT" ).append("\n"); 
