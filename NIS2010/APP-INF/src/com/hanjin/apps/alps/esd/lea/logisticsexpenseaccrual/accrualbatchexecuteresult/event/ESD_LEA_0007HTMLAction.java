...
*@FileName : ESD_LEA_0007HTMLAction.java
...
public class ESD_LEA_0007HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0007HTMLAction 객체를 생성
	 */
	public ESD_LEA_0007HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0007Event event = new EsdLea0007Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchResultExecuteMonthListVO((SearchAccrualBatchResultExecuteMonthListVO)getVO(request, SearchAccrualBatchResultExecuteMonthListVO .class));
		}
