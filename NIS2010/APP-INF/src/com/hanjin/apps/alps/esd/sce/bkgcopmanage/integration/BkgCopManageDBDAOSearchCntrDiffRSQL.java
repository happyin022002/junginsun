...
*@FileName : BkgCopManageDBDAOSearchCntrDiffRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOSearchCntrDiffRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG 과 COP 간 CNTR 의 불일치 사항을 조회한다.
	  * </pre>
	  */
	public BkgCopManageDBDAOSearchCntrDiffRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOSearchCntrDiffRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
