...
*@FileName : ProductCatalogCreateDBDAOSceBkgGetParamRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOSceBkgGetParamRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * bkg 기준 replan 시 param 셋팅
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOSceBkgGetParamRSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOSceBkgGetParamRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       '' EUR_CHECK, '' MANUAL_FLAG, " ).append("\n"); 
		...
		query.append("       T_VVD,ORG_LOC_CD,DEST_LOC_CD,OCN_SEQ,OB_TRSP_MODE,IB_TRSP_MODE, " ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N1_VVD_SEQ')+10,9)) VVD1," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N1_POLNODE')+10,5)) POL1," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N1_PODNODE')+10,5)) POD1," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N1_SLANECD')+10,3)) LANE1, " ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N2_VVD_SEQ')+10,9)) VVD2," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N2_POLNODE')+10,5)) POL2," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N2_PODNODE')+10,5)) POD2," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N2_SLANECD')+10,3)) LANE2," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N3_VVD_SEQ')+10,9)) VVD3," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N3_POLNODE')+10,5)) POL3," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N3_PODNODE')+10,5)) POD3," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N3_SLANECD')+10,3)) LANE3," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N4_VVD_SEQ')+10,9)) VVD4," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N4_POLNODE')+10,5)) POL4," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N4_PODNODE')+10,5)) POD4," ).append("\n"); 
		query.append("       TRIM(SUBSTR(CLPT_SEQ_STR,  INSTR(CLPT_SEQ_STR,'N4_SLANECD')+10,3)) LANE4," ).append("\n"); 
		...
		query.append("    SELECT H.COP_NO,H.CNTR_NO,BC.CNTR_TPSZ_CD,B.PCTL_NO,B.VSL_CD||B.SKD_VOY_NO||B.SKD_DIR_CD T_VVD,    " ).append("\n"); 
		...
		query.append("                                              )" ).append("\n"); 
		query.append("                   " ).append("\n"); 
		query.append("            ), NVL(BC.POR_NOD_CD,B.POR_NOD_CD)),T2.DOR_NOD_CD) POR_NOD_CD," ).append("\n"); 
		query.append("            -- 추가 E-----------    " ).append("\n"); 
		query.append("          BC.POL_YD_CD, B.POL_NOD_CD,B.POD_NOD_CD,DECODE(T.DOR_NOD_CD,NULL,B.DEL_NOD_CD,T.DOR_NOD_CD) DEL_NOD_CD," ).append("\n"); 
		...
		query.append("          DECODE(T2.DOR_NOD_CD,NULL,SUBSTR(B.POR_NOD_CD,1,5),SUBSTR(T2.DOR_NOD_CD,1,5)) POR_CD,SUBSTR(B.POL_NOD_CD,1,5) POL_CD," ).append("\n"); 
		query.append("          SUBSTR(B.POD_NOD_CD,1,5) POD_CD,DECODE(T.DOR_NOD_CD,NULL,SUBSTR(B.DEL_NOD_CD,1,5),SUBSTR(T.DOR_NOD_CD,1,5)) DEL_CD," ).append("\n"); 
		query.append("          DECODE(T2.DOR_NOD_CD,NULL,NVL(BC.RCV_TERM_CD,B.RCV_TERM_CD),'D')  RCV_TERM_CD, " ).append("\n"); 
		query.append("          DECODE(T.DOR_NOD_CD,NULL,NVL(BC.DE_TERM_CD,B.DE_TERM_CD),'D')  DE_TERM_CD," ).append("\n"); 
		query.append("          NVL(NVL(T2.FM_NOD_CD,PU.NOD_CD),B.MTY_PKUP_YD_CD) MT_PU, NVL(NVL(T.TO_NOD_CD,RTN.NOD_CD),B.MTY_RTN_YD_CD) MT_RTN, @[io_bnd_cd] IO_BND_CD," ).append("\n"); 
		query.append("          -- O/B Shuttle S/O Check" ).append("\n"); 
		query.append("          (SELECT 'N'                                                      " ).append("\n"); 
		query.append("           FROM TRS_TRSP_SVC_ORD T" ).append("\n"); 
		query.append("           WHERE T.COP_NO = H.COP_NO" ).append("\n"); 
		query.append("           AND T.TRSP_BND_CD ='O'" ).append("\n"); 
		query.append("           AND DECODE(T.TRSP_BND_CD,'O',T.TO_NOD_CD,'I',T.FM_NOD_CD) = DECODE(T.TRSP_BND_CD,'O',B.POL_NOD_CD,'I',B.POD_NOD_CD)" ).append("\n"); 
		query.append("           AND DECODE(T.TRSP_BND_CD,'O',SUBSTR(B.POL_NOD_CD,1,5),'I',SUBSTR(B.POD_NOD_CD,1,5)) <> DECODE(T.TRSP_BND_CD,'O',SUBSTR(B.POR_NOD_CD,1,5),'I',SUBSTR(B.DEL_NOD_CD,1,5))" ).append("\n"); 
		...
		query.append("          B.POL_CD ORG_LOC_CD,B.POD_CD DEST_LOC_CD,NULL OCN_SEQ, --OCN 정보" ).append("\n"); 
		query.append("          --OCN.ROUT_ORG_NOD_CD ORG_LOC_CD,OCN.ROUT_DEST_NOD_CD DEST_LOC_CD,OCN.ROUT_SEQ OCN_SEQ, --OCN 정보" ).append("\n"); 
		query.append("          (    " ).append("\n"); 
		query.append("                SELECT " ).append("\n"); 
		query.append("                    'N1_POL_SEQ'||MAX(DECODE(VSL_SEQ,0, POL_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N1_POD_SEQ'||MAX(DECODE(VSL_SEQ,0, POD_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N1_VVD_SEQ'||MAX(DECODE(VSL_SEQ,0, VSL_CD||SKD_VOY_NO||SKD_DIR_CD,'         ')) ||" ).append("\n"); 
		query.append("                    'N1_POLNODE'||MAX(DECODE(VSL_SEQ,0, POL_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N1_PODNODE'||MAX(DECODE(VSL_SEQ,0, POD_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N1_SLANECD'||MAX(DECODE(VSL_SEQ,0, SLAN_CD,'   ')) ||                    " ).append("\n"); 
		query.append("                    'N2_POL_SEQ'||MAX(DECODE(VSL_SEQ,1, POL_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N2_POD_SEQ'||MAX(DECODE(VSL_SEQ,1, POD_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N2_VVD_SEQ'||MAX(DECODE(VSL_SEQ,1, VSL_CD||SKD_VOY_NO||SKD_DIR_CD,'         ')) ||" ).append("\n"); 
		query.append("                    'N2_POLNODE'||MAX(DECODE(VSL_SEQ,1, POL_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N2_PODNODE'||MAX(DECODE(VSL_SEQ,1, POD_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N2_SLANECD'||MAX(DECODE(VSL_SEQ,1, SLAN_CD,'   ')) ||                    " ).append("\n"); 
		query.append("                    'N3_POL_SEQ'||MAX(DECODE(VSL_SEQ,2, POL_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N3_POD_SEQ'||MAX(DECODE(VSL_SEQ,2, POD_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N3_VVD_SEQ'||MAX(DECODE(VSL_SEQ,2, VSL_CD||SKD_VOY_NO||SKD_DIR_CD,'         ')) ||" ).append("\n"); 
		query.append("                    'N3_POLNODE'||MAX(DECODE(VSL_SEQ,2, POL_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N3_PODNODE'||MAX(DECODE(VSL_SEQ,2, POD_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N3_SLANECD'||MAX(DECODE(VSL_SEQ,2, SLAN_CD,'   ')) ||                    " ).append("\n"); 
		query.append("                    'N4_POL_SEQ'||MAX(DECODE(VSL_SEQ,3, POL_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N4_POD_SEQ'||MAX(DECODE(VSL_SEQ,3, POD_CLPT_IND_SEQ,' ')) ||" ).append("\n"); 
		query.append("                    'N4_VVD_SEQ'||MAX(DECODE(VSL_SEQ,3, VSL_CD||SKD_VOY_NO||SKD_DIR_CD,'         ')) || " ).append("\n"); 
		query.append("                    'N4_POLNODE'||MAX(DECODE(VSL_SEQ,3, POL_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N4_PODNODE'||MAX(DECODE(VSL_SEQ,3, POD_CD,'     ')) ||" ).append("\n"); 
		query.append("                    'N4_SLANECD'||MAX(DECODE(VSL_SEQ,3, SLAN_CD,'   ')) CLPT_SEQ" ).append("\n"); 
		query.append("				FROM (" ).append("\n"); 
		query.append("						-- BKG VVD Sequnce 수정 : PreVVD : VSL_PRE_PST_CD = 'S', Trunk VVD : VSL_PRE_PST_CD = 'T', PostVVD : VSL_PRE_PST_CD = 'U'" ).append("\n"); 
		query.append("						-- VSL_PRE_PST_CD, VSL_SEQ 별로 VVD Sequence 읽도록 함." ).append("\n"); 
		query.append("        				SELECT (ROW_NUMBER() OVER (PARTITION BY BKG_NO ORDER BY VSL_PRE_PST_CD, VSL_SEQ) - 1) VSL_SEQ," ).append("\n"); 
		query.append("							BKG_NO, POL_CLPT_IND_SEQ, POD_CLPT_IND_SEQ, VSL_CD, SKD_VOY_NO, SKD_DIR_CD, POL_CD, POD_CD, SLAN_CD" ).append("\n"); 
		query.append("       					FROM BKG_VVD B" ).append("\n"); 
		query.append("        				WHERE B.BKG_NO = (SELECT BKG_NO FROM SCE_COP_HDR WHERE COP_NO = @[cop_no] ) " ).append("\n"); 
		query.append("    			)" ).append("\n"); 
		...
		query.append("          WHERE PCTL_NO =B.PCTL_NO" ).append("\n"); 
		...
		query.append("          TO_CHAR(POL_ETD_DT,'YYYYMMDD') AS POL_ETD_DT" ).append("\n"); 
		query.append("    FROM SCE_COP_HDR H,SCE_COP_DTL PU, SCE_COP_DTL RTN, BKG_CONTAINER BC, BKG_BOOKING B," ).append("\n"); 
		...
		query.append("     AND B.PCTL_NO = M.PCTL_NO" ).append("\n"); 
		query.append("     AND B.PCTL_NO = O.PCTL_NO" ).append("\n"); 
		...
		query.append("     AND B.PCTL_NO = I.PCTL_NO" ).append("\n"); 
		...
		query.append("                       AND ROWNUM =1)" ).append("\n"); 
		query.append("     AND B.PCTL_NO = OCN.PCTL_NO" ).append("\n"); 
