...
*@FileName : CustomerNominatedTruckerRgstDAOMultiCntRgstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerRgstDAOMultiCntRgstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomerNominatedTruckerRgstDAOMultiCntRgstCSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerRgstDAOMultiCntRgstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",@[rgst_ofc_cd]" ).append("\n"); 
		query.append(",@[cost_desc]" ).append("\n"); 
		query.append(",'00' -- disp_sts_cd saved" ).append("\n"); 
