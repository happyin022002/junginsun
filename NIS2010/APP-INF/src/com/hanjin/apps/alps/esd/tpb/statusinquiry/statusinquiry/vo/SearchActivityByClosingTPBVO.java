...
public class SearchActivityByClosingTPBVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cls_mon", getClsMon());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cls_mon", "clsMon");
	 ...
	 * @param clsMon
	 */
	public void setClsMon(String clsMon) {
		this.clsMon = clsMon;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setClsMon(JSPUtil.getParameter(request, prefix + "cls_mon", ""));
	...
	public SearchActivityByClosingTPBVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] clsMon = (JSPUtil.getParameter(request, prefix	+ "cls_mon", length));
	...
	*/
	public void unDataFormat(){
		...
		this.clsMon = this.clsMon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
