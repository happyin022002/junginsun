...
*@FileName : SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CASE" ).append("\n"); 
		query.append("WHEN Q.YD_CD NOT LIKE 'KRPUS%' AND Q.IO_GA_CD = 'O' AND Q.COND_NO = '2'" ).append("\n"); 
		...
		query.append("CASE" ).append("\n"); 
		query.append("WHEN Q.YD_CD NOT LIKE 'KRPUS%' AND Q.IO_GA_CD = 'O' AND Q.COND_NO = '2'" ).append("\n"); 
		query.append("THEN NVL(TO_NUMBER(W.ACT_USD_AMT_20FT),0) * 2" ).append("\n"); 
		...
		query.append("CASE" ).append("\n"); 
		query.append("WHEN Q.YD_CD NOT LIKE 'KRPUS%' AND Q.IO_GA_CD = 'O' AND Q.COND_NO = '2'" ).append("\n"); 
		query.append("THEN NVL(TO_NUMBER(W.ACT_USD_AMT_40FT),0) * 2" ).append("\n"); 
		query.append("ELSE CASE" ).append("\n"); 
		query.append("WHEN (NVL(TO_NUMBER(W.ACT_USD_AMT_20FT),0) <> NVL(TO_NUMBER(Q.AUTO_USD_AMT_20FT),0)) OR (NVL(TO_NUMBER(W.ACT_USD_AMT_40FT),0) <> NVL(TO_NUMBER(Q.AUTO_USD_AMT_40FT),0))" ).append("\n"); 
		...
		query.append("FROM TES_ACT_COST_HDR TH, TES_ACT_COST_DTL TD, TES_ACT_COST_TP_SZ TT, MDM_YARD Y" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND TD.TML_AWK_TS_CD IN ('S' , 'D')" ).append("\n"); 
		query.append("AND TD.IO_GA_CD IN ('I' , 'O')" ).append("\n"); 
		query.append("AND NVL(TH.DELT_FLG,'N') <> 'Y'" ).append("\n"); 
		query.append("AND TH.EXE_STS_CD IN ('C')" ).append("\n"); 
		query.append("AND TO_CHAR(TH.EXE_FM_DT,'YYYYMM') = REPLACE(@[year_month],'-','') --// 년월 날짜 입력값" ).append("\n"); 
		query.append("AND TH.TML_ACT_COST_SEQ > 0" ).append("\n"); 
		...
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("X.IBFLAG, X.TML_ACT_COST_SEQ, X.YD_CD, X.PORT_CD, X.TML_CD, X.MN_YD_FLG, X.TML_AWK_CGO_TRF_TP_CD," ).append("\n"); 
		query.append("'A' IO_BND_CD, 'A' IO_GA_CD, 'A' TML_AWK_TS_CD," ).append("\n"); 
		query.append("0 COND_NO, '' COND_DESC, TO_NUMBER('') TML_AWK_TRF_VER_NO, '' MAN_LOCL_CURR_CD ," ).append("\n"); 
		query.append("TO_NUMBER('') MAN_LOCL_AMT_20FT," ).append("\n"); 
		query.append("TO_NUMBER('') MAN_LOCL_AMT_40FT," ).append("\n"); 
		query.append("TO_NUMBER('') MAN_USD_AMT_20FT," ).append("\n"); 
		query.append("TO_NUMBER('') MAN_USD_AMT_40FT," ).append("\n"); 
		...
		query.append("'' CALC_RMK , X.LST_UPD_USR_ID, X.LST_UPD_DT, X.CRE_USR_OFC_CD, X.UPD_USR_OFC_CD, X.CHK_AUTH_YN, X.SPCL_CGO_REF_SEQ, X.ACT_YD_OFC_AUTH_YN" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("'I' IBFLAG" ).append("\n"); 
		query.append(", TD.TML_ACT_COST_SEQ" ).append("\n"); 
