...
*@FileName : PortPairExceptionDBDAOPartnerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortPairExceptionDBDAOPartnerRSQL implements ISQLTemplate{
