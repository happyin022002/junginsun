...
*@FileName : ESD_SCE_00666HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESD_SCE_0066HTMLAction extends HTMLActionSupport{
    
    /** Constructor
     * 
     */
    public ESD_SCE_0066HTMLAction(){
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	log.debug("Event 0066  spawn");
    	FormCommand command = FormCommand.fromRequest(request);
    	EsdSce0066Event event = new EsdSce0066Event();
    	
       if (command.isCommand(FormCommand.SEARCH01)) {
             log.debug("0066 program ");
             ...
             ArrayList<String> bkg_nos = new ArrayList();
             ArrayList<String> cntr_nos = new ArrayList();
             HashMap map = getParameterArray(request);
             ...
             log.debug("0066 program - bkg_no :" + bkg_no);
             log.debug("0066 program - event_dt :" + event_dt);
             	/*다중처리*/
