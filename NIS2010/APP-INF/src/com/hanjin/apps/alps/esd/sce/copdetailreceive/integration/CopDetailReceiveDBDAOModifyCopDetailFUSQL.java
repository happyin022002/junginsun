...
*@FileName : CopDetailReceiveDBDAOModifyCopDetailFUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOModifyCopDetailFUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CopDetailReceiveDBDAOModifyCopDetailFUSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOModifyCopDetailFUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",act_dt         = to_date(@[in_act_dt],'YYYY/MM/DD HH24:MI:SS')" ).append("\n"); 
