...
*@FileName : TrsCommonDBDAOSearchContiCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsCommonDBDAOSearchContiCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrsCommonDBDAOSearchContiCodeRSQL(){
		setQuery();
		...
		query.append("FileName : TrsCommonDBDAOSearchContiCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	NVL(C.CONTI_CD, '') CONTI_CD /* CONTINENT CODE */" ).append("\n"); 
