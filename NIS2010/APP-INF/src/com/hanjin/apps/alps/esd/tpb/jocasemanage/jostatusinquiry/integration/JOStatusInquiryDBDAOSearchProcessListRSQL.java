...
public class JOStatusInquiryDBDAOSearchProcessListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                            WHERE N3PTY_OFC_TP_CD in ('G', 'J')" ).append("\n"); 
		...
		query.append("      ,NULL REV_AMT" ).append("\n"); 
		...
		query.append("      ,TES.CALC_RMK" ).append("\n"); 
		query.append("--[TPB]-----------------------------------------------------------------------------------------" ).append("\n"); 
		query.append("      ,CASE WHEN NVL(OTPC.OTS_STS_CD,'Z') IN ('R','T','J') THEN COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD02799',OTPG.OTS_STS_DTL_CD)" ).append("\n"); 
		query.append("            ELSE COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD00588', NVL(OTPC.OTS_STS_CD,'Z'))" ).append("\n"); 
		...
		query.append("      ,CTPB.REV_AMT" ).append("\n"); 
		...
		query.append("      ,OTPB.REV_AMT" ).append("\n"); 
		query.append("      ,NULL INV_IF_DT " ).append("\n"); 
		query.append("      ,NULL CRE_USR_ID " ).append("\n"); 
		query.append("      ,NULL INV_IF_OFC_CD       " ).append("\n"); 
		...
		query.append("      ,TES.CALC_RMK" ).append("\n"); 
		query.append("      --[TPB]-----------------------------------------------------------------------------------------" ).append("\n"); 
		query.append("      ,CASE WHEN OTPC.OTS_STS_CD IN ('R','T','J') THEN COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD02799',OTPG.OTS_STS_DTL_CD)" ).append("\n"); 
		query.append("            ELSE COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD00588', OTPC.OTS_STS_CD)" ).append("\n"); 
		query.append("       END AS OTS_STS_NM" ).append("\n"); 
		query.append("      ,OTPB.N3PTY_NO " ).append("\n"); 
		query.append("      ,OTPG.N3PTY_INV_NO " ).append("\n"); 
		query.append("      ,CASE OTPB.VNDR_CUST_DIV_CD WHEN 'V' THEN LPAD(TO_CHAR(OTPB.VNDR_SEQ), 6, '0') WHEN 'C' THEN OTPB.CUST_CNT_CD||LPAD(OTPB.CUST_SEQ, 6, '0') WHEN 'S' THEN OTPB.N3PTY_OFC_CD END AS TRD_PARTY_CODE " ).append("\n"); 
