...
*@FileName : OceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
