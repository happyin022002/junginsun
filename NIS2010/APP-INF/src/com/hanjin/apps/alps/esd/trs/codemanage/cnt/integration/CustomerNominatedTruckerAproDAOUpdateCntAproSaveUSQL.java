...
*@FileName : CustomerNominatedTruckerAproDAOUpdateCntAproSaveUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOUpdateCntAproSaveUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CNT(Customer Nominated Trucker) Approval Save
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOUpdateCntAproSaveUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerAproDAOUpdateCntAproSaveUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET HJS_TRKR_AGMT_NO         = @[hjs_trkr_agmt_no]" ).append("\n"); 
