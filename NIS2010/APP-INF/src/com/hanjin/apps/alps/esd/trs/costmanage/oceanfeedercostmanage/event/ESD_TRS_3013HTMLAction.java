...
*@FileName : ESD_TRS_3013HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_TRS_3013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_3013HTMLAction 객체를 생성
	 */
	public ESD_TRS_3013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs3013Event event = new EsdTrs3013Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setOceanFeederCostCondVO((OceanFeederCostCondVO)getVO(request, OceanFeederCostCondVO .class));
