...
*@FileName : SpperformancEvaluationDBDAOmultiTrsTrspVndrPerfEvSoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpperformancEvaluationDBDAOmultiTrsTrspVndrPerfEvSoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SpperformancEvaluationDBDAOmultiTrsTrspVndrPerfEvSoUSQL(){
		setQuery();
		...
		query.append("FileName : SpperformancEvaluationDBDAOmultiTrsTrspVndrPerfEvSoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
