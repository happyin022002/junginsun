...
*@FileName : SearchCntcBkgNoCntrListVO.java
*@FileTitle : SearchCntcBkgNoCntrListVO
*Open Issues :
*Change history :
...
public class SearchCntcBkgNoCntrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchCntcBkgNoCntrListVO> models = new ArrayList<SearchCntcBkgNoCntrListVO>();
...
/**
	 ...
	 * @param request
	 * @return SearchCntcBkgNoCntrListVO[]
	 */
	public SearchCntcBkgNoCntrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCntcBkgNoCntrListVO[]
	 */
	public SearchCntcBkgNoCntrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchCntcBkgNoCntrListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchCntcBkgNoCntrListVO();
				if (vslCd[i] != null)
		...
		return getSearchCntcBkgNoCntrListVOs();
	}
	 ...
	 * @return SearchCntcBkgNoCntrListVO[]
	 */
	public SearchCntcBkgNoCntrListVO[] getSearchCntcBkgNoCntrListVOs(){
		SearchCntcBkgNoCntrListVO[] vos = (SearchCntcBkgNoCntrListVO[])models.toArray(new SearchCntcBkgNoCntrListVO[models.size()]);
		return vos;
	}
