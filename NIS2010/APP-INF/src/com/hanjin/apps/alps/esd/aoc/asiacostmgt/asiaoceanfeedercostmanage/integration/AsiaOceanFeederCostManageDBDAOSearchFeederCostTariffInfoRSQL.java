...
*@FileName : AsiaOceanFeederCostManageDBDAOSearchFeederCostTariffInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOSearchFeederCostTariffInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOSearchFeederCostTariffInfoRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOSearchFeederCostTariffInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    AOC_CHN_FDR_TRF_DTL D" ).append("\n"); 
