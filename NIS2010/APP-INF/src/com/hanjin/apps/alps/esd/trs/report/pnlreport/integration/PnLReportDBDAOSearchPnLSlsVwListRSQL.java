...
*@FileName : PnLReportDBDAOSearchPnLSlsVwListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PnLReportDBDAOSearchPnLSlsVwListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2012.07.18 변종건 [CHM-201217633] Profit & Loss Report for Europe Inland BIZ 신규 개발 - Sales View
	  * </pre>
	  */
	public PnLReportDBDAOSearchPnLSlsVwListRSQL(){
		setQuery();
		...
		query.append("FileName : PnLReportDBDAOSearchPnLSlsVwListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          SELECT  DIV" ).append("\n"); 
		query.append("                , DECODE(DIV, '3', SVC_SCP_CD, CTRT_OFC_CD||'-'||SVC_SCP_CD)    GRP_NO" ).append("\n"); 
		query.append("                , DECODE(DIV, '1', CTRT_OFC_CD, '2', CTRT_OFC_CD, 'ALL')        CTRT_OFC_CD" ).append("\n"); 
		query.append("                , DECODE(DIV, '1', SVC_SCP_CD, SVC_SCP_CD||' TTL')              SVC_SCP_CD" ).append("\n"); 
		query.append("                , DECODE(DIV, '1', WO_OFC_CD, NULL)                             WO_OFC_CD" ).append("\n"); 
		...
		query.append("                , DECODE(DIV, '3', SVC_SCP_CD, CTRT_OFC_CD||'-'||SVC_SCP_CD)" ).append("\n"); 
		query.append("                , DECODE(DIV, '1', CTRT_OFC_CD, '2', CTRT_OFC_CD, 'ALL')" ).append("\n"); 
		query.append("                , DECODE(DIV, '1', SVC_SCP_CD, SVC_SCP_CD||' TTL')" ).append("\n"); 
		query.append("                , DECODE(DIV, '1', WO_OFC_CD, NULL)" ).append("\n"); 
		...
		query.append("                  DECODE(DIV, '3', 'ZZZZZ', CTRT_OFC_CD)" ).append("\n"); 
		query.append("                , SVC_SCP_CD" ).append("\n"); 
		query.append("                , WO_OFC_CD" ).append("\n"); 
		query.append("                , PRC_CTRT_CUST_TP_NM" ).append("\n"); 
		query.append("                , INLND_REV_TP_NM" ).append("\n"); 
