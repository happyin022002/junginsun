...
public class CSMSendDBDAOAddFlatFileCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		'$$$MSGSTART:'||RPAD('SMLM', 20, ' ')||RPAD('USCS', 20, ' ')||RPAD('AMS315', 10, ' ')||@[flt_file_ref_no]||chr(13)||chr(10) ||  --to_char(sysdate, 'yymmdd'), sce_cntr_sts_msg_flt_file_seq1.nextval" ).append("\n"); 
		query.append("		'MUID : ' || to_char(sysdate, 'yyyymmddhh24miss') || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'SNDID : ' || 'SMLM' || chr(13) || chr(10) || " ).append("\n"); 
		query.append("		'RCVID : ' || 'USCS' || chr(13) || chr(10) || " ).append("\n"); 
