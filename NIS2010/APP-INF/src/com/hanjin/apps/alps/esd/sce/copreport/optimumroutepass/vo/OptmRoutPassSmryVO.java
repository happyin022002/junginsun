...
public class OptmRoutPassSmryVO extends AbstractValueObject {
	...
	/* Column Info */
	private String altPassCnt = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("alt_pass_cnt", getAltPassCnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("alt_pass_cnt", "altPassCnt");
	 ...
	 * @return altPassCnt
	 */
	public String getAltPassCnt() {
		return this.altPassCnt;
	}
	 ...
	 * @param altPassCnt
	 */
	public void setAltPassCnt(String altPassCnt) {
		this.altPassCnt = altPassCnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAltPassCnt(JSPUtil.getParameter(request, prefix + "alt_pass_cnt", ""));
	}
	...
	public OptmRoutPassSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] altPassCnt = (JSPUtil.getParameter(request, prefix	+ "alt_pass_cnt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (altPassCnt[i] != null)
					model.setAltPassCnt(altPassCnt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.altPassCnt = this.altPassCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
