...
*@FileName : InlandRouteManageDBDAOGetNewRouteSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOGetNewRouteSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRouteManageDBDAOGetNewRouteSeqRSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOGetNewRouteSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
