...
*@FileName : EurInlandCostManageDBDAORemoveInlandCostReeferUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAORemoveInlandCostReeferUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAORemoveInlandCostReeferUSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAORemoveInlandCostReeferUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
