...
*@FileName : TerminalAgreementManageDBDAOSearchTypeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOSearchTypeListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Container Type List Inquiry
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOSearchTypeListRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOSearchTypeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
