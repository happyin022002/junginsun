...
* 2009.08.27 손은주(TRS) 
* 1.0 Creation
* 1.2 2011.03.28 손은주 [CHM-201109560-01] Split 04-Intra - Europe Business 관련 VAT 기능 개발 
=========================================================*/
...
public class SearchInvoiceAuditVO extends AbstractValueObject {
	...
	/* Column Info */
	private String bpmSumInvTotAmt = null;
	/* Column Info */
	private String apRvsCngFlg = null;
	/* Column Info */
	private String sbcAmt = null;
	...
	public SearchInvoiceAuditVO(String ibflag, String pagerows, String ifSysKndCdParam, String ifSysKndCd, String trspInvActStsCdParam, String trspInvAudStsCdParam, String trspInvAudStsCd, String comboSvcProvider, String applyCurrency, String invAmt, String vatAmt, String whtAmt, String totAmt, String recieveDt, String issueDt, String trspSoVndrNo, String formCreUsrId, String provUsrId, String provPhnId, String formUsrOfcCd, String invoiceNo, String modeParam, String invNoParam, String invVndrSeqParam, String paymtSpCd, String woNo, String bookingNo, String blNo, String eqNoText, String soNo, String bpmSumInvTotAmt, String apRvsCngFlg, String sbcAmt, String idaCgstAmt, String idaSgstAmt, String idaIgstAmt, String idaUgstAmt) {
		...
		this.bpmSumInvTotAmt = bpmSumInvTotAmt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("bpm_sum_inv_tot_amt", getBpmSumInvTotAmt());
		this.hashColumns.put("ap_rvs_cng_flg", getApRvsCngFlg());
		this.hashColumns.put("sbc_amt", getSbcAmt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("bpm_sum_inv_tot_amt", "bpmSumInvTotAmt");
		this.hashFields.put("ap_rvs_cng_flg", "apRvsCngFlg");
		this.hashFields.put("sbc_amt", "sbcAmt");
	...
	/**
	 * Column Info
	 * @return bpmSumInvTotAmt
	 */
	public String getBpmSumInvTotAmt() {
		return this.bpmSumInvTotAmt;
	}
	
	/**
	 * @return the apRvsCngFlg
	 */
	...
	/**
	 * Column Info
	 * @param bpmSumInvTotAmt
	 */
	public void setBpmSumInvTotAmt(String bpmSumInvTotAmt) {
		this.bpmSumInvTotAmt = bpmSumInvTotAmt;
	}
	
	/**
	 * @param apRvsCngFlg the apRvsCngFlg to set
	 */
	 ...
	 * @return the sbcAmt
	 */
	public String getSbcAmt() {
		return sbcAmt;
	}

	/**
	 * @param sbcAmt the sbcAmt to set
	 */
	public void setSbcAmt(String sbcAmt) {
		this.sbcAmt = sbcAmt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBpmSumInvTotAmt(JSPUtil.getParameter(request, "bpm_sum_inv_tot_amt", ""));
		setApRvsCngFlg(JSPUtil.getParameter(request, "ap_rvs_cng_flg", ""));
		setSbcAmt(JSPUtil.getParameter(request, "sbc_amt", ""));
		
		setIdaCgstAmt(JSPUtil.getParameter(request, "inp_ida_cgst_amt", ""));
		setIdaSgstAmt(JSPUtil.getParameter(request, "inp_ida_sgst_amt", ""));
		setIdaIgstAmt(JSPUtil.getParameter(request, "inp_ida_igst_amt", ""));
		setIdaUgstAmt(JSPUtil.getParameter(request, "inp_ida_ugst_amt", ""));
	}
	...
	public SearchInvoiceAuditVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] bpmSumInvTotAmt = (JSPUtil.getParameter(request, prefix	+ "bpm_sum_inv_tot_amt", length));
			String[] apRvsCngFlg = (JSPUtil.getParameter(request, prefix	+ "ap_rvs_cng_flg", length));
			String[] sbcAmt = (JSPUtil.getParameter(request, prefix	+ "sbc_amt", length));
			
			String[] idaCgstAmt = (JSPUtil.getParameter(request, prefix	+ "inp_ida_cgst_amt", length));
			String[] idaSgstAmt = (JSPUtil.getParameter(request, prefix	+ "inp_ida_sgst_amt", length));
			String[] idaIgstAmt = (JSPUtil.getParameter(request, prefix	+ "inp_ida_igst_amt", length));
			String[] idaUgstAmt = (JSPUtil.getParameter(request, prefix	+ "inp_ida_ugst_amt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (bpmSumInvTotAmt[i] != null)
					model.setBpmSumInvTotAmt(bpmSumInvTotAmt[i]);
				if (apRvsCngFlg[i] != null)
					model.setApRvsCngFlg(apRvsCngFlg[i]);
				if (sbcAmt[i] != null)
					model.setSbcAmt(sbcAmt[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.bpmSumInvTotAmt = this.bpmSumInvTotAmt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.apRvsCngFlg = this.apRvsCngFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sbcAmt = this.sbcAmt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
