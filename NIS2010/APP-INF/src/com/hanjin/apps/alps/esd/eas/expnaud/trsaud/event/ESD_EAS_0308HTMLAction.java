...
*@FileName : ESD_EAS_0308HTMLAction.java
...
public class ESD_EAS_0308HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0308HTMLAction 객체를 생성
	 */
	public ESD_EAS_0308HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0308Event event = new EsdEas0308Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setDropOffChargeInquiryVO((DropOffChargeInquiryVO)getVO(request, DropOffChargeInquiryVO .class));
