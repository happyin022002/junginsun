...
*@FileName : AgreementRailScgDBDAOInsertRailFuelFixScgAgmtVerifyDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementRailScgDBDAOInsertRailFuelFixScgAgmtVerifyDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail Surcharge AgreementFileImport 의 Verify
	  * </pre>
	  */
	public AgreementRailScgDBDAOInsertRailFuelFixScgAgmtVerifyDataCSQL(){
		setQuery();
		...
		params.put("agmt_rail_tmp_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AgreementRailScgDBDAOInsertRailFuelFixScgAgmtVerifyDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_AGMT_RAIL_SCG_RT_TMP" ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("AGMT_RAIL_TMP_SEQ" ).append("\n"); 
