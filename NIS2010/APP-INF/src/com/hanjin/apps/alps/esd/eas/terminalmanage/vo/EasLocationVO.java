...
public class EasLocationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EasLocationVO> models = new ArrayList<EasLocationVO>();
	 ...
	 * @return LocationVO[]
	 */
	public EasLocationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LocationVO[]
	 */
	public EasLocationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EasLocationVO model = null;
	 ...
	 * @return LocationVO[]
	 */
	public EasLocationVO[] getEasLocationVOs(){
		EasLocationVO[] vos = (EasLocationVO[])models.toArray(new EasLocationVO[models.size()]);
		return vos;
	}
