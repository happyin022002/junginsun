...
public class ManualRegisterDBDAOCreateTPBCandidateCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("#if (${s_n3pty_expn_tp_cd} =='PSO')" ).append("\n"); 
		query.append(", SUBSTR(@[eq_no],1,4)" ).append("\n"); 
		query.append(", SUBSTR(@[eq_no],5,4)" ).append("\n"); 
		query.append(", SUBSTR(@[eq_no],9,1)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		...
		query.append("#if (${s_n3pty_expn_tp_cd} =='PSO')" ).append("\n"); 
		query.append(", SUBSTR(@[eq_no],9,1)||SUBSTR(@[eq_no],9,1)" ).append("\n"); 
		query.append("#else" ).append("\n"); 
