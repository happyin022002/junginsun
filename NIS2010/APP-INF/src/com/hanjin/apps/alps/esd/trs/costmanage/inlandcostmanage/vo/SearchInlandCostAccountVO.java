...
*@FileName : SearchInlandCostAccountVO.java
*@FileTitle : SearchInlandCostAccountVO
*Open Issues :
*Change history :
...
public class SearchInlandCostAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInlandCostAccountVO> models = new ArrayList<SearchInlandCostAccountVO>();
...
/**
	 ...
	 */
	public SearchInlandCostAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInlandCostAccountVO[]
	 */
	public SearchInlandCostAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInlandCostAccountVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchInlandCostAccountVO();
	...
	public SearchInlandCostAccountVO[] getSearchInlandCostAccountVOs(){
		SearchInlandCostAccountVO[] vos = (SearchInlandCostAccountVO[])models.toArray(new SearchInlandCostAccountVO[models.size()]);
		return vos;
	}
