...
*@FileName : ESD_AOC_3123HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3123HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3123HTMLAction 객체를 생성
	 */
	public ESD_AOC_3123HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3123Event event = new EsdAoc3123Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchOceanFeederCostAccountVO((AsiaFeederCostAccountVO)getVO(request, AsiaFeederCostAccountVO .class));
		}
