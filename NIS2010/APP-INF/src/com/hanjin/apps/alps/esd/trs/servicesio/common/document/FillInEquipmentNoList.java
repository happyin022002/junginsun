...
public class FillInEquipmentNoList {
	...
	private String ctmScacChkFlg    = "";      //column vndr seq of Ctm movement table 
	
	/**
	 * @return so_eq_flag을 리턴합니다.
	 */
	public String getCtm_scac_chk_flg() {
		return ctmScacChkFlg;
	}
	/**
	 * @param so_eq_flag 설정하려는so_eq_flag입니다.
	 */
	public void setCtm_scac_chk_flg(String ctm_scac_chk_flg) {
		this.ctmScacChkFlg = ctm_scac_chk_flg;
	}
	/**
	 * @return so_eq_flag을 리턴합니다.
	 */
