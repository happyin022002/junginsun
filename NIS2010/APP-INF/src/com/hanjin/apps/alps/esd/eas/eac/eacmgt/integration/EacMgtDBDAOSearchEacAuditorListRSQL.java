...
*@FileName : EacMgtDBDAOSearchEacAuditorListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOSearchEacAuditorListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EacMgtDBDAOSearchEacAuditorListRSQL(){
		setQuery();
		...
		query.append("FileName : EacMgtDBDAOSearchEacAuditorListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT A.EAC_USR_ID" ).append("\n"); 
