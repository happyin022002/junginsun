...
package com.hanjin.apps.alps.esd.trs.invoicemanage.railinvoiceinquirycorrection.vo;
...
public class TrsTrspRailInvWrkVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInvRemark(JSPUtil.getParameter(request, "inv_remark", ""));
		...
		setTrspInvAudStsNm(JSPUtil.getParameter(request, "trsp_inv_aud_sts_nm", ""));
		setInvVndrNm(JSPUtil.getParameter(request, "inv_vndr_nm", ""));
		...
		setWoTotAmt(JSPUtil.getParameter(request, "wo_tot_amt", ""));
