...
*@FileName : AgreementImportDBDAODeleteCorrScgAgmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAODeleteCorrScgAgmtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgreementImportDBDAODeleteCorrScgAgmtUSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAODeleteCorrScgAgmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
