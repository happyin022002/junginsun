 ...
 * @since J2EE 1.4
 */
public class ESD_EAS_0104HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
     * ESD_EAS_0102HTMLAction 객체를 생성
     */
    public ESD_EAS_0104HTMLAction() {}
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0104Event event = new EsdEas0104Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDODCollectionParmVO((DODCollectionParmVO)getVO(request, DODCollectionParmVO .class));
		}
