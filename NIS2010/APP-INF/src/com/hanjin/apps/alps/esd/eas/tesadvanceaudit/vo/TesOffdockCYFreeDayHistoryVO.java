...
*@FileName : TesOffdockCYFreeDayHistoryVO.java
*@FileTitle : TesOffdockCYFreeDayHistoryVO
*Open Issues :
*Change history :
...
public class TesOffdockCYFreeDayHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesOffdockCYFreeDayHistoryVO> models = new ArrayList<TesOffdockCYFreeDayHistoryVO>();
	...
	public TesOffdockCYFreeDayHistoryVO() {}
...
/**
	 ...
	 * @param request
	 * @return TesOffdockCYFreeDayHistoryVO[]
	 */
	public TesOffdockCYFreeDayHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesOffdockCYFreeDayHistoryVO[]
	 */
	public TesOffdockCYFreeDayHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesOffdockCYFreeDayHistoryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesOffdockCYFreeDayHistoryVO();
				if (currCd[i] != null)
		...
		return getTesOffdockCYFreeDayHistoryVOs();
	}
	 ...
	 * @return TesOffdockCYFreeDayHistoryVO[]
	 */
	public TesOffdockCYFreeDayHistoryVO[] getTesOffdockCYFreeDayHistoryVOs(){
		TesOffdockCYFreeDayHistoryVO[] vos = (TesOffdockCYFreeDayHistoryVO[])models.toArray(new TesOffdockCYFreeDayHistoryVO[models.size()]);
		return vos;
	}
