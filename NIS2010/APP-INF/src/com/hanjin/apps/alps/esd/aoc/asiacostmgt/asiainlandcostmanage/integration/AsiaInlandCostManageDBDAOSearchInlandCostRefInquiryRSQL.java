...
*@FileName : AsiaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
