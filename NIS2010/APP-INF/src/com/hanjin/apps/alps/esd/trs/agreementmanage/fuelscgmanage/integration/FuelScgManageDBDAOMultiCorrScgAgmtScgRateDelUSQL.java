...
*@FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateDelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAOMultiCorrScgAgmtScgRateDelUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FuelScgManageDBDAOMultiCorrScgAgmtScgRateDelUSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateDelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
