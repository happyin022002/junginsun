...
*@FileName : UsaInlandCostAccountVO.java
*@FileTitle : UsaInlandCostAccountVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class UsaInlandCostAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaInlandCostAccountVO> models = new ArrayList<UsaInlandCostAccountVO>();
...
/**
	 ...
	 */
	public UsaInlandCostAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaInlandCostAccountVO[]
	 */
	public UsaInlandCostAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaInlandCostAccountVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaInlandCostAccountVO();
	...
	public UsaInlandCostAccountVO[] getSearchInlandCostAccountVOs(){
		UsaInlandCostAccountVO[] vos = (UsaInlandCostAccountVO[])models.toArray(new UsaInlandCostAccountVO[models.size()]);
		return vos;
	}
