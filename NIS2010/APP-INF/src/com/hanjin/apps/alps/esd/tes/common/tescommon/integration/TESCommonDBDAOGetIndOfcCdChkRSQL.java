...
*@FileName : TESCommonDBDAOGetIndOfcCdChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESCommonDBDAOGetIndOfcCdChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESCommonDBDAOGetIndOfcCdChkRSQL(){
		setQuery();
		...
		query.append("FileName : TESCommonDBDAOGetIndOfcCdChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(OFC_CD),1,'Y','N') IDA_OFC_CD" ).append("\n"); 
