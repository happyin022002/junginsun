...
*@FileName : PsoAdvanceAuditDBDAOsearchReBatchTargetCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PsoAdvanceAuditDBDAOsearchReBatchTargetCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PsoAdvanceAuditDBDAOsearchReBatchTargetCheckRSQL(){
		setQuery();
		...
		query.append("FileName : PsoAdvanceAuditDBDAOsearchReBatchTargetCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" WHERE SUB_SYS_CD = 'PSO'" ).append("\n"); 
