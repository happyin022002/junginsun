...
*@FileName : ExceptionDataDBDAOMultiExpTypeDetailForPstmttCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ExceptionDataDBDAOMultiExpTypeDetailForPstmttCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ExceptionDataDBDAOMultiExpTypeDetailForPstmttCSQL(){
		setQuery();
		...
		params.put("f_to_act",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("f_to_act_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("f_to_expt_cd",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.sce.masterdatamanage.exceptiondata.integration").append("\n"); 
		query.append("FileName : ExceptionDataDBDAOMultiExpTypeDetailForPstmttCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* queryStrTAct */" ).append("\n"); 
		query.append("MERGE  INTO   SCE_EXPT_CD A" ).append("\n"); 
		query.append("USING  ( SELECT   @[f_to_expt_cd] AS EXPT_CD         --to Activity expt_cd" ).append("\n"); 
		query.append(", @[f_ibflag] AS IB_FLG  						--insert/update/delete IBSheet SCREEN flag" ).append("\n"); 
		query.append(", @[f_to_act] AS EXPT_CD_NM          --to Activity Code" ).append("\n"); 
		query.append(", @[f_to_act_nm] AS EXPT_CD_DESC     --to Activity Name" ).append("\n"); 
		query.append(", @[f_cop_expt_tp_dtl_desc] AS COP_EXPT_TP_DTL_DESC    --to Activity Description" ).append("\n"); 
		...
		query.append("VALUES (@[f_to_expt_cd], @[f_to_act], @[f_to_act_nm], @[f_cop_expt_tp_dtl_desc], @[f_usr_id], SYSDATE, DECODE(@[f_ibflag],'D','N', @[f_act_flg]), @[f_usr_id])" ).append("\n"); 
