...
public class AdjustmentManageDBDAOSearchWriteOffRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          (SELECT WRTF_RSN_CD " ).append("\n"); 
		query.append("             FROM TPB_ADJ_STS S " ).append("\n"); 
		query.append("            WHERE N3PTY_NO = A.N3PTY_NO " ).append("\n"); 
		query.append("			  AND N3PTY_STL_TP_CD = 'W' " ).append("\n"); 
		query.append("			  AND UPD_DT =(SELECT MAX(UPD_DT) " ).append("\n"); 
		query.append("                             FROM TPB_ADJ_STS Y " ).append("\n"); 
		query.append("							WHERE N3PTY_NO = A.N3PTY_NO " ).append("\n"); 
		query.append("							  AND N3PTY_STL_TP_CD = 'W' ) ) WRTF_RSN_CD --wonjoo" ).append("\n"); 
