...
*@FileName : ESD_PRD_0083HTMLAction.java
...
public class ESD_PRD_0083HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_PRD_0083HTMLAction 객체를 생성
	 */
	public ESD_PRD_0083HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdPrd0083Event event = new EsdPrd0083Event();
		event.setAttribute("pgmNo", request.getServletPath().substring(1,13));
		log.debug("\n\n ESD_PRD_0083HTMLAction-------------------------------------------------------");
...
//		}
		if(command.isCommand(FormCommand.ADD)) {
			event.setPrdValChkVO ((PrdValChkVO)getVO(request, PrdValChkVO.class ));
			log.debug("\n\n PrdValChkVO::"+event.getPrdValChkVO().toString());
		}
