...
*@FileName : ESD_TRS_3004HTMLAction.java
 ...
 * - ESD_TRS_3004SC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 *
 * @author 
 * @see EsdTrs3004Event 참조
 * @since J2EE 1.4
 */
public class ESD_TRS_3004HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TRS_3004HTMLAction 객체를 생성
	 */
	public ESD_TRS_3004HTMLAction(){}
...
public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs3004Event event = new EsdTrs3004Event();
