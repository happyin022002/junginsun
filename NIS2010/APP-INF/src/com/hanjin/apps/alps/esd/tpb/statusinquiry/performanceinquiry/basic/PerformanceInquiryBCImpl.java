...
import com.hanjin.apps.alps.esd.tpb.statusinquiry.performanceinquiry.integration.PerformanceInquiryDBDAO;
...
/**
 * ALPS-PerformanceInquiry Business Logic Basic Command implementation<br>
 * - ALPS-PerformanceInquiry에 대한 비지니스 로직을 처리한다.<br>
 *
 * @author Jong-Geon Byeon
 * @see ESD_TPB_105EventResponse,PerformanceInquiryBC 각 DAO 클래스 참조
 * @since J2EE 1.6
 */
public class PerformanceInquiryBCImpl extends BasicCommandSupport implements PerformanceInquiryBC {
	...
	/**
	 * PerformanceInquiryBCImpl 객체 생성<br>
	 * PerformanceInquiryDBDAO를 생성한다.<br>
	 */
