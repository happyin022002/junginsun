...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorageAccountCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOSearchStorageAccountCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOSearchStorageAccountCodeRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorageAccountCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(REPLACE(D.TML_CRR_CD,'-','')," ).append("\n"); 
		query.append("NULL,C.ACCT_CD,C.CRR_ACCT_CD)  ACCT_CD," ).append("\n"); 
