...
*@FileName : ProductCatalogCreateDBDAOUpdateAssignVvdDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOUpdateAssignVvdDetailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateAssignVvdDetail
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOUpdateAssignVvdDetailUSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOUpdateAssignVvdDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND SUBSTR(D.org_nod_cd, 1, 5) = @[pol]" ).append("\n"); 
		query.append("AND SUBSTR(D.dest_nod_cd, 1, 5) = @[pod]" ).append("\n"); 
