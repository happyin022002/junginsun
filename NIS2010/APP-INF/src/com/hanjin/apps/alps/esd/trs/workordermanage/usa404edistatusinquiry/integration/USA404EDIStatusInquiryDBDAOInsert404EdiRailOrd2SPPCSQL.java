...
*@FileName : USA404EDIStatusInquiryDBDAOInsert404EdiRailOrd2SPPCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOInsert404EdiRailOrd2SPPCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPP에서 404 Cancel Edi에 대한 정보 W/O 테이블에 추가 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOInsert404EdiRailOrd2SPPCSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOInsert404EdiRailOrd2SPPCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
