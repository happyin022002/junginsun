...
*@FileName : AsiaOceanFeederCostManageDBDAOVerifyFeederCostConfirmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOVerifyFeederCostConfirmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOVerifyFeederCostConfirmRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOVerifyFeederCostConfirmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
