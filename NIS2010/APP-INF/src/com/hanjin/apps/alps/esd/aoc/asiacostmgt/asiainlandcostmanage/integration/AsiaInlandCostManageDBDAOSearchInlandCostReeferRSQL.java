...
*@FileName : AsiaInlandCostManageDBDAOSearchInlandCostReeferRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchInlandCostReeferRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchInlandCostReeferRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOSearchInlandCostReeferRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , AOC_CHN_INLND_RF_TRF_DTL R" ).append("\n"); 
