...
public class SearchOceanLaneVO extends AbstractValueObject {
	...
	public SearchOceanLaneVO(String ibflag, String pagerows, String polx, String podx, String lanex, String dirx, String fdrFlgx, String svcTpx, String ttx, String polxetb, String podxetb, String oriLoc, String destLoc, String lane) {
		this.polx = polx;
		this.svcTpx = svcTpx;
		this.oriLoc = oriLoc;
		this.podx = podx;
