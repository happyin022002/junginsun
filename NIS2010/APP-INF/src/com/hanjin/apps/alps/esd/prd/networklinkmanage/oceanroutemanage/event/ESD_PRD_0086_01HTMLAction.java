 ...
 *@FileName : ESD_PRD_0086_01HTMLAction.java
 ...
 *
 * @author kimyoungchul
 * @see EsdPrd0086_01Event , ESD_PRD_086_01EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_PRD_0086_01HTMLAction extends HTMLActionSupport{

	/**
	 * ESD_PRD_0086_01HTMLAction 객체를 생성
	 */
	public ESD_PRD_0086_01HTMLAction(){
	}
...
//		String userId = account.getUsr_id();
		...
		EsdPrd008601Event event = new EsdPrd008601Event();
