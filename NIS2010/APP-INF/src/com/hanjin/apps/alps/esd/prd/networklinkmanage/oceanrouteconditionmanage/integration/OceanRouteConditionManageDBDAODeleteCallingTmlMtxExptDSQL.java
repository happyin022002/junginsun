...
*@FileName : OceanRouteConditionManageDBDAODeleteCallingTmlMtxExptDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteConditionManageDBDAODeleteCallingTmlMtxExptDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanRouteConditionManageDBDAODeleteCallingTmlMtxExptDSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteConditionManageDBDAODeleteCallingTmlMtxExptDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM prd_port_tml_expt ptm" ).append("\n"); 
		...
		query.append("AND ptm.tml_cd = @[tml_cd]" ).append("\n"); 
