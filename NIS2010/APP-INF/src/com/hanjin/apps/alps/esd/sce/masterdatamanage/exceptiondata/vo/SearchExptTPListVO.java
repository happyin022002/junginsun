...
*@FileName : SearchExptTPListVO.java
*@FileTitle : SearchExptTPListVO
*Open Issues :
*Change history :
...
public class SearchExptTPListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchExptTPListVO> models = new ArrayList<SearchExptTPListVO>();
	...
	public SearchExptTPListVO() {}

	public SearchExptTPListVO(String ibflag, String pagerows, String exptCd, String exptCdNm) {
		this.ibflag = ibflag;
		this.exptCd = exptCd;
	 ...
	 * @param request
	 * @return SearchExptTPListVO[]
	 */
	public SearchExptTPListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchExptTPListVO[]
	 */
	public SearchExptTPListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchExptTPListVO model = null;
	 ...
	 * @return SearchExptTPListVO[]
	 */
	public SearchExptTPListVO[] getSearchExptTPListVOs(){
		SearchExptTPListVO[] vos = (SearchExptTPListVO[])models.toArray(new SearchExptTPListVO[models.size()]);
		return vos;
	}
