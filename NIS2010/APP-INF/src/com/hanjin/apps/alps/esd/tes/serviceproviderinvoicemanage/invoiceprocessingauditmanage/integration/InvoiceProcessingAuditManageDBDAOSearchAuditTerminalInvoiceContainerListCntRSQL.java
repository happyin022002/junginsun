...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InvoiceProcessingAuditManage 총 건수
	  * 
	  * SearchAuditTerminalInvoiceContainerListCnt
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListCntRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
