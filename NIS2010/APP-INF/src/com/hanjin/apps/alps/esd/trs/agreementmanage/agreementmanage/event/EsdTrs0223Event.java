...
public class EsdTrs0223Event extends EventSupport {
	...
	public void setRailSurchargeAgmtTmpVo(
			RailSurchargeAgmtTmpVO railSurchargeAgmtTmpVoValue) {
		this.railSurchargeAgmtTmpVo = railSurchargeAgmtTmpVoValue;
	}

	public RailSurchargeAgmtTmpVO[] getRailSurchargeAgmtTmpVos() {
		return railSurchargeAgmtTmpVos;
	}

	public void setRailSurchargeAgmtTmpVos(
			RailSurchargeAgmtTmpVO[] railSurchargeAgmtTmpVosValue) {
		this.railSurchargeAgmtTmpVos = railSurchargeAgmtTmpVosValue;
	}
