...
*@FileName : DwellNotificationDBDAOUpdateCandidateDwllNtfcSvcListDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DwellNotificationDBDAOUpdateCandidateDwllNtfcSvcListDtlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateCandidateDwllNtfcSvcListDtl
	  * </pre>
	  */
	public DwellNotificationDBDAOUpdateCandidateDwllNtfcSvcListDtlUSQL(){
		setQuery();
		...
		params.put("snd_opt_cd_aw",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : DwellNotificationDBDAOUpdateCandidateDwllNtfcSvcListDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  , SND_OPT_CD = DECODE(@[snd_opt_cd_aw],'1','AW','OT')" ).append("\n"); 
