 ...
 *
 * @author byungheeyoo
 * @see EsdTes9030Event , ESD_TES_903EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9034HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_903HTMLAction 객체를 생성
	 */
	public ESD_TES_9034HTMLAction() {
		log.debug("\n\n  constr - ESD_TES_9030HTMLAction  \n\n");
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_9030Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes9030Event event = new EsdTes9030Event();
