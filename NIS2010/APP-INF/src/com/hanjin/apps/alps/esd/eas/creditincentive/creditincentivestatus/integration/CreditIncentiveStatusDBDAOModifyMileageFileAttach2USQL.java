...
*@FileName : CreditIncentiveStatusDBDAOModifyMileageFileAttach2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOModifyMileageFileAttach2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOModifyMileageFileAttach2USQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOModifyMileageFileAttach2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EAS_BNF_MLG" ).append("\n"); 
