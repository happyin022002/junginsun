...
public class ReplanManageDBDAOModifyPlnSoListUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("DELT_USR_ID                 = NVL(@[delt_usr_id],                A.DELT_USR_ID               )," ).append("\n"); 
		query.append("DELT_DT                     = NVL(TO_DATE(@[delt_dt], 'YYYYMMDDHH24MISS'),                    A.DELT_DT                   )," ).append("\n"); 
		...
		query.append(",  " ).append("\n"); 
		query.append("SO_CNDDT_DELT_USR_ID  		= NVL(@[upd_usr_id],				A.SO_CNDDT_DELT_USR_ID		 ),  " ).append("\n"); 
