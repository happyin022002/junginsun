...
*@FileName : OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewDTLUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewDTLUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiOffdock3rdIFlistNewDTLUpdate
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewDTLUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOMultiOffdock3rdIFlistNewDTLUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
