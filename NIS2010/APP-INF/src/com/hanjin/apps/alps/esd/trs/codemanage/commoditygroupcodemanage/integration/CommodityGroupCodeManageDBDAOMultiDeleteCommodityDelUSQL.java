...
*@FileName : CommodityGroupCodeManageDAOMultiDeleteCommodityDelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityGroupCodeManageDBDAOMultiDeleteCommodityDelUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail VENDOR 별 GROUP COMMODITY 재 정의된 자료를 Delete 상태로 변경
	  * </pre>
	  */
	public CommodityGroupCodeManageDBDAOMultiDeleteCommodityDelUSQL(){
		setQuery();
		...
		query.append("FileName : CommodityGroupCodeManageDAOMultiDeleteCommodityDelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
