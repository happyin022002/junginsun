...
public class ProductCatalogCreateDBDAOSelectFullRtnYdCctRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("    SELECT DISTINCT PRD_GET_CCT_FNC(D.ORG_NOD_CD,D.VSL_SLAN_CD,D.SKD_DIR_CD,DECODE(M.RF_SPCL_FLG,'Y','RF',DECODE(M.DG_SPCL_FLG,'Y','DG','DR')),NVL(S.VPS_ETB_DT,D.ARR_ST_DT),NVL(S.VPS_ETD_DT,D.ARR_ST_DT), D.VSL_CD||D.SKD_VOY_NO||D.SKD_DIR_CD) CCT," ).append("\n"); 
		query.append("           M.DG_SPCL_FLG,M.RF_SPCL_FLG,m.FULL_RTN_YD_CD " ).append("\n"); 
