...
*@FileName : CommonPopUpManageDBDAOSearchTroSubOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonPopUpManageDBDAOSearchTroSubOfficeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonPopUpManageDBDAOSearchTroSubOfficeRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.common.popup.integration").append("\n"); 
		query.append("FileName : CommonPopUpManageDBDAOSearchTroSubOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
