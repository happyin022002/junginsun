...
*@FileName : ESD_TES_0004HTMLAction.java
 ...
 *
 * @author byungheeyoo
 * @see EsdTes0004Event , ESD_TES_004EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0004HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_0004HTMLAction 객체를 생성
	 */
	public ESD_TES_0004HTMLAction() {
		log.debug("\n\n  constr - ESD_TES_0004HTMLAction  \n\n");
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_0004Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("\n\n  ESD_TES_0004HTMLAction  \n\n");
		
		EsdTes0004Event event = new EsdTes0004Event();
