...
*@FileName : vslSkdEmlVO.java
*@FileTitle : vslSkdEmlVO
*Open Issues :
*Change history :
...
public class vslSkdEmlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<vslSkdEmlVO> models = new ArrayList<vslSkdEmlVO>();
	...
	public vslSkdEmlVO(String ibflag, String pagerows, String emlJbId, String svcStDt, String svcEndDt, String emlGrpId, String vslSlanCd, String fmPortCd, String toPortCd, String vskdDurId, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String ibFlag, String subscEml) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return vslSkdEmlVO[]
	 */
	public vslSkdEmlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return vslSkdEmlVO[]
	 */
	public vslSkdEmlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		vslSkdEmlVO model = null;
	 ...
	 * @return vslSkdEmlVO[]
	 */
	public vslSkdEmlVO[] getvslSkdEmlVOs(){
		vslSkdEmlVO[] vos = (vslSkdEmlVO[])models.toArray(new vslSkdEmlVO[models.size()]);
		return vos;
	}
