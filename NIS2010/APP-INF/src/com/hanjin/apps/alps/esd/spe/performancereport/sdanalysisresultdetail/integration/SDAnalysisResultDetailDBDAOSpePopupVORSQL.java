...
*@FileName : SDAnalysisResultDetailDBDAOSpePopupVORSQL.java
...
public class SDAnalysisResultDetailDBDAOSpePopupVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SDAnalysisResultDetailDBDAOSpePopupVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.spe.performancereport.sdanalysisresultdetail.integration").append("\n"); 
		query.append("FileName : SDAnalysisResultDetailDBDAOSpePopupVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
