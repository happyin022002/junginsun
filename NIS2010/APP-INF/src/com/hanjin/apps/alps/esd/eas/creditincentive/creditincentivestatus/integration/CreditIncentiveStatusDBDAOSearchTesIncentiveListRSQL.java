...
*@FileName : CreditIncentiveStatusDBDAOSearchTesIncentiveListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOSearchTesIncentiveListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Terminal Incentive list search
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOSearchTesIncentiveListRSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOSearchTesIncentiveListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
