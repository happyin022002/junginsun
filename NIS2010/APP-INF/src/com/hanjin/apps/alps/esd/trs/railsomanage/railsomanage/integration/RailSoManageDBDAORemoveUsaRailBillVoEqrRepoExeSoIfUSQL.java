...
*@FileName : RailSoManageDBDAORemoveUsaRailBillVoEqrRepoExeSoIfUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAORemoveUsaRailBillVoEqrRepoExeSoIfUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 해당 SO를 EQR의 테이블에 Delete 상태로 수정 SQL
	  * </pre>
	  */
	public RailSoManageDBDAORemoveUsaRailBillVoEqrRepoExeSoIfUSQL(){
		setQuery();
		...
		query.append("FileName : RailSoManageDBDAORemoveUsaRailBillVoEqrRepoExeSoIfUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET WO_EXE_FLG = 'N'," ).append("\n"); 
