...
*@FileName : OceanFeederCostManageDBDAOMultiFeederRfCostUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOMultiFeederRfCostUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOMultiFeederRfCostUSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOMultiFeederRfCostUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  TRS_FDR_RF_COST_TRF" ).append("\n"); 
