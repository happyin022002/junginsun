...
*@FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertTerminalAgreementSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertTerminalAgreementSeqRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	NVL(MAX(tml_agmt_dtl_seq),0)+1 MAX_NUM" ).append("\n"); 
