...
public class GuaranteeCommonVO extends AbstractValueObject {
	...
	/* Column Info */
	private String irrNoHidden = null;
	/* Column Info */
	private String gnteCustCdTmp = null;
	/* Column Info */
	...
	/* Column Info */
	private String gnteTpCdTmp = null;
	/* Column Info */
	...
	/* Column Info */
	private String gnteNoHidden = null;
	/* Column Info */
	...
	/* Column Info */
	private String vndrSeqTmp = null;
	/* Column Info */
	...
	public GuaranteeCommonVO(String ibflag, String pagerows, String tesMode, String oid, String idx, String fCmd, String def, String functionname, String ifrid, String fmCreDt, String toCreDt, String cntrNoTmp, String bkgNoTmp, String gnteCustCdTmp, String vndrSeqTmp, String gnteTpCdTmp, String gnteTpCd, String ofcCd, String refNo, String allTmp, String cntrNo, String blNo, String bkgNo, String invNo, String gnteCustCd, String gnteFlg, String gnteNo, String irrNo, String creFlg, String cntrSeq, String sysCd, String appCd, String batchInd, String faxTitle, String param, String rcvInfo, String emailTitle, String emailContents, String emailAddr, String faxNum, String gnteNoHidden, String irrNoHidden) {
		this.irrNoHidden = irrNoHidden;
		this.gnteCustCdTmp = gnteCustCdTmp;
		...
		this.gnteNoHidden = gnteNoHidden;
		this.creFlg = creFlg;
		this.idx = idx;
	...
	public HashMap<String, String> getColumnValues(){
		this.hashColumns.put("irr_no_hidden", getIrrNoHidden());
		this.hashColumns.put("gnte_cust_cd_tmp", getGnteCustCdTmp());
		...
		this.hashColumns.put("all_tmp", getAllTmp());
		...
		this.hashColumns.put("gnte_tp_cd_tmp", getGnteTpCdTmp());
		...
		this.hashColumns.put("gnte_no_hidden", getGnteNoHidden());
		...
		this.hashColumns.put("vndr_seq_tmp", getVndrSeqTmp());
	...
	public HashMap<String, String> getFieldNames(){
		this.hashFields.put("irr_no_hidden", "irrNoHidden");
		this.hashFields.put("gnte_cust_cd_tmp", "gnteCustCdTmp");
		...
		this.hashFields.put("all_tmp", "allTmp");
		...
		this.hashFields.put("gnte_tp_cd_tmp", "gnteTpCdTmp");
		...
		this.hashFields.put("gnte_no_hidden", "gnteNoHidden");
		...
		this.hashFields.put("vndr_seq_tmp", "vndrSeqTmp");
	 ...
	 * @return irrNoHidden
	 */
	public String getIrrNoHidden() {
		return this.irrNoHidden;
	}
	
	/**
	 * Column Info
	 * @return gnteCustCdTmp
	 */
	public String getGnteCustCdTmp() {
		return this.gnteCustCdTmp;
	}
	 ...
	 * @return gnteTpCdTmp
	 */
	public String getGnteTpCdTmp() {
		return this.gnteTpCdTmp;
	}
	 ...
	 * @return gnteNoHidden
	 */
	public String getGnteNoHidden() {
		return this.gnteNoHidden;
	}
	 ...
	 * @return vndrSeqTmp
	 */
	public String getVndrSeqTmp() {
		return this.vndrSeqTmp;
	}
	 ...
	 * @param irrNoHidden
	 */
	public void setIrrNoHidden(String irrNoHidden) {
		this.irrNoHidden = irrNoHidden;
	}
	 ...
	 * @param gnteCustCdTmp
	 */
	public void setGnteCustCdTmp(String gnteCustCdTmp) {
		this.gnteCustCdTmp = gnteCustCdTmp;
	}
	 ...
	 * @param allTmp
	 */
	public void setAllTmp(String allTmp) {
		this.allTmp = allTmp;
	}
	 ...
	 * @param gnteTpCdTmp
	 */
	public void setGnteTpCdTmp(String gnteTpCdTmp) {
		this.gnteTpCdTmp = gnteTpCdTmp;
	}
	 ...
	 * @param gnteNoHidden
	 */
	public void setGnteNoHidden(String gnteNoHidden) {
		this.gnteNoHidden = gnteNoHidden;
	}
	 ...
	 * @param vndrSeqTmp
	 */
	public void setVndrSeqTmp(String vndrSeqTmp) {
		this.vndrSeqTmp = vndrSeqTmp;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setIrrNoHidden(JSPUtil.getParameter(request, prefix + "irr_no_hidden", ""));
		setGnteCustCdTmp(JSPUtil.getParameter(request, prefix + "gnte_cust_cd_tmp", ""));
		setFmCreDt(JSPUtil.getParameter(request, prefix + "fm_cre_dt", ""));
		setGnteCustCd(JSPUtil.getParameter(request, prefix + "gnte_cust_cd", ""));
		...
		setFaxNum(JSPUtil.getParameter(request, prefix + "fax_num", ""));
		setEmailContents(JSPUtil.getParameter(request, prefix + "email_contents", ""));
		setEmailAddr(JSPUtil.getParameter(request, prefix + "email_addr", ""));
		setEmailTitle(JSPUtil.getParameter(request, prefix + "email_title", ""));
		setAllTmp(JSPUtil.getParameter(request, prefix + "all_tmp", ""));
		setBlNo(JSPUtil.getParameter(request, prefix + "bl_no", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setGnteNo(JSPUtil.getParameter(request, prefix + "gnte_no", ""));
		...
		setGnteTpCdTmp(JSPUtil.getParameter(request, prefix + "gnte_tp_cd_tmp", ""));
		setOid(JSPUtil.getParameter(request, prefix + "oid", ""));
		setCntrSeq(JSPUtil.getParameter(request, prefix + "cntr_seq", ""));
		setIrrNo(JSPUtil.getParameter(request, prefix + "irr_no", ""));
		setGnteTpCd(JSPUtil.getParameter(request, prefix + "gnte_tp_cd", ""));
		setBkgNoTmp(JSPUtil.getParameter(request, prefix + "bkg_no_tmp", ""));
		setIfrid(JSPUtil.getParameter(request, prefix + "ifrid", ""));
		setFaxTitle(JSPUtil.getParameter(request, prefix + "fax_title", ""));
		setGnteNoHidden(JSPUtil.getParameter(request, prefix + "gnte_no_hidden", ""));
		setCreFlg(JSPUtil.getParameter(request, prefix + "cre_flg", ""));
		setIdx(JSPUtil.getParameter(request, prefix + "idx", ""));
		setBatchInd(JSPUtil.getParameter(request, prefix + "batch_ind", ""));
		setTesMode(JSPUtil.getParameter(request, prefix + "tes_mode", ""));
		setAppCd(JSPUtil.getParameter(request, prefix + "app_cd", ""));
		setInvNo(JSPUtil.getParameter(request, prefix + "inv_no", ""));
		setOfcCd(JSPUtil.getParameter(request, prefix + "ofc_cd", ""));
		setBkgNo(JSPUtil.getParameter(request, prefix + "bkg_no", ""));
		setVndrSeqTmp(JSPUtil.getParameter(request, prefix + "vndr_seq_tmp", ""));
		setCntrNo(JSPUtil.getParameter(request, prefix + "cntr_no", ""));
		setSysCd(JSPUtil.getParameter(request, prefix + "sys_cd", ""));
		setRefNo(JSPUtil.getParameter(request, prefix + "ref_no", ""));
		setCntrNoTmp(JSPUtil.getParameter(request, prefix + "cntr_no_tmp", ""));
	...
	public GuaranteeCommonVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] irrNoHidden = (JSPUtil.getParameter(request, prefix	+ "irr_no_hidden", length));
			String[] gnteCustCdTmp = (JSPUtil.getParameter(request, prefix	+ "gnte_cust_cd_tmp", length));
			...
			String[] allTmp = (JSPUtil.getParameter(request, prefix	+ "all_tmp", length));
			...
			String[] gnteTpCdTmp = (JSPUtil.getParameter(request, prefix	+ "gnte_tp_cd_tmp", length));
			...
			String[] gnteNoHidden = (JSPUtil.getParameter(request, prefix	+ "gnte_no_hidden", length));
			...
			String[] vndrSeqTmp = (JSPUtil.getParameter(request, prefix	+ "vndr_seq_tmp", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (irrNoHidden[i] != null)
					model.setIrrNoHidden(irrNoHidden[i]);
				if (gnteCustCdTmp[i] != null)
					model.setGnteCustCdTmp(gnteCustCdTmp[i]);
				if (fmCreDt[i] != null)
				...
				if (def[i] != null)
					model.setDef(def[i]);
				if (gnteTpCdTmp[i] != null)
					model.setGnteTpCdTmp(gnteTpCdTmp[i]);
				if (oid[i] != null)
					model.setOid(oid[i]);
				if (cntrSeq[i] != null)
				...
				if (gnteNoHidden[i] != null)
					model.setGnteNoHidden(gnteNoHidden[i]);
				if (creFlg[i] != null)
				...
				if (vndrSeqTmp[i] != null)
					model.setVndrSeqTmp(vndrSeqTmp[i]);
				if (cntrNo[i] != null)
	...
	*/
	public void unDataFormat(){
		this.irrNoHidden = this.irrNoHidden .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.gnteCustCdTmp = this.gnteCustCdTmp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.allTmp = this.allTmp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.gnteTpCdTmp = this.gnteTpCdTmp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.gnteNoHidden = this.gnteNoHidden .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.vndrSeqTmp = this.vndrSeqTmp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
