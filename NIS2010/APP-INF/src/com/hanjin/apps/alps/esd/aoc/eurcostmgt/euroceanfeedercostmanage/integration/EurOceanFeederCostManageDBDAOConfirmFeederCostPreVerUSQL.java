...
*@FileName : EurOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
