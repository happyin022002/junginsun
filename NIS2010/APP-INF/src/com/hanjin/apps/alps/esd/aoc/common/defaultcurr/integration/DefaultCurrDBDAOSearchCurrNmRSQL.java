...
*@FileName : DefaultCurrDBDAOSearchCurrNmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DefaultCurrDBDAOSearchCurrNmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DefaultCurrDBDAOSearchCurrNmRSQL(){
		setQuery();
		...
		query.append("FileName : DefaultCurrDBDAOSearchCurrNmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
