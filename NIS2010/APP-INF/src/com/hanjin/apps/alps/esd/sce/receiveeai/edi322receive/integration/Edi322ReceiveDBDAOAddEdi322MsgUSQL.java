...
public class Edi322ReceiveDBDAOAddEdi322MsgUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("@[SPCL_HNDL_CD] iSPCL_HNDL_CD, @[BL_NO] iBL_EDI_322_NO, HJSEAI_PKG.unescapetext(@[BKG_NO], '&amp;&lt;&#xD;&#xA;&gt;&apos;&quot;') iBKG_EDI_322_NO," ).append("\n"); 
		query.append("sysdate iCRE_DT,sysdate iUPD_DT, @[PSN_CD] iPSN_CD, @[PICKUP_NO] iPKUP_EDI_322_NO, TO_DATE(@[RAIL_DEST_N1ST_ETA_DT], 'yyyy/mm/dd HH24:MI:SS') iRAIL_DEST_N1ST_ETA_DT FROM DUAL ) S" ).append("\n"); 
