...
*@FileName : ESD_EAS_0013HTMLAction.java
...
/**
 * ESD_EAS_0013HTMLAction ���� PDTO(Data Transfer Object including Parameters)<br>
 * @author ho-sam lee
 * @see EventSupport 참조
 * @since J2EE 1.4
 */
public class ESD_EAS_0013HTMLAction extends HTMLActionSupport {
	...
	/**
     * ESD_EAS_0013HTMLAction 객체를 생성
     */
    public ESD_EAS_0013HTMLAction() {
    }

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsdEas0013Event로 파싱하여 request에 셋팅<br>
	 *
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdEas0013Event event = new EsdEas0013Event();
