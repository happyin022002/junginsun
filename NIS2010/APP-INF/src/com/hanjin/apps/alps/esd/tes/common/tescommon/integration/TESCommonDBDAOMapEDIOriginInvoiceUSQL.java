...
*@FileName : TESCommonDBDAOMapEDIOriginInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESCommonDBDAOMapEDIOriginInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * file을 찾으면 mapping해준다.
	  * </pre>
	  */
	public TESCommonDBDAOMapEDIOriginInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : TESCommonDBDAOMapEDIOriginInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TES_EDI_SO_FILE F" ).append("\n"); 
		query.append("SET F.TML_EDI_SO_OFC_CTY_CD = @[tml_edi_so_ofc_cty_cd], F.TML_EDI_SO_SEQ = @[tml_edi_so_seq]" ).append("\n"); 
