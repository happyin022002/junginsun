...
*@FileName : SearchOceanFeederCostAccountVO.java
*@FileTitle : SearchOceanFeederCostAccountVO
*Open Issues :
*Change history :
...
public class SearchOceanFeederCostAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOceanFeederCostAccountVO> models = new ArrayList<SearchOceanFeederCostAccountVO>();
...
/**
	 ...
	 */
	public SearchOceanFeederCostAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOceanFeederCostAccountVO[]
	 */
	public SearchOceanFeederCostAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOceanFeederCostAccountVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOceanFeederCostAccountVO();
		...
		return getSearchOceanFeederCostAccountVOs();
	}
	...
	public SearchOceanFeederCostAccountVO[] getSearchOceanFeederCostAccountVOs(){
		SearchOceanFeederCostAccountVO[] vos = (SearchOceanFeederCostAccountVO[])models.toArray(new SearchOceanFeederCostAccountVO[models.size()]);
		return vos;
	}
