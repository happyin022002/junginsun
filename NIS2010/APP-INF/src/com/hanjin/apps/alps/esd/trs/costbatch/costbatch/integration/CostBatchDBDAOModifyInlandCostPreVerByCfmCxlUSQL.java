...
*@FileName : CostBatchDBDAOModifyInlandCostPreVerByCfmCxlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostBatchDBDAOModifyInlandCostPreVerByCfmCxlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2012.06.19 변종건 [CHM-201217633] Inland Cost Batch Creation 의 Confirm Cancel 시 이전 차수의 Confirm 건 Update 쿼리
	  * </pre>
	  */
	public CostBatchDBDAOModifyInlandCostPreVerByCfmCxlUSQL(){
		setQuery();
		...
		query.append("FileName : CostBatchDBDAOModifyInlandCostPreVerByCfmCxlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
