...
*@FileName : AsiaInlnadCostSpeInquiryVO.java
*@FileTitle : AsiaInlnadCostSpeInquiryVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaInlnadCostSpeInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaInlnadCostSpeInquiryVO> models = new ArrayList<AsiaInlnadCostSpeInquiryVO>();
	 ...
	 */
	public AsiaInlnadCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaInlnadCostSpeInquiryVO[]
	 */
	public AsiaInlnadCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaInlnadCostSpeInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AsiaInlnadCostSpeInquiryVO();
				if (rfFxRto[i] != null)
	...
	public AsiaInlnadCostSpeInquiryVO[] getInlnadCostSpeInquiryVOs(){
		AsiaInlnadCostSpeInquiryVO[] vos = (AsiaInlnadCostSpeInquiryVO[])models.toArray(new AsiaInlnadCostSpeInquiryVO[models.size()]);
		return vos;
	}
