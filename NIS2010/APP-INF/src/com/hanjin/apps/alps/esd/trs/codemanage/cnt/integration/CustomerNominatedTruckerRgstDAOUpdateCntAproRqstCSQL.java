...
*@FileName : CustomerNominatedTruckerRgstDAOUpdateCntAproRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerRgstDAOUpdateCntAproRqstCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Approval Requset시 Insert
	  * </pre>
	  */
	public CustomerNominatedTruckerRgstDAOUpdateCntAproRqstCSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerRgstDAOUpdateCntAproRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,@[vndr_seq]" ).append("\n"); 
		query.append("		,@[io_bnd_cd] " ).append("\n"); 
		query.append("		,@[org_nod_cd] || @[org_nod_yard]" ).append("\n"); 
		query.append("		,@[dest_nod_cd] || @[dest_nod_yard]" ).append("\n"); 
		query.append("		,@[mty_pkup_rtn_yd_cd]" ).append("\n"); 
		query.append("		,@[cntr_tpsz_cd]" ).append("\n"); 
		query.append("		,@[cust_nomi_trkr_bzc_amt]" ).append("\n"); 
		query.append("		,@[cust_nomi_trkr_fuel_div_cd]" ).append("\n"); 
		...
		query.append("		,@[cost_desc]" ).append("\n"); 
		query.append("		,'01' -- disp_sts_cd saved" ).append("\n"); 
		...
		query.append("		,@[upd_usr_id] -- 세션 User_id" ).append("\n"); 
