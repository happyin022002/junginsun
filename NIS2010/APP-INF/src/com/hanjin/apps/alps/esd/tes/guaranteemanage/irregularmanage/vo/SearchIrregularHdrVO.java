...
*@FileName : SearchIrregularHdrVO.java
*@FileTitle : SearchIrregularHdrVO
*Open Issues :
*Change history :
...
public class SearchIrregularHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchIrregularHdrVO> models = new ArrayList<SearchIrregularHdrVO>();
	 ...
	 */
	public SearchIrregularHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchIrregularHdrVO[]
	 */
	public SearchIrregularHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchIrregularHdrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchIrregularHdrVO();
				if (currCd[i] != null)
		...
		return getSearchIrregularHdrVOs();
	}
	 ...
	 * @return SearchIrregularHdrVO[]
	 */
	public SearchIrregularHdrVO[] getSearchIrregularHdrVOs(){
		SearchIrregularHdrVO[] vos = (SearchIrregularHdrVO[])models.toArray(new SearchIrregularHdrVO[models.size()]);
		return vos;
	}
