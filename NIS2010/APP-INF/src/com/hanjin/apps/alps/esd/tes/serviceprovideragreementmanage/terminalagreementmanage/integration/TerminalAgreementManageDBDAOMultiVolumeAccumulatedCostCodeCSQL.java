...
*@FileName : TerminalAgreementManageDBDAOMultiVolumeAccumulatedCostCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOMultiVolumeAccumulatedCostCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOMultiVolumeAccumulatedCostCodeCSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOMultiVolumeAccumulatedCostCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TES_TML_SO_ACCM_COST (" ).append("\n"); 
		...
		query.append(", @[accm_seq]" ).append("\n"); 
		query.append(", NVL(MAX(accm_cost_seq), 0) + 1" ).append("\n"); 
		query.append(", @[lgs_cost_cd]" ).append("\n"); 
		query.append(", @[cre_usr_id]" ).append("\n"); 
