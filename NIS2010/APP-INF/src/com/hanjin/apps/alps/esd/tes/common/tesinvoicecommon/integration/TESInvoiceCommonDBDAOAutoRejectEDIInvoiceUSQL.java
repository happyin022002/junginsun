...
*@FileName : TESInvoiceCommonDBDAOAutoRejectEDIInvoiceUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInvoiceCommonDBDAOAutoRejectEDIInvoiceUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AutoRejectEDIInvoice
	  * </pre>
	  */
	public TESInvoiceCommonDBDAOAutoRejectEDIInvoiceUSQL(){
		setQuery();
		...
		query.append("FileName : TESInvoiceCommonDBDAOAutoRejectEDIInvoiceUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",TML_INV_RJCT_STS_CD= DECODE(TRIM(@[inv_rjct_rmk]),NULL,TML_INV_RJCT_STS_CD,'',TML_INV_RJCT_STS_CD,'AJ')" ).append("\n"); 
