...
*@FileName : EurFeederCostSpeInquiryVO.java
*@FileTitle : EurFeederCostSpeInquiryVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurFeederCostSpeInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurFeederCostSpeInquiryVO> models = new ArrayList<EurFeederCostSpeInquiryVO>();
...
/**
	 ...
	 * @param request
	 * @return EurFeederCostSpeInquiryVO[]
	 */
	public EurFeederCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurFeederCostSpeInquiryVO[]
	 */
	public EurFeederCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurFeederCostSpeInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EurFeederCostSpeInquiryVO();
				if (rfFxRto[i] != null)
	 ...
	 * @return EurFeederCostSpeInquiryVO[]
	 */
	public EurFeederCostSpeInquiryVO[] getFeederCostSpeInquiryVOs(){
		EurFeederCostSpeInquiryVO[] vos = (EurFeederCostSpeInquiryVO[])models.toArray(new EurFeederCostSpeInquiryVO[models.size()]);
		return vos;
	}
