...
public class Edi315SendDBDAOAddSceEdiSndRsltCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			decode(@[rslt_flag], 'R', TO_DATE(substr(@[edi_snd_itval_hr], 1, 14), 'YYYY/MM/DD HH24:MI:SS'), ''),--EDI_SND_RSV_DT" ).append("\n"); 
		...
		query.append("			decode(@[rslt_flag],'L', GLOBALDATE_PKG.TIME_CONV_FNC(SUBSTR('KRPUS',1,5), SYSDATE, SUBSTR(@[nod_cd], 1, 5))" ).append("\n"); 
		query.append("                               ,'K', GLOBALDATE_PKG.TIME_CONV_FNC(SUBSTR('KRPUS',1,5), SYSDATE, SUBSTR(@[nod_cd], 1, 5))" ).append("\n"); 
		query.append("                               ,'Y', GLOBALDATE_PKG.TIME_CONV_FNC(SUBSTR('KRPUS',1,5), SYSDATE, SUBSTR(@[nod_cd], 1, 5))" ).append("\n"); 
		query.append("							   ,'R', GLOBALDATE_PKG.TIME_CONV_FNC(SUBSTR('KRPUS',1,5), SYSDATE, SUBSTR(@[nod_cd], 1, 5))" ).append("\n"); 
