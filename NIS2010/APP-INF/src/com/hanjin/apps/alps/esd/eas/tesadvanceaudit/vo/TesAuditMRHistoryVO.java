...
*@FileName : TesAuditMRHistoryVO.java
*@FileTitle : TesAuditMRHistoryVO
*Open Issues :
*Change history :
...
public class TesAuditMRHistoryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesAuditMRHistoryVO> models = new ArrayList<TesAuditMRHistoryVO>();
...
/**
	 ...
	 * @param request
	 * @return TesAuditMRHistoryVO[]
	 */
	public TesAuditMRHistoryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesAuditMRHistoryVO[]
	 */
	public TesAuditMRHistoryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesAuditMRHistoryVO model = null;
		...
		return getTesAuditMRHistoryVOs();
	}
	 ...
	 * @return TesAuditMRHistoryVO[]
	 */
	public TesAuditMRHistoryVO[] getTesAuditMRHistoryVOs(){
		TesAuditMRHistoryVO[] vos = (TesAuditMRHistoryVO[])models.toArray(new TesAuditMRHistoryVO[models.size()]);
		return vos;
	}
