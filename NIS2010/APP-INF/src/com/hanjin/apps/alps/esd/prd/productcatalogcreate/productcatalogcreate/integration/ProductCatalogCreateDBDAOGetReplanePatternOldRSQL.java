...
*@FileName : ProductCatalogCreateDBDAOGetReplanePatternOldRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOGetReplanePatternOldRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ProductCatalogCreateDBDAOGetReplanePatternRSQL
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOGetReplanePatternOldRSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOGetReplanePatternOldRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              and RPRL.CNTR_DP_SEQ(+) = 1" ).append("\n"); 
		...
		query.append("			 and RPRL.CNTR_DP_SEQ(+) = 1 --jsy" ).append("\n"); 
		...
		query.append("	 , ORG_J,POR_ZN_CD --jsy" ).append("\n"); 
		...
		query.append("		  , DECODE(POR_ZN_CD,  POR_NOD_CD, 0,1) ORG_J , POR_ZN_CD --jsy" ).append("\n"); 
