...
*@FileName : TerminalAgreementManageDBDAORemoveVolumeAccmDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAORemoveVolumeAccmDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAORemoveVolumeAccmDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAORemoveVolumeAccmDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE	FROM	TES_TML_SO_ACCM" ).append("\n"); 
