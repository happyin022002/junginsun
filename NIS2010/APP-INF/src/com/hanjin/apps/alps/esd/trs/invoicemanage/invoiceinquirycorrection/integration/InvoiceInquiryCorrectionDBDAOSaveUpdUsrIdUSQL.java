...
*@FileName : InvoiceInquiryCorrectionDBDAOSaveUpdUsrIdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceInquiryCorrectionDBDAOSaveUpdUsrIdUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Update User Id를 update
	  * </pre>
	  */
	public InvoiceInquiryCorrectionDBDAOSaveUpdUsrIdUSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceInquiryCorrectionDBDAOSaveUpdUsrIdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
