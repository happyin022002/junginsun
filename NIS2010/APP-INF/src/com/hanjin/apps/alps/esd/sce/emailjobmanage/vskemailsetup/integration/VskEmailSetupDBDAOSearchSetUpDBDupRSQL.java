...
*@FileName : VskEmailSetupDBDAOSearchSetUpDBDupRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VskEmailSetupDBDAOSearchSetUpDBDupRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL E-MAIL 대상 추가 및 변경에 대한 방법 체크
	  * </pre>
	  */
	public VskEmailSetupDBDAOSearchSetUpDBDupRSQL(){
		setQuery();
		...
		params.put("subscEmlHis",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : VskEmailSetupDBDAOSearchSetUpDBDupRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND A.VSL_SLAN_CD = @[vslSlanCdHis]" ).append("\n"); 
		query.append("AND A.TO_PORT_CD = @[toPortCdHis]" ).append("\n"); 
		query.append("AND A.VSKD_DUR_ID = @[vskdDurIdHis]||'D'" ).append("\n"); 
		query.append("AND C.EML_SND_HR = @[emlSndHrHis]" ).append("\n"); 
		query.append("AND C.EML_SND_DYS_CTNT = @[emlSndDysCtntHis]" ).append("\n"); 
		query.append("AND B.SUBSC_EML = @[subscEmlHis]" ).append("\n"); 
