...
*@FileName : EurOceanFeederCostManageDBDAOMultiFeederCostHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOMultiFeederCostHdrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOMultiFeederCostHdrUSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOMultiFeederCostHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
