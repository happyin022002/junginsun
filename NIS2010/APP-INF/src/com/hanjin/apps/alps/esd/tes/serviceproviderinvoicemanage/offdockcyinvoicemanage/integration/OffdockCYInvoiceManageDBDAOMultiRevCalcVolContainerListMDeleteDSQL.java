...
*@FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListMDeleteDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListMDeleteDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiRevCalcVolContainerListMDelete
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListMDeleteDSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListMDeleteDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
