...
*@FileName : CustomerNominatedTruckerAproDAOSearchDtAproDivRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOSearchDtAproDivRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CustomerNominatedTruckerAproDAOSearchDtAproDiv
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOSearchDtAproDivRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.codemanage.cnt.integration").append("\n"); 
		query.append("FileName : CustomerNominatedTruckerAproDAOSearchDtAproDivRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
