...
*@FileName : SearchWriteOffInquiryReviewVO.java
*@FileTitle : SearchWriteOffInquiryReviewVO
*Open Issues :
*Change history :
...
public class SearchWriteOffInquiryReviewVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchWriteOffInquiryReviewVO> models = new ArrayList<SearchWriteOffInquiryReviewVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("wrtf_rsn_cd", getWrtfRsnCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("wrtf_rsn_cd", "wrtfRsnCd");
	 ...
	 * @return wrtfRsnCd
	 */
	public String getWrtfRsnCd() {
		return this.wrtfRsnCd;
	}
	 ...
	 * @param wrtfRsnCd
	 */
	public void setWrtfRsnCd(String wrtfRsnCd) {
		this.wrtfRsnCd = wrtfRsnCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setWrtfRsnCd(JSPUtil.getParameter(request, "wrtf_rsn_cd", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return SearchWriteOffInquiryReviewVO[]
	 */
	public SearchWriteOffInquiryReviewVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchWriteOffInquiryReviewVO[]
	 */
	public SearchWriteOffInquiryReviewVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchWriteOffInquiryReviewVO model = null;
		...
		try {
			...
			String[] wrtfRsnCd = (JSPUtil.getParameter(request, prefix	+ "wrtf_rsn_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new SearchWriteOffInquiryReviewVO();
				if (sCurrCdTp[i] != null)
				...
				if (wrtfRsnCd[i] != null)
					model.setWrtfRsnCd(wrtfRsnCd[i]);
				models.add(model);
			}
		...
		return getSearchWriteOffInquiryReviewVOs();
	}
	...
	public SearchWriteOffInquiryReviewVO[] getSearchWriteOffInquiryReviewVOs(){
		SearchWriteOffInquiryReviewVO[] vos = (SearchWriteOffInquiryReviewVO[])models.toArray(new SearchWriteOffInquiryReviewVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.wrtfRsnCd = this.wrtfRsnCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
