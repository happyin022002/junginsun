...
*@FileName : ESD_TRS_3001HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_TRS_3001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_3001HTMLAction 객체를 생성
	 */
	public ESD_TRS_3001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs3001Event event = new EsdTrs3001Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setInlandCostConditionVO((InlandCostConditionVO)getVO(request, InlandCostConditionVO .class));
			event.setInlandCostVOS((InlandCostVO[])getVOs(request, InlandCostVO .class,""));
		} else if(command.isCommand(FormCommand.MULTI02)) {
			event.setInBtnSts(JSPUtil.getParameter(request, "in_btn_sts", ""));
			event.setInlandCostConditionVO((InlandCostConditionVO)getVO(request, InlandCostConditionVO .class));
			event.setInlandCostSpecialCargoVOS((InlandCostSpecialCargoVO[])getVOs(request, InlandCostSpecialCargoVO .class,""));
