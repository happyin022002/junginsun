...
*@FileName : SingleTransportationSOManageDBDAOSingleTransportationSOManageDBDAOEmptyModifySingleTrsEqrEqUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOSingleTransportationSOManageDBDAOEmptyModifySingleTrsEqrEqUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OFF- Hire Eqr Eq UPDATE
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOSingleTransportationSOManageDBDAOEmptyModifySingleTrsEqrEqUSQL(){
		setQuery();
		...
		query.append("FileName : SingleTransportationSOManageDBDAOSingleTransportationSOManageDBDAOEmptyModifySingleTrsEqrEqUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
