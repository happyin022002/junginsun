...
*@FileName : MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceDetailInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceDetailInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiTerminalInvoiceDetailInsert
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceDetailInsertCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOMultiTerminalInvoiceDetailInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                -- [CHM-201640117]유효 AGMT 판단 Date와 Invoice Confirm시 가져오는 GW AGMT date 일치 (2016-02-16)" ).append("\n"); 
		query.append("				, CASE	WHEN @[calc_tp_cd] = 'M' AND NVL(@[semi_auto_calc_flg], 'N') != 'Y' " ).append("\n"); 
		query.append("							THEN TES_GET_AGMT_VER_FNC(@[yd_cd], @[vndr_seq], @[atb_dt], @[atb_dt], 'A') 		-- tml_agmt_ofc_cty_cd" ).append("\n"); 
		query.append("							ELSE @[tml_agmt_ofc_cty_cd]" ).append("\n"); 
		query.append("				  END" ).append("\n"); 
		query.append("				, CASE	WHEN @[calc_tp_cd] = 'M' AND NVL(@[semi_auto_calc_flg], 'N') != 'Y' " ).append("\n"); 
		query.append("							THEN TES_GET_AGMT_VER_FNC(@[yd_cd], @[vndr_seq], @[atb_dt], @[atb_dt], 'B') 		-- tml_agmt_seq" ).append("\n"); 
		query.append("							ELSE @[tml_agmt_seq]" ).append("\n"); 
		query.append("				  END" ).append("\n"); 
		query.append("				, CASE	WHEN @[calc_tp_cd] = 'M' AND NVL(@[semi_auto_calc_flg], 'N') != 'Y' " ).append("\n"); 
		query.append("							THEN TES_GET_AGMT_VER_FNC(@[yd_cd], @[vndr_seq], @[atb_dt], @[atb_dt], 'C') 		-- tml_agmt_ver_no" ).append("\n"); 
		...
		query.append("				, GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[locl_cre_dt])		-- cre_dt" ).append("\n"); 
		query.append("				, @[upd_usr_id]" ).append("\n"); 
		query.append("				, SYSDATE" ).append("\n"); 
		query.append("				, GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[locl_upd_dt])		-- cre_dt" ).append("\n"); 
		query.append("				, @[semi_auto_calc_flg]" ).append("\n"); 
