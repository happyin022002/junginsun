...
*@FileName : InlnadCostInquiryVO.java
*@FileTitle : InlnadCostInquiryVO
*Open Issues :
*Change history :
...
public class InlnadCostInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InlnadCostInquiryVO> models = new ArrayList<InlnadCostInquiryVO>();
...
/**
	 ...
	 */
	public InlnadCostInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InlnadCostInquiryVO[]
	 */
	public InlnadCostInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InlnadCostInquiryVO model = null;
	...
	public InlnadCostInquiryVO[] getInlnadCostInquiryVOs(){
		InlnadCostInquiryVO[] vos = (InlnadCostInquiryVO[])models.toArray(new InlnadCostInquiryVO[models.size()]);
		return vos;
	}
