...
*@FileName : InlnadCostSpeInquiryVO.java
*@FileTitle : InlnadCostSpeInquiryVO
*Open Issues :
*Change history :
...
public class InlnadCostSpeInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InlnadCostSpeInquiryVO> models = new ArrayList<InlnadCostSpeInquiryVO>();
...
/**
	 ...
	 */
	public InlnadCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InlnadCostSpeInquiryVO[]
	 */
	public InlnadCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InlnadCostSpeInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new InlnadCostSpeInquiryVO();
				if (rfFxRto[i] != null)
	...
	public InlnadCostSpeInquiryVO[] getInlnadCostSpeInquiryVOs(){
		InlnadCostSpeInquiryVO[] vos = (InlnadCostSpeInquiryVO[])models.toArray(new InlnadCostSpeInquiryVO[models.size()]);
		return vos;
	}
