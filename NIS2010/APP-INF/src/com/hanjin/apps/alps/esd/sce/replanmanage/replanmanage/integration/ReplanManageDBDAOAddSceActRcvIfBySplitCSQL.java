...
*@FileName : ReplanManageDBDAOAddSceActRcvIfBySplitCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReplanManageDBDAOAddSceActRcvIfBySplitCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReplanManageDBDAOAddSceActRcvIfBySplitCSQL(){
		setQuery();
		...
		query.append("FileName : ReplanManageDBDAOAddSceActRcvIfBySplitCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  VSL_DLAY_RSN_DESC ," ).append("\n"); 
		query.append("  VPS_LOC_CD," ).append("\n"); 
		query.append("  'CrtBySplit'," ).append("\n"); 
		query.append("  'CrtBySplit'," ).append("\n"); 
