...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistOnlyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistOnlyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistOnlyRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistOnlyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CASE	WHEN T.VNDR_CUST_DIV_CD = 'C' THEN T.CUST_CNT_CD|| LPAD(T.CUST_SEQ, 6, '0')" ).append("\n"); 
