...
*@FileName : RailBillingReqCreateDBDAOsearchEmptyCntrTpSzRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingReqCreateDBDAOsearchEmptyCntrTpSzRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RailBillingReqCreateDBDAOsearchEmptyCntrTpSzRSQL(){
		setQuery();
		...
		query.append("FileName : RailBillingReqCreateDBDAOsearchEmptyCntrTpSzRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        	      ,a.cntr_tpsz_rmk                                        " ).append("\n"); 
		query.append("        	  FROM mdm_cntr_tp_sz a                                       " ).append("\n"); 
		query.append("        	 WHERE a.cntr_tpsz_cd IN (@[d2], @[d4], @[d5], @[d7], @[o2], @[o4], @[a2], @[a4], @[a5], @[r5], @[r2], @[o5])" ).append("\n"); 
