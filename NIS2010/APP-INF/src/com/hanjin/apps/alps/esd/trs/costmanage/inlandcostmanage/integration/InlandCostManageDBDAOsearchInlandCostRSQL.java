...
*@FileName : InlandCostManageDBDAOsearchInlandCostRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOsearchInlandCostRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOsearchInlandCostRSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOsearchInlandCostRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , DECODE(D.INLND_ROUT_CMB_FLG,'N',D.N1ST_VNDR_40FT_AGMT_WGT,GREATEST(D.N1ST_VNDR_40FT_AGMT_WGT, D.N2ND_VNDR_40FT_AGMT_WGT)) AGMT_WGT_40FT" ).append("\n"); 
		...
		query.append("      , TRS_INLND_COST_TRF D  " ).append("\n"); 
