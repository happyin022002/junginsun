...
*@FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAODeleteCorrSumAgmtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Rate Type의 모든 Current 테이블의 상태코드를 Delete로 Update한다.
	  * </pre>
	  */
	public AgreementCorrectionDBDAODeleteCorrSumAgmtUSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",AGMT_EXP_DT = TO_DATE(TO_CHAR(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[fm_account_ofc_cd])-1, 'YYYYMMDD'), 'YYYYMMDD')" ).append("\n"); 
