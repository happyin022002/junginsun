...
*@FileName : KPIDetailReportbyKPIDBDAOKPIDetailReportVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KPIDetailReportbyKPIDBDAOKPIDetailReportVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * KPI Detail Report by KPI VO 생성쿼리
	  * </pre>
	  */
	public KPIDetailReportbyKPIDBDAOKPIDetailReportVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.spe.performancereport.kpidetailreportbykpi.integration").append("\n"); 
		query.append("FileName : KPIDetailReportbyKPIDBDAOKPIDetailReportVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
