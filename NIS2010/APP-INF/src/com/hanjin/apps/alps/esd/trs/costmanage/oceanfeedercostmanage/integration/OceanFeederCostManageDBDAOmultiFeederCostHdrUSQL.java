...
*@FileName : OceanFeederCostManageDBDAOmultiFeederCostHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOmultiFeederCostHdrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOmultiFeederCostHdrUSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOmultiFeederCostHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
