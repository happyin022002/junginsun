...
*@FileName : ESD_TRS_3015HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_TRS_3015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_3015HTMLAction 객체를 생성
	 */
	public ESD_TRS_3015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs3015Event event = new EsdTrs3015Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setSearchStatusMonitorVO((SearchStatusMonitorVO)getVO(request, SearchStatusMonitorVO .class));
