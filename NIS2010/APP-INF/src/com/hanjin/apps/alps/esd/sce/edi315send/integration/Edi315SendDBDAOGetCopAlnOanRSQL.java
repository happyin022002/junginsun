...
*@FileName : Edi315SendDBDAOGetCopAlnOanRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Edi315SendDBDAOGetCopAlnOanRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Edi315SendDBDAOGetCopAlnOanRSQL(){
		setQuery();
		...
		query.append("FileName : Edi315SendDBDAOGetCopAlnOanRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("and     substr(nod_cd, 1, 5) = DECODE(@[e_chk_sts], 'RLN', substr(@[e_event_yard], 1, 5), substr(nod_cd, 1, 5))" ).append("\n"); 
