...
*@FileName : SearchIrregularCntrListVO.java
*@FileTitle : SearchIrregularCntrListVO
*Open Issues :
*Change history :
...
public class SearchIrregularCntrListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchIrregularCntrListVO> models = new ArrayList<SearchIrregularCntrListVO>();
	...
	public SearchIrregularCntrListVO() {}

	public SearchIrregularCntrListVO(String ibflag, String pagerows, String irrNo, String gnteNo, String tmlGnteCntrListSeq, String cntrNo, String cntrTpszCd, String bkgNo, String bkgNo2, String bkgNoListCtnt, String blNo, String scNo, String vvdCd, String fmDt, String toDt, String tmlIfOfcCd, String tmlIfSeq, String gnteAmt, String chkTpbIf) {
		this.fmDt = fmDt;
	 ...
	 */
	public SearchIrregularCntrListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchIrregularCntrListVO[]
	 */
	public SearchIrregularCntrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchIrregularCntrListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchIrregularCntrListVO();
				if (fmDt[i] != null)
		...
		return getSearchIrregularCntrListVOs();
	}
	 ...
	 * @return SearchIrregularCntrListVO[]
	 */
	public SearchIrregularCntrListVO[] getSearchIrregularCntrListVOs(){
		SearchIrregularCntrListVO[] vos = (SearchIrregularCntrListVO[])models.toArray(new SearchIrregularCntrListVO[models.size()]);
		return vos;
	}
