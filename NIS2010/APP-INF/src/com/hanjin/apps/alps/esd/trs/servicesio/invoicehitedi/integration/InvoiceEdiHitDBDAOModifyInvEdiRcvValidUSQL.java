...
*@FileName : InvoiceEdiHitDBDAOModifyInvEdiRcvValidUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceEdiHitDBDAOModifyInvEdiRcvValidUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice EDI Header 정보 Validation 결과 Update
	  * </pre>
	  */
	public InvoiceEdiHitDBDAOModifyInvEdiRcvValidUSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceEdiHitDBDAOModifyInvEdiRcvValidUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TRS_INV_EDI_RCV" ).append("\n"); 
		query.append("   SET VAL_CHK_FLG = @[val_chk_flg]" ).append("\n"); 
		query.append("      ,VAL_RMK = SUBSTR(VAL_RMK||' '||@[val_rmk],1,1000)" ).append("\n"); 
		query.append("      ,UPD_USR_ID = 'HIT_INV_VAL'" ).append("\n"); 
