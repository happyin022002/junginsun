...
*@FileName : CustomerEdiDBDAOSearchDetailOtherReportRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDAOSearchDetailOtherReportRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchDetailOtherReport
	  * </pre>
	  */
	public CustomerEdiDBDAOSearchDetailOtherReportRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDAOSearchDetailOtherReportRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select t.vvd, t.bkg_no, t.bl_no  , t.cntr_no, t.por_cd, t.pol_cd, t.pod_cd, t.del_cd, '' flag     " ).append("\n"); 
		query.append("	,t.EDI_STS_CD,t.edi_sub_sts_cd ,t.edi_snd_knt, t.act_dt1, t.act_dt2, t.nod_cd, t.cre_dt1, t.cre_dt2    " ).append("\n"); 
		query.append("	,t.gmt_dt1, t.gmt_dt2 , t.rbtn , t.cop_no , '' flag, t.ts_port, t.rail, flt_file_ref_no 	" ).append("\n"); 
		query.append("from (	" ).append("\n"); 
		query.append("select L.vvd, L.bkg_no" ).append("\n"); 
		query.append("       , L.bl_no                         " ).append("\n"); 
		query.append("       , L.cntr_no, L.por_cd, L.pol_cd, L.pod_cd, L.del_cd, ''   " ).append("\n"); 
		query.append("        ,L.EDI_STS_CD    " ).append("\n"); 
		query.append("        ,L.edi_sub_sts_cd    " ).append("\n"); 
		query.append("        ,L.edi_snd_knt, L.act_dt1, L.act_dt2, L.nod_cd, L.cre_dt1, L.cre_dt2     " ).append("\n"); 
		query.append("        ,L.gmt_dt1, L.gmt_dt2                " ).append("\n"); 
		query.append("        , decode(L.edi_snd_knt,null,'9',case when L.max_edi_snd_knt= L.edi_snd_knt then '0' else '9' end) rbtn    " ).append("\n"); 
		query.append("        , L.cop_no , ''  , ts_port, rail ,rownum no, flt_file_ref_no  " ).append("\n"); 
		query.append("from (   " ).append("\n"); 
		query.append(" select DISTINCT dtl.vvd,dtl.bkg_no,dtl.cntr_no, dtl.por_cd, dtl.pol_cd, dtl.pod_cd, dtl.del_cd,''         " ).append("\n"); 
		query.append(" ,dtl.EDI_STS_CD        " ).append("\n"); 
		query.append(" ,dtl.edi_sub_sts_cd        " ).append("\n"); 
		query.append(" ,dtl.edi_snd_knt,dtl.act_dt1, dtl.act_dt2,nod_cd,dtl.cre_dt1, dtl.cre_dt2, '0'	, dtl.cop_no, dtl.bl_no        " ).append("\n"); 
		query.append(",sts.edi_sts_seq sort_seq, dtl.act_dt1||dtl.act_dt2 sort_dt  " ).append("\n"); 
		query.append(" ,max_edi_snd_knt   " ).append("\n"); 
		query.append(" ,dtl.gmt_dt1, dtl.gmt_dt2  , dtl.ts_port, dtl.rail    " ).append("\n"); 
		query.append(" ,dtl.flt_file_ref_no " ).append("\n"); 
		query.append(" from                                                                                                          " ).append("\n"); 
		query.append(" (                                                                                                             " ).append("\n"); 
		query.append(" 	select   vvd,a.bkg_no, a.cntr_no, por_cd, pol_cd, pod_cd, del_cd,'' flg                        " ).append("\n"); 
		query.append("        ,a.EDI_STS_CD,r.edi_snd_knt,to_char(r.act_dt,'yyyymmdd') act_dt1, to_char(r.act_dt,'hh24miss') act_dt2 " ).append("\n"); 
		query.append(" ,r.nod_cd, to_char(r.upd_dt,'yyyymmdd') cre_dt1, to_char(r.upd_dt,'hh24miss') cre_dt2, a.cop_no , a.bl_no, r.act_dt	" ).append("\n"); 
		query.append(" ,a.edi_sub_sts_cd        ,  a.ts_port ,  a.rail                      " ).append("\n"); 
		query.append(" ,MAX(r.edi_snd_knt) OVER ( PARTITION BY vvd,a.bkg_no, a.cntr_no, por_cd, pol_cd, pod_cd, del_cd,a.EDI_STS_CD,a.edi_sub_sts_cd) max_edi_snd_knt    " ).append("\n"); 
		query.append(" ,to_char(r.gmt_dt,'yyyymmdd') gmt_dt1, to_char(r.gmt_dt,'hh24miss') gmt_dt2              " ).append("\n"); 
		...
		query.append("                        r.edi_snd_knt, r.act_dt, r.nod_cd, r.GMT_DT, r.upd_dt, r.flt_file_ref_no   " ).append("\n"); 
		...
		query.append("			  AND r.EDI_GRP_CD   = @[cs_grp_id] 	" ).append("\n"); 
		query.append("     #else " ).append("\n"); 
		query.append("            where r.EDI_GRP_CD   = @[cs_grp_id] " ).append("\n"); 
		query.append("     #end " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(" 			           ,e.edi_grp_cd edi_grp_cd, hb.cop_no, hb.bl_no      ,ts_port, rail                          " ).append("\n"); 
		...
		query.append(" 					 ,m.N1ST_TS_PORT_CD ts_port, COP_RAIL_CHK_CD rail             " ).append("\n"); 
		query.append(" 			     " ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append("#if(${bl_no_} != '' )" ).append("\n"); 
		query.append("                     FROM   bkg_booking b , sce_cop_hdr h  ,PRD_PROD_CTL_MST m          " ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("                     FROM   sce_cop_hdr h  , bkg_booking b ,PRD_PROD_CTL_MST m                                 " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if((${vvd} == '') && (${bkg_no_} == '') && (${bl_no_} == '') &&  (${cntr_no_} == ''))" ).append("\n"); 
		...
		query.append(" group by vvd,a.bkg_no, a.cntr_no, por_cd, pol_cd, pod_cd, del_cd                " ).append("\n"); 
		query.append(" ,a.EDI_STS_CD   " ).append("\n"); 
		query.append(" ,a.edi_sub_sts_cd           " ).append("\n"); 
		query.append(" ,r.edi_snd_knt,r.act_dt, r.act_dt   " ).append("\n"); 
		query.append(" ,r.nod_cd,r.upd_dt, a.cop_no , a.bl_no, r.act_dt   " ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append(" ,r.gmt_dt ,a.ts_port, a.rail  " ).append("\n"); 
		query.append("  " ).append("\n"); 
		query.append(" ,r.flt_file_ref_no " ).append("\n"); 
		query.append(" ) dtl, EDI_CGO_STND_STS sts                                " ).append("\n"); 
		query.append("   where sts.EDI_STND_STS_CD = dtl.edi_sts_cd and edi_sts_seq > 799     " ).append("\n"); 
		query.append("order by vvd, bkg_no, cntr_no, sort_seq, dtl.edi_snd_knt       " ).append("\n"); 
