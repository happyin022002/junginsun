...
*@FileName : AgreementImportDBDAOSearchVenderNameRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOSearchVenderNameRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgreementImportDBDAOSearchVenderNameRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOSearchVenderNameRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND VNDR_SEQ= @[vndr_prmry_seq]" ).append("\n"); 
