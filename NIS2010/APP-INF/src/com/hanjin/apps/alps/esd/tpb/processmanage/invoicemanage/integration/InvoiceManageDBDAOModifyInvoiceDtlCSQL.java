...
*@FileName : InvoiceManageDBDAOModifyInvoiceDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceManageDBDAOModifyInvoiceDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceManageDBDAOModifyInvoiceDtlCSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceManageDBDAOModifyInvoiceDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
