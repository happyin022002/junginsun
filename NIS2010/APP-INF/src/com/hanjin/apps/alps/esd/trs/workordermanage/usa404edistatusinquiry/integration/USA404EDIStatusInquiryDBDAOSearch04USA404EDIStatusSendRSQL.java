...
*@FileName : USA404EDIStatusInquiryDBDAOSearch04USA404EDIStatusSendRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOSearch04USA404EDIStatusSendRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 404 Cancel EDI FF의 내용을 조회 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOSearch04USA404EDIStatusSendRSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOSearch04USA404EDIStatusSendRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    A.TRSP_SO_OFC_CTY_CD, A.TRSP_SO_SEQ, " ).append("\n"); 
		...
		query.append("    CASE WHEN LENGTH(S.EDI_RCV_VNDR_ABBR_NM) > 0 THEN S.EDI_RCV_VNDR_ABBR_NM " ).append("\n"); 
		query.append("    WHEN LENGTH(T.EDI_RCV_VNDR_ABBR_NM) > 0 THEN T.EDI_RCV_VNDR_ABBR_NM " ).append("\n"); 
		query.append("    ELSE '' " ).append("\n"); 
		query.append("    END APP_MTC, " ).append("\n"); 
		...
		query.append("    CASE     WHEN A.TRSP_BND_CD = 'I' AND                      " ).append("\n"); 
		query.append("                 A.CGO_TP_CD = 'F' AND                        " ).append("\n"); 
		query.append("                (A.FM_NOD_CD = 'USORFM1' OR                    " ).append("\n"); 
		query.append("                A.FM_NOD_CD = 'USORFM2') THEN 'VITUSBRAIL'  " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_VITUSBRAIL,                                    " ).append("\n"); 
		query.append("    CASE     WHEN A.POD_NOD_CD = 'USLGBM5' AND                 " ).append("\n"); 
		query.append("                 A.FM_NOD_CD != 'USLGBPT' THEN 'SSOFA'        " ).append("\n"); 
		query.append("             WHEN A.POL_NOD_CD = 'USLGBM5' AND                 " ).append("\n"); 
		query.append("                 A.TO_NOD_CD != 'USLGBPT' THEN 'SSOFA'        " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_SSOFA,                                        " ).append("\n"); 
		query.append("    CASE     WHEN A.POD_NOD_CD = 'USLGBM6' AND                 " ).append("\n"); 
		query.append("                 A.FM_NOD_CD != 'USLGBPT' THEN 'ITS'        " ).append("\n"); 
		query.append("             WHEN A.POL_NOD_CD = 'USLGBM6' AND                 " ).append("\n"); 
		query.append("                 A.TO_NOD_CD != 'USLGBPT' THEN 'ITS'        " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_ITS,                                        " ).append("\n"); 
		query.append("    CASE     WHEN A.POD_NOD_CD = 'USLAXYM' AND                 " ).append("\n"); 
		query.append("                 A.FM_NOD_CD != 'USLGBPT' THEN 'MTCLAX'        " ).append("\n"); 
		query.append("             WHEN A.POL_NOD_CD = 'USLAXYM' AND                 " ).append("\n"); 
		query.append("                 A.TO_NOD_CD != 'USLGBPT' THEN 'MTCLAX'        " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		...
		query.append("            WHEN A.CGO_TP_CD = 'M' AND A.FM_NOD_CD  = 'USLAXM4' THEN 'MTCLA'" ).append("\n"); 
		query.append("            WHEN A.CGO_TP_CD = 'M' AND A.TO_NOD_CD  = 'USLAXM4' THEN 'MTCLA'" ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_MTCLA,    --CHM-201325385 [TRS] 404 EDI terminal setup 차후 적용" ).append("\n"); 
		query.append("    CASE     WHEN A.POD_NOD_CD = 'USLAXM4' AND A.FM_NOD_CD != 'USLGBPT' THEN 'ETSLAX'        " ).append("\n"); 
		query.append("             WHEN A.POL_NOD_CD = 'USLAXM4' AND A.TO_NOD_CD != 'USLGBPT' THEN 'ETSLAX'" ).append("\n"); 
		query.append("            WHEN A.CGO_TP_CD = 'M' AND A.FM_NOD_CD  = 'USLAXM4' THEN 'ETSLAX'" ).append("\n"); 
		query.append("            WHEN A.CGO_TP_CD = 'M' AND A.TO_NOD_CD  = 'USLAXM4' THEN 'ETSLAX'" ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_ETSLAX,    --CHM-201538922 RailBilling EDI (404 & 998) 중복 생성 요청    " ).append("\n"); 
		query.append("    CASE     WHEN (A.POD_NOD_CD = 'USLGBM5' OR                  " ).append("\n"); 
		query.append("                  A.POD_NOD_CD = 'USLGBM6' OR                 " ).append("\n"); 
		query.append("                  A.POD_NOD_CD = 'USLAXYM' OR " ).append("\n"); 
		query.append("                  A.POD_NOD_CD = 'USLAXM1' OR " ).append("\n"); 
		query.append("                  A.POD_NOD_CD = 'USLAXM2' OR" ).append("\n"); 
		query.append("                  A.POD_NOD_CD = 'USLAXM4' ) AND                 " ).append("\n"); 
		query.append("                  A.FM_NOD_CD = 'USLGBPT' THEN 'MTCHANINT'    " ).append("\n"); 
		query.append("             WHEN (A.POL_NOD_CD = 'USLGBM5' OR                  " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLGBM6' OR                 " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXYM' OR " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXM1' OR " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXM2' OR" ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXM4' ) AND                 " ).append("\n"); 
		query.append("                  A.TO_NOD_CD = 'USLGBPT' THEN 'MTCHANINT'    " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		...
		query.append("                  A.POD_NOD_CD = 'USLAXM2' OR" ).append("\n"); 
		query.append("                  A.POD_NOD_CD = 'USLAXM4' ) AND                 " ).append("\n"); 
		query.append("                  A.FM_NOD_CD = 'USLGBPT' THEN 'MTCHAN'        " ).append("\n"); 
		query.append("             WHEN (A.POL_NOD_CD = 'USLGBM5' OR                  " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLGBM6' OR                 " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXYM' OR " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXM1' OR " ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXM2' OR" ).append("\n"); 
		query.append("                  A.POL_NOD_CD = 'USLAXM4' ) AND                 " ).append("\n"); 
		query.append("                  A.TO_NOD_CD = 'USLGBPT' THEN 'MTCHAN'        " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_MTCHAN," ).append("\n"); 
		query.append("    DECODE(C.USA_EDI_CD,'NWCS','NWCS310','') APP_NWCS310," ).append("\n"); 
		query.append("    CASE    WHEN A.POD_NOD_CD = 'USLAXM2' AND" ).append("\n"); 
		query.append("                 A.FM_NOD_CD = 'USLAXM2' THEN '3105488232'" ).append("\n"); 
		query.append("            WHEN A.POL_NOD_CD = 'USLAXM2' AND" ).append("\n"); 
		query.append("                 A.TO_NOD_CD = 'USLAXM2' THEN '3105488232'" ).append("\n"); 
		query.append("    ELSE    ''" ).append("\n"); 
		query.append("    END     APP_3105488232," ).append("\n"); 
		query.append("    A.RAIL_CMB_THRU_TP_CD RAIL_CMB, S.EDI_RCV_VNDR_ABBR_NM APP_MTC1, T.EDI_RCV_VNDR_ABBR_NM APP_MTC2, " ).append("\n"); 
		...
		query.append("    TO_CHAR(A.WO_ISS_DT, 'YYYYMMDD') ACTDT, " ).append("\n"); 
		...
		query.append("    LPAD(O.BIL_EDI_CTRL_SEQ, 8, '0') CREDIT, " ).append("\n"); 
		...
		query.append("    DECODE(SUBSTR(BK.DEL_CD,1,2), 'CA', '',DECODE( AI.IBD_TRSP_TP_CD, '62', AI.IBD_TRSP_NO)  ) TRANSEXPNO, '' DOCK, " ).append("\n"); 
		query.append("    '' FFDESC, A.EQ_TPSZ_CD EQNISTS, SUBSTR(A.EQ_NO, 1, 4) EQINIT, SUBSTR(A.EQ_NO, 5, 6) EQNO, " ).append("\n"); 
		...
		query.append("    O.EQDESC_C, DECODE(SUBSTR(A.EQ_TPSZ_CD, 2, 1), '2', '2000', '7', '4500', '4000' ) EQLTH_C, " ).append("\n"); 
		query.append("    SUBSTR(A.EQ_NO, 11, 1) EQCHK, " ).append("\n"); 
		query.append("    CASE WHEN LENGTH(S.EDI_RCV_VNDR_ABBR_NM) > 0 OR LENGTH(T.EDI_RCV_VNDR_ABBR_NM) > 0 THEN 'Z' " ).append("\n"); 
		query.append("    ELSE 'X' " ).append("\n"); 
		query.append("    END EX_VNDR, " ).append("\n"); 
		...
		query.append("    'ML' ILTRANS_C, DECODE(SUBSTR(A.FM_NOD_CD, 1, 5),'CAVAN','IB',  AI.IBD_TRSP_TP_CD) CUSTENTTP_C, DECODE(SUBSTR(BK.DEL_CD, 1, 2), 'CA', CV.CGO_CTRL_NO_PFX_NM, AI.IBD_TRSP_NO) CUSTENTNO, " ).append("\n"); 
		...
		query.append("                        ,'CN',CASE WHEN A.TRSP_BND_CD = 'I' AND 'US' = SUBSTR(A.ROUT_DEST_NOD_CD,1,2) THEN( SELECT LOC_AMS_PORT_CD  " ).append("\n"); 
		query.append("                                                                                                              FROM MDM_LOCATION" ).append("\n"); 
		query.append("                                                                                                              WHERE LOC_CD = ( SELECT A.CSTMS_LOC_CD" ).append("\n"); 
		query.append("                                                                                                                                 FROM BKG_CSTMS_ADV_BL A" ).append("\n"); 
		query.append("                                                                                                                                   WHERE A.CNT_CD ='US'" ).append("\n"); 
		query.append("                                                                                                                                      AND A.BL_NO = (SELECT BL_NO" ).append("\n"); 
		...
		query.append("    I.YD_LOC_CTY_NM ORGCTY, I.YD_LOC_STE_CD ORGSTATE, I.YD_CTRL_OFC_CTY_NM||', '||I.YD_CTRL_OFC_STE_CD ORGLOC, A.FM_NOD_CD ORGYD, " ).append("\n"); 
		query.append("    K.YD_LOC_CTY_NM DSTCTY, K.YD_LOC_STE_CD DSTSTATE, K.YD_CTRL_OFC_CTY_NM||', '||K.YD_CTRL_OFC_STE_CD DSTLOC, A.TO_NOD_CD DSTYD,  " ).append("\n"); 
		query.append("    'SM LINE CORPORATION' SHPR_N,  TRIM(REPLACE( REPLACE(REPLACE(REPLACE(I.YD_CTRL_OFC_ADDR, CHR(13), ' '), CHR(10), ' '), CHR(9), ' '), CHR(43), ' ')) SHPR_A, " ).append("\n"); 
		...
		query.append("    K.YD_CTRL_OFC_CTY_NM  CNEE_C, K.YD_CTRL_OFC_STE_CD CNEE_S, K.YD_CTRL_OFC_ZIP_CD CNEE_P, LOC2.CNT_CD AS CNEE_CN," ).append("\n"); 
		query.append("    NVL(OFC.TEAM_MGR_NM,  'SM LINE CORPORATION') NTFY_N, NVL(REPLACE(REPLACE(  NVL( OFC.TEAM_FAX_NO,  OFC.OFC_FAX_NO  )  , ' ', ''), '-', ''), '') NTFY_T, " ).append("\n"); 
		query.append("    'SM LINE CORPORATION' CARE_N, K.YD_CTRL_OFC_ADDR CARE_A, K.YD_CTRL_OFC_CTY_NM CARE_C, " ).append("\n"); 
		query.append("    K.YD_CTRL_OFC_STE_CD CARE_S, K.YD_CTRL_OFC_ZIP_CD CARE_P, LOC2.CNT_CD AS CARE_CN, 'SM LINE CORPORATION' BILL_N, " ).append("\n"); 
		query.append("    '1750 E. NORTHROP BLVD SUITE 140' BILL_A, 'CHANDLER' BILL_C, 'AZ' BILL_S, '85286' BILL_P, 'US'AS BILL_CN," ).append("\n"); 
		...
		query.append("    'SM LINE CORPORATION' RECV_N, '1750 E. NORTHROP BLVD SUITE 140' RECV_A, 'CHANDLER' RECV_C, 'AZ' RECV_S, " ).append("\n"); 
		query.append("    '85286' RECV_P, 'US' AS RECV_CN, 'SM LINE CORPORATION' ADMC_C, SP.FDA FDA_IND, " ).append("\n"); 
		...
		query.append("    M.VENT_RTO VENT, M.HUMID_NO HUMID, M.PWR_SPL_CBL_FLG GENSET, " ).append("\n"); 
		query.append("    'AESNO' REFID, A.AUTO_XPT_SYS_NO REFVAL, '' S, " ).append("\n"); 
		query.append("--    C.USA_EDI_CD APPRECV_C_OLD," ).append("\n"); 
		query.append("    C.USA_EDI_CD APPRECV_C_OLD," ).append("\n"); 
		...
		query.append("    UPPER(O.AGMT_REF_NO) CONTRACT, LPAD(O.BIL_EDI_CTRL_SEQ, 8, '0') CREDIT_OLD, " ).append("\n"); 
		query.append("    'M'||LPAD(O.BIL_EDI_CTRL_SEQ, 8, '0') MTC_CREDIT_OLD, " ).append("\n"); 
		query.append("    SUBSTR(A.EQ_NO, 1, 4) EQINIT_OLD, SUBSTR(A.EQ_NO, 5, 6) EQNO_OLD, " ).append("\n"); 
		query.append("    TO_CHAR(A.WO_ISS_DT, 'YYYYMMDD') SNDDT_OLD, 'R' TYPE, " ).append("\n"); 
		query.append("    O.ROUTCARR ROUTCARR, O.ROUTSEQ ROUTSEQ, O.ROUTCITY ROUTCITY, O.INTMOSVR INTMOSVR, " ).append("\n"); 
		query.append("    O.TRANSTP TRANSTP, O.TO_YARD_CD TO_YARD_CD, UPPER(O.AGMT_REF_NO) CONTRACT, O.ROUTCARR2 ROUTCARR2, O.ROUTSEQ2 ROUTSEQ2, O.ROUTCITY2 ROUTCITY2, " ).append("\n"); 
		query.append("    O.INTMOSVR2 INTMOSVR2, O.TRANSTP2 TRANSTP2, O.TO_YARD_CD2 TO_YARD_CD2, UPPER(O.AGMT_REF_NO2) CONTRACT2, O.ROUTCARR3 ROUTCARR3, O.ROUTSEQ3 ROUTSEQ3, " ).append("\n"); 
		query.append("    O.ROUTCITY3 ROUTCITY3, O.INTMOSVR3 INTMOSVR3, O.TRANSTP3 TRANSTP3, O.TO_YARD_CD3 TO_YARD_CD3, UPPER(O.AGMT_REF_NO3) CONTRACT3, '' INBOND, " ).append("\n"); 
		query.append("    SP.LADELINE1, SP.LADELINE2, SP.LADELINE3, SP.LADELINE4, SP.LADELINE5, " ).append("\n"); 
		query.append("    SP.LADEDESC1, SP.LADEDESC2, SP.LADEDESC3, SP.LADEDESC4, SP.LADEDESC5, " ).append("\n"); 
		query.append("    SP.COMMCODE1, SP.COMMCODE2, SP.COMMCODE3, SP.COMMCODE4, SP.COMMCODE5, " ).append("\n"); 
		query.append("    SP.NISCOMM1, SP.NISCOMM2, SP.NISCOMM3, SP.NISCOMM4, SP.NISCOMM5, " ).append("\n"); 
		query.append("    SP.NISRETP1, SP.NISRETP2, SP.NISRETP3, SP.NISRETP4, SP.NISRETP5, " ).append("\n"); 
		...
		query.append("    R.STCC_CD DG_STCC, P.IMDG_UN_NO DG_UN, P.PRP_SHP_NM DG_NAME, P.HZD_DESC DG_CONTENTS, P.IMDG_CLSS_CD DG_CLASS, " ).append("\n"); 
		query.append("    DECODE(P.IMDG_PCK_GRP_CD, '1', 'I', '2', 'II', '3', 'III') DG_PGRP, P.PSA_NO DG_PSAGRP, P.MRN_POLUT_FLG DG_MP, P.FLSH_PNT_CDO_TEMP DG_FLSHTEMP, 'C' DG_FLSHUNIT, NVL(P.OUT_IMDG_PCK_QTY1,0) DG_QTY, P.OUT_IMDG_PCK_CD1 DG_QUNIT, NVL(P.GRS_WGT,0) DG_WEIGHT, " ).append("\n"); 
		query.append("    P.WGT_UT_CD DG_WUNIT," ).append("\n"); 
		query.append("    P.FLSH_PNT_CDO_TEMP DG_FLASHTEMP," ).append("\n"); 
		query.append("    CASE WHEN SUBSTR(P.IMDG_CLSS_CD,1,1)='1' AND NVL(P.SPCL_CGO_APRO_CD,'N')='Y' AND NVL(P.NET_EXPLO_WGT,0)<> 0 THEN TO_CHAR(P.NET_EXPLO_WGT)" ).append("\n"); 
		query.append("         ELSE ''" ).append("\n"); 
		query.append("     END AS DG_CLASS1NEW," ).append("\n"); 
		query.append("    CASE WHEN SUBSTR(P.IMDG_CLSS_CD,1,1)='1' AND NVL(P.SPCL_CGO_APRO_CD,'N')='Y'  AND NVL(P.NET_EXPLO_WGT,0)<> 0 THEN 'KGS' " ).append("\n"); 
		query.append("         ELSE '' " ).append("\n"); 
		...
		query.append("     MDM_VENDOR C, BKG_CONTAINER D, " ).append("\n"); 
		...
		query.append("   (SELECT A.TRSP_SO_OFC_CTY_CD, A.TRSP_SO_SEQ, " ).append("\n"); 
		...
		query.append("        MAX(EDI.BIL_EDI_CTRL_SEQ) BIL_EDI_CTRL_SEQ, MAX(EDI.BKG_NO) BKG_NO, " ).append("\n"); 
		query.append("        MAX(DECODE(A.SUB_RAIL_SEQ, 1, DECODE(SUBSTR(A.RAIL_CRR_TP_CD, 1, 1), 'C' , 'CN', 'T' ,'CC'))) EQDESC_C, " ).append("\n"); 
		query.append("        MAX(C.FM_NOD_CD) FM_NOD_CD,      MAX(C.TO_NOD_CD) TO_NOD_CD " ).append("\n"); 
		query.append("    FROM TRS_TRSP_RAIL_BIL_VNDR_SET A, MDM_VENDOR B, TRS_TRSP_RAIL_BIL_ORD C, TRS_TRSP_EDI_TMP TMP, TRS_TRSP_EDI_RAIL_ORD EDI, " ).append("\n"); 
		query.append("    TRS_AGMT_HDR AGMT, PRD_INLND_ROUT_DTL PRD , PRD_INLND_ROUT_MST MST " ).append("\n"); 
		...
		query.append("    SELECT " ).append("\n"); 
		query.append("        A.TRSP_SO_OFC_CTY_CD, A.TRSP_SO_SEQ, A.VNDR_SEQ, " ).append("\n"); 
		query.append("        B.USA_EDI_CD ROUTCARR, MAX(DECODE(A.SUB_RAIL_SEQ, 1, DECODE(SUBSTR(C.RAIL_CMB_THRU_TP_CD, 3), 'T', 'S', 'C', 'S', 'R'), 2,1,3,2)) ROUTSEQ,  " ).append("\n"); 
		query.append("        PRD.INLND_ROUT_JUNC_NM ROUTCITY, MST.ROUT_PLN_CD INTMOSVR, DECODE(SUBSTR(A.RAIL_CRR_TP_CD, 1, 1), 'C', 'X') TRANSTP, " ).append("\n"); 
		query.append("        MAX(DECODE(A.SUB_RAIL_SEQ, 1, A.TO_NOD_CD, '')) TO_YARD_CD, MAX(AGMT.AGMT_REF_NO) AGMT_REF_NO, " ).append("\n"); 
		query.append("        '' ROUTCARR2, '' ROUTSEQ2, '' ROUTCITY2, '' INTMOSVR2, '' TRANSTP2, '' TO_YARD_CD2, '' AGMT_REF_NO2, " ).append("\n"); 
		query.append("        '' ROUTCARR3, '' ROUTSEQ3, '' ROUTCITY3,'' INTMOSVR3, '' TRANSTP3, '' TO_YARD_CD3, '' AGMT_REF_NO3, " ).append("\n"); 
		query.append("        MAX(EDI.BIL_EDI_CTRL_SEQ) BIL_EDI_CTRL_SEQ, MAX(EDI.BKG_NO) BKG_NO,  " ).append("\n"); 
		query.append("        MAX(DECODE(A.SUB_RAIL_SEQ, 1, DECODE(SUBSTR(A.RAIL_CRR_TP_CD, 1, 1), 'C' , 'CN', 'T' ,'CC'))) EQDESC_C, " ).append("\n"); 
		query.append("        MAX(A.FM_NOD_CD) FM_NOD_CD, MAX(A.TO_NOD_CD) TO_NOD_CD  " ).append("\n"); 
		query.append("    FROM TRS_TRSP_RAIL_BIL_VNDR_SET A, MDM_VENDOR B, TRS_TRSP_RAIL_BIL_ORD C, TRS_TRSP_EDI_TMP TMP, TRS_TRSP_EDI_RAIL_ORD EDI, " ).append("\n"); 
		query.append("    TRS_AGMT_HDR AGMT, PRD_INLND_ROUT_DTL PRD , PRD_INLND_ROUT_MST MST   " ).append("\n"); 
		query.append("    WHERE TMP.TRSP_EDI_SND_NO = @[strsp_edi_snd_no]" ).append("\n"); 
		query.append("    AND A.TRSP_SO_OFC_CTY_CD = TMP.TRSP_SO_OFC_CTY_CD " ).append("\n"); 
		...
		query.append("( " ).append("\n"); 
		query.append("        SELECT " ).append("\n"); 
		query.append("            A.TRSP_SO_OFC_CTY_CD, A.TRSP_SO_SEQ, MAX(FDA_DECL_FLG) FDA," ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 1, LADELINE, '')) LADELINE1, MAX(DECODE(LADELINE, 2, LADELINE, '')) LADELINE2, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 3, LADELINE, '')) LADELINE3, MAX(DECODE(LADELINE, 4, LADELINE, '')) LADELINE4, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 5, LADELINE, '')) LADELINE5, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 1, LADEDESC, '')) LADEDESC1, MAX(DECODE(LADELINE, 2, LADEDESC, '')) LADEDESC2, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 3, LADEDESC, '')) LADEDESC3, MAX(DECODE(LADELINE, 4, LADEDESC, '')) LADEDESC4, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 5, LADEDESC, '')) LADEDESC5, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 1, COMMCODE, '')) COMMCODE1, MAX(DECODE(LADELINE, 2, COMMCODE, '')) COMMCODE2, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 3, COMMCODE, '')) COMMCODE3, MAX(DECODE(LADELINE, 4, COMMCODE, '')) COMMCODE4, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 5, COMMCODE, '')) COMMCODE5, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 1, NISCOMM, '')) NISCOMM1, MAX(DECODE(LADELINE, 2, NISCOMM, '')) NISCOMM2, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 3, NISCOMM, '')) NISCOMM3, MAX(DECODE(LADELINE, 4, NISCOMM, '')) NISCOMM4, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 5, NISCOMM, '')) NISCOMM5, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 1, NISRETP, '')) NISRETP1, MAX(DECODE(LADELINE, 2, NISRETP, '')) NISRETP2, " ).append("\n"); 
		query.append("            MAX(DECODE(LADELINE, 3, NISRETP, '')) NISRETP3, MAX(DECODE(LADELINE, 4, NISRETP, '')) NISRETP4, " ).append("\n"); 
		...
		query.append("                A.CGO_TP_CD, 'F', DECODE(A.TRSP_BND_CD, 'O', NVL(F.CMDT_NM, E.REP_CMDT_NM), " ).append("\n"); 
		...
		query.append("            B.CMDT_CD NISCOMM, B.REP_CMDT_CD NISRETP, TF.FDA_DECL_FLG" ).append("\n"); 
		query.append("        FROM TRS_TRSP_RAIL_BIL_ORD A, TRS_TRSP_RAIL_BIL_VNDR_SET AB, BKG_BOOKING B, BKG_CONTAINER C, BKG_CNTR_MF_DESC D, MDM_REP_CMDT E, " ).append("\n"); 
		query.append("        MDM_COMMODITY F, BKG_RATE BRH, MDM_VENDOR VD, TRS_TRSP_EDI_TMP STMP, BKG_HAMO_TRF TF" ).append("\n"); 
		...
		query.append("     FROM  BKG_CONTAINER BC , BKG_BOOKING BK ,TRS_TRSP_RAIL_BIL_ORD A ,TRS_TRSP_EDI_TMP STMP    " ).append("\n"); 
		query.append("    WHERE    " ).append("\n"); 
		query.append("        STMP.TRSP_EDI_SND_NO = @[strsp_edi_snd_no]" ).append("\n"); 
		query.append("    AND STMP.TRSP_SO_OFC_CTY_CD = A.TRSP_SO_OFC_CTY_CD     " ).append("\n"); 
		query.append("    AND STMP.TRSP_SO_SEQ = A.TRSP_SO_SEQ     " ).append("\n"); 
