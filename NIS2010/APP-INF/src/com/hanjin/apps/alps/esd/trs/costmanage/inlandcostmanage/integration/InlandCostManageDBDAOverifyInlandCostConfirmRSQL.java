...
*@FileName : InlandCostManageDBDAOverifyInlandCostConfirmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOverifyInlandCostConfirmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOverifyInlandCostConfirmRSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOverifyInlandCostConfirmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
