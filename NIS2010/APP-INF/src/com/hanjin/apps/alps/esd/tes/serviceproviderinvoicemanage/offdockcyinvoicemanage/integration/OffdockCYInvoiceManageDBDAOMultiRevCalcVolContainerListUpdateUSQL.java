...
*@FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListUpdateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListUpdateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiRevCalcVolContainerListUpdate
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListUpdateUSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListUpdateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("TML_RVIS_IND_FLG    =DECODE(@[tml_rvis_ind_flg],'1','Y','')," ).append("\n"); 
