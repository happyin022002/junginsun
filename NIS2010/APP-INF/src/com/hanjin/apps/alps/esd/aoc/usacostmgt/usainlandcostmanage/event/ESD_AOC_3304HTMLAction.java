...
*@FileName : ESD_AOC_3304HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3304HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3304HTMLAction 객체를 생성
	 */
	public ESD_AOC_3304HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3304Event event = new EsdAoc3304Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchInlandCostAccountVO((UsaInlandCostAccountVO)getVO(request, UsaInlandCostAccountVO .class));
		}
