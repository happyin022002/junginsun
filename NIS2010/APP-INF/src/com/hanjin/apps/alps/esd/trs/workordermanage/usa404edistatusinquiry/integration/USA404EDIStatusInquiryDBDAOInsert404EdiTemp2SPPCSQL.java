...
*@FileName : USA404EDIStatusInquiryDBDAOInsert404EdiTemp2SPPCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOInsert404EdiTemp2SPPCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPP에서 404 Cancel Edi에 쓰일 Send No, SO# W/O TEMP 테이블에 추가 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOInsert404EdiTemp2SPPCSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOInsert404EdiTemp2SPPCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
