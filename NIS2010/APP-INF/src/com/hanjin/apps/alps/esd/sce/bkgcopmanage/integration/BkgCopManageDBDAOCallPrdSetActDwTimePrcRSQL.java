...
*@FileName : BkgCopManageDBDAOCallPrdSetActDwTimePrcRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOCallPrdSetActDwTimePrcRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PRD 가 관리하는 PRD_SET_ACT_DWTIME_PRC 프로시져를 Booking Creation, Replan, Split 시에 call 한다.
	  * </pre>
	  */
	public BkgCopManageDBDAOCallPrdSetActDwTimePrcRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOCallPrdSetActDwTimePrcRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
