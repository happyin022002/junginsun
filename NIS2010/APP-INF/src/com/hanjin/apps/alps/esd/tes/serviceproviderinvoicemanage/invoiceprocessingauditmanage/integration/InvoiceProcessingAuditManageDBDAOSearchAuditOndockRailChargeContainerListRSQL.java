...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOndockRailChargeContainerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOndockRailChargeContainerListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * AuditOndockRailChargeContainerList 조회
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOndockRailChargeContainerListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOndockRailChargeContainerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("				, C.VSL_CD || C.SKD_VOY_NO || C.SKD_DIR_CD AS VVD_NO" ).append("\n"); 
