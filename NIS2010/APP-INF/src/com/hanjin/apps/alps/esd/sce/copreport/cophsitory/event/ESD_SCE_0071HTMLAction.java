...
*@FileName : EsdSce001HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESD_SCE_0071HTMLAction extends HTMLActionSupport {

    /**
     * ESD_SCE_0071HTMLAction 객체를 생성
     */
    public ESD_SCE_0071HTMLAction() {
    }
...
//    	FormCommand command = FormCommand.fromRequest(request);
    	EsdSce0071Event event = new EsdSce0071Event();
