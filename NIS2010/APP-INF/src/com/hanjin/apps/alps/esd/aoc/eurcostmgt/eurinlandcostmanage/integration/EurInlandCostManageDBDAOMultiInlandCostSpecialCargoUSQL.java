...
*@FileName : EurInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AOC_EUR_INLND_SPCL_TRF_DTL" ).append("\n"); 
