...
*@FileName : ESD_TPB_0136HTMLAction.java
...
public class ESD_TPB_0136HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0136HTMLAction 객체를 생성
	 */
	public ESD_TPB_0136HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0136Event event = new EsdTpb0136Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchActivityByClosingTPBVO( (SearchActivityByClosingTPBVO)getVO(request, SearchActivityByClosingTPBVO .class));
		}
