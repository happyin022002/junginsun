...
public class CARIssueTransferSlipManageDBDAORejectInvoiceUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("T.INV_RJCT_DT = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[locl_upd_dt])," ).append("\n"); 
		query.append("T.UPD_DT = SYSDATE," ).append("\n"); 
		query.append("T.LOCL_UPD_DT = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[locl_upd_dt])" ).append("\n"); 
