...
public class SpecialCargoQuotationManageDBDAOcheckYdCdInputAuthRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("(SELECT" ).append("\n"); 
		query.append("NVL(TRS_OOG_GET_AUTH_YN_FNC(@[lg_ofc_cd],(SELECT OFC_CD" ).append("\n"); 
		...
		query.append("(SELECT" ).append("\n"); 
		query.append("DISTINCT TRS_OOG_GET_AUTH_YN_FNC(@[lg_ofc_cd], OFC_CD)" ).append("\n"); 
		query.append("FROM MDM_YARD" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND YD_CD LIKE @[fm_yd_cd]||'%'" ).append("\n"); 
		query.append("AND NVL(DELT_FLG,'N')<>'Y'" ).append("\n"); 
		query.append("AND NVL(TRS_OOG_GET_AUTH_YN_FNC(@[lg_ofc_cd], OFC_CD),'N') = 'Y'),'X')" ).append("\n"); 
		query.append("FROM DUAL)" ).append("\n"); 
