...
*@FileName : PrdCommonManageDBDAOIsDoorTerminalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PrdCommonManageDBDAOIsDoorTerminalRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PrdCommonManageDBDAOIsDoorTerminalRSQL(){
		setQuery();
		...
		query.append("FileName : PrdCommonManageDBDAOIsDoorTerminalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT n.nod_tp_cd node_code" ).append("\n"); 
