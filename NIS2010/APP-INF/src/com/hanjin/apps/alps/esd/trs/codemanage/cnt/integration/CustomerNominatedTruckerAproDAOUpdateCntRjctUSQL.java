...
*@FileName : CustomerNominatedTruckerAproDAOUpdateCntRjctUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOUpdateCntRjctUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CNT(Customer Nominated Trucker) Approval - Reject
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOUpdateCntRjctUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerAproDAOUpdateCntRjctUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- 상태코드 UPDATE (REJECT)" ).append("\n"); 
		query.append("UPDATE TRS_CUST_NOMI_TRKR" ).append("\n"); 
		query.append("   SET DISP_STS_CD = '02'" ).append("\n"); 
		query.append("      ,CUST_NOMI_TRKR_RJCT_DT = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[cre_ofc_cd]) -- Session Office Code" ).append("\n"); 
