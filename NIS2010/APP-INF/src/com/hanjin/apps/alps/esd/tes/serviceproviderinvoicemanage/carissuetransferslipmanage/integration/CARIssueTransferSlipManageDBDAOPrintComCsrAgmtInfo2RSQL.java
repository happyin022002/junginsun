...
*@FileName : CARIssueTransferSlipManageDBDAOPrintComCsrAgmtInfo2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CARIssueTransferSlipManageDBDAOPrintComCsrAgmtInfo2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CARIssueTransferSlipManageDBDAOPrintComCsrAgmtInfo2RSQL(){
		setQuery();
		...
		query.append("FileName : CARIssueTransferSlipManageDBDAOPrintComCsrAgmtInfo2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT H.CSR_NO, " ).append("\n"); 
		query.append("		H.VNDR_SEQ, " ).append("\n"); 
		query.append("		H.INV_NO, " ).append("\n"); 
		query.append("		A.AGMT_DOC_NO l_assetcd, " ).append("\n"); 
		...
		query.append("ORDER BY H.CSR_NO, " ).append("\n"); 
		query.append("		H.VNDR_SEQ, " ).append("\n"); 
		query.append("		H.INV_NO, " ).append("\n"); 
