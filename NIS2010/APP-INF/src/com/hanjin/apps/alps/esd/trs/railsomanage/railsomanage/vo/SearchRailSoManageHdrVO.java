...
*@FileName : SearchRailSoManageHdrVO.java
*@FileTitle : SearchRailSoManageHdrVO
*Open Issues :
*Change history :
...
public class SearchRailSoManageHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchRailSoManageHdrVO> models = new ArrayList<SearchRailSoManageHdrVO>();
	
	/* Column Info */
	private String toNodCd = null;
	/* Column Info */
	private String neededQty = null;
	/* Column Info */
	...
	public SearchRailSoManageHdrVO() {}

	public SearchRailSoManageHdrVO(String ibflag, String pagerows, String repoPlnId, String plnYrwk, String plnSeq, String refId, String toNodCd, String neededQty, String soIfDivCd, String cretQty, String allocated, String ediQty, String trspModCd, String trspCostDtlModCd, String vvdCd, String fmLocCd, String currDt, String soRqstDt, String trspCrrModCd, String fmDt, String chk1, String toLocCd, String remainingQty, String eqTpszCd, String fmNodCd, String toDt, String slanCd, String repoPurpRmk) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("needed_qty", getNeededQty());
		...
		this.hashColumns.put("edi_qty", getEdiQty());
		...
		this.hashColumns.put("remaining_qty", getRemainingQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("needed_qty", "neededQty");
		...
		this.hashFields.put("edi_qty", "ediQty");
		...
		this.hashFields.put("remaining_qty", "remainingQty");
	 ...
	 * @param ediQty
	 */
	public void setEdiQty(String ediQty) {
		this.ediQty = ediQty;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setNeededQty(JSPUtil.getParameter(request, prefix + "needed_qty", ""));
		...
		setEdiQty(JSPUtil.getParameter(request, prefix + "edi_qty", ""));
		...
		setRemainingQty(JSPUtil.getParameter(request, prefix + "remaining_qty", ""));
	 ...
	 */
	public SearchRailSoManageHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchRailSoManageHdrVO[]
	 */
	public SearchRailSoManageHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchRailSoManageHdrVO model = null;
		...
		try {
			...
			String[] neededQty = (JSPUtil.getParameter(request, prefix	+ "needed_qty", length));
			...
			String[] ediQty = (JSPUtil.getParameter(request, prefix	+ "edi_qty", length));
			...
			String[] remainingQty = (JSPUtil.getParameter(request, prefix	+ "remaining_qty", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchRailSoManageHdrVO();
				if (toNodCd[i] != null)
					model.setToNodCd(toNodCd[i]);
				if (neededQty[i] != null)
					model.setNeededQty(neededQty[i]);
				if (soIfDivCd[i] != null)
				...
				if (remainingQty[i] != null)
					model.setRemainingQty(remainingQty[i]);
				if (eqTpszCd[i] != null)
		...
		return getSearchRailSoManageHdrVOs();
	}
	...
	public SearchRailSoManageHdrVO[] getSearchRailSoManageHdrVOs(){
		SearchRailSoManageHdrVO[] vos = (SearchRailSoManageHdrVO[])models.toArray(new SearchRailSoManageHdrVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.neededQty = this.neededQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ediQty = this.ediQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.remainingQty = this.remainingQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
