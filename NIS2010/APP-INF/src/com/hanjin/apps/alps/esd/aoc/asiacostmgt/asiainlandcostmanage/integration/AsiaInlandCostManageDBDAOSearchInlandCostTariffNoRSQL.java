...
*@FileName : AsiaInlandCostManageDBDAOSearchInlandCostTariffNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchInlandCostTariffNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchInlandCostTariffNoRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOSearchInlandCostTariffNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
