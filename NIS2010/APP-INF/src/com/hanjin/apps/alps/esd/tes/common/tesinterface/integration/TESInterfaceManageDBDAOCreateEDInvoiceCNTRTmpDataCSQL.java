...
*@FileName : TESInterfaceManageDBDAOCreateEDInvoiceCNTRTmpDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInterfaceManageDBDAOCreateEDInvoiceCNTRTmpDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateEDInvoiceCNTRTmpData
	  * </pre>
	  */
	public TESInterfaceManageDBDAOCreateEDInvoiceCNTRTmpDataCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.common.tesinterface.integration ").append("\n"); 
		query.append("FileName : TESInterfaceManageDBDAOCreateEDInvoiceCNTRTmpDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into TES_EDI_SO_CNTR_LIST" ).append("\n"); 
		query.append("(" ).append("\n"); 
