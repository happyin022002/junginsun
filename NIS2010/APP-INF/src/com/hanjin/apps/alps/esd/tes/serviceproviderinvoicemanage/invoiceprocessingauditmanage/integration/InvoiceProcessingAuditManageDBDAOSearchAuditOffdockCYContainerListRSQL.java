...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InvoiceProcessingAuditManage
	  * AuditOffdockCYContainerList 조회
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, A.TML_RVIS_IND_FLG" ).append("\n"); 
