...
*@FileName : EurInlandCostManageDBDAOVerifyInlandCostConfirmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOVerifyInlandCostConfirmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOVerifyInlandCostConfirmRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOVerifyInlandCostConfirmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
