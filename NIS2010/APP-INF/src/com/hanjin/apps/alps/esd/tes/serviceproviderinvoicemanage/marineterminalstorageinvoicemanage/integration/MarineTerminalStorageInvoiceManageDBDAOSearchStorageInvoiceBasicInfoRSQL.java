...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorageInvoiceBasicInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOSearchStorageInvoiceBasicInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchStorageInvoiceBasicInfo
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOSearchStorageInvoiceBasicInfoRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorageInvoiceBasicInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  CASE WHEN A.FM_PRD_DT IS NOT NULL THEN SUBSTR(A.FM_PRD_DT,0,4)||'-'||SUBSTR(A.FM_PRD_DT,5,2)||'-'||SUBSTR(A.FM_PRD_DT,7,2) ELSE '' END FM_PRD_DT," ).append("\n"); 
		query.append("  A.HLD_FLG             , " ).append("\n"); 
		query.append("  A.HLD_RMK             , " ).append("\n"); 
		query.append("  CASE WHEN A.TO_PRD_DT IS NOT NULL THEN SUBSTR(A.TO_PRD_DT,0,4)||'-'||SUBSTR(A.TO_PRD_DT,5,2)||'-'||SUBSTR(A.TO_PRD_DT,7,2) ELSE '' END TO_PRD_DT," ).append("\n"); 
		...
		query.append("    WHEN A.EDI_FLG = 'Y'" ).append("\n"); 
		...
		query.append("        AND E.TML_SO_OFC_CTY_CD = A.TML_SO_OFC_CTY_CD" ).append("\n"); 
		query.append("        AND E.TML_SO_SEQ = A.TML_SO_SEQ" ).append("\n"); 
