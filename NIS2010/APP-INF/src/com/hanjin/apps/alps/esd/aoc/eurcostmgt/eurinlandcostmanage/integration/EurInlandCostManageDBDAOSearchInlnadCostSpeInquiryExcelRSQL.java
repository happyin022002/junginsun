...
*@FileName : EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.eurcostmgt.eurinlandcostmanage.integration").append("\n"); 
		query.append("FileName : EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
