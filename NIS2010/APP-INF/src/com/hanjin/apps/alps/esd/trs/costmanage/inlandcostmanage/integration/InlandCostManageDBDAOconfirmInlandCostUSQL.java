...
*@FileName : InlandCostManageDBDAOconfirmInlandCostUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOconfirmInlandCostUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOconfirmInlandCostUSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOconfirmInlandCostUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
