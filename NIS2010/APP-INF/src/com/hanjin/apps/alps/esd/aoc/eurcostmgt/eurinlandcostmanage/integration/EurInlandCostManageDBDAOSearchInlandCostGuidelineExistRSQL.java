...
*@FileName : EurInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
