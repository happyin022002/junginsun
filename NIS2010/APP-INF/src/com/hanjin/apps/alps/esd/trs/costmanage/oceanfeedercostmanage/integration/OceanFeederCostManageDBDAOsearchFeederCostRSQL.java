...
*@FileName : OceanFeederCostManageDBDAOsearchFeederCostRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOsearchFeederCostRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOsearchFeederCostRSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOsearchFeederCostRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
