...
*@FileName : ComTesTrfCondVO.java
*@FileTitle : ComTesTrfCondVO
*Open Issues :
*Change history :
...
public class ComTesTrfCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L; 
	
	private Collection<ComTesTrfCondVO> models = new ArrayList<ComTesTrfCondVO>();
	
	/* Column Info */
	private String tmlAwkCgoCondTpNm = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tml_awk_cgo_cond_tp_nm", getTmlAwkCgoCondTpNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tml_awk_cgo_cond_tp_nm", "tmlAwkCgoCondTpNm");
	...
	/**
	 * Column Info
	 * @return tmlAwkCgoCondTpNm
	 */
	public String getTmlAwkCgoCondTpNm() {
		return this.tmlAwkCgoCondTpNm;
	}
	...
	/**
	 * Column Info
	 * @param tmlAwkCgoCondTpNm
	 */
	public void setTmlAwkCgoCondTpNm(String tmlAwkCgoCondTpNm) {
		this.tmlAwkCgoCondTpNm = tmlAwkCgoCondTpNm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTmlAwkCgoCondTpNm(JSPUtil.getParameter(request, prefix + "tml_awk_cgo_cond_tp_nm", ""));
	 ...
	 * @return TesTrfCondVO[]
	 */
	public ComTesTrfCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesTrfCondVO[]
	 */
	public ComTesTrfCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComTesTrfCondVO model = null;
		...
		try {
			...
			String[] tmlAwkCgoCondTpNm = (JSPUtil.getParameter(request, prefix	+ "tml_awk_cgo_cond_tp_nm", length));
			...
			for (int i = 0; i < length; i++) {
				model = new ComTesTrfCondVO();
				if (tmlAwkCgoCondTpCd[i] != null)
					model.setTmlAwkCgoCondTpCd(tmlAwkCgoCondTpCd[i]);
				if (tmlAwkCgoCondTpNm[i] != null)
					model.setTmlAwkCgoCondTpNm(tmlAwkCgoCondTpNm[i]);
				if (deltFlg[i] != null)
	...
	public ComTesTrfCondVO[] getComTesTrfCondVOs(){
		ComTesTrfCondVO[] vos = (ComTesTrfCondVO[])models.toArray(new ComTesTrfCondVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tmlAwkCgoCondTpNm = this.tmlAwkCgoCondTpNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
