...
*@FileName : InlandCostManageDBDAOmultiInlandCostSpecialCargoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOmultiInlandCostSpecialCargoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOmultiInlandCostSpecialCargoUSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOmultiInlandCostSpecialCargoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TRS_INLND_SPCL_CGO" ).append("\n"); 
