...
*@FileName : LogisticsRevenueDBDAOCheckTrdPartyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogisticsRevenueDBDAOCheckTrdPartyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LogisticsRevenueDBDAOCheckTrdPartyRSQL(){
		setQuery();
		...
		query.append("FileName : LogisticsRevenueDBDAOCheckTrdPartyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       	AND VNDR_SEQ = TO_NUMBER(@[s_vndr_seq])" ).append("\n"); 
