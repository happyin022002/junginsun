...
*@FileName : EurOceanFeederCostManageDBDAOSearchFeederCostTariffNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOSearchFeederCostTariffNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOSearchFeederCostTariffNoRSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOSearchFeederCostTariffNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
