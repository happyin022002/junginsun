...
*@FileName : SearchInlandCostBatchErrorVO.java
*@FileTitle : SearchInlandCostBatchErrorVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esd.trs.costbatch.costbatch.vo;
...
public class SearchInlandCostBatchErrorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInlandCostBatchErrorVO> models = new ArrayList<SearchInlandCostBatchErrorVO>();
	...
	public SearchInlandCostBatchErrorVO() {}

	public SearchInlandCostBatchErrorVO(String ibflag, String pagerows, String costTrfNo, String portLoc, String rcvDeTermCd, String portNodCd, String hubNodCd, String locNodCd, String trspCrrModCd, String costErrCd, String errDesc) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public SearchInlandCostBatchErrorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInlandCostBatchErrorVO[]
	 */
	public SearchInlandCostBatchErrorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInlandCostBatchErrorVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchInlandCostBatchErrorVO();
				if (ibflag[i] != null)
	...
	public SearchInlandCostBatchErrorVO[] getSearchInlandCostBatchErrorVOs(){
		SearchInlandCostBatchErrorVO[] vos = (SearchInlandCostBatchErrorVO[])models.toArray(new SearchInlandCostBatchErrorVO[models.size()]);
		return vos;
	}
