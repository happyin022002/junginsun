		...
		try{
			...
			if(eventResponse != null){
				if(event.getFormCommand().isCommand(FormCommand.MULTI01)){    //detail 저장XML인 경우
					...
					xmlString.append("<DATA TOTAL=\"").append(rsVoList.size()).append("\">");
					if(event.getFormCommand().isCommand(FormCommand.SEARCHLIST) || event.getFormCommand().isCommand(FormCommand.SEARCHLIST01) || event.getFormCommand().isCommand(FormCommand.MULTI)){
						for(int i = 0; i < rsVoList.size(); i++){
							...
							xmlString.append("<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("inlnd_rout_optm_flg"))).append("]]></TD>");
							xmlString.append("<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("altn_optm_flg"))).append("]]></TD>"); // alt optm flg 
							...
							xmlString.append("<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("lnk_knt"))).append("]]></TD>");
							xmlString.append("<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("inlnd_tmnl_shtl_flg"))).append("]]></TD>");
							xmlString.append("<TD><![CDATA[").append(JSPUtil.getNull(colValues.get("optm_del_able_flg"))).append("]]></TD>");
					...
					if(event.getFormCommand().isCommand(FormCommand.SEARCH)){
						if(rsVoList != null && rsVoList.size() > 0){
							...
							xmlString.append("<ETC KEY=\"i_wrs_fl_cd\"><![CDATA[").append(JSPUtil.getNull(colValues.get("wrs_full_cmdt_cd"))).append("]]></ETC>");
							xmlString.append("<ETC KEY=\"i_wrs_mt_cd\"><![CDATA[").append(JSPUtil.getNull(colValues.get("wrs_mty_cmdt_cd"))).append("]]></ETC>");
							...
							xmlString.append("<ETC KEY=\"i_optm_flg \"><![CDATA[").append(JSPUtil.getNull(colValues.get("inlnd_rout_optm_flg")).equals("Y") ? JSPUtil.getNull(colValues.get("inlnd_rout_optm_flg")) : "").append("]]></ETC>");
							xmlString.append("<ETC KEY=\"i_old_optm_flg \"><![CDATA[").append(JSPUtil.getNull(colValues.get("inlnd_rout_optm_flg")).equals("Y") ? JSPUtil.getNull(colValues.get("inlnd_rout_optm_flg")) : "").append("]]></ETC>");
							...
							xmlString.append("<ETC KEY=\"i_altn_optm_flg \"><![CDATA[").append(JSPUtil.getNull(colValues.get("altn_optm_flg")).equals("Y") ? JSPUtil.getNull(colValues.get("altn_optm_flg")) : "").append("]]></ETC>");
						}
						...
						xmlString.append("<ETC KEY=\"sch_conti_cd\"><![CDATA[").append(JSPUtil.getNull(eventResponse.getETCData("sch_conti_cd"))).append("]]></ETC>");
