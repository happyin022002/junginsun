...
*@FileName : SingleTransportationSOManageDBDAOSearchEmptyRepoRefSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOSearchEmptyRepoRefSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EQR_REPO_EXE_SO_IF의 REF_ID 생성
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOSearchEmptyRepoRefSeqRSQL(){
		setQuery();
		...
		query.append("FileName : SingleTransportationSOManageDBDAOSearchEmptyRepoRefSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
