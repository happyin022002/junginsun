...
*@FileName : MnrAdvanceAuditDBDAOsearchMultipleRepairCNTRByPeriodDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MnrAdvanceAuditDBDAOsearchMultipleRepairCNTRByPeriodDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ESD_EAS_365
	  * Multiple Repair CNTR by Period Detail
	  * 특정기간 동안 다발 수리한 CNTR 조회 세부항목 - cleanig제외
	  * </pre>
	  */
	public MnrAdvanceAuditDBDAOsearchMultipleRepairCNTRByPeriodDetailRSQL(){
		setQuery();
		...
		query.append("FileName : MnrAdvanceAuditDBDAOsearchMultipleRepairCNTRByPeriodDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("             FROM MDM_YARD YD, MDM_LOCATION LOC, MDM_EQ_ORZ_CHT CHT" ).append("\n"); 
		query.append("            WHERE B.YD_CD = YD.YD_CD" ).append("\n"); 
