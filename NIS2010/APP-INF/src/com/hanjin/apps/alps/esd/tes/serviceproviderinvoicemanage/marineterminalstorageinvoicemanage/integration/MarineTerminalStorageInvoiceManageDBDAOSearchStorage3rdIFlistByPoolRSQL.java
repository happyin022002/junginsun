...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByPoolRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByPoolRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchStorage3rdIFlistByPool
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByPoolRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOSearchStorage3rdIFlistByPoolRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("T.BKG_NO, T.BKG_NO_SPLIT, T.BL_NO," ).append("\n"); 
