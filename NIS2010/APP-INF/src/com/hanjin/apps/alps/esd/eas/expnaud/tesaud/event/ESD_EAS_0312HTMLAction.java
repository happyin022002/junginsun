...
/**
 * @author 9014613
 * @see EsdEas0312Event , ESD_EAS_0312EventResponse 참조
 * @since J2EE 1.6
 */
public class ESD_EAS_0312HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0312HTMLAction 객체를 생성
	 */
	public ESD_EAS_0312HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0312Event event = new EsdEas0312Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setTesOnDockRailVO((TesOnDockRailVO)getVO(request, TesOnDockRailVO .class));
		}
