...
*@FileName : ESD_TPB_0803HTMLAction.java
...
public class ESD_TPB_0803HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0803HTMLAction 객체를 생성
	 */
	public ESD_TPB_0803HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0803Event event = new EsdTpb0803Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchInvoiceManageListVOS((SearchInvoiceManageListVO[])getVOs(request, SearchInvoiceManageListVO .class,""));
		}
