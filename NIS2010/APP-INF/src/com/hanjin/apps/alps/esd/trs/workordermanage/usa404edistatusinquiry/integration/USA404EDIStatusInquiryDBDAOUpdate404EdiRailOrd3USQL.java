...
*@FileName : USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd3USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd3USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SO 마스터 테이블에 Frustrate 상태 수정 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd3USQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOUpdate404EdiRailOrd3USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET TRSP_FRST_FLG = 'Y'," ).append("\n"); 
