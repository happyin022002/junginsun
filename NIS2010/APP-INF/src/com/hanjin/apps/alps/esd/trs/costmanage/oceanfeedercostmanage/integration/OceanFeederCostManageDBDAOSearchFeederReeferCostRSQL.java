...
*@FileName : OceanFeederCostManageDBDAOSearchFeederReeferCostRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOSearchFeederReeferCostRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOSearchFeederReeferCostRSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOSearchFeederReeferCostRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
