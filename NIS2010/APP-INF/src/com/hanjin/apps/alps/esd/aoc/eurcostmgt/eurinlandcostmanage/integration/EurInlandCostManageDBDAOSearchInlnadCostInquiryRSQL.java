...
*@FileName : EurInlandCostManageDBDAOSearchInlnadCostInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlnadCostInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlnadCostInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlnadCostInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , B.INLND_45FT_TTL_AMT" ).append("\n"); 
		...
		query.append("      , NVL(B.MB_45FT_RTO,0)||'%' MB_45FT_RTO -- 45' Cost 추가" ).append("\n"); 
		...
		query.append("      , COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03050', B.TRSP_45FT_COST_SYS_SRC_CD) TRSP_45FT_COST_SYS_SRC_NM" ).append("\n"); 
		query.append("      , B.TRSP_45FT_COST_AMT" ).append("\n"); 
		query.append("      , B.TRSP_45FT_ADJ_COST_AMT" ).append("\n"); 
		query.append("      , B.TRSP_45FT_TTL_COST_AMT" ).append("\n"); 
		query.append("      , B.TRSP_AGMT_45FT_MTY_YD_CD" ).append("\n"); 
		query.append("      , CASE WHEN NVL(B.MTY_PKUP_RTN_YD_CD, 1) = NVL(B.TRSP_AGMT_45FT_MTY_YD_CD, 1) THEN 'N' ELSE 'Y' END AS TRSP_DIFF_45FT" ).append("\n"); 
		query.append("      , DECODE(B.INLND_ROUT_CMB_FLG,'N',B.N1ST_VNDR_45FT_AGMT_WGT,GREATEST(B.N1ST_VNDR_45FT_AGMT_WGT, B.N2ND_VNDR_45FT_AGMT_WGT)) AGMT_WGT_45FT" ).append("\n"); 
		query.append("      , SUBSTR(B.N1ST_VNDR_45FT_AGMT_WY_TP_CD, 1, 1)||SUBSTR(B.N2ND_VNDR_45FT_AGMT_WY_TP_CD, 1, 1) AS TRSP_RATE_TYPE_45FT" ).append("\n"); 
		...
		query.append("      -- 45' Cost 추가 start" ).append("\n"); 
		query.append("      , COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03050', B.MTY_TRSP_45FT_COST_SYS_SRC_CD) MTY_TRSP_45FT_COST_SYS_SRC_NM" ).append("\n"); 
		query.append("      , B.MTY_TRSP_45FT_COST_AMT" ).append("\n"); 
		query.append("      , B.MTY_TRSP_45FT_ADJ_COST_AMT" ).append("\n"); 
		query.append("      , B.MTY_TRSP_45FT_TTL_COST_AMT" ).append("\n"); 
		query.append("      -- 45' Cost 추가 end" ).append("\n"); 
		...
		query.append("      -- 45' Cost 추가 start" ).append("\n"); 
		query.append("      , COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03050', B.TML_45FT_COST_SYS_SRC_CD) TML_45FT_COST_SYS_SRC_NM" ).append("\n"); 
		query.append("      , B.TML_45FT_COST_AMT" ).append("\n"); 
		query.append("      , B.TML_45FT_ADJ_COST_AMT" ).append("\n"); 
		query.append("      , B.TML_45FT_TTL_COST_AMT" ).append("\n"); 
		query.append("      -- 45' Cost 추가 end" ).append("\n"); 
		query.append("      , B.HJL_COST_RCVR_AMT HJL_FEE_AMT" ).append("\n"); 
		...
		query.append("                GREATEST(NVL(B.N1ST_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(B.N1ST_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(B.N1ST_VNDR_45FT_AGMT_OLD_FLG,'0'), NVL(B.N2ND_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(B.N2ND_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(B.N2ND_VNDR_45FT_AGMT_OLD_FLG,'0')),'0',NULL," ).append("\n"); 
		query.append("                GREATEST(NVL(B.N1ST_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(B.N1ST_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(B.N1ST_VNDR_45FT_AGMT_OLD_FLG,'0'), NVL(B.N2ND_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(B.N2ND_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(B.N2ND_VNDR_45FT_AGMT_OLD_FLG,'0'))" ).append("\n"); 
		...
		query.append("FROM    AOC_EUR_INLND_TRF_HDR A" ).append("\n"); 
		query.append("      , AOC_EUR_INLND_TRF_DTL B      " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("     --Full Trans 45' " ).append("\n"); 
		query.append("#if (${cost_factor_cd} == 'ALL' || ${fullTrans45} == 'Y')" ).append("\n"); 
		query.append("     OR B.TRSP_45FT_COST_SYS_SRC_CD IN (" ).append("\n"); 
		query.append("      #foreach ($user_sysSrcCds IN ${sysSrcCds})" ).append("\n"); 
		query.append("        #if($velocityCount < $sysSrcCds.size())" ).append("\n"); 
		query.append("          '$user_sysSrcCds'," ).append("\n"); 
		query.append("        #else" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append(" " ).append("\n"); 
		query.append("     --TMNL 45'" ).append("\n"); 
		query.append("#if (${cost_factor_cd} == 'ALL' || ${tmnl45} == 'Y')" ).append("\n"); 
		query.append("     OR B.TML_45FT_COST_SYS_SRC_CD IN (" ).append("\n"); 
		query.append("      #foreach ($user_sysSrcCds IN ${sysSrcCds})" ).append("\n"); 
		query.append("        #if($velocityCount < $sysSrcCds.size())" ).append("\n"); 
		query.append("          '$user_sysSrcCds'," ).append("\n"); 
		query.append("        #else" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("     --Empty 45'" ).append("\n"); 
		query.append("#if (${cost_factor_cd} == 'ALL' || ${empty45} == 'Y')" ).append("\n"); 
		query.append("     OR 'X' IN (" ).append("\n"); 
		query.append("      #foreach ($user_sysSrcCds IN ${sysSrcCds})" ).append("\n"); 
		query.append("        #if($velocityCount < $sysSrcCds.size())" ).append("\n"); 
		query.append("          '$user_sysSrcCds'," ).append("\n"); 
		...
		query.append("#if (${cost_factor_cd} == 'ALL' || ${fullTrans45} == 'Y')" ).append("\n"); 
		query.append("  #if (${adjustment_cd} == 'E')" ).append("\n"); 
		query.append("     OR NVL(B.TRSP_45FT_ADJ_COST_AMT, 0) = 0" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("  #if (${adjustment_cd} == 'N')" ).append("\n"); 
		query.append("     OR NVL(B.TRSP_45FT_ADJ_COST_AMT, 0) <> 0" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		...
		query.append("#if (${cost_factor_cd} == 'ALL' || ${tmnl45} == 'Y')" ).append("\n"); 
		query.append("  #if (${adjustment_cd} == 'E')" ).append("\n"); 
		query.append("     OR NVL(B.TML_45FT_ADJ_COST_AMT, 0) = 0" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("  #if (${adjustment_cd} == 'N')" ).append("\n"); 
		query.append("     OR NVL(B.TML_45FT_ADJ_COST_AMT, 0) <> 0" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		...
		query.append("#if (${cost_factor_cd} == 'ALL' || ${empty45} == 'Y')" ).append("\n"); 
		query.append("  #if (${adjustment_cd} == 'E')" ).append("\n"); 
		query.append("     OR NVL(B.MTY_TRSP_45FT_ADJ_COST_AMT, 0) = 0" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
		query.append("  #if (${adjustment_cd} == 'N')" ).append("\n"); 
		query.append("     OR NVL(B.MTY_TRSP_45FT_ADJ_COST_AMT, 0) <> 0" ).append("\n"); 
		query.append("  #end" ).append("\n"); 
