...
*@FileName : ESD_EAS_0316HTMLAction.java
...
public class ESD_EAS_0316HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0316HTMLAction 객체를 생성
	 */
	public ESD_EAS_0316HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0316Event event = new EsdEas0316Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setRehandlingBkgCodVO((RehandlingBkgCodVO)getVO(request, RehandlingBkgCodVO .class));
		}
