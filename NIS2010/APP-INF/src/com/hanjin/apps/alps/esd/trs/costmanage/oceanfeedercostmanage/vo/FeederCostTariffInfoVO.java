...
*@FileName : FeederCostTariffInfoVO.java
*@FileTitle : FeederCostTariffInfoVO
*Open Issues :
*Change history :
...
public class FeederCostTariffInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FeederCostTariffInfoVO> models = new ArrayList<FeederCostTariffInfoVO>();
	...
	public FeederCostTariffInfoVO() {}

	public FeederCostTariffInfoVO(String ibflag, String pagerows, String costTrfStsCd, String costTrfStsNm, String currCd, String effFmDt, String updDt, String updUsrId, String nextTrfFlg, String rhqCd) {
		this.updDt = updDt;
		this.ibflag = ibflag;
		this.currCd = currCd;
		this.rhqCd = rhqCd;
...
/**
	 ...
	 */
	public FeederCostTariffInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FeederCostTariffInfoVO[]
	 */
	public FeederCostTariffInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FeederCostTariffInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new FeederCostTariffInfoVO();
				if (updDt[i] != null)
	 ...
	 * @return FeederCostTariffInfoVO[]
	 */
	public FeederCostTariffInfoVO[] getFeederCostTariffInfoVOs(){
		FeederCostTariffInfoVO[] vos = (FeederCostTariffInfoVO[])models.toArray(new FeederCostTariffInfoVO[models.size()]);
		return vos;
	}
