...
*@FileName : OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateOffdockDetailN3rdFlag
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagUSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOUpdateOffdockDetailN3rdFlagUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
