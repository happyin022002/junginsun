...
*@FileName : MarineTerminalStorageInvoiceManageDBDAORemoveStorageInvoiceAutoCalcDataN3rdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAORemoveStorageInvoiceAutoCalcDataN3rdDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAORemoveStorageInvoiceAutoCalcDataN3rdDSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAORemoveStorageInvoiceAutoCalcDataN3rdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND T.CALC_COST_GRP_CD = @[calc_cost_grp_cd]" ).append("\n"); 
