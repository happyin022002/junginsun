...
*@FileName : CreditIncentiveStatusDBDAOMultiMileageCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOMultiMileageCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Mileage Insert/Update
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOMultiMileageCSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOMultiMileageCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EAS_BNF_MLG A USING DUAL" ).append("\n"); 
		query.append("ON( A.BSE_YR = @[bse_yr]" ).append("\n"); 
		query.append("AND A.INCNT_NO  = @[incnt_no]" ).append("\n"); 
		query.append(") " ).append("\n"); 
		query.append("WHEN MATCHED THEN" ).append("\n"); 
		query.append("     UPDATE SET RHQ_CD = @[rhq_cd]" ).append("\n"); 
		query.append("               ,TEAM_NM = @[team_nm]" ).append("\n"); 
		query.append("               ,BANK_NM = @[bank_nm]" ).append("\n"); 
		query.append("               ,MLG_FM_DT = TO_DATE(@[mlg_fm_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("               ,MLG_TO_DT = TO_DATE(@[mlg_to_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("               ,PAY_AMT = @[pay_amt]" ).append("\n"); 
		query.append("               ,MLG_ISS_DT = TO_DATE(@[mlg_iss_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("               ,MLG_PNT_AMT = @[mlg_pnt_amt]" ).append("\n"); 
		query.append("               ,CSH_BAK_DT = TO_DATE(@[csh_bak_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("               ,CSH_BAK_AMT = @[csh_bak_amt]" ).append("\n"); 
		query.append("               ,CSH_BAK_BAL_AMT = @[csh_bak_bal_amt]" ).append("\n"); 
