...
*@FileName : SearchEQKindVO.java
*@FileTitle : SearchEQKindVO
*Open Issues :
*Change history :
...
public class SearchEQKindVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchEQKindVO> models = new ArrayList<SearchEQKindVO>();
	...
	public SearchEQKindVO() {}

	public SearchEQKindVO(String ibflag, String pagerows, String intgCdValCtnt, String intgCdValDpDesc) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return SearchEQKindVO[]
	 */
	public SearchEQKindVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchEQKindVO[]
	 */
	public SearchEQKindVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchEQKindVO model = null;
	 ...
	 * @return SearchEQKindVO[]
	 */
	public SearchEQKindVO[] getSearchEQKindVOs(){
		SearchEQKindVO[] vos = (SearchEQKindVO[])models.toArray(new SearchEQKindVO[models.size()]);
		return vos;
	}
