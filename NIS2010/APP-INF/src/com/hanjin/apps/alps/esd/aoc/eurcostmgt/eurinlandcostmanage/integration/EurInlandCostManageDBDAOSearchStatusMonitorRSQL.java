...
*@FileName : EurInlandCostManageDBDAOSearchStatusMonitorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchStatusMonitorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchStatusMonitorRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchStatusMonitorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                                     , AOC_EUR_INLND_TRF_HDR C" ).append("\n"); 
		...
		query.append("          AND     A.COST_TRF_NO IN (" ).append("\n"); 
		query.append("                                     SELECT  H.COST_TRF_NO" ).append("\n"); 
		query.append("                                     FROM    AOC_EUR_FDR_TRF_HDR H" ).append("\n"); 
		query.append("                                           ," ).append("\n"); 
		query.append("                                             (" ).append("\n"); 
		query.append("                                               SELECT  A.RHQ_CD" ).append("\n"); 
		...
		query.append("                                                     , AOC_EUR_FDR_TRF_HDR C" ).append("\n"); 
