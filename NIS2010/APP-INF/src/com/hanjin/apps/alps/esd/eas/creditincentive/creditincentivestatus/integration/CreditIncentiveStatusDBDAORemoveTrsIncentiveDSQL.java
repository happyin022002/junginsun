...
*@FileName : CreditIncentiveStatusDBDAORemoveTrsIncentiveDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAORemoveTrsIncentiveDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRS Incentive Delete
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAORemoveTrsIncentiveDSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAORemoveTrsIncentiveDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EAS_TRSP_INCNT" ).append("\n"); 
