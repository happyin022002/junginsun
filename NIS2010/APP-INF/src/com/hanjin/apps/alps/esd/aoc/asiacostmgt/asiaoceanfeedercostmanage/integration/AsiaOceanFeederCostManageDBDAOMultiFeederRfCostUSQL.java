...
*@FileName : AsiaOceanFeederCostManageDBDAOMultiFeederRfCostUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOMultiFeederRfCostUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOMultiFeederRfCostUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOMultiFeederRfCostUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  AOC_CHN_FDR_RF_TRF_DTL" ).append("\n"); 
