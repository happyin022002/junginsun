...
*@FileName : TerminalAgreementManageDBDAODeleteThoroughputCCDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAODeleteThoroughputCCDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Thoroughput Cost Code Delete
	  * </pre>
	  */
	public TerminalAgreementManageDBDAODeleteThoroughputCCDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAODeleteThoroughputCCDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
