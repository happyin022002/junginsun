...
*@FileName : SearchResponsibleOfficeChangeInquiryVO.java
*@FileTitle : SearchResponsibleOfficeChangeInquiryVO
*Open Issues :
*Change history :
...
public class SearchResponsibleOfficeChangeInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchResponsibleOfficeChangeInquiryVO> models = new ArrayList<SearchResponsibleOfficeChangeInquiryVO>();
	 ...
	 */
	public SearchResponsibleOfficeChangeInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchResponsibleOfficeChangeInquiryVO[]
	 */
	public SearchResponsibleOfficeChangeInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchResponsibleOfficeChangeInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchResponsibleOfficeChangeInquiryVO();
				if (sCurrCdTp[i] != null)
	 ...
	 * @return SearchResponsibleOfficeChangeInquiryVO[]
	 */
	public SearchResponsibleOfficeChangeInquiryVO[] getSearchResponsibleOfficeChangeVOs(){
		SearchResponsibleOfficeChangeInquiryVO[] vos = (SearchResponsibleOfficeChangeInquiryVO[])models.toArray(new SearchResponsibleOfficeChangeInquiryVO[models.size()]);
		return vos;
	}
