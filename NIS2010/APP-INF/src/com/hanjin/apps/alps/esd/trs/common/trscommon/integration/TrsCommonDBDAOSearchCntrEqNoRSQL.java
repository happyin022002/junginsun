...
*@FileName : TrsCommonDBDAOSearchCntrEqNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsCommonDBDAOSearchCntrEqNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Container Validation 공통기능
	  * </pre>
	  */
	public TrsCommonDBDAOSearchCntrEqNoRSQL(){
		setQuery();
		...
		query.append("FileName : TrsCommonDBDAOSearchCntrEqNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
