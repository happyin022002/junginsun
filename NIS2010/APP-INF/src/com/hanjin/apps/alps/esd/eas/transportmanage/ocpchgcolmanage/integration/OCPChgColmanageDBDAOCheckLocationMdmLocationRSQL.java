...
*@FileName : OCPChgColmanageDBDAOCheckLocationMdmLocationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OCPChgColmanageDBDAOCheckLocationMdmLocationRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OCPChgColmanageDBDAOCheckLocationMdmLocationRSQL
	  * </pre>
	  */
	public OCPChgColmanageDBDAOCheckLocationMdmLocationRSQL(){
		setQuery();
		...
		query.append("FileName : OCPChgColmanageDBDAOCheckLocationMdmLocationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
