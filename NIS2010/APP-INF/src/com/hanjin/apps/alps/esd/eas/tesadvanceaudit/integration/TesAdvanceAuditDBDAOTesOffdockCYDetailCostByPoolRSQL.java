...
*@FileName : TesAdvanceAuditDBDAOTesOffdockCYDetailCostByPoolRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesAdvanceAuditDBDAOTesOffdockCYDetailCostByPoolRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TesOffdockCYDetailCostByPool
	  * </pre>
	  */
	public TesAdvanceAuditDBDAOTesOffdockCYDetailCostByPoolRSQL(){
		setQuery();
		...
		query.append("FileName : TesAdvanceAuditDBDAOTesOffdockCYDetailCostByPoolRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , MIN(SUBSTR(D.WRK_DT, 0, 6)) AS WRK_DT" ).append("\n"); 
