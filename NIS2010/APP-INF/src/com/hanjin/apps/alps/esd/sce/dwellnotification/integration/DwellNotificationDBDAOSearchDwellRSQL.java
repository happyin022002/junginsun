...
*@FileName : DwellNotificationDBDAOSearchDwellRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DwellNotificationDBDAOSearchDwellRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DwellNotificationDBDAOSearchDwellRSQL(){
		setQuery();
		...
		query.append("FileName : DwellNotificationDBDAOSearchDwellRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , (SELECT 'E-mailing History(SEQ:'||COUNT(*)||')'" ).append("\n"); 
		query.append("            FROM SCE_DWLL_NTFC_EML_SND_RSLT R" ).append("\n"); 
		query.append("            WHERE A.EML_SND_DT = R.EML_SND_DT  " ).append("\n"); 
		query.append("              AND A.DWLL_TM_TP_CD = R.DWLL_TM_TP_CD" ).append("\n"); 
		query.append("              AND A.CNTR_NO = R.CNTR_NO" ).append("\n"); 
		query.append("              AND A.BKG_NO = R.BKG_NO" ).append("\n"); 
		query.append("              AND S.CUST_CNT_CD = R.DWLL_CUST_CNT_CD" ).append("\n"); 
		query.append("              AND S.CUST_SEQ = R.DWLL_CUST_SEQ ) EML_CNT" ).append("\n"); 
		query.append("    , (SELECT 'E-mailing History(SEQ:'||COUNT(*)||')'" ).append("\n"); 
		query.append("            FROM SCE_DWLL_NTFC_EML_SND_RSLT R" ).append("\n"); 
		query.append("            WHERE A.EML_SND_DT = R.EML_SND_DT  " ).append("\n"); 
		query.append("              AND A.DWLL_TM_TP_CD = R.DWLL_TM_TP_CD" ).append("\n"); 
		...
		query.append("              AND A.BKG_NO = R.BKG_NO" ).append("\n"); 
		query.append("              AND C.CUST_CNT_CD = R.DWLL_CUST_CNT_CD" ).append("\n"); 
		query.append("              AND C.CUST_SEQ = R.DWLL_CUST_SEQ ) CNEE_EML_CNT" ).append("\n"); 
		query.append("    , (SELECT 'E-mailing History(SEQ:'||COUNT(*)||')'" ).append("\n"); 
		query.append("            FROM SCE_DWLL_NTFC_EML_SND_RSLT R" ).append("\n"); 
		query.append("            WHERE A.EML_SND_DT = R.EML_SND_DT  " ).append("\n"); 
		query.append("              AND A.DWLL_TM_TP_CD = R.DWLL_TM_TP_CD" ).append("\n"); 
		...
		query.append("              AND A.BKG_NO = R.BKG_NO" ).append("\n"); 
		query.append("              AND N.CUST_CNT_CD = R.DWLL_CUST_CNT_CD" ).append("\n"); 
		query.append("              AND N.CUST_SEQ = R.DWLL_CUST_SEQ ) NTFY_EML_CNT" ).append("\n"); 
		...
		query.append("	, S.CUST_CNT_CD||DECODE(S.CUST_SEQ, NULL, '', 0, '', LPAD(S.CUST_SEQ, 6, '0'))||NVL2(S.CUST_NM,'('||S.CUST_NM||')', '') SHIP_CUST_CD_NM" ).append("\n"); 
		...
		query.append("    ,  SCE_DWLL_NTFC_CUST S" ).append("\n"); 
		query.append("    ,  SCE_DWLL_NTFC_CUST C" ).append("\n"); 
		query.append("    ,  SCE_DWLL_NTFC_CUST N" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append(" -- correction 14/10/30" ).append("\n"); 
		...
		query.append("WHERE 'Y' in  (AA.SND_STS,CNEE_SND_STS,NTFY_SND_STS)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif(${sent} == 'N')" ).append("\n"); 
		query.append("WHERE NOT('Y' in  (AA.SND_STS,CNEE_SND_STS,NTFY_SND_STS))" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("" ).append("\n"); 
