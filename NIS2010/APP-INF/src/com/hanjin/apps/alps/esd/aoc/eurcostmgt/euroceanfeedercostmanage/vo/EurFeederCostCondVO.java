...
*@FileName : EurFeederCostCondVO.java
*@FileTitle : EurFeederCostCondVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurFeederCostCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurFeederCostCondVO> models = new ArrayList<EurFeederCostCondVO>();
...
/**
	 ...
	 */
	public EurFeederCostCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurFeederCostCondVO[]
	 */
	public EurFeederCostCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurFeederCostCondVO model = null;
	 ...
	 * @return EurFeederCostCondVO[]
	 */
	public EurFeederCostCondVO[] getOceanFeederCostCondVOs(){
		EurFeederCostCondVO[] vos = (EurFeederCostCondVO[])models.toArray(new EurFeederCostCondVO[models.size()]);
		return vos;
	}
