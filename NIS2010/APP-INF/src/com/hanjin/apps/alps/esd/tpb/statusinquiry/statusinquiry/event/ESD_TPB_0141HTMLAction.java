...
*@FileName : ESD_TPB_0141HTMLAction.java
...
public class ESD_TPB_0141HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0141HTMLAction 객체를 생성
	 */
	public ESD_TPB_0141HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0141Event event = new EsdTpb0141Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEmailFaxSentHistVO((EmailFaxSentHistVO)getVO(request, EmailFaxSentHistVO .class));
		}
