...
*@FileName : CreditIncentiveStatusDBDAORemoveMileageDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAORemoveMileageDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAORemoveMileageDSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAORemoveMileageDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
