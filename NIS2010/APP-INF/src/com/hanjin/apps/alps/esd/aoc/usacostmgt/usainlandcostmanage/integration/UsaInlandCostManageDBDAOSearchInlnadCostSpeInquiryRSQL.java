...
*@FileName : UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , AOC_USA_INLND_SPCL_TRF_DTL B      " ).append("\n"); 
