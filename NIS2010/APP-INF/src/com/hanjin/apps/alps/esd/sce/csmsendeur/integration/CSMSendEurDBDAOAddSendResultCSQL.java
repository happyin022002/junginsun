...
*@FileName : CSMSendEurDBDAOAddSendResultCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSMSendEurDBDAOAddSendResultCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSMSendEurDBDAOAddSendResultCSQL(){
		setQuery();
		...
		query.append("FileName : CSMSendEurDBDAOAddSendResultCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("CSM_CNT_CD, -- 구주 세관 신규 개발 추가  " ).append("\n"); 
		...
		query.append("		      AND ACT_RCV_NO = @[act_rcv_no] ) A, " ).append("\n"); 
		query.append("		 (  " ).append("\n"); 
		query.append("           SELECT ACT_RCV_DT, " ).append("\n"); 
		query.append("		          ACT_RCV_NO, " ).append("\n"); 
		query.append("		          STND_EDI_STS_CD, " ).append("\n"); 
