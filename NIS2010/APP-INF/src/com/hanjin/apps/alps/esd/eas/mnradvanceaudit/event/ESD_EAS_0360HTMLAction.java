 ...
 * @since J2EE 1.4
 */
public class ESD_EAS_0360HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0360Event event = new EsdEas0360Event();
		...
		if(command.isCommand(FormCommand.SEARCH)){ 
			event.setMnrInvoiceChargeINVO((MnrInvoiceChargeINVO)getVO(request, MnrInvoiceChargeINVO.class));
 			...
 			event.setMnrChargeListVOS((MnrChargeListVO[])getVOs(request, MnrChargeListVO.class));
