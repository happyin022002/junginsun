...
public class EsdTrs0023Event extends EventSupport {
	...
	WoIssueListVO [] woIssueListVOs = null;
...
//	private SurchargeVO surchargeVO = null;
	...
	public WoIssueListVO [] getWoIssueListVOs(){
		...
		if (this.woIssueListVOs != null) {
			rtnVOs = new WoIssueListVO[woIssueListVOs.length];
			System.arraycopy(woIssueListVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}	
	public void setWoIssueListVOs(WoIssueListVO [] WoIssueListVOs){
		if (WoIssueListVOs != null) {
			WoIssueListVO[] tmpVOs = new WoIssueListVO[WoIssueListVOs.length];
			System.arraycopy(WoIssueListVOs, 0, tmpVOs, 0, tmpVOs.length);
	...
	String radioContract;
	String scRfaCd;
	
	String vgmFlg;
	
	public String getRadioContract() {
		return radioContract;
	}
	public void setRadioContract(String radioContract) {
		this.radioContract = radioContract;
	}
