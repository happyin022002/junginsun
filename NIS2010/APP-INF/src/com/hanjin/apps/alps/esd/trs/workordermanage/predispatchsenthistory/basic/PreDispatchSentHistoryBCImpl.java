...
import com.hanjin.apps.alps.esd.trs.workordermanage.predispatchsenthistory.integration.PreDispatchSentHistoryDBDAO;
import com.hanjin.apps.alps.esd.trs.workordermanage.predispatchsenthistory.integration.RDFaxSendEAIDAO;
import com.hanjin.apps.alps.esd.trs.workordermanage.predispatchsenthistory.integration.RDMailSendEAIDAO;
...
//			return new EsdTrs0021EventResponse(rowSet,"SUCCESS");
...
//		// 데이터 전송을 위해 DB ResultSet을 구현한 객체
//		try {
//			ArrayList arr_list = dbDao.batchPreDispatchSentHistory(models);
//			return new ESD012_HU01EventResponse(arr_list);
//		} catch (DAOException de) {
//			log.error("err "+de.toString(),de);
//			throw new EventException(de.getMessage());
//		}		
...
//			return new PreDispatchStatusEventResponse();
			return eventResponse;
		} catch (DAOException de) {
			log.error("err "+de.toString(),de);
			throw new EventException(de.getMessage());
