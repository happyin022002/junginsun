...
*@FileName : ESD_AOC_3125HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3125HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3125HTMLAction 객체를 생성
	 */
	public ESD_AOC_3125HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3125Event event = new EsdAoc3125Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setOceanFeederCostCondVO((AsiaFeederCostCondVO)getVO(request, AsiaFeederCostCondVO .class));
