...
*@FileName : OceanLinkBackEndDBDAOHistoryOcnAddCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanLinkBackEndDBDAOHistoryOcnAddCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 특정 Ocean Route를 History로 저장한다
	  * </pre>
	  */
	public OceanLinkBackEndDBDAOHistoryOcnAddCSQL(){
		setQuery();
		...
		query.append("FileName : OceanLinkBackEndDBDAOHistoryOcnAddCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND ROUT_SEQ = TO_NUMBER(@[routSeq])" ).append("\n"); 
