...
*@FileName : WorkOrderPreviewDBDAOSearchEdi10514701AwkwardCgoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOSearchEdi10514701AwkwardCgoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchEdi_105147_01_AWKWARD_CGO
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOSearchEdi10514701AwkwardCgoRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOSearchEdi10514701AwkwardCgoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND th.awk_cgo_seq = awk.awk_cgo_seq" ).append("\n"); 
