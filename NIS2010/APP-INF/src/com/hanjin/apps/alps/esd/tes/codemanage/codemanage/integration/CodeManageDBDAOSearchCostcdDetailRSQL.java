...
*@FileName : CodeManageDBDAOSearchCostcdDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeManageDBDAOSearchCostcdDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CodeManageDBDAOSearchCostcdDetail
	  * LGS COST CODE 조회
	  * </pre>
	  */
	public CodeManageDBDAOSearchCostcdDetailRSQL(){
		setQuery();
		...
		query.append("FileName : CodeManageDBDAOSearchCostcdDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY LGS_COST_CD DESC" ).append("\n"); 
