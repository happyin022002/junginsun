...
*@FileName : UsaInlnadCostSpeInquiryVO.java
*@FileTitle : UsaInlnadCostSpeInquiryVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class UsaInlnadCostSpeInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaInlnadCostSpeInquiryVO> models = new ArrayList<UsaInlnadCostSpeInquiryVO>();
	 ...
	 */
	public UsaInlnadCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaInlnadCostSpeInquiryVO[]
	 */
	public UsaInlnadCostSpeInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaInlnadCostSpeInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaInlnadCostSpeInquiryVO();
				if (rfFxRto[i] != null)
	...
	public UsaInlnadCostSpeInquiryVO[] getInlnadCostSpeInquiryVOs(){
		UsaInlnadCostSpeInquiryVO[] vos = (UsaInlnadCostSpeInquiryVO[])models.toArray(new UsaInlnadCostSpeInquiryVO[models.size()]);
		return vos;
	}
