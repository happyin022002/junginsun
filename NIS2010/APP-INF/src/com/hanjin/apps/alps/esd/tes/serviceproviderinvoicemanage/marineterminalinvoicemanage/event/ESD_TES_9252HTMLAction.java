...
*@FileName : ESD_TES_9252HTMLAction.java
 ...
 *
 * @author kimjinjoo
 * @see EsdTes9252Event,EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9252HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_925_2HTMLAction 객체를 생성
	 */
	public ESD_TES_9252HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_925_2Event로 파싱하여 request에 셋팅<br>
	 *
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		log.debug("start ESD_TES_9252HTMLAction ===============================> ");
...
//		FormCommand			command	= FormCommand.fromRequest(request);
		EsdTes9252Event		event	= new EsdTes9252Event();
