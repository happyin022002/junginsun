...
*@FileName : RailSoManageDBDAOMultiUsaRailBillVoSeqCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAOMultiUsaRailBillVoSeqCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SO 정보를 SO Vendor 테이블에 추가 SQL
	  * </pre>
	  */
	public RailSoManageDBDAOMultiUsaRailBillVoSeqCSQL(){
		setQuery();
		...
		query.append("FileName : RailSoManageDBDAOMultiUsaRailBillVoSeqCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("MAX(MIN_SEQ) MIN_SEQ," ).append("\n"); 
		query.append("MAX(MAX_SEQ) MAX_SEQ," ).append("\n"); 
		query.append("MAX(N1ST_VNDR) N1ST_VNDR," ).append("\n"); 
		query.append("MAX(N2ND_Vndr) N2ND_VNDR," ).append("\n"); 
		query.append("MAX(N3RD_VNDR) N3RD_VNDR" ).append("\n"); 
		query.append("FROM(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("MIN_SEQ, MAX_SEQ," ).append("\n"); 
		...
		query.append("MAX(DECODE( @[fm_nod_cd] , LNK_ORG_NOD_CD, ROUT_DTL_SEQ)) MIN_SEQ," ).append("\n"); 
		query.append("MAX(DECODE( @[to_nod_cd] , LNK_DEST_NOD_CD, ROUT_DTL_SEQ)) MAX_SEQ" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
