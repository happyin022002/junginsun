...
*@FileName : SceAdminManageDBDAOaddCandidateSceCsrMntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SceAdminManageDBDAOaddCandidateSceCsrMntrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SceAdminManageDBDAOaddCandidateSceCsrMntrCSQL(){
		setQuery();
		...
		query.append("FileName : SceAdminManageDBDAOaddCandidateSceCsrMntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into SCE_CSR_MNTR" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("TRIM(@[bkg_no])," ).append("\n"); 
		query.append("@[cntr_no]," ).append("\n"); 
		query.append("@[cost_act_grp_cd]," ).append("\n"); 
		query.append("@[cost_act_grp_seq]," ).append("\n"); 
		query.append("'LEAIF'," ).append("\n"); 
