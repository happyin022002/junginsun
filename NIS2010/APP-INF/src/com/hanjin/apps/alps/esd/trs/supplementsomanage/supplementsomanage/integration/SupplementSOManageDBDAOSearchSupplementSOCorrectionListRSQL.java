...
public class SupplementSOManageDBDAOSearchSupplementSOCorrectionListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("X.TTL_DIST," ).append("\n"); 
		query.append("NVL(X.LNK_DIST_DIV_CD,' ') LNK_DIST_DIV_CD" ).append("\n"); 
		...
		query.append("AND A.LOCL_CRE_DT < TO_DATE(NVL(@[to_date], '99991231'), 'YYYYMMDD')+0.99999" ).append("\n"); 
		...
		query.append("AND AA.HJL_NO IS NULL" ).append("\n"); 
