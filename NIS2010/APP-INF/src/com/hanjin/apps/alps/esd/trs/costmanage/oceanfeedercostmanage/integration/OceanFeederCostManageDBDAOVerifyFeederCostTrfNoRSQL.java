...
*@FileName : OceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.costmanage.oceanfeedercostmanage.integration ").append("\n"); 
		query.append("FileName : OceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
