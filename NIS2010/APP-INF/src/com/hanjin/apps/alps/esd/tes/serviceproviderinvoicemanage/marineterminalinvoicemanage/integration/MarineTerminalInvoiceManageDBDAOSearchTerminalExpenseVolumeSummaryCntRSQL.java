...
*@FileName : MarineTerminalInvoiceManageDBDAOSearchTerminalExpenseVolumeSummaryCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOSearchTerminalExpenseVolumeSummaryCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchTerminalExpenseVolumeSummary 총개수
	  * MarineTerminalInvoiceManageDBDAOSearchTerminalExpenseVolumeSummaryCnt
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOSearchTerminalExpenseVolumeSummaryCntRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOSearchTerminalExpenseVolumeSummaryCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
