...
*@FileName : EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlnadCostSpeInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , AOC_EUR_INLND_SPCL_TRF_DTL B      " ).append("\n"); 
