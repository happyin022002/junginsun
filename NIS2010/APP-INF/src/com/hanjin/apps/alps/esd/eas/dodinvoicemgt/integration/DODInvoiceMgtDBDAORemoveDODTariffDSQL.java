...
*@FileName : DODInvoiceMgtDBDAORemoveDODTariffDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DODInvoiceMgtDBDAORemoveDODTariffDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DODInvoiceMgtDBDAORemoveDODTariffDSQL(){
		setQuery();
		...
		query.append("FileName : DODInvoiceMgtDBDAORemoveDODTariffDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EAS_DOD_TRF " ).append("\n"); 
