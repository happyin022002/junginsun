                ...
                while(rs.next()){
                    ...
                    for(int j = 0; j < colCount; j++){
                    	...
                    	if( "TRSP_SO_OFC_CTY_CD".equals(colName) ) {
                    		...
                    		sb.append("<TD><![CDATA[");
    						sb.append(getNull(rs.getObject(colName)) + "]]></TD>");
                    	}else if (colName.equals("FM_NOD_CD") || colName.equals("TO_NOD_CD")) {
	        				sb.append((new StringBuilder())
    						  .append("<TD")
    						  .append(" COMBO-TEXT='").append(JSPUtil.getNull(rs.getObject(colName))).append("'")
    						  .append(" COMBO-CODE='").append(JSPUtil.getNull(rs.getObject(colName))).append("'")
    						  .append(">")
    						  .append(JSPUtil.getNull(rs.getObject(colName)))
    						  .append("</TD>").toString());
                    	}else {
                    		sb.append("<TD>");
    						sb.append(getNull(rs.getObject(colName)) + "</TD>");
