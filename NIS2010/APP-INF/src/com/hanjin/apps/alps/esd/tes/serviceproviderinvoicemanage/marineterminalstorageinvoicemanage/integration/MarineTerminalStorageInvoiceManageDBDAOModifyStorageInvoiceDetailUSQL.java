...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceDetailUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyStorageInvoiceDetail
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceDetailUSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOModifyStorageInvoiceDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
