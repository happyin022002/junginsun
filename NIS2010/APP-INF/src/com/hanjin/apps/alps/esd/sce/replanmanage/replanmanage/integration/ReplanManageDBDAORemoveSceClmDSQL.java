...
*@FileName : ReplanManageDBDAORemoveSceClmDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReplanManageDBDAORemoveSceClmDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReplanManageDBDAORemoveSceClmDSQL(){
		setQuery();
		...
		query.append("FileName : ReplanManageDBDAORemoveSceClmDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCE_CLM" ).append("\n"); 
