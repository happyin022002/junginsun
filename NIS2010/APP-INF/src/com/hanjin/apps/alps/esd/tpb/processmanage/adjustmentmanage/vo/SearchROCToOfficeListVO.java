...
*@FileName : SearchROCToOfficeListVO.java
*@FileTitle : SearchROCToOfficeListVO
*Open Issues :
*Change history :
...
public class SearchROCToOfficeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchROCToOfficeListVO> models = new ArrayList<SearchROCToOfficeListVO>();
	...
	public SearchROCToOfficeListVO() {}

	public SearchROCToOfficeListVO(String ibflag, String pagerows, String ofcCd, String n3ptyOfcCd, String rhqCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String sOfcCd, String sIfOfcCd, String sIfRhqCd) {
		this.updDt = updDt;
		this.rhqCd = rhqCd;
	 ...
	 */
	public SearchROCToOfficeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchROCToOfficeListVO[]
	 */
	public SearchROCToOfficeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchROCToOfficeListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchROCToOfficeListVO();
				if (updDt[i] != null)
		...
		return getSearchROCToOfficeListVOs();
	}
	...
	public SearchROCToOfficeListVO[] getSearchROCToOfficeListVOs(){
		SearchROCToOfficeListVO[] vos = (SearchROCToOfficeListVO[])models.toArray(new SearchROCToOfficeListVO[models.size()]);
		return vos;
	}
