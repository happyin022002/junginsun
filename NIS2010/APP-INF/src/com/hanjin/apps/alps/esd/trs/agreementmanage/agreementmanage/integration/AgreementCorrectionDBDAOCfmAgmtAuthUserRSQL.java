...
*@FileName : AgreementCorrectionDBDAOCfmAgmtAuthUserRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAOCfmAgmtAuthUserRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * User별 Confirm Office정보 조회
	  * </pre>
	  */
	public AgreementCorrectionDBDAOCfmAgmtAuthUserRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAOCfmAgmtAuthUserRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
