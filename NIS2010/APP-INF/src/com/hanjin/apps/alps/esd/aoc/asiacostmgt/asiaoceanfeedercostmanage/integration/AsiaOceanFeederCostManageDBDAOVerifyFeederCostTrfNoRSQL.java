...
*@FileName : AsiaOceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiaoceanfeedercostmanage.integration").append("\n"); 
		query.append("FileName : AsiaOceanFeederCostManageDBDAOVerifyFeederCostTrfNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
