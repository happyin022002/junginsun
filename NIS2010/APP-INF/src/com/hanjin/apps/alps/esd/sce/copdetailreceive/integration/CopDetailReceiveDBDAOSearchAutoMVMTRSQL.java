...
public class CopDetailReceiveDBDAOSearchAutoMVMTRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",TO_CHAR( GLOBALDATE_PKG.TIME_CONV_FNC('KRSEL', sysdate, substr(@[nod_cd],1,5)),'YYYY/MM/DD HH24:MI:SS' )  ACT_DAT_RCV_DT   -- 20130430 By MinJi Jang" ).append("\n"); 
		query.append("--,TO_CHAR(SYSDATE,'YYYY/MM/DD HH24:MI:SS') ACT_DAT_RCV_DT" ).append("\n"); 
		...
		query.append(",TO_CHAR(UPD_LOCL_DT,'YYYY/MM/DD HH24:MI:SS') ACT_DAT_RCV_DT    -- 20130430 By MinJi Jang" ).append("\n"); 
		query.append("--,TO_CHAR(CRE_DT,'YYYY/MM/DD HH24:MI:SS') ACT_DAT_RCV_DT" ).append("\n"); 
		...
		query.append("AND   CNMV_EVNT_DT = TO_DATE(@[act_dt],'YYYY/MM/DD HH24:MI:SS')" ).append("\n"); 
		query.append("-- CHM-201325965" ).append("\n"); 
		...
		query.append("union" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("-- CHM-201324080 Movement A/F Type I/F Start" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		...
		query.append("AND		M.CNMV_CYC_NO			IN	( @[cnmv_cyc_no], @[cnmv_cyc_no] - 1 )	-- in case when ID (TN) When OC comes" ).append("\n"); 
		query.append("AND		M.MVMT_CRE_TP_CD	IN ('U','S')" ).append("\n"); 
		query.append("AND		NOT ( M.ORG_YD_CD	LIKE 'CNXGG%' AND MVMT_STS_CD = 'ID' )	-- 20130430 By MinJi Jang" ).append("\n"); 
		query.append("AND		@[act_sts_mapg_cd]  IN ( 'OC' , 'MT', 'IC' )				-- 20130430 By MinJi Jang" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("-- CHM-201324080 Movement A/F Type I/F End" ).append("\n"); 
		query.append(")" ).append("\n"); 
