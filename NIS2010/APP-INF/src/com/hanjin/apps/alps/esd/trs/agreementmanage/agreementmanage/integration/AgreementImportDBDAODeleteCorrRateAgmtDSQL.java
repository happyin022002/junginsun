...
*@FileName : AgreementImportDBDAODeleteCorrRateAgmtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAODeleteCorrRateAgmtDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgreementImportDBDAODeleteCorrRateAgmtDSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAODeleteCorrRateAgmtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
