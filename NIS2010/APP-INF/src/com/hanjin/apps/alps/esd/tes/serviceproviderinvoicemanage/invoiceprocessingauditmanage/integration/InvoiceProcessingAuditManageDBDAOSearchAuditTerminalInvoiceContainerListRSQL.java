...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Audit Invoice Terminal Container List
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceContainerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, A.LANE_CD2" ).append("\n"); 
		query.append("		, A.ATB_DT" ).append("\n"); 
		query.append("		, A.CNTR_NO" ).append("\n"); 
		query.append("		, A.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("		, A.CNTR_STY_CD" ).append("\n"); 
		query.append("		, A.LOCL_TS_IND_CD" ).append("\n"); 
		query.append("		, A.SAM_LOCL_TS_IND_CD" ).append("\n"); 
		query.append("		, A.RCVDE_TERM_IND_CD" ).append("\n"); 
		query.append("		, A.PRE_YD_CD" ).append("\n"); 
		query.append("		, A.MVMT_GATE_IN_DT" ).append("\n"); 
		query.append("		, A.INV_GATE_IN_DT" ).append("\n"); 
		query.append("		, A.GATE_IN_TD_DYS" ).append("\n"); 
		query.append("		, A.MVMT_GATE_OUT_DT" ).append("\n"); 
		query.append("		, A.INV_GATE_OUT_DT" ).append("\n"); 
		query.append("		, A.GATE_OUT_TD_DYS" ).append("\n"); 
		query.append("		, A.MVMT_STAY_DYS" ).append("\n"); 
		query.append("		, A.INV_STAY_DYS" ).append("\n"); 
		query.append("		, A.STAY_DIFF_DYS" ).append("\n"); 
		query.append("		, A.DCGO_CLSS_CD" ).append("\n"); 
		query.append("		, A.BB_CGO_FLG" ).append("\n"); 
		query.append("		, A.WRK_DT" ).append("\n"); 
		query.append("		, A.CLM_DT" ).append("\n"); 
		query.append("		, A.RAIL_BIL_DT" ).append("\n"); 
		query.append("		, A.BKG_NO_CON" ).append("\n"); 
		query.append("		, A.BKG_NO" ).append("\n"); 
		query.append("		, A.BL_NO" ).append("\n"); 
		query.append("		, A.DSCR_RSN" ).append("\n"); 
		query.append("		, A.HNDL_RSLT_RMK" ).append("\n"); 
		query.append("		, A.CNTR_RMK" ).append("\n"); 
		query.append("		, A.VVD" ).append("\n"); 
		query.append("		, A.DSCR_DTL_IND_CD" ).append("\n"); 
		query.append("		, A.TML_TRNS_MOD_CD" ).append("\n"); 
		query.append("		, A.AWK_CGO_FLG" ).append("\n"); 
		query.append("		, A.RC_FLG" ).append("\n"); 
		query.append("		, A.NO AS TOTAL" ).append("\n"); 
		...
		query.append("				, DECODE(TES_GET_COMCODENAME_FNC('CD00823', C.DSCR_IND_CD), NULL, '', TES_GET_COMCODENAME_FNC('CD00823', C.DSCR_IND_CD)) AS DSCR_IND_NM" ).append("\n"); 
		...
		query.append("				, C.LANE_CD AS LANE_CD2" ).append("\n"); 
		query.append("				, TO_CHAR(C.ATB_DT, 'YYYY-MM-DD') AS ATB_DT" ).append("\n"); 
		query.append("				, C.CNTR_NO" ).append("\n"); 
		query.append("				, C.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("				, C.CNTR_STY_CD" ).append("\n"); 
		query.append("				, C.LOCL_TS_IND_CD" ).append("\n"); 
		query.append("				, C.SAM_LOCL_TS_IND_CD" ).append("\n"); 
		query.append("				, SUBSTR(C.RCVDE_TERM_IND_CD, 0, 1) || '/' || SUBSTR(C.RCVDE_TERM_IND_CD, 2, 1) AS RCVDE_TERM_IND_CD" ).append("\n"); 
		query.append("				, C.PRE_YD_CD" ).append("\n"); 
		query.append("				, TO_CHAR(C.MVMT_GATE_IN_DT, 'YYYY-MM-DD') AS MVMT_GATE_IN_DT" ).append("\n"); 
		query.append("				, TO_CHAR(C.INV_GATE_IN_DT, 'YYYY-MM-DD') AS INV_GATE_IN_DT" ).append("\n"); 
		...
		query.append("				, TO_CHAR(C.WRK_DT, 'YYYY-MM-DD') AS WRK_DT" ).append("\n"); 
		query.append("				, TO_CHAR(C.CLM_DT, 'YYYY-MM-DD') AS CLM_DT" ).append("\n"); 
		query.append("				, TO_CHAR(C.RAIL_BIL_DT, 'YYYY-MM-DD') AS RAIL_BIL_DT" ).append("\n"); 
		query.append("				, DECODE(C.CNTR_STY_CD, 'F', C.BKG_NO, '' ) AS BKG_NO_CON" ).append("\n"); 
		...
		query.append("				, C.VSL_CD || C.SKD_VOY_NO || C.SKD_DIR_CD AS VVD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("AND		A.NO BETWEEN @[startpart] AND @[endpart]" ).append("\n"); 
