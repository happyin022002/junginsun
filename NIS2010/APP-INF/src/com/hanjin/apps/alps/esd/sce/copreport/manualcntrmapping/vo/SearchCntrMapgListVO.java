...
package com.hanjin.apps.alps.esd.sce.copreport.manualcntrmapping.vo;
...
public class SearchCntrMapgListVO extends AbstractValueObject {
	...
	public SearchCntrMapgListVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String cntrTpszCd, String bkgCreDt, String nisEventDt, String cntrVolQty, String cntrRcvTermCd, String cntrDeTermCd, String dist) {
	...
	public SearchCntrMapgListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] nisEventDt = (JSPUtil.getParameter(request, prefix	+ "nis_event_dt", length));
