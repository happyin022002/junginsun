...
public class VskEmailSendDBDAOSearchVslSkdCtntRSQL implements ISQLTemplate{
	...
	public VskEmailSendDBDAOSearchVslSkdCtntRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.sce.emailjobmanage.vskemailsend.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("#if(${emlGrpId} != 'SAMSUNG_ELEC')" ).append("\n"); 
		query.append("AND VPS_PORT_CD = @[toPortCd]" ).append("\n"); 
