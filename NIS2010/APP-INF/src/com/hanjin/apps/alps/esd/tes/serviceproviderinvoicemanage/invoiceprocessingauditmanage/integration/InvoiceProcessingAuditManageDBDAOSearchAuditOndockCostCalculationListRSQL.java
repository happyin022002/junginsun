...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOndockCostCalculationListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOndockCostCalculationListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * AuditOndockCostCalculationList 조회
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOndockCostCalculationListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOndockCostCalculationListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, A.CNTR_TPSZ_CD2" ).append("\n"); 
		...
		query.append("				, LPAD(D.REF_VNDR_SEQ, 6, '0') AS REF_VNDR_SEQ" ).append("\n"); 
		...
		query.append("				, D.VOL_TR_UT_CD" ).append("\n"); 
		query.append("				, D.CTRT_RT" ).append("\n"); 
		query.append("				, LPAD(D.REF_VNDR_SEQ, 6, '0')" ).append("\n"); 
		query.append("				, D.TML_CRR_CD" ).append("\n"); 
		query.append("				, D.CALC_RMK" ).append("\n"); 
