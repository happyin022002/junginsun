 ...
 * @since J2EE 1.5
 */
public class EsdSce0154ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		sbufXML.append("<TD COL=\"prop_mqc_qty\" DATA-TYPE=\"dtData\"><![CDATA[" + JSPUtil.getNull(cloumndata[1].toString()) +"]]></TD>\n");
		sbufXML.append("<TD COL=\"unit_nm\" DATA-TYPE=\"dtData\"><![CDATA["+ JSPUtil.getNull(cloumndata[2].toString()) +"]]></TD>\n");
		sbufXML.append("<TD COL=\"prop_ofc_cd\" DATA-TYPE=\"dtData\"><![CDATA[" + JSPUtil.getNull(cloumndata[3].toString()) +"]]></TD>\n");
		...
		sbufXML.append("<TD COL=\"email_list_cnt\" DATA-TYPE=\"dtData\"><![CDATA[" + JSPUtil.getNull(cloumndata[6].toString()) +"]]></TD>\n");
		sbufXML.append("</TR>\n");
		sbufXML.append("</DATA>\n");
