...
*@FileName : TesAdvanceAuditDBDAOTesMRStorageFreeDayHistoryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesAdvanceAuditDBDAOTesMRStorageFreeDayHistoryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TesMRStorageFreeDayHistory
	  * </pre>
	  */
	public TesAdvanceAuditDBDAOTesMRStorageFreeDayHistoryRSQL(){
		setQuery();
		...
		query.append("FileName : TesAdvanceAuditDBDAOTesMRStorageFreeDayHistoryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
