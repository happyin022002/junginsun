...
*@FileName : USARailPerformanceDBDAOSearchENISSORRailPerformanceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchENISSORRailPerformanceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchENISSORRailPerformance select
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchENISSORRailPerformanceRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchENISSORRailPerformanceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	  AND T.AGMT_REF_NO = @[agmt_ref_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
