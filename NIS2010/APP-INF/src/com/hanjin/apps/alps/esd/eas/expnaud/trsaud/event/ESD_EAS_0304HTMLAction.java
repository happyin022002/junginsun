...
*@FileName : ESD_EAS_0304HTMLAction.java
...
public class ESD_EAS_0304HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0304HTMLAction 객체를 생성
	 */
	public ESD_EAS_0304HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0304Event event = new EsdEas0304Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setSpecialSoOfTrsVO((SpecialSoOfTrsVO)getVO(request, SpecialSoOfTrsVO .class));
		}
