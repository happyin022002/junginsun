...
*@FileName : SearchWriteOffReviewVO.java
*@FileTitle : SearchWriteOffReviewVO
*Open Issues :
*Change history :
...
public class SearchWriteOffReviewVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchWriteOffReviewVO> models = new ArrayList<SearchWriteOffReviewVO>();
	 ...
	 * @param request
	 * @return SearchWriteOffReviewVO[]
	 */
	public SearchWriteOffReviewVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchWriteOffReviewVO[]
	 */
	public SearchWriteOffReviewVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchWriteOffReviewVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchWriteOffReviewVO();
				if (sCurrCdTp[i] != null)
		...
		return getSearchWriteOffReviewVOs();
	}
	...
	public SearchWriteOffReviewVO[] getSearchWriteOffReviewVOs(){
		SearchWriteOffReviewVO[] vos = (SearchWriteOffReviewVO[])models.toArray(new SearchWriteOffReviewVO[models.size()]);
		return vos;
	}
