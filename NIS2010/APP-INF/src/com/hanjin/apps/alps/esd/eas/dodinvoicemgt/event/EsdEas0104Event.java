 ...
 * @since J2EE 1.4
 */
public class EsdEas0104Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	private DODCollectionParmVO dODCollectionParmVO = null;

	public DODCollectionParmVO getDODCollectionParmVO() {
		return dODCollectionParmVO;
	}

	public void setDODCollectionParmVO(DODCollectionParmVO dODCollectionParmVO) {
		this.dODCollectionParmVO = dODCollectionParmVO;
	}
