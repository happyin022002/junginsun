...
*@FileName : DOFChgTrfmanageDBDAOmultiDrffChgTrfDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DOFChgTrfmanageDBDAOmultiDrffChgTrfDtlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DOFChgTrfmanageDBDAOmultiDrffChgTrfDtlUSQL(){
		setQuery();
		...
		query.append("FileName : DOFChgTrfmanageDBDAOmultiDrffChgTrfDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EAS_DRFF_CHG_TRF_DTL" ).append("\n"); 
		query.append("SET SCC_CD = @[scc_cd]" ).append("\n"); 
		...
		query.append(",POD_CNT_LIST_CTNT = @[pod_cnt_list_ctnt]" ).append("\n"); 
		query.append(",CURR_CD = @[curr_cd]" ).append("\n"); 
		query.append(",CURR_LIST_CTNT = @[curr_list_ctnt]" ).append("\n"); 
		query.append(",EXP_FLG = @[exp_flg]" ).append("\n"); 
