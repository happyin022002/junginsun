...
*@FileName : RehandExpmanageDBDAOOpfTdrAtchFileVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RehandExpmanageDBDAOOpfTdrAtchFileVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RehandExpmanageDBDAOOpfTdrAtchFileVORSQL(){
		setQuery();
		...
		query.append("FileName : RehandExpmanageDBDAOOpfTdrAtchFileVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
