...
public class InvoiceCreationVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSLoclTaxAmt(JSPUtil.getParameter(request, "s_locl_tax_amt", ""));
		setN2ndLoclTaxRt(JSPUtil.getParameter(request, "n2nd_locl_tax_rt", ""));
		setSN2ndLoclTaxAmt(JSPUtil.getParameter(request, "s_n2nd_locl_tax_amt", ""));
