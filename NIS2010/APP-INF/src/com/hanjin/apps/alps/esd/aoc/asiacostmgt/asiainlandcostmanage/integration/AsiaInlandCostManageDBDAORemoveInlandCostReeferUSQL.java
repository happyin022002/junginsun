...
*@FileName : AsiaInlandCostManageDBDAORemoveInlandCostReeferUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAORemoveInlandCostReeferUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAORemoveInlandCostReeferUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAORemoveInlandCostReeferUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
