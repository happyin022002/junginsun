...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOModifyStorage3rdIFlistUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOModifyStorage3rdIFlistUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOModifyStorage3rdIFlistUSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOModifyStorage3rdIFlistUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
