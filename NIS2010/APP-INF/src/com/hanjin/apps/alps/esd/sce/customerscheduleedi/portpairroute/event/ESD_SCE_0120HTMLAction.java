...
public class ESD_SCE_0120HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce0120Event event = new EsdSce0120Event();
		if (command.isCommand(FormCommand.SEARCH)) {
			...
			event.setPortPairRouteConditionVO((PortPairRouteConditionVO) getVO(request,
					PortPairRouteConditionVO.class));
			event.setPortPairRouteMstVOs((PortPairRouteMstVO[]) getVOs(request, PortPairRouteMstVO.class, ""));
