...
public class SearchPerformanceInquiryListVO {
	
	private static final long serialVersionUID = 1L;
	
	private Collection<SearchPerformanceInquiryListVO> models = new ArrayList<SearchPerformanceInquiryListVO>();
	...
	public SearchPerformanceInquiryListVO() {}

	public SearchPerformanceInquiryListVO(String ibflag, String pagerows, String n3ptyOfcTpCd, String ofcCd, String sOfcCd, String rhqCd, String n3ptyCtrlOfcCd, String n3ptyOfcCd, String n3ptyArOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SearchPerformanceInquiryListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCandidateListVO[]
	 */
	public SearchPerformanceInquiryListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchPerformanceInquiryListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchPerformanceInquiryListVO();
				if (updDt[i] != null)
	 ...
	 * @return SearchCandidateListVO[]
	 */
	public SearchPerformanceInquiryListVO[] getSearchCandidateListVOs(){
		SearchPerformanceInquiryListVO[] vos = (SearchPerformanceInquiryListVO[])models.toArray(new SearchPerformanceInquiryListVO[models.size()]);
		return vos;
	}
