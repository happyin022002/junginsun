...
public class ESD_TRS_0032HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		String[] inv_iss_dt 	= request.getParameterValues("inv_iss_dt");
		...
		event.setPayTerm	(JSPUtil.getParameter(request, "gen_pay_term_view", ""));
		...
		event.setMstInvFileFlg(JSPUtil.getParameter(request, "mst_inv_file_flg", ""));
