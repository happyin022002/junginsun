...
*@FileName : InlandCostManageDBDAOsearchInlnadCostInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOsearchInlnadCostInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOsearchInlnadCostInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOsearchInlnadCostInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${cost_sel_rout_flg} == 'Y')" ).append("\n"); 
