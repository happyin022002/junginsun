...
*@FileName : DODInvoiceMgtDBDAOAddPayerContactPointCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DODInvoiceMgtDBDAOAddPayerContactPointCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddPayerContactPoint
	  * </pre>
	  */
	public DODInvoiceMgtDBDAOAddPayerContactPointCSQL(){
		setQuery();
		...
		query.append("FileName : DODInvoiceMgtDBDAOAddPayerContactPointCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EAS_PAYR_CNTC_PNT (" ).append("\n"); 
