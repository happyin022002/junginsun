...
*@FileName : TerminalAgreementManageDBDAOCreateThoroughputCCRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOCreateThoroughputCCRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Throughput Cost Code Seq Max Value 조회
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOCreateThoroughputCCRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOCreateThoroughputCCRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT	NVL(MAX(thrp_seq),0) + 1 max_num" ).append("\n"); 
