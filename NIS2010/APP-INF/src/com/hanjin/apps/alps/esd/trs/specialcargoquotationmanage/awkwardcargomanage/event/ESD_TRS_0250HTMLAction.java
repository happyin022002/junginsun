...
*@FileName : ESD_TRS_0250HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ESD_TRS_0250HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_0250HTMLAction 객체를 생성
	 */
	public ESD_TRS_0250HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0250Event event = new EsdTrs0250Event();
	

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setTrsAwkCgoTrfMngVO ((TrsAwkCgoTrfMngVO) getVO(request, TrsAwkCgoTrfMngVO .class));
			...
			event.setTrsAwkCgoTrfMngVOs ((TrsAwkCgoTrfMngVO[]) getVOs(request, TrsAwkCgoTrfMngVO .class));
		}
