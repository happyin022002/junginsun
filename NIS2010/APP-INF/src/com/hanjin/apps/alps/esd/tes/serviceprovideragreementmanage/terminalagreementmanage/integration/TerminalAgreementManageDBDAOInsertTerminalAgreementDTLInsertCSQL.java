...
*@FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementDTLInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOInsertTerminalAgreementDTLInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOInsertTerminalAgreementDTLInsertCSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOInsertTerminalAgreementDTLInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
