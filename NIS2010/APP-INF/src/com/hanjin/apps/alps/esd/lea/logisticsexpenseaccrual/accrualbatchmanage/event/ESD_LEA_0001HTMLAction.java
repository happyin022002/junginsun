...
*@FileName : ESD_LEA_0001HTMLAction.java
...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esd.lea.logisticsexpenseaccrual.accrualbatchmanage.event;
...
public class ESD_LEA_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0001HTMLAction 객체를 생성
	 */
	public ESD_LEA_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0001Event event = new EsdLea0001Event();
		
		event.setFrmConfirmDiv(request.getParameter("frm_confirm_div"));
		event.setFrmExeYrmon(request.getParameter("frm_exe_yrmon"));
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchPreConditionVO((SearchAccrualBatchPreConditionVO)getVO(request, SearchAccrualBatchPreConditionVO .class));
		}
