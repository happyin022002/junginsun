...
*@FileName : ESD_EAS_0203HTMLAction.java
...
public class ESD_EAS_0203HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0203HTMLAction 객체를 생성
	 */
	public ESD_EAS_0203HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0203Event event = new EsdEas0203Event();
		

		if(command.isCommand(FormCommand.MULTI01)) {
			event.setEacOfficeConfigVO((EACOfcCfgVO)getVO(request, EACOfcCfgVO.class));
