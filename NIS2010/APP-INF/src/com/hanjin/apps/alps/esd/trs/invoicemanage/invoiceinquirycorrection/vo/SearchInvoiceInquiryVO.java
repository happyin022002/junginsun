...
public class SearchInvoiceInquiryVO extends AbstractValueObject {
	...
	/* Column Info */
	private String ivcUpdUsrId = null;
	/* Column Info */
	...
	public SearchInvoiceInquiryVO(String ibflag, String pagerows, String fCmd, String ipage, String formCreUsrId, String formUsrOfcCd, String invCreOfcCd, String formInvNo, String formInvVndrSeq, String fmdate, String todate, String dateCd, String statusCd, String holdCd, String recievedCd, String amountVerifyCd, String spTp, String comboSvcProvider, String noTp, String noCd, String invCreOfc, String ivcUpdUsrId) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ivc_cre_usr_id", getIvcUpdUsrId());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ivc_upd_usr_id", "ivcUpdUsrId");
	 ...
	 * @return ivcUpdUsrId
	 */
	public String getIvcUpdUsrId() {
		return this.ivcUpdUsrId;
	}
	 ...
	 * @param ivcUpdUsrId
	 */
	public void setIvcUpdUsrId(String ivcUpdUsrId) {
		this.ivcUpdUsrId = ivcUpdUsrId;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIvcUpdUsrId(JSPUtil.getParameter(request, "ivc_upd_usr_id", ""));
	...
	public SearchInvoiceInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ivcUpdUsrId = (JSPUtil.getParameter(request, prefix	+ "ivc_upd_usr_id", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ivcUpdUsrId[i] != null)
					model.setIvcUpdUsrId(ivcUpdUsrId[i]);
				if (ipage[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.ivcUpdUsrId = this.ivcUpdUsrId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
