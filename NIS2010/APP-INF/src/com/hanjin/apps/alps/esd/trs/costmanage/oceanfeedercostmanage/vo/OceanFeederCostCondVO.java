...
*@FileName : OceanFeederCostCondVO.java
*@FileTitle : OceanFeederCostCondVO
*Open Issues :
*Change history :
...
public class OceanFeederCostCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OceanFeederCostCondVO> models = new ArrayList<OceanFeederCostCondVO>();
...
/**
	 ...
	 */
	public OceanFeederCostCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OceanFeederCostCondVO[]
	 */
	public OceanFeederCostCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OceanFeederCostCondVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new OceanFeederCostCondVO();
				if (toNodCd[i] != null)
	 ...
	 * @return OceanFeederCostCondVO[]
	 */
	public OceanFeederCostCondVO[] getOceanFeederCostCondVOs(){
		OceanFeederCostCondVO[] vos = (OceanFeederCostCondVO[])models.toArray(new OceanFeederCostCondVO[models.size()]);
		return vos;
	}
