...
public class PrdSearchEurDrRePatternVO extends AbstractValueObject {
	...
	private String porTmlDiffFlg = null;
	
	private String delTmlDiffFlg = null;
	...
	public PrdSearchEurDrRePatternVO(String ibflag, String pagerows, String copNo, String copPattOrdNo, String newPctlNo, String oldPctlNo, String eurObFlg, String bkgRcvTermCd, String obUnconfirmFlg, String polTmlDiffFlg, String newPor, String newPol, String mtyPkupYdCd, String fullRtnYdCd, String obTrspMod, String eurIbFlg, String bkgDeTermCd, String ibUnconfirmFlg, String podTmlDiffFlg, String newPod, String newDel, String fullPkupYdCd, String mtyRtnYdCd, String ibTrspMod, String obContent, String ibContent, String ocnContent, String cct, String polT, String podT, String tVvd, String orgLocCd, String destLocCd, String ocnSeq, String vvd1, String vvd2, String vvd3, String vvd4, String n1PolClptSeq, String n1PodClptSeq, String n2PolClptSeq, String n2PodClptSeq, String n3PolClptSeq, String n3PodClptSeq, String n4PolClptSeq, String n4PodClptSeq, String porTmlDiffFlg, String delTmlDiffFlg) {
		...
		this.porTmlDiffFlg = porTmlDiffFlg;
		this.delTmlDiffFlg = delTmlDiffFlg;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("por_tml_diff_flg", getPorTmlDiffFlg());
		this.hashColumns.put("del_tml_diff_flg", getDelTmlDiffFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("por_tml_diff_flg", "porTmlDiffFlg");
		this.hashFields.put("del_tml_diff_flg", "delTmlDiffFlg");
	...
	/**
	 * Column Info
	 * @return porTmlDiffFlg
	 */
	public String getPorTmlDiffFlg() {
		return this.porTmlDiffFlg;
	}

	/**
	 * Column Info
	 * @return delTmlDiffFlg
	 */
	public String getDelTmlDiffFlg() {
		return this.delTmlDiffFlg;
	}
	 ...
	 * @param porTmlDiffFlg
	 */
	public void setPorTmlDiffFlg(String porTmlDiffFlg) {
		this.porTmlDiffFlg = porTmlDiffFlg;
	}
	 ...
	 * @param delTmlDiffFlg
	 */
	public void setDelTmlDiffFlg(String delTmlDiffFlg) {
		this.delTmlDiffFlg = delTmlDiffFlg;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPorTmlDiffFlg(JSPUtil.getParameter(request, prefix + "por_tml_diff_flg", ""));
		setDelTmlDiffFlg(JSPUtil.getParameter(request, prefix + "del_tml_diff_flg", ""));
	}
	...
	public PrdSearchEurDrRePatternVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] porTmlDiffFlg = (JSPUtil.getParameter(request, prefix	+ "por_tml_diff_flg", length));
			String[] delTmlDiffFlg = (JSPUtil.getParameter(request, prefix	+ "del_tml_diff_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (porTmlDiffFlg[i] != null)
					model.setPorTmlDiffFlg(porTmlDiffFlg[i]);
				if (delTmlDiffFlg[i] != null)
					model.setDelTmlDiffFlg(delTmlDiffFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.porTmlDiffFlg = this.porTmlDiffFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.delTmlDiffFlg = this.delTmlDiffFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
