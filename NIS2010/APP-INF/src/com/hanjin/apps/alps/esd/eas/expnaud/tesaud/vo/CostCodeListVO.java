...
*@FileName : CostCodeListVO.java
*@FileTitle : CostCodeListVO
*Open Issues :
*Change history :
...
public class CostCodeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CostCodeListVO> models = new ArrayList<CostCodeListVO>();
	...
	public CostCodeListVO() {}

	public CostCodeListVO(String ibflag, String pagerows, String lgsCostCd, String tmlInvTpCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public CostCodeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CostCodeListVO[]
	 */
	public CostCodeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CostCodeListVO model = null;
	 ...
	 * @return CostCodeListVO[]
	 */
	public CostCodeListVO[] getCostCodeListVOs(){
		CostCodeListVO[] vos = (CostCodeListVO[])models.toArray(new CostCodeListVO[models.size()]);
		return vos;
	}
