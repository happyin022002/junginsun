...
*@FileName : RailBillingCancelManageDBDAOMultiCancelRailBillingListRailSo2USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingCancelManageDBDAOMultiCancelRailBillingListRailSo2USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RailBillingCancelManageDBDAOMultiCancelRailBillingListRailSo2USQL(){
		setQuery();
		...
		query.append("FileName : RailBillingCancelManageDBDAOMultiCancelRailBillingListRailSo2USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CXL_RQST_FLG = 'Y'," ).append("\n"); 
