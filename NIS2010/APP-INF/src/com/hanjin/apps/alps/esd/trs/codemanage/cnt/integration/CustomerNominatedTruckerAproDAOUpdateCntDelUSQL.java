...
*@FileName : CustomerNominatedTruckerAproDAOUpdateCntDelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOUpdateCntDelUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete TRS_CUST_NOMI_TRKR
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOUpdateCntDelUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerAproDAOUpdateCntDelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
