...
*@FileName : StatusInquiryDBDAOSearchTPBDetailInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatusInquiryDBDAOSearchTPBDetailInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TPB Inquiry Detail Information
	  * </pre>
	  */
	public StatusInquiryDBDAOSearchTPBDetailInfoRSQL(){
		setQuery();
		...
		query.append("FileName : StatusInquiryDBDAOSearchTPBDetailInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,DECODE( (SELECT COUNT(1) FROM TPB_OTS_GRP_STS WHERE OTS_STS_CD = 'E' AND N3PTY_NO = B.N3PTY_NO AND OTS_STS_SEQ = (SELECT MAX(OTS_STS_SEQ) FROM TPB_OTS_GRP_STS WHERE N3PTY_NO = B.N3PTY_NO))" ).append("\n"); 
		query.append("		, 0, DECODE((SELECT COUNT(1) FROM TPB_OTS_GRP_STS WHERE OTS_STS_CD = 'T' AND N3PTY_NO = B.N3PTY_NO)" ).append("\n"); 
		query.append("		, 0, TRUNC(SYSDATE - B.CFM_DT), TRUNC(SYSDATE - (SELECT MAX(CRE_DT) FROM TPB_OTS_GRP_STS WHERE OTS_STS_CD = 'T' AND N3PTY_NO = B.N3PTY_NO) ))) AS OVERDUE" ).append("\n"); 
		...
		query.append("      ,(SELECT STL_TO_CLT_CNG_OFC_CD FROM TPB_ADJ_STS WHERE N3PTY_NO = B.N3PTY_NO AND STL_STS_LST_FLG = 'Y') AS ROC_IN" ).append("\n"); 
