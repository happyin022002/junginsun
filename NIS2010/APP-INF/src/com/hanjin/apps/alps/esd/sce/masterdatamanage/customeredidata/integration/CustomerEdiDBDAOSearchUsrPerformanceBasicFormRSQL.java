...
*@FileName : CustomerEdiDBDAOSearchUsrPerformanceBasicFormRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDAOSearchUsrPerformanceBasicFormRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchUsrPerformanceBasicForm
	  * </pre>
	  */
	public CustomerEdiDBDAOSearchUsrPerformanceBasicFormRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDAOSearchUsrPerformanceBasicFormRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
