...
*@FileName : ESD_SPE_1013HTMLAction.java
...
public class ESD_SPE_1013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SPE_1013HTMLAction 객체를 생성
	 */
	public ESD_SPE_1013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSpe1013Event event = new EsdSpe1013Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setTmlProdTgtInpVO((TmlProdTgtInpVO)getVO(request, TmlProdTgtInpVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setTmlProdTgtInpVOs((TmlProdTgtInpVO[])getVOs(request, TmlProdTgtInpVO .class));
		}
