...
*@FileName : USARailPerformanceDBDAOSearchALLSORRailPerformanceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchALLSORRailPerformanceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchALLSORRailPerformance SELECT
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchALLSORRailPerformanceRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchALLSORRailPerformanceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
