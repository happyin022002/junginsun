...
*@FileName : OceanRouteManageDBDAOSearchOceanRouteMultiCreationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteManageDBDAOSearchOceanRouteMultiCreationRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOceanRouteMultiCreation
	  * </pre>
	  */
	public OceanRouteManageDBDAOSearchOceanRouteMultiCreationRSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteManageDBDAOSearchOceanRouteMultiCreationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    POL1 ORG_LOC_CD, " ).append("\n"); 
		query.append("    DECODE(LINK_COUNT,1,POD1, 2, POD2, 3, POD3, 4, POD4 ) DEST_LOC_CD,  " ).append("\n"); 
		...
		query.append("    TG.OCN_ROUT_USR_RMK RMK,         " ).append("\n"); 
		query.append("    TOT_TT,    -- TRANSIT TIME" ).append("\n"); 
		...
		query.append("    LTRIM(TO_CHAR(TRUNC((TOT_TT + TOT_ST)/24),'00'))||LTRIM(TO_CHAR(MOD((TOT_TT + TOT_ST),24  ),'00')) TOT_TT_ST ," ).append("\n"); 
		...
		query.append("    0 BKG_CNT, NVL(TG.UPD_IND_CD,'S') UPD_IND_CD,TO_CHAR(TG.CRE_DT , 'YYYY-MM-DD')C_DATE, TG.CRE_USR_ID C_USER " ).append("\n"); 
		query.append("    ,ROUT_SEQ" ).append("\n"); 
		query.append("    , 'Y' LINK_VALID_FLG" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${lnk_cnt} == '1')" ).append("\n"); 
		query.append("-----directSQL-------------------------------------------------------------------------------------------------------" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("    A.VSL_SLAN_CD  LIKE RTRIM(@[lane1])||'%' " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif(${lnk_cnt} == '2')" ).append("\n"); 
		query.append("--ts1---------------------------------------------------------------------------------------------------------------------------------------------------" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        SELECT /*+ ORDERED */ 'B' ST,  " ).append("\n"); 
		query.append("               A.FM_PORT_CD   POL1, " ).append("\n"); 
		query.append("               A.TO_PORT_CD   POD1, " ).append("\n"); 
		query.append("               A.VSL_SLAN_CD  LANE1,  " ).append("\n"); 
		query.append("               A.SKD_DIR_CD   DIR1, " ).append("\n"); 
		...
		query.append("               NULL           FDR_FLG4,  " ).append("\n"); 
		query.append("               NULL           SVC_TP4,  " ).append("\n"); 
		query.append("               2              PRIO,        -- MOTHER - MOTHER  " ).append("\n"); 
		...
		query.append("        AND   A.VSL_SLAN_CD  LIKE RTRIM(@[lane1])||'%'  " ).append("\n"); 
		query.append("        AND   B.VSL_SLAN_CD  LIKE RTRIM(@[lane2])||'%'  " ).append("\n"); 
		query.append("        AND   A.VSL_SLAN_CD  <> B.VSL_SLAN_CD  " ).append("\n"); 
		query.append("        AND   SUBSTR(A.FM_PORT_CD, 1, 2) <> SUBSTR(B.TO_PORT_CD, 1, 2) " ).append("\n"); 
		query.append("        AND   EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                         FROM PRD_SVC_LANE PSL  " ).append("\n"); 
		query.append("                        WHERE A.VSL_SLAN_CD = PSL.VSL_SLAN_CD  " ).append("\n"); 
		query.append("                          AND PSL.UPD_IND_CD <> 'D'  " ).append("\n"); 
		...
		query.append("        SELECT /*+ ORDERED */ 'C' ST,                    " ).append("\n"); 
		...
		query.append("               'T'            TS_IND,   " ).append("\n"); 
		query.append("               'N'            FDR_USD,  " ).append("\n"); 
		query.append("        	   NULL           POD1ETB, " ).append("\n"); 
		query.append("        	   B.FM_PORT_ETB_DY_CD POL2ETB, " ).append("\n"); 
		query.append("        	   B.TO_PORT_ETB_DY_CD POD2ETB, " ).append("\n"); 
		query.append("        	   NULL           POL3ETB,    " ).append("\n"); 
		query.append("        	   NULL           POD3ETB,     " ).append("\n"); 
		...
		query.append("      " ).append("\n"); 
		query.append("        UNION ALL         " ).append("\n"); 
		query.append("        SELECT /*+ ORDERED */ 'D' ST,                     " ).append("\n"); 
		query.append("               A.FM_PORT_CD       POL1,  " ).append("\n"); 
		query.append("               A.TO_PORT_CD       POD1,  " ).append("\n"); 
		query.append("               A.VSL_SLAN_CD      LANE1,  " ).append("\n"); 
		query.append("               A.SKD_DIR_CD       DIR1,  " ).append("\n"); 
		...
		query.append("        AND   B.VSL_SLAN_CD  LIKE RTRIM(@[lane2])||'%' " ).append("\n"); 
		query.append("        AND   A.VSL_SLAN_CD  <> B.VSL_SLAN_CD  " ).append("\n"); 
		query.append("        AND   B.PCTL_IO_BND_CD IN ('I', 'B')  " ).append("\n"); 
		query.append("        AND   SUBSTR(A.FM_PORT_CD, 1, 2) <> SUBSTR(B.LNK_DEST_LOC_CD, 1, 2) " ).append("\n"); 
		query.append("        AND   EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                         FROM PRD_SVC_LANE PSL  " ).append("\n"); 
		query.append("                        WHERE A.VSL_SLAN_CD = PSL.VSL_SLAN_CD  " ).append("\n"); 
		query.append("                          AND PSL.UPD_IND_CD <> 'D'  " ).append("\n"); 
		...
		query.append("                          AND TFS.LNK_DEST_LOC_CD = B.LNK_DEST_LOC_CD )   " ).append("\n"); 
		query.append("        AND A.DELT_FLG <> 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif(${lnk_cnt} == '3')" ).append("\n"); 
		query.append("-----ts2----------------------------------------------------------------------------------------------------" ).append("\n"); 
		query.append("SELECT /*+ ORDERED */ 'E' ST,                    " ).append("\n"); 
		query.append("       A.LNK_ORG_LOC_CD   POL1,     " ).append("\n"); 
		query.append("       A.LNK_DEST_LOC_CD  POD1,     " ).append("\n"); 
		query.append("       A.VSL_SLAN_CD      LANE1,    " ).append("\n"); 
		query.append("       A.SKD_DIR_CD       DIR1,  " ).append("\n"); 
		...
		query.append("       NULL           FDR_FLG4,  " ).append("\n"); 
		query.append("       NULL           SVC_TP4,  " ).append("\n"); 
		query.append("       4              PRIO,       " ).append("\n"); 
		query.append("       NULL           RMK,       " ).append("\n"); 
		query.append("       (A.TZTM_HRS + B.TZTM_HRS + C.TZTM_HRS)     TOT_TT,    " ).append("\n"); 
		query.append("       A.TZTM_HRS     TT1,   " ).append("\n"); 
		query.append("       B.TZTM_HRS     TT2,   " ).append("\n"); 
		...
		query.append("	   B.FM_PORT_ETB_DY_CD POL2ETB," ).append("\n"); 
		query.append("	   B.TO_PORT_ETB_DY_CD POD2ETB," ).append("\n"); 
		query.append("	   C.FM_PORT_ETB_DY_CD POL3ETB," ).append("\n"); 
		query.append("	   C.TO_PORT_ETB_DY_CD POD3ETB," ).append("\n"); 
		query.append("	   NULL           POL4ETB,     " ).append("\n"); 
		query.append("	   3              LINK_COUNT     " ).append("\n"); 
		query.append("FROM PRD_FDR_LNK A, PRD_PF_TZ_TM B, PRD_PF_TZ_TM C  " ).append("\n"); 
		query.append("WHERE A.LNK_DEST_LOC_CD = B.FM_PORT_CD  " ).append("\n"); 
		query.append("AND   B.TO_PORT_CD      = C.FM_PORT_CD  " ).append("\n"); 
		query.append("AND   A.VSL_SLAN_CD  LIKE RTRIM(@[lane1])||'%'  " ).append("\n"); 
		query.append("AND   B.VSL_SLAN_CD  LIKE RTRIM(@[lane2])||'%'  " ).append("\n"); 
		query.append("AND   C.VSL_SLAN_CD  LIKE RTRIM(@[lane3])||'%' " ).append("\n"); 
		query.append("AND   A.VSL_SLAN_CD  <> B.VSL_SLAN_CD " ).append("\n"); 
		query.append("AND   B.VSL_SLAN_CD  <> C.VSL_SLAN_CD " ).append("\n"); 
		query.append("AND   A.PCTL_IO_BND_CD IN ('O', 'B') " ).append("\n"); 
		query.append("AND   SUBSTR(A.LNK_ORG_LOC_CD, 1, 2) <> SUBSTR(B.TO_PORT_CD, 1, 2) " ).append("\n"); 
		query.append("AND   SUBSTR(A.LNK_ORG_LOC_CD, 1, 2) <> SUBSTR(C.TO_PORT_CD, 1, 2) " ).append("\n"); 
		query.append("AND   EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_SVC_LANE PSL  " ).append("\n"); 
		query.append("                WHERE B.VSL_SLAN_CD = PSL.VSL_SLAN_CD  " ).append("\n"); 
		query.append("                  AND PSL.UPD_IND_CD <> 'D'  " ).append("\n"); 
		...
		query.append("                  AND TG.N1ST_LANE_FDR_FLG = 'N'  " ).append("\n"); 
		query.append("                  AND TG.UPD_IND_CD  = 'D')" ).append("\n"); 
		query.append("AND   (A.TZTM_HRS + B.TZTM_HRS + C.TZTM_HRS) < 50 * 24  " ).append("\n"); 
		query.append("AND NOT EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_FDR_LNK TFS  " ).append("\n"); 
		query.append("                WHERE TFS.LNK_ORG_LOC_CD  = A.LNK_ORG_LOC_CD  " ).append("\n"); 
		query.append("                  AND TFS.LNK_DEST_LOC_CD = C.TO_PORT_CD )    " ).append("\n"); 
		query.append("AND NOT EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_FDR_LNK TFS  " ).append("\n"); 
		query.append("                WHERE TFS.LNK_ORG_LOC_CD  = A.LNK_ORG_LOC_CD  " ).append("\n"); 
		query.append("                  AND TFS.LNK_DEST_LOC_CD = B.TO_PORT_CD )   " ).append("\n"); 
		...
		query.append("UNION ALL         " ).append("\n"); 
		query.append("SELECT /*+ ORDERED */ 'F' ST,                " ).append("\n"); 
		query.append("       A.FM_PORT_CD       POL1,  " ).append("\n"); 
		query.append("       A.TO_PORT_CD       POD1,  " ).append("\n"); 
		query.append("       A.VSL_SLAN_CD      LANE1,  " ).append("\n"); 
		query.append("       A.SKD_DIR_CD       DIR1,  " ).append("\n"); 
		...
		query.append("AND   A.VSL_SLAN_CD  <> B.VSL_SLAN_CD   " ).append("\n"); 
		query.append("AND   B.VSL_SLAN_CD  <> C.VSL_SLAN_CD  " ).append("\n"); 
		query.append("AND   C.PCTL_IO_BND_CD IN ('I', 'B')    " ).append("\n"); 
		query.append("AND   SUBSTR(A.FM_PORT_CD, 1, 2) <> SUBSTR(C.LNK_DEST_LOC_CD, 1, 2) " ).append("\n"); 
		query.append("AND   SUBSTR(B.FM_PORT_CD, 1, 2) <> SUBSTR(C.LNK_DEST_LOC_CD, 1, 2)" ).append("\n"); 
		query.append("AND   EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_SVC_LANE PSL  " ).append("\n"); 
		query.append("                WHERE A.VSL_SLAN_CD = PSL.VSL_SLAN_CD  " ).append("\n"); 
		query.append("                  AND PSL.UPD_IND_CD <> 'D'  " ).append("\n"); 
		...
		query.append("                 FROM PRD_FDR_LNK TFS  " ).append("\n"); 
		query.append("                WHERE TFS.LNK_ORG_LOC_CD  = A.FM_PORT_CD  " ).append("\n"); 
		query.append("                  AND TFS.LNK_DEST_LOC_CD = C.LNK_DEST_LOC_CD )     " ).append("\n"); 
		query.append("AND NOT EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_FDR_LNK TFS  " ).append("\n"); 
		...
		query.append("AND B.DELT_FLG <> 'Y'" ).append("\n"); 
		query.append("UNION ALL  " ).append("\n"); 
		query.append("SELECT /*+ ORDERED */ 'G' ST,                     " ).append("\n"); 
		query.append("       A.LNK_ORG_LOC_CD   POL1,     " ).append("\n"); 
		query.append("       A.LNK_DEST_LOC_CD  POD1,     " ).append("\n"); 
		query.append("       A.VSL_SLAN_CD      LANE1,    " ).append("\n"); 
		query.append("       A.SKD_DIR_CD       DIR1,  " ).append("\n"); 
		...
		query.append("AND B.DELT_FLG <> 'Y'" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("-- HQ-HQ-HQ" ).append("\n"); 
		query.append("SELECT /*+ ORDERED */ 'I' ST,                     -- ST (CASE)" ).append("\n"); 
		query.append("       A.FM_PORT_CD       POL1," ).append("\n"); 
		query.append("       A.TO_PORT_CD       POD1," ).append("\n"); 
		query.append("       A.VSL_SLAN_CD      LANE1," ).append("\n"); 
		query.append("       A.SKD_DIR_CD       DIR1," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#elseif(${lnk_cnt} == '4')" ).append("\n"); 
		query.append("--ts3--------------------------------------------------------------------------------------------------------------------------" ).append("\n"); 
		query.append("SELECT /*+ ORDERED */ 'H' ST,                     " ).append("\n"); 
		query.append("       A.LNK_ORG_LOC_CD   POL1,     " ).append("\n"); 
		query.append("       A.LNK_DEST_LOC_CD  POD1,     " ).append("\n"); 
		query.append("       A.VSL_SLAN_CD      LANE1,    " ).append("\n"); 
		query.append("       A.SKD_DIR_CD       DIR1,  " ).append("\n"); 
		...
		query.append("       6              PRIO,      " ).append("\n"); 
		query.append("       NULL           RMK,        " ).append("\n"); 
		query.append("       (A.TZTM_HRS + B.TZTM_HRS + C.TZTM_HRS + D.TZTM_HRS)     TOT_TT,   " ).append("\n"); 
		query.append("       A.TZTM_HRS     TT1,   " ).append("\n"); 
		query.append("       B.TZTM_HRS     TT2,   " ).append("\n"); 
		query.append("       C.TZTM_HRS     TT3,   " ).append("\n"); 
		...
		query.append("	   C.TO_PORT_ETB_DY_CD POD3ETB," ).append("\n"); 
		query.append("	   NULL           POL4ETB,   " ).append("\n"); 
		query.append("	   4              LINK_COUNT      " ).append("\n"); 
		...
		query.append("AND   B.VSL_SLAN_CD  LIKE RTRIM(@[lane2])||'%'  " ).append("\n"); 
		query.append("AND   C.VSL_SLAN_CD  LIKE RTRIM(@[lane3])||'%'  " ).append("\n"); 
		query.append("AND   D.VSL_SLAN_CD  LIKE RTRIM(@[lane4])||'%' " ).append("\n"); 
		query.append("AND   A.VSL_SLAN_CD  <> B.VSL_SLAN_CD   " ).append("\n"); 
		query.append("AND   B.VSL_SLAN_CD  <> C.VSL_SLAN_CD  " ).append("\n"); 
		query.append("AND   C.VSL_SLAN_CD  <> D.VSL_SLAN_CD  " ).append("\n"); 
		query.append("AND   A.PCTL_IO_BND_CD IN ('O', 'B')    " ).append("\n"); 
		query.append("AND   D.PCTL_IO_BND_CD IN ('I', 'B')    " ).append("\n"); 
		query.append("AND   SUBSTR(A.LNK_ORG_LOC_CD, 1, 2) <> SUBSTR(B.TO_PORT_CD, 1, 2)" ).append("\n"); 
		query.append("AND   SUBSTR(A.LNK_ORG_LOC_CD, 1, 2) <> SUBSTR(C.TO_PORT_CD, 1, 2) " ).append("\n"); 
		query.append("AND   SUBSTR(B.FM_PORT_CD, 1, 2)     <> SUBSTR(D.LNK_DEST_LOC_CD, 1, 2)" ).append("\n"); 
		query.append("AND   SUBSTR(C.FM_PORT_CD, 1, 2)     <> SUBSTR(D.LNK_DEST_LOC_CD, 1, 2)" ).append("\n"); 
		query.append("AND   EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_SVC_LANE PSL  " ).append("\n"); 
		query.append("                WHERE B.VSL_SLAN_CD = PSL.VSL_SLAN_CD  " ).append("\n"); 
		query.append("                  AND PSL.UPD_IND_CD <> 'D'  " ).append("\n"); 
		...
		query.append("                  AND TG.N1ST_LANE_FDR_FLG = 'N'  " ).append("\n"); 
		query.append("                  AND TG.UPD_IND_CD  = 'D') " ).append("\n"); 
		query.append("AND   (A.TZTM_HRS + B.TZTM_HRS + C.TZTM_HRS + D.TZTM_HRS) < 50 * 24   " ).append("\n"); 
		query.append("AND NOT EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_FDR_LNK TFS  " ).append("\n"); 
		query.append("                WHERE TFS.LNK_ORG_LOC_CD  = A.LNK_ORG_LOC_CD  " ).append("\n"); 
		query.append("                  AND TFS.LNK_DEST_LOC_CD = D.LNK_DEST_LOC_CD )     " ).append("\n"); 
		query.append("AND NOT EXISTS ( SELECT 'X'  " ).append("\n"); 
		query.append("                 FROM PRD_FDR_LNK TFS  " ).append("\n"); 
		query.append("                WHERE TFS.LNK_ORG_LOC_CD  = A.LNK_ORG_LOC_CD  " ).append("\n"); 
		query.append("                  AND TFS.LNK_DEST_LOC_CD = B.TO_PORT_CD )   " ).append("\n"); 
		...
		query.append("WHERE " ).append("\n"); 
		query.append("--POL1 = P1(+) " ).append("\n"); 
		query.append("--AND   LANE1 = L1(+) " ).append("\n"); 
		query.append("--AND   POD1 = P2(+) " ).append("\n"); 
		query.append("  TG.UPD_IND_CD(+) NOT IN ('D', 'N', 'O') " ).append("\n"); 
		query.append("--AND   NVL(LANE2, 'N/A') =  NVL(L2(+),'N') " ).append("\n"); 
		query.append("--AND   NVL(POD2,  'N/A') =  NVL(P3(+),'N') " ).append("\n"); 
		query.append("--AND   NVL(LANE3, 'N/A') =  NVL(L3(+),'N') " ).append("\n"); 
		query.append("--AND   NVL(POD3,  'N/A') =  NVL(P4(+),'N') " ).append("\n"); 
		query.append("--AND   NVL(LANE4, 'N/A') =  NVL(L4(+),'N') " ).append("\n"); 
		query.append("--AND   NVL(POD4,  'USLGB')  =  NVL(P5(+),'N') " ).append("\n"); 
		...
		query.append("         DECODE(TG.ORG_LOC_CD, NULL, 'N', 'Y'),TG.UPD_IND_CD,TG.CRE_DT, TG.CRE_USR_ID,tg.ocn_rout_USR_rmk,tg.ROUT_SEQ  " ).append("\n"); 
