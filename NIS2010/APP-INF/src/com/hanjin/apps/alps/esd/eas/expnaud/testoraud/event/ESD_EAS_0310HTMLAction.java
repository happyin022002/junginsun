...
*@FileName : ESD_EAS_0310HTMLAction.java
...
public class ESD_EAS_0310HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0310HTMLAction 객체를 생성
	 */
	public ESD_EAS_0310HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0310Event event = new EsdEas0310Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setRehandlingExpenseTorVsTpbVO((RehandlingExpenseTorVsTpbVO)getVO(request, RehandlingExpenseTorVsTpbVO .class));
		}
