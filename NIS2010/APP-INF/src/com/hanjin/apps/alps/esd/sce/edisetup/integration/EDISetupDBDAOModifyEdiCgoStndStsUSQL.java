...
*@FileName : EDISetupDBDAOModifyEdiCgoStndStsUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EDISetupDBDAOModifyEdiCgoStndStsUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EDISetupDBDAOModifyEdiCgoStndStsUSQL(){
		setQuery();
		...
		query.append("FileName : EDISetupDBDAOModifyEdiCgoStndStsUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("update edi_cgo_stnd_sts set" ).append("\n"); 
		query.append("EDI_STS_SEQ =         @[status_seq]" ).append("\n"); 
		query.append(",EDI_STS_DESC =        @[status_desc]" ).append("\n"); 
		query.append(",EDI_ORG_TP_CD =       @[origin_cd]" ).append("\n"); 
		query.append(",EDI_DEST_TP_CD =      @[dest_cd]" ).append("\n"); 
		query.append(",EAI_EVNT_DT = to_date(@[eai_date],'yyyy/mm/dd hh24:mi:ss')" ).append("\n"); 
		query.append("where" ).append("\n"); 
		query.append("EDI_STND_STS_CD =      @[status_std_cd]" ).append("\n"); 
