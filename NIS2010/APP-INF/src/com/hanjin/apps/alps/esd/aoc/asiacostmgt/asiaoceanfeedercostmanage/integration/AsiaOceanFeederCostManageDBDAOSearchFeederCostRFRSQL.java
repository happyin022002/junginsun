...
*@FileName : AsiaOceanFeederCostManageDBDAOSearchFeederCostRFRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOSearchFeederCostRFRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOSearchFeederCostRFRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOSearchFeederCostRFRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , AOC_CHN_FDR_RF_TRF_DTL D" ).append("\n"); 
