...
*@FileName : EsdEas0377ViewAdapter.java
...
public class EsdEas0377ViewAdapter extends EasDefaultViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix, Event event)
	{
        ...
        if( formcommand.isCommand(FormCommand.SEARCHLIST01) ){
            ...
            for(int i = 0; i < realCnt; i++)
            {
                ...
                String sExceedAvgRto = getNull(colValues.get("expn_max_prmt_rto")).toString();
                sbufXML.append("\t<TR>");
                ...
                for(int j = 0; j < colCnt; j++) {
                	...
                	if (colName.equals("estm_amt")) {
                		sbufXML.append((new StringBuilder())
                				.append("<TD")
                				.append(sExceedAvgFlg.equals("Y")?" COLOR='255, 0, 0'" : sExceedAvgRto.equals("")?" COLOR='0, 255, 0'" : " COLOR='0, 0, 0'")
                				.append(">")
