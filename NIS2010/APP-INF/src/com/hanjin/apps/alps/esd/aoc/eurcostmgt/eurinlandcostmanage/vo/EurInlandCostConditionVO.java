...
*@FileName : EurInlandCostConditionVO.java
*@FileTitle : EurInlandCostConditionVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurInlandCostConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurInlandCostConditionVO> models = new ArrayList<EurInlandCostConditionVO>();
	...
	public EurInlandCostConditionVO() {}
...
/**
	 ...
	 */
	public EurInlandCostConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurInlandCostConditionVO[]
	 */
	public EurInlandCostConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurInlandCostConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EurInlandCostConditionVO();
				if (fromDt[i] != null)
	...
	public EurInlandCostConditionVO[] getInlandCostConditionVOs(){
		EurInlandCostConditionVO[] vos = (EurInlandCostConditionVO[])models.toArray(new EurInlandCostConditionVO[models.size()]);
		return vos;
	}
