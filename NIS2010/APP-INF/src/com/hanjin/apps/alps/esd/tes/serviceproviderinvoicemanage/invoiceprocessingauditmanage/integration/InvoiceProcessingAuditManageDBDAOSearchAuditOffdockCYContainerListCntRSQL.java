...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InvoiceProcessingAuditManageDBDAO
	  * SearchAuditOffdockCYContainerListCnt
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListCntRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYContainerListCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
