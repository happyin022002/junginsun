...
public class ESD_TRS_0023HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
       ...
       */ 
		...
		String radio_contract	= request.getParameter("radio_contract");
		String sc_rfa_cd	= request.getParameter("sc_rfa_cd");
		String vgm_flg	= request.getParameter("vgm_flg");
		...
		event.setRadioContract(radio_contract);
		event.setScRfaCd(sc_rfa_cd);
		event.setVgmFlg(vgm_flg);
