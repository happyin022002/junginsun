...
*@FileName : EurFeederReeferCostVO.java
*@FileTitle : EurFeederReeferCostVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurFeederReeferCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurFeederReeferCostVO> models = new ArrayList<EurFeederReeferCostVO>();
...
/**
	 ...
	 */
	public EurFeederReeferCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurFeederReeferCostVO[]
	 */
	public EurFeederReeferCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurFeederReeferCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EurFeederReeferCostVO();
				if (toNodCd[i] != null)
	 ...
	 * @return EurFeederReeferCostVO[]
	 */
	public EurFeederReeferCostVO[] getSearchFeederReeferCostVOs(){
		EurFeederReeferCostVO[] vos = (EurFeederReeferCostVO[])models.toArray(new EurFeederReeferCostVO[models.size()]);
		return vos;
	}
