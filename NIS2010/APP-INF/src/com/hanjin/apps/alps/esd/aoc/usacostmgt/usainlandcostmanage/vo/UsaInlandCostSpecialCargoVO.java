...
*@FileName : UsaInlandCostSpecialCargoVO.java
*@FileTitle : UsaInlandCostSpecialCargoVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class UsaInlandCostSpecialCargoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaInlandCostSpecialCargoVO> models = new ArrayList<UsaInlandCostSpecialCargoVO>();
...
/**
	 ...
	 */
	public UsaInlandCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaInlandCostSpecialCargoVO[]
	 */
	public UsaInlandCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaInlandCostSpecialCargoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaInlandCostSpecialCargoVO();
	...
	public UsaInlandCostSpecialCargoVO[] getInlandCostSpecialCargoVOs(){
		UsaInlandCostSpecialCargoVO[] vos = (UsaInlandCostSpecialCargoVO[])models.toArray(new UsaInlandCostSpecialCargoVO[models.size()]);
		return vos;
	}
