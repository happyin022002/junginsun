...
*@FileName : WorkOrderPreviewDBDAOSearchEdi102297ShCancleRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOSearchEdi102297ShCancleRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchEdi102297ShCancle
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOSearchEdi102297ShCancleRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOSearchEdi102297ShCancleRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	  AND wo.wo_prv_grp_seq = @[wo_prv_grp_seq]" ).append("\n"); 
		query.append("	  AND wo.wo_iss_no = @[wo_iss_no]" ).append("\n"); 
		query.append("	  AND wo.trsp_so_ofc_cty_cd = so.trsp_so_ofc_cty_cd" ).append("\n"); 
		query.append("	  AND wo.trsp_so_seq = so.trsp_so_seq" ).append("\n"); 
