...
*@FileName : TesAdvanceAuditDBDAOTesOffdockCYDetailCostByDayRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesAdvanceAuditDBDAOTesOffdockCYDetailCostByDayRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TesOffdockCYDetailCostByDay
	  * </pre>
	  */
	public TesAdvanceAuditDBDAOTesOffdockCYDetailCostByDayRSQL(){
		setQuery();
		...
		query.append("FileName : TesAdvanceAuditDBDAOTesOffdockCYDetailCostByDayRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
