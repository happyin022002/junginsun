...
*@FileName : ESD_SCE_0164HTMLAction.java
 ...
 *
 * @author eunju son
 * @see EsdSce0164Event 참조
 * @since J2EE 1.6
 */
public class ESD_SCE_0164HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * ESD_SCE_0164HTMLAction 객체를 생성
	 */
	public ESD_SCE_0164HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce0164Event event = new EsdSce0164Event();
