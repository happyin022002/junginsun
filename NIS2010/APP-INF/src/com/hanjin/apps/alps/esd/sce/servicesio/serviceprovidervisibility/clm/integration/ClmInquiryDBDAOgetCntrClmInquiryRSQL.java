...
*@FileName : ClmInquiryDBDAOgetCntrClmInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esd.sce.servicesio.serviceprovidervisibility.clm.integration ;
...
public class ClmInquiryDBDAOgetCntrClmInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ClmInquiryDBDAOgetCntrClmInquiryRSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.sce.servicesio.serviceprovidervisibility.clm.integration ").append("\n"); 
		query.append("FileName : ClmInquiryDBDAOgetCntrClmInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("max(sc.full_mty_cd) full_mty," ).append("\n"); 
		query.append("MAX(ttr.eq_tpsz_cd) cntr_tpsz_cd," ).append("\n"); 
		query.append("MAX(scs.clm_sght_abbr_nm) event_nm," ).append("\n"); 
		...
		query.append("END ) crrnt_loc," ).append("\n"); 
		query.append("MAX(sc.arr_ste_cd) crrnt_state," ).append("\n"); 
