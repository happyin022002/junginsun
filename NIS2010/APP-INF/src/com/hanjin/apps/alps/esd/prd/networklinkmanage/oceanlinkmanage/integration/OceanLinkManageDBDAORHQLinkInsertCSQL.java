...
public class OceanLinkManageDBDAORHQLinkInsertCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SUN_ST_FLG, MON_ST_FLG, TUE_ST_FLG, WED_ST_FLG, THU_ST_FLG, FRI_ST_FLG, SAT_ST_FLG)" ).append("\n"); 
		query.append("VALUES ( @[s_lane] , @[s_from] , @[s_to] ," ).append("\n"); 
		...
		query.append("@[upd_usr_id],sysdate ,  DECODE(@[s_dr],'1','Y','N') , DECODE(@[s_sn],'1','Y','N') , DECODE(@[s_mn],'1','Y','N') , DECODE(@[s_te],'1','Y','N') , DECODE(@[s_wb],'1','Y','N') , DECODE(@[s_tu],'1','Y','N') , DECODE(@[s_fi],'1','Y','N') , DECODE(@[s_st],'1','Y','N')  )" ).append("\n"); 
