...
*@FileName : AsiaFeederCostVO.java
*@FileTitle : AsiaFeederCostVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaFeederCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaFeederCostVO> models = new ArrayList<AsiaFeederCostVO>();
...
/**
	 ...
	 */
	public AsiaFeederCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaFeederCostVO[]
	 */
	public AsiaFeederCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaFeederCostVO model = null;
	 ...
	 * @return AsiaFeederCostVO[]
	 */
	public AsiaFeederCostVO[] getFeederCostVOs(){
		AsiaFeederCostVO[] vos = (AsiaFeederCostVO[])models.toArray(new AsiaFeederCostVO[models.size()]);
		return vos;
	}
