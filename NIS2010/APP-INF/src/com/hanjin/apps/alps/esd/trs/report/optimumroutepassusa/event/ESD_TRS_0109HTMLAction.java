...
*@FileName : ESD_TRS_0109HTMLAction.java
 ...
 * @author 조인영
 * @see EsdTrs0109Event 참조
 * @since J2EE 1.6
 */
public class ESD_TRS_0109HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_0171HTMLAction 객체를 생성
	 */
	public ESD_TRS_0109HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs0109Event event = new EsdTrs0109Event();
