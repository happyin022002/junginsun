...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOInsertStorageInvoiceDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOInsertStorageInvoiceDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOInsertStorageInvoiceDetailCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOInsertStorageInvoiceDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
