...
*@FileName : EurInlandCostManageDBDAOSearchInlandCostDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlandCostDetailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlandCostDetailRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlandCostDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , INLND_45FT_TTL_AMT -- 45' Cost 추가" ).append("\n"); 
		query.append("      , SCC_CD" ).append("\n"); 
		query.append("      , NVL(MB_20FT_RTO,0)||'%' MB_20FT_RTO" ).append("\n"); 
		query.append("      , NVL(MB_40FT_RTO,0)||'%' MB_40FT_RTO" ).append("\n"); 
		query.append("      , NVL(MB_45FT_RTO,0)||'%' MB_45FT_RTO -- 45' Cost 추가" ).append("\n"); 
		...
		query.append("      , COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03050', TRSP_45FT_COST_SYS_SRC_CD) TRSP_45FT_COST_SYS_SRC_NM" ).append("\n"); 
		...
		query.append("      -- 45' Cost 추가 start" ).append("\n"); 
		query.append("      , COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03050', TML_45FT_COST_SYS_SRC_CD) TML_45FT_COST_SYS_SRC_NM" ).append("\n"); 
		...
		query.append("                GREATEST(NVL(N1ST_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(N1ST_VNDR_40FT_AGMT_OLD_FLG,0), NVL(N1ST_VNDR_45FT_AGMT_OLD_FLG,0), NVL(N2ND_VNDR_20FT_AGMT_OLD_FLG,0), NVL(N2ND_VNDR_40FT_AGMT_OLD_FLG,0), NVL(N2ND_VNDR_45FT_AGMT_OLD_FLG,0)),'0',NULL," ).append("\n"); 
		query.append("                GREATEST(NVL(N1ST_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(N1ST_VNDR_40FT_AGMT_OLD_FLG,0), NVL(N1ST_VNDR_45FT_AGMT_OLD_FLG,0), NVL(N2ND_VNDR_20FT_AGMT_OLD_FLG,0), NVL(N2ND_VNDR_40FT_AGMT_OLD_FLG,0), NVL(N2ND_VNDR_45FT_AGMT_OLD_FLG,0))" ).append("\n"); 
		...
		query.append("-- 45' Cost 추가" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'TT45')" ).append("\n"); 
		query.append("                                                            INLND_45FT_TTL_AMT " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("-- 45' Cost 추가" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'FT45')" ).append("\n"); 
		query.append("                                                            DECODE(TRSP_45FT_COST_SYS_SRC_CD, 'A', 'A', 'X') ASC, TRSP_45FT_COST_AMT " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("-- 45' Cost 추가" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'MT45')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("-- 45' Cost 추가" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'TM45')" ).append("\n"); 
		query.append("                                                            DECODE(TML_45FT_COST_SYS_SRC_CD, 'A', 'A', 'X') ASC, TML_45FT_COST_AMT " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("          FROM    AOC_EUR_INLND_RF_TRF_DTL" ).append("\n"); 
		...
		query.append("-- 45' Cost 추가" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'FT45')" ).append("\n"); 
		query.append("      , DECODE(TRSP_45FT_COST_SYS_SRC_CD, 'A', 'A', 'X') ASC" ).append("\n"); 
		query.append("      , TRSP_45FT_COST_AMT " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'FT4')" ).append("\n"); 
		...
		query.append("-- 45' Cost 추가" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'TM45')" ).append("\n"); 
		query.append("      , DECODE(TML_45FT_COST_SYS_SRC_CD, 'A', 'A', 'X') ASC" ).append("\n"); 
		query.append("      , TML_45FT_COST_AMT " ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${in_sort_by} == 'TM4')" ).append("\n"); 
