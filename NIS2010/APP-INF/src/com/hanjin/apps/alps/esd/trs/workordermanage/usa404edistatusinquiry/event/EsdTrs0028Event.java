...
public class EsdTrs0028Event extends EventSupport {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("f_trsp_so_ofc_cty_cd", this.getFTrspSoOfcCtyCd());// Use In Confirmation MSG Send SEARCH02
		this.hashColumns.put("f_trsp_so_seq", this.getFTrspSoSeq());// Use In Confirmation MSG Send SEARCH02
