...
*@FileName : PortPairExceptionDBDAOSearchTpIdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortPairExceptionDBDAOSearchTpIdRSQL implements ISQLTemplate{
