...
*@FileName : CreditIncentiveStatusDBDAOMultiTesIncentiveHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOMultiTesIncentiveHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TES Incentive History Save
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOMultiTesIncentiveHisCSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOMultiTesIncentiveHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EAS_TML_INCNT_HIS (" ).append("\n"); 
		...
		query.append("          FROM EAS_TML_INCNT_HIS" ).append("\n"); 
