...
*@FileName : SPServiceCategoryDBDAORemoveSpSvcCateCfmHisCSQL.java
...
public class SPServiceCategoryDBDAORemoveSpSvcCateCfmHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 히스토리 테이블에 등록된 업체의 정보의 플레그를 삭제로 저장한다.
	  * </pre>
	  */
	public SPServiceCategoryDBDAORemoveSpSvcCateCfmHisCSQL(){
		setQuery();
		...
		query.append("FileName : SPServiceCategoryDBDAORemoveSpSvcCateCfmHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
