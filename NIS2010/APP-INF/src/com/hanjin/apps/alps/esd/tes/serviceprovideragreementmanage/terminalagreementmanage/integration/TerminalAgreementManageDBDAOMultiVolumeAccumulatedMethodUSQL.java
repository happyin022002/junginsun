...
*@FileName : TerminalAgreementManageDBDAOMultiVolumeAccumulatedMethodUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOMultiVolumeAccumulatedMethodUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOMultiVolumeAccumulatedMethodUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOMultiVolumeAccumulatedMethodUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE	TES_TML_SO_ACCM_MZD SET" ).append("\n"); 
		query.append("ctrt_ofc_cd	= @[ctrt_ofc_cd]" ).append("\n"); 
		query.append(", accm_fm_dt	= @[accm_fm_dt]" ).append("\n"); 
		query.append(", accm_to_dt	= @[accm_to_dt]" ).append("\n"); 
