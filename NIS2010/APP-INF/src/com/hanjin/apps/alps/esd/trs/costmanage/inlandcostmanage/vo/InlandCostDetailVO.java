...
*@FileName : InlandCostDetailVO.java
*@FileTitle : InlandCostDetailVO
*Open Issues :
*Change history :
...
public class InlandCostDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InlandCostDetailVO> models = new ArrayList<InlandCostDetailVO>();
...
/**
	 ...
	 */
	public InlandCostDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InlandCostDetailVO[]
	 */
	public InlandCostDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InlandCostDetailVO model = null;
	...
	public InlandCostDetailVO[] getInlandCostDetailVOs(){
		InlandCostDetailVO[] vos = (InlandCostDetailVO[])models.toArray(new InlandCostDetailVO[models.size()]);
		return vos;
	}
