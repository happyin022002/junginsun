...
*@FileName : PortPairExceptionDBDAOModifyMultiBlockLaneUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortPairExceptionDBDAOModifyMultiBlockLaneUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortPairExceptionDBDAOModifyMultiBlockLaneUSQL(){
		setQuery();
		...
		query.append("FileName : PortPairExceptionDBDAOModifyMultiBlockLaneUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET SLAN_CD  = @[slan_cd]," ).append("\n"); 
