...
*@FileName : EDS_EAS_0375HTMLAction.java
*@FileTitle : MR Storage Audit Detail
*Open Issues :
*Change history :
...
/**
 * EDS_EAS_0375HTMLAction PDTO(Data Transfer Object including Parameters)<br>
 * @author Jong-Ock Kim
 * @see EventSupport 참조
 * @since J2EE 1.4
 */
public class ESD_EAS_0375HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 6292978124068251371L;

	/**
     * EDS_EAS_0375HTMLAction 객체를 생성
     */
    public ESD_EAS_0375HTMLAction() {
    }

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 EsdEas0375Event로 파싱하여 request에 셋팅<br>
	 *
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsdEas0375Event event = new EsdEas0375Event();
