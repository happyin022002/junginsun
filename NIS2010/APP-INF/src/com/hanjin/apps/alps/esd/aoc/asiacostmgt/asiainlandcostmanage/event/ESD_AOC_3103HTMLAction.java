...
*@FileName : ESD_AOC_3103HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3103HTMLAction 객체를 생성
	 */
	public ESD_AOC_3103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3103Event event = new EsdAoc3103Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInlandCostConditionVO((AsiaInlandCostConditionVO)getVO(request, AsiaInlandCostConditionVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setInlandCostConditionVO((AsiaInlandCostConditionVO)getVO(request, AsiaInlandCostConditionVO .class));
			event.setInlandCostDetailVOS((AsiaInlandCostDetailVO[])getVOs(request, AsiaInlandCostDetailVO .class,""));
