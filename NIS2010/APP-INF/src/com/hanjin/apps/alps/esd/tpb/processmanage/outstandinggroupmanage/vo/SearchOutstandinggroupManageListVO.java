...
public class SearchOutstandinggroupManageListVO {
	
	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOutstandinggroupManageListVO> models = new ArrayList<SearchOutstandinggroupManageListVO>();
	...
	public SearchOutstandinggroupManageListVO() {}

	public SearchOutstandinggroupManageListVO(String ibflag, String pagerows, String n3ptyOfcTpCd, String ofcCd, String sOfcCd, String rhqCd, String n3ptyCtrlOfcCd, String n3ptyOfcCd, String n3ptyArOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return SearchOutstandinggroupListVO[]
	 */
	public SearchOutstandinggroupManageListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOutstandinggroupListVO[]
	 */
	public SearchOutstandinggroupManageListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOutstandinggroupManageListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOutstandinggroupManageListVO();
				if (updDt[i] != null)
		...
		return getSearchOutstandinggroupListVOs();
	}
	 ...
	 * @return SearchOutstandinggroupListVO[]
	 */
	public SearchOutstandinggroupManageListVO[] getSearchOutstandinggroupListVOs(){
		SearchOutstandinggroupManageListVO[] vos = (SearchOutstandinggroupManageListVO[])models.toArray(new SearchOutstandinggroupManageListVO[models.size()]);
		return vos;
	}
