...
*@FileName : ESD_AOC_3311HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3311HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3311HTMLAction 객체를 생성
	 */
	public ESD_AOC_3311HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3311Event event = new EsdAoc3311Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setSearchStatusMonitorVO((UsaStatusMonitorVO)getVO(request, UsaStatusMonitorVO .class));
