...
* 2009-09-28 Jong-Geon Byeon	1.2 ALPS Migration
* -------------------------------------------------------
* History
...
/**
 * ALPS RecoveryActivityManageDBDAO <br>
 * - ALPS-RecoveryActivityManage system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author GUN-HA HWANG
