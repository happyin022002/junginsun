...
*@FileName : ESD_TES_9310HTMLAction.java
 ...
 *
 * @author KimYongJin
 * @see ESD_TES_9310HTMLAction 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9310HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_9310HTMLAction 객체를 생성
	 */
	public ESD_TES_9310HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_9310HTMLAction 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		log.debug("\n\n  ESD_TES_9310HTMLAction  \n\n");

		EsdTes9310Event		event	= new EsdTes9310Event();
