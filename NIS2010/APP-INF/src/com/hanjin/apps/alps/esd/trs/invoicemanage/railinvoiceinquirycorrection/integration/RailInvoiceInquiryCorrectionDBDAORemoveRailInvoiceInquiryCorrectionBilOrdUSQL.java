...
*@FileName : RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionBilOrdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionBilOrdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionBilOrdUSQL(){
		setQuery();
		...
		query.append("FileName : RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionBilOrdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET    FINC_VSL_CD     = null," ).append("\n"); 
		query.append("FINC_SKD_VOY_NO = null," ).append("\n"); 
		query.append("FINC_SKD_DIR_CD = null," ).append("\n"); 
