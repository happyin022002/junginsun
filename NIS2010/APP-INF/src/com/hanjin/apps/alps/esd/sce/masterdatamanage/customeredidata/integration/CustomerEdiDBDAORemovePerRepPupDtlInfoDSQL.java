...
*@FileName : CustomerEdiDBDAORemovePerRepPupDtlInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDAORemovePerRepPupDtlInfoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemovePerRepPupDtlInfo
	  * </pre>
	  */
	public CustomerEdiDBDAORemovePerRepPupDtlInfoDSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDAORemovePerRepPupDtlInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE SCE_PERF_RPT_FOM" ).append("\n"); 
