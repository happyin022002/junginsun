...
*@FileName      : EsdTrs0102ViewAdapter.java
*@FileTitle     : EsdTrs0102ViewAdapter IBSheet Generation Class
*Open Issues    :
*Change history :
...
public class EsdTrs0102ViewAdapter extends TrsDefaultViewAdapter {
...
//			String changedColNms[] = getChangedColNms(realColNms, prefix);
			...
			sb.append((new StringBuilder("<DATA ")).append(">\n").toString());
                int i =1;
                ...
                if( rs != null ){
                    ...
                    while(rs.next()){
                    	...
                    	sb.append("<TR><TD>R</TD>");
                    	
                        for(int j = 0; j < rs.getMetaData().getColumnCount(); j++){
                        	
                        		if( j == 0 || j == 1 || j ==2 || j == 4 || j == 5 || j == 6
                        				|| j == 7 || j == 8 || j == 9 ){
                        			sb.append("<TD>" + getNull(rs.getObject(i++)) + "</TD>");                        			
                        		}else{
