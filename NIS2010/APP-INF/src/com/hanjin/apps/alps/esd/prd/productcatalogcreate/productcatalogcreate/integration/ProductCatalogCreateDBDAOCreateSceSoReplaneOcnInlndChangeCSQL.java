...
public class ProductCatalogCreateDBDAOCreateSceSoReplaneOcnInlndChangeCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    NVL(@[prm_cust_flg], 'N')" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		...
		query.append("@[cre_usr_id] CRE_USR_ID, sysdate CRE_DT , @[cre_usr_id] UPD_USR_ID, sysdate UPD_DT," ).append("\n"); 
		...
		query.append("		 -- S/O없을때 (bkg Y, temp N) S/O있으면 우선 적용, 이외는 TD" ).append("\n"); 
		...
		query.append("                        RANK() OVER (PARTITION BY ORG_LOC_CD,DEST_LOC_CD,OCN_SEQ,OB_DEST ORDER BY FULL_RTN_PRIO_SEQ,OB_OPTM_FLG,OB_BKG_FLG,OB_MODE_PRIO_SEQ,OB_TMP_FLG,OB_PRIO_SEQ,OB_ROUT_SEQ) OB_RK," ).append("\n"); 
		...
		query.append("--                                          ELSE" ).append("\n"); 
		query.append("--                                           TRIM(DECODE(INSTR(SKD_STR,'VVD1'),0,NULL,SUBSTR(SKD_STR,INSTR(SKD_STR,'VVD1')+4,9)))" ).append("\n"); 
		...
		query.append("--                                          ELSE" ).append("\n"); 
		query.append("--                                    		TRIM(DECODE(INSTR(SKD_STR,'VVD2'),0,NULL,SUBSTR(SKD_STR,INSTR(SKD_STR,'VVD2')+4,9)))" ).append("\n"); 
		...
		query.append("--                                          ELSE" ).append("\n"); 
		query.append("--                                    		TRIM(DECODE(INSTR(SKD_STR,'VVD3'),0,NULL,SUBSTR(SKD_STR,INSTR(SKD_STR,'VVD3')+4,9))) " ).append("\n"); 
		...
		query.append("--                                          ELSE" ).append("\n"); 
		query.append("--                                    		TRIM(DECODE(INSTR(SKD_STR,'VVD4'),0,NULL,SUBSTR(SKD_STR,INSTR(SKD_STR,'VVD4')+4,9))) " ).append("\n"); 
		...
		query.append("                                    (CASE WHEN @[skipActVal] = 'Y' AND @[vvd1] IS NULL THEN NULL" ).append("\n"); 
		query.append("                                          ELSE" ).append("\n"); 
		query.append("                                           TRIM(DECODE(INSTR(SKD_STR,'VVD1'),0,NULL,SUBSTR(SKD_STR, 1 +length('VVD1'),9 )))" ).append("\n"); 
		query.append("                                    END) VVD1," ).append("\n"); 
		...
		query.append("                                    (CASE WHEN @[skipActVal] = 'Y' AND @[vvd2] IS NULL THEN NULL" ).append("\n"); 
		query.append("                                          ELSE" ).append("\n"); 
		query.append("                                    		TRIM(DECODE(INSTR(SKD_STR,'VVD2'),0,NULL,SUBSTR(SKD_STR,143+length('VVD2'),9)))" ).append("\n"); 
		query.append("									END) VVD2," ).append("\n"); 
		...
		query.append("                                    (CASE WHEN @[skipActVal] = 'Y' AND @[vvd3] IS NULL THEN NULL" ).append("\n"); 
		query.append("                                          ELSE" ).append("\n"); 
		query.append("                                    		TRIM(DECODE(INSTR(SKD_STR,'VVD3'),0,NULL,SUBSTR(SKD_STR,266+length('VVD3'),9))) " ).append("\n"); 
		query.append("									END) VVD3," ).append("\n"); 
		...
		query.append("                                    (CASE WHEN @[skipActVal] = 'Y' AND @[vvd4] IS NULL THEN NULL" ).append("\n"); 
		query.append("                                          ELSE" ).append("\n"); 
		query.append("                                    		TRIM(DECODE(INSTR(SKD_STR,'VVD4'),0,NULL,SUBSTR(SKD_STR,389+length('VVD4'),9))) " ).append("\n"); 
		query.append("									END) VVD4," ).append("\n"); 
		...
		query.append("                                        --REGEXP_SUBSTR(source, ?쒗쁽?? ?쒖옉?꾩튂, 諛쒖깮?잛닔, Matching Modifiers )  " ).append("\n"); 
		...
		query.append("                                          WHEN @[rcv_t] = 'D' THEN NVL(@[por_n], OB_REP_ZN_CD) -- add for SO" ).append("\n"); 
		query.append("                                          WHEN @[manualFlg] = 'Y' AND @[ioBndCd] = 'O' THEN @[por_n] -- add for SO" ).append("\n"); 
		...
		query.append("							-- O/B Included Shuttle S/O Flag 추가 - #Add 2010.05.27 by sj" ).append("\n"); 
		...
		query.append("							-- I/B Included Shuttle S/O Flag 추가 - #Add 2010.05.27 by sj" ).append("\n"); 
		...
		query.append("                                          WHEN @[del_t] = 'D' THEN NVL(@[del_n], IB_REP_ZN_CD) -- add for SO" ).append("\n"); 
		query.append("                                          WHEN @[manualFlg] = 'Y' AND @[ioBndCd] = 'I' THEN @[del_n] -- add for SO" ).append("\n"); 
		...
		query.append("                            AND NVL(I.FULL_PKUP_YD_CD(+),'X') = NVL(DECODE(@[ioBndCd],'I',NVL(@[f_pu],NVL(I.FULL_PKUP_YD_CD(+),'X')),NVL(I.FULL_PKUP_YD_CD(+),'X')),'X') --INBOUND??곕르??FULL PICKUP CY" ).append("\n"); 
		query.append("                            AND NVL(O.TRSP_MOD_CD(+),'X') = NVL(DECODE(@[ob_trsp_mode],'AL',NVL(O.TRSP_MOD_CD(+),'X'),@[ob_trsp_mode]),NVL(O.TRSP_MOD_CD(+),'X'))  --TRNS MODE CODE : LIST - TD,RD,WD,TR,TW (?닌딉폒 TRO ?怨몄벥 TRANS MODE) " ).append("\n"); 
		query.append("                            AND NVL(I.TRSP_MOD_CD(+),'X') = NVL(DECODE(@[ib_trsp_mode],'AL',NVL(I.TRSP_MOD_CD(+),'X'),@[ib_trsp_mode]),NVL(I.TRSP_MOD_CD(+),'X'))  --TRNS MODE CODE : LIST - TD,RD,WD,TR,TW (?닌딉폒 TRO ?怨몄벥 TRANS MODE)" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("						AND NVL(ROUT.ORG_ROUT,'X') LIKE " ).append("\n"); 
		query.append("							CASE WHEN @[manualFlg] = 'Y' AND @[ioBndCd] = 'O' AND @[ob_str] = '%' THEN '%'" ).append("\n"); 
		query.append("								 WHEN @[manualFlg] = 'Y' AND @[ioBndCd] = 'O' AND @[ob_str] != '%' THEN REGEXP_REPLACE(@[ob_str],'-...-','-')||'%'" ).append("\n"); 
		query.append("								 WHEN @[manualFlg] = 'Y' AND @[ioBndCd] != 'O' AND @[ob_str] != '%' THEN REGEXP_REPLACE(@[ob_str],'-...-','-')||'%'" ).append("\n"); 
		query.append("			     			     ELSE REGEXP_REPLACE(@[ob_str],'-...-','-')||'%' END " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                        AND NVL(ROUT.DEST_ROUT,'X') LIKE " ).append("\n"); 
		query.append("							CASE WHEN @[manualFlg] = 'Y' AND @[ioBndCd] = 'I' AND @[ib_str] = '%' THEN '%'" ).append("\n"); 
		query.append("								 WHEN @[manualFlg] = 'Y' AND @[ioBndCd] = 'I' AND @[ib_str] != '%' THEN REGEXP_REPLACE(@[ib_str],'-...-','-')||'%'" ).append("\n"); 
		query.append("								 WHEN @[manualFlg] = 'Y' AND @[ioBndCd] != 'I' AND @[ib_str] != '%' THEN REGEXP_REPLACE(@[ib_str],'-...-','-')||'%'" ).append("\n"); 
		query.append("			     			     ELSE REGEXP_REPLACE(@[ib_str],'-...-','-')||'%' END " ).append("\n"); 
		query.append("                    )" ).append("\n"); 
