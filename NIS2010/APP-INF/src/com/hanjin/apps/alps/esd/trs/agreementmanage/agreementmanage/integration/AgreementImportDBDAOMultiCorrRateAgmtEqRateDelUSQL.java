...
*@FileName : AgreementImportDBDAOMultiCorrRateAgmtEqRateDelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOMultiCorrRateAgmtEqRateDelUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Correction시 체크박스 해제시 Rate를 삭제로 update
	  * </pre>
	  */
	public AgreementImportDBDAOMultiCorrRateAgmtEqRateDelUSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOMultiCorrRateAgmtEqRateDelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
