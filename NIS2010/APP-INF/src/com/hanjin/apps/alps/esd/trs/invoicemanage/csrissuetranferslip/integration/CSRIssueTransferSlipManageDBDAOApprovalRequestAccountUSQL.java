...
*@FileName : CSRIssueTransferSlipManageDBDAOApprovalRequestAccountUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOApprovalRequestAccountUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOApprovalRequestAccountUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOApprovalRequestAccountUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
