...
*@FileName : AocComboVO.java
*@FileTitle : AocComboVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esd.aoc.common.aoccommon.vo;
...
public class AocComboVO extends AbstractValueObject
{
    ...
    public AocComboVO(String ibflag, String pagerows, String val, String name, String desc, String comboCd)
    {
        models = new ArrayList();
        this.comboCd = null;
        this.val = null;
    ...
    public AocComboVO[] fromRequestGrid(HttpServletRequest request)
    {
        return fromRequestGrid(request, "");
    }

    public AocComboVO[] fromRequestGrid(HttpServletRequest request, String prefix)
    {
    	AocComboVO model = null;
        ...
        return getAocComboVOs();
    }

    public AocComboVO[] getAocComboVOs()
    {
    	AocComboVO vos[] = (AocComboVO[])models.toArray(new AocComboVO[models.size()]);
        return vos;
    }
