...
*@FileName : AsiaInlandCostSpecialCargoVO.java
*@FileTitle : AsiaInlandCostSpecialCargoVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaInlandCostSpecialCargoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaInlandCostSpecialCargoVO> models = new ArrayList<AsiaInlandCostSpecialCargoVO>();
	...
	public AsiaInlandCostSpecialCargoVO() {}
...
/**
	 ...
	 */
	public AsiaInlandCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaInlandCostSpecialCargoVO[]
	 */
	public AsiaInlandCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaInlandCostSpecialCargoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AsiaInlandCostSpecialCargoVO();
	...
	public AsiaInlandCostSpecialCargoVO[] getInlandCostSpecialCargoVOs(){
		AsiaInlandCostSpecialCargoVO[] vos = (AsiaInlandCostSpecialCargoVO[])models.toArray(new AsiaInlandCostSpecialCargoVO[models.size()]);
		return vos;
	}
