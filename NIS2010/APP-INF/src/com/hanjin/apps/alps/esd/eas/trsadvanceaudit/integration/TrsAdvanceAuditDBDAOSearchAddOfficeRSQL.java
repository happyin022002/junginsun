...
*@FileName : TrsAdvanceAuditDBDAOSearchAddOfficeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsAdvanceAuditDBDAOSearchAddOfficeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Add office 시 등록된 office 인지 조회한다
	  * </pre>
	  */
	public TrsAdvanceAuditDBDAOSearchAddOfficeRSQL(){
		setQuery();
		...
		query.append("FileName : TrsAdvanceAuditDBDAOSearchAddOfficeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
