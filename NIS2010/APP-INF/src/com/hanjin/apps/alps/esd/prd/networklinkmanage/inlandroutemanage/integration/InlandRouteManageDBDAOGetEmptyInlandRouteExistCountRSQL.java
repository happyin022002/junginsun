...
*@FileName : InlandRouteManageDBDAOGetEmptyInlandRouteExistCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOGetEmptyInlandRouteExistCountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * GetEmptyInlandRouteExistCount
	  * </pre>
	  */
	public InlandRouteManageDBDAOGetEmptyInlandRouteExistCountRSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOGetEmptyInlandRouteExistCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DECODE(B.TRSP_AGMT_OFC_CTY_CD, NULL,'', B.TRSP_AGMT_OFC_CTY_CD||LPAD(B.TRSP_AGMT_SEQ,6,00)) AGMT," ).append("\n"); 
		query.append("B.INLND_ROUT_CMB_FLG CMB, B.INLND_ROUT_JUNC_NM JUNK," ).append("\n"); 
		query.append("ROW_NUMBER() OVER(PARTITION BY b.ROUT_ORG_NOD_CD, b.ROUT_DEST_NOD_CD,b.ROUT_SEQ" ).append("\n"); 
		query.append("ORDER BY b.ROUT_ORG_NOD_CD, b.ROUT_DEST_NOD_CD, b.ROUT_SEQ,  b.ROUT_DTL_SEQ) r" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("and nvl(m.WRS_FULL_CMDT_CD,'X')=nvl( ''      ,'X')" ).append("\n"); 
		query.append("and nvl(m.WRS_MTY_CMDT_CD ,'X')=nvl( @[wrs_chk]       ,'X')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${param_val} != '')" ).append("\n"); 
		query.append("#foreach(${itm} in ${param_val})" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("and nvl(dtl.CMB${itm.a}          ,'X')=nvl( '${itm.inlnd_rout_cmb_flg}'       ,'N')" ).append("\n"); 
