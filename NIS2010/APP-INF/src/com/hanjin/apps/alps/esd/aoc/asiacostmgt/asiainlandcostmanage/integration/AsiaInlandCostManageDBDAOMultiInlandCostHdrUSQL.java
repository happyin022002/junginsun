...
*@FileName : AsiaInlandCostManageDBDAOMultiInlandCostHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOMultiInlandCostHdrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOMultiInlandCostHdrUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOMultiInlandCostHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
