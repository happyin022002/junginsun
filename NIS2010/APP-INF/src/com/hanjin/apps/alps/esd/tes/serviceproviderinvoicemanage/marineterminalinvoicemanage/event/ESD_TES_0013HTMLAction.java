...
*@FileName : ESD_TES_013HTMLAction.java
 ...
 *
 * @author kimjinjoo
 * @see EsdTes0013Event , ESD_TES_013EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0013HTMLAction extends HTMLActionSupport {


	/**
	 * ESD_TES_013HTMLAction 객체를 생성
	 */
	public ESD_TES_0013HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_013Event로 파싱하여 request에 셋팅<br>
	 *
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		while (enums.hasMoreElements()){
			...
			log.debug(param_name+" >>>>>>>>>>>>>>>>>> "+request.getParameter(param_name));
		...
		log.debug("\n\nESD_TES_TML_0013HTMLAction -> codeLenght = "+codeLength +"\n\n");

		EsdTes0013Event		event	= new EsdTes0013Event();
		...
		event.setTesEdiSoHdrVO( (TesEdiSoHdrVO)getVO(request, TesEdiSoHdrVO.class) );
...
*/
        /*** HashMap 사용할까해서.. ***/
/*
		EsdTes013Event event = new EsdTes013Event(
				param_map,
...
/*		ESD_TES_013Event event = new ESD_TES_013Event(
