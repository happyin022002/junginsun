...
*@FileName : OceanRouteManageDBDAOGetMaxSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteManageDBDAOGetMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanRouteManageDBDAOGetMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteManageDBDAOGetMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT NVL(MAX(ROUT_SEQ), 0) maxS" ).append("\n"); 
