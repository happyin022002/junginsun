...
*@FileName : ESD_LEA_0017HTMLAction.java
...
public class ESD_LEA_0017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0017HTMLAction 객체를 생성
	 */
	public ESD_LEA_0017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0017Event event = new EsdLea0017Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchCsrListByGLMonthVO((SearchCsrListByGLMonthVO)getVO(request, SearchCsrListByGLMonthVO .class));
		}
