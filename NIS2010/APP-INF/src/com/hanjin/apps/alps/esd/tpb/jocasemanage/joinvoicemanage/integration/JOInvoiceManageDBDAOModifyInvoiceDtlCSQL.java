...
*@FileName : JOInvoiceManageDBDAOModifyInvoiceDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOModifyInvoiceDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOInvoiceManageDBDAOModifyInvoiceDtlCSQL(){
		setQuery();
		...
		query.append("FileName : JOInvoiceManageDBDAOModifyInvoiceDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_INV_RVIS_PKG.UPD_INV_RVIS_DTL(" ).append("\n"); 
