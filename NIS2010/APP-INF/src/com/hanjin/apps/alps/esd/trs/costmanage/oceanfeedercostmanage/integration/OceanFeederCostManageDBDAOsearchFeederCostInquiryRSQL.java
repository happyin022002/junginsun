...
*@FileName : OceanFeederCostManageDBDAOsearchFeederCostInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOsearchFeederCostInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOsearchFeederCostInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOsearchFeederCostInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
