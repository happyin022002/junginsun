...
public class CopDetailReceiveDBDAOSearchEdiVEDRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("        ,DECODE(a.STND_EDI_STS_CD, 'VAD', 'VE', 'VDL', 'VDE', 'VDT', 'VET','VAT', 'VETS', " ).append("\n"); 
		query.append("				'VBD', 'VBE') edi_sts -- //2015.03.16 김민정 [CHM-201534483] Anchored Vessel 관련 ETB, ATB 수신 화주 추가 - 'VBE' 이벤트 EDI 발송" ).append("\n"); 
		...
		query.append("#if (${event_tp_cd} == 'ETB' ) -- //2015.03.16 김민정 [CHM-201534483] Anchored Vessel 관련 ETB, ATB 수신 화주 추가 - 'VBE' 이벤트 EDI 발송" ).append("\n"); 
		query.append("AND    a.STND_EDI_STS_CD IN ('VBD')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
