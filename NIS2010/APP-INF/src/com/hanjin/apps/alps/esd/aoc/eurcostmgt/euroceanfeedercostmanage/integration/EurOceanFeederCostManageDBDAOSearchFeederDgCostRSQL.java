...
*@FileName : EurOceanFeederCostManageDBDAOSearchFeederDgCostRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOSearchFeederDgCostRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOSearchFeederDgCostRSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOSearchFeederDgCostRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", AOC_EUR_FDR_TRF_DTL DRY" ).append("\n"); 
