...
*@FileName : USA404EDIStatusInquiryDBDAOInsert404EdiResendTrsTrspEdiTmpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USA404EDIStatusInquiryDBDAOInsert404EdiResendTrsTrspEdiTmpCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 404 Edi에 쓰일 Send No, SO# W/O TEMP 테이블에 추가 SQL
	  * </pre>
	  */
	public USA404EDIStatusInquiryDBDAOInsert404EdiResendTrsTrspEdiTmpCSQL(){
		setQuery();
		...
		query.append("FileName : USA404EDIStatusInquiryDBDAOInsert404EdiResendTrsTrspEdiTmpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
