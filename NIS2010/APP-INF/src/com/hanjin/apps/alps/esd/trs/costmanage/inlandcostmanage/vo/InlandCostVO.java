...
*@FileName : InlandCostVO.java
*@FileTitle : InlandCostVO
*Open Issues :
*Change history :
...
public class InlandCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InlandCostVO> models = new ArrayList<InlandCostVO>();
...
/**
	 ...
	 * @return InlandCostVO[]
	 */
	public InlandCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InlandCostVO[]
	 */
	public InlandCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InlandCostVO model = null;
	...
	public InlandCostVO[] getInlandCostVOs(){
		InlandCostVO[] vos = (InlandCostVO[])models.toArray(new InlandCostVO[models.size()]);
		return vos;
	}
