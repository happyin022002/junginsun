...
*@FileName : CSRIssueTransferSlipManageDBDAOUpdateGLDTRailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOUpdateGLDTRailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOUpdateGLDTRailUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOUpdateGLDTRailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET  	GL_DT = DECODE(@[INV_STAT_CD], 'U',  (" ).append("\n"); 
