...
*@FileName : ReplanManageDBDAOSearch315VEToBeSentRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReplanManageDBDAOSearch315VEToBeSentRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReplanManageDBDAOSearch315VEToBeSentRSQL(){
		setQuery();
		...
		query.append("FileName : ReplanManageDBDAOSearch315VEToBeSentRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
