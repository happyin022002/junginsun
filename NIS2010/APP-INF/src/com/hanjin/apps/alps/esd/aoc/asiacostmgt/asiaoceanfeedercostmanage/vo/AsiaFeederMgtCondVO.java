...
*@FileName : AsiaFeederMgtCondVO.java
*@FileTitle : AsiaFeederMgtCondVO
*Open Issues :
*Change history :
...
public class AsiaFeederMgtCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaFeederMgtCondVO> models = new ArrayList<AsiaFeederMgtCondVO>();
	...
	public AsiaFeederMgtCondVO() {}

	public AsiaFeederMgtCondVO(String ibflag, String pagerows, String inCostTrfNo, String inOfcCd, String inBtnSts, String inFromNodCd, String inToNodCd, String inRhqCd) {
...
/**
	 ...
	 */
	public AsiaFeederMgtCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaFeederMgtCondVO[]
	 */
	public AsiaFeederMgtCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaFeederMgtCondVO model = null;
		...
		return getAsiaFeederMgtCondVOs();
	}
	...
	public AsiaFeederMgtCondVO[] getAsiaFeederMgtCondVOs(){
		AsiaFeederMgtCondVO[] vos = (AsiaFeederMgtCondVO[])models.toArray(new AsiaFeederMgtCondVO[models.size()]);
		return vos;
	}
