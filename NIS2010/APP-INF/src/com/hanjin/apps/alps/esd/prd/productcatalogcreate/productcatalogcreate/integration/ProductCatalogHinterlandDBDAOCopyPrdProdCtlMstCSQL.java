...
*@FileName : ProductCatalogHinterlandDBDAOCopyPrdProdCtlMstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogHinterlandDBDAOCopyPrdProdCtlMstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProductCatalogHinterlandDBDAOCopyPrdProdCtlMstCSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogHinterlandDBDAOCopyPrdProdCtlMstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- AOC PC 생성로직 변경 --" ).append("\n"); 
		...
		query.append("SELECT DECODE(@[new_seq], NULL, NULL, @[hd_pctl_no] || @[new_seq]) PCTL_NO" ).append("\n"); 
