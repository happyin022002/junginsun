...
*@FileName : FeederCostInquiryVO.java
*@FileTitle : FeederCostInquiryVO
*Open Issues :
*Change history :
...
public class FeederCostInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FeederCostInquiryVO> models = new ArrayList<FeederCostInquiryVO>();
...
/**
	 ...
	 * @param request
	 * @return FeederCostInquiryVO[]
	 */
	public FeederCostInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FeederCostInquiryVO[]
	 */
	public FeederCostInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FeederCostInquiryVO model = null;
	 ...
	 * @return FeederCostInquiryVO[]
	 */
	public FeederCostInquiryVO[] getFeederCostInquiryVOs(){
		FeederCostInquiryVO[] vos = (FeederCostInquiryVO[])models.toArray(new FeederCostInquiryVO[models.size()]);
		return vos;
	}
