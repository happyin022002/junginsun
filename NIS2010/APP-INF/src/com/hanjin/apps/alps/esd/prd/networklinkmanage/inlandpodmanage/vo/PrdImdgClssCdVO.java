...
public class PrdImdgClssCdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PrdImdgClssCdVO> models = new ArrayList<PrdImdgClssCdVO>();
	...
	public PrdImdgClssCdVO() {}

	public PrdImdgClssCdVO(String ibflag, String pagerows, String imdgClssCd, String imdgClssCdDesc, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public PrdImdgClssCdVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public PrdImdgClssCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PrdImdgClssCdVO model = null;
		...
		return getPrdImdgClssCdVOs();
	}

	public PrdImdgClssCdVO[] getPrdImdgClssCdVOs(){
		PrdImdgClssCdVO[] vos = (PrdImdgClssCdVO[])models.toArray(new PrdImdgClssCdVO[models.size()]);
		return vos;
	}
