...
*@FileName : EasOpfTdrAtchFileVO.java
*@FileTitle : EasOpfTdrAtchFileVO
*Open Issues :
*Change history :
*@LastModifyDate : 
* 1.0 Creation
...
public class EasOpfTdrAtchFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EasOpfTdrAtchFileVO> models = new ArrayList<EasOpfTdrAtchFileVO>();
	...
	public EasOpfTdrAtchFileVO() {}

	public EasOpfTdrAtchFileVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String vpsPortCd, String clptIndSeq, String cntrHndlKndCd, String cntrNo, String atchFileSeq, String fileNm, String fileSavId, String updUsrId, String updDt, String creUsrId, String creDt, String fileDownload) {
		this.updDt = updDt;
		this.vslCd = vslCd;
...
/**
	 ...
	 * @param request
	 * @return EasOpfTdrAtchFileVO[]
	 */
	public EasOpfTdrAtchFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EasOpfTdrAtchFileVO[]
	 */
	public EasOpfTdrAtchFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EasOpfTdrAtchFileVO model = null;
		...
		return getEasOpfTdrAtchFileVOs();
	}
	 ...
	 * @return EasOpfTdrAtchFileVO[]
	 */
	public EasOpfTdrAtchFileVO[] getEasOpfTdrAtchFileVOs(){
		EasOpfTdrAtchFileVO[] vos = (EasOpfTdrAtchFileVO[])models.toArray(new EasOpfTdrAtchFileVO[models.size()]);
		return vos;
	}
