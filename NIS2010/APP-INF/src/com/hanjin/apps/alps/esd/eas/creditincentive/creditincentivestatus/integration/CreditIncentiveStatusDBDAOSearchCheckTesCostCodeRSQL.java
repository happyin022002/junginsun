...
*@FileName : CreditIncentiveStatusDBDAOSearchCheckTesCostCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOSearchCheckTesCostCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Grid에 입력된 Terminal Cost Code Validation
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOSearchCheckTesCostCodeRSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOSearchCheckTesCostCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
