...
public class EsdSce0068EventResponse extends EventResponseSupport {
    ...
    /**
     * EsdSce0068 요청을 처리한 서버 실행 결과(DB ResultSet)를 담아 EsdSce0068EventResponse 객체를 생성
     * 
    ...
    /**
     * EsdSce0068 요청을 처리한 서버 실행 결과(DB ResultSet)와 성공여부(successFlag)를 담아 EsdSce0068EventResponse 객체를 생성
     * 
     * @param rowSet 서버 실행 결과
