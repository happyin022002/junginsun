...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.enis.esd.tes 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 *
 * @author 
 * @see EsdTes0032Event , ESD_TES_0032EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0032HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_031HTMLAction 객체를 생성
	 */
	public ESD_TES_0032HTMLAction() {
	} 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes0032Event event = new EsdTes0032Event(); 
		
		event.setMdmVendorInfoVO( (MdmVendorInfoVO)getVO( request, MdmVendorInfoVO.class ) );
