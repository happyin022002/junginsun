...
public class OceanLinkBackEndDBDAOModifyOceanRouteByLinkUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      N1ST_SKD_DIR_CD = @[dircd] , " ).append("\n"); 
		...
		query.append("      N2ND_SKD_DIR_CD = @[dircd] , " ).append("\n"); 
		...
		query.append("      N3RD_SKD_DIR_CD = @[dircd] , " ).append("\n"); 
		...
		query.append("      N4TH_SKD_DIR_CD = @[dircd] , " ).append("\n"); 
