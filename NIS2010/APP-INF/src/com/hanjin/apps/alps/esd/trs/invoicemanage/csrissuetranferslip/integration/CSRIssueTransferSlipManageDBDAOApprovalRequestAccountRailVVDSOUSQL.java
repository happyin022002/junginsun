...
public class CSRIssueTransferSlipManageDBDAOApprovalRequestAccountRailVVDSOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("D.LGS_COST_CD LIKE 'TRM%' OR D.LGS_COST_CD LIKE 'SM%' OR D.LGS_COST_CD LIKE 'TRC%' OR D.LGS_COST_CD LIKE 'TRG%'			/* 2008.06.06 CNTC Modification based on GL Date, Empty Container Only	*/" ).append("\n"); 
