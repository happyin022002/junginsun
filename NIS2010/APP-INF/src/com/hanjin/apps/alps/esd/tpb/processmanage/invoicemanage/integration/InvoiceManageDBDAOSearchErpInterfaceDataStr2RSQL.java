...
public class InvoiceManageDBDAOSearchErpInterfaceDataStr2RSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    bt.chg_cd As n3pty_inv_chg_tp_cd,       /* Like 3CC (general), 'XXX' ('JO' case) */" ).append("\n"); 
		query.append("    CASE WHEN bt.chg_cd = 'VGA' OR bt.chg_cd = 'VGO' OR bt.chg_cd = 'VGP' OR bt.chg_cd = 'VGW' THEN NVL(dtl.inv_dtl_amt,0) + NVL(dtl.add_amt,0) - NVL(dtl.rev_amt,0) " ).append("\n"); 
		query.append("         ELSE NVL(dtl.inv_dtl_amt,0) - NVL(dtl.rev_amt,0) " ).append("\n"); 
		query.append("    END As chg_amt," ).append("\n"); 
		query.append("    --NVL(dtl.inv_dtl_amt,0) - NVL(dtl.rev_amt,0) As chg_amt," ).append("\n"); 
		query.append("    COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01394',bt.chg_cd ) As chg_full_nm,  /* ADDED CHARGE TYPE CODE NAME ... */" ).append("\n"); 
		...
		query.append("    --DECODE(nvl(otl.n3pty_tp_cd,'X'), 'R', bt.rev_acct_cd, DECODE(ots.n3pty_expn_tp_cd, 'TES','512181', 'TRS','512381', 'MNR','511581', 'PSO','511881', NULL)) As acct_cd,   /* ACCT_CD DECISION */" ).append("\n"); 
		query.append("    bt.rev_acct_cd As acct_cd,   /* ACCT_CD DECISION */" ).append("\n"); 
		...
		query.append("FROM TPB_OTS_GRP ots, TPB_INVOICE inv, TPB_INV_RVIS hdr, TPB_INV_RVIS_DTL dtl, TPB_OTS_DTL otl, TPB_N3RD_PTY_BIL_TP  bt" ).append("\n"); 
		...
		query.append("    AND ots.n3pty_no = otl.n3pty_no" ).append("\n"); 
		query.append("    AND otl.n3pty_no_dp_seq = 1" ).append("\n"); 
		...
		query.append("    AND dtl.n3pty_bil_tp_cd = bt.n3pty_bil_tp_cd" ).append("\n"); 
		query.append("----- ----- -----" ).append("\n"); 
		...
		query.append("    hdr.curr_cd As chg_curr_cd," ).append("\n"); 
		query.append("    DECODE(dtl.n3pty_bil_tp_cd, 'JO','954117',NULL) As rev_acct_cd," ).append("\n"); 
		query.append("    DECODE(ots.n3pty_expn_tp_cd, 'TES','512181', 'TRS','512381', 'MNR','511581', 'PSO','511881', NULL) As acct_cd,   /* ACCT_CD DECISION */" ).append("\n"); 
		query.append("    null As inv_if_flg," ).append("\n"); 
		query.append("    null As inv_if_no," ).append("\n"); 
		query.append("    TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') As inv_if_dt," ).append("\n"); 
		query.append("    inv.ofc_cd As inv_if_ofc_cd," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("UNION ALL " ).append("\n"); 
		query.append("SELECT ----- SBC CASE" ).append("\n"); 
		query.append("    @[ar_if_no] As ar_if_no," ).append("\n"); 
		query.append("    ( SELECT MAX(n3pty_inv_rvis_dtl_seq)+1 FROM TPB_INV_RVIS_DTL aa WHERE aa.n3pty_inv_no = hdr.n3pty_inv_no AND aa.n3pty_inv_rvis_seq = hdr.n3pty_inv_rvis_seq )    --- CHG_SEQ -- START " ).append("\n"); 
		query.append("    + ( SELECT COUNT(0) CNT" ).append("\n"); 
		query.append("        FROM TPB_OTS_GRP ots1, TPB_INVOICE inv1, TPB_INV_RVIS hdr1, TPB_INV_RVIS_DTL dtl1" ).append("\n"); 
		query.append("        WHERE inv1.n3pty_inv_no = hdr1.n3pty_inv_no" ).append("\n"); 
		query.append("            AND inv1.n3pty_inv_no = dtl1.n3pty_inv_no" ).append("\n"); 
		...
		query.append("            AND hdr1.n3pty_inv_no = hdr.n3pty_inv_no" ).append("\n"); 
		query.append("            AND hdr1.n3pty_inv_rvis_seq = hdr.n3pty_inv_rvis_seq" ).append("\n"); 
		query.append("            AND dtl1.n3pty_bil_tp_cd = 'JO'                            " ).append("\n"); 
		query.append("            AND ( dtl1.rev_amt IS NOT NULL AND dtl1.rev_amt != 0.0 )  " ).append("\n"); 
		query.append("      )" ).append("\n"); 
		query.append("    + ROWNUM As chg_seq,                                  " ).append("\n"); 
		query.append("    'SBC' As ar_inv_chg_tp_cd,    " ).append("\n"); 
		query.append("    NVL(hdr.locl_tax_amt,0) As chg_amt," ).append("\n"); 
		query.append("    COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01394','TVA') As chg_full_nm,   " ).append("\n"); 
		query.append("    hdr.curr_cd As chg_curr_cd," ).append("\n"); 
		query.append("    DECODE(dtl.n3pty_bil_tp_cd, 'JO','954117', NULL) As rev_acct_cd," ).append("\n"); 
		query.append("    '954117' As acct_cd,      /* SBC case, '954117' */" ).append("\n"); 
		query.append("    null As inv_if_flg," ).append("\n"); 
		query.append("    null As inv_if_no," ).append("\n"); 
		query.append("    TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS') As inv_if_dt," ).append("\n"); 
		query.append("    inv.ofc_cd As inv_if_ofc_cd," ).append("\n"); 
		...
		query.append("    AND hdr.n3pty_inv_no = @[s_n3pty_inv_no]" ).append("\n"); 
		query.append("    AND hdr.n3pty_inv_rvis_seq = @[s_n3pty_inv_his_seq]" ).append("\n"); 
		query.append("    AND ( hdr.locl_tax_amt IS NOT NULL AND hdr.locl_tax_amt > 0.0 )    " ).append("\n"); 
		query.append("    AND dtl.N3pty_inv_rvis_dtl_seq = 1" ).append("\n"); 
		query.append("UNION ALL " ).append("\n"); 
		query.append("SELECT ----- INDIA KKC CASE" ).append("\n"); 
		query.append("    @[ar_if_no] As ar_if_no," ).append("\n"); 
		query.append("    ( SELECT MAX(n3pty_inv_rvis_dtl_seq)+2 FROM TPB_INV_RVIS_DTL aa WHERE aa.n3pty_inv_no = hdr.n3pty_inv_no AND aa.n3pty_inv_rvis_seq = hdr.n3pty_inv_rvis_seq )    --- CHG_SEQ -- START " ).append("\n"); 
		query.append("    + ( SELECT COUNT(0) CNT" ).append("\n"); 
		query.append("        FROM TPB_OTS_GRP ots1, TPB_INVOICE inv1, TPB_INV_RVIS hdr1, TPB_INV_RVIS_DTL dtl1" ).append("\n"); 
		query.append("        WHERE inv1.n3pty_inv_no = hdr1.n3pty_inv_no" ).append("\n"); 
		query.append("            AND inv1.n3pty_inv_no = dtl1.n3pty_inv_no" ).append("\n"); 
		...
		query.append("      )" ).append("\n"); 
		query.append("    + ROWNUM As chg_seq,                                  " ).append("\n"); 
		query.append("    'KKC' As ar_inv_chg_tp_cd,    " ).append("\n"); 
		query.append("    NVL(hdr.locl_tax_amt,0) As chg_amt," ).append("\n"); 
		query.append("    COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD01394','TVA') As chg_full_nm,   " ).append("\n"); 
		query.append("    hdr.curr_cd As chg_curr_cd," ).append("\n"); 
		query.append("    DECODE(dtl.n3pty_bil_tp_cd, 'JO','954117', NULL) As rev_acct_cd," ).append("\n"); 
		...
		query.append("    AND hdr.n3pty_inv_no = @[s_n3pty_inv_no]" ).append("\n"); 
		query.append("    AND hdr.n3pty_inv_rvis_seq = @[s_n3pty_inv_his_seq]" ).append("\n"); 
		query.append("    AND ( hdr.n2nd_locl_tax_amt IS NOT NULL AND hdr.n2nd_locl_tax_amt > 0.0 )    " ).append("\n"); 
		query.append("    AND dtl.N3pty_inv_rvis_dtl_seq = 1" ).append("\n"); 
