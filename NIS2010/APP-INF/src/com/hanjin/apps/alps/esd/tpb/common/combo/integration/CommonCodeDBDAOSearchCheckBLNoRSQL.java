...
*@FileName : CommonCodeDBDAOSearchCheckBLNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonCodeDBDAOSearchCheckBLNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonCodeDBDAOSearchCheckBLNoRSQL(){
		SetQuery();
		...
		query.append("FileName : CommonCodeDBDAOSearchCheckBLNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
