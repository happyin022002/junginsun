...
public class StatusInquiryDBDAOSearchActivityByClosingTPBRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                  , ( SELECT RHQ_CD FROM TPB_HNDL_OFC WHERE OFC_CD = B.OFC_CD AND DELT_FLG = 'N' AND N3PTY_OFC_TP_CD = 'T') AS RHQ" ).append("\n"); 
		...
		query.append("                  , TO_CHAR(B.N3PTY_CLZ_DT, 'YY-MM') AS CLS_MON" ).append("\n"); 
		...
		query.append("				#end" ).append("\n"); 
		query.append("                    )" ).append("\n"); 
		query.append("           AND      B.N3PTY_CLZ_DT BETWEEN TO_DATE(@[s_sdate],'YYYYMM') AND ADD_MONTHS(TO_DATE(@[s_edate],'YYYYMM'),1)" ).append("\n"); 
