...
*@FileName : DODInvoiceMgtDBDAOSearchPayerFaxNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DODInvoiceMgtDBDAOSearchPayerFaxNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DODInvoiceMgtDBDAOSearchPayerFaxNoRSQL(){
		setQuery();
		...
		query.append("FileName : DODInvoiceMgtDBDAOSearchPayerFaxNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,CNTC_PNT_FAX_NO AS CNTC_PNT_FAX_NO" ).append("\n"); 
		query.append("FROM EAS_PAYR_CNTC_PNT K" ).append("\n"); 
