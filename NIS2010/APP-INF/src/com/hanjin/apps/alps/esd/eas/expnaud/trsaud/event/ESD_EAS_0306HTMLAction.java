...
*@FileName : ESD_EAS_0306HTMLAction.java
...
public class ESD_EAS_0306HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0306HTMLAction 객체를 생성
	 */
	public ESD_EAS_0306HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0306Event event = new EsdEas0306Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setTrffCmprsnByTRSAgrmntVO((TrffCmprsnByTRSAgrmntVO)getVO(request, TrffCmprsnByTRSAgrmntVO .class));
