...
*@FileName : CommonPopUpManageDBDAOSearchSCNOManageRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonPopUpManageDBDAOSearchSCNOManageRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommonPopUpManageDBDAOSearchSCNOManageRSQL(){
		setQuery();
		...
		query.append("FileName : CommonPopUpManageDBDAOSearchSCNOManageRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
