...
*@FileName : AsiaInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOSearchInlandCostGuidelineExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
