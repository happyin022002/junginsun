...
import com.hanjin.apps.alps.esd.tes.codemanage.codemanage.vo.TesCodeManageCommonVO;
...
public class EsdTes9090Event extends EventSupport {
	...
	public TesCodeManageCommonVO[] getTesCodeManageCommonVOs() {
		return tesCodeManageCommonVOs;
	}

	public void setTesCodeManageCommonVOs(
			TesCodeManageCommonVO[] tesCodeManageCommonVOs) {
		this.tesCodeManageCommonVOs = tesCodeManageCommonVOs;
	}
