...
*@FileName : EurOceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOSearchOceanFeederCostAccountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03050', FDR_45FT_COST_SYS_SRC_CD) AS SYS_SRC_CD_45FT" ).append("\n"); 
		query.append("      , A.FDR_45FT_COST_CALC_RMK                                              AS CALC_RMK_45FT" ).append("\n"); 
