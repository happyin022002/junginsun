...
*@FileName : AccrualBatchExecuteResultDBDAOModifyYearlyCostBudgetUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccrualBatchExecuteResultDBDAOModifyYearlyCostBudgetUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyYearlyCostBudget
	  * </pre>
	  */
	public AccrualBatchExecuteResultDBDAOModifyYearlyCostBudgetUSQL(){
		setQuery();
		...
		params.put("mon_bud_usd_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccrualBatchExecuteResultDBDAOModifyYearlyCostBudgetUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE LEA_YRY_COST_BUD" ).append("\n"); 
		query.append("SET MON_BUD_USD_AMT = @[mon_bud_usd_amt]" ).append("\n"); 
		query.append("   ,TTL_USD_AMT     = @[mon_bud_usd_amt] * 12" ).append("\n"); 
