...
*@FileName : WorkOrderInquiryDBDAOsearchAuthAproTrsInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderInquiryDBDAOsearchAuthAproTrsInquiryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Authorization Approval Inquiry 화면에 대한 TRS 용 조회
	  * </pre>
	  */
	public WorkOrderInquiryDBDAOsearchAuthAproTrsInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderInquiryDBDAOsearchAuthAproTrsInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       APRO_RSLT," ).append("\n"); 
		query.append("       AUTH_APRO_DT," ).append("\n"); 
		...
		query.append("       CAAR.CXL_FLG," ).append("\n"); 
		query.append("       CAAR.DTL_PGM_URL_CTNT," ).append("\n"); 
		query.append("       CAAR.AUTH_APRO_RMK," ).append("\n"); 
		query.append("       CAAR.APRO_RSLT," ).append("\n"); 
		query.append("       CAAR.AUTH_APRO_DT," ).append("\n"); 
		query.append("       CAAR.AUTH_APRO_USR_ID," ).append("\n"); 
		query.append("       CAAR.AUTH_APRO_USR_NM," ).append("\n"); 
		...
		query.append(", DECODE(Q.CXL_FLG,'Y','Cancelled','') AS CXL_FLG" ).append("\n"); 
