...
*@FileName : SearchTPBDetailInfoVO.java
*@FileTitle : SearchTPBDetailInfoVO
*Open Issues :
*Change history :
...
public class SearchTPBDetailInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchTPBDetailInfoVO> models = new ArrayList<SearchTPBDetailInfoVO>();
	...
	public SearchTPBDetailInfoVO() {}

	public SearchTPBDetailInfoVO(String ibflag, String pagerows, String n3ptyNo, String n3ptyInvNo, String ofcCd, String otsStsNm, String overdue, String vndrCustDivCd, String trdPartyVal, String trdPartyNm, String csrNo, String rocIn, String rocOut, String fileNo, String sN3ptyInvNo, String sN3ptyNo) {
		this.csrNo = csrNo;
	 ...
	 */
	public SearchTPBDetailInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTPBDetailInfoVO[]
	 */
	public SearchTPBDetailInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchTPBDetailInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchTPBDetailInfoVO();
				if (csrNo[i] != null)
		...
		return getSearchTPBDetailInfoVOs();
	}
	...
	public SearchTPBDetailInfoVO[] getSearchTPBDetailInfoVOs(){
		SearchTPBDetailInfoVO[] vos = (SearchTPBDetailInfoVO[])models.toArray(new SearchTPBDetailInfoVO[models.size()]);
		return vos;
	}
