...
*@FileName : TrsAdvanceAuditDBDAOremoveAutoAuditDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsAdvanceAuditDBDAOremoveAutoAuditDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRS Auto Audit Detail을 삭제한다.
	  * </pre>
	  */
	public TrsAdvanceAuditDBDAOremoveAutoAuditDtlDSQL(){
		setQuery();
		...
		query.append("FileName : TrsAdvanceAuditDBDAOremoveAutoAuditDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM EAS_TRSP_AUD_CHK" ).append("\n"); 
