...
*@FileName : AgreementHisDBDAOUpdateTrsAgmtEqRtHisUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementHisDBDAOUpdateTrsAgmtEqRtHisUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AgreementHisDBDAOUpdateTrsAgmtEqRtHis
	  * </pre>
	  */
	public AgreementHisDBDAOUpdateTrsAgmtEqRtHisUSQL(){
		setQuery();
		...
		query.append("FileName : AgreementHisDBDAOUpdateTrsAgmtEqRtHisUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TRS_AGMT_EQ_RT_HIS" ).append("\n"); 
