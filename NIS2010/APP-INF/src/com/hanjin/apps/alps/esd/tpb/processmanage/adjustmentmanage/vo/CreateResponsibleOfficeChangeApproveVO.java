...
public class CreateResponsibleOfficeChangeApproveVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CreateResponsibleOfficeChangeApproveVO> models = new ArrayList<CreateResponsibleOfficeChangeApproveVO>();
	...
	public CreateResponsibleOfficeChangeApproveVO() {}

	public CreateResponsibleOfficeChangeApproveVO(String ibflag, String pagerows, String sChk, String sWrtfRsnCd, String sN3ptyNo, String n3ptyNo, String sStlCltOfcCngAmt, String stlCltOfcCngAmt, String sStlFwrdOfcCd, String sRaRmk1, String sUserOfcCd, String sUserId, String sFileNo, String chkApp, String chkRej, String reviewStep, String n2ndRvwChk, String adjStsSeq, String adjN2ndRvwSeq, String adjN2ndRvwStsCd) {
	 ...
	 */
	public CreateResponsibleOfficeChangeApproveVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreateResponsibleOfficeChangeApproveVO[]
	 */
	public CreateResponsibleOfficeChangeApproveVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CreateResponsibleOfficeChangeApproveVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CreateResponsibleOfficeChangeApproveVO();
	...
	public CreateResponsibleOfficeChangeApproveVO[] getCreateResponsibleOfficeChangeApproveVOs(){
		CreateResponsibleOfficeChangeApproveVO[] vos = (CreateResponsibleOfficeChangeApproveVO[])models.toArray(new CreateResponsibleOfficeChangeApproveVO[models.size()]);
		return vos;
	}
