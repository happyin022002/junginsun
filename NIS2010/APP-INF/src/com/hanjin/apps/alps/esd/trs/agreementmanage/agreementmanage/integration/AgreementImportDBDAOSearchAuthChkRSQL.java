...
*@FileName : AgreementImportDBDAOSearchAuthChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOSearchAuthChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgreementImportDBDAOSearchAuthChkRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOSearchAuthChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  SELECT OFC_CD, OFC_KND_CD, PRNT_OFC_CD" ).append("\n"); 
		query.append("    FROM MDM_ORGANIZATION" ).append("\n"); 
		query.append("   WHERE 1=1" ).append("\n"); 
		query.append("     AND DELT_FLG = 'N'" ).append("\n"); 
		query.append(" CONNECT BY PRIOR PRNT_OFC_CD = OFC_CD" ).append("\n"); 
		query.append("   START WITH OFC_CD = @[login_ofc_cd]" ).append("\n"); 
		...
		query.append("   START WITH OFC_CD = @[login_ofc_cd]" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("WHERE OFC_CD NOT IN ('SELDC', 'SELHO')  " ).append("\n"); 
