...
*@FileName : EacMgtDBDAOEACPsonCfgVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOEACPsonCfgVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EacMgtDBDAOEACPsonCfgVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.eac.eacmgt.integration").append("\n"); 
		query.append("FileName : EacMgtDBDAOEACPsonCfgVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
