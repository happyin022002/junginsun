...
*@FileName : AsiaInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOMultiInlandCostSpecialCargoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AOC_CHN_INLND_SPCL_TRF_DTL" ).append("\n"); 
