...
*@FileName : SearchWriteOffInquiryVO.java
*@FileTitle : SearchWriteOffInquiryVO
*Open Issues :
*Change history :
...
public class SearchWriteOffInquiryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchWriteOffInquiryVO> models = new ArrayList<SearchWriteOffInquiryVO>();
	 ...
	 */
	public SearchWriteOffInquiryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchWriteOffInquiryVO[]
	 */
	public SearchWriteOffInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchWriteOffInquiryVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchWriteOffInquiryVO();
				if (sCurrCdTp[i] != null)
		...
		return getSearchWriteOffInquiryVOs();
	}
	...
	public SearchWriteOffInquiryVO[] getSearchWriteOffInquiryVOs(){
		SearchWriteOffInquiryVO[] vos = (SearchWriteOffInquiryVO[])models.toArray(new SearchWriteOffInquiryVO[models.size()]);
		return vos;
	}
