...
*@FileName : InlandCostManageDBDAOSearchInlandCostAccountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOSearchInlandCostAccountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOSearchInlandCostAccountRSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOSearchInlandCostAccountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", COA_GET_COM_NM_FNC('cost_act_grp_cd', A.COST_ACT_GRP_CD)                AS ACT_GRP" ).append("\n"); 
		...
		query.append(", COA_GET_COM_NM_FNC('coa_cost_src_cd', A.COA_COST_SRC_CD)                AS SRC_NM" ).append("\n"); 
		...
		query.append("FROM    TRS_INLND_COST_ACCT A" ).append("\n"); 
		query.append(", COA_STND_ACCT_V     V" ).append("\n"); 
