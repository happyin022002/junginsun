...
public class USA404EDIStatusInquiryDBDAOSearch03USA404EDIStatusSendRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("--               WHEN A.POD_NOD_CD = 'USLAXM4' AND                 " ).append("\n"); 
		query.append("--                 A.FM_NOD_CD != 'USLGBPT' THEN 'MTCLAX'        " ).append("\n"); 
		query.append("--             WHEN A.POL_NOD_CD = 'USLAXM4' AND                 " ).append("\n"); 
		query.append("--                 A.TO_NOD_CD != 'USLGBPT' THEN 'MTCLAX'        " ).append("\n"); 
		query.append("    ELSE    ''                                              " ).append("\n"); 
		...
		query.append("    ELSE    ''                                              " ).append("\n"); 
		query.append("    END     APP_MTCLA,    --CHM-201325385 [TRS] 404 EDI terminal setup" ).append("\n"); 
		...
		query.append("    SUBSTR(A.EQ_NO, 11, 1) EQCHK, (SELECT CNTR_SEAL_NO FROM BKG_CNTR_SEAL_NO WHERE BKG_NO = D.BKG_NO AND CNTR_NO = D.CNTR_NO AND CNTR_SEAL_SEQ = 1) SEALNO, " ).append("\n"); 
		...
		query.append("    LOC1.CNT_CD AS SHPR_CN," ).append("\n"); 
		...
		query.append("    TO_CHAR(A.WO_ISS_DT, 'YYYYMMDD') SNDDT_OLD, 'N' TYPE, " ).append("\n"); 
		...
		query.append("    R.PCK_GRP_VAL_CD DG_PGRP, P.PSA_NO DG_PSAGRP, P.MRN_POLUT_FLG DG_MP, P.FLSH_PNT_CDO_TEMP DG_FLSHTEMP, 'C' DG_FLSHUNIT, NVL(P.OUT_IMDG_PCK_QTY1,0) DG_QTY, P.OUT_IMDG_PCK_CD1 DG_QUNIT, NVL(P.GRS_WGT,0) DG_WEIGHT, " ).append("\n"); 
		query.append("    P.WGT_UT_CD DG_WUNIT, P.FLSH_PNT_CDO_TEMP DG_FLASHTEMP, P.EMER_CNTC_PHN_NO_CTNT DG_TEL, P.EMER_CNTC_PSON_NM DG_CONTACT, A.CRE_OFC_CD, " ).append("\n"); 
		query.append("    DGP.DCGO_SEQ DG_MAX_SEQ, O.BKG_NO DG_BKG_NO, A.EQ_NO DG_EQ_NO " ).append("\n"); 
