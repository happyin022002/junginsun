...
public class EsdSce0032EventResponse  extends EventResponseSupport  {
    ...
    private DBRowSet hanjinTpIdList = null;
    ...
    public EsdSce0032EventResponse(DBRowSet edi_customer_grp_list_
        ...
        this.hanjinTpIdList = hanjin_tp_id_list_;
    ...
    /**
     * @return Returns the hanjinTpIdList.
     */
    public DBRowSet getHanjin_tp_id_list() {
        return hanjinTpIdList;
    }
