...
*@FileName : InlandCostManageDBDAOsearchInlandCostTariffNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOsearchInlandCostTariffNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOsearchInlandCostTariffNoRSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOsearchInlandCostTariffNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
