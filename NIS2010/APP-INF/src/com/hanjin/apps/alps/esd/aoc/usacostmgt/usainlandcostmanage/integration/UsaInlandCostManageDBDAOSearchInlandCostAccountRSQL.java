...
*@FileName : UsaInlandCostManageDBDAOSearchInlandCostAccountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchInlandCostAccountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchInlandCostAccountRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOSearchInlandCostAccountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    AOC_USA_INLND_TRF_ACCT	A" ).append("\n"); 
