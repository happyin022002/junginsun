...
*@FileName : SearchOfcStatisticsVO.java
*@FileTitle : SearchOfcStatisticsVO
*Open Issues :
*Change history :
...
public class SearchOfcStatisticsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOfcStatisticsVO> models = new ArrayList<SearchOfcStatisticsVO>();
	...
	public SearchOfcStatisticsVO() {}

	public SearchOfcStatisticsVO(String ibflag, String pagerows, String audrOfcCd, String mBilUmchCnt, String mBilUmchAmt, String mRtDisUmchCnt, String mRtDisUmchAmt, String mDblBilUmchCnt, String mDblBilUmchAmt, String mNotAcctUmchCnt, String mNotAcctUmchAmt, String mLackEvidCnt, String mLackEvidAmt, String mOtrCnt, String mOtrAmt, String mSubTotCnt, String mSubTotAmt, String iBkgCnt, String iBkgAmt, String iWrkOrdCnt, String iWrkOrdAmt, String iOpCnt, String iOpAmt, String iCtrtCnt, String iCtrtAmt, String iSysCnt, String iSysAmt, String iOtrCnt, String iOtrAmt, String iSubTotCnt, String iSubTotAmt, String misTpbCnt, String misTpbAmt, String totCnt, String totAmt) {
...
/**
	 ...
	 */
	public SearchOfcStatisticsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOfcStatisticsVO[]
	 */
	public SearchOfcStatisticsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOfcStatisticsVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchOfcStatisticsVO();
				if (mOtrCnt[i] != null)
		...
		return getSearchOfcStatisticsVOs();
	}
	...
	public SearchOfcStatisticsVO[] getSearchOfcStatisticsVOs(){
		SearchOfcStatisticsVO[] vos = (SearchOfcStatisticsVO[])models.toArray(new SearchOfcStatisticsVO[models.size()]);
		return vos;
	}
