...
*@FileName : ESD_TRS_037Event.java
...
/**
 * ESD_TRS_037 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESD_TRS_037HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.6
 */
public class EsdTrs0037Event extends EventSupport {
	...
	public EsdTrs0037Event(){}

	/**
	 * @param apInvHdr
	 * @param paramMap
	 */
	public EsdTrs0037Event(AP_INV_HDR apInvHdr, HashMap paramMap) {
	 ...
	 * @param apInvHdrs
	 */
	public EsdTrs0037Event(AP_INV_HDR apInvHdr, Collection apInvHdrs) {
		this.apInvHdr = apInvHdr;
