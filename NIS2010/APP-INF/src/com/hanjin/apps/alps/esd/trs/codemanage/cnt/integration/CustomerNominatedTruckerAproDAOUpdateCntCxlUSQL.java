...
*@FileName : CustomerNominatedTruckerAproDAOUpdateCntCxlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOUpdateCntCxlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CNT(Customer Nominated Trucker) Approval - Cancel
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOUpdateCntCxlUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerAproDAOUpdateCntCxlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- 상태코드 UPDATE (Cancle)" ).append("\n"); 
		query.append("UPDATE TRS_CUST_NOMI_TRKR" ).append("\n"); 
		query.append("   SET DISP_STS_CD = '01'" ).append("\n"); 
		query.append("      ,CUST_NOMI_TRKR_RQST_DT = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[cre_ofc_cd]) -- Session Office Code" ).append("\n"); 
		query.append("      ,CUST_NOMI_TRKR_RJCT_DT = '' -- reset" ).append("\n"); 
		query.append("      ,CUST_NOMI_TRKR_APRO_DT = '' -- reset" ).append("\n"); 
