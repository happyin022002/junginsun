...
*@FileName : SearchActivityByConfirmedTPBVO.java
*@FileTitle : SearchActivityByConfirmedTPBVO
*Open Issues :
*Change history :
...
public class SearchActivityByConfirmedTPBVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchActivityByConfirmedTPBVO> models = new ArrayList<SearchActivityByConfirmedTPBVO>();
	...
	public SearchActivityByConfirmedTPBVO() {}

	public SearchActivityByConfirmedTPBVO(String ibflag, String pagerows, String sCurrCdTp, String sUserOfcCd, String sOfficeLevel, String sIfRhqCd, String sIfCtrlCd, String sEdate, String sSdate, String sIfOfcCd, String sOfcCdForRhq, String n3ptyNo, String n3ptyNoDpSeq, String rhq, String cfmOfcCd, String n3ptySrcSubSysCd, String n3ptyInvNo, String invIssDt, String n3ptySrcNo, String bkgNoAll, String blNoAll, String vvd, String eqNo, String n3ptyBilTpNm, String trdPartyCode, String trdPartyName, String cltActYn, String otsStsNm, String overdue, String otsAmt, String invAmt, String cltAmt, String stlAmt, String balAmt, String ifUsrId, String ifOfcCd, String n3ptyStlTpCd, String stlRqstOfcCd, String stlToCltCngOfcCd, String fmCltCngOfcN3ptyNo, String ednTpNm, String csrNo, String otsStsCd, String vndrCustDivCd, String currCd, String n3ptyBilTpCd, String cfmDt, String cfmMon, String soIfSeq, String creDt, String sIfType) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("cfm_mon", getCfmMon());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("cfm_mon", "cfmMon");
	 ...
	 * @param cfmMon
	 */
	public void setCfmMon(String cfmMon) {
		this.cfmMon = cfmMon;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCfmMon(JSPUtil.getParameter(request, prefix + "cfm_mon", ""));
	 ...
	 */
	public SearchActivityByConfirmedTPBVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchActivityByConfirmedTPBVO[]
	 */
	public SearchActivityByConfirmedTPBVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchActivityByConfirmedTPBVO model = null;
		...
		try {
			...
			String[] cfmMon = (JSPUtil.getParameter(request, prefix	+ "cfm_mon", length));
			...
			for (int i = 0; i < length; i++) {
				model = new SearchActivityByConfirmedTPBVO();
				if (sCurrCdTp[i] != null)
		...
		return getSearchActivityByConfirmedTPBVOs();
	}
	...
	public SearchActivityByConfirmedTPBVO[] getSearchActivityByConfirmedTPBVOs(){
		SearchActivityByConfirmedTPBVO[] vos = (SearchActivityByConfirmedTPBVO[])models.toArray(new SearchActivityByConfirmedTPBVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.cfmMon = this.cfmMon .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
