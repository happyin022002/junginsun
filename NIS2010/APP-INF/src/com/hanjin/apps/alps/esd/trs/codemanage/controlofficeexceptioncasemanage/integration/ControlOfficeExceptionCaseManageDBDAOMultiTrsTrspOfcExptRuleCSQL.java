...
*@FileName : ControlOfficeExceptionCaseManageDBDAOMultiTrsTrspOfcExptRuleCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ControlOfficeExceptionCaseManageDBDAOMultiTrsTrspOfcExptRuleCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ControlOfficeExceptionCaseManageDBDAOMultiTrsTrspOfcExptRuleCSQL(){
		setQuery();
		...
		query.append("FileName : ControlOfficeExceptionCaseManageDBDAOMultiTrsTrspOfcExptRuleCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_TRSP_OFC_EXPT_RULE (" ).append("\n"); 
