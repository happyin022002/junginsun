...
*@FileName : TerminalAgreementManageDBDAORegBeforeCheckThrpRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAORegBeforeCheckThrpRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAORegBeforeCheckThrpRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAORegBeforeCheckThrpRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND		THRP_LGS_COST_CD	= @[thrp_lgs_cost_cd]" ).append("\n"); 
