...
*@FileName : CandidateConfirmDBDAOSearchCheckTrdPartyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CandidateConfirmDBDAOSearchCheckTrdPartyRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Third Party Value Validation Check
	  * </pre>
	  */
	public CandidateConfirmDBDAOSearchCheckTrdPartyRSQL(){
		setQuery();
		...
		query.append("FileName : CandidateConfirmDBDAOSearchCheckTrdPartyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
