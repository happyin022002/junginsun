...
*@FileName : ESD_LEA_0016HTMLAction.java
...
public class ESD_LEA_0016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0016HTMLAction 객체를 생성
	 */
	public ESD_LEA_0016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0016Event event = new EsdLea0016Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchACBMInquiryVO((SearchACBMInquiryVO)getVO(request, SearchACBMInquiryVO .class));
		}
