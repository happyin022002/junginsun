...
*@FileName : SearchTPBModificationVO.java
*@FileTitle : SearchTPBModificationVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esd.tpb.processmanage.outstandinggroupmanage.vo;
...
public class SearchTPBModificationVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchTPBModificationVO> models = new ArrayList<SearchTPBModificationVO>();
	...
	public SearchTPBModificationVO() {}

	public SearchTPBModificationVO(String vslCd, String currCd, String eDate, String sTrdPartyVal, String fCmd, String otsDtlSeq, String sDate, String sN3ptyNoStrsLink, String sUserOfcCd, String sN3ptyNo, String ibflag, String editable, String blNo, String n3ptyBilTpNm, String pagerows, String n3ptyOfcCd, String vndrCustDivCd, String blNoChk, String n3ptyBilTpCd, String cfmAmt, String eqNo, String vvdCd, String n3ptyNo, String fincDirCd, String n3ptySrcNoVisible, String blNoTp, String sOfficeLevel, String blNoAll, String custCntCd, String skdVoyNo, String vndrSeq, String bkgNoAll, String bkgNoSplit, String sVndrCustDivCd, String custSeq, String sOfcCdForRhq, String n3ptyNoDpSeq, String bkgNo, String otsStsNm, String sRhqCdForRhq, String gVvd, String trdPartyVal, String n3ptySrcSubSysCd) {
		this.vslCd = vslCd;
		this.currCd = currCd;
		this.eDate = eDate;
	 ...
	 */
	public SearchTPBModificationVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchTPBModificationVO[]
	 */
	public SearchTPBModificationVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchTPBModificationVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchTPBModificationVO();
				if (vslCd[i] != null)
		...
		return getSearchTPBModificationVOs();
	}
	...
	public SearchTPBModificationVO[] getSearchTPBModificationVOs(){
		SearchTPBModificationVO[] vos = (SearchTPBModificationVO[])models.toArray(new SearchTPBModificationVO[models.size()]);
		return vos;
	}
