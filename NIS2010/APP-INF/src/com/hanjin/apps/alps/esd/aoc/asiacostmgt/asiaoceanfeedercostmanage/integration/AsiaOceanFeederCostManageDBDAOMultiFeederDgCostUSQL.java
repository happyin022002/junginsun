...
*@FileName : AsiaOceanFeederCostManageDBDAOMultiFeederDgCostUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOMultiFeederDgCostUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOMultiFeederDgCostUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOMultiFeederDgCostUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  AOC_CHN_FDR_DG_TRF_DTL" ).append("\n"); 
