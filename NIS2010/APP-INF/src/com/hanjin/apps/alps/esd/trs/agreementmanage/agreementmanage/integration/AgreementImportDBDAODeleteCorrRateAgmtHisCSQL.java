...
*@FileName : AgreementImportDBDAODeleteCorrRateAgmtHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAODeleteCorrRateAgmtHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rate Delete History 입력
	  * </pre>
	  */
	public AgreementImportDBDAODeleteCorrRateAgmtHisCSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAODeleteCorrRateAgmtHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",TRSP_AGMT_NOD_SEQ" ).append("\n"); 
		query.append(",TRSP_AGMT_RT_SEQ" ).append("\n"); 
		query.append(",TRS_AGMT_EQ_RT_SEQ1.NEXTVAL" ).append("\n"); 
		query.append(",TRSP_AGMT_EQ_TP_SZ_CD" ).append("\n"); 
		query.append(",EQ_KND_CD" ).append("\n"); 
		query.append(",WTR_RCV_TERM_CD" ).append("\n"); 
		query.append(",WTR_DE_TERM_CD" ).append("\n"); 
		...
		query.append(",@[fm_account_usr_id]" ).append("\n"); 
		query.append(",SYSDATE" ).append("\n"); 
		query.append("FROM TRS_AGMT_EQ_RT" ).append("\n"); 
