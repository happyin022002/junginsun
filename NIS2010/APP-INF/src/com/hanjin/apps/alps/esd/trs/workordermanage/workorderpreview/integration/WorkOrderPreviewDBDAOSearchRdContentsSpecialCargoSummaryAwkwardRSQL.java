...
*@FileName : WorkOrderPreviewDBDAOSearchRdContentsSpecialCargoSummaryAwkwardRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOSearchRdContentsSpecialCargoSummaryAwkwardRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchRdContentsSpecialCargoSummaryAwkward
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOSearchRdContentsSpecialCargoSummaryAwkwardRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOSearchRdContentsSpecialCargoSummaryAwkwardRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT row_id as awk_rnum" ).append("\n"); 
		...
		query.append(",awk.ovr_void_slt_no as awk_void" ).append("\n"); 
		...
		query.append(",rs_trsp_svc_ord so" ).append("\n"); 
		...
		query.append("AND awk.awk_cgo_seq = DECODE(SUBSTR(cntr.bkg_tro_no,2,1)" ).append("\n"); 
		...
		query.append(",'E',NVL(cntr.eq_no,'-STORMBOY-'),awk.cntr_no)" ).append("\n"); 
		query.append("AND NVL(cntr.spcl_cgo_cntr_tp_cd,'-STORMBOY-') = DECODE(SUBSTR(cntr.bkg_tro_no,2,1)" ).append("\n"); 
		query.append(",'E',NVL(cntr.spcl_cgo_cntr_tp_cd,'-STORMBOY-'),'AK')" ).append("\n"); 
