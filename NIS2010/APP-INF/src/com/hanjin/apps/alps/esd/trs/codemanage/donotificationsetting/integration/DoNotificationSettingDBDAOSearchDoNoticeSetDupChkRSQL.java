...
*@FileName : DoNotificationSettingDBDAOSearchDoNoticeSetDupChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DoNotificationSettingDBDAOSearchDoNoticeSetDupChkRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * D/O Notification Setting Duplication check
	  * </pre>
	  */
	public DoNotificationSettingDBDAOSearchDoNoticeSetDupChkRSQL(){
		setQuery();
		...
		query.append("FileName : DoNotificationSettingDBDAOSearchDoNoticeSetDupChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
