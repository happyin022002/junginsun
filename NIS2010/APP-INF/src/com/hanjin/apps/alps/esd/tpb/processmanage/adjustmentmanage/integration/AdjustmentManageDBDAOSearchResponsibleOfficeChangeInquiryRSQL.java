...
public class AdjustmentManageDBDAOSearchResponsibleOfficeChangeInquiryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("TPB_GET_N3PTY_BIL_TP_NM_FNC(D.N3PTY_BIL_TP_CD) AS N3PTY_BIL_TP_NM," ).append("\n"); 
		...
		query.append("TPB_GET_HNDL_OFC_FNC('R',A.STL_RQST_OFC_CD) AS IF_RHQ_CD," ).append("\n"); 
		query.append("A.STL_RQST_OFC_CD AS IF_OFC_CD," ).append("\n"); 
		...
		query.append("WHERE OFC_CD = @[s_user_ofc_cd] ) L" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
