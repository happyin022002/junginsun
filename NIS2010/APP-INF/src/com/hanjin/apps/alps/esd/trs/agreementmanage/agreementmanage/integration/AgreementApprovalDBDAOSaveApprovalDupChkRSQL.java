...
*@FileName : AgreementApprovalDBDAOSaveApprovalDupChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementApprovalDBDAOSaveApprovalDupChkRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRS Agreement Confirm 권한 중복 등록 체크
	  * </pre>
	  */
	public AgreementApprovalDBDAOSaveApprovalDupChkRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementApprovalDBDAOSaveApprovalDupChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  AND CFM_USR_ID = @[cfm_usr_id]" ).append("\n"); 
