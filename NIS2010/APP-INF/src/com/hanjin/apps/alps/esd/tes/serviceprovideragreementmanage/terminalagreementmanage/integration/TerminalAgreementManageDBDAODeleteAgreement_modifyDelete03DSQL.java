...
*@FileName : TerminalAgreementManageDBDAODeleteAgreement_modifyDelete03DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAODeleteAgreement_modifyDelete03DSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agmt DG CGO CLSS 정보 삭제
	  * </pre>
	  */
	public TerminalAgreementManageDBDAODeleteAgreement_modifyDelete03DSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAODeleteAgreement_modifyDelete03DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE TES_TML_AGMT_DG_CGO_CLSS" ).append("\n"); 
