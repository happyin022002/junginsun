...
*@FileName : FeederCostVO.java
*@FileTitle : FeederCostVO
*Open Issues :
*Change history :
...
public class FeederCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FeederCostVO> models = new ArrayList<FeederCostVO>();
...
/**
	 ...
	 * @return FeederCostVO[]
	 */
	public FeederCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FeederCostVO[]
	 */
	public FeederCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FeederCostVO model = null;
	...
	public FeederCostVO[] getFeederCostVOs(){
		FeederCostVO[] vos = (FeederCostVO[])models.toArray(new FeederCostVO[models.size()]);
		return vos;
	}
