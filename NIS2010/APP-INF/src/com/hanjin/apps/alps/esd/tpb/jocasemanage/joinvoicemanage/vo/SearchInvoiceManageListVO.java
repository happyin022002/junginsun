...
public class SearchInvoiceManageListVO {
	
	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInvoiceManageListVO> models = new ArrayList<SearchInvoiceManageListVO>();
	...
	public SearchInvoiceManageListVO() {}

	public SearchInvoiceManageListVO(String ibflag, String pagerows, String n3ptyOfcTpCd, String ofcCd, String sOfcCd, String rhqCd, String n3ptyCtrlOfcCd, String n3ptyOfcCd, String n3ptyArOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SearchInvoiceManageListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInvoiceManageListVO[]
	 */
	public SearchInvoiceManageListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInvoiceManageListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchInvoiceManageListVO();
				if (updDt[i] != null)
		...
		return getSearchInvoiceManageListVOs();
	}
	...
	public SearchInvoiceManageListVO[] getSearchInvoiceManageListVOs(){
		SearchInvoiceManageListVO[] vos = (SearchInvoiceManageListVO[])models.toArray(new SearchInvoiceManageListVO[models.size()]);
		return vos;
	}
