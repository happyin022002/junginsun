 ...
 *
 * @author 9014787
 * @see EsdTrs0939Event , ESD_TRS_0939EventResponse 참조
 * @since J2EE 1.4
 */
...
public class ESD_TRS_0939HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TRS_0939HTMLAction 객체를 생성
	 */
	public ESD_TRS_0939HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TRS_0939Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		String authAproRqstNo = request.getParameter("auth_apro_rqst_no");
		
		event.setAuthAproRqstNo(authAproRqstNo);
