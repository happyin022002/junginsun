...
public class EsdTpb0112Event extends EventSupport {
	...
	public SearchInvoiceStatusVO[] getSearchInvoiceStatusVOs() {
		...
		if (this.searchInvoiceStatusVOs != null) {
			rtnVOs = new SearchInvoiceStatusVO[searchInvoiceStatusVOs.length];
			System.arraycopy(searchInvoiceStatusVOs, 0, rtnVOs, 0, rtnVOs.length);
		}
		return rtnVOs;
	}
	...
	public void setSearchInvoiceStatusVOs(SearchInvoiceStatusVO[] searchInvoiceStatusVOs){
		if(searchInvoiceStatusVOs != null){
			SearchInvoiceStatusVO[] tmpVOs = new SearchInvoiceStatusVO[searchInvoiceStatusVOs.length];
			System.arraycopy(searchInvoiceStatusVOs, 0, tmpVOs, 0, tmpVOs.length);
