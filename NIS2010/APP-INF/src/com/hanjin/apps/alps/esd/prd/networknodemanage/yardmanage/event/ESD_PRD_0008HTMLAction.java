 ...
 *@FileName : ESD_PRD_003HTMLAction.java
 ...
 *
 * @author kimyoungchul
 * @see ESD_PRD_003Event , ESD_PRD_003EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_PRD_0008HTMLAction extends HTMLActionSupport{

	/**
	 * ESD_PRD_003HTMLAction 객체를 생성
	 */
	public ESD_PRD_0008HTMLAction(){
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 RnllwsTestEvent로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException{
		...
		EsdPrd0008Event event = new EsdPrd0008Event();
		event.setAttribute("pgmNo", request.getServletPath().substring(1,13));
		if(command.isCommand(FormCommand.SEARCH)){

			event.setSearchYardDwellHistoryVO((SearchYardDwellHistoryVO) getVO(request, SearchYardDwellHistoryVO.class));
		}
