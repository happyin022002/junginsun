...
*@FileName : ESD_AOC_3032_01HTMLAction.java
 ...
 *
 * @author 
 * @see EsdAoc3032Event 참조
 * @since J2EE 1.4
 */
public class ESD_AOC_3032HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_AOC_3032HTMLAction 객체를 생성
	 */
	public ESD_AOC_3032HTMLAction(){}
...
public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3032Event event = new EsdAoc3032Event();
