...
*@FileName : BiddingCandidateRegistrationDBDAOdelSpotBidCnddtTermUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BiddingCandidateRegistrationDBDAOdelSpotBidCnddtTermUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BiddingCandidateRegistrationDBDAOdelSpotBidCnddtTermUSQL(){
		setQuery();
		...
		query.append("FileName : BiddingCandidateRegistrationDBDAOdelSpotBidCnddtTermUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
