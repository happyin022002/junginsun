...
*@FileName : TESInterfaceManageDBDAOCreateEDInvoiceMNLCNTRTmpDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInterfaceManageDBDAOCreateEDInvoiceMNLCNTRTmpDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateEDInvoiceMNLCNTRTmpData
	  * </pre>
	  */
	public TESInterfaceManageDBDAOCreateEDInvoiceMNLCNTRTmpDataCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.common.tesinterface.integration ").append("\n"); 
		query.append("FileName : TESInterfaceManageDBDAOCreateEDInvoiceMNLCNTRTmpDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into TES_EDI_SO_MNL_CNTR_LIST" ).append("\n"); 
		query.append("(" ).append("\n"); 
