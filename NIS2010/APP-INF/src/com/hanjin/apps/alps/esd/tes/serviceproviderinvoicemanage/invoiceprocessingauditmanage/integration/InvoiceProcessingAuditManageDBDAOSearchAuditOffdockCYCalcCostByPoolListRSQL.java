...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByPoolListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByPoolListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * Off-dock AuditCalcCostByPoolList 조회
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByPoolListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByPoolListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
