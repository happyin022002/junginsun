...
*@FileName : CommodityGroupCodeManageDAOsearchMdmCommodityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityGroupCodeManageDBDAOSearchMdmCommodityRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CommodityGroupCodeManageDBDAOSearchMdmCommodityRSQL(){
		setQuery();
		...
		query.append("FileName : CommodityGroupCodeManageDAOsearchMdmCommodityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND B.rep_cmdt_cd = @[rep_cmdt_cd]" ).append("\n"); 
