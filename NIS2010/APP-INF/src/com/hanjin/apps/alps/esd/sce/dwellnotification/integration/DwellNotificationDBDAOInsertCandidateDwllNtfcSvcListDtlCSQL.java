...
*@FileName : DwellNotificationDBDAOInsertCandidateDwllNtfcSvcListDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DwellNotificationDBDAOInsertCandidateDwllNtfcSvcListDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InsertCandidateDwllNtfcSvcListDtl
	  * </pre>
	  */
	public DwellNotificationDBDAOInsertCandidateDwllNtfcSvcListDtlCSQL(){
		setQuery();
		...
		query.append("FileName : DwellNotificationDBDAOInsertCandidateDwllNtfcSvcListDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" SYSDATE," ).append("\n"); 
		query.append(" DECODE(@[snd_opt_cd_aw],'1','AW','OT')" ).append("\n"); 
		query.append(")" ).append("\n"); 
