...
*@FileName : CommodityGroupCodeManageDAOMultiPartCommodityUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityGroupCodeManageDBDAOMultiPartCommodityUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail VENDOR 별 GROUP COMMODITY를 재 정의하여 수정
	  * </pre>
	  */
	public CommodityGroupCodeManageDBDAOMultiPartCommodityUSQL(){
		setQuery();
		...
		query.append("FileName : CommodityGroupCodeManageDAOMultiPartCommodityUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
