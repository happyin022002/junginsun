...
public class SearchNonTPBListVO extends AbstractValueObject {
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("pso_ratio", getPsoRatio());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("pso_ratio", "psoRatio");
    ...
    public void setPsoRatio(String psoRatio) {
        this.psoRatio = psoRatio;
    }

    public String getPsoRatio() {
        return this.psoRatio;
    }
	...
	*/
    public void unDataFormat() {
        ...
        this.psoRatio = this.psoRatio.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
