...
public class OceanRouteManageDBDAOSearchOceanRouteDelListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT ORG_LOC_CD,DEST_LOC_CD,ROUT_SEQ,POL1,POD1,LANE1,DIR1,FDR_FLG1,SVC_TP1," ).append("\n"); 
		query.append("POL2,POD2,LANE2,DIR2,FDR_FLG2,SVC_TP2,POL3,POD3,LANE3,DIR3,FDR_FLG3,SVC_TP3," ).append("\n"); 
		query.append("POL4,POD4,LANE4,DIR4,FDR_FLG4,SVC_TP4,PRIO,RMK,TZTM_HRS,FMT_TZTM_HRS,N1ST_TZTM_HRS," ).append("\n"); 
		query.append("N2ND_TZTM_HRS,N3RD_TZTM_HRS,N4TH_TZTM_HRS,ST_HRS,FMT_ST_HRS,N1ST_STAY_TM_HRS," ).append("\n"); 
		query.append("N2ND_STAY_TM_HRS,N3RD_STAY_TM_HRS,TS_IND_CD,F_USED,POD1ETB,POL2ETB,POD2ETB," ).append("\n"); 
		query.append("POL3ETB,POD3ETB,POL4ETB,LNK_CNT,UPD_IND_CD,C_DATE,C_USER,U_DATE,U_USER,ORD,NO" ).append("\n"); 
		...
		query.append("       OCN_ROUT_PRIO_CD PRIO, OCN_ROUT_RMK RMK,  " ).append("\n"); 
