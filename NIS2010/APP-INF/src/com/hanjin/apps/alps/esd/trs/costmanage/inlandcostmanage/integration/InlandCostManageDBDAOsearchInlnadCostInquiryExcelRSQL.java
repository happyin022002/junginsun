...
*@FileName : InlandCostManageDBDAOsearchInlnadCostInquiryExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOsearchInlnadCostInquiryExcelRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOsearchInlnadCostInquiryExcelRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.costmanage.inlandcostmanage.integration ").append("\n"); 
		query.append("FileName : InlandCostManageDBDAOsearchInlnadCostInquiryExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
