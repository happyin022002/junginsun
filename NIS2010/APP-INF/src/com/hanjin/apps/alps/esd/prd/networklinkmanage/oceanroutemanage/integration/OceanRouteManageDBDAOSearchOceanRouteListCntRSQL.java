...
*@FileName : OceanRouteManageDBDAOSearchOceanRouteListCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteManageDBDAOSearchOceanRouteListCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OceanRouteManageDBDAOSearchOceanRouteListCntRSQL
	  * </pre>
	  */
	public OceanRouteManageDBDAOSearchOceanRouteListCntRSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteManageDBDAOSearchOceanRouteListCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
