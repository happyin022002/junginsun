...
*@FileName : EDISetupDBDAOHistoryEdiGrpCgoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EDISetupDBDAOHistoryEdiGrpCgoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * EDI_GRP_CGO 테이블에관한 history 값을 저장하는 sql (insert, update, delete)
	  * </pre>
	  */
	public EDISetupDBDAOHistoryEdiGrpCgoCSQL(){
		setQuery();
		...
		query.append("FileName : EDISetupDBDAOHistoryEdiGrpCgoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into edi_grp_cgo_his (			EDI_SND_HIS_SEQ" ).append("\n"); 
		...
		query.append("EDI_GRP_CGO_HIS_SEQ1.NEXTVAL," ).append("\n"); 
