...
*@FileName : WorkOrderInquiryDBDAOsearchWorkOrderInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderInquiryDBDAOsearchWorkOrderInquiryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchWorkOrderInquiry
	  * </pre>
	  */
	public WorkOrderInquiryDBDAOsearchWorkOrderInquiryRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.workordermanage.workorderinquiry.integration").append("\n"); 
		query.append("FileName : WorkOrderInquiryDBDAOsearchWorkOrderInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
