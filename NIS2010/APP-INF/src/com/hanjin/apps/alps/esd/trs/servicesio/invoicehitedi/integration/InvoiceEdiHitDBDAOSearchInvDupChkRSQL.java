...
*@FileName : InvoiceEdiHitDBDAOSearchInvDupChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceEdiHitDBDAOSearchInvDupChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceEdiHitDBDAOSearchInvDupChkRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceEdiHitDBDAOSearchInvDupChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CASE WHEN COUNT(A.INV_NO) = 0 THEN 'N'" ).append("\n"); 
		query.append("            ELSE 'Y'" ).append("\n"); 
		query.append("        END AS INV_DUP_FLG" ).append("\n"); 
