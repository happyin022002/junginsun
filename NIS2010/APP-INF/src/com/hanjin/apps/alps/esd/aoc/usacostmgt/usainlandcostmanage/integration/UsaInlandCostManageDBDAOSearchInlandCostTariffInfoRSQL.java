...
*@FileName : UsaInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("          FROM    AOC_USA_INLND_TRF_DTL" ).append("\n"); 
		query.append("          WHERE   1 = 1" ).append("\n"); 
		query.append("          AND     COST_TRF_NO = A.COST_TRF_NO" ).append("\n"); 
		query.append("          AND     TRK_40FT_BZC_COST_SRC_CD <> 'A'" ).append("\n"); 
		query.append("          AND     COST_SEL_ROUT_FLG = 'Y'" ).append("\n"); 
		query.append("          AND     DELT_FLG = 'N'" ).append("\n"); 
		query.append("        ) AVG_TRK_CNT" ).append("\n"); 
		query.append("      , (" ).append("\n"); 
		query.append("          SELECT  COUNT(1)" ).append("\n"); 
		query.append("          FROM    AOC_USA_INLND_TRF_DTL" ).append("\n"); 
		query.append("          WHERE   1 = 1" ).append("\n"); 
		query.append("          AND     COST_TRF_NO = A.COST_TRF_NO" ).append("\n"); 
		query.append("          AND     RAIL_40FT_BZC_COST_SRC_CD <> 'A'" ).append("\n"); 
		query.append("          AND     COST_SEL_ROUT_FLG = 'Y'" ).append("\n"); 
		query.append("          AND     DELT_FLG = 'N'" ).append("\n"); 
		query.append("        ) AVG_RAIL_CNT" ).append("\n"); 
		query.append("      , (" ).append("\n"); 
