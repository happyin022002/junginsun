...
*@FileName : OceanLinkManageDBDAOHistoryOcnAddCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanLinkManageDBDAOHistoryOcnAddCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanLinkManageDBDAOHistoryOcnAddCSQL(){
		setQuery();
		...
		query.append("FileName : OceanLinkManageDBDAOHistoryOcnAddCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
