...
*@FileName : Edi315SendDBDAOGetEdiSndRsvDtForVERSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Edi315SendDBDAOGetEdiSndRsvDtForVERSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Edi315SendDBDAOGetEdiSndRsvDtForVERSQL(){
		setQuery();
		...
		query.append("FileName : Edi315SendDBDAOGetEdiSndRsvDtForVERSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select  to_char(EDI_SND_RSV_DT, 'yyyymmddhh24miss') AS EDI_SND_RSV_DT" ).append("\n"); 
