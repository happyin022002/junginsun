...
*@FileName : CARIssueTransferSlipManageDBDAOCreateApInvDTRBCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CARIssueTransferSlipManageDBDAOCreateApInvDTRBCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CARIssueTransferSlipManageDBDAOCreateApInvDTRBCSQL(){
		setQuery();
		...
		query.append("FileName : CARIssueTransferSlipManageDBDAOCreateApInvDTRBCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[attr_ctnt15], @[bkg_no],  @[cntr_tpsz_cd], @[act_vvd_cd]," ).append("\n"); 
		query.append("@[pln_sctr_div_cd], @[so_crr_cd], @[yd_cd], @[ftu_use_ctnt1], @[ftu_use_ctnt2]," ).append("\n"); 
		query.append("@[ftu_use_ctnt3], @[ftu_use_ctnt4], @[ftu_use_ctnt5], SYSDATE, @[cre_usr_id]," ).append("\n"); 
		query.append("@[eai_evnt_dt]" ).append("\n"); 
		query.append(")" ).append("\n"); 
