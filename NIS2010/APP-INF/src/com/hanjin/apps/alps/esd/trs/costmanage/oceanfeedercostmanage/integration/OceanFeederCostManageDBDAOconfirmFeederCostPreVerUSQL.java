...
*@FileName : OceanFeederCostManageDBDAOconfirmFeederCostPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanFeederCostManageDBDAOconfirmFeederCostPreVerUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanFeederCostManageDBDAOconfirmFeederCostPreVerUSQL(){
		setQuery();
		...
		query.append("FileName : OceanFeederCostManageDBDAOconfirmFeederCostPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
