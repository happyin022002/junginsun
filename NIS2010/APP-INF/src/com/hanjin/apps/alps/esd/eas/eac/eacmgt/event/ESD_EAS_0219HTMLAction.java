...
*@FileName : ESD_EAS_0219HTMLAction.java
...
public class ESD_EAS_0219HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0219HTMLAction 객체를 생성
	 */
	public ESD_EAS_0219HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0219Event event = new EsdEas0219Event();
		
		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchRegRptVO((SearchRegRptVO)getVO(request, SearchRegRptVO.class));
		}
