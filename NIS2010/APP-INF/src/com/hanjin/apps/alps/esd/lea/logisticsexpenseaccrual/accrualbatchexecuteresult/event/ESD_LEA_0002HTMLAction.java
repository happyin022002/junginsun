...
*@FileName : ESD_LEA_002HTMLAction.java
 ...
 * @see EsdLea0002Event , ESD_LEA_002EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_LEA_0002HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_LEA_002HTMLAction 객체를 생성
	 */
	public ESD_LEA_0002HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_LEA_002Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */
		...
		EsdLea0002Event	event	= new EsdLea0002Event();
		...
		//ESD_LEA_0002.SEARCH (Retrieve:"TAB1") | SEARCH01 (Retrieve:"TAB2") ;; SHEARCH02 :sheet#2번 Loading TAB."Manual Input"
		...
		//ESD_LEA_0002.MODIFY "TAB.Result_By_Account_Code" (Button.Confirm)
		...
		//ESD_LEA_0002.COMMAND01 "TAB.Result_By_Account_Code" (Button.Send Mail)
