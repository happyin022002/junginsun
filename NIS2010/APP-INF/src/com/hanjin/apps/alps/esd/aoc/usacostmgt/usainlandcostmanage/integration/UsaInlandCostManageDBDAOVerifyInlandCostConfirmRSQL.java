...
*@FileName : UsaInlandCostManageDBDAOVerifyInlandCostConfirmRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOVerifyInlandCostConfirmRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOVerifyInlandCostConfirmRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOVerifyInlandCostConfirmRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
