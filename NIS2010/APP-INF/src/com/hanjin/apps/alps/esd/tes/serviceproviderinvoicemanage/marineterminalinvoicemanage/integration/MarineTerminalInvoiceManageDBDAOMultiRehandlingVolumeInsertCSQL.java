...
*@FileName : MarineTerminalInvoiceManageDBDAOMultiRehandlingVolumeInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOMultiRehandlingVolumeInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOMultiRehandlingVolumeInsertCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOMultiRehandlingVolumeInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
