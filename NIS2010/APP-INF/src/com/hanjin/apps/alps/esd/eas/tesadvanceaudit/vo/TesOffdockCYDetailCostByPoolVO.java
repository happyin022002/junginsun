...
*@FileName : TesOffdockCYDetailCostByPoolVO.java
*@FileTitle : TesOffdockCYDetailCostByPoolVO
*Open Issues :
*Change history :
...
public class TesOffdockCYDetailCostByPoolVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesOffdockCYDetailCostByPoolVO> models = new ArrayList<TesOffdockCYDetailCostByPoolVO>();
	...
	public TesOffdockCYDetailCostByPoolVO() {}

	public TesOffdockCYDetailCostByPoolVO(String ibflag, String pagerows, String calcTpCd, String lgsCostCd, String lgsCostFullNm, String fpCalcPrdCd, String prdYm, String wrkDt, String stkVolQty, String invVolQty, String diffVolQty, String fpTeuQty, String ovrVolQty, String volTrUtCd, String ctrtRt, String currCd, String invXchRt, String invAmt, String calcAmt, String calcRmk, String invOfcCd, String invNo, String ydCd, String vndrSeq, String ydNm, String vndrNm, String invCfmDt, String fmPrdDt, String toPrdDt, String tmlInvTpCd, String tmlCalcIndCd, String stoDysIndCd, String calcCostGrpCd, String tmlAgmtOfcCtyCd, String tmlAgmtSeq, String tmlAgmtVerNo, String agmtNo, String agmtVerNo, String totVol, String totAmt, String avgRt, String estmVol, String estmAmt, String exceedAvgFlg, String eacFlg, String expnAudSeq) {
		this.totAmt = totAmt;
		this.currCd = currCd;
...
/**
	 ...
	 * @param request
	 * @return TesOffdockCYDetailCostByPoolVO[]
	 */
	public TesOffdockCYDetailCostByPoolVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesOffdockCYDetailCostByPoolVO[]
	 */
	public TesOffdockCYDetailCostByPoolVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesOffdockCYDetailCostByPoolVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesOffdockCYDetailCostByPoolVO();
				if (totAmt[i] != null)
		...
		return getTesOffdockCYDetailCostByPoolVOs();
	}
	 ...
	 * @return TesOffdockCYDetailCostByPoolVO[]
	 */
	public TesOffdockCYDetailCostByPoolVO[] getTesOffdockCYDetailCostByPoolVOs(){
		TesOffdockCYDetailCostByPoolVO[] vos = (TesOffdockCYDetailCostByPoolVO[])models.toArray(new TesOffdockCYDetailCostByPoolVO[models.size()]);
		return vos;
	}
