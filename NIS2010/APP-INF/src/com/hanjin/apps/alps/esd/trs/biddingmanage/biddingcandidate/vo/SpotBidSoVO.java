...
*@FileName : SpotBidSoVO.java
*@FileTitle : SpotBidSoVO
*Open Issues :
*Change history :
...
public class SpotBidSoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpotBidSoVO> models = new ArrayList<SpotBidSoVO>();
	...
	public SpotBidSoVO(String ibflag, String pagerows, String chk, String trspSoOfcCtyCd, String trspSoSeq, String spotBidFlg, String spotBidDueDt, String spotBidDueDtHms, String trspCrrModCd, String fmNodCd, String viaNodCd, String dorNodCd, String toNodCd) {
...
/**
	 ...
	 * @return SpotBidSoVO[]
	 */
	public SpotBidSoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpotBidSoVO[]
	 */
	public SpotBidSoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpotBidSoVO model = null;
	...
	public SpotBidSoVO[] getSpotBidSoVOs(){
		SpotBidSoVO[] vos = (SpotBidSoVO[])models.toArray(new SpotBidSoVO[models.size()]);
		return vos;
	}
