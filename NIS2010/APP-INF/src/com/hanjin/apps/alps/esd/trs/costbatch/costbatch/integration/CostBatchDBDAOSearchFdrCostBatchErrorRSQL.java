...
*@FileName : CostBatchDBDAOSearchFdrCostBatchErrorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CostBatchDBDAOSearchFdrCostBatchErrorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CostBatchDBDAOSearchFdrCostBatchErrorRSQL(){
		setQuery();
		...
		query.append("FileName : CostBatchDBDAOSearchFdrCostBatchErrorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    TRS_FDR_COST_TRF" ).append("\n"); 
