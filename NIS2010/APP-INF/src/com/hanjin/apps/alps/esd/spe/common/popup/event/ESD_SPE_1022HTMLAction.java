...
*@FileName : ESD_SPE_1022HTMLAction.java
*@FileTitle : S/P Help
*Open Issues :
*Change history :
...
public class ESD_SPE_1022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SPE_1022HTMLAction 객체를 생성
	 */
	public ESD_SPE_1022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSpe1022Event event = new EsdSpe1022Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSpePopupVO((SpePopupVO)getVO(request, SpePopupVO .class));
		}
