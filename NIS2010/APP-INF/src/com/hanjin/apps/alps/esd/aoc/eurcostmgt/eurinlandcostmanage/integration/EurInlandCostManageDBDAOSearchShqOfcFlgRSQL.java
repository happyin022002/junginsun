...
*@FileName : EurInlandCostManageDBDAOSearchShqOfcFlgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchShqOfcFlgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchShqOfcFlgRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchShqOfcFlgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
