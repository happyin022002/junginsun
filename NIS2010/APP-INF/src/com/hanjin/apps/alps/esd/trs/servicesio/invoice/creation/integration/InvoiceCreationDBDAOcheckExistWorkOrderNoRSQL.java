...
*@FileName : InvoiceCreationDBDAOcheckExistWorkOrderNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceCreationDBDAOcheckExistWorkOrderNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice Modify 시 WorkOrder Number 존재여부 체크
	  * </pre>
	  */
	public InvoiceCreationDBDAOcheckExistWorkOrderNoRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceCreationDBDAOcheckExistWorkOrderNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHEN WO_VNDR_SEQ != @[VNDR_SEQ]  THEN '1'" ).append("\n"); 
		query.append("#elseif ($sp_cd.size() > 1)" ).append("\n"); 
		query.append("WHEN (1,WO_VNDR_SEQ) NOT IN (" ).append("\n"); 
