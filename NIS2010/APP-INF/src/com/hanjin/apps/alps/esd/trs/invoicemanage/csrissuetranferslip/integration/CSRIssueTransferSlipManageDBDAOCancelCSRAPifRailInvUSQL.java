...
*@FileName : CSRIssueTransferSlipManageDBDAOCancelCSRAPifRailInvUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSRIssueTransferSlipManageDBDAOCancelCSRAPifRailInvUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CSR cancel시 TRS_TRSP_RAIL_INV_WRK update(Disapproved 건의 취소)
	  * </pre>
	  */
	public CSRIssueTransferSlipManageDBDAOCancelCSRAPifRailInvUSQL(){
		setQuery();
		...
		query.append("FileName : CSRIssueTransferSlipManageDBDAOCancelCSRAPifRailInvUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
