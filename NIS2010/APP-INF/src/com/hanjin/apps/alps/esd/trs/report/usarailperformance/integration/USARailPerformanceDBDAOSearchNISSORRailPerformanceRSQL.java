...
*@FileName : USARailPerformanceDBDAOSearchNISSORRailPerformanceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchNISSORRailPerformanceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchNISSORRailPerformance SELECT
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchNISSORRailPerformanceRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchNISSORRailPerformanceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    	   A.ROUT_ORG_YD_CD FM_NOD_CD," ).append("\n"); 
		query.append("   		   A.ROUT_DEST_YD_CD TO_NOD_CD," ).append("\n"); 
		...
		query.append("           SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '2', 1, 0) /YY2.VNDR_NO                    )  CNTR_20_CNT," ).append("\n"); 
		...
		query.append("    	   " ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '4', 1, 0) /YY2.VNDR_NO                    )  CNTR_40_CNT," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("		   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '5', 1, 0) /YY2.VNDR_NO                    )  CNTR_40HC_CNT," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("    	   SUM(DECODE(F.CNTR_TPSZ_CD, 'D7', 1, 0) /YY2.VNDR_NO                              )   CNTR_45_CNT," ).append("\n"); 
		...
		query.append("       , (SELECT TRSP_SO_OFC_CTY_CD,TRSP_SO_SEQ, COUNT(SUB_RAIL_SEQ) VNDR_NO FROM DOM_RAIL_SO_DTL GROUP BY TRSP_SO_OFC_CTY_CD, TRSP_SO_SEQ) YY2" ).append("\n"); 
		...
		query.append("    AND   A.TRSP_SO_OFC_CTY_CD  = YY2.TRSP_SO_OFC_CTY_CD" ).append("\n"); 
		query.append("    AND   A.TRSP_SO_SEQ         = YY2.TRSP_SO_SEQ" ).append("\n"); 
		...
		query.append("      AND   A.ROUT_ORG_YD_CD = @[input_fm_node]" ).append("\n"); 
		query.append("#elseif (${fm_node_length} == '5')" ).append("\n"); 
		query.append("      AND   A.ROUT_ORG_YD_CD LIKE @[input_fm_node] || '%'" ).append("\n"); 
		query.append("#elseif (${fm_node_length} != '0')" ).append("\n"); 
		query.append("      AND   A.ROUT_ORG_YD_CD LIKE @[input_fm_node] || '%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${to_node_length} == '7')" ).append("\n"); 
		query.append("	  AND   A.ROUT_DEST_YD_CD = @[input_to_node]" ).append("\n"); 
		query.append("#elseif (${to_node_length} == '5')" ).append("\n"); 
		query.append("	  AND   A.ROUT_DEST_YD_CD LIKE @[input_to_node] || '%'" ).append("\n"); 
		...
		query.append("    		A.ROUT_ORG_YD_CD," ).append("\n"); 
		query.append("    		A.ROUT_DEST_YD_CD," ).append("\n"); 
		query.append("    		LOCTO.LOC_CD," ).append("\n"); 
		query.append("    		LOCTO.EQ_CTRL_OFC_CD," ).append("\n"); 
		query.append("    		LOCFM.LOC_CD," ).append("\n"); 
		query.append("    		LOCFM.EQ_CTRL_OFC_CD" ).append("\n"); 
