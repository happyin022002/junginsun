CREATE OR REPLACE PROCEDURE SCE_EDI_IF_DEL_PRC(NAME IN  CHAR )
AUTHID CURRENT_USER
IS
...
LOOP
    ...
    DELETE  FROM SCE_EDI_IF WHERE  CRE_DT < TO_DATE('20080101', 'YYYYMMDD')  AND ROWNUM <= 10000 ;
