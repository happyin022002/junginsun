...
*@FileName : ESD_TRS_0251HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * - SpecialCargoQuotationManageSC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 * @author 이혜민
 * @see EsdTrs0251Event 참조
 * @since J2EE 1.6
 */

public class ESD_TRS_0251HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_0251HTMLAction 객체를 생성
	 */
	public ESD_TRS_0251HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0251Event event = new EsdTrs0251Event();
