...
*@FileName : CreditSmmrSrcVO.java
*@FileTitle : CreditSmmrSrcVO
*Open Issues :
*Change history :
...
public class CreditSmmrSrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CreditSmmrSrcVO> models = new ArrayList<CreditSmmrSrcVO>();
	...
	public CreditSmmrSrcVO() {}

	public CreditSmmrSrcVO(String ibflag, String pagerows, String crSrc, String rhqCd, String ofcCd, String estmAmt, String rcvAmt, String balAmt) {
		this.balAmt = balAmt;
		this.ofcCd = ofcCd;
		this.rcvAmt = rcvAmt;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return CreditSmmrSrcVO[]
	 */
	public CreditSmmrSrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreditSmmrSrcVO[]
	 */
	public CreditSmmrSrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CreditSmmrSrcVO model = null;
	 ...
	 * @return CreditSmmrSrcVO[]
	 */
	public CreditSmmrSrcVO[] getCreditSmmrSrcVOs(){
		CreditSmmrSrcVO[] vos = (CreditSmmrSrcVO[])models.toArray(new CreditSmmrSrcVO[models.size()]);
		return vos;
	}
