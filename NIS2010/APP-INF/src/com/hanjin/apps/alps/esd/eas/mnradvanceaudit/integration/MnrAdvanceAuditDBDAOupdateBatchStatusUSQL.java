...
*@FileName : MnrAdvanceAuditDBDAOupdateBatchStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MnrAdvanceAuditDBDAOupdateBatchStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MnrAdvanceAuditDBDAOupdateBatchStatusUSQL(){
		setQuery();
		...
		query.append("FileName : MnrAdvanceAuditDBDAOupdateBatchStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
