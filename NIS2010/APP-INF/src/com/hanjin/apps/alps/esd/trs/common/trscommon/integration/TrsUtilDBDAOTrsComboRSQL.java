...
*@FileName : TrsUtilDBDAOTrsComboRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsUtilDBDAOTrsComboRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TrsUtilDBDAOTrsCombo
	  * </pre>
	  */
	public TrsUtilDBDAOTrsComboRSQL(){
		setQuery();
		...
		query.append("FileName : TrsUtilDBDAOTrsComboRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
