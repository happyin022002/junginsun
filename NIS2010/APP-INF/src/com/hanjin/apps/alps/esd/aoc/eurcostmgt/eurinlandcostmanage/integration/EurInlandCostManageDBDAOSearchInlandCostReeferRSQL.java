...
*@FileName : EurInlandCostManageDBDAOSearchInlandCostReeferRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlandCostReeferRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2012.10.08 변종건 [CHM-201220395] Add-on Tariff Management 개선 프로젝트 - Reefer 조회
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlandCostReeferRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlandCostReeferRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", DECODE(D.INLND_ROUT_CMB_FLG,'N',D.N1ST_VNDR_20FT_AGMT_WGT,GREATEST(D.N1ST_VNDR_20FT_AGMT_WGT, D.N2ND_VNDR_20FT_AGMT_WGT)) AGMT_WGT_20FT" ).append("\n"); 
		...
		query.append(", R.COST_TRF_RF_SEQ" ).append("\n"); 
