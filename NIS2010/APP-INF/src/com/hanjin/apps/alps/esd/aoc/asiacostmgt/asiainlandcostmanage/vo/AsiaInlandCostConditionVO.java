...
*@FileName : AsiaInlandCostConditionVO.java
*@FileTitle : AsiaInlandCostConditionVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaInlandCostConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaInlandCostConditionVO> models = new ArrayList<AsiaInlandCostConditionVO>();
...
/**
	 ...
	 */
	public AsiaInlandCostConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaInlandCostConditionVO[]
	 */
	public AsiaInlandCostConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaInlandCostConditionVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AsiaInlandCostConditionVO();
				if (fromDt[i] != null)
	 ...
	 * @return AsiaInlandCostConditionVO[]
	 */
	public AsiaInlandCostConditionVO[] getInlandCostConditionVOs(){
		AsiaInlandCostConditionVO[] vos = (AsiaInlandCostConditionVO[])models.toArray(new AsiaInlandCostConditionVO[models.size()]);
		return vos;
	}
