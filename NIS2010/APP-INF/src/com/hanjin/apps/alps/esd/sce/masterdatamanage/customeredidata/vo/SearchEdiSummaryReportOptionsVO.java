...
public class SearchEdiSummaryReportOptionsVO extends AbstractValueObject {
	...
	/* Column Info */
	private String missingType = null;
	/* Column Info */
	private String etdEta = null;
	/* Column Info */
	private String ediCtrlNo = null;
	...
	public SearchEdiSummaryReportOptionsVO(String ibflag, String pagerows, String userId, String csGrpId, String ediGrpCd, String tpId, String ediSts, String trsMode, String custCd, String vvd, String por, String pol, String pod, String del, String bkgNo, String blNo, String cntrNo, String copStatus, String poletddate1, String poletddate2, String podetadate1, String podetadate2, String poletddate1Hidden, String poletddate2Hidden, String podetadate1Hidden, String podetadate2Hidden, String iPage, String vStartpart, String vEndpart
			                               ,String fmDt ,String toDt ,String missingType ,String etdEta, String ediCtrlNo) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("missing_type", getMissingType());
		this.hashColumns.put("etd_eta", getEtdEta());
		this.hashColumns.put("edi_ctrl_no", getEdiCtrlNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("missing_type", "missingType");
		this.hashFields.put("etd_eta", "etdEta");
		this.hashFields.put("edi_ctrl_no", "ediCtrlNo");
	...
	/**
	 * @param missingType the missingType to set
	 */
	...
	/**
	 * @param etdEta the etdEta to set
	 */
	 ...
	 * @return ediCtrlNo
	 */
	public String getEdiCtrlNo() {
		return this.ediCtrlNo;
	}
	
	/**
	 * @param ediCtrlNo the ediCtrlNo to set
	 */
	public void setEdiCtrlNo(String ediCtrlNo) {
		this.ediCtrlNo = ediCtrlNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMissingType(JSPUtil.getParameter(request, "missing_type", ""));
		setEtdEta(JSPUtil.getParameter(request, "etd_eta", ""));
		setEdiCtrlNo(JSPUtil.getParameter(request, "edi_ctrl_no", ""));
	}
	...
	public SearchEdiSummaryReportOptionsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] missingType = (JSPUtil.getParameter(request, prefix	+ "missing_type", length));
			String[] etdEta = (JSPUtil.getParameter(request, prefix	+ "etd_eta", length));
			String[] ediCtrlNo = (JSPUtil.getParameter(request, prefix	+ "edi_ctrl_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (missingType[i] != null)
					model.setMissingType(missingType[i]);
				if (etdEta[i] != null)
					model.setEtdEta(etdEta[i]);
				if (ediCtrlNo[i] != null)
					model.setEdiCtrlNo(ediCtrlNo[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.missingType = this.missingType .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.etdEta = this.etdEta .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ediCtrlNo = this.ediCtrlNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
