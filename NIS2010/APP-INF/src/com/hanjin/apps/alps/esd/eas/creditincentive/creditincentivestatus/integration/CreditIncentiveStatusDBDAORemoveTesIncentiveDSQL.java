...
*@FileName : CreditIncentiveStatusDBDAORemoveTesIncentiveDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAORemoveTesIncentiveDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TES Incentive Delete
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAORemoveTesIncentiveDSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAORemoveTesIncentiveDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EAS_TML_INCNT" ).append("\n"); 
