 ...
 * @since J2EE 1.6
 */
public class ESD_TRS_3020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TRS_3020HTMLAction 객체를 생성
	 */
	public ESD_TRS_3020HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs3020Event event = new EsdTrs3020Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchInlandCostBatchErrorVO((SearchInlandCostBatchErrorVO)getVO(request, SearchInlandCostBatchErrorVO .class));
		}
