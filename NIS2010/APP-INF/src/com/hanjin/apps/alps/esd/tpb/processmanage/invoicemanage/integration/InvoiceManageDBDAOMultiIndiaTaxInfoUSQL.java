...
public class InvoiceManageDBDAOMultiIndiaTaxInfoUSQL implements ISQLTemplate{
	...
	public InvoiceManageDBDAOMultiIndiaTaxInfoUSQL(){
		...
		params.put("n2nd_locl_tax_rt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("locl_tax_rt",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("        ,locl_tax_rt  = @[locl_tax_rt]" ).append("\n"); 
		query.append("        ,n2nd_locl_tax_rt  = @[n2nd_locl_tax_rt]" ).append("\n"); 
