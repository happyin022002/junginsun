...
*@FileName : BiddingCandidateDBDAOInsertSpotBidVndrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BiddingCandidateDBDAOInsertSpotBidVndrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Spot Bidding Invitation Vendor data insert
	  * </pre>
	  */
	public BiddingCandidateDBDAOInsertSpotBidVndrCSQL(){
		setQuery();
		...
		query.append("FileName : BiddingCandidateDBDAOInsertSpotBidVndrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_SPOT_BID_VNDR(" ).append("\n"); 
