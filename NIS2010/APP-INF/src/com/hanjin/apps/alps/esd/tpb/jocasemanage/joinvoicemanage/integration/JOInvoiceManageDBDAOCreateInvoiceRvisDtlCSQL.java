...
*@FileName : JOInvoiceManageDBDAOCreateInvoiceRvisDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOCreateInvoiceRvisDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateInvoiceRvisDtl
	  * </pre>
	  */
	public JOInvoiceManageDBDAOCreateInvoiceRvisDtlCSQL(){
		setQuery();
		...
		params.put("cita_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("last_free_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("occr_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("estm_svr_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("n3pty_cntr_wgt_ut_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("lod_id",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("new_eq_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("vat_dtl_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("new_cntr_seal_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("inv_dtl_add_amt",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tpb.jocasemanage.joinvoicemanage.integration").append("\n"); 
		query.append("FileName : JOInvoiceManageDBDAOCreateInvoiceRvisDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_INV_CRE_PKG.CRE_INV_RVIS_DTL(" ).append("\n"); 
