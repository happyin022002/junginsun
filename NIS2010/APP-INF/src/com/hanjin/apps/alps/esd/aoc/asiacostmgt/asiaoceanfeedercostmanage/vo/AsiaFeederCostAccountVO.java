...
*@FileName : AsiaFeederCostAccountVO.java
*@FileTitle : AsiaFeederCostAccountVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaFeederCostAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaFeederCostAccountVO> models = new ArrayList<AsiaFeederCostAccountVO>();
...
/**
	 ...
	 */
	public AsiaFeederCostAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaFeederCostAccountVO[]
	 */
	public AsiaFeederCostAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaFeederCostAccountVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AsiaFeederCostAccountVO();
	...
	public AsiaFeederCostAccountVO[] getSearchOceanFeederCostAccountVOs(){
		AsiaFeederCostAccountVO[] vos = (AsiaFeederCostAccountVO[])models.toArray(new AsiaFeederCostAccountVO[models.size()]);
		return vos;
	}
