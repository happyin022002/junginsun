...
*@FileName : EacMgtDBDAOSelectAutoAudFileAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOSelectAutoAudFileAllRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EacMgtDBDAOSelectAutoAudFileAllRSQL(){
		setQuery();
		...
		query.append("FileName : EacMgtDBDAOSelectAutoAudFileAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
