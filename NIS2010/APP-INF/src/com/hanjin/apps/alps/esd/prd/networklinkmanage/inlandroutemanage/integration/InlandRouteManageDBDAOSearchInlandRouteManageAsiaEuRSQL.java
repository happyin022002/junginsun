...
public class InlandRouteManageDBDAOSearchInlandRouteManageAsiaEuRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                ,cre_usr_id,cre_ofc_cd,cre_dt ,inlnd_rout_rmk" ).append("\n"); 
		query.append("                ,UPD_USR_ID, UPD_DT --JSY" ).append("\n"); 
		query.append("                ,INLND_ROUT_OPTM_FLG" ).append("\n"); 
		query.append("                , LNK_KNT" ).append("\n"); 
		query.append("                , INLND_TMNL_SHTL_FLG, ALTN_OPTM_FLG" ).append("\n"); 
		query.append("           FROM (" ).append("\n"); 
		...
		query.append("              ,INLND_ROUT_OPTM_FLG,ALTN_OPTM_FLG" ).append("\n"); 
		query.append("                 FROM (" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                       SELECT rout_org_nod_cd, rout_dest_nod_cd, rout_seq, prio_seq,INLND_ROUT_BKG_FLG ,INLND_ROUT_TMP_FLG,INLND_ROUT_INCL_STTL_FLG," ).append("\n"); 
		...
		query.append("                              ,INLND_ROUT_OPTM_FLG, INLND_TMNL_SHTL_FLG,ALTN_OPTM_FLG" ).append("\n"); 
		query.append("                         FROM (" ).append("\n"); 
		...
		query.append("                                          AND FNOD.NOD_TP_CD != 'Z' AND TNOD.NOD_TP_CD != 'Z' " ).append("\n"); 
		...
		query.append("                             AND FNOD.NOD_CD = M.ROUT_ORG_NOD_CD" ).append("\n"); 
		query.append("                             AND TNOD.NOD_CD = M.ROUT_DEST_NOD_CD" ).append("\n"); 
		query.append("                             AND M.PCTL_IO_BND_CD = @[r_inbound]" ).append("\n"); 
		query.append("#if(${r_inbound} == 'I')" ).append("\n"); 
		query.append("                             AND FNOD.NOD_TP_CD IN ( 'M','B' )" ).append("\n"); 
		query.append("                             AND 1 = CASE WHEN @[nod_tp_cd1] = 'Z' THEN DECODE(TNOD.NOD_TP_CD, 'Z', 1, 0)" ).append("\n"); 
		query.append("                                          ELSE DECODE(TNOD.NOD_TP_CD, 'Z', 0, 1)" ).append("\n"); 
		query.append("                                          END" ).append("\n"); 
		query.append("#elseif(${r_inbound} == 'O')" ).append("\n"); 
		query.append("                             AND 1 = CASE WHEN @[nod_tp_cd1] = 'Z' THEN DECODE(FNOD.NOD_TP_CD, 'Z', 1, 0)" ).append("\n"); 
		query.append("                                          ELSE DECODE(FNOD.NOD_TP_CD, 'Z', 0, 1)" ).append("\n"); 
		query.append("                                          END" ).append("\n"); 
		query.append("                             AND TNOD.NOD_TP_CD IN ( 'M','B' )" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		...
		query.append("                 GROUP BY m.rout_org_nod_cd, m.rout_dest_nod_cd, m.rout_seq, m.prio_seq,sum_tt_time,INLND_ROUT_BKG_FLG," ).append("\n"); 
		query.append("                          INLND_ROUT_TMP_FLG,m.INLND_ROUT_INCL_STTL_FLG, M.INLND_ROUT_OPTM_FLG,M.ALTN_OPTM_FLG" ).append("\n"); 
