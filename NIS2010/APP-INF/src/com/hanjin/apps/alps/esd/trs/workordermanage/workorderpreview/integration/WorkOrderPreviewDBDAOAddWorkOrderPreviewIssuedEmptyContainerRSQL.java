...
*@FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedEmptyContainerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedEmptyContainerRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddWorkOrderPreviewIssuedEmptyContainer
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedEmptyContainerRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewIssuedEmptyContainerRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" 	, (							" ).append("\n"); 
		query.append(" 		SELECT 						" ).append("\n"); 
		query.append(" 		ROUND((TO_NUMBER(				" ).append("\n"); 
		query.append("			NVL(B.BZC_AMT, 0) + 			" ).append("\n"); 
		query.append("			NVL(B.ETC_ADD_AMT, 0) + 			" ).append("\n"); 
		query.append("			NVL(B.FUEL_SCG_AMT, 0) +" ).append("\n"); 
		query.append("			NVL(B.SCG_VAT_AMT, 0) + 		" ).append("\n"); 
		query.append("			NVL(B.NEGO_AMT, 0)	+" ).append("\n"); 
		query.append("			NVL(B.TOLL_FEE_AMT, 0)			" ).append("\n"); 
