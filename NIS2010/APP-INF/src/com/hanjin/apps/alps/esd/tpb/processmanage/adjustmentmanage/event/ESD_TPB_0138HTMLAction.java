...
*@FileName : ESD_TPB_0138HTMLAction.java
...
public class ESD_TPB_0138HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0138HTMLAction 객체를 생성
	 */
	public ESD_TPB_0138HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTpb0138Event event = new EsdTpb0138Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchWriteOffReviewVOS((SearchWriteOffReviewVO[])getVOs(request, SearchWriteOffReviewVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchWriteOffReviewVO((SearchWriteOffReviewVO)getVO(request, SearchWriteOffReviewVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCHLIST)) {
			event.setSearchWriteOffInquiryReviewVO((SearchWriteOffInquiryReviewVO)getVO(request, SearchWriteOffInquiryReviewVO .class));
		}
