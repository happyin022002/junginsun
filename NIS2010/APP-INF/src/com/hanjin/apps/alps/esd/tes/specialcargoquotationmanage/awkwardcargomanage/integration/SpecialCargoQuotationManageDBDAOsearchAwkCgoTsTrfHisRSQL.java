...
*@FileName : SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfHisRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfHisRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchAwkCgoTsTrfHis
	  * </pre>
	  */
	public SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfHisRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoQuotationManageDBDAOsearchAwkCgoTsTrfHisRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("ORDER BY T.PORT_CD, T.TML_CD, T.TML_AWK_CGO_TRF_TP_CD, T.IO_BND_CD, T.IO_GA_CD, T.TML_AWK_TS_CD, T.COND_NO, T.TML_AWK_TRF_VER_NO DESC" ).append("\n"); 
