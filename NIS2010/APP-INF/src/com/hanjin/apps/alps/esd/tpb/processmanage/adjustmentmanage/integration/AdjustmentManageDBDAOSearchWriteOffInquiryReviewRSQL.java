...
*@FileName : AdjustmentManageDBDAOSearchWriteOffInquiryReviewRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AdjustmentManageDBDAOSearchWriteOffInquiryReviewRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AdjustmentManageDBDAOSearchWriteOffInquiryReviewRSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentManageDBDAOSearchWriteOffInquiryReviewRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                WHERE 1=1" ).append("\n"); 
		query.append("                                 -- 조직코드변경 SELCON, SELCOE" ).append("\n"); 
		query.append("                               #if (${s_user_ofc_cd} == 'SELOPA' || ${s_user_ofc_cd} == 'SELCON' ) " ).append("\n"); 
