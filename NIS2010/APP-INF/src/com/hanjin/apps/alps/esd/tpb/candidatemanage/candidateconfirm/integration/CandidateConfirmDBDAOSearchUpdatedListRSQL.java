...
public class CandidateConfirmDBDAOSearchUpdatedListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   (SELECT C.OTS_DTL_SEQ, C.N3PTY_NON_CFM_DT, C.N3PTY_NON_CFM_RSN_CD, C. N3PTY_NON_CFM_RSN" ).append("\n"); 
		query.append("        FROM TPB_NON_CFM_RSN_DESC C, " ).append("\n"); 
		query.append("             (" ).append("\n"); 
		query.append("               SELECT OTS_DTL_SEQ, MAX(N3PTY_NON_CFM_DT) AS N3PTY_NON_CFM_DT" ).append("\n"); 
		...
		query.append("        AND C.N3PTY_NON_CFM_DT = D.N3PTY_NON_CFM_DT) B            --CHM-201114303 [TPB] Non-TPB Candidate Remark 란 추가 요청           --CHM-201114303 [TPB] Non-TPB Candidate Remark 란 추가 요청" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("--start[CHM-201114303 [TPB] Non-TPB Candidate Remark 란 추가 요청]----------------------------------------" ).append("\n"); 
		query.append("AND B.OTS_DTL_SEQ(+)=A.OTS_DTL_SEQ" ).append("\n"); 
		query.append("--end[CHM-201114303 [TPB] Non-TPB Candidate Remark 란 추가 요청]------------------------------------------" ).append("\n"); 
