...
import com.hanjin.apps.alps.esd.trs.servicesio.common.util.HashMapEnumeration;
...
//import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.common.TraceLogger;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.basic.RailBillingReqCreateBCImpl;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.BookingDetail;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.BookingSummary;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.ContainerTypeSize;
...
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.EmptyContainer;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.LocationDetail;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.RailBillEmptyCreateVO;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.RailBillErrorVO;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.RailBillFullCreateVO;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.RailRampLocation;
...
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.VndrUserDetail;
import com.hanjin.apps.alps.esd.trs.servicesio.railbilling.requestcreation.event.YardDetail;
    		...
    		ArrayList args = new ArrayList();
	  		while(dRs != null && dRs.next()) {
	            ...
	            if(dRs.getString("tare_wgt") == null || "".equals(dRs.getString("tare_wgt")))
	            	...
	            	bkgInfo.setVgm_wgt  (Double.toString(Double.valueOf(dRs.getString("tare_wgt"))+Double.valueOf(dRs.getString("wgt_qty"))));
	            args.add(bkgInfo);
...
//            trcLogger.detailEnd();          
			...
			// EDI 전송용 데이터
			ediSendVO.setCntr_ofc_cd("PHXSA");
...
//            trcLogger.detailBegin("MT multiProcTRS_TRSP_RAIL_BILLING_VO");
            ...
            piDBDao.multiProcTrsTrspRailBillingVos("PHXSA");
//            trcLogger.detailEnd();
