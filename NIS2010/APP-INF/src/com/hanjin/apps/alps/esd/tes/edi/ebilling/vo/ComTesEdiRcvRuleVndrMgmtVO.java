...
public class ComTesEdiRcvRuleVndrMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComTesEdiRcvRuleVndrMgmtVO> models = new ArrayList<ComTesEdiRcvRuleVndrMgmtVO>();
	...
	/* EDI VNDR TAG list info - TABLE로 VO만들고 반드시 추가해야 한다.  */
	private List<ComTesEdiRcvFltFileTagVO> tesEdiRcvFltFileTagVOlist = null;
	...
	/**
	 * <중> - TABLE로 VO만들고 반드시 추가해야 한다.
	 * EDI VNDR TAG RULE list SETTER
	 * @param tesEdiFltFileTagMgmtVOlist
	 */
	public void setComTesEdiRcvFltFileTagVOlist(List<ComTesEdiRcvFltFileTagVO> tesEdiRcvFltFileTagVOlist){
		this.tesEdiRcvFltFileTagVOlist = tesEdiRcvFltFileTagVOlist;
	}

	/**
	 * <중> - TABLE로 VO만들고 반드시 추가해야 한다.
	 * EDI VNDR TAG RULE list GETTER
	 * @return
	 */
	public List<ComTesEdiRcvFltFileTagVO> getComTesEdiRcvFltFileTagVOlist(){
		return this.tesEdiRcvFltFileTagVOlist;
	}
...
/**
	 ...
	 */
	public ComTesEdiRcvRuleVndrMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesEdiRcvRuleVndrMgmtVO[]
	 */
	public ComTesEdiRcvRuleVndrMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComTesEdiRcvRuleVndrMgmtVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ComTesEdiRcvRuleVndrMgmtVO();
				if (updDt[i] != null)
	 ...
	 * @return TesEdiRcvRuleVndrMgmtVO[]
	 */
	public ComTesEdiRcvRuleVndrMgmtVO[] getTesEdiRcvRuleVndrMgmtVOs(){
		ComTesEdiRcvRuleVndrMgmtVO[] vos = (ComTesEdiRcvRuleVndrMgmtVO[])models.toArray(new ComTesEdiRcvRuleVndrMgmtVO[models.size()]);
		return vos;
	}
