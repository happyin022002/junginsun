...
*@FileName : FuelScgManageDBDAODeleteCorrScgAgmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAODeleteCorrScgAgmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FuelScgManageDBDAODeleteCorrScgAgmtRSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAODeleteCorrScgAgmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
