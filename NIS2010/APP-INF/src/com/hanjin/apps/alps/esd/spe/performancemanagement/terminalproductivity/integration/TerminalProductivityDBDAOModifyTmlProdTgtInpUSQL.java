...
*@FileName : TerminalProductivityDBDAOModifyTmlProdTgtInpUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalProductivityDBDAOModifyTmlProdTgtInpUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Terminal Productivity Target Input 을 수정한다.
	  * </pre>
	  */
	public TerminalProductivityDBDAOModifyTmlProdTgtInpUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalProductivityDBDAOModifyTmlProdTgtInpUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SPE_EV_GRP_TML_PROD_TGT" ).append("\n"); 
		query.append("   SET  EV_YR         = @[ev_yr]" ).append("\n"); 
		query.append("      , SP_SEQ        = @[sp_seq]" ).append("\n"); 
		query.append("      , TML_CD        = @[tml_cd]" ).append("\n"); 
		query.append("      , KPI_TGT_RTO   = @[kpi_tgt_rto]" ).append("\n"); 
		query.append("      , KPI_RMK       = @[kpi_rmk]" ).append("\n"); 
		query.append("      , UPD_USR_ID    = @[upd_usr_id]" ).append("\n"); 
		query.append("      , UPD_DT        = SYSDATE" ).append("\n"); 
		query.append(" WHERE EG_TML_PROD_TGT_SEQ = @[eg_tml_prod_tgt_seq]" ).append("\n"); 
