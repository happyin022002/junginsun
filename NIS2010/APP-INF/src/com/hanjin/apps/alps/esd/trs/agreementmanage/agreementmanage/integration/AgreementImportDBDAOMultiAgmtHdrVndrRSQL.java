...
*@FileName : AgreementImportDBDAOMultiAgmtHdrVndrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOMultiAgmtHdrVndrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgreementImportDBDAOMultiAgmtHdrVndrRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOMultiAgmtHdrVndrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[trsp_agmt_ofc_cty_cd]" ).append("\n"); 
		query.append(",@[trsp_agmt_seq]" ).append("\n"); 
		query.append(",@[vndr_prmry_seq]" ).append("\n"); 
