...
public class SpecialCargoQuotationManageDBDAOsetYearMonthRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("FROM TES_ACT_COST_HDR AH" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND EXE_STS_CD = 'C'" ).append("\n"); 
		query.append("AND NVL(DELT_FLG,'N') <> 'Y'" ).append("\n"); 
		query.append("AND AH.TML_ACT_COST_SEQ = (" ).append("\n"); 
		query.append("SELECT MAX(H.TML_ACT_COST_SEQ)" ).append("\n"); 
		query.append("FROM TES_ACT_COST_HDR H" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND H.EXE_STS_CD = 'C'" ).append("\n"); 
