...
package com.hanjin.apps.alps.esd.sce.visibilitymanage.vesselreport.vo;
...
public class SearchUSIORInfoVO extends AbstractValueObject {
	...
	public SearchUSIORInfoVO(String ibflag, String pagerows, String tTruckSts, String tPupSts, String sBkgNo, String sLane, String costDiv, String sNeweqOffice, String sRailDest, String eqmtOfc, String ediStatus, String tCostMode, String sPupOffice, String mstBkgSts, String sScNo, String sEqOffice, String portCd, String sCLoc, String tEndSts, String tPNo, String fmDt, String tRailBillingSts, String sCntrNo, String sVvd, String toDt, String ofcCd, String sDel, String dateselect, String sPolPod, String vndrSeq, String sMvmtCd) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("s_mvmt_cd", getSMvmtCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("s_mvmt_cd", "sMvmtCd");
	 ...
	 * @param sMvmtCd
	 */
	public void setSMvmtCd(String sMvmtCd) {
		this.sMvmtCd = sMvmtCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setSMvmtCd(JSPUtil.getParameter(request, prefix + "s_mvmt_cd", ""));
	...
	public SearchUSIORInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] sMvmtCd = (JSPUtil.getParameter(request, prefix	+ "s_mvmt_cd", length));
	...
	*/
	public void unDataFormat(){
		...
		this.sMvmtCd = this.sMvmtCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
