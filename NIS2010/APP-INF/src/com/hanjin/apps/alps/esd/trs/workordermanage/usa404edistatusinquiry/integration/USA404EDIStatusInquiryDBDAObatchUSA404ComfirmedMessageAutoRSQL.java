...
public class USA404EDIStatusInquiryDBDAObatchUSA404ComfirmedMessageAutoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("WHERE A.TRSP_SO_OFC_CTY_CD = @[trspSoOfcCtyCd] AND A.TRSP_SO_SEQ = @[trspSoSeq]" ).append("\n"); 
		...
		query.append("GROUP BY A.TRSP_SO_OFC_CTY_CD, A.TRSP_SO_SEQ, A.EQ_NO, A.EQ_TPSZ_CD, A.PROV_VNDR_SEQ, A.PROV_USR_ID, A.PROV_FAX_NO," ).append("\n"); 
		query.append("A.PROV_EML, A.SHPR_CUST_NM, A.SHPR_FAX_NO, C.OFC_CD, A.CRE_USR_ID, A.PROV_CFM_MZD_CD" ).append("\n"); 
