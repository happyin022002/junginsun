...
*@FileName : ESD_LEA_0008HTMLAction.java
...
public class ESD_LEA_0008HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0008HTMLAction 객체를 생성
	 */
	public ESD_LEA_0008HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0008Event event = new EsdLea0008Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchAccrualBatchExecuteResultHistoryListVO((SearchAccrualBatchExecuteResultHistoryListVO)getVO(request, SearchAccrualBatchExecuteResultHistoryListVO .class));
		}
