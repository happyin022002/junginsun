...
*@FileName : EurOceanFeederCostManageDBDAOSearchFeederCostInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOSearchFeederCostInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOSearchFeederCostInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOSearchFeederCostInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , TRSP_45FT_AGMT_WGT AGMT_WGT_45FT" ).append("\n"); 
		...
		query.append("          OR D.TRSP_45FT_COST_SYS_SRC_CD IN (" ).append("\n"); 
		query.append("    #foreach ($user_sysSrcCds IN ${sysSrcCds})" ).append("\n"); 
		query.append("        #if($velocityCount < $sysSrcCds.size())" ).append("\n"); 
		query.append("            '$user_sysSrcCds'," ).append("\n"); 
		query.append("        #else" ).append("\n"); 
		...
		query.append("          OR D.TML_45FT_COST_SYS_SRC_CD IN (" ).append("\n"); 
		query.append("    #foreach ($user_sysSrcCds IN ${sysSrcCds})" ).append("\n"); 
		query.append("        #if($velocityCount < $sysSrcCds.size())" ).append("\n"); 
		query.append("            '$user_sysSrcCds'," ).append("\n"); 
		query.append("        #else" ).append("\n"); 
		...
		query.append("    #if (${cost_factor_cd} == 'ALL' || ${fullTrans45} == 'Y')" ).append("\n"); 
		query.append("        #if (${adjustment_cd} == 'E')" ).append("\n"); 
		query.append("          OR NVL(D.TRSP_45FT_ADJ_COST_AMT, 0) = 0" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("        #if (${adjustment_cd} == 'N')" ).append("\n"); 
		query.append("          OR NVL(D.TRSP_45FT_ADJ_COST_AMT, 0) <> 0" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		...
		query.append("    #if (${cost_factor_cd} == 'ALL' || ${tmnl45} == 'Y')" ).append("\n"); 
		query.append("        #if (${adjustment_cd} == 'E')" ).append("\n"); 
		query.append("          OR NVL(D.TML_45FT_ADJ_COST_AMT, 0) = 0" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("        #if (${adjustment_cd} == 'N')" ).append("\n"); 
		query.append("          OR NVL(D.TML_45FT_ADJ_COST_AMT, 0) <> 0" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		...
		query.append("    #if (${cost_factor_cd} == 'ALL' || ${empty45} == 'Y')" ).append("\n"); 
		query.append("        #if (${adjustment_cd} == 'E')" ).append("\n"); 
		query.append("          OR NVL(D.MTY_TRSP_45FT_ADJ_COST_AMT, 0) = 0" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
		query.append("        #if (${adjustment_cd} == 'N')" ).append("\n"); 
		query.append("          OR NVL(D.MTY_TRSP_45FT_ADJ_COST_AMT, 0) <> 0" ).append("\n"); 
		query.append("        #end" ).append("\n"); 
