...
*@FileName : EasMdmCountryVO.java
*@FileTitle : EasMdmCountryVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
package com.hanjin.apps.alps.esd.eas.terminalmanage.vo;
...
public class EasMdmCountryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EasMdmCountryVO> models = new ArrayList<EasMdmCountryVO>();
	...
	/* Column Info */
	private String emlDsclmCtnt = null; 
	...
	public EasMdmCountryVO() {}

	public EasMdmCountryVO(String ibflag, String pagerows, String emlDsclmCtnt, String cntCd, String cntNm, String scontiCd, String currCd, String frgnVatFlg, String znDivBselCd, String bkgAddrOrdCd, String bkgAddrOrdDesc, String cntIsoCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId, String euCntFlg) {
		this.updDt = updDt;
		...
		this.emlDsclmCtnt = emlDsclmCtnt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("eml_dsclm_ctnt", getEmlDsclmCtnt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("eml_dsclm_ctnt", "emlDsclmCtnt");
	 ...
	 * @return emlDsclmCtnt
	 */
	public String getEmlDsclmCtnt() {
		return this.emlDsclmCtnt;
	}
	 ...
	 * @param emlDsclmCtnt
	 */
	public void setEmlDsclmCtnt(String emlDsclmCtnt) {
		this.emlDsclmCtnt = emlDsclmCtnt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setEmlDsclmCtnt(JSPUtil.getParameter(request, prefix + "eml_dsclm_ctnt", ""));
	 ...
	 * @param request
	 * @return EasMdmCountryVO[]
	 */
	public EasMdmCountryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EasMdmCountryVO[]
	 */
	public EasMdmCountryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EasMdmCountryVO model = null;
		...
		try {
			...
			String[] emlDsclmCtnt = (JSPUtil.getParameter(request, prefix	+ "eml_dsclm_ctnt", length));
			
			
			for (int i = 0; i < length; i++) {
				model = new EasMdmCountryVO();
				if (updDt[i] != null)
				...
				if (emlDsclmCtnt[i] != null)
					model.setEmlDsclmCtnt(emlDsclmCtnt[i]);
	 ...
	 * @return EasMdmCountryVO[]
	 */
	public EasMdmCountryVO[] getEasMdmCountryVOs(){
		EasMdmCountryVO[] vos = (EasMdmCountryVO[])models.toArray(new EasMdmCountryVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.emlDsclmCtnt = this.emlDsclmCtnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
