...
*@FileName : CommodityGroupCodeManageDAOMultiPartCommodityDelDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityGroupCodeManageDAOMultiPartCommodityDelDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail Vendor 별 Group Commodity를 재 정의한 delete flag = 'Y' 인 자료를 삭제
	  * </pre>
	  */
	public CommodityGroupCodeManageDAOMultiPartCommodityDelDSQL(){
		setQuery();
		...
		query.append("FileName : CommodityGroupCodeManageDAOMultiPartCommodityDelDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
