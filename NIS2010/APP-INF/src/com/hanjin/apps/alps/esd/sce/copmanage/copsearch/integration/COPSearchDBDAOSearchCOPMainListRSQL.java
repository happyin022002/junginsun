...
public class COPSearchDBDAOSearchCOPMainListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				        cntr_vol_qty ,--t2.cntr_vol_qty cntr_vol_qty ,																	                                          " ).append("\n"); 
		query.append("				        DECODE(mst_lcl_cd, 'P', 'Y', '') AS mst_lcl_cd , -- decode( t2.mst_lcl_cd, 'P' , 'Y', '') mst_lcl_cd ,                                  									      " ).append("\n"); 
		...
		query.append("                                                                AND sch.bkg_no IN( " ).append("\n"); 
		...
		query.append("				                          " ).append("\n"); 
		query.append("				                          												                -- correction start" ).append("\n"); 
		query.append("                                                                AND MST.bkg_no IN( " ).append("\n"); 
		query.append("                                                                #foreach($code IN ${bkg_no})  " ).append("\n"); 
		query.append("                                                                	#if($velocityCount == 1)  " ).append("\n"); 
		query.append("                                                                		'$code' " ).append("\n"); 
		query.append("                                                                	#else  " ).append("\n"); 
		...
		query.append("				                          WHERE  (BB.BKG_CRE_DT BETWEEN TO_DATE(@[bkg_cre_dt1],'YYYY/MM/DD HH24:MI:SS') AND TO_DATE(@[bkg_cre_dt2],'YYYY/MM/DD HH24:MI:SS') + 1)     --bl_no              " ).append("\n"); 
		query.append("				                          AND    MST.BKG_NO = BB.BKG_NO              " ).append("\n"); 
		...
		query.append("																								                -- correction start" ).append("\n"); 
		query.append("																#if($bkg_no.size() > 0)  " ).append("\n"); 
		query.append("                                                                AND schg.bkg_no IN( " ).append("\n"); 
		query.append("                                                                #foreach($code IN ${bkg_no})  " ).append("\n"); 
		query.append("                                                                	#if($velocityCount == 1)  " ).append("\n"); 
		query.append("                                                                		'$code' " ).append("\n"); 
		query.append("                                                                	#else  " ).append("\n"); 
