...
*@FileName : RailSoManageDBDAORemoveUsaRailBillVoSPPUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAORemoveUsaRailBillVoSPPUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPP에서 해당 SO를 SO 마스터 테이블에 Delete 상태로 수정 SQL
	  * </pre>
	  */
	public RailSoManageDBDAORemoveUsaRailBillVoSPPUSQL(){
		setQuery();
		...
		query.append("FileName : RailSoManageDBDAORemoveUsaRailBillVoSPPUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
