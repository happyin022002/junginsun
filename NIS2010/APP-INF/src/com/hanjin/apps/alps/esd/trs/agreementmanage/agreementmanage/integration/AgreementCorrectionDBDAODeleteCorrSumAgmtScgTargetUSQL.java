...
*@FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Rate Type의 모든 Surcharge History 데이타의 마지막 History 상태코드를 Delete로 Update한다.
	  * </pre>
	  */
	public AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetUSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtScgTargetUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
