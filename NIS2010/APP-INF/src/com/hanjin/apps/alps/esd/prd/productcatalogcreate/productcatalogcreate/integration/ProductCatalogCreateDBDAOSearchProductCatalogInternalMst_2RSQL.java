...
*@FileName : ProductCatalogCreateDBDAOSearchProductCatalogInternalMst_2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOSearchProductCatalogInternalMst_2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOSearchProductCatalogInternalMst_2RSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOSearchProductCatalogInternalMst_2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("              ,DYS_DMT_EXPT_SEA) DYS_DMT_EXPT_SEA" ).append("\n"); 
		query.append("--      ,DECODE(DYS_DMT, 0, 2, DYS_DMT) DYS_DMT" ).append("\n"); 
		...
		query.append("                                WHERE COST_YRMON = mas_bzc_cost_yrmon_fnc('')" ).append("\n"); 
		query.append("    							) P" ).append("\n"); 
		query.append("							WHERE 1=1" ).append("\n"); 
		...
		query.append("                 ) DYS_DMT " ).append("\n"); 
		query.append("				,(" ).append("\n"); 
		query.append("					SELECT NVL(ROUND(SUM(P.TTL_DYS * P.BX_KNT) / DECODE(SUM(P.BX_KNT),0,1,SUM(P.BX_KNT)),2),0) TTL_AVG" ).append("\n"); 
		query.append("					FROM (" ).append("\n"); 
		query.append("    					SELECT DECODE(MAS_UT_TPSZ_FNC('TPS', TPSZ_CD), 'RD2', 'R2', 'RD4', 'R4', 'RD5', 'R5',' RD7', 'R7', 'RD8', 'R8', 'RD9', 'R9', MAS_UT_TPSZ_FNC('TPS', TPSZ_CD)) TPSZ_CD" ).append("\n"); 
		query.append("          					,TTL_DYS" ).append("\n"); 
		query.append("          					,BX_KNT" ).append("\n"); 
