...
public class ESD_SCE_0157HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_0154HTMLAction 객체를 생성
	 */
	public ESD_SCE_0157HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce0157Event event = new EsdSce0157Event();
		DewllNotifiySetupExpContainerVO dellvo = new DewllNotifiySetupExpContainerVO();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDewllNotifiySetupExpContainerVO((DewllNotifiySetupExpContainerVO)getVO(request, DewllNotifiySetupExpContainerVO .class));
		}else if(command.isCommand(FormCommand.SEARCH01)) {
			event.setDewllNotifiySetupExpContainerVO((DewllNotifiySetupExpContainerVO)getVO(request, DewllNotifiySetupExpContainerVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setDewllNotifiySetupExpContainerVOS(dellvo.fromRequestGrid(request, ""));
		}
