...
public class SearchCandidateListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String nonCfmRsnFlg = null;
	/* Column Info */
	...
	public SearchCandidateListVO(String ibflag, String pagerows, String ifDt, String sSkdVoyNo, String vndrCntCd, String gBkgNoAll, String sBkgNoAll, String ifOfcCd, String inOtsDtlSeq, String sTrdPartyVal, String fCmd, String estmSvrId, String otsDtlSeq, String currN3ptyNo, String n3ptyBilTpNm, String n3ptyOfcCd, String cfmD, String sBlNo, String sN3ptyNoStrsLink, String cfmI, String cfmG, String userId, String ifUsrNm, String sOfcTopLvl, String userName, String rvwOfcCd, String sOfficeLevel, String updUsrId, String custCntCd, String cfmR, String csrNo, String n3ptyIfTpCd, String sN3ptySrcNo, String sBlNoAll, String sVndrCustDivCd, String cfmN, String eqTpszCd, String creUsrId, String sCfmStatus, String estmRvisNo, String vndrSeq, String ifAmt, String ifAmtUsd, String sIfRhqCd, String sCsrNo, String sEqKndCd, String n3ptySrcSubSysCd, String n3ptyNonCfmRsnCd, String userOfcCd, String checkFincDirCd, String sVslCd, String sN3ptyBilTpCd, String sBkgNo, String costExptFlg, String userEmail, String rvwUsrId, String sIfCtrlCd, String vndrCustDivCd, String cfmAmt, String eqNo, String n3ptyNo, String estmSeqNo, String tesGubun, String srcVndrSeq, String ifUsrId, String gBlNoAll, String trsGubun, String sEdate, String ifRmk, String sNr, String sSdate, String sIfOfcCd, String sVvd, String custSeq, String cfmRmk, String sSkdDirCd, String sOfcCdForRhq, String ofcCd, String sRhqCdForRhq, String sN3ptySrcSubSysCd, String sEqNo, String cfm, String gVvd, String eqKndNm, String estmDtlSeqNo, String ifCurrCd, String eqKndCd, String trdPartyVal, String n3ptySrcNo, String nonCfmRsnFlg, String n3ptyBilTpCd, String idaSacCd) {
		...
		this.nonCfmRsnFlg = nonCfmRsnFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("non_cfm_rsn_flg", getNonCfmRsnFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("non_cfm_rsn_flg", "nonCfmRsnFlg");
	 ...
	 * @return nonCfmRsnFlg
	 */
	public String getNonCfmRsnFlg() {
		return this.nonCfmRsnFlg;
	}
	 ...
	 * @param nonCfmRsnFlg
	 */
	public void setNonCfmRsnFlg(String nonCfmRsnFlg) {
		this.nonCfmRsnFlg = nonCfmRsnFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCfmI(JSPUtil.getParameter(request, prefix + "cfm_i", ""));
		setUserId(JSPUtil.getParameter(request, prefix + "user_id", ""));
		setCfmG(JSPUtil.getParameter(request, prefix + "cfm_g", ""));
		setSEqKndCd(JSPUtil.getParameter(request, prefix + "s_eq_knd_cd", ""));
		setIfUsrNm(JSPUtil.getParameter(request, prefix + "if_usr_nm", ""));
		setRvwOfcCd(JSPUtil.getParameter(request, prefix + "rvw_ofc_cd", ""));
		setUserName(JSPUtil.getParameter(request, prefix + "user_name", ""));
		setSOfcTopLvl(JSPUtil.getParameter(request, prefix + "s_ofc_top_lvl", ""));
		setNonCfmRsnFlg(JSPUtil.getParameter(request, prefix + "non_cfm_rsn_flg", ""));
		setSOfficeLevel(JSPUtil.getParameter(request, prefix + "s_office_level", ""));
		setUpdUsrId(JSPUtil.getParameter(request, prefix + "upd_usr_id", ""));
		setCustCntCd(JSPUtil.getParameter(request, prefix + "cust_cnt_cd", ""));
		setCfmR(JSPUtil.getParameter(request, prefix + "cfm_r", ""));
		setCsrNo(JSPUtil.getParameter(request, prefix + "csr_no", ""));
		setN3ptyIfTpCd(JSPUtil.getParameter(request, prefix + "n3pty_if_tp_cd", ""));
		...
		setCfmN(JSPUtil.getParameter(request, prefix + "cfm_n", ""));
		setEqTpszCd(JSPUtil.getParameter(request, prefix + "eq_tpsz_cd", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setSCfmStatus(JSPUtil.getParameter(request, prefix + "s_cfm_status", ""));
		setEstmRvisNo(JSPUtil.getParameter(request, prefix + "estm_rvis_no", ""));
		...
		setCheckFincDirCd(JSPUtil.getParameter(request, prefix + "check_finc_dir_cd", ""));
		...
		setRvwUsrId(JSPUtil.getParameter(request, prefix + "rvw_usr_id", ""));
		...
		setTesGubun(JSPUtil.getParameter(request, prefix + "tes_gubun", ""));
		setSrcVndrSeq(JSPUtil.getParameter(request, prefix + "src_vndr_seq", ""));
		setIfRmk(JSPUtil.getParameter(request, prefix + "if_rmk", ""));
		setGBlNoAll(JSPUtil.getParameter(request, prefix + "g_bl_no_all", ""));
		setIfUsrId(JSPUtil.getParameter(request, prefix + "if_usr_id", ""));
		setSEdate(JSPUtil.getParameter(request, prefix + "s_edate", ""));
		setTrsGubun(JSPUtil.getParameter(request, prefix + "trs_gubun", ""));
		setSNr(JSPUtil.getParameter(request, prefix + "s_nr", ""));
		...
		setCfmRmk(JSPUtil.getParameter(request, prefix + "cfm_rmk", ""));
		...
		setCfm(JSPUtil.getParameter(request, prefix + "cfm", ""));
		setGVvd(JSPUtil.getParameter(request, prefix + "g_vvd", ""));
		setIfCurrCd(JSPUtil.getParameter(request, prefix + "if_curr_cd", ""));
		setEstmDtlSeqNo(JSPUtil.getParameter(request, prefix + "estm_dtl_seq_no", ""));
		...
		setIfDt(JSPUtil.getParameter(request, prefix + "n3pty_bil_tp_cd", ""));
	...
	public SearchCandidateListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] nonCfmRsnFlg = (JSPUtil.getParameter(request, prefix	+ "non_cfm_rsn_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (nonCfmRsnFlg[i] != null)
					model.setNonCfmRsnFlg(nonCfmRsnFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.nonCfmRsnFlg = this.nonCfmRsnFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
