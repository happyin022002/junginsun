...
*@FileName : TesAdvanceAuditDBDAOTesOffdockCYTerminalHistoryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesAdvanceAuditDBDAOTesOffdockCYTerminalHistoryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TesOffdockCYTerminalHistory
	  * </pre>
	  */
	public TesAdvanceAuditDBDAOTesOffdockCYTerminalHistoryRSQL(){
		setQuery();
		...
		query.append("FileName : TesAdvanceAuditDBDAOTesOffdockCYTerminalHistoryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , H.TML_CALC_IND_CD --Cal.Ind" ).append("\n"); 
		...
		query.append("     , D.CALC_VOL_QTY --Cal. Vol" ).append("\n"); 
		query.append("     , D.RC_FLG       --Reefer" ).append("\n"); 
		query.append("     , D.REV_YRMON    --Year/Month" ).append("\n"); 
		query.append("     , D.RVIS_VOL_QTY --Rvsd Vol" ).append("\n"); 
		...
		query.append("     , D.N3PTY_FLG    --3rd Party" ).append("\n"); 
		...
		query.append("   AND D.CALC_COST_GRP_CD  = 'TM'  --Terminal" ).append("\n"); 
