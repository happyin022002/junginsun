...
*@FileName : AsiaOceanFeederCostManageDBDAOSearchFeederCostDGRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOSearchFeederCostDGRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOSearchFeederCostDGRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOSearchFeederCostDGRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", AOC_CHN_FDR_TRF_HDR M" ).append("\n"); 
