...
*@FileTitle : Send Bidding Amount response
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.6
 */
public class SpotBiddingReceiveBiddingAmtRequest {
	/** (Param 객체) */
    private SpotBiddingReceiveBiddingAmt[] spotBiddingReceiveBiddingAmt = null;
 
	public SpotBiddingReceiveBiddingAmt[] getSpotBiddingReceiveBiddingAmt() {
	...
	public void setSpotBiddingReceiveBiddingAmt(SpotBiddingReceiveBiddingAmt[] spotBiddingReceiveBiddingAmt) {
