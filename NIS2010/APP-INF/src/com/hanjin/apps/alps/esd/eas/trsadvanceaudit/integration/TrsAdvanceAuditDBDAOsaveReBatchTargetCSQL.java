...
*@FileName : TrsAdvanceAuditDBDAOsaveReBatchTargetCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsAdvanceAuditDBDAOsaveReBatchTargetCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrsAdvanceAuditDBDAOsaveReBatchTargetCSQL(){
		setQuery();
		...
		query.append("FileName : TrsAdvanceAuditDBDAOsaveReBatchTargetCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
