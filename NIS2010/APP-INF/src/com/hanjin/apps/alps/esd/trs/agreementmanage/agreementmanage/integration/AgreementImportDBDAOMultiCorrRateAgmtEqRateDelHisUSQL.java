...
*@FileName : AgreementImportDBDAOMultiCorrRateAgmtEqRateDelHisUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAOMultiCorrRateAgmtEqRateDelHisUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rate Delete History Update
	  * </pre>
	  */
	public AgreementImportDBDAOMultiCorrRateAgmtEqRateDelHisUSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAOMultiCorrRateAgmtEqRateDelHisUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
