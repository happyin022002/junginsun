...
*@FileName : EurOceanFeederCostManageDBDAORemoveFdrTrfDtlDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAORemoveFdrTrfDtlDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2012.11.21 변종건 [CHM-201220395] Add-on Tariff Management 개선 프로젝트 - AOC_EUR_FDR_TRF_DTL 삭제 처리
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAORemoveFdrTrfDtlDSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAORemoveFdrTrfDtlDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    AOC_EUR_FDR_TRF_DTL" ).append("\n"); 
