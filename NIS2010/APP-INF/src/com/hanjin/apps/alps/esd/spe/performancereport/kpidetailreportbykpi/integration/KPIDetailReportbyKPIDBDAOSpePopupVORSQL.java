...
*@FileName : KPIDetailReportbyKPIDBDAOSpePopupVORSQL.java
...
public class KPIDetailReportbyKPIDBDAOSpePopupVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public KPIDetailReportbyKPIDBDAOSpePopupVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.spe.performancereport.kpidetailreportbykpi.integration").append("\n"); 
		query.append("FileName : KPIDetailReportbyKPIDBDAOSpePopupVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
