...
*@FileName : AsiaInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * multiInlandCostDetailSelect
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL(){
		setQuery();
		...
		params.put("cost_sel_rout_flg",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiainlandcostmanage.integration").append("\n"); 
		query.append("FileName : AsiaInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SET COST_SEL_ROUT_FLG = @[cost_sel_rout_flg]" ).append("\n"); 
