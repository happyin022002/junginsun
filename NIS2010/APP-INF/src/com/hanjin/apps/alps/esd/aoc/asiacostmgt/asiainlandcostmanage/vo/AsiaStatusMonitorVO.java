...
*@FileName : AsiaStatusMonitorVO.java
*@FileTitle : AsiaStatusMonitorVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaStatusMonitorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaStatusMonitorVO> models = new ArrayList<AsiaStatusMonitorVO>();
...
/**
	 ...
	 */
	public AsiaStatusMonitorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaStatusMonitorVO[]
	 */
	public AsiaStatusMonitorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaStatusMonitorVO model = null;
	...
	public AsiaStatusMonitorVO[] getSearchStatusMonitorVOs(){
		AsiaStatusMonitorVO[] vos = (AsiaStatusMonitorVO[])models.toArray(new AsiaStatusMonitorVO[models.size()]);
		return vos;
	}
