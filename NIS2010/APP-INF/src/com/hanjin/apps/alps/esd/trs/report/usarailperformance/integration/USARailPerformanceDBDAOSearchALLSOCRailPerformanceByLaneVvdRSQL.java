...
*@FileName : USARailPerformanceDBDAOSearchALLSOCRailPerformanceByLaneVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchALLSOCRailPerformanceByLaneVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchALLSOCRailPerformance SELECT by Lane VVD
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchALLSOCRailPerformanceByLaneVvdRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchALLSOCRailPerformanceByLaneVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      	   B.VNDR_SEQ WO_VNDR_SEQ," ).append("\n"); 
		query.append("           '' EQ_NO," ).append("\n"); 
		query.append("    	   '' TRSP_BND_CD," ).append("\n"); 
		query.append("#if( ${agmt_chk} == 'Y' )" ).append("\n"); 
