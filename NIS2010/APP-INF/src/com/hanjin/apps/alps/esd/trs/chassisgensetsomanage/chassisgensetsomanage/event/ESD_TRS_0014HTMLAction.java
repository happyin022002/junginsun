...
/**
 * HTTP Parser<br>
 * - com.hanjin.apps.alps.esd.trs.chassisgensetsomanage 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ESD_TRS_0014HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		event.setTrspSoVndrNo           (JSPUtil.getParameter(request, "TRSP_SO_VNDR_NO", ""));
		event.setSpotBidCnddtTermSeq    (JSPUtil.getParameter(request, "spot_bid_cnddt_term_seq", ""));
