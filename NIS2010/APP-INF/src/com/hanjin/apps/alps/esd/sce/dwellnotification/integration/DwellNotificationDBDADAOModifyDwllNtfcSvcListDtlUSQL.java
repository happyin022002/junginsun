...
*@FileName : DwellNotificationDBDADAOModifyDwllNtfcSvcListDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DwellNotificationDBDADAOModifyDwllNtfcSvcListDtlUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Email List를 삭제 flag를 업데이트를한다.
	  * </pre>
	  */
	public DwellNotificationDBDADAOModifyDwllNtfcSvcListDtlUSQL(){
		setQuery();
		...
		query.append("FileName : DwellNotificationDBDADAOModifyDwllNtfcSvcListDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
