...
public class AgreementRailScgDBDAOVerifyAgmtFixRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		CASE WHEN T.TRSP_RAIL_SCG_CD = 'OWS' " ).append("\n"); 
		query.append("		AND T.LBS_OVR_WGT IS NULL" ).append("\n"); 
		query.append("		THEN ',OVER WEIGHT ERR'" ).append("\n"); 
		query.append("		WHEN T.TRSP_RAIL_SCG_CD = 'OWS' " ).append("\n"); 
		query.append("		AND ((T.FX_SCG_20FT_RT IS NOT NULL" ).append("\n"); 
		query.append("			AND T.FX_SCG_40FT_RT IS NOT NULL)" ).append("\n"); 
		query.append("			OR (T.FX_SCG_20FT_RT IS NOT NULL" ).append("\n"); 
		query.append("			AND T.FX_SCG_45FT_RT IS NOT NULL)" ).append("\n"); 
		query.append("			OR (T.FX_SCG_40FT_RT IS NOT NULL" ).append("\n"); 
		query.append("			AND T.FX_SCG_45FT_RT IS NOT NULL)" ).append("\n"); 
		query.append("			OR (T.FX_SCG_20FT_RT IS NOT NULL" ).append("\n"); 
		query.append("			AND T.FX_SCG_40FT_RT IS NOT NULL" ).append("\n"); 
		query.append("			AND T.FX_SCG_45FT_RT IS NOT NULL))" ).append("\n"); 
		...
		query.append("		CASE WHEN T.TRSP_RAIL_SCG_CD = 'OWS' " ).append("\n"); 
		query.append("			 AND T.AGMT_EQ_SZ_NO = 'AL'" ).append("\n"); 
		query.append("			 AND T.FX_SCG_ALL_RT IS NULL" ).append("\n"); 
		query.append("		THEN ',AMOUNT ERR'" ).append("\n"); 
		query.append("		WHEN T.TRSP_RAIL_SCG_CD = 'OWS' " ).append("\n"); 
		query.append("			 AND T.AGMT_EQ_SZ_NO = '20'" ).append("\n"); 
		query.append("			 AND T.FX_SCG_20FT_RT IS NULL" ).append("\n"); 
		query.append("		THEN ',AMOUNT ERR'" ).append("\n"); 
		query.append("		WHEN T.TRSP_RAIL_SCG_CD = 'OWS' " ).append("\n"); 
		query.append("			 AND T.AGMT_EQ_SZ_NO = '40'" ).append("\n"); 
		query.append("			 AND T.FX_SCG_40FT_RT IS NULL" ).append("\n"); 
		query.append("		THEN ',AMOUNT ERR'" ).append("\n"); 
		query.append("		WHEN T.TRSP_RAIL_SCG_CD = 'OWS' " ).append("\n"); 
		query.append("			 AND T.AGMT_EQ_SZ_NO = '45'" ).append("\n"); 
		query.append("			 AND T.FX_SCG_45FT_RT IS NULL" ).append("\n"); 
		query.append("		THEN ',AMOUNT ERR'" ).append("\n"); 
		query.append("		END " ).append("\n"); 
		...
		query.append("		WHEN (T.FX_SCG_ALL_RT IS NOT NULL" ).append("\n"); 
		query.append("				AND T.FX_SCG_ALL_RT <> 0)" ).append("\n"); 
		query.append("			AND ((T.FX_SCG_20FT_RT IS NOT NULL" ).append("\n"); 
		query.append("				AND T.FX_SCG_20FT_RT <> 0)" ).append("\n"); 
		query.append("			OR (T.FX_SCG_40FT_RT IS NOT NULL" ).append("\n"); 
		query.append("				AND T.FX_SCG_40FT_RT <> 0)" ).append("\n"); 
		query.append("			OR (T.FX_SCG_45FT_RT IS NOT NULL" ).append("\n"); 
		query.append("				AND T.FX_SCG_45FT_RT <> 0))" ).append("\n"); 
		query.append("		THEN ',ALL CHECK'" ).append("\n"); 
		query.append("		END" ).append("\n"); 
