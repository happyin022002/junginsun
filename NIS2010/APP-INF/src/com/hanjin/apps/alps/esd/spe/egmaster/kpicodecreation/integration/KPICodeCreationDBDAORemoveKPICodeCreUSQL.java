...
*@FileName : KPICodeCreationDBDAORemoveKPICodeCreUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class KPICodeCreationDBDAORemoveKPICodeCreUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * KPI Code Creation 데이터를 삭제 한다
	  * </pre>
	  */
	public KPICodeCreationDBDAORemoveKPICodeCreUSQL(){
		setQuery();
		...
		query.append("FileName : KPICodeCreationDBDAORemoveKPICodeCreUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
