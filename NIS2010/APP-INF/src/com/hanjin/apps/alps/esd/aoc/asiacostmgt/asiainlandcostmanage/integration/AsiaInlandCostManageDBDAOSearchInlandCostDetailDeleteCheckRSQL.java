...
*@FileName : AsiaInlandCostManageDBDAOSearchInlandCostDetailDeleteCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchInlandCostDetailDeleteCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchInlandCostDetailDeleteCheckRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiainlandcostmanage.integration").append("\n"); 
		query.append("FileName : AsiaInlandCostManageDBDAOSearchInlandCostDetailDeleteCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
