...
*@FileName : CHAuditTroArmanageDBDAOSearchSubOfficeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CHAuditTroArmanageDBDAOSearchSubOfficeListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchSubOfficeList SELECT
	  * </pre>
	  */
	public CHAuditTroArmanageDBDAOSearchSubOfficeListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.transportmanage.integration").append("\n"); 
		query.append("FileName : CHAuditTroArmanageDBDAOSearchSubOfficeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
