...
*@FileName : BkgCopManageDBDAOSearchCopHdrInclCnclRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOSearchCopHdrInclCnclRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * cancel 된 cop 를 포함하여 모든 cop 를 bkg 별로 조회
	  * </pre>
	  */
	public BkgCopManageDBDAOSearchCopHdrInclCnclRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOSearchCopHdrInclCnclRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
