...
*@FileName : CommonPopUpManageDBDAOSearchServiceOfficeCodeManageRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommonPopUpManageDBDAOSearchServiceOfficeCodeManageRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Common Office의 데이타 모델에 해당되는 값을 불러온다.
	  * </pre>
	  */
	public CommonPopUpManageDBDAOSearchServiceOfficeCodeManageRSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.common.popup.integration").append("\n"); 
		query.append("FileName : CommonPopUpManageDBDAOSearchServiceOfficeCodeManageRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("START WITH OFC_CD like @[ofc_cd] || '%'" ).append("\n"); 
