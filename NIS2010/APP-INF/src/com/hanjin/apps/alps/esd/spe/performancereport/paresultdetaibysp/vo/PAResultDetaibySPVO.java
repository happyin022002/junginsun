...
*@FileName : PAResultDetaibySPVO.java
*@FileTitle : PAResultDetaibySPVO
*Open Issues :
*Change history :
...
package com.hanjin.apps.alps.esd.spe.performancereport.paresultdetaibysp.vo;
...
public class PAResultDetaibySPVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PAResultDetaibySPVO> models = new ArrayList<PAResultDetaibySPVO>();
	...
	public PAResultDetaibySPVO() {}

	public PAResultDetaibySPVO(String ibflag, String pagerows, String egId, String spKpiId, String spKpiNm, String rsltScreRto, String kpiTgtRto, String tgtAvg, String janRto, String febRto, String marRto, String aprRto, String mayRto, String junRto, String julRto, String augRto, String sepRto, String octRto, String novRto, String decRto, String sEvYr, String sSpSeq, String evYr, String spSeq) {
		this.sepRto = sepRto;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("tgt_avg", getTgtAvg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("tgt_avg", "tgtAvg");
	 ...
	 * @param tgtAvg
	 */
	public void setTgtAvg(String tgtAvg) {
		this.tgtAvg = tgtAvg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTgtAvg(JSPUtil.getParameter(request, prefix + "tgt_avg", ""));
	 ...
	 */
	public PAResultDetaibySPVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PAResultDetaibySPVO[]
	 */
	public PAResultDetaibySPVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PAResultDetaibySPVO model = null;
		...
		try {
			...
			String[] tgtAvg = (JSPUtil.getParameter(request, prefix	+ "tgt_avg", length));
		...
		return getPAResultDetaibySPVOs();
	}
	...
	public PAResultDetaibySPVO[] getPAResultDetaibySPVOs(){
		PAResultDetaibySPVO[] vos = (PAResultDetaibySPVO[])models.toArray(new PAResultDetaibySPVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tgtAvg = this.tgtAvg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
