...
*@FileName : MarineTerminalInvoiceManageDBDAOSearchMarineTerminalTrdPartyVolumeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOSearchMarineTerminalTrdPartyVolumeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchMarineTerminalTrdPartyVolume
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOSearchMarineTerminalTrdPartyVolumeRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOSearchMarineTerminalTrdPartyVolumeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
