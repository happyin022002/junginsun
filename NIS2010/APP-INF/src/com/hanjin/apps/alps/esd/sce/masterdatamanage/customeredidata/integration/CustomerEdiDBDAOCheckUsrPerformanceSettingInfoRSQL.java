...
*@FileName : CustomerEdiDBDAOCheckUsrPerformanceSettingInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerEdiDBDAOCheckUsrPerformanceSettingInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CheckUsrPerformanceSettingInfo
	  * </pre>
	  */
	public CustomerEdiDBDAOCheckUsrPerformanceSettingInfoRSQL(){
		setQuery();
		...
		query.append("FileName : CustomerEdiDBDAOCheckUsrPerformanceSettingInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND EDI_STS_SEQ = 2" ).append("\n"); 
