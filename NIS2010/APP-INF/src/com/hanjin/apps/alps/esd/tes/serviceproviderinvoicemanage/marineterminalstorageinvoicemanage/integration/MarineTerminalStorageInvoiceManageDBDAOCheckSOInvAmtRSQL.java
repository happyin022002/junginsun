...
*@FileName : MarineTerminalStorageInvoiceManageDBDAOCheckSOInvAmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalStorageInvoiceManageDBDAOCheckSOInvAmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalStorageInvoiceManageDBDAOCheckSOInvAmtRSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalStorageInvoiceManageDBDAOCheckSOInvAmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(SIGN(H.TTL_INV_AMT - SUM(ROUND(D.INV_AMT,2))),0,'Y','N') RETVAL" ).append("\n"); 
		...
		query.append("GROUP BY H.TTL_INV_AMT" ).append("\n"); 
