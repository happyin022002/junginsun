...
*@FileName : SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListEurDrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListEurDrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListEurDrRSQL(){
		setQuery();
		...
		query.append("FileName : SingleTransportationSOManageDBDAOSearchSingleTransportationSOCandidatesListEurDrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,NVL2(SUBSTR(T_DOR_ARR_DT,1,8),SUBSTR(T_DOR_ARR_DT,1,8),TO_CHAR(DOR_NOD_PLN_DT, 'YYYYMMDD')) AS DOR_NOD_PLN_DT" ).append("\n"); 
		query.append("      ,NVL2(SUBSTR(T_DOR_ARR_DT,9),SUBSTR(T_DOR_ARR_DT,9),TO_CHAR(DOR_NOD_PLN_DT, 'HH24MISS')) AS DOR_NOD_PLN_DT_HMS" ).append("\n"); 
		query.append("      ,SUBSTR(T_DOR_ARR_DT,1,8) AS DOR_ARR_DT_DD" ).append("\n"); 
		query.append("      ,SUBSTR(T_DOR_ARR_DT,9) AS DOR_ARR_DT_HMS" ).append("\n"); 
		query.append("      ,T_DOR_ARR_DT AS DOR_ARR_DT" ).append("\n"); 
		query.append("      ,DOR_NOD_PLN" ).append("\n"); 
		query.append("      ,TRO_SEQ" ).append("\n"); 
		query.append("      ,TRO_SUB_SEQ" ).append("\n"); 
		query.append("      ,TRO_CNFM" ).append("\n"); 
		query.append("      ,T_TRO_CFM_OFC_CD  AS TRO_CFM_OFC_CD" ).append("\n"); 
		query.append("      ,T_TRO_CFM_USR_ID  AS TRO_CFM_USR_ID" ).append("\n"); 
		query.append("      ,SUBSTR(T_TRO_CFM_UPD_DT,1,8) AS TRO_CFM_UPD_DT1" ).append("\n"); 
		query.append("      ,SUBSTR(T_TRO_CFM_UPD_DT,9)   AS TRO_CFM_UPD_DT2" ).append("\n"); 
		query.append("      ,T_TRO_CFM_CURR_CD AS TRO_CFM_CURR_CD" ).append("\n"); 
		query.append("      ,T_TRSP_RQST_ORD_REV_AMT AS TRO_CFM_REV_AMT" ).append("\n"); 
		query.append("      ,T_TRO_LOD_REF_NO  AS TRO_LOD_REF_NO" ).append("\n"); 
		query.append("      ,T_TRO_REP_CMDT_CD AS TRO_REP_CMDT_CD" ).append("\n"); 
		...
		query.append("      ,CASE WHEN T_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN C_ACT_CUST_ADDR_SEQ" ).append("\n"); 
		query.append("       END AS ACT_CUST_ADDR_SEQ" ).append("\n"); 
		...
		query.append("      ,CASE WHEN T_EXIST IS NOT NULL THEN T_TRSP_RQST_ORD_RMK" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN ''" ).append("\n"); 
		query.append("       END AS SPCL_INSTR_RMK " ).append("\n"); 
		query.append("      ,NULL AS USA_DO_USR_INFO --US D/O Only" ).append("\n"); 
		query.append("      ,NULL AS DO_CRE_DATE     --US D/O Only" ).append("\n"); 
		query.append("      ,NULL AS DO_CRE_TIME     --US D/O Only" ).append("\n"); 
		...
		query.append("      ,NVL2(T_EXIST, T_CNTR_WGT, CNTR_WGT) CNTR_WGT" ).append("\n"); 
		query.append("      ,WGT_MEAS_UT_CD" ).append("\n"); 
		query.append("      ,NOOFPKG" ).append("\n"); 
		query.append("      ,CASE WHEN T_AWK_CGO_SEQ IS NOT NULL AND T_AWK_CGO_SEQ > 0 THEN 'AK'" ).append("\n"); 
		query.append("            WHEN T_RC_SEQ      IS NOT NULL AND T_RC_SEQ > 0 THEN 'RF'" ).append("\n"); 
		query.append("            WHEN DG_INFO       IS NOT NULL AND DG_INFO > 0 THEN 'DG'" ).append("\n"); 
		query.append("            WHEN T_DCGO_SEQ    IS NOT NULL AND T_DCGO_SEQ > 0 THEN 'DG'" ).append("\n"); 
		...
		query.append("      ,TRS_COMMON_PKG.GET_CONV_WGT_TO_KGS_FNC(NVL2(T_EXIST, 'KGS', WGT_MEAS_UT_CD), NVL2(T_EXIST, T_CNTR_WGT, CNTR_WGT)) AS CNTR_KGS_WGT -- EUR TRO에 Weight가 없으면 BKG CNTR 의 Weight값을 조회한다." ).append("\n"); 
		query.append("      ,TRS_COMMON_PKG.GET_CONV_WGT_TO_LBS_FNC(NVL2(T_EXIST, 'KGS', WGT_MEAS_UT_CD), NVL2(T_EXIST, T_CNTR_WGT, CNTR_WGT)) AS CNTR_LBS_WGT -- EUR TRO에 Weight가 없으면 BKG CNTR 의 Weight값을 조회한다." ).append("\n"); 
		...
		query.append("      ,T_CSTMS_CLR_NO  AS CUSTOMSCLEARANCENO -- TRO Only" ).append("\n"); 
		query.append("      ,DECODE(T_CSTMS_CLR_NO,NULL, '', 'Y')   AS CUSTOMSCLEARANCE -- TRO Only" ).append("\n"); 
		query.append("      ,CASE WHEN T_EXIST IS NOT NULL THEN T_MLT_STOP_DE_FLG" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN '' -- TRO Only" ).append("\n"); 
		query.append("       END AS MLT_STOP_DE_FLG" ).append("\n"); 
		query.append("      ,CASE WHEN T_EXIST IS NOT NULL THEN T_PROC_CFM_IND_CD" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN '' -- TRO Only" ).append("\n"); 
		query.append("       END AS PROC_CFM_IND_CD" ).append("\n"); 
		query.append("      ,TRSP_COST_DTL_MOD_SEP" ).append("\n"); 
		query.append("      ,CASE WHEN DG_INFO IS NOT NULL THEN DG_INFO  " ).append("\n"); 
		query.append("            WHEN T_EXIST IS NOT NULL THEN T_DCGO_SEQ  " ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN '' -- TRO Only  " ).append("\n"); 
		query.append("       END AS DCGO_SEQ" ).append("\n"); 
		query.append("      ,CASE WHEN T_EXIST IS NOT NULL THEN T_RC_SEQ" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN '' -- TRO Only" ).append("\n"); 
		query.append("       END AS RC_SEQ" ).append("\n"); 
		query.append("      ,CASE WHEN T_EXIST IS NOT NULL THEN T_AWK_CGO_SEQ" ).append("\n"); 
		query.append("            WHEN C_EXIST IS NOT NULL THEN '' -- TRO Only" ).append("\n"); 
		query.append("       END AS AWK_CGO_SEQ" ).append("\n"); 
		...
		query.append("      ,T_CSTMS_CLR_NO AS CSTMS_CLR_NO" ).append("\n"); 
		query.append("      ,T_REP_CMDT_CD AS REP_CMDT_CD" ).append("\n"); 
		query.append("      ,T_REV_CURR_CD AS REV_CURR_CD" ).append("\n"); 
		query.append("      ,T_TRSP_RQST_ORD_REV_AMT AS TRSP_RQST_ORD_REV_AMT" ).append("\n"); 
		query.append("      ,T_TRSP_RQST_ORD_BND_CD AS TRSP_RQST_ORD_BND_CD" ).append("\n"); 
		query.append("      ,T_TRSP_RQST_ORD_SEQ AS TRSP_RQST_ORD_SEQ" ).append("\n"); 
		...
		query.append("      ,SUBSTR(PRD_DIST, 1, INSTR(PRD_DIST, '/') - 1) LNK_DIST_DIV_CD" ).append("\n"); 
		query.append("      ,SUBSTR(PRD_DIST, INSTR(PRD_DIST, '/') + 1) TTL_DIST" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("           ,'' AS CGOR_FRT_PAY_IND_FLG" ).append("\n"); 
		query.append("           ,'' AS CGOR_ORG_BL_RCVR_IND_FLG" ).append("\n"); 
		query.append("           ,'' AS CGOR_CSTMS_ACPT_RE_IND_FLG           " ).append("\n"); 
		...
		query.append("           ,SUBSTR(X.HD_INFO, 1, INSTR(X.HD_INFO, '^', 1, 1) - 1) AS T_ACT_CUST_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 1) + 1, INSTR(X.HD_INFO, '^', 1, 2) - INSTR(X.HD_INFO, '^', 1, 1) - 1) AS T_ACT_CUST_CNT_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 2) + 1, INSTR(X.HD_INFO, '^', 1, 3) - INSTR(X.HD_INFO, '^', 1, 2) - 1) AS T_ACT_CUST_SEQ" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 3) + 1, INSTR(X.HD_INFO, '^', 1, 4) - INSTR(X.HD_INFO, '^', 1, 3) - 1) AS T_PROC_CFM_IND_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 4) + 1, INSTR(X.HD_INFO, '^', 1, 5) - INSTR(X.HD_INFO, '^', 1, 4) - 1) AS T_CSTMS_CLR_NO" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 5) + 1, INSTR(X.HD_INFO, '^', 1, 6) - INSTR(X.HD_INFO, '^', 1, 5) - 1) AS T_REP_CMDT_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 6) + 1, INSTR(X.HD_INFO, '^', 1, 7) - INSTR(X.HD_INFO, '^', 1, 6) - 1) AS T_REV_CURR_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 7) + 1, INSTR(X.HD_INFO, '^', 1, 8) - INSTR(X.HD_INFO, '^', 1, 7) - 1) AS T_TRSP_RQST_ORD_REV_AMT" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 8) + 1, INSTR(X.HD_INFO, '^', 1, 9) - INSTR(X.HD_INFO, '^', 1, 8) - 1) AS T_TRO_CFM_OFC_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1, 9) + 1, INSTR(X.HD_INFO, '^', 1,10) - INSTR(X.HD_INFO, '^', 1, 9) - 1) AS T_TRO_CFM_USR_ID" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,10) + 1, INSTR(X.HD_INFO, '^', 1,11) - INSTR(X.HD_INFO, '^', 1,10) - 1) AS T_TRO_CFM_UPD_DT" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,11) + 1, INSTR(X.HD_INFO, '^', 1,12) - INSTR(X.HD_INFO, '^', 1,11) - 1) AS T_TRO_CFM_REV_AMT" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,12) + 1, INSTR(X.HD_INFO, '^', 1,13) - INSTR(X.HD_INFO, '^', 1,12) - 1) AS T_TRO_CFM_CURR_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,13) + 1, INSTR(X.HD_INFO, '^', 1,14) - INSTR(X.HD_INFO, '^', 1,13) - 1) AS T_TRO_REP_CMDT_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,14) + 1, INSTR(X.HD_INFO, '^', 1,15) - INSTR(X.HD_INFO, '^', 1,14) - 1) AS T_TRSP_RQST_ORD_BND_CD" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,15) + 1, INSTR(X.HD_INFO, '^', 1,16) - INSTR(X.HD_INFO, '^', 1,15) - 1) AS T_TRSP_RQST_ORD_SEQ" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,16) + 1, INSTR(X.HD_INFO, '^', 1,17) - INSTR(X.HD_INFO, '^', 1,16) - 1) AS T_CNTR_WGT" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,17) + 1, INSTR(X.HD_INFO, '^', 1,18) - INSTR(X.HD_INFO, '^', 1,17) - 1) AS T_DCGO_SEQ" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,18) + 1, INSTR(X.HD_INFO, '^', 1,19) - INSTR(X.HD_INFO, '^', 1,18) - 1) AS T_RC_SEQ" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,19) + 1, INSTR(X.HD_INFO, '^', 1,20) - INSTR(X.HD_INFO, '^', 1,19) - 1) AS T_AWK_CGO_SEQ" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,20) + 1, INSTR(X.HD_INFO, '^', 1,21) - INSTR(X.HD_INFO, '^', 1,20) - 1) AS T_EXIST" ).append("\n"); 
		query.append("           ,SUBSTR(X.HD_INFO, INSTR(X.HD_INFO, '^', 1,21) + 1, INSTR(X.HD_INFO, '^', 1,22) - INSTR(X.HD_INFO, '^', 1,21) - 1) AS T_TRSP_RQST_ORD_RMK" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, 1, INSTR(X.DTL_INFO, '^', 1, 1) - 1) AS T_DOR_ARR_DT" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 1) + 1,  INSTR(X.DTL_INFO, '^', 1, 2) -  INSTR(X.DTL_INFO, '^', 1, 1)  - 1) AS T_TRO_LOD_REF_NO" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 2) + 1,  INSTR(X.DTL_INFO, '^', 1, 3) -  INSTR(X.DTL_INFO, '^', 1, 2)  - 1) AS T_DOR_PST_CD " ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 3) + 1,  INSTR(X.DTL_INFO, '^', 1, 4) -  INSTR(X.DTL_INFO, '^', 1, 3)  - 1) AS T_DOR_DE_ADDR" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 4) + 1,  INSTR(X.DTL_INFO, '^', 1, 5) -  INSTR(X.DTL_INFO, '^', 1, 4)  - 1) AS T_FCTRY_NM" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 5) + 1,  INSTR(X.DTL_INFO, '^', 1, 6) -  INSTR(X.DTL_INFO, '^', 1, 5)  - 1) AS T_CNTC_PSON_PHN_NO" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 6) + 1,  INSTR(X.DTL_INFO, '^', 1, 7) -  INSTR(X.DTL_INFO, '^', 1, 6)  - 1) AS T_CNTC_PSON_NM" ).append("\n"); 
		query.append("           ,SUBSTR(X.DTL_INFO, INSTR(X.DTL_INFO, '^', 1, 7) + 1,  INSTR(X.DTL_INFO, '^', 1, 8) -  INSTR(X.DTL_INFO, '^', 1, 7)  - 1) AS T_MLT_STOP_DE_FLG" ).append("\n"); 
		query.append("           " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("   		   ,TRS_COMMON_PKG.GET_PRD_DISTANCE_FNC ( X.FM_NOD_CD || X.FM_NOD_YD_NO" ).append("\n"); 
		query.append("               			                         ,X.TO_NOD_CD || X.TO_NOD_YD_NO" ).append("\n"); 
		query.append("                                                 ,X.VIA_NOD_CD || X.VIA_NOD_YD_NO " ).append("\n"); 
		query.append("                                                 ,X.DOR_NOD_CD || X.DOR_NOD_YD_NO" ).append("\n"); 
		query.append("                                                 ,X.TRSP_BND_CD" ).append("\n"); 
		...
		query.append("                ,(SELECT HD.ACT_CNT_CD||DECODE(HD.ACT_CUST_SEQ, 0, NULL, HD.ACT_CUST_SEQ)" ).append("\n"); 
		query.append("                         ||'^'|| HD.ACT_CNT_CD" ).append("\n"); 
		query.append("                         ||'^'|| DECODE(HD.ACT_CUST_SEQ, 0, NULL, HD.ACT_CUST_SEQ)" ).append("\n"); 
		query.append("                         ||'^'|| HD.TRO_PROC_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.CSTMS_CLR_NO" ).append("\n"); 
		query.append("                         ||'^'|| HD.REP_CMDT_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.CURR_CD" ).append("\n"); 
		query.append("                         ||'^'|| TO_CHAR(CASE WHEN HD.ALL_IN_RT_CD = 'Y' THEN NVL(HD.TRNS_REV_AMT,0)" ).append("\n"); 
		query.append("                                 WHEN HD.ALL_IN_RT_CD = 'N' THEN NVL(HD.NMF_TRNS_REV_AMT,0)" ).append("\n"); 
		query.append("                                 WHEN HD.ALL_IN_RT_CD = 'A' THEN NVL(HD.TRNS_REV_AMT,0) + NVL(HD.ADD_REV_AMT,0)" ).append("\n"); 
		query.append("                                 WHEN HD.ALL_IN_RT_CD = 'B' THEN NVL(HD.NMF_TRNS_REV_AMT,0) + NVL(HD.ADD_REV_AMT,0)" ).append("\n"); 
		query.append("                                 ELSE 0" ).append("\n"); 
		query.append("                                  END)                         " ).append("\n"); 
		query.append("                         ||'^'|| HD.CFM_OFC_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.CFM_USR_ID" ).append("\n"); 
		query.append("                         ||'^'|| TO_CHAR(HD.CFM_DT,'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append("                         ||'^'|| HD.CFM_REV_AMT" ).append("\n"); 
		query.append("                         ||'^'|| HD.CFM_CURR_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.REP_CMDT_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.IO_BND_CD" ).append("\n"); 
		query.append("                         ||'^'|| HD.TRO_SEQ" ).append("\n"); 
		query.append("                         ||'^'|| HD.CGO_WGT" ).append("\n"); 
		query.append("                         ||'^'|| HD.DCGO_SEQ" ).append("\n"); 
		query.append("                         ||'^'|| HD.RC_SEQ" ).append("\n"); 
		query.append("                         ||'^'|| HD.AWK_CGO_SEQ" ).append("\n"); 
		query.append("                         ||'^'|| HD.BKG_NO" ).append("\n"); 
		query.append("                         ||'^'|| REPLACE(HD.SPCL_INSTR_RMK, '^', ' ')" ).append("\n"); 
		query.append("                         ||'^'" ).append("\n"); 
		query.append("                    FROM BKG_EUR_TRO HD" ).append("\n"); 
		query.append("                   WHERE HD.BKG_NO      = TMP.BKG_NO" ).append("\n"); 
		query.append("                     AND HD.IO_BND_CD   = TMP.TRSP_BND_CD" ).append("\n"); 
		query.append("                     AND HD.TRO_SEQ     = TMP.TRO_SEQ) HD_INFO" ).append("\n"); 
		query.append("                ,(SELECT TO_CHAR(DCGO_SEQ)   " ).append("\n"); 
		query.append("                    FROM BKG_EUR_TRO_DG_SEQ DG   " ).append("\n"); 
		query.append("                   WHERE DG.BKG_NO  = TMP.BKG_NO  " ).append("\n"); 
		query.append("                     AND DG.IO_BND_CD = TMP.TRSP_BND_CD   " ).append("\n"); 
		query.append("                     AND DG.TRO_SEQ   = TMP.TRO_SEQ   " ).append("\n"); 
		query.append("                     AND ROWNUM = 1 " ).append("\n"); 
		query.append("                  ) DG_INFO" ).append("\n"); 
		query.append("                ,DECODE(TMP.TRSP_BND_CD,'I',  (SELECT /*+ INDEX_DESC(DTL XPKBKG_EUR_TRO_DTL) */" ).append("\n"); 
		query.append("                                                      TO_CHAR(DTL.ARR_DT,'YYYYMMDDHH24MISS')" ).append("\n"); 
		query.append("                                                      ||'^'|| DTL.LOD_REF_NO" ).append("\n"); 
		query.append("                                                      ||'^'|| DTL.DOR_ZIP_ID" ).append("\n"); 
		query.append("                                                      ||CASE WHEN DTL.UPD_DT < (SELECT TO_DATE(ATTR_CTNT1, 'YYYYMMDDHH24MISS') " ).append("\n"); 
		query.append("									                                             FROM BKG_HRD_CDG_CTNT " ).append("\n"); 
		query.append("									                                            WHERE HRD_CDG_ID = 'EUR_TRO_ADDRESS') THEN" ).append("\n"); 
		query.append("																	'^'|| TRIM(SUBSTR(DTL.DOR_ADDR,31,30))||' '||TRIM(SUBSTR(DTL.DOR_ADDR,61,30))||' '||TRIM(SUBSTR(DTL.DOR_ADDR,91,30))" ).append("\n"); 
		query.append("			                                                      ||'^'|| TRIM(SUBSTR(DTL.DOR_ADDR,1,30))" ).append("\n"); 
		query.append("														     ELSE" ).append("\n"); 
		query.append("														            '^'|| TRIM(SUBSTR(DTL.DOR_ADDR,51,50))||' '||TRIM(SUBSTR(DTL.DOR_ADDR,101,50))||' '||TRIM(SUBSTR(DTL.DOR_ADDR,151,50))" ).append("\n"); 
		query.append("                                                                  ||'^'|| TRIM(SUBSTR(DTL.DOR_ADDR,1,50))" ).append("\n"); 
		query.append("														END		" ).append("\n"); 
		query.append("                                                      ||'^'|| DTL.CNTC_PHN_NO" ).append("\n"); 
		query.append("                                                      ||'^'|| DTL.CNTC_PSON_NM" ).append("\n"); 
		query.append("                                                      ||'^'|| (CASE WHEN (SELECT COUNT(1)" ).append("\n"); 
		query.append("                                                                   FROM BKG_EUR_TRO_DTL X" ).append("\n"); 
		query.append("                                                                  WHERE X.BKG_NO      = DTL.BKG_NO" ).append("\n"); 
		query.append("                                                                    AND X.IO_BND_CD   = DTL.IO_BND_CD" ).append("\n"); 
		query.append("                                                                    AND X.TRO_SEQ     = DTL.TRO_SEQ) > 1 THEN 'Y'" ).append("\n"); 
		query.append("                                                               ELSE '' END)" ).append("\n"); 
		query.append("                                                      ||'^'" ).append("\n"); 
		query.append("                                                FROM BKG_EUR_TRO_DTL DTL" ).append("\n"); 
		query.append("                                               WHERE BKG_NO      = TMP.BKG_NO" ).append("\n"); 
		query.append("                                                 AND IO_BND_CD   = TMP.TRSP_BND_CD" ).append("\n"); 
		query.append("                                                 AND TRO_SEQ     = TMP.TRO_SEQ" ).append("\n"); 
		...
		query.append("                                                 AND DOR_ADDR_TP_CD = 'D'" ).append("\n"); 
		query.append("                                                 AND ROWNUM = 1 )" ).append("\n"); 
		query.append("                  ) AS DTL_INFO" ).append("\n"); 
		...
		query.append("                         ||'^'|| REPLACE(ATD.ACT_CUST_ADDR, '^', ' ') " ).append("\n"); 
		...
		query.append("                         ||'^'|| ATH.TRSP_ACT_CUST_NO" ).append("\n"); 
		query.append("                         ||'^'" ).append("\n"); 
		...
		query.append("                   WHERE BB.BKG_NO = TMP.BKG_NO" ).append("\n"); 
		query.append("                     ) NON_RT_STS_CD" ).append("\n"); 
		query.append("             FROM TRS_TRSP_SVC_ORD_TMP TMP" ).append("\n"); 
		query.append("            WHERE TRSP_TMP_SEQ = @[trsp_tmp_seq]" ).append("\n"); 
		query.append("          ) X" ).append("\n"); 
		query.append("    ) XX" ).append("\n"); 
		query.append("-- Provision 체크여부 체크일 경우 'UD' (TRO_MAPPING 데이타가 정확 할 경우엔 불표요한 구문(안정화되면 삭제해도 됨)" ).append("\n"); 
		query.append("#if (${TroUnConfirmDoor} == 'UD')" ).append("\n"); 
		query.append("    WHERE 1=1" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("    WHERE T_PROC_CFM_IND_CD = DECODE(TRO_CNFM, 'Y', 'C', '')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY XX.N1ST_NOD_PLN_DT DESC" ).append("\n"); 
