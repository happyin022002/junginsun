...
*@FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtScgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementCorrectionDBDAODeleteCorrSumAgmtScgDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Rate아래의 모든 Surcharge Rate를 삭제한다.
	  * </pre>
	  */
	public AgreementCorrectionDBDAODeleteCorrSumAgmtScgDSQL(){
		setQuery();
		...
		query.append("FileName : AgreementCorrectionDBDAODeleteCorrSumAgmtScgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM TRS_AGMT_SCG_RT" ).append("\n"); 
