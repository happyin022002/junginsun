...
//		else if( vos.get(0) instanceof DBRowSet )
//		{
//			for (int i = 0; i < vos.size(); i++) {
//				DBRowSet rs = (DBRowSet) vos.get(0);
//			}
//			
//		}
...
//			int colCount = realColNms.length;
			...
			while (rs.next()) { 
				...
				sb.append("<TR>");
				sb.append("<TD><![CDATA[]]></TD>"); //chk_box
				sb.append("<TD><![CDATA["+JSPUtil.getNull(rs.getString("upd_ind_cd"))+"]]> </TD>"); //flag
				sb.append("<TD><![CDATA["+JSPUtil.getNull(rs.getString("upd_ind_cd"))+"]]> </TD>"); //priority
