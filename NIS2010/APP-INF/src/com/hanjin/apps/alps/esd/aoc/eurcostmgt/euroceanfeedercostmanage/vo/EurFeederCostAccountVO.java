...
*@FileName : EurFeederCostAccountVO.java
*@FileTitle : EurFeederCostAccountVO
*Open Issues :
*Change history :
...
public class EurFeederCostAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurFeederCostAccountVO> models = new ArrayList<EurFeederCostAccountVO>();
	...
	/* Column Info */
	private String trfAmt45ft = null;
	/* Column Info */
	...
	/* Column Info */
	private String acctTblDiv = null;
	/* VO Data Value( C:Creation, U:Update, D:Delete ) */
	private String ibflag = null;
	/* Column Info */
	private String sysSrcCd45ft = null;
	/* Column Info */
	...
	/* Column Info */
	private String calcRmk45ft = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("trf_amt_45ft", getTrfAmt45ft());
		...
		this.hashColumns.put("acct_tbl_div", getAcctTblDiv());
		this.hashColumns.put("ibflag", getIbflag());
		this.hashColumns.put("sys_src_cd_45ft", getSysSrcCd45ft());
		...
		this.hashColumns.put("calc_rmk_45ft", getCalcRmk45ft());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("trf_amt_45ft", "trfAmt45ft");
		...
		this.hashFields.put("acct_tbl_div", "acctTblDiv");
		this.hashFields.put("ibflag", "ibflag");
		this.hashFields.put("sys_src_cd_45ft", "sysSrcCd45ft");
		...
		this.hashFields.put("calc_rmk_45ft", "calcRmk45ft");
	 ...
	 * @return trfAmt45ft
	 */
	public String getTrfAmt45ft() {
		return this.trfAmt45ft;
	}
	 ...
	 * @return acctTblDiv
	 */
	public String getAcctTblDiv() {
		return this.acctTblDiv;
	}
	 ...
	 * @return sysSrcCd45ft
	 */
	public String getSysSrcCd45ft() {
		return this.sysSrcCd45ft;
	}
	 ...
	 * @return calcRmk45ft
	 */
	public String getCalcRmk45ft() {
		return this.calcRmk45ft;
	}
	 ...
	 * @param trfAmt45ft
	 */
	public void setTrfAmt45ft(String trfAmt45ft) {
		this.trfAmt45ft = trfAmt45ft;
	}
	 ...
	 * @param acctTblDiv
	 */
	public void setAcctTblDiv(String acctTblDiv) {
		this.acctTblDiv = acctTblDiv;
	}
	 ...
	 * @param sysSrcCd45ft
	 */
	public void setSysSrcCd45ft(String sysSrcCd45ft) {
		this.sysSrcCd45ft = sysSrcCd45ft;
	}
	 ...
	 * @param calcRmk45ft
	 */
	public void setCalcRmk45ft(String calcRmk45ft) {
		this.calcRmk45ft = calcRmk45ft;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTrfAmt45ft(JSPUtil.getParameter(request, prefix + "trf_amt_45ft", ""));
		...
		setAcctTblDiv(JSPUtil.getParameter(request, prefix + "acct_tbl_div", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setSysSrcCd45ft(JSPUtil.getParameter(request, prefix + "sys_src_cd_45ft", ""));
		...
		setCalcRmk45ft(JSPUtil.getParameter(request, prefix + "calc_rmk_45ft", ""));
	 ...
	 */
	public EurFeederCostAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurFeederCostAccountVO[]
	 */
	public EurFeederCostAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurFeederCostAccountVO model = null;
		...
		try {
			...
			String[] trfAmt45ft = (JSPUtil.getParameter(request, prefix	+ "trf_amt_45ft", length));
			...
			String[] acctTblDiv = (JSPUtil.getParameter(request, prefix	+ "acct_tbl_div", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] sysSrcCd45ft = (JSPUtil.getParameter(request, prefix	+ "sys_src_cd_45ft", length));
			...
			String[] calcRmk45ft = (JSPUtil.getParameter(request, prefix	+ "calc_rmk_45ft", length));
			...
			for (int i = 0; i < length; i++) {
				model = new EurFeederCostAccountVO();
				...
				if (trfAmt45ft[i] != null)
					model.setTrfAmt45ft(trfAmt45ft[i]);
				...
				if (acctTblDiv[i] != null)
					model.setAcctTblDiv(acctTblDiv[i]);
				if (ibflag[i] != null)
					model.setIbflag(ibflag[i]);
				if (sysSrcCd45ft[i] != null)
					model.setSysSrcCd45ft(sysSrcCd45ft[i]);
				...
				if (calcRmk45ft[i] != null)
					model.setCalcRmk45ft(calcRmk45ft[i]);
		...
		return getEurFeederCostAccountVOs();
	}
	 ...
	 * @return EurFeederCostAccountVO[]
	 */
	public EurFeederCostAccountVO[] getEurFeederCostAccountVOs(){
		EurFeederCostAccountVO[] vos = (EurFeederCostAccountVO[])models.toArray(new EurFeederCostAccountVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.trfAmt45ft = this.trfAmt45ft .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.acctTblDiv = this.acctTblDiv .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.sysSrcCd45ft = this.sysSrcCd45ft .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.calcRmk45ft = this.calcRmk45ft .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
