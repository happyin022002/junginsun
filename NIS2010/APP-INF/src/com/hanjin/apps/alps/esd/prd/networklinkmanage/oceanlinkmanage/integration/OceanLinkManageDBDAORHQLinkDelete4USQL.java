...
*@FileName : OceanLinkManageDBDAORHQLinkDelete4USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanLinkManageDBDAORHQLinkDelete4USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanLinkManageDBDAORHQLinkDelete4USQL(){
		setQuery();
		...
		query.append("FileName : OceanLinkManageDBDAORHQLinkDelete4USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" 	OCN_ROUT_DELT_RMK = SYSDATE||' ID:'||@[upd_usr_id] ||'  ,Deleted by RHQ Ocean Link, N3RD lane'          			 " ).append("\n"); 
		query.append("  WHERE ts_ind_cd = 'T' " ).append("\n"); 
		query.append("    AND upd_ind_cd IN ('C', 'U', 'S') " ).append("\n"); 
		query.append("    AND lnk_knt > 2 " ).append("\n"); 
		query.append("    AND n3rd_pol_cd = RTRIM (@[s_from] )  " ).append("\n"); 
		query.append("    AND n3rd_pod_cd = RTRIM (@[s_to] ) " ).append("\n"); 
		query.append("    AND n3rd_lane_fdr_flg = 'Y'" ).append("\n"); 
