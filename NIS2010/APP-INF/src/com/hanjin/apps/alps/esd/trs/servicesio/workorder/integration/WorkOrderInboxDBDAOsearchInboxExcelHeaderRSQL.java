...
*@FileName : WorkOrderInboxDBDAOsearchInboxExcelHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderInboxDBDAOsearchInboxExcelHeaderRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Excel,Print Header 정보를 조회 한다.
	  * </pre>
	  */
	public WorkOrderInboxDBDAOsearchInboxExcelHeaderRSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderInboxDBDAOsearchInboxExcelHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
