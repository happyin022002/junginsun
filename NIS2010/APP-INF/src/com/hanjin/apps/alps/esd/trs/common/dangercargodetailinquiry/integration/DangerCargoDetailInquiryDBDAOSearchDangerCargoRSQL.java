...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esd.trs.common.dangercargodetailinquiry.integration;
...
public class DangerCargoDetailInquiryDBDAOSearchDangerCargoRSQL implements ISQLTemplate{
	...
	public DangerCargoDetailInquiryDBDAOSearchDangerCargoRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.common.dangercargodetailinquiry.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("AND A.DG_CNTR_SEQ = D.DCGO_SEQ" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("AND A.OUT_IMDG_PCK_CD1  = B.SPCL_CGO_PCK_CD(+)" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${sExsep} == 'E' && ${tro_seq} != '')" ).append("\n"); 
		query.append("AND D.TRO_SEQ = @[tro_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
