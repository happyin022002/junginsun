...
*@FileName : CSMSendDBDAOAddSendResultExistCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CSMSendDBDAOAddSendResultExistCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CSMSendDBDAOAddSendResultExistCSQL(){
		setQuery();
		...
		query.append("FileName : CSMSendDBDAOAddSendResultExistCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM SCE_CNTR_STS_MSG_TGT A," ).append("\n"); 
		query.append("SCE_CNTR_STS_MSG_FLT_FILE B" ).append("\n"); 
		...
		query.append("AND B.EDI_SND_SEQ = @[edi_snd_seq]" ).append("\n"); 
		query.append("" ).append("\n"); 
