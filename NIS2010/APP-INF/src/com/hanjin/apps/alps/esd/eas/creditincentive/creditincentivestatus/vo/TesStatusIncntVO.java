...
*@FileName : TesStatusIncntVO.java
*@FileTitle : TesStatusIncntVO
*Open Issues :
*Change history :
...
public class TesStatusIncntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesStatusIncntVO> models = new ArrayList<TesStatusIncntVO>();
...
/**
	 ...
	 */
	public TesStatusIncntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesStatusIncntVO[]
	 */
	public TesStatusIncntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesStatusIncntVO model = null;
	...
	public TesStatusIncntVO[] getTesStatusIncntVOs(){
		TesStatusIncntVO[] vos = (TesStatusIncntVO[])models.toArray(new TesStatusIncntVO[models.size()]);
		return vos;
	}
