...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByDayListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByDayListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * Off-dock AuditCalcCostByDayList 조회
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByDayListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditOffdockCYCalcCostByDayListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
