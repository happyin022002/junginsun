...
*@FileName : InvoiceAuditDAOIndiaOfcChkRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceAuditDAOIndiaOfcChkRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceAuditDAOIndiaOfcChkRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceAuditDAOIndiaOfcChkRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE (COUNT (A.OFC_CD), 1, 'Y', 'N') IND_OFC_CD " ).append("\n"); 
