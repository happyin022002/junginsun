...
*@FileName : CreditIncentiveStatusDBDAOMultiVslIncentiveCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOMultiVslIncentiveCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOMultiVslIncentiveCSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOMultiVslIncentiveCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EAS_VSL_YRY_CR A USING DUAL" ).append("\n"); 
		...
		query.append("			,ITM_CD             = @[itm_cd]" ).append("\n"); 
		query.append("			,VNDR_SEQ           = @[vndr_seq]" ).append("\n"); 
		query.append("			,CURR_CD            = @[curr_cd]" ).append("\n"); 
		query.append("			,JAN_ESTM_INCNT_AMT = @[jan_estm_incnt_amt]" ).append("\n"); 
		query.append("			,JAN_RCV_INCNT_AMT  = @[jan_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,FEB_ESTM_INCNT_AMT = @[feb_estm_incnt_amt]" ).append("\n"); 
		query.append("			,FEB_RCV_INCNT_AMT  = @[feb_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,MAR_ESTM_INCNT_AMT = @[mar_estm_incnt_amt]" ).append("\n"); 
		query.append("			,MAR_RCV_INCNT_AMT  = @[mar_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,APR_ESTM_INCNT_AMT = @[apr_estm_incnt_amt]" ).append("\n"); 
		query.append("			,APR_RCV_INCNT_AMT  = @[apr_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,MAY_ESTM_INCNT_AMT = @[may_estm_incnt_amt]" ).append("\n"); 
		query.append("			,MAY_RCV_INCNT_AMT  = @[may_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,JUN_ESTM_INCNT_AMT = @[jun_estm_incnt_amt]" ).append("\n"); 
		query.append("			,JUN_RCV_INCNT_AMT  = @[jun_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,JUL_ESTM_INCNT_AMT = @[jul_estm_incnt_amt]" ).append("\n"); 
		query.append("			,JUL_RCV_INCNT_AMT  = @[jul_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,AUG_ESTM_INCNT_AMT = @[aug_estm_incnt_amt]" ).append("\n"); 
		query.append("			,AUG_RCV_INCNT_AMT  = @[aug_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,SEP_ESTM_INCNT_AMT = @[sep_estm_incnt_amt]" ).append("\n"); 
		query.append("			,SEP_RCV_INCNT_AMT  = @[sep_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,OCT_ESTM_INCNT_AMT = @[oct_estm_incnt_amt]" ).append("\n"); 
		query.append("			,OCT_RCV_INCNT_AMT  = @[oct_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,NOV_ESTM_INCNT_AMT = @[nov_estm_incnt_amt]" ).append("\n"); 
		query.append("			,NOV_RCV_INCNT_AMT  = @[nov_rcv_incnt_amt]" ).append("\n"); 
		query.append("			,DEC_ESTM_INCNT_AMT = @[dec_estm_incnt_amt]" ).append("\n"); 
		query.append("			,DEC_RCV_INCNT_AMT  = @[dec_rcv_incnt_amt]" ).append("\n"); 
		...
		query.append("			,INSTR_RMK          = @[instr_rmk]" ).append("\n"); 
