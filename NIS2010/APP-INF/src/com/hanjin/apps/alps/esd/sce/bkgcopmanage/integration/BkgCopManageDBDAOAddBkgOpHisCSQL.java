...
*@FileName : BkgCopManageDBDAOAddBkgOpHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOAddBkgOpHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCE_BKG_OP_HIS 에 booking 에서 operation call 한 정보를 남긴다.
	  * </pre>
	  */
	public BkgCopManageDBDAOAddBkgOpHisCSQL(){
		setQuery();
		...
		params.put("bkg_evnt_rmk",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("bkg_evnt_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : BkgCopManageDBDAOAddBkgOpHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
