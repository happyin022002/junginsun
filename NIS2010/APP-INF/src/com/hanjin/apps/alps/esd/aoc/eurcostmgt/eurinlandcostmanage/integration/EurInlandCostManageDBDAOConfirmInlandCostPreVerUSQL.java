...
*@FileName : EurInlandCostManageDBDAOConfirmInlandCostPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOConfirmInlandCostPreVerUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOConfirmInlandCostPreVerUSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOConfirmInlandCostPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
