...
*@FileName : TESeBillingManageBizType000DBDAOSaveEDInvoiceTmpDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESeBillingManageBizType000DBDAOSaveEDInvoiceTmpDataCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESeBillingManageBizType000DBDAOSaveEDInvoiceTmpDataCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.edi.ebilling.integration").append("\n"); 
		query.append("FileName : TESeBillingManageBizType000DBDAOSaveEDInvoiceTmpDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${table_name} != '')" ).append("\n"); 
