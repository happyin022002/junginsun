...
*@FileName : JOInvoiceManageDBDAOSearchErpInterfaceDataForCreditNoteRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOSearchErpInterfaceDataForCreditNoteRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOInvoiceManageDBDAOSearchErpInterfaceDataForCreditNoteRSQL(){
		setQuery();
		...
		query.append("FileName : JOInvoiceManageDBDAOSearchErpInterfaceDataForCreditNoteRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
