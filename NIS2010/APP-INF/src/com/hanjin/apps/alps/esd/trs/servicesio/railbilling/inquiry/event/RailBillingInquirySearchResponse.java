...
*@FileName : RailBillingInquirySearchResponse.java
*@FileTitle : Rail Billing Inquiry Search Response
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class RailBillingInquirySearchResponse extends BasicResponse {
	/** (Header) */
	private String	id				= "RailBillingInquirySearchResponse";
