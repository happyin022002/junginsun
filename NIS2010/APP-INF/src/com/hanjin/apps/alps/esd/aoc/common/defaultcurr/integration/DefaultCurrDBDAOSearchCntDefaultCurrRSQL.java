...
*@FileName : DefaultCurrDBDAOSearchCntDefaultCurrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DefaultCurrDBDAOSearchCntDefaultCurrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DefaultCurrDBDAOSearchCntDefaultCurrRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.common.defaultcurr.integration").append("\n"); 
		query.append("FileName : DefaultCurrDBDAOSearchCntDefaultCurrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
