...
public class MSCCheckmanageDBDAOSearchMSCListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", COUNT(TROA.TRO_SUB_SEQ) OVER (PARTITION BY TRO.BKG_NO, TRO.IO_BND_CD, TRO.TRO_SEQ) TRO_SUB_SEQ_KNT --// 2012-09-14 추가" ).append("\n"); 
		...
		query.append("--and   troa.tro_sub_seq > 1  --// 2012-09-14 제거" ).append("\n"); 
		query.append("group by" ).append("\n"); 
		query.append("tro.cre_ofc_cd," ).append("\n"); 
		query.append("tro.bkg_no, bb.bl_no, bb.rcv_term_cd, bb.de_term_cd, troa.IO_BND_CD, to_char(tro.cre_dt, 'YYYYMM')" ).append("\n"); 
		query.append(", TRO.IO_BND_CD, TRO.TRO_SEQ, TROA.TRO_SUB_SEQ --// 2012-09-14 추가" ).append("\n"); 
		...
		query.append("AND TROS.TRO_SUB_SEQ_KNT > 1 --// 2012-09-14 추가" ).append("\n"); 
		query.append("group by" ).append("\n"); 
