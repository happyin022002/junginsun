...
*@FileName : CopDetailReceiveDBDAOAddActualHistoryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2009.09.09
*@LastModifier : Sungil Kim
*@LastVersion : 1.0
* 2009.09.09 Sungil Kim
* 2009.09.28 An,JeongSeon 
* 1.0 Creation
=========================================================*/
...
public class CopDetailReceiveDBDAOAddActualHistoryCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CopDetailReceiveDBDAOAddActualHistoryCSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOAddActualHistoryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
