...
*@FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYInvoiceRejectInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOSearchOffdockCYInvoiceRejectInfoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchOffdockCYInvoiceRejectInfo
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOSearchOffdockCYInvoiceRejectInfoRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOSearchOffdockCYInvoiceRejectInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND A.VNDR_SEQ = ?" ).append("\n"); 
