...
*@FileName : CopDetailReceiveDBDAOSearchCopDetailNotCurrentStatusRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOSearchCopDetailNotCurrentStatusRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchCopDetailNotCurrentStatus
	  ...
	  * </pre>
	  */
	public CopDetailReceiveDBDAOSearchCopDetailNotCurrentStatusRSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOSearchCopDetailNotCurrentStatusRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",to_char(a.act_dt,'YYYYMMDDHH24MISS') AS act_dt    -- CHM-201324593 : Added" ).append("\n"); 
		...
		query.append("AND    a.stnd_edi_sts_cd = c.edi_stnd_sts_cd(+)" ).append("\n"); 
