...
*@FileName : CreditIncentiveStatusDBDAOMultiTesIncentiveCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOMultiTesIncentiveCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOMultiTesIncentiveCSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOMultiTesIncentiveCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EAS_TML_INCNT A USING DUAL" ).append("\n"); 
		...
		query.append("			,LOCL_TS_STS_CD = @[locl_ts_sts_cd]" ).append("\n"); 
