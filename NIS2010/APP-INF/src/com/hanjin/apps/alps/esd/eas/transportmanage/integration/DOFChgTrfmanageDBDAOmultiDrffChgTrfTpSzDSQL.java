...
*@FileName : DOFChgTrfmanageDBDAOmultiDrffChgTrfTpSzDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DOFChgTrfmanageDBDAOmultiDrffChgTrfTpSzDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DOFChgTrfmanageDBDAOmultiDrffChgTrfTpSzDSQL(){
		setQuery();
		...
		query.append("FileName : DOFChgTrfmanageDBDAOmultiDrffChgTrfTpSzDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from EAS_DRFF_CHG_TRF_TP_SZ" ).append("\n"); 
