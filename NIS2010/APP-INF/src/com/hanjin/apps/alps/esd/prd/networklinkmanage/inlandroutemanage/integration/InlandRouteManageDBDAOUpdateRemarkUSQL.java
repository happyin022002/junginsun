...
*@FileName : InlandRouteManageDBDAOUpdateRemarkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOUpdateRemarkUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandRouteManageDBDAOUpdateRemarkUSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOUpdateRemarkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET inlnd_rout_rmk = @[i_route_rmk]," ).append("\n"); 
