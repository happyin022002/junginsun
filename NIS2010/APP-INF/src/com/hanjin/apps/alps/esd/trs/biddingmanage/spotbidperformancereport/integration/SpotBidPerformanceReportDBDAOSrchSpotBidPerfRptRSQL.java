...
*@FileName : SpotBidPerformanceReportDBDAOSrchSpotBidPerfRptRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpotBidPerformanceReportDBDAOSrchSpotBidPerfRptRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search Spot Bid Performance Report
	  * </pre>
	  */
	public SpotBidPerformanceReportDBDAOSrchSpotBidPerfRptRSQL(){
		setQuery();
		...
		params.put("r_sel_spotbidsts",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("r_sel_profit",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.biddingmanage.spotbidperformancereport.integration").append("\n"); 
		query.append("FileName : SpotBidPerformanceReportDBDAOSrchSpotBidPerfRptRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${invar_usrail} != 'Y') " ).append("\n"); 
		...
		query.append("    #end" ).append("\n"); 
		query.append("      ,X.SO_CRE_OFC_CD" ).append("\n"); 
		query.append("      ,COMMCODE_PKG.GET_COMDTL_NAME_FNC('CD03430', X.SPOT_BID_STS_CD) AS SPOT_BID_STS_CD" ).append("\n"); 
		query.append("      ,X.GLINE_VNDR_SEQ" ).append("\n"); 
		query.append("      ,X.GLINE_CURR_CD" ).append("\n"); 
		query.append("      ,(CASE WHEN (X.GLINE_VNDR_SEQ IS NULL AND X.GLINE_CURR_CD IS NULL) THEN NULL ELSE X.GLINE_BZC_AMT END)      AS GLINE_BZC_AMT" ).append("\n"); 
		query.append("      ,(CASE WHEN (X.GLINE_VNDR_SEQ IS NULL AND X.GLINE_CURR_CD IS NULL) THEN NULL ELSE X.GLINE_FUEL_SCG_AMT END) AS GLINE_FUEL_SCG_AMT" ).append("\n"); 
		query.append("      ,(CASE WHEN (X.GLINE_VNDR_SEQ IS NULL AND X.GLINE_CURR_CD IS NULL) THEN NULL ELSE X.GLINE_SCG_VAT_AMT END)  AS GLINE_SCG_VAT_AMT" ).append("\n"); 
		query.append("      ,(CASE WHEN (X.GLINE_VNDR_SEQ IS NULL AND X.GLINE_CURR_CD IS NULL) THEN NULL ELSE X.GLINE_TOLL_FEE_AMT END) AS GLINE_TOLL_FEE_AMT" ).append("\n"); 
		query.append("      ,(CASE WHEN (X.GLINE_VNDR_SEQ IS NULL AND X.GLINE_CURR_CD IS NULL) THEN NULL ELSE X.GLINE_TTL_AMT END)      AS GLINE_TTL_AMT" ).append("\n"); 
		query.append("      ,(CASE WHEN (X.GLINE_VNDR_SEQ IS NULL AND X.GLINE_CURR_CD IS NULL) THEN NULL ELSE TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )) END) AS GLINE_TTL_AMT_USD" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, X.WO_CURR_CD) AS VS_WO_CURR_CD" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, (NVL(X.GLINE_TTL_AMT, 0) - NVL(WO_TOT_AMT, 0))) AS VS_WO_AMT" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, NVL((ROUND(TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )), 2)), 0) - NVL(WO_TOT_AMT_USD, 0)) AS VS_WO_AMT_USD" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(SIGN(NVL((ROUND(TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )), 2)), 0) - NVL(WO_TOT_AMT_USD, 0)), -1, 'Loss', 'Profit') ) AS VS_WO_RSLT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(X.INV_NO, NULL, NULL, X.INV_CURR_CD)) AS VS_INV_CURR_CD" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(X.INV_NO, NULL, NULL, (NVL(X.GLINE_TTL_AMT, 0) - NVL(INV_TOT_AMT, 0)))) AS VS_INV_AMT" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(X.INV_NO, NULL, NULL, NVL((ROUND(TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )), 2)), 0) - NVL(INV_TOT_AMT_USD, 0))) AS VS_INV_AMT_USD" ).append("\n"); 
		query.append("      ,DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(X.INV_NO, NULL, NULL, DECODE(SIGN(NVL((ROUND(TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )), 2)), 0) - NVL(INV_TOT_AMT_USD, 0)), -1, 'Loss', 'Profit'))) AS VS_INV_RSLT" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("      ,TRS_COM_SPOT_BID_PKG.GET_SPOT_BID_VNDR_INFO(X.SPOT_BID_NO) AS SPOT_BID_VNDR_INFO" ).append("\n"); 
		query.append("      ,DECODE((SELECT SIGN(COUNT(1)-3) FROM TRS_SPOT_BID_VNDR  WHERE 1=1  AND SPOT_BID_NO = X.SPOT_BID_NO AND SPOT_BID_VNDR_STS_CD = 'S' AND SPOT_BID_AMT > 0 ), 1, 'Y', 'N') AS SPOT_BID_MORE_BID" ).append("\n"); 
		query.append("      ,(SELECT COUNT(1) FROM TRS_SPOT_BID_VNDR  WHERE 1=1  AND SPOT_BID_NO = X.SPOT_BID_NO AND SPOT_BID_VNDR_STS_CD = 'S' AND SPOT_BID_AMT > 0 ) AS SPOT_BID_VNDR_CNT" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		...
		query.append("                ,DECODE (SO.CUST_NOMI_TRKR_FLG,'Y', 'CNT','HJS') AS VNDR_TP_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("        , SB.SPOT_BID_STS_CD" ).append("\n"); 
		query.append("        , SB.GLINE_VNDR_SEQ" ).append("\n"); 
		query.append("        , SB.GLINE_CURR_CD" ).append("\n"); 
		query.append("        , SB.GLINE_BZC_AMT" ).append("\n"); 
		query.append("        , SB.GLINE_FUEL_SCG_AMT" ).append("\n"); 
		query.append("        , SB.GLINE_SCG_VAT_AMT" ).append("\n"); 
		query.append("        , SB.GLINE_TOLL_FEE_AMT" ).append("\n"); 
		query.append("        , SB.GLINE_TTL_AMT" ).append("\n"); 
		...
		query.append("     AND SO.SPOT_BID_NO = SB.SPOT_BID_NO" ).append("\n"); 
		query.append("     AND SO.TRSP_SO_OFC_CTY_CD = SB.TRSP_SO_OFC_CTY_CD" ).append("\n"); 
		query.append("     AND SO.TRSP_SO_SEQ = SB.TRSP_SO_SEQ" ).append("\n"); 
		...
		query.append("    #end" ).append("\n"); 
		query.append("   " ).append("\n"); 
		query.append("    #if($r_spotbidno.size() > 0) " ).append("\n"); 
		query.append("       AND SO.SPOT_BID_NO IN (" ).append("\n"); 
		query.append("       #foreach( ${key} IN ${r_spotbidno}) " ).append("\n"); 
		query.append("         #if($velocityCount < $r_spotbidno.size()) " ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	" ).append("\n"); 
		query.append("    #if (${r_sel_spotbidsts} != '' && ${r_sel_spotbidsts} != 'ALL')" ).append("\n"); 
		query.append("      AND SB.SPOT_BID_STS_CD = @[r_sel_spotbidsts]" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    #if (${r_sel_profit} != '' && ${r_sel_profit} != 'ALL')" ).append("\n"); 
		query.append("      #if (${r_radio_profit} == 'I') " ).append("\n"); 
		query.append("        AND DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(X.INV_NO, NULL, NULL, DECODE(SIGN(NVL((ROUND(TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )), 2)), 0) - NVL(INV_TOT_AMT_USD, 0)), -1, 'Loss', 'Profit'))) = @[r_sel_profit]" ).append("\n"); 
		query.append("      #else " ).append("\n"); 
		query.append("        AND DECODE(X.GLINE_CURR_CD, NULL, NULL, DECODE(SIGN(NVL((ROUND(TRS_COMMON_PKG.GET_CONVERSION_USD_AMT_FNC(X.GLINE_CURR_CD, X.GLINE_TTL_AMT, TO_CHAR(WO_CRE_DT, 'YYYYMM' )), 2)), 0) - NVL(WO_TOT_AMT_USD, 0)), -1, 'Loss', 'Profit') ) = @[r_sel_profit]" ).append("\n"); 
		query.append("      #end" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("" ).append("\n"); 
