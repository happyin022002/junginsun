...
*@FileName : RailBillingCancelManageDBDAOMultiCancelRailBillingListSoSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingCancelManageDBDAOMultiCancelRailBillingListSoSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail So Sequence, Spnd Flag 정보 조회
	  * </pre>
	  */
	public RailBillingCancelManageDBDAOMultiCancelRailBillingListSoSeqRSQL(){
		setQuery();
		...
		query.append("FileName : RailBillingCancelManageDBDAOMultiCancelRailBillingListSoSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
