...
*@FileName : EurInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO AOC_EUR_INLND_SPCL_TRF_DTL" ).append("\n"); 
		...
		query.append("         , @[upd_usr_id]" ).append("\n"); 
		query.append("         , SYSDATE         " ).append("\n"); 
		query.append("    FROM AOC_EUR_INLND_TRF_HDR HDR" ).append("\n"); 
