...
*@FileName : PoolChassisDBDAODeleteInvoicePoolChassisDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PoolChassisDBDAODeleteInvoicePoolChassisDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice Work 테이블의 자료를 삭제한다.
	  * </pre>
	  */
	public PoolChassisDBDAODeleteInvoicePoolChassisDSQL(){
		setQuery();
		...
		query.append("FileName : PoolChassisDBDAODeleteInvoicePoolChassisDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
