...
*@FileName : CustomerNominatedTruckerAproDAOSaveCntAproUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOSaveCntAproUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOSaveCntAproUSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerAproDAOSaveCntAproUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("-- 상태코드 UPDATE (Save)" ).append("\n"); 
		query.append("UPDATE TRS_CUST_NOMI_TRKR A" ).append("\n"); 
		query.append("   SET DISP_STS_CD = @[disp_sts_cd]" ).append("\n"); 
