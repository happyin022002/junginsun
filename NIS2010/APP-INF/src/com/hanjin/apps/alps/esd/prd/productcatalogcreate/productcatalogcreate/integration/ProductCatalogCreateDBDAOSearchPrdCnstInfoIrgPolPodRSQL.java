...
*@FileName : ProductCatalogCreateDBDAOSearchPrdCnstInfoIrgPolPodRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProductCatalogCreateDBDAOSearchPrdCnstInfoIrgPolPodRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 생성된 PC의 해당되는 prd_inlnd_rout를 조회한다.
	  * </pre>
	  */
	public ProductCatalogCreateDBDAOSearchPrdCnstInfoIrgPolPodRSQL(){
		setQuery();
		...
		query.append("FileName : ProductCatalogCreateDBDAOSearchPrdCnstInfoIrgPolPodRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , DECODE(PCTL_IO_BND_CD, 'O', DEL_CD, POD_CD) || ' - ' || DECODE(PCTL_IO_BND_CD, 'O', POD_CD, DEL_CD) NTWK_UT_NM" ).append("\n"); 
		query.append("     , 'Inland Constraint' ITM_NM" ).append("\n"); 
		query.append("     , PCTL_IO_BND_CD || '/B' PCTL_IO_BND_CD" ).append("\n"); 
		query.append("     , SLAN_CD VSL_SLAN_CD" ).append("\n"); 
		query.append("     , DECODE(BKG_DE_TERM_CD, 'A', 'ALL', BKG_DE_TERM_CD) BKG_DE_TERM_CD" ).append("\n"); 
		query.append("     , DECODE(TRSP_MOD_CD, 'AL', 'ALL', TRSP_MOD_CD) TRSP_MOD_CD" ).append("\n"); 
		query.append("     , BKG_RMK CNST_RMK" ).append("\n"); 
		query.append("     , (SELECT OFC_CD FROM COM_USER WHERE USR_ID = RSLT.CRE_USR_ID) CRE_OFC_CD " ).append("\n"); 
		query.append("     , CRE_USR_ID, PCTL_IMDG_CLSS_CTNT " ).append("\n"); 
		...
		query.append("             , CNST.PCTL_IO_BND_CD --, CNST.PCTL_IMDG_CLSS_CTNT" ).append("\n"); 
		...
		query.append("ORDER BY APLY_SVC_MOD_FLG" ).append("\n"); 
