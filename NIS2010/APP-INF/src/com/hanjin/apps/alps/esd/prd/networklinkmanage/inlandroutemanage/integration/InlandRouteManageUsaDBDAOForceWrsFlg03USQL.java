...
*@FileName : InlandRouteManageUsaDBDAOForceWrsFlg03USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageUsaDBDAOForceWrsFlg03USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * force wrs flg setting 3
	  * </pre>
	  */
	public InlandRouteManageUsaDBDAOForceWrsFlg03USQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageUsaDBDAOForceWrsFlg03USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET PRIO_SEQ=1" ).append("\n"); 
