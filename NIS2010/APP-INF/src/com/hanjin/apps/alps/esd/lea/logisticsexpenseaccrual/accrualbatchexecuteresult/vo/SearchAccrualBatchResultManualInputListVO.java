...
public class SearchAccrualBatchResultManualInputListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String estmCostAmtL = null;
	/* Column Info */
	private String estmCostAmtM = null;
	/* Page Number */
	...
	/* Column Info */
	private String actCostAmtDD = null;
	/* Column Info */
	private String actCostAmtA = null;
	/* Column Info */
	private String actCostAmtAA = null;
	/* Column Info */
	private String estmCostAmtA = null;
	
	/* Column Info */
	private String estmCostAmtAA = null;
	/* Column Info */
	private String estmCostAmtDD = null;
	/* Column Info */
	...
	/* Column Info */
	private String actCostAmtL = null;
	/* Column Info */
	private String actCostAmtM = null;
	/* Column Info */
	...
	/* Column Info */
	private String ibflagL = null;
	/* Column Info */
	private String ibflagM = null;	
	/* Column Info */
	...
	/* Column Info */
	private String ibflagDD = null;
	/* Column Info */
	private String exeYrmon = null;
	/* Column Info */
	private String ibflagA = null;
	/* Column Info */
	private String ibflagAA = null;
	/* Column Info */
	...
	/* Column Info */
	private String acclCostAmtL = null;
	/* Column Info */
	private String acclCostAmtM = null;
	/* Column Info */
	...
	/* Column Info */
	private String acclCostAmtAA = null;
	/* Column Info */
	private String acclCostAmtDD = null;
	...
	public SearchAccrualBatchResultManualInputListVO(String ibflag, String pagerows, String exeYrmon, String revYrmon, String ibflagA, String estmCostAmtA, String actCostAmtA, String acclCostAmtA, String ibflagB, String estmCostAmtB, String actCostAmtB, String acclCostAmtB, String ibflagC, String estmCostAmtC, String actCostAmtC, String acclCostAmtC, String ibflagD, String estmCostAmtD, String actCostAmtD, String acclCostAmtD, String ibflagF, String estmCostAmtF, String actCostAmtF, String acclCostAmtF, String ibflagG, String estmCostAmtG, String actCostAmtG, String acclCostAmtG, String ibflagH, String estmCostAmtH, String actCostAmtH, String acclCostAmtH, String ibflagI, String estmCostAmtI, String actCostAmtI, String acclCostAmtI, String ibflagJ, String estmCostAmtJ, String actCostAmtJ, String acclCostAmtJ, String ibflagK, String estmCostAmtK, String actCostAmtK, String acclCostAmtK, String ibflagL, String estmCostAmtL, String actCostAmtL, String acclCostAmtL, String ibflagM, String estmCostAmtM, String actCostAmtM, String acclCostAmtM) {
		...
		this.actCostAmtL = actCostAmtL;
		this.actCostAmtM = actCostAmtM;
		...
		this.ibflagL = ibflagL;
		this.ibflagM = ibflagM;
		...
		this.acclCostAmtL = acclCostAmtL;
		this.acclCostAmtM = acclCostAmtM;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("estm_cost_amt_l", getEstmCostAmtL());
		this.hashColumns.put("estm_cost_amt_m", getEstmCostAmtM());
		...
		this.hashColumns.put("act_cost_amt_aa", getActCostAmtAA());
		this.hashColumns.put("act_cost_amt_dd", getActCostAmtDD());
		
		this.hashColumns.put("estm_cost_amt_a", getEstmCostAmtA());
		
		this.hashColumns.put("estm_cost_amt_aa", getEstmCostAmtAA());
		this.hashColumns.put("estm_cost_amt_dd", getEstmCostAmtDD());
		...
		this.hashColumns.put("act_cost_amt_l", getActCostAmtL());
		this.hashColumns.put("act_cost_amt_m", getActCostAmtM());
		this.hashColumns.put("ibflag_l", getIbflagL());
		this.hashColumns.put("ibflag_m", getIbflagM());
		...
		this.hashColumns.put("ibflag_aa", getIbflagAA());
		this.hashColumns.put("ibflag_dd", getIbflagDD());
		...
		this.hashColumns.put("accl_cost_amt_l", getAcclCostAmtL());
		this.hashColumns.put("accl_cost_amt_m", getAcclCostAmtM());		
		...
		this.hashColumns.put("accl_cost_amt_aa", getAcclCostAmtAA());
		this.hashColumns.put("accl_cost_amt_dd", getAcclCostAmtDD());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("estm_cost_amt_l", "estmCostAmtL");
		this.hashFields.put("estm_cost_amt_m", "estmCostAmtM");		
		...
		this.hashFields.put("estm_cost_amt_aa", "estmCostAmtAA");
		this.hashFields.put("estm_cost_amt_dd", "estmCostAmtDD");
		
		this.hashFields.put("estm_cost_amt_b", "estmCostAmtB");
		this.hashFields.put("ibflag", "ibflag");
		this.hashFields.put("act_cost_amt_d", "actCostAmtD");
		
		this.hashFields.put("act_cost_amt_aa", "actCostAmtAA");
		this.hashFields.put("act_cost_amt_dd", "actCostAmtDD");
		...
		this.hashFields.put("act_cost_amt_l", "actCostAmtL");
		this.hashFields.put("act_cost_amt_m", "actCostAmtM");
		...
		this.hashFields.put("ibflag_l", "ibflagL");
		this.hashFields.put("ibflag_m", "ibflagM");
		...
		this.hashFields.put("ibflag_aa", "ibflagAA");
		this.hashFields.put("ibflag_dd", "ibflagDD");
		...
		this.hashFields.put("accl_cost_amt_l", "acclCostAmtL");
		this.hashFields.put("accl_cost_amt_m", "acclCostAmtM");
		...
		this.hashFields.put("accl_cost_amt_aa", "acclCostAmtAA");
		this.hashFields.put("accl_cost_amt_dd", "acclCostAmtDD");
	 ...
	 * @return estmCostAmtL
	 */
	public String getEstmCostAmtL() {
		return this.estmCostAmtL;
	}
	 ...
	 * @return estmCostAmtM
	 */
	public String getEstmCostAmtM() {
		return this.estmCostAmtM;
	}	
	/**
	 * Column Info
	 * @return estmCostAmtJ
	 ...
	 * @return estmCostAmtD
	 */
	public String getEstmCostAmtAA() {
		return this.estmCostAmtAA;
	}
	/**
	 * Column Info
	 * @return estmCostAmtD
	 */
	public String getEstmCostAmtDD() {
		return this.estmCostAmtDD;
	}
	 ...
	 * @return actCostAmtA
	 */
	public String getActCostAmtAA() {
		return this.actCostAmtAA;
	}
	/**
	 * Column Info
	 * @return actCostAmtA
	 */
	public String getActCostAmtDD() {
		return this.actCostAmtDD;
	}
	 ...
	 * @return actCostAmtL
	 */
	public String getActCostAmtL() {
		return this.actCostAmtL;
	}
	 ...
	 * @return actCostAmtM
	 */
	public String getActCostAmtM() {
		return this.actCostAmtM;
	}
	/**
	 * Column Info
	 * @return ibflagF
	 ...
	 * @return ibflagD
	 */
	public String getIbflagAA() {
		return this.ibflagAA;
	}	/**
	 * Column Info
	 * @return ibflagD
	 */
	public String getIbflagDD() {
		return this.ibflagDD;
	}
	 ...
	 * @return acclCostAmtL
	 */
	public String getAcclCostAmtL() {
		return this.acclCostAmtL;
	}
	 ...
	 * @return acclCostAmtM
	 */
	public String getAcclCostAmtM() {
		return this.acclCostAmtM;
	}
	 ...
	 * @return acclCostAmtB
	 */
	public String getAcclCostAmtAA() {
		return this.acclCostAmtAA;
	}
	/**
	 * Column Info
	 * @return acclCostAmtB
	 */
	public String getAcclCostAmtDD() {
		return this.acclCostAmtDD;
	}
	 ...
	 * @param estmCostAmtL
	 */
	public void setEstmCostAmtL(String estmCostAmtL) {
		this.estmCostAmtL = estmCostAmtL;
	}
	 ...
	 * @param estmCostAmtM
	 */
	public void setEstmCostAmtM(String estmCostAmtM) {
		this.estmCostAmtM = estmCostAmtM;
	}	
	 ...
	 * @param actCostAmtA
	 */
	public void setActCostAmtAA(String actCostAmtAA) {
		this.actCostAmtAA = actCostAmtAA;
	}	/**
	 * Column Info
	 * @param actCostAmtA
	 */
	public void setActCostAmtDD(String actCostAmtDD) {
		this.actCostAmtDD = actCostAmtDD;
	}
	 ...
	 * @param estmCostAmtB
	 */
	public void setEstmCostAmtAA(String estmCostAmtAA) {
		this.estmCostAmtAA = estmCostAmtAA;
	}
	/**
	 * Column Info
	 * @param estmCostAmtB
	 */
	public void setEstmCostAmtDD(String estmCostAmtDD) {
		this.estmCostAmtDD = estmCostAmtDD;
	}
	 ...
	 * @param actCostAmtL
	 */
	public void setActCostAmtL(String actCostAmtL) {
		this.actCostAmtL = actCostAmtL;
	}
	 ...
	 * @param actCostAmtM
	 */
	public void setActCostAmtM(String actCostAmtM) {
		this.actCostAmtM = actCostAmtM;
	}
	 ...
	 * @param ibflagG
	 */
	public void setIbflagAA(String ibflagAA) {
		this.ibflagAA = ibflagAA;
	}	/**
	 * Column Info
	 * @param ibflagG
	 */
	public void setIbflagDD(String ibflagDD) {
		this.ibflagDD = ibflagDD;
	}
	 ...
	 * @param ibflagL
	 */
	public void setIbflagL(String ibflagL) {
		this.ibflagL = ibflagL;
	}
	 ...
	 * @param ibflagM
	 */
	public void setIbflagM(String ibflagM) {
		this.ibflagM = ibflagM;
	}
	 ...
	 * @param acclCostAmtK
	 */
	public void setAcclCostAmtAA(String acclCostAmtAA) {
		this.acclCostAmtAA = acclCostAmtAA;
	}
	/**
	 * Column Info
	 * @param acclCostAmtK
	 */
	public void setAcclCostAmtDD(String acclCostAmtDD) {
		this.acclCostAmtDD = acclCostAmtDD;
	}
	 ...
	 * @param acclCostAmtL
	 */
	public void setAcclCostAmtL(String acclCostAmtL) {
		this.acclCostAmtL = acclCostAmtL;
	}
	 ...
	 * @param acclCostAmtM
	 */
	public void setAcclCostAmtM(String acclCostAmtM) {
		this.acclCostAmtM = acclCostAmtM;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEstmCostAmtL(JSPUtil.getParameter(request, "estm_cost_amt_l", ""));
		setEstmCostAmtM(JSPUtil.getParameter(request, "estm_cost_amt_m", ""));
		setEstmCostAmtD(JSPUtil.getParameter(request, "estm_cost_amt_d", ""));
		setEstmCostAmtG(JSPUtil.getParameter(request, "estm_cost_amt_g", ""));
		
		setEstmCostAmtAA(JSPUtil.getParameter(request, "estm_cost_amt_aa", ""));
		setEstmCostAmtDD(JSPUtil.getParameter(request, "estm_cost_amt_dd", ""));
		...
		setIbflagL(JSPUtil.getParameter(request, "ibflag_l", ""));
		setIbflagM(JSPUtil.getParameter(request, "ibflag_m", ""));
		...
		setActCostAmtL(JSPUtil.getParameter(request, "act_cost_amt_l", ""));
		setActCostAmtM(JSPUtil.getParameter(request, "act_cost_amt_m", ""));
		setAcclCostAmtJ(JSPUtil.getParameter(request, "accl_cost_amt_j", ""));
		setAcclCostAmtK(JSPUtil.getParameter(request, "accl_cost_amt_k", ""));
		setAcclCostAmtL(JSPUtil.getParameter(request, "accl_cost_amt_l", ""));
		setAcclCostAmtM(JSPUtil.getParameter(request, "accl_cost_amt_m", ""));		
		...
		setAcclCostAmtAA(JSPUtil.getParameter(request, "accl_cost_amt_aa", ""));
		setAcclCostAmtDD(JSPUtil.getParameter(request, "accl_cost_amt_dd", ""));
	...
	public SearchAccrualBatchResultManualInputListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] estmCostAmtL = (JSPUtil.getParameter(request, prefix	+ "estm_cost_amt_l", length));
			String[] estmCostAmtM = (JSPUtil.getParameter(request, prefix	+ "estm_cost_amt_m", length));
			...
			String[] estmCostAmtAA = (JSPUtil.getParameter(request, prefix	+ "estm_cost_amt_aa", length));
			String[] estmCostAmtDD = (JSPUtil.getParameter(request, prefix	+ "estm_cost_amt_dd", length));
			...
			String[] actCostAmtDD = (JSPUtil.getParameter(request, prefix	+ "act_cost_amt_dd", length));
			String[] actCostAmtAA = (JSPUtil.getParameter(request, prefix	+ "act_cost_amt_aa", length));
			...
			String[] actCostAmtL = (JSPUtil.getParameter(request, prefix	+ "act_cost_amt_l", length));
			String[] actCostAmtM = (JSPUtil.getParameter(request, prefix	+ "act_cost_amt_m", length));
			...
			String[] ibflagL = (JSPUtil.getParameter(request, prefix	+ "ibflag_l", length));
			String[] ibflagM = (JSPUtil.getParameter(request, prefix	+ "ibflag_m", length));
			...
			String[] ibflagAA = (JSPUtil.getParameter(request, prefix	+ "ibflag_aa", length));
			String[] ibflagDD = (JSPUtil.getParameter(request, prefix	+ "ibflag_dd", length));
			...
			String[] acclCostAmtL = (JSPUtil.getParameter(request, prefix	+ "accl_cost_amt_l", length));
			String[] acclCostAmtM = (JSPUtil.getParameter(request, prefix	+ "accl_cost_amt_m", length));
			...
			String[] acclCostAmtAA = (JSPUtil.getParameter(request, prefix	+ "accl_cost_amt_aa", length));
			String[] acclCostAmtDD = (JSPUtil.getParameter(request, prefix	+ "accl_cost_amt_dd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (estmCostAmtL[i] != null)
					model.setEstmCostAmtL(estmCostAmtL[i]);
				if (estmCostAmtM[i] != null)
					model.setEstmCostAmtM(estmCostAmtM[i]);
				...
				if (estmCostAmtAA[i] != null)
					model.setEstmCostAmtAA(estmCostAmtAA[i]);
				if (estmCostAmtDD[i] != null)
					model.setEstmCostAmtDD(estmCostAmtDD[i]);
				...
				if (actCostAmtAA[i] != null)
					model.setActCostAmtAA(actCostAmtAA[i]);
				if (actCostAmtDD[i] != null)
					model.setActCostAmtDD(actCostAmtDD[i]);
				...
				if (actCostAmtL[i] != null)
					model.setActCostAmtL(actCostAmtL[i]);
				if (actCostAmtM[i] != null)
					model.setActCostAmtM(actCostAmtM[i]);
				if (ibflagF[i] != null)
				...
				if (ibflagL[i] != null)
					model.setIbflagL(ibflagL[i]);
				if (ibflagM[i] != null)
					model.setIbflagM(ibflagM[i]);
				if (ibflagD[i] != null)
				...
				if (ibflagB[i] != null)
					model.setIbflagAA(ibflagAA[i]);
				if (ibflagB[i] != null)
					model.setIbflagDD(ibflagDD[i]);
				...
				if (acclCostAmtL[i] != null)
					model.setAcclCostAmtL(acclCostAmtL[i]);
				if (acclCostAmtM[i] != null)
					model.setAcclCostAmtM(acclCostAmtM[i]);
				...
				if (acclCostAmtAA[i] != null)
					model.setAcclCostAmtAA(acclCostAmtAA[i]);
				if (acclCostAmtDD[i] != null)
					model.setAcclCostAmtDD(acclCostAmtDD[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.estmCostAmtL = this.estmCostAmtL .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.estmCostAmtM = this.estmCostAmtM .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.actCostAmtAA = this.actCostAmtAA .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.actCostAmtDD = this.actCostAmtDD .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.actCostAmtL = this.actCostAmtL .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.actCostAmtM = this.actCostAmtM .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ibflagL = this.ibflagL .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ibflagM = this.ibflagM .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.acclCostAmtL = this.acclCostAmtL .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.acclCostAmtM = this.acclCostAmtM .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
