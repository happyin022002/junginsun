...
public class CustomerEdiDBDAOSearchEdiStatusDataRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(", decode(sts.edi_org_tp_cd,1,'America',2,'Europe',3,'Asia',4,'America+Europe',5,'America+Asia',6,'Europe+Asia',7,'All') edi_org_tp_cd" ).append("\n"); 
		query.append(", decode(sts.edi_dest_tp_cd,1,'America',2,'Europe',3,'Asia',4,'America+Europe',5,'America+Asia',6,'Europe+Asia',7,'All') edi_dest_tp_cd" ).append("\n"); 
		...
		query.append("and grp.edi_grp_cd  IN (${convert_group_id})" ).append("\n"); 
