...
public class PrdCreateManageDBDAOUpdatePrdMstTtlTztmUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(" " ).append("\n"); 
		query.append("        DECODE(SUBSTR(PCTL_NO,1,1 ),'W', SUBSTR(VVD,1,4), DECODE(@[t_vvd],'',SUBSTR(VVD,1,4),SUBSTR(@[t_vvd],1,4))), 			        " ).append("\n"); 
		query.append("        DECODE(SUBSTR(PCTL_NO,1,1 ),'W', SUBSTR(VVD,5,4), DECODE(@[t_vvd],'',SUBSTR(VVD,5,4),SUBSTR(@[t_vvd],5,4))),      		    " ).append("\n"); 
		query.append("        DECODE(SUBSTR(PCTL_NO,1,1 ),'W', SUBSTR(VVD,9,1), DECODE(@[t_vvd],'',SUBSTR(VVD,9,1),SUBSTR(@[t_vvd],9,1)))       		    " ).append("\n"); 
