...
*@FileName : CopDetailReceiveDBDAOSearchCopDetailNotInCrntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOSearchCopDetailNotInCrntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchCopDetailNotInCrnt
	  * </pre>
	  */
	public CopDetailReceiveDBDAOSearchCopDetailNotInCrntRSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOSearchCopDetailNotInCrntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
