...
*@FileName : EurOceanFeederCostManageDBDAOSearchFeederCostDGRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOSearchFeederCostDGRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOSearchFeederCostDGRSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOSearchFeederCostDGRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N1ST_CLSS_20FT_SCG_AMT AS IMDG_N1ST_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N1ST_CLSS_40FT_SCG_AMT AS IMDG_N1ST_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N2ND_CLSS_20FT_SCG_AMT AS IMDG_N2ND_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N2ND_CLSS_40FT_SCG_AMT AS IMDG_N2ND_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N3RD_CLSS_20FT_SCG_AMT AS IMDG_N3RD_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N3RD_CLSS_40FT_SCG_AMT AS IMDG_N3RD_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N4TH_CLSS_20FT_SCG_AMT AS IMDG_N4TH_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N4TH_CLSS_40FT_SCG_AMT AS IMDG_N4TH_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N5TH_CLSS_20FT_SCG_AMT AS IMDG_N5TH_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N5TH_CLSS_40FT_SCG_AMT AS IMDG_N5TH_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N6TH_CLSS_20FT_SCG_AMT AS IMDG_N6TH_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N6TH_CLSS_40FT_SCG_AMT AS IMDG_N6TH_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N7TH_CLSS_20FT_SCG_AMT AS IMDG_N7TH_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N7TH_CLSS_40FT_SCG_AMT AS IMDG_N7TH_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N8TH_CLSS_20FT_SCG_AMT AS IMDG_N8TH_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N8TH_CLSS_40FT_SCG_AMT AS IMDG_N8TH_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append(", D.FDR_20FT_TTL_AMT + DG.IMDG_N9TH_CLSS_20FT_SCG_AMT AS IMDG_N9TH_CLSS_20FT_TTL_AMT" ).append("\n"); 
		query.append(", D.FDR_40FT_TTL_AMT + DG.IMDG_N9TH_CLSS_40FT_SCG_AMT AS IMDG_N9TH_CLSS_40FT_TTL_AMT" ).append("\n"); 
		...
		query.append("FROM    AOC_EUR_FDR_DG_TRF_DTL DG" ).append("\n"); 
		query.append(", AOC_EUR_FDR_TRF_DTL D" ).append("\n"); 
		query.append(", AOC_EUR_FDR_TRF_HDR M" ).append("\n"); 
