...
*@FileName : UsaInlandCostManageDBDAOConfirmInlandCostPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOConfirmInlandCostPreVerUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOConfirmInlandCostPreVerUSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOConfirmInlandCostPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
