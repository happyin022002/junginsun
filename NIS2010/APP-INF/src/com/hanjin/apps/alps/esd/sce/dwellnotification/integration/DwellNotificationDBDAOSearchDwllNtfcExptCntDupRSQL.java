...
*@FileName : DwellNotificationDBDAOSearchDwllNtfcExptCntDupRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DwellNotificationDBDAOSearchDwllNtfcExptCntDupRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DwellNotificationDBDAOSearchDwllNtfcExptCntDupRSQL(){
		setQuery();
		...
		query.append("FileName : DwellNotificationDBDAOSearchDwllNtfcExptCntDupRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT COUNT(*) cnt FROM SCE_DWLL_CNTR_EXPT" ).append("\n"); 
