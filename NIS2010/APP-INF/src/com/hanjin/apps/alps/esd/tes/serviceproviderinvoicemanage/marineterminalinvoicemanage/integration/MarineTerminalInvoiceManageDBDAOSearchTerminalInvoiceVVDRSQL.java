...
public class MarineTerminalInvoiceManageDBDAOSearchTerminalInvoiceVVDRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	       V.VSL_CD||V.SKD_VOY_NO||V.SKD_DIR_CD||V.IO_BND_CD||NVL(V.CALL_YD_IND_SEQ,'1')||NVL(V.CLPT_IND_SEQ,'1') VVD,	" ).append("\n"); 
		query.append("		   V.VSL_CD||V.SKD_VOY_NO||V.SKD_DIR_CD VVD_1,                                              " ).append("\n"); 
		...
		query.append("	        FROM   (SELECT COUNT(*), MAX(DECODE(L.VSL_SVC_TP_CD,'O',DECODE((SELECT CRR_CD FROM MDM_VSL_CNTR M WHERE S.VSL_CD=M.VSL_CD(+)),'SML','H','C'),'H')) TP  " ).append("\n"); 
		...
		query.append("			NVL(V.CLPT_IND_SEQ,'1') VVD_CLPT_IND_SEQ," ).append("\n"); 
		query.append("			NVL(V.CALL_YD_IND_SEQ,'1') VVD_CALL_YD_IND_SEQ                                         " ).append("\n"); 
