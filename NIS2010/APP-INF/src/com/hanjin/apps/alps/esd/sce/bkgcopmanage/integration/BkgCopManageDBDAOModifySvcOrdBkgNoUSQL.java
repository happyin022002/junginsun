...
*@FileName : BkgCopManageDBDAOModifySvcOrdBkgNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOModifySvcOrdBkgNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TRS_TRSP_SVC_ORD table 의 booking no 를 cop 별로 수정한다.
	  * </pre>
	  */
	public BkgCopManageDBDAOModifySvcOrdBkgNoUSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOModifySvcOrdBkgNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
