...
public class ComTesEdiRcvRuleMnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComTesEdiRcvRuleMnVO> models = new ArrayList<ComTesEdiRcvRuleMnVO>();
	...
	/* EDI VNDR info - TABLE로 VO만들고 반드시 추가해야 한다.*/
	private ComTesEdiRcvRuleVndrMgmtVO tesEdiRcvRuleVndrVO = null;
	...
	/**
	 * EDI VNDR RULE SETTER
	 * @param tesEdiRcvRuleVndrVOlist
	 */
	public void setComTesEdiRcvRuleVndrMgmtVO(ComTesEdiRcvRuleVndrMgmtVO tesEdiRcvRuleVndrVO){
		this.tesEdiRcvRuleVndrVO = tesEdiRcvRuleVndrVO;
	}

	/**
	 * EDI VNDR RULE GETTER
	 * @return
	 */
	public ComTesEdiRcvRuleVndrMgmtVO getComTesEdiRcvRuleVndrMgmtVO(){
		return this.tesEdiRcvRuleVndrVO;
	}

	/**
	 * EDI VNDR RULE list SETTER
	 * @param tesEdiRcvRuleVndrVOlist
	 */
//	public void setComTesEdiRcvRuleVndrMgmtVOlist(List<ComTesEdiRcvRuleVndrMgmtVO> tesEdiRcvRuleVndrVOlist){
//		this.tesEdiRcvRuleVndrVOlist = tesEdiRcvRuleVndrVOlist;
//	}

	/**
	 * EDI VNDR RULE list GETTER
	 * @return
	 */
//	public List<ComTesEdiRcvRuleVndrMgmtVO> getComTesEdiRcvRuleVndrMgmtVOlist(){
//		return this.tesEdiRcvRuleVndrVOlist;
//	}
...
/**
	 ...
	 */
	public ComTesEdiRcvRuleMnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesEdiRcvRuleMnVO[]
	 */
	public ComTesEdiRcvRuleMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComTesEdiRcvRuleMnVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ComTesEdiRcvRuleMnVO();
				if (updDt[i] != null)
	 ...
	 * @return TesEdiRcvRuleMnVO[]
	 */
	public ComTesEdiRcvRuleMnVO[] getTesEdiRcvRuleMnVOs(){
		ComTesEdiRcvRuleMnVO[] vos = (ComTesEdiRcvRuleMnVO[])models.toArray(new ComTesEdiRcvRuleMnVO[models.size()]);
		return vos;
	}
