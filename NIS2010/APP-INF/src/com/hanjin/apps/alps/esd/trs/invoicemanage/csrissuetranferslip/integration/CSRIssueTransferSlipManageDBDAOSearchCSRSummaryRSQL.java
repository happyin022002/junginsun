...
public class CSRIssueTransferSlipManageDBDAOSearchCSRSummaryRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     				,	CASE WHEN LOC.CNT_CD = 'CN' THEN ORD.CRE_OFC_CD" ).append("\n"); 
		query.append("                             WHEN LOC2.CONTI_CD = 'M' THEN ORD.CRE_OFC_CD" ).append("\n"); 
		query.append("     						 ELSE W.CRE_OFC_CD" ).append("\n"); 
		...
		query.append("					,	W.INV_TTL_AMT" ).append("\n"); 
		query.append("					,	M.GEN_PAY_TERM_CD" ).append("\n"); 
		query.append("					,	'PHXSA'	   			SO_OFC_CD" ).append("\n"); 
		query.append("     				,	W.INV_ISS_DT" ).append("\n"); 
