...
*@FileName : TerminalAgreementManageDBDAODeleteAgreement_modifyDelete01DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAODeleteAgreement_modifyDelete01DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAODeleteAgreement_modifyDelete01DSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAODeleteAgreement_modifyDelete01DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE	TES_TML_AGMT_TP_SZ" ).append("\n"); 
