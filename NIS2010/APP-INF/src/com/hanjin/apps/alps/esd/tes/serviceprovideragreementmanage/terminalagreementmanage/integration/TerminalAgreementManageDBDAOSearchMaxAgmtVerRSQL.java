...
*@FileName : TerminalAgreementManageDBDAOSearchMaxAgmtVerRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAOSearchMaxAgmtVerRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Ver No Max값 조회
	  * </pre>
	  */
	public TerminalAgreementManageDBDAOSearchMaxAgmtVerRSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAOSearchMaxAgmtVerRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  LPAD(MAX(tml_agmt_ver_no), 4, '0') tml_agmt_ver_no" ).append("\n"); 
		...
		query.append("GROUP BY tml_agmt_ver_no" ).append("\n"); 
