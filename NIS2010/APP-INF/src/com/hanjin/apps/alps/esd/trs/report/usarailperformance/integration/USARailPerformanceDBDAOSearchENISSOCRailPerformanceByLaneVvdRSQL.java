...
*@FileName : USARailPerformanceDBDAOSearchENISSOCRailPerformanceByLaneVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchENISSOCRailPerformanceByLaneVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchENISSOCRailPerformance SELECT by Lane VVD
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchENISSOCRailPerformanceByLaneVvdRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchENISSOCRailPerformanceByLaneVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
