...
*@FileName : TESInterfaceManageDBDAOCreateEDInvoiceHDRTmpDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInterfaceManageDBDAOCreateEDInvoiceHDRTmpDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * createEDInvoiceHDRTmpData
	  * </pre>
	  */
	public TESInterfaceManageDBDAOCreateEDInvoiceHDRTmpDataCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.common.tesinterface.integration").append("\n"); 
		query.append("FileName : TESInterfaceManageDBDAOCreateEDInvoiceHDRTmpDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
