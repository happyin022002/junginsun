...
*@FileName : LogisticsRevenueDBDAOCreateMultiInvoiceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogisticsRevenueDBDAOCreateMultiInvoiceRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LogisticsRevenueDBDAOCreateMultiInvoiceRSQL(){
		setQuery();
		...
		params.put("s_cntr_rtn_yd_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("grp_cfm_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_src_inv_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("out_rtn_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_cntr_rtn_dt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_dtl_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_curr",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_new_bkg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_re_yd_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("out_inv_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_cfm_tp",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("out_tpb_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_dtl_rmk",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("s_rev_inv_rt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LogisticsRevenueDBDAOCreateMultiInvoiceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("CALL TPB_CRE_IF_DATA_REV_PRC(" ).append("\n"); 
		query.append(" @[s_n3pty_if_tp_cd]" ).append("\n"); 
		query.append(",@[s_cfm_tp]" ).append("\n"); 
		...
		query.append(",@[s_dtl_amt]" ).append("\n"); 
		query.append(",@[s_dtl_rmk]" ).append("\n"); 
		query.append(",@[s_re_yd_cd]" ).append("\n"); 
		query.append(",@[s_usr_ofc_cd]" ).append("\n"); 
		query.append(",@[s_usr_id]" ).append("\n"); 
		query.append(",@[eq_no]" ).append("\n"); 
		query.append(",@[out_tpb_no]" ).append("\n"); 
		query.append(",@[out_inv_no]" ).append("\n"); 
		query.append(",@[out_rtn_cd]" ).append("\n"); 
		query.append(")" ).append("\n"); 
