...
public class PrdSceGetParamVO extends AbstractValueObject {
	...
	public PrdSceGetParamVO(String ibflag, String pagerows, String ibTrspMode, String mtRtn, String inBound, String copNo, String polT, String routOrgNodCd, String cct, String pctlNo, String podT, String polCd, String tVvd, String n2PodClptSeq, String cntrTpszCd, String delNodCd, String manualFlag, String n1PodClptSeq, String n4PolClptSeq, String pol4, String delCd, String pol3, String pol2, String pol1, String fullRtnYdCd, String vvd2, String vvd3, String routSeq, String vvd1, String pod2, String podCd, String pod1, String pod4, String vvd4, String pod3, String newPod, String mtPu, String obInclShtlSoFlg, String outBound, String newPol, String porCd, String orgLocCd, String destLocCd, String n3PolClptSeq, String ocnBound, String n2PolClptSeq, String eurCheck, String n3PodClptSeq, String obTroFlg, String obTrspMode, String n1PolClptSeq, String fullPkupYdCd, String routDestNodCd, String rcvTermCd, String lane4, String porNodCd, String ocnSeq, String lane2, String ioBndCd, String lane3, String lane1, String deTermCd, String n4PodClptSeq, String cntrNo, String ibTroFlg, String polYdCd, String ibInclShtlSoFlg, String skipActValFlg, String prmCustFlg, String polEtdDt) {
