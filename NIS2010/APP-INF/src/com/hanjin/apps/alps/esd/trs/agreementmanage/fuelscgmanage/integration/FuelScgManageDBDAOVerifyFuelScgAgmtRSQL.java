...
*@FileName : FuelScgManageDBDAOVerifyFuelScgAgmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAOVerifyFuelScgAgmtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement Fuel Surcharge(FUA) Verify
	  * </pre>
	  */
	public FuelScgManageDBDAOVerifyFuelScgAgmtRSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAOVerifyFuelScgAgmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
