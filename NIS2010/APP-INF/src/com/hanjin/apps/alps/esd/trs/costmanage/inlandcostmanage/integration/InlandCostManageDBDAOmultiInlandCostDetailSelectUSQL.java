...
*@FileName : InlandCostManageDBDAOmultiInlandCostDetailSelectUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOmultiInlandCostDetailSelectUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOmultiInlandCostDetailSelectUSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOmultiInlandCostDetailSelectUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
