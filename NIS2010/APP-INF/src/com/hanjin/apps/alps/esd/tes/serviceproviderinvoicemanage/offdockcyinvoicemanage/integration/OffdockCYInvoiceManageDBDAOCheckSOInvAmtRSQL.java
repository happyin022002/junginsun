...
*@FileName : OffdockCYInvoiceManageDBDAOCheckSOInvAmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOCheckSOInvAmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOCheckSOInvAmtRSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOCheckSOInvAmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
