...
*@FileName : InvoiceInquiryCorrectionDBDAOConfirmCancelInvoiceConfirmYnRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceInquiryCorrectionDBDAOConfirmCancelInvoiceConfirmYnRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Invoice Confirm 여부를 조회
	  * </pre>
	  */
	public InvoiceInquiryCorrectionDBDAOConfirmCancelInvoiceConfirmYnRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceInquiryCorrectionDBDAOConfirmCancelInvoiceConfirmYnRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
