...
*@FileName : ESD_AOC_3004HTMLAction.java
...
* --------------------------------------------------------
* History
* 2012.10.04 변종건 [CHM-201220395] Inland Cost Management - Cost Detail(EUR) 생성
=========================================================*/
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3004HTMLAction 객체를 생성
	 */
	public ESD_AOC_3004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3004Event event = new EsdAoc3004Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchInlandCostAccountVO((EurInlandCostAccountVO)getVO(request, EurInlandCostAccountVO .class));
		}
