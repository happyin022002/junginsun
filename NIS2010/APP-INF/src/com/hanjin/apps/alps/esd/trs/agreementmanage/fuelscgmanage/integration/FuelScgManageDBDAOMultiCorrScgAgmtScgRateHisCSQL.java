...
*@FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisCSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
