...
*@FileName : EurInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOMultiInlandCostDetailSelectUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
