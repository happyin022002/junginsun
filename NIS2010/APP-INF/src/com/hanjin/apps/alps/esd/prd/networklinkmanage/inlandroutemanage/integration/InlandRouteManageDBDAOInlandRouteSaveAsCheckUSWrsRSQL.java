...
*@FileName : InlandRouteManageDBDAOInlandRouteSaveAsCheckWrsRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOInlandRouteSaveAsCheckUSWrsRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InlandRouteSaveAsCheckWrs
	  * </pre>
	  */
	public InlandRouteManageDBDAOInlandRouteSaveAsCheckUSWrsRSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOInlandRouteSaveAsCheckWrsRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
