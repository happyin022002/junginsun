...
*@FileName : ESD_AOC_3111HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3111HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3111HTMLAction 객체를 생성
	 */
	public ESD_AOC_3111HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3111Event event = new EsdAoc3111Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setSearchStatusMonitorVO((AsiaStatusMonitorVO)getVO(request, AsiaStatusMonitorVO .class));
