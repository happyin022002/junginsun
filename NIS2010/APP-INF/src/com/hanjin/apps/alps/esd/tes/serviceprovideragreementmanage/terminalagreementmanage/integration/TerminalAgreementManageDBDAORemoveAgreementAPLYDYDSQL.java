...
*@FileName : TerminalAgreementManageDBDAORemoveAgreementAPLYDYDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAORemoveAgreementAPLYDYDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAORemoveAgreementAPLYDYDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAORemoveAgreementAPLYDYDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM  TES_TML_AGMT_APLY_DY" ).append("\n"); 
