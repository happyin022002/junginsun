...
*@FileName : ESD_LEA_0012HTMLAction.java
...
public class ESD_LEA_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_LEA_0012HTMLAction 객체를 생성
	 */
	public ESD_LEA_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdLea0012Event event = new EsdLea0012Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchActualCostCSRListVO((SearchActualCostCSRListVO)getVO(request, SearchActualCostCSRListVO .class));
		}
