...
*@FileName : RailSoManageDBDAOSearch01RailSoManageCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAOSearch01RailSoManageCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * US Rail I/B SO 대상 추가 SQL
	  * </pre>
	  */
	public RailSoManageDBDAOSearch01RailSoManageCSQL(){
		setQuery();
		...
		params.put("tmp_nod_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : RailSoManageDBDAOSearch01RailSoManageCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("@[tmp_nod_cd]," ).append("\n"); 
		query.append("@[high_val_cgo_tp_cd]," ).append("\n"); 
		query.append("@[blck_stwg_cd]," ).append("\n"); 
