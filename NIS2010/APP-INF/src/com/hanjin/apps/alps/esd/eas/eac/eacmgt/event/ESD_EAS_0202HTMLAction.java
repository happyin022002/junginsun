...
*@FileName : ESD_EAS_0202HTMLAction.java
...
public class ESD_EAS_0202HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0202HTMLAction 객체를 생성
	 */
	public ESD_EAS_0202HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0202Event event = new EsdEas0202Event();
		...
		if(command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setEacSpContactPointVOs((EACSpCtrtVO[])getVOs(request, EACSpCtrtVO.class,""));
		}
