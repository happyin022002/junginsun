...
*@FileName : ESD_EAS_0103HTMLAction.java
*@FileTitle : DEAS DOD Payer Info & Fax/E-mail
*Open Issues :
*Change history :
...
public class ESD_EAS_0103HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0103HTMLAction 객체를 생성
	 */
	public ESD_EAS_0103HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdEas0103Event event = new EsdEas0103Event();
        log.debug("\n ::CALL::> ESD_EAS_0103HTMLAction - " + command.getCommand());
		...
		if(command.isCommand(FormCommand.SEARCH)) {
    		...
    		//PayrInfoVO
    		event.setEasPayrInfoVO((EasPayrInfoVO)getVO(request, EasPayrInfoVO.class));
    		//PayrCntcPntVOs
    		EasPayrCntcPntVO easPayrCntcPntVO = new EasPayrCntcPntVO();
    		event.setEasPayrCntcPntVOs(easPayrCntcPntVO.fromRequestGrid(request, "cntc_pnt"));
        }
