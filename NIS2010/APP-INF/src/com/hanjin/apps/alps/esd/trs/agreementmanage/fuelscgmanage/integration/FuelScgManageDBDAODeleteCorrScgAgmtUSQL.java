...
*@FileName : FuelScgManageDBDAODeleteCorrScgAgmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAODeleteCorrScgAgmtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AGMT SURCHARGE RATE 삭제
	  * </pre>
	  */
	public FuelScgManageDBDAODeleteCorrScgAgmtUSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAODeleteCorrScgAgmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
