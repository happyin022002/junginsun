...
*@FileName : DODInvoiceMgtDBDAOSearchPayerEmailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DODInvoiceMgtDBDAOSearchPayerEmailRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DODInvoiceMgtDBDAOSearchPayerEmailRSQL(){
		setQuery();
		...
		query.append("FileName : DODInvoiceMgtDBDAOSearchPayerEmailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,CNTC_PNT_EML 	AS CNTC_PNT_EML" ).append("\n"); 
		...
		query.append("	,IB_EML    AS CNTC_PNT_EML" ).append("\n"); 
		...
		query.append("SELECT DISTINCT 'MDM' AS JOB_TP" ).append("\n"); 
		query.append("    ,'GENERAL'    AS GUBUN" ).append("\n"); 
		query.append("    , B.CUST_EML 	AS CNTC_PNT_EML" ).append("\n"); 
