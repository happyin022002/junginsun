...
*@FileName : DODInvoiceMgtDBDAOAddAddDODInvoiceMainCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DODInvoiceMgtDBDAOAddAddDODInvoiceMainCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DODInvoiceMgtDBDAOAddAddDODInvoiceMainCSQL(){
		setQuery();
		...
		query.append("FileName : DODInvoiceMgtDBDAOAddAddDODInvoiceMainCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
