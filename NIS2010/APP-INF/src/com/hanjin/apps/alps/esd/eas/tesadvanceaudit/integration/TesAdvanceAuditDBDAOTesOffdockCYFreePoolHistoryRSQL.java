...
*@FileName : TesAdvanceAuditDBDAOTesOffdockCYFreePoolHistoryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesAdvanceAuditDBDAOTesOffdockCYFreePoolHistoryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TesOffdockCYFreePoolHistory
	  * </pre>
	  */
	public TesAdvanceAuditDBDAOTesOffdockCYFreePoolHistoryRSQL(){
		setQuery();
		...
		query.append("FileName : TesAdvanceAuditDBDAOTesOffdockCYFreePoolHistoryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
