...
*@FileName : UsaStatusMonitorVO.java
*@FileTitle : UsaStatusMonitorVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class UsaStatusMonitorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaStatusMonitorVO> models = new ArrayList<UsaStatusMonitorVO>();
...
/**
	 ...
	 */
	public UsaStatusMonitorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaStatusMonitorVO[]
	 */
	public UsaStatusMonitorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaStatusMonitorVO model = null;
	...
	public UsaStatusMonitorVO[] getSearchStatusMonitorVOs(){
		UsaStatusMonitorVO[] vos = (UsaStatusMonitorVO[])models.toArray(new UsaStatusMonitorVO[models.size()]);
		return vos;
	}
