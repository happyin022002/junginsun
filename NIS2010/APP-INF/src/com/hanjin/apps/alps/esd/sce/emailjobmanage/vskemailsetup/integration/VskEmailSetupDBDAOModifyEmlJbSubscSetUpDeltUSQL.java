...
*@FileName : VskEmailSetupDBDAOModifyEmlJbSubscSetUpDeltUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VskEmailSetupDBDAOModifyEmlJbSubscSetUpDeltUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSL E-MAIL 대상 Delt Flag 변경 ( SCE_EML_JB_SUBSC )
	  * </pre>
	  */
	public VskEmailSetupDBDAOModifyEmlJbSubscSetUpDeltUSQL(){
		setQuery();
		...
		query.append("FileName : VskEmailSetupDBDAOModifyEmlJbSubscSetUpDeltUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
