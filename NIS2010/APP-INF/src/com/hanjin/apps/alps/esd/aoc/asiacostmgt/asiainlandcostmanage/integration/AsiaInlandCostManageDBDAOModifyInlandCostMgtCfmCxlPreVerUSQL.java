...
*@FileName : AsiaInlandCostManageDBDAOModifyInlandCostMgtCfmCxlPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOModifyInlandCostMgtCfmCxlPreVerUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyInlandCostMgtCfmCxlPreVer
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOModifyInlandCostMgtCfmCxlPreVerUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOModifyInlandCostMgtCfmCxlPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                          AND IO_BND_CD = substr(@[in_cost_trf_no], -1)" ).append("\n"); 
