...
*@FileName : SpecialCargoQuotationManageDBDAOmodifyAwkCgoTsTrfTpSzUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoQuotationManageDBDAOmodifyAwkCgoTsTrfTpSzUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyAwkCgoTsTrfTpSz
	  * </pre>
	  */
	public SpecialCargoQuotationManageDBDAOmodifyAwkCgoTsTrfTpSzUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoQuotationManageDBDAOmodifyAwkCgoTsTrfTpSzUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND V.IO_BND_CD = DECODE(UPPER(@[io_bnd_cd]),'DEFAULT','A',@[io_bnd_cd])" ).append("\n"); 
		query.append("AND V.IO_GA_CD = DECODE(UPPER(@[io_ga_cd]),'DEFAULT','A','IN','I','OOG','O',@[io_ga_cd])" ).append("\n"); 
		query.append("AND V.TML_AWK_TS_CD = DECODE(UPPER(@[tml_awk_ts_cd]),'DEFAULT','A','DIFF','D','SAME','S',@[tml_awk_ts_cd])" ).append("\n"); 
