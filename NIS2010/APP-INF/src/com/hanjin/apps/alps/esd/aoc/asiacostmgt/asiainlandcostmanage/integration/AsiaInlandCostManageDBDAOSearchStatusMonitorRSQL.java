...
*@FileName : AsiaInlandCostManageDBDAOSearchStatusMonitorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchStatusMonitorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchStatusMonitorRSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOSearchStatusMonitorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , ( SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID = 'CD03051' AND INTG_CD_VAL_CTNT = AA.COST_TRF_STS_CD AND ROWNUM <= 1 ) COST_TRF_STS_NM" ).append("\n"); 
		...
		query.append("                , AOC_TRF_CURR			B" ).append("\n"); 
		...
		query.append("                                                     , AOC_CHN_INLND_TRF_HDR C" ).append("\n"); 
		...
		query.append("                             GROUP BY COST_TRF_NO, SVC_SCP_CD" ).append("\n"); 
		query.append("                            ) A" ).append("\n"); 
		...
		query.append("                , A.UPD_DT     C_UPD_DT" ).append("\n"); 
		query.append("                , A.UPD_USR_ID C_UPD_USR_ID" ).append("\n"); 
		query.append("          FROM    AOC_CHN_FDR_TRF_HDR	A" ).append("\n"); 
		query.append("          WHERE   1 = 1" ).append("\n"); 
		query.append("          AND     A.COST_TRF_STS_CD IN ('B','U','C')" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${combo_rhq} != '')" ).append("\n"); 
		...
		query.append("          AND     A.COST_TRF_NO IN (" ).append("\n"); 
		query.append("                                     SELECT  H.COST_TRF_NO" ).append("\n"); 
		query.append("                                     FROM    AOC_CHN_FDR_TRF_HDR H" ).append("\n"); 
		query.append("                                           ," ).append("\n"); 
		query.append("                                             (" ).append("\n"); 
		query.append("                                               SELECT  A.RHQ_CD" ).append("\n"); 
		...
		query.append("                                                     , AOC_CHN_FDR_TRF_HDR C" ).append("\n"); 
