 ...
 * @since J2EE 1.5
 */
public class EsdSce0160ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		DwellRnsVO vo = null;
		DwellRnsVO conditionVO = (DwellRnsVO) vos.get(0);
		String row = "";
	    vo = (DwellRnsVO) vos.get(1);
	  //  if (vo != null && !"".equals(vo)){
	    	...
	    	sbufXML.append("<TD COL=\"dwll_rsn\" DATA-TYPE=\"dtData\"><![CDATA[" + JSPUtil.getNull(cloumndata[0].toString()) +"]]></TD>\n");
	    	sbufXML.append("</TR>\n");
	    	sbufXML.append("</DATA>\n");
