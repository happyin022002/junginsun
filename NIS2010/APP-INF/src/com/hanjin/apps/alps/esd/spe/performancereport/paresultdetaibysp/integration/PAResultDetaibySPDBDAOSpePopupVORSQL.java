...
*@FileName : PAResultDetaibySPDBDAOSpePopupVORSQL.java
...
public class PAResultDetaibySPDBDAOSpePopupVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PAResultDetaibySPDBDAOSpePopupVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.spe.performancereport.paresultdetaibysp.integration").append("\n"); 
		query.append("FileName : PAResultDetaibySPDBDAOSpePopupVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
