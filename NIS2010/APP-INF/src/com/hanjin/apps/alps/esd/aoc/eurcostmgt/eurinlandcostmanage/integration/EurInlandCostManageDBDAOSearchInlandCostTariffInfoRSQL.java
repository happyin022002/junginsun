...
*@FileName : EurInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlandCostTariffInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
