...
*@FileName : EurInlandCostManageDBDAOMultiInlandCostSpecialCargoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOMultiInlandCostSpecialCargoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOMultiInlandCostSpecialCargoDSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOMultiInlandCostSpecialCargoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM AOC_EUR_INLND_SPCL_TRF_DTL" ).append("\n"); 
