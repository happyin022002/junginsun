...
*@FileName : Edi315SendDBDAOSearchCOPInfoPodRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Edi315SendDBDAOSearchCOPInfoPodRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Edi315SendDBDAOSearchCOPInfoPodRSQL(){
		setQuery();
		...
		query.append("FileName : Edi315SendDBDAOSearchCOPInfoPodRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
