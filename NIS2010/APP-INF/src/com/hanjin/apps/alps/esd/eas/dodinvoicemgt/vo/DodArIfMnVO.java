...
*@FileName : DodArIfMnVO.java
*@FileTitle : DodArIfMnVO
*Open Issues :
*Change history :
*@LastModifyDate :  
*@LastModifier :  
...
public class DodArIfMnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DodArIfMnVO> models = new ArrayList<DodArIfMnVO>();
	...
	/**
	 * @param ofcTrnsFlg the ofcTrnsFlg to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDodInvStsCd(JSPUtil.getParameter(request, "dod_inv_sts_cd", ""));
	}
	 ...
	 * @return DodArIfMnVO[]
	 */
	public DodArIfMnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DodArIfMnVO[]
	 */
	public DodArIfMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DodArIfMnVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				if (arIfFlg [i] != null)	model.setArIfFlg    (arIfFlg [i]);
				if (dodInvStsCd[i] != null)	model.setDodInvStsCd(dodInvStsCd[i]);
				models.add(model);
			}
	 ...
	 * @return DodArIfMnVO[]
	 */
	public DodArIfMnVO[] getDodArIfMnVOs(){
		DodArIfMnVO[] vos = (DodArIfMnVO[])models.toArray(new DodArIfMnVO[models.size()]);
		return vos;
	}
