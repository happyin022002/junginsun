...
*@FileName : ESD_AOC_3031HTMLAction.java
 ...
 *
 * @author 
 * @see EsdAoc3031Event 참조
 * @since J2EE 1.4
 */
public class ESD_AOC_3031HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_AOC_3031HTMLAction 객체를 생성
	 */
	public ESD_AOC_3031HTMLAction(){}
...
public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3031Event event = new EsdAoc3031Event();
