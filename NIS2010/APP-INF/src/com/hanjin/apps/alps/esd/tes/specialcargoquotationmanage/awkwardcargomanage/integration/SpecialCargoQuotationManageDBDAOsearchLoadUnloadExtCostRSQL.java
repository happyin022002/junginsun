...
*@FileName : SpecialCargoQuotationManageDBDAOsearchLoadUnloadExtCostRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoQuotationManageDBDAOsearchLoadUnloadExtCostRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchLoadUnloadExtCost
	  * </pre>
	  */
	public SpecialCargoQuotationManageDBDAOsearchLoadUnloadExtCostRSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoQuotationManageDBDAOsearchLoadUnloadExtCostRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT" ).append("\n"); 
		query.append("DENSE_RANK() OVER (PARTITION BY P.YD_CD, P.TML_AWK_CGO_TRF_TP_CD, P.IO_BND_CD, P.IO_GA_CD, P.TML_AWK_TS_CD, P.COND_NO  ORDER BY P.YD_CD, P.TML_AWK_CGO_TRF_TP_CD, P.IO_BND_CD, P.IO_GA_CD, P.TML_AWK_TS_CD, P.COND_NO, P.TML_AWK_TRF_VER_NO DESC) RN," ).append("\n"); 
		...
		query.append("AND TS.TML_AWK_CGO_TRF_TP_CD = 'B' --B로 고정" ).append("\n"); 
		...
		query.append("AND AD.TML_AWK_CGO_TRF_TP_CD = 'B'" ).append("\n"); 
