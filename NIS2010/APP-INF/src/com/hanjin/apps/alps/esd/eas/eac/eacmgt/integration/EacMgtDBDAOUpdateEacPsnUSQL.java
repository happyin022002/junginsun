...
*@FileName : EacMgtDBDAOUpdateEacPsnUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOUpdateEacPsnUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Personnel Config 를 수정한다.
	  * </pre>
	  */
	public EacMgtDBDAOUpdateEacPsnUSQL(){
		setQuery();
		...
		query.append("FileName : EacMgtDBDAOUpdateEacPsnUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EAS_EXPN_AUD_CS_PSON_CFG" ).append("\n"); 
		query.append("SET    EAC_USR_NM        = @[eac_usr_nm]       " ).append("\n"); 
		query.append("     , PHN_NO            = @[phn_no]           " ).append("\n"); 
		query.append("     , FAX_NO            = @[fax_no]           " ).append("\n"); 
		query.append("     , USR_EML           = @[usr_eml]          " ).append("\n"); 
		query.append("     , NTC_CC_RCV_EML    = @[ntc_cc_rcv_eml]   " ).append("\n"); 
		query.append("     , EXPN_AUD_SCP_DESC = @[expn_aud_scp_desc]" ).append("\n"); 
