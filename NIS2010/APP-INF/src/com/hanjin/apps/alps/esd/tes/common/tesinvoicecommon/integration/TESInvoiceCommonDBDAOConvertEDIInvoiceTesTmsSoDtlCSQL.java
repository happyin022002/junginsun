...
*@FileName : TESInvoiceCommonDBDAOConvertEDIInvoiceTesTmsSoDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInvoiceCommonDBDAOConvertEDIInvoiceTesTmsSoDtlCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ConvertEDIInvoiceTesTmsSoDtl
	  * </pre>
	  */
	public TESInvoiceCommonDBDAOConvertEDIInvoiceTesTmsSoDtlCSQL(){
		setQuery();
		...
		query.append("FileName : TESInvoiceCommonDBDAOConvertEDIInvoiceTesTmsSoDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
