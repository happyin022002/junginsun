...
*@FileName : DistanceCreationDBDAOmultiTrsAgmtDistHisInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DistanceCreationDBDAOmultiTrsAgmtDistHisInsertCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * multiTrsAgmtDistHisInsert
	  * </pre>
	  */
	public DistanceCreationDBDAOmultiTrsAgmtDistHisInsertCSQL(){
		setQuery();
		...
		query.append("FileName : DistanceCreationDBDAOmultiTrsAgmtDistHisInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
