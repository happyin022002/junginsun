...
*@FileName : InlandCostManageDBDAOmultiInlandCostDetailRestUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOmultiInlandCostDetailRestUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOmultiInlandCostDetailRestUSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOmultiInlandCostDetailRestUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
