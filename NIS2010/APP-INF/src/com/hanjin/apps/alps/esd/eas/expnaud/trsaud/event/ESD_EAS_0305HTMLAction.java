...
*@FileName : ESD_EAS_0305HTMLAction.java
...
public class ESD_EAS_0305HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0305HTMLAction 객체를 생성
	 */
	public ESD_EAS_0305HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0305Event event = new EsdEas0305Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setSurchargeReportVO((SurchargeReportVO)getVO(request, SurchargeReportVO .class));
		}
