...
*@FileName : CopDetailReceiveDBDAOAddSceSvcPtalVpsIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopDetailReceiveDBDAOAddSceSvcPtalVpsIfCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CopDetailReceiveDBDAOAddSceSvcPtalVpsIfCSQL(){
		setQuery();
		...
		query.append("FileName : CopDetailReceiveDBDAOAddSceSvcPtalVpsIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCE_SVC_PTAL_VPS_IF(" ).append("\n"); 
		...
		query.append(",sce_svc_ptal_vps_if_seq1.nextval" ).append("\n"); 
		query.append(",@[vsl_cd]" ).append("\n"); 
		query.append(",@[skd_voy_no]" ).append("\n"); 
		query.append(",@[skd_dir_cd]" ).append("\n"); 
		query.append(",@[vps_port_cd]" ).append("\n"); 
		query.append(",@[clpt_ind_seq]" ).append("\n"); 
		query.append(",DECODE(@[act_rcv_tp_cd],'24','ETA','25','ETB','26','ETD','28','ETA','29','ETB','30','ETD')" ).append("\n"); 
