...
*@FileName : EacMgtDBDAOsearchAutoAudFileRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOsearchAutoAudFileRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Auto Audit 첨부파일 내역 조회
	  * </pre>
	  */
	public EacMgtDBDAOsearchAutoAudFileRSQL(){
		setQuery();
		...
		query.append("FileName : EacMgtDBDAOsearchAutoAudFileRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM EAS_ATCH_FILE FLE" ).append("\n"); 
