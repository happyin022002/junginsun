...
*@FileName : TESeBillingManageBizType003DBDAOCreateEDInvoicePSAHDRTmpDataUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESeBillingManageBizType003DBDAOCreateEDInvoicePSAHDRTmpDataUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESeBillingManageBizType003DBDAOCreateEDInvoicePSAHDRTmpDataUSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.edi.ebilling.integration ").append("\n"); 
		query.append("FileName : TESeBillingManageBizType003DBDAOCreateEDInvoicePSAHDRTmpDataUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
