...
*@FileName : CARIssueTransferSlipManageDBDAOModifyApInvDTRBLineNoUpdate02USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CARIssueTransferSlipManageDBDAOModifyApInvDTRBLineNoUpdate02USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyApInvDTRBLineNoUpdate02
	  * </pre>
	  */
	public CARIssueTransferSlipManageDBDAOModifyApInvDTRBLineNoUpdate02USQL(){
		setQuery();
		...
		query.append("FileName : CARIssueTransferSlipManageDBDAOModifyApInvDTRBLineNoUpdate02USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	    AND NVL(FTU_USE_CTNT1,'N') = @[ftu_use_ctnt1]" ).append("\n"); 
