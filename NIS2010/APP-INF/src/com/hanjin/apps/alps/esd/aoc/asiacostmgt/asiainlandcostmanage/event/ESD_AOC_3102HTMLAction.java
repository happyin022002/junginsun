...
*@FileName : ESD_AOC_3102HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3102HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3102HTMLAction 객체를 생성
	 */
	public ESD_AOC_3102HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3102Event event = new EsdAoc3102Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInlandCostConditionVO((AsiaInlandCostConditionVO)getVO(request, AsiaInlandCostConditionVO .class));
			...
			event.setInlandCostConditionVO((AsiaInlandCostConditionVO)getVO(request, AsiaInlandCostConditionVO .class));
			event.setInlandCostVOS((AsiaInlandCostVO[])getVOs(request, AsiaInlandCostVO .class,""));
		} else if(command.isCommand(FormCommand.MULTI02)) {
			event.setInBtnSts(JSPUtil.getParameter(request, "in_btn_sts", ""));
			event.setInlandCostConditionVO((AsiaInlandCostConditionVO)getVO(request, AsiaInlandCostConditionVO .class));
			event.setInlandCostSpecialCargoVOS((AsiaInlandCostSpecialCargoVO[])getVOs(request, AsiaInlandCostSpecialCargoVO .class,""));
