...
public class SearchAccrualBatchResultInvoiceInquiryVO extends AbstractValueObject {
	...
	/* Column Info */
	private String fOtherCarrierExpense = null;
	/* Column Info */
	...
	public SearchAccrualBatchResultInvoiceInquiryVO(String ibflag, String pagerows, String acctCd, String coaCostSrcCd, String ctrlOfcCd, String currCd, String exeYrmon, String fCostTypeC, String fCostTypeEv, String fCostTypeF, String fCostTypeFv, String fCostTypeM, String fCostTypeV, String fCtrlOfcCd, String fOtherCarrierExpense, String fReport, String fRhqCd, String fVndr, String fSubOfcCd, String frmExeYrmonFrom, String frmExeYrmonTo, String loclCostAmt, String mnCostTpNm, String n1stNodCd, String n2ndNodCd, String n3rdNodCd, String n4thNodCd, String revYrmon, String rhqCd, String subCostTpNm, String subOfcCd, String usdCostAmt, String vndrLglEngNm, String vndrSeq, String bindOfcCd, String bindSubOfcCd) {
		...
		this.ibflag = ibflag;
		this.fOtherCarrierExpense = fOtherCarrierExpense;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("f_other_carrier_expense", getFOtherCarrierExpense());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("f_other_carrier_expense", "fOtherCarrierExpense");
	...
	/**
	 * Column Info
	 * @return fOtherCarrierExpense
	 */
	public String getFOtherCarrierExpense() {
		return this.fOtherCarrierExpense;
	}
	...
	/**
	 * Column Info
	 * @param fOtherCarrierExpense
	 */
	public void setFOtherCarrierExpense(String fOtherCarrierExpense) {
		this.fOtherCarrierExpense = fOtherCarrierExpense;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setFrmExeYrmonTo(JSPUtil.getParameter(request, prefix + "frm_exe_yrmon_to", ""));
		setCurrCd(JSPUtil.getParameter(request, prefix + "curr_cd", ""));
		setCoaCostSrcCd(JSPUtil.getParameter(request, prefix + "coa_cost_src_cd", ""));
		setUsdCostAmt(JSPUtil.getParameter(request, prefix + "usd_cost_amt", ""));
		...
		setFOtherCarrierExpense(JSPUtil.getParameter(request, prefix + "f_other_carrier_expense", ""));
		setFrmExeYrmonFrom(JSPUtil.getParameter(request, prefix + "frm_exe_yrmon_from", ""));
		setAcctCd(JSPUtil.getParameter(request, prefix + "acct_cd", ""));
		setFCostTypeM(JSPUtil.getParameter(request, prefix + "f_cost_type_m", ""));
		setFVndr(JSPUtil.getParameter(request, prefix + "f_vndr", ""));
		...
		setLoclCostAmt(JSPUtil.getParameter(request, prefix + "locl_cost_amt", ""));
	...
	public SearchAccrualBatchResultInvoiceInquiryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] fOtherCarrierExpense = (JSPUtil.getParameter(request, prefix	+ "f_other_carrier_expense", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (fOtherCarrierExpense[i] != null)
					model.setFOtherCarrierExpense(fOtherCarrierExpense[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.fOtherCarrierExpense = this.fOtherCarrierExpense .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
