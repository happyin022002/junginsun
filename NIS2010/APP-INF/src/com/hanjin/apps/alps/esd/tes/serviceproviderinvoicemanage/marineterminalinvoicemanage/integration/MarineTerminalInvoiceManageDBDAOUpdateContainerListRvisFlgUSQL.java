...
*@FileName : MarineTerminalInvoiceManageDBDAOUpdateContainerListRvisFlgUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOUpdateContainerListRvisFlgUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * UpdateContainerListRvisFlg
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOUpdateContainerListRvisFlgUSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOUpdateContainerListRvisFlgUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#elseif (${lgs_cost_cd} == 'CG')" ).append("\n"); 
		query.append("CGO_RVIS_IND_FLG = DECODE(@[rvis_ind_flg],'1','Y','N')" ).append("\n"); 
