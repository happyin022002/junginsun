...
*@FileName : ESD_AOC_3003HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3003HTMLAction 객체를 생성
	 */
	public ESD_AOC_3003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3003Event event = new EsdAoc3003Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInlandCostConditionVO((EurInlandCostConditionVO)getVO(request, EurInlandCostConditionVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setInlandCostConditionVO((EurInlandCostConditionVO)getVO(request, EurInlandCostConditionVO .class));
			event.setInlandCostDetailVOS((EurInlandCostDetailVO[])getVOs(request, EurInlandCostDetailVO .class,""));
