...
*@FileName : TrsCommonDBDAOAddFileCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrsCommonDBDAOAddFileCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * TrsCommonDBDAOAddFileCSQL
	  * </pre>
	  */
	public TrsCommonDBDAOAddFileCSQL(){
		setQuery();
		...
		query.append("FileName : TrsCommonDBDAOAddFileCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TRS_ATCH_FILE (" ).append("\n"); 
