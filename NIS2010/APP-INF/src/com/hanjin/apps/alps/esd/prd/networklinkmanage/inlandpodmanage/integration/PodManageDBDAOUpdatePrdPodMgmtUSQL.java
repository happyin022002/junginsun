...
*@FileName : PodManageDBDAOUpdatePrdPodMgmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PodManageDBDAOUpdatePrdPodMgmtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PodManageDBDAOUpdatePrdPodMgmtUSQL(){
		setQuery();
		...
		query.append("FileName : PodManageDBDAOUpdatePrdPodMgmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
