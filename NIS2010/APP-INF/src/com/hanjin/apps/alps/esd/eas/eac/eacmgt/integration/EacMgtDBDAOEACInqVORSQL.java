...
*@FileName : EacMgtDBDAOEACInqVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOEACInqVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EacMgtDBDAOEACInqVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.eac.eacmgt.integration").append("\n"); 
		query.append("FileName : EacMgtDBDAOEACInqVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , '' AS LOCL_CRE_DT" ).append("\n"); 
