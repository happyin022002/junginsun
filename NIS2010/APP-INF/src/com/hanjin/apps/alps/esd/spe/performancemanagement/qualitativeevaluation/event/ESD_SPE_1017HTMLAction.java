...
*@FileName : ESD_SPE_1017HTMLAction.java
...
public class ESD_SPE_1017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SPE_1017HTMLAction 객체를 생성
	 */
	public ESD_SPE_1017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSpe1017Event event = new EsdSpe1017Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setSpeSpQualEvVO((SpeSpQualEvVO)getVO(request, SpeSpQualEvVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setSpeSpQualEvVOs((SpeSpQualEvVO[])getVOs(request, SpeSpQualEvVO .class, ""));
		}
