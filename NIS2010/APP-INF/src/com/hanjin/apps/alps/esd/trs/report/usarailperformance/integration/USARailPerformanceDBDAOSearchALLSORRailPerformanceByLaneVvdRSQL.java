...
*@FileName : USARailPerformanceDBDAOSearchALLSORRailPerformanceByLaneVvdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchALLSORRailPerformanceByLaneVvdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchALLSORRailPerformance SELECT by Lane VVD
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchALLSORRailPerformanceByLaneVvdRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchALLSORRailPerformanceByLaneVvdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("            'International' TRSP_CO_IND_CD," ).append("\n"); 
		...
		query.append("     UNION ALL" ).append("\n"); 
		query.append("     SELECT " ).append("\n"); 
		query.append("           TO_CHAR(A.CRE_DT, 'YYYYMM') SO_CRE_YRMON," ).append("\n"); 
		query.append("#if( ${f_chkprd} == 'M' )" ).append("\n"); 
		query.append("           '' WEEK," ).append("\n"); 
		query.append("#elseif( ${f_chkprd} == 'W' )" ).append("\n"); 
		...
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '2', NVL(B.AGMT_BZC_AMT,0)+NVL('',0), 0)   )  CNTR_20_BZC_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '2', NVL(B.FUEL_SCG_AMT,0)+NVL('',0), 0)   )  CNTR_20_FUEL_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '2', NVL(B.HZD_MTRL_SCG_AMT,0)+NVL(B.TTL_SCG_AMT,0)+NVL('',0), 0)) CNTR_20_OVR_HZD_AMT,  " ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '2', NVL(B.AGMT_RT_AMT,0)+NVL('',0), 0)   )   CNTR_20_TTL_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '4', NVL(B.AGMT_BZC_AMT,0)+NVL('',0), 0)   )  CNTR_40_BZC_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '4', NVL(B.FUEL_SCG_AMT,0)+NVL('',0), 0)   )  CNTR_40_FUEL_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '4', NVL(B.HZD_MTRL_SCG_AMT,0)+NVL(B.TTL_SCG_AMT,0)+NVL('',0), 0)) CNTR_40_OVR_HZD_AMT,  " ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '4', NVL(B.AGMT_RT_AMT,0)+NVL('',0), 0)   )   CNTR_40_TTL_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '5', NVL(B.AGMT_BZC_AMT,0)+NVL('',0), 0)   )  CNTR_40HC_BZC_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '5', NVL(B.FUEL_SCG_AMT,0)+NVL('',0), 0)   )  CNTR_40HC_FUEL_AMT," ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '5', NVL(B.HZD_MTRL_SCG_AMT,0)+NVL(B.TTL_SCG_AMT,0)+NVL('',0), 0)) CNTR_40HC_OVR_HZD_AMT,  " ).append("\n"); 
		query.append("    	   SUM(DECODE(SUBSTR(F.CNTR_TPSZ_CD,2,1), '5', NVL(B.AGMT_RT_AMT,0)+NVL('',0), 0)   )   CNTR_40HC_TTL_AMT," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    	   SUM(DECODE(F.CNTR_TPSZ_CD, 'D7', NVL(B.AGMT_BZC_AMT,0)+NVL('',0) , 0 )           )   CNTR_45_BZC_AMT,   " ).append("\n"); 
		query.append("    	   SUM(DECODE(F.CNTR_TPSZ_CD, 'D7', NVL(B.FUEL_SCG_AMT,0)+NVL('',0) , 0 )           )   CNTR_45_FUEL_AMT,      	    	   " ).append("\n"); 
		query.append("    	   SUM(DECODE(F.CNTR_TPSZ_CD, 'D7', NVL(B.HZD_MTRL_SCG_AMT,0)+NVL(B.TTL_SCG_AMT,0)+NVL('',0) , 0 )       )   CNTR_45_OVR_HZD_AMT,    " ).append("\n"); 
		query.append("    	   SUM(DECODE(F.CNTR_TPSZ_CD, 'D7', NVL(B.AGMT_RT_AMT,0)+NVL('',0) , 0 )            )   CNTR_45_TTL_AMT" ).append("\n"); 
		query.append("	FROM" ).append("\n"); 
		query.append("#if( ${f_chkprd} == 'M' )" ).append("\n"); 
