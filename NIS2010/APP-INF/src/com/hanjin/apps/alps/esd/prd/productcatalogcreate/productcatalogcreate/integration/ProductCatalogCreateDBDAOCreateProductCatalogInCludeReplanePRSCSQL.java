...
public class ProductCatalogCreateDBDAOCreateProductCatalogInCludeReplanePRSCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    ,DG_SPCL_FLG, RF_SPCL_FLG,SPCL_AWK_CGO_FLG, BB_SPCL_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    )" ).append("\n"); 
		...
		query.append("                                          WHEN @[por] = NVL(@[pol], SUBSTR(T.POL1,1,5)) THEN DECODE( NVL(@[so_seq], '0'), '0', 'X', @[por] || '%') -- var for PRS" ).append("\n"); 
