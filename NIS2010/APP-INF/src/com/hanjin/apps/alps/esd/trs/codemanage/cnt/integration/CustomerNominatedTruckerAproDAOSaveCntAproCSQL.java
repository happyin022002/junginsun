...
*@FileName : CustomerNominatedTruckerAproDAOSaveCntAproCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CustomerNominatedTruckerAproDAOSaveCntAproCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CustomerNominatedTruckerAproDAOSaveCntAproCSQL(){
		setQuery();
		...
		query.append("FileName : CustomerNominatedTruckerAproDAOSaveCntAproCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	,@[vndr_seq]" ).append("\n"); 
		query.append("	,@[io_bnd_cd] " ).append("\n"); 
		query.append("	,DECODE(@[io_bnd_cd], 'I', @[fm_nod_cd] || @[fm_nod_yard]   , @[dor_nod_cd] || @[dor_nod_yard]) " ).append("\n"); 
		query.append("	,DECODE(@[io_bnd_cd], 'I', @[dor_nod_cd] || @[dor_nod_yard] , @[to_nod_cd]||@[to_nod_yard])" ).append("\n"); 
		query.append("	,DECODE(@[io_bnd_cd], 'I', @[to_nod_cd]||@[to_nod_yard]     , @[fm_nod_cd] || @[fm_nod_yard])" ).append("\n"); 
		query.append("	,@[cntr_tpsz_cd]" ).append("\n"); 
		query.append("	,@[cust_nomi_trkr_bzc_amt]" ).append("\n"); 
		query.append("	,@[cust_nomi_trkr_fuel_div_cd]" ).append("\n"); 
		query.append("	,@[cust_nomi_trkr_fuel_rto]" ).append("\n"); 
		...
		query.append("--	,[disp_sts_cd] -- disp_sts_cd saved" ).append("\n"); 
