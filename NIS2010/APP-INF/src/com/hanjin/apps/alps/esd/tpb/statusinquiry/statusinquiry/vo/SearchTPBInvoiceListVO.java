...
public class SearchTPBInvoiceListVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String n3ptyIdaGstRgstNo = null;

    /* Column Info */
    private String smIdaGstRgstNo = null;

    /* Column Info */
    private String bkgNo = null;

    /* Column Info */
    private String n3ptyIdaSpclEcnZnUtFlg = null;

    /* Column Info */
    private String smIdaSteCd = null;

    /* Column Info */
    private String n3ptyIdaSteCd = null;

    /* Column Info */
    private String rvsChgFlg = null;

    /* Column Info */
    private String taxablAmt = null;
    ...
    /* Column Info */
    private String idaGstTaxAmt = null;
    ...
    public SearchTPBInvoiceListVO(String ibflag, String pagerows, String ofcCd, String n3ptyNo, String n3ptyInvNo, String n3ptyInvRvisCd, String ifBlNo, String n3ptyExpnTpCd, String currCd, String otsAmt, String vatAmt, String invAmt, String cltAmt, String invIssLoclDt, String updUsrId, String cltAgnFlg, String trdPartyNm, String arIfDt, String lengthN3ptyBilTpCd, String vndrCustDivCd, String trdPartyCode, String n3ptyInvHisSeq, String sUsrOfcCd, String sCond, String sSdate, String sEdate, String sIfRhqCd, String sIfCtrlCd, String sIfOfcCd, String sN3ptyInvNoForSearch, String sN3ptyInvRmdCdForSearch, String sEqNo, String sCltAgnFlg, String sN3ptyInvStsCd, String sVndrCustDivCd, String sTrdPartyVal, String sInvceSearchVersion, String cntCd, String sIfType, String addAmt, String ddctAmt, String idaSacCd, String n3ptyIdaGstRgstNo, String smIdaGstRgstNo, String bkgNo, String n3ptyIdaSpclEcnZnUtFlg, String smIdaSteCd, String n3ptyIdaSteCd, String rvsChgFlg, String taxablAmt, String idaIgstRto, String idaIgstAmt, String idaCgstRto, String idaCgstAmt, String idaSgstRto, String idaSgstAmt, String idaUgstRto, String idaUgstAmt, String idaGstTaxAmt) {
        ...
        this.n3ptyIdaGstRgstNo = n3ptyIdaGstRgstNo;
        this.smIdaGstRgstNo = smIdaGstRgstNo;
        this.bkgNo = bkgNo;
        this.n3ptyIdaSpclEcnZnUtFlg = n3ptyIdaSpclEcnZnUtFlg;
        this.smIdaSteCd = smIdaSteCd;
        this.n3ptyIdaSteCd = n3ptyIdaSteCd;
        ...
        this.idaGstTaxAmt = idaGstTaxAmt;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("n3pty_ida_gst_rgst_no", getN3ptyIdaGstRgstNo());
        this.hashColumns.put("sm_ida_gst_rgst_no", getSmIdaGstRgstNo());
        this.hashColumns.put("bkg_no", getBkgNo());
        this.hashColumns.put("n3pty_ida_spcl_ecn_zn_ut_flg", getN3ptyIdaSpclEcnZnUtFlg());
        this.hashColumns.put("sm_ida_ste_cd", getSmIdaSteCd());
        this.hashColumns.put("n3pty_ida_ste_cd", getN3ptyIdaSteCd());
        this.hashColumns.put("rvs_chg_flg", getRvsChgFlg());
        this.hashColumns.put("taxabl_amt", getTaxablAmt());
        ...
        this.hashColumns.put("ida_gst_tax_amt", getIdaGstTaxAmt());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("n3pty_ida_gst_rgst_no", "n3ptyIdaGstRgstNo");
        this.hashFields.put("sm_ida_gst_rgst_no", "smIdaGstRgstNo");
        this.hashFields.put("bkg_no", "bkgNo");
        this.hashFields.put("n3pty_ida_spcl_ecn_zn_ut_flg", "n3ptyIdaSpclEcnZnUtFlg");
        this.hashFields.put("sm_ida_ste_cd", "smIdaSteCd");
        this.hashFields.put("n3pty_ida_ste_cd", "n3ptyIdaSteCd");
        this.hashFields.put("rvs_chg_flg", "rvsChgFlg");
        this.hashFields.put("taxabl_amt", "taxablAmt");
        ...
        this.hashFields.put("ida_gst_tax_amt", "idaGstTaxAmt");
    ...
    /**
	 * Column Info
	 * @return n3ptyIdaGstRgstNo
	 */
    public String getN3ptyIdaGstRgstNo() {
        return this.n3ptyIdaGstRgstNo;
    }
    ...
    /**
	 * Column Info
	 * @param n3ptyIdaGstRgstNo
	 */
    public void setN3ptyIdaGstRgstNo(String n3ptyIdaGstRgstNo) {
        this.n3ptyIdaGstRgstNo = n3ptyIdaGstRgstNo;
    }
    ...
    /**
	 * @param sIfType the sIfType to set
	 */
    ...
    public void setSmIdaGstRgstNo(String smIdaGstRgstNo) {
        this.smIdaGstRgstNo = smIdaGstRgstNo;
    }

    public String getSmIdaGstRgstNo() {
        return this.smIdaGstRgstNo;
    }
    ...
    public void setN3ptyIdaSpclEcnZnUtFlg(String n3ptyIdaSpclEcnZnUtFlg) {
        this.n3ptyIdaSpclEcnZnUtFlg = n3ptyIdaSpclEcnZnUtFlg;
    }

    public String getN3ptyIdaSpclEcnZnUtFlg() {
        return this.n3ptyIdaSpclEcnZnUtFlg;
    }

    public void setSmIdaSteCd(String smIdaSteCd) {
        this.smIdaSteCd = smIdaSteCd;
    }

    public String getSmIdaSteCd() {
        return this.smIdaSteCd;
    }

    public void setN3ptyIdaSteCd(String n3ptyIdaSteCd) {
        this.n3ptyIdaSteCd = n3ptyIdaSteCd;
    }

    public String getN3ptyIdaSteCd() {
        return this.n3ptyIdaSteCd;
    }
    ...
    public void setTaxablAmt(String taxablAmt) {
        this.taxablAmt = taxablAmt;
    }

    public String getTaxablAmt() {
        return this.taxablAmt;
    }
    ...
    public void setIdaGstTaxAmt(String idaGstTaxAmt) {
        this.idaGstTaxAmt = idaGstTaxAmt;
    }

    public String getIdaGstTaxAmt() {
        return this.idaGstTaxAmt;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setN3ptyIdaGstRgstNo(JSPUtil.getParameter(request, "n3pty_ida_gst_rgst_no", ""));
    }
    ...
    public SearchTPBInvoiceListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] n3ptyIdaGstRgstNo = (JSPUtil.getParameter(request, prefix + "n3pty_ida_gst_rgst_no", length));
            String[] smIdaGstRgstNo = (JSPUtil.getParameter(request, prefix + "sm_ida_gst_rgst_no", length));
	    	String[] bkgNo = (JSPUtil.getParameter(request, prefix + "bkg_no", length));
	    	String[] n3ptyIdaSpclEcnZnUtFlg = (JSPUtil.getParameter(request, prefix + "n3pty_ida_spcl_ecn_zn_ut_flg", length));
	    	String[] smIdaSteCd = (JSPUtil.getParameter(request, prefix + "sm_ida_ste_cd", length));
	    	String[] n3ptyIdaSteCd = (JSPUtil.getParameter(request, prefix + "n3pty_ida_ste_cd", length));
	    	String[] rvsChgFlg = (JSPUtil.getParameter(request, prefix + "rvs_chg_flg", length));
	    	String[] taxablAmt = (JSPUtil.getParameter(request, prefix + "taxabl_amt", length));
	    	...
	    	String[] idaGstTaxAmt = (JSPUtil.getParameter(request, prefix + "ida_gst_tax_amt", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (n3ptyIdaGstRgstNo[i] != null)
                    model.setN3ptyIdaGstRgstNo(n3ptyIdaGstRgstNo[i]);
                if (smIdaGstRgstNo[i] != null) 
		    		model.setSmIdaGstRgstNo(smIdaGstRgstNo[i]);
				if (bkgNo[i] != null) 
		    		model.setBkgNo(bkgNo[i]);
				if (n3ptyIdaSpclEcnZnUtFlg[i] != null) 
		    		model.setN3ptyIdaSpclEcnZnUtFlg(n3ptyIdaSpclEcnZnUtFlg[i]);
				if (smIdaSteCd[i] != null) 
		    		model.setSmIdaSteCd(smIdaSteCd[i]);
				if (n3ptyIdaSteCd[i] != null) 
		    		model.setN3ptyIdaSteCd(n3ptyIdaSteCd[i]);
				if (rvsChgFlg[i] != null) 
		    		model.setRvsChgFlg(rvsChgFlg[i]);
				if (taxablAmt[i] != null) 
		    		model.setTaxablAmt(taxablAmt[i]);
				...
				if (idaGstTaxAmt[i] != null) 
		    		model.setIdaGstTaxAmt(idaGstTaxAmt[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.n3ptyIdaGstRgstNo = this.n3ptyIdaGstRgstNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.smIdaGstRgstNo = this.smIdaGstRgstNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.bkgNo = this.bkgNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.n3ptyIdaSpclEcnZnUtFlg = this.n3ptyIdaSpclEcnZnUtFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.smIdaSteCd = this.smIdaSteCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.n3ptyIdaSteCd = this.n3ptyIdaSteCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.rvsChgFlg = this.rvsChgFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.taxablAmt = this.taxablAmt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.idaGstTaxAmt = this.idaGstTaxAmt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
