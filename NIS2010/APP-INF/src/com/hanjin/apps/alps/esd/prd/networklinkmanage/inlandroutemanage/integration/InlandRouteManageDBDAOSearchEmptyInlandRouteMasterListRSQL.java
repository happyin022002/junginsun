...
*@FileName : InlandRouteManageDBDAOSearchEmptyInlandRouteMasterListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOSearchEmptyInlandRouteMasterListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchEmptyInlandRouteMasterList
	  * </pre>
	  */
	public InlandRouteManageDBDAOSearchEmptyInlandRouteMasterListRSQL(){
		setQuery();
		...
		params.put("wrsFlg",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("delFlg",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.prd.networklinkmanage.inlandroutemanage.integration").append("\n"); 
		query.append("FileName : InlandRouteManageDBDAOSearchEmptyInlandRouteMasterListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    rail_crr_tp_cd ,inlnd_rout_junc_nm ,wrs_mty_cmdt_cd, " ).append("\n"); 
		query.append("    d2_flg, d4_flg, d5_flg, d7_flg, " ).append("\n"); 
		query.append("    o2_flg, o4_flg, o5_flg, a2_flg, a4_flg, a5_flg, r5_flg ,r2_flg ,r8_flg--,r4_flg " ).append("\n"); 
		query.append("    ,UPD_USR_ID,to_char(UPD_DT,'yyyy-mm-dd') UPD_DT --JSY         " ).append("\n"); 
		...
		query.append("         ,MAX(DECODE(cnt,1, wrs_mty_cmdt_cd, DECODE(rout_dtl_seq,1, wrs_mty_cmdt_cd))) wrs_mty_cmdt_cd " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, d2_capa_flg, DECODE(rout_dtl_seq,1, d2_capa_flg))) d2_flg  " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, d4_capa_flg, DECODE(rout_dtl_seq,1, d4_capa_flg))) d4_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, d5_capa_flg, DECODE(rout_dtl_seq,1, d5_capa_flg))) d5_flg  " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, d7_capa_flg, DECODE(rout_dtl_seq,1, d7_capa_flg))) d7_flg  " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, o2_capa_flg, DECODE(rout_dtl_seq,1, o2_capa_flg))) o2_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, o4_capa_flg, DECODE(rout_dtl_seq,1, o4_capa_flg))) o4_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, o5_capa_flg, DECODE(rout_dtl_seq,1, o5_capa_flg))) o5_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, a2_capa_flg, DECODE(rout_dtl_seq,1, a2_capa_flg))) a2_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, a4_capa_flg, DECODE(rout_dtl_seq,1, a4_capa_flg))) a4_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, a5_capa_flg, DECODE(rout_dtl_seq,1, a5_capa_flg))) a5_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, r5_capa_flg, DECODE(rout_dtl_seq,1, r5_capa_flg))) r5_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, r2_capa_flg, DECODE(rout_dtl_seq,1, r2_capa_flg))) r2_flg " ).append("\n"); 
		query.append("         ,MAX(DECODE(cnt,1, r8_capa_flg, DECODE(rout_dtl_seq,1, r8_capa_flg))) r8_flg" ).append("\n"); 
		...
		query.append("                  inlnd_rout_rmk ,rail_crr_tp_cd ,inlnd_rout_junc_nm   ,wrs_mty_cmdt_cd, " ).append("\n"); 
		query.append("                  d2_capa_flg, d4_capa_flg, d5_capa_flg, d7_capa_flg, " ).append("\n"); 
		query.append("                  o2_capa_flg, o4_capa_flg, o5_capa_flg, a2_capa_flg, a4_capa_flg, a5_capa_flg, r2_capa_flg,r5_capa_flg, UPD_USR_ID, UPD_DT ,r8_capa_flg" ).append("\n"); 
		query.append("             FROM ( " ).append("\n"); 
		...
		query.append("                        m.inlnd_rout_rmk,d.rail_crr_tp_cd,d.inlnd_rout_junc_nm,m.wrs_mty_cmdt_cd, " ).append("\n"); 
		query.append("                        m.d2_capa_flg, m.d4_capa_flg, m.d5_capa_flg, m.d7_capa_flg, " ).append("\n"); 
		query.append("                        m.o2_capa_flg, m.o4_capa_flg, m.o5_capa_flg, m.a2_capa_flg, m.a4_capa_flg, m.a5_capa_flg, m.r5_capa_flg, " ).append("\n"); 
		query.append("                        m.UPD_USR_ID, m.UPD_DT, --080821 jsy " ).append("\n"); 
		query.append("                        m.r2_capa_flg ,m.r8_capa_flg--090108 jsy " ).append("\n"); 
		query.append("                   FROM prd_inlnd_rout_mst m, prd_inlnd_rout_dtl d " ).append("\n"); 
		query.append("                   WHERE m.rout_org_nod_cd LIKE @[fromCd]||'%' " ).append("\n"); 
		query.append("                     AND m.rout_dest_nod_cd LIKE @[toCd]||'%' " ).append("\n"); 
		query.append("                     AND NVL(m.DELT_FLG,'N') = nvl(@[delFlg], 'N') " ).append("\n"); 
		...
		query.append("                     AND m.AUTO_IRG_FLG <> 'Y'  --컬럼추가로 조건 추가" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("                     AND m.pctl_io_bnd_cd ='M' " ).append("\n"); 
		query.append("                     AND nvl(m.wrs_mty_cmdt_cd,'N') like @[wrsFlg]||'%' " ).append("\n"); 
