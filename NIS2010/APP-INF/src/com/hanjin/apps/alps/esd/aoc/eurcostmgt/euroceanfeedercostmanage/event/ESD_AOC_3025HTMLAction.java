...
*@FileName : ESD_AOC_3025HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3025HTMLAction 객체를 생성
	 */
	public ESD_AOC_3025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3025Event event = new EsdAoc3025Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setOceanFeederCostCondVO((EurFeederCostCondVO)getVO(request, EurFeederCostCondVO .class));
