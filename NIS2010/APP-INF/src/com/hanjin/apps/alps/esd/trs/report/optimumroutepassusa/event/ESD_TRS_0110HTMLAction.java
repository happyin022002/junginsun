...
*@FileName : ESD_TRS_0110HTMLAction.java
 ...
 * @author 조인영
 * @see EsdTrs0110Event 참조
 * @since J2EE 1.6
 */
public class ESD_TRS_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_0171HTMLAction 객체를 생성
	 */
	public ESD_TRS_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdTrs0110Event event = new EsdTrs0110Event();
