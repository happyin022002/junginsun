...
*@FileName : UsaInlandCostManageDBDAOMultiInlandCostHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOMultiInlandCostHdrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOMultiInlandCostHdrUSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOMultiInlandCostHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
