 ...
 * @since J2EE 1.6
 */
public class ESD_EAS_0320HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0320HTMLAction 객체를 생성
	 */
	public ESD_EAS_0320HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0320Event event = new EsdEas0320Event();
		

		if(command.isCommand(FormCommand.SEARCHLIST01)) {
			event.setTesOnDockRailCostCalculationVO((TesOnDockRailCostCalculationVO)getVO(request, TesOnDockRailCostCalculationVO .class));
		}
