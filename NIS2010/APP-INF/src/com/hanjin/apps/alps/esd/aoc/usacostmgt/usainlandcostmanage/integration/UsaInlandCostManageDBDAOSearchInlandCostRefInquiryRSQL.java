...
*@FileName : UsaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOSearchInlandCostRefInquiryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	 #end" ).append("\n"); 
		query.append("      , TO_CHAR(R.CRE_DT, 'YYYY-MM-DD HH24:MI:SS') LOCL_CRE_DT" ).append("\n"); 
		query.append("      , ( SELECT USR_NM FROM COM_USER WHERE USR_ID = R.CRE_USR_ID ) CRE_USR_ID" ).append("\n"); 
		query.append("      , TO_CHAR(R.UPD_DT, 'YYYY-MM-DD HH24:MI:SS') LOCL_UPD_DT" ).append("\n"); 
		query.append("      , ( SELECT USR_NM FROM COM_USER WHERE USR_ID = R.UPD_USR_ID) UPD_USR_ID" ).append("\n"); 
