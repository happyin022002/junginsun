...
*@FileName : BiddingCandidateDBDAOInsertSpotBiddingInvitationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BiddingCandidateDBDAOInsertSpotBiddingInvitationCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Spot Bidding Invitation Mail Send 정보 저장
	  * </pre>
	  */
	public BiddingCandidateDBDAOInsertSpotBiddingInvitationCSQL(){
		setQuery();
		...
		query.append("FileName : BiddingCandidateDBDAOInsertSpotBiddingInvitationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		   TO_CHAR(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[cre_ofc_cd]),'YYYYMMDD')|| LPAD(TRS_SPOT_BID_IVT_VNDR_SEQ.NEXTVAL,7,'0')" ).append("\n"); 
		query.append("          ,@[spot_bid_no]" ).append("\n"); 
		query.append("          ,NVL(TO_NUMBER(@[spot_bid_cnddt_term_seq]),999999999999)" ).append("\n"); 
		query.append("          ,@[vndr_seq]" ).append("\n"); 
		query.append("		  ,@[modi_spot_bid_vndr_eml]" ).append("\n"); 
