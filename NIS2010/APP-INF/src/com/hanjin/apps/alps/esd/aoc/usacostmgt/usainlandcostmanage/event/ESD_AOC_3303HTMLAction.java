...
*@FileName : ESD_AOC_3303HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3303HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3303HTMLAction 객체를 생성
	 */
	public ESD_AOC_3303HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3303Event event = new EsdAoc3303Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInlandCostConditionVO((UsaInlandCostConditionVO)getVO(request, UsaInlandCostConditionVO .class));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setInlandCostConditionVO((UsaInlandCostConditionVO)getVO(request, UsaInlandCostConditionVO .class));
			event.setInlandCostDetailVOS((UsaInlandCostDetailVO[])getVOs(request, UsaInlandCostDetailVO .class,""));
