...
*@FileName : DOFChgTrfmanageDBDAOmultiDrffChgTrfDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DOFChgTrfmanageDBDAOmultiDrffChgTrfDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DOFChgTrfmanageDBDAOmultiDrffChgTrfDSQL(){
		setQuery();
		...
		query.append("FileName : DOFChgTrfmanageDBDAOmultiDrffChgTrfDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("delete from EAS_DRFF_CHG_TRF_HDR" ).append("\n"); 
