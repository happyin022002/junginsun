...
*@FileName : BkgCopManageDBDAOSearchCopHdrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOSearchCopHdrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BkgCopManageDBDAOSearchCopHdrRSQL(){
		setQuery();
		...
		query.append("FileName : BkgCopManageDBDAOSearchCopHdrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#end" ).append("\n"); 
		query.append("and cop_sts_cd not in ('X', 'O', 'M')" ).append("\n"); 
