...
*@FileName : TesBkgAudDBDAORehandlingBkgCodVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TesBkgAudDBDAORehandlingBkgCodVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TesBkgAudDBDAORehandlingBkgCodVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.expnaud.tesbkgaud.integration").append("\n"); 
		query.append("FileName : TesBkgAudDBDAORehandlingBkgCodVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,''	s_ca_reason" ).append("\n"); 
