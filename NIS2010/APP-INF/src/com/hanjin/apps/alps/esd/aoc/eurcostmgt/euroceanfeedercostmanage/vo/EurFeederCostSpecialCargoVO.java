...
*@FileName : EurFeederCostSpecialCargoVO.java
*@FileTitle : EurFeederCostSpecialCargoVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurFeederCostSpecialCargoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurFeederCostSpecialCargoVO> models = new ArrayList<EurFeederCostSpecialCargoVO>();
	...
	public EurFeederCostSpecialCargoVO() {}

	public EurFeederCostSpecialCargoVO(String ibflag, String pagerows, String cntrSzCd, String rfFxRt, String rfFxRto, String dgFxRt, String dgFxRto, String minCgoWgt, String maxCgoWgt, String ovrWgtFxRt, String ovrWgtFxRto, String costTrfNo, String creUsrId, String updUsrId) {
...
/**
	 ...
	 */
	public EurFeederCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurFeederCostSpecialCargoVO[]
	 */
	public EurFeederCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurFeederCostSpecialCargoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EurFeederCostSpecialCargoVO();
				if (rfFxRto[i] != null)
	 ...
	 * @return EurFeederCostSpecialCargoVO[]
	 */
	public EurFeederCostSpecialCargoVO[] getFeederCostSpecialCargoVOs(){
		EurFeederCostSpecialCargoVO[] vos = (EurFeederCostSpecialCargoVO[])models.toArray(new EurFeederCostSpecialCargoVO[models.size()]);
		return vos;
	}
