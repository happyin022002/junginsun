...
*@FileName : SpotBiddingSendReeferCargoInfoEventResponse.java
...
public class SpotBiddingSendReeferCargoInfoEventResponse {
	 ...
	 */
	public SpotBiddingSendReeferCargoInfoEventResponse(SpotBiddingSendReeferCargoInfo[] spotBiddingSendReeferCargoInfo) {
		this.spotBiddingSendReeferCargoInfo = spotBiddingSendReeferCargoInfo;
	}
	
	public String getEventName() {
    	return "SpotBiddingSendReeferCargoInfoEventResponse";
    }
}