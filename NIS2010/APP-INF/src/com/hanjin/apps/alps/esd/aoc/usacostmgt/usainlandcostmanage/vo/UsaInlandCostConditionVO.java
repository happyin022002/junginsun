...
*@FileName : UsaInlandCostConditionVO.java
*@FileTitle : UsaInlandCostConditionVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class UsaInlandCostConditionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaInlandCostConditionVO> models = new ArrayList<UsaInlandCostConditionVO>();
	...
	/* Column Info */
	private String excelSvcModCd = null;
	...
	public UsaInlandCostConditionVO(String ibflag, String pagerows, String fromDt, String currCd, String inSortBy, String costFactorCd, String excelRcvDeTermCd, String excelSysSrcCd, String excelCostFactorCd, String cntCd, String rcvDeTermCd, String excelDateFlg, String trspCrrModCd, String inAscDesc, String costSelRoutFlg, String dateFlg, String excelTrspCrrModCd, String rhqCd, String costTrfNo, String excelAdjustmentCd, String inCostTrfNo, String sysSrcCd, String hubNodCd, String ioBndCd, String toDt, String adjustmentCd, String portNodCd, String bntFlg, String inCntCd, String locNodCd, String effToDt, String inCostTrfBatSeq, String excelIoBndCd, String costRoutGrpNo, String sCostRoutGrpNo, String excelFromDt, String excelToDt, String excelEffToDt, String excelChkIncl, String excelLocNodCd, String excelHubNodCd, String excelPortNodCd, String excelCostTrfNo, String svcModCd, String excelSvcModCd) {
		...
		this.excelSvcModCd = excelSvcModCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("excel_svc_mod_cd", getExcelSvcModCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("excel_svc_mod_cd", "excelSvcModCd");
	...
	/**
	 * Column Info
	 * @return excelSvcModCd
	 */
	public String getExcelSvcModCd() {
		return this.excelSvcModCd;
	}
	 ...
	 * @param excelSvcModCd
	 */
	public void setExcelSvcModCd(String excelSvcModCd) {
		this.excelSvcModCd = excelSvcModCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setExcelSvcModCd(JSPUtil.getParameter(request, prefix + "excel_svc_mod_cd", ""));
	}
	 ...
	 */
	public UsaInlandCostConditionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaInlandCostConditionVO[]
	 */
	public UsaInlandCostConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaInlandCostConditionVO model = null;
		...
		try {
			...
			String[] excelSvcModCd = (JSPUtil.getParameter(request, prefix	+ "excel_svc_mod_cd", length));
			
			for (int i = 0; i < length; i++) {
				model = new UsaInlandCostConditionVO();
				if (fromDt[i] != null)
				...
				if (excelSvcModCd[i] != null)
					model.setExcelSvcModCd(excelSvcModCd[i]);
				models.add(model);
			}
	 ...
	 * @return UsaInlandCostConditionVO[]
	 */
	public UsaInlandCostConditionVO[] getInlandCostConditionVOs(){
		UsaInlandCostConditionVO[] vos = (UsaInlandCostConditionVO[])models.toArray(new UsaInlandCostConditionVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.excelSvcModCd = this.excelSvcModCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
