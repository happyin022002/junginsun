...
*@FileName : EurStatusMonitorVO.java
*@FileTitle : EurStatusMonitorVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurStatusMonitorVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurStatusMonitorVO> models = new ArrayList<EurStatusMonitorVO>();
...
/**
	 ...
	 */
	public EurStatusMonitorVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurStatusMonitorVO[]
	 */
	public EurStatusMonitorVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurStatusMonitorVO model = null;
	...
	public EurStatusMonitorVO[] getSearchStatusMonitorVOs(){
		EurStatusMonitorVO[] vos = (EurStatusMonitorVO[])models.toArray(new EurStatusMonitorVO[models.size()]);
		return vos;
	}
