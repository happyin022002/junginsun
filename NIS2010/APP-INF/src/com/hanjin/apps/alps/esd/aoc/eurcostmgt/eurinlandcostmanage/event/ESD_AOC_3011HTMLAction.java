...
*@FileName : ESD_AOC_3011HTMLAction.java
...
* --------------------------------------------------------
* History
* 2012.10.04 변종건 [CHM-201220395] Cost & Guideline Tariff Status Monitoring 신규 개발
=========================================================*/
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3011HTMLAction 객체를 생성
	 */
	public ESD_AOC_3011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3011Event event = new EsdAoc3011Event();
		
		if( command.isCommand(FormCommand.SEARCH) ){
			event.setSearchStatusMonitorVO((EurStatusMonitorVO)getVO(request, EurStatusMonitorVO .class));
		} else if( command.isCommand(FormCommand.SEARCH01) || command.isCommand(FormCommand.SEARCH03) ){
			event.setSearchStatusMonitorVO((EurStatusMonitorVO)getVO(request, EurStatusMonitorVO .class));
		}
