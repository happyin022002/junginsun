...
*@FileName : AsiaInlandCostManageDBDAOModifyInlandCostReeferUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOModifyInlandCostReeferUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOModifyInlandCostReeferUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOModifyInlandCostReeferUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  AOC_CHN_INLND_RF_TRF_DTL" ).append("\n"); 
