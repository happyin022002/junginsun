...
*@FileName : AsiaFeederCostSpecialCargoVO.java
*@FileTitle : AsiaFeederCostSpecialCargoVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class AsiaFeederCostSpecialCargoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AsiaFeederCostSpecialCargoVO> models = new ArrayList<AsiaFeederCostSpecialCargoVO>();
	...
	public AsiaFeederCostSpecialCargoVO() {}

	public AsiaFeederCostSpecialCargoVO(String ibflag, String pagerows, String cntrSzCd, String rfFxRt, String rfFxRto, String dgFxRt, String dgFxRto, String minCgoWgt, String maxCgoWgt, String ovrWgtFxRt, String ovrWgtFxRto, String costTrfNo, String creUsrId, String updUsrId) {
...
/**
	 ...
	 */
	public AsiaFeederCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AsiaFeederCostSpecialCargoVO[]
	 */
	public AsiaFeederCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AsiaFeederCostSpecialCargoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new AsiaFeederCostSpecialCargoVO();
				if (rfFxRto[i] != null)
	 ...
	 * @return AsiaFeederCostSpecialCargoVO[]
	 */
	public AsiaFeederCostSpecialCargoVO[] getFeederCostSpecialCargoVOs(){
		AsiaFeederCostSpecialCargoVO[] vos = (AsiaFeederCostSpecialCargoVO[])models.toArray(new AsiaFeederCostSpecialCargoVO[models.size()]);
		return vos;
	}
