...
*@FileName : UsaInlandCostManageDBDAOModifyInlandCostReeferUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOModifyInlandCostReeferUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOModifyInlandCostReeferUSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOModifyInlandCostReeferUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
