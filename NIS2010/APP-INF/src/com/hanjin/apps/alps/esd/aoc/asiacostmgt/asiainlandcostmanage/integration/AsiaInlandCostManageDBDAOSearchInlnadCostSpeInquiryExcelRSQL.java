...
*@FileName : AsiaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiainlandcostmanage.integration").append("\n"); 
		query.append("FileName : AsiaInlandCostManageDBDAOSearchInlnadCostSpeInquiryExcelRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
