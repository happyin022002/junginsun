...
*@FileName : ESD_TES_9500HTMLAction.java
 ...
 *
 * @author parkyeonjin
 * @see EsdTes9500Event , ESD_TES_9500EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_TES_9500HTMLAction extends HTMLActionSupport {

	/**
	 * ESD_TES_9500HTMLAction 객체를 생성
	 */
	public ESD_TES_9500HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_9500Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		EsdTes9500Event event = new EsdTes9500Event();
