...
*@FileName : ESD_TRS_0102HTMLAction.java
...
* 1.0 최초 생성
* 1.5 2011.06.10 김종호 [CHM-201110817] [TRS] US Rail report 기능 보완 / 추가 요청
=========================================================*/
 ...
 *
 * @author Jun Ho Kim
 * @see EsdTrs0102Event 참조
 * @since J2EE 1.4
 */
public class ESD_TRS_0102HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TRS_0102HTMLAction 객체를 생성
	 */
	public ESD_TRS_0102HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTrs0102Event event = new EsdTrs0102Event();
