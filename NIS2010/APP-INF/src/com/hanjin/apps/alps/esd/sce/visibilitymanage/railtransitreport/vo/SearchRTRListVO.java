...
public class SearchRTRListVO extends AbstractValueObject {
	...
	public SearchRTRListVO(String ibflag, String pagerows, String toNodCd, String railItchgN1stEtaDate, String evntDate, String trspSoSeq, String orgGateOutDate, String cgoTpCd, String railItchgN2ndEtdDate, String creDate, String railItchgN1stEtdDate, String fcarNo, String itchgArrSplcLocNm, String vvdCd, String ibdCstmsClrLocCd, String ibIpiLoclIndCd, String scNo, String mstBlNo, String railTztmHrs, String cDate, String chgDate, String railDestN2ndEtaDate, String crntDwllTmHrs, String cgorOrgBlRcvrIndFlg, String itchgN1stDwllTmHrs, String rRailCoDestPntEtaDt, String orgDwllTmHrs, String eqTpszCd, String swoIssDate, String bkgNo, String railItchgN2ndEtaDate, String usaEdiCd, String arrSteCd, String nodCd, String arrLocNm, String destAvailDate, String tztmDiffHrs, String itchgN2ndDwllTmHrs, String itchgHrs, String cstmsAcptFlg, String tmlDwllTmHrs, String orgDepFlg, String bkgHotDeFlg, String chgOutDate, String woVndrSeq, String trspSoOfcCtyCd, String orgSplcLocNm, String vdDate, String eqNo, String railCoItchgPntEtaDt, String itchgN1stDepFlg, String tmlDepFlg, String railDestN1stEtaDate, String shprNm, String dwllHrs, String trspBndCd, String destN2ndDwllTmHrs, String orgGateInDate, String chgArrInDate, String itchgN2ndDepFlg, String railRunTmHrs, String destN2ndDepFlg, String ntfyNm, String itchgSplcLocNm, String fmNodCd, String destN1stDwllTmHrs, String cneeNm, String trnNo, String hldRmk, String avgTzHrs, String destOutDate, String cgorFrtPayIndFlg, String destLocNm, String destInDate, String destN1stDepFlg, String cntrSealNo, String hldFlg, String custCntCd, String custSeq, String custCd, String crntDwllRmk, String preDwllRmk, String soNo) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRailItchgN1stEtaDate(JSPUtil.getParameter(request, prefix + "rail_itchg_n1st_eta_date", ""));
		setEvntDate(JSPUtil.getParameter(request, prefix + "evnt_date", ""));
		setTrspSoSeq(JSPUtil.getParameter(request, prefix + "trsp_so_seq", ""));
		setOrgGateOutDate(JSPUtil.getParameter(request, prefix + "org_gate_out_date", ""));
		setCgoTpCd(JSPUtil.getParameter(request, prefix + "cgo_tp_cd", ""));
		setRailItchgN2ndEtdDate(JSPUtil.getParameter(request, prefix + "rail_itchg_n2nd_etd_date", ""));
		setCreDate(JSPUtil.getParameter(request, prefix + "cre_date", ""));
		setRailItchgN1stEtdDate(JSPUtil.getParameter(request, prefix + "rail_itchg_n1st_etd_date", ""));
		...
		setChgDate(JSPUtil.getParameter(request, prefix + "chg_date", ""));
		setCDate(JSPUtil.getParameter(request, prefix + "c_date", ""));
		setCrntDwllTmHrs(JSPUtil.getParameter(request, prefix + "crnt_dwll_tm_hrs", ""));
		setRailDestN2ndEtaDate(JSPUtil.getParameter(request, prefix + "rail_dest_n2nd_eta_date", ""));
		...
		setRRailCoDestPntEtaDt(JSPUtil.getParameter(request, prefix + "r_rail_co_dest_pnt_eta_dt", ""));
		setOrgDwllTmHrs(JSPUtil.getParameter(request, prefix + "org_dwll_tm_hrs", ""));
		setEqTpszCd(JSPUtil.getParameter(request, prefix + "eq_tpsz_cd", ""));
		setSwoIssDate(JSPUtil.getParameter(request, prefix + "swo_iss_date", ""));
		setBkgNo(JSPUtil.getParameter(request, prefix + "bkg_no", ""));
		setRailItchgN2ndEtaDate(JSPUtil.getParameter(request, prefix + "rail_itchg_n2nd_eta_date", ""));
		...
		setDestAvailDate(JSPUtil.getParameter(request, prefix + "dest_avail_date", ""));
		...
		setChgOutDate(JSPUtil.getParameter(request, prefix + "chg_out_date", ""));
		...
		setVdDate(JSPUtil.getParameter(request, prefix + "vd_date", ""));
		...
		setRailDestN1stEtaDate(JSPUtil.getParameter(request, prefix + "rail_dest_n1st_eta_date", ""));
		...
		setOrgGateInDate(JSPUtil.getParameter(request, prefix + "org_gate_in_date", ""));
		setDestN2ndDwllTmHrs(JSPUtil.getParameter(request, prefix + "dest_n2nd_dwll_tm_hrs", ""));
		setChgArrInDate(JSPUtil.getParameter(request, prefix + "chg_arr_in_date", ""));
		...
		setDestOutDate(JSPUtil.getParameter(request, prefix + "dest_out_date", ""));
		setDestN1stDepFlg(JSPUtil.getParameter(request, prefix + "dest_n1st_dep_flg", ""));
		setDestInDate(JSPUtil.getParameter(request, prefix + "dest_in_date", ""));
