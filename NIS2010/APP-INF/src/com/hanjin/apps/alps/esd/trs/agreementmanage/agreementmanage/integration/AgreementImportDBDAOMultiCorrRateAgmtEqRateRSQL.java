...
public class AgreementImportDBDAOMultiCorrRateAgmtEqRateRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,TO_CHAR(MAX(AGMT_APRO_DT),'YYYYMMDDHH24MISS') AS AGMT_APRO_DT" ).append("\n"); 
		...
		query.append("      ,MAX(WTR_RCV_TERM_CD) WTR_RCV_TERM_CD" ).append("\n"); 
		query.append("      ,MAX(WTR_DE_TERM_CD)  WTR_DE_TERM_CD" ).append("\n"); 
