...
*@FileName : SearchOBCopVO.java
*@FileTitle : SearchOBCopVO
*Open Issues :
*Change history :
...
public class SearchOBCopVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchOBCopVO> models = new ArrayList<SearchOBCopVO>();
	...
	public SearchOBCopVO() {}

	public SearchOBCopVO(String ibflag, String pagerows, String copNo, String actStsCd, String planDt, String vslCd, String skdVoyNo, String skdDirCd, String clptIndSeq) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPlanDt(JSPUtil.getParameter(request, "plan_dt", ""));
	 ...
	 * @param request
	 * @return SearchOBCopVO[]
	 */
	public SearchOBCopVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchOBCopVO[]
	 */
	public SearchOBCopVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchOBCopVO model = null;
	 ...
	 * @return SearchOBCopVO[]
	 */
	public SearchOBCopVO[] getSearchOBCopVOs(){
		SearchOBCopVO[] vos = (SearchOBCopVO[])models.toArray(new SearchOBCopVO[models.size()]);
		return vos;
	}
