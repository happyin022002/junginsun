...
*@FileName : MarineTerminalInvoiceManageDBDAOInsertMGSetFuelingChargeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MarineTerminalInvoiceManageDBDAOInsertMGSetFuelingChargeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MarineTerminalInvoiceManageDBDAOInsertMGSetFuelingChargeCSQL(){
		setQuery();
		...
		query.append("FileName : MarineTerminalInvoiceManageDBDAOInsertMGSetFuelingChargeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO TES_MGST_FUEL_CHG (" ).append("\n"); 
		query.append("TML_SO_OFC_CTY_CD," ).append("\n"); 
		query.append("TML_SO_SEQ," ).append("\n"); 
		query.append("TML_SO_DTL_SEQ," ).append("\n"); 
		query.append("MGST_NO," ).append("\n"); 
		query.append("YD_CD," ).append("\n"); 
		query.append("FUEL_DT," ).append("\n"); 
		query.append("MGST_RUN_HRS," ).append("\n"); 
		query.append("FUEL_QTY," ).append("\n"); 
		query.append("CURR_CD," ).append("\n"); 
		query.append("FUEL_RT," ).append("\n"); 
		query.append("FUEL_AMT," ).append("\n"); 
		query.append("LBR_AMT," ).append("\n"); 
		query.append("TTL_AMT," ).append("\n"); 
		query.append("CHSS_NO," ).append("\n"); 
		query.append("RF_CNTR_NO," ).append("\n"); 
		...
		query.append("@[mgst_no]," ).append("\n"); 
		query.append("@[yd_cd]," ).append("\n"); 
		query.append("TO_DATE(@[fuel_dt] ,'YYYYMMDDHH24MISS')," ).append("\n"); 
		query.append("@[mgst_run_hrs]," ).append("\n"); 
		query.append("@[fuel_qty]," ).append("\n"); 
		query.append("@[curr_cd]," ).append("\n"); 
		query.append("@[fuel_rt]," ).append("\n"); 
