...
*@FileName : AsiaOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * confirmFeederCostPreVer
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOConfirmFeederCostPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                        WHERE RHQ_CD = @[rhq_ofc_cd]" ).append("\n"); 
