...
*@FileName : RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionConvAmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionConvAmtUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionConvAmtUSQL(){
		setQuery();
		...
		query.append("FileName : RailInvoiceInquiryCorrectionDBDAORemoveRailInvoiceInquiryCorrectionConvAmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TRS_TRSP_RAIL_CONV_AMT" ).append("\n"); 
		query.append("SET    INV_BZC_AMT     = null," ).append("\n"); 
