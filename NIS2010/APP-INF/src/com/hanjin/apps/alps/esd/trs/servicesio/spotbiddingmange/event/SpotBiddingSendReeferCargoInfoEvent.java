...
*@FileName : SpotBiddingSendReeferCargoInfoEvent.java
 ...
 * @since J2EE 1.6
 */
public class SpotBiddingSendReeferCargoInfoEvent extends EventSupport {
	 ...
	 * @param eq_no
	 */
	public SpotBiddingSendReeferCargoInfoEvent(String bkg_no,String eq_no) {
		this.bkg_no = bkg_no;
		this.eq_no = eq_no;
	}
