...
*@FileName : ESD_TRS_0092Event.java
...
/**
 * ESD_TRS_0092 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESD_TRS_0092HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
public class EsdTrs0092Event extends EventSupport {
	...
	String hidPrepull = ""; //Pre-Pull
	String cntFlg = "";             //cnt_flg [CHM-201535431]
	String spotBidFlg = "";
	String spotBidNo = "";
	String radioProfit = "";
	String selProfit = "";
	String selSpotBidSts = "";
	...
	public String getHidPrePull() {
		return hidPrepull;
	}

	public void setHidPrePull(String hidPrepull) {
		this.hidPrepull = hidPrepull;
	}
	
	
	/** ESD_TRS_0092Event */
	public EsdTrs0092Event(){}
	...
	/**
	 * @return the radioProfit
	 */
	public String getRadioProfit() {
		return radioProfit;
	}

	/**
	 * @param radioProfit the radioProfit to set
	 */
	public void setRadioProfit(String radioProfit) {
		this.radioProfit = radioProfit;
	}

	/**
	 * @return the selProfit
	 */
	public String getSelProfit() {
		return selProfit;
	}

	/**
	 * @param selProfit the selProfit to set
	 */
	public void setSelProfit(String selProfit) {
		this.selProfit = selProfit;
	}

	/**
	 * @return the selSpotBidSts
	 */
	public String getSelSpotBidSts() {
		return selSpotBidSts;
	}

	/**
	 * @param selSpotBidSts the selSpotBidSts to set
	 */
	public void setSelSpotBidSts(String selSpotBidSts) {
		this.selSpotBidSts = selSpotBidSts;
	}
