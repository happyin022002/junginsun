...
*@FileName : OceanRouteManageDBDAOOceanRouteStatusDelete2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OceanRouteManageDBDAOOceanRouteStatusDelete2RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OceanRouteManageDBDAOOceanRouteStatusDelete2RSQL(){
		setQuery();
		...
		query.append("FileName : OceanRouteManageDBDAOOceanRouteStatusDelete2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
