...
*@FileName : ESD_EAS_0307HTMLAction.java
...
public class ESD_EAS_0307HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0307HTMLAction 객체를 생성
	 */
	public ESD_EAS_0307HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0307Event event = new EsdEas0307Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setUnmatchRouteBkgVsSoVO((UnmatchRouteBkgVsSoVO)getVO(request, UnmatchRouteBkgVsSoVO .class));
		}
