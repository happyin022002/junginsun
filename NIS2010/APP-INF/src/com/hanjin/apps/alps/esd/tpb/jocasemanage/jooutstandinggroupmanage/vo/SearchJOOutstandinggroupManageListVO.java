package com.hanjin.apps.alps.esd.tpb.jocasemanage.jooutstandinggroupmanage.vo;
...
public class SearchJOOutstandinggroupManageListVO {
	
	private static final long serialVersionUID = 1L;
	
	private Collection<SearchJOOutstandinggroupManageListVO> models = new ArrayList<SearchJOOutstandinggroupManageListVO>();
	...
	public SearchJOOutstandinggroupManageListVO() {}

	public SearchJOOutstandinggroupManageListVO(String ibflag, String pagerows, String n3ptyOfcTpCd, String ofcCd, String sOfcCd, String rhqCd, String n3ptyCtrlOfcCd, String n3ptyOfcCd, String n3ptyArOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SearchJOOutstandinggroupManageListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchCandidateListVO[]
	 */
	public SearchJOOutstandinggroupManageListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchJOOutstandinggroupManageListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchJOOutstandinggroupManageListVO();
				if (updDt[i] != null)
	 ...
	 * @return SearchCandidateListVO[]
	 */
	public SearchJOOutstandinggroupManageListVO[] getSearchCandidateListVOs(){
		SearchJOOutstandinggroupManageListVO[] vos = (SearchJOOutstandinggroupManageListVO[])models.toArray(new SearchJOOutstandinggroupManageListVO[models.size()]);
		return vos;
	}
