...
*@FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAOMultiCorrScgAgmtScgRateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FuelScgManageDBDAOMultiCorrScgAgmtScgRateRSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAOMultiCorrScgAgmtScgRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,MAX(TO_WGT) TO_WGT" ).append("\n"); 
		query.append("      ,MAX(WGT_MEAS_UT_CD) WGT_MEAS_UT_CD" ).append("\n"); 
		...
		query.append("      ,X.TRSP_AGMT_EQ_TP_CD||X.TRSP_AGMT_EQ_SZ_CD TRSP_AGMT_EQ_TP_SZ_CD" ).append("\n"); 
		query.append("      ,X.EQ_KND_CD" ).append("\n"); 
		query.append("      ,X.DELT_FLG" ).append("\n"); 
		query.append("      ,MAX(X.AGMT_SCG_RT_DIV_CD) AGMT_SCG_RT_DIV_CD" ).append("\n"); 
		query.append("      ,(" ).append("\n"); 
		...
		query.append("      ,(SELECT TO_CHAR(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(@[ofc_cd])-1, 'YYYYMMDD') FROM DUAL) AS AGMT_EXP_DT" ).append("\n"); 
