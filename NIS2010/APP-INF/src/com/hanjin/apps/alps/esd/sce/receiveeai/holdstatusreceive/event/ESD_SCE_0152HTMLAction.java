...
*@FileName : EsdSce0152HTMLAction.java
 ...
 *
 * @author - 
 * @see EsdSce0152Event 참조
 * @since J2EE 1.4
 */
public class ESD_SCE_0152HTMLAction extends HTMLActionSupport{
	/**
	 * 
	 */
	 ...
	 * Constructor 
	 */
	public ESD_SCE_0152HTMLAction(){
		log.debug("Starting NoUI Program TEST:ID ");
	}

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 EsdSce0152Event로 파싱하여 request에 셋팅<br>
     * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce0152Event event = new EsdSce0152Event();
        ...
        if (command.isCommand(FormCommand.SEARCH)) {
			...
			event.setEventName("EsdSce0152Event");
