...
*@FileName : AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlUSQL(){
		setQuery();
		...
		query.append("FileName : AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
