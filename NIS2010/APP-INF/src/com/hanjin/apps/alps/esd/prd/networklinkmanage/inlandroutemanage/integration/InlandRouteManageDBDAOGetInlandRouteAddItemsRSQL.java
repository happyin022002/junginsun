...
public class InlandRouteManageDBDAOGetInlandRouteAddItemsRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("SUBSTRB( MIN( TO_CHAR(D.ROUT_DTL_SEQ,'FM099')||NVL(D.INLND_ROUT_CMB_FLG,'N') )" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ),4)  FIRST_INLND_ROUT_CMB_FLG ," ).append("\n"); 
		query.append("SUBSTRB( MAX( TO_CHAR(D.ROUT_DTL_SEQ,'FM099')||NVL(D.INLND_ROUT_CMB_FLG,'N') )" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ),4)  LAST_INLND_ROUT_CMB_FLG ," ).append("\n"); 
		query.append("SUBSTRB( MIN( TO_CHAR(D.ROUT_DTL_SEQ,'FM099')||D.LNK_DEST_NOD_CD )" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ),4)  FIRST_LNK_DEST_NOD_CD ," ).append("\n"); 
		query.append("SUBSTRB( MAX( (CASE WHEN D.INLND_ROUT_CMB_FLG = 'Y' THEN TO_CHAR(D.ROUT_DTL_SEQ,'FM099')||D.LNK_DEST_NOD_CD  END) )" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ),4)  FULL_RTN_CY_CD_Y ," ).append("\n"); 
		query.append("SUBSTRB( MAX( TO_CHAR(D.ROUT_DTL_SEQ,'FM099')||D.LNK_ORG_NOD_CD )" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ),4)  LAST_LNK_ORG_NOD_CD ," ).append("\n"); 
		query.append("SUBSTRB( MIN( (CASE WHEN D.INLND_ROUT_CMB_FLG = 'Y' THEN TO_CHAR(D.ROUT_DTL_SEQ,'FM099')||D.LNK_ORG_NOD_CD  END) )" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ),4)  FULL_PKUP_YD_CD_Y ," ).append("\n"); 
		...
		query.append("MAX( DECODE(D.TRSP_MOD_CD, 'TD','TD'))" ).append("\n"); 
		query.append("OVER ( PARTITION BY D.ROUT_ORG_NOD_CD , D.ROUT_DEST_NOD_CD , D.ROUT_SEQ ) TD_TRSP_MOD_CD" ).append("\n"); 
