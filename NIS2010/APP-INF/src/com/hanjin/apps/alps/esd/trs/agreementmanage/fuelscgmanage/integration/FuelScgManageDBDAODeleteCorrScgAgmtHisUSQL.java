...
*@FileName : FuelScgManageDBDAODeleteCorrScgAgmtHisUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class FuelScgManageDBDAODeleteCorrScgAgmtHisUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FuelScgManageDBDAODeleteCorrScgAgmtHisUSQL(){
		setQuery();
		...
		query.append("FileName : FuelScgManageDBDAODeleteCorrScgAgmtHisUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
