...
*@FileName : AsiaInlandCostManageDBDAOAddInlandCostReeferCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaInlandCostManageDBDAOAddInlandCostReeferCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AsiaInlandCostManageDBDAOAddInlandCostReeferCSQL(){
		setQuery();
		...
		query.append("FileName : AsiaInlandCostManageDBDAOAddInlandCostReeferCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO AOC_CHN_INLND_RF_TRF_DTL" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("(" ).append("\n"); 
		query.append("      @[cost_trf_no]" ).append("\n"); 
		query.append("    , AOC_CHN_INLND_RF_TRF_SEQ1.NEXTVAL" ).append("\n"); 
		query.append("    , @[cost_trf_rout_seq]" ).append("\n"); 
		query.append("    , @[port_nod_cd]" ).append("\n"); 
		query.append("    , @[hub_nod_cd]" ).append("\n"); 
		query.append("    , @[loc_nod_cd]" ).append("\n"); 
