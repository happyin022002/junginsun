...
*@FileName : CreditIncentiveStatusDBDAOMultiMnrCreditUsedHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOMultiMnrCreditUsedHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * M&R Credit Used History Save
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOMultiMnrCreditUsedHisCSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOMultiMnrCreditUsedHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO EAS_MNR_CR_USD_HIS(" ).append("\n"); 
		query.append("       CR_ISS_NO" ).append("\n"); 
		query.append("      ,CR_USD_SEQ" ).append("\n"); 
		query.append("      ,CR_USD_HIS_SEQ" ).append("\n"); 
		...
		query.append("       @[cr_iss_no]" ).append("\n"); 
		query.append("      ,@[cr_usd_seq]" ).append("\n"); 
		query.append("      ,(SELECT CASE WHEN MAX(CR_USD_HIS_SEQ) IS NULL THEN 1" ).append("\n"); 
		query.append("                    ELSE MAX(CR_USD_HIS_SEQ)+1" ).append("\n"); 
		query.append("                END" ).append("\n"); 
		query.append("          FROM EAS_MNR_CR_USD_HIS" ).append("\n"); 
