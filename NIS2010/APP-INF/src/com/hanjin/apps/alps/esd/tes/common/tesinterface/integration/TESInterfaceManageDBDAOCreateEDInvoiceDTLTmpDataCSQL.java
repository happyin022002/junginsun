...
*@FileName : TESInterfaceManageDBDAOCreateEDInvoiceDTLTmpDataCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInterfaceManageDBDAOCreateEDInvoiceDTLTmpDataCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CreateEDInvoiceDTLTmpData
	  * </pre>
	  */
	public TESInterfaceManageDBDAOCreateEDInvoiceDTLTmpDataCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.tes.common.tesinterface.integration ").append("\n"); 
		query.append("FileName : TESInterfaceManageDBDAOCreateEDInvoiceDTLTmpDataCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("insert into TES_EDI_SO_DTL" ).append("\n"); 
		query.append("(" ).append("\n"); 
