...
*@FileName : ESD_TPB_0124HTMLAction.java
...
public class ESD_TPB_0124HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0124HTMLAction 객체를 생성
	 */
	public ESD_TPB_0124HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0124Event event = new EsdTpb0124Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchTPBHandlingListVOs((SearchTPBHandlingListVO[])getVOs(request, SearchTPBHandlingListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchTPBHandlingListVO((SearchTPBHandlingListVO)getVO(request, SearchTPBHandlingListVO .class));
		}
