...
*@FileName : TPBFileUploadDBDAOSearchGetFileNoSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TPBFileUploadDBDAOSearchGetFileNoSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TPBFileUploadDBDAOSearchGetFileNoSeqRSQL(){
		setQuery();
		...
		query.append("FileName : TPBFileUploadDBDAOSearchGetFileNoSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE file_no = NVL(@[s_file_no],'0')" ).append("\n"); 
