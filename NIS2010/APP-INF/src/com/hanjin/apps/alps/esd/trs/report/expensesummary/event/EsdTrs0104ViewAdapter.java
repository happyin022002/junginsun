...
*@FileName : EsdTrs0104ViewAdapter.java
...
public class EsdTrs0104ViewAdapter extends TrsDefaultViewAdapter {
        ...
        try
        {
        	if( formcommand.isCommand(FormCommand.MULTI) ||
                ...
                {    
                	...
                	if( sDiv.equals("22") || sDiv.equals("44") ){
						sEdit="FALSE";
					}else{
						sEdit="TRUE";
					}
