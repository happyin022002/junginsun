...
*@FileName : EacRegRptDBDAOSearchSpPerfRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacRegRptDBDAOSearchSpPerfRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EacRegRptDBDAOSearchSpPerfRSQL(){
		setQuery();
		...
		query.append("FileName : EacRegRptDBDAOSearchSpPerfRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      ,(SELECT X.VNDR_LGL_ENG_NM FROM MDM_VENDOR X WHERE X.VNDR_SEQ = AA.VNDR_SEQ) AS VNDR_NM      " ).append("\n"); 
		...
		query.append("      FROM (" ).append("\n"); 
		query.append("        SELECT TRS_COMMON_PKG.TRS_GET_RHQ_OFC_CD(AUDR_OFC_CD) RHQ_OFC_CD" ).append("\n"); 
		query.append("              ,AUDR_OFC_CD OFC_CD" ).append("\n"); 
		...
		query.append("--           AND A.EAC_STS_CD IN ('IS', 'AC', 'RC', 'HC') 요청에 의한 코드 변경" ).append("\n"); 
