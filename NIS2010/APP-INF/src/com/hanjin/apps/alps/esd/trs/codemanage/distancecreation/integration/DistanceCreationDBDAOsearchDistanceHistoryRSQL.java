...
*@FileName : DistanceCreationDBDAOsearchDistanceHistoryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DistanceCreationDBDAOsearchDistanceHistoryRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchDistanceHistory
	  * </pre>
	  */
	public DistanceCreationDBDAOsearchDistanceHistoryRSQL(){
		setQuery();
		...
		params.put("frm_node",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("to_node",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : DistanceCreationDBDAOsearchDistanceHistoryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM TRS_AGMT_DIST_HIS A" ).append("\n"); 
		query.append("WHERE 1=1" ).append("\n"); 
		query.append("AND A.HJL_NO IS NULL" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${frm_node} !='')" ).append("\n"); 
		query.append("AND A.fm_nod_cd = @[frm_node]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if(${to_node} !='')" ).append("\n"); 
		query.append("AND A.to_nod_cd = @[to_node]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
