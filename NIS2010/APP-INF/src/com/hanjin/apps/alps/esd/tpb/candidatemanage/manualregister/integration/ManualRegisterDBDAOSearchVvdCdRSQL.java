...
*@FileName : ManualRegisterDBDAOSearchVvdCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ManualRegisterDBDAOSearchVvdCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ManualRegisterDBDAOSearchVvdCdRSQL(){
		setQuery();
		...
		query.append("FileName : ManualRegisterDBDAOSearchVvdCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
