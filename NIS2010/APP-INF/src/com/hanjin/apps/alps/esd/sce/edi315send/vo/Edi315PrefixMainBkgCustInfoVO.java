...
*@FileName : Edi315PrefixMainBkgCustInfoVO.java
*@FileTitle : Edi315PrefixMainBkgCustInfoVO
*Open Issues :
*Change history :
...
public class Edi315PrefixMainBkgCustInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<Edi315PrefixMainBkgCustInfoVO> models = new ArrayList<Edi315PrefixMainBkgCustInfoVO>();
	...
	public Edi315PrefixMainBkgCustInfoVO() {}

	public Edi315PrefixMainBkgCustInfoVO(String ibflag, String pagerows, String shprcode, String shpr1, String shpr2, String shpr3, String shpr4, String shpr5, String shprCityNm, String shprStatCd, String shprZipCd, String shprCntCd, String cneecode, String cnee1, String cnee2, String cnee3, String cnee4, String cnee5, String cneeCityNm, String cneeStatCd, String cneeZipCd, String cneeCntCd, String ntfycode, String ntfy1, String ntfy2, String ntfy3, String ntfy4, String ntfy5, String ntfyCityNm, String ntfyStatCd, String ntfyZipCd, String ntfyCntCd, String antfycode) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("antfycode", getAntfycode());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("antfycode", "antfycode");
	 ...
	 * @return antfycode
	 */
	public String getAntfycode() {
		return this.antfycode;
	}
	 ...
	 * @param antfycode
	 */
	public void setAntfycode(String antfycode) {
		this.antfycode = antfycode;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAntfycode(JSPUtil.getParameter(request, prefix + "antfycode", ""));
	 ...
	 */
	public Edi315PrefixMainBkgCustInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return Edi315PrefixMainBkgCustInfoVO[]
	 */
	public Edi315PrefixMainBkgCustInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		Edi315PrefixMainBkgCustInfoVO model = null;
		...
		try {
			...
			String[] antfycode = (JSPUtil.getParameter(request, prefix	+ "antfycode", length));
			...
			for (int i = 0; i < length; i++) {
				model = new Edi315PrefixMainBkgCustInfoVO();
				if (ntfycode[i] != null)
				...
				if (antfycode[i] != null)
					model.setAntfycode(antfycode[i]);
		...
		return getEdi315PrefixMainBkgCustInfoVOs();
	}
	 ...
	 * @return Edi315PrefixMainBkgCustInfoVO[]
	 */
	public Edi315PrefixMainBkgCustInfoVO[] getEdi315PrefixMainBkgCustInfoVOs(){
		Edi315PrefixMainBkgCustInfoVO[] vos = (Edi315PrefixMainBkgCustInfoVO[])models.toArray(new Edi315PrefixMainBkgCustInfoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.antfycode = this.antfycode .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
