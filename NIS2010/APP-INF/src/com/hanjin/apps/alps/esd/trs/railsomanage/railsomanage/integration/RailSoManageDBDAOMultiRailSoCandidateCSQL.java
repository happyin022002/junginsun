...
*@FileName : RailSoManageDBDAOMultiRailSoCandidateCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailSoManageDBDAOMultiRailSoCandidateCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RailSoManageDBDAOMultiRailSoCandidateCSQL(){
		setQuery();
		...
		query.append("FileName : RailSoManageDBDAOMultiRailSoCandidateCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
