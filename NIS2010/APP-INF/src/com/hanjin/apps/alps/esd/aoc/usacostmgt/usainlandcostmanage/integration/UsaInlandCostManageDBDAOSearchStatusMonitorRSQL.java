...
*@FileName : UsaInlandCostManageDBDAOSearchStatusMonitorRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOSearchStatusMonitorRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOSearchStatusMonitorRSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOSearchStatusMonitorRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                                     , AOC_USA_INLND_TRF_HDR C" ).append("\n"); 
