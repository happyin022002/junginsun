...
*@FileName : ESD_EAS_0220HTMLAction.java
...
public class ESD_EAS_0220HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0220HTMLAction 객체를 생성
	 */
	public ESD_EAS_0220HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0220Event event = new EsdEas0220Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setEacInqEacVO((EACInqEacVO)getVO(request, EACInqEacVO .class));
		}
