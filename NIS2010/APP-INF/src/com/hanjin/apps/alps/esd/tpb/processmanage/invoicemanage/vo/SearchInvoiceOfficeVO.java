...
*@FileName : SearchInvoiceOfficeVO.java
*@FileTitle : SearchInvoiceOfficeVO
*Open Issues :
*Change history :
...
public class SearchInvoiceOfficeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchInvoiceOfficeVO> models = new ArrayList<SearchInvoiceOfficeVO>();
	...
	public SearchInvoiceOfficeVO() {}

	public SearchInvoiceOfficeVO(String ibflag, String pagerows, String cnt, String sInvIssOfcCd) {
		this.ibflag = ibflag;
		this.cnt = cnt;
	 ...
	 * @param request
	 * @return SearchInvoiceOfficeVO[]
	 */
	public SearchInvoiceOfficeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchInvoiceOfficeVO[]
	 */
	public SearchInvoiceOfficeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchInvoiceOfficeVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchInvoiceOfficeVO();
				if (ibflag[i] != null)
		...
		return getSearchInvoiceOfficeVOs();
	}
	 ...
	 * @return SearchInvoiceOfficeVO[]
	 */
	public SearchInvoiceOfficeVO[] getSearchInvoiceOfficeVOs(){
		SearchInvoiceOfficeVO[] vos = (SearchInvoiceOfficeVO[])models.toArray(new SearchInvoiceOfficeVO[models.size()]);
		return vos;
	}
