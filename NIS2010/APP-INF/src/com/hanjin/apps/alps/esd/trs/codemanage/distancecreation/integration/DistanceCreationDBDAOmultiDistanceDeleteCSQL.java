...
*@FileName : DistanceCreationDBDAOmultiDistanceDeleteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DistanceCreationDBDAOmultiDistanceDeleteCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DistanceCreationDBDAOmultiDistanceDeleteCSQL(){
		setQuery();
		...
		query.append("FileName : DistanceCreationDBDAOmultiDistanceDeleteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
