...
public class ProductCatalogCreateDBDAOSearchProductCatalogInternalDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT DECODE(nod_lnk_div_cd," ).append("\n"); 
		query.append("'N', org_nod_cd," ).append("\n"); 
		query.append("org_nod_cd || ' -> ' || dest_nod_cd" ).append("\n"); 
		query.append(") node_link," ).append("\n"); 
		query.append("'Planned' trans_st, DECODE(trsp_mod_cd,'X','',trsp_mod_cd) trsp_mod_cd," ).append("\n"); 
		...
		query.append("WHEN trsp_mod_cd IN ('WD', 'VD')" ).append("\n"); 
		...
		query.append("CASE WHEN nod_lnk_div_cd='N' AND PCTL_IO_BND_CD='O'" ).append("\n"); 
		query.append("AND ORG_NOD_TP_CD ='Z' AND DEST_NOD_TP_CD ='Z' THEN   'Y'" ).append("\n"); 
		query.append("ELSE 'N'" ).append("\n"); 
