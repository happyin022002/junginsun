...
*@FileName : AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlPreVerUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlPreVerUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * modifyFeederCostMgtCfmCxlPreVer
	  * </pre>
	  */
	public AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlPreVerUSQL(){
		setQuery();
		...
		params.put("in_rhq_cd",new String[]{arrTmp[0],arrTmp[1]});

		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.aoc.asiacostmgt.asiaoceanfeedercostmanage.integration").append("\n"); 
		query.append("FileName : AsiaOceanFeederCostManageDBDAOModifyFeederCostMgtCfmCxlPreVerUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE AOC_CHN_FDR_TRF_HDR" ).append("\n"); 
		query.append("   SET EFF_TO_DT = TO_DATE('29991231', 'YYYYMMDD')" ).append("\n"); 
		...
		query.append("                        WHERE RHQ_CD = @[in_rhq_cd]" ).append("\n"); 
