...
*@FileName : ESD_TES_100Event.java
...
/**
 * ESD_TES_100 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESD_TES_100HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.4
 */
public class EsdTes0100Event extends EventSupport {
...
//	
//
//	public EsdTes0100Event(){log.debug("ESD_TES_100Event -_----------------------");}
//
//	public EsdTes0100Event(AP_INV_HDR ap_inv_hdr, HashMap param_map) {
//		this.ap_inv_hdr = ap_inv_hdr;
//		this.param_map = param_map;
//    }
//
//	public EsdTes0100Event(AP_INV_HDR ap_inv_hdr, Collection ap_inv_hdrs, HashMap param_map) {
//		this.ap_inv_hdr = ap_inv_hdr;
