...
*@FileName : TESInvoiceCommonDBDAOSearchOldCsrDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESInvoiceCommonDBDAOSearchOldCsrDataRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESInvoiceCommonDBDAOSearchOldCsrDataRSQL(){
		setQuery();
		...
		query.append("FileName : TESInvoiceCommonDBDAOSearchOldCsrDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT B.INV_OFC_CD," ).append("\n"); 
		...
		query.append("       WHERE VNDR_SEQ = B.VNDR_NO) PAY_SP,       " ).append("\n"); 
		query.append("       B.CRE_DT,      " ).append("\n"); 
		query.append("       B.CRE_USR_ID," ).append("\n"); 
		query.append("       (SELECT USR_NM FROM COM_USER WHERE USR_ID = B.CRE_USR_ID)  CRE_USR_NM," ).append("\n"); 
		...
		query.append("	  AND TO_CHAR(A.CRE_DT,'YYYYMMDD') >= '20170101' " ).append("\n"); 
		query.append("      AND A.CRE_DT < SYSDATE-30" ).append("\n"); 
