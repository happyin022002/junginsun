...
*@FileName : TESeBillingManageBizType002DBDAOGetEDInvoiceToUpdateDtlVVDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESeBillingManageBizType002DBDAOGetEDInvoiceToUpdateDtlVVDRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TESeBillingManageBizType002DBDAOGetEDInvoiceToUpdateDtlVVDRSQL(){
		setQuery();
		...
		query.append("FileName : TESeBillingManageBizType002DBDAOGetEDInvoiceToUpdateDtlVVDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("Y.TML_EDI_SO_OFC_CTY_CD, Y.TML_EDI_SO_SEQ, Y.TML_EDI_SO_DTL_SEQ," ).append("\n"); 
		...
		query.append("Y.VVD_SRC CALC_RMK" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("X.TML_EDI_SO_OFC_CTY_CD, X.TML_EDI_SO_SEQ, X.TML_EDI_SO_DTL_SEQ," ).append("\n"); 
		query.append("CASE" ).append("\n"); 
		...
		query.append("FROM (" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("D.TML_EDI_SO_OFC_CTY_CD, D.TML_EDI_SO_SEQ, D.TML_EDI_SO_DTL_SEQ, D.VSL_CD||D.SKD_VOY_NO||D.SKD_DIR_CD ORG_VVD, D.MDM_VSL_CD," ).append("\n"); 
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
