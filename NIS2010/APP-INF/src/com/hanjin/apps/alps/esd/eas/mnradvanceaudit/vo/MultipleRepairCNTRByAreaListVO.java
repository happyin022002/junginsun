...
*@FileName : MultipleRepairCNTRByAreaListVO.java
*@FileTitle : MultipleRepairCNTRByAreaListVO
*Open Issues :
*Change history :
...
public class MultipleRepairCNTRByAreaListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MultipleRepairCNTRByAreaListVO> models = new ArrayList<MultipleRepairCNTRByAreaListVO>();
...
/**
	 ...
	 * @param request
	 * @return MultipleRepairCNTRByAreaListVO[]
	 */
	public MultipleRepairCNTRByAreaListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MultipleRepairCNTRByAreaListVO[]
	 */
	public MultipleRepairCNTRByAreaListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MultipleRepairCNTRByAreaListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MultipleRepairCNTRByAreaListVO();
				if (pagerows[i] != null)
		...
		return getMultipleRepairCNTRByAreaListVOs();
	}
	 ...
	 * @return MultipleRepairCNTRByAreaListVO[]
	 */
	public MultipleRepairCNTRByAreaListVO[] getMultipleRepairCNTRByAreaListVOs(){
		MultipleRepairCNTRByAreaListVO[] vos = (MultipleRepairCNTRByAreaListVO[])models.toArray(new MultipleRepairCNTRByAreaListVO[models.size()]);
		return vos;
	}
