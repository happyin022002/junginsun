...
*@FileName : CommodityGroupCodeManageDAOMultiPartCommodityDelUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityGroupCodeManageDBDAOMultiPartCommodityDelUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rail VENDOR 별 GROUP COMMODITY를 재 정의한 자료를 Delete 상태로 변경
	  * </pre>
	  */
	public CommodityGroupCodeManageDBDAOMultiPartCommodityDelUSQL(){
		setQuery();
		...
		query.append("FileName : CommodityGroupCodeManageDAOMultiPartCommodityDelUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
