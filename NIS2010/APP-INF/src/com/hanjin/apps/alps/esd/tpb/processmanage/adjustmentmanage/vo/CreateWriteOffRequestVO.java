...
public class CreateWriteOffRequestVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CreateWriteOffRequestVO> models = new ArrayList<CreateWriteOffRequestVO>();
	...
	public CreateWriteOffRequestVO() {}

	public CreateWriteOffRequestVO(String ibflag, String pagerows, String sWrtfRsnCd,String sN3ptyNo, String n3ptyNo, String sUserOfcCd, String sUserId, String sRaRmk1, String sStlToCltCngOfcCd, String stlToCltCngOfcCd, String sFileNo, String sRaRmk2) {
	 ...
	 */
	public CreateWriteOffRequestVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreateResponsibleOfficeChangeRequestVO[]
	 */
	public CreateWriteOffRequestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CreateWriteOffRequestVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CreateWriteOffRequestVO();
				if (sRaRmk2[i] != null)
	 ...
	 * @return CreateResponsibleOfficeChangeRequestVO[]
	 */
	public CreateWriteOffRequestVO[] getCreateResponsibleOfficeChangeRequestVOs(){
		CreateWriteOffRequestVO[] vos = (CreateWriteOffRequestVO[])models.toArray(new CreateWriteOffRequestVO[models.size()]);
		return vos;
	}
