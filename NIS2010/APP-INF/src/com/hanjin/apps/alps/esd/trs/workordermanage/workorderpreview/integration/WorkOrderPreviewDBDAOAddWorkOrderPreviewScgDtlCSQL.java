...
*@FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewScgDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOAddWorkOrderPreviewScgDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOAddWorkOrderPreviewScgDtlCSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewScgDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE WO_PRV_GRP_SEQ = @[scg_grp_seq]		" ).append("\n"); 
		query.append("	AND TRSP_SO_OFC_CTY_CD = @[trsp_so_ofc_cty_cd]			" ).append("\n"); 
		query.append("	AND TRSP_SO_SEQ = @[trsp_so_seq]		" ).append("\n"); 
		query.append("	AND (SUBSTR(LGS_COST_CD, 3, 2)	<> 'FU' AND SUBSTR(LGS_COST_CD, 3, 4) <> 'OTAX' AND  NVL(TRSP_AGMT_BFR_EXTD_FLG,'N') = 'N')" ).append("\n"); 
