 ...
 *@FileName : ESD_PRD_087HTMLAction.java
 *@FileTitle : ESD_PRD_087HTMLAction
 *Open Issues :
 *Change history :
 ...
 * @see ESD_PRD_087Event , ESD_PRD_087EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_PRD_0087HTMLAction extends HTMLActionSupport{

	/**
	 * ESD_PRD_087HTMLAction 객체를 생성
	 */
	public ESD_PRD_0087HTMLAction(){
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_PRD_087Event로 파싱하여 request에 셋팅<br>
	 * 
...
//		String userId = account.getUsr_id();
		...
		EsdPrd0087Event event = new EsdPrd0087Event();
		event.setAttribute("pgmNo", request.getServletPath().substring(1,13));
		event.setPrdImdgClssCdVO((PrdImdgClssCdVO)getVO(request, PrdImdgClssCdVO .class));
