...
*@FileName : SearchPerfCostDtlListVO.java
*@FileTitle : SearchPerfCostDtlListVO
*Open Issues :
*Change history :
...
public class SearchPerfCostDtlListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchPerfCostDtlListVO> models = new ArrayList<SearchPerfCostDtlListVO>();
	...
	public SearchPerfCostDtlListVO() {}

	public SearchPerfCostDtlListVO(String ibflag, String pagerows, String ofcCd, String glMon, String mdlCd, String vndrNo, String lgsCostCd, String lgsCostNm, String acctCd, String invCnt, String currCd, String currAmt, String usdAmt, String ymTpCd, String sYm, String sCompareMon, String sMdlCd, String sOfcCd, String sVndrSeq, String sLgsCostCd, String sRhqYn) {
...
/**
	 ...
	 * @param request
	 * @return SearchPerfCostDtlListVO[]
	 */
	public SearchPerfCostDtlListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchPerfCostDtlListVO[]
	 */
	public SearchPerfCostDtlListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchPerfCostDtlListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SearchPerfCostDtlListVO();
				if (pagerows[i] != null)
		...
		return getSearchPerfCostDtlListVOs();
	}
	...
	public SearchPerfCostDtlListVO[] getSearchPerfCostDtlListVOs(){
		SearchPerfCostDtlListVO[] vos = (SearchPerfCostDtlListVO[])models.toArray(new SearchPerfCostDtlListVO[models.size()]);
		return vos;
	}
