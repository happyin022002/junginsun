...
*@FileName : BkgCopManageDBDAOMergeMasCopIfMgmtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BkgCopManageDBDAOMergeMasCopIfMgmtCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BkgCopManageDBDAOMergeMasCopIfMgmtCSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.sce.bkgcopmanage.integration").append("\n"); 
		query.append("FileName : BkgCopManageDBDAOMergeMasCopIfMgmtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
