...
*@FileName : EacMgtDBDAOEACNtcHisVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EacMgtDBDAOEACNtcHisVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rejection Notice Send History 화면의 VO 생성쿼리
	  * </pre>
	  */
	public EacMgtDBDAOEACNtcHisVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.eas.eac.eacmgt.integration").append("\n"); 
		query.append("FileName : EacMgtDBDAOEACNtcHisVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , '' AS SND_TP_CD" ).append("\n"); 
		query.append("     , '' AS NTC_SND_DT" ).append("\n"); 
		...
		query.append("     , '' AS S_SND_TP_CD" ).append("\n"); 
		query.append("     , '' AS S_SND_FM_DT" ).append("\n"); 
		query.append("     , '' AS S_SND_TO_DT" ).append("\n"); 
		query.append("     , '' AS S_VNDR_SEQ" ).append("\n"); 
		query.append("     , '' AS S_SND_RSLT_CD" ).append("\n"); 
		query.append("     , '' AS S_SND_TP_CD" ).append("\n"); 
