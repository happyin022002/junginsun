...
*@FileName : MultipleRepairCNTRByAreaDetailVO.java
*@FileTitle : MultipleRepairCNTRByAreaDetailVO
*Open Issues :
*Change history :
...
public class MultipleRepairCNTRByAreaDetailVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MultipleRepairCNTRByAreaDetailVO> models = new ArrayList<MultipleRepairCNTRByAreaDetailVO>();
	...
	public MultipleRepairCNTRByAreaDetailVO() {}

	public MultipleRepairCNTRByAreaDetailVO(String ibflag, String pagerows, String ofcCd, String rhqOfcCd, String eqNo, String eqTpszCd, String rqstRefNo, String mnrInpDt, String woNo, String rnum, String vndrSeq, String vndrLglEngNm, String currCd, String woAmt, String chgCostAmt, String ydCd, String eqLocCd, String vndrCnt, String eqLocNm, String eqCmpoCd, String eqCmpoNm, String eqDmgCd, String eqDmgNm, String eqRprCd, String eqRprNm, String mnrVrfyTpNm, String onhDt, String dvValue, String usingDays, String woUser) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return MultipleRepairCNTRByAreaDetailVO[]
	 */
	public MultipleRepairCNTRByAreaDetailVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MultipleRepairCNTRByAreaDetailVO[]
	 */
	public MultipleRepairCNTRByAreaDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MultipleRepairCNTRByAreaDetailVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MultipleRepairCNTRByAreaDetailVO();
				if (ibflag[i] != null)
		...
		return getMultipleRepairCNTRByAreaDetailVOs();
	}
	 ...
	 * @return MultipleRepairCNTRByAreaDetailVO[]
	 */
	public MultipleRepairCNTRByAreaDetailVO[] getMultipleRepairCNTRByAreaDetailVOs(){
		MultipleRepairCNTRByAreaDetailVO[] vos = (MultipleRepairCNTRByAreaDetailVO[])models.toArray(new MultipleRepairCNTRByAreaDetailVO[models.size()]);
		return vos;
	}
