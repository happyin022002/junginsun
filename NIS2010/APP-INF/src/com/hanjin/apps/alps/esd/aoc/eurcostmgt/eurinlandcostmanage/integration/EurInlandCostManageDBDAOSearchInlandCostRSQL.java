...
*@FileName : EurInlandCostManageDBDAOSearchInlandCostRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOSearchInlandCostRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOSearchInlandCostRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOSearchInlandCostRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , D.INLND_45FT_TTL_AMT -- 45' Cost 추가" ).append("\n"); 
		...
		query.append("      , NVL(D.MB_45FT_RTO,0)||'%' MB_45FT_RTO -- 45' Cost 추가" ).append("\n"); 
		...
		query.append("      , D.TRSP_AGMT_45FT_MTY_YD_CD" ).append("\n"); 
		query.append("      , CASE WHEN NVL(D.MTY_PKUP_RTN_YD_CD, 1) = NVL(D.TRSP_AGMT_45FT_MTY_YD_CD, 1) THEN 'N' ELSE 'Y' END AS TRSP_DIFF_45FT" ).append("\n"); 
		query.append("      , CASE WHEN TRSP_45FT_COST_SYS_SRC_CD <> 'A' AND DECODE(D.INLND_ROUT_CMB_FLG,'N',D.N1ST_VNDR_45FT_AGMT_WGT,GREATEST(D.N1ST_VNDR_45FT_AGMT_WGT, D.N2ND_VNDR_45FT_AGMT_WGT)) IS NULL THEN 'MAX'" ).append("\n"); 
		query.append("      WHEN DECODE(D.INLND_ROUT_CMB_FLG,'N',D.N1ST_VNDR_45FT_AGMT_WGT,GREATEST(D.N1ST_VNDR_45FT_AGMT_WGT, D.N2ND_VNDR_45FT_AGMT_WGT)) = 999999.99 THEN 'MAX'" ).append("\n"); 
		query.append("      ELSE TO_CHAR(DECODE(D.INLND_ROUT_CMB_FLG,'N',D.N1ST_VNDR_45FT_AGMT_WGT,GREATEST(D.N1ST_VNDR_45FT_AGMT_WGT, D.N2ND_VNDR_45FT_AGMT_WGT)))" ).append("\n"); 
		query.append("      END AGMT_WGT_45FT" ).append("\n"); 
		query.append("      , SUBSTR(D.N1ST_VNDR_45FT_AGMT_WY_TP_CD, 1, 1)||SUBSTR(D.N2ND_VNDR_45FT_AGMT_WY_TP_CD, 1, 1) AS TRSP_RATE_TYPE_45FT" ).append("\n"); 
		...
		query.append("      -- 45' Cost 추가 end" ).append("\n"); 
		query.append("      , D.HJL_COST_RCVR_AMT HJL_FEE_AMT" ).append("\n"); 
		...
		query.append("                GREATEST(NVL(D.N1ST_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(D.N1ST_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(D.N1ST_VNDR_45FT_AGMT_OLD_FLG,'0'), NVL(D.N2ND_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(D.N2ND_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(D.N2ND_VNDR_45FT_AGMT_OLD_FLG,'0')),'0',NULL," ).append("\n"); 
		query.append("                GREATEST(NVL(D.N1ST_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(D.N1ST_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(D.N1ST_VNDR_45FT_AGMT_OLD_FLG,'0'), NVL(D.N2ND_VNDR_20FT_AGMT_OLD_FLG,'0'), NVL(D.N2ND_VNDR_40FT_AGMT_OLD_FLG,'0'), NVL(D.N2ND_VNDR_45FT_AGMT_OLD_FLG,'0'))" ).append("\n"); 
