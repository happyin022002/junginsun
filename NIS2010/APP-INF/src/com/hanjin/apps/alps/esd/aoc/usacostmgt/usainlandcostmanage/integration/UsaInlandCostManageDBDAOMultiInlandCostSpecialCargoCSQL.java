...
*@FileName : UsaInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UsaInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UsaInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL(){
		setQuery();
		...
		query.append("FileName : UsaInlandCostManageDBDAOMultiInlandCostSpecialCargoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO AOC_USA_INLND_SPCL_TRF_DTL" ).append("\n"); 
		...
		query.append("         , HDR.CURR_CD" ).append("\n"); 
		...
		query.append("         , @[upd_usr_id]" ).append("\n"); 
		query.append("         , SYSDATE         " ).append("\n"); 
		query.append("    FROM AOC_USA_INLND_TRF_HDR HDR" ).append("\n"); 
		...
		query.append("     AND INTG_CD_VAL_CTNT||CNTR_SZ_CD NOT IN ( SELECT TRSP_CRR_MOD_CD||CNTR_SZ_CD" ).append("\n"); 
		query.append("                                     FROM AOC_USA_INLND_SPCL_TRF_DTL" ).append("\n"); 
