...
*@FileName : InlandCostManageDBDAOmultiInlandCostHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandCostManageDBDAOmultiInlandCostHdrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InlandCostManageDBDAOmultiInlandCostHdrUSQL(){
		setQuery();
		...
		query.append("FileName : InlandCostManageDBDAOmultiInlandCostHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
