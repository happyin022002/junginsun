...
*@FileName : TesOffdockCYDetailCostByDayVO.java
*@FileTitle : TesOffdockCYDetailCostByDayVO
*Open Issues :
*Change history :
...
public class TesOffdockCYDetailCostByDayVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesOffdockCYDetailCostByDayVO> models = new ArrayList<TesOffdockCYDetailCostByDayVO>();
...
/**
	 ...
	 * @param request
	 * @return TesOffdockCYDetailCostByDayVO[]
	 */
	public TesOffdockCYDetailCostByDayVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesOffdockCYDetailCostByDayVO[]
	 */
	public TesOffdockCYDetailCostByDayVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesOffdockCYDetailCostByDayVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesOffdockCYDetailCostByDayVO();
				if (totQty[i] != null)
		...
		return getTesOffdockCYDetailCostByDayVOs();
	}
	 ...
	 * @return TesOffdockCYDetailCostByDayVO[]
	 */
	public TesOffdockCYDetailCostByDayVO[] getTesOffdockCYDetailCostByDayVOs(){
		TesOffdockCYDetailCostByDayVO[] vos = (TesOffdockCYDetailCostByDayVO[])models.toArray(new TesOffdockCYDetailCostByDayVO[models.size()]);
		return vos;
	}
