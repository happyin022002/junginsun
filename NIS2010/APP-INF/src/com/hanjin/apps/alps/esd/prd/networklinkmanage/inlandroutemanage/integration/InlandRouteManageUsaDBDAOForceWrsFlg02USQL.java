...
*@FileName : InlandRouteManageUsaDBDAOForceWrsFlg02USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageUsaDBDAOForceWrsFlg02USQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * force wrs flg setting 2
	  * </pre>
	  */
	public InlandRouteManageUsaDBDAOForceWrsFlg02USQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageUsaDBDAOForceWrsFlg02USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET WRS_FULL_CMDT_CD=''" ).append("\n"); 
