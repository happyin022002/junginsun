...
*@FileName : SearchPerCsInfoVO.java
*@FileTitle : SearchPerCsInfoVO
*Open Issues :
*Change history :
...
public class SearchPerCsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchPerCsInfoVO> models = new ArrayList<SearchPerCsInfoVO>();
	...
	public SearchPerCsInfoVO() {}

	public SearchPerCsInfoVO(String ibflag, String pagerows, String csGrpId, String tpId, String csDesc, String custCd, String ediSts) {
		this.ediSts = ediSts;
		this.ibflag = ibflag;
		this.csDesc = csDesc;
		this.custCd = custCd;
	 ...
	 */
	public SearchPerCsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchPerCsInfoVO[]
	 */
	public SearchPerCsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchPerCsInfoVO model = null;
	 ...
	 * @return SearchPerCsInfoVO[]
	 */
	public SearchPerCsInfoVO[] getSearchPerCsInfoVOs(){
		SearchPerCsInfoVO[] vos = (SearchPerCsInfoVO[])models.toArray(new SearchPerCsInfoVO[models.size()]);
		return vos;
	}
