...
*@FileName : CntDefaultCurrVO.java
*@FileTitle : CntDefaultCurrVO
*Open Issues :
*Change history :
...
public class CntDefaultCurrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CntDefaultCurrVO> models = new ArrayList<CntDefaultCurrVO>();
	...
	public CntDefaultCurrVO() {}

	public CntDefaultCurrVO(String ibflag, String pagerows, String cntCd, String cntNm, String contiNm, String scontiNm, String euCntFlg, String currCd, String currNm, String rhqCd, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CntDefaultCurrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CntDefaultCurrVO[]
	 */
	public CntDefaultCurrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CntDefaultCurrVO model = null;
	...
	public CntDefaultCurrVO[] getCntDefaultCurrVOs(){
		CntDefaultCurrVO[] vos = (CntDefaultCurrVO[])models.toArray(new CntDefaultCurrVO[models.size()]);
		return vos;
	}
