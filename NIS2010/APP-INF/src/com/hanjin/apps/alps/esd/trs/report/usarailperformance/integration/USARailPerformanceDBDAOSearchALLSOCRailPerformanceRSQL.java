...
*@FileName : USARailPerformanceDBDAOSearchALLSOCRailPerformanceRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class USARailPerformanceDBDAOSearchALLSOCRailPerformanceRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchALLSOCRailPerformance SELECT
	  * </pre>
	  */
	public USARailPerformanceDBDAOSearchALLSOCRailPerformanceRSQL(){
		setQuery();
		...
		query.append("FileName : USARailPerformanceDBDAOSearchALLSOCRailPerformanceRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
