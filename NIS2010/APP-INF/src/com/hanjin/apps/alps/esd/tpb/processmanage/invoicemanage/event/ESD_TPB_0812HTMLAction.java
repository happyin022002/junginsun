...
*@FileName : ESD_TPB_0812HTMLAction.java
...
public class ESD_TPB_0812HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0812HTMLAction 객체를 생성
	 */
	public ESD_TPB_0812HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0812Event event = new EsdTpb0812Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchIndiaTaxInfoVOs((SearchIndiaTaxInfoVO[])getVOs(request, SearchIndiaTaxInfoVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setSearchIndiaTaxInfoVO((SearchIndiaTaxInfoVO)getVO(request, SearchIndiaTaxInfoVO .class));
		}
