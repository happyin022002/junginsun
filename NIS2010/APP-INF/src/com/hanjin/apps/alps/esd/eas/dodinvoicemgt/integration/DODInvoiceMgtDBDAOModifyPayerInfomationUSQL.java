...
*@FileName : DODInvoiceMgtDBDAOModifyPayerInfomationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DODInvoiceMgtDBDAOModifyPayerInfomationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyPayerInfomation
	  * </pre>
	  */
	public DODInvoiceMgtDBDAOModifyPayerInfomationUSQL(){
		setQuery();
		...
		query.append("FileName : DODInvoiceMgtDBDAOModifyPayerInfomationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE EAS_PAYR_INFO" ).append("\n"); 
		query.append("SET " ).append("\n"); 
		query.append("	PAYR_NM 		= @[payr_nm]" ).append("\n"); 
		...
		query.append(",	N1ST_EML 		= @[n1st_eml]" ).append("\n"); 
