...
*@FileName : ESD_EAS_0221HTMLAction.java
...
public class ESD_EAS_0221HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_EAS_0221HTMLAction 객체를 생성
	 */
	public ESD_EAS_0221HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0221Event event = new EsdEas0221Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		   event.setEacNtcHisVO((EACNtcHisVO)getVO(request, EACNtcHisVO .class));
		}
