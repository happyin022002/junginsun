...
*@FileName : EurInlandCostSpecialCargoVO.java
*@FileTitle : EurInlandCostSpecialCargoVO
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
public class EurInlandCostSpecialCargoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurInlandCostSpecialCargoVO> models = new ArrayList<EurInlandCostSpecialCargoVO>();
...
/**
	 ...
	 */
	public EurInlandCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurInlandCostSpecialCargoVO[]
	 */
	public EurInlandCostSpecialCargoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurInlandCostSpecialCargoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EurInlandCostSpecialCargoVO();
	...
	public EurInlandCostSpecialCargoVO[] getInlandCostSpecialCargoVOs(){
		EurInlandCostSpecialCargoVO[] vos = (EurInlandCostSpecialCargoVO[])models.toArray(new EurInlandCostSpecialCargoVO[models.size()]);
		return vos;
	}
