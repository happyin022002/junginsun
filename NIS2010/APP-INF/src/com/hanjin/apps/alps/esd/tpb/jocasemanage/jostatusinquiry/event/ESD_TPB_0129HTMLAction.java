...
*@FileName : ESD_TPB_0129HTMLAction.java
...
public class ESD_TPB_0129HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_TPB_0129HTMLAction 객체를 생성
	 */
	public ESD_TPB_0129HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTpb0129Event event = new EsdTpb0129Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setSearchJOInvoiceListVOS((SearchJOInvoiceListVO[])getVOs(request, SearchJOInvoiceListVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchJOInvoiceListVO((SearchJOInvoiceListVO)getVO(request, SearchJOInvoiceListVO .class));
		}
