...
*@FileName : InlandRouteManageDBDAOInlandRouteSaveAsUSCheckWrs2RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InlandRouteManageDBDAOInlandRouteSaveAsUSCheckWrs2RSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * InlandRouteSaveAsUSCheckWrs2
	  * </pre>
	  */
	public InlandRouteManageDBDAOInlandRouteSaveAsUSCheckWrs2RSQL(){
		setQuery();
		...
		query.append("FileName : InlandRouteManageDBDAOInlandRouteSaveAsUSCheckWrs2RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
