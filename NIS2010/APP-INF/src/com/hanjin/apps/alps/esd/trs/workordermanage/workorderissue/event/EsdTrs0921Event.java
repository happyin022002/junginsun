...
//	private HashMap hashParam = new HashMap();
	...
	String locCntCd;		// Office 가 USA 이면서 Agreement Type 이 HJS 일경우 More Candidate 사용을 필수 처리 하기 위한
	String mltMorOnyFlg;
	...
	/**
	 * @param locCntCd the locCntCd to set
	 */
	public void setLocCntCd(String locCntCd) {
		this.locCntCd = locCntCd;
	}
	
	public String getMltMorOnyFlg() {
		return mltMorOnyFlg;
	}
	public void setMltMorOnyFlg(String mltMorOnyFlg) {
		this.mltMorOnyFlg = mltMorOnyFlg;
	}
