...
*@FileName : ESD_AOC_3302HTMLAction.java
 ...
 * @since J2EE 1.6
 */
public class ESD_AOC_3302HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_AOC_3302HTMLAction 객체를 생성
	 */
	public ESD_AOC_3302HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	EsdAoc3302Event event = new EsdAoc3302Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInlandCostConditionVO((UsaInlandCostConditionVO)getVO(request, UsaInlandCostConditionVO .class));
			...
			event.setInlandCostConditionVO((UsaInlandCostConditionVO)getVO(request, UsaInlandCostConditionVO .class));
			event.setInlandCostVOS((UsaInlandCostVO[])getVOs(request, UsaInlandCostVO .class,""));
		} else if(command.isCommand(FormCommand.MULTI02)) {
			event.setInBtnSts(JSPUtil.getParameter(request, "in_btn_sts", ""));
			event.setInlandCostConditionVO((UsaInlandCostConditionVO)getVO(request, UsaInlandCostConditionVO .class));
			event.setInlandCostSpecialCargoVOS((UsaInlandCostSpecialCargoVO[])getVOs(request, UsaInlandCostSpecialCargoVO .class,""));
