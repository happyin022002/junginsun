...
*@FileName : AgreementImportDBDAODeleteCorrScgAgmtDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementImportDBDAODeleteCorrScgAgmtDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgreementImportDBDAODeleteCorrScgAgmtDSQL(){
		setQuery();
		...
		query.append("FileName : AgreementImportDBDAODeleteCorrScgAgmtDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
