 ...
 *@FileName : ESD_PRD_0006HTMLAction.java
 ...
 *
 * @author jungsunyong
 * @see EsdPrd0006Event , ESD_PRD_006EventResponse 참조
 * @since J2EE 1.4
 */
public class ESD_PRD_0006HTMLAction extends HTMLActionSupport{

	/**
	 * ESD_PRD_0006HTMLAction 객체를 생성
	 */
	public ESD_PRD_0006HTMLAction(){
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_PRD_006Event로 파싱하여 request에 셋팅<br>
	 * 
...
//		FormCommand command = FormCommand.fromRequest(request);
		EsdPrd0006Event event = new EsdPrd0006Event();

		event.setAttribute("pgmNo", request.getServletPath().substring(1,13));
		event.setInlandRouteSelCreVO((InlandRouteSelCreVO) getVO(request, InlandRouteSelCreVO.class));
