...
*@FileName : EurInlandCostManageDBDAOVerifyInlandCostLocGrpCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOVerifyInlandCostLocGrpCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOVerifyInlandCostLocGrpCntRSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOVerifyInlandCostLocGrpCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
