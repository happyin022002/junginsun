...
*@FileName : JOInvoiceManageDBDAOSearchInvoiceStatusCheckForRevisionRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JOInvoiceManageDBDAOSearchInvoiceStatusCheckForRevisionRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JOInvoiceManageDBDAOSearchInvoiceStatusCheckForRevisionRSQL(){
		setQuery();
		...
		query.append("FileName : JOInvoiceManageDBDAOSearchInvoiceStatusCheckForRevisionRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE( COUNT(*), 1, 'Y', 'N') VALIDYN" ).append("\n"); 
