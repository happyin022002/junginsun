...
*@FileName : AdjustmentManageDBDAOSearchNextStepROCCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AdjustmentManageDBDAOSearchNextStepROCCheckRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AdjustmentManageDBDAOSearchNextStepROCCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AdjustmentManageDBDAOSearchNextStepROCCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DECODE(COUNT(H.N3PTY_NO),0,'N','Y') NXT_STP_ROC_CHK" ).append("\n"); 
		...
		query.append("AND H.UPD_USR_ID = (" ).append("\n"); 
		...
		query.append("AND H.N2ND_RVW_AVAL_FLG IS NULL" ).append("\n"); 
