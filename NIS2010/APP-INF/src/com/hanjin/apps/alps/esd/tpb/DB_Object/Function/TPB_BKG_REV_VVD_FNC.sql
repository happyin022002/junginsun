...
/********************************************************************************************************************* 
   ...
   5. Author           : Sun, Choi 
   6. Description      : REVENUE VVD Select, COA_BOOKING_V, AGT_BKG_REV_VVD_PRC 참고 
   7. Revision History : 2007.04.03  Kim Y. C       1.0  Created 
                         2009.08.10  Park Sung-Jin  1.1  ALPS Migration 
                         2012.07.13  An Jeong-Seon  1.2  AGT_BOOKING_V -->TRS_BOOKING_V 변경 
                         2012.08.27  An Jeong-Seon  1.3  COA 변경분 반여
                             동일 노선간의 T/S시 Rev.VVD 선정 로직 변경" - COA_RANK_INFO_FNC
                         2014.09.24  JS.AN [CHM-201431808] Split 06-[COA] 동일노선간의 T/S시 Rev.VVD 선정 로직 변경
                         2015.06.18  KIM HYUN HWA - COA 관련 Func 를 MAS로 변경함.
                         2015.11.05  KIM HYUN HWA - [CHM-201538461]팬듈럼(PDM) Rev. Lane 귀속 로직 변경. mas_rev_dir_conv_fnc 의 POD 추가                     
**********************************************************************************************************************/ 
(  
...
BEGIN 
   ...
   SELECT NVL(TPB_GET_RLANE_FNC(first_lane_cd,first_pol_cd,first_pod_cd), 'RBCCO'), 
        ...
        /* POD 추가 */      
          x_first_vvd||nvl(mas_rev_dir_conv_fnc(first_lane_cd,first_pol_cd,substr(x_first_vvd,9,1), first_pod_cd),substr(x_first_vvd,9,1)), 
          x_second_vvd||nvl(decode(second_lane_cd,'',null,mas_rev_dir_conv_fnc(second_lane_cd,second_pol_cd,substr(x_second_vvd,9,1),second_pod_cd)),substr(x_second_vvd,9,1)), 
          x_third_vvd||nvl(decode(third_lane_cd,'',null,mas_rev_dir_conv_fnc(third_lane_cd,third_pol_cd,substr(x_third_vvd,9,1), third_pod_cd)),substr(x_third_vvd,9,1)), 
          x_fourth_vvd||nvl(decode(fourth_lane_cd,'',null,mas_rev_dir_conv_fnc(fourth_lane_cd,fourth_pol_cd,substr(x_fourth_vvd,9,1), fourth_pod_cd)),substr(x_fourth_vvd,9,1)), 
        /*                               
    ...
    --v_rank :=coa_rank_info_fnc(v_n1st_rlane_cd,v_n2nd_rlane_cd,v_n3rd_rlane_cd,v_n4th_rlane_cd,v_n1st_conti ,v_n2nd_conti,v_n3rd_conti,v_n4th_conti,null,null,null,null);   
    v_rank :=mas_rank_info_comp_fnc(v_n1st_rlane_cd,v_n2nd_rlane_cd,v_n3rd_rlane_cd,v_n4th_rlane_cd,v_n1st_conti ,v_n2nd_conti,v_n3rd_conti,v_n4th_conti,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
