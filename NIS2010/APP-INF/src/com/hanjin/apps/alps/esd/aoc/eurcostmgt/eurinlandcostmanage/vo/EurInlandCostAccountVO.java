...
*@FileName : EurInlandCostAccountVO.java
*@FileTitle : EurInlandCostAccountVO
*Open Issues :
*Change history :
...
public class EurInlandCostAccountVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EurInlandCostAccountVO> models = new ArrayList<EurInlandCostAccountVO>();
...
/**
	 ...
	 */
	public EurInlandCostAccountVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EurInlandCostAccountVO[]
	 */
	public EurInlandCostAccountVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EurInlandCostAccountVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EurInlandCostAccountVO();
		...
		return getEurInlandCostAccountVOs();
	}
	 ...
	 * @return EurInlandCostAccountVO[]
	 */
	public EurInlandCostAccountVO[] getEurInlandCostAccountVOs(){
		EurInlandCostAccountVO[] vos = (EurInlandCostAccountVO[])models.toArray(new EurInlandCostAccountVO[models.size()]);
		return vos;
	}
