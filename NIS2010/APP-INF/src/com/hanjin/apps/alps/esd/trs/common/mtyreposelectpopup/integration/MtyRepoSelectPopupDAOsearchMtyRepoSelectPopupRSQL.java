...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.esd.trs.common.mtyreposelectpopup.integration;
...
public class MtyRepoSelectPopupDAOsearchMtyRepoSelectPopupRSQL implements ISQLTemplate{
	...
	public MtyRepoSelectPopupDAOsearchMtyRepoSelectPopupRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.apps.alps.esd.trs.common.mtyreposelectpopup.integration").append("\n"); 
