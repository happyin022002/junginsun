...
*@FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListDeleteDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListDeleteDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MultiRevCalcVolContainerListDelete
	  * </pre>
	  */
	public OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListDeleteDSQL(){
		setQuery();
		...
		query.append("FileName : OffdockCYInvoiceManageDBDAOMultiRevCalcVolContainerListDeleteDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
