...
*@FileName : TerminalAgreementManageDBDAORemoveAgreementTPSZDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalAgreementManageDBDAORemoveAgreementTPSZDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalAgreementManageDBDAORemoveAgreementTPSZDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalAgreementManageDBDAORemoveAgreementTPSZDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM  TES_TML_AGMT_TP_SZ" ).append("\n"); 
