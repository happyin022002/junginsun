...
public class ESD_SCE_0165HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESD_SCE_0154HTMLAction 객체를 생성
	 */
	public ESD_SCE_0165HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdSce0165Event event = new EsdSce0165Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchOneTimeSndHistVO((SearchOneTimeSndHistVO)getVO(request, SearchOneTimeSndHistVO .class));
		}
