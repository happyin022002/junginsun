...
*@FileName : RailBillingReqCreateDBDAOInsertRailBillVndrSetEmptyCntrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RailBillingReqCreateDBDAOInsertRailBillVndrSetEmptyCntrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Insert Rail Bill Vender Set (Empty Cntr) SQL
	  * </pre>
	  */
	public RailBillingReqCreateDBDAOInsertRailBillVndrSetEmptyCntrCSQL(){
		setQuery();
		...
		query.append("FileName : RailBillingReqCreateDBDAOInsertRailBillVndrSetEmptyCntrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("(" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("DECODE(@[fm_nod_cd], LNK_ORG_NOD_CD, ROUT_DTL_SEQ) MIN_SEQ," ).append("\n"); 
		query.append("DECODE(@[to_nod_cd], LNK_DEST_NOD_CD, ROUT_DTL_SEQ) MAX_SEQ," ).append("\n"); 
