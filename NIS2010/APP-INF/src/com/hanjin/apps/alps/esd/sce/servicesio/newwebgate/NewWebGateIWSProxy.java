...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.apps.alps.esd.sce.servicesio.newwebgate;
...
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.CntrMvmt;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.CntrMvmtRequest;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.CntrMvmtResponse;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.Movement;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.MovementRequest;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.MovementResponse;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.SppSce0001Event;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.SppSce0001EventResponse;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.SppSce0002Event;
import com.hanjin.apps.alps.esd.sce.servicesio.newwebgate.event.SppSce0002EventResponse;
...
@WLHttpTransport(contextPath="/hanjin/webservices", serviceUri="/NewWebGateIWSProxy",
