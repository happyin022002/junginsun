...
/**
 * ESD_SCE_0140 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - ESD_SCE_0140HTMLAction에서 작성<br>
 ...
 * @since J2EE 1.6 
 */
public class EsdSce0140Event extends EventSupport {
	...
	private String prop_ofc_cd = null;

	private String ctrt_ofc_cd = null;
	...
	public EsdSce0140Event(){}
	
	/**
	 * @param searchDwellVO
	 */
	public EsdSce0140Event(SearchDwellVO searchDwellVO) {
	 ...
	 * @return the cntr_no
	 */
	public String getProp_ofc_cd() {
		return prop_ofc_cd;
	}

	/**
	 * @param prop_ofc_cd the prop_ofc_cd to set
	 */
	public void setProp_ofc_cd(String prop_ofc_cd) {
		this.prop_ofc_cd = prop_ofc_cd;
	}

	/**
	 * @return the ctrt_ofc_cd
	 */
	public String getCtrt_ofc_cd() {
		return ctrt_ofc_cd;
	}

	/**
	 * @param ctrt_ofc_cd the ctrt_ofc_cd to set
	 */
	public void setCtrt_ofc_cd(String ctrt_ofc_cd) {
