...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditStorageContainerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditStorageContainerListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditStorageContainerListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditStorageContainerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
