...
*@FileName : InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceCalculationListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceCalculationListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * Terminal Invoice Calculation List
	  * </pre>
	  */
	public InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceCalculationListRSQL(){
		setQuery();
		...
		query.append("FileName : InvoiceProcessingAuditManageDBDAOSearchAuditTerminalInvoiceCalculationListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, A.RF_MNTR_DYS" ).append("\n"); 
		query.append("		, A.PLUG_TERM" ).append("\n"); 
		query.append("		--// CHM-201538943 TES Invoice Processing Audit 기능 보완 (By Bkg) (2015-11-24 양양선B 요청)" ).append("\n"); 
		query.append("		-- 4000Byte까지만 가능" ).append("\n"); 
		query.append("		--, WM_CONCAT(B.CNTR_NO) AS CNTR_LIST  " ).append("\n"); 
		query.append("		-- 4000Byte 초과로 에러 발생막기위해." ).append("\n"); 
		query.append("		--, SUBSTR(SUBSTR( XMLAgg(XMLElement(X, ',', B.CNTR_NO) ORDER BY A.INV_NO).Extract('//text()').getCLOBval() , 2), 0 , 1000) AS CNTR_LIST" ).append("\n"); 
		query.append("		, COUNT(B.CNTR_NO) AS BKG_CNTR_VOL" ).append("\n"); 
		query.append("		, COUNT(B.CNTR_NO) * CTRT_RT * INV_XCH_RT AS BKG_CNTR_AMT" ).append("\n"); 
		...
		query.append("				, D.VSL_CD || D.SKD_VOY_NO || D.SKD_DIR_CD AS VVD_NO" ).append("\n"); 
		query.append("				, D.IOC_CD" ).append("\n"); 
		query.append("				, D.LANE_CD" ).append("\n"); 
		query.append("				, D.LANE_CD AS LANE_CD2" ).append("\n"); 
		...
		query.append("				, TO_CHAR(D.ATB_DT, 'YYYYMMDD') AS ATB_DT" ).append("\n"); 
		query.append("				, D.CNTR_NO" ).append("\n"); 
		query.append("				, D.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("				, D.CALC_VOL_QTY" ).append("\n"); 
		query.append("				, NVL(D.FM_TR_VOL_VAL, '1') AS FM_TR_VOL_VAL" ).append("\n"); 
		query.append("				, NVL(D.TO_TR_VOL_VAL, '99999') AS TO_TR_VOL_VAL" ).append("\n"); 
		query.append("				, NVL(D.FM_TR_VOL_VAL, '1') || ' ~ ' || NVL(D.TO_TR_VOL_VAL, '99999') AS TIER" ).append("\n"); 
		query.append("				, D.RVIS_VOL_QTY" ).append("\n"); 
		query.append("				, DECODE(D.DCGO_IND_CD, '', 'N', D.DCGO_IND_CD) AS DCGO_IND_CD" ).append("\n"); 
		...
		query.append("				, D.PLG_TERM_DYS AS PLUG_TERM" ).append("\n"); 
		...
		query.append("				, D.TML_SO_DTL_SEQ" ).append("\n"); 
		query.append("				, D.CALC_COST_GRP_CD" ).append("\n"); 
		query.append("				, DECODE(D.CALC_TP_CD, 'A', D.CALC_TP_CD, (DECODE(D.SEMI_AUTO_CALC_FLG, 'Y', 'S', D.CALC_TP_CD)))" ).append("\n"); 
		query.append("				, D.VSL_CD" ).append("\n"); 
		query.append("				, D.SKD_VOY_NO " ).append("\n"); 
		query.append("				, D.SKD_DIR_CD" ).append("\n"); 
		...
		query.append("				, D.LGS_COST_CD" ).append("\n"); 
		query.append("				, D.ACCT_CD" ).append("\n"); 
		query.append("				, TO_CHAR(D.ATB_DT, 'YYYYMMDD')" ).append("\n"); 
		query.append("				, D.CNTR_NO" ).append("\n"); 
		query.append("				, D.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("				, D.CALC_VOL_QTY" ).append("\n"); 
		query.append("				, NVL(D.FM_TR_VOL_VAL, '1')" ).append("\n"); 
		query.append("				, NVL(D.TO_TR_VOL_VAL, '99999')" ).append("\n"); 
		query.append("				, NVL(D.FM_TR_VOL_VAL, '1') || ' ~ ' || NVL(D.TO_TR_VOL_VAL, '99999')" ).append("\n"); 
		query.append("				, D.RVIS_VOL_QTY" ).append("\n"); 
		query.append("				, DECODE(D.DCGO_IND_CD, '', 'N', D.DCGO_IND_CD)" ).append("\n"); 
		query.append("				, D.STAY_DYS" ).append("\n"); 
		query.append("				, D.FREE_DYS" ).append("\n"); 
		query.append("				, D.OVR_DYS" ).append("\n"); 
		query.append("				, D.TML_WRK_DY_CD" ).append("\n"); 
		...
		query.append("				, D.TML_TRNS_MOD_CD" ).append("\n"); 
		query.append("				, D.RF_MNTR_DYS" ).append("\n"); 
		query.append("				, D.PLG_TERM_DYS" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${bkg_no} != '' or ${cntr_no} != '' ) " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("GROUP BY  A.INV_OFC_CD" ).append("\n"); 
		query.append("		, A.COST_OFC_CD" ).append("\n"); 
		query.append("		, A.INV_NO" ).append("\n"); 
		query.append("		, A.VNDR_SEQ" ).append("\n"); 
		query.append("		, A.YD_CD" ).append("\n"); 
