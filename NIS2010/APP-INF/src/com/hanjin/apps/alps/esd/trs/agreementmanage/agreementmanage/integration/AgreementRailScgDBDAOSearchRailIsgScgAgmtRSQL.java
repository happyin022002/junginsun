...
*@FileName : AgreementRailScgDBDAOSearchRailIsgScgAgmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgreementRailScgDBDAOSearchRailIsgScgAgmtRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agreement USA Rail Surcharge Incentiv  조회
	  * </pre>
	  */
	public AgreementRailScgDBDAOSearchRailIsgScgAgmtRSQL(){
		setQuery();
		...
		query.append("FileName : AgreementRailScgDBDAOSearchRailIsgScgAgmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
