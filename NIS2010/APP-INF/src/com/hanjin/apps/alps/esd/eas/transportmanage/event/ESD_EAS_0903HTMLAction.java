...
*@FileName : ESD_EAS_0903HTMLAction.java
 ...
 * @since J2EE 1.4
 */
public class ESD_EAS_0903HTMLAction extends HTMLActionSupport {

	   /**
     * ESD_EAS_0903HTMLAction 객체를 생성
     */
    public ESD_EAS_0903HTMLAction() {
    }
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdEas0903Event event = new EsdEas0903Event(); // table value object

		String bkgNo = request.getParameter("bkg_no");
		String soOfcCd = request.getParameter("so_ofc_cd");
	
		event.setBkgNo(bkgNo);
		event.setSoOfcCd(soOfcCd);
