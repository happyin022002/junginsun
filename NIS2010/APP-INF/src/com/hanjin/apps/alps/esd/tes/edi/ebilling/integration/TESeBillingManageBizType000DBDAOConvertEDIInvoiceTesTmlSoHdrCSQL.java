...
*@FileName : TESeBillingManageBizType000DBDAOConvertEDIInvoiceTesTmlSoHdrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TESeBillingManageBizType000DBDAOConvertEDIInvoiceTesTmlSoHdrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 일반 TML invoice 기본 정보 생성
	  * </pre>
	  */
	public TESeBillingManageBizType000DBDAOConvertEDIInvoiceTesTmlSoHdrCSQL(){
		setQuery();
		...
		query.append("FileName : TESeBillingManageBizType000DBDAOConvertEDIInvoiceTesTmlSoHdrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
