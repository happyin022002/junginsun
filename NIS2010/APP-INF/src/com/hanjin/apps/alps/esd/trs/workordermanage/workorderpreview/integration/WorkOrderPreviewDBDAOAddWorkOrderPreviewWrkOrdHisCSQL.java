...
*@FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewWrkOrdHisCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOAddWorkOrderPreviewWrkOrdHisCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * trs_trsp_wrk_ord_his insert
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOAddWorkOrderPreviewWrkOrdHisCSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOAddWorkOrderPreviewWrkOrdHisCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
