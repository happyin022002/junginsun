...
*@FileName : CreditIncentiveStatusDBDAOMultiTrsIncentiveCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOMultiTrsIncentiveCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOMultiTrsIncentiveCSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOMultiTrsIncentiveCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO EAS_TRSP_INCNT A USING DUAL" ).append("\n"); 
		query.append("      ON( A.BSE_YR = @[bse_yr]" ).append("\n"); 
		query.append("          AND A.INCNT_NO  = @[incnt_no]" ).append("\n"); 
		query.append(") " ).append("\n"); 
		query.append("WHEN MATCHED THEN" ).append("\n"); 
		query.append("      UPDATE" ).append("\n"); 
		query.append("         SET RHQ_CD                 = @[rhq_cd]" ).append("\n"); 
		query.append("			,INV_OFC_CD             = @[inv_ofc_cd]" ).append("\n"); 
		query.append("			,INV_TRNS_MOD_CD        = @[inv_trns_mod_cd]" ).append("\n"); 
		query.append("			,VNDR_SEQ               = @[vndr_seq]" ).append("\n"); 
		query.append("			,ORG_YD_DESC            = @[org_yd_desc]" ).append("\n"); 
		query.append("			,DEST_YD_DESC           = @[dest_yd_desc]" ).append("\n"); 
		query.append("			,EFF_FM_DT              = TO_DATE(@[eff_fm_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("			,EFF_TO_DT              = TO_DATE(@[eff_to_dt],'YYYYMMDD')" ).append("\n"); 
		query.append("			,INV_CYC_CD             = @[inv_cyc_cd]" ).append("\n"); 
		query.append("			,INV_ISS_DT_RMK         = @[inv_iss_dt_rmk]" ).append("\n"); 
		query.append("			,FULL_MTY_CD            = @[full_mty_cd]" ).append("\n"); 
		query.append("			,LGS_COST_CD            = @[lgs_cost_cd]" ).append("\n"); 
		query.append("			,INCNT_UT_CD            = @[incnt_ut_cd]" ).append("\n"); 
		query.append("			,JAN_CNTR_VOL_QTY       = @[jan_cntr_vol_qty]" ).append("\n"); 
		query.append("			,FEB_CNTR_VOL_QTY       = @[feb_cntr_vol_qty]" ).append("\n"); 
		query.append("			,MAR_CNTR_VOL_QTY       = @[mar_cntr_vol_qty]" ).append("\n"); 
		query.append("			,APR_CNTR_VOL_QTY       = @[apr_cntr_vol_qty]" ).append("\n"); 
		query.append("			,MAY_CNTR_VOL_QTY       = @[may_cntr_vol_qty]" ).append("\n"); 
		query.append("			,JUN_CNTR_VOL_QTY       = @[jun_cntr_vol_qty]" ).append("\n"); 
		query.append("			,JUL_CNTR_VOL_QTY       = @[jul_cntr_vol_qty]" ).append("\n"); 
		query.append("			,AUG_CNTR_VOL_QTY       = @[aug_cntr_vol_qty]" ).append("\n"); 
		query.append("			,SEP_CNTR_VOL_QTY       = @[sep_cntr_vol_qty]" ).append("\n"); 
		query.append("			,OCT_CNTR_VOL_QTY       = @[oct_cntr_vol_qty]" ).append("\n"); 
		query.append("			,NOV_CNTR_VOL_QTY       = @[nov_cntr_vol_qty]" ).append("\n"); 
		query.append("			,DEC_CNTR_VOL_QTY       = @[dec_cntr_vol_qty]" ).append("\n"); 
		query.append("			,TTL_CNTR_VOL_QTY       = @[ttl_cntr_vol_qty]" ).append("\n"); 
		query.append("			,ESTM_CNTR_VOL_QTY      = @[estm_cntr_vol_qty]" ).append("\n"); 
		query.append("			,CURR_CD                = @[curr_cd]" ).append("\n"); 
		query.append("			,CNTR_UT_INCNT_AMT      = @[cntr_ut_incnt_amt]" ).append("\n"); 
		query.append("			,JAN_INCNT_AMT          = @[jan_incnt_amt]" ).append("\n"); 
		query.append("			,FEB_INCNT_AMT          = @[feb_incnt_amt]" ).append("\n"); 
		query.append("			,MAR_INCNT_AMT          = @[mar_incnt_amt]" ).append("\n"); 
		query.append("			,APR_INCNT_AMT          = @[apr_incnt_amt]" ).append("\n"); 
		query.append("			,MAY_INCNT_AMT          = @[may_incnt_amt]" ).append("\n"); 
		query.append("			,JUN_INCNT_AMT          = @[jun_incnt_amt]" ).append("\n"); 
		query.append("			,JUL_INCNT_AMT          = @[jul_incnt_amt]" ).append("\n"); 
		query.append("			,AUG_INCNT_AMT          = @[aug_incnt_amt]" ).append("\n"); 
		query.append("			,SEP_INCNT_AMT          = @[sep_incnt_amt]" ).append("\n"); 
		query.append("			,OCT_INCNT_AMT          = @[oct_incnt_amt]" ).append("\n"); 
		query.append("			,NOV_INCNT_AMT          = @[nov_incnt_amt]" ).append("\n"); 
		query.append("			,DEC_INCNT_AMT          = @[dec_incnt_amt]" ).append("\n"); 
		query.append("			,TTL_INCNT_AMT          = @[ttl_incnt_amt]" ).append("\n"); 
		query.append("			,TTL_RCV_AMT            = @[ttl_rcv_amt]" ).append("\n"); 
		query.append("			,TTL_RMN_AMT            = @[ttl_rmn_amt]" ).append("\n"); 
		query.append("			,TTL_INCNT_USD_AMT      = @[ttl_incnt_usd_amt]" ).append("\n"); 
		query.append("			,TTL_RCV_USD_AMT        = @[ttl_rcv_usd_amt]" ).append("\n"); 
		query.append("			,TTL_RMN_USD_AMT        = @[ttl_rmn_usd_amt]" ).append("\n"); 
		query.append("			,RCT_DT_RMK             = @[rct_dt_rmk]" ).append("\n"); 
		query.append("			,INCNT_DESC             = @[incnt_desc]" ).append("\n"); 
		query.append("			,INCNT_RMK              = @[incnt_rmk]" ).append("\n"); 
		query.append("			,ATCH_FILE_LNK_ID       = @[atch_file_lnk_id]" ).append("\n"); 
		query.append("            ,ATCH_N2ND_FILE_LNK_ID  = @[atch_n2nd_file_lnk_id]" ).append("\n"); 
		query.append("			,UPD_USR_ID             = @[usr_id]" ).append("\n"); 
		query.append("			,UPD_DT                 = SYSDATE" ).append("\n"); 
		query.append("WHEN NOT MATCHED THEN" ).append("\n"); 
		query.append("    INSERT( BSE_YR" ).append("\n"); 
