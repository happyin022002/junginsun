...
*@FileName : SpotBiddingSpUsrInfoEvent.java
 ...
 * @since J2EE 1.6
 */
public class SpotBiddingSpUsrInfoEvent extends EventSupport {
	...
	/**
	 * SPP로부터 사용자 정보를 I/F 받는다.  
	 * @param spotBiddingReceiveBiddingAmt
	 */
	public SpotBiddingSpUsrInfoEvent(SpotBiddingSpUsrInfo[] spotBiddingSpUsrInfo){
		this.spotBiddingSpUsrInfo = spotBiddingSpUsrInfo;
	}
}