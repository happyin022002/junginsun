...
*@FileName : EurOceanFeederCostManageDBDAOSearchFeederCostRFRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurOceanFeederCostManageDBDAOSearchFeederCostRFRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurOceanFeederCostManageDBDAOSearchFeederCostRFRSQL(){
		setQuery();
		...
		query.append("FileName : EurOceanFeederCostManageDBDAOSearchFeederCostRFRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
