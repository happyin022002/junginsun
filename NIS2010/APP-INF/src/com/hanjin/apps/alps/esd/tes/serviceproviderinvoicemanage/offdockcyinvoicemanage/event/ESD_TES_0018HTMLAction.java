...
*@FileName : ESD_TES_0018HTMLAction.java
 ...
 *
 * @author jongbaemoon
 * @see EsdTes0018Event 참조
 * @since J2EE 1.4
 */
public class ESD_TES_0018HTMLAction extends HTMLActionSupport {
	...
	/**
	 * ESD_TES_0018HTMLAction 객체를 생성
	 */
	public ESD_TES_0018HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ESD_TES_0018Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		EsdTes0018Event event = new EsdTes0018Event();
