...
*@FileName : CreditIncentiveStatusDBDAOModifyTrsFileAttachUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CreditIncentiveStatusDBDAOModifyTrsFileAttachUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CreditIncentiveStatusDBDAOModifyTrsFileAttachUSQL(){
		setQuery();
		...
		query.append("FileName : CreditIncentiveStatusDBDAOModifyTrsFileAttachUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
