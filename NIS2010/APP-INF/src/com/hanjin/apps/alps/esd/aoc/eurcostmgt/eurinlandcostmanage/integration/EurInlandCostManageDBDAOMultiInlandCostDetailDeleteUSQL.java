...
*@FileName : EurInlandCostManageDBDAOMultiInlandCostDetailDeleteUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EurInlandCostManageDBDAOMultiInlandCostDetailDeleteUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EurInlandCostManageDBDAOMultiInlandCostDetailDeleteUSQL(){
		setQuery();
		...
		query.append("FileName : EurInlandCostManageDBDAOMultiInlandCostDetailDeleteUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
