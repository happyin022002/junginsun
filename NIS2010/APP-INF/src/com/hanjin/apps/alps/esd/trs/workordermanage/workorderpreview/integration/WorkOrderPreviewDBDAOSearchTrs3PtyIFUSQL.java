...
*@FileName : WorkOrderPreviewDBDAOSearchTrs3PtyIFUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class WorkOrderPreviewDBDAOSearchTrs3PtyIFUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public WorkOrderPreviewDBDAOSearchTrs3PtyIFUSQL(){
		setQuery();
		...
		query.append("FileName : WorkOrderPreviewDBDAOSearchTrs3PtyIFUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND IF_FLG = 'N'" ).append("\n"); 
