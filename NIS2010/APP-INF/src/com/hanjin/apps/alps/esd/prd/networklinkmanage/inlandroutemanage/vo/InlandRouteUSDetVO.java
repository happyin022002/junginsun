...
*@FileName : InlandRouteUSDetVO.java
*@FileTitle : InlandRouteUSDetVO
*Open Issues :
*Change history :
...
public class InlandRouteUSDetVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InlandRouteUSDetVO> models = new ArrayList<InlandRouteUSDetVO>();
	
	/* Column Info */
	private String lnkDestType = null;
	/* Column Info */
	private String clonTrspModCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String clonRailCrrTpCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String clonCombinedMd = null;
	/* Column Info */
	private String creUsrId = null;
	/* Column Info */
	private String clonVndrSeq = null;
	/* Column Info */
	private String trspAgmtSeq = null;
	/* Column Info */
	private String vndrSeq = null;
	/* Column Info */
	private String refeNo = null;
	/* Column Info */
	...
	/* Column Info */
	private String combinedMd = null;
	/* Column Info */
	...
	/* Column Info */
	private String clonAgmtNo = null;
	/* Column Info */
	...
	/* Column Info */
	private String clonInlndRoutJuncNm = null;
	/* Column Info */
	...
	public InlandRouteUSDetVO() {}

	public InlandRouteUSDetVO(String ibflag, String pagerows, String routOrgNodCd, String routDestNodCd, String routSeq, String prioSeq, String lnkOrgNodCd, String lnkDestNodCd, String routDtlSeq, String trspModCd, String lnkOrgLoc, String lnkOrgType, String lnkDestLoc, String lnkDestType, String cnt, String sumTtTime, String vndrSeq, String lnkDist, String distUtCd, String creOfcCd, String railCrrTpCd, String inlndRoutInvBilPattCd, String routPlnCd, String mcntrRoutFlg, String tztmHrs, String inlndRoutRmk, String inlndRoutCmbFlg, String vndrAbbrNm, String inlndRoutJuncNm, String fmtTztmHrs, String fc, String cc, String wrsFullCmdt, String wrsFullCmdtCd, String wrsMtyCmdtCd, String inlndRoutBkgFlg, String trspAgmtOfcCtyCd, String trspAgmtSeq, String agmtNo, String agmtRefNo, String clonTrspModCd, String clonRailCrrTpCd, String clonCombinedMd, String clonVndrSeq, String refeNo, String vndrName, String combinedMd, String clonAgmtNo, String selRow, String clonInlndRoutJuncNm, String updUsrId, String creUsrId,String ctyCd,String iAgmtSeq, String inlndRoutOptmFlg) {
		this.lnkDestType = lnkDestType;
		this.clonTrspModCd = clonTrspModCd;
		...
		this.clonRailCrrTpCd = clonRailCrrTpCd;
		...
		this.clonCombinedMd = clonCombinedMd;
		this.creUsrId = creUsrId;
		this.clonVndrSeq = clonVndrSeq;
		...
		this.clonInlndRoutJuncNm = clonInlndRoutJuncNm;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("clon_trsp_mod_cd", getClonTrspModCd());
		...
		this.hashColumns.put("clon_rail_crr_tp_cd", getClonRailCrrTpCd());
		...
		this.hashColumns.put("clon_combined_md", getClonCombinedMd());
		this.hashColumns.put("cre_usr_id", getCreUsrId());
		this.hashColumns.put("clon_vndr_seq", getClonVndrSeq());
		this.hashColumns.put("trsp_agmt_seq", getTrspAgmtSeq());
		this.hashColumns.put("vndr_seq", getVndrSeq());
		this.hashColumns.put("refe_no", getRefeNo());
		...
		this.hashColumns.put("combined_md", getCombinedMd());
		...
		this.hashColumns.put("clon_agmt_no", getClonAgmtNo());
		this.hashColumns.put("cnt", getCnt());
		this.hashColumns.put("wrs_full_cmdt", getWrsFullCmdt());
		this.hashColumns.put("sel_row", getSelRow());
		...
		this.hashColumns.put("clon_inlnd_rout_junc_nm", getClonInlndRoutJuncNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("clon_trsp_mod_cd", "clonTrspModCd");
		...
		this.hashFields.put("clon_rail_crr_tp_cd", "clonRailCrrTpCd");
		...
		this.hashFields.put("clon_combined_md", "clonCombinedMd");
		this.hashFields.put("cre_usr_id", "creUsrId");
		this.hashFields.put("clon_vndr_seq", "clonVndrSeq");
		this.hashFields.put("trsp_agmt_seq", "trspAgmtSeq");
		this.hashFields.put("vndr_seq", "vndrSeq");
		this.hashFields.put("refe_no", "refeNo");
		...
		this.hashFields.put("combined_md", "combinedMd");
		...
		this.hashFields.put("clon_agmt_no", "clonAgmtNo");
		this.hashFields.put("cnt", "cnt");
		this.hashFields.put("wrs_full_cmdt", "wrsFullCmdt");
		this.hashFields.put("sel_row", "selRow");
		...
		this.hashFields.put("clon_inlnd_rout_junc_nm", "clonInlndRoutJuncNm");
	...
	/**
	 * Column Info
	 * @return clonTrspModCd
	 */
	public String getClonTrspModCd() {
		return this.clonTrspModCd;
	}
	...
	/**
	 * Column Info
	 * @return clonRailCrrTpCd
	 */
	public String getClonRailCrrTpCd() {
		return this.clonRailCrrTpCd;
	}
	...
	/**
	 * Column Info
	 * @return clonCombinedMd
	 */
	public String getClonCombinedMd() {
		return this.clonCombinedMd;
	}
	 ...
	 * @return clonVndrSeq
	 */
	public String getClonVndrSeq() {
		return this.clonVndrSeq;
	}
	 ...
	 * @return combinedMd
	 */
	public String getCombinedMd() {
		return this.combinedMd;
	}
	 ...
	 * @return clonAgmtNo
	 */
	public String getClonAgmtNo() {
		return this.clonAgmtNo;
	}
	...
	/**
	 * Column Info
	 * @return clonInlndRoutJuncNm
	 */
	public String getClonInlndRoutJuncNm() {
		return this.clonInlndRoutJuncNm;
	}
	 ...
	 * @param clonTrspModCd
	 */
	public void setClonTrspModCd(String clonTrspModCd) {
		this.clonTrspModCd = clonTrspModCd;
	}
	...
	/**
	 * Column Info
	 * @param clonRailCrrTpCd
	 */
	public void setClonRailCrrTpCd(String clonRailCrrTpCd) {
		this.clonRailCrrTpCd = clonRailCrrTpCd;
	}
	...
	/**
	 * Column Info
	 * @param clonCombinedMd
	 */
	public void setClonCombinedMd(String clonCombinedMd) {
		this.clonCombinedMd = clonCombinedMd;
	}
	 ...
	 * @param clonVndrSeq
	 */
	public void setClonVndrSeq(String clonVndrSeq) {
		this.clonVndrSeq = clonVndrSeq;
	}
	 ...
	 * @param combinedMd
	 */
	public void setCombinedMd(String combinedMd) {
		this.combinedMd = combinedMd;
	}
	 ...
	 * @param clonAgmtNo
	 */
	public void setClonAgmtNo(String clonAgmtNo) {
		this.clonAgmtNo = clonAgmtNo;
	}
	...
	/**
	 * Column Info
	 * @param clonInlndRoutJuncNm
	 */
	public void setClonInlndRoutJuncNm(String clonInlndRoutJuncNm) {
		this.clonInlndRoutJuncNm = clonInlndRoutJuncNm;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setClonTrspModCd(JSPUtil.getParameter(request, "clon_trsp_mod_cd", ""));
		...
		setClonRailCrrTpCd(JSPUtil.getParameter(request, "clon_rail_crr_tp_cd", ""));
		...
		setClonCombinedMd(JSPUtil.getParameter(request, "clon_combined_md", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setClonVndrSeq(JSPUtil.getParameter(request, "clon_vndr_seq", ""));
		setTrspAgmtSeq(JSPUtil.getParameter(request, "trsp_agmt_seq", ""));
		setVndrSeq(JSPUtil.getParameter(request, "vndr_seq", ""));
		setRefeNo(JSPUtil.getParameter(request, "refe_no", ""));
		...
		setCombinedMd(JSPUtil.getParameter(request, "combined_md", ""));
		...
		setClonAgmtNo(JSPUtil.getParameter(request, "clon_agmt_no", ""));
		setCnt(JSPUtil.getParameter(request, "cnt", ""));
		setWrsFullCmdt(JSPUtil.getParameter(request, "wrs_full_cmdt", ""));
		setSelRow(JSPUtil.getParameter(request, "sel_row", ""));
		...
		setClonInlndRoutJuncNm(JSPUtil.getParameter(request, "clon_inlnd_rout_junc_nm", ""));
	 ...
	 */
	public InlandRouteUSDetVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InlandRouteUSDetVO[]
	 */
	public InlandRouteUSDetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InlandRouteUSDetVO model = null;
		...
		try {
			...
			String[] clonTrspModCd = (JSPUtil.getParameter(request, prefix	+ "clon_trsp_mod_cd", length));
			...
			String[] clonRailCrrTpCd = (JSPUtil.getParameter(request, prefix	+ "clon_rail_crr_tp_cd", length));
			...
			String[] clonCombinedMd = (JSPUtil.getParameter(request, prefix	+ "clon_combined_md", length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id", length));
			String[] clonVndrSeq = (JSPUtil.getParameter(request, prefix	+ "clon_vndr_seq", length));
			String[] trspAgmtSeq = (JSPUtil.getParameter(request, prefix	+ "trsp_agmt_seq", length));
			String[] vndrSeq = (JSPUtil.getParameter(request, prefix	+ "vndr_seq", length));
			String[] refeNo = (JSPUtil.getParameter(request, prefix	+ "refe_no", length));
			...
			String[] combinedMd = (JSPUtil.getParameter(request, prefix	+ "combined_md", length));
			...
			String[] clonAgmtNo = (JSPUtil.getParameter(request, prefix	+ "clon_agmt_no", length));
			...
			String[] selRow = (JSPUtil.getParameter(request, prefix	+ "sel_row", length));
			...
			String[] clonInlndRoutJuncNm = (JSPUtil.getParameter(request, prefix	+ "clon_inlnd_rout_junc_nm", length));
			...
			for (int i = 0; i < length; i++) {
				model = new InlandRouteUSDetVO();
				if (lnkDestType[i] != null)
					model.setLnkDestType(lnkDestType[i]);
				if (clonTrspModCd[i] != null)
					model.setClonTrspModCd(clonTrspModCd[i]);
				...
				if (clonRailCrrTpCd[i] != null)
					model.setClonRailCrrTpCd(clonRailCrrTpCd[i]);
				...
				if (clonCombinedMd[i] != null)
					model.setClonCombinedMd(clonCombinedMd[i]);
				if (creUsrId[i] != null)
					model.setCreUsrId(creUsrId[i]);
				if (clonVndrSeq[i] != null)
					model.setClonVndrSeq(clonVndrSeq[i]);
				if (trspAgmtSeq[i] != null)
					model.setTrspAgmtSeq(trspAgmtSeq[i]);
				if (vndrSeq[i] != null)
					model.setVndrSeq(vndrSeq[i]);
				if (refeNo[i] != null)
					model.setRefeNo(refeNo[i]);
				...
				if (combinedMd[i] != null)
					model.setCombinedMd(combinedMd[i]);
				if (creOfcCd[i] != null)
				...
				if (clonAgmtNo[i] != null)
					model.setClonAgmtNo(clonAgmtNo[i]);
				if (cnt[i] != null)
					model.setCnt(cnt[i]);
				if (wrsFullCmdt[i] != null)
					model.setWrsFullCmdt(wrsFullCmdt[i]);
				if (selRow[i] != null)
					model.setSelRow(selRow[i]);
				if (routPlnCd[i] != null)
				...
				if (clonInlndRoutJuncNm[i] != null)
					model.setClonInlndRoutJuncNm(clonInlndRoutJuncNm[i]);
				if (prioSeq[i] != null)
	...
	public InlandRouteUSDetVO[] getInlandRouteUSDetVOs(){
		InlandRouteUSDetVO[] vos = (InlandRouteUSDetVO[])models.toArray(new InlandRouteUSDetVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.clonTrspModCd = this.clonTrspModCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.clonRailCrrTpCd = this.clonRailCrrTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.clonCombinedMd = this.clonCombinedMd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.creUsrId = this.creUsrId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.clonVndrSeq = this.clonVndrSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.trspAgmtSeq = this.trspAgmtSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.vndrSeq = this.vndrSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.refeNo = this.refeNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.combinedMd = this.combinedMd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.clonAgmtNo = this.clonAgmtNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.selRow = this.selRow .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.clonInlndRoutJuncNm = this.clonInlndRoutJuncNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
