...
*@FileName : UsaInlandCostTariffInfoVO.java
*@FileTitle : UsaInlandCostTariffInfoVO
*Open Issues :
*Change history :
...
public class UsaInlandCostTariffInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UsaInlandCostTariffInfoVO> models = new ArrayList<UsaInlandCostTariffInfoVO>();
	...
	public UsaInlandCostTariffInfoVO() {}

	public UsaInlandCostTariffInfoVO(String ibflag, String pagerows, String ioBndCd, String ioBndNm, String costTrfStsCd, String costTrfStsNm, String currCd, String effFmDt, String updDt, String updUsrId, String nextTrfFlg, String costTrfBatSeq, String avgCnt,String cntr20ftCrteWgt, String cntr40ftCrteWgt, String avgTrkCnt, String avgRailCnt) {
		this.updDt = updDt;
		this.ibflag = ibflag;
		this.currCd = currCd;
...
/**
	 ...
	 */
	public UsaInlandCostTariffInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UsaInlandCostTariffInfoVO[]
	 */
	public UsaInlandCostTariffInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UsaInlandCostTariffInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UsaInlandCostTariffInfoVO();
				if (updDt[i] != null)
	 ...
	 * @return UsaInlandCostTariffInfoVO[]
	 */
	public UsaInlandCostTariffInfoVO[] getInlandCostTariffInfoVOs(){
		UsaInlandCostTariffInfoVO[] vos = (UsaInlandCostTariffInfoVO[])models.toArray(new UsaInlandCostTariffInfoVO[models.size()]);
		return vos;
	}
