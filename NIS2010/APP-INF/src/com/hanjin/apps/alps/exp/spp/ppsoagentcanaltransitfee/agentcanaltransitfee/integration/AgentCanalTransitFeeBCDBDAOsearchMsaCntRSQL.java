...
*@FileName : AgentCanalTransitFeeBCDBDAOsearchMsaCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOsearchMsaCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOsearchMsaCntRSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOsearchMsaCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
