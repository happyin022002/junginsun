...
*@FileName : AgentCanalTransitFeeBCDBDAOaddPsoCnlTzAtchFileCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOaddPsoCnlTzAtchFileCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOaddPsoCnlTzAtchFileCSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOaddPsoCnlTzAtchFileCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PSO_CNL_TZ_ATCH_FILE" ).append("\n"); 
		query.append("       (" ).append("\n"); 
