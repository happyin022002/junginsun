...
*@FileName : EXP_SPP_0006HTMLAction.java
...
public class EXP_SPP_0006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EXP_SPP_0006HTMLAction 객체를 생성
	 */
	public EXP_SPP_0006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ExpSpp0006Event event = new ExpSpp0006Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {  //retrieve button click
			event.setCanalTransitScheduleVO((CanalTransitScheduleVO)getVO(request, CanalTransitScheduleVO .class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {//save button click	
			event.setCanalTransitScheduleVOs((CanalTransitScheduleVO[])getVOs(request, CanalTransitScheduleVO .class, "sheet1_"));
		}
