...
public class ExpSpp0003Event extends EventSupport {
	...
	/** Table Value Object Multi Data 처리 */
	private PsoCnlTzAtchFileVO[] psoCnlTzAtchFileVOs = null;	

	/** Table Value Object 조회 조건 및 단건 처리  */
	private PsoCnlTzAtchFileVO psoCnlTzAtchFileVO = null;
	...
	public void setPsoCnlTzAtchFileVO(PsoCnlTzAtchFileVO psoCnlTzAtchFileVO){
		this. psoCnlTzAtchFileVO = psoCnlTzAtchFileVO;
	}

	public void setPsoCnlTzAtchFileVOS(PsoCnlTzAtchFileVO[] psoCnlTzAtchFileVOs){
		this. psoCnlTzAtchFileVOs = psoCnlTzAtchFileVOs;
	}

	public PsoCnlTzAtchFileVO getPsoCnlTzAtchFileVO(){
		return psoCnlTzAtchFileVO;
	}

	public PsoCnlTzAtchFileVO[] getPsoCnlTzAtchFileVOS(){
		return psoCnlTzAtchFileVOs;
	}
