...
*@FileName : AgentCanalTransitFeeBCDBDAOsearchCanalTzAllowanceTEURSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOsearchCanalTzAllowanceTEURSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchCanalTzAllowanceTEU
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOsearchCanalTzAllowanceTEURSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOsearchCanalTzAllowanceTEURSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND BUD_SCNR_NO 		= A.BUD_SCNR_NO" ).append("\n"); 
		query.append("),999999999999999.99))" ).append("\n"); 
		query.append("TTL_AMT,  --ADV. Payment TTL Amount" ).append("\n"); 
		query.append("A.SCG_RT_AMT," ).append("\n"); 
