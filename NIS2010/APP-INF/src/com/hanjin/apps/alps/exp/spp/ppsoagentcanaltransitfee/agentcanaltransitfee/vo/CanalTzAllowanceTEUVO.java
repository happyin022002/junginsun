...
*@FileName : CanalTzAllowanceTEUVO.java
*@FileTitle : CanalTzAllowanceTEUVO
*Open Issues :
*Change history :
...
public class CanalTzAllowanceTEUVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CanalTzAllowanceTEUVO> models = new ArrayList<CanalTzAllowanceTEUVO>();
	...
	public CanalTzAllowanceTEUVO() {}

	public CanalTzAllowanceTEUVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String revYrmon, String ttlAmt, String scgRtAmt, String suzNetTongWgt, String loclXchRt, String trVolVal, String cnlTzProcStsCd, String cntrPnmCapa) {
		this.vslCd = vslCd;
	 ...
	 */
	public CanalTzAllowanceTEUVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CanalTzAllowanceTEUVO[]
	 */
	public CanalTzAllowanceTEUVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CanalTzAllowanceTEUVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CanalTzAllowanceTEUVO();
				if (vslCd[i] != null)
		...
		return getCanalTzAllowanceTEUVOs();
	}
	 ...
	 * @return CanalTzAllowanceTEUVO[]
	 */
	public CanalTzAllowanceTEUVO[] getCanalTzAllowanceTEUVOs(){
		CanalTzAllowanceTEUVO[] vos = (CanalTzAllowanceTEUVO[])models.toArray(new CanalTzAllowanceTEUVO[models.size()]);
		return vos;
	}
