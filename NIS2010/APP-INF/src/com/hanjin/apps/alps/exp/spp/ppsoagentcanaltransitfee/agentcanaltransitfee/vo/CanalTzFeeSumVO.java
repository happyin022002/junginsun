...
public class CanalTzFeeSumVO extends AbstractValueObject {
	...
	/* Column Info */
	private String portSkipSts = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("port_skip_sts", getPortSkipSts());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("port_skip_sts", "portSkipSts");
	 ...
	 * @return trnsDt
	 */
	public String getPortSkipSts() {
		return this.portSkipSts;
	}
	 ...
	 * @param portSkipSts
	 */
	public void setPortSkipSts(String portSkipSts) {
		this.portSkipSts = portSkipSts;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPortSkipSts(JSPUtil.getParameter(request, prefix + "port_skip_sts", ""));
	}
	...
	public CanalTzFeeSumVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] portSkipSts = (JSPUtil.getParameter(request, prefix	+ "port_skip_sts", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (portSkipSts[i] != null)
					model.setPortSkipSts(portSkipSts[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.portSkipSts = this.portSkipSts .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
