...
public class AgentCanalTransitFeeBCDBDAOsearchCanalTransitScheduleRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      	,TO_CHAR(T6.CNL_BKG_TZ_DT,'YYYY-MM-DD') CNL_BKG_TZ_DT" ).append("\n"); 
		query.append("      	,T6.CNL_OT_SVC_APRO_FLG" ).append("\n"); 
		query.append("		,TO_CHAR(T6.CNL_OT_SVC_ARR_DT,'YYYY-MM-DD HH24:MI') CNL_OT_SVC_ARR_DT" ).append("\n"); 
		query.append("		,T6.CNL_BKG_AMT" ).append("\n"); 
		...
		query.append("AND		T1.VSL_SLAN_CD	= T7.VSL_SLAN_CD" ).append("\n"); 
