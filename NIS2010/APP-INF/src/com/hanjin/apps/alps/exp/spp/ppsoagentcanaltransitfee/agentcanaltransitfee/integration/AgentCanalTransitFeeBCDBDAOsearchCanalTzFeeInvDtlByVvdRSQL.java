...
public class AgentCanalTransitFeeBCDBDAOsearchCanalTzFeeInvDtlByVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("NULL FILE_SAV_ID," ).append("\n"); 
		query.append("NULL FILE_UPLD_NM" ).append("\n"); 
		...
		query.append("D.FILE_SAV_ID," ).append("\n"); 
		query.append("D.FILE_UPLD_NM" ).append("\n"); 
		query.append("FROM 	(" ).append("\n"); 
		...
		query.append("AND DECODE((select VSL_OWN_IND_CD from MDM_VSL_CNTR where VSL_CD = SUBSTR(@[vvd],0,4)),'O',LGS_COST_CD,'YYYY') <> 'CNOW'" ).append("\n"); 
		...
		query.append("--SUBSTR(A.LGS_COST_CD,1,4) LGS_COST_CD," ).append("\n"); 
		query.append("A.LGS_COST_CD," ).append("\n"); 
		query.append("A.FILE_SAV_ID," ).append("\n"); 
		query.append("B.FILE_UPLD_NM" ).append("\n"); 
		query.append("FROM" ).append("\n"); 
		query.append("PSO_CNL_TZ_ATCH_FILE A," ).append("\n"); 
		...
		query.append("AND     A.LGS_COST_CD = D.LGS_COST_CD(+)" ).append("\n"); 
