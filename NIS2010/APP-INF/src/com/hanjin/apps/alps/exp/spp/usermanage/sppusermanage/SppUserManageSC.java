...
* 1.0 Creation
=========================================================*/
package com.hanjin.apps.alps.exp.spp.usermanage.sppusermanage;

import java.util.List;

import com.hanjin.apps.alps.exp.spp.usermanage.sppusermanage.basic.SppUserManageBC;
...
import com.hanjin.apps.alps.exp.spp.usermanage.sppusermanage.integration.SppUserManageDBDAO;
...
public class SppUserManageSC extends ServiceCommandSupport {
	...
	public EventResponse perform(Event e) throws EventException {
		...
		if (e.getEventName().equalsIgnoreCase("SppusermanageEvent")) {
			if (e.getFormCommand().isCommand(FormCommand.SEARCH)) {
				...
				eventResponse = modifySppUserBidPwdInfo(e);
			}	
		}  
		return eventResponse;
	}
	...
	/**
	 * Bidding User Password 수정
	 * @param e
	 * @return
	 * @exception EventException
	 */
	private EventResponse modifySppUserBidPwdInfo(Event e) throws EventException {
		...
		try{
			begin();
			command.modifySppUserBidPwdInfo(mnrPartnerGRPVO, account);
			commit();
		}catch(EventException ex){
			rollback();
			throw ex;
