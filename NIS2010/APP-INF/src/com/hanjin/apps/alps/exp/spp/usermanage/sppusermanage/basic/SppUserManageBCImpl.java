	...
	public void modifySppUserBidPwdInfo(MnrPartnerGRPVO mnrPartnerGRPVO, SignOnUserAccount account) throws EventException{
		try {     
			...
			if ( mnrPartnerGRPVO !=null ) { 
				...
				prnrVO.setSpPtalPwd(URLDecoder.decode(prnrVO.getSpPtalPwd(), "UTF-8"));
				prnrVO.setUpdUsrId(URLDecoder.decode(prnrVO.getSpPtalId(), "UTF-8"));
				prnrVO.setSpPtalId(URLDecoder.decode(prnrVO.getSpPtalId(), "UTF-8"));
				
				dbDao.modifySppUserBidPwdInfo(prnrVO);
			}   
