...
public class AgentCanalTransitFeeBCDBDAOsearchCanalTzVVDListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       ,ADV_PY_STS" ).append("\n"); 
		...
		query.append("          FROM VSK_VSL_PORT_SKD A, VSK_CNL_VNDR B, PSO_CNL_TZ_FEE C, VSK_VSL_SKD D" ).append("\n"); 
		...
		query.append("		   AND C.BUD_SCNR_NO 		= '999912'" ).append("\n"); 
