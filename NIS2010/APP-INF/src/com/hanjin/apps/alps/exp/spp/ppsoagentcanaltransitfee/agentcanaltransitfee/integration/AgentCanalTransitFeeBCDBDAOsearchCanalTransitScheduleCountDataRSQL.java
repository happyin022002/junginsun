...
*@FileName : AgentCanalTransitFeeBCDBDAOsearchCanalTransitScheduleCountDataRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOsearchCanalTransitScheduleCountDataRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Canal Transit Schedule inquiry Count
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOsearchCanalTransitScheduleCountDataRSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOsearchCanalTransitScheduleCountDataRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		,T6.CNL_TZ_BKG_PRD_CD" ).append("\n"); 
		query.append("      	,T6.CNL_TZ_BKG_PROC_STS_CD" ).append("\n"); 
		query.append("      	,T6.CNL_BKG_TZ_DT" ).append("\n"); 
		query.append("      	,T6.CNL_OT_SVC_APRO_FLG" ).append("\n"); 
		...
		query.append("	 , VSK_CNL_TZ_BKG T6" ).append("\n"); 
		query.append("     , VSK_CNL_VNDR T7" ).append("\n"); 
		query.append("WHERE  1=1" ).append("\n"); 
		...
		query.append("AND     T7.VSL_SLAN_CD    = T1.VSL_SLAN_CD" ).append("\n"); 
		query.append("	#if (${vndr_seq} != '') " ).append("\n"); 
		query.append("AND		T7.CNL_AGN_VNDR_SEQ = TO_NUMBER(@[vndr_seq])" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
