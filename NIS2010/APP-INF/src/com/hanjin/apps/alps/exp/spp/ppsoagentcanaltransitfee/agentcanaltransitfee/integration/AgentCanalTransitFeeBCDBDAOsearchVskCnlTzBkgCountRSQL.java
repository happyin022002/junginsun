...
*@FileName : AgentCanalTransitFeeBCDBDAOsearchVskCnlTzBkgCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOsearchVskCnlTzBkgCountRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AgentCanalTransitFeeBCDBDAOsearchVskCnlTzBkgCount
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOsearchVskCnlTzBkgCountRSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOsearchVskCnlTzBkgCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
