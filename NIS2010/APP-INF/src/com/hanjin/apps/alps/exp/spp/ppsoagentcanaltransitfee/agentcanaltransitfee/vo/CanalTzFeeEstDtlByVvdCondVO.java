...
public class CanalTzFeeEstDtlByVvdCondVO extends AbstractValueObject {
	...
	public CanalTzFeeEstDtlByVvdCondVO(String ibflag, String pagerows, String vndrSeq, String vvd, String ydCd, String callSeq, String revYrmon, String cnlTzBztpCd) {
		this.vvd = vvd;
		this.ibflag = ibflag;
