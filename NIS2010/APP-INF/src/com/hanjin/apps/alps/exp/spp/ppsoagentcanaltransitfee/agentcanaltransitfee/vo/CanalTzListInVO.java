...
public class CanalTzListInVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CanalTzListInVO> models = new ArrayList<CanalTzListInVO>();
	 ...
	 */
	public CanalTzListInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CanalTzListInVO[]
	 */
	public CanalTzListInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CanalTzListInVO model = null;
	...
	public CanalTzListInVO[] getCanalTzListInVOs(){
		CanalTzListInVO[] vos = (CanalTzListInVO[])models.toArray(new CanalTzListInVO[models.size()]);
		return vos;
	}
