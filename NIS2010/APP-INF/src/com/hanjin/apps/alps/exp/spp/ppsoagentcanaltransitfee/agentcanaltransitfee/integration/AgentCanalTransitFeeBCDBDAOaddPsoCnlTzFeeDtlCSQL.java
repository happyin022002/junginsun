...
*@FileName : AgentCanalTransitFeeBCDBDAOaddPsoCnlTzFeeDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOaddPsoCnlTzFeeDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOaddPsoCnlTzFeeDtlCSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOaddPsoCnlTzFeeDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PSO_CNL_TZ_FEE_DTL" ).append("\n"); 
		query.append("(" ).append("\n"); 
