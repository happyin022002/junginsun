...
*@FileName : AgentCanalTransitFeeBCDBDAOdeleteVskCnlTzBkgDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOdeleteVskCnlTzBkgDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AgentCanalTransitFeeBCDBDAOdeleteVskCnlTzBkg
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOdeleteVskCnlTzBkgDSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOdeleteVskCnlTzBkgDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM VSK_CNL_TZ_BKG " ).append("\n"); 
