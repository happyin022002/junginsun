...
*@FileName : StateDBDAOTotalStateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StateDBDAOTotalStateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StateDBDAOTotalStateRSQL(){
		setQuery();
		...
		query.append("FileName : StateDBDAOTotalStateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
