...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.contractno.event;
...
public class COM_ENS_021HTMLAction extends HTMLActionSupport {
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        ComEns021Event event = new ComEns021Event(cont_tp, cont_no, cust_nm, sdate, edate, iPage, ofc_cd, ctrt_cust_sls_ofc_cd);
