...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.eqorgchart.basic;

import java.util.List;

import com.hanjin.bizcommon.eqorgchart.integration.EQOrgChartDBDAO;
...
public class EQOrgChartBCImpl   extends BasicCommandSupport implements EQOrgChartBC {
	 ...
	 */
	public List<EQQrgChartListVO> searchEQOrgChartList(String depth, String chkDepth) throws EventException {
		List<EQQrgChartListVO> list = null;
		int cnt = 0;
        
        try {
        	cnt    = dbDao.totalEQOrgChartList(depth, chkDepth);
        	list   = dbDao.searchEQOrgChartList(depth, chkDepth);
