...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.eqorgchart.integration;
...
public class EQOrgChartDBDAO extends DBDAOSupport {
     ...
     *
     */
	public int totalEQOrgChartList(String depth, String chkDepth) throws DAOException {
	 ...
	 * @throws DAOException
	 */
	public List<EQQrgChartListVO> searchEQOrgChartList(String depth, String chkDepth) throws DAOException {
		DBRowSet dbRowset = null;
    	//query parameter
		Map<String, Object> param = new HashMap<String, Object>();
		//velocity parameter
