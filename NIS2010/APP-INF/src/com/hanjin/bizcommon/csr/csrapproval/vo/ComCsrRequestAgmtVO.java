...
*@FileName : ComCsrRequestAgmtVO.java
*@FileTitle : ComCsrRequestAgmtVO
*Open Issues :
*Change history :
...
public class ComCsrRequestAgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComCsrRequestAgmtVO> models = new ArrayList<ComCsrRequestAgmtVO>();
	...
	public ComCsrRequestAgmtVO() {}

	public ComCsrRequestAgmtVO(String ibflag, String pagerows, String lDocumentTitle, String lAssetcd, String csrNo, String vndrSeq, String invNo) {
		this.invNo = invNo;
		this.csrNo = csrNo;
...
/**
	 ...
	 */
	public ComCsrRequestAgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComCsrRequestAgmtVO[]
	 */
	public ComCsrRequestAgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComCsrRequestAgmtVO model = null;
		...
		return getComCsrRequestAgmtVOs();
	}
	...
	public ComCsrRequestAgmtVO[] getComCsrRequestAgmtVOs(){
		ComCsrRequestAgmtVO[] vos = (ComCsrRequestAgmtVO[])models.toArray(new ComCsrRequestAgmtVO[models.size()]);
		return vos;
	}
