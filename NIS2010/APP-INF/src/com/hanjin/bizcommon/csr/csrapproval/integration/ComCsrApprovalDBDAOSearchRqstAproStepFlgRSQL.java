...
*@FileName : ComCsrApprovalDBDAOSearchRqstAproStepFlgRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ComCsrApprovalDBDAOSearchRqstAproStepFlgRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ComCsrApprovalDBDAOSearchRqstAproStepFlgRSQL(){
		setQuery();
		...
		query.append("FileName : ComCsrApprovalDBDAOSearchRqstAproStepFlgRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
