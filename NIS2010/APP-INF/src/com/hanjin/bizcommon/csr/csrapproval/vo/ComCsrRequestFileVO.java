...
*@FileName : ComCsrRequestFileVO.java
*@FileTitle : ComCsrRequestFileVO
*Open Issues :
*Change history :
...
public class ComCsrRequestFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComCsrRequestFileVO> models = new ArrayList<ComCsrRequestFileVO>();
	...
	public ComCsrRequestFileVO() {}

	public ComCsrRequestFileVO(String ibflag, String pagerows, String lFileModuleId, String lFileSavId, String lFileNm) {
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public ComCsrRequestFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComCsrRequestFileVO[]
	 */
	public ComCsrRequestFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComCsrRequestFileVO model = null;
		...
		return getComCsrRequestFileVOs();
	}
	...
	public ComCsrRequestFileVO[] getComCsrRequestFileVOs(){
		ComCsrRequestFileVO[] vos = (ComCsrRequestFileVO[])models.toArray(new ComCsrRequestFileVO[models.size()]);
		return vos;
	}
