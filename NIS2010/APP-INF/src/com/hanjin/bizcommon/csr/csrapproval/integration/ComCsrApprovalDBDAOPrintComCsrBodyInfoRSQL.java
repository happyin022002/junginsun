...
*@FileName : ComCsrApprovalDBDAOPrintComCsrBodyInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ComCsrApprovalDBDAOPrintComCsrBodyInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ComCsrApprovalDBDAOPrintComCsrBodyInfoRSQL(){
		setQuery();
		...
		query.append("FileName : ComCsrApprovalDBDAOPrintComCsrBodyInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
