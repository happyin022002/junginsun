...
*@FileName : COM_CSR_0016HTMLAction.java
...
public class COM_CSR_0016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * COM_CSR_0016HTMLAction 객체를 생성
	 */
	public COM_CSR_0016HTMLAction() {
	}
