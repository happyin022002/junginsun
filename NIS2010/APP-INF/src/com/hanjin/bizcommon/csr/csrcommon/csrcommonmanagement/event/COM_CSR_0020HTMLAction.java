...
*@FileName : COM_CSR_0020HTMLAction.java
...
public class COM_CSR_0020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * COM_CSR_0020HTMLAction 객체를 생성
	 */
	public COM_CSR_0020HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComCsr0020Event event = new ComCsr0020Event();
		event.setApprovalCsrVO((CSRApprovalCommonManagementVO)getVO(request, CSRApprovalCommonManagementVO.class));
