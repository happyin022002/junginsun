...
public class CSRExternalFinderDBDAOAddApPayInvDtlVOCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",@[yd_cd]" ).append("\n"); 
		query.append(",@[cntr_tpsz_cd]" ).append("\n"); 
		query.append(",DECODE( (SELECT INV_CURR_CD" ).append("\n"); 
		query.append("FROM AP_PAY_INV" ).append("\n"); 
		query.append("WHERE inv_rgst_no = @[inv_rgst_no]) , 'KRW', ROUND(NVL(@[inv_amt],0),0)" ).append("\n"); 
		query.append(", 'JPY', ROUND(NVL(@[inv_amt],0),0)" ).append("\n"); 
		query.append(",ROUND(NVL(@[inv_amt],0),2))" ).append("\n"); 
		query.append(",@[so_20ft_qty]" ).append("\n"); 
		query.append(",@[so_40ft_qty]" ).append("\n"); 
		query.append(",@[so_teu_qty]" ).append("\n"); 
		query.append(",@[so_ut_qty]" ).append("\n"); 
