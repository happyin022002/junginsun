...
public class ConsultationSlipRequestMgtDBDAOModifyDescUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("AND (A.VNDR_SEQ, A.INV_NO, B.ACCT_CD, B.INV_AMT, B.LGS_COST_CD) IN (SELECT A.VNDR_NO, B.ATTR_CTNT1, B.DTRB_COA_ACCT_CD,B.INV_AMT, B.FTU_USE_CTNT1" ).append("\n"); 
		...
		query.append("#if (${dtrb_coa_acct_cd} == '110911')" ).append("\n"); 
