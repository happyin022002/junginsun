...
public class ConsultationSlipRequestMgt0008ViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"csr_no","vndr_no","inv_desc","if_status","if_dt","if_err_rsn","no_of_inv","csr_curr_cd","csr_amt","due_dt","pay_grp_lu_cd","attr_ctnt2","csr_usd_amt","agmt_doc_cfm_cd","agmt_file_cfm_cd","file_upld_flg","csr_apro_tp_cd","cre_usr_id","iss_dt","rcv_dt","vndr_term_nm","aft_act_flg","if_flg","rcv_err_flg","tml_inv_sts_cd","tml_inv_rjct_sts_cd","apro_rqst_no","cost_ofc_cd","acct_xch_rt_yrmon","chk_gw_2_al"};
