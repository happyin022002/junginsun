...
public class ConsultationSlipRequestMgtDBDAOTAXInfoRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT NVL(DECODE(VNDR_CNT_CD,'KR',VNDR_LOCL_LANG_NM, VNDR_LGL_ENG_NM), ' ') VNDR_NM," ).append("\n"); 
		query.append("NVL(BZCT_NM, ' ') BZCT_NM," ).append("\n"); 
		query.append("NVL(BZTP_NM, ' ') BZTP_NM," ).append("\n"); 
		query.append("NVL(DECODE(VNDR_CNT_CD,'KR',LOCL_LANG_ADDR, ENG_ADDR), ' ') VNDR_ADDR," ).append("\n"); 
