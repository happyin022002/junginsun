 ...
 * @since J2EE 1.6
 */
public class ConsultationSlipRequestMgt0001ViewAdapter extends ViewAdapter {
	/**
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"cost_ofc_cd","vndr_no","vndr_seq_name","cnt_inv","inv_curr_cd","total_amt","inv_iss_dt","inv_rcv_dt","gen_pay_term_cd","gen_pay_term_desc","pay_term_tp_cd","inv_sub_sys_cd","payment_due_dt","pso_trns_slp_ctnt","inv_cfm_dt","vndr_seq","inv_ofc_cd"};
