...
public class ConsultationSlipRequestMgtDBDAOApInvDTRBOutRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("( SELECT DECODE(SUBSTR(LOC_CD,1,2)," ).append("\n"); 
		query.append("'KR','TAX'," ).append("\n"); 
		query.append("'HQ','TAX'," ).append("\n"); 
		...
		query.append("WHERE  OFC_CD = H.COST_OFC_CD )             DTRB_COA_CTR_CD," ).append("\n"); 
		query.append("( SELECT DECODE(SUBSTR(LOC_CD,1,2)," ).append("\n"); 
		query.append("'KR','111811'," ).append("\n"); 
		query.append("'HQ','111811'," ).append("\n"); 
		query.append("'111821')" ).append("\n"); 
		query.append("FROM   MDM_ORGANIZATION" ).append("\n"); 
