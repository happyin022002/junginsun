...
*@FileName : ApprovalStepSendDBDAOCreateAproStepSendLogCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalStepSendDBDAOCreateAproStepSendLogCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalStepSendDBDAOCreateAproStepSendLogCSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalStepSendDBDAOCreateAproStepSendLogCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO COM_APRO_SND_LOG (" ).append("\n"); 
		...
		query.append("@[snd_log_seq] --SND_LOG_SEQ" ).append("\n"); 
		query.append(", @[csr_no] --CSR_NO" ).append("\n"); 
		query.append(", @[src_ctnt] --SRC_CTNT" ).append("\n"); 
		query.append(", @[exe_sts_cd] --EXE_STS_CD" ).append("\n"); 
		query.append(", @[act_tp_cd] --EXE_ACT_TP_CD" ).append("\n"); 
		query.append(", SYSDATE --EXE_DT" ).append("\n"); 
		...
		query.append(", TO_DATE(REPLACE(@[apro_dt],'-',''),'YYYYMMDD') --APRO_DT" ).append("\n"); 
		query.append(", 'ALPS_CSR' --CRE_USR_ID" ).append("\n"); 
		query.append(", SYSDATE" ).append("\n"); 
		query.append(", 'ALPS_CSR' --UPD_USR_ID" ).append("\n"); 
		query.append(", SYSDATE" ).append("\n"); 
		query.append(")" ).append("\n"); 
