...
*@FileName : COM_CSR_0015HTMLAction.java
...
public class COM_CSR_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * COM_CSR_0015HTMLAction 객체를 생성
	 */
	public COM_CSR_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComCsr0015Event event = new ComCsr0015Event();
		
		event.setIfCsrListInputVO((IfCsrListInputVO)getVO(request, IfCsrListInputVO .class));
		event.setIfCsrListInputVOs((IfCsrListInputVO[])getVOs(request, IfCsrListInputVO .class, ""));
