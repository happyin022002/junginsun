...
*@FileName : ConsultationSlipRequestMgtDBDAOCreateApInvDTRBASANoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOCreateApInvDTRBASANoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOCreateApInvDTRBASANoUSQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOCreateApInvDTRBASANoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
