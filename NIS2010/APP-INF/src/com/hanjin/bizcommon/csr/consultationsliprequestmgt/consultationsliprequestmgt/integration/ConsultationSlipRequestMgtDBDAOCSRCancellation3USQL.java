...
*@FileName : ConsultationSlipRequestMgtDBDAOCSRCancellation3USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOCSRCancellation3USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOCSRCancellation3USQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOCSRCancellation3USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE COM_APRO_RQST_HDR A" ).append("\n"); 
