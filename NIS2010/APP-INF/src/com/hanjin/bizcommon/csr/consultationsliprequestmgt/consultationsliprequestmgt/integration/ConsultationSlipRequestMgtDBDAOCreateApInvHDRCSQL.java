...
public class ConsultationSlipRequestMgtDBDAOCreateApInvHDRCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("#if (${pso_trns_slp_ctnt} == 'AR' || ${pso_trns_slp_ctnt} == 'AA')" ).append("\n"); 
		...
		query.append("WHEN SUBSTR(@[vndr_term_nm],1,1)='O' THEN @[vndr_term_nm]" ).append("\n"); 
		query.append("ELSE" ).append("\n"); 
		query.append("CASE" ).append("\n"); 
		...
		query.append("ELSE @[vndr_term_nm]" ).append("\n"); 
		query.append("END" ).append("\n"); 
		query.append("ELSE @[vndr_term_nm]" ).append("\n"); 
		query.append("END" ).append("\n"); 
		...
		query.append("@[src_ctnt]                                                 ," ).append("\n"); 
		query.append("(SELECT DECODE(b.conti_cd,'M','CMS CHECK(O/EXP)','E','CMS WIRE','WIRE')" ).append("\n"); 
		query.append("FROM mdm_organization a, mdm_location b" ).append("\n"); 
		query.append("WHERE a.ofc_cd = @[cost_ofc_cd]" ).append("\n"); 
		...
		query.append("WHERE INV_RGST_NO = @[inv_rgst_no]" ).append("\n"); 
		query.append("AND ROWNUM = 1" ).append("\n"); 
		query.append("), '110911', '210111', '210121'" ).append("\n"); 
		query.append(")," ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("@[coa_acct_cd]," ).append("\n"); 
		query.append("#end" ).append("\n"); 
