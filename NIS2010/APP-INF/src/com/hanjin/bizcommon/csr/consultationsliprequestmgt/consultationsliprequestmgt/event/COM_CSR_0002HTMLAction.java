...
public class COM_CSR_0002HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			CsrListInputVO[] csrListInputVOs = (new CsrListInputVO()).fromRequestGrid(request);
			event.setCsrListInputVOs(csrListInputVOs);
			request.setAttribute("Event", event);		
			...
			event.setApOfcCd(request.getParameter("ap_ofc_cd"));
