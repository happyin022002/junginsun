...
*@FileName : ConsultationSlipRequestMgtDBDAOCancelCSR02USQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOCancelCSR02USQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOCancelCSR02USQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOCancelCSR02USQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET A.AFT_ACT_FLG = @[aft_act_flg]" ).append("\n"); 
