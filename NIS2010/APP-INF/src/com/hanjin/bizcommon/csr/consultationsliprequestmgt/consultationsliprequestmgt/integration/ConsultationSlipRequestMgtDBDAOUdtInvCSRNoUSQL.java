...
*@FileName : ConsultationSlipRequestMgtDBDAOUdtInvCSRNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOUdtInvCSRNoUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOUdtInvCSRNoUSQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOUdtInvCSRNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET A.CSR_NO = @[csr_no]" ).append("\n"); 
		query.append("#if (${batch_flag} != 'N')" ).append("\n"); 
		query.append(",A.GL_DT = (" ).append("\n"); 
		query.append("SELECT GL_DT" ).append("\n"); 
		query.append("FROM AP_INV_HDR" ).append("\n"); 
		query.append("WHERE CSR_NO = @[csr_no]" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append(",A.INV_EFF_DT = TO_DATE((" ).append("\n"); 
		query.append("SELECT GL_DT" ).append("\n"); 
		query.append("FROM AP_INV_HDR" ).append("\n"); 
		query.append("WHERE CSR_NO = @[csr_no]" ).append("\n"); 
