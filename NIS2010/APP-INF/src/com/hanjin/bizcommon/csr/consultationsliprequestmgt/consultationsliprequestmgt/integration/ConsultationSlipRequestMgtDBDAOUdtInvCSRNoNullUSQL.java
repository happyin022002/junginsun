...
*@FileName : ConsultationSlipRequestMgtDBDAOUdtInvCSRNoNullUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ConsultationSlipRequestMgtDBDAOUdtInvCSRNoNullUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ConsultationSlipRequestMgtDBDAOUdtInvCSRNoNullUSQL(){
		setQuery();
		...
		query.append("FileName : ConsultationSlipRequestMgtDBDAOUdtInvCSRNoNullUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET A.CSR_NO = null" ).append("\n"); 
