...
*@FileName : ApInvDTRBInVO.java
*@FileTitle : ApInvDTRBInVO
*Open Issues :
*Change history :
...
public class ApInvDTRBInVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ApInvDTRBInVO> models = new ArrayList<ApInvDTRBInVO>();
...
/**
	 ...
	 * @param request
	 * @return ApInvDTRBInVO[]
	 */
	public ApInvDTRBInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ApInvDTRBInVO[]
	 */
	public ApInvDTRBInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ApInvDTRBInVO model = null;
	 ...
	 * @return ApInvDTRBInVO[]
	 */
	public ApInvDTRBInVO[] getApInvDTRBInVOs(){
		ApInvDTRBInVO[] vos = (ApInvDTRBInVO[])models.toArray(new ApInvDTRBInVO[models.size()]);
		return vos;
	}
