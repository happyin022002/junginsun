...
*@FileName : COM_ENS_0I1HTMLAction.java
...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.scontinent.event;
 ...
 * @see ComEns0I1Event , COM_ENS_0I1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_0I1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0I1HTMLAction 객체를 생성
	 */
	public COM_ENS_0I1HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_0I1Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComEns0I1Event event = new ComEns0I1Event(iPage);
		
		event.setSearchSubContinentListVO((SearchSubContinentListVO)getVO(request, SearchSubContinentListVO .class));
