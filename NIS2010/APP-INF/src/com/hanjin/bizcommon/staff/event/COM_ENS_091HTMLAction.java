...
*@FileName : COM_ENS_091HTMLAction.java
*@FileTitle : VVD
*Open Issues :
*Change history :
...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.staff.event;
 ...
 * @see ComEns091Event , COM_ENS_091EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_091HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_091HTMLAction 객체를 생성
	 */
	public COM_ENS_091HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_091Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	String user_cd = JSPUtil.getParameter(request, "user_cd".trim(), "");
    	...
    	ComEns091Event event = new ComEns091Event(ofc_cd, user_cd, user_nm, iPage);
