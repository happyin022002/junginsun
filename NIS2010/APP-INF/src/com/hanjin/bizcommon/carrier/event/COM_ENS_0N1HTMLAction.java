...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.carrier.event;
 ...
 * @since J2EE 1.4
 */
public class COM_ENS_0N1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0N1HTMLAction 객체를 생성
	 */
	public COM_ENS_0N1HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ComEns0N1Event event = new ComEns0N1Event(iPage);
