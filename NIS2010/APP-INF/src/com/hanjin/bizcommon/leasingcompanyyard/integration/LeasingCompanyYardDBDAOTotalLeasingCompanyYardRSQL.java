...
*@FileName : LeasingCompanyYardDBDAOTotalLeasingCompanyYardRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.hanjin.bizcommon.leasingcompanyyard.integration;
...
public class LeasingCompanyYardDBDAOTotalLeasingCompanyYardRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LeasingCompanyYardDBDAOTotalLeasingCompanyYardRSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.leasingcompanyyard.integration").append("\n"); 
		query.append("FileName : LeasingCompanyYardDBDAOTotalLeasingCompanyYardRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
