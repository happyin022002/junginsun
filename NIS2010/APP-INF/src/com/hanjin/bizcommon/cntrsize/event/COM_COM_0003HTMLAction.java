 ...
 * @see ComCom0003Event , COM_COM_0003EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_COM_0003HTMLAction extends HTMLActionSupport {
	 ...
	 * HttpRequst의 정보를 COM_COM_0003Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	String cntr_sz_cd = JSPUtil.getParameter(request, "cntr_sz_cd".trim(), "");
    	String cntr_sz_desc = JSPUtil.getParameter(request, "cntr_sz_desc".trim(), "");
    	
    	int iPage           = JSPUtil.getParameterAsInt(request, "iPage", 1);  
    	
    	FormCommand f_cmd = FormCommand.fromRequest(request);
    	
    	ComCom0003Event event = new ComCom0003Event(cntr_sz_cd, cntr_sz_desc, iPage);
