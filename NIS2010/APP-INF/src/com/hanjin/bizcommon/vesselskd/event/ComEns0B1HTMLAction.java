...
*@FileName : COM_ENS_0B1HTMLAction.java
 ...
 *
 * @author Hyunsu, Ryu
 * @see ComEns0B1Event , COM_ENS_0B1EventResponse 참조
 * @since J2EE 1.4
 */
public class ComEns0B1HTMLAction extends HTMLActionSupport {

    /**
     * COM_ENS_0B1HTMLAction 객체를 생성
     */
    public ComEns0B1HTMLAction() {
    }

    /**
     * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
     * HttpRequst의 정보를 COM_ENS_0B1Event로 파싱하여 request에 셋팅<br>
     * 
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */ 
        ...
        ComEns0B1Event event = new ComEns0B1Event(vvd_cd, iPage ); // table value object
