...
public class ComEns0K1Event extends EventSupport {
	...
	public SearchRepCommodityListVO[] getSearchRepCommodityListVOs() {
		return searchRepCommodityListVOs;
	}

	/**
	 * @param searchRepCommodityListVOs the searchRepCommodityListVOs to set
	 */
	public void setSearchRepCommodityListVOs(
			SearchRepCommodityListVO[] searchRepCommodityListVOs) {
		this.searchRepCommodityListVOs = searchRepCommodityListVOs;
	}
