...
*@FileName : RepCommodityDBDAOTotalRepCommodityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RepCommodityDBDAOTotalRepCommodityRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Rep Commodity의 총 카운트를 조회한다
	  * </pre>
	  */
	public RepCommodityDBDAOTotalRepCommodityRSQL(){
		setQuery();
		...
		query.append("FileName : RepCommodityDBDAOTotalRepCommodityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
