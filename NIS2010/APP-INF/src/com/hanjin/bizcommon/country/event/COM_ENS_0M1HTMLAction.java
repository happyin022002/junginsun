...
*@FileName : COM_ENS_0M1HTMLAction.java
*@FileTitle : Country
*Open Issues :
*Change history :
...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.country.event;
 ...
 * @see ComEns0M1Event , COM_ENS_0M1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_0M1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0M1HTMLAction 객체를 생성
	 */
	public COM_ENS_0M1HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_0M1Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ComEns0M1Event event = new ComEns0M1Event(iPage);
    	
    	if(f_cmd.isCommand(FormCommand.SEARCH)) {
    		event.setCountryListVO((CountryListVO)getVO(request, CountryListVO .class));
    	}
