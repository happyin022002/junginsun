...
*@FileName : COM_ENS_0G1HTMLAction.java
*@FileTitle : CntrTpSz
*Open Issues :
*Change history :
 ...
 * @see ComEns0G1Event , COM_ENS_0G1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_0G1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0G1HTMLAction 객체를 생성
	 */
	public COM_ENS_0G1HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_0G1Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	String cntr_tpsz_desc = JSPUtil.getParameter(request, "cntr_tpsz_desc".trim(), "");
    	
    	int iPage           = JSPUtil.getParameterAsInt(request, "iPage", 1);  
    	
    	FormCommand f_cmd = FormCommand.fromRequest(request);
    	
    	ComEns0G1Event event = new ComEns0G1Event(cntr_tpsz_cd, cntr_tpsz_desc, iPage);
