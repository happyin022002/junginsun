...
*@FileName : LogicsServiceProviderDBDAOTotalCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.hanjin.bizcommon.logicsserviceprovider.integration;
...
public class LogicsServiceProviderDBDAOTotalCntRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LogicsServiceProviderDAORMdmVenderRSQL TOTAL CNT
	  * </pre>
	  */
	public LogicsServiceProviderDBDAOTotalCntRSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.logicsserviceprovider.integration").append("\n"); 
		query.append("FileName : LogicsServiceProviderDBDAOTotalCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
