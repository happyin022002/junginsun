...
public class LocationDBDAOSearchLocationDetailRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	DECODE(A.PORT_INLND_CD,'Y','PORT','INLAND') PORT_INLND_CD," ).append("\n"); 
		...
		query.append("FROM MDM_LOCATION A, MDM_CONTINENT B, MDM_EQ_ORZ_CHT C, MDM_SUBCONTINENT D, MDM_STATE S" ).append("\n"); 
