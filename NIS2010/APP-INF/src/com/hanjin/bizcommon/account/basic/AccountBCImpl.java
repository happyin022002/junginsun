...
* 1.0 Creation
=========================================================*/
package com.hanjin.bizcommon.account.basic;

import java.util.List;

import com.hanjin.bizcommon.account.integration.AccountDBDAO;
...
public class AccountBCImpl extends BasicCommandSupport implements AccountBC {
	 ...
	 * 
	 * @param MdmAccountVO mdmaccountvo
	 * @return List<MdmAccountVO>
	 * @exception EventException
	 */
	public List<MdmAccountVO> searchAccountList(MdmAccountVO mdmaccountvo) throws EventException {
		try {
