...
*@FileName : ApprouteDBDAOaddApprovalRouteCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprouteDBDAOaddApprovalRouteCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Approval Route 정보를 저장한다
	  * </pre>
	  */
	public ApprouteDBDAOaddApprovalRouteCSQL(){
		setQuery();
		...
		query.append("FileName : ApprouteDBDAOaddApprovalRouteCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
