...
*@FileName : ApprouteDBDAOsearchAproRqstNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprouteDBDAOsearchAproRqstNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprouteDBDAOsearchAproRqstNoRSQL(){
		setQuery();
		...
		query.append("FileName : ApprouteDBDAOsearchAproRqstNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CSR.APRO_RQST_NO" ).append("\n"); 
		query.append("FROM COM_APRO_CSR_DTL CSR" ).append("\n"); 
		query.append(",COM_APRO_RQST_HDR HDR" ).append("\n"); 
		query.append(",COM_APRO_RQST_ROUT ROUT" ).append("\n"); 
		query.append("WHERE HDR.APRO_RQST_NO = CSR.APRO_RQST_NO" ).append("\n"); 
