...
*@FileName : COM_ENS_0J1HTMLAction.java
*@FileTitle : Region
*Open Issues :
*Change history :
...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.region.event;
 ...
 * @see ComEns0J1Event , COM_ENS_0J1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_0J1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0J1HTMLAction 객체를 생성
	 */
	public COM_ENS_0J1HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_0J1Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		ComEns0J1Event event = new ComEns0J1Event();
		
    	int iPage           = JSPUtil.getParameterAsInt(request, "iPage", 1);  
    	
    	FormCommand f_cmd = FormCommand.fromRequest(request);
    	
    	event = new ComEns0J1Event(iPage);
    	
    	if(f_cmd.isCommand(FormCommand.SEARCH)) {
    		event.setSearchRegionListVO((SearchRegionListVO)getVO(request, SearchRegionListVO .class));
    	}
