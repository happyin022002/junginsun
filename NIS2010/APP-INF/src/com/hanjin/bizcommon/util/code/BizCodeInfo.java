...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.util.code;
...
public class BizCodeInfo implements java.io.Serializable, Comparable {
	 ...
	 */
	private String name;
	private String pgmSubSysNm;
	private String pgmApplCd;
	/**
	 * 1. 기능 : CodeInfo 생성자
	 * <p>
	 * 2. 처리개요 :
	 ...
	 * <p>
	 * 2. 처리개요 :
	 * <p> - code값, code명, pgmSubSysNm, pgmApplCd을 받아 모델 setting
	 * <p>
	 * 3. 주의사항 :
	 * <p>
	 * @param String sortKey 
	 * @param String code
	 * @param String name
	 * @param String pgmSubSysNm
	 * @param String pgmApplCd
	 */
	public BizCodeInfo(String sortKey, String code, String name,String pgmSubSysNm,String pgmApplCd) {
		this.code = code;
		this.name = name;
		this.sortKey = sortKey;
		this.pgmSubSysNm = pgmSubSysNm;
	...
	public void setPgmSubSysNm(String pgmSubSysNm) {
		this.pgmSubSysNm = pgmSubSysNm;
	}
	/**
