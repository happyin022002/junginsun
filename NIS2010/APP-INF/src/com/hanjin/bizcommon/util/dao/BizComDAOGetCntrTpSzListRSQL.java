...
*@FileName : BizComDAOGetCntrTpSzListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BizComDAOGetCntrTpSzListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BizComDAOGetCntrTpSzListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.util.dao").append("\n"); 
		query.append("FileName : BizComDAOGetCntrTpSzListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       CNTR_TPSZ_CD as code, CNTR_TPSZ_DESC as name" ).append("\n"); 
