...
*@FileName : BizComDAOGetSContiListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BizComDAOGetSContiListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BizComDAOGetSContiListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.util.dao").append("\n"); 
		query.append("FileName : BizComDAOGetSContiListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SCONTI_CD as code, SCONTI_NM as name" ).append("\n"); 
