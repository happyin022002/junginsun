...
*@FileName : BizComDAOGetCntrTpListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BizComDAOGetCntrTpListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BizComDAOGetCntrTpListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.util.dao").append("\n"); 
		query.append("FileName : BizComDAOGetCntrTpListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       CNTR_TP_CD as code, CNTR_TP_DESC as name " ).append("\n"); 
