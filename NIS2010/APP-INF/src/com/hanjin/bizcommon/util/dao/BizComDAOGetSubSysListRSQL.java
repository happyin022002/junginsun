...
*@FileName : BizComDAOGetSubSysListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BizComDAOGetSubSysListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BizComDAOGetSubSysListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.util.dao").append("\n"); 
		query.append("FileName : BizComDAOGetSubSysListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       PGM_SUB_SYS_CD as code, PGM_SUB_SYS_CD as name" ).append("\n"); 
		query.append("  FROM COM_PGM_SUB_SYS" ).append("\n"); 
		query.append(" WHERE PGM_APPL_CD = 'ALPS'" ).append("\n"); 
		query.append("" ).append("\n"); 
