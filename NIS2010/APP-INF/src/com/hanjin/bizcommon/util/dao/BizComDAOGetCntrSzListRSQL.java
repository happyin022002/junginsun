...
*@FileName : BizComDAOGetCntrSzListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BizComDAOGetCntrSzListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BizComDAOGetCntrSzListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.util.dao").append("\n"); 
		query.append("FileName : BizComDAOGetCntrSzListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(" 	   CNTR_SZ_CD as code, CNTR_SZ_DESC as name " ).append("\n"); 
