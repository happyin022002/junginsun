...
*@FileName : BizComDAOGetGensetListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BizComDAOGetGensetListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BizComDAOGetGensetListRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.util.dao").append("\n"); 
		query.append("FileName : BizComDAOGetGensetListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
