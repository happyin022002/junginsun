...
*@FileName : AuthorizationDBDAOupdateAuthAproCfmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AuthorizationDBDAOupdateAuthAproCfmUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COM_AUTH_APRO_RQST에서 CFM_FLG Update
	  * </pre>
	  */
	public AuthorizationDBDAOupdateAuthAproCfmUSQL(){
		setQuery();
		...
		query.append("FileName : AuthorizationDBDAOupdateAuthAproCfmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
