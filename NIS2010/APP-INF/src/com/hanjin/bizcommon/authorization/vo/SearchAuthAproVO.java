...
*@FileName : SearchAuthAproVO.java
*@FileTitle : SearchAuthAproVO
*Open Issues :
*Change history :
...
public class SearchAuthAproVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchAuthAproVO> models = new ArrayList<SearchAuthAproVO>();
	...
	public SearchAuthAproVO() {}

	public SearchAuthAproVO(String ibflag, String pagerows, String subSysCdAuth, String subSysCd, String pgmNo, String pgmNm, String authAproRoutUsrSeq, String authAproJbTitNm, String authAproUsrId, String authAproRoutSeq, String authAproUsrNm, String authAproOfcCd, String authAproOfcNm, String authAproTpCd, String ofcCdAuth, String ofcCd, String usrId) {
		this.subSysCd = subSysCd;
		this.authAproTpCd = authAproTpCd;
		this.authAproJbTitNm = authAproJbTitNm;
		this.authAproUsrJbTitNm = authAproJbTitNm;
...
/**
	 ...
	 */
	public SearchAuthAproVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchAuthAproVO[]
	 */
	public SearchAuthAproVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchAuthAproVO model = null;
	...
	public SearchAuthAproVO[] getSearchAuthAproVOs(){
		SearchAuthAproVO[] vos = (SearchAuthAproVO[])models.toArray(new SearchAuthAproVO[models.size()]);
		return vos;
	}
