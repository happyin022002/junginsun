...
*@FileName : COM_APR_0T1HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 *
 * @author 심성윤
 * @see ComApr0T1Event , COM_APR_0T1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_APR_0T1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_APR_0T1HTMLAction 객체를 생성
	 */
	public COM_APR_0T1HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComApr0T1Event event = new ComApr0T1Event();
    	String xls_prmt = request.getParameter("xls_prmt");
    	...
    	event.setAuthorizationRouteVO((AuthorizationRouteVO)getVO(request, AuthorizationRouteVO.class));
    	...
    	event.setAttribute("xls_prmt", xls_prmt);
    	event.setxlsPrmt(xls_prmt);
