...
*@FileName : COM_APR_0S1HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public class COM_APR_0S1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_APR_0S1HTMLAction 객체를 생성
	 */
	public COM_APR_0S1HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComApr0S1Event event = new ComApr0S1Event();
