...
* 1.0 Creation
=========================================================*/
package com.hanjin.bizcommon.activity.event;
...
public class COM_COM_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * COM_COM_0010HTMLAction 객체를 생성
	 */
	public COM_COM_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComCom0009Event event = new ComCom0009Event();
		

		log.debug("Event. command" + Integer.toString(command.getCommand()));
		event.setSearchMdmActivityVO((SearchMdmActivityVO)getVO(request, SearchMdmActivityVO .class));
