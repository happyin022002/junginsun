 ...
 * @see ComEns0H1Event , COM_ENS_0H1EventResponse 참조
 * @since J2EE 1.4
 */
public class COM_ENS_0H1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0H1HTMLAction 객체를 생성
	 */
	public COM_ENS_0H1HTMLAction() {
	}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 COM_ENS_0H1Event로 파싱하여 request에 셋팅<br>
	 * 
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ComEns0H1Event event = new ComEns0H1Event();
