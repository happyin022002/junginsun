 ...
 * @since J2EE 1.4
 */
public class COM_ENS_0S1HTMLAction extends HTMLActionSupport {

	/**
	 * COM_ENS_0S1HTMLAction 객체를 생성
	 */
	public COM_ENS_0S1HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		String cnt_cd = JSPUtil.getParameter(request, "cnt_cd_cnt".trim(), "");
    	String frDate = JSPUtil.getParameter(request, "frDate_cnt".trim(), "");    	
    	String toDate = JSPUtil.getParameter(request, "toDate_cnt".trim(), "");
    	...
    	ComEns0S1Event event = new ComEns0S1Event();
    	
		if (f_cmd.isCommand(FormCommand.SEARCHLIST)) {
	        event = new ComEns0S1Event(cnt_cd, frDate, toDate, iPage);
		} 
