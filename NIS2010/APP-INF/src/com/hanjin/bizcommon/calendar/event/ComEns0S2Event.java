 ...
 * @since J2EE 1.4
 */
public class ComEns0S2Event extends EventSupport {
	 ...
	 * @param int iPage
	 */
	public ComEns0S2Event(String cnt_cd, String ste_cd, String frDate, String toDate, int iPage) {
		this.cntCd = cnt_cd;
		this.steCd = ste_cd;
		this.frDate = frDate;
		this.toDate = toDate;
