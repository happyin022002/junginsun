 ...
 * @since J2EE 1.4
 */
public class ComEns0S2EventResponse extends EventResponseSupport {
	 ...
	 */
	public ComEns0S2EventResponse(DBRowSet rowSet) {
		this.rowSet = rowSet;
	}
	 ...
	 */
	public ComEns0S2EventResponse(DBRowSet rowSet, String successFlag) {
		this.rowSet=rowSet;
	...
	public String toString() {
		return "COM_ENS_0S2EventResponse";
	}
