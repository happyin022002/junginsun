 ...
 * @since J2EE 1.4
 */
public class ComEns0S3EventResponse extends EventResponseSupport {
	 ...
	 */
	public ComEns0S3EventResponse(DBRowSet rowSet) {
		this.rowSet = rowSet;
	}
	 ...
	 */
	public ComEns0S3EventResponse(DBRowSet rowSet, String successFlag) {
		this.rowSet=rowSet;
	...
	public String toString() {
		return "COM_ENS_0S3EventResponse";
	}
