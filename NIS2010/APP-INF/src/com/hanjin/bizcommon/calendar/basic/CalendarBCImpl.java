...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.bizcommon.calendar.basic;

import java.util.Collection;

import com.hanjin.bizcommon.calendar.event.ComEns0S1Event;
import com.hanjin.bizcommon.calendar.event.ComEns0S1EventResponse;
import com.hanjin.bizcommon.calendar.event.ComEns0S2Event;
import com.hanjin.bizcommon.calendar.event.ComEns0S2EventResponse;
import com.hanjin.bizcommon.calendar.event.ComEns0S3Event;
import com.hanjin.bizcommon.calendar.event.ComEns0S3EventResponse;
import com.hanjin.bizcommon.calendar.event.ComEns0S4EventResponse;
import com.hanjin.bizcommon.calendar.integration.CalendarDBDAO;
...
public class CalendarBCImpl   extends BasicCommandSupport implements CalendarBC {
	...
	public EventResponse modifyCntHoliday(Event e) throws EventException {
        ...
        try {
        	...
        	ComEns0S1EventResponse eventResponse = new ComEns0S1EventResponse(null, "SUCCESS");
            return eventResponse;
        } catch (DAOException de) {
            log.error("err "+de.toString(),de);
            throw new EventException(de.getMessage());
	...
	public EventResponse modifySteHoliday(Event e) throws EventException {
        ...
        try {
        	...
        	ComEns0S2EventResponse eventResponse = new ComEns0S2EventResponse(null,"SUCCESS");
            return eventResponse;
        } catch (DAOException de) {
            log.error("err "+de.toString(),de);
            throw new EventException(de.getMessage());
	...
	public EventResponse modifyLocHoliday(Event e) throws EventException {
        ...
        try {
        	...
        	ComEns0S3EventResponse eventResponse = new ComEns0S3EventResponse(null, "SUCCESS"); 
            return eventResponse;  
        } catch (DAOException de) {
            log.error("err "+de.toString(),de);
            throw new EventException(de.getMessage());
