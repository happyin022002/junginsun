...
*@FileName : COM_NTC_0004HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @author YJ Jeon
 * @see ComNtc0004Event 참조
 * @since J2EE 1.6
 */

public class COM_NTC_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * COM_NTC_0004HTMLAction 객체를 생성
	 */
	public COM_NTC_0004HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ComNtc0004Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComNtc0004Event event = new ComNtc0004Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
		event = new ComNtc0004Event(pgm_no);
		}
