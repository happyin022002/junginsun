...
*@FileName : COM_NTC_0002HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
 ...
 * @see ComNtc0002Event 참조
 * @since J2EE 1.6
 */

public class COM_NTC_0002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * COM_NTC_0002HTMLAction 객체를 생성
	 */
	public COM_NTC_0002HTMLAction() {}

	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ComNtc0002Event로 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ComNtc0002Event event = new ComNtc0002Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSearchContractCreationUserVO((SearchContractCreationUserVO)getVO(request,SearchContractCreationUserVO.class));
		}
		return  event;
	}
