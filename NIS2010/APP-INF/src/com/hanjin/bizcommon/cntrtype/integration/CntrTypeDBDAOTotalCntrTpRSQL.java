...
*@FileName : CntrTypeDBDAOTotalCntrTpRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CntrTypeDBDAOTotalCntrTpRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Count Container type
	  * </pre>
	  */
	public CntrTypeDBDAOTotalCntrTpRSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.cntrtype.integration ").append("\n"); 
		query.append("FileName : CntrTypeDBDAOTotalCntrTpRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
