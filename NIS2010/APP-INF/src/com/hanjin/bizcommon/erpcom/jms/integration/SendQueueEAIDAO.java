...
* 1.0 최초 생성
* 2013.03.18 김현화[CHM-201323299] ALPS 공통 모듈 내의 ERP 연동 로직 보완 요청- WeblogicSendQClientTemp를 WeblogicSendQClient로 수정.
=========================================================*/
...
public class SendQueueEAIDAO extends EAIDAOSupport {
	...
	public void transferInvToERP(FNS0080003Document docReq) throws Exception, DAOException {		
		...
		try {
			eai = new WeblogicSendQClient(SubSystemConfigFactory.get("COM.ALPSJ.JMS.SEND.URL"), SendQueueEAIDAO.class);			
