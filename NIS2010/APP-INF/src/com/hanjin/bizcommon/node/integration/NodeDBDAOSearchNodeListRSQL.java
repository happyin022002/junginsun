...
* 1.0 Creation
=========================================================*/
package com.hanjin.bizcommon.node.integration;
...
public class NodeDBDAOSearchNodeListRSQL implements ISQLTemplate{
	...
	public NodeDBDAOSearchNodeListRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.bizcommon.node.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("		        loc_cd, yd_cstms_no" ).append("\n"); 
		...
		query.append("		                A.loc_cd, A.yd_cstms_no" ).append("\n"); 
		...
		query.append("			AND A.yd_nm LIKE '%' || @[node_nm] || '%' " ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		...
		query.append("	#end" ).append("\n"); 
		query.append("	#if(${node_nm} != '')" ).append("\n"); 
		query.append("			AND A.zn_nm LIKE '%' || @[node_nm] || '%' " ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("    		 AND NVL(A.DELT_FLG, 'N') <> 'Y'" ).append("\n"); 
		query.append("    		 AND NVL(B.DELT_FLG, 'N') <> 'Y'" ).append("\n"); 
