...
public class ApprovalDBDAOApprovalCsrVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      ,T.CRNT_APRO_SEQ APRO_RQST_SEQ" ).append("\n"); 
		...
		query.append("      ,T.CSR_USD_AMT" ).append("\n"); 
		...
		query.append("      , AP_COM_CHK_CURR_APRO_USR_FNC((SELECT D.CSR_NO FROM COM_APRO_CSR_DTL D WHERE D.APRO_RQST_NO = T.APRO_RQST_NO),@[usr_id]) CHK_CURR_APRO_USR_YN" ).append("\n"); 
		...
		query.append("            ,E.CSR_USD_AMT --추가" ).append("\n"); 
		query.append("      		,E.ACCT_XCH_RT_YRMON" ).append("\n"); 
		...
		query.append("			,NVL(E.AGMT_FILE_CFM_CD,'N') AGMT_FILE_CFM_CD" ).append("\n"); 
		...
		query.append("            AND NVL(E.CSR_APRO_TP_CD,'AL') = 'AL'" ).append("\n"); 
		query.append("            AND NVL(E.RQST_APRO_STEP_FLG,'N') <> 'Y'" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("            AND C.APRO_USR_ID IN ( SELECT NVL(EP_ID, USR_ID)" ).append("\n"); 
		...
		query.append("                                      AND USE_FLG = 'Y'" ).append("\n"); 
		query.append("                                 )" ).append("\n"); 
		query.append("           #if (${status} == 'S') --Created" ).append("\n"); 
		query.append("           #if (${sdate} != '')" ).append("\n"); 
		query.append("            AND TO_CHAR(E.CRE_DT, 'YYYY-MM-DD') >= @[sdate]" ).append("\n"); 
		query.append("           #end" ).append("\n"); 
		query.append("           #if (${edate} != '')" ).append("\n"); 
		query.append("            AND TO_CHAR(E.CRE_DT, 'YYYY-MM-DD') <= @[edate]" ).append("\n"); 
		query.append("           #end" ).append("\n"); 
		query.append("           #else" ).append("\n"); 
		query.append("           #if (${sdate} != '')" ).append("\n"); 
