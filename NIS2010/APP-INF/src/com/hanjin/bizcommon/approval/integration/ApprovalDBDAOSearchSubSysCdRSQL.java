...
*@FileName : ApprovalDBDAOSearchSubSysCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOSearchSubSysCdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CSR NO으로 SUB_SYS_CD를 조회한다
	  * </pre>
	  */
	public ApprovalDBDAOSearchSubSysCdRSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOSearchSubSysCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
