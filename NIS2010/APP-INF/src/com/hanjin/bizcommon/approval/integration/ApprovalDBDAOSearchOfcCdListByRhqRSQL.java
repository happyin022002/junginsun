...
*@FileName : ApprovalDBDAOSearchOfcCdListByRhqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOSearchOfcCdListByRhqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Approval Inquery화면에서 RHQ콤보 변경시 Office comboBox조회
	  * </pre>
	  */
	public ApprovalDBDAOSearchOfcCdListByRhqRSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOSearchOfcCdListByRhqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
