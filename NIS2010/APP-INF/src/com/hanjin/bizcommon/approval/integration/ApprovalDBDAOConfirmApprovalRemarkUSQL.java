...
*@FileName : ApprovalDBDAOConfirmApprovalRemarkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOConfirmApprovalRemarkUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalDBDAOConfirmApprovalRemarkUSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOConfirmApprovalRemarkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET APRO_RMK = 'Retry'" ).append("\n"); 
