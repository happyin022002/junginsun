...
*@FileName : ApprovalDBDAOSearchExeActTpCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOSearchExeActTpCdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalDBDAOSearchExeActTpCdRSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOSearchExeActTpCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("R.EXE_ACT_TP_CD" ).append("\n"); 
		query.append("FROM AP_INV_HDR A, COM_AP_SND_MN_RULE R" ).append("\n"); 
