...
*@FileName : ApprovalDBDAOApprovalStepUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOApprovalStepUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalDBDAOApprovalStepUSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOApprovalStepUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     GL_DT      = @[new_gl_dt]								" ).append("\n"); 
