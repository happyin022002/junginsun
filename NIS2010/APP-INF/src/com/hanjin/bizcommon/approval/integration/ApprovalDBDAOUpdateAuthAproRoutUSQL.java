...
*@FileName : ApprovalDBDAOUpdateAuthAproRoutUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOUpdateAuthAproRoutUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Authorization Approve, Confirm 시 Rout Update
	  * </pre>
	  */
	public ApprovalDBDAOUpdateAuthAproRoutUSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOUpdateAuthAproRoutUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET R.AUTH_APSTS_CD = 'C', R.AUTH_APRO_DT = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC ((SELECT Q.RQST_OFC_CD FROM COM_AUTH_APRO_RQST Q WHERE Q.AUTH_APRO_RQST_NO = R.AUTH_APRO_RQST_NO AND ROWNUM=1))" ).append("\n"); 
