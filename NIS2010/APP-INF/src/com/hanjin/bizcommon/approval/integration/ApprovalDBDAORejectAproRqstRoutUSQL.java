...
*@FileName : ApprovalDBDAORejectAproRqstRoutUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAORejectAproRqstRoutUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * COM_APRO_RQST_ROUT 정보를 수정한다.
	  * </pre>
	  */
	public ApprovalDBDAORejectAproRqstRoutUSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAORejectAproRqstRoutUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     , APSTS_CD = 'R'" ).append("\n"); 
		query.append("     , APRO_RMK = SUBSTRB('Disapproved'||@[apro_rmk],1,999)" ).append("\n"); 
