...
*@FileName : ApprovalDBDAOUpdateConfirmAuthAproFinalUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOUpdateConfirmAuthAproFinalUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ApprovalDBDAOUpdateConfirmAuthAproFinalUSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOUpdateConfirmAuthAproFinalUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET Q.AUTH_APSTS_CD = 'C'" ).append("\n"); 
		query.append("    , Q.RQST_END_DT = GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC(Q.RQST_OFC_CD) " ).append("\n"); 
