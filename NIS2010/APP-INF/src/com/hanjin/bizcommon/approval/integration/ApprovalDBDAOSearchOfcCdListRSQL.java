...
*@FileName : ApprovalDBDAOSearchOfcCdListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ApprovalDBDAOSearchOfcCdListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Approval Inquery화면의 Office comboBox조회
	  * </pre>
	  */
	public ApprovalDBDAOSearchOfcCdListRSQL(){
		setQuery();
		...
		query.append("FileName : ApprovalDBDAOSearchOfcCdListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT LL.OFC_N5TH_LVL_CD AS OFC_CD" ).append("\n"); 
		query.append("      ,LL.OFC_N5TH_LVL_CD AS OFC_NM" ).append("\n"); 
		...
		query.append("       OR LL.OFC_CD = @[ofc_cd]" ).append("\n"); 
		query.append("      )		" ).append("\n"); 
