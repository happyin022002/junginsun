...
public class ApprovalViewAdapter extends ViewAdapter {
	...
	protected String makeDataTag(List<AbstractValueObject> vos, String prefix) {
		...
		String[] realColNms = {"apro_rqst_no","crnt_apro_seq","apsts_cd","sub_sys_cd","rqst_st_dt","cost_ofc_cd","csr_no","inv_knt","vndr_seq","vndr_nm","pay_due_dt","pay_dt","curr_cd","apro_ttl_amt","csr_usd_amt","agmt_doc_cfm_cd","agmt_file_cfm_cd","file_upld_flg","chk_curr_apro_usr_yn","apro_rmk", "file_knt", "cmt_yn", "appyn"};
