...
* 1.0 최초 생성
* History
* 2015.07.16 심성윤 [CHM-201536387] [Develop]ALPS Auth 사후 결재 기능 탭 로직 추가(VO추가)
=========================================================*/
...
public class COM_ENS_0U1HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	event.setAuthorizationAproVOS((AuthorizationAproVO[])getVOs(request, AuthorizationAproVO.class, ""));
    	event.setAuthorizationAproVO((AuthorizationAproVO)getVO(request, AuthorizationAproVO.class));
