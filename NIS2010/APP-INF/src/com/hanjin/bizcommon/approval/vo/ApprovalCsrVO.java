...
public class ApprovalCsrVO	extends	 AbstractValueObject
{
	...
	/*	Column Info	*/
	private  String	 editUrgPayChk   =  null;
	/*	Column Info	*/
	...
	/*	Column Info	*/
	private  String	 aproCfmScrnFlg   =  null;
	/*	Column Info	*/
	...
	public ApprovalCsrVO(String aproStep,String payDt,String aproTtlAmt,String apstsCd,String ibflag,String aproSeqKey,String csrNo,String subSysCd,String agmtDocCfmCd,String aproRmk,String aproRqstSeq,String usrNm,String fileUpldFlg,String cmtYn,String invSubSysCd,String chkCurrAproUsrYn,String fileKnt,String asaNo,String frstAproUsrId,String asaAmt,String pagerows,String editUrgPayChk,String costOfcCd,String ofcCd,String urgPayFlg,String currCd,String usrId,String agmtFileCfmCd,String invKnt,String payDueDt,String vndrSeq,String aproRqstNo,String csrUsdAmt,String aproCfmScrnFlg,String vndrNm,String rqstStDt,String crntAproSeq,String appyn,String alpsStatus,String ifStatus)	{
		...
		this.fileKnt  = fileKnt ;
		this.asaNo  = asaNo ;
		this.frstAproUsrId  = frstAproUsrId ;
		this.asaAmt  = asaAmt ;
		this.pagerows  = pagerows ;
		this.editUrgPayChk  = editUrgPayChk ;
		...
		this.aproCfmScrnFlg  = aproCfmScrnFlg ;
		this.vndrNm  = vndrNm ;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("edit_urg_pay_chk", getEditUrgPayChk());		
		this.hashColumns.put("cost_ofc_cd", getCostOfcCd());		
		this.hashColumns.put("ofc_cd", getOfcCd());		
		this.hashColumns.put("urg_pay_flg", getUrgPayFlg());		
		...
		this.hashColumns.put("apro_cfm_scrn_flg", getAproCfmScrnFlg());		
	...
	public  HashMap<String, String>  getFieldNames(){
		...
		this.hashFields.put("edit_urg_pay_chk", "editUrgPayChk");
		...
		this.hashFields.put("apro_cfm_scrn_flg", "aproCfmScrnFlg");
 ...
 //	Getters	and	Setters
	...
	* @param  fileKnt
	*/
	public void	setFileKnt( String	fileKnt ) {
		this.fileKnt =	fileKnt;
	}
	...
	* @param  editUrgPayChk
	*/
	public void	setEditUrgPayChk( String	editUrgPayChk ) {
		this.editUrgPayChk =	editUrgPayChk;
	}
 
	/**
	 * Column Info
	 * @return	editUrgPayChk
	 */
	 public	 String	getEditUrgPayChk() {
		 return	this.editUrgPayChk;
	 } 
 	/**
	* Column Info
	* @param  costOfcCd
	...
	*/
	 ...
	 */
 	...
 	/**
	* Column Info
	* @param  aproCfmScrnFlg
	*/
	public void	setAproCfmScrnFlg( String	aproCfmScrnFlg ) {
		this.aproCfmScrnFlg =	aproCfmScrnFlg;
	}
 
	/**
	 * Column Info
	 * @return	aproCfmScrnFlg
	 */
	 public	 String	getAproCfmScrnFlg() {
		 return	this.aproCfmScrnFlg;
	 } 
 	/**
	* Column Info
	* @param  vndrNm
	...
	*/
	...
	public void	fromRequest(HttpServletRequest request,	String prefix) {
		...
		setCmtYn(JSPUtil.getParameter(request,	prefix + "cmt_yn", ""));
		...
		setFileKnt(JSPUtil.getParameter(request,	prefix + "file_knt", ""));
		...
		setEditUrgPayChk(JSPUtil.getParameter(request,	prefix + "edit_urg_pay_chk", ""));
		setCostOfcCd(JSPUtil.getParameter(request,	prefix + "cost_ofc_cd", ""));
		setOfcCd(JSPUtil.getParameter(request,	prefix + "ofc_cd", ""));
		setUrgPayFlg(JSPUtil.getParameter(request,	prefix + "urg_pay_flg", ""));
		...
		setAproCfmScrnFlg(JSPUtil.getParameter(request,	prefix + "apro_cfm_scrn_flg", ""));
	...
	public ApprovalCsrVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		...
		try	{
				...
				String[] cmtYn =	(JSPUtil.getParameter(request, prefix +	"cmt_yn".trim(),	length));
				String[] invSubSysCd =	(JSPUtil.getParameter(request, prefix +	"inv_sub_sys_cd".trim(),	length));
				String[] chkCurrAproUsrYn =	(JSPUtil.getParameter(request, prefix +	"chk_curr_apro_usr_yn".trim(),	length));
				String[] fileKnt =	(JSPUtil.getParameter(request, prefix +	"file_knt".trim(),	length));
				...
				String[] editUrgPayChk =	(JSPUtil.getParameter(request, prefix +	"edit_urg_pay_chk".trim(),	length));
				String[] costOfcCd =	(JSPUtil.getParameter(request, prefix +	"cost_ofc_cd".trim(),	length));
				String[] ofcCd =	(JSPUtil.getParameter(request, prefix +	"ofc_cd".trim(),	length));
				String[] urgPayFlg =	(JSPUtil.getParameter(request, prefix +	"urg_pay_flg".trim(),	length));
				...
				String[] csrUsdAmt =	(JSPUtil.getParameter(request, prefix +	"csr_usd_amt".trim(),	length));
				String[] aproCfmScrnFlg =	(JSPUtil.getParameter(request, prefix +	"apro_cfm_scrn_flg".trim(),	length));
				...
				for	(int i = 0;	i <	length;	i++) {
					model =	new	ApprovalCsrVO();
						...
						if ( editUrgPayChk[i] !=	null)
						model.setEditUrgPayChk( editUrgPayChk[i]);
						if ( costOfcCd[i] !=	null)
						model.setCostOfcCd( costOfcCd[i]);
						if ( ofcCd[i] !=	null)
						model.setOfcCd( ofcCd[i]);
						if ( urgPayFlg[i] !=	null)
						model.setUrgPayFlg( urgPayFlg[i]);
						if ( currCd[i] !=	null)
						...
						if ( aproCfmScrnFlg[i] !=	null)
						model.setAproCfmScrnFlg( aproCfmScrnFlg[i]);
						if ( vndrNm[i] !=	null)
	...
	*/
	public void	unDataFormat(){
		...
		this.cmtYn =	this.cmtYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.fileKnt =	this.fileKnt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.editUrgPayChk =	this.editUrgPayChk.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.costOfcCd =	this.costOfcCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ofcCd =	this.ofcCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.urgPayFlg =	this.urgPayFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.aproCfmScrnFlg =	this.aproCfmScrnFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
