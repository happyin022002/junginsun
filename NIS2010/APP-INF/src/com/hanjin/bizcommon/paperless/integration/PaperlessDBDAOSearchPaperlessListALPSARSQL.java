...
*@FileName : PaperlessDBDAOSearchPaperlessListALPSARSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PaperlessDBDAOSearchPaperlessListALPSARSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * PaperlessDBDAOSearchPaperlessListALPSARSQL
	  * </pre>
	  */
	public PaperlessDBDAOSearchPaperlessListALPSARSQL(){
		setQuery();
		...
		query.append("FileName : PaperlessDBDAOSearchPaperlessListALPSARSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
