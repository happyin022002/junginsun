...
* 1.0 Creation
=========================================================*/
package com.hanjin.sample.groupwarepopup.groupwarepopup.integration;
...
public class GroupwarePopupDBDAOComEmlSndInfoVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.sample.groupwarepopup.groupwarepopup.integration").append("\n"); 
