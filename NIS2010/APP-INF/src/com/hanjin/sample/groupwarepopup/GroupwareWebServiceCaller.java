...
import com.hanjin.integration.schedule.GroupwareUpdateResultLoggingDocument;
import com.hanjin.integration.schedule.GroupwareUpdateResultLoggingResponseDocument;
import com.hanjin.integration.schedule.GroupwareUpdateResultLoggingDocument.GroupwareUpdateResultLogging;
import com.hanjin.integration.schedule.GroupwareUpdateResultLoggingResponseDocument.GroupwareUpdateResultLoggingResponse;
...
public class GroupwareWebServiceCaller {
	public static void main(String[] args) throws EAIException, XmlException {
		...
		String target = "http://203.246.142.84:7001/hanjin/webservices/GroupwarePopupMailLogging?WSDL";
