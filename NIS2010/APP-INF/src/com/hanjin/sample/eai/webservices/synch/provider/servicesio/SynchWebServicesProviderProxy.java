...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.sample.eai.webservices.synch.provider.servicesio;
...
@WLHttpTransport(contextPath="/hanjin/webservices", serviceUri="/SynchWebServicesProviderProxy",
