...
public class ReceiveHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ESM_BKG_0225HTMLAction 객체를 생성
	 */
	public ReceiveHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if (command.isCommand(FormCommand.COMMAND03)){
			event.setBkgWebServiceVO((BkgWebServiceVO)getVO(request, BkgWebServiceVO.class));
		}else{
