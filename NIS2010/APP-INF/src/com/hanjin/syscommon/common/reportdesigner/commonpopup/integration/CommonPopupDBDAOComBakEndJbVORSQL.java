...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.common.reportdesigner.commonpopup.integration;
...
public class CommonPopupDBDAOComBakEndJbVORSQL implements ISQLTemplate{
	...
	public CommonPopupDBDAOComBakEndJbVORSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.syscommon.common.reportdesigner.commonpopup.integration").append("\n"); 
