...
*@FileName : MasSimSmryVO.java
*@FileTitle : MasSimSmryVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimSmryVO> models = new ArrayList<MasSimSmryVO>();
	...
	public MasSimSmryVO(String ibflag, String pagerows, String costYrmon, String trdCd, String subTrdCd, String rlaneCd, String dirCd, String porCd, String polCd, String podCd, String delCd, String sgrpCostCd, String simPerfAmt, String simRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.porCd = porCd;
		this.creDt = creDt;
		this.delCd = delCd;
	 ...
	 * @return MasSimSmryVO[]
	 */
	public MasSimSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimSmryVO[]
	 */
	public MasSimSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimSmryVO model = null;
	 ...
	 * @return MasSimSmryVO[]
	 */
	public MasSimSmryVO[] getMasSimSmryVOs(){
		MasSimSmryVO[] vos = (MasSimSmryVO[])models.toArray(new MasSimSmryVO[models.size()]);
		return vos;
	}
