...
*@FileName : SqmQtaPotnMgmtVO.java
*@FileTitle : SqmQtaPotnMgmtVO
*Open Issues :
*Change history :
...
public class SqmQtaPotnMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmQtaPotnMgmtVO> models = new ArrayList<SqmQtaPotnMgmtVO>();
...
/**
	 ...
	 */
	public SqmQtaPotnMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmQtaPotnMgmtVO[]
	 */
	public SqmQtaPotnMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmQtaPotnMgmtVO model = null;
	...
	public SqmQtaPotnMgmtVO[] getSqmQtaPotnMgmtVOs(){
		SqmQtaPotnMgmtVO[] vos = (SqmQtaPotnMgmtVO[])models.toArray(new SqmQtaPotnMgmtVO[models.size()]);
		return vos;
	}
