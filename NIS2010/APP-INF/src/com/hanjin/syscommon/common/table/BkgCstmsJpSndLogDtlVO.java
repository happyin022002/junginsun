...
*@FileName : BkgCstmsJpSndLogDtlVO.java
*@FileTitle : BkgCstmsJpSndLogDtlVO
*Open Issues :
*Change history :
...
public class BkgCstmsJpSndLogDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsJpSndLogDtlVO> models = new ArrayList<BkgCstmsJpSndLogDtlVO>();
	...
	public BkgCstmsJpSndLogDtlVO() {}

	public BkgCstmsJpSndLogDtlVO(String ibflag, String pagerows, String jpSndLogId, String msgSndDt, String ofcCd, String logSeq, String subSeq, String ediSndMsg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.ofcCd = ofcCd;
	 ...
	 * @param request
	 * @return BkgCstmsJpSndLogDtlVO[]
	 */
	public BkgCstmsJpSndLogDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsJpSndLogDtlVO[]
	 */
	public BkgCstmsJpSndLogDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsJpSndLogDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCstmsJpSndLogDtlVO();
				if (updDt[i] != null)
		...
		return getBkgCstmsJpSndLogDtlVOs();
	}
	 ...
	 * @return BkgCstmsJpSndLogDtlVO[]
	 */
	public BkgCstmsJpSndLogDtlVO[] getBkgCstmsJpSndLogDtlVOs(){
		BkgCstmsJpSndLogDtlVO[] vos = (BkgCstmsJpSndLogDtlVO[])models.toArray(new BkgCstmsJpSndLogDtlVO[models.size()]);
		return vos;
	}
