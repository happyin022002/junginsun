...
*@FileName : FmsChtrPtyFileVO.java
*@FileTitle : FmsChtrPtyFileVO
*Open Issues :
*Change history :
...
public class FmsChtrPtyFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FmsChtrPtyFileVO> models = new ArrayList<FmsChtrPtyFileVO>();
	...
	public FmsChtrPtyFileVO() {}

	public FmsChtrPtyFileVO(String ibflag, String pagerows, String fletCtrtNo, String fileSeq, String fletFileTpCd, String fileNm, String fileDesc, String fileSavId, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public FmsChtrPtyFileVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public FmsChtrPtyFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FmsChtrPtyFileVO model = null;
		...
		return getFmsChtrPtyFileVOs();
	}

	public FmsChtrPtyFileVO[] getFmsChtrPtyFileVOs(){
		FmsChtrPtyFileVO[] vos = (FmsChtrPtyFileVO[])models.toArray(new FmsChtrPtyFileVO[models.size()]);
		return vos;
	}
