...
*@FileName : ComAproRoleRqstHdrVO.java
*@FileTitle : ComAproRoleRqstHdrVO
*Open Issues :
*Change history :
...
public class ComAproRoleRqstHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComAproRoleRqstHdrVO> models = new ArrayList<ComAproRoleRqstHdrVO>();
	...
	public ComAproRoleRqstHdrVO() {}

	public ComAproRoleRqstHdrVO(String ibflag, String pagerows, String aproRqstNo, String aproKndCd, String apstsCd, String crntAproSeq, String rqstUsrId, String rqstUsrNm, String rqstOfcCd, String rqstOfcNm, String rqstUsrJbTitNm, String rqstStDt, String rqstEndDt, String rqstTitNm, String rqstRmk, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public ComAproRoleRqstHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComAproRoleRqstHdrVO[]
	 */
	public ComAproRoleRqstHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComAproRoleRqstHdrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ComAproRoleRqstHdrVO();
				if (updDt[i] != null)
		...
		return getComAproRoleRqstHdrVOs();
	}
	...
	public ComAproRoleRqstHdrVO[] getComAproRoleRqstHdrVOs(){
		ComAproRoleRqstHdrVO[] vos = (ComAproRoleRqstHdrVO[])models.toArray(new ComAproRoleRqstHdrVO[models.size()]);
		return vos;
	}
