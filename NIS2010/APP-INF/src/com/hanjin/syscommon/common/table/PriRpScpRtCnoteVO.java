...
*@FileName : PriRpScpRtCnoteVO.java
*@FileTitle : PriRpScpRtCnoteVO
*Open Issues :
*Change history :
...
public class PriRpScpRtCnoteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtCnoteVO> models = new ArrayList<PriRpScpRtCnoteVO>();
	 ...
	 * @param request
	 * @return PriRpScpRtCnoteVO[]
	 */
	public PriRpScpRtCnoteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtCnoteVO[]
	 */
	public PriRpScpRtCnoteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtCnoteVO model = null;
	...
	public PriRpScpRtCnoteVO[] getPriRpScpRtCnoteVOs(){
		PriRpScpRtCnoteVO[] vos = (PriRpScpRtCnoteVO[])models.toArray(new PriRpScpRtCnoteVO[models.size()]);
		return vos;
	}
