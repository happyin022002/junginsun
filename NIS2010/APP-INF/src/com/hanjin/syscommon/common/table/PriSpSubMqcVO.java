...
*@FileName : PriSpSubMqcVO.java
*@FileTitle : PriSpSubMqcVO
*Open Issues :
*Change history :
...
public class PriSpSubMqcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpSubMqcVO> models = new ArrayList<PriSpSubMqcVO>();
	...
	public PriSpSubMqcVO() {}

	public PriSpSubMqcVO(String ibflag, String pagerows, String propNo, String amdtSeq, String subMqcCtnt, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriSpSubMqcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpSubMqcVO[]
	 */
	public PriSpSubMqcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpSubMqcVO model = null;
	...
	public PriSpSubMqcVO[] getPriSpSubMqcVOs(){
		PriSpSubMqcVO[] vos = (PriSpSubMqcVO[])models.toArray(new PriSpSubMqcVO[models.size()]);
		return vos;
	}
