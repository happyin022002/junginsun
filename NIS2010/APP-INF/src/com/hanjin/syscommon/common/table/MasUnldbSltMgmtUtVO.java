...
*@FileName : MasUnldbSltMgmtUtVO.java
*@FileTitle : MasUnldbSltMgmtUtVO
*Open Issues :
*Change history :
 ...
 */
public class MasUnldbSltMgmtUtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasUnldbSltMgmtUtVO> models = new ArrayList<MasUnldbSltMgmtUtVO>();
	 ...
	 * @param request
	 * @return MasUnldbSltMgmtUtVO[]
	 */
	public MasUnldbSltMgmtUtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasUnldbSltMgmtUtVO[]
	 */
	public MasUnldbSltMgmtUtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasUnldbSltMgmtUtVO model = null;
		...
		return getMasUnldbSltMgmtUtVOs();
	}
	 ...
	 * @return MasUnldbSltMgmtUtVO[]
	 */
	public MasUnldbSltMgmtUtVO[] getMasUnldbSltMgmtUtVOs(){
		MasUnldbSltMgmtUtVO[] vos = (MasUnldbSltMgmtUtVO[])models.toArray(new MasUnldbSltMgmtUtVO[models.size()]);
		return vos;
	}
