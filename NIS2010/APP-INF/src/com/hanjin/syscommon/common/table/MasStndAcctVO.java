...
*@FileName : MasStndAcctVO.java
*@FileTitle : MasStndAcctVO
*Open Issues :
*Change history :
 ...
 */
public class MasStndAcctVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasStndAcctVO> models = new ArrayList<MasStndAcctVO>();
	...
	public MasStndAcctVO() {}

	public MasStndAcctVO(String ibflag, String pagerows, String stndCostCd, String stndCostNm, String mgrpCostCd, String sgrpCostCd, String perfVwCd, String krnCostFullDesc, String raAcctCd, String raMnCostCd, String raSgrpCostCd, String raPerfVwCd, String hirScpFlg, String acctDpSeq, String masCostSrcPrtCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasStndAcctVO[]
	 */
	public MasStndAcctVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasStndAcctVO[]
	 */
	public MasStndAcctVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasStndAcctVO model = null;
	...
	public MasStndAcctVO[] getMasStndAcctVOs(){
		MasStndAcctVO[] vos = (MasStndAcctVO[])models.toArray(new MasStndAcctVO[models.size()]);
		return vos;
	}
