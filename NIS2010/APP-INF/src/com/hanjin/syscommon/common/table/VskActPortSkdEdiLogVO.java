...
public class VskActPortSkdEdiLogVO extends AbstractValueObject {
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("match_mode", "modeMode");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMtchModCd(JSPUtil.getParameter(request, "match_mode", ""));
	}
	...
	public VskActPortSkdEdiLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] mtchModCd = (JSPUtil.getParameter(request, prefix	+ "match_mode", length));
