...
*@FileName : PriSpScpGriRoutPntCpyVO.java
*@FileTitle : PriSpScpGriRoutPntCpyVO
*Open Issues :
*Change history :
...
public class PriSpScpGriRoutPntCpyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGriRoutPntCpyVO> models = new ArrayList<PriSpScpGriRoutPntCpyVO>();
	...
	public PriSpScpGriRoutPntCpyVO() {}

	public PriSpScpGriRoutPntCpyVO(String ibflag, String pagerows, String usrId, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String orgDestTpCd, String griRoutPntSeq, String routPntLocTpCd, String routPntLocDefCd, String rcvDeTermCd, String creUsrId, String creDt, String updUsrId, String updDt) {
...
/**
	 ...
	 * @param request
	 * @return PriSpScpGriRoutPntCpyVO[]
	 */
	public PriSpScpGriRoutPntCpyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGriRoutPntCpyVO[]
	 */
	public PriSpScpGriRoutPntCpyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGriRoutPntCpyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpGriRoutPntCpyVO();
				if (pagerows[i] != null)
		...
		return getPriSpScpGriRoutPntCpyVOs();
	}
	 ...
	 * @return PriSpScpGriRoutPntCpyVO[]
	 */
	public PriSpScpGriRoutPntCpyVO[] getPriSpScpGriRoutPntCpyVOs(){
		PriSpScpGriRoutPntCpyVO[] vos = (PriSpScpGriRoutPntCpyVO[])models.toArray(new PriSpScpGriRoutPntCpyVO[models.size()]);
		return vos;
	}
