...
*@FileName : PriSpScpArbGriGrpVO.java
*@FileTitle : PriSpScpArbGriGrpVO
*Open Issues :
*Change history :
...
public class PriSpScpArbGriGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpArbGriGrpVO> models = new ArrayList<PriSpScpArbGriGrpVO>();
	 ...
	 */
	public PriSpScpArbGriGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpArbGriGrpVO[]
	 */
	public PriSpScpArbGriGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpArbGriGrpVO model = null;
		...
		return getPriSpScpArbGriGrpVOs();
	}
	...
	public PriSpScpArbGriGrpVO[] getPriSpScpArbGriGrpVOs(){
		PriSpScpArbGriGrpVO[] vos = (PriSpScpArbGriGrpVO[])models.toArray(new PriSpScpArbGriGrpVO[models.size()]);
		return vos;
	}
