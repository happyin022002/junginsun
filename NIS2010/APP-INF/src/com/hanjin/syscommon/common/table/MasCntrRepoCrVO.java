...
*@FileName : MasCntrRepoCrVO.java
*@FileTitle : MasCntrRepoCrVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoCrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoCrVO> models = new ArrayList<MasCntrRepoCrVO>();
	...
	public MasCntrRepoCrVO() {}

	public MasCntrRepoCrVO(String ibflag, String pagerows, String costYrmon, String cntrTpszCd, String repoLvlGrpCd, String eqRepoCrRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public MasCntrRepoCrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoCrVO[]
	 */
	public MasCntrRepoCrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoCrVO model = null;
	...
	public MasCntrRepoCrVO[] getMasCntrRepoCrVOs(){
		MasCntrRepoCrVO[] vos = (MasCntrRepoCrVO[])models.toArray(new MasCntrRepoCrVO[models.size()]);
		return vos;
	}
