 ...
 * @since J2EE 1.4
 */
public final class COM_CODEVALUE implements java.io.Serializable {
	...
	public static COM_CODEVALUE fromRequest(HttpServletRequest request) {
		COM_CODEVALUE model = new COM_CODEVALUE();
		try {
