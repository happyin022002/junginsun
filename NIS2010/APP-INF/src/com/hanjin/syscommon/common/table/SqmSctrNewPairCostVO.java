...
*@FileName : SqmSctrNewPairCostVO.java
*@FileTitle : SqmSctrNewPairCostVO
*Open Issues :
*Change history :
...
public class SqmSctrNewPairCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrNewPairCostVO> models = new ArrayList<SqmSctrNewPairCostVO>();
...
/**
	 ...
	 * @param request
	 * @return SqmSctrNewPairCostVO[]
	 */
	public SqmSctrNewPairCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrNewPairCostVO[]
	 */
	public SqmSctrNewPairCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrNewPairCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SqmSctrNewPairCostVO();
				if (updDt[i] != null)
		...
		return getSqmSctrNewPairCostVOs();
	}
	 ...
	 * @return SqmSctrNewPairCostVO[]
	 */
	public SqmSctrNewPairCostVO[] getSqmSctrNewPairCostVOs(){
		SqmSctrNewPairCostVO[] vos = (SqmSctrNewPairCostVO[])models.toArray(new SqmSctrNewPairCostVO[models.size()]);
		return vos;
	}
