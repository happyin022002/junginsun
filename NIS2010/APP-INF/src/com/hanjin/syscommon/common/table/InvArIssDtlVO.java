...
*@FileName : InvArIssDtlVO.java
*@FileTitle : InvArIssDtlVO
*Open Issues :
*Change history :
...
public class InvArIssDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvArIssDtlVO> models = new ArrayList<InvArIssDtlVO>();
	...
	public InvArIssDtlVO() {}

	public InvArIssDtlVO(String ibflag, String pagerows, String invNo, String arIfNo, String arIfSerNo, String chgSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.invNo = invNo;
	...
	public InvArIssDtlVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public InvArIssDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvArIssDtlVO model = null;
		...
		return getInvArIssDtlVOs();
	}

	public InvArIssDtlVO[] getInvArIssDtlVOs(){
		InvArIssDtlVO[] vos = (InvArIssDtlVO[])models.toArray(new InvArIssDtlVO[models.size()]);
		return vos;
	}
