...
*@FileName : PriCmpbGrpCmdtDtlVO.java
*@FileTitle : PriCmpbGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class PriCmpbGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGrpCmdtDtlVO> models = new ArrayList<PriCmpbGrpCmdtDtlVO>();
	...
	public PriCmpbGrpCmdtDtlVO() {}

	public PriCmpbGrpCmdtDtlVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String grpCmdtSeq, String grpCmdtDtlSeq, String prcCmdtTpCd, String prcCmdtDefCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriCmpbGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGrpCmdtDtlVO[]
	 */
	public PriCmpbGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGrpCmdtDtlVO model = null;
		...
		return getPriCmpbGrpCmdtDtlVOs();
	}
	...
	public PriCmpbGrpCmdtDtlVO[] getPriCmpbGrpCmdtDtlVOs(){
		PriCmpbGrpCmdtDtlVO[] vos = (PriCmpbGrpCmdtDtlVO[])models.toArray(new PriCmpbGrpCmdtDtlVO[models.size()]);
		return vos;
	}
