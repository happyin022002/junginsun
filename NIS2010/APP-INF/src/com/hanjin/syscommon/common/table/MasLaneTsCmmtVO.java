...
*@FileName : MasLaneTsCmmtVO.java
*@FileTitle : MasLaneTsCmmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneTsCmmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneTsCmmtVO> models = new ArrayList<MasLaneTsCmmtVO>();
	...
	public MasLaneTsCmmtVO() {}

	public MasLaneTsCmmtVO(String ibflag, String pagerows, String costYrmon, String fmTrdCd, String fmRlaneCd, String fmIocCd, String fmSkdDirCd, String toTrdCd, String toRlaneCd, String toIocCd, String toSkdDirCd, String tsRtAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasLaneTsCmmtVO[]
	 */
	public MasLaneTsCmmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneTsCmmtVO[]
	 */
	public MasLaneTsCmmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneTsCmmtVO model = null;
	...
	public MasLaneTsCmmtVO[] getMasLaneTsCmmtVOs(){
		MasLaneTsCmmtVO[] vos = (MasLaneTsCmmtVO[])models.toArray(new MasLaneTsCmmtVO[models.size()]);
		return vos;
	}
