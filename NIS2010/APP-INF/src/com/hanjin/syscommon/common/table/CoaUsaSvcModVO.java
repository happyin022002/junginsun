...
*@FileName : CoaUsaSvcModVO.java
*@FileTitle : CoaUsaSvcModVO
*Open Issues :
*Change history :
...
public class CoaUsaSvcModVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaUsaSvcModVO> models = new ArrayList<CoaUsaSvcModVO>();
	...
	public CoaUsaSvcModVO() {}

	public CoaUsaSvcModVO(String ibflag, String pagerows, String orgRgnCd, String destRgnCd, String svcModCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public CoaUsaSvcModVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaUsaSvcModVO[]
	 */
	public CoaUsaSvcModVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaUsaSvcModVO model = null;
	...
	public CoaUsaSvcModVO[] getCoaUsaSvcModVOs(){
		CoaUsaSvcModVO[] vos = (CoaUsaSvcModVO[])models.toArray(new CoaUsaSvcModVO[models.size()]);
		return vos;
	}
