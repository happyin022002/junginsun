...
*@FileName : VskSltPrcPortDtlVO.java
*@FileTitle : VskSltPrcPortDtlVO
*Open Issues :
*Change history :
...
public class VskSltPrcPortDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VskSltPrcPortDtlVO> models = new ArrayList<VskSltPrcPortDtlVO>();
	...
	public VskSltPrcPortDtlVO() {}

	public VskSltPrcPortDtlVO(String ibflag, String pagerows, String vslSlanCd, String pfSvcTpCd, String sltPrcWrkYr, String bseQtrCd, String vslClssCd, String portCd, String skdDirCd, String clptSeq, String portRotnSeq, String ydCd, String peAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return VskSltPrcPortDtlVO[]
	 */
	public VskSltPrcPortDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VskSltPrcPortDtlVO[]
	 */
	public VskSltPrcPortDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VskSltPrcPortDtlVO model = null;
	 ...
	 * @return VskSltPrcPortDtlVO[]
	 */
	public VskSltPrcPortDtlVO[] getVskSltPrcPortDtlVOs(){
		VskSltPrcPortDtlVO[] vos = (VskSltPrcPortDtlVO[])models.toArray(new VskSltPrcPortDtlVO[models.size()]);
		return vos;
	}
