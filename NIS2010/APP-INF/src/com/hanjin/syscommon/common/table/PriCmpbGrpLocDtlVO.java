...
*@FileName : PriCmpbGrpLocDtlVO.java
*@FileTitle : PriCmpbGrpLocDtlVO
*Open Issues :
*Change history :
...
public class PriCmpbGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGrpLocDtlVO> models = new ArrayList<PriCmpbGrpLocDtlVO>();
	...
	public PriCmpbGrpLocDtlVO() {}

	public PriCmpbGrpLocDtlVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String grpLocSeq, String grpLocDtlSeq, String locCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriCmpbGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGrpLocDtlVO[]
	 */
	public PriCmpbGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGrpLocDtlVO model = null;
	...
	public PriCmpbGrpLocDtlVO[] getPriCmpbGrpLocDtlVOs(){
		PriCmpbGrpLocDtlVO[] vos = (PriCmpbGrpLocDtlVO[])models.toArray(new PriCmpbGrpLocDtlVO[models.size()]);
		return vos;
	}
