...
*@FileName : BsaBudSltChtrCrrCapaVO.java
*@FileTitle : BsaBudSltChtrCrrCapaVO
*Open Issues :
*Change history :
...
public class BsaBudSltChtrCrrCapaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaBudSltChtrCrrCapaVO> models = new ArrayList<BsaBudSltChtrCrrCapaVO>();
	...
	public BsaBudSltChtrCrrCapaVO() {}

	public BsaBudSltChtrCrrCapaVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String dirCd, String bsaSeq, String vslSeq, String bsaOpCd, String bsaOpJbCd, String crrCd, String crrBsaCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.trdCd = trdCd;
...
/**
	 ...
	 */
	public BsaBudSltChtrCrrCapaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaBudSltChtrCrrCapaVO[]
	 */
	public BsaBudSltChtrCrrCapaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaBudSltChtrCrrCapaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BsaBudSltChtrCrrCapaVO();
				if (updDt[i] != null)
		...
		return getBsaBudSltChtrCrrCapaVOs();
	}
	 ...
	 * @return BsaBudSltChtrCrrCapaVO[]
	 */
	public BsaBudSltChtrCrrCapaVO[]  fromRequestGridConv(HttpServletRequest request, String[] prefix) {
		BsaBudSltChtrCrrCapaVO model = null;
		...
		String[] tmp = request.getParameterValues("ibflag");
  		...
  		try {
			for (int k=0 ; k < arrPrefix.length ; k++){
				...
				String[] vslSeq		= (JSPUtil.getParameter(request, "vsl_seq", length));
	...
	public BsaBudSltChtrCrrCapaVO[] getBsaBudSltChtrCrrCapaVOs(){
		BsaBudSltChtrCrrCapaVO[] vos = (BsaBudSltChtrCrrCapaVO[])models.toArray(new BsaBudSltChtrCrrCapaVO[models.size()]);
		return vos;
	}
