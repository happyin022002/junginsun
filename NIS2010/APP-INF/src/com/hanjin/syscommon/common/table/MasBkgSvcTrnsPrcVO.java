...
*@FileName : MasBkgSvcTrnsPrcVO.java
*@FileTitle : MasBkgSvcTrnsPrcVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgSvcTrnsPrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgSvcTrnsPrcVO> models = new ArrayList<MasBkgSvcTrnsPrcVO>();
	 ...
	 * @param request
	 * @return MasBkgSvcTrnsPrcVO[]
	 */
	public MasBkgSvcTrnsPrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgSvcTrnsPrcVO[]
	 */
	public MasBkgSvcTrnsPrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgSvcTrnsPrcVO model = null;
	 ...
	 * @return MasBkgSvcTrnsPrcVO[]
	 */
	public MasBkgSvcTrnsPrcVO[] getMasBkgSvcTrnsPrcVOs(){
		MasBkgSvcTrnsPrcVO[] vos = (MasBkgSvcTrnsPrcVO[])models.toArray(new MasBkgSvcTrnsPrcVO[models.size()]);
		return vos;
	}
