...
*@FileName : CoaComParaVO.java
*@FileTitle : CoaComParaVO
*Open Issues :
*Change history :
...
public class CoaComParaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaComParaVO> models = new ArrayList<CoaComParaVO>();
	 ...
	 * @return CoaComParaVO[]
	 */
	public CoaComParaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaComParaVO[]
	 */
	public CoaComParaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaComParaVO model = null;
	 ...
	 * @return CoaComParaVO[]
	 */
	public CoaComParaVO[] getCoaComParaVOs(){
		CoaComParaVO[] vos = (CoaComParaVO[])models.toArray(new CoaComParaVO[models.size()]);
		return vos;
	}
