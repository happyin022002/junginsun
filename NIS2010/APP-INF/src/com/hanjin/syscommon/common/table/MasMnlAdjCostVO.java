...
*@FileName : MasMnlAdjCostVO.java
*@FileTitle : MasMnlAdjCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasMnlAdjCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMnlAdjCostVO> models = new ArrayList<MasMnlAdjCostVO>();
...
/**
	 ...
	 * @param request
	 * @return MasMnlAdjCostVO[]
	 */
	public MasMnlAdjCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMnlAdjCostVO[]
	 */
	public MasMnlAdjCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMnlAdjCostVO model = null;
	 ...
	 * @return MasMnlAdjCostVO[]
	 */
	public MasMnlAdjCostVO[] getMasMnlAdjCostVOs(){
		MasMnlAdjCostVO[] vos = (MasMnlAdjCostVO[])models.toArray(new MasMnlAdjCostVO[models.size()]);
		return vos;
	}
