...
*@FileName : MasMssStsVO.java
*@FileTitle : MasMssStsVO
*Open Issues :
*Change history :
 ...
 */
public class MasMssStsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMssStsVO> models = new ArrayList<MasMssStsVO>();
	...
	public MasMssStsVO(String ibflag, String pagerows, String costYrwk, String stndCostCd, String trdCd, String iocCd, String rlaneCd, String vslCd, String skdVoyNo, String dirCd, String costCalcRmk, String costMon, String bsaZrFlg, String prcNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
		this.vslCd = vslCd;
		this.creDt = creDt;
	 ...
	 * @return MasMssStsVO[]
	 */
	public MasMssStsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMssStsVO[]
	 */
	public MasMssStsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMssStsVO model = null;
	 ...
	 * @return MasMssStsVO[]
	 */
	public MasMssStsVO[] getMasMssStsVOs(){
		MasMssStsVO[] vos = (MasMssStsVO[])models.toArray(new MasMssStsVO[models.size()]);
		return vos;
	}
