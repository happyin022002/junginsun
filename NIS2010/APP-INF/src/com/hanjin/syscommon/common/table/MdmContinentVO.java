...
*@FileName : MdmContinentVO.java
*@FileTitle : MdmContinentVO
*Open Issues :
*Change history :
...
public class MdmContinentVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmContinentVO> models = new ArrayList<MdmContinentVO>();
	...
	public MdmContinentVO() {}

	public MdmContinentVO(String ibflag, String pagerows, String contiCd, String contiNm, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public MdmContinentVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmContinentVO[]
	 */
	public MdmContinentVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MdmContinentVO model = null;
	...
	public MdmContinentVO[] getMdmContinentVOs(){
		MdmContinentVO[] vos = (MdmContinentVO[])models.toArray(new MdmContinentVO[models.size()]);
		return vos;
	}
