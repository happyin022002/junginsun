...
*@FileName : CoaSvcTrnsPrcPfitLssVO.java
*@FileTitle : CoaSvcTrnsPrcPfitLssVO
*Open Issues :
*Change history :
...
public class CoaSvcTrnsPrcPfitLssVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaSvcTrnsPrcPfitLssVO> models = new ArrayList<CoaSvcTrnsPrcPfitLssVO>();
	 ...
	 * @param request
	 * @return CoaSvcTrnsPrcPfitLssVO[]
	 */
	public CoaSvcTrnsPrcPfitLssVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaSvcTrnsPrcPfitLssVO[]
	 */
	public CoaSvcTrnsPrcPfitLssVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaSvcTrnsPrcPfitLssVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaSvcTrnsPrcPfitLssVO();
				if (updDt[i] != null)
		...
		return getCoaSvcTrnsPrcPfitLssVOs();
	}
	 ...
	 * @return CoaSvcTrnsPrcPfitLssVO[]
	 */
	public CoaSvcTrnsPrcPfitLssVO[] getCoaSvcTrnsPrcPfitLssVOs(){
		CoaSvcTrnsPrcPfitLssVO[] vos = (CoaSvcTrnsPrcPfitLssVO[])models.toArray(new CoaSvcTrnsPrcPfitLssVO[models.size()]);
		return vos;
	}
