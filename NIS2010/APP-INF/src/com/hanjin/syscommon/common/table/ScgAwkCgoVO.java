...
*@FileName : ScgAwkCgoVO.java
*@FileTitle : ScgAwkCgoVO
*Open Issues :
*Change history :
...
public class ScgAwkCgoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgAwkCgoVO> models = new ArrayList<ScgAwkCgoVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("xtd_ovr_no", getXtdOvrNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("xtd_ovr_no", "xtdOvrNo");
	 ...
	 * @return xtdOvrNo
	 */
	public String getXtdOvrNo() {
		return this.xtdOvrNo;
	}
	 ...
	 * @param xtdOvrNo
	 */
	public void setXtdOvrNo(String xtdOvrNo) {
		this.xtdOvrNo = xtdOvrNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setXtdOvrNo(JSPUtil.getParameter(request, "xtd_ovr_no", ""));
	 ...
	 * @return ScgAwkCgoVO[]
	 */
	public ScgAwkCgoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgAwkCgoVO[]
	 */
	public ScgAwkCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgAwkCgoVO model = null;
		...
		try {
			...
			String[] xtdOvrNo = (JSPUtil.getParameter(request, prefix	+ "xtd_ovr_no", length));
			String[] ovrFwrdLen = (JSPUtil.getParameter(request, prefix	+ "ovr_fwrd_len", length));
			String[] grsWgt = (JSPUtil.getParameter(request, prefix	+ "grs_wgt", length));
			
			for (int i = 0; i < length; i++) {
				model = new ScgAwkCgoVO();
	...
	public ScgAwkCgoVO[] getScgAwkCgoVOs(){
		ScgAwkCgoVO[] vos = (ScgAwkCgoVO[])models.toArray(new ScgAwkCgoVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.xtdOvrNo = this.xtdOvrNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
