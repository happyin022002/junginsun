...
*@FileName : MdmVslSvcLaneDirVO.java
*@FileTitle : MdmVslSvcLaneDirVO
*Open Issues :
*Change history :
...
public class MdmVslSvcLaneDirVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmVslSvcLaneDirVO> models = new ArrayList<MdmVslSvcLaneDirVO>();
	...
	public MdmVslSvcLaneDirVO() {}

	public MdmVslSvcLaneDirVO(String ibflag, String pagerows, String vslSlanCd, String vslSlanDirCd, String vslSlanDirSeq, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId) {
		this.updDt = updDt;
	 ...
	 */
	public MdmVslSvcLaneDirVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmVslSvcLaneDirVO[]
	 */
	public MdmVslSvcLaneDirVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MdmVslSvcLaneDirVO model = null;
	...
	public MdmVslSvcLaneDirVO[] getMdmVslSvcLaneDirVOs(){
		MdmVslSvcLaneDirVO[] vos = (MdmVslSvcLaneDirVO[])models.toArray(new MdmVslSvcLaneDirVO[models.size()]);
		return vos;
	}
