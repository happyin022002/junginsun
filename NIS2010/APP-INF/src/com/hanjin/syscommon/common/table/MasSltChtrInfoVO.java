...
*@FileName : MasSltChtrInfoVO.java
*@FileTitle : MasSltChtrInfoVO
*Open Issues :
*Change history :
 ...
 */
public class MasSltChtrInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSltChtrInfoVO> models = new ArrayList<MasSltChtrInfoVO>();
	...
	public MasSltChtrInfoVO() {}

	public MasSltChtrInfoVO(String ibflag, String pagerows, String sltTpCd, String vopCd, String incmBzcChtrCd, String incmSubLseCd, String incmCrsChtrCd, String expnBzcChtrCd, String expnSubChtrCd, String expnCrsChtrCd, String opCreStsCd, String creSlctFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSltChtrInfoVO[]
	 */
	public MasSltChtrInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSltChtrInfoVO[]
	 */
	public MasSltChtrInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSltChtrInfoVO model = null;
	...
	public MasSltChtrInfoVO[] getMasSltChtrInfoVOs(){
		MasSltChtrInfoVO[] vos = (MasSltChtrInfoVO[])models.toArray(new MasSltChtrInfoVO[models.size()]);
		return vos;
	}
