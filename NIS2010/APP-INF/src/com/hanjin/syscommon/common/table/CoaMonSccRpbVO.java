...
*@FileName : CoaMonSccRpbVO.java
*@FileTitle : CoaMonSccRpbVO
*Open Issues :
*Change history :
...
public class CoaMonSccRpbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaMonSccRpbVO> models = new ArrayList<CoaMonSccRpbVO>();
	...
	public CoaMonSccRpbVO() {}

	public CoaMonSccRpbVO(String ibflag, String pagerows, String rpbYrmon, String bkgPorSccCd, String bkgDelSccCd, String cntrTpszCd, String bkgAvgRpbRev, String bkgOftAvgRpbRev, String bkgMiscAvgRpbRev, String scrChgAvgRpbRev, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaMonSccRpbVO[]
	 */
	public CoaMonSccRpbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaMonSccRpbVO[]
	 */
	public CoaMonSccRpbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaMonSccRpbVO model = null;
	 ...
	 * @return CoaMonSccRpbVO[]
	 */
	public CoaMonSccRpbVO[] getCoaMonSccRpbVOs(){
		CoaMonSccRpbVO[] vos = (CoaMonSccRpbVO[])models.toArray(new CoaMonSccRpbVO[models.size()]);
		return vos;
	}
