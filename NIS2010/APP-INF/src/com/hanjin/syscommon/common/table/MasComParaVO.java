...
*@FileName : MasComParaVO.java
*@FileTitle : MasComParaVO
*Open Issues :
*Change history :
 ...
 */
public class MasComParaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComParaVO> models = new ArrayList<MasComParaVO>();
	 ...
	 * @return MasComParaVO[]
	 */
	public MasComParaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComParaVO[]
	 */
	public MasComParaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComParaVO model = null;
	 ...
	 * @return MasComParaVO[]
	 */
	public MasComParaVO[] getMasComParaVOs(){
		MasComParaVO[] vos = (MasComParaVO[])models.toArray(new MasComParaVO[models.size()]);
		return vos;
	}
