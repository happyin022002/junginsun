...
*@FileName : MasLnkAvgStndCostVO.java
*@FileTitle : MasLnkAvgStndCostVO
*Open Issues :
*Change history :
...
* 1.0 Creation
* HISTORY
* 2009.09.25 임옥영 UI 개발을 위해 masCostSrcCdV, stndCostCd, mtyUcAmt 추가
=========================================================*/
 ...
 */
public class MasLnkAvgStndCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLnkAvgStndCostVO> models = new ArrayList<MasLnkAvgStndCostVO>();
	...
	/* mas_cost_src_cd_v */
	private String masCostSrcCdV = null;
	/* stnd_cost_cd */
	...
	public MasLnkAvgStndCostVO() {}

	public MasLnkAvgStndCostVO(String ibflag, String pagerows, String costYrmon, String lnkFmNodCd, String lnkToNodCd, String coCd, String cntrTpszCd, String fullMtyCd, String masCostSrcCd, String costLocGrpCd, String loclCurrCd, String stndCostUsdAmt, String lnkLoclRtAmt, String lnkUsdRtAmt, String costAssBseCd, String routTzModCd, String fmEffDt, String toEffDt, String lnkTtlQty, String lnkTtlAmt, String costVolCd, String costCalcRmk, String costFxFlg, String creUsrId, String creDt, String updUsrId, String updDt, String masCostSrcCdV, String stndCostCd, String mtyUcAmt) {
		...
		this.masCostSrcCdV = masCostSrcCdV;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mas_cost_src_cd_v", getMasCostSrcCdV());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mas_cost_src_cd_v", "masCostSrcCdV");
	...
	/**
	 * Column Info
	 * @return masCostSrcCdV
	 */
	public String getMasCostSrcCdV() {
		return masCostSrcCdV;
	}
	/**
	 * Column Info
	 * @param masCostSrcCdV
	 */
	public void setMasCostSrcCdV(String masCostSrcCdV) {
		this.masCostSrcCdV = masCostSrcCdV;
	}
	/**
	 * Column Info
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMasCostSrcCdV(JSPUtil.getParameter(request, "mas_cost_src_cd_v", ""));
	 ...
	 * @param request
	 * @return MasLnkAvgStndCostVO[]
	 */
	public MasLnkAvgStndCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLnkAvgStndCostVO[]
	 */
	public MasLnkAvgStndCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLnkAvgStndCostVO model = null;
		...
		try {
			...
			String[] masCostSrcCdV = (JSPUtil.getParameter(request, prefix	+ "mas_cost_src_cd_v", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (masCostSrcCdV[i] != null)
					model.setMasCostSrcCdV(masCostSrcCdV[i]);		
		...
		return getMasLnkAvgStndCostVOs();
	}
	 ...
	 * @return MasLnkAvgStndCostVO[]
	 */
	public MasLnkAvgStndCostVO[] getMasLnkAvgStndCostVOs(){
		MasLnkAvgStndCostVO[] vos = (MasLnkAvgStndCostVO[])models.toArray(new MasLnkAvgStndCostVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.masCostSrcCdV = this.masCostSrcCdV .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
