...
*@FileName : MasMonLaneRpbVO.java
*@FileTitle : MasMonLaneRpbVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonLaneRpbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonLaneRpbVO> models = new ArrayList<MasMonLaneRpbVO>();
	 ...
	 * @param request
	 * @return MasMonLaneRpbVO[]
	 */
	public MasMonLaneRpbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonLaneRpbVO[]
	 */
	public MasMonLaneRpbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonLaneRpbVO model = null;
	 ...
	 * @return MasMonLaneRpbVO[]
	 */
	public MasMonLaneRpbVO[] getMasMonLaneRpbVOs(){
		MasMonLaneRpbVO[] vos = (MasMonLaneRpbVO[])models.toArray(new MasMonLaneRpbVO[models.size()]);
		return vos;
	}
