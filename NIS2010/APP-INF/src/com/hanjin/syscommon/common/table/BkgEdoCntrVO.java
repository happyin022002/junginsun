...
*@FileName : BkgEdoCntrVO.java
*@FileTitle : BkgEdoCntrVO
*Open Issues :
*Change history :
...
public class BkgEdoCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgEdoCntrVO> models = new ArrayList<BkgEdoCntrVO>();
	...
	public BkgEdoCntrVO(String ibflag, String pagerows, String edoRqstNo, String edoRqstSeq, String cntrNo, String cntrTpszCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return BkgEdoCntrVO[]
	 */
	public BkgEdoCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgEdoCntrVO[]
	 */
	public BkgEdoCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgEdoCntrVO model = null;
	 ...
	 * @return BkgEdoCntrVO[]
	 */
	public BkgEdoCntrVO[] getBkgEdoCntrVOs(){
		BkgEdoCntrVO[] vos = (BkgEdoCntrVO[])models.toArray(new BkgEdoCntrVO[models.size()]);
		return vos;
	}
