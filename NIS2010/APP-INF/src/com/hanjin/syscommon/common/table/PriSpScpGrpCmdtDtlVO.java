...
*@FileName : PriSpScpGrpCmdtDtlVO.java
*@FileTitle : PriSpScpGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class PriSpScpGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGrpCmdtDtlVO> models = new ArrayList<PriSpScpGrpCmdtDtlVO>();
	...
	public PriSpScpGrpCmdtDtlVO() {}

	public PriSpScpGrpCmdtDtlVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String grpCmdtSeq, String grpCmdtDtlSeq, String prcCmdtTpCd, String prcCmdtDefCd, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.acptDt = acptDt;
	 ...
	 */
	public PriSpScpGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGrpCmdtDtlVO[]
	 */
	public PriSpScpGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGrpCmdtDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpGrpCmdtDtlVO();
				if (updDt[i] != null)
		...
		return getPriSpScpGrpCmdtDtlVOs();
	}
	...
	public PriSpScpGrpCmdtDtlVO[] getPriSpScpGrpCmdtDtlVOs(){
		PriSpScpGrpCmdtDtlVO[] vos = (PriSpScpGrpCmdtDtlVO[])models.toArray(new PriSpScpGrpCmdtDtlVO[models.size()]);
		return vos;
	}
