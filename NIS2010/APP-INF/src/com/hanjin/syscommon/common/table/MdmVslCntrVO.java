...
public class MdmVslCntrVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMadnVoySuzNetTongWgt(JSPUtil.getParameter(request, "madn_voy_suz_net_tong_wgt", ""));
		...
		setMnEngHorPwrUtCd(JSPUtil.getParameter(request, "mn_eng_hor_pwr_ut_cd", ""));
