...
*@FileName : MdmStateVO.java
*@FileTitle : MdmStateVO
*Open Issues :
*Change history :
...
public class MdmStateVO extends AbstractValueObject {
	...
	public MdmStateVO(String ibflag, String pagerows, String cntCd, String steCd, String steNm, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId) {
		this.updDt = updDt;
