...
*@FileName : PriSpScpGriRoutPntVO.java
*@FileTitle : PriSpScpGriRoutPntVO
*Open Issues :
*Change history :
...
public class PriSpScpGriRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGriRoutPntVO> models = new ArrayList<PriSpScpGriRoutPntVO>();
	 ...
	 * @param request
	 * @return PriSpScpGriRoutPntVO[]
	 */
	public PriSpScpGriRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGriRoutPntVO[]
	 */
	public PriSpScpGriRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGriRoutPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpGriRoutPntVO();
				if (updDt[i] != null)
		...
		return getPriSpScpGriRoutPntVOs();
	}
	 ...
	 * @return PriSpScpGriRoutPntVO[]
	 */
	public PriSpScpGriRoutPntVO[] getPriSpScpGriRoutPntVOs(){
		PriSpScpGriRoutPntVO[] vos = (PriSpScpGriRoutPntVO[])models.toArray(new PriSpScpGriRoutPntVO[models.size()]);
		return vos;
	}
