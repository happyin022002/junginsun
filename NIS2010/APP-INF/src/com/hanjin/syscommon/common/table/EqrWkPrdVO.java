...
*@FileName : EqrWkPrdVO.java
*@FileTitle : EqrWkPrdVO
*Open Issues :
*Change history :
...
public class EqrWkPrdVO extends AbstractValueObject {
	...
	public EqrWkPrdVO(String ibflag, String pagerows, String plnYr, String plnWk, String plnMon, String wkStDt, String wkEndDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.plnMon = plnMon;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPlnWk(JSPUtil.getParameter(request, "pln_wk", ""));
