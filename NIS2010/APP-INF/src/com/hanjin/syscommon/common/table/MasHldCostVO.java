...
*@FileName : MasHldCostVO.java
*@FileTitle : MasHldCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasHldCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasHldCostVO> models = new ArrayList<MasHldCostVO>();
	...
	public MasHldCostVO(String ibflag, String pagerows, String costYrmon, String cntrChssDivCd, String eqTpszCd, String stndCostCd, String chssHldUcAmt, String ttlHldAmt, String eqBxKnt, String eqHldDys, String chssUsaQty, String costAssBseCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return MasHldCostVO[]
	 */
	public MasHldCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasHldCostVO[]
	 */
	public MasHldCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasHldCostVO model = null;
	 ...
	 * @return MasHldCostVO[]
	 */
	public MasHldCostVO[] getMasHldCostVOs(){
		MasHldCostVO[] vos = (MasHldCostVO[])models.toArray(new MasHldCostVO[models.size()]);
		return vos;
	}
