...
*@FileName : PriPrsRoutActCostVO.java
*@FileTitle : PriPrsRoutActCostVO
*Open Issues :
*Change history :
...
public class PriPrsRoutActCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriPrsRoutActCostVO> models = new ArrayList<PriPrsRoutActCostVO>();
	 ...
	 * @param request
	 * @return PriPrsRoutActCostVO[]
	 */
	public PriPrsRoutActCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriPrsRoutActCostVO[]
	 */
	public PriPrsRoutActCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriPrsRoutActCostVO model = null;
		...
		return getPriPrsRoutActCostVOs();
	}
	 ...
	 * @return PriPrsRoutActCostVO[]
	 */
	public PriPrsRoutActCostVO[] getPriPrsRoutActCostVOs(){
		PriPrsRoutActCostVO[] vos = (PriPrsRoutActCostVO[])models.toArray(new PriPrsRoutActCostVO[models.size()]);
		return vos;
	}
