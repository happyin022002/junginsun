...
*@FileName : BsaBudSltChtrBzcVO.java
*@FileTitle : BsaBudSltChtrBzcVO
*Open Issues :
*Change history :
...
public class BsaBudSltChtrBzcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaBudSltChtrBzcVO> models = new ArrayList<BsaBudSltChtrBzcVO>();
	...
	public BsaBudSltChtrBzcVO() {}

	public BsaBudSltChtrBzcVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String dirCd, String vslSeq, String bsaSeq, String vvdCd, String bsaFmDt, String bsaToDt, String vslCd, String hjsFnlBsaCapa, String hjsBsaBfrSubCapa, String vslBsaChkFlg, String schtDesc, String vslMltInpFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("hjs_fnl_bsa_capa", getHjsFnlBsaCapa());
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setHjsFnlBsaCapa(JSPUtil.getParameter(request, prefix + "hjs_fnl_bsa_capa", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setHjsBsaBfrSubCapa(JSPUtil.getParameter(request, prefix + "hjs_bsa_bfr_sub_capa", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setVslBsaChkFlg(JSPUtil.getParameter(request, prefix + "vsl_bsa_chk_flg", ""));
		setVvdCd(JSPUtil.getParameter(request, prefix + "vvd_cd", ""));
		setSchtDesc(JSPUtil.getParameter(request, prefix + "scht_desc", ""));
		setBsaToDt(JSPUtil.getParameter(request, prefix + "bsa_to_dt", ""));
		setVslMltInpFlg(JSPUtil.getParameter(request, prefix + "vsl_mlt_inp_flg", ""));
	 ...
	 */
	public BsaBudSltChtrBzcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaBudSltChtrBzcVO[]
	 */
	public BsaBudSltChtrBzcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaBudSltChtrBzcVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				if (hjsFnlBsaCapa[i] != null)
					model.setHjsFnlBsaCapa(hjsFnlBsaCapa[i]);
				if (pagerows[i] != null)
	...
	public BsaBudSltChtrBzcVO[] getBsaBudSltChtrBzcVOs(){
		BsaBudSltChtrBzcVO[] vos = (BsaBudSltChtrBzcVO[])models.toArray(new BsaBudSltChtrBzcVO[models.size()]);
		return vos;
	}
