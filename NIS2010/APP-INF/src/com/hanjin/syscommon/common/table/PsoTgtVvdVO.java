...
public class PsoTgtVvdVO extends AbstractValueObject {
	...
	public PsoTgtVvdVO(String ibflag, String pagerows, String psoBztpCd, String vslCd, String skdVoyNo, String skdDirCd, String expnYrmon, String psoVvdActStsCd, String cnlTzBkgStsCd, String diffRmk, String vslSlanCd, String cntrVslClssCapa, String creUsrId, String creDt, String updUsrId, String updDt, String budScnrNo) {
		this.updDt = updDt;
		this.vslCd = vslCd;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCnlTzBkgStsCd(JSPUtil.getParameter(request, prefix + "cnl_tz_bkg_sts_cd", ""));
		...
		setExpnYrmon(JSPUtil.getParameter(request, prefix + "expn_yrmon", ""));
		setPsoVvdActStsCd(JSPUtil.getParameter(request, prefix + "pso_vvd_act_sts_cd", ""));
