...
*@FileName : MasLaneTsUtCostVO.java
*@FileTitle : MasLaneTsUtCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneTsUtCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneTsUtCostVO> models = new ArrayList<MasLaneTsUtCostVO>();
	...
	public MasLaneTsUtCostVO() {}

	public MasLaneTsUtCostVO(String ibflag, String pagerows, String costYr, String fmTrdCd, String fmRlaneCd, String fmIocCd, String fmSkdDirCd, String tsUcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasLaneTsUtCostVO[]
	 */
	public MasLaneTsUtCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneTsUtCostVO[]
	 */
	public MasLaneTsUtCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneTsUtCostVO model = null;
	...
	public MasLaneTsUtCostVO[] getMasLaneTsUtCostVOs(){
		MasLaneTsUtCostVO[] vos = (MasLaneTsUtCostVO[])models.toArray(new MasLaneTsUtCostVO[models.size()]);
		return vos;
	}
