...
*@FileName : MasActGrpCostMapgVO.java
*@FileTitle : MasActGrpCostMapgVO
*Open Issues :
*Change history :
 ...
 */
public class MasActGrpCostMapgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasActGrpCostMapgVO> models = new ArrayList<MasActGrpCostMapgVO>();
	...
	public MasActGrpCostMapgVO() {}

	public MasActGrpCostMapgVO(String ibflag, String pagerows, String costActGrpCd, String masCostSrcCd, String costAplyFlg, String lgsCostCdChkFlg, String actGrpTmlFlg, String lgsCostAutoCdFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasActGrpCostMapgVO[]
	 */
	public MasActGrpCostMapgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasActGrpCostMapgVO[]
	 */
	public MasActGrpCostMapgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasActGrpCostMapgVO model = null;
		...
		return getMasActGrpCostMapgVOs();
	}
	 ...
	 * @return MasActGrpCostMapgVO[]
	 */
	public MasActGrpCostMapgVO[] getMasActGrpCostMapgVOs(){
		MasActGrpCostMapgVO[] vos = (MasActGrpCostMapgVO[])models.toArray(new MasActGrpCostMapgVO[models.size()]);
		return vos;
	}
