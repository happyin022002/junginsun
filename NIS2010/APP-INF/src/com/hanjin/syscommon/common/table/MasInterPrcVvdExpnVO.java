...
*@FileName : MasInterPrcVvdExpnVO.java
*@FileTitle : MasInterPrcVvdExpnVO
*Open Issues :
*Change history :
 ...
 */
public class MasInterPrcVvdExpnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasInterPrcVvdExpnVO> models = new ArrayList<MasInterPrcVvdExpnVO>();
	...
	public MasInterPrcVvdExpnVO() {}

	public MasInterPrcVvdExpnVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String iocCd, String vslCd, String skdVoyNo, String dirCd, String stndCostCd, String interPrcUcAmt, String cntrLodQty,String cntrTeuQty, String interPrcTtlExpnAmt, String costCalcRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
		this.vslCd = vslCd;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return MasInterPrcVvdExpnVO[]
	 */
	public MasInterPrcVvdExpnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasInterPrcVvdExpnVO[]
	 */
	public MasInterPrcVvdExpnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasInterPrcVvdExpnVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasInterPrcVvdExpnVO();
				if (updDt[i] != null)
		...
		return getMasInterPrcVvdExpnVOs();
	}
	 ...
	 * @return MasInterPrcVvdExpnVO[]
	 */
	public MasInterPrcVvdExpnVO[] getMasInterPrcVvdExpnVOs(){
		MasInterPrcVvdExpnVO[] vos = (MasInterPrcVvdExpnVO[])models.toArray(new MasInterPrcVvdExpnVO[models.size()]);
		return vos;
	}
