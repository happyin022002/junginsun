...
*@FileName : TblSubmitQueueVO.java
*@FileTitle : TblSubmitQueueVO
*Open Issues :
*Change history :
...
public class TblSubmitQueueVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TblSubmitQueueVO> models = new ArrayList<TblSubmitQueueVO>();
...
/**
	 ...
	 * @param request
	 * @return TblSubmitQueueVO[]
	 */
	public TblSubmitQueueVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TblSubmitQueueVO[]
	 */
	public TblSubmitQueueVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TblSubmitQueueVO model = null;
	 ...
	 * @return TblSubmitQueueVO[]
	 */
	public TblSubmitQueueVO[] getTblSubmitQueueVOs(){
		TblSubmitQueueVO[] vos = (TblSubmitQueueVO[])models.toArray(new TblSubmitQueueVO[models.size()]);
		return vos;
	}
