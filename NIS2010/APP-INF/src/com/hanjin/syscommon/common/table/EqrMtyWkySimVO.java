...
*@FileName : EqrMtyWkySimVO.java
*@FileTitle : EqrMtyWkySimVO
*Open Issues :
*Change history :
...
public class EqrMtyWkySimVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrMtyWkySimVO> models = new ArrayList<EqrMtyWkySimVO>();
	...
	public EqrMtyWkySimVO() {}

	public EqrMtyWkySimVO(String ibflag, String pagerows, String fcastYrwk, String locGrpCd, String locCd, String wkySimTpCd, String cntrTpszCd, String cntrQty, String tmpSavFlg, String cfmFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.cfmFlg = cfmFlg;
...
/**
	 ...
	 * @param request
	 * @return EqrMtyWkySimVO[]
	 */
	public EqrMtyWkySimVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrMtyWkySimVO[]
	 */
	public EqrMtyWkySimVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrMtyWkySimVO model = null;
	 ...
	 * @return EqrMtyWkySimVO[]
	 */
	public EqrMtyWkySimVO[] getEqrMtyWkySimVOs(){
		EqrMtyWkySimVO[] vos = (EqrMtyWkySimVO[])models.toArray(new EqrMtyWkySimVO[models.size()]);
		return vos;
	}
