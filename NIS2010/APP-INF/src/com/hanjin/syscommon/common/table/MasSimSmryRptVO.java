...
*@FileName : MasSimSmryRptVO.java
*@FileTitle : MasSimSmryRptVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimSmryRptVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimSmryRptVO> models = new ArrayList<MasSimSmryRptVO>();
	...
	public MasSimSmryRptVO() {}

	public MasSimSmryRptVO(String ibflag, String pagerows, String simDt, String simNo, String sectNo, String simRptNo, String sgrpCostCd, String vslCd, String simPerfAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return MasSimSmryRptVO[]
	 */
	public MasSimSmryRptVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimSmryRptVO[]
	 */
	public MasSimSmryRptVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimSmryRptVO model = null;
	 ...
	 * @return MasSimSmryRptVO[]
	 */
	public MasSimSmryRptVO[] getMasSimSmryRptVOs(){
		MasSimSmryRptVO[] vos = (MasSimSmryRptVO[])models.toArray(new MasSimSmryRptVO[models.size()]);
		return vos;
	}
