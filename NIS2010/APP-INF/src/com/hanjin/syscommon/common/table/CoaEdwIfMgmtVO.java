...
*@FileName : CoaEdwIfMgmtVO.java
*@FileTitle : CoaEdwIfMgmtVO
*Open Issues :
*Change history :
...
public class CoaEdwIfMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaEdwIfMgmtVO> models = new ArrayList<CoaEdwIfMgmtVO>();
	...
	public CoaEdwIfMgmtVO() {}

	public CoaEdwIfMgmtVO(String ibflag, String pagerows, String cntrTpszCd, String cntrNo, String ydCd, String mvmtDt, String mvmtStsCd, String cnmvSeq, String fullMtyCd, String coCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.coCd = coCd;
	 ...
	 * @param request
	 * @return CoaEdwIfMgmtVO[]
	 */
	public CoaEdwIfMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaEdwIfMgmtVO[]
	 */
	public CoaEdwIfMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaEdwIfMgmtVO model = null;
	 ...
	 * @return CoaEdwIfMgmtVO[]
	 */
	public CoaEdwIfMgmtVO[] getCoaEdwIfMgmtVOs(){
		CoaEdwIfMgmtVO[] vos = (CoaEdwIfMgmtVO[])models.toArray(new CoaEdwIfMgmtVO[models.size()]);
		return vos;
	}
