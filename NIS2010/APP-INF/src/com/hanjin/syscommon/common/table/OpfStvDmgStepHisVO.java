...
*@FileName : OpfStvDmgStepHisVO.java
*@FileTitle : OpfStvDmgStepHisVO
*Open Issues :
*Change history :
...
public class OpfStvDmgStepHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpfStvDmgStepHisVO> models = new ArrayList<OpfStvDmgStepHisVO>();
	...
	/* Column Info */
	private String stvDmgCrntProcStsCd = null;
	/* Column Info */
	...
	public OpfStvDmgStepHisVO() {}

	public OpfStvDmgStepHisVO(String ibflag, String pagerows, String stvDmgNo, String stvDmgProcCd, String stvDmgStepHisSeq, String stvDmgCrntProcStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		...
		this.creDt = creDt;
		this.stvDmgCrntProcStsCd = stvDmgCrntProcStsCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("stv_dmg_crnt_proc_sts_cd", getStvDmgCrntProcStsCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("stv_dmg_crnt_proc_sts_cd", "stvDmgCrntProcStsCd");
	...
	/**
	 * Column Info
	 * @return stvDmgCrntProcStsCd
	 */
	public String getStvDmgCrntProcStsCd() {
		return this.stvDmgCrntProcStsCd;
	}
	...
	/**
	 * Column Info
	 * @param stvDmgCrntProcStsCd
	 */
	public void setStvDmgCrntProcStsCd(String stvDmgCrntProcStsCd) {
		this.stvDmgCrntProcStsCd = stvDmgCrntProcStsCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setStvDmgCrntProcStsCd(JSPUtil.getParameter(request, "stv_dmg_crnt_proc_sts_cd", ""));
	 ...
	 */
	public OpfStvDmgStepHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpfStvDmgStepHisVO[]
	 */
	public OpfStvDmgStepHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpfStvDmgStepHisVO model = null;
		...
		try {
			...
			String[] stvDmgCrntProcStsCd = (JSPUtil.getParameter(request, prefix	+ "stv_dmg_crnt_proc_sts_cd", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] stvDmgNo = (JSPUtil.getParameter(request, prefix	+ "stv_dmg_no", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			
			for (int i = 0; i < length; i++) {
				model = new OpfStvDmgStepHisVO();
				if (updDt[i] != null)
				...
				if (stvDmgCrntProcStsCd[i] != null)
					model.setStvDmgCrntProcStsCd(stvDmgCrntProcStsCd[i]);
				if (updUsrId[i] != null)
	...
	public OpfStvDmgStepHisVO[] getOpfStvDmgStepHisVOs(){
		OpfStvDmgStepHisVO[] vos = (OpfStvDmgStepHisVO[])models.toArray(new OpfStvDmgStepHisVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.stvDmgCrntProcStsCd = this.stvDmgCrntProcStsCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
