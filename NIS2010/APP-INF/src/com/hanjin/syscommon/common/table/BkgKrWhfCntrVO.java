...
*@FileName : BkgKrWhfCntrVO.java
*@FileTitle : BkgKrWhfCntrVO
*Open Issues :
*Change history :
...
public class BkgKrWhfCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgKrWhfCntrVO> models = new ArrayList<BkgKrWhfCntrVO>();
	...
	public BkgKrWhfCntrVO() {}

	public BkgKrWhfCntrVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String blNo, 
			String cntrNo, String cntrTpszCd, String pckTpCd, String wgtQty, String wgtUtCd, String cntrFullFlg, 
			String creUsrId, String creDt, String updUsrId, String updDt, String fm) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 */
	public BkgKrWhfCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgKrWhfCntrVO[]
	 */
	public BkgKrWhfCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgKrWhfCntrVO model = null;
	...
	public BkgKrWhfCntrVO[] getBkgKrWhfCntrVOs(){
		BkgKrWhfCntrVO[] vos = (BkgKrWhfCntrVO[])models.toArray(new BkgKrWhfCntrVO[models.size()]);
		return vos;
	}
