...
*@FileName : MasSimTmlOpDysVO.java
*@FileTitle : MasSimTmlOpDysVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimTmlOpDysVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimTmlOpDysVO> models = new ArrayList<MasSimTmlOpDysVO>();
	 ...
	 * @param request
	 * @return MasSimTmlOpDysVO[]
	 */
	public MasSimTmlOpDysVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimTmlOpDysVO[]
	 */
	public MasSimTmlOpDysVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimTmlOpDysVO model = null;
	 ...
	 * @return MasSimTmlOpDysVO[]
	 */
	public MasSimTmlOpDysVO[] getMasSimTmlOpDysVOs(){
		MasSimTmlOpDysVO[] vos = (MasSimTmlOpDysVO[])models.toArray(new MasSimTmlOpDysVO[models.size()]);
		return vos;
	}
