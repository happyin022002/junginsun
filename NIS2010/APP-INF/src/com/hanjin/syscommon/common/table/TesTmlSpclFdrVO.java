...
*@FileName : TesTmlSpclFdrVO.java
*@FileTitle : TesTmlSpclFdrVO
*Open Issues :
*Change history :
...
public class TesTmlSpclFdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesTmlSpclFdrVO> models = new ArrayList<TesTmlSpclFdrVO>();
	...
	public TesTmlSpclFdrVO() {}

	public TesTmlSpclFdrVO(String ibflag, String pagerows, String fdrPolCd, String fdrPodCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return TesTmlSpclFdrVO[]
	 */
	public TesTmlSpclFdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesTmlSpclFdrVO[]
	 */
	public TesTmlSpclFdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesTmlSpclFdrVO model = null;
	 ...
	 * @return TesTmlSpclFdrVO[]
	 */
	public TesTmlSpclFdrVO[] getTesTmlSpclFdrVOs(){
		TesTmlSpclFdrVO[] vos = (TesTmlSpclFdrVO[])models.toArray(new TesTmlSpclFdrVO[models.size()]);
		return vos;
	}
