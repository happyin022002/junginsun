...
*@FileName : BsaRfScgMstVO.java
*@FileTitle : BsaRfScgMstVO
*Open Issues :
*Change history :
...
public class BsaRfScgMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaRfScgMstVO> models = new ArrayList<BsaRfScgMstVO>();
	
	/* Column Info */
	private String updDt = null;
	/* Column Info */
	private String rfScgSltPrcSeq = null;
	/* Column Info */
	...
	public BsaRfScgMstVO() {}

	public BsaRfScgMstVO(String ibflag, String pagerows, String bsaSltCostTpCd, String rfScgSltPrcSeq, String rtTeuFlg, String trdCd, String rlaneCd, String dirCd, String vvdCd, String bsaSltPrcFmDt, String bsaSltPrcToDt, String bsaErrFlg, String deltFlg, String errLogRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.rfScgSltPrcSeq = rfScgSltPrcSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("rf_scg_slt_prc_seq", getRfScgSltPrcSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("rf_scg_slt_prc_seq", "rfScgSltPrcSeq");
	...
	/**
	 * Column Info
	 * @return rfScgSltPrcSeq
	 */
	public String getRfScgSltPrcSeq() {
		return this.rfScgSltPrcSeq;
	}
	...
	/**
	 * Column Info
	 * @param rfScgSltPrcSeq
	 */
	public void setRfScgSltPrcSeq(String rfScgSltPrcSeq) {
		this.rfScgSltPrcSeq = rfScgSltPrcSeq;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setRfScgSltPrcSeq(JSPUtil.getParameter(request, "rf_scg_slt_prc_seq", ""));
	 ...
	 * @param request
	 * @return BsaRfScgMstVO[]
	 */
	public BsaRfScgMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaRfScgMstVO[]
	 */
	public BsaRfScgMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaRfScgMstVO model = null;
		...
		try {
			...
			String[] rfScgSltPrcSeq = (JSPUtil.getParameter(request, prefix	+ "rf_scg_slt_prc_seq", length));
			...
			for (int i = 0; i < length; i++) {
				model = new BsaRfScgMstVO();
				if (updDt[i] != null)
					model.setUpdDt(updDt[i]);
				if (rfScgSltPrcSeq[i] != null)
					model.setRfScgSltPrcSeq(rfScgSltPrcSeq[i]);
				if (rtTeuFlg[i] != null)
	 ...
	 * @return BsaRfScgMstVO[]
	 */
	public BsaRfScgMstVO[] getBsaRfScgMstVOs(){
		BsaRfScgMstVO[] vos = (BsaRfScgMstVO[])models.toArray(new BsaRfScgMstVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.rfScgSltPrcSeq = this.rfScgSltPrcSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
