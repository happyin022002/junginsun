...
*@FileName : TesTmlAgmtDtlTrcVO.java
*@FileTitle : TesTmlAgmtDtlTrcVO
*Open Issues :
*Change history :
...
public class TesTmlAgmtDtlTrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesTmlAgmtDtlTrcVO> models = new ArrayList<TesTmlAgmtDtlTrcVO>();
	...
	public TesTmlAgmtDtlTrcVO() {}

	public TesTmlAgmtDtlTrcVO(String ibflag, String pagerows, String tmlAgmtOfcCtyCd, String tmlAgmtSeq, String tmlAgmtVerNo, String tmlAgmtDtlSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return TesTmlAgmtDtlTrcVO[]
	 */
	public TesTmlAgmtDtlTrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesTmlAgmtDtlTrcVO[]
	 */
	public TesTmlAgmtDtlTrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesTmlAgmtDtlTrcVO model = null;
	 ...
	 * @return TesTmlAgmtDtlTrcVO[]
	 */
	public TesTmlAgmtDtlTrcVO[] getTesTmlAgmtDtlTrcVOs(){
		TesTmlAgmtDtlTrcVO[] vos = (TesTmlAgmtDtlTrcVO[])models.toArray(new TesTmlAgmtDtlTrcVO[models.size()]);
		return vos;
	}
