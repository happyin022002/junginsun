...
*@FileName : PriRqScgAdjVO.java
*@FileTitle : PriRqScgAdjVO
*Open Issues :
*Change history :
...
public class PriRqScgAdjVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqScgAdjVO> models = new ArrayList<PriRqScgAdjVO>();
	 ...
	 */
	public PriRqScgAdjVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqScgAdjVO[]
	 */
	public PriRqScgAdjVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqScgAdjVO model = null;
	...
	public PriRqScgAdjVO[] getPriRqScgAdjVOs(){
		PriRqScgAdjVO[] vos = (PriRqScgAdjVO[])models.toArray(new PriRqScgAdjVO[models.size()]);
		return vos;
	}
