...
*@FileName : MasBkgExpnDtlVO.java
*@FileTitle : MasBkgExpnDtlVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgExpnDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgExpnDtlVO> models = new ArrayList<MasBkgExpnDtlVO>();
	...
	/* Column Info */
	private String agmtPrcCtrtCustTpCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String crrHlgSvcChgAmt = null;
	/* Column Info */
	...
	/* Column Info */
	private String ctrtBrncOfcCd = null;
	/* Column Info */
	...
	public MasBkgExpnDtlVO(String ibflag, String pagerows, String bkgNo, String cntrTpszCd, String costRoutNo, String costYrmon, String slsYrmon, String costWk, String trdCd, String subTrdCd, String rlaneCd, String iocCd, String vslCd, String skdVoyNo, String dirCd, String n1stTrdCd, String n2ndTrdCd, String n3rdTrdCd, String n4thTrdCd, String n1stRlaneCd, String n2ndRlaneCd, String n3rdRlaneCd, String n4thRlaneCd, String n1stIocContiCd, String n2ndIocContiCd, String n3rdIocContiCd, String n4thIocContiCd, String n1stFincVvdCd, String n2ndFincVvdCd, String n3rdFincVvdCd, String n4thFincVvdCd, String bkgPorCd, String bkgPolCd, String bkgPodCd, String bkgDelCd, String revPolCd, String revPodCd, String n1stPolCd, String n2ndPolCd, String n3rdPolCd, String n4thPolCd, String n1stPodCd, String n2ndPodCd, String n3rdPodCd, String n4thPodCd, String agmtSgnOfcCd, String rhqCd, String rgnOfcCd, String slsOfcCd, String ctrtHqOfcCd, String ctrtRgnOfcCd, String ctrtOfcCd, String ctrtSrepCd, String scNo, String rfaNo, String custTpCd, String blNo, String bkgRcvTermCd, String cmdtCd, String bkgDeTermCd, String bkgStsCd, String bkgCgoTpCd, String usaBkgModCd, String repCmdtCd, String spclRcFlg, String spclDgCgoFlg, String spclBbCgoFlg, String spclAwkCgoFlg, String rdFlg, String socFlg, String shprCntCd, String shprCustSeq, String shprNm, String cneeNm, String ntfyNm, String oftTpCd, String obrdDt, String cntrRcvDt, String srepCd, String revContiCd, String bkgOfcCd, String agmtCustTpCd, String agmtCntCd, String agmtCustSeq, String custKeyAgmtMgrFlg, String bkgQty, String raFcgoTzDys, String raMcgoTzDys, String bkgRev, String bkgOftRev, String bkgMiscRev, String scrChgRev, String dmdtComAmt, String sltMgmtUtComAmt, String bzcStvgComAmt, String otrCyHndlComAmt, String tsStvgComAmt, String dckCyHndlComAmt, String cgoHndlComAmt, String fcntrStoComAmt, String miscCgoHndlComAmt, String tmlComAmt, String fullRailDirComAmt, String fullRailTrkComAmt, String fullTrkDirComAmt, String fullWtrDirComAmt, String fullWtrRailComAmt, String fullWtrTrkComAmt, String fullTrspComAmt, String mtyStvgPaAmt, String mtyTrspPaAmt, String cgoVarVolDcAmt, String acComAmt, String cntrStermPaAmt, String cntrLtermPaAmt, String cntrMnrChgPaAmt, String cntrDpcPaAmt, String cntrInsurPaAmt, String chssStermPaAmt, String chssLtermPaAmt, String chssMnrChgPaAmt, String chssDpcPaAmt, String chssDrygPaAmt, String chssInsurPaAmt, String bizActPaAmt, String ownVolActAmt, String otrVolActAmt, String stpIncmAmt, String stpCostAmt, String opInterSltRntlBseAmt, String mtySimAmt, String interEqRntlBseAmt, String paCmCostTtlAmt, String paCmAmt, String paCmPreBxAmt, String raCmCostTtlAmt, String raCmAmt, String raCmPreBxAmt, String raOpCostTtlAmt, String raOpAmt, String raOpPreBxAmt, String bkgRmk, String creUsrId, String creDt, String updUsrId, String updDt, String spclCntrTpszCd, String bkgCgoWgt, String bzcSpclFlg, String bkgWgtTpCd, String chssFxAmt, String cneeCntCd, String cntrFxAmt, String cneeCustSeq, String ntfyCntCd, String ntfyCustSeq, String scRfaHldCntCd, String scRfaHldCustSeq, String blNoTp, String blNoChk, String slanCd, String deltFlg, String actOfcCd, String autoRatDt, String bkgDelYdCd, String bkgPorYdCd, String cltOfcCd, String fincDirCd, String n1stPolPodDys, String n2ndPolPodDys, String n3rdPolPodDys, String n4thPolPodDys, String taaNo, String ppdOfcCd, String revDirCd, String vopCd, String wrkVvdCd, String agmtPrcCtrtCustTpCd, String rtBlTpCd, String ownFdrAmt, String trnkPolCd, String trnkPodCd, String agmtActCntCd, String agmtActCustSeq, String actCustNm, String ctrtBrncOfcCd, String custGrpId, String custGrpNm, String crrHlgSvcChgAmt, String usaDmstSavCrAmt) {
		...
		this.agmtPrcCtrtCustTpCd = agmtPrcCtrtCustTpCd;
		...
		this.crrHlgSvcChgAmt = crrHlgSvcChgAmt;
		...
		this.ctrtBrncOfcCd = ctrtBrncOfcCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("agmt_prc_ctrt_cust_tp_cd", getAgmtPrcCtrtCustTpCd());
		...
		this.hashColumns.put("crr_hlg_svc_chg_amt", getCrrHlgSvcChgAmt());
		...
		this.hashColumns.put("ctrt_brnc_ofc_cd", getCtrtBrncOfcCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("agmt_prc_ctrt_cust_tp_cd", "agmtPrcCtrtCustTpCd");
		...
		this.hashFields.put("crr_hlg_svc_chg_amt", "crrHlgSvcChgAmt");
		...
		this.hashFields.put("ctrt_brnc_ofc_cd", "ctrtBrncOfcCd");
	...
	/**
	 * Column Info
	 * @return agmtPrcCtrtCustTpCd
	 */
	public String getAgmtPrcCtrtCustTpCd() {
		return this.agmtPrcCtrtCustTpCd;
	}
	...
	/**
	 * Column Info
	 * @return crrHlgSvcChgAmt
	 */
	public String getCrrHlgSvcChgAmt() {
		return this.crrHlgSvcChgAmt;
	}
	...
	/**
	 * Column Info
	 * @return ctrtBrncOfcCd
	 */
	public String getCtrtBrncOfcCd() {
		return this.ctrtBrncOfcCd;
	}
	...
	/**
	 * Column Info
	 * @param agmtPrcCtrtCustTpCd
	 */
	public void setAgmtPrcCtrtCustTpCd(String agmtPrcCtrtCustTpCd) {
		this.agmtPrcCtrtCustTpCd = agmtPrcCtrtCustTpCd;
	}
	...
	/**
	 * Column Info
	 * @param crrHlgSvcChgAmt
	 */
	public void setCrrHlgSvcChgAmt(String crrHlgSvcChgAmt) {
		this.crrHlgSvcChgAmt = crrHlgSvcChgAmt;
	}
	 ...
	 * @param ctrtBrncOfcCd
	 */
	public void setCtrtBrncOfcCd(String ctrtBrncOfcCd) {
		this.ctrtBrncOfcCd = ctrtBrncOfcCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setCostRoutNo(JSPUtil.getParameter(request, prefix + "cost_rout_no", ""));
		...
		setScRfaHldCustSeq(JSPUtil.getParameter(request, prefix + "sc_rfa_hld_cust_seq", ""));
		...
		setActOfcCd(JSPUtil.getParameter(request, prefix + "act_ofc_cd", ""));
		setOwnVolActAmt(JSPUtil.getParameter(request, prefix + "own_vol_act_amt", ""));
		setCneeCntCd(JSPUtil.getParameter(request, prefix + "cnee_cnt_cd", ""));
		setFullTrkDirComAmt(JSPUtil.getParameter(request, prefix + "full_trk_dir_com_amt", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setCtrtHqOfcCd(JSPUtil.getParameter(request, prefix + "ctrt_hq_ofc_cd", ""));
		setN2ndTrdCd(JSPUtil.getParameter(request, prefix + "n2nd_trd_cd", ""));
		setBkgPodCd(JSPUtil.getParameter(request, prefix + "bkg_pod_cd", ""));
		setTmlComAmt(JSPUtil.getParameter(request, prefix + "tml_com_amt", ""));
		setCustGrpNm(JSPUtil.getParameter(request, prefix + "cust_grp_nm", ""));
		setCtrtOfcCd(JSPUtil.getParameter(request, prefix + "ctrt_ofc_cd", ""));
		setRaCmCostTtlAmt(JSPUtil.getParameter(request, prefix + "ra_cm_cost_ttl_amt", ""));
		...
		setOpInterSltRntlBseAmt(JSPUtil.getParameter(request, prefix + "op_inter_slt_rntl_bse_amt", ""));
		setFullWtrRailComAmt(JSPUtil.getParameter(request, prefix + "full_wtr_rail_com_amt", ""));
		setUpdUsrId(JSPUtil.getParameter(request, prefix + "upd_usr_id", ""));
		setBkgOfcCd(JSPUtil.getParameter(request, prefix + "bkg_ofc_cd", ""));
		setRhqCd(JSPUtil.getParameter(request, prefix + "rhq_cd", ""));
		setBkgMiscRev(JSPUtil.getParameter(request, prefix + "bkg_misc_rev", ""));
		setAgmtActCustSeq(JSPUtil.getParameter(request, prefix + "agmt_act_cust_seq", ""));
		setFullWtrTrkComAmt(JSPUtil.getParameter(request, prefix + "full_wtr_trk_com_amt", ""));
		...
		setFullWtrDirComAmt(JSPUtil.getParameter(request, prefix + "full_wtr_dir_com_amt", ""));
		setPpdOfcCd(JSPUtil.getParameter(request, prefix + "ppd_ofc_cd", ""));
		setBkgCgoWgt(JSPUtil.getParameter(request, prefix + "bkg_cgo_wgt", ""));
		setBkgWgtTpCd(JSPUtil.getParameter(request, prefix + "bkg_wgt_tp_cd", ""));
		setPaCmCostTtlAmt(JSPUtil.getParameter(request, prefix + "pa_cm_cost_ttl_amt", ""));
		...
		setCntrDpcPaAmt(JSPUtil.getParameter(request, prefix + "cntr_dpc_pa_amt", ""));
		setN2ndIocContiCd(JSPUtil.getParameter(request, prefix + "n2nd_ioc_conti_cd", ""));
		...
		setN1stPolPodDys(JSPUtil.getParameter(request, prefix + "n1st_pol_pod_dys", ""));
		setChssInsurPaAmt(JSPUtil.getParameter(request, prefix + "chss_insur_pa_amt", ""));
		setAgmtPrcCtrtCustTpCd(JSPUtil.getParameter(request, prefix + "agmt_prc_ctrt_cust_tp_cd", ""));
		setCntrRcvDt(JSPUtil.getParameter(request, prefix + "cntr_rcv_dt", ""));
		setN2ndPolPodDys(JSPUtil.getParameter(request, prefix + "n2nd_pol_pod_dys", ""));
		setMtyStvgPaAmt(JSPUtil.getParameter(request, prefix + "mty_stvg_pa_amt", ""));
		setChssDpcPaAmt(JSPUtil.getParameter(request, prefix + "chss_dpc_pa_amt", ""));
		setScrChgRev(JSPUtil.getParameter(request, prefix + "scr_chg_rev", ""));
		setDeltFlg(JSPUtil.getParameter(request, prefix + "delt_flg", ""));
		setN3rdIocContiCd(JSPUtil.getParameter(request, prefix + "n3rd_ioc_conti_cd", ""));
		setOtrCyHndlComAmt(JSPUtil.getParameter(request, prefix + "otr_cy_hndl_com_amt", ""));
		...
		setRaOpPreBxAmt(JSPUtil.getParameter(request, prefix + "ra_op_pre_bx_amt", ""));
		setMiscCgoHndlComAmt(JSPUtil.getParameter(request, prefix + "misc_cgo_hndl_com_amt", ""));
		setN4thIocContiCd(JSPUtil.getParameter(request, prefix + "n4th_ioc_conti_cd", ""));
		...
		setFincDirCd(JSPUtil.getParameter(request, prefix + "finc_dir_cd", ""));
		setRevPodCd(JSPUtil.getParameter(request, prefix + "rev_pod_cd", ""));
		setDirCd(JSPUtil.getParameter(request, prefix + "dir_cd", ""));
		setWrkVvdCd(JSPUtil.getParameter(request, prefix + "wrk_vvd_cd", ""));
		...
		setChssStermPaAmt(JSPUtil.getParameter(request, prefix + "chss_sterm_pa_amt", ""));
		setInterEqRntlBseAmt(JSPUtil.getParameter(request, prefix + "inter_eq_rntl_bse_amt", ""));
		setCgoVarVolDcAmt(JSPUtil.getParameter(request, prefix + "cgo_var_vol_dc_amt", ""));
		setN1stFincVvdCd(JSPUtil.getParameter(request, prefix + "n1st_finc_vvd_cd", ""));
		setFullRailDirComAmt(JSPUtil.getParameter(request, prefix + "full_rail_dir_com_amt", ""));
		setCntrInsurPaAmt(JSPUtil.getParameter(request, prefix + "cntr_insur_pa_amt", ""));
		setTsStvgComAmt(JSPUtil.getParameter(request, prefix + "ts_stvg_com_amt", ""));
		setAgmtCustTpCd(JSPUtil.getParameter(request, prefix + "agmt_cust_tp_cd", ""));
		setBizActPaAmt(JSPUtil.getParameter(request, prefix + "biz_act_pa_amt", ""));
		setN4thPolCd(JSPUtil.getParameter(request, prefix + "n4th_pol_cd", ""));
		setNtfyNm(JSPUtil.getParameter(request, prefix + "ntfy_nm", ""));
		setRaMcgoTzDys(JSPUtil.getParameter(request, prefix + "ra_mcgo_tz_dys", ""));
		setAutoRatDt(JSPUtil.getParameter(request, prefix + "auto_rat_dt", ""));
		...
		setBkgOftRev(JSPUtil.getParameter(request, prefix + "bkg_oft_rev", ""));
		...
		setRaOpCostTtlAmt(JSPUtil.getParameter(request, prefix + "ra_op_cost_ttl_amt", ""));
		setVslCd(JSPUtil.getParameter(request, prefix + "vsl_cd", ""));
		setN3rdFincVvdCd(JSPUtil.getParameter(request, prefix + "n3rd_finc_vvd_cd", ""));
		setBkgRmk(JSPUtil.getParameter(request, prefix + "bkg_rmk", ""));
		setN1stPolCd(JSPUtil.getParameter(request, prefix + "n1st_pol_cd", ""));
		setTrnkPodCd(JSPUtil.getParameter(request, prefix + "trnk_pod_cd", ""));
		setChssMnrChgPaAmt(JSPUtil.getParameter(request, prefix + "chss_mnr_chg_pa_amt", ""));
		setTrdCd(JSPUtil.getParameter(request, prefix + "trd_cd", ""));
		setRlaneCd(JSPUtil.getParameter(request, prefix + "rlane_cd", ""));
		setFullTrspComAmt(JSPUtil.getParameter(request, prefix + "full_trsp_com_amt", ""));
		...
		setChssLtermPaAmt(JSPUtil.getParameter(request, prefix + "chss_lterm_pa_amt", ""));
		setN4thTrdCd(JSPUtil.getParameter(request, prefix + "n4th_trd_cd", ""));
		setScNo(JSPUtil.getParameter(request, prefix + "sc_no", ""));
		setBlNoTp(JSPUtil.getParameter(request, prefix + "bl_no_tp", ""));
		setN1stTrdCd(JSPUtil.getParameter(request, prefix + "n1st_trd_cd", ""));
		...
		setChssFxAmt(JSPUtil.getParameter(request, prefix + "chss_fx_amt", ""));
		setStpIncmAmt(JSPUtil.getParameter(request, prefix + "stp_incm_amt", ""));
		setCntrMnrChgPaAmt(JSPUtil.getParameter(request, prefix + "cntr_mnr_chg_pa_amt", ""));
		setN4thPolPodDys(JSPUtil.getParameter(request, prefix + "n4th_pol_pod_dys", ""));
		setChssDrygPaAmt(JSPUtil.getParameter(request, prefix + "chss_dryg_pa_amt", ""));
		setOtrVolActAmt(JSPUtil.getParameter(request, prefix + "otr_vol_act_amt", ""));
		setTrnkPolCd(JSPUtil.getParameter(request, prefix + "trnk_pol_cd", ""));
		setAcComAmt(JSPUtil.getParameter(request, prefix + "ac_com_amt", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setDmdtComAmt(JSPUtil.getParameter(request, prefix + "dmdt_com_amt", ""));
		setCntrLtermPaAmt(JSPUtil.getParameter(request, prefix + "cntr_lterm_pa_amt", ""));
		setCrrHlgSvcChgAmt(JSPUtil.getParameter(request, prefix + "crr_hlg_svc_chg_amt", ""));
		setCntrFxAmt(JSPUtil.getParameter(request, prefix + "cntr_fx_amt", ""));
		setRaCmPreBxAmt(JSPUtil.getParameter(request, prefix + "ra_cm_pre_bx_amt", ""));
		setCustKeyAgmtMgrFlg(JSPUtil.getParameter(request, prefix + "cust_key_agmt_mgr_flg", ""));
		setSubTrdCd(JSPUtil.getParameter(request, prefix + "sub_trd_cd", ""));
		setBzcStvgComAmt(JSPUtil.getParameter(request, prefix + "bzc_stvg_com_amt", ""));
		setScRfaHldCntCd(JSPUtil.getParameter(request, prefix + "sc_rfa_hld_cnt_cd", ""));
		setDckCyHndlComAmt(JSPUtil.getParameter(request, prefix + "dck_cy_hndl_com_amt", ""));
		setCgoHndlComAmt(JSPUtil.getParameter(request, prefix + "cgo_hndl_com_amt", ""));
		setAgmtSgnOfcCd(JSPUtil.getParameter(request, prefix + "agmt_sgn_ofc_cd", ""));
		...
		setFullRailTrkComAmt(JSPUtil.getParameter(request, prefix + "full_rail_trk_com_amt", ""));
		setN4thFincVvdCd(JSPUtil.getParameter(request, prefix + "n4th_finc_vvd_cd", ""));
		setUsaDmstSavCrAmt(JSPUtil.getParameter(request, prefix + "usa_dmst_sav_cr_amt", ""));
		setCtrtBrncOfcCd(JSPUtil.getParameter(request, prefix + "ctrt_brnc_ofc_cd", ""));
		setStpCostAmt(JSPUtil.getParameter(request, prefix + "stp_cost_amt", ""));
		...
		setRevContiCd(JSPUtil.getParameter(request, prefix + "rev_conti_cd", ""));
		setN3rdPolPodDys(JSPUtil.getParameter(request, prefix + "n3rd_pol_pod_dys", ""));
		setN3rdTrdCd(JSPUtil.getParameter(request, prefix + "n3rd_trd_cd", ""));
		setShprNm(JSPUtil.getParameter(request, prefix + "shpr_nm", ""));
		setCustTpCd(JSPUtil.getParameter(request, prefix + "cust_tp_cd", ""));
		setCntrStermPaAmt(JSPUtil.getParameter(request, prefix + "cntr_sterm_pa_amt", ""));
		setMtySimAmt(JSPUtil.getParameter(request, prefix + "mty_sim_amt", ""));
		setUpdDt(JSPUtil.getParameter(request, prefix + "upd_dt", ""));
		setIocCd(JSPUtil.getParameter(request, prefix + "ioc_cd", ""));
		setBkgPolCd(JSPUtil.getParameter(request, prefix + "bkg_pol_cd", ""));
		setSltMgmtUtComAmt(JSPUtil.getParameter(request, prefix + "slt_mgmt_ut_com_amt", ""));
		setFcntrStoComAmt(JSPUtil.getParameter(request, prefix + "fcntr_sto_com_amt", ""));
		setRaFcgoTzDys(JSPUtil.getParameter(request, prefix + "ra_fcgo_tz_dys", ""));
		setCtrtRgnOfcCd(JSPUtil.getParameter(request, prefix + "ctrt_rgn_ofc_cd", ""));
		setRaOpAmt(JSPUtil.getParameter(request, prefix + "ra_op_amt", ""));
		setMtyTrspPaAmt(JSPUtil.getParameter(request, prefix + "mty_trsp_pa_amt", ""));
		setN1stIocContiCd(JSPUtil.getParameter(request, prefix + "n1st_ioc_conti_cd", ""));
		setObrdDt(JSPUtil.getParameter(request, prefix + "obrd_dt", ""));
		setSocFlg(JSPUtil.getParameter(request, prefix + "soc_flg", ""));
		setOftTpCd(JSPUtil.getParameter(request, prefix + "oft_tp_cd", ""));
		setActCustNm(JSPUtil.getParameter(request, prefix + "act_cust_nm", ""));
		setPaCmPreBxAmt(JSPUtil.getParameter(request, prefix + "pa_cm_pre_bx_amt", ""));
		setBkgPorYdCd(JSPUtil.getParameter(request, prefix + "bkg_por_yd_cd", ""));
		setN2ndFincVvdCd(JSPUtil.getParameter(request, prefix + "n2nd_finc_vvd_cd", ""));
		...
		setBzcSpclFlg(JSPUtil.getParameter(request, prefix + "bzc_spcl_flg", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return MasBkgExpnDtlVO[]
	 */
	public MasBkgExpnDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgExpnDtlVO[]
	 */
	public MasBkgExpnDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgExpnDtlVO model = null;
		...
		try {
			...
			String[] agmtPrcCtrtCustTpCd = (JSPUtil.getParameter(request, prefix	+ "agmt_prc_ctrt_cust_tp_cd", length));
			...
			String[] crrHlgSvcChgAmt = (JSPUtil.getParameter(request, prefix	+ "crr_hlg_svc_chg_amt", length));
			...
			String[] ctrtBrncOfcCd = (JSPUtil.getParameter(request, prefix	+ "ctrt_brnc_ofc_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (agmtPrcCtrtCustTpCd[i] != null)
					model.setAgmtPrcCtrtCustTpCd(agmtPrcCtrtCustTpCd[i]);
				if (cntrRcvDt[i] != null)
				...
				if (crrHlgSvcChgAmt[i] != null)
					model.setCrrHlgSvcChgAmt(crrHlgSvcChgAmt[i]);
				if (cntrFxAmt[i] != null)
				...
				if (ctrtBrncOfcCd[i] != null)
					model.setCtrtBrncOfcCd(ctrtBrncOfcCd[i]);
	 ...
	 * @return MasBkgExpnDtlVO[]
	 */
	public MasBkgExpnDtlVO[] getMasBkgExpnDtlVOs(){
		MasBkgExpnDtlVO[] vos = (MasBkgExpnDtlVO[])models.toArray(new MasBkgExpnDtlVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.agmtPrcCtrtCustTpCd = this.agmtPrcCtrtCustTpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.crrHlgSvcChgAmt = this.crrHlgSvcChgAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ctrtBrncOfcCd = this.ctrtBrncOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
