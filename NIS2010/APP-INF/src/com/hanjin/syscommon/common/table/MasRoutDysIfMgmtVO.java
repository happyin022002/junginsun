...
*@FileName : MasRoutDysIfMgmtVO.java
*@FileTitle : MasRoutDysIfMgmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasRoutDysIfMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRoutDysIfMgmtVO> models = new ArrayList<MasRoutDysIfMgmtVO>();
	...
	public MasRoutDysIfMgmtVO() {}

	public MasRoutDysIfMgmtVO(String ibflag, String pagerows, String costYr, String costLocGrpCd, String cntrTpszCd, String orgLocCd, String destLocCd, String eqDys, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasRoutDysIfMgmtVO[]
	 */
	public MasRoutDysIfMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRoutDysIfMgmtVO[]
	 */
	public MasRoutDysIfMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRoutDysIfMgmtVO model = null;
	 ...
	 * @return MasRoutDysIfMgmtVO[]
	 */
	public MasRoutDysIfMgmtVO[] getMasRoutDysIfMgmtVOs(){
		MasRoutDysIfMgmtVO[] vos = (MasRoutDysIfMgmtVO[])models.toArray(new MasRoutDysIfMgmtVO[models.size()]);
		return vos;
	}
