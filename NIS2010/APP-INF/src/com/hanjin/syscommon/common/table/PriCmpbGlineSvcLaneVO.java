...
*@FileName : PriCmpbGlineSvcLaneVO.java
*@FileTitle : PriCmpbGlineSvcLaneVO
*Open Issues :
*Change history :
...
public class PriCmpbGlineSvcLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGlineSvcLaneVO> models = new ArrayList<PriCmpbGlineSvcLaneVO>();
	...
	public PriCmpbGlineSvcLaneVO() {}

	public PriCmpbGlineSvcLaneVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq, String vslSlanCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.bseSeq = bseSeq;
	 ...
	 */
	public PriCmpbGlineSvcLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGlineSvcLaneVO[]
	 */
	public PriCmpbGlineSvcLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGlineSvcLaneVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriCmpbGlineSvcLaneVO();
				if (updDt[i] != null)
		...
		return getPriCmpbGlineSvcLaneVOs();
	}
	...
	public PriCmpbGlineSvcLaneVO[] getPriCmpbGlineSvcLaneVOs(){
		PriCmpbGlineSvcLaneVO[] vos = (PriCmpbGlineSvcLaneVO[])models.toArray(new PriCmpbGlineSvcLaneVO[models.size()]);
		return vos;
	}
