...
*@FileName : MasMtyEccCntrSmryVO.java
*@FileTitle : MasMtyEccCntrSmryVO
*Open Issues :
*Change history :
 ...
 */
public class MasMtyEccCntrSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMtyEccCntrSmryVO> models = new ArrayList<MasMtyEccCntrSmryVO>();
	 ...
	 * @param request
	 * @return MasMtyEccCntrSmryVO[]
	 */
	public MasMtyEccCntrSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMtyEccCntrSmryVO[]
	 */
	public MasMtyEccCntrSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMtyEccCntrSmryVO model = null;
		...
		return getMasMtyEccCntrSmryVOs();
	}
	 ...
	 * @return MasMtyEccCntrSmryVO[]
	 */
	public MasMtyEccCntrSmryVO[] getMasMtyEccCntrSmryVOs(){
		MasMtyEccCntrSmryVO[] vos = (MasMtyEccCntrSmryVO[])models.toArray(new MasMtyEccCntrSmryVO[models.size()]);
		return vos;
	}
