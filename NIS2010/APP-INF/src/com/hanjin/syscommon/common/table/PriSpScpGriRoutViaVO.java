...
*@FileName : PriSpScpGriRoutViaVO.java
*@FileTitle : PriSpScpGriRoutViaVO
*Open Issues :
*Change history :
...
public class PriSpScpGriRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGriRoutViaVO> models = new ArrayList<PriSpScpGriRoutViaVO>();
	...
	public PriSpScpGriRoutViaVO() {}

	public PriSpScpGriRoutViaVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String orgDestTpCd, String griRoutViaSeq, String routViaPortTpCd, String routViaPortDefCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriSpScpGriRoutViaVO[]
	 */
	public PriSpScpGriRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGriRoutViaVO[]
	 */
	public PriSpScpGriRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGriRoutViaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpGriRoutViaVO();
				if (updDt[i] != null)
		...
		return getPriSpScpGriRoutViaVOs();
	}
	 ...
	 * @return PriSpScpGriRoutViaVO[]
	 */
	public PriSpScpGriRoutViaVO[] getPriSpScpGriRoutViaVOs(){
		PriSpScpGriRoutViaVO[] vos = (PriSpScpGriRoutViaVO[])models.toArray(new PriSpScpGriRoutViaVO[models.size()]);
		return vos;
	}
