...
*@FileName : InvEdiIntgCdVO.java
*@FileTitle : InvEdiIntgCdVO
*Open Issues :
*Change history :
...
public class InvEdiIntgCdVO extends AbstractValueObject {
 
	private static final long serialVersionUID = 1L;
	
	private Collection<InvEdiIntgCdVO> models = new ArrayList<InvEdiIntgCdVO>();
	...
	public InvEdiIntgCdVO() {}

	public InvEdiIntgCdVO(String ibflag, String pagerows, String intgCdId, String intgCdNm, String intgCdDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public InvEdiIntgCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return InvEdiIntgCdVO[]
	 */
	public InvEdiIntgCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvEdiIntgCdVO model = null;
	 ...
	 * @return InvEdiIntgCdVO[]
	 */
	public InvEdiIntgCdVO[] getInvEdiIntgCdVOs(){
		InvEdiIntgCdVO[] vos = (InvEdiIntgCdVO[])models.toArray(new InvEdiIntgCdVO[models.size()]);
		return vos;
	}
