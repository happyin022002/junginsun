...
*@FileName : PriRpScpGrpLocDtlVO.java
*@FileTitle : PriRpScpGrpLocDtlVO
*Open Issues :
*Change history :
...
public class PriRpScpGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpGrpLocDtlVO> models = new ArrayList<PriRpScpGrpLocDtlVO>();
	...
	public PriRpScpGrpLocDtlVO() {}

	public PriRpScpGrpLocDtlVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String grpLocSeq, String grpLocDtlSeq, String locCd, String prcProgStsCd, String srcInfoCd, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt, String n1stCmncAmdtSeq) {
		this.updDt = updDt;
		this.acptDt = acptDt;
	 ...
	 */
	public PriRpScpGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpGrpLocDtlVO[]
	 */
	public PriRpScpGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpGrpLocDtlVO model = null;
		...
		return getPriRpScpGrpLocDtlVOs();
	}
	...
	public PriRpScpGrpLocDtlVO[] getPriRpScpGrpLocDtlVOs(){
		PriRpScpGrpLocDtlVO[] vos = (PriRpScpGrpLocDtlVO[])models.toArray(new PriRpScpGrpLocDtlVO[models.size()]);
		return vos;
	}
