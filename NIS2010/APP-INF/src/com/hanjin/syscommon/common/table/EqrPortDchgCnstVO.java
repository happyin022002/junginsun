...
*@FileName : EqrPortDchgCnstVO.java
*@FileTitle : EqrPortDchgCnstVO
*Open Issues :
*Change history :
...
public class EqrPortDchgCnstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrPortDchgCnstVO> models = new ArrayList<EqrPortDchgCnstVO>();
	...
	public EqrPortDchgCnstVO() {}

	public EqrPortDchgCnstVO(String ibflag, String pagerows, String vslLaneCd, String vslLocCd, String cnstCntrTpszCd, String cntrVolQty, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public EqrPortDchgCnstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrPortDchgCnstVO[]
	 */
	public EqrPortDchgCnstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrPortDchgCnstVO model = null;
	 ...
	 * @return EqrPortDchgCnstVO[]
	 */
	public EqrPortDchgCnstVO[] fromRequestGridArrayList(HttpServletRequest request, String prefix) {
		EqrPortDchgCnstVO model = null;
		...
		try {
			for (int k=0 ; k < arrPrefix.length ; k++){
				...
				String[] vslLaneCd 		= (JSPUtil.getParameter(request, "lane",			length));
				...
				String[] vslLocCd		= (JSPUtil.getParameter(request, "pod",	length));
				...
				String cnstCntrTpszCd	= arrPrefix[k].toString();
				String[] cntrVolQty		= (JSPUtil.getParameter(request, cnstCntrTpszCd.toLowerCase() + "_qty", length));
				...
				for (int i = 0; i < length; i++) {
					...
					if (ibflag[i] != null)
						model.setIbflag(ibflag[i]);
					if (cnstCntrTpszCd != null)
						model.setCnstCntrTpszCd(cnstCntrTpszCd);
					if (creDt[i] != null)
						model.setCreDt(creDt[i]);
					if (cntrVolQty[i] != null)
						model.setCntrVolQty(cntrVolQty[i]);
	...
	public EqrPortDchgCnstVO[] getEqrPortDchgCnstVOs(){
		EqrPortDchgCnstVO[] vos = (EqrPortDchgCnstVO[])models.toArray(new EqrPortDchgCnstVO[models.size()]);
		return vos;
	}
