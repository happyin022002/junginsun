...
*@FileName : PriRqGrpCmdtVO.java
*@FileTitle : PriRqGrpCmdtVO
*Open Issues :
*Change history :
...
public class PriRqGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqGrpCmdtVO> models = new ArrayList<PriRqGrpCmdtVO>();
	...
	public PriRqGrpCmdtVO() {}

	public PriRqGrpCmdtVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqGrpCmdtVO[]
	 */
	public PriRqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqGrpCmdtVO model = null;
	...
	public PriRqGrpCmdtVO[] getPriRqGrpCmdtVOs(){
		PriRqGrpCmdtVO[] vos = (PriRqGrpCmdtVO[])models.toArray(new PriRqGrpCmdtVO[models.size()]);
		return vos;
	}
