...
*@FileName : PriRpScpNoteCtntVO.java
*@FileTitle : PriRpScpNoteCtntVO
*Open Issues :
*Change history :
...
public class PriRpScpNoteCtntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpNoteCtntVO> models = new ArrayList<PriRpScpNoteCtntVO>();
	 ...
	 */
	public PriRpScpNoteCtntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpNoteCtntVO[]
	 */
	public PriRpScpNoteCtntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpNoteCtntVO model = null;
	...
	public PriRpScpNoteCtntVO[] getPriRpScpNoteCtntVOs(){
		PriRpScpNoteCtntVO[] vos = (PriRpScpNoteCtntVO[])models.toArray(new PriRpScpNoteCtntVO[models.size()]);
		return vos;
	}
