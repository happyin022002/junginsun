...
*@FileName : MasComSvcTrnsPrcBkupVO.java
*@FileTitle : MasComSvcTrnsPrcBkupVO
*Open Issues :
*Change history :
 ...
 */
public class MasComSvcTrnsPrcBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComSvcTrnsPrcBkupVO> models = new ArrayList<MasComSvcTrnsPrcBkupVO>();
	...
	public MasComSvcTrnsPrcBkupVO() {}

	public MasComSvcTrnsPrcBkupVO(String ibflag, String pagerows, String pctlNo, String masCostSrcCd, String comRoutSeq, String locCd, String condOfcCd, String divMeasCd, String ofcClssCd, String slsActCd, String raAcctCd, String stndCostCd, String costAssBseCd, String svcTrnsPrcAmt, String bkgKnt, String cntrBxKnt, String cntrTeuQty, String vslDys, String comFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasComSvcTrnsPrcBkupVO[]
	 */
	public MasComSvcTrnsPrcBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComSvcTrnsPrcBkupVO[]
	 */
	public MasComSvcTrnsPrcBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComSvcTrnsPrcBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasComSvcTrnsPrcBkupVO();
				if (updDt[i] != null)
		...
		return getMasComSvcTrnsPrcBkupVOs();
	}
	 ...
	 * @return MasComSvcTrnsPrcBkupVO[]
	 */
	public MasComSvcTrnsPrcBkupVO[] getMasComSvcTrnsPrcBkupVOs(){
		MasComSvcTrnsPrcBkupVO[] vos = (MasComSvcTrnsPrcBkupVO[])models.toArray(new MasComSvcTrnsPrcBkupVO[models.size()]);
		return vos;
	}
