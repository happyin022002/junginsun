...
*@FileName : MasLaneRgstVO.java
*@FileTitle : MasLaneRgstVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneRgstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneRgstVO> models = new ArrayList<MasLaneRgstVO>();
	 ...
	 */
	public MasLaneRgstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneRgstVO[]
	 */
	public MasLaneRgstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneRgstVO model = null;
	...
	public MasLaneRgstVO[] getMasLaneRgstVOs(){
		MasLaneRgstVO[] vos = (MasLaneRgstVO[])models.toArray(new MasLaneRgstVO[models.size()]);
		return vos;
	}
