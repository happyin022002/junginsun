...
*@FileName : PriSpScpNoteCtntVO.java
*@FileTitle : PriSpScpNoteCtntVO
*Open Issues :
*Change history :
...
public class PriSpScpNoteCtntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpNoteCtntVO> models = new ArrayList<PriSpScpNoteCtntVO>();
	...
	public PriSpScpNoteCtntVO() {}

	public PriSpScpNoteCtntVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String noteTpCd, String noteSeq, String noteCtntSeq, String chgCd, String noteCtnt, String noteConvFlg, String dpSeq, String noteConvMapgId, String noteChgTpCd, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.dpSeq = dpSeq;
	 ...
	 */
	public PriSpScpNoteCtntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpNoteCtntVO[]
	 */
	public PriSpScpNoteCtntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpNoteCtntVO model = null;
	...
	public PriSpScpNoteCtntVO[] getPriSpScpNoteCtntVOs(){
		PriSpScpNoteCtntVO[] vos = (PriSpScpNoteCtntVO[])models.toArray(new PriSpScpNoteCtntVO[models.size()]);
		return vos;
	}
