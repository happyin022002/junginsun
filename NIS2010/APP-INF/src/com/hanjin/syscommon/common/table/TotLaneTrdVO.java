...
*@FileName : TotLaneTrdVO.java
*@FileTitle : TotLaneTrdVO
*Open Issues :
*Change history :
...
public class TotLaneTrdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TotLaneTrdVO> models = new ArrayList<TotLaneTrdVO>();
	...
	public TotLaneTrdVO(String ibflag, String pagerows, String stlYrmon, String vslSlanCd, String laneSeq, String trdCd, String creDt, String creUsrId, String updDt, String updUsrId) {
		this.updDt = updDt;
	 ...
	 * @return TotLaneTrdVO[]
	 */
	public TotLaneTrdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TotLaneTrdVO[]
	 */
	public TotLaneTrdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TotLaneTrdVO model = null;
	...
	public TotLaneTrdVO[] getTotLaneTrdVOs(){
		TotLaneTrdVO[] vos = (TotLaneTrdVO[])models.toArray(new TotLaneTrdVO[models.size()]);
		return vos;
	}
