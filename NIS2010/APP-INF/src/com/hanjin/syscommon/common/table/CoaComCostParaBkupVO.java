...
*@FileName : CoaComCostParaBkupVO.java
*@FileTitle : CoaComCostParaBkupVO
*Open Issues :
*Change history :
...
public class CoaComCostParaBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaComCostParaBkupVO> models = new ArrayList<CoaComCostParaBkupVO>();
	 ...
	 * @param request
	 * @return CoaComCostParaBkupVO[]
	 */
	public CoaComCostParaBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaComCostParaBkupVO[]
	 */
	public CoaComCostParaBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaComCostParaBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaComCostParaBkupVO();
		...
		return getCoaComCostParaBkupVOs();
	}
	 ...
	 * @return CoaComCostParaBkupVO[]
	 */
	public CoaComCostParaBkupVO[] getCoaComCostParaBkupVOs(){
		CoaComCostParaBkupVO[] vos = (CoaComCostParaBkupVO[])models.toArray(new CoaComCostParaBkupVO[models.size()]);
		return vos;
	}
