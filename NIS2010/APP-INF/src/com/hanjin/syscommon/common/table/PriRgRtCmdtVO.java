...
*@FileName : PriRgRtCmdtVO.java
*@FileTitle : PriRgRtCmdtVO
*Open Issues :
*Change history :
...
public class PriRgRtCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgRtCmdtVO> models = new ArrayList<PriRgRtCmdtVO>();
	...
	public PriRgRtCmdtVO() {}

	public PriRgRtCmdtVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String cmdtHdrSeq, String cmdtSeq, String prcCmdtTpCd, String prcCmdtDefCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRgRtCmdtVO[]
	 */
	public PriRgRtCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgRtCmdtVO[]
	 */
	public PriRgRtCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgRtCmdtVO model = null;
	...
	public PriRgRtCmdtVO[] getPriRgRtCmdtVOs(){
		PriRgRtCmdtVO[] vos = (PriRgRtCmdtVO[])models.toArray(new PriRgRtCmdtVO[models.size()]);
		return vos;
	}
