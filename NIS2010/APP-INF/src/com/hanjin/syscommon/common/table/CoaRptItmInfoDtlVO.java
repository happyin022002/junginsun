...
*@FileName : CoaRptItmInfoDtlVO.java
*@FileTitle : CoaRptItmInfoDtlVO
*Open Issues :
*Change history :
...
public class CoaRptItmInfoDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaRptItmInfoDtlVO> models = new ArrayList<CoaRptItmInfoDtlVO>();
	...
	/* Column Info */
	private String coaRptItmCd = null;
	/* Column Info */
	...
	public CoaRptItmInfoDtlVO() {}

	public CoaRptItmInfoDtlVO(String ibflag, String pagerows, String slctItmFomSeq, String coaRptItmCd, String creUsrId, String rptItmDesc, String rptItmColNm, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.slctItmFomSeq = slctItmFomSeq;
		this.creUsrId = creUsrId;
		this.ibflag = ibflag;
		this.rptItmColNm = rptItmColNm;
		this.coaRptItmCd = coaRptItmCd;
		this.creDt = creDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("coa_rpt_itm_cd", getCoaRptItmCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("coa_rpt_itm_cd", "coaRptItmCd");
	 ...
	 * @return coaRptItmCd
	 */
	public String getCoaRptItmCd() {
		return this.coaRptItmCd;
	}
	 ...
	 * @param coaRptItmCd
	 */
	public void setCoaRptItmCd(String coaRptItmCd) {
		this.coaRptItmCd = coaRptItmCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCoaRptItmCd(JSPUtil.getParameter(request, "coa_rpt_itm_cd", ""));
	 ...
	 * @param request
	 * @return CoaRptItmInfoDtlVO[]
	 */
	public CoaRptItmInfoDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaRptItmInfoDtlVO[]
	 */
	public CoaRptItmInfoDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaRptItmInfoDtlVO model = null;
		...
		try {
			...
			String[] coaRptItmCd = (JSPUtil.getParameter(request, prefix	+ "coa_rpt_itm_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (coaRptItmCd[i] != null)
					model.setCoaRptItmCd(coaRptItmCd[i]);
				if (creDt[i] != null)
	...
	public CoaRptItmInfoDtlVO[] getCoaRptItmInfoDtlVOs(){
		CoaRptItmInfoDtlVO[] vos = (CoaRptItmInfoDtlVO[])models.toArray(new CoaRptItmInfoDtlVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.coaRptItmCd = this.coaRptItmCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
