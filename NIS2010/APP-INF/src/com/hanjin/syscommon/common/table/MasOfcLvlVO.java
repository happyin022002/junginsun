...
*@FileName : MasOfcLvlVO.java
*@FileTitle : MasOfcLvlVO
*Open Issues :
*Change history :
 ...
 */
public class MasOfcLvlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasOfcLvlVO> models = new ArrayList<MasOfcLvlVO>();
	 ...
	 * @return MasOfcLvlVO[]
	 */
	public MasOfcLvlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasOfcLvlVO[]
	 */
	public MasOfcLvlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasOfcLvlVO model = null;
	 ...
	 * @return MasOfcLvlVO[]
	 */
	public MasOfcLvlVO[] getMasOfcLvlVOs(){
		MasOfcLvlVO[] vos = (MasOfcLvlVO[])models.toArray(new MasOfcLvlVO[models.size()]);
		return vos;
	}
