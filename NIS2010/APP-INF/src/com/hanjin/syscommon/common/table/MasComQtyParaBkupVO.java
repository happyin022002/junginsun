...
*@FileName : MasComQtyParaBkupVO.java
*@FileTitle : MasComQtyParaBkupVO
*Open Issues :
*Change history :
 ...
 */
public class MasComQtyParaBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComQtyParaBkupVO> models = new ArrayList<MasComQtyParaBkupVO>();
	...
	public MasComQtyParaBkupVO() {}

	public MasComQtyParaBkupVO(String ibflag, String pagerows, String pctlNo, String cntrTpszCd, String bkgRev, String bkgOftRev, String bkgQty, String estmCmAmt, String estmOpfitAmt, String raOpfitAmt, String raCmAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasComQtyParaBkupVO[]
	 */
	public MasComQtyParaBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComQtyParaBkupVO[]
	 */
	public MasComQtyParaBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComQtyParaBkupVO model = null;
		...
		return getMasComQtyParaBkupVOs();
	}
	 ...
	 * @return MasComQtyParaBkupVO[]
	 */
	public MasComQtyParaBkupVO[] getMasComQtyParaBkupVOs(){
		MasComQtyParaBkupVO[] vos = (MasComQtyParaBkupVO[])models.toArray(new MasComQtyParaBkupVO[models.size()]);
		return vos;
	}
