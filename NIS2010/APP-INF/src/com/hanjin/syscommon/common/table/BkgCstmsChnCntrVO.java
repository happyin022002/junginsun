...
*@FileName : BkgCstmsChnCntrVO.java
*@FileTitle : BkgCstmsChnCntrVO
*Open Issues :
*Change history :
...
public class BkgCstmsChnCntrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsChnCntrVO> models = new ArrayList<BkgCstmsChnCntrVO>();
	...
	public BkgCstmsChnCntrVO() {}

	public BkgCstmsChnCntrVO(String ibflag, String pagerows, String chnMfSndIndCd, String blNo, String cntrNo, String cntrTpszCd, String fullMtyCd, String cntrWgt, String wgtUtCd, String cntrMeasQty, String measUtCd, String pckQty, String pckTpCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return BkgCstmsChnCntrVO[]
	 */
	public BkgCstmsChnCntrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsChnCntrVO[]
	 */
	public BkgCstmsChnCntrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsChnCntrVO model = null;
	 ...
	 * @return BkgCstmsChnCntrVO[]
	 */
	public BkgCstmsChnCntrVO[] getBkgCstmsChnCntrVOs(){
		BkgCstmsChnCntrVO[] vos = (BkgCstmsChnCntrVO[])models.toArray(new BkgCstmsChnCntrVO[models.size()]);
		return vos;
	}
