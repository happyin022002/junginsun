...
*@FileName : BsaSltChtrCrrCapaVO.java
*@FileTitle : BsaSltChtrCrrCapaVO
*Open Issues :
*Change history :
...
public class BsaSltChtrCrrCapaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaSltChtrCrrCapaVO> models = new ArrayList<BsaSltChtrCrrCapaVO>();
	...
	public BsaSltChtrCrrCapaVO() {}

	public BsaSltChtrCrrCapaVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String dirCd, String bsaSeq, String vslSeq, String bsaOpCd, String bsaOpJbCd, String crrCd, String crrBsaCapa, String spcCtrlSltCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.trdCd = trdCd;
	 ...
	 */
	public BsaSltChtrCrrCapaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaSltChtrCrrCapaVO[]
	 */
	public BsaSltChtrCrrCapaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaSltChtrCrrCapaVO model = null;
		...
		return getBsaSltChtrCrrCapaVOs();
	}
	...
	public BsaSltChtrCrrCapaVO[] getBsaSltChtrCrrCapaVOs(){
		BsaSltChtrCrrCapaVO[] vos = (BsaSltChtrCrrCapaVO[])models.toArray(new BsaSltChtrCrrCapaVO[models.size()]);
		return vos;
	}
