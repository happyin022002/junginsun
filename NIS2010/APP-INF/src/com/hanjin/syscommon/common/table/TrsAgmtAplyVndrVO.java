...
*@FileName : TrsAgmtAplyVndrVO.java
*@FileTitle : TrsAgmtAplyVndrVO
*Open Issues :
*Change history :
...
public class TrsAgmtAplyVndrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TrsAgmtAplyVndrVO> models = new ArrayList<TrsAgmtAplyVndrVO>();
	...
	public TrsAgmtAplyVndrVO() {}

	public TrsAgmtAplyVndrVO(String ibflag, String pagerows, String trspAgmtOfcCtyCd, String trspAgmtSeq, String vndrSeq, String agmtVndrPrmryFlg, String creOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public TrsAgmtAplyVndrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TrsAgmtAplyVndrVO[]
	 */
	public TrsAgmtAplyVndrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TrsAgmtAplyVndrVO model = null;
	...
	public TrsAgmtAplyVndrVO[] getTrsAgmtAplyVndrVOs(){
		TrsAgmtAplyVndrVO[] vos = (TrsAgmtAplyVndrVO[])models.toArray(new TrsAgmtAplyVndrVO[models.size()]);
		return vos;
	}
