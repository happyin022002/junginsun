...
*@FileName : MasMonVvdYryPlnVO.java
*@FileTitle : MasMonVvdYryPlnVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonVvdYryPlnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonVvdYryPlnVO> models = new ArrayList<MasMonVvdYryPlnVO>();
...
/**
	 ...
	 */
	public MasMonVvdYryPlnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonVvdYryPlnVO[]
	 */
	public MasMonVvdYryPlnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonVvdYryPlnVO model = null;
	...
	public MasMonVvdYryPlnVO[] getMasMonVvdYryPlnVOs(){
		MasMonVvdYryPlnVO[] vos = (MasMonVvdYryPlnVO[])models.toArray(new MasMonVvdYryPlnVO[models.size()]);
		return vos;
	}
