...
*@FileName : BsaVvdCrrPerfVO.java
*@FileTitle : BsaVvdCrrPerfVO
*Open Issues :
*Change history :
...
public class BsaVvdCrrPerfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaVvdCrrPerfVO> models = new ArrayList<BsaVvdCrrPerfVO>();
	...
	/* Column Info */
	private String crrPerfLoclAmt = null;
	/* Page Number */
	...
	/* Column Info */
	private String crrPerfAmt = null;
	/* Column Info */
	...
	public BsaVvdCrrPerfVO() {}

	public BsaVvdCrrPerfVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String skdDirCd, String bsaOpJbCd, String crrCd, String crrBsaCapa, String crrPerfAmt, String joEvntDt, String sltPrcCapa, String creUsrId, String creDt, String updUsrId, String updDt, String crrPerfLoclAmt, String currCd, String usdXchRt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.currCd = currCd;
		...
		this.crrPerfLoclAmt = crrPerfLoclAmt;
		this.pagerows = pagerows;
		this.creUsrId = creUsrId;
		this.ibflag = ibflag;
		this.bsaOpJbCd = bsaOpJbCd;
		this.sltPrcCapa = sltPrcCapa;
		this.crrPerfAmt = crrPerfAmt;
	...
	/**
	 * Column Info
	 * @return crrPerfLoclAmt
	 */
	public String getCrrPerfLoclAmt() {
		return this.crrPerfLoclAmt;
	}
	 ...
	 * @return crrPerfAmt
	 */
	public String getCrrPerfAmt() {
		return this.crrPerfAmt;
	}
	...
	/**
	 * Column Info
	 * @param crrPerfLoclAmt
	 */
	public void setCrrPerfLoclAmt(String crrPerfLoclAmt) {
		this.crrPerfLoclAmt = crrPerfLoclAmt;
	}
	 ...
	 * @param crrPerfAmt
	 */
	public void setCrrPerfAmt(String crrPerfAmt) {
		this.crrPerfAmt = crrPerfAmt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setJoEvntDt(JSPUtil.getParameter(request, prefix + "jo_evnt_dt", ""));
		setSkdDirCd(JSPUtil.getParameter(request, prefix + "skd_dir_cd", ""));
		setCrrCd(JSPUtil.getParameter(request, prefix + "crr_cd", ""));
		setCrrBsaCapa(JSPUtil.getParameter(request, prefix + "crr_bsa_capa", ""));
		setCrrPerfLoclAmt(JSPUtil.getParameter(request, prefix + "crr_perf_locl_amt", ""));
		...
		setCrrPerfAmt(JSPUtil.getParameter(request, prefix + "crr_perf_amt", ""));
	 ...
	 * @param request
	 * @return BsaVvdCrrPerfVO[]
	 */
	public BsaVvdCrrPerfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaVvdCrrPerfVO[]
	 */
	public BsaVvdCrrPerfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaVvdCrrPerfVO model = null;
		...
		try {
			...
			String[] crrPerfLoclAmt = (JSPUtil.getParameter(request, prefix	+ "crr_perf_locl_amt", length));
			...
			String[] crrPerfAmt = (JSPUtil.getParameter(request, prefix	+ "crr_perf_amt", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			
			for (int i = 0; i < length; i++) {
				model = new BsaVvdCrrPerfVO();
				if (updDt[i] != null)
				...
				if (crrPerfLoclAmt[i] != null)
					model.setCrrPerfLoclAmt(crrPerfLoclAmt[i]);
				if (pagerows[i] != null)
				...
				if (crrPerfAmt[i] != null)
					model.setCrrPerfAmt(crrPerfAmt[i]);
				if (updUsrId[i] != null)
	 ...
	 * @return BsaVvdCrrPerfVO[]
	 */
	public BsaVvdCrrPerfVO[] getBsaVvdCrrPerfVOs(){
		BsaVvdCrrPerfVO[] vos = (BsaVvdCrrPerfVO[])models.toArray(new BsaVvdCrrPerfVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.crrPerfLoclAmt = this.crrPerfLoclAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.crrPerfAmt = this.crrPerfAmt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
