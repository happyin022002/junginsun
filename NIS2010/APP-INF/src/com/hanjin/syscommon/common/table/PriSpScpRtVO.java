...
*@FileName : PriSpScpRtVO.java
*@FileTitle : PriSpScpRtVO
*Open Issues :
*Change history :
...
public class PriSpScpRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRtVO> models = new ArrayList<PriSpScpRtVO>();
	 ...
	 * @return PriSpScpRtVO[]
	 */
	public PriSpScpRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRtVO[]
	 */
	public PriSpScpRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRtVO model = null;
	...
	public PriSpScpRtVO[] getPriSpScpRtVOs(){
		PriSpScpRtVO[] vos = (PriSpScpRtVO[])models.toArray(new PriSpScpRtVO[models.size()]);
		return vos;
	}
