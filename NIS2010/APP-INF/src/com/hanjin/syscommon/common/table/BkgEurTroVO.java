...
public class BkgEurTroVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAddRevRmk(JSPUtil.getParameter(request, "add_rev_rmk", ""));
	}
