 ...
 * @author Hyung Choon
 * @since J2EE 1.4
 */public final class MdmZn implements java.io.Serializable {
    ...
    public String          getStrt_nm        (){    return strt_nm            ;    }
    ...
    public void setStrt_nm        ( String          strt_nm         ){    this.strt_nm         = strt_nm            ;    }
    ...
    public static MdmZn fromRequest(HttpServletRequest request) {
        MdmZn model = new MdmZn();
        try {
            ...
            model.setStrt_nm            (JSPUtil.getParameter(request, "strt_nm                ".trim(), ""));
    ...
    public static Collection fromRequest(HttpServletRequest request, int length) {
        ...
        try {
            ...
            String[] strt_nm         =  (JSPUtil.getParameter(request, "strt_nm                ".trim(), length));
    ...
    public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] strt_nm         =  (JSPUtil.getParameter(request, prefix + "strt_nm                ".trim(), length));
