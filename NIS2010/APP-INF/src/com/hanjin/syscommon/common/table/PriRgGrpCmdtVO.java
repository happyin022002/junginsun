...
*@FileName : PriRgGrpCmdtVO.java
*@FileTitle : PriRgGrpCmdtVO
*Open Issues :
*Change history :
...
public class PriRgGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgGrpCmdtVO> models = new ArrayList<PriRgGrpCmdtVO>();
	...
	public PriRgGrpCmdtVO() {}

	public PriRgGrpCmdtVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String prcCustTpCd, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRgGrpCmdtVO[]
	 */
	public PriRgGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgGrpCmdtVO[]
	 */
	public PriRgGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgGrpCmdtVO model = null;
	...
	public PriRgGrpCmdtVO[] getPriRgGrpCmdtVOs(){
		PriRgGrpCmdtVO[] vos = (PriRgGrpCmdtVO[])models.toArray(new PriRgGrpCmdtVO[models.size()]);
		return vos;
	}
