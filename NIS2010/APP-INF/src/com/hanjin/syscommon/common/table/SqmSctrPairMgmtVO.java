...
*@FileName : SqmSctrPairMgmtVO.java
*@FileTitle : SqmSctrPairMgmtVO
*Open Issues :
*Change history :
...
public class SqmSctrPairMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrPairMgmtVO> models = new ArrayList<SqmSctrPairMgmtVO>();
	...
	public SqmSctrPairMgmtVO() {}

	public SqmSctrPairMgmtVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String dirCd, String pfGrpCd, String polCd, String podCd, String trdCd, String subTrdCd, String polCallSeq, String podCallSeq, String sqmActFlg, String sqmMnSctrFlg, String addFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
...
/**
	 ...
	 */
	public SqmSctrPairMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrPairMgmtVO[]
	 */
	public SqmSctrPairMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrPairMgmtVO model = null;
	...
	public SqmSctrPairMgmtVO[] getSqmSctrPairMgmtVOs(){
		SqmSctrPairMgmtVO[] vos = (SqmSctrPairMgmtVO[])models.toArray(new SqmSctrPairMgmtVO[models.size()]);
		return vos;
	}
