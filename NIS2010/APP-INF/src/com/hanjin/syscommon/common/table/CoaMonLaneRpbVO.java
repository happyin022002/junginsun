...
*@FileName : CoaMonLaneRpbVO.java
*@FileTitle : CoaMonLaneRpbVO
*Open Issues :
*Change history :
...
public class CoaMonLaneRpbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaMonLaneRpbVO> models = new ArrayList<CoaMonLaneRpbVO>();
	...
	public CoaMonLaneRpbVO() {}

	public CoaMonLaneRpbVO(String ibflag, String pagerows, String rpbYrmon, String rlaneCd, String iocCd, String dirCd, String net20ftAvgRev, String oft20ftAvgRev, String misc20ftAvgRev, String scr20ftAvgRev, String net40ftAvgRev, String oft40ftAvgRev, String misc40ftAvgRev, String scr40ftAvgRev, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
	 ...
	 * @param request
	 * @return CoaMonLaneRpbVO[]
	 */
	public CoaMonLaneRpbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaMonLaneRpbVO[]
	 */
	public CoaMonLaneRpbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaMonLaneRpbVO model = null;
	 ...
	 * @return CoaMonLaneRpbVO[]
	 */
	public CoaMonLaneRpbVO[] getCoaMonLaneRpbVOs(){
		CoaMonLaneRpbVO[] vos = (CoaMonLaneRpbVO[])models.toArray(new CoaMonLaneRpbVO[models.size()]);
		return vos;
	}
