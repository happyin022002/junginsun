...
*@FileName : BkgKrWhfCfmVO.java
*@FileTitle : BkgKrWhfCfmVO
*Open Issues :
*Change history :
...
public class BkgKrWhfCfmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgKrWhfCfmVO> models = new ArrayList<BkgKrWhfCfmVO>();
	...
	public BkgKrWhfCfmVO() {}

	public BkgKrWhfCfmVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String portCd, String whfBndCd, String whfCfmFlg, String cfmUsrId, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 */
	public BkgKrWhfCfmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgKrWhfCfmVO[]
	 */
	public BkgKrWhfCfmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgKrWhfCfmVO model = null;
	 ...
	 * @return BkgKrWhfCfmVO[]
	 */
	public BkgKrWhfCfmVO[] getBkgKrWhfCfmVOs(){
		BkgKrWhfCfmVO[] vos = (BkgKrWhfCfmVO[])models.toArray(new BkgKrWhfCfmVO[models.size()]);
		return vos;
	}
