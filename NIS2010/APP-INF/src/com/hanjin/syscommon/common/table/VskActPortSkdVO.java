...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setActArrRmk(JSPUtil.getParameter(request, prefix + "act_arr_rmk", ""));
		...
		setActDepRmk(JSPUtil.getParameter(request, prefix + "act_dep_rmk", ""));
		...
		setActBrthRmk(JSPUtil.getParameter(request, prefix + "act_brth_rmk", ""));
