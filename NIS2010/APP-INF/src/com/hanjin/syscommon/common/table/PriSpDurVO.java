...
*@FileName : PriSpDurVO.java
*@FileTitle : PriSpDurVO
*Open Issues :
*Change history :
...
public class PriSpDurVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpDurVO> models = new ArrayList<PriSpDurVO>();
	...
	public PriSpDurVO(String ibflag, String pagerows, String propNo, String amdtSeq, String ctrtEffDt, String ctrtExpDt, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return PriSpDurVO[]
	 */
	public PriSpDurVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpDurVO[]
	 */
	public PriSpDurVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpDurVO model = null;
	...
	public PriSpDurVO[] getPriSpDurVOs(){
		PriSpDurVO[] vos = (PriSpDurVO[])models.toArray(new PriSpDurVO[models.size()]);
		return vos;
	}
