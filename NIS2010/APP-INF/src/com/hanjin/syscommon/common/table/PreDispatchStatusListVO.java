...
public class PreDispatchStatusListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String disN3ndFaxSndNo = null;
	/* Column Info */
	private String disN1stEmlSndNo = null;
	/* Column Info */
	private String disN2ndEmlSndNo = null;
	/* Column Info */
	private String disN3ndEmlSndNo = null;
	...
	public PreDispatchStatusListVO(String ibflag, String pagerows, String trspWoOfcCtyCd, String trspWoSeq, String woIssKnt, String trspSoOfcCtyCd, String trspSoSeq, String vndrSeq, String disN1stFaxNo, String disN2ndFaxNo, String disN3rdFaxNo, String disN1stEml, String disN2ndEml, String disN3rdEml, String vndrLglEngNm, String creOfcCd, String updUsrId, String localTime, String trspDisRefNo, String trspDisIssSeq, String disN1stFaxSndNo, String disN2ndFaxSndNo, String disN3ndFaxSndNo, String disN1stEmlSndNo, String disN2ndEmlSndNo, String disN3ndEmlSndNo) {
		...
		this.disN3ndFaxSndNo = disN3ndFaxSndNo;
		this.disN1stEmlSndNo = disN1stEmlSndNo;
		this.disN2ndEmlSndNo = disN2ndEmlSndNo;
		this.disN3ndEmlSndNo = disN3ndEmlSndNo;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dis_n1st_fax_snd_no", this.getDisN1stFaxSndNo());
		this.hashColumns.put("dis_n2nd_fax_snd_no", this.getDisN2ndFaxSndNo());
		this.hashColumns.put("dis_n3rd_fax_snd_no", this.getDisN3ndFaxSndNo());
		this.hashColumns.put("dis_n1st_eml_snd_no", this.getDisN1stEmlSndNo());
		this.hashColumns.put("dis_n2nd_eml_snd_no", this.getDisN2ndEmlSndNo());
		this.hashColumns.put("dis_n3rd_eml_snd_no", this.getDisN3ndEmlSndNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dis_n3rd_fax_snd_no", "disN3ndFaxSndNo");
		this.hashFields.put("dis_n1st_eml_snd_no", "disN1stEmlSndNo");
		this.hashFields.put("dis_n2nd_eml_snd_no", "disN2ndEmlSndNo");
		this.hashFields.put("dis_n3rd_eml_snd_no", "disN3ndEmlSndNo");
	...
	/**
	 * Column Info
	 * @return disN3ndFaxSndNo
	 */
	public String getDisN3ndFaxSndNo() {
		return disN3ndFaxSndNo;
	}
	/**
	 * Column Info
	...
	/**
	 * Column Info
	 * @return disN3ndEmlSndNo
	 */
	public String getDisN3ndEmlSndNo() {
		return disN3ndEmlSndNo;
	}
	...
	/**
	 * Column Info
	 * @param disN3ndFaxSndNo
	 */
	public void setDisN3ndFaxSndNo(String disN3ndFaxSndNo) {
		this.disN3ndFaxSndNo = disN3ndFaxSndNo;
	}
	/**
	 * Column Info
	...
	/**
	 * Column Info
	 * @param disN3ndEmlSndNo
	 */
	public void setDisN3ndEmlSndNo(String disN3ndEmlSndNo) {
		this.disN3ndEmlSndNo = disN3ndEmlSndNo;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDisN3ndFaxSndNo(JSPUtil.getParameter(request, "dis_n3rd_fax_snd_no", ""));
		...
		setDisN3ndEmlSndNo(JSPUtil.getParameter(request, "dis_n3rd_eml_snd_no", ""));
	}
	...
	public PreDispatchStatusListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] disN3ndFaxSndNo = (JSPUtil.getParameter(request, prefix	+ "dis_n3rd_fax_snd_no", length));
			...
			String[] disN3ndEmlSndNo = (JSPUtil.getParameter(request, prefix	+ "dis_n3rd_eml_snd_no", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (disN3ndFaxSndNo[i] != null)
					model.setDisN3ndFaxSndNo(disN3ndFaxSndNo[i]);
				...
				if (disN3ndEmlSndNo[i] != null)
					model.setDisN3ndEmlSndNo(disN3ndEmlSndNo[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.disN3ndFaxSndNo = this.disN3ndFaxSndNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.disN3ndEmlSndNo = this.disN3ndEmlSndNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
