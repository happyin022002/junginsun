...
*@FileName : MasMonMiscRevPreTeuVO.java
*@FileTitle : MasMonMiscRevPreTeuVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonMiscRevPreTeuVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonMiscRevPreTeuVO> models = new ArrayList<MasMonMiscRevPreTeuVO>();
	...
	public MasMonMiscRevPreTeuVO() {}

	public MasMonMiscRevPreTeuVO(String ibflag, String pagerows, String revYrmon, String trdCd, String dirCd, String rlaneCd, String trdTtlAmt, String trdTtlQty, String etcUtRevAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasMonMiscRevPreTeuVO[]
	 */
	public MasMonMiscRevPreTeuVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonMiscRevPreTeuVO[]
	 */
	public MasMonMiscRevPreTeuVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonMiscRevPreTeuVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasMonMiscRevPreTeuVO();
				if (updDt[i] != null)
		...
		return getMasMonMiscRevPreTeuVOs();
	}
	...
	public MasMonMiscRevPreTeuVO[] getMasMonMiscRevPreTeuVOs(){
		MasMonMiscRevPreTeuVO[] vos = (MasMonMiscRevPreTeuVO[])models.toArray(new MasMonMiscRevPreTeuVO[models.size()]);
		return vos;
	}
