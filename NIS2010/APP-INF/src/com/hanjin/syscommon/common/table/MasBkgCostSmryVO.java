...
*@FileName : MasBkgCostSmryVO.java
*@FileTitle : MasBkgCostSmryVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgCostSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgCostSmryVO> models = new ArrayList<MasBkgCostSmryVO>();
	 ...
	 * @param request
	 * @return MasBkgCostSmryVO[]
	 */
	public MasBkgCostSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgCostSmryVO[]
	 */
	public MasBkgCostSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgCostSmryVO model = null;
	 ...
	 * @return MasBkgCostSmryVO[]
	 */
	public MasBkgCostSmryVO[] getMasBkgCostSmryVOs(){
		MasBkgCostSmryVO[] vos = (MasBkgCostSmryVO[])models.toArray(new MasBkgCostSmryVO[models.size()]);
		return vos;
	}
