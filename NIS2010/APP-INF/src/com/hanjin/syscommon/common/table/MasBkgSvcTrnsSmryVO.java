...
*@FileName : MasBkgSvcTrnsSmryVO.java
*@FileTitle : MasBkgSvcTrnsSmryVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgSvcTrnsSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgSvcTrnsSmryVO> models = new ArrayList<MasBkgSvcTrnsSmryVO>();
	 ...
	 * @param request
	 * @return MasBkgSvcTrnsSmryVO[]
	 */
	public MasBkgSvcTrnsSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgSvcTrnsSmryVO[]
	 */
	public MasBkgSvcTrnsSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgSvcTrnsSmryVO model = null;
		...
		return getMasBkgSvcTrnsSmryVOs();
	}
	 ...
	 * @return MasBkgSvcTrnsSmryVO[]
	 */
	public MasBkgSvcTrnsSmryVO[] getMasBkgSvcTrnsSmryVOs(){
		MasBkgSvcTrnsSmryVO[] vos = (MasBkgSvcTrnsSmryVO[])models.toArray(new MasBkgSvcTrnsSmryVO[models.size()]);
		return vos;
	}
