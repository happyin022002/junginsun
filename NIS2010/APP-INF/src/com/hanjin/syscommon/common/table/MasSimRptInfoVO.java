...
*@FileName : MasSimRptInfoVO.java
*@FileTitle : MasSimRptInfoVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimRptInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimRptInfoVO> models = new ArrayList<MasSimRptInfoVO>();
	...
	public MasSimRptInfoVO() {}

	public MasSimRptInfoVO(String ibflag, String pagerows, String sgrpCostCd, String krDpDesc, String engDpDesc, String dpSeqNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSimRptInfoVO[]
	 */
	public MasSimRptInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimRptInfoVO[]
	 */
	public MasSimRptInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimRptInfoVO model = null;
	 ...
	 * @return MasSimRptInfoVO[]
	 */
	public MasSimRptInfoVO[] getMasSimRptInfoVOs(){
		MasSimRptInfoVO[] vos = (MasSimRptInfoVO[])models.toArray(new MasSimRptInfoVO[models.size()]);
		return vos;
	}
