...
*@FileName : MasCntrRepoSplsDelRtoVO.java
*@FileTitle : MasCntrRepoSplsDelRtoVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoSplsDelRtoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoSplsDelRtoVO> models = new ArrayList<MasCntrRepoSplsDelRtoVO>();
	...
	public MasCntrRepoSplsDelRtoVO() {}

	public MasCntrRepoSplsDelRtoVO(String ibflag, String pagerows, String costYrmon, String cntrTpszCd, String porEccCd, String delEccCd, String eqRepoCrRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasCntrRepoSplsDelRtoVO[]
	 */
	public MasCntrRepoSplsDelRtoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoSplsDelRtoVO[]
	 */
	public MasCntrRepoSplsDelRtoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoSplsDelRtoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasCntrRepoSplsDelRtoVO();
				if (updDt[i] != null)
		...
		return getMasCntrRepoSplsDelRtoVOs();
	}
	 ...
	 * @return MasCntrRepoSplsDelRtoVO[]
	 */
	public MasCntrRepoSplsDelRtoVO[] getMasCntrRepoSplsDelRtoVOs(){
		MasCntrRepoSplsDelRtoVO[] vos = (MasCntrRepoSplsDelRtoVO[])models.toArray(new MasCntrRepoSplsDelRtoVO[models.size()]);
		return vos;
	}
