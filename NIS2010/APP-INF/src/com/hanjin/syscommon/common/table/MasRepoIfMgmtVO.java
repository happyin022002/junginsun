...
*@FileName : MasRepoIfMgmtVO.java
*@FileTitle : MasRepoIfMgmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasRepoIfMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRepoIfMgmtVO> models = new ArrayList<MasRepoIfMgmtVO>();
	...
	public MasRepoIfMgmtVO() {}

	public MasRepoIfMgmtVO(String ibflag, String pagerows, String costYr, String costMon, String verTpCd, String costLocGrpCd, String ifVerCd, String cntrTpszCd, String cntrOrgDestCd, String locCd, String actUtPrcAmt, String adjRtAmt, String plcyPrcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasRepoIfMgmtVO[]
	 */
	public MasRepoIfMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRepoIfMgmtVO[]
	 */
	public MasRepoIfMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRepoIfMgmtVO model = null;
	 ...
	 * @return MasRepoIfMgmtVO[]
	 */
	public MasRepoIfMgmtVO[] getMasRepoIfMgmtVOs(){
		MasRepoIfMgmtVO[] vos = (MasRepoIfMgmtVO[])models.toArray(new MasRepoIfMgmtVO[models.size()]);
		return vos;
	}
