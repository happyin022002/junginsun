...
*@FileName : MasLaneTpHisVO.java
*@FileTitle : MasLaneTpHisVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneTpHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneTpHisVO> models = new ArrayList<MasLaneTpHisVO>();
	...
	public MasLaneTpHisVO() {}

	public MasLaneTpHisVO(String ibflag, String pagerows, String rlaneCd, String dirCd, String trdCd, String iocCd, String laneSeq, String vslLaneTpCd, String stupFlg, String vvdCd, String laneAplyFmDt, String laneAplyToDt, String creUsrId, String creDt, String updUsrId, String updDt, String autoFlg, String opLaneTpCd) {
		this.updDt = updDt;
		this.iocCd = iocCd;
	 ...
	 */
	public MasLaneTpHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneTpHisVO[]
	 */
	public MasLaneTpHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneTpHisVO model = null;
	...
	public MasLaneTpHisVO[] getMasLaneTpHisVOs(){
		MasLaneTpHisVO[] vos = (MasLaneTpHisVO[])models.toArray(new MasLaneTpHisVO[models.size()]);
		return vos;
	}
