...
*@FileName : EqrOnfHirExePlnQtyVO.java
*@FileTitle : EqrOnfHirExePlnQtyVO
*Open Issues :
*Change history :
...
public class EqrOnfHirExePlnQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrOnfHirExePlnQtyVO> models = new ArrayList<EqrOnfHirExePlnQtyVO>();
	...
	/* Column Info */
	private String onfHirCostAmtUpdate = null;
	/* Column Info */
	private String onfHirCostAmtInsert = null;
	...
	public EqrOnfHirExePlnQtyVO() {}

	public EqrOnfHirExePlnQtyVO(String ibflag, String pagerows, String repoPlnId, String plnYrwk, String plnSeq, String refId, String cntrTpszCd, String cntrQty, String onfHirCostAmt, String plnUcAmt, String fmEccCostAmt, String toEccCostAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("onf_hir_cost_amt_update", getOnfHirCostAmtUpdate());
		this.hashColumns.put("onf_hir_cost_amt_insert", getOnfHirCostAmtInsert());
	...
	public String getOnfHirCostAmtUpdate() {
		return onfHirCostAmtUpdate;
	}

	public void setOnfHirCostAmtUpdate(String onfHirCostAmtUpdate) {
		this.onfHirCostAmtUpdate = onfHirCostAmtUpdate;
	}

	public String getOnfHirCostAmtInsert() {
		return onfHirCostAmtInsert;
	}

	public void setOnfHirCostAmtInsert(String onfHirCostAmtInsert) {
		this.onfHirCostAmtInsert = onfHirCostAmtInsert;
	}
	 ...
	 */
	public EqrOnfHirExePlnQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrOnfHirExePlnQtyVO[]
	 */
	public EqrOnfHirExePlnQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrOnfHirExePlnQtyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EqrOnfHirExePlnQtyVO();
				if (updDt[i] != null)
		...
		return getEqrOnfHirExePlnQtyVOs();
	}
	 ...
	 * @return EqrOnfHirExePlnQtyVO[]
	 */
	public EqrOnfHirExePlnQtyVO[] getEqrOnfHirExePlnQtyVOs(){
		EqrOnfHirExePlnQtyVO[] vos = (EqrOnfHirExePlnQtyVO[])models.toArray(new EqrOnfHirExePlnQtyVO[models.size()]);
		return vos;
	}
