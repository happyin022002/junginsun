...
*@FileName : PriSpScpDurVO.java
*@FileTitle : PriSpScpDurVO
*Open Issues :
*Change history :
...
public class PriSpScpDurVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpDurVO> models = new ArrayList<PriSpScpDurVO>();
	 ...
	 */
	public PriSpScpDurVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpDurVO[]
	 */
	public PriSpScpDurVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpDurVO model = null;
	...
	public PriSpScpDurVO[] getPriSpScpDurVOs(){
		PriSpScpDurVO[] vos = (PriSpScpDurVO[])models.toArray(new PriSpScpDurVO[models.size()]);
		return vos;
	}
