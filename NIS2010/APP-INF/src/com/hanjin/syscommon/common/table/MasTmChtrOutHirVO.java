...
*@FileName : MasTmChtrOutHirVO.java
*@FileTitle : MasTmChtrOutHirVO
*Open Issues :
*Change history :
 ...
 */
public class MasTmChtrOutHirVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasTmChtrOutHirVO> models = new ArrayList<MasTmChtrOutHirVO>();
	...
	public MasTmChtrOutHirVO() {}

	public MasTmChtrOutHirVO(String ibflag, String pagerows, String toHirSeq, String fmVslClssCapa, String toVslClssCapa, String vslTeuUcAmt, String vslDlyUcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasTmChtrOutHirVO[]
	 */
	public MasTmChtrOutHirVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasTmChtrOutHirVO[]
	 */
	public MasTmChtrOutHirVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasTmChtrOutHirVO model = null;
	 ...
	 * @return MasTmChtrOutHirVO[]
	 */
	public MasTmChtrOutHirVO[] getMasTmChtrOutHirVOs(){
		MasTmChtrOutHirVO[] vos = (MasTmChtrOutHirVO[])models.toArray(new MasTmChtrOutHirVO[models.size()]);
		return vos;
	}
