 ...
 *@FileName : PriRqRtCmdtHdrVO.java
 *@FileTitle : PriRqRtCmdtHdrVO
 *Open Issues :
 *Change history :
...
public class PriRqRtCmdtHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<PriRqRtCmdtHdrVO> models = new ArrayList<PriRqRtCmdtHdrVO>();
	...
	public PriRqRtCmdtHdrVO() {
	}

	public PriRqRtCmdtHdrVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String srcInfoCd, String creUsrId, String updUsrId,
			String creDt, String updDt, String ficRtTpCd) {
		this.updDt = updDt;
	 ...
	 */
	public PriRqRtCmdtHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtCmdtHdrVO[]
	 */
	public PriRqRtCmdtHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtCmdtHdrVO model = null;
	...
	public PriRqRtCmdtHdrVO[] getPriRqRtCmdtHdrVOs() {
		PriRqRtCmdtHdrVO[] vos = (PriRqRtCmdtHdrVO[]) models.toArray(new PriRqRtCmdtHdrVO[models.size()]);
		return vos;
	}
