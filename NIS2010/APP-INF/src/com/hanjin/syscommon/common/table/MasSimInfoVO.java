...
*@FileName : MasSimInfoVO.java
*@FileTitle : MasSimInfoVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimInfoVO> models = new ArrayList<MasSimInfoVO>();
	...
	public MasSimInfoVO(String ibflag, String pagerows, String simDt, String simNo, String slanCd, String simDeptCd, String extdLaneFlg, String simRmk, String creUsrId, String creDt, String updUsrId, String updDt, String svcDurDys, String brthItvalDys, String expcOtPerfRto, String simStsCd, String coCd) {
		this.updDt = updDt;
		this.coCd = coCd;
	 ...
	 * @return MasSimInfoVO[]
	 */
	public MasSimInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimInfoVO[]
	 */
	public MasSimInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimInfoVO model = null;
	 ...
	 * @return MasSimInfoVO[]
	 */
	public MasSimInfoVO[] getMasSimInfoVOs(){
		MasSimInfoVO[] vos = (MasSimInfoVO[])models.toArray(new MasSimInfoVO[models.size()]);
		return vos;
	}
