...
*@FileName : MasTrnsFdrTermVO.java
*@FileTitle : MasTrnsFdrTermVO
*Open Issues :
*Change history :
 ...
 */
public class MasTrnsFdrTermVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasTrnsFdrTermVO> models = new ArrayList<MasTrnsFdrTermVO>();
	...
	public MasTrnsFdrTermVO() {}

	public MasTrnsFdrTermVO(String ibflag, String pagerows, String orgLocCd, String destLocCd, String fullMtyCd, String fdrRcvTermCd, String fdrDeTermCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public MasTrnsFdrTermVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasTrnsFdrTermVO[]
	 */
	public MasTrnsFdrTermVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasTrnsFdrTermVO model = null;
	...
	public MasTrnsFdrTermVO[] getMasTrnsFdrTermVOs(){
		MasTrnsFdrTermVO[] vos = (MasTrnsFdrTermVO[])models.toArray(new MasTrnsFdrTermVO[models.size()]);
		return vos;
	}
