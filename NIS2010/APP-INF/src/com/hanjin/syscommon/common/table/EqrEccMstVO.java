...
*@FileName : EqrEccMstVO.java
*@FileTitle : EqrEccMstVO
*Open Issues :
*Change history :
...
public class EqrEccMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrEccMstVO> models = new ArrayList<EqrEccMstVO>();
	 ...
	 * @return EqrEccMstVO[]
	 */
	public EqrEccMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrEccMstVO[]
	 */
	public EqrEccMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrEccMstVO model = null;
	...
	public EqrEccMstVO[] getEqrEccMstVOs(){
		EqrEccMstVO[] vos = (EqrEccMstVO[])models.toArray(new EqrEccMstVO[models.size()]);
		return vos;
	}
