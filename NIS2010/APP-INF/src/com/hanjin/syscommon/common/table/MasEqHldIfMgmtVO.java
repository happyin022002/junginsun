...
*@FileName : MasEqHldIfMgmtVO.java
*@FileTitle : MasEqHldIfMgmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasEqHldIfMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasEqHldIfMgmtVO> models = new ArrayList<MasEqHldIfMgmtVO>();
	...
	public MasEqHldIfMgmtVO() {}

	public MasEqHldIfMgmtVO(String ibflag, String pagerows, String costYr, String costMon, String verTpCd, String ifVerCd, String cntrTpszCd, String actPrcAmt, String adjRtAmt, String plcyPrcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasEqHldIfMgmtVO[]
	 */
	public MasEqHldIfMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasEqHldIfMgmtVO[]
	 */
	public MasEqHldIfMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasEqHldIfMgmtVO model = null;
	 ...
	 * @return MasEqHldIfMgmtVO[]
	 */
	public MasEqHldIfMgmtVO[] getMasEqHldIfMgmtVOs(){
		MasEqHldIfMgmtVO[] vos = (MasEqHldIfMgmtVO[])models.toArray(new MasEqHldIfMgmtVO[models.size()]);
		return vos;
	}
