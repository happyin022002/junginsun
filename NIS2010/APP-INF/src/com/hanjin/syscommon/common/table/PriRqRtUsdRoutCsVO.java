...
*@FileName : PriRqRtUsdRoutCsVO.java
*@FileTitle : PriRqRtUsdRoutCsVO
*Open Issues :
*Change history :
...
public class PriRqRtUsdRoutCsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtUsdRoutCsVO> models = new ArrayList<PriRqRtUsdRoutCsVO>();
	...
	public PriRqRtUsdRoutCsVO() {}

	public PriRqRtUsdRoutCsVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String routSeq, String rtSeq, String routCsNo, String routCsSrcDt, String usdRoutCsSelFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRqRtUsdRoutCsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtUsdRoutCsVO[]
	 */
	public PriRqRtUsdRoutCsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtUsdRoutCsVO model = null;
	 ...
	 * @return PriRqRtUsdRoutCsVO[]
	 */
	public PriRqRtUsdRoutCsVO[] getPriRqRtUsdRoutCsVOs(){
		PriRqRtUsdRoutCsVO[] vos = (PriRqRtUsdRoutCsVO[])models.toArray(new PriRqRtUsdRoutCsVO[models.size()]);
		return vos;
	}
