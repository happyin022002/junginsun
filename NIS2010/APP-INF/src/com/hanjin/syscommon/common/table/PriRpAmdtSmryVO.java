...
*@FileName : PriRpAmdtSmryVO.java
*@FileTitle : PriRpAmdtSmryVO
*Open Issues :
*Change history :
...
public class PriRpAmdtSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpAmdtSmryVO> models = new ArrayList<PriRpAmdtSmryVO>();
	...
	public PriRpAmdtSmryVO() {}

	public PriRpAmdtSmryVO(String ibflag, String pagerows, String propNo, String amdtSeq, String propTermTpCd, String amdtFlg, String acptFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRpAmdtSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpAmdtSmryVO[]
	 */
	public PriRpAmdtSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpAmdtSmryVO model = null;
	...
	public PriRpAmdtSmryVO[] getPriRpAmdtSmryVOs(){
		PriRpAmdtSmryVO[] vos = (PriRpAmdtSmryVO[])models.toArray(new PriRpAmdtSmryVO[models.size()]);
		return vos;
	}
