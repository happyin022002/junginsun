...
*@FileName : PriRpScpRtCmdtRnoteVO.java
*@FileTitle : PriRpScpRtCmdtRnoteVO
*Open Issues :
*Change history :
...
public class PriRpScpRtCmdtRnoteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtCmdtRnoteVO> models = new ArrayList<PriRpScpRtCmdtRnoteVO>();
	 ...
	 * @param request
	 * @return PriRpScpRtCmdtRnoteVO[]
	 */
	public PriRpScpRtCmdtRnoteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtCmdtRnoteVO[]
	 */
	public PriRpScpRtCmdtRnoteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtCmdtRnoteVO model = null;
		...
		try {
			...
			String[] routNoteSeq = (JSPUtil.getParameter(request, prefix	+ "rout_note_seq", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			String[] n1stCmncDt = (JSPUtil.getParameter(request, prefix	+ "n1st_cmnc_dt", length));
			
			for (int i = 0; i < length; i++) {
				model = new PriRpScpRtCmdtRnoteVO();
				if (updDt[i] != null)
		...
		return getPriRpScpRtCmdtRnoteVOs();
	}
	...
	public PriRpScpRtCmdtRnoteVO[] getPriRpScpRtCmdtRnoteVOs(){
		PriRpScpRtCmdtRnoteVO[] vos = (PriRpScpRtCmdtRnoteVO[])models.toArray(new PriRpScpRtCmdtRnoteVO[models.size()]);
		return vos;
	}
