...
*@FileName : BkgUsaWhfBlVO.java
*@FileTitle : BkgUsaWhfBlVO
*Open Issues :
*Change history :
...
public class BkgUsaWhfBlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgUsaWhfBlVO> models = new ArrayList<BkgUsaWhfBlVO>();
	...
	public BkgUsaWhfBlVO() {}

	public BkgUsaWhfBlVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String portCd, String ioBndCd, String blNo, String cstmsDesc, String orgDestLocCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return BkgUsaWhfBlVO[]
	 */
	public BkgUsaWhfBlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgUsaWhfBlVO[]
	 */
	public BkgUsaWhfBlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgUsaWhfBlVO model = null;
	 ...
	 * @return BkgUsaWhfBlVO[]
	 */
	public BkgUsaWhfBlVO[] getBkgUsaWhfBlVOs(){
		BkgUsaWhfBlVO[] vos = (BkgUsaWhfBlVO[])models.toArray(new BkgUsaWhfBlVO[models.size()]);
		return vos;
	}
