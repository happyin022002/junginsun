...
*@FileName : MasMonVvdPortCostVO.java
*@FileTitle : MasMonVvdPortCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonVvdPortCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonVvdPortCostVO> models = new ArrayList<MasMonVvdPortCostVO>();
	 ...
	 * @param request
	 * @return MasMonVvdPortCostVO[]
	 */
	public MasMonVvdPortCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonVvdPortCostVO[]
	 */
	public MasMonVvdPortCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonVvdPortCostVO model = null;
		...
		return getMasMonVvdPortCostVOs();
	}
	 ...
	 * @return MasMonVvdPortCostVO[]
	 */
	public MasMonVvdPortCostVO[] getMasMonVvdPortCostVOs(){
		MasMonVvdPortCostVO[] vos = (MasMonVvdPortCostVO[])models.toArray(new MasMonVvdPortCostVO[models.size()]);
		return vos;
	}
