...
*@FileName : BkgCstmsAnrEdiHisVO.java
*@FileTitle : BkgCstmsAnrEdiHisVO
*Open Issues :
*Change history :
...
public class BkgCstmsAnrEdiHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsAnrEdiHisVO> models = new ArrayList<BkgCstmsAnrEdiHisVO>();
	 ...
	 */
	public BkgCstmsAnrEdiHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsAnrEdiHisVO[]
	 */
	public BkgCstmsAnrEdiHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsAnrEdiHisVO model = null;
		...
		return getBkgCstmsAnrEdiHisVOs();
	}
	 ...
	 * @return BkgCstmsAnrEdiHisVO[]
	 */
	public BkgCstmsAnrEdiHisVO[] getBkgCstmsAnrEdiHisVOs(){
		BkgCstmsAnrEdiHisVO[] vos = (BkgCstmsAnrEdiHisVO[])models.toArray(new BkgCstmsAnrEdiHisVO[models.size()]);
		return vos;
	}
