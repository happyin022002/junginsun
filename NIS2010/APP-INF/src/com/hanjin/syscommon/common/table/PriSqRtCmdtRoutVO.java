...
*@FileName : PriSqRtCmdtRoutVO.java
*@FileTitle : PriSqRtCmdtRoutVO
*Open Issues :
*Change history :
...
public class PriSqRtCmdtRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqRtCmdtRoutVO> models = new ArrayList<PriSqRtCmdtRoutVO>();
	 ...
	 */
	public PriSqRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqRtCmdtRoutVO[]
	 */
	public PriSqRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqRtCmdtRoutVO model = null;
	...
	public PriSqRtCmdtRoutVO[] getPriSqRtCmdtRoutVOs(){
		PriSqRtCmdtRoutVO[] vos = (PriSqRtCmdtRoutVO[])models.toArray(new PriSqRtCmdtRoutVO[models.size()]);
		return vos;
	}
