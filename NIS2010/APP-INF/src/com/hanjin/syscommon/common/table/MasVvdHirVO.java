...
*@FileName : MasVvdHirVO.java
*@FileTitle : MasVvdHirVO
*Open Issues :
*Change history :
 ...
 */
public class MasVvdHirVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasVvdHirVO> models = new ArrayList<MasVvdHirVO>();
	 ...
	 * @return MasVvdHirVO[]
	 */
	public MasVvdHirVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasVvdHirVO[]
	 */
	public MasVvdHirVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasVvdHirVO model = null;
	 ...
	 * @return MasVvdHirVO[]
	 */
	public MasVvdHirVO[] getMasVvdHirVOs(){
		MasVvdHirVO[] vos = (MasVvdHirVO[])models.toArray(new MasVvdHirVO[models.size()]);
		return vos;
	}
