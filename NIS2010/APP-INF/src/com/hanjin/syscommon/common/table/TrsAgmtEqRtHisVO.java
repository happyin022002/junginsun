...
*@FileName : TrsAgmtEqRtHisVO.java
*@FileTitle : TrsAgmtEqRtHisVO
*Open Issues :
*Change history :
...
public class TrsAgmtEqRtHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TrsAgmtEqRtHisVO> models = new ArrayList<TrsAgmtEqRtHisVO>();
...
/**
	 ...
	 */
	public TrsAgmtEqRtHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TrsAgmtEqRtHisVO[]
	 */
	public TrsAgmtEqRtHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TrsAgmtEqRtHisVO model = null;
	...
	public TrsAgmtEqRtHisVO[] getTrsAgmtEqRtHisVOs(){
		TrsAgmtEqRtHisVO[] vos = (TrsAgmtEqRtHisVO[])models.toArray(new TrsAgmtEqRtHisVO[models.size()]);
		return vos;
	}
