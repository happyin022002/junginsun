...
*@FileName : PriSqGrpCmdtVO.java
*@FileTitle : PriSqGrpCmdtVO
*Open Issues :
*Change history :
...
public class PriSqGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqGrpCmdtVO> models = new ArrayList<PriSqGrpCmdtVO>();
	...
	public PriSqGrpCmdtVO() {}

	public PriSqGrpCmdtVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriSqGrpCmdtVO[]
	 */
	public PriSqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqGrpCmdtVO[]
	 */
	public PriSqGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqGrpCmdtVO model = null;
	 ...
	 * @return PriSqGrpCmdtVO[]
	 */
	public PriSqGrpCmdtVO[] getPriSqGrpCmdtVOs(){
		PriSqGrpCmdtVO[] vos = (PriSqGrpCmdtVO[])models.toArray(new PriSqGrpCmdtVO[models.size()]);
		return vos;
	}
