...
public class VskLanePicVO extends AbstractValueObject {
	...
	/* Column Info */
	private String picCrrDesc = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pic_crr_desc", getPicCrrDesc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pic_crr_desc", "picCrrDesc");
	 ...
	 * @return picCrrDesc
	 */
	public String getPicCrrDesc() {
		return this.picCrrDesc;
	}
	 ...
	 * @param picCrrDesc
	 */
	public void setPicCrrDesc(String picCrrDesc) {
		this.picCrrDesc = picCrrDesc;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPicCrrDesc(JSPUtil.getParameter(request, prefix + "pic_crr_desc", ""));
	}
	...
	public VskLanePicVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] picCrrDesc = (JSPUtil.getParameter(request, prefix	+ "pic_crr_desc", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (picCrrDesc[i] != null)
					model.setPicCrrDesc(picCrrDesc[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.picCrrDesc = this.picCrrDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
