...
*@FileName : SpcAlocCustPolPodVO.java
*@FileTitle : SpcAlocCustPolPodVO
*Open Issues :
*Change history :
...
* 2013.03.12 최윤성 
* 1.0 Creation
* 2013.03.12 최윤성 [CHM-201322502-01] SPC 프로젝트 - 성수기 선복운영 개선을 위한 T/F추진 
=========================================================*/
...
public class SpcAlocCustPolPodVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpcAlocCustPolPodVO> models = new ArrayList<SpcAlocCustPolPodVO>();
	...
	/* Column Info */
	private String checkLvl = null;
	
	/* Column Info */
	private String ctrlWt = null;

	/* Column Info */
	private String orgOfc = null;
	...
	public SpcAlocCustPolPodVO() {}

	public SpcAlocCustPolPodVO(String ibflag, String pagerows, String rlaneCd, String dirCd, String vslCd, String skdVoyNo,
			                   String skdDirCd, String slsOfcCd, String polYdCd, String delYdCd, String podYdCd, String tsFlg, String mnlFlg,
			                   String custCntCd, String custSeq, String custCtrlCd, String repTrdCd, String repSubTrdCd, String trdCd,
			                   String subTrdCd, String iocCd, String slsRhqCd, String slsRgnOfcCd, String asgnTtlQty, String asgn20ftQty,
			                   String asgn40ftQty, String asgn40ftHcQty, String asgn45ftHcQty, String asgn53ftQty, String asgnRfQty, String asgnTtlWgt,
			                   String bkgAvalTtlQty, String bkgAval20ftQty, String bkgAval40ftQty, String bkgAval40ftHcQty, String bkgAval45ftHcQty,
			                   String bkgAval53ftQty, String bkgAvalRfQty, String bkgAvalTtlWgt, String mnlAlocRmk, String alocUsrId, String alocGdt,
			                   String slsAqCd, String fcastTtlQty, String fcast40ftHcQty, String fcast45ftHcQty, String fcast53ftQty, String fcastRfQty,
			                   String fcastTtlWgt, String usdBkgTtlQty, String usdBkg20ftQty, String usdBkg40ftQty, String usdBkg40ftHcQty, String usdBkg45ftHcQty,
			                   String usdBkg53ftQty, String usdBkgRfQty, String usdBkgTtlWgt, String spcCtrlAlocRmk, String spcCtrlAlocPolRmk, String spcCtrlAlocPodRmk,
			                   String polIndSeq, String podIndSeq, String polYdIndSeq, String podYdIndSeq, String creUsrId, String creDt, String updUsrId, String updDt,
			                   String polCd, String podCd, String ctrlLvlCd, String usMod, String accountCd, String delCd, String asgnD2Qty, String asgnD4Qty,
			                   String asgnRdQty, String usdBkgD2Qty, String usdBkgD4Qty, String usdBkgRdQty, String bsTeu, String bsWgt, String checkLvl, String ctrlWt,
			                   String fcastD2Qty,String fcastD4Qty, String fcastRdQty, String bkgAvalD2Qty, String bkgAvalD4Qty, String bkgAvalRdQty, String ctrtNo, String alocMdfy, String orgOfc) {
		this.vslCd = vslCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("check_lvl", getCheckLvl() );
		this.hashColumns.put("ctrl_wt", getCtrlWt() );

		this.hashColumns.put("org_ofc", getOrgOfc() );
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("check_lvl", "checkLvl");
		this.hashFields.put("ctrl_wt", "ctrlWt");

		this.hashFields.put("org_ofc", "orgOfc");
	 ...
	 * @return checkLvl
	 */
	public String getCheckLvl() {
		return this.checkLvl;
	}
	 ...
	 * @param checkLvl
	 */
	public void setCheckLvl(String checkLvl) {
		this.checkLvl = checkLvl;
	}
	 ...
	 * @param orgOfc
	 */
	public void setOrgOfc(String orgOfc) {
		this.orgOfc = orgOfc;
	}
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setBkgAval40ftQty(JSPUtil.getParameter(request, prefix + "bkg_aval_40ft_qty", ""));
		...
		setAsgnRfQty(JSPUtil.getParameter(request, prefix + "asgn_rf_qty", ""));
		setBkgAvalTtlWgt(JSPUtil.getParameter(request, prefix + "bkg_aval_ttl_wgt", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setSpcCtrlAlocRmk(JSPUtil.getParameter(request, prefix + "spc_ctrl_aloc_rmk", ""));
		setMnlAlocRmk(JSPUtil.getParameter(request, prefix + "mnl_aloc_rmk", ""));
		setSlsOfcCd(JSPUtil.getParameter(request, prefix + "sls_ofc_cd", ""));
		setAlocUsrId(JSPUtil.getParameter(request, prefix + "aloc_usr_id", ""));
		setAsgn40ftQty(JSPUtil.getParameter(request, prefix + "asgn_40ft_qty", ""));
		setUsdBkg40ftHcQty(JSPUtil.getParameter(request, prefix + "usd_bkg_40ft_hc_qty", ""));
		setBkgAvalRfQty(JSPUtil.getParameter(request, prefix + "bkg_aval_rf_qty", ""));
		setUpdUsrId(JSPUtil.getParameter(request, prefix + "upd_usr_id", ""));
		setCustCntCd(JSPUtil.getParameter(request, prefix + "cust_cnt_cd", ""));
		setSlsAqCd(JSPUtil.getParameter(request, prefix + "sls_aq_cd", ""));
		setAsgn20ftQty(JSPUtil.getParameter(request, prefix + "asgn_20ft_qty", ""));
		setSkdVoyNo(JSPUtil.getParameter(request, prefix + "skd_voy_no", ""));
		setBkgAval53ftQty(JSPUtil.getParameter(request, prefix + "bkg_aval_53ft_qty", ""));
		...
		setAsgn45ftHcQty(JSPUtil.getParameter(request, prefix + "asgn_45ft_hc_qty", ""));
		setCreDt(JSPUtil.getParameter(request, prefix + "cre_dt", ""));
		setUsdBkg20ftQty(JSPUtil.getParameter(request, prefix + "usd_bkg_20ft_qty", ""));
		setBkgAval40ftHcQty(JSPUtil.getParameter(request, prefix + "bkg_aval_40ft_hc_qty", ""));
		setAsgnTtlQty(JSPUtil.getParameter(request, prefix + "asgn_ttl_qty", ""));
		...
		setAsgn40ftHcQty(JSPUtil.getParameter(request, prefix + "asgn_40ft_hc_qty", ""));
		setCustSeq(JSPUtil.getParameter(request, prefix + "cust_seq", ""));
		setSkdDirCd(JSPUtil.getParameter(request, prefix + "skd_dir_cd", ""));
		setBkgAvalTtlQty(JSPUtil.getParameter(request, prefix + "bkg_aval_ttl_qty", ""));
		setBkgAval45ftHcQty(JSPUtil.getParameter(request, prefix + "bkg_aval_45ft_hc_qty", ""));
		setAsgn53ftQty(JSPUtil.getParameter(request, prefix + "asgn_53ft_qty", ""));
		setBkgAval20ftQty(JSPUtil.getParameter(request, prefix + "bkg_aval_20ft_qty", ""));
		...
		setCheckLvl(JSPUtil.getParameter(request, "check_lvl", ""));
		setCtrlWt(JSPUtil.getParameter(request, "ctrl_wt", ""));

		setOrgOfc(JSPUtil.getParameter(request, "org_ofc", ""));
	}
	 ...
	 */
	public SpcAlocCustPolPodVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpcAlocCustPolPodVO[]
	 */
	public SpcAlocCustPolPodVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpcAlocCustPolPodVO model = null;
		...
		try {
			...
			String[] checkLvl  = (JSPUtil.getParameter(request, prefix	+ "check_lvl"    , length));
			String[] ctrlWt  = (JSPUtil.getParameter(request, prefix	+ "ctrl_wt"    , length));

			String[] orgOfc  = (JSPUtil.getParameter(request, prefix	+ "org_ofc"    , length));
			
			
			
			for (int i = 0; i < length; i++) {
				model = new SpcAlocCustPolPodVO();
				if (vslCd[i] != null)
				...
				if (checkLvl[i] != null)
					model.setCheckLvl(checkLvl[i]);
				
				if (ctrlWt[i] != null)
					model.setCtrlWt(ctrlWt[i]);
				
				if (orgOfc[i] != null)
					model.setOrgOfc(orgOfc[i]);
		...
		return getSpcAlocCustPolPodVOs();
	}
	...
	public SpcAlocCustPolPodVO[] getSpcAlocCustPolPodVOs(){
		SpcAlocCustPolPodVO[] vos = (SpcAlocCustPolPodVO[])models.toArray(new SpcAlocCustPolPodVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.checkLvl    = this.checkLvl.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ctrlWt    = this.ctrlWt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");

		this.orgOfc    = this.orgOfc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
