...
*@FileName : EasPortSoCfmInvHisVO.java
*@FileTitle : EasPortSoCfmInvHisVO
*Open Issues :
*Change history :
...
public class EasPortSoCfmInvHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EasPortSoCfmInvHisVO> models = new ArrayList<EasPortSoCfmInvHisVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("aud_his_seq", getAudHisSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("aud_his_seq", "audHisSeq");
	 ...
	 * @return audHisSeq
	 */
	public String getAudHisSeq() {
		return this.audHisSeq;
	}
	 ...
	 * @param audHisSeq
	 */
	public void setAudHisSeq(String audHisSeq) {
		this.audHisSeq = audHisSeq;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAudHisSeq(JSPUtil.getParameter(request, prefix + "aud_his_seq", ""));
	 ...
	 * @param request
	 * @return EasPortSoCfmInvHisVO[]
	 */
	public EasPortSoCfmInvHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EasPortSoCfmInvHisVO[]
	 */
	public EasPortSoCfmInvHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EasPortSoCfmInvHisVO model = null;
		...
		try {
			...
			String[] audHisSeq = (JSPUtil.getParameter(request, prefix	+ "aud_his_seq", length));
			...
			for (int i = 0; i < length; i++) {
				model = new EasPortSoCfmInvHisVO();
				if (vslCd[i] != null)
				...
				if (audHisSeq[i] != null)
					model.setAudHisSeq(audHisSeq[i]);
				if (csrNo[i] != null)
		...
		return getEasPortSoCfmInvHisVOs();
	}
	 ...
	 * @return EasPortSoCfmInvHisVO[]
	 */
	public EasPortSoCfmInvHisVO[] getEasPortSoCfmInvHisVOs(){
		EasPortSoCfmInvHisVO[] vos = (EasPortSoCfmInvHisVO[])models.toArray(new EasPortSoCfmInvHisVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.audHisSeq = this.audHisSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
