...
*@FileName : SqmQtaTgtVvdVO.java
*@FileTitle : SqmQtaTgtVvdVO
*Open Issues :
*Change history :
...
public class SqmQtaTgtVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmQtaTgtVvdVO> models = new ArrayList<SqmQtaTgtVvdVO>();
...
/**
	 ...
	 */
	public SqmQtaTgtVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmQtaTgtVvdVO[]
	 */
	public SqmQtaTgtVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmQtaTgtVvdVO model = null;
	...
	public SqmQtaTgtVvdVO[] getSqmQtaTgtVvdVOs(){
		SqmQtaTgtVvdVO[] vos = (SqmQtaTgtVvdVO[])models.toArray(new SqmQtaTgtVvdVO[models.size()]);
		return vos;
	}
