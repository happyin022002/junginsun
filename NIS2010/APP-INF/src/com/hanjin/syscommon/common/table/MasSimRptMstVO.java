...
*@FileName : MasSimRptMstVO.java
*@FileTitle : MasSimRptMstVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimRptMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimRptMstVO> models = new ArrayList<MasSimRptMstVO>();
	...
	public MasSimRptMstVO() {}

	public MasSimRptMstVO(String ibflag, String pagerows, String simDt, String simNo, String sectNo, String simRptNo, String ldfRto, String grsRpbRev, String bnkCostAmt, String simRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSimRptMstVO[]
	 */
	public MasSimRptMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimRptMstVO[]
	 */
	public MasSimRptMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimRptMstVO model = null;
	 ...
	 * @return MasSimRptMstVO[]
	 */
	public MasSimRptMstVO[] getMasSimRptMstVOs(){
		MasSimRptMstVO[] vos = (MasSimRptMstVO[])models.toArray(new MasSimRptMstVO[models.size()]);
		return vos;
	}
