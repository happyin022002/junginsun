...
*@FileName : MasSimCtrbMgnCostVO.java
*@FileTitle : MasSimCtrbMgnCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimCtrbMgnCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimCtrbMgnCostVO> models = new ArrayList<MasSimCtrbMgnCostVO>();
	...
	public MasSimCtrbMgnCostVO() {}

	public MasSimCtrbMgnCostVO(String ibflag, String pagerows, String simDt, String simNo, String sectNo, String polCd, String podCd, String sgrpCostCd, String cgoVarUcAmt, String cgoVarAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public MasSimCtrbMgnCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimCtrbMgnCostVO[]
	 */
	public MasSimCtrbMgnCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimCtrbMgnCostVO model = null;
		...
		return getMasSimCtrbMgnCostVOs();
	}
	 ...
	 * @return MasSimCtrbMgnCostVO[]
	 */
	public MasSimCtrbMgnCostVO[] getMasSimCtrbMgnCostVOs(){
		MasSimCtrbMgnCostVO[] vos = (MasSimCtrbMgnCostVO[])models.toArray(new MasSimCtrbMgnCostVO[models.size()]);
		return vos;
	}
