...
*@FileName : MasMnGrpCostVO.java
*@FileTitle : MasMnGrpCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasMnGrpCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMnGrpCostVO> models = new ArrayList<MasMnGrpCostVO>();
	...
	public MasMnGrpCostVO() {}

	public MasMnGrpCostVO(String ibflag, String pagerows, String mgrpCostCd, String stndCostTpCd, String mgrpCostCdDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasMnGrpCostVO[]
	 */
	public MasMnGrpCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMnGrpCostVO[]
	 */
	public MasMnGrpCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMnGrpCostVO model = null;
	 ...
	 * @return MasMnGrpCostVO[]
	 */
	public MasMnGrpCostVO[] getMasMnGrpCostVOs(){
		MasMnGrpCostVO[] vos = (MasMnGrpCostVO[])models.toArray(new MasMnGrpCostVO[models.size()]);
		return vos;
	}
