...
public class MdmChargeVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ind_sac_cd", getIndSacCd());
		...
		this.hashColumns.put("ind_chg_nm", getIndChgNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ind_sac_cd", "indSacCd");
		...
		this.hashFields.put("ind_chg_nm", "indChgNm");
	 ...
	 * @return indSacCd
	 */
	public String getIndSacCd() {
		return this.indSacCd;
	}
	 ...
	 * @return indChgNm
	 */
	public String getIndChgNm() {
		return this.indChgNm;
	}
	 ...
	 * @param indSacCd
	 */
	public void setIndSacCd(String indSacCd) {
		this.indSacCd = indSacCd;
	}
	 ...
	 * @param indChgNm
	 */
	public void setIndChgNm(String indChgNm) {
		this.indChgNm = indChgNm;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setIndSacCd(JSPUtil.getParameter(request, prefix + "ind_sac_cd", ""));
		...
		setIndChgNm(JSPUtil.getParameter(request, prefix + "ind_chg_nm", ""));
	...
	public MdmChargeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] indSacCd = (JSPUtil.getParameter(request, prefix	+ "ind_sac_cd", length));
			...
			String[] indChgNm = (JSPUtil.getParameter(request, prefix	+ "ind_chg_nm", length));
	...
	*/
	public void unDataFormat(){
		...
		this.indSacCd = this.indSacCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.indChgNm = this.indChgNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
