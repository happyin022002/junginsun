...
*@FileName : MasBkgCostSrcDtlVO.java
*@FileTitle : MasBkgCostSrcDtlVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgCostSrcDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgCostSrcDtlVO> models = new ArrayList<MasBkgCostSrcDtlVO>();
	 ...
	 * @param request
	 * @return MasBkgCostSrcDtlVO[]
	 */
	public MasBkgCostSrcDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgCostSrcDtlVO[]
	 */
	public MasBkgCostSrcDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgCostSrcDtlVO model = null;
	 ...
	 * @return MasBkgCostSrcDtlVO[]
	 */
	public MasBkgCostSrcDtlVO[] getMasBkgCostSrcDtlVOs(){
		MasBkgCostSrcDtlVO[] vos = (MasBkgCostSrcDtlVO[])models.toArray(new MasBkgCostSrcDtlVO[models.size()]);
		return vos;
	}
