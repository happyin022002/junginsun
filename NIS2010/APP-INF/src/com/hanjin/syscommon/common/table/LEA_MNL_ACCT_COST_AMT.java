...
*@FileName : LEA_MNL_ACCT_COST_AMT.java
 ...
 * @since J2EE 1.4
 */
public final class LEA_MNL_ACCT_COST_AMT implements java.io.Serializable {
	...
	public static LEA_MNL_ACCT_COST_AMT fromRequest(HttpServletRequest request) {
		LEA_MNL_ACCT_COST_AMT model = new LEA_MNL_ACCT_COST_AMT();
		try {
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		LEA_MNL_ACCT_COST_AMT model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new LEA_MNL_ACCT_COST_AMT();
