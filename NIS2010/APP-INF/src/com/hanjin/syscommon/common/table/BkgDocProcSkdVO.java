...
public class BkgDocProcSkdVO extends AbstractValueObject {
	...
	/* Column Info */
	private String pairFlg = null;
	/* Column Info */
	private String oldDiffRmk = null;
	/* Column Info */
	...
	public BkgDocProcSkdVO(String ibflag, String pagerows, String bkgNo, String bkgNoSplit, String bkgDocProcTpCd, String docProcSeq, String evntDt, String evntUsrId, String diffRmk, String bkgEvntCd1, String bkgEvntCd2, String docPerfDeltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String pairFlg, String oldDiffRmk, String caFlg) {
		this.updDt = updDt;
		...
		this.evntDt = evntDt;
		this.pairFlg = pairFlg;
		this.oldDiffRmk = oldDiffRmk;
		this.caFlg = caFlg;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pair_flg", getPairFlg());
		this.hashColumns.put("old_diff_rmk", getOldDiffRmk());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pair_flg", "pairFlg");
		this.hashFields.put("old_diff_rmk", "oldDiffRmk");
	 ...
	 * @return oldDiffRmk
	 */
	public String getOldDiffRmk() {
		return this.oldDiffRmk;
	}
	 ...
	 * @param pairFlg
	 */
	public void setPairFlg(String pairFlg) {
		this.pairFlg = pairFlg;
	}
	 ...
	 * @param oldDiffRmk
	 */
	public void setOldDiffRmk(String oldDiffRmk) {
		this.oldDiffRmk = oldDiffRmk;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPairFlg(JSPUtil.getParameter(request, "pair_flg", ""));
		setEvntDt(JSPUtil.getParameter(request, "evnt_dt", ""));
		setOldDiffRmk(JSPUtil.getParameter(request, "old_diff_rmk", ""));
	}
	...
	public BkgDocProcSkdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] pairFlg = (JSPUtil.getParameter(request, prefix	+ "pair_flg", length));
			String[] oldDiffRmk = (JSPUtil.getParameter(request, prefix	+ "old_diff_rmk", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (pairFlg[i] != null)
					model.setPairFlg(pairFlg[i]);
				if (oldDiffRmk[i] != null)
					model.setOldDiffRmk(oldDiffRmk[i]);
				if (caFlg[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.pairFlg = this.pairFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.evntDt = this.evntDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.oldDiffRmk = this.oldDiffRmk .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
