...
*@FileName : EqrCtrlMtyBkgExeQtyVO.java
*@FileTitle : EqrCtrlMtyBkgExeQtyVO
*Open Issues :
*Change history :
...
public class EqrCtrlMtyBkgExeQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrCtrlMtyBkgExeQtyVO> models = new ArrayList<EqrCtrlMtyBkgExeQtyVO>();
	...
	public EqrCtrlMtyBkgExeQtyVO() {}

	public EqrCtrlMtyBkgExeQtyVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String bkgExeSeq, String cntrTpszCd, String cntrQty, String creUsrId, String creDt, String updUsrId, String updDt, String trspModCd) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return EqrCtrlMtyBkgExeQtyVO[]
	 */
	public EqrCtrlMtyBkgExeQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrCtrlMtyBkgExeQtyVO[]
	 */
	public EqrCtrlMtyBkgExeQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrCtrlMtyBkgExeQtyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EqrCtrlMtyBkgExeQtyVO();
				if (updDt[i] != null)
		...
		return getEqrCtrlMtyBkgExeQtyVOs();
	}
	 ...
	 * @return EqrCtrlMtyBkgExeQtyVO[]
	 */
	public EqrCtrlMtyBkgExeQtyVO[] getEqrCtrlMtyBkgExeQtyVOs(){
		EqrCtrlMtyBkgExeQtyVO[] vos = (EqrCtrlMtyBkgExeQtyVO[])models.toArray(new EqrCtrlMtyBkgExeQtyVO[models.size()]);
		return vos;
	}
