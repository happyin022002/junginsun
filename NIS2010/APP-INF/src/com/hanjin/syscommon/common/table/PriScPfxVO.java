...
*@FileName : PriScPfxVO.java
*@FileTitle : PriScPfxVO
*Open Issues :
*Change history :
...
public class PriScPfxVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriScPfxVO> models = new ArrayList<PriScPfxVO>();
	...
	public PriScPfxVO(String ibflag, String pagerows, String scPfxCd, String scPfxDesc, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setScPfxDesc(JSPUtil.getParameter(request, prefix + "sc_pfx_desc", ""));
	 ...
	 * @return PriScPfxVO[]
	 */
	public PriScPfxVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriScPfxVO[]
	 */
	public PriScPfxVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriScPfxVO model = null;
		...
		try {
			...
			String[] scPfxDesc = (JSPUtil.getParameter(request, prefix	+ "sc_pfx_desc", length));
	...
	public PriScPfxVO[] getPriScPfxVOs(){
		PriScPfxVO[] vos = (PriScPfxVO[])models.toArray(new PriScPfxVO[models.size()]);
		return vos;
	}
