...
*@FileName : BkgCstmsJpBlCustVO.java
*@FileTitle : BkgCstmsJpBlCustVO
*Open Issues :
*Change history :
*	2017.09.07 하대성 podCd Column Add
 ...
 */
public class BkgCstmsJpBlCustVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<BkgCstmsJpBlCustVO> models = new ArrayList<BkgCstmsJpBlCustVO>();
    ...
    public BkgCstmsJpBlCustVO() {
    }

    public BkgCstmsJpBlCustVO(String ibflag, String pagerows, String blNo, String blSplitNo, String bkgCustTpCd, String custCntCd, String custSeq, String custNm, String custAddr, String phnNo, String faxNo, String creUsrId, String creDt, String updUsrId, String updDt, String podCd) {
        this.updDt = updDt;
        this.phnNo = phnNo;
        this.custNm = custNm;
        this.creDt = creDt;
	 ...
	 * @param request
	 * @return BkgCstmsJpBlCustVO[]
	 */
    public BkgCstmsJpBlCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsJpBlCustVO[]
	 */
    public BkgCstmsJpBlCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        BkgCstmsJpBlCustVO model = null;
	 ...
	 * @return BkgCstmsJpBlCustVO[]
	 */
    public BkgCstmsJpBlCustVO[] getBkgCstmsJpBlCustVOs() {
        BkgCstmsJpBlCustVO[] vos = (BkgCstmsJpBlCustVO[]) models.toArray(new BkgCstmsJpBlCustVO[models.size()]);
        return vos;
    }
