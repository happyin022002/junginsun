...
*@FileName : MasPortTrfVO.java
*@FileTitle : MasPortTrfVO
*Open Issues :
*Change history :
 ...
 */
public class MasPortTrfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasPortTrfVO> models = new ArrayList<MasPortTrfVO>();
	...
	public MasPortTrfVO(String ibflag, String pagerows, String slanCd, String vslCd, String skdVoyNo, String skdDirCd, String tmlCd, String portUsdAmt, String cnlUsdAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
...
/**
	 ...
	 * @return MasPortTrfVO[]
	 */
	public MasPortTrfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasPortTrfVO[]
	 */
	public MasPortTrfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasPortTrfVO model = null;
	...
	public MasPortTrfVO[] getMasPortTrfVOs(){
		MasPortTrfVO[] vos = (MasPortTrfVO[])models.toArray(new MasPortTrfVO[models.size()]);
		return vos;
	}
