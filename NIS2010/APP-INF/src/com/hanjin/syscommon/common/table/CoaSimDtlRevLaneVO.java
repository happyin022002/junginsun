...
*@FileName : CoaSimDtlRevLaneVO.java
*@FileTitle : CoaSimDtlRevLaneVO
*Open Issues :
*Change history :
...
public class CoaSimDtlRevLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaSimDtlRevLaneVO> models = new ArrayList<CoaSimDtlRevLaneVO>();
	...
	public CoaSimDtlRevLaneVO() {}

	public CoaSimDtlRevLaneVO(String ibflag, String pagerows, String rlaneCd, String skdDirCd, String iocCd, String fmContiCd, String toContiCd, String trdCd, String subTrdCd, String slanCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
	 ...
	 * @param request
	 * @return CoaSimDtlRevLaneVO[]
	 */
	public CoaSimDtlRevLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaSimDtlRevLaneVO[]
	 */
	public CoaSimDtlRevLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaSimDtlRevLaneVO model = null;
	 ...
	 * @return CoaSimDtlRevLaneVO[]
	 */
	public CoaSimDtlRevLaneVO[] getCoaSimDtlRevLaneVOs(){
		CoaSimDtlRevLaneVO[] vos = (CoaSimDtlRevLaneVO[])models.toArray(new CoaSimDtlRevLaneVO[models.size()]);
		return vos;
	}
