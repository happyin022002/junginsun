...
*@FileName : BsaOcnOvrMstVO.java
*@FileTitle : BsaOcnOvrMstVO
*Open Issues :
*Change history :
...
public class BsaOcnOvrMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaOcnOvrMstVO> models = new ArrayList<BsaOcnOvrMstVO>();
	...
	public BsaOcnOvrMstVO() {}

	public BsaOcnOvrMstVO(String ibflag, String pagerows, String bsaSltCostTpCd, String ovrUsdSltPrcSeq, String cntrFullFlg, String trdCd, String rlaneCd, String dirCd, String vvdCd, String bsaSltPrcFmDt, String bsaSltPrcToDt, String bsaErrFlg, String deltFlg, String errLogRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return BsaOcnOvrMstVO[]
	 */
	public BsaOcnOvrMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaOcnOvrMstVO[]
	 */
	public BsaOcnOvrMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaOcnOvrMstVO model = null;
	 ...
	 * @return BsaOcnOvrMstVO[]
	 */
	public BsaOcnOvrMstVO[] getBsaOcnOvrMstVOs(){
		BsaOcnOvrMstVO[] vos = (BsaOcnOvrMstVO[])models.toArray(new BsaOcnOvrMstVO[models.size()]);
		return vos;
	}
