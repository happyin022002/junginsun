...
*@FileName : PriNoteConvGrpLocVO.java
*@FileTitle : PriNoteConvGrpLocVO
*Open Issues :
*Change history :
*@LastModifyDate : 2013.08.21
*@LastModifier : CHLOE MIJIN SEO
*@LastVersion : 1.0
* 2013.08.21 CHLOE MIJIN SEO 
* 1.0 Creation
=========================================================*/
...
public class PriNoteConvGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriNoteConvGrpLocVO> models = new ArrayList<PriNoteConvGrpLocVO>();
	...
	public PriNoteConvGrpLocVO() {}

	public PriNoteConvGrpLocVO(String ibflag, String pagerows, String prcCtrtTpCd, String noteConvGrpLocCd, String noteConvGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setNoteConvGrpLocDesc(JSPUtil.getParameter(request, prefix + "note_conv_grp_loc_desc", ""));
		setNoteConvGrpLocCd(JSPUtil.getParameter(request, prefix + "note_conv_grp_loc_cd", ""));
	 ...
	 */
	public PriNoteConvGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriNoteConvGrpLocVO[]
	 */
	public PriNoteConvGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriNoteConvGrpLocVO model = null;
		...
		return getPriNoteConvGrpLocVOs();
	}
	...
	public PriNoteConvGrpLocVO[] getPriNoteConvGrpLocVOs(){
		PriNoteConvGrpLocVO[] vos = (PriNoteConvGrpLocVO[])models.toArray(new PriNoteConvGrpLocVO[models.size()]);
		return vos;
	}
