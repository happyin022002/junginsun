...
public class TesEdiRcvFltFileXcldVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesEdiRcvFltFileXcldVO> models = new ArrayList<TesEdiRcvFltFileXcldVO>();
	...
	public TesEdiRcvFltFileXcldVO() {}

	public TesEdiRcvFltFileXcldVO(String ibflag, String pagerows, String ediRcvRuleMnSeq, String ediVndrSeq, String fltFileTagNm, String fltFileKeyNm, String dfltValCtnt, String qttnConcFlg, String rplcValFlg, String rplcValCtnt, String creUsrId, String creDt, String updUsrId, String updDt, String savSeq) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public TesEdiRcvFltFileXcldVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesEdiRcvFltFileXcldVO[]
	 */
	public TesEdiRcvFltFileXcldVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesEdiRcvFltFileXcldVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesEdiRcvFltFileXcldVO();
				if (updDt[i] != null)
	 ...
	 * @return TesEdiRcvFltFileXcldVO[]
	 */
	public TesEdiRcvFltFileXcldVO[] getTesEdiRcvFltFileXcldVOs(){
		TesEdiRcvFltFileXcldVO[] vos = (TesEdiRcvFltFileXcldVO[])models.toArray(new TesEdiRcvFltFileXcldVO[models.size()]);
		return vos;
	}
