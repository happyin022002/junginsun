...
*@FileName : PriRgGrpLocVO.java
*@FileTitle : PriRgGrpLocVO
*Open Issues :
*Change history :
...
public class PriRgGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgGrpLocVO> models = new ArrayList<PriRgGrpLocVO>();
	...
	public PriRgGrpLocVO() {}

	public PriRgGrpLocVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String grpLocSeq, String orgDestTpCd, String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRgGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgGrpLocVO[]
	 */
	public PriRgGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgGrpLocVO model = null;
	...
	public PriRgGrpLocVO[] getPriRgGrpLocVOs(){
		PriRgGrpLocVO[] vos = (PriRgGrpLocVO[])models.toArray(new PriRgGrpLocVO[models.size()]);
		return vos;
	}
