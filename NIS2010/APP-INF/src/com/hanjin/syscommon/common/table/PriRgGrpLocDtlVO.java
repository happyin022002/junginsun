...
*@FileName : PriRgGrpLocDtlVO.java
*@FileTitle : PriRgGrpLocDtlVO
*Open Issues :
*Change history :
...
public class PriRgGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgGrpLocDtlVO> models = new ArrayList<PriRgGrpLocDtlVO>();
	...
	public PriRgGrpLocDtlVO() {}

	public PriRgGrpLocDtlVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String grpLocSeq, String grpLocDtlSeq, String locCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRgGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgGrpLocDtlVO[]
	 */
	public PriRgGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgGrpLocDtlVO model = null;
	...
	public PriRgGrpLocDtlVO[] getPriRgGrpLocDtlVOs(){
		PriRgGrpLocDtlVO[] vos = (PriRgGrpLocDtlVO[])models.toArray(new PriRgGrpLocDtlVO[models.size()]);
		return vos;
	}
