...
public class TrsTrspRailInvDtlVO extends AbstractValueObject {
	...
	/* Column Info */
	private String dmstRepoFlg = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("dmst_repo_flg", getDmstRepoFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("dmst_repo_flg", "dmstRepoFlg");
	 ...
	 * @param dmstRepoFlg
	 */
	public void setDmstRepoFlg(String dmstRepoFlg) {
		this.dmstRepoFlg = dmstRepoFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDmstRepoFlg(JSPUtil.getParameter(request, "dmst_repo_flg", ""));
	}
	...
	public TrsTrspRailInvDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] dmstRepoFlg = (JSPUtil.getParameter(request, prefix	+ "dmst_repo_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (dmstRepoFlg[i] != null)
					model.setDmstRepoFlg(dmstRepoFlg[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.dmstRepoFlg = this.dmstRepoFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
