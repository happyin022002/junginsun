...
*@FileName : VskPfCallPortVO.java
*@FileTitle : VskPfCallPortVO
*Open Issues :
*Change history :
...
public class VskPfCallPortVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VskPfCallPortVO> models = new ArrayList<VskPfCallPortVO>();
	...
	public VskPfCallPortVO() {}

	public VskPfCallPortVO(String ibflag, String pagerows, String vslSlanCd, String pfSvcTpCd, String skdDirCd, String portCd, String clptSeq, String portRotnSeq, String ydCd, String callYdIndSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return VskPfCallPortVO[]
	 */
	public VskPfCallPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VskPfCallPortVO[]
	 */
	public VskPfCallPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VskPfCallPortVO model = null;
	 ...
	 * @return VskPfCallPortVO[]
	 */
	public VskPfCallPortVO[] getVskPfCallPortVOs(){
		VskPfCallPortVO[] vos = (VskPfCallPortVO[])models.toArray(new VskPfCallPortVO[models.size()]);
		return vos;
	}
