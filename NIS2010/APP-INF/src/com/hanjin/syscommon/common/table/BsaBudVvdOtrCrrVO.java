...
*@FileName : BsaBudVvdOtrCrrVO.java
*@FileTitle : BsaBudVvdOtrCrrVO
*Open Issues :
*Change history :
...
public class BsaBudVvdOtrCrrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaBudVvdOtrCrrVO> models = new ArrayList<BsaBudVvdOtrCrrVO>();
	...
	public BsaBudVvdOtrCrrVO() {}

	public BsaBudVvdOtrCrrVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String skdDirCd, String bsaOpJbCd, String crrCd, String crrBsaCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
		this.trdCd = trdCd;
...
/**
	 ...
	 * @param request
	 * @return BsaBudVvdOtrCrrVO[]
	 */
	public BsaBudVvdOtrCrrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaBudVvdOtrCrrVO[]
	 */
	public BsaBudVvdOtrCrrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaBudVvdOtrCrrVO model = null;
	 ...
	 * @return BsaBudVvdOtrCrrVO[]
	 */
	public BsaBudVvdOtrCrrVO[] getBsaBudVvdOtrCrrVOs(){
		BsaBudVvdOtrCrrVO[] vos = (BsaBudVvdOtrCrrVO[])models.toArray(new BsaBudVvdOtrCrrVO[models.size()]);
		return vos;
	}
