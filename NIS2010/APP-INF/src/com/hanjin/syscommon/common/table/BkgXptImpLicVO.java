...
public class BkgXptImpLicVO extends AbstractValueObject {
	...
	public BkgXptImpLicVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] trShprTaxId = (JSPUtil.getParameter(request, prefix	+ "tr_shpr_tax_id".trim(), length));
			String[] trCneeTaxId = (JSPUtil.getParameter(request, prefix	+ "tr_cnee_tax_id".trim(), length));
			String[] trNtfyTaxId = (JSPUtil.getParameter(request, prefix	+ "tr_ntfy_tax_id".trim(), length));
			String[] aesTpPrnFlg = (JSPUtil.getParameter(request, prefix	+ "aes_tp_prn_flg".trim(), length));
			String[] vinCtnt = (JSPUtil.getParameter(request, prefix	+ "vin_ctnt".trim(), length));
			String[] tgEctnNo = (JSPUtil.getParameter(request, prefix	+ "tg_ectn_no".trim(), length));
			String[] ngExsEnsNo = (JSPUtil.getParameter(request, prefix	+ "ng_exs_ens_no".trim(), length));
