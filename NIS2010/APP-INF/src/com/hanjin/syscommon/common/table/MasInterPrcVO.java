...
*@FileName : MasInterPrcVO.java
*@FileTitle : MasInterPrcVO
*Open Issues :
*Change history :
 ...
 */
public class MasInterPrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasInterPrcVO> models = new ArrayList<MasInterPrcVO>();
	 ...
	 * @param request
	 * @return MasInterPrcVO[]
	 */
	public MasInterPrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasInterPrcVO[]
	 */
	public MasInterPrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasInterPrcVO model = null;
	 ...
	 * @return MasInterPrcVO[]
	 */
	public MasInterPrcVO[] getMasInterPrcVOs(){
		MasInterPrcVO[] vos = (MasInterPrcVO[])models.toArray(new MasInterPrcVO[models.size()]);
		return vos;
	}
