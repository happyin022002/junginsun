...
*@FileName : MasOwnVslDlyHirVO.java
*@FileTitle : MasOwnVslDlyHirVO
*Open Issues :
*Change history :
 ...
 */
public class MasOwnVslDlyHirVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasOwnVslDlyHirVO> models = new ArrayList<MasOwnVslDlyHirVO>();
	...
	public MasOwnVslDlyHirVO() {}

	public MasOwnVslDlyHirVO(String ibflag, String pagerows, String costYrmon, String vslCd, String vslClssCapa, String stndCostCd, String dhirAmt, String ownVslRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasOwnVslDlyHirVO[]
	 */
	public MasOwnVslDlyHirVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasOwnVslDlyHirVO[]
	 */
	public MasOwnVslDlyHirVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasOwnVslDlyHirVO model = null;
	...
	public MasOwnVslDlyHirVO[] getMasOwnVslDlyHirVOs(){
		MasOwnVslDlyHirVO[] vos = (MasOwnVslDlyHirVO[])models.toArray(new MasOwnVslDlyHirVO[models.size()]);
		return vos;
	}
