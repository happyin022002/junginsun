...
*@FileName : PriSvcScpTrfVO.java
*@FileTitle : PriSvcScpTrfVO
*Open Issues :
*Change history :
...
public class PriSvcScpTrfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSvcScpTrfVO> models = new ArrayList<PriSvcScpTrfVO>();
	...
	public PriSvcScpTrfVO() {}

	public PriSvcScpTrfVO(String ibflag, String pagerows, String svcScpCd, String trfPfxCd, String trfNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public PriSvcScpTrfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSvcScpTrfVO[]
	 */
	public PriSvcScpTrfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSvcScpTrfVO model = null;
	...
	public PriSvcScpTrfVO[] getPriSvcScpTrfVOs(){
		PriSvcScpTrfVO[] vos = (PriSvcScpTrfVO[])models.toArray(new PriSvcScpTrfVO[models.size()]);
		return vos;
	}
