...
*@FileName : CoaNtwkCostCreVO.java
*@FileTitle : CoaNtwkCostCreVO
*Open Issues :
*Change history :
...
public class CoaNtwkCostCreVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaNtwkCostCreVO> models = new ArrayList<CoaNtwkCostCreVO>();
	...
	public CoaNtwkCostCreVO() {}

	public CoaNtwkCostCreVO(String ibflag, String pagerows, String stndCostCd, String vslOshpCd, String vopCd, String creStsCd, String creSlctFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaNtwkCostCreVO[]
	 */
	public CoaNtwkCostCreVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaNtwkCostCreVO[]
	 */
	public CoaNtwkCostCreVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaNtwkCostCreVO model = null;
	...
	public CoaNtwkCostCreVO[] getCoaNtwkCostCreVOs(){
		CoaNtwkCostCreVO[] vos = (CoaNtwkCostCreVO[])models.toArray(new CoaNtwkCostCreVO[models.size()]);
		return vos;
	}
