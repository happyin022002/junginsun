...
*@FileName : EqrInlndTrspPlnQtyVO.java
*@FileTitle : EqrInlndTrspPlnQtyVO
*Open Issues :
*Change history :
...
public class EqrInlndTrspPlnQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrInlndTrspPlnQtyVO> models = new ArrayList<EqrInlndTrspPlnQtyVO>();
	...
	public EqrInlndTrspPlnQtyVO() {}

	public EqrInlndTrspPlnQtyVO(String ibflag, String pagerows, String repoPlnId, String plnYrwk, String plnSeq, String cntrTpszCd, String cntrQty, String trspCostAmt, String plnUcAmt, String fmEccCostAmt, String toEccCostAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return EqrInlndTrspPlnQtyVO[]
	 */
	public EqrInlndTrspPlnQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrInlndTrspPlnQtyVO[]
	 */
	public EqrInlndTrspPlnQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrInlndTrspPlnQtyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EqrInlndTrspPlnQtyVO();
				if (updDt[i] != null)
		...
		return getEqrInlndTrspPlnQtyVOs();
	}
	 ...
	 * @return EqrInlndTrspPlnQtyVO[]
	 */
	public EqrInlndTrspPlnQtyVO[] getEqrInlndTrspPlnQtyVOs(){
		EqrInlndTrspPlnQtyVO[] vos = (EqrInlndTrspPlnQtyVO[])models.toArray(new EqrInlndTrspPlnQtyVO[models.size()]);
		return vos;
	}
