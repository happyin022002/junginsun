...
*@FileName : MasComCostParaVO.java
*@FileTitle : MasComCostParaVO
*Open Issues :
*Change history :
 ...
 */
public class MasComCostParaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComCostParaVO> models = new ArrayList<MasComCostParaVO>();
	 ...
	 * @param request
	 * @return MasComCostParaVO[]
	 */
	public MasComCostParaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComCostParaVO[]
	 */
	public MasComCostParaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComCostParaVO model = null;
	 ...
	 * @return MasComCostParaVO[]
	 */
	public MasComCostParaVO[] getMasComCostParaVOs(){
		MasComCostParaVO[] vos = (MasComCostParaVO[])models.toArray(new MasComCostParaVO[models.size()]);
		return vos;
	}
