...
*@FileName : SqmQtaLaneOfcVO.java
*@FileTitle : SqmQtaLaneOfcVO
*Open Issues :
*Change history :
...
public class SqmQtaLaneOfcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmQtaLaneOfcVO> models = new ArrayList<SqmQtaLaneOfcVO>();
	...
	public SqmQtaLaneOfcVO() {}

	public SqmQtaLaneOfcVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String trdCd, String rlaneCd, String dirCd, String rgnOfcCd, String rhqCd, String subTrdCd, String sqmActFlg, String addFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.rhqCd = rhqCd;
...
/**
	 ...
	 */
	public SqmQtaLaneOfcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmQtaLaneOfcVO[]
	 */
	public SqmQtaLaneOfcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmQtaLaneOfcVO model = null;
	...
	public SqmQtaLaneOfcVO[] getSqmQtaLaneOfcVOs(){
		SqmQtaLaneOfcVO[] vos = (SqmQtaLaneOfcVO[])models.toArray(new SqmQtaLaneOfcVO[models.size()]);
		return vos;
	}
