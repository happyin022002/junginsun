...
*@FileName : MasCntrMtyMvmtRoutVO.java
*@FileTitle : MasCntrMtyMvmtRoutVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrMtyMvmtRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrMtyMvmtRoutVO> models = new ArrayList<MasCntrMtyMvmtRoutVO>();
	 ...
	 * @param request
	 * @return MasCntrMtyMvmtRoutVO[]
	 */
	public MasCntrMtyMvmtRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrMtyMvmtRoutVO[]
	 */
	public MasCntrMtyMvmtRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrMtyMvmtRoutVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasCntrMtyMvmtRoutVO();
				if (creDt[i] != null)
		...
		return getMasCntrMtyMvmtRoutVOs();
	}
	 ...
	 * @return MasCntrMtyMvmtRoutVO[]
	 */
	public MasCntrMtyMvmtRoutVO[] getMasCntrMtyMvmtRoutVOs(){
		MasCntrMtyMvmtRoutVO[] vos = (MasCntrMtyMvmtRoutVO[])models.toArray(new MasCntrMtyMvmtRoutVO[models.size()]);
		return vos;
	}
