...
public class SpcDlyFcastCustVO extends AbstractValueObject {
	...
	public SpcDlyFcastCustVO(String ibflag, String pagerows, String rlaneCd, String dirCd, String vslCd, String skdVoyNo, String skdDirCd, String iocTsCd, String srepUsrId, String custCntCd, String custSeq, String polYdCd, String podYdCd, String fcastOfcCd, String fcastCustTpCd, String iocCd, String repTrdCd, String repSubTrdCd, String trdCd, String subTrdCd, String slsRhqCd, String slsAqCd, String slsRgnOfcCd, String slsOfcCd, String fcastTtlQty, String fcast40ftHcQty, String fcast45ftHcQty, String fcastRfQty, String fcastTtlWgt, String cfmTtlQty, String cfm40ftHcQty, String cfm45ftHcQty, String cfmRfQty, String cfmTtlWgt, String ctrlLvlCd, String modiGdt, String cfmUsrId, String cfmDt, String usdBkgTtlQty, String usdBkg20ftQty, String usdBkg40ftQty, String usdBkg40ftHcQty, String usdBkg45ftHcQty, String usdBkgRfQty, String usdBkgTtlWgt, String creUsrId, String creDt, String updUsrId, String updDt, String usdBkg53ftQty, String cfm53ftQty, String fcast53ftQty,String fcast20ftQty, String fcast40ftQty
		...
		//fcast20ftDryQty, fcast40ftDryQty, fcastRdQty, usdBkg20ftDryQty, usdBkg40ftDryQty, usdBkgRdQty
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		//fcast20ftDryQty, fcast40ftDryQty, fcastRdQty, usdBkg20ftDryQty, usdBkg40ftDryQty, usdBkgRdQty
		//getFcast20ftDryQty, getFcast40ftDryQty, getFcastRdQty, getUsdBkg20ftDryQty, getUsdBkg40ftDryQty, getUsdBkgRdQty
		//setFcast20ftDryQty, setFcast40ftDryQty, setFcastRdQty, setUsdBkg20ftDryQty, setUsdBkg40ftDryQty, setUsdBkgRdQty
		//fcast_20ft_dry_qty, fcast_40ft_dry_qty, fcast_rd_qty, usd_bkg_20ft_dry_qty, usd_bkg_40ft_dry_qty, usd_bkg_rd_qty
	...
	/**
	 * @param fcast20ftDryQty the fcast20ftDryQty to set
	 */
	...
	/**
	 * @param fcast40ftDryQty the fcast40ftDryQty to set
	 */
	...
	/**
	 * @param fcastRdQty the fcastRdQty to set
	 */
	...
	/**
	 * @param usdBkg20ftDryQty the usdBkg20ftDryQty to set
	 */
	...
	/**
	 * @param usdBkg40ftDryQty the usdBkg40ftDryQty to set
	 */
	...
	/**
	 * @param usdBkgRdQty the usdBkgRdQty to set
	 */
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFcast20ftQty(JSPUtil.getParameter(request, "fcast_20ft_qty", ""));
		setFcast40ftQty(JSPUtil.getParameter(request, "fcast_40ft_qty", ""));
		...
		setScFlg(JSPUtil.getParameter(request, "sc_flg", ""));
		setFcast20ftDryQty(JSPUtil.getParameter(request, "fcast_20ft_dry_qty", ""));
		setFcast40ftDryQty(JSPUtil.getParameter(request, "fcast_40ft_dry_qty", ""));
		setFcastRdQty(JSPUtil.getParameter(request, "fcast_rd_qty", ""));
		setUsdBkg20ftDryQty(JSPUtil.getParameter(request, "usd_bkg_20ft_dry_qty", ""));
		setUsdBkg40ftDryQty(JSPUtil.getParameter(request, "usd_bkg_40ft_dry_qty", ""));
	...
	public SpcDlyFcastCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] usaBkgModCd = request.getParameterValues(prefix + "usa_bkg_mod_cd");
			...
			String[][] usdBkgTtlQty		= new String[wk][];
			String[][] usdBkg20ftQty	= new String[wk][];
			String[][] usdBkg40ftQty	= new String[wk][];
			String[][] usdBkg40ftHcQty	= new String[wk][];
			String[][] usdBkg45ftHcQty	= new String[wk][];
			String[][] usdBkg53ftQty	= new String[wk][];
			String[][] usdBkgRfQty		= new String[wk][];
			String[][] usdBkgTtlWgt		= new String[wk][];
			
			String[][] fcast20ftDryQty      = new String[wk][];
			String[][] fcast40ftDryQty      = new String[wk][];
			String[][] fcastRdQty     	     = new String[wk][];
			String[][] usdBkg20ftDryQty 	 =  new String[wk][];
			String[][] usdBkg40ftDryQty 	 = new String[wk][];
			String[][] usdBkgRdQty 	         =  new String[wk][];
			...
			for(int j = 1; j < wk + 1; j++) {
				...
				usdBkg53ftQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_53ft_qty_"    + j, length));
				usdBkg40ftQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_40ft_qty_"    + j, length));
				usdBkg40ftHcQty[j-1]	= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_40ft_hc_qty_" + j, length));
				usdBkg45ftHcQty[j-1]	= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_45ft_hc_qty_" + j, length));
				usdBkg20ftQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_20ft_qty_"    + j, length));
				usdBkgTtlQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_ttl_qty_"     + j, length));
				usdBkgRfQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_rf_qty_"      + j, length));
				usdBkgTtlWgt[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_ttl_wgt_"     + j, length));
				
				fcast20ftDryQty[j-1]	= (JSPUtil.getParameter(request, prefix	+ "fcast_20ft_dry_qty_" + j, length));
				fcast40ftDryQty[j-1]	= (JSPUtil.getParameter(request, prefix	+ "fcast_40ft_dry_qty_" + j, length));
				fcastRdQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "fcast_rd_qty_"    + j, length));
				usdBkg20ftDryQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_20ft_dry_qty_"     + j, length));
				usdBkg40ftDryQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_40ft_dry_qty_"      + j, length));
				usdBkgRdQty[j-1]		= (JSPUtil.getParameter(request, prefix	+ "usd_bkg_rd_qty_"     + j, length));
			}
			...
			for (int i = 0; i < length; i++) {
				...
				if (usdBkg40ftQty[i%wk][i/wk] != null)
					model.setUsdBkg40ftQty(usdBkg40ftQty[i%wk][i/wk]);
				if (pagerows[i] != null)
				...
				if (usdBkg40ftHcQty[i%wk][i/wk] != null)
					model.setUsdBkg40ftHcQty(usdBkg40ftHcQty[i%wk][i/wk]);
				if (ctrlLvlCd[i] != null)
				...
				if (usdBkg45ftHcQty[i%wk][i/wk] != null)
					model.setUsdBkg45ftHcQty(usdBkg45ftHcQty[i%wk][i/wk]);
				...
				if (usdBkg20ftQty[i%wk][i/wk] != null)
					model.setUsdBkg20ftQty(usdBkg20ftQty[i%wk][i/wk]);
				if (creDt[i] != null)
				...
				if (usdBkgTtlQty[i%wk][i/wk] != null)
					model.setUsdBkgTtlQty(usdBkgTtlQty[i%wk][i/wk]);
				if (usdBkgRfQty[i%wk][i/wk] != null)
					model.setUsdBkgRfQty(usdBkgRfQty[i%wk][i/wk]);
				if (dirCd[i] != null)
				...
				if (usdBkgTtlWgt[i%wk][i/wk] != null)
					model.setUsdBkgTtlWgt(usdBkgTtlWgt[i%wk][i/wk]);
				if (slsRgnOfcCd[i] != null)
					model.setSlsRgnOfcCd(slsRgnOfcCd[i]);
				if (repSubTrdCd[i] != null)
					model.setRepSubTrdCd(repSubTrdCd[i]);
				if (usdBkg53ftQty[i%wk][i/wk] != null)
					model.setUsdBkg53ftQty(usdBkg53ftQty[i%wk][i/wk]);
				...
				if (fcast20ftDryQty[i%wk][i/wk] != null)
					model.setFcast20ftDryQty(fcast20ftDryQty[i%wk][i/wk]);
				if (fcast40ftDryQty[i%wk][i/wk] != null)
					model.setFcast40ftDryQty(fcast40ftDryQty[i%wk][i/wk]);
				if (fcastRdQty[i%wk][i/wk] != null)
					model.setFcastRdQty(fcastRdQty[i%wk][i/wk]);
				if (usdBkg20ftDryQty[i%wk][i/wk] != null)
					model.setUsdBkg20ftDryQty(usdBkg20ftDryQty[i%wk][i/wk]);
				if (usdBkg40ftDryQty[i%wk][i/wk] != null)
					model.setUsdBkg40ftDryQty(usdBkg40ftDryQty[i%wk][i/wk]);
				if (usdBkgRdQty[i%wk][i/wk] != null)
					model.setUsdBkgRdQty(usdBkgRdQty[i%wk][i/wk]);
	...
	*/
	public void unDataFormat(){
		...
		//usa_bkg_mod_cd, usaBkgModCd, UsaBkgModCd
