...
*@FileName : MasBnkCsmVO.java
*@FileTitle : MasBnkCsmVO
*Open Issues :
*Change history :
 ...
 */
public class MasBnkCsmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBnkCsmVO> models = new ArrayList<MasBnkCsmVO>();
	...
	public MasBnkCsmVO(String ibflag, String pagerows, String vslClssCapa, String bzcVslSpd, String foilSailCsm, String creUsrId, String creDt, String updUsrId, String updDt, String fVslClssCapa) {
		this.updDt = updDt;
	 ...
	 * @return MasBnkCsmVO[]
	 */
	public MasBnkCsmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBnkCsmVO[]
	 */
	public MasBnkCsmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBnkCsmVO model = null;
	...
	public MasBnkCsmVO[] getMasBnkCsmVOs(){
		MasBnkCsmVO[] vos = (MasBnkCsmVO[])models.toArray(new MasBnkCsmVO[models.size()]);
		return vos;
	}
