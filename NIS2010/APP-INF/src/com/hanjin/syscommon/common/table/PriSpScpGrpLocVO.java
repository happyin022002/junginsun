...
*@FileName : PriSpScpGrpLocVO.java
*@FileTitle : PriSpScpGrpLocVO
*Open Issues :
*Change history :
...
public class PriSpScpGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGrpLocVO> models = new ArrayList<PriSpScpGrpLocVO>();
	...
	public PriSpScpGrpLocVO() {}

	public PriSpScpGrpLocVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String grpLocSeq, String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriSpScpGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGrpLocVO[]
	 */
	public PriSpScpGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGrpLocVO model = null;
	...
	public PriSpScpGrpLocVO[] getPriSpScpGrpLocVOs(){
		PriSpScpGrpLocVO[] vos = (PriSpScpGrpLocVO[])models.toArray(new PriSpScpGrpLocVO[models.size()]);
		return vos;
	}
