...
*@FileName : MDM_SVC_SCP_LANE.java
 ...
 * @since J2EE 1.4
 */
public final class MdmSvcScpLane implements java.io.Serializable {
	...
	public static MdmSvcScpLane fromRequest(HttpServletRequest request) {
		MdmSvcScpLane model = new MdmSvcScpLane();
		try {
