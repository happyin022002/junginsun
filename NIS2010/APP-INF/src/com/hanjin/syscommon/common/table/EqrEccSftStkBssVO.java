...
*@FileName : EqrEccSftStkBssVO.java
*@FileTitle : EqrEccSftStkBssVO
*Open Issues :
*Change history :
...
public class EqrEccSftStkBssVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrEccSftStkBssVO> models = new ArrayList<EqrEccSftStkBssVO>();
	...
	public EqrEccSftStkBssVO() {}

	public EqrEccSftStkBssVO(String ibflag, String pagerows, String eccCd, String cntrTpszCd, String sfstkLvlCd, String sfstkVolQty, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return EqrEccSftStkBssVO[]
	 */
	public EqrEccSftStkBssVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrEccSftStkBssVO[]
	 */
	public EqrEccSftStkBssVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrEccSftStkBssVO model = null;
		...
		return getEqrEccSftStkBssVOs();
	}

	
	/**
	 * Request 넘어온 여러 건 DATA를 TPSZ에 맞게 VO Class 에 담는다. 
	 * @param request
	 * @param prefix
	 * @return EqrEccSftStkBssVO[]
	 */
	public EqrEccSftStkBssVO[] fromRequestGrid(HttpServletRequest request, String cntr_tp_sz ,String loc) {
		EqrEccSftStkBssVO model = null;
		
		 ArrayList models = new ArrayList();
	        String[] prefix = null;
	        if (!(cntr_tp_sz.equals(""))){
	        	prefix = cntr_tp_sz.split(",");
	        }
		...
		try {
			...
			for (int k=0 ; k < prefix.length ; k++){
				...
				//String[] cntrTpszCd = (JSPUtil.getParameter(request,  "cntr_tpsz_cd", length));
				...
				String[] sfstkVolQty = (JSPUtil.getParameter(request,  prefix[k] + "sfstk_vol_qty", length));
				String[] sfstkLvlCd = (JSPUtil.getParameter(request,  prefix[k] + "sfstk_lvl_cd", length));
	 ...
	 * @return EqrEccSftStkBssVO[]
	 */
	public EqrEccSftStkBssVO[] getEqrEccSftStkBssVOs(){
		EqrEccSftStkBssVO[] vos = (EqrEccSftStkBssVO[])models.toArray(new EqrEccSftStkBssVO[models.size()]);
		return vos;
	}
