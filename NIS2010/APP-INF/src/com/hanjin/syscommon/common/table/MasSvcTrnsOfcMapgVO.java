...
*@FileName : MasSvcTrnsOfcMapgVO.java
*@FileTitle : MasSvcTrnsOfcMapgVO
*Open Issues :
*Change history :
 ...
 */
public class MasSvcTrnsOfcMapgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSvcTrnsOfcMapgVO> models = new ArrayList<MasSvcTrnsOfcMapgVO>();
	...
	public MasSvcTrnsOfcMapgVO() {}

	public MasSvcTrnsOfcMapgVO(String ibflag, String pagerows, String costYrmon, String ofcCd, String ofcActCd, String divMeasCd, String pfitctrFlg, String svcTrnsPrcFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSvcTrnsOfcMapgVO[]
	 */
	public MasSvcTrnsOfcMapgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSvcTrnsOfcMapgVO[]
	 */
	public MasSvcTrnsOfcMapgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSvcTrnsOfcMapgVO model = null;
		...
		return getMasSvcTrnsOfcMapgVOs();
	}
	 ...
	 * @return MasSvcTrnsOfcMapgVO[]
	 */
	public MasSvcTrnsOfcMapgVO[] getMasSvcTrnsOfcMapgVOs(){
		MasSvcTrnsOfcMapgVO[] vos = (MasSvcTrnsOfcMapgVO[])models.toArray(new MasSvcTrnsOfcMapgVO[models.size()]);
		return vos;
	}
