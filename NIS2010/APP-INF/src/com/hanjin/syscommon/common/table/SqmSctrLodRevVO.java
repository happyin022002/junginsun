...
*@FileName : SqmSctrLodRevVO.java
*@FileTitle : SqmSctrLodRevVO
*Open Issues :
*Change history :
...
public class SqmSctrLodRevVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrLodRevVO> models = new ArrayList<SqmSctrLodRevVO>();
	...
	public SqmSctrLodRevVO() {}

	public SqmSctrLodRevVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String rlaneCd, String dirCd, String fnlBsaCapa, String pfGrpCd, String rgnOfcCd, String polCd, String podCd, String trdCd, String subTrdCd, String rhqCd, String gidLodQty, String gidGrsRpbRev, String lodQty, String grsRpbRev, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.lodQty = lodQty;
		this.rhqCd = rhqCd;
...
/**
	 ...
	 */
	public SqmSctrLodRevVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrLodRevVO[]
	 */
	public SqmSctrLodRevVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrLodRevVO model = null;
	...
	public SqmSctrLodRevVO[] getSqmSctrLodRevVOs(){
		SqmSctrLodRevVO[] vos = (SqmSctrLodRevVO[])models.toArray(new SqmSctrLodRevVO[models.size()]);
		return vos;
	}
