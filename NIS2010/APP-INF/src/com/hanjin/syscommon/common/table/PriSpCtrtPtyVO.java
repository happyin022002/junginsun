...
public class PriSpCtrtPtyVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("oti_bd_no", getOtiBdNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("oti_bd_no", "otiBdNo");
	 ...
	 * @param otiBdNo
	 */
	public void setOtiBdNo(String otiBdNo) {
		this.otiBdNo = otiBdNo;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPoaAtchFileId(JSPUtil.getParameter(request, prefix + "poa_atch_file_id", ""));
		...
		setOtiBdNo(JSPUtil.getParameter(request, prefix + "oti_bd_no", ""));
	...
	public PriSpCtrtPtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] otiBdNo = (JSPUtil.getParameter(request, prefix	+ "oti_bd_no", length));
	...
	*/
	public void unDataFormat(){
		...
		this.poaAtchFileId = this.poaAtchFileId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.otiBdNo = this.otiBdNo .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
