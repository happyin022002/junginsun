...
*@FileName : MasComCostParaBkupVO.java
*@FileTitle : MasComCostParaBkupVO
*Open Issues :
*Change history :
 ...
 */
public class MasComCostParaBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComCostParaBkupVO> models = new ArrayList<MasComCostParaBkupVO>();
	 ...
	 * @param request
	 * @return MasComCostParaBkupVO[]
	 */
	public MasComCostParaBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComCostParaBkupVO[]
	 */
	public MasComCostParaBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComCostParaBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasComCostParaBkupVO();
		...
		return getMasComCostParaBkupVOs();
	}
	 ...
	 * @return MasComCostParaBkupVO[]
	 */
	public MasComCostParaBkupVO[] getMasComCostParaBkupVOs(){
		MasComCostParaBkupVO[] vos = (MasComCostParaBkupVO[])models.toArray(new MasComCostParaBkupVO[models.size()]);
		return vos;
	}
