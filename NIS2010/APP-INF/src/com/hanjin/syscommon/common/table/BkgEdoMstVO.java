...
public class BkgEdoMstVO extends AbstractValueObject {
	...
	/*	Column Info	*/
	private  String	 edoRctLocNm   =  null;	
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("edo_rct_loc_nm", getEdoRctLocNm());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("edo_rct_loc_nm", "edoRctLocNm");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEdoRctLocNm(JSPUtil.getParameter(request, "edo_rct_loc_nm", ""));
	}
	...
	public BkgEdoMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] edoRctLocNm = (JSPUtil.getParameter(request, prefix	+ "edo_rct_loc_nm", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (edoRctLocNm[i] != null)
					model.setEdoRctLocNm(edoRctLocNm[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.edoRctLocNm = this.edoRctLocNm .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}

	public String getEdoRctLocNm() {
		return edoRctLocNm;
	}

	public void setEdoRctLocNm(String edoRctLocNm) {
		this.edoRctLocNm = edoRctLocNm;
	}
}
