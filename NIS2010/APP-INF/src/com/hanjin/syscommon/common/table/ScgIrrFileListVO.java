...
*@FileName : ScgIrrFileListVO.java
*@FileTitle : ScgIrrFileListVO
*Open Issues :
*Change history :
...
public class ScgIrrFileListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgIrrFileListVO> models = new ArrayList<ScgIrrFileListVO>();
	...
	public ScgIrrFileListVO() {}

	public ScgIrrFileListVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String spclCgoIrrSeq, String spclCgoIrrFileSeq, String fileSavId, String fileNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 */
	public ScgIrrFileListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgIrrFileListVO[]
	 */
	public ScgIrrFileListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgIrrFileListVO model = null;
		...
		try {
			...
			String[] spclCgoIrrFileSeq = (JSPUtil.getParameter(request, prefix	+ "spcl_cgo_irr_file_seq", length));
	...
	public ScgIrrFileListVO[] getScgIrrFileListVOs(){
		ScgIrrFileListVO[] vos = (ScgIrrFileListVO[])models.toArray(new ScgIrrFileListVO[models.size()]);
		return vos;
	}
