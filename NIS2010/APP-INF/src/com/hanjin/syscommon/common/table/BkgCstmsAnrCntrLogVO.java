...
*@FileName : BkgCstmsAnrCntrLogVO.java
*@FileTitle : BkgCstmsAnrCntrLogVO
*Open Issues :
*Change history :
...
public class BkgCstmsAnrCntrLogVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsAnrCntrLogVO> models = new ArrayList<BkgCstmsAnrCntrLogVO>();
	 ...
	 */
	public BkgCstmsAnrCntrLogVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsAnrCntrLogVO[]
	 */
	public BkgCstmsAnrCntrLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsAnrCntrLogVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgCstmsAnrCntrLogVO();
				if (updDt[i] != null)
		...
		return getBkgCstmsAnrCntrLogVOs();
	}
	 ...
	 * @return BkgCstmsAnrCntrLogVO[]
	 */
	public BkgCstmsAnrCntrLogVO[] getBkgCstmsAnrCntrLogVOs(){
		BkgCstmsAnrCntrLogVO[] vos = (BkgCstmsAnrCntrLogVO[])models.toArray(new BkgCstmsAnrCntrLogVO[models.size()]);
		return vos;
	}
