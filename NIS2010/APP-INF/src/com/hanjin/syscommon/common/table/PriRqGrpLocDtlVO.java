...
*@FileName : PriRqGrpLocDtlVO.java
*@FileTitle : PriRqGrpLocDtlVO
*Open Issues :
*Change history :
...
public class PriRqGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqGrpLocDtlVO> models = new ArrayList<PriRqGrpLocDtlVO>();
	...
	public PriRqGrpLocDtlVO() {}

	public PriRqGrpLocDtlVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpLocSeq, String grpLocDtlSeq, String locCd, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRqGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqGrpLocDtlVO[]
	 */
	public PriRqGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqGrpLocDtlVO model = null;
	...
	public PriRqGrpLocDtlVO[] getPriRqGrpLocDtlVOs(){
		PriRqGrpLocDtlVO[] vos = (PriRqGrpLocDtlVO[])models.toArray(new PriRqGrpLocDtlVO[models.size()]);
		return vos;
	}
