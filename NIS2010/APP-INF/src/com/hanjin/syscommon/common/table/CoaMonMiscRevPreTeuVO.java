...
*@FileName : CoaMonMiscRevPreTeuVO.java
*@FileTitle : CoaMonMiscRevPreTeuVO
*Open Issues :
*Change history :
...
public class CoaMonMiscRevPreTeuVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaMonMiscRevPreTeuVO> models = new ArrayList<CoaMonMiscRevPreTeuVO>();
	...
	public CoaMonMiscRevPreTeuVO() {}

	public CoaMonMiscRevPreTeuVO(String ibflag, String pagerows, String revYrmon, String trdCd, String dirCd, String rlaneCd, String trdTtlAmt, String trdTtlQty, String etcUtRevAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaMonMiscRevPreTeuVO[]
	 */
	public CoaMonMiscRevPreTeuVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaMonMiscRevPreTeuVO[]
	 */
	public CoaMonMiscRevPreTeuVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaMonMiscRevPreTeuVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaMonMiscRevPreTeuVO();
				if (updDt[i] != null)
		...
		return getCoaMonMiscRevPreTeuVOs();
	}
	...
	public CoaMonMiscRevPreTeuVO[] getCoaMonMiscRevPreTeuVOs(){
		CoaMonMiscRevPreTeuVO[] vos = (CoaMonMiscRevPreTeuVO[])models.toArray(new CoaMonMiscRevPreTeuVO[models.size()]);
		return vos;
	}
