...
*@FileName : PriRqRtRoutPntVO.java
*@FileTitle : PriRqRtRoutPntVO
*Open Issues :
*Change history :
...
public class PriRqRtRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtRoutPntVO> models = new ArrayList<PriRqRtRoutPntVO>();
...
/**
	 ...
	 * @param request
	 * @return PriRqRtRoutPntVO[]
	 */
	public PriRqRtRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtRoutPntVO[]
	 */
	public PriRqRtRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtRoutPntVO model = null;
	 ...
	 * @return PriRqRtRoutPntVO[]
	 */
	public PriRqRtRoutPntVO[] getPriRqRtRoutPntVOs(){
		PriRqRtRoutPntVO[] vos = (PriRqRtRoutPntVO[])models.toArray(new PriRqRtRoutPntVO[models.size()]);
		return vos;
	}
