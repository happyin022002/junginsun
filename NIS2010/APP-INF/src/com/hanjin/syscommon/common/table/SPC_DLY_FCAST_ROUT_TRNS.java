...
*@FileName : SPC_DLY_FCAST_ROUT_TRNS.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPC_DLY_FCAST_ROUT_TRNS implements Serializable {
	...
	public SPC_DLY_FCAST_ROUT_TRNS() {
	}

	public SPC_DLY_FCAST_ROUT_TRNS(String ibflag, String page_rows,
	...
	public static SPC_DLY_FCAST_ROUT_TRNS fromRequest(HttpServletRequest request) {
		String strUserId = getUserId(request);
		SPC_DLY_FCAST_ROUT_TRNS model = new SPC_DLY_FCAST_ROUT_TRNS();
		try {
	...
	public static Collection fromRequestGrid(HttpServletRequest request,
			String prefix) {
		String strUserId = getUserId(request);
		SPC_DLY_FCAST_ROUT_TRNS model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SPC_DLY_FCAST_ROUT_TRNS();
				if (ibflag[i] != null)
