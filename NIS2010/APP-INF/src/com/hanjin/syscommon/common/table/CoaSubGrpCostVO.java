...
*@FileName : CoaSubGrpCostVO.java
*@FileTitle : CoaSubGrpCostVO
*Open Issues :
*Change history :
...
public class CoaSubGrpCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaSubGrpCostVO> models = new ArrayList<CoaSubGrpCostVO>();
	...
	public CoaSubGrpCostVO() {}

	public CoaSubGrpCostVO(String ibflag, String pagerows, String mgrpCostCd, String sgrpCostCd, String sgrpCostCdDesc, String fxCostDtrbFlg, String creUcSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaSubGrpCostVO[]
	 */
	public CoaSubGrpCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaSubGrpCostVO[]
	 */
	public CoaSubGrpCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaSubGrpCostVO model = null;
	 ...
	 * @return CoaSubGrpCostVO[]
	 */
	public CoaSubGrpCostVO[] getCoaSubGrpCostVOs(){
		CoaSubGrpCostVO[] vos = (CoaSubGrpCostVO[])models.toArray(new CoaSubGrpCostVO[models.size()]);
		return vos;
	}
