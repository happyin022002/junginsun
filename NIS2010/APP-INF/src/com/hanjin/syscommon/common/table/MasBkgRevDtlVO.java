...
*@FileName : MasBkgRevDtlVO.java
*@FileTitle : MasBkgRevDtlVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgRevDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgRevDtlVO> models = new ArrayList<MasBkgRevDtlVO>();
	 ...
	 * @param request
	 * @return MasBkgRevDtlVO[]
	 */
	public MasBkgRevDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgRevDtlVO[]
	 */
	public MasBkgRevDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgRevDtlVO model = null;
	 ...
	 * @return MasBkgRevDtlVO[]
	 */
	public MasBkgRevDtlVO[] getMasBkgRevDtlVOs(){
		MasBkgRevDtlVO[] vos = (MasBkgRevDtlVO[])models.toArray(new MasBkgRevDtlVO[models.size()]);
		return vos;
	}
