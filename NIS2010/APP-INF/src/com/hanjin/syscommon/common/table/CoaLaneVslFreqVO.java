...
*@FileName : CoaLaneVslFreqVO.java
*@FileTitle : CoaLaneVslFreqVO
*Open Issues :
*Change history :
...
public class CoaLaneVslFreqVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaLaneVslFreqVO> models = new ArrayList<CoaLaneVslFreqVO>();
	...
	public CoaLaneVslFreqVO() {}

	public CoaLaneVslFreqVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String freqNo, String creUsrId, String creDt, String updUsrId, String updDt, String costUseTpCd, String dirCd) {
		this.updDt = updDt;
		this.freqNo = freqNo;
...
/**
	 ...
	 * @param request
	 * @return CoaLaneVslFreqVO[]
	 */
	public CoaLaneVslFreqVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaLaneVslFreqVO[]
	 */
	public CoaLaneVslFreqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaLaneVslFreqVO model = null;
	 ...
	 * @return CoaLaneVslFreqVO[]
	 */
	public CoaLaneVslFreqVO[] getCoaLaneVslFreqVOs(){
		CoaLaneVslFreqVO[] vos = (CoaLaneVslFreqVO[])models.toArray(new CoaLaneVslFreqVO[models.size()]);
		return vos;
	}
