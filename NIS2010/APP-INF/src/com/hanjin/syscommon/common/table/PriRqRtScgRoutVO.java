...
*@FileName : PriRqRtScgRoutVO.java
*@FileTitle : PriRqRtScgRoutVO
*Open Issues :
*Change history :
...
public class PriRqRtScgRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtScgRoutVO> models = new ArrayList<PriRqRtScgRoutVO>();
	...
	public PriRqRtScgRoutVO() {}

	public PriRqRtScgRoutVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String genSpclRtTpCd, String cmdtHdrSeq, String routSeq, String rtSeq, String porCd, String polCd, String podCd, String delCd, String rcvTermCd, String deTermCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.porCd = porCd;
	 ...
	 * @param request
	 * @return PriRqRtScgRoutVO[]
	 */
	public PriRqRtScgRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtScgRoutVO[]
	 */
	public PriRqRtScgRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtScgRoutVO model = null;
	 ...
	 * @return PriRqRtScgRoutVO[]
	 */
	public PriRqRtScgRoutVO[] getPriRqRtScgRoutVOs(){
		PriRqRtScgRoutVO[] vos = (PriRqRtScgRoutVO[])models.toArray(new PriRqRtScgRoutVO[models.size()]);
		return vos;
	}
