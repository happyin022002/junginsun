...
*@FileName : BsaVvdOtrCrrVO.java
*@FileTitle : BsaVvdOtrCrrVO
*Open Issues :
*Change history :
...
public class BsaVvdOtrCrrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaVvdOtrCrrVO> models = new ArrayList<BsaVvdOtrCrrVO>();
	...
	public BsaVvdOtrCrrVO() {}

	public BsaVvdOtrCrrVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String skdDirCd, String bsaOpJbCd, String crrCd, String crrBsaCapa, String spcCtrlSltCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
		this.trdCd = trdCd;
	 ...
	 * @param request
	 * @return BsaVvdOtrCrrVO[]
	 */
	public BsaVvdOtrCrrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaVvdOtrCrrVO[]
	 */
	public BsaVvdOtrCrrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaVvdOtrCrrVO model = null;
	 ...
	 * @return BsaVvdOtrCrrVO[]
	 */
	public BsaVvdOtrCrrVO[] getBsaVvdOtrCrrVOs(){
		BsaVvdOtrCrrVO[] vos = (BsaVvdOtrCrrVO[])models.toArray(new BsaVvdOtrCrrVO[models.size()]);
		return vos;
	}
