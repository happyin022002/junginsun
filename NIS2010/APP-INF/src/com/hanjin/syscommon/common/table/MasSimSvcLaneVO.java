...
*@FileName : MasSimSvcLaneVO.java
*@FileTitle : MasSimSvcLaneVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimSvcLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimSvcLaneVO> models = new ArrayList<MasSimSvcLaneVO>();
	 ...
	 * @param request
	 * @return MasSimSvcLaneVO[]
	 */
	public MasSimSvcLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimSvcLaneVO[]
	 */
	public MasSimSvcLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimSvcLaneVO model = null;
	 ...
	 * @return MasSimSvcLaneVO[]
	 */
	public MasSimSvcLaneVO[] getMasSimSvcLaneVOs(){
		MasSimSvcLaneVO[] vos = (MasSimSvcLaneVO[])models.toArray(new MasSimSvcLaneVO[models.size()]);
		return vos;
	}
