...
public class TrsTrspInvEdiVO extends AbstractValueObject {
	...
	/* Column Info */
	private String invEdiRsltCd = null;
	...
	public TrsTrspInvEdiVO(String ibflag, String pagerows, String trspInvEdiSeq, String invNo, String trspWoOfcCtyCd, String trspWoSeq, String trspSoOfcCtyCd, String trspSoSeq, String eqNo, String eqTpszCd, String bkgNo, String invAmt, String invCurrCd, String invRmk, String invIssDt, String creUsrId, String creDt, String updUsrId, String updDt, String invEdiRsltCd) {
		...
		this.invEdiRsltCd = invEdiRsltCd;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("inv_edi_rslt_cd", getInvEdiRsltCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("inv_edi_rslt_cd", "invEdiRsltCd");
	 ...
	 * @return invEdiRsltCd
	 */
	public String getInvEdiRsltCd() {
		return this.invEdiRsltCd;
	}
	 ...
	 * @param invEdiRsltCd
	 */
	public void setInvEdiRsltCd(String invEdiRsltCd) {
		this.invEdiRsltCd = invEdiRsltCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setInvEdiRsltCd(JSPUtil.getParameter(request, "inv_edi_rslt_cd", ""));
	}
	...
	public TrsTrspInvEdiVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] invEdiRsltCd = (JSPUtil.getParameter(request, prefix	+ "inv_edi_rslt_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (invEdiRsltCd[i] != null)
					model.setInvEdiRsltCd(invEdiRsltCd[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.invEdiRsltCd = this.invEdiRsltCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
