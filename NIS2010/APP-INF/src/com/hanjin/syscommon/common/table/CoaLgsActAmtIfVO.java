...
*@FileName : CoaLgsActAmtIfVO.java
*@FileTitle : CoaLgsActAmtIfVO
*Open Issues :
*Change history :
...
public class CoaLgsActAmtIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaLgsActAmtIfVO> models = new ArrayList<CoaLgsActAmtIfVO>();
	...
	public CoaLgsActAmtIfVO() {}

	public CoaLgsActAmtIfVO(String ibflag, String pagerows, String bkgNo, String cntrTpszCd, String costRoutNo, String costActGrpSeq, String coaCostSrcCd, String bkgStsCd, String costActGrpCd, String costSrcSysCd, String cntrQty, String actCostAmt, String lstActCostAmt, String acclCostAmt, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaLgsActAmtIfVO[]
	 */
	public CoaLgsActAmtIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaLgsActAmtIfVO[]
	 */
	public CoaLgsActAmtIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaLgsActAmtIfVO model = null;
	 ...
	 * @return CoaLgsActAmtIfVO[]
	 */
	public CoaLgsActAmtIfVO[] getCoaLgsActAmtIfVOs(){
		CoaLgsActAmtIfVO[] vos = (CoaLgsActAmtIfVO[])models.toArray(new CoaLgsActAmtIfVO[models.size()]);
		return vos;
	}
