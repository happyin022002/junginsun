...
public class BkgCustomerVO extends AbstractValueObject {
    ...
    public void fromRequest(HttpServletRequest request) {
        setEndUsrNm(JSPUtil.getParameter(request, "end_usr_nm", ""));
