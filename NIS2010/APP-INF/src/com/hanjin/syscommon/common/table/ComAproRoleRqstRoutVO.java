...
*@FileName : ComAproRoleRqstRoutVO.java
*@FileTitle : ComAproRoleRqstRoutVO
*Open Issues :
*Change history :
...
public class ComAproRoleRqstRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComAproRoleRqstRoutVO> models = new ArrayList<ComAproRoleRqstRoutVO>();
	...
	public ComAproRoleRqstRoutVO() {}

	public ComAproRoleRqstRoutVO(String ibflag, String pagerows, String aproRqstNo, String aproRqstSeq, String aproUsrId, String aproUsrNm, String aproOfcCd, String aproOfcNm, String aproUsrJbTitNm, String aproDt, String apstsCd, String aproRmk, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return ComAproRoleRqstRoutVO[]
	 */
	public ComAproRoleRqstRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComAproRoleRqstRoutVO[]
	 */
	public ComAproRoleRqstRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComAproRoleRqstRoutVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new ComAproRoleRqstRoutVO();
				if (updDt[i] != null)
		...
		return getComAproRoleRqstRoutVOs();
	}
	 ...
	 * @return ComAproRoleRqstRoutVO[]
	 */
	public ComAproRoleRqstRoutVO[] getComAproRoleRqstRoutVOs(){
		ComAproRoleRqstRoutVO[] vos = (ComAproRoleRqstRoutVO[])models.toArray(new ComAproRoleRqstRoutVO[models.size()]);
		return vos;
	}
