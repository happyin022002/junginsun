...
*@FileName : BkgVslDchgYdVO.java
*@FileTitle : BkgVslDchgYdVO
*Open Issues :
*Change history :
...
public class BkgVslDchgYdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgVslDchgYdVO> models = new ArrayList<BkgVslDchgYdVO>();
	...
	public BkgVslDchgYdVO() {}

	public BkgVslDchgYdVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String skdCallSeq, String clptCd, String ydCd, String cvyRefNo, String uqVslIdNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.clptCd = clptCd;
		this.creDt = creDt;
	 ...
	 */
	public BkgVslDchgYdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgVslDchgYdVO[]
	 */
	public BkgVslDchgYdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgVslDchgYdVO model = null;
	...
	public BkgVslDchgYdVO[] getBkgVslDchgYdVOs(){
		BkgVslDchgYdVO[] vos = (BkgVslDchgYdVO[])models.toArray(new BkgVslDchgYdVO[models.size()]);
		return vos;
	}
