...
*@FileName : EqrOnfHirExePlnTrcVO.java
*@FileTitle : EqrOnfHirExePlnTrcVO
*Open Issues :
*Change history :
...
public class EqrOnfHirExePlnTrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrOnfHirExePlnTrcVO> models = new ArrayList<EqrOnfHirExePlnTrcVO>();
	...
	public EqrOnfHirExePlnTrcVO() {}

	public EqrOnfHirExePlnTrcVO(String ibflag, String pagerows, String repoPlnId, String plnYrwk, String refId, String cntrTpszCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return EqrOnfHirExePlnTrcVO[]
	 */
	public EqrOnfHirExePlnTrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrOnfHirExePlnTrcVO[]
	 */
	public EqrOnfHirExePlnTrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrOnfHirExePlnTrcVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EqrOnfHirExePlnTrcVO();
				if (updDt[i] != null)
		...
		return getEqrOnfHirExePlnTrcVOs();
	}
	 ...
	 * @return EqrOnfHirExePlnTrcVO[]
	 */
	public EqrOnfHirExePlnTrcVO[] getEqrOnfHirExePlnTrcVOs(){
		EqrOnfHirExePlnTrcVO[] vos = (EqrOnfHirExePlnTrcVO[])models.toArray(new EqrOnfHirExePlnTrcVO[models.size()]);
		return vos;
	}
