...
*@FileName : MasSimDtlRevLaneVO.java
*@FileTitle : MasSimDtlRevLaneVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimDtlRevLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimDtlRevLaneVO> models = new ArrayList<MasSimDtlRevLaneVO>();
	...
	public MasSimDtlRevLaneVO() {}

	public MasSimDtlRevLaneVO(String ibflag, String pagerows, String rlaneCd, String skdDirCd, String iocCd, String fmContiCd, String toContiCd, String trdCd, String subTrdCd, String slanCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
	 ...
	 * @param request
	 * @return MasSimDtlRevLaneVO[]
	 */
	public MasSimDtlRevLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimDtlRevLaneVO[]
	 */
	public MasSimDtlRevLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimDtlRevLaneVO model = null;
	 ...
	 * @return MasSimDtlRevLaneVO[]
	 */
	public MasSimDtlRevLaneVO[] getMasSimDtlRevLaneVOs(){
		MasSimDtlRevLaneVO[] vos = (MasSimDtlRevLaneVO[])models.toArray(new MasSimDtlRevLaneVO[models.size()]);
		return vos;
	}
