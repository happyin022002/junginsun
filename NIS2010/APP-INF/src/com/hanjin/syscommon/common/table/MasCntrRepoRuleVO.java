...
*@FileName : MasCntrRepoRuleVO.java
*@FileTitle : MasCntrRepoRuleVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoRuleVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoRuleVO> models = new ArrayList<MasCntrRepoRuleVO>();
	 ...
	 * @param request
	 * @return MasCntrRepoRuleVO[]
	 */
	public MasCntrRepoRuleVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoRuleVO[]
	 */
	public MasCntrRepoRuleVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoRuleVO model = null;
	...
	public MasCntrRepoRuleVO[] getMasCntrRepoRuleVOs(){
		MasCntrRepoRuleVO[] vos = (MasCntrRepoRuleVO[])models.toArray(new MasCntrRepoRuleVO[models.size()]);
		return vos;
	}
