...
*@FileName : MasRptItmInfoDtlVO.java
*@FileTitle : MasRptItmInfoDtlVO
*Open Issues :
*Change history :
 ...
 */
public class MasRptItmInfoDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRptItmInfoDtlVO> models = new ArrayList<MasRptItmInfoDtlVO>();
	...
	/* Column Info */
	private String masRptItmCd = null;
	/* Column Info */
	...
	public MasRptItmInfoDtlVO() {}

	public MasRptItmInfoDtlVO(String ibflag, String pagerows, String slctItmFomSeq, String masRptItmCd, String creUsrId, String rptItmDesc, String rptItmColNm, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.slctItmFomSeq = slctItmFomSeq;
		this.creUsrId = creUsrId;
		this.ibflag = ibflag;
		this.rptItmColNm = rptItmColNm;
		this.masRptItmCd = masRptItmCd;
		this.creDt = creDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mas_rpt_itm_cd", getMasRptItmCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mas_rpt_itm_cd", "masRptItmCd");
	 ...
	 * @return masRptItmCd
	 */
	public String getMasRptItmCd() {
		return this.masRptItmCd;
	}
	 ...
	 * @param masRptItmCd
	 */
	public void setMasRptItmCd(String masRptItmCd) {
		this.masRptItmCd = masRptItmCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setMasRptItmCd(JSPUtil.getParameter(request, "mas_rpt_itm_cd", ""));
	 ...
	 * @param request
	 * @return MasRptItmInfoDtlVO[]
	 */
	public MasRptItmInfoDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRptItmInfoDtlVO[]
	 */
	public MasRptItmInfoDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRptItmInfoDtlVO model = null;
		...
		try {
			...
			String[] masRptItmCd = (JSPUtil.getParameter(request, prefix	+ "mas_rpt_itm_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (masRptItmCd[i] != null)
					model.setMasRptItmCd(masRptItmCd[i]);
				if (creDt[i] != null)
	...
	public MasRptItmInfoDtlVO[] getMasRptItmInfoDtlVOs(){
		MasRptItmInfoDtlVO[] vos = (MasRptItmInfoDtlVO[])models.toArray(new MasRptItmInfoDtlVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.masRptItmCd = this.masRptItmCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
