...
*@FileName : PriRpScpRtRoutPntVO.java
*@FileTitle : PriRpScpRtRoutPntVO
*Open Issues :
*Change history :
...
public class PriRpScpRtRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtRoutPntVO> models = new ArrayList<PriRpScpRtRoutPntVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBsePortLocCd(JSPUtil.getParameter(request, "bse_port_loc_cd", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return PriRpScpRtRoutPntVO[]
	 */
	public PriRpScpRtRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtRoutPntVO[]
	 */
	public PriRpScpRtRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtRoutPntVO model = null;
		...
		return getPriRpScpRtRoutPntVOs();
	}
	 ...
	 * @return PriRpScpRtRoutPntVO[]
	 */
	public PriRpScpRtRoutPntVO[] getPriRpScpRtRoutPntVOs(){
		PriRpScpRtRoutPntVO[] vos = (PriRpScpRtRoutPntVO[])models.toArray(new PriRpScpRtRoutPntVO[models.size()]);
		return vos;
	}
