...
*@FileName : MdmCustRepVO.java
*@FileTitle : MdmCustRepVO
*Open Issues :
*Change history :
...
public class MdmCustRepVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmCustRepVO> models = new ArrayList<MdmCustRepVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("autoInvFlg", getAutoInvFlg());
		this.hashColumns.put("hjsCustSvcPicTpCd", getHjsCustSvcPicTpCd());
		this.hashColumns.put("hjsRefNo", getHjsRefNo());
		this.hashColumns.put("custRefNoFlg", getCustRefNoFlg());
		this.hashColumns.put("loclChgFlg", getLoclChgFlg());
		this.hashColumns.put("hjsRefEml", getHjsRefEml());
		this.hashColumns.put("deltFlg", getDeltFlg());
		this.hashColumns.put("eaiEvntDt", getEaiEvntDt());
		this.hashColumns.put("eaiIfId", getEaiIfId());
		this.hashColumns.put("creUsrId", getCreUsrId());
		this.hashColumns.put("creDt", getCreDt());
		this.hashColumns.put("updUsrId", getUpdUsrId());
		this.hashColumns.put("updDt", getUpdDt());
		this.hashColumns.put("autoInvEml", getAutoInvEml());
	 ...
	 * @return MdmCustRepVO[]
	 */
	public MdmCustRepVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmCustRepVO[]
	 */
	public MdmCustRepVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MdmCustRepVO model = null;
	 ...
	 * @return MdmCustRepVO[]
	 */
	public MdmCustRepVO[] getMdmCustRepVOs(){
		MdmCustRepVO[] vos = (MdmCustRepVO[])models.toArray(new MdmCustRepVO[models.size()]);
		return vos;
	}
