...
*@FileName : PriCmpbGlineBseVO.java
*@FileTitle : PriCmpbGlineBseVO
*Open Issues :
*Change history :
...
public class PriCmpbGlineBseVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGlineBseVO> models = new ArrayList<PriCmpbGlineBseVO>();
	...
	public PriCmpbGlineBseVO() {}

	public PriCmpbGlineBseVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String prsCustTpCd, String bseSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.bseSeq = bseSeq;
	 ...
	 */
	public PriCmpbGlineBseVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGlineBseVO[]
	 */
	public PriCmpbGlineBseVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGlineBseVO model = null;
	...
	public PriCmpbGlineBseVO[] getPriCmpbGlineBseVOs(){
		PriCmpbGlineBseVO[] vos = (PriCmpbGlineBseVO[])models.toArray(new PriCmpbGlineBseVO[models.size()]);
		return vos;
	}
