...
*@FileName : EqrCtrlPlnRepoInVO.java
*@FileTitle : EqrCtrlPlnRepoInVO
*Open Issues :
*Change history :
...
public class EqrCtrlPlnRepoInVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrCtrlPlnRepoInVO> models = new ArrayList<EqrCtrlPlnRepoInVO>();
	...
	public EqrCtrlPlnRepoInVO() {}

	public EqrCtrlPlnRepoInVO(String ibflag, String pagerows, String fcastYrwk, String vslCd, String skdVoyNo, String skdDirCd, String plnRepoStsCd, String podYdCd, String toEtbDt, String vslLaneCd, String locCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
...
/**
	 ...
	 * @param request
	 * @return EqrCtrlPlnRepoInVO[]
	 */
	public EqrCtrlPlnRepoInVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrCtrlPlnRepoInVO[]
	 */
	public EqrCtrlPlnRepoInVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrCtrlPlnRepoInVO model = null;
	 ...
	 * @return EqrCtrlPlnRepoInVO[]
	 */
	public EqrCtrlPlnRepoInVO[] getEqrCtrlPlnRepoInVOs(){
		EqrCtrlPlnRepoInVO[] vos = (EqrCtrlPlnRepoInVO[])models.toArray(new EqrCtrlPlnRepoInVO[models.size()]);
		return vos;
	}
