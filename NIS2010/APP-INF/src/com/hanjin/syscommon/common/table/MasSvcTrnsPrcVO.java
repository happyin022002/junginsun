...
*@FileName : MasSvcTrnsPrcVO.java
*@FileTitle : MasSvcTrnsPrcVO
*Open Issues :
*Change history :
 ...
 */
public class MasSvcTrnsPrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSvcTrnsPrcVO> models = new ArrayList<MasSvcTrnsPrcVO>();
	 ...
	 */
	public MasSvcTrnsPrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSvcTrnsPrcVO[]
	 */
	public MasSvcTrnsPrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSvcTrnsPrcVO model = null;
	...
	public MasSvcTrnsPrcVO[] getMasSvcTrnsPrcVOs(){
		MasSvcTrnsPrcVO[] vos = (MasSvcTrnsPrcVO[])models.toArray(new MasSvcTrnsPrcVO[models.size()]);
		return vos;
	}
