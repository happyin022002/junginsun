...
*@FileName : MasComQtyParaVO.java
*@FileTitle : MasComQtyParaVO
*Open Issues :
*Change history :
 ...
 */
public class MasComQtyParaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComQtyParaVO> models = new ArrayList<MasComQtyParaVO>();
	...
	public MasComQtyParaVO() {}

	public MasComQtyParaVO(String ibflag, String pagerows, String pctlNo, String cntrTpszCd, String bkgRev, String bkgOftRev, String bkgQty, String estmCmAmt, String estmOpfitAmt, String raOpfitAmt, String raCmAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasComQtyParaVO[]
	 */
	public MasComQtyParaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComQtyParaVO[]
	 */
	public MasComQtyParaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComQtyParaVO model = null;
	 ...
	 * @return MasComQtyParaVO[]
	 */
	public MasComQtyParaVO[] getMasComQtyParaVOs(){
		MasComQtyParaVO[] vos = (MasComQtyParaVO[])models.toArray(new MasComQtyParaVO[models.size()]);
		return vos;
	}
