...
*@FileName : MasSltMgmtUtVO.java
*@FileTitle : MasSltMgmtUtVO
*Open Issues :
*Change history :
 ...
 */
public class MasSltMgmtUtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSltMgmtUtVO> models = new ArrayList<MasSltMgmtUtVO>();
	...
	public MasSltMgmtUtVO() {}

	public MasSltMgmtUtVO(String ibflag, String pagerows, String costYrmon, String trdCd, String rlaneCd, String vslSlanDirCd, String costLaneTpCd, String laneGrpCd, String bseUcAmt, String plcyPrcUtAmt, String vslAvgDys, String vslSltDysUcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public MasSltMgmtUtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSltMgmtUtVO[]
	 */
	public MasSltMgmtUtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSltMgmtUtVO model = null;
	...
	public MasSltMgmtUtVO[] getMasSltMgmtUtVOs(){
		MasSltMgmtUtVO[] vos = (MasSltMgmtUtVO[])models.toArray(new MasSltMgmtUtVO[models.size()]);
		return vos;
	}
