...
public class ScgPckGasReguVO extends AbstractValueObject {
	 ...
	 * @return tubChkFlg
	 */
	public String getTubChkFlg() {
		return this.tubChkFlg;
	}
	 ...
	 * @return tstPrdYr
	 */
	public String getTstPrdYr() {
		return this.tstPrdYr;
	}
	 ...
	 * @param tubChkFlg
	 */
	public void setTubChkFlg(String tubChkFlg) {
		this.tubChkFlg = tubChkFlg;
	}
	 ...
	 * @param tstPrdYr
	 */
	public void setTstPrdYr(String tstPrdYr) {
		this.tstPrdYr = tstPrdYr;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTubChkFlg(JSPUtil.getParameter(request, prefix + "tub_chk_flg", ""));
		...
		setTstPrdYr(JSPUtil.getParameter(request, prefix + "tst_prd_yr", ""));
	...
	public ScgPckGasReguVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] tubChkFlg = (JSPUtil.getParameter(request, prefix	+ "tub_chk_flg", length));
			...
			String[] tstPrdYr = (JSPUtil.getParameter(request, prefix	+ "tst_prd_yr", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (tubChkFlg[i] != null)
					model.setTubChkFlg(tubChkFlg[i]);
				if (ibflag[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.tubChkFlg = this.tubChkFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.tstPrdYr = this.tstPrdYr .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
