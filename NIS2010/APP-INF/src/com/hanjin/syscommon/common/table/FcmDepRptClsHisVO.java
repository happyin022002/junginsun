...
*@FileName : FcmDepRptClsHisVO.java
*@FileTitle : FcmDepRptClsHisVO
*Open Issues :
*Change history :
...
public class FcmDepRptClsHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FcmDepRptClsHisVO> models = new ArrayList<FcmDepRptClsHisVO>();
...
/**
	 ...
	 */
	public FcmDepRptClsHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FcmDepRptClsHisVO[]
	 */
	public FcmDepRptClsHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FcmDepRptClsHisVO model = null;
	 ...
	 * @return FcmDepRptClsHisVO[]
	 */
	public FcmDepRptClsHisVO[] getFcmDepRptClsHisVOs(){
		FcmDepRptClsHisVO[] vos = (FcmDepRptClsHisVO[])models.toArray(new FcmDepRptClsHisVO[models.size()]);
		return vos;
	}
