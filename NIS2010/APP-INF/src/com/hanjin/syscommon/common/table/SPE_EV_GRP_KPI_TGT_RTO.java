...
*@FileName : SPE_EV_GRP_KPI_TGT_RTO.java
 ...
 * @since J2EE 1.4
 */
public final class SPE_EV_GRP_KPI_TGT_RTO implements java.io.Serializable {
	...
	public static SPE_EV_GRP_KPI_TGT_RTO fromRequest(HttpServletRequest request) {
		SPE_EV_GRP_KPI_TGT_RTO model = new SPE_EV_GRP_KPI_TGT_RTO();
		try {
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		SPE_EV_GRP_KPI_TGT_RTO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new SPE_EV_GRP_KPI_TGT_RTO();
