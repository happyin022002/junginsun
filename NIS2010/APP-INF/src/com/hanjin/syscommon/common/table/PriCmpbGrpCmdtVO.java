...
*@FileName : PriCmpbGrpCmdtVO.java
*@FileTitle : PriCmpbGrpCmdtVO
*Open Issues :
*Change history :
...
public class PriCmpbGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGrpCmdtVO> models = new ArrayList<PriCmpbGrpCmdtVO>();
	...
	public PriCmpbGrpCmdtVO() {}

	public PriCmpbGrpCmdtVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriCmpbGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGrpCmdtVO[]
	 */
	public PriCmpbGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGrpCmdtVO model = null;
	...
	public PriCmpbGrpCmdtVO[] getPriCmpbGrpCmdtVOs(){
		PriCmpbGrpCmdtVO[] vos = (PriCmpbGrpCmdtVO[])models.toArray(new PriCmpbGrpCmdtVO[models.size()]);
		return vos;
	}
