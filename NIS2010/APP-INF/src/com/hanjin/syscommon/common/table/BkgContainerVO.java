...
public class BkgContainerVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setVgmDtmnDt(JSPUtil.getParameter(request, "vgm_dtmn_dt", ""));
