...
*@FileName : PriCmpbGrpLocVO.java
*@FileTitle : PriCmpbGrpLocVO
*Open Issues :
*Change history :
...
public class PriCmpbGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGrpLocVO> models = new ArrayList<PriCmpbGrpLocVO>();
	...
	public PriCmpbGrpLocVO() {}

	public PriCmpbGrpLocVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String grpLocSeq, String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriCmpbGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGrpLocVO[]
	 */
	public PriCmpbGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGrpLocVO model = null;
	...
	public PriCmpbGrpLocVO[] getPriCmpbGrpLocVOs(){
		PriCmpbGrpLocVO[] vos = (PriCmpbGrpLocVO[])models.toArray(new PriCmpbGrpLocVO[models.size()]);
		return vos;
	}
