...
*@FileName : PriSqRtScgVO.java
*@FileTitle : PriSqRtScgVO
*Open Issues :
*Change history :
...
public class PriSqRtScgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqRtScgVO> models = new ArrayList<PriSqRtScgVO>();
	 ...
	 * @return PriSqRtScgVO[]
	 */
	public PriSqRtScgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqRtScgVO[]
	 */
	public PriSqRtScgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqRtScgVO model = null;
	...
	public PriSqRtScgVO[] getPriSqRtScgVOs(){
		PriSqRtScgVO[] vos = (PriSqRtScgVO[])models.toArray(new PriSqRtScgVO[models.size()]);
		return vos;
	}
