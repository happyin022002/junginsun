...
public class BkgEdoDoVO extends AbstractValueObject {
	...
	/* Column Info */
	private String payrRemitDt1 = null;
	/* Column Info */
	private String payrRemitDt2 = null;
	/* Column Info */
	private String payrRemitDt = null;
	...
	public BkgEdoDoVO(String ibflag, String pagerows, String edoRqstNo, String edoRqstSeq, String edoXterPrnrAckCd, String payAmtCtnt, String payCurrCd, String payrNm, String payrBankNm, String payrBankAcctNo, String hndlOfcCd, String rqstEdoIssDt, String edoIssOfcCd, String edoTrsmDt, String edoTrsmUsrId, String creUsrId, String creDt, String updUsrId, String updDt, String payrRemitDt1, String payrRemitDt2, String payrRemitDt) {
		...
		this.payrRemitDt1 = payrRemitDt1;
		this.payrRemitDt2 = payrRemitDt2;
		this.payrRemitDt = payrRemitDt;
	}
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("payr_remit_dt1", getPayrRemitDt1());
		this.hashColumns.put("payr_remit_dt2", getPayrRemitDt2());
		this.hashColumns.put("payr_remit_dt", getPayrRemitDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("payr_remit_dt1", "payrRemitDt1");
		this.hashFields.put("payr_remit_dt2", "payrRemitDt2");
		this.hashFields.put("payr_remit_dt", "payrRemitDt");
	 ...
	 * @return payrRemitDt1
	 */
	public String getPayrRemitDt1() {
		return this.payrRemitDt1;
	}
	 ...
	 * @return payrRemitDt2
	 */
	public String getPayrRemitDt2() {
		return this.payrRemitDt2;
	}
	 ...
	 * @return payrRemitDt
	 */
	public String getPayrRemitDt() {
		return this.payrRemitDt;
	}
	 ...
	 * @param payrRemitDt1
	 */
	public void setPayrRemitDt1(String payrRemitDt1) {
		this.payrRemitDt1 = payrRemitDt1;
	}
	 ...
	 * @param payrRemitDt2
	 */
	public void setPayrRemitDt2(String payrRemitDt2) {
		this.payrRemitDt2 = payrRemitDt2;
	}
	 ...
	 * @param payrRemitDt
	 */
	public void setPayrRemitDt(String payrRemitDt) {
		this.payrRemitDt = payrRemitDt;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPayrRemitDt1(JSPUtil.getParameter(request, "payr_remit_dt1", ""));
		setPayrRemitDt2(JSPUtil.getParameter(request, "payr_remit_dt2", ""));
		setPayrRemitDt(JSPUtil.getParameter(request, "payr_remit_dt", ""));
	}
	...
	public BkgEdoDoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] payrRemitDt1 = (JSPUtil.getParameter(request, prefix	+ "payr_remit_dt1", length));
			String[] payrRemitDt2 = (JSPUtil.getParameter(request, prefix	+ "payr_remit_dt2", length));
			String[] payrRemitDt = (JSPUtil.getParameter(request, prefix	+ "payr_remit_dt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (payrRemitDt1[i] != null)
					model.setPayrRemitDt1(payrRemitDt1[i]);
				if (payrRemitDt2[i] != null)
					model.setPayrRemitDt2(payrRemitDt2[i]);
				if (payrRemitDt[i] != null)
					model.setPayrRemitDt(payrRemitDt[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.payrRemitDt1 = this.payrRemitDt1 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.payrRemitDt2 = this.payrRemitDt2 .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.payrRemitDt = this.payrRemitDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
