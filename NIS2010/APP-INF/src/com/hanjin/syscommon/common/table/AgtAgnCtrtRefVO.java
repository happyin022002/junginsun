...
*@FileName : AgtAgnCtrtRefVO.java
*@FileTitle : AgtAgnCtrtRefVO
*Open Issues :
*Change history :
...
public class AgtAgnCtrtRefVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AgtAgnCtrtRefVO> models = new ArrayList<AgtAgnCtrtRefVO>();
	...
	/* Column Info */
	private String agnCtrtOfcCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String ctrtRefDivCd = null;
	/* Column Info */
	...
	public AgtAgnCtrtRefVO() {}

	public AgtAgnCtrtRefVO(String ibflag, String pagerows, String agmtOfcCd, String agmtOfcCtyCd, String agnAgmtSeq, String vndrCntCd, String vndrSeq, String agnAgmtVerSeq, String ioBndCd, String acTpCd, String agnSeq, String scRfaFlg, String ctrtRefDivCd, String ctrtLvlCd, String agnCtrtOfcCd, String creUsrId, String creDt, String updUsrId, String updDt, String gubunValue, String infoNo) {
		this.updDt = updDt;
		this.vndrCntCd = vndrCntCd;
		this.agnSeq = agnSeq;
		this.creDt = creDt;
		this.ctrtLvlCd = ctrtLvlCd;
		this.ioBndCd = ioBndCd;
		this.agmtOfcCd = agmtOfcCd;
		this.pagerows = pagerows;
		this.agnCtrtOfcCd = agnCtrtOfcCd;
		...
		this.ctrtRefDivCd = ctrtRefDivCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ctrt_lvl_cd", getCtrtLvlCd());
		this.hashColumns.put("io_bnd_cd", getIoBndCd());
		this.hashColumns.put("agmt_ofc_cd", getAgmtOfcCd());
		this.hashColumns.put("pagerows", getPagerows());
		this.hashColumns.put("agn_ctrt_ofc_cd", getAgnCtrtOfcCd());
		...
		this.hashColumns.put("ctrt_ref_div_cd", getCtrtRefDivCd());
		this.hashColumns.put("upd_usr_id", getUpdUsrId());
		this.hashColumns.put("gubun_value", getGubunValue());
		this.hashColumns.put("gubun_value", getInfoNo());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ctrt_lvl_cd", "ctrtLvlCd");
		this.hashFields.put("io_bnd_cd", "ioBndCd");
		this.hashFields.put("agmt_ofc_cd", "agmtOfcCd");
		this.hashFields.put("pagerows", "pagerows");
		this.hashFields.put("agn_ctrt_ofc_cd", "agnCtrtOfcCd");
		...
		this.hashFields.put("ctrt_ref_div_cd", "ctrtRefDivCd");
	 ...
	 * @return ctrtLvlCd
	 */
	public String getCtrtLvlCd() {
		return this.ctrtLvlCd;
	}
	 ...
	 * @return agnCtrtOfcCd
	 */
	public String getAgnCtrtOfcCd() {
		return this.agnCtrtOfcCd;
	}
	 ...
	 * @return ctrtRefDivCd
	 */
	public String getCtrtRefDivCd() {
		return this.ctrtRefDivCd;
	}
	 ...
	 * @param ctrtLvlCd
	 */
	public void setCtrtLvlCd(String ctrtLvlCd) {
		this.ctrtLvlCd = ctrtLvlCd;
	}
	 ...
	 * @param agnCtrtOfcCd
	 */
	public void setAgnCtrtOfcCd(String agnCtrtOfcCd) {
		this.agnCtrtOfcCd = agnCtrtOfcCd;
	}
	 ...
	 * @param ctrtRefDivCd
	 */
	public void setCtrtRefDivCd(String ctrtRefDivCd) {
		this.ctrtRefDivCd = ctrtRefDivCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCtrtLvlCd(JSPUtil.getParameter(request, "ctrt_lvl_cd", ""));
		setIoBndCd(JSPUtil.getParameter(request, "io_bnd_cd", ""));
		setAgmtOfcCd(JSPUtil.getParameter(request, "agmt_ofc_cd", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setAgnCtrtOfcCd(JSPUtil.getParameter(request, "agn_ctrt_ofc_cd", ""));
		...
		setScRfaFlg(JSPUtil.getParameter(request, "sc_rfa_flg", ""));
		setCtrtRefDivCd(JSPUtil.getParameter(request, "ctrt_ref_div_cd", ""));
	 ...
	 */
	public AgtAgnCtrtRefVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AgtAgnCtrtRefVO[]
	 */
	public AgtAgnCtrtRefVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AgtAgnCtrtRefVO model = null;
		...
		try {
			...
			String[] ctrtLvlCd = (JSPUtil.getParameter(request, prefix	+ "ctrt_lvl_cd", length));
			String[] ioBndCd = (JSPUtil.getParameter(request, prefix	+ "io_bnd_cd", length));
			String[] agmtOfcCd = (JSPUtil.getParameter(request, prefix	+ "agmt_ofc_cd", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			String[] agnCtrtOfcCd = (JSPUtil.getParameter(request, prefix	+ "agn_ctrt_ofc_cd", length));
			...
			String[] ctrtRefDivCd = (JSPUtil.getParameter(request, prefix	+ "ctrt_ref_div_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (ctrtLvlCd[i] != null)
					model.setCtrtLvlCd(ctrtLvlCd[i]);
				if (ioBndCd[i] != null)
				...
				if (agnCtrtOfcCd[i] != null)
					model.setAgnCtrtOfcCd(agnCtrtOfcCd[i]);
				...
				if (ctrtRefDivCd[i] != null)
					model.setCtrtRefDivCd(ctrtRefDivCd[i]);
				if (updUsrId[i] != null)
	...
	public AgtAgnCtrtRefVO[] getAgtAgnCtrtRefVOs(){
		AgtAgnCtrtRefVO[] vos = (AgtAgnCtrtRefVO[])models.toArray(new AgtAgnCtrtRefVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.ctrtLvlCd = this.ctrtLvlCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ioBndCd = this.ioBndCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.agmtOfcCd = this.agmtOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.pagerows = this.pagerows .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.agnCtrtOfcCd = this.agnCtrtOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.ctrtRefDivCd = this.ctrtRefDivCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
