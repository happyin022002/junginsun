...
*@FileName : MasMonVvdPortOpDysVO.java
*@FileTitle : MasMonVvdPortOpDysVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonVvdPortOpDysVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonVvdPortOpDysVO> models = new ArrayList<MasMonVvdPortOpDysVO>();
...
/**
	 ...
	 * @param request
	 * @return MasMonVvdPortOpDysVO[]
	 */
	public MasMonVvdPortOpDysVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonVvdPortOpDysVO[]
	 */
	public MasMonVvdPortOpDysVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonVvdPortOpDysVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasMonVvdPortOpDysVO();
				if (updDt[i] != null)
		...
		return getMasMonVvdPortOpDysVOs();
	}
	...
	public MasMonVvdPortOpDysVO[] getMasMonVvdPortOpDysVOs(){
		MasMonVvdPortOpDysVO[] vos = (MasMonVvdPortOpDysVO[])models.toArray(new MasMonVvdPortOpDysVO[models.size()]);
		return vos;
	}
