...
*@FileName : PriScNoteConvVO.java
*@FileTitle : PriScNoteConvVO
*Open Issues :
*Change history :
...
public class PriScNoteConvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriScNoteConvVO> models = new ArrayList<PriScNoteConvVO>();
...
/**
	 ...
	 */
	public PriScNoteConvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriScNoteConvVO[]
	 */
	public PriScNoteConvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriScNoteConvVO model = null;
	...
	public PriScNoteConvVO[] getPriScNoteConvVOs(){
		PriScNoteConvVO[] vos = (PriScNoteConvVO[])models.toArray(new PriScNoteConvVO[models.size()]);
		return vos;
	}
