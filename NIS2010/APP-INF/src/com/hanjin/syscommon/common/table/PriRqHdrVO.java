...
*@FileName : PriRqHdrVO.java
*@FileTitle : PriRqHdrVO
*Open Issues :
*Change history :
...
public class PriRqHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqHdrVO> models = new ArrayList<PriRqHdrVO>();
	...
	public PriRqHdrVO(String ibflag, String pagerows, String qttnNo, String qttnStsCd, String qttnOfcCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return PriRqHdrVO[]
	 */
	public PriRqHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqHdrVO[]
	 */
	public PriRqHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqHdrVO model = null;
	 ...
	 * @return PriRqHdrVO[]
	 */
	public PriRqHdrVO[] getPriRqHdrVOs(){
		PriRqHdrVO[] vos = (PriRqHdrVO[])models.toArray(new PriRqHdrVO[models.size()]);
		return vos;
	}
