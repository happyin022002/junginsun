...
*@FileName : TesTmlSoCntrListTrcVO.java
*@FileTitle : TesTmlSoCntrListTrcVO
*Open Issues :
*Change history :
...
public class TesTmlSoCntrListTrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesTmlSoCntrListTrcVO> models = new ArrayList<TesTmlSoCntrListTrcVO>();
	...
	public TesTmlSoCntrListTrcVO() {}

	public TesTmlSoCntrListTrcVO(String ibflag, String pagerows, String tmlSoOfcCtyCd, String tmlSoSeq, String tmlSoCntrListSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return TesTmlSoCntrListTrcVO[]
	 */
	public TesTmlSoCntrListTrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesTmlSoCntrListTrcVO[]
	 */
	public TesTmlSoCntrListTrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesTmlSoCntrListTrcVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesTmlSoCntrListTrcVO();
				if (updDt[i] != null)
		...
		return getTesTmlSoCntrListTrcVOs();
	}
	 ...
	 * @return TesTmlSoCntrListTrcVO[]
	 */
	public TesTmlSoCntrListTrcVO[] getTesTmlSoCntrListTrcVOs(){
		TesTmlSoCntrListTrcVO[] vos = (TesTmlSoCntrListTrcVO[])models.toArray(new TesTmlSoCntrListTrcVO[models.size()]);
		return vos;
	}
