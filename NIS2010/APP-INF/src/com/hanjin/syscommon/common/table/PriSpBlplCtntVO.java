...
*@FileName : PriSpBlplCtntVO.java
*@FileTitle : PriSpBlplCtntVO
*Open Issues :
*Change history :
...
public class PriSpBlplCtntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpBlplCtntVO> models = new ArrayList<PriSpBlplCtntVO>();
	...
	public PriSpBlplCtntVO() {}

	public PriSpBlplCtntVO(String ibflag, String pagerows, String propNo, String amdtSeq, String blplSeq, String blplCtntSeq, String blplCtnt, String dpSeq, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.dpSeq = dpSeq;
		this.acptDt = acptDt;
	 ...
	 */
	public PriSpBlplCtntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpBlplCtntVO[]
	 */
	public PriSpBlplCtntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpBlplCtntVO model = null;
	...
	public PriSpBlplCtntVO[] getPriSpBlplCtntVOs(){
		PriSpBlplCtntVO[] vos = (PriSpBlplCtntVO[])models.toArray(new PriSpBlplCtntVO[models.size()]);
		return vos;
	}
