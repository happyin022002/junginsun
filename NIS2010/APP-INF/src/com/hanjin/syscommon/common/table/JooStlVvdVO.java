...
public class JooStlVvdVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vvditem", getVvdItem());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("vvditem", "vvdItem");
	 ...
	 * @param vvdItem
	 */
	public void setVvdItem(String vvdItem) {
		this.vvdItem = vvdItem;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setVvdItem(JSPUtil.getParameter(request, "vvditem", ""));
	}
	...
	public JooStlVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] vvdItem = (JSPUtil.getParameter(request, prefix	+ "vvditem", length));
	...
	*/
	public void unDataFormat(){
		...
		this.vvdItem = this.vvdItem .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
