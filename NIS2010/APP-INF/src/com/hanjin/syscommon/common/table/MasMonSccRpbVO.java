...
*@FileName : MasMonSccRpbVO.java
*@FileTitle : MasMonSccRpbVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonSccRpbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonSccRpbVO> models = new ArrayList<MasMonSccRpbVO>();
	...
	public MasMonSccRpbVO() {}

	public MasMonSccRpbVO(String ibflag, String pagerows, String rpbYrmon, String bkgPorSccCd, String bkgDelSccCd, String cntrTpszCd, String bkgAvgRpbRev, String bkgOftAvgRpbRev, String bkgMiscAvgRpbRev, String scrChgAvgRpbRev, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBkgDelSccCd(JSPUtil.getParameter(request, "bkg_del_scc_cd", ""));
		...
		setBkgPorSccCd(JSPUtil.getParameter(request, "bkg_por_scc_cd", ""));
	 ...
	 * @param request
	 * @return MasMonSccRpbVO[]
	 */
	public MasMonSccRpbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonSccRpbVO[]
	 */
	public MasMonSccRpbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonSccRpbVO model = null;
	 ...
	 * @return MasMonSccRpbVO[]
	 */
	public MasMonSccRpbVO[] getMasMonSccRpbVOs(){
		MasMonSccRpbVO[] vos = (MasMonSccRpbVO[])models.toArray(new MasMonSccRpbVO[models.size()]);
		return vos;
	}
