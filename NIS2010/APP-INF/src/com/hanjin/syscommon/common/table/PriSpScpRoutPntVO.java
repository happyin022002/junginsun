...
*@FileName : PriSpScpRoutPntVO.java
*@FileTitle : PriSpScpRoutPntVO
*Open Issues :
*Change history :
...
public class PriSpScpRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRoutPntVO> models = new ArrayList<PriSpScpRoutPntVO>();
	...
	public PriSpScpRoutPntVO() {}

	public PriSpScpRoutPntVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String orgDestTpCd, String routPntSeq, String routPntLocTpCd, String routPntLocDefCd, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.acptDt = acptDt;
	 ...
	 */
	public PriSpScpRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRoutPntVO[]
	 */
	public PriSpScpRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRoutPntVO model = null;
	...
	public PriSpScpRoutPntVO[] getPriSpScpRoutPntVOs(){
		PriSpScpRoutPntVO[] vos = (PriSpScpRoutPntVO[])models.toArray(new PriSpScpRoutPntVO[models.size()]);
		return vos;
	}
