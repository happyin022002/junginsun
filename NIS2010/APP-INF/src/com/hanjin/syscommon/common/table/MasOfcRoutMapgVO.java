...
*@FileName : MasOfcRoutMapgVO.java
*@FileTitle : MasOfcRoutMapgVO
*Open Issues :
*Change history :
 ...
 */
public class MasOfcRoutMapgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasOfcRoutMapgVO> models = new ArrayList<MasOfcRoutMapgVO>();
	...
	public MasOfcRoutMapgVO() {}

	public MasOfcRoutMapgVO(String ibflag, String pagerows, String costYrmon, String ofcClssCd, String slsActCd, String divMeasCd, String slsOfcClssNm, String slsActDesc, String divMeasNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasOfcRoutMapgVO[]
	 */
	public MasOfcRoutMapgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasOfcRoutMapgVO[]
	 */
	public MasOfcRoutMapgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasOfcRoutMapgVO model = null;
	 ...
	 * @return MasOfcRoutMapgVO[]
	 */
	public MasOfcRoutMapgVO[] getMasOfcRoutMapgVOs(){
		MasOfcRoutMapgVO[] vos = (MasOfcRoutMapgVO[])models.toArray(new MasOfcRoutMapgVO[models.size()]);
		return vos;
	}
