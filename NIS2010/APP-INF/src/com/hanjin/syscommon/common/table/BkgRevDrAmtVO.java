...
*@FileName : BkgRevDrAmtVO.java
*@FileTitle : BkgRevDrAmtVO
*Open Issues :
*Change history :
...
public class BkgRevDrAmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgRevDrAmtVO> models = new ArrayList<BkgRevDrAmtVO>();
	...
	public BkgRevDrAmtVO() {}

	public BkgRevDrAmtVO(String ibflag, String pagerows, String rdnNo, String rvisSeq, String currCd, String drAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return BkgRevDrAmtVO[]
	 */
	public BkgRevDrAmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgRevDrAmtVO[]
	 */
	public BkgRevDrAmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgRevDrAmtVO model = null;
	...
	public BkgRevDrAmtVO[] getBkgRevDrAmtVOs(){
		BkgRevDrAmtVO[] vos = (BkgRevDrAmtVO[])models.toArray(new BkgRevDrAmtVO[models.size()]);
		return vos;
	}
