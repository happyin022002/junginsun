...
*@FileName : SqmQtaLaneOfcCostVO.java
*@FileTitle : SqmQtaLaneOfcCostVO
*Open Issues :
*Change history :
...
public class SqmQtaLaneOfcCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmQtaLaneOfcCostVO> models = new ArrayList<SqmQtaLaneOfcCostVO>();
...
/**
	 ...
	 */
	public SqmQtaLaneOfcCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmQtaLaneOfcCostVO[]
	 */
	public SqmQtaLaneOfcCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmQtaLaneOfcCostVO model = null;
		...
		return getSqmQtaLaneOfcCostVOs();
	}
	...
	public SqmQtaLaneOfcCostVO[] getSqmQtaLaneOfcCostVOs(){
		SqmQtaLaneOfcCostVO[] vos = (SqmQtaLaneOfcCostVO[])models.toArray(new SqmQtaLaneOfcCostVO[models.size()]);
		return vos;
	}
