...
*@FileName : CoaSvcTrnsPrcMgnVO.java
*@FileTitle : CoaSvcTrnsPrcMgnVO
*Open Issues :
*Change history :
...
public class CoaSvcTrnsPrcMgnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaSvcTrnsPrcMgnVO> models = new ArrayList<CoaSvcTrnsPrcMgnVO>();
	...
	public CoaSvcTrnsPrcMgnVO() {}

	public CoaSvcTrnsPrcMgnVO(String ibflag, String pagerows, String costYrmon, String ofcActCd, String stpMgnRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaSvcTrnsPrcMgnVO[]
	 */
	public CoaSvcTrnsPrcMgnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaSvcTrnsPrcMgnVO[]
	 */
	public CoaSvcTrnsPrcMgnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaSvcTrnsPrcMgnVO model = null;
	 ...
	 * @return CoaSvcTrnsPrcMgnVO[]
	 */
	public CoaSvcTrnsPrcMgnVO[] getCoaSvcTrnsPrcMgnVOs(){
		CoaSvcTrnsPrcMgnVO[] vos = (CoaSvcTrnsPrcMgnVO[])models.toArray(new CoaSvcTrnsPrcMgnVO[models.size()]);
		return vos;
	}
