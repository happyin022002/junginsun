...
*@FileName : MasPfitLssSmryVO.java
*@FileTitle : MasPfitLssSmryVO
*Open Issues :
*Change history :
 ...
 */
public class MasPfitLssSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasPfitLssSmryVO> models = new ArrayList<MasPfitLssSmryVO>();
	 ...
	 * @param request
	 * @return MasPfitLssSmryVO[]
	 */
	public MasPfitLssSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasPfitLssSmryVO[]
	 */
	public MasPfitLssSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasPfitLssSmryVO model = null;
	 ...
	 * @return MasPfitLssSmryVO[]
	 */
	public MasPfitLssSmryVO[] getMasPfitLssSmryVOs(){
		MasPfitLssSmryVO[] vos = (MasPfitLssSmryVO[])models.toArray(new MasPfitLssSmryVO[models.size()]);
		return vos;
	}
