...
*@FileName : PriTaaTriListVO.java
*@FileTitle : PriTaaTriListVO
*Open Issues :
*Change history :
...
public class PriTaaTriListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriTaaTriListVO> models = new ArrayList<PriTaaTriListVO>();
	...
	public PriTaaTriListVO() {}

	public PriTaaTriListVO(String ibflag, String pagerows, String taaPropNo, String amdtSeq, String triPropNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriTaaTriListVO[]
	 */
	public PriTaaTriListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriTaaTriListVO[]
	 */
	public PriTaaTriListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriTaaTriListVO model = null;
	 ...
	 * @return PriTaaTriListVO[]
	 */
	public PriTaaTriListVO[] getPriTaaTriListVOs(){
		PriTaaTriListVO[] vos = (PriTaaTriListVO[])models.toArray(new PriTaaTriListVO[models.size()]);
		return vos;
	}
