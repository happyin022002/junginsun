 ...
 * @since J2EE 1.4
 */
public final class MdmPckTp implements java.io.Serializable {

	private String      ibflag      = "";
	private String      page_rows   = "";
	private String      pck_cd      = "";
	private String      pck_nm      = "";
	...
	public String      getPck_nm     (){	return pck_nm     	;	}
	...
	public void setPck_nm     ( String      pck_nm      ){	this.pck_nm      = pck_nm     	;	}
	...
	public static MdmPckTp fromRequest(HttpServletRequest request) {
		MdmPckTp model = new MdmPckTp();
		try {
			model.setIbflag     	(JSPUtil.getParameter(request, "ibflag     		".trim(), ""));
			model.setPage_rows  	(JSPUtil.getParameter(request, "page_rows  		".trim(), ""));
			model.setPck_cd     	(JSPUtil.getParameter(request, "pck_cd     		".trim(), ""));
			model.setPck_nm     	(JSPUtil.getParameter(request, "pck_nm     		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] pck_nm      =  (JSPUtil.getParameter(request, "pck_nm     		".trim(), length));
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] pck_nm      =  (JSPUtil.getParameter(request, prefix + "pck_nm     		".trim(), length));
