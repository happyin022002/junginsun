...
*@FileName : PriScgPctBseVO.java
*@FileTitle : PriScgPctBseVO
*Open Issues :
*Change history :
...
public class PriScgPctBseVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriScgPctBseVO> models = new ArrayList<PriScgPctBseVO>();
	...
	public PriScgPctBseVO() {}

	public PriScgPctBseVO(String ibflag, String pagerows, String pctBseCd, String pattDesc, String dpSeq, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String acsDt) {
		this.updDt = updDt;
		this.dpSeq = dpSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("acs_dt", getAcsDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("acs_dt", "acsDt");
	...
	public final void setAcsDt(String acsDt) {
		this.acsDt = acsDt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setAcsDt(JSPUtil.getParameter(request, prefix + "acs_dt", ""));
	}
	 ...
	 */
	public PriScgPctBseVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriScgPctBseVO[]
	 */
	public PriScgPctBseVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriScgPctBseVO model = null;
		...
		try {
			...
			String[] acsDt = (JSPUtil.getParameter(request, prefix	+ "acs_dt", length));
			
			for (int i = 0; i < length; i++) {
				model = new PriScgPctBseVO();
				if (updDt[i] != null)
	...
	public PriScgPctBseVO[] getPriScgPctBseVOs(){
		PriScgPctBseVO[] vos = (PriScgPctBseVO[])models.toArray(new PriScgPctBseVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.acsDt = this.acsDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
