...
*@FileName : MasBkgComIfVO.java
*@FileTitle : MasBkgComIfVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgComIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgComIfVO> models = new ArrayList<MasBkgComIfVO>();
	...
	public MasBkgComIfVO() {}

	public MasBkgComIfVO(String ibflag, String pagerows, String bkgNo, String costSrcSysCd, String ifDt, String ifRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.ifDt = ifDt;
		this.ifRmk = ifRmk;
	 ...
	 * @param request
	 * @return MasBkgComIfVO[]
	 */
	public MasBkgComIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgComIfVO[]
	 */
	public MasBkgComIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgComIfVO model = null;
	 ...
	 * @return MasBkgComIfVO[]
	 */
	public MasBkgComIfVO[] getMasBkgComIfVOs(){
		MasBkgComIfVO[] vos = (MasBkgComIfVO[])models.toArray(new MasBkgComIfVO[models.size()]);
		return vos;
	}
