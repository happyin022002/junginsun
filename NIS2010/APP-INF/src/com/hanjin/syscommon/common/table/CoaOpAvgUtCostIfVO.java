...
*@FileName : CoaOpAvgUtCostIfVO.java
*@FileTitle : CoaOpAvgUtCostIfVO
*Open Issues :
*Change history :
...
public class CoaOpAvgUtCostIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaOpAvgUtCostIfVO> models = new ArrayList<CoaOpAvgUtCostIfVO>();
	...
	public CoaOpAvgUtCostIfVO() {}

	public CoaOpAvgUtCostIfVO(String ibflag, String pagerows, String costYrmon, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String dirCd, String stndCostCd, String opLaneTpCd, String opCostAmt, String bsaCapa, String opUcAmt, String vvdRmk, String vvdSeq, String creUsrId, String creDt, String updUsrId, String updDt, String costUseTpCd) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.vvdRmk = vvdRmk;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return CoaOpAvgUtCostIfVO[]
	 */
	public CoaOpAvgUtCostIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaOpAvgUtCostIfVO[]
	 */
	public CoaOpAvgUtCostIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaOpAvgUtCostIfVO model = null;
	 ...
	 * @return CoaOpAvgUtCostIfVO[]
	 */
	public CoaOpAvgUtCostIfVO[] getCoaOpAvgUtCostIfVOs(){
		CoaOpAvgUtCostIfVO[] vos = (CoaOpAvgUtCostIfVO[])models.toArray(new CoaOpAvgUtCostIfVO[models.size()]);
		return vos;
	}
