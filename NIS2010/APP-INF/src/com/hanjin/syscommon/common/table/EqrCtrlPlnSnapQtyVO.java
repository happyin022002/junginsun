...
*@FileName : EqrCtrlPlnSnapQtyVO.java
*@FileTitle : EqrCtrlPlnSnapQtyVO
*Open Issues :
*Change history :
...
public class EqrCtrlPlnSnapQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrCtrlPlnSnapQtyVO> models = new ArrayList<EqrCtrlPlnSnapQtyVO>();
	...
	public EqrCtrlPlnSnapQtyVO() {}

	public EqrCtrlPlnSnapQtyVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String podYdCd, String toEtbDt, String fcastYrwk, String cntrTpszCd, String cntrQty, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
...
/**
	 ...
	 * @param request
	 * @return EqrCtrlPlnSnapQtyVO[]
	 */
	public EqrCtrlPlnSnapQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrCtrlPlnSnapQtyVO[]
	 */
	public EqrCtrlPlnSnapQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrCtrlPlnSnapQtyVO model = null;
		...
		return getEqrCtrlPlnSnapQtyVOs();
	}
	 ...
	 * @return EqrCtrlPlnSnapQtyVO[]
	 */
	public EqrCtrlPlnSnapQtyVO[] getEqrCtrlPlnSnapQtyVOs(){
		EqrCtrlPlnSnapQtyVO[] vos = (EqrCtrlPlnSnapQtyVO[])models.toArray(new EqrCtrlPlnSnapQtyVO[models.size()]);
		return vos;
	}
