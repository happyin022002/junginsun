...
public class BkgUsrDfltSetVO extends AbstractValueObject {
	...
	private String vskdDlayFlg = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vskd_dlay_flg", getVskdDlayFlg());
		...
		this.hashColumns.put("smpl_si_flg", getSmplSiFlg());
		this.hashColumns.put("pod_cd", getPodCd());
		this.hashColumns.put("date_flg", getDateFlg());
		this.hashColumns.put("hbl_tp", getHblTp());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("vskd_dlay_flg", "vskdDlayFlg");
		...
		this.hashFields.put("smpl_si_flg", "smplSiFlg");
		this.hashFields.put("pod_cd", "podCd");
		this.hashFields.put("date_flg", "dateFlg");
		this.hashFields.put("hbl_tp", "hblTp");
	 ...
	 * @param hblTp
	 */
	public void setHblTp(String hblTp) {
		this.hblTp = hblTp;
	}
	...
	public String getVskdDlayFlg() {
		return vskdDlayFlg;
	}

	public void setVskdDlayFlg(String vskdDlayFlg) {
		this.vskdDlayFlg = vskdDlayFlg;
	}
	...
	public String getSmplSiFlg() {
		return smplSiFlg;
	}
	
	public void setSmplSiFlg(String smplSiFlg) {
		this.smplSiFlg = smplSiFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setHblTp(JSPUtil.getParameter(request, "hbl_tp", ""));
		...
		setVskdDlayFlg(JSPUtil.getParameter(request, "vskd_dlay_flg", ""));
		...
		setSmplSiFlg(JSPUtil.getParameter(request, "smpl_si_flg", ""));
		setPodCd(JSPUtil.getParameter(request, "pod_cd", ""));
		setDateFlg(JSPUtil.getParameter(request, "date_flg", ""));
	}
	...
	public BkgUsrDfltSetVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] vskdDlayFlg = (JSPUtil.getParameter(request, prefix	+ "vskd_dlay_flg", length));
			...
			String[] smplSiFlg = (JSPUtil.getParameter(request, prefix	+ "smpl_si_flg", length));
			String[] podCd = (JSPUtil.getParameter(request, prefix	+ "pod_cd", length));
			String[] dateFlg = (JSPUtil.getParameter(request, prefix	+ "date_flg", length));
			String[] hblTp = (JSPUtil.getParameter(request, prefix	+ "hbl_tp", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (vskdDlayFlg[i] != null)
					model.setVskdDlayFlg(vskdDlayFlg[i]);
				...
				if (smplSiFlg[i] != null)
					model.setSmplSiFlg(smplSiFlg[i]);
				if (podCd[i] != null)
					model.setPodCd(podCd[i]);
				if (dateFlg[i] != null)
					model.setDateFlg(dateFlg[i]);
				if (hblTp[i] != null)
					model.setHblTp(hblTp[i]);
				models.add(model);
			}
	...
	*/
	public void unDataFormat(){
		...
		this.vskdDlayFlg = this.vskdDlayFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.smplSiFlg = this.smplSiFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podCd = this.podCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.dateFlg = this.dateFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.hblTp = this.hblTp .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
