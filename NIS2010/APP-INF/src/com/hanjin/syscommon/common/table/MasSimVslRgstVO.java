...
*@FileName : MasSimVslRgstVO.java
*@FileTitle : MasSimVslRgstVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimVslRgstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimVslRgstVO> models = new ArrayList<MasSimVslRgstVO>();
	...
	public MasSimVslRgstVO() {}

	public MasSimVslRgstVO(String ibflag, String pagerows, String vslCd, String vslOshpCd, String vopCd, String portClssCapa, String vslClssCapa, String stndLdbCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return MasSimVslRgstVO[]
	 */
	public MasSimVslRgstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimVslRgstVO[]
	 */
	public MasSimVslRgstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimVslRgstVO model = null;
	 ...
	 * @return MasSimVslRgstVO[]
	 */
	public MasSimVslRgstVO[] getMasSimVslRgstVOs(){
		MasSimVslRgstVO[] vos = (MasSimVslRgstVO[])models.toArray(new MasSimVslRgstVO[models.size()]);
		return vos;
	}
