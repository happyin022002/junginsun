...
*@FileName : PriSpScpRtCmdtRnoteVO.java
*@FileTitle : PriSpScpRtCmdtRnoteVO
*Open Issues :
*Change history :
...
public class PriSpScpRtCmdtRnoteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRtCmdtRnoteVO> models = new ArrayList<PriSpScpRtCmdtRnoteVO>();
	 ...
	 * @param request
	 * @return PriSpScpRtCmdtRnoteVO[]
	 */
	public PriSpScpRtCmdtRnoteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRtCmdtRnoteVO[]
	 */
	public PriSpScpRtCmdtRnoteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRtCmdtRnoteVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriSpScpRtCmdtRnoteVO();
				if (updDt[i] != null)
		...
		return getPriSpScpRtCmdtRnoteVOs();
	}
	...
	public PriSpScpRtCmdtRnoteVO[] getPriSpScpRtCmdtRnoteVOs(){
		PriSpScpRtCmdtRnoteVO[] vos = (PriSpScpRtCmdtRnoteVO[])models.toArray(new PriSpScpRtCmdtRnoteVO[models.size()]);
		return vos;
	}
