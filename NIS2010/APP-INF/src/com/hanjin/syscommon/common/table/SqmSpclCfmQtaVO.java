...
*@FileName : SqmSpclCfmQtaVO.java
*@FileTitle : SqmSpclCfmQtaVO
*Open Issues :
*Change history :
...
public class SqmSpclCfmQtaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSpclCfmQtaVO> models = new ArrayList<SqmSpclCfmQtaVO>();
...
/**
	 ...
	 */
	public SqmSpclCfmQtaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSpclCfmQtaVO[]
	 */
	public SqmSpclCfmQtaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSpclCfmQtaVO model = null;
	...
	public SqmSpclCfmQtaVO[] getSqmSpclCfmQtaVOs(){
		SqmSpclCfmQtaVO[] vos = (SqmSpclCfmQtaVO[])models.toArray(new SqmSpclCfmQtaVO[models.size()]);
		return vos;
	}
