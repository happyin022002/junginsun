...
*@FileName : PriRpScpNoteVO.java
*@FileTitle : PriRpScpNoteVO
*Open Issues :
*Change history :
...
public class PriRpScpNoteVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpNoteVO> models = new ArrayList<PriRpScpNoteVO>();
	...
	public PriRpScpNoteVO() {}

	public PriRpScpNoteVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String noteTpCd, String noteSeq, String noteTitNm, String noteClssCd, String dpSeq, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.dpSeq = dpSeq;
	 ...
	 */
	public PriRpScpNoteVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpNoteVO[]
	 */
	public PriRpScpNoteVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpNoteVO model = null;
	 ...
	 * @return PriRpScpNoteVO[]
	 */
	public PriRpScpNoteVO[] getPriRpScpNoteVOs(){
		PriRpScpNoteVO[] vos = (PriRpScpNoteVO[])models.toArray(new PriRpScpNoteVO[models.size()]);
		return vos;
	}
