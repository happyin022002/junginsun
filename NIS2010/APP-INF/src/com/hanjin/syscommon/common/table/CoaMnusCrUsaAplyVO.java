...
*@FileName : CoaMnusCrUsaAplyVO.java
*@FileTitle : CoaMnusCrUsaAplyVO
*Open Issues :
*Change history :
...
public class CoaMnusCrUsaAplyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaMnusCrUsaAplyVO> models = new ArrayList<CoaMnusCrUsaAplyVO>();
	...
	public CoaMnusCrUsaAplyVO() {}

	public CoaMnusCrUsaAplyVO(String ibflag, String pagerows, String costYrmon, String eccCd, String cntrTpszCd, String portEccVlQty, String portEccVdQty, String cntrImbalQty, String mnusCrAplyFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaMnusCrUsaAplyVO[]
	 */
	public CoaMnusCrUsaAplyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaMnusCrUsaAplyVO[]
	 */
	public CoaMnusCrUsaAplyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaMnusCrUsaAplyVO model = null;
	 ...
	 * @return CoaMnusCrUsaAplyVO[]
	 */
	public CoaMnusCrUsaAplyVO[] getCoaMnusCrUsaAplyVOs(){
		CoaMnusCrUsaAplyVO[] vos = (CoaMnusCrUsaAplyVO[])models.toArray(new CoaMnusCrUsaAplyVO[models.size()]);
		return vos;
	}
