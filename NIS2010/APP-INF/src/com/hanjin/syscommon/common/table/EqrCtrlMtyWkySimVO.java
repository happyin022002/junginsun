...
*@FileName : EqrCtrlMtyWkySimVO.java
*@FileTitle : EqrCtrlMtyWkySimVO
*Open Issues :
*Change history :
...
public class EqrCtrlMtyWkySimVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrCtrlMtyWkySimVO> models = new ArrayList<EqrCtrlMtyWkySimVO>();
	...
	public EqrCtrlMtyWkySimVO() {}

	public EqrCtrlMtyWkySimVO(String ibflag, String pagerows, String fcastYrwk, String locGrpCd, String locCd, String wkySimTpCd, String cntrTpszCd, String cntrQty, String tmpSavFlg, String cfmFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.cfmFlg = cfmFlg;
...
/**
	 ...
	 * @param request
	 * @return EqrCtrlMtyWkySimVO[]
	 */
	public EqrCtrlMtyWkySimVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrCtrlMtyWkySimVO[]
	 */
	public EqrCtrlMtyWkySimVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrCtrlMtyWkySimVO model = null;
	 ...
	 * @return EqrCtrlMtyWkySimVO[]
	 */
	public EqrCtrlMtyWkySimVO[] getEqrCtrlMtyWkySimVOs(){
		EqrCtrlMtyWkySimVO[] vos = (EqrCtrlMtyWkySimVO[])models.toArray(new EqrCtrlMtyWkySimVO[models.size()]);
		return vos;
	}
