...
*@FileName : CgmEqTpSzVO.java
*@FileTitle : CgmEqTpSzVO
*Open Issues :
*Change history :
...
public class CgmEqTpSzVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CgmEqTpSzVO> models = new ArrayList<CgmEqTpSzVO>();
	...
	public CgmEqTpSzVO(String ibflag, String pagerows, String eqTpszCd, String eqKndCd, String eqTpszRepCd, String dpSeq, String diffDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.dpSeq = dpSeq;
	 ...
	 * @return CgmEqTpSzVO[]
	 */
	public CgmEqTpSzVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CgmEqTpSzVO[]
	 */
	public CgmEqTpSzVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CgmEqTpSzVO model = null;
	 ...
	 * @return CgmEqTpSzVO[]
	 */
	public CgmEqTpSzVO[] getCgmEqTpSzVOs(){
		CgmEqTpSzVO[] vos = (CgmEqTpSzVO[])models.toArray(new CgmEqTpSzVO[models.size()]);
		return vos;
	}
