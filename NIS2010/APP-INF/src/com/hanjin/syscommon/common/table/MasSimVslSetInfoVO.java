...
*@FileName : MasSimVslSetInfoVO.java
*@FileTitle : MasSimVslSetInfoVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimVslSetInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimVslSetInfoVO> models = new ArrayList<MasSimVslSetInfoVO>();
	 ...
	 * @param request
	 * @return MasSimVslSetInfoVO[]
	 */
	public MasSimVslSetInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimVslSetInfoVO[]
	 */
	public MasSimVslSetInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimVslSetInfoVO model = null;
	 ...
	 * @return MasSimVslSetInfoVO[]
	 */
	public MasSimVslSetInfoVO[] getMasSimVslSetInfoVOs(){
		MasSimVslSetInfoVO[] vos = (MasSimVslSetInfoVO[])models.toArray(new MasSimVslSetInfoVO[models.size()]);
		return vos;
	}
