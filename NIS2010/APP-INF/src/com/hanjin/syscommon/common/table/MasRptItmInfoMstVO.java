...
*@FileName : MasRptItmInfoMstVO.java
*@FileTitle : MasRptItmInfoMstVO
*Open Issues :
*Change history :
 ...
 */
public class MasRptItmInfoMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRptItmInfoMstVO> models = new ArrayList<MasRptItmInfoMstVO>();
	...
	public MasRptItmInfoMstVO() {}

	public MasRptItmInfoMstVO(String ibflag, String pagerows, String slctItmFomSeq, String creUsrId, String slctItmFomDesc, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasRptItmInfoMstVO[]
	 */
	public MasRptItmInfoMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRptItmInfoMstVO[]
	 */
	public MasRptItmInfoMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRptItmInfoMstVO model = null;
	...
	public MasRptItmInfoMstVO[] getMasRptItmInfoMstVOs(){
		MasRptItmInfoMstVO[] vos = (MasRptItmInfoMstVO[])models.toArray(new MasRptItmInfoMstVO[models.size()]);
		return vos;
	}
