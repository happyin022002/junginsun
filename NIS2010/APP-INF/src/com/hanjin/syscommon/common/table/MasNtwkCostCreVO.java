...
*@FileName : MasNtwkCostCreVO.java
*@FileTitle : MasNtwkCostCreVO
*Open Issues :
*Change history :
 ...
 */
public class MasNtwkCostCreVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasNtwkCostCreVO> models = new ArrayList<MasNtwkCostCreVO>();
	...
	public MasNtwkCostCreVO() {}

	public MasNtwkCostCreVO(String ibflag, String pagerows, String stndCostCd, String vslOshpCd, String vopCd, String creStsCd, String creSlctFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasNtwkCostCreVO[]
	 */
	public MasNtwkCostCreVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasNtwkCostCreVO[]
	 */
	public MasNtwkCostCreVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasNtwkCostCreVO model = null;
	...
	public MasNtwkCostCreVO[] getMasNtwkCostCreVOs(){
		MasNtwkCostCreVO[] vos = (MasNtwkCostCreVO[])models.toArray(new MasNtwkCostCreVO[models.size()]);
		return vos;
	}
