...
*@FileName : SCE_CLM_IF.java
*@FileTitle : CLM Data Interface
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public final class SCE_CLM_IF implements java.io.Serializable {
	...
	public SCE_CLM_IF(
		...
		this.so_mapg_sts_cd = so_mapg_sts_cd;
	...
	public String         getSo_mapg_sts_cd(){	return so_mapg_sts_cd	;	}
	...
	public void setSo_mapg_sts_cd( String         so_mapg_sts_cd ){	this.so_mapg_sts_cd = so_mapg_sts_cd	;	}
	public void setErr_msg       ( String         err_msg        ){	this.err_msg        = err_msg       	;	}

	public static SCE_CLM_IF fromRequest(HttpServletRequest request) {
		SCE_CLM_IF model = new SCE_CLM_IF();
		try {
			...
			model.setSo_mapg_sts_cd	(JSPUtil.getParameter(request, "so_mapg_sts_cd		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] so_mapg_sts_cd =  (JSPUtil.getParameter(request, "so_mapg_sts_cd		".trim(), length));
			String[] err_msg        =  (JSPUtil.getParameter(request, "err_msg       		".trim(), length));
			for (int i = 0; i < length; i++) {
				model = new SCE_CLM_IF();
				...
				model.setSo_mapg_sts_cd		  (so_mapg_sts_cd	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] so_mapg_sts_cd =  (JSPUtil.getParameter(request, prefix + "so_mapg_sts_cd		".trim(), length));
