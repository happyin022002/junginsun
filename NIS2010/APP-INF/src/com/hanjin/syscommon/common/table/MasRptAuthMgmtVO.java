...
*@FileName : MasRptAuthMgmtVO.java
*@FileTitle : MasRptAuthMgmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasRptAuthMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRptAuthMgmtVO> models = new ArrayList<MasRptAuthMgmtVO>();
	 ...
	 */
	public MasRptAuthMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRptAuthMgmtVO[]
	 */
	public MasRptAuthMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRptAuthMgmtVO model = null;
	...
	public MasRptAuthMgmtVO[] getMasRptAuthMgmtVOs(){
		MasRptAuthMgmtVO[] vos = (MasRptAuthMgmtVO[])models.toArray(new MasRptAuthMgmtVO[models.size()]);
		return vos;
	}
