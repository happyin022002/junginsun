...
*@FileName : MasCntrMtyMvmtVO.java
*@FileTitle : MasCntrMtyMvmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrMtyMvmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrMtyMvmtVO> models = new ArrayList<MasCntrMtyMvmtVO>();
	 ...
	 * @param request
	 * @return MasCntrMtyMvmtVO[]
	 */
	public MasCntrMtyMvmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrMtyMvmtVO[]
	 */
	public MasCntrMtyMvmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrMtyMvmtVO model = null;
	 ...
	 * @return MasCntrMtyMvmtVO[]
	 */
	public MasCntrMtyMvmtVO[] getMasCntrMtyMvmtVOs(){
		MasCntrMtyMvmtVO[] vos = (MasCntrMtyMvmtVO[])models.toArray(new MasCntrMtyMvmtVO[models.size()]);
		return vos;
	}
