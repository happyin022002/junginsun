...
*@FileName : PriRpScpRtCmdtVO.java
*@FileTitle : PriRpScpRtCmdtVO
*Open Issues :
*Change history :
...
public class PriRpScpRtCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtCmdtVO> models = new ArrayList<PriRpScpRtCmdtVO>();
	 ...
	 * @param request
	 * @return PriRpScpRtCmdtVO[]
	 */
	public PriRpScpRtCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtCmdtVO[]
	 */
	public PriRpScpRtCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtCmdtVO model = null;
	...
	public PriRpScpRtCmdtVO[] getPriRpScpRtCmdtVOs(){
		PriRpScpRtCmdtVO[] vos = (PriRpScpRtCmdtVO[])models.toArray(new PriRpScpRtCmdtVO[models.size()]);
		return vos;
	}
