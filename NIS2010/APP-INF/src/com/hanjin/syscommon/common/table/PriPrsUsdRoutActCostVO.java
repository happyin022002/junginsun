...
*@FileName : PriPrsUsdRoutActCostVO.java
*@FileTitle : PriPrsUsdRoutActCostVO
*Open Issues :
*Change history :
...
public class PriPrsUsdRoutActCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriPrsUsdRoutActCostVO> models = new ArrayList<PriPrsUsdRoutActCostVO>();
	...
	/* Column Info */
	private String pstActGrpCd = null;
	/* Column Info */
	...
	/* Column Info */
	private String preActGrpCd = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pst_act_grp_cd", getPstActGrpCd());
		...
		this.hashColumns.put("pre_act_grp_cd", getPreActGrpCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pst_act_grp_cd", "pstActGrpCd");
		...
		this.hashFields.put("pre_act_grp_cd", "preActGrpCd");
	 ...
	 * @return pstActGrpCd
	 */
	public String getPstActGrpCd() {
		return this.pstActGrpCd;
	}
	 ...
	 * @return preActGrpCd
	 */
	public String getPreActGrpCd() {
		return this.preActGrpCd;
	}
	 ...
	 * @param pstActGrpCd
	 */
	public void setPstActGrpCd(String pstActGrpCd) {
		this.pstActGrpCd = pstActGrpCd;
	}
	 ...
	 * @param preActGrpCd
	 */
	public void setPreActGrpCd(String preActGrpCd) {
		this.preActGrpCd = preActGrpCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPstActGrpCd(JSPUtil.getParameter(request, "pst_act_grp_cd", ""));
		...
		setPreActGrpCd(JSPUtil.getParameter(request, "pre_act_grp_cd", ""));
	 ...
	 * @param request
	 * @return PriPrsUsdRoutActCostVO[]
	 */
	public PriPrsUsdRoutActCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriPrsUsdRoutActCostVO[]
	 */
	public PriPrsUsdRoutActCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriPrsUsdRoutActCostVO model = null;
		...
		try {
			...
			String[] pstActGrpCd = (JSPUtil.getParameter(request, prefix	+ "pst_act_grp_cd", length));
			...
			String[] preActGrpCd = (JSPUtil.getParameter(request, prefix	+ "pre_act_grp_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new PriPrsUsdRoutActCostVO();
				...
				if (pstActGrpCd[i] != null)
					model.setPstActGrpCd(pstActGrpCd[i]);
				...
				if (preActGrpCd[i] != null)
					model.setPreActGrpCd(preActGrpCd[i]);
		...
		return getPriPrsUsdRoutActCostVOs();
	}
	 ...
	 * @return PriPrsUsdRoutActCostVO[]
	 */
	public PriPrsUsdRoutActCostVO[] getPriPrsUsdRoutActCostVOs(){
		PriPrsUsdRoutActCostVO[] vos = (PriPrsUsdRoutActCostVO[])models.toArray(new PriPrsUsdRoutActCostVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.pstActGrpCd = this.pstActGrpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.preActGrpCd = this.preActGrpCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
