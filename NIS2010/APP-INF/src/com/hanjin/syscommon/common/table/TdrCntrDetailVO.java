...
public class TdrCntrDetailVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("upd_sys_cd", getUpdSysCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("upd_sys_cd", "updSysCd");
	 ...
	 * @return updSysCd
	 */
	public String getUpdSysCd() {
		return this.updSysCd;
	}
	 ...
	 * @param updSysCd
	 */
	public void setUpdSysCd(String updSysCd) {
		this.updSysCd = updSysCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPsaClass(JSPUtil.getParameter(request, prefix + "psa_class", ""));
		setPor(JSPUtil.getParameter(request, prefix + "por", ""));
		setDmCode(JSPUtil.getParameter(request, prefix + "dm_code", ""));
		setDmChk(JSPUtil.getParameter(request, prefix + "dm_chk", ""));
		...
		setPrePod(JSPUtil.getParameter(request, prefix + "pre_pod", ""));
		setPodIso(JSPUtil.getParameter(request, prefix + "pod_iso", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setCodChk(JSPUtil.getParameter(request, prefix + "cod_chk", ""));
		setPol(JSPUtil.getParameter(request, prefix + "pol", ""));
		setPod(JSPUtil.getParameter(request, prefix + "pod", ""));
		setDmh(JSPUtil.getParameter(request, prefix + "dmh", ""));
		setHcChk(JSPUtil.getParameter(request, prefix + "hc_chk", ""));
		setUpdateTime(JSPUtil.getParameter(request, prefix + "update_time", ""));
		setStatus(JSPUtil.getParameter(request, prefix + "status", ""));
		setDmb(JSPUtil.getParameter(request, prefix + "dmb", ""));
		setWidth(JSPUtil.getParameter(request, prefix + "width", ""));
		setGrossWork(JSPUtil.getParameter(request, prefix + "gross_work", ""));
		setDelvCd(JSPUtil.getParameter(request, prefix + "delv_cd", ""));
		setGrossGang(JSPUtil.getParameter(request, prefix + "gross_gang", ""));
		setPod2(JSPUtil.getParameter(request, prefix + "pod2", ""));
		setCommence(JSPUtil.getParameter(request, prefix + "commence", ""));
		setRfChk(JSPUtil.getParameter(request, prefix + "rf_chk", ""));
		setPageNo(JSPUtil.getParameter(request, prefix + "page_no", ""));
		setNetGang(JSPUtil.getParameter(request, prefix + "net_gang", ""));
		setTemp(JSPUtil.getParameter(request, prefix + "temp", ""));
		setUpdSysCd(JSPUtil.getParameter(request, prefix + "upd_sys_cd", ""));
		setCrane(JSPUtil.getParameter(request, prefix + "crane", ""));
		setSztp(JSPUtil.getParameter(request, prefix + "sztp", ""));
		setUpdateUser(JSPUtil.getParameter(request, prefix + "update_user", ""));
		setDml(JSPUtil.getParameter(request, prefix + "dml", ""));
		setPosition(JSPUtil.getParameter(request, prefix + "position", ""));
		setWeight(JSPUtil.getParameter(request, prefix + "weight", ""));
		setLostHr(JSPUtil.getParameter(request, prefix + "lost_hr", ""));
		setOptionChk(JSPUtil.getParameter(request, prefix + "option_chk", ""));
		setPrecell(JSPUtil.getParameter(request, prefix + "precell", ""));
		setImdg(JSPUtil.getParameter(request, prefix + "imdg", ""));
		setNetWork(JSPUtil.getParameter(request, prefix + "net_work", ""));
		setTempChk(JSPUtil.getParameter(request, prefix + "temp_chk", ""));
		...
		setComplete(JSPUtil.getParameter(request, prefix + "complete", ""));
		setCargoType(JSPUtil.getParameter(request, prefix + "cargo_type", ""));
		setLength(JSPUtil.getParameter(request, prefix + "length", ""));
		setOvp(JSPUtil.getParameter(request, prefix + "ovp", ""));
		setDirCd(JSPUtil.getParameter(request, prefix + "dir_cd", ""));
		setPortCd(JSPUtil.getParameter(request, prefix + "port_cd", ""));
		setSlot(JSPUtil.getParameter(request, prefix + "slot", ""));
		setShiftChk(JSPUtil.getParameter(request, prefix + "shift_chk", ""));
		...
		setDgChk(JSPUtil.getParameter(request, prefix + "dg_chk", ""));
		...
		setMishandleChk(JSPUtil.getParameter(request, prefix + "mishandle_chk", ""));
	...
	public TdrCntrDetailVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		String[] tmp = request.getParameterValues(prefix + "ibflag");
  		...
  		int len = request.getParameterValues(prefix + "ibflag").length;
  
		try {
			String[] shiftType = (JSPUtil.getParameter(request, prefix	+ "shift_type", len));
			String[] vslCd = (JSPUtil.getParameter(request, prefix	+ "vsl_cd", len));
			String[] remark = (JSPUtil.getParameter(request, prefix	+ "remark", len));
			String[] psaClass = (JSPUtil.getParameter(request, prefix	+ "psa_class", len));
			String[] por = (JSPUtil.getParameter(request, prefix	+ "por", len));
			String[] dmCode = (JSPUtil.getParameter(request, prefix	+ "dm_code", len));
			String[] dmChk = (JSPUtil.getParameter(request, prefix	+ "dm_chk", len));
			String[] fpod = (JSPUtil.getParameter(request, prefix	+ "fpod", len));
			String[] codRsn = (JSPUtil.getParameter(request, prefix	+ "cod_rsn", len));
			String[] party = (JSPUtil.getParameter(request, prefix	+ "party", len));
			String[] prePod = (JSPUtil.getParameter(request, prefix	+ "pre_pod", len));
			String[] podIso = (JSPUtil.getParameter(request, prefix	+ "pod_iso", len));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", len));
			String[] codChk = (JSPUtil.getParameter(request, prefix	+ "cod_chk", len));
			String[] pol = (JSPUtil.getParameter(request, prefix	+ "pol", len));
			String[] pod = (JSPUtil.getParameter(request, prefix	+ "pod", len));
			String[] dmh = (JSPUtil.getParameter(request, prefix	+ "dmh", len));
			String[] hcChk = (JSPUtil.getParameter(request, prefix	+ "hc_chk", len));
			String[] updateTime = (JSPUtil.getParameter(request, prefix	+ "update_time", len));
			String[] status = (JSPUtil.getParameter(request, prefix	+ "status", len));
			String[] dmb = (JSPUtil.getParameter(request, prefix	+ "dmb", len));
			String[] width = (JSPUtil.getParameter(request, prefix	+ "width", len));
			String[] grossWork = (JSPUtil.getParameter(request, prefix	+ "gross_work", len));
			String[] delvCd = (JSPUtil.getParameter(request, prefix	+ "delv_cd", len));
			String[] grossGang = (JSPUtil.getParameter(request, prefix	+ "gross_gang", len));
			String[] pod2 = (JSPUtil.getParameter(request, prefix	+ "pod2", len));
			String[] commence = (JSPUtil.getParameter(request, prefix	+ "commence", len));
			String[] rfChk = (JSPUtil.getParameter(request, prefix	+ "rf_chk", len));
			String[] pageNo = (JSPUtil.getParameter(request, prefix	+ "page_no", len));
			String[] netGang = (JSPUtil.getParameter(request, prefix	+ "net_gang", len));
			String[] temp = (JSPUtil.getParameter(request, prefix	+ "temp", len));
			String[] updSysCd = (JSPUtil.getParameter(request, prefix	+ "upd_sys_cd", len));
			String[] crane = (JSPUtil.getParameter(request, prefix	+ "crane", len));
			String[] sztp = (JSPUtil.getParameter(request, prefix	+ "sztp", len));
			String[] updateUser = (JSPUtil.getParameter(request, prefix	+ "update_user", len));
			String[] dml = (JSPUtil.getParameter(request, prefix	+ "dml", len));
			String[] position = (JSPUtil.getParameter(request, prefix	+ "position", len));
			String[] weight = (JSPUtil.getParameter(request, prefix	+ "weight", len));
			String[] lostHr = (JSPUtil.getParameter(request, prefix	+ "lost_hr", len));
			String[] optionChk = (JSPUtil.getParameter(request, prefix	+ "option_chk", len));
			String[] precell = (JSPUtil.getParameter(request, prefix	+ "precell", len));
			String[] imdg = (JSPUtil.getParameter(request, prefix	+ "imdg", len));
			String[] netWork = (JSPUtil.getParameter(request, prefix	+ "net_work", len));
			String[] tempChk = (JSPUtil.getParameter(request, prefix	+ "temp_chk", len));
			String[] unno = (JSPUtil.getParameter(request, prefix	+ "unno", len));
			String[] ovh = (JSPUtil.getParameter(request, prefix	+ "ovh", len));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", len));
			String[] callInd = (JSPUtil.getParameter(request, prefix	+ "call_ind", len));
			String[] pod2Iso = (JSPUtil.getParameter(request, prefix	+ "pod2_iso", len));
			String[] complete = (JSPUtil.getParameter(request, prefix	+ "complete", len));
			String[] cargoType = (JSPUtil.getParameter(request, prefix	+ "cargo_type", len));
			String[] length = (JSPUtil.getParameter(request, prefix	+ "len", len));
			String[] ovp = (JSPUtil.getParameter(request, prefix	+ "ovp", len));
			String[] dirCd = (JSPUtil.getParameter(request, prefix	+ "dir_cd", len));
			String[] portCd = (JSPUtil.getParameter(request, prefix	+ "port_cd", len));
			String[] slot = (JSPUtil.getParameter(request, prefix	+ "slot", len));
			String[] shiftChk = (JSPUtil.getParameter(request, prefix	+ "shift_chk", len));
			String[] ovs = (JSPUtil.getParameter(request, prefix	+ "ovs", len));
			String[] voyNo = (JSPUtil.getParameter(request, prefix	+ "voy_no", len));
			String[] ova = (JSPUtil.getParameter(request, prefix	+ "ova", len));
			String[] dgChk = (JSPUtil.getParameter(request, prefix	+ "dg_chk", len));
			String[] shiftRsn = (JSPUtil.getParameter(request, prefix	+ "shift_rsn", len));
			String[] ovf = (JSPUtil.getParameter(request, prefix	+ "ovf", len));
			String[] cntrType = (JSPUtil.getParameter(request, prefix	+ "cntr_type", len));
			String[] mishandleChk = (JSPUtil.getParameter(request, prefix	+ "mishandle_chk", len));
			String[] respbCntrNo = (JSPUtil.getParameter(request, prefix	+ "respb_cntr_no", len));
			String[] fe = (JSPUtil.getParameter(request, prefix	+ "fe", len));
			String[] unit = (JSPUtil.getParameter(request, prefix	+ "unit", len));
			String[] cntrSize = (JSPUtil.getParameter(request, prefix	+ "cntr_size", len));
			String[] commodity = (JSPUtil.getParameter(request, prefix	+ "commodity", len));
			String[] oprCd = (JSPUtil.getParameter(request, prefix	+ "opr_cd", len));
			String[] cntrNo = (JSPUtil.getParameter(request, prefix	+ "cntr_no", len));
			String[] account = (JSPUtil.getParameter(request, prefix	+ "account", len));
	...
	*/
	public void unDataFormat(){
		...
		this.updSysCd = this.updSysCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
