...
public class PriTariffVO extends AbstractValueObject {
	...
	public PriTariffVO(String ibflag, String pagerows, String trfPfxCd, String trfNo, String trfNm, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String trfOrzNm, String trfOrzTpNm, String trfClssCd, String trfInlndFlg, String webDpFlg) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("web_dp_flg", getWebDpFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("web_dp_flg", "webDpFlg");
	 ...
	 * @return webDpFlg
	 */
	public String getWebDpFlg() {
		return this.webDpFlg;
	}	
	 ...
	 * @param webDpFlg
	 */
	public void setWebDpFlg(String webDpFlg) {
		this.webDpFlg = webDpFlg;
	}	
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setWebDpFlg(JSPUtil.getParameter(request, prefix + "web_dp_flg", ""));
	...
	public PriTariffVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] webDpFlg = (JSPUtil.getParameter(request, prefix	+ "web_dp_flg", length));
	...
	*/
	public void unDataFormat(){
		...
		this.webDpFlg = this.webDpFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
