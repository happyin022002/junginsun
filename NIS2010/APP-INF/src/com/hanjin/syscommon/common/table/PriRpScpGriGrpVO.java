...
*@FileName : PriRpScpGriGrpVO.java
*@FileTitle : PriRpScpGriGrpVO
*Open Issues :
*Change history :
...
public class PriRpScpGriGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpGriGrpVO> models = new ArrayList<PriRpScpGriGrpVO>();
	...
	public PriRpScpGriGrpVO() {}

	public PriRpScpGriGrpVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String fltPctTpCd, String griApplDivCd, String griApplFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRpScpGriGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpGriGrpVO[]
	 */
	public PriRpScpGriGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpGriGrpVO model = null;
	...
	public PriRpScpGriGrpVO[] getPriRpScpGriGrpVOs(){
		PriRpScpGriGrpVO[] vos = (PriRpScpGriGrpVO[])models.toArray(new PriRpScpGriGrpVO[models.size()]);
		return vos;
	}
