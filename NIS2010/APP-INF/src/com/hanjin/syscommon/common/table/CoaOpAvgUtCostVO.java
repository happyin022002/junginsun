...
public class CoaOpAvgUtCostVO extends AbstractValueObject {
	...
	public CoaOpAvgUtCostVO(String ibflag, String pagerows, String costYrmon, String trdCd, String rlaneCd, String stndCostCd, String opLaneTpCd, String opCostAmt, String bsaCapa, String opUcAmt, String vvdRmk, String creUsrId, String creDt, String updUsrId, String updDt, String costUseTpCd, String dirCd) {
		this.updDt = updDt;
		this.vvdRmk = vvdRmk;
		this.creDt = creDt;
		this.trdCd = trdCd;
