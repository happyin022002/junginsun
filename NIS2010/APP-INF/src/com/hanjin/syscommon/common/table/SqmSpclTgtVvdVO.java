...
*@FileName : SqmSpclTgtVvdVO.java
*@FileTitle : SqmSpclTgtVvdVO
*Open Issues :
*Change history :
...
public class SqmSpclTgtVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSpclTgtVvdVO> models = new ArrayList<SqmSpclTgtVvdVO>();
	...
	public SqmSpclTgtVvdVO() {}

	public SqmSpclTgtVvdVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String vslCd, String skdVoyNo, String skdDirCd, String bseMon, String bseWk, String convDirCd, String subTrdCd, String iocCd, String fnlBsaCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
		this.vslCd = vslCd;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return SqmSpclTgtVvdVO[]
	 */
	public SqmSpclTgtVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSpclTgtVvdVO[]
	 */
	public SqmSpclTgtVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSpclTgtVvdVO model = null;
	 ...
	 * @return SqmSpclTgtVvdVO[]
	 */
	public SqmSpclTgtVvdVO[] getSqmSpclTgtVvdVOs(){
		SqmSpclTgtVvdVO[] vos = (SqmSpclTgtVvdVO[])models.toArray(new SqmSpclTgtVvdVO[models.size()]);
		return vos;
	}
