...
*@FileName : PriScgPctBseChgVO.java
*@FileTitle : PriScgPctBseChgVO
*Open Issues :
*Change history :
...
public class PriScgPctBseChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriScgPctBseChgVO> models = new ArrayList<PriScgPctBseChgVO>();
	...
	public PriScgPctBseChgVO() {}

	public PriScgPctBseChgVO(String ibflag, String pagerows, String pctBseCd, String chgCd, String creUsrId, String creDt, String updUsrId, String updDt, String pctBseChgSeq, String effDt, String expDt) {
		this.updDt = updDt;
	...
	public final String getPctBseChgSeq() {
		return pctBseChgSeq;
	}

	public final void setPctBseChgSeq(String pctBseChgSeq) {
		this.pctBseChgSeq = pctBseChgSeq;
	}
	...
	public final void setEffDt(String effDt) {
		this.effDt = effDt;
	}
	...
	public final void setExpDt(String expDt) {
		this.expDt = expDt;
	}
...
/**
	 ...
	 */
	public PriScgPctBseChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriScgPctBseChgVO[]
	 */
	public PriScgPctBseChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriScgPctBseChgVO model = null;
	...
	public PriScgPctBseChgVO[] getPriScgPctBseChgVOs(){
		PriScgPctBseChgVO[] vos = (PriScgPctBseChgVO[])models.toArray(new PriScgPctBseChgVO[models.size()]);
		return vos;
	}
