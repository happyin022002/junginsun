...
*@FileName : PriRpScpGriRoutPntVO.java
*@FileTitle : PriRpScpGriRoutPntVO
*Open Issues :
*Change history :
...
public class PriRpScpGriRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpGriRoutPntVO> models = new ArrayList<PriRpScpGriRoutPntVO>();
	 ...
	 * @param request
	 * @return PriRpScpGriRoutPntVO[]
	 */
	public PriRpScpGriRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpGriRoutPntVO[]
	 */
	public PriRpScpGriRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpGriRoutPntVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriRpScpGriRoutPntVO();
				if (updDt[i] != null)
		...
		return getPriRpScpGriRoutPntVOs();
	}
	 ...
	 * @return PriRpScpGriRoutPntVO[]
	 */
	public PriRpScpGriRoutPntVO[] getPriRpScpGriRoutPntVOs(){
		PriRpScpGriRoutPntVO[] vos = (PriRpScpGriRoutPntVO[])models.toArray(new PriRpScpGriRoutPntVO[models.size()]);
		return vos;
	}
