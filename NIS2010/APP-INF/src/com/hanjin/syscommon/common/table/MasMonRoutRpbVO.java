...
*@FileName : MasMonRoutRpbVO.java
*@FileTitle : MasMonRoutRpbVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonRoutRpbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonRoutRpbVO> models = new ArrayList<MasMonRoutRpbVO>();
	...
	public MasMonRoutRpbVO() {}

	public MasMonRoutRpbVO(String ibflag, String pagerows, String rpbYrmon, String rlaneCd, String iocCd, String bkgPorCd, String bkgDelCd, String cntrTpszCd, String bkgAvgRpbRev, String bkgOftAvgRpbRev, String bkgMiscAvgRpbRev, String scrChgAvgRpbRev, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
	 ...
	 * @param request
	 * @return MasMonRoutRpbVO[]
	 */
	public MasMonRoutRpbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonRoutRpbVO[]
	 */
	public MasMonRoutRpbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonRoutRpbVO model = null;
	 ...
	 * @return MasMonRoutRpbVO[]
	 */
	public MasMonRoutRpbVO[] getMasMonRoutRpbVOs(){
		MasMonRoutRpbVO[] vos = (MasMonRoutRpbVO[])models.toArray(new MasMonRoutRpbVO[models.size()]);
		return vos;
	}
