...
*@FileName : PriSqGrpCmdtDtlVO.java
*@FileTitle : PriSqGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class PriSqGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqGrpCmdtDtlVO> models = new ArrayList<PriSqGrpCmdtDtlVO>();
	...
	public PriSqGrpCmdtDtlVO() {}

	public PriSqGrpCmdtDtlVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpCmdtSeq, String grpCmdtDtlSeq, String prcCmdtTpCd, String prcCmdtDefCd, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriSqGrpCmdtDtlVO[]
	 */
	public PriSqGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqGrpCmdtDtlVO[]
	 */
	public PriSqGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqGrpCmdtDtlVO model = null;
	 ...
	 * @return PriSqGrpCmdtDtlVO[]
	 */
	public PriSqGrpCmdtDtlVO[] getPriSqGrpCmdtDtlVOs(){
		PriSqGrpCmdtDtlVO[] vos = (PriSqGrpCmdtDtlVO[])models.toArray(new PriSqGrpCmdtDtlVO[models.size()]);
		return vos;
	}
