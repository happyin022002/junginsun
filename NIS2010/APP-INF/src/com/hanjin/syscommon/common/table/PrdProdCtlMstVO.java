...
public class PrdProdCtlMstVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setN1stVslLodgDueDt(JSPUtil.getParameter(request, "n1st_vsl_lodg_due_dt", ""));
		setShprSeq(JSPUtil.getParameter(request, "shpr_seq", ""));
		setPrmCustFlg(JSPUtil.getParameter(request, "prm_cust_flg", ""));
		...
		setMcntrDorArrDueDt(JSPUtil.getParameter(request, "mcntr_dor_arr_due_dt", ""));
