...
*@FileName : MasSvcTrnsPrcMgnVO.java
*@FileTitle : MasSvcTrnsPrcMgnVO
*Open Issues :
*Change history :
 ...
 */
public class MasSvcTrnsPrcMgnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSvcTrnsPrcMgnVO> models = new ArrayList<MasSvcTrnsPrcMgnVO>();
	...
	public MasSvcTrnsPrcMgnVO() {}

	public MasSvcTrnsPrcMgnVO(String ibflag, String pagerows, String costYrmon, String ofcActCd, String stpMgnRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSvcTrnsPrcMgnVO[]
	 */
	public MasSvcTrnsPrcMgnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSvcTrnsPrcMgnVO[]
	 */
	public MasSvcTrnsPrcMgnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSvcTrnsPrcMgnVO model = null;
	 ...
	 * @return MasSvcTrnsPrcMgnVO[]
	 */
	public MasSvcTrnsPrcMgnVO[] getMasSvcTrnsPrcMgnVOs(){
		MasSvcTrnsPrcMgnVO[] vos = (MasSvcTrnsPrcMgnVO[])models.toArray(new MasSvcTrnsPrcMgnVO[models.size()]);
		return vos;
	}
