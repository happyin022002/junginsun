...
public class BsaCrrRgstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaCrrRgstVO> models = new ArrayList<BsaCrrRgstVO>();
	...
	public BsaCrrRgstVO(String ibflag, String pagerows, String bsaOpCd, String bsaOpJbCd, String crrCd, String crrDpNo, String aplyFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return BsaCrrRgstVO[]
	 */
	public BsaCrrRgstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaCrrRgstVO[]
	 */
	public BsaCrrRgstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaCrrRgstVO model = null;
		...
		try {
			...
			String[] crrDpNo = (JSPUtil.getParameter(request, prefix	+ "crr_dp_no", length));
	 ...
	 * @return BsaCrrRgstVO[]
	 */
	public BsaCrrRgstVO[] getBsaCrrRgstVOs(){
		BsaCrrRgstVO[] vos = (BsaCrrRgstVO[])models.toArray(new BsaCrrRgstVO[models.size()]);
		return vos;
	}
