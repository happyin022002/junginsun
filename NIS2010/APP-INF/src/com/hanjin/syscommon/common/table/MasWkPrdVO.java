...
*@FileName : MasWkPrdVO.java
*@FileTitle : MasWkPrdVO
*Open Issues :
*Change history :
 ...
 */
public class MasWkPrdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasWkPrdVO> models = new ArrayList<MasWkPrdVO>();
	...
	public MasWkPrdVO(String ibflag, String pagerows, String costYr, String costWk, String slsFmDt, String slsToDt, String eqWk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return MasWkPrdVO[]
	 */
	public MasWkPrdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasWkPrdVO[]
	 */
	public MasWkPrdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasWkPrdVO model = null;
	 ...
	 * @return MasWkPrdVO[]
	 */
	public MasWkPrdVO[] getMasWkPrdVOs(){
		MasWkPrdVO[] vos = (MasWkPrdVO[])models.toArray(new MasWkPrdVO[models.size()]);
		return vos;
	}
