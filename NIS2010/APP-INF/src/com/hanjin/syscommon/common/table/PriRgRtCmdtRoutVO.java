...
*@FileName : PriRgRtCmdtRoutVO.java
*@FileTitle : PriRgRtCmdtRoutVO
*Open Issues :
*Change history :
...
public class PriRgRtCmdtRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgRtCmdtRoutVO> models = new ArrayList<PriRgRtCmdtRoutVO>();
	...
	public PriRgRtCmdtRoutVO() {}

	public PriRgRtCmdtRoutVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String cmdtHdrSeq, String routSeq, String dirCallFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRgRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgRtCmdtRoutVO[]
	 */
	public PriRgRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgRtCmdtRoutVO model = null;
	...
	public PriRgRtCmdtRoutVO[] getPriRgRtCmdtRoutVOs(){
		PriRgRtCmdtRoutVO[] vos = (PriRgRtCmdtRoutVO[])models.toArray(new PriRgRtCmdtRoutVO[models.size()]);
		return vos;
	}
