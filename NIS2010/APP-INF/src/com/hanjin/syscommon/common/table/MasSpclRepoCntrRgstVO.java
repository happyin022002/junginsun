...
*@FileName : MasSpclRepoCntrRgstVO.java
*@FileTitle : MasSpclRepoCntrRgstVO
*Open Issues :
*Change history :
 ...
 */
public class MasSpclRepoCntrRgstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSpclRepoCntrRgstVO> models = new ArrayList<MasSpclRepoCntrRgstVO>();
	...
	public MasSpclRepoCntrRgstVO() {}

	public MasSpclRepoCntrRgstVO(String ibflag, String pagerows, String listBxSetLvlCd, String cntrTpszCd, String spclCgoFlg, String repoFlg, String listBxDesc, String deltFlg, String spclCntrTpszCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSpclRepoCntrRgstVO[]
	 */
	public MasSpclRepoCntrRgstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSpclRepoCntrRgstVO[]
	 */
	public MasSpclRepoCntrRgstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSpclRepoCntrRgstVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasSpclRepoCntrRgstVO();
				if (updDt[i] != null)
		...
		return getMasSpclRepoCntrRgstVOs();
	}
	...
	public MasSpclRepoCntrRgstVO[] getMasSpclRepoCntrRgstVOs(){
		MasSpclRepoCntrRgstVO[] vos = (MasSpclRepoCntrRgstVO[])models.toArray(new MasSpclRepoCntrRgstVO[models.size()]);
		return vos;
	}
