...
*@FileName : CoaComParaBkupVO.java
*@FileTitle : CoaComParaBkupVO
*Open Issues :
*Change history :
...
public class CoaComParaBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaComParaBkupVO> models = new ArrayList<CoaComParaBkupVO>();
	 ...
	 * @param request
	 * @return CoaComParaBkupVO[]
	 */
	public CoaComParaBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaComParaBkupVO[]
	 */
	public CoaComParaBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaComParaBkupVO model = null;
	 ...
	 * @return CoaComParaBkupVO[]
	 */
	public CoaComParaBkupVO[] getCoaComParaBkupVOs(){
		CoaComParaBkupVO[] vos = (CoaComParaBkupVO[])models.toArray(new CoaComParaBkupVO[models.size()]);
		return vos;
	}
