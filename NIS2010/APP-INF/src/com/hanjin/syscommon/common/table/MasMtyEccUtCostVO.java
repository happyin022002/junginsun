...
*@FileName : MasMtyEccUtCostVO.java
*@FileTitle : MasMtyEccUtCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasMtyEccUtCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMtyEccUtCostVO> models = new ArrayList<MasMtyEccUtCostVO>();
	 ...
	 * @param request
	 * @return MasMtyEccUtCostVO[]
	 */
	public MasMtyEccUtCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMtyEccUtCostVO[]
	 */
	public MasMtyEccUtCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMtyEccUtCostVO model = null;
	 ...
	 * @return MasMtyEccUtCostVO[]
	 */
	public MasMtyEccUtCostVO[] getMasMtyEccUtCostVOs(){
		MasMtyEccUtCostVO[] vos = (MasMtyEccUtCostVO[])models.toArray(new MasMtyEccUtCostVO[models.size()]);
		return vos;
	}
