...
public class PriRpScpTrspAddChgVO extends AbstractValueObject {
	...
	public PriRpScpTrspAddChgVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String addChgTpCd, String orgDestTpCd, String addChgSeq,
			String bsePortTpCd, String bsePortDefCd, String routPntLocTpCd, String routPntLocDefCd, String ratUtCd, String prcCgoTpCd, String prcTrspModCd,
			String rcvDeTermCd, String minCgoWgt, String maxCgoWgt, String custCntCd, String custSeq, String currCd, String propFrtRtAmt, String coffrFrtRtAmt,
			String fnlFrtRtAmt, String griApplTpCd, String griApplAmt, String addChgNoteCtnt, String noteDpSeq, String prcProgStsCd, String srcInfoCd, String n1stCmncDt,
			String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt, String n1stCmncAmdtSeq,
			String ficGlineRtAmt, String ficGlineUpdDt, String optmTrspModFlg, String ficRoutCmbTpCd, String ficRtUseStsCd) {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFicGlineUpdDt(JSPUtil.getParameter(request, "fic_gline_upd_dt", ""));
		setOptmTrspModFlg(JSPUtil.getParameter(request, "optm_trsp_mod_flg", ""));
		setFicRoutCmbTpCd(JSPUtil.getParameter(request, "fic_rout_cmb_tp_cd", ""));
		setFicRtUseStsCd(JSPUtil.getParameter(request, "fic_rt_use_sts_cd", ""));
	}
