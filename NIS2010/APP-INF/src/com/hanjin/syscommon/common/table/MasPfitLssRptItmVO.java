...
*@FileName : MasPfitLssRptItmVO.java
*@FileTitle : MasPfitLssRptItmVO
*Open Issues :
*Change history :
 ...
 */
public class MasPfitLssRptItmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasPfitLssRptItmVO> models = new ArrayList<MasPfitLssRptItmVO>();
	...
	/* Column Info */
	private String krRptItmDesc = null;
	/* Column Info */
	...
	/* Column Info */
	private String sgrpKrDesc = null;
	...
	public MasPfitLssRptItmVO() {}

	public MasPfitLssRptItmVO(String ibflag, String pagerows, String stndCostCd, String rptVwCd, String sgrpCostCd, String stndCostTpCd, String rptItmDesc, String krRptItmDesc, String sgrpCostCdDesc, String sgrpKrDesc, String rptDpSeq, String rptDpSgrpSeq, String rptItmColrFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.rptVwCd = rptVwCd;
		this.krRptItmDesc = krRptItmDesc;
		this.creDt = creDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("kr_rpt_itm_desc", getKrRptItmDesc());
		...
		this.hashColumns.put("sgrp_kr_desc", getSgrpKrDesc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("kr_rpt_itm_desc", "krRptItmDesc");
		...
		this.hashFields.put("sgrp_kr_desc", "sgrpKrDesc");
	 ...
	 * @return krRptItmDesc
	 */
	public String getKrRptItmDesc() {
		return this.krRptItmDesc;
	}
	 ...
	 * @return sgrpKrDesc
	 */
	public String getSgrpKrDesc() {
		return this.sgrpKrDesc;
	}
	 ...
	 * @param krRptItmDesc
	 */
	public void setKrRptItmDesc(String krRptItmDesc) {
		this.krRptItmDesc = krRptItmDesc;
	}
	 ...
	 * @param sgrpKrDesc
	 */
	public void setSgrpKrDesc(String sgrpKrDesc) {
		this.sgrpKrDesc = sgrpKrDesc;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setKrRptItmDesc(JSPUtil.getParameter(request, "kr_rpt_itm_desc", ""));
		...
		setSgrpKrDesc(JSPUtil.getParameter(request, "sgrp_kr_desc", ""));
	}

	/**
	 * Request 의 데이터를 VO 배열로 변환하여 반환.
	 * @param request
	 * @return MasPfitLssRptItmVO[]
	 */
	public MasPfitLssRptItmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasPfitLssRptItmVO[]
	 */
	public MasPfitLssRptItmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasPfitLssRptItmVO model = null;
		...
		try {
			...
			String[] krRptItmDesc = (JSPUtil.getParameter(request, prefix	+ "kr_rpt_itm_desc", length));
			...
			String[] sgrpKrDesc = (JSPUtil.getParameter(request, prefix	+ "sgrp_kr_desc", length));
			
			for (int i = 0; i < length; i++) {
				model = new MasPfitLssRptItmVO();
				if (updDt[i] != null)
					model.setUpdDt(updDt[i]);
				if (rptVwCd[i] != null)
					model.setRptVwCd(rptVwCd[i]);
				if (krRptItmDesc[i] != null)
					model.setKrRptItmDesc(krRptItmDesc[i]);
				if (creDt[i] != null)
				...
				if (sgrpKrDesc[i] != null)
					model.setSgrpKrDesc(sgrpKrDesc[i]);
				models.add(model);
			}
	 ...
	 * @return MasPfitLssRptItmVO[]
	 */
	public MasPfitLssRptItmVO[] getMasPfitLssRptItmVOs(){
		MasPfitLssRptItmVO[] vos = (MasPfitLssRptItmVO[])models.toArray(new MasPfitLssRptItmVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.krRptItmDesc = this.krRptItmDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.sgrpKrDesc = this.sgrpKrDesc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
