...
*@FileName : CoaCntrRepoIdxItmVO.java
*@FileTitle : CoaCntrRepoIdxItmVO
*Open Issues :
*Change history :
...
public class CoaCntrRepoIdxItmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaCntrRepoIdxItmVO> models = new ArrayList<CoaCntrRepoIdxItmVO>();
	 ...
	 * @param request
	 * @return CoaCntrRepoIdxItmVO[]
	 */
	public CoaCntrRepoIdxItmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaCntrRepoIdxItmVO[]
	 */
	public CoaCntrRepoIdxItmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaCntrRepoIdxItmVO model = null;
		...
		return getCoaCntrRepoIdxItmVOs();
	}
	 ...
	 * @return CoaCntrRepoIdxItmVO[]
	 */
	public CoaCntrRepoIdxItmVO[] getCoaCntrRepoIdxItmVOs(){
		CoaCntrRepoIdxItmVO[] vos = (CoaCntrRepoIdxItmVO[])models.toArray(new CoaCntrRepoIdxItmVO[models.size()]);
		return vos;
	}
