...
*@FileName : OpfCodDvsFeeVO.java
*@FileTitle : OpfCodDvsFeeVO
*Open Issues :
*Change history :
...
public class OpfCodDvsFeeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpfCodDvsFeeVO> models = new ArrayList<OpfCodDvsFeeVO>();
	...
	public OpfCodDvsFeeVO() {}

	public OpfCodDvsFeeVO(String ibflag, String pagerows, String contiCd, String dvsFeeTpCd, String dvsFeeAmt, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String dirCd) {
		this.updDt = updDt;
	 ...
	 */
	public OpfCodDvsFeeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpfCodDvsFeeVO[]
	 */
	public OpfCodDvsFeeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpfCodDvsFeeVO model = null;
	...
	public OpfCodDvsFeeVO[] getOpfCodDvsFeeVOs(){
		OpfCodDvsFeeVO[] vos = (OpfCodDvsFeeVO[])models.toArray(new OpfCodDvsFeeVO[models.size()]);
		return vos;
	}
