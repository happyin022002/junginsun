...
*@FileName : PriRgRtRoutViaVO.java
*@FileTitle : PriRgRtRoutViaVO
*Open Issues :
*Change history :
...
public class PriRgRtRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgRtRoutViaVO> models = new ArrayList<PriRgRtRoutViaVO>();
	...
	public PriRgRtRoutViaVO() {}

	public PriRgRtRoutViaVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String cmdtHdrSeq, String routSeq, String orgDestTpCd, String routViaSeq, String routViaPortTpCd, String routViaPortDefCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRgRtRoutViaVO[]
	 */
	public PriRgRtRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgRtRoutViaVO[]
	 */
	public PriRgRtRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgRtRoutViaVO model = null;
	 ...
	 * @return PriRgRtRoutViaVO[]
	 */
	public PriRgRtRoutViaVO[] getPriRgRtRoutViaVOs(){
		PriRgRtRoutViaVO[] vos = (PriRgRtRoutViaVO[])models.toArray(new PriRgRtRoutViaVO[models.size()]);
		return vos;
	}
