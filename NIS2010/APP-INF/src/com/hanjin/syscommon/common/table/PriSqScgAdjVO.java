...
*@FileName : PriSqScgAdjVO.java
*@FileTitle : PriSqScgAdjVO
*Open Issues :
*Change history :
...
public class PriSqScgAdjVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqScgAdjVO> models = new ArrayList<PriSqScgAdjVO>();
	 ...
	 */
	public PriSqScgAdjVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqScgAdjVO[]
	 */
	public PriSqScgAdjVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqScgAdjVO model = null;
	...
	public PriSqScgAdjVO[] getPriSqScgAdjVOs(){
		PriSqScgAdjVO[] vos = (PriSqScgAdjVO[])models.toArray(new PriSqScgAdjVO[models.size()]);
		return vos;
	}
