...
*@FileName : MasLaneTsBsaCmmtVO.java
*@FileTitle : MasLaneTsBsaCmmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneTsBsaCmmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneTsBsaCmmtVO> models = new ArrayList<MasLaneTsBsaCmmtVO>();
	...
	public MasLaneTsBsaCmmtVO() {}

	public MasLaneTsBsaCmmtVO(String ibflag, String pagerows, String costYrmon, String fmTrdCd, String fmRlaneCd, String fmIocCd, String fmDirCd, String toTrdCd, String bsaCmmtAmt, String creUsrId, String creDt, String updUsrId, String updDt, String fmHulBndCd, String toHulBndCd, String bsaCmmtRto) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public MasLaneTsBsaCmmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneTsBsaCmmtVO[]
	 */
	public MasLaneTsBsaCmmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneTsBsaCmmtVO model = null;
	...
	public MasLaneTsBsaCmmtVO[] getMasLaneTsBsaCmmtVOs(){
		MasLaneTsBsaCmmtVO[] vos = (MasLaneTsBsaCmmtVO[])models.toArray(new MasLaneTsBsaCmmtVO[models.size()]);
		return vos;
	}
