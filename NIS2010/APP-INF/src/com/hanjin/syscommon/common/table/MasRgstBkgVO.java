...
*@FileName : MasRgstBkgVO.java
*@FileTitle : MasRgstBkgVO
*Open Issues :
*Change history :
 ...
 */
public class MasRgstBkgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRgstBkgVO> models = new ArrayList<MasRgstBkgVO>();
	 ...
	 * @return MasRgstBkgVO[]
	 */
	public MasRgstBkgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRgstBkgVO[]
	 */
	public MasRgstBkgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRgstBkgVO model = null;
	 ...
	 * @return MasRgstBkgVO[]
	 */
	public MasRgstBkgVO[] getMasRgstBkgVOs(){
		MasRgstBkgVO[] vos = (MasRgstBkgVO[])models.toArray(new MasRgstBkgVO[models.size()]);
		return vos;
	}
