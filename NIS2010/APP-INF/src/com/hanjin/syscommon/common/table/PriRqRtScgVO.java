...
*@FileName : PriRqRtScgVO.java
*@FileTitle : PriRqRtScgVO
*Open Issues :
*Change history :
...
public class PriRqRtScgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtScgVO> models = new ArrayList<PriRqRtScgVO>();
	 ...
	 * @return PriRqRtScgVO[]
	 */
	public PriRqRtScgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtScgVO[]
	 */
	public PriRqRtScgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtScgVO model = null;
	...
	public PriRqRtScgVO[] getPriRqRtScgVOs(){
		PriRqRtScgVO[] vos = (PriRqRtScgVO[])models.toArray(new PriRqRtScgVO[models.size()]);
		return vos;
	}
