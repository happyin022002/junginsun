...
*@FileName : PriRpScpGriCmdtVO.java
*@FileTitle : PriRpScpGriCmdtVO
*Open Issues :
*Change history :
...
public class PriRpScpGriCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpGriCmdtVO> models = new ArrayList<PriRpScpGriCmdtVO>();
	...
	public PriRpScpGriCmdtVO() {}

	public PriRpScpGriCmdtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String cmdtSeq, String prcCmdtTpCd, String prcCmdtDefCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRpScpGriCmdtVO[]
	 */
	public PriRpScpGriCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpGriCmdtVO[]
	 */
	public PriRpScpGriCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpGriCmdtVO model = null;
	...
	public PriRpScpGriCmdtVO[] getPriRpScpGriCmdtVOs(){
		PriRpScpGriCmdtVO[] vos = (PriRpScpGriCmdtVO[])models.toArray(new PriRpScpGriCmdtVO[models.size()]);
		return vos;
	}
