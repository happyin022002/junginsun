...
*@FileName : PriRpScpGrpCmdtDtlVO.java
*@FileTitle : PriRpScpGrpCmdtDtlVO
*Open Issues :
*Change history :
...
public class PriRpScpGrpCmdtDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpGrpCmdtDtlVO> models = new ArrayList<PriRpScpGrpCmdtDtlVO>();
	 ...
	 */
	public PriRpScpGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpGrpCmdtDtlVO[]
	 */
	public PriRpScpGrpCmdtDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpGrpCmdtDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriRpScpGrpCmdtDtlVO();
				if (updDt[i] != null)
		...
		return getPriRpScpGrpCmdtDtlVOs();
	}
	...
	public PriRpScpGrpCmdtDtlVO[] getPriRpScpGrpCmdtDtlVOs(){
		PriRpScpGrpCmdtDtlVO[] vos = (PriRpScpGrpCmdtDtlVO[])models.toArray(new PriRpScpGrpCmdtDtlVO[models.size()]);
		return vos;
	}
