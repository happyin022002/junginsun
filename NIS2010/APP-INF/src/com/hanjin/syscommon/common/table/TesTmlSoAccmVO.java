...
*@FileName : TesTmlSoAccmVO.java
*@FileTitle : TesTmlSoAccmVO
*Open Issues :
*Change history :
...
public class TesTmlSoAccmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesTmlSoAccmVO> models = new ArrayList<TesTmlSoAccmVO>();
	...
	public TesTmlSoAccmVO() {}

	public TesTmlSoAccmVO(String ibflag, String pagerows, String vndrSeq, String accmSeq, String payVolQty, String creUsrId, String creDt, String updUsrId, String updDt, String loclCreDt, String loclUpdDt) {
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pay_vol_qty", getPayVolQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pay_vol_qty", "payVolQty");
	 ...
	 * @return payVolQty
	 */
	public String getPayVolQty() {
		return this.payVolQty;
	}
	 ...
	 * @param payVolQty
	 */
	public void setPayVolQty(String payVolQty) {
		this.payVolQty = payVolQty;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPayVolQty(JSPUtil.getParameter(request, "pay_vol_qty", ""));
	 ...
	 */
	public TesTmlSoAccmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesTmlSoAccmVO[]
	 */
	public TesTmlSoAccmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesTmlSoAccmVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				if (payVolQty[i] != null)
					model.setPayVolQty(payVolQty[i]);
				if (loclUpdDt[i] != null)
	...
	public TesTmlSoAccmVO[] getTesTmlSoAccmVOs(){
		TesTmlSoAccmVO[] vos = (TesTmlSoAccmVO[])models.toArray(new TesTmlSoAccmVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.payVolQty = this.payVolQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
