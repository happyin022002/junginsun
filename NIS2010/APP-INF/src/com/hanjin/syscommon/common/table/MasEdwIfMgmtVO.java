...
*@FileName : MasEdwIfMgmtVO.java
*@FileTitle : MasEdwIfMgmtVO
*Open Issues :
*Change history :
 ...
 */
public class MasEdwIfMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasEdwIfMgmtVO> models = new ArrayList<MasEdwIfMgmtVO>();
	...
	public MasEdwIfMgmtVO() {}

	public MasEdwIfMgmtVO(String ibflag, String pagerows, String cntrTpszCd, String cntrNo, String ydCd, String mvmtDt, String mvmtStsCd, String cnmvSeq, String fullMtyCd, String coCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.coCd = coCd;
	 ...
	 * @param request
	 * @return MasEdwIfMgmtVO[]
	 */
	public MasEdwIfMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasEdwIfMgmtVO[]
	 */
	public MasEdwIfMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasEdwIfMgmtVO model = null;
	 ...
	 * @return MasEdwIfMgmtVO[]
	 */
	public MasEdwIfMgmtVO[] getMasEdwIfMgmtVOs(){
		MasEdwIfMgmtVO[] vos = (MasEdwIfMgmtVO[])models.toArray(new MasEdwIfMgmtVO[models.size()]);
		return vos;
	}
