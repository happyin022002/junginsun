...
public class PriRgMnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRgMnVO> models = new ArrayList<PriRgMnVO>();
	...
	public PriRgMnVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String effDt, String expDt, String cfmFlg, String cfmUsrId, String cfmOfcCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return PriRgMnVO[]
	 */
	public PriRgMnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRgMnVO[]
	 */
	public PriRgMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRgMnVO model = null;
	...
	public PriRgMnVO[] getPriRgMnVOs(){
		PriRgMnVO[] vos = (PriRgMnVO[])models.toArray(new PriRgMnVO[models.size()]);
		return vos;
	}
