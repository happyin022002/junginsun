...
*@FileName : PriSpScpGrpCmdtVO.java
*@FileTitle : PriSpScpGrpCmdtVO
*Open Issues :
*Change history :
...
public class PriSpScpGrpCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGrpCmdtVO> models = new ArrayList<PriSpScpGrpCmdtVO>();
	...
	public PriSpScpGrpCmdtVO() {}

	public PriSpScpGrpCmdtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String grpCmdtSeq, String prcGrpCmdtCd, String prcGrpCmdtDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriSpScpGrpCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGrpCmdtVO[]
	 */
	public PriSpScpGrpCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGrpCmdtVO model = null;
	...
	public PriSpScpGrpCmdtVO[] getPriSpScpGrpCmdtVOs(){
		PriSpScpGrpCmdtVO[] vos = (PriSpScpGrpCmdtVO[])models.toArray(new PriSpScpGrpCmdtVO[models.size()]);
		return vos;
	}
