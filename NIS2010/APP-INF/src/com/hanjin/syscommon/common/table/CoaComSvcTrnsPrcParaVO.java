...
*@FileName : CoaComSvcTrnsPrcParaVO.java
*@FileTitle : CoaComSvcTrnsPrcParaVO
*Open Issues :
*Change history :
...
public class CoaComSvcTrnsPrcParaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaComSvcTrnsPrcParaVO> models = new ArrayList<CoaComSvcTrnsPrcParaVO>();
	 ...
	 * @param request
	 * @return CoaComSvcTrnsPrcParaVO[]
	 */
	public CoaComSvcTrnsPrcParaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaComSvcTrnsPrcParaVO[]
	 */
	public CoaComSvcTrnsPrcParaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaComSvcTrnsPrcParaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaComSvcTrnsPrcParaVO();
				if (updDt[i] != null)
		...
		return getCoaComSvcTrnsPrcParaVOs();
	}
	 ...
	 * @return CoaComSvcTrnsPrcParaVO[]
	 */
	public CoaComSvcTrnsPrcParaVO[] getCoaComSvcTrnsPrcParaVOs(){
		CoaComSvcTrnsPrcParaVO[] vos = (CoaComSvcTrnsPrcParaVO[])models.toArray(new CoaComSvcTrnsPrcParaVO[models.size()]);
		return vos;
	}
