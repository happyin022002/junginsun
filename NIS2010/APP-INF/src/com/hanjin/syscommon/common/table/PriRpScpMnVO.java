...
public class PriRpScpMnVO extends AbstractValueObject {
	...
	/* Column Info */
	private String prsRtMbFlg = null;
	/* Column Info */
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("prs_rt_mb_flg", getPrsRtMbFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("prs_rt_mb_flg", "prsRtMbFlg");
	 ...
	 * @return prsRtMbFlg
	 */
	public String getPrsRtMbFlg() {
		return this.prsRtMbFlg;
	}
	 ...
	 * @param prsRtMbFlg
	 */
	public void setPrsRtMbFlg(String prsRtMbFlg) {
		this.prsRtMbFlg = prsRtMbFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPrsRtMbFlg(JSPUtil.getParameter(request, prefix + "prs_rt_mb_flg", ""));
	...
	public PriRpScpMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] prsRtMbFlg = (JSPUtil.getParameter(request, prefix	+ "prs_rt_mb_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (prsRtMbFlg[i] != null)
					model.setPrsRtMbFlg(prsRtMbFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.prsRtMbFlg = this.prsRtMbFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
