...
public class ArFincDirConvVO extends AbstractValueObject {
	...
	/* Column Info */
	private String podRlaneDirCd = null;
	/* Column Info */
	private String podRlaneCd = null;
	/* Column Info */
	private String podSlaneDirCd = null;
	/* Column Info */
	...
	public ArFincDirConvVO(String ibflag, String pagerows, String podContiCd, String podRlaneDirCd, String podRlaneCd, String podSlaneDirCd, String slanCd, String scontiCd, String slanDirCd, String rlaneDirCd, String dirCngCd, String deltFlg, String updUsrId, String creDt, String updDt, String eaiEvntDt,String rlaneCd) {
		this.podContiCd = podContiCd;
		this.podRlaneDirCd = podRlaneDirCd;
		this.podRlaneCd = podRlaneCd;
		this.podSlaneDirCd = podSlaneDirCd;
		this.updDt = updDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pod_rlane_dir_cd", getPodRlaneDirCd());
		this.hashColumns.put("pod_rlane_cd", getPodRlaneCd());
		this.hashColumns.put("pod_slane_dir_cd", getPodSlaneDirCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pod_rlane_dir_cd", "podRlaneDirCd");
		this.hashFields.put("pod_rlane_cd", "podRlaneCd");
		this.hashFields.put("pod_slane_dir_cd", "podSlaneDirCd");
	...
	public String getPodRlaneDirCd() {
		return this.podRlaneDirCd;
	}
	public String getPodRlaneCd() {
		return this.podRlaneCd;
	}
	public String getPodSlaneDirCd() {
		return this.podSlaneDirCd;
	}
	...
	public void setPodRlaneDirCd(String podRlaneDirCd) {
		this.podRlaneDirCd = podRlaneDirCd;
	}
	
	public void setPodRlaneCd(String podRlaneCd) {
		this.podRlaneCd = podRlaneCd;
	}
	
	public void setPodSlaneDirCd(String podSlaneDirCd) {
		this.podSlaneDirCd = podSlaneDirCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		setPodContiCd(JSPUtil.getParameter(request, "pod_conti_cd", ""));
		setPodRlaneDirCd(JSPUtil.getParameter(request, "pod_rlane_dir_cd", ""));
		setPodRlaneCd(JSPUtil.getParameter(request, "pod_rlane_cd", ""));
		setPodSlaneDirCd(JSPUtil.getParameter(request, "pod_slane_dir_cd", ""));
	...
	public ArFincDirConvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] podContiCd = (JSPUtil.getParameter(request, prefix	+ "pod_conti_cd".trim(), length));
			String[] podRlaneDirCd = (JSPUtil.getParameter(request, prefix	+ "pod_rlane_dir_cd".trim(), length));
			String[] podRlaneCd = (JSPUtil.getParameter(request, prefix	+ "pod_rlane_cd".trim(), length));
			String[] podSlaneDirCd = (JSPUtil.getParameter(request, prefix	+ "pod_slane_dir_cd".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (podRlaneDirCd[i] != null)
					model.setPodRlaneDirCd(podRlaneDirCd[i]);
				if (podRlaneCd[i] != null)
					model.setPodRlaneCd(podRlaneCd[i]);
				if (podSlaneDirCd[i] != null)
					model.setPodSlaneDirCd(podSlaneDirCd[i]);
				if (updDt[i] != null)
	...
	*/
	public void onDataFormat(){
		...
		this.podRlaneDirCd = this.podRlaneDirCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podRlaneCd = this.podRlaneCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podSlaneDirCd = this.podSlaneDirCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
