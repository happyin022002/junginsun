 ...
 * @since J2EE 1.4
 */
public final class MdmRevLane implements java.io.Serializable {

	private String        ibflag        = "";
	private String        page_rows     = "";
	private String        rlane_cd      = "";
	private String        rlane_nm      = "";
	private String        vsl_tp_cd     = "";
	private String        rep_trd_cd    = "";
	private String        vsl_slan_cd   = "";
	private String        modi_rlane_cd = "";
	...
	public String        getRlane_nm     (){	return rlane_nm     	;	}
	...
	public String        getModi_rlane_cd(){	return modi_rlane_cd	;	}
	...
	public void setRlane_nm     ( String        rlane_nm      ){	this.rlane_nm      = rlane_nm     	;	}
	...
	public void setModi_rlane_cd( String        modi_rlane_cd ){	this.modi_rlane_cd = modi_rlane_cd	;	}
	...
	public static MdmRevLane fromRequest(HttpServletRequest request) {
		MdmRevLane model = new MdmRevLane();
		try {
			model.setIbflag       	(JSPUtil.getParameter(request, "ibflag       		".trim(), ""));
			model.setPage_rows    	(JSPUtil.getParameter(request, "page_rows    		".trim(), ""));
			model.setRlane_cd     	(JSPUtil.getParameter(request, "rlane_cd     		".trim(), ""));
			model.setRlane_nm     	(JSPUtil.getParameter(request, "rlane_nm     		".trim(), ""));
			...
			model.setModi_rlane_cd	(JSPUtil.getParameter(request, "modi_rlane_cd		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] modi_rlane_cd =  (JSPUtil.getParameter(request, "modi_rlane_cd		".trim(), length));
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] rlane_nm      =  (JSPUtil.getParameter(request, prefix + "rlane_nm     		".trim(), length));
			...
			String[] modi_rlane_cd =  (JSPUtil.getParameter(request, prefix + "modi_rlane_cd		".trim(), length));
