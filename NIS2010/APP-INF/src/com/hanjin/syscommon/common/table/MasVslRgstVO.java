...
*@FileName : MasVslRgstVO.java
*@FileTitle : MasVslRgstVO
*Open Issues :
*Change history :
 ...
 */
public class MasVslRgstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasVslRgstVO> models = new ArrayList<MasVslRgstVO>();
	 ...
	 * @return MasVslRgstVO[]
	 */
	public MasVslRgstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasVslRgstVO[]
	 */
	public MasVslRgstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasVslRgstVO model = null;
	...
	public MasVslRgstVO[] getMasVslRgstVOs(){
		MasVslRgstVO[] vos = (MasVslRgstVO[])models.toArray(new MasVslRgstVO[models.size()]);
		return vos;
	}
