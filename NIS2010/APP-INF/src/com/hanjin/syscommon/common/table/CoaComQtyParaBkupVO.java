...
*@FileName : CoaComQtyParaBkupVO.java
*@FileTitle : CoaComQtyParaBkupVO
*Open Issues :
*Change history :
...
public class CoaComQtyParaBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaComQtyParaBkupVO> models = new ArrayList<CoaComQtyParaBkupVO>();
	...
	public CoaComQtyParaBkupVO() {}

	public CoaComQtyParaBkupVO(String ibflag, String pagerows, String pctlNo, String cntrTpszCd, String bkgRev, String bkgOftRev, String bkgQty, String estmCmAmt, String estmOpfitAmt, String raOpfitAmt, String raCmAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaComQtyParaBkupVO[]
	 */
	public CoaComQtyParaBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaComQtyParaBkupVO[]
	 */
	public CoaComQtyParaBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaComQtyParaBkupVO model = null;
		...
		return getCoaComQtyParaBkupVOs();
	}
	 ...
	 * @return CoaComQtyParaBkupVO[]
	 */
	public CoaComQtyParaBkupVO[] getCoaComQtyParaBkupVOs(){
		CoaComQtyParaBkupVO[] vos = (CoaComQtyParaBkupVO[])models.toArray(new CoaComQtyParaBkupVO[models.size()]);
		return vos;
	}
