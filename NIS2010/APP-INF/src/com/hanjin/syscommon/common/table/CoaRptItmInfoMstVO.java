...
*@FileName : CoaRptItmInfoMstVO.java
*@FileTitle : CoaRptItmInfoMstVO
*Open Issues :
*Change history :
...
public class CoaRptItmInfoMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaRptItmInfoMstVO> models = new ArrayList<CoaRptItmInfoMstVO>();
	...
	public CoaRptItmInfoMstVO() {}

	public CoaRptItmInfoMstVO(String ibflag, String pagerows, String slctItmFomSeq, String creUsrId, String slctItmFomDesc, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaRptItmInfoMstVO[]
	 */
	public CoaRptItmInfoMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaRptItmInfoMstVO[]
	 */
	public CoaRptItmInfoMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaRptItmInfoMstVO model = null;
	...
	public CoaRptItmInfoMstVO[] getCoaRptItmInfoMstVOs(){
		CoaRptItmInfoMstVO[] vos = (CoaRptItmInfoMstVO[])models.toArray(new CoaRptItmInfoMstVO[models.size()]);
		return vos;
	}
