...
*@FileName : MasSimDlyHirVO.java
*@FileTitle : MasSimDlyHirVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimDlyHirVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimDlyHirVO> models = new ArrayList<MasSimDlyHirVO>();
	...
	public MasSimDlyHirVO() {}

	public MasSimDlyHirVO(String ibflag, String pagerows, String simDt, String simNo, String vslCd, String sgrpCostCd, String vslDlyCostAmt, String lypFlg, String lypCostAmt, String vslDlyUcAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return MasSimDlyHirVO[]
	 */
	public MasSimDlyHirVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimDlyHirVO[]
	 */
	public MasSimDlyHirVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimDlyHirVO model = null;
	 ...
	 * @return MasSimDlyHirVO[]
	 */
	public MasSimDlyHirVO[] getMasSimDlyHirVOs(){
		MasSimDlyHirVO[] vos = (MasSimDlyHirVO[])models.toArray(new MasSimDlyHirVO[models.size()]);
		return vos;
	}
