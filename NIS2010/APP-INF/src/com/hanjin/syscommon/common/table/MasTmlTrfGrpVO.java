...
*@FileName : MasTmlTrfGrpVO.java
*@FileTitle : MasTmlTrfGrpVO
*Open Issues :
*Change history :
 ...
 */
public class MasTmlTrfGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasTmlTrfGrpVO> models = new ArrayList<MasTmlTrfGrpVO>();
	...
	public MasTmlTrfGrpVO() {}

	public MasTmlTrfGrpVO(String ibflag, String pagerows, String tmlCd, String tmlTrfItmCd, String tmlTrfDtlCd, String masCostSrcCd, String tmlDesc, String tmlTrfItmDesc, String tmlTrfDtlDesc, String tmlUtCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public MasTmlTrfGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasTmlTrfGrpVO[]
	 */
	public MasTmlTrfGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasTmlTrfGrpVO model = null;
	...
	public MasTmlTrfGrpVO[] getMasTmlTrfGrpVOs(){
		MasTmlTrfGrpVO[] vos = (MasTmlTrfGrpVO[])models.toArray(new MasTmlTrfGrpVO[models.size()]);
		return vos;
	}
