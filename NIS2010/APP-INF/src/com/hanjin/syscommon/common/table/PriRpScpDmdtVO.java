...
*@FileName : PriRpScpDmdtVO.java
*@FileTitle : PriRpScpDmdtVO
*Open Issues :
*Change history :
...
public class PriRpScpDmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpDmdtVO> models = new ArrayList<PriRpScpDmdtVO>();
	...
	public PriRpScpDmdtVO() {}

	public PriRpScpDmdtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String dmdtFtTpCd, String prcProgStsCd, String srcInfoCd, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRpScpDmdtVO[]
	 */
	public PriRpScpDmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpDmdtVO[]
	 */
	public PriRpScpDmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpDmdtVO model = null;
	 ...
	 * @return PriRpScpDmdtVO[]
	 */
	public PriRpScpDmdtVO[] getPriRpScpDmdtVOs(){
		PriRpScpDmdtVO[] vos = (PriRpScpDmdtVO[])models.toArray(new PriRpScpDmdtVO[models.size()]);
		return vos;
	}
