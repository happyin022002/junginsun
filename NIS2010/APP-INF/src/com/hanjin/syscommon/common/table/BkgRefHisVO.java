...
*@FileName : BkgRefHisVO.java
*@FileTitle : BkgRefHisVO
*Open Issues :
*Change history :
...
public class BkgRefHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgRefHisVO> models = new ArrayList<BkgRefHisVO>();
	...
	public BkgRefHisVO(String ibflag, String pagerows, String bkgNo, String snapHisSeq, String refSeq, String bkgRefTpCd, String custRefNoCtnt, String cntrNo, String cntrMfSeq, String cpyDescFlg, String snapDt, String expDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return BkgRefHisVO[]
	 */
	public BkgRefHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgRefHisVO[]
	 */
	public BkgRefHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgRefHisVO model = null;
		...
		try {
			...
			String[] snapDt = (JSPUtil.getParameter(request, prefix	+ "snap_dt", length));
			...
			String[] snapHisSeq = (JSPUtil.getParameter(request, prefix	+ "snap_his_seq", length));
			String[] expDt = (JSPUtil.getParameter(request, prefix	+ "exp_dt", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			
			for (int i = 0; i < length; i++) {
				model = new BkgRefHisVO();
				if (updDt[i] != null)
	 ...
	 * @return BkgRefHisVO[]
	 */
	public BkgRefHisVO[] getBkgRefHisVOs(){
		BkgRefHisVO[] vos = (BkgRefHisVO[])models.toArray(new BkgRefHisVO[models.size()]);
		return vos;
	}
