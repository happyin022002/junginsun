...
*@FileName : SpcBsaMgmtVO.java
*@FileTitle : SpcBsaMgmtVO
*Open Issues :
*Change history :
...
public class SpcBsaMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpcBsaMgmtVO> models = new ArrayList<SpcBsaMgmtVO>();
	...
	public SpcBsaMgmtVO(String ibflag, String pagerows, String trdCd, String subTrdCd, String vslCd, String skdVoyNo, String skdDirCd, String bsaSeq, String crrCd, String bsaCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
		this.trdCd = trdCd;
...
/**
	 ...
	 * @return SpcBsaMgmtVO[]
	 */
	public SpcBsaMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpcBsaMgmtVO[]
	 */
	public SpcBsaMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpcBsaMgmtVO model = null;
	...
	public SpcBsaMgmtVO[] getSpcBsaMgmtVOs(){
		SpcBsaMgmtVO[] vos = (SpcBsaMgmtVO[])models.toArray(new SpcBsaMgmtVO[models.size()]);
		return vos;
	}
