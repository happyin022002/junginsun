...
public class MdmCommodityVO extends AbstractValueObject {
	...
	public MdmCommodityVO(String ibflag, String pagerows, String cmdtCd, String cmdtNm, String repImdgLvlCd, String repCmdtCd, String grpCmdtCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String fmcExpFlg, String eaiIfId, String chemFlg) {
		this.ibflag = ibflag;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setChemFlg(JSPUtil.getParameter(request, "chem_flg", ""));
	}
	...
	public MdmCommodityVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] chemFlg      = (JSPUtil.getParameter(request, prefix	+ "chem_flg".trim()      , length));
