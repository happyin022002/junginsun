...
public final class MdmCustomer implements java.io.Serializable {
	...
	private String               nvocc_hjs_scac_cd    = "";
	...
	public MdmCustomer(
		...
		this.nvocc_hjs_scac_cd    = nvocc_hjs_scac_cd   ;
	...
	public String               getNvocc_hjs_scac_cd   (){	return nvocc_hjs_scac_cd   	;	}
	...
	public void setNvocc_hjs_scac_cd   ( String               nvocc_hjs_scac_cd    ){	this.nvocc_hjs_scac_cd    = nvocc_hjs_scac_cd   	;	}
	...
	public static MdmCustomer fromRequest(HttpServletRequest request) {
		...
		try {
			...
			model.setNvocc_hjs_scac_cd   	(JSPUtil.getParameter(request, "nvocc_hjs_scac_cd   		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] nvocc_hjs_scac_cd    =  (JSPUtil.getParameter(request, "nvocc_hjs_scac_cd   		".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				model.setNvocc_hjs_scac_cd   		  (nvocc_hjs_scac_cd   	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] nvocc_hjs_scac_cd    =  (JSPUtil.getParameter(request, prefix + "nvocc_hjs_scac_cd   		".trim(), length));
