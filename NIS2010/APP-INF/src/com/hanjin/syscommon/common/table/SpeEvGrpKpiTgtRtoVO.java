...
*@FileName : SpeEvGrpKpiTgtRtoVO.java
*@FileTitle : SpeEvGrpKpiTgtRtoVO
*Open Issues :
*Change history :
...
public class SpeEvGrpKpiTgtRtoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpeEvGrpKpiTgtRtoVO> models = new ArrayList<SpeEvGrpKpiTgtRtoVO>();
	...
	public SpeEvGrpKpiTgtRtoVO() {}

	public SpeEvGrpKpiTgtRtoVO(String ibflag, String pagerows, String egId, String egIdSeq, String spKpiCd, String evYr, String kpiUtCd, String kpiTgtRto, String kpiWgtRto, String kpiPerfRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
	 ...
	 */
	public SpeEvGrpKpiTgtRtoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpeEvGrpKpiTgtRtoVO[]
	 */
	public SpeEvGrpKpiTgtRtoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpeEvGrpKpiTgtRtoVO model = null;
		...
		return getSpeEvGrpKpiTgtRtoVOs();
	}
	...
	public SpeEvGrpKpiTgtRtoVO[] getSpeEvGrpKpiTgtRtoVOs(){
		SpeEvGrpKpiTgtRtoVO[] vos = (SpeEvGrpKpiTgtRtoVO[])models.toArray(new SpeEvGrpKpiTgtRtoVO[models.size()]);
		return vos;
	}
