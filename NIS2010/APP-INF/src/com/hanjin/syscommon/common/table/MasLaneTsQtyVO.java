...
*@FileName : MasLaneTsQtyVO.java
*@FileTitle : MasLaneTsQtyVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneTsQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneTsQtyVO> models = new ArrayList<MasLaneTsQtyVO>();
	 ...
	 * @param request
	 * @return MasLaneTsQtyVO[]
	 */
	public MasLaneTsQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneTsQtyVO[]
	 */
	public MasLaneTsQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneTsQtyVO model = null;
	 ...
	 * @return MasLaneTsQtyVO[]
	 */
	public MasLaneTsQtyVO[] getMasLaneTsQtyVOs(){
		MasLaneTsQtyVO[] vos = (MasLaneTsQtyVO[])models.toArray(new MasLaneTsQtyVO[models.size()]);
		return vos;
	}
