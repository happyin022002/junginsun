...
*@FileName : PriRpScpRtActCustVO.java
*@FileTitle : PriRpScpRtActCustVO
*Open Issues :
*Change history :
...
public class PriRpScpRtActCustVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtActCustVO> models = new ArrayList<PriRpScpRtActCustVO>();
	 ...
	 */
	public PriRpScpRtActCustVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtActCustVO[]
	 */
	public PriRpScpRtActCustVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtActCustVO model = null;
		...
		return getPriRpScpRtActCustVOs();
	}
	...
	public PriRpScpRtActCustVO[] getPriRpScpRtActCustVOs(){
		PriRpScpRtActCustVO[] vos = (PriRpScpRtActCustVO[])models.toArray(new PriRpScpRtActCustVO[models.size()]);
		return vos;
	}
