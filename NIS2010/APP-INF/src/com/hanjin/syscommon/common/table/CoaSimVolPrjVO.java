...
*@FileName : CoaSimVolPrjVO.java
*@FileTitle : CoaSimVolPrjVO
*Open Issues :
*Change history :
...
public class CoaSimVolPrjVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaSimVolPrjVO> models = new ArrayList<CoaSimVolPrjVO>();
	
	/* Column Info */
	private String updDt = null;
	/* Column Info */
	private String srcPrdCd = null;
	/* Column Info */
	...
	public CoaSimVolPrjVO() {}

	public CoaSimVolPrjVO(String ibflag, String pagerows, String simDt, String simNo, String sectNo, String polCd, String podCd, String portPairQty, String portPairLodQty, String portPairRto, String grsRpbRev, String srcPrdCd, String trdCd, String subTrdCd, String rlaneCd, String skdDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.srcPrdCd = srcPrdCd;
		this.creDt = creDt;
		this.simDt = simDt;
		this.trdCd = trdCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("src_prd_cd", getSrcPrdCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("src_prd_cd", "srcPrdCd");
	 ...
	 * @return srcPrdCd
	 */
	public String getSrcPrdCd() {
		return this.srcPrdCd;
	}
	 ...
	 * @param srcPrdCd
	 */
	public void setSrcPrdCd(String srcPrdCd) {
		this.srcPrdCd = srcPrdCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setSrcPrdCd(JSPUtil.getParameter(request, "src_prd_cd", ""));
	 ...
	 * @param request
	 * @return CoaSimVolPrjVO[]
	 */
	public CoaSimVolPrjVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaSimVolPrjVO[]
	 */
	public CoaSimVolPrjVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaSimVolPrjVO model = null;
		...
		try {
			...
			String[] srcPrdCd = (JSPUtil.getParameter(request, prefix	+ "src_prd_cd", length));
			...
			for (int i = 0; i < length; i++) {
				model = new CoaSimVolPrjVO();
				if (updDt[i] != null)
					model.setUpdDt(updDt[i]);
				if (srcPrdCd[i] != null)
					model.setSrcPrdCd(srcPrdCd[i]);
				if (creDt[i] != null)
	 ...
	 * @return CoaSimVolPrjVO[]
	 */
	public CoaSimVolPrjVO[] getCoaSimVolPrjVOs(){
		CoaSimVolPrjVO[] vos = (CoaSimVolPrjVO[])models.toArray(new CoaSimVolPrjVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.srcPrdCd = this.srcPrdCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
