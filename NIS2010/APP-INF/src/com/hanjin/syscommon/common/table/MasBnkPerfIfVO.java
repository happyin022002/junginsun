...
*@FileName : MasBnkPerfIfVO.java
*@FileTitle : MasBnkPerfIfVO
*Open Issues :
*Change history :
 ...
 */
public class MasBnkPerfIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBnkPerfIfVO> models = new ArrayList<MasBnkPerfIfVO>();
	 ...
	 * @param request
	 * @return MasBnkPerfIfVO[]
	 */
	public MasBnkPerfIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBnkPerfIfVO[]
	 */
	public MasBnkPerfIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBnkPerfIfVO model = null;
	 ...
	 * @return MasBnkPerfIfVO[]
	 */
	public MasBnkPerfIfVO[] getMasBnkPerfIfVOs(){
		MasBnkPerfIfVO[] vos = (MasBnkPerfIfVO[])models.toArray(new MasBnkPerfIfVO[models.size()]);
		return vos;
	}
