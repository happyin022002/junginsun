...
*@FileName : EqrScnrEccSftStkVO.java
*@FileTitle : EqrScnrEccSftStkVO
*Open Issues :
*Change history :
...
public class EqrScnrEccSftStkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrScnrEccSftStkVO> models = new ArrayList<EqrScnrEccSftStkVO>();
	...
	public EqrScnrEccSftStkVO() {}

	public EqrScnrEccSftStkVO(String ibflag, String pagerows, String scnrId, String eccCd, String cntrTpszCd, String sfstkLvlCd, String sfstkVolQty, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public EqrScnrEccSftStkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrScnrEccSftStkVO[]
	 */
	public EqrScnrEccSftStkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrScnrEccSftStkVO model = null;
	 ...
	 * @return EqrScnrEccSftStkVO[]
	 */
	public EqrScnrEccSftStkVO[] fromRequestGridArrayList(HttpServletRequest request, String prefix) {
		EqrScnrEccSftStkVO model = null;
		...
		try {
			for ( int k=0 ; k < arrPrefix.length ; k++) {
				...
				String[] sfstkVolQty= (JSPUtil.getParameter(request, cntrTpszCd.toLowerCase() + "sfstk_vol_qty", length));
				String[] sfstkLvlCd	= (JSPUtil.getParameter(request, cntrTpszCd.toLowerCase() + "sfstk_lvl_cd", length));
	...
	public EqrScnrEccSftStkVO[] getEqrScnrEccSftStkVOs(){
		EqrScnrEccSftStkVO[] vos = (EqrScnrEccSftStkVO[])models.toArray(new EqrScnrEccSftStkVO[models.size()]);
		return vos;
	}
