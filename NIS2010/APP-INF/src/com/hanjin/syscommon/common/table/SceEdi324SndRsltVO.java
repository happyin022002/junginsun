...
public class SceEdi324SndRsltVO extends AbstractValueObject {
	...
	public SceEdi324SndRsltVO(String ibflag, String pagerows, String vndrSeq, String bkgNo, String cntrNo, String vslCd, String skdVoyNo, String skdDirCd, String ediSndSeq, String ediSndId, String mnlFlg, String ediSndTpCd, String ediSndRmk, String ediSndDt, String copNo, String lloydVslNo, String vslNm, String polYdCd, String polDepActDt, String podYdCd, String podNm, String actCd, String podEstmArrDt, String podEstmArrGdt, String blNo, String cntrWgt, String cntrWgtUtCd, String cntrLbsWgt, String cntrTpszCd, String cntrLen, String cntrHgt, String cntrSealNo, String orgYdLocCtyNm, String orgYdLocSteCd, String orgLocNm, String orgYdCd, String destYdLocCtyNm, String destYdLocSteCd, String destLocNm, String destYdCd, String dgFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.vslCd = vslCd;
...
/**
	...
	public SceEdi324SndRsltVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] orgLocNm = (JSPUtil.getParameter(request, prefix	+ "org_loc_nm", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] cntrTpszCd = (JSPUtil.getParameter(request, prefix	+ "cntr_tpsz_cd", length));
			String[] cntrWgtUtCd = (JSPUtil.getParameter(request, prefix	+ "cntr_wgt_ut_cd", length));
			String[] orgYdLocCtyNm = (JSPUtil.getParameter(request, prefix	+ "org_yd_loc_cty_nm", length));
			...
			String[] destYdLocSteCd = (JSPUtil.getParameter(request, prefix	+ "dest_yd_loc_ste_cd", length));
			String[] updDt = (JSPUtil.getParameter(request, prefix	+ "upd_dt", length));
			String[] actCd = (JSPUtil.getParameter(request, prefix	+ "act_cd", length));
			String[] podEstmArrGdt = (JSPUtil.getParameter(request, prefix	+ "pod_estm_arr_gdt", length));
			...
			String[] orgYdLocSteCd = (JSPUtil.getParameter(request, prefix	+ "org_yd_loc_ste_cd", length));
			String[] destYdLocCtyNm = (JSPUtil.getParameter(request, prefix	+ "dest_yd_loc_cty_nm", length));
			String[] cntrSealNo = (JSPUtil.getParameter(request, prefix	+ "cntr_seal_no", length));
			String[] podEstmArrDt = (JSPUtil.getParameter(request, prefix	+ "pod_estm_arr_dt", length));
