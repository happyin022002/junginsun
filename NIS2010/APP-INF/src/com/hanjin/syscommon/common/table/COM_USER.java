 ...
 * @since J2EE 1.4
 */
public final class COM_USER implements java.io.Serializable {
	...
	public static COM_USER fromRequest(HttpServletRequest request) {
		COM_USER model = new COM_USER();
		try {
