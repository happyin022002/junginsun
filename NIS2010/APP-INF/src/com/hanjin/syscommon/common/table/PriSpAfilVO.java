...
*@FileName : PriSpAfilVO.java
*@FileTitle : PriSpAfilVO
*Open Issues :
*Change history :
...
public class PriSpAfilVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpAfilVO> models = new ArrayList<PriSpAfilVO>();
	 ...
	 * @return PriSpAfilVO[]
	 */
	public PriSpAfilVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpAfilVO[]
	 */
	public PriSpAfilVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpAfilVO model = null;
	...
	public PriSpAfilVO[] getPriSpAfilVOs(){
		PriSpAfilVO[] vos = (PriSpAfilVO[])models.toArray(new PriSpAfilVO[models.size()]);
		return vos;
	}
