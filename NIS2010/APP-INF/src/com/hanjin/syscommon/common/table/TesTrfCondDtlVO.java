...
*@FileName : TesTrfCondDtlVO.java
*@FileTitle : TesTrfCondDtlVO
*Open Issues :
*Change history :
...
public class TesTrfCondDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesTrfCondDtlVO> models = new ArrayList<TesTrfCondDtlVO>();
	...
	public TesTrfCondDtlVO() {}

	public TesTrfCondDtlVO(String ibflag, String pagerows, String condNo, String condDtlUseTpCd, String condSeq, String tmlCondDtlTpCd, String tmlCondOprCd, String objListNo, String condOprValCtnt, String creUsrId, String creDt, String updUsrId, String updDt) {
...
/**
	 ...
	 * @param request
	 * @return TesTrfCondDtlVO[]
	 */
	public TesTrfCondDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesTrfCondDtlVO[]
	 */
	public TesTrfCondDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesTrfCondDtlVO model = null;
	 ...
	 * @return TesTrfCondDtlVO[]
	 */
	public TesTrfCondDtlVO[] getTesTrfCondDtlVOs(){
		TesTrfCondDtlVO[] vos = (TesTrfCondDtlVO[])models.toArray(new TesTrfCondDtlVO[models.size()]);
		return vos;
	}
