...
*@FileName : SqmSctrAlocQtaVO.java
*@FileTitle : SqmSctrAlocQtaVO
*Open Issues :
*Change history :
...
public class SqmSctrAlocQtaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrAlocQtaVO> models = new ArrayList<SqmSctrAlocQtaVO>();
...
/**
	 ...
	 * @param request
	 * @return SqmSctrAlocQtaVO[]
	 */
	public SqmSctrAlocQtaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrAlocQtaVO[]
	 */
	public SqmSctrAlocQtaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrAlocQtaVO model = null;
	 ...
	 * @return SqmSctrAlocQtaVO[]
	 */
	public SqmSctrAlocQtaVO[] getSqmSctrAlocQtaVOs(){
		SqmSctrAlocQtaVO[] vos = (SqmSctrAlocQtaVO[])models.toArray(new SqmSctrAlocQtaVO[models.size()]);
		return vos;
	}
