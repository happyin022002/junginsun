...
*@FileName : CoaCntrRepoRoutEccVO.java
*@FileTitle : CoaCntrRepoRoutEccVO
*Open Issues :
*Change history :
...
public class CoaCntrRepoRoutEccVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaCntrRepoRoutEccVO> models = new ArrayList<CoaCntrRepoRoutEccVO>();
	...
	public CoaCntrRepoRoutEccVO() {}

	public CoaCntrRepoRoutEccVO(String ibflag, String pagerows, String costYrmon, String rccCd, String eccCd, String cntrTpszCd, String spclCgoRfFlg, String porRepoFlg, String delRepoFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 */
	public CoaCntrRepoRoutEccVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaCntrRepoRoutEccVO[]
	 */
	public CoaCntrRepoRoutEccVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaCntrRepoRoutEccVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaCntrRepoRoutEccVO();
		...
		return getCoaCntrRepoRoutEccVOs();
	}
	...
	public CoaCntrRepoRoutEccVO[] getCoaCntrRepoRoutEccVOs(){
		CoaCntrRepoRoutEccVO[] vos = (CoaCntrRepoRoutEccVO[])models.toArray(new CoaCntrRepoRoutEccVO[models.size()]);
		return vos;
	}
