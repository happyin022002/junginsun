...
*@FileName : FcmDepRptErrVO.java
*@FileTitle : FcmDepRptErrVO
*Open Issues :
*Change history :
...
public class FcmDepRptErrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<FcmDepRptErrVO> models = new ArrayList<FcmDepRptErrVO>();
...
/**
	 ...
	 */
	public FcmDepRptErrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return FcmDepRptErrVO[]
	 */
	public FcmDepRptErrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		FcmDepRptErrVO model = null;
	...
	public FcmDepRptErrVO[] getFcmDepRptErrVOs(){
		FcmDepRptErrVO[] vos = (FcmDepRptErrVO[])models.toArray(new FcmDepRptErrVO[models.size()]);
		return vos;
	}
