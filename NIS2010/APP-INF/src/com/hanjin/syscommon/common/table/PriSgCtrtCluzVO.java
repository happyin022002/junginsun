...
*@FileName : PriSgCtrtCluzVO.java
*@FileTitle : PriSgCtrtCluzVO
*Open Issues :
*Change history :
...
public class PriSgCtrtCluzVO extends AbstractValueObject {

private static final long serialVersionUID = 1L;
	
	private Collection<PriSgCtrtCluzVO> models = new ArrayList<PriSgCtrtCluzVO>();
	...
	public PriSgCtrtCluzVO() {}

	public PriSgCtrtCluzVO(String ibflag, String pagerows, String svcScpCd, String glineSeq, String ctrtCluzSeq, String noteClssCd, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 */
	public PriSgCtrtCluzVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSgCtrtCluzVO[]
	 */
	public PriSgCtrtCluzVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSgCtrtCluzVO model = null;
	...
	public PriSgCtrtCluzVO[] getPriSgCtrtCluzVOs(){
		PriSgCtrtCluzVO[] vos = (PriSgCtrtCluzVO[])models.toArray(new PriSgCtrtCluzVO[models.size()]);
		return vos;
	}
