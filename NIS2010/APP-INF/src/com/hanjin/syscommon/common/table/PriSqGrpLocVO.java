...
*@FileName : PriSqGrpLocVO.java
*@FileTitle : PriSqGrpLocVO
*Open Issues :
*Change history :
...
public class PriSqGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqGrpLocVO> models = new ArrayList<PriSqGrpLocVO>();
	...
	public PriSqGrpLocVO() {}

	public PriSqGrpLocVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpLocSeq, String prcGrpLocCd, String prcGrpLocDesc, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriSqGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqGrpLocVO[]
	 */
	public PriSqGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqGrpLocVO model = null;
	...
	public PriSqGrpLocVO[] getPriSqGrpLocVOs(){
		PriSqGrpLocVO[] vos = (PriSqGrpLocVO[])models.toArray(new PriSqGrpLocVO[models.size()]);
		return vos;
	}
