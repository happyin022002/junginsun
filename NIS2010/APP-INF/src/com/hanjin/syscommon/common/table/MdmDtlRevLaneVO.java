...
*@FileName : MdmDtlRevLaneVO.java
*@FileTitle : MdmDtlRevLaneVO
*Open Issues :
*Change history :
...
public class MdmDtlRevLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmDtlRevLaneVO> models = new ArrayList<MdmDtlRevLaneVO>();
	...
	public MdmDtlRevLaneVO() {}

	public MdmDtlRevLaneVO(String ibflag, String pagerows, String rlaneCd, String vslSlanDirCd, String iocCd, String fmContiCd, String toContiCd, String trdCd, String subTrdCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId) {
		this.iocCd = iocCd;
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MdmDtlRevLaneVO[]
	 */
	public MdmDtlRevLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmDtlRevLaneVO[]
	 */
	public MdmDtlRevLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MdmDtlRevLaneVO model = null;
	 ...
	 * @return MdmDtlRevLaneVO[]
	 */
	public MdmDtlRevLaneVO[] getMdmDtlRevLaneVOs(){
		MdmDtlRevLaneVO[] vos = (MdmDtlRevLaneVO[])models.toArray(new MdmDtlRevLaneVO[models.size()]);
		return vos;
	}
