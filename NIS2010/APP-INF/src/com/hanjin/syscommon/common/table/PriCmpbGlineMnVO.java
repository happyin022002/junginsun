...
*@FileName : PriCmpbGlineMnVO.java
*@FileTitle : PriCmpbGlineMnVO
*Open Issues :
*Change history :
...
public class PriCmpbGlineMnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriCmpbGlineMnVO> models = new ArrayList<PriCmpbGlineMnVO>();
	...
	public PriCmpbGlineMnVO() {}

	public PriCmpbGlineMnVO(String ibflag, String pagerows, String svcScpCd, String creOfcCd, String glineSeq, String effDt, String expDt, String cfmFlg, String cfmUsrId, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriCmpbGlineMnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriCmpbGlineMnVO[]
	 */
	public PriCmpbGlineMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriCmpbGlineMnVO model = null;
	...
	public PriCmpbGlineMnVO[] getPriCmpbGlineMnVOs(){
		PriCmpbGlineMnVO[] vos = (PriCmpbGlineMnVO[])models.toArray(new PriCmpbGlineMnVO[models.size()]);
		return vos;
	}
