...
*@FileName : SqmCfmQtaPotnMgmtVO.java
*@FileTitle : SqmCfmQtaPotnMgmtVO
*Open Issues :
*Change history :
...
public class SqmCfmQtaPotnMgmtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmCfmQtaPotnMgmtVO> models = new ArrayList<SqmCfmQtaPotnMgmtVO>();
...
/**
	 ...
	 */
	public SqmCfmQtaPotnMgmtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmCfmQtaPotnMgmtVO[]
	 */
	public SqmCfmQtaPotnMgmtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmCfmQtaPotnMgmtVO model = null;
		...
		return getSqmCfmQtaPotnMgmtVOs();
	}
	...
	public SqmCfmQtaPotnMgmtVO[] getSqmCfmQtaPotnMgmtVOs(){
		SqmCfmQtaPotnMgmtVO[] vos = (SqmCfmQtaPotnMgmtVO[])models.toArray(new SqmCfmQtaPotnMgmtVO[models.size()]);
		return vos;
	}
