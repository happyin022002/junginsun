...
*@FileName : BsaJntOpPortDwnVO.java
*@FileTitle : BsaJntOpPortDwnVO
*Open Issues :
*Change history :
...
public class BsaJntOpPortDwnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaJntOpPortDwnVO> models = new ArrayList<BsaJntOpPortDwnVO>();
	...
	public BsaJntOpPortDwnVO() {}

	public BsaJntOpPortDwnVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String dirCd, String vopCd, String vslCapa, String bsaSeq, String bsaOpCd, String bsaOpJbCd, String crrCd, String portSeq, String portCd, String portBsaCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.vopCd = vopCd;
		this.trdCd = trdCd;
	 ...
	 */
	public BsaJntOpPortDwnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaJntOpPortDwnVO[]
	 */
	public BsaJntOpPortDwnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaJntOpPortDwnVO model = null;
	...
	public BsaJntOpPortDwnVO[] getBsaJntOpPortDwnVOs(){
		BsaJntOpPortDwnVO[] vos = (BsaJntOpPortDwnVO[])models.toArray(new BsaJntOpPortDwnVO[models.size()]);
		return vos;
	}
