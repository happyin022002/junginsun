...
*@FileName : MasPfitLssSvcTrnsPrcVO.java
*@FileTitle : MasPfitLssSvcTrnsPrcVO
*Open Issues :
*Change history :
 ...
 */
public class MasPfitLssSvcTrnsPrcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasPfitLssSvcTrnsPrcVO> models = new ArrayList<MasPfitLssSvcTrnsPrcVO>();
	 ...
	 * @param request
	 * @return MasPfitLssSvcTrnsPrcVO[]
	 */
	public MasPfitLssSvcTrnsPrcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasPfitLssSvcTrnsPrcVO[]
	 */
	public MasPfitLssSvcTrnsPrcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasPfitLssSvcTrnsPrcVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasPfitLssSvcTrnsPrcVO();
				if (updDt[i] != null)
		...
		return getMasPfitLssSvcTrnsPrcVOs();
	}
	 ...
	 * @return MasPfitLssSvcTrnsPrcVO[]
	 */
	public MasPfitLssSvcTrnsPrcVO[] getMasPfitLssSvcTrnsPrcVOs(){
		MasPfitLssSvcTrnsPrcVO[] vos = (MasPfitLssSvcTrnsPrcVO[])models.toArray(new MasPfitLssSvcTrnsPrcVO[models.size()]);
		return vos;
	}
