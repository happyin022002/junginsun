...
*@FileName : TesMgstFuelChgVO.java
*@FileTitle : TesMgstFuelChgVO
*Open Issues :
*Change history :
...
public class TesMgstFuelChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesMgstFuelChgVO> models = new ArrayList<TesMgstFuelChgVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("fuel_qty", getFuelQty());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("fuel_qty", "fuelQty");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setFuelQty(JSPUtil.getParameter(request, "fuel_qty", ""));
	 ...
	 * @param request
	 * @return TesMgstFuelChgVO[]
	 */
	public TesMgstFuelChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesMgstFuelChgVO[]
	 */
	public TesMgstFuelChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesMgstFuelChgVO model = null;
		...
		try {
			...
			String[] fuelQty = (JSPUtil.getParameter(request, prefix	+ "fuel_qty", length));
	...
	public TesMgstFuelChgVO[] getTesMgstFuelChgVOs(){
		TesMgstFuelChgVO[] vos = (TesMgstFuelChgVO[])models.toArray(new TesMgstFuelChgVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.fuelQty = this.fuelQty .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
