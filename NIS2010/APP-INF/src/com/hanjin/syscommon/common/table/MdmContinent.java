 ...
 * @since J2EE 1.4
 */
public final class MdmContinent implements java.io.Serializable {

	private String      ibflag      = "";
	private String      page_rows   = "";
	private String      conti_cd    = "";
	private String      conti_nm    = "";
	...
	public String      getConti_nm   (){	return conti_nm   	;	}
	...
	public void setConti_nm   ( String      conti_nm    ){	this.conti_nm    = conti_nm   	;	}
	...
	public static MdmContinent fromRequest(HttpServletRequest request) {
		MdmContinent model = new MdmContinent();
		try {
			model.setIbflag     	(JSPUtil.getParameter(request, "ibflag     		".trim(), ""));
			model.setPage_rows  	(JSPUtil.getParameter(request, "page_rows  		".trim(), ""));
			model.setConti_cd   	(JSPUtil.getParameter(request, "conti_cd   		".trim(), ""));
			model.setConti_nm   	(JSPUtil.getParameter(request, "conti_nm   		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MdmContinent();
				model.setIbflag     		  (ibflag     	[i]);
				model.setPage_rows  		  (page_rows  	[i]);
				model.setConti_cd   		  (conti_cd   	[i]);
				model.setConti_nm   		  (conti_nm   	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] conti_nm    =  (JSPUtil.getParameter(request, prefix + "conti_nm   		".trim(), length));
