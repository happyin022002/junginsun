...
public final class GL_CTR_ERP implements java.io.Serializable {
	...
	public String            getCtr_krn_nm       (){	return ctr_krn_nm       	;	}
	...
	public void setCtr_krn_nm       ( String            ctr_krn_nm        ){	this.ctr_krn_nm        = ctr_krn_nm       	;	}
	...
	public static GL_CTR_ERP fromRequest(HttpServletRequest request) {
		...
		try {
			...
			model.setCtr_krn_nm       	(JSPUtil.getParameter(request, "ctr_krn_nm       		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] ctr_krn_nm        =  (JSPUtil.getParameter(request, "ctr_krn_nm       		".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				model.setCtr_krn_nm       		  (ctr_krn_nm       	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ctr_krn_nm        =  (JSPUtil.getParameter(request, prefix + "ctr_krn_nm       		".trim(), length));
