 ...
 * @since J2EE 1.4
 */
public final class MdmState implements java.io.Serializable {

	private String      ibflag      = "";
	private String      page_rows   = "";
	private String      cnt_cd      = "";
	private String      ste_cd      = "";
	private String      ste_nm      = "";
	...
	public String      getSte_nm     (){	return ste_nm     	;	}
	...
	public void setSte_nm     ( String      ste_nm      ){	this.ste_nm      = ste_nm     	;	}
	...
	public static MdmState fromRequest(HttpServletRequest request) {
		MdmState model = new MdmState();
		try {
			...
			model.setSte_nm     	(JSPUtil.getParameter(request, "ste_nm     		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] ste_nm      =  (JSPUtil.getParameter(request, "ste_nm     		".trim(), length));
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] ste_nm      =  (JSPUtil.getParameter(request, prefix + "ste_nm     		".trim(), length));
