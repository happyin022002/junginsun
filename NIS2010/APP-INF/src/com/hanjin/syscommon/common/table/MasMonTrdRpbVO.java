...
*@FileName : MasMonTrdRpbVO.java
*@FileTitle : MasMonTrdRpbVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonTrdRpbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonTrdRpbVO> models = new ArrayList<MasMonTrdRpbVO>();
	 ...
	 * @param request
	 * @return MasMonTrdRpbVO[]
	 */
	public MasMonTrdRpbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonTrdRpbVO[]
	 */
	public MasMonTrdRpbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonTrdRpbVO model = null;
	 ...
	 * @return MasMonTrdRpbVO[]
	 */
	public MasMonTrdRpbVO[] getMasMonTrdRpbVOs(){
		MasMonTrdRpbVO[] vos = (MasMonTrdRpbVO[])models.toArray(new MasMonTrdRpbVO[models.size()]);
		return vos;
	}
