...
*@FileName : MasFullEccImbalVO.java
*@FileTitle : MasFullEccImbalVO
*Open Issues :
*Change history :
 ...
 */
public class MasFullEccImbalVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasFullEccImbalVO> models = new ArrayList<MasFullEccImbalVO>();
	...
	public MasFullEccImbalVO() {}

	public MasFullEccImbalVO(String ibflag, String pagerows, String costYrmon, String costLocGrpCd, String fcntrEccCd, String cntrTpszCd, String cntrIoVolStsCd, String cntrImbalRto, String cntrImbalQty, String cntrIbQty, String cntrObQty, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return MasFullEccImbalVO[]
	 */
	public MasFullEccImbalVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasFullEccImbalVO[]
	 */
	public MasFullEccImbalVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasFullEccImbalVO model = null;
	 ...
	 * @return MasFullEccImbalVO[]
	 */
	public MasFullEccImbalVO[] getMasFullEccImbalVOs(){
		MasFullEccImbalVO[] vos = (MasFullEccImbalVO[])models.toArray(new MasFullEccImbalVO[models.size()]);
		return vos;
	}
