...
*@FileName : MasMtyDestCostVO.java
*@FileTitle : MasMtyDestCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasMtyDestCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMtyDestCostVO> models = new ArrayList<MasMtyDestCostVO>();
	...
	public MasMtyDestCostVO() {}

	public MasMtyDestCostVO(String ibflag, String pagerows, String costYrmon, String costLocGrpCd, String cntrOrgDestCd, String eccCd, String cntrTpszCd, String simStvgUcAmt, String mtyStvgTtlAmt, String mtyQty, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.eccCd = eccCd;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return MasMtyDestCostVO[]
	 */
	public MasMtyDestCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMtyDestCostVO[]
	 */
	public MasMtyDestCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMtyDestCostVO model = null;
	 ...
	 * @return MasMtyDestCostVO[]
	 */
	public MasMtyDestCostVO[] getMasMtyDestCostVOs(){
		MasMtyDestCostVO[] vos = (MasMtyDestCostVO[])models.toArray(new MasMtyDestCostVO[models.size()]);
		return vos;
	}
