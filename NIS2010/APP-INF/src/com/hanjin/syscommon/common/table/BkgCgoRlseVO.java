...
public class BkgCgoRlseVO extends AbstractValueObject {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("event_id", getEventId());		
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("event_id", "eventId");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setEventId(JSPUtil.getParameter(request, "event_id", ""));
	...
	public BkgCgoRlseVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] eventId = (JSPUtil.getParameter(request, prefix	+ "event_id", length));
	...
	*/
	public void unDataFormat(){
		...
		this.eventId = this.eventId .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
