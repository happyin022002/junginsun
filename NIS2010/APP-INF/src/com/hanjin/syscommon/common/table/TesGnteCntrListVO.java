...
public class TesGnteCntrListVO extends AbstractValueObject {
	...
	/* Column Info */
	private String irrNoIfFlg = null;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("irr_no_if_flg", getIrrNoIfFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("irr_no_if_flg", "irrNoIfFlg");
	 ...
	 * @return irrNoIfFlg
	 */
	public String getIrrNoIfFlg() {
		return this.irrNoIfFlg;
	}
	 ...
	 * @param irrNoIfFlg
	 */
	public void setIrrNoIfFlg(String irrNoIfFlg) {
		this.irrNoIfFlg = irrNoIfFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setIrrNoIfFlg(JSPUtil.getParameter(request, "irr_no_if_flg", ""));
	}
	...
	public TesGnteCntrListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] irrNoIfFlg = (JSPUtil.getParameter(request, prefix + "irr_no_if_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (irrNoIfFlg[i] != null)
				model.setIrrNoIfFlg(irrNoIfFlg[i]);
	...
	*/
	public void unDataFormat(){
		...
		this.irrNoIfFlg = this.irrNoIfFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
	}
}
