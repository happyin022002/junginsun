...
*@FileName : ScgImdgSegrGrpVO.java
*@FileTitle : ScgImdgSegrGrpVO
*Open Issues :
*Change history :
...
public class ScgImdgSegrGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgImdgSegrGrpVO> models = new ArrayList<ScgImdgSegrGrpVO>();
	...
	public ScgImdgSegrGrpVO() {}

	public ScgImdgSegrGrpVO(String ibflag, String pagerows, String imdgSegrGrpNo, String imdgSegrGrpNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public ScgImdgSegrGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgImdgSegrGrpVO[]
	 */
	public ScgImdgSegrGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgImdgSegrGrpVO model = null;
	...
	public ScgImdgSegrGrpVO[] getScgImdgSegrGrpVOs(){
		ScgImdgSegrGrpVO[] vos = (ScgImdgSegrGrpVO[])models.toArray(new ScgImdgSegrGrpVO[models.size()]);
		return vos;
	}
