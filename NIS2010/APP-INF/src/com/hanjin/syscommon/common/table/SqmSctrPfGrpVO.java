...
*@FileName : SqmSctrPfGrpVO.java
*@FileTitle : SqmSctrPfGrpVO
*Open Issues :
*Change history :
...
public class SqmSctrPfGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrPfGrpVO> models = new ArrayList<SqmSctrPfGrpVO>();
	...
	public SqmSctrPfGrpVO() {}

	public SqmSctrPfGrpVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String pfGrpCd, String pfSvcTpCd, String trdCd, String subTrdCd, String pfRoutDesc, String sqmActFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
...
/**
	 ...
	 * @param request
	 * @return SqmSctrPfGrpVO[]
	 */
	public SqmSctrPfGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrPfGrpVO[]
	 */
	public SqmSctrPfGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrPfGrpVO model = null;
	 ...
	 * @return SqmSctrPfGrpVO[]
	 */
	public SqmSctrPfGrpVO[] getSqmSctrPfGrpVOs(){
		SqmSctrPfGrpVO[] vos = (SqmSctrPfGrpVO[])models.toArray(new SqmSctrPfGrpVO[models.size()]);
		return vos;
	}
