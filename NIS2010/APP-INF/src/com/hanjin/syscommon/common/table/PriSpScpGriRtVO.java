...
*@FileName : PriSpScpGriRtVO.java
*@FileTitle : PriSpScpGriRtVO
*Open Issues :
*Change history :
...
public class PriSpScpGriRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGriRtVO> models = new ArrayList<PriSpScpGriRtVO>();
	...
	public PriSpScpGriRtVO() {}

	public PriSpScpGriRtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String griRtSeq, String ratUtCd, String prcCgoTpCd, String currCd, String griRtAmt, String griRtRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriSpScpGriRtVO[]
	 */
	public PriSpScpGriRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGriRtVO[]
	 */
	public PriSpScpGriRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGriRtVO model = null;
	...
	public PriSpScpGriRtVO[] getPriSpScpGriRtVOs(){
		PriSpScpGriRtVO[] vos = (PriSpScpGriRtVO[])models.toArray(new PriSpScpGriRtVO[models.size()]);
		return vos;
	}
