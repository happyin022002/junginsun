...
*@FileName : MdmRepChgVO.java
*@FileTitle : MdmRepChgVO
*Open Issues :
*Change history :
...
public class MdmRepChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MdmRepChgVO> models = new ArrayList<MdmRepChgVO>();
	...
	public MdmRepChgVO(String ibflag, String pagerows, String updDt, String creUsrId, String repChgCd, String repChgNm, String deltFlg, String creDt, String eaiEvntDt, String updUsrId, String eaiIfId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return MdmRepChgVO[]
	 */
	public MdmRepChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MdmRepChgVO[]
	 */
	public MdmRepChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
	 ...
	 * @return MdmRepChgVO[]
	 */
	public MdmRepChgVO[] getMdmRepChgVOs(){
		MdmRepChgVO[] vos = (MdmRepChgVO[])models.toArray(new MdmRepChgVO[models.size()]);
		return vos;
	}
