...
*@FileName : PriSpScpArbGriRtVO.java
*@FileTitle : PriSpScpArbGriRtVO
*Open Issues :
*Change history :
...
public class PriSpScpArbGriRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpArbGriRtVO> models = new ArrayList<PriSpScpArbGriRtVO>();
	...
	public PriSpScpArbGriRtVO() {}

	public PriSpScpArbGriRtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String orgDestTpCd, String griGrpSeq, String griAdjSeq, String ratUtCd, String prcCgoTpCd, String currCd, String griRtAmt, String griRtRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriSpScpArbGriRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpArbGriRtVO[]
	 */
	public PriSpScpArbGriRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpArbGriRtVO model = null;
	...
	public PriSpScpArbGriRtVO[] getPriSpScpArbGriRtVOs(){
		PriSpScpArbGriRtVO[] vos = (PriSpScpArbGriRtVO[])models.toArray(new PriSpScpArbGriRtVO[models.size()]);
		return vos;
	}
