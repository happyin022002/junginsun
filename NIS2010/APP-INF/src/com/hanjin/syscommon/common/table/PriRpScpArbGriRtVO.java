...
*@FileName : PriRpScpArbGriRtVO.java
*@FileTitle : PriRpScpArbGriRtVO
*Open Issues :
*Change history :
...
public class PriRpScpArbGriRtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpArbGriRtVO> models = new ArrayList<PriRpScpArbGriRtVO>();
	...
	public PriRpScpArbGriRtVO() {}

	public PriRpScpArbGriRtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String orgDestTpCd, String griGrpSeq, String griAdjSeq, String ratUtCd, String prcCgoTpCd, String currCd, String griRtAmt, String griRtRto, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRpScpArbGriRtVO[]
	 */
	public PriRpScpArbGriRtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpArbGriRtVO[]
	 */
	public PriRpScpArbGriRtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpArbGriRtVO model = null;
	 ...
	 * @return PriRpScpArbGriRtVO[]
	 */
	public PriRpScpArbGriRtVO[] getPriRpScpArbGriRtVOs(){
		PriRpScpArbGriRtVO[] vos = (PriRpScpArbGriRtVO[])models.toArray(new PriRpScpArbGriRtVO[models.size()]);
		return vos;
	}
