...
public class PrdBkgCopMapVO extends AbstractValueObject {
	...
	/* Column Info */
	private String obAutoIrgEnblFlg = null;
	/* Column Info */
	...
	public PrdBkgCopMapVO(String ibflag, String pagerows, String pctlNo, String bkgNo, String copNo, String copMapgSeq, String crntFlg, String cntrNo, String cntrTpszCd, String copOpTpCd, String bkgOpRmk, String obItchgCtnt, String ibItchgCtnt, String ocnItchgCtnt, String mtyPkupYdCd, String mtyRtnYdCd, String porNodCd, String polNodCd, String bkgRcvTermCd, String bkgDeTermCd, String obTroFlg, String ibTroFlg, String copPattOrdNo, String copSoKnt, String creUsrId, String creDt, String updUsrId, String updDt, String obAutoIrgEnblFlg) {
		this.copSoKnt = copSoKnt;
		this.bkgOpRmk = bkgOpRmk;
		this.obAutoIrgEnblFlg = obAutoIrgEnblFlg;
		this.creDt = creDt;
		this.copNo = copNo;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ob_auto_irg_enbl_flg", getObAutoIrgEnblFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ob_auto_irg_enbl_flg", "obAutoIrgEnblFlg");
	...
	/**
	 * Column Info
	 * @return obAutoIrgEnblFlg
	 */
	public String getObAutoIrgEnblFlg() {
		return this.obAutoIrgEnblFlg;
	}
	...
	/**
	 * Column Info
	 * @param obAutoIrgEnblFlg
	 */
	public void setObAutoIrgEnblFlg(String obAutoIrgEnblFlg) {
		this.obAutoIrgEnblFlg = obAutoIrgEnblFlg;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setObAutoIrgEnblFlg(JSPUtil.getParameter(request, prefix + "ob_auto_irg_enbl_flg", ""));
	...
	public PrdBkgCopMapVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] obAutoIrgEnblFlg = (JSPUtil.getParameter(request, prefix	+ "ob_auto_irg_enbl_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (obAutoIrgEnblFlg[i] != null)
					model.setObAutoIrgEnblFlg(obAutoIrgEnblFlg[i]);
				if (creDt[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.obAutoIrgEnblFlg = this.obAutoIrgEnblFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
