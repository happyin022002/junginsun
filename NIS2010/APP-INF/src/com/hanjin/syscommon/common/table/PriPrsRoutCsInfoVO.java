...
*@FileName : PriPrsRoutCsInfoVO.java
*@FileTitle : PriPrsRoutCsInfoVO
*Open Issues :
*Change history :
...
public class PriPrsRoutCsInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriPrsRoutCsInfoVO> models = new ArrayList<PriPrsRoutCsInfoVO>();
	 ...
	 */
	public PriPrsRoutCsInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriPrsRoutCsInfoVO[]
	 */
	public PriPrsRoutCsInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriPrsRoutCsInfoVO model = null;
	...
	public PriPrsRoutCsInfoVO[] getPriPrsRoutCsInfoVOs(){
		PriPrsRoutCsInfoVO[] vos = (PriPrsRoutCsInfoVO[])models.toArray(new PriPrsRoutCsInfoVO[models.size()]);
		return vos;
	}
