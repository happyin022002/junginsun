...
*@FileName : PriRqRtCmdtVO.java
*@FileTitle : PriRqRtCmdtVO
*Open Issues :
*Change history :
...
public class PriRqRtCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtCmdtVO> models = new ArrayList<PriRqRtCmdtVO>();
	...
	public PriRqRtCmdtVO() {}

	public PriRqRtCmdtVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String cmdtSeq, String prcCmdtTpCd, String prcCmdtDefCd, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRqRtCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtCmdtVO[]
	 */
	public PriRqRtCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtCmdtVO model = null;
	...
	public PriRqRtCmdtVO[] getPriRqRtCmdtVOs(){
		PriRqRtCmdtVO[] vos = (PriRqRtCmdtVO[])models.toArray(new PriRqRtCmdtVO[models.size()]);
		return vos;
	}
