...
*@FileName : MasBkgLgsSmryVO.java
*@FileTitle : MasBkgLgsSmryVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgLgsSmryVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgLgsSmryVO> models = new ArrayList<MasBkgLgsSmryVO>();
	 ...
	 * @param request
	 * @return MasBkgLgsSmryVO[]
	 */
	public MasBkgLgsSmryVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgLgsSmryVO[]
	 */
	public MasBkgLgsSmryVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgLgsSmryVO model = null;
	 ...
	 * @return MasBkgLgsSmryVO[]
	 */
	public MasBkgLgsSmryVO[] getMasBkgLgsSmryVOs(){
		MasBkgLgsSmryVO[] vos = (MasBkgLgsSmryVO[])models.toArray(new MasBkgLgsSmryVO[models.size()]);
		return vos;
	}
