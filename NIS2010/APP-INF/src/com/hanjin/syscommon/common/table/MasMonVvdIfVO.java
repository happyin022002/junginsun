...
*@FileName : MasMonVvdIfVO.java
*@FileTitle : MasMonVvdIfVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonVvdIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonVvdIfVO> models = new ArrayList<MasMonVvdIfVO>();
	 ...
	 * @param request
	 * @return MasMonVvdIfVO[]
	 */
	public MasMonVvdIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonVvdIfVO[]
	 */
	public MasMonVvdIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonVvdIfVO model = null;
	 ...
	 * @return MasMonVvdIfVO[]
	 */
	public MasMonVvdIfVO[] getMasMonVvdIfVOs(){
		MasMonVvdIfVO[] vos = (MasMonVvdIfVO[])models.toArray(new MasMonVvdIfVO[models.size()]);
		return vos;
	}
