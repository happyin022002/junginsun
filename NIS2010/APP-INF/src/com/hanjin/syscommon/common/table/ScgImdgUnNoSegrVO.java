...
*@FileName : ScgImdgUnNoSegrVO.java
*@FileTitle : ScgImdgUnNoSegrVO
*Open Issues :
*Change history :
...
public class ScgImdgUnNoSegrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgImdgUnNoSegrVO> models = new ArrayList<ScgImdgUnNoSegrVO>();
	...
	public ScgImdgUnNoSegrVO() {}

	public ScgImdgUnNoSegrVO(String ibflag, String pagerows, String imdgUnNo, String imdgUnNoSeq, String imdgClssCd, String imdgSegrCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return ScgImdgUnNoSegrVO[]
	 */
	public ScgImdgUnNoSegrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgImdgUnNoSegrVO[]
	 */
	public ScgImdgUnNoSegrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgImdgUnNoSegrVO model = null;
	 ...
	 * @return ScgImdgUnNoSegrVO[]
	 */
	public ScgImdgUnNoSegrVO[] getScgImdgUnNoSegrVOs(){
		ScgImdgUnNoSegrVO[] vos = (ScgImdgUnNoSegrVO[])models.toArray(new ScgImdgUnNoSegrVO[models.size()]);
		return vos;
	}
