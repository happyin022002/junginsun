...
*@FileName : PriSqGrpLocDtlVO.java
*@FileTitle : PriSqGrpLocDtlVO
*Open Issues :
*Change history :
...
public class PriSqGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqGrpLocDtlVO> models = new ArrayList<PriSqGrpLocDtlVO>();
	...
	public PriSqGrpLocDtlVO() {}

	public PriSqGrpLocDtlVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String grpLocSeq, String grpLocDtlSeq, String locCd, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriSqGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqGrpLocDtlVO[]
	 */
	public PriSqGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqGrpLocDtlVO model = null;
	...
	public PriSqGrpLocDtlVO[] getPriSqGrpLocDtlVOs(){
		PriSqGrpLocDtlVO[] vos = (PriSqGrpLocDtlVO[])models.toArray(new PriSqGrpLocDtlVO[models.size()]);
		return vos;
	}
