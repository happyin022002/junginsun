...
*@FileName : MasInterOwnTmlCostVO.java
*@FileTitle : MasInterOwnTmlCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasInterOwnTmlCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasInterOwnTmlCostVO> models = new ArrayList<MasInterOwnTmlCostVO>();
	...
	public MasInterOwnTmlCostVO() {}

	public MasInterOwnTmlCostVO(String ibflag, String pagerows, String costYrmon, String tmlCd, String tmlTrfItmCd, String tmlTrfDtlCd, String cntrTpszCd, String masCostSrcCd, String tmlUtCd, String loclCurrCd, String mnItmChkFlg, String mnTrfDtlCd, String tmlQty, String loclTmlAmt, String tmlUsdAmt, String tmlUcAmt, String creUsrId, String creDt, String updUsrId, String updDt, String ucSlanCd) {
		this.updDt = updDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setTmlUsdAmt(JSPUtil.getParameter(request, prefix + "tml_usd_amt", ""));
		...
		setMnTrfDtlCd(JSPUtil.getParameter(request, prefix + "mn_trf_dtl_cd", ""));
		setLoclTmlAmt(JSPUtil.getParameter(request, prefix + "locl_tml_amt", ""));
		setCntrTpszCd(JSPUtil.getParameter(request, prefix + "cntr_tpsz_cd", ""));
		setTmlQty(JSPUtil.getParameter(request, prefix + "tml_qty", ""));
		setMnItmChkFlg(JSPUtil.getParameter(request, prefix + "mn_itm_chk_flg", ""));
	 ...
	 */
	public MasInterOwnTmlCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasInterOwnTmlCostVO[]
	 */
	public MasInterOwnTmlCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasInterOwnTmlCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasInterOwnTmlCostVO();
				if (updDt[i] != null)
		...
		return getMasInterOwnTmlCostVOs();
	}
	...
	public MasInterOwnTmlCostVO[] getMasInterOwnTmlCostVOs(){
		MasInterOwnTmlCostVO[] vos = (MasInterOwnTmlCostVO[])models.toArray(new MasInterOwnTmlCostVO[models.size()]);
		return vos;
	}
