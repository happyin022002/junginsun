...
*@FileName : MasVslSubTrdCapaVO.java
*@FileTitle : MasVslSubTrdCapaVO
*Open Issues :
*Change history :
 ...
 */
public class MasVslSubTrdCapaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasVslSubTrdCapaVO> models = new ArrayList<MasVslSubTrdCapaVO>();
	...
	public MasVslSubTrdCapaVO() {}

	public MasVslSubTrdCapaVO(String ibflag, String pagerows, String vslCd, String subTrdCd, String subTrdCapa, String creUsrId, String creDt, String updUsrId, String updDt, String lstFlg, String vslSeq, String autoFlg) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAutoFlg(JSPUtil.getParameter(request, "autoFlg", ""));
	}
	 ...
	 */
	public MasVslSubTrdCapaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasVslSubTrdCapaVO[]
	 */
	public MasVslSubTrdCapaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasVslSubTrdCapaVO model = null;
	...
	public MasVslSubTrdCapaVO[] getMasVslSubTrdCapaVOs(){
		MasVslSubTrdCapaVO[] vos = (MasVslSubTrdCapaVO[])models.toArray(new MasVslSubTrdCapaVO[models.size()]);
		return vos;
	}
