...
*@FileName : PriRpDurVO.java
*@FileTitle : PriRpDurVO
*Open Issues :
*Change history :
...
public class PriRpDurVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpDurVO> models = new ArrayList<PriRpDurVO>();
	...
	public PriRpDurVO(String ibflag, String pagerows, String propNo, String amdtSeq, String ctrtEffDt, String ctrtExpDt, String prcProgStsCd, String srcInfoCd, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt, String n1stCmncAmdtSeq) {
		this.updDt = updDt;
	 ...
	 * @return PriRpDurVO[]
	 */
	public PriRpDurVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpDurVO[]
	 */
	public PriRpDurVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpDurVO model = null;
	...
	public PriRpDurVO[] getPriRpDurVOs(){
		PriRpDurVO[] vos = (PriRpDurVO[])models.toArray(new PriRpDurVO[models.size()]);
		return vos;
	}
