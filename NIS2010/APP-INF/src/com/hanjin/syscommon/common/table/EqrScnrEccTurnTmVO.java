...
*@FileName : EqrScnrEccTurnTmVO.java
*@FileTitle : EqrScnrEccTurnTmVO
*Open Issues :
*Change history :
...
public class EqrScnrEccTurnTmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrScnrEccTurnTmVO> models = new ArrayList<EqrScnrEccTurnTmVO>();
	...
	public EqrScnrEccTurnTmVO() {}

	public EqrScnrEccTurnTmVO(String ibflag, String pagerows, String scnrId, String coCd, String ioBndCd, String fmEccCd, String toEccCd, String cntrTpszCd, String ttRtoDys, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.coCd = coCd;
		this.scnrId = scnrId;
	 ...
	 * @param request
	 * @return EqrScnrEccTurnTmVO[]
	 */
	public EqrScnrEccTurnTmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrScnrEccTurnTmVO[]
	 */
	public EqrScnrEccTurnTmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrScnrEccTurnTmVO model = null;
	 ...
	 * @return EqrScnrEccTurnTmVO[]
	 */
	public EqrScnrEccTurnTmVO[] fromRequestGridArrayList(HttpServletRequest request, String tpsztype) {
		EqrScnrEccTurnTmVO model = null;
  		String prefix = "";
		...
		try {
			for (int k=0 ; k < prefix1.length ; k++){
				...
				String[] creUsrId = (JSPUtil.getParameter(request, prefix	+ "cre_usr_id", length));
				String[] cntrTpszCd = (JSPUtil.getParameter(request, prefix	+ "cntr_tpsz_cd", length));		
				String cntr_tpsz_cd  =   prefix1[k].trim().toString();	
				String[] ttRtoDys = (JSPUtil.getParameter(request, prefix	+ "tt_rto_dys", length));
				String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
	...
	public EqrScnrEccTurnTmVO[] getEqrScnrEccTurnTmVOs(){
		EqrScnrEccTurnTmVO[] vos = (EqrScnrEccTurnTmVO[])models.toArray(new EqrScnrEccTurnTmVO[models.size()]);
		return vos;
	}
