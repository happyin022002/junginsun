 ...
 **/
public final class AD_BBOARDFILE implements java.io.Serializable {
    ...
    public static AD_BBOARDFILE fromRequest(HttpServletRequest request) {
        AD_BBOARDFILE model = new AD_BBOARDFILE();
        try {
