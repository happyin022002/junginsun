...
public class TesEdiRcvFltFileTagVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TesEdiRcvFltFileTagVO> models = new ArrayList<TesEdiRcvFltFileTagVO>();
	...
	public TesEdiRcvFltFileTagVO() {}

	public TesEdiRcvFltFileTagVO(String ibflag, String pagerows, String ediRcvRuleMnSeq, String ediVndrSeq, String fltFileTagNm, String tblNm, String tblVoNm, String hdrTagFlg, String savSeq, String prntTagNm, String tagVldKnt, String creUsrId, String creDt, String updUsrId, String updDt, String mnlCntrRcvTagFlg) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public TesEdiRcvFltFileTagVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TesEdiRcvFltFileTagMgmtVO[]
	 */
	public TesEdiRcvFltFileTagVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TesEdiRcvFltFileTagVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TesEdiRcvFltFileTagVO();
				if (updDt[i] != null)
	 ...
	 * @return TesEdiRcvFltFileTagMgmtVO[]
	 */
	public TesEdiRcvFltFileTagVO[] getTesEdiRcvFltFileTagMgmtVOs(){
		TesEdiRcvFltFileTagVO[] vos = (TesEdiRcvFltFileTagVO[])models.toArray(new TesEdiRcvFltFileTagVO[models.size()]);
		return vos;
	}
