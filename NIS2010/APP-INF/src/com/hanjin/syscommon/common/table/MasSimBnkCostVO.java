...
*@FileName : MasSimBnkCostVO.java
*@FileTitle : MasSimBnkCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimBnkCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimBnkCostVO> models = new ArrayList<MasSimBnkCostVO>();
	...
	public MasSimBnkCostVO() {}

	public MasSimBnkCostVO(String ibflag, String pagerows, String simDt, String simNo, String sectNo, String vslClssCapa, String foilSailCsm, String foilPortCsm, String foilUcAmt, String doilCsm, String doilUcAmt, String bzcVslSpd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSimBnkCostVO[]
	 */
	public MasSimBnkCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimBnkCostVO[]
	 */
	public MasSimBnkCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimBnkCostVO model = null;
	 ...
	 * @return MasSimBnkCostVO[]
	 */
	public MasSimBnkCostVO[] getMasSimBnkCostVOs(){
		MasSimBnkCostVO[] vos = (MasSimBnkCostVO[])models.toArray(new MasSimBnkCostVO[models.size()]);
		return vos;
	}
