...
*@FileName : CoaComSvcTrnsPrcBkupVO.java
*@FileTitle : CoaComSvcTrnsPrcBkupVO
*Open Issues :
*Change history :
...
public class CoaComSvcTrnsPrcBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaComSvcTrnsPrcBkupVO> models = new ArrayList<CoaComSvcTrnsPrcBkupVO>();
	...
	public CoaComSvcTrnsPrcBkupVO() {}

	public CoaComSvcTrnsPrcBkupVO(String ibflag, String pagerows, String pctlNo, String coaCostSrcCd, String comRoutSeq, String locCd, String condOfcCd, String divMeasCd, String ofcClssCd, String slsActCd, String raAcctCd, String stndCostCd, String costAssBseCd, String svcTrnsPrcAmt, String bkgKnt, String cntrBxKnt, String cntrTeuQty, String vslDys, String comFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaComSvcTrnsPrcBkupVO[]
	 */
	public CoaComSvcTrnsPrcBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaComSvcTrnsPrcBkupVO[]
	 */
	public CoaComSvcTrnsPrcBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaComSvcTrnsPrcBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaComSvcTrnsPrcBkupVO();
				if (updDt[i] != null)
		...
		return getCoaComSvcTrnsPrcBkupVOs();
	}
	 ...
	 * @return CoaComSvcTrnsPrcBkupVO[]
	 */
	public CoaComSvcTrnsPrcBkupVO[] getCoaComSvcTrnsPrcBkupVOs(){
		CoaComSvcTrnsPrcBkupVO[] vos = (CoaComSvcTrnsPrcBkupVO[])models.toArray(new CoaComSvcTrnsPrcBkupVO[models.size()]);
		return vos;
	}
