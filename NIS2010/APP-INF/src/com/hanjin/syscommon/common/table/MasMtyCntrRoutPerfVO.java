...
*@FileName : MasMtyCntrRoutPerfVO.java
*@FileTitle : MasMtyCntrRoutPerfVO
*Open Issues :
*Change history :
 ...
 */
public class MasMtyCntrRoutPerfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMtyCntrRoutPerfVO> models = new ArrayList<MasMtyCntrRoutPerfVO>();
	 ...
	 * @param request
	 * @return MasMtyCntrRoutPerfVO[]
	 */
	public MasMtyCntrRoutPerfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMtyCntrRoutPerfVO[]
	 */
	public MasMtyCntrRoutPerfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMtyCntrRoutPerfVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasMtyCntrRoutPerfVO();
				if (updDt[i] != null)
		...
		return getMasMtyCntrRoutPerfVOs();
	}
	 ...
	 * @return MasMtyCntrRoutPerfVO[]
	 */
	public MasMtyCntrRoutPerfVO[] getMasMtyCntrRoutPerfVOs(){
		MasMtyCntrRoutPerfVO[] vos = (MasMtyCntrRoutPerfVO[])models.toArray(new MasMtyCntrRoutPerfVO[models.size()]);
		return vos;
	}
