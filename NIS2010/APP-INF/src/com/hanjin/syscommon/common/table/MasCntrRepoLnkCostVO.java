...
*@FileName : MasCntrRepoLnkCostVO.java
*@FileTitle : MasCntrRepoLnkCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoLnkCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoLnkCostVO> models = new ArrayList<MasCntrRepoLnkCostVO>();
	...
	public MasCntrRepoLnkCostVO() {}

	public MasCntrRepoLnkCostVO(String ibflag, String pagerows, String costYrmon, String lnkFmEccCd, String lnkToEccCd, String cntrTpszCd, String trspModCd, String lnkUcAmt, String lnkTpFlg, String lnkTtlQty, String lnkTtlAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return MasCntrRepoLnkCostVO[]
	 */
	public MasCntrRepoLnkCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoLnkCostVO[]
	 */
	public MasCntrRepoLnkCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoLnkCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasCntrRepoLnkCostVO();
				if (updDt[i] != null)
		...
		return getMasCntrRepoLnkCostVOs();
	}
	 ...
	 * @return MasCntrRepoLnkCostVO[]
	 */
	public MasCntrRepoLnkCostVO[] getMasCntrRepoLnkCostVOs(){
		MasCntrRepoLnkCostVO[] vos = (MasCntrRepoLnkCostVO[])models.toArray(new MasCntrRepoLnkCostVO[models.size()]);
		return vos;
	}
