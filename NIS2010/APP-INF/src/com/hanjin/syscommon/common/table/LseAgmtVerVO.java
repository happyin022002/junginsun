...
*@FileName : LseAgmtVerVO.java
*@FileTitle : LseAgmtVerVO
*Open Issues :
*Change history :
...
public class LseAgmtVerVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LseAgmtVerVO> models = new ArrayList<LseAgmtVerVO>();
	...
	public LseAgmtVerVO(String ibflag, String pagerows, String agmtCtyCd, String agmtSeq, String agmtVerSeq, String effDt, String expDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return LseAgmtVerVO[]
	 */
	public LseAgmtVerVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LseAgmtVerVO[]
	 */
	public LseAgmtVerVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LseAgmtVerVO model = null;
	 ...
	 * @return LseAgmtVerVO[]
	 */
	public LseAgmtVerVO[] getLseAgmtVerVOs(){
		LseAgmtVerVO[] vos = (LseAgmtVerVO[])models.toArray(new LseAgmtVerVO[models.size()]);
		return vos;
	}
