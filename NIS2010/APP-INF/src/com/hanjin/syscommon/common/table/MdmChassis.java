...
*@FileName : MDM_CHASSIS.java
*@FileTitle : Control Office Exception Case Creation
*Open Issues :
*Change history :
*@LastModifyDate : 2006-10-10
*@LastModifier : poong
*@LastVersion : 1.0
* 2006-10-10 poong
* 1.0 최초 생성
 ...
 * @since J2EE 1.4
 */
public final class MdmChassis implements java.io.Serializable {
	...
	public String              getNew_usd_cd         (){	return new_usd_cd         	;	}
	...
	public String              getDp_flg             (){	return dp_flg             	;	}
	...
	public String              getTerm_flg           (){	return term_flg           	;	}
	...
	public void setNew_usd_cd         ( String              new_usd_cd          ){	this.new_usd_cd          = new_usd_cd         	;	}
	...
	public void setDp_flg             ( String              dp_flg              ){	this.dp_flg              = dp_flg             	;	}
	...
	public void setTerm_flg           ( String              term_flg            ){	this.term_flg            = term_flg           	;	}
	...
	public static MdmChassis fromRequest(HttpServletRequest request) {
		MdmChassis model = new MdmChassis();
		try {
			...
			model.setNew_usd_cd         	(JSPUtil.getParameter(request, "new_usd_cd         		".trim(), ""));
			...
			model.setDp_flg             	(JSPUtil.getParameter(request, "dp_flg             		".trim(), ""));
			...
			model.setTerm_flg           	(JSPUtil.getParameter(request, "term_flg           		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] new_usd_cd          =  (JSPUtil.getParameter(request, "new_usd_cd         		".trim(), length));
			...
			String[] dp_flg              =  (JSPUtil.getParameter(request, "dp_flg             		".trim(), length));
			...
			String[] term_flg            =  (JSPUtil.getParameter(request, "term_flg           		".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				model.setNew_usd_cd         		  (new_usd_cd         	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] new_usd_cd          =  (JSPUtil.getParameter(request, prefix + "new_usd_cd         		".trim(), length));
			...
			String[] dp_flg              =  (JSPUtil.getParameter(request, prefix + "dp_flg             		".trim(), length));
			...
			String[] term_flg            =  (JSPUtil.getParameter(request, prefix + "term_flg           		".trim(), length));
