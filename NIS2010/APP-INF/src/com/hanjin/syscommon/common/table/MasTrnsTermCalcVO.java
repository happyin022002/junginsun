...
*@FileName : MasTrnsTermCalcVO.java
*@FileTitle : MasTrnsTermCalcVO
*Open Issues :
*Change history :
 ...
 */
public class MasTrnsTermCalcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasTrnsTermCalcVO> models = new ArrayList<MasTrnsTermCalcVO>();
	 ...
	 */
	public MasTrnsTermCalcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasTrnsTermCalcVO[]
	 */
	public MasTrnsTermCalcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasTrnsTermCalcVO model = null;
	...
	public MasTrnsTermCalcVO[] getMasTrnsTermCalcVOs(){
		MasTrnsTermCalcVO[] vos = (MasTrnsTermCalcVO[])models.toArray(new MasTrnsTermCalcVO[models.size()]);
		return vos;
	}
