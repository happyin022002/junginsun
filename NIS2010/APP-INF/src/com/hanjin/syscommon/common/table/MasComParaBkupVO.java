...
*@FileName : MasComParaBkupVO.java
*@FileTitle : MasComParaBkupVO
*Open Issues :
*Change history :
 ...
 */
public class MasComParaBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComParaBkupVO> models = new ArrayList<MasComParaBkupVO>();
	 ...
	 * @param request
	 * @return MasComParaBkupVO[]
	 */
	public MasComParaBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComParaBkupVO[]
	 */
	public MasComParaBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComParaBkupVO model = null;
	 ...
	 * @return MasComParaBkupVO[]
	 */
	public MasComParaBkupVO[] getMasComParaBkupVOs(){
		MasComParaBkupVO[] vos = (MasComParaBkupVO[])models.toArray(new MasComParaBkupVO[models.size()]);
		return vos;
	}
