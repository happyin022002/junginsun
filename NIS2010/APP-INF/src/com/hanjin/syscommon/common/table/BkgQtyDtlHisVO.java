...
*@FileName : BkgQtyDtlHisVO.java
*@FileTitle : BkgQtyDtlHisVO
*Open Issues :
*Change history :
...
public class BkgQtyDtlHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgQtyDtlHisVO> models = new ArrayList<BkgQtyDtlHisVO>();
	...
	/* Column Info */
	private String crrHngrTblBarUseFlg = null;
	/* Column Info */
	...
	public BkgQtyDtlHisVO() {}

	public BkgQtyDtlHisVO(String ibflag, String pagerows, String bkgNo, String corrNo, String cntrTpszCd, String substSeq, String opCntrQty, String awkCgoFlg, String dcgoFlg, String rcFlg, String bbCgoFlg, String socFlg, String crrHngrSglBarUseFlg, String crrHngrDblBarUseFlg, String eqSubstCntrTpszCd, String creUsrId, String creDt, String updUsrId, String updDt, String dryCgoFlg, String crrHngrFlg, String merHngrFlg, String crrHngrTblBarUseFlg) {
		...
		this.creDt = creDt;
		this.corrNo = corrNo;
		this.crrHngrTblBarUseFlg = crrHngrTblBarUseFlg;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("crr_hngr_tbl_bar_use_flg", getCrrHngrTblBarUseFlg());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("crr_hngr_tbl_bar_use_flg", "crrHngrTblBarUseFlg");
	...
	/**
	 * Column Info
	 * @return crrHngrTblBarUseFlg
	 */
	public String getCrrHngrTblBarUseFlg() {
		return this.crrHngrTblBarUseFlg;
	}
	...
	/**
	 * Column Info
	 * @param crrHngrTblBarUseFlg
	 */
	public void setCrrHngrTblBarUseFlg(String crrHngrTblBarUseFlg) {
		this.crrHngrTblBarUseFlg = crrHngrTblBarUseFlg;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCrrHngrTblBarUseFlg(JSPUtil.getParameter(request, "crr_hngr_tbl_bar_use_flg", ""));
	 ...
	 * @param request
	 * @return BkgQtyDtlHisVO[]
	 */
	public BkgQtyDtlHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgQtyDtlHisVO[]
	 */
	public BkgQtyDtlHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgQtyDtlHisVO model = null;
		...
		try {
			...
			String[] crrHngrTblBarUseFlg = (JSPUtil.getParameter(request, prefix	+ "crr_hngr_tbl_bar_use_flg", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (crrHngrTblBarUseFlg[i] != null)
					model.setCrrHngrTblBarUseFlg(crrHngrTblBarUseFlg[i]);
	 ...
	 * @return BkgQtyDtlHisVO[]
	 */
	public BkgQtyDtlHisVO[] getBkgQtyDtlHisVOs(){
		BkgQtyDtlHisVO[] vos = (BkgQtyDtlHisVO[])models.toArray(new BkgQtyDtlHisVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.crrHngrTblBarUseFlg = this.crrHngrTblBarUseFlg .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
