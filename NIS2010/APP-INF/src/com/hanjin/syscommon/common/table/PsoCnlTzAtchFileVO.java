...
*@FileName : PsoCnlTzAtchFileVO.java
*@FileTitle : PsoCnlTzAtchFileVO
*Open Issues :
*Change history :
...
public class PsoCnlTzAtchFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsoCnlTzAtchFileVO> models = new ArrayList<PsoCnlTzAtchFileVO>();
	...
	public PsoCnlTzAtchFileVO() {}

	public PsoCnlTzAtchFileVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String ydCd, String callSeq, String fileSavId, String lgsCostCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
...
/**
	 ...
	 * @param request
	 * @return PsoCnlTzAtchFileVO[]
	 */
	public PsoCnlTzAtchFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsoCnlTzAtchFileVO[]
	 */
	public PsoCnlTzAtchFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsoCnlTzAtchFileVO model = null;
	 ...
	 * @return PsoCnlTzAtchFileVO[]
	 */
	public PsoCnlTzAtchFileVO[] getPsoCnlTzAtchFileVOs(){
		PsoCnlTzAtchFileVO[] vos = (PsoCnlTzAtchFileVO[])models.toArray(new PsoCnlTzAtchFileVO[models.size()]);
		return vos;
	}
