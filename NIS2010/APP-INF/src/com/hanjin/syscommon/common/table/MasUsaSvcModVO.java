...
*@FileName : MasUsaSvcModVO.java
*@FileTitle : MasUsaSvcModVO
*Open Issues :
*Change history :
 ...
 */
public class MasUsaSvcModVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasUsaSvcModVO> models = new ArrayList<MasUsaSvcModVO>();
	...
	public MasUsaSvcModVO() {}

	public MasUsaSvcModVO(String ibflag, String pagerows, String orgRgnCd, String destRgnCd, String svcModCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setDestRgnCd(JSPUtil.getParameter(request, "dest_rgn_cd", ""));
	 ...
	 * @param request
	 * @return MasUsaSvcModVO[]
	 */
	public MasUsaSvcModVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasUsaSvcModVO[]
	 */
	public MasUsaSvcModVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasUsaSvcModVO model = null;
	 ...
	 * @return MasUsaSvcModVO[]
	 */
	public MasUsaSvcModVO[] getMasUsaSvcModVOs(){
		MasUsaSvcModVO[] vos = (MasUsaSvcModVO[])models.toArray(new MasUsaSvcModVO[models.size()]);
		return vos;
	}
