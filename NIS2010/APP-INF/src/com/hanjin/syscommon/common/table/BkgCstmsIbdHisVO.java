...
*@FileName : BkgCstmsIbdHisVO.java
*@FileTitle : BkgCstmsIbdHisVO
*Open Issues :
*Change history :
...
public class BkgCstmsIbdHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsIbdHisVO> models = new ArrayList<BkgCstmsIbdHisVO>();
	...
	public BkgCstmsIbdHisVO() {}

	public BkgCstmsIbdHisVO(String ibflag, String pagerows, String cntCd, String blNo, String blNoTp, String blNoChk, String hisSeq, String hisTpId, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public BkgCstmsIbdHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsIbdHisVO[]
	 */
	public BkgCstmsIbdHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsIbdHisVO model = null;
	 ...
	 * @return BkgCstmsIbdHisVO[]
	 */
	public BkgCstmsIbdHisVO[] getBkgCstmsIbdHisVOs(){
		BkgCstmsIbdHisVO[] vos = (BkgCstmsIbdHisVO[])models.toArray(new BkgCstmsIbdHisVO[models.size()]);
		return vos;
	}
