...
*@FileName : ComPgmRoleVO.java
*@FileTitle : ComPgmRoleVO
*Open Issues :
*Change history :
...
public class ComPgmRoleVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComPgmRoleVO> models = new ArrayList<ComPgmRoleVO>();
	...
	public ComPgmRoleVO(String ibflag, String pagerows, String pgmNo, String usrRoleCd, String creUsrId, String creDt, String updUsrId, String updDt) {
	...
	public ComPgmRoleVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public ComPgmRoleVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		return getComPgmRoleVOs();
	}

	public ComPgmRoleVO[] getComPgmRoleVOs(){
		ComPgmRoleVO[] vos = (ComPgmRoleVO[])models.toArray(new ComPgmRoleVO[models.size()]);
		return vos;
	}
