...
*@FileName : MasLaneVslFreqVO.java
*@FileTitle : MasLaneVslFreqVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneVslFreqVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneVslFreqVO> models = new ArrayList<MasLaneVslFreqVO>();
	...
	public MasLaneVslFreqVO() {}

	public MasLaneVslFreqVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String freqNo, String creUsrId, String creDt, String updUsrId, String updDt, String costUseTpCd, String dirCd) {
		this.updDt = updDt;
		this.freqNo = freqNo;
...
/**
	 ...
	 * @param request
	 * @return MasLaneVslFreqVO[]
	 */
	public MasLaneVslFreqVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneVslFreqVO[]
	 */
	public MasLaneVslFreqVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneVslFreqVO model = null;
	 ...
	 * @return MasLaneVslFreqVO[]
	 */
	public MasLaneVslFreqVO[] getMasLaneVslFreqVOs(){
		MasLaneVslFreqVO[] vos = (MasLaneVslFreqVO[])models.toArray(new MasLaneVslFreqVO[models.size()]);
		return vos;
	}
