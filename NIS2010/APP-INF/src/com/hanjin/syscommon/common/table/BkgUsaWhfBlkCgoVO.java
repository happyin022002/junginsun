...
*@FileName : BkgUsaWhfBlkCgoVO.java
*@FileTitle : BkgUsaWhfBlkCgoVO
*Open Issues :
*Change history :
...
public class BkgUsaWhfBlkCgoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgUsaWhfBlkCgoVO> models = new ArrayList<BkgUsaWhfBlkCgoVO>();
	...
	public BkgUsaWhfBlkCgoVO() {}

	public BkgUsaWhfBlkCgoVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String portCd, String ioBndCd, String bbCgoSeq, String cmdtDesc, String usaWhfRatUtCd, String ratAsQty, String whfUtPrc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
	 ...
	 * @param request
	 * @return BkgUsaWhfBlkCgoVO[]
	 */
	public BkgUsaWhfBlkCgoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgUsaWhfBlkCgoVO[]
	 */
	public BkgUsaWhfBlkCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgUsaWhfBlkCgoVO model = null;
	 ...
	 * @return BkgUsaWhfBlkCgoVO[]
	 */
	public BkgUsaWhfBlkCgoVO[] getBkgUsaWhfBlkCgoVOs(){
		BkgUsaWhfBlkCgoVO[] vos = (BkgUsaWhfBlkCgoVO[])models.toArray(new BkgUsaWhfBlkCgoVO[models.size()]);
		return vos;
	}
