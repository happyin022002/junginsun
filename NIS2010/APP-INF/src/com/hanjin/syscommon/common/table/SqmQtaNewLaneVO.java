...
*@FileName : SqmQtaNewLaneVO.java
*@FileTitle : SqmQtaNewLaneVO
*Open Issues :
*Change history :
...
public class SqmQtaNewLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmQtaNewLaneVO> models = new ArrayList<SqmQtaNewLaneVO>();
	...
	public SqmQtaNewLaneVO() {}

	public SqmQtaNewLaneVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String srcTrdCd, String srcRlaneCd, String srcDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public SqmQtaNewLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmQtaNewLaneVO[]
	 */
	public SqmQtaNewLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmQtaNewLaneVO model = null;
	...
	public SqmQtaNewLaneVO[] getSqmQtaNewLaneVOs(){
		SqmQtaNewLaneVO[] vos = (SqmQtaNewLaneVO[])models.toArray(new SqmQtaNewLaneVO[models.size()]);
		return vos;
	}
