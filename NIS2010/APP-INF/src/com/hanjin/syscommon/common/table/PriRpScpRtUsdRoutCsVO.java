...
*@FileName : PriRpScpRtUsdRoutCsVO.java
*@FileTitle : PriRpScpRtUsdRoutCsVO
*Open Issues :
*Change history :
...
public class PriRpScpRtUsdRoutCsVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtUsdRoutCsVO> models = new ArrayList<PriRpScpRtUsdRoutCsVO>();
	...
	public PriRpScpRtUsdRoutCsVO() {}

	public PriRpScpRtUsdRoutCsVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String cmdtHdrSeq, String routSeq, String rtSeq, String routCsNo, String routCsSrcDt, String usdRoutCsSelFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRpScpRtUsdRoutCsVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtUsdRoutCsVO[]
	 */
	public PriRpScpRtUsdRoutCsVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtUsdRoutCsVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriRpScpRtUsdRoutCsVO();
				if (updDt[i] != null)
		...
		return getPriRpScpRtUsdRoutCsVOs();
	}
	 ...
	 * @return PriRpScpRtUsdRoutCsVO[]
	 */
	public PriRpScpRtUsdRoutCsVO[] getPriRpScpRtUsdRoutCsVOs(){
		PriRpScpRtUsdRoutCsVO[] vos = (PriRpScpRtUsdRoutCsVO[])models.toArray(new PriRpScpRtUsdRoutCsVO[models.size()]);
		return vos;
	}
