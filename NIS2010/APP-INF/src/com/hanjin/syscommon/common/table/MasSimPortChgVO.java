...
*@FileName : MasSimPortChgVO.java
*@FileTitle : MasSimPortChgVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimPortChgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimPortChgVO> models = new ArrayList<MasSimPortChgVO>();
	...
	public MasSimPortChgVO() {}

	public MasSimPortChgVO(String ibflag, String pagerows, String simDt, String simNo, String tmlCd, String vslClssCapa, String portTrfAmt, String cnlFeeAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasSimPortChgVO[]
	 */
	public MasSimPortChgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimPortChgVO[]
	 */
	public MasSimPortChgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimPortChgVO model = null;
	 ...
	 * @return MasSimPortChgVO[]
	 */
	public MasSimPortChgVO[] getMasSimPortChgVOs(){
		MasSimPortChgVO[] vos = (MasSimPortChgVO[])models.toArray(new MasSimPortChgVO[models.size()]);
		return vos;
	}
