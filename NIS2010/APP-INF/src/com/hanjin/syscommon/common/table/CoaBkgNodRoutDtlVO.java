...
*@FileName : CoaBkgNodRoutDtlVO.java
*@FileTitle : CoaBkgNodRoutDtlVO
*Open Issues :
*Change history :
...
public class CoaBkgNodRoutDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaBkgNodRoutDtlVO> models = new ArrayList<CoaBkgNodRoutDtlVO>();
	...
	/* Column Info */
	private String laneOpCoCd = null;
	/* Column Info */
	...
	public CoaBkgNodRoutDtlVO() {}

	public CoaBkgNodRoutDtlVO(String ibflag, String pagerows, String bkgNo, String bkgRoutSeq, String orgNodCd, String destNodCd, String nodLnkDivCd, String bkgIoBndCd, String trspModCd, String rlaneCd, String laneOpCoCd, String vslCd, String skdVoyNo, String skdDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("lane_op_co_cd", getLaneOpCoCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("lane_op_co_cd", "laneOpCoCd");
	 ...
	 * @return laneOpCoCd
	 */
	public String getLaneOpCoCd() {
		return this.laneOpCoCd;
	}
	 ...
	 * @param laneOpCoCd
	 */
	public void setLaneOpCoCd(String laneOpCoCd) {
		this.laneOpCoCd = laneOpCoCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBkgIoBndCd(JSPUtil.getParameter(request, "bkg_io_bnd_cd", ""));
		...
		setLaneOpCoCd(JSPUtil.getParameter(request, "lane_op_co_cd", ""));
	 ...
	 * @param request
	 * @return CoaBkgNodRoutDtlVO[]
	 */
	public CoaBkgNodRoutDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaBkgNodRoutDtlVO[]
	 */
	public CoaBkgNodRoutDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaBkgNodRoutDtlVO model = null;
		...
		try {
			...
			String[] laneOpCoCd = (JSPUtil.getParameter(request, prefix	+ "lane_op_co_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (laneOpCoCd[i] != null)
					model.setLaneOpCoCd(laneOpCoCd[i]);
				if (orgNodCd[i] != null)
	 ...
	 * @return CoaBkgNodRoutDtlVO[]
	 */
	public CoaBkgNodRoutDtlVO[] getCoaBkgNodRoutDtlVOs(){
		CoaBkgNodRoutDtlVO[] vos = (CoaBkgNodRoutDtlVO[])models.toArray(new CoaBkgNodRoutDtlVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.laneOpCoCd = this.laneOpCoCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
