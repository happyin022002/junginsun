...
*@FileName : MasCntrRepoSimCostVO.java
*@FileTitle : MasCntrRepoSimCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoSimCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoSimCostVO> models = new ArrayList<MasCntrRepoSimCostVO>();
	...
	public MasCntrRepoSimCostVO() {}

	public MasCntrRepoSimCostVO(String ibflag, String pagerows, String costYrmon, String porEccCd, String delEccCd, String cntrTpszCd, String eqRepoCrRto, String mtySimCostAmt, String fnlMtySimCostAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 * @param request
	 * @return MasCntrRepoSimCostVO[]
	 */
	public MasCntrRepoSimCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoSimCostVO[]
	 */
	public MasCntrRepoSimCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoSimCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasCntrRepoSimCostVO();
				if (porEccCd[i] != null)
		...
		return getMasCntrRepoSimCostVOs();
	}
	 ...
	 * @return MasCntrRepoSimCostVO[]
	 */
	public MasCntrRepoSimCostVO[] getMasCntrRepoSimCostVOs(){
		MasCntrRepoSimCostVO[] vos = (MasCntrRepoSimCostVO[])models.toArray(new MasCntrRepoSimCostVO[models.size()]);
		return vos;
	}
