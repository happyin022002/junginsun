...
*@FileName : BkgCstmsAnrEdiMsgVO.java
*@FileTitle : BkgCstmsAnrEdiMsgVO
*Open Issues :
*Change history :
...
public class BkgCstmsAnrEdiMsgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCstmsAnrEdiMsgVO> models = new ArrayList<BkgCstmsAnrEdiMsgVO>();
	...
	public BkgCstmsAnrEdiMsgVO() {}

	public BkgCstmsAnrEdiMsgVO(String ibflag, String pagerows, String msgTpCd, String rcvSndDivCd, String anrDeclNo, String refSeq, String msgSeq, String ediMsg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public BkgCstmsAnrEdiMsgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCstmsAnrEdiMsgVO[]
	 */
	public BkgCstmsAnrEdiMsgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCstmsAnrEdiMsgVO model = null;
		...
		return getBkgCstmsAnrEdiMsgVOs();
	}
	 ...
	 * @return BkgCstmsAnrEdiMsgVO[]
	 */
	public BkgCstmsAnrEdiMsgVO[] getBkgCstmsAnrEdiMsgVOs(){
		BkgCstmsAnrEdiMsgVO[] vos = (BkgCstmsAnrEdiMsgVO[])models.toArray(new BkgCstmsAnrEdiMsgVO[models.size()]);
		return vos;
	}
