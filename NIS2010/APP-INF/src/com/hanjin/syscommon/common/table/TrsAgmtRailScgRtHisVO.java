...
*@FileName : TrsAgmtRailScgRtHisVO.java
*@FileTitle : TrsAgmtRailScgRtHisVO
*Open Issues :
*Change history : 
...
public class TrsAgmtRailScgRtHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TrsAgmtRailScgRtHisVO> models = new ArrayList<TrsAgmtRailScgRtHisVO>();
...
/**
	 ...
	 */
	public TrsAgmtRailScgRtHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TrsAgmtRailScgRtHisVO[]
	 */
	public TrsAgmtRailScgRtHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TrsAgmtRailScgRtHisVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new TrsAgmtRailScgRtHisVO();
				if (toNodCd[i] != null)
		...
		return getTrsAgmtRailScgRtHisVOs();
	}
	...
	public TrsAgmtRailScgRtHisVO[] getTrsAgmtRailScgRtHisVOs(){
		TrsAgmtRailScgRtHisVO[] vos = (TrsAgmtRailScgRtHisVO[])models.toArray(new TrsAgmtRailScgRtHisVO[models.size()]);
		return vos;
	}
