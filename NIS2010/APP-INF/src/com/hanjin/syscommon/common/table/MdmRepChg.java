 ...
 * @since J2EE 1.4
 */
public final class MdmRepChg implements java.io.Serializable {

	private String      ibflag      = "";
	private String      page_rows   = "";
	private String      rep_chg_cd  = "";
	private String      rep_chg_nm  = "";
	...
	public String      getRep_chg_nm (){	return rep_chg_nm 	;	}
	...
	public void setRep_chg_nm ( String      rep_chg_nm  ){	this.rep_chg_nm  = rep_chg_nm 	;	}
	...
	public static MdmRepChg fromRequest(HttpServletRequest request) {
		MdmRepChg model = new MdmRepChg();
		try {
			model.setIbflag     	(JSPUtil.getParameter(request, "ibflag     		".trim(), ""));
			model.setPage_rows  	(JSPUtil.getParameter(request, "page_rows  		".trim(), ""));
			model.setRep_chg_cd 	(JSPUtil.getParameter(request, "rep_chg_cd 		".trim(), ""));
			model.setRep_chg_nm 	(JSPUtil.getParameter(request, "rep_chg_nm 		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				model.setRep_chg_nm 		  (rep_chg_nm 	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] rep_chg_nm  =  (JSPUtil.getParameter(request, prefix + "rep_chg_nm 		".trim(), length));
