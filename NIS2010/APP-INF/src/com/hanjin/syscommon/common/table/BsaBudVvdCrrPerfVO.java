...
*@FileName : BsaBudVvdCrrPerfVO.java
*@FileTitle : BsaBudVvdCrrPerfVO
*Open Issues :
*Change history :
...
public class BsaBudVvdCrrPerfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaBudVvdCrrPerfVO> models = new ArrayList<BsaBudVvdCrrPerfVO>();
	...
	public BsaBudVvdCrrPerfVO() {}

	public BsaBudVvdCrrPerfVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String skdDirCd, String bsaOpJbCd, String crrCd, String crrBsaCapa, String crrPerfAmt, String sltPrcCapa, String creUsrId, String creDt, String updUsrId, String updDt, String crrPerfLoclAmt, String currCd, String usdXchRt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.currCd = currCd;
...
/**
	 ...
	 * @param request
	 * @return BsaBudVvdCrrPerfVO[]
	 */
	public BsaBudVvdCrrPerfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaBudVvdCrrPerfVO[]
	 */
	public BsaBudVvdCrrPerfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaBudVvdCrrPerfVO model = null;
	 ...
	 * @return BsaBudVvdCrrPerfVO[]
	 */
	public BsaBudVvdCrrPerfVO[] getBsaBudVvdCrrPerfVOs(){
		BsaBudVvdCrrPerfVO[] vos = (BsaBudVvdCrrPerfVO[])models.toArray(new BsaBudVvdCrrPerfVO[models.size()]);
		return vos;
	}
