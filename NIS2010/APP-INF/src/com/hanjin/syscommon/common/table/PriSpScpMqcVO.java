...
*@FileName : PriSpScpMqcVO.java
*@FileTitle : PriSpScpMqcVO
*Open Issues :
*Change history :
...
public class PriSpScpMqcVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpMqcVO> models = new ArrayList<PriSpScpMqcVO>();
	...
	public PriSpScpMqcVO() {}

	public PriSpScpMqcVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String cntrLodUtCd, String propScpMqcQty, String coffrMqcQty, String fnlMqcQty, String prcProgStsCd, String srcInfoCd, String n1stCmncAmdtSeq, String n1stCmncDt, String acptUsrId, String acptOfcCd, String acptDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.acptDt = acptDt;
	 ...
	 */
	public PriSpScpMqcVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpMqcVO[]
	 */
	public PriSpScpMqcVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpMqcVO model = null;
	...
	public PriSpScpMqcVO[] getPriSpScpMqcVOs(){
		PriSpScpMqcVO[] vos = (PriSpScpMqcVO[])models.toArray(new PriSpScpMqcVO[models.size()]);
		return vos;
	}
