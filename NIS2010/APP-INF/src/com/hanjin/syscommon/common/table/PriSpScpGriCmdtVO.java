...
*@FileName : PriSpScpGriCmdtVO.java
*@FileTitle : PriSpScpGriCmdtVO
*Open Issues :
*Change history :
...
public class PriSpScpGriCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGriCmdtVO> models = new ArrayList<PriSpScpGriCmdtVO>();
	...
	public PriSpScpGriCmdtVO() {}

	public PriSpScpGriCmdtVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String cmdtSeq, String prcCmdtTpCd, String prcCmdtDefCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriSpScpGriCmdtVO[]
	 */
	public PriSpScpGriCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGriCmdtVO[]
	 */
	public PriSpScpGriCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGriCmdtVO model = null;
	...
	public PriSpScpGriCmdtVO[] getPriSpScpGriCmdtVOs(){
		PriSpScpGriCmdtVO[] vos = (PriSpScpGriCmdtVO[])models.toArray(new PriSpScpGriCmdtVO[models.size()]);
		return vos;
	}
