...
*@FileName : MasVslChrgIfVO.java
*@FileTitle : MasVslChrgIfVO
*Open Issues :
*Change history :
 ...
 */
public class MasVslChrgIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasVslChrgIfVO> models = new ArrayList<MasVslChrgIfVO>();
	...
	public MasVslChrgIfVO() {}

	public MasVslChrgIfVO(String ibflag, String pagerows, String costYrmon, String vslCd, String chrgCtrtNo, String chrgCtrtSeq, String ctrtEffFmDt, String ctrtEffToDt, String n1stHirRt, String n1stCurrCd, String n2ndHirRt, String n2ndCurrCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return MasVslChrgIfVO[]
	 */
	public MasVslChrgIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasVslChrgIfVO[]
	 */
	public MasVslChrgIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasVslChrgIfVO model = null;
	 ...
	 * @return MasVslChrgIfVO[]
	 */
	public MasVslChrgIfVO[] getMasVslChrgIfVOs(){
		MasVslChrgIfVO[] vos = (MasVslChrgIfVO[])models.toArray(new MasVslChrgIfVO[models.size()]);
		return vos;
	}
