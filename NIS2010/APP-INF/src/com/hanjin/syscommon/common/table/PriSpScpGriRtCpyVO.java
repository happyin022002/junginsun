...
*@FileName : PriSpScpGriRtCpyVO.java
*@FileTitle : PriSpScpGriRtCpyVO
*Open Issues :
*Change history :
...
public class PriSpScpGriRtCpyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpGriRtCpyVO> models = new ArrayList<PriSpScpGriRtCpyVO>();
	...
	public PriSpScpGriRtCpyVO() {}

	public PriSpScpGriRtCpyVO(String ibflag, String pagerows, String usrId, String propNo, String amdtSeq, String svcScpCd, String genSpclRtTpCd, String griGrpSeq, String griRtSeq, String ratUtCd, String prcCgoTpCd, String currCd, String griRtAmt, String griRtRto, String creUsrId, String creDt, String updUsrId, String updDt) {
...
/**
	 ...
	 * @param request
	 * @return PriSpScpGriRtCpyVO[]
	 */
	public PriSpScpGriRtCpyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpGriRtCpyVO[]
	 */
	public PriSpScpGriRtCpyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpGriRtCpyVO model = null;
	 ...
	 * @return PriSpScpGriRtCpyVO[]
	 */
	public PriSpScpGriRtCpyVO[] getPriSpScpGriRtCpyVOs(){
		PriSpScpGriRtCpyVO[] vos = (PriSpScpGriRtCpyVO[])models.toArray(new PriSpScpGriRtCpyVO[models.size()]);
		return vos;
	}
