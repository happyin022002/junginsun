...
*@FileName : PriSpScpScgAdjVO.java
*@FileTitle : PriSpScpScgAdjVO
*Open Issues :
*Change history :
...
public class PriSpScpScgAdjVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpScgAdjVO> models = new ArrayList<PriSpScpScgAdjVO>();
	 ...
	 */
	public PriSpScpScgAdjVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpScgAdjVO[]
	 */
	public PriSpScpScgAdjVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpScgAdjVO model = null;
	...
	public PriSpScpScgAdjVO[] getPriSpScpScgAdjVOs(){
		PriSpScpScgAdjVO[] vos = (PriSpScpScgAdjVO[])models.toArray(new PriSpScpScgAdjVO[models.size()]);
		return vos;
	}
