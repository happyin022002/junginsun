...
*@FileName : VskCustEdiBlckVO.java
*@FileTitle : VskCustEdiBlckVO
*Open Issues :
*Change history :
...
public class VskCustEdiBlckVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VskCustEdiBlckVO> models = new ArrayList<VskCustEdiBlckVO>();
	...
	public VskCustEdiBlckVO() {}

	public VskCustEdiBlckVO(String ibflag, String pagerows, String routRcvDt, String routSeq, String blckSeq, String slanCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public VskCustEdiBlckVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VskCustEdiBlckVO[]
	 */
	public VskCustEdiBlckVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VskCustEdiBlckVO model = null;
	...
	public VskCustEdiBlckVO[] getVskCustEdiBlckVOs(){
		VskCustEdiBlckVO[] vos = (VskCustEdiBlckVO[])models.toArray(new VskCustEdiBlckVO[models.size()]);
		return vos;
	}
