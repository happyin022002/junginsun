...
public class TesTmlAgmtVrfyMzdVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		setTmlDcgoAplyFlg(JSPUtil.getParameter(request, "tml_dcgo_aply_flg", ""));
		setTmlLaneFlg(JSPUtil.getParameter(request, "tml_lane_flg", ""));
		setTmlIoBndFlg(JSPUtil.getParameter(request, "tml_io_bnd_flg", ""));
		setStoFpCalcPrdFlg(JSPUtil.getParameter(request, "sto_fp_calc_prd_flg", ""));
		setStoFreeDyTrDyFlg(JSPUtil.getParameter(request, "sto_free_dy_tr_dy_flg", ""));
		setRtTeuFlg(JSPUtil.getParameter(request, "rt_teu_flg", ""));
		setTmlThrpCostCdFlg(JSPUtil.getParameter(request, "tml_thrp_cost_cd_flg", ""));
		setCreDt(JSPUtil.getParameter(request, "cre_dt", ""));
		setStoFreeDyIoBndFlg(JSPUtil.getParameter(request, "sto_free_dy_io_bnd_flg", ""));
		setStoFreeDyDcgoRtFlg(JSPUtil.getParameter(request, "sto_free_dy_dcgo_rt_flg", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setFreeDyCntrTpszFlg(JSPUtil.getParameter(request, "free_dy_cntr_tpsz_flg", ""));
		setStoFreeDyXcldDtFlg(JSPUtil.getParameter(request, "sto_free_dy_xcld_dt_flg", ""));
		setTmlAplyDtFlg(JSPUtil.getParameter(request, "tml_aply_dt_flg", ""));
		setRtMvFlg(JSPUtil.getParameter(request, "rt_mv_flg", ""));
		setTmlTrnsModFlg(JSPUtil.getParameter(request, "tml_trns_mod_flg", ""));
		setUpdUsrId(JSPUtil.getParameter(request, "upd_usr_id", ""));
		setUpdDt(JSPUtil.getParameter(request, "upd_dt", ""));
		setRtBxFlg(JSPUtil.getParameter(request, "rt_bx_flg", ""));
		setStoComAgmtTpFlg(JSPUtil.getParameter(request, "sto_com_agmt_tp_flg", ""));
		setStoFreeDyFlg(JSPUtil.getParameter(request, "sto_free_dy_flg", ""));
		setTmlIocFlg(JSPUtil.getParameter(request, "tml_ioc_flg", ""));
		setTmlOvtShftFlg(JSPUtil.getParameter(request, "tml_ovt_shft_flg", ""));
		setStoFreeDyDcgoTmFlg(JSPUtil.getParameter(request, "sto_free_dy_dcgo_tm_flg", ""));
		setTmlThcFlg(JSPUtil.getParameter(request, "tml_thc_flg", ""));
		setRtCntrTpszFlg(JSPUtil.getParameter(request, "rt_cntr_tpsz_flg", ""));
		setCreUsrId(JSPUtil.getParameter(request, "cre_usr_id", ""));
		setStoFpTeuFlg(JSPUtil.getParameter(request, "sto_fp_teu_flg", ""));
		setTmlAgmtDivFlg(JSPUtil.getParameter(request, "tml_agmt_div_flg", ""));
		setLgsCostCd(JSPUtil.getParameter(request, "lgs_cost_cd", ""));
		setComAutoCalcFlg(JSPUtil.getParameter(request, "com_auto_calc_flg", ""));
		setTmlTrVolFlg(JSPUtil.getParameter(request, "tml_tr_vol_flg", ""));
		setStoComCmncTmFlg(JSPUtil.getParameter(request, "sto_com_cmnc_tm_flg", ""));
	}
