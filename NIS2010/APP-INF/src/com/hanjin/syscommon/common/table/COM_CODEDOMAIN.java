 ...
 * @since J2EE 1.4
 */
public final class COM_CODEDOMAIN implements java.io.Serializable {
	...
	public static COM_CODEDOMAIN fromRequest(HttpServletRequest request) {
		COM_CODEDOMAIN model = new COM_CODEDOMAIN();
		try {
