...
*@FileName : EqrVslPlnCodQtyVO.java
*@FileTitle : EqrVslPlnCodQtyVO
*Open Issues :
*Change history :
...
public class EqrVslPlnCodQtyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrVslPlnCodQtyVO> models = new ArrayList<EqrVslPlnCodQtyVO>();
	...
	public EqrVslPlnCodQtyVO() {}

	public EqrVslPlnCodQtyVO(String ibflag, String pagerows, String repoPlnId, String plnYrwk, String plnSeq, String cntrTpszCd, String cntrQty, String lodgDchgCostAmt, String creUsrId, String creDt, String updUsrId, String updDt, String prePlnCntrQty, String codSimFlg, String codDchgPlnFlg, String prePlnDchgLocCd) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return EqrVslPlnCodQtyVO[]
	 */
	public EqrVslPlnCodQtyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrVslPlnCodQtyVO[]
	 */
	public EqrVslPlnCodQtyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrVslPlnCodQtyVO model = null;
	...
	public EqrVslPlnCodQtyVO[] getEqrVslPlnCodQtyVOs(){
		EqrVslPlnCodQtyVO[] vos = (EqrVslPlnCodQtyVO[])models.toArray(new EqrVslPlnCodQtyVO[models.size()]);
		return vos;
	}
