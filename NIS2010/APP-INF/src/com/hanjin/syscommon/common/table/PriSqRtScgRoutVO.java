...
*@FileName : PriSqRtScgRoutVO.java
*@FileTitle : PriSqRtScgRoutVO
*Open Issues :
*Change history :
...
public class PriSqRtScgRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqRtScgRoutVO> models = new ArrayList<PriSqRtScgRoutVO>();
	...
	public PriSqRtScgRoutVO() {}

	public PriSqRtScgRoutVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String genSpclRtTpCd, String cmdtHdrSeq, String routSeq, String rtSeq, String porCd, String polCd, String podCd, String delCd, String rcvTermCd, String deTermCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.porCd = porCd;
	 ...
	 * @param request
	 * @return PriSqRtScgRoutVO[]
	 */
	public PriSqRtScgRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqRtScgRoutVO[]
	 */
	public PriSqRtScgRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqRtScgRoutVO model = null;
	 ...
	 * @return PriSqRtScgRoutVO[]
	 */
	public PriSqRtScgRoutVO[] getPriSqRtScgRoutVOs(){
		PriSqRtScgRoutVO[] vos = (PriSqRtScgRoutVO[])models.toArray(new PriSqRtScgRoutVO[models.size()]);
		return vos;
	}
