...
*@FileName : MasOfcRoutMapgBkupVO.java
*@FileTitle : MasOfcRoutMapgBkupVO
*Open Issues :
*Change history :
 ...
 */
public class MasOfcRoutMapgBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasOfcRoutMapgBkupVO> models = new ArrayList<MasOfcRoutMapgBkupVO>();
	...
	public MasOfcRoutMapgBkupVO() {}

	public MasOfcRoutMapgBkupVO(String ibflag, String pagerows, String ofcClssCd, String slsActCd, String divMeasCd, String slsOfcClssNm, String slsActDesc, String divMeasNm, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasOfcRoutMapgBkupVO[]
	 */
	public MasOfcRoutMapgBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasOfcRoutMapgBkupVO[]
	 */
	public MasOfcRoutMapgBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasOfcRoutMapgBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasOfcRoutMapgBkupVO();
				if (updDt[i] != null)
		...
		return getMasOfcRoutMapgBkupVOs();
	}
	 ...
	 * @return MasOfcRoutMapgBkupVO[]
	 */
	public MasOfcRoutMapgBkupVO[] getMasOfcRoutMapgBkupVOs(){
		MasOfcRoutMapgBkupVO[] vos = (MasOfcRoutMapgBkupVO[])models.toArray(new MasOfcRoutMapgBkupVO[models.size()]);
		return vos;
	}
