...
*@FileName : BkgIdaSacMstVO.java
*@FileTitle : BkgIdaSacMstVO
*Open Issues :
*Change history :
...
public class BkgIdaSacMstVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgIdaSacMstVO> models = new ArrayList<BkgIdaSacMstVO>();
	...
	/* 인도 SAC 타입( STR: START(시작점), SCT : SECTION, HDG:HEADING, GRP:GROUP, SAC : SAC   ) */
	...
	public BkgIdaSacMstVO() {}

	public BkgIdaSacMstVO(String ibflag, String pagerows, String idaSacCd, String idaSacNm, String idaSacTpCd, String prntIdaSacCd, String deltFlg, String creDt, String creUsrId, String updDt, String updUsrId, String idaGstRto, String idaCgstRto, String idaSgstRto, String idaIgstRto, String idaUgstRto) {
...
/**
	 ...
	 */
	public BkgIdaSacMstVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgIdaSacMstVO[]
	 */
	public BkgIdaSacMstVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgIdaSacMstVO model = null;
	...
	public BkgIdaSacMstVO[] getBkgIdaSacMstVOs(){
		BkgIdaSacMstVO[] vos = (BkgIdaSacMstVO[])models.toArray(new BkgIdaSacMstVO[models.size()]);
		return vos;
	}
