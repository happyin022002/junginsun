...
*@FileName : CoaSsnlSltMgmtUtVO.java
*@FileTitle : CoaSsnlSltMgmtUtVO
*Open Issues :
*Change history :
...
public class CoaSsnlSltMgmtUtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaSsnlSltMgmtUtVO> models = new ArrayList<CoaSsnlSltMgmtUtVO>();
	...
	public CoaSsnlSltMgmtUtVO() {}

	public CoaSsnlSltMgmtUtVO(String ibflag, String pagerows, String costYrmon, String trdCd, String rlaneCd, String vslSlanDirCd, String subTrdCd, String vopVarFxAmt, String cmCostAmt, String lodQty, String plcyPrcUtAmt, String ssnlDiffAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public CoaSsnlSltMgmtUtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaSsnlSltMgmtUtVO[]
	 */
	public CoaSsnlSltMgmtUtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaSsnlSltMgmtUtVO model = null;
	...
	public CoaSsnlSltMgmtUtVO[] getCoaSsnlSltMgmtUtVOs(){
		CoaSsnlSltMgmtUtVO[] vos = (CoaSsnlSltMgmtUtVO[])models.toArray(new CoaSsnlSltMgmtUtVO[models.size()]);
		return vos;
	}
