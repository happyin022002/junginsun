 ...
 * @author Hyung Choon
 * @since J2EE 1.4
 */public final class PRD_NOD implements java.io.Serializable {
    ...
    public static PRD_NOD fromRequest(HttpServletRequest request) {
        PRD_NOD model = new PRD_NOD();
        try {
