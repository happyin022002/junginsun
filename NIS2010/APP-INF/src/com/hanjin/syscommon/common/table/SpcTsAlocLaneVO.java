...
*@FileName : SpcTsAlocLaneVO.java
*@FileTitle : SpcTsAlocLaneVO
*Open Issues :
*Change history :
...
public class SpcTsAlocLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpcTsAlocLaneVO> models = new ArrayList<SpcTsAlocLaneVO>();
	...
	public SpcTsAlocLaneVO() {}

	public SpcTsAlocLaneVO(String ibflag, String pagerows, String bseYr, String bseMon, String rlaneCd, String dirCd, String slsRhqCd, String repTrdCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.bseMon = bseMon;
	 ...
	 * @param request
	 * @return SpcTsAlocLaneVO[]
	 */
	public SpcTsAlocLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpcTsAlocLaneVO[]
	 */
	public SpcTsAlocLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpcTsAlocLaneVO model = null;
	 ...
	 * @return SpcTsAlocLaneVO[]
	 */
	public SpcTsAlocLaneVO[] getSpcTsAlocLaneVOs(){
		SpcTsAlocLaneVO[] vos = (SpcTsAlocLaneVO[])models.toArray(new SpcTsAlocLaneVO[models.size()]);
		return vos;
	}
