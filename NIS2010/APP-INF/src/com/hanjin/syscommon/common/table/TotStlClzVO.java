...
*@FileName : TotStlClzVO.java
*@FileTitle : TotStlClzVO
*Open Issues :
*Change history :
...
public class TotStlClzVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TotStlClzVO> models = new ArrayList<TotStlClzVO>();
	...
	public TotStlClzVO(String ibflag, String pagerows, String stlYr, String stlClzFlg, String creDt, String creUsrId, String updDt, String updUsrId) {
		this.updDt = updDt;
		this.stlYr = stlYr;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setStlClzFlg(JSPUtil.getParameter(request, "stl_clz_flg", ""));
	 ...
	 * @return TotStlClzVO[]
	 */
	public TotStlClzVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TotStlClzVO[]
	 */
	public TotStlClzVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TotStlClzVO model = null;
		...
		try {
			...
			String[] stlClzFlg = (JSPUtil.getParameter(request, prefix	+ "stl_clz_flg".trim(), length));
			String[] creDt = (JSPUtil.getParameter(request, prefix	+ "cre_dt".trim(), length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id".trim(), length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows".trim(), length));
			
			for (int i = 0; i < length; i++) {
				model = new TotStlClzVO();
				if (updDt[i] != null)
	...
	public TotStlClzVO[] getTotStlClzVOs(){
		TotStlClzVO[] vos = (TotStlClzVO[])models.toArray(new TotStlClzVO[models.size()]);
		return vos;
	}
