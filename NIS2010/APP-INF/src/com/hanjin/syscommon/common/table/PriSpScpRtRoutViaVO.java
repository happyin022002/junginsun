...
*@FileName : PriSpScpRtRoutViaVO.java
*@FileTitle : PriSpScpRtRoutViaVO
*Open Issues :
*Change history :
...
public class PriSpScpRtRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRtRoutViaVO> models = new ArrayList<PriSpScpRtRoutViaVO>();
	 ...
	 * @param request
	 * @return PriSpScpRtRoutViaVO[]
	 */
	public PriSpScpRtRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRtRoutViaVO[]
	 */
	public PriSpScpRtRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRtRoutViaVO model = null;
		...
		return getPriSpScpRtRoutViaVOs();
	}
	 ...
	 * @return PriSpScpRtRoutViaVO[]
	 */
	public PriSpScpRtRoutViaVO[] getPriSpScpRtRoutViaVOs(){
		PriSpScpRtRoutViaVO[] vos = (PriSpScpRtRoutViaVO[])models.toArray(new PriSpScpRtRoutViaVO[models.size()]);
		return vos;
	}
