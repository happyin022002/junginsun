...
*@FileName : BkgCoffTmVO.java
*@FileTitle : BkgCoffTmVO
*Open Issues :
*Change history :
...
public class BkgCoffTmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgCoffTmVO> models = new ArrayList<BkgCoffTmVO>();
	...
	public BkgCoffTmVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String polCd, String clptIndSeq, String bkgOfcCd, String bkgClzStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 * @return BkgCoffTmVO[]
	 */
	public BkgCoffTmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgCoffTmVO[]
	 */
	public BkgCoffTmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgCoffTmVO model = null;
	...
	public BkgCoffTmVO[] getBkgCoffTmVOs(){
		BkgCoffTmVO[] vos = (BkgCoffTmVO[])models.toArray(new BkgCoffTmVO[models.size()]);
		return vos;
	}
