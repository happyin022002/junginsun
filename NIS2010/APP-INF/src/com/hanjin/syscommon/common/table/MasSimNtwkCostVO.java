...
*@FileName : MasSimNtwkCostVO.java
*@FileTitle : MasSimNtwkCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimNtwkCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimNtwkCostVO> models = new ArrayList<MasSimNtwkCostVO>();
	...
	public MasSimNtwkCostVO() {}

	public MasSimNtwkCostVO(String ibflag, String pagerows, String simDt, String simNo, String sectNo, String vslCd, String tmlCd, String vslDblCallSeq, String sgrpCostCd, String vopCd, String vslClssCapa, String ntwkCostAmt, String aftOcnTrnsCostAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
	 ...
	 * @param request
	 * @return MasSimNtwkCostVO[]
	 */
	public MasSimNtwkCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimNtwkCostVO[]
	 */
	public MasSimNtwkCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimNtwkCostVO model = null;
	 ...
	 * @return MasSimNtwkCostVO[]
	 */
	public MasSimNtwkCostVO[] getMasSimNtwkCostVOs(){
		MasSimNtwkCostVO[] vos = (MasSimNtwkCostVO[])models.toArray(new MasSimNtwkCostVO[models.size()]);
		return vos;
	}
