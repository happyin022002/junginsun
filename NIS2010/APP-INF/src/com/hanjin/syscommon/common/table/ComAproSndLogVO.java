...
public class ComAproSndLogVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComAproSndLogVO> models = new ArrayList<ComAproSndLogVO>();
...
/**
	 ...
	 */
	public ComAproSndLogVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComAproSndLogVO[]
	 */
	public ComAproSndLogVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComAproSndLogVO model = null;
	 ...
	 * @return ComAproSndLogVO[]
	 */
	public ComAproSndLogVO[] getComAproSndLogVOs(){
		ComAproSndLogVO[] vos = (ComAproSndLogVO[])models.toArray(new ComAproSndLogVO[models.size()]);
		return vos;
	}
