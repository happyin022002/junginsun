...
public class PriRqMnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqMnVO> models = new ArrayList<PriRqMnVO>();
	 ...
	 * @return PriRqMnVO[]
	 */
	public PriRqMnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqMnVO[]
	 */
	public PriRqMnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqMnVO model = null;
	 ...
	 * @return PriRqMnVO[]
	 */
	public PriRqMnVO[] getPriRqMnVOs(){
		PriRqMnVO[] vos = (PriRqMnVO[])models.toArray(new PriRqMnVO[models.size()]);
		return vos;
	}
