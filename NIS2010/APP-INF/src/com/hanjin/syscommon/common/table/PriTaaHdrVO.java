...
*@FileName : PriTaaHdrVO.java
*@FileTitle : PriTaaHdrVO
*Open Issues :
*Change history :
...
public class PriTaaHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriTaaHdrVO> models = new ArrayList<PriTaaHdrVO>();
	...
	public PriTaaHdrVO(String ibflag, String pagerows, String taaPropNo, String taaNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return PriTaaHdrVO[]
	 */
	public PriTaaHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriTaaHdrVO[]
	 */
	public PriTaaHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriTaaHdrVO model = null;
	 ...
	 * @return PriTaaHdrVO[]
	 */
	public PriTaaHdrVO[] getPriTaaHdrVOs(){
		PriTaaHdrVO[] vos = (PriTaaHdrVO[])models.toArray(new PriTaaHdrVO[models.size()]);
		return vos;
	}
