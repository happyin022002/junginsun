...
*@FileName : MasSvcTrnsPrcPfitLssVO.java
*@FileTitle : MasSvcTrnsPrcPfitLssVO
*Open Issues :
*Change history :
 ...
 */
public class MasSvcTrnsPrcPfitLssVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSvcTrnsPrcPfitLssVO> models = new ArrayList<MasSvcTrnsPrcPfitLssVO>();
	 ...
	 * @param request
	 * @return MasSvcTrnsPrcPfitLssVO[]
	 */
	public MasSvcTrnsPrcPfitLssVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSvcTrnsPrcPfitLssVO[]
	 */
	public MasSvcTrnsPrcPfitLssVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSvcTrnsPrcPfitLssVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasSvcTrnsPrcPfitLssVO();
				if (updDt[i] != null)
		...
		return getMasSvcTrnsPrcPfitLssVOs();
	}
	 ...
	 * @return MasSvcTrnsPrcPfitLssVO[]
	 */
	public MasSvcTrnsPrcPfitLssVO[] getMasSvcTrnsPrcPfitLssVOs(){
		MasSvcTrnsPrcPfitLssVO[] vos = (MasSvcTrnsPrcPfitLssVO[])models.toArray(new MasSvcTrnsPrcPfitLssVO[models.size()]);
		return vos;
	}
