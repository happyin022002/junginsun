...
*@FileName : MasSimTmlInfoVO.java
*@FileTitle : MasSimTmlInfoVO
*Open Issues :
*Change history :
 ...
 */
public class MasSimTmlInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasSimTmlInfoVO> models = new ArrayList<MasSimTmlInfoVO>();
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setBzcVslSpd(JSPUtil.getParameter(request, "vsl_slan_cd", ""));
		setBzcVslSpd(JSPUtil.getParameter(request, "port_cd", ""));
	 ...
	 */
	public MasSimTmlInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasSimTmlInfoVO[]
	 */
	public MasSimTmlInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasSimTmlInfoVO model = null;
	...
	public MasSimTmlInfoVO[] getMasSimTmlInfoVOs(){
		MasSimTmlInfoVO[] vos = (MasSimTmlInfoVO[])models.toArray(new MasSimTmlInfoVO[models.size()]);
		return vos;
	}
