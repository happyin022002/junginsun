...
*@FileName : PriRqRtRoutViaVO.java
*@FileTitle : PriRqRtRoutViaVO
*Open Issues :
*Change history :
...
public class PriRqRtRoutViaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRqRtRoutViaVO> models = new ArrayList<PriRqRtRoutViaVO>();
	...
	public PriRqRtRoutViaVO() {}

	public PriRqRtRoutViaVO(String ibflag, String pagerows, String qttnNo, String qttnVerNo, String cmdtHdrSeq, String routSeq, String orgDestTpCd, String routViaSeq, String routViaPortTpCd, String routViaPortDefCd, String srcInfoCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRqRtRoutViaVO[]
	 */
	public PriRqRtRoutViaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRqRtRoutViaVO[]
	 */
	public PriRqRtRoutViaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRqRtRoutViaVO model = null;
	 ...
	 * @return PriRqRtRoutViaVO[]
	 */
	public PriRqRtRoutViaVO[] getPriRqRtRoutViaVOs(){
		PriRqRtRoutViaVO[] vos = (PriRqRtRoutViaVO[])models.toArray(new PriRqRtRoutViaVO[models.size()]);
		return vos;
	}
