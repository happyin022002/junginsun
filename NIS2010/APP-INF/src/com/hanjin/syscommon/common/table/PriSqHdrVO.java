...
*@FileName : PriSqHdrVO.java
*@FileTitle : PriSqHdrVO
*Open Issues :
*Change history :
...
public class PriSqHdrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSqHdrVO> models = new ArrayList<PriSqHdrVO>();
	...
	public PriSqHdrVO(String ibflag, String pagerows, String qttnNo, String qttnOfcCd, String qttnStsCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return PriSqHdrVO[]
	 */
	public PriSqHdrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSqHdrVO[]
	 */
	public PriSqHdrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSqHdrVO model = null;
	 ...
	 * @return PriSqHdrVO[]
	 */
	public PriSqHdrVO[] getPriSqHdrVOs(){
		PriSqHdrVO[] vos = (PriSqHdrVO[])models.toArray(new PriSqHdrVO[models.size()]);
		return vos;
	}
