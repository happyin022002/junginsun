...
*@FileName : PriSgRtRoutPntVO.java
*@FileTitle : PriSgRtRoutPntVO
*Open Issues :
*Change history :
...
public class PriSgRtRoutPntVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSgRtRoutPntVO> models = new ArrayList<PriSgRtRoutPntVO>();
	...
	public PriSgRtRoutPntVO[] fromRequestGrid(HttpServletRequest request) {
		return fromRequestGrid(request, "");
	}

	public PriSgRtRoutPntVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSgRtRoutPntVO model = null;
		...
		return getPriSgRtRoutPntVOs();
	}

	public PriSgRtRoutPntVO[] getPriSgRtRoutPntVOs(){
		PriSgRtRoutPntVO[] vos = (PriSgRtRoutPntVO[])models.toArray(new PriSgRtRoutPntVO[models.size()]);
		return vos;
	}
