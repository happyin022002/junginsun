...
*@FileName : TrsDmstLstCtyVO.java
*@FileTitle : TrsDmstLstCtyVO
*Open Issues :
*Change history :
...
public class TrsDmstLstCtyVO extends AbstractValueObject {
	...
	public TrsDmstLstCtyVO(String ibflag, String pagerows, String orgLocCd, String destLocCd, String lstLocCd, String creOfcCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setLstLocCd(JSPUtil.getParameter(request, "lst_loc_cd", ""));
