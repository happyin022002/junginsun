...
*@FileName : MasFxAmtDtrbVO.java
*@FileTitle : MasFxAmtDtrbVO
*Open Issues :
*Change history :
 ...
 */
public class MasFxAmtDtrbVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasFxAmtDtrbVO> models = new ArrayList<MasFxAmtDtrbVO>();
	 ...
	 * @param request
	 * @return MasFxAmtDtrbVO[]
	 */
	public MasFxAmtDtrbVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasFxAmtDtrbVO[]
	 */
	public MasFxAmtDtrbVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasFxAmtDtrbVO model = null;
	 ...
	 * @return MasFxAmtDtrbVO[]
	 */
	public MasFxAmtDtrbVO[] getMasFxAmtDtrbVOs(){
		MasFxAmtDtrbVO[] vos = (MasFxAmtDtrbVO[])models.toArray(new MasFxAmtDtrbVO[models.size()]);
		return vos;
	}
