...
*@FileName : MasRoutDysIfMgmtBkupVO.java
*@FileTitle : MasRoutDysIfMgmtBkupVO
*Open Issues :
*Change history :
 ...
 */
public class MasRoutDysIfMgmtBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasRoutDysIfMgmtBkupVO> models = new ArrayList<MasRoutDysIfMgmtBkupVO>();
	...
	public MasRoutDysIfMgmtBkupVO() {}

	public MasRoutDysIfMgmtBkupVO(String ibflag, String pagerows, String costYr, String costLocGrpCd, String cntrTpszCd, String orgLocCd, String destLocCd, String eqDys, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasRoutDysIfMgmtBkupVO[]
	 */
	public MasRoutDysIfMgmtBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasRoutDysIfMgmtBkupVO[]
	 */
	public MasRoutDysIfMgmtBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasRoutDysIfMgmtBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasRoutDysIfMgmtBkupVO();
				if (updDt[i] != null)
		...
		return getMasRoutDysIfMgmtBkupVOs();
	}
	 ...
	 * @return MasRoutDysIfMgmtBkupVO[]
	 */
	public MasRoutDysIfMgmtBkupVO[] getMasRoutDysIfMgmtBkupVOs(){
		MasRoutDysIfMgmtBkupVO[] vos = (MasRoutDysIfMgmtBkupVO[])models.toArray(new MasRoutDysIfMgmtBkupVO[models.size()]);
		return vos;
	}
