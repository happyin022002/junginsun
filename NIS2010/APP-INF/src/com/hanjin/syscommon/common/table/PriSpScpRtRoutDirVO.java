...
*@FileName : PriSpScpRtRoutDirVO.java
*@FileTitle : PriSpScpRtRoutDirVO
*Open Issues :
*Change history :
...
public class PriSpScpRtRoutDirVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRtRoutDirVO> models = new ArrayList<PriSpScpRtRoutDirVO>();
	 ...
	 */
	public PriSpScpRtRoutDirVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRtRoutDirVO[]
	 */
	public PriSpScpRtRoutDirVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRtRoutDirVO model = null;
		...
		return getPriSpScpRtRoutDirVOs();
	}
	...
	public PriSpScpRtRoutDirVO[] getPriSpScpRtRoutDirVOs(){
		PriSpScpRtRoutDirVO[] vos = (PriSpScpRtRoutDirVO[])models.toArray(new PriSpScpRtRoutDirVO[models.size()]);
		return vos;
	}
