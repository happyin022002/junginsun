...
*@FileName : PriSpScpRtCmdtVO.java
*@FileTitle : PriSpScpRtCmdtVO
*Open Issues :
*Change history :
...
public class PriSpScpRtCmdtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRtCmdtVO> models = new ArrayList<PriSpScpRtCmdtVO>();
	 ...
	 * @param request
	 * @return PriSpScpRtCmdtVO[]
	 */
	public PriSpScpRtCmdtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRtCmdtVO[]
	 */
	public PriSpScpRtCmdtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRtCmdtVO model = null;
	...
	public PriSpScpRtCmdtVO[] getPriSpScpRtCmdtVOs(){
		PriSpScpRtCmdtVO[] vos = (PriSpScpRtCmdtVO[])models.toArray(new PriSpScpRtCmdtVO[models.size()]);
		return vos;
	}
