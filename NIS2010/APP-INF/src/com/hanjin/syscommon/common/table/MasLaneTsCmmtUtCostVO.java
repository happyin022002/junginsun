...
*@FileName : MasLaneTsCmmtUtCostVO.java
*@FileTitle : MasLaneTsCmmtUtCostVO
*Open Issues :
*Change history :
 ...
 */
public class MasLaneTsCmmtUtCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasLaneTsCmmtUtCostVO> models = new ArrayList<MasLaneTsCmmtUtCostVO>();
	...
	public MasLaneTsCmmtUtCostVO() {}

	public MasLaneTsCmmtUtCostVO(String ibflag, String pagerows, String costYrmon, String trdCd, String iocCd, String rlaneCd, String dirCd, String tsAmt, String hjsBsaBfrSubCapa, String tsUcAmt, String costCalcRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.iocCd = iocCd;
		this.creDt = creDt;
		this.trdCd = trdCd;
	 ...
	 * @param request
	 * @return MasLaneTsCmmtUtCostVO[]
	 */
	public MasLaneTsCmmtUtCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasLaneTsCmmtUtCostVO[]
	 */
	public MasLaneTsCmmtUtCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasLaneTsCmmtUtCostVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasLaneTsCmmtUtCostVO();
				if (updDt[i] != null)
		...
		return getMasLaneTsCmmtUtCostVOs();
	}
	 ...
	 * @return MasLaneTsCmmtUtCostVO[]
	 */
	public MasLaneTsCmmtUtCostVO[] getMasLaneTsCmmtUtCostVOs(){
		MasLaneTsCmmtUtCostVO[] vos = (MasLaneTsCmmtUtCostVO[])models.toArray(new MasLaneTsCmmtUtCostVO[models.size()]);
		return vos;
	}
