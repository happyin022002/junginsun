...
public class BkgBlDocVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		setBdrCxlDt(JSPUtil.getParameter(request, "bdr_cxl_dt", ""));
		setBdrCxlUsrId(JSPUtil.getParameter(request, "bdr_cxl_usr_id", ""));
		setBdrRsnRmk(JSPUtil.getParameter(request, "bdr_rsn_rmk", ""));
		setBdrRsnCd(JSPUtil.getParameter(request, "bdr_rsn_cd", ""));
