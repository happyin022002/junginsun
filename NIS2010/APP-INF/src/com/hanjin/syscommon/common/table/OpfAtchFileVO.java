...
*@FileName : OpfAtchFileVO.java
*@FileTitle : OpfAtchFileVO
*Open Issues :
*Change history :
...
public class OpfAtchFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OpfAtchFileVO> models = new ArrayList<OpfAtchFileVO>();
	...
	public OpfAtchFileVO() {}

	public OpfAtchFileVO(String ibflag, String pagerows, String atchFileLnkId, String atchFileLnkSeq, String fileSavId, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public OpfAtchFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OpfAtchFileVO[]
	 */
	public OpfAtchFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OpfAtchFileVO model = null;
	...
	public OpfAtchFileVO[] getOpfAtchFileVOs(){
		OpfAtchFileVO[] vos = (OpfAtchFileVO[])models.toArray(new OpfAtchFileVO[models.size()]);
		return vos;
	}
