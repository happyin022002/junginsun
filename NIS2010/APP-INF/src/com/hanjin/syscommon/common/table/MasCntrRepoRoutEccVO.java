...
*@FileName : MasCntrRepoRoutEccVO.java
*@FileTitle : MasCntrRepoRoutEccVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoRoutEccVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoRoutEccVO> models = new ArrayList<MasCntrRepoRoutEccVO>();
	...
	public MasCntrRepoRoutEccVO() {}

	public MasCntrRepoRoutEccVO(String ibflag, String pagerows, String costYrmon, String rccCd, String eccCd, String cntrTpszCd, String spclCgoRfFlg, String porRepoFlg, String delRepoFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
	 ...
	 */
	public MasCntrRepoRoutEccVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoRoutEccVO[]
	 */
	public MasCntrRepoRoutEccVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoRoutEccVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasCntrRepoRoutEccVO();
		...
		return getMasCntrRepoRoutEccVOs();
	}
	...
	public MasCntrRepoRoutEccVO[] getMasCntrRepoRoutEccVOs(){
		MasCntrRepoRoutEccVO[] vos = (MasCntrRepoRoutEccVO[])models.toArray(new MasCntrRepoRoutEccVO[models.size()]);
		return vos;
	}
