...
*@FileName : MasOtrCommVO.java
*@FileTitle : MasOtrCommVO
*Open Issues :
*Change history :
 ...
 */
public class MasOtrCommVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasOtrCommVO> models = new ArrayList<MasOtrCommVO>();
	...
	public MasOtrCommVO(String ibflag, String pagerows, String costYrmon, String cntrTpszCd, String commLocCd, String masCostSrcCd, String stndCostUsdAmt, String bkgTtlQty, String otrCommTtlAmt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @return MasOtrCommVO[]
	 */
	public MasOtrCommVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasOtrCommVO[]
	 */
	public MasOtrCommVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasOtrCommVO model = null;
	...
	public MasOtrCommVO[] getMasOtrCommVOs(){
		MasOtrCommVO[] vos = (MasOtrCommVO[])models.toArray(new MasOtrCommVO[models.size()]);
		return vos;
	}
