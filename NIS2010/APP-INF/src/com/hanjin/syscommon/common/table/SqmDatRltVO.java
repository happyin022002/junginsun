...
*@FileName : SqmDatRltVO.java
*@FileTitle : SqmDatRltVO
*Open Issues :
*Change history :
...
public class SqmDatRltVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmDatRltVO> models = new ArrayList<SqmDatRltVO>();
	...
	public SqmDatRltVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String ofcVwCd, String trdCd, String rlaneCd, String convDirCd, String rhqCd, String teamCd, String obDivCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return SqmDatRltVO[]
	 */
	public SqmDatRltVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmDatRltVO[]
	 */
	public SqmDatRltVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmDatRltVO model = null;
	...
	public SqmDatRltVO[] getSqmDatRltVOs(){
		SqmDatRltVO[] vos = (SqmDatRltVO[])models.toArray(new SqmDatRltVO[models.size()]);
		return vos;
	}
