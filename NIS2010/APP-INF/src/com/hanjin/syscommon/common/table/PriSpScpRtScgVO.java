...
*@FileName : PriSpScpRtScgVO.java
*@FileTitle : PriSpScpRtScgVO
*Open Issues :
*Change history :
...
public class PriSpScpRtScgVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriSpScpRtScgVO> models = new ArrayList<PriSpScpRtScgVO>();
	 ...
	 */
	public PriSpScpRtScgVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriSpScpRtScgVO[]
	 */
	public PriSpScpRtScgVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriSpScpRtScgVO model = null;
	...
	public PriSpScpRtScgVO[] getPriSpScpRtScgVOs(){
		PriSpScpRtScgVO[] vos = (PriSpScpRtScgVO[])models.toArray(new PriSpScpRtScgVO[models.size()]);
		return vos;
	}
