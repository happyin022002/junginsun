...
*@FileName : SpcDlyFcastRoutVO.java
*@FileTitle : SpcDlyFcastRoutVO
*Open Issues :
*Change history :
...
public class SpcDlyFcastRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpcDlyFcastRoutVO> models = new ArrayList<SpcDlyFcastRoutVO>();
	...
	public SpcDlyFcastRoutVO() {}

	public SpcDlyFcastRoutVO(String ibflag, String pagerows, String slsFcastNo, String tsSeq, String vslPrePstCd, String rlaneCd, String dirCd, String vslCd, String skdVoyNo, String skdDirCd, String polYdCd, String podYdCd, String repTrdCd, String repSubTrdCd, String trdCd, String subTrdCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
		this.trdCd = trdCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("ts_seq", getTsSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("ts_seq", "tsSeq");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTsSeq(JSPUtil.getParameter(request, "ts_seq", ""));
	 ...
	 * @param request
	 * @return SpcDlyFcastRoutVO[]
	 */
	public SpcDlyFcastRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpcDlyFcastRoutVO[]
	 */
	public SpcDlyFcastRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpcDlyFcastRoutVO model = null;
		...
		try {
			...
			String[] tsSeq = (JSPUtil.getParameter(request, prefix	+ "ts_seq", length));
	 ...
	 * @return SpcDlyFcastRoutVO[]
	 */
	public SpcDlyFcastRoutVO[] getSpcDlyFcastRoutVOs(){
		SpcDlyFcastRoutVO[] vos = (SpcDlyFcastRoutVO[])models.toArray(new SpcDlyFcastRoutVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.tsSeq = this.tsSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
