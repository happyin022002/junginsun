...
public class TrsTrspEdiRailOrdVO extends AbstractValueObject {
	...
	public TrsTrspEdiRailOrdVO(String ibflag, String pagerows, String trspSoOfcCtyCd, String trspSoSeq, String bilIssKnt, String bilIssStsCd, String bkgNo, String blNo, String bkgCgoTpCd, String vndrSeq, String eqNo, String eqTpszCd, String fmNodCd, String toNodCd, String cxlRqstDt, String cxlRqstRjctRsn, String interRmk, String spclInstrRmk, String bilEdiSntDt, String bilEdiRcvRsltFlg, String bilEdiRcvRsltDt, String mtcEdiIndCd, String mtcEdiRcvRsltFlg, String mtcEdiRcvRsltDt, String cfmMsgSntDt, String railOrdRjctFlg, String deltFlg, String creOfcCd, String bilEdiCtrlSeq, String bilEdiRcvRsltCd, String woRjctRsn, String bilEdiRsndDt, String bilEdiRsndRcvRsltCd, String bilEdiRsndRcvRsltDt, String dwUpdDt, String creUsrId, String creDt, String updUsrId, String updDt, String loclCreDt, String loclUpdDt, String copNo, String cgoTpCd, String repoPlnId, String plnYrwk, String refId, String refSeq, String costActGrpSeq, String railCmbThruTpCd, String fmNodYard, String toNodYard, String trspSoStsCd, String trspBndCd) {
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashColumns.put("repo_pln_id", "repoPlnId");
		this.hashColumns.put("pln_yrwk", "plnYrwk");
		this.hashColumns.put("ref_id", "refId");
		this.hashColumns.put("ref_seq", "refSeq");
		this.hashColumns.put("cost_act_grp_seq", "costActGrpSeq");
		this.hashColumns.put("rail_cmb_thru_tp_cd", "railCmbThruTpCd");
		this.hashColumns.put("fm_nod_yard", "fmNodYard");
		this.hashColumns.put("to_nod_yard", "toNodYard");
		this.hashColumns.put("trsp_so_sts_cd", "trspSoStsCd");
		this.hashColumns.put("trsp_bnd_cd", "trspBndCd");
	...
	*/
	...
	public static TrsTrspEdiRailOrdVO[] fromRequestWrs(RailBillingCancelEvent event, int length) {
		TrsTrspEdiRailOrdVO model = null;	
		
		Collection<TrsTrspEdiRailOrdVO> modelCol = new ArrayList<TrsTrspEdiRailOrdVO>();
		
		String[] ibflag  			  =  event.getIbflag();
		String[] trspSoOfcCtyCd    	  =  event.getTrsp_so_ofc_cty_cd();
		String[] trspSoSeq            =  event.getTrsp_so_seq();
		String[] bilIssKnt		      =  event.getBil_iss_knt();
		String[] spclInstrRmk		  =  event.getSpcl_instr_rmk();
		String[] railOrdRjctFlg	      =  event.getRail_ord_rjct_flg();
		String[] woRjctRsn		      =  event.getWo_rjct_rsn();
		...
		TrsTrspEdiRailOrdVO[] modelResult = (TrsTrspEdiRailOrdVO[])modelCol.toArray(new TrsTrspEdiRailOrdVO[modelCol.size()]);
