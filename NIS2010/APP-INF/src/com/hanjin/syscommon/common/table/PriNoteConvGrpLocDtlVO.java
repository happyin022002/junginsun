...
*@FileName : PriNoteConvGrpLocDtlVO.java
*@FileTitle : PriNoteConvGrpLocDtlVO
*Open Issues :
*Change history :
...
public class PriNoteConvGrpLocDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriNoteConvGrpLocDtlVO> models = new ArrayList<PriNoteConvGrpLocDtlVO>();
	...
	public PriNoteConvGrpLocDtlVO() {}

	public PriNoteConvGrpLocDtlVO(String ibflag, String pagerows, String prcCtrtTpCd, String noteConvGrpLocCd, String locCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public PriNoteConvGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriNoteConvGrpLocDtlVO[]
	 */
	public PriNoteConvGrpLocDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriNoteConvGrpLocDtlVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriNoteConvGrpLocDtlVO();
				if (updDt[i] != null)
		...
		return getPriNoteConvGrpLocDtlVOs();
	}
	...
	public PriNoteConvGrpLocDtlVO[] getPriNoteConvGrpLocDtlVOs(){
		PriNoteConvGrpLocDtlVO[] vos = (PriNoteConvGrpLocDtlVO[])models.toArray(new PriNoteConvGrpLocDtlVO[models.size()]);
		return vos;
	}
