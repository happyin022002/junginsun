...
*@FileName : SqmDirConvVO.java
*@FileTitle : SqmDirConvVO
*Open Issues :
*Change history :
...
public class SqmDirConvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmDirConvVO> models = new ArrayList<SqmDirConvVO>();
	...
	public SqmDirConvVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String trdCd, String rlaneCd, String dirCd, String convDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.trdCd = trdCd;
		this.bseYr = bseYr;
...
/**
	 ...
	 * @return SqmDirConvVO[]
	 */
	public SqmDirConvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmDirConvVO[]
	 */
	public SqmDirConvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmDirConvVO model = null;
	...
	public SqmDirConvVO[] getSqmDirConvVOs(){
		SqmDirConvVO[] vos = (SqmDirConvVO[])models.toArray(new SqmDirConvVO[models.size()]);
		return vos;
	}
