...
*@FileName : BkgPkupNtcPkupNoHisVO.java
*@FileTitle : BkgPkupNtcPkupNoHisVO
*Open Issues :
*Change history :
...
public class BkgPkupNtcPkupNoHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BkgPkupNtcPkupNoHisVO> models = new ArrayList<BkgPkupNtcPkupNoHisVO>();
	...
	public BkgPkupNtcPkupNoHisVO() {}

	public BkgPkupNtcPkupNoHisVO(String ibflag, String pagerows, String bkgNo, String cntrNo, String ofcCd, String hisSeq, String blNo, String vslCd, String skdVoyNo, String skdDirCd, String podCd, String delCd, String deTermCd, String railDestLocCd, String ibdTrspHubCd, String pkupYdCd, String pkupNo, String pkupAvalDt, String lstFreeDt, String rtnYdCd, String pkupCreDt, String pkupCreUsrId, String pkupUpdDt, String pkupUpdUsrId, String deltFlg, String pkupDeltDt, String pkupDeltUsrId, String pkupDeltRsn, String creUsrId, String creDt, String updUsrId, String updDt, String railArrDt, String railDepDt, String pkupMnlUpldFlg) {
		this.vslCd = vslCd;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPkupDeltRsn(JSPUtil.getParameter(request, prefix + "pkup_delt_rsn", ""));
	 ...
	 * @param request
	 * @return BkgPkupNtcPkupNoHisVO[]
	 */
	public BkgPkupNtcPkupNoHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BkgPkupNtcPkupNoHisVO[]
	 */
	public BkgPkupNtcPkupNoHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BkgPkupNtcPkupNoHisVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new BkgPkupNtcPkupNoHisVO();
				if (vslCd[i] != null)
		...
		return getBkgPkupNtcPkupNoHisVOs();
	}
	 ...
	 * @return BkgPkupNtcPkupNoHisVO[]
	 */
	public BkgPkupNtcPkupNoHisVO[] getBkgPkupNtcPkupNoHisVOs(){
		BkgPkupNtcPkupNoHisVO[] vos = (BkgPkupNtcPkupNoHisVO[])models.toArray(new BkgPkupNtcPkupNoHisVO[models.size()]);
		return vos;
	}
