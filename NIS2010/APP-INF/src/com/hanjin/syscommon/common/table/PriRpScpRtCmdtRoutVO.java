...
*@FileName : PriRpScpRtCmdtRoutVO.java
*@FileTitle : PriRpScpRtCmdtRoutVO
*Open Issues :
*Change history :
...
public class PriRpScpRtCmdtRoutVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpRtCmdtRoutVO> models = new ArrayList<PriRpScpRtCmdtRoutVO>();
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setPrsCrntPfitCmpbAmt(JSPUtil.getParameter(request, prefix + "prs_crnt_pfit_cmpb_amt", ""));
		...
		setPrsRmnPfitCmpbAmt(JSPUtil.getParameter(request, prefix + "prs_rmn_pfit_cmpb_amt", ""));
	 ...
	 */
	public PriRpScpRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpRtCmdtRoutVO[]
	 */
	public PriRpScpRtCmdtRoutVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpRtCmdtRoutVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PriRpScpRtCmdtRoutVO();
		...
		return getPriRpScpRtCmdtRoutVOs();
	}
	...
	public PriRpScpRtCmdtRoutVO[] getPriRpScpRtCmdtRoutVOs(){
		PriRpScpRtCmdtRoutVO[] vos = (PriRpScpRtCmdtRoutVO[])models.toArray(new PriRpScpRtCmdtRoutVO[models.size()]);
		return vos;
	}
