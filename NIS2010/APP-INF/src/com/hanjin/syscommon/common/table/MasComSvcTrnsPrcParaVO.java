...
*@FileName : MasComSvcTrnsPrcParaVO.java
*@FileTitle : MasComSvcTrnsPrcParaVO
*Open Issues :
*Change history :
 ...
 */
public class MasComSvcTrnsPrcParaVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasComSvcTrnsPrcParaVO> models = new ArrayList<MasComSvcTrnsPrcParaVO>();
	 ...
	 * @param request
	 * @return MasComSvcTrnsPrcParaVO[]
	 */
	public MasComSvcTrnsPrcParaVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasComSvcTrnsPrcParaVO[]
	 */
	public MasComSvcTrnsPrcParaVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasComSvcTrnsPrcParaVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasComSvcTrnsPrcParaVO();
				if (updDt[i] != null)
		...
		return getMasComSvcTrnsPrcParaVOs();
	}
	 ...
	 * @return MasComSvcTrnsPrcParaVO[]
	 */
	public MasComSvcTrnsPrcParaVO[] getMasComSvcTrnsPrcParaVOs(){
		MasComSvcTrnsPrcParaVO[] vos = (MasComSvcTrnsPrcParaVO[])models.toArray(new MasComSvcTrnsPrcParaVO[models.size()]);
		return vos;
	}
