...
*@FileName : MasMonVvdVO.java
*@FileTitle : MasMonVvdVO
*Open Issues :
*Change history :
 ...
 */
public class MasMonVvdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasMonVvdVO> models = new ArrayList<MasMonVvdVO>();
	 ...
	 * @return MasMonVvdVO[]
	 */
	public MasMonVvdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasMonVvdVO[]
	 */
	public MasMonVvdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasMonVvdVO model = null;
	...
	public MasMonVvdVO[] getMasMonVvdVOs(){
		MasMonVvdVO[] vos = (MasMonVvdVO[])models.toArray(new MasMonVvdVO[models.size()]);
		return vos;
	}
