...
*@FileName : MST_CNTR_ISO_TP_SZ.java
*@FileTitle : 사용자 관리5
*Open Issues :
*Change history :
 ...
 * @since J2EE 1.4
 */
public final class MST_CNTR_ISO_TP_SZ implements java.io.Serializable {

	private String            ibflag            = "";
	private String            page_rows         = "";
	private String            cntr_tpsz_cd      = "";
	private String            iso_cntr_tpsz_cd  = "";
	private String            hjs_cntr_tpsz_flg = "";
	private String            cre_dt            = "";
	private String            upd_dt            = "";
	private String            upd_usr_id        = "";
	private String            eai_evnt_dt       = "";

	public MST_CNTR_ISO_TP_SZ(){}
	...
	public MST_CNTR_ISO_TP_SZ(
		...
		this.hjs_cntr_tpsz_flg = hjs_cntr_tpsz_flg;
		this.cre_dt            = cre_dt           ;
		this.upd_dt            = upd_dt           ;
	...
	public String            getHjs_cntr_tpsz_flg(){	return hjs_cntr_tpsz_flg	;	}
	...
	public void setHjs_cntr_tpsz_flg( String            hjs_cntr_tpsz_flg ){	this.hjs_cntr_tpsz_flg = hjs_cntr_tpsz_flg	;	}
	public void setCre_dt           ( String            cre_dt            ){	this.cre_dt            = cre_dt           	;	}
	public void setUpd_dt           ( String            upd_dt            ){	this.upd_dt            = upd_dt           	;	}
	public void setUpd_usr_id       ( String            upd_usr_id        ){	this.upd_usr_id        = upd_usr_id       	;	}
	public void setEai_evnt_dt      ( String            eai_evnt_dt       ){	this.eai_evnt_dt       = eai_evnt_dt      	;	}

	public static MST_CNTR_ISO_TP_SZ fromRequest(HttpServletRequest request) {
		MST_CNTR_ISO_TP_SZ model = new MST_CNTR_ISO_TP_SZ();
		try {
			...
			model.setHjs_cntr_tpsz_flg	(JSPUtil.getParameter(request, "hjs_cntr_tpsz_flg		".trim(), ""));
	...
	public static Collection fromRequest(HttpServletRequest request, int length) {
		...
		try {
			...
			String[] hjs_cntr_tpsz_flg =  (JSPUtil.getParameter(request, "hjs_cntr_tpsz_flg		".trim(), length));
			String[] cre_dt            =  (JSPUtil.getParameter(request, "cre_dt           		".trim(), length));
			String[] upd_dt            =  (JSPUtil.getParameter(request, "upd_dt           		".trim(), length));
			String[] upd_usr_id        =  (JSPUtil.getParameter(request, "upd_usr_id       		".trim(), length));
			String[] eai_evnt_dt       =  (JSPUtil.getParameter(request, "eai_evnt_dt      		".trim(), length));
			for (int i = 0; i < length; i++) {
				model = new MST_CNTR_ISO_TP_SZ();
				model.setIbflag           		  (ibflag           	[i]);
				model.setPage_rows        		  (page_rows        	[i]);
				model.setCntr_tpsz_cd     		  (cntr_tpsz_cd     	[i]);
				model.setIso_cntr_tpsz_cd 		  (iso_cntr_tpsz_cd 	[i]);
				model.setHjs_cntr_tpsz_flg		  (hjs_cntr_tpsz_flg	[i]);
	...
	public static Collection fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] hjs_cntr_tpsz_flg =  (JSPUtil.getParameter(request, prefix + "hjs_cntr_tpsz_flg		".trim(), length));
