...
*@FileName : CoaRoutDysIfMgmtBkupVO.java
*@FileTitle : CoaRoutDysIfMgmtBkupVO
*Open Issues :
*Change history :
...
public class CoaRoutDysIfMgmtBkupVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CoaRoutDysIfMgmtBkupVO> models = new ArrayList<CoaRoutDysIfMgmtBkupVO>();
	...
	public CoaRoutDysIfMgmtBkupVO() {}

	public CoaRoutDysIfMgmtBkupVO(String ibflag, String pagerows, String costYr, String costLocGrpCd, String cntrTpszCd, String orgLocCd, String destLocCd, String eqDys, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return CoaRoutDysIfMgmtBkupVO[]
	 */
	public CoaRoutDysIfMgmtBkupVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CoaRoutDysIfMgmtBkupVO[]
	 */
	public CoaRoutDysIfMgmtBkupVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CoaRoutDysIfMgmtBkupVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CoaRoutDysIfMgmtBkupVO();
				if (updDt[i] != null)
		...
		return getCoaRoutDysIfMgmtBkupVOs();
	}
	 ...
	 * @return CoaRoutDysIfMgmtBkupVO[]
	 */
	public CoaRoutDysIfMgmtBkupVO[] getCoaRoutDysIfMgmtBkupVOs(){
		CoaRoutDysIfMgmtBkupVO[] vos = (CoaRoutDysIfMgmtBkupVO[])models.toArray(new CoaRoutDysIfMgmtBkupVO[models.size()]);
		return vos;
	}
