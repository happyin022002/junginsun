...
*@FileName : ScgImdgSegrGrpDtlVO.java
*@FileTitle : ScgImdgSegrGrpDtlVO
*Open Issues :
*Change history :
...
public class ScgImdgSegrGrpDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgImdgSegrGrpDtlVO> models = new ArrayList<ScgImdgSegrGrpDtlVO>();
	...
	public ScgImdgSegrGrpDtlVO() {}

	public ScgImdgSegrGrpDtlVO(String ibflag, String pagerows, String imdgUnNo, String imdgSegrGrpNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public ScgImdgSegrGrpDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgImdgUnNoSegrGrpVO[]
	 */
	public ScgImdgSegrGrpDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgImdgSegrGrpDtlVO model = null;
	 ...
	 * @return ScgImdgUnNoSegrGrpVO[]
	 */
	public ScgImdgSegrGrpDtlVO[] getScgImdgUnNoSegrGrpVOs(){
		ScgImdgSegrGrpDtlVO[] vos = (ScgImdgSegrGrpDtlVO[])models.toArray(new ScgImdgSegrGrpDtlVO[models.size()]);
		return vos;
	}
