...
*@FileName : SqmSctrPairCostVO.java
*@FileTitle : SqmSctrPairCostVO
*Open Issues :
*Change history :
...
public class SqmSctrPairCostVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrPairCostVO> models = new ArrayList<SqmSctrPairCostVO>();
	...
	public SqmSctrPairCostVO() {}

	public SqmSctrPairCostVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String dirCd, String polCd, String podCd, String trdCd, String subTrdCd, String gidPaCmUcAmt, String gidRaCmUcAmt, String paCmUcAmt, String raCmUcAmt, String addFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return SqmSctrPairCostVO[]
	 */
	public SqmSctrPairCostVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrPairCostVO[]
	 */
	public SqmSctrPairCostVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrPairCostVO model = null;
	 ...
	 * @return SqmSctrPairCostVO[]
	 */
	public SqmSctrPairCostVO[] getSqmSctrPairCostVOs(){
		SqmSctrPairCostVO[] vos = (SqmSctrPairCostVO[])models.toArray(new SqmSctrPairCostVO[models.size()]);
		return vos;
	}
