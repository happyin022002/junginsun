...
*@FileName : SPC_DLY_FCAST_CUST_HIS.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SPC_DLY_FCAST_CUST_HIS implements Serializable {
	...
	public SPC_DLY_FCAST_CUST_HIS() {
	}

	public SPC_DLY_FCAST_CUST_HIS(String ibflag, String page_rows,
			String rlane_cd, String dir_cd, String vsl_cd, String skd_voy_no,
			String skd_dir_cd, String ioc_ts_cd, String srep_usr_id,
			String cust_cnt_cd, String cust_seq, String pol_cd, String pod_cd,
			String fcast_ofc_cd, String fcast_cust_tp_cd, String modi_seq,
			String ioc_cd, String rep_trd_cd, String rep_sub_trd_cd,
			String trd_cd, String sub_trd_cd, String sls_rhq_cd,
			String sls_aq_cd, String sls_rgn_ofc_cd, String sls_ofc_cd,
			String fcast_ttl_qty, String fcast_40ft_hc_qty,
			String fcast_45ft_hc_qty, String fcast_rf_qty,
			String fcast_ttl_wgt, String cfm_ttl_qty, String cfm_40ft_hc_qty,
			String cfm_45ft_hc_qty, String cfm_rf_qty, String cfm_ttl_wgt,
			String ctrl_lvl_cd, String modi_gdt, String cfm_usr_id,
			String cfm_dt, String cre_usr_id, String upd_usr_id,
			String cfm_flg, String usd_bkg_ttl_qty, String usd_bkg_20ft_qty,
			String usd_bkg_40ft_qty, String usd_bkg_40ft_hc_qty,
			String usd_bkg_45ft_hc_qty, String usd_bkg_rf_qty,
			String usd_bkg_ttl_wgt) {
		this.ibflag = ibflag;
	...
	public static SPC_DLY_FCAST_CUST_HIS fromRequest(HttpServletRequest request) {
		String strUserId = getUserId(request);
		SPC_DLY_FCAST_CUST_HIS model = new SPC_DLY_FCAST_CUST_HIS();
		try {
			...
			model.setFcast_ofc_cd(JSPUtil.getParameter(request, "fcast_ofc_cd",
					""));
			model.setFcast_cust_tp_cd(JSPUtil.getParameter(request,
					"fcast_cust_tp_cd", ""));
			...
			model.setCfm_ttl_qty(JSPUtil.getParameter(request, "cfm_ttl_qty",
					""));
			model.setCfm_40ft_hc_qty(JSPUtil.getParameter(request,
					"cfm_40ft_hc_qty", ""));
			model.setCfm_45ft_hc_qty(JSPUtil.getParameter(request,
					"cfm_45ft_hc_qty", ""));
			model
					.setCfm_rf_qty(JSPUtil.getParameter(request, "cfm_rf_qty",
							""));
			...
			model
					.setCfm_usr_id(JSPUtil.getParameter(request, "cfm_usr_id",
							""));
	...
	public static Collection fromRequestGrid(HttpServletRequest request,
			String prefix) {
		String strUserId = getUserId(request);
		SPC_DLY_FCAST_CUST_HIS model = null;
		...
		try {
			...
			String[] srep_usr_id = (JSPUtil.getParameter(request, prefix
					+ "srep_usr_id".trim(), length));
			...
			String[] pod_cd = (JSPUtil.getParameter(request, prefix
					+ "pod_cd".trim(), length));
			String[] fcast_ofc_cd = (JSPUtil.getParameter(request, prefix
					+ "fcast_ofc_cd".trim(), length));
			String[] fcast_cust_tp_cd = (JSPUtil.getParameter(request, prefix
					+ "fcast_cust_tp_cd".trim(), length));
			...
			String[] cfm_ttl_qty = (JSPUtil.getParameter(request, prefix
					+ "cfm_ttl_qty".trim(), length));
			String[] cfm_40ft_hc_qty = (JSPUtil.getParameter(request, prefix
					+ "cfm_40ft_hc_qty".trim(), length));
			String[] cfm_45ft_hc_qty = (JSPUtil.getParameter(request, prefix
					+ "cfm_45ft_hc_qty".trim(), length));
			String[] cfm_rf_qty = (JSPUtil.getParameter(request, prefix
					+ "cfm_rf_qty".trim(), length));
			String[] cfm_ttl_wgt = (JSPUtil.getParameter(request, prefix
					+ "cfm_ttl_wgt".trim(), length));
			String[] ctrl_lvl_cd = (JSPUtil.getParameter(request, prefix
					+ "ctrl_lvl_cd".trim(), length));
			String[] modi_gdt = (JSPUtil.getParameter(request, prefix
					+ "modi_gdt".trim(), length));
			String[] cfm_usr_id = (JSPUtil.getParameter(request, prefix
					+ "cfm_usr_id".trim(), length));
			String[] cfm_dt = (JSPUtil.getParameter(request, prefix
					+ "cfm_dt".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				model = new SPC_DLY_FCAST_CUST_HIS();
				if (ibflag[i] != null)
