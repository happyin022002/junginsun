...
*@FileName : EqrEccLnkVO.java
*@FileTitle : EqrEccLnkVO
*Open Issues :
*Change history :
...
public class EqrEccLnkVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EqrEccLnkVO> models = new ArrayList<EqrEccLnkVO>();
	 ...
	 * @return EqrEccLnkVO[]
	 */
	public EqrEccLnkVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EqrEccLnkVO[]
	 */
	public EqrEccLnkVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EqrEccLnkVO model = null;
	...
	public EqrEccLnkVO[] getEqrEccLnkVOs(){
		EqrEccLnkVO[] vos = (EqrEccLnkVO[])models.toArray(new EqrEccLnkVO[models.size()]);
		return vos;
	}
