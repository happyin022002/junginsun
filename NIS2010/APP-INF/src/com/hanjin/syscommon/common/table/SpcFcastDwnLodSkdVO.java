...
*@FileName : SpcFcastDwnLodSkdVO.java
*@FileTitle : SpcFcastDwnLodSkdVO
*Open Issues :
*Change history :
...
public class SpcFcastDwnLodSkdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SpcFcastDwnLodSkdVO> models = new ArrayList<SpcFcastDwnLodSkdVO>();
	...
	public SpcFcastDwnLodSkdVO() {}

	public SpcFcastDwnLodSkdVO(String ibflag, String pagerows, String bseYrmon, String dwnLodDy, String exeDt, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public SpcFcastDwnLodSkdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SpcFcastDwnLodSkdVO[]
	 */
	public SpcFcastDwnLodSkdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SpcFcastDwnLodSkdVO model = null;
		...
		return getSpcFcastDwnLodSkdVOs();
	}
	...
	public SpcFcastDwnLodSkdVO[] getSpcFcastDwnLodSkdVOs(){
		SpcFcastDwnLodSkdVO[] vos = (SpcFcastDwnLodSkdVO[])models.toArray(new SpcFcastDwnLodSkdVO[models.size()]);
		return vos;
	}
