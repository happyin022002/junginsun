...
*@FileName : MasOpAvgUtCostIfVO.java
*@FileTitle : MasOpAvgUtCostIfVO
*Open Issues :
*Change history :
 ...
 */
public class MasOpAvgUtCostIfVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasOpAvgUtCostIfVO> models = new ArrayList<MasOpAvgUtCostIfVO>();
...
/**
	 ...
	 * @param request
	 * @return MasOpAvgUtCostIfVO[]
	 */
	public MasOpAvgUtCostIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasOpAvgUtCostIfVO[]
	 */
	public MasOpAvgUtCostIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasOpAvgUtCostIfVO model = null;
	 ...
	 * @return MasOpAvgUtCostIfVO[]
	 */
	public MasOpAvgUtCostIfVO[] getMasOpAvgUtCostIfVOs(){
		MasOpAvgUtCostIfVO[] vos = (MasOpAvgUtCostIfVO[])models.toArray(new MasOpAvgUtCostIfVO[models.size()]);
		return vos;
	}
