...
*@FileName : MasCntrRepoShtgInfoVO.java
*@FileTitle : MasCntrRepoShtgInfoVO
*Open Issues :
*Change history :
 ...
 */
public class MasCntrRepoShtgInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasCntrRepoShtgInfoVO> models = new ArrayList<MasCntrRepoShtgInfoVO>();
	 ...
	 */
	public MasCntrRepoShtgInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasCntrRepoShtgInfoVO[]
	 */
	public MasCntrRepoShtgInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasCntrRepoShtgInfoVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new MasCntrRepoShtgInfoVO();
				if (updDt[i] != null)
		...
		return getMasCntrRepoShtgInfoVOs();
	}
	...
	public MasCntrRepoShtgInfoVO[] getMasCntrRepoShtgInfoVOs(){
		MasCntrRepoShtgInfoVO[] vos = (MasCntrRepoShtgInfoVO[])models.toArray(new MasCntrRepoShtgInfoVO[models.size()]);
		return vos;
	}
