...
*@FileName : BsaVvdPortDwnVO.java
*@FileTitle : BsaVvdPortDwnVO
*Open Issues :
*Change history :
...
public class BsaVvdPortDwnVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<BsaVvdPortDwnVO> models = new ArrayList<BsaVvdPortDwnVO>();
	...
	public BsaVvdPortDwnVO() {}

	public BsaVvdPortDwnVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String vslCd, String skdVoyNo, String skdDirCd, String bsaOpJbCd, String crrCd, String portSeq, String portCd, String portBsaCapa, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.vslCd = vslCd;
		this.creDt = creDt;
		this.trdCd = trdCd;
	 ...
	 */
	public BsaVvdPortDwnVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return BsaVvdPortDwnVO[]
	 */
	public BsaVvdPortDwnVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		BsaVvdPortDwnVO model = null;
	...
	public BsaVvdPortDwnVO[] getBsaVvdPortDwnVOs(){
		BsaVvdPortDwnVO[] vos = (BsaVvdPortDwnVO[])models.toArray(new BsaVvdPortDwnVO[models.size()]);
		return vos;
	}
