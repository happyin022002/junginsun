...
*@FileName : JooLtrAtchFileVO.java
*@FileTitle : JooLtrAtchFileVO
*Open Issues :
*Change history :
...
public class JooLtrAtchFileVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<JooLtrAtchFileVO> models = new ArrayList<JooLtrAtchFileVO>();
	...
	public JooLtrAtchFileVO() {}

	public JooLtrAtchFileVO(String ibflag, String pagerows, String joLtrSeq, String fileSavId, String creDt, String creUsrId, String updDt, String updUsrId) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return JooLtrAtchFileVO[]
	 */
	public JooLtrAtchFileVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return JooLtrAtchFileVO[]
	 */
	public JooLtrAtchFileVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		JooLtrAtchFileVO model = null;
	 ...
	 * @return JooLtrAtchFileVO[]
	 */
	public JooLtrAtchFileVO[] getJooLtrAtchFileVOs(){
		JooLtrAtchFileVO[] vos = (JooLtrAtchFileVO[])models.toArray(new JooLtrAtchFileVO[models.size()]);
		return vos;
	}
