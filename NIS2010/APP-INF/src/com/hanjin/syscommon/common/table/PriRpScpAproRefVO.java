...
*@FileName : PriRpScpAproRefVO.java
*@FileTitle : PriRpScpAproRefVO
*Open Issues :
*Change history :
...
public class PriRpScpAproRefVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpAproRefVO> models = new ArrayList<PriRpScpAproRefVO>();
	...
	public PriRpScpAproRefVO() {}

	public PriRpScpAproRefVO(String ibflag, String pagerows, String propNo, String amdtSeq, String aproRqstSeq, String svcScpCd, String aproRqstRmk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return PriRpScpAproRefVO[]
	 */
	public PriRpScpAproRefVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpAproRefVO[]
	 */
	public PriRpScpAproRefVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpAproRefVO model = null;
	 ...
	 * @return PriRpScpAproRefVO[]
	 */
	public PriRpScpAproRefVO[] getPriRpScpAproRefVOs(){
		PriRpScpAproRefVO[] vos = (PriRpScpAproRefVO[])models.toArray(new PriRpScpAproRefVO[models.size()]);
		return vos;
	}
