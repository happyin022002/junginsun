...
*@FileName : MasBkgCostCalcHisVO.java
*@FileTitle : MasBkgCostCalcHisVO
*Open Issues :
*Change history :
 ...
 */
public class MasBkgCostCalcHisVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MasBkgCostCalcHisVO> models = new ArrayList<MasBkgCostCalcHisVO>();
	...
	public MasBkgCostCalcHisVO() {}

	public MasBkgCostCalcHisVO(String ibflag, String pagerows, String bkgNo, String costBatDt, String costBatRmk, String costYrmon, String slsYrmon, String costWk, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 * @param request
	 * @return MasBkgCostCalcHisVO[]
	 */
	public MasBkgCostCalcHisVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasBkgCostCalcHisVO[]
	 */
	public MasBkgCostCalcHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MasBkgCostCalcHisVO model = null;
		...
		return getMasBkgCostCalcHisVOs();
	}
	 ...
	 * @return MasBkgCostCalcHisVO[]
	 */
	public MasBkgCostCalcHisVO[] getMasBkgCostCalcHisVOs(){
		MasBkgCostCalcHisVO[] vos = (MasBkgCostCalcHisVO[])models.toArray(new MasBkgCostCalcHisVO[models.size()]);
		return vos;
	}
