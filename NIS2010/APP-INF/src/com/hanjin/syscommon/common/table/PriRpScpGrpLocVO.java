...
*@FileName : PriRpScpGrpLocVO.java
*@FileTitle : PriRpScpGrpLocVO
*Open Issues :
*Change history :
...
public class PriRpScpGrpLocVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PriRpScpGrpLocVO> models = new ArrayList<PriRpScpGrpLocVO>();
	...
	public PriRpScpGrpLocVO() {}

	public PriRpScpGrpLocVO(String ibflag, String pagerows, String propNo, String amdtSeq, String svcScpCd, String grpLocSeq, String orgDestTpCd, String prcGrpLocCd, String prcGrpLocDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
	 ...
	 */
	public PriRpScpGrpLocVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PriRpScpGrpLocVO[]
	 */
	public PriRpScpGrpLocVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PriRpScpGrpLocVO model = null;
	...
	public PriRpScpGrpLocVO[] getPriRpScpGrpLocVOs(){
		PriRpScpGrpLocVO[] vos = (PriRpScpGrpLocVO[])models.toArray(new PriRpScpGrpLocVO[models.size()]);
		return vos;
	}
