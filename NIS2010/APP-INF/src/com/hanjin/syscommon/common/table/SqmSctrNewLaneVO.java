...
*@FileName : SqmSctrNewLaneVO.java
*@FileTitle : SqmSctrNewLaneVO
*Open Issues :
*Change history :
...
public class SqmSctrNewLaneVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SqmSctrNewLaneVO> models = new ArrayList<SqmSctrNewLaneVO>();
	...
	public SqmSctrNewLaneVO() {}

	public SqmSctrNewLaneVO(String ibflag, String pagerows, String bseTpCd, String bseYr, String bseQtrCd, String rlaneCd, String dirCd, String trdCd, String subTrdCd, String srcTrdCd, String srcRlaneCd, String srcDirCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return SqmSctrNewLaneVO[]
	 */
	public SqmSctrNewLaneVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SqmSctrNewLaneVO[]
	 */
	public SqmSctrNewLaneVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SqmSctrNewLaneVO model = null;
	 ...
	 * @return SqmSctrNewLaneVO[]
	 */
	public SqmSctrNewLaneVO[] getSqmSctrNewLaneVOs(){
		SqmSctrNewLaneVO[] vos = (SqmSctrNewLaneVO[])models.toArray(new SqmSctrNewLaneVO[models.size()]);
		return vos;
	}
