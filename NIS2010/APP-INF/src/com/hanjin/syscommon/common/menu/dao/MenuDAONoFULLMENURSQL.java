...
*@FileName : MenuDAONoFULLMENURSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MenuDAONoFULLMENURSQL implements ISQLTemplate{
	...
	public MenuDAONoFULLMENURSQL(){
		...
		query.append("FileName : MenuDAONoFULLMENURSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
