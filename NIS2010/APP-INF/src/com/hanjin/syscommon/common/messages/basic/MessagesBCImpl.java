 ...
 * 1.0 최초 생성
=========================================================*/
package com.hanjin.syscommon.common.messages.basic;
...
import com.hanjin.syscommon.common.messages.integration.MessagesDAO;
	...
	public void addComMessages(Event e) throws EventException {
		...
		try {
			...
			for ( int i=0 ; i < rcvrUsrId.length ; i++ ) {
				...
				dbDao.addComMgsRcv(event.getComMsgRcv());
			}
