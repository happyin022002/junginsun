...
public class GroupwareMailPopupEvent extends EventSupport {
	...
	/**This method sets a GwTo
	 * @author Jeong-Hoon, KIM
	 * @param parameter
	 */
	public void setGwTo(String gwTo) {
		this.gwTo = gwTo;
	}
	
	/**
	 * This method gets a GwTo
	 * @author Jeong-Hoon, KIM
	 * @return
	 */
	public String getGwTo() {
		return gwTo;
	}
	
	/**This method sets a GwCc
	 * @author Jeong-Hoon, KIM
	 * @param parameter
	 */
	public void setGwCc(String gwCc) {
		this.gwCc = gwCc;
	}
	
	/**
	 * This method gets a GwCc
	 * @author Jeong-Hoon, KIM
	 * @return
	 */
	public String getGwCc() {
		return gwCc;
	}
}