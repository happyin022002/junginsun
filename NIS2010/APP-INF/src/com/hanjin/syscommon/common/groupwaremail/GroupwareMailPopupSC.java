...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.common.groupwaremail;
...
import com.hanjin.syscommon.common.groupwaremail.basic.GroupwareMailPopupExecuteBC;
import com.hanjin.syscommon.common.groupwaremail.basic.GroupwareMailPopupExecuteBCImpl;
import com.hanjin.syscommon.common.groupwaremail.event.GroupwareMailPopupEvent;
...
public class GroupwareMailPopupSC extends ServiceCommandSupport {
	...
	private EventResponse popGroupwareWindow(Event e) throws EventException {
		...
		try{
			eventResponse.setETCData("GroupwarePopupURL", command.popGroupwareWindow(event.getGwSubject(),event.getGwContents(), event.getGwTo(), event.getGwCc(), this.account));
