...
*@FileName : IbSheetDBDAOchkExistRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IbSheetDBDAOchkExistRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IbSheetDBDAOchkExistRSQL(){
		setQuery();
		...
		query.append("FileName : IbSheetDBDAOchkExistRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT hdr_desc" ).append("\n"); 
