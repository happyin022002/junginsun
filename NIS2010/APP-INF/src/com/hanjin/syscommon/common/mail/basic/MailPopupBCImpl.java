...
import com.hanjin.framework.component.rdmail.dao.ComEmlSndInfoDBDAO;
import com.hanjin.framework.component.util.io.FileUtils;
import com.hanjin.framework.component.util.reportdesigner.ReportDesignerUtilities;
...
public class MailPopupBCImpl implements MailPopupBC {
	...
	public List<ComUpldFileVO> exportReport(MailCustomVO mailCustomVO) throws Exception{
		...
		return designerExporter.doExports(identifiedComRptDsgnXptInfoVO, SiteConfigFactory.get("COM.HANJIN.RDEXP.RPT_OUTPUT_PATH.DEFAULT"));
	}
