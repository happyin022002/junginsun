...
*@LastVersion    : 1.0
=========================================================*/
package com.hanjin.syscommon.rd.servicesio;
...
import com.hanjin.framework.component.rdmail.servicesio.ReportDesignerStatusUpdate;
...
@WebService(name="ReportDesignerStatusUpdatePortType", serviceName="ReportDesignerStatusUpdate",
        targetNamespace="http://www.hanjin.com/integration/schedule")

@SOAPBinding(style=SOAPBinding.Style.DOCUMENT,
         use=SOAPBinding.Use.LITERAL,
         parameterStyle=SOAPBinding.ParameterStyle.WRAPPED)

@WLHttpTransport(contextPath="/hanjin/webservices", serviceUri="/ReportDesignerStatusUpdate",
