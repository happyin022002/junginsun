...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.syscommon.management.alps.officeprogram.event;
 ...
 *
 * @author Hyunsu, Ryu
 * @see OfficeProgramEvent , COM_ENS_071EventResponse 참조
 * @since J2EE 1.4
 */
public class OfficeProgramHTMLAction extends HTMLActionSupport {

    /**
     * COM_ENS_071HTMLAction 객체를 생성
     */
    public OfficeProgramHTMLAction() {
    }
    ...
    public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */ 
    	...
    	SearchComOfcPgmMtchVO searchComOfcPgmMtchVO = (SearchComOfcPgmMtchVO)getVO(request, SearchComOfcPgmMtchVO.class);
        OfficeProgramEvent event = new OfficeProgramEvent(); // table value object
        event.setSearchComOfcPgmMtchVO(searchComOfcPgmMtchVO);
