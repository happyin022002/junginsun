...
*@FileName : JobCodeManagementDBDAOAddProgramListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JobCodeManagementDBDAOAddProgramListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JobCodeManagementDBDAOAddProgramListCSQL(){
		setQuery();
		...
		query.append("FileName : JobCodeManagementDBDAOAddProgramListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
