...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.menu.integration;
...
import com.hanjin.syscommon.management.alps.menu.basic.MenuBCImpl;
import com.hanjin.syscommon.management.alps.menu.vo.ComMnuCfgSearchVO;
import com.hanjin.syscommon.management.alps.menu.vo.MnuCfgExcelVO;
...
import com.hanjin.syscommon.common.table.ComMnuCfgVO;
...
public class MenuDAO extends DBDAOSupport {
	...
	public List<ComMnuCfgSearchVO> searchComMnuCfgVO(ComProgramVO commnucfgvo) throws DAOException {
		...
		String mnuCfgCd = SiteConfigFactory.get("COM.HANJIN.MENU.CONFIG.CODE");
		String rootPgmCd = SiteConfigFactory.get("COM.HANJIN.MENU.ROOT.PROGRAM.CODE");
		param.put("mnu_cfg_cd", mnuCfgCd);
		param.put("pgm_no", rootPgmCd);
		velParam.put("acss_lvl", commnucfgvo.getUpdUsrId());
		velParam.put("pgm_mnu_div_cd", commnucfgvo.getPgmLvlDivCd());
		try{
