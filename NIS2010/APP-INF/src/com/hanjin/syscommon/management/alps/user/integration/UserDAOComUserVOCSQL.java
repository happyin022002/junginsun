...
public class UserDAOComUserVOCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("@[usr_id], @[usr_nm], @[usr_pwd], @[use_flg], @[mphn_no], @[usr_eml], @[cnt_cd], @[lang_tp_cd]," ).append("\n"); 
		query.append("@[gmt_tmzn_cd], @[cnt_dt_fmt_cd], @[cnt_no_fmt_cd], @[xtn_phn_no], @[cre_usr_id], sysdate," ).append("\n"); 
		query.append("@[upd_usr_id], sysdate, @[usr_locl_nm], @[usr_auth_tp_cd], @[ofc_cd]" ).append("\n"); 
		query.append(")" ).append("\n"); 
