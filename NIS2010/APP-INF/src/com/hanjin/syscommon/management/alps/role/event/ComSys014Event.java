...
public class ComSys014Event extends EventSupport {
	...
	private ComUsrRoleVO[] comUsrRoleVOs = null;
	/**
	 * 
	 */
	...
	public ComUsrRoleVO[] getComUsrRoleVOS(){
		...
		if(this.comUsrRoleVOs!= null) {
			rtnVOs=Arrays.copyOf(comUsrRoleVOs, comUsrRoleVOs.length);	
		}
		return rtnVOs;
	}
	
	public void setComUsrRoleVOS(ComUsrRoleVO[] comUsrRoleVOs) {
		if(comUsrRoleVOs != null) {
			ComUsrRoleVO[] tmpVOs= Arrays.copyOf(comUsrRoleVOs,comUsrRoleVOs.length);
			this.comUsrRoleVOs = tmpVOs;
		}
	}
