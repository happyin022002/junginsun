...
/**
 * HTTP Parser<br>
 * - NIS2010.APP-INF.src.com.hanjin.syscommon.nis2010.management.usermanagement 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */ 
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			String usrId = JSPUtil.getParameter(request, "usr_id", "");
			String viewFlg = JSPUtil.getParameter(request, "view_flg", "");
			event.setFlg(viewFlg);
			...
			String viewFlg = JSPUtil.getParameter(request, "view_flg", "");
			comuservo.setViewFlg(viewFlg==""?"Y":viewFlg);
