...
*@FileName : ADM_SYS_0011HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see AdmSys0011Event 참조
 * @since J2EE 1.6
 */
public class ADM_SYS_0011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	* ADM_SYS_0011HTMLAction 객체를 생성
	*/
	public ADM_SYS_0011HTMLAction() {}

	/**
	* HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	* HttpRequst의 정보를 AdmSys0011Event로 파싱하여 request에 셋팅<br>
	...
	*/
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		AdmSys0011Event event = new AdmSys0011Event();
		...
		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			...
			event.setJobCodeManagementVOs((JobCodeManagementVO[])getVOs(request, JobCodeManagementVO.class));
		}
		return  event;
	}
