...
public class ComEmlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComEmlVO> models = new ArrayList<ComEmlVO>();
...
/**
	 ...
	 * @return ComEmlVO[]
	 */
	public ComEmlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComEmlVO[]
	 */
	public ComEmlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComEmlVO model = null;
	 ...
	 * @return ComEmlVO[]
	 */
	public ComEmlVO[] getComEmlVOs(){
		ComEmlVO[] vos = (ComEmlVO[])models.toArray(new ComEmlVO[models.size()]);
		return vos;
	}
