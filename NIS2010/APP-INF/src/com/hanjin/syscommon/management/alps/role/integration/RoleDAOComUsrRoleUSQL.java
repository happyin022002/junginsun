...
public class RoleDAOComUsrRoleUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("update com_usr_role set" ).append("\n"); 
		query.append("usr_role_nm = @[usr_role_nm]," ).append("\n"); 
		query.append("usr_role_desc = @[usr_role_desc]," ).append("\n"); 
		query.append("prnt_usr_role_cd = @[prnt_usr_role_cd]," ).append("\n"); 
