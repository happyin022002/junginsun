...
import com.hanjin.syscommon.common.table.COM_USER2;
import com.hanjin.syscommon.common.table.ComUsrOfcCngVO;
import com.hanjin.syscommon.common.table.GNI_USR_FILE;
...
public class UiComSys015Event extends EventSupport {
	...
	private GNI_USR_FILE[] gniUsrFileVOs = null;
	/**
	 * 
	 */
	...
	public void setGNI_USR_FILES(Collection<Object> gniUsrFiles) {
		this.gniUsrFiles = gniUsrFiles;
	}
	...
	/** (non-Javadoc)
	 * @see com.hanjin.framework.support.layer.event.EventSupport#getEventName()
	 */
	...
	public void setComUserVO(ComUsrOfcCngVO[] comUserVO) {
		if(comUserVO != null) {
			ComUsrOfcCngVO[] tmpVOs= Arrays.copyOf(comUserVO, comUserVO.length);
	...
	public GNI_USR_FILE[] getGniUsrFileVOs() {
		GNI_USR_FILE[] rtnVOs = null;
		if(this.gniUsrFileVOs != null) {
			rtnVOs=Arrays.copyOf(gniUsrFileVOs , gniUsrFileVOs .length);	
		}
		return rtnVOs;	
	}

	public void setGniUsrFileVOs(GNI_USR_FILE[] gniUsrFileVOs ) {
		if(gniUsrFileVOs  != null) {
			GNI_USR_FILE[] tmpVOs= Arrays.copyOf(gniUsrFileVOs , gniUsrFileVOs .length);
			this.gniUsrFileVOs  = tmpVOs;
		}
	}
