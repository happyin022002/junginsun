...
*@FileName : ADM_SYS_0020HTMLAction.java
 ...
 * @author KIM, Sang-Soo
 * @see AdmSys0020Event 참조
 * @since J2EE 1.6
 */
public class ADM_SYS_0020HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	* ADM_SYS_0020HTMLAction 객체를 생성
	*/
	public ADM_SYS_0020HTMLAction() {}

	/**
	* HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	* HttpRequst의 정보를 AdmSys0020Event로 파싱하여 request에 셋팅<br>
	...
	*/
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		AdmSys0020Event event = new AdmSys0020Event();

		if (command.isCommand(FormCommand.SEARCH) || command.isCommand(FormCommand.SEARCH01)) {
			event.setJobCodeInquiryVO((JobCodeInquiryVO)getVO(request, JobCodeInquiryVO.class));
		}
		return  event;
	}
