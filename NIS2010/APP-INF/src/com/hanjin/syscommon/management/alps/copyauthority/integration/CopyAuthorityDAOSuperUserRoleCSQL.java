...
*@FileName : CopyAuthorityDAOSuperUserRoleCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopyAuthorityDAOSuperUserRoleCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * copy super user role
	  * </pre>
	  */
	public CopyAuthorityDAOSuperUserRoleCSQL(){
		setQuery();
		...
		query.append("FileName : CopyAuthorityDAOSuperUserRoleCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("select @[to_usr_id] usr_id, usr_role_cd from com_usr_role_adm_mtch where usr_id = @[from_usr_id]" ).append("\n"); 
		query.append("minus" ).append("\n"); 
		query.append("select @[to_usr_id] usr_id, usr_role_cd from com_usr_role_adm_mtch where usr_id = @[to_usr_id]" ).append("\n"); 
		query.append(")" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("insert into com_usr_role_adm_mtch" ).append("\n"); 
		query.append("select @[to_usr_id], usr_role_cd, 'authcopy', sysdate, 'authcopy', sysdate" ).append("\n"); 
		query.append("from com_usr_role_adm_mtch" ).append("\n"); 
