...
*@FileName : ADM_SYS_0012THTMLAction.java
*@FileTitle : Job Code Office Mapping
*Open Issues :
*Change history :
...
/**
 * HTTP Parser<br>
 * - com.hanjin.syscommon.alps.management.programmanagement 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
 ...
 * @since J2EE 1.6
 */
public class ADM_SYS_0012HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * OFFICE_MANAGEMENTHTMLAction 객체를 생성
	 */
	public ADM_SYS_0012HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		AdmSys0012Event event = new AdmSys0012Event();

		if (command.isCommand(FormCommand.SEARCH)) {
			event.setOfficeMappingVO((OfficeMappingVO)getVO(request, OfficeMappingVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setOfficeMappingVOs((OfficeMappingVO[])getVOs(request, OfficeMappingVO.class));
		}
		return  event;		
	}
