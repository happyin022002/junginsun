...
*@FileName : SearchModulePicVO.java
*@FileTitle : SearchModulePicVO
*Open Issues :
*Change history :
...
public class SearchModulePicVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SearchModulePicVO> models = new ArrayList<SearchModulePicVO>();
	...
	public SearchModulePicVO() {}

	public SearchModulePicVO(String ibflag, String pagerows, String roleModule, String usrId, String usrNm, String usrEml) {
		this.ibflag = ibflag;
		this.usrNm = usrNm;
		this.usrId = usrId;
		this.usrEml = usrEml;
...
/**
	 ...
	 * @param request
	 * @return SearchModulePicVO[]
	 */
	public SearchModulePicVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SearchModulePicVO[]
	 */
	public SearchModulePicVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SearchModulePicVO model = null;
	 ...
	 * @return SearchModulePicVO[]
	 */
	public SearchModulePicVO[] getSearchModulePicVOs(){
		SearchModulePicVO[] vos = (SearchModulePicVO[])models.toArray(new SearchModulePicVO[models.size()]);
		return vos;
	}
