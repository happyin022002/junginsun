...
*@FileName : JobCodeManagementDBDAOAddJobCodeRoleMtchCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JobCodeManagementDBDAOAddJobCodeRoleMtchCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JobCodeManagementDBDAOAddJobCodeRoleMtchCSQL(){
		setQuery();
		...
		query.append("FileName : JobCodeManagementDBDAOAddJobCodeRoleMtchCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("VALUES (@[rqst_usr_id]," ).append("\n"); 
		query.append("        @[usr_role_cd]," ).append("\n"); 
		query.append("        @[cre_usr_id]," ).append("\n"); 
