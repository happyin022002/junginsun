 ...
 * - ReportSearchSC에서 View(JSP)로 실행결과를 전송하는 EventResponse를 request에 셋팅<br>
 *
 * @author YongHoo-Kim
 * @see  ReportSearchHTMLAction 참조
 * @since J2SE 6.0
 */
public class ReportSearchHTMLAction extends HTMLActionSupport {
	 ...
	 */
	public ReportSearchHTMLAction() {
	}
	
	/**
	 * HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	 * HttpRequst의 정보를 ReportSearchEvent 파싱하여 request에 셋팅<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		ReportSearchEvent reportSearchEvent = new ReportSearchEvent();
		reportSearchEvent.setReportdesigner(reportDesignerVO);
