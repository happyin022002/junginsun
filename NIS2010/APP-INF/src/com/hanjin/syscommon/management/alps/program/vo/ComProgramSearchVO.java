...
package com.hanjin.syscommon.management.alps.program.vo;
...
public class ComProgramSearchVO extends AbstractValueObject {
	...
	public ComProgramSearchVO(String ibflag, String pagerows, String pgmNo, String pgmNm, String pgmDesc, String pgmUrl, String roles, String ofcs, String pgmMnuDivCd, String pgmTpCd, String pgmStsCd, String devNm, String devDt, String popupFlg, String useFlg, String jobs, String pgmUseFlg) {
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("jobs", getJobs());
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setJobs(JSPUtil.getParameter(request, "jobs", ""));
		setPgmUseFlg(JSPUtil.getParameter(request, "pgm_use_flg", ""));
	}
	...
	public ComProgramSearchVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] jobs = (JSPUtil.getParameter(request, prefix	+ "jobs", length));
			String[] pgmUseFlg = (JSPUtil.getParameter(request, prefix	+ "pgm_use_flg".trim(), length));
	...
	*/
	public void unDataFormat(){
		...
		this.jobs = this.jobs .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
