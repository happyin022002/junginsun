...
package com.hanjin.syscommon.management.alps.bookmark.vo;
...
public class BookmarkListVO extends AbstractValueObject {
	...
	public BookmarkListVO(String ibflag, String pagerows, String level, String dpNm, String folFlg, String pgmNo, String dpSeq, String prntPgmNo, String pgmNm, String pgmUrl, String usrId) {
		this.dpSeq = dpSeq;
		this.dpNm = dpNm;
		this.pgmUrl = pgmUrl;
		this.ibflag = ibflag;
