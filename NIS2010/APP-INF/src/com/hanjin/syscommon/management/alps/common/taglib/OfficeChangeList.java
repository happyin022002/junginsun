...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.common.taglib;
...
import com.hanjin.syscommon.management.alps.user.basic.UserOfcCngBC;
import com.hanjin.syscommon.management.alps.user.basic.UserOfcCngBCImpl;
import com.hanjin.syscommon.management.alps.user.event.UiComSys015Event;
	...
	public int doStartTag() throws JspException {
		try {
			...
			sb.append("<select style=\""+styleValue+"\" " +  
					...
					functionValue + " > ");
			while (rowset.next()) {
				if(!rowset.getString("expire").equals("Y")){
