...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.user.vo;
...
public class ComUserVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String lstLginDt = null;

    /* Column Info */
    private String mblApstsCd = null;

    /* Column Info */
    private String mblDvcId = null;

    /* Column Info */
    private String mblSprAdmFlg = null;
    ...
    public ComUserVO(String ibflag, String pagerows, String usrId, String usrPwd, String usrNm, String usrLoclNm, String ofcCd, String cngOfcCd, String usrAuthTpCd, String useFlg, String mphnNo, String roleAssign, String superRoleAssign, String pgmAssign, String xtnPhnNo, String usrEml, String jbEngNm, String psnEngNm, String grdEngNm, String cntCd, String langTpCd, String gmtTmznCd, String cntDtFmtCd, String cntNoFmtCd, String faxNo, String dfltEml, String srepCd, String creUsrId, String creDt, String updUsrId, String updDt, String lstLginDt, String mblApstsCd, String mblDvcId, String mblSprAdmFlg, String viewFlg) {
        ...
        this.faxNo = faxNo;
        this.lstLginDt = lstLginDt;
        this.mblApstsCd = mblApstsCd;
        this.mblDvcId = mblDvcId;
        this.mblDvcId = mblDvcId;
        this.mblSprAdmFlg = mblSprAdmFlg;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("lst_lgin_dt", getLstLginDt());
        this.hashColumns.put("mbl_apsts_cd", getMblApstsCd());
        this.hashColumns.put("mbl_dvc_id", getMblDvcId());
        this.hashColumns.put("mbl_spr_adm_flg", getMblSprAdmFlg());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("lst_lgin_dt", "lstLginDt");
        this.hashFields.put("mbl_apsts_cd", "mblApstsCd");
        this.hashFields.put("mbl_dvc_id", "mblDvcId");
        this.hashFields.put("mbl_spr_adm_flg", "mblSprAdmFlg");
	 ...
	 * @return updDt
	 */
    public String getLstLginDt() {
        return this.lstLginDt;
    }
	 ...
	 * @param updDt
	 */
    public void setLstLginDt(String lstLginDt) {
        this.lstLginDt = lstLginDt;
    }
	 ...
	 * @param mblApstsCd
	 */
    public void setMblApstsCd(String mblApstsCd) {
        this.mblApstsCd = mblApstsCd;
    }
	 ...
	 * @param mblDvcId
	 */
    public void setMblDvcId(String mblDvcId) {
        this.mblDvcId = mblDvcId;
    }
	 ...
	 * @param mblSprAdmFlg
	 */
    public void setMblSprAdmFlg(String mblSprAdmFlg) {
        this.mblSprAdmFlg = mblSprAdmFlg;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setLstLginDt(JSPUtil.getParameter(request, prefix + "lst_lgin_dt", ""));
    ...
    public ComUserVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] lstLginDt = (JSPUtil.getParameter(request, prefix + "lst_lgin_dt", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (lstLginDt[i] != null)
                    model.setLstLginDt(lstLginDt[i]);
                if (viewFlg[i] != null) 
	...
	*/
    public void unDataFormat() {
        ...
        this.lstLginDt = this.lstLginDt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.mblApstsCd = this.mblApstsCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.mblDvcId = this.mblDvcId.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.mblSprAdmFlg = this.mblSprAdmFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
