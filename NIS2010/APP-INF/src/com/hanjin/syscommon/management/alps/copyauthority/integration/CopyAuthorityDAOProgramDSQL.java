...
*@FileName : CopyAuthorityDAOProgramDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopyAuthorityDAOProgramDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CopyAuthorityDAOProgramDSQL(){
		setQuery();
		...
		query.append("FileName : CopyAuthorityDAOProgramDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
