...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.accesshistory.integration;
...
public class LastLoginDateDAOLastLoginDateRSQL implements ISQLTemplate{
	...
	public LastLoginDateDAOLastLoginDateRSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.hanjin.syscommon.management.alps.accesshistory.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("and c.acss_tms BETWEEN TO_DATE(@[from_dt]|| '00:00', 'yyyy-mm-dd hh24:mi') AND TO_DATE(@[to_dt]|| '23:59', 'yyyy-mm-dd hh24:mi')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
