...
/**
 * HTTP Parser<br>
 * - NIS2010.src.com.hanjin.syscommon.management.nis2010.bookmark 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
        ...
        */ 
		...
		if(command.isCommand(FormCommand.MULTI)  || command.isCommand(FormCommand.ADD) || command.isCommand(FormCommand.REMOVE)) {
			...
			ComBookmarkVO combookmark = (ComBookmarkVO)getVO(request, ComBookmarkVO.class);
			event.setCombookmark(combookmark);
		}
