...
*@FileName : JobCodeManagementDBDAOAddJobCodeManagementCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JobCodeManagementDBDAOAddJobCodeManagementCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JobCodeManagementDBDAOAddJobCodeManagementCSQL(){
		setQuery();
		...
		query.append("FileName : JobCodeManagementDBDAOAddJobCodeManagementCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("USR_ROLE_TP_CD" ).append("\n"); 
		query.append(")" ).append("\n"); 
