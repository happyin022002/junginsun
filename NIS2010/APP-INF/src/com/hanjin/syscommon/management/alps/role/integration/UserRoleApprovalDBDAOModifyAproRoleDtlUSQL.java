...
*@FileName : UserRoleApprovalDBDAOModifyAproRoleDtlUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserRoleApprovalDBDAOModifyAproRoleDtlUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserRoleApprovalDBDAOModifyAproRoleDtlUSQL(){
		setQuery();
		...
		query.append("FileName : UserRoleApprovalDBDAOModifyAproRoleDtlUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
