...
public class SearchComUsrRoleVO extends AbstractValueObject {
	 ...
	 */
	public SearchComUsrRoleVO(String ibflag, String pagerows, String level, String delcheck, String status, String lvl, String usrRoleCd, String usrRoleNm, String usrRoleDesc, String prntUsrRoleCd, String userAssign, String progAssign, String creDt, String admYn,String ofcCd,String updDt,String updId,String usrNm) {
		this.level = level;
	...
	public SearchComUsrRoleVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] updId = (JSPUtil.getParameter(request, prefix	+ "upd_id".trim(), length));
