...
import com.hanjin.syscommon.management.alps.copyauthority.basic.CopyAuthorityBC;
import com.hanjin.syscommon.management.alps.copyauthority.basic.CopyAuthorityBCImpl;
import com.hanjin.syscommon.management.alps.copyauthority.event.CopyAuthorityEvent;
	...
	public EventResponse multiCopyAuthority(Event e) throws EventException {
		...
		try{
			...
			for ( int i= 0 ; i < toUsrId.length ; i++ ) {
				...
				hm.put("cre_usr_id", account.getUsr_id());
