...
* 1.0 Creation 
=========================================================*/
package com.hanjin.syscommon.management.alps.console.backendjob.event;
...
public class ComBackendjobEvent extends EventSupport {
	...
	public void setComBakEndJbVOS(ComBakEndJbVO[] comBakEndJbVOs){
		if(comBakEndJbVOs != null){
			ComBakEndJbVO[] tempVOs = Arrays.copyOf(comBakEndJbVOs,comBakEndJbVOs.length); 
			this. comBakEndJbVOs = tempVOs;
		}
	}
	...
	public ComBakEndJbVO[] getComBakEndJbVOS(){
		...
		rtnVOs = Arrays.copyOf(this.comBakEndJbVOs, this.comBakEndJbVOs.length);
		}
		return rtnVOs;
	}
