...
*@FileName : ADM_SYS_0025HTMLAction.java
 ...
 * @author Choi, DukWoo
 * @see AdmSys0025Event 참조
 * @since J2EE 1.6
 */
public class ADM_SYS_0025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	* ADM_SYS_0025HTMLAction 객체를 생성
	*/
	public ADM_SYS_0025HTMLAction() {}

	/**
	* HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
	* HttpRequst의 정보를 AdmSys0025Event로 파싱하여 request에 셋팅<br>
	...
	*/
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		AdmSys0025Event event = new AdmSys0025Event();
