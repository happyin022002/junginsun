...
*@FileName : ProgramMappingDAOComPgmROLECSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProgramMappingDAOComPgmROLECSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProgramMappingDAOComPgmROLECSQL(){
		setQuery();
		...
		query.append("FileName : ProgramMappingDAOComPgmROLECSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
