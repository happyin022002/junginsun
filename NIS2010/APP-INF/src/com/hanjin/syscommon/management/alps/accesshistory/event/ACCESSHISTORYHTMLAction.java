...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.accesshistory.event;
...
public class ACCESSHISTORYHTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * ACCESSHISTORYHTMLAction 객체를 생성
	 */
	public ACCESSHISTORYHTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		AccesshistoryEvent event = new AccesshistoryEvent();
		
		event.setParam("from_dt", request.getParameter("dateFrom")+"00");
		event.setParam("to_dt", request.getParameter("dateTo")+"23");
