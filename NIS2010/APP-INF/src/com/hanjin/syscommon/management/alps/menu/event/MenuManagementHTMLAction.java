...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.menu.event;
...
/**
 * HTTP Parser<br>
 * - NIS2010.APP-INF.src.com.hanjin.syscommon.nis2010.management.menumanagement 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class MenuManagementHTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		event.getComProgramVO().setPgmMnuDivCd(request.getParameter("s_pgm_mnu_div_cd"));
