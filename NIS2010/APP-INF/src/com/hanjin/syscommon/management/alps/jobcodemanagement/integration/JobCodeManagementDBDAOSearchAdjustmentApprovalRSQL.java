...
*@FileName : JobCodeManagementDBDAOSearchAdjustmentApprovalRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JobCodeManagementDBDAOSearchAdjustmentApprovalRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JobCodeManagementDBDAOSearchAdjustmentApprovalRSQL(){
		setQuery();
		...
		query.append("FileName : JobCodeManagementDBDAOSearchAdjustmentApprovalRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE OFC_CD = HDR.RQST_OFC_CD) AS OFC_TP_CD," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("AND HDR.APRO_RQST_NO IN (SELECT APRO_RQST_NO" ).append("\n"); 
		query.append("FROM COM_APRO_ROLE_RQST_ROUT" ).append("\n"); 
		query.append("WHERE APRO_USR_ID = @[rqst_usr_id])" ).append("\n"); 
