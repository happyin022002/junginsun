...
public class ComFaxVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ComFaxVO> models = new ArrayList<ComFaxVO>();
	...
	/* Column Info */
	private String faxSvrSndLoclDt = null;
	/* Column Info */
	...
	/* Column Info */
	private String faxSndLoclDt = null;
	/* Column Info */
	...
	public ComFaxVO(String ibflag, String pagerows, String faxSndNo, String rdSubSysCd, String rdApplCd, String batFlg, String faxTitNm, String faxProcStsCd, String paraInfoCtnt, String rdParaTpCd, String rcvrInfoCtnt, String ofcCd, String faxIp, String rptFileNm, String ttlPgKnt, String xptRsltCd, String xptDt, String xptErrMsg, String ftpRsltCd, String ftpDt, String ftpErrMsg, String faxRsltCd, String faxDt, String faxSndLoclDt, String faxErrMsg, String deltFlg, String xptErrDtlMsg, String thdId, String creUsrId, String creDt, String updUsrId, String updDt, String faxSvrSndLoclDt, String applSvrNm) {
		...
		this.faxSvrSndLoclDt = faxSvrSndLoclDt;
		...
		this.faxSndLoclDt = faxSndLoclDt;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("fax_svr_snd_locl_dt", getFaxSvrSndLoclDt());
		...
		this.hashColumns.put("fax_snd_locl_dt", getFaxSndLoclDt());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("fax_svr_snd_locl_dt", "faxSvrSndLoclDt");
		...
		this.hashFields.put("fax_snd_locl_dt", "faxSndLoclDt");
	...
	/**
	 * Column Info
	 * @return faxSvrSndLoclDt
	 */
	public String getFaxSvrSndLoclDt() {
		return this.faxSvrSndLoclDt;
	}
	 ...
	 * @return faxSndLoclDt
	 */
	public String getFaxSndLoclDt() {
		return this.faxSndLoclDt;
	}
	...
	/**
	 * Column Info
	 * @param faxSvrSndLoclDt
	 */
	public void setFaxSvrSndLoclDt(String faxSvrSndLoclDt) {
		this.faxSvrSndLoclDt = faxSvrSndLoclDt;
	}
	 ...
	 * @param faxSndLoclDt
	 */
	public void setFaxSndLoclDt(String faxSndLoclDt) {
		this.faxSndLoclDt = faxSndLoclDt;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setRptFileNm(JSPUtil.getParameter(request, prefix + "rpt_file_nm", ""));
		setDeltFlg(JSPUtil.getParameter(request, prefix + "delt_flg", ""));
		setXptRsltCd(JSPUtil.getParameter(request, prefix + "xpt_rslt_cd", ""));
		setCreDt(JSPUtil.getParameter(request, prefix + "cre_dt", ""));
		setFaxTitNm(JSPUtil.getParameter(request, prefix + "fax_tit_nm", ""));
		setFtpDt(JSPUtil.getParameter(request, prefix + "ftp_dt", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setFaxRsltCd(JSPUtil.getParameter(request, prefix + "fax_rslt_cd", ""));
		setFtpRsltCd(JSPUtil.getParameter(request, prefix + "ftp_rslt_cd", ""));
		...
		setFaxDt(JSPUtil.getParameter(request, prefix + "fax_dt", ""));
		setXptErrDtlMsg(JSPUtil.getParameter(request, prefix + "xpt_err_dtl_msg", ""));
		setXptDt(JSPUtil.getParameter(request, prefix + "xpt_dt", ""));
		setFaxErrMsg(JSPUtil.getParameter(request, prefix + "fax_err_msg", ""));
		setFaxSvrSndLoclDt(JSPUtil.getParameter(request, prefix + "fax_svr_snd_locl_dt", ""));
		...
		setRcvrInfoCtnt(JSPUtil.getParameter(request, prefix + "rcvr_info_ctnt", ""));
		setFaxProcStsCd(JSPUtil.getParameter(request, prefix + "fax_proc_sts_cd", ""));
		setTtlPgKnt(JSPUtil.getParameter(request, prefix + "ttl_pg_knt", ""));
		setFaxSndLoclDt(JSPUtil.getParameter(request, prefix + "fax_snd_locl_dt", ""));
		setFtpErrMsg(JSPUtil.getParameter(request, prefix + "ftp_err_msg", ""));
		setRdParaTpCd(JSPUtil.getParameter(request, prefix + "rd_para_tp_cd", ""));
	 ...
	 * @return ComFaxVO[]
	 */
	public ComFaxVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ComFaxVO[]
	 */
	public ComFaxVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ComFaxVO model = null;
		...
		try {
			...
			String[] faxSvrSndLoclDt = (JSPUtil.getParameter(request, prefix	+ "fax_svr_snd_locl_dt", length));
			...
			String[] faxSndLoclDt = (JSPUtil.getParameter(request, prefix	+ "fax_snd_locl_dt", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (faxSvrSndLoclDt[i] != null)
					model.setFaxSvrSndLoclDt(faxSvrSndLoclDt[i]);
				if (updUsrId[i] != null)
				...
				if (faxSndLoclDt[i] != null)
					model.setFaxSndLoclDt(faxSndLoclDt[i]);
				if (ftpErrMsg[i] != null)
	 ...
	 * @return ComFaxVO[]
	 */
	public ComFaxVO[] getComFaxVOs(){
		ComFaxVO[] vos = (ComFaxVO[])models.toArray(new ComFaxVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.faxSvrSndLoclDt = this.faxSvrSndLoclDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		...
		this.faxSndLoclDt = this.faxSndLoclDt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
