...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.syscommon.management.alps.pgmcode;

import java.util.Collection;

import com.hanjin.framework.component.util.code.CodeException;
import com.hanjin.framework.core.layer.integration.DAOException;
import com.hanjin.syscommon.management.alps.pgmcode.dao.CodeDAO;
...
public class CodeUtil {
	 ...
	 *  CodeDAO 객체
	 */
	private transient CodeDAO codedao = null;
		 ...
		 Collection codeList = null;
			try {
				if ( "".equals(mainCode)){ // 빈값이면
					codeList = codedao.getCodeList( );
				}else{
				   codeList = codedao.getCodeListForsSubCode(mainCode, sortKey);
				}
