...
*@FileName : JobCodeManagementDBDAOSearchProgramListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JobCodeManagementDBDAOSearchProgramListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JobCodeManagementDBDAOSearchProgramListRSQL(){
		setQuery();
		...
		query.append("FileName : JobCodeManagementDBDAOSearchProgramListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND Y.USR_ROLE_CD(+) = @[usr_role_cd]" ).append("\n"); 
