...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.syscommon.management.alps.schedule.event;
...
import com.hanjin.syscommon.common.table.ComScheduleLog;

/**
 * HTTP Parser<br>
 * - NIS2010.src.com.hanjin.syscommon.management.nis2010 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class ScheduleLogHTMLAction extends HTMLActionSupport {
	...
	/**
        ...
        */ 
		...
		String prefix = "";
		ScheduleLogEvent event = null;
		if(command.isCommand(FormCommand.MULTI)) {
			comschedules = ComScheduleLog.fromRequestGrid(request, prefix);
		}

		if(command.isCommand(FormCommand.SEARCH)) {
			event = new ScheduleLogEvent(null, null); // table value object
			/*
			  Parameter 설정
			*/
