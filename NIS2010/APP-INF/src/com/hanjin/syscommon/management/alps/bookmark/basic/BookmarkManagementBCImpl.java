...
* 1.0 최초 생성
=========================================================*/
package com.hanjin.syscommon.management.alps.bookmark.basic;
...
import com.hanjin.syscommon.management.alps.bookmark.integration.BookmarkManagementDBDAO;
...
public class BookmarkManagementBCImpl extends BasicCommandSupport implements BookmarkManagementBC {
	...
	@Override
	public String searchPgmNoAuthority(String usrId, String pgmNo)	throws EventException {
		try {
			return dbDao.searchPgmNoAuthority(usrId, pgmNo);
		} catch (DAOException de) {
			throw new EventException(de.getMessage());
		} catch (Exception de) {
			log.error("err " + de.toString(), de);
