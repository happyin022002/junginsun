...
*@FileName : ProgramMappingDAOprogramMappingRoleMENURSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProgramMappingDAOprogramMappingRoleMENURSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * programMappingRoleMENU
	  * </pre>
	  */
	public ProgramMappingDAOprogramMappingRoleMENURSQL(){
		setQuery();
		...
		params.put("prnt_role_no",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : ProgramMappingDAOprogramMappingRoleMENURSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		lv as \"level\"	, ").append("\n"); 
		query.append("		pgm_no, " ).append("\n"); 
		query.append("		pgm_nm, " ).append("\n"); 
		query.append("		auth " ).append("\n"); 
		query.append("FROM (SELECT                                                              " ).append("\n"); 
		query.append("      level lv,                                                               " ).append("\n"); 
		query.append("      chd_pgm_no pgm_no,                                                          " ).append("\n"); 
		query.append("      pgm_nm," ).append("\n"); 
		query.append("	  auth," ).append("\n"); 
		query.append("	  CONNECT_BY_ISLEAF as leaf                                                             " ).append("\n"); 
		query.append("FROM (SELECT DISTINCT a.mnu_cfg_cd,a.prnt_pgm_no,a.chd_pgm_no,a.pgm_lvl_val,a.dp_seq" ).append("\n"); 
		...
		query.append("		  (select A.prnt_pgm_no" ).append("\n"); 
		...
		query.append("        and C.usr_role_cd= @[prnt_role_no]       -- 여기엔 role 코드를 Parameter 로 받아서 세팅" ).append("\n"); 
		...
		query.append("WHERE LEAF = 0" ).append("\n"); 
