...
* 1.0 Creation
=========================================================*/
package com.hanjin.syscommon.management.alps.menu.basic;
...
import com.hanjin.syscommon.management.alps.menu.integration.MenuDAO;
		...
		try {
			...
			for ( int i=0; i<commnucfgvo .length; i++ ) {
				if ( commnucfgvo[i].getIbflag().equals("I")){
					commnucfgvo[i].setCreUsrId(account.getCre_usr_id());
					commnucfgvo[i].setUpdUsrId(account.getCre_usr_id());
