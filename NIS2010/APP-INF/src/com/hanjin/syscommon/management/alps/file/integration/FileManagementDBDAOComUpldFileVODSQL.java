...
public class FileManagementDBDAOComUpldFileVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public FileManagementDBDAOComUpldFileVODSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : FileManagementDBDAOComUpldFileVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}