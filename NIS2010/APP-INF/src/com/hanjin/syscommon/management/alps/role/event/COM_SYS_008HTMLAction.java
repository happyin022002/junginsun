...
public class COM_SYS_008HTMLAction extends HTMLActionSupport {
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		String usrRoleCd = JSPUtil.getParameter(request, "usrRoleCd".trim(), "");
		String usrRoleNm = JSPUtil.getParameter(request, "usrRoleNm".trim(), "");
		...
		event.setUsrRoleCd(usrRoleCd);
		event.setUsrRoleNm(usrRoleNm);
		
		if(command.isCommand(FormCommand.MULTI)) {
			ComUsrRoleMtchVO[] comUsrRoleMtchVOs = (ComUsrRoleMtchVO[])getVOs(request, ComUsrRoleMtchVO.class);
			...
			event.setComUsrRoleVO((ComUsrRoleVO)getVO(request, ComUsrRoleVO.class));
		}
