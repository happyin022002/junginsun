...
*@FileName : JobCodeManagementDBDAOModifyAdjustmentRequestRoutUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class JobCodeManagementDBDAOModifyAdjustmentRequestRoutUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public JobCodeManagementDBDAOModifyAdjustmentRequestRoutUSQL(){
		setQuery();
		...
		query.append("FileName : JobCodeManagementDBDAOModifyAdjustmentRequestRoutUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
