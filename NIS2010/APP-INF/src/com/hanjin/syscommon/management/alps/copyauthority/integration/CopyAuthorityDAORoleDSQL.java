...
*@FileName : CopyAuthorityDAORoleDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CopyAuthorityDAORoleDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * user vs role mapping delete
	  * </pre>
	  */
	public CopyAuthorityDAORoleDSQL(){
		setQuery();
		...
		query.append("FileName : CopyAuthorityDAORoleDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
