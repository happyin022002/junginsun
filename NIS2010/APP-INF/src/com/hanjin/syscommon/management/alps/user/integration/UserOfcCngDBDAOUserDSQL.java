...
*@FileName : UserOfcCngDBDAOUserDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class UserOfcCngDBDAOUserDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public UserOfcCngDBDAOUserDSQL(){
		setQuery();
		...
		query.append("FileName : UserOfcCngDBDAOUserDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM COM_USR_OFC_CNG" ).append("\n"); 
