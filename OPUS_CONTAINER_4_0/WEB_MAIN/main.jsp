...
<%
  ...
  if(account != null){
  	...
  	log.info("LoginCnt; " + account.getUsr_id() +"; " + SiteConfigFactory.get(SiteConfigFactory.SYSTEM_TYPE));
  }
...
String error_kind = StringUtil.xssFilter(request.getParameter("FORM_ERR_KIND"));
