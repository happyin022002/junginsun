            ...
            case 1:      //IBSheet1 init
                with(sheetObj){                        
                      ...
                      if(mainPage == undefined){
                          HeadTitle="Sel|Sel|Seq|Location|Location Name|SCC|LCC|RCC|Country";
                      }else{
                          HeadTitle="Seq|Location|Location Name|SCC|LCC|RCC|Country";
                      }
                      ...
                      if(mainPage == undefined){
                          ...
                          var cols = [ {Type:"Radio",     Hidden:0, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"radio",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                                 ...
                                 {Type:"Text",      Hidden:0,  Width:180,  Align:"Left",    ColMerge:0,   SaveName:"loc_nm",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                                 {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"scc_cd",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:-1 },
                                 {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"lcc_cd",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:-1 },
                                 {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"rcc_cd",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:-1 },
...
/*
                ...
                case "Code_Detall":
                    ...
                    //ComOpenPopup('/opuscntr/ESD_TRS_0980.do' + param, 900, 450, 'getESD_TRS_0980_1', dispaly);
                    break;
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch("ESD_TRS_0980GS.do", selectVal );
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value=SEARCH;
                selectVal=FormQueryString(formObj);
                sheetObj.DoSearch("ESD_TRS_0980GS.do", selectVal+"&iPage=" + PageNo,{Append:true} );
