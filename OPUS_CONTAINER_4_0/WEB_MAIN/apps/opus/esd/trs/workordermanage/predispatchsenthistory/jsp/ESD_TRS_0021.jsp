...
<%@ page import="com.clt.apps.opus.esd.trs.workordermanage.predispatchsenthistory.event.EsdTrs0021Event"%>
<%
	        ...
	        <tbody>
	            <tr>
	                ...
	                <td class="sm" colspan="3" align="center">
	                    ...
	                    <input type="radio" name="rad_wonotic" class="trans" value="N"> Notice Sent&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    <input name="frm_plandate" type="text" maxlength="8" style="width:75px" onFocus="javascript:delHypen(this);" onBlur="javascript:getHypen(this);">&nbsp;~&nbsp;
	                    <input name="to_plandate" type="text" maxlength="8" style="width:75px" onFocus="javascript:delHypen(this);" onBlur="javascript:getHypen(this);" onKeyup="javascript:doSearchEnter();">
	            ...
	            <tr>
	                ...
	                <td colspan="3">
	                    ...
	                    <input type="text" name="trsp_so_vndr_no" style="width:427px;" readonly value="" class="input2">
...
<div class="opus_design_grid" >
    ...
    <div class="opus_design_btn">
        ...
        <button type="button" class="btn_normal" name="btng_statushistory" id="btng_statushistory">Status Inquiry</button>
