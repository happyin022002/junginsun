...
<%@ page import="com.clt.apps.opus.esd.trs.workordermanage.workordermanagement.event.EsdTrs0979Event"%>
<%
	EsdTrs0979Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
	    ...
	    event = (EsdTrs0979Event)request.getAttribute("Event");
