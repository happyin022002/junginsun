...
<%@ page import="com.clt.apps.opus.esd.trs.workordermanage.emptyreleaseredeliveryordermgt.event.EsdTrs0429Event"%>
<%
  EsdTrs0429Event  event = null; 
  ...
  try {
    ...
    event = (EsdTrs0429Event)request.getAttribute("Event");
...
<input type="hidden" name="sub_sys_cd" value="TRS">                    <!-- Mail Module -->
...
<input type="hidden" name="tmpl_mrd" value="ESD_TRS_0451.mrd">         <!-- Mail Template MRD -->
    ...
    <div class="opus_design_inquiry wFit">   <!-- no TAB  -->
        <table>
             <tr>
               <th>Date</th>
               <td colspan="3">
                  <input type="text" style="width:84px;ime-mode:disabled;" class="input1" value="<%=pDate1%>" tabindex="1" id="p_date1" name="p_date1" dataformat="ymd" onblur="getDateBetween(this);"><!--
                  --><span class="dash">-</span><!--
                  --><input type="text" style="width:85px;ime-mode:disabled;" class="input1" value="<%=pDate2%>" tabindex="2" id="p_date2" name="p_date2" dataformat="ymd"><!--
             ...
             <tr>
               ...
               <td colspan="3"><input type="text" style="width:120px;ime-mode:disabled;" class="input" maxlength="13" tabindex="6" name="bl_no" dataformat="engup"></td>
               <th>Empty CY</th>
               <td colspan="3"><input type="text" style="width:72px;ime-mode:disabled;" class="input" maxlength="5" tabindex="9" name="yd_cd_disp" dataformat="engup" onBlur="obj_onkeyup();"><!--
             ...
             <tr>
               ...
               <td width="130"><select style="width:61px;" tabindex="5" name="issued">
               ...
               <td><input type="text" style="width:121px;ime-mode:disabled;" class="input" maxlength="13" tabindex="11" name="wo_no" dataformat="engup"></td>
             </tr>
        </table>
    </div>
</div>
