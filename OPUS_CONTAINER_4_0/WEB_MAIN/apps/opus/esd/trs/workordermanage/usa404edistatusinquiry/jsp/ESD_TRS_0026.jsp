...
<%@ page import="com.clt.apps.opus.esd.trs.workordermanage.usa404edistatusinquiry.event.EsdTrs0026Event"%>
<%
	EsdTrs0026Event  			event 			= null;		//PDTO(Data Transfer Object including Parameters)
	...
	try {
       ...
       bkg_cgo_tp_cd       = JSPUtil.getNull(request.getParameter("bkg_cgo_tp_cd")     ); //OK
       ...
       bzc_amt             = JSPUtil.getNull(request.getParameter("bzc_amt")); //OK
		...
		event 				= (EsdTrs0026Event)request.getAttribute("Event");
...
<input type="hidden" name="cgo_tp_cd" value="<%=bkg_cgo_tp_cd.equals("R")&cgo_tp_cd.equals("F")?"M":cgo_tp_cd%>" id="cgo_tp_cd" />
...
<input type="hidden" name="spcl_cgo_cntr_tp_cd" value="<%=spcl_cgo_cntr_tp_cd%>" id="spcl_cgo_cntr_tp_cd" />
...
<div class="page_title_area clear">
	...
	<!-- page_title(S) -->
	<h2 class="page_title"><span>Surcharge for USA/CA Rail</span></h2>
	<!-- page_title(E) -->
		...
		<table>
		   ...
		   <tbody>
		   		...
		   		<tr>
					...
					<td><input type="text" style="width:50px;background-color: white;" name="bkg_cgo_tp_cd" id="bkg_cgo_tp_cd" value="<%=bkg_cgo_tp_cd.equals("R")?"Y":"N"%>" align="center" readonly></td>
		   		</tr>
		   </tbody>
		</table>		
	</div>
