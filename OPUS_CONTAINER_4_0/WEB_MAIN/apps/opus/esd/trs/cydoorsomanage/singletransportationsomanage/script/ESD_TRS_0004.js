		...
		switch(srcName) {
			...
			case "btng_officetransfer": //Office Transfer button
				if( doOfficeTrans(sheetObject) ) {
					ComOpenPopup('ESD_TRS_0930Pop.screen', 500, 180, '', '0,0', true);
				}
				break;
...
function loadPage() {
	...
	for (var i=0; i < comboObjMaxLen; i++) {
...
function initSheet(sheetObj, sheetNo) {
	switch(sheetObj.id) {
		case "t1sheet1":
			      ...
			      HeadTitle0 += "Web D/O|Web D/O|Web D/O|Web D/O|Web D/O|Web D/O|Multi\nStop|Estimated Time|Estimated Time|";
				  HeadTitle0 += "Estimated Time|Estimated Time|Estimated Time|Estimated Time|Estimated Time|Estimated Time|";
				  HeadTitle0 += "Latest Movement Status|Latest Movement Status|Latest Movement Status|Full CGO CCT|Port CCT|COP No|A/G SEQ|A/G Code|S/O Status|BKG No|Master BKG No|BL No|BND|Term|";
			      ...
			      HeadTitle0 += "|stop_off_loc_cd|stop_off_cntc_pson_nm|stop_off_cntc_phn_no|stop_off_diff_rmk";
			      
			      var HeadTitle1="Sel.|STS|CB|SOURCE|BKG\nStat.|BKG\nStat.|CNTR No.|TP / SZ|Cost\nMode|Trans\nMode|";
			      HeadTitle1 += "Loc|Node|Loc|Node|Loc|Node|Loc|Zone|Name|";
			      HeadTitle1 += "Actual\nCustomer|Factory\nName|Zip\nCode|Address|";
			      HeadTitle1 += "TEL|FAX|PIC|Remark\n(Special Instruction)|";
			      HeadTitle1 += "UserID|UserName|Phone No|Email|Time|Time|Multi\nStop|From Departure|From Departure|";
			      HeadTitle1 += "To Arrival|To Arrival|Door Arrival|Door Arrival|TRO Door Date|TRO Door Date|";
			      HeadTitle1 += "Status|Yard|Date|Full CGO CCT|Port CCT|COP No|A/G SEQ|A/G Code|S/O Status|BKG No|Master BKG No|BL No|BND|Term";
			      ...
			      HeadTitle1 += "Customs\nC.LOC|USA\nLast City|";
			      HeadTitle1 += "F|O|C|Pickup No.|Available DT|Available DT|Last Free DT|Last Free DT|S/C No|";
			      HeadTitle1 += "Customs\nClearance|Customs\nClearance No|RFA No|Used|Imm.\nExit|L/T|";
			      HeadTitle1 += "Door\nSVC TP|Internal\nRemark|S/O Office|IRG|";
			      ...
			      var cols = [ {Type:"CheckBox",  Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"chk1" },
					             ...
					             {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"fm_nod_cd",                   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:5, AcceptKeys:"E|N", InputCaseSensitive:1 },
					             ...
					             {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"via_nod_cd",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:5, AcceptKeys:"E|N", InputCaseSensitive:1 },
					             ...
					             {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"to_nod_cd",                   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:5, AcceptKeys:"E|N", InputCaseSensitive:1 },
					             ...
					             {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"dor_nod_cd",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:5, AcceptKeys:"E|N", InputCaseSensitive:1 },
					             ...
					             {Type:"Text",      Hidden:0, Width:150,  Align:"Left",    ColMerge:1,   SaveName:"fctry_nm",                    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
					             {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"dor_pst_cd",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:10 },
					             {Type:"Text",      Hidden:0, Width:150,  Align:"Left",    ColMerge:1,   SaveName:"dor_de_addr",                 KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:200 },
					             ...
					             {Type:"Text",      Hidden:0, Width:100,  Align:"Left",    ColMerge:1,   SaveName:"cntc_pson_nm",                KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
					             ...
					             {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"usa_do_usr_info",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:255 },
					             {Type:"Text",      Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"usa_do_usr_info1",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:255 },
					             {Type:"Text",      Hidden:0, Width:120,  Align:"Center",  ColMerge:1,   SaveName:"usa_do_usr_info2",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:255 },
					             {Type:"Text",      Hidden:0, Width:150,  Align:"Center",  ColMerge:1,   SaveName:"usa_do_usr_info3",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:255 },
					             {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"do_cre_date",                 KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:255 },
					             {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"do_cre_time",                 KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:255 },
					             {Type:"Text",      Hidden:1, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"mlt_stop_de_flg",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
					             {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"n1st_nod_pln_dt",             KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
					             ...
					             {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"lst_nod_pln_dt",              KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
					             ...
					             {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"dor_nod_pln_dt",              KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:1,   UpdateEdit:1,   InsertEdit:1 },
					             ...
					             {Type:"Text",      Hidden:0,  Width:130, Align:"Center",  ColMerge:1,   SaveName:"r_cct",					  	 KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		                         {Type:"Text",      Hidden:0,  Width:130, Align:"Center",  ColMerge:1,   SaveName:"t_cct",					  	 KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"tro_seq",                     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"tro_cnfm",                    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"tro_cfm_ofc_cd",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"tro_cfm_usr_id",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"tro_cfm_upd_dt1",             KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"tro_cfm_upd_dt2",             KeyField:0,   CalcLogic:"",   Format:"Hms",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"tro_cfm_curr_cd",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"tro_cfm_rev_amt",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"tro_lod_ref_no",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"tri_axl_req_flg",           	 KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Float",     Hidden:0, Width:100,  Align:"Right",   ColMerge:1,   SaveName:"vgm_kgs_wgt",                 KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Float",     Hidden:0, Width:100,  Align:"Right",   ColMerge:1,   SaveName:"vgm_lbs_wgt",                 KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Right",   ColMerge:1,   SaveName:"cntr_wgt",                    KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Float",     Hidden:0, Width:100,  Align:"Right",   ColMerge:1,   SaveName:"cntr_lbs_wgt",                KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Text",      Hidden:1, Width:50,   Align:"Right",   ColMerge:1,   SaveName:"noofpkg",                     KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"del_cd",                      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:1,   SaveName:"rail_to_nod_cd",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"rail_cre_dt_dd",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"rail_cre_dt_hms",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"ibd_cstms_clr_loc_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Combo",     Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"lst_loc_cd",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
					             {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"cgor_frt_pay_ind_flg",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"cgor_org_bl_rcvr_ind_flg",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"cgor_cstms_acpt_re_ind_flg",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"cntr_pkup_no",                KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Date",      Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"aval_dt",                     KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"aval_dt_hms",                 KeyField:0,   CalcLogic:"",   Format:"Hms",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Date",      Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"lst_free_dt",                 KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"lst_free_dt_hms",             KeyField:0,   CalcLogic:"",   Format:"Hms",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:100,  Align:"Left",    ColMerge:1,   SaveName:"sc_no",                       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Combo",     Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"dor_svc_tp_cd",               KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
					             ...
					             {Type:"Text",      Hidden:0, Width:110,  Align:"Center",  ColMerge:1,   SaveName:"trns_rqst_ofc_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:1,   UpdateEdit:0,   InsertEdit:0 },
					             {Type:"Text",      Hidden:0, Width:130,  Align:"Center",  ColMerge:1,   SaveName:"trns_rqst_usr_id",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
					             ...
					             {Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"lse_cntr_flg",                KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
...
//			      SetRangeBackColor(1,5,1,22,"#555555");
//			      SetRangeBackColor(1,24,1,38,"#555555");
//			      SetRangeBackColor(1,84,1,85,"#555555");
//			      SetRangeBackColor(1,92,1,93,"#555555");
			      ComResizeSheet(sheetObj);
			break;

		case "sheet2":  {
			  var HeadTitle0="Office Code|Seqence";
		      sheetObj.SetConfig( { SearchMode:2,Page:20, ataRowMerge:1 } );
		...
		case "t4sheet1": {
			...
			sheetObj.SetConfig( { SearchMode:2, Page:20, DataRowMerge:1 } );
	      	var headers = [ { Text:HeadTitle0, Align:"Center"} ];
	      	sheetObj.InitHeaders(headers, {});
...
function initCombo(comboObj, comNo) {
 	...
 	switch (comboObj.options.id) {
 		...
 		case "door_svc_tp": {
 			...
 			with (comboObj) {
 				InsertItem(i++, "", "");
 				InsertItem(i++, "Undecided", "Undecided");
 				InsertItem(i++, "Live Load", "Live Load");
 				InsertItem(i++, "Live Unload", "Live Unload");
 				InsertItem(i++, "Street Turn", "Street Turn");
 				InsertItem(i++, "Drop and Pick", "Drop and Pick");
 				SetSelectIndex(0);
 				SetDropHeight(300);
 			}
 			break;
...
function validateFormSearch(formObj) {
	...
	// From, To Multi 조회 옵션 필수항목 제약 해제
	var lvfrm_node_multi = doSepRemove(formObj.search_fm_node.value, " ");
	var lvto_node_multi = doSepRemove(formObj.search_to_node.value, " ");
	...
	if( lvfrmDate == "" && lvtoDate != "" ) { 
		...
		if( lvtrunk_vvd == "" && lvbkg_no == "" && lvbill_no == "" && lvcntr_no == "" && lvcontract_no == "" && lvfrm_node == "" && lvto_node == "" && lvdor_loc == "" && lvfrm_node_multi == "" && lvto_node_multi == "") {
	...
	if( document.form.unplan_shuttle.checked ) {
		if( lvfrm_node == "" && document.form.search_fm_node.value == "" ) {
			ComShowCodeMessage("TRS90410", "From Node");
			return false;
		} else {
			if( lvtrunk_vvd == "" && lvbkg_no == "" && lvbill_no == "" && lvcntr_no == "" && lvcontract_no == "" && lvfrm_node == "" && lvto_node == "" && lvdor_loc == "" && lvfrm_node_multi == "" && lvto_node_multi == "") {
				ComShowCodeMessage("TRS90410", "From Node");
...
//tab1's sheet is information about
		...
		if( doengnumcheck(lvfm) ) {
			if( lvfm.length == 5 ) {
				...
				if( sheetObj.GetCellValue(row, "fm_nod_cd") != "" ) {
					...
					getUSALastCitySheetCombo(sheetObj, document.form, row, "lst_loc_cd");
				} else {
...
function validateForm(sheetObj, formObj) {
	...
	for( var i=0; i<arrRow.length; i++ ) {
		...
		var lvcgo_tp_cd=sheetObj.GetCellValue(fromRow, "cgo_tp_cd"); //CGO_TP_CD Empty, Full구분
		...
		var lv_fm_loc_conti_cd=doSepRemove(sheetObj.GetCellValue(fromRow, "fm_loc_conti_cd"), " "); //2007.12.27 jsk
...
//        }		
		/**
		 * docUnconfirm : ''PROVISION' if 'Y' or 'N'
		 */
		/* 'Door' Term Only */
		if( lvcostmod == "DOOR" ) {
		    /* 'PROVISION' */
		...
		if( docUnplanshuttle == "Y" ) {
			...
			if( lvcgo_tp_cd == "M" ) { //Empty a difference if the day
				if( lvfmnod == lvtonod ) {
					ComShowCodeMessage("TRS90134");
					return false;
				}
...
/*
* Business Validation Check / Combined CNTR Trans. Case One and Single Transportation check the relationship
*/
...
/*
* Combined CNTR Trans. Case Two checking
*/
...
/*
* Multiple Apply checking
* Multiple Apply Popup 
*/
...
//Combined CNTR Trans. Case One --> Single Transportation(used for rollback)
...
//Combined CNTR Trans. Case Two --> Single Transportation(used for rollback)
...
function t1sheet1_OnPopupClick(sheetObj, row, col) {
	...
	} else if(  sheetObj.ColSaveName(col) == "stop_off_flg") {
...
function applyAtualCustomer(winObj, selected_row, act_cust_cd, act_cust_cnt_cd, act_cust_seq, act_cust_addr_seq, act_cust_nm, factory_nm, factory_zip_code, factory_addr, factory_tel_no, factory_fax_no, pic_nm) {
	if( sheetObjects[0].GetCellValue(selected_row, "trsp_cost_dtl_mod_cd") == "DOOR" ) {
 		sheetObjects[0].SetCellValue(selected_row, "act_cust_cd",act_cust_cd, 0);
...
function popSearchPiCommCodeGrid(classID,midCD,cdName,sheetName,sRow,colCode,colName){
	...
	var url = myUrl+"?class_id="+classID + "&mid_cd="+midCD + "&cdName="+cdName+ "&sheetName="+sheetName+ "&sRow="+sRow+ "&colCode="+colCode+ "&colName="+colName;
	var myWin=window.open(url, "piCommCodePop", myOption);
}
/**
...
function t1sheet1_OnSearchEnd(sheetObj,errMsg){
    ...
    for(var k = sheetObj.HeaderRows(); k < sheetObj.RowCount() + sheetObj.HeaderRows(); k++) {
        ...
        sheetObj.SetCellEditable(k, "stop_off_flg", 1);
    }
}
/**
 * Tool Tip
...
/**
 * sheet내의 USA Last City combo를 가져와서 등록한다.(셀단위)
 ...
 **/
function getUSALastCitySheetCombo(sheetObj, formObj, row, colName) {
	var org_loc_cd = "";
	var dest_loc_cd = "";
	formObj.f_cmd.value = SEARCH02;
	if (sheetObj.GetCellValue(row, "trsp_cost_dtl_mod_cd") == "CY") {
		org_loc_cd = sheetObj.GetCellValue(row, "fm_nod_cd");
		dest_loc_cd = sheetObj.GetCellValue(row, "to_nod_cd");
	} else {
		org_loc_cd = sheetObj.GetCellValue(row, "fm_nod_cd");
		dest_loc_cd = sheetObj.GetCellValue(row, "dor_nod_cd");
	}
	var queryString = "org_loc_cd=" + org_loc_cd + "&dest_loc_cd=" + dest_loc_cd + "&" + FormQueryString(formObj);
	var sXml = sheetObj.GetSearchData("ESD_TRS_0076GS.do", queryString);
	var lst_cty_value = ComXml2ComboString(sXml, colName, colName);
	sheetObj.CellComboItem(row, colName, { ComboText : lst_cty_value[0], ComboCode : lst_cty_value[0] });
	if (lst_cty_value[0] != "") {
		sheetObj.SetCellValue(row, sheetObj.SaveNameCol(colName), lst_cty_value[0].split("|")[0]);
	}
}
