...
<%
	...
	try {
		...
		selDOORSVCTP  = JSPUtil.getCodeCombo("dor_svc_tp_cd", "01", "style='width:48'", "CD00284", 0, "000020::");
...
<div class="page_title_area clear">
	...
	<input name="ui_conti_cd" type="hidden" value="M">
	<!-- opus_design_btn (S) -->
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				<th>Date</th>
				<td class="sm">
				    <input type="radio" name="rad_dateSep" id="rad_dateSep1" class="trans" value="P" checked><label for="rad_dateSep1">Planned Departure</label> 
				    <input type="radio" name="rad_dateSep" id="rad_dateSep2" value="D" class="trans"><label for="rad_dateSep2">Door Arrival </label>
				    <input type="radio" name="rad_dateSep" id="rad_dateSep3" value="R" class="trans"><label for="rad_dateSep3">Rail Creation</label>
				</td>
				<td class="sm">
				    <input name="frm_plandate" type="text" class="input1" style="width:75px;" value="" maxlength="8" onfocus="javascript:delHypen(this);" onblur="javascript:getHypen(this); getDateBetween(this);" id="frm_plandate" dataformat="ymd" />~ <input id="to_plandate" name="to_plandate" type="text" class="input1" style="width:75px;" value="" maxlength="8" onFocus="javascript:delHypen(this);" onBlur="javascript:getHypen(this);" onKeyup="javascript:doSearchEnter();" dataformat="ymd"><button type="button" id="btns_calendar" name="btns_calendar" class="calendar ir"></button>
				</td>
			    <th>CY/Door</th>
			    <td><SELECT name = "cydoor_div" style='width:70px' onChange="getCostModeCombo(sel_costmode);" ><OPTION  value="DR">DOOR</OPTION><OPTION  value="CY">CY</OPTION></SELECT></td>
				<td><input type="checkbox" name="unplan_shuttle" value="" class="trans" onclick="javascript:fun_chekcbox('01');" id="unplan_shuttle" /><strong><label for="unplan_shuttle">Unplanned</label></strong><!--  
				 --><input type="checkbox" name="tro_unconfirm_dr" value="" class="trans" onclick="javascript:fun_chekcbox('03');" id="tro_unconfirm_dr" /><strong><label for="tro_unconfirm_dr">Provision</label></strong></td>
			</tr>
		</table>
		<table>
			<colgroup>
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				...
				<th>F.VVD</th>						
				<td class="sm"><input type="radio" name="feeder_vvd" class="trans" value="A" checked id="feeder_vvd" /><label for="feeder_vvd">All</label><input type="radio" name="feeder_vvd" class="trans" value="I" id="feeder_vvd" /><label for="feeder_vvd">In VVD</label><input type="radio" name="feeder_vvd" class="trans" value="O" id="feeder_vvd" /><label for="feeder_vvd">Out VVD</label></td>
				...
				<td>
					<script type="text/javascript">ComComboObject('stop_off_flg', 1, 50, 0)</script>
				</td>
				<th title="Stop Off">Tri-axle</th>
				<td>
					<script type="text/javascript">ComComboObject('tri_axl_req_flg', 1, 50, 0)</script>
				</td>
			</tr>
		</table>
		<table>
			...
			<tr>
				...
				<th>Container No.</th>
				<td><input name="cntr_no" type="text" style="width:93px;" onkeyup="javascript:doSearchEnter();" onchange="javascript:this.value=multiCntrChkDgt(this.value);" onblur="setgetUpper(this);" id="cntr_no"  dataformat="engup" otherchar=","/><button type="button" id="btns_multicntr" name="btns_multicntr" class="multiple_inq ir"></button></td>
				<th>Contract No.</th>
				<td class="sm"><input type="radio" name="contract_tp_cd" id="contract_tp_cd1" class="trans" value="S" checked><label for="contract_tp_cd1">S/C</label><input type="radio" name="contract_tp_cd" id="contract_tp_cd2" class="trans" value="R"><label for="contract_tp_cd2">RFA</label></td>
				...
				<th title="Stop Off">Door SVC TP</th>
				<td>
					<%=selDOORSVCTP %>
				</td>
