    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
           ...
           case IBSEARCH:      //조회
               ...
               //sheetObj.DoSearch4Post("com.clt.apps.bms.bms.pfm.managemarketstatus.UIBMSPFM001Action.do", TrsFrmQryString(formObj));
                break;
            case IBSAVE:        //저장
              if(validateForm(sheetObj,formObj,sAction))
//                  ComShowMessage (" Save .. ");
//                formObj.f_cmd.value = MULTI;
                ...
                //sheetObj.DoAllSave("com.clt.apps.bms.bms.pfm.managemarketstatus.UIBMSPFM001Action.do", TrsFrmQryString(formObj));
                break;
