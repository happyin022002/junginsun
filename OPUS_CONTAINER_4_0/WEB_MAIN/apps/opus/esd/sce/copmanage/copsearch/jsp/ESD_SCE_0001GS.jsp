...
<%@ page import="com.clt.apps.opus.esd.sce.copmanage.copsearch.event.ESD_SCE_0001EventResponse_N"%>
<%@ page import="com.clt.apps.opus.esd.sce.copmanage.copsearch.event.ESD_SCE_0001Event_N"%>
