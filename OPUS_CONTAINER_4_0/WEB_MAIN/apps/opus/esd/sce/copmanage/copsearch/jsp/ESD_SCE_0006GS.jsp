...
<%@ page import="com.clt.apps.opus.esd.sce.copmanage.copsearch.event.ESD_SCE_0006Event"%>
<%@ page import="com.clt.apps.opus.esd.sce.copmanage.copsearch.event.ESD_SCE_0006EventResponse"%>
...
<%@ page import="com.clt.apps.opus.esd.sce.copmanage.copupdate.event.ESD_SCE_0006Event_U" %>
<%@ page import="com.clt.apps.opus.esd.sce.copmanage.copupdate.event.ESD_SCE_0006EventResponse_U" %>
