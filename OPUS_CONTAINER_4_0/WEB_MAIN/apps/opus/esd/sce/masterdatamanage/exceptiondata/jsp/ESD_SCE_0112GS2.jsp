...
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.exceptiondata.event.ESD_SCE_0112Event"%>
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.exceptiondata.event.ESD_SCE_0112EventResponse"%>
...
%>
    ...
    <TR>
        ...
        <TD><![CDATA[<%=JSPUtil.getNull(rowSet.getString("MAPG_OFC_CD"))%>]]></TD>
        <TD><![CDATA[<%=JSPUtil.getNull(rowSet.getString("MAPG_OFC_ENG_NM"))%>]]></TD>
