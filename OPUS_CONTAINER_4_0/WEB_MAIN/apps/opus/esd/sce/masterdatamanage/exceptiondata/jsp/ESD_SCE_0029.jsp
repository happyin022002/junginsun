...
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.exceptiondata.event.EsdSce0029Event"%>
				...
				<td class="bg">
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td width="250"><input name="cnt_cd" type="text" style="width:80; text-transform:uppercase;" value="" maxlength="5" onkeyup="e=event.keyCode; if(e==9) { } else{ this.value=this.value.toUpperCase(); } ">&nbsp;<img onclick="openCntPop(false,'cnt_cd')" class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"  ></td>
							<td width="140">Location Code</td>
							<td width=""><input name="loc_cd" type="text" style="width:80; text-transform:uppercase;" value="" maxlength="5" onkeyup="e=event.keyCode; if(e==9) { } else{ this.value=this.value.toUpperCase(); } ">&nbsp;<img onclick="openLocPop(true,'loc_cd')" class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"  ></td>
