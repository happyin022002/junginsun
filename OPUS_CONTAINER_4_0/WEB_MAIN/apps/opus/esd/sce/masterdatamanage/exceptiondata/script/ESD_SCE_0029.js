...
function initSheet(sheetObj,sheetNo) {
	...
	switch(sheetNo) {
        ...
        InitDataProperty(0, cnt++ , dtHidden,     0,    daCenter,  false,   "r_act_cd2_nm",         false,        "",      dfNone,     	0,          false,     false);
				...
				//setting Combo information[ROW, COL, COMBO-TEXT, COMBO-CODE, DEFAULT-TEXT] 			//sheetObj.CellValue2(sheetObj.SelectRow, "r_loc_cd") = "ALL";
...
/**
 * Contry in the pop-up function that calls the Common
 *
 * @param rowArray 
 */
