...
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.activitydata.event.ESD_SCE_0024Event"%>
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.activitydata.event.ESD_SCE_0024EventResponse"%>
