...
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.activitydata.event.ESD_SCE_0022Event"%>
<%@ page import="com.clt.apps.opus.esd.sce.masterdatamanage.activitydata.event.ESD_SCE_0022EventResponse"%>
