 ...
 ***************************************************************************************/
	/**
	 * @extends
	 * @class ees_sce_0000 : business script for ees_sce_0000
	 */
	function ees_sce_0000() {
		...
		switch(sAction) {
			case IBSAVE:
				...
				frmObj.f_cmd.value=SEARCH;
 				var saveXml=sheetObjects[0].GetSaveData("ESD_SCE_0000GS.do", sheetObjects[0].GetSaveString() + "&" + FormQueryString(frmObj));
