...
<html>
<head>
<title>Welcome to OPUS! Program TEST for Non UI programs</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<script>
        function command01Calling(commandName){
			if(commandName == "COMMAND01")
		      document.form.action="http://localhost:8001/opuscntr/ESD_SCE_NTEST1.do?f_cmd=" + COMMAND01;
            if(commandName == "COMMAND02")
              document.form.action="http://localhost:8001/opuscntr/ESD_SCE_NTEST1.do?f_cmd=" + COMMAND02;
		    if(commandName == "COMMAND03")
			  document.form.action="http://localhost:8001/opuscntr/ESD_SCE_NTEST1.do?f_cmd=" + COMMAND03;
		    if(commandName == "COMMAND04")
			  document.form.action="http://localhost:8001/opuscntr/ESD_SCE_NTEST1.do?f_cmd=" + COMMAND04;
		    if(commandName == "COMMAND05")
			  document.form.action="http://localhost:8001/opuscntr/ESD_SCE_0150.do?f_cmd=" + SEARCH;
		    if(commandName == "COMMAND06")
			  document.form.action="http://localhost:8001/opuscntr/ESD_SCE_0151.do?f_cmd=" + SEARCH;
