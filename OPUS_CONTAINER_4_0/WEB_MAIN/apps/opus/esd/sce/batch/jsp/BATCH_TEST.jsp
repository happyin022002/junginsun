...
<%@ page import="com.clt.apps.opus.esd.sce.batch.batchexceptionidentify.event.IbatchVisibilityEvent"%>
<%@ page import="com.clt.apps.opus.esd.sce.batch.batchexceptionidentify.event.IbatchVisibilityEventResponse"%>
<%
...
<table  class="search" border="0" >
	<tr>
		<td>
			Please, Select one from lower part : <img class="cursor" src="/opuscntr/img/opus/button/btn_retrieve.gif" width="66" height="20" border="0" name="btn_retrieve">
		</td>					
	</tr>
</table>
