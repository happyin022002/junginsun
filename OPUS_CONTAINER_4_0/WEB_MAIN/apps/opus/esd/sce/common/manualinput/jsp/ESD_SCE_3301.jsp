...
<%@ page import="com.clt.apps.opus.esd.sce.common.manualinput.event.EsdSce3301Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsdSce3301Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsdSce3301Event)request.getAttribute("Event");
...
<input type="hidden" name="chk_act_cd">
<input type="hidden" name="chk_act_sts_mapg_cd">
<input type="hidden" name="chk_act_rcv_tp_cd">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <th>Actual Code</th>
                    <td>
                        <input type="text" style="width:60px; ime-mode:disabled; text-transform:uppercase;"name="frm_act_cd"   dataformat="engup" maxlength="6">
                    </td>
                    <th>Activity Status Mapping Code</th>
                    <td>
                        <input type="text" style="width:60px; ime-mode:disabled; text-transform:uppercase;"name="frm_act_sts_mapg_cd" class="input" dataformat="engup" maxlength="6">
                    </td>
                </tr>
            </tbody>
        </table>
