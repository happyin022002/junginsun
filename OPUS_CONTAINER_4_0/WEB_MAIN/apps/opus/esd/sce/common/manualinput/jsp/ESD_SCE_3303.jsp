...
<%@ page import="com.clt.apps.opus.esd.sce.common.manualinput.event.EsdSce3303Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EsdSce3303Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsdSce3303Event)request.getAttribute("Event");
...
<input type="hidden" name="chk_cop_dtl_grp_cd">
<input type="hidden" name="act_grp_seq">
...
<div class="wrap_search">
    ...
    <div class="opus_design_inquiry wFit">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <th>COP Detail Group Code</th>
                    <td><input type="text" style="width:60px; ime-mode:disabled" name="frm_cop_dtl_grp_cd"  class="input1" dataformat="engup" maxlength="6"></td>
                </tr>
            </tbody>
        </table>
