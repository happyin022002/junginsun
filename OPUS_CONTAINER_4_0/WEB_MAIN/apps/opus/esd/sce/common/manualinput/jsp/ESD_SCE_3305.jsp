...
<%@ page import="com.clt.apps.opus.esd.sce.common.manualinput.event.EsdSce3305Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdSce3305Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsdSce3305Event)request.getAttribute("Event");
