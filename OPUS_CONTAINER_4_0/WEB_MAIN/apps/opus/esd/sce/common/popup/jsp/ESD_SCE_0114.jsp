...
*@FileTitle : Exception Inquiry / Office Mapping Popup
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier :
...
<tr><td valign="top">
		...
		<table width="100%" border="0">
			<tr><td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp;Office Mapping Search</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
				...
				<td class="bg">
					<table class="search" border="0" style="width:100%">
						<tr class="h23">
							...
							<img onClick="openOfcPopUp(true,'popmstofccd')" class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle"></td>
