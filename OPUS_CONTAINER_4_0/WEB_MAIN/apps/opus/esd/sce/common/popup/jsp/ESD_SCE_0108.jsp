...
<tr><td valign="top">
		...
		<%if (dist.equals("expt_rsn_inq")){ %>
		<tr><td height="79" class="title"><img src="/opuscntr/img/opus/ico_t1.gif" width="20" height="12">Exception Reason</td></tr>
		<%}else{%>
		<tr><td height="79" class="title"><img src="/opuscntr/img/opus/ico_t1.gif" width="20" height="12">Exception Reason Insert</td></tr>	
		<% }%>		
		</table>
		<!-- : ( Title ) (E) -->
