...
*@FileName : ESD_PRD_0059.jsp
*@FileTitle : Route List Inquiry
*Open Issues :
*Change history :
*@LastModifyDate :
*@LastModifier : 
...
<%
    ...
    String optStr2="|000010: : "; //ibsheet combo
    try {
...
<html>
<head>
<title>Route List Inquiry</title>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp;Route List Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
			        ...
			        <table class="search">
			            <tr class="h23">
			                ...
			                <td width="20%"><input class="input1" name="i_org_cd" type="text" required caption="From" maxlength="7" tabIndex="1" style="width:70" style="text-transform:uppercase" dataformat="engup">
			                	<img class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="ib_org_loc_btn"></td>
			                ...
			                <td><input class="input1" name="i_dest_cd" type="text" required caption="To" maxlength="7" tabIndex="3" style="width:70" style="text-transform:uppercase" dataformat="engup">
			                	<img class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="ib_dest_loc_btn"></td>
			            </tr>
			        </table>
				...
				<td class="bg">
					...
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td align="left"><input name="i_bkg_flg" type="checkbox" class="trans" value="Y" unchecked></td>
