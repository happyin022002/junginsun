...
<%@ page import="com.clt.apps.opus.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0010Event"%>
<%@ page import="com.clt.apps.opus.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.vo.SearchCostTypeCodeComboListVO" %>
		...
		<!-- TABLE '#D' : ( Search Options ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					<td>Cost Code</td>
					<td><input type="text" style="width:120;" name="frm_cost_cd" maxlength="6" desc="Cost Code" onKeyUp="upper(this);lea_comm_isAlphaMessage(this,6);" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve')"></td>
					<td>Acct. Code</td>
					<td><input type="text" style="width:120;" name="frm_acct_cd" maxlength="6" desc="Acct. Code" onKeyUp="lea_comm_isNumberMessage(this,6);" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve')"></td>
				</tr>
				<tr class="h23">
