...
<%@ page import="com.clt.apps.opus.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0004Event"%>
     	...
     	<table class="search">
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="160"><input type="text" style="width:55;" name="frm_acct_cd" value="<%=acct_cd%>" desc= "Acc. Code" maxlength="6" onKeyUp="lea_comm_isNumberMessage(this,6);" onKeyDown="lea_com_enterKeyEvent('lea_enterRetrieve')">&nbsp;<img class="cursor" src="/opuscntr/img/button/btns_search.gif" name="btns_acct_search" width="19" height="20" border="0" align="absmiddle"></td>
