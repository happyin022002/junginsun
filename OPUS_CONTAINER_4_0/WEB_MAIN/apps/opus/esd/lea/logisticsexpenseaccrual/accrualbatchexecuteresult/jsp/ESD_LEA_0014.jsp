...
<%@ page import="com.clt.apps.opus.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0014Event"%>
		...
		<!-- TABLE '#D' : ( Search Options ) (S) -->
     	<table class="search">
       	<tr><td class="bg">
			...
			<tr class="h23">
				<td width="114">Rev. Year-Month</td>
				<td><input type="text" class="input1" style="width:55;" name="rev_yrmon" valid="1" desc= "Rev. Year-Month" value="<%=rev_yrmon%>" onKeyUp="lea_comm_isNumberMessage(this,6);" onBlur="lea_com_convertYymm(this);lea_com_enterKeyEvent('lea_enterRetrieve')"></td></tr>
			</table>
			<table class="search_in" border="0">
			<tr class="h23">
						...
						<table border="0" style="height:23; width:385; background-color: #E9E9E9;">
							<tr class="h23">
								<td style="padding-left:10;">
									<input type="checkbox" name="f_cost_type_f" class="trans" value="1" checked  onChange="lea_setCookieAcclType();">Full Expense&nbsp;&nbsp;
									<input type="checkbox" name="f_cost_type_m" class="trans" value="1" checked  onChange="lea_setCookieAcclType();">Empty Expense&nbsp;&nbsp;
									<input type="checkbox" name="f_cost_type_v" class="trans" value="1" checked  onChange="lea_setCookieAcclType();">Volume Incentive&nbsp;&nbsp;
								</td>
							</tr>
						</table>
				</td>
