...
<%@ page import="com.clt.apps.opus.esd.lea.logisticsexpenseaccrual.accrualbatchexecuteresult.event.EsdLea0902Event"%>
...
<tr><td valign="top">
		...
		<tr><td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp; Rev. VVD Inquiry</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
