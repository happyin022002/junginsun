...
<%@ page import="com.clt.apps.opus.esd.lea.logisticsexpenseaccrual.accrualemailsetting.event.EsdLea0009Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.LogisticsExpenseAccrual.AccrualEmailSetting");
...
<input type="hidden" name="frm_mail_div"> 
<input type="hidden" name="frm_save_div" value="N">
