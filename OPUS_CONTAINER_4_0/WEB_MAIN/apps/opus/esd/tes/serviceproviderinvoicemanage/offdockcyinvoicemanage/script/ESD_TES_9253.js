...
/**
 * @extends Tes
 * @class ESD_TES_9253 : business script for Off-Dock CY Container List - 3rd Party Interface
 */
	...
	case 1: //sheet1 init
		with (sheetObj) {
            ...
            var cols = [ {Type:"Status",	Hidden:1, Width:30,   Align:"Center",	ColMerge:1,   SaveName:"ibflag",							KeyField:0,   CalcLogic:"" },
                     ...
                     {Type:"Combo",  Hidden:0, Width:80,	Align:"Left",			ColMerge:0,   SaveName:"vndr_cust_div_cd",		KeyField:0,   CalcLogic:"",   Format:"",			PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                     {Type:"Text",		Hidden:0,	Width:100,	Align:"Left",			ColMerge:0,   SaveName:"trd_party_val",				KeyField:0,   CalcLogic:"",   Format:"" ,			PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                     ...
                     {Type:"Text",		Hidden:1,	Width:65,		Align:"Right",		ColMerge:1,   SaveName:"tml_inv_tp_cd",				KeyField:0,   CalcLogic:"",   Format:"" } ];
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	case IBSEARCH:
		...
		sheetObj.DoSearch("ESD_TES_9253Popup.do", tesFrmQryStr(formObj));
		break;
	}
}
/**
