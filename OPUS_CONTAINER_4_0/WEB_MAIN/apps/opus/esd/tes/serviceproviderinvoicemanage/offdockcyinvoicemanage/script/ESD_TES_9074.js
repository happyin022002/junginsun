/**
 * @extends Tes
 * @class ESD_TES_9074 : business script for Off-Dock CY Container List - Tab Cost Calc.(TMNL) - Revised Volume TO Input
 */
function ESD_TES_9074() {
    ...
    function processButtonClick(){
    	 ...
    	 try {
    		...
    		if( e == "[object Error]") {
    			ComShowMessage(getMsg('TES23028')); 
    		} else {
    			ComShowMessage(e);
    		}
    	}
    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with (sheetObj) {
	            	var HeadTitle = "Del.|Seq.|Cost Code|CNTR No.|B/L|Remarks";
	 				SetConfig( { SearchMode:2, MergeSheet:2, Page:20, FrozenCol:0, DataRowMerge:1 } );
					var info    = { Sort:1, ColMove:1, HeaderCheck:0, ColResize:1 };
					var headers = [ { Text:HeadTitle, Align:"Center"} ];
					InitHeaders(headers, info);
					
					var cols = [ {Type:"CheckBox",	Hidden:0, Width:30,   Align:"Center",	ColMerge:0,   SaveName:"cntr_sty_cd",		KeyField:0,   CalcLogic:"" },
					        {Type:"Seq",		Hidden:0,	Width:50,		Align:"Center",		ColMerge:0,   SaveName:"",									KeyField:0,   CalcLogic:"",   Format:"" },
					        {Type:"Text",		Hidden:0,	Width:90,		Align:"Center",		ColMerge:0,   SaveName:"lgs_cost_cd",				KeyField:0,   CalcLogic:"",   Format:"" },
					        {Type:"Text",		Hidden:0,	Width:90,		Align:"Center",		ColMerge:0,   SaveName:"cntr_no",						KeyField:0,   CalcLogic:"",   Format:"" },
				            {Type:"Text",		Hidden:0,	Width:90,		Align:"Center",		ColMerge:0,   SaveName:"bl_no",							KeyField:0,   CalcLogic:"",   Format:"" },
				            {Type:"Text",		Hidden:0,	Width:90,		Align:"Left",			ColMerge:0,   SaveName:"cntr_rmk",					KeyField:0,   CalcLogic:"",   Format:"" },
				            ...
				            {Type:"Text",		Hidden:1,	Width:30,		Align:"Center",		ColMerge:0,   SaveName:"cntr_tpsz_cd",				KeyField:0,   CalcLogic:"",   Format:"" },
			                {Type:"Text",		Hidden:1,	Width:30,		Align:"Center",		ColMerge:0,   SaveName:"cntr_sty_cd",					KeyField:0,   CalcLogic:"",   Format:"" } ];
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
		   case IBSEARCH:      //Retrieve
			    ...
			    sheetObj.DoSearch("ESD_TES_9074Popup.do", tesFrmQryStr(formObj));
			    break;
        }
    }
    /**
