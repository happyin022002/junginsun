...
<%@ page import="com.clt.apps.opus.esd.spe.evaluationgrouptargetmanage.evaluationgroupstrategicimportancemanage.event.EsdSpe0003Event"%>
...
<%
	EsdSpe0003Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.EvaluationGroupTargetManage.EvaluationGroupStrategicImportanceManage");
	...
	try {
		...
		event = (EsdSpe0003Event)request.getAttribute("Event");
				...
				<td class="bg">
					...
					<table class="search_in" border="0">
						<tr class="h23">
							<td>EG ID</td>
							<td colspan="2">
								<select name="f_eg_id" style="width:180"  caption="EG ID">
								...
								%>
							<td>Year</td>
							<td><select name="ev_yr" style="width:70" required caption="Year" class="input1">
						...
						<tr class="h23">
							...
							<td width="170">
								<select name="f_eg_rhq_cd" style="width:124" caption="Level 1">
												<option value="" selected>&lt;&lt; select &gt;&gt;</option>
							...
							<td width="47" class="stm">Level 2</td>
							<td width="170"><input type="text"  name="f_eg_cty_cd" style="width:125" maxlength="3" onKeyPress="ComKeyOnlyAlphabet('upper');"></td>
							<td width="47" class="stm">Level 3</td>
