...
<%@ page import="com.clt.apps.opus.esd.spe.serviceproviderresultmanage.serviceproviderrelationshipattractivenessresult.event.EsdSpe0004Event"%>
...
<%
	EsdSpe0004Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.ServiceProviderResultManage.ServiceProviderRelationshipAttractivenessResult");
	...
	try {
		...
		event = (EsdSpe0004Event)request.getAttribute("Event");
		...
		//System.out.println( "-----------------------------"+egidList.size());
...
<html>
<head>
<title>SI Analysis Result</title>
				...
				<td class="bg">
					...
					<table class="search_in" border="0">
						...
						<tr class="h23">
							...
							<td width="150"><input type="text"  name="f_eg_cty_cd" style="width:105" maxlength="3" onKeyPress="ComKeyOnlyAlphabet('upper');"></td>
							<td width="45" class="stm">Level 3</td>
							<td><select name="f_svc_cate_cd" style="width:105"    caption="Level 3">
												<option value="" selected>&lt;&lt; select &gt;&gt;</option>
							...
							<td align="right">
								<table border="0" style="height:20; width:235; background-color: #E9E9E9;">
									<tr class="h23">
										<td style="padding-left:10;">
									<input type="radio" name="f_mapping_div" value="A" class="trans" checked>All&nbsp;
									<input type="radio" name="f_mapping_div" value="M" class="trans">Mapped&nbsp;
									<input type="radio" name="f_mapping_div" value="U" class="trans">Unmapped</td></tr>
								</table>
							</td>
						</tr>
					</table>
					...
					<table class="search_in" border="0">
						<tr class="h23">
							...
							<td width="223"><input type="text" class="input2" style="width:160" name="f_vndr_seq" readOnly> <img class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="btn_sp"></td>
