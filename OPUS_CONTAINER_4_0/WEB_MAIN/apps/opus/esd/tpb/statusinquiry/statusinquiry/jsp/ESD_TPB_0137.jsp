...
<%@ page import="com.clt.apps.opus.esd.tpb.statusinquiry.statusinquiry.event.EsdTpb0137Event"%>
<%@ page import="com.clt.apps.opus.esd.tpb.common.TPBUtils"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsdTpb0137Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {	   	
		...
		event = (EsdTpb0137Event)request.getAttribute("Event");
...
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><button type="button"><span>Pending TPB of <%=account.getOfc_cd()%></span></button></h2>
	<!-- page_title(E) -->
...
<div class="wrap_search">
	...
	<div class="opus_design_inquiry wFit">
		<table>
		   ...
		   <tbody>
		   		<tr>
		   			<td><font size="3" color="red">Following data requires of your immediate actions for further process !!!</font></td>
		   		</tr>
		   </tbody>
		</table>
	</div>
