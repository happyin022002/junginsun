 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ESD_TPB_0118 : business script for ESD_TPB_0118
     */
     /* Global Variables */
...
//  		tpb_3rdPartyStaffClear(s_vndr_cust_div_cd);
  	...
  	function initSheet(sheetObj,sheetNo) {
  		...
  		switch(sheetNo) {
  			case 1:	  //IBSheet1 init
  			    with(sheetObj){
  		        var cnt=0;
  		        var HeadTitle="|SEQ|Office|TPB No.|Invoice No.|Version()|AR B/L No.|Expense type|Currency|Net Amount|VAT Amount|Invoice Amount|AR I/F Amount|Issued Date|Issued By|C/L|3rd Party|AR I/F Date|length_n3pty_bil_tp_cd|3rd Party Division Code|3rd Party Code|Inv Seq|Cnt CD|"; // Recovery Activity|
  		        ...
  		        var cols = [ {Type:"Status",    Hidden:1, Width:100,  Align:"Center",  ColMerge:0,   SaveName:"sts",                     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
  		             ...
  		             {Type:"Text",      Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"cnt_cd",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
  		        InitColumns(cols);
  		        SetEditable(1);
	            SetDataLinkMouse("n3pty_no",1);
	            SetDataLinkMouse("n3pty_inv_rvis_cd",1);
	            SetColHidden("if_bl_no",1);//2009-03-02
	  	     	//SetSheetHeight(410);
  		...
  		switch(sAction) {
  		   case IBSEARCH:	  //Retrieve
  				...
  				formObj.f_cmd.value=SEARCH;
   				sheetObj.DoSearch("ESD_TPB_0118GS.do", tpbFrmQryStr(formObj) );
  				break;
  		   case IBCLEAR:	   //Clear
  				sheetObj.RemoveAll();
  				break;
...
//  			document.form.submit();
			document.form.s_n3pty_ofc_cd.value=sheetObj.GetCellValue(Row, "ofc_cd");
			...
			document.form.s_length_n3pty_bil_tp_cd.value=sheetObj.GetCellValue(Row, "length_n3pty_bil_tp_cd");
			document.form.s_cnt_cd.value=sheetObj.GetCellValue(Row, "cnt_cd");
//  			alert(sheetObj.CellValue(Row, "cnt_cd"));
