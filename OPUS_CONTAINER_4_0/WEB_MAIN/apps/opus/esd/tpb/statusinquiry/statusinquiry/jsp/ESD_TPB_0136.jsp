...
<%@ page import="com.clt.apps.opus.esd.tpb.statusinquiry.statusinquiry.event.EsdTpb0136Event"%>
	...
	<div class="wrap_search">
		...
		<div class="opus_design_inquiry wFit">
			<table>
				...
				<tr>
					<th><h3 class="title_design">Closing</h3></th>
				    <td></td>
				    <th>RHQ</th>
					...
					<th>Closing Date</th>
					<td><input type="text" name="s_sdate" id="s_sdate" style="width:75px" value="<%=p_sdate%>" caption="Date" data_format="ymd" OnKeyDown="tpb_isNumD(this, 'Y');" onBlur="tpb_validateDateObj(this);">~ <input type="text" name="s_edate" id="s_edate" style="width:75px" value="<%=p_edate%>"  caption="Date" data_format="ymd" OnKeyDown="tpb_isNumD(this, 'Y');" onBlur="tpb_validateDateObj(this);"><button type="button" id="btns_calendar2" name="btns_calendar2" class="calendar ir"></button></td>
				</tr>
			</table>
			<table>
				<colgroup>
				...
				<tr>
					...
					<td><select style="width:100px;" name="s_if_ctrl_cd" id="s_if_ctrl_cd" OnChange="javascript:if_ctrl_cd_OnChange();" caption="Control Office"></select></td>
					<th>Currency</th>
			...
			<table>
				...
				<tr>
					<td></td>
					<th>Office</th>
					<td><select style="width:90px;" name="s_if_ofc_cd" id="s_if_ofc_cd"><option value="" selected>All</option></select></td>
				</tr>
			</table>
		</div>
