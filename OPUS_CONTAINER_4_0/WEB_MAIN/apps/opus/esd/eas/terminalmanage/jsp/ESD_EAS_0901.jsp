...
<%
	...
	String			bkg_no			= request.getParameter("bkg_no").trim();
	String			eas_expn_tp_cd	= JSPUtil.getNull(request.getParameter("eas_expn_tp_cd"));
	String			rmk_ctnt		= JSPUtil.getNull(request.getParameter("rmk_ctnt"));
	String			rmk_ctnt_seq	= JSPUtil.getNull(request.getParameter("rmk_ctnt_seq"));
...
<tr><td valign="top">
        ...
        <tr><td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp;Expense Audit Remark Detail</td></tr>
        </table>
        <!-- : ( Title ) (E) -->
