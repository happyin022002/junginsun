...
<%
	...
	String so_ofc_cd = request.getParameter("so_ofc_cd");
...
<html>
<head>
<title>Route UnMatch List Detail</title>
...
<tr><td valign="top">
					...
					<!-- TABLE '#D' : ( Page Title, Historical Tail Navigation ) (S) -->
						...
						<tr><td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp;Route Unmatch - B/L vs. S/O Detail</td></tr>
						</table>
