...
<%@ page import="com.clt.apps.opus.esd.eas.transportmanage.event.EsdEas0903Event"%>
<%@ page import="com.clt.apps.opus.esd.eas.transportmanage.event.EsdEas0903EventResponse"%>
<%@ page import="com.clt.framework.support.controller.html.FormCommand"%>
<%
	EsdEas0903Event event = null;
	EsdEas0903EventResponse eventResponse = null;	 //RDTO(Data Transfer Object including DB ResultSet)
	...
	eventResponse = (EsdEas0903EventResponse)request.getAttribute("EventResponse");
...
<%
					for (int j = 0 ; j < rowSet.getMetaData().getColumnCount() ; j++) {
						//if ( j==10 ) break;
%>						
		<TD><![CDATA[<%=rowSet.getString(i++)%><%//=JSPUtil.getNull(rowSet.getString(i++))%>]]></TD>
<%
					}
