...
<%@ page import="com.clt.apps.opus.esd.eas.transportmanage.event.EsdEas0008Event"%>
<%@ page import="com.clt.apps.opus.esd.eas.transportmanage.event.EsdEas0008EventResponse"%>
<%@ page import="com.clt.framework.support.controller.html.FormCommand"%>
<%
	EsdEas0008Event event = null;
	EsdEas0008EventResponse eventResponse = null;	//RDTO(Data Transfer Object including DB ResultSet)
	...
	event = (EsdEas0008Event)request.getAttribute("Event");
	eventResponse = (EsdEas0008EventResponse)request.getAttribute("EventResponse");
