	...
	switch(sheetNo){
		case 1:      //sheet1 init
			  with(sheetObj){
				   ...
				   var HeadTitle="|Del|Exchange Rate Yrmon|Rate Division|CURR Code|USD : Local|"+currCd+" : Local|USD : "+currCd+"|Rate User Level|Delete Flag|Acct Xch Rt Yrmon|Acct Sch Rt Lvl|Curr Code";
				   ...
				   var cols = [ {Type:"Status",    Hidden:1,  Width:0,    Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
							    ...
							    {Type:"Float",     Hidden:0,  Width:300,  Align:"Right",   ColMerge:0,   SaveName:"usd_locl_xch_rt",      KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:5,   UpdateEdit:0,   InsertEdit:0,   EditLen:15 },
							    {Type:"Float",     Hidden:0,  Width:300,  Align:"Right",   ColMerge:0,   SaveName:"locl_cny_xch_rt",      KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:5,   UpdateEdit:0,   InsertEdit:0,   EditLen:11 },
							    {Type:"Float",     Hidden:0,  Width:300,  Align:"Right",   ColMerge:0,   SaveName:"usd_cny_xch_rt",       KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:5,   UpdateEdit:0,   InsertEdit:0,   EditLen:11 },
