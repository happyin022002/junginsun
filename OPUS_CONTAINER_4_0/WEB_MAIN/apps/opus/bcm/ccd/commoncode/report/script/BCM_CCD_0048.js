    ...
    function initSheet(sheetObj,sheetNo) {
    	var cnt=0;
		        with(sheetObj){
		          ...
		          HeadTitle+="PrepaidParty|Alternate Currency|Manual Booking Option|Sakura CTR Code|Sakura Agent Code|Delete Flag|Create User|Create Date/Time|Last Update User|Last Update Date/Time";
