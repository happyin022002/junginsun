	...
	function initSheet(sheetObj, sheetNo) {
		...
		case "sheet1":
		    with(sheetObj){
			      ...
			      var HeadTitle1="|Customer Code|Customer Country|Legal English Name|Local Language Name|Address|Abbreviation|Tax Payer ID or Registry No.|Location Code|Admin. Office|Sales Rep Code|Firm/Private|Customer Type|Container Customer Type|Need Base Seg. Class1|Need Base Seg. Class2|Need Base Seg. Class3|Need Base Seg. Class|Vendor Code|Group Customer|Multi Trade Account|Named Customer Flag|Key Account Flag|Key Account Effective Date|Key Account Expire Date|Foundation Date|Finance Status|Employees|Industry Type|Yearly Volume (TEU)|Listed Stock|CTS No.|Capital Currency|Capital Amount|Remark|Standard Carrier Alpha Code|NVO FMC License No|NVO FMC Bond No|FMC Bond Amount|Bond Effective Date|Bond Expire Date|F/FWDR FMC File No|Delete Flag";
