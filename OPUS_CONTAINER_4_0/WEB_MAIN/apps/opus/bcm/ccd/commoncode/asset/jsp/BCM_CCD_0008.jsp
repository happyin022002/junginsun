...
<!--                 <col width="146"/> -->
            ...
            <tbody>
                <tr>
                    ...
                    <th>VIP Ope. Kind</th>
                    <td><script type="text/javascript">ComComboObject('modi_vsl_opr_tp_cd', 2, 150, 0, 0, 0, false)</script></td>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" style="width:100px;text-align:right;ime-mode:disabled;" class="input" caption="Depth (M)" dataformat="float" name="vsl_dpth" maxlength="3"" id="vsl_dpth" /> </td>
