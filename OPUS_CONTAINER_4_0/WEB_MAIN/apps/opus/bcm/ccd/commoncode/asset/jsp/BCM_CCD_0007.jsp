...
<div class="opus_design_inquiry wFit">	
	...
	<table>
		...
		<tr class="h23">
			...
			<td><input type="text" style="width:80px;text-align:right;ime-mode:disabled;" class="input" dataformat="float" name="cntr_tpsz_lodg_wgt" maxlength="11" pointcount="3"></td>
			<th>Loading Capacity(CBM)</th>
			<td><input type="text" style="width:60px;text-align:right;ime-mode:disabled;" class="input" caption="Loading Capacity(CBM)" dataformat="float" maxlength="19" pointcount="3" name="cntr_tpsz_lodg_capa"></td>
			<th>Tare Weight(KG)</th>
			<td><input type="text" style="width:80px;text-align:right;ime-mode:disabled;" class="input" dataformat="float" name="cntr_tpsz_tare_wgt" maxlength="11" pointcount="3"></td>
		</tr>
	</table>
	<table>
		<colgroup>
