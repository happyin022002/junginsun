    ...
    try {
        ...
        switch(srcName) {
            ...
            case "btn_Row_Add":
                ...
                sheetObject1.SetCellValue(sheetObject1.GetSelectRow(), prefix1+"delt_flg","N",0);
                break;
            case "btn_Row_Copy":
                    ...
                    for(var i=chkIdxArr.length-1 ; i>=0 ; i--) {
                        ...
                        if(sheetObject1.GetRowStatus(chkIdx) == "I") {
                            ...
                            if(ComShowCodeConfirm("COM130301", "data")) {
                                ...
                                if(result == "") {
                                    sheetObject1.SetCellValue(chkIdx, prefix1+"delt_flg","Y",0);
                                }else {
                                    ComShowCodeMessage(result);
                                }
                                sheetObject1.SetCellValue(chkIdx, prefix1+"delt_chk",0,0);
                            }else {
                                sheetObject1.SetCellValue(chkIdx, prefix1+"delt_chk",0,0);
                                sheetObject1.SetSelectRow(chkIdx);
                            }
                        }
                    }
                }
...
function initSheet(sheetObj,sheetNo) {
    ...
    switch(sheetID) {
        case "sheet1":      //sheet1 init
          ...
          var cols = [ {Type:"Status",    Hidden:1, Width:20,   Align:"Left",    ColMerge:0,   SaveName:prefix1+"ibflag",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                 ...
                 {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:0,   SaveName:prefix1+"seq",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
        ...
        switch (colNm) {
            ...
            case prefix1+"scc_cd":
                if(val != "") {
                    ...
                    var sParam=FormQueryString(formObj);
                    var sXml=GetSearchData("BCM_CCD_0022GS.do", sParam + "&loc_cd=" + val);
...
function locCodeHelp(rowArray, row, col) {
    ...
    sheetObj.SetCellValue(row, col,colArray[1],0);
}
/**
 * All Data Clear
 * @param sheetObj
