	...
	<div class="opus_design_inquiry">
		<table>
			...
			<tbody>
				<tr>
					<th>Carrier Code</th>
					<td><nobr><input type="text" class="input1" style="width:70px;ime-mode:disabled;text-align:center;" name="crr_cd" id="crr_cd" dataformat="engup" maxlength="3"><button type="button" class="input_seach_btn" name="btn_com_ens_on1" id="btn_com_ens_on1"></button> </nobr></td>
				</tr>	
				<tr>
					<th>Name</th>
					<td><input type="text" style="width:650px;text-align:left;" class="input1" dataformat="engup" otherchar="()_\-,. " name="crr_nm" value=" " maxlength="50" id="crr_nm"/> </td>
					<!--td>Booking EDI</td-->					
					<td><input type="hidden" style="width:100%;ime-mode:disabled;text-align:left;" dataformat="engupspace" class="input" value=" " name="bkg_edi_cd" maxlength="2" id="bkg_edi_cd" /></td>
				</tr>
				<tr><td colspan="3"><table class="line_bluedot"><tr><td></td></tr></table></td></tr>	
