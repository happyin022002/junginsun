	...
	<div class="opus_design_inquiry wFit">
		...
		<table border=1>
			...
			<tbody>
				<tr>
					<th>English Name</th>
					<td><input id="ofc_eng_nm" style="width: 180px; ime-mode:disabled; text-align:left;" class="input1" value="" name="ofc_eng_nm" maxlength="50" dataformat="engup" otherchar="()_\-,. " type="text"/> </td>
					<th>Local Name</th>
		...
		<table>
			...
			<tbody>
				 <tr>
					...
					<td><input id="intl_phn_no" style="width: 80px; text-align:left;" class="input1" value="" name="intl_phn_no" maxlength="4" dataformat="num" type="text" /> </td>
					<th>Tel. No</th>
					<td><input id="ofc_phn_no" style="width: 140px; text-align:left;" class="input1" value="" name="ofc_phn_no" maxlength="20" dataformat="num" type="text" /> </td>
					<th>International Fax. No</th>
					<td><input id="intl_fax_no" style="width: 80px; text-align:left;" class="input" value="" name="intl_fax_no" maxlength="4" dataformat="num" type="text" /> </td>
					<th>Fax. No</th>
					<td><input id="ofc_fax_no" style="width: 100px; text-align:left;" class="input" value="" name="ofc_fax_no" maxlength="20" dataformat="num" type="text" /> </td>
				</tr>
				<tr>
				    <th>URL</th>
