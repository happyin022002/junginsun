		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><input type="text" style="width:137px;ime-mode:disabled;text-align:center" name="vsl_slan_cd" class="input1" dataformat="engup" maxlength="3" id="vsl_slan_cd" /><button type="button" class="input_seach_btn" name="btns_search1" id="btns_search1"></button></td>
					<th>VIP Code</th>
                    <td><input type="text" style="width:150px;text-align:center;" class="input1" dataformat="engup" id="modi_vsl_slan_cd" name="modi_vsl_slan_cd" maxlength="30"></td>
                    ...
                    <th>VIP Team Code</th>
                    <td><input type="text" style="width:150px;text-align:center;" class="input" dataformat="engup" id="modi_vip_team_cd" name="modi_vip_team_cd" maxlength="20"></td>
				</tr>
				<tr>
					<th>Name</th>
					<td colspan="3"><input type="text" style="width:490px;ime-mode:disabled;text-align:left" class="input1" name="vsl_slan_nm" dataformat="engup" otherchar="()_\-,. " maxlength="50" id="vsl_slan_nm"/> </td>                    
					<th>Legacy Code</th>
