...
//        doActionIBSheet(sheetObjects[0], formObj, IBCLEAR);
    ...
    function initSheet(sheetObj,sheetNo) {
    	var cnt=0;
        with(sheetObj){
	          var HeadTitle="|Del.|Vessel Service Lane Direction|VIP Dir Code|Vessel Service Lane Direction Sequence|Delete Flag|Create User|Create Date/Time|Last Update User|Last Update Date/Time|modi_vsl_slan_cd";
	          ...
	          var cols = [ {Type:"Status",    Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName:prefix+"ibflag" },
	                 ...
	                 {Type:"Int",       Hidden:0,  Width:300,  Align:"Center",  ColMerge:0,   SaveName:prefix+"vsl_slan_dir_seq", KeyField:0,   CalcLogic:"",   Format:"NullInteger", PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:4 },
