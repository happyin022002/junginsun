        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>Account (G/L)</th>
                    <td>
                        <input type="text" style="width:100px;text-align:center;ime-mode:disabled;" class="input1" dataformat="engup" name="co_chg_acct_cd" maxlength="6" onChange="obj_change();"><!-- 
