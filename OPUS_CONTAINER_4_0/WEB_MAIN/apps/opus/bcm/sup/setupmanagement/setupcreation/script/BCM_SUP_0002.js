 ...
 */
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
            with(sheetObj){
				SetFocusEditMode(1);
				var HeadTitle="|Seq|Del|Group Code|Company Div.|Country|Customer Seq.|SC / RFA No.|Effective Date|Expire Date|Partner Office|I/B Service Flag|B/L Type|BKG Confirm Flag|BKG Confirm Flag(Auto)|B/L Flag(Auto)|B/L Flag|Cargo Tracking Flag|A/N Flag|Contract Type";
				...
				var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
							...
							{Type:"Text",       Hidden:1, Width:80,   Align:"Center",  ColMerge:0,   SaveName:"an_flg",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
