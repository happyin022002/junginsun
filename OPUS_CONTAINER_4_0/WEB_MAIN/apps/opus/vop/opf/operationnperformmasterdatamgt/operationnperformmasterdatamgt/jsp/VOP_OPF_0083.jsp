	...
	<div class="layout_vertical_2" style="width: 20%;">
		<div class="wrap_result">
			<table>
					...
					<tr>
						<th class="title_design ">Shifting Method</th>
						<td>&nbsp;</td>
					</tr>
			</table>
	...
	<div class="layout_vertical_2" style="width: 80%">
		<div class="wrap_result">
			<table>
					...
					<tr>
						<th class="title_design mar_top_12">Account and Reason</th>
						<td>&nbsp;</td>
					</tr>
			</table>
			<div class="opus_design_grid" id="subTable">
