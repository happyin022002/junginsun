...
<%@ page import="com.clt.apps.opus.vop.opf.operationnperformmasterdatamgt.operationnperformmasterdatamgt.event.VopOpf0049Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopOpf0049Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopOpf0049Event)request.getAttribute("Event");
