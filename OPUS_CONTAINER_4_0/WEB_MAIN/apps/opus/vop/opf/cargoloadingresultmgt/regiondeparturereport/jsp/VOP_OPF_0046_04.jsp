...
<%@ page import="com.clt.apps.opus.vop.opf.cargoloadingresultmgt.regiondeparturereport.event.VopOpf004604Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopOpf004604Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopOpf004604Event)request.getAttribute("Event");
...
<input type="hidden" name="crr_cd" id="crr_cd" />
	...
	<div class="layout_wrap">
	    ...
	    <div class="layout_vertical_2" style="width:49%;">
	        ...
	        <div class="opus_design_grid" id="mainTable">
				<div class="opus_design_btn">
					<button class="btn_accent" name="btn_Row_Add2" id="btn_Row_Add2" type="button">Row Add</button><!--
					--><button class="btn_normal" name="btn_Row_Insert2" id="btn_Row_Insert2" type="button">Row Insert</button><!--		
					--><button class="btn_normal" name="btn_Row_Copy2" id="btn_Row_Copy2" type="button">Row Copy</button><!--
					--><button class="btn_normal" name="btn_Row_Delete2" id="btn_Row_Delete2" type="button">Row Delete</button> 
				</div>
