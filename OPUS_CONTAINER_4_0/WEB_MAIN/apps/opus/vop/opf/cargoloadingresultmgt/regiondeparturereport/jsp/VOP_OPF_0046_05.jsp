...
<%@ page import="com.clt.apps.opus.vop.opf.cargoloadingresultmgt.regiondeparturereport.event.VopOpf004605Event"%>
...
<input type="hidden" name="segment" value="AL" id="segment" />
<input type="hidden" name="crr_cd" id="crr_cd" />

	<!-- opus_design_grid(S) -->
	<div class="opus_design_grid" id="mainTable">
		<div class="opus_design_btn">
			<button class="btn_accent" name="btn_ImportAllocation" id="btn_ImportAllocation" type="button">Import Allocation</button><!--
