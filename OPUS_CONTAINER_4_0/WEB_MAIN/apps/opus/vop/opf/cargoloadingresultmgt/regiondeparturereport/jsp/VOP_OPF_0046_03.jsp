...
<%@ page import="com.clt.apps.opus.vop.opf.cargoloadingresultmgt.regiondeparturereport.event.VopOpf004603Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopOpf004603Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopOpf004603Event)request.getAttribute("Event");
...
<!-- Using Operator Code Valid Check  on sheet1 -->

<div class="opus_design_grid" id="mainTable">
	<div class="opus_design_btn">
		<button class="btn_accent" name="btn_ImportSubAllocation" id="btn_ImportSubAllocation" type="button">Import Sub Allocation</button><!--
		--><button class="btn_normal" name="btn_Row_Add" id="btn_Row_Add" type="button">Row Add</button><!--		
