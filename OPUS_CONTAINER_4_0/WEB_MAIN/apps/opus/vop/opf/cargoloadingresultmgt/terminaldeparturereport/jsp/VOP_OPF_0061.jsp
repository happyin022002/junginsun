...
<%@ page import="com.clt.apps.opus.vop.opf.cargoloadingresultmgt.terminaldeparturereport.event.VopOpf0061Event"%>
...
<div class="wrap_search">
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				<th>RHQ</th>
				<td><script type="text/javascript">ComComboObject('rhq', 1, 80, 1);</script></td>
				<th>Port</th>
				<td><!--  
				...
				<td>R/H Reason&nbsp;&nbsp;<input type="checkbox" name="rh_reason" class="trans" checked id="rh_reason" /></td>
				<th>From to Date</th>
