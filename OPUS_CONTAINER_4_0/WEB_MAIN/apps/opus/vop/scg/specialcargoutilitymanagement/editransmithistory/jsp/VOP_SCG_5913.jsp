...
<%@ page import="com.clt.apps.opus.vop.scg.specialcargoutilitymanagement.editransmithistory.event.VopScg5913Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg5913Event  event    = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg5913Event)request.getAttribute("Event");
...
<!-- popup_title_area(S) -->
 <div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>&nbsp;DG EDI Booking Receive History</span></h2>
		<!-- page_title(E) -->
			...
			<table class="search" border="0" > 
			   ...
			   <tbody>		   		
				<tr>
					...
					<td><input type="text" name="cgo_opr_cd" style="width:55px;text-align:center;" class="input2" value="<%=cgoOprCd%>" caption="Vessel Operator" maxlength="4" dataformat="engup" id="cgo_opr_cd" readonly/>
