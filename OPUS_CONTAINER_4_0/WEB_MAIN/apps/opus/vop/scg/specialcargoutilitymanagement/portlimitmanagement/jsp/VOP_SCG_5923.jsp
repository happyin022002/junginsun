...
<%@ page import="com.clt.apps.opus.vop.scg.specialcargoutilitymanagement.portlimitmanagement.event.VopScg5923Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg5923Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg5923Event)request.getAttribute("Event");
...
<!-- popup_title_area(S) -->
 <div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>Port Limits Sub Risk(s)</span></h2>
		<!-- page_title(E) -->
			...
			<table>
				...
				<colgroup>
					...
					<tr>
						...
						<td><textarea  rows="4" style="width:100%;resize:none;" name = "portLmtRepDesc" id="portLmtRepDesc" maxlength="1500" style="ime-mode:active"><%//=portLmtRepDesc%></textarea></td> 
					</tr>
				</tbody>
			</table>
		</div>
	...
	<div class="opus_design_inquiry wFit">
		...
		<div class="layout_wrap">
		    <div class="layout_vertical" style="padding-right:20px;">
			    <div class="layout_vertical_1">
			    	<div id="mainTable" style="padding-left:20px;">
						<!-- opus_grid_btn(S) -->
						<div class="opus_design_btn">
