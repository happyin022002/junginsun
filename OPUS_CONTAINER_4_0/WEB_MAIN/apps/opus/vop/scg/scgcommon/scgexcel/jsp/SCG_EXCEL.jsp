...
<%@ page import="com.clt.apps.opus.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScgExcelEvent"%>
  
<%@ page import="com.clt.framework.component.util.io.HttpUtil"%>
<%@ page import="com.clt.framework.component.util.JSPUtil"%>
<%@ page import="com.clt.apps.opus.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.vo.ComExcelVO"%>
<%@ page import="com.clt.framework.component.util.JSPUtil"%>
...
<%!
    public String getExcelXml(HashMap hmVo){
        ...
        String horizontal = (String)JSPUtil.getNull( hmVo.get("align"));
        if("center".equals(horizontal.toLowerCase())){
        	horizontal = "Center";
        } else if("left".equals(horizontal.toLowerCase())){
        	horizontal = "Left";
        } else if("right".equals(horizontal.toLowerCase())){
        	horizontal = "Right";
        }
        int spanRow = Integer.parseInt((String)hmVo.get("cols"));

        sXml.append(" <Label>                                                                                         \n");
        sXml.append("     <Range Row1='1' Col1='1' Row2='2' Col2='"+(spanRow+1)+"' RowHeight='20'> \n");
        sXml.append("         <CellFormat>                                                                            \n");
        sXml.append("             <Merge>True</Merge>                                                                 \n");
        sXml.append("             <Alignment Horizontal='"+horizontal+"' Vertical='Center'/> \n");
        sXml.append("             <Interior BackColor='255,255,255' />                                           \n");
        sXml.append("             <Font Name='굴림' Bold='True'  Size='18' UnderLine='Single'              \n");
        sXml.append("              Strikethrough='False' Superscript='False' Subscript='False' Color='0,0,0'/>   \n");
        sXml.append("         </CellFormat>                                                                           \n");
...
%>
<% 
    VopScgExcelEvent  event     = null;	 
	Exception serverException   = null;	 
	String strErrMsg = "";	
	Logger log       = Logger.getLogger(this.getClass().getName());
	
	event            = (VopScgExcelEvent)request.getAttribute("Event");
