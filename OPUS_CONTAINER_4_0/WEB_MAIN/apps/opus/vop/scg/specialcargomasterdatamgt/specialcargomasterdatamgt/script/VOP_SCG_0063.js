 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0063 : business script for vop_scg_0063 
     */
    function vop_scg_0063() {
               ...
               if(ComGetBtnDisable(srcName)) return false;
                switch(srcName) {
                   ...
                   case "btn1_Excel":
                       ...
                       paramObj.title="DG Abbreviation";
//                       paramObj.columnwidth="2:10|3:110";
...
//            	   (5, 0, 0, true);
            	   var HeadTitle="|No.|Abbreviation|Full Name";
            	   ...
            	   var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag",               Wrap:1 },
            	                ...
            	                {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"imdg_abbr_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8,     Wrap:1 },
            	                {Type:"Text",      Hidden:0,  Width:750,  Align:"Left",    ColMerge:1,   SaveName:"imdg_abbr_full_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1000,  Wrap:1 },
