 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0037 : business script for vop_scg_0037 
     */
         ...
         switch(sheetNo) {
         	case 1:      //t1sheet1 init
         		...
         		var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
         		             ...
         		             {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"imdg_clss_cd",       KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:3 },
   ...
   // Sheet related process handling
 	...
 	function sheet1_OnChange(sheetObj,Row, Col, Value){
 		if (sheetObj.ColSaveName(Col) == "imdg_clss_cd") {
 			var bfCode=sheetObj.GetCellValue(Row,"imdg_clss_cd");
			if (bfCode.length == 1 && bfCode == ".") {
				ComShowCodeMessage('SCG50015');
				sheetObj.SelectCell(Row, Col);
				sheetObj.SetCellValue(Row,"imdg_clss_cd","");
