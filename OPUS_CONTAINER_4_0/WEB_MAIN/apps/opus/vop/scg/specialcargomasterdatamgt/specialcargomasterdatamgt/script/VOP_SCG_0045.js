 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0045 : business javascript for vop_scg_0045 
     */
         	...
         	case 1:      //t1sheet1 init
         		with (sheetObj) {
	                ...
	                var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag",               Wrap:1 },
	                       ...
	                       {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"imdg_abbr_cd",         KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8,     Wrap:1, AcceptKeys:"E", InputCaseSensitive:1 },
