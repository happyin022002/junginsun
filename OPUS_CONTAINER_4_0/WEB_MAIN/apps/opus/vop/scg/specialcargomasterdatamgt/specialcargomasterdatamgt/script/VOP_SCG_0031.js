...
//    	        (6, 0, 0, true);
    	        ...
    	        var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
    	               ...
    	               {Type:"Text",      Hidden:0,  Width:140,  Align:"Center",  ColMerge:1,   SaveName:"spcl_cgo_lod_rjct_rsn_cd",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:3 },
    	               {Type:"Text",      Hidden:0,  Width:540,  Align:"Left",    ColMerge:1,   SaveName:"rjct_rsn_cd_desc",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1000 },
    	        ...
    	        resizeSheet();
    	        SetEditable(1);
    	        SetColProperty("spcl_cgo_lod_rjct_rsn_cd" , {AcceptKeys:"E|N" , InputCaseSensitive:1});
    	 		}
    	 		break;
    	 }
     }
         	...
         	case IBSEARCH:      //retrieve
         		if(validateForm(sheetObj,formObj,sAction)) {
					if(sheetObj.id == "sheet1") {
		        		formObj.f_cmd.value=SEARCH01; // 75자리 trim처리 하지 않음
...
//         axon_event.addListener ('keydown', 'ComKeyEnter', 		'form');
     ...
     /**
      * In case input value changed in IBSheet Object
      */
     function sheet1_OnChange(sheetObj,Row, Col, Value){
    	 if (sheetObj.ColSaveName(Col) == "spcl_cgo_lod_rjct_rsn_cd") {
    		 var bfCode=sheetObj.GetCellValue(Row,"spcl_cgo_lod_rjct_rsn_cd");
