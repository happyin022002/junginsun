 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0047 : business script for vop_scg_0047 
     */
    	 ...
    	 switch(sheetNo) {
    	 	case 1:      //t1sheet1 init
    	 		with (sheetObj) {
	    	        ...
	    	        var HeadTitle="|Sel.|No.|Compatibility Group|Description";
	    	        ...
	    	        var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag",              Wrap:1 },
	    	               ...
	    	               {Type:"Text",      Hidden:0,  Width:150,  Align:"Center",  ColMerge:1,   SaveName:"imdg_comp_grp_cd",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:1,     Wrap:1, AcceptKeys:"E", InputCaseSensitive:1 },
	    	               {Type:"Text",      Hidden:0,  Width:680,  Align:"Left",    ColMerge:1,   SaveName:"imdg_comp_grp_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1000,  Wrap:1 },
	      	...
	      	case IBSEARCH:      //retrieve
				if(validateForm(sheetObj,formObj,sAction)) {
					if(sheetObj.id == "sheet1") {
		        		...
		        		sheetObj.DoSearch("VOP_SCG_0047GS.do", FormQueryString(formObj) );
					}
				}			
	    	   	break;
			case IBSAVE:        //save
				...
				sheetObj.DoSave("VOP_SCG_0047GS.do", FormQueryString(formObj), '-1', false);
				break;
         }
     }
  	/**
...
//         axon_event.addListener ('keydown', 'ComKeyEnter', 'form');
     ...
     function validateForm(sheetObj,formObj,sAction){
     	if (sAction == IBSAVE) {
 			var dupRow = sheetObj.ColValueDupRows("imdg_comp_grp_cd", false, true);
 			if(dupRow != "") {
