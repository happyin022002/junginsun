 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0065 : business script for vop_scg_0065 
     */
    function vop_scg_0065() {
        ...
        try {
            ...
            switch(srcName) {
                ...
                case "btn1_Excel":
                    ...
                    paramObj.title="Compatibility Groups of Class 1";
                    ...
                    if(sheetExcelObj.RowCount() < 1){//no data
                		  ComShowCodeMessage("COM132501");
	       	       		...
	       	       		sheetExcelObj.Down2Excel( {DownCols: makeHiddenSkipCol(sheetExcelObj), SheetDesign:1,Merge:1});
        	       	}
...
//            	(5, 0, 0, true);
            	var HeadTitle="|No.|Compatibility\nGroup|Description";
            	...
            	var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag",              Wrap:1 },
            	             ...
            	             {Type:"Text",      Hidden:0,  Width:120,  Align:"Center",  ColMerge:1,   SaveName:"imdg_comp_grp_cd",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:1,     Wrap:1 },
            	             {Type:"Text",      Hidden:0,  Width:710,  Align:"Left",    ColMerge:1,   SaveName:"imdg_comp_grp_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1000,  Wrap:1 },
