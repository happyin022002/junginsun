		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="imdg_pck_instr_cd" style="width:70px;" class="input" maxlength="10" value="" dataformat="engup" id="imdg_pck_instr_cd" /> </td>
				</tr>		
			</tbody>
		</table>
	</div>
...
<div class="wrap_result">
	<div class="opus_design_grid clear" >
		<div class="opus_design_btn">
			...
			--><button type="button" class="btn_normal" name="btn_update" 	id="btn_update">File Update</button>
		</div>
