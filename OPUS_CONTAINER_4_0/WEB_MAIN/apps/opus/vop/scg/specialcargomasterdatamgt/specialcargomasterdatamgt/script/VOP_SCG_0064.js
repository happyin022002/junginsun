 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class vop_scg_0064 : business script for vop_scg_0064
     */
...
//                     sheetObjects[0].Down2Excel( {DownCols: makeHiddenSkipCol(                    sheetObjects[0]), SheetDesign:1,Merge:1 });
     ...
     function loadPage() {
         ...
         imdg_segr_tp_cd.SetSelectIndex(0);
     }
...
//            	(5, 0, 0, true);
            	...
            	var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag",          Wrap:1 },
            	             ...
            	             {Type:"Text",      Hidden:0,  Width:150,  Align:"Center",  ColMerge:1,   SaveName:"imdg_segr_cd",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:1,     Wrap:1 },
...
//         }
//     }
     function imdg_segr_tp_cd_OnChange(comboObj, oldIndex, oldText, oldCode, newIndex, newText, newCode) {//CHECK OLD CODE: OnChange(comboObj,value,text) {
         var formObj=document.form;
         var sText=comboObj.GetText( newCode , 1);
         if( newText == "" ){
        	 formObj.imdg_segr_tp_nm.value="";
         }else{
        	 formObj.imdg_segr_tp_nm.value=sText;
         } 
         doActionIBSheet( sheetObjects[0],document.form,IBSEARCH);
     }
