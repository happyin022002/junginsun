...
<%@ page import="com.clt.apps.opus.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0045Event"%>
...
<div class="wrap_search">
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				<th>Abbreviation</th>
				<td><input type="text" name="imdg_abbr_cd" maxlength="8" style="width:80px;" class="input" value="" dataformat="enguponly" id="imdg_abbr_cd" /> </td>
			</tr>
		</table>
	</div>
</div>
