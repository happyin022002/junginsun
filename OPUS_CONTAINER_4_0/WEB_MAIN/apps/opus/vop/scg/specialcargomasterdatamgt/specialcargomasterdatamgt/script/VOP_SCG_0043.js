...
=========================================================*/
    ...
    var sheetCnt=0;
    var NUMBER_STRING="0123456789"; // number
    var SPCHAR_STRING="~!@#$%^&*()_+{}|:<>?`-=[]\\;',./\" "; // Punctuation, Typography...
    ...
    function processButtonClick(){
    	...
    	var formObject=document.form;
     	try {
     		...
     		switch(srcName) {
				case "btn_RowAdd":
					if (formObject.imdg_pck_tp_cd[1].checked) {
						sheetObject.SetColProperty("imdg_pck_tp_cd", {ComboText:"I|O|M", ComboCode:"I|O|M"} );
					}else if (formObject.imdg_pck_tp_cd[2].checked) {
						sheetObject.SetColProperty("imdg_pck_tp_cd", {ComboText:"I|O|M", ComboCode:"I|O|M"} );
					}else if (formObject.imdg_pck_tp_cd[3].checked) {
						sheetObject.SetColProperty("imdg_pck_tp_cd", {ComboText:"I|O|M", ComboCode:"I|O|M"} );
					}
...
//					break;	
   ...
   /**
         	...
         	case 1:      //t1sheet1 init
         	    with(sheetObj){               
		              ...
		              var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
		                     ...
		                     {Type:"Text",      Hidden:0,  Width:60,   Align:"Left",    ColMerge:1,   SaveName:"imdg_pck_cd",     KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:5 },
		                     {Type:"Text",      Hidden:0,  Width:800,  Align:"Left",    ColMerge:1,   SaveName:"imdg_pck_desc",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1000 },
		                     {Type:"Combo",     Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"imdg_pck_tp_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Combo",      Hidden:0, Width:30,   Align:"Center",    ColMerge:1,   SaveName:"delt_flg",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 } ];
		              ...
		              //SetSheetHeight(422);
		              resizeSheet();
		              SetColProperty("imdg_pck_tp_cd", {ComboText:"I|O|M", ComboCode:"I|O|M"} );
		              SetColProperty("delt_flg", {ComboText:"Y|N", ComboCode:"1|0"} );
                }
         		break;
         }
     }
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
			...
			case IBSAVE:        //save
				...
				sheetObj.DoSave("VOP_SCG_0043GS.do", FormQueryString(formObj), '-1', false);
				break;
         }
     }
  	/**
     ...
     function validateForm(sheetObj,formObj,sAction){
    	 if (sAction == IBSAVE) {
  			var dupRow = sheetObj.ColValueDupRows("imdg_pck_cd", false, true);
 			if(dupRow != "") {
