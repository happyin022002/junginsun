...
<%@ page import="com.clt.apps.opus.vop.scg.specialcargomasterdatamgt.specialcargomasterdatamgt.event.VopScg0046Event"%>
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				<th>Type</th>
				<td>
			   		<script type="text/javascript">ComComboObject('imdg_segr_tp_cd', 2, 50, 1, 1);</script><!--  
			   		--><input type="text" name="imdg_segr_tp_nm" style="width:450px;" class="input2" value="" readonly id="imdg_segr_tp_nm"></td>
			</tr>
		</table>
	</div>
</div>
