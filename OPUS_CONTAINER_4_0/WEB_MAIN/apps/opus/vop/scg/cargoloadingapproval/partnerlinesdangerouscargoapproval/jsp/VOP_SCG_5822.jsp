...
<%@ page import="com.clt.apps.opus.vop.scg.cargoloadingapproval.partnerlinesdangerouscargoapproval.event.VopScg5822Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	VopScg5822Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (VopScg5822Event)request.getAttribute("Event");
...
%>
<title>Application Request & Approval Status for Partner Lines - DG</title>
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span>Application Request & Approval Status for Partner Lines - DG</span></h2>
	...
	<div class="wrap_search">
		<div class="opus_design_inquiry wFit">
			<table> 
				<tbody>
					<tr>
						<th width="60">BKG Reference No</th>
