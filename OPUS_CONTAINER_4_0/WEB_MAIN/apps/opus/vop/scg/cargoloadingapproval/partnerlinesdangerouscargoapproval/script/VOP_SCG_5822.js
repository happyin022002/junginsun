     	...
     	try {
     		...
     		switch(srcName) {
     			...
     			case "btn_DownExcel":
                    ...
                    paramObj.title="Application Request"+ " & " +"Approval Status for Partner Lines - DG";
    	...
    	switch(sheetObj.id) {
    		case "sheet1":      //t1sheet1 init
    		    with(sheetObj){
	    	      ...
	    	      var cols = [{Type:"Text",      Hidden:0,  Width:35,   Align:"Center",  ColMerge:0,   SaveName:"spcl_cgo_rqst_seq",       KeyField:0,   CalcLogic:"",   Format:"",            Wrap:1 },
	    	             ...
	    	             {Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"cntr_cgo_seq",            KeyField:0,   CalcLogic:"",   Format:"",            Wrap:1 },
	    	             ...
	    	             {Type:"Text",      Hidden:0,  Width:45,   Align:"Center",  ColMerge:0,   SaveName:"imdg_un_no",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:45,   Align:"Center",  ColMerge:0,   SaveName:"imdg_un_no_seq",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:0,   SaveName:"imdg_clss_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"imdg_subs_rsk_lbl_cd",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"mrn_polut_flg",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"imdg_pck_grp_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"imdg_lmt_qty_flg",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:0,   SaveName:"imdg_expt_qty_flg",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:0,   SaveName:"flsh_pnt_cdo_temp",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Float",     Hidden:0,  Width:70,   Align:"Right",   ColMerge:0,   SaveName:"grs_wgt",                 KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   Wrap:1 },
	    	             {Type:"Float",     Hidden:0,  Width:70,   Align:"Right",   ColMerge:0,   SaveName:"net_wgt",                 KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:0,   Wrap:1 },
	    	             ...
	    	             {Type:"Text",      Hidden:0,  Width:40,   Align:"Center",  ColMerge:0,   SaveName:"psa_no",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   Wrap:1 },
	    	             ...
	    	             {Type:"Text",      Hidden:1,  Width:180,  Align:"Left",    ColMerge:0,   SaveName:"spcl_rqst_desc",          KeyField:0,   CalcLogic:"",   Format:"",            Wrap:1 },
    	...
    	switch(sAction) {
    		case IBSEARCH:      //retrieve
				 ...
				 formObj.f_cmd.value=SEARCH;    			
 				 sheetObj.DoSearch("VOP_SCG_5822GS.do", FormQueryString(formObj) );
			 ...
			 case IBSAVE:        //save
				 ...
				 sheetObj.DoSave("VOP_SCG_5822GS.do", FormQueryString(formObj), '-1', false);
				 break;
         }
     }
     /**
...
//             }
     ...
     function setBkgStatus(sheetObj)
     {
     	with(sheetObj)
     	{
     		if (GetCellText(sheetObj.LastRow(), "bkg_sts_cd") == "C") {
