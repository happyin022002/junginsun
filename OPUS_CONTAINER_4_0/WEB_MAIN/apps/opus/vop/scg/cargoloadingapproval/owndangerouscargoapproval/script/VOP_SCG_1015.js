     	...
     	try {
     		...
     		switch(srcName) {
     			...
     			case "btn_DownExcel":
                    ...
                    paramObj.title="Application Request / Approval Status - DG";
    	...
    	switch(sheetObj.id) {
    		case "sheet1":      //t1sheet1 init
    		    with(sheetObj){
	    	      ...
	    	      SetConfig( { SearchMode:2, MergeSheet:9, Page:20, FrozenCol:9, DataRowMerge:0 } );
	    	      ...
	    	      var cols = [{Type:"Text",      Hidden:0,  Width:40,   Align:"Center",  ColMerge:0,   SaveName:"vsl_pre_pst_nm",          KeyField:0,   CalcLogic:"",   Format:"",            Wrap:1 },
	    	             //{Type:"Text",      Hidden:0,  Width:35,   Align:"Center",  ColMerge:0,   SaveName:"",       KeyField:0,   CalcLogic:"",   Format:"",            Wrap:1 },
