...
<%
	...
	try {
		...
		vsl_cd = request.getParameter("vsl_cd");
...
<input type="hidden" name="file_pop_kind" value="readOnly">
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"><span id="title">SPCL CGO Irregular Inquiry</span></td></tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!--Button (S) -->
       				...
       				<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width="320">&nbsp;<input name="vsl_cd" required fullfill type="text" style="width:55;" class="input1" value="" caption="Vessel Code" maxlength="4" dataformat="engup"  style="ime-mode:disabled">
												...
												&nbsp;<input name="vsl_eng_nm" type="text" style="width:140;" class="input2" value="" readonly="readonly"></td>
								<td width="40">Lane</td>
								<td width="315">&nbsp;<input name="vsl_slan_cd" type="text" style="width:40;" class="input2" value="" readonly="readonly">
												&nbsp;<input name="vsl_slan_nm" type="text" style="width:233;" class="input2" value="" readonly="readonly"></td>
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width="270">&nbsp;<input name="vsl_opr_tp_cd" type="text" style="width:48;" class="input2" value="" readonly="readonly" caption="Vessel Operator" maxlength="4" dataformat="engup" style="ime-mode:disabled">
												&nbsp;<input name="vsl_opr_tp_nm" type="text" style="width:173;" class="input2" value="" readonly="readonly"></td>
						...
						<table  class="search_sm" border="0" style="width:330;" >
							<tr class="h23">
								...
								<td class="stm"><input name="spcl_cgo_cate_cd" type="radio" value="DG" class="trans" checked>Dangerous Goods&nbsp;&nbsp;<input name="spcl_cgo_cate_cd" type="radio" value="AC" class="trans" >Awkward Cargo</td>
							</tr>
						</table>
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width="620" colspan="2">&nbsp;
									<script language="javascript">ComComboObject('spcl_cgo_irr_tp_cd', 3, 400, 1, 0, 0, false);</script>
								</td>
								<td width="66">Update By</td>
								<td width="">&nbsp;<input name="upd_usr_id" type="text" style="width:60;" class="input2" value="<%=strUsr_id%>" readonly="readonly">
											 &nbsp;<input name="upd_dt" type="text" style="width:120;" class="input2" value="<%=DateTime.getFormatDate(new java.util.Date(),"yyyy-MM-dd")%>" readonly="readonly"></td>
							</tr>
						</table>
				<!--  biz_1   (E) -->
       				...
       				<td class="bg">
						...
						<table class="search" border="0" style="width:979;"> 
							<tr class="h23">
								...
								<td width="230">&nbsp;<input name="bkg_no" fullfill type="text" style="width:130;" class="input" value="" caption="BKG No." maxlength="13" dataformat="engup" style="ime-mode: disabled"></td>
								<td width="50">B/L No.</td>
								<td width="177">&nbsp;<input name="bl_no" fullfill type="text" style="width:120;" class="input" value="" caption="B/L No." maxlength="12" dataformat="engup" style="ime-mode: disabled"></td>
								<td width="36">POR</td>
								<td width="100">&nbsp;<input name="por_cd" type="text" style="width:50;" class="input2" value="" caption="POR" readonly="readonly"></td>
								<td width="25">POL</td>
								<td width="100">&nbsp;<input name="pol_cd" type="text" style="width:50;" class="input2" value="" caption="POL" readonly="readonly"></td>
								<td width="25">POD</td>
								<td width="100">&nbsp;<input name="pod_cd" type="text" style="width:50;" class="input2" value="" caption="POD" readonly="readonly"></td>
								<td width="25">Delivery</td>
								<td width="">&nbsp;<input name="del_cd" type="text" style="width:50;" class="input2" value="" caption="Delivery" readonly="readonly"></td>
							</tr>
						</table>
