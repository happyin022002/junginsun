...
<%@ page import="com.clt.apps.opus.vop.vsk.scheduleplanningoperation.vesselschedulemgt.event.VopVsk0057Event"%>
...
<input type="hidden" id = "loc_cd"          name="loc_cd">
<input type="hidden" id = "port_cd"         name="port_cd">
<input type="hidden" id = "vps_port_cd"     name="vps_port_cd">
<input type="hidden" id = "clpt_seq"        name="clpt_seq" id="clpt_seq">
<input type="hidden" id = "vps_etb_dt"      name="vps_etb_dt">
<input type="hidden" id = "vsl_svc_tp_cd"   name="vsl_svc_tp_cd">
<input type="hidden" id = "vsl_slan_dir_cd" name="vsl_slan_dir_cd">
<input type="hidden" id = "act_arr_dt"      name="act_arr_dt">
<input type="hidden" id = "pre_port_cd"     name="pre_port_cd">
<input type="hidden" id = "pre_etd_dt"      name="pre_etd_dt">
<!-- page_title_area(S) -->
	...
	<!-- page_title(E) -->
	    ...
	    <div class="opus_design_btn">
			...
			<button type="button" class="btn_accent" name="btn_retrieve" id="btn_retrieve">Retrieve</button><!-- 
			 ...
			 --><button type="button" class="btn_normal" name="btn_pfsked" id="btn_pfsked">P/F SKED Use</button>						
	    </div>
	    <!-- opus_design_btn(E) -->
