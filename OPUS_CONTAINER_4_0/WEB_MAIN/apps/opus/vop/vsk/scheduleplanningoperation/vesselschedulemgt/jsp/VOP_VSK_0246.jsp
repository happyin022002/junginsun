...
<%@ page import="com.clt.apps.opus.vop.vsk.scheduleplanningoperation.vesselschedulemgt.event.VopVsk0246Event"%>
<%@ page import="com.clt.apps.opus.vop.vsk.scheduleplanningoperation.vesselschedulemgt.vo.CanalBnkSavVO"%>
...
<%
	...
	String vslSlanCd = request.getParameter("vsl_slan_cd");
	String vpsPortCd = request.getParameter("vps_port_cd");
...
<input type="hidden" name="bound" value="<%=StringUtil.xssFilter(bound)%>">
			...
			<table class="search"> 
       		<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width=""><input type="text" style="width:55;text-align:center;" class="input2" name="vsl_slan_cd" value="<%=StringUtil.xssFilter(vslSlanCd)%>" readonly></td>   
					</tr>
				</table>
				<!--  biz_1   (E) -->
				...
				<tr>
					...
					<td align="center" colspan="2"><input type="text" name="vps_port_cd" style="width:100%;text-align:center" class="noinput" value="<%=StringUtil.xssFilter(vpsPortCd)%> " readOnly></td>
					<td align="center" colspan="2"><input type="text" style="width:100%;text-align:center" class="noinput" value="EGSCA" readOnly>	</td>
...
<!--  result mapping grid. no show in screen -->
