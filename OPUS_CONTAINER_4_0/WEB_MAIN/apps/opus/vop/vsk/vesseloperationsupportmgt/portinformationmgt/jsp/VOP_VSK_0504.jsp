		...
		<table>
			<tbody>
				...
				<tr class="h23">
					...
					<th>RHQ</th>
					<td>
						<div id="comboRhq" style="display: none;">
							<script type="text/javascript">ComComboObject('rhq', 1, 90, 1);</script>
						</div>
						<div id="inputRhq" style="display: inline;">
							<input type="text" style="width: 80px; text-align:center;" class="input2" value="" name="in_rhq" id="in_rhq" readOnly>
						</div>
					</td>
					<th>Year</th>
					<td>
						...
						--><input type="text" name="cel_year" id="cel_year" style="width: 60px; text-align:center;" class="input" value="<%=DateTime.getYear()%>" dataformat="num" maxlength="4" caption="Year" readonly><!-- 
						--><button type="button" class="calendar ir" name="btn_Calendar" id="btn_Calendar" readonly></button>
					</td>
					<th>Updated Date</th>
					<td>
...
<div class="wrap_result">
	...
	<div id="tabLayer" style="display:inline;">
		<div class="opus_design_grid">
			<div class="opus_design_btn">
				<button type="button" class="btn_accent" name="btn_t1add" id="btn_t1add">Row Add</button>
				<button type="button" class="btn_normal" name="btn_t1insert" id="btn_t1insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_t2add" id="btn_t2add">Row Add</button>
			<button type="button" class="btn_normal" name="btn_t2insert" id="btn_t2insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_t3add" id="btn_t3add">Row Add</button>
			<button type="button" class="btn_normal" name="btn_t3insert" id="btn_t3insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_t4add" id="btn_t4add">Row Add</button>
			<button type="button" class="btn_normal" name="btn_t4insert" id="btn_t4insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_t5add" id="btn_t5add">Row Add</button>
			<button type="button" class="btn_normal" name="btn_t5insert" id="btn_t5insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_t6add" id="btn_t6add">Row Add</button>
			<button type="button" class="btn_normal" name="btn_t6insert" id="btn_t6insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		<div class="opus_design_btn">
			<button type="button" class="btn_accent" name="btn_t7add" id="btn_t7add">Row Add</button>
			<button type="button" class="btn_normal" name="btn_t7insert" id="btn_t7insert">Row Insert</button>
	...
	<div class="opus_design_grid clear" name="tabLayer" id="tabLayer" style="display:none">
		...
		<script tpye="text/javascript">ComSheetObject('t5sheet3');</script>
	</div>
</div>
</form>