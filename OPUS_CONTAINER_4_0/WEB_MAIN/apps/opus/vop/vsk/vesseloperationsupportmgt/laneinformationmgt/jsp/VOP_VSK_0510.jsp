...
<%@ page import="com.clt.apps.opus.vop.vsk.vesseloperationsupportmgt.laneinformationmgt.event.VopVsk0510Event"%>
...
<%
	VopVsk0510Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	StringBuffer laneNm = new StringBuffer("");
	try {
	   	SignOnUserAccount account=(SignOnUserAccount)session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
		strUsr_id =	account.getUsr_id();
		strUsr_nm = account.getUsr_nm();
		event = (VopVsk0510Event)request.getAttribute("Event");
		...
		if(list2 != null){
			for(int cnt = 0; cnt < list2.size(); cnt++){
				...
				laneNm.append("|" + combo.getVslSlanCd() + "\t" + combo.getVslSlanNm());
...
<input id="laneNm" name="laneNm" value="<%=laneNm%>" type="hidden" />
...
<div class="wrap_result">
	...
	<div  name="tabLayer" id="tabLayer" style="display:inline">
		...
		<div  style="text-align: right;">
			<button type="button" class="btn_etc" id="btn_t1DLGroup" name="btn_t1DLGroup">Lane Group</button>
		</div>
	</div>
	...
	<div id="tabLayer" style="display:none">
        ...
        <div class="opus_design_grid">
			<h3 class="title_design mar_btm_8">Own Vessel Operator</h3>
			 <div class="opus_design_btn">
					<button type="button" class="btn_accent" name="btn_t2add1" id="btn_t2add1">Row Add</button><!-- 
					 --><button type="button" class="btn_normal" name="btn_t2insert1" id="btn_t2insert1">Row Insert</button><!-- 
					 --><button type="button" class="btn_normal" name="btn_t2del1" id="btn_t2del1">Row Delete</button>
			</div>
        ...
        <div class="opus_design_grid">
			<h3 class="title_design mar_btm_8">Partner's Vessel Operator</h3>
			 <div class="opus_design_btn">
					<button type="button" class="btn_accent" name="btn_t2add2" id="btn_t2add2">Row Add</button><!-- 
					 --><button type="button" class="btn_normal" name="btn_t2insert2" id="btn_t2insert2">Row Insert</button><!-- 
					 --><button type="button" class="btn_normal" name="btn_t2del2" id="btn_t2del2">Row Delete</button>
			</div>
        ...
        <div class="opus_design_grid">
			<h3 class="title_design mar_btm_8">Special Cargo Authorization Part</h3>
			 <div class="opus_design_btn">
					<button type="button" class="btn_accent" name="btn_t2add3" id="btn_t2add3">Row Add</button><!-- 
					 --><button type="button" class="btn_normal" name="btn_t2insert3" id="btn_t2insert3">Row Insert</button><!-- 
					 --><button type="button" class="btn_normal" name="btn_t2del3" id="btn_t2del3">Row Delete</button>
			</div>
	...
	<div name="tabLayer" id="tabLayer" style="display:none">
         <!-- opus_design_grid(S) -->
        <div class="opus_design_grid">
			<h3 class="title_design mar_btm_8">Unit(%)</h3>
			<div class="opus_design_btn">
