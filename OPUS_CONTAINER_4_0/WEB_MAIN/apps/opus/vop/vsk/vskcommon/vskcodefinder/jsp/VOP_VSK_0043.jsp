	            ...
	            <tbody>
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        --><input type="text" name="port_cd" maxlength=3 style="width:50px;text-align:center;ime-mode:disabled;" dataformat="engup" class="input" value="<%=StringUtil.xssFilter(portCd) %>"tabindex="2">
	                    </td>
	                </tr>
	                <tr>
	                    <th>Port Name</th>
