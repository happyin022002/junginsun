		...
		try {
			...
			switch(srcName) {
				case "btn_ok":
					...
					if(row < sheetObject1.HeaderRows()){
			...
			case 1:      // sheet1 init
				with(sheetObj){
					...
					if(document.form.ctrl_cd.value == "RSLT"){
						...
						cols=[ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"Status" },
						{Type:"Text",      Hidden:0,  Width:40,   Align:"Center",  ColMerge:0,   SaveName:"vsl_cd",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
						...
						{Type:"Text",      Hidden:0,  Width:40,   Align:"Center",  ColMerge:0,   SaveName:"sub_trd_dir_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
						{Type:"Date",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"act_inp_yrmon",   KeyField:0,   CalcLogic:"",   Format:"Ym",          PointCount:0,   UpdateEdit:0,   InsertEdit:1 } ];
					}else{
						...
						cols.push({Type:"Date",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"vps_eta_dt",      KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
		   ...
		   case SEARCH:      //Retrieve
				if(validateForm(sheetObj,formObj,sAction)){
					if ( sheetObj.id == "sheet1"){
						...
						var sXml=sheetObj.GetSearchData("VOP_VSK_0230GS.do", sParam); 
