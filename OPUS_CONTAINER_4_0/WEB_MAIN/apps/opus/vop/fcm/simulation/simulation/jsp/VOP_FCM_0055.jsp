...
<%@ page import="com.clt.apps.opus.vop.fcm.simulation.simulation.event.VopFcm0055Event"%>
...
<%
	...
	//Logger log = Logger.getLogger("com.clt.apps.vop.fcm.trendline.trendline");
...
<script language="javascript" src="/opuscntr/sheet/ibchart.js"></script>
