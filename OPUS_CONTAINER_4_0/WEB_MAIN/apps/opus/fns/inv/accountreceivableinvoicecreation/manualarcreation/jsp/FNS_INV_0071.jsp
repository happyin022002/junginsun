          ...
          <col width="*" />
			...
			<tr>
				...
				<td colspan="5"><input type="text" style="width: 35px;" class="input1" name="cust_cnt_cd" maxlength="2" dataformat="engup" value="" id="cust_cnt_cd" /><!-- 
								 ...
								 --><input type="text" style="width: 124px;" class="input1" value="" name="cust_rgst_no" dataformat="num" maxlength="20" id="cust_rgst_no" /><!-- 
			...
			<tr>
				...
				<th>S/I Ref. No.</th>
				<td colspan="6"><input type="text" style="width: 277px;" class="input2" value="" name="si_ref_no" readonly id="si_ref_no" /> </td>
			</tr>
			<tr>
				<th>Description</th>
			...
			<tr>
				...
				<th>Input Date</th>
				<td colspan="6"><input type="text" style="width: 80px;" class="input2" name="bl_inv_if_dt" value="" readonly id="bl_inv_if_dt" /> </td>
			</tr>
		</table>
	</div>
</div>
