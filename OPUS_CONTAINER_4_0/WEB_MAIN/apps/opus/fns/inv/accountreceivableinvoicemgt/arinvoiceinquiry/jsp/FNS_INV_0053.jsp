	...
	<div class="opus_design_inquiry">		
		...
		<colgroup>
			...
			<tbody>
				<tr>
					<th>Invoice No</th>   
					<td><input name="inv_no" type="text" style="width:130px;" class="input1" value="" dataformat="engup" maxlength="9" id="inv_no" /> </td>
					<th>Issue Date</th>   
		...
		<colgroup>
			...
			<tbody> 
				<tr>
					<th>Local VVD</th>   
					<td><input name="vvd" type="text" style="width:141px;" class="input2" value="" maxlength="9" readonly tabindex="-1" id="vvd" /> </td>
					<th>Scope</th>   
					<td><input name="svc_scp_cd" type="text" style="width:74px;" class="input2" value="" maxlength="3" readonly tabindex="-1" id="svc_scp_cd" /> </td>
					<th>Bound</th>   
					<td><input name="io_bnd_cd" type="text" style="width:55px;" class="input2" value="" maxlength="3" readonly tabindex="-1" id="io_bnd_cd" /> </td>
					<th>S/A Date</th>   
					<td><input name="sail_arr_dt" type="text" style="width:88px;" class="input2" value="" readonly tabindex="-1" id="sail_arr_dt" /> </td>
				</tr>
		</table>
		<table class="search" >
		<colgroup>
			...
			<tbody>  
				<tr>
					<th>Trunk VVD</th>   
					<td><input name="trunk_vvd" type="text" style="width:141px;" class="input2" value="" maxlength="9" readonly tabindex="-1" id="trunk_vvd" /> </td>
					<th>Lane</th>   
					<td><input name="slan_cd" type="text" style="width:38px;" class="input2" value="" maxlength="3" readonly tabindex="-1" id="slan_cd" /> </td>
					<th>Invoice Curr.</th>   
					<td><input name="locl_curr_cd" type="text" style="width:74px;" class="input2" value="" maxlength="3" readonly tabindex="-1" id="locl_curr_cd" /> </td>
					<th>Due Date</th>   
					<td><input name="due_dt" type="text" style="width:88px;" class="input2" value="" readonly tabindex="-1" id="due_dt" /> </td>
				</tr>
			</tbody>
		</table>	
		<table class="search" > 
		<colgroup>
			...
			<tbody> 
				<tr> 
					<th>Description</th>   
					<td><input name="inv_rmk" id="inv_rmk" type="text" style="width:824px;" class="input2" value="" readonly tabIndex="-1"></td>
				</tr>
			</tbody>
		</table>
	</div>
