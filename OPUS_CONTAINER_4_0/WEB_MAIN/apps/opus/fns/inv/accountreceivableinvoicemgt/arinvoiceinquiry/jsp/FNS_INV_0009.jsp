		...
		<table> 
			...
			<tbody>
				...
				<tr>
					...
					<td><input name="ots_pay_cd" type="text" style="width:30px;" class="input2" value="" readonly tabindex="-1" id="ots_pay_cd" /> </td>
					<th>OSCAR Inv No</th>
					<td><input name="org_inv_no" type="text" style="width:110px;" class="input2" value="" readonly tabindex="-1" id="org_inv_no" /> </td>
					<td></td>
				</tr>
			</tbody>
		</table>
