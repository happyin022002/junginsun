 ...
 ***************************************************************************************/
	...
	/**
	 * @extends 
	 * @class fns_inv_0116 : defile script for create  fns_inv_0116 UI.
	 */
	function fns_inv_0116() {
			...
			case 1:      //sheet1 init
				with (sheetObj) {
					...
					var HeadTitle = "";
						...
						HeadTitle = "|Seq|GL Month|RHQ|Office|Rev \n Type|Rev \n Source|ACCT|ACCT NAME|CURR|AR \n AMT|ERP AR \n AMT|DIFF AMT";
					...
					InitDataProperty(0, cnt++ , dtData,    		100,     daCenter,  false,	"erp_if_gl_dt",	 false,    "",	dfDateYm);
					InitDataProperty(0, cnt++ , dtData,    		70,     daCenter,  false,	"ar_hd_qtr_ofc_cd",      	 false,    "",	dfNone);
					InitDataProperty(0, cnt++ , dtData,    		70,     daCenter,  false,	"ar_ofc_cd", false,    "",	dfNone);
					InitDataProperty(0, cnt++ , dtData,    		70,  	daCenter,  false,	"rev_tp_cd",     	 false,    "",	dfNone);
					InitDataProperty(0, cnt++ , dtData,    		70,     daCenter,  false,	"rev_src_cd",      false,    "",	dfNone);
					InitDataProperty(0, cnt++ , dtData,    		70,  	daCenter,  false,	"inv_coa_acct_cd",     	 false,    "",	dfNone);
					InitDataProperty(0, cnt++ , dtData,    		200,  	daLeft,  false,	"acct_krn_nm",     	false,    "",	dfNone);
					InitDataProperty(0, cnt++ , dtData,    		70,		daCenter,  false,	"curr_cd",     	false,    "",	dfNone);
					if (setDpPrcsKnt > 0) {
						InitDataProperty(0, cnt++ , dtData,    	80,		daRight,   false,	"inv_amt",		false,    "",	dfNullFloat, setDpPrcsKnt);
						InitDataProperty(0, cnt++ , dtData,    	80,		daRight,  false,	"erp_amt",    false,    "",	dfNullFloat, setDpPrcsKnt);
						InitDataProperty(0, cnt++ , dtData,    	80,  	daRight,  false,	"diff_amt",   	false,    "",	dfNullFloat, setDpPrcsKnt);
						
					}
					else {
						InitDataProperty(0, cnt++ , dtData,    	80,		daRight,   false,	"inv_amt",		false,    "",	dfInteger);
						InitDataProperty(0, cnt++ , dtData,    	80,		daRight,  false,	"erp_amt",    false,    "",	dfInteger);
						InitDataProperty(0, cnt++ , dtData,    	80,  	daRight,  false,	"diff_amt",   	false,    "",	dfInteger);
		...
		switch(sAction) {
			case IBSEARCH:      //retrieve
				if(validateForm(sheetObj,formObj,sAction)) {
					...
					var sXml = sheetObj.GetSearchXml("FNS_INV_0116GS.do", FormQueryString(formObj));
	...
	function MakeComboObject(cmbObj, arrStr) {
	   ...
	   /**
		 * function called when ar_hd_qtr_ofc_cd change<br>
		 * office setting<br>
		 * <br><b>Example : </b>
		 * <pre>
		 * </pre>
	...
	/** 
	  * change value when rev_tp_cd changed<br>
	  * <br><b>Example :</b>
	  * <pre>
	  * </pre>
	  * @param {IBMultiCombo} comboObj
	...
	function rev_tp_cd_OnCheckClick(comboObj, s_index, s_code) {
     ...
     function doChange(thisObj){
      ...
      /** 
  	 * select value change when rev_src_cd changed.<br>
  	 * <br><b>Example :</b>
  	 * <pre>
  	 * </pre>
  	 * @param {IBMultiCombo} comboObj
     ...
     * @param formObj
   	 ...
   	 * @version 2009.06.03
     	...
     	function setDefaultDateValue(formObj) {
     		...
     		formObj.from_date.value = year+"-"+ComLpad(mon,2,"0")+"-"+ComLpad(sday-11,2,"0");
