    ...
    switch(sheetNo) {
        case 1:      //sheet1 init
            ...
            if (setDpPrcsKnt > 0) {
                var HeadTitle="";
                if (headType == "G") {
                HeadTitle="|Seq|Good Date|Office|Bound|Type|VVD|S/A Date|POL|POD|Cust Code|Cust Name|B/L No|I/F No|Ex. Rate|Local Amount|Invoice No.|User ID|OSCAR OTS Status|OSCAR Inv No";
                }
                else if(headType == "I"){
                HeadTitle="|Seq|I/F Date|Office|Bound|Type|VVD|S/A Date|POL|POD|Cust Code|Cust Name|B/L No|I/F No|Ex. Rate|Local Amount|Invoice No.|User ID|OSCAR OTS Status|OSCAR Inv No";
                }
                else {
                HeadTitle="|Seq|Eff. Date|Office|Bound|Type|VVD|S/A Date|POL|POD|Cust Code|Cust Name|B/L No|I/F No|Ex. Rate|Local Amount|Invoice No.|User ID|OSCAR OTS Status|OSCAR Inv No";
                }
                ...
                var cols = [{Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                            ...
                            {Type:"Text",      Hidden:0,  Width:105,  Align:"Center",  ColMerge:0,   SaveName:"ots_pay_cd",   KeyField:0,   CalcLogic:"",   Format:"" },
                            {Type:"Text",      Hidden:0,  Width:110,  Align:"Center",  ColMerge:0,   SaveName:"org_inv_no",   KeyField:0,   CalcLogic:"",   Format:"" } ];
