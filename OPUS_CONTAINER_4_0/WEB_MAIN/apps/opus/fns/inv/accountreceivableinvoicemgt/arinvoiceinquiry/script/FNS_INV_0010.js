		...
		switch(sheetNo) {
			case 1:      //sheet1 init
		      ...
		      var cols = [ {Type:"Seq",       Hidden:0, Width:35,   Align:"Center",  ColMerge:0,   SaveName:"Seq" },
		             ...
		             {Type:"Text",      Hidden:0,  Width:85,   Align:"Center",  ColMerge:0,   SaveName:"cust_cd",                KeyField:0,   CalcLogic:"",   Format:"" },
		             ...
		             {Type:"Text",      Hidden:0,  Width:85,   Align:"Center",  ColMerge:0,   SaveName:"inv_no",                 KeyField:0,   CalcLogic:"",   Format:"" },
		             {Type:"Text",      Hidden:0,  Width:45,   Align:"Center",  ColMerge:0,   SaveName:"curr_cd",                KeyField:0,   CalcLogic:"",   Format:"" } ];
		            	if (dpPrcsKnt > 0) {
		            		cols.push({Type:"Float",     Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"chg_amt",                KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:dpPrcsKnt });
		            	}
		            	else {
		            		cols.push({Type:"Int",       Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"chg_amt",                KeyField:0,   CalcLogic:"",   Format:"Integer" });
		            	}
		            	...
		            	if (dpPrcsKntLocal > 0) {
		            		cols.push({Type:"Float",     Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"local_total",            KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:dpPrcsKntLocal });
		            	}
		            	else {
		            		cols.push({Type:"Int",       Hidden:0,  Width:100,   Align:"Right",   ColMerge:0,   SaveName:"local_total",            KeyField:0,   CalcLogic:"",   Format:"Integer" });
		            	}
