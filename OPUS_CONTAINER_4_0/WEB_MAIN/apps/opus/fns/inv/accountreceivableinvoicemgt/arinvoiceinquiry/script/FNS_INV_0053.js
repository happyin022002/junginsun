		...
		switch(sheetNo) {
			case 1:      //sheet1 init
			    with(sheetObj){			        
			      ...
			      var HeadTitle="|B/L No.|POL|POD|CHG|Rated As|Rate|Per|Curr|Amount|Ex. Rate|Local Amount|INV Curr|INV Ex. Rate|INV Amount";
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
					             {Type:"Text",      Hidden:0,  Width:170,  Align:"Center",  ColMerge:0,   SaveName:"bl_src_no",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
