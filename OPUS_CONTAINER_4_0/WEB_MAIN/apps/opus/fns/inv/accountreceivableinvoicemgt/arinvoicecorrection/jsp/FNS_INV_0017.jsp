        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>Port</th>
                    <td><input type="text" style="width: 100px;" name="port_cd" value="" class="input" maxlength="5" dataformat="engup"><button type="button" class="input_seach_btn" name="btns_port" id="btns_port"></button>
                </tr>
                <tr>
                    <th>Route</th>
                    <td colspan="3">
