...
<%@ page import="com.clt.apps.opus.fns.inv.accountreceivableinvoicemgt.arinvoicecorrection.event.FnsInv0033Event"%>
	...
	<div class= "opus_design_inquiry">
		<table>
			<tbody>
				...
				<tr>
					<th>Invoice No.</th>
					<td><input type="text" style="width:120px;" class="input1" name="inv_no" dataformat="engup" maxlength="15" id="inv_no" /> </td>
					<th>B/L No.</th>
				...
				<tr >
					<th>Issue Date</th>
					<td><input type="text" class="input2" style="width:120px;" name="frm_iss_dt" readonly dataformat="ymd" id="frm_iss_dt" /> </td>
					<th title="Vessel Voyage Direction">VVD</th>
					<td><input type="text" class="input2" style="width:100px;" name="frm_local_vvd" readonly id="frm_local_vvd" /> </td>
					<th>Port CD</th>
					<td><input type="text" class="input2" style="width:105px;" name="frm_port_cd" readonly id="frm_port_cd" /> </td>
					<th>S/A Date</th>
					<td><input type="text" class="input2" style="width:103px;" name="frm_sail_arr_dt" readonly dataformat="ymd" id="frm_sail_arr_dt" /> </td>
					<th>Bound</th>
					<td><input type="text" class="input2" style="width:100px;" name="frm_io_bnd_cd" readonly id="frm_io_bnd_cd" /> </td>
				</tr>	
				<tr>
					<th>Actual Cust.</th>
					<td  colspan="3"><input type="text" style="width:30px;" class="input2" name="frm_act_cust_cnt_cd" readonly id="frm_act_cust_cnt_cd" /><input type="text" style="width:65px;" class="input2" name="frm_act_cust_seq" readonly id="frm_act_cust_seq" /><button type="button" id="btn_frmactcust" name="btn_frmactcust" class="input_seach_btn"></button><input type="text" style="width:223px;" class="input2" name="frm_cust_nm" readonly id="frm_cust_nm" /><input type="hidden" name="frm_dflt_inv_curr_div_cd" id="frm_dflt_inv_curr_div_cd" readonly> </td>
					<th>INV Cust.</th>
					<td><input type="text" style="width:30px;" class="input2" name="frm_inv_cust_cnt_cd" readonly id="frm_inv_cust_cnt_cd" /><input type="text" style="width:65px;" class="input2" name="frm_inv_cust_seq" id="frm_inv_cust_seq" /> </td>
					<th>TEU/FEU</th>
					<td><input type="text" style="width:47px;" class="input2" name="frm_bkg_teu_qty" readonly id="frm_bkg_teu_qty" /><input type="text" style="width:47px;" class="input2" name="frm_bkg_feu_qty" value="" readonly id="frm_bkg_feu_qty" /><button type="button" id="btn_container" name="btn_container" class="input_seach_btn"></button></td>
				    <th>Issue Curr</th>
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
									...
									--><input type="text" style="width:230px;" class="input2" name="cust_lgl_eng_nm" readonly id="cust_lgl_eng_nm" /><!--
