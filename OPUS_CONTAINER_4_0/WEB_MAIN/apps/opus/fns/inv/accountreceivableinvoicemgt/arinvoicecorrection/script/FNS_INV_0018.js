...
=========================================================*/
	/**
	 * @extends 
	 * @class FNS_INV_0018 : FNS_INV_0018 business script define.
	 */
	...
	function processButtonClick(){
		...
		try {
			...
			case "btn_new":
				...
				formObject.if_no.readOnly=false;
				formObject.split_cnt.readOnly=false;					
				formObject.if_no.className="input1";
				formObject.split_cnt.className="input1";
				formObject.if_no.value = "";
				formObject.iss_to_split_flg.value = "N";
				formObject.if_no.focus();
				f_Search = 0;
				break;
			case "btn_save":
			...
			case "btn_actcust":
				...
				ComOpenPopup('/opuscntr/FNS_INV_0013.do'+param, 1270, 690, '', '0,0', false, false, "", "", 0);
				break;
			case "btn_frmactcust":
			...
			case "btn_container_e":	
				...
				break;
			case "btn_rfano":
				ComOpenPopup('/opuscntr/FNS_INV_0090.do?pgmNo=FNS_INV_0090&rfa_no='+formObject.frm_rfa_no.value, 600, 366, '', '0,0');  
				break; 
			case "btn_scno":
				ComOpenPopup('/opuscntr/FNS_INV_0091.do?pgmNo=FNS_INV_0091&sc_no='+formObject.frm_sc_no.value, 600, 366, '', '0,0');  
				break; 
			} // end switch
		}catch(e) {
			if( e == "[object Error]") {
	...
	/** 
	 * IBSheet Object sheetObjects array register <br>
	 * <br><b>Example :</b>
	 * <pre>
	 * </pre>
	...
	function loadPage() {
		...
		if(document.form.iss_to_split_flg.value == "Y") doActionIBSheet(sheetObjects[0],document.form,IBSEARCH_ASYNC02);
		else document.form.if_no.focus();
	}
...
//			      SetConfig( { SearchMode:2, MergeSheet:0, Page:20, DataRowMerge:1 } );
			      ...
			      SetSheetHeight(122);
//			      SetWaitImageVisible(0);
//			      sheetObj.ShowSubSum([{StdCol:"curr_cd", SumCols:"7", Sort:false, ShowCumulate:true, CaptionCol:0, CaptionText:"Total"}]);
			      sheetObj.ShowSubSum([{StdCol:"curr_cd", SumCols:"chg_amt", Sort:0,   CaptionCol:3, CaptionText:"%col"}]);
		...
		case "t0sheet1":   			
		    with(sheetObj){
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ibflag",               KeyField:0,   CalcLogic:"",   Format:"" },
			             {Type:"Seq",       Hidden:0, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"Seq",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:-1 },
			             {Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"chg_cd",               KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:-1 },
			             {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"curr_cd",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:-1 },
			             ...
			             {Type:"AutoSum",   Hidden:0,  Width:70,   Align:"Right",   ColMerge:1,   SaveName:"chg_amt",              KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
		...
		case "t1sheet1":   			
		    with(sheetObj){
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ibflag",               KeyField:0,   CalcLogic:"",   Format:"" },
			             ...
			             {Type:"Float",     Hidden:0,  Width:80,   Align:"Right",   ColMerge:1,   SaveName:"trf_rt_amt",           KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1,   EditLen:50 },
			             {Type:"Float",     Hidden:0,  Width:70,   Align:"Right",   ColMerge:1,   SaveName:"rat_as_cntr_qty",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:3,   UpdateEdit:1,   InsertEdit:1,   EditLen:50 },
			             {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"per_tp_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:-1 },
			             {Type:"AutoSum",   Hidden:0,  Width:70,   Align:"Right",   ColMerge:1,   SaveName:"chg_amt",              KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0,   EditLen:-1 },
			             {Type:"Text",      Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"inv_xch_rt",           KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:7,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Text",      Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"tj_src_nm",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Text",      Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ar_if_no",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Text",      Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ar_if_ser_no",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		...
		case "s0sheet1":      //sheet1 init
		    with(sheetObj){
			      var HeadTitle="|ar_if_no|act_cust_cnt_cd|act_cust_seq|bkg_teu_qty|bkg_feu_qty|inv_ref_no|co_stf_ctnt|inv_rmk|io_bnd_cd|sail_dt|cust_cd|del_flg|bfr_inv_curr_cd";
			      SetConfig( { SearchMode:2, MergeSheet:0, Page:20, DataRowMerge:1 } );
			      var info    = { Sort:1, ColMove:1, HeaderCheck:0, ColResize:1 };
			      var headers = [ { Text:HeadTitle, Align:"Center"} ];
			      InitHeaders(headers, info);
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:40,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
			             ...
			             {Type:"Text",     Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"act_cust_cnt_cd",  KeyField:0 },
			             {Type:"Text",     Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"act_cust_seq",     KeyField:0 },
			             ...
			             {Type:"Text",     Hidden:1,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"del_flg" },
			             {Type:"Text",     Hidden:1,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"bfr_inv_curr_cd" } ];
	...
	/** 
	 * retrieve save server function doActionIBSheet <br>
	 * <br><b>Example :</b>
	 * <pre>
	 * </pre>
	 * @param  {IBSheet} sheetObj  
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		case IBSEARCH_ASYNC01: // screen loading AR_OFFICE_LIST retrieve
			ComOpenWait(true);
		...
		case IBSEARCH_ASYNC02:
			...
			var sXml=sheetObj.GetSearchData("FNS_INV_0018GS.do", FormQueryString(formObj));
			var sStr=ComGetEtcData(sXml,"split_cust_cd");
			var arrStr=sStr.split("|");
			
			formObj.split_cnt.value = arrStr.length == 1 ? 2 : arrStr.length;
			
			for(var i=0;i<arrStr.length;i++){
				formObj.act_cust_cnt_cd[i].value = arrStr[i].substring(0,2);
				formObj.act_cust_seq[i].value = arrStr[i].substring(2,8);
				formObj.cust_cnt_cd.value = arrStr[i].substring(0,2);
				formObj.cust_seq.value = arrStr[i].substring(2,8);
				
				formObj.f_cmd.value=SEARCH03;
				var sXml=sheetObj.GetSearchData("INVCommonGS.do", FormQueryString(formObj));
				var cust_nm=ComGetEtcData(sXml,"cust_eng_nm");
				formObj.cust_lgl_eng_nm[i].value = cust_nm;
			}
			
			if(arrStr.length == 1){
				formObj.act_cust_cnt_cd[1].value = formObj.act_cust_cnt_cd[0].value;
				formObj.act_cust_seq[1].value = formObj.act_cust_seq[0].value;
				formObj.cust_lgl_eng_nm[1].value = formObj.cust_lgl_eng_nm[0].value;
			}
		...
		case IBSEARCH:      //retrieve 0
			if(validateForm(sheetObj,formObj,sAction)){
				...
				var sXml=sheetObj.GetSearchData("FNS_INV_0018GS.do" , FormQueryString(formObj));
				    arrXmlA=sXml.split("|$$|");
				if ( arrXmlA[0] != null)	{
					sheetObjects[0].LoadSearchData(arrXmlA[0],{Sync:1} );
				}
				if ( arrXmlA[1] != null)	{
					sheetObjects[1].LoadSearchData(arrXmlA[1],{Sync:1} );
				}	
				if ( arrXmlA[2] != null)	{
					sheetObjects[2].LoadSearchData(arrXmlA[2],{Sync:1} );
				}
				if ( arrXmlA[3] != null)	{
					sheetObjects[3].LoadSearchData(arrXmlA[3],{Sync:1} );
				}
				if(ComGetEtcData(arrXmlA[0],"TRANS_RESULT_KEY")=="F"){
					ComOpenWait(false);  
					document.form.if_no.select();
					return;
				}	
				...
				var sStr=ComGetEtcData(arrXmlA[0],"max_seq");
				document.form.max_seq.value=sStr;
				
				var orgIfNoList=ComGetEtcData(arrXmlA[0],"org_if_no_list");
				document.form.org_if_no_list.value=orgIfNoList;
				
				var cxlIfNoList=ComGetEtcData(arrXmlA[0],"cxl_if_no_list");
				document.form.cxl_if_no_list.value=cxlIfNoList;
				
				var maxIfNo=ComGetEtcData(arrXmlA[0],"max_if_no");
				document.form.max_if_no.value=maxIfNo;
					...
					for(cnt=0;cnt < split_cnt; cnt++){
						for(i=0;i<sheetObjects.length;i++){
							if(sheetObjects[i].id=="t"+cnt+"sheet1"){
								if ( arrXmlA[1] != null)	{
									sheetObjects[i].LoadSearchData(arrXmlA[1],{Sync:1} );
								}
								for(k=1;k<=sheetObjects[i].RowCount();k++){
									...
									if (currPoint == '0') {
										sheetObjects[i].InitCellProperty(k, "chg_amt",{ Type:"Int",Align:"Right",Format:"Integer"} );
									}
									else {
										sheetObjects[i].InitCellProperty(k, "chg_amt",{ Type:"Float",Align:"Right",Format:"NullFloat",PointCount:currPoint} );
									}
								}	
	//							sheetObjects[i].ShowSubSum([{StdCol:"curr_cd", SumCols:"7", Sort:false, ShowCumulate:false, CaptionCol:0, CaptionText:"Total"}]);
	//							sheetObj.ShowSubSum([{StdCol:"curr_cd", SumCols:"chg_amt", Sort:0,   CaptionCol:2, CaptionText:"Total"}]);
							}
						}
		...
		case IBSAVE:        //save
						...
						if(sheetObjects[i].id=="t"+cnt+"sheet1"){
							...
							for(c; c<=sheetObjects[i].RowCount();c++){
								if(sheetObjects[i].GetCellValue(c,"chg_amt")!="0"&&sheetObjects[i].GetCellValue(c,"Seq")!=""){
									chgSeq=chgSeq + 1;
									if(prev_ser_no!=sheetObjects[i].GetCellValue(c,"ar_if_ser_no")){
										serNo=serNo+1;
										arIfChgSeq=1;	
									}else{
										serNo=serNo;
									...
									prev_ser_no=sheetObjects[i].GetCellValue(c,"ar_if_ser_no");
			...
			if(validateForm(sheetObj,formObj,sAction)){		
				...
				if (ComShowCodeConfirm("INV00160")) {   
					...
					setTimeout( function () {				
						sheetObj.DoSave("FNS_INV_0018GS.do", {Param:FormQueryString(formObj)+ "&" + ComSetPrifix(sheetObjects[9].GetSaveString(true),"s0sheet1_")+ "&" + ComSetPrifix(sheetObjects[10].GetSaveString(true),"s0sheet2_")+ "&" + ComSetPrifix(sheetObjects[11].GetSaveString(true),"s0sheet3_")+ "&" + ComSetPrifix(sheetObjects[12].GetSaveString(true),"s0sheet4_"),Quest:"false", Sync:1} );
					    //InvOpenWait(false, true);
					    ar_ofc_cd.SetSelectText(document.form.ofc_cd.value);						
						formObj.if_no.readOnly=true;
						formObj.split_cnt.readOnly=true;					
						formObj.if_no.className="input2";
						formObj.split_cnt.className="input2";
					} , 100);
					*/
					
					var sParam = FormQueryString(formObj)+ "&" + ComSetPrifix(sheetObjects[9].GetSaveString(true),"s0sheet1_")+ "&" + ComSetPrifix(sheetObjects[10].GetSaveString(true),"s0sheet2_")+ "&" + ComSetPrifix(sheetObjects[11].GetSaveString(true),"s0sheet3_")+ "&" + ComSetPrifix(sheetObjects[12].GetSaveString(true),"s0sheet4_");
										
					ComOpenWait(true);
	 				var sXml=sheetObj.GetSaveData("FNS_INV_0018GS.do", sParam);
					var backendJobKey=ComGetEtcData(sXml, "BackEndJobKey");
					if (backendJobKey != undefined && backendJobKey != '') {
						ComSetObjValue(formObj.backendjob_key, backendJobKey);
						sheetObj.SetWaitImageVisible(0);
						sheetObj.SetWaitTimeOut(10000);
						timer=setInterval(getBackEndJobStatusSAVE, 3000); // calling getBackEndJobStatus function after three seconds - recall
					}
...
//						InsertItem( document.form.ofc.value.substring(0,"0")+document.form.ofc.value.substring(0,3) + ComLpad(min_seq));
	...
	/** 
	 * screen form input validateForm <br>
	 * <br><b>Example :</b>
	 * <pre>
	 * </pre>
	 * @param  {IBSheet} sheetObj  
	...
	function validateForm(sheetObj,formObj,sAction){
		with(formObj){
			...
			case IBSAVE:        //save
				...
				if(formObj.split_cnt.value != ""){
					if(formObj.iss_to_split_flg.value == "N"){
						for(cnt=0;cnt < formObj.split_cnt.value; cnt++){						
					...
					for (i=0; i<document.form.split_curr_cd.length; i++) {						
						if(parseFloat(document.form.mst_chg_amt[i].value.replace(",","")) != parseFloat(document.form.split_chg_amt[i].value.replace(",",""))){
					...
					for(cnt=0;cnt < document.form.split_cnt.value; cnt++){
						...
						if(formObj.iss_to_split_flg.value == "Y"){
							if(amtFlg == "Y"){
								var tabIfNo = tabObjects[0].GetTabTitle(cnt);
								
								for(var pp=1; pp<=sheetObjects[9].RowCount(); pp++){
									var mainIfNo = sheetObjects[9].GetCellValue(pp,"ar_if_no");
									
									if(tabIfNo == mainIfNo) sheetObjects[9].SetCellValue(pp,"del_flg","Y");
								}
							}else{
								if( formObj.act_cust_cnt_cd[cnt].value.trim() == "" || formObj.act_cust_seq[cnt].value.trim() == "" ) {
									ComShowCodeMessage("INV00004");
	...
	/**
	 * sheet2 retrieve finish execute function<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	function sheet2_OnSearchEnd(sheetObj, ErrMsg){
		...
		for(k=1;k<=sheetObj.RowCount();k++){
			...
			if (currPoint == '0') {
				sheetObj.InitCellProperty(k, "chg_amt",{ Type:"Int",Align:"Right",Format:"Integer"} );
			}
			else {
				sheetObj.InitCellProperty(k, "chg_amt",{ Type:"Float",Align:"Right",Format:"NullFloat",PointCount:currPoint} );
			}
		}	
		...
		var sumrow=sheetObj.FindSubSumRow();
		...
		for (idx=0; idx<arrRow.length; idx++) {
			//sVal=sheetObjects[1].GetCellValue(arrRow[idx], "chg_amt")+"";
	...
	/**
	 * sheet1 retrieve finish execute function<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	/**
	 * Each tap charge grid subsum form split total price setting<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	function reSum(sheetObj){	
		//sheetObj.HideSubSum();
//		sheetObj.ShowSubSum([{StdCol:"curr_cd", SumCols:"7", Sort:false, ShowCumulate:false, CaptionCol:0, CaptionText:"Total"}]);
//		sheetObj.ShowSubSum([{StdCol:"curr_cd", SumCols:"7", Sort:0,   CaptionCol:2, CaptionText:"Total"}]);
		var max_seq=document.form.max_seq.value;
		var split_cnt=document.form.split_cnt.value;
		var sumrow=0;	
		var T=Number('1e'+1);
		if(split_cnt!=''&&max_seq!=''){
			if(document.form.split_curr_cd!=undefined)
				{
			for (i=0; i<document.form.split_curr_cd.length; i++) {	
				var amt=0.000;
				for(cnt=0;cnt < split_cnt; cnt++){
					for(j=0;j<sheetObjects.length;j++){
						if(sheetObjects[j].id=="t"+cnt+"sheet1"){
							...
							arrRow=sumrow.split("|");
							for (idx=0; idx<arrRow.length; idx++) {
								if(document.form.split_curr_cd[i].value==sheetObjects[j].GetCellValue(arrRow[idx]-1, "curr_cd")){
									amt=amt + parseFloat(sheetObjects[j].GetCellValue(arrRow[idx], "chg_amt"));
								}
							}
						}
	...
	/**
	 * combo box ar_ofc_cd data change execute function<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	function ar_ofc_cd_OnChange(comboObj,oldIndex, oldText, oldCode, newIndex, newText, newCode){ 
	    ...
	    formObj.inv_curr_cd.value = lclCurr;
	    
	}
	/**
	 * paper issue Number of copy invoice office retrieve setting <br>
	 * <br><b>Example : </b>
	 * <pre>
	 *   get_copy_cnt();
	 * </pre>
	...
	function MakeComboObject2(cmbObj, arrStr) {
		for (var i=1; i < arrStr.length;i++ ) {
			...
			var ar_ofc_cd_c=arrStr2[1];
			ar_ofc_cd.InsertItem(i-1, ar_ofc_cd_c, arrStr[i]);			 
		}
		ar_ofc_cd.SetDropHeight(190);
	}
	/**
	 * popup (FNS_INV_0086) UI process, execute function<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	/**
	 * popup (FNS_INV_0098) UI process, execute function<br>
	 * <br><b>Example : </b>
	 * <pre>
	 *    getFNS_INV_0098();
	 * </pre>
	...
	/**
	 * act_cust_cnt_cd, act_cust_seq change execute function<br>
	 * <br><b>Example : </b>
	 * <pre>
	 *    fn_act_cust_chg();
	 * </pre>
	...
	/**
	 * Selection tab's act_cust_cnt_cd, act_cust_seq change execute function<br>
	 * Call fn_dueDate_chg()
	 * @author Choi Do Soon
	 * @version 2009.10.06
	 */
	...
	/**
	 * Go to Send click mail popup(FNS_INV_0034_02)<br>
	 * <br><b>Example : </b>
	 * <pre>
	 *    open_email();
	 * </pre>
	...
	/**
	 * selection tab's cust_cnt_cd length check,  cust_seq focus<br>
	 * <br><b>Example : </b>
	 * <pre>
	 *    checkCustLeng();
	 * </pre>
...
//			rdFile = "FNS_INV_0522.mrd";
	...
	/**
	 * BackEndJob result complete, result retrieve.<br>
	 * 
	 * @return none
	...
	/**
	 * selection tab's charge grid(t0sheet1) price change<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	/**
	 * selection tab's charge grid(t1sheet1) price change<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	/**
	 * selection tab's charge grid(t2sheet1) price change<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	/**
	 * selection tab's charge grid(t3sheet1) price change<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	/**
	 * selection tab's charge grid(t4sheet1) price change<br>
	 * <br><b>Example : </b>
	 * <pre>
	...
	function initControl() {
		//Axon event process1. eventcatch
	...
	function obj_keypress(){
	 ...
	 /**
	  * DXBBB, FNS_INV_0110 popup screen, ISSUE OK in case, call <br>
	  * <br><b>Example :</b>
	  * @param
	  * @return
	  * @version 2009.10.20
	 ...
	 function setCustTargetYN() {
	 	...
	 	//if(formObject.iss_to_split_flg.value == "Y"){
	 		sheetObj.DataInsert(-1);
	 		sheetObj.SetCellValue(1,prefix+"act_cust_cnt_cd","");
	 		sheetObj.SetCellValue(1,prefix+"act_cust_seq","");
	 		sheetObj.SetCellValue(1,prefix+"dflt_inv_curr_div_cd","");
	 		sheetObj.SetCellValue(1,prefix+"bl_src_no",formObject.frm_bl_src_no.value);
	 		sheetObj.SetCellValue(1,prefix+"target_yn", "Y");
	 	/*	
	 	}else{
		 	for(cnt=0;cnt < formObject.split_cnt.value; cnt++){
		 		sheetObj.DataInsert(-1);
		 		sheetObj.SetCellValue(cnt+1,prefix+"act_cust_cnt_cd",formObject.act_cust_cnt_cd[cnt].value);
		 		sheetObj.SetCellValue(cnt+1,prefix+"act_cust_seq",formObject.act_cust_seq[cnt].value);
		 		sheetObj.SetCellValue(cnt+1,prefix+"dflt_inv_curr_div_cd",formObject.dflt_inv_curr_div_cd[cnt].value);
	 ...
	 * @see #doActionIBSheet
	 */
	function getBackEndJobStatusSAVE() {
		form.f_cmd.value=COMMAND01;
		
 		var sXml=sheetObjects[0].GetSearchData("FNS_INV_0018GS.do", FormQueryString(form));
		var arrXml=sXml.split("|$$|");
		var jobState=ComGetEtcData(arrXml[0], "jb_sts_flg");
		//alert("getBackEndJobStatus:::" + jobState);
		if(jobState == "3") {
			clearInterval(timer);
			getBackEndJobLoadFileSAVE();
			ComOpenWait(false);
		} else if(jobState == "4") {
			clearInterval(timer);
	 		// BackEndJob was failed
	...
	function getBackEndJobLoadFileSAVE() {
	 	var formObj=document.form;
