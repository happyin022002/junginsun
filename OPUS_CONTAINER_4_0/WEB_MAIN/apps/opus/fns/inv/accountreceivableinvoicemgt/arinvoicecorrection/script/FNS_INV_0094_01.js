	...
	function initSheet(sheetObj,sheetNo) {
		...
		case "sheet2":
		    with(sheetObj){
		      ...
		      var HeadTitle1="|inv_no|ar_if_no|ar_ofc_cd|bl_src_no|bkg_no|iss_dt|inv_ref_no|vvd|por_cd|pol_cd|pod_cd|del_cd|sail_arr_dt|svc_scp_cd|io_bnd_cd|act_cust_cnt_cd|act_cust_seq|cust_nm|rev_tp_cd|rev_src_cd|inv_cust_cnt_cd|inv_cust_seq|inv_cust_nm|inv_curr_cd|dflt_inv_curr_div_cd";
		      var headCount=ComCountHeadTitle(HeadTitle1);
		      var rowCnt=0;
