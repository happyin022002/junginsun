...
//    	sheetObj.SetCellValue(1,"inv_vat_chg_cd",formObj.inv_vat_chg_cd.text,0);
     ...
     * @version 2009.10.19
     */
	/*function MakeComboObject2_1(cmbObj, arrStr) { // 기존소스
  	 	cmbObj.RemoveAll();
