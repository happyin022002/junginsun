...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationmasterdatamgt.renewalmasterdatamgt.event.FnsJoo0088Event"%>
...
<script type="text/javascript">
	var joCrrCdComboItems 	= "<%=joCrrCdComboItems%>";
	var trdCdComboItems 	= "<%=trdCdComboItems%>";
	...
	<table>
		<tbody>
			...
			<tr class="h23">
               ...
               <th>Delete Mark</th>
               <td><input type="radio" class="trans" name='delt_flg'  value='' checked>&nbsp;All
