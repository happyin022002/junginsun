    ...
    try {
        ...
        switch (srcName) {
            ...
            case "btn_copy":
                ...
                if(ComIsEmpty(trdCd) || trdCd.length < 3){
        ...
        case "sheet1": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                ...
                var cols = [ 
                       ...
                       {Type:"PopupEdit", Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"vndr_seq",         KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                       ...
                       {Type:"PopupEdit", Hidden:0, Width:110,  Align:"Center",  ColMerge:1,   SaveName:"cust_cd",          KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                       {Type:"Text",      Hidden:1, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"cust_seq",         KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                ...
                SetColProperty(0    , "trd_cd"          , {ComboText:"|"+trdCdComboItems, ComboCode:"|"+trdCdComboItems} );
    ...
    switch (sAction) {
        ...
        case IBSEARCH_ASYNC05://Rev Lane Combo Item Setting.
            ...
            if(!ComIsEmpty(rlaneCdComboItems)){
                ...
                ComShowCodeMessage("JOO00136", "Rev Lane");
