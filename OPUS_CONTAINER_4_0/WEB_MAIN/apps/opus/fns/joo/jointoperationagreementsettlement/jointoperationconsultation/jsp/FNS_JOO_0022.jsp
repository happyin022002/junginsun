...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.jointoperationconsultation.event.FnsJoo0022Event"%>
...
<input type="hidden" name="sysdate" id="sysdate" value="<%=yyyyMMdd%>">
			...
			<tbody>
			    ...
			    <tr>
					<td><input type="radio" value="0" name="if_flg" class="trans " checked="" id="if_flg" />&nbsp;&nbsp;<b>Iss.DT</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- 
					 ...
					 --><input type="text" style="width:80px;" value="<%=yyyyMMdd%>" class="input" name="slp_iss_dt" dataformat="ymd" id="slp_iss_dt" /><button type="button" id="btn_calendar" name="btn_calendar" class="calendar ir"></button></td>
               		<th>Office</th>
               		<td><script type="text/javascript">ComComboObject('auth_ofc_cd',1, 80,0, 0);</script></td>
					<th>CSR No.</th>
					<td><input type="text" style="width:160px;" name="csr_no" class="input" maxlength="20" id="csr_no" dataformat="engup"/> </td>
				</tr> 
