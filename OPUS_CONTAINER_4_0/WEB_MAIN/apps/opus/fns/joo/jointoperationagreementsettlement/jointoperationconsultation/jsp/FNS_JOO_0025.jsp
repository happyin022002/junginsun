	...
	<div class= "opus_design_inquiry">
		<table style="width:979px">
			<tbody>
			    ...
			    <tr>
					<td>
					 	<input type="radio" value="0" name="gubun" class="trans" checked="" id="gubun" />&nbsp;&nbsp;<!-- 
					    ...
					    --><button type="button" id="btnCalTo" name="btnCalTo" class="calendar ir"></button>
					</td>	
					<th>Office</th>
					<td><script type="text/javascript">ComComboObject('auth_ofc_cd',1,80,0,1);</script></td>
					<th>CSR No.</th>
					<td><input type="text" style="width:170px;" class="input" name="csr_no" maxlength="20" dataformat="engup" id="csr_no" /> </td>
				</tr> 
			</tbody>
		</table>
