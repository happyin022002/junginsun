...
function initSheet(sheetObj, sheetNo) {
    ...
    switch (sheetObj.id) {
        case "t1sheet1": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                var HeadTitle1="|Partner|R.Lane|Invoice No|Slip No|Approved|Curr.|Revenue|Expense|Actual\nPayer/Receiver|Customer/S.Provider|Customer/S.Provider|cust_vndr_cnt_cd|cust_vndr_seq";
                var HeadTitle2="|Partner|R.Lane|Invoice No|Slip No|Approved|Curr.|Revenue|Expense|Actual\nPayer/Receiver|Code|Name|cust_vndr_cnt_cd|cust_vndr_seq";
                ...
                var cols = [ 
                       ...
                       //{Type:"Seq",       Hidden:0, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "seq",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       ...
                       {Type:"Text",      Hidden:0, Width:120,  Align:"Center",  ColMerge:0,   SaveName: prefix + "acctg_crr_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
        ...
        case "t2sheet1": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                var HeadTitle1="|Partner|R.Lane|Invoice No|Slip No|Approved|Rev\nExp|Item|Curr.|Actual\nPayer/Receiver|Customer/S.Provider|Customer/S.Provider|Rev.VVD|Amount|Amount|Remark|Udate User|Update Date";
                    //HeadTitle1+="|cust_vndr_cnt_cd|cust_vndr_seq";
                var HeadTitle2="|Partner|R.Lane|Invoice No|Slip No|Approved|Rev\nExp|Item|Curr.|Actual\nPayer/Receiver|Code|Name|Rev.VVD|Invoice|Slip|Remark|Udate User|Update Date";
                    //HeadTitle2+="|cust_vndr_cnt_cd|cust_vndr_seq";
                var headCount=ComCountHeadTitle(HeadTitle1);
                ...
                var cols = [ 
                       ...
                       {Type:"Float",     Hidden:0, Width:120,  Align:"Right",   ColMerge:0,   SaveName: prefix + "inv_act_amt",        KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Float",     Hidden:0, Width:120,  Align:"Right",   ColMerge:0,   SaveName: prefix + "slp_act_amt",        KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
    ...
    switch (sAction) {
        case IBSEARCH: // retrieve
            ...
            if ( sheetID == "t1sheet1"){
                ...
                ComOpenWait(true);
                var sXml=sheetObj.GetSearchData("FNS_JOO_0107GS.do", param);
...
function t2sheet1_OnSearchEnd(sheetObj, ErrMsg) {
    if (sheetObj.RowCount() > 0) {
        ...
        for(var i=iStRow;i<=iEdRow;i++){
            ...
            if(str.indexOf("Total")>-1){
                sheetObj.SetMergeCell(i,1,1,12); // OWN 5칸 머지
