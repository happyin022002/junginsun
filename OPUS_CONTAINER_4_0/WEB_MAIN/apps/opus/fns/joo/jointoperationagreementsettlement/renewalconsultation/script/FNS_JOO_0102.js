    ...
    try {
        ...
        switch (srcName) {
            ...
            case "btn_vvd_to_next":
                ...
                break;
            case "btn_GoToStl":
                var params      = "parentPgmNo=FNS_JOO_M001&moved_from=0101&pgmNo=FNS_JOO_0101";
                this.location   = "/opuscntr/FNS_JOO_0101.do?" + params;
                break;
            case "btn_SlipCreate":
...
function initSheet(sheetObj, sheetNo) {
    ...
    switch (sheetObj.id) {
        case "sheet1": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                var HeadTitle1="|Partner|Lane|Curr.|Revenue|Expense|Comb\nined|Actual\nPayer/Receiver|Partner|Partner|Invoice Month|dtl_grp_key";
                var HeadTitle2="|Partner|Lane|Curr.|Revenue|Expense|Comb\nined|Actual\nPayer/Receiver|Customer|S. Provider|Invoice Month|dtl_grp_key";
                ...
                var cols = [ 
                       ...
                       {Type:"Float",     Hidden:0, Width:90,   Align:"Right",   ColMerge:0,   SaveName: prefix + "stl_rev_act_amt",KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Float",     Hidden:0, Width:90,   Align:"Right",   ColMerge:0,   SaveName: prefix + "stl_exp_act_amt",KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"CheckBox",  Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName: prefix + "chk_cmb_flg" },
                       {Type:"Combo",     Hidden:0, Width:90,   Align:"Center",  ColMerge:0,   SaveName: prefix + "acctg_crr_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:0 },
        ...
        case "sheet2": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                ...
                var cols = [ 
                       ...
                       {Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:0,   SaveName: prefix + "exp_vvd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       ...
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "vsl_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "skd_voy_no",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "skd_dir_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "rev_dir_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "rev_yrmon",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "stl_vvd_seq",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "jo_crr_cd",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "jo_stl_jb_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "locl_curr_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Combo",     Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "re_divr_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:0,   SaveName: prefix + "dtl_grp_key",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 }
                       ];
    ...
    switch(colName){
        case "sheet1_chk_cmb_flg":
            ...
            if(!GetIsCurrencyChecked(sheetObj, Row, selLoclCurrCd)){
                ...
                if(!GetIsActualPayerOrReciverChecked(sheetObj, Row, selAcctgCrrCd)){
                    ComShowCodeMessage('JOO00210');//Can't make an invoice with different partners.
                    sheetObj.SetAllowCheck(0);//체크를 막는다.
                }else{
...
function sheet2_OnSearchEnd(sheetObj, ErrMsg) {
    if (sheetObj.RowCount() > 0) {
        sheetObj.SetSumText(0, "sheet2_rlane_cd", "TOTAL");
    }
}
...
function SetSheetInvoiceDetail(sheetObj, Row, selValue){
    ...
    var selGrpKey       = sheetObj.GetCellValue(Row, "sheet1_dtl_grp_key");
    var selAcctgCrrCd   = sheetObj.GetCellValue(Row, "sheet1_acctg_crr_cd");
...
function GetIsActualPayerOrReciverChecked(sheetObj, Row, selValue){
    var chkRows = sheetObj.FindCheckedRow("sheet1_chk_cmb_flg");
    if (chkRows == "") {
        //1건도 존재 하지 않으므로 skip
        return true;
    ...
    var arrSelAcctgCrrCds = selValue.split("^"); //result : "1|3|5|"
    ...
    for (var idx=0; idx<arrChkRows.length; idx++){
        ...
        var tmpAcctgCrrCd   = sheetObj.GetCellValue(nRow, "sheet1_acctg_crr_cd");        
        var arrTmpAcctgCrrCds = tmpAcctgCrrCd.split("^"); 
        
        if(arrTmpAcctgCrrCds == "" || arrTmpAcctgCrrCds.length > 3) return false;
