...
<%@ page import="com.clt.apps.opus.fns.joo.jointoperationagreementsettlement.renewalconsultation.event.FnsJoo0103Event"%>
...
<%
	...
	try {
		...
		pop_yn = JSPUtil.getNull(StringUtil.xssFilter(request.getParameter("pop_mode")), "N");
	...
	<!-- popup_title_area(S) -->
	 <div class="layer_popup_title">
		...
		<div class="page_title_area clear">
			<!-- page_title(S) -->
			<h2 class="page_title"><span>CSR Creation</span></h2>
			<!-- page_title(E) -->
			<!-- opus_design_btn(S) -->
...
<% if (pop_yn.equals("Y")) { %><div class="layer_popup_contents"><%}%>
<!-- wrap_search(S) -->
