...
function initSheet(sheetObj, sheetNo) {
    ...
    switch (sheetObj.id) {
        case "sheet1": // t1sheet1 init     //t1sheet1 init
            with(sheetObj){
                var HeadTitle1="|CHK|Invoice No|Actual\nPayer/Receiver|Customer/S.Provider|Customer/S.Provider|Curr.|Rev\nExp|Amount|Effective\nDate|Due Date|Description";
                    HeadTitle1+="|||||||||||||||";//15개
                var HeadTitle2="|CHK|Invoice No|Actual\nPayer/Receiver|Code|Name|Curr.|Rev\nExp|Amount|Effective\nDate|Due Date|Description";
                    HeadTitle2+="|||||||||||||||";//15개
                ...
                var cols = [ 
                       ...
                       {Type:"CheckBox",  Hidden:0, Width:55,   Align:"Center",  ColMerge:0,   SaveName: prefix + "chk_csr_flg" },
                       ...
                       {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:0,   SaveName: prefix + "acctg_crr_cd",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                       ...
                       {Type:"Date",      Hidden:0, Width:100,  Align:"Center",  ColMerge:0,   SaveName: prefix + "rqst_dt",            KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                       {Type:"Text",      Hidden:0, Width:150,  Align:"Left",    ColMerge:0,   SaveName: prefix + "csr_desc",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
...
function doActionIBSheet(sheetObj, formObj, sAction, cRow) {
    ...
    switch (sAction) {
        case IBSEARCH: // retrieve
            ...
            var sXml = sheetObj.GetSearchData("FNS_JOO_0103GS.do", param);
        ...
        case IBSAVE: // save
            ...
            var sXml = sheetObj.GetSaveData("FNS_JOO_0103GS.do", sParam);
    ...
    switch (colName) {
        case prefix + "eff_dt" :
            ...
            if(!ComIsDate(effDate)){
                sheetObj.ValidateFail(2, ComShowMessage(ComGetMsg("JOO00213", "Effective Date"))); //Please input Duration {?msg1} exactly
            }
            ...
            if(!ComIsEmpty(effDate) && !ComIsEmpty(tmpRqstDt)){
                if(!GetCheckPeriod(effDate, tmpRqstDt)){
                    sheetObj.ValidateFail(2, ComShowMessage(ComGetMsg("JOO00211", "Effective Date", "Due Date")));
                }
            }
            break;
        case prefix + "rqst_dt" :
            ...
            if(!ComIsDate(rqstDate)){
                sheetObj.ValidateFail(2, ComShowMessage(ComGetMsg("JOO00213", "Due Date"))); 
            }
