 ...
 ***************************************************************************************/
 /**
 * @extends 
 * @class Line 접대비 DFF Popup : business script for STM_SAP_0025
 */
/* 공통전역변수 */
var ipageNo=1 ;
	    ...
	    try {
	        ...
	        switch(srcName) {
	    	    ...
	    	    case "btns_loc_srh":
            		...
            		ComOpenPopup("STM_SAP_0023.do" + param, 400, 420, "setLocation", "0,0", true, false);
            		break;	
	    	    case "btns_cal1":  
            		//Vendor Invoice Date
        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
	                ...
	                var HeadTitle="|attr_ctnt1|attr_ctnt2|attr_ctnt3|attr_ctnt4|attr_ctnt5|attr_ctnt6|attr_ctnt7|attr_ctnt8|attr_ctnt9|attr_ctnt10|attr_ctnt11|attr_ctnt12|attr_ctnt13|attr_ctnt14|attr_ctnt15";
...
//			formObj.attr_ctnt3.focus();
    ...
    function funcNew(flag) {
    	...
    	if (flag == "FULL") {
            ...
            formObj.attr_ctnt5.value="";
            formObj.attr_ctnt6.value="";
            formObj.attr_ctnt7.value="";
            formObj.attr_ctnt8.value="";
            formObj.attr_ctnt9.value="";
            formObj.attr_ctnt10.value="";
            formObj.attr_ctnt11.value="";
            formObj.attr_ctnt12.value="";
            formObj.attr_ctnt13.value="";
            formObj.attr_ctnt14.value="";
            formObj.attr_ctnt15.value="";
            formObj.attr_ctnt3_nm.value="";
    	} else if (flag == "OK") {
    		sheetObject.RemoveAll();
    ...
    function funcOK() {
    	...
    	sheetObj.SetCellValue(1, "attr_ctnt5",ComTrim(formObj.attr_ctnt5.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt6",ComTrim(formObj.attr_ctnt6.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt7",ComTrim(formObj.attr_ctnt7.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt8",ComTrim(formObj.attr_ctnt8.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt9",ComTrim(formObj.attr_ctnt9.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt10",ComTrim(formObj.attr_ctnt10.value),0);
    	...
    	sheetObj.SetCellValue(1, "attr_ctnt13",ComTrim(formObj.attr_ctnt13.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt14",ComTrim(formObj.attr_ctnt14.value),0);
    	sheetObj.SetCellValue(1, "attr_ctnt15",ComTrim(formObj.attr_ctnt15.value),0);
    	comPopupOK();
    }
