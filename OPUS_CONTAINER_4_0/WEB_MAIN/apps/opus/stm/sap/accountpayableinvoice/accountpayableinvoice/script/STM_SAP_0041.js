 ...
 ***************************************************************************************/
 /**
 * @extends 
 * @class Line Overseas DFF Popup  : business script for STM_SAP_0041
 */
/* 공통전역변수 */
var ipageNo=1 ;
	    ...
	    try {
	        ...
	        switch(srcName) {
	    	    ...
	    	    case "btns_loc_srh":
            		...
            		ComOpenPopup("STM_SAP_0023.do" + param, 400, 450, "setLocation", "0,0", true, false);
            		break;	
	    	    case "btns_cal1":  
            		//Vendor Invoice Date
