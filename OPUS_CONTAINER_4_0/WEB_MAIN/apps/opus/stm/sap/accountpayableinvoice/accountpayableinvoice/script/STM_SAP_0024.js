 ...
 ***************************************************************************************/
 /**
 * @extends 
 * @class Evidence Popup : business script for STM_SAP_0024
 */
	    ...
	    try {
	        ...
	        switch(srcName) {
	    	    ...
	    	    case "btns_loc_srh":
            		...
            		ComOpenPopup("STM_SAP_0023.do" + param, 450, 300, "setLocation", "0,0", true, false);
            		break;	
	    	    case "btns_cal1":  
...
//			formObj.attr_ctnt3.focus();
    ...
    function funcNew(flag) {
    	...
    	if (flag == "FULL") {
            ...
            formObject.reset();
            formObject.attr_ctnt1.value=""; 
            formObject.attr_ctnt2.value=""; 
            formObject.attr_ctnt3.value=""; 
            formObject.attr_ctnt3_nm.value=""; 
            formObject.attr_ctnt11.value = ""; 
            formObject.attr_ctnt12.value = ""; 
            formObject.attr_ctnt14.value = ""; 
