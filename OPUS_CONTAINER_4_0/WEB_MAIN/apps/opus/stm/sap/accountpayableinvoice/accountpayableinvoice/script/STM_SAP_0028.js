 ...
 ***************************************************************************************/
 /**
 * @extends 
 * @class Line Prepaid Expense DFF Popup  : business script for STM_SAP_0028
 */
/* 공통전역변수 */
var ipageNo=1 ;
...
document.onclick=processButtonClick;
	    ...
	    try {
	        ...
	        switch(srcName) {
	    	    ...
	    	    case "btns_loc_srh":
            		...
            		ComOpenPopup("STM_SAP_0023.do" + param, 400, 410, "setLocation", "0,0", true, false);
            		break;	
	    	    case "btns_cal1":  
            		//Vendor Invoice Date
	    	    ...
	    	    case "btns_cal2":  
            		//Start Date
            		var cal=new ComCalendar();
					cal.select(form.attr_ctnt4, 'yyyy-MM-dd');
					break;
	    	    case "btns_cal3":  
            		//Expire Date
            		var cal=new ComCalendar();
					cal.select(form.attr_ctnt5, 'yyyy-MM-dd');
					break;	
	    	    case "btns_cal4":  
            		//Expire Date
	    	    	var cal=new ComCalendar();
	    	    ...
	    	    case "btns_acct_srh":
	        		//Account
            		var param="?lu_cd=" + form.attr_ctnt6.value;
            		ComOpenPopup("STM_SAP_0450.do" + param, 500, 500, "setAccount", "0,0", true, false);
            		break;           		
	        } // end switch
	    }catch(e) {            
	        if( e == "[object Error]") {
     ...
     */
     function loadPage() {
 		...
 		formObject.attr_ctnt4.value=ComGetMaskedValue(formObject.attr_ctnt4.value, "ymd");
 		formObject.attr_ctnt5.value=ComGetMaskedValue(formObject.attr_ctnt5.value, "ymd");
	...
	function obj_deactivate(){
		...
		ComAddSeparator(form.attr_ctnt4, "ymd");
		ComAddSeparator(form.attr_ctnt5, "ymd");
...
//			formObj.attr_ctnt3.focus();
    ...
    //Account Popup setting
    function setAccount(aryData) {
    	var formObj=document.form;
    	formObj.attr_ctnt6.value=aryData[0][1];
    	formObj.attr_ctnt6_nm.value=aryData[0][2];    	
    }   
