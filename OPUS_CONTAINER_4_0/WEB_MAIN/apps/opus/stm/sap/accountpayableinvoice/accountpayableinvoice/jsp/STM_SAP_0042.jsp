...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title">Line EQ Claim DFF Popup</h2>
		<!-- page_title(E) -->
...
<div class="layer_popup_contents">
			...
			<table>
				...
				<tbody>
					...
					<tr >
						...
						<td><input type="text" style="width:258px;" <%=requiredChkStr%>  name="attr_ctnt1" maxlength="30" dataformat="engupetc" value="<%=attr1%>" Caption="Supplier Invoice No"></td>
					</tr> 
					<tr >
					...
					<tr >
						<th>CNTR EQ Number</th>
						<td><input type="text" style="width:150px;" <%=requiredChkStr2%> name="attr_ctnt8" dataformat="engupetc" maxlength="20" value="<%=attr8%>" caption="CNTR EQ Number" id="attr_ctnt8" /></td>
					</tr> 
					<tr>
						<th>CSR No</th>
						<td><input type="text" style="width:150px;" <%=requiredChkStr2%> name="attr_ctnt9" maxlength="20" dataformat="engupetc" value="<%=attr9%>" caption="CSR No" id="attr_ctnt9" /></td>
					</tr>	
					<tr>
					<th>Activity Date</th>
	...
	<!-- wrap_result(S) -->
	<div class="wrap_result" id="hidSheetDiv">
		<!-- opus_design_grid(S) -->
