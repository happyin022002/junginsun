...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>Line Overseas DFF</span></h2>
		<!-- page_title(E) -->
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" style="width:150px;text-align:right" <%=requiredChkStr2%> name="attr_ctnt4" maxlength="20" dataformat="float" value="<%=attr4%>" caption="Taxable Amount" id="attr_ctnt4" /></td>
					</tr> 	
					<tr>
						<th>Activity Date</th>
