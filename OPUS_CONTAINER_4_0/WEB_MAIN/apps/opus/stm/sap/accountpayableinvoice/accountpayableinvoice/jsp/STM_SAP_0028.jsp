...
*@FileName   : STM_SAP_0028.jsp
*@FileTitle  : Line prepaid Expense DFF Popup
*@author     : CLT
*@version    : 1.0
*@since      : 2014/08/06
=========================================================*/
...
try {
	...
	requiredChkStr3 = " class='input' ";
	
	if (chk_svc_editable != null && chk_svc_editable.equals("ACT")) {
		requiredChkStr4 = " class='input1' readonly ";
	} else {
		requiredChkStr4 = " class='input1' required ";
	}
	...
	if (chk_editable != null && chk_editable.equals("N")) {
		...
		requiredChkStr4 = "  class='input2'  readonly ";
	}
...
<input type="hidden" name="reqHType" id="reqHType" value="<%=reqHType %>">
<div class="layer_popup_title">
	<!-- page_title_area(S) -->
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>Line Prepaid Expense DFF</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn (S) -->
		...
		<div class="opus_design_inquiry wFit">
			<table>
			   ...
			   <tbody>
					...
					<tr>
						<th>Start Date</th>
						<td><input type="text" style="width:80px;" <%=requiredChkStr2%> name="attr_ctnt4" maxlength="10" dataformat="ymd" value="<%=attr4%>" caption="Start Date" id="attr_ctnt4" /><button type="button" id="btns_cal2" name="btns_cal2" class="calendar ir"></button></td>
					</tr>
					<tr>
						<th>Expire Date</th>
						<td><input type="text" style="width:80px;" <%=requiredChkStr2%> name="attr_ctnt5" maxlength="10" dataformat="ymd" value="<%=attr5%>" caption="Expire Date" id="attr_ctnt5" /><button type="button" id="btns_cal3" name="btns_cal3" class="calendar ir"></button></td>
					</tr>
					<tr>
						<th>Account</th>
						<td><input type="text" style="width:80px;" <%=requiredChkStr2%> name="attr_ctnt6" maxlength="10" dataformat="engup" value="<%=attr6%>" caption="Account" onchange="resetName('attr_ctnt6_nm');" id="attr_ctnt6" /><button type="button" id="btns_acct_srh" name="btns_acct_srh" class="input_seach_btn"></button><input type="text" style="width:150px;" class="input2" name="attr_ctnt6_nm" readonly id="attr_ctnt6_nm" /></td>
					</tr>
					<tr>
						<th>VESSEL</th>
						<td><input type="text" style="width:80px;" <%=requiredChkStr3%> name="attr_ctnt7" maxlength="10" dataformat="engup" value="<%=attr7%>" caption="VESSEL" id="attr_ctnt7" /></td>
					</tr>	
					<tr>
						<th>Activity Date</th>
						<td><input type="text" style="width:80px;"   <%=requiredChkStr%>  name="attr_ctnt11" maxlength="10" dataformat="ymd" style="ime-mode:disabled"  value="<%=attr11%>"  Caption="Activity Date"><button type="button" id="btns_cal4" name="btns_cal4" class="calendar ir"></button></td>
					</tr> 
					<tr>
					...
					<tr>
						<th>Service Lane</th>
						<td><input type="text" style="width:258px;"  <%=requiredChkStr4%>   name="attr_ctnt14" maxlength="3" dataformat="engupetc" value="<%=attr14%>"  Caption="Service Lane"></td>
					</tr>
			   </tbody>
			</table>
		</div>
