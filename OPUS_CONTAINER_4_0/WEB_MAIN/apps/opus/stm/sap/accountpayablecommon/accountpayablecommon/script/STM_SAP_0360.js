...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //t1sheet1 init
	    with(sheetObj){       
		      var HeadTitle1="|AR Office Code|Name|Local Name";
		      ...
		      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
		                   ...
		                   {Type:"Text",      Hidden:0,  Width:250,  Align:"Left",    ColMerge:1,   SaveName:"ofc_krn_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];     
		      InitColumns(cols);
		      SetEditable(1);
		      //SetSheetHeight(230);
		      resizeSheet();
	...
	switch (sAction) {		
		case IBSEARCH: //retrieve
			formObj.f_cmd.value=SEARCH;			
 			var sXml=sheetObj.GetSearchData("STM_SAP_0360GS.do", FormQueryString(formObj));
...
window.returnValue=sheetObj.GetCellValue(sheetObj.GetSelectRow(), 'ofc_cd');
}
