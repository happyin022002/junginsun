...
<%@ page import="com.clt.apps.opus.stm.sap.accountpayablecommon.accountpayablecommon.event.StmSap0001Event"%>
...
<%
    StmSap0001Event event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (StmSap0001Event)request.getAttribute("Event");  
		serverException = (Exception)request.getAttribute(CommonWebKeys.EXCEPTION_OBJECT);

		ofc_cd = StringUtil.xssFilter(request.getParameter("ofc_cd"));  //PARAMETER
		ofc_cd = ofc_cd==null?"":ofc_cd;          //PARAMETER
		str_security_flag = JSPUtil.getNull(request.getParameter("security_flag"));
