...
function obj_keypress(){
    ...
    switch(ComGetEvent().dataformat){
		case "engup":
			if(ComGetEvent("name")=="lu_cd" || ComGetEvent("name")=="attr_ctnt1"){
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //t1sheet1 init
	    with(sheetObj){       
	      var HeadTitle1="|Pay Group|Pay Group Name";
	      ...
	      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
	             {Type:"Text",      Hidden:0,  Width:150,  Align:"Left",    ColMerge:1,   SaveName:"lu_cd",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch (sAction) {		
		case IBSEARCH: //retrieve
			...
			var sXml=sheetObj.GetSearchData("STM_SAP_0004GS.do", FormQueryString(formObj));
