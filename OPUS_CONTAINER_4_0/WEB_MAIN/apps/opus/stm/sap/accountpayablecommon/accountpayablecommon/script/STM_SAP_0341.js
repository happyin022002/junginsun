...
*@FileName   : STM_SAP_0341.js
*@FileTitle  : Unsettled Account Popup
*@author     : CLT
*@version    : 1.0
*@since      : 2014/08/06
=========================================================*/
...
/**
 * @extends 
 * @class STM_SAP_0341 : business script for STM_SAP_0341
 */
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //t1sheet1 init
	    with(sheetObj){
		      var HeadTitle1="|Unsettled Account|Account Description";
		      ...
		      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
		             {Type:"Text",      Hidden:0,  Width:120,  Align:"Center",  ColMerge:1,   SaveName:"lu_cd",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"Text",      Hidden:0,  Width:300,  Align:"Left",    ColMerge:1,   SaveName:"lu_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch (sAction) {		
		case IBSEARCH: //retrieve
			...
			var sXml=sheetObj.GetSearchData("STM_SAP_0341GS.do", FormQueryString(formObj));
