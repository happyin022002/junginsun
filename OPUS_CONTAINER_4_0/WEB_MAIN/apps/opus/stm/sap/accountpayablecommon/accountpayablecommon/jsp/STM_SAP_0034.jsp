...
<%@ page import="com.clt.apps.opus.stm.sap.accountpayablecommon.accountpayablecommon.event.StmSap0034Event"%> 
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.clt.framework.component.util.StringUtil" %>

<%
    StmSap0034Event event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (StmSap0034Event)request.getAttribute("Event");
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		...
		<h2 class="page_title"><span>WorkPlaces Popup</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
