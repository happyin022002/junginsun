...
/**
 * @extends 
 * @class STM_SAP_0460 : business script for STM_SAP_0460
 */
...
//			case "engup":
//				if(ComGetEvent("name")=="f_intercom"){
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		...
		switch (sAction) {		
			case IBSEARCH: //retrieve
				...
				var sXml=sheetObj.GetSearchData("STM_SAP_0460GS.do", FormQueryString(formObj));
