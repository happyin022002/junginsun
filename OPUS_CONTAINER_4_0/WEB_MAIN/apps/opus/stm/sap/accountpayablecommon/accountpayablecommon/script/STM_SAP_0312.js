...
/**
 * @extends 
 * @class STM_SAP_0312 : business script for STM_SAP_0312
 */
//function STM_SAP_0312() { 
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //t1sheet1 init
		with (sheetObj) {
	        ...
	        var HeadTitle1="|Card Brnad|Card Description";
	...
	//        (headCount, 0, 0, true);
	        ...
	        var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
	               ...
	               {Type:"Text",      Hidden:0,  Width:150,  Align:"Center",  ColMerge:1,   SaveName:"lu_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
	...
	switch (sAction) {		
		case IBSEARCH: //retrieve
			formObj.f_cmd.value=SEARCH;			
 			var sXml=sheetObj.GetSearchData("STM_SAP_0312GS.do", FormQueryString(formObj));
