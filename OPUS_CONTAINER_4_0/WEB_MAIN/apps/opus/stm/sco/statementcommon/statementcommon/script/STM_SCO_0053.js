...
/**
 * @extends 
 * @class STM_SCO_0053 : business script for STM_SCO_0053
 */
...
function obj_keypress(){
    ...
    switch(event.srcElement.dataformat){
		case "engup":
			if(event.srcElement.name=="f_center"){
	...
	case 1: //t1sheet1 init
		with (sheetObj) {
	        ...
	        var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
		               {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"ctr_erp_no",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		               {Type:"Text",      Hidden:0,  Width:160,  Align:"Left",    ColMerge:1,   SaveName:"ctr_desc",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch (sAction) {		
		case IBSEARCH: //retrieve
			...
			var sXml=sheetObj.GetSearchData("STM_SCO_0053GS.do", FormQueryString(formObj));
...
function sheet1_OnClick(sheetObj, Row, Col){
	window.returnValue=sheetObj.GetCellValue(sheetObj.GetSelectRow(), 'ctr_erp_no');
}
