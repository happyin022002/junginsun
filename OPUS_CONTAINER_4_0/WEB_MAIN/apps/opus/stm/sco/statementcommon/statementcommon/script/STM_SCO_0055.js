...
/**
 * @extends 
 * @class STM_SCO_0055 : business script for STM_SCO_0055
 */
function STM_SCO_0055() { 
...
function obj_keypress(){
    ...
    switch(event.srcElement.dataformat){
		case "engup":
			if(event.srcElement.name=="f_intercom"){
...
function initSheet(sheetObj, sheetNo) {
	...
	case 1: //t1sheet1 init
		...
		var HeadTitle1="|Inter Company|Description";
		...
		var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
		             ...
		             {Type:"Text",      Hidden:0,  Width:160,  Align:"Left",    ColMerge:1,   SaveName:"lu_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
	...
	switch (sAction) {		
		case IBSEARCH: //retrieve
			formObj.f_cmd.value=SEARCH;			
 			var sXml=sheetObj.GetSearchData("STM_SCO_0055GS.do", FormQueryString(formObj));
