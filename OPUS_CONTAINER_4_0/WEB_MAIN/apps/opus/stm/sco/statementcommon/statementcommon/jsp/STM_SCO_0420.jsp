...
<%@ page import="com.clt.apps.opus.stm.sco.statementcommon.statementcommon.event.StmSco0420Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
    StmSco0420Event event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (StmSco0420Event)request.getAttribute("Event");
...
<input type="hidden" name="mdl_tp_cd" id="mdl_tp_cd" />  
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>Profit Center</th>
		           	<td><input type="text" name="pfitctr_cd" id="pfitctr_cd" dataformat="engup" style="width:100px;ime-mode:disabled;text-align:left;" class="input" value="" maxlength="10"></td>
		            <th>SAKURA Account</th>
                    <td><script type="text/javascript">ComComboObject('gl_acct_no', 2, 120, 0, 0);</script></td>
                    <td width="*"></td>
				</tr>
			</tbody>
		</table>
