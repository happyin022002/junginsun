...
<%@ page import="com.clt.apps.opus.stm.sco.statementcommon.statementcommon.event.StmSco0090Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
	StmSco0090Event event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	String pnd_tgt_flg       = "";
	String line_type = "";
	Logger log = Logger.getLogger("com.clt.apps.opus.stm.sco.statementcommon.statementcommon");
	...
	try {
		...
		event = (StmSco0090Event)request.getAttribute("Event");
		serverException = (Exception)request.getAttribute(CommonWebKeys.EXCEPTION_OBJECT);

		acct_cd         = JSPUtil.getNull(request.getParameter("acct_cd"));
		acct_nm         = JSPUtil.getNull(request.getParameter("acct_nm"));
		...
		line_type         = JSPUtil.getNull(request.getParameter("line_type"));
