...
=========================================================*/
    /**
     * @extends 
     * @class stm_sar_9003 : stm_sar_9003 Defining business script.
     */
	// Common variables.
	        ...
	        case IBSEARCH:      //retrieve
				...
				if (sheetObj.id == "sheet1") {
					...
					setTimeout( function () {
						...
						sheetObj.DoSearch("STM_SAR_9003GS.do", FormQueryString(formObj) );
						var delt_flg="";
