...
<%@ page import="com.clt.apps.opus.stm.sar.accountreceivablecommon.accountreceivablecommon.event.StmSar9002Event"%>
<%@ page import="org.apache.log4j.Logger" %>
<%@ page import="com.clt.framework.component.util.StringUtil" %>

<%
	StmSar9002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (StmSar9002Event)request.getAttribute("Event");
