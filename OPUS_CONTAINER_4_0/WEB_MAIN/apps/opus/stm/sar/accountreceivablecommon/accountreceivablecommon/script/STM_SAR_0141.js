...
/**
 * @extends 
 * @class STM_SAR_0141 : business script for STM_SAR_0141
 */
...
function obj_keypress(){
    ...
    switch(ComGetEvent("dataformat")){
		case "engup":
			if(ComGetEvent("name") == "f_acct_tp_cd"){
	...
	case 1: //t1sheet1 init
		with (sheetObj) {
	        ...
	        var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
		               {Type:"Text",      Hidden:0,  Width:200,  Align:"Left",    ColMerge:1,   SaveName:"acct_tp_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		...
		case IBSEARCH: //retrieve
			...
			setTimeout( function () {
				formObj.f_cmd.value=SEARCH;			
	 			var sXml=sheetObj.GetSearchData("STM_SAR_0141GS.do", FormQueryString(formObj));
