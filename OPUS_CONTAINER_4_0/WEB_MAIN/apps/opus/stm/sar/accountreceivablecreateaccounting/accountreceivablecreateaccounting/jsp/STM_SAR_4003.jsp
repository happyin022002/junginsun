...
<%@ page import="com.clt.apps.opus.stm.sar.accountreceivablecreateaccounting.accountreceivablecreateaccounting.event.StmSar4003Event"%>
<%@ page import="org.apache.log4j.Logger" %>


<%
    StmSar4003Event event = null;	 		//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_nm = "";
	String strUsr_ofc = "";
	Logger log = Logger.getLogger("com.clt.apps.opus.stm.sar.accountreceivablecreateaccounting.AccountReceivableCreateAccountingSC"); //수정

	String gl_month = JSPUtil.getKST("yyyy-MM");
	...
	try {
		...
		본 jsp소스 맨 하단을 참조하십시오.ots_ofc_cd
		*/
		/* 
	   ...
	   */
		event = (StmSar4003Event)request.getAttribute("Event");
...
<input type="hidden" name="ar_rhq_cd" id="ar_rhq_cd" />
<input type="hidden" name="ar_acct_cd" id="ar_acct_cd" />
<input type="hidden" name="curr" id="curr" />
<input type="hidden" name="flgCd" id="flgCd" />
<!-- page_title_area(S) -->
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tbody>
				<tr>
					<th>G/L Month</th>
	                <td><input type="text" name="gl_month" style="width:55px;" class="input1" value="<%=gl_month%>" id="gl_month" /><!-- 
	                 --><button type="button" id="btnCalduedtFm" name="btnCalduedtFm" class="calendar ir"></button></td>
	                <th>RHQ</th>
	                <td><script type="text/javascript">ComComboObject('rhq_cd', 1, 80, 1, 0);</script></td>
	                <th>Office</th>
	                <td><script type="text/javascript">ComComboObject('ots_ofc_cd', 1, 80, 0, 0);</script></td>
	                <th>Account</th>
	                <td><script type="text/javascript">ComComboObject('acct_cd', 2, 80, 0, 0);</script><!-- 
	                 --><input type="text" name="acctnm" style="width:240px;" class="input2" value=" " id="acctnm" /></td>
	                <th>Currency</th>
	                <td><script type="text/javascript">ComComboObject('curr_cd', 1, 80, 0, 0, 0, false, 1);</script></td>
				</tr>
			</tbody>
		</table>
	</div>
