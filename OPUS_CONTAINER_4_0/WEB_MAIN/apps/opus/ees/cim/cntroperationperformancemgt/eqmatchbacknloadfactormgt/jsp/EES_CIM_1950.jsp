...
<%@ page import="com.clt.apps.opus.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EES_CIM_1050HTMLAction"%>
...
<script language="javascript" src="/opuscntr/rpt/script/파일을 common_rd.js"></script>
...
<table width="100%" class="popup" cellpadding="10" border="0">
    ...
    <tr><td class="title"><img src="/opuscntr/img/opus/ico_t1.gif" width="20" height="12">Match-back by Vessel</td></tr>
    </table>
    <!-- : ( Title ) (E) -->
