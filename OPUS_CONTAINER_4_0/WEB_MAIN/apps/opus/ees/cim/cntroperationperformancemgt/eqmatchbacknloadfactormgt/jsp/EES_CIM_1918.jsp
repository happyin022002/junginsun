...
<%@ page import="com.clt.apps.opus.ees.cim.cntroperationperformancemgt.eqmatchbacknloadfactormgt.event.EES_CIM_1018HTMLAction"%>
...
<div class="layer_popup_contents">
    <div class="wrap_search" style="height:100%">
