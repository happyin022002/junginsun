...
*@FileName   : EES_CIM_0050.js
*@FileTitle  : RTN(MTY Returned) Information
*@author     : CLT
*@version    : 1.0
*@since      : 2014/08/13
=========================================================*/
    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        switch(shtID) {
            case "sheet1":      //sheet1 init
                with (sheetObj) {
	                var HeadTitle1="MTY Return\nDate|Yard|BKG No.|TP/SZ|Vol|Del\nTerm|SHPR|CNEE|NTFY";
	                var headCount=ComCountHeadTitle(HeadTitle1);
	                SetConfig( { SearchMode:2, FrozenCol:5, MergeSheet:7, Page:20, DataRowMerge:1, FrozenCols:5 } );
	
	                var info    = { Sort:0, ColMove:1, HeaderCheck:1, ColResize:1 };
	                var headers = [ { Text:HeadTitle1, Align:"Center"} ];
	                InitHeaders(headers, info);
	
	                var cols = [ {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"fcast_dt",      KeyField:0,   CalcLogic:"",   Format:"" },
								...
								{Type:"Text",      Hidden:0,  Width:150,  Align:"Left",    ColMerge:1,   SaveName:"shpr",          KeyField:0,   CalcLogic:"",   Format:"" },
								{Type:"Text",      Hidden:0,  Width:150,  Align:"Left",    ColMerge:1,   SaveName:"cnee",          KeyField:0,   CalcLogic:"",   Format:"" },
								{Type:"Text",      Hidden:0,  Width:150,  Align:"Left",    ColMerge:1,   SaveName:"ntfy",          KeyField:0,   CalcLogic:"",   Format:"" } ];
	                 
	                InitColumns(cols);
	
	                SetEditable(0);
	                SetCountPosition(0);//deletingpagecount
	                SetSheetHeight(400);
               }
               break;
        }
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH:      
                ...
                sheetObj.DoSearch("EES_CIM_0050GS.do",FormQueryString(formObj));
            	ComOpenWait(false);             	
                break;
            case IBDOWNEXCEL:     
     ...
     */
      ...
      * setting background color for seleced row
      */
