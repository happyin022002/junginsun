...
=========================================================*/
    /**
    * @extends 
    * @class EES_CIM_0047 : business script for EES_CIM_0047 
    */
    // common variables
    ...
    function doActionIBSheet(sheetObj,formObj,sAction) {
        ...
        switch(sAction) {
            case IBSEARCH:     
                ...
                sheetObj.DoSearch("EES_CIM_0047GS.do",FormQueryString(formObj) );
            	ComOpenWait(false);             	
                break;
            case IBDOWNEXCEL:   
     ...
     */
      ...
      * setting background color selected row
      */
