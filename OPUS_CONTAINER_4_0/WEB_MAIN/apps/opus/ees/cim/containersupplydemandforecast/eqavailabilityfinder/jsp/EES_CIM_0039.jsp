...
<%@ page import="com.clt.apps.opus.ees.cim.containersupplydemandforecast.eqavailabilityfinder.event.EesCim0039Event"%>
...
<input type="hidden" name="io_bnd_cd" value="<%=event.getAvailOptionVO().getIoBndCd() %>" id="io_bnd_cd" />

<!-- page_title_area(S) -->
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<!-- 타이틀 내용 동적생성 (별도 코딩 불필요) -->
		<h2 class="page_title"><span>MTY Reposition for EQ Availability</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
