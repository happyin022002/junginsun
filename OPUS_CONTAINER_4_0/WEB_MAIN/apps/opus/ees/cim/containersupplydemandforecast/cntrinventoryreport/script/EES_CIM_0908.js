...
=========================================================*/
	...
	function rdOpen(){		
		...
		if ( opener_obj.beforetab =='1' ) {
			opener_sheet_obj1=opener_obj.t4sheet1;
		} else if  ( opener_obj.beforetab =='0' ) {
			opener_sheet_obj1=opener_obj.t1sheet1;
		} else if  ( opener_obj.beforetab =='2' ) {
			opener_sheet_obj1=opener_obj.t3sheet1;
		}
		...
		if ( opener_obj.beforetab =='1' ) {
			viewer.openFile(RD_path+'apps/opus/ees/cim/containersupplydemandforecast/cntrinventoryreport/report/EES_CIM_0908_1.mrd',RDServer, {timeout:1800});
		} else {
			viewer.openFile(RD_path+'apps/opus/ees/cim/containersupplydemandforecast/cntrinventoryreport/report/EES_CIM_0908_2.mrd',RDServer, {timeout:1800});
		}
	}
