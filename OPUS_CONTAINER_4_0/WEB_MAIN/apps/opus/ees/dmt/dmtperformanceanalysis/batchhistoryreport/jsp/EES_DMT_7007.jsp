...
<%@ page import="com.clt.apps.opus.ees.dmt.dmtperformanceanalysis.batchhistoryreport.event.EesDmt7007Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.DMTPerformanceAnalysis.BatchHistoryReport");
