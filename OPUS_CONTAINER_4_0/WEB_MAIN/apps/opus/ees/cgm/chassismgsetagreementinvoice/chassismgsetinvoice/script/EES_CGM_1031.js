 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ees_cgm_1031 : ees_cgm_1031 business script for
     */
   	/* developer job	*/
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
	    	case IBSEARCH:      //retrieve
				...
				ComOpenWait(true);	
	     		var sXml=sheetObj.GetSearchData("EES_CGM_1031GS.do" , FormQueryString(formObj), '', true);
	    	...
	    	case IBSAVE:        //saving
				...
				*/
				...
				sheetObj.SetWaitImageVisible(0);
				ComOpenWait(true);		
				var sXml=sheetObj.GetSaveData("EES_CGM_1031GS.do", sParam);
	    	...
	    	case IBCREATE:		// Payable Amount Confirm
				...
				sheetObj.SetWaitImageVisible(0);
				ComOpenWait(true);	
	     		var sXml=sheetObjects[0].GetSaveData("EES_CGM_1031GS.do", sParam);
	    	...
	    	case IBDELETE:
				...
				sheetObj.SetWaitImageVisible(0);
				ComOpenWait(true);	
	     		var sXml=sheetObjects[0].GetSaveData("EES_CGM_1031GS.do", FormQueryString(formObj));
	     		var arrXml=sXml.split("|$$|");
         		// tab1 Sheet Object
	     		//sheetObjects[4].LoadSaveXml("<SHEET><DATA TOTAL='0'></DATA></SHEET>");	
...
//		        			}
    ...
    function t1sheet1_OnDblClick(sheetObj, Row, Col, CellX, CellY, CellW, CellH){
    	...
    	if(Col == 3) // chassis
    	{
    		var eqNo=sheetObj.GetCellValue(Row,Col);
    		if(eqNo != "")
    		{
