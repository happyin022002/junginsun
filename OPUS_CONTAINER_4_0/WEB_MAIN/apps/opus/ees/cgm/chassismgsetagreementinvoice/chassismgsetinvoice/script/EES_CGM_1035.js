	...
	try {
		...
		case "btns_office": // Office Code getting popup
			if (!formObject.cost_ofc_cd.readOnly) {
				ComOpenPopupWithTarget('/opuscntr/COM_ENS_071.do', 800, 480,
						"ofc_cd:cost_ofc_cd", "1,0,1,1,1,1,1,1", true);
			}
			break;
		case "btns_vndr":
			ComOpenPopup('/opuscntr/COM_ENS_0C1.do', 700, 555, "callBackVendor",
...
function initSheet(sheetObj, sheetNo) {
	...
	case "sheet1":
        with(sheetObj){
			...
			{Type:"Text",      Hidden:0,  Width:40,   Align:"Center",  ColMerge:1,   SaveName:"chss_mgst_inv_knd_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	...
	case "sheet2":
        with(sheetObj){
			...
			{Type:"Float",     Hidden:0,  Width:110,  Align:"Right",   ColMerge:1,   SaveName:"pay_tax_amt",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
			{Type:"Float",     Hidden:0,  Width:110,  Align:"Right",   ColMerge:1,   SaveName:"pay_cr_amt",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
			...
			if (sheetObj.id == "sheet1")
			{
		    	...
		    	formObj.f_cmd.value=SEARCH;
		 		...
		 		if(validateForm(sheetObj,formObj,sAction))
		 		{
			 		sheetObj.SetWaitImageVisible(0);
			 		ComOpenWait(true);		 			
 		 			var sXml=sheetObj.GetSearchData("EES_CGM_1035GS.do" , FormQueryString(formObj));
...
//{
//	if(cost_yrmon.GetText(parseInt(cost_yrmon.GetSelectIndex()), 0) != undefined){
