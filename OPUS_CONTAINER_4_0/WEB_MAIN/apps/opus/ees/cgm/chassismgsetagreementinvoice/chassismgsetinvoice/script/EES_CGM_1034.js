...
//    	axon_event.addListenerFormat('keypress', 'obj_keypress', form);
 //   	axon_event.addListenerFormat('focusin', 'obj_focusin', form);
    	axon_event.addListener('change', 'obj_change', 'cost_yrmon', 'cost_ofc_cd'); 
    	axon_event.addListener('focusout', 'obj_focusout', 'inv_rcv_dt', 'inv_iss_dt', 'cost_yrmon', 'cost_ofc_cd'); 
		...
		//IBMultiComboreset
		comboObjects[comboCnt++]=chss_mgst_inv_knd_cd;
		...
		// Form Load  reset 
		comboObjects[0].InsertItem(0,"LSE","LS");
		comboObjects[0].InsertItem(1,"CPO","CP");
		comboObjects[0].InsertItem(2,"NPO","NP");
		comboObjects[0].SetSelectText("LSE",false);
		comboObjects[0].SetSelectCode("LS",false);
		/*
		// Option retrieve
...
//     	formObj.cost_yrmon.value=costYrmon;
    	...
    	document.form.cost_yrmon.value=costYrmon;
     	...
     	comboObjects[0].SetSelectText("LSE",false);
		comboObjects[0].SetSelectCode("LS",false);
		comboObjects[2].SetSelectText("ALL",false);
		// Sheet Object reset
	    	...
	    	case "sheet1":
	    	    with(sheetObj){
	    		      ...
	    		      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
	    		             ...
	    		             {Type:"Float",     Hidden:0,  Width:80,   Align:"Right",   ColMerge:1,   SaveName:"inv_tax_rt",            KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:1,   InsertEdit:1 },
	    		             ...
	    		             {Type:"Text",      Hidden:0,  Width:90,   Align:"Left",    ColMerge:1,   SaveName:"status",                KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	        ...
	        case "sheet2":
	            with(sheetObj){
		          ...
		          var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
				     ...
				     {Type:"Float",     Hidden:0,  Width:80,   Align:"Right",   ColMerge:1,   SaveName:"pay_tax_amt",      KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:1,   InsertEdit:0 },
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
	    ...
	    switch(sAction) {
			case IBSEARCH:      //retrieve
				...
				ComOpenWait(true);	
 				var sXml=sheetObj.GetSearchData("EES_CGM_1034GS.do" , FormQueryString(formObj), '', true);
	    		...
	    		if(iCheckRow > 0){
					...
					formObj.f_cmd.value=MULTI01;
		         	...
		         	sParam=sParam + FormQueryString(formObj);
 		     		var sXml=sheetObj.GetSaveData("EES_CGM_1034GS.do", sParam);
	...
	function validateForm(sheetObj,formObj,sAction){
    	...
    	switch(sAction) {
    		case IBSEARCH:
    			if(chss_mgst_inv_knd_cd.GetSelectText()== ''){
    				ComShowCodeMessage('CGM10004','DIV');
    				return false;
...
//	    	  	    	formObj.inv_iss_dt.focus();
	...
	function sheet1_OnClick(sheetObj, Row, Col, Value, CellX, CellY, CellW, CellH){
		if(sheetObj.ColSaveName(Col) == 'del_chk'){
			if(sheetObj.GetCellValue(Row,"chss_mgst_inv_knd_cd") == 'LS'){
	...
	/**
	 * Sheet1 Double Click -> info retrieve <br>
	 * @author 
	 * @version
	 */ 
    ...
    function chss_mgst_inv_knd_cd_OnChange(comboObj, oldIndex, oldText, oldCode, newIndex, newText, newCode) {//CHECK OLD CODE: OnChange(comboObj, Index_Code, Text){
    	doActionIBSheet(sheetObjects[2], document.form, IBSEARCH_ASYNC01);
    	// S.Provider retrieve
    	doActionIBSheet(sheetObjects[2], document.form, IBSEARCH_ASYNC02);
