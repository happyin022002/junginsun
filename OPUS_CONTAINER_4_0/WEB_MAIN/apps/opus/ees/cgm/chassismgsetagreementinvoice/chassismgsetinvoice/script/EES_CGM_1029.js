 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ees_cgm_1029 : ees_cgm_1029 business script for
     */
				...
				case "btn_InvoiceImportAudit":
					...
					if(iCheckRow > 0){
						...
						if(sChgSeq != ''){
							...
							ComOpenWindowCenter('/opuscntr/EES_CGM_1030.do' + param, sWinName, 1100, 550, true);
							// Retrieve 
				...
				case "btn_AuditResultCreation":
					...
					if(iCheckRow > 0){
						...
						if(sChgSeq != ''){
							...
							ComOpenWindowCenter('/opuscntr/EES_CGM_1031.do' + param, sWinName, 1100, 600, true);
							//ComOpenPopup('/opuscntr/EES_CGM_1031.do' + param, 980, 600, 'setCheckBox', '1,0', true, false, 3, 10, 0);
							// Retrieve 
							//var obj = document.getElementById("btn_Retrieve");
					    	//obj.fireEvent("onclick");
	        ...
	        case 1:      // sheet1 init
	            with(sheetObj){
			         ...
			         var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
			             {Type:"CheckBox",  Hidden:0, Width:50,   Align:"Center",  ColMerge:0,   SaveName:"del_chk", UpdateEdit:0,   InsertEdit:1 },
			             ...
			             {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"agmt_eff_dt",       KeyField:0,   CalcLogic:"",   Format:"Ymd",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"agmt_exp_dt",       KeyField:0,   CalcLogic:"",   Format:"Ymd",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
			             ...
			             {Type:"Text",      Hidden:0,  Width:310,  Align:"Left",    ColMerge:0,   SaveName:"vndr_lgl_eng_nm",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Text",      Hidden:0,  Width:50,   Align:"Left",    ColMerge:0,   SaveName:"lse_chg_sts_desc",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		         ...
		         SetEditable(1);
//		         SetColProperty("agmt_eff_dt", {Format:"####-##-##"} );
//		         SetColProperty("agmt_exp_dt", {Format:"####-##-##"} );
			...
			case 2:      // sheet2 init
			    with(sheetObj){
				      ...
				      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
			             ...
			             {Type:"Float",     Hidden:0,  Width:120,  Align:"Right",   ColMerge:0,   SaveName:"inv_smry_amt",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Float",     Hidden:0,  Width:120,  Align:"Right",   ColMerge:1,   SaveName:"pay_lse_chg_amt",   KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Float",     Hidden:0,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"debit_amt",         KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Float",     Hidden:0,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"cr_smry_amt",       KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Float",     Hidden:0,  Width:90,   Align:"Right",   ColMerge:1,   SaveName:"tax_smry_amt",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Text",      Hidden:0,  Width:95,   Align:"Center",  ColMerge:1,   SaveName:"cre_ofc_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Text",      Hidden:0,  Width:95,   Align:"Center",  ColMerge:1,   SaveName:"cre_usr_id",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
			             {Type:"Date",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"cre_dt",            KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:1 } ];
				      InitColumns(cols);
				      SetEditable(1);
//				      SetSheetHeight(150);
	    ...
	    switch(sAction) {
	    	case IBSEARCH:      //retrieve 
		    	formObj.f_cmd.value=SEARCH;
		 		...
		 		ComOpenWait(true);	 	
 	     		var sXml=sheetObj.GetSearchData("EES_CGM_1029GS.do" , FormQueryString(formObj) + "&" + ComGetPrefixParam("sheet1"),'',true);
	    	...
	    	case IBSAVE:        // saving (Charge Creation)
	    		...
	    		if(iCheckRow > 0){
	    			...
	    			for(var i=0; i<arrCheckRows.length-1; i++){
	    				var lseChgStsCd=sheetObj.GetCellValue(arrCheckRows[i],"lse_chg_sts_cd");
	    				if(lseChgStsCd != '' && lseChgStsCd != 'H'){
	    					ComShowCodeMessage('CGM20015', sheetObj.GetCellValue(arrCheckRows[i],"lse_chg_sts_desc"));
	    					return;
	    				}
	    			}
			 		sheetObj.SetWaitImageVisible(0);
		    		...
		    		formObj.f_cmd.value=MULTI;
		         	...
		         	var prefix=new Array("sheet1", "sheet2");	
 	     			var sXml=sheetObj.GetSaveData("EES_CGM_1029GS.do", sParam + "&" + ComGetPrefixParam(prefix));
		    	...
		    	if(iCheckRow > 0){
		    		if(chgCreSeq != ''){
			    		...
			    		formObj.eq_knd_cd.value=EQ_KND_CD_CHASSIS;
			         	...
			         	sParam=sParam + "&";
			         	sParam=sParam + FormQueryString(formObj);
 			         	var sXml=sheetObjects[1].GetSaveData("EES_CGM_1029GS.do", sParam + "&" + ComGetPrefixParam("sheet1"));
			     		sheetObjects[1].RemoveAll();
     ...
     * @param  {object} formObj	 Form Object
     * @param  {String} sAction	 Action Type 
     * @return {boolean}			false => validation check error, true => validation check success
     * @author 
     * @version 2009.07.20
     */  
...
//	    				cost_yrmon.focus();
	...
	/**
	 * Sheet1 OnSaveEnd event handling (Charge Creation)<br>
	 * @param  {object} sheetObj		 Sheet Object
...
//					sheetObj.SetRowBackColor(i,"#E7FAF8");
					sheetObj.SetRangeBackColor(i, 0, i, sheetObj.LastCol(), "#E7FAF8");
				} else {
...
//						sheetObj.SetRowBackColor(i,"#C0C0C0");
						sheetObj.SetRangeBackColor(i, 0, i, sheetObj.LastCol(), "#C0C0C0");
					} else {
//						sheetObj.SetRowBackColor(i,"#FFFFFF");
						sheetObj.SetRangeBackColor(i, 0, i, sheetObj.LastCol(), "#FFFFFF");
					}
				}
			}
			ComBtnDisable("btn_InvoiceImportAudit");
...
//						sheetObj.SetRowBackColor(i,"#FFFFFF");
			...
			// Invoice Import & Audit Button disable
			if(sheetObj.ColSaveName(Col)=='del_chk'){
				var iCheckRow=sheetObj.CheckedRows("del_chk");
				var sCheckRows=sheetObj.FindCheckedRow("del_chk");
    			var arrCheckRows=sCheckRows.split("|");
    			// Invoice Import & Audit
    			if(iCheckRow > 0){
    				var auditImportBtn=true;
	    			for(var i=0; i<arrCheckRows.length; i++){
	    				var lseChgStsCd=sheetObj.GetCellValue(arrCheckRows[i],"lse_chg_sts_cd");
			...
			formObj.f_cmd.value=SEARCH01;
     		...
     		formObj.lse_chg_sts_cd.value=lseChgStsCd;
      		var sXml=sheetObj.GetSearchData("EES_CGM_1029GS.do" , FormQueryString(formObj) + "&" + ComGetPrefixParam("sheet2"), '', true );
