...
<%@ page import="com.clt.apps.opus.ees.cgm.chassismgsetagreementinvoice.chassismgsetinvoice.event.EesCgm1124Event"%>
...
<input id="eq_knd_cd" name="eq_knd_cd" value="G" type="hidden" />
<input id="actionflag" name="actionflag" type="hidden" />
<input id="ofc_cd" name="ofc_cd" type="hidden" />
<input id="agmt_lstm_cd" name="agmt_lstm_cd" value="NP" type="hidden" />
	...
	<div class="opus_design_inquiry wFit">
		<table>
			<tbody>
				...
				<tr>
					<th>Cost Month</th>
					<td><input id="cost_yrmon" name="cost_yrmon" dataformat="ym" maxlength="7" style="width: 80px;" class="input1" value="" type="text" required /><button class="calendar ir" name="btns_cost_yrmon" id="btns_cost_yrmon" type="button"></button></td>
					<th>Cost Office</th>
					<td><input id="cost_ofc_cd" name="cost_ofc_cd" dataformat="engup" maxlength="6" style="width: 80px;" class="input1" value="" required type="text" /><button class="input_seach_btn" name="btns_office" id="btns_office" type="button"></button></td>
					<td></td>
				</tr>
				<tr>
					<th>Invoice No.</th>
					...
					<th>Agreement No.</th>
					<td><script type="text/javascript">ComComboObject('combo_agmt', 4, 150, 1, 1, 0, false);</script></td>
					<td></td>
				</tr>
				<tr>
					<th>Vendor Code</th>
					...
					<th>Vendor Name</th>
					<td><input id="vndr_lgl_eng_nm" name="vndr_lgl_eng_nm" style="width: 430px;" class="input2" value="" readonly type="text" /> </td>
					<td></td>
				</tr>
			</tbody>
		</table>
	...
	<div class="layout_wrap">
	    <div class="layout_vertical_2 mar_rgt_12" style="width: 49%">
	        ...
	        <div class="opus_design_grid">
	            ...
	            <table class="search"> 
					...
					<tr>
						<th>Max. Rate</th>
						<td><input id="pool_max_rt_amt" name="pool_max_rt_amt" dataformat="float" maxlength="6" class="input" value="" type="text" /> </td>
						<th>Min. Rate</th>
						<td><input id="pool_min_rt_amt" name="pool_min_rt_amt" dataformat="float" maxlength="6" class="input" value="" type="text" /> </td>
					</tr>
				</table>
	        </div>
	        <!-- opus_design_grid(E) -->
	    ...
	    <div class="layout_vertical_2" style="width: 50%">
	        <table class="grid2"> 
				...
				<tr>
					<td><textarea name="diff_rmk" id="diff_rmk" style=" resize: none;width: 100%; height: 265px; ime-mode:disabled"></textarea></td>
				</tr>
			</table>	
	    </div>
	</div>
