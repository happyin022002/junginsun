        	...
        	switch(srcName) {
    			case "btn_retrieve":		// retrieve Action
   				...
   				case "ComOpenPopupWithTarget1":	// Office Code getting popup
   					ComOpenPopupWithTarget('/opuscntr/COM_ENS_071.do', 800, 520, "ofc_cd:agmt_iss_ofc_cd", "1,0,1,1,1,1,1,1", false,false);
//   					ComOpenWindowCenter('/opuscntr/COM_ENS_071.do',"aa", 800, 520,  true);
   					break;
   				case "ComOpenPopupWithTarget2":	// Lessor Code, Name getting popup
   					ComOpenPopup('/opuscntr/COM_ENS_0C1.do', 700, 485, "setProgramNo", "0,1,1,1,1,1", false, false);
					break;
            } // end switch
        }catch(e) {
        	if( e == "[object Error]") {
            ...
            with(sheetObj){
              ...
              InitHeaders(headers, info);
                ...
                var cols = [ {Type:"Radio",     Hidden:0, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"radio",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                       ...
		                       {Type:"Text",      Hidden:0, Width:110,  Align:"Left",    ColMerge:1,   SaveName:"agmt_ref_no",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                       ...
		                       {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"vndr_seq",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                       {Type:"Text",      Hidden:0, Width:200,  Align:"Left",    ColMerge:1,   SaveName:"vndr_lgl_eng_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                       {Type:"Text",      Hidden:0, Width:95,   Align:"Center",  ColMerge:1,   SaveName:"eff_dt",           KeyField:0,   CalcLogic:"",   Format:"Ymd",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                       {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"exp_dt",           KeyField:0,   CalcLogic:"",   Format:"Ymd",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                       {Type:"Text",      Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"agmt_iss_ofc_cd" },
		                       {Type:"Text",      Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"cre_dt",           KeyField:0,   CalcLogic:"",   Format:"Ymd",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                ...
                InitColumns(cols);
                SetSheetHeight(202);
                SetRangeBackColor(1, 0, 1, 1,"#777777");
                SetRangeBackColor(1, 7, 1, 8,"#777777");
              }
  			break;
          }
      }
