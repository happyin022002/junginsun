 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ees_cgm_2023 : ees_cgm_2023 business script for
     */
    			...
    			case "btn_New":
   				...
   				case "btn_VersionDetails":	// VersionDetail
   					if(formObject.agmt_no.value != ''){
						...
						ComOpenPopup('/opuscntr/EES_CGM_2103.do' + param, 900, 500, "", "1,0", true, false);
					}
   					break;
   				...
   				case "btn_Print":			// Print (RD Open)
 					...
 					ComOpenPopupWithTarget('/opuscntr/EES_CGM_2204.do', 775, 600, "", "0,1,1,1,1,1,1", true);
   					break;
   				...
   				case "ComOpenPopupWithTarget2":	// Lessor Code, Name getting popup
   					ComOpenPopup('/opuscntr/COM_ENS_0C1.do', 700, 550, "setProgramNo", "0,1,1,1,1,1", true, false);
   					break;
    ...
    function initControl(){
     ...
     function initSheet(sheetObj,sheetNo) {
         ...
         switch(sheetNo) {
         	case 1:      // sheet1 init
         		with (sheetObj) {
                var HeadTitle="|Seq.|AGMT NO.|Ref.No.|Office|Date|Term|AGMT Effective|Lessor|Lessor Name|Created By|Created Date|Updated By|Updated Date";
                ...
                var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"Status" },
                       ...
                       {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"agmt_iss_ofc_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                       {Type:"Text",      Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"agmt_dt",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                       {Type:"Text",      Hidden:0,  Width:65,   Align:"Center",  ColMerge:0,   SaveName:"agmt_lstm_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                       {Type:"Text",      Hidden:0,  Width:200,  Align:"Center",  ColMerge:0,   SaveName:"effective_date",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                       ...
                       {Type:"Text",      Hidden:0,  Width:330,  Align:"Left",    ColMerge:0,   SaveName:"vndr_lgl_eng_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                       ...
                       {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"upd_dt",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 } ];
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
    	 ...
    	 switch(sAction) {
    	 	case IBSEARCH:      	// Retrive
    	 		...
    	 		formObj.eq_knd_cd.value=EQ_KND_CD_MGSET;	// EQ TYPE  MGSET  setting
        	    sheetObj.SetWaitImageVisible(0);
		 	    ComOpenWait(true);
                	sheetObj.DoSearch("EES_CGM_2023GS.do",FormQueryString(formObj) );
               	ComOpenWait(false);
               	break;
...
//           			}	
      ...
      * @param  {object} formObj	 Form Object
      * @param  {String} srcName	mandatory document inner object name
      * @return 
      * @author 
      * @version
      */ 
...
//	    	    				agmt_dt_to.focus();
    ...
    function MakeComboObject(cmbObj, arrStr, txtCol, codeCol) {
    	agmt_lstm_cd.RemoveAll();
    	agmt_lstm_cd.InsertItem(0,"","");
    	for (var i=0; i < arrStr.length;i++ ) {
    		var arrCode=arrStr[i].split("|");
    		agmt_lstm_cd.InsertItem(i+1, arrCode[txtCol], arrCode[codeCol]);
    	}
    	agmt_lstm_cd.SetSelectIndex("" ,false);
    }
    function agmt_lstm_cd_OnChange(comboObj, oldIndex, oldText, oldCode, newIndex, newText, newCode) {
	   agmt_lstm_cd_text.value = newCode;
    }
   
    function agmt_lstm_cd_OnBlur(comboObj) {
	   agmt_lstm_cd_text.value = comboObj.GetSelectCode();
    }
	/* developer job end */
