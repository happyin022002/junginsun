...
//		rdObjects[0].ApplyLicense("0.0.0.0");
		viewer.openFile(RD_path+'apps/opus/ees/cgm/chassismgsetagreementinvoice/chassismgsetagreement/report/EES_CGM_1023.mrd',RDServer, {timeout:1800});
		//rdObjects[0].FileOpen('http://localhost:9001/opuscntr/apps/opus/ees/cgm/chassismgsetagreementinvoice/chassismgsetagreement/report/EES_CGM_1023.mrd',RDServer);
	}
