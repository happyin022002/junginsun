...
<%@ page import="com.clt.apps.opus.ees.cgm.chassismgsetagreementinvoice.chassismgsetagreement.event.EesCgm2022Event"%>
		...
		<div class="opus_design_inquiry">   <!-- no TAB  -->
			<table>
				...
				<tr>
					...
					<th>Office</th>
					<td><input type="text" name="agmt_iss_ofc_cd" dataformat="engup" maxlength="6" style="width:97px;ime-mode:disabled" class="input" value="" id="agmt_iss_ofc_cd" /><button type="button" id="ComOpenPopupWithTarget1" name="ComOpenPopupWithTarget1" class="input_seach_btn"></button></td>
					<th>Lease Term</th>
					<td><script type="text/javascript">ComComboObject('agmt_lstm_cd', 1, 50, 0, 0, 0, false);</script></td>
					<th>Old AGMT No.</th>
				...
				<tr>
					...
					<th>Lessor</th>
					<td colspan="3"><input type="text" name="vndr_seq" dataformat="num" style="width:97px;ime-mode:disabled" class="input" value="" id="vndr_seq" /><input type="text" name="vndr_lgl_eng_nm" style="width:225px;ime-mode:disabled" class="input2" value="" readonly id="vndr_lgl_eng_nm" /><button type="button" id="ComOpenPopupWithTarget2" name="ComOpenPopupWithTarget2" class="input_seach_btn"></button></td>
				</tr> 
			  </tbody>
			</table>
		</div>
