 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ees_cgm_1118 : ees_cgm_1118 business script for
     */
     	...
     	try {
            ...
            switch(srcName) {
 				...
 				case "btns_office2":	// Office Code getting popup
 					ComOpenPopup('/opuscntr/COM_ENS_071.do', 800, 480, "setCallback_Office", "0,1,1,1,1,1,1,1", true, false);
 					break;
 				case "btns_vndr1":	// Lessor Code getting popup
 					ComOpenPopupWithTarget('/opuscntr/COM_ENS_0C1.do', 700, 545, "vndr_seq:vndr_seq", "1,0,1,1,1,1", true);
 					break;	
 				case "btns_vndr2":	// Lessor Code getting popup
 					ComOpenPopup('/opuscntr/COM_ENS_0C1.do', 700, 545, "setCallback_Vendor", "0,1,1,1,1,1", true, false);
					break;	
            } // end switch
     	} catch(e) {
     		if( e == "[object Error]") {
            ...
            case "sheet1":
                with(sheetObj){
		              ...
		              var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
		                     {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"sts_evnt_ofc_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"old_vndr_seq",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:100,   Align:"Center",  ColMerge:1,   SaveName:"old_agmt_no",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"old_agmt_lstm_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"new_vndr_seq",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:100,   Align:"Center",  ColMerge:1,   SaveName:"new_agmt_no",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"new_agmt_lstm_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
		                     {Type:"AutoSum",   Hidden:0, Width:70,   Align:"Right",   ColMerge:1,   SaveName:"Total",             KeyField:0,   CalcLogic:totalVal,Format:"NullInteger", PointCount:0,   UpdateEdit:0,   InsertEdit:1 }];
						  ...
						  var x = 1;
	 	 	              ...
	 	 	              for ( var i = 0; i < arrCntrTypeSize.length; i++) {
						 	  if (arrCntrTypeSize.length > 1) {
						 		  sCount = "eq_tpsz_cd" + x;
					 			  cols.push({Type:"AutoSum",   Hidden:0, Width:60,   Align:"Right",   ColMerge:1,   SaveName:sCount,    KeyField:0,   CalcLogic:"",   Format:"NullInteger", PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
						 		  x++;
						 	  }
						  }
...
//		              SetSheetHeight(422);
		              ...
		              ShowSubSum([{StdCol:"sts_evnt_ofc_cd", SumCols:sumNmVal, Sort:false, ShowCumulate:false, CaptionCol:"new_agmt_lstm_cd", CaptionText:"Office Total"}]);
                }
 				break;
            case "sheet2":
                with(sheetObj){
		              ...
		              var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"Status" },
		                     {Type:"Text",      Hidden:0,  Width:110,  Align:"Center",  ColMerge:1,   SaveName:"Old_AgreeNo",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:60,   Align:"Center",  ColMerge:1,   SaveName:"Old_Term",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:110,  Align:"Center",  ColMerge:1,   SaveName:"New_AgreeNo",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:60,   Align:"Center",  ColMerge:1,   SaveName:"New_Term",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Date",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"ChangeDate",   KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"TypeSize",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"ChassisNo1",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"ChassisNo2",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"ChassisNo3",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"ChassisNo4",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
		                     {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:"ChassisNo5",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 } ];
        ...
        switch(sAction) {
        	case IBSEARCH:      //retrieve
        	    ...
        	    sheetObj.SetWaitImageVisible(0);
		 	    ComOpenWait(true);
        		// retrieve
		 	    var sXml=sheetObj.GetSearchData("EES_CGM_1118GS.do" , FormQueryString(formObj), '', true);
    ...
    function setCallback_Vendor(aryPopupData, row, col, sheetIdx){
 	...
 	function sheet1_OnChangeSum(sheetObj, Row){
 		with(sheetObj)
 		{
 			...
 			SetSumText(0, "new_agmt_lstm_cd","Grand Total");
 			SetCellAlign(Row, "new_agmt_lstm_cd","Center");
 		}
 	}
 	function sheet1_OnSearchEnd(sheetObj, ErrMsg)
 	{
 		with(sheetObj)
 		{
 			SetSumText(0, "sts_evnt_ofc_cd","");
 			SetSumText(0, "new_agmt_lstm_cd","Grand Total");
 			SetCellAlign(0, "new_agmt_lstm_cd","Center");
 		}
 	} 
     /**
...
//    	alert(sheetObj.CellValue(Row, "new_agmt_lstm_cd"));
    	...
    	param=param + "&old_agmt_lstm_cd=" + old_lstm_cd;
    	param=param + "&new_agmt_lstm_cd=" + new_lstm_cd;
