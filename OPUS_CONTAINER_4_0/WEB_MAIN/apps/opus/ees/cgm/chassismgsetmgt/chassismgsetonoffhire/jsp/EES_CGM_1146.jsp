...
<%@ page import="com.clt.apps.opus.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm1146Event"%>
       	...
       	<tr><td class="bg">
			<table class="search" border="0" style="width:979;"> 
				<tr class="h23">
					...
					<td width="150"><input type="text" style="width:60;ime-mode:disabled" dataformat="ym"  class="input1" name="de_yrmon" maxlength="7" value = "<%=deYrmon %>">&nbsp;<img name="btns_Calendar1" class="cursor" src="img/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle">
					</td>
					<td width="50">EQ. No.</td>
					<td width="250"><input type="text" style="width:100;" class="input1" maxlength="10" dataformat="engup" name="eq_no_fm" value= "<%=eqNoFm %>">&nbsp;-&nbsp;<input type="text" style="width:80;" class="input1" maxlength="6"  dataformat="num" name="eq_no_to" value = "<%=eqNoTo %>"></td>
