...
<%@ page import="com.clt.apps.opus.ees.cgm.chassismgsetmgt.chassismgsetonoffhire.event.EesCgm2018Event"%>
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tbody>
				<tr>
					<th>M.G.Set No.</th>
					<td><input type="text" style="width:90px;ime-mode:disabled;text-align:center" maxlength="10" dataformat="engup" class="input1" value="<%=eq_no %>" name="eq_no" id="eq_no" /> </td>
...
<div class="wrap_result">
	<h3 class="title_design">Update</h3>
	<!-- opus_design_grid(S) -->
