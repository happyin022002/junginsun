...
<%@ page import="com.clt.apps.opus.ees.cgm.chassismgsetmgt.chassismgsetinventory.event.EesCgm2077Event"%>
	...
	<div class="opus_design_inquiry wFit">
		<table>
	        ...
	        <tr>
	            ...
	            <td><input type="text" style="width:140px;ime-mode:disabled" dataformat="enguponly" name="crnt_ofc_cd" class="input" value="" id="crnt_ofc_cd" /><!--  
	        ...
	        <tr>
				<th>Lessor</th>
				<td><input type="text" name="vndr_seq" dataformat="num" style="width:140px;ime-mode:disabled" class="input" value="" id="vndr_seq" /><!--  
				--><button type="button" id="btns_vndr" name="btns_vndr" class="input_seach_btn"></button></td>
				<th>Lease Term</th>
				<td><script type="text/javascript">ComComboObject('agmt_lstm_cd', 1, 155, 0, 0, 0, true);</script></td>
			</tr> 
		</table>
	</div>
