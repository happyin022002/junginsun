     	...
     	try {
             ...
             switch(srcName) {
 				...
 				case "btn_print":
 					...
 					ComOpenPopupWithTarget('/opuscntr/EES_CGM_1106.do?pgmNo=EES_CGM_1106', 775, 800, "", "0,1,1,1,1,1,1", true);
					break;
         ...
         switch(sheetID) {
             case "sheet1":
                 ...
                 var cols = [ {Type:"Status",    Hidden:1, Width:45,   Align:"Center",  ColMerge:0,   SaveName:prefix1+"hdnStatus" },
                        ...
                        {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:0,   SaveName:prefix1+"mg_set_no",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
     ...
     function doActionIBSheet(sheetObj,formObj,sAction) {
         ...
         switch(sAction) {
            ...
            if(validateForm(sheetObj,formObj,sAction)){
            	...
            	sheetObj.SetWaitImageVisible(0);
 			 	ComOpenWait(true);
                 var sXml=sheetObj.GetSearchData("EES_CGM_1105GS.do" , sParam);
                ...
                else
                {
                	...
                	formObj.chss_pool_cd.value=DomXml2String(arrXml[0], "chss_pool_cd");
