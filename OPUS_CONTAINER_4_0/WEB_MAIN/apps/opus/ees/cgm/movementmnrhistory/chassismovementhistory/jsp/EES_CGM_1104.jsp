...
<%@ page import="com.clt.apps.opus.ees.cgm.movementmnrhistory.chassismovementhistory.event.EesCgm1104Event"%>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>Co-Op Pool</th>
					<td><script type="text/javascript">ComComboObject('chss_pool_cd', 1, 286, 0);</script></td>
					<th><label for="Include">Include 'NP'</label></th>
					<td><input type="checkbox" value="1" class="trans" name="Include" id="Include"/></td>
					<td></td>
				</tr>
			</tbody>
		</table>
