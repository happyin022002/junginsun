...
<%
	EesCgm2105Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm2105Event)request.getAttribute("Event");
...
<div class="wrap_result">
	...
	<table class="search" border="0">
          <tr>
              <td><h3 class="title_design mar_btm_8">M.G Set Movement History</h3></td>
          </tr>
    </table>
	...
	<table class="search" border="0">
          <tr>
              <td><h3 class="title_design mar_btm_8">M.G Set Attach/Detach History</h3></td>
          </tr>
    </table>
