...
<%@ page import="com.clt.apps.opus.ees.cgm.movementmnrhistory.mgsetmovementhistory.event.EesCgm2109Event"%>
...
<%
	EesCgm2109Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesCgm2109Event)request.getAttribute("Event");
...
// 			to_day = DateTime.addDays(form_day.replace(".",""),-180);
...
<input type="hidden" name="mgst_no" id="mgst_no" />
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>Period</th>
					<td><input type="text" style="width:80px;text-align:center;ime-mode:disabled" dataformat="ymd" maxlength="10" class="input" name="p_date1" value="" id="p_date1" />~&nbsp;<input type="text" style="width:80px;text-align:center;ime-mode:disabled" dataformat="ymd" class="input" value="" name="p_date2" id="p_date2" /><button type="button" id="btns_Calendar2" name="btns_Calendar2" class="calendar ir"></button></td>
					<td></td>
				</tr> 
			</tbody>
		</table>
