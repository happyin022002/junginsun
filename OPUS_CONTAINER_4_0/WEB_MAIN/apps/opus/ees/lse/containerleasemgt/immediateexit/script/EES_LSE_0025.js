 ...
 ***************************************************************************************/
    /**
     * @extends
     * @class EES_LSE_0025 : business script for EES_LSE_0025
     */
   	/* developer job */
    	...
    	try {
            ...
            switch(srcName) {
				...
				case "btn_new":
					...
					// 2015.10.23 BluePrint#7755: Immediate Exit Flagging Access Rights By Jun Kato
				...
				case "btn_downExcel":
					if(sheetObjects[0].RowCount() < 1){//no data
						...
						sheetObjects[0].Down2Excel( {DownCols: "seq_no|imdt_ext_flg|cntr_no|cntr_tpsz_cd|onh_dt|onh_yd_cd|crnt_yd_cd|cnmv_sts_cd|cnmv_dt|full_flg", SheetDesign:1,Merge:1,CheckBoxOffValue:" " });
					}
					break;
...
//		axon_event.addListenerForm('keydown',		'obj_keydown',	formObj); 
            ...
            case 1:      //t1sheet1 init
                with (sheetObj) {
	                ...
	                var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
	                          ...
	                          {Type:"Text",      Hidden:1, Width:20,   Align:"Center",  ColMerge:1,   SaveName:"agmt_cty_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	                          {Type:"Text",      Hidden:1, Width:20,   Align:"Center",  ColMerge:1,   SaveName:"agmt_seq",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
    ...
    function sheet1_OnSearchEnd(sheetObj, ErrMsg) {
    	...
    	// <begin> 2015.10.23 BluePrint#7755: Immediate Exit Flagging Access Rights By Jun Kato 
    	// <begin> 2015.11.05 (Bug fix) BluePrint#7755: Immediate Exit Flagging Access Rights By Jun Kato 
    	...
    	if(sheetObj.RowCount() > 0) {	
    		...
    		if (!OfficeCodeMgr.checkContainOfficeCode("000001", "LSE", ComGetObjValue(formObj.usr_ofc_cd)) ) {
    			for(var i=2;i<=sheetObj.RowCount()+1;i++) {    		
    				// if immediate Exit flag is checked, change the checkbox to non-editble.
    				if(sheetObj.GetCellValue(i,"imdt_ext_flg") == 1 ){
    				sheetObj.SetCellEditable(i,"imdt_ext_flg",0);
    				}
    		    }
    			// if all row of immediate Exit flag is checked, change Save Button to disable.
    			if(sheetObj.CheckedRows("imdt_ext_flg")==sheetObj.RowCount())
    			{
    				ComBtnDisable("btn_save");
    			}
    		} 
		}
    	//<end> 2015.10.23 BluePrint#7755: Immediate Exit Flagging Access Rights By Jun Kato 
    }
    /**
