 ...
 ***************************************************************************************/
    /**
     * @extends
     * @class EES_LSE_0097 : business script for EES_LSE_0097
     */
    function EES_LSE_0097() {
			...
			,AfterSaveStatus : function(result) {
				...
				if( code == 0) {
					uploadFileName=ComGetEtcData(sXml,"filename");
	 				pSheetObj.SetCellValue(pRow, "cxl_file_sav_id",uploadFileName,0);
	 		...
	 		,AfterAddFile:function(result){
				...
				ComOpenWait(true);
		 		fileUploadFlag=true;
		 		pSheetObj.SetCellValue(pRow, "cxl_file_sav_nm",fileName,0);
	...
	function sheet1_OnMouseMove(sheetObj, Button, Shift, X, Y) {
		with(sheetObj) {
	      ...
	      if (row > 0 && saveName=="cxl_file_sav_nm" && editFlag == 1) {
			if ( fileUploadFlag ) {
				return;
			}
            ...
            case "sheet1":
                with(sheetObj){
		              ...
		              var cols = [ {Type:"Status",    Hidden:1, Width:40,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
		                     ...
		                     {Type:"Text",      Hidden:0,  Width:130,  Align:"Center",  ColMerge:1,   SaveName:"rqst_no",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		                     {Type:"Text",      Hidden:0,  Width:130,  Align:"Center",  ColMerge:1,   SaveName:"apro_no",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		                     ...
		                     {Type:"Text",      Hidden:0,  Width:250,  Align:"Left",    ColMerge:0,   SaveName:"rqst_file_sav_nm",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		                     ...
		                     {Type:"Text",      Hidden:0,  Width:250,  Align:"Left",    ColMerge:0,   SaveName:"apro_file_sav_nm",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		                     ...
		                     {Type:"Text",      Hidden:0,  Width:300,  Align:"Left",    ColMerge:0,   SaveName:"cxl_rsn_desc",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:100 },
...
//						sheetObj.RenderSheet(0);
			...
			case IBSAVE:
				...
				if(validateForm(sheetObj, formObj, sAction)) {
					if(sheetObj.id == "sheet1") {
						...
						sheetObj.DoSave("EES_LSE_0093GS.do", FormQueryString(formObj));
					}
				}
				ComOpenWait(false);
	...
	/**
	 * handling event when ScrollNext Sheet1.<br>
	 * @param sheetObj
	 * @param CondParam
	 * @param PageNo
	 * @param OnePageRows
    ...
    function sheet1_OnSearchEnd(sheetObj, ErrMsg) {
    	with(sheetObj) {
    		...
    		for(var i=HeaderRows(); i <= LastRow(); i++) {
    			var vAproMode=GetCellValue(i, "mss_usd_apro_mod_cd");
    			SetCellEditable(i, "del_chk",vAproMode == "APP");
    			if(vAproMode == "CNL") {
    				SetCellFontColor(i, "mss_usd_apro_mod_cd","#FF0000");
    				SetCellEditable(i, "cxl_file_sav_nm",1);
					SetCellEditable(i, "cxl_rsn_desc",1);
    			}
    		}
	...
	/**
	 * handling event when changing Sheet1.<br>
	 * @param sheetObj
	 * @param Row
	 * @param Col
	 * @param Value
	...
	function sheet1_OnChange(sheetObj, Row, Col, Value) {
		...
		with(sheetObj) {
			...
			switch(sName) {
				case "del_chk":
					if(Value == "1") {
						SetCellEditable(Row, "cxl_file_sav_nm",1);
						SetCellEditable(Row, "cxl_rsn_desc",1);
					} else {
						SetCellEditable(Row, "cxl_file_sav_nm",0);
						SetCellEditable(Row, "cxl_rsn_desc",0);
						SetCellValue(Row, "cxl_file_sav_nm","",0);
						SetCellValue(Row, "cxl_file_sav_id","",0);
						SetCellValue(Row, "cxl_rsn_desc","",0);
					}
				break;
			}
		}
	...
	/**
	 * handling event when Click Sheet1
	 */
...
//		if(sheetObj.GetMousePointer!= "Hand") return;
    ...
    function openPopup(type, Row, Col) {
    	if ( type == "1" ) {
			ComOpenPopupWithTarget('/opuscntr/COM_ENS_071.do', 755, 435, "ofc_cd:rqst_ofc_cd", "1,0,1,1,1,1,1,1", true);
    	}
    	return;
    }
    /**
