...
<%@ page import="com.clt.apps.opus.ees.lse.containerleasemgt.leasereport.event.EesLse0036Event"%>
...
<%
	...
	try {
		...
		//COMMBO LIST		
		company 	= LSEUtil.getValueObject2StringArray((List<?>)eventResponse.getCustomData("COMPANY"), false);
