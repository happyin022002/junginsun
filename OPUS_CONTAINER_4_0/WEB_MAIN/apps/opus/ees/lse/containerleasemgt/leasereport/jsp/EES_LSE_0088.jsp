...
<%@ page import="com.clt.apps.opus.ees.lse.containerleasemgt.leasereport.event.EesLse0088Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesLse0088Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0088Event)request.getAttribute("Event");
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				<th>Period</th>
				<td>
				   <input type="text" name="period_stdt" style="width:80px;ime-mode:disabled" value="" class="input1" dataformat="ymd" id="period_stdt" />&nbsp;~&nbsp;<!--  
				   --><input type="text" name="period_eddt" style="width:80px;ime-mode:disabled" value="" class="input1" dataformat="ymd" ><!--  
