...
/**
 * @extends
 * @class EES_LSE_0052 : business script for EES_LSE_0052
 */
function EES_LSE_0052() {
...
function initSheet(sheetObj,sheetNo) {
	...
	case "sheet1":
		with (sheetObj) {
		    ...
		    SetConfig( { SearchMode:2, FrozenCol:0, MergeSheet:2, Page:1000, DataRowMerge:0 } );
...
function doActionIBSheet(sheetObj,formObj,sAction, CondParam, PageNo) {
	...
	if(validateForm(sheetObj,formObj,sAction))
		if (sheetObj.id == "sheet1"){
			...
			ComOpenWait(true);
			setTimeout( function () {
                var sXml=sheetObj.GetSearchData("EES_LSE_0052GS.do", FormQueryString(formObj));
	...
	if(validateForm(sheetObj,formObj,sAction)) {
		if(sheetObj.id == "sheet2") {
			...
			sheetObj.DoSearch("EES_LSE_0052GS.do",FormQueryString(formObj) );
	...
	case IBSEARCHAPPEND:
		if(sheetObj.id == "sheet2") {
			...
			sheetObj.SetWaitImageVisible(0);
			ComOpenWait(true);
			sheetObj.DoSearch("EES_LSE_0052GS.do", CondParam+"&"+ "iPage="+ PageNo,{Append:true} );
		}
		break;
...
var vLstmCd=sheetObject1.GetCellValue(sRow , "lstm_cd");
...
/**
* sheet1_OnMouseDown
* alling event after mouse-down Sheet
*/
...
function doActionIBSheet1(sheetObj, formObj, sAction, CondParam, PageNo) {
	...
	case IBSEARCHAPPEND:
        ...
        setTimeout( function () {	        	
			...
			sheetObjects[1].DoSearch("EES_LSE_0052GS.do", CondParam+"&"+ "iPage="+ appendPageNo,{Append:true} );  	   
			} , 100);
