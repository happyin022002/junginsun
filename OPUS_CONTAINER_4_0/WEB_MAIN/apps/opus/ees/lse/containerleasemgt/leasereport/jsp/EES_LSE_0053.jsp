...
<%@ page import="com.clt.apps.opus.ees.lse.containerleasemgt.leasereport.event.EesLse0053Event"%>
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
			    ...
			    --><input type="text" name="abbr_nm" style="width:110px;" class="input2" readonly id="abbr_nm" /><!--  
			    --><input type="text" name="vndr_nm" style="width:350px;" class="input2" readonly id="vndr_nm" /></td>
			    <td>&nbsp;</td>
			</tr>
		</table>
		<table>
			...
			<tr>
			    <th>Lease Term</th>
			    <td><script type="text/javascript" >ComComboObject('combo1', 1, 212, 1 );</script><!--  
			    --><input type="hidden" name="lstm_cd" value="" id="lstm_cd" /></td>
			    <th>TP/SZ</th>
			    <td><!--  
			    --><script type="text/javascript" >ComComboObject('combo2', 1, 188, 1 );</script><!--  
