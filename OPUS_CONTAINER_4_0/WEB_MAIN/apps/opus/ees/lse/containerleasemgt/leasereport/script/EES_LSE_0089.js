...
/**
 * @extends
 * @class EES_LSE_0089 : business script for EES_LSE_0089
 */
...
function processButtonClick(){
	...
	try {
		...
		case "btn_New":
			sheetObject1.RemoveAll();
			sheetObject1.SetCellText(0, 1 ,"RCC");
		...
		with (sheetObj) {
		    ...
		    for(var i=0; i < 2; i++) {
			    ...
			    var cols = [ {Type:"Text",      Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"level_no",     KeyField:0,   CalcLogic:"",   Format:""  },
			                 {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"rcc",          KeyField:0,   CalcLogic:"",   Format:"" ,TreeCol:1 ,  LevelSaveName:"level" } ];
			       for(var j=0; j<arrTpSz2.length; j++){
			    	   cols.push({Type:"Text",      Hidden:0,  Width:50,   Align:"Right",   ColMerge:1,   SaveName:arrTpSz2[j]+"", KeyField:0,   CalcLogic:"",   Format:"Float",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
			       }
			    ...
			    cols.push({Type:"Text",   Hidden:0, Width:50,   Align:"Right",   ColMerge:1,   SaveName:"auto_sum",     KeyField:0,   CalcLogic:"",   Format:"Float",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
		    }
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	if(validateForm(sheetObj,formObj,sAction))
		if (sheetObj.id == "sheet1"){
			...
			ComOpenWait(true);
			var sXml=sheetObj.GetSearchData("EES_LSE_0089GS.do", FormQueryString(formObj));
...
/**
 * Check box click in case of MultiSelect property use.
 * @return
 */
