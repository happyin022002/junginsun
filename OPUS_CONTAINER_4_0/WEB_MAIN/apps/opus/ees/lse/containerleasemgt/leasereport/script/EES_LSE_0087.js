...
/**
 * @extends
 * @class EES_LSE_0087 : business script for EES_LSE_0087
 */
...
//		    for(var i=0; i < 2; i++) {
		    ...
		    SetConfig( { SearchMode:2, FrozenCol:2, MergeSheet:2, Page:20, DataRowMerge:0 ,VScrollMode:1} );
		    ...
		    var cols = [ {Type:"Text",      Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"level_no",     KeyField:0,   CalcLogic:"",   Format:"" },
		              {Type:"Text",      Hidden:0,  Width:100,   Align:"Center",  ColMerge:1,   SaveName:"rcc",     TreeCol:1,     KeyField:0,   CalcLogic:"",   Format:"" } ];
		    ...
		    cols.push({Type:"Text",      Hidden:0,  Width:200,   Align:"Right",   ColMerge:1,   SaveName:"ratio",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	if(validateForm(sheetObj,formObj,sAction))
		if (sheetObj.id == "sheet1"){
			...
			sheetObj.SetWaitImageVisible(1);
			ComOpenWait(true);
			var sXml=sheetObj.GetSearchData("EES_LSE_0087GS.do", FormQueryString(formObj));
