...
<%@ page import="com.clt.apps.opus.ees.lse.containerleasemgt.leasereport.event.EesLse0089Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesLse0089Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse0089Event)request.getAttribute("Event");
...
<div class="page_title_area clear">
   <!-- page_title(S) -->
	...
	<!-- page_title(E) -->
	<!-- opus_design_btn(S) -->
	<div class="opus_design_btn"><button type="button" class="btn_accent" name="btn_Retrieve" id="btn_Retrieve">Retrieve</button><button type="button" class="btn_normal" name="btn_New"  	id="btn_New">New</button></div>
	<!-- opus_design_btn(E) -->
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				...
				--><input type="text" name="period_eddt" style="width:80px;ime-mode:disabled;text-align:center;" value="" class="input1" dataformat="ymd" id="period_eddt" /><!--  
			...
			<tr>
				<th>Term Change</th>
				<td><select name="term_change" style="width:92px"><!--  
