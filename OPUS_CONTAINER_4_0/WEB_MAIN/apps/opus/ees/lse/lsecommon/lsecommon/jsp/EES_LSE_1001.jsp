...
<%@ page import="com.clt.apps.opus.ees.lse.lsecommon.lsecommon.event.EesLse1001Event"%>
<%
	EesLse1001Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesLse1001Event) request.getAttribute("Event");
