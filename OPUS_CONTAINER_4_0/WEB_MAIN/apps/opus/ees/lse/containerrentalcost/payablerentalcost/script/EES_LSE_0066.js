 ...
 ***************************************************************************************/
   	...
   	/**
     * @extends 
     * @class EES_LSE_0066 :  business script for EES_LSE_0066
     */
...
* adding first-served functions after loading screen.
	...
	function rdOpen(){				
		...
		if ( viewer.RowCount()   == "0")                     // RD 로 보낼 sheet 에 데이타가 없으면 Error
		{
		...
		viewer.openFile(RD_path+'apps/opus/ees/lse/containerrentalcost/payablerentalcost/report/EES_LSE_0066.mrd',RDServer, {timeout:1800});
	}
