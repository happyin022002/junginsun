...
<%@ page import="com.clt.apps.opus.ees.lse.containerrentalcost.receivablerentalcost.event.EesLse0074Event"%>
...
<%
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.ContainerRentalCost.ReceivableRentalCost");
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tr>
				...
				--><option value="rp_0074" selected>By RCC & Lessee</option><!--  
				...
				--><option value="rp_0078" >By Lessor & Month</option><!--  
				--><option value="rp_0079" >Summary Payable Charge</option></select></td>
				<th>Period</th>
			   ...
			   <td id="fixLayer2" style="position:absolute; visibility:hidden;"><input type="text" name="period_year" id="period_year" style="width:40px;text-align:center;" value="" class="input1"  maxlength="4" dataformat="yyyy" ><!--  
			...
			<tr><!-- company -->
				...
				<td><select style="width:120px;" name="receivable" class="input"><!--  
			...
			<tr>
				<th>Status</th>
				<td><select style="width:71px;" name="status" class="input"><!--  
		...
		<table>
			...
			<tr>
			    <th>AGMT No.</th>
			    <td><input type="text" style="width:70px;text-align:center" name="agmt_cty_cd" class="input2" value="HHO" maxlength="3" readonly="" id="agmt_cty_cd" /><!--  
			    --><input type="text" style="width:82px;text-align:right" name="agmt_seq" class="input" value="" maxlength="6" dataformat="num" id="agmt_seq" /><!--  
			...
			<tr>
			    ...
			    --><input type="text" name="abbr_nm" style="width:59px;" class="input2" readonly="" id="abbr_nm" /><!--  
			    --><input type="text" name="vndr_nm" style="width:266px;" class="input2" readonly="" id="vndr_nm" /></td>
			    <th>TP/SZ</th>
			...
			<tr>
			    ...
			    --><input type="text" style="width:59px;" name="loc_cd" value="" class="input" dataformat="engup" maxlength="5" fullfill="" id="loc_cd" /><!--  
