...
*@FileName : EES_EQR_133.jsp
*@FileTitle : retrieving for Link info
*@author     : CLT
*@version    : 1.0
*@since      : 2014/06/30
=========================================================--%>
...
<div class="wrap_search">
	<div class="opus_design_inquiry">		
		...
		<tr>
			...
			<td width="400px">
				<%= frLocSelectBox %><!--input type="text" name="fromLocation" value="" style="width:280px;ime-mode:disabled;" dataformat="engup"
				--><input type="text" name="fromLocation" value="" style="width:284px;ime-mode:disabled;" dataformat="engup" otherchar=","><!--				
				--><button type="button" class="input_seach_btn" name="frloc_btn"></button>
			</td>
			<th width="100px">To Location</th>
			<td width="%">
				<%= toLocSelectBox %><!--input type="text" name="toLocation" value="" style="width:280px;ime-mode:disabled;" dataformat="engup"
		...
		<table border="0">
		<tr>
			<th width="110px"><%//<img class="nostar">%>Transit Days</th>
			<td width="135px" class="stm" style="padding-left:1"><input name="transitTime" type="text" style="width:59px;ime-mode:disabled;" maxlength=5 dataformat="num"> </td>
			<th width="48px">Mode</th>
			<td width="217px">
				<%= modeSelectBox %>
			</td>
			<th width="91px">Update By / DT</th>
			<td width="*">&nbsp;<input type="text" name="userid" value="" class="input2" style="width:84px" readOnly> / &nbsp;<input type="text" name="date" value="" class="input2" style="width:75px" readOnly></td>
		</tr>
		</table>
		<!-- : ( Transit Time ) (E) -->
	</div>
