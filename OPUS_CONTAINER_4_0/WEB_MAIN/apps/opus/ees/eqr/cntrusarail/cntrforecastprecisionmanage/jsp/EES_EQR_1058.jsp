...
<%@ page import="com.clt.apps.opus.ees.eqr.cntrusarail.cntrforecastprecisionmanage.event.EesEqr1058Event"%>
<%@ page import="com.clt.apps.opus.ees.eqr.cntrusarail.cntrforecastprecisionmanage.vo.MtyRailConditionVO"%>
					...
					<tr><td class="bg">
						<table class="search_in" border="0">
							<tr class="h23">
								...
								<td width="195">&nbsp;<input name="fm_dt" type="text" class="input2" style="width:70; " value="<%=currentDate%>" maxlength="10" dataformat="ymdhm"><img name="btns_calendar" class="cursor" src="/opuscntr/img/button/btns_calendar.gif" width="19" height="20" border="0" align="absmiddle">&nbsp;~&nbsp;
