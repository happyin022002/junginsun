	...
	switch (sheetNo) {
		case 1: // sheet1 init
		    with(sheetObj){
		      ...
		      SetConfig( { SearchMode:2, MergeSheet:7, Page:20, FrozenCol:6, DataRowMerge:1 } );
		      ...
		      var cols = [ {Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"trd_cd",          KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:38,   Align:"Center",  ColMerge:1,   SaveName:"sub_trd_cd",      KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:45,   Align:"Center",  ColMerge:1,   SaveName:"vsl_lane_cd",     KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:43,   Align:"Center",  ColMerge:1,   SaveName:"wk",              KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:68,   Align:"Center",  ColMerge:1,   SaveName:"vvd_cd",          KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:55,   Align:"Center",  ColMerge:1,   SaveName:"pol_yd_cd",       KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:93,   Align:"Center",  ColMerge:1,   SaveName:"eta_dt",          KeyField:0,   CalcLogic:"",   Format:"####-##-####:##", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:93,   Align:"Center",  ColMerge:1,   SaveName:"etd_dt",          KeyField:0,   CalcLogic:"",   Format:"####-##-####:##", PintCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Text",      Hidden:0,  Width:65,   Align:"Center",  ColMerge:1,   SaveName:"fcbf_dt",         KeyField:0,   CalcLogic:"",   Format:"####-##-##", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"mty_pln_teu",     KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
		             {Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"mty_pln_box",     KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 } ];
		      for (var i = 0; i < consTpszArr.length; i++) { // MT PLAN
			      col_nm = "mty_pln_"+(consTpszArr[i]).toLowerCase();
			      cols.push({Type:"Int",       Hidden:0,  Width:38,   Align:"Right",   ColMerge:0,   SaveName:col_nm,            KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      }
		      cols.push({Type:"Int",       Hidden:0,  Width:43,   Align:"Right",   ColMerge:0,   SaveName:"mty_pln_ton",     KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"mty_bkg_teu",     KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"mty_bkg_box",     KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      for (var i = 0; i < consTpszArr.length; i++) {//MT Booking
			      col_nm = "mty_bkg_"+(consTpszArr[i]).toLowerCase();
			      cols.push({Type:"Int",       Hidden:0,  Width:38,   Align:"Right",   ColMerge:0,   SaveName:col_nm,            KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      }
		      cols.push({Type:"Int",       Hidden:0,  Width:43,   Align:"Right",   ColMerge:0,   SaveName:"mty_bkg_ton",     KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:35,   Align:"Right",   ColMerge:0,   SaveName:"diff_teu",        KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:35,   Align:"Right",   ColMerge:0,   SaveName:"diff_box",        KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      for (var i = 0; i < consTpszArr.length; i++) {//Diff(A-B)
			      col_nm = "diff_"+(consTpszArr[i]).toLowerCase();
			      cols.push({Type:"Int",       Hidden:0,  Width:35,   Align:"Right",   ColMerge:0,   SaveName:col_nm,            KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      }
		      cols.push({Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"bkg_lodg_teu",    KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"bkg_lodg_box",    KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      for (var i = 0; i < consTpszArr.length; i++) {// Full BKG Lodg
			      col_nm = "bkg_lodg_"+(consTpszArr[i]).toLowerCase();
			      cols.push({Type:"Int",       Hidden:0,  Width:38,   Align:"Right",   ColMerge:0,   SaveName:col_nm,            KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      }
		      cols.push({Type:"Int",       Hidden:0,  Width:45,   Align:"Right",   ColMerge:0,   SaveName:"bkg_lodg_ton",    KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      ...
		      cols.push({Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"bkg_disch_teu",   KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"bkg_disch_box",   KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      for (var i = 0; i < consTpszArr.length; i++) {// Full BKG Disch
			      col_nm = "bkg_disch_"+(consTpszArr[i]).toLowerCase();
			      cols.push({Type:"Int",       Hidden:0,  Width:38,   Align:"Right",   ColMerge:0,   SaveName:col_nm,            KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      }
		      cols.push({Type:"Int",       Hidden:0,  Width:45,   Align:"Right",   ColMerge:0,   SaveName:"bkg_disch_ton",   KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:35,   Align:"Right",   ColMerge:1,   SaveName:"void_teu",        KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:45,   Align:"Right",   ColMerge:0,   SaveName:"bsa_teu",         KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Int",       Hidden:0,  Width:48,   Align:"Right",   ColMerge:0,   SaveName:"bsa_ton",         KeyField:0,   CalcLogic:"",   Format:"NullInteger", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:45,   Align:"Right",   ColMerge:1,   SaveName:"lf_fd",           KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"lf_full_teu",     KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:45,   Align:"Right",   ColMerge:0,   SaveName:"lf_full_ton",     KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:40,   Align:"Right",   ColMerge:0,   SaveName:"lf_ttl_teu",      KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:45,   Align:"Right",   ColMerge:0,   SaveName:"lf_ttl_ton",      KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:80,   Align:"Left",    ColMerge:0,   SaveName:"pln_rsn_hdr_cd",  KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:80,   Align:"Left",    ColMerge:0,   SaveName:"pln_rsn_sub_cd",  KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:0,  Width:100,  Align:"Left",    ColMerge:1,   SaveName:"pln_rsn_rmk",     KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:1, Width:50,   Align:"Left",    ColMerge:1,   SaveName:"sort_flg",        KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
		      cols.push({Type:"Text",      Hidden:1, Width:50,   Align:"Left",    ColMerge:1,   SaveName:"ibflag",          KeyField:0,   CalcLogic:"",   Format:"", UpdateEdit:0,   InsertEdit:0,   EditLen:0 });
...
function form_keypress() {
	...
	switch (event.srcElement.name) {
		...
		break;
		case "eta_fm_dt":
			ComKeyOnlyNumber(formObj.eta_fm_dt,"");
		break;
		case "eta_to_dt":
			ComKeyOnlyNumber(formObj.eta_to_dt,"");
		break;
	}
}
/**
...
//parameter changed[check again]CLT 				var sXml=sheetObj.GetSearchData("EES_EQR_1025GS.do", FormQueryString(formObj));
...
function init_form() {
	...
	formObj.trade.SetSelectCode("");
	formObj.subtrade.SetSelectCode("");
	formObj.lane.SetSelectCode("");
	formObj.vvd_cd.value="";
