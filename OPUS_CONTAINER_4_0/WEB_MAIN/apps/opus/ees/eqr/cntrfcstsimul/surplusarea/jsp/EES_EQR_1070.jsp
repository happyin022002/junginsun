...
<%@ page import="com.clt.apps.opus.ees.eqr.cntrfcstsimul.surplusarea.event.EesEqr1070Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
    EesEqr1070Event  event = null;                  //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EesEqr1070Event)request.getAttribute("Event");
...
<div class="page_title_area clear">
	...
	<!-- page_title(S) -->
	<h2 class="page_title"><button type="button">History Report - Surplus Area</button></h2>
	<!-- page_title(E) -->
	...
	<div class="opus_design_inquiry wFit">
		<table>
		   ...
		   <tbody>
		   		<tr>
				 	<th>Period (YYYYWW)</th>
                    <td><input name="fm_yrwk" value="" type="text" class="input1" style="width:60px;ime-mode:disabled;" maxlength="6" dataformat="num" id="fm_yrwk" />~ <input name="to_yrwk" value="" type="text" class="input1" style="width:60px;ime-mode:disabled;" maxlength="6" dataformat="num" id="to_yrwk" /></td>
                    <td></td>
                    <th>Location by</th>
                    ...
                    --><option value="7">SCC (by Yard)</option><!-- loc_cd --></select><!--
                    ...
                    <td></td>
                    <td><input type="checkbox" name="show_detail" class="trans" onclick="showDetail();" id="show_detail" /> Show Detail</td>
		   		</tr>
		   </tbody>
		</table>
	</div>
