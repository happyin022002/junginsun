...
<%@ page import="com.clt.apps.opus.ees.ctm.equipmentmovementmgt.containermovementmasterdatamgt.event.EesCtm1001Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
  EesCtm1001Event event = null;        //PDTO(Data Transfer Object including Parameters)
  ...
  try {
    ...
    event = (EesCtm1001Event)request.getAttribute("Event");
