...
<%@ page import="com.clt.apps.opus.ees.mnr.generalmanage.officegeneralinfomgt.event.EesMnr0217Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesMnr0217Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0217Event)request.getAttribute("Event");
	...
	<table>
		...
		<tbody>
			<tr>
				...
				<td><script type="text/javascript">ComComboObject('combo2',2, 120 , 1);</script></td>
			</tr>
		</tbody>
	</table>
</div>
