...
<div class="wrap_search">
	...
	<div class="opus_design_inquiry">
	    ...
	    <table>
	        ...
	        <tbody>
				<tr class="h23">
					<th>Component 1ST Group</th>
					<td><script type="text/javascript">ComComboObject('combo1', 2, 300, 1, 1);</script></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<div class="wrap_result">
	<div class="layout_wrap" >
	    <div class="layout_vertical_3 pad_rgt_8">
		    ...
		    <!-- opus_design_btn(S) -->
		    <h3 class="title_design">EQ Component 1st Group</h3>
 				<div class="opus_design_btn">
	    ...
	    <div class="layout_vertical_3 pad_rgt_8" >
	        <div class="opus_design_grid"  id="mainTable">
		    <h3 class="title_design">EQ Component 2nd Group</h3>
	          <div class="opus_design_btn">
	    ...
	    <div class="layout_vertical_3" >
	        <div class="opus_design_grid"  id="mainTable">
		    <h3 class="title_design">EQ Component Code</h3>
		    	<div class="opus_design_btn">
			        ...
			        <button type="button" class="btn_normal" name="btn_Grouping3" id="btn_Grouping3">Grouping</button>
