...
<%@ page import="com.clt.apps.opus.ees.mnr.generalmanage.hangerinventorymgt.event.EesMnr0110Event"%>
...
<input type="hidden" name="ofc_cd" id="ofc_cd" />
	...
	<div class="page_title_area clear ">
		...
		<h2 class="page_title">
			<button type="button">
				<span id="title">Hanger Bar Inventory</span>
			</button>
		</h2>
		<!-- page_title(E) -->
	...
	<div class="opus_design_inquiry">
	    ...
	    <table>
	        ...
	        <tbody>
				<tr class="h23">
					<th>Regional HQ</th>
					<td><script type="text/javascript">ComComboObject('combo1',2, 180 ,0,1)</script></td>
					<th>Office</th>
					<td><script type="text/javascript">ComComboObject('combo2',2, 180 ,0,1)</script></td>
				</tr>
...
<div class="wrap_result">	
	...
	<div class="opus_design_grid"  id="mainTable">
		<h3 class="title_design">Hanger Bar Inventory</h3>		
	    <!-- opus_design_btn(S) -->
	    <div class="opus_design_btn"><!-- 그리드 버튼 영역(데이터 그리드 상단에 위치) --><!-- 버튼 name / ID정의되어 있음. 별도 지정 금지 --><!--
