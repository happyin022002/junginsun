...
<%@ page import="com.clt.apps.opus.ees.mnr.generalmanage.reefersparepartmgt.event.EesMnr0198Event"%>
...
<input type="hidden" name="spr_ut_tp_nm" id="spr_ut_tp_nm" />
...
<div class="layer_popup_title">	
	...
	<div class="page_title_area clear">
		...
		<h2 class="page_title">
			<span>Reefer Spare Kit Type Inquiry</span>
		</h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn (S) -->
	...
	<div class="wrap_search">
		<div class="opus_design_inquiry wFit">
			<table>
				...
				<tr>
					<th>Spare Type</th>
					<td><script type="text/javascript">ComComboObject('combo_spr_tp_cd',2, 100 , 1, 0,0,false);</script><input type="hidden" name="spr_tp_cd" id="spr_tp_cd" /></td>
					<td></td>
				</tr>
			</table>
