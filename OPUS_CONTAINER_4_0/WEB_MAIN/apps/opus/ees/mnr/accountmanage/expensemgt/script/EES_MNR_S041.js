    		...
    		if(ComGetBtnDisable(srcName)) return false;
          	switch(srcName) {
				...
				case "btn_Return":
					...
					break;
				case "btn_Retrieve":
					var idx=parseInt(comboObjects[0].GetSelectIndex()) + 1;
				...
				case "btn_RepairDetail":
					...
					if(beforetab=="0"){
						...
						eq_knd_cd=sheetObjects[3].GetCellValue(sheetObjects[3].GetSelectRow(),"eq_tpsz_cd");
						...
						eq_knd_cd=sheetObjects[4].GetCellValue(sheetObjects[4].GetSelectRow(),PrefixSheet2+"eq_tpsz_cd");
					...
					if(woType == 'EST'){ 
						if(MnrNullToBlank(eqNo) != ''){
							ComOpenPopup('/opuscntr/EES_MNR_0192.do?rqst_eq_no='+eqNo+"&rpr_rqst_seq="+rpr_rqst_seq+"&rpr_rqst_ver_no="+rpr_rqst_ver_no+"&eq_knd_cd=" + eq_knd_cd+"&spp_type=Y", 1024, 768, '', '0,0', false);   		
						}   			
					}else if(woType == 'SPL'){ 
						if(MnrNullToBlank(mnrOrdOfcCtyCd) != ''&& MnrNullToBlank(mnrOrdSeq) != ''){
							ComOpenPopup('/opuscntr/EES_MNR_0226.do?mnr_ord_ofc_cty_cd='+mnrOrdOfcCtyCd+'&mnr_ord_seq='+mnrOrdSeq+'&cost_ofc_cd='+costOfcCd, 900, 670, '', '0,0', true);   
						}   
					}else if(woType == 'EXT'){ 
						if(MnrNullToBlank(mnrOrdOfcCtyCd) != ''&& MnrNullToBlank(mnrOrdSeq) != ''){
							ComOpenPopup('/opuscntr/EES_MNR_0227.do?mnr_ord_ofc_cty_cd='+mnrOrdOfcCtyCd+'&mnr_ord_seq='+mnrOrdSeq+'&cost_ofc_cd='+costOfcCd, 900, 550, '', '0,0', true);   
						}   
					}else if(woType == 'RFS'){ 
						if(MnrNullToBlank(mnrOrdOfcCtyCd) != ''&& MnrNullToBlank(mnrOrdSeq) != ''){
							ComOpenPopup('/opuscntr/EES_MNR_0228.do?mnr_ord_ofc_cty_cd='+mnrOrdOfcCtyCd+'&mnr_ord_seq='+mnrOrdSeq+'&cost_ofc_cd='+costOfcCd, 900, 500, '', '0,0', true);   
						}   
					}						
					break;
				case "btn_DownExcel":
        ...
        switch(sheetid) {
             case "t1sheet1":
                with (sheetObj) {
                 ...
                 var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                     ...
                     {Type:"Text",      Hidden:0,  Width:60,   Align:"Left",    ColMerge:0,   SaveName:"iss_ofc_cd",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     ...
                     {Type:"Text",      Hidden:0,  Width:50,   Align:"Left",    ColMerge:0,   SaveName:"wo_type",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     ...
                     {Type:"Text",      Hidden:0,  Width:60,   Align:"Left",    ColMerge:0,   SaveName:"cre_dt",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     {Type:"Text",     Hidden:0,  Width:50,   Align:"Right",   ColMerge:0,   SaveName:"mnr_wrk_amt",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
                     ...
                     {Type:"Text",      Hidden:1, Width:60,   Align:"Right",   ColMerge:0,   SaveName:"vndr_seq",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
             ...
             case "t2sheet1":
                with (sheetObj) {
                 ...
                 var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                     ...
                     {Type:"Seq",       Hidden:0, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"Seq" },
                     {Type:"Text",      Hidden:0,  Width:60,   Align:"Left",    ColMerge:0,   SaveName:"cost_ofc_cd",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     {Type:"Text",      Hidden:1, Width:80,   Align:"Left",    ColMerge:0,   SaveName:"vndr_lgl_eng_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     {Type:"Text",      Hidden:0,  Width:50,   Align:"Left",    ColMerge:0,   SaveName:"wo_type",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     {Type:"Text",      Hidden:0,  Width:65,   Align:"Left",    ColMerge:0,   SaveName:"wo_no",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     {Type:"Text",     Hidden:0,  Width:50,   Align:"Right",   ColMerge:0,   SaveName:"mnr_wrk_amt",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
			...
			case "sheet1":
	            ...
	            var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
	                {Type:"CheckBox",  Hidden:0, Width:45,   Align:"Center",  ColMerge:1,   SaveName:"Check",               KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
	                ...
	                {Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:1,   SaveName:"rpr_rslt_dt",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	                ...
	                {Type:"AutoSum",   Hidden:0, Width:70,   Align:"Right",   ColMerge:1,   SaveName:"inv_amt",             KeyField:1,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1 },
			...
			case "sheet2":
                ...
                var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:PrefixSheet2+"ibflag" },
                 {Type:"CheckBox",  Hidden:0, Width:45,   Align:"Center",  ColMerge:1,   SaveName:PrefixSheet2+"Check",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                 ...
                 {Type:"PopupEdit", Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:PrefixSheet2+"rpr_rslt_dt",        KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                 ...
                 {Type:"AutoSum",   Hidden:0, Width:70,   Align:"Right",   ColMerge:1,   SaveName:PrefixSheet2+"inv_amt",            KeyField:1,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:1,   InsertEdit:1 },
		...
		if(sheetObj.RowCount()>0){
	    	...
	    	for(i=sheetObj.LastRow(); i > 1 ; i--){
	    		if(sheetObj.GetCellValue(i,  "mnr_vrfy_tp_cd")!="SS"){
					sheetObj.SetRowBackColor(i,"#FFC0FF");
				}
        ...
        switch(sAction) {
          	case IBSEARCH:      //조회
	          	if(validateForm(sheetObj,formObj,sAction)){
					...
					sheetObj.DoSearch("EES_MNR_S041GS.do",FormQueryString(formObj) );
				}		
                break;
					...
					if(invInfoClearYN!="N"){
						for(var i=1; i <= sheetObjects[0].RowCount(); i++){
							if(sheetObjects[0].GetCellValue(i,"sel") == 1){
								...
								if(currPrcsKnt=="0"){
									var info = {format:"Int"};
									sheetObjects[3].InitCellProperty(0, "inv_amt", info);
									sheetObjects[4].InitCellProperty(0, PrefixSheet2+"inv_amt", info);
								}else{
									var info = {format:"Float"};
									sheetObjects[3].InitCellProperty(0, "inv_amt", info);
									sheetObjects[4].InitCellProperty(0, PrefixSheet2+"inv_amt", info);
								}	
								comboObjects[1].SetSelectCode(sheetObjects[0].GetCellValue(i,"mnr_inv_sts_cd"));
						...
						var sXml=sheetObj.GetSaveData("EES_MNR_S041GS.do", sParam);
          	...
          	case IBSEARCH_ASYNC04:      //Invoice Detail조회
				...
				saveRet=="N";   	
	          	if(validateForm(sheetObj,formObj,sAction)){          	
					...
					if(invInfoClearYN!="N"){
						for(var i=1; i <= sheetObjects[2].RowCount(); i++){
							if(sheetObjects[2].GetCellValue(i,"sel") == 1){
								...
								if(currPrcsKnt=="0"){
									var info = {format:"Int"};
									sheetObjects[3].InitCellProperty(0, "cost_amt", info);
									sheetObjects[4].InitCellProperty(0, PrefixSheet2+"cost_amt", info);
									sheetObjects[3].InitCellProperty(0, "inv_amt", info);
									sheetObjects[4].InitCellProperty(0, PrefixSheet2+"inv_amt", info);
								}else{
									var info = {format:"Float"};
								...
								comboObjects[1].SetSelectCode(sheetObjects[2].GetCellValue(i,"mnr_inv_sts_cd"));
					...
					if(comboObjects[1].GetSelectCode()== "SS"||comboObjects[1].GetSelectCode()== "HJ")
					{
						ComBtnEnable("btn_Save");
						ComBtnEnable("btn_Delete");
						ComBtnEnable("btn_Request");
	 		...
	 		case IBSAVE:        // Save
	          	if(validateForm(sheetObj,formObj,sAction)){
					...
					comboObjects[1].SetSelectCode(formObj.mnr_inv_sts_cd.value);
			...
			case IBSEARCH_ASYNC06:      //Reject
	          	if(validateForm(sheetObj,formObj,sAction)){	
					...
					formObj.f_cmd.value=MULTI;
					var sXml=sheetObj.GetSaveData("EES_MNR_S041GS.do", FormQueryString(formObj));
					comboObjects[1].SetSelectCode(formObj.mnr_inv_sts_cd.value);
					sheetObj.LoadSaveData(sXml);
				}	
				break;
...
//                    formObj.sheet2.LoadSearchData(sXml,{Sync:1} );
//					MnrRowDelete(form.sheet1, "Check");
//					//ComSheet2SheetCheck(formObj.sheet1, formObj.sheet2, "Check");
//					//formObj.sheet2.ColumnSort(PrefixSheet2+"Seq", "ASC")
//					for(var i=2; i <= (formObj.sheet2.RowCount()+ 1); i++){
//						if(formObj.sheet2.GetCellValue(i,PrefixSheet2+"mnr_wo_tp_cd") == "EST"){
//							formObj.sheet2.SetCellEditable(i,PrefixSheet2+"rpr_rslt_dt",true)
//						}
//					}
//
//					calcGamount();					
...
//				break;
				if(validateForm(sheetObj,formObj,sAction)){
					...
					var sXml=MnrGetDataSearchXml(sheetObjects[3]);
							...
							for(var j=0; j < comboList[i].length;j++){ 
								...
								//Repair Invoice Status Code
									...
									if(j == 0){      
										...
										comboObjects[1].SetSelectCode("NEW");
    ...
    function validateForm(sheetObj,formObj,sAction){
        with(formObj){
			if(sAction==IBSEARCH) { //Retrive
			    var cboCode=comboObjects[0].GetSelectCode();
				if(cboCode=="WI"){
				...
				if(currPrcsKnt=="0"){				
					...
					var bzcAmt=MnrMakeRound(parseFloat(formObj.bzc_amt.value.replace(/,/g,"")),2);
					var slsTaxAmt=MnrMakeRound(parseFloat(formObj.sls_tax_amt.value.replace(/,/g,"")),2);
					var vatAmt=MnrMakeRound(parseFloat(formObj.vat_amt.value.replace(/,/g,"")),2);
					var whldTaxAmt=MnrMakeRound(parseFloat(formObj.whld_tax_amt.value.replace(/,/g,"")),2);
					calAmt=MnrMakeRound(parseFloat(parseFloat(bzcAmt) + parseFloat(vatAmt) - parseFloat(whldTaxAmt)),2);  
					ttlAmt=MnrMakeRound(parseFloat(formObj.ttl_amt.value.replace(/,/g,"")),2);   
				}   							 					
				if(calAmt != ttlAmt ){	 			 
				...
				if(comboObjects[1].GetSelectCode()=="NEW"){
				...
				var	tot=0;
				for(var i=2; i <= (sheetObjects[4].RowCount()+ 1); i++){
					tot +=  sheetObjects[4].GetCellValue(i, PrefixSheet2+"inv_amt")*100; //parseFloat로 더할시 결과가  3998.0000000023 로 나오는 경우가 있어서
					if(sheetObjects[4].GetCellValue(i,PrefixSheet2+"mnr_wo_tp_cd") == "EST" && sheetObjects[4].GetCellValue(i,PrefixSheet2+"rpr_rslt_dt") == ""){
	...
	function setPopData_Sp(aryPopupData, Row, Col, SheetIdx) {
		...
		if ( aryPopupData.length > 0 ) {
			var idx=formObj.combo1.GetSelectIndex();
			if(idx=="0"){
	...
	function setInvoiceListValue() {
		var formObj=document.form;
		var kind=comboObjects[0].GetSelectCode();
		if(kind=="WI"){
		...
		ComSetObjValue(formObj.inv_sch_type_code, comboObjects[0].GetSelectCode());
	}	
	function setInvoiceListClear() {
		...
		sheetObjects[1].RemoveAll();
		sheetObjects[2].RemoveAll();
		comboObjects[0].SetSelectCode("WI");
		saveEndYN="";
		saveType="";
		invInfoClearYN="";
	}
	...
	function calcGamount() {
		...
		if(currPrcsKnt=="0"){	
			...
			if(sta=="")	sta="0.00";		
			var amt=MnrMakeRound(parseFloat(parseFloat(sheetObjects[4].GetSumValue(0,PrefixSheet2+"inv_amt")) + parseFloat(sta)),2);
	...
	function getEES_MNR_0143(rArray,ret_val){
		...
		ComSetObjValue(formObj.inv_sch_type_code, formObj.combo1.GetSelectCode());
		tabObjects[0].SetSelectedIndex(0);
		var sParam=ComGetSaveString(sheetObjects[5]);
		if (sParam == "") return;
		sParam += "&" + FormQueryString(formObj);
		var sXml=sheetObjects[3].GetSaveData("EES_MNR_S041GS.do", sParam);
		//currency별  소수점 가져오기	
	...
	function setGetRowBackColorChange(){
     ...
     function MnrGetDataSearchXml(sheet_obj)  {
      var rowXml="";
      var allXml="<?xml version='1.0'  ?>\n<SHEET>\n  <DATA TOTAL='"+ sheet_obj.GetTotalRows()+"'>\n";
	  var chk="";
			...
			switch(ComGetEvent("name")) {      
	    		...
	    		case "rcv_dt": 	  
	        		MnrChkDateValid(formObj.rcv_dt,"Receive DT");
				   	break; 	
	    		case "inv_no":  
	    			var invNo = checkInvoiceNo(sheetObj,formObj.inv_no.value,formObj.mnr_prnr_seq.value == "" ? formObj.ord_vndr_seq.value:formObj.mnr_prnr_seq.value,formObj.pay_inv_seq.value);
	    			if(invNo != null && invNo != ""){
