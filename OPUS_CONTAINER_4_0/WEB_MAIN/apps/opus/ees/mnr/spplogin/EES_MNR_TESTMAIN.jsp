...
<script language="javascript"> 
	function spp_login(){ 
		...
		document.location.href = 'apps/opus/ees/mnr/spplogin/EES_MNR_TESTSUB.jsp?loginType=' + loginType + '&vseq=' + vseq + '&ofcCd=' + ofcCd + '&user_id=' + user_id;
	}   	      
			   
	function mnr_login(){   
		var loginType = "MNR";
		document.location.href = 'apps/opus/ees/mnr/spplogin/EES_MNR_TESTSUB.jsp?loginType=' + loginType;
	}
</script> 
</head>    
<body> 
