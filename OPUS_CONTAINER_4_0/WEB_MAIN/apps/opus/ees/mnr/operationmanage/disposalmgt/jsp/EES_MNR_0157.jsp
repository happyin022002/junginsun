...
<%@ page import="com.clt.apps.opus.ees.mnr.operationmanage.disposalmgt.event.EesMnr0157Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EesMnr0157Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EesMnr0157Event)request.getAttribute("Event");
		...
		<div class="layout_vertical_2" style="width: 30%;" >
			<div class="opus_design_inquiry">
				<table>
					...
					<tr>
						<th>Status</th>
						<td><select name="status_cd" id="status_cd" style="width:100px">
	...
	<!-- layout_vertical_2(S) -->
		<div class="layout_vertical_2" style="width: 60%;">
			<table>
				...
				<tr>
					<th class="title_design">Disposal Information</th>
					<td>&nbsp;</td>
				</tr>
			</table>
			<div class="opus_design_inquiry">
				<table>
					...
					<tr>
						<th>Disposal No.</th>
						<td><input type="text" name="disp_no" id="disp_no" style="width:100px" value="" class="input2" readOnly></td>
						<th>Request DT</th>
						<td><input type="text" name="rqst_dt" id="rqst_dt" style="width:100px" value="" class="input2" readOnly></td>
						<th>Status</th>
						<td><script type="text/javascript">ComComboObject('disp_sts_cd', 1, 102, 1, 3,0,false,0);</script></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<th>EQ Type</th>
						...
						<th>Req Office</th>
						<td><input type="text" name="rqst_ofc_cd" id="rqst_ofc_cd" style="width:100px" value="" class="input2" readOnly></td>
						<th>Currency</th>
					...
					<tr>
						<th>Total Q'ty</th>
						<td><input type="text" name="disp_qty" id="disp_qty" style="width:100px;text-align:right" value="" class="input2" dataformat="num" readOnly></td>
						<th>Total AMT</th>
						<td><input type="text" name="disp_st_prc" id="disp_st_prc" style="width:100px;text-align:right" value="" class="input2" dataformat="float" pointcount="2" readOnly></td>
<!-- 						<td>&nbsp;</td> -->
...
<!-- 						<td>&nbsp;</td> -->
		...
		<div class="layout_vertical_2" style="width: 40%;">
			<table>
				...
				<tr>
					<th class="title_design">Buyer Selection</th>
					<td>&nbsp;</td>
				</tr>
			</table>
	...
	<div class="layout_wrap" style="width: 100%;">
		...
		<div class="layout_vertical_2" style="width: 62%;">
			<div class="opus_design_data">
				<table class="grid2" style="margin-top:42px;">
					<colgroup>
						<col width="80">
						<col width="*">
					</colgroup>
					<tr>
						<th>Remark(s)</th>
						<td><textarea name="mnr_disp_rmk" id="mnr_disp_rmk" wrap="off" style="width:100%;height:110px;resize:none;" maxLength="4000"></textarea></td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="layout_vertical_2" style="width: 35%;margin-left: 30px;">
			<table>
				...
				<tr>
					<th class="title_design">File Attachment</th>
					<td>&nbsp;</td>
				</tr>
			</table>
			<div class="opus_design_grid">
