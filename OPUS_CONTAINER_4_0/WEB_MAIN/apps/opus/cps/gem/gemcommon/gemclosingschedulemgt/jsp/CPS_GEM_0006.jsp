...
<%@ page import="com.clt.apps.opus.cps.gem.gemcommon.gemclosingschedulemgt.event.CpsGem0006Event"%>
			...
			<tr>
				...
				<table width="100%" id="mainTable">
					<tr>
						...
						<td width="40%"><script language="javascript">ComSheetObject('sheet2');</script></td>
					</tr>
				</table>
				<!-- Grid (E) -->
				</td>
