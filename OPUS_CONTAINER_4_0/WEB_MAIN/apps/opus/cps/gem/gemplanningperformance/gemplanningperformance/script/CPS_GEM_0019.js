...
function getBackEndJobLoadFileByYearly() {
	...
	if (sheet1.RowCount <= 0 ) {
		...
		if(condVal == "Y" && targetVal == "EI") {
			...
			//sheet1.SpeedDown2Excel(1,false,false,"","apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0019_04.xml",false,false,"Yearly Expense",true,columnSkipList);
			sheet1.SpeedDown2Excel(1,false,false,"","",false,false,"Yearly Expense",true,columnSkipList);
		} else {
			//sheet1.SpeedDown2Excel(1,false,false,"","apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0019_01.xml",false,false,"Yearly Expense",true,columnSkipList);
			sheet1.SpeedDown2Excel(1,false,false,"","",false,false,"Yearly Expense",true,columnSkipList);
		}
	}
}
...
function getBackEndJobLoadFileByRequestInitial() {
	...
	if (sheet2.RowCount <= 0 ) {
		...
		var columnSkipList = "";		
		//sheet2.SpeedDown2Excel(1,false,false,"","apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0019_02.xml",false,false,"Request Expense Initial",true,columnSkipList);
...
function getBackEndJobLoadFileByRequestRqstNo() {
	...
	if (sheet3.RowCount <= 0 ) {
		...
		var columnSkipList = "";		
		//sheet3.SpeedDown2Excel(1,false,false,"","apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/script/CPS_GEM_0019_03.xml",false,false,"Request Expense Detail",true,columnSkipList);
