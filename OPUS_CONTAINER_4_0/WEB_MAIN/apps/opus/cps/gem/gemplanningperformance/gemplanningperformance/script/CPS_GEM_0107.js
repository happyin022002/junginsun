...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class cps_gem_0107 : cps_gem_0107 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function cps_gem_0107() {
             ...
             case "sheet1":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					InitDataProperty(0, cnt++ , dtData,			40,		daCenter,		true,		"fm_to",				false,		"",			dfNone,			0,		false, false);
         ...
         switch(sAction) {
 			case IBSEARCH:      //조회
 				...
 				frm.f_cmd.value = SEARCH;
	  			...
	  			var sXml = sheet1.GetSearchXml("CPS_GEM_0107GS.do", FormQueryString(frm));
...
//		Rdviewer.ViewShowMode(0);
 	...
 	*/
 	function rdOpen(rdObject, formObject, param){
 		...
 		var rdParam = "/rp " + param + " /riprnmargin /rwait";
 		// 열고자 하는 RD 파일을 지정한다.
 		var strPath = RD_path+"apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0029.mrd";
 		//var strPath = "http://localhost:9001/opuscntr/"+"apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0029.mrd";
 		//alert(rdParam + "\n\n" + strPath);
