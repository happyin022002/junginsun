             ...
             case "sheet1":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					var HeadTitle1 = "|SLIP No.|Seq.|Office|SUB OFC|EXPN CD|SUB EXPN|EXPN NM|SUB EXPN NM|TIC|CUR|EFF DT|SLIP AMT|Expense|Performance|Ratio %|SLIP Description";
             ...
             case "sheet2":
                 with (sheetObj) {
                    ...
                    //전체Edit 허용 여부 [선택, Default false]
 					...
 					//var HeadTitle1 = "|SLIP NO.|SEQ|Office|EXPN CD|ABBR NM|TIC|CUR|EFF DT|SLIP AMT|Expense|Ratio %|SLIP Description";
 					var HeadTitle1 = "|SLIP NO.|SEQ|Office|SUB OFC|EXPN CD|SUB EXPN|ACCT CD|EXPN NM|SUB EXPN NM|TIC|CUR|EFF DT|SLIP AMT|SLIP VENDOR|Expense|Performance|Ratio %|SLIP Description";
                    var headCount = ComCountHeadTitle(HeadTitle1);
