...
<body onLoad="setupPage();">
	...
	<!--Page Title, Historical (S)-->
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">            
            ...
            <tr><td class="title"><img src="img/icon_title_dot.gif" align="absmiddle"><span id="title"> Approval of Requested expense</span></td></tr>
        </table>
        ...
        <table class="search" border="0" style="width:979;"> 
            ...
            <!--  Button_Sub (S) -->
                            ...
                            <td class="btn2_bg">
                                <table border="0" cellpadding="0" cellspacing="0"><tr>
                                    ...
                                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
                                        <tr><td class="btn2_left"></td>
                                        <td class="btn2" name="t3_btn2_Save">Save</td>
                                        <td class="btn2_right"></td>
                                        </tr>
                                        </table></td>                                        
                                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="button">
	        ...
	        <input type="hidden" name="fm_eng_abbr_nm">
                ...
                <tr class="h23">
                    ...
                    <td width="180"><input type="text" style="width:155;text-align:center;" class="input2" readonly="readonly" name="gen_expn_rqst_no">&nbsp;<img src="img/btns_search.gif" width="19" height="20" alt="" border="0" align="absmiddle" class="cursor"></td>
                ...
                <table class="search" border="0">
                    <tr class="h23">
                        ...
                        <td width="25">TIC</td>
                        <td><input type="text" name="fm_tic_cd" readonly="readonly" style="width:53;text-align:center;" class="input2" value="SELAGP"></td>
                    </tr>
                </table>
                <table class="search" border="0">
                    <tr class="h23">
...
&nbsp;&nbsp;<input type="checkbox"  value="Y" name="same_expn_cd" class="trans" disabled="disabled">Same Expense Code</td>
                ...
                <table class="search" border="0">
                    ...
                    <tr class="h23">
                        ...
                        <td width=""><textarea style="width:822;overflow: hidden;" rows="1" readonly="readonly" class="input2" rows="1" caption="Requester's Opinion" name="to_rqst_opin_rmk" maxlength="600"></textarea></td>
                        <td><img src="img/btns_note.gif" width="19" height="20" alt="" border="0" style="cursor: hand;"  align="absmiddle" onClick="showNote('D', 'C' ,'form1')"></td>
                    </tr>
                </table>
...
<!-- ============================================================================= -->
            ...
            <input type="hidden" name="rqst_ofc_cd">
                ...
                <table class="search" border="0">
                    <tr class="h23">
                        <td width="124">Calculation Basis</td>
                        <td width="837"><textarea style="width:831;overflow: hidden;" rows="1" class="input2" caption="Calculation Basis" readonly="readonly" maxlength="1300" caption="Calculation Basis" name="fm_gen_expn_calc_bss_desc"></textarea></td>
                        <td><img src="img/btns_note.gif" width="19" height="20" alt="" border="0" style="cursor: hand;"  align="absmiddle" onClick="showNote('F', 'B')"></td>
                    </tr>
                    <tr class="h23">
                        <td width="">Requester's Opinion</td>
                        <td width=""><textarea style="width:831;overflow: hidden;" readonly="readonly" rows="1" class="input2" rows="1"  caption="Requester's Opinion" name="fm_rqst_opin_rmk" maxlength="600"></textarea></td>
                        ...
                        <td width="280" valign="top">
                            <table width="100%" class="search_sm2"> 
                                <tr class="h23">                                         
                                    ...
                                    <td class="stm"><input type="radio" value="M" name="ei_fm_assign_rule" class="trans" disabled="disabled">Manual&nbsp;&nbsp;&nbsp;<input type="radio" value="A" name="ei_fm_assign_rule" class="trans">Auto</td> 
                                </tr>
                            </table> 
                            <table width="100%" class="search"> 
                                <tr class="h23">                                         
                                    <td width="20%">&nbsp;Month</td>                                         
                                    <td width="40%" class="stm">FM&nbsp;<select style="width:80;" class="input" name="fm_monthFrom">
                                        <option value="1" selected="selected">JAN</option>
                                        <option value="2">FEB</option>
                                        <option value="3">MAR</option>
                                        <option value="4">APR</option>
...
<!-- Grid BG Box  (S) -->
    ...
    <!--Button (E) -->
    <div style="display: none;"><script language="javascript">ComSheetObject('sheet7');</script></div>
<!-- 개발자 작업  끝 -->
