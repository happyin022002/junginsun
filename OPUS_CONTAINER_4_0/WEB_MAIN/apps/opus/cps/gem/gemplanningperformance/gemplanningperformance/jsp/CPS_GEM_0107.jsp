<%/*=========================================================
     ...
     *@FileName : cps_gem_0107.jsp
     *@FileTitle : [CPS_GEM-0107] Performance Inquiry_Transfer
     *Open Issues :
     *Change history :
...
<html>
<head>
<title>Performance Inquiry_Transfer</title>
		...
		<table class="search" id="mainTable"> 
       		<tr><td class="bg">
				...
				<table class="search_sm2" border="0" style="width:200;"> 
					<tr class="h23">
						<td><input type="radio" value="" class="trans" disabled>Additional&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="" class="trans" checked>Transfer</td>
					</tr>
				</table> 
				<table class="search" border="0" style="width:100%;"> 
				<tr class="h23">
					<td width="70">&nbsp;&nbsp;FM Office</td>
					<td width="70"><input type="text" style="width:50;" class="input" value="<%= fmOfcCd %>" readonly></td>
					<td width="110">FM Expense Code</td>
					<td width="70"><input type="text" style="width:50;" class="input" value="<%= fmGenExpnCd %>" readonly></td>
					<td width="60">TO Office</td>
					<td width="70"><input type="text" style="width:50;" class="input" value="<%= toOfcCd %>" readonly></td>
					<td width="110">TO Expense Code</td>
					<td width=""><input type="text" style="width:50;" class="input" value="<%= toGenExpnCd %>" readonly></td>
