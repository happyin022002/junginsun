 			...
 			switch(srcName) {
 				...
 				case "btn1_DownExcel":
 					if (sheet1.RowCount <= 0 ) {
 						...
 						sheet1.WaitImageVisible = true;
 						//sheet1.Down2Excel(1,false,false,true,"","",false,false,"Actual Results for Subsidiaries",false,"slp_perf_amt01");
 						sheet1.SpeedDown2Excel(1,false,false,"","",false,false,"Actual Results for Subsidiaries",false,"slp_perf_amt01");
 						sheet1.WaitImageVisible = false;
 					}
 					break;
             } // end switch
