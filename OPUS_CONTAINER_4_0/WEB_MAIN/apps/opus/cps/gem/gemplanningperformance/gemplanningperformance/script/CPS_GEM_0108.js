...
// 		Rdviewer.ViewShowMode(0);
 	...
 	*/
 	function rdOpen(rdObject, formObject, param){
 		...
 		var rdParam = "/rp " + param + " /riprnmargin /rwait";
 		// 열고자 하는 RD 파일을 지정한다.
 		var strPath = RD_path+"apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0030.mrd";
 		//var strPath = "http://localhost:9001/opuscntr/"+"apps/opus/cps/gem/gemplanningperformance/gemplanningperformance/report/CPS_GEM_0030.mrd";
 		//alert(rdParam + "\n\n" + strPath);
