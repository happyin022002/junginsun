	...
	*/ 
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case "sheet1": //sheet1 init
		    with(sheetObj){
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
			             ...
			             {Type:"Text",      Hidden:0,  Width:0,    Align:"Center",  ColMerge:1,   SaveName:"cgo_clm_ref_bl_no",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		...
		case "sheet2": //sheet2 init
		    with(sheetObj){
			      ...
			      InitHeaders(headers, info);
			      var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
			             {Type:"Seq",       Hidden:0, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"seq",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Text",      Hidden:0,  Width:0,    Align:"Center",  ColMerge:1,   SaveName:"cgo_clm_ref_cntr_no",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	...
	function doActionIBSheet(sAction) {
		if (sAction == SEARCHLIST01) {
			...
			var sXml=sheet3.GetSearchData("CPS_CNI_0034GS.do",
			...
			var sXml=sheet2.GetSearchData("CPS_CNI_0010GS.do", FormQueryString(frm),"",true);
			var arrXml=sXml.split("|$$|");
			if (arrXml.length > 0) {
