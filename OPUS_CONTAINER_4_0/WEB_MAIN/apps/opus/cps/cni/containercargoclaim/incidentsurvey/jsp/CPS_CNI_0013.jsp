...
<%@page import="com.clt.apps.opus.cps.cni.containercargoclaim.incidentsurvey.event.CpsCni0013Event"%>
<%@page import="com.clt.apps.opus.cps.cni.common.CniUtil"%>
<%@page import="com.clt.framework.component.util.io.HttpUtil"%>
<%
	CpsCni0013Event event = null;
    ...
    try
    {
        ...
        event = (CpsCni0013Event) request.getAttribute("Event");
	...
	<div class="opus_design_inquiry wFit">
		<table>
		   ...
		   <tbody>
		   		<tr>
					...
					<td><input type="text" style="width:76px;text-align:center" name="upd_dt1" value="" class="input2" readonly id="upd_dt1" /> </td>
					<th>Incident No.</th>
					...
					<th>VOC No.</th>
					<td><input type="text" style="width:100%;text-align:center" name="crm_voc_no" value="" class="input2" readonly id="crm_voc_no" /> </td>
		   		</tr>
		   		...
		   		<th>Status</th>
					...
					<td><input type="text" style="width:95px;text-align:center" name="clm_tm_bar_dt" value="" class="input2" readonly id="clm_tm_bar_dt" /> </td>
					<th>Summons Served Date</th>
					<td><input type="text" style="width:100%;text-align:center" name="smns_sve_date" value="" class="input2" readonly id="smns_sve_date" /> </td>
		   		</tr>
		   		...
		   		<th title="Type of Claim">TOC</th>
					...
					<th> Cargo</th>
					<td><input type="text" style="width:53px;text-align:center" name="clm_cgo_tp_cd" value="" class="input2" readonly id="clm_cgo_tp_cd" /><input type="text" style="width:115px;" name="cgo_qlty_desc" value="" class="input2" readonly id="cgo_qlty_desc" /> </td>
					<th> Claim Amount</th>
					<td colspan="3"><input type="text" style="width:165px;text-align:right" name="clmt_usd_amt" value="" class="input2" readonly dataformat="float" id="clmt_usd_amt" />USD</td>
		   		</tr>
		   		...
		   		<th>Lane</th>
					...
					<td colspan="3"><input type="text" style="width:100%;text-align:center" name="insur_ref_no" value="" class="input2" readonly id="insur_ref_no" /> </td>
		   		</tr>
		   </tbody>
		</table>
		</div>
		...
		<table style="width:1230px">
		   ...
		   <tbody>
		   		<tr>
		   		<th>Salvager</th>
					<td><input type="hidden" style="width:80px;" name="clm_pty_no" value="" class="input1" required="" caption="Salvager" id="clm_pty_no" /> <input type="text" style="width:80px;" name="clm_pty_abbr_nm2" value="" class="input1" readonly required="" caption="Salvager" id="clm_pty_abbr_nm2" /><button type="button" id="btns_salvager" name="btns_salvager" class="input_seach_btn"></button><input type="text" style="width:220px;" name="pty_nm" value="" class="input2" readonly id="pty_nm" /><button class="btn_etc" name="btns_style" id="btns_style" type="button">Style</button></td>
					<th>SL Ref No.</th>
					<td><input type="text" style="width:100px;text-align:center;ime-mode:disabled" name="ref_slv_no" value="" class="input" maxlength="20" id="ref_slv_no" /><button class="btn_etc" name="btn1_File_Upload" id="btn1_File_Upload" type="button">File Upload</button></td>
		   		</tr>
	
		   		<tr>
		   			<th>Salvaged Date</th>
					<td><input type="text" style="width:76px;text-align:center" name="slv_dt" value="" class="input" dataformat="ymd" maxlength="10" id="slv_dt" /><button type="button" id="btns_date_cal1" name="btns_date_cal1" class="calendar ir"></button></td>
					<th>SL Updater</th>
					<td><input type="text" style="width:68px;text-align:center" name="upd_usr_id" value="" readonly class="input2" id="upd_usr_id" /> </td>
					<th>SL DOU</th>
					<td><input type="text" style="width:80px;text-align:center" name="upd_dt2" value="" readonly class="input2" id="upd_dt2" /> </td>
		   		</tr>

		   		<tr>
		   			<th>Salvage Amount</th>
					<td><input type="text" style="width:150px;text-align:right;ime-mode:disabled" class="input" name="slv_locl_amt" value="" dataformat="float" maxlength="19" pointcount="2" caption="Salvage Amount" id="slv_locl_amt" /><input type="text" style="width:38px;" class="input" name="slv_locl_curr_cd" value="" maxlength="3" minlength="3" id="slv_locl_curr_cd" dataformat="enguponly" /><button type="button" id="btns_currency" name="btns_currency" class="input_seach_btn"></button></td>
					<th title="Rate of Exchange">R.O.E</th>
					<td><input type="text" style="width:80px;text-align:right;ime-mode:disabled" class="input" name="slv_xch_rt" value="" dataformat="float" maxlength="12" pointcount="5" caption="R.O.E" id="slv_xch_rt" /><button type="button" id="btns_roe" name="btns_roe" class="input_seach_btn"></button><input type="text" style="width:146px;text-align:right;ime-mode:disabled" class="input2" name="slv_usd_amt" value="" dataformat="float" maxlength="19" pointcount="2" readonly id="slv_usd_amt" />   USD</td>
		   		</tr>
		   </tbody>
		</table>
...
<div class="wrap_result wFit">
	...
	<div class="opus_design_grid">
		<h3 class="title_design mar_btm_8">DV & Result</h3>
		<textarea name="slv_desc" caption="DV & Result" style="width:101%;ime-mode:disabled" rows="20" class="textarea1" required></textarea>
	</div>
</div>
