	...
	<div class="wrap_search">
		<div class="opus_design_inquiry wFit">
			...
			<tr class="h23">
				...
				<td width="200px"><input type="text" style="width:230px;" value="<%=insur_tp_nm%>" class="input2"></td>
				<th width="79px">&nbsp;&nbsp;Policy Year</th>
				<td width=""><input type="text" style="width:49px;text-align:center" value="<%=insur_plcy_yr%>" class="input2"></td>
			</tr>
			<tr class="h23">
				<% if (pop_cont_col.equals("int_desc") || pop_cont_col.equals("subj_mat_ins_desc")) { %>
				<th width="" colspan="4">&nbsp;&nbsp;<%=pop_title%></th>
				<% } else { %>
				<th width="131px">&nbsp;&nbsp;<%=pop_title%></th>
