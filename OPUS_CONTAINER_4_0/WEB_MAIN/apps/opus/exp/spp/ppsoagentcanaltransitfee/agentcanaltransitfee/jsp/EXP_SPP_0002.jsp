...
<%@ page import="com.clt.apps.opus.exp.spp.ppsoagentcanaltransitfee.agentcanaltransitfee.event.ExpSpp0002Event"%>
...
<%
	...
	try {
		...
		//Getting the set request values from the main page.
...
<!-- The receiving value from the opener -->
...
<!-- Saving ADV Payment Status after retrieving -->
		...
		<table class="search"> 
       	<tr><td class="bg">
				...
				<tr class="h23">
					...
					<td width="180">ADV Payment Rev. Month</td>
					...
					<td width="180">ADV. Payment TTL Amount</td>
