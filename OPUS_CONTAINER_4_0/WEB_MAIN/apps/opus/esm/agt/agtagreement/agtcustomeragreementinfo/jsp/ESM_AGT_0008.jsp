...
*@FileTitle : FAC Agreement Rate Creation/Inquiry
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
<%
        ...
        String modYn = "N";                                                     //Possible to Mofify or not

        String strErrMsg = "";                                                  //error message
        String tmpGrpTp = "";                                                   //Location Type
        String tmpFacDiv = "";                                                  //Type 
        String tmpFacTp = "";                                                   //Charge Type 
        String tmpRcvTerm = "";                                                 //Received Term 
        String tmpDelTerm = "";                                                 //Delivery Term 
        ...
        String facTpCode = "";                                                  //Charge Type Code
        String facTpText = "";                                                  //Charge Type Text
        String rcvTermCode = "*|";                                              //Received Term Code
        String delTermCode = "*|";                                              //Delivery Term Code
