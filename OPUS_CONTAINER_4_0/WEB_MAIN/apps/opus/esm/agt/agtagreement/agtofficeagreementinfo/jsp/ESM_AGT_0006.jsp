...
*@FileTitle : Region/Location Retrieve and multiple Optional(Pop-up)
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier :
...
<%@ page import="com.clt.apps.opus.esm.agt.agtagreement.agtofficeagreementinfo.event.EsmAgt0006Event"%>
...
<html>
<head>
<title>지역/점소 Retrieve 및 다중 Optional(Pop-up)</title>
...
<tr><td valign="top">
		...
		<tr><td class="title"><img src="/opuscntr/img/ico_t1.gif" width="20" height="12">Geographic / Office Code</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
