...
*@FileTitle : Container type size를 Retrieve 및 다중 Optional(Pop-up)
*Open Issues :
*Change history :
...
<%@ page import="com.clt.apps.opus.esm.agt.agtagreement.agtofficeagreementinfo.event.ESM_AGT_004Event"%>
<%@ page import="com.clt.apps.opus.esm.agt.agtagreement.agtofficeagreementinfo.event.ESM_AGT_004EventResponse"%>
