			...
			switch(srcName) {
                case "cnt_btn":
                	...
                	{                	        
            		    ...
            		    if(chkStr == "1,0") {
            		    	ComOpenPopup('/opuscntr/ESM_AGT_0044.do' + param, 780, 540, 'getESM_AGT_001_1', v_display, true);
            		    }else {
			...
			case 2:      //sheet1 init
				with (sheetObj) {
				   ...
				   //Edit kind [Optional, Default false]
					...
					InitDataProperty(0, cnt++ , dtCombo,      80,    daCenter,   true,    "ofc_chr_lvl",     true,          "",       dfNone,          0,     false,       false);
			...
			case 3:      //sheet3 init
				with (sheetObj) {
				   ...
				   //Edit kind [Optional, Default false]
					...
					InitDataValid(0, "fx_comm_amt", vtNumericOther, ".");//Number and .
					InitDataValid(0, "bkg_comm_rt", vtNumericOther, ".");//Number and .
