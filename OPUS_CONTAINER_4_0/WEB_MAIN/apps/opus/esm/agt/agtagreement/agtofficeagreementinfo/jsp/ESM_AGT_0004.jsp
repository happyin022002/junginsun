...
<%@ page import="com.clt.apps.opus.esm.agt.agtagreement.agtofficeagreementinfo.event.EsmAgt0004Event"%>
...
<table width="600" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<table width="580" border="0">
			<tr>
				<td class="title"><img src="/opuscntr/img/ico_t1.gif" width="20" height="12">CNTR Type Size List</td>
			</tr>
		</table>
		<!-- : ( Title ) (E) -->
		<!--Button_L (S) -->
