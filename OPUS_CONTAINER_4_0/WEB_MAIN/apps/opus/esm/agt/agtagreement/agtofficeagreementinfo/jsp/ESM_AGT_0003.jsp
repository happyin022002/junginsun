                            	...
                            	<td width="240" valign="top">
									...
									<table style="width:240;" class="search">
                                    	<tr class="h23">
                                        	...
                                        	<td><input type="hidden" style="width:45;" name="vndr_cnt_cd" readonly><input class="input1" type="text" style="width:60;" name="vndr_seq" readonly >&nbsp;<img class="cursor" src="/opuscntr/img/button/btns_search.gif" width="19" height="20" border="0" align="absmiddle" name="cnt_btn"></td>
                                    	</tr>
                                        <tr class="h23">
                                        	<td>Agreement No.</td>
                        		...
                        		<td class="btn2_bg">
                        			<table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
											...
											<td valign="top"><a OnClick="JavaScript:expandSheet();"><img class="cursor" src="/opuscntr/img/bt_mnopen_off.gif" height="14" border="0" name="col_hidden"></a></td>
											<!-- Repeat Pattern -->
										</tr>
									</table>
                                </td>
