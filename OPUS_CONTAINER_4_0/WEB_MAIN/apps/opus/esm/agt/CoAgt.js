 // AGT 추가 메세지
	...
	**/
	function checkCustomer(str) {
        ...
        if( cust_cnt_cd.length <= 0 || cust_seq.length <= 0 || isNaN(cust_seq) || containsCharsOnly(cust_cnt_cd, chars) == false ){//|| isNumber(cust_seq) == false ){//containsCharsOnly2(cust_cnt_cd, chars) == false ||
		    return false;
		}
