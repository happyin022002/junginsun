...
*@FileTitle : Brokerage Detail & History fo BL Pop-up 
*Open Issues :
*Change history :
*@LastModifyDate : 
*@LastModifier : 
...
<%@ page import="com.clt.apps.opus.esm.agt.agtaudit.brkgaudit.event.EsmAgt0014Event"%>
...
try {
	...
	//Receiving parameters from ESM_AGT_0013 
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp; Brokerage Details & History for B/L</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!--Button_L (S) -->
