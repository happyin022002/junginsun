...
<%@ page import="com.clt.apps.opus.esm.agt.agtaudit.agtaudit.event.EsmAgt0010Event"%>
...
<input type="hidden" name="param1"> <!-- ComboUtil codeItem -->
<input type="hidden" name="param2"> <!-- All Display Flag(Y, N, [All]) -->
				...
				<table class="search_in" border="0">
					<tr class="h23">
						...
						<td align="right"><input type="text" name="search_dt_fr" style="width:75;ime-mode:disabled" dataformat="ymd" OnBeforeDeactivate="ComAddSeparator(this)" OnBeforeActivate="ComClearSeparator(this)" maxlength="10">&nbsp;<img
							class="cursor" src="/opuscntr/img/button/btns_calendar.gif"
