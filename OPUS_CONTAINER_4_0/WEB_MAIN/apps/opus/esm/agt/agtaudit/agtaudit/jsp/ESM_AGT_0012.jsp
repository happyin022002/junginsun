...
<%@ page import="com.clt.apps.opus.esm.agt.agtaudit.agtaudit.event.EsmAgt0012Event"%>
<%
...
<input type="hidden" name="bl_no"  value="<%=blNo%>">	<!-- Parameters from ESM_AGT_011 : B/L No -->
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp; Deduction Details for B/L</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!-- Search BG (S) -->
						...
						<table class="search" border="0">
							<tr>
								<td width="600" valign="top">
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/opuscntr/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Rating</td>
										</tr>
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/opuscntr/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Total</td>
										</tr>
										<tr><td height="5"></td></tr>
									</table>
								...
								<td valign="top">
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/opuscntr/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Deducted Charge</td>
										</tr>
										<tr><td height="5"></td></tr>
									</table>
									<table width="100%" id="mainTable">
									...
									<table class="search">
										<tr>
											<td class="gray_tit"><img src="/opuscntr/img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;Deducted Transportation Cost</td>
										</tr>
										<tr><td height="5"></td></tr>
									</table>
									<table width="100%" id="mainTable" >
