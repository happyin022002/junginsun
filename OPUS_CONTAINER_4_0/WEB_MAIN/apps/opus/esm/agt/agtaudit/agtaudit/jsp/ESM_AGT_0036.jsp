...
<%@ page import="com.clt.apps.opus.esm.agt.agtaudit.agtaudit.event.EsmAgt0036Event"%>
...
<!-- Hidden parameters from (ESM_AGT_010, ESM_AGT_016) -->
<input type="hidden" name="scn_id">	<!-- Commission type -->
...
<input type="hidden" name="exp_type">	<!-- Other Commission General(512691) or General Exception(512692,512693) -->
	...
	<tr>
		<td valign="top">
			...
			<table width="100%" border="0">
				<tr>
					<td height="79" class="title"><img src="/opuscntr/img/icon_title_dot.gif" align="absmiddle">&nbsp; Agent Commission Audit</td>
				</tr>
			</table>
			<!-- : ( Title ) (E) -->
			<!--Button_L (S) -->
