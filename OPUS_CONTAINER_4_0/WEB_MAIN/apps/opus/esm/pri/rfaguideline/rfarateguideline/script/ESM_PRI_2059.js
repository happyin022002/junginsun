...
//                }
    ...
    function initSheet(sheetObj, sheetNo) {
        ...
        case 1: // sheet1 init
            ...
            var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
             ...
             {Type:"Float",     Hidden:0,  Width:100,  Align:"Right",   ColMerge:0,   SaveName:"frt_rt_amt",                 KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:1,   InsertEdit:1,   EditLen:9 } ];
    ...
    function sheet1_OnDblClick(sheetObj, Row, Col) {
        ...
        if (colName == "prc_cmdt_def_nm") {
            ...
            ComOpenPopup(sUrl, 600, 345, "findCommodity", "1,0,1,1,1,1,1", true);
            ...
            ComOpenPopup(sUrl, 700, 310, "findLocation_org", "1,0,1,1,1,1,1", true);
        } else if (colName == "dest_rout_pnt_loc_def_nm") {
            var sUrl="/opuscntr/ESM_PRI_4026.do?" + FormQueryString(document.form);
            sUrl += "&group_cmd=" + PRI_RG + "&location_cmd=LG&loc_tp_cd=L&org_dest_cd=D";
            sUrl += "&loc_def_nm=" + sheetObj.GetCellValue(Row, Col);
            ComOpenPopup(sUrl, 700, 310, "findLocation_dest", "1,0,1,1,1,1,1", true);
        }
    }
    
    function findCommodity(rtnVal) {
    	if (rtnVal != null){
    		_tmp_sheetObject.sheet.SetCellValue(_tmp_sheetObject.row, "prc_cmdt_def_cd", rtnVal.cd, 0);
    		_tmp_sheetObject.sheet.SetCellValue(_tmp_sheetObject.row, "prc_cmdt_def_nm", rtnVal.nm, 0);
    	}
    }
    function findLocation_org(rtnVal) {
    	if (rtnVal != null){
    		_tmp_sheetObject.sheet.SetCellValue(_tmp_sheetObject.row, "org_rout_pnt_loc_def_cd", rtnVal.cd, 0);
    		_tmp_sheetObject.sheet.SetCellValue(_tmp_sheetObject.row, "org_rout_pnt_loc_def_nm", rtnVal.nm, 0);
    	}
    }
    function findLocation_dest(rtnVal) {
    	if (rtnVal != null){
    		_tmp_sheetObject.sheet.SetCellValue(_tmp_sheetObject.row, "dest_rout_pnt_loc_def_cd", rtnVal.cd, 0);
    		_tmp_sheetObject.sheet.SetCellValue(_tmp_sheetObject.row, "dest_rout_pnt_loc_def_nm", rtnVal.nm, 0);
    	}
    }
    ...
    function doActionIBSheet(sheetObj, formObj, sAction) {
        ...
        case IBSAVE: // Save
            ...
            sheetObj.DoSave("ESM_PRI_2059GS.do", FormQueryString(formObj), -1, false);
            ComOpenWait(false);
            break;
        }
    }
        ...
        switch (sAction) {
            case IBSEARCH_ASYNC01: // Check
                ...
                for (var i = sheetObj.HeaderRows(), n = sheetObj.HeaderRows()+sheetObj.RowCount() ; i < n; i++) {
                    ...
                    if (perTypeCode != "" || cargoTypeCode != "" || rateAmt !== "") {
                        chkMdtryRate=true;
                        if (perTypeCode == "") {
                ...
                var sXml=sheetObject2.GetSearchData("ESM_PRI_2059GS.do", sParam);
