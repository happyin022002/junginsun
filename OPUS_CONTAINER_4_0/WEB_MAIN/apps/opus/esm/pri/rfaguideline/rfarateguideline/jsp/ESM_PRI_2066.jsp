...
*@FileName 	 : ESM_PRI_2066.jsp
*@FileTitle  : RFA Guideline Creation - Rate [Load Excel] (H Type)
*@author     : CLT
*@version    : 1.0
*@since      : 2014/09/25
=========================================================*/
...
<%@ page import="com.clt.apps.opus.esm.pri.rfaguideline.rfarateguideline.event.EsmPri2066Event"%>
...
<%
    EsmPri2066Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri2066Event) request.getAttribute("Event");
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span>Rate Creation - Excel Import (Horizontal)</span></h2>
