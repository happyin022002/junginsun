...
<%@ page import="com.clt.apps.opus.esm.pri.rfaguideline.rfaarbitrarychargeguideline.event.EsmPri201803Event"%>
...
<%
	EsmPri201803Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri201803Event)request.getAttribute("Event");
...
<div>
	<!-- opus_design_btn (S) -->
	<div class="opus_design_btn opus_design_normal2" style="padding-right:0; padding-bottom:10px">
