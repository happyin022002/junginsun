...
<%@ page import="com.clt.apps.opus.esm.pri.rfaguideline.rfaarbitrarychargeguideline.event.EsmPri200103Event"%>
...
<%
	EsmPri200103Event  event = null;			//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri200103Event)request.getAttribute("Event");
...
<div class="opus_design_grid" id="mainTable">
	...
	<div class="grid_option_left">
		<table>
			...
			<tr>
				<th class="sm">Type</th>
				<td class="sm" style="padding-left:15px;"><input type="radio" name="org_dest_tp_cd" value="O" class="trans" checked>&nbsp;<span id="org_dest_tp_cd1">Origin Arbitrary</span></td> 
				<td class="sm"><input type="radio" name="org_dest_tp_cd" value="D" class="trans">&nbsp;<span id="org_dest_tp_cd2">Destination Arbitrary</span></td>
				<td></td> 
			</tr>
		</table>
	</div>
