...
<%@ page import="com.clt.apps.opus.esm.pri.surcharge.surchargegrouplocation.event.EsmPri4004Event"%>
<%@ page import="com.clt.syscommon.common.table.PriScgGrpLocVO"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmPri4004Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri4004Event)request.getAttribute("Event");
...
<input name="etc1" type="hidden" value="" id="etc1" />
	...
	<div class="layer_popup_title">
		...
		<div class="page_title_area clear">	
			<h2 class="page_title"><span id="titles">Surcharge Location Group Creation</span></h2>
	...
	<div class="layout_wrap" style="width: 100%">
		<div class="layout_vertical_2 pad_rgt_8" style="width: 40%">
			<div class="opus_design_grid" id="mainTable">
				...
				--><button type="button" class="btn_accent" name="btn_del" id="btn_del">Delete</button><!--  
				--></div>
	   	...
	   	<div class="layout_vertical_2" style="width: 60%">
			<div class="opus_design_grid" id="mainTable">
				...
				--><button type="button" class="btn_accent" name="btn_del2" id="btn_del2">Delete</button><!--  
				--></div>
