...
<%@ page import="com.clt.apps.opus.esm.pri.scguideline.scrateguideline.event.EsmPri0105Event"%>
...
<input type="hidden" id="svc_scp_cd"    name="svc_scp_cd"    value="<%=svcScpCd    %>">
<input type="hidden" id="gline_seq"     name="gline_seq"  value="<%=glineSeq    %>">
<input type="hidden" id="prc_cust_tp_cd"  name="prc_cust_tp_cd" value="<%=prcCustTpCd %>">
<input type="hidden" id="cmdt_hdr_seq"  name="cmdt_hdr_seq"  value="<%=cmdtHdrSeq  %>">
<input type="hidden" id="rout_seq"  name="rout_seq"      value="<%=routSeq     %>">

<div class="layer_popup_title">
<!-- page_title_area(S) -->
<div class="page_title_area clear">
   <!-- page_title(S) -->
	<h2 class="page_title"><span>Rate Guideline Inquiry - Route Note</span></h2>
	<!-- page_title(E) -->
	<!-- opus_design_btn(S) -->
