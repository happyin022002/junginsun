...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scrateproposal.event.EsmPri0091Event"%>
...
<input type="hidden" name="lgcy_if_flg" value="<%=StringUtil.xssFilter(request.getParameter("lgcy_if_flg")) %>" id="lgcy_if_flg" />
<div class="layer_popup_title">
	<!-- page_title_area(S) -->
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>Commodity Note Creation</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
