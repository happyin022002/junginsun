...
*@FileName   : ESM_PRI_0117.js
*@FileTitle  : Amendment History - Rate (Direct Call)
*@author     : CLT
*@version    : 1.0
*@since      : 2014/09/05
=========================================================*/
...
//ESM_PRI_0057_06
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
	      ...
	      var HeadTitle="|prop_no|amdt_seq|svc_scp_cd|gen_spcl_rt_tp_cd|cmdt_hdr_seq|rout_seq|Direct Call|EFF Date|EXP Date|Source Code|Source|Status Code|Status|n1st_cmnc_amdt_seq|Accept Staff/Team|Accept Date|Accept User";
	      ...
	      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
	             ...
	             {Type:"Combo",     Hidden:0, Width:80,   Align:"Center",  ColMerge:0,   SaveName:"dir_call_flg",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:2 },
...
//            }
			...
			case IBSEARCH: // parent sheet에서 조회
				...
				var sXml=window.parent.getSheetXml(10);
