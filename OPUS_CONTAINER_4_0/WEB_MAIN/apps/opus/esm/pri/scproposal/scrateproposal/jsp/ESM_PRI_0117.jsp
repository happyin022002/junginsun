...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scrateproposal.event.EsmPri0117Event"%>
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span>Amendment History - Rate (Direct Call)</span></h2>
