...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scrateproposal.event.EsmPri0098Event"%>
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		...
		<h2 class="page_title"><span>S/C Proposal General/Special Rate - Route Note Inquiry</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
