...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scgricalculationproposal.event.EsmPri0081Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
    EsmPri0081Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri0081Event) request.getAttribute("Event");
		...
		<div class="opus_design_inquiry wFit">
			<table> 
                <tr>
                    ...
                    <input type="radio" id="cmdtActcustTp1" name="cmdtActcustTp" value="0" class="trans">&nbsp;Commodity&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" id="cmdtActcustTp2" name="cmdtActcustTp" value="1" class="trans">&nbsp;Actual Customer</td>
               	</tr>
            </table>
		</div>
	</div>
