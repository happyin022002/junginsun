...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scgricalculationproposal.event.EsmPri0066Event"%>
...
<input type="hidden" id="gri_grp_seq" name="gri_grp_seq"> 
<input type="hidden" id="gri_appl_flg" name="gri_appl_flg">
