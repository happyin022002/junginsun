...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0100Event"%>
	...
	<div class="wrap_result">
		...
		<div class="opus_design_inquiry">
			<table class="grid2">
				...
				<tbody>
					<tr>
						<td class="noinput2"><textarea name="note_ctnt" id="note_ctnt" style="height: 90px; width: 100%; font-size: 9pt;resize:none;" class="noinput2" readonly="true"></textarea></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div class="opus_design_grid">
			...
			<!-- opus_design_grid(S) -->
			<div class="layout_vertical_2"  style="text-align: left; width: 60%">
				<div class="opus_design_btn">
