...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0033Event"%>
...
<%
	EsmPri0033Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0033Event)request.getAttribute("Event");
		...
		routSeq 		= JSPUtil.getNull(request.getParameter("rout_seq"));
		routNoteSeq 	= JSPUtil.getNull(request.getParameter("rout_note_seq"));
...
<input type="hidden" name="rout_note_seq" value="<%=routNoteSeq%>" id="rout_note_seq" />
...
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><span>Route Note Conversion</span></h2>
	<!-- page_title(E) -->
	
	<!-- opus_design_btn (S) -->
	<div class="opus_design_btn">
		<button class="btn_accent" id="btn_retrieve" type="button" name="btn_retrieve">Retrieve</button>
		<button class="btn_normal" id="btn_save" type="button" name="btn_save">Save</button>
...
<div class="wrap_result">
	...
	<div class="opus_design_data">
		<table>
		   <tbody>
		   		<tr>
		   			<td><textarea id="note_ctnt" name="note_ctnt" id="note_ctnt" style="width:100%; height:90px; resize:none;" class="textarea2" readonly="true"></textarea></td>
                </tr>
		   </tbody>
		</table>
		...
		<div class="opus_design_grid">
			<div class="wrap_layout">
				...
				<div class="layout_vertical_2" style="text-align: right; width: 60%">
				    ...
				    --><button class="btn_normal" id="btn_copy" type="button" name="btn_copy">Copy</button><!--
					--><button class="btn_normal" type="button" id="btn_paste" name="btn_paste">Paste</button><!-- 
					...
					--><button class="btn_normal" id="btn_rowcopy" type="button" name="btn_rowcopy">Row Copy</button><!--
					--><button class="btn_normal" id="btn_delete" type="button" name="btn_delete">Delete</button><!--
					--></div>
					<!-- opus_design_btn (E) -->
				</div>
