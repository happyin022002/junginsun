...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0101Event"%>
...
<%
	EsmPri0101Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0101Event)request.getAttribute("Event");
	...
	<div class="wrap_result">
		...
		<div class="opus_design_data">
			<table class="grid_2">
				...
				<tbody>
					<tr>
						<td><textarea name="note_ctnt" id="note_ctnt" style="width: 100%; height: 90px; resize:none;"class="textarea2" readonly="true"></textarea></td>
					</tr>
				</tbody>
			</table>
