...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0032Event"%>
...
<%
	EsmPri0032Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri0032Event)request.getAttribute("Event");
...
<div class="page_title_area clear">
	...
	<!-- page_title(S) -->
	<h2 class="page_title"><span>Special Note Conversion</span></h2>
	<!-- page_title(E) -->
...
<div class="wrap_result">
	...
	<div class="layout_wrap">
	   <!-- layout_flex_fixed(S) -->
	   <div class="layout_flex_fixed" style="width:350px"> <!-- setting : FIXED width(300px) -->
	       <!-- opus_design_grid(S) -->
	   ...
	   <!-- layout_flex_fixed(E) -->
	   <!-- layout_flex_fixed(S) -->
	   <div class="pad_left_8 layout_flex_fixed" style="width:30px"> <!-- setting : FIXED width(300px) -->
	       <table><tr><td style="padding-top:40px;"><button type="button" class="btn_right"></button></td></tr></table>
	   </div>
	   <!-- layout_flex_fixed(E) -->
	   <!-- layout_flex_flex(S) -->
	   <div class="layout_flex_flex" style="padding-left:388px"> <!-- (fixed Width) + (padding 8px) = 608 -->
	        <!-- opus_design_grid(S) -->
	       <div class="opus_design_grid">
	...
	<div class="opus_design_data"  style="margin-top:30px">
		<table>
		   <tbody>
		   		<tr>
		   			<td><textarea id="note_ctnt" name="note_ctnt" id="note_ctnt" style="width:100%; height:90px; maxlength:2000; resize:none;" class="textarea2" readonly="true"></textarea></td>
		   		</tr>
		   </tbody>
		</table>
		<table class="line_bluedot"><tr><td height="23"></td></tr></table>
	</div>
	...
	<div class="opus_design_grid">
		<table>
		   ...
		   <tbody>
		   		<tr>
		   			<th class="pad_btm_4">C/TYPE</th>
					<td class="pad_btm_4"><script type="text/javascript">ComComboObject("note_chg_tp_cd", 1, 130, 1, 1, 0, false);</script></td>
					<td>
						<!-- opus_design_btn (S) -->
						<div class="opus_design_btn">
