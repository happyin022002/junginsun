...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scnoteconversionproposal.event.EsmPri0052Event"%>
...
<input type="hidden" name="rout_note_seq" value="<%=StringUtil.xssFilter(request.getParameter("rout_note_seq")) %>" id="rout_note_seq" />
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span>Route Note Conversion - Inquiry</span></h2>
...
<div class="layer_popup_contents">
	<div class="wrap_result">
		...
		<div class="opus_design_data wFit">
			<table>
				<tr>
					<td><textarea name="note_ctnt" id="note_ctnt" style="width:100%; height: 90px;resize:none;" class="textarea2" readonly></textarea></td>
				</tr>
			</table>
		</div>
