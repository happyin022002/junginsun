...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.sctransportationadditionalchargeproposal.event.EsmPri000305Event"%>
...
<%
		EsmPri000305Event  event = null;					//PDTO(Data Transfer Object including Parameters)
		...
		try {
		   	SignOnUserAccount account=(SignOnUserAccount)session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
				...
				event = (EsmPri000305Event)request.getAttribute("Event");
...
<div class="opus_design_grid" id="mainTable">
	...
	<div class="grid_option_left">
		<table>
			<tbody>
				<tr>
					<th width="60" class="sm">Type</th>
					<td class="sm">
						<input type="radio" name="org_dest_tp_cd" value="O" checked><span id="org_dest_tp_cd1">  Origin IHC</span>
						<input type="radio" name="org_dest_tp_cd" value="D"><span id="org_dest_tp_cd2">  Destination IHC</span></td>
					<td></td>
				</tr>
			</tbody>
		</table>
