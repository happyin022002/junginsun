...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.sctransportationadditionalchargeproposal.event.EsmPri0024Event"%>
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>Origin/Destination Arbitrary - Excel Import</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
