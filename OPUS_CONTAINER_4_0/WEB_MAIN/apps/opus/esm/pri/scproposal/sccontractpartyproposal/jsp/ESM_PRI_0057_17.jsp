...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.sccontractpartyproposal.event.EsmPri005717Event"%>
...
<input type="hidden" name="prc_ctrt_pty_tp_cd" 	id="prc_ctrt_pty_tp_cd" value="C">
