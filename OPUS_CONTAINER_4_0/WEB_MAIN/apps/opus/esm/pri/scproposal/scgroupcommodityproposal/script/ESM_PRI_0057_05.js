 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_0057_05 : Business Script for ESM_PRI_0057_05
     */
    ...
    */
	function initSheet(sheetObj, sheetNo) {
		...
		switch (sheetID) {
			...
			case "sheet2":
				with(sheetObj){					
					var HeadTitle="|Sel.|Seq.|prop_no|amdt_seq|svc_scp_cd|grp_cmdt_seq|grp_cmdt_dtl_seq|Code|Description|prc_cmdt_tp_cd" + "|EFF Date|EFF Seq|EXP Date|Source|Status|Accept Staff/Team|Accept Date";
					var headCount=ComCountHeadTitle(HeadTitle);
					SetConfig( { SearchMode:2, MergeSheet:0, Page:20, DataRowMerge:1 } );
