...
<%@ page import="com.clt.apps.opus.esm.pri.scproposal.scgroupcommodityproposal.event.EsmPri000303Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
		EsmPri000303Event event = null; //PDTO(Data Transfer Object including Parameters)
		...
		try {
				...
				event = (EsmPri000303Event) request.getAttribute("Event");
		...
		<div class="opus_design_grid" id="mainTable">
			<div class="opus_design_btn">
				<button type="button" class="btn_normal" name="btn_rowadd2" suppressWait="Y" id="btn_rowadd2">Row Add</button><!-- 
				 ...
				 --><button type="button" class="btn_normal" name="btn_amendcancel" id="btn_amendcancel"  suppressWait="Y">Amend Cancel</button><!-- 
