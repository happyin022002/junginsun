...
<%@ page import="com.clt.apps.opus.esm.pri.pricommondata.pricommondata.event.EsmPri5002Event"%>
...
<%
	EsmPri5002Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmPri5002Event)request.getAttribute("Event");
...
<!-- layout_wrap(S) -->
	<div class="layout_wrap" style="width: 100%">
		...
		<div class="layout_vertical_2" style="width: 47%">
			...
			<div class="opus_design_btn"><button type="button" class="btn_normal" name="btn_rowadd1" id="btn_rowadd1">Row Add</button><!--
					--><button type="button" class="btn_normal" name="btn_rowdelete1" id="btn_rowdelete1">Row Delete</button></div>
		...
		<!-- opus_design_grid(E) -->
	     ...
	     <div class="layout_vertical_2" style="width: 3%;text-align:center">
	     ...
	     <div class="layout_vertical_2" style="width: 50%">
			...
			--><button type="button" class="btn_normal" name="btn_rowdelete2" id="btn_rowdelete2">Row Delete</button></div>
