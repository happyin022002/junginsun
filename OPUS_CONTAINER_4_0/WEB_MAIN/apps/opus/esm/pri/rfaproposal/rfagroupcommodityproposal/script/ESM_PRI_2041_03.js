 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ESM_PRI_2041_03 : business script for ESM_PRI_2041_03  
     */
    ...
    */
		...
		switch (sheetID) {
			case "sheet1":
				with(sheetObj){
					...
					InitColumns(cols);
					resizeSheet(); //SetSheetHeight(289);
					SetEditable(0);
			...
			case "sheet2":
				with(sheetObj){
					var HeadTitle1="|Sel.|Seq.|prop_no|amdt_seq|svc_scp_cd|CMDT Type|CMDT Code|Description|EFF Date|EXP Date" +"|Source|Status|Accepted|Accepted|grp_cmdt_seq|grp_cmdt_dtl_seq|n1st_cmnc_amdt_seq";
					var HeadTitle2="|Sel.|Seq.|prop_no|amdt_seq|svc_scp_cd|CMDT Type|CMDT Code|Description|EFF Date|EXP Date" +"|Source|Status|By|On|grp_cmdt_seq|grp_cmdt_dtl_seq|n1st_cmnc_amdt_seq";
					var headCount=ComCountHeadTitle(HeadTitle1);
					SetConfig( { SearchMode:2, MergeSheet:5, Page:20, DataRowMerge:1 } );
	...
	function resizeSheet(){
      ...
      * setting highlight selected row <br>
      */		
   ...
   /**
    * calling function when click sheet's row<br>
    * retrieving selected row's child sheet <br>
    */		
    ...
    */
	function validateForm(sheetObj, formObj, sAction) {
 	...
 	/**
    * calling function when click tab in parent screen<br>
    * showing retrieving  data <br>
    */ 	
...
//			formObject.dur_dup_flg.value = sDurDupFlg ;
	...
	/**
    * setting parent screen's control authority clear <br>
    */		
     ...
     * prohibiting input, update, delete in case of Confirmation is YES<br>
     */		
	...
	function sheet2_OnSearchEnd(sheetObj, errMsg){
		...
		if(amdt_seq!=0){
			for(var i=sheetObj.HeaderRows(); i <= sheetObj.LastRow(); i++) {
				...
				else if(sheetObj.GetCellValue(i,"amdt_seq") == sheetObj.GetCellValue(i,"n1st_cmnc_amdt_seq")){
