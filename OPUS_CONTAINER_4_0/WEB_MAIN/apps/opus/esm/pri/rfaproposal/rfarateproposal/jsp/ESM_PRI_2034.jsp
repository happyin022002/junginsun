...
<%@ page import="com.clt.apps.opus.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2034Event"%>
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<h2 class="page_title"><span>RFA Proposal Creation - Rate [Check Duplicate]</span></h2>
		
		<div class="opus_design_btn">
			<button type="button" class="btn_normal" name="btn_duplicatecheck" id="btn_duplicatecheck">Duplicate Check</button><!--  -->
