...
<%@ page import="com.clt.apps.opus.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2073Event"%>
...
<%
    EsmPri2073Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri2073Event) request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>RFA Proposal Inquiry - Rate (Route Note)</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
			...
			<table class="grid_2">
				...
				<tbody>
					<tr>
						...
						<td><textarea name="ta_note_ctnt" id="ta_note_ctnt" style="width:100%;height:80px" readOnly></textarea></td>
					</tr>
				</tbody>
			</table>
			<table><tbody><tr class="line_bluedot"><td colspan="2"></td></tr></tbody></table>
		</div>
	<!-- opus_design_inquiry(E) -->
		<div class="opus_design_grid clear" >
			<table>
					<tbody>
						<tr>
							<td><h3 class="title_design pad_btm_8">Conversion</h3></td>
						</tr>	
					</tbody>
				</table>					
