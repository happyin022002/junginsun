...
=========================================================*/
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
	      ...
	      var HeadTitle="|Sel.|Seq.|prop_no|amdt_seq|svc_scp_cd|cmdt_hdr_seq|cmdt_seq|CMDT Type|CMDT Code|Commodity Description|EFF Date|EXP Date|Source Code|Source|Status Code|Status|n1st_cmnc_amdt_seq|Accept User|1st ord|2nd ord";
	      ...
	      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
	             ...
	             {Type:"Text",      Hidden:0,  Width:200,  Align:"Left",    ColMerge:0,   SaveName:"prc_cmdt_def_nm",     KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	      ...
	      resizeSheet(); //SetSheetHeight(350);
	      }
		 break;
		}
	}
	...
	function sheet1_OnPopupClick(sheetObj, Row, Col) {
		...
		if (colName == "prc_cmdt_def_cd") {
			if (sheetObj.GetCellEditable(Row, "prc_cmdt_def_cd")) {
	            ...
	            sUrl += "&grp_cd=" + PRI_RP_SCP + "&commodity_cmd=CRG&prc_cmdt_tp_cd=" + sheetObj.GetCellValue(sheetObj.GetSelectRow(), "prc_cmdt_tp_cd");
	            
	            ComOpenPopup(sUrl, 700, 345, "setReturnValue", "1,0,1,1,1,1,1", false);
	...
	function setReturnValue(rtnVal) {
		if (rtnVal != null){
			...
			if (rtnVal.cd.length == 5) {
				...
				sheet1.SetCellValue(popupRow, "prc_cmdt_tp_cd","R", 1);
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        ...
        try {
            if (ComGetEvent() == null || ComGetEvent().suppresWait != "Y") {
                ComOpenWait(true);
            }
	        ...
	        case IBSEARCH_ASYNC12: // Amend Cancel
	        	...
	        	if (sheetObj.GetCellValue(oldRow, "prc_cmdt_tp_cd") == "G") {
					...
					formObj.f_cmd.value=SEARCH10;
					var param="&cd=" + oldGrpCd + "&nm=rpscp" + "&etc1=" + formObj.prop_no.value + "&etc2=" + formObj.amdt_seq.value + "&etc3=" + formObj.svc_scp_cd.value;
 					var sXml=sheetObj.GetSearchData("PRICommonGS.do", FormQueryString(formObj) + param);
					var arrData=ComPriXml2ComboString(sXml, "cd", "nm");
					if (arrData == null || arrData.length <= 0 || arrData[1] == "") {
	        ...
	        case IBSEARCH_ASYNC13: // Accept
	            ...
	            sParam += "&" + sSheetParam;
 	            var sXml=sheetObj.GetSaveData("ESM_PRI_2023GS.do", sParam);
	            ...
	            for (var i=sheetObj.HeaderRows(); sheetObj.RowCount()> 0 && i <= sheetObj.LastRow(); i++) {
	            	if (sheetObj.GetCellValue(i, "n1st_ord_ref") == "" || sheetObj.GetCellValue(i, "n2nd_ord_ref") == "") {
	            		...
	            		if (sheetObj.GetCellValue(i, "prc_cmdt_tp_cd") == "G") {
	            			n1stOrdRef=1;
	            		} else if (sheetObj.GetCellValue(i, "prc_cmdt_tp_cd") == "R") {
	            			n1stOrdRef=2;
