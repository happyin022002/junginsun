...
<%@ page import="com.clt.apps.opus.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2090Event"%>
<%@ page import="org.apache.log4j.Logger"%>

<%
	EsmPri2090Event event = null; //PDTO(Data Transfer Object including Parameters)
    ...
    try {
        ...
        event = (EsmPri2090Event) request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		...
		<!-- page_title(S) -->
		<h2 class="page_title"><span>Amendment History - Rate (Actual Customer)</span></h2>
		<!-- page_title(E) -->
