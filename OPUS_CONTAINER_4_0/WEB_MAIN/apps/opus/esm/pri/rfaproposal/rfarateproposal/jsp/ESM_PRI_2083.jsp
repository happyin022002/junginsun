...
<%@ page import="com.clt.apps.opus.esm.pri.rfaproposal.rfarateproposal.event.EsmPri2083Event"%>
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>RFA Proposal Inquiry - Rate (Actual Customer)</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
