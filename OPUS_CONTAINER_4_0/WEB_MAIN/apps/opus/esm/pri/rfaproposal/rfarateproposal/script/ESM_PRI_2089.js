...
=========================================================*/
	...
	function initSheet(sheetObj, sheetNo) {
		...
		case 1: // sheet1 init
		    with(sheetObj){	        
			      var HeadTitle="|Seq.|prop_no|amdt_seq|svc_scp_cd|cmdt_hdr_seq|cmdt_seq|CMDT Type|CMDT Code|Commodity Description|EFF Date|EXP Date|Source Code|Source|Status Code|Status|Accept Staff/Team|Accept Date|n1st_cmnc_amdt_seq|Accept User|1st ord|2nd ord";
			      ...
			      var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
			             ...
			             {Type:"Text",      Hidden:1, Width:100,  Align:"Center",  ColMerge:0,   SaveName:"cmdt_seq",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Combo",     Hidden:0, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"prc_cmdt_tp_cd",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
			             {Type:"PopupEdit", Hidden:0, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"prc_cmdt_def_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:6 },
			             {Type:"Text",      Hidden:0,  Width:200,  Align:"Left",    ColMerge:0,   SaveName:"prc_cmdt_def_nm",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Date",      Hidden:0,  Width:96,   Align:"Center",  ColMerge:0,   SaveName:"eff_dt",              KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             {Type:"Date",      Hidden:0,  Width:96,   Align:"Center",  ColMerge:0,   SaveName:"exp_dt",              KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             ...
			             {Type:"Date",      Hidden:0,  Width:96,   Align:"Center",  ColMerge:0,   SaveName:"acpt_dt",             KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
        try {
			...
			case IBCLEAR: // 로딩시 코드조회
				//sheetObj.SetColProperty("prc_cmdt_tp_cd", {ComboText:COMODITY_TYPE3[1] ,COMODITY_TYPE3[0], ComboCode:"",""} );
				sheetObj.InitDataCombo(0,"prc_cmdt_tp_cd", COMODITY_TYPE3[1], COMODITY_TYPE3[0], " ", " ", 0);
				break;
