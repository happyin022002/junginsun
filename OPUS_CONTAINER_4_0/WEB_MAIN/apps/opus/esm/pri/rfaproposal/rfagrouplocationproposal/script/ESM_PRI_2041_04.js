 ...
 ***************************************************************************************/
   /**
    ...
    /**
     * @extends 
     * @class ESM_PRI_2041_04 : Business Script for ESM_PRI_2041_04
     */
	...
	function initSheet(sheetObj, sheetNo) {
		...
		switch (sheetID) {
			...
			case "sheet2":
				with(sheetObj){
					var HeadTitle1="|Sel.|Seq.|Proposal No.|Amend Seq.|Service Scope|Group Location Seq.|Group Location Detail Seq.|" +"Location Code|Description|EFF Date|EXP Date|Source|Status|Accepted|Accepted|n1st_cmnc_amdt_seq";
					var HeadTitle2="|Sel.|Seq.|Proposal No.|Amend Seq.|Service Scope|Group Location Seq.|Group Location Detail Seq.|" +"Location Code|Description|EFF Date|EXP Date|Source|Status|By|On|n1st_cmnc_amdt_seq";
					var headCount=ComCountHeadTitle(HeadTitle1);
					SetConfig( { SearchMode:2, MergeSheet:5, Page:20, DataRowMerge:1 } );
