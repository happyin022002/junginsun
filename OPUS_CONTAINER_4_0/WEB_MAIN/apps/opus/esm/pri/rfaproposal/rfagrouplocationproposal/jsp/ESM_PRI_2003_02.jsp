...
<%@ page import="com.clt.apps.opus.esm.pri.rfaproposal.rfagrouplocationproposal.event.EsmPri200302Event"%>
	...
	<!-- layout_wrap (S) -->
		<div class="layout_wrap">
		    ...
		    <div class="layout_vertical_2" style="width: 5%; text-align: center; margin-top: 170px;">
				...
				<!-- <img src="img/btn_add.gif" width="26px" height="26px" alt="" border="0" align="absmiddle" name="" id=""> -->
		    </div>
