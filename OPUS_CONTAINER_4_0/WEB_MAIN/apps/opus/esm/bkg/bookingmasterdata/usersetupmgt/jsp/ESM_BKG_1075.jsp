...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg1075Event"%>
	    ...
	    <table>
	        ...
	        <tbody>
				<tr class="h23">
					<th>BKG OFC</th>
					<td>
						<input type="text" name="bkg_ofc_cd" id="bkg_ofc_cd"  style="ime-mode:disabled;width:120px;" dataformat="enguponly" class="input">
					</td>
					<th>Customer Code</th>
					<td>
						<input type="text" name="cust_cd" id="cust_cd" style="ime-mode:disabled;width:90px;" dataformat="engup" class="input">
					</td>
