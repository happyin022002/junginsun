...
<input type="hidden" name="obl_domain" id="obl_domain" value="<%=CFG_FILEOPEN_LOGURL_BASE%>"/>
<input type="hidden" name="obl_url" id="obl_url" value="<%=CFG_FILEOPEN_LOGURL_LOGPATH%>"/>
<input type="hidden" name="form_ca_yn" id="form_ca_yn" />
		...
		<div class="opus_design_inquiry wFit">
			...
			<table class="grid2">
				<tbody>
					...
					<tr>
						<th class="tr2_head" nowrap style="text-align:center;"><strong>Print Page (Face)</strong></th>
						<td colspan="3" class="input"><%=JSPUtil.getCodeCombo("face_print_cnt", "", "", "CD20057", 0, "")%> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Copy Page <input type="text" id="bl_cpy_no" name="bl_cpy_no" style="width: 30px;" readonly/></td>
					</tr>
					<tr><th class="tr2_head" nowrap style="text-align:center;"><strong>Print Page (Rider)</strong></th>
						<td class="input" colspan="3"><%=JSPUtil.getCodeCombo("rider_print_cnt", "", "", "CD20057", 0, "")%></td>
					</tr>
				</tbody>
			</table>
			<table>
