...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingmasterdata.usersetupmgt.event.EsmBkg1606Event"%>
	    ...
	    <table>
	        ...
	        <tbody>
				<tr class="h23">
					<th>Country Code</th>
					<td>
						<input type="text" name="org_cnt_cd" id="org_cnt_cd"  style="ime-mode:disabled;width:40px;" dataformat="enguponly" maxlength="2" class="input">
					</td>					
				</tr>
