...
<form name="form">
	...
	<div class="layout_wrap">
					...
					<table class="grid2">
						<tbody>
							...
							<tbody>
								...
								<tr>
									<th><strong>Print Page</strong></th>
									<td>
		...
		<div class="layout_vertical_2">
			...
			<div class="layout_vertical_2">
				<div class="wrap_result" style="height:475px;width:660px">
					 <!-- opus_design_RD(S) -->
					<div class="opus_design_RD rd_hidden">
						<script>rdViewerObject();</script>
						<iframe id="rdframe" name="rdframe" class="hiddenFrame" width="475px" height="660px" src="COM_RD_FRAME_01.do"></iframe>
					</div>
				    <!-- opus_design_RD(E) -->
				</div>
			</div>	
