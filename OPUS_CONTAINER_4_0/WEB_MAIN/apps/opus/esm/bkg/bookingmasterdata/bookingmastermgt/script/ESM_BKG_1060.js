...
/**
 * @extends
 * @class ESM_BKG_1060 : business script for ESM_BKG_1060
 */
	...
	case IBSEARCH:
		if (validateForm(sheetObj, formObj, sAction))
			if (sheetObj.id == "sheet1") {
				...
				sheetObj.DoSearch("ESM_BKG_1060GS.do", FormQueryString(formObj) );
			}
		break;
	case IBSAVE: 
		if (validateForm(sheetObj, formObj, sAction))
			if (sheetObj.id == "sheet1") {
				...
				var sXml=sheetObj.GetSaveData("ESM_BKG_1060GS.do", FormQueryString(formObj));
