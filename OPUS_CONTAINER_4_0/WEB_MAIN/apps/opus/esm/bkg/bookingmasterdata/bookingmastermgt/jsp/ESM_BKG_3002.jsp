...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg3002Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
EsmBkg3002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg3002Event)request.getAttribute("Event");
...
<input type="hidden" name="bl_grp_seq">
	...
	<div class="opus_design_inquiry wFit">
		    <table>
		        ...
		        <tbody>
					<tr>
						<th>BL Group Name</th>
						<td><input type="text" style="width:200px; text-transform:uppercase; ime-mode:inactive; ime-mode:disabled" name="bl_grp_nm" class="input"></td>
						<th>BL Group Description</th>
						<td><input type="text" style="width:200px; ime-mode:abled" name="bl_grp_desc" class="input" ></td>
						<th>Customer</th>
						<td>
							<input type="text" name="cust_cnt_cd" dataformat="enguponly" maxlength="2" style="width:25px;ime-mode:disabled" >
...
<!--         opus_design_grid(E) -->
    ...
    <div class="layout_vertical_2" style ="width: 100%">
	    ...
	    --></div>
	    <!-- opus_design_btn(E) -->
		<h3 class="title_design mar_btm_8">Customer</h3>
