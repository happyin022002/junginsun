...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg1060Event"%>
...
<input 	type="hidden" name="agn_flg" id="agn_flg" value="Y">
	...
	<table>
		...
		<tbody>
			<tr>
				...
				<th>Agent Code</th>
				<td>
					<input type="text" style="width: 40px; ime-mode: disabled" class="input" name="chn_agn_cd" id="chn_agn_cd" maxlength="2" dataformat="engup" value="">
				</td>
				<th>User ID</th>
				<td>
					<input type="text" style="width: 80px; ime-mode: disabled" class="input" name="cre_usr_id" id="cre_usr_id" maxlength="20" dataformat="engup" value="">
				</td>
				<th>Use</th>
				<td>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>Agent Code</th>
					<td>
						<input type="text" style="width: 40px;" class="input1" id="act_chn_agn_cd" name="act_chn_agn_cd" maxlength="2" dataformat="engup" value="">
					</td>				
					<td class="pad_left_8">
