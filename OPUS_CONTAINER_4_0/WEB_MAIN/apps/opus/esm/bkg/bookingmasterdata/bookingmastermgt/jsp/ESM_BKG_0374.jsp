...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingmasterdata.bookingmastermgt.event.EsmBkg0374Event"%>	
	    ...
	    <table>
	        ...
	        <tbody>
				<tr class="h23">
					<th>EQ Office</th>
					<td>
						<input type="text" style="width:60;" class="input1" name="p_eq_ctrl_ofc_cd" dataformat='enguponly' maxlength='5' style="ime-mode:disabled"  value="">
					</td>
					<th>Handling Office</th>
					<td>
						<input type="text" style="width:60;" class="input" name="p_hndl_ofc_cd" dataformat='enguponly' maxlength='5' style="ime-mode:disabled"  value="">
					</td>
				</tr>
