...
//	     		loadPage();
	     	...
	     	case IBSAVE: // Save
				...
				var sXml=sheetObjects[0].GetSaveData("ESM_BKG_2004GS.do", "f_cmd=" + MULTI + "&" +sParam);
			...
			case SEARCH02:	//check if there is id in DB
				...
				var sXml=sheetObj.GetSaveData("ESM_BKG_2004GS.do", FormQueryString(formObj));
	 ...
	 */  
	 function popupId(row) {
	     with (sheetObjects[0]) {
	        	...
	        	var sUrl="/opuscntr/ESM_BKG_2005.do?hrd_cdg_id="+idx+"&attr_nm1="+idx1+"&attr_nm2="+idx2+"&attr_nm3="+idx3+"&attr_nm4="+idx4+"&attr_nm5="+idx5+"&attr_nm6="+idx6+"&attr_nm7="+idx7+"&attr_nm8="+idx8+"&attr_nm9="+idx9+"&attr_nm10="+idx10;
