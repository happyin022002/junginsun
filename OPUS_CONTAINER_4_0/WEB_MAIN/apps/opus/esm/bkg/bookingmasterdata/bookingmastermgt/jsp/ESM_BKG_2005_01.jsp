...
<%
	EsmBkg200501Event event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg200501Event) request.getAttribute("Event");
