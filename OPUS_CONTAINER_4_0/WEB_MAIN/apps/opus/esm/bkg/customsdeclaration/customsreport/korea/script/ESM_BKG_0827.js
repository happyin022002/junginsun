...
*@FileName : esm_bkg_0827.js
*@FileTitle : SEA IMPORT CARGO MANIFEST
*Open Issues :
*Change history :
...
function rdOpen(){
	...
	//RD_path = "http://203.246.151.91:9001/opuscntr/"; // TEST 할때만..
	viewer.openFile(RD_path+"apps/opus/esm/bkg/customsdeclaration/customsreport/korea/report/ESM_BKG_0827.mrd", RDServer, {timeout:1800});
}
