...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span> Transmit to SEA-NACCS [NEW]</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
	...
	<div class="wrap_search">
		<div class="opus_design_inquiry wFit">
			...
			<table>
				...
				<tbody>
					<tr>
						<td class="align_center"><button type="button" class="btn_normal" style="text-align:center; width:105px;" name="btn2_MFR">MFR</button></td>
					...
					<tr id="delete_reason" style="visibility:hidden;">
						<td colspan="3">
