	...
	<div class= "opus_design_inquiry wFit">
		<table style="width:900px">
			...
			<tbody>
				...
				<tr>
					<th>ETA</th>
					<td><input type="text" style="width:75px;" class="input" name="in_vps_eta_dt" dataformat="ymd" maxlength="10" id="in_vps_eta_dt" /><button type="button" id="btns_calendar" name="btns_calendar" class="calendar ir"></button></td>
					<th>B/L Type</th>
					<td width="100">
