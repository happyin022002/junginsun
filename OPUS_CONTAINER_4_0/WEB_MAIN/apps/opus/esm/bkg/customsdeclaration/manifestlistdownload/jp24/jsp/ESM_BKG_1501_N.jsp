...
<div class="wrap_result">
	...
	<h3 class="title_design">All dates are in POL local time.</h3>
		<!-- opus_design_btn (S) -->
		<div class="opus_design_btn">
			<button class="btn_accent" name="btn_bll_separate" id="btn_bll_separate" type="button">BLL - Separate</button><!--
			--><button class="btn_normal" name="btn_bll_combine" id="btn_bll_combine" type="button">BLL - Combine</button>
		</div>
		<!-- opus_design_btn (E) -->
