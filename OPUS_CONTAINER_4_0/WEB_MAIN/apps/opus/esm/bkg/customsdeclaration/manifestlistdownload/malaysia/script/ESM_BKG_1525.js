...
*@FileName   : esm_bkg_1525.js
*@FileTitle  : Ship Call No Registration(KCT) : Import Schedule
*@author     : CLT
*@version    : 1.0
*@since      :
=========================================================*/
...
function processButtonClick(){
	...
	try {
		...
		case "btn_calendar1":
			...
			cal.select(formObj.etb_dt1, formObj.etb_dt2, "yyyy-MM-dd");
			break;
		case "btn_Close":
			ComClosePopup();
			break;
...
function initSheet(sheetObj,sheetNo) {
	...
	case "sheet1":
		with (sheetObj) {
			...
			var HeadTitle1="|SEQ|SEL|OPUS VVD|OPUS VVD|OPUS VVD|Malaysia Vessel Name|Voyage/Direction";
			...
			var cols = [{Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
						{Type:"Seq",       Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"Seq",                 KeyField:0,   PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:0 },
						{Type:"CheckBox",  Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"Sel",                 KeyField:0,   PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
						{Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"vsl_cd",              KeyField:1,   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:4 },
						{Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"skd_voy_no",          KeyField:1,   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:4 },
						{Type:"Text",      Hidden:0,  Width:30,   Align:"Center",  ColMerge:1,   SaveName:"skd_dir_cd",          KeyField:1,   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:1 },
						{Type:"Text",      Hidden:0,  Width:400,  Align:"Left",    ColMerge:1,   SaveName:"malaysia_vsl_nm",     KeyField:1,   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:100 },
						{Type:"Text",      Hidden:0,  Width:120,  Align:"Left",    ColMerge:1,   SaveName:"malaysia_voy_dir_cd", KeyField:1,   PointCount:0,   UpdateEdit:1,   InsertEdit:1,   EditLen:6 } ];
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	case IBSEARCH:
		if(validateForm(sheetObj,formObj,sAction)) {
			...
			var sXml=sheetObj.GetSearchData("ESM_BKG_1525GS.do",  FormQueryString(formObj));
