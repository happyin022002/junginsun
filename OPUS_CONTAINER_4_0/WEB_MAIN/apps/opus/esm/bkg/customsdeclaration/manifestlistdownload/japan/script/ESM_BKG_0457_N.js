...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch (sAction) {
		...
		case COMMAND06:  // Mark & Desc
			var sUrl = "ESM_BKG_0458_N.do?pgmNo=ESM_BKG_0458&gubun=CMF&bl_no=" + formObj.in_bl_no.value + formObj.in_bl_split_no.value;
			ComOpenWindowCenter(sUrl, "ESM_BKG_0458_N", 780, 450, true);
		break;

		case COMMAND07: // Transmit
			var sUrl = "ESM_BKG_0991_N.do?pgmNo=ESM_BKG_0991&bl_no="
			...
			ComOpenWindowCenter(sUrl, "ESM_BKG_0991", 500, 370, true);
		break;
