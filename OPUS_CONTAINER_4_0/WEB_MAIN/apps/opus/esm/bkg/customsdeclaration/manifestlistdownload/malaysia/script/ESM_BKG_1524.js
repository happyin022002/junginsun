...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	switch(sAction) {
		case IBCLEAR:      //combo initialization
			var sXml = sheetObj.GetSearchData("ESM_BKG_1524GS.do", "f_cmd=" + INIT);
		...
		case IBSEARCH:      //retrieve
			...
			var sXml = sheetObj.GetSearchData("ESM_BKG_1524GS.do", FormQueryString(formObj));
		...
		case IBSAVE:     // Save
			...
			sheetObj.DoSave("ESM_BKG_1524GS.do",  FormQueryString(formObj), -1, false)
			ComOpenWait(false);
		break;
	}
}
