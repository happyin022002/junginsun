...
<%@ page import="com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.ancs.event.EsmBkg0063Event"%>
...
<div class="page_title_area clear">
	...
	<div class="opus_design_btn">
		...
		--><button type="button" class="btn_normal" name="btn_view" id="btn_view">Manifest(B/L)</button><!--
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td><input type="text" style="width:100px;text-align:center;;ime-mode:disabled" name="vvd" id="vvd" class="input1" align="middle" maxlength="9" dataformat="engup" value="<%=vvd %>"></td>
					<th>SSR No.</th>
					...
					<th>POD</th>
					<td><script type="text/javascript">ComComboObject('pod', 2, 100, 0, 1);</script></td>
					<th>VSL Name</th>
					<td><input type="text" style="width:200px;text-align:left;" name="vsl_name" id="vsl_name" class="input2" align="middle" maxlength="50" dataformat="engup" readonly="readonly"></td>
					<th>ETA</th>
					<td><input type="text" style="width:100px;text-align:center;" name="eta" id="eta" class="input2" maxlength="10" dataformat="ymd" readonly="readonly"></td>
				</tr>
			</tbody>
		</table>
	</div>
