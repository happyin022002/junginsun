...
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><span> Manifest Registration(MFR) - Marks And Description [NEW]</span></h2>
	<!-- page_title(E) -->
			...
			<tr class="h23">
				...
				<td width="50%" style="padding-left:13px;">
					<table border="0" style="width:100%; background-color:white;" class="grid2">
						...
						<tr>
							<td><textarea style="width:100%;" rows="11" name="bl_desc" dataformat="engupetc" style="ime-mode:disabled" maxlength="350"></textarea></td>
						</tr>
					</table>
				</td>
			</tr>
