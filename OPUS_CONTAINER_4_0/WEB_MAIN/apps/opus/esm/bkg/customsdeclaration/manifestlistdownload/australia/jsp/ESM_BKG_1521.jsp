...
*@FileName   : ESM_BKG_1521.jsp
*@FileTitle  : Aus DG EDI Transmit History
*@author     : CLT
*@version    : 1.0
*@since      :
=========================================================*/
...
<%@ page import="com.clt.apps.opus.esm.bkg.customsdeclaration.manifestlistdownload.australia.event.EsmBkg1521Event"%>

<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmBkg1521Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmBkg1521Event)request.getAttribute("Event");
