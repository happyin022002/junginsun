...
<%@ page import="com.clt.apps.opus.esm.bkg.outbounddocumentation.blrating.blrating.event.EsmBkg1076Event"%>
...
<input id="taa_no" name="taa_no" value="<%=JSPUtil.getParameter(request, "taa_no")%>" type="hidden" />
...
<input id="brk_dwn_flg" name="brk_dwn_flg" value="<%=JSPUtil.getParameter(request, "brk_dwn_flg")%>" type="hidden" />
...
<input id="ctrt_tp_cd" name="ctrt_tp_cd" value="T" type="hidden" />
	...
	<div class="layout_wrap">
		...
		<table>
			...
			<tr>
				...
				<th>TAA No.</th>
				<td><input id="frm_ftaa_no" style="width:110px;" class="input" name="frm_ftaa_no" value="<%=JSPUtil.getParameter(request, " taa_no") %>" type="text" readonly="readonly"/></td>
			</tr>
		</table>
		      ...
		      <table class="grid_2" style="width:690px;">
					...
					<tr>
						...
						<td class="input2"><input id="frm_s_cust_cnt_cd" style="width: 100%; text-align: center" class="noinput2" name="frm_s_cust_cnt_cd" value="" readonly="" type="text" /></td>
						<td class="input2"><input id="frm_s_cust_seq" style="width: 100%; text-align: right" class="noinput2" name="frm_s_cust_seq" value="" readonly="" type="text" /></td>
						<td align="left" class="input2"><input id="frm_s_cust_nm" style="width: 100%; text-align: left" class="noinput2" name="frm_s_cust_nm" value="" readonly="" type="text" /></td>
					</tr>
					<tr>
					...
					<tr>
						<th><strong>TAA customer	</strong></th>
		...
		<table>
			...
			<tr>
				...
				<td width="240">
					...
					--><input id="frm_del_cd" style="width:50px;" class="input2" name="frm_del_cd" value="" type="text" />
				</td>
				<td></td>
				<th>Pre</th>
