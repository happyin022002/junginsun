...
*@FileTitle  : Export / Import Information (ARGENTINA)
*@author     : CLT
*@version    : 1.0
*@since      : 2015/01/22
=========================================================
	...
	<div id="tabLayer" style="display:inline">
			...
			<table>
				...
				<tbody>
					<tr class="h23">
						<th>Country</th>
						<td>
							<%=JSPUtil.getCodeCombo("exp_cnt_cd", "AR", "onChange='javascript:goCtnCd(this);'", "CD20055", 0, "")%>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="opus_design_inquiry">
			<table>
				...
				<tbody>
					<tr class="h23">
						<th colspan="2"  style="text-align:left"><h3 class="title_design">Export License Number for Argnetina</h3></th>
					</tr>
					<tr class="h23">
						<th>Booking No.</th>
						<td>
			...
			<table>
				...
				<tbody>
					<tr class="h23">
						<th>Country</th>
						<td>
							<%=JSPUtil.getCodeCombo("imp_cnt_cd", "AR", "onChange='javascript:goCtnCd(this);'", "CD20055", 0, "")%>
						</td>
					</tr>
				</tbody>
			</table>
