...
<div class="wrap_search_tab">
	<div class="wrap_result">
		...
		<div id="tabLayer" style="display:inline">
				...
				<table>
					...
					<tbody>
						<tr>
							<th>Country</th>
							<td>
								<%=JSPUtil.getCodeCombo("exp_cnt_cd", "ID", "onChange='javascript:goCtnCd(this);'", "CD20055", 0, "")%>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="opus_design_inquiry wFit">
				<h3 class="title_design mar_btm_8">Manifest Data for INDONESIA Customs</h3>
				<table>
					<colgroup>
						<col width="60">
						<col width="*">
				...
				<table>
					...
					<tbody>
						<tr>
							<th>Country</th>
							<td>
								<%=JSPUtil.getCodeCombo("imp_cnt_cd", "ID", "onChange='javascript:goCtnCd(this);'", "CD30017", 0, "")%>
							</td>
						</tr>
					</tbody>
				</table>
