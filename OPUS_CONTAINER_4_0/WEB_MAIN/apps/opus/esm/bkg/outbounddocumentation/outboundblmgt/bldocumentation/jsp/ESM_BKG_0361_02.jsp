...
<!--TAB Export (S) -->
	<div id="tabLayer" style="display:inline">
			...
			<table>
				...
				<tbody>
					<tr class="h23">
						<th>Country</th>
						<td>
							<%=JSPUtil.getCodeCombo("exp_cnt_cd", "KR", "onChange='javascript:goCtnCd(this);'", "CD20055", 0, "")%>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="opus_design_inquiry">
			<table>
				...
				<tbody>
					<tr class="h23">
						<th colspan="2"  style="text-align:left"><h3 class="title_design">Export License Number for Korea</h3></th>
					</tr>
					<tr class="h23">
						<th>Booking No.</th>
						<td>
							<input type="text" name="bkg_no" style="width:110px;" class="input2" value="<%=bkg_no%>" readonly>
						</td>
					</tr>
				</tbody>
			</table>
	...
	<div id="tabLayer" style="display:none">
			...
			<table>
				...
				<tbody>
					<tr class="h23">
						<th>Country</th>
						<td>
							<%=JSPUtil.getCodeCombo("imp_cnt_cd", "KR", "onChange='javascript:goCtnCd(this);'", "CD30017", 0, "")%>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<table>
			...
			<tbody>
				<tr class="title_h">
						<th colspan="2" style="text-align:left"><h3 class="title_design">Import License Number for Korea</h3></th>
					</tr>
				<tr class="h23">
					<th>Booking No.</th>
					<td>
