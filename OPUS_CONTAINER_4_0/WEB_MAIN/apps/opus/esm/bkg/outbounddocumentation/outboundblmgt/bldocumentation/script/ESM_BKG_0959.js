...
/*------------------다음 코드는 JSDoc을 잘 만들기 위해서 추가된 코드임 ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_BKG_959 : ESM_BKG_959 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
     */
    function ESM_BKG_0959() {
...
//					if(!opener) opener=window.dialogArguments; 
					...
					if(callback_func != ''){
						eval('opener.'+callback_func)(org_cntr_mf_no);
					}
				//break;
				case "btn1_Close":
					ComClosePopup(); 
    ...
    function loadPage() {
		...
		//
		document.form.org_cntr_mf_no.focus();
	}
    /**
