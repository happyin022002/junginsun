...
<%@ page import="com.clt.apps.opus.esm.bkg.inbounddocumentation.csscreenmgt.csscreen.event.EsmBkg0660Event"%>
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>Break Bulk Detail(s) Pop-up</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
