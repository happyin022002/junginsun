...
<%@ page import="com.clt.apps.opus.esm.bkg.inbounddocumentation.cargoreleaseordermgt.cargoreleaseorder.event.EsmBkg1022Event"%>
...
<input type="hidden" name="do_no" value="<%=JSPUtil.getNull(request.getParameter(" do_no")) %>" id="do_no" />
...
<div class="layer_popup_contents">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>Outstanding Amount</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
