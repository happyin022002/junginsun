...
function processButtonClick(){
	...
	try {
		...
		case "btn_ImportSchedule":
			...
			ComOpenPopup("/opuscntr/ESM_BKG_1013.do?"+params, 540, 400, "0002", "1,0", false);
			break;
		} // end switch
	}catch(e) {
		if( e == "[object Error]") {
	...
	//  searching the VSL NM in case of inserting VSL CD
	 if (Col==3) {
		  ...
		  if (Col==3) {
			  ...
			  var sXml=sheetObj.GetSearchData("ESM_BKG_0575GS.do?vsl_cd="+sheetObj.GetCellValue(Row,Col)+"&f_cmd="+formObj.f_cmd.value);
