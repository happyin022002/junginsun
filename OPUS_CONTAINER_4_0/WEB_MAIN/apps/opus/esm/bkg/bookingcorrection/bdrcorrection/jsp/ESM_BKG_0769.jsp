...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingcorrection.bdrcorrection.event.EsmBkg0769Event"%>
...
<!--
      /* 
       * Information entered by the user through event presents on the screen.
       */
      with(document.form)
      {
        <%
