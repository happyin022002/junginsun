...
<%@ page import="com.clt.apps.opus.esm.bkg.revenueaudit.unmatchbl.event.EsmBkg0151Event"%>
...
//    String[] usaSvcModCds = null;
    ...
    try {
        ...
        // cargo type term Combo Data creation
	...
	<div class="opus_design_inquiry wFit">
		...
		<table>
				...
				<tr>
					...
					<th>Office</th>
					<td><script type="text/javascript">ComComboObject('bkg_ofc_cd', 1, 70, 0, 0, 0, false);</script></td>
					<td>
						<div>
							<table>
								<tr class="sm">
									...
									<td>
										<input type="text" style="width:75px;text-align:center;" class="input1" name="from_dt" caption="From Date" dataformat="ymd" maxLength="10" minlength="8"><!--
										--><button type="button" class="calendar ir" name="btns_calendar1" id="btns_calendar1"></button>
										~
										<input type="text" style="width:75px;text-align:center;" class="input1" name="to_dt" caption="To Date" dataformat="ymd" maxLength="10" minlength="8"><!--
					...
					<th>B/L No.</th>
					<td>
						<input type="text" style="width:95px;text-align:center;ime-mode:disabled" class="input" name="bl_no" caption="B/L No" dataformat="engup" maxlength="12">
					</td>
				</tr>
				</table>
				<table>
				...
				<tr>
					<th>Contract Type</th>
					<td>
						<script type="text/javascript">ComComboObject('bkg_ctrt_tp_cd', 1, 55, 0, 1, 0, false);</script>
					</td>
					<th>Contract No.</th>
					<td>
					...
					<th>Cargo Type</th>
					<td>
						<script type="text/javascript">ComComboObject('cargo_type', 2, 72, 0, 0, 0, false);</script>
					</td>
				</tr>
				</table>
				<table>
				...
				<tr>
					...
					<td>
						<input type="text" style="width:55px;ime-mode:disabled;" class="input" name="por_cd" dataformat="engup" maxlength="5">
					</td>
					<th title="Port of Loading">POL</th>
					<td>
						<input type="text" style="width:55px;ime-mode:disabled;" class="input" name="pol_cd" dataformat="engup" maxlength="5">
					</td>
					<th title="Port of Discharging">POD</th>
					<td>
						<input type="text" style="width:55px;ime-mode:disabled;" class="input" name="pod_cd" dataformat="engup" maxlength="5">
					</td>
					<th title="Place of Delivery">DEL</th>
					<td>
						<input type="text" style="width:55px;ime-mode:disabled;" class="input" name="del_cd" dataformat="engup" maxlength="5">
					</td>
					<th>R/D Term</th>
	                <td>
					...
					<td>
						...
						--><input type="text" style="width:25px;text-align:center;ime-mode:disabled;" class="input" name="cust_cnt_cd" dataformat="enguponly" maxlength="2"><!--
						...
						--><input type="text" style="width:105px;text-align:left;ime-mode:disabled;" class="input" name="cust_nm" dataformat="engup" maxlength="20">
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			<tbody>
				<tr>
					...
					<td width="60">
						<input type="text" style="width:40;text-align:center;ime-mode:disabled;" class="input" name="curr_cd" dataformat="enguponly" maxlength="3">
					</td>
...
<div class="opus_design_grid">
	<div class="opus_design_btn" style="padding-bottom:5px">
