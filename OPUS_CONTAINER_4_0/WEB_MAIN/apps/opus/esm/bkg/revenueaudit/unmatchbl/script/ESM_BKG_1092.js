...
/**
 * @extends  
 * @class ESM_BKG_1092 : business script for ESM_BKG_1092 
 */
...
function initIBComboItem() {
	...
	getComboObject(comboObjects, 'bkg_ctrt_tp_cd').SetSelectCode("S",false);
		...
		case "sheet1":
			with(sheet1){
			    ...
			    var cols = [ {Type:"Text",      Hidden:0, Width:40,   Align:"Center",  ColMerge:1,   SaveName:"bkg_seq",               KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 ...
			                 {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"rep_cmdt_cd",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 ...
			                 {Type:"Text",      Hidden:0, Width:150,  Align:"Left",    ColMerge:0,   SaveName:"cstms_desc",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 ...
			                 {Type:"Text",      Hidden:0, Width:50,   Align:"Center",  ColMerge:0,   SaveName:"eq_subst_flg",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 ...
			                 {Type:"Text",      Hidden:0, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"rcv_term_cd",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"de_term_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"usa_svc_mod_nm",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:270,  Align:"Left",    ColMerge:0,   SaveName:"s_cust_nm",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:270,  Align:"Left",    ColMerge:0,   SaveName:"c_cust_nm",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:270,  Align:"Left",    ColMerge:0,   SaveName:"n_cust_nm",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:200,  Align:"Left",    ColMerge:0,   SaveName:"ctrt_cust_nm",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:40,   Align:"Center",  ColMerge:0,   SaveName:"ctrt_cust_tp_cd",       KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"ctrt_cust_val_sgm_nm",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"bdr_flg",               KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"bkg_sts_nm",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"split_nm",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"charge_nm",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:0,   SaveName:"auto_rat_nm",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"rt_bl_tp_nm",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:0,   SaveName:"rater_id",              KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Popup",     Hidden:0, Width:100,  Align:"Center",  ColMerge:0,   SaveName:"rdn_no",                KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
			                 {Type:"Text",      Hidden:0, Width:80,   Align:"Center",  ColMerge:0,   SaveName:"rdn_sts_nm",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 ...
			                 {Type:"Text",      Hidden:0, Width:120,  Align:"Right",   ColMerge:0,   SaveName:"chg_ut_amt",            KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:100,  Align:"Right",   ColMerge:0,   SaveName:"rat_as_qty",            KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:3,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:40,   Align:"Center",  ColMerge:0,   SaveName:"rat_ut_cd",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:120,  Align:"Right",   ColMerge:0,   SaveName:"chg_amt",               KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
			                 {Type:"Text",      Hidden:0, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"auto_rat_cd",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			                 ...
			                 {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"bkg_ctrt_tp_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
			    InitColumns(cols);
			    SetEditable(1);
...
//===================================================================================
/** 
* getting value from pop up of retrieving Location code
* @param  {IBSheet} aryPopupData  : sheet Object  
*/ 
...
function setNew() {
    ...
    rhqObj.SetSelectIndex("-1");
   	...
   	bkgCtrtTpObj.SetSelectCode("S",false);
        ...
        case IBBATCH: //backendjob
        	try {
    			...
    			sheet3.SetWaitImageVisible(0);
     			var sXml=sheet3.GetSearchData("ESM_BKG_1092GS.do", FormQueryString(formObj));
    			var backendJobKey=ComGetEtcData(sXml, "BackEndJobKey");
    			if (backendJobKey.length > 0) {
    				formObj.backendjob_key.value=backendJobKey;
    				sheet3.SetWaitTimeOut(10000);
    				timer=setInterval(getBackEndJobStatus, 3000); // 3 seconds
    																// getBackEndJobStatus
    			}else{
        			ComOpenWait(false);
    			}
...
/**
* BackEndJob : checking until Status='3'
*/
function getBackEndJobStatus() {
	try {
		var form=document.form;
		form.f_cmd.value=SEARCH;
 		var sXml=sheet3.GetSearchData("ESM_BKG_1092GS.do", FormQueryString(form));
...
/**
* downloading Excel file after finishing BackEndJob(Request Expense Inital)
*/
function getBackEndJobLoadFile() {
	try {
		...
		var formString="f_cmd=" + form.f_cmd.value + "&backendjob_key=" + form.backendjob_key.value;
 		var sXml=sheet1.GetSearchData("ESM_BKG_1092GS.do", formString);
		sheet1.LoadSearchData(sXml,{Sync:1} );
		//starting from 0 
		form.bl_cnt.value=sheet1.GetCellValue(sheet1.RowCount()+ sheet1.HeaderRows()-1,0);
	}catch(e){
		ComShowMessage(e);
	}finally{        	
		ComOpenWait(false);        		
...
/** 
* checking condition for VVD input
*/ 
...
/*
	...
	if(vvdObj.maxLength == vvdObj.value.length){
		...
		chargeObj.SetBackColor("#FFFFFF");
		dtClassNm="input";
		// 
	}else{
		gIsSearchDt=true;
		if(chargeFlgObj.GetSelectCode()== "N"){
			chargeObj.className="mult_combo";
			chargeObj.SetBackColor("#FFFFFF");
			// 
			dtClassNm="input1";			
...
* @param  {String} chkDays : maximum date
*/ 
...
function validateForm(sheetObj, formObj, sAction){
    ...
    switch (sAction) {
    	case IBSEARCH: //retrieve
			if((null == rhqObj.GetSelectCode()|| "" == rhqObj.GetSelectCode()) && blNoObj.maxLength != blNoObj.value.length) {
...
/**
 * activating in case of changing chg_cd
 */ 
function chg_cd_OnChange(comboObj, oldindex, oldtext, oldcode, newindex , text , code) {
