...
<%@ page import="com.clt.apps.opus.esm.bkg.bookingconduct.ebookingconduct.ebookingreceipt.event.EsmBkg0235Event"%>
...
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><span>OPUS Container Office Setup</span></h2>
	<!-- page_title(E) -->
	
	<!-- opus_design_btn(S) -->
	<div class="opus_design_btn">
		<button type="button" class="btn_accent" name="btn_Retrieve" id="btn_Retrieve">Retrieve</button><!-- 
	    --><button type="button" class="btn_accent" name="btn_save" id="btn_save">Confirm</button><!--
			...
			<table> 
				...
				<tbody>
					<tr>
						...
						<th>Office Name</th>
						<td><input type="text" name="ofc_nm" id="ofc_nm" style="width:580px;" class="input" style="ime-mode:disabled" value="" dataformat="engup" otherchar="!@#$%^&*()? ][{}=+-"></td>
					</tr> 
				</tbody>
			</table>
		</div>
...
<div class="wrap_result">
	...
	<div class="opus_design_grid">
		<b>Select the appropriate Handling office to re-route the Bookings Only one Handling office may be selected.</b><br>
