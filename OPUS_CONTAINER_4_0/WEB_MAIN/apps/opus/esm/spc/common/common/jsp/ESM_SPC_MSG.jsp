       	...
       	<tr><td style='WIDTH: 100%' > 
			...
			<table style='border-collapse: collapse;width:100%;HEIGHT:100%; border:1px solid #A3A4C7;background-color:#C0EBA3;' border='1'  ><tr><td> 
        		...
        		<tr style='height:23;font-family: Arial;  font-size: 10px;text-align:center; color: #636363;background-color:#FFFFFF;border:1px solid #A3A4C7; '> 
    					<td width='30%' style='border:1px solid #A3A4C7;HEIGHT: 100%'> 
    						<div>
    							<textarea name=msg style="WIDTH:100% ;HEIGHT: 100%;border:2px" readonly onChange="document.form.msg.scrollTop=0;"></textarea>
    						</div> 
    					</td> 
    			</tr>         
				</table> 
...
<% if( "1".equals(windowType) ){ %>							
								<td align=center><img class='cursor' src='/opuscntr/img/button/btn_ok.gif' width='66' height='20' border='0' name='btn_ok' ></td>
								<td align=center><img class='cursor' src='/opuscntr/img/button/btn_cancel.gif' width='66' height='20' border='0' name='btn_cancel'></td>
<%}else{ %>								
								<td align=center><img class='cursor' src='/opuscntr/img/button/btn_close.gif' width='66' height='20' border='0' name='btn_close' ></td>
<%} %>								
								<td align=center><img class='cursor' src='/opuscntr/img/button/btn_copytoclipboard.gif' width='130' height='20' border='0' name='btn_copy' ></td>
							</tr>
						</table>
					</td>
				</tr>
