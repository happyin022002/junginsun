...
<%@ page import="com.clt.apps.opus.esm.coa.lanesimulation.event.EsmCoa0166Event"%>
<%@ page import="java.util.*"%>
<%
    EsmCoa0166Event  event = null;     //PDTO(Data Transfer Object including Parameters)
    ...
    Logger log = Logger.getLogger("com.clt.apps.opus.esm.coa.lanesimulation.EsmCoa0166Event");
    ...
    try {
        ...
        if (serverException != null) {
            ...
            event = (EsmCoa0166Event)request.getAttribute("Event");
        ...
        log.error("EsmCoa0166Event Exception : "+e.toString());
...
<table width="1000" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; BSA by VVD</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
