...
<%@ page import="com.clt.apps.opus.esm.coa.lanesimulation.event.EsmCoa0053Event"%>
...
<%
    ...
    Logger log = Logger.getLogger("com.clt.apps.opus.esm.coa.lanesimulation.EsmCoa0053Event");
    try {
					...
					<tr><td valign="top">
	                              <table class="search" border="0">
	                                  <tr>
	                                      ...
	                                      <td width="120" style="padding-right:5;"><img class="cursor" src="img/opus/cost_step02.gif" border="0" name="step02"></td>
	                                      <td width="120" style="padding-right:5;"><img class="cursor" src="img/opus/cost_step03_on.gif"    border="0" name="step03"></td>
	       	...
	       	<tr>
				<td class="bg">
					...
					<table class="search" border="0" width="100%">
						<tr>
							<td colspan="2" height="30" valign="top"><img src="img/opus/cost_step03s.gif" height="22" border="0"></td>
...
<!-- Tab1 ///////////////////////////////////////////////////////////////////////////////////////////////// -->
					...
					<tr><td class="bg">
	                            ...
	                            <table class="search" border="0">
	                                <tr>
	                                    <td class="gray_tit"><img src="img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">&nbsp;<input type="text" name="subtitle" style="width:234;" class="transgray" readonly></td>
	                                    <td class="gray" rowspan="2">(TEU)</td>
	                                </tr>
									...
									<tr>
										...
										<td align="right" valign="top" width="50%" height="18" >
											<div id="dir_bnk_consum" style="display:none">
												<img class="cursor" src="img/opus/ico_newwin.gif" width="11" height="12" align="absmiddle" hspace="5">
