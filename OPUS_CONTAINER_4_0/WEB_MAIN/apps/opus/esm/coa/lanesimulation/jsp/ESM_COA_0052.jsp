...
<%@ page import="com.clt.apps.opus.esm.coa.lanesimulation.event.EsmCoa0052Event"%>
<%@ page import="com.clt.framework.support.view.signon.SignOnUserAccount"%>
<%@ page import="com.clt.framework.component.util.io.HttpUtil"%>
<%
  	SignOnUserAccount account = (SignOnUserAccount) session.getAttribute(CommonWebKeys.SIGN_ON_USER_ACCOUNT);
    EsmCoa0052Event event     = null;     //PDTO(Data Transfer Object including Parameters)
    Exception serverException = null; //서버에서 발생한 에러
    String strErrMsg  = "";            //에러메세지
    String xml = "";
    String v_ext_flg  = "";

    Logger log = Logger.getLogger("com.clt.apps.opus.esm.coa.lanesimulation.EsmCoa0052");
    ...
    try {
        ...
        log.error("ESM_COA_052 Exception : "+e.toString());
                        ...
                        <td class="bg">
                            ...
                            <table class="search_in" border="0">
                                <tr class="h23">
                                    ...
                                    <td width="317">
										...
										<!--input type="text" style="width:75;" name="f_sim_dt" dataformat="ymd" onblur="ComAddSeparator(this);" onFocus="ComClearSeparator(this); this.select();" readOnly class="input2">
                            ...
                            <tr><td valign="top">
                                        <table class="search" border="0">
                                            <tr>
                                            	<td width="110">&nbsp;</td>
                                                <td width="120" style="padding-right:5;"><img class="cursor" src="img/opus/cost_step01.gif"    border="0" name="step01"></td>
                                                <td width="120" style="padding-right:5;"><img class="cursor" src="img/opus/cost_step02_on.gif" border="0" name="step02"></td>
                                                <td width="120" style="padding-right:5;"><img class="cursor" src="img/opus/cost_step03.gif"    border="0" name="step03"></td>
		     	...
		     	<table class="search" border="0">
			       	<tr>
						<td class="bg">
							...
							<table class="search" border="0">
								<tr><td height="30" valign="top"><img src="img/opus/cost_step02s.gif" height="22" border="0"></td></tr>
							</table>
							...
							<table class="search" border="0">
								<tr>
									<td class="bg">
										...
										<table class="search" border="0">
                      <tr class="h23">
                        <td class="gray_tit" style="padding-left:0;"><img src="img/ico_star.gif">&nbsp;<strong>Remark</strong></td>
                      </tr>
                      <tr class="h23">
                        <td class="gray_tit" colspan="2" style="padding-left:10;">
                          <img src="img/ico_hystory.gif" align="absmiddle" width="8" height="9" border="0">
