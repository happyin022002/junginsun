...
<%@ page import="com.clt.apps.opus.esm.coa.lanesimulation.event.EsmCoa0165Event"%>
<%
    ...
    Logger log = Logger.getLogger("com.clt.apps.opus.esm.coa.lanesimulation.ESM_COA_165");
...
<table width="900" class="popup" cellpadding="10" border="0">
	...
	<tr>
		...
		<tr><td height="79" class="title"><img src="img/icon_title_dot.gif" align="absmiddle">&nbsp; File Mgmt</td></tr>
		</table>
		<!-- : ( Title ) (E) -->
