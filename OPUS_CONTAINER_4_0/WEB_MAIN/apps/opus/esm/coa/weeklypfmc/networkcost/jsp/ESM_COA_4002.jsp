...
<%@ page import="com.clt.apps.opus.esm.coa.weeklypfmc.networkcost.event.EsmCoa4002Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCoa4002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCoa4002Event)request.getAttribute("Event");
		...
		<table>
			<tbody>
				<colgroup>
			    	...
			    	<tr><td colspan="6"><script type="text/javascript">coaPeriod1("1","O");</script></td></tr>
					<tr>
						<th>Trade</th>
		                <td width="170">&nbsp;<script type="text/javascript">ComComboObject('f_seltrade',1, 100 , 0 )</script></td>
		                <th>Lane</th>
		                <td width="180"><div id="div_rLane">&nbsp;<script type="text/javascript">ComComboObject('f_selrlane',1, 100 , 0 )</script></div></td>
