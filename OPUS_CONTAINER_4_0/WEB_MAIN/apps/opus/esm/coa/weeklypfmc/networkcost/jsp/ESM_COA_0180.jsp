...
<%@ page import="com.clt.apps.opus.esm.coa.weeklypfmc.networkcost.event.EsmCoa0180Event"%>
	...
	<div class= "opus_design_inquiry wFit">
		<table>
			<tbody>
		    	...
		    	<tr><td colspan="6"><script type="text/javascript">coaPeriod1("1","");</script></td></tr>
				<tr>
					<th>Trade</th>
