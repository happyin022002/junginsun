...
/*------------------Code for JSDoc creation below ------------------*/
   /**
    ...
    /**
     * @extends 
     * @class ESM_COA_0180 : ESM_COA_0180 Business script for the UI
     */
   	/* Developer's task	*/
	//Grobal Variable
	...
	function initSheet(sheetObj,sheetNo) {
		...
		switch(sheetNo) {
			case 1:		//sheet1 init
			    with(sheetObj){
		     //   (7, 0, 0, true);
		      var HeadTitle="STS|Trade|R.Lane|VVD|Load|Unit Cost|Total Expense";
		      var cnt=0;
		      ...
		      var cols = [ {Type:"Status",    Hidden:0, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"ibflag",                  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"Text",      Hidden:0,  Width:80,   Align:"Right",   ColMerge:1,   SaveName:"cntr_lod_qty",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"Text",      Hidden:0,  Width:80,   Align:"Right",   ColMerge:1,   SaveName:"inter_prc_uc_amt",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"Text",      Hidden:0,  Width:100,  Align:"Right",   ColMerge:1,   SaveName:"inter_prc_ttl_expn_amt",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
	        case IBCLEAR:          //Inquiry
				...
				var sXml=sheetObj.GetSearchData("ESM_COA_0180GS2.do", coaFormQueryString(formObj));
	        ...
	        case IBSEARCH:      //Inquiry
				...
				formObj.f_cmd.value=SEARCHLIST;
 				sheetObj.DoSearch("ESM_COA_0180GS.do", coaFormQueryString(formObj) );
				break;
				...
				if (sheetObj.RowCount()> 0) {
                    if (ComShowConfirm(ComGetMsg('COA10020')) == true) { 
                        ...
                        setTimeout( function () {
	                        ...
	                        var sXml = sheetObj.GetSaveData("ESM_COA_0180GS.do", sParam );
