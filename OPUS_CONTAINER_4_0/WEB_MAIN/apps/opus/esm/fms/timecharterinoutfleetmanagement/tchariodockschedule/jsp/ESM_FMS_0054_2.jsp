...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutfleetmanagement.tchariodockschedule.event.EsmFms00542Event"%>
...
<input type="hidden" name="dck_sel_cd" value="C" id="dck_sel_cd" />
	...
	<div class="opus_design_inquiry wFit">
		<table>
		   ...
		   <tbody>
		   		<tr>
		   			<th>Vessel Code</th>
					<td><input type="text" onchange="vsl_cd_change()" dataformat="engup" style="width:54px;text-align:center;" class="input1" value="" maxlength="4" name="vsl_cd" required fullfill caption="Vessel Code" id="vsl_cd" /><button type="button" id="btn_vslpop" name="btn_vslpop" class="input_seach_btn"></button><input type="text" style="width:162px;" class="input2" name="vsl_eng_nm" readonly value="" id="vsl_eng_nm" /></td>
		   		</tr>
		   </tbody>
		</table>
	</div>
