...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutfleetmanagement.tchariodeliveryschedule.event.EsmFms0020Event"%>
	...
	<div class="opus_design_inquiry wFit">
		<table>
		   ...
		   <tbody>
	   		<tr>
		   		<th>Search Period</th>
				<td class="stm"><input type="radio" name="btn_periodFlag" id="btn_periodFlag" value="" class="trans" checked>Date&nbsp;&nbsp;&nbsp;<input type="radio" name="btn_periodFlag" value="" class="trans">Month&nbsp;&nbsp;&nbsp;<input type="radio" name="btn_periodFlag" value="" class="trans">Year</td>
				<th>Duration</th>
				<td>
		...
		<table>
		   ...
		   <tbody>
				...
				<th>Owner</th>
				<td><input type="text" name="ownrNm" style="width:204px;" class="input" value="" readonly><!-- 
		...
		<table>
		   ...
		   <tbody>
		   		<tr>
					...
					<td><input type="text" name="shpNm" maxlength="50" style="width:204px;" class="input" value=""></td>
		   		</tr>
		   </tbody>
		</table>
	</div>
