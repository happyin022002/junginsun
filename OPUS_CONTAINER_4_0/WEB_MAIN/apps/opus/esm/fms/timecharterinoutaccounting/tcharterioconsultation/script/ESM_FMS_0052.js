 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ESM_FMS_0052 : ESM_FMS_0052 definition of biz script for creation screen
     */
    	...
    	try {
            ...
            switch(srcName) {
				...
				case "btn_save":
                    ...
                    break;
				case "btn_slip":
					if(sheetObject.GetSelectRow()> 0){
						var csr_no=formObject.slp_no.value;
						var vsl_cd=formObject.vsl_code.value;
						var vsl_eng_nm=formObject.vsl_eng_name.value;
						var csr_curr_cd=sheetObject.GetCellValue(sheetObject.GetSelectRow(), "csr_curr_cd");
						ComOpenPopup("ESM_FMS_0042.do?csr_no="+ csr_no+"&vsl_cd="+vsl_cd+"&vsl_eng_nm="+vsl_eng_nm+"&csr_curr_cd="+csr_curr_cd, 1024, 550, "setSlipInquiry", "1,0,1,1,1,1", true, false, null, null, 0, "ESM_FMS_0042");
					} else {
    ...
    function initSheet(sheetObj,sheetNo) {
        ...
        switch(sheetNo) {
            case 1:      //sheet1 init
                with(sheetObj){
//		              (23, 0, 0, true);
		              var HeadTitle1="|Seq|CSR No.|CSR Date|Produced By|Currency|CSR Amount|CSR Description|Approval|Request Team|Rqst Date|Ownr Code|Ownr Name|Evid Type|Deduction|Rqst Amt|Diff Desc|Cxl Flg|Cxl Desc|Vsl Code|Vsl Eng Name|flet_ctrt_tp_cd|slip_type|ownr_full_nm|ownr_tp_cd";
		              ...
		              var cols = [ {Type:"Status",    Hidden:1, Width:00,   Align:"Center",  ColMerge:0,   SaveName:"Status" },
		                     ...
		                     {Type:"Text",      Hidden:1, Width:70,   Align:"Center",  ColMerge:0,   SaveName:"apro_flg",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		                     ...
		                     {Type:"Text",      Hidden:1, Width:120,  Align:"Center",  ColMerge:0,   SaveName:"slip_type",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
        ...
        switch(sAction) {
           case IBSEARCH:      
           	...
           	case IBSAVE:        
 				...
 				var sXml=sheetObj.GetSaveData("ESM_FMS_0052GS.do", FormQueryString(formObj));
    ...
    function initControl() {
        ...
        // axon_event.addListener  ('click'   , 'condition_click' , 'condition');		// Control Date Field when clicking Condition 
        // axon_event.addListener  ('click'   , 'approval_click'  , 'apro_flg');		///Control Field related to Cancel when clicking Approval
    ...
    /**
     * Control Date Field when clicking Condition <br>
     **/
    ...
    /**
     * Control Field related to Cancel when clicking Approval <br>
     **/
...
// 		document.images["btn_vslpop"].name="btn_vslpop";
    ...
    function validateForm(sheetObj,formObj,sAction){
        ...
        if (sAction == IBSAVE) {
        	...
        	if (formObj.apro_flg[0].checked) {
        		sheetObjects[0].SetCellValue(sheetObjects[0].GetSelectRow(), "apro_flg","Y");
        	} else {
        		sheetObjects[0].SetCellValue(sheetObjects[0].GetSelectRow(), "apro_flg","N");
        		sheetObjects[0].SetCellValue(sheetObjects[0].GetSelectRow(), "cxl_flg","Y");
        		sheetObjects[0].SetCellValue(sheetObjects[0].GetSelectRow(), "cxl_desc",formObj.cxl_desc.value);
        	}
        	formObj.flet_ctrt_tp_cd.value=sheetObjects[0].GetCellValue(sheetObjects[0].GetSelectRow(), "flet_ctrt_tp_cd");
        	formObj.save_csr_no.value=sheetObjects[0].GetCellValue(sheetObjects[0].GetSelectRow(), "csr_no");
	        }
        return true;
    }
    /**
    ...
    function setCsrHeadInfomation(sheetObj, row) {
    	...
    	if(sheetObj.GetCellValue(row,"apro_flg") == "Y") {
		...
		//Control Field related to Cancel by Approval
		approval_click();
		...
		form.slip_type.value=sheetObj.GetCellValue(row,"slip_type");
