...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharterioconsultation.event.EsmFms0087Event"%>
...
<%
	...
	String csrType = StringUtil.xssFilter(request.getParameter("csr_type"));
%>
...
<input type="hidden" name="csr_type" value="<%=csrType%>" id="csr_type" />

<!-- page_title_area(S) -->
<div class="page_title_area clear">

	<!-- page_title(S) -->
	<h2 class="page_title"><span>Slip Selection</span></h2>
	<!-- page_title(E) -->
