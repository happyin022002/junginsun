...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharterioconsultation.event.EsmFms0043Event"%>
	...
	<div class="opus_design_inquiry wFit">
		<table>
		   ...
		   <tbody>
		   		<tr>
		   			<th>Condition</th>
					<td><input type="radio" value="E" class="trans" name="condition" onclick="condition_click()" checked="" id="condition" /> Effective    <input type="radio" onclick="condition_click()" value="C" name="condition" class="trans" id="condition" /> CSR Date </td>
		...
		<table> 
			...
			<tr>
				<th>Vessel Code</th>
				<td><input type="text" dataformat="engup" onchange="vsl_cd_change()" style="width:56px;text-align:center;" class="input" maxlength="4" name="vsl_cd" id="vsl_cd" /><button type="button" id="btn_vslpop" name="btn_vslpop" class="input_seach_btn"></button><input type="text" style="width:150px;" class="input2" name="vsl_eng_nm" readonly id="vsl_eng_nm" /></td>
				<th>CSR No.</th>
				<td><input type="text" style="width:224px;" class="input" name="csr_no" maxlength="22" id="csr_no" /> </td>
			</tr>
		</table>
	</div>
...
<div class="wrap_result">
	...
	<div class="opus_design_grid">
		<h3 class="title_design mar_btm_8">Correction Result List</h3>
...
<div class="wrap_result bg">
	...
	<div class="opus_design_inquiry wFit">
		...
		<table> 
			...
			<tr>
					<th>Request Team</th>
					<td><input type="text" style="width:120px;text-align:center;" class="input2" id="request_team" name="request_team" readonly></td>
					<th>CSR Date</th>
					<td><input type="text" style="width:80px;text-align:center;" class="input2" name="csr_dt" id="csr_dt" readonly></td>
					<th>Request Date</th>
					<td><input type="text" style="width:80px;text-align:center;" class="input2" name="rqst_dt" id="rqst_dt" readonly></td>
			</tr>
		</table>
		<table>
			<colgroup>
			...
			<tr>
				<th>Produced By  </th>
				<td><input type="text" style="width:120px;text-align:center;" class="input2" name="produced_by" id="produced_by" readonly></td>
				<th>CSR Desc</th>
				<td><input type="text" style="width:370px;" class="input" name="csr_desc" id="csr_desc"></td>
			</tr>
		</table>
		<table>
			<colgroup>
		...
		<table>
			...
			<tr>
				...
				<td></td>
				<th>Cancel Remark</th>
				<td><input type="text" style="width:370px;" maxlength="100" class="input2" name="cxl_desc" readonly caption="Cancel Remark" id="cxl_desc" /> <input type="hidden" name="slp_no" id="slp_no" /> <input type="hidden" name="vsl_code" id="vsl_code" /> <input type="hidden" name="vsl_eng_name" id="vsl_eng_name" /> <input type="hidden" name="sel_row"></td>
			</tr>
		</table>
	</div>	
	<!-- opus_design_inquiry(E) -->
