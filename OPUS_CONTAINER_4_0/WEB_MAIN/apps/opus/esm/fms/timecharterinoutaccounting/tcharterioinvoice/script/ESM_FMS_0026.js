 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class ESM_FMS_0026 : ESM_FMS_0026 definition of biz script for creation screen
     */
				...
				switch(srcName) {
			        case "btn_confirm":
	    	        	...
	    	        	for(var i=0; i<sheetObject.LastRow();i++) {
	    	        		...
	    	        		offhireExpData.acct_nm=sheetObject.GetCellValue(row,"acct_nm");
							offhireExpData.acct_cd=sheetObject.GetCellValue(row,"acct_cd");
							offhireExpData.vvd_bunker=sheetObject.GetCellValue(row,"vvd_bunker");
							offhireExpData.curr_cd=sheetObject.GetCellValue(row,"curr_cd");
							offhireExpData.inv_amt=sheetObject.GetCellValue(row,"inv_amt");
							offhireExpData.inv_desc=sheetObject.GetCellValue(row,"inv_desc");
							offhireExpData.ctr_cd=sheetObject.GetCellValue(row,"ctr_cd");
							offhireExpData.slp_loc_cd=sheetObject.GetCellValue(row,"slp_loc_cd");
							offhireExpData.flet_iss_tp_cd=sheetObject.GetCellValue(row,"flet_iss_tp_cd");
							offhireExpData.inv_seq=sheetObject.GetCellValue(row,"inv_seq");
							offhireExpData.inv_dtl_seq=sheetObject.GetCellValue(row,"inv_dtl_seq");
							offhireExpData.flet_src_tp_cd=sheetObject.GetCellValue(row,"flet_src_tp_cd");
							offhireExpData.eff_dt=sheetObject.GetCellValue(row,"eff_dt");
							offhireExpData.exp_dt=sheetObject.GetCellValue(row,"exp_dt");
							offhireExpData.flet_ctrt_no=sheetObject.GetCellValue(row,"flet_ctrt_no");
	    	        		aryData[idx++]=offhireExpData;
	    	        	}
	    	        	localopener.setOffhireExp(aryData);
	    				ComClosePopup(); 
						break;
			        case "btn_close":
			        	ComClosePopup(); 
        ...
        switch(sheetNo) {
            case 1:
             ...
             var cols = [ {Type:"Status",    Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
                 ...
                 {Type:"Text",      Hidden:0,  Width:200,  Align:"Center",  ColMerge:0,   SaveName:"duration",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                 ...
                 {Type:"Text",      Hidden:0,  Width:300,  Align:"Left",    ColMerge:0,   SaveName:"inv_desc",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                 ...
                 {Type:"Text",      Hidden:1, Width:65,   Align:"Center",  ColMerge:1,   SaveName:"eff_dt",          KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                 {Type:"Text",      Hidden:1, Width:65,   Align:"Center",  ColMerge:1,   SaveName:"exp_dt",          KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
