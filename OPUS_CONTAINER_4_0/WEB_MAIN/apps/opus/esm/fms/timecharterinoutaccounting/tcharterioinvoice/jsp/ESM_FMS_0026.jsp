...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharterioinvoice.event.EsmFms0026Event"%>
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title"><span>Offhire Expenses Selection</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
