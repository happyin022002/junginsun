...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharterioestimated.event.EsmFms0048Event"%>
		   ...
		   <tbody>
		   		<tr>
					...
					<td><input type="text" name="exe_yrmon" style="width:60px;text-align:center;ime-mode:disabled; " class="input1" maxlength="6" dataformat="ym" required=""  caption="Accrual Month" id="exe_yrmon" /><button type="button" id="btn_exe_yrmon" name="btn_exe_yrmon" class="calendar ir"></button></td>
		   			<th>Revenue Month</th>
					<td><!--
					--><input type="text" name="fr_duration" style="width:60px;text-align:center;ime-mode:disabled;" class="input1" maxlength="6" dataformat="ym" required caption="Revenue From Month" id="fr_duration" /><!--
					--><button type="button" id="btn_fr_duration" name="btn_fr_duration" class="calendar ir"></button>~ <!--
					--><input type="text" name="to_duration" style="width:60px;text-align:center;ime-mode:disabled; " class="input1" maxlength="6" dataformat="ym" required caption="Revenue To Month" id="to_duration" /><!--
