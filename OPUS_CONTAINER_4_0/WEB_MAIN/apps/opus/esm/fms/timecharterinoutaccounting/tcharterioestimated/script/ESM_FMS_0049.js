...
//						sheetObject.Down2Excel( {DownCols: makeHiddenSkipCol(sheetObject), SheetDesign:0,Merge:1 });
...
function initSheet(sheetObj,sheetNo) {
    ...
    switch(sheetNo) {
        case 1:      //sheet1 init
            with(sheetObj){
	              var HeadTitle="|Seq|Rev. Month|Activity Date|Rev./Exp.|VVD|Daily Hire|FMS VVD Duration|FMS VVD Duration|Total\nVoy Days|Working\nDays|Account Name|Estimated|Actual VVD Duration|Actual VVD Duration|Actual|Accrual|vsl_cd|skd_voy_no|skd_dir_cd|rev_dir_cd|exe_yrmon|rlane_cd|acct_cd|ori_hire_eff_dt|ori_hire_exp_dt|estm_seq_no|estm_vvd_tp_cd";
	              ...
	              var cols = [ 
			                     ...
			                     {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"vst_dt",           KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   	UpdateEdit:0,   InsertEdit:0 },
			                     {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"ved_dt",           KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   	UpdateEdit:0,   InsertEdit:0 },
			                     ...
			                     {Type:"Text",      Hidden:0, Width:150,  Align:"Center",  ColMerge:0,   SaveName:"acct_itm_nm",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   	UpdateEdit:0,   InsertEdit:0 },
			                     ...
			                     {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"slp_eff_dt",       KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   	UpdateEdit:0,   InsertEdit:0 },
			                     {Type:"Date",      Hidden:0, Width:80,   Align:"Center",  ColMerge:1,   SaveName:"slp_exp_dt",       KeyField:0,   CalcLogic:"",   Format:"Ymd",         PointCount:0,   	UpdateEdit:0,   InsertEdit:0 },
...
function doActionIBSheet(sheetObj,formObj,sAction, Col, Row) {
    ...
    switch(sAction) {
     	case IBSEARCH:      
        		...
        		sheetObj.DoSearch("ESM_FMS_0049GS.do", FormQueryString(formObj));
        		//sheet1.ShowSubSum([{StdCol:"subsumcol", SumCols:"est_amt|act_amt|acc_amt", Sort:false, ShowCumulate:false, CaptionCol:8, CaptionText:"TotalAmount"}]);
...
function sheet1_OnSearchEnd(sheetObj,ErrMsg){
	...
	//sheet1.ShowSubSum([{StdCol:"subsumcol", SumCols:"10|13|15", Sort:false, ShowCumulate:false, CaptionCol:8, CaptionText:"TotalAmount"}]);
	//sheetObj.SetSumText();
}
...
function rdOpen(formObject){
	...
	var rdFile = 'apps/opus/esm/fms/timecharterinoutaccounting/tcharterioestimated/report/ESM_FMS_047.mrd';
