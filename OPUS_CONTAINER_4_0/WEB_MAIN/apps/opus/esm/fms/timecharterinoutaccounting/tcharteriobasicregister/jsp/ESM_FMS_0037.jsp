...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharteriobasicregister.event.EsmFms0037Event"%>
...
<div class="opus_design_btn"><!--
	...
	--><button class="btn_normal" name="btn_vvdcreation" id="btn_vvdcreation" type="button">Creation From SKD/Rev. VVD</button><!--
	--><button class="btn_normal" name="btn_vvdfinalizing" id="btn_vvdfinalizing" type="button">Creation From Estimation VVD</button><!--
	--></div>
<!-- opus_design_btn (E) -->
	...
	<div class="opus_design_inquiry wFit">	
		<table class="mar_btm_4">
		   ...
		   <tbody>
		   		<tr>
		   			<th>Revenue Month</th>
					<td><input type="text" name="rev_yrmon" style="width:60px;text-align:center;ime-mode:disabled;" class="input1" dataformat="ym" maxlength="7" required caption="Period" ><!-- 
					 --><button type="button" name="btn_period" id="btn_period"  class="calendar ir"></button></td>
					<th>Service Lane</th>
					<td><input type="text" name="slan_cd" maxlength="3" style="width:60px;text-align:center;ime-mode:disabled;" dataformat="engup" class="input" value=""><!-- 
