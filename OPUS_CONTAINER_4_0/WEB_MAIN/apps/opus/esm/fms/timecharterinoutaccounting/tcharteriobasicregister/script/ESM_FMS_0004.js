...
*@FileName   : esm_fms_0004.jsp
*@FileTitle  : Vendor Code Entry
*@author     : CLT
*@version    : 1.0
*@since      : 2014/06/16
=========================================================*/
 ...
 ***************************************************************************************/
    /**
     * @extends 
     * @class Vendor Code : Vendor Code definition of biz script for creation screen
     */
...
//					sheetObject.SetCellValue(row, "flet_ownr_tp_cd")='';
...
//					sheetObject.SetCellValue(row, "flet_ownr_tp_cd")='';
    ...
    function loadPage() {
        ...
        initControl();
        /* [UI개선_수정(DO-HYUN KIM) - 2014.08.04] */
...
//              (9, 0, 0, true);
              ...
              var cols = [ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                     ...
                     {Type:"PopupEdit", Hidden:0, Width:105,  Align:"Center",  ColMerge:0,   SaveName:"vndr_seq",                 KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:6 },
                     {Type:"Text",      Hidden:0,  Width:315,  Align:"Left",    ColMerge:0,   SaveName:"vndr_lgl_eng_nm",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
                     {Type:"Text",      Hidden:1, Width:0,    Align:"Center",  ColMerge:1,   SaveName:"flet_mgmt_ownr_vndr_seq" },
                     {Type:"Popup",     Hidden:0, Width:240,  Align:"Left",    ColMerge:0,   SaveName:"ownr_nm",                  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
                     ...
                     {Type:"Text",      Hidden:1, Width:90,   Align:"Center",  ColMerge:0,   SaveName:"tax_required",             KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
               
              InitColumns(cols);

              SetEditable(1);
              SetShowButtonImage(2);
              SetColProperty("vndr_seq", {Format:"######"} );
              SetSelectionMode(smSelectionRow);
              SetDataLinkMouse("vndr_seq",1);
    ...
    function doActionIBSheet(sheetObj,formObj, sAction, Col, Row) {
        ...
        switch(sAction) {
			...
			case IBROWSEARCH:   
	    		...
	    		} else if (Col == "vndr_seq") {// Inserting Vendor/Customer code directly
					formObj.f_cmd.value=SEARCH01;
					var sXml=sheetObj.GetSearchData("ESM_FMS_0070GS.do" , FormQueryString(formObj)+"&cond_flag=VM&cd_cnt=&cd_seq="+sheetObj.GetCellValue(Row,Col));
    ...
    function setVendorCustomerName(sheetObj, sXml, Row, Col) {
    	if (sXml != "" ) {
			if (ComGetEtcData(sXml, "cdName") != undefined) {
				sheetObj.SetCellValue(Row,"vndr_lgl_eng_nm",ComGetEtcData(sXml, "cdName"));
	    	} else {
				sheetObj.SetCellValue(Row,"vndr_seq",'',0);
				sheetObj.SetCellValue(Row,"vndr_lgl_eng_nm",'',0);
...
//             }
 	...
 	function sheet1_OnPopupClick(sheetObj, Row,Col)
 		{
 			if (sheetObj.ColSaveName(Col) == "vndr_seq") {
 				ComOpenPopup("ESM_FMS_0070.do?condFlag=VP", 580, 432, "setVendorCode", "1,0,1,1,1,1", true, false, Row, Col, 0, "ESM_FMS_0070");
	...
	function setOwnerName(aryPopupData, Row, Col, sheetIdx){
		...
		sheetObjects[0].SetCellValue(Row,"flet_mgmt_ownr_vndr_seq",aryPopupData[0][3],0);
