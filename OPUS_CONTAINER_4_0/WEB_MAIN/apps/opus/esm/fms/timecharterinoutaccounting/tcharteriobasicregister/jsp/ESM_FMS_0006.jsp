...
<%@ page import="com.clt.apps.opus.esm.fms.timecharterinoutaccounting.tcharteriobasicregister.event.EsmFms0006Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmFms0006Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmFms0006Event)request.getAttribute("Event");
