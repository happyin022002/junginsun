...
<%@ page import="com.clt.apps.opus.esm.csq.adjustment.qtaadjustment.event.EsmCsq0051Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0051Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0051Event)request.getAttribute("Event");
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>N.OB/OB</th>
					<td><script type="text/javascript">ComComboObject('f_ob_div_cd', 1, 80, 1)</script></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<div class="wrap_result">
	...
	<div class="opus_design_grid">
		<div class="opus_design_btn">
			<button class="btn_normal" name="btn_FigureInquiry" id="btn_FigureInquiry" type="button">Figure Inquiry</button><!--  
			--><button class="btn_normal" name="btn_RowGrpAdd" id="btn_RowGrpAdd" type="button">RHQ Group Row Add</button><!--  
			--><button class="btn_normal" name="btn_RowAdd" id="btn_RowAdd" type="button">RHQ Row Add</button>
		</div>
		<div class="opus_design_inquiry">
			<table>
				...
				<tbody>
					<tr>
						<td style="text-align:right;" id="sheet_unit">[Unit: %]</td>
					</tr>
				</tbody>
			</table>
		</div>
