...
*@FileName   : ESM_CSQ_0052.jsp
*@FileTitle  : Portion Adjustment by Head Office_Figure Inquiry
*@author     : CLT
*@version    : 1.0
*@since      : 2015/02/06
=========================================================*/
...
<div class="page_title_area clear">
	 <!-- page_title(S) -->
	 <h2 class="page_title"><span>Portion Adjustment by Head Office_Figure Inquiry</span></h2>
	 <!-- page_title(e) -->
			...
			<table class="search">
			   ...
			   <tbody>
	               ...
	               <tr>
		                 ...
		                 <th>Trade Bound</th>
		                 <td><input type="text" style="text-align:center; width:55px; ime-mode:disabled" name="f_conv_dir_cd" class="input2" readonly maxlength="20" value="<%=dirCd%>"></td>
	                 	 <th>N.OB/OB</th>
