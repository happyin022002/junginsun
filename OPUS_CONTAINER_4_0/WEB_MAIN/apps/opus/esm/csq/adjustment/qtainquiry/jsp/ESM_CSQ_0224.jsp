...
<%@ page import="com.clt.apps.opus.esm.csq.adjustment.qtainquiry.event.EsmCsq0224Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0224Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0224Event)request.getAttribute("Event");
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>Office Level</th>
					<td><script type="text/javascript">ComComboObject('f_ofc_lvl', 1, 85, 1, 1)</script></td>
			...
			<tbody>
				<tr>
					...
					<td><div id="div_mon" style="display:inline"><!--  
							...
							--><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" onkeypress="ComKeyOnlyNumber(window);" name="f_to_mon" id="f_to_mon"><!--  
						--></div><!--  
						--><div id="div_wk" style="display:none"><!--  
							...
							--><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" onkeypress="ComKeyOnlyNumber(window);" name="f_to_wk" id="f_to_wk"><!--  
						--></div></td>
					...
					<th>R/Lane</th>
					<td><script type="text/javascript">ComComboObject('f_rlane_cd', 1, 85, 1)</script></td>
					<th>POL</th>
