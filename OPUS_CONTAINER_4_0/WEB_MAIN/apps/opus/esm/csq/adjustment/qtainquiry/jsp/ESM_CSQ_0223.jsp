...
<%@ page import="com.clt.apps.opus.esm.csq.adjustment.qtainquiry.event.EsmCsq0223Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0223Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0223Event)request.getAttribute("Event");
			...
			<tbody>
				<tr>
					...
					<td><div id="div_mon" style="display:inline"><!--  
										--><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" onkeypress="ComKeyOnlyNumber(window);" name="f_fm_mon" id="f_fm_mon"><span class="dash">~</span><!--  
										--><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" onkeypress="ComKeyOnlyNumber(window);" name="f_to_mon" id="f_to_mon"></div><!--  
									--><div id="div_wk" style="display:none"><!--  
										--><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" onkeypress="ComKeyOnlyNumber(window);" name="f_fm_wk" id="f_fm_wk"><span class="dash">~</span><!--  
										--><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" onkeypress="ComKeyOnlyNumber(window);" name="f_to_wk" id="f_to_wk"></div></td>
					...
					<th>Sub Trade</th>
					<td><script type="text/javascript">ComComboObject('f_sub_trd_cd', 1, 75, 1)</script></td>
					...
					<td><div id="div_main_sel" style="display:none;"><!--  
						--><select  name="f_csq_mn_sctr_flg" id="f_csq_mn_sctr_flg" style="width:60px;" class="input">
	...
	<div class="opus_design_grid">
		<div class="opus_design_inquiry">
			<table>
				...
				<tbody>
					<tr class="h23">
						<th><input type="checkbox" value="W" name="f_chk_week" id="f_chk_week" class="trans"><label for="f_chk_week">Week</label></th>
						<th><input type="checkbox" value="V" name="f_chk_vvd" id="f_chk_vvd" class="trans"><label for="f_chk_vvd">VVD</label></th>
						<th><input type="checkbox" value="Y" name="f_chk_pair" id="f_chk_pair" class="trans"><label for="f_chk_pair">POL-POD Pair</label></th>
