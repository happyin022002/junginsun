...
/**
 * @extends 
 * @class ESM_CSQ_0037 : ESM_CSQ_0037 �앹꽦���꾪븳 �붾㈃�먯꽌 �ъ슜�섎뒗 �낅Т �ㅽ겕由쏀듃瑜��뺤쓽�쒕떎.
 */
	/* 媛쒕컻���묒뾽	*/
	//怨듯넻�꾩뿭蹂�닔
			...
			case 1:		//sheet1 init
			    with(sheetObj){
			        ...
			        var cols = [ {Type:"Seq",       Hidden:0, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"seq",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             ...
			             {Type:"AutoSum",   Hidden:0, Width:65,   Align:"Right",   ColMerge:1,   SaveName:"fnl_bsa_capa",  KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		...
		switch(sAction) {
			case IBCLEAR:          // �붾㈃ �묒냽 ��
				...
				var sXml=sheetObj.GetSearchData("ESM_CSQ_0037GS.do", FormQueryString(formObj));
			...
			case IBSEARCH:          //�붾㈃ 議고쉶��
				...
				var rtnXml=sheetObj.GetSearchData("ESM_CSQ_0037GS.do",FormQueryString(formObj));
	  ...
	  */
	  function sheet1_OnSearchEnd(sheetObj, ErrMsg){
	 	...
	 	if(comboObjects[2].GetSelectCode()== "01"){
	  ...
	  function validateForm(sheetObj, formObj, sAction){
	  	switch(sAction) {
	  		case IBSEARCH:  // �붾㈃ 議고쉶�쒖뿉
	  			var yr=ComGetObjValue(f_bse_yr); //Quarter
	  			if (formObj.f_fm_mon.value != "" && formObj.f_to_mon.value != ""){
	  				if (formObj.f_fm_mon.value < "00" ||formObj.f_to_mon.value > "53"){
	  						ComShowCodeMessage('CSQ00025',yr); 
	  						return false;
	  				}
	  			} else {
	  				if(formObj.f_fm_mon.value==""&&formObj.f_to_mon.value==""){
