...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planninginquiry.event.EsmCsq0037Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0037Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0037Event)request.getAttribute("Event");
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tbody>
				...
				<tr>
					<th>Month</th>
					<td><input type="text" style="text-align: center; width: 31px" class="input" size="3" maxlength="2" dataformat="num" name="f_fm_mon" id="f_fm_mon" />~ <input type="text" style="text-align: center; width: 32px" class="input" dataformat="num" size="3" maxlength="2" name="f_to_mon" id="f_to_mon"></td>
					<th>Trade</th>
