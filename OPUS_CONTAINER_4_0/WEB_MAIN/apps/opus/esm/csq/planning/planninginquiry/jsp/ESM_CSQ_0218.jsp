...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planninginquiry.event.EsmCsq0218Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0218Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0218Event)request.getAttribute("Event");
	...
	<div class="opus_design_inquiry wFit">
		<table>
			...
			<tbody>
				<tr>
					<th>Year</th>
					<td><script type="text/javascript">ComComboObject('f_bse_yr', 1, 80, 1, 1 )</script></td>
					<th>Quarter</th>
					...
					<th>Office Level</th>
					<td><script type="text/javascript">ComComboObject('f_ofc_lvl', 1, 70, 1, 1)</script></td>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td><input type="text" style="text-align:center;" class="input" size="2" maxlength="2" dataformat="num" name="f_fm_mon"><span class="dash">~</span>
						<input type="text" style="text-align:center;" class="input" size="2" maxlength="2" dataformat="num" name="f_to_mon"></td>
					<th>Sub Trade</th>
					...
					<td><div id="div_main_sel" style="display:none;">
							<select  name="f_csq_mn_sctr_flg" style="width:70;" class="input">
