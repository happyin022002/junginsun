...
/**
 * @extends 
 * @class ESM_CSQ_0023 : ESM_CSQ_0023 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
	/* 개발자 작업	*/
	//공통전역변수
	...
	function initSheet(sheetObj,sheetNo) {
		...
		switch(sheetNo) {
			case 1:		//sheet1 init
			    with(sheetObj){
		        var HeadTitle1="SEQ|Year|Quarter|N.OB/OB|Office View|Trade|Trade\nBound|RHQ|RHQ Load QTA Summary|RHQ Load QTA Summary|RHQ Load QTA Summary|RHQ G.REV QTA Summary|RHQ G.REV QTA Summary|RHQ G.REV QTA Summary|RHQ Past PFMC Per Week|RHQ Past PFMC Per Week|RHQ Past PFMC Per Week|RHQ Past PFMC Per Week|RHQ Simulation vs RHQ Past PFMC|RHQ Simulation vs RHQ Past PFMC|RHQ Simulation vs RHQ Past PFMC|RHQ Simulation vs RHQ Past PFMC";
		        var HeadTitle2="SEQ|Year|Quarter|N.OB/OB|Office View|Trade|Trade\nBound|RHQ|TTL Load|Weekly Load|RHQ %|TTL G.REV|Weekly G.REV|RHQ %|Load|Load %|G.REV|G.REV %|Load|Load %|G.REV|G.REV %";
		        ...
		        var cols = [ {Type:"Seq",       Hidden:0, Width:30,   Align:"Center",  ColMerge:1,   SaveName:"seq",           KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  ColMerge:1,   SaveName:"rhq_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"rhq_qty",       KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"rhq_wk_qty",    KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"rhq_qty_rto",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"AutoSum",   Hidden:0, Width:90,   Align:"Right",   ColMerge:1,   SaveName:"rhq_rev",       KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"AutoSum",   Hidden:0, Width:90,   Align:"Right",   ColMerge:1,   SaveName:"rhq_wk_rev",    KeyField:0,   CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"rhq_rev_rto",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"pst_qty_rto",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"pst_rev_rto",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"diff_qty_rto",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		             ...
		             {Type:"AutoSum",   Hidden:0, Width:80,   Align:"Right",   ColMerge:1,   SaveName:"diff_rev_rto",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
		        InitColumns(cols);
		        SetEditable(0);
		        SetRangeBackColor(1, 8, 1, 21, "#555555");
		        SetSheetHeight(300);
	            }
			break;
		}
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		...
		switch(sAction) {
			case IBSEARCH:          // 화면 조회 시
				...
				var rtnXml=sheetObj.GetSearchData("ESM_CSQ_0023GS.do", searchParams);
