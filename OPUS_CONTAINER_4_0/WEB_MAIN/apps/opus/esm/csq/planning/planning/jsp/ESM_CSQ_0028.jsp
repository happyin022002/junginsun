...
*@FileName   : ESM_CSQ_0028.jsp
*@FileTitle  : QTA Set up by RHQ_NON OB Contract_Office Distribute Result
*@author     : CLT
*@version    : 1.0
*@since      : 2015/02/09
=========================================================*/
...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planning.event.EsmCsq0025Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0025Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0025Event)request.getAttribute("Event");
...
<input type="hidden" name="f_ob_div_cd" value="N" id="f_ob_div_cd" />
<!-- 개발자 작업	-->

<!-- page_title_area(S) -->
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><span>QTA Set up by RHQ_NON OB Contract_Office Distribute Result</span></h2>
	<!-- page_title(E) -->
		...
		<div class="opus_design_inquiry wFit">
			<table class="search">
				...
				<tr>
					...
					<th>R/Lane</th>
					<td><input type="text" style="text-align:center; width: 50px; ime-mode:disabled" name="f_rlane_cd" class="input2" maxlength="20" readOnly value="<%=rlaneCd%>"></td>
					<th>Trade Bound</th>
					<td><input type="text" style="text-align:center; width:55px; ime-mode:disabled" name="f_dir_cd" class="input2" maxlength="20" readOnly value="<%=dirCd%>"></td>
					<th>Office</th>
