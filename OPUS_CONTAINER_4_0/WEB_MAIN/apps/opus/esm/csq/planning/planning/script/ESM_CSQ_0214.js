...
/**
 * @extends
 * @class ESM_CSQ_0214 : ESM_CSQ_0214 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
/* 개발자 작업	*/
//공통전역변수
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		case IBSEARCH:          // 화면 조회 시
			...
			ComOpenWait(true);
			var rtnXml=sheetObj.GetSearchData("ESM_CSQ_0214GS.do",searchParams);
		...
		case MULTI01:		// Add Creation
            ...
            var sXml=sheetObj.GetSaveData("ESM_CSQ_0214GS.do", searchParams + "&" +sParam);
            ComOpenWait(false);
