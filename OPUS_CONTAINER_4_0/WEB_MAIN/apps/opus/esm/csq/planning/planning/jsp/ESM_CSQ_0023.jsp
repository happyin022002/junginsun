...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planning.event.EsmCsq0023Event"%>
...
<%
	...
	EsmCsq0023Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0023Event)request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>QTA Set up by Head Office_RHQ QTA Summary</span></h2>
		<!-- page_title(E) -->
