...
*@FileName   : ESM_CSQ_0034.jsp
*@FileTitle  : QTA Set up by RHQ_Contract TTL retrieve only_Office Distribute Result
*@author     : CLT
*@version    : 1.0
*@since      : 2015/02/09
=========================================================*/
...
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><span>QTA Set up by RHQ_Contract TTL retrieve only_Office Distribute Result</span></h2>
	<!-- page_title(E) -->
