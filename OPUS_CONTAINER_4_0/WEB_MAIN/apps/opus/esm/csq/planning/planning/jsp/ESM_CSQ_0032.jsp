...
*@FileName   : ESM_CSQ_0032.jsp
*@FileTitle  : QTA Set up by RHQ_OB Contract_Office QTA Summary
*@author     : CLT
*@version    : 1.0
*@since      : 2015/02/09
=========================================================*/
...
<div class="page_title_area clear">
	<!-- page_title(S) -->
	<h2 class="page_title"><span>QTA Set up by RHQ_OB Contract_Office QTA Summary</span></h2>
	<!-- page_title(E) -->
