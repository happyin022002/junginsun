...
*@FileName   : ESM_CSQ_0025.jsp
*@FileTitle  : QTA Set up by RHQ_OB Loading_Office Distribute Result
*@author     : CLT
*@version    : 1.0
*@since      : 2015/01/20
=========================================================*/
...
<div class="layer_popup_title">
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>QTA Set up by RHQ_OB Loading_Office Distribute Result</span></h2>
		<!-- page_title(E) -->
