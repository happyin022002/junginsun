...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planning.event.EsmCsq0020Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0020Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0020Event)request.getAttribute("Event");
...
<input type="hidden" name="f_qta_step_cd" value="01" id="f_qta_step_cd" />
<!-- 개발자 작업	-->
...
<div class="page_title_area clear">
	...
	<div class="opus_design_btn">
		...
		--><button class="btn_normal" name="btn_Confirm" id="btn_Confirm" type="button">QTA Confirm</button><!--
