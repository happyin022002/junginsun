...
/**
 * @extends 
 * @class ESM_CSQ_0024 : ESM_CSQ_0024 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
	/* 개발자 작업	*/
	//공통전역변수
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		...
		switch(sAction) {
			case IBCLEAR:          // 화면 접속 시
				...
				var sXml=sheetObj.GetSearchData("ESM_CSQ_0024GS.do", FormQueryString(formObj));
			...
			case IBSEARCH:          // 화면 조회 시
				...
				ComOpenWait(true);
				var rtnXml=sheetObj.GetSearchData("ESM_CSQ_0024GS.do",searchParams);
				ComOpenWait(false);
			...
			case IBSAVE:          // 화면 저장시
				...
				var sXml = sheetObj.GetSaveData("ESM_CSQ_0024GS.do", searchParams + "&" + saveStr);
			...
			case "DisResult":		
				...
				ComOpenWindow("ESM_CSQ_0025.do?" + searchParams+ "&div_period=" + document.getElementById("div_period").innerHTML,  window,  "dialogHeight:520px;dialogWidth:1100px;center:yes;resizable:yes;scroll:yes;status:no;unadorned:yes;" , true);
				break;
			...
			case "QtaSimul":		
				...
				ComSetSearchParams("f_cmd", "");
				ComOpenWindow("ESM_CSQ_0026.do?" + searchParams+ "&div_period=" + document.getElementById("div_period").innerHTML,  window,  "dialogHeight:560px;dialogWidth:1000px;center:yes;resizable:yes;scroll:yes;status:no;unadorned:yes;" , true);
				break;	
	    }
	}
	 /**
