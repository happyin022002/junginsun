...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planning.event.EsmCsq0215Event"%>
...
<%
	...
	EsmCsq0215Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0215Event)request.getAttribute("Event");
...
<input type="hidden" name="f_add_flg" value="Y" id="f_add_flg" />
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>QTA Set up by Head Office for IAS Sector_Add Freezing</span></h2>
		<!-- page_title(E) -->
