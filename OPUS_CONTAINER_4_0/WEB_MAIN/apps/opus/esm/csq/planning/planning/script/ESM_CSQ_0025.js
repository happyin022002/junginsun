...
/**
 * @extends 
 * @class ESM_CSQ_0025 : ESM_CSQ_0025 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
/* 개발자 작업	*/
//공통전역변수
...
function initSheet(sheetObj,sheetNo) {
	...
	switch(sheetNo) {
      ...
      (ComCountHeadTitle(HeadTitle1), 1, 0, true);
...
function doActionIBSheet(sheetObj, formObj, sAction) {
	...
	switch(sAction) {
		case IBSEARCH:          //조회
			...
			var rtnXml=sheetObj.GetSearchData("ESM_CSQ_0025GS.do",sParam);
