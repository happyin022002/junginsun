...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planning.event.EsmCsq0027Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0027Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0027Event)request.getAttribute("Event");
...
<input type="hidden" name="f_qta_step_cd" value="04" id="f_qta_step_cd" />
