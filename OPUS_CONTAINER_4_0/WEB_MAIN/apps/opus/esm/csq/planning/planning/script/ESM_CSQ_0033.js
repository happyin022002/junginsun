...
/**
 * @extends 
 * @class ESM_CSQ_0033 : ESM_CSQ_0033 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
	/* 개발자 작업	*/
	//공통전역변수
	...
	*/
	...
	function initSheet(sheetObj,sheetNo) {
		...
		case 1:		//sheet1 init
		    with(sheetObj){
	        var HeadTitle1="SEQ|Year|Quarter|N.OB/OB|Office View|Trade|Sub Trade|Lane|Lane Bound|Trade Bound|RHQ|Office|Load (TEU) Portion Setting|Load (TEU) Portion Setting|G.REV Portion Setting|G.REV Portion Setting";
	        var HeadTitle2="SEQ|Year|Quarter|N.OB/OB|Office View|Trade|Sub Trade|Lane|Lane Bound|Trade Bound|RHQ|Office|PFMC %|Target %|PFMC %|Target %";
	        ...
	        var cols = [ {Type:"Seq",       Hidden:0, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"seq",               KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	             {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"bse_yr",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	             ...
	             {Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"ob_div_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	             {Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"ofc_vw_cd",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	             ...
	             {Type:"Text",      Hidden:0,  Width:85,   Align:"Center",  ColMerge:1,   SaveName:"rhq_cd",            KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	             {Type:"Text",      Hidden:0,  Width:85,   Align:"Center",  ColMerge:1,   SaveName:"rgn_ofc_cd",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
	             {Type:"AutoSum",   Hidden:0, Width:120,   Align:"Right",   ColMerge:1,   SaveName:"gid_lod_potn_rto",  KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
	             {Type:"AutoSum",   Hidden:0, Width:130,   Align:"Right",   ColMerge:1,   SaveName:"lod_potn_rto",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0,   EditLen:5 },
	             {Type:"AutoSum",   Hidden:0, Width:120,   Align:"Right",   ColMerge:1,   SaveName:"gid_rev_potn_rto",  KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 },
	             {Type:"AutoSum",   Hidden:0, Width:130,   Align:"Right",   ColMerge:1,   SaveName:"rev_potn_rto",      KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0,   EditLen:5 } ];
	        InitColumns(cols);
	        SetEditable(1);
	...
	*/
	...
	function doActionIBSheet(sheetObj, formObj, sAction) {
		...
		case IBCLEAR:          // 화면 접속 시
			...
			var sXml=sheetObj.GetSearchData("ESM_CSQ_0033GS.do", FormQueryString(formObj));
			...
			if (arrXml.length > 3)
				ComXml2ComboItem(arrXml[3], f_ob_div_cd, "code", "name");
			if (arrXml.length > 4)
				ComXml2ComboItem(arrXml[4], f_rgn_ofc_cd, "code", "name");
			setTradeCombo();
			ComOpenWait(false);
			break;
		case IBSEARCH:          // 화면 조회 시
			...
			ComOpenWait(true);
			var rtnXml=sheetObj.GetSearchData("ESM_CSQ_0033GS2.do",FormQueryString(formObj));
		...
		case "DisResult":		
			...
			ComOpenWindow("ESM_CSQ_0034.do?" + searchParams+ "&div_period=" + document.getElementById("div_period").innerHTML,  window,  "dialogHeight:520px;dialogWidth:1100px;center:yes;resizable:yes;scroll:yes;status:no;unadorned:yes;" , true);
			break;
		...
		case "QtaSimul":		
			...
			ComSetSearchParams("f_cmd", "");
			ComOpenWindow("ESM_CSQ_0035.do?" + searchParams+ "&div_period=" + document.getElementById("div_period").innerHTML,  window,  "dialogHeight:560px;dialogWidth:1000px;center:yes;resizable:yes;scroll:yes;status:no;unadorned:yes;" , true);
			break;		
		}
	}
