...
<%@ page import="com.clt.apps.opus.esm.csq.planning.planning.event.EsmCsq0213Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0213Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0213Event)request.getAttribute("Event");
...
<input type="hidden" name="f_p_cnt" id="f_p_cnt" />
<input type="hidden" name="f_c_cnt" id="f_c_cnt" />
<input type="hidden" name="f_t_cnt" id="f_t_cnt" />
...
<div class="page_title_area clear">
	...
	<div class="opus_design_btn">
		...
		--><button class="btn_normal" name="btn_Freezing" id="btn_Freezing" type="button">Freezing</button><!--  
		--><button class="btn_normal" name="btn_AddFreezing" id="btn_AddFreezing" type="button">Add-Freezing</button><!--  
		--><button class="btn_normal" name="btn_Transfer" id="btn_Transfer" type="button">1Q Transfer</button><!--  
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>R/Lane</th>
					<td><script type="text/javascript">ComComboObject('f_rlane_cd', 1, 60, 1)</script></td>
					<th>Lane Bound</th>
					...
					<th>P/F Group</th>
					<td><script type="text/javascript">ComComboObject('f_pf_grp_cd', 2, 65, 1,0,1)</script></td>
					<th>Supply</th>
                    <td><script type="text/javascript">ComComboObject('f_fnl_bsa_capa', 1, 60, 1)</script></td>
					<th>Main</th>
					<td><select name="f_csq_mn_sctr_flg" id="f_csq_mn_sctr_flg" style="width:60px;" class="input">
