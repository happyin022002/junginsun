...
<%@ page import="com.clt.apps.opus.esm.csq.datamanage.officemapping.event.EsmCsq0206Event"%>
...
<%
	...
	EsmCsq0206Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0206Event)request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><span>Sector-Office Relation Setting for IAS Sector_POL-POD pair Add</span></h2>
		<!-- page_title(E) -->
