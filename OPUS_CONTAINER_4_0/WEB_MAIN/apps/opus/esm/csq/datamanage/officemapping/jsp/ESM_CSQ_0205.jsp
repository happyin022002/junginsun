...
<%@ page import="com.clt.apps.opus.esm.csq.datamanage.officemapping.event.EsmCsq0205Event"%>
...
<%
	...
	EsmCsq0205Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	String strUsr_id		= "";
	String strUsr_nm		= "";
	Logger log = Logger.getLogger("com.clt.apps.opus.esm.csq.datamanage.officemapping");
	...
	try {
		...
		event = (EsmCsq0205Event)request.getAttribute("Event");
...
<input type="hidden" name="act_cnt" id="act_cnt" />
...
<div class="page_title_area clear">
	...
	<!-- page_title(S) -->
	<h2 class="page_title"><span>Sector-Office Relation Setting for IAS Sector_Add Creation</span></h2>
	<!-- page_title(E) -->
		...
		<table>
		   ...
		   <tbody>
		   		<tr>
					...
					<th>Office View</th>
					<td><input type="text" name="f_ofc_vw_cd" style="width:70px;text-align:center;ime-mode:disabled;" readonly class="input2" value="" id="f_ofc_vw_cd" /> </td>
					<td></td>
		   		</tr>
				<tr>
