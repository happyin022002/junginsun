		...
		<table>
			...
			<tbody>
				<tr>
					...
					<th>RHQ</th>
					<td><script type="text/javascript">ComComboObject('f_rhq_cd', 1, 75, 1)</script></td>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;N.OB/OB</th>
					<td><script type="text/javascript">ComComboObject('f_ob_div_cd', 1, 85, 1)</script></td>
					<th></th>
					<td></td>
				</tr>
			</tbody>
