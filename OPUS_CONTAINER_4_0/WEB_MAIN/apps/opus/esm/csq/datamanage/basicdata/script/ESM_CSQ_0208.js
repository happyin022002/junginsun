...
/**
 * @extends 
 * @class ESM_CSQ_0208 : ESM_CSQ_0208 생성을 위한 화면에서 사용하는 업무 스크립트를 정의한다.
 */
	/* ê°œë°œìž� ìž‘ì—…	*/
	...
	function doActionIBSheet(formObj, sAction) {
		switch(sAction) {
			case IBCREATE:          // Data Create 시
				...
				var sXml=sheet1.GetSearchData("ESM_CSQ_0208GS.do?", FormQueryString(formObj));
