...
<%@ page import="com.clt.apps.opus.esm.csq.datamanage.costmanage.event.EsmCsq0210Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmCsq0210Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmCsq0210Event)request.getAttribute("Event");
...
<div class="page_title_area clear">
	...
	<div class="opus_design_btn">
		...
		--><button class="btn_normal" name="btn_NewLaneCostIF" id="btn_NewLaneCostIF" type="button">New Lane Cost IF</button>
	</div>
	<!-- opus_design_btn (E) -->
...
<div class="wrap_search">
	...
	<div class="opus_design_inquiry wFit">
		...
		<table>
			...
			<tbody>
				<tr>
					<th class='sm pad_left_8' style="text-align:left;"><input type="radio" name="f_bse_tp_cd" id="f_bse_tp_cdQ" class="trans" value="Q" checked><label for="f_bse_tp_cdQ">Quarterly</label></th>
					<th>Sub Trade</th>
...
<div class="wrap_result">
	...
	<div class="opus_design_grid">
		<div class="opus_design_btn">
			<button class="btn_normal" name="btn_CoaUcPfmc" id="btn_CoaUcPfmc" type="button">COA UC PFMC</button>
		</div>
