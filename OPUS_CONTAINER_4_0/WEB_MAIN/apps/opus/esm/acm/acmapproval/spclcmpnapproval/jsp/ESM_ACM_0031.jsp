...
<%@ page import="com.clt.apps.opus.esm.acm.acmapproval.spclcmpnapproval.event.EsmAcm0031Event"%>
		...
		<table>
				...
				<tbody>
					<tr>
						...
						<td><%=JSPUtil.getCodeCombo("date_div", "", "tabindex='4' style='width:110px;'", "CD03053", 0, "")%><!-- 
							 ...
							 --><button type="button" class="calendar" name="btn_calendar"></button>
						</td>
						<th>Interface Option</th>
						<td><%=JSPUtil.getCodeCombo("if_opt", "", "tabindex='4' style='width:90px;'", "CD03071", 0, "")%></td>
						<th>Eff Date</th>
						<td><input type="text" class="input1" style="width: 85" dataformat="ymd" OnBeforeDeactivate="ComAddSeparator(this)" OnBeforeActivate="ComClearSeparator(this)" name="inv_dt" id="inv_dt"><!-- 
							 --><button type="button" class="calendar" name="btn_inv_dt" id="btn_inv_dt" onclick="doDisplay('DATE1', frm1);"></button>
						</td>
					</tr>
				</tbody>
			</table>
			<table>
				...
				<tbody>
					<tr>
						<th>AGMT Customer</th>
						<td><input type="text" name="ff_cnt_seq" id="ff_cnt_seq" dataformat="engup" style="width:79px; ime-mode: disabled;" maxlength="8"><!-- 
							 --><button type="button" class="input_seach_btn" name="btn_forwarder" id="btn_forwarder" ></button>
						</td>
						<th>B/L</th>
						<!-- Memo Sheet (S) -->
						...
						<th>Select</th>
						<td><input name="slct_start" id="slct_start" type="text" dataformat="int" maxlength="5" style="width: 41px;" tabindex="9"><span class="dash">~</span><!-- 
							 --><input name="slct_end"   id="slct_end"   type="text" dataformat="int" maxlength="5" style="width: 41px;" tabindex="10"><!--
						...
						<th>VAT(%)</th>
	                    <td><input type="text" style="width:80px;text-align:right" maxlength = "8" name="inv_tax_rt" value="0.00" onfocus="invTaxRt_onfocus(this)" onblur="invTaxRt_validate(this)"></td>
					</tr>
				</tbody>
			</table>
			<table>
			...
			<table>
				...
				<tbody>
					<tr style= "display:none">
						<th>Approval Step</th>
						<td><input name="apro_step" id="apro_step" type="text" class="input1" size="65" style="width: 440px;" value="<%= aproStep %>" disabled><!--
						--><button type="button" class="btn_etc" name="btn_clear" id="btn_clear" >Clear</button><!-- 
						 --><button type="button" class="btn_etc" name="btn_popup" id="btn_popup" >Edit Approval Staff</button></td>
					</tr>
				</tbody>
			</table>
	</div>
...
<div class="wrap_result">
	<div class="opus_design_grid clear"  >
		<h3 class="title_design">Master</h3><br/>
		<script type="text/javascript">ComSheetObject('sheet1');</script>
	</div>
	<div class="opus_design_grid clear"  >
		<h3  class="title_design">Detail</h3><br/>
