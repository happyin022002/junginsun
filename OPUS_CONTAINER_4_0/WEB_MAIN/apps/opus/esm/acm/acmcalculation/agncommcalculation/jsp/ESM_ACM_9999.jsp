...
<%@ page import="com.clt.apps.opus.esm.acm.acmcalculation.agncommcalculation.event.EsmAcm9999Event"%>
...
<input type="hidden" name="aproSeqKey" value="<%=com.clt.bizcommon.approval.util.ApprovalUtil.getApprovalRoute1(strOfc_cd, inv_sub_sys_cd)%>">
