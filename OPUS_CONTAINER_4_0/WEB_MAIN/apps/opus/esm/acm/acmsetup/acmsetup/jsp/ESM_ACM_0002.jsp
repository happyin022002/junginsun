...
<div class="page_title_area clear">
	...
	<div class="opus_design_btn">
		<button class="btn_accent" name="btn_retreive" id="btn_retreive" type="button">Retrieve</button><!--
...
<div class="wrap_result">
	...
	<h3 class="title_design">Container TP/SZ Code Selection</h3>
	<!-- opus_design_grid(S) -->
	<div class="opus_design_grid">
		<h3 class="mar_btm_8">Selected TP/SZ</h3>
		<table>
			<tbody>
				<tr>
                	<td><textarea name="slct_tpsz" id="slct_tpsz" style="width:100%; height:34px" class="input2" readonly></textarea></td>
              	</tr>
			</tbody>
		</table>
		<h3 class="mar_btm_8">Container TP/SZ Code</h3>
