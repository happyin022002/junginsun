            ...
            switch (shtObj.id) {
                case "sheet1":
                    ...
                    var cols = [ {Type:"Status",    Hidden:1, Width:35,   Align:"Center",  ColMerge:1,   SaveName:"ibflag" },
                                 ...
                                 {Type:"Popup",     Hidden:0, Width:120,  Align:"Center",  ColMerge:1,   SaveName:"agn_agmt_no" },
	                ...
	                SetRangeBackColor(1,2,1,4,"#555555");
        ...
        switch (sAction) {
            ...
            case IBSEARCH:
                ...
                frmObj.f_cmd.value=SEARCH;
                 shtObj.DoSearch("ESM_ACM_0001GS.do", FormQueryString(frmObj), {Sync:2} );    // *** ESM_ACM_0001GS.do를 호출 **** // (Auctual Agreement를 호출해야 하므로.. );
                ComOpenWait(false);
                break;
            case MULTI:
                if (!ComChkValid(frmObj)) return;
                ...
                ComOpenWait(true);
                shtObj.LoadSaveData(shtObj.GetSaveData("ESM_ACM_0115GS.do", saveParam));
                ComOpenWait(false);
                break;
        }
    }
            ...
            switch (elementName) {
                case "dir_agmt_no":
                    if (dir_agmt_no.value.length > 8) {
                        // validation
                         var xmlStr=shtObj.GetSearchData("ESM_ACM_0115GS.do", "f_cmd=" + SEARCH02 + "&agn_agmt_no=" + dir_agmt_no.value);
