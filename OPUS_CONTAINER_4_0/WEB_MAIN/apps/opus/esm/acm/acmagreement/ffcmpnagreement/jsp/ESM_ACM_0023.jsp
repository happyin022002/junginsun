...
<%@ page import="com.clt.apps.opus.esm.acm.acmagreement.ffcmpnagreement.event.EsmAcm0023Event"%>
	...
	<table>
		<tbody>
			<colgroup>
			   ...
			   <tr>
                 <th>Freight Forwarder Code</th>
                 <td><input type="text" name="search_brog_cnt_cust_seq" id="search_brog_cnt_cust_seq" style="width:100px;ime-mode:disabled;" dataformat="engup" onKeyPress="ComKeyOnlyAlphabet('uppernum')" maxlength="8"><!-- 
