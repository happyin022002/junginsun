...
<%@ page import="com.clt.apps.opus.esm.acm.acmagreement.spclcmpnagreement.event.EsmAcm0025Event"%>
<%@ page import="com.clt.bizcommon.util.BizComUtil"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
  EsmAcm0025Event event = null;        //PDTO(Data Transfer Object including Parameters)
  ...
  try {
    ...
    event = (EsmAcm0025Event)request.getAttribute("Event");
...
<%=JSPUtil.getIBCodeCombo("customerKindCd", "", "CD02817", 0, "")%>
		...
		<tbody>
			<colgroup>
			   ...
			   <tr class="h23">
                <th>Office</th>
                <td>
                  <select name="spcl_ofc_cd" id="spcl_ofc_cd" required caption="Office" class="input1" style="width:100px;" tabindex="1"></select>
                </td>
                <th>Agreement Customer</th>
                <td><input type="text" name="fcust_cnt_seq" id="fcust_cnt_seq" style="width:100px;ime-mode:disabled;" dataformat="engup" maxlength="8"><button type="button" name="btn_popup" id="btn_popup" class="input_seach_btn"></button>
                </td>
                <th>Show Deleted Customer</th>
                <td><input type="checkbox" value="Y" name="deleted_customer" id="deleted_customer" class="trans"></td>
              </tr>
		</tbody>		
	</table>
</div>
