        ...
        try {
            ...
            switch (srcName) {
                case "tab1btn_retrieve":    // TAB1_Retrieve
                	if(t1shtObj1.IsDataModified()==true){
                ...
                case "tab1btn_copy":    // TAB1_Copy
                    ...
                    ComOpenPopup("ESM_ACM_0101.do" + param, 800, 450, "", "1,0", true, false);
                    break;
         ...
         case "tab2sheet1":    // Selected Agreement
             ...
             case "tab2sheet2":    // Compensation Master
                    ...
                    var cols = [ {Type:"Status",    Hidden:0, Width:50,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                                 ...
                                 {Type:"Combo",     Hidden:0, Width:60,   Align:"Center",  ColMerge:1,   SaveName:"io_bnd_cd",           KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                                 {Type:"Combo",     Hidden:0, Width:100,  Align:"Center",  ColMerge:1,   SaveName:"ac_tp_cd",            KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
                ...
                case "tab2sheet3":    // Compensation Rate (화면용)
                    ...
                    var cols = [ {Type:"Status",    Hidden:1, Width:40,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                                 ...
                                 {Type:"Popup",     Hidden:0, Width:100,  Align:"Left",    ColMerge:0,   SaveName:"cntr_tpsz_cd" },
                                 {Type:"Combo",     Hidden:0, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"full_mty_cd" },
...
//                    SetColProperty("curr_cd", {ComboText:"USD|JPY", ComboCode:"USD|JPY"} );
                ...
                case "tab2sheet5":    // Route Setting (화면용)
                    ...
                    var cols = [ {Type:"Status",    Hidden:1, Width:40,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
                                 ...
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"por_4" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"por_lvl_cd" },
                                 {Type:"Popup",     Hidden:0, Width:95,   Align:"Center",  ColMerge:0,   SaveName:"por" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pol_1" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pol_2" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pol_3" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pol_4" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pol_lvl_cd" },
                                 {Type:"Popup",     Hidden:0, Width:95,   Align:"Center",  ColMerge:0,   SaveName:"pol" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pod_1" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pod_2" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pod_3" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pod_4" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"pod_lvl_cd" },
                                 {Type:"Popup",     Hidden:0, Width:95,   Align:"Center",  ColMerge:0,   SaveName:"pod" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"del_1" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"del_2" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"del_3" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"del_4" },
                                 {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:0,   SaveName:"del_lvl_cd" },
                                 {Type:"Popup",     Hidden:0, Width:95,   Align:"Center",  ColMerge:0,   SaveName:"del" } ];
    ...
    function doActionIBSheet(shtObj, frmObj, sAction, CondParam, PageNo) {
        ...
        case SEARCH01:       // RHQ 목록 조회
            ...
            ACMXml2SelectItem(xmlStr, ComGetObject("combo_rhq_cd_disp"), "value0", "value0", true);    // CoAcm.js에 정의
...
//            	$('#combo_rhq_cd_disp').show();
//        		$('#rhq_cd').hide();
            	frmObj.combo_rhq_cd_disp.style.display="inline";    // hidden��form.rhq_cd_disp媛�蹂댁뿬吏�쾶 ��
                frmObj.rhq_cd.style.display="none";    // form.rhq_cd���④�
            } else {
            	frmObj.combo_rhq_cd_disp.value=rhqCd;    // hidden�곹깭 洹몃�濡�form.rhq_cd_disp��rhqCd媛��좏깮�섍쾶 �섍퀬
                //rhq_cd_disp.fireEvent("onchange");    // hidden�곹깭 洹몃�濡�form.rhq_cd_disp��媛뺤젣濡�OnChange�대깽��諛쒖깮(frmObj_OnChange瑜��몄텧)
            	ComFireEvent(frmObj.combo_rhq_cd_disp, "change");    // hidden�곹깭 洹몃�濡�form.rhq_cd_disp��媛뺤젣濡�OnChange�대깽��諛쒖깮(frmObj_OnChange瑜��몄텧)
            }
            break;
        ...
        case SEARCH11:    // TAB2_Sheet2_Retrieve / TAB3_Sheet2_Retrieve
            ComOpenWait(true);
             shtObj.DoSearch("ESM_ACM_0001GS.do", "f_cmd=" + SEARCH11 + "&" + CondParam, {Sync:2} );
            ComOpenWait(false);
            break;
        case MULTI01:    // TAB2_Save
            ...
            ComOpenWait(true);
            shtObj.DoSave("ESM_ACM_0001GS.do", "f_cmd=" + MULTI01);
            ComOpenWait(false);
            break;
        ...
        with (shtObj) {
            switch (ColSaveName(Col)) {
                ...
                case "delt_flg":
                    ...
                    break;
                case "agmt_fm_dt": 
                	if( GetCellValue(Row,"agmt_to_dt") != "" && GetCellValue(Row,"agmt_fm_dt") > GetCellValue(Row,"agmt_to_dt") ) {
                    ...
                    break;
                case "agmt_to_dt":
                	if( GetCellValue(Row,"agmt_fm_dt") > GetCellValue(Row,"agmt_to_dt") ) {
        ...
        with (shtObj) {
            switch (ColSaveName(Col)) {
                case "cntr_tpsz_cd":
                    ...
                    ComOpenPopup("ESM_ACM_0102.do" + param, 742, 630, "setPopupData", "1,0", true, false, Row, Col, 3);
                    break;
                case "curr_cd":
                    // ComOpenPopup(sUrl, iWidth, iHeight, sFunc, sDisplay, bModal, b2ndSheet, iRow, iCol, iSheetIdx, sWinName, sScroll)
                    ComOpenPopup("COM_ENS_N13.do", 700, 500, "setPopupData", "1,0,1,1,1,1,1", true, false, Row, Col, 3);
                    break;
            }
        }
    }
    ...
    function tab2sheet4_OnPopupClick(shtObj, Row, Col) {
        with (shtObj) {
            switch (ColSaveName(Col)) {
                case "ofc_cd":
                    // ComOpenPopup(sUrl, iWidth, iHeight, sFunc, sDisplay, bModal, b2ndSheet, iRow, iCol, iSheetIdx, sWinName, sScroll)
                    ComOpenPopup("COM_ENS_071.do", 700, 520, "setPopupData", "1,0,1,1,1,1,1", true, false, Row, Col, 4);
                    break;
            }
        }
    }
...
//                    ComShowMemoPad(shtObj, Row, Col, true);
    ...
    function frmObj_OnChange() {
        ...
        with (document.form) {
            switch (elementName) {
                case "combo_rhq_cd_disp":    // RHQ를 변경시 Office목록을 setting
                    if (combo_rhq_cd_disp.value == "") {
                        ComClearCombo(ar_ofc_cd);
                        ComClearCombo(agn_cd);
                        return;
                    }
                    rhq_cd.value=combo_rhq_cd_disp.value;
