...
/**
 * @extends
 * @class ESM_SAQ_0049 : business script for ESM_SAQ_0049.
 */
...
function loadPage() {
    ...
    for (var k = 0; k < comboCnt; k++) {
        comObjects[k].SetSelectText("ALL", true);
    }
    //search for child
    ...
    rhqCd04.SetSelectIndex(-1);
    rhqCd05.SetSelectIndex(-1);
    formObj.dirCd04.value = "E";
    formObj.dirCd05.value = "E";
}
	...
	switch(sheetNo) {
		case 1: // tradeGroupSheet sheet init
			with(sheetObj){
				...
				var cols = [ {Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"trd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"dir",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"sub",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
				...
				for (i=0; i<=3; i++) {
					cols.push({Type:"Float",       Hidden:0,  Width:70,   Align:"Right",   ColMerge:0,   SaveName:"",      KeyField:0,   CalcLogic:"",   Format:"#,##0.#####",   UpdateEdit:0,   InsertEdit:0 });
				}
		...
		case 2: // laneSheet sheet init
			with(sheetObj){
				SetConfig( { SearchMode:2, MergeSheet:7, Page:20, DataRowMerge:0 , PrevColumnMergeMode:0} );
				changeSheetHead(sheetObj, sheetNo,"init");
				var cols = [ {Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"dir",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"sub",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"lane",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
				{Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"item",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
		...
		case 3: // rhqSheet sheet init
			with(sheetObj){
				...
				changeSheetHead(sheetObj, sheetNo,"init");
				var cols = [ {Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"dir",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"rhq",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				...
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"ofc",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0},
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"sub",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0, Width:90,   Align:"Center",  ColMerge:1,   SaveName:"lane",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"item",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
		...
		case 4: //cOffice
			with(sheetObj){
				...
				{Type:"Text",      Hidden:0, Width:120,   Align:"Center",  ColMerge:1,   SaveName:"rhq",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0, Width:100,   Align:"Center",  ColMerge:1,   SaveName:"aq",          KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0, Width:150,   Align:"Center",  ColMerge:1,   SaveName:"rgn",         KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
				{Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"item",        KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
    ...
    switch (sAction) {
        case IBSEARCH: //search
            ...
            if (currentTabIndex == 0) {
                ...
                f_url = "ESM_SAQ_0049GS.do";
            } else if (currentTabIndex == 1) {
                // Lane retrieve
                f_cmd = "&f_cmd=" + SEARCHLIST02;
                f_url = "ESM_SAQ_0049GS2.do";
            } else if (currentTabIndex == 2) {
                // RHQ retrieve
                f_cmd = "&f_cmd=" + SEARCHLIST03;
                f_url = "ESM_SAQ_0049GS3.do";
            } else if (currentTabIndex == 3) {
                // C.Office retrieve
                f_cmd = "&f_cmd=" + SEARCHLIST04;
                f_url = "ESM_SAQ_0049GS4.do";
            } else if (currentTabIndex == 4) {
                // C.Offcie2 retrieve
                f_cmd = "&f_cmd=" + SEARCHLIST05;
                f_url = "ESM_SAQ_0049GS5.do";
            }
...
function validateForm(sheetObj, formObj, sAction) {
    ...
    switch (currentTabIndex) {
        case 0: // checking targetGroup validation
            if (getItem_parameter(item01) == "ALL:") {
                ComShowCodeMessage("COM12113", "Item");
                return false;
            }
            break;
        case 1: // checking Lane validation
        ...
        case 4:
            ...
            if (ComIsNull(formObj.from_wk05.value)) {
...
function searchKeyQueryString(formObj) {
    var query = "";
    var tgtOrzCdTx = tgtOrzCd.GetSelectCode();
    var version = formObj.version.value;
    version = version.split("-");
    var mstVersion = version[0];
    var glineVerNo = version[1];
    tgtOrzCdTx = tgtOrzCdTx.split("-");
    var datCreStepCd = tgtOrzCdTx[0];
    var tgtOrzCdTx = tgtOrzCdTx[1];
...
function searchTabQueryString(formObj) {
    ...
    switch (currentTabIndex) {
        ...
        case 2: // rhq
            ...
            break;
        case 3: // cOffice
            queryString = queryString + "&trade=" + formObj.trade04.value + "&dirCd=" + formObj.dirCd04.value + "&subTrade=" + formObj.subTrade04.value + "&rhqCd=" + rhqCd04.GetSelectCode() + "&item=" + getItem_parameter(item04);
            break;
        case 4: // cOffice2
            ...
            to_wk = to_wk.split("|")[0];
            queryString = queryString + "&trade=" + formObj.trade05.value + "&dirCd=" + formObj.dirCd05.value + "&subTrade=" + formObj.subTrade05.value + "&rlaneCd=" + lane05.GetSelectCode() + "&rhqCd=" + rhqCd05.GetSelectCode() + "&item=" + getItem_parameter(item05) + "&from_wk=" + from_wk + "&to_wk=" + to_wk;
            break;
    } // end switch
    return queryString;
}
...
function version_change() {
    ...
    // 		} 		
    var params = "year=" + document.form.year.value + "&bse_qtr_cd=" + document.form.bse_quarter.value + "&targetGrp=" + targetGroup + "&tgt_orz_cd=" + curr_tgt_orz_cd + "&tgt_ofc_cd1=" + document.form.org.value + "&tgt_ofc_cd2=SELHO" + "&stage=" + stage;
    getSelectCodeList(document.form.version, "SaqSmryHdrMstVersion", params);
    tgtOrzCd_change();
}
...
function tgtOrzCd_change() {
    ...
    // 		    stage=document.form.stage[1].value;
    // 		}
    var params = "year=" + document.form.year.value + "&bse_qtr_cd=" + form.bse_quarter.value + "&targetGrp=" + targetGroup + "&tgt_orz_cd=" + curr_tgt_orz_cd + "&qta_mst_ver_no=" + mstVersion + "&tgt_ofc_cd1=" + document.form.org.value + "&tgt_ofc_cd2=SELHO" + "&stage=" + stage;
...
function rhqSheet_OnTreeChild(sheetObj, Row) {
    ...
    var params = "&f_cmd=" + SEARCHLIST13 + "&dirCd=" + sheetObj.GetCellValue(Row, "dir") + "&rhqCd=" + sheetObj.GetCellValue(Row, "rhq") + "&ctrtAqCd=" + aqCd + "&ctrtOfcCd=" + sheetObj.GetCellValue(Row, "ofc") + "&subTrade=" + sheetObj.GetCellValue(Row, "sub") + tabChildSearchParams[currentTabIndex];
    sheetObj.DoSearchChild(Row, "ESM_SAQ_0049GS3.do", params);
    //retriving All Child
...
function cOfficeSheet_OnTreeChild(sheetObj, Row) {
    var aqCd = convertAqCd(sheetObj.GetCellValue(Row, "aq"));
    var params = "&f_cmd=" + SEARCHLIST14 + "&rlaneCd=" + sheetObj.GetCellValue(Row, "lane") + "&ctrtAqCd=" + aqCd + "&rgnOfcCd=" + sheetObj.GetCellValue(Row, "rgn") + "&subTrade=" + sheetObj.GetCellValue(Row, "sub_trd_cd") + "&rhqCd=" + sheetObj.GetCellValue(Row, "rhq") + tabChildSearchParams[currentTabIndex];
    sheetObj.DoSearchChild(Row, "ESM_SAQ_0049GS4.do", params);
...
function cOfficeSheet2_OnTreeChild(sheetObj, Row) {
    var aqCd = convertAqCd(sheetObj.GetCellValue(Row, "aq"));
    var params = "&f_cmd=" + SEARCHLIST15 + "&vvdGroupCd=" + sheetObj.GetCellValue(Row, "vvdgcd") + "&rhqCd=" + sheetObj.GetCellValue(Row, "rhq") + "&ctrtAqCd=" + aqCd + "&rgnOfcCd=" + sheetObj.GetCellValue(Row, "rgn") + "&subTrade=" + sheetObj.GetCellValue(Row, "sub_trd_cd") + "&rlaneCd=" + sheetObj.GetCellValue(Row, "lane") + tabChildSearchParams[currentTabIndex];
    sheetObj.DoSearchChild(Row, "ESM_SAQ_0049GS.do", params);
    //retriving All Child
    recordChildKey(sheetObj, Row);
}
...
function vvdgcd_cur_chng(sheetObj, Button, Shift, X, Y) {
    ...
    var cursor = "Default"; // change cursor
...
function getSelectText(comboObj) {
    ...
    for (var i = 0; i < arrCode.length; i++) {
        mText += comboObj.GetText(arrCode[i], 1) + "|";
    }
...
function optionSetting() {
    ...
    SaqSearchOptionTargetGroup("targetGrp", document.form.org.value, false);
    ...
    SaqSearchOptionRhq("rhqCd04");
    SaqSearchOptionBound("dirCd04");
    SaqSearchOptionComCodeMulti("item04", "CD01060", true, true, 8, "type2");
    SaqSearchOptionRhq("rhqCd05");
    SaqSearchOptionLane("lane05");
    SaqSearchOptionBound("dirCd05");
