...
<%@ page import="com.clt.apps.opus.esm.saq.monthlysalesquotamanage.monthlyquotaadjustmentslsrhq.event.EsmSaq0158Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSaq0158Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	String search_rlane_cd = JSPUtil.getParameter(request, "search_rlane_cd", "");
	...
	try {
		...
		event = (EsmSaq0158Event)request.getAttribute("Event");
...
<input type="hidden" name="search_rlane_cd" value="<%=search_rlane_cd%>" id="search_rlane_cd" />
