...
<%@ page import="com.clt.apps.opus.esm.saq.monthlysalesquotamanage.monthlyquotacreation.event.EsmSaq0183Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSaq0183Event event = null;		//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSaq0183Event)request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title" id="popup_title" name="popup_title"><span>CPB Adjust</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
...
<div class="layer_popup_contents">	
			...
			<table>
				...
				<tbody>
					...
					<tr>						
						...
						<td></td>
						<th>Amount</th>
						<td><input class="input" type="text" name="amount" size="7" maxlength="9" style="ime-mode:disabled;" dataformat="singledFloat" onkeydown ="amt_OnKeyDown();"></td>
						<th>Ratio</th>
						<td><input class="input" type="text" name="ratio" size="7" maxlength="9" style="ime-mode:disabled;" dataformat="singledFloat" onkeydown="rto_OnKeyDown();">%</td>						
					</tr>						
				</tbody>
			</table>
		</div>
	...
	<div class="wrap_result">
		<div class="opus_design_grid" id="mainTable">
			<div class="opus_design_btn">
				<button type="button" class="btn_normal" name="btn_init" id="btn_init">Initialize</button><!-- 
