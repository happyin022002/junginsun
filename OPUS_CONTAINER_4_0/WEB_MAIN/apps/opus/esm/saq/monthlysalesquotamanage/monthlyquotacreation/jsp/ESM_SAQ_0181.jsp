...
<%@ page import="com.clt.apps.opus.esm.saq.monthlysalesquotamanage.monthlyquotacreation.event.EsmSaq0181Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSaq0181Event event = null;		//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSaq0181Event)request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title" id="popup_title" name="popup_title"><span>Lane Adjust</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
