...
<%@ page import="com.clt.apps.opus.esm.saq.monthlysalesquotamanage.monthlyquotacreation.event.EsmSaq0184Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSaq0184Event event = null;		//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSaq0184Event)request.getAttribute("Event");
...
<div class="layer_popup_title">
	...
	<div class="page_title_area clear">
	   <!-- page_title(S) -->
		<h2 class="page_title" id="popup_title" name="popup_title"><span>Office Adjust</span></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->
...
<div class="layer_popup_contents">	
	...
	<div class="wrap_result">
		<div class="opus_design_grid" id="mainTable">
			<div class="opus_design_btn">
				<button type="button" class="btn_normal" name="btn_rowcopy" id="btn_rowcopy">Copy</button><!--
