...
<%@ page import="com.clt.apps.opus.esm.saq.monthlysalesquotamanage.monthlyquotaadjustmenttraderhq.event.EsmSaq0148Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSaq0148Event  event = null;				//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSaq0148Event)request.getAttribute("Event");
