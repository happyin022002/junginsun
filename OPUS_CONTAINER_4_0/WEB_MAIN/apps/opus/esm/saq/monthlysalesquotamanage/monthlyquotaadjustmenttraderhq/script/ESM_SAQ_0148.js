	...
	try {
		...
		switch(srcName) {
			...
			case "btn_retrieve": 
				...
				break;
			case "btn_save": // close after save
...
function initSheet(sheetObj,sheetNo) {
	...
	switch(sheetNo) {
		case 1:      //sheet1 init
	        ...
	        var cols = [ {Type:"Text",      Hidden:1,  Width:90,   Align:"Center",  ColMerge:1,   SaveName:"sub_trd_cd",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8 },
	                     ...
	                     {Type:"Text",      Hidden:1,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"grp_seq1",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:8 },
	                     ...
	                     {Type:"Float",     Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"load1",        KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     {Type:"Text",      Hidden:1,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"g_rpb1tmp",    KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:13,  UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     {Type:"Float",     Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"g_rpb1",       KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     ...
	                     {Type:"Float",     Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"load2",        KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     {Type:"Text",      Hidden:1,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"g_rpb2tmp",    KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:13,  UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     {Type:"Float",     Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"g_rpb2",       KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     ...
	                     {Type:"Float",     Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"load3",        KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     {Type:"Text",      Hidden:1,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"g_rpb3tmp",    KeyField:0,   CalcLogic:"",   Format:"Float",       PointCount:13,  UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
	                     {Type:"Float",     Hidden:0,  Width:95,   Align:"Center",  ColMerge:0,   SaveName:"g_rpb3",       KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:1,   EditLen:25 },
...
function changeHeadTitle(sheetObj) {
	...
	var rtn=getCodeList("CommonCode", "codeNo=CD20011");	//월번호 "01","02","03","04","05","06","07","08","09","10","11","12","01","02"
...
function doActionIBSheet(sheetObj,formObj,sAction) {
	...
	switch(sAction) {
	   case IBSEARCH:      //
        	...
        	sheetObj.DoSearch("ESM_SAQ_0148GS.do", saqFormString(formObj) );
      	...
      	case IBSAVE:        //save            
           if(validateSave(sheetObj)){
    			...
    			saveParams=replaceParams(saveParams,"f_cmd",formObj.f_cmd.value);           	
              	var rtn=doSaveSheet(sheetObj, "ESM_SAQ_0148GS.do", saveParams);
    			isSheetEdited=false;   
            }       	
          	break;
	}
