...
/**
 * @extends
 * @class ESM_SAQ_0126 : business script for ESM_SAQ_0126.
 */
    		...
    		try {
    			...
    			switch(srcName) {
    				...
    				case "btn_print":
    					...
    					break;
    				case "btn_downexcel":
    					vvdgcd_popUp(cOfficeSheet2,1,1);
    			...
    			case 2: // laneSheet sheet init
    			    with(sheetObj){
		    		      ...
		    		      var cols = [ {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:1,   SaveName:"dir",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		    		             ...
		    		             {Type:"Text",      Hidden:0,  Width:60,   Align:"Center",  ColMerge:1,   SaveName:"item",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
		    		      for (i=0; i<=3; i++) {
		    		    	  cols.push({Type:"Float",     Hidden:0,  Width:70,   Align:"Right",   ColMerge:0,   SaveName:"",      KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:0 });
		    		      }
		    		      cols.push({Type:"Text",      Hidden:1, Width:50,   Align:"Center",  ColMerge:1,   SaveName:"tree",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 });
    			...
    			case 3: // rhqSheet sheet init
    			    with(sheetObj){
		    		      ...
		    		      var cols = [ {Type:"Text",      Hidden:0, Width:60,   Align:"Center",  ColMerge:1,   SaveName:"dir",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		    		             ...
		    		             {Type:"Text",      Hidden:1, Width:70,   Align:"Center",  ColMerge:1,   SaveName:"sub",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		    		             {Type:"Text",      Hidden:1, Width:60,   Align:"Center",  ColMerge:1,   SaveName:"lane",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
		    		             {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:1,   SaveName:"item",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
		    		      for (i=0; i<=3; i++) {
		    		    	  cols.push({Type:"Float",     Hidden:0,  Width:70,   Align:"Right",   ColMerge:0,   SaveName:"",      KeyField:0,   CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:0 });
		    		      }
    		   ...
    		   case IBSEARCH:
    				...
    				if (validateForm(sheetObj,formObj,sAction) == false) {
    		   		...
    		   		if (currentTabIndex == 0) {
    				    ...
    				    f_url="ESM_SAQ_0126GS01.do";
    		   		} else if (currentTabIndex == 1) {
    		   			// Lane retrieve
    				    f_cmd="&f_cmd=" + SEARCHLIST02;
    				    f_url="ESM_SAQ_0126GS02.do";
    		   		} else if (currentTabIndex == 2) {
    		   			// RHQ retrieve
    				    f_cmd="&f_cmd=" + SEARCHLIST03;
    				    f_url="ESM_SAQ_0126GS03.do";
    		   		} else if (currentTabIndex == 3) {
    		   			// C.Office retrieve
    				    f_cmd="&f_cmd=" + SEARCHLIST04;
    				    f_url="ESM_SAQ_0126GS04.do";
    		   		} else if (currentTabIndex == 4) {
    		   			// C.Offcie2 retrieve
    				    f_cmd="&f_cmd=" + SEARCHLIST05;
    				    f_url="ESM_SAQ_0126GS05.do";
    				}
    		   		ComOpenWait(true);
...
//    		} // with end
    	 ...
    	 *  Target Group 변경시
    	 */
    	function targetGrp_OnChange(comObj, oldIndex, oldText, oldCode, newIndex, newText, newCode){
    		targetGroup=targetGrp.GetSelectCode();
    	    version_change();
        	trade_change();
    	}
    	/*
    	 * Year / Target Group chaning version setting
    	 */
    	...
    	/*
    	 * Target Group chaning Trade setting
    	 */
    	...
    	/*
    	 * Trade chaning Sub Trade setting
    	 */
...
//    		common_tree_DblClick(sheetObj, Row, Col);
    	...
    	function rhqSheet_OnTreeChild(sheetObj,  Row){
    	    var params="&f_cmd=" + SEARCHLIST13
					...
					+ "&ctrtOfcCd=" + sheetObj.GetCellValue(Row, "ofc")
					+ "&subTrade=" + sheetObj.GetCellValue(Row, "sub")
	    			+ tabChildSearchParams[currentTabIndex];
    	    sheetObj.DoSearchChild(Row, "ESM_SAQ_0126GS13.do", params);
