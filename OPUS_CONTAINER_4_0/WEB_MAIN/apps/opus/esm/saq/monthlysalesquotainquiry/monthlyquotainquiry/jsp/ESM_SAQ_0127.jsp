...
<%@ page import="com.clt.apps.opus.esm.saq.monthlysalesquotainquiry.monthlyquotainquiry.event.EsmSaq0127Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	EsmSaq0127Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (EsmSaq0127Event)request.getAttribute("Event");
	...
	<div class="opus_design_inquiry wFit">
		<table>
			<tbody>
				...
				<tr class="h23">
					<th>Origin</th>
					<td><input id="rhqCd" class="input1" style="width: 80px;" value="<%=account.getOfc_cd()%>" name="rhqCd" readonly type="text" /> </td>
					<th>Year</th>
			...
			<table>
				<tbody>
					...
					<tr class="h23">
						...
						<th>Trade</th>
						<td><select name="trade01" id="trade01" style="width: 70px;"></select></td>
						<th>Bound</th>
						<td><select name="dirCd01" id="dirCd01" style="width: 70px;"></select></td>
						<th>Item</th>
			...
			<table>
				<tbody>
					...
					<tr class="h23">
						...
						<th>Trade</th>
						<td><select name="trade02" id="trade02" style="width: 70px;" class="input1"></select></td>
						<th>Bound</th>
						<td><select name="dirCd02" id="dirCd02" style="width: 70px;"></select></td>
						<th>Item</th>
			...
			<table>
				<tbody>
					...
					<tr class="h23">
						...
						<th>Trade</th>
						<td><select name="trade03" id="trade03" style="width: 70px;"  class="input1"></select></td>
						<th>Bound</th>
						<td><select name="dirCd03" id="dirCd03" style="width: 70px;"></select></td>
						<th>Item</th>
			...
			<table>
				<tbody>
					...
					<tr class="h23">
						...
						<th>Trade</th>
						<td><select name="trade04" id="trade04" style="width: 70px;" onchange="subTrade_change('C')" class="input1"></select></td>
						<th>Sub Trade</th>
						<td><select name="subTrade04" style="width: 70px;"></select></td>
						<th>Bound</th>
						<td><select name="dirCd04" id="dirCd04" style="width: 70px;" class="input1"></select></td>
						<th>Item</th>
			...
			<table>
				<tbody>
					...
					<tr class="h23">
						...
						<th>Trade</th>
						<td><select name="trade05" id="trade05" style="width: 70px;" onchange="trade05_OnChange()" class="input1"></select></td>
						<th>Sub Trade</th>
						<td><select name="subTrade05" id="subTrade05"  style="width: 70px;"></select></td>
						<th>Lane</th>
						<td><script type="text/javascript">ComComboObject("lane05", 4, 80, 0, 0, 2);</script></td>
						<td colspan="3" style="text-align:right;"><span class="gray pad_btm_8"  id="sheet_unit" name="sheet_unit"  style="display:block;" >Unit : TEU / USD / USD 1,000*</span></td>
					</tr>
					<tr class="h23">
						<td></td>
						<th>Area Director</th>
						<td><select name="aqCd05" id="aqCd05" style="width: 120px;"></select></td>
						<th>Bound</th>
						<td><select name="dirCd05" id="dirCd05" class="input1" style="width: 65px;" onchange="subTrade_change('C2');"></select></td>
						<th>Item</th>
					...
					<tr class="h23">
						<td></td>
						<th>Duration(Week)</th>
						<td><select name="from_wk05" id="from_wk05" class="input1" style="width: 55px;" onChange="week_onChange('C2');" ></select>~ <select name="to_wk05" id="to_wk05" class="input1" style="width: 55px;" onChange="week_onChange('C2');"  ></select></td>
