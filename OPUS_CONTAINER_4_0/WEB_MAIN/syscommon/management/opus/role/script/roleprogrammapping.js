		...
		switch(sheetNo) {
             case 1:      //IBSheet1 init
                with (sheetObj) {
	               ...
	               var cols = [ {Type:"Text",      Hidden:0,  Width:70,   Align:"Center",  ColMerge:0,   SaveName:"level",  KeyField:0,   CalcLogic:"",   Format:"", PointCount:0,   UpdateEdit:0,   InsertEdit:1,   TreeCol:1 ,  LevelSaveName:"level"},
	                      {Type:"Text",      Hidden:0,  Width:100,   Align:"Center",  ColMerge:0,   SaveName:"pgm_no",      KeyField:0,   CalcLogic:"",   Format:"",  PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			...
			case 2:	  //IBSheet2 init
                with (sheetObj) {
			      ...
			      var cols = [ 
			             {Type:"CheckBox",  Hidden:0, Width:50,   Align:"Center",  ColMerge:0,   SaveName:"check_val" },
			             {Type:"Status",    Hidden:1, Width:40,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
			             {Type:"Text",      Hidden:0,  Width:80,   Align:"Left",    ColMerge:0,   SaveName:"pgm_no",       KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 },
			             ...
			             //{Type:"Text",      Hidden:1, Width:150,  Align:"Left",    ColMerge:0,   SaveName:"pgm_nm",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0 } ];
	...
	function doActionIBSheet(sheetObj,formObj,sAction) {
		...
		switch(sAction) {
		   case IBSEARCH:	  //조회
				...
				sheetObj.DoSearch("searchProgramMapping.do", FormQueryString(formObj));
				break;
			case IBCLEAR:	   //Clear
				sheetObj.RemoveAll();
				break;
