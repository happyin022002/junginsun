 ...
 ***************************************************************************************/
        ...
        switch(sheetID) {
            case "sheet1":
                with(sheetObj){
            	 ...
            	 var HeadTitle;
            	 if(adminPageValue == "Y"){
    	             HeadTitle="|User ID|Password|Pwd Reset|User Name|User Local Name|Office Code|Log In OFC|Auth Type|Super user's Role|Use Flag|Role|Program|Cell Phone|Phone No|Fax No|Email|Sales Rep|Email from IAM|Job|Position|Grade|National|Language|TimeZone|Date Type|Num Type|Create User ID|Create Date|Modi. User ID|Modi. Date|Saved Password|usr_pwd_cre_dt|usr_lck_dt|usr_lgin_fald_knt" ; 
            	 }else{
    	             HeadTitle="|User ID|Password|Pwd Change|User Name|User Local Name|Office Code|Log In OFC|Auth Type|Super user's Role|Use Flag|Role|Program|Cell Phone|Phone No|Fax No|Email|Sales Rep|Email from IAM|Job|Position|Grade|National|Language|TimeZone|Date Type|Num Type|Create User ID|Create Date|Modi. User ID|Modi. Date|Saved Password|usr_pwd_cre_dt|usr_lck_dt|usr_lgin_fald_knt" ;
            	 }
	             ...
	             var cols=[ {Type:"Status",    Hidden:1, Width:30,   Align:"Center",  ColMerge:0,   SaveName:"ibflag" },
	                 ...
	                 {Type:"Combo",     Hidden:0, Width:80,   Align:"Left",    ColMerge:0,   SaveName:"usr_auth_tp_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1, ComboText:"Regular|Almighty|SuperUser|SystemAdmin", ComboCode:"R|A|S|E" },
    ...
    function sheet1_OnChange(sheetObj,Row,Col) {
    	var formObject=document.form;
    	if(Col!=8) return;
    	if(sheetObj.GetCellValue(Row,Col)!="S") return;
		...
		if(ComGetEtcData(sXml,"cnt") == "0"){
			...
			sheetObj.SetCellValue(Row,Col,"R",0);
		}
    }
