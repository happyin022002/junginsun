		...
		<div class="opus_design_inquiry">
			<table class="grid_2">
				...
				<tr>
					...
					<%
						int i = 0;
						if (!CheckUtils.isNull(mailCustomVO)) {
...
<!-- hidden start --> 
<input type="hidden" id="com_fromName" name="com_fromName" value="<%=mailCustomVO.getFromName()%>" /> 
<input type="hidden" id="com_smtp" name="com_smtp" value="<%=mailCustomVO.getSmtp()%>" /> 
<input type="hidden" id="f_cmd" name="f_cmd" value="7" /> 
<input type="hidden" id="com_officeCode" name="com_officeCode" value="<%=mailCustomVO.getOfficeCode()%>" /> 
<input type="hidden" id="com_groupwareMail" name="com_groupwareMail" value="<%=mailCustomVO.getGroupwareMail()%>" /> 
<input type="hidden" id="com_fileKey" name="com_fileKey"/> 
<input type="hidden" id="com_mailKeyFlag" name="com_mailKeyFlag" value="<%=mailCustomVO.getMailKeyFlag()%>" /> 
<!-- hidden end -->
<!-- : ( bottom : email ) (E) -->
