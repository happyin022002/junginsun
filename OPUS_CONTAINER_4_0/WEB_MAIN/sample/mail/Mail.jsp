	...
	<div class="wrap_result">
		<div class="opus_design_inquiry wFit">
			<table>
				...
				<tr>
					<td>From</td>
					<td><input type="text" size=100 name="com_from" value="nhc123@cyberlogitec.com"></td>
				</tr>
				<tr>
					<td>From Name</td>
				...
				<tr>
					<td>To</td>
					<td><input type="text" size=100 name="com_recipient" value="coolguy@cyberlogitec.com"></td>
				</tr>
				<tr>
					<td>CC</td>
				...
				<tr>
					...
					<td><input type="text" size=100 name="com_argument" value="name;김정훈,message;Hello"></td>
				</tr>
				<tr>
					<td>RD Template(MRD)</td>
					<td><input type="text" size=100 name="com_templateMrd" value="sample/rd/mrdSample/TEST.mrd"></td>
				</tr>
				<tr>
					<td>RD Template(MRD) Arguments</td>
					<td><input type="text" size=100 name="com_templateMrdArguments" value=""></td>
				</tr>
				<tr>
				...
				<tr>
					<td>RD Template(MRD)</td>
					<td><input type="text" size=100 name="com_templateMrd" value="sample/rd/mrdSample/TESTWithParam.mrd"></td>
				</tr>
				<tr>
					<td>RD Template(MRD) Arguments</td>
					<td><input type="text" size=100 name="com_templateMrdArguments" value="/rp [김정훈] [안녕]"></td>
				</tr>	
				<tr>
					<td>RD Export File Name</td>
