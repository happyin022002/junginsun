        ...
        switch(sheetNo) {
            case 1:      //IBSheet1 init
                with (sheetObj) {
	                ...
	                var HeadTitle="||No|Code|Name| Cnt Code" ;
	                if(mdmYN.replace(/\s/g,"") != ""){
	                HeadTitle += "|Status";
	                }
	                ...
	                var cols = [ {Type:"Radio",     Hidden:0, Width:20,   Align:"Center",  ColMerge:0,   SaveName:"radio",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 },
	                 ...
	                 {Type:"Text",      Hidden:0,  Width:110,  Align:"Left",    ColMerge:0,   SaveName:"ste_nm",    KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 },
    ...
    function doActionIBSheet(sheetObj,formObj,sAction, a, PageNo) {
        ...
        switch(sAction) {
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch("COM_ENS_0X1GS.do", selectVal );
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value=SEARCHLIST;  
                sheetObj.DoSearch("COM_ENS_0X1GS.do", selectVal+"&"+ "iPage=" + PageNo,{Append:true} );
           break;
        }
    }
