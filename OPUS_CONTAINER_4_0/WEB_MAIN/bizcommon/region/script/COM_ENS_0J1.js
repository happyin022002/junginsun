            ...
            case 1:      //IBSheet1 init
                with(sheetObj){   
            		...
            		if(mainPage == undefined) {
            			HeadTitle = "||Seq.|Region Code|Name|Country Code|Sub Continent";
            		} else {
            			HeadTitle = "Seq.|Region Code|Name|Country Code|Sub Continent";
            		}
            		...
            		SetConfig( { SearchMode:0, MergeSheet:0, Page:20, FrozenCol:0, DataRowMerge:0 } );
            		var info    = { Sort:1, ColMove:1, HeaderCheck:1, ColResize:1 };
            		var headers = [ { Text:HeadTitle, Align:"Center"} ];
            		InitHeaders(headers, info);
            		var cols = new Array();
            		if(mainPage == undefined ) {
	            		cols.push({Type:"Radio",     Hidden:0, Width:20,   Align:"Center",  ColMerge:0,   SaveName:"radio",      KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 });
	            		cols.push({Type:"CheckBox",  Hidden:0, Width:20,   Align:"Center",  ColMerge:0,   SaveName:"checkbox",   KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:1,   InsertEdit:1 });
            		}
            		...
            		cols.push({Type:"Text",      Hidden:0,  Width:100,  Align:"Center",  ColMerge:0,   SaveName:"rgn_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
            		cols.push({Type:"Text",      Hidden:0,  Width:250,  Align:"Left",    ColMerge:0,   SaveName:"rgn_nm",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
            		cols.push({Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"cnt_cd",     KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
            		cols.push({Type:"Text",      Hidden:0,  Width:90,   Align:"Center",  ColMerge:0,   SaveName:"sconti_cd",  KeyField:0,   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1 });
            		if(mdmYN.replace(/\s/g,"") != ""){
    ...
    function doActionIBSheet(sheetObj, formObj, sAction,  a,  PageNo) {
        switch(sAction) {
          case IBSEARCH:        //조회
                ...
                sheetObj.DoSearch("COM_ENS_0J1GS.do", selectVal );
           break;
           case IBSEARCHAPPEND:  // 페이징 조회
                formObj.f_cmd.value=SEARCHLIST;  
                sheetObj.DoSearch("COM_ENS_0J1GS.do", selectVal+"&iPage=" + PageNo,{Append:true} );
           break;
        }
    }
//    var iPageNo = 1;
