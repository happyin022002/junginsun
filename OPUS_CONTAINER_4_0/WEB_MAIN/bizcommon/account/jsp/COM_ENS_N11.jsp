...
<div class="opus_design_inquiry wFit">
	<table>
		...
		<tr class="h23">
			<th>Account</th>
			<td><input type="text" name="acct_cd" dataformat="num" style="width:60px;ime-mode:disabled" maxlength="6" class="input" value="<%=(request.getParameter("acct_cd") == null) ? "" : request.getParameter("acct_cd") %>"></td>
			<th>Description</th>
