	...
	<div class="opus_design_inquiry">
		<table>
			...
			<tbody>
				<tr>
					<th>Contract No.</th>
					<td><input type="text" name="cont_tp" dataformat="enguponly" maxlength="3" size="3" style="width:35px"><input type="text" name="cont_no" dataformat="num" maxlength="6" size="6"  style="width:65px;ime-mode:disabled"></td>
					<th>Period</th>
