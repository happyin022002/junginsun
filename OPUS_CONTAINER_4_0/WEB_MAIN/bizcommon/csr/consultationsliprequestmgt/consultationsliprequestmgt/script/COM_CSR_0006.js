    	...
    	function rdOpen(){		
          ...
          if ( rdObj[0].RowCount()== "0")
          {
              ...
              return;
    			...
    			if(previewFlg =="krjp"){			
					//Real 
    				viewer.openFile(RD_path+'bizcommon/csr/consultationsliprequestmgt/consultationsliprequestmgt/report/COM_CSR_0006krjp.mrd', '');
					//Local
    				...
    				//Real 
    				viewer.openFile(RD_path+'bizcommon/csr/consultationsliprequestmgt/consultationsliprequestmgt/report/COM_CSR_0006.mrd', ''); 
					//Local
