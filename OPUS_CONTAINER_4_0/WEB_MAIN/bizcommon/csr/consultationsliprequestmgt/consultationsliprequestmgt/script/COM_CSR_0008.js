...
=========================================================*/
    			...
    			switch(srcName) {
    				...
    				case "btng_viewapprovalstep":
    					...
    					if (apro_rqst_no==undefined || apro_rqst_no==null || apro_rqst_no.trim()==''){
    						showErrMessage(getMsg('CSR40041','Approval Request No')); 
    						return false;
    					}
						var param="?apro_rqst_no="+apro_rqst_no;
	 					ComOpenPopup('/opuscntr/COM_ENS_0W1.do' + param, 640, 270, '', 'none', true);
    					break;
    				case "btng_print":
        ...
        function initSheet(sheetObj,sheetNo) {
            ...
            switch(sheetNo) {
            	case 1:      //sheet1 init
            		with(sheetObj){
                		var HeadTitle1="|CSR No.|Payment S/P|Payment S/P|I/F\nStatus|I/F Status\nUpdated Time|Error\nReason|CSR\nCreated Time|CSR Registered|CSR Registered|CSR Approved/ Disapproved|CSR Approved/ Disapproved|No. of\n Invoice|Currency|Total\nAmount|Payment\nDue Date|Payment\nGroup|ASA No." ;
