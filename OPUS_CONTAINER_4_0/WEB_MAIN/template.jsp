...
<%
	...
	try {
		...
		try {
			...
			menuProcessor.doEnd();
			HashMap menu = (HashMap) request
					.getAttribute("MenuInformation");
			title = (String) menu.get("title");
			description = (String) menu.get("description");
			navigation = ((String) menu.get("navigation"))
					.substring(10);
		} catch (Exception ee) {
			;
		}
...
<body onload="setupPage();startCheck();">
    ...
    <div class="header_fixed">
        ...
        <div class="util_bar">
            ...
            <!-- full_menu(S) -->
            <iframe
                src="fullmenuFrame.jsp?parentPgmNo=<%=StringUtil.xssFilter(request.getParameter("parentPgmNo"))%>"
                class="fullmenu_wrap" id="fullmenu_frame"
                onload="fullmenu_load()"></iframe>
            <!-- full_menu(E) -->
    ...
    <iframe
        src="gnbFrame.jsp?parentPgmNo=<%=StringUtil.xssFilter(request.getParameter("parentPgmNo"))%>"
        class="gnb_wrap" id="gnb_frame" style="width: 0"></iframe>
    <!-- //GNB -->
