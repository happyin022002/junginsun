...
*@FileName : AgentCanalTransitFeeBCDBDAOaddPsoMsaCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AgentCanalTransitFeeBCDBDAOaddPsoMsaCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AgentCanalTransitFeeBCDBDAOaddPsoMsaCSQL(){
		setQuery();
		...
		query.append("FileName : AgentCanalTransitFeeBCDBDAOaddPsoMsaCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO PSO_MSA(" ).append("\n"); 
