...
/**
 * EXP_SPP_0002 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * - EXP_SPP_0002HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Kim Seong Kwang
 * @see EXP_SPP_0002HTMLAction 참조
 * @since J2EE 1.6
 */

public class ExpSpp0002Event extends EventSupport {
	...
	/**
	 * 메인 조회 조건 
	 * @category EXP_SPP_0002_searchcond_voset
	 * @param vo
	 */
