...
*@FileName : EXP_SPP_0005HTMLAction.java
...
public class EXP_SPP_0005HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * EXP_SPP_0005HTMLAction 객체를 생성
	 */
	public EXP_SPP_0005HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	ExpSpp0005Event event = new ExpSpp0005Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {  //retrieve button click
			event.setCanalTzBkgVvdVO((CanalTzBkgVvdVO)getVO(request, CanalTzBkgVvdVO .class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {//save button click	
			event.setCanalTzBkgVvdVOS((CanalTzBkgVvdVO[])getVOs(request, CanalTzBkgVvdVO .class, "sheet1_"));
		}
