...
public class MsaRemVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MsaRemVO> models = new ArrayList<MsaRemVO>();
	...
	public MsaRemVO(String ibflag, String pagerows, String vslCd, String vslNm, String skdVoyNo, String skdDirCd, String vvd, String amount, String revYrmon, String vndrSeq, String ydCd, String trnsDt) {
		this.amount = amount;
		this.vvd = vvd;
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 * @return MsaRemVO[]
	 */
	public MsaRemVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MsaRemVO[]
	 */
	public MsaRemVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MsaRemVO model = null;
	 ...
	 * @return MsaRemVO[]
	 */
	public MsaRemVO[] getMsaRemVOs(){
		MsaRemVO[] vos = (MsaRemVO[])models.toArray(new MsaRemVO[models.size()]);
		return vos;
	}
