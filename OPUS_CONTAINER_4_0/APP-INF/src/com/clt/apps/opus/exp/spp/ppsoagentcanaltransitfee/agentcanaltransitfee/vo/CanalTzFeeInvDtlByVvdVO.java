...
public class CanalTzFeeInvDtlByVvdVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setAseq(JSPUtil.getParameter(request, "aseq", ""));
		setPsoBztpCd(JSPUtil.getParameter(request, "pso_bztp_cd", ""));
		setSq(JSPUtil.getParameter(request, "sq", ""));
		setCallSeq(JSPUtil.getParameter(request, "call_seq", ""));
		setLgsCostCdClssLvl(JSPUtil.getParameter(request, "lgs_cost_cd_clss_lvl", ""));
		...
		setDseq(JSPUtil.getParameter(request, "dseq", ""));
		setYdCd(JSPUtil.getParameter(request, "yd_cd", ""));
		setVndrSeq(JSPUtil.getParameter(request, "vndr_seq", ""));
		setLgsCostCd(JSPUtil.getParameter(request, "lgs_cost_cd", ""));
		setCreditsAmt(JSPUtil.getParameter(request, "credits_amt", ""));
