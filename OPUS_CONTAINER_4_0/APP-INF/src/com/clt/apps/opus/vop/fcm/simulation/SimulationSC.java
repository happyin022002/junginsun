...
package com.clt.apps.opus.vop.fcm.simulation;
...
import com.clt.apps.opus.vop.fcm.simulation.simulation.basic.SimulationBC;
import com.clt.apps.opus.vop.fcm.simulation.simulation.basic.SimulationBCImpl;
import com.clt.apps.opus.vop.fcm.simulation.simulation.event.VopFcm0052Event;
import com.clt.apps.opus.vop.fcm.simulation.simulation.event.VopFcm0053Event;
import com.clt.apps.opus.vop.fcm.simulation.simulation.event.VopFcm0054Event;
import com.clt.apps.opus.vop.fcm.simulation.simulation.event.VopFcm0055Event;
import com.clt.apps.opus.vop.fcm.simulation.simulation.event.VopFcm0056Event;
import com.clt.apps.opus.vop.fcm.simulation.simulation.vo.BnkReqSimVO;
...
import com.clt.apps.opus.vop.fcm.simulation.simulation.vo.StandardFocVO;
import com.clt.apps.opus.vop.fcm.simulation.simulation.vo.TrndLineSimulationVO;
...
public class SimulationSC extends ServiceCommandSupport {
	...
	public EventResponse perform(Event e) throws EventException {
		...
		if (e.getEventName().equalsIgnoreCase("VopFcm0052Event")) {
