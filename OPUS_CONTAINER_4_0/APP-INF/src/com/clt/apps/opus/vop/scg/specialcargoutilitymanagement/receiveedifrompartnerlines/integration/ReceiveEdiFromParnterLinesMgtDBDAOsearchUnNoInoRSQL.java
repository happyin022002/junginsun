...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOsearchUnNoInoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOsearchUnNoInoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOsearchUnNoInoRSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOsearchUnNoInoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MAX('1') IMDG_UN_NO " ).append("\n"); 
