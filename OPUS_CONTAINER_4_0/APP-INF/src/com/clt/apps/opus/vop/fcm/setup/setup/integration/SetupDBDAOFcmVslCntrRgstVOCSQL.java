...
*@FileName : SetupDBDAOFcmVslCntrRgstVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SetupDBDAOFcmVslCntrRgstVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SetupDBDAOFcmVslCntrRgstVOCSQL(){
		setQuery();
		...
		query.append("FileName : SetupDBDAOFcmVslCntrRgstVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO FCM_VSL_CNTR_RGST( " ).append("\n"); 
