...
*@FileName : TdrUtilizeVO.java
*@FileTitle : TdrUtilizeVO
*Open Issues :
*Change history :
...
public class TdrUtilizeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TdrUtilizeVO> models = new ArrayList<TdrUtilizeVO>();
	...
	public TdrUtilizeVO(String ibflag, String pagerows, String vslCd, String voyNo, String dirCd, String portCd, String callInd, String oprCd, String pod, String cntrType, String cntrSize, String status, String qty, String weight, String updateTime, String updateUser, String podIso) {
		this.vslCd = vslCd;
		this.voyNo = voyNo;
		this.weight = weight;
	 ...
	 * @return TdrUtilizeVO[]
	 */
	public TdrUtilizeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TdrUtilizeVO[]
	 */
	public TdrUtilizeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TdrUtilizeVO model = null;
	 ...
	 * @return TdrUtilizeVO[]
	 */
	public TdrUtilizeVO[] getTdrUtilizeVOs(){
		TdrUtilizeVO[] vos = (TdrUtilizeVO[])models.toArray(new TdrUtilizeVO[models.size()]);
		return vos;
	}
