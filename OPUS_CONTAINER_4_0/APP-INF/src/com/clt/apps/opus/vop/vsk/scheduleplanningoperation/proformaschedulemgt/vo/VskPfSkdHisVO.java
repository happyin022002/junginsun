...
public class VskPfSkdHisVO extends AbstractValueObject {
	...
	public VskPfSkdHisVO(String ibflag, String pagerows, String num, String vslSlanCd, String pfSvcTpCd, String simDt, String simNo, String pfHisSeq, String pfSkdStsCd, String diffRmk, String creUsrId, String creDt, String updUsrId, String updDt, String history) {
		this.updDt = updDt;
		this.creDt = creDt;
		this.simDt = simDt;
		this.simNo = simNo;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("history", getHistory());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("history", "history");
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setHistory(JSPUtil.getParameter(request, "history", ""));
	...
	public VskPfSkdHisVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] history = (JSPUtil.getParameter(request, prefix	+ "history".trim(), length));
			String[] pfSkdStsCd = (JSPUtil.getParameter(request, prefix	+ "pf_skd_sts_cd".trim(), length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag".trim(), length));
			String[] num = (JSPUtil.getParameter(request, prefix	+ "num".trim(), length));
	...
	*/
	public void unDataFormat(){
		...
		this.history = this.history .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
