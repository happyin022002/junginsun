...
*@FileName : VOP_SCG_1019HTMLAction.java
...
public class VOP_SCG_1019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_1019HTMLAction 객체를 생성
	 */
	public VOP_SCG_1019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg1019Event event = new VopScg1019Event();
