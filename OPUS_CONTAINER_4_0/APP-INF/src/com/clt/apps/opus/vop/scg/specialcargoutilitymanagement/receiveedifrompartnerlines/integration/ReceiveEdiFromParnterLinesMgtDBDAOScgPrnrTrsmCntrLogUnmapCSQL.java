...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCntrLogUnmapCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCntrLogUnmapCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * cntr log unmap 데이터생성
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCntrLogUnmapCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCntrLogUnmapCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_PRNR_CNTR_LOG_UNMAP" ).append("\n"); 
		...
		query.append("          	FROM    SCG_PRNR_CNTR_LOG_UNMAP 	UN" ).append("\n"); 
		...
		query.append("          	AND     UN.CNTR_SEQ   				= @[cntr_seq]" ).append("\n"); 
		query.append("          	)    " ).append("\n"); 
		query.append("																		/* EDI_UNMAP_SEQ        */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
