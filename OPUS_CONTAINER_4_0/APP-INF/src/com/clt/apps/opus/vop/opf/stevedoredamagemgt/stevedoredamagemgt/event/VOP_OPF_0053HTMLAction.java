...
*@FileName : VOP_OPF_0053HTMLAction.java
...
public class VOP_OPF_0053HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0053HTMLAction 객체를 생성
	 */
	public VOP_OPF_0053HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0053Event event = new VopOpf0053Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSdmsOptionVO((SdmsOptionVO)getVO(request, SdmsOptionVO .class));
		}
