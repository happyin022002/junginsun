...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOAddScgPrnrSpclCgoDtlErrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOAddScgPrnrSpclCgoDtlErrCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddScgPrnrSpclCgoDtlErr
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOAddScgPrnrSpclCgoDtlErrCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOAddScgPrnrSpclCgoDtlErrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SCG_PRNR_SPCL_CGO_DTL_ERR" ).append("\n"); 
		query.append("	(" ).append("\n"); 
		...
		query.append("            FROM SCG_PRNR_SPCL_CGO_DTL_ERR" ).append("\n"); 
