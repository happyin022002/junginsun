...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFInquirySummaryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFInquirySummaryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFInquirySummaryRSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFInquirySummaryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SELECT SUBSTR(POD,1,5) AS POD" ).append("\n"); 
		query.append("     , CASE WHEN P = 0 AND M = 1 AND S = 0 AND W = 0 THEN 'Sub WG'" ).append("\n"); 
		query.append("            ELSE MLB" ).append("\n"); 
		query.append("       END  MLB" ).append("\n"); 
		query.append("     , CASE WHEN P = 0 AND M = 1 AND S = 1 AND W = 1 THEN 'Sub Total'" ).append("\n"); 
		...
		query.append("     , CASE WHEN P = 0 AND M = 0 AND S = 0 AND W = 1 THEN 'Total'" ).append("\n"); 
		...
		query.append("FROM   ( SELECT (POD||POD_CLPT_IND_SEQ) AS POD, MLB, DECODE(NVL(SORT,0),0,NULL,MAX(FM)) FM, WG, MAX(WSEQ) WSEQ," ).append("\n"); 
		query.append("                GROUPING(POD||POD_CLPT_IND_SEQ) P, GROUPING(MLB) M, GROUPING(SORT) S, GROUPING(WG) W," ).append("\n"); 
		query.append("                CASE" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ)=0 AND GROUPING(MLB)=0 AND GROUPING(SORT)=0 AND GROUPING(WG)=0 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ)=0 AND GROUPING(MLB)=0 AND GROUPING(SORT)=0 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ)=0 AND GROUPING(MLB)=1 AND GROUPING(SORT)=1 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ)=0 AND GROUPING(MLB)=0 AND GROUPING(SORT)=1 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ)=0 AND GROUPING(MLB)=1 AND GROUPING(SORT)=0 AND GROUPING(WG)=1 THEN 1" ).append("\n"); 
		query.append("                WHEN GROUPING(POD||POD_CLPT_IND_SEQ)=0 AND GROUPING(MLB)=1 AND GROUPING(SORT)=0 AND GROUPING(WG)=0 THEN 1" ).append("\n"); 
		...
		query.append("         FROM ( SELECT DISTINCT O.POD POD, O.POD_CLPT_IND_SEQ, O.MLB, O.FM FM, O.WG WG, O.WSEQ WSEQ," ).append("\n"); 
		...
		query.append("                FROM   ( SELECT POD, POD_CLPT_IND_SEQ, MLB, FM, SORT, WG, WSEQ," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("                                       SUM(DECODE(SUBSTR(TP,2,1),'2',DECODE(OWNR,'Y',1,CNTR_QTY),0))+SUM(DECODE(SUBSTR(TP,2,1),'A',DECODE(OWNR,'Y',1,CNTR_QTY),0)) TQTY," ).append("\n"); 
		query.append("                                       SUM(DECODE(SUBSTR(TP,2,1),'3',DECODE(OWNR,'Y',1,CNTR_QTY),0)) THQTY," ).append("\n"); 
		query.append("                                       SUM(DECODE(SUBSTR(TP,2,1),'4',DECODE(OWNR,'Y',1,CNTR_QTY),0))+SUM(DECODE(SUBSTR(TP,2,1),'B',DECODE(OWNR,'Y',1,CNTR_QTY),0)) FQTY," ).append("\n"); 
		query.append("                                       SUM(DECODE(SUBSTR(TP,2,1),'5',DECODE(OWNR,'Y',1,CNTR_QTY),0)) FHQTY," ).append("\n"); 
		query.append("                                       SUM(DECODE(SUBSTR(TP,2,1),'7',DECODE(OWNR,'Y',1,CNTR_QTY),0)) SQTY" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                                         FROM   OPF_CGO_BKG_FCAST 				H" ).append("\n"); 
		query.append("											, 	OPF_CGO_BKG_FCAST_CNTR 			D" ).append("\n"); 
		...
		query.append("                                GROUP BY POD, POD_CLPT_IND_SEQ, MLB, FM, WG, WSEQ, OPR )," ).append("\n"); 
		query.append("                                DUMY AS" ).append("\n"); 
		query.append("                                ( SELECT 'F' FM FROM DUAL" ).append("\n"); 
		query.append("                                  UNION ALL" ).append("\n"); 
		query.append("                                  SELECT 'E' FM FROM DUAL )," ).append("\n"); 
		query.append("                                WGTGRP AS ( SELECT CNTR_WGT_GRP_CD WG, CNTR_WGT_GRP_SEQ WSEQ" ).append("\n"); 
		query.append("                                              FROM OPF_CGO_BKG_FCAST_WGT_GRP" ).append("\n"); 
		query.append("                                          GROUP BY CNTR_WGT_GRP_CD, CNTR_WGT_GRP_SEQ" ).append("\n"); 
		query.append("                                           )" ).append("\n"); 
		query.append("                                SELECT S1.POD, S1.POD_CLPT_IND_SEQ, S1.MLB, S1.FM, DECODE(S1.FM,'F',1,2) SORT, S1.WG, S1.WSEQ, S1.OPR," ).append("\n"); 
		...
		query.append("                                FROM   ( SELECT POD, POD_CLPT_IND_SEQ, MLB, FM, WG, WSEQ, OPR" ).append("\n"); 
		query.append("                                         FROM   ( SELECT DISTINCT POD, POD_CLPT_IND_SEQ, MLB, OPR" ).append("\n"); 
		query.append("                                                  FROM S ) S, DUMY, WGTGRP ) S1, S S2" ).append("\n"); 
		query.append("                                WHERE S1.POD              = S2.POD(+)" ).append("\n"); 
		query.append("                                AND   S1.POD_CLPT_IND_SEQ = S2.POD_CLPT_IND_SEQ(+)" ).append("\n"); 
		query.append("                                AND   NVL(S1.MLB,'N')     = NVL(S2.MLB(+),'N')" ).append("\n"); 
		query.append("                                AND   S1.FM   = S2.FM(+)" ).append("\n"); 
		query.append("                                AND   S1.WG   = S2.WG(+)" ).append("\n"); 
		query.append("                                AND   S1.OPR  = S2.OPR(+) )" ).append("\n"); 
		query.append("                         GROUP BY SORT, POD, POD_CLPT_IND_SEQ, MLB, FM, WG, WSEQ ) O," ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'2',DECODE(OWNR,'Y',1,CNTR_QTY),0))+SUM(DECODE(SUBSTR(TP,2,1),'A',DECODE(OWNR,'Y',1,CNTR_QTY),0)) TQTY," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'2',CNTR_GRS_WGT,0)) 				 +SUM(DECODE(SUBSTR(TP,2,1),'A',CNTR_GRS_WGT,0))                TWGT," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'3',DECODE(OWNR,'Y',1,CNTR_QTY),0)) THQTY," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'3',CNTR_GRS_WGT,0))                THWGT," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'4',DECODE(OWNR,'Y',1,CNTR_QTY),0))+SUM(DECODE(SUBSTR(TP,2,1),'B',DECODE(OWNR,'Y',1,CNTR_QTY),0)) FQTY," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'4',CNTR_GRS_WGT,0)) 				 +SUM(DECODE(SUBSTR(TP,2,1),'B',CNTR_GRS_WGT,0))                FWGT," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'5',DECODE(OWNR,'Y',1,CNTR_QTY),0)) FHQTY," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'5',CNTR_GRS_WGT,0))                FHWGT," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'7',DECODE(OWNR,'Y',1,CNTR_QTY),0)) SQTY," ).append("\n"); 
		query.append("                                SUM(DECODE(SUBSTR(TP,2,1),'7',CNTR_GRS_WGT,0))                SWGT" ).append("\n"); 
		...
		query.append("                                         END  >=1 )" ).append("\n"); 
		query.append("                         WHERE CNTR_RN = 1" ).append("\n"); 
		query.append("                         GROUP BY POD, POD_CLPT_IND_SEQ, MLB, FM, WG, WSEQ )," ).append("\n"); 
		query.append("                         DUMY AS" ).append("\n"); 
		query.append("                         ( SELECT 'F' FM FROM DUAL" ).append("\n"); 
		query.append("                           UNION ALL" ).append("\n"); 
		query.append("                           SELECT 'E' FM FROM DUAL )," ).append("\n"); 
		...
		query.append("                                   GROUP BY CNTR_WGT_GRP_CD, CNTR_WGT_GRP_SEQ" ).append("\n"); 
		query.append("                                   )                           " ).append("\n"); 
		query.append("                         SELECT S1.POD, S1.POD_CLPT_IND_SEQ, S1.MLB, S1.FM, DECODE(S1.FM,'F',1,2) SORT, S1.WG, S1.WSEQ," ).append("\n"); 
		...
		query.append("                         FROM   ( SELECT POD, POD_CLPT_IND_SEQ, MLB, FM, WG, WSEQ" ).append("\n"); 
		query.append("                                  FROM   ( SELECT DISTINCT POD, POD_CLPT_IND_SEQ, MLB" ).append("\n"); 
		query.append("                                           FROM S ) S, DUMY, WGTGRP ) S1, S S2" ).append("\n"); 
		query.append("                         WHERE S1.POD              = S2.POD(+)" ).append("\n"); 
		query.append("                         AND   S1.POD_CLPT_IND_SEQ = S2.POD_CLPT_IND_SEQ(+)" ).append("\n"); 
		query.append("                         AND   NVL(S1.MLB,'N')     = NVL(S2.MLB(+),'N')" ).append("\n"); 
		query.append("                         AND   S1.FM   = S2.FM(+)" ).append("\n"); 
		query.append("                         AND   S1.WG   = S2.WG(+) ) T" ).append("\n"); 
		query.append("                WHERE  O.POD              = T.POD" ).append("\n"); 
		query.append("                AND    O.POD_CLPT_IND_SEQ = T.POD_CLPT_IND_SEQ" ).append("\n"); 
		...
		query.append("         GROUP BY CUBE(POD||POD_CLPT_IND_SEQ, MLB, SORT, WG) ) A, " ).append("\n"); 
		...
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT NVL(SUBSTR(POD,1,5),'Grand Total') POD" ).append("\n"); 
		query.append("     , MLB" ).append("\n"); 
		query.append("     , CASE WHEN P = 1 AND M = 1 AND S = 1 AND W = 1 THEN 'Grand Weight'" ).append("\n"); 
		...
		query.append("            ELSE DECODE(FM,'F','Full','E','Empty',FM)" ).append("\n"); 
		query.append("       END  FM" ).append("\n"); 
		query.append("     , CASE WHEN P = 0 AND M = 0 AND S = 0 AND W = 1 THEN 'Total Weight'" ).append("\n"); 
		query.append("            ELSE DECODE(WG,'X','Extra Heavy','H','Heavy','M','Medium','L','Light','E','Ultra Light')" ).append("\n"); 
		query.append("       END  WG" ).append("\n"); 
		query.append("     , WSEQ" ).append("\n"); 
		query.append("#if (${qty1} != '')" ).append("\n"); 
		...
		query.append("                                       END  >=1 )" ).append("\n"); 
		query.append("                                WHERE CNTR_RN = 1" ).append("\n"); 
		query.append("                                GROUP BY POD, POD_CLPT_IND_SEQ, MLB, FM, WG, OPR, WSEQ )," ).append("\n"); 
		query.append("                                DUMY AS" ).append("\n"); 
		query.append("                                ( SELECT 'F' FM FROM DUAL" ).append("\n"); 
		query.append("                                  UNION ALL" ).append("\n"); 
		query.append("                                  SELECT 'E' FM FROM DUAL )," ).append("\n"); 
		...
		query.append("     , CASE WHEN S = 1 AND W = 1 THEN 'Grand Total'" ).append("\n"); 
		query.append("            ELSE DECODE(FM,'F','Full','E','Empty',FM)" ).append("\n"); 
		query.append("       END  FM" ).append("\n"); 
		query.append("     , CASE WHEN S = 0 AND W = 1 THEN 'Total'" ).append("\n"); 
		query.append("            ELSE DECODE(WG,'X','Extra Heavy','H','Heavy','M','Medium','L','Light','E','Ultra Light')" ).append("\n"); 
		query.append("       END  WG" ).append("\n"); 
		query.append("     , WSEQ" ).append("\n"); 
		query.append("#if (${qty1} != '')" ).append("\n"); 
		...
		query.append("                                          GROUP BY CNTR_WGT_GRP_CD, CNTR_WGT_GRP_SEQ" ).append("\n"); 
		query.append("                                           )                                  " ).append("\n"); 
		query.append("                                SELECT S1.FM, DECODE(S1.FM,'F',4,5) SORT, S1.WG, S1.WSEQ, S1.OPR," ).append("\n"); 
		query.append("                                       NVL(S2.TQTY,0)  TQTY,  NVL(S2.THQTY,0) THQTY," ).append("\n"); 
		query.append("                                       NVL(S2.FQTY,0)  FQTY,  NVL(S2.FHQTY,0) FHQTY," ).append("\n"); 
		query.append("                                       NVL(S2.SQTY,0)  SQTY," ).append("\n"); 
		query.append("                                       CASE " ).append("\n"); 
		...
		query.append("                                       WHEN S1.OPR = @[qty5] THEN 5" ).append("\n"); 
		query.append("                                       END  ROW_NUM" ).append("\n"); 
		query.append("                                FROM   ( SELECT FM, WG, WSEQ, OPR" ).append("\n"); 
		...
		query.append("SELECT 'Grand Total' POD" ).append("\n"); 
		query.append("     , NULL MLB" ).append("\n"); 
		query.append("     , CASE WHEN S = 1 AND W = 1 THEN 'Grand Weight'" ).append("\n"); 
		query.append("            ELSE DECODE(FM,'F','Full','E','Empty',FM)" ).append("\n"); 
		query.append("       END  FM" ).append("\n"); 
		query.append("     , CASE WHEN S = 0 AND W = 1 THEN 'Total Weight'" ).append("\n"); 
		query.append("            ELSE DECODE(WG,'X','Extra Heavy','H','Heavy','M','Medium','L','Light','E','Ultra Light')" ).append("\n"); 
		query.append("       END  WG" ).append("\n"); 
		query.append("     , WSEQ" ).append("\n"); 
		query.append("#if (${qty1} != '')" ).append("\n"); 
