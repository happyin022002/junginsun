...
*@FileName : VOP_VSK_0252HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.vop.vsk.vskcommon 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class VOP_VSK_0252HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0252HTMLAction 객체를 생성
	 */
	public VOP_VSK_0252HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0252Event event = new VopVsk0252Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCodeInfoVO((CodeInfoVO)getVO(request, CodeInfoVO .class));
		}
