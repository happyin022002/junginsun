...
*@FileName : VOP_OPF_1021HTMLAction.java
...
public class VOP_OPF_1021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_1021HTMLAction 객체를 생성
	 */
	public VOP_OPF_1021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	VopOpf1021Event event = new VopOpf1021Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			String skd_dir_cd = request.getParameter("skd_dir_cd");		
			String yd_cd      = request.getParameter("yd_cd");		
			String pod_cd     = request.getParameter("pod_cd");		
			
			event.setAttribute("vsl_cd", vsl_cd);
			event.setAttribute("skd_voy_no", skd_voy_no);
			event.setAttribute("skd_dir_cd", skd_dir_cd);
			event.setAttribute("yd_cd", yd_cd);
			event.setAttribute("pod_cd", pod_cd);
		}
