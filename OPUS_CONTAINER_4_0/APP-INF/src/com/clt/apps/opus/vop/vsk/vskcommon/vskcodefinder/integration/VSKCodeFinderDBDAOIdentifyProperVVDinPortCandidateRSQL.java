...
*@FileName : VSKCodeFinderDBDAOIdentifyProperVVDinPortCandidateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VSKCodeFinderDBDAOIdentifyProperVVDinPortCandidateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VSKCodeFinderDBDAOIdentifyProperVVDinPortCandidateRSQL(){
		setQuery();
		...
		query.append("FileName : VSKCodeFinderDBDAOIdentifyProperVVDinPortCandidateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("     ,  XX.IB_CSSM_VOY_NO" ).append("\n"); 
		query.append("     ,  XX.OB_CSSM_VOY_NO" ).append("\n"); 
		...
		query.append("					WHEN SUBSTR(PS.OB_CSSM_VOY_NO,1,4) 	= @[ob_cssm_voy_no] AND PS.VPS_PORT_CD = @[pol_cd]	THEN '2'" ).append("\n"); 
		query.append("					WHEN PS.OB_CSSM_VOY_NO 				= @[ob_cssm_voy_no] THEN '3'" ).append("\n"); 
		query.append("					WHEN SUBSTR(PS.OB_CSSM_VOY_NO,1,4) 	= @[ob_cssm_voy_no] THEN '4'" ).append("\n"); 
