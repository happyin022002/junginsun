...
*@FileName : OwnStwgCgoApprovalDBDAOScgStwgCgoVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnStwgCgoApprovalDBDAOScgStwgCgoVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnStwgCgoApprovalDBDAOScgStwgCgoVORSQL(){
		setQuery();
		...
		query.append("FileName : OwnStwgCgoApprovalDBDAOScgStwgCgoVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM SCG_STWG_CGO" ).append("\n"); 
		...
		query.append("AND	SPCL_CGO_APRO_RQST_SEQ = (	SELECT MAX(SPCL_CGO_APRO_RQST_SEQ) FROM SCG_APRO_RQST WHERE SPCL_CGO_CATE_CD = 'SS' AND BKG_NO = @[bkg_no]	)" ).append("\n"); 
