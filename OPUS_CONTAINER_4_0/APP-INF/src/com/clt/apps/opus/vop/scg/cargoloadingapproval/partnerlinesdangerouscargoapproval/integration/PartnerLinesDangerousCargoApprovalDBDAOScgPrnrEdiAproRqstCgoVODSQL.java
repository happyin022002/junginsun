...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrEdiAproRqstCgoVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrEdiAproRqstCgoVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrEdiAproRqstCgoVODSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrEdiAproRqstCgoVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   AUTH_STS_CD       = 'X'" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("   --::2015-05-30::--AND REF_NO            = @[ref_no]" ).append("\n"); 
		query.append("   AND DCGO_REF_NO       = @[dcgo_ref_no]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("   AND AUTH_STS_CD       <> 'X'" ).append("\n"); 
