...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		setColumnwidth(JSPUtil.getParameter(request, prefix + "columnwidth", ""));
		setOrientation(JSPUtil.getParameter(request, prefix + "orientation", ""));
		setTitle(JSPUtil.getParameter(request, prefix + "title", ""));
		setCols(JSPUtil.getParameter(request, prefix + "cols", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setAlign(JSPUtil.getParameter(request, prefix + "align", ""));
		setDatarowheight(JSPUtil.getParameter(request, prefix + "datarowheight", ""));
