...
public class SpecialCargoIrregularMgtDBDAOIrrCntrVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",   TO_CHAR(NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SIC.UPD_DT,'GMT'), SIC.UPD_DT), 'YYYY-MM-DD') UPD_DT" ).append("\n"); 
		...
		query.append("  , DECODE(SIR.CGO_OPR_CD,COM_ConstantMgr_PKG.COM_getCompanyCode_FNC(),SIC.CNTR_NO,SIC.CNTR_REF_NO)" ).append("\n"); 
		query.append("  , SIC.CNTR_TPSZ_CD" ).append("\n"); 
		query.append("  , SIC.SPCL_CGO_CATE_CD" ).append("\n"); 
		query.append("  , SIC.CELL_PSN_NO" ).append("\n"); 
		query.append("  , SIC.CGO_SEQ" ).append("\n"); 
