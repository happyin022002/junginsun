...
*@FileName : StatusVesselMainVO
*@FileTitle : StatusVesselMainVO
*Open Issues :
*Change history :
...
public class StatusVesselMainVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<StatusVesselMainVO> models = new ArrayList<StatusVesselMainVO>();
	...
	public StatusVesselMainVO() {}

	public StatusVesselMainVO(String ibflag, String pagerows, String grp, String svcLane, String opt, String vslClass, String own, String cht, String oth, String ttl) {
		this.grp = grp;
		this.ibflag = ibflag;
		this.oth = oth;
	 ...
	 * @param request
	 * @return StatusVesselMainVO[]
	 */
	public StatusVesselMainVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return StatusVesselMainVO[]
	 */
	public StatusVesselMainVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		StatusVesselMainVO model = null;
	 ...
	 * @return StatusVesselMainVO[]
	 */
	public StatusVesselMainVO[] getStatusVesselMainVOs(){
		StatusVesselMainVO[] vos = (StatusVesselMainVO[])models.toArray(new StatusVesselMainVO[models.size()]);
		return vos;
	}
