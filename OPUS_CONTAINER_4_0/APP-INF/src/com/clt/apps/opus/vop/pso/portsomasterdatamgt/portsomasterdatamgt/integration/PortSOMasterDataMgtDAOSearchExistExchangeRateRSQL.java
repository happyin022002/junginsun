...
*@FileName : PortSOMasterDataMgtDAOSearchExistExchangeRateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortSOMasterDataMgtDAOSearchExistExchangeRateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortSOMasterDataMgtDAOSearchExistExchangeRateRSQL(){
		setQuery();
		...
		query.append("FileName : PortSOMasterDataMgtDAOSearchExistExchangeRateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CASE WHEN COUNT(ACCT_XCH_RT_YRMON) > 0 THEN 'Y' ELSE 'N' END EXIST_YN" ).append("\n"); 
