...
*@FileName : VOP_VSK_0703HTMLAction.java
...
public class VOP_VSK_0703HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0703HTMLAction 객체를 생성
	 */
	public VOP_VSK_0703HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0703Event event = new VopVsk0703Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVskPortFltgCrnVO((VskPortFltgCrnVO)getVO(request, VskPortFltgCrnVO .class));
		}
