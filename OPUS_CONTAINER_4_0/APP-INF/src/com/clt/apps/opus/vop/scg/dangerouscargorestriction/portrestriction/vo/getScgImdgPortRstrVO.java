...
*@FileName : getScgImdgPortRstrVO.java
*@FileTitle : getScgImdgPortRstrVO
*Open Issues :
*Change history :
...
public class getScgImdgPortRstrVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<getScgImdgPortRstrVO> models = new ArrayList<getScgImdgPortRstrVO>();
	...
	public getScgImdgPortRstrVO() {}

	public getScgImdgPortRstrVO(String ibflag, String pagerows, String imdgUnNo, String imdgUnNoSeq, String imdgClssCd, String prohiLodFlg, String prohiDchgFlg, String prohiTsFlg, String prohiPassFlg, String prohiDyTmOpFlg, String prohiDyTmInlndTzFlg, String prohiPortFlg, String prohiPinspFlg, String xtraHndlChgFlg, String sftGadFlg, String kepSftDistIhbFlg, String kepSftDistIhbDist, String rstrRmk, String prohiNgtFlg, String dirLodFlg, String dirDchgFlg, String dirTsFlg, String creUsrId, String creDt, String updUsrId, String updDt, String portCd, String imdgPortRstrSeq, String imdgPortRstrExptFlg) {
	 ...
	 * @param request
	 * @return getScgImdgPortRstrVO[]
	 */
	public getScgImdgPortRstrVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return getScgImdgPortRstrVO[]
	 */
	public getScgImdgPortRstrVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		getScgImdgPortRstrVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new getScgImdgPortRstrVO();
				if (rstrRmk[i] != null)
		...
		return getgetScgImdgPortRstrVOs();
	}
	 ...
	 * @return getScgImdgPortRstrVO[]
	 */
	public getScgImdgPortRstrVO[] getgetScgImdgPortRstrVOs(){
		getScgImdgPortRstrVO[] vos = (getScgImdgPortRstrVO[])models.toArray(new getScgImdgPortRstrVO[models.size()]);
		return vos;
	}
