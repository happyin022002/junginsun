...
*@FileName : PortRestrictionOptionVO.java
*@FileTitle : PortRestrictionOptionVO
*Open Issues :
*Change history :
...
public class PortRestrictionOptionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PortRestrictionOptionVO> models = new ArrayList<PortRestrictionOptionVO>();
	...
	/* Column Info */
	private String polPortRotnSeq = null;
	/* Column Info */
	private String podPortRotnSeq = null;
	/* Column Info */
	...
	public PortRestrictionOptionVO() {}

	public PortRestrictionOptionVO(String ibflag, String pagerows, String portType, String portCd, String imdgCmptnAuthCd, String txtDesc, String polVpsPortCd, String podVpsPortCd, String imdgClssCd, String imdgUnNo, String imdgUnNoSeq, String slanCd, String polPortCd, String podPortCd, String polPortRotnSeq, String podPortRotnSeq, String portRotnSeq, String clptSeq) {
		...
		this.polPortRotnSeq = polPortRotnSeq;
		this.podPortRotnSeq = podPortRotnSeq;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("pol_port_rotn_seq", getPolPortRotnSeq());
		this.hashColumns.put("pod_port_rotn_seq", getPodPortRotnSeq());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("pol_port_rotn_seq", "polPortRotnSeq");
		this.hashFields.put("pod_port_rotn_seq", "podPortRotnSeq");
	...
	/**
	 * Column Info
	 * @return polPortRotnSeq
	 */
	public String getPolPortRotnSeq() {
		return this.polPortRotnSeq;
	}
	
	/**
	 * Column Info
	 * @return podPortRotnSeq
	 */
	public String getPodPortRotnSeq() {
		return this.podPortRotnSeq;
	}
	...
	/**
	 * Column Info
	 * @param polPortRotnSeq
	 */
	public void setPolPortRotnSeq(String polPortRotnSeq) {
		this.polPortRotnSeq = polPortRotnSeq;
	}
	
	/**
	 * Column Info
	 * @param podPortRotnSeq
	 */
	public void setPodPortRotnSeq(String podPortRotnSeq) {
		this.podPortRotnSeq = podPortRotnSeq;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setPolPortRotnSeq(JSPUtil.getParameter(request, "pol_port_rotn_seq", ""));
		setPodPortRotnSeq(JSPUtil.getParameter(request, "pod_port_rotn_seq", ""));
	 ...
	 * @param request
	 * @return PortRestrictionOptionVO[]
	 */
	public PortRestrictionOptionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PortRestrictionOptionVO[]
	 */
	public PortRestrictionOptionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PortRestrictionOptionVO model = null;
		...
		try {
			...
			String[] polPortRotnSeq = (JSPUtil.getParameter(request, prefix	+ "pol_port_rotn_seq", length));
			String[] podPortRotnSeq = (JSPUtil.getParameter(request, prefix	+ "pod_port_rotn_seq", length));
			String[] portRotnSeq = (JSPUtil.getParameter(request, prefix	+ "port_rotn_seq", length));
			String[] clptSeq = (JSPUtil.getParameter(request, prefix	+ "clpt_seq", length));
			
			for (int i = 0; i < length; i++) {
				model = new PortRestrictionOptionVO();
				if (polPortCd[i] != null)
				...
				if (polPortRotnSeq[i] != null)
					model.setPolPortRotnSeq(polPortRotnSeq[i]);
				if (podPortRotnSeq[i] != null)
					model.setPodPortRotnSeq(podPortRotnSeq[i]);
		...
		return getPortRestrictionOptionVOs();
	}
	 ...
	 * @return PortRestrictionOptionVO[]
	 */
	public PortRestrictionOptionVO[] getPortRestrictionOptionVOs(){
		PortRestrictionOptionVO[] vos = (PortRestrictionOptionVO[])models.toArray(new PortRestrictionOptionVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.polPortRotnSeq = this.polPortRotnSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.podPortRotnSeq = this.podPortRotnSeq .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
