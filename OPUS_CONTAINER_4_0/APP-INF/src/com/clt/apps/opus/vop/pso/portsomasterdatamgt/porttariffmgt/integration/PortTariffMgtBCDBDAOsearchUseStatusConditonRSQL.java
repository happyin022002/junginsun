...
public class PortTariffMgtBCDBDAOsearchUseStatusConditonRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , A.UPD_MNU_NO_COND" ).append("\n"); 
		query.append("  FROM (" ).append("\n"); 
		query.append("        SELECT DISTINCT T1.COND_NO                  AS ID" ).append("\n"); 
		query.append("             , T1.COND_DESC                         AS DESCRIPT" ).append("\n"); 
		query.append("             , DECODE(T3.COND_NO, NULL, 'N', 'Y')   AS LINK" ).append("\n"); 
		query.append("             , TO_CHAR(T1.UPD_DT, 'YYYY-MM-DD')     AS CRE_DATE" ).append("\n"); 
		query.append("             , T1.UPD_USR_ID                        AS CRE_USR" ).append("\n"); 
		query.append("             , T1.UPD_MNU_NO                        AS UPD_MNU_NO_COND" ).append("\n"); 
		...
		query.append("AND UPPER(T1.COND_DESC) LIKE '%'||UPPER(@[descript])||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
