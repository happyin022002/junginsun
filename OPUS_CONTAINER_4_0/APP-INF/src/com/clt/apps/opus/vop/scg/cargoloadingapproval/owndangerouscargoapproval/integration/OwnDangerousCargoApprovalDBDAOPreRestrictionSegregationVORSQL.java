...
public class OwnDangerousCargoApprovalDBDAOPreRestrictionSegregationVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("          ---- ::2014-07-23:: ----, UN.IMDG_UN_NO_HLD_FLG" ).append("\n"); 
		...
		query.append("					,	'N'							AS LQ_CHK" ).append("\n"); 
		query.append("					,	'N'							AS EQ_CHK" ).append("\n"); 
		query.append("			FROM		(" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#foreach(${obj} in ${opt_obj})" ).append("\n"); 
		query.append("     #if($velocityCount > ${start_num} && $velocityCount <= ${end_num})" ).append("\n"); 
		...
		query.append("		T.SPCL_CNTR_SEQ1" ).append("\n"); 
		...
		query.append("           , YY.IMDG_SEGR_GRP_STWG_TP_CD   	AS IMDG_SEGR_CD" ).append("\n"); 
		query.append("           , CASE YY.IMDG_SEGR_GRP_STWG_TP_CD WHEN '1' THEN 'Away from Class'" ).append("\n"); 
		query.append("                                              WHEN '2' THEN 'Separated from class'" ).append("\n"); 
		query.append("                                              WHEN '3' THEN 'Separated by compartment or hold from Class'" ).append("\n"); 
		query.append("                                              WHEN '4' THEN 'Separated longitudinally from Class'" ).append("\n"); 
		query.append("                                              ELSE 'N/A'" ).append("\n"); 
		query.append("                                                " ).append("\n"); 
		query.append("             END ||' '|| YY.IMDG_CLSS_CD    AS CONFLICT_DESC" ).append("\n"); 
		query.append("           , UNT2.SPCL_CNTR_SEQ             AS SPCL_CNTR_SEQ2                 " ).append("\n"); 
		query.append("           , UNT2.SPCL_CGO_SEQ              AS SPCL_CGO_SEQ2                 " ).append("\n"); 
		...
		query.append("           , '' --XX.IMDG_UN_NO_HLD_FLG         	AS IMDG_UN_NO_HLD_FLG2   " ).append("\n"); 
		query.append("    " ).append("\n"); 
		query.append("    FROM     UN_NO_TBL                     	UNT" ).append("\n"); 
		query.append("		   , UN_NO_TBL                     	UNT2" ).append("\n"); 
		query.append("           , SCG_IMDG_UN_NO_CLSS_CD        	YY" ).append("\n"); 
		query.append("    WHERE    1 = 1" ).append("\n"); 
		query.append("	AND		 UNT.IMDG_CLSS_CD				= YY.IMDG_CLSS_CD" ).append("\n"); 
		query.append("	AND		 UNT.IMDG_UN_NO                 = YY.IMDG_UN_NO" ).append("\n"); 
		query.append("    AND      UNT.IMDG_UN_NO_SEQ             = YY.IMDG_UN_NO_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    AND      YY.IMDG_CLSS_CD                = UNT2.IMDG_CLSS_CD" ).append("\n"); 
		query.append("	AND		 UNT.IMDG_UN_NO                 <> UNT2.IMDG_UN_NO" ).append("\n"); 
		query.append("    AND      UNT.IMDG_UN_NO_SEQ             <> UNT2.IMDG_UN_NO_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	AND	     UNT.SPCL_CNTR_SEQ				= UNT2.SPCL_CNTR_SEQ" ).append("\n"); 
		query.append("    --==================================================================================================  " ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("    UNION ALL" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("         --:2016-01-27:--, SCG_IMDG_SEGR_GRP_DTL 			ISG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("         , (" ).append("\n"); 
		query.append("			#foreach(${obj} in ${opt_obj})" ).append("\n"); 
		query.append("     			#if($velocityCount > ${start_num} && $velocityCount <= ${end_num})" ).append("\n"); 
		query.append("             " ).append("\n"); 
		query.append("			SELECT		TO_NUMBER('$obj.getImdgSegrGrpNo()')	AS IMDG_SEGR_GRP_NO " ).append("\n"); 
		query.append("					,	'$obj.getImdgUnNo()'     				AS IMDG_UN_NO  " ).append("\n"); 
		query.append("			FROM 		DUAL" ).append("\n"); 
		query.append("          " ).append("\n"); 
		query.append("				#if($velocityCount < ${end_num} && $velocityCount < ${obj_size})" ).append("\n"); 
		...
		query.append("			UNION" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			SELECT    	GRP.IMDG_SEGR_GRP_NO" ).append("\n"); 
		query.append("					,  	GRP.IMDG_UN_NO" ).append("\n"); 
		query.append("            FROM      	SCG_IMDG_SEGR_GRP_DTL GRP" ).append("\n"); 
		query.append("           )								ISG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("         , UN_NO_TBL             			UNT" ).append("\n"); 
		...
		query.append("----           UNT1.SPCL_CNTR_SEQ             AS SPCL_CNTR_SEQ1                 " ).append("\n"); 
		query.append("----         , UNT1.SPCL_CGO_SEQ              AS SPCL_CGO_SEQ1                 " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	AND		NOT (T.IMDG_UN_NO1	= T.IMDG_UN_NO2 AND T.IMDG_UN_NO_SEQ1 = T.IMDG_UN_NO_SEQ2)" ).append("\n"); 
		query.append("" ).append("\n"); 
