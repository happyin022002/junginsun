...
*@FileName : VOP_SCG_5922HTMLAction.java
...
public class VOP_SCG_5922HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_5922HTMLAction 객체를 생성
	 */
	public VOP_SCG_5922HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg5922Event event = new VopScg5922Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPortLimitsBkgVO((PortLimitsBkgVO)getVO(request, PortLimitsBkgVO .class,""));
		}
