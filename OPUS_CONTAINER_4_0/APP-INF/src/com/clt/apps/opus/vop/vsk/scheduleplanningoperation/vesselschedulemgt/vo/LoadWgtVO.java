...
public class LoadWgtVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setCol07(JSPUtil.getParameter(request, "col07", ""));
	}
