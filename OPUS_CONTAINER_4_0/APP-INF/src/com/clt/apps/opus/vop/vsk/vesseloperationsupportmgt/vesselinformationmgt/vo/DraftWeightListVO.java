...
*@FileName : DraftWeightListVO.java
*@FileTitle : DraftWeightListVO
*Open Issues :
*Change history :
...
public class DraftWeightListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<DraftWeightListVO> models = new ArrayList<DraftWeightListVO>();
	...
	public DraftWeightListVO() {}

	public DraftWeightListVO(String ibflag, String pagerows, String mtxSeq, String vslCd, String dwtWgt, String drftDpth, String creUsrId, String creDt, String updUsrId) {
		this.vslCd = vslCd;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setDrftDpth(JSPUtil.getParameter(request, prefix + "drft_dpth", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setMtxSeq(JSPUtil.getParameter(request, prefix + "mtx_seq", ""));
	 ...
	 */
	public DraftWeightListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return DraftWeightListVO[]
	 */
	public DraftWeightListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		DraftWeightListVO model = null;
		...
		try {
			...
			String[] drftDpth = (JSPUtil.getParameter(request, prefix	+ "drft_dpth", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] mtxSeq = (JSPUtil.getParameter(request, prefix	+ "mtx_seq", length));
	...
	public DraftWeightListVO[] getDraftWeightListVOs(){
		DraftWeightListVO[] vos = (DraftWeightListVO[])models.toArray(new DraftWeightListVO[models.size()]);
		return vos;
	}
