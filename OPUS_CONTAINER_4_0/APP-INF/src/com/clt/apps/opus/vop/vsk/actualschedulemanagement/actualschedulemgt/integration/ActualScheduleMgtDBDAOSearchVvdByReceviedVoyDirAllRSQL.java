...
*@FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedVoyDirAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchVvdByReceviedVoyDirAllRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchVvdByReceviedVoyDirAllRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedVoyDirAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
