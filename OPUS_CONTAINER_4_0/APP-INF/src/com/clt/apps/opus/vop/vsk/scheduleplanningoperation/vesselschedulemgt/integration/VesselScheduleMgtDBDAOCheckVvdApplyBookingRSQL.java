...
*@FileName : VesselScheduleMgtDBDAOCheckVvdApplyBookingRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCheckVvdApplyBookingRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCheckVvdApplyBookingRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCheckVvdApplyBookingRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
