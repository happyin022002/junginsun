...
public class VesselScheduleMgtDBDAOAddVskVslPortSkdCSQL implements ISQLTemplate{
	...
	public VesselScheduleMgtDBDAOAddVskVslPortSkdCSQL(){
		...
		params.put("cssm_voy_init_cre_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("			-----------------------------" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			--::ADD:2015-06-26:by TOP::--" ).append("\n"); 
		...
		query.append("		,	@[clpt_seq]" ).append("\n"); 
		query.append("		,	@[slan_cd]" ).append("\n"); 
		query.append("		,	NVL(@[port_skd_sts_cd],'')" ).append("\n"); 
		query.append("		,	@[yd_cd]" ).append("\n"); 
		query.append("		,	@[call_yd_ind_seq]" ).append("\n"); 
		...
		query.append("		,   TO_DATE(CASE WHEN LENGTH(@[cre_dt])>=12 THEN SUBSTR(@[cre_dt],1,12) ELSE TO_CHAR(SYSDATE, 'YYYYMMDDHH24MI') END, 'YYYYMMDDHH24MI')" ).append("\n"); 
		query.append("		,	@[upd_usr_id]" ).append("\n"); 
		...
		query.append("			END" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("		,	DECODE(@[cssm_voy_init_cre_flg],'N','N','Y')" ).append("\n"); 
		query.append("			-----------------------------" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			--::ADD:2015-06-26:by TOP::--" ).append("\n"); 
		query.append("		,	@[vt_add_call_flg]" ).append("\n"); 
		...
		query.append("        ,   @[skp_call_flg]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("        ,   DECODE(@[add_call_xter_flg],'1','Y','N')" ).append("\n"); 
		query.append("		,	@[priv_call_flg]" ).append("\n"); 
		query.append("		)" ).append("\n"); 
