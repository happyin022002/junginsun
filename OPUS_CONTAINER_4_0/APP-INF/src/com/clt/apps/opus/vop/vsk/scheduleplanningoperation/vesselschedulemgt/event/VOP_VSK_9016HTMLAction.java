...
*@FileName : VOP_VSK_9016HTMLAction.java
*@FileTitle : Vessel Rename
*Open Issues :
*Change history :
...
public class VOP_VSK_9016HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_9016HTMLAction 객체를 생성
	 */
	public VOP_VSK_9016HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk9016Event event = new VopVsk9016Event();
