...
*@FileName : RegionDepartureReportDBDAORDRVslMvmtVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORDRVslMvmtVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDRVslMvmtVO Select Query
	  * </pre>
	  */
	public RegionDepartureReportDBDAORDRVslMvmtVORSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORDRVslMvmtVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT M.PORT_CD        AS PORT," ).append("\n"); 
