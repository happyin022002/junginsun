...
public class VslDepRptNotRcvVO extends AbstractValueObject {
	...
	public VslDepRptNotRcvVO(String ibflag, String pagerows, String vslSlanCd, String vvd, String mssPortCd, String mssYdCd, String clptIndSeq) {
		this.mssYdCd = mssYdCd;
		this.vvd = vvd;
		this.ibflag = ibflag;
		this.clptIndSeq = clptIndSeq;
		this.mssPortCd = mssPortCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("mss_port_cd", getMssPortCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("mss_port_cd", "mssPortCd");
	 ...
	 * @return mssPortCd
	 */
	public String getMssPortCd() {
		return this.mssPortCd;
	}
	 ...
	 * @param mssPortCd
	 */
	public void setMssPortCd(String mssPortCd) {
		this.mssPortCd = mssPortCd;
	}
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setMssPortCd(JSPUtil.getParameter(request, prefix + "mss_port_cd", ""));
	...
	public VslDepRptNotRcvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] mssPortCd = (JSPUtil.getParameter(request, prefix	+ "mss_port_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (mssPortCd[i] != null)
					model.setMssPortCd(mssPortCd[i]);
				if (vslSlanCd[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.mssPortCd = this.mssPortCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
