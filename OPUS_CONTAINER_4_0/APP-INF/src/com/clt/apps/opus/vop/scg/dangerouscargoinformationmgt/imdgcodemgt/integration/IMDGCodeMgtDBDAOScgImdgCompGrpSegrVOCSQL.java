...
*@FileName : IMDGCodeMgtDBDAOScgImdgCompGrpSegrVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgCompGrpSegrVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgCompGrpSegrVOCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_COMP_GRP_SEGR (" ).append("\n"); 
		query.append("ROW_IMDG_COMP_GRP_CD" ).append("\n"); 
		query.append(",	COL_IMDG_COMP_GRP_CD" ).append("\n"); 
		query.append(",	IMDG_SEGR_CD" ).append("\n"); 
		query.append(",	IMDG_SEGR_NTC_NO" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgCompGrpSegrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}