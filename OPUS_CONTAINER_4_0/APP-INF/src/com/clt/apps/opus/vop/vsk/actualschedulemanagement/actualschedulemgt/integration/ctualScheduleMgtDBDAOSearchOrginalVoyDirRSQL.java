...
*@FileName : ctualScheduleMgtDBDAOSearchOrginalVoyDirRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ctualScheduleMgtDBDAOSearchOrginalVoyDirRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ctualScheduleMgtDBDAOSearchOrginalVoyDirRSQL(){
		setQuery();
		...
		query.append("FileName : ctualScheduleMgtDBDAOSearchOrginalVoyDirRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
