...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOSelectMatchedPolClptIndSeqforEDIRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOSelectMatchedPolClptIndSeqforEDIRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 적합한 Calling Indicator 추출하기
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOSelectMatchedPolClptIndSeqforEDIRSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOSelectMatchedPolClptIndSeqforEDIRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 	NVL(MAX(X.CLPT_IND_SEQ),-1)" ).append("\n"); 
