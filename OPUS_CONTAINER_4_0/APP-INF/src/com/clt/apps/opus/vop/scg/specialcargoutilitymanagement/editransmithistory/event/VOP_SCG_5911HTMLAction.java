...
*@FileName : VOP_SCG_5012HTMLAction.java
...
public class VOP_SCG_5911HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_5911HTMLAction 객체를 생성
	 */
	public VOP_SCG_5911HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg5911Event event = new VopScg5911Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEdiTransmitHistoryHdrVO((EdiTransmitHistoryHdrVO)getVO(request, EdiTransmitHistoryHdrVO .class));
		}
