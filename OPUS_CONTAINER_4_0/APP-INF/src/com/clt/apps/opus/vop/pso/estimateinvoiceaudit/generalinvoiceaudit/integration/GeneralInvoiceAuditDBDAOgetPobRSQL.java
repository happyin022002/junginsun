...
*@FileName : GeneralInvoiceAuditDBDAOgetPobRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetPobRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetPobRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetPobRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(NVL(A.VPS_ETA_DT, T.PILOT_ARR),'HH24MI')" ).append("\n"); 
