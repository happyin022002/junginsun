...
*@FileName : InterfaceScheduleToExternalDBDAOCheckExistKntForSpecificVVDRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceScheduleToExternalDBDAOCheckExistKntForSpecificVVDRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VIPS I/F 목적의 VVD 존재여부 확인
	  * </pre>
	  */
	public InterfaceScheduleToExternalDBDAOCheckExistKntForSpecificVVDRSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceScheduleToExternalDBDAOCheckExistKntForSpecificVVDRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
