...
public class RegionDepartureReportDBDAORDRLoadVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("			CASE WHEN  POD ='TOTAL'  AND CNTR_SIZE='WEIGHT' THEN  " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("			CASE WHEN  POD ='TOTAL'  AND CNTR_SIZE='WEIGHT' THEN  ''  ELSE NVL(TO_CHAR( TOTAL_VOL),'0') END TOTAL_VOL," ).append("\n"); 
		...
		query.append("				TOTAL_WGT" ).append("\n"); 
		query.append("				FROM   ( 	SELECT OPR_CD, POD, CNTR_TYPE," ).append("\n"); 
		query.append("							DECODE(CNTR_SIZE,'2','20','A','20','3','2H','4','40','B','40','H','4H','L','45') CNTR_SIZE," ).append("\n"); 
		query.append("							CASE" ).append("\n"); 
		query.append("									WHEN GROUPING(OPR_CD)=0 AND GROUPING(POD)=0 AND GROUPING(CNTR_TYPE)=0 AND GROUPING(CNTR_SIZE)=0 THEN 1" ).append("\n"); 
		...
		query.append("								( SELECT M.OPR_CD, M.POD AS POD, M.CNTR_TYPE, M.CNTR_SIZE, M.QTY, M.WEIGHT WGT, POL" ).append("\n"); 
		...
		query.append("						--SELECT 'F' CNTR_TYPE, 'A' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("						--UNION ALL" ).append("\n"); 
		query.append("						SELECT 'F' CNTR_TYPE, '3' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("						UNION ALL" ).append("\n"); 
		query.append("						SELECT 'F' CNTR_TYPE, '4' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("						UNION ALL" ).append("\n"); 
		query.append("						--SELECT 'F' CNTR_TYPE, 'B' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("						--UNION ALL" ).append("\n"); 
		...
		query.append("			FROM   ( 	SELECT OPR_CD, POD, POL, CNTR_TYPE, CNTR_SIZE" ).append("\n"); 
		query.append("			FROM   ( 	SELECT DISTINCT OPR_CD, POD, POL" ).append("\n"); 
		query.append("						FROM S " ).append("\n"); 
		query.append("					) S, DUMY ) S1, S S2" ).append("\n"); 
		query.append("			WHERE S1.OPR_CD    = S2.OPR_CD(+)" ).append("\n"); 
		query.append("			AND   S1.POD   = S2.POD(+)" ).append("\n"); 
		...
		query.append("			GROUP BY CUBE(OPR_CD, POD, CNTR_TYPE, CNTR_SIZE ) )" ).append("\n"); 
		query.append("			WHERE C1 = 1" ).append("\n"); 
		query.append("			" ).append("\n"); 
		query.append("			UNION ALL" ).append("\n"); 
		query.append("			" ).append("\n"); 
		query.append("         SELECT OPR_CD," ).append("\n"); 
		query.append("                'Sub-TTL' POD," ).append("\n"); 
		query.append("                CNTR_TYPE," ).append("\n"); 
		query.append("                CNTR_SIZE," ).append("\n"); 
		query.append("		#foreach($key IN ${pol})" ).append("\n"); 
		query.append("			#if($velocityCount < 10)" ).append("\n"); 
		...
		query.append("                                                TOTAL_VOL," ).append("\n"); 
		query.append("                                                TOTAL_WGT" ).append("\n"); 
		query.append("                                FROM   ( 	SELECT OPR_CD,DECODE(CNTR_SIZE,'2','20','A','20','3','2H','4','40','B','40','H','4H','L','45') CNTR_SIZE," ).append("\n"); 
		query.append("                                        #foreach($key IN ${pol})" ).append("\n"); 
		query.append("                                                #if($velocityCount < 10)" ).append("\n"); 
		query.append("                                                        MAX(DECODE(ROW_NUM, $velocityCount, QTY,0))    POL_QTY_0$velocityCount," ).append("\n"); 
		query.append("                                                #else" ).append("\n"); 
		...
		query.append("                                                        UNION ALL" ).append("\n"); 
		query.append("														--SELECT 'A' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("                                                        --UNION ALL" ).append("\n"); 
		query.append("                                                        SELECT '3' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("                                                        UNION ALL" ).append("\n"); 
		query.append("                                                        SELECT '4' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("                                                        UNION ALL" ).append("\n"); 
		query.append("                                                        --SELECT 'B' CNTR_SIZE FROM DUAL" ).append("\n"); 
		query.append("                                                        --UNION ALL" ).append("\n"); 
		...
		query.append("                                                        GROUP BY OPR_CD,DECODE(CNTR_SIZE,'2','20','A','20','3','2H','4','40','B','40','H','4H','L','45')" ).append("\n"); 
		...
		query.append("				AND    H.DIR_CD  = M.DIR_CD" ).append("\n"); 
		query.append("				AND    H.REGION  = M.REGION" ).append("\n"); 
		query.append("                AND    M.CNTR_SIZE IN ('2','A','3','4','B','H','L')" ).append("\n"); 
		query.append("				AND    M.POL IN (" ).append("\n"); 
		query.append("							#foreach($key IN ${pol})" ).append("\n"); 
		query.append("								#if($velocityCount == 1)" ).append("\n"); 
		query.append("									'$key'" ).append("\n"); 
		...
		query.append("         DECODE(POD,'TOTAL','ZZZZZ','Sub-TTL','ZZZZY',POD)," ).append("\n"); 
