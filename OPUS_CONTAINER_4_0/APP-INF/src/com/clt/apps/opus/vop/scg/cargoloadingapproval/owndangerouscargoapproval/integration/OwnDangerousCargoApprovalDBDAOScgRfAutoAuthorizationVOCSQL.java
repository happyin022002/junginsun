...
*@FileName : OwnDangerousCargoApprovalDBDAOScgRfAutoAuthorizationVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgRfAutoAuthorizationVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgRfAutoAuthorizationVOCSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgRfAutoAuthorizationVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	@[spcl_cgo_cate_cd]  --'RF'" ).append("\n"); 
		query.append(",	@[dcgo_seq]" ).append("\n"); 
		query.append(",	@[rc_seq]" ).append("\n"); 
		query.append(",	@[bb_cgo_seq]" ).append("\n"); 
		query.append(",	@[awk_cgo_seq]" ).append("\n"); 
		...
		query.append(",	(SELECT RQ.RQST_OFC_CD FROM SCG_APRO_RQST RQ WHERE RQ.BKG_NO = @[bkg_no] " ).append("\n"); 
		query.append("	 AND RQ.SPCL_CGO_APRO_RQST_SEQ = @[spcl_cgo_apro_rqst_seq]" ).append("\n"); 
		query.append("	 AND RQ.LST_RQST_DAT_FLG = 'Y'" ).append("\n"); 
		query.append("     )" ).append("\n"); 
		query.append("--,  [auth_ofc_cd]" ).append("\n"); 
		query.append("--,	(SELECT RQ.RQST_USR_ID FROM SCG_APRO_RQST RQ WHERE RQ.BKG_NO = [bkg_no] " ).append("\n"); 
		query.append("--	 AND RQ.SPCL_CGO_APRO_RQST_SEQ = [spcl_cgo_apro_rqst_seq]" ).append("\n"); 
		query.append("--	 AND RQ.LST_RQST_DAT_FLG = 'Y'" ).append("\n"); 
		query.append("--     )" ).append("\n"); 
		query.append(",  'AUTO'" ).append("\n"); 
		query.append(",	NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,BKG_COM_USER_LOC_FNC(@[cre_usr_id])), SYSDATE) --AUTH_DT" ).append("\n"); 
		query.append(",	NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,'GMT'), SYSDATE) --AUTH_GDT" ).append("\n"); 
		query.append(",	@[spcl_cgo_auth_no]" ).append("\n"); 
		query.append(",	@[spcl_cgo_auth_rjct_cd]" ).append("\n"); 
		query.append(",	@[apro_ref_no]" ).append("\n"); 
		query.append(",	@[spcl_cgo_auth_rmk]" ).append("\n"); 
