...
/**
 * OPUS SpecialCargoIrregularMgtDBDAO <br>
 * - OPUS-VesselOperationIrregularMgt system Business Logic을 처리하기 위한 JDBC 작업수행.<br>
 * 
 * @author HyunUk Kim
...
public class SpecialCargoIrregularMgtDBDAO extends DBDAOSupport {
	...
	public void addIrrCntr(IrregularVO irregularVO, List<IrrCntrVO> irrCntrVOs) throws DAOException,Exception {
		...
		try {
			...
			velParam.put("comp_cd", ConstantMgr.getCompanyCode());
			SQLExecuter sqlExe = new SQLExecuter("");
			int insCnt[] = null;
	 ...
	 * 
	 * @param irrFileListVOs List<IrrFileLSpecialCargoIrregularMgtDBDAOIrrCntrVOUSQListVO>
	 * @throws DAOException
	 */
