...
public class TdrDistLoadVolVO extends AbstractValueObject {
	...
	public TdrDistLoadVolVO(String ibflag, String pagerows, String oprCd, String podCd, String fullBo20, String fullBo2h, String fullBo40, String fullBo4h, String fullBo45, String fullTs20, String fullTs2h, String fullTs40, String fullTs4h, String fullTs45, String etBo20, String etBo2h, String etBo40, String etBo4h, String etBo45, String etTs20, String etTs2h, String etTs40, String etTs4h, String etTs45, String wt20, String wt2h, String wt40, String wt4h, String wt45, String idxSheet) {
	...
	public void fromRequest(HttpServletRequest request) {
		setFullBo20(JSPUtil.getParameter(request, "full_bo_20", ""));
		setFullBo4h(JSPUtil.getParameter(request, "full_bo_4h", ""));
		setFullBo2h(JSPUtil.getParameter(request, "full_bo_2h", ""));
		setFullBo45(JSPUtil.getParameter(request, "full_bo_45", ""));
		setFullBo40(JSPUtil.getParameter(request, "full_bo_40", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setEtTs45(JSPUtil.getParameter(request, "et_ts_45", ""));
		setFullTs40(JSPUtil.getParameter(request, "full_ts_40", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setWt40(JSPUtil.getParameter(request, "wt_40", ""));
		setFullTs20(JSPUtil.getParameter(request, "full_ts_20", ""));
		setWt45(JSPUtil.getParameter(request, "wt_45", ""));
		setFullTs4h(JSPUtil.getParameter(request, "full_ts_4h", ""));
		setFullTs45(JSPUtil.getParameter(request, "full_ts_45", ""));
		setEtTs40(JSPUtil.getParameter(request, "et_ts_40", ""));
		setWt2h(JSPUtil.getParameter(request, "wt_2h", ""));
		setEtTs4h(JSPUtil.getParameter(request, "et_ts_4h", ""));
		setEtTs2h(JSPUtil.getParameter(request, "et_ts_2h", ""));
		setEtTs20(JSPUtil.getParameter(request, "et_ts_20", ""));
		setWt4h(JSPUtil.getParameter(request, "wt_4h", ""));
		setFullTs2h(JSPUtil.getParameter(request, "full_ts_2h", ""));
		setEtBo2h(JSPUtil.getParameter(request, "et_bo_2h", ""));
		setEtBo40(JSPUtil.getParameter(request, "et_bo_40", ""));
		setWt20(JSPUtil.getParameter(request, "wt_20", ""));
		setEtBo45(JSPUtil.getParameter(request, "et_bo_45", ""));
		setEtBo20(JSPUtil.getParameter(request, "et_bo_20", ""));
		setPodCd(JSPUtil.getParameter(request, "pod_cd", ""));
		setOprCd(JSPUtil.getParameter(request, "opr_cd", ""));
		setIdxSheet(JSPUtil.getParameter(request, "idx_sheet", ""));
		setEtBo4h(JSPUtil.getParameter(request, "et_bo_4h", ""));
	}
	...
	public TdrDistLoadVolVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] fullBo20 = (JSPUtil.getParameter(request, prefix	+ "full_bo_20", length));
			String[] fullBo4h = (JSPUtil.getParameter(request, prefix	+ "full_bo_4h", length));
			String[] fullBo2h = (JSPUtil.getParameter(request, prefix	+ "full_bo_2h", length));
			String[] fullBo45 = (JSPUtil.getParameter(request, prefix	+ "full_bo_45", length));
			String[] fullBo40 = (JSPUtil.getParameter(request, prefix	+ "full_bo_40", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix	+ "pagerows", length));
			String[] etTs45 = (JSPUtil.getParameter(request, prefix	+ "et_ts_45", length));
			String[] fullTs40 = (JSPUtil.getParameter(request, prefix	+ "full_ts_40", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix	+ "ibflag", length));
			String[] wt40 = (JSPUtil.getParameter(request, prefix	+ "wt_40", length));
			String[] fullTs20 = (JSPUtil.getParameter(request, prefix	+ "full_ts_20", length));
			String[] wt45 = (JSPUtil.getParameter(request, prefix	+ "wt_45", length));
			String[] fullTs4h = (JSPUtil.getParameter(request, prefix	+ "full_ts_4h", length));
			String[] fullTs45 = (JSPUtil.getParameter(request, prefix	+ "full_ts_45", length));
			String[] etTs40 = (JSPUtil.getParameter(request, prefix	+ "et_ts_40", length));
			String[] wt2h = (JSPUtil.getParameter(request, prefix	+ "wt_2h", length));
			String[] etTs4h = (JSPUtil.getParameter(request, prefix	+ "et_ts_4h", length));
			String[] etTs2h = (JSPUtil.getParameter(request, prefix	+ "et_ts_2h", length));
			String[] etTs20 = (JSPUtil.getParameter(request, prefix	+ "et_ts_20", length));
			String[] wt4h = (JSPUtil.getParameter(request, prefix	+ "wt_4h", length));
			String[] fullTs2h = (JSPUtil.getParameter(request, prefix	+ "full_ts_2h", length));
			String[] etBo2h = (JSPUtil.getParameter(request, prefix	+ "et_bo_2h", length));
			String[] etBo40 = (JSPUtil.getParameter(request, prefix	+ "et_bo_40", length));
			String[] wt20 = (JSPUtil.getParameter(request, prefix	+ "wt_20", length));
			String[] etBo45 = (JSPUtil.getParameter(request, prefix	+ "et_bo_45", length));
			String[] etBo20 = (JSPUtil.getParameter(request, prefix	+ "et_bo_20", length));
			...
			String[] etBo4h = (JSPUtil.getParameter(request, prefix	+ "et_bo_4h", length));
