...
*@FileName : VMS_SCG_0037HTMLAction.java
...
public class VOP_SCG_0037HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0037HTMLAction 객체를 생성
	 */
	public VOP_SCG_0037HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0037Event event = new VopScg0037Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgClssCdVOS((ScgImdgClssCdVO[])getVOs(request, ScgImdgClssCdVO .class,""));
		}
