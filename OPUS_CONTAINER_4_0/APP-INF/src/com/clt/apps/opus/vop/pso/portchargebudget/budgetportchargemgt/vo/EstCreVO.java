...
public class EstCreVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EstCreVO> models = new ArrayList<EstCreVO>();
	...
	public EstCreVO(String ibflag, String pagerows, String revYrmon, String vvd, String vslCd, String skdVoyNo, String skdDirCd, String revDirCd, String rlaneCd, String estmVvdTpCd, String creUsrId, String creDt) {
		this.vvd = vvd;
...
/**
	 ...
	 * @return EstCreVO[]
	 */
	public EstCreVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EstCreVO[]
	 */
	public EstCreVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EstCreVO model = null;
	 ...
	 * @return EstCreVO[]
	 */
	public EstCreVO[] getEstCreVOs(){
		EstCreVO[] vos = (EstCreVO[])models.toArray(new EstCreVO[models.size()]);
		return vos;
	}
