...
*@FileName : PortLimitManagmentDBDAOAddPortLimitsCompCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortLimitManagmentDBDAOAddPortLimitsCompCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_IMDG_PORT_LMT_COMP_GRP 생성
	  * </pre>
	  */
	public PortLimitManagmentDBDAOAddPortLimitsCompCSQL(){
		setQuery();
		...
		query.append("FileName : PortLimitManagmentDBDAOAddPortLimitsCompCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_PORT_LMT_COMP_GRP" ).append("\n"); 
		query.append("(" ).append("\n"); 
		...
		query.append("	--,lmt_wgt_tp_cd" ).append("\n"); 
		query.append("	,@[port_lmt_seq]" ).append("\n"); 
		query.append("	--,(SELECT NVL(MAX(PORT_LMT_CLSS_SEQ), 1)" ).append("\n"); 
