...
*@FileName : VOP_OPF_9003HTMLAction.java
...
public class VOP_OPF_9003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_9003HTMLAction 객체를 생성
	 */
	public VOP_OPF_9003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf9003Event event = new VopOpf9003Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setOpfCodDvsFeeVO((OpfCodDvsFeeVO)getVO(request, OpfCodDvsFeeVO .class));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setOpfCodDvsFeeVOS((OpfCodDvsFeeVO[])getVOs(request, OpfCodDvsFeeVO .class));
