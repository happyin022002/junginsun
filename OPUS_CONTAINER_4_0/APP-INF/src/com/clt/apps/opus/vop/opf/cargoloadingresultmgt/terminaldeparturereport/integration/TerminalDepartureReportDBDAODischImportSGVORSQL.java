...
public class TerminalDepartureReportDBDAODischImportSGVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT 		COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()   OPR_CD " ).append("\n"); 
		...
		query.append("       " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 1, 0), 0)) 			+ SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'A', 1, 0),0)))					,2)	DG_20_QTY " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, CNTR_WGT, 0), 0)) 	+ SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'A', CNTR_WGT, 0), 0)))/1000		,2)	DG_20_WGT " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 0, 1), 0)) 			+ SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'B', 0, 1), 0)))					,2) DG_40_QTY " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 0, CNTR_WGT), 0)) 	+ SUM(DECODE(DCGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'B', 0, CNTR_WGT), 0)))/1000		,2) DG_40_WGT " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 1, 0), 0))				+ SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'A', 1, 0), 0)))					,2) RF_20_QTY " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, CNTR_WGT, 0), 0))		+ SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'A', CNTR_WGT, 0), 0)))/1000		,2) RF_20_WGT " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 0, 1), 0))				+ SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'B', 0, 1), 0)))					,2) RF_40_QTY " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 0, CNTR_WGT), 0))		+ SUM(DECODE(RC_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'B', 0, CNTR_WGT), 0)))/1000		,2) RF_40_WGT " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 1, 0), 0)) 		+ SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'A', 1, 0), 0)))				,2) AK_20_QTY " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, CNTR_WGT, 0), 0)) + SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'A', CNTR_WGT, 0), 0)))/1000	,2) AK_20_WGT" ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 0, 1), 0)) 		+ SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'B', 0, 1), 0)))				,2) AK_40_QTY " ).append("\n"); 
		query.append("       ,	ROUND((SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 2, 0, CNTR_WGT), 0)) + SUM(DECODE(AWK_CGO_FLG, 'Y', DECODE(SUBSTR(CNTR_TPSZ_CD, 2, 1), 'B', 0, CNTR_WGT), 0)))/1000	,2) AK_40_WGT" ).append("\n"); 
		query.append("       " ).append("\n"); 
		query.append("       " ).append("\n"); 
		query.append("FROM   ( 	SELECT V.POD_CD,  C.DCGO_FLG,  C.RC_FLG,  C.AWK_CGO_FLG,  C.CNTR_TPSZ_CD,  C.CNTR_NO,  C.CNTR_WGT" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("         	SELECT V.POD_CD,  C.DCGO_FLG,  C.RC_FLG,  C.AWK_CGO_FLG,  C.CNTR_TPSZ_CD,  C.CNTR_NO,  C.CNTR_WGT" ).append("\n"); 
		query.append("         	FROM   VSK_VSL_PORT_SKD S,  BKG_VVD V,  BKG_CONTAINER C,  BKG_BOOKING B" ).append("\n"); 
		query.append("         	WHERE  S.VSL_CD            = @[vsl_cd]" ).append("\n"); 
		query.append("         	AND    S.SKD_VOY_NO        = @[voy_no]" ).append("\n"); 
		query.append("         	AND    S.SKD_DIR_CD        = @[dir_cd]" ).append("\n"); 
