...
public class TerminalDepartureReportDBDAOTmnlPerformVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("         FROM   " ).append("\n"); 
		query.append("         ( " ).append("\n"); 
		query.append("              SELECT /*+ ORDERED */ RHQ," ).append("\n"); 
		query.append("                    PORT," ).append("\n"); 
		query.append("                    YARD," ).append("\n"); 
		query.append("                    LANE," ).append("\n"); 
		...
		query.append("                    GROUPING(RHQ) P, GROUPING(PORT) V, GROUPING(YARD) Y, GROUPING(LANE) L," ).append("\n"); 
		query.append("                    CASE" ).append("\n"); 
		query.append("                    WHEN GROUPING(RHQ)=0 AND GROUPING(PORT)=0 AND GROUPING(YARD)=0 AND GROUPING(LANE)=0 AND GROUPING(VVD)=0 THEN 1" ).append("\n"); 
		query.append("                    ELSE 0" ).append("\n"); 
		query.append("                    END C1," ).append("\n"); 
		query.append("                    CASE" ).append("\n"); 
		query.append("                    WHEN GROUPING(RHQ)=0 AND GROUPING(PORT)=1 AND GROUPING(YARD)=1 AND GROUPING(LANE)=1 THEN 1" ).append("\n"); 
		query.append("                    ELSE 0" ).append("\n"); 
		query.append("                    END C3," ).append("\n"); 
		query.append("                    CASE" ).append("\n"); 
		query.append("                    WHEN GROUPING(RHQ)=0 AND GROUPING(PORT)=0 AND GROUPING(YARD)=1 AND GROUPING(LANE)=1 THEN 1" ).append("\n"); 
		query.append("                    ELSE 0" ).append("\n"); 
		query.append("                    END C4," ).append("\n"); 
		query.append("                    CASE" ).append("\n"); 
		query.append("                    WHEN GROUPING(RHQ)=1 AND GROUPING(PORT)=1 AND GROUPING(YARD)=1 AND GROUPING(LANE)=1 THEN 1" ).append("\n"); 
		query.append("                    ELSE 0" ).append("\n"); 
		...
		query.append("                  FROM" ).append("\n"); 
		query.append("                    (" ).append("\n"); 
		query.append("                    SELECT MAX(R.POR_RHQ) RHQ," ).append("\n"); 
		query.append("                            MAX(V.VPS_PORT_CD) PORT," ).append("\n"); 
		query.append("                            MAX(V.YD_CD) YARD," ).append("\n"); 
		query.append("                            MAX(V.SLAN_CD) LANE," ).append("\n"); 
		query.append("                            MAX(T.VSL_CD||T.VOY_NO||T.DIR_CD) VVD," ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${carr_cd} == 'OTH')" ).append("\n"); 
		query.append("                  AND    T.VSL_CD NOT IN (SELECT VSL_CD FROM MDM_VSL_CNTR WHERE CRR_CD = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC())" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${carr_cd} != '' && ${carr_cd} != 'OTH')" ).append("\n"); 
		query.append("                  AND    T.VSL_CD IN (SELECT VSL_CD FROM MDM_VSL_CNTR WHERE CRR_CD = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC())" ).append("\n"); 
		query.append("#end     " ).append("\n"); 
		query.append("                       GROUP BY ( R.POR_RHQ, V.VPS_PORT_CD, V.YD_CD, V.SLAN_CD)" ).append("\n"); 
		query.append("                       )GROUP BY ROLLUP( RHQ, PORT, YARD, LANE, VVD) " ).append("\n"); 
		query.append("                              )" ).append("\n"); 
		...
		query.append("         GROUP BY ( R.POR_RHQ, V.VPS_PORT_CD, V.YD_CD, V.SLAN_CD)" ).append("\n"); 
		query.append("              )" ).append("\n"); 
		query.append("            GROUP BY ROLLUP( RHQ, PORT, YARD, LANE, VVD) ) WHERE C2 = 1" ).append("\n"); 
		query.append("       /* Q2 */" ).append("\n"); 
		query.append("     )" ).append("\n"); 
