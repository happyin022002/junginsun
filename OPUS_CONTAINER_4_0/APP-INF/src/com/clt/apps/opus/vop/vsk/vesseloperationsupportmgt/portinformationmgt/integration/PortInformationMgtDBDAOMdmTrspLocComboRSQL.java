...
*@FileName : PortInformationMgtDBDAOMdmTrspLocComboRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortInformationMgtDBDAOMdmTrspLocComboRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortInformationMgtDBDAOMdmTrspLocComboRSQL(){
		setQuery();
		...
		query.append("FileName : PortInformationMgtDBDAOMdmTrspLocComboRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
