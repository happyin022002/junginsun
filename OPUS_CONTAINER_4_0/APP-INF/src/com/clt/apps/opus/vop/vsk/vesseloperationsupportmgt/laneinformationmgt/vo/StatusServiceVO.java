...
public class StatusServiceVO extends AbstractValueObject {
	...
	public StatusServiceVO(String ibflag, String pagerows, String type, String count, String vslSvc) {
		this.ibflag = ibflag;
		this.count = count;
		this.vslSvc = vslSvc;
		this.type = type;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("vsl_svc", getVslSvc());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("vsl_svc", "vslSvc");
	 ...
	 * @param vslSvc
	 */
	public void setVslSvc(String vslSvc) {
		this.vslSvc = vslSvc;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setVslSvc(JSPUtil.getParameter(request, "vsl_svc", ""));
	...
	public StatusServiceVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] vslSvc = (JSPUtil.getParameter(request, prefix	+ "vsl_svc", length));
	...
	*/
	public void unDataFormat(){
		...
		this.vslSvc = this.vslSvc .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
