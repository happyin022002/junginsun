...
*@FileName : VOP_OPF_0046_04HTMLAction.java
...
public class VOP_OPF_0046_04HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0046_04HTMLAction 객체를 생성
	 */
	public VOP_OPF_0046_04HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf004604Event event = new VopOpf004604Event();
        ...
        if(command.isCommand(FormCommand.MULTI01)) {//SAVE
            event.setRDRCrtListOptionVO(       (RDRCrtListOptionVO)getVO(request, RDRCrtListOptionVO .class        )  );
            event.setRdrCreatInfoMainTradeVOs( (RdrCreatInfoVO[])getVOs (request, RdrCreatInfoVO     .class,  "sheet1_")  );
            event.setRdrCreatInfoInterPortVOs( (RdrCreatInfoVO[])getVOs (request, RdrCreatInfoVO     .class,  "sheet2_")  );
