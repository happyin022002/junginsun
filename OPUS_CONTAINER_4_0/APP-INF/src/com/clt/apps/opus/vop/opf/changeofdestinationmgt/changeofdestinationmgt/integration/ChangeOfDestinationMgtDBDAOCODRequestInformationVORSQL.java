...
public class ChangeOfDestinationMgtDBDAOCODRequestInformationVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	   TO_CHAR(BC.CNTR_WGT, 'FM999,999,999,999,999')||' '||BC.WGT_UT_CD AS CNTR_WGT," ).append("\n"); 
		query.append("       DECODE(BC.DCGO_FLG,'Y','DG',DECODE(BC.RC_FLG,'Y','RF',DECODE(BC.BB_CGO_FLG,'Y','BB',DECODE(BC.AWK_CGO_FLG,'Y','AK', 'DR')))) AS CONDITION," ).append("\n"); 
