...
*@FileName : RegionDepartureReportDBDAORDRLoadHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORDRLoadHeaderRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDRLoadHeader Select Query
	  * </pre>
	  */
	public RegionDepartureReportDBDAORDRLoadHeaderRSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORDRLoadHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT DISTINCT M.POL  AS OPR_CD" ).append("\n"); 
		...
		query.append("ORDER BY M.POL" ).append("\n"); 
