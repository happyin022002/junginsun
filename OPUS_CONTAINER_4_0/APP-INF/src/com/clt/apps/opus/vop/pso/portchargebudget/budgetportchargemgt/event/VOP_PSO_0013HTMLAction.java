...
*@FileName : VOP_PSO_0013HTMLAction.java
...
public class VOP_PSO_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0013HTMLAction 객체를 생성
	 */
	public VOP_PSO_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0013Event event = new VopPso0013Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setErpSumVO((ErpSumVO)getVO(request, ErpSumVO .class));
