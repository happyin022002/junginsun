...
*@FileName : BudgetPortChargeMgtDBDAOgetPendulumInfoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BudgetPortChargeMgtDBDAOgetPendulumInfoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BudgetPortChargeMgtDBDAOgetPendulumInfoRSQL(){
		setQuery();
		...
		query.append("FileName : BudgetPortChargeMgtDBDAOgetPendulumInfoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
