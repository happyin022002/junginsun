...
*@FileName : VesselScheduleMgtDBDAOCheckFinalYardForSecondDirRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCheckFinalYardForSecondDirRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Second Direction의 Final Yard와 동일한지 체크
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCheckFinalYardForSecondDirRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCheckFinalYardForSecondDirRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND			PD.PORT_CD					= @[vps_port_cd]" ).append("\n"); 
		query.append(" " ).append("\n"); 
