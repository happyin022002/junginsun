...
public class GeneralInvoiceAuditDBDAOgetTierRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                , DECODE(SIGN(TEU - (SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID='CD20072' AND INTG_CD_VAL_CTNT='1')), -1, 'N', 'Y') AS RNK" ).append("\n"); 
		...
		query.append("							AND		T1.TIER		>= (SELECT INTG_CD_VAL_DP_DESC FROM COM_INTG_CD_DTL WHERE INTG_CD_ID='CD20073' AND INTG_CD_VAL_CTNT='1')" ).append("\n"); 
