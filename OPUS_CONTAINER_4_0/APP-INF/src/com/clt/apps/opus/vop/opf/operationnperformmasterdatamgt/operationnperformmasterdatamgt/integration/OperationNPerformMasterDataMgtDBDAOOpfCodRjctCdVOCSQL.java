...
*@FileName : OperationNPerformMasterDataMgtDBDAOOpfCodRjctCdVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OperationNPerformMasterDataMgtDBDAOOpfCodRjctCdVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OperationNPerformMasterDataMgtDBDAOOpfCodRjctCdVOCSQL(){
		setQuery();
		...
		query.append("FileName : OperationNPerformMasterDataMgtDBDAOOpfCodRjctCdVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO opf_cod_rjct_cd (" ).append("\n"); 
