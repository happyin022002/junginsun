...
public class UseStatusConForVO extends AbstractValueObject {
    ...
    public UseStatusConForVO(String ibflag, String pagerows, String formcond, String combo3, String combo2, String combo1, String creUsr, String caller, String fomlDesc, String descript, String condDesc) {
        this.caller = caller;
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setDescript(JSPUtil.getParameter(request, prefix + "descript", ""));
    ...
    public UseStatusConForVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] descript = (JSPUtil.getParameter(request, prefix + "descript", length));
