...
*@FileName : VOP_SCG_5912HTMLAction.java
...
public class VOP_SCG_5912HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_5912HTMLAction 객체를 생성
	 */
	public VOP_SCG_5912HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg5912Event event = new VopScg5912Event();
		
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setImdgItemBkgSummaryVO((ImdgItemBkgSummaryVO)getVO(request, ImdgItemBkgSummaryVO .class));
		}
