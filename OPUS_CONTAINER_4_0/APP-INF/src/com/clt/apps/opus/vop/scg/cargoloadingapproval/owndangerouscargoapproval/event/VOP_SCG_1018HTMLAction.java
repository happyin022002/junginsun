...
*@FileName : VOP_SCG_1018HTMLAction.java
...
public class VOP_SCG_1018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_1018HTMLAction 객체를 생성
	 */
	public VOP_SCG_1018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg1018Event event = new VopScg1018Event();
