...
*@FileName : GeneralInvoiceAuditDBDAOgetEtdDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetEtdDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Tariff 비용 계산을 위해 해당 vvd와 yard의 ETD Date을 구한다.
	  * [2015.07.21]Virtual Add Calling 처리. VSK_VSL_PORT_SKD.NVL(VT_ADD_CALL_FLG, 'N') = 'N'
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetEtdDateRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetEtdDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'TO_DATE('''||TO_CHAR (VPS_ETD_DT, 'YYYYMMDD')||''',''YYYYMMDD'')'" ).append("\n"); 
