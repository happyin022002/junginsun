...
*@FileName : VesselScheduleMgtDBDAOCheckVslSkdByRowID3RSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCheckVslSkdByRowID3RSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCheckVslSkdByRowID3RSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCheckVslSkdByRowID3RSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM      	BKG_VVD       		V" ).append("\n"); 
		query.append("WHERE     	V.VSL_CD      		= @[vsl_cd]" ).append("\n"); 
		query.append("AND       	V.SKD_VOY_NO  		= @[turn_skd_voy_no]" ).append("\n"); 
		query.append("AND       	V.SKD_DIR_CD  		= @[turn_skd_dir_cd]" ).append("\n"); 
		query.append("AND       	V.POD_CD      		= @[vps_port_cd]" ).append("\n"); 
		query.append("AND       	V.POD_CLPT_IND_SEQ  = @[turn_clpt_ind_seq]" ).append("\n"); 
		query.append("AND			ROWNUM				= 1" ).append("\n"); 
