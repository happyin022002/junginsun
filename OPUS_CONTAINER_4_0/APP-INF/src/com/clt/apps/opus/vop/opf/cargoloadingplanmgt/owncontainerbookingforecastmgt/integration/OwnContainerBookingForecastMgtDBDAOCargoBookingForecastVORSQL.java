...
public class OwnContainerBookingForecastMgtDBDAOCargoBookingForecastVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("            NVL(cntr_lmt_wgt1, 0) AS cntr_lmt_wgt1," ).append("\n"); 
		query.append("            NVL(cntr_lmt_wgt2, 0) AS cntr_lmt_wgt2," ).append("\n"); 
		query.append("            NVL(cntr_lmt_wgt3, 0) AS cntr_lmt_wgt3," ).append("\n"); 
		query.append("            NVL(cntr_lmt_wgt4, 0) AS cntr_lmt_wgt4," ).append("\n"); 
