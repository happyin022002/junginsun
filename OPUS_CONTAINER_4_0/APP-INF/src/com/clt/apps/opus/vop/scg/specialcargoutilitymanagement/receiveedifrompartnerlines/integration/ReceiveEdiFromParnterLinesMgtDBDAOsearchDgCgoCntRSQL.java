...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOsearchDgCgoCntRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOsearchDgCgoCntRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOsearchDgCgoCntRSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOsearchDgCgoCntRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 		MAX('Y') AS CGO_CNT" ).append("\n"); 
