...
*@FileName : VOP_VSK_5004HTMLAction.java
...
public class VOP_VSK_5001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_VSK_0010HTMLAction 객체를 생성
	 */
	public VOP_VSK_5001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk5001Event event = new VopVsk5001Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {			
			event.setConsortiumVoyageVO((ConsortiumVoyageVO)getVO(request, ConsortiumVoyageVO.class));
		} else if (command.isCommand(FormCommand.MULTI)) {
			event.setConsortiumVoyageVOs((ConsortiumVoyageVO[])getVOs(request, ConsortiumVoyageVO.class, "sheet1_"));
		}
