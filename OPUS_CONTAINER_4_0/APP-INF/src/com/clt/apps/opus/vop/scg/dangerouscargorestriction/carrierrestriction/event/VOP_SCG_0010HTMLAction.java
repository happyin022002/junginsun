...
*@FileName : VOP_SCG_0010HTMLAction.java
...
public class VOP_SCG_0010HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0010HTMLAction 객체를 생성
	 */
	public VOP_SCG_0010HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0010Event event = new VopScg0010Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgCrrRstrVO((ScgImdgCrrRstrVO)getVO(request, ScgImdgCrrRstrVO .class));
		}else{
	          event.setPCrrCd(           JSPUtil.getParameter(request, "pCrr_cd",        "") );
	          event.setPImdgClssCd(      JSPUtil.getParameter(request, "pImdg_clss_cd",  "") );
	          event.setPImdgClssCd_desc( JSPUtil.getParameter(request, "pImdg_clss_cd_desc", "") );
              ...
              event.setPSearchMethod(    JSPUtil.getParameter(request, "pSearchMethod", "") );    
