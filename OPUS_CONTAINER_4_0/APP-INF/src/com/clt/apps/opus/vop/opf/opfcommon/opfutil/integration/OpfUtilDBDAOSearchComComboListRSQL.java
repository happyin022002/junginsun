...
*@FileName : OpfUtilDBDAOSearchComComboListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OpfUtilDBDAOSearchComComboListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OpfUtilDBDAOSearchComComboListRSQL(){
		setQuery();
		...
		query.append("FileName : OpfUtilDBDAOSearchComComboListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        SELECT  DECODE(INTG_CD_VAL_CTNT, 'X', 1, 'H', 2, 'M', 3, 'L', 4, 'E', 5) SEQ" ).append("\n"); 
