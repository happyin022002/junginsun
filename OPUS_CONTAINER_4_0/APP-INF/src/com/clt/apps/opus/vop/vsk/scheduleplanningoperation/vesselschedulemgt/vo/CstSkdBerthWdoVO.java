...
public class CstSkdBerthWdoVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setUsrInfo(JSPUtil.getParameter(request, "usr_info", ""));
		...
		setExtMsgFlg(JSPUtil.getParameter(request, "ext_msg_flg", ""));
		...
		setFreeTmDt(JSPUtil.getParameter(request, "free_tm_dt", ""));
		...
		setPortPos(JSPUtil.getParameter(request, "port_pos", ""));
		...
		setUpdDtTxt(JSPUtil.getParameter(request, "upd_dt_txt", ""));
		...
		setCgoTtl(JSPUtil.getParameter(request, "cgo_ttl", ""));
		...
		setPfEtbDy(JSPUtil.getParameter(request, "pf_etb_dy", ""));
		setIbCgoQty(JSPUtil.getParameter(request, "ib_cgo_qty", ""));
		setPfEtdDy(JSPUtil.getParameter(request, "pf_etd_dy", ""));
		setPfEtaDy(JSPUtil.getParameter(request, "pf_eta_dy", ""));
	}
