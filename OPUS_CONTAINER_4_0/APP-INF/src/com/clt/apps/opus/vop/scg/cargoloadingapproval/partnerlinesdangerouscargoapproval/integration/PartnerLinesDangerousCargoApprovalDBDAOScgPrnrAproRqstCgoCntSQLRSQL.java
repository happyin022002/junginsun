...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoCntSQLRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoCntSQLRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_PRNR_APRO_RQST_CGO의 데이타 건수를 조회한다.
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoCntSQLRSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoCntSQLRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM     	SCG_PRNR_APRO_RQST				X 		 -- 조건 추가 2015-12-16 -- " ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("#if (${cargo} == 'Y')" ).append("\n"); 
		query.append("AND Y.SPCL_CNTR_SEQ = @[spcl_cntr_seq] " ).append("\n"); 
		query.append("AND Y.SPCL_CGO_SEQ = @[spcl_cgo_seq]" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("AND Y.SPCL_CGO_RQST_SEQ = (@[spcl_cgo_rqst_seq])" ).append("\n"); 
		query.append("AND Y.AUTH_STS_CD IS NULL" ).append("\n"); 
