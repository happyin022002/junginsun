...
public class OwnDangerousCargoApprovalDBDAOScgAuthorizationVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	AUTH_DT = NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,BKG_COM_USER_LOC_FNC(@[upd_usr_id])), SYSDATE)" ).append("\n"); 
		query.append(",	AUTH_GDT = NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),SYSDATE,'GMT'), SYSDATE)" ).append("\n"); 
