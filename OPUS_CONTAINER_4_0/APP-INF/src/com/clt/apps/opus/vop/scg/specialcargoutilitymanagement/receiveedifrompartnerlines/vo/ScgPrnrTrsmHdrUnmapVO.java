...
*@FileName : ScgPrnrTrsmHdrUnmapVO.java
*@FileTitle : ScgPrnrTrsmHdrUnmapVO
*Open Issues :
*Change history :
 ...
 */
public class ScgPrnrTrsmHdrUnmapVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<ScgPrnrTrsmHdrUnmapVO> models = new ArrayList<ScgPrnrTrsmHdrUnmapVO>();
    ...
    public ScgPrnrTrsmHdrUnmapVO() {
    }

    public ScgPrnrTrsmHdrUnmapVO(String ibflag, String pagerows, String trsmBndCd, String trsmDt, String spclCgoCateCd, String prnrSpclCgoSeq, String ediUnmapSeq, String ediUnmapDtlCd, String creUsrId, String creDt, String updUsrId, String updDt, String edwUpdDt, String ediUnmapRmk, String ediUnmapDtlDesc) {
        this.updDt = updDt;
        this.trsmDt = trsmDt;
	 ...
	 */
    public ScgPrnrTrsmHdrUnmapVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgPrnrTrsmHdrUnmapVO[]
	 */
    public ScgPrnrTrsmHdrUnmapVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ScgPrnrTrsmHdrUnmapVO model = null;
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                model = new ScgPrnrTrsmHdrUnmapVO();
                if (updDt[i] != null)
        ...
        return getScgPrnrTrsmHdrUnmapVOs();
    }
	 ...
	 * @return ScgPrnrTrsmHdrUnmapVO[]
	 */
    public ScgPrnrTrsmHdrUnmapVO[] getScgPrnrTrsmHdrUnmapVOs() {
        ScgPrnrTrsmHdrUnmapVO[] vos = (ScgPrnrTrsmHdrUnmapVO[]) models.toArray(new ScgPrnrTrsmHdrUnmapVO[models.size()]);
        return vos;
    }
