...
public class TerminalDepartureReportDBDAOPortLogDetailVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       TO_CHAR(C.START_DATE,'YYYY-MM-DD HH24:MI')	WORK_COMM," ).append("\n"); 
		query.append("       TO_CHAR(C.END_DATE,'YYYY-MM-DD HH24:MI')	WORK_COMP," ).append("\n"); 
		...
		query.append("ORDER  BY C.CRANE_NO" ).append("\n"); 
