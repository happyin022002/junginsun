...
*@FileName : RegionDepartureReportDBDAOModifyRdrHeaderForRemarkUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOModifyRdrHeaderForRemarkUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDR HEADER  -  REMARK 수정
	  * </pre>
	  */
	public RegionDepartureReportDBDAOModifyRdrHeaderForRemarkUSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOModifyRdrHeaderForRemarkUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  RDR_HEADER " ).append("\n"); 
		query.append("   SET  REMARK      = @[remark]" ).append("\n"); 
