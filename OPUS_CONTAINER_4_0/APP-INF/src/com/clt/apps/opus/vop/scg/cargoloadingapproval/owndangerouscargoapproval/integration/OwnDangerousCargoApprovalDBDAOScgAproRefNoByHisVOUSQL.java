...
*@FileName : OwnDangerousCargoApprovalDBDAOScgAproRefNoByHisVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgAproRefNoByHisVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgAproRefNoByHisVOUSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgAproRefNoByHisVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
