...
*@FileName : PortRestrictionDBDAOSearchDgSummaryByPortUnnoSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortRestrictionDBDAOSearchDgSummaryByPortUnnoSeqRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortRestrictionDBDAOSearchDgSummaryByPortUnnoSeqRSQL(){
		setQuery();
		...
		query.append("FileName : PortRestrictionDBDAOSearchDgSummaryByPortUnnoSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			           AA.IMDG_CLSS_CD, " ).append("\n"); 
		...
		query.append("			            WHERE IMDG_UN_NO = AA.IMDG_UN_NO" ).append("\n"); 
		query.append("			              AND IMDG_UN_NO_SEQ = AA.IMDG_UN_NO_SEQ) " ).append("\n"); 
		...
		query.append("			            WHERE U.IMDG_UN_NO = AA.IMDG_UN_NO" ).append("\n"); 
		query.append("			              AND U.IMDG_UN_NO_SEQ = AA.IMDG_UN_NO_SEQ" ).append("\n"); 
		query.append("			              AND M.IMDG_AMDT_NO = U.IMDG_AMDT_NO) " ).append("\n"); 
		query.append("			           EFF_FM_DT," ).append("\n"); 
		query.append("			           AA.IMDG_UN_NO," ).append("\n"); 
		query.append("			           AA.IMDG_UN_NO_SEQ," ).append("\n"); 
		...
		query.append("			           AA.IMDG_UN_NO  = A.IMDG_UN_NO(+)" ).append("\n"); 
		query.append("			    AND    AA.IMDG_UN_NO_SEQ  = A.IMDG_UN_NO_SEQ(+)" ).append("\n"); 
		...
		query.append("      	,  XX.IMDG_CLSS_CD   	DESC" ).append("\n"); 
