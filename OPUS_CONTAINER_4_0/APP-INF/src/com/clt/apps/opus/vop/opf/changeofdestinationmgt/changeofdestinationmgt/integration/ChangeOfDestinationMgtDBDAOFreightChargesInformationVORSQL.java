...
public class ChangeOfDestinationMgtDBDAOFreightChargesInformationVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                  AND    SUBSTR(M.OLD_POD_YD_CD,1,5) = B.POD          --20091008 수정" ).append("\n"); 
		...
		query.append("                           AND    SUBSTR(H.OLD_POD_YD_CD,1,5) = B.POD               --20091008 수정" ).append("\n"); 
		...
		query.append("                           AND    C.POD                       = S.VPS_PORT_CD           --20091008 수정" ).append("\n"); 
