...
*@FileName : VOP_PSO_0213HTMLAction.java
...
public class VOP_PSO_0213HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0213HTMLAction 객체를 생성
	 */
	public VOP_PSO_0213HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0213Event event = new VopPso0213Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setExpnDtlVO((ExpnDtlVO)getVO(request, ExpnDtlVO .class));
		}
