...
*@FileName : VOP_VSK_0704HTMLAction.java
...
public class VOP_VSK_0704HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_704HTMLAction 객체를 생성
	 */
	public VOP_VSK_0704HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0704Event event = new VopVsk0704Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setVskPortCnlTrScgVOS((VskPortCnlTrScgVO[]) getVOs(request, VskPortCnlTrScgVO.class,"sheet1_"));
		} 
