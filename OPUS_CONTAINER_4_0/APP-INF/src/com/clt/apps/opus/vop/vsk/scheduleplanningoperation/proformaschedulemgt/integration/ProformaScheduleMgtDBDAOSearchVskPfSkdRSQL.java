...
*@FileName : ProformaScheduleMgtDBDAOSearchVskPfSkdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ProformaScheduleMgtDBDAOSearchVskPfSkdRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ProformaScheduleMgtDBDAOSearchVskPfSkdRSQL(){
		setQuery();
		...
		query.append("FileName : ProformaScheduleMgtDBDAOSearchVskPfSkdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  #if (${pagerows} == '1') " ).append("\n"); 
		query.append("  AND PF_SVC_TP_CD	<> @[pf_svc_tp_cd]" ).append("\n"); 
