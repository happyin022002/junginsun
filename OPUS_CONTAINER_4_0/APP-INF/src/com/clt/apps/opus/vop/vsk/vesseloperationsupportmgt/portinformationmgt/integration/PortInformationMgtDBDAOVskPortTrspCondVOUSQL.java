...
*@FileName : PortInformationMgtDBDAOVskPortTrspCondVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortInformationMgtDBDAOVskPortTrspCondVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortInformationMgtDBDAOVskPortTrspCondVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE VSK_PORT_TRSP_COND SET" ).append("\n"); 
		query.append("LMT_20FT_WGT = @[lmt_20ft_wgt]" ).append("\n"); 
		query.append(",	LMT_40FT_WGT = @[lmt_40ft_wgt]" ).append("\n"); 
		query.append(",	LMT_AXL_WGT = @[lmt_axl_wgt]" ).append("\n"); 
		query.append(",	LMT_LEN = @[lmt_len]" ).append("\n"); 
		query.append(",	LMT_WDT = @[lmt_wdt]" ).append("\n"); 
		query.append(",	LMT_HGT = @[lmt_hgt]" ).append("\n"); 
		query.append(",	LMT_OVR_LEN = @[lmt_ovr_len]" ).append("\n"); 
		query.append(",	LMT_OVR_WDT = @[lmt_ovr_wdt]" ).append("\n"); 
		query.append(",	LMT_OVR_HGT = @[lmt_ovr_hgt]" ).append("\n"); 
		query.append(",	TRSP_RMK = @[trsp_rmk]" ).append("\n"); 
		...
		query.append("FileName : PortInformationMgtDBDAOVskPortTrspCondVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}