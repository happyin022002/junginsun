...
*@FileName : VSKCodeFinderDBDAOSearchSimNoListByLrskdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VSKCodeFinderDBDAOSearchSimNoListByLrskdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchSimNoListByLrskd
	  * </pre>
	  */
	public VSKCodeFinderDBDAOSearchSimNoListByLrskdRSQL(){
		setQuery();
		...
		query.append("FileName : VSKCodeFinderDBDAOSearchSimNoListByLrskdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND    T1.VSL_SIM_TP_CD = 'P'" ).append("\n"); 
