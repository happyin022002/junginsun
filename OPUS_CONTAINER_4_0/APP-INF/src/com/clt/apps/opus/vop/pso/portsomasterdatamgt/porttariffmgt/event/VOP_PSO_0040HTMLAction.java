...
*@FileName : VOP_PSO_0040HTMLAction.java
...
public class VOP_PSO_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0040HTMLAction 객체를 생성
	 */
	public VOP_PSO_0040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0040Event event = new VopPso0040Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			String objNm = (String) request.getParameter("obj_nm");
			event.setObjNm(objNm);
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setPsoObjListVOS((PsoObjListVO[]) getVOs(request, PsoObjListVO.class,"sheet1_"));
		} 
