...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgCntcPntVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgCntcPntVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Partner’s Contact Point for SPCL CGO (Creation) 수정   
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgCntcPntVOUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE SCG_CNTC_PNT SET" ).append("\n"); 
		...
		query.append(",	VSL_OPR_NM = @[vsl_opr_nm]" ).append("\n"); 
		query.append(",	CNTC_PSON_EML_CTNT = @[cntc_pson_eml_ctnt]" ).append("\n"); 
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgCntcPntVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}