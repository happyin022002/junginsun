...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgLodRjctCdVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgLodRjctCdVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Load Reject Reason (Creation) 조회
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgLodRjctCdVORSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgLodRjctCdVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	SPCL_CGO_LOD_RJCT_RSN_CD" ).append("\n"); 
		query.append("#if (${trim} == 'N') " ).append("\n"); 
		query.append(",	REPLACE(RJCT_RSN_CD_DESC, CHR(34), '') RJCT_RSN_CD_DESC" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(",	SUBSTR(REPLACE(RJCT_RSN_CD_DESC, CHR(34), ''), 1, 75) RJCT_RSN_CD_DESC" ).append("\n"); 
		...
		query.append("FROM SCG_LOD_RJCT_CD" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("#if (${spcl_cgo_lod_rjct_rsn_cd} != '') " ).append("\n"); 
		query.append("AND SPCL_CGO_LOD_RJCT_RSN_CD = @[spcl_cgo_lod_rjct_rsn_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY SPCL_CGO_LOD_RJCT_RSN_CD" ).append("\n"); 
