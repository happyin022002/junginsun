...
*@FileName : IMDGCodeMgtDBDAOScgImdgUnNoOrgRactUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgUnNoOrgRactUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ScgImdgUnNoOrgRact 수정
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgUnNoOrgRactUSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("UPDATE SCG_IMDG_UN_NO_ORG_RACT SET" ).append("\n"); 
		query.append("IMDG_ORG_RACT_TP_CD = @[imdg_org_ract_tp_cd]" ).append("\n"); 
		query.append(",	IMDG_TEC_NM = @[imdg_tec_nm]" ).append("\n"); 
		query.append(",	IMDG_CONC_RT_CTNT = @[imdg_conc_rt_ctnt]" ).append("\n"); 
		query.append(",	IMDG_PCK_MZD_CD = @[imdg_pck_mzd_cd]" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgUnNoOrgRactUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}