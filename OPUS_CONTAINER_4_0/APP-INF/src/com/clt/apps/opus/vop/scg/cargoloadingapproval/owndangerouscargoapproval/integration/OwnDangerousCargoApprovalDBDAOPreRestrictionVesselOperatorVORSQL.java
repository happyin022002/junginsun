...
public class OwnDangerousCargoApprovalDBDAOPreRestrictionVesselOperatorVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("		UNION --:2015-09-03:--ALL" ).append("\n"); 
		...
		query.append("    	 --2016-09-19 Prhoibition 조건 주석 처리 " ).append("\n"); 
		...
		query.append("	   UT.SPCL_CNTR_SEQ                                             AS SPCL_CNTR_SEQ" ).append("\n"); 
		...
		query.append("     , DECODE(@[opt_clss],'U','UN No.','Class')||DECODE(@[opt_clss],'U','',' ('||UT.IMDG_CLSS_CD||')')||' - '||" ).append("\n"); 
		query.append("      (" ).append("\n"); 
