...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOmodifyScgAPVLStatusUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOmodifyScgAPVLStatusUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOmodifyScgAPVLStatusUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOmodifyScgAPVLStatusUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE 	SCG_PRNR_APRO_RQST " ).append("\n"); 
		...
		query.append("AND 	LST_RQST_DAT_FLG 	= 'Y'" ).append("\n"); 
