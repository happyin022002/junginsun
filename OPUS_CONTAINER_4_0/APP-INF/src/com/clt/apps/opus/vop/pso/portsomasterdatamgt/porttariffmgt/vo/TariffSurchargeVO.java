...
public class TariffSurchargeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TariffSurchargeVO> models = new ArrayList<TariffSurchargeVO>();
	...
	public TariffSurchargeVO() {}

	public TariffSurchargeVO(String ibflag, String pagerows, String chgXprNo, String chgXprSeq, String fomlNo, String fomlDesc, String condNo, String objectCode, String seq, String objectName, String rateCode, String rateName, String rangeFrom, String rangeTo, String currency, String rateValue, String methodCode) {
	 ...
	 * @return TariffBaseVO[]
	 */
	public TariffSurchargeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TariffBaseVO[]
	 */
	public TariffSurchargeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TariffSurchargeVO model = null;
	 ...
	 * @return TariffBaseVO[]
	 */
	public TariffSurchargeVO[] getTariffBaseVOs(){
		TariffSurchargeVO[] vos = (TariffSurchargeVO[])models.toArray(new TariffSurchargeVO[models.size()]);
		return vos;
	}
