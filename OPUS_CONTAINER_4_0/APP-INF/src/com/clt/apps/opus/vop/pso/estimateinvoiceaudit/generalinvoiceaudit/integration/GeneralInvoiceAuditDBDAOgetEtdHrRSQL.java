...
*@FileName : GeneralInvoiceAuditDBDAOgetEtdHrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetEtdHrRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetEtdHrRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetEtdHrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(VPS_ETD_DT,'HH24')" ).append("\n"); 
