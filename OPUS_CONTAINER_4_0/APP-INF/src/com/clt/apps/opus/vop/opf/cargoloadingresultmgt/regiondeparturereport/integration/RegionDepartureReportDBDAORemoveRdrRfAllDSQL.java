...
*@FileName : RegionDepartureReportDBDAORemoveRdrRfAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORemoveRdrRfAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDR RF VVD,REGION 별 삭제
	  * </pre>
	  */
	public RegionDepartureReportDBDAORemoveRdrRfAllDSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORemoveRdrRfAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  FROM    RDR_SUMMARY" ).append("\n"); 
