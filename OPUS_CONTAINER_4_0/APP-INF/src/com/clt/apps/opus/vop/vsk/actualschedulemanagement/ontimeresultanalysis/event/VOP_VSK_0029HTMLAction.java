...
*@FileName : VOP_VSK_0029_1HTMLAction.java
...
public class VOP_VSK_0029HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0029_1HTMLAction 객체를 생성
	 */
	public VOP_VSK_0029HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0029Event event = new VopVsk0029Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setResultChangeStatusVO((ResultChangeStatusVO)getVO(request, ResultChangeStatusVO.class));
		}else if(command.isCommand(FormCommand.SEARCH02)){
			event.setResultChangeStatusVO((ResultChangeStatusVO)getVO(request, ResultChangeStatusVO.class));
		}else if(command.isCommand(FormCommand.SEARCH03)){
			event.setResultSkipStatusVO((ResultSkipStatusVO)getVO(request, ResultSkipStatusVO.class));
