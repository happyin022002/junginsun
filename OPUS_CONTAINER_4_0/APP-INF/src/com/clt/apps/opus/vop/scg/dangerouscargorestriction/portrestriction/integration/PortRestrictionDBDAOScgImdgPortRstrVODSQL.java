...
*@FileName : PortRestrictionDBDAOScgImdgPortRstrVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortRestrictionDBDAOScgImdgPortRstrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortRestrictionDBDAOScgImdgPortRstrVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IMDG_PORT_RSTR" ).append("\n"); 
		...
		query.append("FileName : PortRestrictionDBDAOScgImdgPortRstrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}