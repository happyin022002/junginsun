...
*@FileName : VesselReportDBDAOAddFcmNoonRptLogInitCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselReportDBDAOAddFcmNoonRptLogInitCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Create noon report log. Create Initial data.
	  * ===========================================================================
	  * </pre>
	  */
	public VesselReportDBDAOAddFcmNoonRptLogInitCSQL(){
		setQuery();
		...
		query.append("FileName : VesselReportDBDAOAddFcmNoonRptLogInitCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
