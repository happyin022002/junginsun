...
*@FileName : GeneralInvoiceAuditDBDAOgetArvDrftOneMeterRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetArvDrftOneMeterRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetArvDrftOneMeterRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetArvDrftOneMeterRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MAX(B.ARR_AFTDR_HGT)" ).append("\n"); 
