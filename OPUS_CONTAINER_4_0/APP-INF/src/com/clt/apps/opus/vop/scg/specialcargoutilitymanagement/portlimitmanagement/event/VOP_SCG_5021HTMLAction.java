...
*@FileName : VOP_SCG_5021HTMLAction.java
...
public class VOP_SCG_5021HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_5021HTMLAction 객체를 생성
	 */
	public VOP_SCG_5021HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg5021Event event = new VopScg5021Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPortLimitsDataVO((PortLimitsDataVO)getVO(request, PortLimitsDataVO .class,""));
		} else if (command.isCommand(FormCommand.MULTI)){
			event.setPortLimitsDataVOs((PortLimitsDataVO[])getVOs(request, PortLimitsDataVO .class,""));		
		}
