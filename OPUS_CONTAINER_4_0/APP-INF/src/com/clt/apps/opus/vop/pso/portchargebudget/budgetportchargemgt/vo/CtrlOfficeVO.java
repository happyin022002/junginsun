...
public class CtrlOfficeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CtrlOfficeVO> models = new ArrayList<CtrlOfficeVO>();
	 ...
	 * @return LocationVO[]
	 */
	public CtrlOfficeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LocationVO[]
	 */
	public CtrlOfficeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CtrlOfficeVO model = null;
	 ...
	 * @return LocationVO[]
	 */
	public CtrlOfficeVO[] getLocationVOs(){
		CtrlOfficeVO[] vos = (CtrlOfficeVO[])models.toArray(new CtrlOfficeVO[models.size()]);
		return vos;
	}
