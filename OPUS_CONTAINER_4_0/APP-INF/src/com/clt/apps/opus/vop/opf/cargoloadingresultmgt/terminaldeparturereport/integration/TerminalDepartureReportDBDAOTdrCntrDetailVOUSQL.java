...
*@FileName : TerminalDepartureReportDBDAOTdrCntrDetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTdrCntrDetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTdrCntrDetailVOUSQL(){
		setQuery();
		...
		params.put("length",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TerminalDepartureReportDBDAOTdrCntrDetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE TDR_CNTR_DETAIL SET " ).append("\n"); 
		query.append("	DML = @[dml]" ).append("\n"); 
		query.append(",	DMB = @[dmb]" ).append("\n"); 
		query.append(",	DMH = @[dmh]" ).append("\n"); 
		query.append(",	UNIT = @[unit]" ).append("\n"); 
		query.append(",	POSITION = @[position]" ).append("\n"); 
		query.append(",	DELV_CD = @[delv_cd]" ).append("\n"); 
		query.append(",	OVF = @[ovf]" ).append("\n"); 
		query.append(",	OVA = @[ova]" ).append("\n"); 
		query.append(",	OVP = @[ovp]" ).append("\n"); 
		query.append(",	OVS = @[ovs]" ).append("\n"); 
		query.append(",	OVH = @[ovh]" ).append("\n"); 
		query.append(",	SLOT = @[slot]" ).append("\n"); 
		query.append(",	WEIGHT = @[weight]" ).append("\n"); 
		query.append(",	CRANE = @[crane]" ).append("\n"); 
		...
		query.append(",	LOST_HR = @[lost_hr]" ).append("\n"); 
		query.append(",	GROSS_GANG = @[gross_gang]" ).append("\n"); 
		query.append(",	NET_GANG = @[net_gang]" ).append("\n"); 
		query.append(",	LENGTH = @[length]" ).append("\n"); 
		query.append(",	WIDTH = @[width]" ).append("\n"); 
		query.append(",	RF_CHK = @[rf_chk]" ).append("\n"); 
		query.append(",	DG_CHK = @[dg_chk]" ).append("\n"); 
		query.append(",	HC_CHK = @[hc_chk]" ).append("\n"); 
		query.append(",	MISHANDLE_CHK = @[mishandle_chk]" ).append("\n"); 
		query.append(",	DM_CHK = @[dm_chk]" ).append("\n"); 
		query.append(",	SHIFT_CHK = @[shift_chk]" ).append("\n"); 
		query.append(",	COD_CHK = @[cod_chk]" ).append("\n"); 
		query.append(",	TEMP_CHK = @[temp_chk]" ).append("\n"); 
		query.append(",	OPTION_CHK = @[option_chk]" ).append("\n"); 
		query.append(",	TEMP = @[temp]" ).append("\n"); 
		query.append(",	IMDG = @[imdg]" ).append("\n"); 
		query.append(",	UNNO = @[unno]" ).append("\n"); 
		query.append(",	PSA_CLASS = @[psa_class]" ).append("\n"); 
		query.append(",	PAGE_NO = @[page_no]" ).append("\n"); 
		query.append(",	PRECELL = @[precell]" ).append("\n"); 
		query.append(",	DM_CODE = @[dm_code]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("----,	SHIFT_RSN = [shift_rsn]" ).append("\n"); 
		query.append(",	SHIFT_RSN = SUBSTR(@[shift_rsn],1,1)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(",	ACCOUNT = @[account]" ).append("\n"); 
		query.append(",	PARTY = @[party]" ).append("\n"); 
		query.append(",	SHIFT_TYPE = @[shift_type]" ).append("\n"); 
		query.append(",	PRE_POD = @[pre_pod]" ).append("\n"); 
		query.append(",	COD_RSN = @[cod_rsn]" ).append("\n"); 
		query.append(",	REMARK = @[remark]" ).append("\n"); 
		query.append(",	SZTP = @[sztp]" ).append("\n"); 
		query.append(",	UPDATE_USER = @[update_user]" ).append("\n"); 
		query.append(",	UPDATE_TIME = SYSDATE" ).append("\n"); 
		query.append(",	CNTR_TYPE = @[cntr_type]" ).append("\n"); 
		query.append(",	CNTR_SIZE = @[cntr_size]" ).append("\n"); 
		query.append(",	CARGO_TYPE = @[cargo_type]" ).append("\n"); 
		query.append(",	OPR_CD = @[opr_cd]" ).append("\n"); 
		query.append(",	POR = @[por]" ).append("\n"); 
		query.append(",	POL = @[pol]" ).append("\n"); 
		query.append(",	POD = @[pod]" ).append("\n"); 
		query.append(",	POD2 = @[pod2]" ).append("\n"); 
		query.append(",	POD_ISO = NVL((SELECT   Y.INTER_CD_CTNT" ).append("\n"); 
		...
		query.append(",	POD2_ISO = @[pod2]" ).append("\n"); 
		query.append(",	FPOD = @[fpod]" ).append("\n"); 
