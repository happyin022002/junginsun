...
*@FileName : GeneralInvoiceAuditDBDAOgetYearlyVesselCallLaneRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetYearlyVesselCallLaneRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetYearlyVesselCallLaneRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetYearlyVesselCallLaneRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   AND TO_CHAR(A.VPS_ETB_DT,'YYYY')     = B.MAX_VPS_ETB_DT_Y" ).append("\n"); 
