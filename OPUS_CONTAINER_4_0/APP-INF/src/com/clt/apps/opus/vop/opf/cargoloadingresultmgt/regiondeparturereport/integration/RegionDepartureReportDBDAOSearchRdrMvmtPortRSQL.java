...
*@FileName : RegionDepartureReportDBDAOSearchRdrMvmtPortRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOSearchRdrMvmtPortRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MoveMent 등록이 가능한 Port를 검증용으로 사용한다.
	  * </pre>
	  */
	public RegionDepartureReportDBDAOSearchRdrMvmtPortRSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOSearchRdrMvmtPortRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND     CLPT_SEQ  IN (SELECT   MAX(CLPT_SEQ)" ).append("\n"); 
