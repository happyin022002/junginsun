...
*@FileName : OperationNPerformMasterDataMgtDBDAOOpfRHQOfficeListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OperationNPerformMasterDataMgtDBDAOOpfRHQOfficeListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OperationNPerformMasterDataMgtDBDAOOpfRHQOfficeListRSQL(){
		setQuery();
		...
		query.append("FileName : OperationNPerformMasterDataMgtDBDAOOpfRHQOfficeListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--::20150406::--AND       ML.VOP_PORT_FLG     = 'Y'" ).append("\n"); 
