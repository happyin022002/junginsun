...
*@FileName : VvdListByPortVO.java
*@FileTitle : VvdListByPortVO
*Open Issues :
*Change history :
...
public class VvdListByPortVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VvdListByPortVO> models = new ArrayList<VvdListByPortVO>();
	...
	public VvdListByPortVO() {}

	public VvdListByPortVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String clptIndSeq, String vslEngNm, String vpsPortCd, String vslSvcTpCd) {
		this.vslCd = vslCd;
		this.ibflag = ibflag;
	 ...
	 */
	public VvdListByPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VvdListByPortVO[]
	 */
	public VvdListByPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VvdListByPortVO model = null;
	 ...
	 * @return VvdListByPortVO[]
	 */
	public VvdListByPortVO[] getVvdListByPortVOs(){
		VvdListByPortVO[] vos = (VvdListByPortVO[])models.toArray(new VvdListByPortVO[models.size()]);
		return vos;
	}
