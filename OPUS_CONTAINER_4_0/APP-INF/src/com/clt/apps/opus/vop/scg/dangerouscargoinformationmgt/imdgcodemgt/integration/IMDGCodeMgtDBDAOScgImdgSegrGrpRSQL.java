...
*@FileName : IMDGCodeMgtDBDAOScgImdgSegrGrpRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgSegrGrpRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgSegrGrpRSQL(){
		setQuery();
...
//		query.append("WHERE	IMDG_SEGR_GRP_NO = @[imdg_segr_grp_no]" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgSegrGrpRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}