...
*@FileName : OwnContainerBookingForecastMgtDBDAOsearchCBFListUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOsearchCBFListUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOsearchCBFListUSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOsearchCBFListUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	  , BKG_REF_NO_CTNT   = @[bkg_ref_no_ctnt]" ).append("\n"); 
