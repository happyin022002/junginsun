...
public class StevedoreDamageMgtDBDAOOpfStvDmgDtlVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	STV_DMG_RESPB_PTY_KWN_FLG = @[stv_dmg_respb_pty_kwn_flg]" ).append("\n"); 
		...
		query.append(",	STV_DMG_DOC_ATCH_KNT = SUBSTR(@[stv_dmg_doc_atch_knt], 0, DECODE(INSTR(@[stv_dmg_doc_atch_knt],'s'), 0, 1, INSTR(@[stv_dmg_doc_atch_knt],'s')-1)) --@@bug>임시 차후재변경" ).append("\n"); 
