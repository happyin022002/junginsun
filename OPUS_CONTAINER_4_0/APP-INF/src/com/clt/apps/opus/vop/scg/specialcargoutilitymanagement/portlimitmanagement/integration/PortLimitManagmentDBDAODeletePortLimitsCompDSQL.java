...
*@FileName : PortLimitManagmentDBDAODeletePortLimitsCompDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortLimitManagmentDBDAODeletePortLimitsCompDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_IMDG_PORT_LMT_COMP_GRP 삭제한다.
	  * </pre>
	  */
	public PortLimitManagmentDBDAODeletePortLimitsCompDSQL(){
		setQuery();
		...
		query.append("FileName : PortLimitManagmentDBDAODeletePortLimitsCompDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IMDG_PORT_LMT_COMP_GRP" ).append("\n"); 
