...
*@FileName : PsoBasicFomlDtlVO.java
*@FileTitle : PsoBasicFomlDtlVO
*Open Issues :
*Change history :
...
public class PsoBasicFomlDtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PsoBasicFomlDtlVO> models = new ArrayList<PsoBasicFomlDtlVO>();
	...
	public PsoBasicFomlDtlVO() {}

	public PsoBasicFomlDtlVO(String ibflag, String pagerows, String fomlNo, String fomlSeq, String psoFomlDtlTpCd, String fomlOprCd, String objListNo, String rtObjListNo, String fomlPrtCtnt, String consNm, String rowNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.rtObjListNo = rtObjListNo;
		this.fomlPrtCtnt = fomlPrtCtnt;
		this.creDt = creDt;
		this.psoFomlOprCd = fomlOprCd;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setRtObjListNo(JSPUtil.getParameter(request, prefix + "rt_obj_list_no", ""));
		setFomlPrtCtnt(JSPUtil.getParameter(request, prefix + "foml_prt_ctnt", ""));
		setCreDt(JSPUtil.getParameter(request, prefix + "cre_dt", ""));
		setPsoFomlOprCd(JSPUtil.getParameter(request, prefix + "pso_foml_opr_cd", ""));
		setPagerows(JSPUtil.getParameter(request, prefix + "pagerows", ""));
		setIbflag(JSPUtil.getParameter(request, prefix + "ibflag", ""));
		setCreUsrId(JSPUtil.getParameter(request, prefix + "cre_usr_id", ""));
		setFomlSeq(JSPUtil.getParameter(request, prefix + "foml_seq", ""));
		setConsNm(JSPUtil.getParameter(request, prefix + "cons_nm", ""));
		setPsoFomlDtlTpCd(JSPUtil.getParameter(request, prefix + "pso_foml_dtl_tp_cd", ""));
	 ...
	 * @param request
	 * @return PsoBasicFomlDtlVO[]
	 */
	public PsoBasicFomlDtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PsoBasicFomlDtlVO[]
	 */
	public PsoBasicFomlDtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PsoBasicFomlDtlVO model = null;
	 ...
	 * @return PsoBasicFomlDtlVO[]
	 */
	public PsoBasicFomlDtlVO[] getPsoBasicFomlDtlVOs(){
		PsoBasicFomlDtlVO[] vos = (PsoBasicFomlDtlVO[])models.toArray(new PsoBasicFomlDtlVO[models.size()]);
		return vos;
	}
