...
*@FileName : TerminalDepartureReportDBDAOMisHandleContainerVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOMisHandleContainerVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOMisHandleContainerVORSQL(){
		setQuery();
		...
		params.put("mishandlechk",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : TerminalDepartureReportDBDAOMisHandleContainerVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("C.REMARK," ).append("\n"); 
		query.append("C.WEIGHT," ).append("\n"); 
		query.append("C.MISHANDLE_CHK" ).append("\n"); 
		...
		query.append("AND    C.MISHANDLE_CHK  = @[mishandlechk]" ).append("\n"); 
