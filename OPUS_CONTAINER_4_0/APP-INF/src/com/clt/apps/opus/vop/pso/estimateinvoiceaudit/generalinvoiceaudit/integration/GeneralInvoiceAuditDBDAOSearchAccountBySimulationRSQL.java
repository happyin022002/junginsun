...
*@FileName : GeneralInvoiceAuditDBDAOSearchAccountBySimulationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOSearchAccountBySimulationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOSearchAccountBySimulationRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOSearchAccountBySimulationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/**** Tariff에 등록되어 있는 Account 조회 ****/" ).append("\n"); 
		query.append("SELECT DISTINCT T2.ACCT_CD  AS ACCT_CD" ).append("\n"); 
