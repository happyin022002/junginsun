...
public class SimulationConditionVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String costCdDesc = null;
    ...
    public SimulationConditionVO(String ibflag, String pagerows, String portCd, String yardCd, String acctCd, String costCd, String vndrSeq, String vndrLglEngNm, String vslCd, String skdVoyNo, String skdDirCd, String issueDate, String vvd, String ydChgNo, String ydChgVerSeq, String currCd, String costCdDesc, String cplsFlg, String clptIndSeq, String clptSeq) {
        this.vslCd = vslCd;
        this.currCd = currCd;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("cost_cd_desc", getCostCdDesc());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("cost_cd_desc", "costCdDesc");
	 ...
	 * @return costCdDesc
	 */
    public String getCostCdDesc() {
        return this.costCdDesc;
    }
	 ...
	 * @param costCdDesc
	 */
    public void setCostCdDesc(String costCdDesc) {
        this.costCdDesc = costCdDesc;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setCostCdDesc(JSPUtil.getParameter(request, prefix + "cost_cd_desc", ""));
    ...
    public SimulationConditionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] costCdDesc = (JSPUtil.getParameter(request, prefix + "cost_cd_desc", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (costCdDesc[i] != null)
                    model.setCostCdDesc(costCdDesc[i]);
                if (cplsFlg[i] != null)
	...
	*/
    public void unDataFormat() {
        ...
        this.costCdDesc = this.costCdDesc.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
