...
*@FileName : BudgetPortChargeMgtDBDAOsearchSumRptByPeriodSoARSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BudgetPortChargeMgtDBDAOsearchSumRptByPeriodSoARSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BudgetPortChargeMgtDBDAOsearchSumRptByPeriodSoARSQL(){
		setQuery();
		...
		query.append("FileName : BudgetPortChargeMgtDBDAOsearchSumRptByPeriodSoARSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                SELECT VSL_SLAN_CD AS LANE_PORT" ).append("\n"); 
		...
		query.append("                #end" ).append("\n"); 
		query.append("                 GROUP BY VSL_SLAN_CD, CST.ACCT_CD" ).append("\n"); 
		...
		query.append("                       SUBSTR(T10.RLANE_CD, 1, 3) AS LANE_PORT" ).append("\n"); 
		query.append("                     , CST.ACCT_CD AS ACCT_CD" ).append("\n"); 
		query.append("                     , NULL AS BUDGET_AMOUNT" ).append("\n"); 
		query.append("                     , NULL AS BUDGET_CALL" ).append("\n"); 
		query.append("                     , NULL AS ESTIMA_AMOUNT" ).append("\n"); 
		...
		query.append("                	AND VSL.CNTR_VSL_CLSS_CAPA = @[combo2]" ).append("\n"); 
		query.append("                #end " ).append("\n"); 
		query.append("                 GROUP BY SUBSTR(T10.RLANE_CD, 1, 3), CST.ACCT_CD" ).append("\n"); 
		query.append("               )" ).append("\n"); 
		...
		query.append("          FROM (SELECT T21.VSL_SLAN_CD AS VSL_SLAN_CD" ).append("\n"); 
		query.append("                     , SUBSTR(T22.YD_CD, 1, 5) AS LANE_PORT" ).append("\n"); 
		query.append("                     , CST.ACCT_CD AS ACCT_CD" ).append("\n"); 
		...
		query.append("                     , T21.VSL_SLAN_CD" ).append("\n"); 
		...
		query.append("               )" ).append("\n"); 
		query.append("         GROUP BY VSL_SLAN_CD, ACCT_CD " ).append("\n"); 
		...
		query.append("                  T10.SLAN_CD AS VSL_SLAN_CD" ).append("\n"); 
		...
		query.append("					AND VSL.CNTR_VSL_CLSS_CAPA = @[combo2]" ).append("\n"); 
		query.append("					#end " ).append("\n"); 
		query.append("                 GROUP BY T10.SLAN_CD" ).append("\n"); 
		query.append("                     , SUBSTR(SOH.YD_CD, 1, 5)" ).append("\n"); 
		query.append("                     , CST.ACCT_CD" ).append("\n"); 
