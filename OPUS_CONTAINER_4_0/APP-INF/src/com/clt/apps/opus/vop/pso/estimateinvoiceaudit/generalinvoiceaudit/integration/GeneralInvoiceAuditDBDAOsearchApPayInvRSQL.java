...
public class GeneralInvoiceAuditDBDAOsearchApPayInvRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("     , to_char(DUE_DT, 'YYYYMMDD') PAY_DUE_DT" ).append("\n"); 
		...
		query.append("     , DECODE(PSO_TRNS_SLP_CTNT, 'AR', 'Alternative conservation investment-related operating costs ('||TO_CHAR(ISS_DT, 'YYYY.MM')||')' ) INV_RMK" ).append("\n"); 
