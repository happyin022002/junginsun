...
*@FileName : StevedoreDamageMgtDBDAOSdmsSettlementReportVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOSdmsSettlementReportVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SdmsSettlementReportVO Select Query
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOSdmsSettlementReportVORSQL(){
		setQuery();
		...
		query.append("FileName : StevedoreDamageMgtDBDAOSdmsSettlementReportVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SUM(DECODE(S.STV_DMG_STL_PROC_STS_CD,'P',1,0))                          PAY_CNT," ).append("\n"); 
		query.append("ROUND(SUM(DECODE(S.STV_DMG_STL_PROC_STS_CD,'P',S.PAY_USD_AMT,0)),2)     PAY_AMT" ).append("\n"); 
