...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrRqstCgoUnmapCorrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrRqstCgoUnmapCorrUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_PRNR_RQST_CGO_UNMAP 데이터 CORR UPDATE
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrRqstCgoUnmapCorrUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrRqstCgoUnmapCorrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_PRNR_RQST_CGO_UNMAP" ).append("\n"); 
