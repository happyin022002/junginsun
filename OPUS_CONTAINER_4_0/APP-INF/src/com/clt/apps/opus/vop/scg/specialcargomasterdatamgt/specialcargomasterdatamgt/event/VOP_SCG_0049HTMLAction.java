...
*@FileName : VOP_SCG_0049HTMLAction.java
...
public class VOP_SCG_0049HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0049HTMLAction 객체를 생성
	 */
	public VOP_SCG_0049HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0049Event event = new VopScg0049Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setAttribute("objEvent", event); 
