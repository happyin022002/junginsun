...
public class OnTimeResultAnalysisDBDAOAddRsltVslSkdCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    , TO_DATE(@[act_brth_dt], 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		query.append("    , TO_DATE(@[pf_etd_dt]	, 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		query.append("    , TO_DATE(@[act_dep_dt]	, 'YYYY-MM-DD HH24:MI')" ).append("\n"); 
		...
		query.append("    , DECODE(@[skd_cng_sts_cd], 'S', 0, DECODE( SIGN(NVL(ROUND((TO_DATE(@[act_brth_dt]	, 'YYYY-MM-DD HH24:MI')-TO_DATE(@[pf_etb_dt], 'YYYY-MM-DD HH24:MI'))*24, 0), 0)), -1, 0 , NVL(ROUND((TO_DATE(@[act_brth_dt]	, 'YYYY-MM-DD HH24:MI')-TO_DATE(@[pf_etb_dt], 'YYYY-MM-DD HH24:MI'))*24, 0), 0)))" ).append("\n"); 
		query.append("    , DECODE(@[skd_cng_sts_cd], 'S', 0, DECODE( SIGN(NVL(ROUND((TO_DATE(@[act_dep_dt]	, 'YYYY-MM-DD HH24:MI')-TO_DATE(@[pf_etd_dt], 'YYYY-MM-DD HH24:MI'))*24, 0), 0)), -1, 0 , NVL(ROUND((TO_DATE(@[act_dep_dt]	, 'YYYY-MM-DD HH24:MI')-TO_DATE(@[pf_etd_dt], 'YYYY-MM-DD HH24:MI'))*24, 0), 0)))" ).append("\n"); 
		query.append("    , @[vskd_rslt_xcld_cd]" ).append("\n"); 
		query.append("	, @[init_arr_dlay_hrs]" ).append("\n"); 
		query.append("	, @[init_dep_dlay_hrs]" ).append("\n"); 
		query.append("    , @[cre_usr_id]" ).append("\n"); 
