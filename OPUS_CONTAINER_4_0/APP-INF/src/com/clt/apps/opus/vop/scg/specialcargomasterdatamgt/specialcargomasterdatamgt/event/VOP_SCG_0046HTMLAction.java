...
*@FileName : VMS_SCG_0046HTMLAction.java
...
public class VOP_SCG_0046HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0046HTMLAction 객체를 생성
	 */
	public VOP_SCG_0046HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0046Event event = new VopScg0046Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgSegrSymVOS((ScgImdgSegrSymVO[])getVOs(request, ScgImdgSegrSymVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgSegrSymVO((ScgImdgSegrSymVO)getVO(request, ScgImdgSegrSymVO .class));
		}
