...
*@FileName : VOP_VSK_0065HTMLAction.java
 ...
 * @author Jung Jinwoo
 * @see VopVsk0065Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0065HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0065HTMLAction 객체를 생성
	 */
	public VOP_VSK_0065HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0065Event event = new VopVsk0065Event();
