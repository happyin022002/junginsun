...
*@FileName : RegionDepartureReportDBDAOModifyRdrRfUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOModifyRdrRfUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAOModifyRdrRfUSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOModifyRdrRfUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE RDR_SUMMARY" ).append("\n"); 
		...
		query.append("AND    STATUS     = 'RS' " ).append("\n"); 
		query.append("AND    OPR_CD     = @[opr_cd]   " ).append("\n"); 
		query.append("AND    POL        = @[pol]      " ).append("\n"); 
