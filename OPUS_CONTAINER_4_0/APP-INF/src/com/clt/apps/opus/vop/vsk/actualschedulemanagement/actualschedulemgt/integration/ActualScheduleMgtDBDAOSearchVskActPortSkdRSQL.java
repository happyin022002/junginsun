...
public class ActualScheduleMgtDBDAOSearchVskActPortSkdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("       , TO_CHAR(ACT_ATA_INP_DT        , 'YYYYMMDDHH24MI') AS ACT_ATA_INP_DT" ).append("\n"); 
		...
		query.append("       , TO_CHAR(ACT_ATB_INP_DT        , 'YYYYMMDDHH24MI') AS ACT_ATB_INP_DT" ).append("\n"); 
		...
		query.append("       , TO_CHAR(ACT_ATD_INP_DT        , 'YYYYMMDDHH24MI') AS ACT_ATD_INP_DT" ).append("\n"); 
