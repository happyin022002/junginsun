...
*@FileName : VOP_PSO_0214HTMLAction.java
...
public class VOP_PSO_0214HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0213HTMLAction 객체를 생성
	 */
	public VOP_PSO_0214HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0214Event event = new VopPso0214Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setInvSumDtlVO((InvSumDtlVO)getVO(request, InvSumDtlVO.class));
			log.debug(">>0214 Action : " + event.getInvSumDtlVO().getPortCd());
		}
