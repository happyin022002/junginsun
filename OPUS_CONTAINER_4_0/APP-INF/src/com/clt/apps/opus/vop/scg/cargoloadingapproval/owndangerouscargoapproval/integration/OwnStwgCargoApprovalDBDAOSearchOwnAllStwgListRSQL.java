...
*@FileName : OwnStwgCargoApprovalDBDAOSearchOwnAllStwgListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnStwgCargoApprovalDBDAOSearchOwnAllStwgListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnStwgCargoApprovalDBDAOSearchOwnAllStwgListRSQL(){
		setQuery();
		...
		query.append("FileName : OwnStwgCargoApprovalDBDAOSearchOwnAllStwgListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		--2016-06-22 RMK 추가" ).append("\n"); 
		...
		query.append("					AND  (G.SPCL_CGO_AUTH_CD IS NULL OR G.SPCL_CGO_AUTH_CD      !=  'Y')" ).append("\n"); 
		query.append("				#end" ).append("\n"); 
		query.append("" ).append("\n"); 
