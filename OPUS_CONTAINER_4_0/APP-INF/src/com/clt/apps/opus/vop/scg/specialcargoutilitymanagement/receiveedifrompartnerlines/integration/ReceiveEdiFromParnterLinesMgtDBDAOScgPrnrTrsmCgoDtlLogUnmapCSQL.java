...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCgoDtlLogUnmapCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCgoDtlLogUnmapCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_PRNR_CGO_DTL_LOG_UNMAP 데이터 INSERT
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCgoDtlLogUnmapCSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrTrsmCgoDtlLogUnmapCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_PRNR_CGO_DTL_LOG_UNMAP" ).append("\n"); 
		...
		query.append("      	,  	TO_DATE(@[trsm_dt],'YYYYMMDD')								/* TRSM_DT              */" ).append("\n"); 
		query.append("      	,  	@[spcl_cgo_cate_cd]  										/* SPCL_CGO_CATE_CD     */" ).append("\n"); 
		query.append("      	,  	@[prnr_spcl_cgo_seq] 										/* PRNR_SPCL_CGO_SEQ    */" ).append("\n"); 
		query.append("		,	@[prnr_spcl_cgo_sub_seq] 									/* PRNR_SPCL_CGO_SUB_SEQ*/" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("      	,  (SELECT  NVL(MAX(UN.EDI_UNMAP_SEQ)+1,1)" ).append("\n"); 
		query.append("          	FROM    SCG_PRNR_CGO_DTL_LOG_UNMAP 	UN" ).append("\n"); 
		...
		query.append("          	AND     UN.PRNR_SPCL_CGO_SUB_SEQ    = @[prnr_spcl_cgo_sub_seq]" ).append("\n"); 
		query.append("          	)    " ).append("\n"); 
		query.append("																		/* EDI_UNMAP_SEQ        */" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
