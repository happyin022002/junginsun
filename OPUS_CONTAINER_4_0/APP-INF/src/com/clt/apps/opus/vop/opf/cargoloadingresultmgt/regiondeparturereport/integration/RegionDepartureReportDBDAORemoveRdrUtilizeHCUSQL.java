...
*@FileName : RegionDepartureReportDBDAORemoveRdrUtilizeHCUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORemoveRdrUtilizeHCUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAORemoveRdrUtilizeHCUSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORemoveRdrUtilizeHCUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       SLOT_QTY   = NULL" ).append("\n"); 
		...
		query.append("  AND TYPE  IN ('3','H','L')" ).append("\n"); 
