...
public class ProformaScheduleMgtDBDAOPfSkdVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("WHERE	1 = 1" ).append("\n"); 
		query.append("AND   	'*'  			= CASE 	WHEN (	SELECT      COUNT(1)             PF_DIR_ROW_KNT" ).append("\n"); 
		query.append("                            			FROM        VSK_PF_SKD_DTL       PD" ).append("\n"); 
		query.append("                            			WHERE       1 = 1" ).append("\n"); 
		query.append("                            			AND         PD.VSL_SLAN_CD       = T.VSL_SLAN_CD" ).append("\n"); 
		query.append("                            			AND         PD.PF_SVC_TP_CD      = T.PF_SVC_TP_CD" ).append("\n"); 
		query.append("                            			AND         PD.SKD_DIR_CD        = T.SKD_DIR_CD" ).append("\n"); 
		query.append("                            			AND         PD.TURN_PORT_IND_CD  <> 'F'" ).append("\n"); 
		query.append("                            		) = 0 THEN 'X'" ).append("\n"); 
		query.append("                      			ELSE '*'" ).append("\n"); 
		query.append("                  		  END" ).append("\n"); 
		query.append("" ).append("\n"); 
