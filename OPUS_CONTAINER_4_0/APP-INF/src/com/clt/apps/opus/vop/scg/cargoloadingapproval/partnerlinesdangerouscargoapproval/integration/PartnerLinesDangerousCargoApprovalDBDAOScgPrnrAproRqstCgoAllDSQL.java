...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoAllDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoAllDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Delete all cargo information under one booking.
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoAllDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoAllDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
