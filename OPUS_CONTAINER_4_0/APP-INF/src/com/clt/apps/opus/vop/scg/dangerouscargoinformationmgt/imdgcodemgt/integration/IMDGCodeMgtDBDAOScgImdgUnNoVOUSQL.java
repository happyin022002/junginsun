...
public class IMDGCodeMgtDBDAOScgImdgUnNoVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",   N1ST_ADD_SEGR_DESC = @[n1st_add_segr_desc]" ).append("\n"); 
		query.append(",   N2ND_ADD_SEGR_DESC = @[n2nd_add_segr_desc]" ).append("\n"); 
		query.append("--2016-05-27" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append(",	PRP_SHP_NM_VAR_RMK = @[prp_shp_nm_var_rmk]" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append(",   CFR_FLG = DECODE(@[cfr_flg], 'T', 'Y', 'F', 'N', @[cfr_flg])" ).append("\n"); 
