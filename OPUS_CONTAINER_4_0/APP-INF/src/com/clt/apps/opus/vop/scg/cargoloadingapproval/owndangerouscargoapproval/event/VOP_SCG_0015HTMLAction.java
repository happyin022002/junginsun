...
*@FileName : VOP_SCG_0015HTMLAction.java
...
public class VOP_SCG_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0015HTMLAction 객체를 생성
	 */
	public VOP_SCG_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0015Event event = new VopScg0015Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgDgCgoVO((ScgDgCgoVO)getVO(request, ScgDgCgoVO .class));
