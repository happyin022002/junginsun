...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgIrrTpCdVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgIrrTpCdVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPCL CGO Irregular Type (Creation) 삭제   
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgIrrTpCdVODSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgIrrTpCdVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}