...
*@FileName : TariffListWithYdNmVO.java
*@FileTitle : TariffListWithYdNmVO
*Open Issues :
*Change history :
...
public class TariffListWithYdNmVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TariffListWithYdNmVO> models = new ArrayList<TariffListWithYdNmVO>();
	...
	public TariffListWithYdNmVO() {}

	public TariffListWithYdNmVO(String ibflag, String pagerows, String ydChgNo, String ydChgVerSeq, String lgsCostCd, String ydCd, String ydNm, String vndrSeq, String effDt, String expDt, String currCd, String cplsFlg, String orgVndrNm, String rltAgmtNo, String lstFlg, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.currCd = currCd;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setOrgVndrNm(JSPUtil.getParameter(request, prefix + "org_vndr_nm", ""));
		...
		setRltAgmtNo(JSPUtil.getParameter(request, prefix + "rlt_agmt_no", ""));
	 ...
	 * @param request
	 * @return TariffListWithYdNmVO[]
	 */
	public TariffListWithYdNmVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TariffListWithYdNmVO[]
	 */
	public TariffListWithYdNmVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TariffListWithYdNmVO model = null;
		...
		try {
			...
			String[] rltAgmtNo = (JSPUtil.getParameter(request, prefix	+ "rlt_agmt_no", length));
			String[] updUsrId = (JSPUtil.getParameter(request, prefix	+ "upd_usr_id", length));
			
			for (int i = 0; i < length; i++) {
				model = new TariffListWithYdNmVO();
				if (updDt[i] != null)
		...
		return getTariffListWithYdNmVOs();
	}
	 ...
	 * @return TariffListWithYdNmVO[]
	 */
	public TariffListWithYdNmVO[] getTariffListWithYdNmVOs(){
		TariffListWithYdNmVO[] vos = (TariffListWithYdNmVO[])models.toArray(new TariffListWithYdNmVO[models.size()]);
		return vos;
	}
