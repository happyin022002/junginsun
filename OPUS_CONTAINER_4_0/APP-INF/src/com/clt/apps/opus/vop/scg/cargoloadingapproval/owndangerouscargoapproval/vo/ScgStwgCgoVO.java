...
*@FileName : ScgStwgCgoVO.java
*@FileTitle : ScgStwgCgoVO
*Open Issues :
*Change history :
...
public class ScgStwgCgoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ScgStwgCgoVO> models = new ArrayList<ScgStwgCgoVO>();
	...
	public ScgStwgCgoVO(String ibflag, String pagerows, String bkgNo, String spclCgoAproRqstSeq, String stwgCgoSeq, String stwgCd, String stwgRmk, String rqstDt, String rqstGdt, String rqstUsrId, String spclCgoAproCd, String aplyNo, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
		this.rqstDt = rqstDt;
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setStwgCgoSeq(JSPUtil.getParameter(request, prefix + "stwg_cgo_seq", ""));
	 ...
	 * @return ScgStwgCgoVO[]
	 */
	public ScgStwgCgoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ScgStwgCgoVO[]
	 */
	public ScgStwgCgoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ScgStwgCgoVO model = null;
	 ...
	 * @return ScgStwgCgoVO[]
	 */
	public ScgStwgCgoVO[] getScgStwgCgoVOs(){
		ScgStwgCgoVO[] vos = (ScgStwgCgoVO[])models.toArray(new ScgStwgCgoVO[models.size()]);
		return vos;
	}
