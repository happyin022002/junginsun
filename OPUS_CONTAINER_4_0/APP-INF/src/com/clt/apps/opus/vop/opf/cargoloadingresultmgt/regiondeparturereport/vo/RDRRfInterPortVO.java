...
*@FileName : RDRRfInterPortVO.java
*@FileTitle : RDRRfInterPortVO
*Open Issues :
*Change history :
...
public class RDRRfInterPortVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RDRRfInterPortVO> models = new ArrayList<RDRRfInterPortVO>();
	...
	public RDRRfInterPortVO() {}

	public RDRRfInterPortVO(String ibflag, String pagerows, String oprCd, String pol, String pod, String qty20, String qty40) {
		this.qty20 = qty20;
		this.ibflag = ibflag;
		this.oprCd = oprCd;
		this.pol = pol;
	 ...
	 * @param request
	 * @return RDRRfInterPortVO[]
	 */
	public RDRRfInterPortVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RDRRfInterPortVO[]
	 */
	public RDRRfInterPortVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RDRRfInterPortVO model = null;
	 ...
	 * @return RDRRfInterPortVO[]
	 */
	public RDRRfInterPortVO[] getRDRRfInterPortVOs(){
		RDRRfInterPortVO[] vos = (RDRRfInterPortVO[])models.toArray(new RDRRfInterPortVO[models.size()]);
		return vos;
	}
