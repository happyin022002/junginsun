...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOCheckDGPackagingEffectivenessRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOCheckDGPackagingEffectivenessRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DG Packaging Code 유효성 체크
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOCheckDGPackagingEffectivenessRSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOCheckDGPackagingEffectivenessRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
