...
*@FileName : GeneralInvoiceAuditDBDAOmodifyPsoChargeDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOmodifyPsoChargeDetailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOmodifyPsoChargeDetailUSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOmodifyPsoChargeDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE PSO_CHG_DTL SET" ).append("\n"); 
		query.append("DP_IO_BND_CD = @[dp_io_bnd_cd]" ).append("\n"); 
		query.append(",	ORG_SO_DTL_SEQ = @[org_so_dtl_seq]" ).append("\n"); 
		query.append(",	INV_COND_DESC = @[inv_cond_desc]" ).append("\n"); 
		query.append(",	ISS_CTY_CD = @[iss_cty_cd]" ).append("\n"); 
		query.append(",	SO_SEQ = @[so_seq]" ).append("\n"); 
		query.append(",	SO_DTL_SEQ = @[so_dtl_seq]" ).append("\n"); 
		...
		query.append(",	ADJ_AMT = @[adj_amt]" ).append("\n"); 
		...
		query.append(",	AR_YRMON = @[ar_yrmon]" ).append("\n"); 
