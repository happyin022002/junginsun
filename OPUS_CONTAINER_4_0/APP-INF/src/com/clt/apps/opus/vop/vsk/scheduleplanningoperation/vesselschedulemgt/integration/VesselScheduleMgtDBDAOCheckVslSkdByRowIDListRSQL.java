...
*@FileName : VesselScheduleMgtDBDAOCheckVslSkdByRowIDListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCheckVslSkdByRowIDListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CheckVslSkdByRowIDList
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCheckVslSkdByRowIDListRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCheckVslSkdByRowIDListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND			T1.TURN_SKD_VOY_NO  = @[skd_voy_no]    	/* 변경 전 SKD_VOY_NO       */" ).append("\n"); 
		query.append("AND			T1.TURN_SKD_DIR_CD  = @[skd_dir_cd]    	/* 변경 전 SKD_DIR_CD       */" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("AND			T1.TURN_CLPT_IND_SEQ = @[clpt_ind_seq]  /* 변경 전 CLPT_IND_SEQ     */" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("                    AND     	S.POD_CD      		= T1.VPS_PORT_CD " ).append("\n"); 
		query.append("					AND			S.POD_CLPT_IND_SEQ	= T1.CLPT_IND_SEQ" ).append("\n"); 
		query.append("                )" ).append("\n"); 
		query.append("	)" ).append("\n"); 
