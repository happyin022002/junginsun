...
public class PortTariffMgtBCDBDAOMergePsoChgXprDtlCSQL implements ISQLTemplate{
	...
	public PortTariffMgtBCDBDAOMergePsoChgXprDtlCSQL(){
		...
		params.put("cond_als_nm",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append("            ,A.COND_ALS_NM           = @[cond_als_nm]                            " ).append("\n"); 
		...
		query.append("            ,A.COND_ALS_NM" ).append("\n"); 
		...
		query.append("            ,@[cond_als_nm]           " ).append("\n"); 
