...
public class TerminalDepartureReportConditionVO extends AbstractValueObject {
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTargetPorts(JSPUtil.getParameter(request, "target_ports", ""));
		setPagerows(JSPUtil.getParameter(request, "pagerows", ""));
		setGroupBy(JSPUtil.getParameter(request, "group_by", ""));
		setIbflag(JSPUtil.getParameter(request, "ibflag", ""));
		setLocCd(JSPUtil.getParameter(request, "loc_cd", ""));
		setManuInTime(JSPUtil.getParameter(request, "manu_in_time", ""));
		setSlanCd(JSPUtil.getParameter(request, "slan_cd", ""));
		setFromDate(JSPUtil.getParameter(request, "from_date", ""));
		setYdCd(JSPUtil.getParameter(request, "yd_cd", ""));
		setOprCd(JSPUtil.getParameter(request, "opr_cd", ""));
		setOptionCd(JSPUtil.getParameter(request, "option_cd", ""));
		setClptIndSeq(JSPUtil.getParameter(request, "clpt_ind_seq", ""));
		setMishandlechk(JSPUtil.getParameter(request, "mishandlechk", ""));
		setCarrCd(JSPUtil.getParameter(request, "carr_cd", ""));
		setDirCd(JSPUtil.getParameter(request, "dir_cd", ""));
		setTargetLanes(JSPUtil.getParameter(request, "target_lanes", ""));
		setTmlProdRptRsnCd(JSPUtil.getParameter(request, "tml_prod_rpt_rsn_cd", ""));
		setRhq(JSPUtil.getParameter(request, "rhq", ""));
		setRestowReasonList(JSPUtil.getParameter(request, "restow_reason_list", ""));
	}
