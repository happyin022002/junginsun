...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstCgoVOUSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",   AUTH_DT = DECODE(@[auth_sts_cd],'Y', DECODE(AUTH_DT, NULL, SYSDATE, AUTH_DT) " ).append("\n"); 
		query.append("                                   ,'N', DECODE(AUTH_DT, NULL, SYSDATE, AUTH_DT)" ).append("\n"); 
		query.append("                                   ,'P', DECODE(AUTH_DT, NULL, SYSDATE, AUTH_DT),AUTH_DT)" ).append("\n"); 
		...
		query.append(",	APRO_REF_NO = DECODE(@[apro_ref_no], '0', NULL, @[apro_ref_no])" ).append("\n"); 
		...
		query.append(",   CGO_RQST_DT = DECODE(@[auth_sts_cd],'R',DECODE(CGO_RQST_DT, NULL, SYSDATE, CGO_RQST_DT),CGO_RQST_DT)" ).append("\n"); 
		query.append(",   IMDG_AMDT_NO = @[imdg_amdt_no] " ).append("\n"); 
		query.append(",   CFR_FLG = @[cfr_flg] " ).append("\n"); 
