...
*@FileName : VopVsk9016Event.java
*@FileTitle : Vessel Rename (Pop-Up)
*Open Issues :
*Change history :
...
/**
 * VOP_VSK_9016 에 대한 PDTO(Data Transfer Object including Parameters)<br>
 * -  VOP_VSK_9016HTMLAction에서 작성<br>
 * - ServiceCommand Layer로 전달하는 PDTO로 사용<br>
 *
 * @author Ryu Hyuk
 * @see VOP_VSK_9016HTMLAction 참조
 * @since J2EE 1.4
 */

public class VopVsk9016Event extends EventSupport {
