...
*@FileName : RegionDepartureReportDBDAOSearchRdrAllocationRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOSearchRdrAllocationRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAOSearchRdrAllocationRSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOSearchRdrAllocationRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM   RDR_ALLOCATION A" ).append("\n"); 
		...
		query.append("AND   A.OPR_CD =  @[opr_cd]" ).append("\n"); 
		query.append("AND   A.SEGMENT = @[segment]" ).append("\n"); 
