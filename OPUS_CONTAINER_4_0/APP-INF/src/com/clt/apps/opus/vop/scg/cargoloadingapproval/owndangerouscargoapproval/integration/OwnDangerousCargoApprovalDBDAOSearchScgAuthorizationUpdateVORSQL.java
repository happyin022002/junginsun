...
*@FileName : OwnDangerousCargoApprovalDBDAOSearchScgAuthorizationUpdateVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOSearchScgAuthorizationUpdateVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_AUTHORIZATION에 기존에 같은 조건으로 Update된 Data가 있는지 체크한다.
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOSearchScgAuthorizationUpdateVORSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOSearchScgAuthorizationUpdateVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
