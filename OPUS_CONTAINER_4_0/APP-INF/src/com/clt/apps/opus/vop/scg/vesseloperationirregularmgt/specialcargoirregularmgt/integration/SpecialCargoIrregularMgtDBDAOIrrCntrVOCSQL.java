...
*@FileName : SpecialCargoIrregularMgtDBDAOIrrCntrVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoIrregularMgtDBDAOIrrCntrVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPCL CGO Irregular Container 생성
	  * </pre>
	  */
	public SpecialCargoIrregularMgtDBDAOIrrCntrVOCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoIrregularMgtDBDAOIrrCntrVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IRR_CNTR (" ).append("\n"); 
		query.append("	VSL_CD" ).append("\n"); 
		query.append(",	SKD_VOY_NO" ).append("\n"); 
		query.append(",	SKD_DIR_CD" ).append("\n"); 
		query.append(",	SPCL_CGO_IRR_SEQ" ).append("\n"); 
		query.append(",	SPCL_CGO_IRR_CNTR_SEQ" ).append("\n"); 
		...
		query.append(",	AWK_CGO_GRS_WGT" ).append("\n"); 
		query.append(",	AWK_CGO_NET_WGT" ).append("\n"); 
		...
		query.append(",	@[spcl_cgo_irr_seq]" ).append("\n"); 
		query.append(",	@[spcl_cgo_irr_cntr_seq]" ).append("\n"); 
		query.append("#if (${cgo_opr_cd} == ${comp_cd}) " ).append("\n"); 
		query.append(",	@[bkg_no]" ).append("\n"); 
		query.append(",	''" ).append("\n"); 
		query.append(",	@[cntr_no]" ).append("\n"); 
		query.append(",	''" ).append("\n"); 
