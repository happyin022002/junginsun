...
public class SimulationVvdCheckVO extends AbstractValueObject {
	...
	/* Column Info */
	private String voyTypeCnt = null;	
	/* Column Info */
	...
	public SimulationVvdCheckVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String startDate, String endDate, String vslCnt, String voyNoType, String voyTypeCnt, String skdDirCd1, String skdDirCd2, String duration) {
...
/**
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setVoyTypeCnt(JSPUtil.getParameter(request, prefix + "voy_type_cnt", ""));
	...
	public SimulationVvdCheckVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] voyTypeCnt = (JSPUtil.getParameter(request, prefix	+ "voy_type_cnt", length));
	...
	*/
	public void unDataFormat(){
		...
		this.voyTypeCnt = this.voyTypeCnt .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
