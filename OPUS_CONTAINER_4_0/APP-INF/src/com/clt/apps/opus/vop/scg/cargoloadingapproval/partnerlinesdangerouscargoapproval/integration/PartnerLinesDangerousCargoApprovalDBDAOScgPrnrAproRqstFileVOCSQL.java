...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPCL CGO APVL for Partner Lines 의 Request File 생성
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO	SCG_PRNR_APRO_RQST_FILE XX" ).append("\n"); 
		query.append("USING		(" ).append("\n"); 
		query.append("			SELECT		COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()	AS CRR_CD" ).append("\n"); 
		...
		query.append("                  	,  	@[spcl_cgo_rqst_atch_file_seq]      			AS SPCL_CGO_RQST_ATCH_FILE_SEQ" ).append("\n"); 
		query.append("                  	" ).append("\n"); 
		...
		query.append("		AND	XX.SPCL_CGO_RQST_ATCH_FILE_SEQ 	= YY.SPCL_CGO_RQST_ATCH_FILE_SEQ" ).append("\n"); 
		query.append("			)			" ).append("\n"); 
		query.append("			" ).append("\n"); 
		query.append("WHEN MATCHED THEN" ).append("\n"); 
		query.append("UPDATE" ).append("\n"); 
		query.append("SET		XX.FILE_NM							= @[file_nm]          " ).append("\n"); 
		query.append("	,	XX.FILE_SAV_ID             			= @[file_sav_id]                  " ).append("\n"); 
		query.append("	,	XX.UPD_USR_ID              			= @[upd_usr_id]       " ).append("\n"); 
		query.append("	,	XX.UPD_DT                  			= SYSDATE             " ).append("\n"); 
		query.append("	" ).append("\n"); 
		...
		query.append("	,	@[bkg_ref_no]" ).append("\n"); 
		query.append("	,	@[spcl_cgo_rqst_seq]" ).append("\n"); 
		query.append("	,	(	SELECT NVL(MAX(SPCL_CGO_RQST_ATCH_FILE_SEQ),0) + 1 " ).append("\n"); 
