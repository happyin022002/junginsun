...
*@FileName : VesselScheduleMgtDBDAORemoveVskSwapCstPortByPreVvdDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAORemoveVskSwapCstPortByPreVvdDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * VSK_SWAP_CST_PORT 테이블의 자기 자신의 전 차수를 찾아서 REMOVE한다
	  * </pre>
	  */
	public VesselScheduleMgtDBDAORemoveVskSwapCstPortByPreVvdDSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : VesselScheduleMgtDBDAORemoveVskSwapCstPortByPreVvdDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}