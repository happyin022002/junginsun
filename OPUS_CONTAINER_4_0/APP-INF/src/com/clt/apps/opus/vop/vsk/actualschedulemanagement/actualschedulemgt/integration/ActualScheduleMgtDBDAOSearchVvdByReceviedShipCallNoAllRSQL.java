...
*@FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedShipCallNoAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchVvdByReceviedShipCallNoAllRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchVvdByReceviedShipCallNoAllRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedShipCallNoAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
