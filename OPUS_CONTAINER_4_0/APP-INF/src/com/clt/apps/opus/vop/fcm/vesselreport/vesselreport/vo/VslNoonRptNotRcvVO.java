...
*@FileName : VslNoonRptNotRcvVO.java
*@FileTitle : VslNoonRptNotRcvVO
*Open Issues :
*Change history :
...
public class VslNoonRptNotRcvVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VslNoonRptNotRcvVO> models = new ArrayList<VslNoonRptNotRcvVO>();
	...
	public VslNoonRptNotRcvVO() {}

	public VslNoonRptNotRcvVO(String ibflag, String pagerows, String vslSlanCd, String vvd, String depPortCd, String nxtPortCd, String rptDt) {
		this.vvd = vvd;
		this.ibflag = ibflag;
...
/**
	 ...
	 */
	public VslNoonRptNotRcvVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VslNoonRptNotRcvVO[]
	 */
	public VslNoonRptNotRcvVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VslNoonRptNotRcvVO model = null;
	 ...
	 * @return VslNoonRptNotRcvVO[]
	 */
	public VslNoonRptNotRcvVO[] getVslNoonRptNotRcvVOs(){
		VslNoonRptNotRcvVO[] vos = (VslNoonRptNotRcvVO[])models.toArray(new VslNoonRptNotRcvVO[models.size()]);
		return vos;
	}
