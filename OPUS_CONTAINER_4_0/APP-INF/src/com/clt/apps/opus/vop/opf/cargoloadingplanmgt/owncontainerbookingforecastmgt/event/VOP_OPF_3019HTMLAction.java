...
*@FileName : VOP_OPF_3019HTMLAction.java
...
public class VOP_OPF_3019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_3019HTMLAction 객체를 생성
	 */
	public VOP_OPF_3019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf3019Event event = new VopOpf3019Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCargoBookingForecastVOS((CargoBookingForecastVO[])getVOs(request, CargoBookingForecastVO .class,"sheet1_"));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCargoBookingForecastVO((CargoBookingForecastVO)getVO(request, CargoBookingForecastVO .class));
		}
