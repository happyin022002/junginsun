...
public class SearchOwnDGListVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String spclCgoAuthCdChk = null;
    ...
    /* Column Info */
    private String ediChkType = null;

    /* Column Info */
    private String emlChkType = null;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("spcl_cgo_auth_cd_chk", getSpclCgoAuthCdChk());
        ...
        this.hashColumns.put("edi_chk_type", getEdiChkType());
        this.hashColumns.put("eml_chk_type", getEmlChkType());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("spcl_cgo_auth_cd_chk", "spclCgoAuthCdChk");
        ...
        this.hashFields.put("edi_chk_type", "ediChkType");
        this.hashFields.put("eml_chk_type", "emlChkType");
    ...
    /**
 	 * Column Info
 	 * @return spclCgoAuthCdChk
 	 */
    public String getSpclCgoAuthCdChk() {
        return this.spclCgoAuthCdChk;
    }
    ...
    /**
 	 ...
 	 * @return ediChkType
 	 */
    public String getEdiChkType() {
        return this.ediChkType;
    }
    ...
    /**
 	 ...
 	 * @return emlChkType
 	 */
    public String getEmlChkType() {
        return this.emlChkType;
    }
    ...
    /**
	 * Column Info
	 * @param  spclCgoAuthCdChk
 	 */
    public void setSpclCgoAuthCdChk(String spclCgoAuthCdChk) {
        this.spclCgoAuthCdChk = spclCgoAuthCdChk;
    }
	 ...
	 * @param  ediChkType
 	 */
    public void setEdiChkType(String ediChkType) {
        this.ediChkType = ediChkType;
    }
	 ...
	 * @param  emlChkType
 	 */
    public void setEmlChkType(String emlChkType) {
        this.emlChkType = emlChkType;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setSpclCgoAuthCdChk(JSPUtil.getParameter(request, prefix + "spcl_cgo_auth_cd_chk", ""));
        ...
        setEdiChkType(JSPUtil.getParameter(request, prefix + "edi_chk_type", ""));
        setEmlChkType(JSPUtil.getParameter(request, prefix + "eml_chk_type", ""));
    ...
    public SearchOwnDGListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] spclCgoAuthCdChk = (JSPUtil.getParameter(request, prefix + "spcl_cgo_auth_cd_chk", length));
            ...
            String[] ediChkType = (JSPUtil.getParameter(request, prefix + "edi_chk_type", length));
            String[] emlChkType = (JSPUtil.getParameter(request, prefix + "eml_chk_type", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (spclCgoAuthCdChk[i] != null)
                    model.setSpclCgoAuthCdChk(spclCgoAuthCdChk[i]);
                ...
                if (ediChkType[i] != null)
                    model.setEdiChkType(ediChkType[i]);
                if (emlChkType[i] != null)
                    model.setEmlChkType(emlChkType[i]);
                if (updDt[i] != null) 
    ...
    public void unDataFormat() {
        ...
        this.itmStsCd = this.itmStsCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.spclCgoAuthCdChk = this.spclCgoAuthCdChk.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.ediChkType = this.ediChkType.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.emlChkType = this.emlChkType.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
