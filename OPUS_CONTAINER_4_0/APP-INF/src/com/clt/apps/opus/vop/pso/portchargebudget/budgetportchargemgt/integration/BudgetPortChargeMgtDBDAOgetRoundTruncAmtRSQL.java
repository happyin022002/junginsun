...
*@FileName : BudgetPortChargeMgtDBDAOgetRoundTruncAmtRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BudgetPortChargeMgtDBDAOgetRoundTruncAmtRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BudgetPortChargeMgtDBDAOgetRoundTruncAmtRSQL(){
		setQuery();
		...
		query.append("FileName : BudgetPortChargeMgtDBDAOgetRoundTruncAmtRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                       AND DELT_FLG='N')" ).append("\n"); 
		query.append("union all" ).append("\n"); 
		query.append("/*Out-Bound 인 경우 ; 내림*/" ).append("\n"); 
