...
public class BudEstDtlCondVO extends AbstractValueObject {
    ...
    public BudEstDtlCondVO(String ibflag, String pagerows, String acctCd, String laneCd, String creDtFr, String creDtTo, String gubun, String locCd, String vslCls, String termCd) {
        this.laneCd = laneCd;
        this.vslCls = vslCls;
        this.locCd = locCd;
        this.ibflag = ibflag;
