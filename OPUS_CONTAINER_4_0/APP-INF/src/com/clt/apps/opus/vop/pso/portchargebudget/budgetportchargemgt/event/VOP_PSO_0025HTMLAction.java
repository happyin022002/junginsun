...
*@FileName : VOP_PSO_0025HTMLAction.java
...
public class VOP_PSO_0025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0025HTMLAction 객체를 생성
	 */
	public VOP_PSO_0025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0025Event event = new VopPso0025Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setEstTgtVvdByMonVO((EstTgtVvdByMonVO)getVO(request,EstTgtVvdByMonVO.class));
		}
