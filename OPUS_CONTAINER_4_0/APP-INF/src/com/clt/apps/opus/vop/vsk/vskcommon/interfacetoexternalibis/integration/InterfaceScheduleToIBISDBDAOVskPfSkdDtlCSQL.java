...
*@FileName : InterfaceScheduleToIBISDBDAOVskPfSkdDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceScheduleToIBISDBDAOVskPfSkdDtlCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InterfaceScheduleToIBISDBDAOVskPfSkdDtlCSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceScheduleToIBISDBDAOVskPfSkdDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO VSK_PF_SKD_DTL_IBIS_IF" ).append("\n"); 
		query.append("(" ).append("\n"); 
