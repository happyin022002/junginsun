...
*@FileName : UI_PSO_0205HTMLAction.java
...
public class VOP_PSO_0205HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * UI_PSO_0205HTMLAction 객체를 생성
	 */
	public VOP_PSO_0205HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0205Event event = new VopPso0205Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setVendorVO(((VendorVO)getVO(request,VendorVO.class)));
		}
