...
*@FileName : VOP_SCG_5022HTMLAction.java
...
public class VOP_SCG_5022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_5022HTMLAction 객체를 생성
	 */
	public VOP_SCG_5022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg5022Event event = new VopScg5022Event();
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setPortLimitsDgTotalWeightVO((PortLimitsDgTotalWeightVO)getVO(request, PortLimitsDgTotalWeightVO .class,""));
		}
