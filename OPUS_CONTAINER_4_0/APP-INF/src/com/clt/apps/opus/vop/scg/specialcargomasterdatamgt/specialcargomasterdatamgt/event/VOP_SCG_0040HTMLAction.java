...
*@FileName : VMS_SCG_0040HTMLAction.java
...
public class VOP_SCG_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0040HTMLAction 객체를 생성
	 */
	public VOP_SCG_0040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0040Event event = new VopScg0040Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgPckGrpVOS((ScgImdgPckGrpVO[])getVOs(request, ScgImdgPckGrpVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgPckGrpVO((ScgImdgPckGrpVO)getVO(request, ScgImdgPckGrpVO .class));
		}
