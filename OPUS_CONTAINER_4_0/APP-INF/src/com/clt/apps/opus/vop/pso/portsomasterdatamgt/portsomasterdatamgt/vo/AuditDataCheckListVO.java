...
public class AuditDataCheckListVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String chkGrtYn = null;

    /* Column Info */
    private String chkNrtYn = null;

    /* Column Info */
    private String chkDesingCapacityYn = null;

    /* Column Info */
    private String chkLoaYn = null;

    /* Column Info */
    private String chkDwtYn = null;

    /* Column Info */
    private String chkScgtYn = null;

    /* Column Info */
    private String chkAllowanceTeuYn = null;

    /* Column Info */
    private String chkBmYn = null;

    /* Column Info */
    private String chkSummerDraftYn = null;

    /* Column Info */
    private String chkFlagYn = null;

    /* Column Info */
    private String chkOwnershipYn = null;

    /* Column Info */
    private String chkScntYn = null;
    ...
    public AuditDataCheckListVO(String ibflag, String pagerows, String vslCd, String vslEngNm, String grsRgstTongWgt, String netRgstTongWgt, String cntrVslClssCapa, String loaLen, String dwtWgt, String crwKnt, String vslRgstCntCd, String vslDpth, String cntrPnmCapa, String vslWdt, String smrDrftHgt, String scnt, String scgt, String vslOwnIndCd, String cntrDznCapa, String chkGrtYn, String chkNrtYn, String chkDesingCapacityYn, String chkLoaYn, String chkDwtYn, String chkScgtYn, String chkAllowanceTeuYn, String chkBmYn, String chkSummerDraftYn, String chkFlagYn, String chkOwnershipYn, String chkScntYn) {
        ...
        this.chkGrtYn = chkGrtYn;
        this.chkNrtYn = chkNrtYn;
        this.chkDesingCapacityYn = chkDesingCapacityYn;
        this.chkLoaYn = chkLoaYn;
        this.chkDwtYn = chkDwtYn;
        this.chkScgtYn = chkScgtYn;
        this.chkAllowanceTeuYn = chkAllowanceTeuYn;
        this.chkBmYn = chkBmYn;
        this.chkSummerDraftYn = chkSummerDraftYn;
        this.chkFlagYn = chkFlagYn;
        this.chkOwnershipYn = chkOwnershipYn;
        this.chkScntYn = chkScntYn;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("scnt", getScnt());
        this.hashColumns.put("scgt", getScgt());
        this.hashColumns.put("vsl_own_ind_cd", getVslOwnIndCd());
        this.hashColumns.put("cntr_dzn_capa", getCntrDznCapa());
        this.hashColumns.put("chk_grt_yn", getChkGrtYn());
        this.hashColumns.put("chk_nrt_yn", getChkNrtYn());
        this.hashColumns.put("chk_desing_capacity_yn", getChkDesingCapacityYn());
        this.hashColumns.put("chk_loa_yn", getChkLoaYn());
        this.hashColumns.put("chk_dwt_yn", getChkDwtYn());
        this.hashColumns.put("chk_scgt_yn", getChkScgtYn());
        this.hashColumns.put("chk_allowance_teu_yn", getChkAllowanceTeuYn());
        this.hashColumns.put("chk_bm_yn", getChkBmYn());
        this.hashColumns.put("chk_summer_draft_yn", getChkSummerDraftYn());
        this.hashColumns.put("chk_flag_yn", getChkFlagYn());
        this.hashColumns.put("chk_ownership_yn", getChkOwnershipYn());
        this.hashColumns.put("chk_scnt_yn", getChkScntYn());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("scnt", "scnt");
        this.hashFields.put("scgt", "scgt");
        this.hashFields.put("vsl_own_ind_cd", "vslOwnIndCd");
        this.hashFields.put("cntr_dzn_capa", "cntrDznCapa");
        this.hashFields.put("chk_grt_yn", "chkGrtYn");
        this.hashFields.put("chk_nrt_yn", "chkNrtYn");
        this.hashFields.put("chk_desing_capacity_yn", "chkDesingCapacityYn");
        this.hashFields.put("chk_loa_yn", "chkLoaYn");
        this.hashFields.put("chk_dwt_yn", "chkDwtYn");
        this.hashFields.put("chk_scgt_yn", "chkScgtYn");
        this.hashFields.put("chk_allowance_teu_yn", "chkAllowanceTeuYn");
        this.hashFields.put("chk_bm_yn", "chkBmYn");
        this.hashFields.put("chk_summer_draft_yn", "chkSummerDraftYn");
        this.hashFields.put("chk_flag_yn", "chkFlagYn");
        this.hashFields.put("chk_ownership_yn", "chkOwnershipYn");
        this.hashFields.put("chk_scnt_yn", "chkScntYn");
    ...
    public void setChkGrtYn(String chkGrtYn) {
        this.chkGrtYn = chkGrtYn;
    }

    public String getChkGrtYn() {
        return this.chkGrtYn;
    }

    public void setChkNrtYn(String chkNrtYn) {
        this.chkNrtYn = chkNrtYn;
    }

    public String getChkNrtYn() {
        return this.chkNrtYn;
    }

    public void setChkDesingCapacityYn(String chkDesingCapacityYn) {
        this.chkDesingCapacityYn = chkDesingCapacityYn;
    }

    public String getChkDesingCapacityYn() {
        return this.chkDesingCapacityYn;
    }

    public void setChkLoaYn(String chkLoaYn) {
        this.chkLoaYn = chkLoaYn;
    }

    public String getChkLoaYn() {
        return this.chkLoaYn;
    }

    public void setChkDwtYn(String chkDwtYn) {
        this.chkDwtYn = chkDwtYn;
    }

    public String getChkDwtYn() {
        return this.chkDwtYn;
    }

    public void setChkScgtYn(String chkScgtYn) {
        this.chkScgtYn = chkScgtYn;
    }

    public String getChkScgtYn() {
        return this.chkScgtYn;
    }

    public void setChkAllowanceTeuYn(String chkAllowanceTeuYn) {
        this.chkAllowanceTeuYn = chkAllowanceTeuYn;
    }

    public String getChkAllowanceTeuYn() {
        return this.chkAllowanceTeuYn;
    }

    public void setChkBmYn(String chkBmYn) {
        this.chkBmYn = chkBmYn;
    }

    public String getChkBmYn() {
        return this.chkBmYn;
    }

    public void setChkSummerDraftYn(String chkSummerDraftYn) {
        this.chkSummerDraftYn = chkSummerDraftYn;
    }

    public String getChkSummerDraftYn() {
        return this.chkSummerDraftYn;
    }

    public void setChkFlagYn(String chkFlagYn) {
        this.chkFlagYn = chkFlagYn;
    }

    public String getChkFlagYn() {
        return this.chkFlagYn;
    }

    public void setChkOwnershipYn(String chkOwnershipYn) {
        this.chkOwnershipYn = chkOwnershipYn;
    }

    public String getChkOwnershipYn() {
        return this.chkOwnershipYn;
    }

    public void setChkScntYn(String chkScntYn) {
        this.chkScntYn = chkScntYn;
    }

    public String getChkScntYn() {
        return this.chkScntYn;
    }
    ...
    public void fromRequest(HttpServletRequest request) {
        ...
        setScnt(JSPUtil.getParameter(request, "scnt", ""));
        setScgt(JSPUtil.getParameter(request, "scgt", ""));
        setVslOwnIndCd(JSPUtil.getParameter(request, "vsl_own_ind_cd", ""));
        setCntrDznCapa(JSPUtil.getParameter(request, "cntr_dzn_capa", ""));
        setChkGrtYn(JSPUtil.getParameter(request, "chk_grt_yn", ""));
        setChkNrtYn(JSPUtil.getParameter(request, "chk_nrt_yn", ""));
        setChkDesingCapacityYn(JSPUtil.getParameter(request, "chk_desing_capacity_yn", ""));
        setChkLoaYn(JSPUtil.getParameter(request, "chk_loa_yn", ""));
        setChkDwtYn(JSPUtil.getParameter(request, "chk_dwt_yn", ""));
        setChkScgtYn(JSPUtil.getParameter(request, "chk_scgt_yn", ""));
        setChkAllowanceTeuYn(JSPUtil.getParameter(request, "chk_allowance_teu_yn", ""));
        setChkBmYn(JSPUtil.getParameter(request, "chk_bm_yn", ""));
        setChkSummerDraftYn(JSPUtil.getParameter(request, "chk_summer_draft_yn", ""));
        setChkFlagYn(JSPUtil.getParameter(request, "chk_flag_yn", ""));
        setChkOwnershipYn(JSPUtil.getParameter(request, "chk_ownership_yn", ""));
        setChkScntYn(JSPUtil.getParameter(request, "chk_scnt_yn", ""));
    }
    ...
    public AuditDataCheckListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] scnt = (JSPUtil.getParameter(request, prefix + "scnt", length));
            String[] scgt = (JSPUtil.getParameter(request, prefix + "scgt", length));
            ...
            String[] chkGrtYn = (JSPUtil.getParameter(request, prefix + "chk_grt_yn", length));
            String[] chkNrtYn = (JSPUtil.getParameter(request, prefix + "chk_nrt_yn", length));
            String[] chkDesingCapacityYn = (JSPUtil.getParameter(request, prefix + "chk_desing_capacity_yn", length));
            String[] chkLoaYn = (JSPUtil.getParameter(request, prefix + "chk_loa_yn", length));
            String[] chkDwtYn = (JSPUtil.getParameter(request, prefix + "chk_dwt_yn", length));
            String[] chkScgtYn = (JSPUtil.getParameter(request, prefix + "chk_scgt_yn", length));
            String[] chkAllowanceTeuYn = (JSPUtil.getParameter(request, prefix + "chk_allowance_teu_yn", length));
            String[] chkBmYn = (JSPUtil.getParameter(request, prefix + "chk_bm_yn", length));
            String[] chkSummerDraftYn = (JSPUtil.getParameter(request, prefix + "chk_summer_draft_yn", length));
            String[] chkFlagYn = (JSPUtil.getParameter(request, prefix + "chk_flag_yn", length));
            String[] chkOwnershipYn = (JSPUtil.getParameter(request, prefix + "chk_ownership_yn", length));
            String[] chkScntYn = (JSPUtil.getParameter(request, prefix + "chk_scnt_yn", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (scnt[i] != null)
                    model.setScnt(scnt[i]);
                if (scgt[i] != null)
                    model.setScgt(scgt[i]);
                if (vslOwnIndCd[i] != null)
                    model.setVslOwnIndCd(vslOwnIndCd[i]);
                if (cntrDznCapa[i] != null)
                    model.setCntrDznCapa(cntrDznCapa[i]);
                if (chkGrtYn[i] != null)
                    model.setChkGrtYn(chkGrtYn[i]);
                if (chkNrtYn[i] != null)
                    model.setChkNrtYn(chkNrtYn[i]);
                if (chkDesingCapacityYn[i] != null)
                    model.setChkDesingCapacityYn(chkDesingCapacityYn[i]);
                if (chkLoaYn[i] != null)
                    model.setChkLoaYn(chkLoaYn[i]);
                if (chkDwtYn[i] != null)
                    model.setChkDwtYn(chkDwtYn[i]);
                if (chkScgtYn[i] != null)
                    model.setChkScgtYn(chkScgtYn[i]);
                if (chkAllowanceTeuYn[i] != null)
                    model.setChkAllowanceTeuYn(chkAllowanceTeuYn[i]);
                if (chkBmYn[i] != null)
                    model.setChkBmYn(chkBmYn[i]);
                if (chkSummerDraftYn[i] != null)
                    model.setChkSummerDraftYn(chkSummerDraftYn[i]);
                if (chkFlagYn[i] != null)
                    model.setChkFlagYn(chkFlagYn[i]);
                if (chkOwnershipYn[i] != null)
                    model.setChkOwnershipYn(chkOwnershipYn[i]);
                if (chkScntYn[i] != null) 
		    		model.setChkScntYn(chkScntYn[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.scnt = this.scnt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.scgt = this.scgt.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.chkGrtYn = this.chkGrtYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkNrtYn = this.chkNrtYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkDesingCapacityYn = this.chkDesingCapacityYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkLoaYn = this.chkLoaYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkDwtYn = this.chkDwtYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkScgtYn = this.chkScgtYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkAllowanceTeuYn = this.chkAllowanceTeuYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkBmYn = this.chkBmYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkSummerDraftYn = this.chkSummerDraftYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkFlagYn = this.chkFlagYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkOwnershipYn = this.chkOwnershipYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.chkScntYn = this.chkScntYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
}
