...
public class GeneralInvoiceAuditDBDAOaddPsoChargeDetailCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addPsoChargeDetail
	  * [2015.09.10]VT_VVD_FLG, TURN_VVD_CD 신규 추가.
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOaddPsoChargeDetailCSQL(){
		...
		params.put("turn_vvd_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("vt_vvd_flg",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		...
		query.append(",   VT_VVD_FLG" ).append("\n"); 
		query.append(",   TURN_VVD_CD" ).append("\n"); 
		query.append(",	CLPT_IND_SEQ /* 2016.04.26 Double calling port Add  */" ).append("\n"); 
