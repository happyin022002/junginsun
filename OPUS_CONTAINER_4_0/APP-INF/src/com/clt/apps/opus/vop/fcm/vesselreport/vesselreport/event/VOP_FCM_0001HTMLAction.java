...
=========================================================*/
package com.clt.apps.opus.vop.fcm.vesselreport.vesselreport.event;
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.nis2010.vop.fcm.vesselreport 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
