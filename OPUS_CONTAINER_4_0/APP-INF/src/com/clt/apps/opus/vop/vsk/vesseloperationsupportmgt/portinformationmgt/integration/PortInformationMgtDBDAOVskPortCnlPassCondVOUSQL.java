...
*@FileName : PortInformationMgtDBDAOVskPortCnlPassCondVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortInformationMgtDBDAOVskPortCnlPassCondVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortInformationMgtDBDAOVskPortCnlPassCondVOUSQL(){
		setQuery();
		...
		query.append("FileName : PortInformationMgtDBDAOVskPortCnlPassCondVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE VSK_PORT_CNL_PASS_COND SET" ).append("\n"); 
		query.append("SVC_SCP_BND_CD = @[svc_scp_bnd_cd]" ).append("\n"); 
		query.append(",   CNL_TZ_SEQ_CD = @[cnl_tz_seq_cd]" ).append("\n"); 
		query.append(",	SCG_EXPT_LMT_HRMNT = @[scg_expt_lmt_hrmnt]" ).append("\n"); 
		query.append(",	SCG_FM_LMT_HRMNT = @[scg_fm_lmt_hrmnt]" ).append("\n"); 
		query.append(",	SCG_TO_LMT_HRMNT = @[scg_to_lmt_hrmnt]" ).append("\n"); 
		query.append(",	LMT_TM_SCG_RTO = @[lmt_tm_scg_rto]" ).append("\n"); 
		query.append(",	CNL_RMK = @[cnl_rmk]" ).append("\n"); 
