...
*@FileName : VOP_SCG_0019HTMLAction.java
...
public class VOP_SCG_0019HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0019HTMLAction 객체를 생성
	 */
	public VOP_SCG_0019HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0019Event event = new VopScg0019Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setOwnApprovalRequestVO((OwnApprovalRequestVO)getVO(request, OwnApprovalRequestVO .class));
		}
