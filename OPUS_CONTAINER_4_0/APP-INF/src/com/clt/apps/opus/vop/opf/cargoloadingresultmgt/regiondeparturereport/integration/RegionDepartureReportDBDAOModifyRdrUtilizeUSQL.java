...
*@FileName : RegionDepartureReportDBDAOModifyRdrUtilizeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOModifyRdrUtilizeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDR Utilize 수정  Utilize에서 저장시
	  * </pre>
	  */
	public RegionDepartureReportDBDAOModifyRdrUtilizeUSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOModifyRdrUtilizeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  SET  SLOT_QTY     = @[slot_qty]" ).append("\n"); 
		query.append(",      WEIGHT       = @[total_wgt]" ).append("\n"); 
		...
		query.append("  AND TYPE IN ('F','E','A')" ).append("\n"); 
