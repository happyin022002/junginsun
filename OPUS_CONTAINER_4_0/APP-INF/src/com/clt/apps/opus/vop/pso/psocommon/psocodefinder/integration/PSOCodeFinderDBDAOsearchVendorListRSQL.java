...
*@FileName : PSOCodeFinderDBDAOsearchVendorListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PSOCodeFinderDBDAOsearchVendorListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PSOCodeFinderDBDAOsearchVendorListRSQL(){
		setQuery();
		...
		query.append("FileName : PSOCodeFinderDBDAOsearchVendorListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		--ENG_ADD," ).append("\n"); 
		query.append("		--RLOCL_LANG_ADDR," ).append("\n"); 
		...
		query.append("		--SUBS_CO_CDOTR_FLG," ).append("\n"); 
		...
		query.append("#if(${cnl_agn_flg}!='')" ).append("\n"); 
		query.append("AND     CNL_AGN_FLG = 'Y'" ).append("\n"); 
		query.append("#end " ).append("\n"); 
		query.append("#if (${vndr_seq} != '')" ).append("\n"); 
		query.append("AND     VNDR_SEQ = @[vndr_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${loc_cd} != '')" ).append("\n"); 
		query.append("AND     VNDR_CNT_CD = DECODE(SUBSTR(@[loc_cd], 1,5), 'PAPCA', 'PA', 'EGSCA', 'EG', 'All', VNDR_CNT_CD)" ).append("\n"); 
		query.append("#end" ).append("\n"); 
