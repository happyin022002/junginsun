...
public class VopOpf004604Event extends EventSupport {
    ...
    public RdrCreatInfoVO[] getRdrCreatInfoMainTradeVOs() {
		...
		if (this.rdrCreatInfoMainTradeVOs != null) {
			rtnVOs = Arrays.copyOf(this.rdrCreatInfoMainTradeVOs, this.rdrCreatInfoMainTradeVOs.length);
		} // end if
		return rtnVOs;
    }
    ...
    public RdrCreatInfoVO[] getRdrCreatInfoInterPortVOs() {
        RdrCreatInfoVO[] rtnVOs = null;
		if (this.rdrCreatInfoInterPortVOs != null) {
			rtnVOs = Arrays.copyOf(this.rdrCreatInfoInterPortVOs, this.rdrCreatInfoInterPortVOs.length);
		} // end if
		return rtnVOs;
    }
    ...
    public void setRdrCreatInfoMainTradeVOs(
		...
		if (rdrCreatInfoMainTradeVOs != null) {
			RdrCreatInfoVO[] tmpVOs = Arrays.copyOf(rdrCreatInfoMainTradeVOs, rdrCreatInfoMainTradeVOs.length);
    ...
    public void setRdrCreatInfoInterPortVOs(
		...
		if (rdrCreatInfoInterPortVOs != null) {
			RdrCreatInfoVO[] tmpVOs = Arrays.copyOf(rdrCreatInfoInterPortVOs, rdrCreatInfoInterPortVOs.length);
