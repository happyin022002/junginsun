...
public class VesselScheduleMgtDBDAOCstSkdByVvdRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("       , T1.IB_CSSM_VOY_NO" ).append("\n"); 
		query.append("       , T1.OB_CSSM_VOY_NO   " ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("            	WHERE     PS.VSL_CD             = T1.VSL_CD" ).append("\n"); 
		query.append("            	AND       PS.SKD_VOY_NO         = T1.TURN_SKD_VOY_NO" ).append("\n"); 
		query.append("            	AND       PS.SKD_DIR_CD         = T1.TURN_SKD_DIR_CD" ).append("\n"); 
		query.append("            	AND       PS.VPS_PORT_CD        = T1.VPS_PORT_CD" ).append("\n"); 
		query.append("            	AND       PS.CLPT_IND_SEQ       = T1.TURN_CLPT_IND_SEQ" ).append("\n"); 
		query.append("            	)" ).append("\n"); 
		query.append("            	ELSE ''" ).append("\n"); 
		query.append("        END TURN_IB_CSSM_VOY_NO" ).append("\n"); 
		query.append("	   , T1.CSSM_VOY_INIT_CRE_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("              FROM      VSK_VSL_PORT_SKD      PS" ).append("\n"); 
		query.append("              WHERE     PS.VSL_CD             = T1.VSL_CD" ).append("\n"); 
		query.append("              AND       PS.SKD_VOY_NO         = T1.SKD_VOY_NO" ).append("\n"); 
		query.append("              AND       PS.SKD_DIR_CD         = T1.SKD_DIR_CD" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("	   , T1.VT_ADD_CALL_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("       , NVL(T1.SKP_CALL_FLG, DECODE(T1.SKD_CNG_STS_CD, 'S', 'Y')) SKP_CALL_FLG" ).append("\n"); 
		query.append("       , NVL(T1.ADD_CALL_FLG, DECODE(T1.SKD_CNG_STS_CD, 'A', 'Y')) ADD_CALL_FLG" ).append("\n"); 
		query.append("       , T1.VSL_RENM_OLD_VSL_CD" ).append("\n"); 
		query.append("       , T1.VSL_RENM_OLD_VSL_ENG_NM" ).append("\n"); 
		query.append("       , T1.VSL_RENM_NEW_VSL_CD" ).append("\n"); 
		query.append("       , T1.VSL_RENM_NEW_VSL_ENG_NM" ).append("\n"); 
		query.append("       , T1.VSLD_WKS" ).append("\n"); 
		query.append("" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("       --::2015-04-16::--, T2.PORT_ROTN_SEQ" ).append("\n"); 
		query.append("       , CASE WHEN T2.PORT_ROTN_SEQ IS NULL THEN (SELECT PD.PORT_ROTN_SEQ" ).append("\n"); 
		query.append("                                                  FROM VSK_PF_SKD_DTL PD " ).append("\n"); 
		query.append("                                                  WHERE PD.VSL_SLAN_CD = T1.VSL_SLAN_CD " ).append("\n"); 
		query.append("                                                  AND PD.PF_SVC_TP_CD = T1.PF_SKD_TP_CD " ).append("\n"); 
		query.append("                                                  AND PD.PORT_CD      = T1.VPS_PORT_CD" ).append("\n"); 
		query.append("                                                  AND PD.SKD_DIR_CD   = T1.SKD_DIR_CD" ).append("\n"); 
		query.append("                                                  AND PD.CLPT_SEQ     = T1.CLPT_IND_SEQ" ).append("\n"); 
		query.append("                                                  )" ).append("\n"); 
		query.append("              ELSE T2.PORT_ROTN_SEQ" ).append("\n"); 
		query.append("         END  AS      PORT_ROTN_SEQ" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("	   , (" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("			   , T2.VT_ADD_CALL_FLG" ).append("\n"); 
		query.append("               , T2.IB_CSSM_VOY_NO" ).append("\n"); 
		query.append("               , T2.OB_CSSM_VOY_NO" ).append("\n"); 
		query.append("			   , T2.CSSM_VOY_INIT_CRE_FLG" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("               , T2.SKP_CALL_FLG" ).append("\n"); 
		query.append("               , T2.ADD_CALL_FLG" ).append("\n"); 
		query.append("               , T2.VSL_RENM_OLD_VSL_CD" ).append("\n"); 
		query.append("               , T2.VSL_RENM_OLD_VSL_ENG_NM" ).append("\n"); 
		query.append("               , T2.VSL_RENM_NEW_VSL_CD" ).append("\n"); 
		query.append("               , T2.VSL_RENM_NEW_VSL_ENG_NM" ).append("\n"); 
		query.append("               , T2.VSLD_WKS" ).append("\n"); 
		...
		query.append("" ).append("\n"); 
		query.append("---- COMMENT BY TOP : 2015-02-06 ----" ).append("\n"); 
		query.append("----AND T1.SKD_DIR_CD    = T2.SKD_DIR_CD     (+)" ).append("\n"); 
		query.append("----AND T1.CLPT_IND_SEQ  = T2.CLPT_SEQ       (+)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND CASE 	WHEN T1.TURN_PORT_IND_CD IN ('Y','N') THEN T1.SKD_DIR_CD" ).append("\n"); 
		query.append("       		ELSE T1.TURN_SKD_DIR_CD" ).append("\n"); 
		query.append("   	END                 			= T2.SKD_DIR_CD		(+)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("AND CASE 	WHEN T1.TURN_PORT_IND_CD IN ('Y','N') THEN T1.CLPT_IND_SEQ" ).append("\n"); 
		query.append("       		ELSE T1.TURN_CLPT_IND_SEQ" ).append("\n"); 
		query.append("   	END                 			= T2.CLPT_SEQ		(+)" ).append("\n"); 
		query.append("" ).append("\n"); 
