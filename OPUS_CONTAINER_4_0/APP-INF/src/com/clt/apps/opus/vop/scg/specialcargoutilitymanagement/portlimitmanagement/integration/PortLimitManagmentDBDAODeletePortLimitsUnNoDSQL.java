...
*@FileName : PortLimitManagmentDBDAODeletePortLimitsUnNoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortLimitManagmentDBDAODeletePortLimitsUnNoDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortLimitManagmentDBDAODeletePortLimitsUnNoDSQL(){
		setQuery();
		...
		query.append("FileName : PortLimitManagmentDBDAODeletePortLimitsUnNoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IMDG_PORT_LMT_UN_NO " ).append("\n"); 
