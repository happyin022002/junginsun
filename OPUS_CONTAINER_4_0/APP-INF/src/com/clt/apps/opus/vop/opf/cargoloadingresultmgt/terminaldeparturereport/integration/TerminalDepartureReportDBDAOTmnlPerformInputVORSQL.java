...
public class TerminalDepartureReportDBDAOTmnlPerformInputVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("                                AND    S.OPR_CD   = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()                          --:carr_cd('OWN')" ).append("\n"); 
		...
		query.append("                                AND    C.OPR_CD   = COM_ConstantMgr_PKG.COM_getCompanyCode_FNC()                          --:carr_cd('OWN')" ).append("\n"); 
