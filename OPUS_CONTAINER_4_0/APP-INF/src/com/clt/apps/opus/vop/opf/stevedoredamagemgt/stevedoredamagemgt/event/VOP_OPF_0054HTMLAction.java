...
*@FileName : VOP_OPF_0054HTMLAction.java
...
public class VOP_OPF_0054HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0054HTMLAction 객체를 생성
	 */
	public VOP_OPF_0054HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0054Event event = new VopOpf0054Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setSdmsStepHistoryVO((SdmsStepHistoryVO)getVO(request, SdmsStepHistoryVO .class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setOpfStvDmgStepHisVO((OpfStvDmgStepHisVO)getVO(request, OpfStvDmgStepHisVO .class));
		}
