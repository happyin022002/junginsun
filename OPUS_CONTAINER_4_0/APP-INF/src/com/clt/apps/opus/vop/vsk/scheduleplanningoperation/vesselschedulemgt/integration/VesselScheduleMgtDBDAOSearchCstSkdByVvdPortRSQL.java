...
public class VesselScheduleMgtDBDAOSearchCstSkdByVvdPortRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append(",	CASE WHEN T1.CLPT_IND_SEQ = '1' THEN '1st'" ).append("\n"); 
		query.append("		 WHEN T1.CLPT_IND_SEQ = '2'	THEN '2nd'" ).append("\n"); 
		query.append("		 WHEN T1.CLPT_IND_SEQ = '3' THEN '3rd'" ).append("\n"); 
		query.append("		 ELSE T1.CLPT_IND_SEQ||'th'" ).append("\n"); 
		query.append("	END	 AS CLPT_IND_SEQ2	/* Only for Display */" ).append("\n"); 
