...
*@FileName : TerminalDepartureReportDBDAOdeleteTdrSummaryDischSGDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOdeleteTdrSummaryDischSGDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOdeleteTdrSummaryDischSGDSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOdeleteTdrSummaryDischSGDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND CNTR_TYPE IN ('D', 'R','A')" ).append("\n"); 
