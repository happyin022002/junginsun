...
*@FileName : OwnContainerBookingForecastMgtDBDAOOpfCbfCntrImdgSubsRsk2DSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOOpfCbfCntrImdgSubsRsk2DSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOOpfCbfCntrImdgSubsRsk2DSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOOpfCbfCntrImdgSubsRsk2DSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM OPF_CBF_CNTR_IMDG_SUBS_RSK" ).append("\n"); 
