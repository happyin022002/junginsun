...
*@FileName : VSKCodeFinderDBDAOVesselVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VSKCodeFinderDBDAOVesselVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM Vessel Container 테이블을 조회한다.
	  * </pre>
	  */
	public VSKCodeFinderDBDAOVesselVORSQL(){
		setQuery();
		...
		query.append("FileName : VSKCodeFinderDBDAOVesselVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND UPPER(CALL_SGN_NO) LIKE '%' || UPPER(@[call_sgn_no]) || '%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${lloyd_no} != '')" ).append("\n"); 
		query.append("AND UPPER(LLOYD_NO) LIKE '%' || UPPER(@[lloyd_no]) || '%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
