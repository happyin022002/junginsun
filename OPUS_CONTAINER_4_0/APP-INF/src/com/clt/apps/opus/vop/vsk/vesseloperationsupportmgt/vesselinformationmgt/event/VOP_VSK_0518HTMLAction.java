...
*@FileName : VOP_VSK_0518HTMLAction.java
...
public class VOP_VSK_0518HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0518HTMLAction 객체를 생성
	 */
	public VOP_VSK_0518HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0518Event event = new VopVsk0518Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setDraftWeightListVO((DraftWeightListVO)getVO(request, DraftWeightListVO .class,"sheet1_"));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setDraftWeightListVOS((DraftWeightListVO[]) getVOs(request, DraftWeightListVO.class,"sheet1_"));
		} 
