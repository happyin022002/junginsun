...
*@FileName : OperationNPerformMasterDataMgtDBDAOOpfCodDvsFeeVOUSQL.java
...
public class OperationNPerformMasterDataMgtDBDAOOpfCodDvsFeeVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OpfCodDvsFeeVO Update Query
	  * </pre>
	  */
	public OperationNPerformMasterDataMgtDBDAOOpfCodDvsFeeVOUSQL(){
		setQuery();
		...
		query.append("FileName : OperationNPerformMasterDataMgtDBDAOOpfCodDvsFeeVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",	DVS_FEE_TP_CD = @[dvs_fee_tp_cd]" ).append("\n"); 
