...
public class PortTariffMgtBCDBDAOsearchOfficeObjectListARSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("   AND B.PSO_MEAS_UT_CD NOT IN ('12','14','15','16','17')  -- 12 FLAG, 14 Code, 15 Time,16 Date, 17 Day 이 아닌것" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("   AND B.PSO_OBJ_LIST_TP_CD NOT IN ('C')" ).append("\n"); 
		query.append("ORDER BY B.OBJ_LIST_NM , C2.INTG_CD_VAL_DP_DESC" ).append("\n"); 
