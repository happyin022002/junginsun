...
public class PortSkdOnLongRangeVO extends AbstractValueObject {
    ...
    /* Column Info */
    private String exclAddClptIndSeq = null;
    ...
    public PortSkdOnLongRangeVO(String ibflag, String pagerows, String vslSlanCd, String pfSkdTpCd, String vslCd, String skdVoyNo, String skdDirCd, String vslSlanDirSeq, String vpsPortCd, String clptIndSeq, String clptSeq, String portSkdStsCd, String ydCd, String callYdIndSeq, String pfEtaDt, String pfEtbDt, String pfEtdDt, String initEtaDt, String initEtbDt, String initEtdDt, String vpsEtaDt, String vpsEtbDt, String vpsEtdDt, String skdCngStsCd, String turnPortFlg, String turnPortIndCd, String turnSkdVoyNo, String turnSkdDirCd, String turnClptIndSeq, String vpsRmk, String startDate, String endDate, String creDt, String creUsrId, String updDt, String updUsrId, String vslSvcTpCd, String portNm, String vslEngNm, String incDelVsl, String exclAddClptIndSeq, String obCssmVoyNo) {
        ...
        this.exclAddClptIndSeq = exclAddClptIndSeq;
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("excl_add_clpt_ind_seq", getExclAddClptIndSeq());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("excl_add_clpt_ind_seq", "exclAddClptIndSeq");
    ...
    public void setExclAddClptIndSeq(String exclAddClptIndSeq) {
        this.exclAddClptIndSeq = exclAddClptIndSeq;
    }
    ...
    public String getExclAddClptIndSeq() {
        return this.exclAddClptIndSeq;
    }
    ...
    public PortSkdOnLongRangeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] exclAddClptIndSeq = (JSPUtil.getParameter(request, prefix + "excl_add_clpt_ind_seq", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (exclAddClptIndSeq[i] != null) 
		    		model.setExclAddClptIndSeq(exclAddClptIndSeq[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.exclAddClptIndSeq = this.exclAddClptIndSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    ...
    public boolean isSamePort(PortSkdOnLongRangeVO other) {
        if (this.vslSlanCd.equals(other.vslSlanCd) && this.pfSkdTpCd.equals(other.pfSkdTpCd) && this.skdDirCd.equals(other.skdDirCd) && this.vpsPortCd.equals(other.vpsPortCd) && this.ydCd.equals(other.ydCd) && this.clptIndSeq.equals(other.clptIndSeq)) {
            return true;
        } else {
            return false;
        }
