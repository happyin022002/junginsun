...
*@FileName : TerminalDepartureReportDBDAOOpfTmlDepRptDtlVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOOpfTmlDepRptDtlVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOOpfTmlDepRptDtlVOUSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOOpfTmlDepRptDtlVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE OPF_TML_DEP_RPT_DTL SET" ).append("\n"); 
		query.append("TML_PROD_RPT_RSN_CD = @[tml_prod_rpt_rsn_cd]" ).append("\n"); 
		query.append(",	TML_PROD_RPT_RSN_RMK = @[tml_prod_rpt_rsn_rmk]" ).append("\n"); 
		query.append(",	TDR_EML_SND_NO = @[tdr_eml_snd_no]" ).append("\n"); 
