...
public class LaneInformationMgtDBDAOStatusServiceVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT  C.INTG_CD_VAL_DP_DESC TYPE, COUNT, VSL_SVC                                     " ).append("\n"); 
		...
		query.append("        (                                                                                  " ).append("\n"); 
		query.append("            SELECT  VSKD_FLET_GRP_CD, COUNT(DISTINCT A.SLAN_CD) VSL_SVC                " ).append("\n"); 
		...
		query.append("	,	(" ).append("\n"); 
		query.append("		SELECT	'C'	AS INTG_CD_VAL_CTNT, 'Main Service including Slot Charter only' AS INTG_CD_VAL_DP_DESC FROM DUAL UNION ALL" ).append("\n"); 
		query.append("		SELECT	'I'	AS INTG_CD_VAL_CTNT, 'Intra Asia Service(including Alliance)' 	AS INTG_CD_VAL_DP_DESC FROM DUAL UNION ALL" ).append("\n"); 
		query.append("		SELECT	'M'	AS INTG_CD_VAL_CTNT, 'Main Service including Operation' 		AS INTG_CD_VAL_DP_DESC FROM DUAL UNION ALL" ).append("\n"); 
		query.append("		SELECT	'O'	AS INTG_CD_VAL_CTNT, 'Other Alliance Service' 					AS INTG_CD_VAL_DP_DESC FROM DUAL" ).append("\n"); 
