...
*@FileName : RegionDepartureReportDBDAORDRHcVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORDRHcVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RDRHcVO Select Query
	  * </pre>
	  */
	public RegionDepartureReportDBDAORDRHcVORSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORDRHcVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("DECODE(B.TTL_RAT, 'R', 'Rate', 'V', 'Void', 'Rate') RATIO_TYPE" ).append("\n"); 
		...
		query.append("AND    B.OPR_CD    = @[opr_cd]" ).append("\n"); 
		...
		query.append("GROUP BY  M.OPR_CD,  B.OPR_CD , DECODE(B.TTL_RAT, 'R', 'Rate', 'V', 'Void', 'Rate'), NVL(B.HC20_RAT, 0), NVL(B.HC_RAT, 0), NVL(B.UN_RAT_45, 0), NVL(B.OV_RAT_45, 0), NVL(B.HC20_QTY, 0), NVL(B.HC_QTY, 0), NVL(B.QTY_45, 0)" ).append("\n"); 
