...
*@FileName : OwnDangerousCargoApprovalDBDAOSearchBbApprovalDetailListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOSearchBbApprovalDetailListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOSearchBbApprovalDetailListRSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOSearchBbApprovalDetailListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("         ROW_NUMBER() OVER (PARTITION BY NVL(G.BKG_NO, A.BKG_NO),NVL(G.SPCL_CGO_APRO_RQST_SEQ, A.SPCL_CGO_APRO_RQST_SEQ),NVL(G.BB_CGO_SEQ, A.BB_CGO_SEQ),NVL(G.VSL_PRE_PST_CD, A.VSL_PRE_PST_CD),NVL(G.VSL_SEQ, A.VSL_SEQ)" ).append("\n"); 
