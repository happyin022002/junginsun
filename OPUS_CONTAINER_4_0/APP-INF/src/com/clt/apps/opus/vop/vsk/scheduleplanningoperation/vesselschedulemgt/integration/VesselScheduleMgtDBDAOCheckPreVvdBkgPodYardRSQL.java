...
*@FileName : VesselScheduleMgtDBDAOCheckPreVvdBkgPodYardRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselScheduleMgtDBDAOCheckPreVvdBkgPodYardRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * CheckPreVvdBkgPodYard
	  * </pre>
	  */
	public VesselScheduleMgtDBDAOCheckPreVvdBkgPodYardRSQL(){
		setQuery();
		...
		query.append("FileName : VesselScheduleMgtDBDAOCheckPreVvdBkgPodYardRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("			AND    		T1.VPS_PORT_CD 		= T2.POD_CD" ).append("\n"); 
		query.append("			AND			T1.CLPT_IND_SEQ		= T2.POD_CLPT_IND_SEQ" ).append("\n"); 
		...
		query.append("			AND    		T1.SKD_VOY_NO 		= @[turn_skd_voy_no]" ).append("\n"); 
		query.append("			AND    		T1.SKD_DIR_CD 		= @[turn_skd_dir_cd]" ).append("\n"); 
