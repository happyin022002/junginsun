...
public class GeneralInvoiceAuditDBDAOinsertPsoChgDtlCSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	WHERE T1.ISS_CTY_CD = (SELECT SUBSTR(OFC_CD, 1, 3)" ).append("\n"); 
		query.append("                           FROM TABLE (COM_OfficeCodeMgr_PKG.COM_getOfficeCodeList_FNC('000001', 'PSO')))" ).append("\n"); 
