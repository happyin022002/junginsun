...
public class OwnDangerousCargoApprovalDBDAOSearchDGApprovalStatusListRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("    --::2016-04-19::--" ).append("\n"); 
		query.append("    ROW_NUMBER() OVER (PARTITION BY NVL(C.BKG_NO, A.BKG_NO), NVL(C.SPCL_CGO_APRO_RQST_SEQ, A.SPCL_CGO_APRO_RQST_SEQ), NVL(C.DCGO_SEQ, A.DCGO_SEQ), NVL(C.VSL_PRE_PST_CD, A.VSL_PRE_PST_CD), NVL(C.VSL_SEQ, A.VSL_SEQ)" ).append("\n"); 
