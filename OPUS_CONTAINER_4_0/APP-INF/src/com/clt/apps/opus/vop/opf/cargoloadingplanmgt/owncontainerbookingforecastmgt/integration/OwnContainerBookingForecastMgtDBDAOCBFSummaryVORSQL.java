...
*@FileName : OwnContainerBookingForecastMgtDBDAOCBFSummaryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnContainerBookingForecastMgtDBDAOCBFSummaryVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnContainerBookingForecastMgtDBDAOCBFSummaryVORSQL(){
		setQuery();
		...
		query.append("FileName : OwnContainerBookingForecastMgtDBDAOCBFSummaryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            NVL(OPR1_QTY_2,  0) AS OPR1_QTY_2," ).append("\n"); 
		query.append("            NVL(OPR1_QTY_2H,0) AS  OPR1_QTY_2H," ).append("\n"); 
		query.append("            NVL(OPR1_QTY_4,0) AS  OPR1_QTY_4," ).append("\n"); 
		query.append("            NVL(OPR1_QTY_4H,0) AS  OPR1_QTY_4H," ).append("\n"); 
		query.append("            NVL(OPR1_QTY_45,0) AS  OPR1_QTY_45," ).append("\n"); 
		query.append("            NVL(OPR1_TEU, 0) AS  OPR1_TEU," ).append("\n"); 
		query.append("            NVL(TOT_QTY_2, 0) AS  TOT_QTY_2," ).append("\n"); 
		query.append("            NVL(TOT_QTY_2H, 0) AS  TOT_QTY_2H," ).append("\n"); 
		query.append("            NVL(TOT_QTY_4, 0) AS  TOT_QTY_4," ).append("\n"); 
		query.append("            NVL(TOT_QTY_4H, 0) AS  TOT_QTY_4H," ).append("\n"); 
		query.append("            NVL(TOT_QTY_45, 0) AS  TOT_QTY_45," ).append("\n"); 
		query.append("            NVL(TOT_TTL, 0) AS  TOT_TTL," ).append("\n"); 
		query.append("            NVL(TOT_TEU, 0) AS  TOT_TEU," ).append("\n"); 
		query.append("            NVL(AV_WGT_2, 0) AS  AV_WGT_2," ).append("\n"); 
		query.append("            NVL(AV_WGT_4, 0) AS  AV_WGT_4" ).append("\n"); 
		...
		query.append("                                SELECT S1.POD, S1.POD_CLPT_IND_SEQ, S1.MLB, S1.FM, DECODE(S1.FM,'F',1,2) SORT, S2.WG, S2.WSEQ, S1.OPR," ).append("\n"); 
		...
		query.append("                                FROM   ( SELECT POD, POD_CLPT_IND_SEQ, MLB, FM, OPR" ).append("\n"); 
		...
		query.append("                           UNION ALL" ).append("\n"); 
		query.append("                           SELECT 'E' FM FROM DUAL )" ).append("\n"); 
		query.append("                         SELECT S1.POD, S1.POD_CLPT_IND_SEQ, S1.MLB, S1.FM, DECODE(S1.FM,'F',1,2) SORT, S2.WG, S2.WSEQ," ).append("\n"); 
		...
		query.append("                         FROM   ( SELECT POD, POD_CLPT_IND_SEQ, MLB, FM" ).append("\n"); 
		...
		query.append("AND   SUBSTR(POD,1,5) = P.PORT(+)" ).append("\n"); 
		query.append("AND   SUBSTR(POD,6,1) = P.CLPT_IND_SEQ(+)" ).append("\n"); 
		query.append("UNION ALL" ).append("\n"); 
		query.append("SELECT NVL(SUBSTR(POD,1,5),'Grand Total') POD, MLB," ).append("\n"); 
		query.append("       CASE" ).append("\n"); 
