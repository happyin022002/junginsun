...
*@FileName : GeneralInvoiceAuditDBDAOGetEtaDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOGetEtaDateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOGetEtaDateRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOGetEtaDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'TO_DATE('''||TO_CHAR (A.VPS_ETA_DT, 'YYYYMMDD')||''',''YYYYMMDD'')'" ).append("\n"); 
