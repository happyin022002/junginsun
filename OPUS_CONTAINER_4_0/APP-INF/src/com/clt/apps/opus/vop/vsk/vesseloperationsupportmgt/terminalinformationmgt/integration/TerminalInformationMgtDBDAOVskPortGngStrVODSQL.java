...
*@FileName : TerminalInformationMgtDBDAOVskPortGngStrVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalInformationMgtDBDAOVskPortGngStrVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalInformationMgtDBDAOVskPortGngStrVODSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("DELETE FROM vsk_port_gng_strc" ).append("\n"); 
		...
		query.append("FileName : TerminalInformationMgtDBDAOVskPortGngStrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}