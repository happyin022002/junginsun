 ...
 * @see	..
 */
public class SendDgEmailRequestVO extends AbstractValueObject {

    private static final long serialVersionUID = 1L;

    private Collection<SendDgEmailRequestVO> models = new ArrayList<SendDgEmailRequestVO>();
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("scg_flag", getScgFlag());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("scg_flag", "scgFlag");
    ...
    public String getScgFlag() {
        return scgFlag;
    }

    public void setScgFlag(String scgFlag) {
        this.scgFlag = scgFlag;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setScgFlag(JSPUtil.getParameter(request, prefix + "scg_flag", ""));
	 ...
	 */
    public SendDgEmailRequestVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SendDgEdiRequestVO[]
	 */
    public SendDgEmailRequestVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        SendDgEmailRequestVO model = null;
        ...
        try {
            ...
            String[] scgFlag = (JSPUtil.getParameter(request, prefix + "scg_flag", length));
            String[] emlSndTpCd = (JSPUtil.getParameter(request, prefix + "eml_snd_tp_cd", length));
	    	/* Add a field line, do not delete */
            for (int i = 0; i < length; i++) {
                model = new SendDgEmailRequestVO();
                if (ibflag[i] != null)
	 ...
	 * @return SendDgEdiRequestVO[]
	 */
    public SendDgEmailRequestVO[] getSendDgEdiRequestVOs() {
        SendDgEmailRequestVO[] vos = (SendDgEmailRequestVO[]) models.toArray(new SendDgEmailRequestVO[models.size()]);
        return vos;
    }
    ...
    public void unDataFormat() {
        ...
        this.scgFlag = this.scgFlag.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
