...
public class VskPortDistVO extends AbstractValueObject {
	...
	/* Column Info */
	private String tempToLocCd = null;
	/* Column Info */
	...
	public VskPortDistVO(String ibflag, String pagerows, String fmLocCd, String toLocCd, String stndDist, String stndDistDesc, String shrtDist, String shrtDistDesc, String gmtTdHrs, String creUsrId, String creDt, String updUsrId, String updDt, String tempToLocCd) {
		this.updDt = updDt;
		this.tempToLocCd = tempToLocCd;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("temp_to_loc_cd", getTempToLocCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("temp_to_loc_cd", "tempToLocCd");
	 ...
	 * @return tempToLocCd
	 */
	public String getTempToLocCd() {
		return this.tempToLocCd;
	}
	 ...
	 * @param tempToLocCd
	 */
	public void setTempToLocCd(String tempToLocCd) {
		this.tempToLocCd = tempToLocCd;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setTempToLocCd(JSPUtil.getParameter(request, "temp_to_loc_cd", ""));
	...
	public VskPortDistVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			...
			String[] tempToLocCd = (JSPUtil.getParameter(request, prefix	+ "temp_to_loc_cd".trim(), length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (tempToLocCd[i] != null)
					model.setTempToLocCd(tempToLocCd[i]);
				if (gmtTdHrs[i] != null)
	...
	*/
	public void unDataFormat(){
		...
		this.tempToLocCd = this.tempToLocCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
