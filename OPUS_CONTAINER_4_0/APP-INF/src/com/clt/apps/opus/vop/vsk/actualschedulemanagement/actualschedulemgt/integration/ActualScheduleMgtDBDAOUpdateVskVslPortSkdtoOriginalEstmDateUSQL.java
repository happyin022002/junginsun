...
*@FileName : ActualScheduleMgtDBDAOUpdateVskVslPortSkdtoOriginalEstmDateUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOUpdateVskVslPortSkdtoOriginalEstmDateUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Actual Sked delete시에 original estimate date로 복원
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOUpdateVskVslPortSkdtoOriginalEstmDateUSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOUpdateVskVslPortSkdtoOriginalEstmDateUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
