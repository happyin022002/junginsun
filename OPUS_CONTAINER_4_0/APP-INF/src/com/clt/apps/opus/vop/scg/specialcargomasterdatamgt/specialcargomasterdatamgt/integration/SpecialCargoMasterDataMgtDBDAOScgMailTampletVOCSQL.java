...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgMailTampletVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgMailTampletVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Mail Preview 의 Tamplet 을 생성한다.
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgMailTampletVOCSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgMailTampletVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_EML_TMPLT (" ).append("\n"); 
		...
		query.append(",   AUTO_EML_FLG" ).append("\n"); 
