...
*@FileName : VSKCodeFinderDBDAOPfLaneTypeVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VSKCodeFinderDBDAOPfLaneTypeVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VSKCodeFinderDBDAOPfLaneTypeVORSQL(){
		setQuery();
		...
		query.append("FileName : VSKCodeFinderDBDAOPfLaneTypeVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       , VSK_PF_SKD T1" ).append("\n"); 
