...
*@FileName : SpecialCargoIrregularMgtDBDAOIrrCntrVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoIrregularMgtDBDAOIrrCntrVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SPCL CGO Irregular Container 삭제   
	  * </pre>
	  */
	public SpecialCargoIrregularMgtDBDAOIrrCntrVODSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoIrregularMgtDBDAOIrrCntrVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SCG_IRR_CNTR" ).append("\n"); 
		query.append("WHERE	VSL_CD = @[vsl_cd]" ).append("\n"); 
		query.append("AND	SKD_VOY_NO = @[skd_voy_no]" ).append("\n"); 
		query.append("AND	SKD_DIR_CD = @[skd_dir_cd]" ).append("\n"); 
		query.append("AND	SPCL_CGO_IRR_SEQ = @[spcl_cgo_irr_seq]" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${spcl_cgo_irr_cntr_seq} != '')" ).append("\n"); 
