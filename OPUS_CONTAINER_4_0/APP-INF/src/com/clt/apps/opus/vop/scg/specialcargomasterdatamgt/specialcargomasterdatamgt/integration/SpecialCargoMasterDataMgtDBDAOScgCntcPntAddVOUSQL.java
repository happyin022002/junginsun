...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgCntcPntAddVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgCntcPntAddVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Partner’s Contact Point for TDR/RDR, BAPLE (Creation) 수정   
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgCntcPntAddVOUSQL(){
		setQuery();
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgCntcPntAddVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
