...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileMaxSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileMaxSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Dangerous CGO Application Details for Partner Lines 의 Booking Attach File Max Sequence 조회
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileMaxSeqRSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOScgPrnrAproRqstFileMaxSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 	NVL(MAX(SPCL_CGO_RQST_ATCH_FILE_SEQ),0)+1 SPCL_CGO_RQST_ATCH_FILE_SEQ" ).append("\n"); 
