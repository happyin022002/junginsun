...
*@FileName : VSKCodeFinderDBDAOYardVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VSKCodeFinderDBDAOYardVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VSKCodeFinderDBDAOYardVORSQL(){
		setQuery();
		...
		query.append("FileName : VSKCodeFinderDBDAOYardVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("		, '' AS COUNTRY_CD" ).append("\n"); 
