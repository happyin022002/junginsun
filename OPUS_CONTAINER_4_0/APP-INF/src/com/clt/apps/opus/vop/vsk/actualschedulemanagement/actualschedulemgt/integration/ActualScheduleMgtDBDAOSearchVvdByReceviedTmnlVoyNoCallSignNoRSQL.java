...
*@FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoCallSignNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoCallSignNoRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search VVD of vessel schedule, mapping EDI's call sign no., voyage no., yard code.
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoCallSignNoRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoCallSignNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
