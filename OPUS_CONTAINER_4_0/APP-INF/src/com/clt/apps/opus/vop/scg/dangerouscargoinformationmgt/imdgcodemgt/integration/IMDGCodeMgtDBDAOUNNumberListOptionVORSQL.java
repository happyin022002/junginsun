...
public class IMDGCodeMgtDBDAOUNNumberListOptionVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("	,	A.PRP_SHP_NM_VAR_RMK" ).append("\n"); 
		...
		query.append("    ,   A.N1ST_ADD_SEGR_DESC" ).append("\n"); 
		query.append("    ,   A.N2ND_ADD_SEGR_DESC" ).append("\n"); 
		query.append("    --2016-05-27" ).append("\n"); 
		...
		query.append("	,	TO_CHAR(NVL(GLOBALDATE_PKG.TIME_CONV_FNC(COM_ConstantMgr_PKG.COM_getBaseLocationCode_FNC(),A.UPD_DT,'GMT'),A.UPD_DT),'YYYY-MM-DD HH24:MI') AS UPD_DT" ).append("\n"); 
		...
		query.append("			WHERE VSL_OPR_TP_CD = COM_CONSTANTMGR_PKG.COM_GETCOMPANYCODE_FNC()" ).append("\n"); 
		...
		query.append("    AND (IMDG_AMDT_NO = @[imdg_amdt_no] OR CFR_FLG = 'Y')" ).append("\n"); 
		...
		query.append("	AND	(A.PRP_SHP_NM LIKE '%'||@[imdg_tec_nm]||'%')" ).append("\n"); 
		query.append("#end" ).append("\n"); 
