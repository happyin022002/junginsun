...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOSearchOrgMsgReceiveDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOSearchOrgMsgReceiveDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * IFTMBF 받은 날짜를 찾아와 포맷 변경
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOSearchOrgMsgReceiveDateRSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOSearchOrgMsgReceiveDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(CRE_DT, 'YYYYMMDDHH24MI') ORG_MSG_RCV_DT" ).append("\n"); 
		query.append("   FROM SCG_PRNR_SPCL_CGO_TRSM_HDR" ).append("\n"); 
		query.append("   WHERE TRSM_BND_CD = 'I'" ).append("\n"); 
		query.append("   AND   TO_CHAR(TRSM_DT, 'YYYYMMDD') = @[trsm_dt]" ).append("\n"); 
