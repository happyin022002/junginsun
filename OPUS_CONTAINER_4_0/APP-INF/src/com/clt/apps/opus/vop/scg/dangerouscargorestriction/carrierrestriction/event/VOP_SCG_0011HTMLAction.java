...
*@FileName : VOP_SCG_0011HTMLAction.java
...
public class VOP_SCG_0011HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0011HTMLAction 객체를 생성
	 */
	public VOP_SCG_0011HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0011Event event = new VopScg0011Event();
		

		if(command.isCommand(FormCommand.SEARCH01)) {
			event.setContition( (PortRestrictionOptionVO)getVO(request, PortRestrictionOptionVO .class));
		}
