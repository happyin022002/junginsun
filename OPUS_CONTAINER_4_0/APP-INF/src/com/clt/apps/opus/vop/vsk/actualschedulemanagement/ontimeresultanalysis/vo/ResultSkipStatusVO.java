...
*@FileName : ResultSkipStatusVO.java
*@FileTitle : ResultSkipStatusVO
*Open Issues :
*Change history :
...
public class ResultSkipStatusVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ResultSkipStatusVO> models = new ArrayList<ResultSkipStatusVO>();
	 ...
	 */
	public ResultSkipStatusVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ResultSkipStatusVO[]
	 */
	public ResultSkipStatusVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ResultSkipStatusVO model = null;
	...
	public ResultSkipStatusVO[] getResultSkipStatusVOs(){
		ResultSkipStatusVO[] vos = (ResultSkipStatusVO[])models.toArray(new ResultSkipStatusVO[models.size()]);
		return vos;
	}
