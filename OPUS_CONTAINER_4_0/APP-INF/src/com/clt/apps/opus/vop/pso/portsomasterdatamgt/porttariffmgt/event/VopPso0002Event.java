...
import com.clt.apps.opus.vop.pso.portsomasterdatamgt.porttariffmgt.vo.TariffDiscountVO;
import com.clt.apps.opus.vop.pso.portsomasterdatamgt.porttariffmgt.vo.TariffSurchargeVO;
...
public class VopPso0002Event extends EventSupport {
	...
	private String portCd = "";		//[2009.08.24:jmh]	
	private String vndrSeq = "";	//[2009.08.24:jmh]	
	private String acctCd = "";		//[2009.09.04:jmh]	
	...
	/*New*/
	private TariffBaseVO[] tariffBaseVOs = null;		//Base
	...
	public void setPortTariffCodeGRPVO(PortTariffCodeGRPVO portTariffCodeGRPVO) {
		String ver = portTariffCodeGRPVO.getCombo4();
		portTariffCodeGRPVO.setCombo4( ver.substring( ver.indexOf("_")+1));
