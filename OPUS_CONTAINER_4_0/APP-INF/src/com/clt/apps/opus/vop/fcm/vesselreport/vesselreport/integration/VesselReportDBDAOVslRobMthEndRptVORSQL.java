...
*@FileName : VesselReportDBDAOVslRobMthEndRptVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VesselReportDBDAOVslRobMthEndRptVORSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 주어진 조건에 대한 Lane별 ROB/Month End Report 현황을 조회한다.
	  * </pre>
	  */
	public VesselReportDBDAOVslRobMthEndRptVORSQL(){
		setQuery();
		...
		query.append("FileName : VesselReportDBDAOVslRobMthEndRptVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/**" ).append("\n"); 
		query.append("--VslRobMthEndRptVO" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("'' AS MSS_MTCH_RPT_CNT," ).append("\n"); 
		query.append("'' AS ROB_MTH_END_RPT_CNT," ).append("\n"); 
		query.append("'' AS VSL_SLAN_CD," ).append("\n"); 
		query.append("'' AS MSS_RPT_CNT," ).append("\n"); 
		...
		query.append("    SUM(ROB_MTH_END_RPT_CNT) ROB_MTH_END_RPT_CNT," ).append("\n"); 
		query.append("    SUM(MSS_RPT_CNT) MSS_RPT_CNT," ).append("\n"); 
		query.append("    SUM(MSS_MTCH_RPT_CNT) MSS_MTCH_RPT_CNT" ).append("\n"); 
		query.append("FROM (" ).append("\n"); 
		query.append("    SELECT" ).append("\n"); 
		query.append("        VSL_SLAN_CD," ).append("\n"); 
		query.append("        VSL_CD," ).append("\n"); 
		query.append("        COUNT(*) ROB_MTH_END_RPT_CNT," ).append("\n"); 
		query.append("        SUM(MSS_RPT_CNT) MSS_RPT_CNT," ).append("\n"); 
		...
		query.append("    )" ).append("\n"); 
		query.append("    GROUP BY VSL_SLAN_CD, VSL_CD" ).append("\n"); 
		...
		query.append("        0 ROB_MTH_END_RPT_CNT," ).append("\n"); 
		query.append("        0 MSS_RPT_CNT," ).append("\n"); 
		query.append("        COUNT(*) MSS_MTCH_RPT_CNT" ).append("\n"); 
		...
		query.append(")" ).append("\n"); 
		query.append("GROUP BY VSL_SLAN_CD, VSL_CD" ).append("\n"); 
		query.append("ORDER BY VSL_SLAN_CD, VSL_CD" ).append("\n"); 
