...
*@FileName : TerminalDepartureReportDBDAOTdrBsaVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTdrBsaVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTdrBsaVODSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOTdrBsaVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE 	FROM	TDR_BSA" ).append("\n"); 
