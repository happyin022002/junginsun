...
*@FileName : VOP_VSK_9017HTMLAction.java
*@FileTitle : Vessel Slide
*Open Issues :
*Change history :
...
public class VOP_VSK_9017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0250HTMLAction 객체를 생성
	 */
	public VOP_VSK_9017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk9017Event event = new VopVsk9017Event();
