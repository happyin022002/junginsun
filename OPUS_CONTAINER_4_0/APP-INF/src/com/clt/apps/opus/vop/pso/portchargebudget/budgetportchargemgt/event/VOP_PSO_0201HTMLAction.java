...
*@FileName : VOP_PSO_0201HTMLAction.java
...
public class VOP_PSO_0201HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_PSO_0201HTMLAction 객체를 생성
	 */
	public VOP_PSO_0201HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopPso0201Event event = new VopPso0201Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setBudEstDtlCondVO((BudEstDtlCondVO)getVO(request, BudEstDtlCondVO .class));
		}
