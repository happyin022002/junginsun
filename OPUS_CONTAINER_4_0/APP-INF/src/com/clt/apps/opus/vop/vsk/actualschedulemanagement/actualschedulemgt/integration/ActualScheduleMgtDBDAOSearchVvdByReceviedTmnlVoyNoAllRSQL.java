...
*@FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoAllRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoAllRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search all VVDs of vessel schedule, mapping EDI's vessel code, voyage no., yard code.
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoAllRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedTmnlVoyNoAllRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
