...
*@FileName : GeneralInvoiceAuditDBDAOgetEtbHrRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetEtbHrRSQL implements ISQLTemplate{
	...
	public GeneralInvoiceAuditDBDAOgetEtbHrRSQL(){
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetEtbHrRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(A.VPS_ETB_DT, 'HH24')" ).append("\n"); 
