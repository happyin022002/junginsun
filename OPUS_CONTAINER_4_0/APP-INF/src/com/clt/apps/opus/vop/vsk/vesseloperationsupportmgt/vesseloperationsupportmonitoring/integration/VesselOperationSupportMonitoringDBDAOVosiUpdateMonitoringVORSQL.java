...
public class VesselOperationSupportMonitoringDBDAOVosiUpdateMonitoringVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("      NVL(A.VSKD_PORT_RHQ_CD, MO.AR_HD_QTR_OFC_CD) RHQ, " ).append("\n"); 
		...
		query.append("    WHERE 1=1 --A.VOP_PORT_RHQ_CD IS NOT NULL" ).append("\n"); 
		query.append("      AND NVL(A.DELT_FLG,'N') <> 'Y'" ).append("\n"); 
		query.append("#if (${rhq} != '^') " ).append("\n"); 
		query.append("      --AND A.VOP_PORT_RHQ_CD LIKE [rhq]||'%'" ).append("\n"); 
		query.append("    AND NVL(A.VSKD_PORT_RHQ_CD, MO.AR_HD_QTR_OFC_CD) LIKE @[rhq]||'%'" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${loc_cd} != '') " ).append("\n"); 
		...
		query.append("    ORDER BY NVL(A.VSKD_PORT_RHQ_CD, MO.AR_HD_QTR_OFC_CD)" ).append("\n"); 
		query.append("  )" ).append("\n"); 
