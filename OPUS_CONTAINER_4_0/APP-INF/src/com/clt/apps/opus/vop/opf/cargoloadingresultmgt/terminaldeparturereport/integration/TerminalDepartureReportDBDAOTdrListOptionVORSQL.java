...
public class TerminalDepartureReportDBDAOTdrListOptionVORSQL implements ISQLTemplate{
	...
	public void setQuery(){
		...
		query.append("				TO_CHAR(V.VPS_ETA_DT, 'YYYY-MM-DD HH24:MI')                      ETA," ).append("\n"); 
		query.append("				TO_CHAR(V.VPS_ETB_DT, 'YYYY-MM-DD HH24:MI')                      ETB," ).append("\n"); 
		query.append("				TO_CHAR(V.VPS_ETD_DT , 'YYYY-MM-DD HH24:MI')                     ETD," ).append("\n"); 
