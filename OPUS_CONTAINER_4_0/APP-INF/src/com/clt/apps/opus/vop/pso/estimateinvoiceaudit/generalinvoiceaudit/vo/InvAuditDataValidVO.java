...
public class InvAuditDataValidVO extends AbstractValueObject {
    ...
    //[2010.04.14:jmh]
    /* Column Info */
    private String ioChk = null;

    /* Column Info */
    private String existYn = null;

    /* Column Info */
    private String existIssCtyCd = null;

    /* Column Info */
    private String existSoSeq = null;

    /* Column Info */
    private String existInvNo = null;

    /* Column Info */
    private String existDtlYn = null;

    /* Column Info */
    private String dftIoData = null;
    ...
    /* Column Info */
    private String clptIndSeqs = null;
    ...
    public InvAuditDataValidVO(String ibflag, String pagerows, String vslCd, String skdVoyNo, String skdDirCd, String acctCd, String costCd, String io, String vndrLglEngNm, String lgsCostFullNm, String tariffCost, String adjcost, String amount, String foml1, String foml2, String cond1, String cond2, String remark, String ydChgNo, String ydChgVerSeq, String usrId, String issCtyCd, String soSeq, String soDtlSeq, String ydCd, String vndrSeq, String costOfcCd, String invOfcCd, String invNo, String currCd, String ttlLoclAmt, String ttlUsdAmt, String loclAmt, String loclTaxAmt, String loclNetAmt, String loclDdctAmt, String loclWhldTaxAmt, String acptDt, String issDt, String effDt, String payTermDys, String dueDt, String apEffDt, String psoChgStsCd, String invRgstNo, String atd, String updateflag, String revYrmon, String night, String holiday, String boat, String tugrope, String buoy, String sanitation, String barge, String inspection, String arrtp, String deptp, String arrnt, String depnt, String arrtuh, String deptuh, String arrlh, String deplh, String psoTrnsSlpCtnt, String orgFlg, String budScnrNo, String newservice, String rlaneCd, String usdhrs, String vvd, String credit, String copilot, String invLoclAmt, String delChk, String ioChk, String existYn, String existIssCtyCd, String existSoSeq, String existInvNo, String existDtlYn, String dftIoData, String sdr, String tier, String limitTime, String others, String otherValue, String exeYrmon, String pendFlg, String clptIndSeq, String clptSeq, String clptIndSeqs) {
        ...
        this.existIssCtyCd = existIssCtyCd;
        this.existSoSeq = existSoSeq;
        this.existInvNo = existInvNo;
        this.existDtlYn = existDtlYn;
        this.dftIoData = dftIoData;
        this.sdr = sdr;
        this.tier = tier;
        ...
        this.pendFlg = pendFlg;
        this.clptIndSeq = clptIndSeq;
        this.clptSeq = clptSeq;
        this.clptIndSeqs = clptIndSeqs;
    }
    ...
    public HashMap<String, String> getColumnValues() {
        ...
        this.hashColumns.put("exist_yn", getExistYn());
        this.hashColumns.put("exist_iss_cty_cd", getExistIssCtyCd());
        this.hashColumns.put("exist_so_seq", getExistSoSeq());
        this.hashColumns.put("exist_inv_no", getExistInvNo());
        this.hashColumns.put("exist_dtl_yn", getExistDtlYn());
        this.hashColumns.put("dft_io_data", getDftIoData());
        this.hashColumns.put("sdr", getSdr());
        this.hashColumns.put("tier", getTier());
        this.hashColumns.put("limit_time", getLimitTime());
        this.hashColumns.put("others", getOthers());
        this.hashColumns.put("other_value", getOtherValue());
        this.hashColumns.put("exe_yrmon", getExeYrmon());
        this.hashColumns.put("pend_flg", getPendFlg());
        this.hashColumns.put("clpt_ind_seq", getClptIndSeq());
        this.hashColumns.put("clpt_seq", getClptSeq());
        this.hashColumns.put("clpt_ind_seqs", getClptIndSeqs());
    ...
    public HashMap<String, String> getFieldNames() {
        ...
        this.hashFields.put("exist_yn", "existYn");
        this.hashFields.put("exist_iss_cty_cd", "existIssCtyCd");
        this.hashFields.put("exist_so_seq", "existSoSeq");
        this.hashFields.put("exist_inv_no", "existInvNo");
        this.hashFields.put("exist_dtl_yn", "existDtlYn");
        this.hashFields.put("dft_io_data", "dftIoData");
        this.hashFields.put("sdr", "sdr");
        this.hashFields.put("tier", "tier");
        this.hashFields.put("limit_time", "limitTime");
        this.hashFields.put("others", "others");
        this.hashFields.put("other_value", "otherValue");
        this.hashFields.put("exe_yrmon", "exeYrmon");
        this.hashFields.put("pend_flg", "pendFlg");
        this.hashFields.put("clpt_ind_seq", "clptIndSeq");
        this.hashFields.put("clpt_seq", "clptSeq");
        this.hashFields.put("clpt_ind_seqs", "clptIndSeqs");
    ...
    public void setExistIssCtyCd(String existIssCtyCd) {
        this.existIssCtyCd = existIssCtyCd;
    }

    public String getExistIssCtyCd() {
        return this.existIssCtyCd;
    }

    public void setExistSoSeq(String existSoSeq) {
        this.existSoSeq = existSoSeq;
    }

    public String getExistSoSeq() {
        return this.existSoSeq;
    }

    public void setExistInvNo(String existInvNo) {
        this.existInvNo = existInvNo;
    }

    public String getExistInvNo() {
        return this.existInvNo;
    }
    ...
    public void setDftIoData(String dftIoData) {
        this.dftIoData = dftIoData;
    }

    public String getDftIoData() {
        return this.dftIoData;
    }
    ...
    public void setPendFlg(String pendFlg) {
        this.pendFlg = pendFlg;
    }

    public String getPendFlg() {
        return this.pendFlg;
    }
    ...
    public void setClptIndSeqs(String clptIndSeqs) {
        this.clptIndSeqs = clptIndSeqs;
    }

    public String getClptIndSeqs() {
        return this.clptIndSeqs;
    }
    ...
    public void fromRequest(HttpServletRequest request, String prefix) {
        ...
        setExistYn(JSPUtil.getParameter(request, prefix + "exist_yn", ""));
        setExistIssCtyCd(JSPUtil.getParameter(request, prefix + "exist_iss_cty_cd", ""));
        setExistSoSeq(JSPUtil.getParameter(request, prefix + "exist_so_seq", ""));
        setExistInvNo(JSPUtil.getParameter(request, prefix + "exist_inv_no", ""));
        setExistDtlYn(JSPUtil.getParameter(request, prefix + "exist_dtl_yn", ""));
        setDftIoData(JSPUtil.getParameter(request, prefix + "dft_io_data", ""));
        setSdr(JSPUtil.getParameter(request, prefix + "sdr", ""));
        setTier(JSPUtil.getParameter(request, prefix + "tier", ""));
        setLimitTime(JSPUtil.getParameter(request, prefix + "limit_time", ""));
        setOthers(JSPUtil.getParameter(request, prefix + "others", ""));
        setOtherValue(JSPUtil.getParameter(request, prefix + "other_value", ""));
        setExeYrmon(JSPUtil.getParameter(request, prefix + "exe_yrmon", ""));
        setPendFlg(JSPUtil.getParameter(request, prefix + "pend_flg", ""));
        setClptIndSeq(JSPUtil.getParameter(request, prefix + "clpt_ind_seq", ""));
        setClptSeq(JSPUtil.getParameter(request, prefix + "clpt_seq", ""));
        setClptIndSeqs(JSPUtil.getParameter(request, prefix + "clpt_ind_seqs", ""));
    }
    ...
    public InvAuditDataValidVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
        ...
        try {
            ...
            String[] existYn = (JSPUtil.getParameter(request, prefix + "exist_yn", length));
            String[] existIssCtyCd = (JSPUtil.getParameter(request, prefix + "exist_iss_cty_cd", length));
            String[] existSoSeq = (JSPUtil.getParameter(request, prefix + "exist_so_seq", length));
            String[] existInvNo = (JSPUtil.getParameter(request, prefix + "exist_inv_no", length));
            String[] existDtlYn = (JSPUtil.getParameter(request, prefix + "exist_dtl_yn", length));
            String[] dftIoData = (JSPUtil.getParameter(request, prefix + "dft_io_data", length));
            String[] sdr = (JSPUtil.getParameter(request, prefix + "sdr", length));
            String[] tier = (JSPUtil.getParameter(request, prefix + "tier", length));
            String[] limitTime = (JSPUtil.getParameter(request, prefix + "limit_time", length));
            String[] others = (JSPUtil.getParameter(request, prefix + "others", length));
            String[] otherValue = (JSPUtil.getParameter(request, prefix + "other_value", length));
            String[] exeYrmon = (JSPUtil.getParameter(request, prefix + "exe_yrmon", length));
            String[] pendFlg = (JSPUtil.getParameter(request, prefix + "pend_flg", length));
            String[] clptIndSeq = (JSPUtil.getParameter(request, prefix + "clpt_ind_seq", length));
            String[] clptSeq = (JSPUtil.getParameter(request, prefix + "clpt_seq", length));
            String[] clptIndSeqs = (JSPUtil.getParameter(request, prefix + "clpt_ind_seqs", length));
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (existYn[i] != null)
                    model.setExistYn(existYn[i]);
                if (existIssCtyCd[i] != null)
                    model.setExistIssCtyCd(existIssCtyCd[i]);
                if (existSoSeq[i] != null)
                    model.setExistSoSeq(existSoSeq[i]);
                if (existInvNo[i] != null)
                    model.setExistInvNo(existInvNo[i]);
                if (existDtlYn[i] != null)
                    model.setExistDtlYn(existDtlYn[i]);
                if (dftIoData[i] != null)
                    model.setDftIoData(dftIoData[i]);
                if (sdr[i] != null)
                    model.setSdr(sdr[i]);
                if (tier[i] != null)
                    model.setTier(tier[i]);
                if (limitTime[i] != null)
                    model.setLimitTime(limitTime[i]);
                if (others[i] != null)
                    model.setOthers(others[i]);
                if (otherValue[i] != null)
                    model.setOtherValue(otherValue[i]);
                if (exeYrmon[i] != null)
                    model.setExeYrmon(exeYrmon[i]);
                if (pendFlg[i] != null)
                    model.setPendFlg(pendFlg[i]);
                if (clptIndSeq[i] != null)
                    model.setClptIndSeq(clptIndSeq[i]);
                if (clptSeq[i] != null)
                    model.setClptSeq(clptSeq[i]);
                if (clptIndSeqs[i] != null) 
		    		model.setClptIndSeqs(clptIndSeqs[i]);
	...
	*/
    public void unDataFormat() {
        ...
        this.existYn = this.existYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.existIssCtyCd = this.existIssCtyCd.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.existSoSeq = this.existSoSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.existInvNo = this.existInvNo.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.existDtlYn = this.existDtlYn.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.dftIoData = this.dftIoData.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        ...
        this.limitTime = this.limitTime.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.others = this.others.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.otherValue = this.otherValue.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.exeYrmon = this.exeYrmon.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.pendFlg = this.pendFlg.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.clptIndSeq = this.clptIndSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.clptSeq = this.clptSeq.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
        this.clptIndSeqs = this.clptIndSeqs.replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
    }
