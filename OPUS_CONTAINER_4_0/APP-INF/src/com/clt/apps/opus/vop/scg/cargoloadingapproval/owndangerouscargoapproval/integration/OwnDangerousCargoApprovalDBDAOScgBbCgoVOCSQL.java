...
*@FileName : OwnDangerousCargoApprovalDBDAOScgBbCgoVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgBbCgoVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * BKG_BB_CGO에서 SCG_BB_CGO으로 DATA 복제
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgBbCgoVOCSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgBbCgoVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_BB_CGO (" ).append("\n"); 
		...
		query.append(",	(	SELECT MAX(SPCL_CGO_APRO_RQST_SEQ) FROM SCG_APRO_RQST WHERE BKG_NO = @[bkg_no] AND SPCL_CGO_CATE_CD = 'BB'	)" ).append("\n"); 
		...
		query.append("AND BB_CGO_SEQ = @[cgo_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
