...
*@FileName : GeneralInvoiceAuditDBDAOgetEtaMonthRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetEtaMonthRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetEtaMonthRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetEtaMonthRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_NUMBER (TO_CHAR (A.VPS_ETA_DT, 'MM'), '00')" ).append("\n"); 
