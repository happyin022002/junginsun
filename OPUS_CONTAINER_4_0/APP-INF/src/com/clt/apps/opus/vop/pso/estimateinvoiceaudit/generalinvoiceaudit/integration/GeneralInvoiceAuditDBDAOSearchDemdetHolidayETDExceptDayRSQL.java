...
*@FileName : GeneralInvoiceAuditDBDAOSearchDemdetHolidayETDExceptDayRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOSearchDemdetHolidayETDExceptDayRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOSearchDemdetHolidayETDExceptDayRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOSearchDemdetHolidayETDExceptDayRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                 WHERE D.HOL_YR         = TO_CHAR(V.VPS_ETD_DT, 'YYYY')" ).append("\n"); 
