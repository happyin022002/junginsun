...
*@FileName : InterfaceScheduleToExternalDBDAOModifyInterfaceStatusforInclOldVoyageUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InterfaceScheduleToExternalDBDAOModifyInterfaceStatusforInclOldVoyageUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InterfaceScheduleToExternalDBDAOModifyInterfaceStatusforInclOldVoyageUSQL(){
		setQuery();
		...
		query.append("FileName : InterfaceScheduleToExternalDBDAOModifyInterfaceStatusforInclOldVoyageUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET       X.VIPS_IF_TGT_FLG         = NVL(@[vips_if_tgt_flg],X.VIPS_IF_TGT_FLG	)" ).append("\n"); 
		query.append("	   ,  X.INSF_DV_CD				= NVL(@[insf_dv_cd]		,X.INSF_DV_CD		)" ).append("\n"); 
