 ...
 *@FileName : ScgPrnrSpclCgoDtlErrVO.java
 *@FileTitle : ScgPrnrSpclCgoDtlErrVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class ScgPrnrSpclCgoDtlErrVO	extends	 AbstractValueObject {

	private	 static final long serialVersionUID = 1L;

	private	 Collection<ScgPrnrSpclCgoDtlErrVO>  models =	new	ArrayList<ScgPrnrSpclCgoDtlErrVO>();
	...
	/**	Constructor	*/
	public ScgPrnrSpclCgoDtlErrVO(){}

	public ScgPrnrSpclCgoDtlErrVO(String ibflag,String pagerows,String trsmBndCd,String trsmDt,String spclCgoCateCd,String prnrSpclCgoSeq,String prnrSpclCgoSubSeq,String errDtlSeq,String errKndCd,String errDtlCd,String apErrCd,String errDtlRmk,String errLvl,String creUsrId,String creDt,String updUsrId,String updDt)	{
		this.ibflag = ibflag;
	 ...
	 * @param request
	 * @return ScgPrnrSpclCgoDtlErrVO[]
	 */
	public ScgPrnrSpclCgoDtlErrVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return ScgPrnrSpclCgoDtlErrVO[]
	 */
	public ScgPrnrSpclCgoDtlErrVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		ScgPrnrSpclCgoDtlErrVO model = null;
		...
		try	{
			...
			for	(int i = 0;	i <	length;	i++) {
				model =	new	ScgPrnrSpclCgoDtlErrVO();
				if ( ibflag[i] !=	null)
		...
		return getScgPrnrSpclCgoDtlErrVOs();
	}
	 ...
	 * @return ScgPrnrSpclCgoDtlErrVO[]
	 */
	public ScgPrnrSpclCgoDtlErrVO[]	 getScgPrnrSpclCgoDtlErrVOs(){
		ScgPrnrSpclCgoDtlErrVO[] vos = (ScgPrnrSpclCgoDtlErrVO[])models.toArray(new	ScgPrnrSpclCgoDtlErrVO[models.size()]);
		return vos;
	}
