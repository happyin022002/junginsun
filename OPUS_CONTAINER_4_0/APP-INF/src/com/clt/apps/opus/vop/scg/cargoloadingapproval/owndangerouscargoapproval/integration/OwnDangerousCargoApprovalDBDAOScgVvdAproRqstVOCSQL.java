...
*@FileName : OwnDangerousCargoApprovalDBDAOScgVvdAproRqstVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgVvdAproRqstVOCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Booking으로 부터 SCG_VVD_APRO_RQST를 생성한다.
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgVvdAproRqstVOCSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgVvdAproRqstVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_VVD_APRO_RQST (" ).append("\n"); 
		...
		query.append("	@[slan_cd]" ).append("\n"); 
		query.append(",	@[bkg_no]" ).append("\n"); 
		query.append(",(	SELECT NVL(MAX(SPCL_CGO_APRO_RQST_SEQ),1) FROM SCG_APRO_RQST WHERE BKG_NO = @[bkg_no]	)" ).append("\n"); 
		query.append(",	@[vsl_pre_pst_cd]" ).append("\n"); 
		query.append(",	@[vsl_seq]" ).append("\n"); 
		query.append(",	@[vsl_cd]" ).append("\n"); 
		query.append(",	@[skd_voy_no]" ).append("\n"); 
