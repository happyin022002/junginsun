...
public class VOP_VSK_0504HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0504HTMLAction 객체를 생성
	 */
	public VOP_VSK_0504HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			event.setVskPortCnlTrScgVOS((VskPortCnlTrScgVO[])getVOs(request, VskPortCnlTrScgVO .class,"t5sheet3_"));
		}
