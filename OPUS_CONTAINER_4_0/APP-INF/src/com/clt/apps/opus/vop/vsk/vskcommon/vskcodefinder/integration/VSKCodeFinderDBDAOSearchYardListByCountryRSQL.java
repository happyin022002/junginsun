...
*@FileName : VSKCodeFinderDBDAOSearchYardListByCountryRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class VSKCodeFinderDBDAOSearchYardListByCountryRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public VSKCodeFinderDBDAOSearchYardListByCountryRSQL(){
		setQuery();
		...
		query.append("FileName : VSKCodeFinderDBDAOSearchYardListByCountryRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND		LOC_CD LIKE @[country_cd] || '%'" ).append("\n"); 
