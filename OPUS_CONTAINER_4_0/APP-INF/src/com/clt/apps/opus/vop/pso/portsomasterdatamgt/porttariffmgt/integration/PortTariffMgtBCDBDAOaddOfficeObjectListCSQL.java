...
*@FileName : PortTariffMgtBCDBDAOaddOfficeObjectListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortTariffMgtBCDBDAOaddOfficeObjectListCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortTariffMgtBCDBDAOaddOfficeObjectListCSQL(){
		setQuery();
		...
		params.put("rn",new String[]{arrTmp[0],arrTmp[1]});
	...
	public void setQuery(){
		query.append("insert into pso_inv_ofc_obj_list (" ).append("\n"); 
		query.append("ofc_cd," ).append("\n"); 
		query.append("obj_list_no," ).append("\n"); 
		query.append("row_no," ).append("\n"); 
		query.append("obj_list_seq," ).append("\n"); 
		...
		query.append("FileName : PortTariffMgtBCDBDAOaddOfficeObjectListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}