 ...
 *@LastVersion : 1.0
=========================================================*/
package com.clt.apps.opus.vop.scg.dangerouscargorestriction.portrestriction.basic;
...
import com.clt.apps.opus.vop.scg.dangerouscargorestriction.portrestriction.vo.SearchScgImdgPortRstrDtlVO;
 ...
 * 
 * @author
 * @see VOP_SCG_0005EventResponse,PortRestrictionBC
 * @since J2EE 1.6
 */
public class PortRestrictionBCImpl extends BasicCommandSupport implements
    ...
    /**
     * PortRestrictionBCImpl object creation<br>
     * PortRestrictionDBDAO creation<br>
     */
    ...
    /**
     * 
     * Port Restriction save process <br>
     * 
    ...
    public String managePortRestriction(VopScg004ContainVO vopScg004ContainVO,
        ...
        try {
            ...
            /*****************************************************************************************
             * SCG_IMDG_PORT_RSTR - Prohibition handling Sheet 1
             *****************************************************************************************/
            ...
            /************************When SEQ doesn't exist, register mode *******************************/
            if (condition.getImdgPortRstrSeq().equals("")) {
                ...
                if (checList.size() != 0) {
                    throw new EventException(new ErrorHandler("SCG50005",
                            new String[] { "Data" }).getMessage());//duplicated data exist.
                }
            ...
            /*****************************************************************************************
             * SCG_IMDG_PORT_RSTR, SCG_IMDG_PORT_RSTR_DTL - Direct Load handling Sheet
             * 5
             *****************************************************************************************/
            ...
            scgImdgPortRstrDtlVO.setStoDys(directLosdScgImdgPortRstrVOs[0]
                    .getStoDys());
            /*****************************************************************************************
             * SCG_IMDG_PORT_RSTR_DTL - Competent Authority handling Sheet 2
             *****************************************************************************************/
 
            /*****************************************************************************************
             * SCG_IMDG_PORT_RSTR_DTL - Max. Quantity handling Sheet 3
             *****************************************************************************************/
            ...
            /**************************************************************************
             * SCG_IMDG_PORT_RSTR_DTL handling
             * 
             **************************************************************************/
            ...
            /*****************************************************************************************
             * SCG_IMDG_PORT_RSTR_DTL - Text Explanation handling Sheet 4
             *****************************************************************************************/
            ...
            for (int i = 0; i < aPortProhiTpCd.length; i++) {
                // if( PortProhiTpCd[i].equals("Y")){ continue;}//restricted items
    ...
    /**
     * 
     * Port Restriction detail retrieve <br>
     * 
     * @param  PortRestrictonOptionVO portRestrictonOptionVO
    ...
    /**
     * 
     * Port Restriction delete process <br>
     * 
     * @param  PortRestrictonOptionVO portRestrictonOptionVO
     * @throws DAOException
     * @throws EventException
    ...
    /**
     * Class Cd retrieve by UnNo, Seq <br>
     * 
     * @param  String unno
     * @param  String seq
     * @return String[]
    ...
    /**
     * Port Restriction Save As process<br>
     * 
    ...
    public int managePortRestrictionSaveAs(PortRestrictionVO portRestrictionVO,PortRestrictionVO[] portRestrictionVOs,SignOnUserAccount signOnUserAccount) throws EventException {
        ...
        try {
            ...
            /******** data checking by portcd or class code, and error when exist ****************/
...
//                                new String[] { "Data" }).getMessage());
            ...
            /******** data checking by portcd, class, Unno, Unno Seq code, and error when exist ****************/
        ...
        try {
        	if( portRestrictonOptionVO.getOptclass().equals("class") ){
                ...
                if(portRestrictonOptionVO.getImdgUnNo().equals("")){
                    ...
                    //UNNO retrieve select AND UNNO KEY-IN
