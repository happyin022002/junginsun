...
/**
 * HTTP Parser<br>
 * - VOP_FCM_0052 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class VOP_FCM_0053HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;

	/**
	 * VOP_FCM_0053HTMLAction 객체를 생성
	 */
	public VOP_FCM_0053HTMLAction() {
	}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopFcm0053Event event = new VopFcm0053Event();
