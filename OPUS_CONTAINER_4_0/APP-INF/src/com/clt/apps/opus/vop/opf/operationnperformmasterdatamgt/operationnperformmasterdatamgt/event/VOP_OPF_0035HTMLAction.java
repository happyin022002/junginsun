...
*@FileName : VOP_OPF_0034HTMLAction.java
...
public class VOP_OPF_0035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_OPF_0034HTMLAction 객체를 생성
	 */
	public VOP_OPF_0035HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopOpf0035Event event = new VopOpf0035Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setOpfCodRjctCdVOS((OpfCodRjctCdVO[])getVOs(request, OpfCodRjctCdVO .class));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setOpfCodRjctCdVO((OpfCodRjctCdVO)getVO(request, OpfCodRjctCdVO .class));
		}
