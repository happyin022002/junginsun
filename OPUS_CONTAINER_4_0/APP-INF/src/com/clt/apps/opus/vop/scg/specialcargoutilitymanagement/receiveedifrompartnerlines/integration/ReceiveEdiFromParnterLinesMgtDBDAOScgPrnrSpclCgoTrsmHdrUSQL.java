...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrSpclCgoTrsmHdrUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrSpclCgoTrsmHdrUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrSpclCgoTrsmHdrUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOScgPrnrSpclCgoTrsmHdrUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SCG_PRNR_SPCL_CGO_TRSM_HDR" ).append("\n"); 
		query.append("   SET LST_TRSM_STS_CD   = @[lst_trsm_sts_cd]" ).append("\n"); 
		query.append("     , ERR_KND_CD        = @[err_knd_cd]" ).append("\n"); 
