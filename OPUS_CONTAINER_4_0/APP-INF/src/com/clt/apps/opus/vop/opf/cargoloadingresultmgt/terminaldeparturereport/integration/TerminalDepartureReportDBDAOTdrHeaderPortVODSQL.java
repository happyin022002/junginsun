...
*@FileName : TerminalDepartureReportDBDAOTdrHeaderPortVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TerminalDepartureReportDBDAOTdrHeaderPortVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TerminalDepartureReportDBDAOTdrHeaderPortVODSQL(){
		setQuery();
		...
		query.append("FileName : TerminalDepartureReportDBDAOTdrHeaderPortVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM TDR_HEADER" ).append("\n"); 
