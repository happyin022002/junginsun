...
*@FileName : TrendLineDBDAOFcmTrndLineVOPopupRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class TrendLineDBDAOFcmTrndLineVOPopupRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public TrendLineDBDAOFcmTrndLineVOPopupRSQL(){
		setQuery();
		...
		query.append("FileName : TrendLineDBDAOFcmTrndLineVOPopupRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("/* Trend Line 정보를 조회한다 */" ).append("\n"); 
		query.append("SELECT" ).append("\n"); 
		query.append("TRND_LINE_USE_TP_CD||'-'||TRND_LINE_TP_CD||'-'||VSL_CLSS_CD||VSL_CLSS_SUB_CD||DECODE(VSL_SLAN_CD,'A','ALL',VSL_SLAN_CD)||VSL_CD" ).append("\n"); 
		query.append("  ||DECODE(SKD_DIR_CD,'A','ALL',SKD_DIR_CD)||'-'||TO_CHAR(CRE_DT, 'YYMM')||TRND_LINE_TP_SUB_CD TRND_LINE_NO," ).append("\n"); 
		...
		query.append("DECODE(VSL_SLAN_CD,'A','ALL',VSL_SLAN_CD) VSL_SLAN_CD," ).append("\n"); 
		query.append("VSL_CD," ).append("\n"); 
		query.append("DECODE(SKD_DIR_CD,'A','ALL',SKD_DIR_CD) SKD_DIR_CD," ).append("\n"); 
		...
		query.append("AND CRE_DT BETWEEN REPLACE(@[trnd_line_fm_dt], '-', '') AND REPLACE(@[trnd_line_to_dt], '-', '')" ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append("ORDER BY TRND_LINE_SEQ desc" ).append("\n"); 
