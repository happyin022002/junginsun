...
*@FileName : ReceiveEdiFromParnterLinesMgtDBDAOModifyPartnerDGEdiforPreRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReceiveEdiFromParnterLinesMgtDBDAOModifyPartnerDGEdiforPreRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReceiveEdiFromParnterLinesMgtDBDAOModifyPartnerDGEdiforPreRqstUSQL(){
		setQuery();
		...
		query.append("FileName : ReceiveEdiFromParnterLinesMgtDBDAOModifyPartnerDGEdiforPreRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--AND   X.SPCL_CGO_CATE_CD				= [spcl_cgo_cate_cd] " ).append("\n"); 
