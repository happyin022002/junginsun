...
*@FileName : PortLimitManagmentDBDAOSearchPortLimitsSubRskRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortLimitManagmentDBDAOSearchPortLimitsSubRskRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 관리 Port별 Port Limits SubRsk 정보를 조회한다.
	  * </pre>
	  */
	public PortLimitManagmentDBDAOSearchPortLimitsSubRskRSQL(){
		setQuery();
		...
		query.append("FileName : PortLimitManagmentDBDAOSearchPortLimitsSubRskRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM  SCG_IMDG_PORT_LMT_SUBS_RSK A" ).append("\n"); 
		...
		query.append("               )" ).append("\n"); 
		query.append("ORDER BY A.IMDG_SUBS_RSK_LBL_CD" ).append("\n"); 
