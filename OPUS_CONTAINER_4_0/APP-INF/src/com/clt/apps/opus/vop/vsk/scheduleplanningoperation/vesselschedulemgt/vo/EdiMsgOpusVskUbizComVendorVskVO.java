...
*@FileName : EdiMsgOpusVskUbizComVendorVskVO
*@FileTitle : EdiMsgOpusVskUbizComVendorVskVO
*Open Issues :
*Change history :
...
public class EdiMsgOpusVskUbizComVendorVskVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<EdiMsgOpusVskUbizComVendorVskVO> models = new ArrayList<EdiMsgOpusVskUbizComVendorVskVO>();
	 ...
	 * @param request
	 * @return EdiMsgOpusVskUbizComVendorVskVO[]
	 */
	public EdiMsgOpusVskUbizComVendorVskVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return EdiMsgOpusVskUbizComVendorVskVO[]
	 */
	public EdiMsgOpusVskUbizComVendorVskVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		EdiMsgOpusVskUbizComVendorVskVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new EdiMsgOpusVskUbizComVendorVskVO();
				if (laneCd[i] != null)
		...
		return getEdiMsgOpusVskUbizComVendorVskVOs();
	}
	 ...
	 * @return EdiMsgOpusVskUbizComVendorVskVO[]
	 */
	public EdiMsgOpusVskUbizComVendorVskVO[] getEdiMsgOpusVskUbizComVendorVskVOs(){
		EdiMsgOpusVskUbizComVendorVskVO[] vos = (EdiMsgOpusVskUbizComVendorVskVO[])models.toArray(new EdiMsgOpusVskUbizComVendorVskVO[models.size()]);
		return vos;
	}
