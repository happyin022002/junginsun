...
*@FileName : SCGExternalFinderDBDAOCheckCarrierRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SCGExternalFinderDBDAOCheckCarrierRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public SCGExternalFinderDBDAOCheckCarrierRSQL(){
		setQuery();
		...
		query.append("FileName : SCGExternalFinderDBDAOCheckCarrierRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
