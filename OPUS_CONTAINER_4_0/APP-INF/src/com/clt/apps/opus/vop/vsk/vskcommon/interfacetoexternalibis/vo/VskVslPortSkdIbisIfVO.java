...
*@FileName : VskVslPortSkdIbisIfVO.java
*@FileTitle : VskVslPortSkdIbisIfVO
*Open Issues :
*Change history :
...
public class VskVslPortSkdIbisIfVO extends AbstractValueObject {

private static final long serialVersionUID = 1L;
	
	private Collection<VskVslPortSkdIbisIfVO> models = new ArrayList<VskVslPortSkdIbisIfVO>();
...
/**
	 ...
	 * @param request
	 * @return VskVslPortSkdIbisIfVO[]
	 */
	public VskVslPortSkdIbisIfVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VskVslPortSkdIbisIfVO[]
	 */
	public VskVslPortSkdIbisIfVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VskVslPortSkdIbisIfVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new VskVslPortSkdIbisIfVO();
				if (ofcInpFlg[i] != null)
		...
		return getVskVslPortSkdIbisIfVOs();
	}
	 ...
	 * @return VskVslPortSkdIbisIfVO[]
	 */
	public VskVslPortSkdIbisIfVO[] getVskVslPortSkdIbisIfVOs(){
		VskVslPortSkdIbisIfVO[] vos = (VskVslPortSkdIbisIfVO[])models.toArray(new VskVslPortSkdIbisIfVO[models.size()]);
		return vos;
	}
