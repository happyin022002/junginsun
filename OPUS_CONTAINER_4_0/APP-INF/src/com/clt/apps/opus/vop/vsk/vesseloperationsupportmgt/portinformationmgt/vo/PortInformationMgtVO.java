...
*@FileName : PortInformationMgtVO.java
*@FileTitle : PortInformationMgtVO
*Open Issues :
*Change history :
...
public class PortInformationMgtVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PortInformationMgtVO> models = new ArrayList<PortInformationMgtVO>();
	...
	public PortInformationMgtVO() {}

	public PortInformationMgtVO(String ibflag, String pagerows, String ydCd, String ydNm, String alsdCd, String chnlDpth, String brthDpth, String atDrftDpth, String maxDrftDpth, String adLen, String brthLen, String turnBsnLen, String pltMnvrDist, String pltMnvrTmHrs, String mnvrRmk, String creUsrId, String creDt, String updUsrId, String updDt, String tempYdCd) {
		this.updDt = updDt;
		this.adLen = adLen;
	 ...
	 */
	public PortInformationMgtVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PortInformationMgtVO[]
	 */
	public PortInformationMgtVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PortInformationMgtVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new PortInformationMgtVO();
				if (updDt[i] != null)
		...
		return getPortInformationMgtVOs();
	}
	...
	public PortInformationMgtVO[] getPortInformationMgtVOs(){
		PortInformationMgtVO[] vos = (PortInformationMgtVO[])models.toArray(new PortInformationMgtVO[models.size()]);
		return vos;
	}
