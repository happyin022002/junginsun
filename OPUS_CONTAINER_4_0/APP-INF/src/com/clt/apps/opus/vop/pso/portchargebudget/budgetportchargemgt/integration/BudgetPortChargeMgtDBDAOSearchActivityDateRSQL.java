...
*@FileName : BudgetPortChargeMgtDBDAOSearchActivityDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class BudgetPortChargeMgtDBDAOSearchActivityDateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public BudgetPortChargeMgtDBDAOSearchActivityDateRSQL(){
		setQuery();
		...
		query.append("FileName : BudgetPortChargeMgtDBDAOSearchActivityDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT TO_CHAR(T5.VPS_ETD_DT,'YYYYMMDD') AS VPS_ETD_DT" ).append("\n"); 
		...
		query.append("   AND T5.CLPT_IND_SEQ = NVL(@[clpt_ind_seq],(  SELECT MIN(CLPT_IND_SEQ)" ).append("\n"); 
		query.append("                              FROM VSK_VSL_PORT_SKD S" ).append("\n"); 
		query.append("                             WHERE S.VSL_CD = T5.VSL_CD" ).append("\n"); 
		query.append("                               AND S.SKD_VOY_NO = T5.SKD_VOY_NO" ).append("\n"); 
		query.append("                               AND S.SKD_DIR_CD = T5.SKD_DIR_CD" ).append("\n"); 
		query.append("                               AND S.YD_CD = T5.YD_CD" ).append("\n"); 
		query.append("                               AND 'S' != NVL(S.SKD_CNG_STS_CD, ' ')" ).append("\n"); 
		query.append("							   AND NVL(S.VT_ADD_CALL_FLG, 'N') = 'N' /*2015.07.21 Add*/ ))" ).append("\n"); 
