...
*@FileName : VOP_SCG_5822HTMLAction.java
...
public class VOP_SCG_5822HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_5822HTMLAction 객체를 생성
	 */
	public VOP_SCG_5822HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg5822Event event = new VopScg5822Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgPrnrRequestListOptionVO((ScgPrnrRequestListOptionVO)getVO(request, ScgPrnrRequestListOptionVO .class));
		}
		else if(command.isCommand(FormCommand.MULTI)) {
			event.setScgPrnrRequestListOptionVOS((ScgPrnrRequestListOptionVO[])getVOs(request, ScgPrnrRequestListOptionVO .class,""));
		}
