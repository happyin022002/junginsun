...
*@FileName : GeneralInvoiceAuditDBDAOgetOutboundTonRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class GeneralInvoiceAuditDBDAOgetOutboundTonRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public GeneralInvoiceAuditDBDAOgetOutboundTonRSQL(){
		setQuery();
		...
		query.append("FileName : GeneralInvoiceAuditDBDAOgetOutboundTonRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
