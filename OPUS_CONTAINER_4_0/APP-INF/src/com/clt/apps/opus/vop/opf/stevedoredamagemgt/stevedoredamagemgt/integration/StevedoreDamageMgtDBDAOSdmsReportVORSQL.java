...
*@FileName : StevedoreDamageMgtDBDAOSdmsReportVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StevedoreDamageMgtDBDAOSdmsReportVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StevedoreDamageMgtDBDAOSdmsReportVORSQL(){
		setQuery();
		...
		query.append("FileName : StevedoreDamageMgtDBDAOSdmsReportVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("NVL(DECODE(COUNT(D.STV_DMG_NO),0,0,ROUND(SUM(DECODE(D.STV_DMG_RESPB_PTY_KWN_FLG,'N',1,0)) /" ).append("\n"); 
		query.append("COUNT(D.STV_DMG_NO),2)),0)                                                               AS RAT_UNKNOWN," ).append("\n"); 
		query.append("NVL(DECODE(COUNT(D.STV_DMG_NO),0,0,ROUND(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'C',1,0)) /" ).append("\n"); 
		query.append("COUNT(D.STV_DMG_NO),2)),0)                                                               AS RAT_REP," ).append("\n"); 
		query.append("NVL(DECODE(COUNT(D.STV_DMG_NO),0,0,ROUND(SUM(DECODE(C.STV_DMG_CMPN_PROC_STS_CD,'P',1,0)) /" ).append("\n"); 
		query.append("COUNT(D.STV_DMG_NO),2)),0)                                                               AS RAT_COMP," ).append("\n"); 
		query.append("NVL(DECODE(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q','0',R.RPR_COST_USD_AMT)) +" ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q',R.QTTN_COST_USD_AMT,0)),0,0," ).append("\n"); 
		query.append("ROUND(SUM(DECODE(C.STV_DMG_CMPN_PROC_STS_CD,'P',C.CMPN_COST_USD_AMT,0)) /" ).append("\n"); 
		query.append("(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q','0',R.RPR_COST_USD_AMT)) +" ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q',R.QTTN_COST_USD_AMT,0))),2)),0)            AS RAT_AMT_COMP," ).append("\n"); 
		query.append("NVL(DECODE(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q','0',R.RPR_COST_USD_AMT)) +" ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q',R.QTTN_COST_USD_AMT,0)),0,0," ).append("\n"); 
		query.append("ROUND(SUM(DECODE(S.STV_DMG_STL_PROC_STS_CD,'P',S.PAY_USD_AMT,0)) /" ).append("\n"); 
		query.append("(SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q','0',R.RPR_COST_USD_AMT)) +" ).append("\n"); 
		query.append("SUM(DECODE(R.STV_DMG_RPR_PROC_STS_CD,'Q',R.QTTN_COST_USD_AMT,0))),2)),0)            AS RAT_BILL_AMT" ).append("\n"); 
