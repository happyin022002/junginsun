...
*@FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVODSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Packaging Code (Creation) 삭제   
	  * </pre>
	  */
	public SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVODSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append("FileName : SpecialCargoMasterDataMgtDBDAOScgImdgPckCdVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}