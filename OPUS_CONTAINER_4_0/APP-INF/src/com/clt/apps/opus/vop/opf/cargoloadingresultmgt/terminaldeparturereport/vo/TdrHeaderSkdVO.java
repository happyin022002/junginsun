...
*@FileName : TdrHeaderSkdVO.java
*@FileTitle : TdrHeaderSkdVO
*Open Issues :
*Change history :
...
public class TdrHeaderSkdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<TdrHeaderSkdVO> models = new ArrayList<TdrHeaderSkdVO>();
	...
	/* Column Info */
	private String existsTmlDepRptDtl = null;
	/* Column Info */
	...
	public TdrHeaderSkdVO(String ibflag, String pagerows, String vslCd, String voyNo, String dirCd, String portCd, String callInd, String tmlCd, String tdrDate, String tdrUser, String commence, String complete, String grossWork, String netWork, String loseHr, String grossGang, String netGang, String mvs, String netTml, String grossTml, String netGc, String grossGc, String remark, String hatch, String con, String pilotArr, String pilotDep, String anchorArr, String anchorDep, String berth, String unberth, String draftFwdArr, String draftFwdDep, String draftAftArr, String draftAftDep, String ballastArr, String ballastDep, String robFoArr, String robFoDep, String robDoArr, String robDoDep, String robFwArr, String robFwDep, String bunkerFoArr, String bunkerFoDep, String bunkerDoArr, String bunkerDoDep, String bunkerFwArr, String bunkerFwDep, String dwtArr, String dwtDep, String displArr, String displDep, String gmArr, String gmDep, String tugArr, String tugDep, String sulphurFoArr, String sulphurFoDep, String sulphurDoArr, String sulphurDoDep, String supplySulphurFo, String supplySulphurDo, String eta, String etaCanal, String info, String updateUser, String updateTime, String nextPort, String nextCanal, String existsTmlDepRptDtl) {
		...
		this.existsTmlDepRptDtl = existsTmlDepRptDtl;
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("exists_tml_dep_rpt_dtl", getExistsTmlDepRptDtl());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("exists_tml_dep_rpt_dtl", "existsTmlDepRptDtl");
	...
	/**
	 * Column Info
	 * @return existsTmlDepRptDtl
	 */
	public String getExistsTmlDepRptDtl() {
		return this.existsTmlDepRptDtl;
	}
	...
	/**
	 * Column Info
	 * @param existsTmlDepRptDtl
	 */
	public void setExistsTmlDepRptDtl(String existsTmlDepRptDtl) {
		this.existsTmlDepRptDtl = existsTmlDepRptDtl;
	}
	...
	public void fromRequest(HttpServletRequest request) {
		...
		setExistsTmlDepRptDtl(JSPUtil.getParameter(request, "exists_tml_dep_rpt_dtl", ""));
	 ...
	 * @param request
	 * @return TdrHeaderSkdVO[]
	 */
	public TdrHeaderSkdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return TdrHeaderSkdVO[]
	 */
	public TdrHeaderSkdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		TdrHeaderSkdVO model = null;
		...
		try {
			...
			String[] existsTmlDepRptDtl = (JSPUtil.getParameter(request, prefix	+ "exists_tml_dep_rpt_dtl", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (existsTmlDepRptDtl[i] != null)
					model.setExistsTmlDepRptDtl(existsTmlDepRptDtl[i]);
				if (etaCanal[i] != null)
	 ...
	 * @return TdrHeaderSkdVO[]
	 */
	public TdrHeaderSkdVO[] getTdrHeaderSkdVOs(){
		TdrHeaderSkdVO[] vos = (TdrHeaderSkdVO[])models.toArray(new TdrHeaderSkdVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.existsTmlDepRptDtl = this.existsTmlDepRptDtl .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
