...
*@FileName : PortInformationMgtDBDAOVskPortDistVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortInformationMgtDBDAOVskPortDistVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PortInformationMgtDBDAOVskPortDistVORSQL(){
		setQuery();
	...
	public void setQuery(){
		...
		query.append(",	TO_LOC_CD AS TEMP_TO_LOC_CD" ).append("\n"); 
		...
		query.append("FileName : PortInformationMgtDBDAOVskPortDistVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}