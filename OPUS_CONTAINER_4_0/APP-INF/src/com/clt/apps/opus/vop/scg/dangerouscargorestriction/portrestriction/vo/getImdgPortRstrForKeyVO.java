...
*@FileName : getImdgPortRstrForKeyVO.java
*@FileTitle : getImdgPortRstrForKeyVO
*Open Issues :
*Change history :
...
public class getImdgPortRstrForKeyVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<getImdgPortRstrForKeyVO> models = new ArrayList<getImdgPortRstrForKeyVO>();
	 ...
	 * @param request
	 * @return getImdgPortRstrForKeyVO[]
	 */
	public getImdgPortRstrForKeyVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return getImdgPortRstrForKeyVO[]
	 */
	public getImdgPortRstrForKeyVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		getImdgPortRstrForKeyVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new getImdgPortRstrForKeyVO();
				if (rstrRmk[i] != null)
		...
		return getgetImdgPortRstrForKeyVOs();
	}
	 ...
	 * @return getImdgPortRstrForKeyVO[]
	 */
	public getImdgPortRstrForKeyVO[] getgetImdgPortRstrForKeyVOs(){
		getImdgPortRstrForKeyVO[] vos = (getImdgPortRstrForKeyVO[])models.toArray(new getImdgPortRstrForKeyVO[models.size()]);
		return vos;
	}
