...
public class VOP_SCG_0022HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_SCG_0022HTMLAction 객체를 생성
	 */
	public VOP_SCG_0022HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0022Event event = new VopScg0022Event();
		...
		if(command.isCommand(FormCommand.MULTI)) {
			...
			PartnerApprovalRequestVO vo = (PartnerApprovalRequestVO)getVO(request, PartnerApprovalRequestVO .class);
			String funcFlg = request.getParameter("func_flg");
			String fromReqDt = request.getParameter("from_req_dt");
			String toReqDt = request.getParameter("to_req_dt");
			vo.setSearchConditon("func_flg", funcFlg == null?"":funcFlg);
			vo.setSearchConditon("from_req_dt", fromReqDt == null?"":fromReqDt.replace("-", ""));
			vo.setSearchConditon("to_req_dt"  , toReqDt == null?"":toReqDt.replace("-", ""));
			event.setPartnerApprovalRequestVO(vo);
		}
