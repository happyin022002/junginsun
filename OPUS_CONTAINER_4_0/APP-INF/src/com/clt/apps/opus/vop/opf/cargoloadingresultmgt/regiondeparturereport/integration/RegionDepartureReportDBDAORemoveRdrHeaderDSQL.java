...
*@FileName : RegionDepartureReportDBDAORemoveRdrHeaderDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAORemoveRdrHeaderDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAORemoveRdrHeaderDSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAORemoveRdrHeaderDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE  RDR_HEADER  A" ).append("\n"); 
