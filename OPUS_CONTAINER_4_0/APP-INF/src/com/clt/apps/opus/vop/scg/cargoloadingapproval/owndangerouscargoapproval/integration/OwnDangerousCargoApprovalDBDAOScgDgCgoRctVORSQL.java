...
*@FileName : OwnDangerousCargoApprovalDBDAOScgDgCgoRctVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOScgDgCgoRctVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOScgDgCgoRctVORSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOScgDgCgoRctVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("-- ::DG RailBilling 2015-12-02 :: --" ).append("\n"); 
		...
		query.append("AND	SPCL_CGO_APRO_RQST_SEQ = (	SELECT MAX(SPCL_CGO_APRO_RQST_SEQ) FROM SCG_AUTHORIZATION WHERE BKG_NO=@[bkg_no] AND SPCL_CGO_CATE_CD = 'DG' AND SPCL_CGO_AUTH_CD IN ('Y','N')	)" ).append("\n"); 
