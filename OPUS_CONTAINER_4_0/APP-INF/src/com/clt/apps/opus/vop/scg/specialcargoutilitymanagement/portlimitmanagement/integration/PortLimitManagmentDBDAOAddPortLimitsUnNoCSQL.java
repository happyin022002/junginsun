...
*@FileName : PortLimitManagmentDBDAOAddPortLimitsUnNoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PortLimitManagmentDBDAOAddPortLimitsUnNoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SCG_IMDG_PORT_LMT_UN_NO 생성
	  * </pre>
	  */
	public PortLimitManagmentDBDAOAddPortLimitsUnNoCSQL(){
		setQuery();
		...
		query.append("FileName : PortLimitManagmentDBDAOAddPortLimitsUnNoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_PORT_LMT_UN_NO" ).append("\n"); 
		query.append("(" ).append("\n"); 
