...
*@FileName : RegionDepartureReportDBDAOSearchRdrBsaRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class RegionDepartureReportDBDAOSearchRdrBsaRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public RegionDepartureReportDBDAOSearchRdrBsaRSQL(){
		setQuery();
		...
		query.append("FileName : RegionDepartureReportDBDAOSearchRdrBsaRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM    RDR_BSA A" ).append("\n"); 
