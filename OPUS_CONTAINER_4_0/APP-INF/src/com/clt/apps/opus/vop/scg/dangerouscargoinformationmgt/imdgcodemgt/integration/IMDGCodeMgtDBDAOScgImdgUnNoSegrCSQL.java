...
*@FileName : IMDGCodeMgtDBDAOScgImdgUnNoSegrCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class IMDGCodeMgtDBDAOScgImdgUnNoSegrCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public IMDGCodeMgtDBDAOScgImdgUnNoSegrCSQL(){
		setQuery();
	...
	public void setQuery(){
		query.append("INSERT INTO SCG_IMDG_UN_NO_SEGR (" ).append("\n"); 
		...
		query.append("FileName : IMDGCodeMgtDBDAOScgImdgUnNoSegrCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
}