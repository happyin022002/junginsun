...
public class CarrierRestrictionDBDAOSearchCarrierRestrictionRSQL implements ISQLTemplate{
	...
	public void setQuery(){
		query.append("SELECT T.IMDG_TEK_NM_CHECK," ).append("\n"); 
		query.append("       T.ROW_SEQ," ).append("\n"); 
		query.append("       T.OPTCLASS," ).append("\n"); 
		query.append("       T.VSL_OPR_TP_CD ," ).append("\n"); 
		query.append("       T.IMDG_CRR_RSTR_SEQ ," ).append("\n"); 
		query.append("       T.IMDG_UN_NO," ).append("\n"); 
		query.append("       T.IMDG_UN_NO_SEQ," ).append("\n"); 
		query.append("       T.IMDG_AMDT_NO," ).append("\n"); 
		query.append("       T.IMDG_CLSS_CD," ).append("\n"); 
		query.append("       T.IMDG_CLSS_CD_TXT," ).append("\n"); 
		query.append("       T.IMDG_CRR_RSTR_EXPT_CD," ).append("\n"); 
		query.append("       T.SLAN_CD," ).append("\n"); 
		query.append("       T.CRR_REGU_DESC," ).append("\n"); 
		query.append("       T.CRE_USR_ID," ).append("\n"); 
		query.append("       T.CRE_DT," ).append("\n"); 
		query.append("       T.UPD_USR_ID," ).append("\n"); 
		query.append("       T.UPD_DT," ).append("\n"); 
		query.append("       T.IMDG_COMP_GRP_CD," ).append("\n"); 
		query.append("       T.IMDG_CLSS_CD_DESC," ).append("\n"); 
		query.append("       T.PRP_SHP_NM," ).append("\n"); 
		query.append("       T.IMDG_SUBS_RSK_LBL_CD" ).append("\n"); 
		...
		query.append("         WHERE IMDG_UN_NO = Z.IMDG_UN_NO" ).append("\n"); 
		query.append("           AND IMDG_UN_NO_SEQ = Z.IMDG_UN_NO_SEQ" ).append("\n"); 
		...
		query.append("         Z.SLAN_CD" ).append("\n"); 
		query.append("         ) T, SCG_IMDG_AMDT_MST M" ).append("\n"); 
		query.append("WHERE T.IMDG_AMDT_NO = M.IMDG_AMDT_NO(+)" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if(${optclass} != '') " ).append("\n"); 
		query.append("    #if(${optclass} == 'unno') " ).append("\n"); 
		query.append("	AND M.ACT_FLG = 'Y'   /*UNNO로 조회시*/" ).append("\n"); 
		query.append("    #end" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("ORDER BY M.EFF_FM_DT DESC, T.IMDG_AMDT_NO, T.IMDG_CLSS_CD, T.IMDG_UN_NO, T.IMDG_UN_NO_SEQ" ).append("\n"); 
