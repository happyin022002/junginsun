...
//			System.out.println("******************vsl_cd> " + request.getParameter("vsl_cd"));	
//			System.out.println("******************voy_no> " + request.getParameter("voy_no"));	
//			System.out.println("******************dir_cd> " + request.getParameter("dir_cd"));	
			
			event.setOnTimeRsltAnalGRPVO((OnTimeRsltAnalGRPVO)getVO(request, OnTimeRsltAnalGRPVO.class));
//			System.out.println("******************> " + ((OnTimeRsltAnalGRPVO)getVO(request, OnTimeRsltAnalGRPVO.class)).getVoyNo());	
