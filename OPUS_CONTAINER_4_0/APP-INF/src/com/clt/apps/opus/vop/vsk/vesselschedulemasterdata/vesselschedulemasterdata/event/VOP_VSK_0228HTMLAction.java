...
*@FileName : VOP_VSK_0228HTMLAction.java
 ...
 * @author Jung Jinwoo
 * @see VopVsk0228Event 참조
 * @since J2EE 1.5
 */

public class VOP_VSK_0228HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VOP_VSK_0228HTMLAction 객체를 생성
	 */
	public VOP_VSK_0228HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopVsk0228Event event = new VopVsk0228Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setUserLaneGroupVO((UserLaneGroupVO)getVO(request, UserLaneGroupVO.class));
		}else if(command.isCommand(FormCommand.MULTI)){
			event.setUserLaneGroupVOs((UserLaneGroupVO[])getVOs(request, UserLaneGroupVO.class));
		}
