...
*@FileName : OwnDangerousCargoApprovalDBDAOSearchOwnAWKListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OwnDangerousCargoApprovalDBDAOSearchOwnAWKListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OwnDangerousCargoApprovalDBDAOSearchOwnAWKListRSQL(){
		setQuery();
		...
		query.append("FileName : OwnDangerousCargoApprovalDBDAOSearchOwnAWKListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("        		ORDER BY A.VSL_CD||A.SKD_VOY_NO||A.SKD_DIR_CD, A.BKG_NO, A.AWK_CGO_SEQ ASC ) AS NO, " ).append("\n"); 
		...
		query.append("			#if (${scg_flg} == 'AWK' || ${scg_flg} == '45' || ${auth_flg} == 'ALL')" ).append("\n"); 
		...
		query.append("			#if ((${scg_flg} == 'SCG_AWK' || ${scg_flg} == 'SCG_45') && ${auth_flg} != 'ALL')" ).append("\n"); 
		query.append("			  	SCG_AWK_CGO F, " ).append("\n"); 
		...
		query.append("		--::2015-04-10::--AND   F.CNTR_TPSZ_CD 		!= 'D7'" ).append("\n"); 
		query.append("	#else" ).append("\n"); 
		query.append("		--::2015-04-10::--AND   F.CNTR_TPSZ_CD 		= 'D7'" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
		query.append("" ).append("\n"); 
