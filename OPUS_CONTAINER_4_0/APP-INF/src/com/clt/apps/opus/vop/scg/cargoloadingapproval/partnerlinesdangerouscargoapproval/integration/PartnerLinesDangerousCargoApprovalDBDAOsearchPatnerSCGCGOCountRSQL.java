...
*@FileName : PartnerLinesDangerousCargoApprovalDBDAOsearchPatnerSCGCGOCountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerLinesDangerousCargoApprovalDBDAOsearchPatnerSCGCGOCountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerLinesDangerousCargoApprovalDBDAOsearchPatnerSCGCGOCountRSQL(){
		setQuery();
		...
		query.append("FileName : PartnerLinesDangerousCargoApprovalDBDAOsearchPatnerSCGCGOCountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND 	SPCL_CGO_RQST_SEQ 		= '1'" ).append("\n"); 
		query.append("AND 	AUTH_STS_CD 			IS NULL" ).append("\n"); 
