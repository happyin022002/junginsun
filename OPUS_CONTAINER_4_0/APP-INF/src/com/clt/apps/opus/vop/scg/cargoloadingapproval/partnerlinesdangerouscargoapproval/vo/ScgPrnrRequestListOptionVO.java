 ...
 * @see	..
 */
public class ScgPrnrRequestListOptionVO	extends	 AbstractValueObject {

	private	 static final long serialVersionUID = 1L;

	private	 Collection<ScgPrnrRequestListOptionVO>  models =	new	ArrayList<ScgPrnrRequestListOptionVO>();
	 ...
	 */
	public ScgPrnrRequestListOptionVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return ScgRequestListOptionVO[]
	 */
	public ScgPrnrRequestListOptionVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		ScgPrnrRequestListOptionVO model = null;
		...
		try	{
			...
			for	(int i = 0;	i <	length;	i++) {
				model =	new	ScgPrnrRequestListOptionVO();
				if ( ibflag[i] !=	null)
	 ...
	 * @return ScgRequestListOptionVO[]
	 */
	public ScgPrnrRequestListOptionVO[]	 getScgRequestListOptionVOs(){
		ScgPrnrRequestListOptionVO[] vos = (ScgPrnrRequestListOptionVO[])models.toArray(new	ScgPrnrRequestListOptionVO[models.size()]);
		return vos;
	}
