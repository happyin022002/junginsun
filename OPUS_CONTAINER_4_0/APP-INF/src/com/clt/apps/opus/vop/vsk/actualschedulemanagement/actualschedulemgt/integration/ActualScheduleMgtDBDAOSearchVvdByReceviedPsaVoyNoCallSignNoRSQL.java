...
*@FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedPsaVoyNoCallSignNoRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ActualScheduleMgtDBDAOSearchVvdByReceviedPsaVoyNoCallSignNoRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ActualScheduleMgtDBDAOSearchVvdByReceviedPsaVoyNoCallSignNoRSQL(){
		setQuery();
		...
		query.append("FileName : ActualScheduleMgtDBDAOSearchVvdByReceviedPsaVoyNoCallSignNoRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
