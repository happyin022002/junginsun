...
*@FileName : VMS_SCG_0067HTMLAction.java
...
public class VOP_SCG_0067HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0067HTMLAction 객체를 생성
	 */
	public VOP_SCG_0067HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0067Event event = new VopScg0067Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgExptQtyVOS((ScgImdgExptQtyVO[])getVOs(request, ScgImdgExptQtyVO .class,""));
		}
