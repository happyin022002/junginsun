...
*@FileName : VMS_SCG_0043HTMLAction.java
...
public class VOP_SCG_0043HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * VMS_SCG_0043HTMLAction 객체를 생성
	 */
	public VOP_SCG_0043HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		VopScg0043Event event = new VopScg0043Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setScgImdgPckCdVOS((ScgImdgPckCdVO[])getVOs(request, ScgImdgPckCdVO .class,""));
		}
		else if(command.isCommand(FormCommand.SEARCH)) {
			event.setScgImdgPckCdVO((ScgImdgPckCdVO)getVO(request, ScgImdgPckCdVO .class));
		}
