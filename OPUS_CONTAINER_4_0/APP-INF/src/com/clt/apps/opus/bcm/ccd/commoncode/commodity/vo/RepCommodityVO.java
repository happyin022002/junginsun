...
*@FileName : RepCommodityVO.java
*@FileTitle : RepCommodityVO
*Open Issues :
*Change history :
...
public class RepCommodityVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RepCommodityVO> models = new ArrayList<RepCommodityVO>();
	...
	public RepCommodityVO() {}

	public RepCommodityVO(String ibflag, String pagerows, String repCmdtCd, String repCmdtNm, String grpCmdtCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg) {
		this.updDt = updDt;
...
/**
	 ...
	 * @param request
	 * @return RepCommodityVO[]
	 */
	public RepCommodityVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RepCommodityVO[]
	 */
	public RepCommodityVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RepCommodityVO model = null;
	...
	public RepCommodityVO[] getRepCommodityVOs(){
		RepCommodityVO[] vos = (RepCommodityVO[])models.toArray(new RepCommodityVO[models.size()]);
		return vos;
	}
