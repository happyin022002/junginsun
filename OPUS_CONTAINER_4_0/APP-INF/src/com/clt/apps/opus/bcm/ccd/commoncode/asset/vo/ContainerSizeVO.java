...
*@FileName : ContainerSizeVO.java
*@FileTitle : ContainerSizeVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.bcm.ccd.commoncode.asset.vo;
...
public class ContainerSizeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ContainerSizeVO> models = new ArrayList<ContainerSizeVO>();
	...
	public ContainerSizeVO() {}

	public ContainerSizeVO(String ibflag, String pagerows, String cntrSzCd, String cntrSzDesc, String cntrSzTeuCapa, String modiCntrSzCd, String creUsrId, String creDt, String updUsrId, String updDt, String deltFlg, String eaiEvntDt, String eaiIfId) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public ContainerSizeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ContainerSizeVO[]
	 */
	public ContainerSizeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ContainerSizeVO model = null;
	...
	public ContainerSizeVO[] getContainerSizeVOs(){
		ContainerSizeVO[] vos = (ContainerSizeVO[])models.toArray(new ContainerSizeVO[models.size()]);
		return vos;
	}
