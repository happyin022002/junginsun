...
*@FileName : PartnerDBDAOModifyCustCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCustCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOModifyCustCodeUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCustCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if (${key_acct_st_eff_dt} != '')" ).append("\n"); 
		query.append(",  KEY_ACCT_ST_EFF_DT    =  TO_DATE(@[key_acct_st_eff_dt], 'YYYY-MM-DD')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(",  KEY_ACCT_ST_EFF_DT    =  NULL" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("#if (${key_acct_end_eff_dt} != '')" ).append("\n"); 
		query.append(",  KEY_ACCT_END_EFF_DT   =  TO_DATE(@[key_acct_end_eff_dt], 'YYYY-MM-DD') " ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(",  KEY_ACCT_END_EFF_DT   =  NULL" ).append("\n"); 
		query.append("#end  " ).append("\n"); 
		...
		query.append(",  CUST_STS_CD          = DECODE(@[delt_flg], 'Y', 'D', 'A')" ).append("\n"); 
		...
		query.append("#if (${sls_delt_eff_dt} != '')" ).append("\n"); 
		query.append(",  SLS_DELT_EFF_DT      =  TO_CHAR(TO_DATE(@[sls_delt_eff_dt], 'YYYY-MM-DD'), 'YYYYMMDD')" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append(",  SLS_DELT_EFF_DT      =  NULL" ).append("\n"); 
		query.append("#end  " ).append("\n"); 
