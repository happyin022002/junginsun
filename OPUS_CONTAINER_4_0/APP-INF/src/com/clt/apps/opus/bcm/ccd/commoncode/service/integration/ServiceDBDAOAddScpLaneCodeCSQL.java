...
*@FileName : ServiceDBDAOAddScpLaneCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddScpLaneCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOAddScpLaneCodeCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddScpLaneCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
