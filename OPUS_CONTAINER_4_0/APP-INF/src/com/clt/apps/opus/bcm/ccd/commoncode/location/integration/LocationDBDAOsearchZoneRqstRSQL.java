...
*@FileName : LocationDBDAOsearchZoneRqstRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOsearchZoneRqstRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Zone master 정보를 조회합니다.
	  * </pre>
	  */
	public LocationDBDAOsearchZoneRqstRSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOsearchZoneRqstRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM MDM_ZN_RQST" ).append("\n"); 
