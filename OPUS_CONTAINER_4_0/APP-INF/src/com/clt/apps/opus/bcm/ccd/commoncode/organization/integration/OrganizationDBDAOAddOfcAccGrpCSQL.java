...
*@FileName : OrganizationDBDAOAddOfcAccGrpCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OrganizationDBDAOAddOfcAccGrpCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 입력 및 조회된 Office Access Group Creation 정보를 추가 및 수정한다.(UI_CCD_0041)
	  * </pre>
	  */
	public OrganizationDBDAOAddOfcAccGrpCSQL(){
		setQuery();
		...
		query.append("FileName : OrganizationDBDAOAddOfcAccGrpCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_OFC_GRP(" ).append("\n"); 
		...
		query.append("   			,(SELECT NVL(TRIM(TO_CHAR(MAX(OFC_GRP_ID)+1,'000000')),'000001') " ).append("\n"); 
