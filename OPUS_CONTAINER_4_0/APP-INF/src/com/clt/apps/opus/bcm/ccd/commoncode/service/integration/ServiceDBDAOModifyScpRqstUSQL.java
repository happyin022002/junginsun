...
*@FileName : ServiceDBDAOModifyScpRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifyScpRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOModifyScpRqstUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyScpRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_SVC_SCP_RQST" ).append("\n"); 
		query.append("   SET SVC_SCP_NM = @[svc_scp_nm]" ).append("\n"); 
		...
		query.append("      ,MODI_SVC_GRP_CD = @[modi_svc_grp_cd]" ).append("\n"); 
		query.append("      ,MODI_COST_CTR_CD = @[modi_cost_ctr_cd]" ).append("\n"); 
		query.append("      ,DMNT_FLG = @[dmnt_flg]" ).append("\n"); 
