...
*@FileName : LocationDBDAOaddLocCodeRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddLocCodeRqstCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request 신규 Location 정보를 저장합니다.
	  * </pre>
	  */
	public LocationDBDAOaddLocCodeRqstCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddLocCodeRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_LOC_RQST ( " ).append("\n"); 
