...
*@FileName : BCM_CCD_0017HTMLAction.java
*@FileTitle : region
*Open Issues :
*Change history :
...
public class BCM_CCD_0017HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0017HTMLAction 객체를 생성
	 */
	public BCM_CCD_0017HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0017Event event = new BcmCcd0017Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setRgnCd(request.getParameter("rgn_cd"));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setRegionVO((RegionVO)getVO(request, RegionVO .class));
