...
*@FileName : LocationDBDAOremoveZoneDtlCodeDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOremoveZoneDtlCodeDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * zone code detail 정보를 삭제합니다.
	  * </pre>
	  */
	public LocationDBDAOremoveZoneDtlCodeDSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOremoveZoneDtlCodeDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_ZN_DTL" ).append("\n"); 
