...
public class BCM_CCD_0025HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0025HTMLAction 객체를 생성
	 */
	public BCM_CCD_0025HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0025Event event = new BcmCcd0025Event();
		

		if(command.isCommand(FormCommand.SEARCH02)) {
			event.setActCd(request.getParameter("act_cd"));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setActivityVO((ActivityVO)getVO(request, ActivityVO .class));
		}
