...
*@FileName : LocationDBDAOmodifyDyLgtSavTmUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyDyLgtSavTmUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * DayLight Saving Time 정보를 수정합니다.
	  * </pre>
	  */
	public LocationDBDAOmodifyDyLgtSavTmUSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOmodifyDyLgtSavTmUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_DYLGT_SAV_TM" ).append("\n"); 
		query.append("SET DST_CNT_CD = @[dst_cnt_cd]," ).append("\n"); 
