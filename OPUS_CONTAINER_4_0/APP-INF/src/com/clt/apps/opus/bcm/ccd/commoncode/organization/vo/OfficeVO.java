...
package com.clt.apps.opus.bcm.ccd.commoncode.organization.vo;
...
public class OfficeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OfficeVO> models = new ArrayList<OfficeVO>();
	...
	public HashMap<String, String> getColumnValues(){
		...
		this.hashColumns.put("hidden_ofc_cd", getHiddenOfcCd());
	...
	public HashMap<String, String> getFieldNames(){
		...
		this.hashFields.put("hidden_ofc_cd", "hiddenOfcCd");
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setHiddenOfcCd(JSPUtil.getParameter(request, prefix + "hidden_ofc_cd", ""));
	 ...
	 * @return OfficeVO[]
	 */
	public OfficeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OfficeVO[]
	 */
	public OfficeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OfficeVO model = null;
		...
		try {
			...
			String[] hiddenOfcCd = (JSPUtil.getParameter(request, prefix	+ "hidden_ofc_cd", length));
			...
			for (int i = 0; i < length; i++) {
				...
				if (hiddenOfcCd[i] != null)
					model.setHiddenOfcCd(hiddenOfcCd[i]);
				if (subAgnFlg[i] != null)
	...
	public OfficeVO[] getOfficeVOs(){
		OfficeVO[] vos = (OfficeVO[])models.toArray(new OfficeVO[models.size()]);
		return vos;
	}
	...
	*/
	public void unDataFormat(){
		...
		this.hiddenOfcCd = this.hiddenOfcCd .replaceAll(",", "").replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
