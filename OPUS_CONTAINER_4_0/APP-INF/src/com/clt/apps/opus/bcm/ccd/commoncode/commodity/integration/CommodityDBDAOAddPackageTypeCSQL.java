...
*@FileName : CommodityDBDAOAddPackageTypeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOAddPackageTypeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.08 조인영 Package Type 정보를 생성한다.
	  * </pre>
	  */
	public CommodityDBDAOAddPackageTypeCSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOAddPackageTypeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_PCK_TP (" ).append("\n"); 
