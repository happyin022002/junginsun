...
*@FileName : LocationDBDAOaddZoneDtlRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddZoneDtlRqstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOaddZoneDtlRqstCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddZoneDtlRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_ZN_DTL_RQST (" ).append("\n"); 
		...
		query.append("  @[rqst_no]," ).append("\n"); 
		query.append("  @[zn_cd]," ).append("\n"); 
		query.append("  (SELECT DECODE (MAX(ZN_SEQ), NULL, 1, MAX(ZN_SEQ)+1) FROM MDM_ZN_DTL_RQST WHERE ZN_CD = @[zn_cd])," ).append("\n"); 
		query.append("  @[zip_cd]," ).append("\n"); 
		query.append("  @[dstr_nm]," ).append("\n"); 
