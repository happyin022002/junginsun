...
*@FileName : PartnerDBDAOModifyMoreInfoCustCntcPntUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyMoreInfoCustCntcPntUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyMoreInfoCustCntcPnt
	  * </pre>
	  */
	public PartnerDBDAOModifyMoreInfoCustCntcPntUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyMoreInfoCustCntcPntUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("SET CUST_URL = @[cust_url]" ).append("\n"); 
