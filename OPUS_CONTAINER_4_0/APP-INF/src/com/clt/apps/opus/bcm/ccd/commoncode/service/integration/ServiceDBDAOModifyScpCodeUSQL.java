...
*@FileName : ServiceDBDAOModifyScpCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifyScpCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOModifyScpCodeUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyScpCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_SVC_SCP" ).append("\n"); 
