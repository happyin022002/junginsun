...
*@FileName : BCM_CCD_0037HTMLAction.java
...
public class BCM_CCD_0037HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0037HTMLAction 객체를 생성
	 */
	public BCM_CCD_0037HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0037Event event = new BcmCcd0037Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setCustomerContactVO((CustomerContactVO)getVO(request, CustomerContactVO .class,""));
		}else if(command.isCommand(FormCommand.MULTI)) {
				event.setCustomerContactVOS((CustomerContactVO[])getVOs(request, CustomerContactVO .class,"sheet1_"));	
