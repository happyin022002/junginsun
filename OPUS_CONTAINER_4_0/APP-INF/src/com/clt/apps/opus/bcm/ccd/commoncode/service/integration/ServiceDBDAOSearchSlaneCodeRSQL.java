...
*@FileName : ServiceDBDAOSearchSlaneCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOSearchSlaneCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOSearchSlaneCodeRSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOSearchSlaneCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("#if(${dir_flg} == 'Y')" ).append("\n"); 
		query.append("      ,DIR.CRE_USR_ID" ).append("\n"); 
		query.append("      ,DIR.CRE_DT" ).append("\n"); 
		query.append("      ,DIR.UPD_USR_ID" ).append("\n"); 
		query.append("      ,DIR.UPD_DT" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("      ,VSL.CRE_USR_ID" ).append("\n"); 
		query.append("      ,VSL.CRE_DT" ).append("\n"); 
		query.append("      ,VSL.UPD_USR_ID" ).append("\n"); 
		query.append("      ,VSL.UPD_DT" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("  FROM MDM_VSL_SVC_LANE VSL" ).append("\n"); 
		query.append("      ,MDM_VSL_SVC_LANE_DIR DIR" ).append("\n"); 
		query.append(" WHERE VSL.VSL_SLAN_CD = DIR.VSL_SLAN_CD(+)" ).append("\n"); 
		query.append("   AND VSL.VSL_SLAN_CD = @[vsl_slan_cd]" ).append("\n"); 
