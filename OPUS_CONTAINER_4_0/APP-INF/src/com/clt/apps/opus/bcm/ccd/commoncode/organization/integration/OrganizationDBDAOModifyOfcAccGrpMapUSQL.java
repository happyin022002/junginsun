...
*@FileName : OrganizationDBDAOModifyOfcAccGrpMapUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OrganizationDBDAOModifyOfcAccGrpMapUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 수정된 Office Access Group Mapping 정보를 저장한다.
	  * </pre>
	  */
	public OrganizationDBDAOModifyOfcAccGrpMapUSQL(){
		setQuery();
		...
		query.append("FileName : OrganizationDBDAOModifyOfcAccGrpMapUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_OFC_GRP_MAPG" ).append("\n"); 
		...
		query.append("AND OFC_CD = @[cur_ofc_cd]" ).append("\n"); 
		query.append("" ).append("\n"); 
