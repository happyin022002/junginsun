...
*@FileName : ServiceDBDAOSearchScpLimitCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOSearchScpLimitCodeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOSearchScpLimitCodeRSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOSearchScpLimitCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
