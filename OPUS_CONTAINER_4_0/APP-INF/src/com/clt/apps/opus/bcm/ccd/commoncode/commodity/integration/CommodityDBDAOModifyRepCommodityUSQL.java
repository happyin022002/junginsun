...
*@FileName : CommodityDBDAOModifyRepCommodityUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOModifyRepCommodityUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.03 조인영 Rep Commodity 정보를 수정한다.
	  * </pre>
	  */
	public CommodityDBDAOModifyRepCommodityUSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOModifyRepCommodityUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
