...
*@LastVersion : 1.0
=========================================================*/
package com.clt.apps.opus.bcm.ccd.commoncode.location.basic;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import com.clt.apps.opus.bcm.ccd.commoncode.location.integration.LocationDBDAO;
...
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.CountryIfVO;
...
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.LocationIfVO;
...
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.StateIfVO;
...
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.YardIfVO;
...
public class LocationBCImpl extends BasicCommandSupport implements LocationBC {
	 ...
	 * @exception EventException
	 */
	public void manageLseCoYd(LseComYardVO lseCoYdVO) throws EventException {
		try {
			if(lseCoYdVO != null ){
	 ...
	 * @exception EventException
	 */
	public void manageDyLgtSavTm(DaySavingTimeVO dystVO) throws EventException {
		try {
			if(dystVO != null ){
	...
	public ZoneGroupVO searchZoneCode(String znCd) throws EventException {
		try {
			...
			zoneDtlVOs = dbDao.searchZoneDtlCode(znCd);
