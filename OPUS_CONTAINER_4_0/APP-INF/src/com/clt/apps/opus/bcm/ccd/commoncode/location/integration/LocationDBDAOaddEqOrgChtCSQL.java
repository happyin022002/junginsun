...
*@FileName : LocationDBDAOaddEqOrgChtCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddEqOrgChtCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 신규 Equipment ORG Chart 정보를 저장합니다.
	  * </pre>
	  */
	public LocationDBDAOaddEqOrgChtCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddEqOrgChtCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
