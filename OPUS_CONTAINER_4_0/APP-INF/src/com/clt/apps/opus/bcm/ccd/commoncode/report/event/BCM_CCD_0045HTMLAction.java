...
*@FileName : BCM_CCD_0045HTMLAction.java
...
public class BCM_CCD_0045HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0045HTMLAction 객체를 생성
	 */
	public BCM_CCD_0045HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0045Event event = new BcmCcd0045Event();

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setLocationReportConditionVO((LocationReportConditionVO)getVO(request, LocationReportConditionVO .class));
