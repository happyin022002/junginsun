...
*@FileName : AssetDBDAOAddContainerVesselRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AssetDBDAOAddContainerVesselRqstCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Container Vessel 정보를 생성한다.
	  * </pre>
	  */
	public AssetDBDAOAddContainerVesselRqstCSQL(){
		setQuery();
		...
		query.append("FileName : AssetDBDAOAddContainerVesselRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_VSL_CNTR_RQST ( " ).append("\n"); 
		...
		query.append("      ,@[gnr_rpm_pwr]" ).append("\n"); 
		query.append("      ,@[vsl_hgt]" ).append("\n"); 
		query.append("      ,TO_DATE(TRIM(REPLACE(@[rgst_dt], '-', '')),'YYYYMMDD')" ).append("\n"); 
		query.append("      ,@[vsl_edi_nm]" ).append("\n"); 
		query.append("      ,@[co_cd]" ).append("\n"); 
		...
		query.append("      ,@[bwthst_rpm_pwr]" ).append("\n"); 
		query.append("      ,@[lloyd_no]" ).append("\n"); 
		query.append("      ,TO_DATE(TRIM(REPLACE(@[vsl_lnch_dt], '-', '')),'YYYYMMDD')" ).append("\n"); 
		query.append("      ,TO_DATE(TRIM(REPLACE(@[vsl_de_dt], '-', '')),'YYYYMMDD')" ).append("\n"); 
		query.append("      ,TO_DATE(TRIM(REPLACE(@[vsl_kel_ly_dt], '-', '')),'YYYYMMDD')" ).append("\n"); 
		query.append("      ,@[vsl_hl_no]" ).append("\n"); 
		query.append("      ,@[ttl_teu_knt]" ).append("\n"); 
		query.append("      ,@[vsl_htch_knt]" ).append("\n"); 
		query.append("      ,@[vsl_hld_knt]" ).append("\n"); 
