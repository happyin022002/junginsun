...
*@FileName : PartnerDBDAOModifyCrrCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCrrCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOModifyCrrCodeUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCrrCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_CARRIER " ).append("\n"); 
