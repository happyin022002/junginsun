...
*@FileName : AssetDBDAOAddContainerVesselIbisIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AssetDBDAOAddContainerVesselIbisIfCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AssetDBDAOAddContainerVesselIbisIfCSQL(){
		setQuery();
		...
		query.append("FileName : AssetDBDAOAddContainerVesselIbisIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_VSL_CNTR_IBIS_IF(" ).append("\n"); 
		query.append("             VSL_CNTR_IBIS_IF_SEQ" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("    VALUES(  MDM_VSL_CNTR_IBIS_IF_SEQ.NEXTVAL" ).append("\n"); 
		query.append("            ,@[vsl_cd]" ).append("\n"); 
		query.append("            ,@[vsl_clss_flg]" ).append("\n"); 
		query.append("            ,@[vsl_eng_nm]" ).append("\n"); 
		query.append("            ,@[vsl_locl_nm]" ).append("\n"); 
