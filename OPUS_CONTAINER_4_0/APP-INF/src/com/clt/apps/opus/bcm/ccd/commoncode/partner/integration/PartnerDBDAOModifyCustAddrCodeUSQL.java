...
*@FileName : PartnerDBDAOModifyCustAddrCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCustAddrCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Customer Address 코드를 수정한다
	  * </pre>
	  */
	public PartnerDBDAOModifyCustAddrCodeUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCustAddrCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
