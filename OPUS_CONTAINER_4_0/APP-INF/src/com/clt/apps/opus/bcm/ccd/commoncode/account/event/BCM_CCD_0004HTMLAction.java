...
*@FileName : BCM_CCD_0004HTMLAction.java
*@FileTitle : Currency
*Open Issues :
*Change history :
...
public class BCM_CCD_0004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0004HTMLAction 객체를 생성
	 */
	public BCM_CCD_0004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0004Event event = new BcmCcd0004Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setCurrencyVOS((CurrencyVO[])getVOs(request, CurrencyVO.class, "sheet1_"));
			
		} else if(command.isCommand(FormCommand.SEARCH)) {
			event.setCurrencyVO((CurrencyVO)getVO(request, CurrencyVO.class));
