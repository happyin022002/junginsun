...
*@FileName : PartnerDBDAORemoveCntrVndrClssRqstDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAORemoveCntrVndrClssRqstDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAORemoveCntrVndrClssRqstDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAORemoveCntrVndrClssRqstDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM MDM_CNTR_VNDR_CLSS_RQST" ).append("\n"); 
