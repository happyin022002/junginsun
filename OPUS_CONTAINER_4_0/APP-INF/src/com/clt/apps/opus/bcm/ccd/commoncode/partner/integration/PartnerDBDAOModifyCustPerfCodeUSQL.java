...
*@FileName : PartnerDBDAOModifyCustPerfCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCustPerfCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Customer Perf 코드 수정한다.
	  * </pre>
	  */
	public PartnerDBDAOModifyCustPerfCodeUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCustPerfCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
