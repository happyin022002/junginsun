...
public class BCM_CCD_0046HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0046HTMLAction 객체를 생성
	 */
	public BCM_CCD_0046HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0046Event event = new BcmCcd0046Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setYdCd(request.getParameter("yd_cd"));
			event.setYdNm(request.getParameter("yd_nm"));
