...
*@FileName : BCM_CCD_0015HTMLAction.java
...
public class BCM_CCD_0015HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0015HTMLAction 객체를 생성
	 */
	public BCM_CCD_0015HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0015Event event = new BcmCcd0015Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {
			event.setScontiCd(request.getParameter("sconti_cd"));
		}else if(command.isCommand(FormCommand.MULTI)) {
			event.setSubContinentVO((SubContinentVO)getVO(request, SubContinentVO .class));
		}
