...
*@FileName : PartnerDBDAOAddCustCntcCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddCustCntcCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Customer Contact Point Code 를 생성 한다.
	  * </pre>
	  */
	public PartnerDBDAOAddCustCntcCodeCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddCustCntcCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
