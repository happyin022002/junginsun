...
public class BCM_CCD_1035HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_1035HTMLAction 객체를 생성
	 */
	public BCM_CCD_1035HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	BcmCcd1035Event event = new BcmCcd1035Event(cust_cnt_cd, cust_nm, loc_cd, cust_rgst_no, match_rule, iPage);            	
    	
        event.setCommandClassName("CommonCodeSC");
