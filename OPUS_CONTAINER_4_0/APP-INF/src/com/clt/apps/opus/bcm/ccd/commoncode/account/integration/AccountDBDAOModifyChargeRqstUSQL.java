...
*@FileName : AccountDBDAOModifyChargeRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountDBDAOModifyChargeRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request Charge Code 정보를 수정한다.
	  * </pre>
	  */
	public AccountDBDAOModifyChargeRqstUSQL(){
		setQuery();
		...
		query.append("FileName : AccountDBDAOModifyChargeRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_CHG_RQST SET" ).append("\n"); 
