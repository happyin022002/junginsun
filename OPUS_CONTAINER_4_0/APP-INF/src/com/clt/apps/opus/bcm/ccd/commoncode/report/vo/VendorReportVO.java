...
*@FileName : VendorReportVO.java
*@FileTitle : VendorReportVO
*Open Issues :
*Change history :
...
public class VendorReportVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<VendorReportVO> models = new ArrayList<VendorReportVO>();
...
/**
	 ...
	 */
	public VendorReportVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return VendorReportVO[]
	 */
	public VendorReportVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		VendorReportVO model = null;
	...
	public VendorReportVO[] getVendorReportVOs(){
		VendorReportVO[] vos = (VendorReportVO[])models.toArray(new VendorReportVO[models.size()]);
		return vos;
	}
