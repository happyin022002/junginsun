...
*@FileName : ServiceDBDAOAddSlaneCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOAddSlaneCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ServiceDBDAOAddSlaneCodeCSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOAddSlaneCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
