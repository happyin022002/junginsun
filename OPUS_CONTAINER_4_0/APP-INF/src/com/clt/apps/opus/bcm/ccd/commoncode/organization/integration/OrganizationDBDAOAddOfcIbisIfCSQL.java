...
*@FileName : OrganizationDBDAOAddOfcIbisIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class OrganizationDBDAOAddOfcIbisIfCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public OrganizationDBDAOAddOfcIbisIfCSQL(){
		setQuery();
		...
		query.append("FileName : OrganizationDBDAOAddOfcIbisIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_ORGANIZATION_IBIS_IF(" ).append("\n"); 
		query.append("             OFC_IBIS_IF_SEQ" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("    VALUES(  MDM_ORGANIZATION_IBIS_IF_SEQ.NEXTVAL" ).append("\n"); 
		query.append("            ,@[ofc_cd]" ).append("\n"); 
		query.append("            ,@[ofc_eng_nm]" ).append("\n"); 
		query.append("            ,@[ofc_locl_nm]" ).append("\n"); 
		query.append("            ,@[ofc_addr]" ).append("\n"); 
