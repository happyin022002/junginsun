...
*@FileName : PartnerDBDAOAddCustAddrRqstCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOAddCustAddrRqstCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public PartnerDBDAOAddCustAddrRqstCSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOAddCustAddrRqstCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_CUST_ADDR_RQST (" ).append("\n"); 
