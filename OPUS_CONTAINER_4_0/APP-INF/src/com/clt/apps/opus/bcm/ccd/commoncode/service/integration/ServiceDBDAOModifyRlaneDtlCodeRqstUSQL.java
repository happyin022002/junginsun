...
*@FileName : ServiceDBDAOModifyRlaneDtlCodeRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifyRlaneDtlCodeRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request rlane code detail의 상세 정보 수정
	  * </pre>
	  */
	public ServiceDBDAOModifyRlaneDtlCodeRqstUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyRlaneDtlCodeRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_DTL_REV_LANE_RQST " ).append("\n"); 
		query.append("   SET SUB_TRD_CD = @[sub_trd_cd]" ).append("\n"); 
		query.append("      ,UPD_USR_ID = @[user_id]" ).append("\n"); 
		query.append("      ,UPD_DT = SYSDATE" ).append("\n"); 
		query.append("      ,DELT_FLG = @[dtl_delt_flg]" ).append("\n"); 
		query.append("      ,DMNT_LEG_FLG = @[dmnt_leg_flg]" ).append("\n"); 
