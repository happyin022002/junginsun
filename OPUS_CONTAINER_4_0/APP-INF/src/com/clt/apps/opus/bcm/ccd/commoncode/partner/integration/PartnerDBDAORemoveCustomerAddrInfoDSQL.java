...
*@FileName : PartnerDBDAORemoveCustomerAddrInfoDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAORemoveCustomerAddrInfoDSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * RemoveCustomerAddrInfo
	  * </pre>
	  */
	public PartnerDBDAORemoveCustomerAddrInfoDSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAORemoveCustomerAddrInfoDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
