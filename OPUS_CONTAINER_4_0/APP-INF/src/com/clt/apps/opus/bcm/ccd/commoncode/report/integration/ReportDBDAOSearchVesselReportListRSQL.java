...
*@FileName : ReportDBDAOSearchVesselReportListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ReportDBDAOSearchVesselReportListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public ReportDBDAOSearchVesselReportListRSQL(){
		setQuery();
		...
		query.append("FileName : ReportDBDAOSearchVesselReportListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
