...
*@FileName : LocationDBDAOmodifyZoneRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyZoneRqstUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOmodifyZoneRqstUSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOmodifyZoneRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_ZN_RQST" ).append("\n"); 
