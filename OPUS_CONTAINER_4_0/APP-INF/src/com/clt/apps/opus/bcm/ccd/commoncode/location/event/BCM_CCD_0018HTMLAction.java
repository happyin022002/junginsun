...
*@FileName : BCM_CCD_0018HTMLAction.java
*@FileTitle : state
*Open Issues :
*Change history :
...
public class BCM_CCD_0018HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0018HTMLAction 객체를 생성
	 */
	public BCM_CCD_0018HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0018Event event = new BcmCcd0018Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {
			...
			event.setStateVO((StateVO)getVO(request, StateVO .class));
