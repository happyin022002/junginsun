...
=========================================================*/
package com.clt.apps.opus.bcm.ccd.commoncode;
...
import com.clt.apps.opus.bcm.ccd.commoncode.account.event.BcmCcd0002Event;
import com.clt.apps.opus.bcm.ccd.commoncode.account.event.BcmCcd0003Event;
import com.clt.apps.opus.bcm.ccd.commoncode.account.event.BcmCcd0004Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.asset.basic.AssetBC;
import com.clt.apps.opus.bcm.ccd.commoncode.asset.basic.AssetBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.asset.event.BcmCcd0005Event;
import com.clt.apps.opus.bcm.ccd.commoncode.asset.event.BcmCcd0006Event;
import com.clt.apps.opus.bcm.ccd.commoncode.asset.event.BcmCcd0007Event;
import com.clt.apps.opus.bcm.ccd.commoncode.asset.event.BcmCcd0008Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.basic.CommodityBC;
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.basic.CommodityBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.event.BcmCcd0009Event;
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.event.BcmCcd0010Event;
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.event.BcmCcd0011Event;
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.event.BcmCcd0012Event;
import com.clt.apps.opus.bcm.ccd.commoncode.commodity.event.BcmCcd0013Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.location.basic.LocationBC;
import com.clt.apps.opus.bcm.ccd.commoncode.location.basic.LocationBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0014Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0015Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0016Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0017Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0018Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0019Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0020Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0021Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0022Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0023Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.event.BcmCcd0024Event;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.ContinentVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.CountryVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.DaySavingTimeVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.EqOrgChartVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.LocationVO;
...
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.StateVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.SubContinentVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.YardVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.ZoneDtlVO;
import com.clt.apps.opus.bcm.ccd.commoncode.location.vo.ZoneGroupVO;
import com.clt.apps.opus.bcm.ccd.commoncode.mstmgmt.basic.MstMgmtBC;
import com.clt.apps.opus.bcm.ccd.commoncode.mstmgmt.basic.MstMgmtBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.mstmgmt.event.BcmCcd2001Event;
import com.clt.apps.opus.bcm.ccd.commoncode.mstmgmt.event.BcmCcd2002Event;
import com.clt.apps.opus.bcm.ccd.commoncode.mstmgmt.event.BcmCcd2003Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.organization.basic.OrganizationBC;
import com.clt.apps.opus.bcm.ccd.commoncode.organization.basic.OrganizationBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.organization.event.BcmCcd0032Event;
import com.clt.apps.opus.bcm.ccd.commoncode.organization.event.BcmCcd0041Event;
import com.clt.apps.opus.bcm.ccd.commoncode.organization.event.BcmCcd0042Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0034Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0035Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0036Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0037Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0038Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0039Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd0040Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd1035Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd1038Event;
import com.clt.apps.opus.bcm.ccd.commoncode.partner.event.BcmCcd1040Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0043Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0044Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0045Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0046Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0047Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0048Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0049Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0050Event;
import com.clt.apps.opus.bcm.ccd.commoncode.report.event.BcmCcd0051Event;
...
import com.clt.apps.opus.bcm.ccd.commoncode.salesrepresentative.basic.SalesRepresentativeBC;
import com.clt.apps.opus.bcm.ccd.commoncode.salesrepresentative.basic.SalesRepresentativeBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.salesrepresentative.event.BcmCcd0033Event;
import com.clt.apps.opus.bcm.ccd.commoncode.salesrepresentative.vo.SalesRepVO;
import com.clt.apps.opus.bcm.ccd.commoncode.service.basic.ServiceBC;
import com.clt.apps.opus.bcm.ccd.commoncode.service.basic.ServiceBCImpl;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0025Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0026Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0027Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0028Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0029Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0030Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.event.BcmCcd0031Event;
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.ActivityVO;
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.MovementStatusVO;
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.RLaneDtlVO;
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.RLaneGroupVO;
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.SLaneDirVO;
...
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.SubTradeVO;
import com.clt.apps.opus.bcm.ccd.commoncode.service.vo.TradeVO;
...
//				eventResponse = checkSccCode ( e );
			...
			if (e.getFormCommand().isCommand(FormCommand.SEARCH01)) {
				...
				eventResponse = searchSlsRepRqst(e);
			}else if (e.getFormCommand().isCommand(FormCommand.MULTI02)) {
				eventResponse = manageSlsRepRqst(e);
			}else if (e.getFormCommand().isCommand(FormCommand.SEARCH03)) {
				eventResponse = checkCntCode(e);
			}else if (e.getFormCommand().isCommand(FormCommand.SEARCH04)) {
				eventResponse = checkOfcCode(e);
			}else if (e.getFormCommand().isCommand(FormCommand.SEARCH05)) {
				eventResponse = searchSlsRepMaxSeq(e);
			}			
...
//		}
			...
			array[0][0] = "CD00818";   //1.Office Type
			array[1][0] = "CD00675";   //2.Office Kind
			array[1][2] = "Blank";
			array[2][0] = "CD00673";   //3.Agent Type
			array[2][2] = "Blank"; 
			array[3][0] = "CD01109";   //4.Inactive Sales Org.
			array[4][0] = "CD01109";   //5.Subsidiary Company Flag
			array[5][0] = "CD00677";   //6.Sales Office DIV
			array[6][0] = "CD30005";   //7.Manual Booking Option
			array[6][2] = "Blank" ;
			array[7][0] = "Office" ;   //8.A/R Regional HQ
			array[7][2] = "Blank" ;
			array[8][0] = "CD30009" ;  //9.Alternate Currency
			
			array[9][0] = "CD01320";   //10.Finance Region
			array[9][2] = "Blank" ;
			
			array[10][0] = "CD30001";   //10.PrepaidParty
//			array[10][2] = "Blank" ;
			array[11][0] = "CD00912";  //11.Sub Agent
			
			array[12][0] = "CD00676";  //12.S/O Interface
			array[12][2] = "Blank"; 
			array[13][0] = "CD01109";  //13.Delete Flag
		}else if (e.getEventName().equalsIgnoreCase("BcmCcd0033Event")) {
			array = new String[4][3];
			array[0][0] = "CD00711";
			array[0][2] = "Blank";
...
//		}
			...
			array[8][0] = "CD00831";    //9. Subsidiary Company         		
			array[9][0] = "CD01109";    //10. Address Use Flag
			array[10][0] = "CD01109";   //11. Delt Flag
			array[11][0] = "CD01109";   //12. sheet2 Delete Flag
			array[12][0] = "CD00709";   //13. sheet3 Subject
			array[13][0] = "CD00708";   //14. sheet3 Kind of Service
...
*/			
	...
	private EventResponse searchChargeRqst(Event e) throws EventException {
		...
		try{
			List<ChargeVO> vo = command.searchChargeRqst(event.getRqstNo());
			eventResponse.setRsVoList(vo);
	...
	private EventResponse searchContainerType(Event e) throws EventException {
		...
		try{
			List<ContainerTypeVO> vo = command.searchContainerType(event.getCntrTpCd());
			eventResponse.setRsVoList(vo);
		}catch(EventException ex){
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
		}catch(Exception ex){
	...
	private EventResponse manageContainerType(Event e) throws EventException {
		...
		try {
			ContainerTypeVO[] containerTypeVOs = event.getContainerTypeVOS();
			String usrId = account.getUsr_id();
			
			begin();
			command.manageContainerType(containerTypeVOs, usrId);
			commit();
	...
	private EventResponse searchContainerSize(Event e) throws EventException {
		...
		try{
			List<ContainerSizeVO> vo = command.searchContainerSize(event.getCntrSzCd());
			eventResponse.setRsVoList(vo);
		}catch(EventException ex){
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
		}catch(Exception ex){
	...
	private EventResponse manageContainerSize(Event e) throws EventException {
		...
		try {
			ContainerSizeVO[] containerSizeVOs = event.getContainerSizeVOS();
			String usrId = account.getUsr_id();
			
			begin();
			command.manageContainerSize(containerSizeVOs, usrId);
			commit();
	...
	private EventResponse searchContainerTypeSize(Event e) throws EventException {
		...
		try{
			List<ContainerTypeSizeVO> vo = command.searchContainerTypeSize(event.getCntrTpSzCd());
			eventResponse.setRsVoList(vo);
		}catch(EventException ex){
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
		}catch(Exception ex){
	...
	private EventResponse manageContainerTypeSize(Event e) throws EventException {
		...
		try {
			ContainerTypeSizeVO[] ContainerTypeSizeVOs = event.getContainerTypeSizeVOS();
			String usrId = account.getUsr_id();
			
			begin();
			command.manageContainerTypeSize(ContainerTypeSizeVOs, usrId);
			commit();
	...
	private EventResponse manageMvmtStsCode(Event e) throws EventException {
		...
		try{
			begin();
			command.manageMvmtStsCode(event.getMvmtStsVO());
			commit();
		}catch(EventException ex){
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
		}catch(Exception ex){
...
//			eventResponse.setUserMessage((String) new ErrorHandler("PRI00101",new String[]{}).getUserMessage());
	...
	private EventResponse manageLseCoYd(Event e) throws EventException {
		...
		try{
			...
			command.manageLseCoYd(lseCoYdVO);
			commit();
		}catch(EventException ex){
			rollback();
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
	...
	private EventResponse manageDyLgtSavTm(Event e) throws EventException {
		...
		try{
			...
			command.manageDyLgtSavTm(dystVO);
			commit();
		}catch(EventException ex){
			rollback();
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
	 ...
	 * @exception EventException
	 */
	private EventResponse searchSlsRepRqst(Event e) throws EventException {
		// PDTO(Data Transfer Object including Parameters)
		GeneralEventResponse eventResponse = new GeneralEventResponse();
		BcmCcd0033Event event = (BcmCcd0033Event)e;
		SalesRepresentativeBC command = new SalesRepresentativeBCImpl();
		...
		try{
			SalesRepVO vo = command.searchSlsRepRqst(event.getRqstNo());
			eventResponse.setRsVo(vo);
			eventResponse.setETCData("RQST_NO", event.getRqstNo());
		}catch(EventException ex){
			throw new EventException(new ErrorHandler(ex).getMessage(),ex);
...
//                    List<CustomerContactVO> custCntcRqstVOs = ptnCommand.searchCustCntcRqst(rqstNo);
					...
					List<ChargeVO> vo = command.searchChargeRqst(rqstNo);
					vo.get(0).setIbflag("I");
