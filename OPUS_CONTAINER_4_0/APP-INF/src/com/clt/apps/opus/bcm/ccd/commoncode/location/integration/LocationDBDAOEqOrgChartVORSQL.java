...
*@FileName : LocationDBDAOEqOrgChartVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOEqOrgChartVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOEqOrgChartVORSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.bcm.ccd.commoncode.location.integration").append("\n"); 
		query.append("FileName : LocationDBDAOEqOrgChartVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT 'SCC_CD' SCC_CD," ).append("\n"); 
