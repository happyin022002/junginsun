...
*@FileName : CommodityDBDAOSearchPackageTypeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOSearchPackageTypeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.08 조인영 Package Type 정보를 조회한다.
	  * </pre>
	  */
	public CommodityDBDAOSearchPackageTypeRSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOSearchPackageTypeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
