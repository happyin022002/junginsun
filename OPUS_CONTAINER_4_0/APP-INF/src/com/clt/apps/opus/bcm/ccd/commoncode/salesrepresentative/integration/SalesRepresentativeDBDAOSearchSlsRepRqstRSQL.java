...
*@FileName : SalesRepresentativeDBDAOSearchSlsRepRqstRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class SalesRepresentativeDBDAOSearchSlsRepRqstRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request SlsRepCode 조회
	  * </pre>
	  */
	public SalesRepresentativeDBDAOSearchSlsRepRqstRSQL(){
		setQuery();
		...
		query.append("FileName : SalesRepresentativeDBDAOSearchSlsRepRqstRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  FROM MDM_SLS_REP_RQST" ).append("\n"); 
