...
*@FileName : OfcAccGrpVO.java
*@FileTitle : OfcAccGrpVO
*Open Issues :
*Change history :
...
public class OfcAccGrpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OfcAccGrpVO> models = new ArrayList<OfcAccGrpVO>();
	...
	public OfcAccGrpVO(String ibflag, String pagerows, String subSysCd, String ofcGrpId, String ofcGrpNm, String ofcGrpDesc, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return OfcAccGrpVO[]
	 */
	public OfcAccGrpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OfcAccGrpVO[]
	 */
	public OfcAccGrpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OfcAccGrpVO model = null;
	...
	public OfcAccGrpVO[] getOfcAccGrpVOs(){
		OfcAccGrpVO[] vos = (OfcAccGrpVO[])models.toArray(new OfcAccGrpVO[models.size()]);
		return vos;
	}
