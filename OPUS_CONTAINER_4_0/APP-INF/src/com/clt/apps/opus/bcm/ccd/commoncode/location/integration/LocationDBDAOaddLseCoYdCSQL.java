...
*@FileName : LocationDBDAOaddLseCoYdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddLseCoYdCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 신규 Leasing Company Yard 정보를 저장합니다.
	  * </pre>
	  */
	public LocationDBDAOaddLseCoYdCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddLseCoYdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
