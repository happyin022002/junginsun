...
*@FileName : BCM_CCD_0030HTMLAction.java
*@FileTitle : trade
*Open Issues :
*Change history :
...
public class BCM_CCD_0030HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0030HTMLAction 객체를 생성
	 */
	public BCM_CCD_0030HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0030Event event = new BcmCcd0030Event();
		

		if(command.isCommand(FormCommand.SEARCH02)) {
			event.setTradeCd(request.getParameter("trd_cd"));
		}else if(command.isCommand(FormCommand.MULTI01)) {
			event.setTradeVO((TradeVO)getVO(request, TradeVO .class));
