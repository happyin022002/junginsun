...
*@FileName : SubContinentVO.java
*@FileTitle : SubContinentVO
*Open Issues :
*Change history :
...
public class SubContinentVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SubContinentVO> models = new ArrayList<SubContinentVO>();
	...
	public SubContinentVO() {}

	public SubContinentVO(String ibflag, String pagerows, String scontiCd, String contiCd, String scontiNm, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String usrId) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public SubContinentVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SubContinentVO[]
	 */
	public SubContinentVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SubContinentVO model = null;
	 ...
	 * @return SubContinentVO[]
	 */
	public SubContinentVO[] getSubContinentVOs(){
		SubContinentVO[] vos = (SubContinentVO[])models.toArray(new SubContinentVO[models.size()]);
		return vos;
	}
