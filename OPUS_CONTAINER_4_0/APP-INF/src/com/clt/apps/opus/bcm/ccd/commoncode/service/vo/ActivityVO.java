...
public class ActivityVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ActivityVO> models = new ArrayList<ActivityVO>();
...
/**
	 ...
	 * @return ActivityVO[]
	 */
	public ActivityVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ActivityVO[]
	 */
	public ActivityVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ActivityVO model = null;
	...
	public ActivityVO[] getActivityVOs(){
		ActivityVO[] vos = (ActivityVO[])models.toArray(new ActivityVO[models.size()]);
		return vos;
	}
