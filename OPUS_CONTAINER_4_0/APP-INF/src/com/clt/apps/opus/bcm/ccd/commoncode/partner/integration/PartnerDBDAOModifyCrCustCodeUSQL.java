...
*@FileName : PartnerDBDAOModifyCrCustCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class PartnerDBDAOModifyCrCustCodeUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Credit Customer Code 수정한다
	  * </pre>
	  */
	public PartnerDBDAOModifyCrCustCodeUSQL(){
		setQuery();
		...
		query.append("FileName : PartnerDBDAOModifyCrCustCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
