...
*@FileName : ContainerTypeSizeVO.java
*@FileTitle : ContainerTypeSizeVO
*Open Issues :
*Change history :
...
public class ContainerTypeSizeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ContainerTypeSizeVO> models = new ArrayList<ContainerTypeSizeVO>();
...
/**
	 ...
	 */
	public ContainerTypeSizeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ContainerTypeSizeVO[]
	 */
	public ContainerTypeSizeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ContainerTypeSizeVO model = null;
		...
		return getContainerTypeSizeVOs();
	}
	...
	public ContainerTypeSizeVO[] getContainerTypeSizeVOs(){
		ContainerTypeSizeVO[] vos = (ContainerTypeSizeVO[])models.toArray(new ContainerTypeSizeVO[models.size()]);
		return vos;
	}
