...
*@FileName : BCM_CCD_0014HTMLAction.java
*@FileTitle : contient
*Open Issues :
*Change history :
...
public class BCM_CCD_0014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0014HTMLAction 객체를 생성
	 */
	public BCM_CCD_0014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0014Event event = new BcmCcd0014Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {
			event.setContiCd(request.getParameter("conti_cd"));
