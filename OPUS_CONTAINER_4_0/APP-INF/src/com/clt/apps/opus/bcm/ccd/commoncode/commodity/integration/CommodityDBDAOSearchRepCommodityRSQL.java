...
*@FileName : CommodityDBDAOSearchRepCommodityRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CommodityDBDAOSearchRepCommodityRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.03.03 조인영 Rep Commodity 정보를 조회한다.
	  * </pre>
	  */
	public CommodityDBDAOSearchRepCommodityRSQL(){
		setQuery();
		...
		query.append("FileName : CommodityDBDAOSearchRepCommodityRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
