...
*@FileName : BCM_CCD_0009HTMLAction.java
...
public class BCM_CCD_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * BCM_CCD_0009HTMLAction 객체를 생성
	 */
	public BCM_CCD_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		BcmCcd0009Event event = new BcmCcd0009Event();
		
		if(command.isCommand(FormCommand.MULTI)) {
			event.setGrpCommodityVOS((GrpCommodityVO[])getVOs(request, GrpCommodityVO.class, "sheet1_"));
			
		} else if(command.isCommand(FormCommand.SEARCH)) {
			event.setGrpCommodityVO((GrpCommodityVO)getVO(request, GrpCommodityVO.class));
			event.setGrpCmdtCd(request.getParameter("grp_cmdt_cd"));
		}
