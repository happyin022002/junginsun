...
*@FileName : LocationDBDAOaddLocCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddLocCodeCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 신규 Location 정보를 저장합니다.
	  * </pre>
	  */
	public LocationDBDAOaddLocCodeCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddLocCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_LOCATION (" ).append("\n"); 
