...
*@FileName : AssetDBDAOSearchContainerVesselRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AssetDBDAOSearchContainerVesselRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 2011.02.28 조인영 Container Vessel 정보를 조회한다.
	  * </pre>
	  */
	public AssetDBDAOSearchContainerVesselRSQL(){
		setQuery();
		...
		query.append("FileName : AssetDBDAOSearchContainerVesselRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--      ,SUBSTR(VSL_CLZ_DT,1,4)||'-'||SUBSTR(VSL_CLZ_DT,5,2)||'-'||SUBSTR(VSL_CLZ_DT,7) AS VSL_CLZ_DT" ).append("\n"); 
