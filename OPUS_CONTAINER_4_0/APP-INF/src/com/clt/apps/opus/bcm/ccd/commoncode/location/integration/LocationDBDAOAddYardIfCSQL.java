...
*@FileName : LocationDBDAOAddYardIfCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOAddYardIfCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Yard 정보 및 처리상태를 다른 시스템으로 전송하기 위해 저장한다.
	  * </pre>
	  */
	public LocationDBDAOAddYardIfCSQL(){
		setQuery();
		...
		params.put("yd_if_seq",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : LocationDBDAOAddYardIfCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO MDM_YARD_IF(" ).append("\n"); 
		query.append("             YD_IF_SEQ" ).append("\n"); 
		...
		query.append("            )" ).append("\n"); 
		query.append("    VALUES(  @[yd_if_seq]" ).append("\n"); 
		query.append("            ,@[yd_cd]" ).append("\n"); 
		query.append("            ,@[yd_nm]" ).append("\n"); 
