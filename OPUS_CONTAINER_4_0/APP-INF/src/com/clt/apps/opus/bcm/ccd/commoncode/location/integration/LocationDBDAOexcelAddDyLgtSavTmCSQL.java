...
*@FileName : LocationDBDAOexcelAddDyLgtSavTmCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOexcelAddDyLgtSavTmCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOexcelAddDyLgtSavTmCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOexcelAddDyLgtSavTmCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("MERGE INTO MDM_DYLGT_SAV_TM" ).append("\n"); 
		query.append("USING DUAL" ).append("\n"); 
		query.append("ON (DST_ID = @[dst_id] )" ).append("\n"); 
		...
		query.append("          INSERT (	DST_ID," ).append("\n"); 
		...
		query.append("			VALUES (@[dst_id]," ).append("\n"); 
		query.append("				    @[dst_cnt_cd]," ).append("\n"); 
		query.append("				    @[dst_not_aply_ste_cd]," ).append("\n"); 
		query.append("				    @[dst_yr]," ).append("\n"); 
		query.append("				    @[dst_mnts]," ).append("\n"); 
