...
*@FileName : LocationDBDAOaddYardCodeCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOaddYardCodeCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOaddYardCodeCSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOaddYardCodeCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("  NVL(@[rail_arr_ntfc_flg],'N')," ).append("\n"); 
		query.append("  @[modi_yd_cd]," ).append("\n"); 
