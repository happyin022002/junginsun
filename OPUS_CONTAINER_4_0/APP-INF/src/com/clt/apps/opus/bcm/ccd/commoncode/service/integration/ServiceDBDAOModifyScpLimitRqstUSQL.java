...
*@FileName : ServiceDBDAOModifyScpLimitRqstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOModifyScpLimitRqstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Request scp code limit 수정
	  * </pre>
	  */
	public ServiceDBDAOModifyScpLimitRqstUSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOModifyScpLimitRqstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE MDM_SVC_SCP_LMT_RQST" ).append("\n"); 
