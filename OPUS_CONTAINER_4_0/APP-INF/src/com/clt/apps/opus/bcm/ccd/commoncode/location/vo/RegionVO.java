...
public class RegionVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RegionVO> models = new ArrayList<RegionVO>();
	...
	public RegionVO(String ibflag, String pagerows, String rgnCd, String rgnNm, String cntCd, String deltFlg, String creUsrId, String creDt, String updUsrId, String updDt, String usrId) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return RegionVO[]
	 */
	public RegionVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RegionVO[]
	 */
	public RegionVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RegionVO model = null;
	 ...
	 * @return RegionVO[]
	 */
	public RegionVO[] getRegionVOs(){
		RegionVO[] vos = (RegionVO[])models.toArray(new RegionVO[models.size()]);
		return vos;
	}
