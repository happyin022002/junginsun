...
*@FileName : MstMgmtDBDAOSearchMdmDatProcRequestListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MstMgmtDBDAOSearchMdmDatProcRequestListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * MDM_DAT_PROC Request List 정보 조회
	  * </pre>
	  */
	public MstMgmtDBDAOSearchMdmDatProcRequestListRSQL(){
		setQuery();
		...
		query.append("FileName : MstMgmtDBDAOSearchMdmDatProcRequestListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("" ).append("\n"); 
		query.append("(SELECT P.RQST_NO," ).append("\n"); 
		...
		query.append("       'OPEN' AS PROC_TP_NM," ).append("\n"); 
		...
		query.append("	   " ).append("\n"); 
		query.append("       CASE P.MST_DAT_SUBJ_CD" ).append("\n"); 
		query.append("         WHEN 'CUST' THEN (SELECT DECODE(CUST_SEQ, 0, '', CUST_CNT_CD || LPAD(CUST_SEQ, 6, '0')) FROM MDM_CUST_RQST CR WHERE CR.RQST_NO = P.RQST_NO )" ).append("\n"); 
		query.append("         WHEN 'GCST' THEN (SELECT CUST_GRP_ID FROM MDM_CUST_PERF_GRP_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("		 WHEN 'VNDR' THEN (SELECT TO_CHAR(VNDR_SEQ) FROM MDM_VNDR_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("		 WHEN 'CARR' THEN (SELECT CRR_CD FROM MDM_CRR_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("		 WHEN 'CHRG' THEN (SELECT CHG_CD FROM MDM_CHG_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("		 WHEN 'VESL' THEN (SELECT VSL_CD FROM MDM_VSL_CNTR_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("		 WHEN 'CMDT' THEN (SELECT CMDT_CD FROM MDM_CMDT_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'LOCA' THEN (SELECT LOC_CD FROM MDM_LOC_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'REVL' THEN (SELECT RLANE_CD FROM MDM_REV_LANE_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'SCVL' THEN (SELECT VSL_SLAN_CD FROM MDM_VSL_SVC_LANE_RQST CR	WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'SREP' THEN (SELECT SREP_CD FROM MDM_SLS_REP_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'SVSP' THEN (SELECT SVC_SCP_CD FROM MDM_SVC_SCP_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'TRDE' THEN (SELECT TRD_CD FROM MDM_TRD_RQST CR WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'YARD' THEN (SELECT YD_CD FROM MDM_YD_RQST CR	WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         WHEN 'ZONE' THEN (SELECT ZN_CD FROM MDM_ZN_RQST CR	WHERE CR.RQST_NO = P.RQST_NO)" ).append("\n"); 
		query.append("         ELSE ''" ).append("\n"); 
		query.append("       END RQST_CD," ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("       RQST_UPD_DT," ).append("\n"); 
		query.append("       (SELECT SUBSTR(LOC_CD, 0, 2) FROM MDM_CUST_RQST WHERE RQST_NO = P.RQST_NO) CNT_CD," ).append("\n"); 
		query.append("       (SELECT OFC_CD FROM MDM_CUST_RQST WHERE RQST_NO = P.RQST_NO) OFC_CD," ).append("\n"); 
		query.append("       (SELECT USR_NM FROM COM_USER WHERE USR_ID = P.RQST_USR_ID) RQST_USR_NM" ).append("\n"); 
		query.append("  FROM MDM_DAT_PROC P," ).append("\n"); 
		query.append("       MDM_USR_AUTH A" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append(" WHERE 1=1" ).append("\n"); 
		query.append("	 #if (${mdaa_chk} == 'Y')" ).append("\n"); 
		query.append("	   --A.MST_DAT_SUBJ_CD = 'MDAA'" ).append("\n"); 
		query.append("      #else" ).append("\n"); 
		...
		query.append("             AND A.AUTH_TP_CD <> 'R' " ).append("\n"); 
		...
		query.append("#end" ).append("\n"); 
		query.append(") XX" ).append("\n"); 
		query.append("ORDER BY XX.RQST_UPD_DT DESC" ).append("\n"); 
