...
*@FileName : OfcAccGrpMapVO.java
*@FileTitle : OfcAccGrpMapVO
*Open Issues :
*Change history :
...
public class OfcAccGrpMapVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OfcAccGrpMapVO> models = new ArrayList<OfcAccGrpMapVO>();
	...
	public OfcAccGrpMapVO() {}

	public OfcAccGrpMapVO(String ibflag, String pagerows, String ofcGrpId, String subSysCd, String ofcCd, String creUsrId, String creDt, String updUsrId, String updDt, String curOfcCd) {
		this.updDt = updDt;
...
/**
	 ...
	 */
	public OfcAccGrpMapVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OfcAccGrpMapVO[]
	 */
	public OfcAccGrpMapVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OfcAccGrpMapVO model = null;
	...
	public OfcAccGrpMapVO[] getOfcAccGrpMapVOs(){
		OfcAccGrpMapVO[] vos = (OfcAccGrpMapVO[])models.toArray(new OfcAccGrpMapVO[models.size()]);
		return vos;
	}
