...
*@FileName : ServiceDBDAOSearchMvmtStsCodeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class ServiceDBDAOSearchMvmtStsCodeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Movement Status Code로 상세 정보 조회하는 쿼리
	  * </pre>
	  */
	public ServiceDBDAOSearchMvmtStsCodeRSQL(){
		setQuery();
		...
		query.append("FileName : ServiceDBDAOSearchMvmtStsCodeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT MVMT_STS_NM" ).append("\n"); 
