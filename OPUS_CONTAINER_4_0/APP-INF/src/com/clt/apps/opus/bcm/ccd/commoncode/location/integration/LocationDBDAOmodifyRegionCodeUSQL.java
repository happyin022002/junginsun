...
*@FileName : LocationDBDAOmodifyRegionCodeUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LocationDBDAOmodifyRegionCodeUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LocationDBDAOmodifyRegionCodeUSQL(){
		setQuery();
		...
		query.append("FileName : LocationDBDAOmodifyRegionCodeUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	RGN_NM = @[rgn_nm]" ).append("\n"); 
