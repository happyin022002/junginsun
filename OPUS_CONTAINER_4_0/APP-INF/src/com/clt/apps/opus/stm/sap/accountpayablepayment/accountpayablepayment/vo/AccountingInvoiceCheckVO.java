 ...
 *@FileName : AccountingInvoiceCheckVO.java
 *@FileTitle : AccountingInvoiceCheckVO
 *Open Issues :
 *Change history :
 ...
 * @see	..
 */
public class AccountingInvoiceCheckVO	extends	 AbstractValueObject
{

	private	 static final long serialVersionUID = 1L;

	private	 Collection<AccountingInvoiceCheckVO>  models =	new	ArrayList<AccountingInvoiceCheckVO>();
	...
	/**	Constructor	*/
	public AccountingInvoiceCheckVO(){}

	public AccountingInvoiceCheckVO(String accountingRequestId,String ibflag,String usrId,String accountingHeaderId,String invSeq,String accountingEventId,String pagerows,String functionalCurrency,String acctJournalType,String acctGainLossCoa)	{
 ...
 //	Getters	and	Setters
	...
	*/
	 ...
	 * @param request
	 * @return AccountingInvoiceCheckVO[]
	 */
	public AccountingInvoiceCheckVO[]	fromRequestGrid(HttpServletRequest request)	{
	 ...
	 * @return AccountingInvoiceCheckVO[]
	 */
	public AccountingInvoiceCheckVO[]	fromRequestGrid(HttpServletRequest request,	String prefix) {
		AccountingInvoiceCheckVO model = null;
		...
		try	{
				...
				for	(int i = 0;	i <	length;	i++) {
					model =	new	AccountingInvoiceCheckVO();
		...
		return getAccountingInvoiceCheckVOs();
	}
	 ...
	 * @return AccountingInvoiceCheckVO[]
	 */
	public AccountingInvoiceCheckVO[]	 getAccountingInvoiceCheckVOs(){
		AccountingInvoiceCheckVO[] vos = (AccountingInvoiceCheckVO[])models.toArray(new	AccountingInvoiceCheckVO[models.size()]);
		return vos;
		}
