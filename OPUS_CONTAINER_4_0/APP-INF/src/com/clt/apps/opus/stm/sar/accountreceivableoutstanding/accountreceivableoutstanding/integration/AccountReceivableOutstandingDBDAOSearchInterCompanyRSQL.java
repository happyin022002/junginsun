...
*@FileName : AccountReceivableOutstandingDBDAOSearchInterCompanyRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOSearchInterCompanyRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOSearchInterCompanyRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOSearchInterCompanyRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
