...
*@FileName : AccountPayablePaymentDBDAOSearchAccountingPaymentLineCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOSearchAccountingPaymentLineCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchAccountingPaymentLineCheck
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOSearchAccountingPaymentLineCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOSearchAccountingPaymentLineCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
