...
*@FileName : AccountReceivableAdjustDBDAOremoveAutoSettlementDelCheckListDSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOremoveAutoSettlementDelCheckListDSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOremoveAutoSettlementDelCheckListDSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAdjustDBDAOremoveAutoSettlementDelCheckListDSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("DELETE FROM SAR_AUTO_STL_TMP" ).append("\n"); 
		query.append("WHERE ADJ_TP_CD = @[adj_tp_cd]" ).append("\n"); 
