...
*@FileName : StatementCommonDBDAORevenuePortEachLaneCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAORevenuePortEachLaneCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * insert RevenuePortEachLane
	  * </pre>
	  */
	public StatementCommonDBDAORevenuePortEachLaneCSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAORevenuePortEachLaneCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCO_REV_LANE_PORT_INFO (" ).append("\n"); 
