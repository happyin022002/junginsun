...
*@FileName : RegionListVO.java
*@FileTitle : RegionListVO
*Open Issues :
*Change history :
...
public class RegionListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RegionListVO> models = new ArrayList<RegionListVO>();
	...
	public RegionListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @return RegionListVO[]
	 */
	public RegionListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RegionListVO[]
	 */
	public RegionListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RegionListVO model = null;
	 ...
	 * @return RegionListVO[]
	 */
	public RegionListVO[] getRegionListVOs(){
		RegionListVO[] vos = (RegionListVO[])models.toArray(new RegionListVO[models.size()]);
		return vos;
	}
