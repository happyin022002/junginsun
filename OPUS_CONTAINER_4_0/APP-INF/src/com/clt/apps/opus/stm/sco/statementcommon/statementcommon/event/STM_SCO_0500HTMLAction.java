...
*@FileName : STM_SCO_0500HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
/**
 * HTTP Parser<br>
 * - Parsing 한 정보를 Event로 변환, request에 담아 AccountReceivableCommonC로 실행요청<br>
...
public class STM_SCO_0500HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SCO_0500HTMLAction 객체를 생성
	 */
	public STM_SCO_0500HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSco0500Event event = new StmSco0500Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			// 조회할 조건 VO 를 넘김 
			SakuraInterfaceCondVO vo = (SakuraInterfaceCondVO)getVO(request, SakuraInterfaceCondVO.class);
			event.setSakuraInterfaceCondVO(vo);				
		}
