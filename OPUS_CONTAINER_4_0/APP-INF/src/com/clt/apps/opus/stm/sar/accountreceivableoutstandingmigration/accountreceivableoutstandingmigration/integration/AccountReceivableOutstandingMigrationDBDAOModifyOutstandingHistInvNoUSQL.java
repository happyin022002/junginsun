...
*@FileName : AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHistInvNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHistInvNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Update Invoice No to OTS historye
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHistInvNoUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHistInvNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  OPUSADM_TMP.SAR_OTS_HIS SET" ).append("\n"); 
		...
		query.append("AND     INV_NO = '**********'" ).append("\n"); 
