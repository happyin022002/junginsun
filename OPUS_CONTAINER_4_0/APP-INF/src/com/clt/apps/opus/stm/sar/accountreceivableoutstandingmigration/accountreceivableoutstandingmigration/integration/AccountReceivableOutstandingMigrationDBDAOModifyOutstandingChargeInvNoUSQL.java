...
*@FileName : AccountReceivableOutstandingMigrationDBDAOModifyOutstandingChargeInvNoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOModifyOutstandingChargeInvNoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OTS Charge 에 Invoice No Update
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOModifyOutstandingChargeInvNoUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOModifyOutstandingChargeInvNoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
