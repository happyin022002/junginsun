...
*@FileName : STM_SAR_4002HTMLAction.java
*@FileTitle :
*Open Issues :
*Change history :
*@LastModifyDate :
 ...
 * @author
 * @see StmSar4002Event 참조
 * @since J2EE 1.4
 */

public class STM_SAR_4002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_4002HTMLAction 객체를 생성
	 */
	public STM_SAR_4002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar4002Event event = new StmSar4002Event();
