...
*@FileName : StatementCommonDBDAOAddLedgerCodeCombinationCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOAddLedgerCodeCombinationCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddLedgerCodeCombination
	  * </pre>
	  */
	public StatementCommonDBDAOAddLedgerCodeCombinationCSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOAddLedgerCodeCombinationCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                , NVL( (SELECT ACCTG_MNG_TP_CD FROM MDM_ACCOUNT MA WHERE MA.ACCT_CD = @[sgm_ctnt4] ), 'A' )" ).append("\n"); 
		query.append("                , @[enbl_flg]" ).append("\n"); 
		query.append("                , @[sgm_ctnt1]" ).append("\n"); 
		query.append("                , @[sgm_ctnt2]" ).append("\n"); 
		query.append("                , @[sgm_ctnt3]" ).append("\n"); 
		...
		query.append("                , REPLACE(@[coa_end_dt],'-','')" ).append("\n"); 
		query.append("   )" ).append("\n"); 
