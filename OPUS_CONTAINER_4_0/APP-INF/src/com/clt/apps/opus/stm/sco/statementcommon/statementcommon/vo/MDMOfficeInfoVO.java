...
*@FileName : MDMOfficeInfoVO.java
*@FileTitle : MDMOfficeInfoVO
*Open Issues :
*Change history :
...
public class MDMOfficeInfoVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MDMOfficeInfoVO> models = new ArrayList<MDMOfficeInfoVO>();
...
/**
	 ...
	 */
	public MDMOfficeInfoVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MDMOfficeInfoVO[]
	 */
	public MDMOfficeInfoVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MDMOfficeInfoVO model = null;
	 ...
	 * @return MDMOfficeInfoVO[]
	 */
	public MDMOfficeInfoVO[] getMDMOfficeInfoVOs(){
		MDMOfficeInfoVO[] vos = (MDMOfficeInfoVO[])models.toArray(new MDMOfficeInfoVO[models.size()]);
		return vos;
	}
