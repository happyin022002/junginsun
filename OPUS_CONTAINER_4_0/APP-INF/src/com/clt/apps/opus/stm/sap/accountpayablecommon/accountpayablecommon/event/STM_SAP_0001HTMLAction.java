...
*@FileName : STM_SAP_0001HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0001Event event = new StmSap0001Event();
		
        // 전성운 추가 시작
    	if(command.isCommand(FormCommand.SEARCH)) {								
			
			String ofcCd = JSPUtil.getParameter(request, "ofc_cd" , "");
			String str_security_flag = JSPUtil.getParameter(request, "str_security_flag" , "");
			
			event.setOfccd(ofcCd);
			event.setStr_security_flag(str_security_flag);
		}    	
        // 전성운 추가 끝
