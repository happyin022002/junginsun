...
*@FileName : AccountPayablePaymentDBDAOAddAccountingEventPrepayUnApplyInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingEventPrepayUnApplyInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingEventPrepayUnApplyInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingEventPrepayUnApplyInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingEventPrepayUnApplyInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , 'PREPAYMENT UNAPPLICATION' AS ACCTG_EVNT_TP_CD" ).append("\n"); 
