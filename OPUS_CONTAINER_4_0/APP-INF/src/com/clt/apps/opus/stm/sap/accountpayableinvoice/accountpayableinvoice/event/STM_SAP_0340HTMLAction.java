...
*@FileName : STM_SAP_0340HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0340HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0340HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0340Event event = new StmSap0340Event();
		

		if(command.isCommand(FormCommand.COMMAND01)) {		
			SapCommonVO vo = (SapCommonVO)getVO(request, SapCommonVO .class);
			event.setSapCommonVO(vo);	
		}
