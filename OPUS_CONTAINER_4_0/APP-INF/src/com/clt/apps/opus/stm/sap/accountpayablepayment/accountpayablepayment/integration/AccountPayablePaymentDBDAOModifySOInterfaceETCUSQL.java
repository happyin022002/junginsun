...
*@FileName : AccountPayablePaymentDBDAOModifySOInterfaceETCUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOModifySOInterfaceETCUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifySOInterfaceETC
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOModifySOInterfaceETCUSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOModifySOInterfaceETCUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("--SET AP_PAY_DT = to_date(?, 'YYYY-MM-DD HH24:MI:SS'), AP_PAY_AMT = ?, AP_PAY_FLG = 'Y', INV_STS_CD = 'D' " ).append("\n"); 
		query.append("--WHERE CSR_NO = ?" ).append("\n"); 
		query.append("UPDATE  AP_PAY_INV  A" ).append("\n"); 
		query.append("SET (A.AP_PAY_AMT, A.AP_PAY_DT, A.INV_STS_CD, A.AP_PAY_FLG)" ).append("\n"); 
		query.append("    = (" ).append("\n"); 
