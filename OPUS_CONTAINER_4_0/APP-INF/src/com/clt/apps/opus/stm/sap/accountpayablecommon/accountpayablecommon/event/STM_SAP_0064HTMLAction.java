...
*@FileName : STM_SAP_0064HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : sangyoung cha
*@LastModifier : 2014.03.30
*@LastVersion : 1.0
* 
* 1.0 Creation
=========================================================*/
...
public class STM_SAP_0064HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0081HTMLAction 객체를 생성
	 */
	public STM_SAP_0064HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0064Event event = new StmSap0064Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setPopPayInvoiceInfomationListVO((PopPayInvoiceInfomationListVO) getVO(request, PopPayInvoiceInfomationListVO.class));
		}
