...
*@FileName : AccountReceivableOutstandingMigrationDBDAOCheckOutstandingDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOCheckOutstandingDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Outstanding Detail 존재여부 체크
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOCheckOutstandingDetailRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOCheckOutstandingDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
