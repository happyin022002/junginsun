...
public class StmSar2003Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	private ReceiptListByChequeCondVO receiptListByChequeCondVO = null;
	
	public ReceiptListByChequeCondVO getReceiptListByChequeCondVO() {
		return receiptListByChequeCondVO;
	}
	public void setReceiptListByChequeCondVO( ReceiptListByChequeCondVO receiptListByChequeCondVO) {
		this.receiptListByChequeCondVO = receiptListByChequeCondVO;
	}	
