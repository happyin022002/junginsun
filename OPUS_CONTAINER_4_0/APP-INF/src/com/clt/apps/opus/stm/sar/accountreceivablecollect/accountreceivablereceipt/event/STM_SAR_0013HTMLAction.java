...
*@FileName : STM_SAR_0013HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author 
 * @see StmSar0013Event 참조
 * @since J2EE 1.4
 */

public class STM_SAR_0013HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_0013HTMLAction 객체를 생성
	 */
	public STM_SAR_0013HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar0013Event event = new StmSar0013Event();
