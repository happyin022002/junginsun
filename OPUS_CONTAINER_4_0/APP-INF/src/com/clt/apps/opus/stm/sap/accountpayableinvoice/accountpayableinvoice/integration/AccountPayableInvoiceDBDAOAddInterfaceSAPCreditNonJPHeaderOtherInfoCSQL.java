...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPCreditNonJPHeaderOtherInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPCreditNonJPHeaderOtherInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPCreditNonJPHeaderOtherInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPCreditNonJPHeaderOtherInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPCreditNonJPHeaderOtherInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                                        AND     SSCC.SRC_CD = MA.MODI_ACCT_CD AND SSCC.USE_FLG = 'Y' AND SSCC.DELT_FLG = 'N' AND ROWNUM = 1)), --2015.02.11 수정 " ).append("\n"); 
		query.append("                                                  'A106') )" ).append("\n"); 
		query.append("                                ELSE NULL END                       AS COST_CENTER " ).append("\n"); 
