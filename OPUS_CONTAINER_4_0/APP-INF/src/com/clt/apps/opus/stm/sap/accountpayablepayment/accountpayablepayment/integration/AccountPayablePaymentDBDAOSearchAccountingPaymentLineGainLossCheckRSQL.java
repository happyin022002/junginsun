...
*@FileName : AccountPayablePaymentDBDAOSearchAccountingPaymentLineGainLossCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOSearchAccountingPaymentLineGainLossCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchAccountingPaymentLineGainLossCheck
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOSearchAccountingPaymentLineGainLossCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOSearchAccountingPaymentLineGainLossCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , TO_CHAR(SPD.ACCTG_DT, 'YYYYMM') AS PAY_GL_YYMM" ).append("\n"); 
		...
		query.append("      , SPD.PAY_AMT                     AS PAY_AMT" ).append("\n"); 
