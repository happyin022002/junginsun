...
*@FileName : CreateOtsLedgerListVO.java
*@FileTitle : CreateOtsLedgerListVO
*Open Issues :
*Change history :
...
public class CreateOtsLedgerListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CreateOtsLedgerListVO> models = new ArrayList<CreateOtsLedgerListVO>();
...
/**
	 ...
	 */
	public CreateOtsLedgerListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CreateOtsLedgerListVO[]
	 */
	public CreateOtsLedgerListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CreateOtsLedgerListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new CreateOtsLedgerListVO();
				if (funcCurr[i] != null)
		...
		return getCreateOtsLedgerListVOs();
	}
	 ...
	 * @return CreateOtsLedgerListVO[]
	 */
	public CreateOtsLedgerListVO[] getCreateOtsLedgerListVOs(){
		CreateOtsLedgerListVO[] vos = (CreateOtsLedgerListVO[])models.toArray(new CreateOtsLedgerListVO[models.size()]);
		return vos;
	}
