...
*@FileName : AccountReceivableOutstandingMigrationDBDAOAddOutstandingDistributionCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOAddOutstandingDistributionCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOAddOutstandingDistributionCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOAddOutstandingDistributionCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO OPUSADM_TMP.SAR_OTS_DTRB " ).append("\n"); 
		...
		query.append("       OPUSADM_TMP.SAR_OTS_DTRB_SEQ.NEXTVAL" ).append("\n"); 
		query.append("     , @[ots_his_seq]" ).append("\n"); 
		query.append("     , @[ots_cd_cmb_seq]" ).append("\n"); 
		query.append("     , @[inp_dr_amt]" ).append("\n"); 
		query.append("     , @[inp_cr_amt]" ).append("\n"); 
