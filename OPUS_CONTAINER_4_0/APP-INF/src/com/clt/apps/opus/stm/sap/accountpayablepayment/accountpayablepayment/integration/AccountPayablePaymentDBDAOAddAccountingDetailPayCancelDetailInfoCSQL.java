...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPayCancelDetailInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPayCancelDetailInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPayCancelDetailInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPayCancelDetailInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPayCancelDetailInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  , DECODE(SIGN(SPD.PAY_AMT), -1, NULL, SPD.PAY_AMT)                                            AS INP_DR_AMT" ).append("\n"); 
		query.append("                  , DECODE(SIGN(SPD.PAY_AMT), -1, SPD.PAY_AMT * (-1), NULL)                                     AS INP_CR_AMT" ).append("\n"); 
		query.append("                  , DECODE(SIGN(SPD.PAY_AMT), -1, NULL, ROUND(SPD.PAY_AMT * NVL(SIH.INV_XCH_RT,1), " ).append("\n"); 
		...
		query.append("                  , DECODE(SIGN(SPD.PAY_AMT), -1, ROUND((SPD.PAY_AMT * (-1)) * NVL(SIH.INV_XCH_RT,1), " ).append("\n"); 
		...
		query.append("                  , (SELECT SPH.DOC_SEQ FROM SAP_PAY_HDR SPH WHERE SPH.PAY_SEQ = SPD.PAY_SEQ AND ROWNUM = 1) AS ATTR_CTNT4" ).append("\n"); 
