...
*@FileName : AccountReceivableOutstandingMigrationDBDAOSearchASARevenueAmountRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOSearchASARevenueAmountRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOSearchASARevenueAmountRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOSearchASARevenueAmountRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT  #if(${func_curr_cd} == '')" ).append("\n"); 
		...
		query.append("         FROM    OPUSADM_TMP.SAR_OTS_CHG A" ).append("\n"); 
