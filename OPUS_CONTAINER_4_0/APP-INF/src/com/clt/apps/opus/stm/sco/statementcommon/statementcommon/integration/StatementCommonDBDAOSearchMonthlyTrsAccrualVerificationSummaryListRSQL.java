...
*@FileName : StatementCommonDBDAOSearchMonthlyTrsAccrualVerificationSummaryListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOSearchMonthlyTrsAccrualVerificationSummaryListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public StatementCommonDBDAOSearchMonthlyTrsAccrualVerificationSummaryListRSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOSearchMonthlyTrsAccrualVerificationSummaryListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
