...
*@FileName : STM_SAP_0240HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author ORKIM
 * @see STM_SAP_0240HTMLAction 참조
 * @since J2EE 1.6
 */

public class STM_SAP_0240HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0240HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0240Event event = new StmSap0240Event();
