...
*@FileName : STM_SAP_0150HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0150HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0150HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0150Event event = new StmSap0150Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {								
		
			event.setInvoiceAccrualCondVO((InvoiceAccrualCondVO)getVO(request, InvoiceAccrualCondVO.class));
			
		} else if(command.isCommand(FormCommand.MULTI01)) {

			event.setInvoiceAccrualVOs((InvoiceAccrualVO[])getVOs(request, InvoiceAccrualVO.class, "sheet1_"));
