...
*@FileName : AccountReceivableAgentDBDAOSearchASADtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAgentDBDAOSearchASADtlRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableAgentDBDAOSearchASADtlRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAgentDBDAOSearchASADtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   #if (${asa_dtl_seq} != '')" ).append("\n"); 
		query.append("      AND    A.ASA_DTL_SEQ = @[asa_dtl_seq]  " ).append("\n"); 
