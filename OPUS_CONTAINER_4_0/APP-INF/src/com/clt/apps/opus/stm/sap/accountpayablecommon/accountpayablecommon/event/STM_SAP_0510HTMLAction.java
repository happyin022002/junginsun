...
*@FileName : STM_SAP_0510HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author 
 * @see StmSap0510Event 참조
 * @since J2EE 1.4
 */

public class STM_SAP_0510HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0510HTMLAction 객체를 생성
	 */
	public STM_SAP_0510HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0510Event event = new StmSap0510Event();
		
    	if(command.isCommand(FormCommand.SEARCH)) {								
    		String ofcType  = JSPUtil.getParameter(request, "ofc_type" , "");
    		String ofcCd = JSPUtil.getParameter(request, "ofc_cd" , "");
    		String inactiveType = JSPUtil.getParameter(request, "inactive_type" , "");
    		String bankAcctNo = JSPUtil.getParameter(request, "bank_acct_no" , "");
    		
			event.setOfcType(ofcType);
			event.setOfcCd(ofcCd);	
			event.setInactiveType(inactiveType);
