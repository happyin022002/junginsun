...
*@FileName : AccountReceivableOutstandingDBDAOmodifyOutstandingChargeAmtUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOmodifyOutstandingChargeAmtUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OTS Charge 의 Balance Amount 를 Update
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOmodifyOutstandingChargeAmtUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOmodifyOutstandingChargeAmtUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
