...
public class ASADtlVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<ASADtlVO> models = new ArrayList<ASADtlVO>();
	...
	public ASADtlVO(String ibflag, String pagerows, String asaStsCd, String asaNo, String asaDtlSeq, String asaDtlDesc, String asaDrAmt, String asaCrAmt, String effDt, String asaDtlTpCd, String creUsrId, String creDt, String updUsrId, String updDt) {
		this.updDt = updDt;
...
/**
	 ...
	 * @return ASADtlVO[]
	 */
	public ASADtlVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return ASADtlVO[]
	 */
	public ASADtlVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		ASADtlVO model = null;
	 ...
	 * @return ASADtlVO[]
	 */
	public ASADtlVO[] getASADtlVOs(){
		ASADtlVO[] vos = (ASADtlVO[])models.toArray(new ASADtlVO[models.size()]);
		return vos;
	}
