...
*@FileName : AccountPayableCommonDBDAOSearchBankAcctNoDupCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchBankAcctNoDupCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchBankAcctNoDupCheck
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchBankAcctNoDupCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchBankAcctNoDupCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT CASE WHEN COUNT(*) > 0 THEN 'DUP' ELSE 'OK' END AS DUP_CHK" ).append("\n"); 
