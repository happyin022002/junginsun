...
*@FileName : searchPopPayGroupListVO.java
*@FileTitle : searchPopPayGroupListVO
*Open Issues :
*Change history :
...
public class searchPopPayGroupListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<searchPopPayGroupListVO> models = new ArrayList<searchPopPayGroupListVO>();
	...
	public searchPopPayGroupListVO() {}

	public searchPopPayGroupListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return searchPopPayGroupListVO[]
	 */
	public searchPopPayGroupListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return searchPopPayGroupListVO[]
	 */
	public searchPopPayGroupListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		searchPopPayGroupListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new searchPopPayGroupListVO();
				if (ibflag[i] != null)
		...
		return getsearchPopPayGroupListVOs();
	}
	 ...
	 * @return searchPopPayGroupListVO[]
	 */
	public searchPopPayGroupListVO[] getsearchPopPayGroupListVOs(){
		searchPopPayGroupListVO[] vos = (searchPopPayGroupListVO[])models.toArray(new searchPopPayGroupListVO[models.size()]);
		return vos;
	}
