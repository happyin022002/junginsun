...
*@FileName : OfcWrtfTpComboListVO.java
*@FileTitle : OfcWrtfTpComboListVO
*Open Issues :
*Change history :
...
public class OfcWrtfTpComboListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OfcWrtfTpComboListVO> models = new ArrayList<OfcWrtfTpComboListVO>();
	...
	public OfcWrtfTpComboListVO() {}

	public OfcWrtfTpComboListVO(String ibflag, String pagerows, String acctTpCd, String luDesc) {
		this.ibflag = ibflag;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return OfcWrtfTpComboListVO[]
	 */
	public OfcWrtfTpComboListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OfcWrtfTpComboListVO[]
	 */
	public OfcWrtfTpComboListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OfcWrtfTpComboListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new OfcWrtfTpComboListVO();
				if (ibflag[i] != null)
		...
		return getOfcWrtfTpComboListVOs();
	}
	 ...
	 * @return OfcWrtfTpComboListVO[]
	 */
	public OfcWrtfTpComboListVO[] getOfcWrtfTpComboListVOs(){
		OfcWrtfTpComboListVO[] vos = (OfcWrtfTpComboListVO[])models.toArray(new OfcWrtfTpComboListVO[models.size()]);
		return vos;
	}
