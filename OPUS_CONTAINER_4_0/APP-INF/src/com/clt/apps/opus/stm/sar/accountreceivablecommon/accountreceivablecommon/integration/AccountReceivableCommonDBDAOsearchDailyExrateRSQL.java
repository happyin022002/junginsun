...
*@FileName : AccountReceivableCommonDBDAOsearchDailyExrateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCommonDBDAOsearchDailyExrateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableCommonDBDAOsearchDailyExrateRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableCommonDBDAOsearchDailyExrateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   REPLACE(@[xch_rt_dt],'-','') = FM_DT" ).append("\n"); 
