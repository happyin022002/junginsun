...
*@FileName : AccountPayableCommonDBDAOSearchPopUnsettledAccountListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchPopUnsettledAccountListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchPopUnsettledAccountList 조회
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchPopUnsettledAccountListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchPopUnsettledAccountListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND     SLH.LU_TP_CD = 'UNSETTLED ACCOUNT'" ).append("\n"); 
