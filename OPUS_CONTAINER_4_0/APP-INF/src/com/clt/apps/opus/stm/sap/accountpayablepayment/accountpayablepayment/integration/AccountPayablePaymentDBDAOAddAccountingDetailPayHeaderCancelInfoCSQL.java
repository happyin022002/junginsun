...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderCancelInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderCancelInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPayHeaderCancelInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderCancelInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderCancelInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , 'CASH'                           AS ACCTG_LINE_TP_CD" ).append("\n"); 
		...
		query.append("    , DECODE(SIGN(SPH.PAY_AMT * (-1)), -1, SPH.PAY_AMT, NULL)           AS INP_DR_AMT" ).append("\n"); 
		query.append("    , DECODE(SIGN(SPH.PAY_AMT * (-1)), -1, NULL, SPH.PAY_AMT)           AS INP_CR_AMT" ).append("\n"); 
		query.append("    , DECODE(SIGN(SPH.PAY_FUNC_AMT * (-1)), -1, SPH.PAY_FUNC_AMT, NULL) AS ACCT_DR_AMT" ).append("\n"); 
		query.append("    , DECODE(SIGN(SPH.PAY_FUNC_AMT * (-1)), -1, NULL, SPH.PAY_FUNC_AMT) AS ACCT_CR_AMT" ).append("\n"); 
		query.append("    , 'SAP_PAY_HDR'                    AS ACCTG_SRC_TBL_NM" ).append("\n"); 
		...
		query.append("    , 'CASH'                           AS ATTR_CTNT10" ).append("\n"); 
		...
		query.append("    , SBA.ASET_CD_CMB_SEQ              AS ACCT_CD_CMB_SEQ" ).append("\n"); 
