...
*@FileName : AccountReceivableCommonDBDAOaddAdjustReceiptNoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCommonDBDAOaddAdjustReceiptNoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAR_TP_NO 테이블에 insert
	  * </pre>
	  */
	public AccountReceivableCommonDBDAOaddAdjustReceiptNoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableCommonDBDAOaddAdjustReceiptNoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("   SUBSTR(TO_CHAR(GLOBALDATE_PKG.TIME_LOCAL_OFC_FNC((SELECT AR_OFC_CD                                           " ).append("\n"); 
