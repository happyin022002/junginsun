...
*@FileName : AccountReceivableAdjustDBDAOaddOverpaymentOutstandingListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOaddOverpaymentOutstandingListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * addOverpaymentOutstandingList
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOaddOverpaymentOutstandingListCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAdjustDBDAOaddOverpaymentOutstandingListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    SELECT 'A'||NVL(SOI.OVPAY_TP_CD, 'COP') ADJ_TP_CD," ).append("\n"); 
		query.append("           SOH.CLT_OFC_CD       CLT_OFC_CD,  " ).append("\n"); 
		...
		query.append("           NULL                    MISC_LSS_LMT_AMT," ).append("\n"); 
		query.append("           SOI.MISC_INCM_LMT_AMT   MISC_INCM_LMT_AMT       " ).append("\n"); 
		...
		query.append("           'A'||NVL(SOI.OVPAY_TP_CD, 'COP') ," ).append("\n"); 
		...
		query.append("    )       " ).append("\n"); 
		query.append("    WHERE OTS_BAL_USD_AMT < NVL(MISC_INCM_LMT_AMT, 0) * -1" ).append("\n"); 
		query.append(")" ).append("\n"); 
