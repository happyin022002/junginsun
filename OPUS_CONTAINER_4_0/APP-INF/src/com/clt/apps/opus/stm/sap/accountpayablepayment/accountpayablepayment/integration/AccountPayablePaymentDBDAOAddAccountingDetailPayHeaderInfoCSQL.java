...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPayHeaderInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPayHeaderInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            , DECODE(SIGN(SPH.PAY_AMT), -1, SPH.PAY_AMT, NULL)           AS INP_DR_AMT" ).append("\n"); 
		query.append("            , DECODE(SIGN(SPH.PAY_AMT), -1, NULL, SPH.PAY_AMT)           AS INP_CR_AMT" ).append("\n"); 
		query.append("            , DECODE(SIGN(SPH.PAY_FUNC_AMT), -1, SPH.PAY_FUNC_AMT, NULL) AS ACCT_DR_AMT" ).append("\n"); 
		query.append("            , DECODE(SIGN(SPH.PAY_FUNC_AMT), -1, NULL, SPH.PAY_FUNC_AMT) AS ACCT_CR_AMT" ).append("\n"); 
