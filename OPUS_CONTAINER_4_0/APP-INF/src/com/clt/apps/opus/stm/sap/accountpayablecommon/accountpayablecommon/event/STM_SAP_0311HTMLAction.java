...
*@FileName : STM_SAP_0311HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0311HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0311HTMLAction 객체를 생성
	 */
	public STM_SAP_0311HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0311Event event = new StmSap0311Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setCreditCardlistVO((CreditCardListVO) getVO(request, CreditCardListVO.class));
		}
