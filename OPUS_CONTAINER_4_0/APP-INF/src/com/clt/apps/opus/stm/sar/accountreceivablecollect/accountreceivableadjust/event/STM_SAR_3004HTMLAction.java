...
public class STM_SAR_3004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_1003HTMLAction 객체를 생성
	 */
	public STM_SAR_3004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar3004Event event = new StmSar3004Event();

    	AdjViewAccountingListVO paramVO = (AdjViewAccountingListVO)getVO(request, AdjViewAccountingListVO.class);    	
		event.setAdjViewAccountingListVO(paramVO);
