...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvLineCancelExRateInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailInvLineCancelExRateInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AP Invoice Cancel 내역에 대해서 Accounting 처리시 Line 단위별 Ex. Rate 적용하는 경우에 분개 내역 추가
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailInvLineCancelExRateInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvLineCancelExRateInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                   , DECODE(SIGN(SID.DTRB_FUNC_AMT), -1, SID.DTRB_FUNC_AMT * (-1) + NVL(SID.INV_RND_AMT, 0) * (-1), NULL) AS ACCT_CR_AMT" ).append("\n"); 
