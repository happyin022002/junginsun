...
public class StmSap0033Event extends EventSupport {

	private static final long serialVersionUID = 1L;

	/** Table Value Object 조회 조건 처리  */
	private TermsListVO termsListVO = null;

	public StmSap0033Event() {}

	public TermsListVO getTermsListVO() {
		return termsListVO;
	}

	public void setTermsListVO(TermsListVO termsListVO) {
		this.termsListVO = termsListVO;
	}
}