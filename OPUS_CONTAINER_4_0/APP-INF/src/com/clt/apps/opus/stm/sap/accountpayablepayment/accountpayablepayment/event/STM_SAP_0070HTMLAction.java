...
*@FileName : STM_SAP_0070HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0070HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0070HTMLAction 객체를 생성
	 */
	public STM_SAP_0070HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0070Event event = new StmSap0070Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			PaymentSlipCondVO vo = (PaymentSlipCondVO)getVO(request, PaymentSlipCondVO.class);
			
			event.setPaymentSlipCondVO(vo);
