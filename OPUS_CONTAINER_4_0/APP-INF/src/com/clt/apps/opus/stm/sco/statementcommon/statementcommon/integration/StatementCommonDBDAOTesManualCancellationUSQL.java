...
*@FileName : StatementCommonDBDAOTesManualCancellationUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOTesManualCancellationUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Update TesManualCancellation
	  * </pre>
	  */
	public StatementCommonDBDAOTesManualCancellationUSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOTesManualCancellationUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE  SAC_TML_ACCL_COST_IF" ).append("\n"); 
		query.append("SET     CXL_FLG = DECODE(@[cancel_flag], 'Y','N', 'Y')	--'Y'" ).append("\n"); 
