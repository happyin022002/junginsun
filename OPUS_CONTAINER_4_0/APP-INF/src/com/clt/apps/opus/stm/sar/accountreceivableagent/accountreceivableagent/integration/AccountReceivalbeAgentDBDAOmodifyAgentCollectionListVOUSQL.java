...
*@FileName : AccountReceivalbeAgentDBDAOmodifyAgentCollectionListVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivalbeAgentDBDAOmodifyAgentCollectionListVOUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Agent Collection List modify
	  * </pre>
	  */
	public AccountReceivalbeAgentDBDAOmodifyAgentCollectionListVOUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivalbeAgentDBDAOmodifyAgentCollectionListVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
