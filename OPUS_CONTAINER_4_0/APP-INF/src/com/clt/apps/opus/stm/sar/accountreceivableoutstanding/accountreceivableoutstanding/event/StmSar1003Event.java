...
public class StmSar1003Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	
	private OutstandingHisByDateVO outstandingHisByDateVO;


	public OutstandingHisByDateVO getOutstandingHisByDateVO() {
		return outstandingHisByDateVO;
	}


	public void setOutstandingHisByDateVO(
			OutstandingHisByDateVO outstandingHisByDateVO) {
		this.outstandingHisByDateVO = outstandingHisByDateVO;
	}
