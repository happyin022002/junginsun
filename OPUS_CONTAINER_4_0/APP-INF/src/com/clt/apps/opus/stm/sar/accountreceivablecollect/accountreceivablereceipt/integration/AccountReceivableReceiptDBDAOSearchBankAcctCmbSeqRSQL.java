...
*@FileName : AccountReceivableReceiptDBDAOSearchBankAcctCmbSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableReceiptDBDAOSearchBankAcctCmbSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search bank account combination sequence
	  * </pre>
	  */
	public AccountReceivableReceiptDBDAOSearchBankAcctCmbSeqRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableReceiptDBDAOSearchBankAcctCmbSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT BANK_ACCT_NO" ).append("\n"); 
