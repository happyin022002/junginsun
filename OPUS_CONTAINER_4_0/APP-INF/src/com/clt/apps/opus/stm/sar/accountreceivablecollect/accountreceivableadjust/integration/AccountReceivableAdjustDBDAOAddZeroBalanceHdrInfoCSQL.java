...
*@FileName : AccountReceivableAdjustDBDAOAddZeroBalanceHdrInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOAddZeroBalanceHdrInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddZeroBalanceHdrInfo
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOAddZeroBalanceHdrInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAdjustDBDAOAddZeroBalanceHdrInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       @[cre_usr_id]," ).append("\n"); 
		query.append("       SYSDATE," ).append("\n"); 
		query.append("	   NULL    ADJ_KEY_NO," ).append("\n"); 
		query.append("	   SOH.CLT_OFC_CD" ).append("\n"); 
		query.append("FROM   SAR_OTS_HDR  SOH" ).append("\n"); 
		query.append("WHERE  SOH.RHQ_CD = @[rhq_cd]" ).append("\n"); 
