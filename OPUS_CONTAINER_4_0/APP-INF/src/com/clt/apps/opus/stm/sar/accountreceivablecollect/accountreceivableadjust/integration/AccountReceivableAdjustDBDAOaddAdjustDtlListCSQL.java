...
*@FileName : AccountReceivableAdjustDBDAOaddAdjustDtlListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOaddAdjustDtlListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAR_ADJ_DTL  테이블에 insert
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOaddAdjustDtlListCSQL(){
		setQuery();
		...
		params.put("legr_xch_rt",new String[]{arrTmp[0],arrTmp[1]});
		...
		params.put("ots_adj_bal_amt",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountReceivableAdjustDBDAOaddAdjustDtlListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	REPLACE(@[ots_adj_bal_amt], ',', '')," ).append("\n"); 
		query.append("	@[adj_xch_rt]," ).append("\n"); 
		query.append("	@[adj_crs_curr_cd]," ).append("\n"); 
		query.append("	REPLACE(@[adj_crs_curr_amt], ',', '')," ).append("\n"); 
		query.append("	@[legr_xch_rt]," ).append("\n"); 
		query.append("	@[cre_usr_id]," ).append("\n"); 
