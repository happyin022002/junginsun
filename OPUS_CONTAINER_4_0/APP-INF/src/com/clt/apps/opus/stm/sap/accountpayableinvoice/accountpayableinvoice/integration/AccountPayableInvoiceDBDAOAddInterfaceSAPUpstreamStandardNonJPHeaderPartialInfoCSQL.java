...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderPartialInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderPartialInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Upstream Standard 비용 전표에 Partially Apply된 내역에 대한 Liability 금액 정보를 SAKURA로 Interface
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderPartialInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPHeaderPartialInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
