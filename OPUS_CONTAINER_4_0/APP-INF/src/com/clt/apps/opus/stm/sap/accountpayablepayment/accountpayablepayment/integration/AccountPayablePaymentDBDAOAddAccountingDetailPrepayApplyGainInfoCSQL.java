...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyGainInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyGainInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPrepayApplyGainInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyGainInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayApplyGainInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
