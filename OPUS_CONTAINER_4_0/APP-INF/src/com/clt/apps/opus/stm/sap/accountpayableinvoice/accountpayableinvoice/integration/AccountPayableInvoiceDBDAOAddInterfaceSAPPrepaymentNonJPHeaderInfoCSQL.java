...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentNonJPHeaderInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentNonJPHeaderInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPPrepaymentNonJPHeaderInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentNonJPHeaderInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentNonJPHeaderInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                              , 'H6'                                AS DOCUMENT_TYPE" ).append("\n"); 
