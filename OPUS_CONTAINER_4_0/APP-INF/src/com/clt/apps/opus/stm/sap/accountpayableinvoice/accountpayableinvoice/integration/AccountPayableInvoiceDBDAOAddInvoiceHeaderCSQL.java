...
*@FileName : AccountPayableInvoiceDBDAOAddInvoiceHeaderCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInvoiceHeaderCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 전표의 대변인 Header 내역을 생성
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInvoiceHeaderCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInvoiceHeaderCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append(",ROUND( TO_NUMBER( REPLACE( NVL( @[inv_pay_amt], 0 ), ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",TO_DATE(REPLACE( @[inv_dt], '-', ''),'YYYYMMDD')" ).append("\n"); 
		query.append(",NVL( @[ap_inv_src_cd], 'Manual Invoice Entry')" ).append("\n"); 
		query.append(",@[inv_tp_lu_cd]" ).append("\n"); 
		query.append(",@[inv_desc]" ).append("\n"); 
		query.append(",@[bat_seq]" ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[inv_vat_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",@[inv_term_nm]" ).append("\n"); 
		query.append(",TO_DATE(REPLACE( @[inv_term_dt], '-', ''),'YYYYMMDD')" ).append("\n"); 
		query.append(",@[pay_mzd_lu_cd]" ).append("\n"); 
		query.append(",@[ap_pay_grp_lu_cd]" ).append("\n"); 
		query.append(",@[liab_coa_co_cd]" ).append("\n"); 
		query.append(",@[liab_coa_rgn_cd]" ).append("\n"); 
		...
		query.append(",ROUND( TO_NUMBER( REPLACE( @[inv_func_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",@[inv_vat_cd]" ).append("\n"); 
		query.append(",@[inv_xch_rt]" ).append("\n"); 
		query.append(",@[inv_xch_rt_tp_cd]" ).append("\n"); 
		query.append(",TO_DATE(REPLACE( @[inv_xch_dt], '-', ''),'YYYYMMDD')" ).append("\n"); 
		query.append(",DECODE( @[inv_tp_lu_cd], 'PREPAYMENT', SYSDATE, TO_DATE( REPLACE( @[ery_stl_dt], '-', ''), 'YYYYMMDD')  )" ).append("\n"); 
		query.append(",@[attr_ctnt1]" ).append("\n"); 
		query.append(",@[attr_ctnt2]" ).append("\n"); 
		query.append(",@[attr_ctnt3]" ).append("\n"); 
		query.append(",@[attr_ctnt4]" ).append("\n"); 
		...
		query.append(",@[attr_ctnt15]" ).append("\n"); 
		query.append(",@[attr_cate_nm]" ).append("\n"); 
		query.append(",NVL( @[ap_apsts_cd],'NOT REQUIRED' ) " ).append("\n"); 
		query.append(",TO_DATE(REPLACE( @[inv_cxl_dt], '-', ''),'YYYYMMDD')" ).append("\n"); 
		query.append(",@[cxl_usr_id]" ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[inv_cxl_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",@[ofc_cd]" ).append("\n"); 
		query.append(",@[glo_attr_cate_nm]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt1]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt2]" ).append("\n"); 
		...
		query.append(",@[glo_attr_ctnt19]" ).append("\n"); 
		query.append(",@[glo_attr_ctnt20]" ).append("\n"); 
		query.append(",ROUND( TO_NUMBER( REPLACE( @[pay_curr_inv_amt], ',', '') ) , 3 ) " ).append("\n"); 
		query.append(",REPLACE( @[gl_dt], '-', '')" ).append("\n"); 
		query.append(",'N' -- default N inv_apro_rdy_flg" ).append("\n"); 
		query.append(",@[dtrb_set_seq]" ).append("\n"); 
		query.append(",@[xter_bank_acct_seq]" ).append("\n"); 
