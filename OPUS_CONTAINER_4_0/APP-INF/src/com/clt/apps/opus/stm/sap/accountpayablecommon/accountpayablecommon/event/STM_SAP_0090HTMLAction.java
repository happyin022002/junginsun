...
*@FileName : STM_SAP_0090HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0090HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0090HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0090Event event = new StmSap0090Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setBankAccountListVO((BankAccountListVO) getVO(request, BankAccountListVO.class));
		}
