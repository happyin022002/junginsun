...
*@FileName : StatementCommonDBDAOAddSakuraConversionInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOAddSakuraConversionInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddSakuraConversionInfo
	  * </pre>
	  */
	public StatementCommonDBDAOAddSakuraConversionInfoCSQL(){
		setQuery();
		...
		params.put("src_desc",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : StatementCommonDBDAOAddSakuraConversionInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SCO_STMT_CD_CONV" ).append("\n"); 
		query.append("( CONV_TP_CD" ).append("\n"); 
		query.append(", SRC_CD" ).append("\n"); 
		query.append(", TGT_CD" ).append("\n"); 
		query.append(", SRC_DESC" ).append("\n"); 
		query.append(", TGT_DESC" ).append("\n"); 
