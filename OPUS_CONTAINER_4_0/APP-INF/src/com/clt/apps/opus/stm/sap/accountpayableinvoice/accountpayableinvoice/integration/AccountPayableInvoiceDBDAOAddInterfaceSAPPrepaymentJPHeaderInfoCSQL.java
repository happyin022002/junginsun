...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentJPHeaderInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentJPHeaderInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPPrepaymentJPHeaderInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentJPHeaderInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPPrepaymentJPHeaderInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                                          'A106') ) )               AS COST_CENTER " ).append("\n"); 
