...
*@FileName : AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingChargeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingChargeRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Search interface for Outstanding Charge
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingChargeRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOSearchInterfaceForOutstandingChargeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	, A.OTS_AMT BAL_AMT" ).append("\n"); 
