...
*@FileName : AccountPayableInvoiceDBDAOAddUnsettledAccountInvoiceSummaryCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddUnsettledAccountInvoiceSummaryCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountPayableInvoiceDBDAOAddUnsettledAccountInvoiceSummaryCSQL
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddUnsettledAccountInvoiceSummaryCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddUnsettledAccountInvoiceSummaryCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , SUBSTR(SIH.GL_DT, 1, 6)           AS UNSTL_YRMON" ).append("\n"); 
		...
		query.append("      , 'SAP_INV_HDR'                     AS UNSTL_CATE_NM" ).append("\n"); 
		...
		query.append("      , SIH.INV_AMT                       AS INP_CR_AMT" ).append("\n"); 
		query.append("      , 0                                 AS ACCT_DR_AMT" ).append("\n"); 
		query.append("      , SIH.INV_FUNC_AMT                  AS ACCT_CR_AMT" ).append("\n"); 
		query.append("      , SIH.INV_AMT                       AS UNSTL_AMT" ).append("\n"); 
		query.append("      , TO_CHAR(SIH.INV_DT, 'YYYYMMDD')   AS UNSTL_TJ_DT" ).append("\n"); 
		...
		query.append("AND     SIH.GL_DT LIKE REPLACE(@[unstl_yrmon],'-','') || '%'" ).append("\n"); 
