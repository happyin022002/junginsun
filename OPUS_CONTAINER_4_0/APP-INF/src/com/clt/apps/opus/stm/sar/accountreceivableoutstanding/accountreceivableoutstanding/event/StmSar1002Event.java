...
public class StmSar1002Event extends EventSupport {
	...
	private AROustandingbySADateVO aROustandingbySADateVO = null;
	
	public StmSar1002Event(){}
		
	public AROustandingbySADateVO getAROustandingbySADateVO() {
		return aROustandingbySADateVO;
	}
	
	public void setAROustandingbySADateVO(AROustandingbySADateVO aROustandingbySADateVO) {
		this.aROustandingbySADateVO = aROustandingbySADateVO;		
	}
