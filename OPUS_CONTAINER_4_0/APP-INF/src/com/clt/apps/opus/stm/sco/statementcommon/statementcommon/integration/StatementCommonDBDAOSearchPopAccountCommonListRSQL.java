...
*@FileName : StatementCommonDBDAOSearchPopAccountCommonListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOSearchPopAccountCommonListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Ledger Code Combinations 에서 등록 및 조회하는 Account Pop 내역을 조회 처리
	  * </pre>
	  */
	public StatementCommonDBDAOSearchPopAccountCommonListRSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOSearchPopAccountCommonListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                  WHERE H.LU_TP_CD = D.LU_TP_CD " ).append("\n"); 
		query.append("                  AND   D.LU_TP_CD = 'AP TAX ACCOUNT' " ).append("\n"); 
		query.append("                  --AND   D.ATTR_CTNT1 = 'INTERNAL'" ).append("\n"); 
		query.append("                  AND   H.LU_APPL_CD = 'SAP'" ).append("\n"); 
		query.append("                  AND   D.ENBL_FLG = 'Y' )" ).append("\n"); 
