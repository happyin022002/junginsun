...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPStandardNonJPDetailPrepayInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("               , CASE WHEN SID.LINE_TP_LU_CD = 'PREPAY' AND SID.DTRB_AMT < 0 THEN '11'" ).append("\n"); 
		query.append("                      WHEN SID.LINE_TP_LU_CD = 'PREPAY' AND SID.DTRB_AMT >= 0 THEN '01'" ).append("\n"); 
		query.append("                 ELSE '11' END                       AS POST_KEY" ).append("\n"); 
		...
		query.append("                 END                                 AS LOCAL_AMOUNT" ).append("\n"); 
		...
		query.append("               , CASE WHEN NVL((SELECT  ABS(SUM(SID2.DTRB_AMT)) FROM SAP_INV_DTL SID2" ).append("\n"); 
		query.append("                                WHERE   SID.PPAY_INV_SEQ = SID2.PPAY_INV_SEQ AND SID.PPAY_LINE_NO = SID2.PPAY_LINE_NO AND SID.INV_DTRB_SEQ > SID2.INV_DTRB_SEQ), 0) = 0 THEN" ).append("\n"); 
		query.append("                               (SELECT SUBSTR(SIH2.INV_NO, 1, 16) FROM SAP_INV_HDR SIH2 WHERE SIH2.INV_SEQ = SID.PPAY_INV_SEQ AND ROWNUM = 1)" ).append("\n"); 
		query.append("                 ELSE (SELECT  SUBSTR(SIH2.INV_NO, 1, 16) FROM SAP_INV_HDR SIH2, SAP_INV_DTL SID2 WHERE SIH2.INV_SEQ = SID2.INV_SEQ " ).append("\n"); 
		query.append("                       AND     SID2.INV_DTRB_SEQ = (SELECT  MAX(SID3.INV_DTRB_SEQ) FROM SAP_INV_DTL SID3 WHERE SID.PPAY_INV_SEQ = SID3.PPAY_INV_SEQ" ).append("\n"); 
		query.append("                                                     AND     SID.PPAY_LINE_NO = SID3.PPAY_LINE_NO AND SID.INV_DTRB_SEQ > SID3.INV_DTRB_SEQ))" ).append("\n"); 
		query.append("                 END                                 AS ASSIGNMENT_NUMBER" ).append("\n"); 
		...
		query.append("               , DECODE(NVL((SELECT  ABS(SUM(SID2.DTRB_AMT)) FROM SAP_INV_DTL SID2" ).append("\n"); 
		query.append("                             WHERE   SID.PPAY_INV_SEQ = SID2.PPAY_INV_SEQ AND SID.PPAY_LINE_NO = SID2.PPAY_LINE_NO AND SID.INV_DTRB_SEQ > SID2.INV_DTRB_SEQ), 0), 0," ).append("\n"); 
		query.append("                            (SELECT  SIH2.GL_DT FROM SAP_INV_HDR SIH2 WHERE SIH2.INV_SEQ = SID.PPAY_INV_SEQ AND ROWNUM = 1)," ).append("\n"); 
		query.append("                            (SELECT  SIH2.GL_DT FROM SAP_INV_HDR SIH2, SAP_INV_DTL SID2 WHERE SIH2.INV_SEQ = SID2.INV_SEQ " ).append("\n"); 
		query.append("                             AND     SID2.INV_DTRB_SEQ = (SELECT  MAX(SID3.INV_DTRB_SEQ) FROM SAP_INV_DTL SID3 WHERE SID.PPAY_INV_SEQ = SID3.PPAY_INV_SEQ" ).append("\n"); 
		query.append("                             AND     SID.PPAY_LINE_NO = SID3.PPAY_LINE_NO AND SID.INV_DTRB_SEQ > SID3.INV_DTRB_SEQ)))" ).append("\n"); 
		query.append("                                                     AS CALCULATE_DUE_DATE" ).append("\n"); 
		...
		query.append("                                 'A106') ) )         AS BIZ_PARTNER_REF_KEY1 --2015.02.09 수정 --2015.01.28 수정 -- Profit Center (Code Conversion)" ).append("\n"); 
		...
		query.append("               , 'PREPAY'                            AS IF_ITEM_CATEGROY" ).append("\n"); 
