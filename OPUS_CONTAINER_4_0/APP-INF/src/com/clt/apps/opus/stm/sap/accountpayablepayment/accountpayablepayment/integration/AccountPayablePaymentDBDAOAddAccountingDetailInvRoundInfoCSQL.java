...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvRoundInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailInvRoundInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailInvRoundInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailInvRoundInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvRoundInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
