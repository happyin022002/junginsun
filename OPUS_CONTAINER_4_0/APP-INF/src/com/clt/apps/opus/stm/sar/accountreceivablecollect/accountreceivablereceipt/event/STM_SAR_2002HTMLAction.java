...
*@FileName : STM_SAR_2002HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_2002HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_2002HTMLAction 객체를 생성
	 */
	public STM_SAR_2002HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar2002Event event = new StmSar2002Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			// 조회할 조건 VO 를 넘김 
			ReceiptListByDetailCondVO vo = (ReceiptListByDetailCondVO)getVO(request, ReceiptListByDetailCondVO.class);
			event.setReceiptListByDetailCondVO(vo);				
		}
