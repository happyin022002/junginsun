...
*@FileName : STM_SAP_0050HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0050HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 *  STM_SAP_0050HTMLAction 객체를 생성
	 */
	public STM_SAP_0050HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0050Event event = new StmSap0050Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {		
			PaymentScheduleCondVO vo = (PaymentScheduleCondVO)getVO(request, PaymentScheduleCondVO.class);
			
			event.setPaymentScheduleCondVO(vo);
		}
