...
*@FileName : STM_SAP_0140HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0140HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0140HTMLAction 객체를 생성
	 */
	public STM_SAP_0140HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0140Event event = new StmSap0140Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			APTransactionCondVO vo = (APTransactionCondVO)getVO(request, APTransactionCondVO.class);
			
			event.setAPTransactionCondVO(vo);
		}
