...
*@FileName : STM_SAP_0330HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class STM_SAP_0330HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0330HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0330Event event = new StmSap0330Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			PaymentDetailListVO vo = (PaymentDetailListVO)getVO(request, PaymentDetailListVO.class);
			event.setPaymentDetailListVO(vo);
		}
		else if(command.isCommand(FormCommand.SEARCH01)) {								
			PaymentDetailCurrSumListVO vo = (PaymentDetailCurrSumListVO)getVO(request, PaymentDetailCurrSumListVO.class);
			event.setPaymentDetailCurrSumListVO(vo);
		}
