...
*@FileName : STM_SAR_2004HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_2004HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_2004HTMLAction 객체를 생성
	 */
	public STM_SAR_2004HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar2004Event event = new StmSar2004Event();

		if(command.isCommand(FormCommand.SEARCH)) {								
			// 조회할 조건 VO 를 넘김 
			ReceiptListByBankConditionVO vo = (ReceiptListByBankConditionVO)getVO(request, ReceiptListByBankConditionVO.class);
			event.setReceiptListByBankConditionVO(vo);			
		}
