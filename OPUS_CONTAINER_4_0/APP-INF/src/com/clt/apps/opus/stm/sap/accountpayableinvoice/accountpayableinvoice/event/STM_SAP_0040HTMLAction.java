...
*@FileName : STM_SAP_0040HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0040HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0040HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0040Event event = new StmSap0040Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setInvoiceReceiptCondVO((InvoiceReceiptCondVO)getVO(request, InvoiceReceiptCondVO.class, ""));
			
		} else if(command.isCommand(FormCommand.MULTI)) { //save
			event.setInvoiceReceiptListVOs((InvoiceReceiptListVO[])getVOs(request, InvoiceReceiptListVO.class, "sheet1_"));
