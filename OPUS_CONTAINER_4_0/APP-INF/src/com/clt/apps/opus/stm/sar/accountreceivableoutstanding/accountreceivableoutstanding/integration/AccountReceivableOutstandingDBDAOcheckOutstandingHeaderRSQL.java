...
*@FileName : AccountReceivableOutstandingDBDAOcheckOutstandingHeaderRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOcheckOutstandingHeaderRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Outstanding Header 존재여부 체크
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOcheckOutstandingHeaderRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOcheckOutstandingHeaderRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
