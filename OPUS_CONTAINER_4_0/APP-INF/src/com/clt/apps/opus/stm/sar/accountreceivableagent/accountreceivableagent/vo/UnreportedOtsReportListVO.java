...
*@FileName : UnreportedOtsReportListVO.java
*@FileTitle : UnreportedOtsReportListVO
*Open Issues :
*Change history :
...
public class UnreportedOtsReportListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<UnreportedOtsReportListVO> models = new ArrayList<UnreportedOtsReportListVO>();
	...
	public UnreportedOtsReportListVO() {}

	public UnreportedOtsReportListVO(String ibflag, String pagerows, String ofcCd, String vvdCd, String blNo, String sailArrDt, String dueDt, String actUsd, String asaUsd, String tobeUsd, String arOfcCd, String asaNo1, String asaNo2, String asaNo3, String dueDtFm) {
		this.asaNo1 = asaNo1;
		this.asaNo3 = asaNo3;
		this.asaNo2 = asaNo2;
		this.blNo = blNo;
...
/**
	 ...
	 * @param request
	 * @return UnreportedOtsReportListVO[]
	 */
	public UnreportedOtsReportListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return UnreportedOtsReportListVO[]
	 */
	public UnreportedOtsReportListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		UnreportedOtsReportListVO model = null;
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				model = new UnreportedOtsReportListVO();
				if (asaNo1[i] != null)
		...
		return getUnreportedOtsReportListVOs();
	}
	 ...
	 * @return UnreportedOtsReportListVO[]
	 */
	public UnreportedOtsReportListVO[] getUnreportedOtsReportListVOs(){
		UnreportedOtsReportListVO[] vos = (UnreportedOtsReportListVO[])models.toArray(new UnreportedOtsReportListVO[models.size()]);
		return vos;
	}
