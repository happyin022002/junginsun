...
public class StmSar1004Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	
	private OTSAgingBaseVO otsAgingBaseVO;


	public OTSAgingBaseVO getOtsAgingBaseVO() {
		return otsAgingBaseVO;
	}


	public void setOtsAgingBaseVO(OTSAgingBaseVO otsAgingBaseVO) {
		this.otsAgingBaseVO = otsAgingBaseVO;
	}
