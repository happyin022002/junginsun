...
*@FileName : MultiOfficeCodeVO.java
*@FileTitle : MultiOfficeCodeVO
*Open Issues :
*Change history :
...
public class MultiOfficeCodeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<MultiOfficeCodeVO> models = new ArrayList<MultiOfficeCodeVO>();
	...
	public MultiOfficeCodeVO() {}

	public MultiOfficeCodeVO(String ibflag, String pagerows, String ofcCd, String ofcBrncAgnTpCd) {
...
/**
	 ...
	 * @param request
	 * @return MultiOfficeCodeVO[]
	 */
	public MultiOfficeCodeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MultiOfficeCodeVO[]
	 */
	public MultiOfficeCodeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		MultiOfficeCodeVO model = null;
	 ...
	 * @return MultiOfficeCodeVO[]
	 */
	public MultiOfficeCodeVO[] getMultiOfficeCodeVOs(){
		MultiOfficeCodeVO[] vos = (MultiOfficeCodeVO[])models.toArray(new MultiOfficeCodeVO[models.size()]);
		return vos;
	}
