...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLiabilityInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLiabilityInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPrepayUnApplyLiabilityInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLiabilityInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLiabilityInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , 2                                AS ACCTG_EVNT_LINE_NO" ).append("\n"); 
		...
		query.append("    , DECODE(SIGN(SID.DTRB_AMT), -1, SID.DTRB_AMT * (-1), NULL)    AS INP_DR_AMT" ).append("\n"); 
		query.append("    , DECODE(SIGN(SID.DTRB_AMT), -1, NULL, SID.DTRB_AMT)           AS INP_CR_AMT" ).append("\n"); 
		query.append("    , DECODE(SIGN(SID.DTRB_AMT), -1, ROUND((SID.DTRB_AMT * (-1)) * NVL(SIH.INV_XCH_RT, 1), " ).append("\n"); 
		...
		query.append("    , DECODE(SIGN(SID.DTRB_AMT), -1, NULL, ROUND(SID.DTRB_AMT * NVL(SIH.INV_XCH_RT, 1), " ).append("\n"); 
		...
		query.append("    , TO_CHAR(SIH.INV_SEQ)             AS ATTR_CTNT3" ).append("\n"); 
