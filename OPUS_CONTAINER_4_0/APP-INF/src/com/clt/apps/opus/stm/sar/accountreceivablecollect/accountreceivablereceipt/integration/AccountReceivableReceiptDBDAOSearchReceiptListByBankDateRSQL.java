...
*@FileName : AccountReceivableReceiptDBDAOSearchReceiptListByBankDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableReceiptDBDAOSearchReceiptListByBankDateRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ReceiptListByBankDate
	  * </pre>
	  */
	public AccountReceivableReceiptDBDAOSearchReceiptListByBankDateRSQL(){
		setQuery();
		...
		params.put("rct_dt_tp_cd",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountReceivableReceiptDBDAOSearchReceiptListByBankDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("       DECODE(@[rct_dt_tp_cd], 'RECEIPT', RCT_DT, 'DEPOSIT', RCT_DPS_DT) AS RCT_OR_DPS_DT, " ).append("\n"); 
