...
*@FileName : AccountReceivableOutstandingDBDAOaddOutstandingHistCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOaddOutstandingHistCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOaddOutstandingHistCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOaddOutstandingHistCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("INSERT INTO SAR_OTS_HIS" ).append("\n"); 
		query.append("(" ).append("\n"); 
