...
*@FileName : AccountPayableInvoiceDBDAOModifyPayCaptureSelectedInvoiceChangeInfoUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOModifyPayCaptureSelectedInvoiceChangeInfoUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * ModifyPayCaptureSelectedInvoiceChangeInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOModifyPayCaptureSelectedInvoiceChangeInfoUSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOModifyPayCaptureSelectedInvoiceChangeInfoUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE   (INV_SEQ, PAY_SKD_NO) IN (SELECT SPS.INV_SEQ" ).append("\n"); 
