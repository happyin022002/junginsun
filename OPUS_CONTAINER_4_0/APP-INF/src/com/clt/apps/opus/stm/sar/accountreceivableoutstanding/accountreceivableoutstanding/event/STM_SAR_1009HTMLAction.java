...
public class STM_SAR_1009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_1003HTMLAction 객체를 생성
	 */
	public STM_SAR_1009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar1009Event event = new StmSar1009Event();

    	PaymentRequestLetterHisVO paramVO = (PaymentRequestLetterHisVO)getVO(request, PaymentRequestLetterHisVO.class);    	
		event.setPaymentRequestLetterHisVO(paramVO);
