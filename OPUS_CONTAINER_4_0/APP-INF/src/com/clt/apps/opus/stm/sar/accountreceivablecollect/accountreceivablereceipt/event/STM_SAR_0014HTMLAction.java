...
*@FileName : STM_SAR_0014HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_0014HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_0014HTMLAction 객체를 생성
	 */
	public STM_SAR_0014HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar0014Event event = new StmSar0014Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {	
			//String usrId = JSPUtil.getParameter(request, "usr_id" , "");
			//event.setUsrId(usrId);
			
			ReceiptUserListConditionVO vo = (ReceiptUserListConditionVO)getVO(request, ReceiptUserListConditionVO .class);
			event.setReceiptUserListConditionVO(vo);
