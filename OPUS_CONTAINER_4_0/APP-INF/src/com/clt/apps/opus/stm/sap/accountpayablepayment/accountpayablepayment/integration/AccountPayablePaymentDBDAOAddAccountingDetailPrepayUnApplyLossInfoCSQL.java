...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLossInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLossInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailPrepayUnApplyLossInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLossInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailPrepayUnApplyLossInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	  , NULL                             AS INP_DR_AMT" ).append("\n"); 
		query.append("	  , 0                                AS INP_CR_AMT" ).append("\n"); 
		query.append("	  , NULL                             AS ACCT_DR_AMT" ).append("\n"); 
		query.append("	  , @[gain_loss_amt]                 AS ACCT_CR_AMT" ).append("\n"); 
