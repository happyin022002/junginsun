...
*@FileName : STM_SAP_0110HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0110HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0110HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0110Event event = new StmSap0110Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setSchBankAcctNo(JSPUtil.getParameter(request, "sch_bank_acct_no", ""));
			event.setBankAcctSeq(JSPUtil.getParameter(request, "bank_acct_seq", ""));
			
		} else if(command.isCommand(FormCommand.MULTI)) {
			event.setBankAccountSupplierListVO((BankAccountSupplierListVO) getVO(request, BankAccountSupplierListVO.class));
		}
