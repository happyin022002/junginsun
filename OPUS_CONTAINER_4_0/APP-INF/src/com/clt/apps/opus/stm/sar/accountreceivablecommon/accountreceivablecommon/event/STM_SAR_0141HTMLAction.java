...
*@FileName : STM_SAR_0141HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_0141HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_0141HTMLAction 객체를 생성
	 */
	public STM_SAR_0141HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar0141Event event = new StmSar0141Event();
