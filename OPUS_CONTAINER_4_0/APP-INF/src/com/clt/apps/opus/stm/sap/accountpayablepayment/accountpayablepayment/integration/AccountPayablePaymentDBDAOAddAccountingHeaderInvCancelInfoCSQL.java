...
*@FileName : AccountPayablePaymentDBDAOAddAccountingHeaderInvCancelInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingHeaderInvCancelInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingHeaderInvCancelInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingHeaderInvCancelInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingHeaderInvCancelInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                       AND     NVL(SID.RVS_FLG, 'N') = 'Y' AND SID.PRNT_RVS_DTRB_SEQ IS NOT NULL AND ROWNUM = 1), 'YYYY/MM') AS ACCTG_PRD_NM" ).append("\n"); 
