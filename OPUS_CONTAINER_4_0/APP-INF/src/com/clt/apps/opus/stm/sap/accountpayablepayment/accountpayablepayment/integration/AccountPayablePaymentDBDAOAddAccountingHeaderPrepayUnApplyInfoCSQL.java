...
*@FileName : AccountPayablePaymentDBDAOAddAccountingHeaderPrepayUnApplyInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingHeaderPrepayUnApplyInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingHeaderPrepayUnApplyInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingHeaderPrepayUnApplyInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingHeaderPrepayUnApplyInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , TO_CHAR(SID.ACCTG_DT, 'YYYY/MM') AS ACCTG_PRD_NM" ).append("\n"); 
