...
*@FileName : AcctTypeVO.java
*@FileTitle : AcctTypeVO
*Open Issues :
*Change history :
...
public class AcctTypeVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<AcctTypeVO> models = new ArrayList<AcctTypeVO>();
	...
	public AcctTypeVO(String ibflag, String pagerows, String acctTpNm, String payAcctCd, String acctTpCd, String amtSgnCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return AcctTypeVO[]
	 */
	public AcctTypeVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return AcctTypeVO[]
	 */
	public AcctTypeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		AcctTypeVO model = null;
	 ...
	 * @return AcctTypeVO[]
	 */
	public AcctTypeVO[] getAcctTypeVOs(){
		AcctTypeVO[] vos = (AcctTypeVO[])models.toArray(new AcctTypeVO[models.size()]);
		return vos;
	}
