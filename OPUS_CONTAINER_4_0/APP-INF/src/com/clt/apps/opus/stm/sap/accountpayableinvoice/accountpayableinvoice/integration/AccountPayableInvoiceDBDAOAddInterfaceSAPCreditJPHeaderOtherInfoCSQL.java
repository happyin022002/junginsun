...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPCreditJPHeaderOtherInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPCreditJPHeaderOtherInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddInterfaceSAPCreditJPHeaderOtherInfo
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPCreditJPHeaderOtherInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPCreditJPHeaderOtherInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("                     , 'LIABILITY' AS IF_ITEM_CATEGROY" ).append("\n"); 
		query.append("               FROM    (      " ).append("\n"); 
		...
		query.append("                                     WHEN SID.LINE_TP_LU_CD = 'MISCELLANEOUS' THEN NULL ELSE NULL END" ).append("\n"); 
		...
		query.append("                                                'A106') ) )         AS BIZ_PARTNER_REF_KEY1  --2015.02.09수정  --2015.01.28 수정 " ).append("\n"); 
		...
		query.append("                              , 'S'                                 AS PAYMENT_BLOCK_KEY" ).append("\n"); 
