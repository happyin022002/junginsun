...
*@FileName : AccountPayablePaymentDBDAOSearchAccountingPrepayApplyGainLossCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOSearchAccountingPrepayApplyGainLossCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchAccountingPrepayApplyGainLossCheck
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOSearchAccountingPrepayApplyGainLossCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOSearchAccountingPrepayApplyGainLossCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
