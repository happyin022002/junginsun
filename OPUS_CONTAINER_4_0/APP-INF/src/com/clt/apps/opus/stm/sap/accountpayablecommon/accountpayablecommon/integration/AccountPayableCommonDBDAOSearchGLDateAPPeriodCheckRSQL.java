...
*@FileName : AccountPayableCommonDBDAOSearchGLDateAPPeriodCheckRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchGLDateAPPeriodCheckRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SearchGLDateAPPeriodCheck
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchGLDateAPPeriodCheckRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchGLDateAPPeriodCheckRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("WHERE   SP.EFF_YRMON = SUBSTR(REPLACE(@[gl_dt],'-'),0,6)  " ).append("\n"); 
