...
*@FileName : CompanyListVO.java
*@FileTitle : CompanyListVO
*Open Issues :
*Change history :
...
public class CompanyListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<CompanyListVO> models = new ArrayList<CompanyListVO>();
	...
	public CompanyListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 */
	public CompanyListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return CompanyListVO[]
	 */
	public CompanyListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		CompanyListVO model = null;
	 ...
	 * @return CompanyListVO[]
	 */
	public CompanyListVO[] getCompanyListVOs(){
		CompanyListVO[] vos = (CompanyListVO[])models.toArray(new CompanyListVO[models.size()]);
		return vos;
	}
