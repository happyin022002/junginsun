...
*@FileName : STM_SAP_0310HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author hannah lee
 * @see STM_SAP_0310HTMLAction 참조
 * @since J2EE 1.4
 */

public class STM_SAP_0310HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0310HTMLAction 객체를 생성
	 */
	public STM_SAP_0310HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0310Event event = new StmSap0310Event();
		
		if(command.isCommand(FormCommand.SEARCH)) {					
			event.setCrdNo(request.getParameter("crd_no"));
		}else if(command.isCommand(FormCommand.MULTI)){			
			event.setCreditCardMasterListVO((CreditCardMasterListVO)getVO(request, CreditCardMasterListVO.class));
