...
*@FileName : AccountReceivableCommonDBDAOsearchEffectiveDateRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCommonDBDAOsearchEffectiveDateRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableCommonDBDAOsearchEffectiveDateRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableCommonDBDAOsearchEffectiveDateRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("select  DECODE( substr(replace(@[eff_dt],'-',''),1,6)||'01', new_eff_dt, replace(@[eff_dt],'-',''), new_eff_dt) new_eff_dt" ).append("\n"); 
