...
*@FileName : AccountReceivableReceiptDBDAOsearchReceivableForOTSDetailRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableReceiptDBDAOsearchReceivableForOTSDetailRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * OTS Detail 반영대상 Receivable 정보 조회
	  * </pre>
	  */
	public AccountReceivableReceiptDBDAOsearchReceivableForOTSDetailRSQL(){
		setQuery();
		params = new HashMap<String,String[]>();
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.stm.sar.accountreceivablecollect.accountreceivablereceipt.integration").append("\n"); 
		query.append("FileName : AccountReceivableReceiptDBDAOsearchReceivableForOTSDetailRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    , NVL(SUM(A.APLY_AMT), 0) RCT_AMT" ).append("\n"); 
