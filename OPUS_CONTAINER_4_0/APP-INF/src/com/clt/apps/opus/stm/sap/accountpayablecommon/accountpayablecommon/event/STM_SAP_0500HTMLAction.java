...
*@FileName : STM_SAP_0500HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
 ...
 * @author 
 * @see StmSap0500Event 참조
 * @since J2EE 1.4
 */

public class STM_SAP_0500HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0500HTMLAction 객체를 생성
	 */
	public STM_SAP_0500HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0500Event event = new StmSap0500Event();
		
    	if(command.isCommand(FormCommand.SEARCH)) {								
    		String ofcTp  = JSPUtil.getParameter(request, "ofc_type" , "");
    		String ofcCd = JSPUtil.getParameter(request, "ofc_code" , "");
						
			event.setOfcTp(ofcTp);
