...
*@FileName : AccountReceivableOutstandingDBDAOmodifyOutstandingDetailUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingDBDAOmodifyOutstandingDetailUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingDBDAOmodifyOutstandingDetailUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingDBDAOmodifyOutstandingDetailUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("UPDATE SAR_OTS_DTL SET" ).append("\n"); 
