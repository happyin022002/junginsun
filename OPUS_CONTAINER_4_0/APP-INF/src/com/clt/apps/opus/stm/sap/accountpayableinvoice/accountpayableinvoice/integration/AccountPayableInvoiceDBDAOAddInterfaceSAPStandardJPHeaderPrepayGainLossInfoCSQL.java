...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayGainLossInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayGainLossInfoCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayGainLossInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardJPHeaderPrepayGainLossInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
