 ...
 * @author 
 * @see StmSar1007Event 참조
 * @since J2EE 1.4
 */

public class StmSar1007Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	private OutstandingHdrByBlVO outstandingHdrByBlVO ;

	public OutstandingHdrByBlVO getOutstandingHdrByBlVO() {
		return outstandingHdrByBlVO;
	}

	public void setOutstandingHdrByBlVO(OutstandingHdrByBlVO outstandingHdrByBlVO) {
		this.outstandingHdrByBlVO = outstandingHdrByBlVO;
	}
