...
*@FileName : AccountPayablePaymentDBDAOModifyPaymentHeaderUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOModifyPaymentHeaderUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AccountPayablePaymentDBDAOModifyPaymentHeaderUSQL
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOModifyPaymentHeaderUSQL(){
		setQuery();
		...
		params.put("pay_ste_nm",new String[]{arrTmp[0],arrTmp[1]});
		...
		query.append("FileName : AccountPayablePaymentDBDAOModifyPaymentHeaderUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    PAY_STE_NM = @[pay_ste_nm]," ).append("\n"); 
		query.append("    VNDR_NO = @[vndr_no]," ).append("\n"); 
		query.append("    PAY_XCH_RT = @[pay_xch_rt]," ).append("\n"); 
		query.append("    PAY_XCH_DT = @[pay_xch_dt]," ).append("\n"); 
		...
		query.append("    PAY_BAT_NM = @[pay_bat_nm]," ).append("\n"); 
