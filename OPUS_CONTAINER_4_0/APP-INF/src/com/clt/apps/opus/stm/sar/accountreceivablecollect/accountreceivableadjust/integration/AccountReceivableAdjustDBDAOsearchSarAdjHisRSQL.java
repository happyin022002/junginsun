...
*@FileName : AccountReceivableAdjustDBDAOsearchSarAdjHisRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOsearchSarAdjHisRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * select SAR_ADJ_HIS Table
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOsearchSarAdjHisRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAdjustDBDAOsearchSarAdjHisRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		query.append("SELECT    ADJ_HIS_SEQ" ).append("\n"); 
		...
		query.append("#if (${adj_key_no}  !=  '')" ).append("\n"); 
		query.append("	AND  ADJ_KEY_NO = @[adj_key_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${adj_his_seq}  !=  '')" ).append("\n"); 
		query.append("	AND  ADJ_HIS_SEQ = @[adj_his_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${adj_no}  !=  '')" ).append("\n"); 
		query.append("	AND  ADJ_NO = @[adj_no]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${adj_sts_cd}  !=  '')" ).append("\n"); 
		query.append("	AND  ADJ_STS_CD = @[adj_sts_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${adj_tp_cd}  !=  '')" ).append("\n"); 
		query.append("	AND  ADJ_TP_CD = @[adj_tp_cd]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
		query.append("" ).append("\n"); 
		query.append("#if (${ots_his_seq}  !=  '')" ).append("\n"); 
		query.append("	AND  OTS_HIS_SEQ = @[adj_his_seq]" ).append("\n"); 
		query.append("#end" ).append("\n"); 
