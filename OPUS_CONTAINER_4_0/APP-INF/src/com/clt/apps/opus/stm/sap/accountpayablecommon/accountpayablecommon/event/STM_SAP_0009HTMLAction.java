...
*@FileName : STM_SAP_0009HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAP_0009HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SAP_0009HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0009Event event = new StmSap0009Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			
			if(command.isCommand(FormCommand.SEARCH)) {		
				event.setInvoiceTypeListVO((InvoiceTypeListVO)getVO(request, InvoiceTypeListVO.class));
			}
		}
