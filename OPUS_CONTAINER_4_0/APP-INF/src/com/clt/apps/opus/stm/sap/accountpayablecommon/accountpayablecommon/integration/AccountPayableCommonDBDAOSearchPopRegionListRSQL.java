...
*@FileName : AccountPayableCommonDBDAOSearchPopRegionListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableCommonDBDAOSearchPopRegionListRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountPayableCommonDBDAOSearchPopRegionListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableCommonDBDAOSearchPopRegionListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND     SLH.LU_TP_CD = 'GL REGION'" ).append("\n"); 
