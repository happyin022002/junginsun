...
*@FileName : AccountReceivableReceiptDBDAOsearchReceivableApplForReverseRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableReceiptDBDAOsearchReceivableApplForReverseRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Reverse 대상 Receivable Application 정보를 조회
	  * </pre>
	  */
	public AccountReceivableReceiptDBDAOsearchReceivableApplForReverseRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableReceiptDBDAOsearchReceivableApplForReverseRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	, 'REVERSE' RCV_APPL_TP_CD" ).append("\n"); 
		...
		query.append("#if(${bc_flg} == 'N')" ).append("\n"); 
		query.append("	WHERE RCT_SEQ = @[rct_seq]" ).append("\n"); 
		query.append("	AND RCT_APLY_DTL_SEQ = @[rct_aply_dtl_seq]" ).append("\n"); 
		query.append("	AND RCV_APPL_TP_CD = 'RECEIPT'" ).append("\n"); 
		query.append("#else" ).append("\n"); 
		query.append("	, (SELECT RCV_APPL_SEQ WRTF_SEQ, APLY_FM_RCV_APPL_SEQ UNAPP_SEQ" ).append("\n"); 
		query.append(" 	   FROM SAR_RCV_APPL" ).append("\n"); 
		query.append(" 	   WHERE RCT_SEQ = @[rct_seq]" ).append("\n"); 
		query.append("	   AND RCV_APPL_STS_CD = 'WRTF'" ).append("\n"); 
		query.append("	   AND WRTF_TP_CD = 'BC'" ).append("\n"); 
		query.append("	   AND RCV_APPL_TP_CD = 'RECEIPT')" ).append("\n"); 
		query.append("	WHERE (RCV_APPL_SEQ = WRTF_SEQ OR RCV_APPL_SEQ = UNAPP_SEQ)" ).append("\n"); 
