...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPPrepayGainLossInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPPrepayGainLossInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * Upstream module standard slip의 Partially apply에 대한 처리시 Gain/Loss 발생시 SAKURA Interface
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPPrepayGainLossInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPUpstreamStandardNonJPPrepayGainLossInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
