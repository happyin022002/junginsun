...
*@FileName : AccountReceivableCommonDBDAOsearchPopCustomerListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableCommonDBDAOsearchPopCustomerListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * searchPopCustomerList
	  * </pre>
	  */
	public AccountReceivableCommonDBDAOsearchPopCustomerListRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableCommonDBDAOsearchPopCustomerListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
