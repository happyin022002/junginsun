...
*@FileName : StatementCommonDBDAOsearchPopInterCompanyListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOsearchPopInterCompanyListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * STM_SCO_0055의 검색조건 VO
	  * </pre>
	  */
	public StatementCommonDBDAOsearchPopInterCompanyListRSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOsearchPopInterCompanyListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
