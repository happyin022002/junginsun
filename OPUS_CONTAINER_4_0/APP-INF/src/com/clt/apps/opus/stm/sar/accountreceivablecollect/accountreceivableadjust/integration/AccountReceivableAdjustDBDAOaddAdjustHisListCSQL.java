...
*@FileName : AccountReceivableAdjustDBDAOaddAdjustHisListCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAdjustDBDAOaddAdjustHisListCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * SAR_ADJ_HIS  테이블에 insert
	  * </pre>
	  */
	public AccountReceivableAdjustDBDAOaddAdjustHisListCSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAdjustDBDAOaddAdjustHisListCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	REPLACE(@[adj_gl_dt], '-', '')," ).append("\n"); 
		query.append("	@[adj_cd_cmb_seq]," ).append("\n"); 
		query.append("	@[chg_tp_cd]," ).append("\n"); 
		query.append("	@[adj_tp_cd]," ).append("\n"); 
		query.append("	@[adj_rmk]," ).append("\n"); 
		...
		query.append("	@[ap_rmk]," ).append("\n"); 
		query.append("    @[adj_ofc_cd]," ).append("\n"); 
		query.append("	(SELECT ROUND(@[gl_crs_curr_amt],DP_PRCS_KNT) FROM MDM_CURRENCY WHERE CURR_CD = @[gl_crs_curr_cd]),			" ).append("\n"); 
		query.append("    @[gl_crs_curr_cd]," ).append("\n"); 
		query.append("    @[gl_crs_ex_rate]" ).append("\n"); 
