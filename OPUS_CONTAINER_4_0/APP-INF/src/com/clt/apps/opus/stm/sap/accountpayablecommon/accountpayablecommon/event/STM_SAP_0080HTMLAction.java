...
*@FileName : STM_SAP_0080HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class STM_SAP_0080HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAP_0080HTMLAction 객체를 생성
	 */
	public STM_SAP_0080HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSap0080Event event = new StmSap0080Event();
