...
*@FileName : STM_SAR_1006HTMLAction.java
...
public class STM_SAR_1006HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_1006HTMLAction 객체를 생성
	 */
	public STM_SAR_1006HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar1006Event event = new StmSar1006Event();
		...
		if(command.isCommand(FormCommand.SEARCH)) {								
			...
			PaymentRequestLetterByEmailFaxVO vo = (PaymentRequestLetterByEmailFaxVO)getVO(request, PaymentRequestLetterByEmailFaxVO .class);
		    event.setPaymentRequestLetterByEmailFaxVO(vo);
		}
