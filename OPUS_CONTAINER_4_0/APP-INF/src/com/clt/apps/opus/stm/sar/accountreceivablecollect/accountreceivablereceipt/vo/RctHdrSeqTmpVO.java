...
*@FileName : RctHdrSeqTmpVO.java
*@FileTitle : RctHdrSeqTmpVO
*Open Issues :
*Change history :
...
public class RctHdrSeqTmpVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<RctHdrSeqTmpVO> models = new ArrayList<RctHdrSeqTmpVO>();
	...
	public RctHdrSeqTmpVO() {}

	public RctHdrSeqTmpVO(String ibflag, String pagerows, String rctAplyHdrSeq) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return RctHdrSeqTmpVO[]
	 */
	public RctHdrSeqTmpVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return RctHdrSeqTmpVO[]
	 */
	public RctHdrSeqTmpVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		RctHdrSeqTmpVO model = null;
	 ...
	 * @return RctHdrSeqTmpVO[]
	 */
	public RctHdrSeqTmpVO[] getRctHdrSeqTmpVOs(){
		RctHdrSeqTmpVO[] vos = (RctHdrSeqTmpVO[])models.toArray(new RctHdrSeqTmpVO[models.size()]);
		return vos;
	}
