...
*@FileName : AccountPayablePaymentDBDAOAddAccountingEventInvInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingEventInvInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingEventInvInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingEventInvInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingEventInvInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("            , 'INVOICE'                AS ACCTG_EVNT_TP_CD" ).append("\n"); 
