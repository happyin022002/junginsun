...
*@FileName : PaymentMethodListVO.java
*@FileTitle : PaymentMethodListVO
*Open Issues :
*Change history :
...
public class PaymentMethodListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<PaymentMethodListVO> models = new ArrayList<PaymentMethodListVO>();
	...
	public PaymentMethodListVO() {}

	public PaymentMethodListVO(String ibflag, String pagerows, String luCd, String luDesc) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return PaymentMethodListVO[]
	 */
	public PaymentMethodListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return PaymentMethodListVO[]
	 */
	public PaymentMethodListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		PaymentMethodListVO model = null;
		...
		return getPaymentMethodListVOs();
	}
	 ...
	 * @return PaymentMethodListVO[]
	 */
	public PaymentMethodListVO[] getPaymentMethodListVOs(){
		PaymentMethodListVO[] vos = (PaymentMethodListVO[])models.toArray(new PaymentMethodListVO[models.size()]);
		return vos;
	}
