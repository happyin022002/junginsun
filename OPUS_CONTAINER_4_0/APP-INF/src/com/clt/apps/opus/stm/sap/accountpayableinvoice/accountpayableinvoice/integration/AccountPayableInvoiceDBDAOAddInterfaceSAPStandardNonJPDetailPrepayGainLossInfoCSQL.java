...
*@FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayGainLossInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayGainLossInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * 선급금 정산 처리시 Line의 Activity Date의 의한 환율과 Apply 선급금 Header G/L date간의 환율의 차로 인한 정산 처리시 Gain & Loss 발생하는 Line에 대해서 추가 처리
	  * </pre>
	  */
	public AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayGainLossInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayableInvoiceDBDAOAddInterfaceSAPStandardNonJPDetailPrepayGainLossInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("               , 'PREPAY(GAIN/LOSS)'                 AS IF_ITEM_CATEGROY" ).append("\n"); 
