...
*@FileName : AccountReceivableAgentDBDAOSearchASANoSeqRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableAgentDBDAOSearchASANoSeqRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * select SAR_ASA_NO_SEQ
	  * </pre>
	  */
	public AccountReceivableAgentDBDAOSearchASANoSeqRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableAgentDBDAOSearchASANoSeqRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("    FROM      SAR_ASA_NO_SEQ" ).append("\n"); 
