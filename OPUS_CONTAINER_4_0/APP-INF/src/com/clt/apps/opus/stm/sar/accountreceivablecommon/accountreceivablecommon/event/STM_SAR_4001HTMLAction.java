...
*@FileName : STM_SAR_4001HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_4001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_4001HTMLAction 객체를 생성
	 */
	public STM_SAR_4001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar4001Event event = new StmSar4001Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {	
			event.setRevAcctMatrixInfoCondVO((RevAcctMatrixInfoCondVO)getVO(request, RevAcctMatrixInfoCondVO .class));
		} else if(command.isCommand(FormCommand.MULTI01)) {			
			RevAcctMatrixInfoVO[] RevAcctMatrixInfoVOs = (RevAcctMatrixInfoVO[]) getVOs(request, RevAcctMatrixInfoVO.class , "");	
			event.setRevAcctMatrixInfoVOs(RevAcctMatrixInfoVOs);	
