...
*@FileName : STM_SAR_3003HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SAR_3003HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * STM_SAR_3003HTMLAction 객체를 생성
	 */
	public STM_SAR_3003HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSar3003Event event = new StmSar3003Event();
		

		if(command.isCommand(FormCommand.SEARCH)) {								
			event.setAutosettlementCondVO((AutosettlementCondVO)getVO(request, AutosettlementCondVO.class, ""));
		}else if(command.isCommand(FormCommand.MULTI)){
			event.setAutosettlementCondVO((AutosettlementCondVO)getVO(request, AutosettlementCondVO.class, ""));
			event.setAutoSettlementInfoVOs((AutoSettlementInfoVO[])getVOs(request, AutoSettlementInfoVO.class, "sheet1_"));
