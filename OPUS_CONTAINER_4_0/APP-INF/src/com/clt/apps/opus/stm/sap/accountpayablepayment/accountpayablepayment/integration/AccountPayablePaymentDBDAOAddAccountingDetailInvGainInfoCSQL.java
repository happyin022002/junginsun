...
*@FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvGainInfoCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountPayablePaymentDBDAOAddAccountingDetailInvGainInfoCSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * AddAccountingDetailInvGainInfo
	  * </pre>
	  */
	public AccountPayablePaymentDBDAOAddAccountingDetailInvGainInfoCSQL(){
		setQuery();
		...
		query.append("FileName : AccountPayablePaymentDBDAOAddAccountingDetailInvGainInfoCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
