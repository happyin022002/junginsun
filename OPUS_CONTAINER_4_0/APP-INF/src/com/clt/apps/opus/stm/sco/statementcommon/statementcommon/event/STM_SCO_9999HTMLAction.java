...
*@FileName : STM_SCO_9999HTMLAction.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 
...
public class STM_SCO_9999HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * FNS_INV_0013HTMLAction 객체를 생성
	 */
	public STM_SCO_9999HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
    	...
    	StmSco9999Event event = new StmSco9999Event();
		
		event.setAcclYm( request.getParameter("accl_ym")	);   
		event.setJobNm ( request.getParameter("job_nm")	);   
