...
*@FileName : AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHeaderUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHeaderUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHeaderUSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOModifyOutstandingHeaderUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("      , OBL_ISS_OFC_CD = @[obl_iss_ofc_cd]" ).append("\n"); 
		query.append("      , OTS_PAY_CD = @[ots_pay_cd]" ).append("\n"); 
		query.append("      , ORG_INV_NO = @[org_inv_no]" ).append("\n"); 
		query.append("WHERE   RHQ_CD = @[rhq_cd]" ).append("\n"); 
		query.append("AND     OTS_OFC_CD = @[ots_ofc_cd]" ).append("\n"); 
		query.append("AND     BL_NO = @[bl_no]" ).append("\n"); 
		query.append("AND     INV_NO = @[inv_no]" ).append("\n"); 
