...
public class StmSap0009Event extends EventSupport {

	private static final long serialVersionUID = 1L;
	
	/** Table Value Object 조회 조건 처리  */
	private InvoiceTypeListVO invoiceTypeListVO = null;

	public StmSap0009Event() {}

	public InvoiceTypeListVO getInvoiceTypeListVO() {
		return invoiceTypeListVO;
	}

	public void setInvoiceTypeListVO(InvoiceTypeListVO invoiceTypeListVO) {
		this.invoiceTypeListVO = invoiceTypeListVO;
	}
