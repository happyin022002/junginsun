...
*@FileName : StatementCommonDBDAOsearchPopCompanyListRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class StatementCommonDBDAOsearchPopCompanyListRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * STM_SCO_0051  -- Company Popup
	  * </pre>
	  */
	public StatementCommonDBDAOsearchPopCompanyListRSQL(){
		setQuery();
		...
		query.append("FileName : StatementCommonDBDAOsearchPopCompanyListRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
