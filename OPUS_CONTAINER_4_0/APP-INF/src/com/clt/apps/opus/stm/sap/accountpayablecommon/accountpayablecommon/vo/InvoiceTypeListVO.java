...
*@FileName : InvoiceTypeListVO.java
*@FileTitle : InvoiceTypeListVO
*Open Issues :
*Change history :
...
public class InvoiceTypeListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<InvoiceTypeListVO> models = new ArrayList<InvoiceTypeListVO>();
	...
	public InvoiceTypeListVO() {}

	public InvoiceTypeListVO(String ibflag, String pagerows, String luCd, String luDesc, String invTpcd) {
		this.ibflag = ibflag;
		this.luCd = luCd;
		this.luDesc = luDesc;
...
/**
	 ...
	 * @param request
	 * @return InvoiceTypeListVO[]
	 */
	public InvoiceTypeListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @param request
	 * @param prefix
	 * @return searchInvoiceTypeListVO[]
	 */
	public InvoiceTypeListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		InvoiceTypeListVO model = null;
	 ...
	 * @return InvoiceTypeListVO[]
	 */
	public InvoiceTypeListVO[] getInvoiceTypeListVOs(){
		InvoiceTypeListVO[] vos = (InvoiceTypeListVO[])models.toArray(new InvoiceTypeListVO[models.size()]);
		return vos;
	}
