...
*@FileName : OfficeComboListVO.java
*@FileTitle : OfficeComboListVO
*Open Issues :
*Change history :
...
public class OfficeComboListVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<OfficeComboListVO> models = new ArrayList<OfficeComboListVO>();
	...
	public OfficeComboListVO() {}

	public OfficeComboListVO(String ibflag, String pagerows, String ofcCd, String arHdQtrOfcCd) {
		this.ofcCd = ofcCd;
		this.ibflag = ibflag;
...
/**
	 ...
	 * @param request
	 * @return OfficeComboListVO[]
	 */
	public OfficeComboListVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return OfficeComboListVO[]
	 */
	public OfficeComboListVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		OfficeComboListVO model = null;
	...
	public OfficeComboListVO[] getOfficeComboListVOs(){
		OfficeComboListVO[] vos = (OfficeComboListVO[])models.toArray(new OfficeComboListVO[models.size()]);
		return vos;
	}
