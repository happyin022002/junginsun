...
*@FileName : AccountReceivableOutstandingMigrationDBDAOSearchOutstandingRevTypeRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class AccountReceivableOutstandingMigrationDBDAOSearchOutstandingRevTypeRSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public AccountReceivableOutstandingMigrationDBDAOSearchOutstandingRevTypeRSQL(){
		setQuery();
		...
		query.append("FileName : AccountReceivableOutstandingMigrationDBDAOSearchOutstandingRevTypeRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("FROM   OPUSADM_TMP.SAR_OTS_HDR" ).append("\n"); 
